...
// @copyright https://github.com/scriptscat/scriptcat/blob/main/src/types/scriptcat.d.ts
/**
 * 油猴Api unsafeWindow
 */
...
declare const GM_info: {
  ...
  scriptHandler: "Tampermonkey" | "ScriptCat";
 ...
 */
declare function GM_setValue(name: string, value: any): Promise<undefined> | undefined;
 ...
 * 支持level和label
 */
declare function GM_log(message: string, level?: GMTypes.LoggerLevel, labels?: GMTypes.LoggerLabel): any;

/**
 * 根据 @resource 定义的名字获取它的文本内容
 */
declare function GM_getResourceText(name: string): string | undefined;
/**
 * 根据 @resource 定义的名字获取它的Url
 */

...
// @require      https://cdn.jsdelivr.net/npm/@whitesev/utils@1.7.0/dist/index.umd.js
// @require      https://fastly.jsdelivr.net/npm/@whitesev/utils@1.7.0/dist/index.umd.js
// @require      https://cdn.jsdelivr.net/npm/@whitesev/domutils@1.1.2/dist/index.umd.js
...
(function () {
	...
	const GMApi = {
		...
		GM_addElement:
			typeof GM_addElement === "undefined" ||
			(typeof GM_addElement !== "undefined" && GM_addElement == null)
				? void 0
				: GM_addElement,
		GM_addStyle:
		...
		GM_download:
			...
			(typeof GM_download !== "undefined" && GM_download == null)
				? void 0
				: GM_download,
		GM_getResourceText:
		...
		GM_info:
			...
			(typeof GM_info !== "undefined" && GM_info == null)
				...
				: GM_info,
		GM_log:
			typeof GM_log === "undefined" ||
			(typeof GM_log !== "undefined" && GM_log == null)
				? void 0
				: GM_log,
		GM_notification:
			typeof GM_notification === "undefined" ||
			(typeof GM_notification !== "undefined" && GM_notification == null)
				? void 0
				: GM_notification,
		...
		GM_setClipboard:
			...
			(typeof GM_setClipboard !== "undefined" && GM_setClipboard == null)
				...
				: GM_setClipboard,
		GM_getTab:
			typeof GM_getTab === "undefined" ||
			(typeof GM_getTab !== "undefined" && GM_getTab == null)
				? void 0
				: GM_getTab,
		GM_saveTab:
			typeof GM_saveTab === "undefined" ||
			(typeof GM_saveTab !== "undefined" && GM_saveTab == null)
				? void 0
				: GM_saveTab,
		GM_getTabs:
			typeof GM_getTabs === "undefined" ||
			(typeof GM_getTabs !== "undefined" && GM_getTabs == null)
				? void 0
				: GM_getTabs,
		GM_setValue:
			typeof GM_setValue === "undefined" ||
			(typeof GM_setValue !== "undefined" && GM_setValue == null)
				? void 0
				: GM_setValue,
		GM_getValue:
			typeof GM_getValue === "undefined" ||
			(typeof GM_getValue !== "undefined" && GM_getValue == null)
				? void 0
				: GM_getValue,
		GM_deleteValue:
		...
		GM_listValues:
			...
			(typeof GM_listValues !== "undefined" && GM_listValues == null)
				? void 0
				: GM_listValues,
		...
		GM_removeValueChangeListener:
			...
			(typeof GM_removeValueChangeListener !== "undefined" &&
				GM_removeValueChangeListener == null)
				? void 0
				: GM_removeValueChangeListener,
		GM_xmlhttpRequest:
	...
	const GMBetaApi = {
		GM_cookie:
			...
			(typeof GM_cookie !== "undefined" && GM_cookie == null)
				? undefined
				: GM_cookie,
		GM_webRequest:
			typeof GM_webRequest === "undefined" ||
			(typeof GM_webRequest !== "undefined" && GM_webRequest == null)
				? undefined
				: GM_webRequest,
	};
	/** ChromeXt的Api */
	const ChromeXtApi = {
		ChromeXt:
			...
			(typeof ChromeXt !== "undefined" && ChromeXt == null)
				? void 0
				: ChromeXt,
	};
	/** ScriptCat的Api */
	const ScriptCatApi = {
		CAT_userConfig:
			typeof CAT_userConfig === "undefined" ||
			(typeof CAT_userConfig !== "undefined" && CAT_userConfig == null)
				? void 0
				: CAT_userConfig,
		CAT_fileStorage:
			typeof CAT_fileStorage === "undefined" ||
			(typeof CAT_fileStorage !== "undefined" && CAT_fileStorage == null)
				? void 0
				: CAT_fileStorage,
	};
	/** ScriptCat的beta api */
	...
	const ScriptCatDeprecatedApi = {
		CAT_setProxy:
			typeof CAT_setProxy === "undefined" ||
			(typeof CAT_setProxy !== "undefined" && CAT_setProxy == null)
				? void 0
				: CAT_setProxy,
		CAT_clearProxy:
			typeof CAT_clearProxy === "undefined" ||
			(typeof CAT_clearProxy !== "undefined" && CAT_clearProxy == null)
				? void 0
				: CAT_clearProxy,
		CAT_click:
			typeof CAT_click === "undefined" ||
			(typeof CAT_click !== "undefined" && CAT_click == null)
				? void 0
				: CAT_click,
	};
	/** 其它api */

...
(function () {
  ...
  const pc = {
    ...
    detectUserOnlineStatus() {
      ...
      if (window.location.href.match(MT_CONFIG.regexp.forumPostPC)) {
        ...
        var cishu = 0;
        for (
          var sss = document.getElementsByClassName("pls favatar"), ll = 0;
          ll < sss.length;
          ll++
        ) {
          ...
          if (sendmessage.length == 0) {
            ...
            var sendmessageurl =
              sendmessage[0].getElementsByTagName("a")[1].href;
  ...
  const mobile = {
    ...
    pageAfterDOMChangeRunFunction() {
      /* 当本页面动态加载帖子需要重复加载的东西 */
      if (
        window.location.href.match(/bbs.binmt.cc\/forum/) ||
    ...
    paymentSubjectReminder() {
      ...
      let setTipForumPostList =
        GM_getValue("tipToFreeSubjectForumPost") == null
          ? []
    ...
    previewPostForum() {
      ...
      GM_addStyle(`
            ...
            `);
      let open_double = GM_getValue("preview_post_forum_by_double");
                ...
                <li class="comiis_styli_m f15 comiis_flex b_b">
                    ...
                    <div class="styli_r">
                        ...
                        <label for="postformdouble" class="wauto">
                            <code class="bg_f b_ok comiis_checkbox ${
                              open_double ? "" : "comiis_checkbox_close"
                            }"></code>
                        </label>
                    </div>	
                </li>
        ...
        $jq.each(mobile.quickUBB.code, function (index, value) {
          ...
          ubbs.on("click", function () {
            ...
            popup2.confirm({
              ...
              ok: {
                callback: () => {
                  let userInput = $jq(".quickinsertbbsdialog").val().trim();
              ...
              if (has_history != null) {
                if ($jq.inArray(getsearchtext, has_history) != -1) {
                  ...
                  search_history_array =
                    search_history_array.concat(has_history);
                }
              } else {
                console.log("空记录，添加");
              }
        ...
        function add_search_history() {
          ...
          if (search_history_list) {
            for (var i = 0; i < search_history_list.length; i++) {
              option_text =
                option_text + '<option value="' + search_history_list[i] + '">';
            }
    ...
    setDynamicAvatar() {
      ...
      let dynamicAvater = $jq(`
            ...
            <img style="
                ...
                border-radius: 50%;
                overflow: hidden;
            " src="https://avatar-bbs.mt2.cn/uc_server/avatar.php?uid=${uid}&size=small&ts=1" class="kmtximg">
            ...
            GM_xmlhttpRequest({
              ...
              onload: function (resp) {
                ...
                for (let i = 1; i <= peoples.length - 2; i++) {
                  ...
                  ret_json["uid"] = uid;
                  ret_json["avatar"] =
                    "https://avatar-bbs.mt2.cn/uc_server/avatar.php?uid=" +
                    uid +
                    "&size=small";

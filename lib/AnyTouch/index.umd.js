(function (global, factory) {
  ...
  var AnyEvent = (function () {
    ...
    AnyEvent.prototype.__emit = function (type, event) {
      ...
      if (
        ...
        (listeners === null || listeners === void 0 ? void 0 : listeners.length)
      ) {
        try {
          for (
  ...
  function dispatchDomEvent(typeName, el, payload, eventInit) {
    ...
    if (document.createEvent) {
      ...
      event.initEvent(
        typeName,
        eventInit === null || eventInit === void 0 ? void 0 : eventInit.bubbles,
    ...
    default_1.prototype.compute = function (
      ...
      try {
        for (
          ...
          if (
            !this.__computeFunctionCreatorList.includes(computeFunctionCreator)
          ) {
    ...
    at.compute(
      ...
      function (computed) {
        ...
        function test() {
          ...
          return (
            context.pointLength === pointLength && context.threshold <= distance
          );
        }
      }
    );

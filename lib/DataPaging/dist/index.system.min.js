System.register("DataPaging", [], function (t) {
  "use strict";
  return {
    execute: function () {
      const e = {
      ...
      t(
        ...
        class {
          ...
          DOM_CONFIG = {
            ...
            getAttributeWithCurrentPage: (t) =>
              (t || this.DOM_CONFIG.$pageWrapper.dom).querySelector("a[data-current-page]"),
          ...
          addCSS(t = document.head) {
            ...
            (e.setSafeHTML(i, a), t.appendChild(i));
          }
          createDataPagingWrapper() {
            const t = document.createElement(this.DOM_CONFIG.$pageWrapper.localName);
            ((this.DOM_CONFIG.$pageWrapper.dom = t), (t.id = this.DOM_CONFIG.$pageWrapper.id));
            const i = document.createElement(this.DOM_CONFIG.firstBtnNode.localName);
            e.setSafeHTML(i, this.DOM_CONFIG.firstBtnNode.svgHTML);
            const a = document.createElement(this.DOM_CONFIG.prevBtnNode.localName);
            e.setSafeHTML(a, this.DOM_CONFIG.prevBtnNode.svgHTML);
            const s = document.createElement(this.DOM_CONFIG.nextBtnNode.localName);
            e.setSafeHTML(s, this.DOM_CONFIG.nextBtnNode.svgHTML);
            const r = document.createElement(this.DOM_CONFIG.lastBtnNode.localName);
            if (
              (e.setSafeHTML(r, this.DOM_CONFIG.lastBtnNode.svgHTML),
              ...
              return t;
            (this.CONFIG.firstBtn.enable && (this.setFirstBtnClickEvent(i, t), t.appendChild(i)),
              this.CONFIG.prevBtn.enable && (this.setPrevBtnClickEvent(a, t), t.appendChild(a)));
            let n = this.CONFIG.currentPage;
            if (this.CONFIG.pageMaxStep > this.PAGE_CONFIG.maxPage)
              for (let e = n; e <= this.PAGE_CONFIG.maxPage; e++) {
                const i = document.createElement("a");
                (this.DOM_CONFIG.setAttributeWithPageId(i, e),
                  (i.innerText = String(e)),
                  this.CONFIG.currentPage === e && this.DOM_CONFIG.setAttributeWithCurrentPage(i),
                  this.setPageBtnClickEvent(i, t),
                  t.appendChild(i));
              }
              ...
              for (let e = 0; e < this.CONFIG.pageMaxStep; e++) {
                const e = document.createElement("a");
                (this.DOM_CONFIG.setAttributeWithPageId(e, n),
                  (e.innerText = String(n)),
                  this.CONFIG.currentPage === n && this.DOM_CONFIG.setAttributeWithCurrentPage(e),
                  this.setPageBtnClickEvent(e, t),
                  t.appendChild(e),
                  n++);
              }
            return (
              this.CONFIG.nextBtn.enable && (this.setNextBtnClickEvent(s, t), t.appendChild(s)),
              this.CONFIG.lastBtn.enable && (this.setLastBtnClickEvent(r, t), t.appendChild(r)),
          ...
          setLastBtnClickEvent(t, e) {
            t.addEventListener("click", async (t) => {
              ...
              for (; !(this.PAGE_CONFIG.maxPage - s > 3); ) {
                ...
                if (null == t) break;
                (0 === r
                  ? this.DOM_CONFIG.setAttributeWithCurrentPage(t)
                  : this.DOM_CONFIG.removeAttributeWithCurrentPage(t),

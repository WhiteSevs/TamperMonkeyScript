System.register('Utils', [], (function (exports) {
    'use strict';
    return {
        execute: (function () {
        ...
        return _context['realFunc_${_funcName}'].apply(obj, args);
                    ...
                    async beforeRequestCallBack(requestOption) {
                        if (typeof requestOption.allowInterceptConfig === "boolean") {
                            ...
                            if (requestOption.allowInterceptConfig != null) {
                                // 配置存在
                                // 细分处理是否拦截
                                if (typeof requestOption.allowInterceptConfig.beforeRequest === "boolean" &&
                    ...
                    async successResponseCallBack(response, requestOption) {
                        if (typeof requestOption.allowInterceptConfig === "boolean") {
                            ...
                            if (requestOption.allowInterceptConfig != null) {
                                // 配置存在
                                // 细分处理是否拦截
                                if (typeof requestOption.allowInterceptConfig.afterResponseSuccess === "boolean" &&
                    ...
                    async errorResponseCallBack(data) {
                        if (typeof data.requestOption.allowInterceptConfig === "boolean") {
                            ...
                            if (data.requestOption.allowInterceptConfig != null) {
                                // 配置存在
                                // 细分处理是否拦截
                                if (typeof data.requestOption.allowInterceptConfig.afterResponseError === "boolean" &&
                ...
                HttpxResponseCallBack = {
                    ...
                    async onLoad(requestOption, resolve, _reject, argsResult) {
                        ...
                        if (Math.floor(originResponse.status / 100) === 2) {
                            ...
                            // 请求失败
                            this.context.HttpxResponseCallBack.onError(requestOption, resolve, _reject, argsResult, "response status is not 2xx");
                        }
                    },
                    /**
                     * onloadstart请求开始-触发
                ...
                HttpxRequest = {
                    ...
                    async request(requestOption) {
                        ...
                        if (requestOption.fetch) {
                            // 使用fetch请求
                            const { fetchOption: fetchOption, fetchRequestOption: fetchRequestOption, abortController, } = this.context.HttpxRequestOption.handleFetchOption(requestOption);
            ...
            const __GM_cookie__ = (() => isSupportGM_cookie() // @ts-ignore
                ? GM_cookie
                : void 0)();
            const __GM_async_cookie__ = (() => isSupportGM_async_cookie() // @ts-ignore
                ? GM?.cookie
                : void 0)();
            ...
            class CookieManagerService {
                ...
                get baseCookieHandler() {
                    const optionBaseCookieHandler = typeof this.__option.baseCookieHandler === "function"

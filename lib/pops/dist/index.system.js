		...
		<div 
			...
			<div class="pops-${PopsType}-content">
				...
				`;
                         ...
                         * @param formConfig
                         */
                        getSectionContainerItem_select_multiple(formConfig) {
                            let liElement = document.createElement("li");
				...
				`;
                            const PopsPanelSelectMultiple = {
                                ...
                                $ele: {
                                    panelSelect: liElement.querySelector(".pops-panel-select-multiple"),
                                    select: liElement.querySelector(".pops-panel-select-multiple select"),
                                },
                                $eleKey: {
                                    disable: "__disable__",
                                    value: "__value__",
                                ...
                                setChangeEvent() {
                                    popsDOMUtils.on(this.$ele.select, "change", void 0, (event) => {
                                        this.setSelectOptionsDisableStatus();
                                        if (typeof formConfig.callback === "function") {
                                            formConfig.callback(event, this.getSelectInfoList(this.$ele.select));
                                        }
                                    });
                                },
                                /**
                                ...
                                setClickEvent() {
                                    popsDOMUtils.on(this.$ele.select, "click", void 0, (event) => {
                                        this.setSelectOptionsDisableStatus();
                                        if (typeof formConfig.clickCallBack === "function") {
                                            formConfig.clickCallBack(event, this.getSelectInfoList(this.$ele.select));
                                        }
                                    });
                                },
                            };
				...
				`;
                        ...
                        getSectionContainerItem(formConfig) {
                            ...
                            if (formType === "switch") {
                                ...
                                return this.getSectionContainerItem_select_multiple(formConfig);
                            }

...
`,at={$data:{isAddBeautifyCSS:!1},init(){rt.init(),s.execMenu("bili-video-setVideoPlayer",()=>{this.setVideoPlayer();}),s.execMenuOnce("bili-video-repairVideoBottomAreaHeight",()=>{this.repairVideoBottomAreaHeight();}),s.execMenuOnce("bili-video-autoClickContinueToWatchOnTheWebpage",()=>{this.autoClickContinueToWatchOnTheWebpage();}),s.execMenu("bili-video-beautify",()=>{this.beautify();}),s.execMenuOnce("bili-video-cover-bottomRecommendVideo",()=>{this.coverBottomRecommendVideo();}),s.execMenuOnce("bili-video-gestureReturnToCloseCommentArea",()=>{this.gestureReturnToCloseCommentArea();});},beautify(){r.info("美化"),this.$data.isAddBeautifyCSS||(this.$data.isAddBeautifyCSS=!0,x(ot)),a.waitNode(d.className.video+" .bottom-tab .list-view .card-box",1e4).then(t=>{if(!t){r.error("$cardBox is null");return}let e=new a.LockFunction(()=>{document.querySelectorAll(d.className.video+" .bottom-tab .list-view .card-box .v-card-toapp").forEach(i=>{var p,f;let n=i.querySelector(".title"),o=i.querySelector(".count .left"),l=u.getVue(i);if(n&&o&&!i.querySelector(".gm-right-container")){let y=document.createElement("div"),w=(f=(p=l==null?void 0:l.info)==null?void 0:p.owner)==null?void 0:f.name;y.className="gm-up-name",y.innerHTML=`
        ...
        .control-panel{
            display: none !important;
        }`);}},ut={init(){s.execMenuOnce("bili-opus-cover-topicJump",()=>{this.coverTopicJump();});},coverTopicJump(){r.info("覆盖话题跳转点击事件"),m.on(document,"click",d.className.opus+" .launch-app-btn.opus-module-topic",function(t){var l;let e=t.target,i=u.getVue(e);if(!i){h.error("获取话题的__vue__失败");return}let n=(l=i==null?void 0:i.$props)==null?void 0:l.data,o=n==null?void 0:n.jump_url;if(a.isNull(o)){h.error("获取话题的jump_url失败");return}r.info(["话题的跳转信息: ",n]),u.goToUrl(o);},{capture:!0});}},pt={init(){s.execMenuOnce("bili-dynamic-cover-topicJump",()=>{this.coverTopicJump();}),s.execMenuOnce("bili-dynamic-cover-atJump",()=>{this.coverAtJump();}),s.execMenuOnce("bili-dynamic-cover-referenceJump",()=>{this.coverReferenceJump();}),s.execMenuOnce("bili-dynamic-cover-header",()=>{this.coverHeaderJump();});},coverHeaderJump(){r.info("覆盖header点击事件"),m.on(document,"click",d.className.dynamic+" .launch-app-btn .dyn-header",function(t){a.preventEvent(t);let e=t.target,i=u.getVue(e);if(!i){h.error("获取vue属性失败");return}let n=i.url;if(!n){h.error("获取url失败");return}u.goToUrl(n);},{capture:!0});},coverTopicJump(){r.info("覆盖话题跳转点击事件"),m.on(document,"click",d.className.dynamic+" .launch-app-btn .bili-dyn-topic",function(t){var l;a.preventEvent(t);let e=t.target,i=u.getVue(e);if(!i){h.error("获取vue属性失败");return}let n=(l=i==null?void 0:i.$props)==null?void 0:l.data,o=n==null?void 0:n.jump_url;if(a.isNull(o)){h.error("获取jump_url失败");return}r.info(["话题的跳转信息: ",n]),u.goToUrl(o);},{capture:!0});},coverAtJump(){r.info("覆盖@ 跳转"),m.on(document,"click",d.className.dynamic+" .at",function(t){var n,o;a.preventEvent(t);let e=t.target,i=e.getAttribute("data-oid")||((o=(n=u.getVue(e))==null?void 0:n.$props)==null?void 0:o.rid);if(a.isNull(i)){h.error("获取data-oid或rid失败");return}r.info("用户的oid: "+i),u.goToUrl(D.getUserSpaceDynamicUrl(i));},{capture:!0});},coverReferenceJump(){r.info("覆盖引用的点击事件"),m.on(document,"click",d.className.dynamic+" .dyn-content .reference .dyn-orig-author",function(t){a.preventEvent(t);let i=t.target.getAttribute("data-url");if(!i){h.error("获取data-url失败");return}u.goToUrl(i);},{capture:!0}),m.on(document,"click",d.className.dynamic+" .dyn-content .reference .dyn-archive",function(t){var o;a.preventEvent(t);let e=t.target,i=u.getVue(e);if(!i){h.error("获取vue属性失败");return}let n=(o=i==null?void 0:i.data)==null?void 0:o.jump_url;if(a.isNull(n)){h.error("获取jump_url失败");return}u.goToUrl(n);},{capture:!0});}},dt={init(){s.execMenuOnce("bili-head-supplementaryVideoStreamingInformation",()=>{this.addVideoListUPInfo();});},addVideoListUPInfo(){r.info("添加视频列表UP主信息"),x(`
        ${d.className.head}{
            .video-list .card-box{
                .gm-up-info{
                    display: flex;

...
`,Le={init(){f.execMenuOnce("beautifyPage",()=>{this.beautifyPageElement();}),L.isVersion()&&f.execMenuOnce("beautifyHistoryVersionPage",()=>{this.beautifyHistoryVersionPage();}),f.execMenuOnce("beautifyGreasyforkBeautify",()=>{this.beautifyGreasyforkBeautify();}),f.execMenuOnce("beautifyUploadImage",()=>{this.beautifyUploadImage();});},beautifyPageElement(){l.info("美化页面元素"),v(be),v(we),v(xe),v(ve),v(`
        ...
        `;v(Se),v(t),d.ready(function(){let e=document.querySelector("ul.history_versions");if(!e){s.error(n.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(r=>{var w,g;let o=r.querySelector(".version-number a").href,i=r.querySelector(".version-number a").innerText,a=(w=r.querySelector(".version-date"))==null?void 0:w.getAttribute("datetime"),c=((g=r.querySelector(".version-changelog"))==null?void 0:g.innerHTML)||"",u=d.createElement("span",{className:"script-version-date",innerHTML:p.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),m=d.createElement("div",{className:"script-tag",innerHTML:`
                    ...
                    </div>`}),y=d.createElement("div",{className:"script-note-box-body",innerHTML:c});r.appendChild(u),r.appendChild(m),r.appendChild(y);});});},beautifyGreasyforkBeautify(){l.info("美化 Greasyfork Beautify脚本"),v(Ce),p.isPhone()?v(`
            section#script-info,
...
`),y=new Map;document.querySelectorAll(".discussion-list-container").forEach((g,S)=>{var E;if(!g.querySelector("a.script-link"))return;const h={scriptName:g.querySelector("a.script-link").innerText,scriptUrl:g.querySelector("a.script-link").href,scriptId:b.getScriptId(g.querySelector("a.script-link").href),postUserName:g.querySelector("a.user-link").innerText,postUserHomeUrl:g.querySelector("a.user-link").href,postUserId:b.getUserId(g.querySelector("a.user-link").href),postTimeStamp:new Date(g.querySelector("relative-time").getAttribute("datetime")),snippetUrl:g.querySelector("a.discussion-title").href,snippet:g.querySelector("span.discussion-snippet").innerText,replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};if(g.querySelector(".discussion-meta-item .discussion-meta-item")&&(h.replyUserName=g.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").innerText,h.replyUserHomeUrl=g.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").href,h.replyUserId=b.getUserId(h.replyUserHomeUrl),h.replyTimeStamp=new Date((E=g.querySelector(".discussion-meta-item .discussion-meta-item relative-time"))==null?void 0:E.getAttribute("datetime"))),y.has(h.snippet)&&f.getValue("greasyfork-discussions-filter-duplicate-comments")){let k=y.get(h.snippet).querySelector("a.discussion-title");k.setAttribute("data-repeat-tip-show","true");let C=0;k.hasAttribute("data-repeat-count")&&(C=parseInt(k.getAttribute("data-repeat-count"))),C++,k.setAttribute("data-repeat-count",C.toString()),k.setAttribute("data-repeat-tip-show",n.t("已过滤：{{oldCount}}",{oldCount:C})),l.success([`过滤重复内容：${h.snippet}`,h]),g.remove();return}y.set(h.snippet,g);for(const k of c)if(h.scriptId===k){l.success([`过滤脚本id：${h.scriptId}`,h]),g.remove();return}for(const k of u)if(h.postUserId===k){l.success([`过滤发布用户id：${h.postUserId}`,h]),g.remove();return}if(h.replyUserName){for(const k of m)if(h.replyUserId===k){l.success([`过滤回复用户id：${h.replyUserId}`,h]),g.remove();return}}});}},Ue={init(){d.ready(()=>{Te.init();});}},_e={init(){l.info("添加收藏按钮"),p.waitNode("ul#script-links li.current span").then(()=>{let t=d.createElement("li",{innerHTML:`
            ...
            <li class="user-collect-item" data-id="${u.id}" data-name="${u.name}">
              ...
              `;});let c=q.alert({title:{text:n.t("收藏集"),position:"center"},content:{html:!0,text:`<ul>${a}</ul>`},mask:{enable:!0,clickEvent:{toClose:!0}},btn:{ok:{enable:!1}},width:q.isPhone()?"92dvw":"500px",height:"auto",drag:!0,only:!0,style:`
            .pops{
            ...
            `});d.on(c.$shadowRoot,"click",".collect-add-script-id",async function(u){let m=u.target.closest(".user-collect-item"),y=m.dataset.id;m.dataset.name;let w=s.loading(n.t("添加中...")),g=await b.getUserCollectionInfo(r,y);if(!g){w.close();return}let S=p.cloneFormData(g),h=p.cloneFormData(g),E=!1;for(const[I,T]of g.entries())if(I==="scripts-included[]"&&JSON.stringify(T)==JSON.stringify(e)){E=!0;break}else h.append(I,T),S.append(I,T);if(E){s.warning(n.t("该脚本已经在该收藏集中")),w.close();return}S.set("add-script",e),S.set("script-action","i"),h.append("scripts-included[]",e),h.set("save","1");let k=new URLSearchParams(S),C=new URLSearchParams(h),N=Array.from(k).map(([I,T])=>`${encodeURIComponent(I)}=${encodeURIComponent(T)}`).join("&"),R=Array.from(C).map(([I,T])=>`${encodeURIComponent(I)}=${encodeURIComponent(T)}`).join("&");l.info(["添加的数据",N]),l.info(["保存的数据",R]);let M=await b.updateUserSetsInfo(r,y,N);if(!M){w.close();return}let U=M.querySelector(".change-script-set");if(!U){s.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),w.close();return}let B=U.querySelector("section");if(!B){s.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),w.close();return}let P=B.querySelector(".alert");P?q.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:P.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
                        .pops-alert-content{
                            font-style: italic;
                        ...
                        `,drag:!0,dragLimit:!0,width:q.isPhone()?"88vw":"400px",height:q.isPhone()?"50vh":"300px"}):(await b.updateUserSetsInfo(r,y,R),s.success(n.t("添加成功"))),w.close();}),d.on(c.$shadowRoot,"click",".collect-delete-script-id",async function(u){let m=u.target.closest(".user-collect-item"),y=m.dataset.id;m.dataset.name;let w=s.loading(n.t("删除中...")),g=await b.getUserCollectionInfo(r,y);if(!g){w.close();return}let S=new FormData,h=new FormData;for(const[M,U]of g.entries())M==="scripts-included[]"&&JSON.stringify(U)==JSON.stringify(e)||(h.append(M,U),S.append(M,U));S.set("remove-scripts-included[]",e),S.set("remove-selected-scripts","i"),S.delete("script-action"),h.set("save","1");let E=new URLSearchParams(S),k=new URLSearchParams(h),C=Array.from(E).map(([M,U])=>`${encodeURIComponent(M)}=${encodeURIComponent(U)}`).join("&"),N=Array.from(k).map(([M,U])=>`${encodeURIComponent(M)}=${encodeURIComponent(U)}`).join("&");if(l.info(["删除的数据",C]),l.info(["保存的数据",N]),!await b.updateUserSetsInfo(r,y,C)){w.close();return}await b.updateUserSetsInfo(r,y,N),s.success(n.t("删除成功")),w.close();});}},z={init(){this.checkPage(),Le.init(),L.isCodeStrict()&&f.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),L.isCode()&&Ee.init(),L.isDiscuessions()&&Ue.init(),d.ready(()=>{x.initEnv(),Me.init(),L.isScriptList()&&J.init(),x.handleLocalGotoCallBack(),z.setFindCodeSearchBtn(),_e.init(),z.repairImgShow(),z.scriptHomepageAddedTodaySUpdate(),z.languageSelectorLocale(),f.execMenuOnce("optimizeImageBrowsing",()=>{z.optimizeImageBrowsing();}),f.execMenuOnce("overlayBedImageClickEvent",()=>{z.overlayBedImageClickEvent();}),L.isCodeStrict()&&f.execMenuOnce("addCopyCodeButton",()=>{z.addCopyCodeButton();}),L.isCodeStrict()||z.addMarkdownCopyButton();});},setFindCodeSearchBtn(){l.info("设置代码搜索按钮(对于库)"),p.waitNode("ul#script-links li.current span").then(()=>{let t=d.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("寻找引用")}</span>
        ...
        `);function t(){let e=d.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),k=E.querySelector(".w-script-info"),C=d.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});h.deleted&&(E.classList.add("w-script-deleted"),C.querySelector("button").setAttribute("disabled","true")),d.on(C,"click",void 0,async function(){l.success(["同步",h]);let N=C.querySelector("button"),R=C.querySelector("button span"),M=d.createElement("i",{className:"pops-bottom-icon",innerHTML:q.config.iconSVG.loading},{"is-loading":!0});N.setAttribute("disabled","true"),N.setAttribute("data-icon","true"),R.innerText=n.t("同步中..."),d.before(R,M);let U=h==null?void 0:h.id,B=await b.getSourceCodeSyncFormData(U.toString());if(B){const P="script[script_sync_type_id]";if(B.has(P)){let I=B.get(P),T="";I.toString()==="1"?T=n.t("手动"):I.toString()==="2"?T=n.t("自动"):I.toString()==="3"&&(T="webhook");let Z=E.querySelector(".w-script-sync-type");Z?Z.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:T}):d.append(k,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:T})}
									</p>
								</div>`),await b.sourceCodeSync(h.id.toString(),B)?s.success(n.t("同步成功")):s.error(n.t("同步失败"));}else s.error(n.t("该脚本未设置同步信息"));}N.removeAttribute("disabled"),N.removeAttribute("data-icon"),R.innerText=n.t("同步代码"),M.remove();}),E.appendChild(C),o.appendChild(E);}},checkPage(){l.info("检测gf页面是否正确加载，有时候会出现"),d.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let t=parseInt(F("greasyfork-check-page-time",0));if(t&&Date.now()-t<5*1e3){s.error(n.t("上次重载时间 {{time}}，5秒内拒绝反复重载",{time:p.formatTime(t,"yyyy-MM-dd HH:mm:ss")}));return}K("greasyfork-check-page-time",Date.now()),window.location.reload();}});}},Ie={id:"greasy-fork-panel-config-script-list",title:n.t("脚本列表"),callback(t,e,r){z.UIScriptList("script-list",t,e,r);},forms:[]},Ae={id:"greasy-fork-panel-config-library",title:n.t("库"),callback(t,e,r){z.UIScriptList("script-library",t,e,r);},forms:[]},ze=`.w-script-list-item {\r
	padding: 10px 0;\r
...
`,f={$data:{data:new p.Dictionary,oneSuccessExecMenu:new p.Dictionary,onceExec:new p.Dictionary,scriptName:Y,key:V,attributeKeyName:G,attributeDefaultValueName:$},$listener:{listenData:new p.Dictionary},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},initExtensionsMenu(){D.top===D.self&&re.add([{key:"show_pops_panel_setting",text:n.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(t){return t},callback:()=>{this.showPanel();}}]);},initPanelDefaultValue(){let t=this;function e(o){if(!o.attributes)return;let i=o.attributes[G],a=o.attributes[$];if(i==null){l.warn(["请先配置键",o]);return}t.$data.data.has(i)&&l.warn("请检查该key(已存在): "+i),t.$data.data.set(i,a);}let r=this.getPanelContentConfig();for(let o=0;o<r.length;o++){let i=r[o];if(!i.forms)continue;let a=i.forms;for(let c=0;c<a.length;c++){let u=a[c];if(u.forms){let m=u.forms;for(let y=0;y<m.length;y++)e(m[y]);}else e(u);}}},setValue(t,e){let r=F(V,{}),o=r[t];r[t]=e,K(V,r),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,o,e);},getValue(t,e){let o=F(V,{})[t];return o??(this.$data.data.has(t)?this.$data.data.get(t):e)},deleteValue(t){let e=F(V,{}),r=e[t];Reflect.deleteProperty(e,t),K(V,e),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,r,void 0);},addValueChangeListener(t,e){let r=Math.random();return this.$listener.listenData.set(t,{id:r,key:t,callback:e}),r},removeValueChangeListener(t){let e=null;for(const[r,o]of this.$listener.listenData.entries())if(o.id===t){e=r;break}typeof e=="string"?this.$listener.listenData.delete(e):console.warn("没有找到对应的监听器");},hasKey(t){let e=F(V,{});return t in e},execMenu(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){l.warn(`${t} 键不存在`);return}let r=f.getValue(t);r&&e(r);},execMenuOnce(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){l.warn(`${t} 键不存在`);return}let r=f.getValue(t);if(r){if(this.$data.oneSuccessExecMenu.has(t))return;e(r),this.$data.oneSuccessExecMenu.set(t,1);}},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(t)||(e(),this.$data.onceExec.set(t,1));},showPanel(){q.panel({title:{text:n.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:Y}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0,style:`
			${ze}
			`});},isMobile(){return window.outerWidth<550},getWidth(){return window.outerWidth<550?"92dvw":"550px"},getHeight(){return window.outerHeight>450?"80dvh":"450px"},getPanelContentConfig(){return [me,he,ge,ye,Ie,Ae]}};f.init();z.init();

...
(function (l, ne, oe, n, ie) {
	...
	var v=typeof GM_addStyle<"u"?GM_addStyle:void 0,ae=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,F=typeof GM_getValue<"u"?GM_getValue:void 0,O=typeof GM_info<"u"?GM_info:void 0,se=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,K=typeof GM_setValue<"u"?GM_setValue:void 0,le=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,ce=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,D=typeof unsafeWindow<"u"?unsafeWindow:void 0,ee=window;const de={GreasyFork优化:"GreasyFork优化",请求取消:"请求取消",请求超时:"请求超时",请求异常:"请求异常",通用:"通用",账号:"账号",密码:"密码",语言:"语言","账号/密码":"账号/密码",请输入账号:"请输入账号",请输入密码:"请输入密码",自动登录:"自动登录",自动登录当前保存的账号:"自动登录当前保存的账号","清空账号/密码":"清空账号/密码",点击清空:"点击清空","确定清空账号和密码？":"确定清空账号和密码？","已清空账号/密码":"已清空账号/密码","源代码同步【脚本列表】":"源代码同步【脚本列表】",一键同步:"一键同步",前往用户主页:"前往用户主页",获取当前已登录的用户主页失败:"获取当前已登录的用户主页失败","源代码同步【未上架的脚本】":"源代码同步【未上架的脚本】","源代码同步【库】":"源代码同步【库】",论坛:"论坛",功能:"功能",脚本配置:"脚本配置",过滤重复的评论:"过滤重复的评论","过滤掉重复的评论数量(≥2)":"过滤掉重复的评论数量(≥2)","过滤脚本(id)":"过滤脚本(id)","请输入脚本id，每行一个":"请输入脚本id，每行一个","过滤发布的用户(id)":"过滤发布的用户(id)","请输入用户id，每行一个":"请输入用户id，每行一个","过滤回复的用户(id)":"过滤回复的用户(id)",优化:"优化",固定当前语言:"固定当前语言",无:"无","如button、input、textarea":"如button、input、textarea",更直观的查看版本迭代:"更直观的查看版本迭代",美化上传图片按钮:"美化上传图片按钮",放大上传区域:"放大上传区域",优化图片浏览:"优化图片浏览",使用Viewer浏览图片:"使用Viewer浏览图片",覆盖图床图片跳转:"覆盖图床图片跳转","配合上面的【优化图片浏览】更优雅浏览图片":"配合上面的【优化图片浏览】更优雅浏览图片",'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>':'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>',代码:"代码",添加复制代码按钮:"添加复制代码按钮",更优雅的复制:"更优雅的复制",快捷键:"快捷键","【F】键全屏、【Alt+Shift+F】键宽屏":"【F】键全屏、【Alt+Shift+F】键宽屏",库:"库",脚本列表:"脚本列表",屏蔽:"屏蔽","规则(可正则)":"规则(可正则)","请输入屏蔽规则，每行一个":"请输入屏蔽规则，每行一个",请求admin内容失败:"请求admin内容失败",解析admin的源代码同步表单失败:"解析admin的源代码同步表单失败",源代码同步失败:"源代码同步失败",获取用户信息失败:"获取用户信息失败",获取用户的收藏集失败:"获取用户的收藏集失败","解析Script Sets失败":"解析Script Sets失败","获取收藏集{{setsId}}失败":"获取收藏集{{setsId}}失败","获取表单元素#edit_script_set失败":"获取表单元素#edit_script_set失败",更新收藏集表单请求失败:"更新收藏集表单请求失败",请先在菜单中录入账号:"请先在菜单中录入账号",请先在菜单中录入密码:"请先在菜单中录入密码","获取csrf-token失败":"获取csrf-token失败","正在登录中...":"正在登录中...","登录失败，请在控制台查看原因":"登录失败，请在控制台查看原因","登录成功，1s后自动跳转":"登录成功，1s后自动跳转","登录失败，可能是账号/密码错误，请在控制台查看原因":"登录失败，可能是账号/密码错误，请在控制台查看原因","美化 历史版本 页面":"美化 历史版本 页面",未找到history_versions元素列表:"未找到history_versions元素列表","yyyy年MM月dd日 HH:mm:ss":"yyyy-MM-dd HH:mm:ss","美化 Greasyfork Beautify脚本":"美化 Greasyfork Beautify脚本","❌ 最多同时长传5张图":"❌ 最多同时长传5张图片","❌ 图片：{{name}} 大小：{{size}}":"❌ 图片：{{name}} 大小：{{size}}","已过滤：{{oldCount}}":"已过滤：{{oldCount}}",寻找引用:"寻找引用",获取脚本id失败:"获取脚本id失败",收藏:"收藏",请先登录账号:"请先登录账号",获取用户id失败:"获取用户id失败","获取收藏夹中...":"获取收藏夹中...",收藏集:"收藏集","添加中...":"添加中...","添加失败，{{selector}}元素不存在":"添加失败，{{selector}}元素不存在","未找到{{selector}}元素":"未找到{{selector}}元素",添加失败:"添加失败",添加成功:"添加成功","删除中...":"删除中...",删除成功:"删除成功",添加:"添加",刪除:"刪除","拦截跳转：":"拦截跳转：",今日检查:"今日检查",复制代码:"复制代码","加载文件中...":"加载文件中...",复制成功:"复制成功","✅ 复制成功!":"✅ 复制成功!","当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}":"当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}","导航至：":"导航至：","请先登录账号！":"请先登录账号！","获取信息中，请稍后...":"获取信息中，请稍后...","获取成功，共 {{count}} 个":"获取成功，共 {{count}} 个","评分：":"评分：","语言：":"语言：","版本：":"版本：","更新：":"更新：",同步代码:"同步代码","同步中...":"同步中...",手动:"手动",自动:"自动","同步方式：{{syncMode}}":"同步方式：{{syncMode}}",同步成功:"同步成功",同步失败:"同步失败",该脚本未设置同步信息:"该脚本未设置同步信息","上次重载时间 {{time}}，5秒内拒绝反复重载":"上次重载时间 {{time}}，5秒内拒绝反复重载","名称：":"名称：","进度：":"进度：","未获取到【脚本列表】":"未获取到【脚本列表】","源代码同步成功，3秒后更新下一个":"源代码同步成功，3秒后更新下一个",全部更新失败:"全部更新失败","全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}":"全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}","⚙ 设置":"⚙ 设置","{{SCRIPT_NAME}}-设置":"{{SCRIPT_NAME}}-设置",美化页面元素:"美化页面元素",美化历史版本页面:"美化历史版本页面","美化Greasyfork Beautify脚本":"美化Greasyfork Beautify脚本",获取表单csrfToken失败:"获取表单csrfToken失败",Toast配置:"Toast配置",Toast位置:"Toast位置",左上角:"左上角",顶部:"顶部",右上角:"右上角",左边:"左边",中间:"中间",右边:"右边",左下角:"左下角",底部:"底部",右下角:"右下角",Toast显示在页面九宫格的位置:"Toast显示在页面九宫格的位置",最多显示的数量:"最多显示的数量",限制Toast显示的数量:"限制Toast显示的数量",逆序弹出:"逆序弹出",修改Toast弹出的顺序:"修改Toast弹出的顺序",该脚本已经在该收藏集中:"该脚本已经在该收藏集中"},ue={GreasyFork优化:"GreasyFork Optimization",请求取消:"http request cancel",请求超时:"http request timeout",请求异常:"http request error",通用:"General",账号:"Account",密码:"Password",语言:"Language","账号/密码":"Account/Password",请输入账号:"Please enter your account number",请输入密码:"Please enter password",自动登录:"Auto Login",自动登录当前保存的账号:"Automatically log in to the currently saved account","清空账号/密码":"Clear account/password",点击清空:"Clear","确定清空账号和密码？":"Are you sure to clear your account and password?","已清空账号/密码":"Account/password cleared","源代码同步【脚本列表】":"Source Code Synchronization [Script List]",一键同步:"Sync All",前往用户主页:"Go to the user's homepage",获取当前已登录的用户主页失败:"Failed to retrieve the currently logged in user's homepage","源代码同步【未上架的脚本】":"Source code synchronization [Script not listed]","源代码同步【库】":"Source code synchronization 【 Library 】",论坛:"Forum",功能:"Function",脚本配置:"Script Configuration",过滤重复的评论:"Filter duplicate comments","过滤掉重复的评论数量(≥2)":"Filter out duplicate comments (≥ 2)","过滤脚本(id)":"Filter script (id)","请输入脚本id，每行一个":"Please enter the script ID, one per line","过滤发布的用户(id)":"Filter published users (id)","请输入用户id，每行一个":"Please enter the user ID, one per line","过滤回复的用户(id)":"User (ID) who filters replies",优化:"Optimization",固定当前语言:"Fix current language",无:"nothing","如button、input、textarea":"For example button、input、textarea",更直观的查看版本迭代:"More intuitive viewing of version iterations",美化上传图片按钮:"Beautify upload image button",放大上传区域:"Enlarge the upload area",优化图片浏览:"Optimize image browsing",使用Viewer浏览图片:"Using Viewer to browse images",覆盖图床图片跳转:"Overlay bed image jump","配合上面的【优化图片浏览】更优雅浏览图片":"Collaborate with the optimization of image browsing above to browse images more elegantly",'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>':'Greasyfork Beauty script needs to be installed，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐 Click me to install</a>',代码:"Code",添加复制代码按钮:"Add Copy Code Button",更优雅的复制:"More elegant replication",快捷键:"Shortcut keys","【F】键全屏、【Alt+Shift+F】键宽屏":"【F】 Key full screen, [Alt+Shift+F] key wide screen",库:"Library",脚本列表:"Script List",屏蔽:"Shield","规则(可正则)":"Rules (regularizable)","请输入屏蔽规则，每行一个":"Please enter a blocking rule, one per line",请求admin内容失败:"Request for admin content failed",解析admin的源代码同步表单失败:"Failed to parse the source code of admin and synchronize the form",源代码同步失败:"Source code synchronization failed",获取用户信息失败:"Failed to obtain user information",获取用户的收藏集失败:"Failed to retrieve user's collection","解析Script Sets失败":"Parsing Script Sets failed","获取收藏集{{setsId}}失败":"Failed to retrieve collection {{setsId}}","获取表单元素#edit_script_set失败":"Failed to retrieve form element #edit_script_set",更新收藏集表单请求失败:"Update collection form request failed",请先在菜单中录入账号:"Please enter your account in the menu first",请先在菜单中录入密码:"Please enter your password in the menu first","获取csrf-token失败":"Failed to obtain csrf token","正在登录中...":"Logging in...","登录失败，请在控制台查看原因":"Login failed, please check the reason in the console","登录成功，1s后自动跳转":"Login successful, automatically redirect after 1 second","登录失败，可能是账号/密码错误，请在控制台查看原因":"Login failed, possibly due to incorrect account/password. Please check the reason in the console","美化 历史版本 页面":"Beautify the historical version page",未找到history_versions元素列表:"History_versions element list not found","yyyy年MM月dd日 HH:mm:ss":"yyyy-MM-dd HH:mm:ss","美化 Greasyfork Beautify脚本":"Beautify Greasyfork Beauty Script","❌ 最多同时长传5张图":"❌ Upload up to 5 images simultaneously","❌ 图片：{{name}} 大小：{{size}}":"❌ Image:{{name}} Size:{{size}}","已过滤：{{oldCount}}":"Filtered:{{oldCount}}",寻找引用:"Find references",获取脚本id失败:"Failed to obtain script ID",收藏:"Collection",请先登录账号:"Please log in to your account first",获取用户id失败:"Failed to obtain user ID","获取收藏夹中...":"Get in favorites...",收藏集:"Collection","添加中...":"Adding...","添加失败，{{selector}}元素不存在":"Add failed, {{selector}} element does not exist","未找到{{selector}}元素":"{{selector}} element not found",添加失败:"Add failed",添加成功:"Successfully added","删除中...":"Deleting...",删除成功:"Delete successful",添加:"Add in deletion",刪除:"Delete","拦截跳转：":"Intercept jump:",今日检查:"Today's inspection",复制代码:"Copy Code","加载文件中...":"Loading files...",复制成功:"Copy successful","✅ 复制成功!":"✅ Copy successful!","当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}":"Current language: {{currentLocaleLanguage}}, switch to {{localeLanguage}} in 3 seconds","导航至：":"Navigation to:","请先登录账号！":"Please log in to your account first!","获取信息中，请稍后...":"Obtaining information, please wait...","获取成功，共 {{count}} 个":"Successfully obtained, a total of {{count}}","评分：":"Rating:","语言：":"Language:","版本：":"Version:","更新：":"Update:",同步代码:"Synchronize Code","同步中...":"Synchronizing...",手动:"Manual",自动:"Automatic","同步方式：{{syncMode}}":"Synchronization method: {{syncMode}}",同步成功:"Sync successful",同步失败:"Sync failed",该脚本未设置同步信息:"The script has not set synchronization information","上次重载时间 {{time}}，5秒内拒绝反复重载":"Last reload time {{time}}, rejected repeated reloads within 5 seconds","名称：":"Name:","进度：":"Progress:","未获取到【脚本列表】":"Unable to obtain [Script List]","源代码同步成功，3秒后更新下一个":"Source code synchronization successful, update next one in 3 seconds",全部更新失败:"All updates failed","全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}":"All updates completed<br>Success: {{successNums}}<br>Failure: {{failed Nums}}<br>Total: {{scriptUrlListLength}}","⚙ 设置":"⚙  Setting","{{SCRIPT_NAME}}-设置":"{{SCRIPT_NAME}}-Setting",美化页面元素:"Beautify page elements",美化历史版本页面:"Beautify the historical version page","美化Greasyfork Beautify脚本":"Beautify Greasyfork Beauty Script",获取表单csrfToken失败:"Failed to obtain form csrfToken",Toast配置:"Toast Config",Toast位置:"Toast position",左上角:"Top left",顶部:"Top",右上角:"Top right",左边:"Left",中间:"Center",右边:"Right",左下角:"Bottom left",底部:"Bottom",右下角:"Bottom right",Toast显示在页面九宫格的位置:"Toast is displayed in the nine grid position on the page",最多显示的数量:"Maximum number of displays",限制Toast显示的数量:"Limit the number of Toast displays",逆序弹出:"Reverse pop-up",修改Toast弹出的顺序:"Modify the order in which Toast pops up",该脚本已经在该收藏集中:"The script is already in this collection"},V="GM_Panel",G="data-key",H="data-default-value",pe=function(){let e=F(V,{})["setting-language"]||"zh-CN";n.init({lng:e,fallbackLng:"zh-CN",resources:{"zh-CN":{translation:{...de}},"en-US":{translation:{...ue}}}});};pe();const W=F(V,{}),fe=n.t("GreasyFork优化"),p=oe.noConflict(),c=ne.noConflict(),q=ee.pops||D.pops,s=new p.Log(O,D.console||ee.console);var X;const Y=((X=O==null?void 0:O.script)==null?void 0:X.name)||fe,te=!1;s.config({debug:te,logMaxCount:2e4,autoClearConsole:!0,tag:!0});l.config(Object.defineProperty({position:W["qmsg-config-position"]||"bottom",html:!0,maxNums:W["qmsg-config-maxnums"]||5,autoClose:!0,showClose:!1,showReverse:W["qmsg-config-showreverse"]??!0,zIndex:p.getMaxZIndex(10)},"zIndex",{get(){let t=p.getMaxZIndex(10),e=q.config.Utils.getPopsMaxZIndex(10).zIndex;return p.getMaxValue(t,e)}}));const re=new p.GM_Menu({GM_getValue:F,GM_setValue:K,GM_registerMenuCommand:se,GM_unregisterMenuCommand:le}),_=new p.Httpx(ce);_.config({logDetails:te,onabort(){l.warning(n.t("请求取消"));},ontimeout(){l.error(n.t("请求超时"));},onerror(t){l.error(n.t("请求异常")),s.error(["httpx-onerror 请求异常",t]);}});D.Object.defineProperty,D.Function.prototype.apply,D.Function.prototype.call,D.Element.prototype.appendChild,D.setTimeout;const $=function(t,e,r,o,a,i,d,u){return {text:t,type:"button",description:e,buttonIcon:o,buttonIsRightIcon:a,buttonIconIsLoading:i,buttonType:d,buttonText:r,callback(y){typeof u=="function"&&u(y);},afterAddToUListCallBack:void 0}},Q=function(t,e,r,o,a,i="",d,u){let m={text:t,type:"input",isNumber:!!d,isPassword:!!u,attributes:{},description:o,getValue(){return f.getValue(e,r)},callback(y,w){f.setValue(e,w);},placeholder:i};return m.attributes&&(m.attributes[G]=e,m.attributes[H]=r),m},A=function(t,e,r,o,a){let i={text:t,type:"switch",description:a,attributes:{},getValue(){return !!f.getValue(e,r)},callback(d,u){s.success(`${u?"开启":"关闭"} ${t}`),f.setValue(e,!!u);},afterAddToUListCallBack:void 0};return i.attributes&&(i.attributes[G]=e,i.attributes[H]=!!r),i},b={getCodeSearchUrl(t){return "https://greasyfork.org/zh-CN/scripts/code-search?c="+t},getAdminUrl(t){return t+"/admin"},getScriptId(t){var e,r;return (r=(e=t||window.location.pathname)==null?void 0:e.match(/\/scripts\/([\d]+)/i))==null?void 0:r[1]},getUserId(t){var e;return (e=(t||window.location.pathname).match(/\/users\/([\d]+)/i))==null?void 0:e[1]},getScriptName(t){let e=window.location.pathname;t!=null&&(e=new URL(t).pathname),e=decodeURIComponent(e);let r=e.split("/");for(const o of r){let a=o.match(/[\d]+/);if(a&&a.length)return a[1]}},getSwitchLanguageUrl(t="zh-CN"){let e=window.location.origin,r=window.location.pathname.split("/");return r[1]=t,e=e+r.join("/"),e+=window.location.search,window.location.search===""?e+="?locale_override=1":window.location.search.includes("locale_override=1")||(e+="&locale_override=1"),e},async getScriptStats(t){return new Promise(async e=>{let r=await _.get({url:`https://greasyfork.org/scripts/${t}/stats.json`,fetch:!0,onerror(){},ontimeout(){}});if(!r.status){e(null);return}let o=r.data;e(o);})},async getSourceCodeSyncFormData(t){let e=await _.get(`https://greasyfork.org/zh-CN/scripts/${t}/admin`,{fetch:!0});if(s.success(e),!e.status){l.error(n.t("请求admin内容失败"));return}let r=e.data.responseText,a=c.parseHTML(r,!1,!0).querySelector("form.edit_script");if(!a){l.error(n.t("解析admin的源代码同步表单失败"));return}return new FormData(a)},async sourceCodeSync(t,e){let r=await _.post(`https://greasyfork.org/zh-CN/scripts/${t}/sync_update`,{fetch:!0,data:e});if(s.success(r),!r.status){l.error(n.t("源代码同步失败"));return}return r},async getUserInfo(t){let e=await _.get(`https://greasyfork.org/zh-CN/users/${t}.json`,{fetch:!0});if(s.success(e),!e.status){l.error(n.t("获取用户信息失败"));return}let r=p.toJSON(e.data.responseText);return r.scriptList=[],r.scriptLibraryList=[],r.scripts.forEach(o=>{o.code_url.endsWith(".user.js")?r.scriptList.push(o):r.scriptLibraryList.push(o);}),r},async getUserCollection(t){let e=await _.get(`https://greasyfork.org/zh-CN/users/${t}`,{fetch:!0});if(s.info(["获取用户的收藏集",e]),!e.status){l.error(n.t("获取用户的收藏集失败"));return}let r=e.data.responseText,a=c.parseHTML(r,!0,!0).querySelector("#user-script-sets");if(!a){s.error("解析Script Sets失败");return}let i=[];return a.querySelectorAll("li").forEach(d=>{var g;let u=d.querySelector("a:last-child");if(!u)return;let m=u.href;if(m.includes("?fav=1"))return;let y=d.querySelector("a").innerText,w=(g=m.match(/\/sets\/([\d]+)\//))==null?void 0:g[1];i.push({id:w,name:y});}),i},async getUserCollectionInfo(t,e){let r=await _.get(`https://greasyfork.org/zh-CN/users/${t}/sets/${e}/edit`,{fetch:!0});if(!r.status){l.error(n.t("获取收藏集{{setsId}}失败",{setsId:e}));return}let o=r.data.responseText,a=c.parseHTML(o,!0,!0),i=a.querySelector('form[id^="edit_script_set"]');if(!i){l.error(n.t("获取表单元素#edit_script_set失败"));return}let d=new FormData(i),u=a.querySelector('meta[name="csrf-token"]');if(!u){l.error(n.t("获取表单csrfToken失败"));return}if(u.hasAttribute("content")){let m=u.getAttribute("content");m&&d.set("authenticity_token",m);}return d},async updateUserSetsInfo(t,e,r){let o=await _.post(`https://greasyfork.org/zh-CN/users/${t}/sets/${e}`,{fetch:!0,headers:{accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","cache-control":"no-cache","content-type":"application/x-www-form-urlencoded",pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:r});if(!o.status){l.error(n.t("更新收藏集表单请求失败"));return}let a=o.data.responseText;return c.parseHTML(a,!0,!0)},async switchLanguage(t){let e=await _.get(t,{fetch:!0,headers:{"Upgrade-Insecure-Requests":"1"}});e.status&&s.info(e);}},L={isCode(){var t;return (t=window.location.pathname.split("/"))==null?void 0:t.includes("code")},isCodeStrict(){return window.location.pathname.endsWith("/code")},isVersion(){return window.location.pathname.endsWith("/versions")},isUserHome(){return window.location.pathname.match(/\/.+\/users\/.+/gi)},isScript(){return window.location.pathname.includes("/scripts/")},isScriptList(){return window.location.pathname.endsWith("/scripts")},isDiscuessions(){return window.location.pathname.endsWith("/discussions")}},x={menu:re,isLogin:!1,initEnv(){let t=this.getUserLinkElement();this.isLogin=!!t;},getUserLinkElement(){return document.querySelector("#nav-user-info span.user-profile-link a")},async updateScript(t){let e=function(r,o=1){return `
			...
			</div>`};if(p.isNull(t))l.error(n.t("未获取到【脚本列表】"));else {let r=l.loading(e(b.getScriptName(t[0])),{html:!0}),o=0,a=0;for(let i=0;i<t.length;i++){let d=t[i],u=b.getScriptId(d);s.success("更新："+d);let m=b.getScriptName(d);r.setHTML(e(m,i+1));let y=await b.getSourceCodeSyncFormData(u);y?await b.sourceCodeSync(u,y)?(l.success(n.t("源代码同步成功，3秒后更新下一个")),await p.sleep(3e3),o++):(l.error(n.t("源代码同步失败")),a++):(l.error(n.t("源代码同步失败")),a++);}r.close(),o===0?l.error(n.t("全部更新失败")):l.success(n.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:o,failedNums:a,scriptUrlListLength:t.length}),{html:!0});}},handleLocalGotoCallBack(){if(f.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(f.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!L.isUserHome()){f.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),x.getUserLinkElement()?(l.success(n.t("前往用户主页")),window.location.href=x.getUserLinkElement().href):l.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(e=>{t=t.concat(b.getAdminUrl(e.href));}),x.updateScript(t);}else if(f.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(f.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!L.isUserHome()){f.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),x.getUserLinkElement()?(l.success(n.t("前往用户主页")),window.location.href=x.getUserLinkElement().href):l.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(e=>{t=t.concat(b.getAdminUrl(e.href));}),x.updateScript(t);}else if(f.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(f.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!L.isUserHome()){f.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),x.getUserLinkElement()?(l.success(n.t("前往用户主页")),window.location.href=x.getUserLinkElement().href):l.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(e=>{t=t.concat(b.getAdminUrl(e.href));}),x.updateScript(t);}}},j=function(t,e,r,o,a,i){let d=[];typeof o=="function"?d=o():d=o;let u={text:t,type:"select",description:i,attributes:{},getValue(){return f.getValue(e,r)},callback(m,y,w){f.setValue(e,y),typeof a=="function"&&a(m,y,w);},data:d};return u.attributes&&(u.attributes[G]=e,u.attributes[H]=r),u},me={id:"greasy-fork-panel-config-account",title:n.t("通用"),forms:[{text:n.t("账号/密码"),type:"forms",forms:[Q(n.t("账号"),"user","",void 0,void 0,n.t("请输入账号")),Q(n.t("密码"),"pwd","",void 0,void 0,n.t("请输入密码"),!1,!0)]},{text:n.t("Toast配置"),type:"forms",forms:[j(n.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:n.t("左上角")},{value:"top",text:n.t("顶部")},{value:"topright",text:n.t("右上角")},{value:"left",text:n.t("左边")},{value:"center",text:n.t("中间")},{value:"right",text:n.t("右边")},{value:"bottomleft",text:n.t("左下角")},{value:"bottom",text:n.t("底部")},{value:"bottomright",text:n.t("右下角")}],(t,e,r)=>{s.info("设置当前Qmsg弹出位置"+r),n.changeLanguage(e);},n.t("Toast显示在页面九宫格的位置")),j(n.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,n.t("限制Toast显示的数量")),A(n.t("逆序弹出"),"qmsg-config-showreverse",!1,void 0,n.t("修改Toast弹出的顺序"))]},{text:n.t("脚本配置"),type:"forms",forms:[j(n.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(t,e,r)=>{s.info("改变语言："+r),n.changeLanguage(e);})]},{text:n.t("功能"),type:"forms",forms:[A(n.t("自动登录"),"autoLogin",!0,void 0,n.t("自动登录当前保存的账号")),$(n.t("清空账号/密码"),void 0,n.t("点击清空"),void 0,void 0,!1,"default",t=>{if(confirm(n.t("确定清空账号和密码？"))){f.deleteValue("user"),f.deleteValue("pwd"),l.success(n.t("已清空账号/密码"));let e=t.target.getRootNode();e.querySelector('li[data-key="user"] .pops-panel-input input').value="",e.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}}),$(n.t("源代码同步【脚本列表】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!L.isUserHome()){f.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),x.getUserLinkElement()?(l.success(n.t("前往用户主页")),window.location.href=x.getUserLinkElement().href):l.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(r=>{e=e.concat(b.getAdminUrl(r.href));}),x.updateScript(e);}),$(n.t("源代码同步【未上架的脚本】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!L.isUserHome()){f.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),x.getUserLinkElement()?(l.success(n.t("前往用户主页")),window.location.href=x.getUserLinkElement().href):l.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(r=>{e=e.concat(b.getAdminUrl(r.href));}),x.updateScript(e);}),$(n.t("源代码同步【库】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!L.isUserHome()){f.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),x.getUserLinkElement()?(l.success(n.t("前往用户主页")),window.location.href=x.getUserLinkElement().href):l.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(r=>{e=e.concat(b.getAdminUrl(r.href));}),x.updateScript(e);})]}]},he={id:"greasy-fork-panel-config-optimization",title:n.t("优化"),forms:[{text:n.t("功能"),type:"forms",forms:[j(n.t("固定当前语言"),"language-selector-locale","",function(){let t=[{value:"",text:n.t("无")}];return document.querySelectorAll("select#language-selector-locale option").forEach(e=>{let r=e.getAttribute("value");if(r==="help")return;let o=(e.innerText||e.textContent).trim();t.push({value:r,text:o});}),t}()),A(n.t("美化页面元素"),"beautifyPage",!0,void 0,n.t("如button、input、textarea")),A(n.t("美化历史版本页面"),"beautifyHistoryVersionPage",!0,void 0,n.t("更直观的查看版本迭代")),A(n.t("美化上传图片按钮"),"beautifyUploadImage",!0,void 0,n.t("放大上传区域")),A(n.t("优化图片浏览"),"optimizeImageBrowsing",!0,void 0,n.t("使用Viewer浏览图片")),A(n.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",!0,void 0,n.t("配合上面的【优化图片浏览】更优雅浏览图片")),A(n.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",!0,void 0,n.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]},{text:n.t("代码"),type:"forms",forms:[A(n.t("添加复制代码按钮"),"addCopyCodeButton",!0,void 0,n.t("更优雅的复制")),A(n.t("快捷键"),"fullScreenOptimization",!0,void 0,n.t("【F】键全屏、【Alt+Shift+F】键宽屏"))]}]},ge={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:n.t("功能"),type:"forms",forms:[A(n.t("过滤重复的评论"),"greasyfork-discussions-filter-duplicate-comments",!1,void 0,n.t("过滤掉重复的评论数量(≥2)"))]},{text:n.t("过滤脚本(id)"),type:"forms",forms:[{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
								<textarea placeholder="${n.t("请输入脚本id，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),r=e.querySelector("textarea");const o="greasyfork-discussions-filter-script";return r.value=f.getValue(o,""),c.on(r,["input","propertychange"],void 0,p.debounce(function(a){f.setValue(o,r.value);},200)),t.appendChild(e),t}}]},{text:n.t("过滤发布的用户(id)"),type:"forms",forms:[{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
								<textarea placeholder="${n.t("请输入用户id，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),r=e.querySelector("textarea");const o="greasyfork-discussions-filter-post-user";return r.value=f.getValue(o,""),c.on(r,["input","propertychange"],void 0,p.debounce(function(a){f.setValue(o,r.value);},200)),t.appendChild(e),t}}]},{text:n.t("过滤回复的用户(id)"),type:"forms",forms:[{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
								<textarea placeholder="${n.t("请输入用户id，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),r=e.querySelector("textarea");const o="greasyfork-discussions-filter-reply-user";return r.value=f.getValue(o,""),c.on(r,["input","propertychange"],void 0,p.debounce(function(a){f.setValue(o,r.value);},200)),t.appendChild(e),t}}]}]},J={key:"gf-shield-rule",init(){let t=new p.LockFunction(()=>{this.filter();},50);c.ready(()=>{p.mutationObserver(document.body,{config:{subtree:!0,childList:!0},callback:()=>{t.run();}}),t.run();});},filter(){document.querySelectorAll("#browse-script-list > li").forEach(t=>{let e=t.dataset,r=t.querySelector(".script-description");e.scriptDescription=(r==null?void 0:r.innerText)||(r==null?void 0:r.textContent)||"";let o=p.toJSON(e.scriptAuthors);if(p.isNotNull(o)){let i=Object.keys(o)[0],d=o[i];e.scriptAuthorId=i,e.scriptAuthorName=d;}e.scriptRatingScore=parseFloat(e.scriptRatingScore);let a=this.getValue().split(`
`);for(const i of a){let d=i.split("##"),u=d[0],m=d[1];if(u==="scriptRatingScore"){if(m.startsWith(">")){if(e.scriptRatingScore>parseFloat(m.slice(1))){s.info(["触发过滤规则",[i,e]]),t.remove();break}}else if(m.startsWith("<")&&e.scriptRatingScore<parseFloat(m.slice(1))){s.info(["触发过滤规则",[i,e]]),t.remove();break}}else if(u in e||u==="scriptDescription"){if(typeof m!="string")continue;let y=new RegExp(m,"ig");if(e[u].match(y)){s.info(["触发过滤规则",[i,e]]),t.remove();break}}}});},setValue(t){f.setValue(this.key,t);},getValue(){return f.getValue(this.key,"")}},ye={id:"greasy-fork-panel-config-shield",title:n.t("屏蔽"),forms:[{text:n.t("规则(可正则)"),type:"forms",forms:[{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`<textarea placeholder="${n.t("请输入屏蔽规则，每行一个")}" style="height:350px;"></textarea>`},{style:"width: 100%;"}),r=e.querySelector("textarea");return r.value=J.getValue(),c.on(r,["input","propertychange"],void 0,p.debounce(function(){J.setValue(r.value);},200)),t.appendChild(e),t}}]}]},be=`code {\r
...
`,Le={init(){f.execMenuOnce("beautifyPage",()=>{this.beautifyPageElement();}),L.isVersion()&&f.execMenuOnce("beautifyHistoryVersionPage",()=>{this.beautifyHistoryVersionPage();}),f.execMenuOnce("beautifyGreasyforkBeautify",()=>{this.beautifyGreasyforkBeautify();}),f.execMenuOnce("beautifyUploadImage",()=>{this.beautifyUploadImage();});},beautifyPageElement(){s.info("美化页面元素"),v(be),v(we),v(xe),v(ve),v(`
        ...
        `;v(Se),v(t),c.ready(function(){let e=document.querySelector("ul.history_versions");if(!e){l.error(n.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(r=>{var w,g;let o=r.querySelector(".version-number a").href,a=r.querySelector(".version-number a").innerText,i=(w=r.querySelector(".version-date"))==null?void 0:w.getAttribute("datetime"),d=((g=r.querySelector(".version-changelog"))==null?void 0:g.innerHTML)||"",u=c.createElement("span",{className:"script-version-date",innerHTML:p.formatTime(i,n.t("yyyy年MM月dd日 HH:mm:ss"))}),m=c.createElement("div",{className:"script-tag",innerHTML:`
                    ...
                    </div>`}),y=c.createElement("div",{className:"script-note-box-body",innerHTML:d});r.appendChild(u),r.appendChild(m),r.appendChild(y);});});},beautifyGreasyforkBeautify(){s.info("美化 Greasyfork Beautify脚本"),v(Ce),p.isPhone()?v(`
            section#script-info,
            ...
            section#script-info{
                margin-top: 10px;
            }`);},beautifyUploadImage(){s.info("美化上传图片"),v(ke),c.ready(()=>{function t(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let e=document.querySelectorAll('input[type="file"]');e.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||c.on(o,["propertychange","input"],function(a){t(a.target);let i=a.currentTarget.files;if(!i||i.length===0)return;s.info(["选择的图片",i]),i.length>5&&c.after(o,c.createElement("p",{textContent:n.t("❌ 最多同时长传5张图片")}));let d=[];Array.from(i).forEach(u=>{(u.size>204800||!u.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&d.push(u);}),d.length!==0&&d.forEach(u=>{c.after(o,c.createElement("p",{textContent:n.t("❌ 图片：{{name}} 大小：{{size}}",{name:u.name,size:u.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{c.on(o,"paste",a=>{s.info(["触发粘贴事件",a]),setTimeout(()=>{c.trigger(e,"input");},100);});});});}},Ee={init(){this.repairCodeLineNumber();},repairCodeLineNumber(){s.info("修复代码的行号显示不够问题"),f.getValue("beautifyGreasyforkBeautify")&&v(`
			.code-container pre code .marker{
				padding-left: 6px;
			}	
			`),p.waitNode("#script-content div.code-container pre.prettyprint ol").then(t=>{t.childElementCount>=1e3&&(s.success(`当前代码行数${t.childElementCount}行，超过1000行，优化行号显示问题`),v(`
                    pre.prettyprint{
                        padding-left: 26px;
                    }
					`));});}},Te={init(){f.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){p.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let t=f.getValue("user"),e=f.getValue("pwd");if(p.isNull(t)){l.error(n.t("请先在菜单中录入账号"));return}if(p.isNull(e)){l.error(n.t("请先在菜单中录入密码"));return}let r=document.querySelector("meta[name='csrf-token']");if(!r){l.error(n.t("获取csrf-token失败"));return}let o=l.loading(n.t("正在登录中...")),a=await _.post("https://greasyfork.org/zh-CN/users/sign_in",{fetch:!0,data:encodeURI(`authenticity_token=${r.getAttribute("content")}&user[email]=${t}&user[password]=${e}&user[remember_me]=1&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(o.destroy(),!a.status){s.error(a),l.error(n.t("登录失败，请在控制台查看原因"));return}let i=a.data.responseText;c.parseHTML(i,!0,!0).querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(l.success(n.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):(s.error(a),s.error(`当前账号:${t}`),s.error(`当前密码:${e}`),l.error(n.t("登录失败，可能是账号/密码错误，请在控制台查看原因")));});}},Me={init(){s.info("论坛-过滤"),v(`
...
`),y=new Map;document.querySelectorAll(".discussion-list-container").forEach((g,S)=>{var E;if(!g.querySelector("a.script-link"))return;const h={scriptName:g.querySelector("a.script-link").innerText,scriptUrl:g.querySelector("a.script-link").href,scriptId:b.getScriptId(g.querySelector("a.script-link").href),postUserName:g.querySelector("a.user-link").innerText,postUserHomeUrl:g.querySelector("a.user-link").href,postUserId:b.getUserId(g.querySelector("a.user-link").href),postTimeStamp:new Date(g.querySelector("relative-time").getAttribute("datetime")),snippetUrl:g.querySelector("a.discussion-title").href,snippet:g.querySelector("span.discussion-snippet").innerText,replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};if(g.querySelector(".discussion-meta-item .discussion-meta-item")&&(h.replyUserName=g.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").innerText,h.replyUserHomeUrl=g.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").href,h.replyUserId=b.getUserId(h.replyUserHomeUrl),h.replyTimeStamp=new Date((E=g.querySelector(".discussion-meta-item .discussion-meta-item relative-time"))==null?void 0:E.getAttribute("datetime"))),y.has(h.snippet)&&f.getValue("greasyfork-discussions-filter-duplicate-comments")){let k=y.get(h.snippet).querySelector("a.discussion-title");k.setAttribute("data-repeat-tip-show","true");let C=0;k.hasAttribute("data-repeat-count")&&(C=parseInt(k.getAttribute("data-repeat-count"))),C++,k.setAttribute("data-repeat-count",C.toString()),k.setAttribute("data-repeat-tip-show",n.t("已过滤：{{oldCount}}",{oldCount:C})),s.success([`过滤重复内容：${h.snippet}`,h]),g.remove();return}y.set(h.snippet,g);for(const k of d)if(h.scriptId===k){s.success([`过滤脚本id：${h.scriptId}`,h]),g.remove();return}for(const k of u)if(h.postUserId===k){s.success([`过滤发布用户id：${h.postUserId}`,h]),g.remove();return}if(h.replyUserName){for(const k of m)if(h.replyUserId===k){s.success([`过滤回复用户id：${h.replyUserId}`,h]),g.remove();return}}});}},Ue={init(){c.ready(()=>{Me.init();});}},_e={init(){s.info("添加收藏按钮"),p.waitNode("ul#script-links li.current span").then(()=>{let t=c.createElement("li",{innerHTML:`
            ...
            <li class="user-collect-item" data-id="${u.id}" data-name="${u.name}">
              ...
              `;});let d=q.alert({title:{text:n.t("收藏集"),position:"center"},content:{html:!0,text:`<ul>${i}</ul>`},mask:{enable:!0,clickEvent:{toClose:!0}},btn:{ok:{enable:!1}},width:q.isPhone()?"92dvw":"500px",height:"auto",drag:!0,only:!0,style:`
            .pops{
            ...
            `});c.on(d.$shadowRoot,"click",".collect-add-script-id",async function(u){let m=u.target.closest(".user-collect-item"),y=m.dataset.id;m.dataset.name;let w=l.loading(n.t("添加中...")),g=await b.getUserCollectionInfo(r,y);if(!g){w.close();return}let S=p.cloneFormData(g),h=p.cloneFormData(g),E=!1;for(const[I,M]of g.entries())if(I==="scripts-included[]"&&JSON.stringify(M)==JSON.stringify(e)){E=!0;break}else h.append(I,M),S.append(I,M);if(E){l.warning(n.t("该脚本已经在该收藏集中")),w.close();return}S.set("add-script",e),S.set("script-action","i"),h.append("scripts-included[]",e),h.set("save","1");let k=new URLSearchParams(S),C=new URLSearchParams(h),N=Array.from(k).map(([I,M])=>`${encodeURIComponent(I)}=${encodeURIComponent(M)}`).join("&"),R=Array.from(C).map(([I,M])=>`${encodeURIComponent(I)}=${encodeURIComponent(M)}`).join("&");s.info(["添加的数据",N]),s.info(["保存的数据",R]);let T=await b.updateUserSetsInfo(r,y,N);if(!T){w.close();return}let U=T.querySelector(".change-script-set");if(!U){l.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),w.close();return}let B=U.querySelector("section");if(!B){l.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),w.close();return}let P=B.querySelector(".alert");P?q.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:P.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
                        .pops-alert-content{
                            font-style: italic;
                        ...
                        `,drag:!0,dragLimit:!0,width:q.isPhone()?"88vw":"400px",height:q.isPhone()?"50vh":"300px"}):(await b.updateUserSetsInfo(r,y,R),l.success(n.t("添加成功"))),w.close();}),c.on(d.$shadowRoot,"click",".collect-delete-script-id",async function(u){let m=u.target.closest(".user-collect-item"),y=m.dataset.id;m.dataset.name;let w=l.loading(n.t("删除中...")),g=await b.getUserCollectionInfo(r,y);if(!g){w.close();return}let S=new FormData,h=new FormData;for(const[T,U]of g.entries())T==="scripts-included[]"&&JSON.stringify(U)==JSON.stringify(e)||(h.append(T,U),S.append(T,U));S.set("remove-scripts-included[]",e),S.set("remove-selected-scripts","i"),S.delete("script-action"),h.set("save","1");let E=new URLSearchParams(S),k=new URLSearchParams(h),C=Array.from(E).map(([T,U])=>`${encodeURIComponent(T)}=${encodeURIComponent(U)}`).join("&"),N=Array.from(k).map(([T,U])=>`${encodeURIComponent(T)}=${encodeURIComponent(U)}`).join("&");if(s.info(["删除的数据",C]),s.info(["保存的数据",N]),!await b.updateUserSetsInfo(r,y,C)){w.close();return}await b.updateUserSetsInfo(r,y,N),l.success(n.t("删除成功")),w.close();});}},z={init(){this.checkPage(),Le.init(),L.isCodeStrict()&&f.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),L.isCode()&&Ee.init(),L.isDiscuessions()&&Ue.init(),c.ready(()=>{x.initEnv(),Te.init(),L.isScriptList()&&J.init(),x.handleLocalGotoCallBack(),z.setFindCodeSearchBtn(),_e.init(),z.repairImgShow(),z.scriptHomepageAddedTodaySUpdate(),z.languageSelectorLocale(),f.execMenuOnce("optimizeImageBrowsing",()=>{z.optimizeImageBrowsing();}),f.execMenuOnce("overlayBedImageClickEvent",()=>{z.overlayBedImageClickEvent();}),L.isCodeStrict()&&f.execMenuOnce("addCopyCodeButton",()=>{z.addCopyCodeButton();}),L.isCodeStrict()||z.addMarkdownCopyButton();});},setFindCodeSearchBtn(){s.info("设置代码搜索按钮(对于库)"),p.waitNode("ul#script-links li.current span").then(()=>{let t=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("寻找引用")}</span>
					</a>`});c.append(document.querySelector("ul#script-links"),t),c.on(t,"click",async function(){let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){s.error([e,window.location.pathname]),l.error(n.t("获取脚本id失败"));return}let r=e[e.length-1];window.location.href=b.getCodeSearchUrl(`greasyfork.org/scripts/${r}`);});});},repairImgShow(){window.innerWidth<window.innerHeight&&(s.info("修复图片显示问题"),v(`
            img.lum-img{
                width: 100% !important;
        ...
        `);function t(r=[],o=0){let a="";r.forEach(u=>{a+=`<li><img data-src="${u}" loading="lazy"></li>`;});let i=c.createElement("ul",{innerHTML:a}),d=new ie(i,{inline:!1,url:"data-src",zIndex:p.getMaxZIndex()+100,hidden:()=>{d.destroy();}});o=o<0?0:o,d.view(o),d.zoomTo(1),d.show();}function e(r){return r.getAttribute("data-src")||r.getAttribute("src")||r.getAttribute("alt")}c.on(document,"click","img",function(r){var y;let o=r.target;if(((y=o.parentElement)==null?void 0:y.localName)==="a"&&o.hasAttribute("data-screenshots")||o.closest(".viewer-container")||o.closest(".lum-lightbox-position-helper"))return;let a=o.closest(".user-content"),i=[],d=0,u=[],m=e(o);m!=null&&m.startsWith("https://img.shields.io")||(a?(a.querySelectorAll("img").forEach(w=>{u.push(w);let g=e(w),S=w.parentElement;(S==null?void 0:S.localName)==="a"&&(g=S.getAttribute("data-href")||S.href),i.push(g);}),d=u.indexOf(o),d===-1&&(d=0)):(i.push(m),d=0),s.success(["点击浏览图片👉",i,d]),t(i,d));}),document.querySelectorAll(".user-screenshots").forEach(r=>{let o=r.querySelector("a");if(!o)return;let a=o.getAttribute("data-href")||o.getAttribute("href"),i=r.querySelector("img");i&&(i.setAttribute("data-screenshots","true"),i.setAttribute("data-src",a),o.setAttribute("href","javascript:;"),c.after(o,i),o.remove());});},overlayBedImageClickEvent(){s.info("覆盖图床图片的parentElement的a标签"),document.querySelectorAll(".user-content a>img").forEach(t=>{let e=t.parentElement,r=e.getAttribute("href");e.setAttribute("data-href",r),e.removeAttribute("href"),c.on(e,"click",void 0,function(o){l.warning(`<div style="overflow-wrap: anywhere;">${n.t("拦截跳转：")}<a href="${r}" target="_blank">${r}</a></div>`,{html:!0,timeout:5e3,zIndex:p.getMaxZIndex()});});});},async scriptHomepageAddedTodaySUpdate(){if(!L.isScript()||!document.querySelector("#install-area"))return;s.info("脚本首页新增今日更新");let t=await b.getScriptStats(b.getScriptId());if(!t)return;let e=p.toJSON(t.responseText);s.info(["统计信息",e]);let r=e[p.formatTime(void 0,"yyyy-MM-dd")];if(!r){s.error("今日份的统计信息不存在");return}let o=r.update_checks;s.info(["今日统计信息",r]),c.after("dd.script-show-daily-installs",c.createElement("dt",{className:"script-show-daily-update_checks",innerHTML:`<span>${n.t("今日检查")}</span>`})),c.after("dt.script-show-daily-update_checks",c.createElement("dd",{className:"script-show-daily-update_checks",innerHTML:"<span>"+o+"</span>"}));},addCopyCodeButton(){s.info("添加复制代码按钮"),p.waitNode("div#script-content div.code-container").then(t=>{let e=c.createElement("button",{textContent:n.t("复制代码")},{style:"margin-bottom: 1em;"});c.on(e,"click",async function(){let r=l.loading(n.t("加载文件中...")),o=await _.get(`https://greasyfork.org/zh-CN/scripts/${b.getScriptId()}.json`,{fetch:!0,responseType:"json"});if(!o.status){r.close();return}let i=p.toJSON(o.data.responseText).code_url;s.success(["代码地址：",i]);let d=await _.get(i);if(!d.status){r.close();return}r.close(),p.setClip(d.data.responseText),l.success(n.t("复制成功"));}),c.before(t,e);});},fullScreenOptimization(){s.info("F11全屏，F键代码全屏"),v(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
        ...
        `);let t=!1;c.keydown(window,function(e){if(e.key.toLowerCase()==="f"){let r=document.querySelector("#script-content div.code-container code");e.altKey&&e.shiftKey?(p.preventEvent(e),r.classList.contains("code-wide-screen")?r.classList.remove("code-wide-screen"):r.classList.add("code-wide-screen")):!e.altKey&&!e.ctrlKey&&!e.shiftKey&&!e.metaKey&&(p.preventEvent(e),t?(p.exitFullScreen(r),t=!1):(p.enterFullScreen(r),t=!0));}},{capture:!0});},addMarkdownCopyButton(){s.info("在Markdown右上角添加复制按钮"),v(`
        pre{
          position: relative;
        ...
        `);function t(){let e=c.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),r=e.querySelector(".js-clipboard-copy"),o=e.querySelector(".octicon-copy"),a=e.querySelector(".octicon-check-copy");return c.on(e,"click",function(){let i=e.parentElement.querySelector("code");if(!i&&e.parentElement.className.includes("prettyprinted")&&(i=e.parentElement),!i){l.error(n.t("未找到{{selector}}元素",{selector:"code"}));return}p.setClip(i.innerText||i.textContent),r.setAttribute("success","true"),o.setAttribute("aria-hidden","true"),a.removeAttribute("aria-hidden");let d=q.tooltip({target:r,content:n.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:!0});setTimeout(()=>{r.removeAttribute("success"),a.setAttribute("aria-hidden","true"),o.removeAttribute("aria-hidden"),d.close();},2e3);}),e}document.querySelectorAll("pre").forEach(e=>{if(e.querySelector("div.zeroclipboard-container"))return;let o=t(),a=c.createElement("div",{className:"snippet-clipboard-content"});c.before(e,a),a.appendChild(e),a.appendChild(o);});},languageSelectorLocale(){let t=f.getValue("language-selector-locale"),e=window.location.pathname.split("/").filter(r=>!!r)[0];if(s.success("选择语言："+t),s.success("当前语言："+e),!p.isNull(t)&&t!==e){let r=null,o=b.getSwitchLanguageUrl(t);b.switchLanguage(o),s.success("新Url："+o),l.loading(n.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:e,localeLanguage:t}),{timeout:3e3,showClose:!0,onClose(){clearTimeout(r);}}),l.info(n.t("导航至：")+o,{timeout:3e3}),r=setTimeout(()=>{window.location.href=o;},3e3);}},async UIScriptList(t,e,r,o){var w,g,S;if(!x.isLogin){l.error(n.t("请先登录账号！"));return}let i=x.getUserLinkElement().href,d=(S=(g=(w=i==null?void 0:i.split("/"))==null?void 0:w.pop())==null?void 0:g.match(/([0-9]+)/))==null?void 0:S[0],u=q.loading({mask:{enable:!0},parent:o,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),m=await b.getUserInfo(d);if(u.close(),!m)return;s.info(m);let y=t==="script-list"?m.scriptList:m.scriptLibraryList;l.success(n.t("获取成功，共 {{count}} 个",{count:y.length}));for(const h of y){let E=c.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),k=E.querySelector(".w-script-info"),C=c.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});h.deleted&&(E.classList.add("w-script-deleted"),C.querySelector("button").setAttribute("disabled","true")),c.on(C,"click",void 0,async function(){s.success(["同步",h]);let N=C.querySelector("button"),R=C.querySelector("button span"),T=c.createElement("i",{className:"pops-bottom-icon",innerHTML:q.config.iconSVG.loading},{"is-loading":!0});N.setAttribute("disabled","true"),N.setAttribute("data-icon","true"),R.innerText=n.t("同步中..."),c.before(R,T);let U=h==null?void 0:h.id,B=await b.getSourceCodeSyncFormData(U.toString());if(B){const P="script[script_sync_type_id]";if(B.has(P)){let I=B.get(P),M="";I.toString()==="1"?M=n.t("手动"):I.toString()==="2"?M=n.t("自动"):I.toString()==="3"&&(M="webhook");let Z=E.querySelector(".w-script-sync-type");Z?Z.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:M}):c.append(k,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:M})}
									</p>
								</div>`),await b.sourceCodeSync(h.id.toString(),B)?l.success(n.t("同步成功")):l.error(n.t("同步失败"));}else l.error(n.t("该脚本未设置同步信息"));}N.removeAttribute("disabled"),N.removeAttribute("data-icon"),R.innerText=n.t("同步代码"),T.remove();}),E.appendChild(C),o.appendChild(E);}},checkPage(){s.info("检测gf页面是否正确加载，有时候会出现"),c.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let t=parseInt(F("greasyfork-check-page-time",0));if(t&&Date.now()-t<5*1e3){l.error(n.t("上次重载时间 {{time}}，5秒内拒绝反复重载",{time:p.formatTime(t,"yyyy-MM-dd HH:mm:ss")}));return}K("greasyfork-check-page-time",Date.now()),window.location.reload();}});}},Ie={id:"greasy-fork-panel-config-script-list",title:n.t("脚本列表"),callback(t,e,r){z.UIScriptList("script-list",t,e,r);},forms:[]},Ae={id:"greasy-fork-panel-config-library",title:n.t("库"),callback(t,e,r){z.UIScriptList("script-library",t,e,r);},forms:[]},ze=`.w-script-list-item {\r
	padding: 10px 0;\r

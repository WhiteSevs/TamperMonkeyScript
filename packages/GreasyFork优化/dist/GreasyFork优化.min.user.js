...
`,J={addBlockCSS(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(r=>{Array.isArray(r)?t=t.concat(r):t.push(r);}),se(`${t.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ne=="function"?ne(e.keyName):"";typeof t=="string"&&t?se(t):J.addLinkNode(e.url);},async addLinkNode(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,d.ready(()=>{document.head.appendChild(t);}),t},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e}},ie={getInstallUrl(e,t,r){return h.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${e}/${t}${r}.user.js`},getCodeUrl(e,t){return h.isNull(t)&&(t=""),`https://greasyfork.org/scripts/${e}/code?version=${t}`},getScriptInfoUrl(e){return `https://greasyfork.org/scripts/${e}.json`}},Te={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){c.info("美化 历史版本 页面");let e=[];return e.push(w(Me)),e.push(J.addBlockCSS(".version-number",".version-date",".version-changelog")),d.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){f.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var g,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,s=(g=r.querySelector(".version-date"))==null?void 0:g.getAttribute("datetime"),a=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=d.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(s,n.t("yyyy年MM月dd日 HH:mm:ss"))}),m=d.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),u=d.createElement("div",{className:"script-note-box-body",innerHTML:a});r.appendChild(l),r.appendChild(m),r.appendChild(u);});}),e},addExtraTagButton(){c.info("添加额外的标签按钮"),d.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(e=>{var u,g;let t=e.querySelector("a");if(!t)return;let r=new URL(t.href),i=(u=r.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:u[1],o=r.searchParams.get("version"),s=(g=r.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:g[1],a=ie.getInstallUrl(i,o,s),l=ie.getCodeUrl(i,o),m=d.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});d.after(e,m);});});}};let Q=[];const fe=async function(e){if(c.info("当前脚本id："+e),!v.isLogin){c.error("请先登录账号"),f.error(n.t("请先登录账号"));return}let t=b.getUserId(v.getUserLinkElement().href);if(t==null){c.error("获取用户id失败"),f.error(n.t("获取用户id失败"));return}if(!Q.length){let o=f.loading(n.t("获取收藏夹中..."));if(Q=await b.getUserCollection(t)||[],o.close(),!Q.length)return}let r="";Q.forEach(o=>{r+=`
		...
		`});d.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let s=o.target.closest(".user-collect-item"),a=s.dataset.id;s.dataset.name;let l=f.loading(n.t("添加中...")),m=await b.getUserCollectionInfo(t,a);if(!m){l.close();return}let u=h.cloneFormData(m),g=h.cloneFormData(m),y=!1;for(const[q,M]of m.entries())if(q==="scripts-included[]"&&String(M).trim()===String(e).trim()){y=!0;break}else g.append(q,M),u.append(q,M);if(y){f.warning(n.t("该脚本已经在该收藏集中")),l.close();return}u.set("add-script",e.toString()),u.set("script-action","i"),g.append("scripts-included[]",e.toString()),g.set("save","1");let E=new URLSearchParams(u),L=new URLSearchParams(g),S=Array.from(E).map(([q,M])=>`${encodeURIComponent(q)}=${encodeURIComponent(M)}`).join("&"),R=Array.from(L).map(([q,M])=>`${encodeURIComponent(q)}=${encodeURIComponent(M)}`).join("&");c.info(["添加的数据",S]),c.info(["保存的数据",R]);let $=await b.updateUserSetsInfo(t,a,S);if(!$){l.close();return}let k=$.querySelector(".change-script-set");if(!k){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let C=k.querySelector("section");if(!C){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let z=C.querySelector(".alert");z?_.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:z.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					.pops-alert-content{
						font-style: italic;
					...
					`,drag:!0,dragLimit:!0,width:_.isPhone()?"88vw":"400px",height:_.isPhone()?"50vh":"300px"}):(await b.updateUserSetsInfo(t,a,R),f.success(n.t("添加成功"))),l.close();}),d.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let s=o.target.closest(".user-collect-item"),a=s.dataset.id;s.dataset.name;let l=f.loading(n.t("删除中...")),m=await b.getUserCollectionInfo(t,a);if(!m){l.close();return}let u=new FormData,g=new FormData,y=!1;for(const[k,C]of m.entries()){if(String(k).trim()==="scripts-included[]"&&String(C).trim()===String(e).trim()){y=!0;continue}g.append(k,C),u.append(k,C);}if(!y){f.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:e})),l.close();return}u.set("remove-scripts-included[]",e.toString()),u.set("remove-selected-scripts","i"),u.delete("script-action"),g.set("save","1");let E=new URLSearchParams(u),L=new URLSearchParams(g),S=Array.from(E).map(([k,C])=>`${encodeURIComponent(k)}=${encodeURIComponent(C)}`).join("&"),R=Array.from(L).map(([k,C])=>`${encodeURIComponent(k)}=${encodeURIComponent(C)}`).join("&");if(c.info(["删除的数据",S]),c.info(["保存的数据",R]),!await b.updateUserSetsInfo(t,a,S)){l.close();return}await b.updateUserSetsInfo(t,a,R),f.success(n.t("删除成功")),l.close();});},Ie={init(){I.isCode()?Ee.init():I.isVersion()&&Te.init(),I.isCodeStrict()&&(p.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),p.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),p.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),p.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),p.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){c.info("添加收藏按钮"),h.waitNode("ul#script-links li.current span").then(()=>{let e=d.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});d.append(document.querySelector("ul#script-links"),e),d.on(e,"click",()=>{let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){c.error([t,window.location.pathname]),f.error(n.t("获取脚本id失败"));return}let r=t[t.length-1];fe(r);});});},fullScreenOptimization(){c.info("F11全屏，F键代码全屏"),w(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
...
`),t+=e,this.setValue(t)},getValue(){return p.getValue(this.key,"")}},Ue={id:"greasy-fork-panel-config-scripts",title:n.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:n.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("添加复制代码按钮"),"addCopyCodeButton",!0,void 0,n.t("更优雅的复制")),x(n.t("快捷键"),"fullScreenOptimization",!0,void 0,n.t("【F】键全屏、【Alt+Shift+F】键宽屏")),x(n.t("修复代码行号显示"),"code-repairCodeLineNumber",!0,void 0,n.t("修复代码行数超过1k行号显示不全问题"))]}]},{text:n.t("历史版本"),type:"deepMenu",forms:[{text:n.t("功能"),type:"forms",forms:[x(n.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",!0,void 0,n.t("在版本下面添加【安装】、【查看代码】按钮"))]},{text:n.t("美化"),type:"forms",forms:[x(n.t("美化历史版本页面"),"beautifyHistoryVersionPage",!0,void 0,n.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("添加【寻找引用】按钮"),"addFindReferenceButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),x(n.t("添加【收藏】按钮"),"addCollectionButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),x(n.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",!0,void 0,n.t("在脚本信息栏添加【今日检查】信息块"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("美化脚本列表"),"beautifyCenterContent",!0,void 0,n.t("双列显示且添加脚本卡片操作项（安装、收藏）"))]}]},{text:n.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E5%B1%8F%E8%94%BD%E8%A7%84%E5%88%99">${n.t("帮助文档")}</a>`,type:"forms",forms:[x(n.t("启用"),"gf-scripts-filter-enable",!0,void 0,n.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(e){let t=d.createElement("div",{className:"pops-panel-textarea",innerHTML:`
											...
											`}),o=i.querySelector(".pops-color-choose");o.value=p.getValue(t);let s=d.createElement("style");return d.append(document.head,s),d.on(o,["input","propertychange"],a=>{c.info("选择颜色："+o.value),s.innerHTML=`
												.discussion-read{
												...
												<textarea placeholder="${n.t("请输入用户id，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");const i="greasyfork-discussions-filter-reply-user";return r.value=p.getValue(i,""),d.on(r,["input","propertychange"],void 0,h.debounce(function(o){p.setValue(i,r.value);},200)),e.appendChild(t),e}}]}]}]}]}]}]},$e=`code {\r
...
`,De={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){c.info("美化页面元素");let e=[];return e.push(w($e)),e.push(w(Ne)),e.push(w(Ve)),e.push(w(ze)),e.push(w(`
			...
			`)),d.ready(function(){let t=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(d.createElement("span",{textContent:"Markdown"}),t),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&e.push(w(`
					...
					`));}),e},beautifyGreasyforkBeautify(){c.info("美化 Greasyfork Beautify脚本");let e=[];return e.push(w(Be)),h.isPhone()?e.push(w(`
				section#script-info,
...
`),a=new Map;document.querySelectorAll(".discussion-list-container").forEach((l,m)=>{if(!l.querySelector("a.script-link"))return;const u=this.parseDiscussionListContainer(l);if(a.has(u.snippet)&&p.getValue("greasyfork-discussions-filter-duplicate-comments")){let g=a.get(u.snippet).querySelector("a.discussion-title");g.setAttribute("data-repeat-tip-show","true");let y=0;g.hasAttribute("data-repeat-count")&&(y=parseInt(g.getAttribute("data-repeat-count"))),y++,g.setAttribute("data-repeat-count",y.toString()),g.setAttribute("data-repeat-tip-show",n.t("已过滤：{{oldCount}}",{oldCount:y})),c.success([`过滤重复内容：${u.snippet}`,u]),l.remove();return}a.set(u.snippet,l);for(const g of i)if(u.scriptId===g){c.success([`过滤脚本id：${u.scriptId}`,u]),l.remove();return}for(const g of o)if(u.postUserId===g){c.success([`过滤发布用户id：${u.postUserId}`,u]),l.remove();return}if(u.replyUserName){for(const g of s)if(u.replyUserId===g){c.success([`过滤回复用户id：${u.replyUserId}`,u]),l.remove();return}}});},parseDiscussionListContainer(e){var r;const t={scriptName:e.querySelector("a.script-link").innerText,scriptUrl:e.querySelector("a.script-link").href,scriptId:b.getScriptId(e.querySelector("a.script-link").href),postUserName:e.querySelector("a.user-link").innerText,postUserHomeUrl:e.querySelector("a.user-link").href,postUserId:b.getUserId(e.querySelector("a.user-link").href),postTimeStamp:new Date(e.querySelector("relative-time").getAttribute("datetime")),snippetUrl:e.querySelector("a.discussion-title").href,snippet:e.querySelector("span.discussion-snippet").innerText,replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};return e.querySelector(".discussion-meta-item .discussion-meta-item")&&(t.replyUserName=e.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").innerText,t.replyUserHomeUrl=e.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").href,t.replyUserId=b.getUserId(t.replyUserHomeUrl),t.replyTimeStamp=new Date((r=e.querySelector(".discussion-meta-item .discussion-meta-item relative-time"))==null?void 0:r.getAttribute("datetime"))),t}},Fe={init(){this.readBgColor(),d.ready(()=>{p.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),p.execMenuOnce("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();});});},filterEnable(){c.info("启用Greasyfork论坛过滤器"),O.init();},readBgColor(){c.info("设置已读背景颜色");let e=p.getValue("discussions-readBgColor");w(`
        ...
        `);},addShortcutOperationButton(){c.info("添加快捷操作按钮"),document.querySelectorAll(".discussion-list-container").forEach(e=>{if(!e.querySelector("a.script-link"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=d.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),d.on(o,"click",s=>{h.preventEvent(s);const a=O.parseDiscussionListContainer(e);let l=_.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
...
`),S+=g,p.setValue(y,S),E.close(),l.close(),O.filterDiscussions();}}},drag:!0,dragLimit:!0,width:"300px",height:"200px"});});});});}},He={init(){p.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),p.execMenuOnce("gf-scripts-filter-enable",()=>{G.init();}),p.execMenuOnce("beautifyCenterContent",()=>he.beautifyCenterContent());},changeConsoleToTopNavigator(){c.info("迁移【控制台】到顶部导航栏"),J.addBlockCSS("#about-user"),d.ready(()=>{let e=document.querySelector("#about-user"),t=document.querySelector("#site-nav nav");if(!e){c.error("#about-user元素不存在");return}if(!t){c.error("#site-nav nav元素不存在");return}e=e.cloneNode(!0);let r=d.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});d.on(r,"click",i=>{h.preventEvent(i),_.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:h.getMaxZIndex(100),style:`
                    .text-content{
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(e);}),t.appendChild(r);});}},F={init(){p.execMenu("checkPage",()=>{this.checkPage();}),De.init(),I.isScript()&&Ie.init(),(I.isScriptList()||I.isScriptLibraryList())&&he.init(),I.isDiscuessions()&&Fe.init(),I.isUserHome()&&He.init(),p.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),d.ready(()=>{v.initEnv(),Pe.init(),v.handleLocalGotoCallBack(),p.execMenuOnce("fixImageWidth",()=>{F.fixImageWidth();}),F.languageSelectorLocale(),p.execMenuOnce("optimizeImageBrowsing",()=>{F.optimizeImageBrowsing();}),p.execMenuOnce("overlayBedImageClickEvent",()=>{F.overlayBedImageClickEvent();}),I.isCodeStrict()||p.execMenuOnce("addMarkdownCopyButton",()=>{F.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(c.info("修复图片显示问题"),w(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){c.info("优化图片浏览"),w(ne("ViewerCSS")),w(`
        ...
        `);function e(r=[],i=0){let o="";r.forEach(l=>{o+=`<li><img data-src="${l}" loading="lazy"></li>`;});let s=d.createElement("ul",{innerHTML:o}),a=new ge(s,{inline:!1,url:"data-src",zIndex:h.getMaxZIndex()+100,hidden:()=>{a.destroy();}});i=i<0?0:i,a.view(i),a.zoomTo(1),a.show();}function t(r){return r.getAttribute("data-src")||r.getAttribute("src")||r.getAttribute("alt")}d.on(document,"click","img",function(r){var u;let i=r.target;if(((u=i.parentElement)==null?void 0:u.localName)==="a"&&i.hasAttribute("data-screenshots")||i.closest(".viewer-container")||i.closest(".lum-lightbox-position-helper"))return;let o=i.closest(".user-content"),s=[],a=0,l=[],m=t(i);m!=null&&m.startsWith("https://img.shields.io")||(o?(o.querySelectorAll("img").forEach(g=>{l.push(g);let y=t(g),E=g.parentElement;(E==null?void 0:E.localName)==="a"&&(y=E.getAttribute("data-href")||E.href),s.push(y);}),a=l.indexOf(i),a===-1&&(a=0)):(s.push(m),a=0),c.success(["点击浏览图片👉",s,a]),e(s,a));}),document.querySelectorAll(".user-screenshots").forEach(r=>{let i=r.querySelector("a");if(!i)return;let o=i.getAttribute("data-href")||i.getAttribute("href"),s=r.querySelector("img");s&&(s.setAttribute("data-screenshots","true"),s.setAttribute("data-src",o),i.setAttribute("href","javascript:;"),d.after(i,s),i.remove());});},overlayBedImageClickEvent(){c.info("覆盖图床图片的parentElement的a标签"),document.querySelectorAll(".user-content a>img").forEach(e=>{let t=e.parentElement,r=t.getAttribute("href");t.setAttribute("data-href",r),t.removeAttribute("href"),d.on(t,"click",()=>{f.warning(`<div style="overflow-wrap: anywhere;">${n.t("拦截跳转：")}<a href="${r}" target="_blank">${r}</a></div>`,{html:!0,zIndex:h.getMaxZIndex()+105});});});},addMarkdownCopyButton(){c.info("在Markdown右上角添加复制按钮"),w(`
        pre{
          position: relative;
		...
		`),d.ready(()=>{let e=document.querySelector("#site-nav nav"),t=document.querySelector("#site-nav .with-submenu nav"),r=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!r){c.warn("不存在右侧面板元素#script-list-option-groups");return}if(r=r.cloneNode(!0),r.classList.add("option-panel-groups"),!e){c.error("元素#site-nav nav不存在");return}let i=d.createElement("li",{className:"filter-scripts",innerHTML:`
                ...
                `});d.on(i,"click",o=>{h.preventEvent(o),_.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:h.getMaxZIndex(100),style:`
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(r);}),t&&t.children.length?t.appendChild(i):e.appendChild(i);});}},Ge={id:"greasy-fork-panel-config-script-list",title:n.t("脚本列表"),callback(e,t,r){F.UIScriptList("script-list",e,t,r);},forms:[]},Oe={id:"greasy-fork-panel-config-library",title:n.t("库"),callback(e,t,r){F.UIScriptList("script-library",e,t,r);},forms:[]},je=`.w-script-list-item {\r
	padding: 10px 0;\r
...
`,We={id:"greasy-fork-panel-config-account",title:n.t("用户"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("迁移【控制台】到顶部导航栏"),"users-changeConsoleToTopNavigator",!0,void 0,n.t("将【控制台】按钮移动到顶部导航栏，节省空间"))]}]}]}]},V={data:null,oneSuccessExecMenu:null,onceExec:null,listenData:null},p={$data:{get data(){return V.data==null&&(V.data=new h.Dictionary),V.data},get oneSuccessExecMenu(){return V.oneSuccessExecMenu==null&&(V.oneSuccessExecMenu=new h.Dictionary),V.oneSuccessExecMenu},get onceExec(){return V.onceExec==null&&(V.onceExec=new h.Dictionary),V.onceExec},get scriptName(){return ae},key:D,attributeKeyName:K,attributeDefaultValueName:Y},$listener:{get listenData(){return V.listenData==null&&(V.listenData=new h.Dictionary),V.listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},initExtensionsMenu(){T.top===T.self&&ue.add([{key:"show_pops_panel_setting",text:n.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showPanel();}}]);},initPanelDefaultValue(){let e=this;function t(o){if(!o.attributes)return;let s=o.attributes[K],a=o.attributes[Y];if(s==null){c.warn(["请先配置键",o]);return}e.$data.data.has(s)&&c.warn("请检查该key(已存在): "+s),e.$data.data.set(s,a);}function r(o){for(let s=0;s<o.length;s++){let a=o[s];t(a);let l=a.forms;l&&Array.isArray(l)&&r(l);}}let i=this.getPanelContentConfig();for(let o=0;o<i.length;o++){let s=i[o];if(!s.forms)continue;let a=s.forms;a&&Array.isArray(a)&&r(a);}},setValue(e,t){let r=H(D,{}),i=r[e];r[e]=t,ee(D,r),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,i,t);},getValue(e,t){let i=H(D,{})[e];return i??(this.$data.data.has(e)?this.$data.data.get(e):t)},deleteValue(e){let t=H(D,{}),r=t[e];Reflect.deleteProperty(t,e),ee(D,t),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,r,void 0);},addValueChangeListener(e,t,r){let i=Math.random();return this.$listener.listenData.set(e,{id:i,key:e,callback:t}),r&&r.immediate&&t(e,this.getValue(e),this.getValue(e)),i},removeValueChangeListener(e){let t=null;for(const[r,i]of this.$listener.listenData.entries())if(i.id===e){t=r;break}typeof t=="string"?this.$listener.listenData.delete(t):console.warn("没有找到对应的监听器");},hasKey(e){let t=H(D,{});return e in t},execMenu(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){c.warn(`${e} 键不存在`);return}let r=p.getValue(e);r&&t(r);},execMenuOnce(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){c.warn(`${e} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(e))return;this.$data.oneSuccessExecMenu.set(e,1);let r=[],i=a=>{let l=p.getValue(e);o(l,a);},o=(a,l)=>{let m=[];if(a){let u=l??t(a,i);u instanceof HTMLStyleElement?m=[u]:Array.isArray(u)&&(m=[...u.filter(g=>g!=null&&g instanceof HTMLStyleElement)]);}for(let u=0;u<r.length;u++)r[u].remove(),r.splice(u,1),u--;r=[...m];};this.addValueChangeListener(e,(a,l,m)=>{o(m);});let s=p.getValue(e);s&&o(s);},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(e)||(t(),this.$data.onceExec.set(e,1));},showPanel(){_.panel({title:{text:n.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:ae}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0,style:`
			${je}
			`});},isMobile(){return window.outerWidth<550},getWidth(){return window.outerWidth<550?"92dvw":"550px"},getHeight(){return window.outerHeight>450?"80dvh":"450px"},getPanelContentConfig(){return [Le,Ue,_e,We,Ge,Oe]}};p.init();F.init();

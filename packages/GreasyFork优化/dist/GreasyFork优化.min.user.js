...
`,J={addBlockCSS(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(n=>{Array.isArray(n)?e=e.concat(n):e.push(n);}),st(`${e.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof nt=="function"?nt(t.keyName):"";typeof e=="string"&&e?st(e):J.addLinkNode(t.url);},async addLinkNode(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,c.ready(()=>{document.head.appendChild(e);}),e},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t}},it={getInstallUrl(t,e,n){return h.isNotNull(n)?n="/"+n:n="",`https://update.greasyfork.org/scripts/${t}/${e}${n}.user.js`},getCodeUrl(t,e){return h.isNull(e)&&(e=""),`https://greasyfork.org/scripts/${t}/code?version=${e}`},getScriptInfoUrl(t){return `https://greasyfork.org/scripts/${t}.json`}},Mt={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){d.info("美化 历史版本 页面");let t=[];return t.push(w(Et)),t.push(J.addBlockCSS(".version-number",".version-date",".version-changelog")),c.ready(function(){let e=document.querySelector("ul.history_versions");if(!e){f.error(r.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(n=>{var g,y;let i=n.querySelector(".version-number a").href,o=n.querySelector(".version-number a").innerText,s=(g=n.querySelector(".version-date"))==null?void 0:g.getAttribute("datetime"),a=((y=n.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=c.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(s,r.t("yyyy年MM月dd日 HH:mm:ss"))}),m=c.createElement("div",{className:"script-tag",innerHTML:`
                    ...
                    </div>`}),u=c.createElement("div",{className:"script-note-box-body",innerHTML:a});n.appendChild(l),n.appendChild(m),n.appendChild(u);});}),t},addExtraTagButton(){d.info("添加额外的标签按钮"),c.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(t=>{var u,g;let e=t.querySelector("a");if(!e)return;let n=new URL(e.href),i=(u=n.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:u[1],o=n.searchParams.get("version"),s=(g=n.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:g[1],a=it.getInstallUrl(i,o,s),l=it.getCodeUrl(i,o),m=c.createElement("div",{className:"scripts-tag-install",innerHTML:`
						<a class="script-btn-install install-link" data-install-format="js" target="_blank" href="${a}">${r.t("安装此脚本")}</a>
						<a class="script-btn-see-code" target="_blank" href="${l}">${r.t("查看代码")}</a>
						`});c.after(t,m);});});}};let Q=[];const ft=async function(t){if(d.info("当前脚本id："+t),!v.isLogin){d.error("请先登录账号"),f.error(r.t("请先登录账号"));return}let e=b.getUserId(v.getUserLinkElement().href);if(e==null){d.error("获取用户id失败"),f.error(r.t("获取用户id失败"));return}if(!Q.length){let o=f.loading(r.t("获取收藏夹中..."));if(Q=await b.getUserCollection(e)||[],o.close(),!Q.length)return}let n="";Q.forEach(o=>{n+=`
		...
		`});c.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let s=o.target.closest(".user-collect-item"),a=s.dataset.id;s.dataset.name;let l=f.loading(r.t("添加中...")),m=await b.getUserCollectionInfo(e,a);if(!m){l.close();return}let u=h.cloneFormData(m),g=h.cloneFormData(m),y=!1;for(const[B,M]of m.entries())if(B==="scripts-included[]"&&String(M).trim()===String(t).trim()){y=!0;break}else g.append(B,M),u.append(B,M);if(y){f.warning(r.t("该脚本已经在该收藏集中")),l.close();return}u.set("add-script",t.toString()),u.set("script-action","i"),g.append("scripts-included[]",t.toString()),g.set("save","1");let E=new URLSearchParams(u),L=new URLSearchParams(g),S=Array.from(E).map(([B,M])=>`${encodeURIComponent(B)}=${encodeURIComponent(M)}`).join("&"),R=Array.from(L).map(([B,M])=>`${encodeURIComponent(B)}=${encodeURIComponent(M)}`).join("&");d.info(["添加的数据",S]),d.info(["保存的数据",R]);let $=await b.updateUserSetsInfo(e,a,S);if(!$){l.close();return}let k=$.querySelector(".change-script-set");if(!k){f.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let C=k.querySelector("section");if(!C){f.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let z=C.querySelector(".alert");z?_.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:z.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					.pops-alert-content{
						font-style: italic;
					...
					`,drag:!0,dragLimit:!0,width:_.isPhone()?"88vw":"400px",height:_.isPhone()?"50vh":"300px"}):(await b.updateUserSetsInfo(e,a,R),f.success(r.t("添加成功"))),l.close();}),c.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let s=o.target.closest(".user-collect-item"),a=s.dataset.id;s.dataset.name;let l=f.loading(r.t("删除中...")),m=await b.getUserCollectionInfo(e,a);if(!m){l.close();return}let u=new FormData,g=new FormData,y=!1;for(const[k,C]of m.entries()){if(String(k).trim()==="scripts-included[]"&&String(C).trim()===String(t).trim()){y=!0;continue}g.append(k,C),u.append(k,C);}if(!y){f.warning(r.t("该收藏集未包含：{{scriptId}}",{scriptId:t})),l.close();return}u.set("remove-scripts-included[]",t.toString()),u.set("remove-selected-scripts","i"),u.delete("script-action"),g.set("save","1");let E=new URLSearchParams(u),L=new URLSearchParams(g),S=Array.from(E).map(([k,C])=>`${encodeURIComponent(k)}=${encodeURIComponent(C)}`).join("&"),R=Array.from(L).map(([k,C])=>`${encodeURIComponent(k)}=${encodeURIComponent(C)}`).join("&");if(d.info(["删除的数据",S]),d.info(["保存的数据",R]),!await b.updateUserSetsInfo(e,a,S)){l.close();return}await b.updateUserSetsInfo(e,a,R),f.success(r.t("删除成功")),l.close();});},Tt={init(){I.isCode()?Lt.init():I.isVersion()&&Mt.init(),I.isCodeStrict()&&(p.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),p.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),p.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),p.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),p.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){d.info("添加收藏按钮"),h.waitNode("ul#script-links li.current span").then(()=>{let t=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
					</a>`});c.append(document.querySelector("ul#script-links"),t),c.on(t,"click",()=>{let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){d.error([e,window.location.pathname]),f.error(r.t("获取脚本id失败"));return}let n=e[e.length-1];ft(n);});});},fullScreenOptimization(){d.info("F11全屏，F键代码全屏"),w(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
        ...
        `);let t=!1;c.keydown(T,function(e){if(e.key.toLowerCase()==="f"){let n=document.querySelector("#script-content div.code-container code");e.altKey&&e.shiftKey?(h.preventEvent(e),n.classList.contains("code-wide-screen")?n.classList.remove("code-wide-screen"):n.classList.add("code-wide-screen")):!e.altKey&&!e.ctrlKey&&!e.shiftKey&&!e.metaKey&&(h.preventEvent(e),t?(h.exitFullScreen(n),t=!1):(h.enterFullScreen(n),t=!0));}},{capture:!0});},setFindCodeSearchBtn(){d.info("设置代码搜索按钮(对于库)"),h.waitNode("ul#script-links li.current span").then(()=>{let t=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("寻找引用")}</span>
					</a>`});c.append(document.querySelector("ul#script-links"),t),c.on(t,"click",async function(){let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){d.error([e,window.location.pathname]),f.error(r.t("获取脚本id失败"));return}let n=e[e.length-1];window.location.href=b.getCodeSearchUrl(`greasyfork.org/scripts/${n}`);});});},async scriptHomepageAddedTodaySUpdate(){if(!document.querySelector("#install-area"))return;d.info("脚本首页新增【今日检查】");let t=await b.getScriptStats(b.getScriptId());if(!t)return;let e=h.toJSON(t.responseText);d.info(["统计信息",e]);let n=e[h.formatTime(void 0,"yyyy-MM-dd")];if(!n){d.error("今日份的统计信息不存在");return}let i=n.update_checks;d.info(["今日统计信息",n]),c.after("dd.script-show-daily-installs",c.createElement("dt",{className:"script-show-daily-update_checks",innerHTML:`<span>${r.t("今日检查")}</span>`})),c.after("dt.script-show-daily-update_checks",c.createElement("dd",{className:"script-show-daily-update_checks",innerHTML:"<span>"+i+"</span>"}));},addCopyCodeButton(){d.info("添加复制代码按钮"),h.waitNode("div#script-content div.code-container").then(t=>{let e=c.createElement("button",{textContent:r.t("复制代码")},{style:"margin-bottom: 1em;"});c.on(e,"click",async function(){let n=f.loading(r.t("加载文件中...")),i=await U.get(`https://greasyfork.org/zh-CN/scripts/${b.getScriptId()}.json`,{fetch:!0,responseType:"json"});if(!i.status){n.close();return}let s=h.toJSON(i.data.responseText).code_url;d.success(["代码地址：",s]);let a=await U.get(s);if(!a.status){n.close();return}n.close(),h.setClip(a.data.responseText),f.success(r.t("复制成功"));}),c.before(t,e);});}},It=`.sidebarred-main-content {\r
	max-width: unset;\r
	flex: unset;\r
}\r
ol.script-list {\r
...
`,et={getTampermonkey:()=>{var t;return (t=T.external)==null?void 0:t.Tampermonkey},getViolentmonkey:()=>{var t;return (t=T.external)==null?void 0:t.Violentmonkey},getScriptCat:()=>{var t;return (t=T.external)==null?void 0:t.Scriptcat},getScriptContainerStatus(){var e,n,i;let t={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (e=T.external)!=null&&e.Tampermonkey&&(t.Tampermonkey=!0),(n=T.external)!=null&&n.Violentmonkey&&(t.Violentmonkey=!0),(i=T.external)!=null&&i.Scriptcat&&(t.ScriptCat=!0),t},getInstalledVersion(t,e){return new Promise((n,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(t,e,function(l){l.installed?n(l.version):n(null);});return}const s=this.getViolentmonkey();if(s){s.isInstalled(t,e).then(n);return}const a=this.getScriptCat();if(a){a.isInstalled(t,e,function(l){l.installed?n(l.version):n(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(t,e){if(t===e)return 0;const n=t.split("."),i=e.split(".");for(let o=0;o<n.length;o++){const s=this.compareVersionPart(n[o],i[o]);if(s!==0)return s}return 0},compareVersionPart(t,e){const n=this.parseVersionPart(t),i=this.parseVersionPart(e);for(let o=0;o<n.length;o++){if(n[o].length>0&&i[o].length===0)return -1;if(n[o].length===0&&i[o].length>0||n[o]>i[o])return 1;if(n[o]<i[o])return -1}return 0},parseVersionPart(t){if(!t)return [0,"",0,""];const e=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(t);return [e[1]?parseInt(e[1]):0,e[2],e[3]?parseInt(e[3]):0,e[4]]},handleInstallResult(t,e,n){if(e!=null)switch(t.removeAttribute("data-ping-url"),this.compareVersions(e,n)){case-1:t.textContent=t.getAttribute("data-update-label");break;case 1:t.textContent=t.getAttribute("data-downgrade-label");break;case 0:t.textContent=t.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(t,e){const n=t.getAttribute("data-script-name"),i=t.getAttribute("data-script-namespace"),o=t.getAttribute("data-script-version");try{let s=await this.getInstalledVersion(n,i);return s==null?!1:(this.handleInstallResult(t,s,o),!0)}catch{if(e){await h.sleep(1e3);try{return await this.checkForUpdatesJS(t,!1)}catch{}}return !1}},checkForUpdatesCSS(t){const e=t.getAttribute("data-script-name"),n=t.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:e,namespace:n,url:location.href},location.origin);}},mt=t=>{let e=t.dataset;const n={scriptId:parseInt(e.scriptId),scriptName:e.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(e.scriptDailyInstalls),scriptTotalInstalls:parseInt(e.scriptTotalInstalls),scriptRatingScore:parseFloat(e.scriptRatingScore),scriptCreatedDate:new Date(e.scriptCreatedDate),scriptUpdatedDate:new Date(e.scriptUpdatedDate),scriptType:e.scriptType,scriptVersion:e.scriptVersion,sensitive:e.sensitive==="true",scriptLanguage:e.scriptLanguage,cssAvailableAsJs:e.cssAvailableAsJs==="true",codeUrl:e.codeUrl,scriptDescription:e.scriptDescription,scriptAuthorId:parseInt(e.scriptAuthorId),scriptAuthorName:e.scriptAuthorName};let i=h.toJSON(e.scriptAuthors);return Object.keys(i).forEach(o=>{let s=i[o];n.scriptAuthors.push({authorId:parseInt(o),authorName:s});}),n},ht={init(){p.execMenuOnce("gf-scripts-filter-enable",()=>{P.init();}),p.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){d.info("美化脚本列表");let t=[];return t.push(w(It)),A.ready(async()=>{P.getScriptElementList().forEach(s=>{if(s.querySelector(".script-list-operation"))return;let a=mt(s),l=s.querySelector(".inline-script-stats"),m=a.codeUrl,u=A.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),g=A.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${a.scriptRatingScore}</span>`},{"data-position":"right"});a.scriptRatingScore<60?g.classList.add("bad-rating-count"):g.classList.add("good-rating-count");let y=A.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),E=A.createElement("dd",{className:"script-list-version",innerHTML:`<span>${a.scriptVersion}</span>`},{"data-position":"right"}),L=A.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),S=A.createElement("dd",{className:"script-list-operation",innerHTML:`
						<a
							target="_blank"
							class="install-link"
							...
							data-update-label="${r.t("更新到 {{version}} 版本",{version:a.scriptVersion})}"
							data-downgrade-label="${r.t("降级到 {{version}} 版本",{version:a.scriptVersion})}"
							data-reinstall-label="${r.t("重新安装 {{version}} 版本",{version:a.scriptVersion})}"
							href="${m}"></a>
						<button class="script-collect-btn">${r.t("收藏")}</button>
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),R=S.querySelector(".script-collect-btn"),$=S.querySelector(".install-link");if($["data-script-info"]=a,$.classList.add("lum-lightbox-loader"),a.scriptType==="library"&&$.remove(),A.on(R,"click",k=>{h.preventEvent(k),ft(a.scriptId);}),p.getValue("gf-scripts-filter-enable")){let k=A.createElement("button",{className:"script-filter-btn",innerHTML:r.t("过滤")}),C="data-filter-key",z="data-filter-value";A.on(k,"click",B=>{h.preventEvent(B);let M=_.alert({title:{text:r.t("选择过滤的选项"),position:"center"},content:{text:`
									<button ${C}="scriptId" ${z}="^${a.scriptId}$">${r.t("脚本id：{{text}}",{text:a.scriptId})}</button>
									<button ${C}="scriptName" ${z}="^${h.parseStringToRegExpString(a.scriptName)}$">${r.t("脚本名：{{text}}",{text:a.scriptName})}</button>
								...
								`}),j=M.$shadowRoot.querySelector(".pops-alert-content");a.scriptAuthors.forEach(q=>{let N=A.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:q.authorId})});N.setAttribute(C,"scriptAuthorId"),N.setAttribute(z,"^"+q.authorId+"$");let F=A.createElement("button",{innerHTML:r.t("作者名：{{text}}",{text:q.authorName})});F.setAttribute(C,"scriptAuthorName"),F.setAttribute(z,"^"+h.parseStringToRegExpString(q.authorName)+"$"),j.appendChild(N),j.appendChild(F);}),A.on(M.$shadowRoot,"click","button",q=>{h.preventEvent(q);let N=q.target,F=N.getAttribute(C),ot=N.getAttribute(z);P.addValue(`${F}##${ot}`),M.close(),P.filter(),f.success(r.t("添加成功"));});}),S.appendChild(k);}l.appendChild(u),l.appendChild(g),l.appendChild(y),l.appendChild(E),l.appendChild(L),l.appendChild(S);});let n=Array.from(document.querySelectorAll(".install-link[data-install-format=js]")),i=et.getScriptContainerStatus(),o=Object.values(i).filter(Boolean);if(!i.Tampermonkey)n.forEach(async s=>{let a=await et.checkForUpdatesJS(s,!0);s.classList.remove("lum-lightbox-loader"),a||(s.textContent=r.t("安装此脚本"));});else if(o.length)for(let s=0;s<n.length;s++){let a=n[s],l=a["data-script-info"],m=await U.get(it.getScriptInfoUrl(l.scriptId),{fetch:!0});if(!m.status){a.textContent=r.t("安装此脚本");continue}let u=h.toJSON(m.data.responseText);a.setAttribute("data-script-namespace",u.namespace);let g=await et.checkForUpdatesJS(a,!0);a.classList.remove("lum-lightbox-loader"),g||(a.textContent=r.t("安装此脚本")),await h.sleep(150);}else d.error("未知的脚本容器");}),t}},P={key:"gf-shield-rule",init(){d.info("脚本过滤");let t=new h.LockFunction(()=>{this.filter();},50);c.ready(()=>{h.mutationObserver(document.body,{config:{subtree:!0,childList:!0},callback:()=>{t.run();}}),t.run();});},getScriptElementList(){let t=[];return t=t.concat(Array.from(document.querySelectorAll("ol.script-list li"))),t},filter(){this.getScriptElementList().forEach(t=>{let e=mt(t),n=this.getValue().split(`
`);for(let i=0;i<n.length;i++){let o=n[i],s=o.split("##"),a=s[0],l=s[1];if(a==="scriptRatingScore"){let m=parseFloat(l.slice(1));if(l.startsWith(">")){if(e.scriptRatingScore>m){d.info(["触发过滤规则",[o,e]]),t.remove();break}}else if(l.startsWith("<")&&e.scriptRatingScore<m){d.info(["触发过滤规则",[o,e]]),t.remove();break}}else if(a in e||a==="scriptDescription"){if(typeof l!="string")continue;let m=new RegExp(l,"ig");if(e[a].toString().match(m)){d.info(["触发过滤规则",[o,e]]),t.remove();break}}}});},setValue(t){p.setValue(this.key,t);},addValue(t){let e=this.getValue();return e.trim()!==""&&(e+=`
`),e+=t,this.setValue(e)},getValue(){return p.getValue(this.key,"")}},At={id:"greasy-fork-panel-config-account",title:r.t("通用"),forms:[{text:"",type:"forms",forms:[{text:r.t("Toast配置"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[W(r.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:r.t("左上角")},{value:"top",text:r.t("顶部")},{value:"topright",text:r.t("右上角")},{value:"left",text:r.t("左边")},{value:"center",text:r.t("中间")},{value:"right",text:r.t("右边")},{value:"bottomleft",text:r.t("左下角")},{value:"bottom",text:r.t("底部")},{value:"bottomright",text:r.t("右下角")}],(t,e,n)=>{d.info("设置当前Qmsg弹出位置"+n);},r.t("Toast显示在页面九宫格的位置")),W(r.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,r.t("限制Toast显示的数量")),x(r.t("逆序弹出"),"qmsg-config-showreverse",!1,void 0,r.t("修改Toast弹出的顺序"))]}]},W(r.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(t,e,n)=>{d.info("改变语言："+n),r.changeLanguage(e);})]},{text:"",type:"forms",forms:[{text:r.t("账号/密码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[lt(r.t("账号"),"user","",void 0,void 0,r.t("请输入账号")),lt(r.t("密码"),"pwd","",void 0,void 0,r.t("请输入密码"),!1,!0)]},{text:"",type:"forms",forms:[x(r.t("自动登录"),"autoLogin",!0,void 0,r.t("自动登录当前保存的账号")),Z(r.t("清空账号/密码"),void 0,r.t("点击清空"),void 0,void 0,!1,"default",t=>{if(confirm(r.t("确定清空账号和密码？"))){p.deleteValue("user"),p.deleteValue("pwd"),f.success(r.t("已清空账号/密码"));let e=t.target.getRootNode();e.querySelector('li[data-key="user"] .pops-panel-input input').value="",e.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}})]}]},{text:r.t("功能"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[W(r.t("固定当前语言"),"language-selector-locale","",function(){let t=[{value:"",text:r.t("无")}];return document.querySelectorAll("select#language-selector-locale option").forEach(e=>{let n=e.getAttribute("value");if(n==="help")return;let i=(e.innerText||e.textContent).trim();t.push({value:n,text:i});}),t}()),x(r.t("修复图片宽度显示问题"),"fixImageWidth",!0,void 0,r.t("修复图片在移动端宽度超出浏览器宽度问题")),x(r.t("优化图片浏览"),"optimizeImageBrowsing",!0,void 0,r.t("使用Viewer浏览图片")),x(r.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",!0,void 0,r.t("配合上面的【优化图片浏览】更优雅浏览图片")),x(r.t("添加【操作面板】按钮"),"scripts-addOperationPanelBtnWithNavigator",!0,void 0,r.t("在脚本列表页面时为顶部导航栏添加【操作面板】按钮")),x(r.t("给Markdown添加【复制】按钮"),"addMarkdownCopyButton",!0,void 0,r.t("在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容"))]},{text:r.t("检测页面加载"),type:"forms",forms:[x(r.t("启用"),"checkPage",!0,void 0,r.t("检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面")),W(r.t("检测间隔"),"greasyfork-check-page-timeout",5,(()=>{let t=[];for(let e=0;e<5;e++)t.push({value:e+1,text:e+1+"s"});return t})(),void 0,r.t("设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面"))]},{text:r.t("代码同步"),type:"forms",forms:[Z(r.t("源代码同步【脚本列表】"),void 0,r.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!I.isUserHome()){p.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),v.getUserLinkElement()?(f.success(r.t("前往用户主页")),window.location.href=v.getUserLinkElement().href):f.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(n=>{e=e.concat(b.getAdminUrl(n.href));}),v.updateScript(e);}),Z(r.t("源代码同步【未上架的脚本】"),void 0,r.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!I.isUserHome()){p.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),v.getUserLinkElement()?(f.success(r.t("前往用户主页")),window.location.href=v.getUserLinkElement().href):f.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(n=>{e=e.concat(b.getAdminUrl(n.href));}),v.updateScript(e);}),Z(r.t("源代码同步【库】"),void 0,r.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!I.isUserHome()){p.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),v.getUserLinkElement()?(f.success(r.t("前往用户主页")),window.location.href=v.getUserLinkElement().href):f.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(n=>{e=e.concat(b.getAdminUrl(n.href));}),v.updateScript(e);})]}]},{text:r.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("美化页面元素"),"beautifyPage",!0,void 0,r.t("如button、input、textarea")),x(r.t("美化上传图片按钮"),"beautifyUploadImage",!0,void 0,r.t("放大上传区域")),x(r.t("美化顶部导航栏"),"beautifyTopNavigationBar",!0,void 0,r.t("可能会跟Greasyfork Beautify脚本有冲突")),x(r.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",!0,void 0,r.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]}]},{text:r.t("屏蔽脚本"),type:"deepMenu",forms:[{text:`<a href="https://greasyfork.org/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E5%B1%8F%E8%94%BD%E8%A7%84%E5%88%99" target="_blank">${r.t("点击查看规则")}</a>`,type:"forms",forms:[x(r.t("启用"),"greasyfork-shield-enable",!0,void 0,r.t("开启后下面的功能才会生效")),{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`<textarea placeholder="${r.t("请输入屏蔽规则，每行一个")}" style="height:350px;"></textarea>`},{style:"width: 100%;"}),n=e.querySelector("textarea");return n.value=P.getValue(),c.on(n,["input","propertychange"],void 0,h.debounce(function(){P.setValue(n.value);},200)),t.appendChild(e),t}}]}]}]}]},Ut={id:"greasy-fork-panel-config-scripts",title:r.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:r.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("添加复制代码按钮"),"addCopyCodeButton",!0,void 0,r.t("更优雅的复制")),x(r.t("快捷键"),"fullScreenOptimization",!0,void 0,r.t("【F】键全屏、【Alt+Shift+F】键宽屏")),x(r.t("修复代码行号显示"),"code-repairCodeLineNumber",!0,void 0,r.t("修复代码行数超过1k行号显示不全问题"))]}]},{text:r.t("历史版本"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[x(r.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",!0,void 0,r.t("在版本下面添加【安装】、【查看代码】按钮"))]},{text:r.t("美化"),type:"forms",forms:[x(r.t("美化历史版本页面"),"beautifyHistoryVersionPage",!0,void 0,r.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("添加【寻找引用】按钮"),"addFindReferenceButton",!0,void 0,r.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),x(r.t("添加【收藏】按钮"),"addCollectionButton",!0,void 0,r.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),x(r.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",!0,void 0,r.t("在脚本信息栏添加【今日检查】信息块"))]}]},{text:r.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("美化脚本列表"),"beautifyCenterContent",!0,void 0,r.t("双列显示且添加脚本卡片操作项（安装、收藏）"))]}]},{text:r.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E5%B1%8F%E8%94%BD%E8%A7%84%E5%88%99">${r.t("帮助文档")}</a>`,type:"forms",forms:[x(r.t("启用"),"gf-scripts-filter-enable",!0,void 0,r.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${r.t("请输入规则，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),n=e.querySelector("textarea");return n.value=p.getValue(P.key,""),c.on(n,["input","propertychange"],void 0,h.debounce(function(i){p.setValue(P.key,n.value);},200)),t.appendChild(e),t}}]}]}]}]},_t={id:"greasy-fork-panel-config-discussions",title:r.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(t){let e="discussions-readBgColor",n=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											<p class="pops-panel-item-left-main-text">${r.t("自定义已读颜色")}</p>
											<p class="pops-panel-item-left-desc-text">${r.t("在讨论内生效")}</p>
											`}),i=c.createElement("div",{className:"pops-panel-item-right",innerHTML:`
											<input type="color" class="pops-color-choose" />
											`}),o=i.querySelector(".pops-color-choose");o.value=p.getValue(e);let s=c.createElement("style");return c.append(document.head,s),c.on(o,["input","propertychange"],a=>{d.info("选择颜色："+o.value),s.innerHTML=`
												.discussion-read{
												...
												`,p.setValue(e,o.value);}),t.appendChild(n),t.appendChild(i),t}},x(r.t("添加快捷操作按钮"),"discussions-addShortcutOperationButton",!0,void 0,r.t("在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效"))]}]}]},{text:"",type:"forms",forms:[{text:r.t("过滤"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("启用"),"greasyfork-discussions-filter-enable",!0,void 0,r.t("开启后下面的过滤功能才会生效")),x(r.t("过滤重复的评论"),"greasyfork-discussions-filter-duplicate-comments",!1,void 0,r.t("过滤掉重复的评论数量(≥2)"))]},{text:"",type:"forms",forms:[{text:r.t("过滤脚本(id)"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
														<textarea placeholder="${r.t("请输入脚本id，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),n=e.querySelector("textarea");const i="greasyfork-discussions-filter-script";return n.value=p.getValue(i,""),c.on(n,["input","propertychange"],void 0,h.debounce(function(o){p.setValue(i,n.value);},200)),t.appendChild(e),t}}]}]},{text:r.t("过滤发布的用户(id)"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
														<textarea placeholder="${r.t("请输入用户id，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),n=e.querySelector("textarea");const i="greasyfork-discussions-filter-post-user";return n.value=p.getValue(i,""),c.on(n,["input","propertychange"],void 0,h.debounce(function(o){p.setValue(i,n.value);},200)),t.appendChild(e),t}}]}]},{text:r.t("过滤回复的用户(id)"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${r.t("请输入用户id，每行一个")}" style="height:150px;"></textarea>`},{style:"width: 100%;"}),n=e.querySelector("textarea");const i="greasyfork-discussions-filter-reply-user";return n.value=p.getValue(i,""),c.on(n,["input","propertychange"],void 0,h.debounce(function(o){p.setValue(i,n.value);},200)),t.appendChild(e),t}}]}]}]}]}]}]},$t=`code {\r
...
`,Dt={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){d.info("美化页面元素");let t=[];return t.push(w($t)),t.push(w(Nt)),t.push(w(Vt)),t.push(w(zt)),t.push(w(`
			...
			`)),c.ready(function(){let e=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');e&&e.parentElement.replaceChild(c.createElement("span",{textContent:"Markdown"}),e),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&t.push(w(`
					...
					`));}),t},beautifyGreasyforkBeautify(){d.info("美化 Greasyfork Beautify脚本");let t=[];return t.push(w(qt)),h.isPhone()?t.push(w(`
				section#script-info,
				...
				section#script-info{
					margin-top: 10px;
				}`)),t},beautifyUploadImage(){d.info("美化上传图片");let t=[];return t.push(w(Bt)),c.ready(()=>{function e(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let n=document.querySelectorAll('input[type="file"]');n.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||c.on(o,["propertychange","input"],function(s){e(s.target);let a=s.currentTarget.files;if(!a||a.length===0)return;d.info(["选择的图片",a]),a.length>5&&c.after(o,c.createElement("p",{textContent:r.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(a).forEach(m=>{(m.size>204800||!m.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(m);}),l.length!==0&&l.forEach(m=>{c.after(o,c.createElement("p",{textContent:r.t("❌ 图片：{{name}} 大小：{{size}}",{name:m.name,size:m.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{c.on(o,"paste",s=>{d.info(["触发粘贴事件",s]),setTimeout(()=>{c.trigger(n,"input");},100);});});}),t},beautifyTopNavigationBar(){d.info("美化顶部导航栏");let t=[];return t.push(w(Rt)),window.outerWidth>550&&(t.push(J.addBlockCSS(".with-submenu")),c.ready(()=>{let n=document.querySelector("#site-nav").querySelector("nav");document.querySelectorAll(".with-submenu nav li").forEach(i=>{n.appendChild(i);});})),t}},Pt={init(){p.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){h.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let t=p.getValue("user"),e=p.getValue("pwd");if(h.isNull(t)){f.error(r.t("请先在菜单中录入账号"));return}if(h.isNull(e)){f.error(r.t("请先在菜单中录入密码"));return}let n=document.querySelector("meta[name='csrf-token']");if(!n){f.error(r.t("获取csrf-token失败"));return}let i=f.loading(r.t("正在登录中...")),o=await U.post("https://greasyfork.org/zh-CN/users/sign_in",{fetch:!0,data:encodeURI(`authenticity_token=${n.getAttribute("content")}&user[email]=${t}&user[password]=${e}&user[remember_me]=1&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(i.destroy(),!o.status){d.error(o),f.error(r.t("登录失败，请在控制台查看原因"));return}let s=o.data.responseText;c.parseHTML(s,!0,!0).querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(f.success(r.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):(d.error(o),d.error(`当前账号:${t}`),d.error(`当前密码:${e}`),f.error(r.t("登录失败，可能是账号/密码错误，请在控制台查看原因")));});}},O={$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){d.info("论坛-过滤"),w(`
        ...
        `);},addShortcutOperationButton(){d.info("添加快捷操作按钮"),document.querySelectorAll(".discussion-list-container").forEach(t=>{if(!t.querySelector("a.script-link"))return;let n=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`}),o=i.querySelector(".discussion-filter-button");n.appendChild(i),c.on(o,"click",s=>{h.preventEvent(s);const a=O.parseDiscussionListContainer(t);let l=_.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
							<div class="choose-list">
								...
								${a.replyUserId!=null?`<button class="choose-item" data-type="reply-user-id">${r.t("过滤回复的用户(id)")}</button>`:""}
							</div>
						...
						`});c.on(l.$shadowRoot,"click","button[data-type]",m=>{h.preventEvent(m);let u=m.target,g="",y="";u.dataset.type==="script-id"?(g=a.scriptId,y=O.$data.FILTER_SCRIPT_KEY):u.dataset.type==="user-id"?(g=a.postUserId,y=O.$data.FILTER_POST_USER_KEY):u.dataset.type==="reply-user-id"?(g=a.replyUserId,y=O.$data.FILTER_REPLY_USER_KEY):d.warn("未知data-type"),_.confirm({title:{text:r.t("提示"),position:"center"},content:{text:r.t("确定{{type}}：{{filterId}}？",{type:u.textContent,filterId:g}),html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},btn:{ok:{callback(E,L){if(h.isNull(y)){d.error("存储的key是空的");return}let S=p.getValue(y,"").trim();S!==""&&(S+=`
`),S+=g,p.setValue(y,S),E.close(),l.close(),O.filterDiscussions();}}},drag:!0,dragLimit:!0,width:"300px",height:"200px"});});});});}},Ht={init(){p.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),p.execMenuOnce("gf-scripts-filter-enable",()=>{P.init();}),p.execMenuOnce("beautifyCenterContent",()=>ht.beautifyCenterContent());},changeConsoleToTopNavigator(){d.info("迁移【控制台】到顶部导航栏"),J.addBlockCSS("#about-user"),c.ready(()=>{let t=document.querySelector("#about-user"),e=document.querySelector("#site-nav nav");if(!t){d.error("#about-user元素不存在");return}if(!e){d.error("#site-nav nav元素不存在");return}t=t.cloneNode(!0);let n=c.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${r.t("控制台")}</a>`});c.on(n,"click",i=>{h.preventEvent(i),_.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:h.getMaxZIndex(100),style:`
                    .text-content{
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(t);}),e.appendChild(n);});}},H={init(){p.execMenu("checkPage",()=>{this.checkPage();}),Dt.init(),I.isScript()&&Tt.init(),(I.isScriptList()||I.isScriptLibraryList())&&ht.init(),I.isDiscuessions()&&Ft.init(),I.isUserHome()&&Ht.init(),p.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),c.ready(()=>{v.initEnv(),Pt.init(),v.handleLocalGotoCallBack(),p.execMenuOnce("fixImageWidth",()=>{H.fixImageWidth();}),H.languageSelectorLocale(),p.execMenuOnce("optimizeImageBrowsing",()=>{H.optimizeImageBrowsing();}),p.execMenuOnce("overlayBedImageClickEvent",()=>{H.overlayBedImageClickEvent();}),I.isCodeStrict()||p.execMenuOnce("addMarkdownCopyButton",()=>{H.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(d.info("修复图片显示问题"),w(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){d.info("优化图片浏览"),w(nt("ViewerCSS")),w(`
        ...
        `);function t(n=[],i=0){let o="";n.forEach(l=>{o+=`<li><img data-src="${l}" loading="lazy"></li>`;});let s=c.createElement("ul",{innerHTML:o}),a=new gt(s,{inline:!1,url:"data-src",zIndex:h.getMaxZIndex()+100,hidden:()=>{a.destroy();}});i=i<0?0:i,a.view(i),a.zoomTo(1),a.show();}function e(n){return n.getAttribute("data-src")||n.getAttribute("src")||n.getAttribute("alt")}c.on(document,"click","img",function(n){var u;let i=n.target;if(((u=i.parentElement)==null?void 0:u.localName)==="a"&&i.hasAttribute("data-screenshots")||i.closest(".viewer-container")||i.closest(".lum-lightbox-position-helper"))return;let o=i.closest(".user-content"),s=[],a=0,l=[],m=e(i);m!=null&&m.startsWith("https://img.shields.io")||(o?(o.querySelectorAll("img").forEach(g=>{l.push(g);let y=e(g),E=g.parentElement;(E==null?void 0:E.localName)==="a"&&(y=E.getAttribute("data-href")||E.href),s.push(y);}),a=l.indexOf(i),a===-1&&(a=0)):(s.push(m),a=0),d.success(["点击浏览图片👉",s,a]),t(s,a));}),document.querySelectorAll(".user-screenshots").forEach(n=>{let i=n.querySelector("a");if(!i)return;let o=i.getAttribute("data-href")||i.getAttribute("href"),s=n.querySelector("img");s&&(s.setAttribute("data-screenshots","true"),s.setAttribute("data-src",o),i.setAttribute("href","javascript:;"),c.after(i,s),i.remove());});},overlayBedImageClickEvent(){d.info("覆盖图床图片的parentElement的a标签"),document.querySelectorAll(".user-content a>img").forEach(t=>{let e=t.parentElement,n=e.getAttribute("href");e.setAttribute("data-href",n),e.removeAttribute("href"),c.on(e,"click",()=>{f.warning(`<div style="overflow-wrap: anywhere;">${r.t("拦截跳转：")}<a href="${n}" target="_blank">${n}</a></div>`,{html:!0,zIndex:h.getMaxZIndex()+105});});});},addMarkdownCopyButton(){d.info("在Markdown右上角添加复制按钮"),w(`
        pre{
          position: relative;
        ...
        `);function t(){let e=c.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),n=e.querySelector(".js-clipboard-copy"),i=e.querySelector(".octicon-copy"),o=e.querySelector(".octicon-check-copy");return c.on(e,"click",function(){let s=e.parentElement.querySelector("code");if(!s&&e.parentElement.className.includes("prettyprinted")&&(s=e.parentElement),!s){f.error(r.t("未找到{{selector}}元素",{selector:"code"}));return}h.setClip(s.innerText||s.textContent),n.setAttribute("success","true"),i.setAttribute("aria-hidden","true"),o.removeAttribute("aria-hidden");let a=_.tooltip({target:n,content:r.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:!0});setTimeout(()=>{n.removeAttribute("success"),o.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden"),a.close();},2e3);}),e}document.querySelectorAll("pre").forEach(e=>{if(e.querySelector("div.zeroclipboard-container"))return;let i=t(),o=c.createElement("div",{className:"snippet-clipboard-content"});c.before(e,o),o.appendChild(e),o.appendChild(i);});},languageSelectorLocale(){let t=p.getValue("language-selector-locale"),e=window.location.pathname.split("/").filter(n=>!!n)[0];if(d.success("选择语言："+t),d.success("当前语言："+e),!h.isNull(t)&&t!==e){let n=null,i=b.getSwitchLanguageUrl(t);b.switchLanguage(i),d.success("新Url："+i),f.loading(r.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:e,localeLanguage:t}),{timeout:3e3,showClose:!0,onClose(){clearTimeout(n);}}),f.info(r.t("导航至：")+i,{timeout:3e3}),n=setTimeout(()=>{window.location.href=i;},3e3);}},async UIScriptList(t,e,n,i){var g,y,E;if(!v.isLogin){f.error(r.t("请先登录账号！"));return}let s=v.getUserLinkElement().href,a=(E=(y=(g=s==null?void 0:s.split("/"))==null?void 0:g.pop())==null?void 0:y.match(/([0-9]+)/))==null?void 0:E[0],l=_.loading({mask:{enable:!0},parent:i,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:!1}),m=await b.getUserInfo(a);if(l.close(),!m)return;d.info(m);let u=t==="script-list"?m.scriptList:m.scriptLibraryList;f.success(r.t("获取成功，共 {{count}} 个",{count:u.length}));for(const L of u){let S=c.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),R=S.querySelector(".w-script-info"),$=c.createElement("div",{className:"pops-panel-button",innerHTML:`
				<button type="primary" data-icon="" data-righticon="false">
				<span>${r.t("同步代码")}</span>
				</button>
				`});L.deleted&&(S.classList.add("w-script-deleted"),$.querySelector("button").setAttribute("disabled","true")),c.on($,"click",void 0,async function(){d.success(["同步",L]);let k=$.querySelector("button"),C=$.querySelector("button span"),z=c.createElement("i",{className:"pops-bottom-icon",innerHTML:_.config.iconSVG.loading},{"is-loading":!0});k.setAttribute("disabled","true"),k.setAttribute("data-icon","true"),C.innerText=r.t("同步中..."),c.before(C,z);let B=L==null?void 0:L.id,M=await b.getSourceCodeSyncFormData(B.toString());if(M){const j="script[script_sync_type_id]";if(M.has(j)){let q=M.get(j),N="";q.toString()==="1"?N=r.t("手动"):q.toString()==="2"?N=r.t("自动"):q.toString()==="3"&&(N="webhook");let F=S.querySelector(".w-script-sync-type");F?F.querySelector("p").innerText=r.t("同步方式：{{syncMode}}",{syncMode:N}):c.append(R,`
								<div class="w-script-sync-type">
									<p>${r.t("同步方式：{{syncMode}}",{syncMode:N})}
									</p>
								</div>`),await b.sourceCodeSync(L.id.toString(),M)?f.success(r.t("同步成功")):f.error(r.t("同步失败"));}else f.error(r.t("该脚本未设置同步信息"));}k.removeAttribute("disabled"),k.removeAttribute("data-icon"),C.innerText=r.t("同步代码"),z.remove();}),S.appendChild($),i.appendChild(S);}},checkPage(){d.info("检测gf页面是否正确加载，有时候会出现"),c.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let t=parseInt(G("greasyfork-check-page-time",0)),e=p.getValue("greasyfork-check-page-timeout",5),n=e*1e3;if(t&&Date.now()-t<n){f.warning(r.t("上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载",{time:h.formatTime(t,"yyyy-MM-dd HH:mm:ss"),timeout:e}));return}tt("greasyfork-check-page-time",Date.now()),window.location.reload();}});},addOperationPanelBtnWithNavigator(){d.info("添加【操作面板】按钮"),J.addBlockCSS(".sidebarred .sidebar",".sidebarred-main-content .open-sidebar"),w(`
		.sidebarred .sidebarred-main-content{
			max-width: 100%;
		}	
		`),c.ready(()=>{let t=document.querySelector("#site-nav nav"),e=document.querySelector("#site-nav .with-submenu nav"),n=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!n){d.warn("不存在右侧面板元素#script-list-option-groups");return}if(n=n.cloneNode(!0),n.classList.add("option-panel-groups"),!t){d.error("元素#site-nav nav不存在");return}let i=c.createElement("li",{className:"filter-scripts",innerHTML:`
                <a href="javascript:;">${r.t("操作面板")}</a>
                `});c.on(i,"click",o=>{h.preventEvent(o),_.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:h.getMaxZIndex(100),style:`
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(n);}),e&&e.children.length?e.appendChild(i):t.appendChild(i);});}},Gt={id:"greasy-fork-panel-config-script-list",title:r.t("脚本列表"),callback(t,e,n){H.UIScriptList("script-list",t,e,n);},forms:[]},Ot={id:"greasy-fork-panel-config-library",title:r.t("库"),callback(t,e,n){H.UIScriptList("script-library",t,e,n);},forms:[]},jt=`.w-script-list-item {\r
	padding: 10px 0;\r
...
`,Wt={id:"greasy-fork-panel-config-account",title:r.t("用户"),forms:[{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("迁移【控制台】到顶部导航栏"),"users-changeConsoleToTopNavigator",!0,void 0,r.t("将【控制台】按钮移动到顶部导航栏，节省空间"))]}]}]}]},V={data:null,oneSuccessExecMenu:null,onceExec:null,listenData:null},p={$data:{get data(){return V.data==null&&(V.data=new h.Dictionary),V.data},get oneSuccessExecMenu(){return V.oneSuccessExecMenu==null&&(V.oneSuccessExecMenu=new h.Dictionary),V.oneSuccessExecMenu},get onceExec(){return V.onceExec==null&&(V.onceExec=new h.Dictionary),V.onceExec},get scriptName(){return at},key:D,attributeKeyName:K,attributeDefaultValueName:Y},$listener:{get listenData(){return V.listenData==null&&(V.listenData=new h.Dictionary),V.listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},initExtensionsMenu(){T.top===T.self&&ut.add([{key:"show_pops_panel_setting",text:r.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(t){return t},callback:()=>{this.showPanel();}}]);},initPanelDefaultValue(){let t=this;function e(o){if(!o.attributes)return;let s=o.attributes[K],a=o.attributes[Y];if(s==null){d.warn(["请先配置键",o]);return}t.$data.data.has(s)&&d.warn("请检查该key(已存在): "+s),t.$data.data.set(s,a);}function n(o){for(let s=0;s<o.length;s++){let a=o[s];e(a);let l=a.forms;l&&Array.isArray(l)&&n(l);}}let i=this.getPanelContentConfig();for(let o=0;o<i.length;o++){let s=i[o];if(!s.forms)continue;let a=s.forms;a&&Array.isArray(a)&&n(a);}},setValue(t,e){let n=G(D,{}),i=n[t];n[t]=e,tt(D,n),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,i,e);},getValue(t,e){let i=G(D,{})[t];return i??(this.$data.data.has(t)?this.$data.data.get(t):e)},deleteValue(t){let e=G(D,{}),n=e[t];Reflect.deleteProperty(e,t),tt(D,e),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,n,void 0);},addValueChangeListener(t,e,n){let i=Math.random();return this.$listener.listenData.set(t,{id:i,key:t,callback:e}),n&&n.immediate&&e(t,this.getValue(t),this.getValue(t)),i},removeValueChangeListener(t){let e=null;for(const[n,i]of this.$listener.listenData.entries())if(i.id===t){e=n;break}typeof e=="string"?this.$listener.listenData.delete(e):console.warn("没有找到对应的监听器");},hasKey(t){let e=G(D,{});return t in e},execMenu(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){d.warn(`${t} 键不存在`);return}let n=p.getValue(t);n&&e(n);},execMenuOnce(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){d.warn(`${t} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(t))return;this.$data.oneSuccessExecMenu.set(t,1);let n=[],i=a=>{let l=p.getValue(t);o(l,a);},o=(a,l)=>{let m=[];if(a){let u=l??e(a,i);u instanceof HTMLStyleElement?m=[u]:Array.isArray(u)&&(m=[...u.filter(g=>g!=null&&g instanceof HTMLStyleElement)]);}for(let u=0;u<n.length;u++)n[u].remove(),n.splice(u,1),u--;n=[...m];};this.addValueChangeListener(t,(a,l,m)=>{o(m);});let s=p.getValue(t);s&&o(s);},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(t)||(e(),this.$data.onceExec.set(t,1));},showPanel(){_.panel({title:{text:r.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:at}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0,style:`
			${jt}
			`});},isMobile(){return window.outerWidth<550},getWidth(){return window.outerWidth<550?"92dvw":"550px"},getHeight(){return window.outerHeight>450?"80dvh":"450px"},getPanelContentConfig(){return [At,Ut,_t,Wt,Gt,Ot]}};p.init();H.init();

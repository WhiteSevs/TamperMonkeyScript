    ...
    showAnswerContent() {
        utils.waitNode("div.question-swiper").then(async () => {
            await utils.waitVueByInterval(
                function () {
                    return document.querySelector("div.question-swiper") as HTMLDivElement;
                },
                function (__vue__) {
            ...
            CommonUtil.getVue(document.querySelector("div.question-swiper") as any)?.$watch(
            ...
            CommonUtil.getVue(document.querySelector("div.question-swiper") as any)?.$parent.$watch(
            ...
            CommonUtil.getVue(document.querySelector("div.question-swiper") as any)?.$parent.$watch(
                ...
                function () {
                    log.success("滑动改变题目");
                    CommonUtil.getVue(document.querySelector("div.question-swiper") as any)!.isShowAnswer = true;
                    CommonUtil.getVue(document.querySelector("div.question-swiper") as any)!.isShowAnswerContent = true;
                },
                {
                    deep: true,
                    immediate: true,
            ...
            /* 阻止调用App Scheme */
            CommonUtil.getVue(document.querySelector("div.question-swiper") as any)!.$parent.openBgkApp = function () {
                log.success(["openBgkApp：阻止调用App Scheme", arguments]);
            };
            CommonUtil.getVue(document.querySelector("div.question-swiper") as any)!.openApp =
                function () {
                    log.success(["openApp：阻止调用App Scheme", arguments]);
                };
            CommonUtil.getVue(document.querySelector("div.question-swiper") as any)!.$parent.goToApp = function () {

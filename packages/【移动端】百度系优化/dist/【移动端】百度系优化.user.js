...
// @require      https://update.greasyfork.org/scripts/462234/1380485/Message.js
...
(function (ElementPlus, vue, vueRouter, iconsVue) {
  ...
  const MountVue = async function(targetApp, router) {
...
`;
  ...
  **/
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-7878365f"), n = n(), vue.popScopeId(), n);
  ...
  const Home = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-7878365f"]]);
  ...
  const About = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c9511d44"]]);
  const _sfc_main$2 = {};
  ...
  const Follow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-82b5d2d1"]]);
  ...
  const Fans = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-416d1c10"]]);
  const TiebaRouter = {
    router: null,
    init() {
  ...
  const TiebaHome = {
    ...
    init() {
      TiebaRouter.init();
      MountVue(_sfc_main$z, TiebaRouter.router);
      _GM_addStyle(`
        #${VUE_ELE_NAME_ID}{
            z-index: 1000;
        }

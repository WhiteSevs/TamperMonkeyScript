...
`,I={init(){a(se),i.execMenu("csdn-hua-wei-cloud-shieldCloudDeveloperTaskChallengeEvent",()=>{this.shieldCloudDeveloperTaskChallengeEvent();}),i.execMenu("csdn-hua-wei-cloud-autoExpandContent",()=>{this.autoExpandContent();}),i.execMenu("csdn-hua-wei-cloud-shieldLeftFloatingButton",()=>{this.shieldLeftFloatingButton();}),i.execMenu("csdn-hua-wei-cloud-blockRightColumn",()=>{this.blockRightColumn();}),i.execMenu("csdn-hua-wei-cloud-blockRecommendedContentAtTheBottom",()=>{this.blockRecommendedContentAtTheBottom();}),i.execMenu("csdn-hua-wei-cloud-shieldTheBottomForMoreRecommendations",()=>{this.shieldTheBottomForMoreRecommendations();});},autoExpandContent(){n.success("自动展开全文"),a(`
        ...
        `);},shieldCloudDeveloperTaskChallengeEvent(){new d.GM_Cookie().set({name:"show_join_group_index",value:1}),n.success("屏蔽云开发者任务挑战活动");},shieldLeftFloatingButton(){n.success("屏蔽左侧悬浮按钮，包括当前阅读量、点赞按钮、评论按钮、分享按钮"),a(`
        div.toolbar-wrapper.article-interact-bar{
          display: none !important;
        }`);},blockRightColumn(){n.success("屏蔽右侧栏，包括相关产品-活动日历-运营活动-热门标签"),a(`
        div.page-home-right.dp-aside-right{
          display: none !important;
        }
        `);},blockRecommendedContentAtTheBottom(){n.success("屏蔽底部推荐内容"),a(`
        div.recommend-card-box{
          display: none !important;
        }`);},shieldTheBottomForMoreRecommendations(){n.success("屏蔽底部更多推荐"),a(`
        div.more-article{
          display: none !important;
...
`;function S(e=""){d.waitNodeList(e).then(t=>{t.forEach(o=>o.remove());});}const ve={init(){this.addCSS(),i.execMenu("m-csdn-blog-shieldTopToolbar",()=>{this.shieldTopToolbar();}),i.execMenu("m-csdn-blog-notLimitCodePreMaxHeight",()=>{this.notLimitCodePreMaxHeight();}),i.execMenu("m-csdn-blog-notLimitCommentMaxHeight",()=>{this.notLimitCommentMaxHeight();}),i.execMenu("m-csdn-blog-allowSelectText",()=>{this.allowSelectText();}),i.execMenu("m-csdn-blog-autoExpandContent",()=>{this.autoExpandContent();}),i.execMenu("m-csdn-blog-blockBottomArticle",()=>{this.blockBottomArticle();}),i.execMenu("m-csdn-blog-blockComment",()=>{this.blockComment();}),v.ready(()=>{i.execMenu("m-csdn-blog-removeAds",()=>{this.removeAds();}),i.execMenu("m-csdn-blog-refactoringRecommendation",()=>{this.refactoringRecommendation();}),i.execMenu("m-csdn-blog-unBlockCopy",()=>{W.unBlockCopy();});});},addCSS(){a(we),a(Ce);},shieldTopToolbar(){n.success("屏蔽顶部Toolbar"),a(`
        ...
        `);},refactoringRecommendation(){function e(){n.success("重构底部推荐"),document.querySelectorAll(".container-fluid").forEach(o=>{var y,D;let l="",s="",c="",f="",p=!1,g=!1;if(o.hasAttribute("data-url")){if(l=o.getAttribute("data-url"),s=(y=o.querySelector(".recommend_title div.left"))==null?void 0:y.innerHTML,!o.querySelector(".text"))return;c=(D=o.querySelector(".text"))==null?void 0:D.innerHTML,o.querySelectorAll(".recommend-img").length&&o.querySelectorAll(".recommend-img").forEach(q=>{f+=q.innerHTML;});}else n.info("节点上无data-url"),l=o.querySelector("a[data-type]").getAttribute("href"),s=o.querySelector(".recommend_title div.left").innerHTML,c=o.querySelector(".text").innerHTML;var h=new URL(l);h.host==="download.csdn.net"||h.host==="www.iteye.com"&&h.pathname.match(/^\/resource/gi)?(n.info("该链接为csdn资源下载"),p=!0,s='<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>'+s):h.origin.match(/edu.csdn.net/gi)&&(g=!0,n.info("该链接为csdn学院下载"),s='<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>'+s),o.setAttribute("class","GM-csdn-dl"),o.setAttribute("data-url",l),o.innerHTML=`<div class="GM-csdn-title"><div class="left">${s}</div></div><div class="GM-csdn-content">${c}</div><div class="GM-csdn-img">${f}</div>`,o.addEventListener("click",function(){i.getValue("m-csdn-blog-openNewTab")?window.open(l,"_blank"):window.location.href=l;}),(p||g)&&i.getValue("m-csdn-blog-removeResourceArticle")&&o.remove();});}let t=new d.LockFunction(e,50);d.waitNode("#recommend").then(o=>{n.success("重构底部推荐"),t.run(),d.mutationObserver(o,{callback:()=>{t.run();},config:{childList:!0,subtree:!0,attributes:!0}});});},blockBottomArticle(){n.success("屏蔽底部文章"),a("#recommend{display:none !important;}");},blockComment(){n.success("屏蔽评论"),a("#comment{display:none !important;}");},removeAds(){n.info("去除广告"),S(".passport-login-container"),S(".btn_open_app_prompt_box.detail-open-removed"),S(".add-firstAd"),S("div.feed-Sign-weixin"),S("div.ios-shadowbox");},notLimitCodePreMaxHeight(){n.success("不限制代码块最大高度"),a(`
        pre{
            max-height: unset !important;
        }
        `);},notLimitCommentMaxHeight(){n.success("不限制评论区最大高度"),a(`
        #comment{
          max-height: none !important;
        }
      `);},allowSelectText(){n.success("允许选择文字"),a(`
        #content_views,
        #content_views pre,
        #content_views pre code{
        ...
        `);},autoExpandContent(){n.success("自动展开内容"),a(`
...
`,Se={init(){a(ye),i.execMenu("m-csdn-wenku-shieldBottomToolbar",()=>{this.shieldBottomToolbar();});},shieldBottomToolbar(){a(`
        ...
        `);}},G={init(){m.isLink()?(n.info("Router: 中转链接"),ge.init()):m.isHuaWeiCloudBlog()?(n.info("Router: 华为云联盟"),xe.init()):m.isBlog()?(n.info("Router: 博客"),ve.init()):m.isWenKu()?(n.info("Router: 文库"),Se.init()):n.error("暂未适配，请反馈开发者："+globalThis.location.href);}};i.init();let j=d.isPhone(),M="change_env_set",x=C(M);H.add({key:M,text:`⚙ 自动: ${j?"移动端":"PC端"}`,autoReload:!1,isStoreValue:!1,showText(e){return x==null?e:e+` 手动: ${x==1?"移动端":x==2?"PC端":"未知"}`},callback:()=>{let e=[0,1,2],t=window.prompt(`请输入当前脚本环境判定

自动判断: 0
移动端: 1
PC端: 2`,"0");if(!t)return;let o=parseInt(t);if(isNaN(o)){w.error("输入的不是规范的数字");return}if(!e.includes(o)){w.error("输入的值必须是0或1或2");return}o==0?$(M):k(M,o);}});x!=null?(n.info(`手动判定为${x===1?"移动端":"PC端"}`),x==1?G.init():x==2?A.init():(w.error("意外，手动判定的值不在范围内"),$(M))):j?(n.info("自动判定为移动端"),G.init()):(n.info("自动判定为PC端"),A.init());

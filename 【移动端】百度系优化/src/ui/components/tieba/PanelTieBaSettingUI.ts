import { TieBaApi } from "@/business/tieba/api/TieBaApi";
import { Qmsg, utils } from "@/env";
import { BaiduRouter } from "@/router";
import { UIButton } from "@/ui/common-components/ui-button";
            ...
            forms: [
                UIButton(
                    ...
                    async () => {
                        ...
                        Qmsg.info("正在获取所有关注吧");
                        let likeForumList =
                            await TieBaApi.getUserAllLikeForum();
                        if (!likeForumList) {
                            return;
                        }

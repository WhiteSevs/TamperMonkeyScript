    ...
    <div class="posts-container">
        ...
        <div class="posts-container-item" v-for="postItem in postsInfoList" @click="handlePostItemClick(postItem)">
                ...
                <el-row style="align-items: center">
                    ...
                    <div class="posts-item-right-user-info">
                        ...
                        <div class="posts-item-user-other-info">
                            <el-text type="info" size="small">{{ postItem.forumName }}吧 {{ postItem.createTime
                                }}</el-text>
                        </div>
                    </div>
                </el-row>
            ...
            <div class="posts-item-media-container" v-if="postItem.mediaList.length > 0">
                <el-row @click.stop>
                    <el-image style="width: 100px; height: 100px" :src="media" :zoom-rate="1" :max-scale="7"
                        :min-scale="0.2" :preview-src-list="postItem.mediaList" :initial-index="index" fit="cover"
                        v-for="(media, index) in postItem.mediaList" />
                </el-row>
            </div>
            <div class="posts-item-forum">
                <!--<el-button plain>Plain</el-button>-->
                <el-button :icon="ChromeFilled" :size="'small'" style="color: #614FC0;border-color: #614FC0;" plain
                    round @click="handlePostForumButtonClick(postItem)" @click.stop>{{
                        postItem.forumName
                    }}吧</el-button>
            </div>
            <div class="posts-item-footer">
                <el-row justify="space-between">
                    <el-col :span="6" class="posts-item-footer-icon-container">
                        <el-icon>
                            <svg t="1714663858490" viewBox="0 0 1024 1024" version="1.1"
                    ...
                    <el-col :span="6" class="posts-item-footer-icon-container">
                        <el-icon>
                            <svg t="1714663974353" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <el-col :span="6" class="posts-item-footer-icon-container">
                        <el-icon>
                            <svg t="1714664014034" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg">
                                <path

                    ...
                    <div class="user-item-row">
                        <div class="user-item-row-left">
                            ...
                            <div class="user-item-row-center">
                                <div class="user-info">
                                    <el-text class="user-name" truncated>{{ followInfo.userName
                                        }}</el-text>
                                    <el-text class="user-sign-text" :size="'small'" truncated>来自贴吧关注
                                        暂未实现获取签名信息接口</el-text>
                                </div>
                            </div>
                        </div>
                        <div class="user-item-row-right">
                            <el-button type="info" size="small" plain color="#626aef" round
                                class="user-follow-btn">关注</el-button>
                        </div>
                    </div>
                </div>

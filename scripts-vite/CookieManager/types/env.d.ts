...
declare interface Window {
  cookieStore: {
    ...
    delete(options: { name: string; domain?: string; path?: string; partitioned?: boolean }): Promise<undefined>;
    ...
    getAll(options?: { name: string; url?: string }): Promise<CookieStoreData[]>;
    ...
    addChangeListener(eventName: "change", listener: (event: Event) => void): void;
  };
}

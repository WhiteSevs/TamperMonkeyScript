...
(function (y, I, H, ne, se) {
	'use strict';

	var ce=typeof GM<"u"?GM:void 0,qe=typeof GM_cookie<"u"?GM_cookie:void 0,Me=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Ce=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,he=typeof GM_getValue<"u"?GM_getValue:void 0,Z=typeof GM_info<"u"?GM_info:void 0,Ne=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,ie=typeof GM_setValue<"u"?GM_setValue:void 0,Ie=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Oe=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,G=typeof unsafeWindow<"u"?unsafeWindow:void 0,Ge=window;const Re="GM_Panel",Ee="data-init",j="data-key",K="data-default-value",Ue="data-init-more-value",D="data-storage-api",F={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},q={setting:{get width(){return F.width<550?"88vw":F.width<700?"550px":"700px"},get height(){return F.height<450?"70vh":F.height<550?"450px":"550px"}},settingMiddle:{get width(){return F.width<350?"88vw":"350px"},get height(){return F.height<450?"88vh":"450px"}},info:{get width(){return F.width<350?"88vw":"350px"},get height(){return F.height<250?"88vh":"250px"}}};class Pe{storageKey;listenerData;constructor(e){if(typeof e=="string"){let i=e.trim();if(i=="")throw new Error("key参数不能为空字符串");this.storageKey=i;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new H.Dictionary;}getLocalValue(){let e=he(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){ie(this.storageKey,e);}set(e,i){let a=this.get(e),o=this.getLocalValue();Reflect.set(o,e,i),this.setLocalValue(o),this.triggerValueChangeListener(e,a,i);}get(e,i){let a=this.getLocalValue();return Reflect.get(a,e)??i}getAll(){return this.getLocalValue()}delete(e){let i=this.get(e),a=this.getLocalValue();Reflect.deleteProperty(a,e),this.setLocalValue(a),this.triggerValueChangeListener(e,i,void 0);}has(e){let i=this.getLocalValue();return Reflect.has(i,e)}keys(){let e=this.getLocalValue();return Reflect.ownKeys(e)}values(){let e=this.getLocalValue();return Reflect.ownKeys(e).map(i=>Reflect.get(e,i))}clear(){Me(this.storageKey);}addValueChangeListener(e,i){let a=Math.random(),o=this.listenerData.get(e)||[];return o.push({id:a,key:e,callback:i}),this.listenerData.set(e,o),a}removeValueChangeListener(e){let i=false;for(const[a,o]of this.listenerData.entries()){for(let l=0;l<o.length;l++){const r=o[l];(typeof e=="string"&&r.key===e||typeof e=="number"&&r.id===e)&&(o.splice(l,1),l--,i=true);}this.listenerData.set(a,o);}return i}triggerValueChangeListener(e,i,a){if(!this.listenerData.has(e))return;let o=this.listenerData.get(e);for(let l=0;l<o.length;l++){const r=o[l];if(typeof r.callback=="function"){let n=this.get(e),s,p;typeof i<"u"&&arguments.length>=2?p=i:p=n,typeof a<"u"&&arguments.length>2?s=a:s=n,r.callback(e,p,s);}}}}const z=new Pe(Re),Fe={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{E.showPanel(ae.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){E.isTopWindow()&&ge.add(this.$data.menuOption);},addMenuOption(t){Array.isArray(t)||(t=[t]),this.$data.menuOption.push(...t);},updateMenuOption(t){Array.isArray(t)||(t=[t]),t.forEach(e=>{let i=this.$data.menuOption.findIndex(a=>a.key===e.key);i!==-1&&(this.$data.menuOption[i]=e);});},getMenuOption(t=0){return this.$data.menuOption[t]},deleteMenuOption(t=0){this.$data.menuOption.splice(t,1);}},Ve={waitRemove(...t){t.forEach(e=>{typeof e=="string"&&m.waitNodeList(e).then(i=>{i.forEach(a=>a.remove());});});},createBlockCSSNode(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(i=>{Array.isArray(i)?e=e.concat(i):e.push(i);}),I.createElement("style",{type:"text/css",innerHTML:`${e.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof Ce=="function"?Ce(t.keyName):null;typeof e=="string"&&e?$e(e):Ve.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,I.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(i=>{e.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let i=[document.documentElement,document.body].concat(...t||[]);return i.forEach(a=>{a.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){i.forEach(a=>{a.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(a){navigator.clipboard.readText().then(o=>{a(o);}).catch(o=>{_.error("读取剪贴板内容失败👉",o),a("");});}function e(a){navigator.permissions.query({name:"clipboard-read"}).then(o=>{t(a);}).catch(o=>{_.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),t(a);});}function i(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(a=>{if(!i()){a("");return}document.hasFocus()?e(a):window.addEventListener("focus",()=>{e(a);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,i=5e3){let a,o=i-e,l=e,r=async n=>{let s=await t(n);if(typeof s=="boolean"&&!s||n){m.workerClearTimeout(a);return}if(l+=e,l>o){r(true);return}a=m.workerSetTimeout(()=>{r(false);},e);};r(false);},findParentNode(t,e,i){if(i){let a=I.closest(t,i);if(a)return a.querySelector(e)}else return I.matches(t,e)?t:I.closest(t,e)}},E={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new m.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new m.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new m.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new m.Dictionary),this.__onceExecData},get scriptName(){return _e},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:Re,attributeKeyName:j,attributeDefaultValueName:K},init(){this.initContentDefaultValue(),Fe.init();},isTopWindow(){return G.top===G.self},initContentDefaultValue(){const t=a=>{if(!a.attributes||a.type==="button"||a.type==="forms"||a.type==="deepMenu")return;let o=a.attributes[Ee];if(typeof o=="function"){let s=o();if(typeof s=="boolean"&&!s)return}let l=new Map,r=a.attributes[j];if(r!=null){const s=a.attributes[K];l.set(r,s);}let n=a.attributes[Ue];if(typeof n=="object"&&n&&Object.keys(n).forEach(s=>{l.set(s,n[s]);}),!l.size){_.warn(["请先配置键",a]);return}if(a.type==="switch"){let s=typeof a.disabled=="function"?a.disabled():a.disabled;typeof s=="boolean"&&s&&this.$data.contentConfigInitDisabledKeys.push(...l.keys());}for(const[s,p]of l.entries())this.setDefaultValue(s,p);},e=a=>{for(let o=0;o<a.length;o++){let l=a[o];t(l);let r=l.forms;r&&Array.isArray(r)&&e(r);}},i=[...ae.getAllContentConfig()];for(let a=0;a<i.length;a++){let o=i[a];if(!o.forms)continue;const l=o.forms;l&&Array.isArray(l)&&e(l);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(t,e){this.$data.contentConfigInitDefaultValue.has(t)&&_.warn("请检查该key(已存在): "+t),this.$data.contentConfigInitDefaultValue.set(t,e);},setValue(t,e){z.set(t,e);},getValue(t,e){let i=z.get(t);return i??(this.$data.contentConfigInitDefaultValue.has(t)?this.$data.contentConfigInitDefaultValue.get(t):e)},deleteValue(t){z.delete(t);},hasKey(t){return z.has(t)},addValueChangeListener(t,e){return z.addValueChangeListener(t,(a,o,l)=>{e(t,l,o);})},removeValueChangeListener(t){z.removeValueChangeListener(t);},triggerMenuValueChange(t,e,i){z.triggerValueChangeListener(t,i,e);},exec(t,e,i,a=true){const o=this;let l;typeof t=="string"||Array.isArray(t)?l=()=>t:l=t;let r=false,n=l(),s=[];Array.isArray(n)?(r=true,s=n):s.push(n);let p=s.find(b=>!this.$data.contentConfigInitDefaultValue.has(b));if(p){_.warn(`${p} 键不存在`);return}let c=JSON.stringify(s);if(a&&this.$data.onceExecMenuData.has(c))return this.$data.onceExecMenuData.get(c);let f=[],h=[],g=(b,C)=>{let S=[];Array.isArray(C)||(C=[C]),C.forEach(A=>{if(A!=null&&A instanceof HTMLStyleElement){S.push(A);return}}),f=f.concat(S);},d=b=>this.getValue(b),x=()=>{for(let b=0;b<f.length;b++)f[b].remove(),f.splice(b,1),b--;},k=()=>{let b=false;return typeof i=="function"?b=i(s):b=s.every(C=>d(C)),b},w=b=>{let C=k(),S=[];if(C){let A=s.map(R=>this.getValue(R)),M=e({value:r?A:A[0],addStyleElement:(...R)=>g(true,...R)});Array.isArray(M)||(M=[M]),M.forEach(R=>{if(R!=null&&R instanceof HTMLStyleElement){S.push(R);return}});}x(),f=[...S];};a&&s.forEach(b=>{let C=this.addValueChangeListener(b,(S,A,M)=>{w();});h.push(C);}),w();let v={reload(){w();},clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),a&&o.$data.onceExecMenuData.delete(c);},clearStoreStyleElements:()=>x(),removeValueChangeListener:()=>{h.forEach(b=>{this.removeValueChangeListener(b);});}};return this.$data.onceExecMenuData.set(c,v),v},execMenu(t,e,i=false,a=false){return this.exec(t,o=>e(o),o=>o.every(r=>{let n=!!this.getValue(r);return E.$data.contentConfigInitDisabledKeys.includes(r)&&(n=false,_.warn(`.execMenu${a?"Once":""} ${r} 被禁用`)),i&&(n=!n),n}),a)},execMenuOnce(t,e,i=false,a=false){const o=this.execMenu(t,e,i,true);if(a&&o){const l=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(t),this.addUrlChangeWithExecMenuOnceListener(t,l);const r=o.clear;o.clear=()=>{r(),this.removeUrlChangeWithExecMenuOnceListener(t);};}return o},deleteExecMenuOnce(t){return t=this.transformKey(t),this.$data.onceExecMenuData.delete(t),this.$data.urlChangeReloadMenuExecOnce.delete(t),z.removeValueChangeListener(t)},onceExec(t,e){if(t=this.transformKey(t),typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},deleteOnceExec(t){t=this.transformKey(t),this.$data.onceExecData.delete(t);},addUrlChangeWithExecMenuOnceListener(t,e){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.set(t,e);},removeUrlChangeWithExecMenuOnceListener(t){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.delete(t);},triggerUrlChangeWithExecMenuOnceEvent(t){this.$data.urlChangeReloadMenuExecOnce.forEach((e,i)=>{e(t);});},showPanel(t,e=`${_e}-设置`,i=false,a=false){this.$data.$panel=null,this.$data.panelContent=[];let o=t.findIndex(r=>(typeof r.isBottom=="function"?r.isBottom():!!r.isBottom)&&r.id==="script-version")!==-1;!i&&!o&&t.push(...ae.getDefaultBottomContentConfig());let l=$.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(r,n)=>{r.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(r,n)=>{r(),this.$data.$panel=null;}},width:q.setting.width,height:q.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=l,this.$data.panelContent=t,a||this.registerConfigSearch({$panel:l,content:t});},registerConfigSearch(t){const{$panel:e,content:i}=t;let a=async(c,f)=>{if(c==null)return;let h=await f(c);return h&&typeof h.isFind=="boolean"&&h.isFind?h.data:await a(h.data,f)},o=(c,f)=>{const h=new IntersectionObserver(g=>{g.forEach(d=>{d.isIntersecting&&(f?.(),h.disconnect());});},{root:null,threshold:1});h.observe(c),c.scrollIntoView({behavior:"smooth",block:"center"});},l=c=>{const f="pops-flashing";u.animationend(c,()=>{c.classList.remove(f);}),c.classList.add(f);},r=(c,f)=>{m.preventEvent(c);let h=$.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});h.$shadowRoot.querySelector(".search-wrapper");let g=h.$shadowRoot.querySelector(".search-config-text"),d=h.$shadowRoot.querySelector(".search-result-wrapper");g.focus();let x=()=>{u.empty(d);},k=v=>{const b=m.queryProperty(v,S=>S?.next?{isFind:false,data:S.next}:{isFind:true,data:S});let C=u.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return u.on(C,"click",S=>{let M=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[v.index];if(!M){y.error(`左侧项下标${v.index}不存在`);return}M.scrollIntoView({behavior:"smooth",block:"center"}),M.click(),a(v.next,async R=>{if(R?.next){let L=await m.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(T=>{const O=Reflect.get(T,"__formConfig__");return typeof O=="object"&&O!=null&&O.text===R.name}),2500);if(L)L.click();else return y.error("未找到对应的二级菜单"),{isFind:true,data:R};return {isFind:false,data:R.next}}else {let L=await m.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(T=>Reflect.get(T,"__formConfig__")===R.matchedData?.formConfig),2500);if(L){o(L);let T=L.closest(".pops-panel-forms-fold[data-fold-enable]");T&&(T.querySelector(".pops-panel-forms-fold-container").click(),await m.sleep(500)),o(L,()=>{l(L);});}else y.error("未找到对应的菜单项");return {isFind:true,data:R}}});}),C},w=v=>{const b=new RegExp(v,"i"),C=[],S=(M,R)=>{for(let L=0;L<M.length;L++){const T=M[L];let O=T.forms;if(O&&Array.isArray(O)){const Y=m.deepClone(R);if(T.type==="deepMenu"){const ee=m.queryProperty(Y,W=>W?.next?{isFind:false,data:W.next}:{isFind:true,data:W});ee.next={name:T.text};}S(O,Y);}else {let Y=Reflect.get(T,"text"),ee=Reflect.get(T,"description");const W=[Y,ee];let ke=W.findIndex(J=>{if(typeof J=="string")return J.match(b)});if(ke!==-1){const J=m.deepClone(R),ve=m.queryProperty(J,P=>P?.next?{isFind:false,data:P.next}:{isFind:true,data:P});ve.next={name:Y,matchedData:{path:"",formConfig:T,matchedText:W[ke],description:ee}};const be=[];m.queryProperty(J,P=>{const le=P?.name;return typeof le=="string"&&le.trim()!==""&&be.push(le),P?.next?{isFind:false,data:P.next}:{isFind:true,data:P}});const Le=be.join(Ve.escapeHtml(" - "));ve.next.matchedData.path=Le,C.push(J);}}}};for(let M=0;M<i.length;M++){const R=i[M];if(!R.forms||R.isBottom&&R.id==="script-version")continue;const L=R.forms;if(L&&Array.isArray(L)){let T=R.title;typeof T=="function"&&(T=T()),S(L,{index:M,name:T});}}let A=document.createDocumentFragment();for(const M of C){let R=k(M);A.appendChild(R);}x(),d.append(A);};u.on(g,"input",m.debounce(v=>{m.preventEvent(v);let b=u.val(g).trim();if(b===""){x();return}w(b);},200));},n=null,s=false,p;u.on(e.$shadowRoot,"dblclick","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",r),u.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(c,f)=>{clearTimeout(p),p=void 0,s&&n===f?(s=false,n=null,r(c)):(p=setTimeout(()=>{s=false;},200),s=true,n=f);},{capture:true}),e.$shadowRoot.appendChild(u.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
            ...
            `}).$shadowRoot.querySelector(".pops-confirm-content"),n=$.config.PanelHandlerComponents(),s=n.createSectionContainerItem_input(te("name",()=>o.name,w=>o.name=w,i)),p=n.createSectionContainerItem_textarea(ze("value",()=>o.value,w=>o.value=w)),c=n.createSectionContainerItem_input(te("domain",()=>o.domain,w=>o.domain=w)),f=n.createSectionContainerItem_input(te("path",()=>o.path,w=>o.path=w)),h;o.session?h=n.createSectionContainerItem_input(te("expires",()=>"会话",w=>{},true)):h=n.createSectionContainerItem_own({type:"own",getLiElementCallBack:function(w){let v=u.createElement("li",{innerHTML:`
						...
						`}),b=v.querySelector("#cookie-item-property-expires");return b.valueAsNumber=o.expirationDate,u.on(b,["change","input","propertychange"],C=>{m.preventEvent(C),o.expirationDate=b.valueAsNumber;}),v}});let g=n.createSectionContainerItem_select(pe("httpOnly",[{text:"true",value:true},{text:"false",value:false}],()=>o.httpOnly,w=>o.httpOnly=w)),d=n.createSectionContainerItem_select(pe("secure",[{text:"true",value:true},{text:"false",value:false}],()=>o.secure,w=>o.secure=w)),x=[{text:"no_restriction",value:"no_restriction"},{text:"lax",value:"lax"},{text:"strict",value:"strict"},{text:"unspecified",value:"unspecified"}];V.cookieManagerApiName==="cookieStore"&&(x=[{text:"lax",value:"lax"},{text:"strict",value:"strict"},{text:"none",value:"none"}]);let k=n.createSectionContainerItem_select(pe("sameSite",x,()=>o.sameSite,w=>o.sameSite=w));u.append(r,[s,p]),V.cookieManagerApiName==="GM_cookie"||V.cookieManagerApiName==="GM.cookie"?u.append(r,[c,f,h,g,d,k]):V.cookieManagerApiName==="cookieStore"&&u.append(r,[c,f,h,k]);},validCookieInfo(t){return t.name==null||t.name==""?(y.error("name不能为空"),false):t.domain==null||t.domain==""?(y.error("domain不能为空"),false):t.path==null||t.path==""?(y.error("path不能为空"),false):true}},X=function(t,e,i,a,o,l,r){let n=[];typeof a=="function"?n=a():n=a;let s={text:t,type:"select",description:l,attributes:{},props:{},getValue(){return this.props[D].get(e,i)},callback(p,c,f){let h=c;if(_.info(`选择：${f}`),typeof o=="function"&&o(p,h,f))return;this.props[D].set(e,h),typeof r=="function"&&r(p,h,f);},data:n};return Reflect.set(s.attributes,j,e),Reflect.set(s.attributes,K,i),re.initComponentsStorageApi("select",s,{get(p,c){return E.getValue(p,c)},set(p,c){E.setValue(p,c);}}),s},ue=function(t,e,i,a,o,l="",r,n,s,p){let c={text:t,type:"input",isNumber:false,isPassword:false,attributes:{},props:{},description:a,afterAddToUListCallBack:s,getValue(){return this.props[D].get(e,i)},callback(f,h,g){this.props[D].set(e,h);},placeholder:l};return Reflect.set(c.attributes,j,e),Reflect.set(c.attributes,K,i),re.initComponentsStorageApi("input",c,{get(f,h){return E.getValue(f,h)},set(f,h){E.setValue(f,h);}}),c},Be=function(t,e,i,a,o,l="",r,n){let s={text:t,type:"textarea",attributes:{},props:{},description:a,placeholder:l,disabled:r,getValue(){let c=this.props[D].get(e,i);return Array.isArray(c)?c.join(`
`):c},callback(p,c){this.props[D].set(e,c);}};return Reflect.set(s.attributes,j,e),Reflect.set(s.attributes,K,i),re.initComponentsStorageApi("switch",s,{get(p,c){return E.getValue(p,c)},set(p,c){E.setValue(p,c);}}),s};class He{option;constructor(e){this.option=e;}async showView(){let e=$.confirm({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `}),i=e.$shadowRoot.querySelector(".filter-container"),a=document.createDocumentFragment();this.option.filterOption.forEach(o=>{let l=u.createElement("button",{innerText:o.name},{type:"button"}),r=async()=>{(await this.option.getAllRuleInfo()).forEach(async s=>{await o.filterCallBack(s.data)?u.show(s.$el,false):u.hide(s.$el,false);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};u.on(l,"click",async n=>{m.preventEvent(n),!(typeof o.callback=="function"&&!await o.callback(n,r))&&await r();}),a.appendChild(l);}),i.appendChild(a);}}class Ke{option;constructor(e){this.option=e;}async showView(e){let i=$.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    <div class="rule-view-container">
                    </div>
                    `,html:true},btn:{merge:true,reverse:false,position:"space-between",ok:{enable:this.option?.bottomControls?.add?.enable||true,type:"primary",text:"添加",callback:async l=>{this.showEditView(false,await this.option.getAddData(),i.$shadowRoot);}},close:{enable:true,callback(l){i.close();}},cancel:{enable:this.option?.bottomControls?.filter?.enable||false,type:"default",text:"过滤",callback:async(l,r)=>{if(typeof this.option?.bottomControls?.filter?.callback=="function"){let p=await this.option.bottomControls.filter.callback();if(typeof p=="boolean"&&!p)return}let n=()=>Array.from(i.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),s=r.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");if(u.text(s).includes("取消")){let p=await this.option?.bottomControls?.filter?.cancelFilterCallback?.({$button:s,getAllRuleElement:n});if(typeof p=="boolean"&&!p)return;n().forEach(c=>{u.show(c,false);}),u.text(s,"过滤");}else new je({title:this.option.bottomControls?.filter?.title??"过滤规则",filterOption:this.option.bottomControls?.filter?.option||[],execFilterCallBack:async()=>{u.text(s,"取消过滤"),await this.option.bottomControls?.filter?.execFilterCallBack?.();},getAllRuleInfo:()=>n().map(c=>({data:this.parseRuleItemElement(c).data,$el:c}))}).showView();}},other:{enable:this.option?.bottomControls?.clear?.enable||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:l=>{let r=$.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async n=>{if(_.success("清空所有"),typeof this.option?.bottomControls?.clear?.callback=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){y.error("清理失败");return}else y.success("清理成功");await this.updateDeleteAllBtnText(i.$shadowRoot),this.clearContent(i.$shadowRoot),r.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${$.config.cssText.panelCSS}
...
`));}});},getMatchedRuleList(t=window.location.href){let e=this.getData(),i=[];return e.forEach(a=>{if(!a.enable)return;let o=window.location.href,l=a.data.url;if(a.data.enableRegExpToMatchUrl){if(!new RegExp(l,"i").test(o))return}else if(!o.includes(l))return;i.push(a);}),i},showView(){let t=$.config.PanelHandlerComponents();function e(o,l){return {get(r,n){return Reflect.get(o,r)??n},set(r,n){Reflect.set(o,r,n);}}}const i=this.getMatchedRuleList();new Ke({title:"Cookie规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:o=>o.name,updateData:o=>this.updateData(o),deleteData:o=>this.deleteData(o),getData:o=>this.getData().find(n=>n.uuid===o.uuid)??o,itemControls:{enable:{enable:true,getEnable(o){return o.enable},callback:(o,l)=>{o.enable=l,this.updateData(o);}},edit:{enable:true,getView:(o,l)=>{let r=document.createDocumentFragment(),n=this.getTemplateData();l||(o=n);let s=B("启用","enable",n.enable);Reflect.set(s.props,D,e(o));let p=t.createSectionContainerItem_switch(s),c=ue("规则名称","name","",n.name,void 0,"必填");Reflect.set(c.props,D,e(o));let f=t.createSectionContainerItem_input(c),h=X("Cookie管理Api","execApiName",n.data.execApiName,[{text:"（当前）"+V.cookieManagerApiName,value:"use-global"},...we.map(T=>({text:T,value:T}))],void 0,"操作Cookie的Api函数");Reflect.set(h.props,D,e(o.data));let g=t.createSectionContainerItem_select(h),d=ue("网址","url",n.data.url,"用于执行该规则的网址",void 0,"必填");Reflect.set(d.props,D,e(o.data));let x=t.createSectionContainerItem_input(d),k=B("启用正则匹配网址","enableRegExpToMatchUrl",n.data.enableRegExpToMatchUrl);Reflect.set(k.props,D,e(o.data));let w=t.createSectionContainerItem_switch(k),v=ue("Cookie名称","cookieName",n.data.cookieName,"用于匹配执行操作的Cookie名",void 0,"必填");Reflect.set(v.props,D,e(o.data));let b=t.createSectionContainerItem_input(v),C=B("启用正则匹配Cookie名称","enableRegExpToMatchCookieName",n.data.enableRegExpToMatchCookieName);Reflect.set(C.props,D,e(o.data));let S=t.createSectionContainerItem_switch(C),A=X("操作模式","operationMode",n.data.operationMode,[{value:"delete",text:"删除Cookie"},{value:"extended",text:"自动延长Cookie有效期30天"},{value:"extended-90",text:"自动延长Cookie有效期90天"},{value:"extended-180",text:"自动延长Cookie有效期180天"},{value:"extended-360",text:"自动延长Cookie有效期360天"}]);Reflect.set(A.props,D,e(o.data));let M=t.createSectionContainerItem_select(A),R=Be("备注","remark",n.data.remark);Reflect.set(R.props,D,e(o.data));let L=t.createSectionContainerItem_textarea(R);return r.append(p,f,g,x,w,b,S,M,L),r},onsubmit:(o,l,r)=>{let n=o.querySelectorAll(".rule-form-ulist > li"),s=this.getTemplateData();l&&(s.uuid=r.uuid);try{return n.forEach(p=>{let c=Reflect.get(p,"__formConfig__"),f=Reflect.get(c,"attributes"),h=Reflect.get(p,D),g=Reflect.get(f,j),d=Reflect.get(f,K),x=h.get(g,d);Reflect.has(s,g)?Reflect.set(s,g,x):Reflect.has(s.data,g)?Reflect.set(s.data,g,x):_.error(`${g}不在数据中`);}),s.name.trim()===""?(y.error("规则名称不能为空"),{success:!1,data:s}):s.data.url.trim()===""?(y.error("网址不能为空"),{success:!1,data:s}):s.data.cookieName.trim()===""?(y.error("Cookie名称不能为空"),{success:!1,data:s}):l?{success:this.updateData(s),data:s}:{success:this.addData(s),data:s}}catch(p){return _.error(p),{success:false,data:s}}finally{this.init();}},style:`
                    ...
                    `},delete:{enable:true,deleteCallBack:o=>this.deleteData(o)}},bottomControls:{filter:{enable:true,option:[{name:"过滤-已启用",filterCallBack(o){return o.enable}},{name:"过滤-未启用",filterCallBack(o){return !o.enable}},{name:"过滤-当前网站执行",filterCallBack(o){return i.some(l=>l.uuid===o.uuid)}}]}}}).showView();},getTemplateData(){return {uuid:m.generateUUID(),enable:true,name:"",data:{url:"",execApiName:"use-global",enableRegExpToMatchUrl:false,cookieName:"",enableRegExpToMatchCookieName:false,operationMode:"delete",remark:""}}},getData(){return he(this.$key.STORAGE_KEY,[])},setData(t){ie(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(a=>a.uuid==t.uuid)===-1?(e.push(t),ie(this.$key.STORAGE_KEY,e),true):false},updateData(t){let e=this.getData(),i=e.findIndex(o=>o.uuid==t.uuid),a=false;return i!==-1&&(a=true,e[i]=t),this.setData(e),a},deleteData(t){let e=this.getData(),i=e.findIndex(o=>o.uuid==t.uuid),a=false;return i!==-1&&(a=true,e.splice(i,1)),this.setData(e),a},clearData(){Me(this.$key.STORAGE_KEY);},exportRule(t="rule.json"){let e=this.getData(),i=new Blob([JSON.stringify(e,null,4)]),a=window.URL.createObjectURL(i),o=u.createElement("a");o.href=a,o.download=t,o.click(),setTimeout(()=>{window.URL.revokeObjectURL(a);},1500);},importRule(){let t=$.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            ...
            `}),e=t.$shadowRoot.querySelector(".import-mode[data-mode='local']"),i=t.$shadowRoot.querySelector(".import-mode[data-mode='network']");u.on(e,"click",a=>{m.preventEvent(a),t.close();let o=u.createElement("input",{type:"file",accept:".json"});u.on(o,["propertychange","input"],l=>{if(!o.files?.length)return;let r=o.files[0],n=new FileReader;n.onload=()=>{let s=m.toJSON(n.result);if(!Array.isArray(s)){_.error("不是正确的规则文件",s),y.error("不是正确的规则文件");return}this.setData(s),y.success(`成功导入 ${s.length}条规则`);},n.readAsText(r,"UTF-8");}),o.click();}),u.on(i,"click",a=>{m.preventEvent(a),t.close(),$.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"url",focus:true},btn:{ok:{callback:async(o,l)=>{let r=o.text;if(m.isNull(r)){y.error("请填入完整的url");return}let n=await xe.get(r);if(!n.status)return;let s=m.toJSON(n.data.responseText);if(!Array.isArray(s)){_.error("不是正确的规则文件",n,s),y.error("不是正确的规则文件");return}this.setData(s),o.close(),y.success(`成功导入 ${s.length}条规则`);}}},width:q.info.width,height:"auto"});});}},Q={encrypt(t,e){return se.AES.encrypt(t,e).toString()},decrypt(t,e){return se.AES.decrypt(t,e).toString(se.enc.Utf8)},formatCookie(t,e,i){let a="";if(e==="header_string")a=t.map(o=>{let l=o.value;return `${o.name}=${l}; `}).join("");else if(e==="json")a=JSON.stringify({api:V.cookieManagerApiName,hostname:window.location.hostname,data:t},null,2);else throw new Error("不支持的格式化类型："+e);return i&&(a=this.encrypt(a,i)),a},showExportDialog(){let t=$.confirm({title:{text:"导出 Cookie",position:"center"},content:{text:`
					...
					`,html:true},width:window.innerWidth<400?"88vw":"400px",height:"auto",btn:{merge:true,position:"space-between",ok:{text:"导出",async callback(n,s){let p=me.$data.cookieList;if(p.length===0){y.warning("Cookie为空");return}let c=Q.formatCookie(p,r.exportType,r.encodePwd);const f=new Blob([c],{type:"text/plain"}),h=URL.createObjectURL(f);u.createElement("a",{download:`${window.location.hostname}_${r.exportType}_${V.cookieManagerApiName}_${Date.now()}.txt`,href:h,target:"_blank"}).click(),setTimeout(()=>{URL.revokeObjectURL(h);},500),n.close();}},other:{enable:true,text:"导出至剪贴板",type:"xiaomi-primary",async callback(n,s){let p=me.$data.cookieList;if(p.length===0){y.warning("Cookie为空");return}let c=Q.formatCookie(p,r.exportType,r.encodePwd);await m.setClip(c)?y.success("复制成功"):y.error("复制失败"),n.close();}}},style:`
					${$.config.cssText.panelCSS}
				...
				`}),e=t.$shadowRoot.querySelector(".export-example-code-text-container pre"),i=t.$shadowRoot.querySelector("#cookie-format-header_string"),a=t.$shadowRoot.querySelector("#cookie-format-json"),o=t.$shadowRoot.querySelector("#encode-pwd");const l={key:"cookie-backup-export-dialog-config",getConfig(){return E.getValue(this.key,{exportType:"header_string",encodePwd:""})},saveConfig(){let n="header_string";a.checked&&(n="json"),E.setValue(this.key,{exportType:n,encodePwd:u.val(o)}),r=this.getConfig();}};let r=l.getConfig();u.on(i,"input",()=>{const n=[{name:"_ga",value:"GA1.2.123456789.987654321",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"PHPSESSID",value:"28f2d88ee9322cfd2e4f1e",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"csrftoken",value:"abcdef123456",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"logged_in",value:"true",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false}];let s=this.formatCookie(n,"header_string");u.text(e,s),l.saveConfig();}),u.on(a,"input",()=>{const n=[{name:"sessionId",value:"abc123xyz456",domain:".example.com",path:"/",secure:true,httpOnly:true,sameSite:"lax",expirationDate:1713543600,hostOnly:false,session:false}];let s=this.formatCookie(n,"json");u.text(e,s),l.saveConfig();}),u.on(o,["input","propertychange"],()=>{l.saveConfig();}),r.exportType==="header_string"?i.click():r.exportType==="json"&&a.click(),u.val(o,r.encodePwd);},showImportDialog(){let t=$.confirm({title:{text:"导入 Cookie",position:"center"},content:{text:`
					...
					`,html:true},width:window.innerWidth<400?"88vw":"400px",height:"auto",btn:{ok:{text:"导入",async callback(f,h){try{const g=c.decodePwd;let d=c.value;g.trim()===""||(d=Q.decrypt(d,g));const x=m.toJSON(d);if(Array.isArray(x)){_.info(`使用${V.cookieManagerApiName}导入cookie数据`);for(const k of x)await V.updateCookie(k);}else if(typeof x=="object"&&Object.keys(x).length&&Array.isArray(x.data)){const k=new ye(x.api);_.info(`使用${k.cookieManagerApiName}导入cookie数据`);for(const w of x.data)await k.updateCookie(w);}else if(typeof x=="object"&&!Object.keys(x).length){let k=new m.GM_Cookie;_.info(`使用${V.cookieManagerApiName}导入cookie数据`);let w=k.parseCookie(d);for(const v of w)await V.updateCookie({name:v.key,value:v.value,domain:window.location.hostname,path:"/",sameSite:"unspecified",secure:!1,session:!1,hostOnly:!0,httpOnly:!1});}else {_.error(d,x),y.error("cookie格式不符合");return}f.close();}catch(g){y.error(g.toString());}}}},style:`
					${$.config.cssText.panelCSS}
				...
				`}),e="",i=t.$shadowRoot.querySelector("#import-cookie-import_from_text"),a=t.$shadowRoot.querySelector("#import-cookie-import_from_file");t.$shadowRoot.querySelector(".import-cookie-value-container");let o=t.$shadowRoot.querySelector(".import-cookie-value-text"),l=o.querySelector("textarea"),r=t.$shadowRoot.querySelector(".import-cookie-value-file"),n=r.querySelector("input"),s=t.$shadowRoot.querySelector("#decode-pwd");const p={key:"cookie-backup-import-dialog-config",getConfig(){let f=E.getValue(this.key,{importType:"import_from_text",decodePwd:"",value:""});return f.importType==="import_from_text"?f.value=l.value:f.importType==="import_from_file"&&(f.value=e),f},saveConfig(){let f="import_from_text";a.checked&&(f="import_from_file"),E.setValue(this.key,{importType:f,decodePwd:u.val(s)}),c=this.getConfig();}};let c=p.getConfig();u.on(i,"input",()=>{p.saveConfig(),n.value="",e="",u.hide(r,false),u.show(o,false);}),u.on(a,"input",()=>{p.saveConfig(),l.value="",u.hide(o,false),u.show(r,false);}),u.on(l,["input","propertychange"],m.debounce(()=>{p.saveConfig();})),u.on(n,["change","input"],f=>{const h=n.files?.[0];if(h){const g=new FileReader;g.onload=function(d){const x=d.target.result;typeof x=="string"&&(e=x,p.saveConfig());},g.readAsText(h);}}),u.on(s,["input","propertychange"],async f=>{p.saveConfig();}),c.importType==="import_from_text"?i.click():c.importType==="import_from_file"&&a.click(),u.val(s,c.decodePwd);}},me={$data:{cookieList:[]},init(){this.registerMenu();},async showView(){const t=$.alert({title:{text:"Cookie编辑器",html:false,position:"center"},content:{text:`
            ...
            `}),e=t.$shadowRoot.querySelector(".cookie-search-inner input"),i=t.$shadowRoot.querySelector(".cookie-search-setting"),a=t.$shadowRoot.querySelector(".cookie-control-refresh"),o=t.$shadowRoot.querySelector(".cookie-control-add"),l=t.$shadowRoot.querySelector(".cookie-control-export"),r=t.$shadowRoot.querySelector(".cookie-control-import"),n=t.$shadowRoot.querySelector(".cookie-control-clear-all"),s=t.$shadowRoot.querySelector(".cookie-control-rule-manager"),p=t.$shadowRoot.querySelector(".cookie-setting"),c=t.$shadowRoot.querySelector(".cookie-list-wrapper");let f=d=>{const x=u.createElement("div",{className:"cookie-item",innerHTML:`
                `,"data-cookie-info":d}),k=[{leftText:"name",rightText:d.name},{leftText:"value",rightText:E.getValue("decode-cookie-value")?decodeURIComponent(d.value):encodeURIComponent(d.value)}];V.cookieManagerApiName==="GM_cookie"||V.cookieManagerApiName==="GM.cookie"?(d=d,k.push({leftText:"domain",rightText:d.domain},{leftText:"path",rightText:d.path},{leftText:"session",rightText:JSON.stringify(d.session)},{leftText:"expires",rightText:d.session?"会话":d.expirationDate?new Date(d.expirationDate*1e3).toISOString():"未知"},{leftText:"httpOnly",rightText:JSON.stringify(d.httpOnly)},{leftText:"hostOnly",rightText:JSON.stringify(d.hostOnly)},{leftText:"secure",rightText:JSON.stringify(d.secure)},{leftText:"sameSite",rightText:d.sameSite})):V.cookieManagerApiName==="cookieStore"&&(d=d,k.push({leftText:"domain",rightText:d.domain},{leftText:"path",rightText:d.path},{leftText:"expires",rightText:d.expires?new Date(d.expires).toISOString():"会话"},{leftText:"secure",rightText:JSON.stringify(d.secure)},{leftText:"sameSite",rightText:d.sameSite})),k.forEach(S=>{const A=u.createElement("div",{className:"cookie-item-group",innerHTML:`
                ...
                `}),v=w.querySelector(".cookie-item-group-control-copy"),b=w.querySelector(".cookie-item-group-control-edit"),C=w.querySelector(".cookie-item-group-control-delete");return u.on(v,"click",S=>{m.preventEvent(S);let A=d.value;m.setClip(A).then(M=>{M?y.success("复制成功"):y.error("复制失败");});}),u.on(b,"click",S=>{m.preventEvent(S),fe.showView(d,A=>{let M=f(A);u.after(x,M),x.parentElement?.removeChild(x);});}),u.on(C,"click",S=>{m.preventEvent(S),confirm("确定删除该Cookie？")&&V.deleteCookie(d).then(M=>{M?(_.error(M),y.error("删除失败")):(y.success("删除成功"),x.parentElement?.removeChild(x));});}),u.append(x,[w]),x},h=async d=>{let x=await V.queryAllCookie();u.empty(c);let k=document.createDocumentFragment(),w=E.getValue("exclude-session-cookie");x.forEach(v=>{if(w&&(v.session||V.cookieManagerApiName==="cookieStore"&&v.expires==null)||typeof d=="function"&&!d(v))return;const b=f(v);k.appendChild(b);}),this.$data.cookieList=x,c.appendChild(k);};u.on(e,["input","propertychange"],m.debounce(d=>{let x=u.val(e),k=x.trim()==="",w=E.getValue("search-config-use-regexp");h(v=>k?true:w?!!v.name.match(new RegExp(x)):v.name.includes(x));})),u.listenKeyboard(e,"keypress",(d,x,k)=>{d==="Enter"&&k.length===0&&g();}),u.on(i,"click",d=>{m.preventEvent(d);let k=$.alert({title:{text:"搜索配置",position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},drag:true,mask:{clickEvent:{toClose:true}},width:q.info.width,height:q.info.height,style:`
                    ${$.config.cssText.panelCSS}
                ...
                `}).$shadowRoot.querySelector(".pops-alert-content"),v=$.config.PanelHandlerComponents().createSectionContainerItem_switch(B("启用正则表达式","search-config-use-regexp",false,void 0,"使用正则表达式搜索Cookie名称",()=>{g();}));u.append(k,v);}),u.on(a,"click",d=>{m.preventEvent(d),g();}),u.on(o,"click",d=>{m.preventEvent(d),fe.showView(void 0,x=>{g();});}),u.on(l,"click",async d=>{m.preventEvent(d),Q.showExportDialog();}),u.on(r,"click",async d=>{m.preventEvent(d),Q.showImportDialog();}),u.on(n,"click",async d=>{if(m.preventEvent(d),!window.confirm("确定清除全部Cookie？"))return;const k=await V.deleteAllCookie();k.error?y.warning(`清除成功：${k.success} 失败：${k.error}`):y.success("清除成功"),g();}),u.on(s,"click",d=>{m.preventEvent(d),U.showView();}),u.on(p,"click",d=>{m.preventEvent(d);let k=$.alert({title:{text:"设置",position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},drag:true,mask:{clickEvent:{toClose:true}},width:q.settingMiddle.width,height:q.settingMiddle.height,style:`
                    ${$.config.cssText.panelCSS}

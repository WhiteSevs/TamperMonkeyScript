...
(function (w, de, I, j) {
            ...
            var Y=typeof GM<"u"?GM:void 0,he=typeof GM_cookie<"u"?GM_cookie:void 0,ne=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,te=typeof GM_getValue<"u"?GM_getValue:void 0,F=typeof GM_info<"u"?GM_info:void 0,fe=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,H=typeof GM_setValue<"u"?GM_setValue:void 0,ge=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,me=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,T=typeof unsafeWindow<"u"?unsafeWindow:void 0,xe=window;const le="GM_Panel",re="data-init",O="data-key",B="data-default-value",we="data-init-more-value",M="data-storage-api",E={setting:{get width(){return window.innerWidth<550?"88vw":window.innerWidth<700?"550px":"700px"},get height(){return window.innerHeight<450?"70vh":window.innerHeight<550?"450px":"550px"}},info:{get width(){return "350px"},get height(){return "250px"}}};class ve{storageKey;listenerData;constructor(e){if(typeof e=="string"){let o=e.trim();if(o=="")throw new Error("key参数不能为空字符串");this.storageKey=o;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new I.Dictionary;}getLocalValue(){let e=te(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){H(this.storageKey,e);}set(e,o){let i=this.get(e),a=this.getLocalValue();Reflect.set(a,e,o),this.setLocalValue(a),this.triggerValueChangeListener(e,i,o);}get(e,o){let i=this.getLocalValue();return Reflect.get(i,e)??o}getAll(){return this.getLocalValue()}delete(e){let o=this.get(e),i=this.getLocalValue();Reflect.deleteProperty(i,e),this.setLocalValue(i),this.triggerValueChangeListener(e,o,void 0);}has(e){let o=this.getLocalValue();return Reflect.has(o,e)}keys(){let e=this.getLocalValue();return Reflect.ownKeys(e)}values(){let e=this.getLocalValue();return Reflect.ownKeys(e).map(o=>Reflect.get(e,o))}clear(){ne(this.storageKey);}addValueChangeListener(e,o){let i=Math.random(),a=this.listenerData.get(e)||[];return a.push({id:i,key:e,callback:o}),this.listenerData.set(e,a),i}removeValueChangeListener(e){let o=false;for(const[i,a]of this.listenerData.entries()){for(let n=0;n<a.length;n++){const l=a[n];(typeof e=="string"&&l.key===e||typeof e=="number"&&l.id===e)&&(a.splice(n,1),n--,o=true);}this.listenerData.set(i,a);}return o}triggerValueChangeListener(e,o,i){if(!this.listenerData.has(e))return;let a=this.listenerData.get(e);for(let n=0;n<a.length;n++){const l=a[n];if(typeof l.callback=="function"){let r=this.get(e),s,c;typeof o<"u"&&arguments.length>=2?c=o:c=r,typeof i<"u"&&arguments.length>2?s=i:s=r,l.callback(e,c,s);}}}}const q=new ve(le),ye={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{V.showPanel(K.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){V.isTopWindow()&&ce.add(this.$data.menuOption);},addMenuOption(t){Array.isArray(t)||(t=[t]),this.$data.menuOption.push(...t);},updateMenuOption(t){Array.isArray(t)||(t=[t]),t.forEach(e=>{let o=this.$data.menuOption.findIndex(i=>i.key===e.key);o!==-1&&(this.$data.menuOption[o]=e);});},getMenuOption(t=0){return this.$data.menuOption[t]},deleteMenuOption(t=0){this.$data.menuOption.splice(t,1);}},V={$data:{__configDefaultValueData:null,__onceExecMenuData:null,__onceExecData:null,__panelConfig:{},$panel:null,get configDefaultValueData(){return this.__configDefaultValueData==null&&(this.__configDefaultValueData=new v.Dictionary),this.__configDefaultValueData},get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new v.Dictionary),this.__onceExecMenuData},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new v.Dictionary),this.__onceExecData},get scriptName(){return oe},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:le,attributeKeyName:O,attributeDefaultValueName:B},init(){this.initContentDefaultValue(),ye.init();},isTopWindow(){return T.top===T.self},initContentDefaultValue(){const t=i=>{if(!i.attributes||i.type==="button"||i.type==="forms"||i.type==="deepMenu")return;let a={},n=i.attributes[O];n!=null&&(a[n]=i.attributes[B]);let l=i.attributes[re];if(typeof l=="function"){let c=l();if(typeof c=="boolean"&&!c)return}let r=i.attributes[we];r&&typeof r=="object"&&Object.assign(a,r);let s=Object.keys(a);if(!s.length){b.warn(["请先配置键",i]);return}s.forEach(c=>{let p=a[c];this.setDefaultValue(c,p);});},e=i=>{for(let a=0;a<i.length;a++){let n=i[a];t(n);let l=n.forms;l&&Array.isArray(l)&&e(l);}},o=[...K.getAllContentConfig()];for(let i=0;i<o.length;i++){let a=o[i];if(!a.forms)continue;const n=a.forms;n&&Array.isArray(n)&&e(n);}},setDefaultValue(t,e){this.$data.configDefaultValueData.has(t)&&b.warn("请检查该key(已存在): "+t),this.$data.configDefaultValueData.set(t,e);},setValue(t,e){q.set(t,e);},getValue(t,e){let o=q.get(t);return o??(this.$data.configDefaultValueData.has(t)?this.$data.configDefaultValueData.get(t):e)},deleteValue(t){q.delete(t);},hasKey(t){return q.has(t)},addValueChangeListener(t,e){return q.addValueChangeListener(t,(i,a,n)=>{e(t,n,a);})},removeValueChangeListener(t){q.removeValueChangeListener(t);},triggerMenuValueChange(t,e,o){q.triggerValueChangeListener(t,o,e);},deleteExecMenuOnce(t){return this.$data.onceExecMenuData.delete(t),q.removeValueChangeListener(t)},deleteOnceExec(t){this.$data.onceExecData.delete(t);},exec(t,e,o,i=true){const a=this;let n;typeof t=="string"||Array.isArray(t)?n=()=>t:n=t;let l=false,r=n(),s=[];Array.isArray(r)?(l=true,s=r):s.push(r);let c=s.find(x=>!this.$data.configDefaultValueData.has(x));if(c){b.warn(`${c} 键不存在`);return}let p=JSON.stringify(s);if(i){if(this.$data.onceExecMenuData.has(p))return;this.$data.onceExecMenuData.set(p,1);}let f=[],u=[],h=(x,_)=>{let $=[];Array.isArray(_)||(_=[_]),_.forEach(R=>{if(R!=null&&R instanceof HTMLStyleElement){$.push(R);return}}),f=f.concat($);},g=x=>this.getValue(x),y=()=>{for(let x=0;x<f.length;x++)f[x].remove(),f.splice(x,1),x--;},m=()=>{let x=false;return typeof o=="function"?x=o(s):x=s.every(_=>g(_)),x},S=x=>{let _=m(),$=[];if(_){let R=s.map(N=>this.getValue(N)),U=e({value:l?R:R[0],addStyleElement:(...N)=>h(true,...N)});Array.isArray(U)||(U=[U]),U.forEach(N=>{if(N!=null&&N instanceof HTMLStyleElement){$.push(N);return}});}y(),f=[...$];};return i&&s.forEach(x=>{let _=this.addValueChangeListener(x,($,R,U)=>{S();});u.push(_);}),S(),{clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),i&&a.$data.onceExecMenuData.delete(p);},clearStoreStyleElements:()=>y(),removeValueChangeListener:()=>{u.forEach(x=>{this.removeValueChangeListener(x);});}}},execMenu(t,e,o=false){return this.exec(t,i=>e(i),i=>i.every(n=>{let l=!!this.getValue(n);return o&&(l=!l),l}),false)},execMenuOnce(t,e){return this.exec(t,e,o=>o.every(a=>!!this.getValue(a)),true)},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},showPanel(t,e=`${oe}-设置`,o=false){let i=t.some(n=>!(typeof n.isBottom=="function"?n.isBottom():!!n.isBottom)&&n.id!=="script-version");!o&&i&&t.push(...K.getDefaultBottomContentConfig());let a=C.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(n,l)=>{n.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(n,l)=>{n(),this.$data.$panel=null;}},width:E.setting.width,height:E.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a;}},D={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},v=I.noConflict(),d=de.noConflict(),C=j,b=new v.Log(F,T.console||xe.console);let oe=F?.script?.name||void 0;j.config.Utils.AnyTouch();const se=false;b.config({debug:se,logMaxCount:1e3,autoClearConsole:true,tag:true});w.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return V.getValue(D.qmsg_config_position.key,D.qmsg_config_position.defaultValue)}},maxNums:{get(){return V.getValue(D.qmsg_config_maxnums.key,D.qmsg_config_maxnums.defaultValue)}},showReverse:{get(){return V.getValue(D.qmsg_config_showreverse.key,D.qmsg_config_showreverse.defaultValue)}},zIndex:{get(){let t=I.getMaxZIndex(),e=j.config.InstanceUtils.getPopsMaxZIndex().zIndex;return I.getMaxValue(t,e)+100}}}));C.GlobalConfig.setGlobalConfig({zIndex:()=>{let t=I.getMaxZIndex(void 0,void 0,o=>{if(o?.classList?.contains("qmsg-shadow-container")||o?.closest("qmsg")&&o.getRootNode()instanceof ShadowRoot)return  false}),e=j.config.InstanceUtils.getPopsMaxZIndex().zIndex;return I.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}}});const ce=new v.GM_Menu({GM_getValue:te,GM_setValue:H,GM_registerMenuCommand:fe,GM_unregisterMenuCommand:ge}),ie=new v.Httpx({xmlHttpRequest:me,logDetails:se});ie.interceptors.request.use(t=>t);ie.interceptors.response.use(void 0,t=>(b.error("拦截器-请求错误",t),t.type==="onabort"?w.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?w.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?w.error("请求超时",{consoleLogContent:true}):w.error("其它错误",{consoleLogContent:true}),t));T.Object.defineProperty,T.Function.prototype.apply,T.Function.prototype.call,T.Element.prototype.appendChild,T.setTimeout;v.addStyle.bind(v);document.querySelector.bind(document);document.querySelectorAll.bind(document);const ue=new v.GM_Cookie,K={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new v.Dictionary),this.__contentConfig}},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){return [{id:"script-version",title:`版本：${F?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(t,e,o){return window.open(F?.script?.namespace||"https://github.com/WhiteSevs/TamperMonkeyScript","_blank"),false}}]}};let pe=t=>{(typeof t=="object"&&t!=null||typeof t=="function")&&Object.keys(t).forEach(e=>{typeof t[e]=="function"&&(t[e]=t[e].bind(t));});};const P=he;pe(P);pe(ue);const k={get cookieManagerApiName(){return V.getValue("cookie-manager-api","document.cookie")},get cookieManager(){if(this.cookieManagerApiName==="GM_cookie")return {list(t,e){P.list(t,o=>{e(o);});},set(t,e){P.set(t,o=>{e(o);});},delete(t,e){P.delete(t,o=>{e(o);});}};if(this.cookieManagerApiName==="GM.cookie")return {list(t,e){Y.cookie.list().then(o=>{e(o);});},set(t,e){Y.cookie.set(t).then(o=>{e(o??null);}).catch(o=>{e(o);});},delete(t,e){Y.cookie.delete(t).then(o=>{e(o??null);}).catch(o=>{e(o);});}};if(this.cookieManagerApiName==="cookieStore"){let t=T.cookieStore;return {list(e,o){t.getAll().then(i=>{o(i);}).catch(i=>{b.error(i),w.error(i.toString());});},set(e,o){t.set(e).then(()=>{o();}).catch(i=>{o(i);});},delete(e,o){t.delete(e).then(i=>{o();}).catch(i=>{o(i);});}}}else return ue},queryAllCookie(){return new Promise((t,e)=>{try{this.cookieManager.list({},o=>{let i=o||[];i=i.sort((a,n)=>a.name.localeCompare(n.name)),t(i);});}catch(o){b.error(o),w.error(o.toString()),e(o);}})},deleteAllCookie(){return new Promise((t,e)=>{try{this.cookieManager.list({},async o=>{const i=o||[],a={success:0,error:0};for(let n=0;n<i.length;n++){const l=i[n];await new Promise(s=>{this.deleteCookie(l).then(c=>{s(c);});})?a.error++:a.success++;}t(a);});}catch(o){b.error(o),w.error(o.toString()),e(o);}})},addCookie(t){return new Promise((e,o)=>{try{Reflect.deleteProperty(t,"hostOnly"),k.cookieManager.set(t,i=>{e(i);});}catch(i){b.error(i),w.error(i.toString()),o(i);}})},deleteCookie(t){return new Promise((e,o)=>{try{k.cookieManager.delete(t,i=>{e(i);});}catch(i){b.error(i),w.error(i.toString()),o(i);}})},updateCookie(t){return new Promise(async(e,o)=>{let i;try{let a=await k.deleteCookie(t);if(a)throw new TypeError(a.toString());let n=await k.addCookie(t);if(n)throw new TypeError(n.toString())}catch(a){i=a;}finally{e(i);}})}},J={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new I.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,o){let i;this.hasStorageApi(t)?i=this.getStorageApi(t):i=o,this.setComponentsStorageApiProperty(e,i);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,M,e);}},G=function(t,e,o,i,a,n){let l={text:t,type:"switch",description:a,attributes:{},props:{},getValue(){return !!this.props[M].get(e,o)},callback(r,s){let c=!!s;if(b.success(`${c?"开启":"关闭"} ${t}`),typeof i=="function"&&i(r,c))return;this.props[M].set(e,c);},afterAddToUListCallBack:n};return Reflect.set(l.attributes,O,e),Reflect.set(l.attributes,B,o),J.initComponentsStorageApi("switch",l,{get(r,s){return V.getValue(r,s)},set(r,s){V.setValue(r,s);}}),l},ae={beforeEdit(t){const e=k.cookieManagerApiName;return e==="cookieStore"?typeof t.expires=="number"&&(t.expirationDate=t.expires):(e==="GM_cookie"||e==="GM.cookie")&&typeof t.expirationDate=="number"&&(t.expirationDate=t.expirationDate*1e3),t},afterEdit(t){const e=k.cookieManagerApiName;return e==="document.cookie"?t.domain="":e==="cookieStore"?typeof t.expirationDate=="number"&&(t.expires=t.expirationDate):(e==="GM_cookie"||e==="GM.cookie")&&typeof t.expirationDate=="number"&&(t.expirationDate=Math.floor(t.expirationDate/1e3)),t}};let z=(t,e,o,i)=>({text:t,type:"input",isNumber:false,isPassword:false,props:{},attributes:{},description:"",getValue(){return e()},callback(n,l){o(l);},placeholder:"",disabled:!!i}),Z=(t,e,o,i,a)=>({text:t,type:"select",description:"",attributes:{},props:{},getValue(){return o()},callback(l,r,s){i(r);},data:typeof e=="function"?e():e,disabled:false});const ee={init(){},showView(t,e){let o=!!t,i=v.assign({name:"",value:"",domain:window.location.hostname,path:"/",secure:false,hostOnly:false,httpOnly:false,sameSite:"lax",expirationDate:Date.now()+60*60*24*30*1e3},t,true);i=ae.beforeEdit(i);let n=C.confirm({title:{text:o?"编辑Cookie":"添加Cookie",position:"center"},content:{text:"",html:true},drag:true,btn:{position:"center",ok:{text:o?"编辑":"添加",async callback(m,S){if(ee.validCookieInfo(i)){if(i.value=encodeURIComponent(i.value),i=ae.afterEdit(i),o){let x=await k.updateCookie(i);x?w.error(x.toString()):(w.success("修改成功"),m.close());}else {let x=await k.addCookie(i);x?w.error(x.toString()):(w.success("添加成功"),m.close());}typeof e=="function"&&e(i);}}},cancel:{text:"取消"}},mask:{enable:true},width:window.innerWidth>350?"350px":"80vw",height:E.setting.height,style:`
            ...
            `}).$shadowRoot.querySelector(".pops-confirm-content"),l=C.config.PanelHandlerComponents(),r=l.createSectionContainerItem_input(z("name",()=>i.name,m=>i.name=m,o)),s=l.createSectionContainerItem_input(z("value",()=>i.value,m=>i.value=m)),c=l.createSectionContainerItem_input(z("domain",()=>i.domain,m=>i.domain=m)),p=l.createSectionContainerItem_input(z("path",()=>i.path,m=>i.path=m)),f;i.session?f=l.createSectionContainerItem_input(z("expires",()=>"会话",m=>{},true)):f=l.createSectionContainerItem_own({type:"own",getLiElementCallBack:function(m){let S=d.createElement("li",{innerHTML:`
						...
						`}),A=S.querySelector("#cookie-item-property-expires");return A.valueAsNumber=i.expirationDate,d.on(A,["change","input","propertychange"],x=>{v.preventEvent(x),i.expirationDate=A.valueAsNumber;}),S}});let u=l.createSectionContainerItem_select(Z("httpOnly",[{text:"true",value:true},{text:"false",value:false}],()=>i.httpOnly,m=>i.httpOnly=m)),h=l.createSectionContainerItem_select(Z("secure",[{text:"true",value:true},{text:"false",value:false}],()=>i.secure,m=>i.secure=m)),g=[{text:"no_restriction",value:"no_restriction"},{text:"lax",value:"lax"},{text:"strict",value:"strict"},{text:"unspecified",value:"unspecified"}];k.cookieManagerApiName==="cookieStore"&&(g=[{text:"lax",value:"lax"},{text:"strict",value:"strict"},{text:"none",value:"none"}]);let y=l.createSectionContainerItem_select(Z("sameSite",g,()=>i.sameSite,m=>i.sameSite=m));d.append(n,[r,s]),k.cookieManagerApiName==="GM_cookie"||k.cookieManagerApiName==="GM.cookie"?d.append(n,[c,p,f,u,h,y]):k.cookieManagerApiName==="cookieStore"&&d.append(n,[c,p,f,y]);},validCookieInfo(t){return t.name==null||t.name==""?(w.error("name不能为空"),false):t.domain==null||t.domain==""?(w.error("domain不能为空"),false):t.path==null||t.path==""?(w.error("path不能为空"),false):true}},W=function(t,e,o,i,a,n){let l=[];typeof i=="function"?l=i():l=i;let r={text:t,type:"select",description:n,attributes:{},props:{},getValue(){return this.props[M].get(e,o)},callback(s,c,p){let f=c;if(b.info(`选择：${p}`),typeof a=="function"&&a(s,f,p))return;this.props[M].set(e,f);},data:l};return Reflect.set(r.attributes,O,e),Reflect.set(r.attributes,B,o),J.initComponentsStorageApi("select",r,{get(s,c){return V.getValue(s,c)},set(s,c){V.setValue(s,c);}}),r},Q=function(t,e,o,i,a,n="",l,r,s){let c={text:t,type:"input",isNumber:false,isPassword:false,attributes:{},props:{},description:i,afterAddToUListCallBack:s,getValue(){return this.props[M].get(e,o)},callback(p,f,u){this.props[M].set(e,f);},placeholder:n};return Reflect.set(c.attributes,O,e),Reflect.set(c.attributes,B,o),J.initComponentsStorageApi("input",c,{get(p,f){return V.getValue(p,f)},set(p,f){V.setValue(p,f);}}),c},ke=function(t,e,o,i,a,n="",l){let r={text:t,type:"textarea",attributes:{},props:{},description:i,placeholder:n,disabled:l,getValue(){let c=this.props[M].get(e,o);return Array.isArray(c)?c.join(`
`):c},callback(s,c){this.props[M].set(e,c);}};return Reflect.set(r.attributes,O,e),Reflect.set(r.attributes,B,o),J.initComponentsStorageApi("switch",r,{get(s,c){return V.getValue(s,c)},set(s,c){V.setValue(s,c);}}),r};class Ce{option;constructor(e){this.option=e;}async showView(){let e=C.confirm({title:{text:this.option.title,position:"center"},content:{text:`
			...
			`});Reflect.set(a,"data-rule",e);let n="pops-panel-switch-is-checked";const{$enable:l,$enableSwitch:r,$enableSwitchCore:s,$enableSwitchInput:c,$delete:p,$edit:f}=this.parseRuleItemElement(a);return this.option.itemControls.enable.enable?(d.on(s,"click",async u=>{let h=false;r.classList.contains(n)?(r.classList.remove(n),h=false):(r.classList.add(n),h=true),c.checked=h,await this.option.itemControls.enable.callback(e,h);}),await this.option.itemControls.enable.getEnable(e)&&r.classList.add(n)):l.remove(),this.option.itemControls.edit.enable?d.on(f,"click",u=>{v.preventEvent(u),this.showEditView(true,e,o,a,h=>{e=null,e=h;});}):f.remove(),this.option.itemControls.delete.enable?d.on(p,"click",u=>{v.preventEvent(u);let h=C.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async g=>{b.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(e)?(w.success("成功删除该数据"),a.remove(),await this.updateDeleteAllBtnText(o),h.close()):w.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):p.remove(),a}async appendRuleItemElement(e,o){let{$container:i}=this.parseViewElement(e),a=[],n=Array.isArray(o)?o:[o];for(let l=0;l<n.length;l++){let r=n[l],s=await this.createRuleItemElement(r,e);i.appendChild(s),a.push(s);}return await this.updateDeleteAllBtnText(e),a}async updateRuleContaienrElement(e){this.clearContent(e);const{$container:o}=this.parseViewElement(e);let i=await this.option.data();await this.appendRuleItemElement(e,i),await this.updateDeleteAllBtnText(e);}async updateRuleItemElement(e,o,i){let a=await this.createRuleItemElement(e,i);o.after(a),o.remove();}clearContent(e){const{$container:o}=this.parseViewElement(e);d.html(o,"");}setDeleteBtnText(e,o,i=false){const{$deleteBtn:a}=this.parseViewElement(e);i?d.html(a,o):d.text(a,o);}async updateDeleteAllBtnText(e){let o=await this.option.data();this.setDeleteBtnText(e,`清空所有(${o.length})`);}}const L={$key:{STORAGE_KEY:"cookie-rule"},$data:{ruleData:[]},init(){this.$data.ruleData=[],this.getData().forEach(e=>{if(!e.enable)return;let o=window.location.href,i=e.data.url;if(e.data.enableRegExpToMatchUrl){if(!new RegExp(i,"i").test(o))return}else if(!o.includes(i))return;this.$data.ruleData.push(e);});},showView(){let t=C.config.PanelHandlerComponents();function e(i,a){return {get(n,l){return Reflect.get(i,n)??l},set(n,l){Reflect.set(i,n,l);}}}new _e({title:"Cookie规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:i=>i.name,updateData:i=>this.updateData(i),deleteData:i=>this.deleteData(i),getData:i=>this.getData().find(l=>l.uuid===i.uuid)??i,itemControls:{enable:{enable:true,getEnable(i){return i.enable},callback:(i,a)=>{i.enable=a,this.updateData(i);}},edit:{enable:true,getView:(i,a)=>{let n=document.createDocumentFragment(),l=this.getTemplateData();a||(i=l);let r=G("启用","enable",l.enable);Reflect.set(r.props,M,e(i));let s=t.createSectionContainerItem_switch(r),c=Q("规则名称","name","",l.name,void 0,"必填");Reflect.set(c.props,M,e(i));let p=t.createSectionContainerItem_input(c),f=Q("网址","url",l.data.url,"用于执行该规则的网址",void 0,"必填");Reflect.set(f.props,M,e(i.data));let u=t.createSectionContainerItem_input(f),h=G("启用正则匹配网址","enableRegExpToMatchUrl",l.data.enableRegExpToMatchUrl);Reflect.set(h.props,M,e(i.data));let g=t.createSectionContainerItem_switch(h),y=Q("Cookie名称","cookieName",l.data.cookieName,"用于匹配执行操作的Cookie名",void 0,"必填");Reflect.set(y.props,M,e(i.data));let m=t.createSectionContainerItem_input(y),S=G("启用正则匹配Cookie名称","enableRegExpToMatchCookieName",l.data.enableRegExpToMatchCookieName);Reflect.set(S.props,M,e(i.data));let A=t.createSectionContainerItem_switch(S),x=W("操作模式","operationMode",l.data.operationMode,[{value:"delete",text:"删除Cookie"},{value:"extended",text:"自动延长Cookie有效期30天"},{value:"extended-90",text:"自动延长Cookie有效期90天"},{value:"extended-180",text:"自动延长Cookie有效期180天"},{value:"extended-360",text:"自动延长Cookie有效期360天"}]);Reflect.set(x.props,M,e(i.data));let _=t.createSectionContainerItem_select(x),$=ke("备注","remark",l.data.remark);Reflect.set($.props,M,e(i.data));let R=t.createSectionContainerItem_textarea($);return n.append(s,p,u,g,m,A,_,R),n},onsubmit:(i,a,n)=>{let l=i.querySelectorAll(".rule-form-ulist > li"),r=this.getTemplateData();a&&(r.uuid=n.uuid);try{return l.forEach(s=>{let c=Reflect.get(s,"__formConfig__"),p=Reflect.get(c,"attributes"),f=Reflect.get(s,M),u=Reflect.get(p,O),h=Reflect.get(p,B),g=f.get(u,h);Reflect.has(r,u)?Reflect.set(r,u,g):Reflect.has(r.data,u)?Reflect.set(r.data,u,g):b.error(`${u}不在数据中`);}),r.name.trim()===""?(w.error("规则名称不能为空"),{success:!1,data:r}):r.data.url.trim()===""?(w.error("网址不能为空"),{success:!1,data:r}):r.data.cookieName.trim()===""?(w.error("Cookie名称不能为空"),{success:!1,data:r}):a?{success:this.updateData(r),data:r}:{success:this.addData(r),data:r}}catch(s){return b.error(s),{success:false,data:r}}finally{this.init();}},style:`
                    ...
                    `},delete:{enable:true,deleteCallBack:i=>this.deleteData(i)}}}).showView();},getTemplateData(){return {uuid:v.generateUUID(),enable:true,name:"",data:{url:"",enableRegExpToMatchUrl:false,cookieName:"",enableRegExpToMatchCookieName:false,operationMode:"delete",remark:""}}},getData(){return te(this.$key.STORAGE_KEY,[])},setData(t){H(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(i=>i.uuid==t.uuid)===-1?(e.push(t),H(this.$key.STORAGE_KEY,e),true):false},updateData(t){let e=this.getData(),o=e.findIndex(a=>a.uuid==t.uuid),i=false;return o!==-1&&(i=true,e[o]=t),this.setData(e),i},deleteData(t){let e=this.getData(),o=e.findIndex(a=>a.uuid==t.uuid),i=false;return o!==-1&&(i=true,e.splice(o,1)),this.setData(e),i},clearData(){ne(this.$key.STORAGE_KEY);},exportRule(t="rule.json"){let e=this.getData(),o=new Blob([JSON.stringify(e,null,4)]),i=window.URL.createObjectURL(o),a=d.createElement("a");a.href=i,a.download=t,a.click(),setTimeout(()=>{window.URL.revokeObjectURL(i);},1500);},importRule(){let t=C.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            ...
            `}),e=t.$shadowRoot.querySelector(".import-mode[data-mode='local']"),o=t.$shadowRoot.querySelector(".import-mode[data-mode='network']");d.on(e,"click",i=>{v.preventEvent(i),t.close();let a=d.createElement("input",{type:"file",accept:".json"});d.on(a,["propertychange","input"],n=>{if(!a.files?.length)return;let l=a.files[0],r=new FileReader;r.onload=()=>{let s=v.toJSON(r.result);if(!Array.isArray(s)){b.error("不是正确的规则文件",s),w.error("不是正确的规则文件");return}this.setData(s),w.success(`成功导入 ${s.length}条规则`);},r.readAsText(l,"UTF-8");}),a.click();}),d.on(o,"click",i=>{v.preventEvent(i),t.close(),C.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"url",focus:true},btn:{ok:{callback:async(a,n)=>{let l=a.text;if(v.isNull(l)){w.error("请填入完整的url");return}let r=await ie.get(l);if(!r.status)return;let s=v.toJSON(r.data.responseText);if(!Array.isArray(s)){b.error("不是正确的规则文件",r,s),w.error("不是正确的规则文件");return}this.setData(s),a.close(),w.success(`成功导入 ${s.length}条规则`);}}},width:E.info.width,height:"auto"});});}},Ve={init(){this.registerMenu();},async showView(){const t=C.alert({title:{text:"Cookie编辑器",html:false,position:"center"},content:{text:`
            ...
            `}),e=t.$shadowRoot.querySelector(".cookie-search-inner input"),o=t.$shadowRoot.querySelector(".cookie-search-setting"),i=t.$shadowRoot.querySelector(".cookie-control-refresh"),a=t.$shadowRoot.querySelector(".cookie-control-add"),n=t.$shadowRoot.querySelector(".cookie-control-copy-all"),l=t.$shadowRoot.querySelector(".cookie-control-clear-all"),r=t.$shadowRoot.querySelector(".cookie-control-rule-manager"),s=t.$shadowRoot.querySelector(".cookie-setting"),c=t.$shadowRoot.querySelector(".cookie-list-wrapper");let p=u=>{const h=d.createElement("div",{className:"cookie-item",innerHTML:`
                `,"data-cookie-info":u}),g=[{leftText:"name",rightText:u.name},{leftText:"value",rightText:V.getValue("decode-cookie-value")?decodeURIComponent(u.value):encodeURIComponent(u.value)}];k.cookieManagerApiName==="GM_cookie"||k.cookieManagerApiName==="GM.cookie"?(u=u,g.push({leftText:"domain",rightText:u.domain},{leftText:"path",rightText:u.path},{leftText:"session",rightText:JSON.stringify(u.session)},{leftText:"expires",rightText:u.session?"会话":u.expirationDate?new Date(u.expirationDate*1e3).toISOString():"未知"},{leftText:"httpOnly",rightText:JSON.stringify(u.httpOnly)},{leftText:"hostOnly",rightText:JSON.stringify(u.hostOnly)},{leftText:"secure",rightText:JSON.stringify(u.secure)},{leftText:"sameSite",rightText:u.sameSite})):k.cookieManagerApiName==="cookieStore"&&(u=u,g.push({leftText:"domain",rightText:u.domain},{leftText:"path",rightText:u.path},{leftText:"expires",rightText:u.expires?new Date(u.expires).toISOString():"会话"},{leftText:"secure",rightText:JSON.stringify(u.secure)},{leftText:"sameSite",rightText:u.sameSite})),g.forEach(x=>{const _=d.createElement("div",{className:"cookie-item-group",innerHTML:`
                    ...
                    `});d.append(h,_);});let y=d.createElement("div",{className:"cookie-item-group cookie-item-group-control",innerHTML:`
                ...
                `}),m=y.querySelector(".cookie-item-group-control-copy"),S=y.querySelector(".cookie-item-group-control-edit"),A=y.querySelector(".cookie-item-group-control-delete");return d.on(m,"click",x=>{v.preventEvent(x);let _=u.value;v.setClip(_).then($=>{$?w.success("复制成功"):w.error("复制失败");});}),d.on(S,"click",x=>{v.preventEvent(x),ee.showView(u,_=>{let $=p(_);d.after(h,$),h.parentElement?.removeChild(h);});}),d.on(A,"click",x=>{v.preventEvent(x),confirm("确定删除该Cookie？")&&k.deleteCookie(u).then($=>{$?(b.error($),w.error("删除失败")):(w.success("删除成功"),h.parentElement?.removeChild(h));});}),d.append(h,[y]),h},f=async u=>{let h=await k.queryAllCookie();typeof u=="function"&&(h=h.filter(u)),d.empty(c);let g=document.createDocumentFragment();h.forEach(y=>{if(V.getValue("exclude-session-cookie")&&(y.session||k.cookieManagerApiName==="cookieStore"&&y.expires==null))return;const m=p(y);g.appendChild(m);}),c.appendChild(g);};f(),d.on(e,["input","propertychange"],v.debounce(u=>{f(h=>{let g=d.val(e);return V.getValue("search-config-use-regexp")?!!h.name.match(new RegExp(g)):h.name.includes(g)});})),d.listenKeyboard(e,"keypress",(u,h,g)=>{u==="Enter"&&g.length===0&&v.dispatchEvent(e,"input");}),d.on(o,"click",u=>{v.preventEvent(u);let g=C.alert({title:{text:"搜索配置",position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},drag:true,mask:{clickEvent:{toClose:true}},width:E.info.width,height:E.info.height,style:`
                    ${C.config.cssText.panelCSS}
                ...
                `}).$shadowRoot.querySelector(".pops-alert-content"),m=C.config.PanelHandlerComponents().createSectionContainerItem_switch(G("启用正则表达式","search-config-use-regexp",false,void 0,"使用正则表达式搜索Cookie名称"));d.append(g,m);}),d.on(i,"click",u=>{v.preventEvent(u),d.val(e)==""?f():v.dispatchEvent(e,"input");}),d.on(a,"click",u=>{v.preventEvent(u),ee.showView(void 0,h=>{f();});}),d.on(n,"click",u=>{v.preventEvent(u),k.queryAllCookie().then(h=>{if(h=h.filter(y=>!(y.session&&V.getValue("exclude-session-cookie"))),h.length===0){w.warning("没有Cookie可以复制");return}let g=h.map(y=>{let m=y.value;return `${y.name}=${m}; `}).join("");v.setClip(g).then(y=>{y?w.success("复制成功"):w.error("复制失败");});});}),d.on(l,"click",u=>{v.preventEvent(u),window.confirm("确定清除全部Cookie？")&&k.deleteAllCookie().then(g=>{g.error?w.warning(`清除成功：${g.success} 失败：${g.error}`):w.success("清除成功"),f();});}),d.on(r,"click",u=>{v.preventEvent(u),L.showView();}),d.on(s,"click",u=>{v.preventEvent(u);let g=C.alert({title:{text:"设置",position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},drag:true,mask:{clickEvent:{toClose:true}},width:E.info.width,height:E.info.height,style:`
                    ${C.config.cssText.panelCSS}
                ...
                `}).$shadowRoot.querySelector(".pops-alert-content"),y=C.config.PanelHandlerComponents(),m=y.createSectionContainerItem_select(W("CookieManager Api","cookie-manager-api","document.cookie",[{text:"document.cookie",value:"document.cookie"},{text:"cookieStore",value:"cookieStore"},{text:"GM_cookie",value:"GM_cookie"},{text:"GM.cookie",value:"GM.cookie"}],()=>{f();},"操作Cookie的Api函数")),S=y.createSectionContainerItem_switch(G("解码Cookie值","decode-cookie-value",false,()=>{f();},"对Cookie值进行解码")),A=y.createSectionContainerItem_switch(G("排除Session Cookie","exclude-session-cookie",false,()=>{f();},"过滤掉浏览器会话Cookie"));d.append(g,[m,S,A]);});},registerMenu(){const t=this;ce.add({key:"cookie_manager_view",text:"⚙ Cookie管理",autoReload:false,isStoreValue:false,showText(e,o){return e},callback(e){t.showView();}});}},Me={init(){this.execController(),d.ready(()=>{this.execController();});},execController(){for(let t=0;t<L.$data.ruleData.length;t++){const e=L.$data.ruleData[t];k.queryAllCookie().then(async o=>{for(let i=0;i<o.length;i++){let a=o[i];const n=a.name,l=e.data.cookieName;let r=false;if(e.data.enableRegExpToMatchCookieName?new RegExp(l,"i").test(n)&&(r=true):n.includes(l)&&(r=true),r){let s=e.data.operationMode;if(s==="delete")k.deleteCookie(a);else if(s==="extended"||s==="extended-90"||s==="extended-180"||s==="extended-360"){let c=Date.now(),p=30*24*60*60*1e3,f=p*3,u=p*6,h=p*12,g=p;s==="extended-90"?g=f:s==="extended-180"?g=u:s==="extended-360"&&(g=h);let y=false;if(k.cookieManagerApiName==="document.cookie")a.expirationDate=c+g,y=true;else if(k.cookieManagerApiName==="cookieStore"){let m=a.expires;typeof m=="number"&&m-c<g&&(a.expires=m+g,y=true);}else if(k.cookieManagerApiName==="GM_cookie"||k.cookieManagerApiName==="GM.cookie"){let m=a.expirationDate;typeof m=="number"&&m*1e3-c<g&&(a.expirationDate=m+g/1e3,y=true);}else b.error("未知的cookieManagerApiName",k.cookieManagerApiName);y&&await k.updateCookie(a);}}}});}}},X=function(t,e,o,i,a,n,l,r,s,c){let p={text:t,type:"button",attributes:{},props:{},description:e,buttonIcon:i,buttonIsRightIcon:a,buttonIconIsLoading:n,buttonType:l,buttonText:o,callback(f){typeof r=="function"&&r(f);},afterAddToUListCallBack:s};return Reflect.set(p.attributes,re,()=>{p.disable=false;}),p},$e={id:"view-rule",title:"规则",headerTitle:"Cookie操作规则",forms:[{type:"forms",text:"",forms:[X("自定义规则","操作Cookie的规则","管理",void 0,false,false,"default",()=>{L.showView();})]},{type:"forms",text:"",forms:[X("数据导入","导入自定义规则数据","导入",void 0,false,false,"primary",()=>{L.importRule();}),X("数据导出","导出自定义规则数据","导出",void 0,false,false,"primary",()=>{L.exportRule("CookieManagerRule.json");})]}]},Se={id:"view-general",title:"通用",forms:[{text:"Toast配置",type:"forms",forms:[W("Toast位置",D.qmsg_config_position.key,D.qmsg_config_position.defaultValue,[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,o)=>{b.info("设置当前Qmsg弹出位置"+o);},"Toast显示在页面九宫格的位置"),W("最多显示的数量",D.qmsg_config_maxnums.key,D.qmsg_config_maxnums.defaultValue,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),G("逆序弹出",D.qmsg_config_showreverse.key,D.qmsg_config_showreverse.defaultValue,void 0,"修改Toast弹出的顺序")]}]};K.addContentConfig([Se,$e]);V.init();L.init();Me.init();Ve.init();

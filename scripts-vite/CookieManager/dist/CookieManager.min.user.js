...
`)}{display: none !important;}`)},addBlockCSSWithEnd(...e){let t=w.addBlockCSS(...e);return t&&document.documentElement.appendChild(t),t},setGMResourceCSS(e){let t=typeof g==`function`?g(e.keyName):null;return typeof t==`string`&&t?ue(t):w.loadStyleLink(e.url)},async loadStyleLink(e){let n=document.createElement(`link`);return n.rel=`stylesheet`,n.type=`text/css`,n.href=e,new Promise(e=>{t.default.onReady(()=>{document.head.appendChild(n),e(n)})})},async loadScript(e){let t=document.createElement(`script`);return t.src=e,new Promise(e=>{t.onload=()=>{e(null)},(document.head||document.documentElement).appendChild(t)})},fixUrl(e){return e=e.trim(),e.startsWith(`data:`)||e.match(/^http(s|):\/\//i)?e:e.startsWith(`//`)?(e.startsWith(`///`)||(e=window.location.protocol+e),e):(e.startsWith(`/`)||(e+=`/`),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith(`https://`)||!e.startsWith(`http://`))return e;try{let t=new URL(e);return t.protocol=`https:`,t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement(`style`);t.innerHTML=`
      ...
      `}),n=t.$shadowRoot.querySelector(`.export-example-code-text-container pre`),r=t.$shadowRoot.querySelector(`#cookie-format-header_string`),i=t.$shadowRoot.querySelector(`#cookie-format-json`),a=t.$shadowRoot.querySelector(`#encode-pwd`),o={key:`cookie-backup-export-dialog-config`,getConfig(){return N.getValue(this.key,{exportType:`header_string`,encodePwd:``})},saveConfig(){let e=`header_string`;i.checked&&(e=`json`),N.setValue(this.key,{exportType:e,encodePwd:I.val(a)}),s=this.getConfig()}},s=o.getConfig();I.on(r,`input`,()=>{let e=[{name:`_ga`,value:`GA1.2.123456789.987654321`,domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:!1,path:`/`,sameSite:`unspecified`,secure:!1},{name:`PHPSESSID`,value:`28f2d88ee9322cfd2e4f1e`,domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:!1,path:`/`,sameSite:`unspecified`,secure:!1},{name:`csrftoken`,value:`abcdef123456`,domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:!1,path:`/`,sameSite:`unspecified`,secure:!1},{name:`logged_in`,value:`true`,domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:!1,path:`/`,sameSite:`unspecified`,secure:!1}],t=this.formatCookie(e,`header_string`);I.text(n,t),o.saveConfig()}),I.on(i,`input`,()=>{let e=this.formatCookie([{name:`sessionId`,value:`abc123xyz456`,domain:`.example.com`,path:`/`,secure:!0,httpOnly:!0,sameSite:`lax`,expirationDate:1713543600,hostOnly:!1,session:!1}],`json`);I.text(n,e),o.saveConfig()}),I.on(a,[`input`,`propertychange`],()=>{o.saveConfig()}),s.exportType===`header_string`?r.click():s.exportType===`json`&&i.click(),I.val(a,s.encodePwd)},showImportDialog(){let t=L.confirm({title:{text:`导入 Cookie`,position:`center`},content:{text:`

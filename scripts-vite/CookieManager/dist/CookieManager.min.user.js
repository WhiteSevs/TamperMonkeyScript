...
// @require      https://fastly.jsdelivr.net/npm/@whitesev/utils@2.11.5/dist/index.umd.min.js
// @require      https://fastly.jsdelivr.net/npm/@whitesev/domutils@1.9.7/dist/index.umd.min.js
// @require      https://fastly.jsdelivr.net/npm/@whitesev/pops@3.3.5/dist/index.umd.min.js
...
`));}});},getMatchedRuleList(t=window.location.href){const e=this.getData(),n=[];return e.forEach(i=>{if(!i.enable)return;let o=i.data.url;if(i.data.enableRegExpToMatchUrl){if(!new RegExp(o,"i").test(t))return}else if(!t.includes(o))return;n.push(i);}),n},showView(){let t=S.config.PanelHandlerComponents();function e(o){return {get(a,r){return Reflect.get(o,a)??r},set(a,r){Reflect.set(o,a,r);}}}const n=this.getMatchedRuleList();new Ze({title:"Cookie规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:o=>o.name,updateData:o=>this.updateData(o),deleteData:o=>this.deleteData(o),getData:o=>this.getData().find(l=>l.uuid===o.uuid)??o,itemControls:{enable:{enable:true,getEnable(o){return o.enable},callback:(o,a)=>{o.enable=a,this.updateData(o);}},edit:{enable:true,getView:(o,a)=>{const r=document.createDocumentFragment(),l=this.getTemplateData();a||(o=l);const c=W("启用","enable",l.enable);Reflect.set(c.props,N,e(o));const d=t.createSectionContainerItem_switch(c).$el,h=ye("规则名称","name","",l.name,void 0,"必填");Reflect.set(h.props,N,e(o));const f=t.createSectionContainerItem_input(h).$el,u=ie("Cookie管理Api","execApiName",l.data.execApiName,[{text:"（当前）"+L.cookieManagerApiName,value:"use-global"},...$e.map(A=>({text:A,value:A}))],void 0,"操作Cookie的Api函数");Reflect.set(u.props,N,e(o.data));const m=t.createSectionContainerItem_select(u).$el,p=ye("网址","url",l.data.url,"用于执行该规则的网址",void 0,"必填");Reflect.set(p.props,N,e(o.data));const k=t.createSectionContainerItem_input(p).$el,w=W("启用正则匹配网址","enableRegExpToMatchUrl",l.data.enableRegExpToMatchUrl);Reflect.set(w.props,N,e(o.data));const g=t.createSectionContainerItem_switch(w).$el,b=ye("Cookie名称","cookieName",l.data.cookieName,"用于匹配执行操作的Cookie名",void 0,"必填");Reflect.set(b.props,N,e(o.data));const v=t.createSectionContainerItem_input(b).$el,V=W("启用正则匹配Cookie名称","enableRegExpToMatchCookieName",l.data.enableRegExpToMatchCookieName);Reflect.set(V.props,N,e(o.data));const x=t.createSectionContainerItem_switch(V).$el,C=ie("操作模式","operationMode",l.data.operationMode,[{value:"delete",text:"删除Cookie"},{value:"extended",text:"自动延长Cookie有效期30天"},{value:"extended-90",text:"自动延长Cookie有效期90天"},{value:"extended-180",text:"自动延长Cookie有效期180天"},{value:"extended-360",text:"自动延长Cookie有效期360天"}]);Reflect.set(C.props,N,e(o.data));const E=t.createSectionContainerItem_select(C).$el,T=Je("备注","remark",l.data.remark);Reflect.set(T.props,N,e(o.data));const $=t.createSectionContainerItem_textarea(T).$el;return r.append(d,f,m,k,g,v,x,E,$),r},onsubmit:(o,a,r)=>{const l=o.querySelectorAll(".rule-form-ulist > li"),c=this.getTemplateData();a&&(c.uuid=r.uuid);try{return l.forEach(d=>{const h=Reflect.get(d,t.$data.nodeStoreConfigKey),f=Reflect.get(h,"attributes"),u=Reflect.get(d,N),m=Reflect.get(f,Y),p=Reflect.get(f,Z),k=u.get(m,p);Reflect.has(c,m)?Reflect.set(c,m,k):Reflect.has(c.data,m)?Reflect.set(c.data,m,k):M.error(`${m}不在数据中`);}),c.name.trim()===""?(y.error("规则名称不能为空"),{success:!1,data:c}):c.data.url.trim()===""?(y.error("网址不能为空"),{success:!1,data:c}):c.data.cookieName.trim()===""?(y.error("Cookie名称不能为空"),{success:!1,data:c}):a?{success:this.updateData(c),data:c}:{success:this.addData(c),data:c}}catch(d){return M.error(d),{success:false,data:c}}finally{this.init();}},style:`
      ...
      `}).$shadowRoot.querySelector(".pops-confirm-content"),l=S.config.PanelHandlerComponents(),c=l.createSectionContainerItem_input(re("name",()=>o.name,g=>o.name=g,n)).$el,d=l.createSectionContainerItem_textarea(Qe("value",()=>o.value,g=>o.value=g)).$el,h=l.createSectionContainerItem_input(re("domain",()=>o.domain,g=>o.domain=g)).$el,f=l.createSectionContainerItem_input(re("path",()=>o.path,g=>o.path=g)).$el;let u;if(o.session)u=l.createSectionContainerItem_input(re("expires",()=>"会话",()=>{},true)).$el;else {const g=We(()=>{const b=s.createElement("li",{innerHTML:`

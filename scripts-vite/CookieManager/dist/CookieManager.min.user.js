...
`)}{display: none !important;}`)},setGMResourceCSS(t){const e=typeof Ce=="function"?Ce(t.keyName):null;return typeof e=="string"&&e?$e(e):Ee.loadStyleLink(t.url)},async loadStyleLink(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,new Promise(i=>{O.ready(()=>{document.head.appendChild(e),i(e);});})},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(i=>{e.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let i=[document.documentElement,document.body].concat(...t||[]);return i.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){i.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(n){navigator.clipboard.readText().then(o=>{n(o);}).catch(o=>{_.error("读取剪贴板内容失败👉",o),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(o=>{t(n);}).catch(o=>{_.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),t(n);});}function i(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!i()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,i=5e3){let n,o=i-e,l=e,a=async r=>{let s=await t(r);if(typeof s=="boolean"&&!s||r){C.workerClearTimeout(n);return}if(l+=e,l>o){a(true);return}n=C.workerSetTimeout(()=>{a(false);},e);};a(false);},findParentNode(t,e,i){if(i){let n=O.closest(t,i);if(n)return n.querySelector(e)}else return O.matches(t,e)?t:O.closest(t,e)}},D={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new C.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new C.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new C.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new C.Dictionary),this.__onceExecData},get scriptName(){return _e},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:Ve,attributeKeyName:j,attributeDefaultValueName:K},init(){this.initContentDefaultValue(),Ue.init();},isTopWindow(){return G.top===G.self},initContentDefaultValue(){const t=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const o=n.attributes;let l=o[Re];if(typeof l=="function"){let u=l();if(typeof u=="boolean"&&!u)return}let a=new Map,r=o[j];if(r!=null){const u=o[K];a.set(r,u);}let s=o[Ge];if(typeof s=="object"&&s&&Object.keys(s).forEach(u=>{a.set(u,s[u]);}),!a.size){_.warn(["请先配置键",n]);return}if(n.type==="switch"){let u=typeof n.disabled=="function"?n.disabled():n.disabled;typeof u=="boolean"&&u&&this.$data.contentConfigInitDisabledKeys.push(...a.keys());}for(const[u,c]of a.entries())this.setDefaultValue(u,c);},e=n=>{for(let o=0;o<n.length;o++){let l=n[o];t(l);let a=l.forms;a&&Array.isArray(a)&&e(a);}},i=[...ne.getAllContentConfig()];for(let n=0;n<i.length;n++){let o=i[n];if(!o.forms)continue;const l=o.forms;l&&Array.isArray(l)&&e(l);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(t,e){this.$data.contentConfigInitDefaultValue.has(t)&&_.warn("请检查该key(已存在): "+t),this.$data.contentConfigInitDefaultValue.set(t,e);},getDefaultValue(t){return this.$data.contentConfigInitDefaultValue.get(t)},setValue(t,e){z.set(t,e);},getValue(t,e){const i=z.get(t);return i??(this.$data.contentConfigInitDefaultValue.has(t)?this.$data.contentConfigInitDefaultValue.get(t):e)},deleteValue(t){z.delete(t);},hasKey(t){return z.has(t)},addValueChangeListener(t,e){return z.addValueChangeListener(t,(n,o,l)=>{e(t,l,o);})},removeValueChangeListener(t){z.removeValueChangeListener(t);},triggerMenuValueChange(t,e,i){z.triggerValueChangeListener(t,i,e);},async exec(t,e,i,n=true){const o=this;let l;typeof t=="string"||Array.isArray(t)?l=()=>t:l=t;let a=false;const r=l();let s=[];Array.isArray(r)?(a=true,s=r):s.push(r);const u=s.find(x=>!this.$data.contentConfigInitDefaultValue.has(x));if(u){_.warn(`${u} 键不存在`);return}const c=JSON.stringify(s);if(n&&this.$data.onceExecMenuData.has(c))return this.$data.onceExecMenuData.get(c);let d=[];const m=[];let h=[];const f=(x,M)=>{let V=[],R=[],v=[];if(Array.isArray(M))v=v.concat(M);else if(typeof M=="object"&&M!=null)if(M instanceof Element)v.push(M);else {const{$css:$,destory:N}=M;$!=null&&(Array.isArray($)?v=v.concat($):v.push($)),typeof N=="function"&&v.push(N);}else v.push(M);for(const $ of v)if($!=null){if($ instanceof Element){V.push($);continue}if(typeof $=="function"){h.push($);continue}}x?(d=d.concat(V),h=h.concat(R)):(y(),w());},g=x=>this.getValue(x),y=()=>{for(let x=0;x<d.length;x++)d[x]?.remove(),d.splice(x,1),x--;},w=()=>{for(let x=0;x<h.length;x++){const M=h[x];M(),h.splice(x,1),x--;}},b=()=>{let x=false;return typeof i=="function"?x=i(s):x=s.every(M=>g(M)),x},E=async x=>{if(b()){const V=s.map(v=>this.getValue(v)),R=await e({value:a?V:V[0],addStoreValue:(...v)=>f(true,v)});f(true,R);}else f(false,[]);};n&&s.forEach(x=>{const M=this.addValueChangeListener(x,(V,R,v)=>E());m.push(M);}),await E();const A={reload(){this.clearStoreStyleElements(),this.destory(),E();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>y(),destory(){return w()},removeValueChangeListener:()=>{m.forEach(x=>{this.removeValueChangeListener(x);});},clearOnceExecMenuData(){n&&o.$data.onceExecMenuData.delete(c);}};return this.$data.onceExecMenuData.set(c,A),A},async execMenu(t,e,i=false,n=false){return await this.exec(t,async o=>await e(o),o=>o.every(a=>{let r=!!this.getValue(a);return D.$data.contentConfigInitDisabledKeys.includes(a)&&(r=false,_.warn(`.execMenu${n?"Once":""} ${a} 被禁用`)),i&&(r=!r),r}),n)},async execMenuOnce(t,e,i=false,n=false){const o=await this.execMenu(t,e,i,true);if(n&&o){const l=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(t),this.addUrlChangeWithExecMenuOnceListener(t,l);}return o},deleteExecMenuOnce(t){return t=this.transformKey(t),this.$data.onceExecMenuData.delete(t),this.$data.urlChangeReloadMenuExecOnce.delete(t),z.removeValueChangeListener(t)},onceExec(t,e){if(t=this.transformKey(t),typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},deleteOnceExec(t){t=this.transformKey(t),this.$data.onceExecData.delete(t);},addUrlChangeWithExecMenuOnceListener(t,e){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.set(t,e);},removeUrlChangeWithExecMenuOnceListener(t){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.delete(t);},hasUrlChangeWithExecMenuOnceListener(t){return t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.has(t)},async triggerUrlChangeWithExecMenuOnceEvent(t){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const i of e)await i(t);},showPanel(t,e=`${_e}-设置`,i=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let o=t.findIndex(a=>(typeof a.isBottom=="function"?a.isBottom():!!a.isBottom)&&a.id==="script-version")!==-1;!i&&!o&&t.push(...ne.getDefaultBottomContentConfig());let l=S.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(a,r)=>{a.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(a,r)=>{a(),this.$data.$panel=null;}},width:q.setting.width,height:q.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=l,this.$data.panelContent=t,n||this.registerConfigSearch({$panel:l,content:t});},registerConfigSearch(t){const{$panel:e,content:i}=t;let n=async(c,d)=>{if(c==null)return;let m=await d(c);return m&&typeof m.isFind=="boolean"&&m.isFind?m.data:await n(m.data,d)},o=(c,d)=>{const m=new IntersectionObserver(h=>{h.forEach(f=>{f.isIntersecting&&(d?.(),m.disconnect());});},{root:null,threshold:1});m.observe(c),c.scrollIntoView({behavior:"smooth",block:"center"});},l=c=>{const d="pops-flashing";p.animationend(c,()=>{c.classList.remove(d);}),c.classList.add(d);},a=(c,d)=>{p.preventEvent(c);let m=S.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});m.$shadowRoot.querySelector(".search-wrapper");let h=m.$shadowRoot.querySelector(".search-config-text"),f=m.$shadowRoot.querySelector(".search-result-wrapper");h.focus();let g=()=>{p.empty(f);},y=b=>{const E=C.queryProperty(b,x=>x?.next?{isFind:false,data:x.next}:{isFind:true,data:x});let A=p.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return p.on(A,"click",x=>{let V=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[b.index];if(!V){k.error(`左侧项下标${b.index}不存在`);return}V.scrollIntoView({behavior:"smooth",block:"center"}),V.click(),n(b.next,async R=>{if(R?.next){let v=await p.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find($=>{const N=Reflect.get($,"__formConfig__");return typeof N=="object"&&N!=null&&N.text===R.name}),2500);if(v)v.click();else return k.error("未找到对应的二级菜单"),{isFind:true,data:R};return {isFind:false,data:R.next}}else {let v=await p.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find($=>Reflect.get($,"__formConfig__")===R.matchedData?.formConfig),2500);if(v){o(v);let $=v.closest(".pops-panel-forms-fold[data-fold-enable]");$&&($.querySelector(".pops-panel-forms-fold-container").click(),await C.sleep(500)),o(v,()=>{l(v);});}else k.error("未找到对应的菜单项");return {isFind:true,data:R}}});}),A},w=b=>{const E=new RegExp(b,"i"),A=[],x=(V,R)=>{for(let v=0;v<V.length;v++){const $=V[v];let N=$.forms;if(N&&Array.isArray(N)){const Y=C.deepClone(R);if($.type==="deepMenu"){const ee=C.queryProperty(Y,W=>W?.next?{isFind:false,data:W.next}:{isFind:true,data:W});ee.next={name:$.text};}x(N,Y);}else {let Y=Reflect.get($,"text"),ee=Reflect.get($,"description");const W=[Y,ee];let ke=W.findIndex(J=>{if(typeof J=="string")return J.match(E)});if(ke!==-1){const J=C.deepClone(R),be=C.queryProperty(J,U=>U?.next?{isFind:false,data:U.next}:{isFind:true,data:U});be.next={name:Y,matchedData:{path:"",formConfig:$,matchedText:W[ke],description:ee}};const ve=[];C.queryProperty(J,U=>{const le=U?.name;return typeof le=="string"&&le.trim()!==""&&ve.push(le),U?.next?{isFind:false,data:U.next}:{isFind:true,data:U}});const Te=ve.join(Ee.escapeHtml(" - "));be.next.matchedData.path=Te,A.push(J);}}}};for(let V=0;V<i.length;V++){const R=i[V];if(!R.forms||R.isBottom&&R.id==="script-version")continue;const v=R.forms;if(v&&Array.isArray(v)){let $=R.title;typeof $=="function"&&($=$()),x(v,{index:V,name:$});}}let M=document.createDocumentFragment();for(const V of A){let R=y(V);M.appendChild(R);}g(),f.append(M);};p.on(h,"input",C.debounce(b=>{p.preventEvent(b);let E=p.val(h).trim();if(E===""){g();return}w(E);},200));},r=null,s=false,u;p.on(e.$shadowRoot,"dblclick","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",a),p.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(c,d)=>{clearTimeout(u),u=void 0,s&&r===d?(s=false,r=null,a(c)):(u=setTimeout(()=>{s=false;},200),s=true,r=d);},{capture:true}),e.$shadowRoot.appendChild(p.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`));}});},getMatchedRuleList(t=window.location.href){const e=this.getData(),i=[];return e.forEach(n=>{if(!n.enable)return;let o=window.location.href,l=n.data.url;if(n.data.enableRegExpToMatchUrl){if(!new RegExp(l,"i").test(o))return}else if(!o.includes(l))return;i.push(n);}),i},showView(){let t=S.config.PanelHandlerComponents();function e(o,l){return {get(a,r){return Reflect.get(o,a)??r},set(a,r){Reflect.set(o,a,r);}}}const i=this.getMatchedRuleList();new Ke({title:"Cookie规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:o=>o.name,updateData:o=>this.updateData(o),deleteData:o=>this.deleteData(o),getData:o=>this.getData().find(r=>r.uuid===o.uuid)??o,itemControls:{enable:{enable:true,getEnable(o){return o.enable},callback:(o,l)=>{o.enable=l,this.updateData(o);}},edit:{enable:true,getView:(o,l)=>{let a=document.createDocumentFragment(),r=this.getTemplateData();l||(o=r);let s=B("启用","enable",r.enable);Reflect.set(s.props,L,e(o));let u=t.createSectionContainerItem_switch(s),c=ue("规则名称","name","",r.name,void 0,"必填");Reflect.set(c.props,L,e(o));let d=t.createSectionContainerItem_input(c),m=X("Cookie管理Api","execApiName",r.data.execApiName,[{text:"（当前）"+T.cookieManagerApiName,value:"use-global"},...we.map($=>({text:$,value:$}))],void 0,"操作Cookie的Api函数");Reflect.set(m.props,L,e(o.data));let h=t.createSectionContainerItem_select(m),f=ue("网址","url",r.data.url,"用于执行该规则的网址",void 0,"必填");Reflect.set(f.props,L,e(o.data));let g=t.createSectionContainerItem_input(f),y=B("启用正则匹配网址","enableRegExpToMatchUrl",r.data.enableRegExpToMatchUrl);Reflect.set(y.props,L,e(o.data));let w=t.createSectionContainerItem_switch(y),b=ue("Cookie名称","cookieName",r.data.cookieName,"用于匹配执行操作的Cookie名",void 0,"必填");Reflect.set(b.props,L,e(o.data));let E=t.createSectionContainerItem_input(b),A=B("启用正则匹配Cookie名称","enableRegExpToMatchCookieName",r.data.enableRegExpToMatchCookieName);Reflect.set(A.props,L,e(o.data));let x=t.createSectionContainerItem_switch(A),M=X("操作模式","operationMode",r.data.operationMode,[{value:"delete",text:"删除Cookie"},{value:"extended",text:"自动延长Cookie有效期30天"},{value:"extended-90",text:"自动延长Cookie有效期90天"},{value:"extended-180",text:"自动延长Cookie有效期180天"},{value:"extended-360",text:"自动延长Cookie有效期360天"}]);Reflect.set(M.props,L,e(o.data));let V=t.createSectionContainerItem_select(M),R=Be("备注","remark",r.data.remark);Reflect.set(R.props,L,e(o.data));let v=t.createSectionContainerItem_textarea(R);return a.append(u,d,h,g,w,E,x,V,v),a},onsubmit:(o,l,a)=>{let r=o.querySelectorAll(".rule-form-ulist > li"),s=this.getTemplateData();l&&(s.uuid=a.uuid);try{return r.forEach(u=>{let c=Reflect.get(u,"__formConfig__"),d=Reflect.get(c,"attributes"),m=Reflect.get(u,L),h=Reflect.get(d,j),f=Reflect.get(d,K),g=m.get(h,f);Reflect.has(s,h)?Reflect.set(s,h,g):Reflect.has(s.data,h)?Reflect.set(s.data,h,g):_.error(`${h}不在数据中`);}),s.name.trim()===""?(k.error("规则名称不能为空"),{success:!1,data:s}):s.data.url.trim()===""?(k.error("网址不能为空"),{success:!1,data:s}):s.data.cookieName.trim()===""?(k.error("Cookie名称不能为空"),{success:!1,data:s}):l?{success:this.updateData(s),data:s}:{success:this.addData(s),data:s}}catch(u){return _.error(u),{success:false,data:s}}finally{this.init();}},style:`
                    ...
                    `},delete:{enable:true,deleteCallBack:o=>this.deleteData(o)}},bottomControls:{filter:{enable:true,option:[{name:"过滤-已启用",filterCallBack(o){return o.enable}},{name:"过滤-未启用",filterCallBack(o){return !o.enable}},{name:"过滤-当前网站执行",filterCallBack(o){return i.some(l=>l.uuid===o.uuid)}}]}}}).showView();},getTemplateData(){return {uuid:C.generateUUID(),enable:true,name:"",data:{url:"",execApiName:"use-global",enableRegExpToMatchUrl:false,cookieName:"",enableRegExpToMatchCookieName:false,operationMode:"delete",remark:""}}},getData(){return me(this.$key.STORAGE_KEY,[])},setData(t){ie(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(n=>n.uuid==t.uuid)===-1?(e.push(t),ie(this.$key.STORAGE_KEY,e),true):false},updateData(t){let e=this.getData(),i=e.findIndex(o=>o.uuid==t.uuid),n=false;return i!==-1&&(n=true,e[i]=t),this.setData(e),n},deleteData(t){let e=this.getData(),i=e.findIndex(o=>o.uuid==t.uuid),n=false;return i!==-1&&(n=true,e.splice(i,1)),this.setData(e),n},clearData(){Me(this.$key.STORAGE_KEY);},exportRule(t="rule.json"){let e=this.getData(),i=new Blob([JSON.stringify(e,null,4)]),n=window.URL.createObjectURL(i),o=p.createElement("a");o.href=n,o.download=t,o.click(),setTimeout(()=>{window.URL.revokeObjectURL(n);},1500);},importRule(){let t=S.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            ...
            `}),e=t.$shadowRoot.querySelector(".import-mode[data-mode='local']"),i=t.$shadowRoot.querySelector(".import-mode[data-mode='network']");p.on(e,"click",n=>{p.preventEvent(n),t.close();let o=p.createElement("input",{type:"file",accept:".json"});p.on(o,["propertychange","input"],l=>{if(!o.files?.length)return;let a=o.files[0],r=new FileReader;r.onload=()=>{let s=C.toJSON(r.result);if(!Array.isArray(s)){_.error("不是正确的规则文件",s),k.error("不是正确的规则文件");return}this.setData(s),k.success(`成功导入 ${s.length}条规则`);},r.readAsText(a,"UTF-8");}),o.click();}),p.on(i,"click",n=>{p.preventEvent(n),t.close(),S.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"url",focus:true},btn:{ok:{callback:async(o,l)=>{let a=o.text;if(C.isNull(a)){k.error("请填入完整的url");return}let r=await xe.get(a);if(!r.status)return;let s=C.toJSON(r.data.responseText);if(!Array.isArray(s)){_.error("不是正确的规则文件",r,s),k.error("不是正确的规则文件");return}this.setData(s),o.close(),k.success(`成功导入 ${s.length}条规则`);}}},width:q.info.width,height:"auto"});});}},Q={encrypt(t,e){return se.AES.encrypt(t,e).toString()},decrypt(t,e){return se.AES.decrypt(t,e).toString(se.enc.Utf8)},formatCookie(t,e,i){let n="";if(e==="header_string")n=t.map(o=>{let l=o.value;return `${o.name}=${l}; `}).join("");else if(e==="json")n=JSON.stringify({api:T.cookieManagerApiName,hostname:window.location.hostname,data:t},null,2);else throw new Error("不支持的格式化类型："+e);return i&&(n=this.encrypt(n,i)),n},showExportDialog(){let t=S.confirm({title:{text:"导出 Cookie",position:"center"},content:{text:`
				...
				`}),e=t.$shadowRoot.querySelector(".export-example-code-text-container pre"),i=t.$shadowRoot.querySelector("#cookie-format-header_string"),n=t.$shadowRoot.querySelector("#cookie-format-json"),o=t.$shadowRoot.querySelector("#encode-pwd");const l={key:"cookie-backup-export-dialog-config",getConfig(){return D.getValue(this.key,{exportType:"header_string",encodePwd:""})},saveConfig(){let r="header_string";n.checked&&(r="json"),D.setValue(this.key,{exportType:r,encodePwd:p.val(o)}),a=this.getConfig();}};let a=l.getConfig();p.on(i,"input",()=>{const r=[{name:"_ga",value:"GA1.2.123456789.987654321",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"PHPSESSID",value:"28f2d88ee9322cfd2e4f1e",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"csrftoken",value:"abcdef123456",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"logged_in",value:"true",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false}];let s=this.formatCookie(r,"header_string");p.text(e,s),l.saveConfig();}),p.on(n,"input",()=>{const r=[{name:"sessionId",value:"abc123xyz456",domain:".example.com",path:"/",secure:true,httpOnly:true,sameSite:"lax",expirationDate:1713543600,hostOnly:false,session:false}];let s=this.formatCookie(r,"json");p.text(e,s),l.saveConfig();}),p.on(o,["input","propertychange"],()=>{l.saveConfig();}),a.exportType==="header_string"?i.click():a.exportType==="json"&&n.click(),p.val(o,a.encodePwd);},showImportDialog(){let t=S.confirm({title:{text:"导入 Cookie",position:"center"},content:{text:`
					...
					`,html:true},width:window.innerWidth<400?"88vw":"400px",height:"auto",btn:{ok:{text:"导入",async callback(d,m){try{const h=c.decodePwd;let f=c.value;h.trim()===""||(f=Q.decrypt(f,h));const g=C.toJSON(f);if(Array.isArray(g)){_.info(`使用${T.cookieManagerApiName}导入cookie数据`);for(const y of g)await T.updateCookie(y);}else if(typeof g=="object"&&Object.keys(g).length&&Array.isArray(g.data)){const y=new ye(g.api);_.info(`使用${y.cookieManagerApiName}导入cookie数据`);for(const w of g.data)await y.updateCookie(w);}else if(typeof g=="object"&&!Object.keys(g).length){let y=new C.GM_Cookie;_.info(`使用${T.cookieManagerApiName}导入cookie数据`);let w=y.parseCookie(f);for(const b of w)await T.updateCookie({name:b.key,value:b.value,domain:window.location.hostname,path:"/",sameSite:"unspecified",secure:!1,session:!1,hostOnly:!0,httpOnly:!1});}else {_.error(f,g),k.error("cookie格式不符合");return}d.close();}catch(h){k.error(h.toString());}}}},style:`
					${S.config.cssText.panelCSS}

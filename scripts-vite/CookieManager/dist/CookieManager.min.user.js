...
`)}{display: none !important;}`)},setGMResourceCSS(t){const e=typeof Ee=="function"?Ee(t.keyName):null;return typeof e=="string"&&e?Te(e):ee.loadStyleLink(t.url)},async loadStyleLink(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,new Promise(i=>{U.ready(()=>{document.head.appendChild(e),i(e);});})},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(i=>{e.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let i=[document.documentElement,document.body].concat(...t||[]);return i.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){i.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(n){navigator.clipboard.readText().then(o=>{n(o);}).catch(o=>{R.error("读取剪贴板内容失败👉",o),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(o=>{t(n);}).catch(o=>{R.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),t(n);});}function i(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!i()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,i=5e3){let n,o=i-e,l=e,a=async r=>{let c=await t(r);if(typeof c=="boolean"&&!c||r){$.workerClearTimeout(n);return}if(l+=e,l>o){a(true);return}n=$.workerSetTimeout(()=>{a(false);},e);};a(false);},findParentNode(t,e,i){if(i){let n=U.closest(t,i);if(n)return n.querySelector(e)}else return U.matches(t,e)?t:U.closest(t,e)},toStr(t){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(t,(n,o)=>o===void 0?e:o,2).replace(new RegExp(`"${e}"`,"g"),"undefined")}},D={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new $.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new $.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new $.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new $.Dictionary),this.__onceExecData},get scriptName(){return be},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:ce,attributeKeyName:J,attributeDefaultValueName:Y},init(){this.initContentDefaultValue(),je.init();},isTopWindow(){return z.top===z.self},initContentDefaultValue(){const t=n=>{if(!n.attributes||n.type==="button"||n.type==="container"||n.type==="deepMenu")return;const o=n.attributes;let l=o[Ce];if(typeof l=="function"){let p=l();if(typeof p=="boolean"&&!p)return}let a=new Map,r=o[J];if(r!=null){const p=o[Y];a.set(r,p);}let c=o[Pe];if(typeof c=="object"&&c&&Object.keys(c).forEach(p=>{const u=c[p];a.set(p,u);}),!a.size){R.warn(["请先配置键",n]);return}if(n.type==="switch"){let p=typeof n.disabled=="function"?n.disabled():n.disabled;typeof p=="boolean"&&p&&this.$data.contentConfigInitDisabledKeys.push(...a.keys());}for(const[p,u]of a.entries())this.setDefaultValue(p,u);},e=n=>{for(let o=0;o<n.length;o++){let l=n[o];t(l);let a=l.views;a&&Array.isArray(a)&&e(a);}},i=[...pe.getAllContentConfig()];for(let n=0;n<i.length;n++){let o=i[n];if(!o.views)continue;const l=o.views;l&&Array.isArray(l)&&e(l);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(t,e){this.$data.contentConfigInitDefaultValue.has(t)&&R.warn("请检查该key(已存在): "+t),this.$data.contentConfigInitDefaultValue.set(t,e);},getDefaultValue(t){return this.$data.contentConfigInitDefaultValue.get(t)},setValue(t,e){H.set(t,e);},getValue(t,e){const i=H.get(t);return i??(this.$data.contentConfigInitDefaultValue.has(t)?this.$data.contentConfigInitDefaultValue.get(t):e)},deleteValue(t){H.delete(t);},hasKey(t){return H.has(t)},addValueChangeListener(t,e){return H.addValueChangeListener(t,(n,o,l)=>{e(t,l,o);})},removeValueChangeListener(t){H.removeValueChangeListener(t);},triggerMenuValueChange(t,e,i){H.triggerValueChangeListener(t,i,e);},async exec(t,e,i,n=true){const o=this;let l;typeof t=="string"||Array.isArray(t)?l=()=>t:l=t;let a=false;const r=l();let c=[];Array.isArray(r)?(a=true,c=r):c.push(r);const p=c.find(g=>!this.$data.contentConfigInitDefaultValue.has(g));if(p){R.warn(`${p} 键不存在`);return}const u=JSON.stringify(c);if(n&&this.$data.onceExecMenuData.has(u))return this.$data.onceExecMenuData.get(u);let f=[];const h=[];let m=[];const d=(g,v)=>{let E=[],T=[],M=[];if(Array.isArray(v))M=M.concat(v);else if(typeof v=="object"&&v!=null)if(v instanceof Element)M.push(v);else {const{$css:V,destory:A}=v;V!=null&&(Array.isArray(V)?M=M.concat(V):M.push(V)),typeof A=="function"&&M.push(A);}else M.push(v);for(const V of M)if(V!=null){if(V instanceof Element){E.push(V);continue}if(typeof V=="function"){m.push(V);continue}}g?(f=f.concat(E),m=m.concat(T)):(b(),w());},y=g=>!!this.getValue(g),b=()=>{for(let g=0;g<f.length;g++)f[g]?.remove(),f.splice(g,1),g--;},w=()=>{for(let g=0;g<m.length;g++){const v=m[g];v(),m.splice(g,1),g--;}},k=()=>{let g=false;return typeof i=="function"?g=i(c):g=c.every(v=>y(v)),g},C=async g=>{if(k()){const E=c.map(M=>this.getValue(M)),T=await e({value:a?E:E[0],addStoreValue:(...M)=>d(true,M)});d(true,T);}else d(false,[]);};n&&c.forEach(g=>{const v=this.addValueChangeListener(g,(E,T,M)=>C());h.push(v);}),await C();const _={reload(){this.clearStoreStyleElements(),this.destory(),C();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>b(),destory(){return w()},removeValueChangeListener:()=>{h.forEach(g=>{this.removeValueChangeListener(g);});},clearOnceExecMenuData(){n&&o.$data.onceExecMenuData.delete(u);}};return this.$data.onceExecMenuData.set(u,_),_},async execMenu(t,e,i=false,n=false){return await this.exec(t,async o=>await e(o),o=>o.every(a=>{let r=!!this.getValue(a);return D.$data.contentConfigInitDisabledKeys.includes(a)&&(r=false,R.warn(`.execMenu${n?"Once":""} ${a} 被禁用`)),i&&(r=!r),r}),n)},async execMenuOnce(t,e,i=false,n=false){const o=await this.execMenu(t,e,i,true);if(n&&o){const l=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(t),this.addUrlChangeWithExecMenuOnceListener(t,l);}return o},deleteExecMenuOnce(t){return t=this.transformKey(t),this.$data.onceExecMenuData.delete(t),this.$data.urlChangeReloadMenuExecOnce.delete(t),H.removeValueChangeListener(t)},onceExec(t,e){if(t=this.transformKey(t),typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},deleteOnceExec(t){t=this.transformKey(t),this.$data.onceExecData.delete(t);},addUrlChangeWithExecMenuOnceListener(t,e){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.set(t,e);},removeUrlChangeWithExecMenuOnceListener(t){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.delete(t);},hasUrlChangeWithExecMenuOnceListener(t){return t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.has(t)},async triggerUrlChangeWithExecMenuOnceEvent(t){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const i of e)await i(t);},showPanel(t,e=`${be}-设置`,i=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let o=t.findIndex(a=>(typeof a.isBottom=="function"?a.isBottom():!!a.isBottom)&&a.id==="script-version")!==-1;!i&&!o&&t.push(...pe.getDefaultBottomContentConfig());let l=S.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(a,r)=>{a.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(a,r)=>{a(),this.$data.$panel=null;}},width:N.setting.width,height:N.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=l,this.$data.panelContent=t,n||this.registerConfigSearch({$panel:l,content:t});},registerConfigSearch(t){const{$panel:e,content:i}=t,n=async(h,m)=>{if(h==null)return;const d=await m(h);return d&&typeof d.isFind=="boolean"&&d.isFind?d.data:await n(d.data,m)},o=(h,m)=>{const d=new IntersectionObserver(y=>{y.forEach(b=>{b.isIntersecting&&(m?.(),d.disconnect());});},{root:null,threshold:1});d.observe(h),h.scrollIntoView({behavior:"smooth",block:"center"});},l=h=>{const m="pops-flashing";s.animationend(h,()=>{h.classList.remove(m);}),h.classList.add(m);},a=h=>{if(h.type==="dblclick"&&f)return;s.preventEvent(h),c=null;const m=S.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${t.searchDialogStyle??""}
				`});m.$shadowRoot.querySelector(".search-wrapper");const d=m.$shadowRoot.querySelector(".search-config-text"),y=m.$shadowRoot.querySelector(".search-result-wrapper");d.focus();const b=()=>{s.empty(y);},w=C=>{const _=$.queryProperty(C,E=>E?.next?{isFind:false,data:E.next}:{isFind:true,data:E}),g=s.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),v=S.config.PanelHandlerComponents();return s.on(g,"click",E=>{const M=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[C.index];if(!M){x.error(`左侧项下标${C.index}不存在`);return}M.scrollIntoView({behavior:"smooth",block:"center"}),M.click(),n(C.next,async V=>{if(V?.next){const A=await s.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(F=>{const I=Reflect.get(F,v.$data.nodeStoreConfigKey);return typeof I=="object"&&I!=null&&I.text===V.name}),2500);if(A)A.click();else return x.error("未找到对应的二级菜单"),{isFind:true,data:V};return {isFind:false,data:V.next}}else {const A=await s.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(F=>Reflect.get(F,v.$data.nodeStoreConfigKey)===V.matchedData?.formConfig),2500);if(A){o(A);const F=A.closest(".pops-panel-forms-fold[data-fold-enable]");F&&(F.querySelector(".pops-panel-forms-fold-container").click(),await $.sleep(500)),o(A,()=>{l(A);});}else x.error("未找到对应的菜单项");return {isFind:true,data:V}}});}),g},k=C=>{const _=new RegExp(C,"i"),g=[],v=(T,M)=>{for(let V=0;V<T.length;V++){const A=T[V],F=A.views;if(F&&Array.isArray(F)){const I=$.deepClone(M);if(A.type==="deepMenu"){const Z=$.queryProperty(I,Q=>Q?.next?{isFind:false,data:Q.next}:{isFind:true,data:Q});Z.next={name:A.text};}v(F,I);}else {let I,Z;if(A.type==="own"){const O=Reflect.get(A.attributes||{},ze);O&&(typeof O.text=="string"&&(I=O.text),typeof O.desc=="string"&&(Z=O.desc));}else I=Reflect.get(A,"text"),Z=Reflect.get(A,"description");const Q=[I,Z],Me=Q.findIndex(O=>{if(typeof O=="string")return O.match(_)});if(Me!==-1){const O=$.deepClone(M),Re=$.queryProperty(O,j=>j?.next?{isFind:false,data:j.next}:{isFind:true,data:j});Re.next={name:I,matchedData:{path:"",formConfig:A,matchedText:Q[Me],description:Z}};const Ve=[];$.queryProperty(O,j=>{const he=j?.name;return typeof he=="string"&&he.trim()!==""&&Ve.push(he),j?.next?{isFind:false,data:j.next}:{isFind:true,data:j}});const Ne=Ve.join(ee.escapeHtml(" - "));Re.next.matchedData.path=Ne,g.push(O);}}}};for(let T=0;T<i.length;T++){const M=i[T];if(!M.views||M.isBottom&&M.id==="script-version")continue;const V=M.views;if(V&&Array.isArray(V)){let A=M.title;typeof A=="function"&&(A=A()),v(V,{index:T,name:A});}}const E=document.createDocumentFragment();for(const T of g){let M=w(T);E.appendChild(M);}b(),y.append(E);};s.on(d,"input",$.debounce(C=>{s.preventEvent(C);let _=s.val(d).trim();if(_===""){b();return}k(_);},200));};e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(h=>{s.on(h,"dblclick",a);});let c=null,p=false,u,f=false;s.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(h,m)=>{f=true,clearTimeout(u),u=void 0,p&&c===m?(p=false,c=null,a(h)):(u=setTimeout(()=>{p=false;},200),p=true,c=m);},{capture:true}),e.$shadowRoot.appendChild(s.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
				...
				`}));},transformKey(t){if(Array.isArray(t)){const e=t.sort();return JSON.stringify(e)}else return t}},G={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},$=W.noConflict(),s=U.noConflict(),S=ue,R=new $.Log(X,z.console||Fe.console),be=X?.script?.name||void 0,He=ue.config.Utils.AnyTouch(),Ke=false;R.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});x.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(t){const e=t.setting.type;if(e==="loading")return  false;const i=t.setting.content;return e==="warning"?R.warn(i):e==="error"?R.error(i):R.info(i),true},get position(){return D.getValue(G.qmsg_config_position.key,G.qmsg_config_position.defaultValue)},get maxNums(){return D.getValue(G.qmsg_config_maxnums.key,G.qmsg_config_maxnums.defaultValue)},get showReverse(){return D.getValue(G.qmsg_config_showreverse.key,G.qmsg_config_showreverse.defaultValue)},get zIndex(){let t=W.getMaxZIndex(),e=ue.config.InstanceUtils.getPopsMaxZIndex().zIndex;return W.getMaxValue(t,e)+100}});S.GlobalConfig.setGlobalConfig({zIndex:()=>{const t=W.getMaxZIndex(void 0,void 0,i=>{if(i?.classList?.contains("qmsg-shadow-container")||i?.closest("qmsg")&&i.getRootNode()instanceof ShadowRoot)return  false}),e=ue.config.InstanceUtils.getPopsMaxZIndex().zIndex;return W.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const _e=new $.GM_Menu({GM_getValue:oe,GM_setValue:ie,GM_registerMenuCommand:Oe,GM_unregisterMenuCommand:Ge}),de=new $.Httpx({xmlHttpRequest:Ue,logDetails:Ke});de.interceptors.request.use(t=>t);de.interceptors.response.use(void 0,t=>(R.error("拦截器-请求错误",t),t.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),t));z.Object.defineProperty,z.Function.prototype.apply,z.Function.prototype.call,z.Element.prototype.appendChild,z.setTimeout;const Te=s.addStyle.bind(s);U.selector.bind(U);U.selectorAll.bind(U);const Le=new $.GM_Cookie,pe={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new $.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let t=false,e;const i=(l,a)=>{typeof a!="string"&&(a=ee.toStr(a));const r=new Blob([a]),c=globalThis.URL.createObjectURL(r);s.createElement("a",{href:c,download:l}).click(),$.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(c);},500);},n=()=>{const l=f=>{const h=S.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),m=h.$shadowRoot.querySelector(".btn-control[data-mode='local']"),d=h.$shadowRoot.querySelector(".btn-control[data-mode='network']"),y=h.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),b=async k=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof ae=="function"?typeof se=="function"?(ae().forEach(g=>{se(g);}),x.success("已清空脚本存储的配置")):x.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):x.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Ae=="function"?Ae(k):Object.keys(k).forEach(g=>{const v=k[g];ie(g,v);}),x.success("配置导入完毕");},w=k=>new Promise(async C=>{const _=$.toJSON(k);Object.keys(_).length===0?x.warning("解析为空配置，不导入"):await b(_),C(true);});s.on(m,"click",k=>{s.preventEvent(k),h.close();const C=s.createElement("input",{type:"file",accept:".json"});s.on(C,["propertychange","input"],_=>{if(!C.files?.length)return;const g=C.files[0],v=new FileReader;v.onload=()=>{w(v.result);},v.readAsText(g,"UTF-8");}),C.click();}),s.on(d,"click",k=>{s.preventEvent(k),h.close();const C=S.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(v,E){v.close();}},ok:{text:"导入",callback:async(v,E)=>{const T=v.text;if($.isNull(T)){x.error("请填入完整的url");return}const M=x.loading("正在获取配置..."),V=await de.get(T,{allowInterceptConfig:false});if(M.close(),!V.status){R.error(V),x.error("获取配置失败",{consoleLogContent:true});return}await w(V.data.responseText)&&v.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:N.info.width,height:"auto"}),_=C.$shadowRoot.querySelector("input"),g=C.$shadowRoot.querySelector(".pops-prompt-btn-ok");s.on(_,["input","propertychange"],v=>{s.val(_)===""?s.attr(g,"disabled","true"):s.removeAttr(g,"disabled");}),s.listenKeyboard(_,"keydown",(v,E,T)=>{v==="Enter"&&T.length===0&&s.val(_)!==""&&s.trigger(g,"click");}),s.trigger(_,"input");}),s.on(y,"click",async k=>{s.preventEvent(k),h.close();let C=await ee.getClipboardText();if(C.trim()===""){x.warning("获取到的剪贴板内容为空");return}await w(C);});},a=(f=`${be}_panel-setting-${$.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,h)=>{const m=S.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),d=m.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),y=m.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");s.on(d,"click",b=>{s.preventEvent(b);try{i(f,h),m.close();}catch(w){x.error(w.toString(),{consoleLogContent:true});}}),s.on(y,"click",async b=>{await $.copy(h)?(x.success("复制成功"),m.close()):x.error("复制失败");});},c=S.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(f,h){l();}},cancel:{enable:true,text:"导出",callback(f,h){a(void 0,u);}}},width:P.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),p={};if(typeof ae=="function")ae().forEach(h=>{const m=oe(h);Reflect.set(p,h,m);});else {x.warning("不支持函数GM_listValues，仅导出菜单配置");const f=oe(ce);Reflect.set(p,ce,f);}const u=ee.toStr(p);c.value=u;},o=()=>{let l=X?.script?.supportURL||X?.script?.namespace;typeof l=="string"&&$.isNotNull(l)&&window.open(l,"_blank");};return [{id:"script-version",title:`版本：${X?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(l){new He(l.$asideLiElement).on("tap",function(r){clearTimeout(e),e=void 0,t?(t=false,n()):(e=setTimeout(()=>{t=false,o();},200),t=true);});}}]},setDefaultBottomContentConfig(t){this.$data.__defaultBottomContentConfig=t;}};let qe=t=>{(typeof t=="object"&&t!=null||typeof t=="function")&&Object.keys(t).forEach(e=>{typeof t[e]=="function"&&(t[e]=t[e].bind(t));});};const le=Ie;qe(le);qe(Le);const $e=["document.cookie","cookieStore","GM_cookie","GM.cookie"];class Se{__apiName;constructor(e){if(typeof e=="string"&&!$e.includes(e))throw new Error(`未知的apiName：${e}`);this.__apiName=e;}get cookieManagerApiName(){let e=D.getValue("cookie-manager-api","document.cookie");return this.__apiName||e}get cookieManager(){if(this.cookieManagerApiName==="GM_cookie")return {list(e,i){le.list(e,n=>{i(n);});},set(e,i){le.set(e,n=>{i(n);});},delete(e,i){le.delete(e,n=>{i(n);});}};if(this.cookieManagerApiName==="GM.cookie")return {list(e,i){ge.cookie.list().then(n=>{i(n);});},set(e,i){ge.cookie.set(e).then(n=>{i(n??null);}).catch(n=>{i(n);});},delete(e,i){ge.cookie.delete(e).then(n=>{i(n??null);}).catch(n=>{i(n);});}};if(this.cookieManagerApiName==="cookieStore"){let e=z.cookieStore;return {list(i,n){e.getAll().then(o=>{n(o);}).catch(o=>{R.error(o),x.error(o.toString());});},set(i,n){e.set(i).then(()=>{n();}).catch(o=>{n(o);});},delete(i,n){e.delete(i).then(o=>{n();}).catch(o=>{n(o);});}}}else return Le}queryAllCookie(){return new Promise((e,i)=>{try{this.cookieManager.list({},n=>{let o=n||[];o=o.sort((l,a)=>l.name.localeCompare(a.name)),e(o);});}catch(n){R.error(n),x.error(n.toString()),i(n);}})}deleteAllCookie(){return new Promise((e,i)=>{try{this.cookieManager.list({},async n=>{const o=n||[],l={success:0,error:0};for(let a=0;a<o.length;a++){const r=o[a];await new Promise(p=>{this.deleteCookie(r).then(u=>{p(u);});})?l.error++:l.success++;}e(l);});}catch(n){R.error(n),x.error(n.toString()),i(n);}})}addCookie(e){return new Promise((i,n)=>{try{Reflect.deleteProperty(e,"hostOnly"),this.cookieManager.set(e,o=>{i(o);});}catch(o){R.error(o),x.error(o.toString()),n(o);}})}deleteCookie(e){return new Promise((i,n)=>{try{this.cookieManager.delete(e,o=>{i(o);});}catch(o){R.error(o),x.error(o.toString()),n(o);}})}updateCookie(e){return new Promise(async(i,n)=>{let o;try{if(this.cookieManagerApiName==="document.cookie"||this.cookieManagerApiName==="cookieStore"){let a=await this.deleteCookie(e);if(a)throw new TypeError(a.toString())}let l=await this.addCookie(e);if(l)throw new TypeError(l.toString())}catch(l){o=l;}finally{i(o);}})}}const L=new Se,fe={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new W.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,i){let n;this.hasStorageApi(t)?n=this.getStorageApi(t):n=i,this.setComponentsStorageApiProperty(e,n);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,q,e);}},K=function(t,e,i,n,o,l,a,r){const c={text:t,type:"switch",description:o,disabled:a,attributes:{},props:{},getValue(){return this.props[q].get(e,i)},callback(p,u){const f=!!u;if(R.success(`${f?"开启":"关闭"} ${t}`),typeof n=="function"&&n(p,f))return;this.props[q].set(e,f);},afterAddToUListCallBack:l};return Reflect.set(c.attributes,J,e),Reflect.set(c.attributes,Y,i),fe.initComponentsStorageApi("switch",c,{get(p,u){return D.getValue(p,u)},set(p,u){D.setValue(p,u);}}),c},De={beforeEdit(t,e){const i=L.cookieManagerApiName;return i==="cookieStore"?typeof t.expires=="number"&&(t.expirationDate=t.expires):(i==="GM_cookie"||i==="GM.cookie")&&e&&typeof t.expirationDate=="number"&&(t.expirationDate=t.expirationDate*1e3),t},afterEdit(t){const e=L.cookieManagerApiName;return e==="document.cookie"?t.domain="":e==="cookieStore"?typeof t.expirationDate=="number"&&(t.expires=t.expirationDate):(e==="GM_cookie"||e==="GM.cookie")&&typeof t.expirationDate=="number"&&(t.expirationDate=Math.floor(t.expirationDate/1e3)),t}},We=function(t,e,i,n,o,l){const a={type:"own",attributes:{},props:{},getLiElementCallBack:t,afterAddToUListCallBack:l};return Reflect.set(a.attributes,Ce,()=>false),a};let re=(t,e,i,n)=>({text:t,type:"input",isNumber:false,isPassword:false,props:{},attributes:{},description:"",getValue(){return e()},callback(l,a){i(a);},placeholder:"",disabled:!!n}),Je=(t,e,i,n)=>({text:t,type:"textarea",props:{},attributes:{},description:"",placeholder:"",getValue(){return e()},disabled:n,callback:function(l,a){i(a);}}),xe=(t,e,i,n,o)=>({text:t,type:"select",description:"",attributes:{},props:{},getValue(){return i()},callback(a,r,c){n(r);},data:typeof e=="function"?e():e,disabled:false});const ke={init(){},showView(t,e){let i=!!t,n={name:"",value:"",domain:window.location.hostname,path:"/",secure:false,session:false,hostOnly:false,httpOnly:false,sameSite:"lax",expirationDate:Date.now()+3600*24*30*1e3},o=$.assign({},n,true);$.assign(o,t??{},true),o=De.beforeEdit(o,i);const a=S.confirm({title:{text:i?"编辑Cookie":"添加Cookie",position:"center"},content:{text:"",html:true},drag:true,btn:{position:"center",ok:{text:i?"编辑":"添加",async callback(w,k){if(ke.validCookieInfo(o)){if(o.value=encodeURIComponent(o.value),o=De.afterEdit(o),i){let _=await L.updateCookie(o);_?x.error(_.toString()):(x.success("修改成功"),w.close());}else {let _=await L.addCookie(o);_?x.error(_.toString()):(x.success("添加成功"),w.close());}typeof e=="function"&&e(o);}}},cancel:{text:"取消"}},mask:{enable:true},width:N.settingMiddle.width,height:"auto",style:`
            ...
            `}).$shadowRoot.querySelector(".pops-confirm-content"),r=S.config.PanelHandlerComponents(),c=r.createSectionContainerItem_input(re("name",()=>o.name,w=>o.name=w,i)),p=r.createSectionContainerItem_textarea(Je("value",()=>o.value,w=>o.value=w)),u=r.createSectionContainerItem_input(re("domain",()=>o.domain,w=>o.domain=w)),f=r.createSectionContainerItem_input(re("path",()=>o.path,w=>o.path=w));let h;if(o.session)h=r.createSectionContainerItem_input(re("expires",()=>"会话",w=>{},true));else {const w=We(()=>{const k=s.createElement("li",{innerHTML:`
...
`));}});},getMatchedRuleList(t=window.location.href){const e=this.getData(),i=[];return e.forEach(n=>{if(!n.enable)return;let o=window.location.href,l=n.data.url;if(n.data.enableRegExpToMatchUrl){if(!new RegExp(l,"i").test(o))return}else if(!o.includes(l))return;i.push(n);}),i},showView(){let t=S.config.PanelHandlerComponents();function e(o,l){return {get(a,r){return Reflect.get(o,a)??r},set(a,r){Reflect.set(o,a,r);}}}const i=this.getMatchedRuleList();new Xe({title:"Cookie规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:o=>o.name,updateData:o=>this.updateData(o),deleteData:o=>this.deleteData(o),getData:o=>this.getData().find(r=>r.uuid===o.uuid)??o,itemControls:{enable:{enable:true,getEnable(o){return o.enable},callback:(o,l)=>{o.enable=l,this.updateData(o);}},edit:{enable:true,getView:(o,l)=>{let a=document.createDocumentFragment(),r=this.getTemplateData();l||(o=r);let c=K("启用","enable",r.enable);Reflect.set(c.props,q,e(o));let p=t.createSectionContainerItem_switch(c),u=we("规则名称","name","",r.name,void 0,"必填");Reflect.set(u.props,q,e(o));let f=t.createSectionContainerItem_input(u),h=ne("Cookie管理Api","execApiName",r.data.execApiName,[{text:"（当前）"+L.cookieManagerApiName,value:"use-global"},...$e.map(V=>({text:V,value:V}))],void 0,"操作Cookie的Api函数");Reflect.set(h.props,q,e(o.data));let m=t.createSectionContainerItem_select(h),d=we("网址","url",r.data.url,"用于执行该规则的网址",void 0,"必填");Reflect.set(d.props,q,e(o.data));let y=t.createSectionContainerItem_input(d),b=K("启用正则匹配网址","enableRegExpToMatchUrl",r.data.enableRegExpToMatchUrl);Reflect.set(b.props,q,e(o.data));let w=t.createSectionContainerItem_switch(b),k=we("Cookie名称","cookieName",r.data.cookieName,"用于匹配执行操作的Cookie名",void 0,"必填");Reflect.set(k.props,q,e(o.data));let C=t.createSectionContainerItem_input(k),_=K("启用正则匹配Cookie名称","enableRegExpToMatchCookieName",r.data.enableRegExpToMatchCookieName);Reflect.set(_.props,q,e(o.data));let g=t.createSectionContainerItem_switch(_),v=ne("操作模式","operationMode",r.data.operationMode,[{value:"delete",text:"删除Cookie"},{value:"extended",text:"自动延长Cookie有效期30天"},{value:"extended-90",text:"自动延长Cookie有效期90天"},{value:"extended-180",text:"自动延长Cookie有效期180天"},{value:"extended-360",text:"自动延长Cookie有效期360天"}]);Reflect.set(v.props,q,e(o.data));let E=t.createSectionContainerItem_select(v),T=Ye("备注","remark",r.data.remark);Reflect.set(T.props,q,e(o.data));let M=t.createSectionContainerItem_textarea(T);return a.append(p,f,m,y,w,C,g,E,M),a},onsubmit:(o,l,a)=>{let r=o.querySelectorAll(".rule-form-ulist > li"),c=this.getTemplateData();l&&(c.uuid=a.uuid);try{return r.forEach(p=>{let u=Reflect.get(p,t.$data.nodeStoreConfigKey),f=Reflect.get(u,"attributes"),h=Reflect.get(p,q),m=Reflect.get(f,J),d=Reflect.get(f,Y),y=h.get(m,d);Reflect.has(c,m)?Reflect.set(c,m,y):Reflect.has(c.data,m)?Reflect.set(c.data,m,y):R.error(`${m}不在数据中`);}),c.name.trim()===""?(x.error("规则名称不能为空"),{success:!1,data:c}):c.data.url.trim()===""?(x.error("网址不能为空"),{success:!1,data:c}):c.data.cookieName.trim()===""?(x.error("Cookie名称不能为空"),{success:!1,data:c}):l?{success:this.updateData(c),data:c}:{success:this.addData(c),data:c}}catch(p){return R.error(p),{success:false,data:c}}finally{this.init();}},style:`
            ...
            `}),e=t.$shadowRoot.querySelector(".import-mode[data-mode='local']"),i=t.$shadowRoot.querySelector(".import-mode[data-mode='network']");s.on(e,"click",n=>{s.preventEvent(n),t.close();let o=s.createElement("input",{type:"file",accept:".json"});s.on(o,["propertychange","input"],l=>{if(!o.files?.length)return;let a=o.files[0],r=new FileReader;r.onload=()=>{let c=$.toJSON(r.result);if(!Array.isArray(c)){R.error("不是正确的规则文件",c),x.error("不是正确的规则文件");return}this.setData(c),x.success(`成功导入 ${c.length}条规则`);},r.readAsText(a,"UTF-8");}),o.click();}),s.on(i,"click",n=>{s.preventEvent(n),t.close(),S.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"url",focus:true},btn:{ok:{callback:async(o,l)=>{let a=o.text;if($.isNull(a)){x.error("请填入完整的url");return}let r=await de.get(a);if(!r.status)return;let c=$.toJSON(r.data.responseText);if(!Array.isArray(c)){R.error("不是正确的规则文件",r,c),x.error("不是正确的规则文件");return}this.setData(c),o.close(),x.success(`成功导入 ${c.length}条规则`);}}},width:N.info.width,height:"auto"});});}},te={encrypt(t,e){return me.AES.encrypt(t,e).toString()},decrypt(t,e){return me.AES.decrypt(t,e).toString(me.enc.Utf8)},formatCookie(t,e,i){let n="";if(e==="header_string")n=t.map(o=>{let l=o.value;return `${o.name}=${l}; `}).join("");else if(e==="json")n=JSON.stringify({api:L.cookieManagerApiName,hostname:window.location.hostname,data:t},null,2);else throw new Error("不支持的格式化类型："+e);return i&&(n=this.encrypt(n,i)),n},showExportDialog(){let t=S.confirm({title:{text:"导出 Cookie",position:"center"},content:{text:`
				...
				`}),e=t.$shadowRoot.querySelector(".export-example-code-text-container pre"),i=t.$shadowRoot.querySelector("#cookie-format-header_string"),n=t.$shadowRoot.querySelector("#cookie-format-json"),o=t.$shadowRoot.querySelector("#encode-pwd");const l={key:"cookie-backup-export-dialog-config",getConfig(){return D.getValue(this.key,{exportType:"header_string",encodePwd:""})},saveConfig(){let r="header_string";n.checked&&(r="json"),D.setValue(this.key,{exportType:r,encodePwd:s.val(o)}),a=this.getConfig();}};let a=l.getConfig();s.on(i,"input",()=>{const r=[{name:"_ga",value:"GA1.2.123456789.987654321",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"PHPSESSID",value:"28f2d88ee9322cfd2e4f1e",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"csrftoken",value:"abcdef123456",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false},{name:"logged_in",value:"true",domain:window.location.hostname,expires:Date.now()+2592e6,partitioned:false,path:"/",sameSite:"unspecified",secure:false}];let c=this.formatCookie(r,"header_string");s.text(e,c),l.saveConfig();}),s.on(n,"input",()=>{const r=[{name:"sessionId",value:"abc123xyz456",domain:".example.com",path:"/",secure:true,httpOnly:true,sameSite:"lax",expirationDate:1713543600,hostOnly:false,session:false}];let c=this.formatCookie(r,"json");s.text(e,c),l.saveConfig();}),s.on(o,["input","propertychange"],()=>{l.saveConfig();}),a.exportType==="header_string"?i.click():a.exportType==="json"&&n.click(),s.val(o,a.encodePwd);},showImportDialog(){let t=S.confirm({title:{text:"导入 Cookie",position:"center"},content:{text:`
					...
					`,html:true},width:window.innerWidth<400?"88vw":"400px",height:"auto",btn:{ok:{text:"导入",async callback(f,h){try{const m=u.decodePwd;let d=u.value;m.trim()===""||(d=te.decrypt(d,m));const y=$.toJSON(d);if(Array.isArray(y)){R.info(`使用${L.cookieManagerApiName}导入cookie数据`);for(const b of y)await L.updateCookie(b);}else if(typeof y=="object"&&Object.keys(y).length&&Array.isArray(y.data)){const b=new Se(y.api);R.info(`使用${b.cookieManagerApiName}导入cookie数据`);for(const w of y.data)await b.updateCookie(w);}else if(typeof y=="object"&&!Object.keys(y).length){let b=new $.GM_Cookie;R.info(`使用${L.cookieManagerApiName}导入cookie数据`);let w=b.parseCookie(d);for(const k of w)await L.updateCookie({name:k.key,value:k.value,domain:window.location.hostname,path:"/",sameSite:"unspecified",secure:!1,session:!1,hostOnly:!0,httpOnly:!1});}else {R.error(d,y),x.error("cookie格式不符合");return}f.close();}catch(m){x.error(m.toString());}}}},style:`
					${S.config.cssText.panelCSS}
            ...
            `}),e=t.$shadowRoot.querySelector(".cookie-search-inner input"),i=t.$shadowRoot.querySelector(".cookie-search-setting"),n=t.$shadowRoot.querySelector(".cookie-control-refresh"),o=t.$shadowRoot.querySelector(".cookie-control-add"),l=t.$shadowRoot.querySelector(".cookie-control-export"),a=t.$shadowRoot.querySelector(".cookie-control-import"),r=t.$shadowRoot.querySelector(".cookie-control-clear-all"),c=t.$shadowRoot.querySelector(".cookie-control-rule-manager"),p=t.$shadowRoot.querySelector(".cookie-setting"),u=t.$shadowRoot.querySelector(".cookie-list-wrapper");let f=d=>{const y=s.createElement("div",{className:"cookie-item",innerHTML:`
                ...
                `}).$shadowRoot.querySelector(".pops-alert-content"),w=S.config.PanelHandlerComponents(),k=w.createSectionContainerItem_select(ne("CookieManager Api","cookie-manager-api","document.cookie",$e.map(g=>({text:g,value:g})),void 0,"操作Cookie的Api函数",g=>{m();})),C=w.createSectionContainerItem_switch(K("解码Cookie值","decode-cookie-value",false,()=>{m();},"对Cookie值进行解码")),_=w.createSectionContainerItem_switch(K("排除Session Cookie","exclude-session-cookie",false,()=>{m();},"过滤掉浏览器会话Cookie"));s.append(b,[k,C,_]);});let m=()=>{s.trigger(e,"input");};m();},registerMenu(){const t=this;_e.add({key:"cookie_manager_view",text:"⚙ Cookie管理",autoReload:false,isStoreValue:false,showText(e,i){return e},callback(e){t.showView();}});}},et={init(){this.execController(),s.ready(()=>{this.execController();});},async execController(){for(let t=0;t<B.$data.matchedRuleList.length;t++){const e=B.$data.matchedRuleList[t],i=e.data.operationMode;R.success(`执行规则：${e.name}`);let n=e.data.execApiName;n==="use-global"&&(n=void 0);const o=new Se(n),l=await o.queryAllCookie();for(let a=0;a<l.length;a++){let r=l[a];const c=r.name,p=e.data.cookieName;let u=false;if(e.data.enableRegExpToMatchCookieName?new RegExp(p,"i").test(c)&&(u=true):c.includes(p)&&(u=true),u){if(i==="delete")o.deleteCookie(r);else if(i.startsWith("extended")){let f=Date.now(),h=720*60*60*1e3,m=h*3,d=h*6,y=h*12,b=h;i==="extended-90"?b=m:i==="extended-180"?b=d:i==="extended-360"&&(b=y);let w=false;if(o.cookieManagerApiName==="document.cookie")r.expirationDate=f+b,w=true;else if(o.cookieManagerApiName==="cookieStore"){let k=r.expires;typeof k=="number"&&k-f<b&&(r.expires=k+b,w=true);}else if(o.cookieManagerApiName==="GM_cookie"||o.cookieManagerApiName==="GM.cookie"){let k=r.expirationDate;typeof k=="number"&&k*1e3-f<b&&(r.expirationDate=k+b/1e3,w=true);}else R.error("未知的cookieManagerApiName",o.cookieManagerApiName);w&&await o.updateCookie(r);}}}}}},ye=function(t,e,i,n,o,l,a,r,c,p){const u={text:t,type:"button",attributes:{},props:{},description:e,buttonIcon:n,buttonIsRightIcon:o,buttonIconIsLoading:l,buttonType:a,buttonText:i,callback(f){typeof r=="function"&&r(f);},afterAddToUListCallBack:c};return Reflect.set(u.attributes,Ce,()=>{u.disable=false;}),u},tt={id:"view-rule",title:"规则",headerTitle:"Cookie操作规则",views:[{type:"container",text:"",views:[ye("自定义规则","操作Cookie的规则","管理",void 0,false,false,"default",()=>{B.showView();})]},{type:"container",text:"",views:[ye("数据导入","导入自定义规则数据","导入",void 0,false,false,"primary",()=>{B.importRule();}),ye("数据导出","导出自定义规则数据","导出",void 0,false,false,"primary",()=>{B.exportRule("CookieManagerRule.json");})]}]},ot={id:"view-general",title:"通用",views:[{text:"Toast配置",type:"container",views:[ne("Toast位置",G.qmsg_config_position.key,G.qmsg_config_position.defaultValue,[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,i)=>{R.info("设置当前Qmsg弹出位置"+i);},"Toast显示在页面九宫格的位置"),ne("最多显示的数量",G.qmsg_config_maxnums.key,G.qmsg_config_maxnums.defaultValue,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),K("逆序弹出",G.qmsg_config_showreverse.key,G.qmsg_config_showreverse.defaultValue,void 0,"修改Toast弹出的顺序")]}]};pe.addContentConfig([ot,tt]);D.init();ve.init();B.init();et.init();

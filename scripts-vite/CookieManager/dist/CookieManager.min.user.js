...
(function (w, ue, q, J) {
            ...
            var se=Object.defineProperty;var ce=(e,t,o)=>t in e?se(e,t,{enumerable:true,configurable:true,writable:true,value:o}):e[t]=o;var B=(e,t,o)=>ce(e,t+"",o);var pe=typeof GM_cookie<"u"?GM_cookie:void 0,de=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,O=typeof GM_getValue<"u"?GM_getValue:void 0,H=typeof GM_info<"u"?GM_info:void 0,fe=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,P=typeof GM_setValue<"u"?GM_setValue:void 0,he=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,me=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,A=typeof unsafeWindow<"u"?unsafeWindow:void 0,ge=window;const T={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},xe="CookieManager",v=q.noConflict(),m=ue.noConflict(),b=J,C=new v.Log(H,A.console||ge.console);var ae;const ie=((ae=H==null?void 0:H.script)==null?void 0:ae.name)||xe,ne=false;C.config({debug:ne,logMaxCount:1e3,autoClearConsole:true,tag:true});w.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return y.getValue(T.qmsg_config_position.key,T.qmsg_config_position.defaultValue)}},maxNums:{get(){return y.getValue(T.qmsg_config_maxnums.key,T.qmsg_config_maxnums.defaultValue)}},showReverse:{get(){return y.getValue(T.qmsg_config_showreverse.key,T.qmsg_config_showreverse.defaultValue)}},zIndex:{get(){let e=q.getMaxZIndex(),t=J.config.InstanceUtils.getPopsMaxZIndex().zIndex;return q.getMaxValue(e,t)+100}}}));b.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=q.getMaxZIndex(void 0,void 0,o=>{var i;if((i=o==null?void 0:o.classList)!=null&&i.contains("qmsg-shadow-container")||o!=null&&o.closest("qmsg")&&o.getRootNode()instanceof ShadowRoot)return  false}),t=J.config.InstanceUtils.getPopsMaxZIndex().zIndex;return q.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}}});const le=new v.GM_Menu({GM_getValue:O,GM_setValue:P,GM_registerMenuCommand:fe,GM_unregisterMenuCommand:he}),F=new v.Httpx(me);F.interceptors.request.use(e=>e);F.interceptors.response.use(void 0,e=>(C.error("拦截器-请求错误",e),e.type==="onabort"?w.warning("请求取消"):e.type==="onerror"?w.error("请求异常"):e.type==="ontimeout"?w.error("请求超时"):w.error("其它错误"),e));F.config({logDetails:ne});A.Object.defineProperty,A.Function.prototype.apply,A.Function.prototype.call,A.Element.prototype.appendChild,A.setTimeout;v.addStyle.bind(v);document.querySelector.bind(document);document.querySelectorAll.bind(document);const we=new q.GM_Cookie,N="GM_Panel",re="data-init",U="data-key",z="data-default-value",ve="data-init-more-value",$="data-storage-api",I=function(e,t,o,i,a,r){let n={text:e,type:"switch",description:a,attributes:{},props:{},getValue(){return !!this.props[$].get(t,o)},callback(l,s){let u=!!s;C.success(`${u?"开启":"关闭"} ${e}`),!(typeof i=="function"&&i(l,u))&&this.props[$].set(t,u);},afterAddToUListCallBack:r};return Reflect.set(n.attributes,U,t),Reflect.set(n.attributes,z,o),Reflect.set(n.props,$,{get(l,s){return y.getValue(l,s)},set(l,s){y.setValue(l,s);}}),n},j=function(e,t,o,i,a,r){let n=[];typeof i=="function"?n=i():n=i;let l={text:e,type:"select",description:r,attributes:{},props:{},getValue(){return this.props[$].get(t,o)},callback(s,u,f){let h=u;C.info(`选择：${f}`),this.props[$].set(t,h),typeof a=="function"&&a(s,h,f);},data:n};return Reflect.set(l.attributes,U,t),Reflect.set(l.attributes,z,o),Reflect.set(l.props,$,{get(s,u){return y.getValue(s,u)},set(s,u){y.setValue(s,u);}}),l},ye={id:"view-general",title:"通用",forms:[{text:"Toast配置",type:"forms",forms:[j("Toast位置",T.qmsg_config_position.key,T.qmsg_config_position.defaultValue,[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,o)=>{C.info("设置当前Qmsg弹出位置"+o);},"Toast显示在页面九宫格的位置"),j("最多显示的数量",T.qmsg_config_maxnums.key,T.qmsg_config_maxnums.defaultValue,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),I("逆序弹出",T.qmsg_config_showreverse.key,T.qmsg_config_showreverse.defaultValue,void 0,"修改Toast弹出的顺序")]}]},V={setting:{get width(){return window.innerWidth<550?"88vw":"550px"},get height(){return window.innerHeight<450?"70vh":"450px"}},info:{get width(){return "350px"},get height(){return "250px"}}},W=function(e,t,o,i,a,r,n,l,s,u){let f={text:e,type:"button",attributes:{},description:t,buttonIcon:i,buttonIsRightIcon:a,buttonIconIsLoading:r,buttonType:n,buttonText:o,callback(h){typeof l=="function"&&l(h);},afterAddToUListCallBack:s};return Reflect.set(f.attributes,re,()=>{f.disable=false;}),f},Z=function(e,t,o,i,a,r="",n,l){let s={text:e,type:"input",isNumber:false,isPassword:false,props:{},attributes:{},description:i,getValue(){return this.props[$].get(t,o)},callback(u,f){this.props[$].set(t,f);},placeholder:r};return Reflect.set(s.attributes,U,t),Reflect.set(s.attributes,z,o),Reflect.set(s.props,$,{get(u,f){return y.getValue(u,f)},set(u,f){y.setValue(u,f);}}),s},be=function(e,t,o,i,a,r="",n){let l={text:e,type:"textarea",attributes:{},props:{},description:i,placeholder:r,disabled:n,getValue(){let s=this.props[$].get(t,o);return Array.isArray(s)?s.join(`
`):s},callback(s,u){this.props[$].set(t,u);}};return Reflect.set(l.attributes,U,t),Reflect.set(l.attributes,z,o),Reflect.set(l.props,$,{get(s,u){return y.getValue(s,u)},set(s,u){y.setValue(s,u);}}),l};class ke{constructor(t){B(this,"option");this.option=t;}async showView(){var n;let t=b.confirm({title:{text:this.option.title,position:"center"},content:{text:`
			...
			`});Reflect.set(a,"data-rule",t);let r="pops-panel-switch-is-checked";const{$enable:n,$enableSwitch:l,$enableSwitchCore:s,$enableSwitchInput:u,$delete:f,$edit:h}=this.parseRuleItemElement(a);return this.option.itemControls.enable.enable?(m.on(s,"click",async c=>{let p=false;l.classList.contains(r)?(l.classList.remove(r),p=false):(l.classList.add(r),p=true),u.checked=p,await this.option.itemControls.enable.callback(t,p);}),await this.option.itemControls.enable.getEnable(t)&&l.classList.add(r)):n.remove(),this.option.itemControls.edit.enable?m.on(h,"click",c=>{v.preventEvent(c),this.showEditView(true,t,o,a,p=>{t=null,t=p;});}):h.remove(),this.option.itemControls.delete.enable?m.on(f,"click",c=>{v.preventEvent(c);let p=b.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async d=>{C.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(t)?(w.success("成功删除该数据"),a.remove(),await this.updateDeleteAllBtnText(o),p.close()):w.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):f.remove(),a}async appendRuleItemElement(t,o){let{$container:i}=this.parseViewElement(t),a=[],r=Array.isArray(o)?o:[o];for(let n=0;n<r.length;n++){let l=r[n],s=await this.createRuleItemElement(l,t);i.appendChild(s),a.push(s);}return await this.updateDeleteAllBtnText(t),a}async updateRuleContaienrElement(t){this.clearContent(t);const{$container:o}=this.parseViewElement(t);let i=await this.option.data();await this.appendRuleItemElement(t,i),await this.updateDeleteAllBtnText(t);}async updateRuleItemElement(t,o,i){let a=await this.createRuleItemElement(t,i);o.after(a),o.remove();}clearContent(t){const{$container:o}=this.parseViewElement(t);m.html(o,"");}setDeleteBtnText(t,o,i=false){const{$deleteBtn:a}=this.parseViewElement(t);i?m.html(a,o):m.text(a,o);}async updateDeleteAllBtnText(t){let o=await this.option.data();this.setDeleteBtnText(t,`清空所有(${o.length})`);}}const G={$key:{STORAGE_KEY:"cookie-rule"},$data:{ruleData:[]},init(){this.$data.ruleData=[],this.getData().forEach(t=>{if(!t.enable)return;let o=window.location.href,i=t.data.url;if(t.data.enableRegExpToMatchUrl){if(!new RegExp(i,"i").test(o))return}else if(!o.includes(i))return;this.$data.ruleData.push(t);});},showView(){let e=b.config.panelHandleContentUtils();function t(i,a){return {get(r,n){return Reflect.get(i,r)??n},set(r,n){Reflect.set(i,r,n);}}}new _e({title:"Cookie规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:i=>i.name,updateData:i=>this.updateData(i),deleteData:i=>this.deleteData(i),getData:i=>this.getData().find(n=>n.uuid===i.uuid)??i,itemControls:{enable:{enable:true,getEnable(i){return i.enable},callback:(i,a)=>{i.enable=a,this.updateData(i);}},edit:{enable:true,getView:(i,a)=>{let r=document.createDocumentFragment(),n=this.getTemplateData();a||(i=n);let l=I("启用","enable",n.enable);Reflect.set(l.props,$,t(i));let s=e.createSectionContainerItem_switch(l),u=Z("规则名称","name","",n.name,void 0,"必填");Reflect.set(u.props,$,t(i));let f=e.createSectionContainerItem_input(u),h=Z("网址","url",n.data.url,"用于执行该规则的网址",void 0,"必填");Reflect.set(h.props,$,t(i.data));let c=e.createSectionContainerItem_input(h),p=I("启用正则匹配网址","enableRegExpToMatchUrl",n.data.enableRegExpToMatchUrl);Reflect.set(p.props,$,t(i.data));let d=e.createSectionContainerItem_switch(p),x=Z("Cookie名称","cookieName",n.data.cookieName,"用于匹配执行操作的Cookie名",void 0,"必填");Reflect.set(x.props,$,t(i.data));let g=e.createSectionContainerItem_input(x),S=I("启用正则匹配Cookie名称","enableRegExpToMatchCookieName",n.data.enableRegExpToMatchCookieName);Reflect.set(S.props,$,t(i.data));let M=e.createSectionContainerItem_switch(S),k=j("操作模式","operationMode",n.data.operationMode,[{value:"delete",text:"删除Cookie"},{value:"extended",text:"自动延长Cookie有效期30天"},{value:"extended-90",text:"自动延长Cookie有效期90天"},{value:"extended-180",text:"自动延长Cookie有效期180天"},{value:"extended-360",text:"自动延长Cookie有效期360天"}]);Reflect.set(k.props,$,t(i.data));let E=e.createSectionContainerItem_select(k),R=be("备注","remark",n.data.remark);Reflect.set(R.props,$,t(i.data));let D=e.createSectionContainerItem_textarea(R);return r.append(s,f,c,d,g,M,E,D),r},onsubmit:(i,a,r)=>{let n=i.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();a&&(l.uuid=r.uuid);try{return n.forEach(s=>{let u=Reflect.get(s,"__formConfig__"),f=Reflect.get(u,"attributes"),h=Reflect.get(s,$),c=Reflect.get(f,U),p=Reflect.get(f,z),d=h.get(c,p);Reflect.has(l,c)?Reflect.set(l,c,d):Reflect.has(l.data,c)?Reflect.set(l.data,c,d):C.error(`${c}不在数据中`);}),l.name.trim()===""?(w.error("规则名称不能为空"),{success:!1,data:l}):l.data.url.trim()===""?(w.error("网址不能为空"),{success:!1,data:l}):l.data.cookieName.trim()===""?(w.error("Cookie名称不能为空"),{success:!1,data:l}):a?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}}catch(s){return C.error(s),{success:false,data:l}}finally{this.init();}},style:`
                    ...
                    `},delete:{enable:true,deleteCallBack:i=>this.deleteData(i)}}}).showView();},getTemplateData(){return {uuid:v.generateUUID(),enable:true,name:"",data:{url:"",enableRegExpToMatchUrl:false,cookieName:"",enableRegExpToMatchCookieName:false,operationMode:"delete",remark:""}}},getData(){return O(this.$key.STORAGE_KEY,[])},setData(e){P(this.$key.STORAGE_KEY,e);},addData(e){let t=this.getData();return t.findIndex(i=>i.uuid==e.uuid)===-1?(t.push(e),P(this.$key.STORAGE_KEY,t),true):false},updateData(e){let t=this.getData(),o=t.findIndex(a=>a.uuid==e.uuid),i=false;return o!==-1&&(i=true,t[o]=e),this.setData(t),i},deleteData(e){let t=this.getData(),o=t.findIndex(a=>a.uuid==e.uuid),i=false;return o!==-1&&(i=true,t.splice(o,1)),this.setData(t),i},clearData(){de(this.$key.STORAGE_KEY);},exportRule(e="rule.json"){let t=this.getData(),o=new Blob([JSON.stringify(t,null,4)]),i=window.URL.createObjectURL(o),a=m.createElement("a");a.href=i,a.download=e,a.click(),setTimeout(()=>{window.URL.revokeObjectURL(i);},1500);},importRule(){let e=b.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`

...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof me=="function"?me(e.keyName):null;return typeof t=="string"&&t?re(t):T.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{F.onReady(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(o=>{o.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(o=>{o.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(o){navigator.clipboard.readText().then(a=>{o(a);}).catch(a=>{h.error("读取剪贴板内容失败👉",a),o("");});}function t(o){navigator.permissions.query({name:"clipboard-read"}).then(()=>{e(o);}).catch(a=>{h.error("申请剪贴板权限失败，尝试直接读取👉",a.message??a.name??a.stack),e(o);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(o=>{if(!n()){o("");return}document.hasFocus()?t(o):window.addEventListener("focus",()=>{t(o);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let o,a=n-t,i=t,r=async m=>{const l=await e(m);if(typeof l=="boolean"&&l||m){x.workerClearTimeout(o);return}if(i+=t,i>a){r(true);return}o=x.workerSetTimeout(()=>{r(false);},t);};r(false);},findParentNode(e,t,n){if(n){let o=F.closest(e,n);if(o)return o.querySelector(t)}else return F.matches(e,t)?e:F.closest(e,t)},toStr(e,t=2){const n="__undefined__placeholder__replaced__str__"+performance.now();return JSON.stringify(e,(a,i)=>i===void 0?n:i,t).replace(new RegExp(`"${n}"`,"g"),"undefined")},isVerticalScreen(){return !globalThis.screen.orientation.type.includes("landscape")},isMobileDevice(e=768){return this.isVerticalScreen()?globalThis.innerWidth<e:globalThis.innerHeight<e},isTopWindow(){const e=typeof R=="object"&&R!=null?R:window;return e.top===e.self}},ne="GM_Panel",Ae="data-init",oe="data-key",ae="data-default-value",Le="data-init-more-value",Te="data-plugin-search-config",ee="data-storage-api",j={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},J={setting:{get width(){return j.width<550?"88vw":j.width<700?"550px":"700px"},get height(){return j.height<450?"70vh":j.height<550?"450px":"550px"}},settingMiddle:{get width(){return j.width<350?"88vw":"350px"}},info:{get width(){return j.width<350?"88vw":"350px"},get height(){return j.height<250?"88vh":"250px"}}},ie={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new x.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(i,r)=>{typeof r!="string"&&(r=T.toStr(r));const m=new Blob([r]),l=globalThis.URL.createObjectURL(m);u.createElement("a",{href:l,download:i}).click(),x.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},o=()=>{const i=w=>{const d=B.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),y=d.$shadowRoot.querySelector(".btn-control[data-mode='local']"),$=d.$shadowRoot.querySelector(".btn-control[data-mode='network']"),G=d.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),D=async A=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof te=="function"?typeof Y=="function"?(te().forEach(s=>{Y(s);}),_.success("已清空脚本存储的配置")):_.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):_.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof ye=="function"?ye(A):Object.keys(A).forEach(s=>{const p=A[s];le(s,p);}),_.success("配置导入完毕");},O=A=>new Promise(async b=>{const M=x.toJSON(A);Object.keys(M).length===0?_.warning("解析为空配置，不导入"):await D(M),b(true);});u.on(y,"click",A=>{u.preventEvent(A),d.close();const b=u.createElement("input",{type:"file",accept:".json"});u.on(b,["propertychange","input"],M=>{if(!b.files?.length)return;const s=b.files[0],p=new FileReader;p.onload=()=>{O(p.result);},p.readAsText(s,"UTF-8");}),b.click();}),u.on($,"click",A=>{u.preventEvent(A),d.close();const b=B.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(p,E){p.close();}},ok:{text:"导入",callback:async(p,E)=>{const C=p.text;if(x.isNull(C)){_.error("请填入完整的url");return}const f=_.loading("正在获取配置..."),V=await pe.get(C,{allowInterceptConfig:false});if(f.close(),!V.status){h.error(V),_.error("获取配置失败",{consoleLogContent:true});return}await O(V.data.responseText)&&p.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:J.info.width,height:"auto"}),M=b.$shadowRoot.querySelector("input"),s=b.$shadowRoot.querySelector(".pops-prompt-btn-ok");u.on(M,["input","propertychange"],p=>{u.val(M)===""?u.attr(s,"disabled","true"):u.removeAttr(s,"disabled");}),u.onKeyboard(M,"keydown",(p,E,C)=>{p==="Enter"&&C.length===0&&u.val(M)!==""&&u.emit(s,"click");}),u.emit(M,"input");}),u.on(G,"click",async A=>{u.preventEvent(A),d.close();let b=await T.getClipboardText();if(b.trim()===""){_.warning("获取到的剪贴板内容为空");return}await O(b);});},r=(w=`${ue}_panel-setting-${x.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,d)=>{const y=B.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),$=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),G=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");u.on($,"click",D=>{u.preventEvent(D);try{n(w,d),y.close();}catch(O){_.error(O.toString(),{consoleLogContent:true});}}),u.on(G,"click",async D=>{await x.copy(d)?(_.success("复制成功"),y.close()):_.error("复制失败");});},l=B.confirm({title:{text:"配置",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof te=="function")te().forEach(d=>{const y=X(d);Reflect.set(c,d,y);});else {_.warning("不支持函数GM_listValues，仅导出菜单配置");const w=X(ne);Reflect.set(c,ne,w);}const S=T.toStr(c);l.value=S;},a=()=>{let i=Z?.script?.supportURL||Z?.script?.namespace;typeof i=="string"&&x.isNotNull(i)&&window.open(i,"_blank");};return [{id:"script-version",title:`版本：${Z?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(i){new Oe(i.$asideLiElement).on("tap",function(m){clearTimeout(t),t=void 0,e?(e=false,o()):(t=setTimeout(()=>{e=false,a();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},De={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{v.showPanel(ie.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){T.isTopWindow()&&we.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let n=this.$data.menuOption.findIndex(o=>o.key===t.key);n!==-1&&(this.$data.menuOption[n]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}};class Ie{storageKey;listenerData;constructor(t){if(typeof t=="string"){const n=t.trim();if(n=="")throw new Error("key参数不能为空字符串");this.storageKey=n;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new se.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let t=X(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){le(this.storageKey,t);}set(t,n){const o=this.get(t),a=this.getLocalValue();Reflect.set(a,t,n),this.setLocalValue(a),this.emitValueChangeListener(t,n,o);}get(t,n){const o=this.getLocalValue();return Reflect.get(o,t)??n}getAll(){return this.getLocalValue()}delete(t){const n=this.get(t),o=this.getLocalValue();Reflect.deleteProperty(o,t),this.setLocalValue(o),this.emitValueChangeListener(t,void 0,n);}has(t){const n=this.getLocalValue();return Reflect.has(n,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(n=>Reflect.get(t,n))}clear(){Y(this.storageKey);}addValueChangeListener(t,n){const o=Math.random(),a=this.listenerData.get(t)||[];return a.push({id:o,key:t,callback:n}),this.listenerData.set(t,a),o}removeValueChangeListener(t){let n=false;for(const[o,a]of this.listenerData.entries()){for(let i=0;i<a.length;i++){const r=a[i];(typeof t=="string"&&r.key===t||typeof t=="number"&&r.id===t)&&(a.splice(i,1),i--,n=true);}this.listenerData.set(o,a);}return n}async emitValueChangeListener(...t){const[n,o,a]=t;if(!this.listenerData.has(n))return;const i=this.listenerData.get(n);for(let r=0;r<i.length;r++){const m=i[r];if(typeof m.callback=="function"){let l,c;t.length===1||(t.length===2?l=o:t.length===3&&(l=o,c=a)),await m.callback(n,l,c);}}}}const N=new Ie(ne),v={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new x.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new x.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new x.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new x.Dictionary),this.__onceExecData},get scriptName(){return ue},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ne,attributeKeyName:oe,attributeDefaultValueName:ae},init(){this.initContentDefaultValue(),De.init();},initContentDefaultValue(){const e=o=>{if(!o.attributes||o.type==="button"||o.type==="container"||o.type==="deepMenu")return;const a=o.attributes;let i=a[Ae];if(typeof i=="function"){let c=i();if(typeof c=="boolean"&&!c)return}let r=new Map,m=a[oe];if(m!=null){const c=a[ae];r.set(m,c);}let l=a[Le];if(typeof l=="object"&&l&&Object.keys(l).forEach(c=>{const S=l[c];r.set(c,S);}),!r.size){h.warn("请先配置键",o);return}if(o.type==="switch"){let c=typeof o.disabled=="function"?o.disabled():o.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...r.keys());}for(const[c,S]of r.entries())this.setDefaultValue(c,S);},t=o=>{for(let a=0;a<o.length;a++){let i=o[a];e(i);let r=i.views;r&&Array.isArray(r)&&t(r);}},n=[...ie.getAllContentConfig()];for(let o=0;o<n.length;o++){let a=n[o];if(!a.views)continue;const i=a.views;i&&Array.isArray(i)&&t(i);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&h.warn("该key已存在，初始化默认值失败: "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){N.set(e,t);},getValue(e,t){const n=N.get(e);return n??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){N.delete(e);},hasKey(e){return N.has(e)},addValueChangeListener(e,t,n){const o=N.addValueChangeListener(e,t);if(n?.immediate||n?.immediateAll){const a=this.getValue(e);n?.immediate?t(e,a,a):n?.immediateAll&&v.emitMenuValueChange(e,a,a);}return o},removeValueChangeListener(e){N.removeValueChangeListener(e);},emitMenuValueChange(e,t,n){N.emitValueChangeListener(e,t,n);},async exec(e,t,n,o=true){const a=this;let i;typeof e=="string"||Array.isArray(e)?i=()=>e:i=e;let r=false;const m=i();let l=[];Array.isArray(m)?(r=true,l=m):l.push(m);const c=l.find(s=>!this.$data.contentConfigInitDefaultValue.has(s));if(c){h.warn(`${c} 键不存在`);return}const S=JSON.stringify(l);if(o&&this.$data.onceExecMenuData.has(S))return this.$data.onceExecMenuData.get(S);let w=[];const d=[];let y=[];const $=(s,p)=>{let E=[],C=[],f=[];if(Array.isArray(p))f=f.concat(p);else {const g=k=>{if(typeof k=="object"&&k!=null)if(k instanceof Element)f.push(k);else {const{$css:I,destory:P}=k;I!=null&&(Array.isArray(I)?f=f.concat(I):f.push(I)),typeof P=="function"&&f.push(P);}else f.push(k);};if(p!=null&&Array.isArray(p))for(const k of p)g(k);else g(p);}const V=g=>{if(g!=null){if(g instanceof Element){E.push(g);return}if(typeof g=="function"){C.push(g);return}}};for(const g of f){const k=V(g);if(typeof k=="boolean"&&!k)break;if(Array.isArray(g))for(const I of g){const P=V(I);if(typeof P=="boolean"&&!P)break}}D(),O(),s&&(w=w.concat(E),y=y.concat(C));},G=s=>!!this.getValue(s),D=()=>{for(let s=0;s<w.length;s++)w[s]?.remove(),w.splice(s,1),s--;},O=()=>{for(let s=0;s<y.length;s++){const p=y[s];p(),y.splice(s,1),s--;}},A=()=>{let s=false;return typeof n=="function"?s=n(l):s=l.every(p=>G(p)),s},b=async s=>{const p=A();let E=[];if(p){const C=l.map(f=>this.getValue(f));E=await t({key:l,triggerKey:s?.key,value:r?C:C[0],addStoreValue:(...f)=>$(p,f)});}$(p,E);};o&&l.forEach(s=>{const p=this.addValueChangeListener(s,(E,C,f)=>b({key:E}));d.push(p);}),await b();const M={reload(){this.clearStoreStyleElements(),this.destory(),b();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>D(),destory(){return O()},removeValueChangeListener:()=>{d.forEach(s=>{this.removeValueChangeListener(s);});},clearOnceExecMenuData(){o&&a.$data.onceExecMenuData.delete(S);}};return this.$data.onceExecMenuData.set(S,M),M},async execMenu(e,t,n=false,o=false){return await this.exec(e,async a=>await t(a),a=>a.every(r=>{let m=!!this.getValue(r);return v.$data.contentConfigInitDisabledKeys.includes(r)&&(m=false,h.warn(`.execMenu${o?"Once":""} ${r} 被禁用`)),n&&(m=!m),m}),o)},async execMenuOnce(e,t,n=false,o=false){const a=await this.execMenu(e,t,n,true);if(o&&a){const i=()=>{a.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,i);}return a},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),N.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t),{off:()=>this.removeUrlChangeWithExecMenuOnceListener(e)}},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async emitUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const n of t)await n(e);},showPanel(e,t=`${ue}-设置`,n=false,o=false){this.$data.$panel=null,this.$data.panelContent=[];const a=e.findIndex(r=>(typeof r.isBottom=="function"?r.isBottom():!!r.isBottom)&&r.id==="script-version")!==-1;!n&&!a&&e.push(...ie.getDefaultBottomContentConfig());const i=B.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:r=>{r.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:r=>{r(),this.$data.$panel=null;}},width:J.setting.width,height:J.setting.height,drag:true,only:true,style:`
      ...
      `,...this.$data.panelConfig});this.$data.$panel=i,this.$data.panelContent=e,o||this.registerConfigSearch({$panel:i,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,o=async(d,y)=>{if(d==null)return;const $=await y(d);return $&&typeof $.isFind=="boolean"&&$.isFind?$.data:await o($.data,y)},a=(d,y)=>{const $=new IntersectionObserver(G=>{G.forEach(D=>{D.isIntersecting&&(y?.(),$.disconnect());});},{root:null,threshold:1});$.observe(d),d.scrollIntoView({behavior:"smooth",block:"center"});},i=d=>{const y="pops-flashing";u.onAnimationend(d,()=>{d.classList.remove(y);}),d.classList.add(y);},r=d=>{if(d.type==="dblclick"&&w)return;u.preventEvent(d);const y=B.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});y.$shadowRoot.querySelector(".search-wrapper");const $=y.$shadowRoot.querySelector(".search-config-text"),G=y.$shadowRoot.querySelector(".search-result-wrapper");$.focus();const D=()=>{u.empty(G);},O=b=>{const M=x.queryProperty(b,E=>E?.next?{isFind:false,data:E.next}:{isFind:true,data:E}),s=u.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),p=B.fn.PanelHandlerComponents();return u.on(s,"click",()=>{const C=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[b.index];if(!C){_.error(`左侧项下标${b.index}不存在`);return}C.scrollIntoView({behavior:"smooth",block:"center"}),C.click(),o(b.next,async f=>{if(f?.next){const V=await u.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(g=>{const k=Reflect.get(g,p.$data.nodeStoreConfigKey);return typeof k=="object"&&k!=null&&k.text===f.name}),2500);if(V)V.click();else return _.error("未找到对应的二级菜单"),{isFind:true,data:f};return {isFind:false,data:f.next}}else {const V=await u.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(g=>Reflect.get(g,p.$data.nodeStoreConfigKey)===f.matchedData?.formConfig),2500);if(V){a(V);const g=V.closest(".pops-panel-forms-fold[data-fold-enable]");g&&(g.querySelector(".pops-panel-forms-fold-container").click(),await x.sleep(500)),a(V,()=>{i(V);});}else _.error("未找到对应的菜单项");return {isFind:true,data:f}}});}),s},A=b=>{const M=new RegExp(b,"i"),s=[],p=(C,f)=>{for(let V=0;V<C.length;V++){const g=C[V],k=g.views;if(k&&Array.isArray(k)){const I=x.deepClone(f);if(g.type==="deepMenu"){const P=x.queryProperty(I,H=>H?.next?{isFind:false,data:H.next}:{isFind:true,data:H});P.next={name:g.text};}p(k,I);}else {let I,P;if(g.type==="own"){const U=Reflect.get(g.attributes||{},Te);U&&(typeof U.text=="string"&&(I=U.text),typeof U.desc=="string"&&(P=U.desc));}else I=g.text,P=Reflect.get(g,"description");const H=[I,P],he=H.findIndex(U=>{if(typeof U=="string")return U.match(M)});if(he!==-1){const U=x.deepClone(f),fe=x.queryProperty(U,q=>q?.next?{isFind:false,data:q.next}:{isFind:true,data:q});fe.next={name:I,matchedData:{path:"",formConfig:g,matchedText:H[he],description:P}};const ge=[];x.queryProperty(U,q=>{const ce=q?.name;return typeof ce=="string"&&ce.trim()!==""&&ge.push(ce),q?.next?{isFind:false,data:q.next}:{isFind:true,data:q}});const Me=ge.join(T.escapeHtml(" - "));fe.next.matchedData.path=Me,s.push(U);}}}};for(let C=0;C<n.length;C++){const f=n[C];if(!f.views||f.isBottom&&f.id==="script-version")continue;const V=f.views;if(V&&Array.isArray(V)){let g=f.title;typeof g=="function"&&(g=g()),p(V,{index:C,name:g});}}const E=document.createDocumentFragment();for(const C of s){let f=O(C);E.appendChild(f);}D(),G.append(E);};u.on($,"input",x.debounce(b=>{u.preventEvent(b);let M=u.val($).trim();if(M===""){D();return}A(M);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(d=>{u.on(d,"dblclick",r);});let l=new WeakMap,c=false,S,w=false;u.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(d,y)=>{w=true,clearTimeout(S),S=void 0,c&&l.has(y)?(c=false,l.delete(y),r(d)):(S=setTimeout(()=>{c=false;},200),c=true,l.set(y,d));},{capture:true}),t.$shadowRoot.appendChild(u.createElement("style",{type:"text/css",textContent:`
    			.pops-flashing{
    		...
    		`}));},transformKey(e){if(Array.isArray(e)){const t=e.sort();return JSON.stringify(t)}else return e},getDynamicValue(e,t){const n=this;let o=false,a=t;const i=this.addValueChangeListener(e,(r,m)=>{a=m;});return {get value(){return o||(o=true,a=n.getValue(e,t)),a},destory(){n.removeValueChangeListener(i);}}}},W={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},x=se.noConflict(),u=F.noConflict(),B=de,h=new x.Log(Z,R.console||Re.console),ue=Z?.script?.name||void 0,Oe=de.fn.Utils.AnyTouch(),Pe=false;h.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});const Ce=()=>{let t=100;const n=de.fn.InstanceUtils.getPopsMaxZIndex()?.zIndex??100,o=se.getMaxZIndexNodeInfoFromPoint()[0]?.zIndex??100;return t=Math.max(t,n,o),t};_.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?h.warn(n):t==="error"?h.error(n):h.info(n),false},get position(){return v.getValue(W.qmsg_config_position.key,W.qmsg_config_position.defaultValue)},get maxNums(){return v.getValue(W.qmsg_config_maxnums.key,W.qmsg_config_maxnums.defaultValue)},get showReverse(){return v.getValue(W.qmsg_config_showreverse.key,W.qmsg_config_showreverse.defaultValue)},get zIndex(){return Ce()}});B.GlobalConfig.setGlobalConfig({zIndex:()=>Ce(),mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const we=new x.GM_Menu({GM_getValue:X,GM_setValue:le,GM_registerMenuCommand:ke,GM_unregisterMenuCommand:$e}),pe=new x.Httpx({xmlHttpRequest:Ee,logDetails:Pe});pe.interceptors.request.use(e=>e);pe.interceptors.response.use(void 0,e=>(h.error("拦截器-请求错误",e),e.type==="onabort"?_.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?_.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?_.error("请求超时",{consoleLogContent:true}):_.error("其它错误",{consoleLogContent:true}),e));R.Object.defineProperty,R.Object.keys,R.Object.values,R.Function.prototype.apply,R.Function.prototype.call,R.Element.prototype.appendChild,R.setTimeout.bind(R),R.clearTimeout.bind(R),R.setInterval.bind(R),R.clearInterval.bind(R);const re=u.addStyle.bind(u);F.selector.bind(F);F.selectorAll.bind(F);new x.GM_Cookie;const Ue={isGoWild(){return window.location.pathname==="/go-wild"}},xe=function(e=""){u.waitNodeList(e).then(t=>{t.forEach(n=>n.remove());});},z={init(){this.addCSS(),v.execMenu("JianShuAutoJumpRedirect_PC",()=>{this.jumpRedirect();}),v.execMenu("JianShuRemoveClipboardHijacking",()=>{this.removeClipboardHijacking();}),v.execMenu("JianShuAutoExpandFullText",()=>{this.autoExpandFullText();}),v.execMenu("JianShuArticleCenter",()=>this.articleCenter()),v.execMenu("JianShuShieldRelatedArticles",()=>this.blockRelatedArticles()),v.execMenu("jianshu-shieldClientDialog",()=>{this.blockClientDialog();}),v.execMenuOnce("JianShuShieldUserComments",()=>this.blockUserComments()),v.execMenuOnce("JianShuShieldRecommendedReading",()=>this.blockRecommendedReading()),v.execMenuOnce("jianshu-shieldTopNav",()=>this.blockTopNav()),v.execMenuOnce("jianshu-shieldBottomToolbar",()=>this.blockBottomToolbar());},addCSS(){return h.info("添加屏蔽CSS"),re(Ve)},articleCenter(){h.info("全文居中");let e=[];return e.push(T.addBlockCSS("div[role=main] aside","div._3Pnjry"),re(`
			div[role=main] aside,
			div._3Pnjry{
				display: none !important;
			}

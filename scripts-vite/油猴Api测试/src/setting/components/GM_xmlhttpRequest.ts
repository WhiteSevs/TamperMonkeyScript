...
import { GM, GM_xmlhttpRequest } from "ViteGM";
...
export const PanelUI_GM_xmlhttpRequest = (): PopsPanelContentConfig => {
	...
	let result: PopsPanelContentConfig = {
		...
		isDefault() {
			return (
				StorageApi.get(PanelKeyConfig.asideLastVisit) === "GM_xmlhttpRequest"
			);
		},
		callback(data) {

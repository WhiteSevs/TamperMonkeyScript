...
export class ApiTest_audio extends ApiAsyncTestBase {
	...
	public getApiOption() {
		...
		return {
			...
			isSupport_removeStateChangeListener:
				isSupport && typeof GM_audio?.removeStateChangeListener === "function",
		};
	}
	public getApiName() {
		return "GM_audio";
	...
	public getAsyncApiOption() {
		...
		return {
			...
			isSupport_addStateChangeListener:
				isSupportAsync && typeof GM.audio?.addStateChangeListener === "function",
			isSupport_removeStateChangeListener:
				isSupportAsync && typeof GM.audio?.removeStateChangeListener === "function",
		};
	}
	public getUIOption() {
		const that = this;

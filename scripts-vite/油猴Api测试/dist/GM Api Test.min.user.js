...
(function () {
  ...
  function Ar(){try{typeof Object.assign!="function"&&(Object.assign=function(...a){const e=Object(a[0]||{});return a.length>1&&[...a].splice(1,a.length-1).forEach(n=>{for(const r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r]);}),e});}catch(a){console.warn("Qmsg CompatibleProcessing Object.assign error",a);}try{"classList"in document.documentElement||Object.defineProperty(HTMLElement.prototype,"classList",{get:function(){const a=this;function e(t){return function(n){const r=a.className.split(/\s+/g),o=r.indexOf(n);t(r,o,n),a.className=r.join(" ");}}return {add:e(function(t,n,r){~n||t.push(r);}),remove:e(function(t,n){~n&&t.splice(n,1);}),toggle:e(function(t,n,r){~n?t.splice(n,1):t.push(r);}),contains:function(t){return !!~a.className.split(/\s+/g).indexOf(t)},item:function(t){return a.className.split(/\s+/g)[t]||null}}}});}catch(a){console.warn("Qmsg CompatibleProcessing HTMLElement.prototype.classList warning",a);}}const ye={INS_DEFAULT:{},get PLUGIN_NAME(){return "qmsg"},get NAMESPACE(){return "qmsg"},get config(){return {parent:document.body||document.documentElement,useShadowRoot:true,shadowRootMode:"open",animation:true,autoClose:true,listenEventToPauseAutoClose:true,listenEventToCloseInstance:true,content:"",isHTML:false,position:"top",showClose:false,maxNums:5,onClose:null,showIcon:true,showReverse:false,timeout:2500,type:"info",zIndex:5e4,style:"",customClass:"",isLimitWidth:false,limitWidthNum:200,limitWidthWrap:"no-wrap",consoleLogContent:false,afterRender:null}}},Sr=`
	<svg width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		</svg>`},Ce={insInfoList:[],remove(a){let e=false;for(let t=0;t<Ce.insInfoList.length;t++)if(Ce.insInfoList[t].uuid===a){Ce.insInfoList.splice(t,1),e=true;break}return e}},Cr=a=>(e,t)=>(a.set(e,t),t),cn=Number.MAX_SAFE_INTEGER===void 0?9007199254740991:Number.MAX_SAFE_INTEGER,Fn=536870912,dn=Fn*2,Tr=(a,e)=>t=>{const n=e.get(t);let r=n===void 0?t.size:n<dn?n+1:0;if(!t.has(r))return a(t,r);if(t.size<Fn){for(;t.has(r);)r=Math.floor(Math.random()*dn);return a(t,r)}if(t.size>cn)throw new Error("Congratulations, you created a collection of unique numbers which uses all available integers!");for(;t.has(r);)r=Math.floor(Math.random()*cn);return a(t,r)},jn=new WeakMap,kr=Cr(jn),zt=Tr(kr,jn),$r=a=>typeof a.start=="function",pn=new WeakMap,Er=a=>({...a,connect:({call:e})=>async()=>{const{port1:t,port2:n}=new MessageChannel,r=await e("connect",{port:t},[t]);return pn.set(n,r),n},disconnect:({call:e})=>async t=>{const n=pn.get(t);if(n===void 0)throw new Error("The given port is not connected.");await e("disconnect",{portId:n});},isSupported:({call:e})=>()=>e("isSupported")}),Dt=new WeakMap,Mr=a=>{if(Dt.has(a))return Dt.get(a);const e=new Map;return Dt.set(a,e),e},Lr=a=>{const e=Er(a);return t=>{const n=Mr(t);t.addEventListener("message",(({data:s})=>{const{id:l}=s;if(l!==null&&n.has(l)){const{reject:c,resolve:p}=n.get(l);n.delete(l),s.error===void 0?p(s.result):c(new Error(s.error.message));}})),$r(t)&&t.start();const r=(s,l=null,c=[])=>new Promise((p,d)=>{const f=zt(n);n.set(f,{reject:d,resolve:p}),l===null?t.postMessage({id:f,method:s},c):t.postMessage({id:f,method:s,params:l},c);}),o=(s,l,c=[])=>{t.postMessage({id:null,method:s,params:l},c);};let i={};for(const[s,l]of Object.entries(e))i={...i,[s]:l({call:r,notify:o})};return {...i}}},We=new Map([[0,null]]),Ke=new Map([[0,null]]),Ir=Lr({clearInterval:({call:a})=>e=>{typeof We.get(e)=="symbol"&&(We.set(e,null),a("clear",{timerId:e,timerType:"interval"}).then(()=>{We.delete(e);}));},clearTimeout:({call:a})=>e=>{typeof Ke.get(e)=="symbol"&&(Ke.set(e,null),a("clear",{timerId:e,timerType:"timeout"}).then(()=>{Ke.delete(e);}));},setInterval:({call:a})=>(e,t=0,...n)=>{const r=Symbol(),o=zt(We);We.set(o,r);const i=()=>a("set",{delay:t,now:performance.timeOrigin+performance.now(),timerId:o,timerType:"interval"}).then(()=>{const s=We.get(o);if(s===void 0)throw new Error("The timer is in an undefined state.");s===r&&(e(...n),We.get(o)===r&&i());});return i(),o},setTimeout:({call:a})=>(e,t=0,...n)=>{const r=Symbol(),o=zt(Ke);return Ke.set(o,r),a("set",{delay:t,now:performance.timeOrigin+performance.now(),timerId:o,timerType:"timeout"}).then(()=>{const i=Ke.get(o);if(i===void 0)throw new Error("The timer is in an undefined state.");i===r&&(Ke.delete(o),e(...n));}),o}}),_r=a=>{const e=new Worker(a);return Ir(e)},Rr=(a,e)=>{let t=null;return ()=>{if(t!==null)return t;const n=new Blob([e],{type:"application/javascript; charset=utf-8"}),r=URL.createObjectURL(n);return t=a(r),setTimeout(()=>URL.revokeObjectURL(r)),t}},Nr=`(()=>{var e={455:function(e,t){!function(e){"use strict";var t=function(e){return function(t){var r=e(t);return t.add(r),r}},r=function(e){return function(t,r){return e.set(t,r),r}},n=void 0===Number.MAX_SAFE_INTEGER?9007199254740991:Number.MAX_SAFE_INTEGER,o=536870912,s=2*o,a=function(e,t){return function(r){var a=t.get(r),i=void 0===a?r.size:a<s?a+1:0;if(!r.has(i))return e(r,i);if(r.size<o){for(;r.has(i);)i=Math.floor(Math.random()*s);return e(r,i)}if(r.size>n)throw new Error("Congratulations, you created a collection of unique numbers which uses all available integers!");for(;r.has(i);)i=Math.floor(Math.random()*n);return e(r,i)}},i=new WeakMap,u=r(i),c=a(u,i),l=t(c);e.addUniqueNumber=l,e.generateUniqueNumber=c}(t)}},t={};function r(n){var o=t[n];if(void 0!==o)return o.exports;var s=t[n]={exports:{}};return e[n].call(s.exports,s,s.exports,r),s.exports}(()=>{"use strict";const e=-32603,t=-32602,n=-32601,o=(e,t)=>Object.assign(new Error(e),{status:t}),s=t=>o('The handler of the method called "'.concat(t,'" returned an unexpected result.'),e),a=(t,r)=>async({data:{id:a,method:i,params:u}})=>{const c=r[i];try{if(void 0===c)throw(e=>o('The requested method called "'.concat(e,'" is not supported.'),n))(i);const r=void 0===u?c():c(u);if(void 0===r)throw(t=>o('The handler of the method called "'.concat(t,'" returned no required result.'),e))(i);const l=r instanceof Promise?await r:r;if(null===a){if(void 0!==l.result)throw s(i)}else{if(void 0===l.result)throw s(i);const{result:e,transferables:r=[]}=l;t.postMessage({id:a,result:e},r)}}catch(e){const{message:r,status:n=-32603}=e;t.postMessage({error:{code:n,message:r},id:a})}};var i=r(455);const u=new Map,c=(e,r,n)=>({...r,connect:({port:t})=>{t.start();const n=e(t,r),o=(0,i.generateUniqueNumber)(u);return u.set(o,()=>{n(),t.close(),u.delete(o)}),{result:o}},disconnect:({portId:e})=>{const r=u.get(e);if(void 0===r)throw(e=>o('The specified parameter called "portId" with the given value "'.concat(e,'" does not identify a port connected to this worker.'),t))(e);return r(),{result:null}},isSupported:async()=>{if(await new Promise(e=>{const t=new ArrayBuffer(0),{port1:r,port2:n}=new MessageChannel;r.onmessage=({data:t})=>e(null!==t),n.postMessage(t,[t])})){const e=n();return{result:e instanceof Promise?await e:e}}return{result:!1}}}),l=(e,t,r=()=>!0)=>{const n=c(l,t,r),o=a(e,n);return e.addEventListener("message",o),()=>e.removeEventListener("message",o)},d=(e,t)=>r=>{const n=t.get(r);if(void 0===n)return Promise.resolve(!1);const[o,s]=n;return e(o),t.delete(r),s(!1),Promise.resolve(!0)},f=(e,t,r,n)=>(o,s,a)=>{const i=o+s-t.timeOrigin,u=i-t.now();return new Promise(t=>{e.set(a,[r(n,u,i,e,t,a),t])})},m=new Map,h=d(globalThis.clearTimeout,m),p=new Map,v=d(globalThis.clearTimeout,p),w=((e,t)=>{const r=(n,o,s,a)=>{const i=n-e.now();i>0?o.set(a,[t(r,i,n,o,s,a),s]):(o.delete(a),s(!0))};return r})(performance,globalThis.setTimeout),g=f(m,performance,globalThis.setTimeout,w),T=f(p,performance,globalThis.setTimeout,w);l(self,{clear:async({timerId:e,timerType:t})=>({result:await("interval"===t?h(e):v(e))}),set:async({delay:e,now:t,timerId:r,timerType:n})=>({result:await("interval"===n?g:T)(e,t,r)})})})()})();`,$t=Rr(_r,Nr),Or=a=>$t().clearInterval(a),Pr=a=>$t().clearTimeout(a),Dr=(...a)=>$t().setInterval(...a),Br=(...a)=>$t().setTimeout(...a),fe={getNameSpacify(...a){return [ye.NAMESPACE,...a].join("-")},isNumber(a){return /^\d+$/.test(a)},getUUID(){return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){const e=Math.random()*16|0;return (a=="x"?e:e&3|8).toString(16)})},mergeArgs(a="",e){const t={};if(arguments.length===0)return t;if(e!=null){if(t.content=a,typeof e=="object"&&e!=null)return Object.assign(t,e)}else {if(typeof a=="object"&&a!=null)return Object.assign(t,a);t.content=a;}return t},toDynamicObject(a,...e){const t=Object.assign({},a??{});return Object.keys(t).forEach(n=>{let r=t[n];Object.defineProperty(t,n,{get(){const o=e.findIndex(i=>typeof i=="object"&&i!=null&&i.hasOwnProperty.call(i,n));return o!==-1?e[o][n]:r},set(o){r=o;}});}),t},setTimeout(a,e){try{return Br(a,e)}catch{return globalThis.setTimeout(a,e)}},clearTimeout(a){try{a!=null&&Pr(a);}catch{}finally{globalThis.clearTimeout(a);}},setInterval(a,e){try{return Dr(a,e)}catch{return globalThis.setInterval(a,e)}},clearInterval(a){try{a!=null&&Or(a);}catch{}finally{globalThis.clearInterval(a);}},setSafeHTML(a,e){try{a.innerHTML=e;}catch{if(globalThis.trustedTypes){const t=globalThis.trustedTypes.createPolicy("safe-innerHTML",{createHTML:n=>n});a.innerHTML=t.createHTML(e);}else throw new Error("QmsgUtils trustedTypes is not defined")}}},Ie={$state:{opening:"MessageMoveIn",done:"",closing:"MessageMoveOut"},$name:{startNameList:["animationName","WebkitAnimationName","MozAnimationName","msAnimationName","OAnimationName"],endNameList:["animationend","webkitAnimationEnd","mozAnimationEnd","MSAnimationEnd","oanimationend"]},__CAN_ANIMATION__:void 0,get CAN_ANIMATION(){return this.__CAN_ANIMATION__=this.__CAN_ANIMATION__??this.getStyleAnimationNameValue(document.createElement("div"))!=null,this.__CAN_ANIMATION__},getStyleAnimationNameValue(a){for(let e=0;e<this.$name.startNameList.length;e++){const t=this.$name.startNameList[e],n=a.style[t];if(n!=null)return n}},setStyleAnimationName(a,e=""){this.$name.startNameList.forEach(t=>{t in a.style&&(a.style[t]=e);});}},Hr=`@charset "utf-8";\r
.qmsg.qmsg-wrapper {\r
  position: fixed;\r
  top: 16px;\r
  left: 0;\r
...
`;const j={index:_a,ninePalaceGridPosition:Ra,scrollbar:Na,button:Oa,common:Pa,anim:Da,alertCSS:Ba,confirmCSS:Ha,promptCSS:Va,loadingCSS:Ua,iframeCSS:za,tooltipCSS:Fa,drawerCSS:ja,folderCSS:qa,panelCSS:Ga,rightClickMenu:Wa,panelComponents_Select:Ka},it={$data:{},$flag:{isInit:false},init(){if(!this.$flag.isInit){this.$flag.isInit=true;const a=u.createElement("style",{innerHTML:j.anim});u.appendHead(a),this.$data=null,this.$data=u.getKeyFrames(a.sheet),U.setTimeout(()=>{a.remove();},50);}},hasAnim(a){return Object.prototype.hasOwnProperty.call(this.$data,a)}},me={alert:[],confirm:[],drawer:[],folder:[],iframe:[],loading:[],panel:[],prompt:[],rightClickMenu:[],tooltip:[]},he={getMaxZIndexNodeInfo(a=1,e=Y.document,t){a=Number.isNaN(a)?1:a;const n=2*Math.pow(10,9);let r=0,o=null;function i(l){return l.position!=="static"&&l.display!=="none"}function s(l){if(typeof t=="function"){const p=t(l);if(typeof p=="boolean"&&!p)return}const c=Y.window.getComputedStyle(l);if(i(c)){const p=parseInt(c.zIndex);isNaN(p)||p>r&&(r=p,o=l),l.shadowRoot!=null&&l instanceof ShadowRoot&&l.shadowRoot.querySelectorAll("*").forEach(d=>{s(d);});}}return e.querySelectorAll("*").forEach(l=>{s(l);}),r+=a,r>=n&&(r=n),{node:o,zIndex:r}},getPopsMaxZIndex(a=1){a=Number.isNaN(a)?1:a;const e=2*Math.pow(10,9);let t=0,n=null;function r(i){return i.position!=="static"&&i.display!=="none"}Object.keys(me).forEach(i=>{const s=me[i];for(let l=0;l<s.length;l++){const c=s[l],p=window.getComputedStyle(c.$anim);if(r(p)){const d=parseInt(p.zIndex);isNaN(d)||d>t&&(t=d,n=c.$anim);}}}),t+=a;const o=t>=e;return o&&(t=e),{zIndex:t,animElement:n,isOverMaxZIndex:o}},getMaxZIndex(a=1){return this.getMaxZIndexNodeInfo(a).zIndex},removeInstance(a,e,t=false){function n(r){typeof r.beforeRemoveCallBack=="function"&&r.beforeRemoveCallBack(r),r?.$anim?.remove(),r?.$pops?.remove(),r?.$mask?.remove(),r?.$shadowContainer?.remove();}return a.forEach(r=>{r.forEach((o,i)=>{if(t||o.guid===e){const s=o.$anim.getAttribute("anim");if(it.hasAnim(s)){const l=s+"-reverse";o.$anim.style.width="100%",o.$anim.style.height="100%",o.$anim.style["animation-name"]=l,it.hasAnim(o.$anim.style["animation-name"])?u.on(o.$anim,u.getAnimationEndNameList(),function(){n(o);},{capture:true}):n(o);}else n(o);r.splice(i,1);}});}),a},hide(a,e,t,n,r,o){return new Promise(i=>{const s=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;U.setTimeout(()=>{o&&u.css(o,"display","none"),["top","bottom"].includes(c.direction)?s.style.setProperty("height","0"):["left","right"].includes(c.direction)?s.style.setProperty("width","0"):console.error("未知direction：",c.direction),i();},c.closeDelay);}else {const c=t.find(p=>p.guid===n);if(c){const p=c;if(p.$anim.style.width="100%",p.$anim.style.height="100%",Reflect.set(p.$anim.style,"animation-name",p.$anim.getAttribute("anim")+"-reverse"),it.hasAnim(Reflect.get(p.$anim.style,"animation-name"))){let d=function(){p.$anim.style.display="none",p.$mask&&(p.$mask.style.display="none"),u.off(p.$anim,u.getAnimationEndNameList(),d,{capture:true}),i();};u.on(p.$anim,u.getAnimationEndNameList(),d,{capture:true});}else p.$anim.style.display="none",p.$mask&&(p.$mask.style.display="none"),i();}}})},show(a,e,t,n,r,o){return new Promise(i=>{const s=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;U.setTimeout(()=>{o&&u.css(o,"display","");const p=c.direction,d=c.size.toString();["top","bottom"].includes(p)?s.style.setProperty("height",d):["left","right"].includes(p)?s.style.setProperty("width",d):console.error("未知direction：",p),i();},c.openDelay??0);}else {const c=t.find(p=>p.guid===n);if(c){const p=c;if(p.$anim.style.width="",p.$anim.style.height="",Reflect.set(p.$anim.style,"animation-name",p.$anim.getAttribute("anim").replace("-reverse","")),it.hasAnim(Reflect.get(p.$anim.style,"animation-name"))){let d=function(){u.off(p.$anim,u.getAnimationEndNameList(),d,{capture:true}),i();};p.$anim.style.display="",p.$mask&&(p.$mask.style.display=""),u.on(p.$anim,u.getAnimationEndNameList(),d,{capture:true});}else p.$anim.style.display="",p.$mask&&(p.$mask.style.display=""),i();}}})},close(a,e,t,n,r){return new Promise(o=>{const i=r.querySelector(".pops[type-value]"),s=a;function l(){function c(d){d.propertyName==="transform"&&(u.off(i,u.getTransitionEndNameList(),void 0,c),he.removeInstance([t],n),o());}if(u.on(i,u.getTransitionEndNameList(),c),getComputedStyle(i).transform!=="none"){u.emit(i,u.getTransitionEndNameList(),void 0,true);return}["top"].includes(s.direction)?i.style.setProperty("transform","translateY(-100%)"):["bottom"].includes(s.direction)?i.style.setProperty("transform","translateY(100%)"):["left"].includes(s.direction)?i.style.setProperty("transform","translateX(-100%)"):["right"].includes(s.direction)?i.style.setProperty("transform","translateX(100%)"):console.error("未知direction：",s.direction);}e==="drawer"?U.setTimeout(()=>{l();},s.closeDelay):(he.removeInstance([t],n),o());})},drag(a,e){e=Object.assign({limit:true,extraDistance:3,container:Y.globalThis,emitClick:true},e);let t=false,n=0,r=0;const o=U.AnyTouch(),i=new o(e.dragElement,{preventDefault(f){return typeof e.preventEvent=="function"?e.preventEvent(f):true}});u.css(e.dragElement,{cursor:"move"});function s(f){const h=f.style.transitionDuration;return globalThis.getComputedStyle(f).transitionDuration!=="0s"&&(f.style.transitionDuration="0s"),()=>{f.style.transitionDuration=h;}}function l(f){return f=f??globalThis,{width:u.width(f),height:u.height(f)}}function c(f){if(f=f??globalThis,U.isWin(f))return {left:0,top:0};{const h=f.getBoundingClientRect();return {left:h.left,top:h.top}}}let p=u.getTransform(a),d=null;i.on("pan",function(f){if(!t){t=true;const y=e.dragElement.getBoundingClientRect();n=f.x-y.left,r=f.y-y.top,p=u.getTransform(a),d=s(a);}let h=f.x-n+p.transformLeft,b=f.y-r+p.transformTop;if(f.phase==="move"){if(e.limit){const y=l(e.container).width-u.width(a)+p.transformLeft,{left:w,top:S}=c(e.container),v=l(e.container).height-u.height(a)+p.transformTop;h>y&&(h=y),b>v&&(b=v),h-e.extraDistance*2<w+p.transformLeft?(h=w+p.transformLeft,h+=e.extraDistance):h-=e.extraDistance,b-e.extraDistance*2<S+p.transformTop?(b=S+p.transformTop,b+=e.extraDistance):b-=e.extraDistance;}typeof e.moveCallBack=="function"&&e.moveCallBack(a,h,b),u.css(a,{left:h+"px",top:b+"px"});}f.phase==="end"&&(t=false,typeof d=="function"&&(d(),d=null),typeof e.endCallBack=="function"&&e.endCallBack(a,h,b));}),e.emitClick&&i.on(["tap"],function(f){f.changedPoints.forEach(h=>{u.emit(h.target,"click",void 0,true);});});},sortElementListByProperty(a,e,t=true){if(typeof t!="boolean")throw new TypeError("参数 sortByDesc 必须为boolean类型");if(a==null||e==null)throw new Error("获取前面的值或后面的值的方法不能为空");return function(n,r){const o=a(r),i=e(n);return t?i>o?-1:i<o?1:0:i<o?-1:i>o?1:0}}},N={handlerShadow(a){const e=u.createElement("div",{className:"pops-shadow-container"});if(a.useShadowRoot){const t=e.attachShadow({mode:"open"});return {$shadowContainer:e,$shadowRoot:t}}else return {$shadowContainer:e,$shadowRoot:e}},handleInit(a,e){if(it.init(),!!arguments.length&&a!=null&&e!=null){if(typeof e=="string"){if(e.trim()==="")return;e=[{css:e}];}else e=e.map(t=>typeof t=="string"?{css:t}:t);for(const t of e){const n=u.createElement("style",{},{"data-type":"PopsHandler.handleInit"});n.textContent=t.css,typeof t.name=="string"&&n.setAttribute("data-name",t.name),a.appendChild(n);}}},handleMask(a={}){const e={maskElement:u.parseTextToDOM(a.maskHTML)};let t=false;function n(o){u.preventEvent(o);const i=me[a.type];function s(){if(a.config.mask.clickEvent.toClose)return he.close(a.config,a.type,i,a.guid,a.animElement);if(a.config.mask.clickEvent.toHide)return he.hide(a.config,a.type,i,a.guid,a.animElement,e.maskElement)}return typeof a.config.mask.clickCallBack=="function"?a.config.mask.clickCallBack(s,a.config):s(),false}if(a.config.mask.clickEvent.toClose||a.config.mask.clickEvent.toHide){let o=function(i){return !!(i?.localName?.toLowerCase()==="div"&&i.className&&i.className==="pops-anim"&&i.hasAttribute("anim"))};u.on(a.animElement,["touchstart","mousedown"],void 0,i=>{const s=i.composedPath()[0];t=o(s);}),u.on(a.animElement,"click",void 0,i=>{const s=i.composedPath()[0];if(o(s)&&t)return n(i)}),u.on(e.maskElement,"click",void 0,i=>{t=true,n(i);});}return e},handleQueryElement(a,e){return {$pops:a.querySelector(".pops[type-value"),$btnOk:a.querySelector(`.pops-${e}-btn-ok`),$btnCancel:a.querySelector(`.pops-${e}-btn-cancel`),$btnOther:a.querySelector(`.pops-${e}-btn-other`),$title:a.querySelector(`.pops-${e}-title`),$input:a.querySelector(`.pops-${e}-content textarea[pops]`)?a.querySelector(`.pops-${e}-content textarea[pops]`):a.querySelector(`.pops-${e}-content input[pops]`),$headerControls:a.querySelector(".pops-header-controls"),$iframe:a.querySelector("iframe[pops]"),$loading:a.querySelector(".pops-loading"),$content:a.querySelector(`.pops-${e}-content`),$panelRightSectionWrapper:a.querySelector(`.pops-${e}-section-wrapper`),$panelLeftAside:a.querySelector(`.pops-${e}-content aside.pops-${e}-aside`),$panelContentSectionContainer:a.querySelector(`.pops-${e}-content section.pops-${e}-container`),$panelBottomWrapper:a.querySelector(`.pops-${e}-bottom-wrapper`),$panelBottomContainer:a.querySelector(`.pops-${e}-bottom-container`),$panelBottomLeftContainer:a.querySelector(`.pops-${e}-bottom-left-container`),$panelBottomRightContainer:a.querySelector(`.pops-${e}-bottom-right-container`),$contentLoading:a.querySelector(`.pops-${e}-content-global-loading`),$headerBtnMin:a.querySelector(".pops-header-control[data-type='min']"),$headerBtnMax:a.querySelector(".pops-header-control[data-type='max']"),$headerBtnMise:a.querySelector(".pops-header-control[data-type='mise']"),$headerBtnClose:a.querySelector(".pops-header-control[data-type='close']"),$folderList:a.querySelector(".pops-folder-list"),$folderHeaderNav:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div"),$folderHeaderRow:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div .pops-folder-list-table__header-row"),$folderTbody:a.querySelector(".pops-folder-list .pops-folder-list-table__body-div tbody"),$folderHeaderBreadcrumbPrimary:a.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-primary"),$folderSortFileName:a.querySelector('.pops-folder-list-table__sort[data-sort="fileName"]'),$folderSortLatestTime:a.querySelector('.pops-folder-list-table__sort[data-sort="latestTime"]'),$folderSortFileSize:a.querySelector('.pops-folder-list-table__sort[data-sort="fileSize"]')}},handleEventConfig(a,e,t,n,r,o,i,s){return {$shadowContainer:t,$shadowRoot:n,$el:o,$anim:o,$pops:i,$mask:s,mode:r,guid:e,close(){return he.close(a,r,me[r],e,o)},hide(){return he.hide(a,r,me[r],e,o,s)},show(){return he.show(a,r,me[r],e,o,s)}}},handleLoadingEventConfig(a,e,t,n,r,o){return {$el:n,$anim:n,$pops:r,$mask:o,mode:t,guid:e,close(){return he.close(a,t,me[t],e,n)},hide(){return he.hide(a,t,me[t],e,n,o)},show(){return he.show(a,t,me[t],e,n,o)}}},handleResultConfig(a){const e=Object.assign({},a);return U.delete(e,"type"),U.delete(e,"function"),e},handleClickEvent(a,e,t,n){typeof n=="function"&&u.on(e,"click",r=>{n(Object.assign(t,{type:a}),r);},{capture:true});},handleKeyboardEvent(a,e=[],t){const n=function(r){const o=r.code||r.key,i=r.charCode||r.keyCode||r.which;e.includes("ctrl")&&!r.ctrlKey||e.includes("alt")&&!r.altKey||e.includes("meta")&&!r.metaKey||e.includes("shift")&&!r.shiftKey||(typeof a=="string"&&a===o?t&&t(r):typeof a=="number"&&a===i&&t&&t(r));};return u.on(Y.globalThis,"keydown",n,{capture:true}),{removeKeyboardEvent(){u.off(globalThis,"keydown",n,{capture:true});}}},handlePromptClickEvent(a,e,t,n,r){u.on(t,"click",o=>{const i={type:a,text:e.value};r(Object.assign(n,i),o);},{capture:true});},handleZIndex(a){return typeof a=="function"?a():a},handleOnly(a,e){if(e.only)if(a==="loading"||a==="tooltip"||a==="rightClickMenu"){const t=me[a];t&&he.removeInstance([t],"",true);}else he.removeInstance([me.alert,me.confirm,me.prompt,me.iframe,me.drawer,me.folder,me.panel],"",true);else {const t=e.zIndex;e.zIndex=()=>{const{zIndex:n}=he.getPopsMaxZIndex(N.handleZIndex(t)+100);return n};}return e},handlePush(a,e){me[a].push(e);}},Xa=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{position:"flex-end",ok:{size:void 0,enable:true,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback:function(a){a.close();}},close:{enable:true,callback:function(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),Wt={init(a){const e=U.getRandomGUID(),t="alert";let n=Xa();n=U.assign(n,we.getGlobalConfig()),n=U.assign(n,a),n=N.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);N.handleInit(o,[{name:"index",css:j.index},{name:"ninePalaceGridPosition",css:j.ninePalaceGridPosition},{name:"scrollbar",css:j.scrollbar},{name:"button",css:j.button},{name:"anim",css:j.anim},{name:"common",css:j.common},{name:"alertCSS",css:j.alertCSS}]);const i=N.handleZIndex(n.zIndex),s=Z.createMask(e,i),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:p,headerPStyle:d}=Z.createHeaderStyle(t,n),{contentStyle:f,contentPStyle:h}=Z.createContentStyle(t,n),b=Z.createAnim(e,t,n,`
            ...
            </div>${h}`,h,p),S=Z.parseElement(w),{$pops:v,$title:A,$content:C,$folderTbody:x,$folderHeaderBreadcrumbPrimary:E,$headerBtnClose:B,$btnOk:z,$btnCancel:F,$btnOther:X,$folderSortFileName:K,$folderSortLatestTime:$,$folderSortFileSize:M}=N.handleQueryElement(S,t);let T;const g=[S];n.mask.enable&&(T=N.handleMask({type:t,guid:e,config:n,animElement:S,maskHTML:d}).maskElement,g.push(T));const k=N.handleEventConfig(n,e,r,o,t,S,v,T);N.handleClickEvent("close",B,k,n.btn.close.callback),N.handleClickEvent("ok",z,k,n.btn.ok.callback),N.handleClickEvent("cancel",F,k,n.btn.cancel.callback),N.handleClickEvent("other",X,k,n.btn.other.callback),u.append(o,g),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r),T!=null&&S.after(T);class P{init(){n.folder.sort(),this.initFolderView(n.folder);const H=E.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-allFiles:first-child");Reflect.set(H,"data-config",n.folder),u.on(H,"click",_=>{this.setBreadcrumbClickEvent(_,true,n.folder);}),u.on(K.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(K,_,"fileName");},{capture:true}),u.on($.closest("th"),"click",_=>{this.arrowToSortFolderInfoView($,_,"latestTime");},{capture:true}),u.on(M.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(M,_,"fileSize");},{capture:true}),n.sort.name==="fileName"?u.emit(K,"click",{notChangeSortRule:true}):n.sort.name==="latestTime"?u.emit($,"click",{notChangeSortRule:true}):n.sort.name==="fileSize"&&u.emit(M,"click",{notChangeSortRule:true});}createFolderRowElement(H,_="-",q="-",ne=false){const J=H,ae=_,ge=q,xe=u.createElement("tr"),be=u.createElement("td"),ue=u.createElement("td"),Me=u.createElement("td");let nt="",Be=pe.folder;if(ne)_="",q="";else {Be="",typeof _=="number"&&(_=U.formatTime(_)),typeof q=="number"&&(q=U.formatByteToSize(q));for(const Pt in pe)if(H.toLowerCase().endsWith("."+Pt)){nt=Pt,Be=Reflect.get(pe,Pt);break}Be||(nt="Null",Be=pe.Null);}xe.className="pops-folder-list-table__body-row",be.className="pops-folder-list-table__body-td",ue.className="pops-folder-list-table__body-td",Me.className="pops-folder-list-table__body-td",ee.setSafeHTML(be,`
				<div class="pops-folder-list-file-name cursor-p">
					<div>
						<img src="${Be}" alt="${nt}" class="pops-folder-list-file-icon u-file-icon u-file-icon--list">
            ...
            `),ee.setSafeHTML(ue,`
				...
				`);const wt={fileName:J,latestTime:ae,fileSize:ge,isFolder:ne};return Reflect.set(be,"__value__",wt),Reflect.set(ue,"__value__",wt),Reflect.set(Me,"__value__",wt),Reflect.set(xe,"__value__",wt),xe.appendChild(be),xe.appendChild(ue),xe.appendChild(Me),{folderElement:xe,fileNameElement:be,fileTimeElement:ue,fileFormatSize:Me}}createFolderRowElementByMobile(H,_="-",q="-",ne=false){const J=H,ae=_,ge=q,xe=u.createElement("tr"),be=u.createElement("td");let ue="",Me=pe.folder;if(ne)_="",q="";else {Me="",typeof _=="number"&&(_=U.formatTime(_)),typeof q=="number"&&(q=U.formatByteToSize(q));for(const Be in pe)if(H.toLowerCase().endsWith("."+Be)){ue=Be,Me=Reflect.get(pe,Be);break}Me||(ue="Null",Me=pe.Null);}xe.className="pops-folder-list-table__body-row",be.className="pops-folder-list-table__body-td",ee.setSafeHTML(be,`
          ...
          <div class="pops-panel-input_inner">
			...
			`);const n={[Symbol.toStringTag]:"PopsPanelTextArea",$ele:{itemLeftTextContainer:e.querySelector(".pops-panel-item-left-text"),panelTextarea:e.querySelector(".pops-panel-textarea"),textarea:e.querySelector(".pops-panel-textarea textarea")},$data:{value:a.getValue()},init(){this.setValue(this.$data.value),this.onValueChange(),(typeof a.disabled=="function"?a.disabled():a.disabled)&&this.disable();},disable(){this.$ele.textarea.setAttribute("disabled","true"),u.addClassName(this.$ele.panelTextarea,"pops-panel-textarea-disable"),u.addClassName(this.$ele.itemLeftTextContainer,de.textIsDisabled);},notDisable(){this.$ele.textarea.removeAttribute("disabled"),u.removeClassName(this.$ele.panelTextarea,"pops-panel-textarea-disable"),u.removeClassName(this.$ele.itemLeftTextContainer,de.textIsDisabled);},isDisabled(){return this.$ele.textarea.hasAttribute("disabled")||u.containsClassName(this.$ele.panelTextarea,"pops-panel-textarea-disable")},setValue(r){this.$ele.textarea.value=r;},onValueChange(){u.on(this.$ele.textarea,["input","propertychange"],r=>{const o=this.$ele.textarea.value;this.$data.value=o,typeof a.callback=="function"&&a.callback(r,o);});}};return n.init(),Reflect.set(e,"data-textarea",n),{$el:e,handler:n}},createSectionContainerItem_select(a){const e=this,t=u.createElement("li");Reflect.set(t,this.$data.nodeStoreConfigKey,a),this.setElementClassName(t,a.className),this.setElementAttributes(t,a.attributes),this.setElementProps(t,a.props);let n="";a.description&&(n=`<p class="pops-panel-item-left-desc-text">${a.description}</p>`),ee.setSafeHTML(t,`
              ...
              `});return this.setSelectItemText(d,f),Reflect.set(f,"data-info",d),f},setSelectItemText(d,f){const h=typeof d.text=="function"?d.text(d.value,this.$data.selectedData):d.text,b=f.querySelector(".select-item-text");b&&(d.isHTML?ee.setSafeHTML(b,h):b.innerText=h);},onSelectItemClick(d,f){u.on(f,"click",h=>{if(u.preventEvent(h),!this.isDisabled()&&!this.isSelectItemDisabled(f)){if(typeof a.clickCallBack=="function"){const b=a.clickCallBack(h,this.$data.selectedData);if(typeof b=="boolean"&&!b)return}this.isItemSelected(f)?(this.removeItemSelected(f),this.removeSelectedItemInfo()):(this.setItemSelected(f),this.addSelectedItemInfo(d));}});},onValueChangeCallback(d,f=true){f&&this.updateAllSelectItemStatus(),typeof a.callback=="function"&&a.callback(d||this.$data.selectedData);},updateAllSelectItemStatus(){this.getAllSelectItems(false).forEach(f=>{const{data:h,$select:b}=f;this.setSelectItemText(h,f.$select),typeof h.disable=="function"&&h.disable(h.value,this.$data.selectedData)?(this.removeItemSelected(b),this.setSelectItemDisabled(b)):this.removeSelectItemDisabled(b),this.$data.selectedData!=null&&this.$data.selectedData.value===h.value?this.setItemSelected(b):this.removeItemSelected(b);});},resetAllSelectedItemStatus(){const d=this.getAllSelectItems(true);d.length&&this.resetCurrentSelectedInfo(),d.forEach(f=>{const{data:h,$select:b}=f;this.setSelectItemText(h,f.$select),this.removeItemSelected(b),this.removeSelectItemDisabled(b);});},addSelectedItemInfo(d){this.resetCurrentSelectedInfo(),this.updateSelectedInfo(d),this.onValueChangeCallback(d);},removeSelectedItemInfo(){this.updateSelectedInfo(),this.onValueChangeCallback();},updateSelectedInfo(d){if(this.$data.selectedData=void 0,d){if(d.addCustomInput&&d.value.toString()==="")return;this.$data.selectedData=d;}},resetCurrentSelectedInfo(){this.updateSelectedInfo();},setSelectItemDisabled(d){d.setAttribute("aria-disabled","true"),d.setAttribute("disabled","true");},removeSelectItemDisabled(d){d.removeAttribute("aria-disabled"),d.removeAttribute("disabled");},isSelectItemDisabled(d){return d.hasAttribute("disabled")||d.ariaDisabled},setItemSelected(d){this.isItemSelected(d)||d.classList.add("select__selected-item");},removeItemSelected(d){d.classList.remove("select__selected-item");},isItemSelected(d){return d.classList.contains("select__selected-item")},getAllSelectItems(d=true){return Array.from(this.$el.$wrapper?.querySelectorAll(".select-item")??[]).map(f=>{const b={data:this.getItemDataOption(f),$select:f};return d?this.isItemSelected(f)?b:void 0:b}).filter(f=>f!=null)},getItemDataOption(d){return Reflect.get(d,"data-info")}};p.init(),Reflect.set(t,"data-select",p),c=p;}return {$el:t,handler:c}},createSectionContainerItem_select_multiple(a){const e=u.createElement("li");Reflect.set(e,this.$data.nodeStoreConfigKey,a),this.setElementClassName(e,a.className),this.setElementAttributes(e,a.attributes),this.setElementProps(e,a.props);let t="";a.description&&(t=`<p class="pops-panel-item-left-desc-text">${a.description}</p>`),ee.setSafeHTML(e,`
				<div class="pops-panel-item-left-text">
					<p class="pops-panel-item-left-main-text">${a.text}</p>${t}</div>
				...
				`);const s={[Symbol.toStringTag]:"PopsPanelDeepMenu",$ele:{get parentSection(){return e.$el.$panelContentSectionContainer}},init(){this.onLiClick();},initContainerItem(l,c){const p=c;if(p.type==="container"){const d=p.views,f=u.createElement("li"),h=u.createElement("ul");h.classList.add("pops-panel-forms-container-item-formlist"),f.classList.add("pops-panel-forms-container-item");const b=u.createElement("div",{className:"pops-panel-forms-container-item-header-text"});ee.setSafeHTML(b,p.text),p.isFold&&(ee.setSafeHTML(b,`
								<p>${p.text}</p>
...
`)}{display: none !important;}`)},setGMResourceCSS(a){const e=typeof At=="function"?At(a.keyName):null;return typeof e=="string"&&e?Hn(e):ie.loadStyleLink(a.url)},async loadStyleLink(a){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=a,new Promise(t=>{ke.onReady(()=>{document.head.appendChild(e),t(e);});})},async loadScript(a){let e=document.createElement("script");return e.src=a,new Promise(t=>{e.onload=()=>{t(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(a){return a=a.trim(),a.startsWith("data:")||a.match(/^http(s|):\/\//i)?a:a.startsWith("//")?(a.startsWith("///")||(a=window.location.protocol+a),a):(a.startsWith("/")||(a+="/"),a=window.location.origin+a,a)},fixHttps(a){if(a.startsWith("https://")||!a.startsWith("http://"))return a;try{let e=new URL(a);return e.protocol="https:",e.toString()}catch{return a}},lockScroll(...a){let e=document.createElement("style");e.innerHTML=`
		...
		`;let t=[document.documentElement,document.body].concat(...a||[]);return t.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){t.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function a(n){navigator.clipboard.readText().then(r=>{n(r);}).catch(r=>{$e.error("读取剪贴板内容失败👉",r),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(r=>{a(n);}).catch(r=>{$e.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),a(n);});}function t(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!t()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(a,e,t=5e3){let n,r=t-e,o=e,i=async s=>{let l=await a(s);if(typeof l=="boolean"&&!l||s){re.workerClearTimeout(n);return}if(o+=e,o>r){i(true);return}n=re.workerSetTimeout(()=>{i(false);},e);};i(false);},findParentNode(a,e,t){if(t){let n=ke.closest(a,t);if(n)return n.querySelector(e)}else return ke.matches(a,e)?a:ke.closest(a,e)},toStr(a){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(a,(n,r)=>r===void 0?e:r,2).replace(new RegExp(`"${e}"`,"g"),"undefined")}},re=Ge.noConflict(),m=ke.noConflict(),Oe=Rt,$e=new re.Log(je,Ae.console||He.console),Qt=je?.script?.name||void 0,Zs=Rt.config.Utils.AnyTouch(),ei=false;$e.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});R.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(a){const e=a.setting.type;if(e==="loading")return  false;const t=a.setting.content;return e==="warning"?$e.warn(t):e==="error"?$e.error(t):$e.info(t),true},get position(){return Pe.getValue(ot.qmsg_config_position.key,ot.qmsg_config_position.defaultValue)},get maxNums(){return Pe.getValue(ot.qmsg_config_maxnums.key,ot.qmsg_config_maxnums.defaultValue)},get showReverse(){return Pe.getValue(ot.qmsg_config_showreverse.key,ot.qmsg_config_showreverse.defaultValue)},get zIndex(){let a=Ge.getMaxZIndex(),e=Rt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Ge.getMaxValue(a,e)+100}});Oe.GlobalConfig.setGlobalConfig({zIndex:()=>{const a=Ge.getMaxZIndex(void 0,void 0,t=>{if(t?.classList?.contains("qmsg-shadow-container")||t?.closest("qmsg")&&t.getRootNode()instanceof ShadowRoot)return  false}),e=Rt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Ge.getMaxValue(a,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ti=new re.GM_Menu({GM_getValue:qe,GM_setValue:De,GM_registerMenuCommand:Ct,GM_unregisterMenuCommand:jt}),ln=new re.Httpx({xmlHttpRequest:Gn,logDetails:ei});ln.interceptors.request.use(a=>a);ln.interceptors.response.use(void 0,a=>($e.error("拦截器-请求错误",a),a.type==="onabort"?R.warning("请求取消",{consoleLogContent:true}):a.type==="onerror"?R.error("请求异常",{consoleLogContent:true}):a.type==="ontimeout"?R.error("请求超时",{consoleLogContent:true}):R.error("其它错误",{consoleLogContent:true}),a));Ae.Object.defineProperty,Ae.Function.prototype.apply,Ae.Function.prototype.call,Ae.Element.prototype.appendChild,Ae.setTimeout;const Hn=m.addStyle.bind(m);ke.selector.bind(ke);ke.selectorAll.bind(ke);new re.GM_Cookie;const kt="GM_Panel",xr="data-init",Vn="data-key",Un="data-default-value",ni="data-init-more-value",ri="data-plugin-search-config",Le={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},Ne={setting:{get width(){return Le.width<550?"88vw":Le.width<700?"550px":"700px"},get height(){return Le.height<450?"70vh":Le.height<550?"450px":"550px"}},settingMiddle:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<450?"88vh":"450px"}},settingBig:{get width(){return Le.width<800?"92vw":"800px"},get height(){return Le.height<600?"80vh":"600px"}},info:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<250?"88vh":"250px"}}},gt={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new re.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(a){Array.isArray(a)||(a=[a]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,a);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(a=0){return this.$data.contentConfig.get(a)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let a=false,e;const t=(o,i)=>{typeof i!="string"&&(i=ie.toStr(i));const s=new Blob([i]),l=globalThis.URL.createObjectURL(s);m.createElement("a",{href:l,download:o}).click(),re.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const o=d=>{const f=Oe.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),h=f.$shadowRoot.querySelector(".btn-control[data-mode='local']"),b=f.$shadowRoot.querySelector(".btn-control[data-mode='network']"),y=f.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),w=async v=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof st=="function"?typeof lt=="function"?(st().forEach(x=>{lt(x);}),R.success("已清空脚本存储的配置")):R.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):R.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof ct=="function"?ct(v):Object.keys(v).forEach(x=>{const E=v[x];De(x,E);}),R.success("配置导入完毕");},S=v=>new Promise(async A=>{const C=re.toJSON(v);Object.keys(C).length===0?R.warning("解析为空配置，不导入"):await w(C),A(true);});m.on(h,"click",v=>{m.preventEvent(v),f.close();const A=m.createElement("input",{type:"file",accept:".json"});m.on(A,["propertychange","input"],C=>{if(!A.files?.length)return;const x=A.files[0],E=new FileReader;E.onload=()=>{S(E.result);},E.readAsText(x,"UTF-8");}),A.click();}),m.on(b,"click",v=>{m.preventEvent(v),f.close();const A=Oe.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(E,B){E.close();}},ok:{text:"导入",callback:async(E,B)=>{const z=E.text;if(re.isNull(z)){R.error("请填入完整的url");return}const F=R.loading("正在获取配置..."),X=await ln.get(z,{allowInterceptConfig:false});if(F.close(),!X.status){$e.error(X),R.error("获取配置失败",{consoleLogContent:true});return}await S(X.data.responseText)&&E.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:Ne.info.width,height:"auto"}),C=A.$shadowRoot.querySelector("input"),x=A.$shadowRoot.querySelector(".pops-prompt-btn-ok");m.on(C,["input","propertychange"],E=>{m.val(C)===""?m.attr(x,"disabled","true"):m.removeAttr(x,"disabled");}),m.onKeyboard(C,"keydown",(E,B,z)=>{E==="Enter"&&z.length===0&&m.val(C)!==""&&m.emit(x,"click");}),m.emit(C,"input");}),m.on(y,"click",async v=>{m.preventEvent(v),f.close();let A=await ie.getClipboardText();if(A.trim()===""){R.warning("获取到的剪贴板内容为空");return}await S(A);});},i=(d=`${Qt}_panel-setting-${re.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,f)=>{const h=Oe.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),b=h.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),y=h.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");m.on(b,"click",w=>{m.preventEvent(w);try{t(d,f),h.close();}catch(S){R.error(S.toString(),{consoleLogContent:true});}}),m.on(y,"click",async w=>{await re.copy(f)?(R.success("复制成功"),h.close()):R.error("复制失败");});},l=Oe.confirm({title:{text:"配置",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof st=="function")st().forEach(f=>{const h=qe(f);Reflect.set(c,f,h);});else {R.warning("不支持函数GM_listValues，仅导出菜单配置");const d=qe(kt);Reflect.set(c,kt,d);}const p=ie.toStr(c);l.value=p;},r=()=>{let o=je?.script?.supportURL||je?.script?.namespace;typeof o=="string"&&re.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${je?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(o){new Zs(o.$asideLiElement).on("tap",function(s){clearTimeout(e),e=void 0,a?(a=false,n()):(e=setTimeout(()=>{a=false,r();},200),a=true);});}}]},setDefaultBottomContentConfig(a){this.$data.__defaultBottomContentConfig=a;}},Jt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(a){return a},callback:()=>{Pe.showPanel(gt.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){Pe.isTopWindow()&&ti.add(this.$data.menuOption);},addMenuOption(a){Array.isArray(a)||(a=[a]),this.$data.menuOption.push(...a);},updateMenuOption(a){Array.isArray(a)||(a=[a]),a.forEach(e=>{let t=this.$data.menuOption.findIndex(n=>n.key===e.key);t!==-1&&(this.$data.menuOption[t]=e);});},getMenuOption(a=0){return this.$data.menuOption[a]},deleteMenuOption(a=0){this.$data.menuOption.splice(a,1);}};class oi{storageKey;listenerData;constructor(e){if(typeof e=="string"){const t=e.trim();if(t=="")throw new Error("key参数不能为空字符串");this.storageKey=t;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new Ge.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let e=qe(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){De(this.storageKey,e);}set(e,t){const n=this.get(e),r=this.getLocalValue();Reflect.set(r,e,t),this.setLocalValue(r),this.emitValueChangeListener(e,n,t);}get(e,t){const n=this.getLocalValue();return Reflect.get(n,e)??t}getAll(){return this.getLocalValue()}delete(e){const t=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.emitValueChangeListener(e,t,void 0);}has(e){const t=this.getLocalValue();return Reflect.has(t,e)}keys(){const e=this.getLocalValue();return Reflect.ownKeys(e)}values(){const e=this.getLocalValue();return Reflect.ownKeys(e).map(t=>Reflect.get(e,t))}clear(){lt(this.storageKey);}addValueChangeListener(e,t){const n=Math.random(),r=this.listenerData.get(e)||[];return r.push({id:n,key:e,callback:t}),this.listenerData.set(e,r),n}removeValueChangeListener(e){let t=false;for(const[n,r]of this.listenerData.entries()){for(let o=0;o<r.length;o++){const i=r[o];(typeof e=="string"&&i.key===e||typeof e=="number"&&i.id===e)&&(r.splice(o,1),o--,t=true);}this.listenerData.set(n,r);}return t}async emitValueChangeListener(...e){const[t,n,r]=e;if(!this.listenerData.has(t))return;let o=this.listenerData.get(t);for(let i=0;i<o.length;i++){const s=o[i];if(typeof s.callback=="function"){let l=this.get(t),c,p;typeof n<"u"&&e.length>=2?p=n:p=l,typeof r<"u"&&e.length>2?c=r:c=l,await s.callback(t,p,c);}}}}const Ve=new oi(kt),Pe={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new re.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new re.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new re.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new re.Dictionary),this.__onceExecData},get scriptName(){return Qt},get panelConfig(){return this.__panelConfig},set panelConfig(a){this.__panelConfig=a;},key:kt,attributeKeyName:Vn,attributeDefaultValueName:Un},init(){this.initContentDefaultValue(),Jt.init();},isTopWindow(){return Ae.top===Ae.self},initContentDefaultValue(){const a=n=>{if(!n.attributes||n.type==="button"||n.type==="container"||n.type==="deepMenu")return;const r=n.attributes;let o=r[xr];if(typeof o=="function"){let c=o();if(typeof c=="boolean"&&!c)return}let i=new Map,s=r[Vn];if(s!=null){const c=r[Un];i.set(s,c);}let l=r[ni];if(typeof l=="object"&&l&&Object.keys(l).forEach(c=>{const p=l[c];i.set(c,p);}),!i.size){$e.warn(["请先配置键",n]);return}if(n.type==="switch"){let c=typeof n.disabled=="function"?n.disabled():n.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...i.keys());}for(const[c,p]of i.entries())this.setDefaultValue(c,p);},e=n=>{for(let r=0;r<n.length;r++){let o=n[r];a(o);let i=o.views;i&&Array.isArray(i)&&e(i);}},t=[...gt.getAllContentConfig()];for(let n=0;n<t.length;n++){let r=t[n];if(!r.views)continue;const o=r.views;o&&Array.isArray(o)&&e(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(a,e){this.$data.contentConfigInitDefaultValue.has(a)&&$e.warn("请检查该key(已存在): "+a),this.$data.contentConfigInitDefaultValue.set(a,e);},getDefaultValue(a){return this.$data.contentConfigInitDefaultValue.get(a)},setValue(a,e){Ve.set(a,e);},getValue(a,e){const t=Ve.get(a);return t??(this.$data.contentConfigInitDefaultValue.has(a)?this.$data.contentConfigInitDefaultValue.get(a):e)},deleteValue(a){Ve.delete(a);},hasKey(a){return Ve.has(a)},addValueChangeListener(a,e){return Ve.addValueChangeListener(a,(n,r,o)=>{e(a,o,r);})},removeValueChangeListener(a){Ve.removeValueChangeListener(a);},emitMenuValueChange(a,e,t){Ve.emitValueChangeListener(a,t,e);},async exec(a,e,t,n=true){const r=this;let o;typeof a=="string"||Array.isArray(a)?o=()=>a:o=a;let i=false;const s=o();let l=[];Array.isArray(s)?(i=true,l=s):l.push(s);const c=l.find(x=>!this.$data.contentConfigInitDefaultValue.has(x));if(c){$e.warn(`${c} 键不存在`);return}const p=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(p))return this.$data.onceExecMenuData.get(p);let d=[];const f=[];let h=[];const b=(x,E)=>{let B=[],z=[],F=[];if(Array.isArray(E))F=F.concat(E);else {const X=K=>{if(typeof K=="object"&&K!=null)if(K instanceof Element)F.push(K);else {const{$css:$,destory:M}=K;$!=null&&(Array.isArray($)?F=F.concat($):F.push($)),typeof M=="function"&&F.push(M);}else F.push(K);};if(E!=null&&Array.isArray(E))for(const K of E)X(K);else X(E);}for(const X of F)if(X!=null){if(X instanceof Element){B.push(X);continue}if(typeof X=="function"){h.push(X);continue}}x?(d=d.concat(B),h=h.concat(z)):(w(),S());},y=x=>!!this.getValue(x),w=()=>{for(let x=0;x<d.length;x++)d[x]?.remove(),d.splice(x,1),x--;},S=()=>{for(let x=0;x<h.length;x++){const E=h[x];E(),h.splice(x,1),x--;}},v=()=>{let x=false;return typeof t=="function"?x=t(l):x=l.every(E=>y(E)),x},A=async x=>{if(v()){const B=l.map(F=>this.getValue(F)),z=await e({value:i?B:B[0],addStoreValue:(...F)=>b(true,F)});b(true,z);}else b(false,[]);};n&&l.forEach(x=>{const E=this.addValueChangeListener(x,(B,z,F)=>A());f.push(E);}),await A();const C={reload(){this.clearStoreStyleElements(),this.destory(),A();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>w(),destory(){return S()},removeValueChangeListener:()=>{f.forEach(x=>{this.removeValueChangeListener(x);});},clearOnceExecMenuData(){n&&r.$data.onceExecMenuData.delete(p);}};return this.$data.onceExecMenuData.set(p,C),C},async execMenu(a,e,t=false,n=false){return await this.exec(a,async r=>await e(r),r=>r.every(i=>{let s=!!this.getValue(i);return Pe.$data.contentConfigInitDisabledKeys.includes(i)&&(s=false,$e.warn(`.execMenu${n?"Once":""} ${i} 被禁用`)),t&&(s=!s),s}),n)},async execMenuOnce(a,e,t=false,n=false){const r=await this.execMenu(a,e,t,true);if(n&&r){const o=()=>{r.reload();};this.removeUrlChangeWithExecMenuOnceListener(a),this.addUrlChangeWithExecMenuOnceListener(a,o);}return r},deleteExecMenuOnce(a){return a=this.transformKey(a),this.$data.onceExecMenuData.delete(a),this.$data.urlChangeReloadMenuExecOnce.delete(a),Ve.removeValueChangeListener(a)},onceExec(a,e){if(a=this.transformKey(a),typeof a!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(a)||(e(),this.$data.onceExecData.set(a,1));},deleteOnceExec(a){a=this.transformKey(a),this.$data.onceExecData.delete(a);},addUrlChangeWithExecMenuOnceListener(a,e){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.set(a,e);},removeUrlChangeWithExecMenuOnceListener(a){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.delete(a);},hasUrlChangeWithExecMenuOnceListener(a){return a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.has(a)},async emitUrlChangeWithExecMenuOnceEvent(a){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const t of e)await t(a);},showPanel(a,e=`${Qt}-设置`,t=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let r=a.findIndex(i=>(typeof i.isBottom=="function"?i.isBottom():!!i.isBottom)&&i.id==="script-version")!==-1;!t&&!r&&a.push(...gt.getDefaultBottomContentConfig());let o=Oe.panel({title:{text:e,position:"center",html:false,style:""},content:a,btn:{close:{enable:true,callback:(i,s)=>{i.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(i,s)=>{i(),this.$data.$panel=null;}},width:Ne.setting.width,height:Ne.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=a,n||this.registerConfigSearch({$panel:o,content:a});},registerConfigSearch(a){const{$panel:e,content:t}=a,n=async(f,h)=>{if(f==null)return;const b=await h(f);return b&&typeof b.isFind=="boolean"&&b.isFind?b.data:await n(b.data,h)},r=(f,h)=>{const b=new IntersectionObserver(y=>{y.forEach(w=>{w.isIntersecting&&(h?.(),b.disconnect());});},{root:null,threshold:1});b.observe(f),f.scrollIntoView({behavior:"smooth",block:"center"});},o=f=>{const h="pops-flashing";m.onAnimationend(f,()=>{f.classList.remove(h);}),f.classList.add(h);},i=f=>{if(f.type==="dblclick"&&d)return;m.preventEvent(f),l=null;const h=Oe.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${a.searchDialogStyle??""}
				`});h.$shadowRoot.querySelector(".search-wrapper");const b=h.$shadowRoot.querySelector(".search-config-text"),y=h.$shadowRoot.querySelector(".search-result-wrapper");b.focus();const w=()=>{m.empty(y);},S=A=>{const C=re.queryProperty(A,B=>B?.next?{isFind:false,data:B.next}:{isFind:true,data:B}),x=m.createElement("div",{className:"search-result-item",innerHTML:`
				...
				`}));},transformKey(a){if(Array.isArray(a)){const e=a.sort();return JSON.stringify(e)}else return a}};let at="";document.documentElement?document.head?document.body?at=`<html>
    <head>
			...
			`;}),m.html(a,t);},setTag(a,e,t){te.clearTag(a),m.addClass(a,e),typeof t=="string"&&m.html(a,t);},clearTag(a){Object.keys(vr).forEach(e=>{m.removeClass(a,e);});}},Zt=function(a,e,t,n,r,o){const i={type:"own",attributes:n||{},props:r||{},createLIElement:a,afterAddToUListCallBack:o};return Reflect.set(i.attributes,xr,()=>false),i},L=a=>Zt(t=>{let n=m.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
				...
				`});return t.appendChild(n),t},void 0,void 0,void 0,void 0,async(t,n)=>{let r=n.target,o=r.querySelector(".pops-panel-item-left-text"),i=r.querySelector(".pops-panel-item-left-main-text"),s=r.querySelector(".pops-panel-item-left-desc-text"),l=await a();l.tag==null?m.html(i,l.text):m.html(i,vr[l.tag]+l.text),(l.description==null||l.description==="")&&m.hide(s,false),m.html(s,l.description||"");let c=["support-info"];if(l.tag!=null&&c.push(l.tag),m.addClass(i,c),typeof l.afterRender=="function")try{l.afterRender({...n,$leftContainer:o,$leftText:i,$leftDesc:s});}catch(p){console.log(p),te.setTag(i,"error","afterRender 函数执行错误"+p);}}),G={asideLastVisit:"aside-last-visit"},ai={getWindow(){return Te.unsafeWindow.isSupport()?Ae:window}};class si{}class Ot extends si{isSupportGM(){return typeof V=="object"&&V!=null}}class ce extends Ot{}const se={getApiDocUrl(a,e){return e=e??a,`<a href="https://www.tampermonkey.net/documentation.php?ext=gcal&version=#api:${a}" target="_blank">${e}</a>`}};class ii extends ce{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof V.addElement=="function"}}isSupport(){return typeof fn=="function"}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let i=Reflect.apply(fn,this,r);o(i);}),formList:n.views[1].views},{name:t.name,fn:V.addElement,formList:n.views[2].views}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push(L(async()=>{let i=null,s=null,l=ai.getWindow(),c=o+"_test_script_exec",p=`${c}_test_str`;try{return i=await r.fn("script",{id:c,textContent:`window["${p}"] = "bar";`}),s=document.querySelector("#"+c),i==null?{text:`${r.name} returns is null`,tag:"error"}:i instanceof HTMLElement?typeof l[p]!="string"?{text:`${r.name} script element is not work`,tag:"error"}:(Reflect.deleteProperty(l,p),{text:ie.escapeHtml("支持添加<script>元素且执行js"),tag:"success"}):{text:`${r.name} returns is not style element`,tag:"error"}}catch(d){return console.error(d),{text:"执行错误 "+d,tag:"error"}}finally{s&&s.remove();}}),L(async()=>{let i=null,s=null,l=o+"_test2";try{if(i=await r.fn(document.body,"div",{"data-src":"https://example.com/image.png",id:l}),i==null)return {text:r.name+" returns is null",tag:"error"};if(!(i instanceof HTMLElement))return {text:r.name+" returns is not style element",tag:"error"};if(s=document.querySelector("#"+l),!s)return {text:"不支持3个参数",tag:"error"};const c=s.attachShadow({mode:"closed"});return await r.fn(c,"style",{textContent:"div { color: black; };"}),c.querySelector("style")?i==null?{text:"传入3个参数但是返回为空",tag:"error"}:s.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(c){return console.error(c),{text:"执行错误 "+c,tag:"error"}}finally{s&&s.remove();}}));}),n}}class li extends ce{isSupport(){return typeof un=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof V.addStyle=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-GM_addStyle"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let i=Reflect.apply(un,this,r);o(i);}),formList:n.views[1].views},{name:t.name,fn:V.addStyle,formList:n.views[2].views}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push(L(async()=>{let i=null,s=null;try{return i=m.createElement("div",{id:o,innerText:o+" test"}),document.body.appendChild(i),s=await r.fn(`
						...
						`),s==null?{text:`${r.name} returns is null`,tag:"error"}:s instanceof HTMLStyleElement?window.getComputedStyle(i).backgroundColor!=="rgb(255, 0, 0)"?{text:`${r.name} test element background is not rgb(255, 0, 0)`,tag:"error"}:{text:ie.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}:{text:`${r.name} returns is not HTMLStyleElement`,tag:"error"}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}finally{i?.remove(),s?.remove();}}));}),n}}class ci extends ce{isSupport(){return typeof Ft=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof V.addValueChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const i=Ft(...r);o(i);}),formList:n.views[1].views},{name:t.name,fn:V.addValueChangeListener,formList:n.views[2].views}].forEach(r=>{let o=r.name;r.formList.push((()=>{let i=o+"_key_1";return L(()=>({text:"测试监听数据存储改变",description:"",tag:"info",afterRender(s){let l=m.toElement(`
									...
									`,!1,!1);m.on(p,"click",async d=>{try{m.preventEvent(d),await s.delete(l),R.success(s.name+" delete cookie success");}catch(f){R.error(f.toString(),{consoleLogContent:!0});}}),m.after(c.$leftContainer,p);}}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}finally{}}));});}return r}}class pi extends ce{isSupport(){return typeof lt=="function"}getApiName(){return "GM_deleteValue"}getAsyncApiOption(){return {name:"GM.deleteValue",isSupport:this.isSupportGM()&&typeof V.deleteValue=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.name?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const i=lt(...r);o(i);}),formList:n.views[1].views},{name:t.name,fn:V.deleteValue,formList:n.views[2].views}].forEach(r=>{let o=r.name;r.formList.push((()=>{let i=`Test ${o} null`,s=null;return L(()=>({text:"测试存储null值并删除",description:`"${i}": ${s}`,tag:"info",afterRender(l){let c=m.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);m.after(l.$leftContainer,c),m.on(c,"click",async p=>{m.preventEvent(p);try{De(i,s),await r.fn(i);let d=qe(i);typeof d=="object"&&d===null?R.error("该值未删除，读取的值："+d):R.success("成功删除该值");}catch(d){R.error(d.toString(),{consoleLogContent:true});}});}}))})());}),n}}class fi extends ce{isSupport(){return typeof hn=="function"}getApiName(){return "GM_deleteValues"}getAsyncApiOption(){return {name:"GM.deleteValues",isSupport:this.isSupportGM()&&typeof V.deleteValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const i=hn(...r);o(i);}),formList:n.views[1].views},{name:t.name,fn:V.deleteValues,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push((()=>{let o={GM_deleteValues_key_1:555,"GM.deleteValues_key_2":666};return L(()=>({text:"测试存储对象然后删除再读取",description:`${JSON.stringify(o)}`,tag:"info",afterRender(i){let s=m.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);m.after(i.$leftContainer,s),m.on(s,"click",async l=>{m.preventEvent(l);try{ct(o);let c=Object.keys(o),p=St(c);if(JSON.stringify(p)!==JSON.stringify(o)){R.error("写入失败，写入的数据和读取的数据不相同");return}await r.fn(c);let d=St(c);d==null?R.warning("删除情况未知，因为读取到的数据为null"):typeof d=="object"&&JSON.stringify(d)==="{}"?R.success("删除成功，读取的数据为{}"):(R.error("删除情况未知，因为读取到的数据类型不是object"),console.log(d));}catch(c){R.error(c.toString(),{consoleLogContent:true});}});}}))})());}),n}}class ui extends ce{isSupport(){return typeof jr=="function"}getApiName(){return "GM_download"}getAsyncApiOption(){return {name:"GM.download",isSupport:this.isSupportGM()&&typeof V.download=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]}]};return this.isSupport()&&n.views[1].views.push(L(()=>({text:ie.escapeHtml("TODO"),tag:"info",afterRender(r){r.target?.querySelector(".support-info");}}))),n}}class hi extends ce{isSupport(){return typeof At=="function"}getApiName(){return "GM_getResourceText"}getAsyncApiOption(){return {name:"GM.getResourceText",isSupport:this.isSupportGM()&&typeof V.getResourceText=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const i=At(...r);o(i);}),formList:n.views[1].views},{name:t.name,fn:V.getResourceText,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(async()=>{try{return typeof await r.fn("ViewerCSS")=="string"?{text:ie.escapeHtml("支持通过@resource引用资源字符串"),tag:"success"}:{text:ie.escapeHtml(r.name+" return is not string"),tag:"error"}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class bi extends ce{isSupport(){return typeof bn=="function"}getApiName(){return "GM_getResourceURL"}getAsyncApiOption(){return {name:"GM.getResourceUrl",isSupport:this.isSupportGM()&&typeof V.getResourceUrl=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let i=Reflect.apply(bn,this,r);o(i);}),formList:n.views[1].views},{name:t.name,fn:V.getResourceUrl,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(async()=>{try{let o=await r.fn("ViewerCSS");return typeof o!="string"?{text:ie.escapeHtml(`${r.name} return is not string`),tag:"error"}:(o=o.trim(),o.startsWith("data:text/css;base64")?o.startsWith("data:text/css;base64,LyohCiAqIFZpZXdlci5qcyB2MS4xMS43CiAqIGh0dHBzOi8vZmVuZ3")?{text:ie.escapeHtml("支持通过@resource引用资源并进行base64编码"),tag:"success"}:{text:ie.escapeHtml("支持通过@resource引用资源并进行base64编码，但是base64编码的实现方式不同"),tag:"warn"}:{text:ie.escapeHtml("支持通过@resource引用资源，但是未对资源进行base64编码"),tag:"warn"})}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class mi extends ce{isSupport(){return typeof mn=="function"}getApiName(){return "GM_getTab"}getAsyncApiOption(){return {name:"GM.getTab",isSupport:this.isSupportGM()&&typeof V.getTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(r){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async()=>new Promise(r=>{mn((...o)=>{r(...o);});}),formList:n.views[1].views},{name:t.name,fn:V.getTab,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(()=>({text:"测试获取当前Tab",description:"",tag:"info",afterRender(o){let i=m.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
							...
							"${o}-test-key-2": 2,
								...
								`,!1,!1),d,f=re.debounce(()=>{try{clearTimeout(d),m.html(c.$leftText,'<p class="success">测试成功，触发</p>'),s=!1,l=!1;}catch(h){R.error(h.toString(),{consoleLogContent:!0});}},800);m.on(p,"click",async h=>{try{m.preventEvent(h),clearTimeout(d);let b=10,y=b,w=()=>{let v="正在等待触发超时：5000ms";return y--,v};te.setTag(c.$leftText,"info",w()),d=Ee(()=>{te.setTag(c.$leftText,"error","测试超时，未触发ondone回调");},b*1e3);const S=await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",timeout:5e3,ondone(){f();}});}catch(b){R.error(b.toString(),{consoleLogContent:!0});}}),m.after(i,p);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),L(()=>{try{let o,i,s=!1,l=!1,c=!1,p="点击通知的内容测试onclick、ondone函数";return {text:p,description:"https://example.com/",tag:"info",afterRender(f){o=f.target,i=f.$leftContainer;let h=m.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),b,y,w=re.debounce(()=>{try{clearTimeout(b),clearInterval(y);let S="",v="success",A="",C="success";s?(S+="支持 onclick 函数",l?(S=S.trim(),S+="且支持提供 event 参数"):(S+="但是不支持提供 event 参数",v="warn")):(S+="不支持 onclick 函数",v="error"),c?A+="支持 ondone 函数":(A+="不支持 ondone 函数",C="error"),m.html(f.$leftText,`
												<p class="${v}">${S}</p>
												<p class="${C}">${A}</p>`),s=!1,c=!1,l=!1;}catch(S){R.error(S.toString(),{consoleLogContent:!0});}},800);m.on(h,"click",async S=>{try{m.preventEvent(S),clearTimeout(b),clearInterval(y);let v=10,A=v,C=()=>{let x=`正在等待触发回调，请在规定时间内点击弹窗的【关闭】按钮或者内容：${A}s`;return A--,x};m.text(f.$leftText,C()),m.text(f.$leftDesc,p),m.show(f.$leftDesc,!1),b=Ee(()=>{clearInterval(y),te.setTag(f.$leftText,"error","测试超时，未触发回调");},v*1e3),y=setInterval(()=>{m.text(f.$leftText,C());},1e3),await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",onclick:x=>{console.log(x),s=!0,x&&typeof x.preventDefault=="function"&&(l=!0,x.preventDefault()),w();},ondone(){c=!0,w();}});}catch(v){R.error(v.toString(),{consoleLogContent:!0});}}),m.after(i,h);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),L(()=>{try{let o,i,s=!1,l=!1,c=!1,p="123",d="456",f="notification_tag_"+Date.now(),h={title:"测试通知的内容更新（tag）",text:p,tag:f},b=`更新前：${p}，更新后：${d}`;return {text:h.title,description:b,tag:"info",afterRender(y){o=y.target,i=y.$leftContainer;let w=m.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);m.after(o.$leftContainer,i);let s,l;m.on(i,"click",async c=>{try{m.preventEvent(c),clearTimeout(s),clearInterval(l),m.text(o.$leftDesc,this.text),m.show(o.$leftDesc,!1);let p=10,d=()=>{let h=`已执行注册菜单，请在${p}s内点击菜单项`;return p--,h};te.setTag(o.$leftText,"info",d()),l=setInterval(()=>{te.setTag(o.$leftText,"info",d());},1e3),s=Ee(()=>{clearInterval(l),te.setTag(o.$leftText,"error","测试超时，未触发回调");},10*1e3);const f=await r.fn("Test Menu",h=>{try{clearInterval(l),clearTimeout(s),te.clearTag(o.$leftText);let b=[];b.push({tag:"success",text:"支持注册菜单"}),h?b.push({tag:"success",text:"支持点击回调且有event参数"}):b.push({tag:"warn",text:"支持点击回调但是没有event参数"}),typeof f=="number"||typeof f=="string"?b.push({tag:"success",text:"函数返回值是string|number"}):b.push({tag:"error",text:"函数返回值不是string|number："+typeof f}),m.html(o.$leftText,b.map(y=>`<p class="${y.tag}">${y.text}</p>`).join(`
`));}catch(b){R.error(b.toString(),{consoleLogContent:!0});}});}catch(p){R.error(p.toString(),{consoleLogContent:!0});}});}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),L(()=>{try{return {text:"注册并更新菜单 ==> Test Update Menu",description:"请自行验证是否成功更新菜单文字为：Test Update Menu Success!!!",tag:"info",afterRender(o){let i=m.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
...
`));}else te.setTag(s.$leftText,"error","返回值类型错误："+typeof p);m.text(s.$leftDesc,this.text),m.show(s.$leftDesc,!1),alert(JSON.stringify(p,null,4));}catch(p){R.error(p.toString(),{consoleLogContent:!0});}}),m.after(s.$leftContainer,l);}}}catch(s){return console.error(s),{text:"执行错误 "+s,tag:"error"}}finally{}}),L(()=>{try{return {text:ie.escapeHtml("测试监听静音状态改变"),tag:"info",description:"点击按钮进行测试",afterRender(s){let l=m.toElement(`
									...
									`,!1,!1),c=!0,p;m.on(l,"click",async d=>{try{m.preventEvent(d);let f=h=>{c=!1,R.error("移除监听器失败");};p=R.loading("处理监听器中..."),await i.addStateChangeListener(f),await i.removeStateChangeListener(f),p.setText("等待500ms，设置当前Tab静音"),await re.sleep(500),await i.setMute({isMuted:!0}),p.setText("等待500ms，设置当前Tab取消静音"),await re.sleep(500),await i.setMute({isMuted:!1}),p.close(),c&&R.success("移除监听器成功");}catch(f){p?.close(),R.error(f.toString(),{consoleLogContent:!0});}}),m.after(s.$leftContainer,l);}}}catch(s){return console.error(s),{text:"执行错误 "+s,tag:"error"}}finally{}}));}),r}}const Te={unsafeWindow:new _i,GM:new Oi,addElement:new ii,addStyle:new li,download:new ui,getResourceText:new hi,getResourceUrl:new bi,info:new xi,log:new Ai,notification:new Si,openInTab:new Ci,registerMenuCommand:new Ti,unregisterMenuCommand:new Ii,setClipboard:new Ei,getTab:new mi,saveTab:new $i,getTabs:new gi,setValue:new Mi,getValue:new yi,deleteValue:new pi,listValues:new vi,setValues:new Li,getValues:new wi,deleteValues:new fi,addValueChangeListener:new ci,removeValueChangeListener:new ki,xmlHttpRequest:new Ni,webRequest:new Ri,cookie:new di,audio:new Pi},ze={$storageKey:"gm-api-test-storage-config",set(a,e){let t=window.localStorage.getItem(ze.$storageKey)??"{}",n=re.toJSON(t);n[a]=e,window.localStorage.setItem(ze.$storageKey,JSON.stringify(n,(r,o)=>typeof o=="function"?o.tString():o));},get(a,e){let t=window.localStorage.getItem(ze.$storageKey)??"{}";return re.toJSON(t)[a]??e},delete(a){let e=window.localStorage.getItem(ze.$storageKey)??"{}",t=re.toJSON(e);Reflect.deleteProperty(t,a),window.localStorage.setItem(ze.$storageKey,JSON.stringify(t,(n,r)=>typeof r=="function"?r.tString():r));}},W={set(a,e){Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?De(a,e):ze.set(a,e);},get(a,e){return Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?qe(a,e):ze.get(a,e)},delete(a){Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?lt(a):ze.delete(a);}},Di=()=>{let a=[],e=[];Object.keys(Te).forEach(n=>{let r=Te[n],o=r.getApiName(),i=r.isSupport(),s=r.getAsyncApiOption();i?a.push({name:o,isSupport:i}):e.push({name:o,isSupport:i}),s&&(s.isSupport?a.push({name:s.name,isSupport:s.isSupport,leftTargetSelector:"#aside-"+o}):e.push({name:s.name,isSupport:s.isSupport,leftTargetSelector:"#aside-"+o}));});let t=n=>{let r=m.createElement("div",{className:"gm-api-features-item",innerHTML:`
			...
			`});return m.on(r,"click",o=>{m.preventEvent(o);let i=r.getRootNode(),s=re.isNotNull(n.leftTargetSelector)?n.leftTargetSelector:"#aside-"+n.name,l=i.querySelector(s);l&&(l.click(),l.scrollIntoView({behavior:"smooth"}));}),r};return {id:"component-common",title:"通用",scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)==="component-common"},clickCallback(n){W.set(G.asideLastVisit,"component-common");},views:[{type:"container",text:"@run-at document-start<br>注：注入速度等级越低，注入的速度越快<br>范围：0~4",views:[L(()=>({text:ie.escapeHtml(at),tag:"info"}))]},{type:"container",text:"特性",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontSize="1.2em",r.formHeaderDivElement.style.fontWeight="700";},views:[]},{type:"container",text:"不支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.color="rgb(216, 30, 6)",r.formHeaderDivElement.style.fontWeight="600",e.length===0&&r.formContainerListElement?.remove();},views:[Zt(n=>{const r=m.createElement("div",{className:"gm-api-features-not-support"}),o=document.createDocumentFragment();return e.forEach(i=>{o.append(t(i));}),r.appendChild(o),n.appendChild(r),n})]},{type:"container",text:"支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontWeight="600",a.length===0&&r.formContainerListElement?.remove();},views:[Zt(n=>{const r=m.createElement("div",{className:"gm-api-features-support"}),o=document.createDocumentFragment();return a.forEach(i=>{o.append(t(i));}),r.appendChild(o),n.appendChild(r),n})]}]}};class Bi extends Ot{getApiName(){return "window.onurlchange "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return W.get(G.asideLastVisit)===e},clickCallback(n){W.set(G.asideLastVisit,e);},views:[{type:"container",text:"功能测试",views:[L(()=>{try{return {text:ie.escapeHtml("测试window.onurlchange"),tag:"info",description:"点击按钮进行测试",afterRender(n){let r=m.toElement(`
										...
										`,!1,!1),o=()=>{setTimeout(()=>{He.focus();},3e3);};m.on(r,"click",i=>{m.preventEvent(i),window.removeEventListener("blur",o,{capture:!0}),window.addEventListener("blur",o,{capture:!0,once:!0});try{R.info("请切换至其它Tab页面，切换完毕3秒后会自动调用该函数");}catch(s){R.error(s.toString(),{consoleLogContent:!0});}}),m.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}finally{}})]}]}}}if(Pe.isTopWindow()){let a=()=>{Pe.showPanel(gt.getConfig(0),void 0,void 0,true);},e=Jt.getMenuOption(0);e.callback=()=>{a();},Jt.updateMenuOption(e);let t=[Di()];Object.keys(Te).forEach(n=>{let o=Te[n].getUIOption();o&&t.push(o);}),t.push(new Bi().getUIOption()),t.push(new Hi().getUIOption()),t.push(new Vi().getUIOption()),gt.addContentConfig(t),Pe.$data.panelConfig={style:`
		.success{
			color: green;
		}
		.error{

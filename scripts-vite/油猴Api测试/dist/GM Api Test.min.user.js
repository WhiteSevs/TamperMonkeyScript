...
${w.join(", ")}`);if(w.length===0)throw Error("No Webpack JSONP entrypoints could be detected");this.log(`Entrypoint has been detected at window.${w[0]} and set for injection`),this.entrypoint=w[0];}searchObject(w,A){for(const C in w){const T=w[C],E=A.toLowerCase();if(typeof T!="object"){if(C.toString().toLowerCase().includes(E))return  true;if(typeof T!="object"){if(T.toString().toLowerCase().includes(E))return  true}else if(this.searchObject(T,A))return  true}}return  false}findModule(w){const A=[],C=Object.keys(this.modules);if(C.length===0)throw new Error("There are no modules to search through!");return C.forEach(T=>{const E=this.modules[T.toString()];if(E!==void 0)try{if(typeof w=="string")switch(w=w.toLowerCase(),typeof E){case "string":E.toLowerCase().includes(w)&&A.push(E);break;case "function":E.toString().toLowerCase().includes(w)&&A.push(E);break;case "object":this.searchObject(E,w)&&A.push(E);break}else if(typeof w=="function")w(E)&&A.push(E);else throw new TypeError(`findModule can only find via string and function, ${typeof w} was passed`)}catch(k){this.log(`There was an error while searching through module '${T}':
${k}
${k.stack}`);}}),A}findConstructor(w){const A=[],C=Object.keys(this.constructors);if(C.length===0)throw new Error("There are no constructors to search through!");return C.forEach(T=>{const E=this.constructors[T];try{typeof w=="string"?(w=w.toLowerCase(),E.toString().toLowerCase().includes(w)&&A.push([this.constructors[T],this.modules[T]])):typeof w=="function"&&w(E)&&A.push([this.constructors[T],this.modules[T]]);}catch(k){this.log(`There was an error while searching through constructor '${T}':
${k}
${k.stack}`);}}),A}}class Utils{constructor(w){tt(this,"windowApi");tt(this,"version","2025.2.8");tt(this,"ajaxHooker",(w=false)=>w?AjaxHooker1_2_4():AjaxHooker());tt(this,"ColorConversion",ColorConversion);tt(this,"Dictionary",UtilsDictionary);tt(this,"GBKEncoder",GBKEncoder);tt(this,"GM_Cookie",UtilsGMCookie);tt(this,"GM_Menu",GMMenu);tt(this,"Hooks",Hooks);tt(this,"Httpx",Httpx);tt(this,"indexedDB",indexedDB);tt(this,"LockFunction",LockFunction);tt(this,"Log",Log);tt(this,"Progress",Progress);tt(this,"tryCatch",TryCatch);tt(this,"generateUUID",GenerateUUID);tt(this,"Vue",Vue);tt(this,"ModuleRaid",ModuleRaid);this.windowApi=new WindowApi(w);}addStyle(w){if(typeof w!="string")throw new Error("Utils.addStyle 参数cssText 必须为String类型");let A=this.windowApi.document.createElement("style");return A.setAttribute("type","text/css"),A.innerHTML=w,this.windowApi.document.head?this.windowApi.document.head.appendChild(A):this.windowApi.document.body?this.windowApi.document.body.appendChild(A):this.windowApi.document.documentElement.childNodes.length===0?this.windowApi.document.documentElement.appendChild(A):this.windowApi.document.documentElement.insertBefore(A,this.windowApi.document.documentElement.childNodes[0]),A}assign(w={},A={},C=false){let T=this;if(Array.isArray(A)&&!A.filter(k=>typeof k=="object").length)return A;if(A==null)return w;if(w==null&&(w={}),C)for(const E in A){let U=w[E],_=A[E];if(typeof _=="object"&&_!=null&&E in w&&!T.isDOM(_)){w[E]=T.assign(U,_,C);continue}w[E]=_;}else for(const E in w)if(E in A){let k=w[E],U=A[E];if(typeof U=="object"&&U!=null&&!T.isDOM(U)&&Object.keys(U).length){w[E]=T.assign(k,U,C);continue}w[E]=U;}return w}async asyncReplaceAll(w,A,C){let T=this;if(typeof w!="string")throw new TypeError("string必须是字符串");if(typeof C!="function")throw new TypeError("asyncFn必须是函数");let E;if(typeof A=="string")E=new RegExp(T.parseStringToRegExpString(A),"g");else if(A instanceof RegExp){if(!A.global)throw new TypeError("pattern必须是全局匹配");E=new RegExp(A);}else throw new TypeError("pattern必须是正则对象");let k=[],U,_=0;for(;(U=E.exec(w))!==null;){const L=C(U[0]),$=w.slice(_,U.index);_=U.index+U[0].length,k.push(L),k.push($);}return k.push(w.slice(_)),k=await Promise.all(k),k.join("")}canvasClickByPosition(w,A=0,C=0,T=globalThis){if(!(w instanceof HTMLCanvasElement))throw new Error("Utils.canvasClickByPosition 参数canvasElement必须是canvas元素");A=parseInt(A.toString()),C=parseInt(C.toString());const E={cancelBubble:true,cancelable:true,clientX:A,clientY:C,view:T,detail:1};w.dispatchEvent(new MouseEvent("mousedown",E)),w.dispatchEvent(new MouseEvent("mouseup",E));}checkUserClickInNode(w){var P;let A=this;if(!A.isDOM(w))throw new Error("Utils.checkUserClickInNode 参数 targetNode 必须为 Element|Node 类型");let C=A.windowApi.window.event,T=A.windowApi.window.event,E=(P=C==null?void 0:C.composedPath())==null?void 0:P[0],k=(C==null?void 0:C.clientX)!=null?C.clientX:T.touches[0].clientX,U=(C==null?void 0:C.clientY)!=null?C.clientY:T.touches[0].clientY,{left:_,right:L,top:$,bottom:I}=w.getBoundingClientRect();return k>=_&&k<=L&&U>=$&&U<=I?true:!!(E&&w.contains(E)||E==w)}cloneFormData(w,A){let C=new FormData;for(let[T,E]of w.entries()){let k=typeof A=="function"?A(T,E):false;typeof k=="boolean"&&k||C.append(T,E);}return C}createOverload(){let w=new Map;function A(...C){let T=C.map(k=>typeof k).join(","),E=w.get(T);if(!E)throw new TypeError("没有找到对应的实现");return E.apply(this,C)}return A.addImpl=function(...C){let T=C.pop();if(typeof T!="function")throw new TypeError("最后一个参数必须是函数");let E=C.join(",");w.set(E,T);},A}deepClone(w){let A=this;if(w===void 0)return;if(w===null)return null;let C=w instanceof Array?[]:{};for(const[T,E]of Object.entries(w))C[T]=typeof E=="object"?A.deepClone(E):E;return C}debounce(w,A=0){let C=null;const T=this;return function(...E){clearTimeout(C),C=setTimeout(function(){w.apply(T,E);},A);}}deleteParentNode(w,A){let C=this;if(w==null)return;if(!C.isDOM(w))throw new Error("Utils.deleteParentNode 参数 target 必须为 Node|HTMLElement 类型");if(typeof A!="string")throw new Error("Utils.deleteParentNode 参数 targetSelector 必须为 string 类型");let T=false,E=w.closest(A);return E&&(E.remove(),T=true),T}dispatchEvent(w,A,C){let T=[];typeof A=="string"&&(T=[A]),Array.isArray(A)&&(T=[...A]),T.forEach(E=>{let k=new Event(E);C&&Object.assign(k,C),w.dispatchEvent(k);});}downloadBase64(w,A,C=false){if(typeof w!="string")throw new Error("Utils.downloadBase64 参数 base64Data 必须为 string 类型");if(typeof A!="string")throw new Error("Utils.downloadBase64 参数 fileName 必须为 string 类型");if(C){const T=this.windowApi.document.createElement("iframe");T.style.display="none",T.src=w,this.windowApi.document.body.appendChild(T),setTimeout(()=>{T.contentWindow.document.execCommand("SaveAs",true,A),this.windowApi.document.body.removeChild(T);},100);}else {const T=this.windowApi.document.createElement("a");T.setAttribute("target","_blank"),T.download=A,T.href=w,T.click();}}findWebPageVisibleText(w="",A=false){let C=null,T;if(this.windowApi.globalThis.find){let E=this.windowApi.self.find;if(T=E(w,A,true,true,false),T&&this.windowApi.self.getSelection&&!this.windowApi.self.getSelection().anchorNode&&(T=E(w,A,true,true,false)),!T)for(T=E(w,0,1);E(w,0,1););}else if(navigator.appName.indexOf("Microsoft")!=-1)C!=null&&(C=C,C.collapse(false),T=C.findText(w),T&&C.select()),(C==null||T==0)&&(C=this.windowApi.self.document.body.createTextRange(),T=C.findText(w),T&&C.select());else if(navigator.appName=="Opera"){alert("Opera browsers not supported, sorry...");return}return !!T}*findElementsWithText(w,A,C){let T=this;if(w.outerHTML.includes(A))if(w.children.length===0)(typeof C=="function"?C(w):false)||(yield w);else {let E=Array.from(w.childNodes).filter(k=>k.nodeType===Node.TEXT_NODE);for(let k of E)k.textContent.includes(A)&&(typeof C=="function"&&C(w)||(yield k));}for(let E=0;E<w.children.length;E++){let k=w.children[E];yield*T.findElementsWithText(k,A,C);}}findVisibleElement(w){let A=w;for(;A;){if(A.getBoundingClientRect().length)return A;A=A.parentElement;}return null}formatByteToSize(w,A=true){if(w=parseInt(w.toString()),isNaN(w))throw new Error("Utils.formatByteToSize 参数 byteSize 格式不正确");let C=0,T="KB",E={};E.B=1,E.KB=1024,E.MB=E.KB*E.KB,E.GB=E.MB*E.KB,E.TB=E.GB*E.KB,E.PB=E.TB*E.KB,E.EB=E.PB*E.KB,E.ZB=E.EB*E.KB,E.YB=E.ZB*E.KB,E.BB=E.YB*E.KB,E.NB=E.BB*E.KB,E.DB=E.NB*E.KB;for(let k in E)if(C=w/E[k],T=k,E.KB>=C)break;return C=C.toFixed(2),C=A?C+T.toString():parseFloat(C.toString()),C}getNodeListValue(...w){let A=[];for(let C of w){let T=C;if(typeof C=="function"&&(T=C()),T.length!==0){A=[...T];break}}return A}getNonNullValue(...w){let A=w[w.length-1],C=this;for(const T of w)if(C.isNotNull(T)){A=T;break}return A}formatTime(w=new Date,A="yyyy-MM-dd HH:mm:ss"){let C=w==null?new Date:new Date(w);function T(U){return U<10?"0"+U:U}function E(U){return U>12?U-12:U}let k={yyyy:C.getFullYear(),MM:T(C.getMonth()+1),dd:T(C.getDate()),HH:T(C.getHours()),hh:T(E(C.getHours())),mm:T(C.getMinutes()),ss:T(C.getSeconds())};return Object.keys(k).forEach(function(U){let _=new RegExp(U,"g");A=A.replace(_,k[U]);}),A}formatToTimeStamp(w){if(typeof w!="string")throw new Error("Utils.formatToTimeStamp 参数 text 必须为 string 类型");if(w.length===8){let C=new Date;w=C.getFullYear()+"-"+(C.getMonth()+1)+"-"+C.getDate()+" "+w;}return w=w.substring(0,19),w=w.replace(/-/g,"/"),new Date(w).getTime()}getTransitionEndNameList(){return ["webkitTransitionEnd","mozTransitionEnd","MSTransitionEnd","otransitionend","transitionend"]}getAnimationEndNameList(){return ["webkitAnimationEnd","mozAnimationEnd","MSAnimationEnd","oanimationend","animationend"]}getArrayLastValue(w){return w[w.length-1]}getArrayRealValue(...w){let A=null;for(let C of w)if(typeof C=="function"&&(C=C()),C!=null){A=C;break}return A}getDaysDifference(w=Date.now(),A=Date.now(),C="天"){C=C.trim(),w.toString().length===10&&(w=w*1e3),A.toString().length===10&&(A=A*1e3);let T=w>A?A:w,E=w>A?w:A,k=1e3,U=60*k,_=60*U,L=24*_,$=30*L,I=12*$,P=new Date(E),H=new Date(T),z=1;C==="年"?z=I:C==="月"?z=$:C==="天"?z=L:C==="时"?z=_:C==="分"?z=U:C==="秒"&&(z=k);let D=Math.round(Math.abs((P-H)/z));if(C==="auto"){let G=E-T;if(D=Math.floor(G/(24*3600*1e3)),D>0)D=D+"天";else {let V=G%864e5,K=Math.floor(V/(3600*1e3));if(K>0)D=K+"小时";else {let Y=V%36e5,Z=Math.floor(Y/(60*1e3));if(Z>0)D=Z+"分钟";else {let ot=Y%6e4;D=Math.round(ot/1e3)+"秒";}}}}return D}getElementSelector(w){let A=this;if(!w||!w.parentElement)return;if(w.id)return "#"+w.id;let C=A.getElementSelector(w.parentElement);if(!C)return w.tagName.toLowerCase();if(w.parentElement.querySelectorAll(w.tagName).length>1){let T=Array.prototype.indexOf.call(w.parentElement.children,w)+1;C+=" > "+w.tagName.toLowerCase()+":nth-child("+T+")";}else C+=" > "+w.tagName.toLowerCase();return C}getMaxValue(...w){let A=[...w],C=[];if(A.length!==0)if(A.length>1){if(A.length===2&&typeof A[0]=="object"&&typeof A[1]=="function"){let T=A[0],E=A[1];Object.keys(T).forEach(k=>{C=[...C,E(k,T[k])];});}else A.forEach(T=>{isNaN(parseFloat(T))||(C=[...C,parseFloat(T)]);});return Math.max(...C)}else return A[0].forEach(T=>{isNaN(parseFloat(T))||(C=[...C,parseFloat(T)]);}),Math.max(...C)}getMaxZIndexNodeInfo(w=1,A=this.windowApi.document,C){w=Number.isNaN(w)?1:w;const T=this,E=2*Math.pow(10,9);let k=0,U=null;function _($){return $.position!=="static"&&$.display!=="none"}function L($){if(typeof C=="function"){let P=C($);if(typeof P=="boolean"&&!P)return}const I=T.windowApi.window.getComputedStyle($);if(_(I)){let P=parseInt(I.zIndex);isNaN(P)||P>k&&(k=P,U=$),$.shadowRoot!=null&&$ instanceof ShadowRoot&&$.shadowRoot.querySelectorAll("*").forEach(H=>{L(H);});}}return A.querySelectorAll("*").forEach(($,I)=>{L($);}),k+=w,k>=E&&(k=E),{node:U,zIndex:k}}getMaxZIndex(w=1,A=this.windowApi.document,C){return this.getMaxZIndexNodeInfo(w,A,C).zIndex}getMinValue(...w){let A=[...w],C=[];if(A.length!==0)if(A.length>1){if(A.length===2&&typeof A[0]=="object"&&typeof A[1]=="function"){let T=A[0],E=A[1];Object.keys(T).forEach(k=>{C=[...C,E(k,T[k])];});}else A.forEach(T=>{isNaN(parseFloat(T))||(C=[...C,parseFloat(T)]);});return Math.min(...C)}else return A[0].forEach(T=>{isNaN(parseFloat(T))||(C=[...C,parseFloat(T)]);}),Math.min(...C)}getRandomAndroidUA(){let w=this,A=["LDN-LX3","RNE-L03","ASUS_X00ID Build/NMF26F","WAS-LX3","PRA-LX3","MYA-L03","Moto G Play","Moto C Build/NRD90M.063","Redmi Note 4 Build/NRD90M","HUAWEI VNS-L21 Build/HUAWEIVNS-L21","VTR-L09","TRT-LX3","M2003J15SC Build/RP1A.200720.011; wv","MI 13 Build/OPR1.170623.027; wv"],C=w.getRandomValue(12,14),T=w.getRandomValue(A),E=w.getRandomValue(120,132),k=w.getRandomValue(0,0),U=w.getRandomValue(2272,6099),_=w.getRandomValue(1,218);return `Mozilla/5.0 (Linux; Android ${C}; ${T}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${E}.${k}.${U}.${_} Mobile Safari/537.36`}getRandomPCUA(){let w=this,A=w.getRandomValue(120,132),C=w.getRandomValue(0,0),T=w.getRandomValue(2272,6099),E=w.getRandomValue(1,218);return `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${A}.${C}.${T}.${E} Safari/537.36`}getRandomValue(...w){let A=[...w];if(A.length>1)if(A.length===2&&typeof A[0]=="number"&&typeof A[1]=="number"){let C=A[0]>A[1]?A[1]:A[0],T=A[0]>A[1]?A[0]:A[1];return Math.round(Math.random()*(T-C))+C}else return A[Math.floor(Math.random()*A.length)];else if(A.length===1){let C=A[0];if(Array.isArray(C))return C[Math.floor(Math.random()*C.length)];if(typeof C=="object"&&Object.keys(C).length>0){let T=Object.keys(C)[Math.floor(Math.random()*Object.keys(C).length)];return C[T]}else return C}}getReactObj(w){let A={};return Object.keys(w).forEach(C=>{if(C.startsWith("__react")){let T=C.replace(/__(.+)\$.+/i,"$1");T in A||(A[T]=w[C]);}}),A}getSymbol(w,A){if(typeof w!="object")throw new TypeError("target不是一个对象");let C=Object.getOwnPropertySymbols(w);if(typeof A=="string"){let T=C.find(E=>E.toString()===A);if(T)return w[T]}else if(typeof A=="symbol"){let T=C.find(E=>E===A);if(T)return w[T]}else {let T={};return C.forEach(E=>{T[E]=w[E];}),T}}getTextLength(w){return new TextEncoder().encode(w).length}getTextStorageSize(w,A=true){let C=this;return C.formatByteToSize(C.getTextLength(w),A)}getThunderUrl(w){if(w==null)throw new TypeError("url不能为空");if(typeof w!="string")throw new TypeError("url必须是string类型");if(w.trim()==="")throw new TypeError("url不能为空字符串或纯空格");return `thunder://${this.windowApi.globalThis.btoa("AA"+w+"ZZ")}`}isNativeFunc(w){return !!w.toString().match(/^function .*\(\) { \[native code\] }$/)}isNearBottom(...w){let A=50,C=()=>{let k=this.windowApi.window.pageYOffset||this.windowApi.document.documentElement.scrollTop,U=this.windowApi.window.innerHeight||this.windowApi.document.documentElement.clientHeight,_=this.windowApi.document.documentElement.scrollHeight-A;return k+U>=_},T=k=>{let U=k.scrollTop,_=k.clientHeight,L=k.scrollHeight-_-A;return U>=L},E=w[0];if(w.length===0||typeof w[0]=="number")return C();if(typeof w[0]=="object"&&w[0]instanceof HTMLElement)return typeof w[1]=="number"&&!Number.isNaN(w[1])&&(A=w[1]),T(w[0]);throw new TypeError("参数1类型错误"+typeof E)}isDOM(w){return w instanceof Node}isFullscreenEnabled(){return !!(this.windowApi.document.fullscreenEnabled||this.windowApi.document.webkitFullScreenEnabled||this.windowApi.document.mozFullScreenEnabled||this.windowApi.document.msFullScreenEnabled)}isJQuery(w){let A=false;if(typeof jQuery=="object"&&w instanceof jQuery&&(A=true),w==null)return  false;if(typeof w=="object"){let C=["add","addBack","addClass","after","ajaxComplete","ajaxError","ajaxSend","ajaxStart","ajaxStop","ajaxSuccess","animate","append","appendTo","attr","before","bind","blur","change","children","clearQueue","click","clone","closest","constructor","contents","contextmenu","css","data","dblclick","delay","delegate","dequeue","each","empty","end","eq","extend","fadeIn","fadeOut","fadeTo","fadeToggle","filter","find","first","focus","focusin","focusout","get","has","hasClass","height","hide","hover","html","index","init","innerHeight","innerWidth","insertAfter","insertBefore","is","jquery","keydown","keypress","keyup","last","load","map","mousedown","mouseenter","mouseleave","mousemove","mouseout","mouseover","mouseup","next","nextAll","not","off","offset","offsetParent","on","one","outerHeight","outerWidth","parent","parents","position","prepend","prependTo","prev","prevAll","prevUntil","promise","prop","pushStack","queue","ready","remove","removeAttr","removeClass","removeData","removeProp","replaceAll","replaceWith","resize","scroll","scrollLeft","scrollTop","select","show","siblings","slice","slideDown","slideToggle","slideUp","sort","splice","text","toArray","toggle","toggleClass","trigger","triggerHandler","unbind","width","wrap"];for(const T of C)if(T in w)A=true;else {A=false;break}}return A}isPhone(w=navigator.userAgent){return !!/(iPhone|iPad|iPod|iOS|Android|Mobile)/i.test(w)}isSameChars(w,A=1){if(typeof w!="string")throw new TypeError("参数 str 必须是 string 类型");if(w.length<2)return  false;w=w.toLowerCase();const C={};let T=0;for(const k of w)Reflect.has(C,k)?C[k]++:C[k]=1,T++;let E=false;for(const k in C)if(C[k]/T>=A){E=true;break}return E}isNotNull(...w){return !this.isNull.apply(this,w)}isNull(...w){let A=true,C=[...w];for(const T of C){let E=false;if(T==null)E=true;else switch(typeof T){case "object":typeof T[Symbol.iterator]=="function"?E=T.length===0:E=Object.keys(T).length===0;break;case "number":E=T===0;break;case "string":E=T.trim()===""||T==="null"||T==="undefined";break;case "boolean":E=!T;break;case "function":E=!!T.toString().replace(/\s/g,"").match(/^\(.*?\)=>\{\}$|^function.*?\(.*?\)\{\}$/);break}A=A&&E;}return A}isThemeDark(){return this.windowApi.globalThis.matchMedia("(prefers-color-scheme: dark)").matches}isVisible(w,A=false){let C=[];w instanceof Array||w instanceof NodeList?(w=w,C=[...w]):C=[w];let T=true;for(const E of C){if(this.windowApi.window.getComputedStyle(E).display==="none")T=false;else {let U=E.getBoundingClientRect();if(A){let _=this.windowApi.window.innerWidth||this.windowApi.document.documentElement.clientWidth,L=this.windowApi.window.innerHeight||this.windowApi.document.documentElement.clientHeight;T=!(U.right<0||U.left>_||U.bottom<0||U.top>L);}else T=!!E.getClientRects().length;}if(!T)break}return T}isWebView_Via(){let w=true,A=this;if(typeof this.windowApi.top.window.via=="object"){for(const C in Object.values(this.windowApi.top.window.via))if(Reflect.has(this.windowApi.top.window.via,C)){let T=this.windowApi.top.window.via[C];if(typeof T=="function"&&A.isNativeFunc(T))w=true;else {w=false;break}}}else w=false;return w}isWebView_X(){let w=true,A=this;if(typeof this.windowApi.top.window.mbrowser=="object"){for(const C in Object.values(this.windowApi.top.window.mbrowser))if(Reflect.has(this.windowApi.top.window.mbrowser,C)){let T=this.windowApi.top.window.mbrowser[C];if(typeof T=="function"&&A.isNativeFunc(T))w=true;else {w=false;break}}}else w=false;return w}parseObjectToArray(w){if(typeof w!="object")throw new Error("Utils.parseObjectToArray 参数 target 必须为 object 类型");let A=[];return Object.keys(w).forEach(function(C){A=A.concat(w[C]);}),A}mergeArrayToString(w,A){if(!(w instanceof Array))throw new Error("Utils.mergeArrayToString 参数 data 必须为 Array 类型");let C="";return typeof A=="function"?w.forEach(T=>{C+=A(T);}):typeof A=="string"?w.forEach(T=>{C+=T[A];}):w.forEach(T=>{Object.values(T).filter(E=>typeof E=="string").forEach(E=>{C+=E;});}),C}mutationObserver(w,A){let C=this,T={callback:()=>{},config:{subtree:void 0,childList:void 0,attributes:void 0,attributeFilter:void 0,attributeOldValue:void 0,characterData:void 0,characterDataOldValue:void 0},immediate:false};A=C.assign(T,A);let E=this.windowApi.window.MutationObserver||this.windowApi.window.webkitMutationObserver||this.windowApi.window.MozMutationObserver,k=new E(function(U,_){typeof A.callback=="function"&&A.callback(U,_);});return Array.isArray(w)||w instanceof NodeList?w.forEach(U=>{k.observe(U,A.config);}):C.isJQuery(w)?w.each((U,_)=>{k.observe(_,A.config);}):k.observe(w,A.config),A.immediate&&typeof A.callback=="function"&&A.callback([],k),k}mutationVisible(w,A,C){if(typeof IntersectionObserver>"u")throw new TypeError("IntersectionObserver is not defined");if(w==null)throw new TypeError("mutatuinVisible target is null");let T={root:null,rootMargin:"0px 0px 0px 0px",threshold:[.01,.99]};T=this.assign(T,C||{});let E=new IntersectionObserver((k,U)=>{k[0].isIntersecting&&typeof A=="function"&&A(k,U);},T);Array.isArray(w)?w.forEach(k=>{E.observe(k);}):E.observe(w);}noConflict(){return this.windowApi.window.Utils&&Reflect.deleteProperty(this.windowApi.window,"Utils"),this.windowApi.window.Utils=utils$1,utils$1}noConflictFunc(w,A,C=[],T=true){let E=this;if(typeof w!="object")throw new Error("Utils.noConflictFunc 参数 needReleaseObject 必须为 object 类型");if(typeof A!="string")throw new Error("Utils.noConflictFunc 参数 needReleaseName 必须为 string 类型");if(!Array.isArray(C))throw new Error("Utils.noConflictFunc 参数 functionNameList 必须为 Array 类型");let k="__"+A;function U(){typeof E.windowApi.window[k]<"u"||(E.windowApi.window[k]=E.deepClone(w),Object.values(w).forEach(I=>{typeof I=="function"&&(w[I.name]=()=>{});}));}function _(){Array.from(C).forEach(I=>{Object.values(w).forEach(P=>{typeof P=="function"&&(typeof E.windowApi.window[k]>"u"&&(E.windowApi.window[k]={}),I===P.name&&(E.windowApi.window[k][P.name]=w[P.name],w[P.name]=()=>{}));});});}function L(){typeof E.windowApi.window[k]>"u"||(Object.assign(w,E.windowApi.window[k]),Reflect.deleteProperty(E.windowApi.window,"needReleaseKey"));}function $(){typeof E.windowApi.window[k]>"u"||Array.from(C).forEach(I=>{E.windowApi.window[k][I]&&(w[I]=E.windowApi.window[k][I],Reflect.deleteProperty(E.windowApi.window[k],I),Object.keys(E.windowApi.window[k]).length===0&&Reflect.deleteProperty(window,k));});}T?C.length===0?U():_():C.length===0?L():$();}parseBase64ToBlob(w){if(typeof w!="string")throw new Error("Utils.parseBase64ToBlob 参数 dataUri 必须为 string 类型");let A=w.split(","),C=A[0].match(/:(.*?);/)[1],T=atob(A[1]),E=T.length,k=new Uint8Array(E);for(;E--;)k[E]=T.charCodeAt(E);return new Blob([k],{type:C})}parseBase64ToFile(w,A="example"){if(typeof w!="string")throw new Error("Utils.parseBase64ToFile 参数 dataUri 必须为 string 类型");if(typeof A!="string")throw new Error("Utils.parseBase64ToFile 参数 fileName 必须为 string 类型");let C=w.split(","),T=C[0].match(/:(.*?);/)[1],E=atob(C[1]),k=E.length,U=new Uint8Array(k);for(;k--;)U[k]=E.charCodeAt(k);return new File([U],A,{type:T})}parseInt(w=[],A=0){if(w==null)return parseInt(A.toString());let C=parseInt(w[w.length-1]);return isNaN(C)&&(C=parseInt(A.toString())),C}async parseBlobToFile(w,A="example"){return new Promise((C,T)=>{fetch(w).then(E=>E.blob()).then(E=>{const k=new File([E],A,{type:E.type});C(k);}).catch(E=>{console.error("Error:",E),T(E);});})}parseCDATA(w=""){let A="",T=/<\!\[CDATA\[([\s\S]*)\]\]>/.exec(w.trim());return T&&T.length>1&&(A=T[T.length-1]),A}async parseFileToBase64(w){let A=new FileReader;return A.readAsDataURL(w),new Promise(C=>{A.onload=function(T){C(T.target.result);};})}parseFromString(w,A="text/html"){return new DOMParser().parseFromString(w,A)}parseStringToRegExpString(w){if(typeof w!="string")throw new TypeError("string必须是字符串");return w.replace(/[.*+\-?^${}()|[\]\\]/g,"\\$&")}preventEvent(w,A=[],C){function T(E){return E==null||E.preventDefault(),E==null||E.stopPropagation(),E==null||E.stopImmediatePropagation(),false}if(arguments.length===1)return T(arguments[0]);typeof A=="string"&&(A=[A]),A.forEach(E=>{w.addEventListener(E,T,{capture:!!C});});}registerTrustClickEvent(w=true,A){function C(E){return new Proxy(E,{get:function(k,U){return U==="isTrusted"?w:Reflect.get(k,U)}})}A==null&&(A=function(E){return E==="click"});const T=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(...E){let k=E[0],U=E[1];if(E[2],A(k)){if(typeof U=="function")E[1]=function(_){U.call(this,C(_));};else if(typeof U=="object"&&"handleEvent"in U){let _=U.handleEvent;E[1].handleEvent=function(L){if(L!=null)try{L instanceof Proxy,_.call(this,C(L));}catch{L.isTrusted=w;}};}}return T.apply(this,E)};}reverseNumber(w){let A=0,C=false;for(w<0&&(C=true,w=Math.abs(w));w>0;)A=A*10+w%10,w=Math.floor(w/10);return C?-A:A}selectElementText(w,A,C,T){let E=this.windowApi.document.createRange();if(E.selectNodeContents(w),A){if(A.nodeType!==Node.TEXT_NODE)throw new TypeError("childTextNode必须是#text元素");C!=null&&T!=null&&(E.setStart(A,C),E.setEnd(A,T));}let k=this.windowApi.globalThis.getSelection();k&&(k.removeAllRanges(),k.addRange(E));}setClip(w,A={type:"text",mimetype:"text/plain"}){var k,U,_;typeof w=="object"?w instanceof Element?w=w.outerHTML:w=JSON.stringify(w):typeof w!="string"&&(w=w.toString());let C=typeof A=="object"?A.type:A;C.includes("html")?C="text/html":C="text/plain";let T=this;class E{constructor($,I,P){yt(this,k);yt(this,U);yt(this,_);gt(this,k,$),gt(this,U,I),gt(this,_,P);}async init(){let $=false;if(await this.requestClipboardPermission(),this.hasClipboard()&&(this.hasClipboardWrite()||this.hasClipboardWriteText()))try{$=await this.copyDataByClipboard();}catch(I){console.error("复制失败，使用第二种方式，error👉",I),$=this.copyTextByTextArea();}else $=this.copyTextByTextArea();R(this,k).call(this,$),this.destroy();}destroy(){gt(this,k,null),gt(this,U,null),gt(this,_,null);}isText(){return R(this,_).includes("text")}hasClipboard(){return (navigator==null?void 0:navigator.clipboard)!=null}hasClipboardWrite(){var $;return (($=navigator==null?void 0:navigator.clipboard)==null?void 0:$.write)!=null}hasClipboardWriteText(){var $;return (($=navigator==null?void 0:navigator.clipboard)==null?void 0:$.writeText)!=null}copyTextByTextArea(){try{let $=T.windowApi.document.createElement("textarea");return $.value=R(this,U),$.setAttribute("type","text"),$.setAttribute("style","opacity:0;position:absolute;"),$.setAttribute("readonly","readonly"),T.windowApi.document.body.appendChild($),$.select(),T.windowApi.document.execCommand("copy"),T.windowApi.document.body.removeChild($),!0}catch($){return console.error("复制失败，error👉",$),false}}requestClipboardPermission(){return new Promise(($,I)=>{navigator.permissions&&navigator.permissions.query?navigator.permissions.query({name:"clipboard-write"}).then(P=>{$(true);}).catch(P=>{console.error(["申请剪贴板权限失败，尝试直接写入👉",P.message??P.name??P.stack]),$(false);}):$(false);})}copyDataByClipboard(){return new Promise(($,I)=>{if(this.isText())navigator.clipboard.writeText(R(this,U)).then(()=>{$(true);}).catch(P=>{I(P);});else {let P=new Blob([R(this,U)],{type:R(this,_)});navigator.clipboard.write([new ClipboardItem({[R(this,_)]:P})]).then(()=>{$(true);}).catch(H=>{I(H);});}})}}return k=new WeakMap,U=new WeakMap,_=new WeakMap,new Promise(L=>{const $=new E(L,w,C);T.windowApi.document.hasFocus()?$.init():T.windowApi.window.addEventListener("focus",()=>{$.init();},{once:true});})}setTimeout(w,A=0){let C=this;if(typeof w!="function"&&typeof w!="string")throw new TypeError("Utils.setTimeout 参数 callback 必须为 function|string 类型");if(typeof A!="number")throw new TypeError("Utils.setTimeout 参数 delayTime 必须为 number 类型");return new Promise(T=>{setTimeout(()=>{T(C.tryCatch().run(w));},A);})}sleep(w=0){if(typeof w!="number")throw new Error("Utils.sleep 参数 delayTime 必须为 number 类型");return new Promise(A=>{setTimeout(()=>{A(void 0);},w);})}dragSlider(w,A=this.windowApi.window.innerWidth){let C=this;function T(I,P,H){let z=typeof unsafeWindow>"u"?globalThis:unsafeWindow,D=C.windowApi.document.createEvent("MouseEvents");return D.initMouseEvent(I,true,true,z,0,P,H,P,H,false,false,false,false,0,null),D}let E=typeof w=="string"?this.windowApi.document.querySelector(w):w;if(!(E instanceof Node)||!(E instanceof Element))throw new Error("Utils.dragSlider 参数selector 必须为Node/Element类型");let k=E.getBoundingClientRect(),U=k.x||k.left,_=k.y||k.top,L=U+A,$=_;E.dispatchEvent(T("mousedown",U,_)),E.dispatchEvent(T("mousemove",L,$)),E.dispatchEvent(T("mouseleave",L,$)),E.dispatchEvent(T("mouseout",L,$));}enterFullScreen(w=this.windowApi.document.documentElement,A){try{if(w.requestFullscreen)w.requestFullscreen(A);else if(w.webkitRequestFullScreen)w.webkitRequestFullScreen();else if(w.mozRequestFullScreen)w.mozRequestFullScreen();else if(w.msRequestFullscreen)w.msRequestFullscreen();else throw new TypeError("该浏览器不支持全屏API")}catch(C){console.error(C);}}exitFullScreen(w=this.windowApi.document.documentElement){return this.windowApi.document.exitFullscreen?this.windowApi.document.exitFullscreen():this.windowApi.document.msExitFullscreen?this.windowApi.document.msExitFullscreen():this.windowApi.document.mozCancelFullScreen?this.windowApi.document.mozCancelFullScreen():this.windowApi.document.webkitCancelFullScreen?this.windowApi.document.webkitCancelFullScreen():new Promise((A,C)=>{C(new TypeError("该浏览器不支持全屏API"));})}sortListByProperty(w,A,C=true){let T=this;if(typeof A!="function"&&typeof A!="string")throw new Error("Utils.sortListByProperty 参数 getPropertyValueFunc 必须为 function|string 类型");if(typeof C!="boolean")throw new Error("Utils.sortListByProperty 参数 sortByDesc 必须为 boolean 类型");let E=function($){return typeof A=="string"?$[A]:A($)},k=function($,I){let P=E(I),H=E($);return C?H>P?-1:H<P?1:0:H<P?-1:H>P?1:0},U=function($,I){let P=$.length;for(let H=0;H<P-1;H++)for(let z=0;z<P-1-H;z++){let D=$[z],G=$[z+1],V=E(D),K=E(G);if(C==true&&V<K||C==false&&V>K){let Y=D.nextElementSibling;G.after(D),Y==null?Y.parentNode.appendChild(G):Y.before(G),$=I();}}},_=w,L=null;if(w instanceof Function&&(L=w,w=w()),Array.isArray(w))w.sort(k);else if(w instanceof NodeList||T.isJQuery(w))U(w,L),_=L();else throw new Error("Utils.sortListByProperty 参数 data 必须为 Array|NodeList|jQuery 类型");return _}stringToRegular(w,A="ig"){let C;if(A=A.toLowerCase(),typeof w=="string")C=new RegExp(w.replace(/[.*+\-?^${}()|[\]\\]/g,"\\$&"),A);else if(w instanceof RegExp)C=w;else throw new Error("Utils.stringToRegular 参数targetString必须是string|Regexp类型");return C}stringTitleToUpperCase(w,A=false){let C=w.slice(0,1).toUpperCase();return A?C=C+w.slice(1).toLowerCase():C=C+w.slice(1),C}startsWith(w,A,C=0){let T=this;if(C>w.length)return  false;C!==0&&(w=w.slice(C,w.length));let E=A;if(typeof A=="string")E=new RegExp(`^${A}`);else if(Array.isArray(A)){let k=false;for(const U of A)if(!T.startsWith(w,U,C)){k=true;break}return k}return !!w.match(E)}stringTitleToLowerCase(w,A=false){let C=w.slice(0,1).toLowerCase();return A?C=C+w.slice(1).toUpperCase():C=C+w.slice(1),C}toJSON(w,A){let C=this,T={};return typeof w=="object"?w:(C.tryCatch().config({log:false}).error(E=>{C.tryCatch().error(()=>{try{T=C.windowApi.window.eval("("+w+")");}catch(k){typeof A=="function"&&A(k);}}).run(()=>{w&&/^[\],:{}\s]*$/.test(w.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,""))?T=new Function("return "+w)():typeof A=="function"&&A(new Error("target is not a JSON"));});}).run(()=>{w=w.trim(),T=JSON.parse(w);}),T)}toSearchParamsStr(w,A){let C=this,T="";return Array.isArray(w)?w.forEach(E=>{T===""?T+=C.toSearchParamsStr(E):T+="&"+C.toSearchParamsStr(E);}):T=new URLSearchParams(Object.entries(w)).toString(),A&&!T.startsWith("?")&&(T="?"+T),T}searchParamStrToObj(w){return typeof w!="string"?{}:Object.fromEntries(new URLSearchParams(w))}uniqueArray(w=[],A,C=(T,E)=>T===E){if(typeof A=="function"){const T=A,E=new Set,k=[];for(const U of w){const _=T(U);E.has(_)||(E.add(_),k.push(U));}return k}else return Array.from(w).filter(T=>!Array.from(A).some(function(E){return C(T,E)}))}waitArrayLoopToEnd(w,A){let C=this;if(typeof A!="function"&&typeof A!="string")throw new Error("Utils.waitArrayLoopToEnd 参数 handleDataFunction 必须为 function|string 类型");return Promise.all(Array.from(w).map(async(T,E)=>{await C.tryCatch(E,T).run(A);}))}wait(w,A,C){const T=this;let E=typeof A=="number"?A:0;return new Promise(k=>{let U=T.mutationObserver(C||T.windowApi.document,{config:{subtree:true,childList:true,attributes:true},immediate:true,callback(_,L){let $=w();$.success&&(typeof(L==null?void 0:L.disconnect)=="function"&&L.disconnect(),k($.data));}});E>0&&setTimeout(()=>{typeof(U==null?void 0:U.disconnect)=="function"&&U.disconnect(),k(null);},E);})}waitNode(...w){w=w.filter(U=>U!==void 0);let A=this,C=w[0],T=A.windowApi.document,E=0;if(typeof w[0]!="string"&&!Array.isArray(w[0])&&typeof w[0]!="function")throw new TypeError("Utils.waitNode 第一个参数必须是string|string[]|Function");if(w.length!==1)if(w.length===2){let U=w[1];if(typeof U=="number")E=U;else if(typeof U=="object"&&U instanceof Node)T=U;else throw new TypeError("Utils.waitNode 第二个参数必须是number|Node")}else if(w.length===3){let U=w[1],_=w[2];if(typeof U=="object"&&U instanceof Node)if(T=U,typeof _=="number")E=_;else throw new TypeError("Utils.waitNode 第三个参数必须是number");else throw new TypeError("Utils.waitNode 第二个参数必须是Node")}else throw new TypeError("Utils.waitNode 参数个数错误");function k(){if(Array.isArray(C)){let U=[];for(let _=0;_<C.length;_++){let L=T.querySelector(C[_]);L&&U.push(L);}if(U.length===C.length)return U}else return typeof C=="function"?C():T.querySelector(C)}return A.wait(()=>{let U=k();return U?{success:true,data:U}:{success:false,data:U}},E,T)}waitAnyNode(...w){w=w.filter(U=>U!==void 0);let A=this,C=w[0],T=A.windowApi.document,E=0;if(typeof w[0]!="object"&&!Array.isArray(w[0]))throw new TypeError("Utils.waitAnyNode 第一个参数必须是string[]");if(w.length!==1)if(w.length===2){let U=w[1];if(typeof U=="number")E=U;else if(typeof U=="object"&&U instanceof Node)T=U;else throw new TypeError("Utils.waitAnyNode 第二个参数必须是number|Node")}else if(w.length===3){let U=w[1],_=w[2];if(typeof U=="object"&&U instanceof Node)if(T=U,typeof _=="number")E=_;else throw new TypeError("Utils.waitAnyNode 第三个参数必须是number");else throw new TypeError("Utils.waitAnyNode 第二个参数必须是Node")}else throw new TypeError("Utils.waitAnyNode 参数个数错误");let k=C.map(U=>A.waitNode(U,T,E));return Promise.any(k)}waitNodeList(...w){w=w.filter(U=>U!==void 0);let A=this,C=w[0],T=A.windowApi.document,E=0;if(typeof w[0]!="string"&&!Array.isArray(w[0]))throw new TypeError("Utils.waitNodeList 第一个参数必须是string|string[]");if(w.length!==1)if(w.length===2){let U=w[1];if(typeof U=="number")E=U;else if(typeof U=="object"&&U instanceof Node)T=U;else throw new TypeError("Utils.waitNodeList 第二个参数必须是number|Node")}else if(w.length===3){let U=w[1],_=w[2];if(typeof U=="object"&&U instanceof Node)if(T=U,typeof _=="number")E=_;else throw new TypeError("Utils.waitNodeList 第三个参数必须是number");else throw new TypeError("Utils.waitNodeList 第二个参数必须是Node")}else throw new TypeError("Utils.waitNodeList 参数个数错误");function k(){if(Array.isArray(C)){let U=[];for(let _=0;_<C.length;_++){let L=T.querySelectorAll(C[_]);L.length&&U.push(L);}if(U.length===C.length)return U}else {let U=T.querySelectorAll(C);if(U.length)return U}}return A.wait(()=>{let U=k();return U?{success:true,data:U}:{success:false,data:U}},E,T)}waitAnyNodeList(...w){w=w.filter(U=>U!==void 0);let A=this,C=w[0],T=A.windowApi.document,E=0;if(!Array.isArray(w[0]))throw new TypeError("Utils.waitAnyNodeList 第一个参数必须是string[]");if(w.length!==1)if(w.length===2){let U=w[1];if(typeof U=="number")E=U;else if(typeof U=="object"&&U instanceof Node)T=U;else throw new TypeError("Utils.waitAnyNodeList 第二个参数必须是number|Node")}else if(w.length===3){let U=w[1],_=w[2];if(typeof U=="object"&&U instanceof Node)if(T=U,typeof _=="number")E=_;else throw new TypeError("Utils.waitAnyNodeList 第三个参数必须是number");else throw new TypeError("Utils.waitAnyNodeList 第二个参数必须是Node")}else throw new TypeError("Utils.waitAnyNodeList 参数个数错误");let k=C.map(U=>A.waitNodeList(U,T,E));return Promise.any(k)}waitProperty(w,A){return new Promise(C=>{let T=w;typeof w=="function"&&(T=w()),Reflect.has(T,A)?C(T[A]):Object.defineProperty(T,A,{set:function(E){try{C(E);}catch(k){console.error("Error setting property:",k);}}});})}waitPropertyByInterval(w,A,C=250,T=-1){if(w==null)throw new TypeError("checkObj 不能为空对象 ");let E=false;return new Promise((k,U)=>{let _=setInterval(()=>{let L=w;typeof w=="function"&&(L=w()),typeof L=="object"&&L!=null&&(typeof A=="function"&&A(L)||Reflect.has(L,A))&&(E=true,clearInterval(_),k(L[A]));},C);T!==-1&&setTimeout(()=>{E||(clearInterval(_),U());},T);})}async waitVueByInterval(w,A,C=250,T=-1,E="__vue__"){if(w==null)throw new Error("Utils.waitVueByInterval 参数element 不能为空");let k=false,U=this;try{await U.waitPropertyByInterval(w,function(_){if(_==null||!(E in _))return !1;if(A==null)return !0;let L=_[E];if(typeof A=="string"){if(A in L)return k=!0,!0}else if(A(L))return k=!0,!0;return !1},C,T);}catch{return k}return k}watchObject(w,A,C,T){typeof C!="function"&&typeof T!="function"||(typeof C=="function"?Object.defineProperty(w,A,{get(){return typeof C=="function"?C(w[A]):w[A]}}):typeof T=="function"?Object.defineProperty(w,A,{set(E){typeof T=="function"&&T(E);}}):Object.defineProperty(w,A,{get(){return typeof C=="function"?C(w[A]):w[A]},set(E){typeof T=="function"&&T(E);}}));}queryProperty(w,A){if(w==null)return;let C=A(w);return C&&typeof C.isFind=="boolean"&&C.isFind?C.data:this.queryProperty(C.data,A)}createUtils(w){return new Utils(w)}toFormData(w,A=false,C=false){const T=new FormData;return Object.keys(w).forEach(E=>{let k=w[E];C&&(k=JSON.stringify(k)),typeof k=="number"&&(k=k.toString()),A&&typeof k=="string"&&(k=encodeURIComponent(k)),k instanceof File?T.append(E,k,k.name):T.append(E,k);}),T}toUrl(w){if(typeof w!="string")throw new TypeError("toUrl: text must be string");if(w=w.trim(),w==="")throw new TypeError("toUrl: text must not be empty");return w.startsWith("//")?w=this.windowApi.globalThis.location.protocol+w:w.startsWith("/")&&(w=this.windowApi.globalThis.location.origin+w),new URL(w)}}let utils$1=new Utils;const SymbolEvents=Symbol("events_"+((1+Math.random())*65536|0).toString(16).substring(1)),PopsCoreEnv={document,window,globalThis,self},PopsCore={get document(){return PopsCoreEnv.document},get window(){return PopsCoreEnv.window},get globalThis(){return PopsCoreEnv.globalThis},get self(){return PopsCoreEnv.self}},OriginPrototype={Object:{defineProperty:Object.defineProperty}};let t$1=class{constructor(){this.__map={};}beforeEach(w){this.__interceptor=w;}on(w,A){const C=Array.isArray(w)?w:[w];for(const T of C){this.__map[T]=this.__map[T]||[];const E=this.__map[T];E&&E.push(A);}return this}emit(w,A,C){this.__interceptor!==void 0?this.__interceptor(w,()=>{this.__emit(w,A),C&&C();}):(this.__emit(w,A),C&&C());}__emit(w,A){const C=this.__map[w];if(Array.isArray(C)&&(C!=null&&C.length))for(const T of C)T(A,w);this.event=A;}off(w,A){const C=this.__map[w];if(C!==void 0)if(A===void 0)delete this.__map[w];else {const T=C.findIndex(E=>E===A);C.splice(T,1);}}destroy(){this.__map={};}};const n$1="clientX",e$2="clientY",t=16,c$3="start",o$1="move",s$1="cancel",u$3="end",a$2="left",i$3="right",r$4="up",d$1="down",m$2={4:"start",5:"move",1:"end",3:"cancel"};function v$1(S){return m$2[S]}function b(S,w,A){const C={1:{0:{move:4},4:{move:5,end:1,cancel:3},5:{move:5,end:1,cancel:3}},0:{4:{move:2,end:1,cancel:3},5:{start:2,move:2,end:1,cancel:3}}}[Number(S)][w];return C!==void 0&&C[A]||0}function g$1(S){[1,3,2].includes(S.state)&&(S.state=0);}function h$3(S){return [5,1,3].includes(S)}function j(S){if(S.disabled)return S.state=0,true}function O(S,w){return Object.assign(Object.assign(Object.assign({},S),w),{state:0,disabled:false})}function p$3(S){return Math.round(100*S)/100}function r$3(){let S,w,A,C,T=0;return function(E){if(S=w,E!==void 0){T=Number.MAX_SAFE_INTEGER>T?++T:1;const k=function(L,$){const{phase:I,points:P,changedPoints:H,nativeEvent:z}=L,D=P.length,G=c$3===I,V=u$3===I&&D===0||s$1===I,K=Date.now(),{x:Y,y:Z}=c$2(P)||c$2(H),{currentTarget:ot}=z;return Object.assign(L,{id:$,x:Y,y:Z,timestamp:K,isStart:G,isEnd:V,pointLength:D,currentTarget:ot,getOffset(X=ot){const Q=X.getBoundingClientRect();return {x:Y-Math.round(Q.left),y:Z-Math.round(Q.top)}}})}(E,T);w=k;const{isStart:U,pointLength:_}=k;return U&&(A=k,S=void 0,C=1<_?k:void 0),Object.assign(Object.assign({},k),{prevInput:S,startMultiInput:C,startInput:A})}}}function c$2(S){const{length:w}=S;if(0<w){if(w===1){const{clientX:C,clientY:T}=S[0];return {x:Math.round(C),y:Math.round(T)}}const A=S.reduce((C,T)=>(C.x+=T[n$1],C.y+=T[e$2],C),{x:0,y:0});return {x:Math.round(A.x/w),y:Math.round(A.y/w)}}}function a$1(S,w,A,C){const T={};for(const k in A)["target","currentTarget","type"].includes(k)||(T[k]=A[k]);let E;return document.createEvent?(E=document.createEvent("HTMLEvents"),E.initEvent(S,C==null?void 0:C.bubbles,C==null?void 0:C.cancelable)):E=new Event(S,C),Object.assign(E,T,{match:()=>A.targets&&0<A.targets.length&&A.targets.every(k=>E.currentTarget.contains(k))}),w.dispatchEvent(E)}function u$2(S,w){const{preventDefault:A}=w;return C=A,Object.prototype.toString.call(C)==="[object Function]"?A(S):!!A;var C;}const h$2=["touchstart","touchmove","touchend","touchcancel","mousedown"],p$2=["mousemove","mouseup"],g={domEvents:{bubbles:true,cancelable:true},preventDefault:S=>{if(S.target&&"tagName"in S.target){const{tagName:w}=S.target;return !/^(?:INPUT|TEXTAREA|BUTTON|SELECT)$/.test(w)}return  false}};let l$1=class extends t$1{constructor(w,A){super(),this.v="2.1.3",this.__computeFunctionList=[],this.__computeFunctionCreatorList=[],this.__pluginContexts=[],this.__isIgnoreMouse=false,this.el=w,this.c={},this.__options=Object.assign(Object.assign({},g),A);const C=function(E){const k=r$3();return function(U){const _=[],L=[];Array.from(U.touches).forEach(({clientX:I,clientY:P,target:H})=>{E!=null&&E.contains(H)&&(_.push(H),L.push({clientX:I,clientY:P,target:H}));});const $=Array.from(U.changedTouches).map(({clientX:I,clientY:P,target:H})=>({clientX:I,clientY:P,target:H}));return k({phase:U.type.replace("touch",""),changedPoints:$,points:L,nativeEvent:U,target:U.target,targets:_})}}(this.el),T=function(){let E,k=false,U=null;const _=r$3();return function(L){const{clientX:$,clientY:I,type:P,button:H,target:z}=L;let D,G=[{clientX:$,clientY:I,target:z}];if(P==="mousedown"&&H===0)U=z,k=true,D="start";else {if(!k)return;P==="mousemove"?D="move":P==="mouseup"&&(G=[],D="end",k=false);}const V=E||[{clientX:$,clientY:I,target:z}];if(E=[{clientX:$,clientY:I,target:z}],D!==void 0)return _({phase:D,changedPoints:V,points:G,target:U,targets:[U],nativeEvent:L})}}();if(this.__inputCreatorMap={touchstart:C,touchmove:C,touchend:C,touchcancel:C,mousedown:T,mousemove:T,mouseup:T},this.on("at:after",E=>{const{target:k,__type:U}=E,{domEvents:_}=this.__options;_&&this.el!==void 0&&k&&(a$1(U,k,E,_),a$1("at:after",k,E,_));}),w!==void 0){w.style.webkitTapHighlightColor="rgba(0,0,0,0)";let E=false;try{const k={};Object.defineProperty(k,"passive",{get(){E=!0;}}),window.addEventListener("_",()=>{},k);}catch{}this.on("u",function(k,U,_){return h$2.forEach(L=>{k.addEventListener(L,U,_);}),p$2.forEach(L=>{window.addEventListener(L,U,_);}),()=>{h$2.forEach(L=>{k.removeEventListener(L,U);}),p$2.forEach(L=>{window.removeEventListener(L,U);});}}(w,this.catchEvent.bind(this),this.__options.preventDefault===false&&E?{passive:true}:{passive:false}));}}use(w,A){this.__pluginContexts.push(w(this,A));}catchEvent(w){const A=this.__inputCreatorMap[w.type](w);if(A!==void 0){const C=()=>w.stopPropagation(),T=()=>w.stopImmediatePropagation(),E=()=>w.preventDefault();if(u$2(w,this.__options))E();else if(w.type==="touchstart"?this.__isIgnoreMouse=true:w.type==="touchmove"&&(this.__isIgnoreMouse=false),this.__isIgnoreMouse&&w.type.startsWith("mouse"))return void(w.type==="mouseup"&&(this.__isIgnoreMouse=false));this.emit("input",A),this.emit2(`at:${A.phase}`,A,{});const k={};this.__computeFunctionList.forEach(U=>{const _=U(A,k);if(_!==void 0)for(const L in _)k[L]=_[L];}),this.emit("computed",Object.assign(Object.assign(Object.assign({},A),k),{stopPropagation:C,stopImmediatePropagation:T,preventDefault:E}));}}compute(w,A){for(const C of w)this.__computeFunctionCreatorList.includes(C)||(this.__computeFunctionCreatorList.push(C),this.__computeFunctionList.push(C()));this.on("computed",A);}beforeEach(w){super.beforeEach((A,C)=>{var T;!((T=this.c)===null||T===void 0)&&T.name?w(A,C):C();});}get(w){return this.__pluginContexts.find(A=>w===A.name)}set(w){this.__options=Object.assign(Object.assign({},this.__options),w);}emit2(w,A,C){this.c=C,this.emit(w,Object.assign(Object.assign({},A),{type:w}),()=>{this.emit("at:after",Object.assign(Object.assign({},A),{name:w,__type:w}));});}destroy(){this.emit("u"),super.destroy();}};var x=S=>Math.sqrt(S.x*S.x+S.y*S.y),y=(S,w)=>S.x*w.x+S.y*w.y,e$1=(S,w)=>{var A=x(S)*x(w);if(A===0)return 0;var C=y(S,w)/A;return C>1&&(C=1),Math.acos(C)},n=(S,w)=>S.x*w.y-w.x*S.y,o=S=>S/Math.PI*180,s=(S,w)=>{var A=e$1(S,w);return n(S,w)>0&&(A*=-1),o(A)},u$1=(S,w)=>{if(S!==0||w!==0)return Math.abs(S)>=Math.abs(w)?0<S?i$3:a$2:0<w?d$1:r$4};function p$1(){let S=0,w=0;return function(A,C){const{prevVecotr:T,startVecotr:E,activeVecotr:k}=C;return k&&(w=Math.round(s(k,T)),S=Math.round(s(k,E))),{angle:S,deltaAngle:w}}}function d(){return function(S){const{prevInput:w}=S;let A=0,C=0,T=0;if(w!==void 0&&(A=S.x-w.x,C=S.y-w.y,A!==0||C!==0)){const E=Math.sqrt(Math.pow(A,2)+Math.pow(C,2));T=Math.round(o(Math.acos(Math.abs(A)/E)));}return {deltaX:A,deltaY:C,deltaXYAngle:T}}}function h$1(){let S,w=0,A=0,C=0,T=0,E=0;return function(k){const{phase:U,startInput:_}=k;return c$3===U?(w=0,A=0,C=0,T=0,E=0):o$1===U&&(w=Math.round(k.points[0][n$1]-_.points[0][n$1]),A=Math.round(k.points[0][e$2]-_.points[0][e$2]),C=Math.abs(w),T=Math.abs(A),E=Math.round(x({x:C,y:T})),S=u$1(w,A)),{displacementX:w,displacementY:A,distanceX:C,distanceY:T,distance:E,overallDirection:S}}}function l(){let S=1;return function(w,A){let C=1;const{prevVecotr:T,startVecotr:E,activeVecotr:k}=A;return k&&(C=p$3(x(k)/x(T)),S=p$3(x(k)/x(E))),{scale:S,deltaScale:C}}}function f(){let S,w,A=0,C=0,T=0,E=0;return function(k){if(k!==void 0){w=w||k.startInput;const U=k.timestamp-w.timestamp;if(t<U){const _=k.x-w.x,L=k.y-w.y;T=Math.round(_/U*100)/100,E=Math.round(L/U*100)/100,A=Math.abs(T),C=Math.abs(E),S=u$1(_,L),w=k;}}return {velocityX:A,velocityY:C,speedX:T,speedY:E,direction:S}}}function M(){let S=0;return function(w){const{phase:A}=w;return c$3===A&&(S=w.pointLength),{maxPointLength:S}}}function v(S){return {x:S.points[1][n$1]-S.points[0][n$1],y:S.points[1][e$2]-S.points[0][e$2]}}function m$1(){let S,w,A;return function(C){const{prevInput:T,startMultiInput:E}=C;return E!==void 0&&T!==void 0&&C.id!==E.id&&1<T.pointLength&&1<C.pointLength?(S=v(E),w=v(T),A=v(C)):A=void 0,{startVecotr:S,prevVecotr:w,activeVecotr:A}}}const m={name:"tap",pointLength:1,tapTimes:1,waitNextTapTime:300,maxDistance:2,maxDistanceFromPrevTap:9,maxPressTime:250};function r$2(S,w){const A=O(m,w);let C,T,E,k=0;function U(){k=0,C=void 0,T=void 0;}return S.compute([h$1,M],_=>{if(j(A))return;const{phase:L,x:$,y:I}=_;u$3===L&&(A.state=0,function(){const{startInput:P,pointLength:H,timestamp:z}=_,D=z-P.timestamp,{distance:G,maxPointLength:V}=_;return V===A.pointLength&&H===0&&A.maxDistance>=G&&A.maxPressTime>D}()?(clearTimeout(E),function(P,H){if(C!==void 0){const z=x({x:P.x-C.x,y:P.y-C.y});return C=P,H.maxDistanceFromPrevTap>=z}return C=P,true}({x:$,y:I},A)&&function(P){const H=performance.now();if(T===void 0)return T=H,true;{const z=H-T;return T=H,z<P}}(A.waitNextTapTime)?k++:k=1,k%A.tapTimes==0?(A.state=1,S.emit2(A.name,_,A),U()):E=setTimeout(()=>{A.state=2,U();},A.waitNextTapTime)):(U(),A.state=2));}),A}const p={name:"pan",threshold:10,pointLength:1};function u(S,w){const A=O(p,w);return S.compute([f,h$1,d],C=>{if(g$1(A),j(A))return;const T=function(){const{pointLength:E,distance:k}=C;return A.pointLength===E&&A.threshold<=k}();if(A.state=b(T,A.state,C.phase),T||h$3(A.state)){const{name:E}=A;S.emit2(E,C,A),S.emit2(E+v$1(A.state),C,A),![u$3,s$1].includes(C.phase)&&C.direction&&S.emit2(E+C.direction,C,A);}}),A}const c$1={name:"swipe",threshold:10,velocity:.3,pointLength:1};function a(S,w){const A=O(c$1,w);return S.compute([h$1,f,M],C=>{if(A.state=0,!A.disabled&&function(){if(u$3!==C.phase)return  false;const{velocityX:T,velocityY:E,distance:k,maxPointLength:U}=C;return U===A.pointLength&&C.points.length===0&&A.threshold<k&&A.velocity<Math.max(T,E)}()){const{name:T}=A;A.state=1,S.emit2(T,C,A),S.emit2(T+C.direction,C,A);}}),A}const r$1={name:"press",pointLength:1,maxDistance:9,minPressTime:251};function c(S,w){const A=O(r$1,w);let C=0;return S.compute([h$1],T=>{if(j(A))return;const{phase:E,startInput:k,pointLength:U}=T;if(c$3===E&&A.pointLength===U)g$1(A),clearTimeout(C),C=setTimeout(()=>{A.state=1,S.emit2(A.name,T,A);},A.minPressTime);else if(u$3===E&&A.state===1)S.emit2(`${A.name}${r$4}`,T,A);else if(A.state!==1){const _=T.timestamp-k.timestamp;(!function(){const{distance:L}=T;return L&&A.maxDistance>L}()||A.minPressTime>_&&[u$3,s$1].includes(E))&&(clearTimeout(C),A.state=2);}}),A}const i$2={name:"pinch",threshold:0,pointLength:2};function r(S,w){const A=O(i$2,w);return S.compute([m$1,l],C=>{if(g$1(A),j(A))return;const T=function(){const{pointLength:U,scale:_,deltaScale:L,phase:$}=C;return A.pointLength===U&&A.threshold<Math.abs(_-1)}();A.state=b(T,A.state,C.phase);const{name:E}=A;if(T||h$3(A.state)){S.emit2(E,C,A);const{deltaScale:U}=C;U!==1&&S.emit2(E+(1<U?"in":"out"),C,A);}const k=v$1(A.state);k&&S.emit2(E+k,C,A);}),A}const h={name:"rotate",threshold:0,pointLength:2};function i$1(S,w){const A=O(h,w);return S.compute([m$1,p$1],C=>{if(j(A))return;g$1(A);const T=function(){const{pointLength:U,angle:_}=C;return A.pointLength===U&&A.threshold<Math.abs(_)}();A.state=b(T,A.state,C.phase);const{name:E}=A;(T||h$3(A.state))&&S.emit2(E,C,A);const k=v$1(A.state);k&&S.emit2(E+k,C,A);}),A}function e(S){S.use(r$2,{name:"doubletap",tapTimes:2});const w=S.get("doubletap");let A;return S.beforeEach((C,T)=>{C==="tap"?(clearTimeout(A),A=setTimeout(()=>{[0,2].includes(w.state)&&T();},300)):T();}),w}class i extends l$1{constructor(w,A){super(w,A),this.use(r$2),this.use(u),this.use(a),this.use(c),this.use(r),this.use(i$1);}}i.STATE_POSSIBLE=0,i.STATE_START=4,i.STATE_MOVE=5,i.STATE_END=1,i.STATE_CANCELLED=3,i.STATE_FAILED=2,i.STATE_RECOGNIZED=1,i.tap=r$2,i.pan=u,i.swipe=a,i.press=c,i.rotate=i$1,i.pinch=r,i.doubletap=e;class PopsUtils{constructor(){tt(this,"AnyTouch",()=>i);}isWin(w){var A;return typeof w!="object"||w instanceof Node?false:w===globalThis||w===window||w===self||w===PopsCore.globalThis||w===PopsCore.window||w===PopsCore.self||typeof unsafeWindow<"u"&&w===unsafeWindow?true:((A=w==null?void 0:w.Math)==null?void 0:A.toString())==="[object Math]"}isDOM(w){return w instanceof Node}delete(w,A){typeof Reflect=="object"&&Reflect.deleteProperty?Reflect.deleteProperty(w,A):delete w[A];}assign(w={},A={},C=false){let T=this;if(A==null)return w;if(w==null&&(w={}),Array.isArray(A)&&!A.filter(k=>typeof k=="object").length)return A;if(C)for(const E in A){let U=w[E],_=A[E];if(typeof _=="object"&&_!=null&&E in w&&!T.isDOM(_)){w[E]=T.assign(U,_,C);continue}w[E]=_;}else for(const E in w)if(E in A){let k=w[E],U=A[E];if(typeof U=="object"&&U!=null&&!T.isDOM(U)&&Object.keys(U).length){w[E]=T.assign(k,U,C);continue}w[E]=U;}return w}getRandomGUID(){var w,A;return typeof((A=(w=PopsCore.globalThis)==null?void 0:w.crypto)==null?void 0:A.randomUUID)=="function"?PopsCore.globalThis.crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(C){var T=Math.random()*16|0,E=C==="x"?T:T&3|8;return E.toString(16)})}parseTextToDOM(w){return w=w.replace(/^[\n|\s]*/g,"").replace(/[\n|\s]*$/g,""),popsDOMUtils.createElement("div",{innerHTML:w}).firstChild}contains(w,A){if(arguments.length===1)return this.contains(PopsCore.document.body||PopsCore.document.documentElement,arguments[0]);if(A==null)return  false;if(typeof A[Symbol.iterator]=="function"){let C=true;for(const T of A)if(!w.contains(T)){C=false;break}return C}else return w.contains(A)}formatTime(w=new Date,A="yyyy-MM-dd HH:mm:ss"){let C=w==null?new Date:new Date(w);function T(U){return U<10?"0"+U:U}function E(U){return U>12?U-12:U}let k={yyyy:C.getFullYear(),MM:T(C.getMonth()+1),dd:T(C.getDate()),HH:T(C.getHours()),hh:T(E(C.getHours())),mm:T(C.getMinutes()),ss:T(C.getSeconds())};return Object.keys(k).forEach(function(U){let _=new RegExp(U,"g");A=A.replace(_,k[U]);}),A}formatByteToSize(w,A=true){if(w=parseInt(w.toString()),isNaN(w))throw new Error("Utils.formatByteToSize 参数 byteSize 格式不正确");let C=0,T="KB",E={};E.B=1,E.KB=1024,E.MB=E.KB*E.KB,E.GB=E.MB*E.KB,E.TB=E.GB*E.KB,E.PB=E.TB*E.KB,E.EB=E.PB*E.KB,E.ZB=E.EB*E.KB,E.YB=E.ZB*E.KB,E.BB=E.YB*E.KB,E.NB=E.BB*E.KB,E.DB=E.NB*E.KB;for(let k in E)if(C=w/E[k],T=k,E.KB>=C)break;return C=C.toFixed(2),C=A?C+T.toString():parseFloat(C.toString()),C}}const popsUtils=new PopsUtils;class PopsDOMUtilsEvent{on(w,A,C,T,E){function k(D,G,V){return typeof D[G]=="boolean"?(V.capture=D[G],typeof D[G+1]=="boolean"&&(V.once=D[G+1]),typeof D[G+2]=="boolean"&&(V.passive=D[G+2])):typeof D[G]=="object"&&("capture"in D[G]||"once"in D[G]||"passive"in D[G])&&(V.capture=D[G].capture,V.once=D[G].once,V.passive=D[G].passive),V}let U=this,_=arguments;if(typeof w=="string"&&(w=PopsCore.document.querySelectorAll(w)),w==null)return;let L=[];w instanceof NodeList||Array.isArray(w)?(w=w,L=[...w]):L.push(w);let $=[];Array.isArray(A)?$=$.concat(A):typeof A=="string"&&($=$.concat(A.split(" ")));let I=C,P=T,H={capture:false,once:false,passive:false};typeof C=="function"?(I=void 0,P=C,H=k(_,3,H)):H=k(_,4,H);function z(){H.once&&U.off(w,A,C,T,E);}L.forEach(D=>{function G(V){let K=V.target;if(I){let Y=popsUtils.isWin(D)?PopsCore.document.documentElement:D;if(K.matches(I))P.call(K,V),z();else if(K.closest(I)&&Y.contains(K.closest(I))){let Z=K.closest(I);OriginPrototype.Object.defineProperty(V,"target",{get(){return Z}}),P.call(Z,V),z();}}else P.call(D,V),z();}$.forEach(V=>{D.addEventListener(V,G,H),P&&P.delegate&&D.setAttribute("data-delegate",I);let K=D[SymbolEvents]||{};K[V]=K[V]||[],K[V].push({selector:I,option:H,callback:G,originCallBack:P}),D[SymbolEvents]=K;});});}off(w,A,C,T,E,k){function U(z,D,G){return typeof z[D]=="boolean"?G.capture=z[D]:typeof z[D]=="object"&&"capture"in z[D]&&(G.capture=z[D].capture),G}let _=arguments;if(typeof w=="string"&&(w=PopsCore.document.querySelectorAll(w)),w==null)return;let L=[];w instanceof NodeList||Array.isArray(w)?(w=w,L=[...w]):L.push(w);let $=[];Array.isArray(A)?$=$.concat(A):typeof A=="string"&&($=$.concat(A.split(" ")));let I=C,P=T,H={capture:false};typeof C=="function"?(I=void 0,P=C,H=U(_,3,H)):H=U(_,4,H),L.forEach(z=>{let D=z[SymbolEvents]||{};$.forEach(G=>{let V=D[G]||[];typeof k=="function"&&(V=V.filter(k));for(let K=0;K<V.length;K++){let Y=V[K],Z=false;(!I||Y.selector===I)&&(Z=true),(!P||Y.callback===P||Y.originCallBack===P)&&(Z=true),Z&&(z.removeEventListener(G,Y.callback,H),V.splice(K--,1));}V.length===0&&popsUtils.delete(D,A);}),z[SymbolEvents]=D;});}offAll(w,A){if(typeof w=="string"&&(w=PopsCore.document.querySelectorAll(w)),w==null)return;let C=[];w instanceof NodeList||Array.isArray(w)?C=[...w]:C.push(w);let T=[];Array.isArray(A)?T=T.concat(A):typeof A=="string"&&(T=T.concat(A.split(" "))),C.forEach(E=>{Object.getOwnPropertySymbols(E).forEach(k=>{if(!k.toString().startsWith("Symbol(events_"))return;let U=E[k]||{};(T.length?T:Object.keys(U)).forEach(L=>{let $=U[L];if($){for(const I of $)E.removeEventListener(L,I.callback,{capture:I.option.capture});popsUtils.delete(E[k],L);}});});});}ready(w){if(typeof w!="function")return;function A(){try{return document.readyState==="complete"||document.readyState!=="loading"&&!document.documentElement.doScroll}catch{return  false}}function C(){k(),w();}let T=[{target:PopsCore.document,eventType:"DOMContentLoaded",callback:C},{target:PopsCore.window,eventType:"load",callback:C}];function E(){for(let U=0;U<T.length;U++){let _=T[U];_.target.addEventListener(_.eventType,_.callback);}}function k(){for(let U=0;U<T.length;U++){let _=T[U];_.target.removeEventListener(_.eventType,_.callback);}}A()?setTimeout(w):E();}trigger(w,A,C,T=true){if(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w==null)return;let E=[];w instanceof NodeList||Array.isArray(w)?(w=w,E=[...w]):E=[w];let k=[];Array.isArray(A)?k=A:typeof A=="string"&&(k=A.split(" ")),E.forEach(U=>{let _=U[SymbolEvents]||{};k.forEach(L=>{let $=null;C&&C instanceof Event?$=C:($=new Event(L),C&&Object.keys(C).forEach(I=>{$[I]=C[I];})),T==false&&L in _?_[L].forEach(I=>{I.callback($);}):U.dispatchEvent($);});});}click(w,A,C,T){let E=this;typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null&&(A==null?E.trigger(w,"click",C,T):E.on(w,"click",null,A));}blur(w,A,C,T){let E=this;typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null&&(A===null?E.trigger(w,"blur",C,T):E.on(w,"blur",null,A));}focus(w,A,C,T){let E=this;typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null&&(A==null?E.trigger(w,"focus",C,T):E.on(w,"focus",null,A));}hover(w,A,C){let T=this;typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null&&(T.on(w,"mouseenter",null,A,C),T.on(w,"mouseleave",null,A,C));}keyup(w,A,C){let T=this;w!=null&&(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),T.on(w,"keyup",null,A,C));}keydown(w,A,C){let T=this;w!=null&&(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),T.on(w,"keydown",null,A,C));}keypress(w,A,C){let T=this;w!=null&&(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),T.on(w,"keypress",null,A,C));}preventEvent(w,A=[],C){function T(E){return E==null||E.preventDefault(),E==null||E.stopPropagation(),E==null||E.stopImmediatePropagation(),false}if(arguments.length===1)return T(arguments[0]);typeof A=="string"&&(A=[A]),A.forEach(E=>{w.addEventListener(E,T,{capture:!!C});});}}class PopsDOMUtils extends PopsDOMUtilsEvent{getAnimationEndNameList(){return ["webkitAnimationEnd","mozAnimationEnd","MSAnimationEnd","oanimationend","animationend"]}getTransitionEndNameList(){return ["webkitTransitionEnd","mozTransitionEnd","MSTransitionEnd","otransitionend","transitionend"]}offset(w,A=true){let C=w.getBoundingClientRect(),T=w.ownerDocument.defaultView;return new DOMRect(A?parseFloat((C.left+((T==null?void 0:T.pageXOffset)||0)).toString()):C.left,A?parseFloat((C.top+((T==null?void 0:T.pageYOffset)||0)).toString()):C.top,C.width,C.height)}width(w,A=false,C){let T=this;if(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null){if(popsUtils.isWin(w))return PopsCore.window.document.documentElement.clientWidth;if(w.nodeType===9)return w=w,Math.max(w.body.scrollWidth,w.documentElement.scrollWidth,w.body.offsetWidth,w.documentElement.offsetWidth,w.documentElement.clientWidth);if(A||!A&&popsDOMUtils.isShow(w)){if(w=w,parseFloat(popsDOMUtils.getStyleValue(w,"width").toString())>0)return parseFloat(popsDOMUtils.getStyleValue(w,"width").toString());if(w.offsetWidth>0){let E=popsDOMUtils.getStyleValue(w,"borderLeftWidth"),k=popsDOMUtils.getStyleValue(w,"borderRightWidth"),U=popsDOMUtils.getStyleValue(w,"paddingLeft"),_=popsDOMUtils.getStyleValue(w,"paddingRight"),L=parseFloat(w.offsetWidth.toString())-parseFloat(E.toString())-parseFloat(k.toString())-parseFloat(U.toString())-parseFloat(_.toString());return parseFloat(L.toString())}return 0}else {w=w;let{cloneNode:E,recovery:k}=popsDOMUtils.showElement(w,C),U=T.width(E,true,C);return k(),U}}}height(w,A=false,C){let T=this;if(popsUtils.isWin(w))return PopsCore.window.document.documentElement.clientHeight;if(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null){if(w.nodeType===9)return w=w,Math.max(w.body.scrollHeight,w.documentElement.scrollHeight,w.body.offsetHeight,w.documentElement.offsetHeight,w.documentElement.clientHeight);if(A||!A&&popsDOMUtils.isShow(w)){if(w=w,parseFloat(popsDOMUtils.getStyleValue(w,"height").toString())>0)return parseFloat(popsDOMUtils.getStyleValue(w,"height").toString());if(w.offsetHeight>0){let E=popsDOMUtils.getStyleValue(w,"borderTopWidth"),k=popsDOMUtils.getStyleValue(w,"borderBottomWidth"),U=popsDOMUtils.getStyleValue(w,"paddingTop"),_=popsDOMUtils.getStyleValue(w,"paddingBottom"),L=parseFloat(w.offsetHeight.toString())-parseFloat(E.toString())-parseFloat(k.toString())-parseFloat(U.toString())-parseFloat(_.toString());return parseFloat(L.toString())}return 0}else {w=w;let{cloneNode:E,recovery:k}=popsDOMUtils.showElement(w,C),U=T.height(E,true,C);return k(),U}}}outerWidth(w,A=false,C){let T=this;if(popsUtils.isWin(w))return PopsCore.window.innerWidth;if(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null)if(w=w,A||!A&&popsDOMUtils.isShow(w)){let E=getComputedStyle(w,null),k=popsDOMUtils.getStyleValue(E,"marginLeft"),U=popsDOMUtils.getStyleValue(E,"marginRight");return w.offsetWidth+k+U}else {let{cloneNode:E,recovery:k}=popsDOMUtils.showElement(w,C),U=T.outerWidth(E,true,C);return k(),U}}outerHeight(w,A=false,C){let T=this;if(popsUtils.isWin(w))return PopsCore.window.innerHeight;if(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null)if(w=w,A||!A&&popsDOMUtils.isShow(w)){let E=getComputedStyle(w,null),k=popsDOMUtils.getStyleValue(E,"marginTop"),U=popsDOMUtils.getStyleValue(E,"marginBottom");return w.offsetHeight+k+U}else {let{cloneNode:E,recovery:k}=popsDOMUtils.showElement(w,C),U=T.outerHeight(E,true,C);return k(),U}}addClassName(w,A){typeof A=="string"&&A.trim()!==""&&w.classList.add(A);}removeClassName(w,A){typeof A=="string"&&A.trim()!==""&&w.classList.remove(A);}containsClassName(w,A){return typeof A!="string"||A.trim()===""?false:w.classList.contains(A)}css(w,A,C){function T(E,k){let U=["width","height","top","left","right","bottom","font-size"];return typeof k=="number"&&(k=k.toString()),typeof k=="string"&&U.includes(E)&&k.match(/[0-9]$/gi)&&(k=k+"px"),k}if(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null){if(typeof A=="string"){if(C==null)return getComputedStyle(w).getPropertyValue(A);C==="string"&&C.includes("!important")?w.style.setProperty(A,C,"important"):(C=T(A,C),w.style.setProperty(A,C));}else if(typeof A=="object")for(let E in A)typeof A[E]=="string"&&A[E].includes("!important")?w.style.setProperty(E,A[E],"important"):(A[E]=T(E,A[E]),w.style.setProperty(E,A[E]));}}createElement(w,A,C){let T=PopsCore.document.createElement(w);return typeof A=="string"?(T.innerHTML=A,T):(A==null&&(A={}),C==null&&(C={}),Object.keys(A).forEach(E=>{let k=A[E];T[E]=k;}),Object.keys(C).forEach(E=>{let k=C[E];typeof k=="object"?k=JSON.stringify(k):typeof k=="function"&&(k=k.toString()),T.setAttribute(E,k);}),T)}getTextBoundingRect(w,A,C,T){if(!w||!("value"in w))return w;if(typeof A=="string"&&(A=parseFloat(A)),(typeof A!="number"||isNaN(A))&&(A=0),A<0?A=0:A=Math.min(w.value.length,A),typeof C=="string"&&(C=parseFloat(C)),(typeof C!="number"||isNaN(C)||C<A)&&(C=A),C<0?C=0:C=Math.min(w.value.length,C),typeof w.createTextRange=="function"){var E=w.createTextRange();return E.collapse(true),E.moveStart("character",A),E.moveEnd("character",C-A),E.getBoundingClientRect()}var k=ot(),U=k.top,_=k.left,L=X("width",true),$=X("height",true),I="white-space:pre;padding:0;margin:0;",P=["direction","font-family","font-size","font-size-adjust","font-variant","font-weight","font-style","letter-spacing","line-height","text-align","text-indent","text-transform","word-wrap","word-spacing"];U+=X("padding-top",true),U+=X("border-top-width",true),_+=X("padding-left",true),_+=X("border-left-width",true),_+=1;for(var H=0;H<P.length;H++){var z=P[H];I+=z+":"+X(z)+";";}var D=w.value||"G",G=D.length,V=document.createElement("div");A>0&&Z(0,A);var K=Z(A,C);G>C&&Z(C,G),V.style.cssText=I,V.style.position="absolute",V.style.top=U+"px",V.style.left=_+"px",V.style.width=L+"px",V.style.height=$+"px",PopsCore.document.body.appendChild(V);var Y=K.getBoundingClientRect();return T||V.parentNode.removeChild(V),Y;function Z(Q,et){var rt=document.createElement("span");return rt.style.cssText=I,rt.textContent=D.substring(Q,et),V.appendChild(rt),rt}function ot(){var Q=document.body,et=document.defaultView,rt=document.documentElement,bt=document.createElement("div");bt.style.paddingLeft=bt.style.width="1px",Q.appendChild(bt);var xt=bt.offsetWidth==2;Q.removeChild(bt),bt=w.getBoundingClientRect();var q=rt.clientTop||Q.clientTop||0,F=rt.clientLeft||Q.clientLeft||0,B=et.pageYOffset||xt&&rt.scrollTop||Q.scrollTop,N=et.pageXOffset||xt&&rt.scrollLeft||Q.scrollLeft;return {top:bt.top+B-q,left:bt.left+N-F}}function X(Q,et){var rt=PopsCore.document.defaultView.getComputedStyle(w,null).getPropertyValue(Q);return et?parseFloat(rt):rt}}cssHide(w,A=false){w!=null&&(A?w.classList.add("pops-hide-important"):w.classList.add("pops-hide"));}cssShow(w){w!=null&&(w.classList.remove("pops-hide-important"),w.classList.remove("pops-hide"));}parseHTML(w,A=false,C=false){function T(){let k=new DOMParser;return C?k.parseFromString(w,"text/html"):k.parseFromString(w,"text/html").body.firstChild}function E(){let k=PopsCore.document.createElement("div");return k.innerHTML=w,C?k:k.firstChild}return A?T():E()}append(w,A){if(typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w==null)return;function C(T,E){typeof A=="string"?T.insertAdjacentHTML("beforeend",E):T.appendChild(E);}if(Array.isArray(A)||A instanceof NodeList){let T=PopsCore.document.createDocumentFragment();A.forEach(E=>{typeof E=="string"&&(E=this.parseHTML(E,true,false)),T.appendChild(E);}),w.appendChild(T);}else C(w,A);}appendHead(w){PopsCore.document.head?PopsCore.document.head.appendChild(w):PopsCore.document.documentElement.appendChild(w);}appendBody(w){PopsCore.document.body?PopsCore.document.body.appendChild(w):PopsCore.document.documentElement.appendChild(w);}isShow(w){return !!w.getClientRects().length}showElement(w,A){let C=w.cloneNode(true);C.setAttribute("style","visibility: hidden !important;display:block !important;");let T=PopsCore.document.documentElement,E=w.getRootNode();return A==null?E==w?T=PopsCore.document.documentElement:T=E:T=A,T.appendChild(C),{cloneNode:C,recovery(){C.remove();}}}getStyleValue(w,A){let C=null,T=null;w instanceof CSSStyleDeclaration?T=w:(C=w.ownerDocument.defaultView,(!C||!C.opener)&&(C=window),T=C.getComputedStyle(w));let E=parseFloat(T[A]);return isNaN(E)?0:E}before(w,A){typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null&&(typeof A=="string"?w.insertAdjacentHTML("beforebegin",A):w.parentElement.insertBefore(A,w));}after(w,A){typeof w=="string"&&(w=PopsCore.document.querySelector(w)),w!=null&&(typeof A=="string"?w.insertAdjacentHTML("afterend",A):w.parentElement.insertBefore(A,w.nextSibling));}}const popsDOMUtils=new PopsDOMUtils,PopsInstanceUtils={getMaxZIndexNodeInfo(S=1,w=PopsCore.document,A){S=Number.isNaN(S)?1:S;const C=2*Math.pow(10,9);let T=0,E=null;function k(_){return _.position!=="static"&&_.display!=="none"}function U(_){if(typeof A=="function"){let $=A(_);if(typeof $=="boolean"&&!$)return}const L=PopsCore.window.getComputedStyle(_);if(k(L)){let $=parseInt(L.zIndex);isNaN($)||$>T&&(T=$,E=_),_.shadowRoot!=null&&_ instanceof ShadowRoot&&_.shadowRoot.querySelectorAll("*").forEach(I=>{U(I);});}}return w.querySelectorAll("*").forEach((_,L)=>{U(_);}),T+=S,T>=C&&(T=C),{node:E,zIndex:T}},getPopsMaxZIndex(S=1){S=Number.isNaN(S)?1:S;const w=2*Math.pow(10,9);let A=0,C=null;function T(k){return k.position!=="static"&&k.display!=="none"}Object.keys(pops.config.layer).forEach(k=>{let U=pops.config.layer[k];for(let _=0;_<U.length;_++){const L=U[_];let $=window.getComputedStyle(L.animElement);if(T($)){let I=parseInt($.zIndex);isNaN(I)||I>A&&(A=I,C=L.animElement);}}}),A+=S;let E=A>=w;return E&&(A=w),{zIndex:A,animElement:C,isOverMaxZIndex:E}},getMaxZIndex(S=1){return this.getMaxZIndexNodeInfo(S).zIndex},getKeyFrames(S){let w={};return Object.keys(S.cssRules).forEach(A=>{S.cssRules[A].type===7&&S.cssRules[A].name.startsWith("pops-anim-")&&(w[S.cssRules[A].name]=S.cssRules[A]);}),w},removeInstance(S,w,A=false){function C(T){var E,k,U,_;typeof T.beforeRemoveCallBack=="function"&&T.beforeRemoveCallBack(T),(E=T==null?void 0:T.animElement)==null||E.remove(),(k=T==null?void 0:T.popsElement)==null||k.remove(),(U=T==null?void 0:T.maskElement)==null||U.remove(),(_=T==null?void 0:T.$shadowContainer)==null||_.remove();}return S.forEach(T=>{T.forEach((E,k)=>{(A||E.guid===w)&&(pops.config.animation.hasOwnProperty(E.animElement.getAttribute("anim"))?(E.animElement.style.width="100%",E.animElement.style.height="100%",E.animElement.style["animation-name"]=E.animElement.getAttribute("anim")+"-reverse",pops.config.animation.hasOwnProperty(E.animElement.style["animation-name"])?popsDOMUtils.on(E.animElement,popsDOMUtils.getAnimationEndNameList(),function(){C(E);},{capture:true}):C(E)):C(E),T.splice(k,1));});}),S},hide(S,w,A,C,T,E){let k=T.querySelector(".pops[type-value]");if(S==="drawer"){let U=C;setTimeout(()=>{E.style.setProperty("display","none"),["top","bottom"].includes(U.direction)?k.style.setProperty("height","0"):["left","right"].includes(U.direction)?k.style.setProperty("width","0"):console.error("未知direction：",U.direction);},U.closeDelay);}else w.forEach(U=>{if(U.guid===A){if(U.animElement.style.width="100%",U.animElement.style.height="100%",U.animElement.style["animation-name"]=U.animElement.getAttribute("anim")+"-reverse",pops.config.animation.hasOwnProperty(U.animElement.style["animation-name"])){let L=function(){U.animElement.style.display="none",U.maskElement&&(U.maskElement.style.display="none"),popsDOMUtils.off(U.animElement,popsDOMUtils.getAnimationEndNameList(),L,{capture:true});};popsDOMUtils.on(U.animElement,popsDOMUtils.getAnimationEndNameList(),L,{capture:true});}else U.animElement.style.display="none",U.maskElement&&(U.maskElement.style.display="none");return}});},show(S,w,A,C,T,E){let k=T.querySelector(".pops[type-value]");if(S==="drawer"){let U=C;setTimeout(()=>{E.style.setProperty("display","");let _=U.direction,L=U.size.toString();["top","bottom"].includes(_)?k.style.setProperty("height",L):["left","right"].includes(_)?k.style.setProperty("width",L):console.error("未知direction：",_);},U.openDelay);}else w.forEach(U=>{if(U.guid===A)if(U.animElement.style.width="",U.animElement.style.height="",U.animElement.style["animation-name"]=U.animElement.getAttribute("anim").replace("-reverse",""),pops.config.animation.hasOwnProperty(U.animElement.style["animation-name"])){let L=function(){popsDOMUtils.off(U.animElement,popsDOMUtils.getAnimationEndNameList(),L,{capture:true});};U.animElement.style.display="",U.maskElement&&(U.maskElement.style.display=""),popsDOMUtils.on(U.animElement,popsDOMUtils.getAnimationEndNameList(),L,{capture:true});}else U.animElement.style.display="",U.maskElement&&(U.maskElement.style.display="");});},close(S,w,A,C,T){let E=T.querySelector(".pops[type-value]"),k=C;function U(){function _($){$.propertyName==="transform"&&(popsDOMUtils.off(E,popsDOMUtils.getTransitionEndNameList(),void 0,_),PopsInstanceUtils.removeInstance([w],A));}if(popsDOMUtils.on(E,popsDOMUtils.getTransitionEndNameList(),_),getComputedStyle(E).transform!=="none"){popsDOMUtils.trigger(E,popsDOMUtils.getTransitionEndNameList(),void 0,true);return}["top"].includes(k.direction)?E.style.setProperty("transform","translateY(-100%)"):["bottom"].includes(k.direction)?E.style.setProperty("transform","translateY(100%)"):["left"].includes(k.direction)?E.style.setProperty("transform","translateX(-100%)"):["right"].includes(k.direction)?E.style.setProperty("transform","translateX(100%)"):console.error("未知direction：",k.direction);}S==="drawer"?setTimeout(()=>{U();},k.closeDelay):PopsInstanceUtils.removeInstance([w],A);},drag(S,w){w=Object.assign({limit:true,extraDistance:3,container:PopsCore.globalThis,triggerClick:true},w);let A=false,C=0,T=0,E=popsUtils.AnyTouch(),k=new E(w.dragElement,{preventDefault(D){return typeof w.preventEvent=="function"?w.preventEvent(D):true}});popsDOMUtils.css(w.dragElement,{cursor:"move"});function U(D){var Y;let G=0,V=0,K=PopsCore.globalThis.getComputedStyle(D).transform;if(K!=="none"&&K!=null&&K!==""){let Z=(Y=K.match(/\((.+)\)/))==null?void 0:Y[1].split(",");G=Math.abs(parseInt(Z[4])),V=Math.abs(parseInt(Z[5]));}return {transformLeft:G,transformTop:V}}function _(D){let G=D.style.transitionDuration;return globalThis.getComputedStyle(D).transitionDuration!=="0s"&&(D.style.transitionDuration="0s"),()=>{D.style.transitionDuration=G;}}function L(D){return D=D??globalThis,{width:popsDOMUtils.width(D),height:popsDOMUtils.height(D)}}function $(D){if(D=D??globalThis,popsUtils.isWin(D))return {left:0,top:0};{let G=D.getBoundingClientRect();return {left:G.left,top:G.top}}}let I=U(S),P=I.transformLeft,H=I.transformTop,z=null;k.on("pan",function(D){if(!A){A=true;let K=w.dragElement.getBoundingClientRect();C=D.x-K.left,T=D.y-K.top,I=U(S),P=I.transformLeft,H=I.transformTop,z=_(S);}let G=D.x-C+P,V=D.y-T+H;if(D.phase==="move"){if(w.limit){let K=L(w.container).width-popsDOMUtils.width(S)+P,{left:Y,top:Z}=$(w.container),ot=L(w.container).height-popsDOMUtils.height(S)+H;G>K&&(G=K),V>ot&&(V=ot),G-w.extraDistance*2<Y+P?(G=Y+P,G+=w.extraDistance):G-=w.extraDistance,V-w.extraDistance*2<Z+H?(V=Z+H,V+=w.extraDistance):V-=w.extraDistance;}typeof w.moveCallBack=="function"&&w.moveCallBack(S,G,V),popsDOMUtils.css(S,{left:G+"px",top:V+"px"});}D.phase==="end"&&(A=false,typeof z=="function"&&(z(),z=null),typeof w.endCallBack=="function"&&w.endCallBack(S,G,V));}),w.triggerClick&&k.on(["tap"],function(D){D.changedPoints.forEach(G=>{popsDOMUtils.trigger(G.target,"click",void 0,true);});});},sortElementListByProperty(S,w,A=true){if(typeof A!="boolean")throw "参数 sortByDesc 必须为boolean类型";if(S==null||w==null)throw "获取前面的值或后面的值的方法不能为空";return function(C,T){var E=S(T),k=w(C);return A?k>E?-1:k<E?1:0:k<E?-1:k>E?1:0}}};var indexCSS=`@charset "utf-8";\r
.pops * {\r
...
`;const GlobalConfig={config:{},setGlobalConfig(S){Reflect.ownKeys(S).forEach(w=>{Reflect.set(GlobalConfig.config,w,Reflect.get(S,w));});},getGlobalConfig(){let S={};return Object.keys(GlobalConfig.config).forEach(w=>{let A=Reflect.get(GlobalConfig.config,w);if(w==="style"){let C=A==null?"":typeof A=="function"?A():A;typeof C=="string"&&(S.style=C);}else if(w==="zIndex"){let C=A==null?"":typeof A=="function"?A():A;if(typeof C=="string"){let T=C=parseInt(C);isNaN(T)||(S.zIndex=T);}else isNaN(C)||(S.zIndex=C);}else if(w==="mask"){let C=GlobalConfig.config.mask==null?{}:GlobalConfig.config.mask;typeof C=="object"&&C!=null&&(S.mask=C);}else Reflect.set(S,w,A);}),S}},PopsElementHandler={getMaskHTML(S,w=101,A=""){return w=w-100,A.startsWith(";")&&(A=A.replace(";","")),`<div class="pops-mask" data-guid="${S}" style="z-index:${w};${A}"></div>`},getAnimHTML(S,w,A,C="",T="",E){let k=A,U="",_="",L=k.position||"";A.zIndex!=null&&(U+=`z-index: ${E};`,_+=`z-index: ${E};`),k.width!=null&&(_+=`width: ${k.width};`),k.height!=null&&(_+=`height: ${k.height};`);let $=T.trim()!=="";return `
		<div 
		...
		</div>`},getHeaderBtnHTML(S,w){var k,U,_,L,$;if(!w.btn)return "";let A=w;if(S!=="iframe"&&!((U=(k=A.btn)==null?void 0:k.close)!=null&&U.enable))return "";let C="",T="",E=w;if(S==="iframe"&&((_=E.topRightButton)==null?void 0:_.trim())!==""){let I="";E.topRightButton.split("|").forEach(P=>{P=P.toLowerCase(),I+=`
			...
			${$}`,$,U),G=PopsElementHandler.parseElement(D),{popsElement:V,headerCloseBtnElement:K,btnOkElement:Y,titleElement:Z}=PopsHandler.handleQueryElement(G,C),ot=null,X=[G];T.mask.enable&&(ot=PopsHandler.handleMask({type:C,guid:A,config:T,animElement:G,maskHTML:_}).maskElement,X.push(ot));let Q=PopsHandler.handleEventDetails(A,E,k,C,G,V,ot,T);return PopsHandler.handleClickEvent("close",K,Q,T.btn.close.callback),PopsHandler.handleClickEvent("ok",Y,Q,T.btn.ok.callback),popsDOMUtils.append(k,X),typeof T.beforeAppendToPageCallBack=="function"&&T.beforeAppendToPageCallBack(k,E),popsDOMUtils.appendBody(E),ot!=null&&G.after(ot),PopsHandler.handlePush(C,{guid:A,animElement:G,popsElement:V,maskElement:ot,$shadowContainer:E,$shadowRoot:k}),T.drag&&PopsInstanceUtils.drag(V,{dragElement:Z,limit:T.dragLimit,extraDistance:T.dragExtraDistance,moveCallBack:T.dragMoveCallBack,endCallBack:T.dragEndCallBack}),PopsHandler.handleResultDetails(Q)}}const PopsConfirmConfig=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(S){S.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(S){S.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(S){S.close();}},close:{enable:true,callback(S){S.close();}}},useShadowRoot:true,class:"",only:false,width:"350px",height:"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}});class PopsConfirm{constructor(w){const A=popsUtils.getRandomGUID(),C="confirm";let T=PopsConfirmConfig();T=popsUtils.assign(T,GlobalConfig.getGlobalConfig()),T=popsUtils.assign(T,w),T=PopsHandler.handleOnly(C,T);const{$shadowContainer:E,$shadowRoot:k}=PopsHandler.handlerShadow(T);PopsHandler.handleInit(k,[pops.config.cssText.index,pops.config.cssText.ninePalaceGridPosition,pops.config.cssText.scrollbar,pops.config.cssText.button,pops.config.cssText.anim,pops.config.cssText.common,pops.config.cssText.confirmCSS]);let U=PopsHandler.handleZIndex(T.zIndex),_=PopsElementHandler.getMaskHTML(A,U),L=PopsElementHandler.getHeaderBtnHTML(C,T),$=PopsElementHandler.getBottomBtnHTML(C,T),{headerStyle:I,headerPStyle:P}=PopsElementHandler.getHeaderStyle(C,T),{contentStyle:H,contentPStyle:z}=PopsElementHandler.getContentStyle(C,T),D=PopsElementHandler.getAnimHTML(A,C,T,`
            ...
            `,"",E),L=PopsElementHandler.parseElement(_),{popsElement:$}=PopsHandler.handleQueryElement(L,T),I=null,P=[L];A.mask.enable&&(I=PopsHandler.handleMask({type:T,guid:C,config:A,animElement:L,maskHTML:k}).maskElement,P.push(I));let H=PopsHandler.handleLoadingEventDetails(C,T,L,$,I,A);return popsDOMUtils.append(A.parent,P),I!=null&&L.after(I),PopsHandler.handlePush(T,{guid:C,animElement:L,popsElement:$,maskElement:I}),PopsHandler.handleResultDetails(H)}}const PopsIframeConfig=()=>({title:{position:"center",text:"",html:false,style:""},loading:{enable:true,icon:true,text:""},useShadowRoot:true,class:"",url:window.location.href,only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",position:"center",drag:true,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},width:"300px",height:"250px",topRightButton:"min|max|mise|close",sandbox:false,forbiddenScroll:false,loadEndCallBack(){},btn:{min:{callback(){}},max:{callback(){}},mise:{callback(){}},close:{callback(){}}},style:null,beforeAppendToPageCallBack(){}});class PopsIframe{constructor(w){var wt;const A=popsUtils.getRandomGUID(),C="iframe";let T=PopsIframeConfig();if(T=popsUtils.assign(T,GlobalConfig.getGlobalConfig()),T=popsUtils.assign(T,w),T.url==null)throw "config.url不能为空";T=PopsHandler.handleOnly(C,T);const{$shadowContainer:E,$shadowRoot:k}=PopsHandler.handlerShadow(T);PopsHandler.handleInit(k,[pops.config.cssText.index,pops.config.cssText.ninePalaceGridPosition,pops.config.cssText.scrollbar,pops.config.cssText.anim,pops.config.cssText.common,pops.config.cssText.iframeCSS]);let U=T.animation!=null&&T.animation!=""?"position:absolute;":"",_=PopsHandler.handleZIndex(T.zIndex),L=PopsElementHandler.getMaskHTML(A,_,U),$=PopsElementHandler.getHeaderBtnHTML(C,T),I='<div class="pops-loading"></div>',P=T.title.text.trim()!==""?T.title.text:T.url,{headerStyle:H,headerPStyle:z}=PopsElementHandler.getHeaderStyle(C,T),D=PopsElementHandler.getAnimHTML(A,C,T,`
            <div 
            ...
            ${z}
            `,z,I),K=PopsElementHandler.parseElement(V),{popsElement:Y,titleElement:Z,contentElement:ot,folderListBodyElement:X,folderFileListBreadcrumbPrimaryElement:Q,headerCloseBtnElement:et,btnOkElement:rt,btnCancelElement:bt,btnOtherElement:xt,folderListSortFileNameElement:q,folderListSortLatestTimeElement:F,folderListSortFileSizeElement:B}=PopsHandler.handleQueryElement(K,C),N=null,W=[K];T.mask.enable&&(N=PopsHandler.handleMask({type:C,guid:A,config:T,animElement:K,maskHTML:P}).maskElement,W.push(N));let J=PopsHandler.handleEventDetails(A,E,k,C,K,Y,N,T);PopsHandler.handleClickEvent("close",et,J,T.btn.close.callback),PopsHandler.handleClickEvent("ok",rt,J,T.btn.ok.callback),PopsHandler.handleClickEvent("cancel",bt,J,T.btn.cancel.callback),PopsHandler.handleClickEvent("other",xt,J,T.btn.other.callback),popsDOMUtils.append(k,W),typeof T.beforeAppendToPageCallBack=="function"&&T.beforeAppendToPageCallBack(k,E),popsDOMUtils.appendBody(E),N!=null&&K.after(N),T.folder.sort();function nt(st,lt="-",ct="-",vt=false){let pt=st,mt=lt,St=ct,Mt=popsDOMUtils.createElement("tr"),Et=popsDOMUtils.createElement("td"),Tt=popsDOMUtils.createElement("td"),Lt=popsDOMUtils.createElement("td"),Vt="",Dt=Folder_ICON.folder;if(vt)lt="",ct="";else {Dt="",typeof lt=="number"&&(lt=popsUtils.formatTime(lt)),typeof ct=="number"&&(ct=popsUtils.formatByteToSize(ct));for(let re in Folder_ICON)if(st.toLowerCase().endsWith("."+re)){Vt=re,Dt=Folder_ICON[re];break}Dt||(Vt="Null",Dt=Folder_ICON.Null);}Mt.className="pops-folder-list-table__body-row",Et.className="pops-folder-list-table__body-td",Tt.className="pops-folder-list-table__body-td",Lt.className="pops-folder-list-table__body-td",Et.innerHTML=`
            ...
            `;let Zt={fileName:pt,latestTime:mt,fileSize:St,isFolder:vt};return Et.__value__=Zt,Tt.__value__=Zt,Lt.__value__=Zt,Mt.__value__=Zt,Mt.appendChild(Et),Mt.appendChild(Tt),Mt.appendChild(Lt),{folderELement:Mt,fileNameElement:Et,fileTimeElement:Tt,fileFormatSize:Lt}}function at(st,lt="-",ct="-",vt=false){let pt=st,mt=lt,St=ct,Mt=popsDOMUtils.createElement("tr"),Et=popsDOMUtils.createElement("td"),Tt="",Lt=Folder_ICON.folder;if(vt)lt="",ct="";else {Lt="",typeof lt=="number"&&(lt=popsUtils.formatTime(lt)),typeof ct=="number"&&(ct=popsUtils.formatByteToSize(ct));for(let Dt in Folder_ICON)if(st.toLowerCase().endsWith("."+Dt)){Tt=Dt,Lt=Folder_ICON[Dt];break}Lt||(Tt="Null",Lt=Folder_ICON.Null);}Mt.className="pops-folder-list-table__body-row",Et.className="pops-folder-list-table__body-td",Et.innerHTML=`
			...
			</div>`;let C=w.querySelector(".pops-panel-slider input[type=range]");S.step&&C.setAttribute("step",S.step.toString()),C.value=S.getValue().toString();let T=function(k){return typeof S.getToolTipContent=="function"?S.getToolTipContent(k):k},E=pops.tooltip({target:C.parentElement,content:()=>T(C.value),zIndex:()=>PopsInstanceUtils.getPopsMaxZIndex().zIndex,className:"github-tooltip",alwaysShow:false,only:false,position:"top",arrowDistance:10});return popsDOMUtils.on(C,["input","propertychange"],void 0,function(k){E.toolTip.changeContent(T(C.value)),typeof S.callback=="function"&&S.callback(k,k.target.value);}),w},createSectionContainerItem_slider_new(S){let w=document.createElement("li");w.__formConfig__=S,this.setElementClassName(w,S.className),this.setElementAttributes(w,S.attributes),this.setElementProps(w,S.props);let A="";S.description&&(A=`<p class="pops-panel-item-left-desc-text">${S.description}</p>`),w.innerHTML=`
			...
			</div>`;const C={[Symbol.toStringTag]:"PopsPanelSlider",value:S.getValue(),min:S.min,max:S.max,step:S.step||1,$data:{isMove:false,isInitDragPosition:false,isCheckingStopDragMove:false,totalWidth:0,stepPx:0,dragWidth:0,dragPercent:0,stepBlockMap:new Map,tooltip:null},$ele:{slider:w.querySelector(".pops-slider"),runAway:w.querySelector(".pops-slider__runway"),bar:w.querySelector(".pops-slider__bar"),buttonWrapper:w.querySelector(".pops-slider__button-wrapper"),button:w.querySelector(".pops-slider__button")},$interval:{isCheck:false},$tooltip:null,init(){this.initEleData(),this.setToolTipEvent(),this.setPanEvent(),this.setRunAwayClickEvent(),this.intervalInit(),S.disabled&&this.disableDrag();},intervalInit(T=200,E=1e4){if(this.$interval.isCheck)return;this.$interval.isCheck=true;let k=false,U=this.$data.totalWidth,_,L=setInterval(()=>{k?(this.$interval.isCheck=false,clearTimeout(_),clearInterval(L)):(this.initTotalWidth(),this.$data.totalWidth!==0&&(k=true,this.$data.totalWidth!==U&&(PopsMathFloatUtils.isFloat(this.step)?this.initFloatStepMap():this.initStepMap(),this.initSliderPosition())));},T);_=setTimeout(()=>{clearInterval(L);},E);},initEleData(){this.$ele.slider.setAttribute("data-min",this.min.toString()),this.$ele.slider.setAttribute("data-max",this.max.toString()),this.$ele.slider.setAttribute("data-value",this.value.toString()),this.$ele.slider.setAttribute("data-step",this.step.toString()),this.$ele.slider["data-min"]=this.min,this.$ele.slider["data-max"]=this.max,this.$ele.slider["data-value"]=this.value,this.$ele.slider["data-step"]=this.step;},initTotalWidth(){this.$data.totalWidth=popsDOMUtils.width(this.$ele.runAway);},initStepMap(){let T=0,E=(this.max-this.min)/this.step;this.$data.stepPx=this.$data.totalWidth/E;let k=0;for(let U=this.min;U<=this.max;U+=this.step){let _=this.formatValue(U),L={};_===this.min?L={value:_,px:0,pxLeft:0,pxRight:this.$data.stepPx/2,percent:0}:L={value:_,px:k,pxLeft:k-this.$data.stepPx/2,pxRight:k+this.$data.stepPx/2,percent:k/this.$data.totalWidth},this.$data.stepBlockMap.set(T,L),T++,k+=this.$data.stepPx;}},initFloatStepMap(){let T=0,E=(this.max-this.min)/this.step;this.$data.stepPx=this.$data.totalWidth/E;let k=0;for(let U=this.min;U<=this.max;U=PopsMathFloatUtils.add(U,this.step)){let _=this.formatValue(U),L={};_===this.min?L={value:_,px:0,pxLeft:0,pxRight:this.$data.stepPx/2,percent:0}:L={value:_,px:k,pxLeft:k-this.$data.stepPx/2,pxRight:k+this.$data.stepPx/2,percent:k/this.$data.totalWidth},this.$data.stepBlockMap.set(T,L),T++,k+=this.$data.stepPx;}},initSliderPosition(){let T=0;for(const[,E]of this.$data.stepBlockMap.entries())if(E.value==this.value){T=E.percent,this.$data.dragWidth=E.px;break}T=this.formatValue(T*100),this.setSliderPosition(T);},isFloat(T){return Number(T)===T&&T%1!==0},valueChangeCallBack(T,E){typeof S.callback=="function"&&S.callback(T,E);},getDragInfo(T){let E=this.$data.stepBlockMap.get(0);for(const[,k]of this.$data.stepBlockMap.entries())if(k.pxLeft<=T&&T<k.pxRight){E=k;break}return E},getSliderPositonPercent(T){return T/this.$data.totalWidth},formatValue(T){return PopsMathFloatUtils.isFloat(this.step)?T=parseFloat(T.toFixed(2)):T=parseInt(T.toString()),T},setSliderPosition(T){parseInt(T.toString())===1&&(T=1),T>1&&(T=T/100),this.$ele.buttonWrapper.style.left=`${T*100}%`,this.$ele.bar.style.width=`${T*100}%`;},disableDrag(){this.$ele.runAway.classList.add("pops-slider-is-disabled");},allowDrag(){this.$ele.runAway.classList.remove("pops-slider-is-disabled");},isDisabledDrag(){return this.$ele.runAway.classList.contains("pops-slider-is-disabled")},setRunAwayClickEvent(){popsDOMUtils.on(this.$ele.runAway,"click",void 0,T=>{if(T.target!==this.$ele.runAway&&T.target!==this.$ele.bar)return;let E=parseFloat(T.offsetX);this.dragStartCallBack(),this.dragMoveCallBack(T,E,this.value),this.dragEndCallBack(E);},{capture:false});},dragStartCallBack(){if(!this.$data.isMove){if(this.isDisabledDrag())return  false;this.$data.isMove=true;}return  true},dragMoveCallBack(T,E,k){let U=0;if(E<=0)U=0,this.value=this.min;else if(E>=this.$data.totalWidth)U=1,this.value=this.max;else {const _=this.getDragInfo(E);U=_.percent,this.value=this.formatValue(_.value);}this.$data.dragPercent=U,this.setSliderPosition(this.$data.dragPercent),this.showToolTip(),k!==this.value&&this.valueChangeCallBack(T,this.value);},dragEndCallBack(T){this.$data.isMove=false,T<=0?this.$data.dragWidth=0:T>=this.$data.totalWidth?this.$data.dragWidth=this.$data.totalWidth:this.$data.dragWidth=T,this.closeToolTip();},setPanEvent(){const T=popsUtils.AnyTouch();this.$tooltip=new T(this.$ele.button,{preventDefault(){return  false}});let E=0;this.$tooltip.on("at:move",k=>{if(!this.dragStartCallBack())return;let U=this.value;const _=this.$ele.runAway.getBoundingClientRect();let L=k.x-(_.left+globalThis.screenX);L<=0?L=0:L>=_.width&&(L=_.width),E=L,this.dragMoveCallBack(k,E,U);}),this.$tooltip.on("at:end",k=>{this.dragEndCallBack(E);});},showToolTip(){this.$data.tooltip.toolTip.show();},closeToolTip(){this.$data.tooltip.toolTip.close();},checkStopDragMove(){if(this.$data.isCheckingStopDragMove)return;this.$data.isCheckingStopDragMove=true;let T=setInterval(()=>{this.$data.isMove||(this.$data.isCheckingStopDragMove=false,this.closeToolTip(),clearInterval(T));},200);setTimeout(()=>{this.$data.isCheckingStopDragMove=false,clearInterval(T);},2e3);},setToolTipEvent(){function T(){return typeof S.getToolTipContent=="function"?S.getToolTipContent(C.value):C.value}let E=pops.tooltip({target:this.$ele.button,content:T,zIndex:()=>PopsInstanceUtils.getPopsMaxZIndex().zIndex,isFixed:true,className:"github-tooltip",only:false,eventOption:{capture:true,passive:true},showBeforeCallBack:()=>{this.intervalInit();},showAfterCallBack:k=>{E.toolTip.changeContent(T());},closeBeforeCallBack:()=>{if(this.$data.isMove)return this.checkStopDragMove(),false},alwaysShow:false,position:"top",arrowDistance:10});this.$data.tooltip=E;}};return C.init(),w["data-slider"]=C,w},createSectionContainerItem_input(S){let w=document.createElement("li");w.__formConfig__=S,this.setElementClassName(w,S.className),this.setElementAttributes(w,S.attributes),this.setElementProps(w,S.props);let A="text";S.isPassword?A="password":S.isNumber&&(A="number");let C="";S.description&&(C=`<p class="pops-panel-item-left-desc-text">${S.description}</p>`),w.innerHTML=`
			<div class="pops-panel-item-left-text">
				<p class="pops-panel-item-left-main-text">${S.text}</p>
			${C}
			</div>
			...
			`;const C={[Symbol.toStringTag]:"PopsPanelTextArea",$ele:{panelTextarea:w.querySelector(".pops-panel-textarea"),textarea:w.querySelector(".pops-panel-textarea textarea")},$data:{value:S.getValue()},init(){this.setValue(this.$data.value),this.setChangeEvent(),S.disabled&&this.disable();},disable(){this.$ele.textarea.setAttribute("disabled","true"),this.$ele.panelTextarea.classList.add("pops-panel-textarea-disable");},notDisable(){this.$ele.textarea.removeAttribute("disabled"),this.$ele.panelTextarea.classList.remove("pops-panel-textarea-disable");},isDisabled(){return this.$ele.textarea.hasAttribute("disabled")||this.$ele.panelTextarea.classList.contains("pops-panel-textarea-disable")},setValue(T){this.$ele.textarea.value=T;},setChangeEvent(){popsDOMUtils.on(this.$ele.textarea,["input","propertychange"],void 0,T=>{this.$data.value=T.target.value,typeof S.callback=="function"&&S.callback(T,T.target.value);});}};return C.init(),w["data-textarea"]=C,w},createSectionContainerItem_select(S){const w=this;let A=document.createElement("li");A.__formConfig__=S,this.setElementClassName(A,S.className),this.setElementAttributes(A,S.attributes),this.setElementProps(A,S.props);let C="";S.description&&(C=`<p class="pops-panel-item-left-desc-text">${S.description}</p>`),A.innerHTML=`
			<div class="pops-panel-item-left-text">
				<p class="pops-panel-item-left-main-text">${S.text}</p>
			${C}
			</div>
			...
			`;const U={[Symbol.toStringTag]:"PopsPanelDeepMenu",$ele:{get parentSection(){return w.$el.$contentSectionContainer}},init(){this.setLiClickEvent();},initFormItem(_,L){let $=L;if($.type==="forms"){let I=$.forms,P=document.createElement("li"),H=document.createElement("ul");H.classList.add("pops-panel-forms-container-item-formlist"),P.classList.add("pops-panel-forms-container-item");let z=popsDOMUtils.createElement("div",{className:"pops-panel-forms-container-item-header-text"});z.innerHTML=$.text,$.isFold&&(z.innerHTML=`
								<p>${$.text}</p>
							...
							`,popsDOMUtils.on(z,"click",D=>{P.hasAttribute("data-fold-enable")?P.removeAttribute("data-fold-enable"):P.setAttribute("data-fold-enable","");}),z.classList.add("pops-panel-forms-fold-container"),z.classList.add("pops-user-select-none"),P.setAttribute("data-fold-enable",""),P.classList.add("pops-panel-forms-fold")),P.appendChild(z),w.setElementClassName(P,L.className),w.setElementAttributes(P,L.attributes),w.setElementProps(P,L.props),I.forEach(D=>{w.uListContainerAddItem(D,{ulElement:H,sectionContainerULElement:w.sectionContainerULElement,formContainerListElement:P,formHeaderDivElement:z});}),P.appendChild(H),_.appendChild(P),typeof $.afterAddToUListCallBack=="function"&&$.afterAddToUListCallBack(S,{target:P,ulElement:H,sectionContainerULElement:w.sectionContainerULElement,formContainerListElement:P,formHeaderDivElement:z});}else w.uListContainerAddItem(S,{ulElement:w.sectionContainerULElement});},gotoDeepMenu(_,L){var V,K;let $=L.closest("section.pops-panel-container");$&&popsDOMUtils.cssHide($,true);let I=popsDOMUtils.createElement("section",{className:"pops-panel-container pops-panel-deepMenu-container"}),P=popsDOMUtils.createElement("ul",{className:"pops-panel-deepMenu-container-header-ul"}),H=popsDOMUtils.createElement("ul"),z=S.headerTitle??S.text,D=popsDOMUtils.createElement("div",{className:"pops-panel-deepMenu-container-header",innerHTML:`<p>${z}</p>`}),G=popsDOMUtils.createElement("i",{className:"pops-panel-deepMenu-container-left-arrow-icon",innerHTML:pops.config.iconSVG.arrowLeft});if(popsDOMUtils.on(G,"click",void 0,Y=>{Y==null||Y.preventDefault(),Y==null||Y.stopPropagation();let Z=I.previousElementSibling;popsDOMUtils.cssShow(Z),I.remove();},{once:true}),(V=D.firstElementChild)==null||V.insertAdjacentElement("beforebegin",G),P.appendChild(D),I.appendChild(P),I.appendChild(H),S.forms&&Array.isArray(S.forms))for(let Y=0;Y<S.forms.length;Y++){let Z=S.forms[Y];this.initFormItem(H,Z);}(K=w.$el.$content)==null||K.appendChild(I),typeof S.afterEnterDeepMenuCallBack=="function"&&S.afterEnterDeepMenuCallBack(S,{sectionContainer:I,sectionContainerHeaderContainer:P,sectionContainerHeader:D,sectionBodyContainer:H});},setLiClickEvent(){popsDOMUtils.on(A,"click",void 0,async _=>{typeof S.clickCallBack=="function"&&await S.clickCallBack(_,S)||this.gotoDeepMenu(_,A);});}};return U.init(),A["data-deepMenu"]=U,A},createSectionContainerItem_own(S){let w=document.createElement("li");return w.__formConfig__=S,S.className&&(w.className=S.className),w=S.getLiElementCallBack(w),w},createSectionContainerItem(S){let w=S.type;if(w==="switch")return this.createSectionContainerItem_switch(S);if(w==="slider")return this.createSectionContainerItem_slider_new(S);if(w==="input")return this.createSectionContainerItem_input(S);if(w==="textarea")return this.createSectionContainerItem_textarea(S);if(w==="select")return this.createSectionContainerItem_select(S);if(w==="select-multiple")return this.createSectionContainerItem_select_multiple_new(S);if(w==="button")return this.createSectionContainerItem_button(S);if(w==="deepMenu")return this.createSectionContainerItem_deepMenu(S);if(w==="own")return this.createSectionContainerItem_own(S);console.error("尚未实现的type类型",S);},createSectionContainerItem_forms(S){let w=this,A=S;if(A.type==="forms"){let C=S.forms,T=document.createElement("li"),E=document.createElement("ul");E.classList.add("pops-panel-forms-container-item-formlist"),T.classList.add("pops-panel-forms-container-item");let k=popsDOMUtils.createElement("div",{className:"pops-panel-forms-container-item-header-text"});k.innerHTML=A.text,A.isFold&&(k.innerHTML=`
						<p>${A.text}</p>
						<i class="pops-panel-forms-fold-container-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
								<path d="M340.864 149.312a30.592 30.592 0 0 0 0 42.752L652.736 512 340.864 831.872a30.592 30.592 0 0 0 0 42.752 29.12 29.12 0 0 0 41.728 0L714.24 534.336a32 32 0 0 0 0-44.672L382.592 149.376a29.12 29.12 0 0 0-41.728 0z"></path>
			...
			</div>`,"",U),H=PopsElementHandler.parseElement(P),{popsElement:z,headerCloseBtnElement:D,titleElement:G,contentElement:V,contentAsideElement:K,contentSectionContainerElement:Y}=PopsHandler.handleQueryElement(H,C);(T.isMobile||pops.isPhone())&&popsDOMUtils.addClassName(z,T.mobileClassName);let Z=null,ot=[H];if(T.mask.enable){let{maskElement:et}=PopsHandler.handleMask({type:C,guid:A,config:T,animElement:H,maskHTML:_});Z=et,ot.push(Z);}let X=PopsHandler.handleEventDetails(A,E,k,C,H,z,Z,T);return PopsHandler.handleClickEvent("close",D,X,T.btn.close.callback),popsDOMUtils.append(k,ot),typeof T.beforeAppendToPageCallBack=="function"&&T.beforeAppendToPageCallBack(k,E),popsDOMUtils.appendBody(E),Z!=null&&H.after(Z),PanelHandleContentDetails().init({config:T,$el:{$content:V,$contentAside:K,$contentSectionContainer:Y}}),PopsHandler.handlePush(C,{guid:A,animElement:H,popsElement:z,maskElement:Z,$shadowContainer:E,$shadowRoot:k}),T.drag&&PopsInstanceUtils.drag(z,{dragElement:G,limit:T.dragLimit,extraDistance:T.dragExtraDistance,moveCallBack:T.dragMoveCallBack,endCallBack:T.dragEndCallBack}),PopsHandler.handleResultDetails(X)}};const rightClickMenuConfig=()=>({target:document.documentElement,targetSelector:null,data:[{icon:pops.config.iconSVG.search,iconIsLoading:false,text:"搜索",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:pops.config.iconSVG.documentCopy,iconIsLoading:false,text:"复制",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:pops.config.iconSVG.delete,text:"删除",iconIsLoading:false,item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:pops.config.iconSVG.loading,iconIsLoading:true,text:"加载",item:[],callback(S,w,A){return console.log("点击："+this.text,[S,w,A]),false}},{icon:pops.config.iconSVG.elemePlus,iconIsLoading:true,text:"饿了么",callback(S,w,A){return console.log("点击："+this.text,[S,w,A]),false},item:[{icon:"",iconIsLoading:false,text:"处理文件",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:"",iconIsLoading:false,text:"其它处理",callback(S,w,A){console.log("点击："+this.text,[S,w,A]);},item:[{icon:pops.config.iconSVG.view,iconIsLoading:false,text:"查看",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}}]}]}],useShadowRoot:true,className:"",isAnimation:true,only:false,zIndex:1e4,preventDefault:true,style:null,beforeAppendToPageCallBack(){}});class PopsRightClickMenu{constructor(w){const A=popsUtils.getRandomGUID(),C="rightClickMenu";let T=rightClickMenuConfig();if(T=popsUtils.assign(T,GlobalConfig.getGlobalConfig()),T=popsUtils.assign(T,w),T=PopsHandler.handleOnly(C,T),T.target==null)throw "config.target 不能为空";w.data&&(T.data=w.data);const{$shadowContainer:E,$shadowRoot:k}=PopsHandler.handlerShadow(T);if(PopsHandler.handleInit(k,[pops.config.cssText.index,pops.config.cssText.anim,pops.config.cssText.common,pops.config.cssText.rightClickMenu]),T.style!=null){let _=document.createElement("style");_.setAttribute("type","text/css"),_.innerHTML=T.style,k.appendChild(_);}const U={rootElement:null,windowCheckClickEvent(_){if(!U.rootElement)return;let L=_.target;L.closest(`.pops-${C}`)||L.className&&L.className==="pops-shadow-container"&&L.shadowRoot!=null||U.closeAllMenu(U.rootElement);},shadowRootCheckClickEvent(_){!U.rootElement||_.target.closest(`.pops-${C}`)||U.closeAllMenu(U.rootElement);},addWindowCheckClickListener(){if(popsDOMUtils.on(globalThis,"click touchstart",void 0,U.windowCheckClickEvent,{capture:true}),T.target instanceof Node){const _=T.target.getRootNode();_ instanceof ShadowRoot&&popsDOMUtils.on(_,"click touchstart",void 0,U.shadowRootCheckClickEvent,{capture:true});}},removeWindowCheckClickListener(){if(popsDOMUtils.off(globalThis,"click touchstart",void 0,U.windowCheckClickEvent,{capture:true}),T.target instanceof Node){const _=T.target.getRootNode();_ instanceof ShadowRoot&&popsDOMUtils.off(_,"click touchstart",void 0,U.windowCheckClickEvent,{capture:true});}},contextMenuEvent(_){T.preventDefault&&popsDOMUtils.preventEvent(_),PopsHandler.handleOnly(C,T),U.rootElement&&U.closeAllMenu(U.rootElement);let L=U.showMenu(_,T.data);U.rootElement=L,T.only&&PopsHandler.handlePush(C,{$shadowRoot:k,$shadowContainer:E,guid:A,animElement:L,popsElement:L,beforeRemoveCallBack($){U.closeAllMenu($.popsElement);}});},addContextMenuEvent(_,L){popsDOMUtils.on(_,"contextmenu",L,U.contextMenuEvent);},removeContextMenuEvent(_,L){popsDOMUtils.off(_,"contextmenu",L,U.contextMenuEvent);},animationCloseMenu(_){function L($){popsDOMUtils.off(_,popsDOMUtils.getTransitionEndNameList(),void 0,L,{capture:true}),_.remove();}_.classList.contains(`pops-${C}-anim-show`)?(popsDOMUtils.on(_,popsDOMUtils.getTransitionEndNameList(),void 0,L,{capture:true}),_.classList.remove(`pops-${C}-anim-show`)):_.remove();},closeAllMenu(_){var $,I;if(_==null)return;($=_==null?void 0:_.__menuData__)!=null&&$.root&&(_=(I=_==null?void 0:_.__menuData__)==null?void 0:I.root),_.__menuData__.child.forEach(P=>{this.animationCloseMenu(P);}),this.animationCloseMenu(_),U.rootElement=null;},getMenuContainerElement(_){let L=popsDOMUtils.createElement("div",{className:`pops-${C}`,innerHTML:`
					<ul></ul>
					`}),$=this.getMenuZIndex();return $>1e4&&(L.style.zIndex=$.toString()),_&&L.setAttribute("is-children","true"),T.isAnimation&&popsDOMUtils.addClassName(L,`pops-${C}-anim-grid`),L},getMenuZIndex(){return PopsHandler.handleZIndex(T.zIndex)},getOffset(_,L,$){let I=popsDOMUtils.width(_),P=popsDOMUtils.height(_),H=popsDOMUtils.width(globalThis)-I-1,z=popsDOMUtils.height(globalThis)-P-8,D=L,G=$;return D=D<0?0:D,D=D<H?D:H,G=G<0?0:G,G=G<z?G:z,{left:D,top:G}},showMenu(_,L){let $=this.getMenuContainerElement(false);Reflect.set($,"__menuData__",{child:[]}),U.addMenuLiELement(_,$,$,L),popsDOMUtils.css($,{display:"none"}),popsDOMUtils.append(k,$),document.contains(E)||(typeof T.beforeAppendToPageCallBack=="function"&&T.beforeAppendToPageCallBack(k,E),popsDOMUtils.appendBody(E));let{left:I,top:P}=this.getOffset($,_.clientX,_.clientY);return popsDOMUtils.css($,{left:I,top:P,display:""}),T.isAnimation&&popsDOMUtils.addClassName($,`pops-${C}-anim-show`),$},showClildMenu(_,L,$,I,P){let H=this.getMenuContainerElement(true);Reflect.set(H,"__menuData__",{parent:P,root:I}),Reflect.get(I,"__menuData__").child.push(H),U.addMenuLiELement(_,I,H,$),popsDOMUtils.css(H,{display:"none"}),popsDOMUtils.append(k,H);let{left:D,top:G}=this.getOffset(H,L.clientX,L.clientY);return popsDOMUtils.css(H,{left:D,top:G,display:""}),T.isAnimation&&popsDOMUtils.addClassName(H,`pops-${C}-anim-show`),H},addMenuLiELement(_,L,$,I){let P=_.target,H=$.querySelector("ul");I.forEach(z=>{let D=popsUtils.parseTextToDOM("<li></li>");if(typeof z.icon=="string"&&z.icon.trim()!==""){let K=pops.config.iconSVG[z.icon]??z.icon,Y=popsUtils.parseTextToDOM(`<i class="pops-${C}-icon" is-loading="${z.iconIsLoading}">${K}</i>`);D.appendChild(Y);}D.insertAdjacentHTML("beforeend",`<span>${z.text}</span>`),z.item&&Array.isArray(z.item)&&popsDOMUtils.addClassName(D,`pops-${C}-item`);function G(){Array.from(H.children).forEach(Z=>{if(popsDOMUtils.removeClassName(Z,`pops-${C}-is-visited`),!Z.__menuData__)return;function ot(X){X.querySelectorAll("ul li").forEach(Q=>{var et;(et=Q==null?void 0:Q.__menuData__)!=null&&et.child&&ot(Q.__menuData__.child);}),X.remove();}ot(Z.__menuData__.child);});for(let Z=0;Z<L.__menuData__.child.length;Z++){let ot=L.__menuData__.child[Z];k.contains(ot)||(L.__menuData__.child.splice(Z,1),Z--);}if(popsDOMUtils.addClassName(D,`pops-${C}-is-visited`),!z.item)return;let K=D.getBoundingClientRect(),Y=U.showClildMenu(_,{clientX:K.left+popsDOMUtils.outerWidth(D),clientY:K.top},z.item,L,D);D.__menuData__={child:Y};}async function V(K){if(typeof z.callback=="function"){OriginPrototype.Object.defineProperty(_,"target",{get(){return P}});let Y=await z.callback(K,_,D);if(typeof Y=="boolean"&&Y==false)return}Array.from(H.children).forEach(Y=>{popsDOMUtils.off(Y,"mouseenter touchstart");}),U.closeAllMenu(L);}popsDOMUtils.on(D,"mouseenter touchstart",void 0,G),popsDOMUtils.on(D,"click",void 0,V),H.appendChild(D);});}};return U.addContextMenuEvent(T.target,T.targetSelector),U.addWindowCheckClickListener(),{guid:A,config:T,removeWindowCheckClickListener:U.removeWindowCheckClickListener,addWindowCheckClickListener:U.addWindowCheckClickListener,removeContextMenuEvent:U.removeContextMenuEvent,addContextMenuEvent:U.addContextMenuEvent}}}const searchSuggestionConfig=()=>({target:null,inputTarget:null,selfDocument:document,data:[{value:"数据1",text:"数据1-html"},{value:"数据2",text:"数据2-html"}],deleteIcon:{enable:true,callback(S,w,A){console.log("删除当前项",[S,w,A]),w.remove();}},useShadowRoot:true,className:"",isAbsolute:true,isAnimation:true,width:"250px",maxHeight:"300px",followTargetWidth:true,topDistance:0,position:"auto",positionTopToReverse:true,zIndex:1e4,searchingTip:"正在搜索中...",toSearhNotResultHTML:'<li data-none="true">暂无其它数据</li>',toHideWithNotResult:false,followPosition:"target",getItemHTML(S){return S.text??S},async getData(S){return console.log("当前输入框的值是：",S),[]},itemClickCallBack(S,w,A){console.log("item项的点击回调",[S,w,A]),this.inputTarget.value=A.value;},selectCallBack(S,w,A){console.log("item项的选中回调",[S,w,A]);},style:""});class PopsSearchSuggestion{constructor(w){const A=popsUtils.getRandomGUID(),C="searchSuggestion";let T=searchSuggestionConfig();if(T=popsUtils.assign(T,GlobalConfig.getGlobalConfig()),T=popsUtils.assign(T,w),T.target==null)throw new TypeError("config.target 不能为空");T.inputTarget==null&&(T.inputTarget=T.target),w.data&&(T.data=w.data);const{$shadowContainer:E,$shadowRoot:k}=PopsHandler.handlerShadow(T);if(PopsHandler.handleInit(k,[pops.config.cssText.index,pops.config.cssText.anim,pops.config.cssText.common]),T.style!=null){let _=document.createElement("style");_.setAttribute("type","text/css"),_.innerHTML=T.style,k.appendChild(_);}const U={selfDocument:T.selfDocument,$el:{root:null,$hintULContainer:null,$dynamicCSS:null},$data:{isEmpty:true},init(_=document.body||document.documentElement){this.initEl(),U.update(typeof T.data=="function"?T.data():T.data),U.updateDynamicCSS(),U.changeHintULElementWidth(),U.changeHintULElementPosition(),U.hide(),T.isAnimation&&U.$el.root.classList.add(`pops-${C}-animation`),k.appendChild(U.$el.root),_.appendChild(E);},initEl(){this.$el.root=U.getSearchSelectElement(),this.$el.$dynamicCSS=this.$el.root.querySelector("style[data-dynamic]"),this.$el.$hintULContainer=U.$el.root.querySelector("ul");},getSearchSelectElement(){let _=popsDOMUtils.createElement("div",{className:`pops pops-${C}-search-suggestion`,innerHTML:`
						...
						<ul class="pops-${C}-search-suggestion-hint">
         				 ...
         				 `},{"data-guid":A,"type-value":C});return T.className!==""&&T.className!=null&&popsDOMUtils.addClassName(_,T.className),_},getDynamicCSS(){return `
				.pops-${C}-animation{
...
`)}{display: none !important;}`)},setGMResourceCSS(S){let w=typeof _GM_getResourceText=="function"?_GM_getResourceText(S.keyName):"";typeof w=="string"&&w?addStyle(w):CommonUtil.addLinkNode(S.url);},async addLinkNode(S){let w=document.createElement("link");return w.rel="stylesheet",w.type="text/css",w.href=S,domUtils.ready(()=>{document.head.appendChild(w);}),w},fixUrl(S){return S=S.trim(),S.match(/^http(s|):\/\//i)||(S.startsWith("/")||(S+="/"),S=window.location.origin+S),S},escapeHtml(S){return S.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},getTampoerMonkeyApiUrl(S,w){return w=w??S,`<a href="https://www.tampermonkey.net/documentation.php?ext=gcal&version=#api:${S}" target="_blank">${w}</a>`}},GlobalUtil={getWindow(){return GMTotal.unsafeWindow.isSupport()?_unsafeWindow:window}};class TestUIBase{}class ApiTestBase extends TestUIBase{isSupportGM(){return typeof _GM=="object"&&_GM!=null}}class ApiAsyncTestBase extends ApiTestBase{}class ApiTest_addElement extends ApiAsyncTestBase{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof _GM.addElement=="function"}}isSupport(){return typeof _GM_addElement=="function"}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{let T=null,E=null;try{let k=GlobalUtil.getWindow(),U=w+"_test_script_exec";return T=_GM_addElement("script",{id:U,textContent:'window.GM_addElement_test_str = "bar";'}),E=document.querySelector("#"+U),T==null?{text:"GM_addElement is not retrun element",tag:"error"}:typeof k.GM_addElement_test_str!="string"?{text:"GM_addElement script element is not work",tag:"error"}:(Reflect.deleteProperty(k,"GM_addElement_test_str"),{text:CommonUtil.escapeHtml("支持添加<script>元素且执行js"),tag:"success"})}catch(k){return console.error(k),{text:"执行错误 "+k,tag:"error"}}finally{E==null||E.remove();}}),UIInfo(()=>{let T=null,E=null;try{let k="GM_addElement_test2";if(T=_GM_addElement(document.body,"div",{"data-src":"https://example.com/image.png",id:k}),E=document.querySelector("#"+k),!E)return {text:"不支持3个参数",tag:"error"};const U=E.attachShadow({mode:"closed"});return _GM_addElement(U,"style",{textContent:"div { color: black; };"}),U.querySelector("style")?T==null?{text:"传入3个参数但是返回为空",tag:"error"}:E.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(k){return console.error(k),{text:"执行错误 "+k,tag:"error"}}finally{E==null||E.remove();}})),C}}class ApiTest_addStyle extends ApiAsyncTestBase{isSupport(){return typeof _GM_addStyle=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof _GM.addStyle=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-GM_addStyle"+w,title:w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{let T=null,E=null;try{return T=domUtils.createElement("div",{id:w,innerText:w+" test"}),document.body.appendChild(T),E=_GM_addStyle(`
                        ...
                        `),E==null?{text:w+" returns is null",tag:"error"}:window.getComputedStyle(T).backgroundColor!=="rgb(255, 0, 0)"?{text:w+" test element background is not rgb(255, 0, 0)",tag:"error"}:{text:CommonUtil.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}}catch(k){return console.error(k),{text:"执行错误 "+k,tag:"error"}}finally{T==null||T.remove(),E==null||E.remove();}})),C}}class ApiTest_addValueChangeListener extends ApiAsyncTestBase{isSupport(){return typeof _GM_addValueChangeListener=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof _GM.addValueChangeListener=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push((()=>{let T=w+"_key_1";return UIInfo(()=>({text:"测试监听数据存储改变",description:"",tag:"info",afterRender(E){let k=domUtils.parseHTML(`
									...
									`,false,false);domUtils.after(k.$leftContainer,U),domUtils.on(U,"click",_=>{utils.preventEvent(_);try{_GM_setValue(T,E),_GM_deleteValue(T);let L=_GM_getValue(T);typeof L=="object"&&L===null?qmsg.error("该值未删除，读取的值："+L):qmsg.success("成功删除该值");}catch(L){qmsg.error(L.toString(),{consoleLogContent:true});}});}}))})()),C}}class ApiTest_deleteValues extends ApiAsyncTestBase{isSupport(){return typeof _GM_deleteValues=="function"}getApiName(){return "GM_deleteValues"}getAsyncApiOption(){return {name:"GM.deleteValues",isSupport:this.isSupportGM()&&typeof _GM.deleteValues=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push((()=>{let T={GM_deleteValues_key_1:555,"GM.deleteValues_key_2":666};return UIInfo(()=>({text:"测试存储对象然后删除再读取",description:`${JSON.stringify(T)}`,tag:"info",afterRender(E){let k=domUtils.parseHTML(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);domUtils.after(T.$leftContainer,E);let k;domUtils.on(E,"click",U=>{utils.preventEvent(U),domUtils.text(T.$leftDesc,this.text),domUtils.show(T.$leftDesc,false);try{clearTimeout(k),qmsg.info("等待3s内触发成功复制的回调"),k=setTimeoutLog(()=>{TagUtil.setTag(T.$leftText,"error","不支持触发回调函数");},3e3),_GM_getTab(_=>{clearTimeout(k),typeof _=="object"&&_!=null?TagUtil.setTagList(T.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"success",text:"入参tab为object类型"}]):TagUtil.setTagList(T.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"error",text:"入参tab不为object类型"}]);});}catch(_){qmsg.error(_.toString(),{consoleLogContent:true});}});}}))),C}}class ApiTest_getTabs extends ApiAsyncTestBase{isSupport(){return typeof _GM_getTabs=="function"}getApiName(){return "GM_getTabs"}getAsyncApiOption(){return {name:"GM.getTabs",isSupport:this.isSupportGM()&&typeof _GM.getTabs=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_getValue extends ApiAsyncTestBase{isSupport(){return typeof _GM_getValue=="function"}getApiName(){return "GM_getValue"}getAsyncApiOption(){return {name:"GM.getValue",isSupport:this.isSupportGM()&&typeof _GM.getValue=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(...[{key:"Test GM_getValue boolean",value:true,text:function(){return "存储boolean类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue number",value:1,text:function(){return "存储number类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue string",value:"测试字符串",text:function(){return "存储string类型并读取"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:"Test GM_getValue undefined",value:void 0,text:function(){return "存储undefined类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue null",value:null,text:function(){return "存储object类型的null并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue object",value:{"object key":"object value"},text:function(){return "存储object类型并读取"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(T=>(()=>{let E=T.key,k=T.value;return UIInfo(()=>({text:T.text(),description:T.desc(),tag:"info",afterRender(U){let _=domUtils.parseHTML(`
									...
									`,false,false);domUtils.after(U.$leftContainer,_),domUtils.on(_,"click",L=>{utils.preventEvent(L);try{_GM_setValue(E,k);let $=_GM_getValue(E);if(typeof $==typeof k){if(k===null&&k!=$){qmsg.error("读取成功，但存储类型和读取类型不同，存储类型为null，但读取类型不为null");return}qmsg.success("读取成功，存储类型和读取类型一致");}else qmsg.error("读取成功，但存储类型和读取类型不同");}catch($){qmsg.error($.toString(),{consoleLogContent:true});}});}}))})()),(()=>{let T="Test GM_getValue null with defaultValue",E=123;return UIInfo(()=>({text:"存储object类型的null，读取时指定默认值为"+E,description:`GM_getValue("${T}", ${E})`,tag:"info",afterRender(k){let U=domUtils.parseHTML(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);domUtils.after(k.$leftContainer,U),domUtils.on(U,"click",_=>{utils.preventEvent(_);try{_GM_setValue(T,null);let L=_GM_getValue(T,E);typeof L=="object"&&L==null?qmsg.success("读取的值是存储的值："+L):qmsg.error("读取的值不是存储的值："+L);}catch(L){qmsg.error(L.toString(),{consoleLogContent:true});}});}}))})(),(()=>{let T="Test GM_getValue defaultValue",E=123;return UIInfo(()=>({text:"不存储，测试调用默认值",description:`GM_getValue("${T}", ${E})`,tag:"info",afterRender(k){let U=domUtils.parseHTML(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);domUtils.after(k.$leftContainer,U),domUtils.on(U,"click",_=>{utils.preventEvent(_);try{let L=_GM_getValue(T,E);typeof L==typeof E?qmsg.success("读取的值是默认值："+L):qmsg.error("读取的值不是默认值："+L);}catch(L){qmsg.error(L.toString(),{consoleLogContent:true});}});}}))})()),C}}class ApiTest_getValues extends ApiAsyncTestBase{isSupport(){return typeof _GM_getValues=="function"}getApiName(){return "GM_getValues"}getAsyncApiOption(){return {name:"GM.getValues",isSupport:this.isSupportGM()&&typeof _GM.getValues=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>({text:"测试直接读取",description:"没有入参",tag:"info",afterRender(T){let E=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);domUtils.after(T.$leftContainer,E),domUtils.on(E,"click",k=>{utils.preventEvent(k);try{let U=_GM_getValues();qmsg.info("请在控制台查看读取的数据"),console.log(U);}catch(U){qmsg.error(U.toString(),{consoleLogContent:true});}});}})),UIInfo(()=>{let T={"GM_getValues-test-key-non-exists-1":1111,"GM_getValues-test-key-non-exists-2":2222};return {text:"测试读取不存在的数据",description:"数据默认值："+JSON.stringify(T),tag:"info",afterRender(E){let k=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);domUtils.on(k,"click",U=>{utils.preventEvent(U);try{_GM_log(T);}catch(_){qmsg.error(_.toString(),{consoleLogContent:!0});}}),domUtils.after(E.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_notification extends ApiAsyncTestBase{isSupport(){return typeof _GM_notification=="function"}getApiName(){return "GM_notification"}getAsyncApiOption(){return {name:"GM.notification",isSupport:this.isSupportGM()&&typeof _GM.notification=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{let T,E,k=!1,U=!1,_=!1;return {text:"点击通知的内容用于测试函数是否生效",description:"",tag:"info",afterRender(L){T=L.target,E=L.$leftContainer;let $=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),I,P,H=utils.debounce(()=>{try{clearTimeout(I),clearInterval(P);let z="",D="success",G="",V="success";k?(z+="支持 onclick 函数",U?(z=z.trim(),z+="且支持提供 event 参数"):(z+="但是不支持提供 event 参数",D="warn")):(z+="不支持 onclick 函数",D="error"),_?G+="支持 ondone 函数":(G+="不支持 ondone 函数",V="error"),domUtils.html(L.$leftText,`
										<p class="${D}">${z}</p>
										<p class="${V}">${G}</p>
									`),k=!1,_=!1,U=!1;}catch(z){qmsg.error(z.toString(),{consoleLogContent:!0});}},800);domUtils.on($,"click",z=>{try{utils.preventEvent(z),clearTimeout(I),clearInterval(P);let D=10,G=D,V=()=>{let K=`正在等待触发回调，请在规定时间内点击弹窗的【关闭】按钮或者内容：${G}s`;return G--,K};domUtils.text(L.$leftText,V()),domUtils.text(L.$leftDesc,this.text),domUtils.show(L.$leftDesc,!1),I=setTimeoutLog(()=>{clearInterval(P),TagUtil.setTag(L.$leftText,"error","测试超时，未触发回调");},D*1e3),P=setInterval(()=>{domUtils.text(L.$leftText,V());},1e3),_GM_notification({title:"测试 GM_notification 标题",text:"测试 GM_notification 内容",url:"https:/example.com/",onclick:K=>{k=!0,K&&(U=!0,K.preventDefault()),H();},ondone(){_=!0,H();}});}catch(D){qmsg.error(D.toString(),{consoleLogContent:!0});}}),domUtils.after(E,$);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}}),UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("点击通知的内容跳转链接"),tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);domUtils.on(k,"click",U=>{utils.preventEvent(U);try{_GM_notification({title:"测试 GM_notification 标题",text:"测试 GM_notification 内容",url:"https:/example.com/"});}catch(_){qmsg.error(_.toString(),{consoleLogContent:!0});}}),domUtils.after(T.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}})),C}}class ApiTest_openInTab extends ApiAsyncTestBase{isSupport(){return typeof _GM_openInTab=="function"}getApiName(){return "GM_openInTab"}getAsyncApiOption(){return {name:"GM.openInTab",isSupport:this.isSupportGM()&&typeof _GM.openInTab=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:"后台打开：https://www.example.com/",tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									...
									`,!1,!1);domUtils.on(k,"click",U=>{try{utils.preventEvent(U),domUtils.text(T.$leftDesc,this.text),domUtils.show(T.$leftDesc,!1);let _=_GM_openInTab("https://www.example.com/");if(typeof _=="object")if(_==null)TagUtil.setTag(T.$leftText,"error","返回值为null");else {let L="close"in _&&typeof _.close=="function",$="closed"in _&&typeof _.closed=="boolean",I="onclose"in _;domUtils.html(T.$leftText,`
													${L?'<p class="success">支持 .close()</p>':'<p class="error">不支持 .close()</p>'}
													${$?'<p class="success">支持 .closed</p>':'<p class="error">不支持 .closed</p>'}
													${I?'<p class="success">支持设置属性 .onclose</p>':'<p class="error">不支持设置属性 .onclose</p>'}
										`);}else TagUtil.setTag(T.$leftText,"error","返回值不是对象："+typeof _);}catch(_){qmsg.error(_.toString(),{consoleLogContent:!0});}}),domUtils.after(T.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}}),UIInfo(()=>{try{return {text:"配置 active: true",description:"",tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),U;domUtils.on(k,"click",_=>{try{utils.preventEvent(_),clearTimeout(U),TagUtil.setTag(T.$leftText,"info","等待调用 .close()"),domUtils.text(T.$leftDesc,this.text),domUtils.show(T.$leftDesc,!1);let L=_GM_openInTab("https://www.example.com/");L&&typeof(L==null?void 0:L.close)=="function"?U=setTimeoutLog(()=>{try{L.close(),TagUtil.setTag(T.$leftText,"success","成功调用 .close()");}catch($){TagUtil.setTag(T.$leftText,"error","调用 .close() 方法失败 "+$);}},1e3):TagUtil.setTag(T.$leftText,"error","返回对象中不支持 .close() 方法");}catch(L){qmsg.error(L.toString(),{consoleLogContent:!0});}}),domUtils.after(T.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}}),UIInfo(()=>{try{return {text:"测试监听关闭是否生效 .onclose",tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
...
`));}catch(H){qmsg.error(H.toString(),{consoleLogContent:!0});}});}catch(L){qmsg.error(L.toString(),{consoleLogContent:!0});}});}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}}),UIInfo(()=>{try{return {text:"注册并更新菜单 ==> Test Update Menu",description:"请自行验证是否成功更新菜单文字为：Test Update Menu Success!!!",tag:"info",afterRender(T){let E=domUtils.parseHTML(`
								...
								`,!1,!1);domUtils.after(T.$leftContainer,E);let k;domUtils.on(E,"click",U=>{try{utils.preventEvent(U),clearTimeout(k);const _=_GM_registerMenuCommand("Test Update Menu",L=>{});qmsg.info("已注册菜单，3s后自动更新",{timeout:3e3}),clearTimeout(k),k=setTimeoutLog(()=>{_GM_registerMenuCommand("Test Update Menu Success!!!",()=>{},{id:_}),qmsg.success("已执行更新菜单命令，请自行验证");},3e3);}catch(_){qmsg.error(_.toString(),{consoleLogContent:!0});}});}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_removeValueChangeListener extends ApiAsyncTestBase{isSupport(){return typeof _GM_removeValueChangeListener=="function"}getApiName(){return "GM_removeValueChangeListener"}getAsyncApiOption(){return {name:"GM.removeValueChangeListener",isSupport:this.isSupportGM()&&typeof _GM.removeValueChangeListener=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push((()=>{let T=w+"_key_1";return UIInfo(()=>({text:"测试移除监听器",description:"",tag:"info",afterRender(E){let k=domUtils.parseHTML(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
							...
							`,false,false);domUtils.after(T.$leftContainer,E);let k;domUtils.on(E,"click",U=>{try{utils.preventEvent(U),clearTimeout(k),qmsg.info("等待3s内触发成功复制的回调"),k=setTimeoutLog(()=>{TagUtil.setTag(T.$leftText,"error","不支持触发回调函数");},3e3),_GM_setClipboard("Test GM_setClipboard","text",()=>{clearTimeout(k),TagUtil.setTag(T.$leftText,"success","支持触发回调函数");});}catch(_){qmsg.error(_.toString(),{consoleLogContent:true});}});}}))),C}}class ApiTest_setValue extends ApiAsyncTestBase{isSupport(){return typeof _GM_setValue=="function"}getApiName(){return "GM_setValue"}getAsyncApiOption(){return {name:"GM.setValue",isSupport:this.isSupportGM()&&typeof _GM.setValue=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${CommonUtil.getTampoerMonkeyApiUrl(w,`${w} & ${A.name}`)}`,scrollToDefaultView:true,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(...[{key:"Test GM_setValue boolean",value:true,text:function(){return "存储boolean类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue number",value:1,text:function(){return "存储number类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue string",value:"测试字符串",text:function(){return "存储string类型"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:"Test GM_setValue undefined",value:void 0,text:function(){return "存储undefined类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue null",value:null,text:function(){return "存储object类型的null"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue object",value:{"object key":"object value"},text:function(){return "存储object类型"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(T=>(()=>{let E=T.key,k=T.value;return UIInfo(()=>({text:T.text(),description:T.desc(),tag:"info",afterRender(U){let _=domUtils.parseHTML(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>

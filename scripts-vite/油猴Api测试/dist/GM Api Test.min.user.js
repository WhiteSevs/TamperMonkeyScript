...
`,Sa=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-type="arrowRight">\r
	<path\r
		d="M340.864 149.312a30.592 30.592 0 0 0 0 42.752L652.736 512 340.864 831.872a30.592 30.592 0 0 0 0 42.752 29.12 29.12 0 0 0 41.728 0L714.24 534.336a32 32 0 0 0 0-44.672L382.592 149.376a29.12 29.12 0 0 0-41.728 0z"></path>\r
</svg>\r
...
`;const W={index:us,ninePalaceGridPosition:bs,scrollbar:hs,button:ms,common:gs,anim:ys,alertCSS:xs,confirmCSS:ws,promptCSS:vs,loadingCSS:As,iframeCSS:Ss,tooltipCSS:Ts,drawerCSS:Cs,folderCSS:Es,panelCSS:ks,rightClickMenu:Ms},ot={$data:{},$flag:{isInit:false},init(){if(!this.$flag.isInit){this.$flag.isInit=true;const a=p.createElement("style",{innerHTML:W.anim});p.appendHead(a),this.$data=null,this.$data=p.getKeyFrames(a.sheet),U.setTimeout(()=>{a.remove();},50);}},hasAnim(a){return Object.prototype.hasOwnProperty.call(this.$data,a)}},me={alert:[],confirm:[],drawer:[],folder:[],iframe:[],loading:[],panel:[],prompt:[],rightClickMenu:[],tooltip:[]},be={getMaxZIndexNodeInfo(a=1,e=K.document,t){a=Number.isNaN(a)?1:a;const n=2*Math.pow(10,9);let r=0,o=null;function s(l){return l.position!=="static"&&l.display!=="none"}function i(l){if(typeof t=="function"){const f=t(l);if(typeof f=="boolean"&&!f)return}const c=K.window.getComputedStyle(l);if(s(c)){const f=parseInt(c.zIndex);isNaN(f)||f>r&&(r=f,o=l),l.shadowRoot!=null&&l instanceof ShadowRoot&&l.shadowRoot.querySelectorAll("*").forEach(d=>{i(d);});}}return e.querySelectorAll("*").forEach(l=>{i(l);}),r+=a,r>=n&&(r=n),{node:o,zIndex:r}},getPopsMaxZIndex(a=1){a=Number.isNaN(a)?1:a;const e=2*Math.pow(10,9);let t=0,n=null;function r(s){return s.position!=="static"&&s.display!=="none"}Object.keys(me).forEach(s=>{const i=me[s];for(let l=0;l<i.length;l++){const c=i[l],f=window.getComputedStyle(c.animElement);if(r(f)){const d=parseInt(f.zIndex);isNaN(d)||d>t&&(t=d,n=c.animElement);}}}),t+=a;const o=t>=e;return o&&(t=e),{zIndex:t,animElement:n,isOverMaxZIndex:o}},getMaxZIndex(a=1){return this.getMaxZIndexNodeInfo(a).zIndex},removeInstance(a,e,t=false){function n(r){typeof r.beforeRemoveCallBack=="function"&&r.beforeRemoveCallBack(r),r?.animElement?.remove(),r?.popsElement?.remove(),r?.maskElement?.remove(),r?.$shadowContainer?.remove();}return a.forEach(r=>{r.forEach((o,s)=>{if(t||o.guid===e){const i=o.animElement.getAttribute("anim");if(ot.hasAnim(i)){const l=i+"-reverse";o.animElement.style.width="100%",o.animElement.style.height="100%",o.animElement.style["animation-name"]=l,ot.hasAnim(o.animElement.style["animation-name"])?p.on(o.animElement,p.getAnimationEndNameList(),function(){n(o);},{capture:true}):n(o);}else n(o);r.splice(s,1);}});}),a},hide(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(a==="drawer"){const c=n;U.setTimeout(()=>{o.style.setProperty("display","none"),["top","bottom"].includes(c.direction)?i.style.setProperty("height","0"):["left","right"].includes(c.direction)?i.style.setProperty("width","0"):console.error("未知direction：",c.direction),s();},c.closeDelay);}else {const c=e.find(f=>f.guid===t);if(c){const f=c;if(f.animElement.style.width="100%",f.animElement.style.height="100%",Reflect.set(f.animElement.style,"animation-name",f.animElement.getAttribute("anim")+"-reverse"),ot.hasAnim(Reflect.get(f.animElement.style,"animation-name"))){let d=function(){f.animElement.style.display="none",f.maskElement&&(f.maskElement.style.display="none"),p.off(f.animElement,p.getAnimationEndNameList(),d,{capture:true}),s();};p.on(f.animElement,p.getAnimationEndNameList(),d,{capture:true});}else f.animElement.style.display="none",f.maskElement&&(f.maskElement.style.display="none"),s();}}})},show(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(a==="drawer"){const c=n;U.setTimeout(()=>{p.css(o,"display","");const f=c.direction,d=c.size.toString();["top","bottom"].includes(f)?i.style.setProperty("height",d):["left","right"].includes(f)?i.style.setProperty("width",d):console.error("未知direction：",f),s();},c.openDelay??0);}else {const c=e.find(f=>f.guid===t);if(c){const f=c;if(f.animElement.style.width="",f.animElement.style.height="",Reflect.set(f.animElement.style,"animation-name",f.animElement.getAttribute("anim").replace("-reverse","")),ot.hasAnim(Reflect.get(f.animElement.style,"animation-name"))){let d=function(){p.off(f.animElement,p.getAnimationEndNameList(),d,{capture:true}),s();};f.animElement.style.display="",f.maskElement&&(f.maskElement.style.display=""),p.on(f.animElement,p.getAnimationEndNameList(),d,{capture:true});}else f.animElement.style.display="",f.maskElement&&(f.maskElement.style.display=""),s();}}})},close(a,e,t,n,r){return new Promise(o=>{const s=r.querySelector(".pops[type-value]"),i=n;function l(){function c(d){d.propertyName==="transform"&&(p.off(s,p.getTransitionEndNameList(),void 0,c),be.removeInstance([e],t),o());}if(p.on(s,p.getTransitionEndNameList(),c),getComputedStyle(s).transform!=="none"){p.trigger(s,p.getTransitionEndNameList(),void 0,true);return}["top"].includes(i.direction)?s.style.setProperty("transform","translateY(-100%)"):["bottom"].includes(i.direction)?s.style.setProperty("transform","translateY(100%)"):["left"].includes(i.direction)?s.style.setProperty("transform","translateX(-100%)"):["right"].includes(i.direction)?s.style.setProperty("transform","translateX(100%)"):console.error("未知direction：",i.direction);}a==="drawer"?U.setTimeout(()=>{l();},i.closeDelay):(be.removeInstance([e],t),o());})},drag(a,e){e=Object.assign({limit:true,extraDistance:3,container:K.globalThis,triggerClick:true},e);let t=false,n=0,r=0;const o=U.AnyTouch(),s=new o(e.dragElement,{preventDefault(u){return typeof e.preventEvent=="function"?e.preventEvent(u):true}});p.css(e.dragElement,{cursor:"move"});function i(u){const m=u.style.transitionDuration;return globalThis.getComputedStyle(u).transitionDuration!=="0s"&&(u.style.transitionDuration="0s"),()=>{u.style.transitionDuration=m;}}function l(u){return u=u??globalThis,{width:p.width(u),height:p.height(u)}}function c(u){if(u=u??globalThis,U.isWin(u))return {left:0,top:0};{const m=u.getBoundingClientRect();return {left:m.left,top:m.top}}}let f=p.getTransform(a),d=null;s.on("pan",function(u){if(!t){t=true;const g=e.dragElement.getBoundingClientRect();n=u.x-g.left,r=u.y-g.top,f=p.getTransform(a),d=i(a);}let m=u.x-n+f.transformLeft,y=u.y-r+f.transformTop;if(u.phase==="move"){if(e.limit){const g=l(e.container).width-p.width(a)+f.transformLeft,{left:x,top:w}=c(e.container),A=l(e.container).height-p.height(a)+f.transformTop;m>g&&(m=g),y>A&&(y=A),m-e.extraDistance*2<x+f.transformLeft?(m=x+f.transformLeft,m+=e.extraDistance):m-=e.extraDistance,y-e.extraDistance*2<w+f.transformTop?(y=w+f.transformTop,y+=e.extraDistance):y-=e.extraDistance;}typeof e.moveCallBack=="function"&&e.moveCallBack(a,m,y),p.css(a,{left:m+"px",top:y+"px"});}u.phase==="end"&&(t=false,typeof d=="function"&&(d(),d=null),typeof e.endCallBack=="function"&&e.endCallBack(a,m,y));}),e.triggerClick&&s.on(["tap"],function(u){u.changedPoints.forEach(m=>{p.trigger(m.target,"click",void 0,true);});});},sortElementListByProperty(a,e,t=true){if(typeof t!="boolean")throw new TypeError("参数 sortByDesc 必须为boolean类型");if(a==null||e==null)throw new Error("获取前面的值或后面的值的方法不能为空");return function(n,r){const o=a(r),s=e(n);return t?s>o?-1:s<o?1:0:s<o?-1:s>o?1:0}}},I={handlerShadow(a){const e=p.createElement("div",{className:"pops-shadow-container"});if(a.useShadowRoot){const t=e.attachShadow({mode:"open"});return {$shadowContainer:e,$shadowRoot:t}}else return {$shadowContainer:e,$shadowRoot:e}},handleInit(a,e){if(ot.init(),!!arguments.length&&a!=null&&e!=null){if(typeof e=="string"){if(e.trim()==="")return;e=[{css:e}];}else e=e.map(t=>typeof t=="string"?{css:t}:t);for(const t of e){const n=p.createElement("style",{},{"data-type":"PopsHandler.handleInit"});n.textContent=t.css,typeof t.name=="string"&&n.setAttribute("data-name",t.name),a.appendChild(n);}}},handleMask(a={}){const e={maskElement:p.parseTextToDOM(a.maskHTML)};let t=false;function n(o){p.preventEvent(o);const s=me[a.type];function i(){if(a.config.mask.clickEvent.toClose)return be.close(a.type,s,a.guid,a.config,a.animElement);if(a.config.mask.clickEvent.toHide)return be.hide(a.type,s,a.guid,a.config,a.animElement,e.maskElement)}return typeof a.config.mask.clickCallBack=="function"?a.config.mask.clickCallBack(i,a.config):i(),false}if(a.config.mask.clickEvent.toClose||a.config.mask.clickEvent.toHide){let o=function(s){return !!(s?.localName?.toLowerCase()==="div"&&s.className&&s.className==="pops-anim"&&s.hasAttribute("anim"))};p.on(a.animElement,["touchstart","mousedown"],void 0,s=>{const i=s.composedPath()[0];t=o(i);}),p.on(a.animElement,"click",void 0,s=>{const i=s.composedPath()[0];if(o(i)&&t)return n(s)}),p.on(e.maskElement,"click",void 0,s=>{t=true,n(s);});}return e},handleQueryElement(a,e){return {$pops:a.querySelector(".pops[type-value"),$btnOk:a.querySelector(`.pops-${e}-btn-ok`),$btnCancel:a.querySelector(`.pops-${e}-btn-cancel`),$btnOther:a.querySelector(`.pops-${e}-btn-other`),$title:a.querySelector(`.pops-${e}-title`),$input:a.querySelector(`.pops-${e}-content textarea[pops]`)?a.querySelector(`.pops-${e}-content textarea[pops]`):a.querySelector(`.pops-${e}-content input[pops]`),$headerControls:a.querySelector(".pops-header-controls"),$iframe:a.querySelector("iframe[pops]"),$loading:a.querySelector(".pops-loading"),$content:a.querySelector(`.pops-${e}-content`),$panelRightSectionWrapper:a.querySelector(`.pops-${e}-section-wrapper`),$panelLeftAside:a.querySelector(`.pops-${e}-content aside.pops-${e}-aside`),$panelContentSectionContainer:a.querySelector(`.pops-${e}-content section.pops-${e}-container`),$panelBottomWrapper:a.querySelector(`.pops-${e}-bottom-wrapper`),$panelBottomContainer:a.querySelector(`.pops-${e}-bottom-container`),$panelBottomLeftContainer:a.querySelector(`.pops-${e}-bottom-left-container`),$panelBottomRightContainer:a.querySelector(`.pops-${e}-bottom-right-container`),$contentLoading:a.querySelector(`.pops-${e}-content-global-loading`),$headerBtnMin:a.querySelector(".pops-header-control[data-type='min']"),$headerBtnMax:a.querySelector(".pops-header-control[data-type='max']"),$headerBtnMise:a.querySelector(".pops-header-control[data-type='mise']"),$headerBtnClose:a.querySelector(".pops-header-control[data-type='close']"),$folderList:a.querySelector(".pops-folder-list"),$folderHeaderNav:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div"),$folderHeaderRow:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div .pops-folder-list-table__header-row"),$folderTbody:a.querySelector(".pops-folder-list .pops-folder-list-table__body-div tbody"),$folderHeaderBreadcrumbPrimary:a.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-primary"),$folderSortFileName:a.querySelector('.pops-folder-list-table__sort[data-sort="fileName"]'),$folderSortLatestTime:a.querySelector('.pops-folder-list-table__sort[data-sort="latestTime"]'),$folderSortFileSize:a.querySelector('.pops-folder-list-table__sort[data-sort="fileSize"]')}},handleEventDetails(a,e,t,n,r,o,s,i){return {$shadowContainer:e,$shadowRoot:t,element:r,animElement:r,popsElement:o,maskElement:s,mode:n,guid:a,close(){return be.close(n,me[n],a,i,r)},hide(){return be.hide(n,me[n],a,i,r,s)},show(){return be.show(n,me[n],a,i,r,s)}}},handleLoadingEventDetails(a,e,t,n,r,o){return {element:t,animElement:t,popsElement:n,maskElement:r,mode:e,guid:a,close(){return be.close(e,me[e],a,o,t)},hide(){return be.hide(e,me[e],a,o,t,r)},show(){return be.show(e,me[e],a,o,t,r)}}},handleResultDetails(a){const e=Object.assign({},a);return U.delete(e,"type"),U.delete(e,"function"),e},handleClickEvent(a,e,t,n){p.on(e,"click",r=>{n(Object.assign(t,{type:a}),r);},{capture:true});},handleKeyboardEvent(a,e=[],t){const n=function(r){const o=r.code||r.key,s=r.charCode||r.keyCode||r.which;e.includes("ctrl")&&!r.ctrlKey||e.includes("alt")&&!r.altKey||e.includes("meta")&&!r.metaKey||e.includes("shift")&&!r.shiftKey||(typeof a=="string"&&a===o?t&&t(r):typeof a=="number"&&a===s&&t&&t(r));};return p.on(K.globalThis,"keydown",n,{capture:true}),{removeKeyboardEvent(){p.off(globalThis,"keydown",n,{capture:true});}}},handlePromptClickEvent(a,e,t,n,r){p.on(t,"click",o=>{const s={type:a,text:e.value};r(Object.assign(n,s),o);},{capture:true});},handleZIndex(a){return typeof a=="function"?a():a},handleOnly(a,e){if(e.only)if(a==="loading"||a==="tooltip"||a==="rightClickMenu"){const t=me[a];t&&be.removeInstance([t],"",true);}else be.removeInstance([me.alert,me.confirm,me.prompt,me.iframe,me.drawer,me.folder,me.panel],"",true);else {const t=e.zIndex;e.zIndex=()=>{const{zIndex:n}=be.getPopsMaxZIndex(I.handleZIndex(t)+100);return n};}return e},handlePush(a,e){me[a].push(e);}},$s=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{position:"flex-end",ok:{size:void 0,enable:true,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback:function(a){a.close();}},close:{enable:true,callback:function(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),gr={init(a){const e=U.getRandomGUID(),t="alert";let n=$s();n=U.assign(n,ye.getGlobalConfig()),n=U.assign(n,a),n=I.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=I.handlerShadow(n);I.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"button",css:W.button},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"alertCSS",css:W.alertCSS}]);const s=I.handleZIndex(n.zIndex),i=J.createMask(e,s),l=J.createHeader(t,n),c=J.createBottom(t,n),{headerStyle:f,headerPStyle:d}=J.createHeaderStyle(t,n),{contentStyle:u,contentPStyle:m}=J.createContentStyle(t,n),y=J.createAnim(e,t,n,`
			...
			<div class="pops-content pops-${t}-content" style="${u}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${m}">${n.content.text}</p>`}</div>${c}`,c,s),g=J.parseElement(y),{$pops:x,$headerBtnClose:w,$btnOk:A,$title:k}=I.handleQueryElement(g,t);let C=null;const v=[g];n.mask.enable&&(C=I.handleMask({type:t,guid:e,config:n,animElement:g,maskHTML:i}).maskElement,v.push(C));const $=I.handleEventDetails(e,r,o,t,g,x,C,n);return I.handleClickEvent("close",w,$,n.btn.close.callback),I.handleClickEvent("ok",A,$,n.btn.ok.callback),p.append(o,v),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),C!=null&&g.after(C),I.handlePush(t,{guid:e,animElement:g,popsElement:x,maskElement:C,$shadowContainer:r,$shadowRoot:o}),n.drag&&be.drag(x,{dragElement:k,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),I.handleResultDetails($)}},Ls=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),Is={init(a){const e=U.getRandomGUID(),t="confirm";let n=Ls();n=U.assign(n,ye.getGlobalConfig()),n=U.assign(n,a),n=I.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=I.handlerShadow(n);I.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"button",css:W.button},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"confirmCSS",css:W.confirmCSS}]);const s=I.handleZIndex(n.zIndex),i=J.createMask(e,s),l=J.createHeader(t,n),c=J.createBottom(t,n),{headerStyle:f,headerPStyle:d}=J.createHeaderStyle(t,n),{contentStyle:u,contentPStyle:m}=J.createContentStyle(t,n),y=J.createAnim(e,t,n,`
            <div class="pops-title pops-${t}-title" style="text-align: ${n.title.position};${f}">${n.title.html?n.title.text:`<p pops class="pops-${t}-title-text" style="${d}">${n.title.text}</p>`}${l}</div>
                        <div class="pops-content pops-${t}-content" style="${u}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${m}">${n.content.text}</p>`}</div>${c}`,c,s),g=J.parseElement(y),{$pops:x,$title:w,$headerBtnClose:A,$btnOk:k,$btnCancel:C,$btnOther:v}=I.handleQueryElement(g,t);let $=null;const D=[g];n.mask.enable&&($=I.handleMask({type:t,guid:e,config:n,animElement:g,maskHTML:i}).maskElement,D.push($));const z=I.handleEventDetails(e,r,o,t,g,x,$,n);return I.handleClickEvent("close",A,z,n.btn.close.callback),I.handleClickEvent("ok",k,z,n.btn.ok.callback),I.handleClickEvent("cancel",C,z,n.btn.cancel.callback),I.handleClickEvent("other",v,z,n.btn.other.callback),p.append(o,D),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),$!=null&&g.after($),I.handlePush(t,{guid:e,animElement:g,popsElement:x,maskElement:$,$shadowContainer:r,$shadowRoot:o}),n.drag&&be.drag(x,{dragElement:w,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),I.handleResultDetails(z)}},_s=()=>({title:{enable:true,position:"center",text:"默认标题",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:null},useShadowRoot:true,class:"",zIndex:1e4,only:false,direction:"right",size:"30%",lockScroll:false,closeOnPressEscape:true,openDelay:0,closeDelay:0,borderRadius:0,style:null,beforeAppendToPageCallBack(){},forbiddenScroll:false}),Rs={init(a){const e=U.getRandomGUID(),t="drawer";let n=_s();n=U.assign(n,ye.getGlobalConfig()),n=U.assign(n,a),n=I.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=I.handlerShadow(n);I.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"button",css:W.button},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"drawerCSS",css:W.drawerCSS}]);const s=I.handleZIndex(n.zIndex),i=J.createMask(e,s),l=J.createHeader(t,n),c=J.createBottom(t,n),{headerStyle:f,headerPStyle:d}=J.createHeaderStyle(t,n),{contentStyle:u,contentPStyle:m}=J.createContentStyle(t,n),y=J.createAnim(e,t,n,`
            ...
            <div class="pops-content pops-${t}-content" style="${u}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${m}">${n.content.text}</p>`}</div>${c}`,c,s),g=J.parseElement(y),{$pops:x,$headerBtnClose:w,$btnCancel:A,$btnOk:k,$btnOther:C}=I.handleQueryElement(g,t),v=x,$=w,D=A,z=k,F=C;let X=null;const te=[g];n.mask.enable&&(X=I.handleMask({type:t,guid:e,config:n,animElement:g,maskHTML:i}).maskElement,te.push(X));const E=I.handleEventDetails(e,r,o,t,g,v,X,n);return v.setAttribute("direction",n.direction),n.direction==="top"?(v.style.setProperty("height","0"),v.style.setProperty("border-radius",`0px 0px ${n.borderRadius}px ${n.borderRadius}px`)):n.direction==="bottom"?(v.style.setProperty("height","0"),v.style.setProperty("border-radius",`${n.borderRadius}px ${n.borderRadius}px 0px 0px`)):n.direction==="left"?(v.style.setProperty("width","0"),v.style.setProperty("border-radius",`0px ${n.borderRadius}px 0px ${n.borderRadius}px`)):n.direction==="right"&&(v.style.setProperty("width","0"),v.style.setProperty("border-radius",`${n.borderRadius}px 0px ${n.borderRadius}px 0px`)),n.closeOnPressEscape&&I.handleKeyboardEvent("Escape",[],function(){E.close();}),[{type:"close",ele:$},{type:"cancel",ele:D},{type:"ok",ele:z},{type:"other",ele:F}].forEach(h=>{I.handleClickEvent(h.type,h.ele,E,S=>{typeof n.btn[h.type].callback=="function"&&n.btn[h.type].callback(S);});}),te.forEach(h=>{h.style.setProperty("display","none"),["top"].includes(n.direction)?(v.style.setProperty("height",n.size.toString()),v.style.setProperty("transform","translateY(-100%)")):["bottom"].includes(n.direction)?(v.style.setProperty("height",n.size.toString()),v.style.setProperty("transform","translateY(100%)")):["left"].includes(n.direction)?(v.style.setProperty("width",n.size.toString()),v.style.setProperty("transform","translateX(-100%)")):["right"].includes(n.direction)&&(v.style.setProperty("width",n.size.toString()),v.style.setProperty("transform","translateX(100%)")),h.style.setProperty("display","");}),p.append(o,te),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),U.setTimeout(()=>{U.setTimeout(()=>{v.style.setProperty("transform","");},n.openDelay);},50),X!=null&&g.after(X),I.handlePush(t,{guid:e,animElement:g,popsElement:v,maskElement:X,$shadowContainer:r,$shadowRoot:o}),I.handleResultDetails(E)}},Ns=()=>({parent:document.body,content:{text:"加载中...",icon:"loading",style:""},useShadowRoot:true,class:"",only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",forbiddenScroll:false,isAbsolute:false,style:null,addIndexCSS:true}),Wt={init(a){let e=Ns();e=U.assign(e,ye.getGlobalConfig()),e=U.assign(e,a);const t=U.getRandomGUID(),n="loading";e=I.handleOnly(n,e);const r=I.handleZIndex(e.zIndex),o=J.createMask(t,r),{contentPStyle:s}=J.createContentStyle("loading",e),i=J.createAnim(t,n,e,`
            ...
            </div>${m}`,m,f),w=J.parseElement(x),{$pops:A,$title:k,$content:C,$folderTbody:v,$folderHeaderBreadcrumbPrimary:$,$headerBtnClose:D,$btnOk:z,$btnCancel:F,$btnOther:X,$folderSortFileName:te,$folderSortLatestTime:E,$folderSortFileSize:L}=I.handleQueryElement(w,t);let T=null;const h=[w];n.mask.enable&&(T=I.handleMask({type:t,guid:e,config:n,animElement:w,maskHTML:d}).maskElement,h.push(T));const S=I.handleEventDetails(e,r,o,t,w,A,T,n);I.handleClickEvent("close",D,S,n.btn.close.callback),I.handleClickEvent("ok",z,S,n.btn.ok.callback),I.handleClickEvent("cancel",F,S,n.btn.cancel.callback),I.handleClickEvent("other",X,S,n.btn.other.callback),p.append(o,h),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),T!=null&&w.after(T);class P{init(){n.folder.sort(),this.initFolderView(n.folder);const V=$.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-allFiles:first-child");Reflect.set(V,"_config_",n.folder),p.on(V,"click",R=>{this.setBreadcrumbClickEvent(R,true,n.folder);}),p.on(te.closest("th"),"click",R=>{this.arrowToSortFolderInfoView(te,R,"fileName");},{capture:true}),p.on(E.closest("th"),"click",R=>{this.arrowToSortFolderInfoView(E,R,"latestTime");},{capture:true}),p.on(L.closest("th"),"click",R=>{this.arrowToSortFolderInfoView(L,R,"fileSize");},{capture:true}),n.sort.name==="fileName"?p.trigger(te,"click",{notChangeSortRule:true}):n.sort.name==="latestTime"?p.trigger(E,"click",{notChangeSortRule:true}):n.sort.name==="fileSize"&&p.trigger(L,"click",{notChangeSortRule:true});}createFolderRowElement(V,R="-",j="-",ee=false){const Y=V,oe=R,ge=j,xe=p.createElement("tr"),he=p.createElement("td"),pe=p.createElement("td"),Me=p.createElement("td");let et="",Oe=ce.folder;if(ee)R="",j="";else {Oe="",typeof R=="number"&&(R=U.formatTime(R)),typeof j=="number"&&(j=U.formatByteToSize(j));for(const Nt in ce)if(V.toLowerCase().endsWith("."+Nt)){et=Nt,Oe=ce[Nt];break}Oe||(et="Null",Oe=ce.Null);}xe.className="pops-folder-list-table__body-row",he.className="pops-folder-list-table__body-td",pe.className="pops-folder-list-table__body-td",Me.className="pops-folder-list-table__body-td",ne.setSafeHTML(he,`
            ...
            `),ne.setSafeHTML(pe,`
				...
				`);const gt={fileName:Y,latestTime:oe,fileSize:ge,isFolder:ee};return Reflect.set(he,"__value__",gt),Reflect.set(pe,"__value__",gt),Reflect.set(Me,"__value__",gt),Reflect.set(xe,"__value__",gt),xe.appendChild(he),xe.appendChild(pe),xe.appendChild(Me),{folderElement:xe,fileNameElement:he,fileTimeElement:pe,fileFormatSize:Me}}createFolderRowElementByMobile(V,R="-",j="-",ee=false){const Y=V,oe=R,ge=j,xe=p.createElement("tr"),he=p.createElement("td");let pe="",Me=ce.folder;if(ee)R="",j="";else {Me="",typeof R=="number"&&(R=U.formatTime(R)),typeof j=="number"&&(j=U.formatByteToSize(j));for(const Oe in ce)if(V.toLowerCase().endsWith("."+Oe)){pe=Oe,Me=ce[Oe];break}Me||(pe="Null",Me=ce.Null);}xe.className="pops-folder-list-table__body-row",he.className="pops-folder-list-table__body-td",ne.setSafeHTML(he,`
			...
			`);const et={fileName:Y,latestTime:oe,fileSize:ge,isFolder:ee};return Reflect.set(he,"__value__",et),Reflect.set(xe,"__value__",et),xe.appendChild(he),{folderElement:xe,fileNameElement:he}}clearFolderInfoView(){ne.setSafeHTML(v,"");}createHeaderArrowIcon(){return p.createElement("div",{className:"iconArrow"})}createBreadcrumb(V,R){return p.createElement("span",{className:"pops-folder-file-list-breadcrumb-allFiles cursor-p",innerHTML:`<a>${V}</a>`,_config_:R},{title:V})}setBreadcrumbClickEvent(V,R,j){this.clearFolderInfoView();const Y=V.target.closest("span.pops-folder-file-list-breadcrumb-allFiles");if(Y)for(;Y.nextElementSibling;)Y.nextElementSibling.remove();else console.error("获取导航按钮失败");const oe=Wt.init({parent:C,content:{text:"获取文件列表中..."},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},addIndexCSS:false});this.initFolderView(j),oe.close();}async enterFolder(V,R){this.clearFolderInfoView();const j=Wt.init({parent:C,content:{text:"获取文件列表中..."},mask:{enable:true},addIndexCSS:false});if(typeof R.clickEvent=="function"){const ee=await R.clickEvent(V,R);$.appendChild(this.createHeaderArrowIcon());const Y=this.createBreadcrumb(R.fileName,ee);$.appendChild(Y),p.on(Y,"click",oe=>{this.setBreadcrumbClickEvent(oe,false,ee);}),this.initFolderView(ee);}j.close();}async downloadFile(V,R,j){p.preventEvent(V);const ee=R.querySelector("a");if(typeof j.clickEvent=="function"){const Y=await j.clickEvent(V,j);if(Y!=null&&typeof Y=="object"&&!Array.isArray(Y)&&typeof Y.url=="string"&&Y.url.trim()!==""&&(ee.setAttribute("href",Y.url),ee.setAttribute("target","_blank"),Y.autoDownload))if((Y.mode==null||Y.mode==="")&&(Y.mode="aBlank"),Y.mode==="a"||Y.mode==="aBlank"){const oe=p.createElement("a");Y.mode==="aBlank"&&oe.setAttribute("target","_blank"),oe.href=Y.url,oe.click();}else if(Y.mode==="open"||Y.mode==="openBlank")Y.mode==="openBlank"?globalThis.open(Y.url,"_blank"):globalThis.open(Y.url);else if(Y.mode==="iframe"){const oe=p.createElement("iframe");oe.src=Y.url,oe.onload=function(){U.setTimeout(()=>{oe.remove();},1e3);},o.appendChild(oe),U.setTimeout(()=>{oe.remove();},180*1e3);}else console.error("未知的下载模式",Y);}}sortFolderConfig(V,R="fileName",j=false){if(R==="fileName"){const ee=V.filter(oe=>oe.isFolder),Y=V.filter(oe=>!oe.isFolder);return ee.sort((oe,ge)=>{const xe=oe[R].toString(),he=ge[R].toString();let pe=xe.localeCompare(he);return j&&(pe>0?pe=-1:pe<0&&(pe=1)),pe}),Y.sort((oe,ge)=>{const xe=oe[R].toString(),he=ge[R].toString();let pe=xe.localeCompare(he);return j&&(pe>0?pe=-1:pe<0&&(pe=1)),pe}),j?[...Y,...ee]:[...ee,...Y]}else return V.sort((ee,Y)=>{let oe=ee[R],ge=Y[R];return R==="fileSize"?(oe=parseFloat(oe.toString()),ge=parseFloat(ge.toString())):R==="latestTime"&&(oe=new Date(oe).getTime(),ge=new Date(ge).getTime()),oe>ge?j?-1:1:oe<ge?j?1:-1:0}),V}initFolderView(V){this.sortFolderConfig(V,n.sort.name,n.sort.isDesc),V.forEach(R=>{if(R.isFolder){const{folderElement:j,fileNameElement:ee}=U.isPhone()?this.createFolderRowElementByMobile(R.fileName,"","",true):this.createFolderRowElement(R.fileName,"","",true);p.on(ee,"click",Y=>{this.enterFolder(Y,R);}),v.appendChild(j);}else {const{folderElement:j,fileNameElement:ee}=U.isPhone()?this.createFolderRowElementByMobile(R.fileName,R.latestTime,R.fileSize,false):this.createFolderRowElement(R.fileName,R.latestTime,R.fileSize,false);p.on(ee,"click",Y=>{this.downloadFile(Y,ee,R);}),v.appendChild(j);}});}removeArrowActiveStatus(){[...Array.from(te.querySelectorAll(".pops-folder-icon-active")),...Array.from(E.querySelectorAll(".pops-folder-icon-active")),...Array.from(L.querySelectorAll(".pops-folder-icon-active"))].forEach(V=>V.classList.remove("pops-folder-icon-active"));}changeArrowActive(V,R,j){this.removeArrowActiveStatus(),j?R.classList.add("pops-folder-icon-active"):V.classList.add("pops-folder-icon-active");}arrowToSortFolderInfoView(V,R,j){Reflect.get(R,"notChangeSortRule")||(n.sort.name=j,n.sort.isDesc=!n.sort.isDesc);const Y=V.querySelector(".pops-folder-icon-arrow-up"),oe=V.querySelector(".pops-folder-icon-arrow-down");if(this.changeArrowActive(Y,oe,n.sort.isDesc),typeof n.sort.callback=="function"&&n.sort.callback(V,R,n.sort.name,n.sort.isDesc))return;const ge=[];Array.from(v.children).forEach(he=>{const pe=Reflect.get(he,"__value__");Reflect.set(pe,"target",he),ge.push(pe);}),this.sortFolderConfig(ge,n.sort.name,n.sort.isDesc).forEach(he=>{v.appendChild(he.target);});}}const _=new P;return _.init(),Reflect.set(A,"data-pops-folder",_),n.drag&&be.drag(A,{dragElement:k,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),I.handlePush(t,{guid:e,animElement:w,popsElement:A,maskElement:T,$shadowContainer:r,$shadowRoot:o}),I.handleResultDetails(S)}},Bs=()=>({title:{position:"center",text:"",html:false,style:""},loading:{enable:true,icon:true,text:""},useShadowRoot:true,class:"",url:window.location.href,only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",position:"center",drag:true,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",topRightButton:"min|max|mise|close",sandbox:false,forbiddenScroll:false,loadEndCallBack(){},btn:{min:{callback(){}},max:{callback(){}},mise:{callback(){}},close:{callback(){}}},style:null,beforeAppendToPageCallBack(){}}),Ds={init(a){const e=U.getRandomGUID(),t="iframe";let n=Bs();if(n=U.assign(n,ye.getGlobalConfig()),n=U.assign(n,a),n.url==null)throw new Error("config.url不能为空");n=I.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=I.handlerShadow(n);I.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"iframeCSS",css:W.iframeCSS}]);const s=n.animation!=null&&n.animation!=""?"position:absolute;":"",i=I.handleZIndex(n.zIndex),l=J.createMask(e,i,s),c=J.createHeader(t,n),f='<div class="pops-loading"></div>',d=n.title.text.trim()!==""?n.title.text:n.url,{headerStyle:u,headerPStyle:m}=J.createHeaderStyle(t,n),y=J.createAnim(e,t,n,`
			...
			`);const n=e.querySelector(".pops-panel-slider input[type=range]");a.step&&n.setAttribute("step",a.step.toString()),n.value=a.getValue().toString();const r=function(s){return typeof a.getToolTipContent=="function"?a.getToolTipContent(s):s},o=Kt.init({target:n.parentElement,content:()=>r(n.value),zIndex:()=>be.getPopsMaxZIndex().zIndex,className:"github-tooltip",alwaysShow:false,only:false,position:"top",arrowDistance:10});return p.on(n,["input","propertychange"],void 0,function(s){o.toolTip.changeContent(r(n.value)),typeof a.callback=="function"&&a.callback(s,n.valueAsNumber);}),e},createSectionContainerItem_slider_new(a){const e=p.createElement("li");Reflect.set(e,"__formConfig__",a),this.setElementClassName(e,a.className),this.setElementAttributes(e,a.attributes),this.setElementProps(e,a.props);let t="";a.description&&(t=`<p class="pops-panel-item-left-desc-text">${a.description}</p>`),ne.setSafeHTML(e,`
...
`)}{display: none !important;}`)},setGMResourceCSS(a){const e=typeof wt=="function"?wt(a.keyName):null;return typeof e=="string"&&e?Bn(e):fe.loadStyleLink(a.url)},async loadStyleLink(a){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=a,new Promise(t=>{Ee.ready(()=>{document.head.appendChild(e),t(e);});})},async loadScript(a){let e=document.createElement("script");return e.src=a,new Promise(t=>{e.onload=()=>{t(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(a){return a=a.trim(),a.startsWith("data:")||a.match(/^http(s|):\/\//i)?a:a.startsWith("//")?(a.startsWith("///")||(a=window.location.protocol+a),a):(a.startsWith("/")||(a+="/"),a=window.location.origin+a,a)},fixHttps(a){if(a.startsWith("https://")||!a.startsWith("http://"))return a;try{let e=new URL(a);return e.protocol="https:",e.toString()}catch{return a}},lockScroll(...a){let e=document.createElement("style");e.innerHTML=`
		...
		`;let t=[document.documentElement,document.body].concat(...a||[]);return t.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){t.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function a(n){navigator.clipboard.readText().then(r=>{n(r);}).catch(r=>{$e.error("读取剪贴板内容失败👉",r),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(r=>{a(n);}).catch(r=>{$e.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),a(n);});}function t(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!t()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(a,e,t=5e3){let n,r=t-e,o=e,s=async i=>{let l=await a(i);if(typeof l=="boolean"&&!l||i){ae.workerClearTimeout(n);return}if(o+=e,o>r){s(true);return}n=ae.workerSetTimeout(()=>{s(false);},e);};s(false);},findParentNode(a,e,t){if(t){let n=Ee.closest(a,t);if(n)return n.querySelector(e)}else return Ee.matches(a,e)?a:Ee.closest(a,e)}},nt={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},ae=je.noConflict(),b=Ee.noConflict(),dt=_t,$e=new ae.Log(Fe,ve.console||Be.console);let Pn=Fe?.script?.name||void 0;_t.config.Utils.AnyTouch();const Qs=false;$e.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});O.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(a){const e=a.getSetting().type;if(e==="loading")return  false;const t=a.getSetting().content;return e==="warning"?$e.warn(t):e==="error"?$e.error(t):$e.info(t),true},get position(){return Ne.getValue(nt.qmsg_config_position.key,nt.qmsg_config_position.defaultValue)},get maxNums(){return Ne.getValue(nt.qmsg_config_maxnums.key,nt.qmsg_config_maxnums.defaultValue)},get showReverse(){return Ne.getValue(nt.qmsg_config_showreverse.key,nt.qmsg_config_showreverse.defaultValue)},get zIndex(){let a=je.getMaxZIndex(),e=_t.config.InstanceUtils.getPopsMaxZIndex().zIndex;return je.getMaxValue(a,e)+100}});dt.GlobalConfig.setGlobalConfig({zIndex:()=>{let a=je.getMaxZIndex(void 0,void 0,t=>{if(t?.classList?.contains("qmsg-shadow-container")||t?.closest("qmsg")&&t.getRootNode()instanceof ShadowRoot)return  false}),e=_t.config.InstanceUtils.getPopsMaxZIndex().zIndex;return je.getMaxValue(a,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Ys=new ae.GM_Menu({GM_getValue:at,GM_setValue:De,GM_registerMenuCommand:At,GM_unregisterMenuCommand:Ut}),xr=new ae.Httpx({xmlHttpRequest:Vn,logDetails:Qs});xr.interceptors.request.use(a=>a);xr.interceptors.response.use(void 0,a=>($e.error("拦截器-请求错误",a),a.type==="onabort"?O.warning("请求取消",{consoleLogContent:true}):a.type==="onerror"?O.error("请求异常",{consoleLogContent:true}):a.type==="ontimeout"?O.error("请求超时",{consoleLogContent:true}):O.error("其它错误",{consoleLogContent:true}),a));ve.Object.defineProperty,ve.Function.prototype.apply,ve.Function.prototype.call,ve.Element.prototype.appendChild,ve.setTimeout;const Bn=b.addStyle.bind(b);Ee.selector.bind(Ee);Ee.selectorAll.bind(Ee);new ae.GM_Cookie;const wr="GM_Panel",Js="data-init",Dn="data-key",Hn="data-default-value",Zs="data-init-more-value",_e={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},pt={setting:{get width(){return _e.width<550?"88vw":_e.width<700?"550px":"700px"},get height(){return _e.height<450?"70vh":_e.height<550?"450px":"550px"}},settingMiddle:{get width(){return _e.width<350?"88vw":"350px"},get height(){return _e.height<450?"88vh":"450px"}},settingBig:{get width(){return _e.width<800?"92vw":"800px"},get height(){return _e.height<600?"80vh":"600px"}},info:{get width(){return _e.width<350?"88vw":"350px"},get height(){return _e.height<250?"88vh":"250px"}}};class ei{storageKey;listenerData;constructor(e){if(typeof e=="string"){const t=e.trim();if(t=="")throw new Error("key参数不能为空字符串");this.storageKey=t;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new je.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let e=at(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){De(this.storageKey,e);}set(e,t){const n=this.get(e),r=this.getLocalValue();Reflect.set(r,e,t),this.setLocalValue(r),this.triggerValueChangeListener(e,n,t);}get(e,t){const n=this.getLocalValue();return Reflect.get(n,e)??t}getAll(){return this.getLocalValue()}delete(e){const t=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.triggerValueChangeListener(e,t,void 0);}has(e){const t=this.getLocalValue();return Reflect.has(t,e)}keys(){const e=this.getLocalValue();return Reflect.ownKeys(e)}values(){const e=this.getLocalValue();return Reflect.ownKeys(e).map(t=>Reflect.get(e,t))}clear(){xt(this.storageKey);}addValueChangeListener(e,t){const n=Math.random(),r=this.listenerData.get(e)||[];return r.push({id:n,key:e,callback:t}),this.listenerData.set(e,r),n}removeValueChangeListener(e){let t=false;for(const[n,r]of this.listenerData.entries()){for(let o=0;o<r.length;o++){const s=r[o];(typeof e=="string"&&s.key===e||typeof e=="number"&&s.id===e)&&(r.splice(o,1),o--,t=true);}this.listenerData.set(n,r);}return t}async triggerValueChangeListener(...e){const[t,n,r]=e;if(!this.listenerData.has(t))return;let o=this.listenerData.get(t);for(let s=0;s<o.length;s++){const i=o[s];if(typeof i.callback=="function"){let l=this.get(t),c,f;typeof n<"u"&&e.length>=2?f=n:f=l,typeof r<"u"&&e.length>2?c=r:c=l,await i.callback(t,f,c);}}}}const He=new ei(wr),ht={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new ae.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(a){Array.isArray(a)||(a=[a]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,a);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(a=0){return this.$data.contentConfig.get(a)??[]},getDefaultBottomContentConfig(){return this.$data.__defaultBottomContentConfig.length?this.$data.__defaultBottomContentConfig:[{id:"script-version",title:`版本：${Fe?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(a,e,t){let n=Fe?.script?.supportURL||Fe?.script?.namespace;return typeof n=="string"&&ae.isNotNull(n)&&window.open(n,"_blank"),false}}]},setDefaultBottomContentConfig(a){this.$data.__defaultBottomContentConfig=a;}},Xt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(a){return a},callback:()=>{Ne.showPanel(ht.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){Ne.isTopWindow()&&Ys.add(this.$data.menuOption);},addMenuOption(a){Array.isArray(a)||(a=[a]),this.$data.menuOption.push(...a);},updateMenuOption(a){Array.isArray(a)||(a=[a]),a.forEach(e=>{let t=this.$data.menuOption.findIndex(n=>n.key===e.key);t!==-1&&(this.$data.menuOption[t]=e);});},getMenuOption(a=0){return this.$data.menuOption[a]},deleteMenuOption(a=0){this.$data.menuOption.splice(a,1);}},Ne={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new ae.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new ae.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new ae.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new ae.Dictionary),this.__onceExecData},get scriptName(){return Pn},get panelConfig(){return this.__panelConfig},set panelConfig(a){this.__panelConfig=a;},key:wr,attributeKeyName:Dn,attributeDefaultValueName:Hn},init(){this.initContentDefaultValue(),Xt.init();},isTopWindow(){return ve.top===ve.self},initContentDefaultValue(){const a=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const r=n.attributes;let o=r[Js];if(typeof o=="function"){let c=o();if(typeof c=="boolean"&&!c)return}let s=new Map,i=r[Dn];if(i!=null){const c=r[Hn];s.set(i,c);}let l=r[Zs];if(typeof l=="object"&&l&&Object.keys(l).forEach(c=>{s.set(c,l[c]);}),!s.size){$e.warn(["请先配置键",n]);return}if(n.type==="switch"){let c=typeof n.disabled=="function"?n.disabled():n.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...s.keys());}for(const[c,f]of s.entries())this.setDefaultValue(c,f);},e=n=>{for(let r=0;r<n.length;r++){let o=n[r];a(o);let s=o.forms;s&&Array.isArray(s)&&e(s);}},t=[...ht.getAllContentConfig()];for(let n=0;n<t.length;n++){let r=t[n];if(!r.forms)continue;const o=r.forms;o&&Array.isArray(o)&&e(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(a,e){this.$data.contentConfigInitDefaultValue.has(a)&&$e.warn("请检查该key(已存在): "+a),this.$data.contentConfigInitDefaultValue.set(a,e);},getDefaultValue(a){return this.$data.contentConfigInitDefaultValue.get(a)},setValue(a,e){He.set(a,e);},getValue(a,e){const t=He.get(a);return t??(this.$data.contentConfigInitDefaultValue.has(a)?this.$data.contentConfigInitDefaultValue.get(a):e)},deleteValue(a){He.delete(a);},hasKey(a){return He.has(a)},addValueChangeListener(a,e){return He.addValueChangeListener(a,(n,r,o)=>{e(a,o,r);})},removeValueChangeListener(a){He.removeValueChangeListener(a);},triggerMenuValueChange(a,e,t){He.triggerValueChangeListener(a,t,e);},async exec(a,e,t,n=true){const r=this;let o;typeof a=="string"||Array.isArray(a)?o=()=>a:o=a;let s=false;const i=o();let l=[];Array.isArray(i)?(s=true,l=i):l.push(i);const c=l.find(v=>!this.$data.contentConfigInitDefaultValue.has(v));if(c){$e.warn(`${c} 键不存在`);return}const f=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(f))return this.$data.onceExecMenuData.get(f);let d=[];const u=[];let m=[];const y=(v,$)=>{let D=[],z=[],F=[];if(Array.isArray($))F=F.concat($);else if(typeof $=="object"&&$!=null)if($ instanceof Element)F.push($);else {const{$css:X,destory:te}=$;X!=null&&(Array.isArray(X)?F=F.concat(X):F.push(X)),typeof te=="function"&&F.push(te);}else F.push($);for(const X of F)if(X!=null){if(X instanceof Element){D.push(X);continue}if(typeof X=="function"){m.push(X);continue}}v?(d=d.concat(D),m=m.concat(z)):(x(),w());},g=v=>this.getValue(v),x=()=>{for(let v=0;v<d.length;v++)d[v]?.remove(),d.splice(v,1),v--;},w=()=>{for(let v=0;v<m.length;v++){const $=m[v];$(),m.splice(v,1),v--;}},A=()=>{let v=false;return typeof t=="function"?v=t(l):v=l.every($=>g($)),v},k=async v=>{if(A()){const D=l.map(F=>this.getValue(F)),z=await e({value:s?D:D[0],addStoreValue:(...F)=>y(true,F)});y(true,z);}else y(false,[]);};n&&l.forEach(v=>{const $=this.addValueChangeListener(v,(D,z,F)=>k());u.push($);}),await k();const C={reload(){this.clearStoreStyleElements(),this.destory(),k();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>x(),destory(){return w()},removeValueChangeListener:()=>{u.forEach(v=>{this.removeValueChangeListener(v);});},clearOnceExecMenuData(){n&&r.$data.onceExecMenuData.delete(f);}};return this.$data.onceExecMenuData.set(f,C),C},async execMenu(a,e,t=false,n=false){return await this.exec(a,async r=>await e(r),r=>r.every(s=>{let i=!!this.getValue(s);return Ne.$data.contentConfigInitDisabledKeys.includes(s)&&(i=false,$e.warn(`.execMenu${n?"Once":""} ${s} 被禁用`)),t&&(i=!i),i}),n)},async execMenuOnce(a,e,t=false,n=false){const r=await this.execMenu(a,e,t,true);if(n&&r){const o=()=>{r.reload();};this.removeUrlChangeWithExecMenuOnceListener(a),this.addUrlChangeWithExecMenuOnceListener(a,o);}return r},deleteExecMenuOnce(a){return a=this.transformKey(a),this.$data.onceExecMenuData.delete(a),this.$data.urlChangeReloadMenuExecOnce.delete(a),He.removeValueChangeListener(a)},onceExec(a,e){if(a=this.transformKey(a),typeof a!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(a)||(e(),this.$data.onceExecData.set(a,1));},deleteOnceExec(a){a=this.transformKey(a),this.$data.onceExecData.delete(a);},addUrlChangeWithExecMenuOnceListener(a,e){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.set(a,e);},removeUrlChangeWithExecMenuOnceListener(a){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.delete(a);},hasUrlChangeWithExecMenuOnceListener(a){return a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.has(a)},async triggerUrlChangeWithExecMenuOnceEvent(a){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const t of e)await t(a);},showPanel(a,e=`${Pn}-设置`,t=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let r=a.findIndex(s=>(typeof s.isBottom=="function"?s.isBottom():!!s.isBottom)&&s.id==="script-version")!==-1;!t&&!r&&a.push(...ht.getDefaultBottomContentConfig());let o=dt.panel({title:{text:e,position:"center",html:false,style:""},content:a,btn:{close:{enable:true,callback:(s,i)=>{s.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(s,i)=>{s(),this.$data.$panel=null;}},width:pt.setting.width,height:pt.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=a,n||this.registerConfigSearch({$panel:o,content:a});},registerConfigSearch(a){const{$panel:e,content:t}=a;let n=async(f,d)=>{if(f==null)return;let u=await d(f);return u&&typeof u.isFind=="boolean"&&u.isFind?u.data:await n(u.data,d)},r=(f,d)=>{const u=new IntersectionObserver(m=>{m.forEach(y=>{y.isIntersecting&&(d?.(),u.disconnect());});},{root:null,threshold:1});u.observe(f),f.scrollIntoView({behavior:"smooth",block:"center"});},o=f=>{const d="pops-flashing";b.animationend(f,()=>{f.classList.remove(d);}),f.classList.add(d);},s=(f,d)=>{b.preventEvent(f);let u=dt.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${a.searchDialogStyle??""}
				`});u.$shadowRoot.querySelector(".search-wrapper");let m=u.$shadowRoot.querySelector(".search-config-text"),y=u.$shadowRoot.querySelector(".search-result-wrapper");m.focus();let g=()=>{b.empty(y);},x=A=>{const k=ae.queryProperty(A,v=>v?.next?{isFind:false,data:v.next}:{isFind:true,data:v});let C=b.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return b.on(C,"click",v=>{let D=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[A.index];if(!D){O.error(`左侧项下标${A.index}不存在`);return}D.scrollIntoView({behavior:"smooth",block:"center"}),D.click(),n(A.next,async z=>{if(z?.next){let F=await b.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(X=>{const te=Reflect.get(X,"__formConfig__");return typeof te=="object"&&te!=null&&te.text===z.name}),2500);if(F)F.click();else return O.error("未找到对应的二级菜单"),{isFind:true,data:z};return {isFind:false,data:z.next}}else {let F=await b.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(X=>Reflect.get(X,"__formConfig__")===z.matchedData?.formConfig),2500);if(F){r(F);let X=F.closest(".pops-panel-forms-fold[data-fold-enable]");X&&(X.querySelector(".pops-panel-forms-fold-container").click(),await ae.sleep(500)),r(F,()=>{o(F);});}else O.error("未找到对应的菜单项");return {isFind:true,data:z}}});}),C},w=A=>{const k=new RegExp(A,"i"),C=[],v=(D,z)=>{for(let F=0;F<D.length;F++){const X=D[F];let te=X.forms;if(te&&Array.isArray(te)){const E=ae.deepClone(z);if(X.type==="deepMenu"){const L=ae.queryProperty(E,T=>T?.next?{isFind:false,data:T.next}:{isFind:true,data:T});L.next={name:X.text};}v(te,E);}else {let E=Reflect.get(X,"text"),L=Reflect.get(X,"description");const T=[E,L];let h=T.findIndex(S=>{if(typeof S=="string")return S.match(k)});if(h!==-1){const S=ae.deepClone(z),P=ae.queryProperty(S,Q=>Q?.next?{isFind:false,data:Q.next}:{isFind:true,data:Q});P.next={name:E,matchedData:{path:"",formConfig:X,matchedText:T[h],description:L}};const _=[];ae.queryProperty(S,Q=>{const V=Q?.name;return typeof V=="string"&&V.trim()!==""&&_.push(V),Q?.next?{isFind:false,data:Q.next}:{isFind:true,data:Q}});const N=_.join(fe.escapeHtml(" - "));P.next.matchedData.path=N,C.push(S);}}}};for(let D=0;D<t.length;D++){const z=t[D];if(!z.forms||z.isBottom&&z.id==="script-version")continue;const F=z.forms;if(F&&Array.isArray(F)){let X=z.title;typeof X=="function"&&(X=X()),v(F,{index:D,name:X});}}let $=document.createDocumentFragment();for(const D of C){let z=x(D);$.appendChild(z);}g(),y.append($);};b.on(m,"input",ae.debounce(A=>{b.preventEvent(A);let k=b.val(m).trim();if(k===""){g();return}w(k);},200));},i=null,l=false,c;b.on(e.$shadowRoot,"dblclick","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",s),b.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(f,d)=>{clearTimeout(c),c=void 0,l&&i===d?(l=false,i=null,s(f)):(c=setTimeout(()=>{l=false;},200),l=true,i=d);},{capture:true}),e.$shadowRoot.appendChild(b.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
				...
				`});return t.appendChild(n),t},async afterAddToUListCallBack(t,n){let r=n.target,o=r.querySelector(".pops-panel-item-left-text"),s=r.querySelector(".pops-panel-item-left-main-text"),i=r.querySelector(".pops-panel-item-left-desc-text"),l=await a();l.tag==null?b.html(s,l.text):b.html(s,vr[l.tag]+l.text),(l.description==null||l.description==="")&&b.hide(i,false),b.html(i,l.description||"");let c=["support-info"];if(l.tag!=null&&c.push(l.tag),b.addClass(s,c),typeof l.afterRender=="function")try{l.afterRender({...n,$leftContainer:o,$leftText:s,$leftDesc:i});}catch(f){console.log(f),Z.setTag(s,"error","afterRender 函数执行错误"+f);}}}),G={asideLastVisit:"aside-last-visit"},ti={getWindow(){return Ce.unsafeWindow.isSupport()?ve:window}};class ni{}class Rt extends ni{isSupportGM(){return typeof H=="object"&&H!=null}}class le extends Rt{}const se={getApiDocUrl(a,e){return e=e??a,`<a href="https://www.tampermonkey.net/documentation.php?ext=gcal&version=#api:${a}" target="_blank">${e}</a>`}};class ri extends le{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof H.addElement=="function"}}isSupport(){return typeof rn=="function"}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[M(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),M(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(rn,this,r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:H.addElement,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push(M(async()=>{let s=null,i=null,l=ti.getWindow(),c=o+"_test_script_exec",f=`${c}_test_str`;try{return s=await r.fn("script",{id:c,textContent:`window["${f}"] = "bar";`}),i=document.querySelector("#"+c),s==null?{text:`${r.name} returns is null`,tag:"error"}:s instanceof HTMLElement?typeof l[f]!="string"?{text:`${r.name} script element is not work`,tag:"error"}:(Reflect.deleteProperty(l,f),{text:fe.escapeHtml("支持添加<script>元素且执行js"),tag:"success"}):{text:`${r.name} returns is not style element`,tag:"error"}}catch(d){return console.error(d),{text:"执行错误 "+d,tag:"error"}}finally{i&&i.remove();}}),M(async()=>{let s=null,i=null,l=o+"_test2";try{if(s=await r.fn(document.body,"div",{"data-src":"https://example.com/image.png",id:l}),s==null)return {text:r.name+" returns is null",tag:"error"};if(!(s instanceof HTMLElement))return {text:r.name+" returns is not style element",tag:"error"};if(i=document.querySelector("#"+l),!i)return {text:"不支持3个参数",tag:"error"};const c=i.attachShadow({mode:"closed"});return await r.fn(c,"style",{textContent:"div { color: black; };"}),c.querySelector("style")?s==null?{text:"传入3个参数但是返回为空",tag:"error"}:i.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(c){return console.error(c),{text:"执行错误 "+c,tag:"error"}}finally{i&&i.remove();}}));}),n}}class oi extends le{isSupport(){return typeof on=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof H.addStyle=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-GM_addStyle"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[M(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),M(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(on,this,r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:H.addStyle,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push(M(async()=>{let s=null,i=null;try{return s=b.createElement("div",{id:o,innerText:o+" test"}),document.body.appendChild(s),i=await r.fn(`
						...
						`),i==null?{text:`${r.name} returns is null`,tag:"error"}:i instanceof HTMLStyleElement?window.getComputedStyle(s).backgroundColor!=="rgb(255, 0, 0)"?{text:`${r.name} test element background is not rgb(255, 0, 0)`,tag:"error"}:{text:fe.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}:{text:`${r.name} returns is not HTMLStyleElement`,tag:"error"}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}finally{s?.remove(),i?.remove();}}));}),n}}class ai extends le{isSupport(){return typeof Vt=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof H.addValueChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[M(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),M(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=Vt(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:H.addValueChangeListener,formList:n.forms[2].forms}].forEach(r=>{let o=r.name;r.formList.push((()=>{let s=o+"_key_1";return M(()=>({text:"测试监听数据存储改变",description:"",tag:"info",afterRender(i){let l=b.toElement(`
							...
							"${o}-test-key-2": 2,
								...
								`,!1,!1),y,g,x=ae.debounce(()=>{try{clearTimeout(y),clearInterval(g);let w="",A="success",k="",C="success";i?(w+="支持 onclick 函数",l?(w=w.trim(),w+="且支持提供 event 参数"):(w+="但是不支持提供 event 参数",A="warn")):(w+="不支持 onclick 函数",A="error"),c?k+="支持 ondone 函数":(k+="不支持 ondone 函数",C="error"),b.html(u.$leftText,`
												<p class="${A}">${w}</p>
												<p class="${C}">${k}</p>`),i=!1,c=!1,l=!1;}catch(w){O.error(w.toString(),{consoleLogContent:!0});}},800);b.on(m,"click",async w=>{try{b.preventEvent(w),clearTimeout(y),clearInterval(g);let A=10,k=A,C=()=>{let v=`正在等待触发回调，请在规定时间内点击弹窗的【关闭】按钮或者内容：${k}s`;return k--,v};b.text(u.$leftText,C()),b.text(u.$leftDesc,f),b.show(u.$leftDesc,!1),y=ke(()=>{clearInterval(g),Z.setTag(u.$leftText,"error","测试超时，未触发回调");},A*1e3),g=setInterval(()=>{b.text(u.$leftText,C());},1e3),await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",onclick:v=>{console.log(v),i=!0,v&&typeof v.preventDefault=="function"&&(l=!0,v.preventDefault()),x();},ondone(){c=!0,x();}});}catch(A){O.error(A.toString(),{consoleLogContent:!0});}}),b.after(s,m);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),M(()=>{try{let o,s,i=!1,l=!1,c=!1,f="123",d="456",u="notification_tag_"+Date.now(),m={title:"测试通知的内容更新（tag）",text:f,tag:u},y=`更新前：${f}，更新后：${d}`;return {text:m.title,description:y,tag:"info",afterRender(g){o=g.target,s=g.$leftContainer;let x=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),w,A;b.on(x,"click",async k=>{try{b.preventEvent(k),clearTimeout(w),clearInterval(A);let C=5,v=C,$=()=>{let D=`${v}s后通知的内容将更新为：${d}`;return v--,D};b.text(g.$leftDesc,$()),b.show(g.$leftDesc,!1),w=setTimeout(async()=>{clearInterval(A),b.text(g.$leftDesc,y),r.fn({...m,text:d});},C*1e3),A=setInterval(()=>{b.text(g.$leftDesc,$());},1e3),await r.fn(m);}catch(C){O.error(C.toString(),{consoleLogContent:!0});}}),b.after(s,x);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class wi extends le{isSupport(){return typeof un=="function"}getApiName(){return "GM_openInTab"}getAsyncApiOption(){return {name:"GM.openInTab",isSupport:this.isSupportGM()&&typeof H.openInTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[M(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),M(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=un(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:H.openInTab,formList:n.forms[2].forms}].forEach(r=>{r.formList.push(M(()=>{try{return {text:"后台打开：https://www.example.com/",tag:"info",afterRender(o){let s=o.target,i=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
...
`));}catch(y){O.error(y.toString(),{consoleLogContent:!0});}});}catch(f){O.error(f.toString(),{consoleLogContent:!0});}});}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),M(()=>{try{return {text:"注册并更新菜单 ==> Test Update Menu",description:"请自行验证是否成功更新菜单文字为：Test Update Menu Success!!!",tag:"info",afterRender(o){let s=b.toElement(`
								...
								`,false,false);b.after(o.$leftContainer,s);let i;b.on(s,"click",async l=>{try{b.preventEvent(l),clearTimeout(i),O.info("等待3s内触发成功复制的回调"),i=ke(()=>{Z.setTag(o.$leftText,"error","不支持触发回调函数");},3e3),await r.fn("Test "+r.name,"text",()=>{clearTimeout(i),Z.setTag(o.$leftText,"success","支持触发回调函数");});}catch(c){O.error(c.toString(),{consoleLogContent:true});}});}})));}),n}}class Ci extends le{isSupport(){return typeof De=="function"}getApiName(){return "GM_setValue"}getAsyncApiOption(){return {name:"GM.setValue",isSupport:this.isSupportGM()&&typeof H.setValue=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[M(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),M(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=De(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:H.setValue,formList:n.forms[2].forms}].forEach(r=>{let o=r.name;r.formList.push(...[{key:`Test ${o} boolean`,value:true,text:function(){return "存储boolean类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} number`,value:1,text:function(){return "存储number类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} string`,value:"测试字符串",text:function(){return "存储string类型"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:`Test ${o} undefined`,value:void 0,text:function(){return "存储undefined类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} null`,value:null,text:function(){return "存储object类型的null"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} object`,value:{"object key":"object value"},text:function(){return "存储object类型"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(s=>(()=>{let i=s.key,l=s.value;return M(()=>({text:s.text(),description:s.desc(),tag:"info",afterRender(c){let f=b.toElement(`
									...
									`,false,false);b.after(c.$leftContainer,f),b.on(f,"click",async d=>{b.preventEvent(d);try{await r.fn(i,l),O.info("执行写入完毕，请自行查看是否成功写入");}catch(u){O.error(u.toString(),{consoleLogContent:true});}});}}))})()));}),n}}class Ei extends le{isSupport(){return typeof St=="function"}getApiName(){return "GM_setValues"}getAsyncApiOption(){return {name:"GM.setValues",isSupport:this.isSupportGM()&&typeof H.setValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[M(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),M(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=St(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:H.setValues,formList:n.forms[2].forms}].forEach(r=>{r.name,r.formList.push((()=>{let o={foo:1,bar:2};return M(()=>({text:"测试存储对象",description:JSON.stringify(o),tag:"info",afterRender(s){let i=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);b.after(s.$leftContainer,i),b.on(i,"click",async l=>{b.preventEvent(l);try{await r.fn(o),O.info("执行写入完毕，请自行查看是否成功写入");}catch(c){O.error(c.toString(),{consoleLogContent:true});}});}}))})());}),n}}class ki extends le{isSupport(){return typeof Ut=="function"}getApiName(){return "GM_unregisterMenuCommand"}getAsyncApiOption(){return {name:"GM.unregisterMenuCommand",isSupport:this.isSupportGM()&&typeof H.unregisterMenuCommand=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[M(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),M(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=Ut(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:H.unregisterMenuCommand,formList:n.forms[2].forms}].forEach(r=>{r.formList.push(M(()=>{try{return {text:"注册并卸载菜单 ==> Test UnRegister Menu",description:"请自行验证是否成功卸载菜单",tag:"info",afterRender(o){let s=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
...
`));}else Z.setTag(i.$leftText,"error","返回值类型错误："+typeof f);b.text(i.$leftDesc,this.text),b.show(i.$leftDesc,!1),alert(JSON.stringify(f,null,4));}catch(f){O.error(f.toString(),{consoleLogContent:!0});}}),b.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}finally{}}),M(()=>{try{return {text:fe.escapeHtml("测试监听静音状态改变"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=b.toElement(`
									...
									`,!1,!1),c=!0,f;b.on(l,"click",async d=>{try{b.preventEvent(d);let u=m=>{c=!1,O.error("移除监听器失败");};f=O.loading("处理监听器中..."),await s.addStateChangeListener(u),await s.removeStateChangeListener(u),f.setText("等待500ms，设置当前Tab静音"),await ae.sleep(500),await s.setMute({isMuted:!0}),f.setText("等待500ms，设置当前Tab取消静音"),await ae.sleep(500),await s.setMute({isMuted:!1}),f.close(),c&&O.success("移除监听器成功");}catch(u){f?.close(),O.error(u.toString(),{consoleLogContent:!0});}}),b.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}finally{}}));}),r}}const Ce={unsafeWindow:new Mi,GM:new Ii,addElement:new ri,addStyle:new oi,download:new ci,getResourceText:new fi,getResourceUrl:new di,info:new mi,log:new yi,notification:new xi,openInTab:new wi,registerMenuCommand:new vi,unregisterMenuCommand:new ki,setClipboard:new Ti,getTab:new pi,saveTab:new Si,getTabs:new ui,setValue:new Ci,getValue:new bi,deleteValue:new ii,listValues:new gi,setValues:new Ei,getValues:new hi,deleteValues:new li,addValueChangeListener:new ai,removeValueChangeListener:new Ai,xmlHttpRequest:new Li,webRequest:new $i,cookie:new si,audio:new _i},Ue={$storageKey:"gm-api-test-storage-config",set(a,e){let t=window.localStorage.getItem(Ue.$storageKey)??"{}",n=ae.toJSON(t);n[a]=e,window.localStorage.setItem(Ue.$storageKey,JSON.stringify(n,(r,o)=>typeof o=="function"?o.tString():o));},get(a,e){let t=window.localStorage.getItem(Ue.$storageKey)??"{}";return ae.toJSON(t)[a]??e},delete(a){let e=window.localStorage.getItem(Ue.$storageKey)??"{}",t=ae.toJSON(e);Reflect.deleteProperty(t,a),window.localStorage.setItem(Ue.$storageKey,JSON.stringify(t,(n,r)=>typeof r=="function"?r.tString():r));}},q={set(a,e){Ce.setValue.isSupport()&&Ce.getValue.isSupport()&&Ce.deleteValue.isSupport()?De(a,e):Ue.set(a,e);},get(a,e){return Ce.setValue.isSupport()&&Ce.getValue.isSupport()&&Ce.deleteValue.isSupport()?at(a,e):Ue.get(a,e)},delete(a){Ce.setValue.isSupport()&&Ce.getValue.isSupport()&&Ce.deleteValue.isSupport()?xt(a):Ue.delete(a);}},Ri=()=>{let a=[],e=[];Object.keys(Ce).forEach(n=>{let r=Ce[n],o=r.getApiName(),s=r.isSupport(),i=r.getAsyncApiOption();s?a.push({name:o,isSupport:s}):e.push({name:o,isSupport:s}),i&&(i.isSupport?a.push({name:i.name,isSupport:i.isSupport,leftTargetSelector:"#aside-"+o}):e.push({name:i.name,isSupport:i.isSupport,leftTargetSelector:"#aside-"+o}));});let t=n=>{let r=b.createElement("div",{className:"gm-api-features-item",innerHTML:`
			...
			`});return b.on(r,"click",o=>{b.preventEvent(o);let s=r.getRootNode(),i=ae.isNotNull(n.leftTargetSelector)?n.leftTargetSelector:"#aside-"+n.name,l=s.querySelector(i);l&&(l.click(),l.scrollIntoView({behavior:"smooth"}));}),r};return {id:"component-common",title:"通用",scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)==="component-common"},clickCallback(n){q.set(G.asideLastVisit,"component-common");},forms:[{type:"forms",text:"@run-at document-start<br>注：注入速度等级越低，注入的速度越快<br>范围：0~4",forms:[M(()=>({text:fe.escapeHtml(rt),tag:"info"}))]},{type:"forms",text:"特性",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontSize="1.2em",r.formHeaderDivElement.style.fontWeight="700";},forms:[]},{type:"forms",text:"不支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.color="rgb(216, 30, 6)",r.formHeaderDivElement.style.fontWeight="600",e.length===0&&r.formContainerListElement?.remove();},forms:[{type:"own",getLiElementCallBack(n){let r=b.createElement("div",{className:"gm-api-features-not-support"}),o=document.createDocumentFragment();return e.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n}}]},{type:"forms",text:"支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontWeight="600",a.length===0&&r.formContainerListElement?.remove();},forms:[{type:"own",getLiElementCallBack(n){let r=b.createElement("div",{className:"gm-api-features-support"}),o=document.createDocumentFragment();return a.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n}}]}]}};class Ni extends Rt{getApiName(){return "window.onurlchange "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(n){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"功能测试",forms:[M(()=>{try{return {text:fe.escapeHtml("测试window.onurlchange"),tag:"info",description:"点击按钮进行测试",afterRender(n){let r=b.toElement(`
											...
											`,!1,!1);b.on(r,"click",o=>{b.preventEvent(o);try{Be.close();}catch(s){O.error(s.toString(),{consoleLogContent:!0});}}),b.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}finally{}})]}]}}}class Pi extends Rt{getApiName(){return "window.focus "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(n){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"功能测试",forms:[M(()=>{try{return {text:fe.escapeHtml("测试window.focus"),tag:"info",description:"点击按钮执行该函数",afterRender(n){let r=b.toElement(`
											<div class="pops-panel-button pops-panel-button-no-icon">
												<button class="pops-panel-button_inner" type="button" data-type="default">
													<i class="pops-bottom-icon" is-loading="false"></i>
													<span class="pops-panel-button-text">点击执行</span>

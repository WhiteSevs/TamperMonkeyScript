...
`,Oa=`/* firefox上暂不支持::-webkit-scrollbar */\r
...
`,Ba=`.pops[type-value] .pops-alert-title {\r
	display: flex;\r
	align-items: center;\r
	justify-content: space-between;\r
}\r
...
`,Na=`.pops[type-value] .pops-confirm-title {\r
	display: flex;\r
	align-items: center;\r
	justify-content: space-between;\r
}\r
...
`,Ua=`.pops[type-value] .pops-prompt-title {\r
	display: flex;\r
	align-items: center;\r
	justify-content: space-between;\r
}\r
...
`,ja=`.pops[type-value] .pops-folder-title {\r
	display: flex;\r
	align-items: center;\r
	justify-content: space-between;\r
}\r
...
`;const B={index:_a,ninePalaceGridPosition:Ra,scrollbar:Oa,button:Pa,common:Da,anim:Ha,alertCSS:Ba,confirmCSS:Na,promptCSS:Ua,loadingCSS:Va,iframeCSS:za,tooltipCSS:Ga,drawerCSS:Fa,folderCSS:ja,panelCSS:qa,rightClickMenu:Wa},ae={$data:{},$flag:{isInit:false},init(){if(!this.$flag.isInit){this.$flag.isInit=true;let a=document.createElement("style");Q.setSafeHTML(a,B.anim),p.appendHead(a),this.$data=null,this.$data=p.getKeyFrames(a.sheet),D.setTimeout(()=>{a.remove();},50);}},hasAnim(a){return this.$data.hasOwnProperty(a)}},ut={getMaxZIndexNodeInfo(a=1,t=V.document,e){a=Number.isNaN(a)?1:a;const n=2*Math.pow(10,9);let r=0,o=null;function i(l){return l.position!=="static"&&l.display!=="none"}function s(l){if(typeof e=="function"){let d=e(l);if(typeof d=="boolean"&&!d)return}const c=V.window.getComputedStyle(l);if(i(c)){let d=parseInt(c.zIndex);isNaN(d)||d>r&&(r=d,o=l),l.shadowRoot!=null&&l instanceof ShadowRoot&&l.shadowRoot.querySelectorAll("*").forEach(f=>{s(f);});}}return t.querySelectorAll("*").forEach((l,c)=>{s(l);}),r+=a,r>=n&&(r=n),{node:o,zIndex:r}},getPopsMaxZIndex(a=1){a=Number.isNaN(a)?1:a;const t=2*Math.pow(10,9);let e=0,n=null;function r(i){return i.position!=="static"&&i.display!=="none"}Object.keys(mt).forEach(i=>{let s=mt[i];for(let l=0;l<s.length;l++){const c=s[l];let d=window.getComputedStyle(c.animElement);if(r(d)){let f=parseInt(d.zIndex);isNaN(f)||f>e&&(e=f,n=c.animElement);}}}),e+=a;let o=e>=t;return o&&(e=t),{zIndex:e,animElement:n,isOverMaxZIndex:o}},getMaxZIndex(a=1){return this.getMaxZIndexNodeInfo(a).zIndex},removeInstance(a,t,e=false){function n(r){typeof r.beforeRemoveCallBack=="function"&&r.beforeRemoveCallBack(r),r?.animElement?.remove(),r?.popsElement?.remove(),r?.maskElement?.remove(),r?.$shadowContainer?.remove();}return a.forEach(r=>{r.forEach((o,i)=>{if(e||o.guid===t){let s=o.animElement.getAttribute("anim");if(ae.hasAnim(s)){let l=s+"-reverse";o.animElement.style.width="100%",o.animElement.style.height="100%",o.animElement.style["animation-name"]=l,ae.hasAnim(o.animElement.style["animation-name"])?p.on(o.animElement,p.getAnimationEndNameList(),function(){n(o);},{capture:true}):n(o);}else n(o);r.splice(i,1);}});}),a},hide(a,t,e,n,r,o){return new Promise(i=>{let s=r.querySelector(".pops[type-value]");if(a==="drawer"){let c=n;D.setTimeout(()=>{o.style.setProperty("display","none"),["top","bottom"].includes(c.direction)?s.style.setProperty("height","0"):["left","right"].includes(c.direction)?s.style.setProperty("width","0"):console.error("未知direction：",c.direction),i();},c.closeDelay);}else {let c=t.find(d=>d.guid===e);if(c){let d=c;if(d.animElement.style.width="100%",d.animElement.style.height="100%",d.animElement.style["animation-name"]=d.animElement.getAttribute("anim")+"-reverse",ae.hasAnim(d.animElement.style["animation-name"])){let f=function(){d.animElement.style.display="none",d.maskElement&&(d.maskElement.style.display="none"),p.off(d.animElement,p.getAnimationEndNameList(),f,{capture:true}),i();};p.on(d.animElement,p.getAnimationEndNameList(),f,{capture:true});}else d.animElement.style.display="none",d.maskElement&&(d.maskElement.style.display="none"),i();}}})},show(a,t,e,n,r,o){return new Promise(i=>{let s=r.querySelector(".pops[type-value]");if(a==="drawer"){let c=n;D.setTimeout(()=>{p.css(o,"display","");let d=c.direction,f=c.size.toString();["top","bottom"].includes(d)?s.style.setProperty("height",f):["left","right"].includes(d)?s.style.setProperty("width",f):console.error("未知direction：",d),i();},c.openDelay??0);}else {let c=t.find(d=>d.guid===e);if(c){let d=c;if(d.animElement.style.width="",d.animElement.style.height="",d.animElement.style["animation-name"]=d.animElement.getAttribute("anim").replace("-reverse",""),ae.hasAnim(d.animElement.style["animation-name"])){let f=function(){p.off(d.animElement,p.getAnimationEndNameList(),f,{capture:true}),i();};d.animElement.style.display="",d.maskElement&&(d.maskElement.style.display=""),p.on(d.animElement,p.getAnimationEndNameList(),f,{capture:true});}else d.animElement.style.display="",d.maskElement&&(d.maskElement.style.display=""),i();}}})},close(a,t,e,n,r){return new Promise(o=>{let i=r.querySelector(".pops[type-value]"),s=n;function l(){function c(f){f.propertyName==="transform"&&(p.off(i,p.getTransitionEndNameList(),void 0,c),ut.removeInstance([t],e),o());}if(p.on(i,p.getTransitionEndNameList(),c),getComputedStyle(i).transform!=="none"){p.trigger(i,p.getTransitionEndNameList(),void 0,true);return}["top"].includes(s.direction)?i.style.setProperty("transform","translateY(-100%)"):["bottom"].includes(s.direction)?i.style.setProperty("transform","translateY(100%)"):["left"].includes(s.direction)?i.style.setProperty("transform","translateX(-100%)"):["right"].includes(s.direction)?i.style.setProperty("transform","translateX(100%)"):console.error("未知direction：",s.direction);}a==="drawer"?D.setTimeout(()=>{l();},s.closeDelay):(ut.removeInstance([t],e),o());})},drag(a,t){t=Object.assign({limit:true,extraDistance:3,container:V.globalThis,triggerClick:true},t);let e=false,n=0,r=0,o=D.AnyTouch(),i=new o(t.dragElement,{preventDefault(h){return typeof t.preventEvent=="function"?t.preventEvent(h):true}});p.css(t.dragElement,{cursor:"move"});function s(h){let b=0,v=0,E=V.globalThis.getComputedStyle(h).transform;if(E!=="none"&&E!=null&&E!==""){let T=E.match(/\((.+)\)/)?.[1].split(",");b=Math.abs(parseInt(T[4])),v=Math.abs(parseInt(T[5]));}return {transformLeft:b,transformTop:v}}function l(h){let b=h.style.transitionDuration;return globalThis.getComputedStyle(h).transitionDuration!=="0s"&&(h.style.transitionDuration="0s"),()=>{h.style.transitionDuration=b;}}function c(h){return h=h??globalThis,{width:p.width(h),height:p.height(h)}}function d(h){if(h=h??globalThis,D.isWin(h))return {left:0,top:0};{let b=h.getBoundingClientRect();return {left:b.left,top:b.top}}}let f=s(a),u=f.transformLeft,g=f.transformTop,w=null;i.on("pan",function(h){if(!e){e=true;let E=t.dragElement.getBoundingClientRect();n=h.x-E.left,r=h.y-E.top,f=s(a),u=f.transformLeft,g=f.transformTop,w=l(a);}let b=h.x-n+u,v=h.y-r+g;if(h.phase==="move"){if(t.limit){let E=c(t.container).width-p.width(a)+u,{left:T,top:S}=d(t.container),C=c(t.container).height-p.height(a)+g;b>E&&(b=E),v>C&&(v=C),b-t.extraDistance*2<T+u?(b=T+u,b+=t.extraDistance):b-=t.extraDistance,v-t.extraDistance*2<S+g?(v=S+g,v+=t.extraDistance):v-=t.extraDistance;}typeof t.moveCallBack=="function"&&t.moveCallBack(a,b,v),p.css(a,{left:b+"px",top:v+"px"});}h.phase==="end"&&(e=false,typeof w=="function"&&(w(),w=null),typeof t.endCallBack=="function"&&t.endCallBack(a,b,v));}),t.triggerClick&&i.on(["tap"],function(h){h.changedPoints.forEach(b=>{p.trigger(b.target,"click",void 0,true);});});},sortElementListByProperty(a,t,e=true){if(typeof e!="boolean")throw new TypeError("参数 sortByDesc 必须为boolean类型");if(a==null||t==null)throw new Error("获取前面的值或后面的值的方法不能为空");return function(n,r){var o=a(r),i=t(n);return e?i>o?-1:i<o?1:0:i<o?-1:i>o?1:0}}},wt={config:{},setGlobalConfig(a){Reflect.ownKeys(a).forEach(t=>{Reflect.set(wt.config,t,Reflect.get(a,t));});},getGlobalConfig(){let a={};return Object.keys(wt.config).forEach(t=>{let e=Reflect.get(wt.config,t);if(t==="style"){let n=e==null?"":typeof e=="function"?e():e;typeof n=="string"&&(a.style=n);}else if(t==="zIndex"){let n=e==null?"":typeof e=="function"?e():e;if(typeof n=="string"){let r=n=parseInt(n);isNaN(r)||(a.zIndex=r);}else isNaN(n)||(a.zIndex=n);}else if(t==="mask"){let n=wt.config.mask==null?{}:wt.config.mask;typeof n=="object"&&n!=null&&(a.mask=n);}else Reflect.set(a,t,e);}),a}};var Ka=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">\r
	<path\r
		fill="currentColor"\r
...
`,xi=`<svg viewBox="0 0 1123 1024" xmlns="http://www.w3.org/2000/svg">\r
	<path\r
...
`;const at={$data:{min:Ka,mise:Xa,max:Qa,close:Ya,edit:Ja,share:Za,delete:ti,search:ei,upload:ni,loading:ri,next:oi,prev:ai,eleme:ii,elemePlus:si,chromeFilled:li,cpu:ci,videoPlay:di,videoPause:fi,headset:pi,monitor:ui,documentCopy:hi,picture:bi,circleClose:gi,view:mi,hide:yi,keyboard:xi,arrowRight:wi,arrowLeft:vi},hasIcon(a){return Object.keys(at.$data).includes(a)},getIcon(a){return at.$data[a]},deleteIcon(a){return Reflect.deleteProperty(at.$data,a)},setIcon(a,t){Reflect.set(at.$data,a,t);}},W={getMaskHTML(a,t=101,e=""){return t=t-100,e.startsWith(";")&&(e=e.replace(";","")),`<div class="pops-mask" data-guid="${a}" style="z-index:${t};${e}"></div>`},getAnimHTML(a,t,e,n="",r="",o){let i=e,s="",l="",c=i.position||"";e.zIndex!=null&&(s+=`z-index: ${o};`,l+=`z-index: ${o};`),i.width!=null&&(l+=`width: ${i.width};`),i.height!=null&&(l+=`height: ${i.height};`);let d=r.trim()!=="";return `
		<div class="pops-anim" anim="${i.animation||""}" style="${s}" data-guid="${a}">${e.style!=null?`<style tyle="text/css">${e.style}</style>`:""}
			...
			<div class="pops-alert-content" style="${u}">${n.content.html?n.content.text:`<p pops style="${g}">${n.content.text}</p>`}</div>${c}`,c,i),h=W.parseElement(w),{popsElement:b,headerCloseBtnElement:v,btnOkElement:E,titleElement:T}=L.handleQueryElement(h,e),S=null,C=[h];n.mask.enable&&(S=L.handleMask({type:e,guid:t,config:n,animElement:h,maskHTML:s}).maskElement,C.push(S));let I=L.handleEventDetails(t,r,o,e,h,b,S,n);return L.handleClickEvent("close",v,I,n.btn.close.callback),L.handleClickEvent("ok",E,I,n.btn.ok.callback),p.append(o,C),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),S!=null&&h.after(S),L.handlePush(e,{guid:t,animElement:h,popsElement:b,maskElement:S,$shadowContainer:r,$shadowRoot:o}),n.drag&&ut.drag(b,{dragElement:T,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),L.handleResultDetails(I)}},Ei=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:"350px",height:"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),Ti={init(a){const t=D.getRandomGUID(),e="confirm";let n=Ei();n=D.assign(n,wt.getGlobalConfig()),n=D.assign(n,a),n=L.handleOnly(e,n);const{$shadowContainer:r,$shadowRoot:o}=L.handlerShadow(n);L.handleInit(o,[B.index,B.ninePalaceGridPosition,B.scrollbar,B.button,B.anim,B.common,B.confirmCSS]);let i=L.handleZIndex(n.zIndex),s=W.getMaskHTML(t,i),l=W.getHeaderBtnHTML(e,n),c=W.getBottomBtnHTML(e,n),{headerStyle:d,headerPStyle:f}=W.getHeaderStyle(e,n),{contentStyle:u,contentPStyle:g}=W.getContentStyle(e,n),w=W.getAnimHTML(t,e,n,`
            <div class="pops-confirm-title" style="text-align: ${n.title.position};${d}">${n.title.html?n.title.text:`<p pops style="${f}">${n.title.text}</p>`}${l}</div>
                        <div class="pops-confirm-content" style="${u}">${n.content.html?n.content.text:`<p pops style="${g}">${n.content.text}</p>`}</div>${c}`,c,i),h=W.parseElement(w),{popsElement:b,titleElement:v,headerCloseBtnElement:E,btnOkElement:T,btnCancelElement:S,btnOtherElement:C}=L.handleQueryElement(h,e),I=null,q=[h];n.mask.enable&&(I=L.handleMask({type:e,guid:t,config:n,animElement:h,maskHTML:s}).maskElement,q.push(I));let j=L.handleEventDetails(t,r,o,e,h,b,I,n);return L.handleClickEvent("close",E,j,n.btn.close.callback),L.handleClickEvent("ok",T,j,n.btn.ok.callback),L.handleClickEvent("cancel",S,j,n.btn.cancel.callback),L.handleClickEvent("other",C,j,n.btn.other.callback),p.append(o,q),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),I!=null&&h.after(I),L.handlePush(e,{guid:t,animElement:h,popsElement:b,maskElement:I,$shadowContainer:r,$shadowRoot:o}),n.drag&&ut.drag(b,{dragElement:v,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),L.handleResultDetails(j)}},Si=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"",select:false,password:false,row:false,focus:true,placeholder:"默认提示",style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"success",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:"350px",height:"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),Ci={init(a){const t=D.getRandomGUID(),e="prompt";let n=Si();n=D.assign(n,wt.getGlobalConfig()),n=D.assign(n,a),n=L.handleOnly(e,n);const{$shadowContainer:r,$shadowRoot:o}=L.handlerShadow(n);L.handleInit(o,[B.index,B.ninePalaceGridPosition,B.scrollbar,B.button,B.anim,B.common,B.promptCSS]);let i=L.handleZIndex(n.zIndex),s=W.getMaskHTML(t,i),l=W.getHeaderBtnHTML(e,n),c=W.getBottomBtnHTML(e,n),{headerStyle:d,headerPStyle:f}=W.getHeaderStyle(e,n),{contentPStyle:u}=W.getContentStyle(e,n),g=W.getAnimHTML(t,e,n,`
            ...
            <div class="pops-prompt-content" style="${u}">${n.content.row?'<textarea pops="" placeholder="'+n.content.placeholder+'"></textarea>':'<input pops="" placeholder="'+n.content.placeholder+'" type="'+(n.content.password?"password":"text")+'">'}</div>${c}`,c,i),w=W.parseElement(g),{popsElement:h,inputElement:b,headerCloseBtnElement:v,btnOkElement:E,btnCancelElement:T,btnOtherElement:S,titleElement:C}=L.handleQueryElement(w,e),I=null,q=[w];n.mask.enable&&(I=L.handleMask({type:e,guid:t,config:n,animElement:w,maskHTML:s}).maskElement,q.push(I));let j=L.handleEventDetails(t,r,o,e,w,h,I,n);return b.value=n.content.text,L.handlePromptClickEvent("close",b,v,j,n.btn.close.callback),L.handlePromptClickEvent("ok",b,E,j,n.btn.ok.callback),L.handlePromptClickEvent("cancel",b,T,j,n.btn.cancel.callback),L.handlePromptClickEvent("other",b,S,j,n.btn.other.callback),p.append(o,q),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),I!=null&&w.after(I),L.handlePush(e,{guid:t,animElement:w,popsElement:h,maskElement:I,$shadowContainer:r,$shadowRoot:o}),n.drag&&ut.drag(h,{dragElement:C,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),n.content.focus&&b.focus(),n.content.select&&b.select(),L.handleResultDetails(j)}},ki=()=>({parent:document.body,content:{text:"加载中...",icon:"loading",style:""},useShadowRoot:true,class:"",only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",forbiddenScroll:false,isAbsolute:false,style:null,addIndexCSS:true}),Ye={init(a){let t=ki();t=D.assign(t,wt.getGlobalConfig()),t=D.assign(t,a);let e=D.getRandomGUID();const n="loading";t=L.handleOnly(n,t);let r=L.handleZIndex(t.zIndex),o=W.getMaskHTML(e,r),{contentPStyle:i}=W.getContentStyle("loading",t),s=W.getAnimHTML(e,n,t,`
            ...
            </div>`,"",r),l=W.parseElement(s),{popsElement:c}=L.handleQueryElement(l,n),d=null,f=[l];t.mask.enable&&(d=L.handleMask({type:n,guid:e,config:t,animElement:l,maskHTML:o}).maskElement,f.push(d));let u=L.handleLoadingEventDetails(e,n,l,c,d,t);return p.append(t.parent,f),d!=null&&l.after(d),L.handlePush(n,{guid:e,animElement:l,popsElement:c,maskElement:d}),t.isAbsolute&&(p.css(l,"position","absolute !important"),d&&p.css(d,"position","absolute !important")),L.handleResultDetails(u)}},Mi=()=>({title:{position:"center",text:"",html:false,style:""},loading:{enable:true,icon:true,text:""},useShadowRoot:true,class:"",url:window.location.href,only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",position:"center",drag:true,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},width:"300px",height:"250px",topRightButton:"min|max|mise|close",sandbox:false,forbiddenScroll:false,loadEndCallBack(){},btn:{min:{callback(){}},max:{callback(){}},mise:{callback(){}},close:{callback(){}}},style:null,beforeAppendToPageCallBack(){}}),$i={init(a){const t=D.getRandomGUID(),e="iframe";let n=Mi();if(n=D.assign(n,wt.getGlobalConfig()),n=D.assign(n,a),n.url==null)throw new Error("config.url不能为空");n=L.handleOnly(e,n);const{$shadowContainer:r,$shadowRoot:o}=L.handlerShadow(n);L.handleInit(o,[B.index,B.ninePalaceGridPosition,B.scrollbar,B.anim,B.common,B.iframeCSS]);let i=n.animation!=null&&n.animation!=""?"position:absolute;":"",s=L.handleZIndex(n.zIndex),l=W.getMaskHTML(t,s,i),c=W.getHeaderBtnHTML(e,n),d='<div class="pops-loading"></div>',f=n.title.text.trim()!==""?n.title.text:n.url,{headerStyle:u,headerPStyle:g}=W.getHeaderStyle(e,n),w=W.getAnimHTML(t,e,n,`
            <div class="pops-iframe-title" style="text-align: ${n.title.position};${u}">${n.title.html?f:`<p pops style="${g}">${f}</p>`}${c}</div>
			...
			</div>${n.loading.enable?d:""}`,"",s),h=W.parseElement(w),{popsElement:b,headerCloseBtnElement:v,headerControlsElement:E,titleElement:T,iframeElement:S,loadingElement:C,contentLoadingElement:I,headerMinBtnElement:q,headerMaxBtnElement:j,headerMiseBtnElement:J}=L.handleQueryElement(h,e),Z=V.document.querySelector(".pops-iframe-container");Z||(Z=V.document.createElement("div"),Z.className="pops-iframe-container",Z.style.cssText="display: flex;position: fixed;bottom: 0px;flex-flow: wrap-reverse;user-select: none;-webkit-user-select: none;-ms-user-select: none;-moz-user-select: none;",p.appendBody(Z));let lt=null,k=[h];n.mask.enable&&(lt=L.handleMask({type:e,guid:t,config:n,animElement:h,maskHTML:l}).maskElement,k.push(lt));let x=L.handleEventDetails(t,r,o,e,h,b,lt,n);x.iframeElement=S,p.on(h,p.getAnimationEndNameList(),function(){h.style.width="0%",h.style.height="0%";}),p.on(S,"load",()=>{C?.remove(),I.style.animation="iframeLoadingChange_85 0.3s forwards",p.on(I,p.getAnimationEndNameList(),()=>{I.remove();}),n.title.text.trim()===""&&S.contentDocument&&(T.querySelector("p").innerText=S.contentDocument.title),n.loadEndCallBack(x);}),p.append(o,k),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),Z.appendChild(r),lt!=null&&h.after(lt),n.drag&&ut.drag(b,{dragElement:T,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack});const m="type-module";let y="",M="",_=false;return p.on(q,"click",H=>{H.preventDefault(),H.stopPropagation(),y=b.style.left,M=b.style.top,b.classList.add("pops-iframe-unset-top"),b.classList.add("pops-iframe-unset-left"),b.classList.add("pops-iframe-unset-transform"),b.style.transitionDuration="",b.setAttribute(m,"min"),E.setAttribute("type","min"),j.style.setProperty("display","none"),J.style.setProperty("display",""),typeof n?.btn?.min?.callback=="function"&&n.btn.min.callback(x,H);},{capture:true}),p.on(j,"click",H=>{H.preventDefault(),H.stopPropagation(),b.getAttribute(m)!=="min"&&(y=b.style.left,M=b.style.top),_=true,b.style.transitionDuration="",b.style.transform="",b.removeAttribute(m),b.classList.add("pops-iframe-unset-transition"),b.classList.add("pops-iframe-unset-left"),b.classList.add("pops-iframe-unset-top"),b.classList.add("pops-iframe-unset-transform"),b.classList.remove("pops-iframe-unset-transition"),b.setAttribute(m,"max"),E.setAttribute("type","max"),j.style.setProperty("display","none"),J.style.setProperty("display",""),typeof n?.btn?.max?.callback=="function"&&n.btn.max.callback(x,H);},{capture:true}),J?.style?.setProperty("display","none"),p.on(J,"click",H=>{H.preventDefault(),H.stopPropagation(),_&&b.getAttribute(m)==="min"?(b.classList.add("pops-iframe-unset-transition"),b.classList.add("pops-iframe-unset-left"),b.classList.add("pops-iframe-unset-top"),b.classList.add("pops-iframe-unset-transform"),b.classList.remove("pops-iframe-unset-transition"),b.setAttribute(m,"max"),E.setAttribute("type","max")):(_=false,b.style.left=y,b.style.top=M,b.style.transitionDuration="",b.style.transform="",E.removeAttribute("type"),b.removeAttribute(m),b.classList.remove("pops-iframe-unset-top"),b.classList.remove("pops-iframe-unset-left"),b.classList.remove("pops-iframe-unset-transform"),j.style.setProperty("display",""),J.style.setProperty("display","none")),typeof n?.btn?.mise?.callback=="function"&&n.btn.mise.callback(x,H);},{capture:true}),p.on(v,"click",H=>{H.preventDefault(),H.stopPropagation(),ut.removeInstance([mt.iframe],t,false),typeof n?.btn?.close?.callback=="function"&&n.btn.close.callback(x,H);},{capture:true}),L.handlePush(e,{guid:t,animElement:h,popsElement:b,maskElement:lt,$shadowContainer:r,$shadowRoot:o}),L.handleResultDetails(x)}},Li=()=>({title:{enable:true,position:"center",text:"默认标题",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:null},useShadowRoot:true,class:"",zIndex:1e4,only:false,direction:"right",size:"30%",lockScroll:false,closeOnPressEscape:true,openDelay:0,closeDelay:0,borderRadius:0,style:null,beforeAppendToPageCallBack(){},forbiddenScroll:false}),Ii={init(a){const t=D.getRandomGUID(),e="drawer";let n=Li();n=D.assign(n,wt.getGlobalConfig()),n=D.assign(n,a),n=L.handleOnly(e,n);const{$shadowContainer:r,$shadowRoot:o}=L.handlerShadow(n);L.handleInit(o,[B.index,B.ninePalaceGridPosition,B.scrollbar,B.button,B.anim,B.common,B.drawerCSS]);let i=L.handleZIndex(n.zIndex),s=W.getMaskHTML(t,i),l=W.getHeaderBtnHTML(e,n),c=W.getBottomBtnHTML(e,n),{headerStyle:d,headerPStyle:f}=W.getHeaderStyle(e,n),{contentStyle:u,contentPStyle:g}=W.getContentStyle(e,n),w=W.getAnimHTML(t,e,n,`
            ${n.title.enable?`
            ...
            </div>${g}`,g,d),v=W.parseElement(b),{popsElement:E,titleElement:T,contentElement:S,folderListBodyElement:C,folderFileListBreadcrumbPrimaryElement:I,headerCloseBtnElement:q,btnOkElement:j,btnCancelElement:J,btnOtherElement:Z,folderListSortFileNameElement:lt,folderListSortLatestTimeElement:k,folderListSortFileSizeElement:x}=L.handleQueryElement(v,e),m=null,y=[v];n.mask.enable&&(m=L.handleMask({type:e,guid:t,config:n,animElement:v,maskHTML:f}).maskElement,y.push(m));let M=L.handleEventDetails(t,r,o,e,v,E,m,n);L.handleClickEvent("close",q,M,n.btn.close.callback),L.handleClickEvent("ok",j,M,n.btn.ok.callback),L.handleClickEvent("cancel",J,M,n.btn.cancel.callback),L.handleClickEvent("other",Z,M,n.btn.other.callback),p.append(o,y),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),m!=null&&v.after(m),n.folder.sort();function _(G,F="-",tt="-",ft=false){let X=G,nt=F,At=tt,gt=p.createElement("tr"),xt=p.createElement("td"),bt=p.createElement("td"),Mt=p.createElement("td"),Zt="",Rt=st.folder;if(ft)F="",tt="";else {Rt="",typeof F=="number"&&(F=D.formatTime(F)),typeof tt=="number"&&(tt=D.formatByteToSize(tt));for(let He in st)if(G.toLowerCase().endsWith("."+He)){Zt=He,Rt=st[He];break}Rt||(Zt="Null",Rt=st.Null);}gt.className="pops-folder-list-table__body-row",xt.className="pops-folder-list-table__body-td",bt.className="pops-folder-list-table__body-td",Mt.className="pops-folder-list-table__body-td",Q.setSafeHTML(xt,`
            ...
            `),Q.setSafeHTML(bt,`
				...
				`);let me={fileName:X,latestTime:nt,fileSize:At,isFolder:ft};return xt.__value__=me,bt.__value__=me,Mt.__value__=me,gt.__value__=me,gt.appendChild(xt),gt.appendChild(bt),gt.appendChild(Mt),{folderELement:gt,fileNameElement:xt,fileTimeElement:bt,fileFormatSize:Mt}}function P(G,F="-",tt="-",ft=false){let X=G,nt=F,At=tt,gt=p.createElement("tr"),xt=p.createElement("td"),bt="",Mt=st.folder;if(ft)F="",tt="";else {Mt="",typeof F=="number"&&(F=D.formatTime(F)),typeof tt=="number"&&(tt=D.formatByteToSize(tt));for(let Rt in st)if(G.toLowerCase().endsWith("."+Rt)){bt=Rt,Mt=st[Rt];break}Mt||(bt="Null",Mt=st.Null);}gt.className="pops-folder-list-table__body-row",xt.className="pops-folder-list-table__body-td",Q.setSafeHTML(xt,`
			...
			`);const n={[Symbol.toStringTag]:"PopsPanelTextArea",$ele:{panelTextarea:t.querySelector(".pops-panel-textarea"),textarea:t.querySelector(".pops-panel-textarea textarea")},$data:{value:a.getValue()},init(){this.setValue(this.$data.value),this.setChangeEvent(),a.disabled&&this.disable();},disable(){this.$ele.textarea.setAttribute("disabled","true"),this.$ele.panelTextarea.classList.add("pops-panel-textarea-disable");},notDisable(){this.$ele.textarea.removeAttribute("disabled"),this.$ele.panelTextarea.classList.remove("pops-panel-textarea-disable");},isDisabled(){return this.$ele.textarea.hasAttribute("disabled")||this.$ele.panelTextarea.classList.contains("pops-panel-textarea-disable")},setValue(r){this.$ele.textarea.value=r;},setChangeEvent(){p.on(this.$ele.textarea,["input","propertychange"],void 0,r=>{let o=this.$ele.textarea.value;this.$data.value=o,typeof a.callback=="function"&&a.callback(r,o);});}};return n.init(),Reflect.set(t,"data-textarea",n),t},createSectionContainerItem_select(a){const t=this;let e=document.createElement("li");Reflect.set(e,"__formConfig__",a),this.setElementClassName(e,a.className),this.setElementAttributes(e,a.attributes),this.setElementProps(e,a.props);let n="";a.description&&(n=`<p class="pops-panel-item-left-desc-text">${a.description}</p>`),Q.setSafeHTML(e,`
				...
				`);const s={[Symbol.toStringTag]:"PopsPanelDeepMenu",$ele:{get parentSection(){return t.$el.$contentSectionContainer}},init(){this.setLiClickEvent();},initFormItem(l,c){let d=c;if(d.type==="forms"){let f=d.forms,u=document.createElement("li"),g=document.createElement("ul");g.classList.add("pops-panel-forms-container-item-formlist"),u.classList.add("pops-panel-forms-container-item");let w=p.createElement("div",{className:"pops-panel-forms-container-item-header-text"});Q.setSafeHTML(w,d.text),d.isFold&&(Q.setSafeHTML(w,`
							...
							`),p.on(w,"click",h=>{u.hasAttribute("data-fold-enable")?u.removeAttribute("data-fold-enable"):u.setAttribute("data-fold-enable","");}),w.classList.add("pops-panel-forms-fold-container"),w.classList.add("pops-user-select-none"),u.setAttribute("data-fold-enable",""),u.classList.add("pops-panel-forms-fold")),u.appendChild(w),t.setElementClassName(u,c.className),t.setElementAttributes(u,c.attributes),t.setElementProps(u,c.props),f.forEach(h=>{t.uListContainerAddItem(h,{ulElement:g,sectionContainerULElement:t.sectionContainerULElement,formContainerListElement:u,formHeaderDivElement:w});}),u.appendChild(g),l.appendChild(u),typeof d.afterAddToUListCallBack=="function"&&d.afterAddToUListCallBack(a,{target:u,ulElement:g,sectionContainerULElement:t.sectionContainerULElement,formContainerListElement:u,formHeaderDivElement:w});}else t.uListContainerAddItem(a,{ulElement:t.sectionContainerULElement});},gotoDeepMenu(l,c){let d=c.closest("section.pops-panel-container");d&&p.cssHide(d,true);let f=p.createElement("section",{className:"pops-panel-container pops-panel-deepMenu-container"});Reflect.set(f,"__formConfig__",a);let u=p.createElement("ul",{className:"pops-panel-deepMenu-container-header-ul"}),g=p.createElement("ul"),w=a.headerTitle??a.text,h=p.createElement("div",{className:"pops-panel-deepMenu-container-header",innerHTML:`<p>${w}</p>`}),b=p.createElement("i",{className:"pops-panel-deepMenu-container-left-arrow-icon",innerHTML:at.getIcon("arrowLeft")});if(p.on(b,"click",v=>{p.preventEvent(v);let E=f.previousElementSibling;p.cssShow(E),f.remove(),t.triggerRenderRightContainer(E);},{once:true}),h.firstElementChild?.insertAdjacentElement("beforebegin",b),u.appendChild(h),f.appendChild(u),f.appendChild(g),a.forms&&Array.isArray(a.forms))for(let v=0;v<a.forms.length;v++){let E=a.forms[v];this.initFormItem(g,E);}t.$el.$content?.appendChild(f),typeof a.afterEnterDeepMenuCallBack=="function"&&a.afterEnterDeepMenuCallBack(a,{sectionContainer:f,sectionContainerHeaderContainer:u,sectionContainerHeader:h,sectionBodyContainer:g}),t.triggerRenderRightContainer(f);},setLiClickEvent(){p.on(e,"click",void 0,async l=>{typeof a.clickCallBack=="function"&&await a.clickCallBack(l,a)||this.gotoDeepMenu(l,e);});}};return s.init(),Reflect.set(e,"data-deepMenu",s),e},createSectionContainerItem_own(a){let t=document.createElement("li");return Reflect.set(t,"__formConfig__",a),a.className&&(t.className=a.className),t=a.getLiElementCallBack(t),t},createSectionContainerItem(a){let t=a.type;if(t==="switch")return this.createSectionContainerItem_switch(a);if(t==="slider")return this.createSectionContainerItem_slider_new(a);if(t==="input")return this.createSectionContainerItem_input(a);if(t==="textarea")return this.createSectionContainerItem_textarea(a);if(t==="select")return this.createSectionContainerItem_select(a);if(t==="select-multiple")return this.createSectionContainerItem_select_multiple_new(a);if(t==="button")return this.createSectionContainerItem_button(a);if(t==="deepMenu")return this.createSectionContainerItem_deepMenu(a);if(t==="own")return this.createSectionContainerItem_own(a);console.error("尚未实现的type类型",a);},createSectionContainerItem_forms(a){let t=this,e=a;if(e.type==="forms"){let n=a.forms,r=document.createElement("li"),o=document.createElement("ul");o.classList.add("pops-panel-forms-container-item-formlist"),r.classList.add("pops-panel-forms-container-item");let i=p.createElement("div",{className:"pops-panel-forms-container-item-header-text"});Q.setSafeHTML(i,e.text),e.isFold&&(Q.setSafeHTML(i,`
						<p>${e.text}</p>
						<i class="pops-panel-forms-fold-container-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
								<path d="M340.864 149.312a30.592 30.592 0 0 0 0 42.752L652.736 512 340.864 831.872a30.592 30.592 0 0 0 0 42.752 29.12 29.12 0 0 0 41.728 0L714.24 534.336a32 32 0 0 0 0-44.672L382.592 149.376a29.12 29.12 0 0 0-41.728 0z"></path>
			...
			</div>`,"",i),u=W.parseElement(f),{popsElement:g,headerCloseBtnElement:w,titleElement:h,contentElement:b,contentAsideElement:v,contentSectionContainerElement:E}=L.handleQueryElement(u,e);(n.isMobile||D.isPhone())&&p.addClassName(g,n.mobileClassName);let T=null,S=[u];if(n.mask.enable){let{maskElement:j}=L.handleMask({type:e,guid:t,config:n,animElement:u,maskHTML:s});T=j,S.push(T);}let C=L.handleEventDetails(t,r,o,e,u,g,T,n);return L.handleClickEvent("close",w,C,n.btn.close.callback),p.append(o,S),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),T!=null&&u.after(T),br().init({config:n,$el:{$pops:g,$content:b,$contentAside:v,$contentSectionContainer:E}}),L.handlePush(e,{guid:t,animElement:u,popsElement:g,maskElement:T,$shadowContainer:r,$shadowRoot:o}),n.drag&&ut.drag(g,{dragElement:h,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),{...L.handleResultDetails(C),addEventListener:(j,J,Z)=>{g.addEventListener(j,J,Z);},removeEventListener:(j,J,Z)=>{g.removeEventListener(j,J,Z);}}}},Bi=()=>({target:document.documentElement,targetSelector:null,data:[{icon:at.getIcon("search"),iconIsLoading:false,text:"搜索",item:[],callback(a,t,e){console.log("点击："+this.text,[a,t,e]);}},{icon:at.getIcon("documentCopy"),iconIsLoading:false,text:"复制",item:[],callback(a,t,e){console.log("点击："+this.text,[a,t,e]);}},{icon:at.getIcon("delete"),text:"删除",iconIsLoading:false,item:[],callback(a,t,e){console.log("点击："+this.text,[a,t,e]);}},{icon:at.getIcon("loading"),iconIsLoading:true,text:"加载",item:[],callback(a,t,e){return console.log("点击："+this.text,[a,t,e]),false}},{icon:at.getIcon("elemePlus"),iconIsLoading:true,text:"饿了么",callback(a,t,e){return console.log("点击："+this.text,[a,t,e]),false},item:[{icon:"",iconIsLoading:false,text:"处理文件",item:[],callback(a,t,e){console.log("点击："+this.text,[a,t,e]);}},{icon:"",iconIsLoading:false,text:"其它处理",callback(a,t,e){console.log("点击："+this.text,[a,t,e]);},item:[{icon:at.getIcon("view"),iconIsLoading:false,text:"查看",item:[],callback(a,t,e){console.log("点击："+this.text,[a,t,e]);}}]}]}],chileMenuLeftOrRightDistance:0,childMenuTopOrBottomDistance:0,useShadowRoot:true,className:"",isAnimation:true,only:false,zIndex:1e4,preventDefault:true,style:null,beforeAppendToPageCallBack(){}}),Ni={init(a){const t=D.getRandomGUID(),e="rightClickMenu";let n=Bi();if(n=D.assign(n,wt.getGlobalConfig()),n=D.assign(n,a),n=L.handleOnly(e,n),n.target==null)throw new Error("config.target 不能为空");a.data&&(n.data=a.data);const{$shadowContainer:r,$shadowRoot:o}=L.handlerShadow(n);if(L.handleInit(o,[B.index,B.anim,B.common,B.rightClickMenu]),n.style!=null){let s=p.createElement("style",{innerHTML:n.style},{type:"text/css"});o.appendChild(s);}const i={rootElement:null,windowCheckClickEvent(s){if(!i.rootElement)return;let l=s.target;l.closest(`.pops-${e}`)||l.className&&l.className==="pops-shadow-container"&&l.shadowRoot!=null||i.closeAllMenu(i.rootElement);},shadowRootCheckClickEvent(s){!i.rootElement||s.target.closest(`.pops-${e}`)||i.closeAllMenu(i.rootElement);},addWindowCheckClickListener(){if(p.on(globalThis,"click touchstart",void 0,i.windowCheckClickEvent,{capture:true}),n.target instanceof Node){const s=n.target.getRootNode();s instanceof ShadowRoot&&p.on(s,"click touchstart",void 0,i.shadowRootCheckClickEvent,{capture:true});}},removeWindowCheckClickListener(){if(p.off(globalThis,"click touchstart",void 0,i.windowCheckClickEvent,{capture:true}),n.target instanceof Node){const s=n.target.getRootNode();s instanceof ShadowRoot&&p.off(s,"click touchstart",void 0,i.windowCheckClickEvent,{capture:true});}},contextMenuEvent(s,l){n.preventDefault&&p.preventEvent(s),L.handleOnly(e,n),i.rootElement&&i.closeAllMenu(i.rootElement);let c=i.showMenu(s,n.data,l);i.rootElement=c,n.only&&L.handlePush(e,{$shadowRoot:o,$shadowContainer:r,guid:t,animElement:c,popsElement:c,beforeRemoveCallBack(d){i.closeAllMenu(d.popsElement);}});},addContextMenuEvent(s,l){p.on(s,"contextmenu",l,i.contextMenuEvent);},removeContextMenuEvent(s,l){p.off(s,"contextmenu",l,i.contextMenuEvent);},animationCloseMenu(s){function l(c){p.off(s,p.getTransitionEndNameList(),l,{capture:true}),s.remove();}s.classList.contains(`pops-${e}-anim-show`)?(p.on(s,p.getTransitionEndNameList(),l,{capture:true}),s.classList.remove(`pops-${e}-anim-show`)):s.remove();},closeAllMenu(s){if(s==null)return;s?.__menuData__?.root&&(s=s?.__menuData__?.root),s.__menuData__.child.forEach(c=>{this.animationCloseMenu(c);}),this.animationCloseMenu(s),i.rootElement=null;},getMenuContainerElement(s){let l=p.createElement("div",{className:`pops-${e}`,innerHTML:`
					<ul></ul>
					`}),c=this.getMenuZIndex();return c>1e4&&(l.style.zIndex=c.toString()),s&&l.setAttribute("is-children","true"),n.isAnimation&&p.addClassName(l,`pops-${e}-anim-grid`),l},getMenuZIndex(){return L.handleZIndex(n.zIndex)},getOffset(s,l,c){let d={top:0,right:0,bottom:0,left:0},f=p.width(s),u=p.height(s),g=1,w=p.width(globalThis)-g,h=p.height(globalThis)-g,b=w-f,v=h-u,E=n.chileMenuLeftOrRightDistance,T=n.childMenuTopOrBottomDistance,S=l.x,C=l.y;if(S=S<0?0:S,S+E>=b){if(c){let I=p.offset(c.$menu);S=w-I.left-E+g;}else S=g+E;S<0?S=0:S>b&&(S=b),d.right=S,Reflect.deleteProperty(d,"left");}else S=S+E,d.left=S,Reflect.deleteProperty(d,"right");if(C=C<0?0:C,C+T>=v){if(c){let I=p.offset(c.$parentItem,false);C=h-I.bottom-T+g;}else C=g+T;C<0?C=g:C>v&&(C=v),d.bottom=C,Reflect.deleteProperty(d,"top");}else C=C+T,d.top=C,Reflect.deleteProperty(d,"bottom");return d},showMenu(s,l,c){let d=this.getMenuContainerElement(false);Reflect.set(d,"__menuData__",{child:[]}),i.addMenuLiELement(s,d,d,l,c),p.css(d,{display:"none"}),p.append(o,d),document.contains(r)||(typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r));let f=this.getOffset(d,{x:s.clientX,y:s.clientY},null);return p.css(d,{...f,display:""}),n.isAnimation&&p.addClassName(d,`pops-${e}-anim-show`),d},showClildMenu(s,l,c,d,f,u){let g=this.getMenuContainerElement(true);Reflect.set(g,"__menuData__",{parent:f,root:d}),Reflect.get(d,"__menuData__").child.push(g),i.addMenuLiELement(s,d,g,c,u),p.css(g,{display:"none"}),p.append(o,g);let h=f.closest(".pops-rightClickMenu"),b=this.getOffset(g,{x:l.clientX,y:l.clientY},{$menu:h,$parentItem:f});return p.css(g,{...b,display:""}),n.isAnimation&&p.addClassName(g,`pops-${e}-anim-show`),g},addMenuLiELement(s,l,c,d,f){let u=s.target,g=c.querySelector("ul");d.forEach(w=>{let h=p.parseTextToDOM("<li></li>");if(typeof w.icon=="string"&&w.icon.trim()!==""){let E=at.getIcon(w.icon)??w.icon,T=p.parseTextToDOM(`<i class="pops-${e}-icon" is-loading="${w.iconIsLoading??false}">${E}</i>`);h.appendChild(T);}h.insertAdjacentHTML("beforeend",Q.getSafeHTML(`<span>${w.text}</span>`)),w.item&&Array.isArray(w.item)&&p.addClassName(h,`pops-${e}-item`);function b(){Array.from(g.children).forEach(S=>{if(p.removeClassName(S,`pops-${e}-is-visited`),!S.__menuData__)return;function C(I){I.querySelectorAll("ul li").forEach(q=>{q?.__menuData__?.child&&C(q.__menuData__.child);}),I.remove();}C(S.__menuData__.child);});for(let S=0;S<l.__menuData__.child.length;S++){let C=l.__menuData__.child[S];o.contains(C)||(l.__menuData__.child.splice(S,1),S--);}if(p.addClassName(h,`pops-${e}-is-visited`),!w.item)return;let E=h.getBoundingClientRect(),T=i.showClildMenu(s,{clientX:E.left+p.outerWidth(h),clientY:E.top},w.item,l,h,f);h.__menuData__={child:T};}async function v(E){if(typeof w.callback=="function"){try{tr.Object.defineProperty(s,"target",{get(){return u}});}catch{}let T=await w.callback(E,s,h,f);if(typeof T=="boolean"&&T==false)return}Array.from(g.children).forEach(T=>{p.off(T,"mouseenter touchstart");}),i.closeAllMenu(l);}p.on(h,"mouseenter touchstart",void 0,b),p.on(h,"click",void 0,v),g.appendChild(h);});}};return i.addContextMenuEvent(n.target,n.targetSelector),i.addWindowCheckClickListener(),{guid:t,config:n,removeWindowCheckClickListener:i.removeWindowCheckClickListener,addWindowCheckClickListener:i.addWindowCheckClickListener,removeContextMenuEvent:i.removeContextMenuEvent,addContextMenuEvent:i.addContextMenuEvent}}},Ui=()=>({target:null,inputTarget:null,selfDocument:document,data:[{value:"数据1",text:"数据1-html"},{value:"数据2",text:"数据2-html"}],deleteIcon:{enable:true,callback(a,t,e){console.log("删除当前项",[a,t,e]),t.remove();}},useShadowRoot:true,className:"",isAbsolute:true,isAnimation:true,width:"250px",maxHeight:"300px",followTargetWidth:true,topDistance:0,position:"auto",positionTopToReverse:true,zIndex:1e4,searchingTip:"正在搜索中...",toSearhNotResultHTML:'<li data-none="true">暂无其它数据</li>',toHideWithNotResult:false,followPosition:"target",getItemHTML(a){return a.text??a},async getData(a){return console.log("当前输入框的值是：",a),[]},itemClickCallBack(a,t,e){console.log("item项的点击回调",[a,t,e]),this.inputTarget.value=e.value;},selectCallBack(a,t,e){console.log("item项的选中回调",[a,t,e]);},style:""}),Vi={init(a){const t=D.getRandomGUID(),e="searchSuggestion";let n=Ui();if(n=D.assign(n,wt.getGlobalConfig()),n=D.assign(n,a),n.target==null)throw new Error("config.target 不能为空");n.inputTarget==null&&(n.inputTarget=n.target),a.data&&(n.data=a.data);const{$shadowContainer:r,$shadowRoot:o}=L.handlerShadow(n);if(L.handleInit(o,[B.index,B.anim,B.common]),n.style!=null){let s=document.createElement("style");p.createElement("style",{innerHTML:n.style},{type:"text/css"}),o.appendChild(s);}const i={selfDocument:n.selfDocument,$el:{root:null,$hintULContainer:null,$dynamicCSS:null},$data:{isEmpty:true},init(s=document.body||document.documentElement){this.initEl(),i.update(typeof n.data=="function"?n.data():n.data),i.updateDynamicCSS(),i.changeHintULElementWidth(),i.changeHintULElementPosition(),i.hide(),n.isAnimation&&i.$el.root.classList.add(`pops-${e}-animation`),o.appendChild(i.$el.root),s.appendChild(r);},initEl(){this.$el.root=i.getSearchSelectElement(),this.$el.$dynamicCSS=this.$el.root.querySelector("style[data-dynamic]"),this.$el.$hintULContainer=i.$el.root.querySelector("ul");},getSearchSelectElement(){let s=p.createElement("div",{className:`pops pops-${e}-search-suggestion`,innerHTML:`
			...
			`;}),A.html(a,e);},setTag(a,t,e){rt.clearTag(a),A.addClass(a,t),typeof e=="string"&&A.html(a,e);},clearTag(a){Object.keys(xr).forEach(t=>{A.removeClass(a,t);});}},$=a=>({type:"own",getLiElementCallBack(e){let n=A.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
				...
				`});return e.appendChild(n),e},async afterAddToUListCallBack(e,n){let r=n.target,o=r.querySelector(".pops-panel-item-left-text"),i=r.querySelector(".pops-panel-item-left-main-text"),s=r.querySelector(".pops-panel-item-left-desc-text"),l=await a();l.tag==null?A.html(i,l.text):A.html(i,xr[l.tag]+l.text),(l.description==null||l.description==="")&&A.hide(s,false),A.html(s,l.description||"");let c=["support-info"];if(l.tag!=null&&c.push(l.tag),A.addClass(i,c),typeof l.afterRender=="function")try{l.afterRender({...n,$leftContainer:o,$leftText:i,$leftDesc:s});}catch(d){console.log(d),rt.setTag(i,"error","afterRender 函数执行错误"+d);}}}),N={asideLastVisit:"aside-last-visit"},Wi={getWindow(){return Ct.unsafeWindow.isSupport()?vt:window}};class Ki{}class Oe extends Ki{isSupportGM(){return typeof Y=="object"&&Y!=null}}class it extends Oe{}const ot={getApiDocUrl(a,t){return t=t??a,`<a href="https://www.tampermonkey.net/documentation.php?ext=gcal&version=#api:${a}" target="_blank">${t}</a>`}};class Xi extends it{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof Y.addElement=="function"}}isSupport(){return typeof cn=="function"}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:t,fn:async(...r)=>new Promise(o=>{let i=Reflect.apply(cn,this,r);o(i);}),formList:n.forms[1].forms},{name:e.name,fn:Y.addElement,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push($(async()=>{let i=null,s=null,l=Wi.getWindow(),c=o+"_test_script_exec",d=`${c}_test_str`;try{return i=await r.fn("script",{id:c,textContent:`window["${d}"] = "bar";`}),s=document.querySelector("#"+c),i==null?{text:`${r.name} returns is null`,tag:"error"}:i instanceof HTMLElement?typeof l[d]!="string"?{text:`${r.name} script element is not work`,tag:"error"}:(Reflect.deleteProperty(l,d),{text:ht.escapeHtml("支持添加<script>元素且执行js"),tag:"success"}):{text:`${r.name} returns is not style element`,tag:"error"}}catch(f){return console.error(f),{text:"执行错误 "+f,tag:"error"}}finally{s&&s.remove();}}),$(async()=>{let i=null,s=null,l=o+"_test2";try{if(i=await r.fn(document.body,"div",{"data-src":"https://example.com/image.png",id:l}),i==null)return {text:r.name+" returns is null",tag:"error"};if(!(i instanceof HTMLElement))return {text:r.name+" returns is not style element",tag:"error"};if(s=document.querySelector("#"+l),!s)return {text:"不支持3个参数",tag:"error"};const c=s.attachShadow({mode:"closed"});return i=await r.fn(c,"style",{textContent:"div { color: black; };"}),c.querySelector("style")?i==null?{text:"传入3个参数但是返回为空",tag:"error"}:s.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(c){return console.error(c),{text:"执行错误 "+c,tag:"error"}}finally{s&&s.remove();}}));}),n}}class Qi extends it{isSupport(){return typeof dn=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof Y.addStyle=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-GM_addStyle"+t,title:t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:t,fn:async(...r)=>new Promise(o=>{let i=Reflect.apply(dn,this,r);o(i);}),formList:n.forms[1].forms},{name:e.name,fn:Y.addStyle,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push($(async()=>{let i=null,s=null;try{return i=A.createElement("div",{id:o,innerText:o+" test"}),document.body.appendChild(i),s=await r.fn(`
						...
						`),s==null?{text:`${r.name} returns is null`,tag:"error"}:s instanceof HTMLStyleElement?window.getComputedStyle(i).backgroundColor!=="rgb(255, 0, 0)"?{text:`${r.name} test element background is not rgb(255, 0, 0)`,tag:"error"}:{text:ht.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}:{text:`${r.name} returns is not HTMLStyleElement`,tag:"error"}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}finally{i?.remove(),s?.remove();}}));}),n}}class Yi extends it{isSupport(){return typeof Fe=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof Y.addValueChangeListener=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push((()=>{let r=t+"_key_1";return $(()=>({text:"测试监听数据存储改变",description:"",tag:"info",afterRender(o){let i=A.parseHTML(`
									...
									`,!1,!1);A.on(l,"click",c=>{try{z.preventEvent(c),Ot.list({},(d,f)=>{console.log(d),f?R.error(f):Array.isArray(d)?sn.alert({title:{text:"GM_cookie.list",position:"center"},content:{text:JSON.stringify(d,null,4),html:!0},drag:!0,mask:{enable:!0},width:Te.setting.width,height:Te.setting.height,style:`
															.pops-alert-content{
																white-space: pre-wrap;
															}
														`}):alert("获取的cookie信息不是数组");});}catch(d){R.error(d.toString(),{consoleLogContent:!0});}}),A.after(s.$leftContainer,l);}}}catch(s){return console.error(s),{text:"执行错误 "+s,tag:"error"}}finally{}}),$(()=>{try{return {text:ht.escapeHtml("测试set新增Cookie"),tag:"info",description:JSON.stringify(i),afterRender(s){let l=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击执行</span>
									...
									`,!1,!1);A.on(c,"click",d=>{try{z.preventEvent(d),Ot.delete(s,f=>{f?R.error(f,{consoleLogContent:!0}):R.success("delete cookie success");});}catch(f){R.error(f.toString(),{consoleLogContent:!0});}}),A.after(l.$leftContainer,c);}}}catch(s){return console.error(s),{text:"执行错误 "+s,tag:"error"}}finally{}}));}return r}}class Zi extends it{isSupport(){return typeof we=="function"}getApiName(){return "GM_deleteValue"}getAsyncApiOption(){return {name:"GM.deleteValue",isSupport:this.isSupportGM()&&typeof Y.deleteValue=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.name?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push((()=>{let r="Test GM_deleteValue null",o=null;return $(()=>({text:"测试存储null值并删除",description:`"${r}": ${o}`,tag:"info",afterRender(i){let s=A.parseHTML(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);A.after(o.$leftContainer,i),A.on(i,"click",s=>{z.preventEvent(s);try{Ae(r);let l=Object.keys(r),c=re(l);if(JSON.stringify(c)!==JSON.stringify(r)){R.error("写入失败，写入的数据和读取的数据不相同");return}fn(l);let d=re(l);d==null?R.warning("删除情况未知，因为读取到的数据为null"):typeof d=="object"&&JSON.stringify(d)==="{}"?R.success("删除成功，读取的数据为{}"):(R.error("删除情况未知，因为读取到的数据类型不是object"),console.log(d));}catch(l){R.error(l.toString(),{consoleLogContent:true});}});}}))})()),n}}class es extends it{isSupport(){return typeof Ar=="function"}getApiName(){return "GM_download"}getAsyncApiOption(){return {name:"GM.download",isSupport:this.isSupportGM()&&typeof Y.download=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>({text:ht.escapeHtml("TODO"),tag:"info",afterRender(r){r.target?.querySelector(".support-info");}}))),n}}class ns extends it{isSupport(){return typeof ve=="function"}getApiName(){return "GM_getResourceText"}getAsyncApiOption(){return {name:"GM.getResourceText",isSupport:this.isSupportGM()&&typeof Y.getResourceText=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>{try{return typeof ve("ViewerCSS")=="string"?{text:ht.escapeHtml("支持通过@resource引用资源字符串"),tag:"success"}:{text:ht.escapeHtml("GM_getResourceText return is not string"),tag:"error"}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}finally{}})),n}}class rs extends it{isSupport(){return typeof pn=="function"}getApiName(){return "GM_getResourceURL"}getAsyncApiOption(){return {name:"GM.getResourceUrl",isSupport:this.isSupportGM()&&typeof Y.getResourceUrl=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:t,fn:async(...r)=>new Promise(o=>{let i=Reflect.apply(pn,this,r);o(i);}),formList:n.forms[1].forms},{name:e.name,fn:Y.getResourceUrl,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(async()=>{try{let o=await r.fn("ViewerCSS");return typeof o!="string"?{text:ht.escapeHtml(`${r.name} return is not string`),tag:"error"}:(o=o.trim(),o.startsWith("data:text/css;base64")?o.startsWith("data:text/css;base64,LyohCiAqIFZpZXdlci5qcyB2MS4xMS43CiAqIGh0dHBzOi8vZmVuZ3")?{text:ht.escapeHtml("支持通过@resource引用资源并进行base64编码"),tag:"success"}:{text:ht.escapeHtml("支持通过@resource引用资源并进行base64编码，但是base64编码的实现方式不同"),tag:"warn"}:{text:ht.escapeHtml("支持通过@resource引用资源，但是未对资源进行base64编码"),tag:"warn"})}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class os extends it{isSupport(){return typeof un=="function"}getApiName(){return "GM_getTab"}getAsyncApiOption(){return {name:"GM.getTab",isSupport:this.isSupportGM()&&typeof Y.getTab=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:t,fn:async()=>new Promise(r=>{un((...o)=>{r(...o);});}),formList:n.forms[1].forms},{name:e.name,fn:Y.getTab,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(()=>({text:"测试获取当前Tab",description:"",tag:"info",afterRender(o){let i=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);A.after(o.$leftContainer,i);let s;A.on(i,"click",async l=>{z.preventEvent(l);try{clearTimeout(s),rt.setTag(o.$leftText,"error","等待3s内触发回调函数"),s=$t(()=>{rt.setTag(o.$leftText,"error","超时，不支持触发回调函数");},3e3);let c=await r.fn();clearTimeout(s),console.log(r.name+" callback tab",c),typeof c=="object"&&c!=null?rt.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"success",text:"入参tab为object类型"}]):rt.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"error",text:"入参tab不为object类型"}]),alert(JSON.stringify(c));}catch(c){R.error(c.toString(),{consoleLogContent:true});}});}})));}),n}}class as extends it{isSupport(){return typeof hn=="function"}getApiName(){return "GM_getTabs"}getAsyncApiOption(){return {name:"GM.getTabs",isSupport:this.isSupportGM()&&typeof Y.getTabs=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:t,fn:async()=>new Promise(r=>{hn((...o)=>{r(...o);});}),formList:n.forms[1].forms},{name:e.name,fn:Y.getTabs,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(()=>({text:"测试获取所有Tab",description:"",tag:"info",afterRender(o){let i=A.parseHTML(`
								<div class="pops-panel-button pops-panel-button-no-icon">
									<button class="pops-panel-button_inner" type="default">
										<i class="pops-bottom-icon" is-loading="false"></i>
										<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);A.after(o.$leftContainer,i),A.on(i,"click",async s=>{try{z.preventEvent(s);let l=await r.fn();console.log(r.name+" callback tabs",l),alert(JSON.stringify(l));}catch(l){R.error(l.toString(),{consoleLogContent:true});}});}})));}),n}}class is extends it{isSupport(){return typeof Nt=="function"}getApiName(){return "GM_getValue"}getAsyncApiOption(){return {name:"GM.getValue",isSupport:this.isSupportGM()&&typeof Y.getValue=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push(...[{key:"Test GM_getValue boolean",value:true,text:function(){return "存储boolean类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue number",value:1,text:function(){return "存储number类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue string",value:"测试字符串",text:function(){return "存储string类型并读取"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:"Test GM_getValue undefined",value:void 0,text:function(){return "存储undefined类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue null",value:null,text:function(){return "存储object类型的null并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_getValue object",value:{"object key":"object value"},text:function(){return "存储object类型并读取"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(r=>(()=>{let o=r.key,i=r.value;return $(()=>({text:r.text(),description:r.desc(),tag:"info",afterRender(s){let l=A.parseHTML(`
									...
									`,false,false);A.after(i.$leftContainer,s),A.on(s,"click",l=>{z.preventEvent(l);try{let c=Nt(r,o);typeof c==typeof o?R.success("读取的值是默认值："+c):R.error("读取的值不是默认值："+c);}catch(c){R.error(c.toString(),{consoleLogContent:true});}});}}))})()),n}}class ss extends it{isSupport(){return typeof re=="function"}getApiName(){return "GM_getValues"}getAsyncApiOption(){return {name:"GM.getValues",isSupport:this.isSupportGM()&&typeof Y.getValues=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>({text:"测试直接读取",description:"没有入参",tag:"info",afterRender(r){let o=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),f,u=z.debounce(()=>{try{clearTimeout(f),A.html(c.$leftText,'<p class="success">测试成功，触发</p>'),s=!1,l=!1;}catch(g){R.error(g.toString(),{consoleLogContent:!0});}},800);A.on(d,"click",async g=>{try{z.preventEvent(g),clearTimeout(f);let w=10,h=w,b=()=>{let E="正在等待触发超时：5000ms";return h--,E};rt.setTag(c.$leftText,"info",b()),f=$t(()=>{rt.setTag(c.$leftText,"error","测试超时，未触发ondone回调");},w*1e3);const v=await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",timeout:5e3,ondone(){u();}});}catch(w){R.error(w.toString(),{consoleLogContent:!0});}}),A.after(i,d);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),$(()=>{try{let o,i,s=!1,l=!1,c=!1,d="点击通知的内容测试onclick、ondone函数";return {text:d,description:"https://example.com/",tag:"info",afterRender(u){o=u.target,i=u.$leftContainer;let g=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),w,h,b=z.debounce(()=>{try{clearTimeout(w),clearInterval(h);let v="",E="success",T="",S="success";s?(v+="支持 onclick 函数",l?(v=v.trim(),v+="且支持提供 event 参数"):(v+="但是不支持提供 event 参数",E="warn")):(v+="不支持 onclick 函数",E="error"),c?T+="支持 ondone 函数":(T+="不支持 ondone 函数",S="error"),A.html(u.$leftText,`
												<p class="${E}">${v}</p>
												<p class="${S}">${T}</p>`),s=!1,c=!1,l=!1;}catch(v){R.error(v.toString(),{consoleLogContent:!0});}},800);A.on(g,"click",async v=>{try{z.preventEvent(v),clearTimeout(w),clearInterval(h);let E=10,T=E,S=()=>{let C=`正在等待触发回调，请在规定时间内点击弹窗的【关闭】按钮或者内容：${T}s`;return T--,C};A.text(u.$leftText,S()),A.text(u.$leftDesc,d),A.show(u.$leftDesc,!1),w=$t(()=>{clearInterval(h),rt.setTag(u.$leftText,"error","测试超时，未触发回调");},E*1e3),h=setInterval(()=>{A.text(u.$leftText,S());},1e3),await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",onclick:C=>{console.log(C),s=!0,C&&typeof C.preventDefault=="function"&&(l=!0,C.preventDefault()),b();},ondone(){c=!0,b();}});}catch(E){R.error(E.toString(),{consoleLogContent:!0});}}),A.after(i,g);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),$(()=>{try{let o,i,s=!1,l=!1,c=!1,d="123",f="456",u="notification_tag_"+Date.now(),g={title:"测试通知的内容更新（tag）",text:d,tag:u},w=`更新前：${d}，更新后：${f}`;return {text:g.title,description:w,tag:"info",afterRender(h){o=h.target,i=h.$leftContainer;let b=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),v,E;A.on(b,"click",async T=>{try{z.preventEvent(T),clearTimeout(v),clearInterval(E);let S=5,C=S,I=()=>{let q=`${C}s后通知的内容将更新为：${f}`;return C--,q};A.text(h.$leftDesc,I()),A.show(h.$leftDesc,!1),v=setTimeout(async()=>{clearInterval(E),A.text(h.$leftDesc,w),r.fn({...g,text:f});},S*1e3),E=setInterval(()=>{A.text(h.$leftDesc,I());},1e3),await r.fn(g);}catch(S){R.error(S.toString(),{consoleLogContent:!0});}}),A.after(i,b);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class ps extends it{isSupport(){return typeof le=="function"}getApiName(){return "GM_openInTab"}getAsyncApiOption(){return {name:"GM.openInTab",isSupport:this.isSupportGM()&&typeof Y.openInTab=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>{try{return {text:"后台打开：https://www.example.com/",tag:"info",afterRender(r){let o=r.target,i=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
									...
									`,!1,!1);A.on(i,"click",s=>{try{z.preventEvent(s),A.text(r.$leftDesc,this.text),A.show(r.$leftDesc,!1);let l=le("https://www.example.com/");if(typeof l=="object")if(l==null)rt.setTag(r.$leftText,"error","返回值为null");else {let c="close"in l&&typeof l.close=="function",d="closed"in l&&typeof l.closed=="boolean",f="onclose"in l;A.html(r.$leftText,`
								...
								`,!1,!1),s;A.on(i,"click",l=>{try{z.preventEvent(l),clearTimeout(s),rt.setTag(r.$leftText,"info","等待调用 .close()"),A.text(r.$leftDesc,this.text),A.show(r.$leftDesc,!1);let c=le("https://www.example.com/");c&&typeof c?.close=="function"?s=$t(()=>{try{c.close(),rt.setTag(r.$leftText,"success","成功调用 .close()");}catch(d){rt.setTag(r.$leftText,"error","调用 .close() 方法失败 "+d);}},1e3):rt.setTag(r.$leftText,"error","返回对象中不支持 .close() 方法");}catch(c){R.error(c.toString(),{consoleLogContent:!0});}}),A.after(r.$leftContainer,i);}}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}}),$(()=>{try{return {text:"测试监听关闭是否生效 .onclose",tag:"info",afterRender(r){let o=r.target,i=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),s,l;A.on(i,"click",c=>{try{z.preventEvent(c),clearTimeout(l),clearTimeout(s),rt.setTag(r.$leftText,"info","等待触发监听 .onclose"),A.text(r.$leftDesc,this.text),A.show(r.$leftDesc,!1);let d=le("https://www.example.com/");typeof d=="object"&&d!=null&&(d.onclose=()=>{clearTimeout(s),clearTimeout(l),rt.setTag(r.$leftText,"success","成功触发 .onclose");}),d&&typeof d?.close=="function"?s=$t(()=>{try{d.close(),l=$t(()=>{rt.setTag(r.$leftText,"error","测试超时，未触发回调 .onclose");},2e3);}catch(f){rt.setTag(r.$leftText,"error","调用 .close() 方法失败 "+f);}},1e3):rt.setTag(r.$leftText,"error","返回对象中不支持 .close() 方法");}catch(d){R.error(d.toString(),{consoleLogContent:!0});}}),A.after(r.$leftContainer,i);}}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}})),n}}class us extends it{isSupport(){return typeof oe=="function"}getApiName(){return "GM_registerMenuCommand"}getAsyncApiOption(){return {name:"GM.registerMenuCommand",isSupport:this.isSupportGM()&&typeof Y.registerMenuCommand=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>{try{return {text:"注册菜单 ==> Test Menu",tag:"info",afterRender(r){let o=A.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);A.after(r.$leftContainer,o);let i,s;A.on(o,"click",l=>{try{z.preventEvent(l),clearTimeout(i),clearInterval(s),A.text(r.$leftDesc,this.text),A.show(r.$leftDesc,!1);let c=10,d=()=>{let u=`已执行注册菜单，请在${c}s内点击菜单项`;return c--,u};rt.setTag(r.$leftText,"info",d()),s=setInterval(()=>{rt.setTag(r.$leftText,"info",d());},1e3),i=$t(()=>{clearInterval(s),rt.setTag(r.$leftText,"error","测试超时，未触发回调");},10*1e3);const f=oe("Test Menu",u=>{try{clearInterval(s),clearTimeout(i),rt.clearTag(r.$leftText);let g=[];g.push({tag:"success",text:"支持注册菜单"}),u?g.push({tag:"success",text:"支持点击回调且有event参数"}):g.push({tag:"warn",text:"支持点击回调但是没有event参数"}),typeof f=="number"||typeof f=="string"?g.push({tag:"success",text:"函数返回值是string|number"}):g.push({tag:"error",text:"函数返回值不是string|number："+typeof f}),A.html(r.$leftText,g.map(w=>`<p class="${w.tag}">${w.text}</p>`).join(`
`));}catch(g){R.error(g.toString(),{consoleLogContent:!0});}});}catch(c){R.error(c.toString(),{consoleLogContent:!0});}});}}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}finally{}}),$(()=>{try{return {text:"注册并更新菜单 ==> Test Update Menu",description:"请自行验证是否成功更新菜单文字为：Test Update Menu Success!!!",tag:"info",afterRender(r){let o=A.parseHTML(`
							...
							`,false,false);A.after(r.$leftContainer,o);let i;A.on(o,"click",s=>{try{z.preventEvent(s),clearTimeout(i),R.info("等待3s内触发成功复制的回调"),i=$t(()=>{rt.setTag(r.$leftText,"error","不支持触发回调函数");},3e3),xn("Test GM_setClipboard","text",()=>{clearTimeout(i),rt.setTag(r.$leftText,"success","支持触发回调函数");});}catch(l){R.error(l.toString(),{consoleLogContent:true});}});}}))),n}}class ms extends it{isSupport(){return typeof _t=="function"}getApiName(){return "GM_setValue"}getAsyncApiOption(){return {name:"GM.setValue",isSupport:this.isSupportGM()&&typeof Y.setValue=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push(...[{key:"Test GM_setValue boolean",value:true,text:function(){return "存储boolean类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue number",value:1,text:function(){return "存储number类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue string",value:"测试字符串",text:function(){return "存储string类型"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:"Test GM_setValue undefined",value:void 0,text:function(){return "存储undefined类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue null",value:null,text:function(){return "存储object类型的null"},desc:function(){return `"${this.key}": ${this.value}`}},{key:"Test GM_setValue object",value:{"object key":"object value"},text:function(){return "存储object类型"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(r=>(()=>{let o=r.key,i=r.value;return $(()=>({text:r.text(),description:r.desc(),tag:"info",afterRender(s){let l=A.parseHTML(`
								...
								`,!1,!1);A.after(r.$leftContainer,o);let i;A.on(o,"click",s=>{try{z.preventEvent(s),clearTimeout(i);const l=oe("Test UnRegister Menu",c=>{});R.info("已注册菜单，10s后自动执行卸载",{timeout:5*1e3}),clearTimeout(i),i=$t(()=>{je(l),R.success("已执行卸载菜单命令，请自行验证");},10*1e3);}catch(l){R.error(l.toString(),{consoleLogContent:!0});}});}}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}finally{}})),n}}class ws extends it{getApiName(){return "unsafeWindow"}getAsyncApiOption(){}isSupport(){return typeof vt=="object"&&vt!=null}getUIOption(){let t=this.getApiName(),e={id:"aside-"+t,title:t,headerTitle:`${ot.getApiDocUrl(t)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(n){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&e.forms[1].forms.push($(()=>{let n="test-gm-window",r=Pt==vt;return Pt[n]=n,r=typeof vt[n]!="string",Reflect.deleteProperty(Pt,n),r?{text:"window已被Proxy代理",tag:"success"}:{text:"window未被Proxy代理，定义全局变量时会影响到页面变量",tag:"warn"}})),e}}class vs extends it{isSupport(){return typeof Tr=="function"}getApiName(){return "GM_webRequest"}getAsyncApiOption(){return {name:"GM.webRequest",isSupport:this.isSupportGM()&&typeof Y.webRequest=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>{try{return {text:ht.escapeHtml("TODO"),tag:"info"}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}finally{}})),n}}class As extends it{isSupport(){return typeof zn=="function"}getApiName(){return "GM_xmlhttpRequest"}getAsyncApiOption(){return {name:"GM.xmlHttpRequest",isSupport:this.isSupportGM()&&typeof Y.xmlHttpRequest=="function"}}getUIOption(){let t=this.getApiName(),e=this.getAsyncApiOption(),n={id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t,`${t} & ${e.name}`)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(r){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+t,tag:"success"}:{text:"不支持 "+t,tag:"error"}),$(()=>e.isSupport?{text:"支持 "+e.name,tag:"success"}:{text:"不支持 "+e.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>{try{return {text:ht.escapeHtml("TODO"),tag:"info"}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}finally{}})),n}}class Es extends it{getApiName(){return "GM"}getAsyncApiOption(){}isSupport(){return typeof Y=="object"&&Y!=null}getUIOption(){}}const Ct={unsafeWindow:new ws,GM:new Es,addElement:new Xi,addStyle:new Qi,download:new es,getResourceText:new ns,getResourceUrl:new rs,info:new ls,log:new ds,notification:new fs,openInTab:new ps,registerMenuCommand:new us,unregisterMenuCommand:new xs,setClipboard:new gs,getTab:new os,saveTab:new bs,getTabs:new as,setValue:new ms,getValue:new is,deleteValue:new Zi,listValues:new cs,setValues:new ys,getValues:new ss,deleteValues:new ts,addValueChangeListener:new Yi,removeValueChangeListener:new hs,xmlHttpRequest:new As,webRequest:new vs,cookie:new Ji},Bt={$storageKey:"gm-api-test-storage-config",set(a,t){let e=window.localStorage.getItem(Bt.$storageKey)??"{}",n=z.toJSON(e);n[a]=t,window.localStorage.setItem(Bt.$storageKey,JSON.stringify(n,(r,o)=>typeof o=="function"?o.tString():o));},get(a,t){let e=window.localStorage.getItem(Bt.$storageKey)??"{}";return z.toJSON(e)[a]??t},delete(a){let t=window.localStorage.getItem(Bt.$storageKey)??"{}",e=z.toJSON(t);Reflect.deleteProperty(e,a),window.localStorage.setItem(Bt.$storageKey,JSON.stringify(e,(n,r)=>typeof r=="function"?r.tString():r));}},U={set(a,t){Ct.setValue.isSupport()&&Ct.getValue.isSupport()&&Ct.deleteValue.isSupport()?_t(a,t):Bt.set(a,t);},get(a,t){return Ct.setValue.isSupport()&&Ct.getValue.isSupport()&&Ct.deleteValue.isSupport()?Nt(a,t):Bt.get(a,t)},delete(a){Ct.setValue.isSupport()&&Ct.getValue.isSupport()&&Ct.deleteValue.isSupport()?we(a):Bt.delete(a);}},Ts=()=>{let a=[],t=[];Object.keys(Ct).forEach(n=>{let r=Ct[n],o=r.getApiName(),i=r.isSupport(),s=r.getAsyncApiOption();i?a.push({name:o,isSupport:i}):t.push({name:o,isSupport:i}),s&&(s.isSupport?a.push({name:s.name,isSupport:s.isSupport,leftTargetSelector:"#aside-"+o}):t.push({name:s.name,isSupport:s.isSupport,leftTargetSelector:"#aside-"+o}));});let e=n=>{let r=A.createElement("div",{className:"gm-api-features-item",innerHTML:`
			...
			`});return A.on(r,"click",o=>{z.preventEvent(o);let i=r.getRootNode(),s=z.isNotNull(n.leftTargetSelector)?n.leftTargetSelector:"#aside-"+n.name,l=i.querySelector(s);l&&(l.click(),l.scrollIntoView({behavior:"smooth"}));}),r};return {id:"component-common",title:"通用",scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)==="component-common"},callback(n){U.set(N.asideLastVisit,"component-common");},forms:[{type:"forms",text:"@run-at document-start<br>注：注入速度等级越低，注入的速度越快<br>范围：0~4",forms:[$(()=>({text:ht.escapeHtml(ne),tag:"info"}))]},{type:"forms",text:"特性",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontSize="1.2em",r.formHeaderDivElement.style.fontWeight="700";},forms:[]},{type:"forms",text:"不支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.color="rgb(216, 30, 6)",r.formHeaderDivElement.style.fontWeight="600",t.length===0&&r.formContainerListElement?.remove();},forms:[{type:"own",getLiElementCallBack(n){let r=A.createElement("div",{className:"gm-api-features-not-support"}),o=document.createDocumentFragment();return t.forEach(i=>{o.append(e(i));}),r.appendChild(o),n.appendChild(r),n}}]},{type:"forms",text:"支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontWeight="600",a.length===0&&r.formContainerListElement?.remove();},forms:[{type:"own",getLiElementCallBack(n){let r=A.createElement("div",{className:"gm-api-features-support"}),o=document.createDocumentFragment();return a.forEach(i=>{o.append(e(i));}),r.appendChild(o),n.appendChild(r),n}}]}]}};class Ss extends Oe{getApiName(){return "window.onurlchange "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let t=this.getApiName();return {id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(n){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"功能测试",forms:[$(()=>{try{return {text:ht.escapeHtml("测试window.onurlchange"),tag:"info",description:"点击按钮进行测试",afterRender(n){let r=A.parseHTML(`
											...
											`,!1,!1);A.on(r,"click",o=>{z.preventEvent(o);try{Pt.close();}catch(i){R.error(i.toString(),{consoleLogContent:!0});}}),A.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}finally{}})]}]}}}class ks extends Oe{getApiName(){return "window.focus "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let t=this.getApiName();return {id:"aside-"+t,title:""+t,headerTitle:`${ot.getApiDocUrl(t)}`,scrollToDefaultView:true,isDefault(){return U.get(N.asideLastVisit)===t},callback(n){U.set(N.asideLastVisit,t);},forms:[{type:"forms",text:"功能测试",forms:[$(()=>{try{return {text:ht.escapeHtml("测试window.focus"),tag:"info",description:"点击按钮执行该函数",afterRender(n){let r=A.parseHTML(`
											<div class="pops-panel-button pops-panel-button-no-icon">
												<button class="pops-panel-button_inner" type="default">
													<i class="pops-bottom-icon" is-loading="false"></i>
													<span class="pops-panel-button-text">点击执行</span>

...
`;const W={index:hs,ninePalaceGridPosition:ms,scrollbar:gs,button:ys,common:xs,anim:ws,alertCSS:vs,confirmCSS:As,promptCSS:Ss,loadingCSS:Ts,iframeCSS:Cs,tooltipCSS:Es,drawerCSS:ks,folderCSS:Ms,panelCSS:$s,rightClickMenu:Ls},lt={$data:{},$flag:{isInit:false},init(){if(!this.$flag.isInit){this.$flag.isInit=true;const a=d.createElement("style",{innerHTML:W.anim});d.appendHead(a),this.$data=null,this.$data=d.getKeyFrames(a.sheet),z.setTimeout(()=>{a.remove();},50);}},hasAnim(a){return Object.prototype.hasOwnProperty.call(this.$data,a)}},me={alert:[],confirm:[],drawer:[],folder:[],iframe:[],loading:[],panel:[],prompt:[],rightClickMenu:[],tooltip:[]},be={getMaxZIndexNodeInfo(a=1,e=X.document,t){a=Number.isNaN(a)?1:a;const n=2*Math.pow(10,9);let r=0,o=null;function s(l){return l.position!=="static"&&l.display!=="none"}function i(l){if(typeof t=="function"){const f=t(l);if(typeof f=="boolean"&&!f)return}const c=X.window.getComputedStyle(l);if(s(c)){const f=parseInt(c.zIndex);isNaN(f)||f>r&&(r=f,o=l),l.shadowRoot!=null&&l instanceof ShadowRoot&&l.shadowRoot.querySelectorAll("*").forEach(p=>{i(p);});}}return e.querySelectorAll("*").forEach(l=>{i(l);}),r+=a,r>=n&&(r=n),{node:o,zIndex:r}},getPopsMaxZIndex(a=1){a=Number.isNaN(a)?1:a;const e=2*Math.pow(10,9);let t=0,n=null;function r(s){return s.position!=="static"&&s.display!=="none"}Object.keys(me).forEach(s=>{const i=me[s];for(let l=0;l<i.length;l++){const c=i[l],f=window.getComputedStyle(c.animElement);if(r(f)){const p=parseInt(f.zIndex);isNaN(p)||p>t&&(t=p,n=c.animElement);}}}),t+=a;const o=t>=e;return o&&(t=e),{zIndex:t,animElement:n,isOverMaxZIndex:o}},getMaxZIndex(a=1){return this.getMaxZIndexNodeInfo(a).zIndex},removeInstance(a,e,t=false){function n(r){typeof r.beforeRemoveCallBack=="function"&&r.beforeRemoveCallBack(r),r?.animElement?.remove(),r?.popsElement?.remove(),r?.maskElement?.remove(),r?.$shadowContainer?.remove();}return a.forEach(r=>{r.forEach((o,s)=>{if(t||o.guid===e){const i=o.animElement.getAttribute("anim");if(lt.hasAnim(i)){const l=i+"-reverse";o.animElement.style.width="100%",o.animElement.style.height="100%",o.animElement.style["animation-name"]=l,lt.hasAnim(o.animElement.style["animation-name"])?d.on(o.animElement,d.getAnimationEndNameList(),function(){n(o);},{capture:true}):n(o);}else n(o);r.splice(s,1);}});}),a},hide(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;z.setTimeout(()=>{o&&d.css(o,"display","none"),["top","bottom"].includes(c.direction)?i.style.setProperty("height","0"):["left","right"].includes(c.direction)?i.style.setProperty("width","0"):console.error("未知direction：",c.direction),s();},c.closeDelay);}else {const c=t.find(f=>f.guid===n);if(c){const f=c;if(f.animElement.style.width="100%",f.animElement.style.height="100%",Reflect.set(f.animElement.style,"animation-name",f.animElement.getAttribute("anim")+"-reverse"),lt.hasAnim(Reflect.get(f.animElement.style,"animation-name"))){let p=function(){f.animElement.style.display="none",f.maskElement&&(f.maskElement.style.display="none"),d.off(f.animElement,d.getAnimationEndNameList(),p,{capture:true}),s();};d.on(f.animElement,d.getAnimationEndNameList(),p,{capture:true});}else f.animElement.style.display="none",f.maskElement&&(f.maskElement.style.display="none"),s();}}})},show(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;z.setTimeout(()=>{o&&d.css(o,"display","");const f=c.direction,p=c.size.toString();["top","bottom"].includes(f)?i.style.setProperty("height",p):["left","right"].includes(f)?i.style.setProperty("width",p):console.error("未知direction：",f),s();},c.openDelay??0);}else {const c=t.find(f=>f.guid===n);if(c){const f=c;if(f.animElement.style.width="",f.animElement.style.height="",Reflect.set(f.animElement.style,"animation-name",f.animElement.getAttribute("anim").replace("-reverse","")),lt.hasAnim(Reflect.get(f.animElement.style,"animation-name"))){let p=function(){d.off(f.animElement,d.getAnimationEndNameList(),p,{capture:true}),s();};f.animElement.style.display="",f.maskElement&&(f.maskElement.style.display=""),d.on(f.animElement,d.getAnimationEndNameList(),p,{capture:true});}else f.animElement.style.display="",f.maskElement&&(f.maskElement.style.display=""),s();}}})},close(a,e,t,n,r){return new Promise(o=>{const s=r.querySelector(".pops[type-value]"),i=a;function l(){function c(p){p.propertyName==="transform"&&(d.off(s,d.getTransitionEndNameList(),void 0,c),be.removeInstance([t],n),o());}if(d.on(s,d.getTransitionEndNameList(),c),getComputedStyle(s).transform!=="none"){d.trigger(s,d.getTransitionEndNameList(),void 0,true);return}["top"].includes(i.direction)?s.style.setProperty("transform","translateY(-100%)"):["bottom"].includes(i.direction)?s.style.setProperty("transform","translateY(100%)"):["left"].includes(i.direction)?s.style.setProperty("transform","translateX(-100%)"):["right"].includes(i.direction)?s.style.setProperty("transform","translateX(100%)"):console.error("未知direction：",i.direction);}e==="drawer"?z.setTimeout(()=>{l();},i.closeDelay):(be.removeInstance([t],n),o());})},drag(a,e){e=Object.assign({limit:true,extraDistance:3,container:X.globalThis,triggerClick:true},e);let t=false,n=0,r=0;const o=z.AnyTouch(),s=new o(e.dragElement,{preventDefault(u){return typeof e.preventEvent=="function"?e.preventEvent(u):true}});d.css(e.dragElement,{cursor:"move"});function i(u){const h=u.style.transitionDuration;return globalThis.getComputedStyle(u).transitionDuration!=="0s"&&(u.style.transitionDuration="0s"),()=>{u.style.transitionDuration=h;}}function l(u){return u=u??globalThis,{width:d.width(u),height:d.height(u)}}function c(u){if(u=u??globalThis,z.isWin(u))return {left:0,top:0};{const h=u.getBoundingClientRect();return {left:h.left,top:h.top}}}let f=d.getTransform(a),p=null;s.on("pan",function(u){if(!t){t=true;const y=e.dragElement.getBoundingClientRect();n=u.x-y.left,r=u.y-y.top,f=d.getTransform(a),p=i(a);}let h=u.x-n+f.transformLeft,g=u.y-r+f.transformTop;if(u.phase==="move"){if(e.limit){const y=l(e.container).width-d.width(a)+f.transformLeft,{left:x,top:A}=c(e.container),v=l(e.container).height-d.height(a)+f.transformTop;h>y&&(h=y),g>v&&(g=v),h-e.extraDistance*2<x+f.transformLeft?(h=x+f.transformLeft,h+=e.extraDistance):h-=e.extraDistance,g-e.extraDistance*2<A+f.transformTop?(g=A+f.transformTop,g+=e.extraDistance):g-=e.extraDistance;}typeof e.moveCallBack=="function"&&e.moveCallBack(a,h,g),d.css(a,{left:h+"px",top:g+"px"});}u.phase==="end"&&(t=false,typeof p=="function"&&(p(),p=null),typeof e.endCallBack=="function"&&e.endCallBack(a,h,g));}),e.triggerClick&&s.on(["tap"],function(u){u.changedPoints.forEach(h=>{d.trigger(h.target,"click",void 0,true);});});},sortElementListByProperty(a,e,t=true){if(typeof t!="boolean")throw new TypeError("参数 sortByDesc 必须为boolean类型");if(a==null||e==null)throw new Error("获取前面的值或后面的值的方法不能为空");return function(n,r){const o=a(r),s=e(n);return t?s>o?-1:s<o?1:0:s<o?-1:s>o?1:0}}},O={handlerShadow(a){const e=d.createElement("div",{className:"pops-shadow-container"});if(a.useShadowRoot){const t=e.attachShadow({mode:"open"});return {$shadowContainer:e,$shadowRoot:t}}else return {$shadowContainer:e,$shadowRoot:e}},handleInit(a,e){if(lt.init(),!!arguments.length&&a!=null&&e!=null){if(typeof e=="string"){if(e.trim()==="")return;e=[{css:e}];}else e=e.map(t=>typeof t=="string"?{css:t}:t);for(const t of e){const n=d.createElement("style",{},{"data-type":"PopsHandler.handleInit"});n.textContent=t.css,typeof t.name=="string"&&n.setAttribute("data-name",t.name),a.appendChild(n);}}},handleMask(a={}){const e={maskElement:d.parseTextToDOM(a.maskHTML)};let t=false;function n(o){d.preventEvent(o);const s=me[a.type];function i(){if(a.config.mask.clickEvent.toClose)return be.close(a.config,a.type,s,a.guid,a.animElement);if(a.config.mask.clickEvent.toHide)return be.hide(a.config,a.type,s,a.guid,a.animElement,e.maskElement)}return typeof a.config.mask.clickCallBack=="function"?a.config.mask.clickCallBack(i,a.config):i(),false}if(a.config.mask.clickEvent.toClose||a.config.mask.clickEvent.toHide){let o=function(s){return !!(s?.localName?.toLowerCase()==="div"&&s.className&&s.className==="pops-anim"&&s.hasAttribute("anim"))};d.on(a.animElement,["touchstart","mousedown"],void 0,s=>{const i=s.composedPath()[0];t=o(i);}),d.on(a.animElement,"click",void 0,s=>{const i=s.composedPath()[0];if(o(i)&&t)return n(s)}),d.on(e.maskElement,"click",void 0,s=>{t=true,n(s);});}return e},handleQueryElement(a,e){return {$pops:a.querySelector(".pops[type-value"),$btnOk:a.querySelector(`.pops-${e}-btn-ok`),$btnCancel:a.querySelector(`.pops-${e}-btn-cancel`),$btnOther:a.querySelector(`.pops-${e}-btn-other`),$title:a.querySelector(`.pops-${e}-title`),$input:a.querySelector(`.pops-${e}-content textarea[pops]`)?a.querySelector(`.pops-${e}-content textarea[pops]`):a.querySelector(`.pops-${e}-content input[pops]`),$headerControls:a.querySelector(".pops-header-controls"),$iframe:a.querySelector("iframe[pops]"),$loading:a.querySelector(".pops-loading"),$content:a.querySelector(`.pops-${e}-content`),$panelRightSectionWrapper:a.querySelector(`.pops-${e}-section-wrapper`),$panelLeftAside:a.querySelector(`.pops-${e}-content aside.pops-${e}-aside`),$panelContentSectionContainer:a.querySelector(`.pops-${e}-content section.pops-${e}-container`),$panelBottomWrapper:a.querySelector(`.pops-${e}-bottom-wrapper`),$panelBottomContainer:a.querySelector(`.pops-${e}-bottom-container`),$panelBottomLeftContainer:a.querySelector(`.pops-${e}-bottom-left-container`),$panelBottomRightContainer:a.querySelector(`.pops-${e}-bottom-right-container`),$contentLoading:a.querySelector(`.pops-${e}-content-global-loading`),$headerBtnMin:a.querySelector(".pops-header-control[data-type='min']"),$headerBtnMax:a.querySelector(".pops-header-control[data-type='max']"),$headerBtnMise:a.querySelector(".pops-header-control[data-type='mise']"),$headerBtnClose:a.querySelector(".pops-header-control[data-type='close']"),$folderList:a.querySelector(".pops-folder-list"),$folderHeaderNav:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div"),$folderHeaderRow:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div .pops-folder-list-table__header-row"),$folderTbody:a.querySelector(".pops-folder-list .pops-folder-list-table__body-div tbody"),$folderHeaderBreadcrumbPrimary:a.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-primary"),$folderSortFileName:a.querySelector('.pops-folder-list-table__sort[data-sort="fileName"]'),$folderSortLatestTime:a.querySelector('.pops-folder-list-table__sort[data-sort="latestTime"]'),$folderSortFileSize:a.querySelector('.pops-folder-list-table__sort[data-sort="fileSize"]')}},handleEventConfig(a,e,t,n,r,o,s,i){return {$shadowContainer:t,$shadowRoot:n,$el:o,$anim:o,$pops:s,$mask:i,mode:r,guid:e,close(){return be.close(a,r,me[r],e,o)},hide(){return be.hide(a,r,me[r],e,o,i)},show(){return be.show(a,r,me[r],e,o,i)}}},handleLoadingEventConfig(a,e,t,n,r,o){return {$el:n,$anim:n,$pops:r,$mask:o,mode:t,guid:e,close(){return be.close(a,t,me[t],e,n)},hide(){return be.hide(a,t,me[t],e,n,o)},show(){return be.show(a,t,me[t],e,n,o)}}},handleResultConfig(a){const e=Object.assign({},a);return z.delete(e,"type"),z.delete(e,"function"),e},handleClickEvent(a,e,t,n){typeof n=="function"&&d.on(e,"click",r=>{n(Object.assign(t,{type:a}),r);},{capture:true});},handleKeyboardEvent(a,e=[],t){const n=function(r){const o=r.code||r.key,s=r.charCode||r.keyCode||r.which;e.includes("ctrl")&&!r.ctrlKey||e.includes("alt")&&!r.altKey||e.includes("meta")&&!r.metaKey||e.includes("shift")&&!r.shiftKey||(typeof a=="string"&&a===o?t&&t(r):typeof a=="number"&&a===s&&t&&t(r));};return d.on(X.globalThis,"keydown",n,{capture:true}),{removeKeyboardEvent(){d.off(globalThis,"keydown",n,{capture:true});}}},handlePromptClickEvent(a,e,t,n,r){d.on(t,"click",o=>{const s={type:a,text:e.value};r(Object.assign(n,s),o);},{capture:true});},handleZIndex(a){return typeof a=="function"?a():a},handleOnly(a,e){if(e.only)if(a==="loading"||a==="tooltip"||a==="rightClickMenu"){const t=me[a];t&&be.removeInstance([t],"",true);}else be.removeInstance([me.alert,me.confirm,me.prompt,me.iframe,me.drawer,me.folder,me.panel],"",true);else {const t=e.zIndex;e.zIndex=()=>{const{zIndex:n}=be.getPopsMaxZIndex(O.handleZIndex(t)+100);return n};}return e},handlePush(a,e){me[a].push(e);}},Is=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{position:"flex-end",ok:{size:void 0,enable:true,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback:function(a){a.close();}},close:{enable:true,callback:function(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),wr={init(a){const e=z.getRandomGUID(),t="alert";let n=Is();n=z.assign(n,xe.getGlobalConfig()),n=z.assign(n,a),n=O.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=O.handlerShadow(n);O.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"button",css:W.button},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"alertCSS",css:W.alertCSS}]);const s=O.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:f,headerPStyle:p}=Z.createHeaderStyle(t,n),{contentStyle:u,contentPStyle:h}=Z.createContentStyle(t,n),g=Z.createAnim(e,t,n,`
			...
			<div class="pops-content pops-${t}-content" style="${u}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${h}">${n.content.text}</p>`}</div>${c}`,c,s),y=Z.parseElement(g),{$pops:x,$headerBtnClose:A,$btnOk:v,$title:E}=O.handleQueryElement(y,t);let S;const w=[y];n.mask.enable&&(S=O.handleMask({type:t,guid:e,config:n,animElement:y,maskHTML:i}).maskElement,w.push(S));const k=O.handleEventConfig(n,e,r,o,t,y,x,S);return O.handleClickEvent("close",A,k,n.btn.close?.callback),O.handleClickEvent("ok",v,k,n.btn.ok?.callback),d.append(o,w),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),d.appendBody(r),S!=null&&y.after(S),O.handlePush(t,{guid:e,animElement:y,popsElement:x,maskElement:S,$shadowContainer:r,$shadowRoot:o}),n.drag&&be.drag(x,{dragElement:E,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),O.handleResultConfig(k)}},_s=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),Rs={init(a){const e=z.getRandomGUID(),t="confirm";let n=_s();n=z.assign(n,xe.getGlobalConfig()),n=z.assign(n,a),n=O.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=O.handlerShadow(n);O.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"button",css:W.button},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"confirmCSS",css:W.confirmCSS}]);const s=O.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:f,headerPStyle:p}=Z.createHeaderStyle(t,n),{contentStyle:u,contentPStyle:h}=Z.createContentStyle(t,n),g=Z.createAnim(e,t,n,`
            <div class="pops-title pops-${t}-title" style="text-align: ${n.title.position};${f}">${n.title.html?n.title.text:`<p pops class="pops-${t}-title-text" style="${p}">${n.title.text}</p>`}${l}</div>
                        <div class="pops-content pops-${t}-content" style="${u}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${h}">${n.content.text}</p>`}</div>${c}`,c,s),y=Z.parseElement(g),{$pops:x,$title:A,$headerBtnClose:v,$btnOk:E,$btnCancel:S,$btnOther:w}=O.handleQueryElement(y,t);let k;const H=[y];n.mask.enable&&(k=O.handleMask({type:t,guid:e,config:n,animElement:y,maskHTML:i}).maskElement,H.push(k));const U=O.handleEventConfig(n,e,r,o,t,y,x,k);return O.handleClickEvent("close",v,U,n.btn.close.callback),O.handleClickEvent("ok",E,U,n.btn.ok.callback),O.handleClickEvent("cancel",S,U,n.btn.cancel.callback),O.handleClickEvent("other",w,U,n.btn.other.callback),d.append(o,H),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),d.appendBody(r),k!=null&&y.after(k),O.handlePush(t,{guid:e,animElement:y,popsElement:x,maskElement:k,$shadowContainer:r,$shadowRoot:o}),n.drag&&be.drag(x,{dragElement:A,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),O.handleResultConfig(U)}},Os=()=>({title:{enable:true,position:"center",text:"默认标题",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:null},useShadowRoot:true,class:"",zIndex:1e4,only:false,direction:"right",size:"30%",lockScroll:false,closeOnPressEscape:true,openDelay:0,closeDelay:0,borderRadius:0,style:null,beforeAppendToPageCallBack(){},forbiddenScroll:false}),Ns={init(a){const e=z.getRandomGUID(),t="drawer";let n=Os();n=z.assign(n,xe.getGlobalConfig()),n=z.assign(n,a),n=O.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=O.handlerShadow(n);O.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"button",css:W.button},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"drawerCSS",css:W.drawerCSS}]);const s=O.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:f,headerPStyle:p}=Z.createHeaderStyle(t,n),{contentStyle:u,contentPStyle:h}=Z.createContentStyle(t,n),g=Z.createAnim(e,t,n,`
            ...
            <div class="pops-content pops-${t}-content" style="${u}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${h}">${n.content.text}</p>`}</div>${c}`,c,s),y=Z.parseElement(g),{$pops:x,$headerBtnClose:A,$btnCancel:v,$btnOk:E,$btnOther:S}=O.handleQueryElement(y,t),w=x,k=A,H=v,U=E,F=S;let K;const Y=[y];n.mask.enable&&(K=O.handleMask({type:t,guid:e,config:n,animElement:y,maskHTML:i}).maskElement,Y.push(K));const M=O.handleEventConfig(n,e,r,o,t,y,w,K);return w.setAttribute("direction",n.direction),n.direction==="top"?(w.style.setProperty("height","0"),w.style.setProperty("border-radius",`0px 0px ${n.borderRadius}px ${n.borderRadius}px`)):n.direction==="bottom"?(w.style.setProperty("height","0"),w.style.setProperty("border-radius",`${n.borderRadius}px ${n.borderRadius}px 0px 0px`)):n.direction==="left"?(w.style.setProperty("width","0"),w.style.setProperty("border-radius",`0px ${n.borderRadius}px 0px ${n.borderRadius}px`)):n.direction==="right"&&(w.style.setProperty("width","0"),w.style.setProperty("border-radius",`${n.borderRadius}px 0px ${n.borderRadius}px 0px`)),n.closeOnPressEscape&&O.handleKeyboardEvent("Escape",[],function(){M.close();}),[{type:"close",ele:k},{type:"cancel",ele:H},{type:"ok",ele:U},{type:"other",ele:F}].forEach(m=>{O.handleClickEvent(m.type,m.ele,M,(C,P)=>{const I=n.btn[m.type].callback;typeof I=="function"&&I(C,P);});}),Y.forEach(m=>{m.style.setProperty("display","none"),["top"].includes(n.direction)?(w.style.setProperty("height",n.size.toString()),w.style.setProperty("transform","translateY(-100%)")):["bottom"].includes(n.direction)?(w.style.setProperty("height",n.size.toString()),w.style.setProperty("transform","translateY(100%)")):["left"].includes(n.direction)?(w.style.setProperty("width",n.size.toString()),w.style.setProperty("transform","translateX(-100%)")):["right"].includes(n.direction)&&(w.style.setProperty("width",n.size.toString()),w.style.setProperty("transform","translateX(100%)")),m.style.setProperty("display","");}),d.append(o,Y),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),d.appendBody(r),z.setTimeout(()=>{z.setTimeout(()=>{w.style.setProperty("transform","");},n.openDelay);},50),K!=null&&y.after(K),O.handlePush(t,{guid:e,animElement:y,popsElement:w,maskElement:K,$shadowContainer:r,$shadowRoot:o}),O.handleResultConfig(M)}},Ps=()=>({parent:document.body,content:{text:"加载中...",icon:"loading",style:""},useShadowRoot:true,class:"",only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",forbiddenScroll:false,isAbsolute:false,style:null,addIndexCSS:true}),Xt={init(a){let e=Ps();e=z.assign(e,xe.getGlobalConfig()),e=z.assign(e,a);const t=z.getRandomGUID(),n="loading";e=O.handleOnly(n,e);const r=O.handleZIndex(e.zIndex),o=Z.createMask(t,r),{contentPStyle:s}=Z.createContentStyle("loading",e),i=Z.createAnim(t,n,e,`
            ...
            </div>${h}`,h,f),A=Z.parseElement(x),{$pops:v,$title:E,$content:S,$folderTbody:w,$folderHeaderBreadcrumbPrimary:k,$headerBtnClose:H,$btnOk:U,$btnCancel:F,$btnOther:K,$folderSortFileName:Y,$folderSortLatestTime:M,$folderSortFileSize:L}=O.handleQueryElement(A,t);let T;const m=[A];n.mask.enable&&(T=O.handleMask({type:t,guid:e,config:n,animElement:A,maskHTML:p}).maskElement,m.push(T));const C=O.handleEventConfig(n,e,r,o,t,A,v,T);O.handleClickEvent("close",H,C,n.btn.close.callback),O.handleClickEvent("ok",U,C,n.btn.ok.callback),O.handleClickEvent("cancel",F,C,n.btn.cancel.callback),O.handleClickEvent("other",K,C,n.btn.other.callback),d.append(o,m),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),d.appendBody(r),T!=null&&A.after(T);class P{init(){n.folder.sort(),this.initFolderView(n.folder);const D=k.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-allFiles:first-child");Reflect.set(D,"_config_",n.folder),d.on(D,"click",_=>{this.setBreadcrumbClickEvent(_,true,n.folder);}),d.on(Y.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(Y,_,"fileName");},{capture:true}),d.on(M.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(M,_,"latestTime");},{capture:true}),d.on(L.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(L,_,"fileSize");},{capture:true}),n.sort.name==="fileName"?d.trigger(Y,"click",{notChangeSortRule:true}):n.sort.name==="latestTime"?d.trigger(M,"click",{notChangeSortRule:true}):n.sort.name==="fileSize"&&d.trigger(L,"click",{notChangeSortRule:true});}createFolderRowElement(D,_="-",j="-",te=false){const J=D,ae=_,ge=j,we=d.createElement("tr"),he=d.createElement("td"),de=d.createElement("td"),$e=d.createElement("td");let rt="",Be=fe.folder;if(te)_="",j="";else {Be="",typeof _=="number"&&(_=z.formatTime(_)),typeof j=="number"&&(j=z.formatByteToSize(j));for(const Pt in fe)if(D.toLowerCase().endsWith("."+Pt)){rt=Pt,Be=fe[Pt];break}Be||(rt="Null",Be=fe.Null);}we.className="pops-folder-list-table__body-row",he.className="pops-folder-list-table__body-td",de.className="pops-folder-list-table__body-td",$e.className="pops-folder-list-table__body-td",ne.setSafeHTML(he,`
            ...
            `),ne.setSafeHTML(de,`
				...
				`);const wt={fileName:J,latestTime:ae,fileSize:ge,isFolder:te};return Reflect.set(he,"__value__",wt),Reflect.set(de,"__value__",wt),Reflect.set($e,"__value__",wt),Reflect.set(we,"__value__",wt),we.appendChild(he),we.appendChild(de),we.appendChild($e),{folderElement:we,fileNameElement:he,fileTimeElement:de,fileFormatSize:$e}}createFolderRowElementByMobile(D,_="-",j="-",te=false){const J=D,ae=_,ge=j,we=d.createElement("tr"),he=d.createElement("td");let de="",$e=fe.folder;if(te)_="",j="";else {$e="",typeof _=="number"&&(_=z.formatTime(_)),typeof j=="number"&&(j=z.formatByteToSize(j));for(const Be in fe)if(D.toLowerCase().endsWith("."+Be)){de=Be,$e=fe[Be];break}$e||(de="Null",$e=fe.Null);}we.className="pops-folder-list-table__body-row",he.className="pops-folder-list-table__body-td",ne.setSafeHTML(he,`
			...
			`);const rt={fileName:J,latestTime:ae,fileSize:ge,isFolder:te};return Reflect.set(he,"__value__",rt),Reflect.set(we,"__value__",rt),we.appendChild(he),{folderElement:we,fileNameElement:he}}clearFolderInfoView(){ne.setSafeHTML(w,"");}createHeaderArrowIcon(){return d.createElement("div",{className:"iconArrow"})}createBreadcrumb(D,_){return d.createElement("span",{className:"pops-folder-file-list-breadcrumb-allFiles cursor-p",innerHTML:`<a>${D}</a>`,_config_:_},{title:D})}setBreadcrumbClickEvent(D,_,j){this.clearFolderInfoView();const J=D.target.closest("span.pops-folder-file-list-breadcrumb-allFiles");if(J)for(;J.nextElementSibling;)J.nextElementSibling.remove();else console.error("获取导航按钮失败");const ae=Xt.init({parent:S,content:{text:"获取文件列表中..."},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},addIndexCSS:false});this.initFolderView(j),ae.close();}async enterFolder(D,_){this.clearFolderInfoView();const j=Xt.init({parent:S,content:{text:"获取文件列表中..."},mask:{enable:true},addIndexCSS:false});if(typeof _.clickEvent=="function"){const te=await _.clickEvent(D,_);k.appendChild(this.createHeaderArrowIcon());const J=this.createBreadcrumb(_.fileName,te);k.appendChild(J),d.on(J,"click",ae=>{this.setBreadcrumbClickEvent(ae,false,te);}),this.initFolderView(te);}j.close();}async downloadFile(D,_,j){d.preventEvent(D);const te=_.querySelector("a");if(typeof j.clickEvent=="function"){const J=await j.clickEvent(D,j);if(J!=null&&typeof J=="object"&&!Array.isArray(J)&&typeof J.url=="string"&&J.url.trim()!==""&&(te.setAttribute("href",J.url),te.setAttribute("target","_blank"),J.autoDownload))if((J.mode==null||J.mode==="")&&(J.mode="aBlank"),J.mode==="a"||J.mode==="aBlank"){const ae=d.createElement("a");J.mode==="aBlank"&&ae.setAttribute("target","_blank"),ae.href=J.url,ae.click();}else if(J.mode==="open"||J.mode==="openBlank")J.mode==="openBlank"?globalThis.open(J.url,"_blank"):globalThis.open(J.url);else if(J.mode==="iframe"){const ae=d.createElement("iframe");ae.src=J.url,ae.onload=function(){z.setTimeout(()=>{ae.remove();},1e3);},o.appendChild(ae),z.setTimeout(()=>{ae.remove();},180*1e3);}else console.error("未知的下载模式",J);}}sortFolderConfig(D,_="fileName",j=false){if(_==="fileName"){const te=D.filter(ae=>ae.isFolder),J=D.filter(ae=>!ae.isFolder);return te.sort((ae,ge)=>{const we=ae[_].toString(),he=ge[_].toString();let de=we.localeCompare(he);return j&&(de>0?de=-1:de<0&&(de=1)),de}),J.sort((ae,ge)=>{const we=ae[_].toString(),he=ge[_].toString();let de=we.localeCompare(he);return j&&(de>0?de=-1:de<0&&(de=1)),de}),j?[...J,...te]:[...te,...J]}else return D.sort((te,J)=>{let ae=te[_],ge=J[_];return _==="fileSize"?(ae=parseFloat(ae.toString()),ge=parseFloat(ge.toString())):_==="latestTime"&&(ae=new Date(ae).getTime(),ge=new Date(ge).getTime()),ae>ge?j?-1:1:ae<ge?j?1:-1:0}),D}initFolderView(D){this.sortFolderConfig(D,n.sort.name,n.sort.isDesc),D.forEach(_=>{if(_.isFolder){const{folderElement:j,fileNameElement:te}=z.isPhone()?this.createFolderRowElementByMobile(_.fileName,"","",true):this.createFolderRowElement(_.fileName,"","",true);d.on(te,"click",J=>{this.enterFolder(J,_);}),w.appendChild(j);}else {const{folderElement:j,fileNameElement:te}=z.isPhone()?this.createFolderRowElementByMobile(_.fileName,_.latestTime,_.fileSize,false):this.createFolderRowElement(_.fileName,_.latestTime,_.fileSize,false);d.on(te,"click",J=>{this.downloadFile(J,te,_);}),w.appendChild(j);}});}removeArrowActiveStatus(){[...Array.from(Y.querySelectorAll(".pops-folder-icon-active")),...Array.from(M.querySelectorAll(".pops-folder-icon-active")),...Array.from(L.querySelectorAll(".pops-folder-icon-active"))].forEach(D=>D.classList.remove("pops-folder-icon-active"));}changeArrowActive(D,_,j){this.removeArrowActiveStatus(),j?_.classList.add("pops-folder-icon-active"):D.classList.add("pops-folder-icon-active");}arrowToSortFolderInfoView(D,_,j){Reflect.get(_,"notChangeSortRule")||(n.sort.name=j,n.sort.isDesc=!n.sort.isDesc);const J=D.querySelector(".pops-folder-icon-arrow-up"),ae=D.querySelector(".pops-folder-icon-arrow-down");if(this.changeArrowActive(J,ae,n.sort.isDesc),typeof n.sort.callback=="function"&&n.sort.callback(D,_,n.sort.name,n.sort.isDesc))return;const ge=[];Array.from(w.children).forEach(he=>{const de=Reflect.get(he,"__value__");Reflect.set(de,"target",he),ge.push(de);}),this.sortFolderConfig(ge,n.sort.name,n.sort.isDesc).forEach(he=>{w.appendChild(he.target);});}}const I=new P;return I.init(),Reflect.set(v,"data-pops-folder",I),n.drag&&be.drag(v,{dragElement:E,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),O.handlePush(t,{guid:e,animElement:A,popsElement:v,maskElement:T,$shadowContainer:r,$shadowRoot:o}),O.handleResultConfig(C)}},Hs=()=>({title:{position:"center",text:"",html:false,style:""},loading:{enable:true,icon:true,text:""},useShadowRoot:true,class:"",url:window.location.href,only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",position:"center",drag:true,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",topRightButton:"min|max|mise|close",sandbox:false,forbiddenScroll:false,loadEndCallBack(){},btn:{min:{callback(){}},max:{callback(){}},mise:{callback(){}},close:{callback(){}}},style:null,beforeAppendToPageCallBack(){}}),Vs={init(a){const e=z.getRandomGUID(),t="iframe";let n=Hs();if(n=z.assign(n,xe.getGlobalConfig()),n=z.assign(n,a),n.url==null)throw new Error("config.url不能为空");n=O.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=O.handlerShadow(n);O.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"iframeCSS",css:W.iframeCSS}]);const s=n.animation!=null&&n.animation!=""?"position:absolute;":"",i=O.handleZIndex(n.zIndex),l=Z.createMask(e,i,s),c=Z.createHeader(t,n),f='<div class="pops-loading"></div>',p=n.title.text.trim()!==""?n.title.text:n.url,{headerStyle:u,headerPStyle:h}=Z.createHeaderStyle(t,n),g=Z.createAnim(e,t,n,`
...
`)}{display: none !important;}`)},setGMResourceCSS(a){const e=typeof At=="function"?At(a.keyName):null;return typeof e=="string"&&e?Vn(e):ie.loadStyleLink(a.url)},async loadStyleLink(a){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=a,new Promise(t=>{Ee.ready(()=>{document.head.appendChild(e),t(e);});})},async loadScript(a){let e=document.createElement("script");return e.src=a,new Promise(t=>{e.onload=()=>{t(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(a){return a=a.trim(),a.startsWith("data:")||a.match(/^http(s|):\/\//i)?a:a.startsWith("//")?(a.startsWith("///")||(a=window.location.protocol+a),a):(a.startsWith("/")||(a+="/"),a=window.location.origin+a,a)},fixHttps(a){if(a.startsWith("https://")||!a.startsWith("http://"))return a;try{let e=new URL(a);return e.protocol="https:",e.toString()}catch{return a}},lockScroll(...a){let e=document.createElement("style");e.innerHTML=`
		...
		`;let t=[document.documentElement,document.body].concat(...a||[]);return t.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){t.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function a(n){navigator.clipboard.readText().then(r=>{n(r);}).catch(r=>{ke.error("读取剪贴板内容失败👉",r),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(r=>{a(n);}).catch(r=>{ke.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),a(n);});}function t(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!t()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(a,e,t=5e3){let n,r=t-e,o=e,s=async i=>{let l=await a(i);if(typeof l=="boolean"&&!l||i){re.workerClearTimeout(n);return}if(o+=e,o>r){s(true);return}n=re.workerSetTimeout(()=>{s(false);},e);};s(false);},findParentNode(a,e,t){if(t){let n=Ee.closest(a,t);if(n)return n.querySelector(e)}else return Ee.matches(a,e)?a:Ee.closest(a,e)},toStr(a){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(a,(n,r)=>r===void 0?e:r,2).replace(new RegExp(`"${e}"`,"g"),"undefined")}},at={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},re=We.noConflict(),b=Ee.noConflict(),He=Ot,ke=new re.Log(Ge,Ae.console||Ve.console),Yt=Ge?.script?.name||void 0,Js=Ot.config.Utils.AnyTouch(),Zs=false;ke.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});R.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(a){const e=a.setting.type;if(e==="loading")return  false;const t=a.setting.content;return e==="warning"?ke.warn(t):e==="error"?ke.error(t):ke.info(t),true},get position(){return Ne.getValue(at.qmsg_config_position.key,at.qmsg_config_position.defaultValue)},get maxNums(){return Ne.getValue(at.qmsg_config_maxnums.key,at.qmsg_config_maxnums.defaultValue)},get showReverse(){return Ne.getValue(at.qmsg_config_showreverse.key,at.qmsg_config_showreverse.defaultValue)},get zIndex(){let a=We.getMaxZIndex(),e=Ot.config.InstanceUtils.getPopsMaxZIndex().zIndex;return We.getMaxValue(a,e)+100}});He.GlobalConfig.setGlobalConfig({zIndex:()=>{const a=We.getMaxZIndex(void 0,void 0,t=>{if(t?.classList?.contains("qmsg-shadow-container")||t?.closest("qmsg")&&t.getRootNode()instanceof ShadowRoot)return  false}),e=Ot.config.InstanceUtils.getPopsMaxZIndex().zIndex;return We.getMaxValue(a,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ei=new re.GM_Menu({GM_getValue:qe,GM_setValue:Pe,GM_registerMenuCommand:Tt,GM_unregisterMenuCommand:Ft}),ln=new re.Httpx({xmlHttpRequest:Fn,logDetails:Zs});ln.interceptors.request.use(a=>a);ln.interceptors.response.use(void 0,a=>(ke.error("拦截器-请求错误",a),a.type==="onabort"?R.warning("请求取消",{consoleLogContent:true}):a.type==="onerror"?R.error("请求异常",{consoleLogContent:true}):a.type==="ontimeout"?R.error("请求超时",{consoleLogContent:true}):R.error("其它错误",{consoleLogContent:true}),a));Ae.Object.defineProperty,Ae.Function.prototype.apply,Ae.Function.prototype.call,Ae.Element.prototype.appendChild,Ae.setTimeout;const Vn=b.addStyle.bind(b);Ee.selector.bind(Ee);Ee.selectorAll.bind(Ee);new re.GM_Cookie;const Et="GM_Panel",Ar="data-init",Un="data-key",zn="data-default-value",ti="data-init-more-value",ni="data-plugin-search-config",Le={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},Oe={setting:{get width(){return Le.width<550?"88vw":Le.width<700?"550px":"700px"},get height(){return Le.height<450?"70vh":Le.height<550?"450px":"550px"}},settingMiddle:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<450?"88vh":"450px"}},settingBig:{get width(){return Le.width<800?"92vw":"800px"},get height(){return Le.height<600?"80vh":"600px"}},info:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<250?"88vh":"250px"}}};class ri{storageKey;listenerData;constructor(e){if(typeof e=="string"){const t=e.trim();if(t=="")throw new Error("key参数不能为空字符串");this.storageKey=t;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new We.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let e=qe(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){Pe(this.storageKey,e);}set(e,t){const n=this.get(e),r=this.getLocalValue();Reflect.set(r,e,t),this.setLocalValue(r),this.triggerValueChangeListener(e,n,t);}get(e,t){const n=this.getLocalValue();return Reflect.get(n,e)??t}getAll(){return this.getLocalValue()}delete(e){const t=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.triggerValueChangeListener(e,t,void 0);}has(e){const t=this.getLocalValue();return Reflect.has(t,e)}keys(){const e=this.getLocalValue();return Reflect.ownKeys(e)}values(){const e=this.getLocalValue();return Reflect.ownKeys(e).map(t=>Reflect.get(e,t))}clear(){ct(this.storageKey);}addValueChangeListener(e,t){const n=Math.random(),r=this.listenerData.get(e)||[];return r.push({id:n,key:e,callback:t}),this.listenerData.set(e,r),n}removeValueChangeListener(e){let t=false;for(const[n,r]of this.listenerData.entries()){for(let o=0;o<r.length;o++){const s=r[o];(typeof e=="string"&&s.key===e||typeof e=="number"&&s.id===e)&&(r.splice(o,1),o--,t=true);}this.listenerData.set(n,r);}return t}async triggerValueChangeListener(...e){const[t,n,r]=e;if(!this.listenerData.has(t))return;let o=this.listenerData.get(t);for(let s=0;s<o.length;s++){const i=o[s];if(typeof i.callback=="function"){let l=this.get(t),c,f;typeof n<"u"&&e.length>=2?f=n:f=l,typeof r<"u"&&e.length>2?c=r:c=l,await i.callback(t,f,c);}}}}const Ue=new ri(Et),yt={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new re.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(a){Array.isArray(a)||(a=[a]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,a);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(a=0){return this.$data.contentConfig.get(a)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let a=false,e;const t=(o,s)=>{typeof s!="string"&&(s=ie.toStr(s));const i=new Blob([s]),l=globalThis.URL.createObjectURL(i);b.createElement("a",{href:l,download:o}).click(),re.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const o=p=>{const u=He.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),h=u.$shadowRoot.querySelector(".btn-control[data-mode='local']"),g=u.$shadowRoot.querySelector(".btn-control[data-mode='network']"),y=u.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),x=async v=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof it=="function"?typeof ct=="function"?(it().forEach(w=>{ct(w);}),R.success("已清空脚本存储的配置")):R.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):R.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof ft=="function"?ft(v):Object.keys(v).forEach(w=>{const k=v[w];Pe(w,k);}),R.success("配置导入完毕");},A=v=>new Promise(async E=>{const S=re.toJSON(v);Object.keys(S).length===0?R.warning("解析为空配置，不导入"):await x(S),E(true);});b.on(h,"click",v=>{b.preventEvent(v),u.close();const E=b.createElement("input",{type:"file",accept:".json"});b.on(E,["propertychange","input"],S=>{if(!E.files?.length)return;const w=E.files[0],k=new FileReader;k.onload=()=>{A(k.result);},k.readAsText(w,"UTF-8");}),E.click();}),b.on(g,"click",v=>{b.preventEvent(v),u.close();const E=He.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(k,H){k.close();}},ok:{text:"导入",callback:async(k,H)=>{const U=k.text;if(re.isNull(U)){R.error("请填入完整的url");return}const F=R.loading("正在获取配置..."),K=await ln.get(U,{allowInterceptConfig:false});if(F.close(),!K.status){ke.error(K),R.error("获取配置失败",{consoleLogContent:true});return}await A(K.data.responseText)&&k.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:Oe.info.width,height:"auto"}),S=E.$shadowRoot.querySelector("input"),w=E.$shadowRoot.querySelector(".pops-prompt-btn-ok");b.on(S,["input","propertychange"],k=>{b.val(S)===""?b.attr(w,"disabled","true"):b.removeAttr(w,"disabled");}),b.listenKeyboard(S,"keydown",(k,H,U)=>{k==="Enter"&&U.length===0&&b.val(S)!==""&&b.trigger(w,"click");}),b.trigger(S,"input");}),b.on(y,"click",async v=>{b.preventEvent(v),u.close();let E=await ie.getClipboardText();if(E.trim()===""){R.warning("获取到的剪贴板内容为空");return}await A(E);});},s=(p=`${Yt}_panel-setting-${re.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,u)=>{const h=He.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(x,A){x.close();}}},drag:true,mask:{enable:true},width:Oe.info.width,height:Oe.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),g=h.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),y=h.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");b.on(g,"click",x=>{b.preventEvent(x);try{t(p,u),h.close();}catch(A){R.error(A.toString(),{consoleLogContent:true});}}),b.on(y,"click",async x=>{await re.copy(u)?(R.success("复制成功"),h.close()):R.error("复制失败");});},l=He.confirm({title:{text:"配置",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof it=="function")it().forEach(u=>{const h=qe(u);Reflect.set(c,u,h);});else {R.warning("不支持函数GM_listValues，仅导出菜单配置");const p=qe(Et);Reflect.set(c,Et,p);}const f=ie.toStr(c);l.value=f;},r=()=>{let o=Ge?.script?.supportURL||Ge?.script?.namespace;typeof o=="string"&&re.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${Ge?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(){return  false},afterRender(o){new Js(o.$asideLiElement).on("tap",function(i){clearTimeout(e),e=void 0,a?(a=false,n()):(e=setTimeout(()=>{a=false,r();},200),a=true);});}}]},setDefaultBottomContentConfig(a){this.$data.__defaultBottomContentConfig=a;}},Jt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(a){return a},callback:()=>{Ne.showPanel(yt.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){Ne.isTopWindow()&&ei.add(this.$data.menuOption);},addMenuOption(a){Array.isArray(a)||(a=[a]),this.$data.menuOption.push(...a);},updateMenuOption(a){Array.isArray(a)||(a=[a]),a.forEach(e=>{let t=this.$data.menuOption.findIndex(n=>n.key===e.key);t!==-1&&(this.$data.menuOption[t]=e);});},getMenuOption(a=0){return this.$data.menuOption[a]},deleteMenuOption(a=0){this.$data.menuOption.splice(a,1);}},Ne={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new re.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new re.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new re.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new re.Dictionary),this.__onceExecData},get scriptName(){return Yt},get panelConfig(){return this.__panelConfig},set panelConfig(a){this.__panelConfig=a;},key:Et,attributeKeyName:Un,attributeDefaultValueName:zn},init(){this.initContentDefaultValue(),Jt.init();},isTopWindow(){return Ae.top===Ae.self},initContentDefaultValue(){const a=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const r=n.attributes;let o=r[Ar];if(typeof o=="function"){let c=o();if(typeof c=="boolean"&&!c)return}let s=new Map,i=r[Un];if(i!=null){const c=r[zn];s.set(i,c);}let l=r[ti];if(typeof l=="object"&&l&&Object.keys(l).forEach(c=>{const f=l[c];s.set(c,f);}),!s.size){ke.warn(["请先配置键",n]);return}if(n.type==="switch"){let c=typeof n.disabled=="function"?n.disabled():n.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...s.keys());}for(const[c,f]of s.entries())this.setDefaultValue(c,f);},e=n=>{for(let r=0;r<n.length;r++){let o=n[r];a(o);let s=o.forms;s&&Array.isArray(s)&&e(s);}},t=[...yt.getAllContentConfig()];for(let n=0;n<t.length;n++){let r=t[n];if(!r.forms)continue;const o=r.forms;o&&Array.isArray(o)&&e(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(a,e){this.$data.contentConfigInitDefaultValue.has(a)&&ke.warn("请检查该key(已存在): "+a),this.$data.contentConfigInitDefaultValue.set(a,e);},getDefaultValue(a){return this.$data.contentConfigInitDefaultValue.get(a)},setValue(a,e){Ue.set(a,e);},getValue(a,e){const t=Ue.get(a);return t??(this.$data.contentConfigInitDefaultValue.has(a)?this.$data.contentConfigInitDefaultValue.get(a):e)},deleteValue(a){Ue.delete(a);},hasKey(a){return Ue.has(a)},addValueChangeListener(a,e){return Ue.addValueChangeListener(a,(n,r,o)=>{e(a,o,r);})},removeValueChangeListener(a){Ue.removeValueChangeListener(a);},triggerMenuValueChange(a,e,t){Ue.triggerValueChangeListener(a,t,e);},async exec(a,e,t,n=true){const r=this;let o;typeof a=="string"||Array.isArray(a)?o=()=>a:o=a;let s=false;const i=o();let l=[];Array.isArray(i)?(s=true,l=i):l.push(i);const c=l.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(c){ke.warn(`${c} 键不存在`);return}const f=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(f))return this.$data.onceExecMenuData.get(f);let p=[];const u=[];let h=[];const g=(w,k)=>{let H=[],U=[],F=[];if(Array.isArray(k))F=F.concat(k);else if(typeof k=="object"&&k!=null)if(k instanceof Element)F.push(k);else {const{$css:K,destory:Y}=k;K!=null&&(Array.isArray(K)?F=F.concat(K):F.push(K)),typeof Y=="function"&&F.push(Y);}else F.push(k);for(const K of F)if(K!=null){if(K instanceof Element){H.push(K);continue}if(typeof K=="function"){h.push(K);continue}}w?(p=p.concat(H),h=h.concat(U)):(x(),A());},y=w=>!!this.getValue(w),x=()=>{for(let w=0;w<p.length;w++)p[w]?.remove(),p.splice(w,1),w--;},A=()=>{for(let w=0;w<h.length;w++){const k=h[w];k(),h.splice(w,1),w--;}},v=()=>{let w=false;return typeof t=="function"?w=t(l):w=l.every(k=>y(k)),w},E=async w=>{if(v()){const H=l.map(F=>this.getValue(F)),U=await e({value:s?H:H[0],addStoreValue:(...F)=>g(true,F)});g(true,U);}else g(false,[]);};n&&l.forEach(w=>{const k=this.addValueChangeListener(w,(H,U,F)=>E());u.push(k);}),await E();const S={reload(){this.clearStoreStyleElements(),this.destory(),E();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>x(),destory(){return A()},removeValueChangeListener:()=>{u.forEach(w=>{this.removeValueChangeListener(w);});},clearOnceExecMenuData(){n&&r.$data.onceExecMenuData.delete(f);}};return this.$data.onceExecMenuData.set(f,S),S},async execMenu(a,e,t=false,n=false){return await this.exec(a,async r=>await e(r),r=>r.every(s=>{let i=!!this.getValue(s);return Ne.$data.contentConfigInitDisabledKeys.includes(s)&&(i=false,ke.warn(`.execMenu${n?"Once":""} ${s} 被禁用`)),t&&(i=!i),i}),n)},async execMenuOnce(a,e,t=false,n=false){const r=await this.execMenu(a,e,t,true);if(n&&r){const o=()=>{r.reload();};this.removeUrlChangeWithExecMenuOnceListener(a),this.addUrlChangeWithExecMenuOnceListener(a,o);}return r},deleteExecMenuOnce(a){return a=this.transformKey(a),this.$data.onceExecMenuData.delete(a),this.$data.urlChangeReloadMenuExecOnce.delete(a),Ue.removeValueChangeListener(a)},onceExec(a,e){if(a=this.transformKey(a),typeof a!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(a)||(e(),this.$data.onceExecData.set(a,1));},deleteOnceExec(a){a=this.transformKey(a),this.$data.onceExecData.delete(a);},addUrlChangeWithExecMenuOnceListener(a,e){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.set(a,e);},removeUrlChangeWithExecMenuOnceListener(a){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.delete(a);},hasUrlChangeWithExecMenuOnceListener(a){return a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.has(a)},async triggerUrlChangeWithExecMenuOnceEvent(a){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const t of e)await t(a);},showPanel(a,e=`${Yt}-设置`,t=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let r=a.findIndex(s=>(typeof s.isBottom=="function"?s.isBottom():!!s.isBottom)&&s.id==="script-version")!==-1;!t&&!r&&a.push(...yt.getDefaultBottomContentConfig());let o=He.panel({title:{text:e,position:"center",html:false,style:""},content:a,btn:{close:{enable:true,callback:(s,i)=>{s.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(s,i)=>{s(),this.$data.$panel=null;}},width:Oe.setting.width,height:Oe.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=a,n||this.registerConfigSearch({$panel:o,content:a});},registerConfigSearch(a){const{$panel:e,content:t}=a,n=async(u,h)=>{if(u==null)return;const g=await h(u);return g&&typeof g.isFind=="boolean"&&g.isFind?g.data:await n(g.data,h)},r=(u,h)=>{const g=new IntersectionObserver(y=>{y.forEach(x=>{x.isIntersecting&&(h?.(),g.disconnect());});},{root:null,threshold:1});g.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},o=u=>{const h="pops-flashing";b.animationend(u,()=>{u.classList.remove(h);}),u.classList.add(h);},s=u=>{if(u.type==="dblclick"&&p)return;b.preventEvent(u),l=null;const h=He.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${a.searchDialogStyle??""}
				`});h.$shadowRoot.querySelector(".search-wrapper");const g=h.$shadowRoot.querySelector(".search-config-text"),y=h.$shadowRoot.querySelector(".search-result-wrapper");g.focus();const x=()=>{b.empty(y);},A=E=>{const S=re.queryProperty(E,k=>k?.next?{isFind:false,data:k.next}:{isFind:true,data:k}),w=b.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return b.on(w,"click",k=>{const U=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[E.index];if(!U){R.error(`左侧项下标${E.index}不存在`);return}U.scrollIntoView({behavior:"smooth",block:"center"}),U.click(),n(E.next,async F=>{if(F?.next){const K=await b.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(Y=>{const M=Reflect.get(Y,"__formConfig__");return typeof M=="object"&&M!=null&&M.text===F.name}),2500);if(K)K.click();else return R.error("未找到对应的二级菜单"),{isFind:true,data:F};return {isFind:false,data:F.next}}else {const K=await b.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(Y=>Reflect.get(Y,"__formConfig__")===F.matchedData?.formConfig),2500);if(K){r(K);const Y=K.closest(".pops-panel-forms-fold[data-fold-enable]");Y&&(Y.querySelector(".pops-panel-forms-fold-container").click(),await re.sleep(500)),r(K,()=>{o(K);});}else R.error("未找到对应的菜单项");return {isFind:true,data:F}}});}),w},v=E=>{const S=new RegExp(E,"i"),w=[],k=(U,F)=>{for(let K=0;K<U.length;K++){const Y=U[K],M=Y.forms;if(M&&Array.isArray(M)){const L=re.deepClone(F);if(Y.type==="deepMenu"){const T=re.queryProperty(L,m=>m?.next?{isFind:false,data:m.next}:{isFind:true,data:m});T.next={name:Y.text};}k(M,L);}else {let L,T;if(Y.type==="own"){const P=Reflect.get(Y.attributes||{},ni);P&&(typeof P.text=="string"&&(L=P.text),typeof P.desc=="string"&&(T=P.desc));}else L=Reflect.get(Y,"text"),T=Reflect.get(Y,"description");const m=[L,T],C=m.findIndex(P=>{if(typeof P=="string")return P.match(S)});if(C!==-1){const P=re.deepClone(F),I=re.queryProperty(P,D=>D?.next?{isFind:false,data:D.next}:{isFind:true,data:D});I.next={name:L,matchedData:{path:"",formConfig:Y,matchedText:m[C],description:T}};const N=[];re.queryProperty(P,D=>{const _=D?.name;return typeof _=="string"&&_.trim()!==""&&N.push(_),D?.next?{isFind:false,data:D.next}:{isFind:true,data:D}});const Q=N.join(ie.escapeHtml(" - "));I.next.matchedData.path=Q,w.push(P);}}}};for(let U=0;U<t.length;U++){const F=t[U];if(!F.forms||F.isBottom&&F.id==="script-version")continue;const K=F.forms;if(K&&Array.isArray(K)){let Y=F.title;typeof Y=="function"&&(Y=Y()),k(K,{index:U,name:Y});}}const H=document.createDocumentFragment();for(const U of w){let F=A(U);H.appendChild(F);}x(),y.append(H);};b.on(g,"input",re.debounce(E=>{b.preventEvent(E);let S=b.val(g).trim();if(S===""){x();return}v(S);},200));};e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(u=>{b.on(u,"dblclick",s);});let l=null,c=false,f,p=false;b.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(u,h)=>{p=true,clearTimeout(f),f=void 0,c&&l===h?(c=false,l=null,s(u)):(f=setTimeout(()=>{c=false;},200),c=true,l=h);},{capture:true}),e.$shadowRoot.appendChild(b.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
			...
			`;}),b.html(a,t);},setTag(a,e,t){ee.clearTag(a),b.addClass(a,e),typeof t=="string"&&b.html(a,t);},clearTag(a){Object.keys(Sr).forEach(e=>{b.removeClass(a,e);});}},Zt=function(a,e,t,n,r,o){const s={type:"own",attributes:n||{},props:r||{},getLiElementCallBack:a,afterAddToUListCallBack:o};return Reflect.set(s.attributes,Ar,()=>false),s},$=a=>Zt(t=>{let n=b.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
				...
				`});return t.appendChild(n),t},void 0,void 0,void 0,void 0,async(t,n)=>{let r=n.target,o=r.querySelector(".pops-panel-item-left-text"),s=r.querySelector(".pops-panel-item-left-main-text"),i=r.querySelector(".pops-panel-item-left-desc-text"),l=await a();l.tag==null?b.html(s,l.text):b.html(s,Sr[l.tag]+l.text),(l.description==null||l.description==="")&&b.hide(i,false),b.html(i,l.description||"");let c=["support-info"];if(l.tag!=null&&c.push(l.tag),b.addClass(s,c),typeof l.afterRender=="function")try{l.afterRender({...n,$leftContainer:o,$leftText:s,$leftDesc:i});}catch(f){console.log(f),ee.setTag(s,"error","afterRender 函数执行错误"+f);}}),G={asideLastVisit:"aside-last-visit"},oi={getWindow(){return Ce.unsafeWindow.isSupport()?Ae:window}};class ai{}class Nt extends ai{isSupportGM(){return typeof V=="object"&&V!=null}}class ce extends Nt{}const se={getApiDocUrl(a,e){return e=e??a,`<a href="https://www.tampermonkey.net/documentation.php?ext=gcal&version=#api:${a}" target="_blank">${e}</a>`}};class si extends ce{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof V.addElement=="function"}}isSupport(){return typeof cn=="function"}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(cn,this,r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.addElement,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push($(async()=>{let s=null,i=null,l=oi.getWindow(),c=o+"_test_script_exec",f=`${c}_test_str`;try{return s=await r.fn("script",{id:c,textContent:`window["${f}"] = "bar";`}),i=document.querySelector("#"+c),s==null?{text:`${r.name} returns is null`,tag:"error"}:s instanceof HTMLElement?typeof l[f]!="string"?{text:`${r.name} script element is not work`,tag:"error"}:(Reflect.deleteProperty(l,f),{text:ie.escapeHtml("支持添加<script>元素且执行js"),tag:"success"}):{text:`${r.name} returns is not style element`,tag:"error"}}catch(p){return console.error(p),{text:"执行错误 "+p,tag:"error"}}finally{i&&i.remove();}}),$(async()=>{let s=null,i=null,l=o+"_test2";try{if(s=await r.fn(document.body,"div",{"data-src":"https://example.com/image.png",id:l}),s==null)return {text:r.name+" returns is null",tag:"error"};if(!(s instanceof HTMLElement))return {text:r.name+" returns is not style element",tag:"error"};if(i=document.querySelector("#"+l),!i)return {text:"不支持3个参数",tag:"error"};const c=i.attachShadow({mode:"closed"});return await r.fn(c,"style",{textContent:"div { color: black; };"}),c.querySelector("style")?s==null?{text:"传入3个参数但是返回为空",tag:"error"}:i.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(c){return console.error(c),{text:"执行错误 "+c,tag:"error"}}finally{i&&i.remove();}}));}),n}}class ii extends ce{isSupport(){return typeof fn=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof V.addStyle=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-GM_addStyle"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(fn,this,r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.addStyle,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push($(async()=>{let s=null,i=null;try{return s=b.createElement("div",{id:o,innerText:o+" test"}),document.body.appendChild(s),i=await r.fn(`
						...
						`),i==null?{text:`${r.name} returns is null`,tag:"error"}:i instanceof HTMLStyleElement?window.getComputedStyle(s).backgroundColor!=="rgb(255, 0, 0)"?{text:`${r.name} test element background is not rgb(255, 0, 0)`,tag:"error"}:{text:ie.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}:{text:`${r.name} returns is not HTMLStyleElement`,tag:"error"}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}finally{s?.remove(),i?.remove();}}));}),n}}class li extends ce{isSupport(){return typeof zt=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof V.addValueChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=zt(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.addValueChangeListener,formList:n.forms[2].forms}].forEach(r=>{let o=r.name;r.formList.push((()=>{let s=o+"_key_1";return $(()=>({text:"测试监听数据存储改变",description:"",tag:"info",afterRender(i){let l=b.toElement(`
									...
									`,!1,!1);b.on(c,"click",async f=>{try{b.preventEvent(f);const p=await i.list({});console.log(p),Array.isArray(p)?He.alert({title:{text:i.name+".list",position:"center"},content:{text:JSON.stringify(p,null,4),html:!0},drag:!0,mask:{enable:!0},width:Oe.setting.width,height:Oe.setting.height,style:`
															.pops-alert-content{
								...
								`,false,false);b.after(o.$leftContainer,s);let i;b.on(s,"click",async l=>{try{b.preventEvent(l),clearTimeout(i),ee.setTag(o.$leftText,"error","等待3s内触发回调函数"),i=Me(()=>{ee.setTag(o.$leftText,"error","超时，不支持触发回调函数");},3e3);let c=await r.fn();clearTimeout(i),console.log(r.name+" callback tabs",c),typeof c=="object"&&c!=null?ee.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"success",text:"入参tab为object类型"}]):ee.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"error",text:"入参tab不为object类型"}]),alert(JSON.stringify(c));}catch(c){R.error(c.toString(),{consoleLogContent:true});}});}})));}),n}}class gi extends ce{isSupport(){return typeof qe=="function"}getApiName(){return "GM_getValue"}getAsyncApiOption(){return {name:"GM.getValue",isSupport:this.isSupportGM()&&typeof V.getValue=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=qe(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.getValue,formList:n.forms[2].forms}].forEach(r=>{let o=r.name;r.formList.push(...[{key:`Test ${o} boolean`,value:true,text:function(){return "存储boolean类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} number`,value:1,text:function(){return "存储number类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} string`,value:"测试字符串",text:function(){return "存储string类型并读取"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:`Test ${o} undefined`,value:void 0,text:function(){return "存储undefined类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} null`,value:null,text:function(){return "存储object类型的null并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} object`,value:{"object key":"object value"},text:function(){return "存储object类型并读取"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(s=>(()=>{let i=s.key,l=s.value;return $(()=>({text:s.text(),description:s.desc(),tag:"info",afterRender(c){let f=b.toElement(`
									...
									`,false,false);b.after(l.$leftContainer,c),b.on(c,"click",async f=>{b.preventEvent(f);try{let p=await r.fn(s,i);typeof p==typeof i?R.success("读取的值是默认值："+p):R.error("读取的值不是默认值："+p);}catch(p){R.error(p.toString(),{consoleLogContent:true});}});}}))})());}),n}}class yi extends ce{isSupport(){return typeof St=="function"}getApiName(){return "GM_getValues"}getAsyncApiOption(){return {name:"GM.getValues",isSupport:this.isSupportGM()&&typeof V.getValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=St(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.getValues,formList:n.forms[2].forms}].forEach(r=>{let o=r.name;r.formList.push($(()=>({text:"测试直接读取",description:"没有入参",tag:"info",afterRender(s){let i=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
							...
							"${o}-test-key-2": 2,
								...
								`,!1,!1),g,y,x=re.debounce(()=>{try{clearTimeout(g),clearInterval(y);let A="",v="success",E="",S="success";i?(A+="支持 onclick 函数",l?(A=A.trim(),A+="且支持提供 event 参数"):(A+="但是不支持提供 event 参数",v="warn")):(A+="不支持 onclick 函数",v="error"),c?E+="支持 ondone 函数":(E+="不支持 ondone 函数",S="error"),b.html(u.$leftText,`
												<p class="${v}">${A}</p>
												<p class="${S}">${E}</p>`),i=!1,c=!1,l=!1;}catch(A){R.error(A.toString(),{consoleLogContent:!0});}},800);b.on(h,"click",async A=>{try{b.preventEvent(A),clearTimeout(g),clearInterval(y);let v=10,E=v,S=()=>{let w=`正在等待触发回调，请在规定时间内点击弹窗的【关闭】按钮或者内容：${E}s`;return E--,w};b.text(u.$leftText,S()),b.text(u.$leftDesc,f),b.show(u.$leftDesc,!1),g=Me(()=>{clearInterval(y),ee.setTag(u.$leftText,"error","测试超时，未触发回调");},v*1e3),y=setInterval(()=>{b.text(u.$leftText,S());},1e3),await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",onclick:w=>{console.log(w),i=!0,w&&typeof w.preventDefault=="function"&&(l=!0,w.preventDefault()),x();},ondone(){c=!0,x();}});}catch(v){R.error(v.toString(),{consoleLogContent:!0});}}),b.after(s,h);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),$(()=>{try{let o,s,i=!1,l=!1,c=!1,f="123",p="456",u="notification_tag_"+Date.now(),h={title:"测试通知的内容更新（tag）",text:f,tag:u},g=`更新前：${f}，更新后：${p}`;return {text:h.title,description:g,tag:"info",afterRender(y){o=y.target,s=y.$leftContainer;let x=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),A,v;b.on(x,"click",async E=>{try{b.preventEvent(E),clearTimeout(A),clearInterval(v);let S=5,w=S,k=()=>{let H=`${w}s后通知的内容将更新为：${p}`;return w--,H};b.text(y.$leftDesc,k()),b.show(y.$leftDesc,!1),A=setTimeout(async()=>{clearInterval(v),b.text(y.$leftDesc,g),r.fn({...h,text:p});},S*1e3),v=setInterval(()=>{b.text(y.$leftDesc,k());},1e3),await r.fn(h);}catch(S){R.error(S.toString(),{consoleLogContent:!0});}}),b.after(s,x);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class Si extends ce{isSupport(){return typeof gn=="function"}getApiName(){return "GM_openInTab"}getAsyncApiOption(){return {name:"GM.openInTab",isSupport:this.isSupportGM()&&typeof V.openInTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=gn(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.openInTab,formList:n.forms[2].forms}].forEach(r=>{r.formList.push($(()=>{try{return {text:"后台打开：https://www.example.com/",tag:"info",afterRender(o){let s=o.target,i=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
									...
									`,!1,!1),l,c=()=>{clearTimeout(l),ee.setTag(o.$leftText,"success","测试新标签页打开成功");};b.on(i,"click",async f=>{try{b.preventEvent(f),b.off(Ae,"blur",c,{capture:!0}),clearTimeout(l),ee.setTag(o.$leftText,"info","等待页面失去焦点..."),b.text(o.$leftDesc,this.text),b.show(o.$leftDesc,!1),b.on(Ae,"blur",c,{capture:!0,once:!0}),await r.fn("https://www.example.com/",{active:!0}),l=Me(()=>{b.off(Ae,"blur",c,{capture:!0}),ee.setTag(o.$leftText,"error","测试超时，未打开新标签页并获取焦点");},3e3);}catch(p){R.error(p.toString(),{consoleLogContent:!0});}}),b.after(o.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),$(()=>{try{return {text:"测试调用返回值 .close()",tag:"info",afterRender(o){let s=o.target,i=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),l,c;b.on(i,"click",async f=>{try{b.preventEvent(f),clearTimeout(c),clearTimeout(l),ee.setTag(o.$leftText,"info","等待触发监听 .onclose"),b.text(o.$leftDesc,this.text),b.show(o.$leftDesc,!1);let p=await r.fn("https://www.example.com/");typeof p=="object"&&p!=null&&(p.onclose=()=>{clearTimeout(l),clearTimeout(c),ee.setTag(o.$leftText,"success","成功触发 .onclose");}),p&&typeof p?.close=="function"?l=Me(()=>{try{p.close(),c=Me(()=>{ee.setTag(o.$leftText,"error","测试超时，未触发回调 .onclose");},2e3);}catch(u){ee.setTag(o.$leftText,"error","调用 .close() 方法失败 "+u);}},1e3):ee.setTag(o.$leftText,"error","返回对象中不支持 .close() 方法");}catch(p){R.error(p.toString(),{consoleLogContent:!0});}}),b.after(o.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class Ti extends ce{isSupport(){return typeof Tt=="function"}getApiName(){return "GM_registerMenuCommand"}getAsyncApiOption(){return {name:"GM.registerMenuCommand",isSupport:this.isSupportGM()&&typeof V.registerMenuCommand=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=Tt(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.registerMenuCommand,formList:n.forms[2].forms}].forEach(r=>{r.formList.push($(()=>{try{return {text:"注册菜单 ==> Test Menu",tag:"info",afterRender(o){let s=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
...
`));}else ee.setTag(i.$leftText,"error","返回值类型错误："+typeof f);b.text(i.$leftDesc,this.text),b.show(i.$leftDesc,!1),alert(JSON.stringify(f,null,4));}catch(f){R.error(f.toString(),{consoleLogContent:!0});}}),b.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}finally{}}),$(()=>{try{return {text:ie.escapeHtml("测试监听静音状态改变"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=b.toElement(`
			...
			`});return b.on(r,"click",o=>{b.preventEvent(o);let s=r.getRootNode(),i=re.isNotNull(n.leftTargetSelector)?n.leftTargetSelector:"#aside-"+n.name,l=s.querySelector(i);l&&(l.click(),l.scrollIntoView({behavior:"smooth"}));}),r};return {id:"component-common",title:"通用",scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)==="component-common"},clickCallback(n){q.set(G.asideLastVisit,"component-common");},forms:[{type:"forms",text:"@run-at document-start<br>注：注入速度等级越低，注入的速度越快<br>范围：0~4",forms:[$(()=>({text:ie.escapeHtml(st),tag:"info"}))]},{type:"forms",text:"特性",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontSize="1.2em",r.formHeaderDivElement.style.fontWeight="700";},forms:[]},{type:"forms",text:"不支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.color="rgb(216, 30, 6)",r.formHeaderDivElement.style.fontWeight="600",e.length===0&&r.formContainerListElement?.remove();},forms:[Zt(n=>{const r=b.createElement("div",{className:"gm-api-features-not-support"}),o=document.createDocumentFragment();return e.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n})]},{type:"forms",text:"支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontWeight="600",a.length===0&&r.formContainerListElement?.remove();},forms:[Zt(n=>{const r=b.createElement("div",{className:"gm-api-features-support"}),o=document.createDocumentFragment();return a.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n})]}]}};class Bi extends Nt{getApiName(){return "window.onurlchange "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(n){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"功能测试",forms:[$(()=>{try{return {text:ie.escapeHtml("测试window.onurlchange"),tag:"info",description:"点击按钮进行测试",afterRender(n){let r=b.toElement(`
											...
											`,!1,!1);b.on(r,"click",o=>{b.preventEvent(o);try{Ve.close();}catch(s){R.error(s.toString(),{consoleLogContent:!0});}}),b.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}finally{}})]}]}}}class Hi extends Nt{getApiName(){return "window.focus "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(n){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"功能测试",forms:[$(()=>{try{return {text:ie.escapeHtml("测试window.focus"),tag:"info",description:"点击按钮执行该函数",afterRender(n){let r=b.toElement(`
											<div class="pops-panel-button pops-panel-button-no-icon">
												<button class="pops-panel-button_inner" type="button" data-type="default">
													<i class="pops-bottom-icon" is-loading="false"></i>
													<span class="pops-panel-button-text">点击执行</span>

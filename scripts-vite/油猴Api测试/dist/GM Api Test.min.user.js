...
`;const GlobalConfig={config:{},setGlobalConfig(S){Reflect.ownKeys(S).forEach(w=>{Reflect.set(GlobalConfig.config,w,Reflect.get(S,w));});},getGlobalConfig(){let S={};return Object.keys(GlobalConfig.config).forEach(w=>{let A=Reflect.get(GlobalConfig.config,w);if(w==="style"){let C=A==null?"":typeof A=="function"?A():A;typeof C=="string"&&(S.style=C);}else if(w==="zIndex"){let C=A==null?"":typeof A=="function"?A():A;if(typeof C=="string"){let T=C=parseInt(C);isNaN(T)||(S.zIndex=T);}else isNaN(C)||(S.zIndex=C);}else if(w==="mask"){let C=GlobalConfig.config.mask==null?{}:GlobalConfig.config.mask;typeof C=="object"&&C!=null&&(S.mask=C);}else Reflect.set(S,w,A);}),S}},PopsElementHandler={getMaskHTML(S,w=101,A=""){return w=w-100,A.startsWith(";")&&(A=A.replace(";","")),`<div class="pops-mask" data-guid="${S}" style="z-index:${w};${A}"></div>`},getAnimHTML(S,w,A,C="",T="",E){let k=A,U="",I="",L=k.position||"";A.zIndex!=null&&(U+=`z-index: ${E};`,I+=`z-index: ${E};`),k.width!=null&&(I+=`width: ${k.width};`),k.height!=null&&(I+=`height: ${k.height};`);let _=T.trim()!=="";return `
		<div 
		...
		</div>`},getHeaderBtnHTML(S,w){var k,U,I,L,_;if(!w.btn)return "";let A=w;if(S!=="iframe"&&!((U=(k=A.btn)==null?void 0:k.close)!=null&&U.enable))return "";let C="",T="",E=w;if(S==="iframe"&&((I=E.topRightButton)==null?void 0:I.trim())!==""){let P="";E.topRightButton.split("|").forEach($=>{$=$.toLowerCase(),P+=`
                <button class="pops-header-control" type="${$}">
                    <i class="pops-icon">${pops.config.iconSVG[$]}</i>
                </button>`;}),C=`
            <div class="pops-header-controls" data-margin>
                ${P}
            </div>`;}else (_=(L=A.btn)==null?void 0:L.close)!=null&&_.enable&&(T=`
                <div class="pops-header-controls">
                    <button class="pops-header-control" type="close" data-header>
                    <i class="pops-icon">${pops.config.iconSVG.close}</i>
                    </button>
                </div>`),C=T;return C},getBottomBtnHTML(S,w){var I,L,_,P,$,B,V,D,N,R,F,W,X,K;if(!w.btn)return "";let A=w;if(!((L=(I=w.btn)==null?void 0:I.ok)!=null&&L.enable||(P=(_=A.btn)==null?void 0:_.cancel)!=null&&P.enable||(B=($=A.btn)==null?void 0:$.other)!=null&&B.enable))return "";let C="",T="",E="",k="",U="";if(w.btn.position&&(C+=`justify-content: ${w.btn.position};`),A.btn.reverse&&(C+="flex-direction: row-reverse;"),(D=(V=w.btn)==null?void 0:V.ok)!=null&&D.enable){let G="";(w.btn.ok.size==="large"||w.btn.ok.size==="small")&&(G="pops-button-"+w.btn.ok.size);let tt="",et=A.btn.ok.icon;if(et!==""){let nt="";et in pops.config.iconSVG?nt=pops.config.iconSVG[et]:nt=et,nt=nt||"",tt=`
            ...
            `,"",E),L=PopsElementHandler.parseElement(I),{popsElement:_}=PopsHandler.handleQueryElement(L,T),P=null,$=[L];A.mask.enable&&(P=PopsHandler.handleMask({type:T,guid:C,config:A,animElement:L,maskHTML:k}).maskElement,$.push(P));let B=PopsHandler.handleLoadingEventDetails(C,T,L,_,P,A);return popsDOMUtils.append(A.parent,$),P!=null&&L.after(P),PopsHandler.handlePush(T,{guid:C,animElement:L,popsElement:_,maskElement:P}),PopsHandler.handleResultDetails(B)}}const PopsIframeConfig=()=>({title:{position:"center",text:"",html:!1,style:""},loading:{enable:!0,icon:!0,text:""},useShadowRoot:!0,class:"",url:window.location.href,only:!1,zIndex:1e4,mask:{enable:!1,clickEvent:{toClose:!1,toHide:!1},clickCallBack:null},animation:"pops-anim-fadein-zoom",position:"center",drag:!0,dragLimit:!0,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},width:"300px",height:"250px",topRightButton:"min|max|mise|close",sandbox:!1,forbiddenScroll:!1,loadEndCallBack(){},btn:{min:{callback(){}},max:{callback(){}},mise:{callback(){}},close:{callback(){}}},style:null,beforeAppendToPageCallBack(){}});class PopsIframe{constructor(w){var At;const A=popsUtils.getRandomGUID(),C="iframe";let T=PopsIframeConfig();if(T=popsUtils.assign(T,GlobalConfig.getGlobalConfig()),T=popsUtils.assign(T,w),T.url==null)throw "config.url不能为空";T=PopsHandler.handleOnly(C,T);const{$shadowContainer:E,$shadowRoot:k}=PopsHandler.handlerShadow(T);PopsHandler.handleInit(k,[pops.config.cssText.index,pops.config.cssText.ninePalaceGridPosition,pops.config.cssText.scrollbar,pops.config.cssText.anim,pops.config.cssText.common,pops.config.cssText.iframeCSS]);let U=T.animation!=null&&T.animation!=""?"position:absolute;":"",I=PopsHandler.handleZIndex(T.zIndex),L=PopsElementHandler.getMaskHTML(A,I,U),_=PopsElementHandler.getHeaderBtnHTML(C,T),P='<div class="pops-loading"></div>',$=T.title.text.trim()!==""?T.title.text:T.url,{headerStyle:B,headerPStyle:V}=PopsElementHandler.getHeaderStyle(C,T),D=PopsElementHandler.getAnimHTML(A,C,T,`
            <div 
                class="pops-iframe-title"
                style="text-align: ${T.title.position};${B}"
            >
                ${T.title.html?$:`<p pops style="${V}">${$}</p>`}
                ${_}
            </div>
            ...
            ${V}
            `,V,P),F=PopsElementHandler.parseElement(R),{popsElement:W,titleElement:X,contentElement:K,folderListBodyElement:G,folderFileListBreadcrumbPrimaryElement:tt,headerCloseBtnElement:et,btnOkElement:nt,btnCancelElement:bt,btnOtherElement:Y,folderListSortFileNameElement:z,folderListSortLatestTimeElement:q,folderListSortFileSizeElement:J}=PopsHandler.handleQueryElement(F,C),Q=null,rt=[F];T.mask.enable&&(Q=PopsHandler.handleMask({type:C,guid:A,config:T,animElement:F,maskHTML:$}).maskElement,rt.push(Q));let ct=PopsHandler.handleEventDetails(A,E,k,C,F,W,Q,T);PopsHandler.handleClickEvent("close",et,ct,T.btn.close.callback),PopsHandler.handleClickEvent("ok",nt,ct,T.btn.ok.callback),PopsHandler.handleClickEvent("cancel",bt,ct,T.btn.cancel.callback),PopsHandler.handleClickEvent("other",Y,ct,T.btn.other.callback),popsDOMUtils.append(k,rt),typeof T.beforeAppendToPageCallBack=="function"&&T.beforeAppendToPageCallBack(k,E),popsDOMUtils.appendBody(E),Q!=null&&F.after(Q),T.folder.sort();function yt(ot,at="-",it="-",mt=!1){let st=ot,dt=at,Ct=it,wt=popsDOMUtils.createElement("tr"),Tt=popsDOMUtils.createElement("td"),xt=popsDOMUtils.createElement("td"),It=popsDOMUtils.createElement("td"),Nt="",$t=Folder_ICON.folder;if(mt)at="",it="";else {$t="",typeof at=="number"&&(at=popsUtils.formatTime(at)),typeof it=="number"&&(it=popsUtils.formatByteToSize(it));for(let ee in Folder_ICON)if(ot.toLowerCase().endsWith("."+ee)){Nt=ee,$t=Folder_ICON[ee];break}$t||(Nt="Null",$t=Folder_ICON.Null);}wt.className="pops-folder-list-table__body-row",Tt.className="pops-folder-list-table__body-td",xt.className="pops-folder-list-table__body-td",It.className="pops-folder-list-table__body-td",Tt.innerHTML=`
            ...
            `;let Yt={fileName:st,latestTime:dt,fileSize:Ct,isFolder:mt};return Tt.__value__=Yt,xt.__value__=Yt,It.__value__=Yt,wt.__value__=Yt,wt.appendChild(Tt),wt.appendChild(xt),wt.appendChild(It),{folderELement:wt,fileNameElement:Tt,fileTimeElement:xt,fileFormatSize:It}}function kt(ot,at="-",it="-",mt=!1){let st=ot,dt=at,Ct=it,wt=popsDOMUtils.createElement("tr"),Tt=popsDOMUtils.createElement("td"),xt="",It=Folder_ICON.folder;if(mt)at="",it="";else {It="",typeof at=="number"&&(at=popsUtils.formatTime(at)),typeof it=="number"&&(it=popsUtils.formatByteToSize(it));for(let $t in Folder_ICON)if(ot.toLowerCase().endsWith("."+$t)){xt=$t,It=Folder_ICON[$t];break}It||(xt="Null",It=Folder_ICON.Null);}wt.className="pops-folder-list-table__body-row",Tt.className="pops-folder-list-table__body-td",Tt.innerHTML=`
            <div class="pops-folder-list-file-name pops-mobile-folder-list-file-name cursor-p">
                <img src="${It}" alt="${xt}" class="pops-folder-list-file-icon u-file-icon u-file-icon--list">
                <div>
                    <a title="${ot}" class="pops-folder-list-file-name-title-text inline-block-v-middle text-ellip list-name-text">
                        ${ot}
                    </a>
			...
			`;const C={[Symbol.toStringTag]:"PopsPanelSelectMultiple",$el:{$container:void 0,$wrapper:void 0,$section:void 0,$selectedInputWrapper:void 0,$selectedPlaceHolderWrapper:void 0,$suffix:void 0,$suffixIcon:void 0},$data:{defaultValue:S.getValue(),selectInfo:[]},init(){this.initDefault(),this.inintEl(),this.initPlaceHolder(),this.updateTagElement(),this.setSelectContainerClickEvent();},initDefault(){S.data.forEach(T=>{this.$data.defaultValue.includes(T.value)&&this.$data.selectInfo.push({text:T.text,value:T.value,isHTML:!!T.isHTML,disable:T.disable});});},inintEl(){this.$el.$container=w.querySelector(".pops-panel-select-multiple"),this.$el.$wrapper=w.querySelector(".el-select__wrapper"),this.$el.$section=w.querySelector(".el-select__selection"),this.$el.$selectedInputWrapper=w.querySelector(".el-select__selected-item.el-select__input-wrapper"),this.$el.$selectedPlaceHolderWrapper=w.querySelector(".el-select__selected-item.el-select__placeholder"),this.$el.$suffix=w.querySelector(".el-select__suffix"),this.$el.$suffixIcon=w.querySelector(".el-select__suffix .el-icon"),this.hideInputWrapper();},initPlaceHolder(){let T="";if(typeof S.placeholder=="string")T=S.placeholder;else if(typeof S.placeholder=="function"){let k=S.placeholder();typeof k=="string"&&(T=k);}let E=popsDOMUtils.createElement("span",{innerText:T});this.$el.$selectedPlaceHolderWrapper.appendChild(E);},updateTagElement(){S.data.forEach(T=>{if(this.$data.selectInfo.find(k=>k.value===T.value)){let k=this.createSelectedItem({text:T.text,isHTML:T.isHTML});this.addSelectedItem(k.$tag),this.setSelectedItemCloseIconClickEvent({$tag:k.$tag,$closeIcon:k.$closeIcon,value:T.value,text:T.text});}}),this.checkTagEmpty();},createSelectedItem(T){const E=popsDOMUtils.createElement("div",{className:"el-select__selected-item el-select__choose_tag",innerHTML:`
						...
						`}),k=E.querySelector(".el-select__tags-text"),U=E.querySelector(".el-icon.el-tag__close");return T.isHTML?k.innerHTML=T.text:k.innerText=T.text,{$tag:E,$tagText:k,$closeIcon:U}},addSelectedItem(T){if(this.setSectionIsNear(),this.$el.$section.contains(this.$el.$selectedInputWrapper)){let E=this.$el.$selectedInputWrapper.previousElementSibling;E?popsDOMUtils.after(E,T):popsDOMUtils.before(this.$el.$selectedInputWrapper,T);}else if(this.$el.$section.contains(this.$el.$selectedPlaceHolderWrapper)){let E=this.$el.$selectedPlaceHolderWrapper.previousElementSibling;E?popsDOMUtils.after(E,T):popsDOMUtils.before(this.$el.$selectedPlaceHolderWrapper,T);}else this.$el.$section.appendChild(T);this.hideInputWrapper(),this.hidePlaceHolderWrapper();},updateSelectTagItem(){this.$el.$section.querySelectorAll(".el-select__choose_tag").forEach(T=>{T.remove();}),this.updateTagElement();},selectValueChangeCallBack(T){typeof S.callback=="function"&&S.callback(T||this.$data.selectInfo);},setSelectContainerClickEvent(){const T=this;popsDOMUtils.on(this.$el.$container,"click",E=>{let k=[];k=k.concat(T.$data.selectInfo);function U(K){K.classList.add("select-item-is-selected");}function I(K){K.classList.remove("select-item-is-selected");}function L(K){let G=$(K);k.find(et=>et.value===G.value)||k.push({value:G.value,text:G.text,isHTML:!!G.isHTML,disable:G.disable}),T.selectValueChangeCallBack(k);}function _(K){let G=$(K),tt=k.findIndex(et=>et.value===G.value);tt!==-1&&k.splice(tt,1),T.selectValueChangeCallBack(k);}function P(K){return K.classList.contains("select-item-is-selected")}function $(K){return Reflect.get(K,"data-info")}function B(){return Array.from(X.querySelectorAll(".select-item")).map(K=>{if(P(K))return $(K)}).filter(K=>K!=null)}function V(K){let G=popsDOMUtils.createElement("li",{className:"select-item",innerHTML:`
									<span>${K.text}</span>
								`});return Reflect.set(G,"data-info",K),G}function D(K){popsDOMUtils.on(K,"click",G=>{if(popsDOMUtils.preventEvent(G),typeof S.clickCallBack=="function"){let tt=S.clickCallBack(G,B());if(typeof tt=="boolean"&&!tt)return}P(K)?(I(K),_(K)):(U(K),L(K));});}let{style:N,...R}=S.selectConfirmDialogDetails||{},F=popsUtils.assign({title:{text:"请勾选需要选择的选项",position:"center"},content:{text:`
									<ul class="select-container"></ul>
									`,html:!0},btn:{ok:{enable:!1},close:{enable:!0,callback(K,G){T.$data.selectInfo=[...k],T.updateSelectTagItem(),K.close();}}},mask:{enable:!0,clickCallBack(K,G){K(),T.$data.selectInfo=[...k],T.updateSelectTagItem();},clickEvent:{toClose:!0}},drag:!0,dragLimit:!0,width:"300px",height:"300px",style:`
								.select-container{
			...
			</div>`,"",U),B=PopsElementHandler.parseElement($),{popsElement:V,headerCloseBtnElement:D,titleElement:N,contentElement:R,contentAsideElement:F,contentSectionContainerElement:W}=PopsHandler.handleQueryElement(B,C);(T.isMobile||pops.isPhone())&&popsDOMUtils.addClassName(V,T.mobileClassName);let X=null,K=[B];if(T.mask.enable){let{maskElement:et}=PopsHandler.handleMask({type:C,guid:A,config:T,animElement:B,maskHTML:I});X=et,K.push(X);}let G=PopsHandler.handleEventDetails(A,E,k,C,B,V,X,T);return PopsHandler.handleClickEvent("close",D,G,T.btn.close.callback),popsDOMUtils.append(k,K),typeof T.beforeAppendToPageCallBack=="function"&&T.beforeAppendToPageCallBack(k,E),popsDOMUtils.appendBody(E),X!=null&&B.after(X),PanelHandleContentDetails().init({config:T,$el:{$content:R,$contentAside:F,$contentSectionContainer:W}}),PopsHandler.handlePush(C,{guid:A,animElement:B,popsElement:V,maskElement:X,$shadowContainer:E,$shadowRoot:k}),T.drag&&PopsInstanceUtils.drag(V,{dragElement:N,limit:T.dragLimit,extraDistance:T.dragExtraDistance,moveCallBack:T.dragMoveCallBack,endCallBack:T.dragEndCallBack}),PopsHandler.handleResultDetails(G)}};const rightClickMenuConfig=()=>({target:document.documentElement,targetSelector:null,data:[{icon:pops.config.iconSVG.search,iconIsLoading:!1,text:"搜索",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:pops.config.iconSVG.documentCopy,iconIsLoading:!1,text:"复制",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:pops.config.iconSVG.delete,text:"删除",iconIsLoading:!1,item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:pops.config.iconSVG.loading,iconIsLoading:!0,text:"加载",item:[],callback(S,w,A){return console.log("点击："+this.text,[S,w,A]),!1}},{icon:pops.config.iconSVG.elemePlus,iconIsLoading:!0,text:"饿了么",callback(S,w,A){return console.log("点击："+this.text,[S,w,A]),!1},item:[{icon:"",iconIsLoading:!1,text:"处理文件",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}},{icon:"",iconIsLoading:!1,text:"其它处理",callback(S,w,A){console.log("点击："+this.text,[S,w,A]);},item:[{icon:pops.config.iconSVG.view,iconIsLoading:!1,text:"查看",item:[],callback(S,w,A){console.log("点击："+this.text,[S,w,A]);}}]}]}],useShadowRoot:!0,className:"",isAnimation:!0,only:!1,zIndex:1e4,preventDefault:!0,style:null,beforeAppendToPageCallBack(){}});class PopsRightClickMenu{constructor(w){const A=popsUtils.getRandomGUID(),C="rightClickMenu";let T=rightClickMenuConfig();if(T=popsUtils.assign(T,GlobalConfig.getGlobalConfig()),T=popsUtils.assign(T,w),T=PopsHandler.handleOnly(C,T),T.target==null)throw "config.target 不能为空";w.data&&(T.data=w.data);const{$shadowContainer:E,$shadowRoot:k}=PopsHandler.handlerShadow(T);if(PopsHandler.handleInit(k,[pops.config.cssText.index,pops.config.cssText.anim,pops.config.cssText.common,pops.config.cssText.rightClickMenu]),T.style!=null){let I=document.createElement("style");I.setAttribute("type","text/css"),I.innerHTML=T.style,k.appendChild(I);}const U={rootElement:null,windowCheckClickEvent(I){if(!U.rootElement)return;let L=I.target;L.closest(`.pops-${C}`)||L.className&&L.className==="pops-shadow-container"&&L.shadowRoot!=null||U.closeAllMenu(U.rootElement);},shadowRootCheckClickEvent(I){!U.rootElement||I.target.closest(`.pops-${C}`)||U.closeAllMenu(U.rootElement);},addWindowCheckClickListener(){if(popsDOMUtils.on(globalThis,"click touchstart",void 0,U.windowCheckClickEvent,{capture:!0}),T.target instanceof Node){const I=T.target.getRootNode();I instanceof ShadowRoot&&popsDOMUtils.on(I,"click touchstart",void 0,U.shadowRootCheckClickEvent,{capture:!0});}},removeWindowCheckClickListener(){if(popsDOMUtils.off(globalThis,"click touchstart",void 0,U.windowCheckClickEvent,{capture:!0}),T.target instanceof Node){const I=T.target.getRootNode();I instanceof ShadowRoot&&popsDOMUtils.off(I,"click touchstart",void 0,U.windowCheckClickEvent,{capture:!0});}},contextMenuEvent(I){T.preventDefault&&popsDOMUtils.preventEvent(I),PopsHandler.handleOnly(C,T),U.rootElement&&U.closeAllMenu(U.rootElement);let L=U.showMenu(I,T.data);U.rootElement=L,T.only&&PopsHandler.handlePush(C,{$shadowRoot:k,$shadowContainer:E,guid:A,animElement:L,popsElement:L,beforeRemoveCallBack(_){U.closeAllMenu(_.popsElement);}});},addContextMenuEvent(I,L){popsDOMUtils.on(I,"contextmenu",L,U.contextMenuEvent);},removeContextMenuEvent(I,L){popsDOMUtils.off(I,"contextmenu",L,U.contextMenuEvent);},animationCloseMenu(I){function L(_){popsDOMUtils.off(I,popsDOMUtils.getTransitionEndNameList(),void 0,L,{capture:!0}),I.remove();}I.classList.contains(`pops-${C}-anim-show`)?(popsDOMUtils.on(I,popsDOMUtils.getTransitionEndNameList(),void 0,L,{capture:!0}),I.classList.remove(`pops-${C}-anim-show`)):I.remove();},closeAllMenu(I){var _,P;if(I==null)return;(_=I==null?void 0:I.__menuData__)!=null&&_.root&&(I=(P=I==null?void 0:I.__menuData__)==null?void 0:P.root),I.__menuData__.child.forEach($=>{this.animationCloseMenu($);}),this.animationCloseMenu(I),U.rootElement=null;},getMenuContainerElement(I){let L=popsDOMUtils.createElement("div",{className:`pops-${C}`,innerHTML:`
					<ul></ul>
					`}),_=this.getMenuZIndex();return _>1e4&&(L.style.zIndex=_.toString()),I&&L.setAttribute("is-children","true"),T.isAnimation&&popsDOMUtils.addClassName(L,`pops-${C}-anim-grid`),L},getMenuZIndex(){return PopsHandler.handleZIndex(T.zIndex)},getOffset(I,L,_){let P=popsDOMUtils.width(I),$=popsDOMUtils.height(I),B=popsDOMUtils.width(globalThis)-P-1,V=popsDOMUtils.height(globalThis)-$-8,D=L,N=_;return D=D<0?0:D,D=D<B?D:B,N=N<0?0:N,N=N<V?N:V,{left:D,top:N}},showMenu(I,L){let _=this.getMenuContainerElement(!1);Reflect.set(_,"__menuData__",{child:[]}),U.addMenuLiELement(I,_,_,L),popsDOMUtils.css(_,{display:"none"}),popsDOMUtils.append(k,_),document.contains(E)||(typeof T.beforeAppendToPageCallBack=="function"&&T.beforeAppendToPageCallBack(k,E),popsDOMUtils.appendBody(E));let{left:P,top:$}=this.getOffset(_,I.clientX,I.clientY);return popsDOMUtils.css(_,{left:P,top:$,display:""}),T.isAnimation&&popsDOMUtils.addClassName(_,`pops-${C}-anim-show`),_},showClildMenu(I,L,_,P,$){let B=this.getMenuContainerElement(!0);Reflect.set(B,"__menuData__",{parent:$,root:P}),Reflect.get(P,"__menuData__").child.push(B),U.addMenuLiELement(I,P,B,_),popsDOMUtils.css(B,{display:"none"}),popsDOMUtils.append(k,B);let{left:D,top:N}=this.getOffset(B,L.clientX,L.clientY);return popsDOMUtils.css(B,{left:D,top:N,display:""}),T.isAnimation&&popsDOMUtils.addClassName(B,`pops-${C}-anim-show`),B},addMenuLiELement(I,L,_,P){let $=I.target,B=_.querySelector("ul");P.forEach(V=>{let D=popsUtils.parseTextToDOM("<li></li>");if(typeof V.icon=="string"&&V.icon.trim()!==""){let F=pops.config.iconSVG[V.icon]??V.icon,W=popsUtils.parseTextToDOM(`<i class="pops-${C}-icon" is-loading="${V.iconIsLoading}">${F}</i>`);D.appendChild(W);}D.insertAdjacentHTML("beforeend",`<span>${V.text}</span>`),V.item&&Array.isArray(V.item)&&popsDOMUtils.addClassName(D,`pops-${C}-item`);function N(){Array.from(B.children).forEach(X=>{if(popsDOMUtils.removeClassName(X,`pops-${C}-is-visited`),!X.__menuData__)return;function K(G){G.querySelectorAll("ul li").forEach(tt=>{var et;(et=tt==null?void 0:tt.__menuData__)!=null&&et.child&&K(tt.__menuData__.child);}),G.remove();}K(X.__menuData__.child);});for(let X=0;X<L.__menuData__.child.length;X++){let K=L.__menuData__.child[X];k.contains(K)||(L.__menuData__.child.splice(X,1),X--);}if(popsDOMUtils.addClassName(D,`pops-${C}-is-visited`),!V.item)return;let F=D.getBoundingClientRect(),W=U.showClildMenu(I,{clientX:F.left+popsDOMUtils.outerWidth(D),clientY:F.top},V.item,L,D);D.__menuData__={child:W};}async function R(F){if(typeof V.callback=="function"){OriginPrototype.Object.defineProperty(I,"target",{get(){return $}});let W=await V.callback(F,I,D);if(typeof W=="boolean"&&W==!1)return}Array.from(B.children).forEach(W=>{popsDOMUtils.off(W,"mouseenter touchstart");}),U.closeAllMenu(L);}popsDOMUtils.on(D,"mouseenter touchstart",void 0,N),popsDOMUtils.on(D,"click",void 0,R),B.appendChild(D);});}};return U.addContextMenuEvent(T.target,T.targetSelector),U.addWindowCheckClickListener(),{guid:A,config:T,removeWindowCheckClickListener:U.removeWindowCheckClickListener,addWindowCheckClickListener:U.addWindowCheckClickListener,removeContextMenuEvent:U.removeContextMenuEvent,addContextMenuEvent:U.addContextMenuEvent}}}const searchSuggestionConfig=()=>({target:null,inputTarget:null,selfDocument:document,data:[{value:"数据1",text:"数据1-html"},{value:"数据2",text:"数据2-html"}],deleteIcon:{enable:!0,callback(S,w,A){console.log("删除当前项",[S,w,A]),w.remove();}},useShadowRoot:!0,className:"",isAbsolute:!0,isAnimation:!0,width:"250px",maxHeight:"300px",followTargetWidth:!0,topDistance:0,position:"auto",positionTopToReverse:!0,zIndex:1e4,searchingTip:"正在搜索中...",toSearhNotResultHTML:'<li data-none="true">暂无其它数据</li>',toHideWithNotResult:!1,followPosition:"target",getItemHTML(S){return S.text??S},async getData(S){return console.log("当前输入框的值是：",S),[]},itemClickCallBack(S,w,A){console.log("item项的点击回调",[S,w,A]),this.inputTarget.value=A.value;},selectCallBack(S,w,A){console.log("item项的选中回调",[S,w,A]);},style:""});class PopsSearchSuggestion{constructor(w){const A=popsUtils.getRandomGUID(),C="searchSuggestion";let T=searchSuggestionConfig();if(T=popsUtils.assign(T,GlobalConfig.getGlobalConfig()),T=popsUtils.assign(T,w),T.target==null)throw new TypeError("config.target 不能为空");T.inputTarget==null&&(T.inputTarget=T.target),w.data&&(T.data=w.data);const{$shadowContainer:E,$shadowRoot:k}=PopsHandler.handlerShadow(T);if(PopsHandler.handleInit(k,[pops.config.cssText.index,pops.config.cssText.anim,pops.config.cssText.common]),T.style!=null){let I=document.createElement("style");I.setAttribute("type","text/css"),I.innerHTML=T.style,k.appendChild(I);}const U={selfDocument:T.selfDocument,$el:{root:null,$hintULContainer:null,$dynamicCSS:null},$data:{isEmpty:!0},init(I=document.body||document.documentElement){this.initEl(),U.update(typeof T.data=="function"?T.data():T.data),U.updateDynamicCSS(),U.changeHintULElementWidth(),U.changeHintULElementPosition(),U.hide(),T.isAnimation&&U.$el.root.classList.add(`pops-${C}-animation`),k.appendChild(U.$el.root),I.appendChild(E);},initEl(){this.$el.root=U.getSearchSelectElement(),this.$el.$dynamicCSS=this.$el.root.querySelector("style[data-dynamic]"),this.$el.$hintULContainer=U.$el.root.querySelector("ul");},getSearchSelectElement(){let I=popsDOMUtils.createElement("div",{className:`pops pops-${C}-search-suggestion`,innerHTML:`
						...
						<ul class="pops-${C}-search-suggestion-hint">
         				 ...
         				 `},{"data-guid":A,"type-value":C});return T.className!==""&&T.className!=null&&popsDOMUtils.addClassName(I,T.className),I},getDynamicCSS(){return `
				.pops-${C}-animation{
...
`)}{display: none !important;}`)},setGMResourceCSS(S){let w=typeof _GM_getResourceText=="function"?_GM_getResourceText(S.keyName):"";typeof w=="string"&&w?addStyle(w):CommonUtil.addLinkNode(S.url);},async addLinkNode(S){let w=document.createElement("link");return w.rel="stylesheet",w.type="text/css",w.href=S,domUtils.ready(()=>{document.head.appendChild(w);}),w},fixUrl(S){return S=S.trim(),S.match(/^http(s|):\/\//i)||(S.startsWith("/")||(S+="/"),S=window.location.origin+S),S},escapeHtml(S){return S.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")}},GlobalUtil={getWindow(){return GMTotal.unsafeWindow.isSupport()?_unsafeWindow:window}};class ApiTest_addElement extends ApiTestBase{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof _GM.addElement=="function"}}isSupport(){return typeof _GM_addElement=="function"}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{let T=null,E=null;try{let k=GlobalUtil.getWindow(),U="GM_addElement_test_script_exec";return T=_GM_addElement("script",{id:U,textContent:'window.GM_addElement_test_str = "bar";'}),E=document.querySelector("#"+U),T==null?{text:"GM_addElement is not retrun element",tag:"error"}:typeof k.GM_addElement_test_str!="string"?{text:"GM_addElement script element is not work",tag:"error"}:(Reflect.deleteProperty(k,"GM_addElement_test_str"),{text:CommonUtil.escapeHtml("支持添加<script>元素且执行js"),tag:"success"})}catch(k){return console.error(k),{text:"执行错误 "+k,tag:"error"}}finally{E==null||E.remove();}}),UIInfo(()=>{let T=null,E=null;try{let k="GM_addElement_test2";if(T=_GM_addElement(document.body,"div",{"data-src":"https://example.com/image.png",id:k}),E=document.querySelector("#"+k),!E)return {text:"不支持3个参数",tag:"error"};const U=E.attachShadow({mode:"closed"});return _GM_addElement(U,"style",{textContent:"div { color: black; };"}),U.querySelector("style")?T==null?{text:"传入3个参数但是返回为空",tag:"error"}:E.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(k){return console.error(k),{text:"执行错误 "+k,tag:"error"}}finally{E==null||E.remove();}})),C}}class ApiTest_addStyle extends ApiTestBase{isSupport(){return typeof _GM_addStyle=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof _GM.addStyle=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-GM_addStyle"+w,title:w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{let T=null,E=null;try{return T=domUtils.createElement("div",{id:w,innerText:w+" test"}),document.body.appendChild(T),E=_GM_addStyle(`
                        ...
                        `),E==null?{text:w+" returns is null",tag:"error"}:window.getComputedStyle(T).backgroundColor!=="rgb(255, 0, 0)"?{text:w+" test element background is not rgb(255, 0, 0)",tag:"error"}:{text:CommonUtil.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}}catch(k){return console.error(k),{text:"执行错误 "+k,tag:"error"}}finally{T==null||T.remove(),E==null||E.remove();}})),C}}class ApiTest_addValueChangeListener extends ApiTestBase{isSupport(){return typeof _GM_addValueChangeListener=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof _GM.addValueChangeListener=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_cookie extends ApiTestBase{isSupport(){return (typeof _GM_cookie=="object"||typeof _GM_cookie=="function")&&_GM_cookie!=null}getApiOption(){let w=this.isSupport();return {isSupportList:w&&typeof _GM_cookie.list=="function",isSupportSet:w&&typeof _GM_cookie.set=="function",isSupportDelete:w&&typeof _GM_cookie.delete=="function"}}getApiName(){return "GM_cookie"}getAsyncApiOption(){let w=this.isSupportGM()&&typeof _GM.cookie=="object"&&_GM.cookie!=null;return {name:"GM.cookie",isSupport:w,isSupportList:w&&typeof _GM.cookie.list=="function",isSupportSet:w&&typeof _GM.cookie.set=="function",isSupportDelete:w&&typeof _GM.cookie.delete=="function"}}getUIOption(){let w=this.getApiName(),A=this.getApiOption(),C=this.getAsyncApiOption(),T={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${C.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(k){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]},E=T.forms[0].forms;return this.isSupport()&&E.push(UIInfo(()=>A.isSupportList?{text:`支持 ${w}.list`,tag:"success"}:{text:`不支持 ${w}.list`,tag:"error"}),UIInfo(()=>A.isSupportSet?{text:`支持 ${w}.set`,tag:"success"}:{text:`不支持 ${w}.set`,tag:"error"}),UIInfo(()=>A.isSupportDelete?{text:`支持 ${w}.delete`,tag:"success"}:{text:`不支持 ${w}.delete`,tag:"error"})),C.isSupport?E.push(UIInfo(()=>C.isSupportList?{text:`支持 ${C.name}.list`,tag:"success"}:{text:`不支持 ${C.name}.list`,tag:"error"}),UIInfo(()=>C.isSupportSet?{text:`支持 ${C.name}.set`,tag:"success"}:{text:`不支持 ${C.name}.set`,tag:"error"}),UIInfo(()=>C.isSupportDelete?{text:`支持 ${C.name}.delete`,tag:"success"}:{text:`不支持 ${C.name}.delete`,tag:"error"})):E.push(UIInfo(()=>({text:"不支持 "+C.name,tag:"error"}))),this.isSupport()&&T.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(k){return console.error(k),{text:"执行错误 "+k,tag:"error"}}finally{}})),T}}class ApiTest_deleteValue extends ApiTestBase{isSupport(){return typeof _GM_deleteValue=="function"}getApiName(){return "GM_deleteValue"}getAsyncApiOption(){return {name:"GM.deleteValue",isSupport:this.isSupportGM()&&typeof _GM.deleteValue=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.name?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_deleteValues extends ApiTestBase{isSupport(){return typeof _GM_deleteValues=="function"}getApiName(){return "GM_deleteValues"}getAsyncApiOption(){return {name:"GM.deleteValues",isSupport:this.isSupportGM()&&typeof _GM.deleteValues=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_download extends ApiTestBase{isSupport(){return typeof _GM_download=="function"}getApiName(){return "GM_download"}getAsyncApiOption(){return {name:"GM.download",isSupport:this.isSupportGM()&&typeof _GM.download=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>({text:CommonUtil.escapeHtml("TODO"),tag:"info",afterRender(T){var E;(E=T.target)==null||E.querySelector(".support-info");}}))),C}}class ApiTest_getResourceText extends ApiTestBase{isSupport(){return typeof _GM_getResourceText=="function"}getApiName(){return "GM_getResourceText"}getAsyncApiOption(){return {name:"GM.getResourceText",isSupport:this.isSupportGM()&&typeof _GM.getResourceText=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return typeof _GM_getResourceText("ViewerCSS")=="string"?{text:CommonUtil.escapeHtml("支持通过@resource引用资源字符串"),tag:"success"}:{text:CommonUtil.escapeHtml("GM_getResourceText return is not string"),tag:"error"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_getResourceUrl extends ApiTestBase{isSupport(){return typeof _GM_getResourceURL=="function"}getApiName(){return "GM_getResourceURL"}getAsyncApiOption(){return {name:"GM.getResourceUrl",isSupport:this.isSupportGM()&&typeof _GM.getResourceUrl=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{let T=_GM_getResourceURL("ViewerCSS");return typeof T=="string"?T.trim().startsWith("data:text/css;base64")?{text:CommonUtil.escapeHtml("支持通过@resource引用资源并进行base64编码"),tag:"success"}:{text:CommonUtil.escapeHtml("支持通过@resource引用资源，但是未对资源进行base64编码"),tag:"warn"}:{text:CommonUtil.escapeHtml("GM_getResourceURL return is not string"),tag:"error"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_getTab extends ApiTestBase{isSupport(){return typeof _GM_getTab=="function"}getApiName(){return "GM_getTab"}getAsyncApiOption(){return {name:"GM.getTab",isSupport:this.isSupportGM()&&typeof _GM.getTab=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_getTabs extends ApiTestBase{isSupport(){return typeof _GM_getTabs=="function"}getApiName(){return "GM_getTabs"}getAsyncApiOption(){return {name:"GM.getTabs",isSupport:this.isSupportGM()&&typeof _GM.getTabs=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_getValue extends ApiTestBase{isSupport(){return typeof _GM_getValue=="function"}getApiName(){return "GM_getValue"}getAsyncApiOption(){return {name:"GM.getValue",isSupport:this.isSupportGM()&&typeof _GM.getValue=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_getValues extends ApiTestBase{isSupport(){return typeof _GM_getValues=="function"}getApiName(){return "GM_getValues"}getAsyncApiOption(){return {name:"GM.getValues",isSupport:this.isSupportGM()&&typeof _GM.getValues=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_info extends ApiTestBase{isSupport(){return typeof _GM_info=="object"&&_GM_info!=null}getApiName(){return "GM_info"}getAsyncApiOption(){return {name:"GM.info",isSupport:this.isSupportGM()&&typeof _GM.info=="object"}}getUIOption(){var T,E;let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(k){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(...[{value:_GM_info==null?void 0:_GM_info.scriptHandler,type:"string",text:"GM_info.scriptHandler"},{value:_GM_info==null?void 0:_GM_info.scriptMetaStr,type:"string",text:"GM_info.scriptMetaStr"},{value:_GM_info==null?void 0:_GM_info.version,type:"string",text:"GM_info.version"},{value:_GM_info==null?void 0:_GM_info.script,type:"object",text:"GM_info.script"},{value:(T=_GM_info==null?void 0:_GM_info.script)==null?void 0:T.name,type:"string",text:"GM_info.script.name"},{value:(E=_GM_info==null?void 0:_GM_info.script)==null?void 0:E.version,type:"string",text:"GM_info.script.version"}].map(k=>UIInfo(()=>{try{return k.value!=null&&typeof k.value===k.type?{text:"支持 "+k.text+" 类型："+k.type,tag:"success"}:{text:"不支持 "+k.text+" 类型："+k.type,tag:"error"}}catch(U){return console.error(U),{text:"执行错误 "+U,tag:"error"}}finally{}}))),C}}class ApiTest_listValues extends ApiTestBase{isSupport(){return typeof _GM_listValues=="function"}getApiName(){return "GM_listValues"}getAsyncApiOption(){return {name:"GM.listValues",isSupport:this.isSupportGM()&&typeof _GM.listValues=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_log extends ApiTestBase{isSupport(){return typeof _GM_log=="function"}getApiName(){return "GM_log"}getAsyncApiOption(){return {name:"GM.log",isSupport:this.isSupportGM()&&typeof _GM.log=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{let T="test GM_log";return {text:CommonUtil.escapeHtml("请在控制台查看输出"),tag:"info",description:"test GM_log",afterRender(E){let k=domUtils.parseHTML(`
								...
								`,!1,!1);domUtils.on(k,"click",U=>{utils.preventEvent(U),_GM_log(T);}),domUtils.after(E.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_notification extends ApiTestBase{isSupport(){return typeof _GM_notification=="function"}getApiName(){return "GM_notification"}getAsyncApiOption(){return {name:"GM.notification",isSupport:this.isSupportGM()&&typeof _GM.notification=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{let T,E,k=!1,U=!1,I=!1;return {text:"点击通知的内容用于测试函数是否生效",description:"",tag:"info",afterRender(L){T=L.target,E=L.$leftContainer;let _=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
								...
								`,!1,!1),P,$,B=utils.debounce(()=>{clearTimeout(P),clearInterval($);let V="",D="success",N="",R="success";k?(V+="支持 onclick 函数",U?(V=V.trim(),V+="且支持提供 event 参数"):(V+="但是不支持提供 event 参数",D="warn")):(V+="不支持 onclick 函数",D="error"),I?N+="支持 ondone 函数":(N+="不支持 ondone 函数",R="error"),domUtils.html(L.$leftText,`
										<p class="${D}">${V}</p>
										<p class="${R}">${N}</p>
									`),k=!1,I=!1,U=!1;},800);domUtils.on(_,"click",V=>{utils.preventEvent(V),clearTimeout(P),clearInterval($);let D=10,N=D,R=()=>{let F=`正在等待触发回调，请在规定时间内点击弹窗的【关闭】按钮或者内容：${N}s`;return N--,F};domUtils.text(L.$leftText,R()),domUtils.text(L.$leftDesc,this.text),domUtils.show(L.$leftDesc,!1),P=setTimeout(()=>{clearInterval($),TagUtil.setTag(L.$leftText,"error","测试超时，未触发回调");},D*1e3),$=setInterval(()=>{domUtils.text(L.$leftText,R());},1e3),_GM_notification({title:"测试 GM_notification 标题",text:"测试 GM_notification 内容",url:"https:/example.com/",onclick:F=>{k=!0,F&&(U=!0,F.preventDefault()),B();},ondone(){I=!0,B();}});}),domUtils.after(E,_);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}}),UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("点击通知的内容跳转链接"),tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);domUtils.on(k,"click",U=>{utils.preventEvent(U),_GM_notification({title:"测试 GM_notification 标题",text:"测试 GM_notification 内容",url:"https:/example.com/"});}),domUtils.after(T.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}})),C}}class ApiTest_openInTab extends ApiTestBase{isSupport(){return typeof _GM_openInTab=="function"}getApiName(){return "GM_openInTab"}getAsyncApiOption(){return {name:"GM.openInTab",isSupport:this.isSupportGM()&&typeof _GM.openInTab=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:"后台打开：https://www.example.com/",tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									...
									`,!1,!1),U,I=()=>{clearTimeout(U),TagUtil.setTag(T.$leftText,"success","测试新标签页打开成功");};domUtils.on(k,"click",L=>{utils.preventEvent(L),domUtils.off(_unsafeWindow,"blur",I,{capture:!0}),clearTimeout(U),TagUtil.setTag(T.$leftText,"info","等待页面失去焦点..."),domUtils.text(T.$leftDesc,this.text),domUtils.show(T.$leftDesc,!1),domUtils.on(_unsafeWindow,"blur",I,{capture:!0,once:!0}),_GM_openInTab("https://www.example.com/",{active:!0}),U=setTimeout(()=>{domUtils.off(_unsafeWindow,"blur",I,{capture:!0}),TagUtil.setTag(T.$leftText,"error","测试超时，未打开新标签页并获取焦点");},3e3);}),domUtils.after(T.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}}),UIInfo(()=>{try{return {text:"测试调用返回值 .close()",tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),U;domUtils.on(k,"click",I=>{utils.preventEvent(I),clearTimeout(U),TagUtil.setTag(T.$leftText,"info","等待调用 .close()"),domUtils.text(T.$leftDesc,this.text),domUtils.show(T.$leftDesc,!1);let L=_GM_openInTab("https://www.example.com/");L&&typeof(L==null?void 0:L.close)=="function"?U=setTimeout(()=>{try{L.close(),TagUtil.setTag(T.$leftText,"success","成功调用 .close()");}catch(_){TagUtil.setTag(T.$leftText,"error","调用 .close() 方法失败 "+_);}},1e3):TagUtil.setTag(T.$leftText,"error","返回对象中不支持 .close() 方法");}),domUtils.after(T.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}}),UIInfo(()=>{try{return {text:"测试监听关闭是否生效 .onclose",tag:"info",afterRender(T){let E=T.target,k=domUtils.parseHTML(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),U,I;domUtils.on(k,"click",L=>{utils.preventEvent(L),clearTimeout(I),clearTimeout(U),TagUtil.setTag(T.$leftText,"info","等待触发监听 .onclose"),domUtils.text(T.$leftDesc,this.text),domUtils.show(T.$leftDesc,!1);let _=_GM_openInTab("https://www.example.com/");typeof _=="object"&&_!=null&&(_.onclose=()=>{clearTimeout(U),clearTimeout(I),TagUtil.setTag(T.$leftText,"success","成功触发 .onclose");}),_&&typeof(_==null?void 0:_.close)=="function"?U=setTimeout(()=>{try{_.close(),I=setTimeout(()=>{TagUtil.setTag(T.$leftText,"error","测试超时，未触发回调 .onclose");},2e3);}catch(P){TagUtil.setTag(T.$leftText,"error","调用 .close() 方法失败 "+P);}},1e3):TagUtil.setTag(T.$leftText,"error","返回对象中不支持 .close() 方法");}),domUtils.after(T.$leftContainer,k);}}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}})),C}}class ApiTest_registerMenuCommand extends ApiTestBase{isSupport(){return typeof _GM_registerMenuCommand=="function"}getApiName(){return "GM_registerMenuCommand"}getAsyncApiOption(){return {name:"GM.registerMenuCommand",isSupport:this.isSupportGM()&&typeof _GM.registerMenuCommand=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_removeValueChangeListener extends ApiTestBase{isSupport(){return typeof _GM_removeValueChangeListener=="function"}getApiName(){return "GM_removeValueChangeListener"}getAsyncApiOption(){return {name:"GM.removeValueChangeListener",isSupport:this.isSupportGM()&&typeof _GM.removeValueChangeListener=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_saveTab extends ApiTestBase{isSupport(){return typeof _GM_saveTab=="function"}getApiName(){return "GM_saveTab"}getAsyncApiOption(){return {name:"GM.saveTab",isSupport:this.isSupportGM()&&typeof _GM.saveTab=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_setClipboard extends ApiTestBase{isSupport(){return typeof _GM_setClipboard=="function"}getApiName(){return "GM_setClipboard"}getAsyncApiOption(){return {name:"GM.setClipboard",isSupport:this.isSupportGM()&&typeof _GM.setClipboard=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_setValue extends ApiTestBase{isSupport(){return typeof _GM_setValue=="function"}getApiName(){return "GM_setValue"}getAsyncApiOption(){return {name:"GM.setValue",isSupport:this.isSupportGM()&&typeof _GM.setValue=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_setValues extends ApiTestBase{isSupport(){return typeof _GM_setValues=="function"}getApiName(){return "GM_setValues"}getAsyncApiOption(){return {name:"GM.setValues",isSupport:this.isSupportGM()&&typeof _GM.setValues=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_unregisterMenuCommand extends ApiTestBase{isSupport(){return typeof _GM_unregisterMenuCommand=="function"}getApiName(){return "GM_unregisterMenuCommand"}getAsyncApiOption(){return {name:"GM.unregisterMenuCommand",isSupport:this.isSupportGM()&&typeof _GM.unregisterMenuCommand=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_unsafeWindow extends ApiTestBase{getApiName(){return "unsafeWindow"}getAsyncApiOption(){}isSupport(){return typeof _unsafeWindow=="object"&&_unsafeWindow!=null}getUIOption(){let w=this.getApiName(),A={id:"aside-"+w,title:w,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(C){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&A.forms[1].forms.push(UIInfo(()=>{let C="test-gm-window",T=_monkeyWindow==_unsafeWindow;return _monkeyWindow[C]=C,T=typeof _unsafeWindow[C]!="string",Reflect.deleteProperty(_monkeyWindow,C),T?{text:"window已被Proxy代理",tag:"success"}:{text:"window未被Proxy代理，定义全局变量时会影响到页面变量",tag:"warn"}})),A}}class ApiTest_webRequest extends ApiTestBase{isSupport(){return typeof _GM_webRequest=="function"}getApiName(){return "GM_webRequest"}getAsyncApiOption(){return {name:"GM.webRequest",isSupport:this.isSupportGM()&&typeof _GM.webRequest=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_xmlHttpRequest extends ApiTestBase{isSupport(){return typeof _GM_xmlhttpRequest=="function"}getApiName(){return "GM_xmlHttpRequest"}getAsyncApiOption(){return {name:"GM.xmlHttpRequest",isSupport:this.isSupportGM()&&typeof _GM.xmlHttpRequest=="function"}}getUIOption(){let w=this.getApiName(),A=this.getAsyncApiOption(),C={id:"aside-"+w,title:""+w,headerTitle:`${w} & ${A.name}`,scrollToDefaultView:!0,isDefault(){return StorageApi.get(PanelKeyConfig.asideLastVisit)===w},callback(T){StorageApi.set(PanelKeyConfig.asideLastVisit,w);},forms:[{type:"forms",text:"函数测试",forms:[UIInfo(()=>this.isSupport()?{text:"支持 "+w,tag:"success"}:{text:"不支持 "+w,tag:"error"}),UIInfo(()=>A.isSupport?{text:"支持 "+A.name,tag:"success"}:{text:"不支持 "+A.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&C.forms[1].forms.push(UIInfo(()=>{try{return {text:CommonUtil.escapeHtml("TODO"),tag:"info"}}catch(T){return console.error(T),{text:"执行错误 "+T,tag:"error"}}finally{}})),C}}class ApiTest_GM extends ApiTestBase{getApiName(){return "GM"}getAsyncApiOption(){}isSupport(){return typeof _GM=="object"&&_GM!=null}getUIOption(){}}const GMTotal={unsafeWindow:new ApiTest_unsafeWindow,GM:new ApiTest_GM,addElement:new ApiTest_addElement,addStyle:new ApiTest_addStyle,download:new ApiTest_download,getResourceText:new ApiTest_getResourceText,getResourceUrl:new ApiTest_getResourceUrl,info:new ApiTest_info,log:new ApiTest_log,notification:new ApiTest_notification,openInTab:new ApiTest_openInTab,registerMenuCommand:new ApiTest_registerMenuCommand,unregisterMenuCommand:new ApiTest_unregisterMenuCommand,setClipboard:new ApiTest_setClipboard,getTab:new ApiTest_getTab,saveTab:new ApiTest_saveTab,getTabs:new ApiTest_getTabs,setValue:new ApiTest_setValue,getValue:new ApiTest_getValue,deleteValue:new ApiTest_deleteValue,listValues:new ApiTest_listValues,setValues:new ApiTest_setValues,getValues:new ApiTest_getValues,deleteValues:new ApiTest_deleteValues,addValueChangeListener:new ApiTest_addValueChangeListener,removeValueChangeListener:new ApiTest_removeValueChangeListener,xmlHttpRequest:new ApiTest_xmlHttpRequest,webRequest:new ApiTest_webRequest,cookie:new ApiTest_cookie},LocalStorageApi={$storageKey:"gm-api-test-storage-config",set(S,w){let A=window.localStorage.getItem(LocalStorageApi.$storageKey)??"{}",C=utils.toJSON(A);C[S]=w,window.localStorage.setItem(LocalStorageApi.$storageKey,JSON.stringify(C,(T,E)=>typeof E=="function"?E.tString():E));},get(S,w){let A=window.localStorage.getItem(LocalStorageApi.$storageKey)??"{}";return utils.toJSON(A)[S]??w},delete(S){let w=window.localStorage.getItem(LocalStorageApi.$storageKey)??"{}",A=utils.toJSON(w);Reflect.deleteProperty(A,S),window.localStorage.setItem(LocalStorageApi.$storageKey,JSON.stringify(A,(C,T)=>typeof T=="function"?T.tString():T));}},StorageApi={set(S,w){GMTotal.setValue.isSupport()&&GMTotal.getValue.isSupport()&&GMTotal.deleteValue.isSupport()?_GM_setValue(S,w):LocalStorageApi.set(S,w);},get(S,w){return GMTotal.setValue.isSupport()&&GMTotal.getValue.isSupport()&&GMTotal.deleteValue.isSupport()?_GM_getValue(S,w):LocalStorageApi.get(S,w)},delete(S){GMTotal.setValue.isSupport()&&GMTotal.getValue.isSupport()&&GMTotal.deleteValue.isSupport()?_GM_deleteValue(S):LocalStorageApi.delete(S);}},_SCRIPT_NAME_="Monkey Api Test",utils=utils$1.noConflict(),domUtils=domUtils$1.noConflict(),__pops=pops,log=new utils.Log(_GM_info,window.console);var le;const SCRIPT_NAME=((le=_GM_info==null?void 0:_GM_info.script)==null?void 0:le.name)||_SCRIPT_NAME_,DEBUG=!1;log.config({debug:DEBUG,logMaxCount:1e3,autoClearConsole:!0,tag:!0});qmsg.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return PopsPanel.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return PopsPanel.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return PopsPanel.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let S=utils$1.getMaxZIndex(),w=pops.config.InstanceUtils.getPopsMaxZIndex(S).zIndex;return utils$1.getMaxValue(S,w)+100}}}));const GM_Menu=new utils.GM_Menu({GM_getValue:GMTotal.getValue.isSupport()?_GM_getValue:StorageApi.get,GM_setValue:GMTotal.setValue.isSupport()?_GM_setValue:StorageApi.set,GM_registerMenuCommand:GMTotal.registerMenuCommand.isSupport()?_GM_registerMenuCommand:()=>{},GM_unregisterMenuCommand:GMTotal.unregisterMenuCommand.isSupport()?_GM_unregisterMenuCommand:()=>{}}),addStyle=utils.addStyle.bind(utils);document.querySelector.bind(document);document.querySelectorAll.bind(document);let injectDocumentTime="";document.documentElement?document.head?document.body?injectDocumentTime=`<html>
    <head>

...
/* 当清空图标显示时，则隐藏输入框的padding-right */\r
...
`;const W={index:us,ninePalaceGridPosition:bs,scrollbar:hs,button:ms,common:gs,anim:ys,alertCSS:xs,confirmCSS:ws,promptCSS:vs,loadingCSS:As,iframeCSS:Cs,tooltipCSS:Ss,drawerCSS:Ts,folderCSS:Es,panelCSS:ks,rightClickMenu:Ms},lt={$data:{},$flag:{isInit:false},init(){if(!this.$flag.isInit){this.$flag.isInit=true;const a=p.createElement("style",{innerHTML:W.anim});p.appendHead(a),this.$data=null,this.$data=p.getKeyFrames(a.sheet),z.setTimeout(()=>{a.remove();},50);}},hasAnim(a){return Object.prototype.hasOwnProperty.call(this.$data,a)}},me={alert:[],confirm:[],drawer:[],folder:[],iframe:[],loading:[],panel:[],prompt:[],rightClickMenu:[],tooltip:[]},be={getMaxZIndexNodeInfo(a=1,e=X.document,t){a=Number.isNaN(a)?1:a;const n=2*Math.pow(10,9);let r=0,o=null;function s(l){return l.position!=="static"&&l.display!=="none"}function i(l){if(typeof t=="function"){const f=t(l);if(typeof f=="boolean"&&!f)return}const c=X.window.getComputedStyle(l);if(s(c)){const f=parseInt(c.zIndex);isNaN(f)||f>r&&(r=f,o=l),l.shadowRoot!=null&&l instanceof ShadowRoot&&l.shadowRoot.querySelectorAll("*").forEach(d=>{i(d);});}}return e.querySelectorAll("*").forEach(l=>{i(l);}),r+=a,r>=n&&(r=n),{node:o,zIndex:r}},getPopsMaxZIndex(a=1){a=Number.isNaN(a)?1:a;const e=2*Math.pow(10,9);let t=0,n=null;function r(s){return s.position!=="static"&&s.display!=="none"}Object.keys(me).forEach(s=>{const i=me[s];for(let l=0;l<i.length;l++){const c=i[l],f=window.getComputedStyle(c.animElement);if(r(f)){const d=parseInt(f.zIndex);isNaN(d)||d>t&&(t=d,n=c.animElement);}}}),t+=a;const o=t>=e;return o&&(t=e),{zIndex:t,animElement:n,isOverMaxZIndex:o}},getMaxZIndex(a=1){return this.getMaxZIndexNodeInfo(a).zIndex},removeInstance(a,e,t=false){function n(r){typeof r.beforeRemoveCallBack=="function"&&r.beforeRemoveCallBack(r),r?.animElement?.remove(),r?.popsElement?.remove(),r?.maskElement?.remove(),r?.$shadowContainer?.remove();}return a.forEach(r=>{r.forEach((o,s)=>{if(t||o.guid===e){const i=o.animElement.getAttribute("anim");if(lt.hasAnim(i)){const l=i+"-reverse";o.animElement.style.width="100%",o.animElement.style.height="100%",o.animElement.style["animation-name"]=l,lt.hasAnim(o.animElement.style["animation-name"])?p.on(o.animElement,p.getAnimationEndNameList(),function(){n(o);},{capture:true}):n(o);}else n(o);r.splice(s,1);}});}),a},hide(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;z.setTimeout(()=>{o&&p.css(o,"display","none"),["top","bottom"].includes(c.direction)?i.style.setProperty("height","0"):["left","right"].includes(c.direction)?i.style.setProperty("width","0"):console.error("未知direction：",c.direction),s();},c.closeDelay);}else {const c=t.find(f=>f.guid===n);if(c){const f=c;if(f.animElement.style.width="100%",f.animElement.style.height="100%",Reflect.set(f.animElement.style,"animation-name",f.animElement.getAttribute("anim")+"-reverse"),lt.hasAnim(Reflect.get(f.animElement.style,"animation-name"))){let d=function(){f.animElement.style.display="none",f.maskElement&&(f.maskElement.style.display="none"),p.off(f.animElement,p.getAnimationEndNameList(),d,{capture:true}),s();};p.on(f.animElement,p.getAnimationEndNameList(),d,{capture:true});}else f.animElement.style.display="none",f.maskElement&&(f.maskElement.style.display="none"),s();}}})},show(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;z.setTimeout(()=>{o&&p.css(o,"display","");const f=c.direction,d=c.size.toString();["top","bottom"].includes(f)?i.style.setProperty("height",d):["left","right"].includes(f)?i.style.setProperty("width",d):console.error("未知direction：",f),s();},c.openDelay??0);}else {const c=t.find(f=>f.guid===n);if(c){const f=c;if(f.animElement.style.width="",f.animElement.style.height="",Reflect.set(f.animElement.style,"animation-name",f.animElement.getAttribute("anim").replace("-reverse","")),lt.hasAnim(Reflect.get(f.animElement.style,"animation-name"))){let d=function(){p.off(f.animElement,p.getAnimationEndNameList(),d,{capture:true}),s();};f.animElement.style.display="",f.maskElement&&(f.maskElement.style.display=""),p.on(f.animElement,p.getAnimationEndNameList(),d,{capture:true});}else f.animElement.style.display="",f.maskElement&&(f.maskElement.style.display=""),s();}}})},close(a,e,t,n,r){return new Promise(o=>{const s=r.querySelector(".pops[type-value]"),i=a;function l(){function c(d){d.propertyName==="transform"&&(p.off(s,p.getTransitionEndNameList(),void 0,c),be.removeInstance([t],n),o());}if(p.on(s,p.getTransitionEndNameList(),c),getComputedStyle(s).transform!=="none"){p.trigger(s,p.getTransitionEndNameList(),void 0,true);return}["top"].includes(i.direction)?s.style.setProperty("transform","translateY(-100%)"):["bottom"].includes(i.direction)?s.style.setProperty("transform","translateY(100%)"):["left"].includes(i.direction)?s.style.setProperty("transform","translateX(-100%)"):["right"].includes(i.direction)?s.style.setProperty("transform","translateX(100%)"):console.error("未知direction：",i.direction);}e==="drawer"?z.setTimeout(()=>{l();},i.closeDelay):(be.removeInstance([t],n),o());})},drag(a,e){e=Object.assign({limit:true,extraDistance:3,container:X.globalThis,triggerClick:true},e);let t=false,n=0,r=0;const o=z.AnyTouch(),s=new o(e.dragElement,{preventDefault(u){return typeof e.preventEvent=="function"?e.preventEvent(u):true}});p.css(e.dragElement,{cursor:"move"});function i(u){const h=u.style.transitionDuration;return globalThis.getComputedStyle(u).transitionDuration!=="0s"&&(u.style.transitionDuration="0s"),()=>{u.style.transitionDuration=h;}}function l(u){return u=u??globalThis,{width:p.width(u),height:p.height(u)}}function c(u){if(u=u??globalThis,z.isWin(u))return {left:0,top:0};{const h=u.getBoundingClientRect();return {left:h.left,top:h.top}}}let f=p.getTransform(a),d=null;s.on("pan",function(u){if(!t){t=true;const y=e.dragElement.getBoundingClientRect();n=u.x-y.left,r=u.y-y.top,f=p.getTransform(a),d=i(a);}let h=u.x-n+f.transformLeft,g=u.y-r+f.transformTop;if(u.phase==="move"){if(e.limit){const y=l(e.container).width-p.width(a)+f.transformLeft,{left:x,top:w}=c(e.container),A=l(e.container).height-p.height(a)+f.transformTop;h>y&&(h=y),g>A&&(g=A),h-e.extraDistance*2<x+f.transformLeft?(h=x+f.transformLeft,h+=e.extraDistance):h-=e.extraDistance,g-e.extraDistance*2<w+f.transformTop?(g=w+f.transformTop,g+=e.extraDistance):g-=e.extraDistance;}typeof e.moveCallBack=="function"&&e.moveCallBack(a,h,g),p.css(a,{left:h+"px",top:g+"px"});}u.phase==="end"&&(t=false,typeof d=="function"&&(d(),d=null),typeof e.endCallBack=="function"&&e.endCallBack(a,h,g));}),e.triggerClick&&s.on(["tap"],function(u){u.changedPoints.forEach(h=>{p.trigger(h.target,"click",void 0,true);});});},sortElementListByProperty(a,e,t=true){if(typeof t!="boolean")throw new TypeError("参数 sortByDesc 必须为boolean类型");if(a==null||e==null)throw new Error("获取前面的值或后面的值的方法不能为空");return function(n,r){const o=a(r),s=e(n);return t?s>o?-1:s<o?1:0:s<o?-1:s>o?1:0}}},O={handlerShadow(a){const e=p.createElement("div",{className:"pops-shadow-container"});if(a.useShadowRoot){const t=e.attachShadow({mode:"open"});return {$shadowContainer:e,$shadowRoot:t}}else return {$shadowContainer:e,$shadowRoot:e}},handleInit(a,e){if(lt.init(),!!arguments.length&&a!=null&&e!=null){if(typeof e=="string"){if(e.trim()==="")return;e=[{css:e}];}else e=e.map(t=>typeof t=="string"?{css:t}:t);for(const t of e){const n=p.createElement("style",{},{"data-type":"PopsHandler.handleInit"});n.textContent=t.css,typeof t.name=="string"&&n.setAttribute("data-name",t.name),a.appendChild(n);}}},handleMask(a={}){const e={maskElement:p.parseTextToDOM(a.maskHTML)};let t=false;function n(o){p.preventEvent(o);const s=me[a.type];function i(){if(a.config.mask.clickEvent.toClose)return be.close(a.config,a.type,s,a.guid,a.animElement);if(a.config.mask.clickEvent.toHide)return be.hide(a.config,a.type,s,a.guid,a.animElement,e.maskElement)}return typeof a.config.mask.clickCallBack=="function"?a.config.mask.clickCallBack(i,a.config):i(),false}if(a.config.mask.clickEvent.toClose||a.config.mask.clickEvent.toHide){let o=function(s){return !!(s?.localName?.toLowerCase()==="div"&&s.className&&s.className==="pops-anim"&&s.hasAttribute("anim"))};p.on(a.animElement,["touchstart","mousedown"],void 0,s=>{const i=s.composedPath()[0];t=o(i);}),p.on(a.animElement,"click",void 0,s=>{const i=s.composedPath()[0];if(o(i)&&t)return n(s)}),p.on(e.maskElement,"click",void 0,s=>{t=true,n(s);});}return e},handleQueryElement(a,e){return {$pops:a.querySelector(".pops[type-value"),$btnOk:a.querySelector(`.pops-${e}-btn-ok`),$btnCancel:a.querySelector(`.pops-${e}-btn-cancel`),$btnOther:a.querySelector(`.pops-${e}-btn-other`),$title:a.querySelector(`.pops-${e}-title`),$input:a.querySelector(`.pops-${e}-content textarea[pops]`)?a.querySelector(`.pops-${e}-content textarea[pops]`):a.querySelector(`.pops-${e}-content input[pops]`),$headerControls:a.querySelector(".pops-header-controls"),$iframe:a.querySelector("iframe[pops]"),$loading:a.querySelector(".pops-loading"),$content:a.querySelector(`.pops-${e}-content`),$panelRightSectionWrapper:a.querySelector(`.pops-${e}-section-wrapper`),$panelLeftAside:a.querySelector(`.pops-${e}-content aside.pops-${e}-aside`),$panelContentSectionContainer:a.querySelector(`.pops-${e}-content section.pops-${e}-container`),$panelBottomWrapper:a.querySelector(`.pops-${e}-bottom-wrapper`),$panelBottomContainer:a.querySelector(`.pops-${e}-bottom-container`),$panelBottomLeftContainer:a.querySelector(`.pops-${e}-bottom-left-container`),$panelBottomRightContainer:a.querySelector(`.pops-${e}-bottom-right-container`),$contentLoading:a.querySelector(`.pops-${e}-content-global-loading`),$headerBtnMin:a.querySelector(".pops-header-control[data-type='min']"),$headerBtnMax:a.querySelector(".pops-header-control[data-type='max']"),$headerBtnMise:a.querySelector(".pops-header-control[data-type='mise']"),$headerBtnClose:a.querySelector(".pops-header-control[data-type='close']"),$folderList:a.querySelector(".pops-folder-list"),$folderHeaderNav:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div"),$folderHeaderRow:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div .pops-folder-list-table__header-row"),$folderTbody:a.querySelector(".pops-folder-list .pops-folder-list-table__body-div tbody"),$folderHeaderBreadcrumbPrimary:a.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-primary"),$folderSortFileName:a.querySelector('.pops-folder-list-table__sort[data-sort="fileName"]'),$folderSortLatestTime:a.querySelector('.pops-folder-list-table__sort[data-sort="latestTime"]'),$folderSortFileSize:a.querySelector('.pops-folder-list-table__sort[data-sort="fileSize"]')}},handleEventConfig(a,e,t,n,r,o,s,i){return {$shadowContainer:t,$shadowRoot:n,$el:o,$anim:o,$pops:s,$mask:i,mode:r,guid:e,close(){return be.close(a,r,me[r],e,o)},hide(){return be.hide(a,r,me[r],e,o,i)},show(){return be.show(a,r,me[r],e,o,i)}}},handleLoadingEventConfig(a,e,t,n,r,o){return {$el:n,$anim:n,$pops:r,$mask:o,mode:t,guid:e,close(){return be.close(a,t,me[t],e,n)},hide(){return be.hide(a,t,me[t],e,n,o)},show(){return be.show(a,t,me[t],e,n,o)}}},handleResultConfig(a){const e=Object.assign({},a);return z.delete(e,"type"),z.delete(e,"function"),e},handleClickEvent(a,e,t,n){typeof n=="function"&&p.on(e,"click",r=>{n(Object.assign(t,{type:a}),r);},{capture:true});},handleKeyboardEvent(a,e=[],t){const n=function(r){const o=r.code||r.key,s=r.charCode||r.keyCode||r.which;e.includes("ctrl")&&!r.ctrlKey||e.includes("alt")&&!r.altKey||e.includes("meta")&&!r.metaKey||e.includes("shift")&&!r.shiftKey||(typeof a=="string"&&a===o?t&&t(r):typeof a=="number"&&a===s&&t&&t(r));};return p.on(X.globalThis,"keydown",n,{capture:true}),{removeKeyboardEvent(){p.off(globalThis,"keydown",n,{capture:true});}}},handlePromptClickEvent(a,e,t,n,r){p.on(t,"click",o=>{const s={type:a,text:e.value};r(Object.assign(n,s),o);},{capture:true});},handleZIndex(a){return typeof a=="function"?a():a},handleOnly(a,e){if(e.only)if(a==="loading"||a==="tooltip"||a==="rightClickMenu"){const t=me[a];t&&be.removeInstance([t],"",true);}else be.removeInstance([me.alert,me.confirm,me.prompt,me.iframe,me.drawer,me.folder,me.panel],"",true);else {const t=e.zIndex;e.zIndex=()=>{const{zIndex:n}=be.getPopsMaxZIndex(O.handleZIndex(t)+100);return n};}return e},handlePush(a,e){me[a].push(e);}},$s=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{position:"flex-end",ok:{size:void 0,enable:true,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback:function(a){a.close();}},close:{enable:true,callback:function(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),xr={init(a){const e=z.getRandomGUID(),t="alert";let n=$s();n=z.assign(n,ye.getGlobalConfig()),n=z.assign(n,a),n=O.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=O.handlerShadow(n);O.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"button",css:W.button},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"alertCSS",css:W.alertCSS}]);const s=O.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:f,headerPStyle:d}=Z.createHeaderStyle(t,n),{contentStyle:u,contentPStyle:h}=Z.createContentStyle(t,n),g=Z.createAnim(e,t,n,`
            ...
            <div class="pops-content pops-${t}-content" style="${u}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${h}">${n.content.text}</p>`}</div>${c}`,c,s),y=Z.parseElement(g),{$pops:x,$headerBtnClose:w,$btnCancel:A,$btnOk:S,$btnOther:C}=O.handleQueryElement(y,t),v=x,k=w,H=A,U=S,F=C;let K;const J=[y];n.mask.enable&&(K=O.handleMask({type:t,guid:e,config:n,animElement:y,maskHTML:i}).maskElement,J.push(K));const M=O.handleEventConfig(n,e,r,o,t,y,v,K);return v.setAttribute("direction",n.direction),n.direction==="top"?(v.style.setProperty("height","0"),v.style.setProperty("border-radius",`0px 0px ${n.borderRadius}px ${n.borderRadius}px`)):n.direction==="bottom"?(v.style.setProperty("height","0"),v.style.setProperty("border-radius",`${n.borderRadius}px ${n.borderRadius}px 0px 0px`)):n.direction==="left"?(v.style.setProperty("width","0"),v.style.setProperty("border-radius",`0px ${n.borderRadius}px 0px ${n.borderRadius}px`)):n.direction==="right"&&(v.style.setProperty("width","0"),v.style.setProperty("border-radius",`${n.borderRadius}px 0px ${n.borderRadius}px 0px`)),n.closeOnPressEscape&&O.handleKeyboardEvent("Escape",[],function(){M.close();}),[{type:"close",ele:k},{type:"cancel",ele:H},{type:"ok",ele:U},{type:"other",ele:F}].forEach(m=>{O.handleClickEvent(m.type,m.ele,M,(E,P)=>{const I=n.btn[m.type].callback;typeof I=="function"&&I(E,P);});}),J.forEach(m=>{m.style.setProperty("display","none"),["top"].includes(n.direction)?(v.style.setProperty("height",n.size.toString()),v.style.setProperty("transform","translateY(-100%)")):["bottom"].includes(n.direction)?(v.style.setProperty("height",n.size.toString()),v.style.setProperty("transform","translateY(100%)")):["left"].includes(n.direction)?(v.style.setProperty("width",n.size.toString()),v.style.setProperty("transform","translateX(-100%)")):["right"].includes(n.direction)&&(v.style.setProperty("width",n.size.toString()),v.style.setProperty("transform","translateX(100%)")),m.style.setProperty("display","");}),p.append(o,J),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),z.setTimeout(()=>{z.setTimeout(()=>{v.style.setProperty("transform","");},n.openDelay);},50),K!=null&&y.after(K),O.handlePush(t,{guid:e,animElement:y,popsElement:v,maskElement:K,$shadowContainer:r,$shadowRoot:o}),O.handleResultConfig(M)}},Os=()=>({parent:document.body,content:{text:"加载中...",icon:"loading",style:""},useShadowRoot:true,class:"",only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",forbiddenScroll:false,isAbsolute:false,style:null,addIndexCSS:true}),Xt={init(a){let e=Os();e=z.assign(e,ye.getGlobalConfig()),e=z.assign(e,a);const t=z.getRandomGUID(),n="loading";e=O.handleOnly(n,e);const r=O.handleZIndex(e.zIndex),o=Z.createMask(t,r),{contentPStyle:s}=Z.createContentStyle("loading",e),i=Z.createAnim(t,n,e,`
            ...
            </div>${h}`,h,f),w=Z.parseElement(x),{$pops:A,$title:S,$content:C,$folderTbody:v,$folderHeaderBreadcrumbPrimary:k,$headerBtnClose:H,$btnOk:U,$btnCancel:F,$btnOther:K,$folderSortFileName:J,$folderSortLatestTime:M,$folderSortFileSize:L}=O.handleQueryElement(w,t);let T;const m=[w];n.mask.enable&&(T=O.handleMask({type:t,guid:e,config:n,animElement:w,maskHTML:d}).maskElement,m.push(T));const E=O.handleEventConfig(n,e,r,o,t,w,A,T);O.handleClickEvent("close",H,E,n.btn.close.callback),O.handleClickEvent("ok",U,E,n.btn.ok.callback),O.handleClickEvent("cancel",F,E,n.btn.cancel.callback),O.handleClickEvent("other",K,E,n.btn.other.callback),p.append(o,m),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),p.appendBody(r),T!=null&&w.after(T);class P{init(){n.folder.sort(),this.initFolderView(n.folder);const D=k.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-allFiles:first-child");Reflect.set(D,"_config_",n.folder),p.on(D,"click",_=>{this.setBreadcrumbClickEvent(_,true,n.folder);}),p.on(J.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(J,_,"fileName");},{capture:true}),p.on(M.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(M,_,"latestTime");},{capture:true}),p.on(L.closest("th"),"click",_=>{this.arrowToSortFolderInfoView(L,_,"fileSize");},{capture:true}),n.sort.name==="fileName"?p.trigger(J,"click",{notChangeSortRule:true}):n.sort.name==="latestTime"?p.trigger(M,"click",{notChangeSortRule:true}):n.sort.name==="fileSize"&&p.trigger(L,"click",{notChangeSortRule:true});}createFolderRowElement(D,_="-",j="-",te=false){const Y=D,ae=_,ge=j,xe=p.createElement("tr"),he=p.createElement("td"),pe=p.createElement("td"),$e=p.createElement("td");let rt="",Be=fe.folder;if(te)_="",j="";else {Be="",typeof _=="number"&&(_=z.formatTime(_)),typeof j=="number"&&(j=z.formatByteToSize(j));for(const Pt in fe)if(D.toLowerCase().endsWith("."+Pt)){rt=Pt,Be=fe[Pt];break}Be||(rt="Null",Be=fe.Null);}xe.className="pops-folder-list-table__body-row",he.className="pops-folder-list-table__body-td",pe.className="pops-folder-list-table__body-td",$e.className="pops-folder-list-table__body-td",ne.setSafeHTML(he,`
            ...
            `),ne.setSafeHTML(pe,`
				...
				`);const wt={fileName:Y,latestTime:ae,fileSize:ge,isFolder:te};return Reflect.set(he,"__value__",wt),Reflect.set(pe,"__value__",wt),Reflect.set($e,"__value__",wt),Reflect.set(xe,"__value__",wt),xe.appendChild(he),xe.appendChild(pe),xe.appendChild($e),{folderElement:xe,fileNameElement:he,fileTimeElement:pe,fileFormatSize:$e}}createFolderRowElementByMobile(D,_="-",j="-",te=false){const Y=D,ae=_,ge=j,xe=p.createElement("tr"),he=p.createElement("td");let pe="",$e=fe.folder;if(te)_="",j="";else {$e="",typeof _=="number"&&(_=z.formatTime(_)),typeof j=="number"&&(j=z.formatByteToSize(j));for(const Be in fe)if(D.toLowerCase().endsWith("."+Be)){pe=Be,$e=fe[Be];break}$e||(pe="Null",$e=fe.Null);}xe.className="pops-folder-list-table__body-row",he.className="pops-folder-list-table__body-td",ne.setSafeHTML(he,`
			...
			`);const rt={fileName:Y,latestTime:ae,fileSize:ge,isFolder:te};return Reflect.set(he,"__value__",rt),Reflect.set(xe,"__value__",rt),xe.appendChild(he),{folderElement:xe,fileNameElement:he}}clearFolderInfoView(){ne.setSafeHTML(v,"");}createHeaderArrowIcon(){return p.createElement("div",{className:"iconArrow"})}createBreadcrumb(D,_){return p.createElement("span",{className:"pops-folder-file-list-breadcrumb-allFiles cursor-p",innerHTML:`<a>${D}</a>`,_config_:_},{title:D})}setBreadcrumbClickEvent(D,_,j){this.clearFolderInfoView();const Y=D.target.closest("span.pops-folder-file-list-breadcrumb-allFiles");if(Y)for(;Y.nextElementSibling;)Y.nextElementSibling.remove();else console.error("获取导航按钮失败");const ae=Xt.init({parent:C,content:{text:"获取文件列表中..."},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},addIndexCSS:false});this.initFolderView(j),ae.close();}async enterFolder(D,_){this.clearFolderInfoView();const j=Xt.init({parent:C,content:{text:"获取文件列表中..."},mask:{enable:true},addIndexCSS:false});if(typeof _.clickEvent=="function"){const te=await _.clickEvent(D,_);k.appendChild(this.createHeaderArrowIcon());const Y=this.createBreadcrumb(_.fileName,te);k.appendChild(Y),p.on(Y,"click",ae=>{this.setBreadcrumbClickEvent(ae,false,te);}),this.initFolderView(te);}j.close();}async downloadFile(D,_,j){p.preventEvent(D);const te=_.querySelector("a");if(typeof j.clickEvent=="function"){const Y=await j.clickEvent(D,j);if(Y!=null&&typeof Y=="object"&&!Array.isArray(Y)&&typeof Y.url=="string"&&Y.url.trim()!==""&&(te.setAttribute("href",Y.url),te.setAttribute("target","_blank"),Y.autoDownload))if((Y.mode==null||Y.mode==="")&&(Y.mode="aBlank"),Y.mode==="a"||Y.mode==="aBlank"){const ae=p.createElement("a");Y.mode==="aBlank"&&ae.setAttribute("target","_blank"),ae.href=Y.url,ae.click();}else if(Y.mode==="open"||Y.mode==="openBlank")Y.mode==="openBlank"?globalThis.open(Y.url,"_blank"):globalThis.open(Y.url);else if(Y.mode==="iframe"){const ae=p.createElement("iframe");ae.src=Y.url,ae.onload=function(){z.setTimeout(()=>{ae.remove();},1e3);},o.appendChild(ae),z.setTimeout(()=>{ae.remove();},180*1e3);}else console.error("未知的下载模式",Y);}}sortFolderConfig(D,_="fileName",j=false){if(_==="fileName"){const te=D.filter(ae=>ae.isFolder),Y=D.filter(ae=>!ae.isFolder);return te.sort((ae,ge)=>{const xe=ae[_].toString(),he=ge[_].toString();let pe=xe.localeCompare(he);return j&&(pe>0?pe=-1:pe<0&&(pe=1)),pe}),Y.sort((ae,ge)=>{const xe=ae[_].toString(),he=ge[_].toString();let pe=xe.localeCompare(he);return j&&(pe>0?pe=-1:pe<0&&(pe=1)),pe}),j?[...Y,...te]:[...te,...Y]}else return D.sort((te,Y)=>{let ae=te[_],ge=Y[_];return _==="fileSize"?(ae=parseFloat(ae.toString()),ge=parseFloat(ge.toString())):_==="latestTime"&&(ae=new Date(ae).getTime(),ge=new Date(ge).getTime()),ae>ge?j?-1:1:ae<ge?j?1:-1:0}),D}initFolderView(D){this.sortFolderConfig(D,n.sort.name,n.sort.isDesc),D.forEach(_=>{if(_.isFolder){const{folderElement:j,fileNameElement:te}=z.isPhone()?this.createFolderRowElementByMobile(_.fileName,"","",true):this.createFolderRowElement(_.fileName,"","",true);p.on(te,"click",Y=>{this.enterFolder(Y,_);}),v.appendChild(j);}else {const{folderElement:j,fileNameElement:te}=z.isPhone()?this.createFolderRowElementByMobile(_.fileName,_.latestTime,_.fileSize,false):this.createFolderRowElement(_.fileName,_.latestTime,_.fileSize,false);p.on(te,"click",Y=>{this.downloadFile(Y,te,_);}),v.appendChild(j);}});}removeArrowActiveStatus(){[...Array.from(J.querySelectorAll(".pops-folder-icon-active")),...Array.from(M.querySelectorAll(".pops-folder-icon-active")),...Array.from(L.querySelectorAll(".pops-folder-icon-active"))].forEach(D=>D.classList.remove("pops-folder-icon-active"));}changeArrowActive(D,_,j){this.removeArrowActiveStatus(),j?_.classList.add("pops-folder-icon-active"):D.classList.add("pops-folder-icon-active");}arrowToSortFolderInfoView(D,_,j){Reflect.get(_,"notChangeSortRule")||(n.sort.name=j,n.sort.isDesc=!n.sort.isDesc);const Y=D.querySelector(".pops-folder-icon-arrow-up"),ae=D.querySelector(".pops-folder-icon-arrow-down");if(this.changeArrowActive(Y,ae,n.sort.isDesc),typeof n.sort.callback=="function"&&n.sort.callback(D,_,n.sort.name,n.sort.isDesc))return;const ge=[];Array.from(v.children).forEach(he=>{const pe=Reflect.get(he,"__value__");Reflect.set(pe,"target",he),ge.push(pe);}),this.sortFolderConfig(ge,n.sort.name,n.sort.isDesc).forEach(he=>{v.appendChild(he.target);});}}const I=new P;return I.init(),Reflect.set(A,"data-pops-folder",I),n.drag&&be.drag(A,{dragElement:S,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),O.handlePush(t,{guid:e,animElement:w,popsElement:A,maskElement:T,$shadowContainer:r,$shadowRoot:o}),O.handleResultConfig(E)}},Bs=()=>({title:{position:"center",text:"",html:false,style:""},loading:{enable:true,icon:true,text:""},useShadowRoot:true,class:"",url:window.location.href,only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",position:"center",drag:true,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",topRightButton:"min|max|mise|close",sandbox:false,forbiddenScroll:false,loadEndCallBack(){},btn:{min:{callback(){}},max:{callback(){}},mise:{callback(){}},close:{callback(){}}},style:null,beforeAppendToPageCallBack(){}}),Ds={init(a){const e=z.getRandomGUID(),t="iframe";let n=Bs();if(n=z.assign(n,ye.getGlobalConfig()),n=z.assign(n,a),n.url==null)throw new Error("config.url不能为空");n=O.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=O.handlerShadow(n);O.handleInit(o,[{name:"index",css:W.index},{name:"ninePalaceGridPosition",css:W.ninePalaceGridPosition},{name:"scrollbar",css:W.scrollbar},{name:"anim",css:W.anim},{name:"common",css:W.common},{name:"iframeCSS",css:W.iframeCSS}]);const s=n.animation!=null&&n.animation!=""?"position:absolute;":"",i=O.handleZIndex(n.zIndex),l=Z.createMask(e,i,s),c=Z.createHeader(t,n),f='<div class="pops-loading"></div>',d=n.title.text.trim()!==""?n.title.text:n.url,{headerStyle:u,headerPStyle:h}=Z.createHeaderStyle(t,n),g=Z.createAnim(e,t,n,`
			...
			`);const n=e.querySelector(".pops-panel-slider input[type=range]");a.step&&n.setAttribute("step",a.step.toString()),n.value=a.getValue().toString();const r=function(s){return typeof a.getToolTipContent=="function"?a.getToolTipContent(s):s},o=Qt.init({target:n.parentElement,content:()=>r(n.value),zIndex:()=>be.getPopsMaxZIndex().zIndex,className:"github-tooltip",alwaysShow:false,only:false,position:"top",arrowDistance:10});return p.on(n,["input","propertychange"],void 0,function(s){o.toolTip.changeContent(r(n.value)),typeof a.callback=="function"&&a.callback(s,n.valueAsNumber);}),e},createSectionContainerItem_slider_new(a){const e=p.createElement("li");Reflect.set(e,"__formConfig__",a),this.setElementClassName(e,a.className),this.setElementAttributes(e,a.attributes),this.setElementProps(e,a.props);let t="";a.description&&(t=`<p class="pops-panel-item-left-desc-text">${a.description}</p>`),ne.setSafeHTML(e,`
				...
				`);const r={[Symbol.toStringTag]:"PopsPanelInput",$ele:{itemLeftTextContainer:e.querySelector(".pops-panel-item-left-text"),panelInput:e.querySelector(".pops-panel-input"),input:e.querySelector("input"),inputSpanIcon:p.createElement("span"),inputSpanIconInner:null,icon:null},$data:{value:a.getValue(),isView:false},init(){this.initEle(),this.setInputValue(this.$data.value),a.isPassword?(this.setCircleIcon(le.getIcon("view")),this.setCircleIconClickEvent()):this.$ele.input.value!=""&&(this.setCircleIcon(le.getIcon("circleClose")),this.setCircleIconClickEvent()),this.setInputChangeEvent(),(typeof a.disabled=="function"?a.disabled():a.disabled)&&this.disable(),typeof a.handlerCallBack=="function"&&a.handlerCallBack(e,this.$ele.input);},initEle(){this.$ele.input.parentElement.insertBefore(this.$ele.inputSpanIcon,this.$ele.input.nextSibling),this.$ele.inputSpanIcon.className="pops-panel-input__suffix",ne.setSafeHTML(this.$ele.inputSpanIcon,`
...
`)}{display: none !important;}`)},setGMResourceCSS(a){const e=typeof At=="function"?At(a.keyName):null;return typeof e=="string"&&e?Hn(e):ie.loadStyleLink(a.url)},async loadStyleLink(a){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=a,new Promise(t=>{Ee.ready(()=>{document.head.appendChild(e),t(e);});})},async loadScript(a){let e=document.createElement("script");return e.src=a,new Promise(t=>{e.onload=()=>{t(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(a){return a=a.trim(),a.startsWith("data:")||a.match(/^http(s|):\/\//i)?a:a.startsWith("//")?(a.startsWith("///")||(a=window.location.protocol+a),a):(a.startsWith("/")||(a+="/"),a=window.location.origin+a,a)},fixHttps(a){if(a.startsWith("https://")||!a.startsWith("http://"))return a;try{let e=new URL(a);return e.protocol="https:",e.toString()}catch{return a}},lockScroll(...a){let e=document.createElement("style");e.innerHTML=`
		...
		`;let t=[document.documentElement,document.body].concat(...a||[]);return t.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){t.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function a(n){navigator.clipboard.readText().then(r=>{n(r);}).catch(r=>{ke.error("读取剪贴板内容失败👉",r),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(r=>{a(n);}).catch(r=>{ke.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),a(n);});}function t(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!t()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(a,e,t=5e3){let n,r=t-e,o=e,s=async i=>{let l=await a(i);if(typeof l=="boolean"&&!l||i){re.workerClearTimeout(n);return}if(o+=e,o>r){s(true);return}n=re.workerSetTimeout(()=>{s(false);},e);};s(false);},findParentNode(a,e,t){if(t){let n=Ee.closest(a,t);if(n)return n.querySelector(e)}else return Ee.matches(a,e)?a:Ee.closest(a,e)},toStr(a){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(a,(n,r)=>r===void 0?e:r,2).replace(new RegExp(`"${e}"`,"g"),"undefined")}},at={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},re=We.noConflict(),b=Ee.noConflict(),He=Ot,ke=new re.Log(Ge,ve.console||Ve.console);let Yt=Ge?.script?.name||void 0;const Qs=Ot.config.Utils.AnyTouch(),Ys=false;ke.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});R.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(a){const e=a.getSetting().type;if(e==="loading")return  false;const t=a.getSetting().content;return e==="warning"?ke.warn(t):e==="error"?ke.error(t):ke.info(t),true},get position(){return Ne.getValue(at.qmsg_config_position.key,at.qmsg_config_position.defaultValue)},get maxNums(){return Ne.getValue(at.qmsg_config_maxnums.key,at.qmsg_config_maxnums.defaultValue)},get showReverse(){return Ne.getValue(at.qmsg_config_showreverse.key,at.qmsg_config_showreverse.defaultValue)},get zIndex(){let a=We.getMaxZIndex(),e=Ot.config.InstanceUtils.getPopsMaxZIndex().zIndex;return We.getMaxValue(a,e)+100}});He.GlobalConfig.setGlobalConfig({zIndex:()=>{let a=We.getMaxZIndex(void 0,void 0,t=>{if(t?.classList?.contains("qmsg-shadow-container")||t?.closest("qmsg")&&t.getRootNode()instanceof ShadowRoot)return  false}),e=Ot.config.InstanceUtils.getPopsMaxZIndex().zIndex;return We.getMaxValue(a,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Js=new re.GM_Menu({GM_getValue:qe,GM_setValue:Pe,GM_registerMenuCommand:St,GM_unregisterMenuCommand:Ft}),sn=new re.Httpx({xmlHttpRequest:zn,logDetails:Ys});sn.interceptors.request.use(a=>a);sn.interceptors.response.use(void 0,a=>(ke.error("拦截器-请求错误",a),a.type==="onabort"?R.warning("请求取消",{consoleLogContent:true}):a.type==="onerror"?R.error("请求异常",{consoleLogContent:true}):a.type==="ontimeout"?R.error("请求超时",{consoleLogContent:true}):R.error("其它错误",{consoleLogContent:true}),a));ve.Object.defineProperty,ve.Function.prototype.apply,ve.Function.prototype.call,ve.Element.prototype.appendChild,ve.setTimeout;const Hn=b.addStyle.bind(b);Ee.selector.bind(Ee);Ee.selectorAll.bind(Ee);new re.GM_Cookie;const Et="GM_Panel",Zs="data-init",Vn="data-key",Un="data-default-value",ei="data-init-more-value",Le={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},Oe={setting:{get width(){return Le.width<550?"88vw":Le.width<700?"550px":"700px"},get height(){return Le.height<450?"70vh":Le.height<550?"450px":"550px"}},settingMiddle:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<450?"88vh":"450px"}},settingBig:{get width(){return Le.width<800?"92vw":"800px"},get height(){return Le.height<600?"80vh":"600px"}},info:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<250?"88vh":"250px"}}};class ti{storageKey;listenerData;constructor(e){if(typeof e=="string"){const t=e.trim();if(t=="")throw new Error("key参数不能为空字符串");this.storageKey=t;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new We.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let e=qe(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){Pe(this.storageKey,e);}set(e,t){const n=this.get(e),r=this.getLocalValue();Reflect.set(r,e,t),this.setLocalValue(r),this.triggerValueChangeListener(e,n,t);}get(e,t){const n=this.getLocalValue();return Reflect.get(n,e)??t}getAll(){return this.getLocalValue()}delete(e){const t=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.triggerValueChangeListener(e,t,void 0);}has(e){const t=this.getLocalValue();return Reflect.has(t,e)}keys(){const e=this.getLocalValue();return Reflect.ownKeys(e)}values(){const e=this.getLocalValue();return Reflect.ownKeys(e).map(t=>Reflect.get(e,t))}clear(){ct(this.storageKey);}addValueChangeListener(e,t){const n=Math.random(),r=this.listenerData.get(e)||[];return r.push({id:n,key:e,callback:t}),this.listenerData.set(e,r),n}removeValueChangeListener(e){let t=false;for(const[n,r]of this.listenerData.entries()){for(let o=0;o<r.length;o++){const s=r[o];(typeof e=="string"&&s.key===e||typeof e=="number"&&s.id===e)&&(r.splice(o,1),o--,t=true);}this.listenerData.set(n,r);}return t}async triggerValueChangeListener(...e){const[t,n,r]=e;if(!this.listenerData.has(t))return;let o=this.listenerData.get(t);for(let s=0;s<o.length;s++){const i=o[s];if(typeof i.callback=="function"){let l=this.get(t),c,f;typeof n<"u"&&e.length>=2?f=n:f=l,typeof r<"u"&&e.length>2?c=r:c=l,await i.callback(t,f,c);}}}}const Ue=new ti(Et),yt={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new re.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(a){Array.isArray(a)||(a=[a]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,a);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(a=0){return this.$data.contentConfig.get(a)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let a=false,e;const t=(o,s)=>{typeof s!="string"&&(s=ie.toStr(s));const i=new Blob([s]),l=globalThis.URL.createObjectURL(i);b.createElement("a",{href:l,download:o}).click(),re.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const o=d=>{const u=He.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),h=u.$shadowRoot.querySelector(".btn-control[data-mode='local']"),g=u.$shadowRoot.querySelector(".btn-control[data-mode='network']"),y=u.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),x=async A=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof it=="function"?typeof ct=="function"?(it().forEach(v=>{ct(v);}),R.success("已清空脚本存储的配置")):R.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):R.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof ft=="function"?ft(A):Object.keys(A).forEach(v=>{const k=A[v];Pe(v,k);}),R.success("配置导入完毕");},w=A=>new Promise(async S=>{const C=re.toJSON(A);Object.keys(C).length===0?R.warning("解析为空配置，不导入"):await x(C),S(true);});b.on(h,"click",A=>{b.preventEvent(A),u.close();const S=b.createElement("input",{type:"file",accept:".json"});b.on(S,["propertychange","input"],C=>{if(!S.files?.length)return;const v=S.files[0],k=new FileReader;k.onload=()=>{w(k.result);},k.readAsText(v,"UTF-8");}),S.click();}),b.on(g,"click",A=>{b.preventEvent(A),u.close();const S=He.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(k,H){k.close();}},ok:{text:"导入",callback:async(k,H)=>{const U=k.text;if(re.isNull(U)){R.error("请填入完整的url");return}const F=R.loading("正在获取配置..."),K=await sn.get(U,{allowInterceptConfig:false});if(F.close(),!K.status){ke.error(K),R.error("获取配置失败",{consoleLogContent:true});return}await w(K.data.responseText)&&k.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:Oe.info.width,height:"auto"}),C=S.$shadowRoot.querySelector("input"),v=S.$shadowRoot.querySelector(".pops-prompt-btn-ok");b.on(C,["input","propertychange"],k=>{b.val(C)===""?b.attr(v,"disabled","true"):b.removeAttr(v,"disabled");}),b.listenKeyboard(C,"keydown",(k,H,U)=>{k==="Enter"&&U.length===0&&b.val(C)!==""&&b.trigger(v,"click");}),b.trigger(C,"input");}),b.on(y,"click",async A=>{b.preventEvent(A),u.close();let S=await ie.getClipboardText();if(S.trim()===""){R.warning("获取到的剪贴板内容为空");return}await w(S);});},s=(d=`${Yt}_panel-setting-${re.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,u)=>{const h=He.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof it=="function")it().forEach(u=>{const h=qe(u);Reflect.set(c,u,h);});else {R.warning("不支持函数GM_listValues，仅导出菜单配置");const d=qe(Et);Reflect.set(c,Et,d);}const f=ie.toStr(c);l.value=f;},r=()=>{let o=Ge?.script?.supportURL||Ge?.script?.namespace;typeof o=="string"&&re.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${Ge?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(){return  false},afterRender(o){new Qs(o.$asideLiElement).on("tap",function(i){clearTimeout(e),e=void 0,a?(a=false,n()):(e=setTimeout(()=>{a=false,r();},200),a=true);});}}]},setDefaultBottomContentConfig(a){this.$data.__defaultBottomContentConfig=a;}},Jt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(a){return a},callback:()=>{Ne.showPanel(yt.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){Ne.isTopWindow()&&Js.add(this.$data.menuOption);},addMenuOption(a){Array.isArray(a)||(a=[a]),this.$data.menuOption.push(...a);},updateMenuOption(a){Array.isArray(a)||(a=[a]),a.forEach(e=>{let t=this.$data.menuOption.findIndex(n=>n.key===e.key);t!==-1&&(this.$data.menuOption[t]=e);});},getMenuOption(a=0){return this.$data.menuOption[a]},deleteMenuOption(a=0){this.$data.menuOption.splice(a,1);}},Ne={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new re.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new re.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new re.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new re.Dictionary),this.__onceExecData},get scriptName(){return Yt},get panelConfig(){return this.__panelConfig},set panelConfig(a){this.__panelConfig=a;},key:Et,attributeKeyName:Vn,attributeDefaultValueName:Un},init(){this.initContentDefaultValue(),Jt.init();},isTopWindow(){return ve.top===ve.self},initContentDefaultValue(){const a=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const r=n.attributes;let o=r[Zs];if(typeof o=="function"){let c=o();if(typeof c=="boolean"&&!c)return}let s=new Map,i=r[Vn];if(i!=null){const c=r[Un];s.set(i,c);}let l=r[ei];if(typeof l=="object"&&l&&Object.keys(l).forEach(c=>{s.set(c,l[c]);}),!s.size){ke.warn(["请先配置键",n]);return}if(n.type==="switch"){let c=typeof n.disabled=="function"?n.disabled():n.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...s.keys());}for(const[c,f]of s.entries())this.setDefaultValue(c,f);},e=n=>{for(let r=0;r<n.length;r++){let o=n[r];a(o);let s=o.forms;s&&Array.isArray(s)&&e(s);}},t=[...yt.getAllContentConfig()];for(let n=0;n<t.length;n++){let r=t[n];if(!r.forms)continue;const o=r.forms;o&&Array.isArray(o)&&e(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(a,e){this.$data.contentConfigInitDefaultValue.has(a)&&ke.warn("请检查该key(已存在): "+a),this.$data.contentConfigInitDefaultValue.set(a,e);},getDefaultValue(a){return this.$data.contentConfigInitDefaultValue.get(a)},setValue(a,e){Ue.set(a,e);},getValue(a,e){const t=Ue.get(a);return t??(this.$data.contentConfigInitDefaultValue.has(a)?this.$data.contentConfigInitDefaultValue.get(a):e)},deleteValue(a){Ue.delete(a);},hasKey(a){return Ue.has(a)},addValueChangeListener(a,e){return Ue.addValueChangeListener(a,(n,r,o)=>{e(a,o,r);})},removeValueChangeListener(a){Ue.removeValueChangeListener(a);},triggerMenuValueChange(a,e,t){Ue.triggerValueChangeListener(a,t,e);},async exec(a,e,t,n=true){const r=this;let o;typeof a=="string"||Array.isArray(a)?o=()=>a:o=a;let s=false;const i=o();let l=[];Array.isArray(i)?(s=true,l=i):l.push(i);const c=l.find(v=>!this.$data.contentConfigInitDefaultValue.has(v));if(c){ke.warn(`${c} 键不存在`);return}const f=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(f))return this.$data.onceExecMenuData.get(f);let d=[];const u=[];let h=[];const g=(v,k)=>{let H=[],U=[],F=[];if(Array.isArray(k))F=F.concat(k);else if(typeof k=="object"&&k!=null)if(k instanceof Element)F.push(k);else {const{$css:K,destory:J}=k;K!=null&&(Array.isArray(K)?F=F.concat(K):F.push(K)),typeof J=="function"&&F.push(J);}else F.push(k);for(const K of F)if(K!=null){if(K instanceof Element){H.push(K);continue}if(typeof K=="function"){h.push(K);continue}}v?(d=d.concat(H),h=h.concat(U)):(x(),w());},y=v=>!!this.getValue(v),x=()=>{for(let v=0;v<d.length;v++)d[v]?.remove(),d.splice(v,1),v--;},w=()=>{for(let v=0;v<h.length;v++){const k=h[v];k(),h.splice(v,1),v--;}},A=()=>{let v=false;return typeof t=="function"?v=t(l):v=l.every(k=>y(k)),v},S=async v=>{if(A()){const H=l.map(F=>this.getValue(F)),U=await e({value:s?H:H[0],addStoreValue:(...F)=>g(true,F)});g(true,U);}else g(false,[]);};n&&l.forEach(v=>{const k=this.addValueChangeListener(v,(H,U,F)=>S());u.push(k);}),await S();const C={reload(){this.clearStoreStyleElements(),this.destory(),S();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>x(),destory(){return w()},removeValueChangeListener:()=>{u.forEach(v=>{this.removeValueChangeListener(v);});},clearOnceExecMenuData(){n&&r.$data.onceExecMenuData.delete(f);}};return this.$data.onceExecMenuData.set(f,C),C},async execMenu(a,e,t=false,n=false){return await this.exec(a,async r=>await e(r),r=>r.every(s=>{let i=!!this.getValue(s);return Ne.$data.contentConfigInitDisabledKeys.includes(s)&&(i=false,ke.warn(`.execMenu${n?"Once":""} ${s} 被禁用`)),t&&(i=!i),i}),n)},async execMenuOnce(a,e,t=false,n=false){const r=await this.execMenu(a,e,t,true);if(n&&r){const o=()=>{r.reload();};this.removeUrlChangeWithExecMenuOnceListener(a),this.addUrlChangeWithExecMenuOnceListener(a,o);}return r},deleteExecMenuOnce(a){return a=this.transformKey(a),this.$data.onceExecMenuData.delete(a),this.$data.urlChangeReloadMenuExecOnce.delete(a),Ue.removeValueChangeListener(a)},onceExec(a,e){if(a=this.transformKey(a),typeof a!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(a)||(e(),this.$data.onceExecData.set(a,1));},deleteOnceExec(a){a=this.transformKey(a),this.$data.onceExecData.delete(a);},addUrlChangeWithExecMenuOnceListener(a,e){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.set(a,e);},removeUrlChangeWithExecMenuOnceListener(a){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.delete(a);},hasUrlChangeWithExecMenuOnceListener(a){return a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.has(a)},async triggerUrlChangeWithExecMenuOnceEvent(a){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const t of e)await t(a);},showPanel(a,e=`${Yt}-设置`,t=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let r=a.findIndex(s=>(typeof s.isBottom=="function"?s.isBottom():!!s.isBottom)&&s.id==="script-version")!==-1;!t&&!r&&a.push(...yt.getDefaultBottomContentConfig());let o=He.panel({title:{text:e,position:"center",html:false,style:""},content:a,btn:{close:{enable:true,callback:(s,i)=>{s.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(s,i)=>{s(),this.$data.$panel=null;}},width:Oe.setting.width,height:Oe.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=a,n||this.registerConfigSearch({$panel:o,content:a});},registerConfigSearch(a){const{$panel:e,content:t}=a,n=async(u,h)=>{if(u==null)return;const g=await h(u);return g&&typeof g.isFind=="boolean"&&g.isFind?g.data:await n(g.data,h)},r=(u,h)=>{const g=new IntersectionObserver(y=>{y.forEach(x=>{x.isIntersecting&&(h?.(),g.disconnect());});},{root:null,threshold:1});g.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},o=u=>{const h="pops-flashing";b.animationend(u,()=>{u.classList.remove(h);}),u.classList.add(h);},s=u=>{if(u.type==="dblclick"&&d)return;b.preventEvent(u),l=null;const h=He.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${a.searchDialogStyle??""}
				`});h.$shadowRoot.querySelector(".search-wrapper");const g=h.$shadowRoot.querySelector(".search-config-text"),y=h.$shadowRoot.querySelector(".search-result-wrapper");g.focus();const x=()=>{b.empty(y);},w=S=>{const C=re.queryProperty(S,k=>k?.next?{isFind:false,data:k.next}:{isFind:true,data:k}),v=b.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return b.on(v,"click",k=>{const U=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[S.index];if(!U){R.error(`左侧项下标${S.index}不存在`);return}U.scrollIntoView({behavior:"smooth",block:"center"}),U.click(),n(S.next,async F=>{if(F?.next){const K=await b.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(J=>{const M=Reflect.get(J,"__formConfig__");return typeof M=="object"&&M!=null&&M.text===F.name}),2500);if(K)K.click();else return R.error("未找到对应的二级菜单"),{isFind:true,data:F};return {isFind:false,data:F.next}}else {const K=await b.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(J=>Reflect.get(J,"__formConfig__")===F.matchedData?.formConfig),2500);if(K){r(K);const J=K.closest(".pops-panel-forms-fold[data-fold-enable]");J&&(J.querySelector(".pops-panel-forms-fold-container").click(),await re.sleep(500)),r(K,()=>{o(K);});}else R.error("未找到对应的菜单项");return {isFind:true,data:F}}});}),v},A=S=>{const C=new RegExp(S,"i"),v=[],k=(U,F)=>{for(let K=0;K<U.length;K++){const J=U[K],M=J.forms;if(M&&Array.isArray(M)){const L=re.deepClone(F);if(J.type==="deepMenu"){const T=re.queryProperty(L,m=>m?.next?{isFind:false,data:m.next}:{isFind:true,data:m});T.next={name:J.text};}k(M,L);}else {const L=Reflect.get(J,"text"),T=Reflect.get(J,"description"),m=[L,T],E=m.findIndex(P=>{if(typeof P=="string")return P.match(C)});if(E!==-1){const P=re.deepClone(F),I=re.queryProperty(P,D=>D?.next?{isFind:false,data:D.next}:{isFind:true,data:D});I.next={name:L,matchedData:{path:"",formConfig:J,matchedText:m[E],description:T}};const N=[];re.queryProperty(P,D=>{const _=D?.name;return typeof _=="string"&&_.trim()!==""&&N.push(_),D?.next?{isFind:false,data:D.next}:{isFind:true,data:D}});const Q=N.join(ie.escapeHtml(" - "));I.next.matchedData.path=Q,v.push(P);}}}};for(let U=0;U<t.length;U++){const F=t[U];if(!F.forms||F.isBottom&&F.id==="script-version")continue;const K=F.forms;if(K&&Array.isArray(K)){let J=F.title;typeof J=="function"&&(J=J()),k(K,{index:U,name:J});}}const H=document.createDocumentFragment();for(const U of v){let F=w(U);H.appendChild(F);}x(),y.append(H);};b.on(g,"input",re.debounce(S=>{b.preventEvent(S);let C=b.val(g).trim();if(C===""){x();return}A(C);},200));};e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(u=>{b.on(u,"dblclick",s);});let l=null,c=false,f,d=false;b.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(u,h)=>{d=true,clearTimeout(f),f=void 0,c&&l===h?(c=false,l=null,s(u)):(f=setTimeout(()=>{c=false;},200),c=true,l=h);},{capture:true}),e.$shadowRoot.appendChild(b.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
			...
			`;}),b.html(a,t);},setTag(a,e,t){ee.clearTag(a),b.addClass(a,e),typeof t=="string"&&b.html(a,t);},clearTag(a){Object.keys(vr).forEach(e=>{b.removeClass(a,e);});}},$=a=>({type:"own",getLiElementCallBack(t){let n=b.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
				...
				`});return t.appendChild(n),t},async afterAddToUListCallBack(t,n){let r=n.target,o=r.querySelector(".pops-panel-item-left-text"),s=r.querySelector(".pops-panel-item-left-main-text"),i=r.querySelector(".pops-panel-item-left-desc-text"),l=await a();l.tag==null?b.html(s,l.text):b.html(s,vr[l.tag]+l.text),(l.description==null||l.description==="")&&b.hide(i,false),b.html(i,l.description||"");let c=["support-info"];if(l.tag!=null&&c.push(l.tag),b.addClass(s,c),typeof l.afterRender=="function")try{l.afterRender({...n,$leftContainer:o,$leftText:s,$leftDesc:i});}catch(f){console.log(f),ee.setTag(s,"error","afterRender 函数执行错误"+f);}}}),G={asideLastVisit:"aside-last-visit"},ni={getWindow(){return Te.unsafeWindow.isSupport()?ve:window}};class ri{}class Nt extends ri{isSupportGM(){return typeof V=="object"&&V!=null}}class ce extends Nt{}const se={getApiDocUrl(a,e){return e=e??a,`<a href="https://www.tampermonkey.net/documentation.php?ext=gcal&version=#api:${a}" target="_blank">${e}</a>`}};class oi extends ce{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof V.addElement=="function"}}isSupport(){return typeof ln=="function"}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(ln,this,r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.addElement,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push($(async()=>{let s=null,i=null,l=ni.getWindow(),c=o+"_test_script_exec",f=`${c}_test_str`;try{return s=await r.fn("script",{id:c,textContent:`window["${f}"] = "bar";`}),i=document.querySelector("#"+c),s==null?{text:`${r.name} returns is null`,tag:"error"}:s instanceof HTMLElement?typeof l[f]!="string"?{text:`${r.name} script element is not work`,tag:"error"}:(Reflect.deleteProperty(l,f),{text:ie.escapeHtml("支持添加<script>元素且执行js"),tag:"success"}):{text:`${r.name} returns is not style element`,tag:"error"}}catch(d){return console.error(d),{text:"执行错误 "+d,tag:"error"}}finally{i&&i.remove();}}),$(async()=>{let s=null,i=null,l=o+"_test2";try{if(s=await r.fn(document.body,"div",{"data-src":"https://example.com/image.png",id:l}),s==null)return {text:r.name+" returns is null",tag:"error"};if(!(s instanceof HTMLElement))return {text:r.name+" returns is not style element",tag:"error"};if(i=document.querySelector("#"+l),!i)return {text:"不支持3个参数",tag:"error"};const c=i.attachShadow({mode:"closed"});return await r.fn(c,"style",{textContent:"div { color: black; };"}),c.querySelector("style")?s==null?{text:"传入3个参数但是返回为空",tag:"error"}:i.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(c){return console.error(c),{text:"执行错误 "+c,tag:"error"}}finally{i&&i.remove();}}));}),n}}class ai extends ce{isSupport(){return typeof cn=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof V.addStyle=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-GM_addStyle"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(cn,this,r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.addStyle,formList:n.forms[2].forms}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push($(async()=>{let s=null,i=null;try{return s=b.createElement("div",{id:o,innerText:o+" test"}),document.body.appendChild(s),i=await r.fn(`
						...
						`),i==null?{text:`${r.name} returns is null`,tag:"error"}:i instanceof HTMLStyleElement?window.getComputedStyle(s).backgroundColor!=="rgb(255, 0, 0)"?{text:`${r.name} test element background is not rgb(255, 0, 0)`,tag:"error"}:{text:ie.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}:{text:`${r.name} returns is not HTMLStyleElement`,tag:"error"}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}finally{s?.remove(),i?.remove();}}));}),n}}class si extends ce{isSupport(){return typeof zt=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof V.addValueChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=zt(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.addValueChangeListener,formList:n.forms[2].forms}].forEach(r=>{let o=r.name;r.formList.push((()=>{let s=o+"_key_1";return $(()=>({text:"测试监听数据存储改变",description:"",tag:"info",afterRender(i){let l=b.toElement(`
									...
									`,false,false);b.after(s.$leftContainer,i),b.on(i,"click",async l=>{b.preventEvent(l);try{ft(o);let c=Object.keys(o),f=Ct(c);if(JSON.stringify(f)!==JSON.stringify(o)){R.error("写入失败，写入的数据和读取的数据不相同");return}await r.fn(c);let d=Ct(c);d==null?R.warning("删除情况未知，因为读取到的数据为null"):typeof d=="object"&&JSON.stringify(d)==="{}"?R.success("删除成功，读取的数据为{}"):(R.error("删除情况未知，因为读取到的数据类型不是object"),console.log(d));}catch(c){R.error(c.toString(),{consoleLogContent:true});}});}}))})());}),n}}class fi extends ce{isSupport(){return typeof Ar=="function"}getApiName(){return "GM_download"}getAsyncApiOption(){return {name:"GM.download",isSupport:this.isSupportGM()&&typeof V.download=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>({text:ie.escapeHtml("TODO"),tag:"info",afterRender(r){r.target?.querySelector(".support-info");}}))),n}}class di extends ce{isSupport(){return typeof At=="function"}getApiName(){return "GM_getResourceText"}getAsyncApiOption(){return {name:"GM.getResourceText",isSupport:this.isSupportGM()&&typeof V.getResourceText=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=At(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.getResourceText,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(async()=>{try{return typeof await r.fn("ViewerCSS")=="string"?{text:ie.escapeHtml("支持通过@resource引用资源字符串"),tag:"success"}:{text:ie.escapeHtml(r.name+" return is not string"),tag:"error"}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class pi extends ce{isSupport(){return typeof dn=="function"}getApiName(){return "GM_getResourceURL"}getAsyncApiOption(){return {name:"GM.getResourceUrl",isSupport:this.isSupportGM()&&typeof V.getResourceUrl=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(dn,this,r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.getResourceUrl,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(async()=>{try{let o=await r.fn("ViewerCSS");return typeof o!="string"?{text:ie.escapeHtml(`${r.name} return is not string`),tag:"error"}:(o=o.trim(),o.startsWith("data:text/css;base64")?o.startsWith("data:text/css;base64,LyohCiAqIFZpZXdlci5qcyB2MS4xMS43CiAqIGh0dHBzOi8vZmVuZ3")?{text:ie.escapeHtml("支持通过@resource引用资源并进行base64编码"),tag:"success"}:{text:ie.escapeHtml("支持通过@resource引用资源并进行base64编码，但是base64编码的实现方式不同"),tag:"warn"}:{text:ie.escapeHtml("支持通过@resource引用资源，但是未对资源进行base64编码"),tag:"warn"})}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class ui extends ce{isSupport(){return typeof pn=="function"}getApiName(){return "GM_getTab"}getAsyncApiOption(){return {name:"GM.getTab",isSupport:this.isSupportGM()&&typeof V.getTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async()=>new Promise(r=>{pn((...o)=>{r(...o);});}),formList:n.forms[1].forms},{name:t.name,fn:V.getTab,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(()=>({text:"测试获取当前Tab",description:"",tag:"info",afterRender(o){let s=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);b.after(o.$leftContainer,s);let i;b.on(s,"click",async l=>{b.preventEvent(l);try{clearTimeout(i),ee.setTag(o.$leftText,"error","等待3s内触发回调函数"),i=Me(()=>{ee.setTag(o.$leftText,"error","超时，不支持触发回调函数");},3e3);let c=await r.fn();clearTimeout(i),console.log(r.name+" callback tab",c),typeof c=="object"&&c!=null?ee.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"success",text:"入参tab为object类型"}]):ee.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"error",text:"入参tab不为object类型"}]),alert(JSON.stringify(c));}catch(c){R.error(c.toString(),{consoleLogContent:true});}});}})));}),n}}class bi extends ce{isSupport(){return typeof un=="function"}getApiName(){return "GM_getTabs"}getAsyncApiOption(){return {name:"GM.getTabs",isSupport:this.isSupportGM()&&typeof V.getTabs=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async()=>new Promise(r=>{un((...o)=>{r(...o);});}),formList:n.forms[1].forms},{name:t.name,fn:V.getTabs,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(()=>({text:"测试获取所有Tab",description:"",tag:"info",afterRender(o){let s=b.toElement(`
								<div class="pops-panel-button pops-panel-button-no-icon">
									<button class="pops-panel-button_inner" type="button" data-type="default">
										<i class="pops-bottom-icon" is-loading="false"></i>
										<span class="pops-panel-button-text">点击测试</span>
							...
							"${o}-test-key-2": 2,
									...
									`,false,false);b.after(i.$leftContainer,l),b.on(l,"click",async c=>{b.preventEvent(c);try{ft(s);let f=Object.keys(s),d=await r.fn(f);console.log(d),d==null?R.error("读取失败，读取的数据为null"):JSON.stringify(d)===JSON.stringify(s)?R.success("读取成功，写入的数据和读取的数据相同"):R.error("读取成功，但写入的数据和读取的数据不同");}catch(f){R.error(f.toString(),{consoleLogContent:true});}});}}))})());}),n}}class gi extends ce{isSupport(){return typeof Ge=="object"&&Ge!=null}getApiName(){return "GM_info"}getAsyncApiOption(){return {name:"GM.info",isSupport:this.isSupportGM()&&typeof V.info=="object"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（GM）",forms:[]}]};return this.isSupport()&&[{name:e,fn:Ge,formList:n.forms[1].forms},{name:t.name,fn:V.info,formList:n.forms[2].forms}].forEach(r=>{r.name,r.formList.push(...[{value:r.fn?.downloadMode,type:"string",text:`${r.name}.downloadMode`,notExistsTag:"error"},{value:r.fn?.scriptHandler,type:"string",text:`${r.name}.scriptHandler`},{value:r.fn?.scriptMetaStr,type:"string",text:`${r.name}.scriptMetaStr`},{value:r.fn?.version,type:"string",text:`${r.name}.version`},{value:r.fn?.script,type:"object",text:`${r.name}.script`},{value:r.fn?.script?.name,type:"string",text:`${r.name}.script.name`},{value:r.fn?.script?.author,type:"string",text:`${r.name}.script.author`},{value:r.fn?.script?.description,type:"string",text:`${r.name}.script.description`},{value:r.fn?.script?.version,type:"string",text:`${r.name}.script.version`}].map(o=>$(()=>{try{return o.value!=null&&typeof o.value===o.type?{text:"支持 "+o.text+" 类型："+o.type,tag:"success"}:{text:"不支持 "+o.text+" 类型："+o.type,tag:o.notExistsTag??"error"}}catch(s){return console.error(s),{text:"执行错误 "+s,tag:"error"}}finally{}})));}),n}}class yi extends ce{isSupport(){return typeof it=="function"}getApiName(){return "GM_listValues"}getAsyncApiOption(){return {name:"GM.listValues",isSupport:this.isSupportGM()&&typeof V.listValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=it(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.listValues,formList:n.forms[2].forms}].forEach(r=>{r.name,r.formList.push($(()=>({text:"查看存储的所有键名",tag:"info",afterRender(o){let s=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);b.on(i,"click",async l=>{b.preventEvent(l);try{await r.fn(o);}catch(c){R.error(c.toString(),{consoleLogContent:!0});}}),b.after(s.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class wi extends ce{isSupport(){return typeof hn=="function"}getApiName(){return "GM_notification"}getAsyncApiOption(){return {name:"GM.notification",isSupport:this.isSupportGM()&&typeof V.notification=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async r=>new Promise(o=>{let s=r.onclick,i=hn({...r,onclick(...l){typeof s=="function"&&Reflect.apply(s,this,l),o(i??true);}});}),formList:n.forms[1].forms},{name:t.name,fn:V.notification,formList:n.forms[2].forms}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push($(()=>{try{return {text:ie.escapeHtml("点击通知的内容测试url"),tag:"info",description:"https://example.com/",afterRender(o){let s=o.target,i=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),w,A;b.on(x,"click",async S=>{try{b.preventEvent(S),clearTimeout(w),clearInterval(A);let C=5,v=C,k=()=>{let H=`${v}s后通知的内容将更新为：${d}`;return v--,H};b.text(y.$leftDesc,k()),b.show(y.$leftDesc,!1),w=setTimeout(async()=>{clearInterval(A),b.text(y.$leftDesc,g),r.fn({...h,text:d});},C*1e3),A=setInterval(()=>{b.text(y.$leftDesc,k());},1e3),await r.fn(h);}catch(C){R.error(C.toString(),{consoleLogContent:!0});}}),b.after(s,x);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class vi extends ce{isSupport(){return typeof mn=="function"}getApiName(){return "GM_openInTab"}getAsyncApiOption(){return {name:"GM.openInTab",isSupport:this.isSupportGM()&&typeof V.openInTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=mn(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.openInTab,formList:n.forms[2].forms}].forEach(r=>{r.formList.push($(()=>{try{return {text:"后台打开：https://www.example.com/",tag:"info",afterRender(o){let s=o.target,i=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
...
`));}catch(g){R.error(g.toString(),{consoleLogContent:!0});}});}catch(f){R.error(f.toString(),{consoleLogContent:!0});}});}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}),$(()=>{try{return {text:"注册并更新菜单 ==> Test Update Menu",description:"请自行验证是否成功更新菜单文字为：Test Update Menu Success!!!",tag:"info",afterRender(o){let s=b.toElement(`
								...
								`,!1,!1);b.after(o.$leftContainer,s);let i;b.on(s,"click",async l=>{try{b.preventEvent(l),clearTimeout(i);const c=await r.fn("Test Update Menu",f=>{});R.info("已注册菜单，3s后自动更新",{timeout:3e3}),clearTimeout(i),i=Me(async()=>{await r.fn("Test Update Menu Success!!!",()=>{},{id:c}),R.success("已执行更新菜单命令，请自行验证");},3e3);}catch(c){R.error(c.toString(),{consoleLogContent:!0});}});}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}finally{}}));}),n}}class Ci extends ce{isSupport(){return typeof gn=="function"}getApiName(){return "GM_removeValueChangeListener"}getAsyncApiOption(){return {name:"GM.removeValueChangeListener",isSupport:this.isSupportGM()&&typeof V.removeValueChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=gn(...r);o(s);}),formList:n.forms[1].forms},{name:t.name,fn:V.removeValueChangeListener,formList:n.forms[2].forms}].forEach(r=>{r.name,r.formList.push((()=>{let o=e+"_key_1";return $(()=>({text:"测试移除监听器",description:"",tag:"info",afterRender(s){let i=b.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);b.after(s.$leftContainer,i);let l=[];b.on(i,"click",async c=>{b.preventEvent(c);try{l.length=0,ee.setTag(s.$leftText,"info","等待移除监听器"),b.text(s.$leftDesc,this.text),b.show(s.$leftDesc,!1);let f=re.formatTime(Date.now()),d=zt(o,function(u,h,g,y){console.log(arguments),l.push({tag:"error",text:"未成功移除监听器"}),ee.setTagList(s.$leftText,l);});await r.fn(d),l.push({tag:"success",text:"支持移除监听器"}),ee.setTagList(s.$leftText,l),Pe(o,f);}catch(f){R.error(f.toString(),{consoleLogContent:true});}});}}))})());}),n}}class Si extends ce{isSupport(){return typeof Cr=="function"}getApiName(){return "GM_saveTab"}getAsyncApiOption(){return {name:"GM.saveTab",isSupport:this.isSupportGM()&&typeof V.saveTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]}]};return this.isSupport()&&n.forms[1].forms.push($(()=>{try{return {text:ie.escapeHtml("TODO"),tag:"info"}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}finally{}})),n}}class Ti extends ce{isSupport(){return typeof yn=="function"}getApiName(){return "GM_setClipboard"}getAsyncApiOption(){return {name:"GM.setClipboard",isSupport:this.isSupportGM()&&typeof V.setClipboard=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(r){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"函数测试",forms:[$(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),$(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"forms",text:"功能测试",forms:[]},{type:"forms",text:"功能测试（异步）",forms:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{if(typeof r[2]=="function"){const s=r[2];r[2]=(...i)=>{s(...i),o(void 0);};}yn(...r);}),formList:n.forms[1].forms},{name:t.name,fn:async(...r)=>{const o=r[2];await V.setClipboard(...r),typeof o=="function"&&o();},formList:n.forms[2].forms}].forEach(r=>{r.formList.push($(()=>({text:"复制内容到剪贴板：Test "+r.name,tag:"info",afterRender(o){let s=b.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
...
`));}else ee.setTag(i.$leftText,"error","返回值类型错误："+typeof f);b.text(i.$leftDesc,this.text),b.show(i.$leftDesc,!1),alert(JSON.stringify(f,null,4));}catch(f){R.error(f.toString(),{consoleLogContent:!0});}}),b.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}finally{}}),$(()=>{try{return {text:ie.escapeHtml("测试监听静音状态改变"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=b.toElement(`
									...
									`,!1,!1),c=!0,f;b.on(l,"click",async d=>{try{b.preventEvent(d);let u=h=>{c=!1,R.error("移除监听器失败");};f=R.loading("处理监听器中..."),await s.addStateChangeListener(u),await s.removeStateChangeListener(u),f.setText("等待500ms，设置当前Tab静音"),await re.sleep(500),await s.setMute({isMuted:!0}),f.setText("等待500ms，设置当前Tab取消静音"),await re.sleep(500),await s.setMute({isMuted:!1}),f.close(),c&&R.success("移除监听器成功");}catch(u){f?.close(),R.error(u.toString(),{consoleLogContent:!0});}}),b.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}finally{}}));}),r}}const Te={unsafeWindow:new $i,GM:new _i,addElement:new oi,addStyle:new ai,download:new fi,getResourceText:new di,getResourceUrl:new pi,info:new gi,log:new xi,notification:new wi,openInTab:new vi,registerMenuCommand:new Ai,unregisterMenuCommand:new Mi,setClipboard:new Ti,getTab:new ui,saveTab:new Si,getTabs:new bi,setValue:new Ei,getValue:new hi,deleteValue:new li,listValues:new yi,setValues:new ki,getValues:new mi,deleteValues:new ci,addValueChangeListener:new si,removeValueChangeListener:new Ci,xmlHttpRequest:new Ii,webRequest:new Li,cookie:new ii,audio:new Ri},Fe={$storageKey:"gm-api-test-storage-config",set(a,e){let t=window.localStorage.getItem(Fe.$storageKey)??"{}",n=re.toJSON(t);n[a]=e,window.localStorage.setItem(Fe.$storageKey,JSON.stringify(n,(r,o)=>typeof o=="function"?o.tString():o));},get(a,e){let t=window.localStorage.getItem(Fe.$storageKey)??"{}";return re.toJSON(t)[a]??e},delete(a){let e=window.localStorage.getItem(Fe.$storageKey)??"{}",t=re.toJSON(e);Reflect.deleteProperty(t,a),window.localStorage.setItem(Fe.$storageKey,JSON.stringify(t,(n,r)=>typeof r=="function"?r.tString():r));}},q={set(a,e){Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?Pe(a,e):Fe.set(a,e);},get(a,e){return Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?qe(a,e):Fe.get(a,e)},delete(a){Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?ct(a):Fe.delete(a);}},Oi=()=>{let a=[],e=[];Object.keys(Te).forEach(n=>{let r=Te[n],o=r.getApiName(),s=r.isSupport(),i=r.getAsyncApiOption();s?a.push({name:o,isSupport:s}):e.push({name:o,isSupport:s}),i&&(i.isSupport?a.push({name:i.name,isSupport:i.isSupport,leftTargetSelector:"#aside-"+o}):e.push({name:i.name,isSupport:i.isSupport,leftTargetSelector:"#aside-"+o}));});let t=n=>{let r=b.createElement("div",{className:"gm-api-features-item",innerHTML:`
			...
			`});return b.on(r,"click",o=>{b.preventEvent(o);let s=r.getRootNode(),i=re.isNotNull(n.leftTargetSelector)?n.leftTargetSelector:"#aside-"+n.name,l=s.querySelector(i);l&&(l.click(),l.scrollIntoView({behavior:"smooth"}));}),r};return {id:"component-common",title:"通用",scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)==="component-common"},clickCallback(n){q.set(G.asideLastVisit,"component-common");},forms:[{type:"forms",text:"@run-at document-start<br>注：注入速度等级越低，注入的速度越快<br>范围：0~4",forms:[$(()=>({text:ie.escapeHtml(st),tag:"info"}))]},{type:"forms",text:"特性",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontSize="1.2em",r.formHeaderDivElement.style.fontWeight="700";},forms:[]},{type:"forms",text:"不支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.color="rgb(216, 30, 6)",r.formHeaderDivElement.style.fontWeight="600",e.length===0&&r.formContainerListElement?.remove();},forms:[{type:"own",getLiElementCallBack(n){let r=b.createElement("div",{className:"gm-api-features-not-support"}),o=document.createDocumentFragment();return e.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n}}]},{type:"forms",text:"支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontWeight="600",a.length===0&&r.formContainerListElement?.remove();},forms:[{type:"own",getLiElementCallBack(n){let r=b.createElement("div",{className:"gm-api-features-support"}),o=document.createDocumentFragment();return a.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n}}]}]}};class Ni extends Nt{getApiName(){return "window.onurlchange "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(n){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"功能测试",forms:[$(()=>{try{return {text:ie.escapeHtml("测试window.onurlchange"),tag:"info",description:"点击按钮进行测试",afterRender(n){let r=b.toElement(`
											...
											`,!1,!1);b.on(r,"click",o=>{b.preventEvent(o);try{Ve.close();}catch(s){R.error(s.toString(),{consoleLogContent:!0});}}),b.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}finally{}})]}]}}}class Bi extends Nt{getApiName(){return "window.focus "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return q.get(G.asideLastVisit)===e},clickCallback(n){q.set(G.asideLastVisit,e);},forms:[{type:"forms",text:"功能测试",forms:[$(()=>{try{return {text:ie.escapeHtml("测试window.focus"),tag:"info",description:"点击按钮执行该函数",afterRender(n){let r=b.toElement(`
											<div class="pops-panel-button pops-panel-button-no-icon">
												<button class="pops-panel-button_inner" type="button" data-type="default">
													<i class="pops-bottom-icon" is-loading="false"></i>
													<span class="pops-panel-button-text">点击执行</span>

...
(function () {
  ...
  function cr(){try{typeof Object.assign!="function"&&(Object.assign=function(...a){const e=Object(a[0]||{});return a.length>1&&[...a].splice(1,a.length-1).forEach(n=>{for(const r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r]);}),e});}catch(a){console.warn("Qmsg CompatibleProcessing Object.assign error",a);}try{"classList"in document.documentElement||Object.defineProperty(HTMLElement.prototype,"classList",{get:function(){const a=this;function e(t){return function(n){const r=a.className.split(/\s+/g),o=r.indexOf(n);t(r,o,n),a.className=r.join(" ");}}return {add:e(function(t,n,r){~n||t.push(r);}),remove:e(function(t,n){~n&&t.splice(n,1);}),toggle:e(function(t,n,r){~n?t.splice(n,1):t.push(r);}),contains:function(t){return !!~a.className.split(/\s+/g).indexOf(t)},item:function(t){return a.className.split(/\s+/g)[t]||null}}}});}catch(a){console.warn("Qmsg CompatibleProcessing HTMLElement.prototype.classList warning",a);}}const xe={INS_DEFAULT:{},get PLUGIN_NAME(){return "qmsg"},get NAMESPACE(){return "qmsg"},get config(){return {parent:document.body||document.documentElement,useShadowRoot:true,shadowRootMode:"open",animation:true,autoClose:true,listenEventToPauseAutoClose:true,listenEventToCloseInstance:true,content:"",isHTML:false,position:"top",showClose:false,maxNums:5,onClose:null,showIcon:true,showReverse:false,timeout:2500,type:"info",zIndex:5e4,style:"",customClass:"",isLimitWidth:false,limitWidthNum:200,limitWidthWrap:"no-wrap",consoleLogContent:false,afterRender:null}}},pr=`
	<svg width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		</svg>`},Ce={insInfoList:[],remove(a){let e=false;for(let t=0;t<Ce.insInfoList.length;t++)if(Ce.insInfoList[t].uuid===a){Ce.insInfoList.splice(t,1),e=true;break}return e}},dr=a=>(e,t)=>(a.set(e,t),t),Xt=Number.MAX_SAFE_INTEGER===void 0?9007199254740991:Number.MAX_SAFE_INTEGER,kn=536870912,Yt=kn*2,fr=(a,e)=>t=>{const n=e.get(t);let r=n===void 0?t.size:n<Yt?n+1:0;if(!t.has(r))return a(t,r);if(t.size<kn){for(;t.has(r);)r=Math.floor(Math.random()*Yt);return a(t,r)}if(t.size>Xt)throw new Error("Congratulations, you created a collection of unique numbers which uses all available integers!");for(;t.has(r);)r=Math.floor(Math.random()*Xt);return a(t,r)},En=new WeakMap,ur=dr(En),Bt=fr(ur,En),br=(a,e,t,n)=>r=>{const o=e(r);return s=>{const i=a(s);s.addEventListener("message",(({data:p})=>{const{id:f}=p;if(f!==null&&i.has(f)){const{reject:b,resolve:h}=i.get(f);i.delete(f),p.error===void 0?h(p.result):b(new Error(p.error.message));}})),n(s)&&s.start();const l=(p,f=null,b=[])=>new Promise((h,m)=>{const x=t(i);i.set(x,{reject:m,resolve:h}),f===null?s.postMessage({id:x,method:p},b):s.postMessage({id:x,method:p,params:f},b);}),c=(p,f,b=[])=>{s.postMessage({id:null,method:p,params:f},b);};let d={};for(const[p,f]of Object.entries(o))d={...d,[p]:f({call:l,notify:c})};return {...d}}},hr=a=>e=>{if(a.has(e))return a.get(e);const t=new Map;return a.set(e,t),t},mr=a=>e=>({...e,connect:({call:t})=>async()=>{const{port1:n,port2:r}=new MessageChannel,o=await t("connect",{port:n},[n]);return a.set(r,o),r},disconnect:({call:t})=>async n=>{const r=a.get(n);if(r===void 0)throw new Error("The given port is not connected.");await t("disconnect",{portId:r});},isSupported:({call:t})=>()=>t("isSupported")}),gr=a=>typeof a.start=="function",yr=br(hr(new WeakMap),mr(new WeakMap),Bt,gr),xr=a=>e=>t=>{typeof a.get(t)=="symbol"&&(a.set(t,null),e(t).then(()=>{a.delete(t);}));},wr=a=>e=>t=>{typeof a.get(t)=="symbol"&&(a.set(t,null),e(t).then(()=>{a.delete(t);}));},vr=(a,e)=>t=>(n,r=0,...o)=>{const s=Symbol(),i=a(e);e.set(i,s);const l=()=>t(r,i).then(()=>{const c=e.get(i);if(c===void 0)throw new Error("The timer is in an undefined state.");c===s&&(n(...o),e.get(i)===s&&l());});return l(),i},Ar=(a,e)=>t=>(n,r=0,...o)=>{const s=Symbol(),i=a(e);return e.set(i,s),t(r,i).then(()=>{const l=e.get(i);if(l===void 0)throw new Error("The timer is in an undefined state.");l===s&&(e.delete(i),n(...o));}),i},$n=new Map([[0,null]]),Mn=new Map([[0,null]]),Sr=xr($n),Cr=wr(Mn),Tr=vr(Bt,$n),kr=Ar(Bt,Mn),Er=yr({clearInterval:({call:a})=>Sr(e=>a("clear",{timerId:e,timerType:"interval"})),clearTimeout:({call:a})=>Cr(e=>a("clear",{timerId:e,timerType:"timeout"})),setInterval:({call:a})=>Tr((e,t)=>a("set",{delay:e,now:performance.timeOrigin+performance.now(),timerId:t,timerType:"interval"})),setTimeout:({call:a})=>kr((e,t)=>a("set",{delay:e,now:performance.timeOrigin+performance.now(),timerId:t,timerType:"timeout"}))}),$r=a=>{const e=new Worker(a);return Er(e)},Mr=(a,e)=>{let t=null;return ()=>{if(t!==null)return t;const n=new Blob([e],{type:"application/javascript; charset=utf-8"}),r=URL.createObjectURL(n);return t=a(r),setTimeout(()=>URL.revokeObjectURL(r)),t}},Lr=`(()=>{var e={455(e,t){!function(e){"use strict";var t=function(e){return function(t){var r=e(t);return t.add(r),r}},r=function(e){return function(t,r){return e.set(t,r),r}},n=void 0===Number.MAX_SAFE_INTEGER?9007199254740991:Number.MAX_SAFE_INTEGER,o=536870912,s=2*o,a=function(e,t){return function(r){var a=t.get(r),i=void 0===a?r.size:a<s?a+1:0;if(!r.has(i))return e(r,i);if(r.size<o){for(;r.has(i);)i=Math.floor(Math.random()*s);return e(r,i)}if(r.size>n)throw new Error("Congratulations, you created a collection of unique numbers which uses all available integers!");for(;r.has(i);)i=Math.floor(Math.random()*n);return e(r,i)}},i=new WeakMap,u=r(i),c=a(u,i),l=t(c);e.addUniqueNumber=l,e.generateUniqueNumber=c}(t)}},t={};function r(n){var o=t[n];if(void 0!==o)return o.exports;var s=t[n]={exports:{}};return e[n].call(s.exports,s,s.exports,r),s.exports}(()=>{"use strict";const e=-32603,t=-32602,n=-32601,o=(e,t)=>Object.assign(new Error(e),{status:t}),s=t=>o('The handler of the method called "'.concat(t,'" returned an unexpected result.'),e),a=(t,r)=>async({data:{id:a,method:i,params:u}})=>{const c=r[i];try{if(void 0===c)throw(e=>o('The requested method called "'.concat(e,'" is not supported.'),n))(i);const r=void 0===u?c():c(u);if(void 0===r)throw(t=>o('The handler of the method called "'.concat(t,'" returned no required result.'),e))(i);const l=r instanceof Promise?await r:r;if(null===a){if(void 0!==l.result)throw s(i)}else{if(void 0===l.result)throw s(i);const{result:e,transferables:r=[]}=l;t.postMessage({id:a,result:e},r)}}catch(e){const{message:r,status:n=-32603}=e;t.postMessage({error:{code:n,message:r},id:a})}};var i=r(455);const u=new Map,c=(e,r,n)=>({...r,connect:({port:t})=>{t.start();const n=e(t,r),o=(0,i.generateUniqueNumber)(u);return u.set(o,()=>{n(),t.close(),u.delete(o)}),{result:o}},disconnect:({portId:e})=>{const r=u.get(e);if(void 0===r)throw(e=>o('The specified parameter called "portId" with the given value "'.concat(e,'" does not identify a port connected to this worker.'),t))(e);return r(),{result:null}},isSupported:async()=>{if(await new Promise(e=>{const t=new ArrayBuffer(0),{port1:r,port2:n}=new MessageChannel;r.onmessage=({data:t})=>e(null!==t),n.postMessage(t,[t])})){const e=n();return{result:e instanceof Promise?await e:e}}return{result:!1}}}),l=(e,t,r=()=>!0)=>{const n=c(l,t,r),o=a(e,n);return e.addEventListener("message",o),()=>e.removeEventListener("message",o)},d=(e,t)=>r=>{const n=t.get(r);if(void 0===n)return Promise.resolve(!1);const[o,s]=n;return e(o),t.delete(r),s(!1),Promise.resolve(!0)},m=(e,t,r,n)=>(o,s,a)=>{const i=o+s-t.timeOrigin,u=i-t.now();return new Promise(t=>{e.set(a,[r(n,u,i,e,t,a),t])})},f=new Map,h=d(globalThis.clearTimeout,f),p=new Map,v=d(globalThis.clearTimeout,p),w=((e,t)=>{const r=(n,o,s,a)=>{const i=n-e.now();i>0?o.set(a,[t(r,i,n,o,s,a),s]):(o.delete(a),s(!0))};return r})(performance,globalThis.setTimeout),g=m(f,performance,globalThis.setTimeout,w),T=m(p,performance,globalThis.setTimeout,w);l(self,{clear:async({timerId:e,timerType:t})=>({result:await("interval"===t?h(e):v(e))}),set:async({delay:e,now:t,timerId:r,timerType:n})=>({result:await("interval"===n?g:T)(e,t,r)})})})()})();`,xt=Mr($r,Lr),Ir=a=>xt().clearInterval(a),_r=a=>xt().clearTimeout(a),Rr=(...a)=>xt().setInterval(...a),Nr=(...a)=>xt().setTimeout(...a),ie={toStr(a){return JSON.stringify(a,(e,t)=>typeof t=="object"&&t!=null&&t instanceof Node?String(t):t)},getNameSpacify(...a){return [xe.NAMESPACE,...a].join("-")},isNumber(a){return /^\d+$/.test(a)},getUUID(){return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){const e=Math.random()*16|0;return (a=="x"?e:e&3|8).toString(16)})},mergeArgs(a="",e){const t={};if(arguments.length===0)return t;if(e!=null){if(t.content=a,typeof e=="object"&&e!=null)return Object.assign(t,e)}else {if(typeof a=="object"&&a!=null)return Object.assign(t,a);t.content=a;}return t},toDynamicObject(a,...e){const t=Object.assign({},a??{});return Object.keys(t).forEach(n=>{let r=t[n];Object.defineProperty(t,n,{get(){const o=e.findIndex(s=>typeof s=="object"&&s!=null&&s.hasOwnProperty.call(s,n));return o!==-1?e[o][n]:r},set(o){r=o;}});}),t},setTimeout(a,e){try{return Nr(a,e)}catch{return globalThis.setTimeout(a,e)}},clearTimeout(a){try{a!=null&&_r(a);}catch{}finally{globalThis.clearTimeout(a);}},setInterval(a,e){try{return Rr(a,e)}catch{return globalThis.setInterval(a,e)}},clearInterval(a){try{a!=null&&Ir(a);}catch{}finally{globalThis.clearInterval(a);}},setSafeHTML(a,e){try{a.innerHTML=e;}catch{if(globalThis.trustedTypes){const t=globalThis.trustedTypes.createPolicy("safe-innerHTML",{createHTML:n=>n});a.innerHTML=t.createHTML(e);}else throw new Error("QmsgUtils trustedTypes is not defined")}}},_e={$state:{opening:"MessageMoveIn",done:"",closing:"MessageMoveOut"},$name:{startNameList:["animationName","WebkitAnimationName","MozAnimationName","msAnimationName","OAnimationName"],endNameList:["animationend","webkitAnimationEnd","mozAnimationEnd","MSAnimationEnd","oanimationend"]},__CAN_ANIMATION__:void 0,get CAN_ANIMATION(){return this.__CAN_ANIMATION__=this.__CAN_ANIMATION__??this.getStyleAnimationNameValue(document.createElement("div"))!=null,this.__CAN_ANIMATION__},getStyleAnimationNameValue(a){for(let e=0;e<this.$name.startNameList.length;e++){const t=this.$name.startNameList[e],n=a.style[t];if(n!=null)return n}},setStyleAnimationName(a,e=""){this.$name.startNameList.forEach(t=>{t in a.style&&(a.style[t]=e);});}},Dr=`@charset "utf-8";\r
.qmsg.qmsg-wrapper {\r
  position: fixed;\r
  top: 16px;\r
  left: 0;\r
...
`,Ln={css:`
    ...
    ${Or}
  `,getStyleElement(){const a=document.createElement("style");return a.setAttribute("type","text/css"),a.setAttribute("data-type",xe.PLUGIN_NAME),ie.setSafeHTML(a,Ln.css),a}};class Pr{timeId=void 0;startTime;endTime;setting;settingStr;settingJSON;uuid;state;repeatNum;$el={$item:null,get $content(){const e=this.$item.querySelector('[class^="qmsg-content-"] .qmsg-content-text');if(!e)throw new TypeError("QmsgInst $content is null");return e}};constructor(e,t){this.timeId=void 0,this.startTime=Date.now(),this.endTime=null,this.setting=ie.toDynamicObject(xe.config,e,xe.INS_DEFAULT),this.settingStr=ie.toStr(this.setting),this.settingJSON=Object.assign({},this.setting),this.uuid=t,this.state="opening",this.$el.$item=document.createElement("div"),this.repeatNum=1,this.detectionType(),this.initEl(),(typeof this.setting.consoleLogContent=="function"?this.setting.consoleLogContent(this):this.setting.consoleLogContent)&&console.log(this.setting.content),Reflect.set(this.$el.$item,"data-inst",this),typeof this.setting.afterRender=="function"&&this.setting.afterRender(this);}initEl(){const e=this;this.setting.customClass&&typeof this.setting.customClass=="string"&&this.$el.$item.classList.add(this.setting.customClass);const t=Tn[this.setting.type||"info"];let n=ie.getNameSpacify("content-"+this.setting.type||"info");this.setting.showClose&&(n+=" "+ie.getNameSpacify("content-with-close"));const r=this.setting.content||"",o=pr;let s="";this.setting.showClose&&(s=`<i class="qmsg-icon qmsg-icon-close">${o}</i>`);const i=document.createElement("span");i.className="qmsg-content-text";const l=ie.getNameSpacify("data-position",this.setting.position.toLowerCase());if(this.setting.isHTML?ie.setSafeHTML(i,r):i.innerText=r,this.setting.isLimitWidth){let x=this.setting.limitWidthNum;typeof x=="string"?ie.isNumber(x)&&(x=x+"px"):x=x.toString()+"px",i.style.maxWidth=x,i.style.width=x,i.setAttribute("data-limitWidthWrap",this.setting.limitWidthWrap);}else i.setAttribute("data-limitWidthWrap","no-wrap");ie.setSafeHTML(this.$el.$item,`
			...
			`);const d=this.$el.$item.querySelector(".qmsg-content-wrapper");this.$el.$item.classList.add(ie.getNameSpacify("item")),this.$el.$item.setAttribute(ie.getNameSpacify("uuid"),this.uuid);let p,f,b;if(p=document.querySelector(".qmsg-shadow-container"),f=this.setting.useShadowRoot?p?.shadowRoot:p,!p){if(p=document.createElement("div"),p.className="qmsg-shadow-container",this.setting.useShadowRoot?f=p.attachShadow({mode:this.setting.shadowRootMode}):f=p,f.appendChild(Ln.getStyleElement()),this.setting.style!=null){const x=document.createElement("style");x.setAttribute("type","text/css"),x.setAttribute("data-id",this.uuid),ie.setSafeHTML(x,this.setting.style),d.insertAdjacentElement("afterend",x);}this.setting.parent.appendChild(p);}if(f==null)throw new TypeError("QmsgInst "+xe.PLUGIN_NAME+" $shadowRoot is null");b=f.querySelector(`.${xe.NAMESPACE}.${ie.getNameSpacify("wrapper")}.${l}`),b||(b=document.createElement("div"),b.classList.add(xe.NAMESPACE,ie.getNameSpacify("wrapper"),ie.getNameSpacify("is-initialized"),l),f.appendChild(b)),this.setting.showReverse?b.style.flexDirection="column-reverse":b.style.flexDirection="column";let h=this.setting.zIndex;if(typeof h=="function"&&(h=h()),isNaN(h)||(b.style.zIndex=h.toString()),b.appendChild(this.$el.$item),this.setState(this.$el.$item,"opening"),this.setting.showClose){const x=this.$el.$item.querySelector(".qmsg-icon-close");x&&x.addEventListener("click",()=>{e.close();});}const m=()=>{_e.getStyleAnimationNameValue(e.$el.$item)===_e.$state.closing&&(e.endTime=Date.now(),e.destroy()),_e.setStyleAnimationName(this.$el.$item);};if(_e.$name.endNameList.forEach(function(x){e.$el.$item.addEventListener(x,m);}),this.setting.autoClose&&this.setting.listenEventToPauseAutoClose){this.resetAutoCloseTimer();const x=()=>{this.clearAutoCloseTimer();},A=()=>{if(this.timeId!=null){console.warn("QmsgInst timeId is not null，mouseenter may be not first trigger，timeId："+this.timeId);return}this.startAutoCloseTimer();};let v=false;this.$el.$item.addEventListener("mouseenter",x),this.$el.$item.addEventListener("mouseleave",A),this.$el.$item.addEventListener("touchstart",()=>{v||(v=true,this.$el.$item.removeEventListener("mouseenter",x),this.$el.$item.removeEventListener("mouseleave",A)),x();},{passive:true}),this.$el.$item.addEventListener("touchend",A),this.$el.$item.addEventListener("touchcancel",A);}}detectionType(){this.setting.timeout!=null&&typeof this.setting.timeout=="string"&&(this.setting.timeout=parseInt(this.setting.timeout)),isNaN(this.setting.timeout)&&(this.setting.timeout=xe.config.timeout),this.setting.timeout!=null&&parseInt(this.setting.timeout.toString())>=0&&parseInt(this.setting.timeout.toString())<=Number.MAX_VALUE||(this.setting.timeout=xe.config.timeout),typeof this.setting.zIndex=="function"&&(this.setting.zIndex=this.setting.zIndex()),this.setting.zIndex!=null&&typeof this.setting.zIndex=="string"&&(this.setting.zIndex=parseInt(this.setting.zIndex)),isNaN(this.setting.zIndex)&&(this.setting.zIndex=typeof xe.config.zIndex=="function"?xe.config.zIndex():xe.config.zIndex);}setState(e,t){!t||!_e.$state[t]||(this.state=t,_e.setStyleAnimationName(e,_e.$state[t]));}setRepeatNumIncreasing(){this.repeatNum++;}setMsgCount(){const e=ie.getNameSpacify("count"),t=this.$el.$item.querySelector(`.${xe.NAMESPACE}.${ie.getNameSpacify("wrapper")} [class^="qmsg-content-"]`);if(!t)throw new TypeError("QmsgInst $content is null");let n=t.querySelector("."+e);n||(n=document.createElement("span"),n.classList.add(e),t.appendChild(n));const r=this.repeatNum;ie.setSafeHTML(n,r.toString()),_e.setStyleAnimationName(n),_e.setStyleAnimationName(n,"MessageShake"),this.resetAutoCloseTimer();}clearAutoCloseTimer(){ie.clearTimeout(this.timeId),this.timeId=void 0,this.startTime=null,this.endTime=null;}startAutoCloseTimer(){this.setting.autoClose&&this.setting.listenEventToPauseAutoClose&&(this.startTime=Date.now(),this.endTime=null,this.timeId=ie.setTimeout(()=>{this.close();},this.setting.timeout));}resetAutoCloseTimer(){this.clearAutoCloseTimer(),this.startAutoCloseTimer();}close(){this.setState(this.$el.$item,"closing"),_e.CAN_ANIMATION?Ce.remove(this.uuid):this.destroy();const e=this.setting.onClose;e&&typeof e=="function"&&e.call(this);}destroy(){this.endTime=Date.now(),this.$el.$item.remove(),ie.clearTimeout(this.timeId),Ce.remove(this.uuid),this.timeId=void 0;}setText(e){const t=this.$el.$content;t.innerText=e,this.setting.content=e;}setHTML(e){const t=this.$el.$content;ie.setSafeHTML(t,e),this.setting.content=e;}}function at(a={}){const e=ie.toStr(a),t=ie.toDynamicObject(xe.config,a,xe.INS_DEFAULT),n=ie.toStr(t);let r=Ce.insInfoList.find(s=>s.configStr===e&&s.inst.settingStr===n),o=r?.inst;if(o==null){const s=ie.getUUID(),i=new Pr(t,s),l={uuid:s,configStr:e,inst:i};Ce.insInfoList.push(l);const c=Ce.insInfoList.length,d=l.inst.setting.maxNums;if(c>d)for(let p=0;p<c-d;p++){const f=Ce.insInfoList[p];f&&f.inst.setting.autoClose&&f.inst.close();}r=l,o=l.inst;}else o.repeatNum?o.repeatNum>=99||o.setRepeatNumIncreasing():o.repeatNum=2,o.setMsgCount();if(o)o.$el.$item.setAttribute("data-count",o?.repeatNum.toString());else throw new Error("QmsgInst is null");return o}const st={visibilitychange:{eventConfig:{callback(){if(document.visibilityState==="visible")for(let a=0;a<Ce.insInfoList.length;a++){const t=Ce.insInfoList[a].inst,n=t.setting,r=Date.now();n.type!=="loading"&&n.autoClose&&typeof t.endTime!="number"&&typeof t.startTime=="number"&&typeof n.timeout=="number"&&r-t.startTime>=n.timeout&&t.close();}},option:{capture:true}},addEvent(){"visibilityState"in document?document.addEventListener("visibilitychange",st.visibilitychange.eventConfig.callback,st.visibilitychange.eventConfig.option):console.error("Qmsg addEvent visibilityState not support");},removeEvent(){document.removeEventListener("visibilitychange",st.visibilitychange.eventConfig.callback,st.visibilitychange.eventConfig.option);}}},Br="1.6.2";cr();class Hr{$data;$eventUtils;constructor(e){this.$data={version:Br,config:xe,icon:Tn,instanceStorage:Ce},this.$eventUtils=st,this.$eventUtils.visibilitychange.addEvent(),this.config(e);}config(e){const t=xe;if(e==null||typeof e!="object")return t.INS_DEFAULT;for(const n in e){if(!Object.hasOwn(e,n))continue;const r=Object.getOwnPropertyDescriptor(e,n);if(r)if("get"in r)Reflect.deleteProperty(t.INS_DEFAULT,n),Object.defineProperty(t.INS_DEFAULT,n,{get:r.get,configurable:true,enumerable:true});else if("value"in r)Reflect.deleteProperty(t.INS_DEFAULT,n),Object.defineProperty(t.INS_DEFAULT,n,{get:()=>r.value,configurable:true,enumerable:true});else throw new TypeError("Qmsg.config: descriptor.get or descriptor.value is null");else Reflect.set(t.INS_DEFAULT,n,e[n]);}return t.INS_DEFAULT}info(e,t){const n=ie.mergeArgs(e,t);return n.type="info",at.call(this,n)}warning(e,t){const n=ie.mergeArgs(e,t);return n.type="warning",at.call(this,n)}success(e,t){const n=ie.mergeArgs(e,t);return n.type="success",at.call(this,n)}error(e,t){const n=ie.mergeArgs(e,t);return n.type="error",at.call(this,n)}loading(e,t){const n=ie.mergeArgs(e,t);return n.type="loading",n.autoClose=false,at.call(this,n)}remove(e){Ce.remove(e);}closeAll(){for(let e=Ce.insInfoList.length-1;e>=0;e--){const t=Ce.insInfoList[e];t&&t.inst&&t.inst.close();}}}const I=new Hr;var U=typeof GM<"u"?GM:void 0,Qt=typeof GM_addElement<"u"?GM_addElement:void 0,Jt=typeof GM_addStyle<"u"?GM_addStyle:void 0,Lt=typeof GM_addValueChangeListener<"u"?GM_addValueChangeListener:void 0,Re=typeof GM_cookie<"u"?GM_cookie:void 0,tt=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Zt=typeof GM_deleteValues<"u"?GM_deleteValues:void 0,en=typeof GM_download<"u"?GM_download:void 0,bt=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,tn=typeof GM_getResourceURL<"u"?GM_getResourceURL:void 0,nn=typeof GM_getTab<"u"?GM_getTab:void 0,rn=typeof GM_getTabs<"u"?GM_getTabs:void 0,qe=typeof GM_getValue<"u"?GM_getValue:void 0,ht=typeof GM_getValues<"u"?GM_getValues:void 0,je=typeof GM_info<"u"?GM_info:void 0,Ze=typeof GM_listValues<"u"?GM_listValues:void 0,on=typeof GM_log<"u"?GM_log:void 0,an=typeof GM_notification<"u"?GM_notification:void 0,sn=typeof GM_openInTab<"u"?GM_openInTab:void 0,mt=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,ln=typeof GM_removeValueChangeListener<"u"?GM_removeValueChangeListener:void 0,Vr=typeof GM_saveTab<"u"?GM_saveTab:void 0,cn=typeof GM_setClipboard<"u"?GM_setClipboard:void 0,Pe=typeof GM_setValue<"u"?GM_setValue:void 0,nt=typeof GM_setValues<"u"?GM_setValues:void 0,It=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Ur=typeof GM_webRequest<"u"?GM_webRequest:void 0,In=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,Ae=typeof GM_audio<"u"?GM_audio:void 0,ue=typeof unsafeWindow<"u"?unsafeWindow:void 0,He=window;const zr="1.9.2";let We=class{defaultApi={document,window,globalThis,self,top,setTimeout:globalThis.setTimeout.bind(globalThis),setInterval:globalThis.setInterval.bind(globalThis),clearTimeout:globalThis.clearTimeout.bind(globalThis),clearInterval:globalThis.clearInterval.bind(globalThis)};api;constructor(e){e&&(e.globalThis==null&&(e.globalThis=e.window),e.self==null&&(e.self=e.window)),e||(e=Object.assign({},this.defaultApi)),this.api=Object.assign({},e);}get document(){return this.api.document}get window(){return this.api.window}get globalThis(){return this.api.globalThis}get self(){return this.api.self}get top(){return this.api.top}get setTimeout(){return this.api.setTimeout}get clearTimeout(){return this.api.clearTimeout}get setInterval(){return this.api.setInterval}get clearInterval(){return this.api.clearInterval}};const P={windowApi:new We({document,window,top,setTimeout:globalThis.setTimeout.bind(globalThis),clearTimeout:globalThis.clearTimeout.bind(globalThis),setInterval:globalThis.setInterval.bind(globalThis),clearInterval:globalThis.clearInterval.bind(globalThis)}),isShow(a){return !!a.getClientRects().length},createSafeHTML(a){return window.trustedTypes?window.trustedTypes.createPolicy("safe-innerHTML",{createHTML:t=>t}).createHTML(a):a},setSafeHTML(a,e){a.innerHTML=this.createSafeHTML(e);},forceShow(a){const e=a.cloneNode(true);return e.setAttribute("style","visibility: hidden !important;display:block !important;"),this.windowApi.document.documentElement.appendChild(e),{recovery(){e.remove();}}},getStyleValue(a,e){let t=null,n=null;a instanceof CSSStyleDeclaration?n=a:(t=a.ownerDocument.defaultView,(!t||!t.opener)&&(t=window),n=t.getComputedStyle(a));const r=parseFloat(n[e]);return isNaN(r)?0:r},isWin(a){return typeof a!="object"||a instanceof Node?false:a===globalThis||a===window||a===self||a===globalThis||a===window||a===self||typeof unsafeWindow<"u"&&a===unsafeWindow?true:a?.Math?.toString()==="[object Math]"},isDOM(a){return a instanceof Node},delete(a,e){if(typeof Reflect=="object"&&Reflect!=null&&Reflect.deleteProperty)return Reflect.deleteProperty(a,e);delete a[e];},isNodeList(a){return Array.isArray(a)||a instanceof NodeList},getAnimationEndNameList(){return ["webkitAnimationEnd","mozAnimationEnd","MSAnimationEnd","oanimationend","animationend"]},getTransitionEndNameList(){return ["webkitTransitionEnd","mozTransitionEnd","MSTransitionEnd","otransitionend","transitionend"]}};class _n{windowApi;constructor(e){this.windowApi=new We(e);}selector(e,t){return this.selectorAll(e,t)[0]}selectorAll(e,t){const n=this;if(t=t||n.windowApi.document,e=e.trim(),e.startsWith("xpath:")){e=e.replace(/^xpath:/i,"");const r=n.windowApi.document.evaluate(e,t,null,XPathResult.ORDERED_NODE_ITERATOR_TYPE,null),o=[];let s=r.iterateNext();for(;s;)o.push(s),s=r.iterateNext();return o}else {if(e.match(/[^\s]{1}:empty$/gi))return e=e.replace(/:empty$/gi,""),Array.from(t.querySelectorAll(e)).filter(r=>r?.innerHTML?.trim()==="");if(e.match(/[^\s]{1}:contains\("(.*)"\)$/i)||e.match(/[^\s]{1}:contains\('(.*)'\)$/i)){const o=e.match(/:contains\(("|')(.*)("|')\)$/i)[2];return e=e.replace(/:contains\(("|')(.*)("|')\)$/gi,""),Array.from(t.querySelectorAll(e)).filter(s=>(s?.textContent||s?.innerText)?.includes(o))}else if(e.match(/[^\s]{1}:regexp\("(.*)"\)$/i)||e.match(/[^\s]{1}:regexp\('(.*)'\)$/i)){let o=e.match(/:regexp\(("|')(.*)("|')\)$/i)[2];const s=o.match(/("|'),[\s]*("|')([igm]{0,3})$/i);let i="";s&&(o=o.replace(/("|'),[\s]*("|')([igm]{0,3})$/gi,""),i=s[3]);const l=new RegExp(o,i);return e=e.replace(/:regexp\(("|')(.*)("|')\)$/gi,""),Array.from(t.querySelectorAll(e)).filter(c=>!!(c?.textContent||c?.innerText)?.match(l))}else return Array.from(t.querySelectorAll(e))}}matches(e,t){if(t=t.trim(),e==null||e instanceof Document)return  false;if(t.match(/[^\s]{1}:empty$/gi))return t=t.replace(/:empty$/gi,""),e.matches(t)&&e?.innerHTML?.trim()==="";if(t.match(/[^\s]{1}:contains\("(.*)"\)$/i)||t.match(/[^\s]{1}:contains\('(.*)'\)$/i)){const r=t.match(/:contains\(("|')(.*)("|')\)$/i)[2];t=t.replace(/:contains\(("|')(.*)("|')\)$/gi,"");let o=e?.textContent||e?.innerText;return typeof o!="string"&&(o=""),e.matches(t)&&o?.includes(r)}else if(t.match(/[^\s]{1}:regexp\("(.*)"\)$/i)||t.match(/[^\s]{1}:regexp\('(.*)'\)$/i)){let r=t.match(/:regexp\(("|')(.*)("|')\)$/i)[2];const o=r.match(/("|'),[\s]*("|')([igm]{0,3})$/i);let s="";o&&(r=r.replace(/("|'),[\s]*("|')([igm]{0,3})$/gi,""),s=o[3]);const i=new RegExp(r,s);t=t.replace(/:regexp\(("|')(.*)("|')\)$/gi,"");let l=e?.textContent||e?.innerText;return typeof l!="string"&&(l=""),e.matches(t)&&!!l?.match(i)}else return e.matches(t)}closest(e,t){if(t=t.trim(),e==null||e instanceof Document)return null;if(t.match(/[^\s]{1}:empty$/gi)){t=t.replace(/:empty$/gi,"");const n=e?.closest(t);return n&&n?.innerHTML?.trim()===""?n:null}else if(t.match(/[^\s]{1}:contains\("(.*)"\)$/i)||t.match(/[^\s]{1}:contains\('(.*)'\)$/i)){const r=t.match(/:contains\(("|')(.*)("|')\)$/i)[2];t=t.replace(/:contains\(("|')(.*)("|')\)$/gi,"");const o=e?.closest(t);if(o){const s=e?.textContent||e?.innerText;if(typeof s=="string"&&s.includes(r))return o}return null}else if(t.match(/[^\s]{1}:regexp\("(.*)"\)$/i)||t.match(/[^\s]{1}:regexp\('(.*)'\)$/i)){let r=t.match(/:regexp\(("|')(.*)("|')\)$/i)[2];const o=r.match(/("|'),[\s]*("|')([igm]{0,3})$/i);let s="";o&&(r=r.replace(/("|'),[\s]*("|')([igm]{0,3})$/gi,""),s=o[3]);const i=new RegExp(r,s);t=t.replace(/:regexp\(("|')(.*)("|')\)$/gi,"");const l=e?.closest(t);if(l){const c=e?.textContent||e?.innerText;if(typeof c=="string"&&c.match(i))return l}return null}else return e?.closest(t)}}const Ne=new _n,Fr=function(a){return a instanceof Node};let jr=class{windowApi;constructor(e){this.windowApi=new We(e);}isJQuery(e){let t=false;if(typeof jQuery=="object"&&e instanceof jQuery&&(t=true),e==null)return  false;if(typeof e=="object"){const n=["add","addBack","addClass","after","ajaxComplete","ajaxError","ajaxSend","ajaxStart","ajaxStop","ajaxSuccess","animate","append","appendTo","attr","before","bind","blur","change","children","clearQueue","click","clone","closest","constructor","contents","contextmenu","css","data","dblclick","delay","delegate","dequeue","each","empty","end","eq","extend","fadeIn","fadeOut","fadeTo","fadeToggle","filter","find","first","focus","focusin","focusout","get","has","hasClass","height","hide","hover","html","index","init","innerHeight","innerWidth","insertAfter","insertBefore","is","jquery","keydown","keypress","keyup","last","load","map","mousedown","mouseenter","mouseleave","mousemove","mouseout","mouseover","mouseup","next","nextAll","not","off","offset","offsetParent","on","one","outerHeight","outerWidth","parent","parents","position","prepend","prependTo","prev","prevAll","prevUntil","promise","prop","pushStack","queue","ready","remove","removeAttr","removeClass","removeData","removeProp","replaceAll","replaceWith","resize","scroll","scrollLeft","scrollTop","select","show","siblings","slice","slideDown","slideToggle","slideUp","sort","splice","text","toArray","toggle","toggleClass","trigger","triggerHandler","unbind","width","wrap"];for(const r of n)if(r in e)t=true;else {t=false;break}}return t}assign(e={},t={},n=false){const r=this;if(Array.isArray(t)&&!t.filter(i=>typeof i=="object").length)return t;if(t==null)return e;e==null&&(e={});let o;n?o=t:o=e;for(const s in o){if(!n&&!(s in t))continue;const i=Reflect.get(e,s),l=Reflect.get(t,s);if(typeof l=="object"&&l!=null&&s in e&&!Fr(l)){let c;Array.isArray(l)?(Array.isArray(i)&&(i.length=0),c=l):c=r.assign(i,l,n),Reflect.set(e,s,c);}else Reflect.set(e,s,l);}return e}mutationObserver(e,t){const n=this,r={callback:()=>{},config:{subtree:void 0,childList:void 0,attributes:void 0,attributeFilter:void 0,attributeOldValue:void 0,characterData:void 0,characterDataOldValue:void 0},immediate:false};t=n.assign(r,t);const o=this.windowApi.window.MutationObserver||this.windowApi.window.webkitMutationObserver||this.windowApi.window.MozMutationObserver,s=new o(function(i,l){typeof t.callback=="function"&&t.callback(i,l);});return Array.isArray(e)||e instanceof NodeList?e.forEach(i=>{s.observe(i,t.config);}):n.isJQuery(e)?e.each((i,l)=>{s.observe(l,t.config);}):s.observe(e,t.config),t.immediate&&typeof t.callback=="function"&&t.callback([],s),s}};const qr=new jr;class Rn extends _n{windowApi;constructor(e){super(e),this.windowApi=new We(e);}wait(e,t,n){const r=this,o=typeof t=="number"?t:0;return new Promise(s=>{const i=qr.mutationObserver(n||r.windowApi.document,{config:{subtree:true,childList:true,attributes:true},immediate:true,callback(l,c){const d=e();d.success&&(typeof c?.disconnect=="function"&&c.disconnect(),s(d.data));}});o>0&&setTimeout(()=>{typeof i?.disconnect=="function"&&i.disconnect(),s(null);},o);})}waitNode(...e){e=e.filter(i=>i!==void 0);const t=this,n=e[0];let r=t.windowApi.document,o=0;if(typeof e[0]!="string"&&!Array.isArray(e[0])&&typeof e[0]!="function")throw new TypeError("DOMUtils.waitNode 第一个参数必须是string|string[]|Function");if(e.length!==1)if(e.length===2){const i=e[1];if(typeof i=="number")o=i;else if(typeof i=="object"&&i instanceof Node)r=i;else throw new TypeError("DOMUtils.waitNode 第二个参数必须是number|Node")}else if(e.length===3){const i=e[1],l=e[2];if(typeof i=="object"&&i instanceof Node)if(r=i,typeof l=="number")o=l;else throw new TypeError("DOMUtils.waitNode 第三个参数必须是number");else throw new TypeError("DOMUtils.waitNode 第二个参数必须是Node")}else throw new TypeError("DOMUtils.waitNode 参数个数错误");function s(){if(Array.isArray(n)){const i=[];for(let l=0;l<n.length;l++){const c=Ne.selector(n[l]);c&&i.push(c);}if(i.length===n.length)return i}else return typeof n=="function"?n():Ne.selector(n,r)}return t.wait(()=>{const i=s();return i?{success:true,data:i}:{success:false,data:i}},o,r)}waitAnyNode(...e){e=e.filter(i=>i!==void 0);const t=this,n=e[0];let r=t.windowApi.document,o=0;if(typeof e[0]!="object"&&!Array.isArray(e[0]))throw new TypeError("DOMUtils.waitAnyNode 第一个参数必须是string[]");if(e.length!==1)if(e.length===2){const i=e[1];if(typeof i=="number")o=i;else if(typeof i=="object"&&i instanceof Node)r=i;else throw new TypeError("DOMUtils.waitAnyNode 第二个参数必须是number|Node")}else if(e.length===3){const i=e[1],l=e[2];if(typeof i=="object"&&i instanceof Node)if(r=i,typeof l=="number")o=l;else throw new TypeError("DOMUtils.waitAnyNode 第三个参数必须是number");else throw new TypeError("DOMUtils.waitAnyNode 第二个参数必须是Node")}else throw new TypeError("DOMUtils.waitAnyNode 参数个数错误");const s=n.map(i=>t.waitNode(i,r,o));return Promise.any(s)}waitNodeList(...e){e=e.filter(i=>i!==void 0);const t=this,n=e[0];let r=t.windowApi.document,o=0;if(typeof e[0]!="string"&&!Array.isArray(e[0]))throw new TypeError("DOMUtils.waitNodeList 第一个参数必须是string|string[]");if(e.length!==1)if(e.length===2){const i=e[1];if(typeof i=="number")o=i;else if(typeof i=="object"&&i instanceof Node)r=i;else throw new TypeError("DOMUtils.waitNodeList 第二个参数必须是number|Node")}else if(e.length===3){const i=e[1],l=e[2];if(typeof i=="object"&&i instanceof Node)if(r=i,typeof l=="number")o=l;else throw new TypeError("DOMUtils.waitNodeList 第三个参数必须是number");else throw new TypeError("DOMUtils.waitNodeList 第二个参数必须是Node")}else throw new TypeError("DOMUtils.waitNodeList 参数个数错误");function s(){if(Array.isArray(n)){const i=[];for(let l=0;l<n.length;l++){const c=Ne.selectorAll(n[l],r);c.length&&i.push(c);}if(i.length===n.length)return i}else {const i=Ne.selectorAll(n,r);if(i.length)return i}}return t.wait(()=>{const i=s();return i?{success:true,data:i}:{success:false,data:i}},o,r)}waitAnyNodeList(...e){e=e.filter(i=>i!==void 0);const t=this,n=e[0];let r=t.windowApi.document,o=0;if(!Array.isArray(e[0]))throw new TypeError("DOMUtils.waitAnyNodeList 第一个参数必须是string[]");if(e.length!==1)if(e.length===2){const i=e[1];if(typeof i=="number")o=i;else if(typeof i=="object"&&i instanceof Node)r=i;else throw new TypeError("DOMUtils.waitAnyNodeList 第二个参数必须是number|Node")}else if(e.length===3){const i=e[1],l=e[2];if(typeof i=="object"&&i instanceof Node)if(r=i,typeof l=="number")o=l;else throw new TypeError("DOMUtils.waitAnyNodeList 第三个参数必须是number");else throw new TypeError("DOMUtils.waitAnyNodeList 第二个参数必须是Node")}else throw new TypeError("DOMUtils.waitAnyNodeList 参数个数错误");const s=n.map(i=>t.waitNodeList(i,r,o));return Promise.any(s)}}new Rn;class Nn extends Rn{windowApi;constructor(e){super(e),this.windowApi=new We(e);}animate(e,t,n=1e3,r=null){const o=this;if(typeof e=="string"&&(e=Ne.selectorAll(e)),e==null)return;if(P.isNodeList(e)){e.forEach(d=>{o.animate(d,t,n,r);});return}if(typeof n!="number"||n<=0)throw new TypeError("duration must be a positive number");if(typeof r!="function"&&r!==void 0)throw new TypeError("callback must be a function or null");if(typeof t!="object"||t===void 0)throw new TypeError("styles must be an object");if(Object.keys(t).length===0)throw new Error("styles must contain at least one property");const s=performance.now(),i={},l={};for(const d in t)i[d]=e.style[d]||o.windowApi.globalThis.getComputedStyle(e)[d],l[d]=t[d];const c=setInterval(function(){let p=(performance.now()-s)/n;p>1&&(p=1);for(const f in t)e.style[f]=i[f]+(l[f]-i[f])*p+"px";p===1&&(clearInterval(c),r&&r());},10);}show(e,t=true){const n=this;if(e!=null)if(typeof e=="string"&&(e=Ne.selectorAll(e)),e instanceof NodeList||e instanceof Array){e=e;for(const r of e)n.show(r,t);}else e=e,e.style.display="",t&&(P.isShow(e)||e.style.setProperty("display","unset","important"));}hide(e,t=true){const n=this;if(e!=null)if(typeof e=="string"&&(e=Ne.selectorAll(e)),e instanceof NodeList||e instanceof Array){e=e;for(const r of e)n.hide(r,t);}else e=e,e.style.display="none",t&&P.isShow(e)&&e.style.setProperty("display","none","important");}fadeIn(e,t=400,n){if(e==null)return;const r=this;if(typeof e=="string"&&(e=Ne.selectorAll(e)),P.isNodeList(e)){e.forEach(l=>{r.fadeIn(l,t,n);});return}e.style.opacity="0",e.style.display="";let o=null,s=null;function i(l){o||(o=l);const c=l-o;e=e,e.style.opacity=Math.min(c/t,1).toString(),c<t?r.windowApi.window.requestAnimationFrame(i):(n&&typeof n=="function"&&n(),r.windowApi.window.cancelAnimationFrame(s));}s=r.windowApi.window.requestAnimationFrame(i);}fadeOut(e,t=400,n){const r=this;if(e==null)return;if(typeof e=="string"&&(e=Ne.selectorAll(e)),P.isNodeList(e)){e.forEach(l=>{r.fadeOut(l,t,n);});return}e.style.opacity="1";let o=null,s=null;function i(l){o||(o=l);const c=l-o;e=e,e.style.opacity=Math.max(1-c/t,0).toString(),c<t?r.windowApi.window.requestAnimationFrame(i):(e.style.display="none",typeof n=="function"&&n(),r.windowApi.window.cancelAnimationFrame(s));}s=r.windowApi.window.requestAnimationFrame(i);}toggle(e,t){const n=this;if(typeof e=="string"&&(e=Ne.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(r=>{n.toggle(r);});return}n.windowApi.globalThis.getComputedStyle(e).getPropertyValue("display")==="none"?n.show(e,t):n.hide(e,t);}}}new Nn;const Xe={domEventSymbol:Symbol("events_"+((1+Math.random())*65536|0).toString(16).substring(1))},Gr={Object:{defineProperty:Object.defineProperty}};class Dn extends Nn{windowApi;constructor(e){super(e),this.windowApi=new We(e);}getAnimationEndNameList(){return P.getAnimationEndNameList()}getTransitionEndNameList(){return P.getTransitionEndNameList()}on(e,t,n,r,o){function s(m,x,A){const v=m[x];return typeof v=="boolean"?(A.capture=v,typeof m[x+1]=="boolean"&&(A.once=m[x+1]),typeof m[x+2]=="boolean"&&(A.passive=m[x+2])):typeof v=="object"&&("capture"in v||"once"in v||"passive"in v||"isComposedPath"in v)&&(A.capture=v.capture,A.once=v.once,A.passive=v.passive,A.isComposedPath=v.isComposedPath),A}const i=this,l=arguments;if(typeof e=="string"&&(e=i.selectorAll(e)),e==null)return {off(){},emit(){}};let c=[];e instanceof NodeList||Array.isArray(e)?c=c.concat(Array.from(e)):c.push(e);let d=[];Array.isArray(t)?d=d.concat(t.filter(m=>typeof m=="string"&&m.toString()!=="")):typeof t=="string"&&(d=d.concat(t.split(" ").filter(m=>m!=="")));let p=[];Array.isArray(n)?p=p.concat(n.filter(m=>typeof m=="string"&&m.toString()!=="")):typeof n=="string"&&p.push(n);let f=r,b={capture:false,once:false,passive:false,isComposedPath:false};typeof n=="function"?(f=n,b=s(l,3,b)):b=s(l,4,b);const h=()=>{b.once&&i.off(e,t,n,r,o);};return c.forEach(m=>{const x=function(A){if(p.length){let v=b.isComposedPath?A.composedPath()[0]:A.target,S=m;if(P.isWin(S)&&S===i.windowApi.document&&(S=i.windowApi.document.documentElement),p.find(w=>{if(i.matches(v,w))return  true;const E=i.closest(v,w);return E&&S?.contains?.(E)?(v=E,true):false})){try{Gr.Object.defineProperty(A,"target",{get(){return v}});}catch{}f.call(v,A,v),h();}}else f.call(m,A),h();};d.forEach(A=>{m.addEventListener(A,x,b);const v=Reflect.get(m,Xe.domEventSymbol)||{};v[A]=v[A]||[],v[A].push({selector:p,option:b,handlerCallBack:x,callback:f}),Reflect.set(m,Xe.domEventSymbol,v);});}),{off:m=>{i.off(c,d,p,f,b,m);},emit:(m,x)=>{i.emit(c,d,m,x);}}}off(e,t,n,r,o,s){function i(x,A,v){const S=x[A];return typeof S=="boolean"?v.capture=S:typeof S=="object"&&S!=null&&"capture"in S&&(v.capture=S.capture),v}const l=this,c=arguments;if(typeof e=="string"&&(e=l.selectorAll(e)),e==null)return;let d=[];e instanceof NodeList||Array.isArray(e)?(e=e,d=d.concat(Array.from(e))):d.push(e);let p=[];Array.isArray(t)?p=p.concat(t.filter(x=>typeof x=="string"&&x.toString()!=="")):typeof t=="string"&&(p=p.concat(t.split(" ").filter(x=>x!=="")));let f=[];Array.isArray(n)?f=f.concat(n.filter(x=>typeof x=="string"&&x.toString()!=="")):typeof n=="string"&&f.push(n);let b=r,h={capture:false};typeof n=="function"?(b=n,h=i(c,3,h)):h=i(c,4,h);let m=false;(c.length===2||c.length===3&&typeof c[2]=="string"||Array.isArray(c[2]))&&(m=true),c.length===5&&typeof c[4]=="function"&&typeof s!="function"&&(s=o),d.forEach(x=>{const A=Reflect.get(x,Xe.domEventSymbol)||{};p.forEach(v=>{const S=A[v]||[],C=typeof s=="function"?S.filter(s):S;for(let w=0;w<C.length;w++){const E=C[w];let B=true;if(B&&b&&E.callback!==b&&(B=false),B&&f.length&&Array.isArray(E.selector)&&JSON.stringify(E.selector)!==JSON.stringify(f)&&(B=false),B&&typeof E.option.capture=="boolean"&&h.capture!==E.option.capture&&(B=false),B||m){x.removeEventListener(v,E.handlerCallBack,E.option);const H=S.findIndex(z=>z===E);H!==-1&&S.splice(H,1);}}S.length===0&&P.delete(A,t);}),Reflect.set(x,Xe.domEventSymbol,A);});}offAll(e,t){if(typeof e=="string"&&(e=this.selectorAll(e)),e==null)return;let r=[];e instanceof NodeList||Array.isArray(e)?r=r.concat(Array.from(e)):r.push(e);let o=[];Array.isArray(t)?o=o.concat(t):typeof t=="string"&&(o=o.concat(t.split(" "))),r.forEach(s=>{[...new Set([...Object.getOwnPropertySymbols(s),Xe.domEventSymbol])].forEach(l=>{if(!l.toString().startsWith("Symbol(events_"))return;const c=Reflect.get(s,l)||{};(o.length?o:Object.keys(c)).forEach(p=>{const f=c[p];if(!f)return;for(const h of f)s.removeEventListener(p,h.handlerCallBack,{capture:h.option.capture});const b=Reflect.get(s,l);P.delete(b,p);});});});}onReady(...e){const t=e[0];let n;const r=this,o=[{target:r.windowApi.document,eventType:"DOMContentLoaded",callback:()=>{s.completed();}},{target:r.windowApi.window,eventType:"load",callback:()=>{s.completed();}}],s={init(){if(e.length===0)return new Promise(i=>{n=i,s.check();});s.check();},check(){s.isReady()?setTimeout(()=>{s.completed();},0):s.onCompleted();},isReady(){try{return r.windowApi.document.readyState==="complete"||r.windowApi.document.readyState!=="loading"&&!r.windowApi.document.documentElement.doScroll}catch{return  false}},completed(){s.offCompleted(),typeof t=="function"&&t(),typeof n=="function"&&n();},onCompleted(){for(const i of o)r.on(i.target,i.eventType,i.callback);},offCompleted(){for(const i of o)r.off(i.target,i.eventType,i.callback);}};return s.init()}emit(e,t,n,r=true){if(typeof e=="string"&&(e=this.selectorAll(e)),e==null)return;let s=[];e instanceof NodeList||Array.isArray(e)?s=s.concat(Array.from(e)):s.push(e);let i=[];Array.isArray(t)?i=t.filter(l=>typeof l=="string"&&l.trim()!==""):typeof t=="string"&&(i=t.split(" ")),s.forEach(l=>{const c=Reflect.get(l,Xe.domEventSymbol)||{};i.forEach(d=>{let p=null;n&&n instanceof Event?p=n:(p=new Event(d),typeof n=="object"&&n!=null&&Object.keys(n).forEach(b=>{const h=Reflect.get(n,b);Reflect.set(p,b,h);})),r==false&&d in c?c[d].forEach(f=>{f.handlerCallBack(p);}):l.dispatchEvent(p);});});}click(e,t,n,r){const o=this;if(typeof e=="string"&&(e=o.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(s=>{o.click(s,t,n,r);});return}t==null?o.emit(e,"click",n,r):o.on(e,"click",null,t);}}blur(e,t,n,r){const o=this;if(typeof e=="string"&&(e=o.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(s=>{o.focus(s,t,n,r);});return}t===null?o.emit(e,"blur",n,r):o.on(e,"blur",null,t);}}focus(e,t,n,r){const o=this;if(typeof e=="string"&&(e=o.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(s=>{o.focus(s,t,n,r);});return}t==null?o.emit(e,"focus",n,r):o.on(e,"focus",null,t);}}onHover(e,t,n){const r=this;if(typeof e=="string"&&(e=r.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(o=>{r.onHover(o,t,n);});return}r.on(e,"mouseenter",null,t,n),r.on(e,"mouseleave",null,t,n);}}onAnimationend(e,t,n){const r=this;if(typeof e=="string"&&(e=r.selector(e)),e==null)return;const o={once:true};Object.assign(o,n||{});const s=P.getAnimationEndNameList();if(r.on(e,s,null,t,o),!o.once)return {off(){r.off(e,s,null,t,o);}}}onTransitionend(e,t,n){const r=this;if(typeof e=="string"&&(e=r.selector(e)),e==null)return;const o={once:true};Object.assign(o,n||{});const s=P.getTransitionEndNameList();if(r.on(e,s,null,t,o),!o.once)return {off(){r.off(e,s,null,t,o);}}}onKeyup(e,t,n){const r=this;if(e!=null){if(typeof e=="string"&&(e=r.selectorAll(e)),P.isNodeList(e)){e.forEach(o=>{r.onKeyup(o,t,n);});return}r.on(e,"keyup",null,t,n);}}onKeydown(e,t,n){const r=this;if(e!=null){if(typeof e=="string"&&(e=r.selectorAll(e)),P.isNodeList(e)){e.forEach(o=>{r.onKeydown(o,t,n);});return}r.on(e,"keydown",null,t,n);}}onKeypress(e,t,n){const r=this;if(e!=null){if(typeof e=="string"&&(e=r.selectorAll(e)),P.isNodeList(e)){e.forEach(o=>{r.onKeypress(o,t,n);});return}r.on(e,"keypress",null,t,n);}}onKeyboard(e,t="keypress",n,r){const o=this;typeof e=="string"&&(e=o.selectorAll(e));const s=function(i){const l=i.key||i.code,c=i.charCode||i.keyCode||i.which,d=[];i.ctrlKey&&d.push("ctrl"),i.altKey&&d.push("alt"),i.metaKey&&d.push("meta"),i.shiftKey&&d.push("shift"),typeof n=="function"&&n(l,c,d,i);};return o.on(e,t,s,r),{removeListen:()=>{o.off(e,t,s,r);}}}onInput(e,t,n){let r=false;const o=async p=>{r||await t(p);},s=()=>{r=true;},i=()=>{r=false,this.emit(e,"input",{isComposite:r});},l=this.on(e,"input",o,n),c=this.on(e,"compositionstart",s,n),d=this.on(e,"compositionend",i,n);return {off:()=>{l.off(),c.off(),d.off();}}}onDoubleClick(...e){const t=e[0];let n,r,o;if(e.length===2)if(typeof e[1]=="function")r=e[1];else throw new TypeError("handler is not a function");else if(e.length===3)typeof e[1]=="function"?(r=e[1],o=e[2]):(n=e[1],r=e[2]);else if(e.length===4)n=e[1],r=e[2],o=e[3];else throw new Error("args length error");let s=null,i=false,l,c=false;const d=200,p=async(h,m)=>{h.type==="dblclick"&&c||await r(h,m);},f=this.on(t,"dblclick",h=>{this.preventEvent(h),p(h,{isDoubleClick:true});},o),b=this.on(t,"pointerup",n,(h,m)=>{this.preventEvent(h),h.pointerType==="touch"&&(c=true),clearTimeout(l),l=void 0,i&&s===m?(i=false,s=null,p(h,{isDoubleClick:true})):(l=setTimeout(()=>{i=false,p(h,{isDoubleClick:false});},d),i=true,s=m);},o);return {off(){s=null,f.off(),b.off();}}}preventEvent(...e){const t=n=>(n?.preventDefault(),n?.stopPropagation(),n?.stopImmediatePropagation(),false);if(e.length===1)return t(e[0]);{const n=e[0];let r=e[1];const o=e[2];typeof r=="string"&&(r=[r]),this.on(n,r,t,{capture:!!o});}}}new Dn;class On extends Dn{windowApi;constructor(e){super(e),this.windowApi=new We(e);}getElementSelector(e){const t=this;if(!e||!e.parentElement)return;if(e.id)return `#${e.id}`;let n=t.getElementSelector(e.parentElement);if(!n)return e.tagName.toLowerCase();if(e.parentElement.querySelectorAll(e.tagName).length>1){const r=Array.prototype.indexOf.call(e.parentElement.children,e)+1;n+=` > ${e.tagName.toLowerCase()}:nth-child(${r})`;}else n+=` > ${e.tagName.toLowerCase()}`;return n}}new On;let Wr=class Pn extends On{constructor(e){super(e);}version=zr;noConflict(){const e=this;return e.windowApi.window.DOMUtils&&P.delete(window,"DOMUtils"),e.windowApi.window.DOMUtils=this,this}attr(e,t,n){const r=this;if(typeof e=="string"&&(e=r.selectorAll(e)),e!=null){if(P.isNodeList(e)){if(n==null)return r.attr(e[0],t,n);e.forEach(o=>{r.attr(o,t,n);});return}if(n==null)return e.getAttribute(t);e.setAttribute(t,n);}}createElement(e,t,n){const r=this,o=r.windowApi.document.createElement(e);return typeof t=="string"?(r.html(o,t),o):(t==null&&(t={}),n==null&&(n={}),Object.keys(t).forEach(s=>{const i=t[s];if(s==="innerHTML"){r.html(o,i);return}o[s]=i;}),Object.keys(n).forEach(s=>{let i=n[s];typeof i=="object"?i=JSON.stringify(i):typeof i=="function"&&(i=i.toString()),o.setAttribute(s,i);}),o)}css(e,t,n){const r=this;function o(i,l){const c=["width","height","top","left","right","bottom","font-size"];return typeof l=="number"&&(l=l.toString()),typeof l=="string"&&c.includes(i)&&l.match(/[0-9]$/gi)&&(l=l+"px"),l}if(typeof e=="string"&&(e=r.selectorAll(e)),e==null)return;if(P.isNodeList(e)){if(typeof t=="string"){if(n==null)return r.css(e[0],t);e.forEach(i=>{r.css(i,t);});return}else if(typeof t=="object"){e.forEach(i=>{r.css(i,t);});return}return}const s=(i,l)=>{typeof l=="string"&&l.trim().endsWith("!important")?(l=l.trim().replace(/!important$/gi,"").trim(),e.style.setProperty(i,l,"important")):(l=o(i,l),e.style.setProperty(i,l));};if(typeof t=="string"){if(n==null)return r.windowApi.globalThis.getComputedStyle(e).getPropertyValue(t);s(t,n);}else if(typeof t=="object")for(const i in t){const l=t[i];s(i,l);}else throw new TypeError("property must be string or object")}text(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e!=null){if(P.isNodeList(e)){if(t==null)return n.text(e[0]);e.forEach(r=>{n.text(r,t);});return}if(t==null)return e.textContent||e.innerText;t instanceof Node&&(t=t.textContent||t.innerText),"textContent"in e?e.textContent=t:"innerText"in e&&(e.innerText=t);}}html(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e!=null){if(P.isNodeList(e)){if(t==null)return n.html(e[0]);e.forEach(r=>{n.html(r,t);});return}if(t==null)return e.innerHTML;t instanceof Element&&(t=t.innerHTML),"innerHTML"in e&&P.setSafeHTML(e,t);}}getTransform(e,t=false){const n=this;let r=0,o=0;if(!(t||!t&&P.isShow(e))){const{recovery:i}=P.forceShow(e),l=n.getTransform(e,true);return i(),l}const s=n.windowApi.globalThis.getComputedStyle(e).transform;if(s!=null&&s!=="none"&&s!==""){const i=s.match(/\((.+)\)/)?.[1].split(",");i?(r=Math.abs(parseInt(i[4])),o=Math.abs(parseInt(i[5]))):(r=0,o=0);}return {transformLeft:r,transformTop:o}}val(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e!=null){if(P.isNodeList(e)){if(t==null)return n.val(e[0]);e.forEach(r=>{n.val(r,t);});return}if(t==null)return e.localName==="input"&&(e.type==="checkbox"||e.type==="radio")?e.checked:e.value;e.localName==="input"&&(e.type==="checkbox"||e.type==="radio")?e.checked=!!t:e.value=t;}}prop(e,t,n){const r=this;if(typeof e=="string"&&(e=r.selectorAll(e)),e!=null){if(P.isNodeList(e)){if(n==null)return r.prop(e[0],t);e.forEach(o=>{r.prop(o,t,n);});return}if(n==null)return Reflect.get(e,t);e instanceof Element&&t==="innerHTML"?r.html(e,n):Reflect.set(e,t,n);}}removeAttr(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(r=>{n.removeAttr(r,t);});return}e.removeAttribute(t);}}removeClass(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(r=>{n.removeClass(r,t);});return}t==null?e.className="":(Array.isArray(t)||(t=t.trim().split(" ")),t.forEach(r=>{e.classList.remove(r);}));}}removeProp(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(r=>{n.removeProp(r,t);});return}P.delete(e,t);}}addClass(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(r=>{n.addClass(r,t);});return}Array.isArray(t)||(t=t.split(" ")),t.forEach(r=>{r.trim()!=""&&e.classList.add(r);});}}hasClass(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e==null)return  false;if(P.isNodeList(e)){let r=true;for(let o=0;o<e.length;o++){const s=e[o];r=r&&n.hasClass(s,t);}return r}if(!e?.classList)return  false;Array.isArray(t)||(t=t.split(" "));for(let r=0;r<t.length;r++){const o=t[r].trim();if(!e.classList.contains(o))return  false}return  true}append(e,...t){if(typeof e=="string"&&(e=this.selectorAll(e)),e==null)return;if(P.isNodeList(e)){e.forEach(o=>{this.append(o,...t);});return}const n=(o,s)=>{o instanceof DocumentFragment?(typeof s=="string"&&(s=this.toElement(s,true,false)),o.appendChild(s)):typeof s=="string"?o.insertAdjacentHTML("beforeend",P.createSafeHTML(s)):o.appendChild(s);},r=this.windowApi.document.createDocumentFragment();t.forEach(o=>{P.isNodeList(o)?o.forEach(s=>{n(r,s);}):n(r,o);}),n(e,r);}prepend(e,...t){if(typeof e=="string"&&(e=this.selectorAll(e)),e==null)return;if(P.isNodeList(e)){e.forEach(o=>{this.prepend(o,...t);});return}const n=(o,s)=>{if(o instanceof DocumentFragment)typeof s=="string"&&(s=this.toElement(s,true,false)),o.appendChild(s);else if(typeof s=="string")o.insertAdjacentHTML("afterbegin",P.createSafeHTML(s));else {const i=o.firstChild;i?o.insertBefore(s,i):o.prepend(s);}},r=this.windowApi.document.createDocumentFragment();t.forEach(o=>{P.isNodeList(o)?o.forEach(s=>{n(r,s);}):n(r,o);}),n(e,r);}after(e,...t){if(typeof e=="string"&&(e=this.selectorAll(e)),e==null)return;if(P.isNodeList(e)){e.forEach(o=>{this.after(o,...t);});return}const n=(o,s)=>{if(o instanceof DocumentFragment)typeof s=="string"&&(s=this.toElement(s,true,false)),o.appendChild(s);else if(typeof s=="string")o.insertAdjacentHTML("afterend",P.createSafeHTML(s));else {const i=e.parentElement,l=e.nextSibling;i&&l?i.insertBefore(s,l):e.after(s);}},r=this.windowApi.document.createDocumentFragment();t.forEach(o=>{P.isNodeList(o)?o.forEach(s=>{n(r,s);}):n(r,o);}),n(e,r);}before(e,...t){if(typeof e=="string"&&(e=this.selectorAll(e)),e==null)return;if(P.isNodeList(e)){e.forEach(o=>{this.before(o,...t);});return}const n=(o,s)=>{if(o instanceof DocumentFragment)typeof s=="string"&&(s=this.toElement(s,true,false)),o.appendChild(s);else if(typeof s=="string")e.insertAdjacentHTML("beforebegin",P.createSafeHTML(s));else {const i=e.parentElement;i?i.insertBefore(s,e):e.before(s);}},r=this.windowApi.document.createDocumentFragment();t.forEach(o=>{P.isNodeList(o)?o.forEach(s=>{n(r,s);}):n(r,o);}),n(e,r);}remove(e){const t=this;if(typeof e=="string"&&(e=t.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(n=>{t.remove(n);});return}typeof e.remove=="function"?e.remove():e.parentElement?e.parentElement.removeChild(e):e.parentNode&&e.parentNode.removeChild(e);}}empty(e){const t=this;if(typeof e=="string"&&(e=t.selectorAll(e)),e!=null){if(P.isNodeList(e)){e.forEach(n=>{t.empty(n);});return}e.innerHTML?e.innerHTML="":e.textContent&&(e.textContent="");}}offset(e){const t=this;if(typeof e=="string"&&(e=t.selector(e)),e==null)return;const n=e.getBoundingClientRect();return {top:n.top+t.windowApi.globalThis.scrollY,left:n.left+t.windowApi.globalThis.scrollX}}width(e,t=false){const n=this;if(typeof e=="string"&&(e=n.selector(e)),P.isWin(e))return n.windowApi.window.document.documentElement.clientWidth;if(e.nodeType===9)return e=e,Math.max(e.body.scrollWidth,e.documentElement.scrollWidth,e.body.offsetWidth,e.documentElement.offsetWidth,e.documentElement.clientWidth);if(t||!t&&P.isShow(e)){if(e=e,parseFloat(P.getStyleValue(e,"width").toString())>0)return parseFloat(P.getStyleValue(e,"width").toString());if(e.offsetWidth>0){const r=P.getStyleValue(e,"borderLeftWidth"),o=P.getStyleValue(e,"borderRightWidth"),s=P.getStyleValue(e,"paddingLeft"),i=P.getStyleValue(e,"paddingRight"),l=parseFloat(e.offsetWidth.toString())-parseFloat(r.toString())-parseFloat(o.toString())-parseFloat(s.toString())-parseFloat(i.toString());return parseFloat(l.toString())}return 0}else {e=e;const{recovery:r}=P.forceShow(e),o=n.width(e,true);return r(),o}}height(e,t=false){const n=this;if(P.isWin(e))return n.windowApi.window.document.documentElement.clientHeight;if(typeof e=="string"&&(e=n.selector(e)),e.nodeType===9)return e=e,Math.max(e.body.scrollHeight,e.documentElement.scrollHeight,e.body.offsetHeight,e.documentElement.offsetHeight,e.documentElement.clientHeight);if(t||!t&&P.isShow(e)){if(e=e,parseFloat(P.getStyleValue(e,"height").toString())>0)return parseFloat(P.getStyleValue(e,"height").toString());if(e.offsetHeight>0){const r=P.getStyleValue(e,"borderTopWidth"),o=P.getStyleValue(e,"borderBottomWidth"),s=P.getStyleValue(e,"paddingTop"),i=P.getStyleValue(e,"paddingBottom"),l=parseFloat(e.offsetHeight.toString())-parseFloat(r.toString())-parseFloat(o.toString())-parseFloat(s.toString())-parseFloat(i.toString());return parseFloat(l.toString())}return 0}else {e=e;const{recovery:r}=P.forceShow(e),o=n.height(e,true);return r(),o}}outerWidth(e,t=false){const n=this;if(P.isWin(e))return n.windowApi.window.innerWidth;if(typeof e=="string"&&(e=n.selector(e)),e=e,t||!t&&P.isShow(e)){const r=n.windowApi.globalThis.getComputedStyle(e,null),o=P.getStyleValue(r,"marginLeft"),s=P.getStyleValue(r,"marginRight");return e.offsetWidth+o+s}else {const{recovery:r}=P.forceShow(e),o=n.outerWidth(e,true);return r(),o}}outerHeight(e,t=false){const n=this;if(P.isWin(e))return n.windowApi.window.innerHeight;if(typeof e=="string"&&(e=n.selector(e)),e=e,t||!t&&P.isShow(e)){const r=n.windowApi.globalThis.getComputedStyle(e,null),o=P.getStyleValue(r,"marginTop"),s=P.getStyleValue(r,"marginBottom");return e.offsetHeight+o+s}else {const{recovery:r}=P.forceShow(e),o=n.outerHeight(e,true);return r(),o}}replaceWith(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e==null)return;if(P.isNodeList(e)){e.forEach(o=>{n.replaceWith(o,t);});return}typeof t=="string"&&(t=n.toElement(t,false,false));const r=e.parentElement;r?r.replaceChild(t,e):(n.after(e,t),e.remove());}wrap(e,t){const n=this;if(typeof e=="string"&&(e=n.selectorAll(e)),e==null)return;if(P.isNodeList(e)){e.forEach(i=>{n.wrap(i,t);});return}e=e;const r=n.windowApi.document.createElement("div");n.html(r,t);const o=r.firstChild;e.parentElement.insertBefore(o,e),o.appendChild(e);}prev(e){if(typeof e=="string"&&(e=this.selector(e)),e!=null)return e.previousElementSibling}next(e){if(typeof e=="string"&&(e=this.selector(e)),e!=null)return e.nextElementSibling}siblings(e){if(typeof e=="string"&&(e=this.selector(e)),e!=null)return Array.from(e.parentElement.children).filter(n=>n!==e)}parent(e){const t=this;if(typeof e=="string"&&(e=t.selector(e)),e!=null)if(P.isNodeList(e)){const n=[];return e.forEach(r=>{n.push(t.parent(r));}),n}else return e.parentElement}toElement(e,t=false,n=false){const r=this;e=e.trim();function o(){const i=new DOMParser;return n?i.parseFromString(e,"text/html"):i.parseFromString(e,"text/html").body.firstChild}function s(){const i=r.windowApi.document.createElement("div");return r.html(i,e),n?i:i.firstElementChild??i.firstChild}return t?o():s()}toElements(e,t=false){const n=this;e=e.trim();function r(){const s=new DOMParser;return Array.from(s.parseFromString(e,"text/html").body.childNodes)}function o(){const s=n.windowApi.document.createElement("div");return n.html(s,e),Array.from(s.childNodes)}return t?r():o()}serialize(e){if(!(e instanceof HTMLFormElement))throw new TypeError("DOMUtils.serialize 参数必须是HTMLFormElement");const t=e.elements,n=[];for(let r=0;r<t.length;r++){const o=t[r];if(o.name&&!o.disabled&&(o.checked||["text","hidden","password","textarea","select-one","select-multiple"].includes(o.type)))if(o.type==="select-multiple")for(let s=0;s<o.options.length;s++)o.options[s].selected&&n.push({name:o.name,value:o.options[s].value});else n.push({name:o.name,value:o.value});}return n.map(r=>`${encodeURIComponent(r.name)}=${encodeURIComponent(r.value)}`).join("&")}createDOMUtils(e){return new Pn(e)}getTextBoundingRect(e,t,n){const r=this;if(!e||!("value"in e))return e;if(t==null&&(t=e.selectionStart||0),n==null&&(n=e.selectionEnd||0),typeof t=="string"&&(t=parseFloat(t)),(typeof t!="number"||isNaN(t))&&(t=0),t<0?t=0:t=Math.min(e.value.length,t),typeof n=="string"&&(n=parseFloat(n)),(typeof n!="number"||isNaN(n)||n<t)&&(n=t),n<0?n=0:n=Math.min(e.value.length,n),typeof e.createTextRange=="function"){const C=e.createTextRange();return C.collapse(true),C.moveStart("character",t),C.moveEnd("character",n-t),C.getBoundingClientRect()}const o=v(),s=S("width",true),i=S("height",true);let l=o.top,c=o.left,d="white-space:pre;padding:0;margin:0;";const p=["direction","font-family","font-size","font-size-adjust","font-variant","font-weight","font-style","letter-spacing","line-height","text-align","text-indent","text-transform","word-wrap","word-spacing"];l+=S("padding-top",true),l+=S("border-top-width",true),c+=S("padding-left",true),c+=S("border-left-width",true),c+=1;for(let C=0;C<p.length;C++){const w=p[C];d+=w+":"+S(w,false)+";";}const f=e.value||"G",b=f.length,h=r.windowApi.document.createElement("div");t>0&&A(0,t);const m=A(t,n);b>n&&A(n,b),h.style.cssText=d,h.style.position="absolute",h.style.top=l+"px",h.style.left=c+"px",h.style.width=s+"px",h.style.height=i+"px",r.windowApi.document.body.appendChild(h);const x=m.getBoundingClientRect();return h?.parentNode?.removeChild(h),x;function A(C,w){const E=r.windowApi.document.createElement("span");return E.style.cssText=d,E.textContent=f.substring(C,w),h.appendChild(E),E}function v(){const C=r.windowApi.document.body,w=r.windowApi.document.defaultView,E=r.windowApi.document.documentElement,B=r.windowApi.document.createElement("div");B.style.paddingLeft=B.style.width="1px",C.appendChild(B);const H=B.offsetWidth==2;C.removeChild(B);const z=e.getBoundingClientRect(),Y=E.clientTop||C.clientTop||0,j=E.clientLeft||C.clientLeft||0,T=w.pageYOffset||H&&E.scrollTop||C.scrollTop,M=w.pageXOffset||H&&E.scrollLeft||C.scrollLeft;return {top:z.top+T-Y,left:z.left+M-j}}function S(C,w){const E=r.windowApi.document.defaultView.getComputedStyle(e,null).getPropertyValue(C);return w?parseFloat(E):E}}addStyle(e){if(typeof e!="string")throw new Error("DOMUtils.addStyle 参数cssText 必须为String类型");const t=this.createElement("style",{type:"text/css",innerHTML:e});return this.windowApi.document.head?this.windowApi.document.head.appendChild(t):this.windowApi.document.documentElement.childNodes.length===0?this.windowApi.document.documentElement.appendChild(t):this.windowApi.document.documentElement.insertBefore(t,this.windowApi.document.documentElement.childNodes[0]),t}checkUserClickInNode(e){const t=this;if(!P.isDOM(e))throw new Error("DOMUtils.checkUserClickInNode 参数 targetNode 必须为 Element|Node 类型");const n=t.windowApi.window.event,r=t.windowApi.window.event,o=n?.composedPath()?.[0],s=n?.clientX!=null?n.clientX:r.touches[0].clientX,i=n?.clientY!=null?n.clientY:r.touches[0].clientY,{left:l,right:c,top:d,bottom:p}=e.getBoundingClientRect();return s>=l&&s<=c&&i>=d&&i<=p?true:!!(o&&e.contains(o)||o==e)}deleteParentNode(e,t){if(e==null)return;if(!P.isDOM(e))throw new Error("DOMUtils.deleteParentNode 参数 target 必须为 Node|HTMLElement 类型");if(typeof t!="string")throw new Error("DOMUtils.deleteParentNode 参数 targetSelector 必须为 string 类型");let n=false;const r=ke.closest(e,t);return r&&(this.remove(r),n=true),n}*findElementsWithText(e,t,n){const r=this;if(e.outerHTML.includes(t))if(e.children.length===0)typeof n=="function"&&n(e)||(yield e);else {const o=Array.from(e.childNodes).filter(s=>s.nodeType===Node.TEXT_NODE);for(const s of o)s.textContent.includes(t)&&(typeof n=="function"&&n(e)||(yield s));}for(let o=0;o<e.children.length;o++){const s=e.children[o];yield*r.findElementsWithText(s,t,n);}}findVisibleElement(e){let t=e;for(;t;){if(t.getBoundingClientRect().length)return t;t=t.parentElement;}return null}setElementSelection(e,t,n,r){const o=this.windowApi.document.createRange();if(o.selectNodeContents(e),t){if(t.nodeType!==Node.TEXT_NODE)throw new TypeError("childTextNode必须是#text元素");n!=null&&r!=null&&(o.setStart(t,n),o.setEnd(t,r));}const s=this.windowApi.globalThis.getSelection();s&&(s.removeAllRanges(),s.addRange(o));}};const ke=new Wr,we={config:{},setGlobalConfig(a){Reflect.ownKeys(a).forEach(e=>{Reflect.set(we.config,e,Reflect.get(a,e));});},getGlobalConfig(){const a={};return Object.keys(we.config).forEach(e=>{const t=Reflect.get(we.config,e);if(e==="style"){const n=t==null?"":typeof t=="function"?t():t;typeof n=="string"&&(a.style=n);}else if(e==="zIndex"){let n=t==null?"":typeof t=="function"?t():t;if(typeof n=="string"){const r=n=Number(n);isNaN(r)||(a.zIndex=r);}else isNaN(n)||(a.zIndex=n);}else if(e==="mask"){const n=we.config.mask==null?{}:we.config.mask;typeof n=="object"&&n!=null&&(a.mask=n);}else Reflect.set(a,e,t);}),a}};var Kr=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="min">\r
  <path fill="currentColor" d="M128 544h768a32 32 0 1 0 0-64H128a32 32 0 0 0 0 64z"></path>\r
</svg>\r
`,Xr=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="mise">\r
  <path\r
    fill="currentColor"\r
...
`,Yr=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="max">\r
  <path\r
    fill="currentColor"\r
...
`,Qr=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="close">\r
	<path\r
		fill="currentColor"\r
...
`,Jr=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="edit">\r
  <path\r
    fill="currentColor"\r
...
`,Zr=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="share">\r
  <path\r
    fill="currentColor"\r
...
`,eo=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="delete">\r
  <path\r
    fill="currentColor"\r
    d="M160 256H96a32 32 0 0 1 0-64h256V95.936a32 32 0 0 1 32-32h256a32 32 0 0 1 32 32V192h256a32 32 0 1 1 0 64h-64v672a32 32 0 0 1-32 32H192a32 32 0 0 1-32-32V256zm448-64v-64H416v64h192zM224 896h576V256H224v640zm192-128a32 32 0 0 1-32-32V416a32 32 0 0 1 64 0v320a32 32 0 0 1-32 32zm192 0a32 32 0 0 1-32-32V416a32 32 0 0 1 64 0v320a32 32 0 0 1-32 32z"></path>\r
</svg>\r
`,to=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="search">\r
  <path\r
    fill="currentColor"\r
...
`,no=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="upload">\r
  <path\r
    fill="currentColor"\r
...
`,ro=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="loading">\r
  <path\r
    fill="currentColor"\r
...
`,oo=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="next">\r
  <path\r
    fill="currentColor"\r
...
`,io=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="elemePlus">\r
  <path\r
...
`,lo=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" xml:space="preserve" data-type="chromeFilled">\r
	<path\r
...
`,co=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="cpu">\r
  <path\r
    fill="currentColor"\r
...
`,po=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="videoPlay">\r
  <path\r
    fill="currentColor"\r
...
`,uo=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="headset">\r
  <path\r
    fill="currentColor"\r
...
`,bo=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="monitor">\r
  <path\r
    fill="currentColor"\r
...
`,ho=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="documentCopy">\r
  <path\r
    fill="currentColor"\r
...
`,mo=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-type="picture">\r
  <path\r
    fill="currentColor"\r
...
`,go=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-type="circleClose">\r
	<path\r
		fill="currentColor"\r
...
`,yo=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-type="view">\r
  <path\r
    fill="currentColor"\r
...
`,wo=`<svg viewBox="0 0 1123 1024" xmlns="http://www.w3.org/2000/svg" data-type="keyboard">\r
  <path\r
...
`,vo=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-type="arrowRight">\r
	<path\r
		d="M340.864 149.312a30.592 30.592 0 0 0 0 42.752L652.736 512 340.864 831.872a30.592 30.592 0 0 0 0 42.752 29.12 29.12 0 0 0 41.728 0L714.24 534.336a32 32 0 0 0 0-44.672L382.592 149.376a29.12 29.12 0 0 0-41.728 0z"></path>\r
</svg>\r
`,Ao=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-type="arrowLeft">\r
	<path\r
		d="M609.408 149.376 277.76 489.6a32 32 0 0 0 0 44.672l331.648 340.352a29.12 29.12 0 0 0 41.728 0 30.592 30.592 0 0 0 0-42.752L339.264 511.936l311.872-319.872a30.592 30.592 0 0 0 0-42.688 29.12 29.12 0 0 0-41.728 0z"></path>\r
</svg>\r
`;const So={min:Kr,mise:Xr,max:Yr,close:Qr,edit:Jr,share:Zr,delete:eo,search:to,upload:no,loading:ro,next:oo,prev:ao,eleme:so,elemePlus:io,chromeFilled:lo,cpu:co,videoPlay:po,videoPause:fo,headset:uo,monitor:bo,documentCopy:ho,picture:mo,circleClose:go,view:yo,hide:xo,keyboard:wo,arrowRight:vo,arrowLeft:Ao},le={$data:So,hasIcon(a){return Object.keys(le.$data).includes(a)},getIcon(a){return le.$data[a]},deleteIcon(a){return Reflect.deleteProperty(le.$data,a)},setIcon(a,e){Reflect.set(le.$data,a,e);}},Ye=Symbol("events_"+((1+Math.random())*65536|0).toString(16).substring(1)),Co={document,window,globalThis,self},ft=Object.assign({},Co),X={get document(){return ft.document},get window(){return ft.window},get globalThis(){return ft.globalThis},get self(){return ft.self}},Bn={Object:{defineProperty:Object.defineProperty}},To=a=>(e,t)=>(a.set(e,t),t),pn=Number.MAX_SAFE_INTEGER===void 0?9007199254740991:Number.MAX_SAFE_INTEGER,Hn=536870912,dn=Hn*2,ko=(a,e)=>t=>{const n=e.get(t);let r=n===void 0?t.size:n<dn?n+1:0;if(!t.has(r))return a(t,r);if(t.size<Hn){for(;t.has(r);)r=Math.floor(Math.random()*dn);return a(t,r)}if(t.size>pn)throw new Error("Congratulations, you created a collection of unique numbers which uses all available integers!");for(;t.has(r);)r=Math.floor(Math.random()*pn);return a(t,r)},Vn=new WeakMap,Eo=To(Vn),Ht=ko(Eo,Vn),$o=(a,e,t,n)=>r=>{const o=e(r);return s=>{const i=a(s);s.addEventListener("message",(({data:p})=>{const{id:f}=p;if(f!==null&&i.has(f)){const{reject:b,resolve:h}=i.get(f);i.delete(f),p.error===void 0?h(p.result):b(new Error(p.error.message));}})),n(s)&&s.start();const l=(p,f=null,b=[])=>new Promise((h,m)=>{const x=t(i);i.set(x,{reject:m,resolve:h}),f===null?s.postMessage({id:x,method:p},b):s.postMessage({id:x,method:p,params:f},b);}),c=(p,f,b=[])=>{s.postMessage({id:null,method:p,params:f},b);};let d={};for(const[p,f]of Object.entries(o))d={...d,[p]:f({call:l,notify:c})};return {...d}}},Mo=a=>e=>{if(a.has(e))return a.get(e);const t=new Map;return a.set(e,t),t},Lo=a=>e=>({...e,connect:({call:t})=>async()=>{const{port1:n,port2:r}=new MessageChannel,o=await t("connect",{port:n},[n]);return a.set(r,o),r},disconnect:({call:t})=>async n=>{const r=a.get(n);if(r===void 0)throw new Error("The given port is not connected.");await t("disconnect",{portId:r});},isSupported:({call:t})=>()=>t("isSupported")}),Io=a=>typeof a.start=="function",_o=$o(Mo(new WeakMap),Lo(new WeakMap),Ht,Io),Ro=a=>e=>t=>{typeof a.get(t)=="symbol"&&(a.set(t,null),e(t).then(()=>{a.delete(t);}));},No=a=>e=>t=>{typeof a.get(t)=="symbol"&&(a.set(t,null),e(t).then(()=>{a.delete(t);}));},Do=(a,e)=>t=>(n,r=0,...o)=>{const s=Symbol(),i=a(e);e.set(i,s);const l=()=>t(r,i).then(()=>{const c=e.get(i);if(c===void 0)throw new Error("The timer is in an undefined state.");c===s&&(n(...o),e.get(i)===s&&l());});return l(),i},Oo=(a,e)=>t=>(n,r=0,...o)=>{const s=Symbol(),i=a(e);return e.set(i,s),t(r,i).then(()=>{const l=e.get(i);if(l===void 0)throw new Error("The timer is in an undefined state.");l===s&&(e.delete(i),n(...o));}),i},Un=new Map([[0,null]]),zn=new Map([[0,null]]),Po=Ro(Un),Bo=No(zn),Ho=Do(Ht,Un),Vo=Oo(Ht,zn),Uo=_o({clearInterval:({call:a})=>Po(e=>a("clear",{timerId:e,timerType:"interval"})),clearTimeout:({call:a})=>Bo(e=>a("clear",{timerId:e,timerType:"timeout"})),setInterval:({call:a})=>Ho((e,t)=>a("set",{delay:e,now:performance.timeOrigin+performance.now(),timerId:t,timerType:"interval"})),setTimeout:({call:a})=>Vo((e,t)=>a("set",{delay:e,now:performance.timeOrigin+performance.now(),timerId:t,timerType:"timeout"}))}),zo=a=>{const e=new Worker(a);return Uo(e)},Fo=(a,e)=>{let t=null;return ()=>{if(t!==null)return t;const n=new Blob([e],{type:"application/javascript; charset=utf-8"}),r=URL.createObjectURL(n);return t=a(r),setTimeout(()=>URL.revokeObjectURL(r)),t}},jo=`(()=>{var e={455(e,t){!function(e){"use strict";var t=function(e){return function(t){var r=e(t);return t.add(r),r}},r=function(e){return function(t,r){return e.set(t,r),r}},n=void 0===Number.MAX_SAFE_INTEGER?9007199254740991:Number.MAX_SAFE_INTEGER,o=536870912,s=2*o,a=function(e,t){return function(r){var a=t.get(r),i=void 0===a?r.size:a<s?a+1:0;if(!r.has(i))return e(r,i);if(r.size<o){for(;r.has(i);)i=Math.floor(Math.random()*s);return e(r,i)}if(r.size>n)throw new Error("Congratulations, you created a collection of unique numbers which uses all available integers!");for(;r.has(i);)i=Math.floor(Math.random()*n);return e(r,i)}},i=new WeakMap,u=r(i),c=a(u,i),l=t(c);e.addUniqueNumber=l,e.generateUniqueNumber=c}(t)}},t={};function r(n){var o=t[n];if(void 0!==o)return o.exports;var s=t[n]={exports:{}};return e[n].call(s.exports,s,s.exports,r),s.exports}(()=>{"use strict";const e=-32603,t=-32602,n=-32601,o=(e,t)=>Object.assign(new Error(e),{status:t}),s=t=>o('The handler of the method called "'.concat(t,'" returned an unexpected result.'),e),a=(t,r)=>async({data:{id:a,method:i,params:u}})=>{const c=r[i];try{if(void 0===c)throw(e=>o('The requested method called "'.concat(e,'" is not supported.'),n))(i);const r=void 0===u?c():c(u);if(void 0===r)throw(t=>o('The handler of the method called "'.concat(t,'" returned no required result.'),e))(i);const l=r instanceof Promise?await r:r;if(null===a){if(void 0!==l.result)throw s(i)}else{if(void 0===l.result)throw s(i);const{result:e,transferables:r=[]}=l;t.postMessage({id:a,result:e},r)}}catch(e){const{message:r,status:n=-32603}=e;t.postMessage({error:{code:n,message:r},id:a})}};var i=r(455);const u=new Map,c=(e,r,n)=>({...r,connect:({port:t})=>{t.start();const n=e(t,r),o=(0,i.generateUniqueNumber)(u);return u.set(o,()=>{n(),t.close(),u.delete(o)}),{result:o}},disconnect:({portId:e})=>{const r=u.get(e);if(void 0===r)throw(e=>o('The specified parameter called "portId" with the given value "'.concat(e,'" does not identify a port connected to this worker.'),t))(e);return r(),{result:null}},isSupported:async()=>{if(await new Promise(e=>{const t=new ArrayBuffer(0),{port1:r,port2:n}=new MessageChannel;r.onmessage=({data:t})=>e(null!==t),n.postMessage(t,[t])})){const e=n();return{result:e instanceof Promise?await e:e}}return{result:!1}}}),l=(e,t,r=()=>!0)=>{const n=c(l,t,r),o=a(e,n);return e.addEventListener("message",o),()=>e.removeEventListener("message",o)},d=(e,t)=>r=>{const n=t.get(r);if(void 0===n)return Promise.resolve(!1);const[o,s]=n;return e(o),t.delete(r),s(!1),Promise.resolve(!0)},m=(e,t,r,n)=>(o,s,a)=>{const i=o+s-t.timeOrigin,u=i-t.now();return new Promise(t=>{e.set(a,[r(n,u,i,e,t,a),t])})},f=new Map,h=d(globalThis.clearTimeout,f),p=new Map,v=d(globalThis.clearTimeout,p),w=((e,t)=>{const r=(n,o,s,a)=>{const i=n-e.now();i>0?o.set(a,[t(r,i,n,o,s,a),s]):(o.delete(a),s(!0))};return r})(performance,globalThis.setTimeout),g=m(f,performance,globalThis.setTimeout,w),T=m(p,performance,globalThis.setTimeout,w);l(self,{clear:async({timerId:e,timerType:t})=>({result:await("interval"===t?h(e):v(e))}),set:async({delay:e,now:t,timerId:r,timerType:n})=>({result:await("interval"===n?g:T)(e,t,r)})})})()})();`,wt=Fo(zo,jo),qo=a=>wt().clearInterval(a),Go=a=>wt().clearTimeout(a),Wo=(...a)=>wt().setInterval(...a),Ko=(...a)=>wt().setTimeout(...a);let Xo=class{constructor(){this.__map={};}beforeEach(e){this.__interceptor=e;}on(e,t){const n=Array.isArray(e)?e:[e];for(const r of n){this.__map[r]=this.__map[r]||[];const o=this.__map[r];o&&o.push(t);}return this}emit(e,t,n){this.__interceptor!==void 0?this.__interceptor(e,(()=>{this.__emit(e,t),n&&n();})):(this.__emit(e,t),n&&n());}__emit(e,t){const n=this.__map[e];if(Array.isArray(n)&&n?.length)for(const r of n)r(t,e);this.event=t;}off(e,t){const n=this.__map[e];if(n!==void 0)if(t===void 0)delete this.__map[e];else {const r=n.findIndex((o=>o===t));n.splice(r,1);}}destroy(){this.__map={};}};const it="clientX",lt="clientY",Yo=16,vt="start",Qo="move",Vt="cancel",rt="end",Jo="left",Zo="right",Fn="up",ea="down",ta={4:"start",5:"move",1:"end",3:"cancel"};function Ut(a){return ta[a]}function zt(a,e,t){const n={1:{0:{move:4},4:{move:5,end:1,cancel:3},5:{move:5,end:1,cancel:3}},0:{4:{move:2,end:1,cancel:3},5:{start:2,move:2,end:1,cancel:3}}}[Number(a)][e];return n!==void 0&&n[t]||0}function At(a){[1,3,2].includes(a.state)&&(a.state=0);}function Ft(a){return [5,1,3].includes(a)}function pt(a){if(a.disabled)return a.state=0,true}function ot(a,e){return Object.assign(Object.assign(Object.assign({},a),e),{state:0,disabled:false})}function fn(a){return Math.round(100*a)/100}function un(){let a,e,t,n,r=0;return function(o){if(a=e,o!==void 0){r=Number.MAX_SAFE_INTEGER>r?++r:1;const s=(function(c,d){const{phase:p,points:f,changedPoints:b,nativeEvent:h}=c,m=f.length,x=vt===p,A=rt===p&&m===0||Vt===p,v=Date.now(),{x:S,y:C}=bn(f)||bn(b),{currentTarget:w}=h;return Object.assign(c,{id:d,x:S,y:C,timestamp:v,isStart:x,isEnd:A,pointLength:m,currentTarget:w,getOffset(E=w){const B=E.getBoundingClientRect();return {x:S-Math.round(B.left),y:C-Math.round(B.top)}}})})(o,r);e=s;const{isStart:i,pointLength:l}=s;return i&&(t=s,a=void 0,n=1<l?s:void 0),Object.assign(Object.assign({},s),{prevInput:a,startMultiInput:n,startInput:t})}}}function bn(a){const{length:e}=a;if(0<e){if(e===1){const{clientX:n,clientY:r}=a[0];return {x:Math.round(n),y:Math.round(r)}}const t=a.reduce(((n,r)=>(n.x+=r[it],n.y+=r[lt],n)),{x:0,y:0});return {x:Math.round(t.x/e),y:Math.round(t.y/e)}}}function hn(a,e,t,n){const r={};for(const s in t)["target","currentTarget","type"].includes(s)||(r[s]=t[s]);let o;return document.createEvent?(o=document.createEvent("HTMLEvents"),o.initEvent(a,n?.bubbles,n?.cancelable)):o=new Event(a,n),Object.assign(o,r,{match:()=>t.targets&&0<t.targets.length&&t.targets.every((s=>o.currentTarget.contains(s)))}),e.dispatchEvent(o)}function na(a,e){const{preventDefault:t}=e;return n=t,Object.prototype.toString.call(n)==="[object Function]"?t(a):!!t;var n;}const mn=["touchstart","touchmove","touchend","touchcancel","mousedown"],gn=["mousemove","mouseup"],ra={domEvents:{bubbles:true,cancelable:true},preventDefault:a=>{if(a.target&&"tagName"in a.target){const{tagName:e}=a.target;return !/^(?:INPUT|TEXTAREA|BUTTON|SELECT)$/.test(e)}return  false}};let oa=class extends Xo{constructor(e,t){super(),this.v="2.1.3",this.__computeFunctionList=[],this.__computeFunctionCreatorList=[],this.__pluginContexts=[],this.__isIgnoreMouse=false,this.el=e,this.c={},this.__options=Object.assign(Object.assign({},ra),t);const n=(function(o){const s=un();return function(i){const l=[],c=[];Array.from(i.touches).forEach((({clientX:p,clientY:f,target:b})=>{o?.contains(b)&&(l.push(b),c.push({clientX:p,clientY:f,target:b}));}));const d=Array.from(i.changedTouches).map((({clientX:p,clientY:f,target:b})=>({clientX:p,clientY:f,target:b})));return s({phase:i.type.replace("touch",""),changedPoints:d,points:c,nativeEvent:i,target:i.target,targets:l})}})(this.el),r=(function(){let o,s=false,i=null;const l=un();return function(c){const{clientX:d,clientY:p,type:f,button:b,target:h}=c;let m,x=[{clientX:d,clientY:p,target:h}];if(f==="mousedown"&&b===0)i=h,s=true,m="start";else {if(!s)return;f==="mousemove"?m="move":f==="mouseup"&&(x=[],m="end",s=false);}const A=o||[{clientX:d,clientY:p,target:h}];if(o=[{clientX:d,clientY:p,target:h}],m!==void 0)return l({phase:m,changedPoints:A,points:x,target:i,targets:[i],nativeEvent:c})}})();if(this.__inputCreatorMap={touchstart:n,touchmove:n,touchend:n,touchcancel:n,mousedown:r,mousemove:r,mouseup:r},this.on("at:after",(o=>{const{target:s,__type:i}=o,{domEvents:l}=this.__options;l&&this.el!==void 0&&s&&(hn(i,s,o,l),hn("at:after",s,o,l));})),e!==void 0){e.style.webkitTapHighlightColor="rgba(0,0,0,0)";let o=false;try{const s={};Object.defineProperty(s,"passive",{get(){o=!0;}}),window.addEventListener("_",(()=>{}),s);}catch{}this.on("u",(function(s,i,l){return mn.forEach((c=>{s.addEventListener(c,i,l);})),gn.forEach((c=>{window.addEventListener(c,i,l);})),()=>{mn.forEach((c=>{s.removeEventListener(c,i);})),gn.forEach((c=>{window.removeEventListener(c,i);}));}})(e,this.catchEvent.bind(this),this.__options.preventDefault===false&&o?{passive:true}:{passive:false}));}}use(e,t){this.__pluginContexts.push(e(this,t));}catchEvent(e){const t=this.__inputCreatorMap[e.type](e);if(t!==void 0){const n=()=>e.stopPropagation(),r=()=>e.stopImmediatePropagation(),o=()=>e.preventDefault();if(na(e,this.__options))o();else if(e.type==="touchstart"?this.__isIgnoreMouse=true:e.type==="touchmove"&&(this.__isIgnoreMouse=false),this.__isIgnoreMouse&&e.type.startsWith("mouse"))return void(e.type==="mouseup"&&(this.__isIgnoreMouse=false));this.emit("input",t),this.emit2(`at:${t.phase}`,t,{});const s={};this.__computeFunctionList.forEach((i=>{const l=i(t,s);if(l!==void 0)for(const c in l)s[c]=l[c];})),this.emit("computed",Object.assign(Object.assign(Object.assign({},t),s),{stopPropagation:n,stopImmediatePropagation:r,preventDefault:o}));}}compute(e,t){for(const n of e)this.__computeFunctionCreatorList.includes(n)||(this.__computeFunctionCreatorList.push(n),this.__computeFunctionList.push(n()));this.on("computed",t);}beforeEach(e){super.beforeEach(((t,n)=>{var r;!((r=this.c)===null||r===void 0)&&r.name?e(t,n):n();}));}get(e){return this.__pluginContexts.find((t=>e===t.name))}set(e){this.__options=Object.assign(Object.assign({},this.__options),e);}emit2(e,t,n){this.c=n,this.emit(e,Object.assign(Object.assign({},t),{type:e}),(()=>{this.emit("at:after",Object.assign(Object.assign({},t),{name:e,__type:e}));}));}destroy(){this.emit("u"),super.destroy();}};var Fe=a=>Math.sqrt(a.x*a.x+a.y*a.y),aa=(a,e)=>a.x*e.x+a.y*e.y,sa=(a,e)=>{var t=Fe(a)*Fe(e);if(t===0)return 0;var n=aa(a,e)/t;return n>1&&(n=1),Math.acos(n)},ia=(a,e)=>a.x*e.y-e.x*a.y,jn=a=>a/Math.PI*180,yn=(a,e)=>{var t=sa(a,e);return ia(a,e)>0&&(t*=-1),jn(t)},qn=(a,e)=>{if(a!==0||e!==0)return Math.abs(a)>=Math.abs(e)?0<a?Zo:Jo:0<e?ea:Fn};function la(){let a=0,e=0;return function(t,n){const{prevVecotr:r,startVecotr:o,activeVecotr:s}=n;return s&&(e=Math.round(yn(s,r)),a=Math.round(yn(s,o))),{angle:a,deltaAngle:e}}}function ca(){return function(a){const{prevInput:e}=a;let t=0,n=0,r=0;if(e!==void 0&&(t=a.x-e.x,n=a.y-e.y,t!==0||n!==0)){const o=Math.sqrt(Math.pow(t,2)+Math.pow(n,2));r=Math.round(jn(Math.acos(Math.abs(t)/o)));}return {deltaX:t,deltaY:n,deltaXYAngle:r}}}function St(){let a,e=0,t=0,n=0,r=0,o=0;return function(s){const{phase:i,startInput:l}=s;return vt===i?(e=0,t=0,n=0,r=0,o=0):Qo===i&&(e=Math.round(s.points[0][it]-l.points[0][it]),t=Math.round(s.points[0][lt]-l.points[0][lt]),n=Math.abs(e),r=Math.abs(t),o=Math.round(Fe({x:n,y:r})),a=qn(e,t)),{displacementX:e,displacementY:t,distanceX:n,distanceY:r,distance:o,overallDirection:a}}}function pa(){let a=1;return function(e,t){let n=1;const{prevVecotr:r,startVecotr:o,activeVecotr:s}=t;return s&&(n=fn(Fe(s)/Fe(r)),a=fn(Fe(s)/Fe(o))),{scale:a,deltaScale:n}}}function Gn(){let a,e,t=0,n=0,r=0,o=0;return function(s){if(s!==void 0){e=e||s.startInput;const i=s.timestamp-e.timestamp;if(Yo<i){const l=s.x-e.x,c=s.y-e.y;r=Math.round(l/i*100)/100,o=Math.round(c/i*100)/100,t=Math.abs(r),n=Math.abs(o),a=qn(l,c),e=s;}}return {velocityX:t,velocityY:n,speedX:r,speedY:o,direction:a}}}function Wn(){let a=0;return function(e){const{phase:t}=e;return vt===t&&(a=e.pointLength),{maxPointLength:a}}}function $t(a){return {x:a.points[1][it]-a.points[0][it],y:a.points[1][lt]-a.points[0][lt]}}function Kn(){let a,e,t;return function(n){const{prevInput:r,startMultiInput:o}=n;return o!==void 0&&r!==void 0&&n.id!==o.id&&1<r.pointLength&&1<n.pointLength?(a=$t(o),e=$t(r),t=$t(n)):t=void 0,{startVecotr:a,prevVecotr:e,activeVecotr:t}}}const da={name:"tap",pointLength:1,tapTimes:1,waitNextTapTime:300,maxDistance:2,maxDistanceFromPrevTap:9,maxPressTime:250};function jt(a,e){const t=ot(da,e);let n,r,o,s=0;function i(){s=0,n=void 0,r=void 0;}return a.compute([St,Wn],(l=>{if(pt(t))return;const{phase:c,x:d,y:p}=l;rt===c&&(t.state=0,(function(){const{startInput:f,pointLength:b,timestamp:h}=l,m=h-f.timestamp,{distance:x,maxPointLength:A}=l;return A===t.pointLength&&b===0&&t.maxDistance>=x&&t.maxPressTime>m})()?(clearTimeout(o),(function(f,b){if(n!==void 0){const h=Fe({x:f.x-n.x,y:f.y-n.y});return n=f,b.maxDistanceFromPrevTap>=h}return n=f,true})({x:d,y:p},t)&&(function(f){const b=performance.now();if(r===void 0)return r=b,true;{const h=b-r;return r=b,h<f}})(t.waitNextTapTime)?s++:s=1,s%t.tapTimes==0?(t.state=1,a.emit2(t.name,l,t),i()):o=setTimeout((()=>{t.state=2,i();}),t.waitNextTapTime)):(i(),t.state=2));})),t}const fa={name:"pan",threshold:10,pointLength:1};function Xn(a,e){const t=ot(fa,e);return a.compute([Gn,St,ca],(n=>{if(At(t),pt(t))return;const r=(function(){const{pointLength:o,distance:s}=n;return t.pointLength===o&&t.threshold<=s})();if(t.state=zt(r,t.state,n.phase),r||Ft(t.state)){const{name:o}=t;a.emit2(o,n,t),a.emit2(o+Ut(t.state),n,t),![rt,Vt].includes(n.phase)&&n.direction&&a.emit2(o+n.direction,n,t);}})),t}const ua={name:"swipe",threshold:10,velocity:.3,pointLength:1};function Yn(a,e){const t=ot(ua,e);return a.compute([St,Gn,Wn],(n=>{if(t.state=0,!t.disabled&&(function(){if(rt!==n.phase)return  false;const{velocityX:r,velocityY:o,distance:s,maxPointLength:i}=n;return i===t.pointLength&&n.points.length===0&&t.threshold<s&&t.velocity<Math.max(r,o)})()){const{name:r}=t;t.state=1,a.emit2(r,n,t),a.emit2(r+n.direction,n,t);}})),t}const ba={name:"press",pointLength:1,maxDistance:9,minPressTime:251};function Qn(a,e){const t=ot(ba,e);let n=0;return a.compute([St],(r=>{if(pt(t))return;const{phase:o,startInput:s,pointLength:i}=r;if(vt===o&&t.pointLength===i)At(t),clearTimeout(n),n=setTimeout((()=>{t.state=1,a.emit2(t.name,r,t);}),t.minPressTime);else if(rt===o&&t.state===1)a.emit2(`${t.name}${Fn}`,r,t);else if(t.state!==1){const l=r.timestamp-s.timestamp;(!(function(){const{distance:c}=r;return c&&t.maxDistance>c})()||t.minPressTime>l&&[rt,Vt].includes(o))&&(clearTimeout(n),t.state=2);}})),t}const ha={name:"pinch",threshold:0,pointLength:2};function Jn(a,e){const t=ot(ha,e);return a.compute([Kn,pa],(n=>{if(At(t),pt(t))return;const r=(function(){const{pointLength:i,scale:l,deltaScale:c,phase:d}=n;return t.pointLength===i&&t.threshold<Math.abs(l-1)})();t.state=zt(r,t.state,n.phase);const{name:o}=t;if(r||Ft(t.state)){a.emit2(o,n,t);const{deltaScale:i}=n;i!==1&&a.emit2(o+(1<i?"in":"out"),n,t);}const s=Ut(t.state);s&&a.emit2(o+s,n,t);})),t}const ma={name:"rotate",threshold:0,pointLength:2};function Zn(a,e){const t=ot(ma,e);return a.compute([Kn,la],(n=>{if(pt(t))return;At(t);const r=(function(){const{pointLength:i,angle:l}=n;return t.pointLength===i&&t.threshold<Math.abs(l)})();t.state=zt(r,t.state,n.phase);const{name:o}=t;(r||Ft(t.state))&&a.emit2(o,n,t);const s=Ut(t.state);s&&a.emit2(o+s,n,t);})),t}function ga(a){a.use(jt,{name:"doubletap",tapTimes:2});const e=a.get("doubletap");let t;return a.beforeEach(((n,r)=>{n==="tap"?(clearTimeout(t),t=setTimeout((()=>{[0,2].includes(e.state)&&r();}),300)):r();})),e}class Se extends oa{constructor(e,t){super(e,t),this.use(jt),this.use(Xn),this.use(Yn),this.use(Qn),this.use(Jn),this.use(Zn);}}Se.STATE_POSSIBLE=0,Se.STATE_START=4,Se.STATE_MOVE=5,Se.STATE_END=1,Se.STATE_CANCELLED=3,Se.STATE_FAILED=2,Se.STATE_RECOGNIZED=1,Se.tap=jt,Se.pan=Xn,Se.swipe=Yn,Se.press=Qn,Se.rotate=Zn,Se.pinch=Jn,Se.doubletap=ga;class ya{isWin(e){return typeof e!="object"||e instanceof Node?false:e===globalThis||e===window||e===self||e===X.globalThis||e===X.window||e===X.self||typeof unsafeWindow<"u"&&e===unsafeWindow?true:e?.Math?.toString()==="[object Math]"}isDOM(e){return e instanceof Node}delete(e,t){typeof Reflect=="object"&&typeof Reflect.deleteProperty=="function"?Reflect.deleteProperty(e,t):delete e[t];}assign(e={},t={},n=false){const r=this;if(Array.isArray(t)&&!t.filter(i=>typeof i=="object").length)return t;if(t==null)return e;e==null&&(e={});let o;n?o=t:o=e;for(const s in o){if(!n&&!(s in t))continue;const i=Reflect.get(e,s),l=Reflect.get(t,s);if(typeof l=="object"&&l!=null&&s in e&&!r.isDOM(l)){let c;Array.isArray(l)?(Array.isArray(i)&&(i.length=0),c=l):c=r.assign(i,l,n),Reflect.set(e,s,c);}else Reflect.set(e,s,l);}return e}getRandomGUID(){return typeof X.globalThis?.crypto?.randomUUID=="function"?X.globalThis.crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){const t=Math.random()*16|0;return (e==="x"?t:t&3|8).toString(16)})}contains(...e){const[t,n]=e;if(e.length===1)return this.contains(X.document.body||X.document.documentElement,e[0]);if(n==null)return  false;if(typeof n[Symbol.iterator]=="function"){let r=true;for(const o of n)if(!t.contains(o)){r=false;break}return r}else return t.contains(n)}formatTime(e=new Date,t="yyyy-MM-dd HH:mm:ss"){const n=e==null?new Date:new Date(e);function r(i){return i<10?"0"+i:i}function o(i){return i>12?i-12:i}const s={yyyy:n.getFullYear(),MM:r(n.getMonth()+1),dd:r(n.getDate()),HH:r(n.getHours()),hh:r(o(n.getHours())),mm:r(n.getMinutes()),ss:r(n.getSeconds())};return Object.keys(s).forEach(function(i){const l=new RegExp(i,"g");t=t.replace(l,s[i]);}),t}formatByteToSize(e,t=true){if(e=parseInt(e.toString()),isNaN(e))throw new TypeError("Utils.formatByteToSize 参数 byteSize 格式不正确");let n=0,r="KB";const o={};o.B=1,o.KB=1024,o.MB=o.KB*o.KB,o.GB=o.MB*o.KB,o.TB=o.GB*o.KB,o.PB=o.TB*o.KB,o.EB=o.PB*o.KB,o.ZB=o.EB*o.KB,o.YB=o.ZB*o.KB,o.BB=o.YB*o.KB,o.NB=o.BB*o.KB,o.DB=o.NB*o.KB;for(const s in o)if(n=e/o[s],r=s,o.KB>=n)break;return n=n.toFixed(2),n=t?n+r.toString():parseFloat(n.toString()),n}AnyTouch=()=>Se;isPhone(e=X.globalThis.navigator.userAgent){return !!/(iPhone|iPad|iPod|iOS|Android)/i.test(e)}setTimeout(e,t=0){try{return Ko(e,t)}catch{return setTimeout(e,t)}}clearTimeout(e){try{e!=null&&Go(e);}catch{}finally{clearTimeout(e);}}setInterval(e,t=0){try{return Wo(e,t)}catch{return setInterval(e,t)}}clearInterval(e){try{e!=null&&qo(e);}catch{}finally{clearInterval(e);}}setArray(e,t,n){if(e==null||!Array.isArray(n))return;const r=e[t];Array.isArray(e[t])?r.length=0:e[t]=[],e[t]=n;}}const F=new ya,ee={getSafeHTML(a){return window.trustedTypes?window.trustedTypes.createPolicy("safe-innerHTML",{createHTML:t=>t}).createHTML(a):a},setSafeHTML(a,e){a.innerHTML=this.getSafeHTML(e);}},de={flexCenter:"pops-flex-items-center",flexYCenter:"pops-flex-y-center",hide:"pops-hide",hideImportant:"pops-hide-important",userSelectNone:"pops-user-select-none",textIsDisabled:"pops-text-is-disabled"};class xa{on(e,t,n,r,o){function s(m,x,A){const v=m[x];return typeof v=="boolean"?(A.capture=v,typeof m[x+1]=="boolean"&&(A.once=m[x+1]),typeof m[x+2]=="boolean"&&(A.passive=m[x+2])):typeof v=="object"&&("capture"in v||"once"in v||"passive"in v||"isComposedPath"in v)&&(A.capture=v.capture,A.once=v.once,A.passive=v.passive,A.isComposedPath=v.isComposedPath),A}const i=this,l=arguments;if(typeof e=="string"&&(e=i.selectorAll(e)),e==null)return {off(){},emit(){}};let c=[];e instanceof NodeList||Array.isArray(e)?(e=e,c=[...e]):c.push(e);let d=[];Array.isArray(t)?d=d.concat(t.filter(m=>typeof m=="string"&&m.toString()!=="")):typeof t=="string"&&(d=d.concat(t.split(" ").filter(m=>m!=="")));let p=[];Array.isArray(n)?p=p.concat(n.filter(m=>typeof m=="string"&&m.toString()!=="")):typeof n=="string"&&p.push(n);let f=r,b={capture:false,once:false,passive:false,isComposedPath:false};typeof n=="function"?(f=n,b=s(l,3,b)):b=s(l,4,b);function h(){b.once&&i.off(e,t,n,r,o);}return c.forEach(m=>{function x(A){if(p.length){let v=b.isComposedPath?A.composedPath()[0]:A.target,S=m;if(F.isWin(S)&&S===X.document&&(S=X.document.documentElement),p.find(w=>{if(i.matches(v,w))return  true;const E=i.closest(v,w);return E&&S?.contains(E)?(v=E,true):false})){try{Bn.Object.defineProperty(A,"target",{get(){return v}});}catch{}f.call(v,A,v),h();}}else f.call(m,A),h();}d.forEach(A=>{m.addEventListener(A,x,b);const v=Reflect.get(m,Ye)||{};v[A]=v[A]||[],v[A].push({selector:p,option:b,callback:x,originCallBack:f}),Reflect.set(m,Ye,v);});}),{off:m=>{i.off(c,d,p,f,b,m);},emit:(m,x)=>{i.emit(c,d,m,x);}}}off(e,t,n,r,o,s){function i(x,A,v){const S=x[A];return typeof S=="boolean"?v.capture=S:typeof S=="object"&&S!=null&&"capture"in S&&(v.capture=S.capture),v}const l=this,c=arguments;if(typeof e=="string"&&(e=l.selectorAll(e)),e==null)return;let d=[];e instanceof NodeList||Array.isArray(e)?(e=e,d=d.concat(e)):d.push(e);let p=[];Array.isArray(t)?p=p.concat(t.filter(x=>typeof x=="string"&&x.toString()!=="")):typeof t=="string"&&(p=p.concat(t.split(" ").filter(x=>x!=="")));let f=[];Array.isArray(n)?f=f.concat(n.filter(x=>typeof x=="string"&&x.toString()!=="")):typeof n=="string"&&f.push(n);let b=r,h={capture:false};typeof n=="function"?(b=n,h=i(c,3,h)):h=i(c,4,h);let m=false;(c.length===2||c.length===3&&typeof c[2]=="string"||Array.isArray(c[2]))&&(m=true),c.length===5&&typeof c[4]=="function"&&typeof s!="function"&&(s=o),d.forEach(x=>{const A=Reflect.get(x,Ye)||{};p.forEach(v=>{const S=A[v]||[],C=typeof s=="function"?S.filter(s):S;for(let w=0;w<C.length;w++){const E=C[w];let B=true;if(B&&b&&E.originCallBack!==b&&(B=false),B&&f.length&&Array.isArray(E.selector)&&JSON.stringify(E.selector)!==JSON.stringify(f)&&(B=false),B&&typeof E.option.capture=="boolean"&&h.capture!==E.option.capture&&(B=false),B||m){x.removeEventListener(v,E.callback,E.option);const H=S.findIndex(z=>z===E);H!==-1&&S.splice(H,1);}}S.length===0&&F.delete(A,t);}),Reflect.set(x,Ye,A);});}offAll(e,t){if(typeof e=="string"&&(e=this.selectorAll(e)),e==null)return;let r=[];e instanceof NodeList||Array.isArray(e)?r=r.concat(Array.from(e)):r.push(e);let o=[];Array.isArray(t)?o=o.concat(t):typeof t=="string"&&(o=o.concat(t.split(" "))),r.forEach(s=>{[...new Set([...Object.getOwnPropertySymbols(s),Ye])].forEach(l=>{if(!l.toString().startsWith("Symbol(events_"))return;const c=Reflect.get(s,l)||{};(o.length?o:Object.keys(c)).forEach(p=>{const f=c[p];if(!f)return;for(const h of f)s.removeEventListener(p,h.callback,{capture:h.option.capture});const b=Reflect.get(s,l);F.delete(b,p);});});});}onReady(e){const t=this;if(typeof e!="function")return;function n(){try{return document.readyState==="complete"||document.readyState!=="loading"&&!document.documentElement.doScroll}catch{return  false}}function r(){i(),e();}const o=[{target:X.document,eventType:"DOMContentLoaded",callback:r},{target:X.window,eventType:"load",callback:r}];function s(){for(let l=0;l<o.length;l++){const c=o[l];t.on(c.target,c.eventType,c.callback);}}function i(){for(let l=0;l<o.length;l++){const c=o[l];t.off(c.target,c.eventType,c.callback);}}n()?F.setTimeout(e,0):s();}emit(e,t,n,r=true){if(typeof e=="string"&&(e=X.document.querySelector(e)),e==null)return;let o=[];e instanceof NodeList||Array.isArray(e)?(e=e,o=[...e]):o=[e];let s=[];Array.isArray(t)?s=t:typeof t=="string"&&(s=t.split(" ")),o.forEach(i=>{const l=i[Ye]||{};s.forEach(c=>{let d=null;n&&n instanceof Event?d=n:(d=new Event(c),n&&Object.keys(n).forEach(p=>{d[p]=n[p];})),r==false&&c in l?l[c].forEach(p=>{p.callback(d);}):i.dispatchEvent(d);});});}click(e,t,n,r){const o=this;typeof e=="string"&&(e=X.document.querySelector(e)),e!=null&&(t==null?o.emit(e,"click",n,r):o.on(e,"click",null,t));}blur(e,t,n,r){const o=this;typeof e=="string"&&(e=X.document.querySelector(e)),e!=null&&(t===null?o.emit(e,"blur",n,r):o.on(e,"blur",null,t));}focus(e,t,n,r){const o=this;typeof e=="string"&&(e=X.document.querySelector(e)),e!=null&&(t==null?o.emit(e,"focus",n,r):o.on(e,"focus",null,t));}onHover(e,t,n){const r=this;typeof e=="string"&&(e=X.document.querySelector(e)),e!=null&&(r.on(e,"mouseenter",null,t,n),r.on(e,"mouseleave",null,t,n));}onKeyup(e,t,n){const r=this;e!=null&&(typeof e=="string"&&(e=X.document.querySelector(e)),r.on(e,"keyup",null,t,n));}onKeydown(e,t,n){const r=this;e!=null&&(typeof e=="string"&&(e=X.document.querySelector(e)),r.on(e,"keydown",null,t,n));}onKeypress(e,t,n){const r=this;e!=null&&(typeof e=="string"&&(e=X.document.querySelector(e)),r.on(e,"keypress",null,t,n));}preventEvent(e,t=[],n){function r(o){return o?.preventDefault(),o?.stopPropagation(),o?.stopImmediatePropagation(),false}if(arguments.length===1)return r(arguments[0]);typeof t=="string"&&(t=[t]),t.forEach(o=>{this.on(e,o,r,{capture:!!n});});}selector(e){return this.selectorAll(e)[0]}selectorAll(e){if(e=e.trim(),e.match(/[^\s]{1}:empty$/gi))return e=e.replace(/:empty$/gi,""),Array.from(X.document.querySelectorAll(e)).filter(t=>t?.innerHTML?.trim()==="");if(e.match(/[^\s]{1}:contains\("(.*)"\)$/i)||e.match(/[^\s]{1}:contains\('(.*)'\)$/i)){const n=e.match(/:contains\(("|')(.*)("|')\)$/i)[2];return e=e.replace(/:contains\(("|')(.*)("|')\)$/gi,""),Array.from(X.document.querySelectorAll(e)).filter(r=>(r?.textContent||r?.innerText)?.includes(n))}else if(e.match(/[^\s]{1}:regexp\("(.*)"\)$/i)||e.match(/[^\s]{1}:regexp\('(.*)'\)$/i)){let n=e.match(/:regexp\(("|')(.*)("|')\)$/i)[2];const r=n.match(/("|'),[\s]*("|')([igm]{0,3})$/i);let o="";r&&(n=n.replace(/("|'),[\s]*("|')([igm]{0,3})$/gi,""),o=r[3]);const s=new RegExp(n,o);return e=e.replace(/:regexp\(("|')(.*)("|')\)$/gi,""),Array.from(X.document.querySelectorAll(e)).filter(i=>!!(i?.textContent||i?.innerText)?.match(s))}else return Array.from(X.document.querySelectorAll(e))}matches(e,t){if(t=t.trim(),e==null)return  false;if(t.match(/[^\s]{1}:empty$/gi))return t=t.replace(/:empty$/gi,""),e.matches(t)&&e?.innerHTML?.trim()==="";if(t.match(/[^\s]{1}:contains\("(.*)"\)$/i)||t.match(/[^\s]{1}:contains\('(.*)'\)$/i)){const r=t.match(/:contains\(("|')(.*)("|')\)$/i)[2];t=t.replace(/:contains\(("|')(.*)("|')\)$/gi,"");let o=e?.textContent||e?.innerText;return typeof o!="string"&&(o=""),e.matches(t)&&o?.includes(r)}else if(t.match(/[^\s]{1}:regexp\("(.*)"\)$/i)||t.match(/[^\s]{1}:regexp\('(.*)'\)$/i)){let r=t.match(/:regexp\(("|')(.*)("|')\)$/i)[2];const o=r.match(/("|'),[\s]*("|')([igm]{0,3})$/i);let s="";o&&(r=r.replace(/("|'),[\s]*("|')([igm]{0,3})$/gi,""),s=o[3]);const i=new RegExp(r,s);t=t.replace(/:regexp\(("|')(.*)("|')\)$/gi,"");let l=e?.textContent||e?.innerText;return typeof l!="string"&&(l=""),e.matches(t)&&!!l?.match(i)}else return e.matches(t)}closest(e,t){if(t=t.trim(),t.match(/[^\s]{1}:empty$/gi)){t=t.replace(/:empty$/gi,"");const n=e?.closest(t);return n&&n?.innerHTML?.trim()===""?n:null}else if(t.match(/[^\s]{1}:contains\("(.*)"\)$/i)||t.match(/[^\s]{1}:contains\('(.*)'\)$/i)){const r=t.match(/:contains\(("|')(.*)("|')\)$/i)[2];t=t.replace(/:contains\(("|')(.*)("|')\)$/gi,"");const o=e?.closest(t);if(o){const s=e?.textContent||e?.innerText;if(typeof s=="string"&&s.includes(r))return o}return null}else if(t.match(/[^\s]{1}:regexp\("(.*)"\)$/i)||t.match(/[^\s]{1}:regexp\('(.*)'\)$/i)){let r=t.match(/:regexp\(("|')(.*)("|')\)$/i)[2];const o=r.match(/("|'),[\s]*("|')([igm]{0,3})$/i);let s="";o&&(r=r.replace(/("|'),[\s]*("|')([igm]{0,3})$/gi,""),s=o[3]);const i=new RegExp(r,s);t=t.replace(/:regexp\(("|')(.*)("|')\)$/gi,"");const l=e?.closest(t);if(l){const c=e?.textContent||e?.innerText;if(typeof c=="string"&&c.match(i))return l}return null}else return e?.closest(t)}}class wa extends xa{getAnimationEndNameList(){return ["webkitAnimationEnd","mozAnimationEnd","MSAnimationEnd","oanimationend","animationend"]}getTransitionEndNameList(){return ["webkitTransitionEnd","mozTransitionEnd","MSTransitionEnd","otransitionend","transitionend"]}offset(e,t=true){const n=e.getBoundingClientRect(),r=e.ownerDocument.defaultView;return new DOMRect(t?parseFloat((n.left+(r?.pageXOffset||0)).toString()):n.left,t?parseFloat((n.top+(r?.pageYOffset||0)).toString()):n.top,n.width,n.height)}width(e,t=false,n){const r=this;if(typeof e=="string"&&(e=X.document.querySelector(e)),e!=null){if(F.isWin(e))return X.window.document.documentElement.clientWidth;if(e.nodeType===9)return e=e,Math.max(e.body.scrollWidth,e.documentElement.scrollWidth,e.body.offsetWidth,e.documentElement.offsetWidth,e.documentElement.clientWidth);if(t||!t&&u.isShow(e)){if(e=e,parseFloat(u.getStyleValue(e,"width").toString())>0)return parseFloat(u.getStyleValue(e,"width").toString());if(e.offsetWidth>0){const o=u.getStyleValue(e,"borderLeftWidth"),s=u.getStyleValue(e,"borderRightWidth"),i=u.getStyleValue(e,"paddingLeft"),l=u.getStyleValue(e,"paddingRight"),c=parseFloat(e.offsetWidth.toString())-parseFloat(o.toString())-parseFloat(s.toString())-parseFloat(i.toString())-parseFloat(l.toString());return parseFloat(c.toString())}return 0}else {e=e;const{cloneNode:o,recovery:s}=u.showElement(e,n),i=r.width(o,true,n);return s(),i}}}height(e,t=false,n){const r=this;if(F.isWin(e))return X.window.document.documentElement.clientHeight;if(typeof e=="string"&&(e=X.document.querySelector(e)),e!=null){if(e.nodeType===9)return e=e,Math.max(e.body.scrollHeight,e.documentElement.scrollHeight,e.body.offsetHeight,e.documentElement.offsetHeight,e.documentElement.clientHeight);if(t||!t&&u.isShow(e)){if(e=e,parseFloat(u.getStyleValue(e,"height").toString())>0)return parseFloat(u.getStyleValue(e,"height").toString());if(e.offsetHeight>0){const o=u.getStyleValue(e,"borderTopWidth"),s=u.getStyleValue(e,"borderBottomWidth"),i=u.getStyleValue(e,"paddingTop"),l=u.getStyleValue(e,"paddingBottom"),c=parseFloat(e.offsetHeight.toString())-parseFloat(o.toString())-parseFloat(s.toString())-parseFloat(i.toString())-parseFloat(l.toString());return parseFloat(c.toString())}return 0}else {e=e;const{cloneNode:o,recovery:s}=u.showElement(e,n),i=r.height(o,true,n);return s(),i}}}outerWidth(e,t=false,n){const r=this;if(F.isWin(e))return X.window.innerWidth;if(typeof e=="string"&&(e=X.document.querySelector(e)),e!=null)if(e=e,t||!t&&u.isShow(e)){const o=getComputedStyle(e,null),s=u.getStyleValue(o,"marginLeft"),i=u.getStyleValue(o,"marginRight");return e.offsetWidth+s+i}else {const{cloneNode:o,recovery:s}=u.showElement(e,n),i=r.outerWidth(o,true,n);return s(),i}}outerHeight(e,t=false,n){const r=this;if(F.isWin(e))return X.window.innerHeight;if(typeof e=="string"&&(e=X.document.querySelector(e)),e=e,t||!t&&u.isShow(e)){const o=getComputedStyle(e,null),s=u.getStyleValue(o,"marginTop"),i=u.getStyleValue(o,"marginBottom");return e.offsetHeight+s+i}else {const{cloneNode:o,recovery:s}=u.showElement(e,n),i=r.outerHeight(o,true,n);return s(),i}}addClassName(e,t){e!=null&&t!=null&&(typeof t=="function"&&(t=t()),Array.isArray(t)||(t=[t]),t.forEach(n=>{if(typeof n!="string"||n.trim()==="")return;const r=n.split(" ").filter(o=>o.trim()!=="");e?.classList?.add?.(...r);}));}removeClassName(e,t){if(e==null||typeof t!="string"||t.trim()==="")return;const n=t.split(" ").filter(r=>r.trim()!=="");e.classList.remove(...n);}containsClassName(e,t){return e==null||typeof t!="string"||t.trim()===""?false:e.classList.contains(t)}css(e,t,n){const r=this;function o(i,l){const c=["width","height","top","left","right","bottom","font-size"];return typeof l=="number"&&(l=l.toString()),typeof l=="string"&&c.includes(i)&&l.match(/[0-9]$/gi)&&(l=l+"px"),l}if(typeof e=="string"&&(e=r.selectorAll(e)),e==null)return;if(Array.isArray(e)||e instanceof NodeList){if(typeof t=="string"){if(n==null)return r.css(e[0],t);e.forEach(i=>{r.css(i,t);});return}else if(typeof t=="object"){e.forEach(i=>{r.css(i,t);});return}return}const s=(i,l)=>{typeof l=="string"&&l.trim().endsWith("!important")?(l=l.trim().replace(/!important$/gi,"").trim(),e.style.setProperty(i,l,"important")):(l=o(i,l),e.style.setProperty(i,l));};if(typeof t=="string"){if(n==null)return X.globalThis.getComputedStyle(e).getPropertyValue(t);s(t,n);}else if(typeof t=="object")for(const i in t){const l=t[i];s(i,l);}else throw new TypeError("property must be string or object")}createElement(e,t,n){const r=X.document.createElement(e);return typeof t=="string"?(ee.setSafeHTML(r,t),r):(t==null&&(t={}),n==null&&(n={}),Object.keys(t).forEach(o=>{const s=t[o];if(o==="innerHTML"){ee.setSafeHTML(r,s);return}Reflect.set(r,o,s);}),Object.keys(n).forEach(o=>{let s=n[o];typeof s=="object"?s=JSON.stringify(s):typeof s=="function"&&(s=s.toString()),r.setAttribute(o,s);}),r)}parseTextToDOM(e){return e=e.replace(/^[\n|\s]*/g,"").replace(/[\n|\s]*$/g,""),this.createElement("div",{innerHTML:e}).firstChild}getTextBoundingRect(e,t,n,r){if(!e||!("value"in e))return e;if(typeof t=="string"&&(t=parseFloat(t)),(typeof t!="number"||isNaN(t))&&(t=0),t<0?t=0:t=Math.min(e.value.length,t),typeof n=="string"&&(n=parseFloat(n)),(typeof n!="number"||isNaN(n)||n<t)&&(n=t),n<0?n=0:n=Math.min(e.value.length,n),typeof e.createTextRange=="function"){const C=e.createTextRange();return C.collapse(true),C.moveStart("character",t),C.moveEnd("character",n-t),C.getBoundingClientRect()}const o=v();let s=o.top,i=o.left;const l=S("width",true),c=S("height",true);let d="white-space:pre;padding:0;margin:0;";const p=["direction","font-family","font-size","font-size-adjust","font-variant","font-weight","font-style","letter-spacing","line-height","text-align","text-indent","text-transform","word-wrap","word-spacing"];s+=S("padding-top",true),s+=S("border-top-width",true),i+=S("padding-left",true),i+=S("border-left-width",true),i+=1;for(let C=0;C<p.length;C++){const w=p[C];d+=w+":"+S(w,false)+";";}const f=e.value||"G",b=f.length,h=document.createElement("div");t>0&&A(0,t);const m=A(t,n);b>n&&A(n,b),h.style.cssText=d,h.style.position="absolute",h.style.top=s+"px",h.style.left=i+"px",h.style.width=l+"px",h.style.height=c+"px",X.document.body.appendChild(h);const x=m.getBoundingClientRect();return r||h.parentNode.removeChild(h),x;function A(C,w){const E=document.createElement("span");return E.style.cssText=d,E.textContent=f.substring(C,w),h.appendChild(E),E}function v(){const C=document.body,w=document.defaultView,E=document.documentElement,B=document.createElement("div");B.style.paddingLeft=B.style.width="1px",C.appendChild(B);const H=B.offsetWidth==2;C.removeChild(B);const z=e.getBoundingClientRect(),Y=E.clientTop||C.clientTop||0,j=E.clientLeft||C.clientLeft||0,T=w?.pageYOffset||H&&E.scrollTop||C.scrollTop,M=w?.pageXOffset||H&&E.scrollLeft||C.scrollLeft;return {top:z.top+T-Y,left:z.left+M-j}}function S(C,w){const E=X.document.defaultView.getComputedStyle(e,null).getPropertyValue(C);return w?parseFloat(E):E}}cssHide(e,t=false){e!=null&&(t?u.addClassName(e,de.hideImportant):u.addClassName(e,de.hide));}cssShow(e){e!=null&&(u.removeClassName(e,de.hide),u.removeClassName(e,de.hideImportant));}toElement(e,t=false,n=false){function r(){const s=new DOMParser;return n?s.parseFromString(e,"text/html"):s.parseFromString(e,"text/html").body.firstChild}function o(){const s=X.document.createElement("div");return ee.setSafeHTML(s,e),n?s:s.firstChild}return t?r():o()}append(e,t){if(typeof e=="string"&&(e=X.document.querySelector(e)),e==null)return;function n(r,o){typeof t=="string"?r.insertAdjacentHTML("beforeend",ee.getSafeHTML(o)):r.appendChild(o);}if(Array.isArray(t)||t instanceof NodeList){const r=X.document.createDocumentFragment();t.forEach(o=>{typeof o=="string"&&(o=this.toElement(o,true,false)),r.appendChild(o);}),e.appendChild(r);}else n(e,t);}appendHead(e){X.document.head?X.document.head.appendChild(e):X.document.documentElement.appendChild(e);}appendBody(e){X.document.body?X.document.body.appendChild(e):X.document.documentElement.appendChild(e);}isShow(e){return !!e.getClientRects().length}showElement(e,t){const n=e.cloneNode(true);n.setAttribute("style","visibility: hidden !important;display:block !important;");let r=X.document.documentElement;const o=e.getRootNode();return t==null?o==e?r=X.document.documentElement:r=o:r=t,r.appendChild(n),{cloneNode:n,recovery(){n.remove();}}}getStyleValue(e,t){let n=null,r=null;e instanceof CSSStyleDeclaration?r=e:(n=e.ownerDocument.defaultView,(!n||!n.opener)&&(n=window),r=n.getComputedStyle(e));const o=parseFloat(r[t]);return isNaN(o)?0:o}before(e,t){typeof e=="string"&&(e=X.document.querySelector(e)),e!=null&&(typeof t=="string"?e.insertAdjacentHTML("beforebegin",ee.getSafeHTML(t)):e.parentElement.insertBefore(t,e));}after(e,t){typeof e=="string"&&(e=X.document.querySelector(e)),e!=null&&(typeof t=="string"?e.insertAdjacentHTML("afterend",ee.getSafeHTML(t)):e.parentElement.insertBefore(t,e.nextSibling));}getKeyFrames(e){const t={};return Object.keys(e.cssRules).forEach(n=>{e.cssRules[n].type===7&&e.cssRules[n].name.startsWith("pops-anim-")&&(t[e.cssRules[n].name]=e.cssRules[n]);}),t}calcColor(){function e(){return {hexToRgb:s=>{let i="";if(!/^#(?:[0-9A-Fa-f]{3}|[0-9A-Fa-f]{6}|[0-9A-Fa-f]{8})$/.test(s))return console.warn("输入错误的hex"),"";s=s.replace("#",""),i=s.match(/../g);for(let c=0;c<3;c++)i[c]=parseInt(i[c],16);return i},rgbToHex:(s,i,l)=>{const c=/^\d{1,3}$/;if(!c.test(s)||!c.test(i)||!c.test(l))return console.warn("输入错误的rgb颜色值"),"";const d=[s.toString(16),i.toString(16),l.toString(16)];for(let p=0;p<3;p++)d[p].length==1&&(d[p]=`0${d[p]}`);return `#${d.join("")}`},getDarkColor:(s,i)=>{if(!/^#(?:[0-9A-Fa-f]{3}|[0-9A-Fa-f]{6}|[0-9A-Fa-f]{8})$/.test(s))return console.warn("输入错误的hex颜色值"),"";const c=e().hexToRgb(s);for(let d=0;d<3;d++)c[d]=Math.floor(c[d]*(1-i));return e().rgbToHex(c[0],c[1],c[2])},getLightColor:(s,i)=>{if(!/^#(?:[0-9A-Fa-f]{3}|[0-9A-Fa-f]{6}|[0-9A-Fa-f]{8})$/.test(s))return console.warn("输入错误的hex颜色值"),"";const c=e().hexToRgb(s);for(let d=0;d<3;d++)c[d]=Math.floor((255-c[d])*i+c[d]);return e().rgbToHex(c[0],c[1],c[2])}}}return e()}getTransform(e){let t=0,n=0;const r=X.globalThis.getComputedStyle(e).transform;if(r!=="none"&&r!=null&&r!==""){const s=r.match(/\((.+)\)/)?.[1]?.split?.(",");t=Math.abs(parseInt(s[4])),n=Math.abs(parseInt(s[5]));}return {transformLeft:t,transformTop:n}}onInput(e,t,n){let r=false;const o=async p=>{r||await t(p);},s=()=>{r=true;},i=()=>{r=false,this.emit(e,"input",{isComposite:r});},l=this.on(e,"input",o,n),c=this.on(e,"compositionstart",s,n),d=this.on(e,"compositionend",i,n);return {off:()=>{l.off(),c.off(),d.off();}}}}const u=new wa,Z={createMask(a,e=101,t=""){return e=e-100,t.startsWith(";")&&(t=t.replace(";","")),`<div class="pops-mask" data-guid="${a}" style="z-index:${e};${t}"></div>`},createAnim(a,e,t,n="",r="",o){const s=t;let i="",l="";const c=s.position||"";t.zIndex!=null&&(i+=`z-index: ${o};`,l+=`z-index: ${o};`),s.width!=null&&(l+=`width: ${s.width};`),s.height!=null&&(l+=`height: ${s.height};`);const d=r.trim()!=="";return `
		<div class="pops-anim" anim="${s.animation||""}" style="${i}" data-guid="${a}">${t.style!=null?`<style tyle="text/css">${t.style}</style>`:""}
            ...
            <div class="pops-header-controls" data-margin>${s}</div>`;}else t.btn?.close?.enable&&(r=`
                ...
                </div>`),n=r;return n},createHeaderStyle(a,e){return {headerStyle:e?.title?.html&&e?.title?.style||"",headerPStyle:e?.title?.html?"":e?.title?.style||""}},createBottom(a,e){if(e.btn==null)return "";const t=e;if(!(e.btn?.ok?.enable||t.btn?.cancel?.enable||t.btn?.other?.enable))return "";let n="",r="",o="",s="",i="";if(e.btn.position&&(n+=`justify-content: ${e.btn.position};`),t.btn.reverse&&(n+="flex-direction: row-reverse;"),e.btn?.ok?.enable){let l="";(e.btn.ok.size==="large"||e.btn.ok.size==="small")&&(l="pops-button-"+e.btn.ok.size);let c="";const d=t.btn.ok.icon;if(d!==""){let p="";le.hasIcon(d)?p=le.getIcon(d):p=d,p=p||"",c=`<i class="pops-bottom-icon" is-loading="${e.btn.ok.iconIsLoading}">${p}</i>`;}o=`
            <button 
            ...
            </button>`;}if(t.btn?.cancel?.enable){let l="";(t.btn.cancel.size==="large"||t.btn.cancel.size==="small")&&(l="pops-button-"+t.btn.cancel.size);let c="";const d=t.btn.cancel.icon;if(d!==""){let p="";le.hasIcon(d)?p=le.getIcon(d):p=d,p=p||"",c=`<i class="pops-bottom-icon" is-loading="${t.btn.cancel.iconIsLoading}">${p}</i>`;}s=`
            <button
            ...
            </button>`;}if(t.btn?.other?.enable){let l="";(t.btn.other.size==="large"||t.btn.other.size==="small")&&(l="pops-button-"+t.btn.other.size);let c="";const d=t.btn.other.icon;if(d!==""){let p="";le.hasIcon(d)&&(p=le.getIcon(d)),p=p||"",c=`<i class="pops-bottom-icon" is-loading="${t.btn.other.iconIsLoading}">${p}</i>`;}i=`
            <button
            ...
            `;}else r=`<div class="pops-botttom-btn-controls pops-${a}-btn" style="${n}">${o}${s}${i}</div>`;return r},createContentStyle(a,e){return {contentStyle:e?.content?.html&&e?.content?.style||"",contentPStyle:e?.content?.html?"":e?.content?.style||""}},parseElement(a){return u.parseTextToDOM(a)}};var va=`@charset "utf-8";\r
.pops * {\r
...
`,Sa=`/* ::-webkit-scrollbar 是非标准的css */\r
...
`,Ea="",$a="",Ma=`.pops[type-value="prompt"] {\r
...
\r
  --pops-panel-components-input-border-radius: 4px;\r
...
.pops-panel-input_inner {\r
  ...
  border-radius: var(--pops-panel-components-input-border-radius);\r
...
`;const q={index:va,ninePalaceGridPosition:Aa,scrollbar:Sa,button:Ca,common:Ta,anim:ka,alertCSS:Ea,confirmCSS:$a,promptCSS:Ma,loadingCSS:La,iframeCSS:Ia,tooltipCSS:_a,drawerCSS:Ra,folderCSS:Na,panelCSS:Da,rightClickMenu:Oa,panelComponents_Select:Pa},et={$data:{},$flag:{isInit:false},init(){if(!this.$flag.isInit){this.$flag.isInit=true;const a=u.createElement("style",{innerHTML:q.anim});u.appendHead(a),this.$data=null,this.$data=u.getKeyFrames(a.sheet),F.setTimeout(()=>{a.remove();},50);}},hasAnim(a){return Object.prototype.hasOwnProperty.call(this.$data,a)}},he={alert:[],confirm:[],drawer:[],folder:[],iframe:[],loading:[],panel:[],prompt:[],rightClickMenu:[],tooltip:[]},me={getMaxZIndexNodeInfo(a=1,e=X.document,t){a=Number.isNaN(a)?1:a;const n=2*Math.pow(10,9);let r=0,o=null;function s(l){return l.position!=="static"&&l.display!=="none"}function i(l){if(typeof t=="function"){const d=t(l);if(typeof d=="boolean"&&!d)return}const c=X.window.getComputedStyle(l);if(s(c)){const d=parseInt(c.zIndex);isNaN(d)||d>r&&(r=d,o=l),l.shadowRoot!=null&&l instanceof ShadowRoot&&l.shadowRoot.querySelectorAll("*").forEach(p=>{i(p);});}}return e.querySelectorAll("*").forEach(l=>{i(l);}),r+=a,r>=n&&(r=n),{node:o,zIndex:r}},getPopsMaxZIndex(a=1){a=Number.isNaN(a)?1:a;const e=2*Math.pow(10,9);let t=0,n=null;function r(s){return s.position!=="static"&&s.display!=="none"}Object.keys(he).forEach(s=>{const i=he[s];for(let l=0;l<i.length;l++){const c=i[l],d=window.getComputedStyle(c.$anim);if(r(d)){const p=parseInt(d.zIndex);isNaN(p)||p>t&&(t=p,n=c.$anim);}}}),t+=a;const o=t>=e;return o&&(t=e),{zIndex:t,animElement:n,isOverMaxZIndex:o}},getMaxZIndex(a=1){return this.getMaxZIndexNodeInfo(a).zIndex},async removeInstance(a,e,t=false){const n=function(o){typeof o.beforeRemoveCallBack=="function"&&o.beforeRemoveCallBack(o),o?.$anim?.remove(),o?.$pops?.remove(),o?.$mask?.remove(),o?.$shadowContainer?.remove();},r=[];return a.forEach(o=>{o.forEach(async(s,i)=>{if(t||typeof e=="string"&&s.guid===e){const l=s.$anim.getAttribute("anim");if(et.hasAnim(l)){const c=l+"-reverse";u.css(s.$anim,"width","100%"),u.css(s.$anim,"height","100%"),u.css(s.$anim,"animation-name",c),et.hasAnim(u.css(s.$anim,"animation-name"))?r.push(new Promise(d=>{u.on(s.$anim,u.getAnimationEndNameList(),function(){n(s),d();},{capture:true});})):n(s);}else n(s);o.splice(i,1);}});}),await Promise.all(r),a},hide(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;F.setTimeout(()=>{o&&u.css(o,"display","none"),["top","bottom"].includes(c.direction)?i.style.setProperty("height","0"):["left","right"].includes(c.direction)?i.style.setProperty("width","0"):console.error("未知direction：",c.direction),s();},c.closeDelay);}else {const c=t.find(d=>d.guid===n);if(c){const d=c;if(d.$anim.style.width="100%",d.$anim.style.height="100%",Reflect.set(d.$anim.style,"animation-name",d.$anim.getAttribute("anim")+"-reverse"),et.hasAnim(Reflect.get(d.$anim.style,"animation-name"))){let p=function(){d.$anim.style.display="none",d.$mask&&(d.$mask.style.display="none"),u.off(d.$anim,u.getAnimationEndNameList(),p,{capture:true}),s();};u.on(d.$anim,u.getAnimationEndNameList(),p,{capture:true});}else d.$anim.style.display="none",d.$mask&&(d.$mask.style.display="none"),s();}}})},show(a,e,t,n,r,o){return new Promise(s=>{const i=r.querySelector(".pops[type-value]");if(e==="drawer"){const c=a;F.setTimeout(()=>{o&&u.css(o,"display","");const d=c.direction,p=c.size.toString();["top","bottom"].includes(d)?i.style.setProperty("height",p):["left","right"].includes(d)?i.style.setProperty("width",p):console.error("未知direction：",d),s();},c.openDelay??0);}else {const c=t.find(d=>d.guid===n);if(c){const d=c;if(d.$anim.style.width="",d.$anim.style.height="",Reflect.set(d.$anim.style,"animation-name",d.$anim.getAttribute("anim").replace("-reverse","")),et.hasAnim(Reflect.get(d.$anim.style,"animation-name"))){let p=function(){u.off(d.$anim,u.getAnimationEndNameList(),p,{capture:true}),s();};d.$anim.style.display="",d.$mask&&(d.$mask.style.display=""),u.on(d.$anim,u.getAnimationEndNameList(),p,{capture:true});}else d.$anim.style.display="",d.$mask&&(d.$mask.style.display=""),s();}}})},async close(a,e,t,n,r){await new Promise(async o=>{const s=r.querySelector(".pops[type-value]"),i=a;function l(){async function c(p){p.propertyName==="transform"&&(u.off(s,u.getTransitionEndNameList(),c),await me.removeInstance([t],n),o());}if(u.on(s,u.getTransitionEndNameList(),c),getComputedStyle(s).transform!=="none"){u.emit(s,u.getTransitionEndNameList(),void 0,true);return}["top"].includes(i.direction)?s.style.setProperty("transform","translateY(-100%)"):["bottom"].includes(i.direction)?s.style.setProperty("transform","translateY(100%)"):["left"].includes(i.direction)?s.style.setProperty("transform","translateX(-100%)"):["right"].includes(i.direction)?s.style.setProperty("transform","translateX(100%)"):console.error("未知direction：",i.direction);}e==="drawer"?F.setTimeout(()=>{l();},i.closeDelay):(await me.removeInstance([t],n),o());}),he.rightClickMenu.forEach(o=>{const s=o.config;if(s.$target instanceof HTMLElement){const i=s.$target.getRootNode();i instanceof HTMLElement&&i.parentElement==null&&o.destory();}}),he.tooltip.forEach(o=>{const s=o.config;if(s.$target instanceof HTMLElement){const i=s.$target.getRootNode();i instanceof HTMLElement&&i.parentElement==null&&o.destory();}});},drag(a,e){e=Object.assign({limit:true,extraDistance:3,container:X.globalThis,emitClick:true},e);let t=false,n=0,r=0;const o=F.AnyTouch(),s=new o(e.dragElement,{preventDefault(f){return typeof e.preventEvent=="function"?e.preventEvent(f):true}});u.css(e.dragElement,{cursor:"move"});function i(f){const b=f.style.transitionDuration;return globalThis.getComputedStyle(f).transitionDuration!=="0s"&&(f.style.transitionDuration="0s"),()=>{f.style.transitionDuration=b;}}function l(f){return f=f??globalThis,{width:u.width(f),height:u.height(f)}}function c(f){if(f=f??globalThis,F.isWin(f))return {left:0,top:0};{const b=f.getBoundingClientRect();return {left:b.left,top:b.top}}}let d=u.getTransform(a),p=null;s.on("pan",function(f){if(!t){t=true;const m=e.dragElement.getBoundingClientRect();n=f.x-m.left,r=f.y-m.top,d=u.getTransform(a),p=i(a);}let b=f.x-n+d.transformLeft,h=f.y-r+d.transformTop;if(f.phase==="move"){if(e.limit){const m=l(e.container).width-u.width(a)+d.transformLeft,{left:x,top:A}=c(e.container),v=l(e.container).height-u.height(a)+d.transformTop;b>m&&(b=m),h>v&&(h=v),b-e.extraDistance*2<x+d.transformLeft?(b=x+d.transformLeft,b+=e.extraDistance):b-=e.extraDistance,h-e.extraDistance*2<A+d.transformTop?(h=A+d.transformTop,h+=e.extraDistance):h-=e.extraDistance;}typeof e.moveCallBack=="function"&&e.moveCallBack(a,b,h),u.css(a,{left:b+"px",top:h+"px"});}f.phase==="end"&&(t=false,typeof p=="function"&&(p(),p=null),typeof e.endCallBack=="function"&&e.endCallBack(a,b,h));}),e.emitClick&&s.on(["tap"],function(f){f.changedPoints.forEach(b=>{u.emit(b.target,"click",void 0,true);});});},sortElementListByProperty(a,e,t=true){if(typeof t!="boolean")throw new TypeError("参数 sortByDesc 必须为boolean类型");if(a==null||e==null)throw new Error("获取前面的值或后面的值的方法不能为空");return function(n,r){const o=a(r),s=e(n);return t?s>o?-1:s<o?1:0:s<o?-1:s>o?1:0}}},N={handlerShadow(a){const e=u.createElement("div",{className:"pops-shadow-container"});if(a.useShadowRoot){const t=e.attachShadow({mode:"open"});return {$shadowContainer:e,$shadowRoot:t}}else return {$shadowContainer:e,$shadowRoot:e}},handleInit(a,e){if(et.init(),!!arguments.length&&a!=null&&e!=null){if(typeof e=="string"){if(e.trim()==="")return;e=[{css:e}];}else e=e.map(t=>typeof t=="string"?{css:t}:t);for(const t of e){const n=u.createElement("style",{},{"data-type":"PopsHandler.handleInit"});n.textContent=t.css,typeof t.name=="string"&&n.setAttribute("data-name",t.name),a.appendChild(n);}}},handleMask(a={}){const e={maskElement:u.parseTextToDOM(a.maskHTML)};let t=false;function n(o){u.preventEvent(o);const s=he[a.type];function i(){if(a.config.mask.clickEvent.toClose)return me.close(a.config,a.type,s,a.guid,a.animElement);if(a.config.mask.clickEvent.toHide)return me.hide(a.config,a.type,s,a.guid,a.animElement,e.maskElement)}return typeof a.config.mask.clickCallBack=="function"?a.config.mask.clickCallBack(i,a.config):i(),false}if(a.config.mask.clickEvent.toClose||a.config.mask.clickEvent.toHide){let o=function(s){return !!(s?.localName?.toLowerCase()==="div"&&s.className&&s.className==="pops-anim"&&s.hasAttribute("anim"))};u.on(a.animElement,["touchstart","mousedown"],s=>{const i=s.composedPath()[0];t=o(i);}),u.on(a.animElement,"click",s=>{const i=s.composedPath()[0];if(o(i)&&t)return n(s)}),u.on(e.maskElement,"click",s=>{t=true,n(s);});}return e},handleQueryElement(a,e){return {$pops:a.querySelector(".pops[type-value"),$btnOk:a.querySelector(`.pops-${e}-btn-ok`),$btnCancel:a.querySelector(`.pops-${e}-btn-cancel`),$btnOther:a.querySelector(`.pops-${e}-btn-other`),$title:a.querySelector(`.pops-${e}-title`),$input:a.querySelector(`.pops-${e}-content textarea[pops]`)?a.querySelector(`.pops-${e}-content textarea[pops]`):a.querySelector(`.pops-${e}-content input[pops]`),$headerControls:a.querySelector(".pops-header-controls"),$iframe:a.querySelector("iframe[pops]"),$loading:a.querySelector(".pops-loading"),$content:a.querySelector(`.pops-${e}-content`),$panelRightSectionWrapper:a.querySelector(`.pops-${e}-section-wrapper`),$panelLeftAside:a.querySelector(`.pops-${e}-content aside.pops-${e}-aside`),$panelContentSectionContainer:a.querySelector(`.pops-${e}-content section.pops-${e}-container`),$panelBottomWrapper:a.querySelector(`.pops-${e}-bottom-wrapper`),$panelBottomContainer:a.querySelector(`.pops-${e}-bottom-container`),$panelBottomLeftContainer:a.querySelector(`.pops-${e}-bottom-left-container`),$panelBottomRightContainer:a.querySelector(`.pops-${e}-bottom-right-container`),$contentLoading:a.querySelector(`.pops-${e}-content-global-loading`),$headerBtnMin:a.querySelector(".pops-header-control[data-type='min']"),$headerBtnMax:a.querySelector(".pops-header-control[data-type='max']"),$headerBtnMise:a.querySelector(".pops-header-control[data-type='mise']"),$headerBtnClose:a.querySelector(".pops-header-control[data-type='close']"),$folderList:a.querySelector(".pops-folder-list"),$folderHeaderNav:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div"),$folderHeaderRow:a.querySelector(".pops-folder-list .pops-folder-list-table__header-div .pops-folder-list-table__header-row"),$folderTbody:a.querySelector(".pops-folder-list .pops-folder-list-table__body-div tbody"),$folderHeaderBreadcrumbPrimary:a.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-primary"),$folderSortFileName:a.querySelector('.pops-folder-list-table__sort[data-sort="fileName"]'),$folderSortLatestTime:a.querySelector('.pops-folder-list-table__sort[data-sort="latestTime"]'),$folderSortFileSize:a.querySelector('.pops-folder-list-table__sort[data-sort="fileSize"]')}},handleEventConfig(a,e,t,n,r,o,s,i){return {$shadowContainer:t,$shadowRoot:n,$el:o,$anim:o,$pops:s,$mask:i,mode:r,guid:e,close(){return me.close(a,r,he[r],e,o)},hide(){return me.hide(a,r,he[r],e,o,i)},show(l){return l&&l.appendChild(he[r][0].$shadowRoot),me.show(a,r,he[r],e,o,i)}}},handleLoadingEventConfig(a,e,t,n,r,o){return {$el:n,$anim:n,$pops:r,$mask:o,mode:t,guid:e,close(){return me.close(a,t,he[t],e,n)},hide(){return me.hide(a,t,he[t],e,n,o)},show(){return me.show(a,t,he[t],e,n,o)}}},handleResultConfig(a){const e=Object.assign({},a);return F.delete(e,"type"),F.delete(e,"function"),e},handleClickEvent(a,e,t,n){typeof n=="function"&&u.on(e,"click",r=>{n(Object.assign(t,{type:a}),r);},{capture:true});},handleKeyboardEvent(a,e=[],t){const n=function(r){const o=r.code||r.key,s=r.charCode||r.keyCode||r.which;e.includes("ctrl")&&!r.ctrlKey||e.includes("alt")&&!r.altKey||e.includes("meta")&&!r.metaKey||e.includes("shift")&&!r.shiftKey||(typeof a=="string"&&a===o?t&&t(r):typeof a=="number"&&a===s&&t&&t(r));};return u.on(X.globalThis,"keydown",n,{capture:true}),{removeKeyboardEvent(){u.off(globalThis,"keydown",n,{capture:true});}}},handlePromptClickEvent(a,e,t,n,r){u.on(t,"click",o=>{const s={type:a,text:e.value};r(Object.assign(n,s),o);},{capture:true});},handleZIndex(a){return typeof a=="function"?a():a},handleOnly(a,e){if(e.only)if(a==="loading"||a==="tooltip"||a==="rightClickMenu"){const t=he[a];t&&me.removeInstance([t],"",true);}else me.removeInstance([he.alert,he.confirm,he.drawer,he.folder,he.iframe,he.panel,he.prompt],"",true);else {const t=e.zIndex;e.zIndex=()=>{const{zIndex:n}=me.getPopsMaxZIndex(N.handleZIndex(t)+100);return n};}return e},handlePush(a,e){he[a].push(e);}},Ba=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{position:"flex-end",ok:{size:void 0,enable:true,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback:function(a){a.close();}},close:{enable:true,callback:function(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),_t={init(a){const e=F.getRandomGUID(),t="alert";let n=Ba();n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n=N.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);N.handleInit(o,[{name:"index",css:q.index},{name:"ninePalaceGridPosition",css:q.ninePalaceGridPosition},{name:"scrollbar",css:q.scrollbar},{name:"button",css:q.button},{name:"anim",css:q.anim},{name:"common",css:q.common},{name:"alertCSS",css:q.alertCSS}]);const s=N.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:d,headerPStyle:p}=Z.createHeaderStyle(t,n),{contentStyle:f,contentPStyle:b}=Z.createContentStyle(t,n),h=Z.createAnim(e,t,n,`
			...
			<div class="pops-content pops-${t}-content" style="${f}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${b}">${n.content.text}</p>`}</div>${c}`,c,s),m=Z.parseElement(h),{$pops:x,$headerBtnClose:A,$btnOk:v,$title:S}=N.handleQueryElement(m,t);let C;const w=[m];n.mask.enable&&(C=N.handleMask({type:t,guid:e,config:n,animElement:m,maskHTML:i}).maskElement,w.push(C));const E=N.handleEventConfig(n,e,r,o,t,m,x,C),B=N.handleResultConfig(E);return N.handleClickEvent("close",A,E,n.btn.close?.callback),N.handleClickEvent("ok",v,E,n.btn.ok?.callback),u.append(o,w),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r),C!=null&&m.after(C),N.handlePush(t,{guid:e,$anim:m,$pops:x,$mask:C,$shadowContainer:r,$shadowRoot:o,config:n,destory:B.close}),n.drag&&me.drag(x,{dragElement:S,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),B}},Ha=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),Va={init(a){const e=F.getRandomGUID(),t="confirm";let n=Ha();n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n=N.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);N.handleInit(o,[{name:"index",css:q.index},{name:"ninePalaceGridPosition",css:q.ninePalaceGridPosition},{name:"scrollbar",css:q.scrollbar},{name:"button",css:q.button},{name:"anim",css:q.anim},{name:"common",css:q.common},{name:"confirmCSS",css:q.confirmCSS}]);const s=N.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:d,headerPStyle:p}=Z.createHeaderStyle(t,n),{contentStyle:f,contentPStyle:b}=Z.createContentStyle(t,n),h=Z.createAnim(e,t,n,`
            <div class="pops-title pops-${t}-title" style="text-align: ${n.title.position};${d}">${n.title.html?n.title.text:`<p pops class="pops-${t}-title-text" style="${p}">${n.title.text}</p>`}${l}</div>
                        <div class="pops-content pops-${t}-content" style="${f}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${b}">${n.content.text}</p>`}</div>${c}`,c,s),m=Z.parseElement(h),{$pops:x,$title:A,$headerBtnClose:v,$btnOk:S,$btnCancel:C,$btnOther:w}=N.handleQueryElement(m,t);let E;const B=[m];n.mask.enable&&(E=N.handleMask({type:t,guid:e,config:n,animElement:m,maskHTML:i}).maskElement,B.push(E));const H=N.handleEventConfig(n,e,r,o,t,m,x,E),z=N.handleResultConfig(H);return N.handleClickEvent("close",v,H,n.btn.close.callback),N.handleClickEvent("ok",S,H,n.btn.ok.callback),N.handleClickEvent("cancel",C,H,n.btn.cancel.callback),N.handleClickEvent("other",w,H,n.btn.other.callback),u.append(o,B),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r),E!=null&&m.after(E),N.handlePush(t,{guid:e,$anim:m,$pops:x,$mask:E,$shadowContainer:r,$shadowRoot:o,config:n,destory:z.close}),n.drag&&me.drag(x,{dragElement:A,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),z}},Ua=()=>({title:{enable:true,position:"center",text:"默认标题",html:false,style:""},content:{text:"默认内容",html:false,style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"primary",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:null},useShadowRoot:true,class:"",zIndex:1e4,only:false,direction:"right",size:"30%",lockScroll:false,closeOnPressEscape:true,openDelay:0,closeDelay:0,borderRadius:0,style:null,beforeAppendToPageCallBack(){},forbiddenScroll:false}),za={init(a){const e=F.getRandomGUID(),t="drawer";let n=Ua();n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n=N.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);N.handleInit(o,[{name:"index",css:q.index},{name:"ninePalaceGridPosition",css:q.ninePalaceGridPosition},{name:"scrollbar",css:q.scrollbar},{name:"button",css:q.button},{name:"anim",css:q.anim},{name:"common",css:q.common},{name:"drawerCSS",css:q.drawerCSS}]);const s=N.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:d,headerPStyle:p}=Z.createHeaderStyle(t,n),{contentStyle:f,contentPStyle:b}=Z.createContentStyle(t,n),h=Z.createAnim(e,t,n,`
            ...
            <div class="pops-content pops-${t}-content" style="${f}">${n.content.html?n.content.text:`<p pops class="pops-${t}-content-text" style="${b}">${n.content.text}</p>`}</div>${c}`,c,s),m=Z.parseElement(h),{$pops:x,$headerBtnClose:A,$btnCancel:v,$btnOk:S,$btnOther:C}=N.handleQueryElement(m,t),w=x,E=A,B=v,H=S,z=C;let Y;const j=[m];n.mask.enable&&(Y=N.handleMask({type:t,guid:e,config:n,animElement:m,maskHTML:i}).maskElement,j.push(Y));const T=N.handleEventConfig(n,e,r,o,t,m,w,Y),M=N.handleResultConfig(T);return w.setAttribute("direction",n.direction),n.direction==="top"?(w.style.setProperty("height","0"),w.style.setProperty("border-radius",`0px 0px ${n.borderRadius}px ${n.borderRadius}px`)):n.direction==="bottom"?(w.style.setProperty("height","0"),w.style.setProperty("border-radius",`${n.borderRadius}px ${n.borderRadius}px 0px 0px`)):n.direction==="left"?(w.style.setProperty("width","0"),w.style.setProperty("border-radius",`0px ${n.borderRadius}px 0px ${n.borderRadius}px`)):n.direction==="right"&&(w.style.setProperty("width","0"),w.style.setProperty("border-radius",`${n.borderRadius}px 0px ${n.borderRadius}px 0px`)),n.closeOnPressEscape&&N.handleKeyboardEvent("Escape",[],function(){T.close();}),[{type:"close",ele:E},{type:"cancel",ele:B},{type:"ok",ele:H},{type:"other",ele:z}].forEach(y=>{N.handleClickEvent(y.type,y.ele,T,($,O)=>{const _=n.btn[y.type].callback;typeof _=="function"&&_($,O);});}),j.forEach(y=>{y.style.setProperty("display","none"),["top"].includes(n.direction)?(w.style.setProperty("height",n.size.toString()),w.style.setProperty("transform","translateY(-100%)")):["bottom"].includes(n.direction)?(w.style.setProperty("height",n.size.toString()),w.style.setProperty("transform","translateY(100%)")):["left"].includes(n.direction)?(w.style.setProperty("width",n.size.toString()),w.style.setProperty("transform","translateX(-100%)")):["right"].includes(n.direction)&&(w.style.setProperty("width",n.size.toString()),w.style.setProperty("transform","translateX(100%)")),y.style.setProperty("display","");}),u.append(o,j),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r),F.setTimeout(()=>{F.setTimeout(()=>{w.style.setProperty("transform","");},n.openDelay);},50),Y!=null&&m.after(Y),N.handlePush(t,{guid:e,$anim:m,$pops:w,$mask:Y,$shadowContainer:r,$shadowRoot:o,config:n,destory:M.close}),M}},Fa=()=>({$parent:document.body||document.documentElement,content:{text:"加载中...",icon:"loading",style:""},useShadowRoot:true,class:"",only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",forbiddenScroll:false,isAbsolute:false,style:null,addIndexCSS:true}),Rt={init(a){const e=F.getRandomGUID(),t="loading";let n=Fa();n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n=N.handleOnly(t,n);const r=N.handleZIndex(n.zIndex),o=Z.createMask(e,r),{contentPStyle:s}=Z.createContentStyle("loading",n),i=Z.createAnim(e,t,n,`
            ...
            </div>${b}`,b,d),A=Z.parseElement(x),{$pops:v,$title:S,$content:C,$folderTbody:w,$folderHeaderBreadcrumbPrimary:E,$headerBtnClose:B,$btnOk:H,$btnCancel:z,$btnOther:Y,$folderSortFileName:j,$folderSortLatestTime:T,$folderSortFileSize:M}=N.handleQueryElement(A,t);let k;const y=[A];n.mask.enable&&(k=N.handleMask({type:t,guid:e,config:n,animElement:A,maskHTML:p}).maskElement,y.push(k));const $=N.handleEventConfig(n,e,r,o,t,A,v,k),O=N.handleResultConfig($);N.handleClickEvent("close",B,$,n.btn.close.callback),N.handleClickEvent("ok",H,$,n.btn.ok.callback),N.handleClickEvent("cancel",z,$,n.btn.cancel.callback),N.handleClickEvent("other",Y,$,n.btn.other.callback),u.append(o,y),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r),k!=null&&A.after(k);class _{init(){n.folder.sort(),this.initFolderView(n.folder);const V=E.querySelector(".pops-folder-list .pops-folder-file-list-breadcrumb-allFiles:first-child");Reflect.set(V,"data-config",n.folder),u.on(V,"click",R=>{this.setBreadcrumbClickEvent(R,true,n.folder);}),u.on(j.closest("th"),"click",R=>{this.arrowToSortFolderInfoView(j,R,"fileName");},{capture:true}),u.on(T.closest("th"),"click",R=>{this.arrowToSortFolderInfoView(T,R,"latestTime");},{capture:true}),u.on(M.closest("th"),"click",R=>{this.arrowToSortFolderInfoView(M,R,"fileSize");},{capture:true}),n.sort.name==="fileName"?u.emit(j,"click",{notChangeSortRule:true}):n.sort.name==="latestTime"?u.emit(T,"click",{notChangeSortRule:true}):n.sort.name==="fileSize"&&u.emit(M,"click",{notChangeSortRule:true});}createFolderRowElement(V,R="-",G="-",ne=false){const J=V,ae=R,ye=G,ve=u.createElement("tr"),ge=u.createElement("td"),be=u.createElement("td"),Me=u.createElement("td");let Ke="",Be=fe.folder;if(ne)R="",G="";else {Be="",typeof R=="number"&&(R=F.formatTime(R)),typeof G=="number"&&(G=F.formatByteToSize(G));for(const Et in fe)if(V.toLowerCase().endsWith("."+Et)){Ke=Et,Be=Reflect.get(fe,Et);break}Be||(Ke="Null",Be=fe.Null);}ve.className="pops-folder-list-table__body-row",ge.className="pops-folder-list-table__body-td",be.className="pops-folder-list-table__body-td",Me.className="pops-folder-list-table__body-td",ee.setSafeHTML(ge,`
				<div class="pops-folder-list-file-name cursor-p">
					<div>
						<img src="${Be}" alt="${Ke}" class="pops-folder-list-file-icon u-file-icon u-file-icon--list">
						<a title="${V}" class="pops-folder-list-file-name-title-text inline-block-v-middle text-ellip list-name-text">
						${V}
						</a>
					</div>
				</div>
            `),ee.setSafeHTML(be,`
				...
				`);const dt={fileName:J,latestTime:ae,fileSize:ye,isFolder:ne};return Reflect.set(ge,"__value__",dt),Reflect.set(be,"__value__",dt),Reflect.set(Me,"__value__",dt),Reflect.set(ve,"__value__",dt),ve.appendChild(ge),ve.appendChild(be),ve.appendChild(Me),{folderElement:ve,fileNameElement:ge,fileTimeElement:be,fileFormatSize:Me}}createFolderRowElementByMobile(V,R="-",G="-",ne=false){const J=V,ae=R,ye=G,ve=u.createElement("tr"),ge=u.createElement("td");let be="",Me=fe.folder;if(ne)R="",G="";else {Me="",typeof R=="number"&&(R=F.formatTime(R)),typeof G=="number"&&(G=F.formatByteToSize(G));for(const Be in fe)if(V.toLowerCase().endsWith("."+Be)){be=Be,Me=Reflect.get(fe,Be);break}Me||(be="Null",Me=fe.Null);}ve.className="pops-folder-list-table__body-row",ge.className="pops-folder-list-table__body-td",ee.setSafeHTML(ge,`
				<div class="pops-folder-list-file-name pops-mobile-folder-list-file-name cursor-p">
					<img src="${Me}" alt="${be}" class="pops-folder-list-file-icon u-file-icon u-file-icon--list">
					<div>
						<a title="${V}" class="pops-folder-list-file-name-title-text inline-block-v-middle text-ellip list-name-text">${V}</a>
						<span>${R} ${G}</span>
					</div>
				</div>
			`);const Ke={fileName:J,latestTime:ae,fileSize:ye,isFolder:ne};return Reflect.set(ge,"__value__",Ke),Reflect.set(ve,"__value__",Ke),ve.appendChild(ge),{folderElement:ve,fileNameElement:ge}}clearFolderInfoView(){ee.setSafeHTML(w,"");}createHeaderArrowIcon(){return u.createElement("div",{className:"iconArrow"})}createBreadcrumb(V,R){return u.createElement("span",{className:"pops-folder-file-list-breadcrumb-allFiles cursor-p",innerHTML:`<a>${V}</a>`,"data-config":R},{title:V})}setBreadcrumbClickEvent(V,R,G){this.clearFolderInfoView();const J=V.target.closest("span.pops-folder-file-list-breadcrumb-allFiles");if(J)for(;J.nextElementSibling;)J.nextElementSibling.remove();else console.error("获取导航按钮失败");const ae=Rt.init({$parent:C,content:{text:"获取文件列表中..."},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},addIndexCSS:false});this.initFolderView(G),ae.close();}async enterFolder(V,R){this.clearFolderInfoView();const G=Rt.init({$parent:C,content:{text:"获取文件列表中..."},mask:{enable:true},addIndexCSS:false});if(typeof R.clickEvent=="function"){const ne=await R.clickEvent(V,R);E.appendChild(this.createHeaderArrowIcon());const J=this.createBreadcrumb(R.fileName,ne);E.appendChild(J),u.on(J,"click",ae=>{this.setBreadcrumbClickEvent(ae,false,ne);}),this.initFolderView(ne);}G.close();}async downloadFile(V,R,G){u.preventEvent(V);const ne=R.querySelector("a");if(typeof G.clickEvent=="function"){const J=await G.clickEvent(V,G);if(J!=null&&typeof J=="object"&&!Array.isArray(J)&&typeof J.url=="string"&&J.url.trim()!==""&&(ne.setAttribute("href",J.url),ne.setAttribute("target","_blank"),J.autoDownload))if((J.mode==null||String(J.mode)==="")&&(J.mode="aBlank"),J.mode==="a"||J.mode==="aBlank"){const ae=u.createElement("a");J.mode==="aBlank"&&ae.setAttribute("target","_blank"),ae.href=J.url,ae.click();}else if(J.mode==="open"||J.mode==="openBlank")J.mode==="openBlank"?globalThis.open(J.url,"_blank"):globalThis.open(J.url);else if(J.mode==="iframe"){const ae=u.createElement("iframe");ae.src=J.url,ae.onload=function(){F.setTimeout(()=>{ae.remove();},1e3);},o.appendChild(ae),F.setTimeout(()=>{ae.remove();},180*1e3);}else console.error("未知的下载模式",J);}}sortFolderConfig(V,R="fileName",G=false){if(R==="fileName"){const ne=V.filter(ae=>ae.isFolder),J=V.filter(ae=>!ae.isFolder);return ne.sort((ae,ye)=>{const ve=ae[R].toString(),ge=ye[R].toString();let be=ve.localeCompare(ge);return G&&(be>0?be=-1:be<0&&(be=1)),be}),J.sort((ae,ye)=>{const ve=ae[R].toString(),ge=ye[R].toString();let be=ve.localeCompare(ge);return G&&(be>0?be=-1:be<0&&(be=1)),be}),G?[...J,...ne]:[...ne,...J]}else return V.sort((ne,J)=>{let ae=ne[R],ye=J[R];return R==="fileSize"?(ae=parseFloat(ae.toString()),ye=parseFloat(ye.toString())):R==="latestTime"&&(ae=new Date(ae).getTime(),ye=new Date(ye).getTime()),ae>ye?G?-1:1:ae<ye?G?1:-1:0}),V}initFolderView(V){this.sortFolderConfig(V,n.sort.name,n.sort.isDesc),V.forEach(R=>{if(R.isFolder){const{folderElement:G,fileNameElement:ne}=F.isPhone()?this.createFolderRowElementByMobile(R.fileName,"","",true):this.createFolderRowElement(R.fileName,"","",true);u.on(ne,"click",J=>{this.enterFolder(J,R);}),w.appendChild(G);}else {const{folderElement:G,fileNameElement:ne}=F.isPhone()?this.createFolderRowElementByMobile(R.fileName,R.latestTime,R.fileSize,false):this.createFolderRowElement(R.fileName,R.latestTime,R.fileSize,false);u.on(ne,"click",J=>{this.downloadFile(J,ne,R);}),w.appendChild(G);}});}removeArrowActiveStatus(){[...Array.from(j.querySelectorAll(".pops-folder-icon-active")),...Array.from(T.querySelectorAll(".pops-folder-icon-active")),...Array.from(M.querySelectorAll(".pops-folder-icon-active"))].forEach(V=>V.classList.remove("pops-folder-icon-active"));}changeArrowActive(V,R,G){this.removeArrowActiveStatus(),G?R.classList.add("pops-folder-icon-active"):V.classList.add("pops-folder-icon-active");}arrowToSortFolderInfoView(V,R,G){Reflect.get(R,"notChangeSortRule")||(n.sort.name=G,n.sort.isDesc=!n.sort.isDesc);const J=V.querySelector(".pops-folder-icon-arrow-up"),ae=V.querySelector(".pops-folder-icon-arrow-down");if(this.changeArrowActive(J,ae,n.sort.isDesc),typeof n.sort.callback=="function"&&n.sort.callback(V,R,n.sort.name,n.sort.isDesc))return;const ye=[];Array.from(w.children).forEach(ge=>{const be=Reflect.get(ge,"__value__");Reflect.set(be,"target",ge),ye.push(be);}),this.sortFolderConfig(ye,n.sort.name,n.sort.isDesc).forEach(ge=>{w.appendChild(ge.target);});}}const D=new _;return D.init(),Reflect.set(v,"data-pops-folder",D),n.drag&&me.drag(v,{dragElement:S,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),N.handlePush(t,{guid:e,$anim:A,$pops:v,$mask:k,$shadowContainer:r,$shadowRoot:o,config:n,destory:O.close}),O}},Ga=()=>({title:{position:"center",text:"",html:false,style:""},loading:{enable:true,icon:true,text:""},useShadowRoot:true,class:"",url:window.location.href,only:false,zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},animation:"pops-anim-fadein-zoom",position:"center",drag:true,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",topRightButton:"min|max|mise|close",sandbox:false,forbiddenScroll:false,loadEndCallBack(){},btn:{min:{callback(){}},max:{callback(){}},mise:{callback(){}},close:{callback(){}}},style:null,beforeAppendToPageCallBack(){}}),Wa={init(a){const e=F.getRandomGUID(),t="iframe";let n=Ga();if(n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n.url==null)throw new TypeError("config.url must not be null.");n=N.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);N.handleInit(o,[{name:"index",css:q.index},{name:"ninePalaceGridPosition",css:q.ninePalaceGridPosition},{name:"scrollbar",css:q.scrollbar},{name:"anim",css:q.anim},{name:"common",css:q.common},{name:"iframeCSS",css:q.iframeCSS}]);const s=n.animation!=null&&n.animation!=""?"position:absolute;":"",i=N.handleZIndex(n.zIndex),l=Z.createMask(e,i,s),c=Z.createHeader(t,n),d='<div class="pops-loading"></div>',p=n.title.text.trim()!==""?n.title.text:n.url,{headerStyle:f,headerPStyle:b}=Z.createHeaderStyle(t,n),h=Z.createAnim(e,t,n,`
      ...
      `,"",s),f=Z.parseElement(p),{$pops:b,$headerBtnClose:h,$title:m,$content:x,$panelRightSectionWrapper:A,$panelLeftAside:v,$panelContentSectionContainer:S,$panelBottomWrapper:C,$panelBottomContainer:w,$panelBottomLeftContainer:E,$panelBottomRightContainer:B}=N.handleQueryElement(f,t);(n.isMobile||F.isPhone())&&u.addClassName(b,n.mobileClassName);let H;const z=[f];n.mask.enable&&(H=N.handleMask({type:t,guid:e,config:n,animElement:f,maskHTML:i}).maskElement,z.push(H));const Y=N.handleEventConfig(n,e,r,o,t,f,b,H),j=N.handleResultConfig(Y);return N.handleClickEvent("close",h,Y,n.btn?.close?.callback),u.append(o,z),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r),H!=null&&f.after(H),tr().init({config:n,$el:{$pops:b,$content:x,$panelRightSectionWrapper:A,$panelLeftAside:v,$panelContentSectionContainer:S,$panelBottomWrapper:C,$panelBottomContainer:w,$panelBottomLeftContainer:E,$panelBottomRightContainer:B}}),N.handlePush(t,{guid:e,$anim:f,$pops:b,$mask:H,$shadowContainer:r,$shadowRoot:o,config:n,destory:j.close}),n.drag&&me.drag(b,{dragElement:m,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),{...j,addEventListener:(M,k,y)=>{b.addEventListener(M,k,y);},removeEventListener:(M,k,y)=>{b.removeEventListener(M,k,y);}}}},Ja=()=>({title:{text:"默认标题",position:"left",html:false,style:""},content:{text:"",select:false,password:false,row:false,focus:true,placeholder:"默认提示",style:""},btn:{merge:false,mergeReverse:false,reverse:false,position:"flex-end",ok:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"确定",type:"success",callback(a){a.close();}},cancel:{enable:true,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"关闭",type:"default",callback(a){a.close();}},other:{enable:false,size:void 0,icon:void 0,rightIcon:false,iconIsLoading:false,text:"其它按钮",type:"default",callback(a){a.close();}},close:{enable:true,callback(a){a.close();}}},useShadowRoot:true,class:"",only:false,width:window.innerWidth<550?"88vw":"350px",height:window.innerHeight<450?"70vh":"200px",position:"center",animation:"pops-anim-fadein-zoom",zIndex:1e4,mask:{enable:false,clickEvent:{toClose:false,toHide:false},clickCallBack:null},drag:false,dragLimit:true,dragExtraDistance:3,dragMoveCallBack(){},dragEndCallBack(){},forbiddenScroll:false,style:null,beforeAppendToPageCallBack(){}}),Za={init(a){const e=F.getRandomGUID(),t="prompt";let n=Ja();n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n=N.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);N.handleInit(o,[{name:"index",css:q.index},{name:"ninePalaceGridPosition",css:q.ninePalaceGridPosition},{name:"scrollbar",css:q.scrollbar},{name:"button",css:q.button},{name:"anim",css:q.anim},{name:"common",css:q.common},{name:"promptCSS",css:q.promptCSS}]);const s=N.handleZIndex(n.zIndex),i=Z.createMask(e,s),l=Z.createHeader(t,n),c=Z.createBottom(t,n),{headerStyle:d,headerPStyle:p}=Z.createHeaderStyle(t,n),{contentPStyle:f}=Z.createContentStyle(t,n),b=Z.createAnim(e,t,n,`
            <div class="pops-title pops-${t}-title" style="text-align: ${n.title.position};${d}">${n.title.html?n.title.text:`<p pops class="pops-${t}-title-text" style="${p}">${n.title.text}</p>`}${l}</div>
            <div class="pops-content pops-${t}-content" style="${f}">${n.content.row?'<textarea name="pops-input-text" pops="" placeholder="'+n.content.placeholder+'"></textarea>':'<input name="pops-input-text" pops="" placeholder="'+n.content.placeholder+'" type="'+(n.content.password?"password":"text")+'">'}</div>${c}`,c,s),h=Z.parseElement(b),{$pops:m,$input:x,$headerBtnClose:A,$btnOk:v,$btnCancel:S,$btnOther:C,$title:w}=N.handleQueryElement(h,t);let E;const B=[h];n.mask.enable&&(E=N.handleMask({type:t,guid:e,config:n,animElement:h,maskHTML:i}).maskElement,B.push(E));const H=N.handleEventConfig(n,e,r,o,t,h,m,E),z=N.handleResultConfig(H);return x.value=n.content.text,N.handlePromptClickEvent("close",x,A,H,n.btn.close.callback),N.handlePromptClickEvent("ok",x,v,H,n.btn.ok.callback),N.handlePromptClickEvent("cancel",x,S,H,n.btn.cancel.callback),N.handlePromptClickEvent("other",x,C,H,n.btn.other.callback),u.append(o,B),typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r),E!=null&&h.after(E),N.handlePush(t,{guid:e,$anim:h,$pops:m,$mask:E,$shadowContainer:r,$shadowRoot:o,config:n,destory:z.close}),n.drag&&me.drag(m,{dragElement:w,limit:n.dragLimit,extraDistance:n.dragExtraDistance,moveCallBack:n.dragMoveCallBack,endCallBack:n.dragEndCallBack}),n.content.focus&&x.focus(),n.content.select&&x.select(),z}},es=()=>({$target:document.documentElement,targetSelector:null,position:"fixed",data:[{icon:le.getIcon("search"),iconIsLoading:false,text:"搜索",item:[],callback(a,e,t){console.log("点击："+this.text,[a,e,t]);}},{icon:le.getIcon("documentCopy"),iconIsLoading:false,text:"复制",item:[],callback(a,e,t){console.log("点击："+this.text,[a,e,t]);}},{icon:le.getIcon("delete"),text:"删除",iconIsLoading:false,item:[],callback(a,e,t){console.log("点击："+this.text,[a,e,t]);}},{icon:le.getIcon("loading"),iconIsLoading:true,text:"加载",item:[],callback(a,e,t){return console.log("点击："+this.text,[a,e,t]),false}},{icon:le.getIcon("elemePlus"),iconIsLoading:true,text:"饿了么",callback(a,e,t){return console.log("点击："+this.text,[a,e,t]),false},item:[{icon:"",iconIsLoading:false,text:"处理文件",item:[],callback(a,e,t){console.log("点击："+this.text,[a,e,t]);}},{icon:"",iconIsLoading:false,text:"其它处理",callback(a,e,t){return console.log("点击："+this.text,[a,e,t]),false},item:[{icon:le.getIcon("view"),iconIsLoading:false,text:"查看",item:[],callback(a,e,t){console.log("点击："+this.text,[a,e,t]);}}]}]}],chileMenuLeftOrRightDistance:0,childMenuTopOrBottomDistance:0,useShadowRoot:true,className:"",isAnimation:false,useScaleAnimation:true,only:false,zIndex:1e4,preventDefault:true,style:null,beforeAppendToPageCallBack(){},limitPositionXInView:true,limitPositionYInView:true,beforeShowCallBack(){}}),ts={init(a){const e=F.getRandomGUID(),t="rightClickMenu";let n=es();n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n=N.handleOnly(t,n);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);if(N.handleInit(o,[{name:"index",css:q.index},{name:"anim",css:q.anim},{name:"common",css:q.common},{name:"rightClickMenu",css:q.rightClickMenu}]),n.style!=null){const i=u.createElement("style",{innerHTML:n.style},{type:"text/css"});o.appendChild(i);}const s={$data:{menuDataKey:"data-menu"},$el:{$root:null},windowCheckClickEvent(i){if(!s.$el.$root)return;const l=i.target;if(!l.closest(`.pops-${t}`)){if(l.className&&l.className==="pops-shadow-container"&&l.shadowRoot!=null){s.shadowRootCheckClickEvent(i);return}s.closeAllMenu(s.$el.$root);}},shadowRootCheckClickEvent(i){!s.$el.$root||i.composedPath()[0].closest(`.pops-${t}`)||s.closeAllMenu(s.$el.$root);},addWindowCheckClickListener(){if(u.on(globalThis,"click touchstart",s.windowCheckClickEvent,{capture:true}),n.$target instanceof Node){const i=n.$target.getRootNode();i instanceof ShadowRoot&&u.on(i,"click touchstart",s.shadowRootCheckClickEvent,{capture:true});}},removeWindowCheckClickListener(){if(u.off(globalThis,"click touchstart",s.windowCheckClickEvent,{capture:true}),n.$target instanceof Node){const i=n.$target.getRootNode();i instanceof ShadowRoot&&u.off(i,"click touchstart",s.windowCheckClickEvent,{capture:true});}},async contextMenuEvent(i,l){n.preventDefault&&u.preventEvent(i),N.handleOnly(t,n),s.$el.$root&&s.closeAllMenu(s.$el.$root),l=l??n.$target;const c=await n?.beforeShowCallBack(i);if(typeof c=="boolean"&&!c)return;const d=s.showMenu(i,n.data,l);s.$el.$root=d,n.only&&N.handlePush(t,{$shadowRoot:o,$shadowContainer:r,guid:e,$anim:d,$pops:d,beforeRemoveCallBack(p){s.closeAllMenu(p.$pops);},config:n,destory:()=>{s.closeAllMenu(d);}});},addContextMenuEvent(i,l){u.on(i,"contextmenu",l,s.contextMenuEvent);},removeContextMenuEvent(i,l){u.off(i,"contextmenu",l,s.contextMenuEvent);},animationCloseMenu(i){const l=c=>{u.off(i,u.getTransitionEndNameList(),l,{capture:true}),i.remove();};u.containsClassName(i,`pops-${t}-anim-show`)?(u.on(i,u.getTransitionEndNameList(),l,{capture:true}),u.removeClassName(i,`pops-${t}-anim-show`)):u.containsClassName(i,`pops-${t}-anim-scale`)&&u.containsClassName(i,`pops-${t}-anim-scale-open`)?(u.on(i,u.getTransitionEndNameList(),l,{capture:true}),u.removeClassName(i,`pops-${t}-anim-scale-open`),u.addClassName(i,`pops-${t}-anim-scale-not-open`)):i.remove();},closeAllMenu(i){if(i==null)return;const l=Reflect.get(i,s.$data.menuDataKey);l?.root&&(i=l.root),l.child.forEach(d=>{this.animationCloseMenu(d);}),this.animationCloseMenu(i),s.$el.$root=null;},createMenuContainerElement(i){const l=u.createElement("div",{className:`pops-${t}`,innerHTML:`<ul class="pops-${t}-wrapper"></ul>`},{"data-position":n.position}),c=this.getMenuZIndex();return c>1e4&&(l.style.zIndex=c.toString()),i&&l.setAttribute("is-children","true"),n.isAnimation&&u.addClassName(l,`pops-${t}-anim-grid`),n.useScaleAnimation&&(u.addClassName(l,`pops-${t}-anim-scale`),u.addClassName(l,`pops-${t}-anim-scale-not-open`)),l},getMenuZIndex(){return N.handleZIndex(n.zIndex)},getOffset(i,l,c){const d={top:0,right:0,bottom:0,left:0},p=u.width(i),f=u.height(i),b=1;let h=u.width(globalThis)-b,m=u.height(globalThis)-b;n.position==="absolute"&&(h+=globalThis.scrollX,m+=globalThis.scrollY);const x=h-p,A=m-f,v=n.chileMenuLeftOrRightDistance,S=n.childMenuTopOrBottomDistance;let C=l.x,w=l.y;if(C=C<0?0:C,w=w<0?0:w,n.limitPositionXInView&&C+v>=x){if(c){const E=u.offset(c.$menu);C=h-E.left-v+b;}else C=b+v;C<0?C=0:C>x&&(C=x),d.right=C,Reflect.deleteProperty(d,"left");}else C=C+v,d.left=C,Reflect.deleteProperty(d,"right");if(n.limitPositionYInView&&w+S>=A){if(c){const E=u.offset(c.$parentItem,false);w=m-E.bottom-S+b;}else w=b+S;w<0?w=b:w>A&&(w=A),d.bottom=w,Reflect.deleteProperty(d,"top");}else w=w+S,d.top=w,Reflect.deleteProperty(d,"bottom");return d},showMenu(i,l,c){const d=this.createMenuContainerElement(false);return Reflect.set(d,s.$data.menuDataKey,{child:[]}),s.addMenuLiELement(i,d,d,l,c),u.append(o,d),document.contains(r)||(typeof n.beforeAppendToPageCallBack=="function"&&n.beforeAppendToPageCallBack(o,r),u.appendBody(r)),this.handlerShowMenuCSS(d,i),d},showClildMenu(i,l,c,d,p,f){const b=this.createMenuContainerElement(true);Reflect.set(b,s.$data.menuDataKey,{parent:p,root:d}),Reflect.get(d,s.$data.menuDataKey).child.push(b),s.addMenuLiELement(i,d,b,c,f),u.append(o,b);const m=p.closest(".pops-rightClickMenu");return this.handlerShowMenuCSS(b,l,{$menu:m,$parentItem:p}),b},handlerShowMenuCSS(i,l,c){const d=this.getOffset(i,{x:l.clientX,y:l.clientY},c);u.css(i,{...d}),n.isAnimation&&u.addClassName(i,`pops-${t}-anim-show`),n.useScaleAnimation&&(u.removeClassName(i,`pops-${t}-anim-scale-not-open`),u.addClassName(i,`pops-${t}-anim-scale-open`));},addMenuLiELement(i,l,c,d,p){const f=i.target,b=c.querySelector("ul");d.forEach(h=>{const m=u.parseTextToDOM("<li></li>");if(typeof h.icon=="string"&&h.icon.trim()!==""){const C=le.getIcon(h.icon)??h.icon,w=u.parseTextToDOM(`<i class="pops-${t}-icon" is-loading="${h.iconIsLoading??false}">${C}</i>`);m.appendChild(w);}const x=typeof h.text=="function"?h.text():h.text;m.insertAdjacentHTML("beforeend",ee.getSafeHTML(`<span>${x}</span>`)),h.item&&Array.isArray(h.item)&&u.addClassName(m,`pops-${t}-item`);let A=false;function v(C){if(C.type==="touchstart"&&(A=true),A&&C.type==="mouseenter")return;Array.from(b.children).forEach(H=>{u.removeClassName(H,`pops-${t}-is-visited`);const z=Reflect.get(H,s.$data.menuDataKey);if(!z)return;function Y(j){j&&(j.querySelectorAll("ul li").forEach(T=>{const M=Reflect.get(T,s.$data.menuDataKey);M?.child&&Y(M.child);}),j.remove());}Y(z.child);});const w=Reflect.get(l,s.$data.menuDataKey);for(let H=0;H<w.child.length;H++){const z=w.child[H];o.contains(z)||(w.child.splice(H,1),H--);}if(u.addClassName(m,`pops-${t}-is-visited`),!h.item)return;const E=m.getBoundingClientRect(),B=s.showClildMenu(i,{clientX:E.left+u.outerWidth(m),clientY:E.top},h.item,l,m,p);Reflect.set(m,s.$data.menuDataKey,{child:B});}async function S(C){if(typeof h.callback=="function"){try{Bn.Object.defineProperty(i,"target",{get(){return f}});}catch{}const w=await h.callback(C,i,m,p);if(typeof w=="boolean"&&w==false)return}Array.from(b.children).forEach(w=>{u.off(w,"mouseenter touchstart");}),s.closeAllMenu(l);}u.on(m,"mouseenter touchstart",v),u.on(m,"click",S),b.appendChild(m);});}};return s.addContextMenuEvent(n.$target,n.targetSelector),s.addWindowCheckClickListener(),{guid:e,config:n,addWindowCheckClickListener:s.addWindowCheckClickListener,removeWindowCheckClickListener:s.removeWindowCheckClickListener,addContextMenuEvent:s.addContextMenuEvent,removeContextMenuEvent:s.removeContextMenuEvent,removeInitEventListener:{contextMenu(){s.removeContextMenuEvent(n.$target,n.targetSelector);},windowClick(){s.removeWindowCheckClickListener();}},PopsContextMenu:s}}},ns=()=>{const a=[];for(let e=0;e<10;e++)a.push({value:`测试${e}`,enableDeleteButton:true,deleteButtonClickCallback(t,n,r,o){const s=r.value;return console.log("删除当前项："+s,[t,n,r,o]),true},itemView(t){return `${t.value}-html`},clickCallback(t,n,r,o){const s=e%2===0,i=r.value;return s?console.log("item项的点击回调,更新input内的值："+i,[t,n,r,o,i]):console.log("item项的点击回调："+i,[t,n,r,o,i]),s},selectCallback(t,n,r,o){const s=r.value;console.log("item项的选中回调："+s,[t,n,r,o]);}});return {$target:null,$inputTarget:null,$selfDocument:document,data:a,useShadowRoot:true,className:"",isAbsolute:true,isAnimation:false,useFoldAnimation:true,useArrow:false,width:"250px",maxHeight:"300px",followTargetWidth:true,topDistance:0,position:"auto",positionTopToReverse:true,zIndex:1e4,searchingTip:"正在搜索中...",toSearhNotResultHTML:'<li data-none="true">暂无其它数据</li>',toHideWithNotResult:false,followPosition:"target",async inputTargetChangeRefreshShowDataCallback(e,t){return console.log("当前输入框的值是：",e),t.filter(n=>n.value.includes(e))},style:""}},rs={init(a){const e=F.getRandomGUID(),t="searchSuggestion";let n=ns();n=F.assign(n,we.getGlobalConfig()),n=F.assign(n,a),n.$inputTarget==null&&(n.$inputTarget=n.$target);const{$shadowContainer:r,$shadowRoot:o}=N.handlerShadow(n);if(N.handleInit(o,[{name:"index",css:q.index},{name:"anim",css:q.anim},{name:"common",css:q.common}]),n.style!=null){const l=u.createElement("style",{type:"text/css",innerHTML:n.style});o.appendChild(l);}const s={capture:true,passive:true},i={selfDocument:n.$selfDocument,$el:{root:null,$dropdownWrapper:null,$dropdownContainer:null,$arrow:null,$dynamicCSS:null},$evt:{offInputChangeEvtHandler:[]},$data:{isEmpty:true,storeNodeHandlerKey:"data-SearchSuggestion"},init(l=document.body||document.documentElement){i.initEl(),i.update(i.getData()),i.updateStyleSheet(),i.hide(),o.appendChild(i.$el.root),l.appendChild(r);},initEl(){i.$el.root=i.createSearchSelectElement(),Reflect.set(i.$el.root,this.$data.storeNodeHandlerKey,i),i.$el.$dynamicCSS=i.$el.root.querySelector("style[data-dynamic]"),i.$el.$dropdownWrapper=i.$el.root.querySelector(`.pops-${t}-search-suggestion-dropdown-wrapper`),i.$el.$dropdownContainer=i.$el.root.querySelector(`ul.pops-${t}-search-suggestion-dropdown-container`),i.$el.$arrow=i.$el.root.querySelector(`.pops-${t}-search-suggestion-arrow`);},getData(){return typeof n.data=="function"?n.data():n.data},setData(l){n.data=l;},createSearchSelectElement(){const l=u.createElement("div",{className:`pops pops-${t}-search-suggestion`,innerHTML:`
						<style type="text/css">
							.pops-${t}-animation{
            ...
            <div class="pops-${t}-search-suggestion-dropdown-wrapper">
              <ul class="pops-${t}-search-suggestion-dropdown-container ${de.userSelectNone}">${n.toSearhNotResultHTML}</ul>
            </div>
            <!-- 箭头 -->
        ...
        .pops-${t}-search-suggestion-dropdown-wrapper{
				...
				`},getItemDataValue(l){return l},createSearchItemLiElement(l,c){const d=i.getItemDataValue(l),p=u.createElement("li",{className:`pops-${t}-search-suggestion-dropdown-item`,"data-index":c,"data-value":d});Reflect.set(p,"data-index",c),Reflect.set(p,"data-value",d);const f=l.itemView(l,p,n);typeof f=="string"?ee.setSafeHTML(p,f):u.append(p,f);const b=l.enableDeleteButton;if(typeof b=="boolean"&&b){const h=i.createItemDeleteIcon();u.append(p,h);}return u.addClassName(p,de.flexCenter),u.addClassName(p,de.flexYCenter),p},setSearchItemClickEvent(l){u.on(l,"click",async c=>{u.preventEvent(c);const d=c.target,p=i.getData(),f=Reflect.get(l,"data-value");if(!!d.closest(`.pops-${t}-delete-icon`)){if(typeof f.deleteButtonClickCallback=="function"){const h=await f.deleteButtonClickCallback(c,l,f,n);typeof h=="boolean"&&h&&(p.splice(p.indexOf(f),1),l.remove());}i.$el.$dropdownContainer.children.length||i.clear(),i.updateStyleSheet();}else if(typeof f.clickCallback=="function"){const h=await f.clickCallback(c,l,f,n);typeof h=="boolean"&&h&&(n.$inputTarget instanceof HTMLInputElement||n.$inputTarget instanceof HTMLTextAreaElement)&&(n.$inputTarget.value=String(f.value));}},{capture:true});},setSearchItemSelectEvent(l){},setInputChangeEvent(l=s){if(!(n.$inputTarget instanceof HTMLInputElement||n.$inputTarget instanceof HTMLTextAreaElement))return;n.$inputTarget.setAttribute("autocomplete","off");const c=u.onInput(n.$inputTarget,async()=>{const d=i.getData(),p=await n.inputTargetChangeRefreshShowDataCallback(n.$inputTarget.value,d,n);i.update(p),i.updateStyleSheet();},l);i.$evt.offInputChangeEvtHandler.push(c.off);},removeInputChangeEvent(){for(let l=0;l<i.$evt.offInputChangeEvtHandler.length;l++){const c=i.$evt.offInputChangeEvtHandler[l];c(),i.$evt.offInputChangeEvtHandler.splice(l,1),l--;}},showEvent(){i.updateStyleSheet(),n.toHideWithNotResult&&i.$data.isEmpty?i.hide(true):i.show();},setShowEvent(l=s){if(n.followPosition==="target")u.on([n.$target],["focus","click"],i.showEvent,l);else if(n.followPosition==="input")u.on([n.$inputTarget],["focus","click"],i.showEvent,l);else if(n.followPosition==="inputCursor")u.on([n.$inputTarget],["focus","click","input"],i.showEvent,l);else throw new Error("未知followPosition："+n.followPosition)},removeShowEvent(l=s){u.off([n.$target,n.$inputTarget],["focus","click"],i.showEvent,l),u.off([n.$inputTarget],["input"],i.showEvent,l);},hideEvent(l){if(l.target instanceof Node){if(r.contains(l.target)||n.$target.contains(l.target)||n.$inputTarget.contains(l.target))return;i.hide(true);}},setHideEvent(l=s){Array.isArray(i.selfDocument)?i.selfDocument.forEach(c=>{u.on(c,["click","touchstart"],i.hideEvent,l);}):u.on(i.selfDocument,["click","touchstart"],i.hideEvent,l);},removeHideEvent(l=s){Array.isArray(i.selfDocument)?i.selfDocument.forEach(c=>{u.off(c,["click","touchstart"],i.hideEvent,l);}):u.off(i.selfDocument,["click","touchstart"],i.hideEvent,l);},setAllEvent(l=s){i.setInputChangeEvent(l),i.setHideEvent(l),i.setShowEvent(l);},removeAllEvent(l=s){i.removeInputChangeEvent(),i.removeHideEvent(l),i.removeShowEvent(l);},createItemDeleteIcon(l=16,c="#bababa"){return u.parseTextToDOM(`
...
`)}{display: none !important;}`)},setGMResourceCSS(a){const e=typeof bt=="function"?bt(a.keyName):null;return typeof e=="string"&&e?An(e):ce.loadStyleLink(a.url)},async loadStyleLink(a){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=a,new Promise(t=>{ke.onReady(()=>{document.head.appendChild(e),t(e);});})},async loadScript(a){let e=document.createElement("script");return e.src=a,new Promise(t=>{e.onload=()=>{t(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(a){return a=a.trim(),a.startsWith("data:")||a.match(/^http(s|):\/\//i)?a:a.startsWith("//")?(a.startsWith("///")||(a=window.location.protocol+a),a):(a.startsWith("/")||(a+="/"),a=window.location.origin+a,a)},fixHttps(a){if(a.startsWith("https://")||!a.startsWith("http://"))return a;try{let e=new URL(a);return e.protocol="https:",e.toString()}catch{return a}},lockScroll(...a){let e=document.createElement("style");e.innerHTML=`
		...
		`;let t=[document.documentElement,document.body].concat(...a||[]);return t.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){t.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function a(n){navigator.clipboard.readText().then(r=>{n(r);}).catch(r=>{Ee.error("读取剪贴板内容失败👉",r),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(r=>{a(n);}).catch(r=>{Ee.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),a(n);});}function t(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!t()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(a,e,t=5e3){let n,r=t-e,o=e,s=async i=>{const l=await a(i);if(typeof l=="boolean"&&l||i){re.workerClearTimeout(n);return}if(o+=e,o>r){s(true);return}n=re.workerSetTimeout(()=>{s(false);},e);};s(false);},findParentNode(a,e,t){if(t){let n=ke.closest(a,t);if(n)return n.querySelector(e)}else return ke.matches(a,e)?a:ke.closest(a,e)},toStr(a){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(a,(n,r)=>r===void 0?e:r,2).replace(new RegExp(`"${e}"`,"g"),"undefined")}},re=Ge.noConflict(),g=ke.noConflict(),Oe=Ct,Ee=new re.Log(je,ue.console||He.console),Dt=je?.script?.name||void 0,Ys=Ct.config.Utils.AnyTouch(),Qs=false;Ee.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});I.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(a){const e=a.setting.type;if(e==="loading")return  false;const t=a.setting.content;return e==="warning"?Ee.warn(t):e==="error"?Ee.error(t):Ee.info(t),false},get position(){return Ie.getValue(Qe.qmsg_config_position.key,Qe.qmsg_config_position.defaultValue)},get maxNums(){return Ie.getValue(Qe.qmsg_config_maxnums.key,Qe.qmsg_config_maxnums.defaultValue)},get showReverse(){return Ie.getValue(Qe.qmsg_config_showreverse.key,Qe.qmsg_config_showreverse.defaultValue)},get zIndex(){let a=Ge.getMaxZIndex(),e=Ct.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Ge.getMaxValue(a,e)+100}});Oe.GlobalConfig.setGlobalConfig({zIndex:()=>{const a=Ge.getMaxZIndex(void 0,void 0,t=>{if(t?.classList?.contains("qmsg-shadow-container")||t?.closest("qmsg")&&t.getRootNode()instanceof ShadowRoot)return  false}),e=Ct.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Ge.getMaxValue(a,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Js=new re.GM_Menu({GM_getValue:qe,GM_setValue:Pe,GM_registerMenuCommand:mt,GM_unregisterMenuCommand:It}),Kt=new re.Httpx({xmlHttpRequest:In,logDetails:Qs});Kt.interceptors.request.use(a=>a);Kt.interceptors.response.use(void 0,a=>(Ee.error("拦截器-请求错误",a),a.type==="onabort"?I.warning("请求取消",{consoleLogContent:true}):a.type==="onerror"?I.error("请求异常",{consoleLogContent:true}):a.type==="ontimeout"?I.error("请求超时",{consoleLogContent:true}):I.error("其它错误",{consoleLogContent:true}),a));ue.Object.defineProperty,ue.Object.keys,ue.Object.values,ue.Function.prototype.apply,ue.Function.prototype.call,ue.Element.prototype.appendChild,ue.setTimeout.bind(ue),ue.clearTimeout.bind(ue),ue.setInterval.bind(ue),ue.clearInterval.bind(ue);const An=g.addStyle.bind(g);ke.selector.bind(ke);ke.selectorAll.bind(ke);new re.GM_Cookie;const yt="GM_Panel",ir="data-init",Sn="data-key",Cn="data-default-value",Zs="data-init-more-value",ei="data-plugin-search-config",Le={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},De={setting:{get width(){return Le.width<550?"88vw":Le.width<700?"550px":"700px"},get height(){return Le.height<450?"70vh":Le.height<550?"450px":"550px"}},settingMiddle:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<450?"88vh":"450px"}},settingBig:{get width(){return Le.width<800?"92vw":"800px"},get height(){return Le.height<600?"80vh":"600px"}},info:{get width(){return Le.width<350?"88vw":"350px"},get height(){return Le.height<250?"88vh":"250px"}}},ct={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new re.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(a){Array.isArray(a)||(a=[a]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,a);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(a=0){return this.$data.contentConfig.get(a)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let a=false,e;const t=(o,s)=>{typeof s!="string"&&(s=ce.toStr(s));const i=new Blob([s]),l=globalThis.URL.createObjectURL(i);g.createElement("a",{href:l,download:o}).click(),re.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const o=p=>{const f=Oe.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),b=f.$shadowRoot.querySelector(".btn-control[data-mode='local']"),h=f.$shadowRoot.querySelector(".btn-control[data-mode='network']"),m=f.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),x=async v=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof Ze=="function"?typeof tt=="function"?(Ze().forEach(w=>{tt(w);}),I.success("已清空脚本存储的配置")):I.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):I.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof nt=="function"?nt(v):Object.keys(v).forEach(w=>{const E=v[w];Pe(w,E);}),I.success("配置导入完毕");},A=v=>new Promise(async S=>{const C=re.toJSON(v);Object.keys(C).length===0?I.warning("解析为空配置，不导入"):await x(C),S(true);});g.on(b,"click",v=>{g.preventEvent(v),f.close();const S=g.createElement("input",{type:"file",accept:".json"});g.on(S,["propertychange","input"],C=>{if(!S.files?.length)return;const w=S.files[0],E=new FileReader;E.onload=()=>{A(E.result);},E.readAsText(w,"UTF-8");}),S.click();}),g.on(h,"click",v=>{g.preventEvent(v),f.close();const S=Oe.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(E,B){E.close();}},ok:{text:"导入",callback:async(E,B)=>{const H=E.text;if(re.isNull(H)){I.error("请填入完整的url");return}const z=I.loading("正在获取配置..."),Y=await Kt.get(H,{allowInterceptConfig:false});if(z.close(),!Y.status){Ee.error(Y),I.error("获取配置失败",{consoleLogContent:true});return}await A(Y.data.responseText)&&E.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:De.info.width,height:"auto"}),C=S.$shadowRoot.querySelector("input"),w=S.$shadowRoot.querySelector(".pops-prompt-btn-ok");g.on(C,["input","propertychange"],E=>{g.val(C)===""?g.attr(w,"disabled","true"):g.removeAttr(w,"disabled");}),g.onKeyboard(C,"keydown",(E,B,H)=>{E==="Enter"&&H.length===0&&g.val(C)!==""&&g.emit(w,"click");}),g.emit(C,"input");}),g.on(m,"click",async v=>{g.preventEvent(v),f.close();let S=await ce.getClipboardText();if(S.trim()===""){I.warning("获取到的剪贴板内容为空");return}await A(S);});},s=(p=`${Dt}_panel-setting-${re.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,f)=>{const b=Oe.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),h=b.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),m=b.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");g.on(h,"click",x=>{g.preventEvent(x);try{t(p,f),b.close();}catch(A){I.error(A.toString(),{consoleLogContent:true});}}),g.on(m,"click",async x=>{await re.copy(f)?(I.success("复制成功"),b.close()):I.error("复制失败");});},l=Oe.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(p,f){o();}},cancel:{enable:true,text:"导出",callback(p,f){s(void 0,d);}}},width:Le.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof Ze=="function")Ze().forEach(f=>{const b=qe(f);Reflect.set(c,f,b);});else {I.warning("不支持函数GM_listValues，仅导出菜单配置");const p=qe(yt);Reflect.set(c,yt,p);}const d=ce.toStr(c);l.value=d;},r=()=>{let o=je?.script?.supportURL||je?.script?.namespace;typeof o=="string"&&re.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${je?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(o){new Ys(o.$asideLiElement).on("tap",function(i){clearTimeout(e),e=void 0,a?(a=false,n()):(e=setTimeout(()=>{a=false,r();},200),a=true);});}}]},setDefaultBottomContentConfig(a){this.$data.__defaultBottomContentConfig=a;}},Ot={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(a){return a},callback:()=>{Ie.showPanel(ct.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){Ie.isTopWindow()&&Js.add(this.$data.menuOption);},addMenuOption(a){Array.isArray(a)||(a=[a]),this.$data.menuOption.push(...a);},updateMenuOption(a){Array.isArray(a)||(a=[a]),a.forEach(e=>{let t=this.$data.menuOption.findIndex(n=>n.key===e.key);t!==-1&&(this.$data.menuOption[t]=e);});},getMenuOption(a=0){return this.$data.menuOption[a]},deleteMenuOption(a=0){this.$data.menuOption.splice(a,1);}};class ti{storageKey;listenerData;constructor(e){if(typeof e=="string"){const t=e.trim();if(t=="")throw new Error("key参数不能为空字符串");this.storageKey=t;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new Ge.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let e=qe(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){Pe(this.storageKey,e);}set(e,t){const n=this.get(e),r=this.getLocalValue();Reflect.set(r,e,t),this.setLocalValue(r),this.emitValueChangeListener(e,t,n);}get(e,t){const n=this.getLocalValue();return Reflect.get(n,e)??t}getAll(){return this.getLocalValue()}delete(e){const t=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.emitValueChangeListener(e,void 0,t);}has(e){const t=this.getLocalValue();return Reflect.has(t,e)}keys(){const e=this.getLocalValue();return Reflect.ownKeys(e)}values(){const e=this.getLocalValue();return Reflect.ownKeys(e).map(t=>Reflect.get(e,t))}clear(){tt(this.storageKey);}addValueChangeListener(e,t){const n=Math.random(),r=this.listenerData.get(e)||[];return r.push({id:n,key:e,callback:t}),this.listenerData.set(e,r),n}removeValueChangeListener(e){let t=false;for(const[n,r]of this.listenerData.entries()){for(let o=0;o<r.length;o++){const s=r[o];(typeof e=="string"&&s.key===e||typeof e=="number"&&s.id===e)&&(r.splice(o,1),o--,t=true);}this.listenerData.set(n,r);}return t}async emitValueChangeListener(...e){const[t,n,r]=e;if(!this.listenerData.has(t))return;const o=this.listenerData.get(t);for(let s=0;s<o.length;s++){const i=o[s];if(typeof i.callback=="function"){let l,c;e.length===1||(e.length===2?l=n:e.length===3&&(l=n,c=r)),await i.callback(t,l,c);}}}}const Ve=new ti(yt),Ie={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new re.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new re.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new re.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new re.Dictionary),this.__onceExecData},get scriptName(){return Dt},get panelConfig(){return this.__panelConfig},set panelConfig(a){this.__panelConfig=a;},key:yt,attributeKeyName:Sn,attributeDefaultValueName:Cn},init(){this.initContentDefaultValue(),Ot.init();},isTopWindow(){return ue.top===ue.self},initContentDefaultValue(){const a=n=>{if(!n.attributes||n.type==="button"||n.type==="container"||n.type==="deepMenu")return;const r=n.attributes;let o=r[ir];if(typeof o=="function"){let c=o();if(typeof c=="boolean"&&!c)return}let s=new Map,i=r[Sn];if(i!=null){const c=r[Cn];s.set(i,c);}let l=r[Zs];if(typeof l=="object"&&l&&Object.keys(l).forEach(c=>{const d=l[c];s.set(c,d);}),!s.size){Ee.warn("请先配置键",n);return}if(n.type==="switch"){let c=typeof n.disabled=="function"?n.disabled():n.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...s.keys());}for(const[c,d]of s.entries())this.setDefaultValue(c,d);},e=n=>{for(let r=0;r<n.length;r++){let o=n[r];a(o);let s=o.views;s&&Array.isArray(s)&&e(s);}},t=[...ct.getAllContentConfig()];for(let n=0;n<t.length;n++){let r=t[n];if(!r.views)continue;const o=r.views;o&&Array.isArray(o)&&e(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(a,e){this.$data.contentConfigInitDefaultValue.has(a)&&Ee.warn("请检查该key(已存在): "+a),this.$data.contentConfigInitDefaultValue.set(a,e);},getDefaultValue(a){return this.$data.contentConfigInitDefaultValue.get(a)},setValue(a,e){Ve.set(a,e);},getValue(a,e){const t=Ve.get(a);return t??(this.$data.contentConfigInitDefaultValue.has(a)?this.$data.contentConfigInitDefaultValue.get(a):e)},deleteValue(a){Ve.delete(a);},hasKey(a){return Ve.has(a)},addValueChangeListener(a,e,t){const n=Ve.addValueChangeListener(a,e);if(t?.immediate||t?.immediateAll){const r=this.getValue(a);t?.immediate?e(a,r,r):t?.immediateAll&&Ie.emitMenuValueChange(a,r,r);}return n},removeValueChangeListener(a){Ve.removeValueChangeListener(a);},emitMenuValueChange(a,e,t){Ve.emitValueChangeListener(a,e,t);},async exec(a,e,t,n=true){const r=this;let o;typeof a=="string"||Array.isArray(a)?o=()=>a:o=a;let s=false;const i=o();let l=[];Array.isArray(i)?(s=true,l=i):l.push(i);const c=l.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(c){Ee.warn(`${c} 键不存在`);return}const d=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(d))return this.$data.onceExecMenuData.get(d);let p=[];const f=[];let b=[];const h=(w,E)=>{let B=[],H=[],z=[];if(Array.isArray(E))z=z.concat(E);else {const j=T=>{if(typeof T=="object"&&T!=null)if(T instanceof Element)z.push(T);else {const{$css:M,destory:k}=T;M!=null&&(Array.isArray(M)?z=z.concat(M):z.push(M)),typeof k=="function"&&z.push(k);}else z.push(T);};if(E!=null&&Array.isArray(E))for(const T of E)j(T);else j(E);}const Y=j=>{if(j!=null){if(j instanceof Element){B.push(j);return}if(typeof j=="function"){H.push(j);return}}};for(const j of z){const T=Y(j);if(typeof T=="boolean"&&!T)break;if(Array.isArray(j))for(const M of j){const k=Y(M);if(typeof k=="boolean"&&!k)break}}x(),A(),w&&(p=p.concat(B),b=b.concat(H));},m=w=>!!this.getValue(w),x=()=>{for(let w=0;w<p.length;w++)p[w]?.remove(),p.splice(w,1),w--;},A=()=>{for(let w=0;w<b.length;w++){const E=b[w];E(),b.splice(w,1),w--;}},v=()=>{let w=false;return typeof t=="function"?w=t(l):w=l.every(E=>m(E)),w},S=async w=>{const E=v();let B=[];if(E){const H=l.map(z=>this.getValue(z));B=await e({key:l,value:s?H:H[0],addStoreValue:(...z)=>h(E,z)});}h(E,B);};n&&l.forEach(w=>{const E=this.addValueChangeListener(w,(B,H,z)=>S());f.push(E);}),await S();const C={reload(){this.clearStoreStyleElements(),this.destory(),S();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>x(),destory(){return A()},removeValueChangeListener:()=>{f.forEach(w=>{this.removeValueChangeListener(w);});},clearOnceExecMenuData(){n&&r.$data.onceExecMenuData.delete(d);}};return this.$data.onceExecMenuData.set(d,C),C},async execMenu(a,e,t=false,n=false){return await this.exec(a,async r=>await e(r),r=>r.every(s=>{let i=!!this.getValue(s);return Ie.$data.contentConfigInitDisabledKeys.includes(s)&&(i=false,Ee.warn(`.execMenu${n?"Once":""} ${s} 被禁用`)),t&&(i=!i),i}),n)},async execMenuOnce(a,e,t=false,n=false){const r=await this.execMenu(a,e,t,true);if(n&&r){const o=()=>{r.reload();};this.removeUrlChangeWithExecMenuOnceListener(a),this.addUrlChangeWithExecMenuOnceListener(a,o);}return r},deleteExecMenuOnce(a){return a=this.transformKey(a),this.$data.onceExecMenuData.delete(a),this.$data.urlChangeReloadMenuExecOnce.delete(a),Ve.removeValueChangeListener(a)},onceExec(a,e){if(a=this.transformKey(a),typeof a!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(a)||(e(),this.$data.onceExecData.set(a,1));},deleteOnceExec(a){a=this.transformKey(a),this.$data.onceExecData.delete(a);},addUrlChangeWithExecMenuOnceListener(a,e){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.set(a,e);},removeUrlChangeWithExecMenuOnceListener(a){a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.delete(a);},hasUrlChangeWithExecMenuOnceListener(a){return a=this.transformKey(a),this.$data.urlChangeReloadMenuExecOnce.has(a)},async emitUrlChangeWithExecMenuOnceEvent(a){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const t of e)await t(a);},showPanel(a,e=`${Dt}-设置`,t=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];const r=a.findIndex(s=>(typeof s.isBottom=="function"?s.isBottom():!!s.isBottom)&&s.id==="script-version")!==-1;!t&&!r&&a.push(...ct.getDefaultBottomContentConfig());const o=Oe.panel({title:{text:e,position:"center",html:false,style:""},content:a,btn:{close:{enable:true,callback:(s,i)=>{s.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(s,i)=>{s(),this.$data.$panel=null;}},width:De.setting.width,height:De.setting.height,drag:true,only:true,style:`
        ...
        `,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=a,n||this.registerConfigSearch({$panel:o,content:a});},registerConfigSearch(a){const{$panel:e,content:t}=a,n=async(f,b)=>{if(f==null)return;const h=await b(f);return h&&typeof h.isFind=="boolean"&&h.isFind?h.data:await n(h.data,b)},r=(f,b)=>{const h=new IntersectionObserver(m=>{m.forEach(x=>{x.isIntersecting&&(b?.(),h.disconnect());});},{root:null,threshold:1});h.observe(f),f.scrollIntoView({behavior:"smooth",block:"center"});},o=f=>{const b="pops-flashing";g.onAnimationend(f,()=>{f.classList.remove(b);}),f.classList.add(b);},s=f=>{if(f.type==="dblclick"&&p)return;g.preventEvent(f),l=null;const b=Oe.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});b.$shadowRoot.querySelector(".search-wrapper");const h=b.$shadowRoot.querySelector(".search-config-text"),m=b.$shadowRoot.querySelector(".search-result-wrapper");h.focus();const x=()=>{g.empty(m);},A=S=>{const C=re.queryProperty(S,B=>B?.next?{isFind:false,data:B.next}:{isFind:true,data:B}),w=g.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),E=Oe.config.PanelHandlerComponents();return g.on(w,"click",B=>{const z=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[S.index];if(!z){I.error(`左侧项下标${S.index}不存在`);return}z.scrollIntoView({behavior:"smooth",block:"center"}),z.click(),n(S.next,async Y=>{if(Y?.next){const j=await g.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(T=>{const M=Reflect.get(T,E.$data.nodeStoreConfigKey);return typeof M=="object"&&M!=null&&M.text===Y.name}),2500);if(j)j.click();else return I.error("未找到对应的二级菜单"),{isFind:true,data:Y};return {isFind:false,data:Y.next}}else {const j=await g.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(T=>Reflect.get(T,E.$data.nodeStoreConfigKey)===Y.matchedData?.formConfig),2500);if(j){r(j);const T=j.closest(".pops-panel-forms-fold[data-fold-enable]");T&&(T.querySelector(".pops-panel-forms-fold-container").click(),await re.sleep(500)),r(j,()=>{o(j);});}else I.error("未找到对应的菜单项");return {isFind:true,data:Y}}});}),w},v=S=>{const C=new RegExp(S,"i"),w=[],E=(H,z)=>{for(let Y=0;Y<H.length;Y++){const j=H[Y],T=j.views;if(T&&Array.isArray(T)){const M=re.deepClone(z);if(j.type==="deepMenu"){const k=re.queryProperty(M,y=>y?.next?{isFind:false,data:y.next}:{isFind:true,data:y});k.next={name:j.text};}E(T,M);}else {let M,k;if(j.type==="own"){const O=Reflect.get(j.attributes||{},ei);O&&(typeof O.text=="string"&&(M=O.text),typeof O.desc=="string"&&(k=O.desc));}else M=j.text,k=Reflect.get(j,"description");const y=[M,k],$=y.findIndex(O=>{if(typeof O=="string")return O.match(C)});if($!==-1){const O=re.deepClone(z),_=re.queryProperty(O,V=>V?.next?{isFind:false,data:V.next}:{isFind:true,data:V});_.next={name:M,matchedData:{path:"",formConfig:j,matchedText:y[$],description:k}};const D=[];re.queryProperty(O,V=>{const R=V?.name;return typeof R=="string"&&R.trim()!==""&&D.push(R),V?.next?{isFind:false,data:V.next}:{isFind:true,data:V}});const Q=D.join(ce.escapeHtml(" - "));_.next.matchedData.path=Q,w.push(O);}}}};for(let H=0;H<t.length;H++){const z=t[H];if(!z.views||z.isBottom&&z.id==="script-version")continue;const Y=z.views;if(Y&&Array.isArray(Y)){let j=z.title;typeof j=="function"&&(j=j()),E(Y,{index:H,name:j});}}const B=document.createDocumentFragment();for(const H of w){let z=A(H);B.appendChild(z);}x(),m.append(B);};g.on(h,"input",re.debounce(S=>{g.preventEvent(S);let C=g.val(h).trim();if(C===""){x();return}v(C);},200));};e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(f=>{g.on(f,"dblclick",s);});let l=null,c=false,d,p=false;g.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(f,b)=>{p=true,clearTimeout(d),d=void 0,c&&l===b?(c=false,l=null,s(f)):(d=setTimeout(()=>{c=false;},200),c=true,l=b);},{capture:true}),e.$shadowRoot.appendChild(g.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
				...
				`}));},transformKey(a){if(Array.isArray(a)){const e=a.sort();return JSON.stringify(e)}else return a},getDynamicValue(a,e){const t=this;let n=false,r=e;const o=this.addValueChangeListener(a,(s,i)=>{r=i;});return {get value(){return n||(n=true,r=t.getValue(a,e)),r},destory(){t.removeValueChangeListener(o);}}}};let Je="";document.documentElement?document.head?document.body?Je=`<html>
    <head>
...
注入速度等级：0`;const $e=(a,e,...t)=>setTimeout(async()=>{try{await a(...t);}catch(n){I.error(n.toString());}},e),lr={success:"√ ",error:"× ",warn:"!!! ",info:""},te={setTagList(a,e){g.html(a,"");let t="";e.forEach(n=>{t+=`
				<p class="${n.tag}">${n.text??""}</p>
			`;}),g.html(a,t);},setTag(a,e,t){te.clearTag(a),g.addClass(a,e),typeof t=="string"&&g.html(a,t);},clearTag(a){Object.keys(lr).forEach(e=>{g.removeClass(a,e);});}},Pt=function(a,e,t,n,r,o){const s={type:"own",attributes:n||{},props:r||{},createLIElement:a,afterAddToUListCallBack:o};return Reflect.set(s.attributes,ir,()=>false),s},L=a=>Pt(t=>{let n=g.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
					<p class="pops-panel-item-left-main-text"></p>
					<p class="pops-panel-item-left-desc-text"></p>
				`});return t.appendChild(n),t},void 0,void 0,void 0,void 0,async(t,n)=>{let r=n.target,o=r.querySelector(".pops-panel-item-left-text"),s=r.querySelector(".pops-panel-item-left-main-text"),i=r.querySelector(".pops-panel-item-left-desc-text"),l=await a();l.tag==null?g.html(s,l.text):g.html(s,lr[l.tag]+l.text),(l.description==null||l.description==="")&&g.hide(i,false),g.html(i,l.description||"");let c=["support-info"];if(l.tag!=null&&c.push(l.tag),g.addClass(s,c),typeof l.afterRender=="function")try{l.afterRender({...n,$leftContainer:o,$leftText:s,$leftDesc:i});}catch(d){console.log(d),te.setTag(s,"error","afterRender 函数执行错误"+d);}}),W={asideLastVisit:"aside-last-visit"},ni={getWindow(){return Te.unsafeWindow.isSupport()?ue:window}};class ri{}class kt extends ri{isSupportGM(){return typeof U=="object"&&U!=null}}class pe extends kt{}const se={getApiDocUrl(a,e){return e=e??a,`<a href="https://www.tampermonkey.net/documentation.php?ext=gcal&version=#api:${a}" target="_blank">${e}</a>`}};class oi extends pe{getApiName(){return "GM_addElement"}getAsyncApiOption(){return {name:"GM.addElement",isSupport:this.isSupportGM()&&typeof U.addElement=="function"}}isSupport(){return typeof Qt=="function"}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(Qt,this,r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.addElement,formList:n.views[2].views}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push(L(async()=>{let s=null,i=null,l=ni.getWindow(),c=o+"_test_script_exec",d=`${c}_test_str`;try{return s=await r.fn("script",{id:c,textContent:`window["${d}"] = "bar";`}),i=document.querySelector("#"+c),s==null?{text:`${r.name} returns is null`,tag:"error"}:s instanceof HTMLElement?typeof l[d]!="string"?{text:`${r.name} script element is not work`,tag:"error"}:(Reflect.deleteProperty(l,d),{text:ce.escapeHtml("支持添加<script>元素且执行js"),tag:"success"}):{text:`${r.name} returns is not style element`,tag:"error"}}catch(p){return console.error(p),{text:"执行错误 "+p,tag:"error"}}finally{i&&i.remove();}}),L(async()=>{let s=null,i=null,l=o+"_test2";try{if(s=await r.fn(document.body,"div",{"data-src":"https://example.com/image.png",id:l}),s==null)return {text:r.name+" returns is null",tag:"error"};if(!(s instanceof HTMLElement))return {text:r.name+" returns is not style element",tag:"error"};if(i=document.querySelector("#"+l),!i)return {text:"不支持3个参数",tag:"error"};const c=i.attachShadow({mode:"closed"});return await r.fn(c,"style",{textContent:"div { color: black; };"}),c.querySelector("style")?s==null?{text:"传入3个参数但是返回为空",tag:"error"}:i.hasAttribute("data-src")?{text:"支持3个参数并返回元素对象",tag:"success"}:{text:"不支持设置自定义属性data-src",tag:"error"}:{text:"不支持3个参数的shadowRoot",tag:"error"}}catch(c){return console.error(c),{text:"执行错误 "+c,tag:"error"}}finally{i&&i.remove();}}));}),n}}class ai extends pe{isSupport(){return typeof Jt=="function"}getApiName(){return "GM_addStyle"}getAsyncApiOption(){return {name:"GM.addStyle",isSupport:this.isSupportGM()&&typeof U.addStyle=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-GM_addStyle"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(Jt,this,r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.addStyle,formList:n.views[2].views}].forEach(r=>{let o=r.name.replace(".","__async__");r.formList.push(L(async()=>{let s=null,i=null;try{return s=g.createElement("div",{id:o,innerText:o+" test"}),document.body.appendChild(s),i=await r.fn(`
							#${o} {
								background-color: rgb(255, 0, 0);
							}
						`),i==null?{text:`${r.name} returns is null`,tag:"error"}:i instanceof HTMLStyleElement?window.getComputedStyle(s).backgroundColor!=="rgb(255, 0, 0)"?{text:`${r.name} test element background is not rgb(255, 0, 0)`,tag:"error"}:{text:ce.escapeHtml("支持添加CSS字符串并返回元素对象"),tag:"success"}:{text:`${r.name} returns is not HTMLStyleElement`,tag:"error"}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}finally{s?.remove(),i?.remove();}}));}),n}}class si extends pe{isSupport(){return typeof Lt=="function"}getApiName(){return "GM_addValueChangeListener"}getAsyncApiOption(){return {name:"GM.addValueChangeListener",isSupport:this.isSupportGM()&&typeof U.addValueChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=Lt(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.addValueChangeListener,formList:n.views[2].views}].forEach(r=>{let o=r.name;r.formList.push((()=>{let s=o+"_key_1";return L(()=>({text:"测试监听数据存储改变",description:"",tag:"info",afterRender(i){let l=g.toElement(`
									...
									`,false,false);g.after(i.$leftContainer,l);let c,d,p=[];g.on(l,"click",async f=>{g.preventEvent(f);try{p.length=0,clearTimeout(c),te.setTag(i.$leftText,"info","等待触发回调"),g.text(i.$leftDesc,this.text),g.show(i.$leftDesc,!1);let b=re.formatTime(Date.now());d=d??await r.fn(s,function(h,m,x,A){console.log(arguments),clearTimeout(c),p.push({tag:"success",text:"支持触发回调"}),typeof h!="string"?p.push({tag:"error",text:`不支持回调参数key，当前类型：${typeof h}`}):p.push({tag:"success",text:`支持回调参数key，当前类型：${typeof h}`}),typeof x!=typeof b?p.push({tag:"error",text:`不支持回调参数newValue，当前类型：${typeof b}`}):p.push({tag:"success",text:`支持回调参数newValue，当前类型：${typeof b}`}),typeof A!="boolean"?p.push({tag:"error",text:`不支持回调参数remote，当前类型：${typeof A}`}):p.push({tag:"success",text:`支持回调参数remote，当前类型：${typeof A}`}),te.setTagList(i.$leftText,p);}),console.log(r.name+" listenerId："+d+" typeof："+typeof d),typeof d!="number"&&typeof d!="string"?p.push({tag:"warn",text:"listenerId类型不是number或string"}):p.push({tag:"success",text:"listenerId类型："+typeof d}),c=setTimeout(()=>{p.push({tag:"error",text:"不支持触发回调"}),te.setTagList(i.$leftText,p);},3e3),Pe(s,b);}catch(b){I.error(b.toString());}});}}))})());}),n}}class ii extends pe{isSupport(){return (typeof Re=="object"||typeof Re=="function")&&Re!=null}getApiOption(){let e=this.isSupport();return {isSupportList:e&&typeof Re.list=="function",isSupportSet:e&&typeof Re.set=="function",isSupportDelete:e&&typeof Re.delete=="function"}}getApiName(){return "GM_cookie"}getAsyncApiOption(){let e=this.isSupportGM()&&(typeof U.cookie=="object"||typeof U.cookie=="function")&&U.cookie!=null;return {name:"GM.cookie",isSupport:e,isSupportList:e&&typeof U.cookie.list=="function",isSupportSet:e&&typeof U.cookie.set=="function",isSupportDelete:e&&typeof U.cookie.delete=="function"}}getUIOption(){let e=this.getApiName(),t=this.getApiOption(),n=this.getAsyncApiOption(),r={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e+".list",`${e} & ${n.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(s){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:`支持 ${e}，类型 ${typeof Re}`,tag:"success"}:{text:"不支持 "+e,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]},o=r.views[0].views;if(this.isSupport()&&o.push(L(()=>t.isSupportList?{text:`支持 ${e}.list`,tag:"success"}:{text:`不支持 ${e}.list`,tag:"error"}),L(()=>t.isSupportSet?{text:`支持 ${e}.set`,tag:"success"}:{text:`不支持 ${e}.set`,tag:"error"}),L(()=>t.isSupportDelete?{text:`支持 ${e}.delete`,tag:"success"}:{text:`不支持 ${e}.delete`,tag:"error"})),n.isSupport?o.push(L(()=>n.isSupportList?{text:`支持 ${n.name}.list`,tag:"success"}:{text:`不支持 ${n.name}.list`,tag:"error"}),L(()=>n.isSupportSet?{text:`支持 ${n.name}.set`,tag:"success"}:{text:`不支持 ${n.name}.set`,tag:"error"}),L(()=>n.isSupportDelete?{text:`支持 ${n.name}.delete`,tag:"success"}:{text:`不支持 ${n.name}.delete`,tag:"error"})):o.push(L(()=>({text:"不支持 "+n.name,tag:"error"}))),this.isSupport()){let s={name:"test",value:"1",expirationDate:(Date.now()+864e5)/1e3};[{name:e,list:async(...i)=>new Promise((l,c)=>{const[d,p]=i;Re.list(d,(f,b)=>{b?c(b):l(f);});}),set:async(...i)=>new Promise((l,c)=>{const[d,p]=i;Re.set(d,f=>{f?c(f):l(void 0);});}),delete:async(...i)=>new Promise((l,c)=>{const[d,p]=i;Re.delete(d,f=>{f?c(f):l(void 0);});}),formList:r.views[1].views},{name:n.name,list:U.cookie?.list,set:U.cookie?.set,delete:U.cookie?.delete,formList:r.views[2].views}].forEach(i=>{i.name,i.formList.push(L(()=>{try{return {text:ce.escapeHtml("测试list获取所有Cookie"),tag:"info",description:"点击按钮进行测试",afterRender(l){let c=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
									...
									`,!1,!1);g.on(c,"click",async d=>{try{g.preventEvent(d);const p=await i.list({});console.log(p),Array.isArray(p)?Oe.alert({title:{text:i.name+".list",position:"center"},content:{text:JSON.stringify(p,null,4),html:!0},drag:!0,mask:{enable:!0},width:De.setting.width,height:De.setting.height,style:`
															.pops-alert-content{
																white-space: pre-wrap;
															}
														`}):alert("获取的cookie信息不是数组");}catch(p){I.error(p.toString());}}),g.after(l.$leftContainer,c);}}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}}),L(()=>{try{return {text:ce.escapeHtml("测试set新增Cookie"),tag:"info",description:JSON.stringify(s),afterRender(l){let c=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击执行</span>
									...
									`,!1,!1);g.on(c,"click",async d=>{try{g.preventEvent(d),await i.set(s),I.success(i.name+" set cookie success");}catch(p){I.error(p.toString());}}),g.after(l.$leftContainer,c);}}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}}),L(()=>{try{let l={name:"test"};return {text:ce.escapeHtml("测试delete删除Cookie"),tag:"info",description:JSON.stringify(l),afterRender(c){let d=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击执行</span>
									...
									`,!1,!1);g.on(d,"click",async p=>{try{g.preventEvent(p),await i.delete(l),I.success(i.name+" delete cookie success");}catch(f){I.error(f.toString());}}),g.after(c.$leftContainer,d);}}}catch(l){return console.error(l),{text:"执行错误 "+l,tag:"error"}}}));});}return r}}class li extends pe{isSupport(){return typeof tt=="function"}getApiName(){return "GM_deleteValue"}getAsyncApiOption(){return {name:"GM.deleteValue",isSupport:this.isSupportGM()&&typeof U.deleteValue=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.name?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=tt(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.deleteValue,formList:n.views[2].views}].forEach(r=>{let o=r.name;r.formList.push((()=>{let s=`Test ${o} null`,i=null;return L(()=>({text:"测试存储null值并删除",description:`"${s}": ${i}`,tag:"info",afterRender(l){let c=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(l.$leftContainer,c),g.on(c,"click",async d=>{g.preventEvent(d);try{Pe(s,i),await r.fn(s);let p=qe(s);typeof p=="object"&&p===null?I.error("该值未删除，读取的值："+p):I.success("成功删除该值");}catch(p){I.error(p.toString());}});}}))})());}),n}}class ci extends pe{isSupport(){return typeof Zt=="function"}getApiName(){return "GM_deleteValues"}getAsyncApiOption(){return {name:"GM.deleteValues",isSupport:this.isSupportGM()&&typeof U.deleteValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=Zt(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.deleteValues,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push((()=>{let o={GM_deleteValues_key_1:555,"GM.deleteValues_key_2":666};return L(()=>({text:"测试存储对象然后删除再读取",description:`${JSON.stringify(o)}`,tag:"info",afterRender(s){let i=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(s.$leftContainer,i),g.on(i,"click",async l=>{g.preventEvent(l);try{nt(o);let c=Object.keys(o),d=ht(c);if(JSON.stringify(d)!==JSON.stringify(o)){I.error("写入失败，写入的数据和读取的数据不相同");return}await r.fn(c);let p=ht(c);p==null?I.warning("删除情况未知，因为读取到的数据为null"):typeof p=="object"&&JSON.stringify(p)==="{}"?I.success("删除成功，读取的数据为{}"):(I.error("删除情况未知，因为读取到的数据类型不是object"),console.log(p));}catch(c){I.error(c.toString());}});}}))})());}),n}}class pi extends pe{isSupport(){return typeof en=="function"}getApiName(){return "GM_download"}getAsyncApiOption(){return {name:"GM.download",isSupport:this.isSupportGM()&&typeof U.download=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=r[0];if(typeof r[0]=="string"){const l=r[1];s={url:r[0]},typeof l=="string"&&(s.name=l);}if(typeof s.onload=="function"){const l=s.onload;s.onload=(...c)=>{l(...c),o(i);};}if(typeof s.onerror=="function"){const l=s.onerror;s.onerror=(...c)=>{l(...c),o(i);};}if(typeof s.onprogress=="function"){const l=s.onprogress;s.onprogress=(...c)=>{l(...c);};}if(typeof s.ontimeout=="function"){const l=s.ontimeout;s.ontimeout=(...c)=>{l(...c),o(i);};}const i=en(s);return i}),formList:n.views[1].views},{name:t.name,fn:U.download,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push((()=>{const o="https://httpbin.org/image/png",s="test.png";return L(()=>({text:"下载图片："+o,description:"",tag:"info",afterRender(i){let l=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(i.$leftContainer,l);let c=null,d=false,p=false;g.on(l,"click",async f=>{g.preventEvent(f);try{let b=I.loading("下载中...",{showClose:!0,onClose(){!d&&typeof c=="function"&&c();}});const h=await r.fn({url:o,name:s,onload(){d=!0,b.close(),I.success(`下载 ${s} 已完成`);},onprogress(m){if(typeof m=="object"&&"loaded"in m&&"total"in m&&!p){let A=(m.loaded/m.total*100).toFixed(2);b.setText(`下载中...${A}%`),m.loaded===m.total&&(p=!0);}},onerror(m){b.close(),console.error("下载失败error👉",m),typeof m=="object"&&m.error?I.error(`下载 ${s} 失败或已取消 原因：${m.error}`,{timeout:6e3}):I.error(`下载 ${s} 失败或已取消`);},ontimeout(){b.close(),I.error(`下载 ${s} 请求超时`);}});typeof h=="object"&&h!=null&&"abort"in h&&(c=h.abort);}catch(b){I.error(b.toString());}});}}))})(),(()=>{const o="https://media.w3.org/2010/05/sintel/trailer.mp4",s="test.mp4";return L(()=>({text:"下载视频："+o,description:"",tag:"info",afterRender(i){let l=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(i.$leftContainer,l);let c=null,d=false,p=false;g.on(l,"click",async f=>{g.preventEvent(f);try{let b=I.loading("下载中...",{showClose:!0,onClose(){!d&&typeof c=="function"&&c();}});const h=await r.fn({url:o,name:s,onload(){d=!0,b.close(),I.success(`下载 ${s} 已完成`);},onprogress(m){if(typeof m=="object"&&"loaded"in m&&"total"in m&&!p){let A=(m.loaded/m.total*100).toFixed(2);b.setText(`下载中...${A}%`),m.loaded===m.total&&(p=!0);}},onerror(m){b.close(),console.error("下载失败error👉",m),typeof m=="object"&&m.error?I.error(`下载 ${s} 失败或已取消 原因：${m.error}`,{timeout:6e3}):I.error(`下载 ${s} 失败或已取消`);},ontimeout(){b.close(),I.error(`下载 ${s} 请求超时`);}});typeof h=="object"&&h!=null&&"abort"in h&&(c=h.abort);}catch(b){I.error(b.toString());}});}}))})());}),n}}class di extends pe{isSupport(){return typeof bt=="function"}getApiName(){return "GM_getResourceText"}getAsyncApiOption(){return {name:"GM.getResourceText",isSupport:this.isSupportGM()&&typeof U.getResourceText=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=bt(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.getResourceText,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(async()=>{try{return typeof await r.fn("ViewerCSS")=="string"?{text:ce.escapeHtml("支持通过@resource引用资源字符串"),tag:"success"}:{text:ce.escapeHtml(r.name+" return is not string"),tag:"error"}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class fi extends pe{isSupport(){return typeof tn=="function"}getApiName(){return "GM_getResourceURL"}getAsyncApiOption(){return {name:"GM.getResourceUrl",isSupport:this.isSupportGM()&&typeof U.getResourceUrl=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{let s=Reflect.apply(tn,this,r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.getResourceUrl,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(async()=>{try{let o=await r.fn("ViewerCSS");return typeof o!="string"?{text:ce.escapeHtml(`${r.name} return is not string`),tag:"error"}:(o=o.trim(),o.startsWith("data:text/css;base64")?o.startsWith("data:text/css;base64,LyohCiAqIFZpZXdlci5qcyB2MS4xMS43CiAqIGh0dHBzOi8vZmVuZ3")?{text:ce.escapeHtml("支持通过@resource引用资源并进行base64编码"),tag:"success"}:{text:ce.escapeHtml("支持通过@resource引用资源并进行base64编码，但是base64编码的实现方式不同"),tag:"warn"}:{text:ce.escapeHtml("支持通过@resource引用资源，但是未对资源进行base64编码"),tag:"warn"})}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class ui extends pe{isSupport(){return typeof nn=="function"}getApiName(){return "GM_getTab"}getAsyncApiOption(){return {name:"GM.getTab",isSupport:this.isSupportGM()&&typeof U.getTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async()=>new Promise(r=>{nn((...o)=>{r(...o);});}),formList:n.views[1].views},{name:t.name,fn:U.getTab,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(()=>({text:"测试获取当前Tab",description:"",tag:"info",afterRender(o){let s=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);g.after(o.$leftContainer,s);let i;g.on(s,"click",async l=>{g.preventEvent(l);try{clearTimeout(i),te.setTag(o.$leftText,"error","等待3s内触发回调函数"),i=$e(()=>{te.setTag(o.$leftText,"error","超时，不支持触发回调函数");},3e3);let c=await r.fn();clearTimeout(i),console.log(r.name+" callback tab",c),typeof c=="object"&&c!=null?te.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"success",text:"入参tab为object类型"}]):te.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"error",text:"入参tab不为object类型"}]),alert(JSON.stringify(c));}catch(c){I.error(c.toString());}});}})));}),n}}class bi extends pe{isSupport(){return typeof rn=="function"}getApiName(){return "GM_getTabs"}getAsyncApiOption(){return {name:"GM.getTabs",isSupport:this.isSupportGM()&&typeof U.getTabs=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async()=>new Promise(r=>{rn((...o)=>{r(...o);});}),formList:n.views[1].views},{name:t.name,fn:U.getTabs,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(()=>({text:"测试获取所有Tab",description:"",tag:"info",afterRender(o){let s=g.toElement(`
								<div class="pops-panel-button pops-panel-button-no-icon">
									<button class="pops-panel-button_inner" type="button" data-type="default">
										<i class="pops-bottom-icon" is-loading="false"></i>
										<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);g.after(o.$leftContainer,s);let i;g.on(s,"click",async l=>{try{g.preventEvent(l),clearTimeout(i),te.setTag(o.$leftText,"error","等待3s内触发回调函数"),i=$e(()=>{te.setTag(o.$leftText,"error","超时，不支持触发回调函数");},3e3);let c=await r.fn();clearTimeout(i),console.log(r.name+" callback tabs",c),typeof c=="object"&&c!=null?te.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"success",text:"入参tab为object类型"}]):te.setTagList(o.$leftText,[{tag:"success",text:"支持触发回调函数"},{tag:"error",text:"入参tab不为object类型"}]),alert(JSON.stringify(c));}catch(c){I.error(c.toString());}});}})));}),n}}class hi extends pe{isSupport(){return typeof qe=="function"}getApiName(){return "GM_getValue"}getAsyncApiOption(){return {name:"GM.getValue",isSupport:this.isSupportGM()&&typeof U.getValue=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=qe(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.getValue,formList:n.views[2].views}].forEach(r=>{let o=r.name;r.formList.push(...[{key:`Test ${o} boolean`,value:true,text:function(){return "存储boolean类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} number`,value:1,text:function(){return "存储number类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} string`,value:"测试字符串",text:function(){return "存储string类型并读取"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:`Test ${o} undefined`,value:void 0,text:function(){return "存储undefined类型并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} null`,value:null,text:function(){return "存储object类型的null并读取"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} object`,value:{"object key":"object value"},text:function(){return "存储object类型并读取"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(s=>(()=>{let i=s.key,l=s.value;return L(()=>({text:s.text(),description:s.desc(),tag:"info",afterRender(c){let d=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(c.$leftContainer,d),g.on(d,"click",async p=>{g.preventEvent(p);try{Pe(i,l);let f=await r.fn(i);if(typeof f==typeof l){if(l===null&&l!=f){I.error("读取成功，但存储类型和读取类型不同，存储类型为null，但读取类型不为null");return}I.success("读取成功，存储类型和读取类型一致");}else I.error("读取成功，但存储类型和读取类型不同");}catch(f){I.error(f.toString());}});}}))})()),(()=>{let s=`Test ${o} null with defaultValue`,i=123;return L(()=>({text:"存储object类型的null，读取时指定默认值为"+i,description:`${o}("${s}", ${i})`,tag:"info",afterRender(l){let c=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(l.$leftContainer,c),g.on(c,"click",async d=>{g.preventEvent(d);try{await r.fn(s,null);let p=await r.fn(s,i);typeof p=="object"&&p==null?I.success("读取的值是存储的值："+p):I.error("读取的值不是存储的值："+p);}catch(p){I.error(p.toString());}});}}))})(),(()=>{let s=`Test ${o} defaultValue`,i=123;return L(()=>({text:"不存储，测试调用默认值",description:`${o}("${s}", ${i})`,tag:"info",afterRender(l){let c=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(l.$leftContainer,c),g.on(c,"click",async d=>{g.preventEvent(d);try{let p=await r.fn(s,i);typeof p==typeof i?I.success("读取的值是默认值："+p):I.error("读取的值不是默认值："+p);}catch(p){I.error(p.toString());}});}}))})());}),n}}class mi extends pe{isSupport(){return typeof ht=="function"}getApiName(){return "GM_getValues"}getAsyncApiOption(){return {name:"GM.getValues",isSupport:this.isSupportGM()&&typeof U.getValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=ht(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.getValues,formList:n.views[2].views}].forEach(r=>{let o=r.name;r.formList.push(L(()=>({text:"测试直接读取",description:"没有入参",tag:"info",afterRender(s){let i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);g.after(s.$leftContainer,i),g.on(i,"click",async l=>{g.preventEvent(l);try{let c=await r.fn();I.info("请在控制台查看读取的数据"),console.log(c);}catch(c){I.error(c.toString());}});}})),L(()=>{let s=re.toJSON(`{
								"${o}-test-key-non-exists-1": 1111,
								"${o}-test-key-non-exists-2": 2222,
							}`);return {text:"测试读取不存在的数据",description:"数据默认值："+JSON.stringify(s),tag:"info",afterRender(i){let l=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);g.after(i.$leftContainer,l),g.on(l,"click",async c=>{g.preventEvent(c);try{let d=await r.fn(s);console.log(d),d==null?I.error("读取失败，读取的数据为null"):JSON.stringify(d)===JSON.stringify(s)?I.success("读取成功，读取的数据和默认值相同"):I.error("读取成功，但读取的数据和默认值不同");}catch(d){I.error(d.toString());}});}}}),(()=>{let s=re.toJSON(`{
							"${o}-test-key-1": 1,
							"${o}-test-key-2": 2,
						}`);return L(()=>({text:"测试存储对象并读取",description:JSON.stringify(s),tag:"info",afterRender(i){let l=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(i.$leftContainer,l),g.on(l,"click",async c=>{g.preventEvent(c);try{nt(s);let d=Object.keys(s),p=await r.fn(d);console.log(p),p==null?I.error("读取失败，读取的数据为null"):JSON.stringify(p)===JSON.stringify(s)?I.success("读取成功，写入的数据和读取的数据相同"):I.error("读取成功，但写入的数据和读取的数据不同");}catch(d){I.error(d.toString());}});}}))})());}),n}}class gi extends pe{isSupport(){return typeof je=="object"&&je!=null}getApiName(){return "GM_info"}getAsyncApiOption(){return {name:"GM.info",isSupport:this.isSupportGM()&&typeof U.info=="object"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（GM）",views:[]}]};return this.isSupport()&&[{name:e,fn:je,formList:n.views[1].views},{name:t.name,fn:U.info,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push(...[{value:r.fn?.downloadMode,type:"string",text:`${r.name}.downloadMode`,notExistsTag:"error"},{value:r.fn?.scriptHandler,type:"string",text:`${r.name}.scriptHandler`},{value:r.fn?.scriptMetaStr,type:"string",text:`${r.name}.scriptMetaStr`},{value:r.fn?.version,type:"string",text:`${r.name}.version`},{value:r.fn?.script,type:"object",text:`${r.name}.script`},{value:r.fn?.script?.name,type:"string",text:`${r.name}.script.name`},{value:r.fn?.script?.author,type:"string",text:`${r.name}.script.author`},{value:r.fn?.script?.description,type:"string",text:`${r.name}.script.description`},{value:r.fn?.script?.version,type:"string",text:`${r.name}.script.version`}].map(o=>L(()=>{try{return o.value!=null&&typeof o.value===o.type?{text:"支持 "+o.text+" 类型："+o.type,tag:"success"}:{text:"不支持 "+o.text+" 类型："+o.type,tag:o.notExistsTag??"error"}}catch(s){return console.error(s),{text:"执行错误 "+s,tag:"error"}}})));}),n}}class yi extends pe{isSupport(){return typeof Ze=="function"}getApiName(){return "GM_listValues"}getAsyncApiOption(){return {name:"GM.listValues",isSupport:this.isSupportGM()&&typeof U.listValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=Ze(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.listValues,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push(L(()=>({text:"查看存储的所有键名",tag:"info",afterRender(o){let s=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);g.after(o.$leftContainer,s),g.on(s,"click",async i=>{g.preventEvent(i);try{let l=await r.fn();console.log(r.name+" call result",l),Array.isArray(l)?l.find(d=>typeof d!="string")?I.error("返回值数组中存在非string类型"):alert(JSON.stringify(l,null,4)):I.error("返回值不是数组");}catch(l){I.error(l.toString());}});}})));}),n}}class xi extends pe{isSupport(){return typeof on=="function"}getApiName(){return "GM_log"}getAsyncApiOption(){return {name:"GM.log",isSupport:this.isSupportGM()&&typeof U.log=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=on(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.log,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push(L(()=>{try{let o="test "+r.name;return {text:ce.escapeHtml("请在控制台查看输出"),tag:"info",description:"test "+r.name,afterRender(s){let i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击执行</span>
								...
								`,!1,!1);g.on(i,"click",async l=>{g.preventEvent(l);try{await r.fn(o);}catch(c){I.error(c.toString());}}),g.after(s.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class wi extends pe{isSupport(){return typeof an=="function"}getApiName(){return "GM_notification"}getAsyncApiOption(){return {name:"GM.notification",isSupport:this.isSupportGM()&&typeof U.notification=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async r=>new Promise(o=>{let s=r.onclick,i=an({...r,onclick(...l){typeof s=="function"&&Reflect.apply(s,this,l),o(i??true);}});}),formList:n.views[1].views},{name:t.name,fn:U.notification,formList:n.views[2].views}].forEach(r=>{r.name.replace(".","__async__"),r.formList.push(L(()=>{try{return {text:ce.escapeHtml("点击通知的内容测试url"),tag:"info",description:"https://example.com/",afterRender(o){let s=o.target,i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);g.on(i,"click",async l=>{g.preventEvent(l);try{await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/"});}catch(c){I.error(c.toString());}}),g.after(o.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),L(()=>{try{let o,s,i=!1,l=!1;return {text:"测试通知的timeout",description:"请勿点击通知",tag:"info",afterRender(c){o=c.target,s=c.$leftContainer;let d=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),p,f=re.debounce(()=>{try{clearTimeout(p),g.html(c.$leftText,'<p class="success">测试成功，触发</p>'),i=!1,l=!1;}catch(b){I.error(b.toString());}},800);g.on(d,"click",async b=>{try{g.preventEvent(b),clearTimeout(p);let h=10,m=h,x=()=>{let v="正在等待触发超时：5000ms";return m--,v};te.setTag(c.$leftText,"info",x()),p=$e(()=>{te.setTag(c.$leftText,"error","测试超时，未触发ondone回调");},h*1e3);const A=await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",timeout:5e3,ondone(){f();}});}catch(h){I.error(h.toString());}}),g.after(s,d);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),L(()=>{try{let o,s,i=!1,l=!1,c=!1,d="点击通知的内容测试onclick、ondone函数";return {text:d,description:"https://example.com/",tag:"info",afterRender(f){o=f.target,s=f.$leftContainer;let b=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),h,m,x=re.debounce(()=>{try{clearTimeout(h),clearInterval(m);let A="",v="success",S="",C="success";i?(A+="支持 onclick 函数",l?(A=A.trim(),A+="且支持提供 event 参数"):(A+="但是不支持提供 event 参数",v="warn")):(A+="不支持 onclick 函数",v="error"),c?S+="支持 ondone 函数":(S+="不支持 ondone 函数",C="error"),g.html(f.$leftText,`
												<p class="${v}">${A}</p>
												<p class="${C}">${S}</p>`),i=!1,c=!1,l=!1;}catch(A){I.error(A.toString());}},800);g.on(b,"click",async A=>{try{g.preventEvent(A),clearTimeout(h),clearInterval(m);let v=10,S=v,C=()=>{let w=`正在等待触发回调，请在规定时间内点击弹窗的【关闭】按钮或者内容：${S}s`;return S--,w};g.text(f.$leftText,C()),g.text(f.$leftDesc,d),g.show(f.$leftDesc,!1),h=$e(()=>{clearInterval(m),te.setTag(f.$leftText,"error","测试超时，未触发回调");},v*1e3),m=setInterval(()=>{g.text(f.$leftText,C());},1e3),await r.fn({title:`测试 ${r.name} 标题`,text:`测试 ${r.name} 内容`,url:"https://example.com/",onclick:w=>{console.log(w),i=!0,w&&typeof w.preventDefault=="function"&&(l=!0,w.preventDefault()),x();},ondone(){c=!0,x();}});}catch(v){I.error(v.toString());}}),g.after(s,b);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),L(()=>{try{let o,s,i=!1,l=!1,c=!1,d="123",p="456",f="notification_tag_"+Date.now(),b={title:"测试通知的内容更新（tag）",text:d,tag:f},h=`更新前：${d}，更新后：${p}`;return {text:b.title,description:h,tag:"info",afterRender(m){o=m.target,s=m.$leftContainer;let x=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),A,v;g.on(x,"click",async S=>{try{g.preventEvent(S),clearTimeout(A),clearInterval(v);let C=5,w=C,E=()=>{let B=`${w}s后通知的内容将更新为：${p}`;return w--,B};g.text(m.$leftDesc,E()),g.show(m.$leftDesc,!1),A=setTimeout(async()=>{clearInterval(v),g.text(m.$leftDesc,h),r.fn({...b,text:p});},C*1e3),v=setInterval(()=>{g.text(m.$leftDesc,E());},1e3),await r.fn(b);}catch(C){I.error(C.toString());}}),g.after(s,x);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class vi extends pe{isSupport(){return typeof sn=="function"}getApiName(){return "GM_openInTab"}getAsyncApiOption(){return {name:"GM.openInTab",isSupport:this.isSupportGM()&&typeof U.openInTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=sn(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.openInTab,formList:n.views[2].views}].forEach(r=>{r.formList.push(L(()=>{try{return {text:"后台打开 active: false",tag:"info",afterRender(o){let s=o.target,i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
									...
									`,!1,!1);g.on(i,"click",async l=>{try{g.preventEvent(l),g.text(o.$leftDesc,this.text),g.show(o.$leftDesc,!1);let c=await r.fn("https://www.example.com/",{active:!1});if(typeof c=="object")if(c==null)te.setTag(o.$leftText,"error","返回值为null");else {let d="close"in c&&typeof c.close=="function",p="closed"in c&&typeof c.closed=="boolean",f="onclose"in c;g.html(o.$leftText,`
										...
										`);}else te.setTag(o.$leftText,"error","返回值不是对象："+typeof c);}catch(c){I.error(c.toString());}}),g.after(o.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),L(()=>{try{return {text:"配置 active: true",description:"",tag:"info",afterRender(o){let s=o.target,i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
									...
									`,!1,!1),l,c=()=>{clearTimeout(l),te.setTag(o.$leftText,"success","测试新标签页打开成功");};g.on(i,"click",async d=>{try{g.preventEvent(d),g.off(ue,"blur",c,{capture:!0}),clearTimeout(l),te.setTag(o.$leftText,"info","等待页面失去焦点..."),g.text(o.$leftDesc,this.text),g.show(o.$leftDesc,!1),g.on(ue,"blur",c,{capture:!0,once:!0}),await r.fn("https://www.example.com/",{active:!0}),l=$e(()=>{g.off(ue,"blur",c,{capture:!0}),te.setTag(o.$leftText,"error","测试超时，未打开新标签页并获取焦点");},3e3);}catch(p){I.error(p.toString());}}),g.after(o.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),L(()=>{try{return {text:"测试调用返回值 .close()",tag:"info",afterRender(o){let s=o.target,i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),l;g.on(i,"click",async c=>{try{g.preventEvent(c),clearTimeout(l),te.setTag(o.$leftText,"info","等待调用 .close()"),g.text(o.$leftDesc,this.text),g.show(o.$leftDesc,!1);let d=await r.fn("https://www.example.com/");d&&typeof d?.close=="function"?l=$e(()=>{try{d.close(),te.setTag(o.$leftText,"success","成功调用 .close()");}catch(p){te.setTag(o.$leftText,"error","调用 .close() 方法失败 "+p);}},1e3):te.setTag(o.$leftText,"error","返回对象中不支持 .close() 方法");}catch(d){I.error(d.toString());}}),g.after(o.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),L(()=>{try{return {text:"测试监听关闭是否生效 .onclose",tag:"info",afterRender(o){let s=o.target,i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1),l,c;g.on(i,"click",async d=>{try{g.preventEvent(d),clearTimeout(c),clearTimeout(l),te.setTag(o.$leftText,"info","等待触发监听 .onclose"),g.text(o.$leftDesc,this.text),g.show(o.$leftDesc,!1);let p=await r.fn("https://www.example.com/");typeof p=="object"&&p!=null&&(p.onclose=()=>{clearTimeout(l),clearTimeout(c),te.setTag(o.$leftText,"success","成功触发 .onclose");}),p&&typeof p?.close=="function"?l=$e(()=>{try{p.close(),c=$e(()=>{te.setTag(o.$leftText,"error","测试超时，未触发回调 .onclose");},2e3);}catch(f){te.setTag(o.$leftText,"error","调用 .close() 方法失败 "+f);}},1e3):te.setTag(o.$leftText,"error","返回对象中不支持 .close() 方法");}catch(p){I.error(p.toString());}}),g.after(o.$leftContainer,i);}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class Ai extends pe{isSupport(){return typeof mt=="function"}getApiName(){return "GM_registerMenuCommand"}getAsyncApiOption(){return {name:"GM.registerMenuCommand",isSupport:this.isSupportGM()&&typeof U.registerMenuCommand=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=mt(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.registerMenuCommand,formList:n.views[2].views}].forEach(r=>{r.formList.push(L(()=>{try{return {text:"注册菜单 ==> Test Menu",tag:"info",afterRender(o){let s=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);g.after(o.$leftContainer,s);let i,l;g.on(s,"click",async c=>{try{g.preventEvent(c),clearTimeout(i),clearInterval(l),g.text(o.$leftDesc,this.text),g.show(o.$leftDesc,!1);let d=10,p=()=>{let b=`已执行注册菜单，请在${d}s内点击菜单项`;return d--,b};te.setTag(o.$leftText,"info",p()),l=setInterval(()=>{te.setTag(o.$leftText,"info",p());},1e3),i=$e(()=>{clearInterval(l),te.setTag(o.$leftText,"error","测试超时，未触发回调");},10*1e3);const f=await r.fn("Test Menu",b=>{try{clearInterval(l),clearTimeout(i),te.clearTag(o.$leftText);let h=[];h.push({tag:"success",text:"支持注册菜单"}),b?h.push({tag:"success",text:"支持点击回调且有event参数"}):h.push({tag:"warn",text:"支持点击回调但是没有event参数"}),typeof f=="number"||typeof f=="string"?h.push({tag:"success",text:"函数返回值是string|number"}):h.push({tag:"error",text:"函数返回值不是string|number："+typeof f}),g.html(o.$leftText,h.map(m=>`<p class="${m.tag}">${m.text}</p>`).join(`
`));}catch(h){I.error(h.toString(),{consoleLogContent:!0});}});}catch(d){I.error(d.toString());}});}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}),L(()=>{try{return {text:"注册并更新菜单 ==> Test Update Menu",description:"请自行验证是否成功更新菜单文字为：Test Update Menu Success!!!",tag:"info",afterRender(o){let s=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);g.after(o.$leftContainer,s);let i;g.on(s,"click",async l=>{try{g.preventEvent(l),clearTimeout(i);const c=await r.fn("Test Update Menu",d=>{});I.info("已注册菜单，3s后自动更新",{timeout:3e3}),clearTimeout(i),i=$e(async()=>{await r.fn("Test Update Menu Success!!!",()=>{},{id:c}),I.success("已执行更新菜单命令，请自行验证");},3e3);}catch(c){I.error(c.toString());}});}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class Si extends pe{isSupport(){return typeof ln=="function"}getApiName(){return "GM_removeValueChangeListener"}getAsyncApiOption(){return {name:"GM.removeValueChangeListener",isSupport:this.isSupportGM()&&typeof U.removeValueChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=ln(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.removeValueChangeListener,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push((()=>{let o=e+"_key_1";return L(()=>({text:"测试移除监听器",description:"",tag:"info",afterRender(s){let i=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(s.$leftContainer,i);let l=[];g.on(i,"click",async c=>{g.preventEvent(c);try{l.length=0,te.setTag(s.$leftText,"info","等待移除监听器"),g.text(s.$leftDesc,this.text),g.show(s.$leftDesc,!1);let d=re.formatTime(Date.now()),p=Lt(o,function(f,b,h,m){console.log(arguments),l.push({tag:"error",text:"未成功移除监听器"}),te.setTagList(s.$leftText,l);});await r.fn(p),l.push({tag:"success",text:"支持移除监听器"}),te.setTagList(s.$leftText,l),Pe(o,d);}catch(d){I.error(d.toString());}});}}))})());}),n}}class Ci extends pe{isSupport(){return typeof Vr=="function"}getApiName(){return "GM_saveTab"}getAsyncApiOption(){return {name:"GM.saveTab",isSupport:this.isSupportGM()&&typeof U.saveTab=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]}]};return this.isSupport()&&n.views[1].views.push(L(()=>{try{return {text:ce.escapeHtml("TODO"),tag:"info"}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}})),n}}class Ti extends pe{isSupport(){return typeof cn=="function"}getApiName(){return "GM_setClipboard"}getAsyncApiOption(){return {name:"GM.setClipboard",isSupport:this.isSupportGM()&&typeof U.setClipboard=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{if(typeof r[2]=="function"){const s=r[2];r[2]=(...i)=>{s(...i),o(void 0);};}cn(...r);}),formList:n.views[1].views},{name:t.name,fn:async(...r)=>{const o=r[2];await U.setClipboard(...r),typeof o=="function"&&o();},formList:n.views[2].views}].forEach(r=>{r.formList.push(L(()=>({text:"复制内容到剪贴板：Test "+r.name,tag:"info",afterRender(o){let s=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);g.after(o.$leftContainer,s);let i;g.on(s,"click",async l=>{try{g.preventEvent(l),clearTimeout(i),I.info("等待3s内触发成功复制的回调"),i=$e(()=>{te.setTag(o.$leftText,"error","不支持触发回调函数");},3e3),await r.fn("Test "+r.name,"text",()=>{clearTimeout(i),te.setTag(o.$leftText,"success","支持触发回调函数");});}catch(c){I.error(c.toString());}});}})));}),n}}class ki extends pe{isSupport(){return typeof Pe=="function"}getApiName(){return "GM_setValue"}getAsyncApiOption(){return {name:"GM.setValue",isSupport:this.isSupportGM()&&typeof U.setValue=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=Pe(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.setValue,formList:n.views[2].views}].forEach(r=>{let o=r.name;r.formList.push(...[{key:`Test ${o} boolean`,value:true,text:function(){return "存储boolean类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} number`,value:1,text:function(){return "存储number类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} string`,value:"测试字符串",text:function(){return "存储string类型"},desc:function(){return `"${this.key}": "${this.value}"`}},{key:`Test ${o} undefined`,value:void 0,text:function(){return "存储undefined类型"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} null`,value:null,text:function(){return "存储object类型的null"},desc:function(){return `"${this.key}": ${this.value}`}},{key:`Test ${o} object`,value:{"object key":"object value"},text:function(){return "存储object类型"},desc:function(){return `"${this.key}": ${JSON.stringify(this.value)}`}}].map(s=>(()=>{let i=s.key,l=s.value;return L(()=>({text:s.text(),description:s.desc(),tag:"info",afterRender(c){let d=g.toElement(`
										<div class="pops-panel-button pops-panel-button-no-icon">
											<button class="pops-panel-button_inner" type="button" data-type="default">
												<i class="pops-bottom-icon" is-loading="false"></i>
												<span class="pops-panel-button-text">点击测试</span>
									...
									`,false,false);g.after(c.$leftContainer,d),g.on(d,"click",async p=>{g.preventEvent(p);try{await r.fn(i,l),I.info("执行写入完毕，请自行查看是否成功写入");}catch(f){I.error(f.toString());}});}}))})()));}),n}}class Ei extends pe{isSupport(){return typeof nt=="function"}getApiName(){return "GM_setValues"}getAsyncApiOption(){return {name:"GM.setValues",isSupport:this.isSupportGM()&&typeof U.setValues=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=nt(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.setValues,formList:n.views[2].views}].forEach(r=>{r.name,r.formList.push((()=>{let o={foo:1,bar:2};return L(()=>({text:"测试存储对象",description:JSON.stringify(o),tag:"info",afterRender(s){let i=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,false,false);g.after(s.$leftContainer,i),g.on(i,"click",async l=>{g.preventEvent(l);try{await r.fn(o),I.info("执行写入完毕，请自行查看是否成功写入");}catch(c){I.error(c.toString());}});}}))})());}),n}}class $i extends pe{isSupport(){return typeof It=="function"}getApiName(){return "GM_unregisterMenuCommand"}getAsyncApiOption(){return {name:"GM.unregisterMenuCommand",isSupport:this.isSupportGM()&&typeof U.unregisterMenuCommand=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]};return this.isSupport()&&[{name:e,fn:async(...r)=>new Promise(o=>{const s=It(...r);o(s);}),formList:n.views[1].views},{name:t.name,fn:U.unregisterMenuCommand,formList:n.views[2].views}].forEach(r=>{r.formList.push(L(()=>{try{return {text:"注册并卸载菜单 ==> Test UnRegister Menu",description:"请自行验证是否成功卸载菜单",tag:"info",afterRender(o){let s=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击测试</span>
								...
								`,!1,!1);g.after(o.$leftContainer,s);let i;g.on(s,"click",l=>{try{g.preventEvent(l),clearTimeout(i);const c=mt("Test UnRegister Menu",d=>{});I.info("已注册菜单，10s后自动执行卸载",{timeout:10*1e3}),clearTimeout(i),i=$e(async()=>{await r.fn(c),I.success("已执行卸载菜单命令，请自行验证");},10*1e3);}catch(c){I.error(c.toString());}});}}}catch(o){return console.error(o),{text:"执行错误 "+o,tag:"error"}}}));}),n}}class Mi extends pe{getApiName(){return "unsafeWindow"}getAsyncApiOption(){}isSupport(){return typeof ue=="object"&&ue!=null}getUIOption(){let e=this.getApiName(),t={id:"aside-"+e,title:e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(n){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"})]},{type:"container",text:"功能测试",views:[]}]};return this.isSupport()&&t.views[1].views.push(L(()=>{let n="test-gm-window",r=He==ue;return He[n]=n,r=typeof ue[n]!="string",Reflect.deleteProperty(He,n),r?{text:"window已被Proxy代理",tag:"success"}:{text:"window未被Proxy代理，定义全局变量时会影响到页面变量",tag:"warn"}})),t}}class Li extends pe{isSupport(){return typeof Ur=="function"}getApiName(){return "GM_webRequest"}getAsyncApiOption(){return {name:"GM.webRequest",isSupport:this.isSupportGM()&&typeof U.webRequest=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]}]};return this.isSupport()&&n.views[1].views.push(L(()=>{try{return {text:ce.escapeHtml("TODO"),tag:"info"}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}})),n}}class Ii extends pe{isSupport(){return typeof In=="function"}getApiName(){return "GM_xmlhttpRequest"}getAsyncApiOption(){return {name:"GM.xmlHttpRequest",isSupport:this.isSupportGM()&&typeof U.xmlHttpRequest=="function"}}getUIOption(){let e=this.getApiName(),t=this.getAsyncApiOption(),n={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e,`${e} & ${t.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(r){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:"支持 "+e,tag:"success"}:{text:"不支持 "+e,tag:"error"}),L(()=>t.isSupport?{text:"支持 "+t.name,tag:"success"}:{text:"不支持 "+t.name,tag:"error"})]},{type:"container",text:"功能测试",views:[]}]};return this.isSupport()&&n.views[1].views.push(L(()=>{try{return {text:ce.escapeHtml("TODO"),tag:"info"}}catch(r){return console.error(r),{text:"执行错误 "+r,tag:"error"}}})),n}}class _i extends pe{getApiName(){return "GM"}getAsyncApiOption(){}isSupport(){return typeof U=="object"&&U!=null}getUIOption(){}}class Ri extends pe{isSupport(){return (typeof Ae=="object"||typeof Ae=="function")&&Ae!=null&&typeof Ae?.setMute=="function"&&typeof Ae?.getState=="function"&&typeof Ae?.addStateChangeListener=="function"&&typeof Ae?.removeStateChangeListener=="function"}getApiOption(){let e=this.isSupport();return {isSupport_setMute:e&&typeof Ae?.setMute=="function",isSupport_getState:e&&typeof Ae?.getState=="function",isSupport_addStateChangeListener:e&&typeof Ae?.addStateChangeListener=="function",isSupport_removeStateChangeListener:e&&typeof Ae?.removeStateChangeListener=="function"}}getApiName(){return "GM_audio"}getAsyncApiOption(){let e=this.isSupportGM()&&(typeof U.audio=="object"||typeof U.audio=="function")&&U.audio!=null&&typeof U.audio?.setMute=="function"&&typeof U.audio?.getState=="function"&&typeof U.audio?.addStateChangeListener=="function"&&typeof U.audio?.removeStateChangeListener=="function";return {name:"GM.audio",isSupport:e,isSupport_setMute:e&&typeof U.audio?.setMute=="function",isSupport_getState:e&&typeof U.audio?.getState=="function",isSupport_addStateChangeListener:e&&typeof U.audio?.addStateChangeListener=="function",isSupport_removeStateChangeListener:e&&typeof U.audio?.removeStateChangeListener=="function"}}getUIOption(){let e=this.getApiName(),t=this.getApiOption(),n=this.getAsyncApiOption(),r={id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e+".setMute",`${e} & ${n.name}`)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(s){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"函数测试",views:[L(()=>this.isSupport()?{text:`支持 ${e}，类型：${typeof Ae}`,tag:"success"}:{text:"不支持 "+e,tag:"error"})]},{type:"container",text:"功能测试",views:[]},{type:"container",text:"功能测试（异步）",views:[]}]},o=r.views[0].views;return this.isSupport()&&o.push(L(()=>t.isSupport_setMute?{text:`支持 ${e}.setMute`,tag:"success"}:{text:`不支持 ${e}.setMute`,tag:"error"}),L(()=>t.isSupport_getState?{text:`支持 ${e}.getState`,tag:"success"}:{text:`不支持 ${e}.getState`,tag:"error"}),L(()=>t.isSupport_addStateChangeListener?{text:`支持 ${e}.addStateChangeListener`,tag:"success"}:{text:`不支持 ${e}.addStateChangeListener`,tag:"error"}),L(()=>t.isSupport_removeStateChangeListener?{text:`支持 ${e}.removeStateChangeListener`,tag:"success"}:{text:`不支持 ${e}.removeStateChangeListener`,tag:"error"})),n.isSupport?o.push(L(()=>n.isSupport_setMute?{text:`支持 ${n.name}.setMute`,tag:"success"}:{text:`不支持 ${n.name}.setMute`,tag:"error"}),L(()=>n.isSupport_getState?{text:`支持 ${n.name}.getState`,tag:"success"}:{text:`不支持 ${n.name}.getState`,tag:"error"}),L(()=>n.isSupport_addStateChangeListener?{text:`支持 ${n.name}.addStateChangeListener`,tag:"success"}:{text:`不支持 ${n.name}.addStateChangeListener`,tag:"error"}),L(()=>n.isSupport_removeStateChangeListener?{text:`支持 ${n.name}.removeStateChangeListener`,tag:"success"}:{text:`不支持 ${n.name}.removeStateChangeListener`,tag:"error"})):o.push(L(()=>({text:"不支持 "+n.name,tag:"error"}))),this.isSupport()&&[{name:e,setMute:async(...s)=>new Promise((i,l)=>{const[c,d]=s;Ae.setMute(c,p=>{p?l(p):i(void 0);});}),getState:async(...s)=>new Promise((i,l)=>{const[c,d]=s;Ae.getState(p=>{p||l(new Error("failed to read state")),i(p);});}),addStateChangeListener:async(...s)=>new Promise((i,l)=>{const[c]=s;Ae.addStateChangeListener(c,d=>{d?l(d):i(void 0);});}),removeStateChangeListener:async(...s)=>new Promise((i,l)=>{const[c]=s;Ae.removeStateChangeListener(c,d=>{d?l(d):i(void 0);});}),formList:r.views[1].views},{name:n.name,setMute:async(...s)=>{const[i]=s;return await U.audio?.setMute(i)},getState:async(...s)=>{const i=await U.audio?.getState();if(typeof i=="object"&&i!=null){if(typeof i?.isMuted!="boolean")throw new Error("GM.audio.getState 返回值类型错误");return i}else throw new Error("返回值不是一个对象")},addStateChangeListener:U.audio?.addStateChangeListener,removeStateChangeListener:U.audio?.removeStateChangeListener,formList:r.views[2].views}].forEach(s=>{s.name,s.formList.push(L(()=>{try{return {text:ce.escapeHtml("测试设置当前tab静音"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=g.toElement(`
                                        <div class="pops-panel-button pops-panel-button-no-icon">
                                            <button class="pops-panel-button_inner" type="button" data-type="default">
                                                <i class="pops-bottom-icon" is-loading="false"></i>
                                                <span class="pops-panel-button-text">点击执行</span>
                                        ...
                                        `,!1,!1);g.on(l,"click",async c=>{try{g.preventEvent(c);const d=await s.setMute({isMuted:!0});console.log(s.name+".setMute result：",d),d===void 0?te.setTag(i.$leftText,"success","执行成功"):te.setTag(i.$leftText,"warn","执行成功，但返回值类型不同："+d),g.text(i.$leftDesc,this.text),g.show(i.$leftDesc,!1);}catch(d){I.error(d.toString());}}),g.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}}),L(()=>{try{return {text:ce.escapeHtml("测试取消当前tab静音"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=g.toElement(`
                                        <div class="pops-panel-button pops-panel-button-no-icon">
                                            <button class="pops-panel-button_inner" type="button" data-type="default">
                                                <i class="pops-bottom-icon" is-loading="false"></i>
                                                <span class="pops-panel-button-text">点击执行</span>
                                        ...
                                        `,!1,!1);g.on(l,"click",async c=>{try{g.preventEvent(c);const d=await s.setMute({isMuted:!1});console.log(s.name+".setMute result：",d),d===void 0?te.setTag(i.$leftText,"success","执行成功"):te.setTag(i.$leftText,"warn","执行成功，但返回值类型不同："+d),g.text(i.$leftDesc,this.text),g.show(i.$leftDesc,!1);}catch(d){I.error(d.toString());}}),g.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}}),L(()=>{try{return {text:ce.escapeHtml("获取当前tab静音状态信息"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击执行</span>
									...
									`,!1,!1);g.on(l,"click",async c=>{try{g.preventEvent(c);const d=await s.getState();if(console.log(s.name+".getState result：",d),typeof d=="object"&&d!==null){const p=[];typeof d?.isMuted=="boolean"?p.push(`
                                                    ...
                                                    `),te.setTag(i.$leftText,"success",p.join(`
`));}else te.setTag(i.$leftText,"error","返回值类型错误："+typeof d);g.text(i.$leftDesc,this.text),g.show(i.$leftDesc,!1),alert(JSON.stringify(d,null,4));}catch(d){I.error(d.toString());}}),g.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}}),L(()=>{try{return {text:ce.escapeHtml("测试监听静音状态改变"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击执行</span>
									...
									`,!1,!1),c;g.on(l,"click",async d=>{try{g.preventEvent(d),await s.addStateChangeListener(p=>{console.log(s.name+".addStateChangeListener callback change value：",p),alert(JSON.stringify(p,null,4));}),await re.sleep(500),await s.setMute({isMuted:!0}),await re.sleep(500),await s.setMute({isMuted:!1});}catch(p){I.error(p.toString());}}),g.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}}),L(()=>{try{return {text:ce.escapeHtml("测试移除监听器"),tag:"info",description:"点击按钮进行测试",afterRender(i){let l=g.toElement(`
									<div class="pops-panel-button pops-panel-button-no-icon">
										<button class="pops-panel-button_inner" type="button" data-type="default">
											<i class="pops-bottom-icon" is-loading="false"></i>
											<span class="pops-panel-button-text">点击执行</span>
									...
									`,!1,!1),c=!0,d;g.on(l,"click",async p=>{try{g.preventEvent(p);let f=b=>{c=!1,I.error("移除监听器失败");};d=I.loading("处理监听器中..."),await s.addStateChangeListener(f),await s.removeStateChangeListener(f),d.setText("等待500ms，设置当前Tab静音"),await re.sleep(500),await s.setMute({isMuted:!0}),d.setText("等待500ms，设置当前Tab取消静音"),await re.sleep(500),await s.setMute({isMuted:!1}),d.close(),c&&I.success("移除监听器成功");}catch(f){d?.close(),I.error(f.toString());}}),g.after(i.$leftContainer,l);}}}catch(i){return console.error(i),{text:"执行错误 "+i,tag:"error"}}}));}),r}}const Te={unsafeWindow:new Mi,GM:new _i,addElement:new oi,addStyle:new ai,download:new pi,getResourceText:new di,getResourceUrl:new fi,info:new gi,log:new xi,notification:new wi,openInTab:new vi,registerMenuCommand:new Ai,unregisterMenuCommand:new $i,setClipboard:new Ti,getTab:new ui,saveTab:new Ci,getTabs:new bi,setValue:new ki,getValue:new hi,deleteValue:new li,listValues:new yi,setValues:new Ei,getValues:new mi,deleteValues:new ci,addValueChangeListener:new si,removeValueChangeListener:new Si,xmlHttpRequest:new Ii,webRequest:new Li,cookie:new ii,audio:new Ri},ze={$storageKey:"gm-api-test-storage-config",set(a,e){let t=window.localStorage.getItem(ze.$storageKey)??"{}",n=re.toJSON(t);n[a]=e,window.localStorage.setItem(ze.$storageKey,JSON.stringify(n,(r,o)=>typeof o=="function"?o.tString():o));},get(a,e){let t=window.localStorage.getItem(ze.$storageKey)??"{}";return re.toJSON(t)[a]??e},delete(a){let e=window.localStorage.getItem(ze.$storageKey)??"{}",t=re.toJSON(e);Reflect.deleteProperty(t,a),window.localStorage.setItem(ze.$storageKey,JSON.stringify(t,(n,r)=>typeof r=="function"?r.tString():r));}},K={set(a,e){Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?Pe(a,e):ze.set(a,e);},get(a,e){return Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?qe(a,e):ze.get(a,e)},delete(a){Te.setValue.isSupport()&&Te.getValue.isSupport()&&Te.deleteValue.isSupport()?tt(a):ze.delete(a);}},Ni=()=>{let a=[],e=[];Object.keys(Te).forEach(n=>{let r=Te[n],o=r.getApiName(),s=r.isSupport(),i=r.getAsyncApiOption();s?a.push({name:o,isSupport:s}):e.push({name:o,isSupport:s}),i&&(i.isSupport?a.push({name:i.name,isSupport:i.isSupport,leftTargetSelector:"#aside-"+o}):e.push({name:i.name,isSupport:i.isSupport,leftTargetSelector:"#aside-"+o}));});let t=n=>{let r=g.createElement("div",{className:"gm-api-features-item",innerHTML:`
			...
			`});return g.on(r,"click",o=>{g.preventEvent(o);let s=r.getRootNode(),i=re.isNotNull(n.leftTargetSelector)?n.leftTargetSelector:"#aside-"+n.name,l=s.querySelector(i);l&&(l.click(),l.scrollIntoView({behavior:"smooth"}));}),r};return {id:"component-common",title:"通用",scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)==="component-common"},clickCallback(n){K.set(W.asideLastVisit,"component-common");},views:[{type:"container",text:"@run-at document-start<br>注：注入速度等级越低，注入的速度越快<br>范围：0~4",views:[L(()=>({text:ce.escapeHtml(Je),tag:"info"}))]},{type:"container",text:"特性",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontSize="1.2em",r.formHeaderDivElement.style.fontWeight="700";},views:[]},{type:"container",text:"不支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.color="rgb(216, 30, 6)",r.formHeaderDivElement.style.fontWeight="600",e.length===0&&r.formContainerListElement?.remove();},views:[Pt(n=>{const r=g.createElement("div",{className:"gm-api-features-not-support"}),o=document.createDocumentFragment();return e.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n})]},{type:"container",text:"支持列表",afterAddToUListCallBack(n,r){r.formHeaderDivElement.style.fontWeight="600",a.length===0&&r.formContainerListElement?.remove();},views:[Pt(n=>{const r=g.createElement("div",{className:"gm-api-features-support"}),o=document.createDocumentFragment();return a.forEach(s=>{o.append(t(s));}),r.appendChild(o),n.appendChild(r),n})]}]}};class Di extends kt{getApiName(){return "window.onurlchange "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(n){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"功能测试",views:[L(()=>{try{return {text:ce.escapeHtml("测试window.onurlchange"),tag:"info",description:"点击按钮进行测试",afterRender(n){let r=g.toElement(`
											<div class="pops-panel-button pops-panel-button-no-icon">
												<button class="pops-panel-button_inner" type="button" data-type="default">
													<i class="pops-bottom-icon" is-loading="false"></i>
													<span class="pops-panel-button-text">点击执行</span>
											...
											`,!1,!1),o=i=>{clearTimeout(s),console.log("urlchange event info ==> ",i),I.success("urlchange event ==> url is changed");},s;g.on(r,"click",i=>{try{g.preventEvent(i),clearTimeout(s),He.onurlchange===null?(He.removeEventListener("urlchange",o),He.addEventListener("urlchange",o),window.history.pushState({},"","#/onurlchange"),s=setTimeout(()=>{I.error("urlchange event is not trigger");},1e3)):I.error("window.onurlchange is not null");}catch(l){I.error(l.toString(),{consoleLogContent:!0});}}),g.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}})]}]}}}class Oi extends kt{getApiName(){return "window.close "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(n){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"功能测试",views:[L(()=>{try{return {text:ce.escapeHtml("测试window.close"),tag:"info",description:"点击按钮执行该函数",afterRender(n){let r=g.toElement(`
											<div class="pops-panel-button pops-panel-button-no-icon">
												<button class="pops-panel-button_inner" type="button" data-type="default">
													<i class="pops-bottom-icon" is-loading="false"></i>
													<span class="pops-panel-button-text">点击执行</span>
											...
											`,!1,!1);g.on(r,"click",o=>{g.preventEvent(o);try{He.close();}catch(s){I.error(s.toString(),{consoleLogContent:!0});}}),g.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}})]}]}}}class Pi extends kt{getApiName(){return "window.focus "}getAsyncApiOption(){}isSupport(){return  true}getUIOption(){let e=this.getApiName();return {id:"aside-"+e,title:""+e,headerTitle:`${se.getApiDocUrl(e)}`,scrollToDefaultView:true,isDefault(){return K.get(W.asideLastVisit)===e},clickCallback(n){K.set(W.asideLastVisit,e);},views:[{type:"container",text:"功能测试",views:[L(()=>{try{return {text:ce.escapeHtml("测试window.focus"),tag:"info",description:"点击按钮执行该函数",afterRender(n){let r=g.toElement(`
											<div class="pops-panel-button pops-panel-button-no-icon">
												<button class="pops-panel-button_inner" type="button" data-type="default">
													<i class="pops-bottom-icon" is-loading="false"></i>
													<span class="pops-panel-button-text">点击执行</span>
										...
										`,!1,!1),o=()=>{setTimeout(()=>{He.focus();},3e3);};g.on(r,"click",s=>{g.preventEvent(s),window.removeEventListener("blur",o,{capture:!0}),window.addEventListener("blur",o,{capture:!0,once:!0});try{I.info("请切换至其它Tab页面，切换完毕3秒后会自动调用该函数");}catch(i){I.error(i.toString(),{consoleLogContent:!0});}}),g.after(n.$leftContainer,r);}}}catch(n){return console.error(n),{text:"执行错误 "+n,tag:"error"}}})]}]}}}if(Ie.isTopWindow()){let a=()=>{Ie.showPanel(ct.getConfig(0),void 0,void 0,true);},e=Ot.getMenuOption(0);e.callback=()=>{a();},Ot.updateMenuOption(e);let t=[Ni()];Object.keys(Te).forEach(n=>{let o=Te[n].getUIOption();o&&t.push(o);}),t.push(new Di().getUIOption()),t.push(new Oi().getUIOption()),t.push(new Pi().getUIOption()),ct.addContentConfig(t),Ie.$data.panelConfig={style:`
		.success{
			color: green;
		}
		.error{

    ...
    utils.mutationObserver(document.documentElement, {
      ...
      callback: () => {
        ...
        function handleCardMainTime() {
          // 其它区域，如首页
          Array.from($$<HTMLElement>(".card.m-panel .m-text-cut .time:not([data-gm-absolute-time])")).forEach(
            ($time) => {
        ...
        function handleCardLzlTime() {
          ...
          if (litePageWrapVueIns) {
            ...
            let $timeList = Array.from($$<HTMLElement>(".lite-page-comment .card .card-main .m-box .time"));
        ...
        function handleCardCommentTime() {
          Array.from($$<HTMLElement>(".comment-content .card .m-box .time:not([data-gm-absolute-time])")).forEach(
            ($time) => {

              ...
              views: [
                ...
                UIButton(
                  ...
                  async (event) => {
                    ...
                    let $desc = $li.querySelector<HTMLElement>(".pops-panel-item-left-desc-text")!;
                  ...
                  async (formCOnfig, container) => {
                    let $desc = container.target!.querySelector<HTMLElement>(".pops-panel-item-left-desc-text")!;

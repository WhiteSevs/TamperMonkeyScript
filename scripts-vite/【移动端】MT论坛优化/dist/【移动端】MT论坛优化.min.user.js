            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=!0;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=!0;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=!0;});},setUploadChangeEvent(t,e,i,n){r.on(t,"change",s=>{var m;if(!((m=t.files)!=null&&m.length))return;r.text(e,"🤡获取文件信息中..."),e.removeAttribute("data-success");let l=t.files[0],o=l.size,a=new Image,c=new FileReader;c.readAsDataURL(l),c.onload=function(d){a.src=d.target.result,a.onload=function(){if(a.width>i.width||a.height>i.height){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片尺寸不符合，宽：${a.width} 高：${a.height}`);return}if(o>lt.$data.avatarInfo.maxSize){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片大小不符合：${o}byte，限制最大：${lt.$data.avatarInfo.maxSize}byte`);return}e.setAttribute("data-success","true"),r.text(e,`🤣 通过 宽:${a.width} 高:${a.height} 大小(byte):${o}`),n();};};});},async getUploadUrl(){let t=await F.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":g.getRandomPCUA()}});if(!t.status)return;if(g.isNull(t.data.responseText)){x.error("获取PC数据失败");return}let e=t.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(e==null||e.length!=2){x.error("获取变量-data失败");return}let n=e[e.length-1].split(",");return n[n.indexOf("src")+1].replace("images/camera.swf?inajax=1","index.php?m=user&a=rectavatar&base64=yes")}},ie={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[Tt("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,i)=>{b.info("设置当前Qmsg弹出位置"+i);},"Toast显示在页面九宫格的位置"),Tt("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),R("逆序弹出","qmsg-config-showreverse",!1,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[R("启用","httpx-use-cookie-enable",!1,void 0,"启用后，将根据下面的配置进行添加cookie"),R("使用document.cookie","httpx-use-document-cookie",!1,void 0,"自动根据请求的域名来设置对应的cookie"),pt("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[R("链接文本转超链接","mt-link-text-to-hyperlink",!0,void 0,"自动把页面中的链接文本转换为超链接"),R("显示用户UID","mt-show-user-uid",!0,void 0,"格式为UID：xxx"),R("小窗模式","mt-small-window",!0,void 0,"开启后点击帖子右侧区域为小窗打开")]}]},{text:"额外菜单项",type:"deepMenu",forms:[{type:"forms",text:"",forms:[R("小黑屋","mt-black-home",!0,void 0,"将会在左侧面板添加【小黑屋】菜单"),R("在线用户","mt-online-user",!0,void 0,"将会在左侧面板添加【在线用户】菜单"),R("付费主题白嫖提醒","mt-post-paidThemePost",!0,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),R("我的屏蔽","mt-ownBlock",!0,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),R("商品上架提醒","mt-productListingReminder",!0,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),R("自定义用户标签","mt-customizeUserLabels",!0,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),R("评论过滤器","mt-post-comment-filter",!0,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",forms:[{text:"",type:"forms",forms:[yt(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												style="
													...
													overflow: hidden;
												">
											`});return t.appendChild(e),t.appendChild(i),t}),ft("修改头像",`可以上传gif图片，注意图片最大限制为${st.formatByteToSize(lt.$data.avatarInfo.maxSize)}`,"上传",void 0,!1,!1,"primary",()=>{lt.init();})]}]}]}]},j={registerLeftMenu(t){g.waitNode(".comiis_sidenv_box .sidenv_li .comiis_left_Touch",1e4).then(e=>{if(!e){b.error("注册左侧面板菜单失败，原因：该元素不存在");return}let i=r.createElement("li",{className:"comiis_left_Touch",innerHTML:`

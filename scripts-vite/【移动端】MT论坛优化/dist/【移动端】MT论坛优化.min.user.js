...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof $t=="function"?$t(t.keyName):"";typeof e=="string"&&e?G(e):vt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,r.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(i=>{e.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()}},te="【移动端】MT论坛优化",g=st.noConflict(),r=X.noConflict(),B=bt,b=new g.Log(ht,y.console||Zt.console);var Et;const kt=((Et=ht==null?void 0:ht.script)==null?void 0:Et.name)||te,Lt=!1;b.config({debug:Lt,logMaxCount:1e3,autoClearConsole:!0,tag:!0});x.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return q.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return q.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return q.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let t=st.getMaxZIndex(),e=bt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return st.getMaxValue(t,e)+100}}}));const ee=new g.GM_Menu({GM_getValue:Y,GM_setValue:W,GM_registerMenuCommand:Kt,GM_unregisterMenuCommand:Qt}),V=new g.Httpx(Jt);V.interceptors.request.use(t=>(Xt.handle(t),t));V.interceptors.response.use(void 0,t=>(b.error(["拦截器-请求错误",t]),t.type==="onabort"?x.warning("请求取消"):t.type==="onerror"?x.error("请求异常"):t.type==="ontimeout"?x.error("请求超时"):x.error("其它错误"),t));V.config({logDetails:Lt});bt.GlobalConfig.setGlobalConfig({mask:{enable:!0,clickEvent:{toClose:!1,toHide:!1}}});y.Object.defineProperty,y.Function.prototype.apply,y.Function.prototype.call,y.Element.prototype.appendChild,y.setTimeout;const G=g.addStyle.bind(g);vt.setGMResourceCSS(Rt.Viewer);vt.setGMResourceCSS(Rt.Hljs);const E=document.querySelector.bind(document),O=document.querySelectorAll.bind(document),rt="GM_Panel",Dt="data-init",et="data-key",it="data-default-value",ie="data-init-more-value",P="data-storage-api",A=function(t,e,i,n,s,l){let o={text:t,type:"switch",description:s,attributes:{},props:{},getValue(){return !!this.props[P].get(e,i)},callback(a,c){let m=!!c;b.success(`${m?"开启":"关闭"} ${t}`),this.props[P].set(e,m);},afterAddToUListCallBack:l};return Reflect.set(o.attributes,et,e),Reflect.set(o.attributes,it,i),Reflect.set(o.props,P,{get(a,c){return q.getValue(a,c)},set(a,c){q.setValue(a,c);}}),o},pt=function(t,e,i,n,s,l="",o){let a={text:t,type:"textarea",attributes:{},props:{},description:n,placeholder:l,disabled:o,getValue(){return this.props[P].get(e,i)},callback(c,m){this.props[P].set(e,m);}};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,i),Reflect.set(a.props,P,{get(c,m){return q.getValue(c,m)},set(c,m){q.setValue(c,m);}}),a},St=function(t,e,i,n,s,l){let o=[];typeof n=="function"?o=n():o=n;let a={text:t,type:"select",description:l,attributes:{},props:{},getValue(){return this.props[P].get(e,i)},callback(c,m,d){let u=m;b.info(`选择：${d}`),this.props[P].set(e,u),typeof s=="function"&&s(c,u,d);},data:o};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,i),Reflect.set(a.props,P,{get(c,m){return q.getValue(c,m)},set(c,m){q.setValue(c,m);}}),a},ft=function(t,e,i,n,s,l,o,a,c){return {text:t,type:"button",description:e,buttonIcon:n,buttonIsRightIcon:s,buttonIconIsLoading:l,buttonType:o,buttonText:i,callback(d){typeof a=="function"&&a(d);},afterAddToUListCallBack:c}},Tt=function(t,e,i,n){let s={type:"own",attributes:{},props:i,getLiElementCallBack:t,afterAddToUListCallBack:n};return Reflect.set(s.attributes,Dt,()=>!1),s},F={getAvatar:(t,e="middle")=>`/uc_server/avatar.php?uid=${t}&size=${e}&ts=1`,getCurrentUID(){let t=y.discuz_uid;if(typeof t=="string")return t;let e=document.querySelector('.sidenv_exit a[href*="uid="]');if(e){let i=e.href.match(/uid=([0-9]+)/);if(i)return i[i.length-1]}},getCurrentFormHash(){let t=document.querySelector('.sidenv_exit a[href*="formhash="]');if(t){let e=t.href.match(/formhash=([0-9a-zA-Z]+)/);if(e)return e[e.length-1]}},envIsMobile(){return (y.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:t=>{let e=t.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(e){let i=e.filter(Boolean);return i[i.length-1]}},getForumId(t){let e=t.match(/&fid=([\d]+)/i);if(e)return e[e.length-1]},getPostId(t){let e=t.match(/&pid=([\d]+)/i);if(e)return e[e.length-1]},getRepquote(t){let e=t.match(/&repquote=([\d]+)/i);if(e)return e[e.length-1]}},lt={$upload:{small:!1,middle:!1,big:!1},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return lt.$el.$smallUpload.files[0]},get middle(){return lt.$el.$middleUpload.files[0]},get big(){return lt.$el.$bigUpload.files[0]}},showView(){const t=this;let e=B.confirm({title:{text:"修改头像",position:"center"},content:{text:`
                ...
                `,html:!0},btn:{ok:{text:"上传",callback:async()=>{if(!t.$upload.small){x.error("请上传小头像");return}if(!t.$upload.middle){x.error("请上传中头像");return}if(!t.$upload.big){x.error("请上传大头像");return}let i=x.loading("正在处理数据中...");try{let n=await this.getUploadUrl();if(n==null)return;let s=F.getCurrentFormHash();if(s==null){x.error("获取formhash失败");return}let l={big:{base64:await g.parseFileToBase64(this.$avatar.small)},middle:{base64:await g.parseFileToBase64(this.$avatar.middle)},small:{base64:await g.parseFileToBase64(this.$avatar.small)}};Object.keys(l).forEach(c=>{let m=l[c];m.base64=m.base64.substring(m.base64.indexOf(",")+1);});let o=new FormData;o.append("Filedata",this.$avatar.big||""),o.append("confirm","确定"),o.append("avatar1",l.big.base64),o.append("avatar2",l.middle.base64),o.append("avatar3",l.small.base64),o.append("formhash",s),b.info("头像的base64字符串",l);let a=await V.post(n,{data:o,processData:!1,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","User-Agent":g.getRandomPCUA(),Host:window.location.hostname,Origin:window.location.origin,Referer:`${window.location.origin}/home.php?mod=spacecp&ac=avatar`}});if(!a.status)return;a.data.responseText.indexOf("window.parent.postMessage('success','*')")!=-1?(e.close(),x.success("上传成功")):(b.error("上传失败",a),x.error(a.data.responseText,{timeout:6e3,isHTML:!1,html:!1}));}catch(n){b.error(n);}finally{i.close();}}}},mask:{enable:!0},width:"88vw",height:"500px",style:`
            .avatar-container{
                display: flex;
...
`;class qe{constructor(e){nt(this,"isBacking",!1);nt(this,"config");this.config=e,this.enterGestureBackMode.bind(this),this.quitGestureBackMode.bind(this),this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(e){g.preventEvent(e),!this.isBacking&&this.quitGestureBackMode(!0);}enterGestureBackMode(){b.success("进入手势模式");let e=this.config.hash;e.startsWith("#")||(e.startsWith("/")||(e="/"+e),e="#"+e),this.config.useUrl&&(e=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+e),this.config.win.history.pushState({},"",e),b.success("监听popstate事件"),r.on(this.config.win,"popstate",this.popStateEvent.bind(this),{capture:!0});}async quitGestureBackMode(e=!1){this.isBacking=!0,b.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(e);let i=Date.now()+1e3*5;for(;;){if(Date.now()>i){b.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))b.info("history.back()"),this.config.win.history.back(),await g.sleep(this.config.backDelayTime||150);else break}b.success("移除popstate事件"),r.off(this.config.win,"popstate",this.popStateEvent.bind(this),{capture:!0}),this.isBacking=!1,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(e);}}const ct={https:`
        ...
        <div class="small-window-title-container">
            ...
            `);var i="";g.sortListByProperty(e,s=>{var l=s.href.match(/thread-(.+?)-/i);return parseInt(l[l.length-1])},!0),b.info("导读内容",e),e.forEach(s=>{i+=`
                ...
                </li>`;});let n=document.querySelector(".comiis_forumlist.comiis_xznlist");X.before(n,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}};class Ht{constructor(e){nt(this,"option");this.option=e;}showView(){var o;let e=B.confirm({title:{text:this.option.title,position:"center"},content:{text:`

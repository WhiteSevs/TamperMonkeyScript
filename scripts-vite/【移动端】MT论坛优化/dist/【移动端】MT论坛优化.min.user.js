...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Pe=="function"?Pe(e.keyName):null;return typeof t=="string"&&t?K(t):pe.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(i=>{H.onReady(()=>{document.head.appendChild(t),i(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(i=>{t.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let i=[document.documentElement,document.body].concat(...e||[]);return i.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){i.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(a=>{n(a);}).catch(a=>{h.error("读取剪贴板内容失败👉",a),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(a=>{e(n);}).catch(a=>{h.error("申请剪贴板权限失败，尝试直接读取👉",a.message??a.name??a.stack),e(n);});}function i(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!i()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,i=5e3){let n,a=i-t,o=t,l=async r=>{const c=await e(r);if(typeof c=="boolean"&&c||r){f.workerClearTimeout(n);return}if(o+=t,o>a){l(true);return}n=f.workerSetTimeout(()=>{l(false);},t);};l(false);},findParentNode(e,t,i){if(i){let n=H.closest(e,i);if(n)return n.querySelector(t)}else return H.matches(e,t)?e:H.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(n,a)=>a===void 0?t:a,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},f=X.noConflict(),s=H.noConflict(),U=we,h=new f.Log(be,x.console||nt.console),Ee=be?.script?.name||void 0,st=we.config.Utils.AnyTouch(),at=false;h.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});b.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const i=e.setting.content;return t==="warning"?h.warn(i):t==="error"?h.error(i):h.info(i),false},get position(){return S.getValue(ne.qmsg_config_position.key,ne.qmsg_config_position.defaultValue)},get maxNums(){return S.getValue(ne.qmsg_config_maxnums.key,ne.qmsg_config_maxnums.defaultValue)},get showReverse(){return S.getValue(ne.qmsg_config_showreverse.key,ne.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=X.getMaxZIndex(),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return X.getMaxValue(e,t)+100}});U.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=X.getMaxZIndex(void 0,void 0,i=>{if(i?.classList?.contains("qmsg-shadow-container")||i?.closest("qmsg")&&i.getRootNode()instanceof ShadowRoot)return  false}),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return X.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ot=new f.GM_Menu({GM_getValue:Z,GM_setValue:W,GM_registerMenuCommand:et,GM_unregisterMenuCommand:tt}),B=new f.Httpx({xmlHttpRequest:it,logDetails:at});B.interceptors.request.use(e=>e);B.interceptors.response.use(void 0,e=>(h.error("拦截器-请求错误",e),e.type==="onabort"?b.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?b.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?b.error("请求超时",{consoleLogContent:true}):b.error("其它错误",{consoleLogContent:true}),e));x.Object.defineProperty,x.Object.keys,x.Object.values,x.Function.prototype.apply,x.Function.prototype.call,x.Element.prototype.appendChild,x.setTimeout.bind(x),x.clearTimeout.bind(x),x.setInterval.bind(x),x.clearInterval.bind(x);const K=s.addStyle.bind(s),C=H.selector.bind(H),F=H.selectorAll.bind(H);new f.GM_Cookie;const ke="GM_Panel",Re="data-init",te="data-key",ie="data-default-value",lt="data-init-more-value",He="data-plugin-search-config",V="data-storage-api",re={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},ce={setting:{get width(){return re.width<550?"88vw":re.width<700?"550px":"700px"},get height(){return re.height<450?"70vh":re.height<550?"450px":"550px"}},settingMiddle:{get width(){return re.width<350?"88vw":"350px"}},info:{get width(){return re.width<350?"88vw":"350px"},get height(){return re.height<250?"88vh":"250px"}}},ye={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new f.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const i=(o,l)=>{typeof l!="string"&&(l=pe.toStr(l));const r=new Blob([l]),c=globalThis.URL.createObjectURL(r);s.createElement("a",{href:c,download:o}).click(),f.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(c);},500);},n=()=>{const o=u=>{const p=U.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),g=p.$shadowRoot.querySelector(".btn-control[data-mode='local']"),y=p.$shadowRoot.querySelector(".btn-control[data-mode='network']"),q=p.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),$=async T=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof ve=="function"?typeof ae=="function"?(ve().forEach(R=>{ae(R);}),b.success("已清空脚本存储的配置")):b.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):b.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Ve=="function"?Ve(T):Object.keys(T).forEach(R=>{const M=T[R];W(R,M);}),b.success("配置导入完毕");},k=T=>new Promise(async L=>{const I=f.toJSON(T);Object.keys(I).length===0?b.warning("解析为空配置，不导入"):await $(I),L(true);});s.on(g,"click",T=>{s.preventEvent(T),p.close();const L=s.createElement("input",{type:"file",accept:".json"});s.on(L,["propertychange","input"],I=>{if(!L.files?.length)return;const R=L.files[0],M=new FileReader;M.onload=()=>{k(M.result);},M.readAsText(R,"UTF-8");}),L.click();}),s.on(y,"click",T=>{s.preventEvent(T),p.close();const L=U.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(M,N){M.close();}},ok:{text:"导入",callback:async(M,N)=>{const z=M.text;if(f.isNull(z)){b.error("请填入完整的url");return}const w=b.loading("正在获取配置..."),_=await B.get(z,{allowInterceptConfig:false});if(w.close(),!_.status){h.error(_),b.error("获取配置失败",{consoleLogContent:true});return}await k(_.data.responseText)&&M.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:ce.info.width,height:"auto"}),I=L.$shadowRoot.querySelector("input"),R=L.$shadowRoot.querySelector(".pops-prompt-btn-ok");s.on(I,["input","propertychange"],M=>{s.val(I)===""?s.attr(R,"disabled","true"):s.removeAttr(R,"disabled");}),s.onKeyboard(I,"keydown",(M,N,z)=>{M==="Enter"&&z.length===0&&s.val(I)!==""&&s.emit(R,"click");}),s.emit(I,"input");}),s.on(q,"click",async T=>{s.preventEvent(T),p.close();let L=await pe.getClipboardText();if(L.trim()===""){b.warning("获取到的剪贴板内容为空");return}await k(L);});},l=(u=`${Ee}_panel-setting-${f.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,p)=>{const g=U.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),y=g.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),q=g.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");s.on(y,"click",$=>{s.preventEvent($);try{i(u,p),g.close();}catch(k){b.error(k.toString(),{consoleLogContent:true});}}),s.on(q,"click",async $=>{await f.copy(p)?(b.success("复制成功"),g.close()):b.error("复制失败");});},c=U.confirm({title:{text:"配置",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),m={};if(typeof ve=="function")ve().forEach(p=>{const g=Z(p);Reflect.set(m,p,g);});else {b.warning("不支持函数GM_listValues，仅导出菜单配置");const u=Z(ke);Reflect.set(m,ke,u);}const d=pe.toStr(m);c.value=d;},a=()=>{let o=be?.script?.supportURL||be?.script?.namespace;typeof o=="string"&&f.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${be?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(o){new st(o.$asideLiElement).on("tap",function(r){clearTimeout(t),t=void 0,e?(e=false,n()):(t=setTimeout(()=>{e=false,a();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},rt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{S.showPanel(ye.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){S.isTopWindow()&&ot.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let i=this.$data.menuOption.findIndex(n=>n.key===t.key);i!==-1&&(this.$data.menuOption[i]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}};class ct{storageKey;listenerData;constructor(t){if(typeof t=="string"){const i=t.trim();if(i=="")throw new Error("key参数不能为空字符串");this.storageKey=i;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new X.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let t=Z(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){W(this.storageKey,t);}set(t,i){const n=this.get(t),a=this.getLocalValue();Reflect.set(a,t,i),this.setLocalValue(a),this.emitValueChangeListener(t,i,n);}get(t,i){const n=this.getLocalValue();return Reflect.get(n,t)??i}getAll(){return this.getLocalValue()}delete(t){const i=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.emitValueChangeListener(t,void 0,i);}has(t){const i=this.getLocalValue();return Reflect.has(i,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(i=>Reflect.get(t,i))}clear(){ae(this.storageKey);}addValueChangeListener(t,i){const n=Math.random(),a=this.listenerData.get(t)||[];return a.push({id:n,key:t,callback:i}),this.listenerData.set(t,a),n}removeValueChangeListener(t){let i=false;for(const[n,a]of this.listenerData.entries()){for(let o=0;o<a.length;o++){const l=a[o];(typeof t=="string"&&l.key===t||typeof t=="number"&&l.id===t)&&(a.splice(o,1),o--,i=true);}this.listenerData.set(n,a);}return i}async emitValueChangeListener(...t){const[i,n,a]=t;if(!this.listenerData.has(i))return;const o=this.listenerData.get(i);for(let l=0;l<o.length;l++){const r=o[l];if(typeof r.callback=="function"){let c,m;t.length===1||(t.length===2?c=n:t.length===3&&(c=n,m=a)),await r.callback(i,c,m);}}}}const le=new ct(ke),S={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new f.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new f.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new f.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new f.Dictionary),this.__onceExecData},get scriptName(){return Ee},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ke,attributeKeyName:te,attributeDefaultValueName:ie},init(){this.initContentDefaultValue(),rt.init();},isTopWindow(){return x.top===x.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="container"||n.type==="deepMenu")return;const a=n.attributes;let o=a[Re];if(typeof o=="function"){let m=o();if(typeof m=="boolean"&&!m)return}let l=new Map,r=a[te];if(r!=null){const m=a[ie];l.set(r,m);}let c=a[lt];if(typeof c=="object"&&c&&Object.keys(c).forEach(m=>{const d=c[m];l.set(m,d);}),!l.size){h.warn("请先配置键",n);return}if(n.type==="switch"){let m=typeof n.disabled=="function"?n.disabled():n.disabled;typeof m=="boolean"&&m&&this.$data.contentConfigInitDisabledKeys.push(...l.keys());}for(const[m,d]of l.entries())this.setDefaultValue(m,d);},t=n=>{for(let a=0;a<n.length;a++){let o=n[a];e(o);let l=o.views;l&&Array.isArray(l)&&t(l);}},i=[...ye.getAllContentConfig()];for(let n=0;n<i.length;n++){let a=i[n];if(!a.views)continue;const o=a.views;o&&Array.isArray(o)&&t(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&h.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){le.set(e,t);},getValue(e,t){const i=le.get(e);return i??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){le.delete(e);},hasKey(e){return le.has(e)},addValueChangeListener(e,t,i){const n=le.addValueChangeListener(e,t);if(i?.immediate||i?.immediateAll){const a=this.getValue(e);i?.immediate?t(e,a,a):i?.immediateAll&&S.emitMenuValueChange(e,a,a);}return n},removeValueChangeListener(e){le.removeValueChangeListener(e);},emitMenuValueChange(e,t,i){le.emitValueChangeListener(e,t,i);},async exec(e,t,i,n=true){const a=this;let o;typeof e=="string"||Array.isArray(e)?o=()=>e:o=e;let l=false;const r=o();let c=[];Array.isArray(r)?(l=true,c=r):c.push(r);const m=c.find(R=>!this.$data.contentConfigInitDefaultValue.has(R));if(m){h.warn(`${m} 键不存在`);return}const d=JSON.stringify(c);if(n&&this.$data.onceExecMenuData.has(d))return this.$data.onceExecMenuData.get(d);let u=[];const p=[];let g=[];const y=(R,M)=>{let N=[],z=[],w=[];if(Array.isArray(M))w=w.concat(M);else {const v=E=>{if(typeof E=="object"&&E!=null)if(E instanceof Element)w.push(E);else {const{$css:D,destory:j}=E;D!=null&&(Array.isArray(D)?w=w.concat(D):w.push(D)),typeof j=="function"&&w.push(j);}else w.push(E);};if(M!=null&&Array.isArray(M))for(const E of M)v(E);else v(M);}const _=v=>{if(v!=null){if(v instanceof Element){N.push(v);return}if(typeof v=="function"){z.push(v);return}}};for(const v of w){const E=_(v);if(typeof E=="boolean"&&!E)break;if(Array.isArray(v))for(const D of v){const j=_(D);if(typeof j=="boolean"&&!j)break}}$(),k(),R&&(u=u.concat(N),g=g.concat(z));},q=R=>!!this.getValue(R),$=()=>{for(let R=0;R<u.length;R++)u[R]?.remove(),u.splice(R,1),R--;},k=()=>{for(let R=0;R<g.length;R++){const M=g[R];M(),g.splice(R,1),R--;}},T=()=>{let R=false;return typeof i=="function"?R=i(c):R=c.every(M=>q(M)),R},L=async R=>{const M=T();let N=[];if(M){const z=c.map(w=>this.getValue(w));N=await t({key:c,value:l?z:z[0],addStoreValue:(...w)=>y(M,w)});}y(M,N);};n&&c.forEach(R=>{const M=this.addValueChangeListener(R,(N,z,w)=>L());p.push(M);}),await L();const I={reload(){this.clearStoreStyleElements(),this.destory(),L();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>$(),destory(){return k()},removeValueChangeListener:()=>{p.forEach(R=>{this.removeValueChangeListener(R);});},clearOnceExecMenuData(){n&&a.$data.onceExecMenuData.delete(d);}};return this.$data.onceExecMenuData.set(d,I),I},async execMenu(e,t,i=false,n=false){return await this.exec(e,async a=>await t(a),a=>a.every(l=>{let r=!!this.getValue(l);return S.$data.contentConfigInitDisabledKeys.includes(l)&&(r=false,h.warn(`.execMenu${n?"Once":""} ${l} 被禁用`)),i&&(r=!r),r}),n)},async execMenuOnce(e,t,i=false,n=false){const a=await this.execMenu(e,t,i,true);if(n&&a){const o=()=>{a.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,o);}return a},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),le.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async emitUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const i of t)await i(e);},showPanel(e,t=`${Ee}-设置`,i=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];const a=e.findIndex(l=>(typeof l.isBottom=="function"?l.isBottom():!!l.isBottom)&&l.id==="script-version")!==-1;!i&&!a&&e.push(...ye.getDefaultBottomContentConfig());const o=U.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(l,r)=>{l.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(l,r)=>{l(),this.$data.$panel=null;}},width:ce.setting.width,height:ce.setting.height,drag:true,only:true,style:`
        ...
        `,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:o,content:e});},registerConfigSearch(e){const{$panel:t,content:i}=e,n=async(p,g)=>{if(p==null)return;const y=await g(p);return y&&typeof y.isFind=="boolean"&&y.isFind?y.data:await n(y.data,g)},a=(p,g)=>{const y=new IntersectionObserver(q=>{q.forEach($=>{$.isIntersecting&&(g?.(),y.disconnect());});},{root:null,threshold:1});y.observe(p),p.scrollIntoView({behavior:"smooth",block:"center"});},o=p=>{const g="pops-flashing";s.onAnimationend(p,()=>{p.classList.remove(g);}),p.classList.add(g);},l=p=>{if(p.type==="dblclick"&&u)return;s.preventEvent(p),c=null;const g=U.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});g.$shadowRoot.querySelector(".search-wrapper");const y=g.$shadowRoot.querySelector(".search-config-text"),q=g.$shadowRoot.querySelector(".search-result-wrapper");y.focus();const $=()=>{s.empty(q);},k=L=>{const I=f.queryProperty(L,N=>N?.next?{isFind:false,data:N.next}:{isFind:true,data:N}),R=s.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),M=U.config.PanelHandlerComponents();return s.on(R,"click",N=>{const w=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[L.index];if(!w){b.error(`左侧项下标${L.index}不存在`);return}w.scrollIntoView({behavior:"smooth",block:"center"}),w.click(),n(L.next,async _=>{if(_?.next){const v=await s.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(E=>{const D=Reflect.get(E,M.$data.nodeStoreConfigKey);return typeof D=="object"&&D!=null&&D.text===_.name}),2500);if(v)v.click();else return b.error("未找到对应的二级菜单"),{isFind:true,data:_};return {isFind:false,data:_.next}}else {const v=await s.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(E=>Reflect.get(E,M.$data.nodeStoreConfigKey)===_.matchedData?.formConfig),2500);if(v){a(v);const E=v.closest(".pops-panel-forms-fold[data-fold-enable]");E&&(E.querySelector(".pops-panel-forms-fold-container").click(),await f.sleep(500)),a(v,()=>{o(v);});}else b.error("未找到对应的菜单项");return {isFind:true,data:_}}});}),R},T=L=>{const I=new RegExp(L,"i"),R=[],M=(z,w)=>{for(let _=0;_<z.length;_++){const v=z[_],E=v.views;if(E&&Array.isArray(E)){const D=f.deepClone(w);if(v.type==="deepMenu"){const j=f.queryProperty(D,J=>J?.next?{isFind:false,data:J.next}:{isFind:true,data:J});j.next={name:v.text};}M(E,D);}else {let D,j;if(v.type==="own"){const Q=Reflect.get(v.attributes||{},He);Q&&(typeof Q.text=="string"&&(D=Q.text),typeof Q.desc=="string"&&(j=Q.desc));}else D=v.text,j=Reflect.get(v,"description");const J=[D,j],ue=J.findIndex(Q=>{if(typeof Q=="string")return Q.match(I)});if(ue!==-1){const Q=f.deepClone(w),Ae=f.queryProperty(Q,oe=>oe?.next?{isFind:false,data:oe.next}:{isFind:true,data:oe});Ae.next={name:D,matchedData:{path:"",formConfig:v,matchedText:J[ue],description:j}};const Me=[];f.queryProperty(Q,oe=>{const Ce=oe?.name;return typeof Ce=="string"&&Ce.trim()!==""&&Me.push(Ce),oe?.next?{isFind:false,data:oe.next}:{isFind:true,data:oe}});const Xe=Me.join(pe.escapeHtml(" - "));Ae.next.matchedData.path=Xe,R.push(Q);}}}};for(let z=0;z<i.length;z++){const w=i[z];if(!w.views||w.isBottom&&w.id==="script-version")continue;const _=w.views;if(_&&Array.isArray(_)){let v=w.title;typeof v=="function"&&(v=v()),M(_,{index:z,name:v});}}const N=document.createDocumentFragment();for(const z of R){let w=k(z);N.appendChild(w);}$(),q.append(N);};s.on(y,"input",f.debounce(L=>{s.preventEvent(L);let I=s.val(y).trim();if(I===""){$();return}T(I);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(p=>{s.on(p,"dblclick",l);});let c=null,m=false,d,u=false;s.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(p,g)=>{u=true,clearTimeout(d),d=void 0,m&&c===g?(m=false,c=null,l(p)):(d=setTimeout(()=>{m=false;},200),m=true,c=g);},{capture:true}),t.$shadowRoot.appendChild(s.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
				...
				`}));},transformKey(e){if(Array.isArray(e)){const t=e.sort();return JSON.stringify(t)}else return e},getDynamicValue(e,t){const i=this;let n=false,a=t;const o=this.addValueChangeListener(e,(l,r)=>{a=r;});return {get value(){return n||(n=true,a=i.getValue(e,t)),a},destory(){i.removeValueChangeListener(o);}}}};class mt{$data={get enable(){return S.getValue(ne.httpx_cookie_manager_enable.key,ne.httpx_cookie_manager_enable.defaultValue)},get useDocumentCookie(){return S.getValue(ne.httpx_cookie_manager_use_document_cookie.key,ne.httpx_cookie_manager_use_document_cookie.defaultValue)},cookieRule:[]};constructor(t){Array.isArray(t)&&(this.$data.cookieRule=t);}fixCookieSplit(t){return f.isNotNull(t)&&!t.trim().endsWith(";")&&(t+=";"),t}concatCookie(t,i){return f.isNull(t)?i:(t=t.trim(),i=i.trim(),t=this.fixCookieSplit(t),i.startsWith(";")&&(i=i.substring(1)),t.concat(i))}handle(t){if(t.fetch||!this.$data.enable)return;let i="",n=t.url;n.startsWith("//")&&(n=window.location.protocol+n);let a=new URL(n);this.$data.useDocumentCookie&&a.hostname.endsWith(window.location.hostname.split(".").slice(-2).join("."))&&(i=this.concatCookie(i,document.cookie.trim()));for(let o=0;o<this.$data.cookieRule.length;o++){let l=this.$data.cookieRule[o];if(a.hostname.match(l.hostname)){let r=S.getValue(l.key);if(f.isNull(r))break;i=this.concatCookie(i,r);}}f.isNotNull(i)&&(t.headers&&t.headers.Cookie?t.headers.Cookie=this.concatCookie(t.headers.Cookie,i):t.headers.Cookie=i,h.info("Httpx => 设置cookie:",t)),t.headers&&t.headers.Cookie!=null&&f.isNull(t.headers.Cookie)&&delete t.headers.Cookie;}}pe.setGMResourceCSS(Oe.Viewer);pe.setGMResourceCSS(Oe.Hljs);const dt=new mt([{key:"httpx-cookie-bbs.binmt.cc",hostname:/bbs.binmt.cc/g}]);B.interceptors.request.use(e=>(dt.handle(e),e));U.GlobalConfig.setGlobalConfig({mask:{enable:true},drag:true});b.config({isLimitWidth:true,limitWidthWrap:"wrap"});const G={registerLeftMenu(e){s.waitNode(".comiis_sidenv_box .sidenv_li .comiis_left_Touch",1e4).then(t=>{if(!t){h.error("注册左侧面板菜单失败，原因：该元素不存在");return}let i=s.createElement("li",{className:"comiis_left_Touch",innerHTML:`
...
`,ee={formhash:/formhash=([0-9a-zA-Z]+)/,uid:/uid(=|-)(\d+)/,fontSpecial:/<font.*?>|<\/font>|<strike>|<strong>|<i>|<u>|align=".*?"|<br>[\s]*<br>[\s]*<br>/g,ptid:/&ptid=([\d]+)/i,pid:/&pid=([\d]+)/i,tid:/&tid=([\d]+)/i},O={getAvatar:(e,t="middle")=>`/uc_server/avatar.php?uid=${e}&size=${t}&ts=1`,getCurrentUID(){let e=x.discuz_uid;if(typeof e=="string")return e;let t=document.querySelector('.sidenv_exit a[href*="uid="]');if(t){let i=t.href.match(/uid=([0-9]+)/);if(i)return i[i.length-1]}},async getFormHash(){let e=Array.from((top||globalThis).document.querySelectorAll("input[name=formhash]"));for(let n=0;n<e.length;n++){let o=e[n].value;if(o)return o}let t=Array.from((top||globalThis).document.querySelectorAll('a[href*="formhash="]'));for(let n=0;n<t.length;n++){let o=t[n].href.match(ee.formhash);if(o){let l=o[o.length-1];if(l)return l}}let i=await B.get("/home.php?mod=spacecp",{fetch:true,allowInterceptConfig:false});if(i.status){let n=i.data.responseText,o=s.toElement(n,true,true).querySelector("input[name=formhash]");if(o){let l=o.value;if(f.isNotNull(l))return l}}else h.error("请求个人主页获取formhash失败",i);},envIsMobile(){return (x.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:e=>{let t=e.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(t){let i=t.filter(Boolean);return i[i.length-1]}},getForumId(e){let t=e.match(/&fid=([\d]+)/i);if(t)return t[t.length-1]},getPostId(e){let t=e.match(/&pid=([\d]+)/i);if(t)return t[t.length-1]},getRepquote(e){let t=e.match(/&repquote=([\d]+)/i);if(t)return t[t.length-1]}},ut={$data:{cid:""},init(){this.registerMenu();},registerMenu(){G.registerLeftMenu({name:"小黑屋",iconColor:"#000000",icon:"",callback:()=>{this.showBlackHome();}});},async showBlackHome(){let e=b.loading("正在获取小黑屋名单中..."),t=await this.getBlackListInfo("");if(e.close(),!t)return;if(t.data.length===0){b.error("获取小黑屋名单为空");return}this.$data.cid=t.next_cid;let i=U.confirm({title:{text:"小黑屋名单",position:"center"},content:{text:`
                <div class="blackhome-user-filter">
                    <input placeholder="过滤用户名/操作人员/UID(可正则)">
                </div>
                <div class="blackhome-user-list"></div>
                `,html:true},btn:{ok:{text:"下一页",callback:async()=>{let r=b.loading("正在获取小黑屋名单中...");h.info("下一页的cid: ",this.$data.cid);let c=await this.getBlackListInfo(this.$data.cid);r.close(),c&&(this.$data.cid=c.next_cid,c.data.forEach(m=>{let d=this.createListViewItem(m);n.appendChild(d);}),c.data.length===0?b.error("获取小黑屋名单为空"):b.success(`成功获取 ${c.data.length}条数据`),s.emit(a,"input"));}},cancel:{text:"关闭"}},width:"88vw",height:"82vh",style:pt}),n=i.$shadowRoot.querySelector(".blackhome-user-list"),a=i.$shadowRoot.querySelector(".blackhome-user-filter input");t.data.forEach(r=>{let c=this.createListViewItem(r);n.appendChild(c);}),b.success(`成功获取 ${t.data.length}条数据`);let o=false;s.on(a,["input","propertychange"],f.debounce(()=>{let r=a.value.trim();if(!o){if(o=true,r==""){i.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.removeAttribute("style");}),o=false;return}i.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.getAttribute("data-name").match(new RegExp(r,"ig"))||c.getAttribute("data-uid").trim().match(new RegExp(r,"ig"))||c.getAttribute("data-operator").match(new RegExp(r,"ig"))?c.removeAttribute("style"):c.setAttribute("style","display:none;");}),o=false;}}));let l=await this.getBlackListInfo(this.$data.cid);l&&(this.$data.cid=l.next_cid);},async getBlackListInfo(e=""){let t={mod:"misc",action:"showdarkroom",cid:e,ajaxdata:"json"},i=await B.get(`/forum.php?${f.toSearchParamsStr(t)}`,{headers:{"User-Agent":f.getRandomPCUA()},responseType:"json"});if(!i.status)return;let n=f.toJSON(i.data.responseText),a=n.message.split("|"),o=a[a.length-1],l=f.parseObjectToArray(n.data),r=[],c=[];return l.forEach(m=>{let d=m.dateline.match(/([0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]*[0-9]{1,2}:[0-9]{1,2})/g);if(d==null){let u=parseInt((Date.now()/1e3).toString()),p=0,g=m.dateline.match(/([0-9]+|半)[\s\S]*秒前/),y=m.dateline.match(/([0-9]+|半)[\s\S]*分钟前/),q=m.dateline.match(/([0-9]+|半)[\s\S]*小时前/),$=m.dateline.match(/昨天[\s\S]*(\d{2}):(\d{2})/),k=m.dateline.match(/前天[\s\S]*(\d{2}):(\d{2})/),T=m.dateline.match(/([0-9]+|半)[\s\S]*天前/);if(g)g=g[g.length-1],g=g.replace(/半/g,.5),g=parseFloat(g),p=u-g;else if(y)y=y[y.length-1],y=y.replace(/半/g,.5),y=parseFloat(y),p=u-y*60;else if(q)q=q[q.length-1],q=q.replace(/半/g,.5),q=parseFloat(q),p=u-q*60*60;else if($){let L=$[1],I=$[2];p=u-86400-parseInt(L)*3600-parseInt(I)*60;}else if(k){let L=k[1],I=k[2];p=u-86400*2-parseInt(L)*3600-parseInt(I)*60;}else T&&(T=T[T.length-1],T=T.replace(/半/g,.5),T=parseFloat(T),p=u-T*60*60*24);m.time=parseInt(p.toString())*1e3,r=r.concat(m);return}else d=d[0];m.time=f.formatToTimeStamp(d),r=r.concat(m);}),f.sortListByProperty(r,"time"),f.sortListByProperty(c,"time",false),r=r.concat(c),{next_cid:o,data:r}},createListViewItem(e){let t=s.createElement("div",{className:"blackhome-user-item",innerHTML:`
...
`,gt={$data:{},init(){this.registerMenu();},registerMenu(){G.registerLeftMenu({name:"在线用户",iconColor:"#2d92ff",icon:"",callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let e=b.loading("正在获取在线用户名单中..."),t=await this.getOnlineUserListInfo();if(e.close(),!t)return;let i=U.alert({title:{text:"在线用户",position:"center"},content:{text:`
...
`,Ue=[];class je{option;$data={STORAGE_KEY:"mt-image-bed-upload-history"};constructor(t){this.option=t,Ue.push({id:this.option.id,callback:this.option.delImageEvent.bind(this)}),this.addTab(),s.on(`.comiis_post_imglist[data-chartbed="${this.option.name}"] .up_btn a`,"click",async i=>{await this.option.uploadBtnClickEvent(i)&&C(`.comiis_post_imglist[data-chartbed="${this.option.name}"] input[type="file"]`).click();}),s.on(`.comiis_post_imglist[data-chartbed="${this.option.name}"] input[type="file"]`,"change",async i=>{let n=i.target,a=()=>{n.value="";},o=async l=>{let r=await this.option.fileChangeEvent(i,l);a(),r.success&&r.data.forEach(c=>{this.addImage(c);let m=this.createImageBtnElement("插入",c.url);this.setImageBtnDeleteEvent(m,c),s.append(`.comiis_post_imglist[data-chartbed="${this.option.name}"]`,m);});};if(n.files&&n.files.length){let l=n.files;if(S.getValue("mt-image-bed-watermark-enable")){let r=b.loading("处理水印中..."),c=[],m=[];await Promise.all(Array.from(n.files).map(async(d,u)=>{if(d.type==="image/gif"){let g=await f.parseFileToBase64(d);c.push(g),m.push(d);}else {b.info(`添加水印 ${u+1}/${l.length}`);var p=new window.Watermark;await p.setFile(d),p.addText({text:[S.getValue("mt-image-bed-watermark-text")],color:S.getValue("mt-image-bed-watermark-text-color"),fontSize:S.getValue("mt-image-bed-watermark-font-size"),globalAlpha:S.getValue("mt-image-bed-watermark-font-opacity"),xMoveDistance:S.getValue("mt-image-bed-watermark-left-right-margin"),yMoveDistance:S.getValue("mt-image-bed-watermark-top-bottom-margin"),rotateAngle:S.getValue("mt-image-bed-watermark-rotate")}),c.push(p.render("png")),m.push(f.parseBase64ToFile(p.render("png"),"WaterMark_"+d.name));}})),r.close(),l=m,S.getValue("mt-image-bed-watermark-autoAddWaterMark")?await o(l):U.confirm({title:{text:"水印预览",position:"center"},content:{text:`
...
`)}    
      ...
      `),C("#comiis_foot_menu_beautify .comiis_position_key"),this.$el.$like=C("#comiis_foot_menu_beautify .comiis_recommend_addkey"),C("#comiis_foot_menu_beautify #comiis_favorite_a"),C("#comiis_pictitle_key"),this.$el.$btn_submit=C('#comiis_foot_menu_beautify_big li[data-attr="发表"] input'),this.$el.$input=C("#comiis_foot_menu_beautify_big textarea"),this.$el.$fastpostsubmit=C("#fastpostsubmit"),x.textarea_scrollHeight=()=>{},typeof x.comiis_addsmilies=="function"&&(x.comiis_addsmilies=d=>{x.$("#needmessage").comiis_insert(d),x.$("#needmessage")[0].dispatchEvent(new Event("propertychange"));}),x.$("#imglist .up_btn").append(x.$("#filedata")),x.$(document).on("click","#imglist .up_btn a",function(){x.$(this).next().click();}),x.$(document).on("click","#imglist .p_img a",function(){let d=x.$(this);if(d.attr("onclick")==null){let u=d.find("img").attr("id").replace("aimg_","");x.comiis_addsmilies(`[attachimg]${u}[/attachimg]`);}}),s.hide("#comiis_foot_menu_beautify_big .menu_body",false),this.setInputChangeEvent(),this.setLikeBtnClickEvent(),this.setSubmitBtnClickEvent(),this.setGlobalReplyBtnClickEvent(),this.setGlobalClickCheckEvent(),this.setMenuIconToggleEvent(),this.setMenuImageClickEvent(),this.setMenuImageToggleEvent(),this.setMenuSmileClickEvent(),this.setMenuSmileTabClickEvent(),this.setMenuInsertClickEvent(),this.setMenuQuickUBB(),S.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",async()=>{this.setInputChangeSaveEvent(),await this.initReplyText();}),S.execMenuOnce("mt-image-bed-hello-enable",()=>{Ge.init();}),S.execMenuOnce("mt-image-bed-mt-enable",()=>{We.init();});},handle_error(e){let t=false;const i=s.text(s.toElement(e,false,false).querySelector("#messagetext"));return !i||typeof i=="string"&&i.trim()==""||wt.forEach(n=>{const a=n.match instanceof RegExp?n.match:new RegExp(n.match),o=i.match(a);if(o){if(i.includes("typeof errorhandle_=='function'")){let l=n.msg;o.forEach((r,c)=>{l=l.replace(`{$${c}}`,r);}),b.error(l);}t=true;return}}),t},setInputChangeEvent(){const e=this;s.on(e.$el.$input,["input","propertychange"],function(t){e.$el.$input.value===""?(e.$el.$btn_submit.setAttribute("data-text","false"),C("#comiis_foot_menu_beautify li[data-attr='回帖'] input")?.setAttribute("placeholder","发帖千百度，文明第一步")):(e.$el.$btn_submit.setAttribute("data-text","true"),C("#comiis_foot_menu_beautify li[data-attr='回帖'] input")?.setAttribute("placeholder","[草稿待发送]")),s.css(e.$el.$input,"height","70px"),s.css(e.$el.$input,"height",e.$el.$input.scrollHeight-20+"px");});},setInputChangeSaveEvent(){const e=this;s.on(this.$el.$input,["input","propertychange"],async t=>{const i=e.$el.$input.value,a=e.$el.$input.closest(".reply_area").querySelector(".reply_user_content").getAttribute("data-reply-url"),o={url:window.location.href,text:i,repquote:a?O.getRepquote(a):void 0,forumId:e.$data.tid},l=await e.$data.db.get("data");if(!l.success||l.code===201){console.warn(l);return}let r=l.data.findIndex(c=>c.forumId===o.forumId&&c.repquote===o.repquote);r!==-1?i==null||i===""?l.data.splice(r,1):l.data[r]=f.assign(l.data[r],{text:o.text}):l.data.push(o),await e.$data.db.save("data",l.data);});},async initReplyText(e=false,t=void 0){const i=this;(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let a=await this.$data.db.get("data");if(!a.success||a.code===201){console.warn(a);return}let o;t&&(o=O.getRepquote(t));let l=a.data.find(r=>e?r.forumId===i.$data.tid&&r.repquote==o:r.forumId===i.$data.tid&&r.repquote==null);l&&(s.val(this.$el.$input,l.text),s.emit(this.$el.$input,"input"));},setLikeBtnClickEvent(){s.on(this.$el.$like,"click",async e=>{if(s.preventEvent(e),x.comiis_recommend_key==0){x.comiis_recommend_key=1;let o=await B.get(this.$el.$like.href+"&inajax=1",{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false});if(!o.status){window.location.href=this.$el.$like.href,setTimeout(function(){x.comiis_recommend_key=0;},500);return}let r=f.parseFromString(o.data.responseText,"text/xml").lastChild?.firstChild?.nodeValue;if(r.includes("您已评价过本主题")){let c=this.$el.$like.href.match(ee.tid)[1];if(!(await B.get(`plugin.php?id=comiis_app&comiis=re_recommend&tid=${c}&inajax=1`,{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false})).status){b.error("取消点赞失败，网络异常");return}var t=Number(s.text("#comiis_recommend_num"));document.querySelectorAll(".comiis_recommend_list_a").length>0&&s.remove("#comiis_recommend_list_a"+x.uid),document.querySelectorAll(".comiis_recommend_list_s").length>0&&s.remove("#comiis_recommend_list_s"+x.uid),document.querySelectorAll(".comiis_recommend_list_t").length>0&&s.remove("#comiis_recommend_list_t"+x.uid),t>1?(s.text(".comiis_recommend_num",t-Number(x.allowrecommend)),s.text(".comiis_recommend_nums","+"+(t-Number(x.allowrecommend)))):(s.remove("#comiis_recommend_num"),s.text(".comiis_recommend_nums",""),document.querySelectorAll(".comiis_recommend_list_a").length>0&&(s.empty(".comiis_recommend_list_a"),s.removeClass(".comiis_recommend_list_a","comiis_recommend_list_on")),document.querySelectorAll(".comiis_recommend_list_t").length>0&&s.removeClass(".comiis_recommend_list_t","comiis_recommend_list_on")),s.html(".comiis_recommend_addkey i","&#xe63b;"),s.removeClass(".comiis_recommend_color","f_a"),s.addClass(".comiis_recommend_color","f_b"),document.querySelectorAll(".comiis_recommend_list_s").length>0&&(document.querySelectorAll(".comiis_recommend_list_s li").length<7?s.hide(".txshow_more",false):s.show(".txshow_more",false)),b.success("已取消点赞");}else if(r.includes("您不能评价自己的帖子"))b.error("不能点赞自己的帖子");else if(r.includes("今日评价机会已用完"))b.warning("您今日的点赞机会已用完");else if(r.includes("'recommendv':'+"+x.allowrecommend+"'")){var i={recommendc:0,daycount:0},n;n=r.match(/\'recommendc\':\'(.*?)\'/),n!=null?i.recommendc=parseInt(n[1]):i.recommendc=0,n=r.match(/\'daycount\':\'(.*?)\'/),n!=null?i.daycount=parseInt(n[1]):i.daycount=0,document.querySelectorAll(".comiis_recommend_new span").length<1&&s.append(".comiis_recommend_new",'<span class="bg_del f_f comiis_kmvnum comiis_recommend_num" id="comiis_recommend_num">0</span>');var a=Number(s.text("#comiis_recommend_num"));if(F(".comiis_recommend_list_a").length>0){let c=F(".comiis_recommend_list_a");s.removeClass(c,"comiis_recommend_list_on"),s.addClass(c,"comiis_recommend_list_on"),s.prepend(c,(F(".comiis_recommend_list_a li").length>0?"":'<li style="float:right;margin-right:0;"><a href="misc.php?op=recommend&tid= '+x.tid+'&mod=faq&mobile=2"><span class="bg_b f_c"><em class="comiis_recommend_num">'+a+"</em>赞</span></a></li>")+'<li id="comiis_recommend_list_a'+x.uid+'"><a href="home.php?mod=space&uid='+x.uid+'"><img src="'+O.getAvatar(x.uid,"small")+'"></a></li>');}if(F(".comiis_recommend_list_t").length>0){let c=F(".comiis_recommend_list_t");s.removeClass(c,"comiis_recommend_list_on"),s.addClass(c,"comiis_recommend_list_on"),s.prepend(c,`<span id="comiis_recommend_list_t${x.uid}">
		...
		<div class="comiis_multi_box bg_f b_t">
			...
			`),s.on(document,"click",".reader-copy-button",async function(i){s.preventEvent(i);let n=i.target,a=C(n.getAttribute("data-code-selector"));return await f.copy(a.outerText||a.innerText),b.success("已复制到剪贴板"),false})),F(".comiis_blockcode.comiis_bodybg").forEach(i=>{if(i.getAttribute("data-copy"))return;i.setAttribute("data-copy","true");let n=s.createElement("div",{innerHTML:`
        ...
        `),H.onReady(()=>{S.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),S.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),S.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){h.info("显示搜索历史");let e=Z("search_history",[]),t=C("#scform_srchtxt"),i=C("#searchform");const n=e.map(r=>({value:r,enableDeleteButton:true,deleteButtonClickCallback(c,m,d,u){let p=e.findIndex(g=>g===d.value);p!==-1&&(e.splice(p,1),W("search_history",e)),m.remove();},itemView(c,m,d){return c.value},clickCallback(c,m,d,u){t.value=d.value,i.submit();}}));let a=U.searchSuggestion({$target:t,$inputTarget:t,data:n,inputTargetChangeRefreshShowDataCallback(r,c,m){return n.filter(d=>d.value.includes(r))}});a.init(),a.setAllEvent();function o(){let r=document.querySelector("#scform_submit");H.on(r,"click",function(){let c=t.value;if(c!=""){let m=Z("search_history",[]);m.includes(c)?h.info("已有该搜索历史记录"):(h.info("无该记录，追加"),m.push(c)),W("search_history",m);}});}function l(){let c='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+Z("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    border: none;
                    float: right;
                    background: red;
                    color: #fff;
					...
					<div class="k_misign_wp">
						<div class="k_misign_list bg_f">
							...
							<li class="flex">
								...
								`)),o(c,l);});};}},qt={init(){S.execMenuOnce("mt-space-repairEnterSpace",()=>{this.repairEnterSpace();}),s.onReady(()=>{S.execMenuOnce("mt-space-showCommentContent",()=>{this.showCommentContent();});});},repairEnterSpace(){if(h.info("修复无法进入空间"),A.isSpace()){let e=window.location.href.match(/home.php\?(.+)/gi),t=e[e.length-1];t.split("&").length==2&&t.indexOf("uid=")!=-1&&t.indexOf("mod=space")!=-1&&(window.location.href=window.location.href+"&do=profile");}else if(A.isSpaceWithAt()){let e=window.location.href.match(/space-uid-(.+).html/i),t=e[e.length-1];window.location.href=`${window.location.origin}/home.php?mod=space&uid=${t}&do=profile`;}},async showCommentContent(){h.info("显示帖子回复内容"),K(`
		div.contrete-reply{padding:5px 10px;border-top:1px solid #f3f3f3}
		div.contrete-reply a{margin:0 10px}
		`);async function e(){let l=await B.get(window.location.href,{headers:{"User-Agent":f.getRandomPCUA()}});if(!l.status)return;let r=s.toElement(l.data.responseText,true,true),c=[];return r.querySelectorAll("#delform tr.bw0_all+tr").forEach(m=>{let d=[],u=m.querySelector("td"),p=s.html(u).replace(/^&nbsp;/,"");d.push(p);let g=s.next(m),y=r.querySelectorAll("#delform tr");for(let q=0;q<y.length&&!(!g||s.attr(g,"class")==="bw0_all");q++){let $=g.querySelector("td"),k=s.html($).replace(/^&nbsp;/,"");d=d.concat(k),g=s.next(g);}c.push(...d);}),c}function t(){return f.getNodeListValue(G.comiisForumList(),G.comiisPostli(),G.comiisMmlist())}function i(l){let r={};return l.forEach(c=>{let d=s.createElement("div",{innerHTML:c}).querySelector("a")?.getAttribute("href"),u=d.match(ee.ptid),p=d.match(ee.pid);if(!u){b.error("获取ptid失败");return}if(!p){b.error("获取pid失败");return}let g=u[u.length-1],y=p[p.length-1];r[g]?r[g].data.push(c):r[g]={ptid:g,pid:y,data:[c]};}),r}var n=await e();if(n==null)return;var a=i(n);t().forEach((l,r)=>{let m=l.querySelector(".comiis_xznalist_bottom a").getAttribute("tid");if(!m){b.error("获取帖子tid失败"),h.error(l);return}a[m]&&a[m].data.forEach(d=>{s.append(l,`<div class="contrete-reply">${d}</div>`);});});}},ge={$key:{tipData:"tipToFreeSubjectForumPost"},init(){this.registerMenu();let e=this.getTipData();if(A.isPost()&&document.querySelector("span.kmren")){h.info("当前帖子存在需要购买主题");let o=false,l;e.forEach((c,m)=>{if(window.location.href.match(c.url)){o=true;return}}),o?(h.warn("已设置提醒"),l=s.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                ...
                <span class="sidenv_num bg_del f_f" style="
                    ...
                    display: inline-flex;
                    bottom: 8px;
                "></span>`);},registerMenu(){G.registerLeftMenu({name:"付费主题白嫖提醒",icon:"",iconColor:"#ec0000",callback:()=>{this.showView();}});},showView(){h.info("显示白嫖列表");let e=ge.getTipData();U.alert({title:{text:"付费主题白嫖列表",position:"center"},content:{text:"",html:true},btn:{ok:{text:"关闭",type:"default"}},width:"88vw",height:"88vh"});let t="",i=0,n="",a="",o=[],l=[],r=[];e.forEach((g,y)=>{let q="#f91212",$="";new Date().getTime()>g.expirationTimeStamp&&(q="#1e90ff",g.isVisited||($=`
                ...
                </tbody>`,timestamp:g.expirationTimeStamp};new Date().getTime()>g.expirationTimeStamp?$!=""?o.push(k):l.push(k):r.push(k);}),h.info("可白嫖但未访问：",o),h.info("可白嫖：",l),h.info("未到白嫖时间：",r),f.sortListByProperty(o,"expirationTimeStamp",false),f.sortListByProperty(l,"timestamp",false),f.sortListByProperty(r,"timestamp",false),h.info("排序后——可白嫖但未访问：",o),h.info("排序后——可白嫖：",l),h.info("排序后——未到白嫖时间：",r),n=f.mergeArrayToString(o,"content")+f.mergeArrayToString(l,"content"),a=f.mergeArrayToString(r,"content"),i>0&&(t=`
...
`;class kt{isBacking=false;config;constructor(t){this.config=t,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(t){s.preventEvent(t),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){h.success("进入手势模式");let t=this.config.hash;t.startsWith("#")||(t.startsWith("/")||(t="/"+t),t="#"+t),this.config.useUrl&&(t=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+t),this.config.win.history.pushState({},"",t),h.success("监听popstate事件"),s.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(t=false){this.isBacking=true,h.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(t);let i=Date.now()+1e3*5;for(;;){if(Date.now()>i){h.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))h.info("history.back()"),this.config.win.history.back(),await X.sleep(this.config.backDelayTime||150);else break}h.success("移除popstate事件"),s.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(t);}}const he={https:`
        ...
        <div class="small-window-title-container">
            ...
            `);var i="";f.sortListByProperty(t,a=>{var o=a.href.match(/thread-(.+?)-/i);return parseInt(o[o.length-1])},true),h.info("导读内容",t),t.forEach(a=>{i+=`
                ...
                </li>`;});let n=document.querySelector(".comiis_forumlist.comiis_xznlist");H.before(n,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}},Se=function(e,t,i,n,a,o,l,r,c,m){const d={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:a,buttonIconIsLoading:o,buttonType:l,buttonText:i,callback(u){typeof r=="function"&&r(u);},afterAddToUListCallBack:c};return Reflect.set(d.attributes,Re,()=>{d.disable=false;}),d},me=function(e,t,i,n,a,o="",l,r){const c={text:e,type:"input",inputType:"number",attributes:{},props:{},description:n,placeholder:o,afterAddToUListCallBack:l,getValue(){return this.props[V].get(t,i)},callback(m,d,u){this.props[V].set(t,d);}};return Reflect.set(c.attributes,te,t),Reflect.set(c.attributes,ie,i),fe.initComponentsStorageApi("input",c,{get(m,d){return S.getValue(m,d)},set(m,d){S.setValue(m,d);}}),c},ze=function(e,t,i,n,a,o="",l,r){const c={text:e,type:"input",inputType:"password",attributes:{},props:{},description:n,placeholder:o,afterAddToUListCallBack:l,getValue(){return this.props[V].get(t,i)},callback(m,d){this.props[V].set(t,d);}};return Reflect.set(c.attributes,te,t),Reflect.set(c.attributes,ie,i),fe.initComponentsStorageApi("input",c,{get(m,d){return S.getValue(m,d)},set(m,d){S.setValue(m,d);}}),c},Ne=function(e,t,i,n,a,o){const l={type:"own",attributes:{},props:{},createLIElement:e,afterAddToUListCallBack:o};return Reflect.set(l.attributes,Re,()=>false),typeof i=="object"&&i!==null&&Reflect.set(l.attributes,He,i),l},Be=function(e,t,i,n,a,o,l){const r={text:e,type:"select",description:o,attributes:{},props:{},getValue(){return this.props[V].get(t,i)},callback(c){if(c==null)return;const m=c.value;if(h.info(`选择：${c.text}`),typeof a=="function"&&a(c))return;this.props[V].set(t,m);},data:n};return Reflect.set(r.attributes,te,t),Reflect.set(r.attributes,ie,i),fe.initComponentsStorageApi("select",r,{get(c,m){return S.getValue(c,m)},set(c,m){S.setValue(c,m);}}),r},P=function(e,t,i,n,a,o,l,r,c){const m={text:e,type:"switch",description:a,disabled:l,attributes:{},props:{},getValue(){return this.props[V].get(t,i)},callback(d,u){const p=!!u;h.success(`${p?"开启":"关闭"} ${e}`),this.props[V].set(t,p);},afterAddToUListCallBack:(...d)=>{}};return Reflect.set(m.attributes,te,t),Reflect.set(m.attributes,ie,i),fe.initComponentsStorageApi("switch",m,{get(d,u){return S.getValue(d,u)},set(d,u){S.setValue(d,u);}}),m},_e=function(e,t,i,n,a,o="",l,r){const c={text:e,type:"textarea",attributes:{},props:{},description:n,placeholder:o,disabled:l,getValue(){const d=this.props[V].get(t,i);return Array.isArray(d)?d.join(`
...
`,Lt=()=>({"[呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq001.gif","[撇嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq002.gif","[色]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq003.gif","[发呆]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq004.gif","[得意]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq005.gif","[流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq006.gif","[害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq007.gif","[闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq008.gif","[睡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq009.gif","[大哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq010.gif","[尴尬]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq011.gif","[发怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq012.gif","[调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq013.gif","[呲牙]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq014.gif","[惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq015.gif","[难过]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq016.gif","[酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq017.gif","[冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq018.gif","[抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq019.gif","[吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq020.gif","[偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq021.gif","[可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq022.gif","[白眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq023.gif","[傲慢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq024.gif","[饥饿]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq025.gif","[困]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq026.gif","[惊恐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq027.gif","[流汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq028.gif","[憨笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq029.gif","[装逼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq030.gif","[奋斗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq031.gif","[咒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq032.gif","[疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq033.gif","[嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq034.gif","[晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq035.gif","[折磨]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq036.gif","[衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq037.gif","[骷髅]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq038.gif","[敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq039.gif","[再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq040.gif","[擦汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq041.gif","[抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq042.gif","[鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq043.gif","[糗大了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq044.gif","[坏笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq045.gif","[左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq046.gif","[右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq047.gif","[哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq048.gif","[鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq049.gif","[委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq050.gif","[快哭了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq051.gif","[阴脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq052.gif","[亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq053.gif","[吓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq054.gif","[可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq055.gif","[眨眼睛]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq056.gif","[笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq057.gif","[dogeQQ]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq058.gif","[泪奔]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq059.gif","[无奈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq060.gif","[托腮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq061.gif","[卖萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq062.png","[斜眼笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq063.gif","[喷血]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq064.gif","[惊喜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq065.gif","[骚扰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq066.gif","[小纠结]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq067.gif","[我最美]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq068.gif","[菜刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq069.gif","[西瓜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq070.gif","[啤酒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq071.gif","[篮球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq072.gif","[乒乓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq073.gif","[咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq074.gif","[饭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq075.gif","[猪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq076.gif","[玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq077.gif","[凋谢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq078.gif","[示爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq079.gif","[爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq080.gif","[心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq081.gif","[蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq082.gif","[闪电]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq083.gif","[炸弹]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq084.gif","[刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq085.gif","[足球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq086.gif","[瓢虫]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq087.gif","[便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq088.gif","[月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq089.gif","[太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq090.gif","[礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq091.gif","[抱抱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq092.gif","[喝彩]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq93.gif","[祈祷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq94.gif","[棒棒糖]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq95.gif","[药]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq96.gif","[赞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq097.gif","[差劲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq098.gif","[握手]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq099.gif","[胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq100.gif","[抱拳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq101.gif","[勾引]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq102.gif","[拳头]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq103.gif","[爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq105.gif","[NO]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq106.gif","[OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq107.gif","[#呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_1.png","[#滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_10.png","[#吐舌]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_3.png","[#哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_2.png","[#啊]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_23.png","[#酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_22.png","[#怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_13.png","[#开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_39.png","[#汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_14.png","[#泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_16.png","[#黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_15.png","[#鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_21.png","[#不高兴]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_12.png","[#真棒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_17.png","[#钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_40.png","[#疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_26.png","[#阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_20.png","[#吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_34.png","[#咦]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_41.png","[#委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_29.png","[#花心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_6.png","[#呼～]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_42.png","[#激动]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_5.png","[#冷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_43.png","[#可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_4.png","[#What？]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_25.png","[#勉强]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_38.png","[#狂汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_24.png","[#酸爽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_27.png","[#乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_8.png","[#雅美蝶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_28.png","[#睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_31.png","[#惊哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_19.png","[#哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_44.png","[#笑尿]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_32.png","[#惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_30.png","[#小乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_7.png","[#喷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_18.png","[#抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_33.png","[#捂嘴笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_9.png","[#你懂的]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_11.png","[#犀利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_35.png","[#小红脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_36.png","[#懒得理]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_37.png","[#爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_45.png","[#心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_46.png","[#玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_47.png","[#礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_48.png","[#彩虹]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_49.png","[#太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_50.png","[#月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_51.png","[#钱币]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_52.png","[#咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_53.png","[#蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_54.png","[#大拇指]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_55.png","[#胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_56.png","[#爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_57.png","[#OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_58.png","[#弱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_59.png","[#沙发]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_60.png","[#纸巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_61.png","[#香蕉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_62.png","[#便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_63.png","[#药丸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_64.png","[#红领巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_65.png","[#蜡烛]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_66.png","[#三道杠]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_67.png","[#音乐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_68.png","[#灯泡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_69.png","[doge]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/1.png","[doge思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/2.png","[doge再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/3.png","[doge生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/4.png","[doge气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/5.png","[doge笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/7.png","[doge调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/6.png","[doge啊哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/8.png","[doge原谅TA]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/9.png","[miao]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/10.png","[miao思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/11.png","[miao拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/12.png","[miao生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/13.png","[miao气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/14.png","[二哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/15.png","[摊手]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/19.png","[w并不简单]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/20.png","[w滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/21.png","[w色]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/22.png","[w爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/23.png","[w拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/24.png","[w悲伤]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/25.png","[w鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/26.png","[w馋嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/27.png","[w冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/28.png","[w打哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/29.png","[w打脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/30.png","[w敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/31.png","[w生病]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/32.png","[w闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/33.png","[w鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/34.png","[w哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/35.png","[w害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/36.png","[w呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/37.png","[w黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/38.png","[w哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/39.png","[w调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/40.png","[w可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/41.png","[w可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/42.png","[w酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/43.png","[w困]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/44.png","[w懒得理你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/45.png","[w流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/46.png","[w怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/47.png","[w怒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/48.png","[w钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/49.png","[w亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/50.png","[w傻眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/51.png","[w便秘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/52.png","[w失望]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/53.png","[w衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/54.png","[w睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/55.png","[w思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/56.png","[w开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/57.png","[w色舔]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/58.png","[w偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/59.png","[w吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/60.png","[w抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/61.png","[w委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/62.png","[w笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/63.png","[w嘻嘻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/64.png","[w嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/65.png","[w阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/66.png","[w疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/67.png","[w抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/70.png","[w晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/69.png","[w右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/68.png","[w左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/71.png","[w肥皂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/77.png","[w奥特曼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/78.png","[w草泥马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/79.png","[w兔子]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/80.png","[w熊猫]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/81.png","[w猪头]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/82.png","[w→_→]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/83.png","[w给力]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/84.png","[w囧]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/85.png","[w萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/86.png","[w神马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/87.png","[w威武]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/88.png"}),Ie={parseText(e){const t=Lt();let i=e.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/g);i&&i.forEach(w=>{let _=w.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/),v=_?_[_.length-1]:"",E=s.attr(`#aimg_${v}`,"title"),D=s.attr(`#aimg_${v}`,"src");D||(E="该图片不存在"),e=e.replace(w,`<span class="comiis_postimg vm"><img loading="lazy" id="aimg_${v}" src="${D}" alt="${E}" title="${E}"></span>`);});let n=e.match(/\[code\]([\s\S]*?)\[\/code\]/g);n&&n.forEach(w=>{let _=w.match(/\[code\]([\s\S]*?)\[\/code\]/),v=_?_[_.length-1]:"",E="",D=v.split(`
`);D.length==1?E=`<li>${v}</li>`:Array.from(D).forEach((j,J)=>{J==D.length-1?E=`${E}<li>${j}</li>`:E=`${E}<li>${j}<br></li>`;}),e=e.replace(w,`
                <div class="comiis_blockcode comiis_bodybg b_ok f_b"><div class="bg_f b_l"><ol>${E}</ol></div></div>`);});let a=e.match(/\[url\=[\s\S]*?\]([\s\S]*?)\[\/url\]/g);a&&a.forEach(w=>{let _=w.match(/\[url=([\s\S]*?)\][\s\S]*\[\/url\]/),v=w.match(/\[url=[\s\S]*?\]([\s\S]*?)\[\/url\]/),E=_?_[_.length-1]:"",D=v?v[v.length-1]:"";e=e.replace(w,`<a href="${E}" target="_blank">${D}</a>`);});let o=e.match(/\[color\=[\s\S]*?\]([\s\S]*?)\[\/color\]/g);o&&o.forEach(w=>{let _=w.match(/\[color=([\s\S]*?)\][\s\S]*\[\/color\]/),v=w.match(/\[color=[\s\S]*?\]([\s\S]*?)\[\/color\]/),E=_?_[_.length-1]:"",D=v?v[v.length-1]:"";e=e.replace(w,`<font color="${E}">${D}</font>`);});let l=e.match(/\[size\=[\s\S]*?\]([\s\S]*?)\[\/size\]/g);l&&l.forEach(w=>{let _=w.match(/\[size=([\s\S]*?)\][\s\S]*\[\/size\]/),v=w.match(/\[size=[\s\S]*?\]([\s\S]*?)\[\/size\]/),E=_?_[_.length-1]:"",D=v?v[v.length-1]:"";e=e.replace(w,`<font size="${E}">${D}</font>`);});let r=e.match(/\[img(|\=[\s\S]+?)\]([\s\S]*?)\[\/img\]/g);r&&r.forEach(w=>{let _=null,v=null,E=w.match(/\[img\=([\s\S]+?)\][\s\S]*?\[\/img\]/);E&&(E=E[E.length-1].split(","),_=E[0],v=E[1]),_=_||"",v=v||"";let D=w.match(/\[img\]([\s\S]*?)\[\/img\]|\[img=[\s\S]*?\]([\s\S]*?)\[\/img\]/),j="";D&&(D[D.length-1]==null?j=D[D.length-2]:j=D[D.length-1]),e=e.replace(w,`<img loading="lazy" src="${j}" border="0" alt="" width="${_}" height="${v}" crossoriginNew="anonymous">`);});let c=e.match(/\[hide\]([\s\S]*?)\[\/hide\]/g);c&&c.forEach(w=>{let _=w.match(/\[hide\]([\s\S]*?)\[\/hide\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c"><h2 class="f_a">本帖隐藏的内容: </h2>${v}</div>`);});let m=e.match(/\[hide=[\s\S]*?\]([\s\S]*?)\[\/hide\]/g);m&&m.forEach(w=>{let _=w.match(/\[hide=([\s\S]*?)\]([\s\S]*?)\[\/hide\]/),v=_?_[_.length-2]:"";v=v.split(",");let E=v.length==2?v[1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c">以下内容需要积分高于 ${E} 才可浏览</div>`);});let d=e.match(/\[quote\]([\s\S]*?)\[\/quote\]/g);d&&d.forEach(w=>{let _=w.match(/\[quote\]([\s\S]*?)\[\/quote\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h b_dashed f_c"><blockquote><font>回复</font> ${v}</blockquote></div>`);});let u=e.match(/\[free\]([\s\S]*?)\[\/free\]/g);u&&u.forEach(w=>{let _=w.match(/\[free\]([\s\S]*?)\[\/free\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c"><blockquote>${v}</blockquote></div>`);});let p=e.match(/\[b\]([\s\S]*?)\[\/b\]/g);p&&p.forEach(w=>{let _=w.match(/\[b\]([\s\S]*?)\[\/b\]/i),v=_?_[_.length-1]:"";e=e.replace(w,`<strong>${v}</strong>`);});let g=e.match(/\[u\]([\s\S]*?)\[\/u\]/g);g&&g.forEach(w=>{let _=w.match(/\[u\]([\s\S]*?)\[\/u\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<u>${v}</u>`);});let y=e.match(/\[i\]([\s\S]*?)\[\/i\]/g);y&&y.forEach(w=>{let _=w.match(/\[i\]([\s\S]*?)\[\/i\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<i>${v}</i>`);});let q=e.match(/\[s\]([\s\S]*?)\[\/s\]/g);q&&q.forEach(w=>{let _=w.match(/\[s\]([\s\S]*?)\[\/s\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<strike>${v}</strike>`);});let $=e.match(/\[([\s\S]+?)\]/g);$&&$.forEach(w=>{let _=t[w];_&&(e=e.replace(w,`<img loading="lazy" src="${_}" border="0" alt="" smilieid="">`));});let k=e.match(/\[media=[\s\S]+?\][\s\S]+?\[\/media\]/g);k&&k.forEach(w=>{let _=w.match(/\[media=[\s\S]*?\]([\s\S]*?)\[\/media\]/),v=_?_[_.length-1]:"";v&&(e=e.replace(w,`<ignore_js_op><span><iframe src="${v}" border="0" scrolling="no" framespacing="0" allowfullscreen="true" style="max-width: 100%" width="100%" height="auto" frameborder="no"></iframe></span></ignore_js_op>`));});let T=e.match(/\[email=[\s\S]+?\][\s\S]+?\[\/email\]/g);T&&T.forEach(w=>{let _=w.match(/\[email=([\s\S]*?)\][\s\S]*?\[\/email\]/),v=w.match(/\[email=[\s\S]*?\]([\s\S]*?)\[\/email\]/),E=_.length?_[_.length-1]:"",D=v.length?v[v.length-1]:"";(E||D)&&(e=e.replace(w,`<a href="mailto:${E}">${D}</a>`));});let L=e.match(/\[align=[\s\S]+?\][\s\S]+?\[\/align\]/g);L&&L.forEach(w=>{let _=w.match(/\[align=([\s\S]*?)\][\s\S]+?\[\/align\]/),v=w.match(/\[align=[\s\S]*?\]([\s\S]+?)\[\/align\]/),E=_.length?_[_.length-1]:"",D=v.length?v[v.length-1]:"";(E||D)&&(e=e.replace(w,`<div align="${E}">${D}</div>`));});let I=e.match(/\[qq\][\s\S]*?\[\/qq\]/g);I&&I.forEach(w=>{let _=w.match(/\[qq\]([\s\S]*?)\[\/qq\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<a href="http://wpa.qq.com/msgrd?v=3&uin=${v}&site=[Discuz!]&from=discuz&menu=yes" target="_blank"><img loading="lazy" src="static/image/common/qq_big.gif" border="0"></a>`);});let R=e.match(/\[td\][\s\S]+?\[\/td\]/g);R&&R.forEach(w=>{let _=w.match(/\[td\]([\s\S]*?)\[\/td\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<td>${v}</td>`);});let M=e.match(/\[tr\][\s\S]+?\[\/tr\]/g);M&&M.forEach(w=>{let _=w.match(/\[tr\]([\s\S]*?)\[\/tr\]/),v=_?_[_.length-1]:"";e=e.replace(w,`<tr>${v}</tr>`);});let N=e.match(/\[table\][\s\S]+?\[\/table\]/g);N&&N.forEach(w=>{let _=w.match(/\[table\]([\s\S]*?)\[\/table\]/),v=_?_[_.length-1]:"";v=v.replace(/\n/g,""),e=e.replace(w,`<table>${v}</table>`);});let z=e.match(/\[list=[\s\S]+?\][\s\S]+?\[\/list\]/g);return z&&z.forEach(w=>{let _=w.match(/\[list=([\s\S]*?)\][\s\S]*?\[\/list\]/),v=w.match(/\[list=[\s\S]*?\]([\s\S]*?)\[\/list\]/),E=_?_[_.length-1]:"",D="";E==="a"?D="litype_2":E==="A"?D="litype_3":E.length===1&&E.match(/[0-9]{1}/)&&(D="litype_1");let j=v?v[v.length-1]:"",J=j.split("[*]");if(J.length>1){let ue="";J[0].replace(/[\s]*/,"")==""&&(J=J.slice(1)),Array.from(J).forEach(Q=>{ue=`${ue}<li>${Q}</li>`;}),j=ue;}j=j.replace(/\n/g,""),e=e.replace(w,`<ul type="${E}" class="${D}">${j}</ul>`);}),e},parseVoteText(){let e=["rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)","rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)"],t=F(".comiis_polloption_add ul li:first-child div.flex .comiis_input.kmshow[type='text']"),i=parseInt(s.val("input#maxchoices"));i=isNaN(i)?0:i,i=i>0?i:0,i=i>t.length?t.length:i;let n=parseInt(s.val("input#polldatas"));n=isNaN(n)?0:n,x.$("input#visibilitypoll").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close");let a=!x.$("input#overt").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close"),o="",l="";t.forEach((r,c)=>{c>=20||(l=l+`
                    <li class="kmnop">
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
			...
			`));let e=new f.LockFunction(()=>{let t=f.getNodeListValue(G.comiisForumList(),G.comiisPostli(),G.comiisMmlist());t.length&&t.forEach(i=>{if(i.querySelector(".gm-custom-label-uid"))return;let a=Array.from(i.querySelectorAll("a")).map(o=>{let r=o.href.match(ee.uid);if(r)return r[r.length-1]}).filter(o=>o!=null);if(a.length){let o=a[0],l=document.createElement("a"),r=i.querySelector(".top_lev");l.className=r.className,l.classList.add("gm-custom-label-uid"),l.style.cssText="background: #FF7600 !important;",l.innerHTML="UID:"+o,s.on(l,"click",async c=>{s.preventEvent(c),await f.copy(o)?b.success(`${o}已复制`):b.error(`${o}复制失败`);}),r.parentElement.append(l);}});});f.mutationObserver(document,{config:{subtree:true,childList:true},callback(){e.run();}});},async extendCookieExpire(){h.info("延长cookie有效期");let e=await De.cookie.list({}),t=["_auth","_saltkey","_client_created","_client_token"];e.forEach(async i=>{if(i.session)return;let n=i.expirationDate,a=Date.now()/1e3;if(n<a)return;let o=3600*24*30;n-a>o||!t.find(r=>i.name.endsWith(r))||De.cookie.set({name:i.name,value:i.value,expirationDate:i.expirationDate+o}).then(()=>{h.info(`延长Cookie +30天成功：${i.name}`);}).catch(()=>{h.error(`延长Cookie +30天失败：${i.name}`);});});}},de={$upload:{small:false,middle:false,big:false},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return de.$el.$smallUpload.files[0]},get middle(){return de.$el.$middleUpload.files[0]},get big(){return de.$el.$bigUpload.files[0]}},showView(){const e=this;let t=U.confirm({title:{text:"修改头像",position:"center"},content:{text:`
                ...
                `,html:true},btn:{ok:{text:"上传",callback:async()=>{if(!e.$upload.small){b.error("请上传小头像");return}if(!e.$upload.middle){b.error("请上传中头像");return}if(!e.$upload.big){b.error("请上传大头像");return}let i=b.loading("正在处理数据中...");try{let n=await this.getUploadUrl();if(n==null)return;let a=await O.getFormHash();if(a==null){b.error("获取formhash失败");return}let o={big:{base64:await f.parseFileToBase64(this.$avatar.big)},middle:{base64:await f.parseFileToBase64(this.$avatar.middle)},small:{base64:await f.parseFileToBase64(this.$avatar.small)}};Object.keys(o).forEach(c=>{let m=o[c];m.base64=m.base64.substring(m.base64.indexOf(",")+1);});let l=new FormData;l.append("Filedata",this.$avatar.big||""),l.append("confirm","确定"),l.append("avatar1",o.big.base64),l.append("avatar2",o.middle.base64),l.append("avatar3",o.small.base64),l.append("formhash",a),h.info("头像的base64字符串",o);let r=await B.post(n,{data:l,processData:!1,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","User-Agent":f.getRandomPCUA(),Host:window.location.hostname,Origin:window.location.origin,Referer:`${window.location.origin}/home.php?mod=spacecp&ac=avatar`}});if(!r.status)return;r.data.responseText.indexOf("window.parent.postMessage('success','*')")!=-1?(t.close(),b.success("上传成功")):(h.error("上传失败",r),b.error(r.data.responseText,{timeout:6e3,isHTML:!1}));}catch(n){h.error(n);}finally{i.close();}}}},width:"88vw",height:"500px",style:`
            .avatar-container{
                display: flex;
                width: -webkit-fill-available;
                width: -moz-available;
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,i,n){s.on(e,"change",a=>{if(!e.files?.length)return;s.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let o=e.files[0],l=o.size,r=new Image,c=new FileReader;c.readAsDataURL(o),c.onload=function(m){r.src=m.target.result,r.onload=function(){if(r.width>i.width||r.height>i.height){e.value="",t.setAttribute("data-success","false"),s.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${r.width} 高：${r.height}`);return}if(l>de.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),s.text(t,`🤡校验失败 ==> 图片大小不符合：${l}byte，限制最大：${de.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),s.text(t,`🤣 通过 宽:${r.width} 高:${r.height} 大小(byte):${l}`),n();};};});},async getUploadUrl(){let e=await B.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":f.getRandomPCUA()}});if(!e.status)return;if(f.isNull(e.data.responseText)){b.error("动态头像：获取上传地址失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){b.error("动态头像：获取变量data失败");return}let n=t[t.length-1].split(","),a=n.indexOf("stl_src");if(a===-1&&(a=n.indexOf("src")),a===-1){b.error("动态头像：获取上传地址失败");return}let o=n[a+1],l=new URL(o);return l.pathname=l.pathname.replace("/images/camera.swf","/index.php"),l.searchParams.delete("inajax"),l.searchParams.set("m","user"),l.searchParams.set("a","rectavatar"),l.searchParams.set("base64","yes"),o=l.toString(),h.info("上传地址："+o),o}},Dt={id:"component-common",title:"通用",views:[{text:"",type:"container",views:[{text:"Toast配置",type:"deepMenu",views:[{text:"",type:"container",views:[Be("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],e=>{h.info("设置当前Qmsg弹出位置"+e.text);},"Toast显示在页面九宫格的位置"),Be("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),P("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",views:[{text:"",type:"container",views:[P("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),P("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie"),_e("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"container",views:[{text:"功能",type:"deepMenu",views:[{text:"",type:"container",views:[P("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),P("显示用户UID","mt-show-user-uid",true,void 0,"格式为UID：xxx"),P("小窗模式","mt-small-window",true,void 0,"开启后点击帖子右侧区域为小窗打开"),P("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{text:"额外菜单项",type:"deepMenu",views:[{type:"container",text:"",views:[P("小黑屋","mt-black-home",true,void 0,"将会在左侧面板添加【小黑屋】菜单"),P("在线用户","mt-online-user",true,void 0,"将会在左侧面板添加【在线用户】菜单"),P("付费主题白嫖提醒","mt-post-paidThemePost",true,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),P("我的屏蔽","mt-ownBlock",true,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),P("商品上架提醒","mt-productListingReminder",true,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),P("自定义用户标签","mt-customizeUserLabels",true,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),P("评论过滤器","mt-post-comment-filter",true,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",views:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"container",views:[Ne(e=>{const t=s.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return i.querySelector(".avatar-img[data-size='small']"),i.querySelector(".avatar-img[data-size='middle']"),i.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(i),e.appendChild(n),e},void 0,{text:"头像（有缓存）",desc:"小、中、大"}),Ne(e=>{const t=s.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return e.appendChild(t),e.appendChild(i),e},void 0,{text:"头像",desc:"小、中、大"}),Se("修改头像",`可以上传gif图片，注意图片最大限制为${X.formatByteToSize(de.$data.avatarInfo.maxSize)}`,"上传",void 0,false,false,"primary",()=>{de.showView();})]}]}]}]},Pt={id:"component-forum-post",title:"帖子",views:[{text:"",type:"container",views:[{text:"功能",type:"deepMenu",views:[{text:"",type:"container",views:[P("自动展开内容","mt-forum-post-autoExpandContent",true,void 0,"注入CSS展开帖子的内容"),P("修复图片宽度","mt-forum-post-repairImageWidth",true,void 0,"修复图片宽度超出页面宽度的问题"),P("移除帖子字体效果","mt-forum-post-removeFontStyle",false,void 0,""),P("移除评论区的字体效果","mt-forum-post-removeCommentFontStyle",false,void 0,""),P("添加【点评】按钮","mt-forum-post-addCommentOnBtn",false,void 0,"在评论区的每个评论右下角添加按钮"),P("附件点击提醒","mt-forum-post-setAttachmentsClickTip",true,void 0,"阻止默认点击附件就会触发附件下载"),P("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮"),P("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片")]}]},{text:"自动加载评论",type:"deepMenu",views:[{type:"container",text:"",views:[P("自动加载下一页评论","mt-forum-post-loadNextPageComment",true,void 0,""),P("同步加载的地址","mt-forum-post-syncNextPageUrl",false,void 0,"便于刷新页面会停留在当前查看的评论页面")]}]},{text:"编辑器-简略版",type:"deepMenu",views:[{type:"container",text:"",views:[P("启用","mt-forum-post-editorOptimizationNormal",true,void 0,"优化样式，插入bbcode代码等"),P("自动保存输入记录","mt-forum-post-editorOptimizationNormal-recordInputText",true,void 0,"当回复时会自动清空记录"),Se("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async e=>{let n=e.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),a=await se.clearAllReplyRecord();a.success?(b.success("清理成功"),s.text(n,`当前占用空间大小：${await se.getReplyRecordSize()}`)):b.error("清理失败 "+a.msg);},async(e,t)=>{let i=t.target.querySelector(".pops-panel-item-left-desc-text");s.text(i,`当前占用空间大小：${await se.getReplyRecordSize()}`);})]}]},{text:"编辑器-完整版",type:"deepMenu",views:[{type:"container",text:"",views:[P("启用","mt-forum-post-publish-editorOptimization",true,void 0,"优化样式，插入bbcode代码，双列预览等"),P("自动保存输入记录","mt-forum-post-editorOptimization-recordInputText",true,void 0,"当回复/发表时会自动清空记录"),Se("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async e=>{let n=e.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),a=await $e.clearAllReplyRecord();a.success?(b.success("清理成功"),s.text(n,`当前占用空间大小：${await $e.getReplyRecordSize()}`)):b.error("清理失败 "+a.msg);},async(e,t)=>{let i=t.target.querySelector(".pops-panel-item-left-desc-text");s.text(i,`当前占用空间大小：${await $e.getReplyRecordSize()}`);})]}]},{text:"编辑器-图床配置",type:"deepMenu",views:[{type:"container",text:'<a href="https://www.helloimg.com/" target="_blank">Hello图床</a>',views:[P("启用","mt-image-bed-hello-enable",false,void 0,"启用Hello图床"),Y("账号","mt-image-bed-hello-account","","",void 0,"必填"),ze("密码","mt-image-bed-hello-password","","",void 0,"必填"),ze("token","mt-image-bed-hello-token","","",void 0,"必填")]},{type:"container",text:'<a href="https://img.binmt.cc/" target="_blank">MT图床</a>',views:[P("启用","mt-image-bed-mt-enable",true,void 0,"启用MT图床")]},{type:"container",text:"图片水印",views:[P("启用","mt-image-bed-watermark-enable",false,void 0,"开启后会为图床图片添加文字水印"),P("自动添加水印","mt-image-bed-watermark-autoAddWaterMark",false,void 0,"开启后会自动添加水印，关闭后会有添加水印后的图片预览"),Y("水印文字","mt-image-bed-watermark-text","MT论坛"),Y("颜色","mt-image-bed-watermark-text-color","#000000",void 0,void 0,"","color",(e,t)=>{let i=t.target?.querySelector("input"),n=t.target?.querySelector(".pops-panel-input__suffix");s.hide(n,false),i.setAttribute("type","color"),s.css(i,{margin:"unset",padding:"unset",width:"80px"});}),me("大小","mt-image-bed-watermark-font-size",16),me("透明度","mt-image-bed-watermark-font-opacity",1),me("左右间距","mt-image-bed-watermark-left-right-margin",80),me("上下间距","mt-image-bed-watermark-top-bottom-margin",80),me("旋转角度","mt-image-bed-watermark-rotate",45)]}]}]}]},Vt={id:"component-search",title:"搜索",views:[{type:"container",text:"",views:[P("显示搜索历史","mt-search-showSearchHistory",true,void 0,"自动记住搜索历史并显示"),P("修复清空按钮","mt-search-repairClearBtn",true,void 0,"修复点击清空按钮不清空输入框的问题"),P("搜索框自动获取焦点","mt-search-searchInputAutoFocus",true,void 0,"")]}]},Ut={id:"component-sigh",title:"签到",views:[{text:"功能",type:"container",views:[P("显示【今日签到之星】","mt-sign-showTodaySignStar",true,void 0,"在签到按钮上面显示今日签到之星"),P("显示【今日最先】","mt-sign-showTodayRanking",true,void 0,"在签到排名上面新增【今日最先】")]},{text:"自动签到",type:"container",views:[P("启用","mt-auto-sign",true,void 0,"自动请求签到"),P("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),Se("签到信息",`上次签到时间：${(()=>{let e=qe.getHostNameSignInfo(window.location.hostname);return e?X.formatTime(e.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",e=>{let i=e.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");U.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:n=>{let a=window.location.hostname;qe.clearSignInfo(a),b.success("删除成功"),s.text(i,`上次签到时间：${(()=>{let o=qe.getHostNameSignInfo(a);return o?X.formatTime(o.time):"尚未签到"})()}`),n.close();}}},width:"88vw",height:"200px"});})]}]},zt={id:"component-space",title:"空间",views:[{type:"container",text:"",views:[P("修复无法进入空间","mt-space-repairEnterSpace",true,void 0,"修复链接错误导致不能进入空间的问题"),P("显示帖子回复内容","mt-space-showCommentContent",true,void 0,"在帖子-回复下面显示具体评论的内容")]}]},Nt={id:"component-guide",title:"导读",views:[{type:"container",text:"",views:[P("显示最新帖子","mt-guide-showLatestPost",true,void 0,"在最上面显示最新发布的帖子")]}]};ye.addContentConfig([Dt,Pt,Vt,Ut,zt,Nt]);S.init();G.registerLeftMenu({name:"MT论坛脚本设置",icon:"",iconColor:"#ff0505",iconSize:"23px",callback:()=>{S.showPanel(ye.getConfig(0));}});Mt.init();

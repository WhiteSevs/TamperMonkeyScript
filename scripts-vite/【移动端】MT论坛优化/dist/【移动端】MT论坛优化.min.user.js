...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof $t=="function"?$t(t.keyName):"";typeof e=="string"&&e?G(e):vt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,r.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(i=>{e.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()}},te="【移动端】MT论坛优化",g=at.noConflict(),r=X.noConflict(),B=bt,b=new g.Log(ht,y.console||Zt.console);var Et;const kt=((Et=ht==null?void 0:ht.script)==null?void 0:Et.name)||te,Lt=!1;b.config({debug:Lt,logMaxCount:1e3,autoClearConsole:!0,tag:!0});x.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return q.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return q.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return q.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let t=at.getMaxZIndex(),e=bt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return at.getMaxValue(t,e)+100}}}));const ee=new g.GM_Menu({GM_getValue:Y,GM_setValue:W,GM_registerMenuCommand:Kt,GM_unregisterMenuCommand:Qt}),V=new g.Httpx(Jt);V.interceptors.request.use(t=>(Xt.handle(t),t));V.interceptors.response.use(void 0,t=>(b.error(["拦截器-请求错误",t]),t.type==="onabort"?x.warning("请求取消"):t.type==="onerror"?x.error("请求异常"):t.type==="ontimeout"?x.error("请求超时"):x.error("其它错误"),t));V.config({logDetails:Lt});bt.GlobalConfig.setGlobalConfig({mask:{enable:!0,clickEvent:{toClose:!1,toHide:!1}}});y.Object.defineProperty,y.Function.prototype.apply,y.Function.prototype.call,y.Element.prototype.appendChild,y.setTimeout;const G=g.addStyle.bind(g);vt.setGMResourceCSS(Rt.Viewer);vt.setGMResourceCSS(Rt.Hljs);const E=document.querySelector.bind(document),O=document.querySelectorAll.bind(document),lt="GM_Panel",Dt="data-init",it="data-key",nt="data-default-value",ie="data-init-more-value",P="data-storage-api",A=function(t,e,i,n,s,l){let o={text:t,type:"switch",description:s,attributes:{},props:{},getValue(){return !!this.props[P].get(e,i)},callback(a,c){let m=!!c;b.success(`${m?"开启":"关闭"} ${t}`),this.props[P].set(e,m);},afterAddToUListCallBack:l};return Reflect.set(o.attributes,it,e),Reflect.set(o.attributes,nt,i),Reflect.set(o.props,P,{get(a,c){return q.getValue(a,c)},set(a,c){q.setValue(a,c);}}),o},pt=function(t,e,i,n,s,l="",o){let a={text:t,type:"textarea",attributes:{},props:{},description:n,placeholder:l,disabled:o,getValue(){return this.props[P].get(e,i)},callback(c,m){this.props[P].set(e,m);}};return Reflect.set(a.attributes,it,e),Reflect.set(a.attributes,nt,i),Reflect.set(a.props,P,{get(c,m){return q.getValue(c,m)},set(c,m){q.setValue(c,m);}}),a},St=function(t,e,i,n,s,l){let o=[];typeof n=="function"?o=n():o=n;let a={text:t,type:"select",description:l,attributes:{},props:{},getValue(){return this.props[P].get(e,i)},callback(c,m,d){let u=m;b.info(`选择：${d}`),this.props[P].set(e,u),typeof s=="function"&&s(c,u,d);},data:o};return Reflect.set(a.attributes,it,e),Reflect.set(a.attributes,nt,i),Reflect.set(a.props,P,{get(c,m){return q.getValue(c,m)},set(c,m){q.setValue(c,m);}}),a},ft=function(t,e,i,n,s,l,o,a,c){return {text:t,type:"button",description:e,buttonIcon:n,buttonIsRightIcon:s,buttonIconIsLoading:l,buttonType:o,buttonText:i,callback(d){typeof a=="function"&&a(d);},afterAddToUListCallBack:c}},Tt=function(t,e,i,n){let s={type:"own",attributes:{},props:i,getLiElementCallBack:t,afterAddToUListCallBack:n};return Reflect.set(s.attributes,Dt,()=>!1),s},F={getAvatar:(t,e="middle")=>`/uc_server/avatar.php?uid=${t}&size=${e}&ts=1`,getCurrentUID(){let t=y.discuz_uid;if(typeof t=="string")return t;let e=document.querySelector('.sidenv_exit a[href*="uid="]');if(e){let i=e.href.match(/uid=([0-9]+)/);if(i)return i[i.length-1]}},getCurrentFormHash(){let t=document.querySelector('.sidenv_exit a[href*="formhash="]');if(t){let e=t.href.match(/formhash=([0-9a-zA-Z]+)/);if(e)return e[e.length-1]}},envIsMobile(){return (y.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:t=>{let e=t.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(e){let i=e.filter(Boolean);return i[i.length-1]}},getForumId(t){let e=t.match(/&fid=([\d]+)/i);if(e)return e[e.length-1]},getPostId(t){let e=t.match(/&pid=([\d]+)/i);if(e)return e[e.length-1]},getRepquote(t){let e=t.match(/&repquote=([\d]+)/i);if(e)return e[e.length-1]}},tt={$upload:{small:!1,middle:!1,big:!1},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return tt.$el.$smallUpload.files[0]},get middle(){return tt.$el.$middleUpload.files[0]},get big(){return tt.$el.$bigUpload.files[0]}},showView(){let t=B.confirm({title:{text:"修改头像",position:"center"},content:{text:`
                ...
                `,html:!0},btn:{ok:{text:"上传",callback:async()=>{if(!tt.$upload.small||!tt.$upload.middle||!tt.$upload.big){x.error("校验失败");return}let e=x.loading("正在处理数据中..."),i=await g.parseFileToBase64(this.$avatar.small),n=await g.parseFileToBase64(this.$avatar.middle);const o=[await g.parseFileToBase64(this.$avatar.big),n,i].map(u=>u.substring(u.indexOf(",")+1));let a=await this.getUploadUrl();if(e.close(),a==null)return;let c=F.getCurrentFormHash();if(c==null){x.error("获取formhash失败");return}let m=new FormData;m.append("Filedata",this.$avatar.big||""),m.append("confirm","确定"),m.append("avatar1",o[0]),m.append("avatar2",o[1]),m.append("avatar3",o[2]),m.append("formhash",c);let d=await V.post(a,{data:m,processData:!1,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","User-Agent":g.getRandomPCUA(),Host:window.location.hostname,Origin:window.location.origin,Referer:`${window.location.origin}/home.php?mod=spacecp&ac=avatar`}});t.close(),d.status&&(d.data.responseText.indexOf("window.parent.postMessage('success','*')")!=-1?x.success("上传成功"):(b.error("上传失败",d),x.error(d.data.responseText,{timeout:6e3,isHTML:!1,html:!1})));}}},mask:{enable:!0},width:"88vw",height:"500px",style:`
            .avatar-container{
                display: flex;
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=!0;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=!0;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=!0;});},setUploadChangeEvent(t,e,i,n){r.on(t,"change",s=>{var m;if(!((m=t.files)!=null&&m.length))return;r.text(e,"🤡获取文件信息中..."),e.removeAttribute("data-success");let l=t.files[0],o=l.size,a=new Image,c=new FileReader;c.readAsDataURL(l),c.onload=function(d){a.src=d.target.result,a.onload=function(){if(a.width>i.width||a.height>i.height){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片尺寸不符合，宽：${a.width} 高：${a.height}`);return}if(o>tt.$data.avatarInfo.maxSize){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片大小不符合：${o}byte，限制最大：${tt.$data.avatarInfo.maxSize}byte`);return}e.setAttribute("data-success","true"),r.text(e,`🤣 通过 宽:${a.width} 高:${a.height} 大小(byte):${o}`),n();};};});},async getUploadUrl(){let t=await V.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":g.getRandomPCUA()}});if(!t.status)return;if(g.isNull(t.data.responseText)){x.error("动态头像：获取上传地址失败");return}let e=t.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(e==null||e.length!=2){x.error("动态头像：获取变量data失败");return}let n=e[e.length-1].split(","),s=n[n.indexOf("src")+1].replace("images/camera.swf?inajax=1","index.php?m=user&a=rectavatar&base64=yes");return b.info("上传地址："+s),s}},ne={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[St("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,i)=>{b.info("设置当前Qmsg弹出位置"+i);},"Toast显示在页面九宫格的位置"),St("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),A("逆序弹出","qmsg-config-showreverse",!1,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[A("启用","httpx-use-cookie-enable",!1,void 0,"启用后，将根据下面的配置进行添加cookie"),A("使用document.cookie","httpx-use-document-cookie",!1,void 0,"自动根据请求的域名来设置对应的cookie"),pt("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[A("链接文本转超链接","mt-link-text-to-hyperlink",!0,void 0,"自动把页面中的链接文本转换为超链接"),A("显示用户UID","mt-show-user-uid",!0,void 0,"格式为UID：xxx"),A("小窗模式","mt-small-window",!0,void 0,"开启后点击帖子右侧区域为小窗打开")]}]},{text:"额外菜单项",type:"deepMenu",forms:[{type:"forms",text:"",forms:[A("小黑屋","mt-black-home",!0,void 0,"将会在左侧面板添加【小黑屋】菜单"),A("在线用户","mt-online-user",!0,void 0,"将会在左侧面板添加【在线用户】菜单"),A("付费主题白嫖提醒","mt-post-paidThemePost",!0,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),A("我的屏蔽","mt-ownBlock",!0,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),A("商品上架提醒","mt-productListingReminder",!0,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),A("自定义用户标签","mt-customizeUserLabels",!0,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),A("评论过滤器","mt-post-comment-filter",!0,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",forms:[{text:"",type:"forms",forms:[Tt(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return i.querySelector(".avatar-img[data-size='small']"),i.querySelector(".avatar-img[data-size='middle']"),i.querySelector(".avatar-img[data-size='big']"),t.appendChild(e),t.appendChild(i),t.appendChild(n),t}),Tt(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
...
`);N.length==1?z=`<li>${S}</li>`:Array.from(N).forEach((Z,rt)=>{rt==N.length-1?z=`${z}<li>${Z}</li>`:z=`${z}<li>${Z}<br></li>`;}),t=t.replace($,`
        ...
        `);let e=E("#select-post-section"),i=F.getForumId(window.location.href);I.isPostPublish_newthread()?(b.info("发帖"),r.on(e,"change",function(){let n=r.val(e),s=`forum.php?mod=post&action=newthread&fid=${n}&extra=&topicsubmit=yes&mobile=2`;b.info(`修改发帖板块: ${t[n]} ${s}`);let l={求助问答:{className:"gm_user_select_help",optionHTML:`<option value="0" selected="selected">请选择</option>
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
            ...
            </div>`),r.on(".gm_plugin_previewpostforum","click",function(i){let n=this;if(O("#polldatas").length&&xt.parseVoteText(),n.querySelector("i.comiis_font").classList.contains("f_0"))r.hide(".gm_plugin_previewpostforum_html",!1);else {r.show(".gm_plugin_previewpostforum_html",!1);let l=xt.parseText(r.val(t.$el.$input));r.html(".gm_plugin_previewpostforum_html .comiis_message_table",l),r.css(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box.comiis_input_style","height",r.css(t.$el.$input,"height"));}});},initSettingImmersionMode(){b.info("初始化设置功能-使用沉浸模式"),r.append(r.parent("#htmlon"),`
            <li class="comiis_styli_m f15 comiis_flex b_b">
...
`,be={$data:{},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"在线用户",iconColor:"#2d92ff",icon:"",callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let t=x.loading("正在获取在线用户名单中..."),e=await this.getOnlineUserListInfo();if(t.close(),!e)return;let i=B.alert({title:{text:"在线用户",position:"center"},content:{text:`
        ...
        `),q.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),X.ready(()=>{q.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),q.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){b.info("显示搜索历史");let t=Y("search_history",[]),e=document.querySelector("#scform_srchtxt"),i=document.querySelector("#searchform"),n=B.searchSuggestion({target:e,inputTarget:e,data:t,getItemHTML:function(o){return o},getData(o){return t.filter(a=>a.includes(o))},deleteIcon:{enable:!0,callback(o,a,c){let m=t.findIndex(d=>d===c);m!==-1&&(t.splice(m,1),W("search_history",t)),a.remove();}},itemClickCallBack(o,a,c){e.value=c,i.submit();}});n.init(),n.setAllEvent();function s(){let o=document.querySelector("#scform_submit");X.on(o,"click",function(){let a=e.value;if(a!=""){let c=Y("search_history",[]);c.includes(a)?b.info("已有该搜索历史记录"):(b.info("无该记录，追加"),c.push(a)),W("search_history",c);}});}function l(){let a='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+Y("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    ...
                    min-width: 20vw;
                    width: 20vw;
                ">清理记录</button></div>`;X.before(document.querySelector(".comiis_p12"),a);let c=document.querySelector(".btn_clear_search_history");X.on(c,"click",m=>{g.preventEvent(m),ot("search_history"),window.location.reload();});}s(),l();},repairClearBtn(){g.waitNode("a.ssclose").then(t=>{b.info("修复清空按钮"),X.on(t,"click",e=>{let i=document.querySelector("#scform_srchtxt");i?i.value="":x.error("获取输入框失败");},{capture:!0});});},searchInputAutoFocus(){new URLSearchParams(window.location.search).has("kw")||g.waitNode("#scform_srchtxt").then(e=>{b.info("搜索框自动获取焦点"),e.focus();});}},xe={init(){q.execMenuOnce("mt-sign-showTodaySignStar",()=>{this.showTodaySignStar();}),q.execMenuOnce("mt-sign-showTodayRanking",()=>{this.showTodayRanking();});},async showTodaySignStar(){b.info("显示【今日签到之星】");let t=document.querySelector(".pg_k_misign .comiis_qdinfo"),e=document.createElement("ul"),i=await V.get("/k_misign-sign.html",{headers:{"User-Agent":g.getRandomPCUA()}});if(!i.status)return;let s=r.parseHTML(i.data.responseText,!0,!0).querySelector("#pt span.xg1");if(!s)return;let l=r.text(s).replace("今日签到之星：","");e.innerHTML=`
...
`;class qe{constructor(e){st(this,"isBacking",!1);st(this,"config");this.config=e,this.enterGestureBackMode.bind(this),this.quitGestureBackMode.bind(this),this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(e){g.preventEvent(e),!this.isBacking&&this.quitGestureBackMode(!0);}enterGestureBackMode(){b.success("进入手势模式");let e=this.config.hash;e.startsWith("#")||(e.startsWith("/")||(e="/"+e),e="#"+e),this.config.useUrl&&(e=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+e),this.config.win.history.pushState({},"",e),b.success("监听popstate事件"),r.on(this.config.win,"popstate",this.popStateEvent.bind(this),{capture:!0});}async quitGestureBackMode(e=!1){this.isBacking=!0,b.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(e);let i=Date.now()+1e3*5;for(;;){if(Date.now()>i){b.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))b.info("history.back()"),this.config.win.history.back(),await g.sleep(this.config.backDelayTime||150);else break}b.success("移除popstate事件"),r.off(this.config.win,"popstate",this.popStateEvent.bind(this),{capture:!0}),this.isBacking=!1,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(e);}}const ct={https:`
        ...
        <div class="small-window-title-container">
            ...
            <div class="small-window-control">
                ...
                `,html:!0},mask:{enable:!0,clickEvent:{toClose:!0},clickCallBack(C,D){R.quitGestureBackMode();}},btn:{ok:{enable:!1},cancel:{enable:!1},close:{enable:!1}},direction:"bottom",size:"92%",borderRadius:18,style:ve}),a=o.$shadowRoot.querySelector(".small-window-website-icon"),c=o.$shadowRoot.querySelector(".refresh-icon"),m=o.$shadowRoot.querySelector(".small-window-control-image-view"),d=o.$shadowRoot.querySelector(".small-window-control-open-blank"),u=o.$shadowRoot.querySelector(".small-window-control-close"),f=o.$shadowRoot.querySelector(".small-window-title-text");this.$el.$refreshIcon=c,this.$el.$webSiteIcon=a;let p=o.$shadowRoot.querySelector("iframe"),h=o.$shadowRoot.querySelector(".small-window-drag"),_=B.config.Utils.AnyTouch(),k=new _(h),v=o.popsElement,T=r.height(v);k.on("pan",C=>{C.phase=="move"&&C.displacementY>0&&(v.style.transition="none",v.style.height=Math.abs(T-C.distanceY)+"px"),C.isEnd&&(v.style.transition="0.2s ease-in",parseInt(v.style.height)>window.innerHeight/2?v.style.height=T+"px":o.close());});let R=new qe({win:self,hash:this.$key.smallWindow,useUrl:!0,beforeHistoryBackCallBack:()=>{o.close();}});R.enterGestureBackMode(),r.on(f,"click",C=>{g.preventEvent(C),g.setClip(`『${t}』 - ${e}`),x.success("已复制链接");}),r.on(m,"click",C=>{g.preventEvent(C),b.info("查看图片",i);var D="";i.forEach(H=>{D+=`<li><img data-src="${H}"></li>`;});var L=r.parseHTML(`<ul>${D}</ul>`,!1,!1);let M=new At(L,{inline:!1,url:"data-src",zIndex:(()=>{let H=g.getMaxZIndex(),$=B.config.InstanceUtils.getPopsMaxZIndex().zIndex;return g.getMaxValue(H,$)+100})(),hidden:()=>{M.destroy();}});M.zoomTo(1),M.show();}),r.on(u,"click",C=>{g.preventEvent(C),R.quitGestureBackMode();}),r.on(d,"click",C=>{g.preventEvent(C),window.open(e,"_blank");}),r.on(a,"click",C=>{g.preventEvent(C),p.contentWindow.location.reload(),this.checkIframeReadyState(p);}),this.checkIframeReadyState(p);},async handleForumPost(t){t.forEach(e=>{if(e.getAttribute("data-injection-small-window"))return;let i=r.text(e.querySelector(".mmlist_li_box h2 a"));(i==""||i==null)&&(i=r.text(e.querySelector(".mmlist_li_box a"))),i=i.trim();let n=e.querySelector(".mmlist_li_box a").href;var s=[];e.setAttribute("data-injection-small-window","true"),e.setAttribute("data-injection-small-window-url",n),e.setAttribute("data-injection-small-window-title",i),e.querySelectorAll(".comiis_pyqlist_img img").forEach(o=>{s.push(o.getAttribute("src"));}),e.querySelectorAll(".comiis_pyqlist_imgs img").forEach(o=>{s.push(o.getAttribute("src"));}),e.querySelectorAll(".mmlist_li_box a").forEach(o=>{o.removeAttribute("href"),o.setAttribute("data-href",n);});let l=e.querySelector(".mmlist_li_box");r.on(l,"click",function(o){var a=Number(o.clientX);document.body.offsetWidth/2>a?window.location.href=n:Vt.showSmallWindow(i,n,s);});});},checkIframeReadyState(t){this.showRefreshIcon();let e=setInterval(()=>{t.contentWindow&&(clearInterval(e),r.createDOMUtils({document:t.contentWindow.document,window:t.contentWindow,globalThis:t.contentWindow,self:t.contentWindow,top}).ready(()=>{b.success("小窗内容已加载完毕"),this.hideRefreshIcon();}));},400);},hideRefreshIcon(){this.$el.$refreshIcon.style.display="none",this.$el.$webSiteIcon.style.display="";},showRefreshIcon(){this.$el.$refreshIcon.style.display="",this.$el.$webSiteIcon.style.display="none";}},$e={init(){X.ready(()=>{q.execMenuOnce("mt-guide-showLatestPost",()=>{this.showLatestPost();});});},showLatestPost(){b.info("显示最新帖子");async function t(){let e=await V.get("/forum.php?mod=guide&view=hot",{fetch:!0,allowInterceptConfig:!1});if(!e.status){x.error("获取轮播失败");return}if(e.data.responseText.indexOf('<script src="/_guard/auto.js"><\/script>')!==-1){x.error("获取轮播失败 未知的/_guard/auto.js文件");return}var i=X.parseHTML(e.data.responseText,!0,!0),n=i.querySelectorAll('div.comiis_mh_kxtxt div[id*="comiis_mh_kxtxt"] ul');if(n.length===0){x.error("获取轮播失败");return}else {var s=[];n[n.length-1].querySelectorAll("a").forEach(l=>{s.push({href:l.getAttribute("href"),title:l.getAttribute("title")});});}return s}t().then(e=>{if(!e)return;G(`
            ...
            `);var i="";g.sortListByProperty(e,s=>{var l=s.href.match(/thread-(.+?)-/i);return parseInt(l[l.length-1])},!0),b.info("导读内容",e),e.forEach(s=>{i+=`
                ...
                </li>`;});let n=document.querySelector(".comiis_forumlist.comiis_xznlist");X.before(n,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}};class Ht{constructor(e){st(this,"option");this.option=e;}showView(){var o;let e=B.confirm({title:{text:this.option.title,position:"center"},content:{text:`

...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof kt=="function"?kt(e.keyName):null;typeof t=="string"&&t?G(t):wt.loadStyleLink(e.url);},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,Z.ready(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(i=>{t.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;let t=new URL(e);return t.protocol="https:",t.toString()},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let i=[document.documentElement,document.body].concat(...e||[]);return i.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){i.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(s=>{n(s);}).catch(s=>{u.error("读取剪贴板内容失败👉",s),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(s=>{e(n);}).catch(s=>{u.error("申请剪贴板权限失败，尝试直接读取👉",s.message??s.name??s.stack),e(n);});}function i(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!i()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")}},At={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}},X={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false},httpx_cookie_manager_enable:{key:"httpx-use-cookie-enable",defaultValue:false},httpx_cookie_manager_use_document_cookie:{key:"httpx-use-document-cookie",defaultValue:false}},p=Y.noConflict(),o=Z.noConflict(),D=pt,u=new p.Log(ct,b.console||Kt.console);let St=ct?.script?.name||void 0;pt.config.Utils.AnyTouch();const Rt=false;u.config({debug:Rt,logMaxCount:1e3,autoClearConsole:true,tag:true});f.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return v.getValue(X.qmsg_config_position.key,X.qmsg_config_position.defaultValue)}},maxNums:{get(){return v.getValue(X.qmsg_config_maxnums.key,X.qmsg_config_maxnums.defaultValue)}},showReverse:{get(){return v.getValue(X.qmsg_config_showreverse.key,X.qmsg_config_showreverse.defaultValue)}},zIndex:{get(){let e=Y.getMaxZIndex(),t=pt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Y.getMaxValue(e,t)+100}}}));D.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=Y.getMaxZIndex(void 0,void 0,i=>{if(i?.classList?.contains("qmsg-shadow-container")||i?.closest("qmsg")&&i.getRootNode()instanceof ShadowRoot)return  false}),t=pt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Y.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}}});const Yt=new p.GM_Menu({GM_getValue:K,GM_setValue:W,GM_registerMenuCommand:jt,GM_unregisterMenuCommand:Gt}),N=new p.Httpx({xmlHttpRequest:Wt,logDetails:Rt});N.interceptors.request.use(e=>e);N.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?f.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?f.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?f.error("请求超时",{consoleLogContent:true}):f.error("其它错误",{consoleLogContent:true}),e));b.Object.defineProperty,b.Function.prototype.apply,b.Function.prototype.call,b.Element.prototype.appendChild,b.setTimeout;const G=p.addStyle.bind(p),$=document.querySelector.bind(document),z=document.querySelectorAll.bind(document);new p.GM_Cookie;const Dt="GM_Panel",vt="data-init",et="data-key",it="data-default-value",Zt="data-init-more-value",M="data-storage-api",Ct={setting:{get width(){return window.innerWidth<550?"88vw":window.innerWidth<700?"550px":"700px"},get height(){return window.innerHeight<450?"70vh":window.innerHeight<550?"450px":"550px"}}};class Qt{storageKey;listenerData;constructor(t){if(typeof t=="string"){let i=t.trim();if(i=="")throw new Error("key参数不能为空字符串");this.storageKey=i;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new Y.Dictionary;}getLocalValue(){let t=K(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){W(this.storageKey,t);}set(t,i){let n=this.get(t),s=this.getLocalValue();Reflect.set(s,t,i),this.setLocalValue(s),this.triggerValueChangeListener(t,n,i);}get(t,i){let n=this.getLocalValue();return Reflect.get(n,t)??i}getAll(){return this.getLocalValue()}delete(t){let i=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,i,void 0);}has(t){let i=this.getLocalValue();return Reflect.has(i,t)}keys(){let t=this.getLocalValue();return Reflect.ownKeys(t)}values(){let t=this.getLocalValue();return Reflect.ownKeys(t).map(i=>Reflect.get(t,i))}clear(){st(this.storageKey);}addValueChangeListener(t,i){let n=Math.random(),s=this.listenerData.get(t)||[];return s.push({id:n,key:t,callback:i}),this.listenerData.set(t,s),n}removeValueChangeListener(t){let i=false;for(const[n,s]of this.listenerData.entries()){for(let a=0;a<s.length;a++){const r=s[a];(typeof t=="string"&&r.key===t||typeof t=="number"&&r.id===t)&&(s.splice(a,1),a--,i=true);}this.listenerData.set(n,s);}return i}triggerValueChangeListener(t,i,n){if(!this.listenerData.has(t))return;let s=this.listenerData.get(t);for(let a=0;a<s.length;a++){const r=s[a];if(typeof r.callback=="function"){let l=this.get(t),c,m;typeof i<"u"&&arguments.length>=2?m=i:m=l,typeof n<"u"&&arguments.length>2?c=n:c=l,r.callback(t,m,c);}}}}const nt=new Qt(Dt),dt={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new p.Dictionary),this.__contentConfig}},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){return [{id:"script-version",title:`版本：${ct?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(e,t,i){let n=ct?.script?.supportURL||ct?.script?.namespace;return typeof n=="string"&&p.isNotNull(n)&&window.open(n,"_blank"),false}}]}},Jt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{v.showPanel(dt.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){v.isTopWindow()&&Yt.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let i=this.$data.menuOption.findIndex(n=>n.key===t.key);i!==-1&&(this.$data.menuOption[i]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},v={$data:{__configDefaultValueData:null,__onceExecMenuData:null,__onceExecData:null,__panelConfig:{},$panel:null,get configDefaultValueData(){return this.__configDefaultValueData==null&&(this.__configDefaultValueData=new p.Dictionary),this.__configDefaultValueData},get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new p.Dictionary),this.__onceExecMenuData},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new p.Dictionary),this.__onceExecData},get scriptName(){return St},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:Dt,attributeKeyName:et,attributeDefaultValueName:it},init(){this.initContentDefaultValue(),Jt.init();},isTopWindow(){return b.top===b.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;let s={},a=n.attributes[et];a!=null&&(s[a]=n.attributes[it]);let r=n.attributes[vt];if(typeof r=="function"){let m=r();if(typeof m=="boolean"&&!m)return}let l=n.attributes[Zt];l&&typeof l=="object"&&Object.assign(s,l);let c=Object.keys(s);if(!c.length){u.warn(["请先配置键",n]);return}c.forEach(m=>{let d=s[m];this.setDefaultValue(m,d);});},t=n=>{for(let s=0;s<n.length;s++){let a=n[s];e(a);let r=a.forms;r&&Array.isArray(r)&&t(r);}},i=[...dt.getAllContentConfig()];for(let n=0;n<i.length;n++){let s=i[n];if(!s.forms)continue;const a=s.forms;a&&Array.isArray(a)&&t(a);}},setDefaultValue(e,t){this.$data.configDefaultValueData.has(e)&&u.warn("请检查该key(已存在): "+e),this.$data.configDefaultValueData.set(e,t);},setValue(e,t){nt.set(e,t);},getValue(e,t){let i=nt.get(e);return i??(this.$data.configDefaultValueData.has(e)?this.$data.configDefaultValueData.get(e):t)},deleteValue(e){nt.delete(e);},hasKey(e){return nt.has(e)},addValueChangeListener(e,t){return nt.addValueChangeListener(e,(n,s,a)=>{t(e,a,s);})},removeValueChangeListener(e){nt.removeValueChangeListener(e);},triggerMenuValueChange(e,t,i){nt.triggerValueChangeListener(e,i,t);},deleteExecMenuOnce(e){return this.$data.onceExecMenuData.delete(e),nt.removeValueChangeListener(e)},deleteOnceExec(e){this.$data.onceExecData.delete(e);},exec(e,t,i,n=true){const s=this;let a;typeof e=="string"||Array.isArray(e)?a=()=>e:a=e;let r=false,l=a(),c=[];Array.isArray(l)?(r=true,c=l):c.push(l);let m=c.find(E=>!this.$data.configDefaultValueData.has(E));if(m){u.warn(`${m} 键不存在`);return}let d=JSON.stringify(c);if(n){if(this.$data.onceExecMenuData.has(d))return;this.$data.onceExecMenuData.set(d,1);}let h=[],_=[],g=(E,L)=>{let F=[];Array.isArray(L)||(L=[L]),L.forEach(U=>{if(U!=null&&U instanceof HTMLStyleElement){F.push(U);return}}),h=h.concat(F);},y=E=>this.getValue(E),k=()=>{for(let E=0;E<h.length;E++)h[E].remove(),h.splice(E,1),E--;},S=()=>{let E=false;return typeof i=="function"?E=i(c):E=c.every(L=>y(L)),E},C=E=>{let L=S(),F=[];if(L){let U=c.map(O=>this.getValue(O)),j=t({value:r?U:U[0],addStyleElement:(...O)=>g(true,...O)});Array.isArray(j)||(j=[j]),j.forEach(O=>{if(O!=null&&O instanceof HTMLStyleElement){F.push(O);return}});}k(),h=[...F];};return n&&c.forEach(E=>{let L=this.addValueChangeListener(E,(F,U,j)=>{C();});_.push(L);}),C(),{clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),n&&s.$data.onceExecMenuData.delete(d);},clearStoreStyleElements:()=>k(),removeValueChangeListener:()=>{_.forEach(E=>{this.removeValueChangeListener(E);});}}},execMenu(e,t,i=false){return this.exec(e,n=>t(n),n=>n.every(a=>{let r=!!this.getValue(a);return i&&(r=!r),r}),false)},execMenuOnce(e,t){return this.exec(e,t,i=>i.every(s=>!!this.getValue(s)),true)},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},showPanel(e,t=`${St}-设置`,i=false){let n=e.findIndex(a=>(typeof a.isBottom=="function"?a.isBottom():!!a.isBottom)&&a.id==="script-version")!==-1;!i&&!n&&e.push(...dt.getDefaultBottomContentConfig());let s=D.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(a,r)=>{a.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(a,r)=>{a(),this.$data.$panel=null;}},width:Ct.setting.width,height:Ct.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=s;}};class Xt{$data={get enable(){return v.getValue(X.httpx_cookie_manager_enable.key,X.httpx_cookie_manager_enable.defaultValue)},get useDocumentCookie(){return v.getValue(X.httpx_cookie_manager_use_document_cookie.key,X.httpx_cookie_manager_use_document_cookie.defaultValue)},cookieRule:[]};constructor(t){Array.isArray(t)&&(this.$data.cookieRule=t);}fixCookieSplit(t){return p.isNotNull(t)&&!t.trim().endsWith(";")&&(t+=";"),t}concatCookie(t,i){return p.isNull(t)?i:(t=t.trim(),i=i.trim(),t=this.fixCookieSplit(t),i.startsWith(";")&&(i=i.substring(1)),t.concat(i))}handle(t){if(t.fetch||!this.$data.enable)return;let i="",n=t.url;n.startsWith("//")&&(n=window.location.protocol+n);let s=new URL(n);this.$data.useDocumentCookie&&s.hostname.endsWith(window.location.hostname.split(".").slice(-2).join("."))&&(i=this.concatCookie(i,document.cookie.trim()));for(let a=0;a<this.$data.cookieRule.length;a++){let r=this.$data.cookieRule[a];if(s.hostname.match(r.hostname)){let l=v.getValue(r.key);if(p.isNull(l))break;i=this.concatCookie(i,l);}}p.isNotNull(i)&&(t.headers&&t.headers.Cookie?t.headers.Cookie=this.concatCookie(t.headers.Cookie,i):t.headers.Cookie=i,u.info(["Httpx => 设置cookie:",t])),t.headers&&t.headers.Cookie!=null&&p.isNull(t.headers.Cookie)&&delete t.headers.Cookie;}}wt.setGMResourceCSS(At.Viewer);wt.setGMResourceCSS(At.Hljs);const te=new Xt([{key:"httpx-cookie-bbs.binmt.cc",hostname:/bbs.binmt.cc/g}]);N.interceptors.request.use(e=>(te.handle(e),e));D.GlobalConfig.setGlobalConfig({mask:{enable:true},drag:true});const H={registerLeftMenu(e){p.waitNode(".comiis_sidenv_box .sidenv_li .comiis_left_Touch",1e4).then(t=>{if(!t){u.error("注册左侧面板菜单失败，原因：该元素不存在");return}let i=o.createElement("li",{className:"comiis_left_Touch",innerHTML:`
						<a href="javascript:;" class="comiis_left_Touch">
							<i class="comiis_font"></i>
							${e.name}
						</a>
						`}),n=i.querySelector(".comiis_font");typeof e.style=="string"&&(n.style.cssText=e.style),typeof e.icon=="string"&&(n.innerHTML=e.icon),typeof e.iconColor=="string"&&(n.style.color=e.iconColor),typeof e.iconSize=="string"&&(n.style.fontSize=e.iconSize),o.on(i,"click",s=>{p.preventEvent(s),typeof e.callback=="function"&&e.callback();}),o.append(t,i);});},comiisForumList:()=>document.querySelectorAll("li.forumlist_li"),comiisPostli:()=>document.querySelectorAll("div.comiis_postli.comiis_list_readimgs.nfqsqi"),comiisMmlist:()=>document.querySelectorAll(".comiis_mmlist")},ee=`.pops-confirm-content {\r
	display: flex;\r
...
`)}
								...
								`});}else await a(r);}});}addTab(){let t=$("#comiis_pictitle_key"),i=t.querySelector("a[data-type='history']"),n=`
            <li>
                <a href="javascript:;" class="comiis-picture-tab" data-type="image-bed">${this.option.name}</a>
            </li>
        `;if(!i){let r=o.createElement("li");i=o.createElement("a",{href:"javascript:;",className:"comiis-picture-tab",innerHTML:"历史图片"},{"data-type":"history"}),o.on(i,"click",()=>{this.initHistoryUploadImageList();}),o.append(r,i),o.append(t,r);}o.before(i.parentElement,n);let s=$("#comiis_pictitle_tab .bqbox_t"),a=Array.from(z("#comiis_pictitle_tab .comiis_upbox")).find(r=>!!r.querySelector("#imglist_history"));a||(a=o.createElement("div",{className:"comiis_upbox bg_f cl",innerHTML:`
					<ul class="comiis_post_imglist cl" id="imglist_history">	
                    </ul>
				`},{style:"display: none;"}),o.before(s,a),a=Array.from(z("#comiis_pictitle_tab .comiis_upbox")).find(r=>!!r.querySelector("#imglist_history"))),o.before(a,`
            ...
            `);}createImageBtnElement(t,i){return o.createElement("li",{innerHTML:`
...
`)}    
            ...
            `),$("#comiis_foot_menu_beautify .comiis_position_key"),this.$el.$like=$("#comiis_foot_menu_beautify .comiis_recommend_addkey"),$("#comiis_foot_menu_beautify #comiis_favorite_a"),$("#comiis_pictitle_key"),this.$el.$btn_submit=$('#comiis_foot_menu_beautify_big li[data-attr="发表"] input'),this.$el.$input=$("#comiis_foot_menu_beautify_big textarea"),this.$el.$fastpostsubmit=$("#fastpostsubmit"),b.textarea_scrollHeight=()=>{},typeof b.comiis_addsmilies=="function"&&(b.comiis_addsmilies=d=>{b.$("#needmessage").comiis_insert(d),b.$("#needmessage")[0].dispatchEvent(new Event("propertychange"));}),b.$("#imglist .up_btn").append(b.$("#filedata")),b.$(document).on("click","#imglist .up_btn a",function(){b.$(this).next().click();}),b.$(document).on("click","#imglist .p_img a",function(){let d=b.$(this);if(d.attr("onclick")==null){let h=d.find("img").attr("id").replace("aimg_","");b.comiis_addsmilies(`[attachimg]${h}[/attachimg]`);}}),o.hide("#comiis_foot_menu_beautify_big .menu_body",false),this.setInputChangeEvent(),this.setLikeBtnClickEvent(),this.setSubmitBtnClickEvent(),this.setGlobalReplyBtnClickEvent(),this.setGlobalClickCheckEvent(),this.setMenuIconToggleEvent(),this.setMenuImageClickEvent(),this.setMenuImageToggleEvent(),this.setMenuSmileClickEvent(),this.setMenuSmileTabClickEvent(),this.setMenuInsertClickEvent(),this.setMenuQuickUBB(),v.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{this.initReplyText(),this.setInputChangeSaveEvent();}),v.execMenuOnce("mt-image-bed-hello-enable",()=>{zt.init();}),v.execMenuOnce("mt-image-bed-mt-enable",()=>{Vt.init();});},handle_error(e){let t=false,i=o.text(o.parseHTML(e,false,false).querySelector("#messagetext"));return !i||typeof i=="string"&&i.trim()==""||Object.keys(It).forEach(n=>{let s=It[n];if(i.indexOf(s.error_match)!=-1){i.indexOf("typeof errorhandle_=='function'")!=-1&&f.error(s.popup_text),t=true;return}}),t},setInputChangeEvent(){const e=this;o.on(e.$el.$input,["input","propertychange"],function(t){e.$el.$input.value===""?(e.$el.$btn_submit.setAttribute("data-text","false"),$("#comiis_foot_menu_beautify li[data-attr='回帖'] input")?.setAttribute("placeholder","发帖千百度，文明第一步")):(e.$el.$btn_submit.setAttribute("data-text","true"),$("#comiis_foot_menu_beautify li[data-attr='回帖'] input")?.setAttribute("placeholder","[草稿待发送]")),o.css(e.$el.$input,"height","70px"),o.css(e.$el.$input,"height",e.$el.$input.scrollHeight-20+"px");});},setInputChangeSaveEvent(){const e=this;o.on(this.$el.$input,["input","propertychange"],t=>{let i=e.$el.$input.value,s=e.$el.$input.closest(".reply_area").querySelector(".reply_user_content").getAttribute("data-reply-url"),a={url:window.location.href,text:i,repquote:s?V.getRepquote(s):void 0,forumId:e.$data.tid};e.$data.db.get("data").then(r=>{if(!r.success||r.code===201){console.warn(r);return}let l=r.data.findIndex(c=>c.forumId===a.forumId&&c.repquote===a.repquote);l!==-1?i==null||i===""?r.data.splice(l,1):r.data[l]=p.assign(r.data[l],{text:a.text}):r.data.push(a),e.$data.db.save("data",r.data).then(c=>{});});});},async initReplyText(e=false,t=void 0){const i=this;(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let s=await this.$data.db.get("data");if(!s.success||s.code===201){console.warn(s);return}let a;t&&(a=V.getRepquote(t));let r=s.data.find(l=>e?l.forumId===i.$data.tid&&l.repquote==a:l.forumId===i.$data.tid&&l.repquote==null);r&&(o.val(this.$el.$input,r.text),p.dispatchEvent(this.$el.$input,"input"));},setLikeBtnClickEvent(){o.on(this.$el.$like,"click",async e=>{if(p.preventEvent(e),b.comiis_recommend_key==0){b.comiis_recommend_key=1;let a=await N.get(this.$el.$like.href+"&inajax=1",{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false});if(!a.status){window.location.href=this.$el.$like.href,setTimeout(function(){b.comiis_recommend_key=0;},500);return}let l=p.parseFromString(a.data.responseText,"text/xml").lastChild?.firstChild?.nodeValue;if(l.includes("您已评价过本主题")){let c=this.$el.$like.href.match(J.tid)[1];if(!(await N.get(`plugin.php?id=comiis_app&comiis=re_recommend&tid=${c}&inajax=1`,{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false})).status){f.error("取消点赞失败，网络异常");return}var t=Number(o.text("#comiis_recommend_num"));document.querySelectorAll(".comiis_recommend_list_a").length>0&&o.remove("#comiis_recommend_list_a"+b.uid),document.querySelectorAll(".comiis_recommend_list_s").length>0&&o.remove("#comiis_recommend_list_s"+b.uid),document.querySelectorAll(".comiis_recommend_list_t").length>0&&o.remove("#comiis_recommend_list_t"+b.uid),t>1?(o.text(".comiis_recommend_num",t-Number(b.allowrecommend)),o.text(".comiis_recommend_nums","+"+(t-Number(b.allowrecommend)))):(o.remove("#comiis_recommend_num"),o.text(".comiis_recommend_nums",""),document.querySelectorAll(".comiis_recommend_list_a").length>0&&(o.empty(".comiis_recommend_list_a"),o.removeClass(".comiis_recommend_list_a","comiis_recommend_list_on")),document.querySelectorAll(".comiis_recommend_list_t").length>0&&o.removeClass(".comiis_recommend_list_t","comiis_recommend_list_on")),o.html(".comiis_recommend_addkey i","&#xe63b;"),o.removeClass(".comiis_recommend_color","f_a"),o.addClass(".comiis_recommend_color","f_b"),document.querySelectorAll(".comiis_recommend_list_s").length>0&&(document.querySelectorAll(".comiis_recommend_list_s li").length<7?o.hide(".txshow_more",false):o.show(".txshow_more",false)),f.success("已取消点赞");}else if(l.includes("您不能评价自己的帖子"))f.error("不能点赞自己的帖子");else if(l.includes("今日评价机会已用完"))f.warning("您今日的点赞机会已用完");else if(l.includes("'recommendv':'+"+b.allowrecommend+"'")){var i={recommendc:0,daycount:0},n;n=l.match(/\'recommendc\':\'(.*?)\'/),n!=null?i.recommendc=parseInt(n[1]):i.recommendc=0,n=l.match(/\'daycount\':\'(.*?)\'/),n!=null?i.daycount=parseInt(n[1]):i.daycount=0,document.querySelectorAll(".comiis_recommend_new span").length<1&&o.append(".comiis_recommend_new",'<span class="bg_del f_f comiis_kmvnum comiis_recommend_num" id="comiis_recommend_num">0</span>');var s=Number(o.text("#comiis_recommend_num"));if(z(".comiis_recommend_list_a").length>0){let c=z(".comiis_recommend_list_a");o.removeClass(c,"comiis_recommend_list_on"),o.addClass(c,"comiis_recommend_list_on"),o.prepend(c,(z(".comiis_recommend_list_a li").length>0?"":'<li style="float:right;margin-right:0;"><a href="misc.php?op=recommend&tid= '+b.tid+'&mod=faq&mobile=2"><span class="bg_b f_c"><em class="comiis_recommend_num">'+s+"</em>赞</span></a></li>")+'<li id="comiis_recommend_list_a'+b.uid+'"><a href="home.php?mod=space&uid='+b.uid+'"><img src="'+V.getAvatar(b.uid,"small")+'"></a></li>');}if(z(".comiis_recommend_list_t").length>0){let c=z(".comiis_recommend_list_t");o.removeClass(c,"comiis_recommend_list_on"),o.addClass(c,"comiis_recommend_list_on"),o.prepend(c,`<span id="comiis_recommend_list_t${b.uid}">
                          							<a href="home.php?mod=space&uid=${b.uid}" class="f_c">${b.username}</a>
													${z(".comiis_recommend_list_t a").length>0?'<span class="f_d"> , </span>':""}
                        						</span>`);}if(z(".comiis_recommend_list_s").length>0){let c=z(".comiis_recommend_list_s");o.removeClass(c,"comiis_recommend_list_on"),o.addClass(c,"comiis_recommend_list_on"),o.prepend(c,(z(".comiis_recommend_list_s li").length>0,""+'<li id="comiis_recommend_list_s'+b.uid+'"><a href="home.php?mod=space&uid='+b.uid+'"><img loading="lazy" src="'+V.getAvatar(b.uid,"small")+'"></a></li>'));}o.text(".comiis_recommend_num",s+Number(b.allowrecommend)),o.text(".comiis_recommend_nums","+"+(s+Number(b.allowrecommend))),o.html(".comiis_recommend_addkey i","&#xe654;"),o.removeClass(".comiis_recommend_color","f_b"),o.addClass(".comiis_recommend_color","f_a"),z(".comiis_recommend_list_s").length>0&&(z(".comiis_recommend_list_s li").length<7?o.hide(".txshow_more",false):o.show(".txshow_more",false)),f.success("点赞成功"+(i.daycount?`, 您今天还能点赞 ${i.daycount-1} 次`:""));}else l.indexOf("window.location.href = 'member.php?mod=logging&action=login&mobile=2'")>=0?window.location.href="member.php?mod=logging&action=login&mobile=2":f.error("没有点赞权限或帖子不存在");setTimeout(function(){b.comiis_recommend_key=0;},500);}return  false});},setSubmitBtnClickEvent(){const e=this;o.on(this.$el.$fastpostsubmit,"click",async t=>{p.preventEvent(t);var i=$("#needmessage"),n=o.val(i);if(n=encodeURIComponent(n),!(n==null||n==="")){if(o.val(e.$el.$fastpostsubmit)=="发表"){let s=f.loading("发表中，请稍后..."),a="message="+n;z("#imglist input[type='hidden']").forEach(d=>{let h=d.getAttribute("name");a+=`&${h}=`;}),a=o.serialize(e.$el.$form)+"&"+a;let r=e.$data.forum_action+"reply&handlekey=fastpost&loc=1&inajax=1",l=await N.post(r,{data:a,fetch:true,allowInterceptConfig:false,headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(s.close(),!l.status){f.error("发表失败，网络异常");return}let m=p.parseFromString(l.data.responseText,"text/xml").lastChild?.firstChild?.nodeValue;if(b.evalscript(m),this.handle_error(m))return;window.scrollTo({top:o.height(document)}),o.val("#needmessage",""),$("#comiis_head")?.click(),o.hide("#comiis_foot_menu_beautify_big .reply_user_content",false),o.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),o.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"),this.deleteReplyTextStorage();}else {let s=o.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-serialize")+n;z("#imglist input[type='hidden']").forEach(m=>{s=`${s}&${m.getAttribute("name")}=`;});let a=o.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-action"),r=await N.post(a+"&handlekey=fastposts&loc=1&inajax=1",{allowInterceptConfig:false,fetch:true,data:s,headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(!r.status){f.error("回复失败，网络异常");return}let c=p.parseFromString(r.data.responseText,"text/xml").lastChild?.firstChild?.nodeValue;if(u.info(c),b.evalscript(c),this.handle_error(c))return;$(c)?.click(),o.val("#needmessage",""),$("#comiis_head").click(),o.val('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"发表"),o.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),o.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"),window.scrollTo({top:o.height(document)}),this.deleteReplyTextStorage(true,a);}return  false}});},setGlobalReplyBtnClickEvent(){o.on(document,"click",'.comiis_postli_times .dialog[href*="reply"]',async e=>{p.preventEvent(e);let t=e.target;o.attr("#comiis_foot_menu_beautify_big","data-model","reply");let i=await N.get(o.attr(t,"datahref")||t.href+"&inajax=1",{fetch:true,allowInterceptConfig:false});if(!i.status){f.error("网络异常，获取回复参数失败");return}let s=p.parseFromString(i.data.responseText,"text/xml").lastChild?.firstChild?.nodeValue;if(this.handle_error(s))return;let a=o.parseHTML(`<div>${s}</div>`,true,false),r=a.querySelector(".comiis_tip .tip_tit a")?.getAttribute("href"),l=o.text(a.querySelector(".comiis_tip span.f_0")),c=o.val(a.querySelector("input[name='noticeauthormsg']")),m=o.attr(a.querySelector("#postforms"),"action"),d=o.serialize(a.querySelector("#postforms"));o.text("#comiis_foot_menu_beautify_big .reply_user_content",`回复 ${l}: ${c}`),o.show("#comiis_foot_menu_beautify_big .reply_user_content",false),$("#comiis_foot_menu_beautify li[data-attr='回帖'] input")?.click(),o.focus("#comiis_foot_menu_beautify li[data-attr='回帖'] input"),o.val("#fastpostsubmitline input","回复"),o.attr("#comiis_foot_menu_beautify_big .fastpostform_new a","href",r),o.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-url",r),o.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-action",m),o.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-serialize",d),yt=t,o.val("#needmessage",o.attr(t,"data-text")||""),v.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{this.initReplyText(true,r);});},{capture:true});},setGlobalClickCheckEvent(){const e=this;let t=$("#fastpostform .header_y a").href;o.on(document,"click",function(i){let n=i.target;if($(".popups-popmenu")||tt.$data.isUBBCodeInsertClick){u.info("点击的是弹出层，不做处理"),tt.$data.isUBBCodeInsertClick=false;return}else n?.classList&&n?.classList?.contains(".dialog_reply")||n?.closest&&n?.closest(".dialog_reply")||n===$('li[data-attr="回帖"] input')?(u.info("点击回复按钮或者是编辑器，显示编辑器"),o.hide("#comiis_foot_menu_beautify",false),o.show("#comiis_foot_menu_beautify_big",false),o.focus("#needmessage")):window.event&&!p.checkUserClickInNode($("#comiis_foot_menu_beautify_big"))&&(u.info("点击的其它区域，隐藏大编辑器，显示小编辑器"),o.show("#comiis_foot_menu_beautify",false),o.hide("#comiis_foot_menu_beautify_big",false),o.attr("#comiis_foot_menu_beautify_big","data-model")=="reply"&&(o.attr("#comiis_foot_menu_beautify_big","data-model","comment"),o.val("#fastpostsubmitline input","发表"),o.attr("#comiis_foot_menu_beautify_big .fastpostform_new a","href",t),o.text("#comiis_foot_menu_beautify_big .reply_area .reply_user_content"),o.hide("#comiis_foot_menu_beautify_big .reply_area .reply_user_content",false),o.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-url",""),o.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-action",""),o.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-serialize",""),yt&&(o.attr(yt,"data-text",o.val("#needmessage")),o.val("#needmessage",""),o.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),o.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"))),o.val(e.$el.$input)===""&&v.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{e.initReplyText();}));});},setMenuIconToggleEvent(){o.on("#comiis_foot_menu_beautify_big .menu_icon a i","click",function(e){let t=this;t.classList.contains("f_0")?(o.hide("#comiis_foot_menu_beautify_big .menu_body",false),o.removeClass("#comiis_foot_menu_beautify_big .menu_icon a i","f_0")):(o.show("#comiis_foot_menu_beautify_big .menu_body",false),o.removeClass("#comiis_foot_menu_beautify_big .menu_icon a i","f_0"),o.addClass(t,"f_0"));});},setMenuImageClickEvent(){o.on("#comiis_foot_menu_beautify_big .menu_icon a.comiis_pictitle","click",function(e){o.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",false),o.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",false),o.show("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",false);});},setMenuImageToggleEvent(){o.on("#comiis_foot_menu_beautify_big #comiis_pictitle_tab #comiis_pictitle_key","click","li",function(e){let t=e.target;o.removeClass("#comiis_foot_menu_beautify_big #comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),o.addClass(t,"bg_f"),b.$("#comiis_foot_menu_beautify_big #comiis_pictitle_tab div.comiis_upbox").hide().eq(b.$(t).index()).fadeIn();});},setMenuSmileClickEvent(){o.on("#comiis_foot_menu_beautify_big .menu_icon a.comiis_smile","click",function(e){o.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",false),o.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",false),o.show("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",false);let t=$("#comiis_foot_menu_beautify_big .menu_body .comiis_bqbox");o.attr(t,"data-isLoaded")!=1&&(o.attr(t,"data-isLoaded",1),t.querySelectorAll("img").forEach(i=>{let n=i.getAttribute("data-src");n&&i.setAttribute("src",n);}));});},setMenuSmileTabClickEvent(){o.on("#comiis_foot_menu_beautify_big #comiis_smilies_key li","click",function(e){let t=this;o.removeClass("#comiis_foot_menu_beautify_big #comiis_smilies_key li a"),o.addClass(t.querySelector("a"),"bg_f b_l b_r"),b.$("#comiis_post_tab div.swiper-wrapper.bqbox_c.comiis_optimization .swiper-slide").hide().eq(b.$(t).index()).fadeIn();});},setMenuInsertClickEvent(){o.on("#comiis_foot_menu_beautify_big .menu_icon a.commis_insert_bbs","click",e=>{o.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",false),o.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",false),o.show("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",false);});},async getReplyRecordSize(){let e=await this.$data.db.get("data");return e.success?p.getTextStorageSize(e?.data?.length?JSON.stringify(e.data):""):p.formatByteToSize(0)},async clearAllReplyRecord(){return await this.$data.db.deleteAll()},deleteReplyTextStorage(e=false,t=void 0){const i=this;this.$data.db.get("data").then(n=>{if(!n.success||n.code===201){console.warn(n);return}let s=n.data.findIndex(a=>e?a.forumId===i.$data.tid&&t&&a.repquote===V.getRepquote(t):a.forumId===i.$data.tid&&p.isNull(a.repquote));s!==-1&&(n.data.splice(s,1),this.$data.db.save("data",n.data).then(a=>{}));});},setMenuQuickUBB(){let e=$("#comiis_insert_ubb_tab_list"),t=Nt();Reflect.set(t,"code",{key:"代码",value:"[code][/code]",tagL:"]",tagR:"[",L:"[code]",R:"[/code]",cursorL:"[code]",cursorLength:7,quickUBBReplace:"[code]replace[/code]"}),Reflect.set(t,"password",{key:"密码",value:"[password][/password]",tagL:"]",tagR:"[",L:"[password]",R:"[/password]",cursorL:"[password]",cursorLength:10,quickUBBReplace:"[password]replace[/password]"}),Object.keys(t).forEach(i=>{let n=t[i],s=o.createElement("li",{className:"quickUBBs",innerHTML:`
                    <a href="javascript:;" class="comiis_xifont f_d">
                        <i class="comiis_font"></i>${n.key}
                    </a>
                `});o.on(s,"click",a=>{o.removeClass("#comiis_insert_ubb_tab div.comiis_post_urlico ul li.quickUBBs a.comiis_xifont","f_0"),o.addClass("#comiis_insert_ubb_tab div.comiis_post_urlico ul li.quickUBBs a.comiis_xifont","f_d");let r=s.querySelector(".comiis_xifont");o.removeClass(r,"f_d"),o.removeClass(r,"f_d");let l=D.prompt({title:{text:"UBB代码",position:"center"},content:{text:"",placeholder:`请输入需要${n.key}的文字`,focus:true},btn:{ok:{text:"插入",type:"primary",callback:c=>{if(c.text.trim()===""){f.error("输入框不能为空或纯空格");return}n.isFunc?b.comiis_addsmilies(Bt(n.num,c.text)):n.quickUBBReplace?b.comiis_addsmilies(n.quickUBBReplace.replaceAll("replace",c.text)):b.comiis_addsmilies(c.text),l.close();}},cancel:{text:"关闭",callback:()=>{l.close();}}},width:"300px",height:"200px"});}),e.append(s);});}},Ut={$flag:{isSetHljsCSS:false},init(){v.execMenuOnce("mt-forum-post-autoExpandContent",()=>this.autoExpandContent()),v.execMenuOnce("mt-forum-post-repairImageWidth",()=>this.repairImageWidth()),o.ready(()=>{v.execMenu("mt-forum-post-removeFontStyle",()=>{this.removeFontStyle();}),v.execMenu("mt-forum-post-removeCommentFontStyle",()=>{this.removeCommentFontStyle();}),v.execMenu("mt-forum-post-addCommentOnBtn",()=>{this.addCommentOnBtn();}),v.execMenuOnce("mt-forum-post-loadNextPageComment",()=>{this.loadNextPageComment();}),v.execMenuOnce("mt-forum-post-codeQuoteOptimization",()=>{this.codeQuoteOptimization();}),v.execMenuOnce("mt-forum-post-editorOptimizationNormal",()=>{tt.init();}),v.execMenu("mt-forum-post-optimizationImagePreview",()=>{this.optimizationImagePreview();}),v.execMenuOnce("mt-forum-post-setAttachmentsClickTip",()=>{this.setAttachmentsClickTip();});});},autoExpandContent(){return u.info("自动展开帖子内容"),G(`
        ...
        .comiis_messages img{
            max-width: 100% !important;
						...
						`,true,false);o.on(d,"click",function(){p.waitNode("div[id=ntcmsg_popmenu]>div>span.f_c").then(h=>{try{h.innerText="点评 "+m;}catch(_){u.error("修改点评失败",_);}});}),o.prepend(t,d);}});});},loadNextPageComment(){if(u.info("自动加载下一页评论"),document.title.includes("提示信息 - MT论坛"))return;function e(){return $("#loading-comment-tip")}function t(){return $("#loading-comment-tip").parentElement}function i(c){let m=e(),d=t();o.css(d,"display","");let _=Array.from(c.querySelectorAll("a[href]")).find(S=>S.textContent?.trim()==="下一页").href;if(u.info("获取下一页url：",_),_.includes("javascript:;")){u.info("暂无下一页的评论"),o.remove(d);return}function g(){o.remove(".comiis_page.bg_f"),o.remove(d),o.off(m,"click",y),o.off(window,"scroll",k.run);}async function y(){o.text(m,"正在加载评论中..."),o.css(d,"display",""),u.info("请求下一页评论："+_);let S=_,C=await N.get(S,{fetch:true});if(!C.status)return;let A=o.parseHTML(C.data.responseText,true,true),E=$(".comiis_postlist.kqide"),L=A.querySelector(".comiis_postlist.kqide"),F=A.querySelector(".nxt"),U=F?.getAttribute("href")||F?.href;if(U){if(u.success("成功获取到下一页评论"),U===_){u.warn("获取到下一页评论的url和上次请求的url相同，判定为已加载完全部评论，移除监听事件"),g();return}_=U;}else u.error("评论全部加载完毕，移除监听事件"),g();let j=F?.parentElement.querySelector("strong");if(j){let O=$("#select_a");if(O){let w=Array.from(O.childNodes).find(x=>x.nodeName==="#text");w&&(w.textContent=`第 ${j.textContent} 页`);}}v.execMenu("mt-forum-post-syncNextPageUrl",()=>{if(window===top?.window){let O=new URL(S),w=`${O.pathname}${O.search}`;window.history.pushState("forward","",w);}}),o.append(E,L),Ut.init();}var k=new p.LockFunction(async()=>{p.isNearBottom(50)&&await y();});o.text(m,"请上下滑动或点击加载"),o.on(window,"scroll",k.run),o.on(m,"click",y),k.run();}let s=o.parseHTML(`
		<div class="comiis_multi_box bg_f b_t">
			<label class="comiis_loadbtn bg_e f_d" id="loading-comment-tip">正在等待页面加载完毕</label>
		</div>`,true,false),a=$(".comiis_bodybox");o.append(a,s);let r=$(".comiis_pltit span.f_d")||$("#comiis_foot_memu .comiis_kmvnum");if($(".comiis_pltit h2")&&$(".comiis_pltit h2")?.textContent.includes("暂无评论")){o.remove(t()),u.info("暂无评论");return}parseInt(r.textContent)>=10?p.waitNode(".comiis_page.bg_f").then(c=>{i(c);}):(o.remove(t()),u.info("无多页评论"));},codeQuoteOptimization(){u.info("代码块优化");function e(i){var n=["add","and","cmp","cmpg","cmpl","const","div","double","float","goto","if","int","long","move","mul","neg","new","nop","not","or","rem","return","shl","shr","sput","sub","throw","ushr","xor"],s=["aget","aput","array","check","execute","fill","filled","goto/16","goto/32","iget","instance","invoke","iput","monitor","packed","sget","sparse"],a=["transient","constructor","abstract","final","synthetic","public","private","protected","static","bridge","system"];return {aliases:["smali"],contains:[{className:"string",begin:'"',end:'"',relevance:0},i.COMMENT("#","$",{relevance:0}),{className:"keyword",variants:[{begin:"\\s*\\.end\\s[a-zA-Z0-9]*"},{begin:"^[ ]*\\.[a-zA-Z]*",relevance:0},{begin:"\\s:[a-zA-Z_0-9]*",relevance:0},{begin:"\\s("+a.join("|")+")"}]},{className:"built_in",variants:[{begin:"\\s("+n.join("|")+")\\s"},{begin:"\\s("+n.join("|")+")((\\-|/)[a-zA-Z0-9]+)+\\s",relevance:10},{begin:"\\s("+s.join("|")+")((\\-|/)[a-zA-Z0-9]+)*\\s",relevance:10}]},{className:"class",begin:`L[^(;:
			...
			`),o.on(document,"click",".reader-copy-button",async function(i){p.preventEvent(i);let n=i.target,s=$(n.getAttribute("data-code-selector"));return await p.setClip(s.outerText||s.innerText),f.success("已复制到剪贴板"),false})),z(".comiis_blockcode.comiis_bodybg").forEach(i=>{if(i.getAttribute("data-copy"))return;i.setAttribute("data-copy","true");let n=o.createElement("div",{innerHTML:`
					...
					复制
					</span>`},{style:"height: 34px;margin: 14px 0px;display: inline-flex;align-items: flex-end;"});o.before(i,n);function s(d,h="java"){d.oldValue||(d.oldValue=d.textContent),d.innerHTML=ut.highlight(d.oldValue,{language:h}).value.replace(/\\n$/gi,"");}let a=ut.highlightAuto(i.textContent).language,r=document.createElement("div"),l=document.createElement("select"),c=ut.listLanguages().sort();c=c.concat("自动检测");let m="";c.forEach(d=>{d.startsWith("自动检测")?m+=`<option data-value="${a}" selected="selected">${d}(${a})</option>`:m+=`<option data-value="${d}">${d}</option>`;}),l.className="code-select-language",l.innerHTML=m,o.on(l,"change",function(){let d=l.selectedOptions[0].getAttribute("data-value");l.setAttribute("aria-label",d),u.info("切换代码块语言: ",d),i.querySelectorAll("li").forEach(h=>{s(h,d);});}),p.preventEvent(l,"click"),r.appendChild(l),n.append(r),p.dispatchEvent(l,"change"),i.className="hljs",i.firstChild.removeAttribute("class"),n.querySelector(".reader-copy-button").setAttribute("data-code-selector",p.getElementSelector(i));});},optimizationImagePreview(){u.info("图片查看优化");function e(i=[],n=0){let s="";i.forEach(l=>{s+=`<li><img data-src="${l}"></li>`;});let a=o.createElement("ul",{innerHTML:s}),r=new Mt(a,{inline:false,url:"data-src",zIndex:p.getMaxZIndex()+100,hidden:()=>{r.destroy();}});u.info("查看的图片的下标",n),r.view(n),r.zoomTo(1),r.show();}let t=[{hostName:"avatar-bbs.mt2.cn",pathName:"*"},{hostName:"cdn-bbs.mt2.cn",pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"/uc_server/avatar.php"}];p.waitNodeList("div.comiis_postlist.kqide .comiis_postli:not([data-isHandlingViewIMG])").then(i=>{i.forEach(n=>{n.setAttribute("data-isHandlingViewIMG","true");let s=[];n.querySelectorAll("img").forEach(a=>{let r=a.src,l=new URL(r).hostname,c=new URL(r).pathname,m=a.parentElement;m.nodeName.toLowerCase()==="span"&&m.removeAttribute("onclick"),m.nodeName.toLowerCase()==="a"&&m.getAttribute("href")===r&&(m.setAttribute("href","javascript:;"),m.removeAttribute("target"));let d=false;for(let h of t)if(l.indexOf(h.hostName)!=-1&&c.match(h.pathName)){d=true;break}d||(s=[...s,r],o.on(a,"click",function(){u.info("点击图片",a);let h=s.findIndex(_=>_==r);e(s,h);}));}),s.length&&u.info("处理的图片",s);});});},setAttachmentsClickTip(){u.info("附件点击提醒");function e(t){if(t.hasAttribute("href")){let i=t.getAttribute("href"),n=t.querySelector("span.f_ok"),s=t.querySelector(".attach_size");if(o.text(s).indexOf("金币")===-1)return;u.info("发现附件",t),u.info("该附件是金币附件，拦截！");let a=o.text(n);t.setAttribute("data-href",t.getAttribute("href")),t.removeAttribute("href"),n.innerText="【已拦截】"+a,t.onclick=function(){u.info("附件url：",i),D.confirm({title:{text:"提示",position:"center"},content:{text:`<br />确定花费2金币下载附件 <a style="color: #507daf !important;">${a}</a> ？<br /><br />`,html:true},btn:{ok:{callback:r=>{window.open(i,"_blank"),r.close();}}},mask:{enable:true},width:"88vw",height:"200px"});};}}p.mutationObserver(document.documentElement,{callback:()=>{z(".attnm a").forEach(t=>{e(t);}),z(".comiis_attach a").forEach(t=>{e(t);});},config:{childList:true,subtree:true}}),p.waitNodeList(".attnm a").then(t=>{t.forEach(i=>{e(i);});}),p.waitNodeList(".comiis_attach a").then(t=>{t.forEach(i=>{e(i);});});}},ce={init(){G(`
		/* 去除搜索框的蒙版 */
        #comiis_search_noe{
        ...
        `),Z.ready(()=>{v.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),v.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),v.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){u.info("显示搜索历史");let e=K("search_history",[]),t=$("#scform_srchtxt"),i=$("#searchform"),n=D.searchSuggestion({target:t,inputTarget:t,data:e,getItemHTML:function(r){return r},getData(r){return e.filter(l=>l.includes(r))},deleteIcon:{enable:true,callback(r,l,c){let m=e.findIndex(d=>d===c);m!==-1&&(e.splice(m,1),W("search_history",e)),l.remove();}},itemClickCallBack(r,l,c){t.value=c,i.submit();}});n.init(),n.setAllEvent();function s(){let r=document.querySelector("#scform_submit");Z.on(r,"click",function(){let l=t.value;if(l!=""){let c=K("search_history",[]);c.includes(l)?u.info("已有该搜索历史记录"):(u.info("无该记录，追加"),c.push(l)),W("search_history",c);}});}function a(){let l='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+K("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    ...
                    min-width: 20vw;
                    width: 20vw;
                ">清理记录</button></div>`;Z.before(document.querySelector(".comiis_p12"),l);let c=document.querySelector(".btn_clear_search_history");Z.on(c,"click",m=>{p.preventEvent(m),st("search_history"),window.location.reload();});}s(),a();},repairClearBtn(){p.waitNode("a.ssclose").then(e=>{u.info("修复清空按钮"),Z.on(e,"click",t=>{let i=document.querySelector("#scform_srchtxt");i?i.value="":f.error("获取输入框失败");},{capture:true});});},searchInputAutoFocus(){new URLSearchParams(window.location.search).has("kw")||p.waitNode("#scform_srchtxt").then(t=>{u.info("搜索框自动获取焦点"),t.focus();});}},me={init(){o.ready(()=>{v.execMenuOnce("mt-sign-showTodaySignStar",()=>{this.showTodaySignStar();}),v.execMenuOnce("mt-sign-showTodayRanking",()=>{this.showTodayRanking();});});},async showTodaySignStar(){u.info("显示【今日签到之星】");let e=document.querySelector(".pg_k_misign .comiis_qdinfo"),t=document.createElement("ul"),i=await N.get("/k_misign-sign.html",{headers:{"User-Agent":p.getRandomPCUA()}});if(!i.status)return;let s=o.parseHTML(i.data.responseText,true,true).querySelector("#pt span.xg1");if(!s)return;let a=o.text(s).replace("今日签到之星：","");t.innerHTML=`
		...
		.pg_k_misign .comiis_qdinfo{
			height: 110px !important;
		}`),e.append(t);},showTodayRanking(){u.info("显示【今日最先】");let e=document.querySelector(".comiis_topnv .comiis_flex .flex"),t=o.createElement("li",{className:"flex"}),i=o.createElement("a",{id:"k_misignlist_today_latest",href:"javascript:;",innerHTML:"今日最先"},{onclick:"ajaxlist('todayLatest');"});t.appendChild(i),o.after(e,t);let n=async r=>{let l=await N.get(`/k_misign-sign.html?operation=${r}`,{responseType:"html",headers:{"User-Agent":p.getRandomPCUA()}});if(!l.status)return;let m=o.parseHTML(l.data.responseText,true,true).querySelector("#J_list_detail .pg span");if(m&&typeof m.title<"u"){let d=m.title.match(/([0-9]+)/);if(d&&d.length==2)return parseInt(d[d.length-1]);f.error("获取页失败");}else f.error("请求最先签到的页失败");},s=async r=>{let l=await N.get(`/k_misign-sign.html?operation=list&op=&page=${r}`,{responseType:"html",headers:{"User-Agent":p.getRandomPCUA()}});if(!l.status)return;let m=o.parseHTML(l.data.responseText,true,true).querySelectorAll("#J_list_detail tbody tr"),d=[];if(m.length==2&&m[0].textContent.indexOf("暂无内容")!=-1)return d;for(let h=1;h<=m.length-2;h++){let _=m[h],g={user:"",uid:"",avatar:"",days:"",monthDays:"",time:"",reward:""},y=_.children[0].getElementsByTagName("a")[0].textContent,S=_.children[0].getElementsByTagName("a")[0].href.match(/space-uid-([0-9]*)/)[1],C=_.children[1].textContent,A=_.children[2].textContent,E=_.children[3].textContent,L=_.children[5].textContent;g.user=y,g.uid=S,g.avatar=V.getAvatar(S,"small"),g.days=C,g.monthDays=A,g.time=E,g.reward=L,d.push(g);}return d};function a(r,l){let c=document.querySelector("#ranklist");o.html(c,r),o.attr(c,"listtype",l);}b.ajaxlist=async r=>{if(r=r,r=="today"?(loadingdelay=false,urlextra="list&op=today"):r=="month"?(loadingdelay=false,urlextra="list&op=month"):r=="zong"?(loadingdelay=false,urlextra="list&op=zong"):r=="calendar"?(loadingdelay=true,urlextra="calendar"):(loadingdelay=false,urlextra="list"),r=="todayLatest"){loadingdelay=false,urlextra="list&op=&page=0";let l=await n(urlextra);if(!l)return;let c=await s(l);if(c.reverse(),c.length<10){let h=await s(l-1);h.reverse(),c=c.concat(h),c.reverse();}let m="";c.reverse(),c.forEach(h=>{m=m+`
					...
					</div>`;a(d,r);}else N.get(`plugin.php?id=k_misign:sign&operation=${urlextra}`,{responseType:"html",fetch:true}).then(l=>{let c=l.data.responseText;c=c.replace("今日排行</a></li>",`今日排行</a></li>
							<li class="flex">
								...
								`)),a(c,r);});};}},de={init(){v.execMenuOnce("mt-space-repairEnterSpace",()=>{this.repairEnterSpace();}),o.ready(()=>{v.execMenuOnce("mt-space-showCommentContent",()=>{this.showCommentContent();});});},repairEnterSpace(){if(u.info("修复无法进入空间"),T.isSpace()){let e=window.location.href.match(/home.php\?(.+)/gi),t=e[e.length-1];t.split("&").length==2&&t.indexOf("uid=")!=-1&&t.indexOf("mod=space")!=-1&&(window.location.href=window.location.href+"&do=profile");}else if(T.isSpaceWithAt()){let e=window.location.href.match(/space-uid-(.+).html/i),t=e[e.length-1];window.location.href=`${window.location.origin}/home.php?mod=space&uid=${t}&do=profile`;}},async showCommentContent(){u.info("显示帖子回复内容"),G(`
		div.contrete-reply{padding:5px 10px;border-top:1px solid #f3f3f3}
		div.contrete-reply a{margin:0 10px}
		`);async function e(){let r=await N.get(window.location.href,{headers:{"User-Agent":p.getRandomPCUA()}});if(!r.status)return;let l=o.parseHTML(r.data.responseText,true,true),c=[];return l.querySelectorAll("#delform tr.bw0_all+tr").forEach(m=>{let d=[],h=m.querySelector("td"),_=o.html(h).replace(/^&nbsp;/,"");d.push(_);let g=o.next(m),y=l.querySelectorAll("#delform tr");for(let k=0;k<y.length&&!(!g||o.attr(g,"class")==="bw0_all");k++){let S=g.querySelector("td"),C=o.html(S).replace(/^&nbsp;/,"");d=d.concat(C),g=o.next(g);}c.push(...d);}),c}function t(){return p.getNodeListValue(H.comiisForumList(),H.comiisPostli(),H.comiisMmlist())}function i(r){let l={};return r.forEach(c=>{let d=o.createElement("div",{innerHTML:c}).querySelector("a")?.getAttribute("href"),h=d.match(J.ptid),_=d.match(J.pid);if(!h){f.error("获取ptid失败");return}if(!_){f.error("获取pid失败");return}let g=h[h.length-1],y=_[_.length-1];l[g]?l[g].data.push(c):l[g]={ptid:g,pid:y,data:[c]};}),l}var n=await e();if(n==null)return;var s=i(n);t().forEach((r,l)=>{let m=r.querySelector(".comiis_xznalist_bottom a").getAttribute("tid");if(!m){f.error("获取帖子tid失败"),u.error(r);return}s[m]&&s[m].data.forEach(d=>{o.append(r,`<div class="contrete-reply">${d}</div>`);});});}},lt={$key:{tipData:"tipToFreeSubjectForumPost"},init(){this.registerMenu();let e=this.getTipData();if(T.isPost()&&document.querySelector("span.kmren")){u.info("当前帖子存在需要购买主题");let a=false,r;e.forEach((c,m)=>{if(window.location.href.match(c.url)){a=true;return}}),a?(u.warn("已设置提醒"),r=o.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                        <i class="comiis_font" style="color: #ffffff;"></i>
                        `}),o.on(r,"click",function(){D.confirm({title:{text:"提示",position:"center"},content:{text:"<p>确定移出付费主题白嫖列表？</p>",html:true},btn:{ok:{callback:function(){let c=e.findIndex((m,d)=>window.location.href.match(m.url));c!==-1?(e.splice(c,1),lt.setTipData(e),f.success("移除成功")):f.error("移除失败");}}},width:"88vw",height:"300px"});})):(u.info("未设置提醒"),r=o.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                        <i class="comiis_font" style="color: #FF9900;"></i>
                        `}),o.on(r,"click",()=>{let c=document.querySelector(".kmren"),m=o.parent(c),d=o.text(m).replace(/\t|\n/g,"").match(/[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]{1}[0-9]{1,2}:[0-9]{1,2}/);if(!d||d.length==0){f.error("获取付费主题到期时间失败");return}let h=d[0],_=p.formatToTimeStamp(h);e.push({url:window.location.href,title:document.title.replace(" - MT论坛",""),expirationTime:h,expirationTimeStamp:_,isVisited:false}),W("tipToFreeSubjectForumPost",e),f.success("添加成功"),setTimeout(function(){window.location.reload();},1500);}));let l=document.querySelector(".comiis_head.f_top .header_y");o.append(l,r);}function t(){let s=0;return Array.from(lt.getTipData()).forEach((a,r)=>{new Date().getTime()>a.expirationTimeStamp&&a.isVisited==false&&(s+=1);}),s}if(T.isMySpace()||T.isGuide()||T.isForumList()||T.isPlate()){let s=document.querySelector(".icon_msgs.bg_del.f_f"),a=0;s?(a=parseInt(o.text(s)),o.html(s,(a+t()).toString()),o.append(".comiis_head .header_z .kmuser em",'<span class="icon_msgs bg_del"></span>')):t()&&o.append(".comiis_head .header_z .kmuser em",'<span class="icon_msgs bg_del"></span>');}let i=document.querySelector(".sidenv_num.bg_del.f_f"),n=0;if(i)n=parseInt(o.text(i)),o.html(".sidenv_num.bg_del.f_f",(n+t()).toString());else {let s=t();s&&o.before(".sidenv_user em",`<span class="sidenv_num bg_del f_f">${s}</span>`);}t()&&o.append(".comiis_left_Touch .paymentsubjectreminder div.flex",`
                <span class="sidenv_num bg_del f_f" style="
                    ...
                    display: inline-flex;
                    bottom: 8px;
                "></span>`);},registerMenu(){H.registerLeftMenu({name:"付费主题白嫖提醒",icon:"",iconColor:"#ec0000",callback:()=>{this.showView();}});},showView(){u.info("显示白嫖列表");let e=lt.getTipData();D.alert({title:{text:"付费主题白嫖列表",position:"center"},content:{text:"",html:true},btn:{ok:{text:"关闭",type:"default"}},width:"88vw",height:"88vh"});let t="",i=0,n="",s="",a=[],r=[],l=[];e.forEach((g,y)=>{let k="#f91212",S="";new Date().getTime()>g.expirationTimeStamp&&(k="#1e90ff",g.isVisited||(S=`
                ...
                </tbody>`,timestamp:g.expirationTimeStamp};new Date().getTime()>g.expirationTimeStamp?S!=""?a.push(C):r.push(C):l.push(C);}),u.info("可白嫖但未访问：",a),u.info("可白嫖：",r),u.info("未到白嫖时间：",l),p.sortListByProperty(a,"expirationTimeStamp",false),p.sortListByProperty(r,"timestamp",false),p.sortListByProperty(l,"timestamp",false),u.info("排序后——可白嫖但未访问：",a),u.info("排序后——可白嫖：",r),u.info("排序后——未到白嫖时间：",l),n=p.mergeArrayToString(a,"content")+p.mergeArrayToString(r,"content"),s=p.mergeArrayToString(l,"content"),i>0&&(t=`
        ...
        `,d=document.querySelector(".msgcon");o.html(d,""),o.append(d,c),o.append(d,m),o.css(d,"height","400px"),o.on(document.querySelector(".delsubjecttip i.comiis_font"),"click",g=>{let y=g.target,k=o.parent(y);var S=parseInt(k.getAttribute("t-index"));D.confirm({title:{text:"提示",position:"center"},content:{text:"<p>确定移出付费主题白嫖列表？</p>",html:true},btn:{ok:{callback:C=>{e.splice(S,1),lt.setTipData(e),p.deleteParentNode(y,"tr"),C.close();}}},width:"80vw",height:"300px"});});let h=document.querySelector("#paymentSubjectReminderIsFreeList");o.on(h,"click","a",g=>{let y=g.target;var k=parseInt(y.getAttribute("t-index")),S=y.getAttribute("t-href");if(e[k].isVisited=true,lt.setTipData(e),window.open(S,"_blank"),y.setAttribute("style","color: #000000;"),y?.parentElement?.parentElement?.children[0].className!="icon_msgs bg_del")return;y.parentElement.parentElement.children[0].remove(),o.append(h,y?.parentElement?.parentElement?.parentElement?.parentElement?.parentElement);let C=document.querySelector(".subjectcanvisit summary span.icon_msgs.bg_del.f_f"),A=o.text(C),E=parseInt(A)-1;E>0?o.html(C,E.toString()):C.remove();});let _=document.querySelector("paymentSubjectReminderIsPaidList");o.on(_,"click","a",g=>{let y=g.target;y.getAttribute("t-index");var k=y.getAttribute("t-href");window.open(k,"_blank"),y.setAttribute("style","color: #000000;");});},getTipData(){return K(this.$key.tipData,[])},setTipData(e){W(this.$key.tipData,e);}},pe=`.pops {\r
	--icon-width: 24px;\r
...
`;class ue{isBacking=false;config;constructor(t){this.config=t,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(t){Y.preventEvent(t),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){u.success("进入手势模式");let t=this.config.hash;t.startsWith("#")||(t.startsWith("/")||(t="/"+t),t="#"+t),this.config.useUrl&&(t=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+t),this.config.win.history.pushState({},"",t),u.success("监听popstate事件"),o.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(t=false){this.isBacking=true,u.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(t);let i=Date.now()+1e3*5;for(;;){if(Date.now()>i){u.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))u.info("history.back()"),this.config.win.history.back(),await Y.sleep(this.config.backDelayTime||150);else break}u.success("移除popstate事件"),o.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(t);}}const rt={https:`
        ...
        <div class="small-window-title-container">
        ...
        </div>`,r=D.drawer({title:{enable:true,text:a,html:true,style:"height: auto;line-height: normal;"},content:{text:`
                <iframe scrolling="auto" allowtransparency="true" frameborder="0" src="${t}" style="width:100%; height:100%;">
                </iframe>
                `,html:true},mask:{enable:true,clickEvent:{toClose:true},clickCallBack(L,F){E.quitGestureBackMode();}},btn:{ok:{enable:false},cancel:{enable:false},close:{enable:false}},direction:"bottom",size:"92%",borderRadius:18,style:pe}),l=r.$shadowRoot.querySelector(".small-window-website-icon"),c=r.$shadowRoot.querySelector(".refresh-icon"),m=r.$shadowRoot.querySelector(".small-window-control-image-view"),d=r.$shadowRoot.querySelector(".small-window-control-open-blank"),h=r.$shadowRoot.querySelector(".small-window-control-close"),_=r.$shadowRoot.querySelector(".small-window-title-text");this.$el.$refreshIcon=c,this.$el.$webSiteIcon=l;let g=r.$shadowRoot.querySelector("iframe"),y=r.$shadowRoot.querySelector(".small-window-drag"),k=D.config.Utils.AnyTouch(),S=new k(y),C=r.popsElement,A=o.height(C);S.on("pan",L=>{L.phase=="move"&&L.displacementY>0&&(C.style.transition="none",C.style.height=Math.abs(A-L.distanceY)+"px"),L.isEnd&&(C.style.transition="0.2s ease-in",parseInt(C.style.height)>window.innerHeight/2?C.style.height=A+"px":r.close());});let E=new ue({hash:this.$key.smallWindow,useUrl:true,win:b,beforeHistoryBackCallBack:L=>{r.close();}});E.enterGestureBackMode(),o.on(_,"click",L=>{p.preventEvent(L),p.setClip(`『${e}』 - ${t}`),f.success("已复制链接");}),o.on(m,"click",L=>{p.preventEvent(L),u.info("查看图片",i);var F="";i.forEach(O=>{F+=`<li><img data-src="${O}"></li>`;});var U=o.parseHTML(`<ul>${F}</ul>`,false,false);let j=new Mt(U,{inline:false,url:"data-src",zIndex:(()=>{let O=p.getMaxZIndex(),w=D.config.InstanceUtils.getPopsMaxZIndex().zIndex;return p.getMaxValue(O,w)+100})(),hidden:()=>{j.destroy();}});j.zoomTo(1),j.show();}),o.on(h,"click",L=>{p.preventEvent(L),E.quitGestureBackMode();}),o.on(d,"click",L=>{p.preventEvent(L),window.open(t,"_blank");}),o.on(l,"click",L=>{p.preventEvent(L),g.contentWindow.location.reload(),this.checkIframeReadyState(g);}),this.checkIframeReadyState(g);},async handleForumPost(e){e.forEach(t=>{if(t.getAttribute("data-injection-small-window"))return;let i=o.text(t.querySelector(".mmlist_li_box h2 a"));(i==""||i==null)&&(i=o.text(t.querySelector(".mmlist_li_box a"))),i=i.trim();let n=t.querySelector(".mmlist_li_box a").href;var s=[];t.setAttribute("data-injection-small-window","true"),t.setAttribute("data-injection-small-window-url",n),t.setAttribute("data-injection-small-window-title",i),t.querySelectorAll(".comiis_pyqlist_img img").forEach(r=>{s.push(r.getAttribute("src"));}),t.querySelectorAll(".comiis_pyqlist_imgs img").forEach(r=>{s.push(r.getAttribute("src"));}),t.querySelectorAll(".mmlist_li_box a").forEach(r=>{r.removeAttribute("href"),r.setAttribute("data-href",n);});let a=t.querySelector(".mmlist_li_box");o.on(a,"click",function(r){var l=Number(r.clientX);document.body.offsetWidth/2>l?window.location.href=n:Ft.showSmallWindow(i,n,s);});});},checkIframeReadyState(e){this.showRefreshIcon();let t=setInterval(()=>{e.contentWindow&&(clearInterval(t),o.createDOMUtils({document:e.contentWindow.document,window:e.contentWindow,globalThis:e.contentWindow,self:e.contentWindow,top}).ready(()=>{u.success("小窗内容已加载完毕"),this.hideRefreshIcon();}));},400);},hideRefreshIcon(){this.$el.$refreshIcon.style.display="none",this.$el.$webSiteIcon.style.display="";},showRefreshIcon(){this.$el.$refreshIcon.style.display="",this.$el.$webSiteIcon.style.display="none";}},ge={init(){Z.ready(()=>{v.execMenuOnce("mt-guide-showLatestPost",()=>{this.showLatestPost();});});},showLatestPost(){u.info("显示最新帖子");async function e(){let t=await N.get("/forum.php?mod=guide&view=hot",{fetch:true,allowInterceptConfig:false});if(!t.status){f.error("获取轮播失败");return}if(t.data.responseText.indexOf('<script src="/_guard/auto.js"><\/script>')!==-1){f.error("获取轮播失败 未知的/_guard/auto.js文件");return}var i=Z.parseHTML(t.data.responseText,true,true),n=i.querySelectorAll('div.comiis_mh_kxtxt div[id*="comiis_mh_kxtxt"] ul');if(n.length===0){f.error("获取轮播失败");return}else {var s=[];n[n.length-1].querySelectorAll("a").forEach(a=>{s.push({href:a.getAttribute("href"),title:a.getAttribute("title")});});}return s}e().then(t=>{if(!t)return;G(`
            ...
            `);var i="";p.sortListByProperty(t,s=>{var a=s.href.match(/thread-(.+?)-/i);return parseInt(a[a.length-1])},true),u.info("导读内容",t),t.forEach(s=>{i+=`
                <li>
                    <span>新帖</span>
                    <a href="${s.href}" title="${s.title}" target="_blank">${s.title}</a>
                </li>`;});let n=document.querySelector(".comiis_forumlist.comiis_xznlist");Z.before(n,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}},bt={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new Y.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,i){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=i,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,M,t);}},B=function(e,t,i,n,s,a="",r,l,c){let m={text:e,type:"input",isNumber:!!r,isPassword:!!l,attributes:{},props:{},description:n,afterAddToUListCallBack:c,getValue(){return this.props[M].get(t,i)},callback(d,h,_){this.props[M].set(t,h);},placeholder:a};return Reflect.set(m.attributes,et,t),Reflect.set(m.attributes,it,i),bt.initComponentsStorageApi("input",m,{get(d,h){return v.getValue(d,h)},set(d,h){v.setValue(d,h);}}),m},I=function(e,t,i,n,s,a){let r={text:e,type:"switch",description:s,attributes:{},props:{},getValue(){return !!this.props[M].get(t,i)},callback(l,c){let m=!!c;u.success(`${m?"开启":"关闭"} ${e}`),this.props[M].set(t,m);},afterAddToUListCallBack:a};return Reflect.set(r.attributes,et,t),Reflect.set(r.attributes,it,i),bt.initComponentsStorageApi("switch",r,{get(l,c){return v.getValue(l,c)},set(l,c){v.setValue(l,c);}}),r};class Ot{option;constructor(t){this.option=t;}async showView(){let t=D.confirm({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `}),i=t.$shadowRoot.querySelector(".filter-container"),n=document.createDocumentFragment();this.option.filterOption.forEach(s=>{let a=document.createElement("button");a.innerText=s.name;let r=async()=>{(await this.option.getAllRuleInfo()).forEach(async c=>{await s.filterCallBack(c.data)?o.show(c.$el,false):o.hide(c.$el,false);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),t.close();};o.on(a,"click",async l=>{p.preventEvent(l),!(typeof s.callback=="function"&&!await s.callback(l,r))&&await r();}),n.appendChild(a);}),i.appendChild(n);}}class qt{option;constructor(t){this.option=t;}async showView(t){let i=D.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    <div class="rule-view-container">
                    </div>
                    `,html:true},btn:{merge:true,reverse:false,position:"space-between",ok:{enable:this.option?.bottomControls?.add?.enable||true,type:"primary",text:"添加",callback:async a=>{this.showEditView(false,await this.option.getAddData(),i.$shadowRoot);}},close:{enable:true,callback(a){i.close();}},cancel:{enable:this.option?.bottomControls?.filter?.enable||false,type:"default",text:"过滤",callback:(a,r)=>{typeof this.option?.bottomControls?.filter?.callback=="function"&&this.option.bottomControls.filter.callback();let l=()=>Array.from(i.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),c=r.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");o.text(c).includes("取消")?(l().forEach(m=>{o.show(m,false);}),o.text(c,"过滤")):new he({title:this.option.bottomControls?.filter?.title??"过滤规则",filterOption:this.option.bottomControls?.filter?.option||[],execFilterCallBack(){o.text(c,"取消过滤");},getAllRuleInfo:()=>l().map(d=>({data:this.parseRuleItemElement(d).data,$el:d}))}).showView();}},other:{enable:this.option?.bottomControls?.clear?.enable||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:a=>{let r=D.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async l=>{if(u.success("清空所有"),typeof this.option?.bottomControls?.clear?.callback=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){f.error("清理失败");return}else f.success("清理成功");await this.updateDeleteAllBtnText(i.$shadowRoot),this.clearContent(i.$shadowRoot),r.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${D.config.cssText.panelCSS}
            ...
            `}),n=await this.option.data(),s=false;for(let a=0;a<n.length;a++){let r=n[a],l=await this.appendRuleItemElement(i.$shadowRoot,r);(typeof t=="function"?t(r):true)||(s=true,l.forEach(m=>{o.hide(m,false);}));}if(s){let a=i.$shadowRoot.querySelector(".pops-confirm-btn-cancel span");o.text(a,"取消过滤");}}showEditView(t,i,n,s,a,r){let l=async m=>{if(m){if(typeof r=="function"){let d=await this.option.getData(i);r(d);}}else if(t||await this.option.deleteData(i),typeof a=="function"){let d=await this.option.getData(i);a(d);}};new Ot({title:t?"编辑":"添加",data:()=>i,dialogCloseCallBack:l,getView:async m=>await this.option.itemControls.edit.getView(m,t),btn:{ok:{enable:true,text:t?"修改":"添加"},cancel:{callback:async(m,d)=>{m.close(),await l(false);}},close:{callback:async(m,d)=>{m.close(),await l(false);}}},onsubmit:async(m,d)=>{let h=await this.option.itemControls.edit.onsubmit(m,t,d);return h.success?t?(f.success("修改成功"),n&&await this.updateRuleItemElement(h.data,s,n)):n&&await this.appendRuleItemElement(n,h.data):t&&u.error("修改失败"),h},style:this.option.itemControls.edit.style,width:this.option.itemControls.edit.width,height:this.option.itemControls.edit.height}).showView();}parseViewElement(t){let i=t.querySelector(".rule-view-container"),n=t.querySelector(".pops-confirm-btn button.pops-confirm-btn-other");return {$container:i,$deleteBtn:n}}parseRuleItemElement(t){let i=t.querySelector(".rule-controls-enable"),n=i.querySelector(".pops-panel-switch"),s=i.querySelector(".pops-panel-switch__input"),a=i.querySelector(".pops-panel-switch__core"),r=t.querySelector(".rule-controls-edit"),l=t.querySelector(".rule-controls-delete");return {$enable:i,$enableSwitch:n,$enableSwitchInput:s,$enableSwitchCore:a,$edit:r,$delete:l,data:Reflect.get(t,"data-rule")}}async createRuleItemElement(t,i){let n=await this.option.getDataItemName(t),s=o.createElement("div",{className:"rule-item",innerHTML:`
			...
			`});Reflect.set(s,"data-rule",t);let a="pops-panel-switch-is-checked";const{$enable:r,$enableSwitch:l,$enableSwitchCore:c,$enableSwitchInput:m,$delete:d,$edit:h}=this.parseRuleItemElement(s);return this.option.itemControls.enable.enable?(o.on(c,"click",async _=>{let g=false;l.classList.contains(a)?(l.classList.remove(a),g=false):(l.classList.add(a),g=true),m.checked=g,await this.option.itemControls.enable.callback(t,g);}),await this.option.itemControls.enable.getEnable(t)&&l.classList.add(a)):r.remove(),this.option.itemControls.edit.enable?o.on(h,"click",_=>{p.preventEvent(_),this.showEditView(true,t,i,s,g=>{t=null,t=g;});}):h.remove(),this.option.itemControls.delete.enable?o.on(d,"click",_=>{p.preventEvent(_);let g=D.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async y=>{u.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(t)?(f.success("成功删除该数据"),s.remove(),await this.updateDeleteAllBtnText(i),g.close()):f.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):d.remove(),s}async appendRuleItemElement(t,i){let{$container:n}=this.parseViewElement(t),s=[],a=Array.isArray(i)?i:[i];for(let r=0;r<a.length;r++){let l=a[r],c=await this.createRuleItemElement(l,t);n.appendChild(c),s.push(c);}return await this.updateDeleteAllBtnText(t),s}async updateRuleContaienrElement(t){this.clearContent(t);const{$container:i}=this.parseViewElement(t);let n=await this.option.data();await this.appendRuleItemElement(t,n),await this.updateDeleteAllBtnText(t);}async updateRuleItemElement(t,i,n){let s=await this.createRuleItemElement(t,n);i.after(s),i.remove();}clearContent(t){const{$container:i}=this.parseViewElement(t);o.html(i,"");}setDeleteBtnText(t,i,n=false){const{$deleteBtn:s}=this.parseViewElement(t);n?o.html(s,i):o.text(s,i);}async updateDeleteAllBtnText(t){let i=await this.option.data();this.setDeleteBtnText(t,`清空所有(${i.length})`);}}const fe={$key:{STORAGE_KEY:"mt-own-block-rule"},$data:{isRegister:false},init(){this.registerMenu();let e=new p.LockFunction(()=>{this.runRule();});p.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{e.run();}});},registerMenu(){this.$data.isRegister||(this.$data.isRegister=true,H.registerLeftMenu({name:"我的屏蔽",icon:"",iconColor:"#000",callback:()=>{this.showView();}}));},getTemplateData(){return {uuid:p.generateUUID(),enable:true,name:"",data:{userName:"",userUID:"",userLevel:"",postUrl:"",postTitle:"",postContent:"",postPlateName:""}}},showView(){let e=D.config.PanelHandlerComponents();function t(n){return {get(s,a){return n[s]??a},set(s,a){n[s]=a;}}}new qt({title:"我的屏蔽",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(r=>r.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,s)=>{n.enable=s,this.updateData(n);}},edit:{enable:true,getView:(n,s)=>{let a=document.createDocumentFragment();s||(n=this.getTemplateData());let r=I("启用","enable",true);Reflect.set(r.props,M,t(n));let l=e.createSectionContainerItem_switch(r),c=B("规则名称","name","","",void 0,"必填");Reflect.set(c.props,M,t(n));let m=e.createSectionContainerItem_input(c),d=B("用户名","userName","","",void 0,"可正则");Reflect.set(d.props,M,t(n.data));let h=e.createSectionContainerItem_input(d),_=B("用户UID","userUID","","",void 0,"可正则");Reflect.set(_.props,M,t(n.data));let g=e.createSectionContainerItem_input(_),y=B("用户等级","userLevel","","",void 0,"可正则");Reflect.set(y.props,M,t(n.data));let k=e.createSectionContainerItem_input(y),S=B("帖子url","postUrl","","",void 0,"可正则");Reflect.set(S.props,M,t(n.data));let C=e.createSectionContainerItem_input(S),A=B("帖子标题","postTitle","","",void 0,"可正则");Reflect.set(A.props,M,t(n.data));let E=e.createSectionContainerItem_input(A),L=B("帖子内容","postContent","","",void 0,"可正则");Reflect.set(L.props,M,t(n.data));let F=e.createSectionContainerItem_input(L),U=B("帖子所在的板块名","postPlateName","","",void 0,"可正则");Reflect.set(U.props,M,t(n.data));let j=e.createSectionContainerItem_input(U);return a.appendChild(l),a.appendChild(m),a.appendChild(h),a.appendChild(g),a.appendChild(k),a.appendChild(C),a.appendChild(E),a.appendChild(F),a.appendChild(j),a},onsubmit:(n,s,a)=>{let r=n.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();return s&&(l.uuid=a.uuid),r.forEach(c=>{let m=Reflect.get(c,"__formConfig__"),d=Reflect.get(m,"attributes"),h=Reflect.get(c,M),_=Reflect.get(d,et),g=Reflect.get(d,it),y=h.get(_,g);Reflect.has(l,_)?Reflect.set(l,_,y):Reflect.has(l.data,_)?Reflect.set(l.data,_,y):u.error(`${_}不在数据中`);}),l.name.trim()===""?(f.error("规则名称不能为空"),{success:false,data:l}):s?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}}},delete:{enable:true,deleteCallBack:n=>this.deleteData(n)}}}).showView();},runRule(){let e=this.getData();function t(i){for(const n of e){let s=n.data;if(Object.keys(s).find(r=>{let l=s[r];if(p.isNotNull(l)){let c=new RegExp(l,"i"),m=Reflect.get(i,r);if(typeof m=="string"&&p.isNotNull(m)&&m.match(c))return u.info("屏蔽",[s,m]),true}return  false}))return  true}return  false}(T.isGuide()||T.isPlate()||T.isPost())&&(this.getData(),document.querySelectorAll(".comiis_forumlist .forumlist_li").forEach(i=>{let n=i.querySelector("a.top_user"),s=n.href.match(J.uid),a={userName:n.innerText,userUID:s[s.length-1].trim(),userLevel:i.querySelector("span.top_lev").innerText.replace("Lv.",""),postUrl:i.querySelector(".mmlist_li_box a").getAttribute("href")||i.querySelector(".mmlist_li_box a").getAttribute("data-href"),postTitle:i.querySelector(".mmlist_li_box h2 a")?.innerText||"",postContent:i.querySelector(".mmlist_li_box .list_body").innerText,postPlateName:(i.querySelector(".forumlist_li_time a.f_d")||i.querySelector(".comiis_xznalist_bk.cl")).innerText.replace(//g,"").replace(/\s*/g,"").replace(/来自/g,"")};p.isNull(a.postPlateName)&&(a.postPlateName=document.querySelector("#comiis_wx_title_box").innerText),t(a)&&i.remove();}),document.querySelectorAll(".comiis_postlist .comiis_postli").forEach(i=>{let n=i.querySelector("a.top_user"),s=n.href.match(J.uid),a={userName:n.innerText,userUID:s[s.length-1].trim(),userLevel:i.querySelector("a.top_lev").innerText.replace("Lv.",""),postUrl:void 0,postTitle:void 0,postContent:i.querySelector(".comiis_message_table").innerText,postPlateName:void 0};t(a)&&i.remove();})),T.isMessageList()&&(this.getData(),z(".comiis_pms_box .comiis_pmlist ul li").forEach(i=>{let n=i.querySelector("a.b_b").href.match(J.uid),s={userName:i.querySelector("h2").innerText.replace(i.querySelector("h2 span").innerText,"").replace(/\s*/,""),userUID:n[n.length-1].trim(),userLevel:void 0,postUrl:i.querySelector("a.b_b").href,postTitle:void 0,postContent:i.querySelector("p.f_c").innerText.trim(),postPlateName:void 0};t(s)&&i.remove();}));},getData(){return K(this.$key.STORAGE_KEY,[])},setData(e){W(this.$key.STORAGE_KEY,e);},addData(e){let t=this.getData();return t.findIndex(n=>n.uuid==e.uuid)===-1?(t.push(e),W(this.$key.STORAGE_KEY,t),true):false},updateData(e){let t=this.getData(),i=t.findIndex(s=>s.uuid==e.uuid),n=false;return i!==-1&&(n=true,t[i]=e),this.setData(t),n},deleteData(e){let t=this.getData(),i=t.findIndex(s=>s.uuid==e.uuid),n=false;return i!==-1&&(n=true,t.splice(i,1)),this.setData(t),n},clearData(){st(this.$key.STORAGE_KEY);}},mt=function(e,t,i,n,s,a="",r){let l={text:e,type:"textarea",attributes:{},props:{},description:n,placeholder:a,disabled:r,getValue(){let m=this.props[M].get(t,i);return Array.isArray(m)?m.join(`
`):m},callback(c,m){this.props[M].set(t,m);}};return Reflect.set(l.attributes,et,t),Reflect.set(l.attributes,it,i),bt.initComponentsStorageApi("switch",l,{get(c,m){return v.getValue(c,m)},set(c,m){v.setValue(c,m);}}),l},be={$el:{isFilterElementHTML:[]},$key:{STORAGE_KEY:"mt-post-comment-filter-rule"},init(){if(this.registerMenu(),T.isPost()){let e=this.getData();if(!e.enable)return;let t=new p.LockFunction(()=>{this.runFilter(e);});p.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{t.run();}});}},registerMenu(){H.registerLeftMenu({name:"评论过滤器",icon:"",iconColor:"#ff0019",callback:()=>{this.showView();}});},runFilter(e){let t=function(n){for(const s of e.userBlackList)if(s==n.userName||s==n.userUID)return u.success("评论过滤器：黑名单用户",n),true;return  false},i=function(n){for(const s of e.userWhiteList)if(s===n.userName||s===n.userUID)return u.success("评论过滤器：白名单用户",n),true;return  false};z(".comiis_postlist .comiis_postli").forEach(n=>{if(n.querySelector("#comiis_allreplies"))return;let s=n.querySelector("a.top_user"),a=s.href.match(J.uid),r={userName:s?.innerText||"",userUID:a&&a[a?.length-1]?.trim()||"",content:n.querySelector(".comiis_message_table")?.innerText?.trim()||"",isAuthor:!!n.querySelector("span.top_lev")};if(!i(r)){if(e.replyFlag&&n.querySelector(".comiis_quote")){let l=n.querySelector(".comiis_quote");this.$el.isFilterElementHTML.push(l.outerHTML),l.remove();}if(!(r.isAuthor&&!e.avatarFlag)){if(t(r)){this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}if(!(typeof e.minLength=="number"&&e.minLength>r.content.length)&&!(typeof e.keywordLength=="number"&&e.keywordLength<r.content.length))for(const l of e.keywords){if(typeof l!="string")continue;let c=new RegExp(l);if(r.content.match(c)){console.log("评论过滤器：",r),this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}}}}});},showView(){const e=this;function t(s){return {get(a,r){let l=e.getData(),c=Reflect.get(l,a,r);return (a==="keywords"||a==="userWhiteList"||a==="userBlackList")&&(c=c.join(`
`)),c},set(a,r){(a==="keywords"||a==="userWhiteList"||a==="userBlackList")&&(r=r.split(`
`).filter(l=>l.trim()!="")),Reflect.set(s,a,r),e.setData(s);}}}let i=D.config.PanelHandlerComponents();new Ot({title:"评论过滤器",data:()=>this.getData(),getView:s=>{let a=document.createDocumentFragment(),r=I("启用","enable",true);Reflect.set(r.props,M,t(s));let l=i.createSectionContainerItem_switch(r),c=I("处理回复引用","replyFlag",false,void 0,"移除引用");Reflect.set(c.props,M,t(s));let m=i.createSectionContainerItem_switch(c),d=I("处理作者评论","avatarFlag",false);Reflect.set(d.props,M,t(s));let h=i.createSectionContainerItem_switch(d),_=I('处理从"搜索页面"或"我的帖子提醒页面"进入的网站',"viewthreadFlag",false);Reflect.set(_.props,M,t(s));let g=i.createSectionContainerItem_switch(_),y=B("匹配的评论内容长度最小值","minLength",5,"小于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(y.props,M,t(s));let k=i.createSectionContainerItem_input(y),S=B("匹配的评论内容长度最大值","keywordLength",8,"大于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(S.props,M,t(s));let C=i.createSectionContainerItem_input(S),A=mt("评论关键字","keywords","","多个关键字换行分割");Reflect.set(A.props,M,t(s));let E=i.createSectionContainerItem_textarea(A),L=mt("黑名单用户","userBlackList","","多个用户换行分割");Reflect.set(L.props,M,t(s));let F=i.createSectionContainerItem_textarea(L),U=mt("白名单用户","userWhiteList","","多个用户换行分割");Reflect.set(U.props,M,t(s));let j=i.createSectionContainerItem_textarea(U);return a.append(l,m,h,g,k,C,E,F,j),a},btn:{merge:true,position:"space-between",ok:{enable:false},cancel:{enable:true,text:"关闭"},other:{enable:true,text:`查看已过滤（${this.$el.isFilterElementHTML.length}）`,type:"primary",callback:(s,a)=>{console.log(this.$el.isFilterElementHTML),D.alert({title:{text:"评论过滤器-已过滤",position:"center"},content:{text:`
                                ${Array.from(document.querySelectorAll('link[rel="stylesheet"]')).map(r=>r.outerHTML).join(`
`)}

                                ${this.$el.isFilterElementHTML.join(`
`)}
                                `,html:true},btn:{ok:{type:"default",text:"关闭"}},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh"});}}},dialogCloseCallBack(s){},onsubmit:(s,a)=>({success:true,data:a}),style:`
            .pops-panel-item-left-desc-text{
                line-height: normal;
                margin-top: 6px;
                font-size: 0.8em;
...
`,we=()=>({"[呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq001.gif","[撇嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq002.gif","[色]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq003.gif","[发呆]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq004.gif","[得意]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq005.gif","[流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq006.gif","[害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq007.gif","[闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq008.gif","[睡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq009.gif","[大哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq010.gif","[尴尬]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq011.gif","[发怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq012.gif","[调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq013.gif","[呲牙]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq014.gif","[惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq015.gif","[难过]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq016.gif","[酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq017.gif","[冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq018.gif","[抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq019.gif","[吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq020.gif","[偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq021.gif","[可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq022.gif","[白眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq023.gif","[傲慢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq024.gif","[饥饿]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq025.gif","[困]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq026.gif","[惊恐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq027.gif","[流汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq028.gif","[憨笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq029.gif","[装逼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq030.gif","[奋斗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq031.gif","[咒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq032.gif","[疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq033.gif","[嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq034.gif","[晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq035.gif","[折磨]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq036.gif","[衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq037.gif","[骷髅]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq038.gif","[敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq039.gif","[再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq040.gif","[擦汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq041.gif","[抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq042.gif","[鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq043.gif","[糗大了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq044.gif","[坏笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq045.gif","[左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq046.gif","[右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq047.gif","[哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq048.gif","[鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq049.gif","[委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq050.gif","[快哭了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq051.gif","[阴脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq052.gif","[亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq053.gif","[吓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq054.gif","[可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq055.gif","[眨眼睛]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq056.gif","[笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq057.gif","[dogeQQ]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq058.gif","[泪奔]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq059.gif","[无奈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq060.gif","[托腮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq061.gif","[卖萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq062.png","[斜眼笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq063.gif","[喷血]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq064.gif","[惊喜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq065.gif","[骚扰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq066.gif","[小纠结]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq067.gif","[我最美]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq068.gif","[菜刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq069.gif","[西瓜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq070.gif","[啤酒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq071.gif","[篮球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq072.gif","[乒乓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq073.gif","[咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq074.gif","[饭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq075.gif","[猪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq076.gif","[玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq077.gif","[凋谢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq078.gif","[示爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq079.gif","[爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq080.gif","[心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq081.gif","[蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq082.gif","[闪电]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq083.gif","[炸弹]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq084.gif","[刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq085.gif","[足球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq086.gif","[瓢虫]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq087.gif","[便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq088.gif","[月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq089.gif","[太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq090.gif","[礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq091.gif","[抱抱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq092.gif","[喝彩]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq93.gif","[祈祷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq94.gif","[棒棒糖]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq95.gif","[药]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq96.gif","[赞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq097.gif","[差劲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq098.gif","[握手]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq099.gif","[胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq100.gif","[抱拳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq101.gif","[勾引]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq102.gif","[拳头]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq103.gif","[爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq105.gif","[NO]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq106.gif","[OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq107.gif","[#呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_1.png","[#滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_10.png","[#吐舌]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_3.png","[#哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_2.png","[#啊]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_23.png","[#酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_22.png","[#怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_13.png","[#开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_39.png","[#汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_14.png","[#泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_16.png","[#黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_15.png","[#鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_21.png","[#不高兴]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_12.png","[#真棒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_17.png","[#钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_40.png","[#疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_26.png","[#阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_20.png","[#吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_34.png","[#咦]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_41.png","[#委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_29.png","[#花心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_6.png","[#呼～]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_42.png","[#激动]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_5.png","[#冷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_43.png","[#可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_4.png","[#What？]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_25.png","[#勉强]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_38.png","[#狂汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_24.png","[#酸爽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_27.png","[#乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_8.png","[#雅美蝶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_28.png","[#睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_31.png","[#惊哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_19.png","[#哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_44.png","[#笑尿]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_32.png","[#惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_30.png","[#小乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_7.png","[#喷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_18.png","[#抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_33.png","[#捂嘴笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_9.png","[#你懂的]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_11.png","[#犀利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_35.png","[#小红脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_36.png","[#懒得理]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_37.png","[#爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_45.png","[#心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_46.png","[#玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_47.png","[#礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_48.png","[#彩虹]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_49.png","[#太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_50.png","[#月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_51.png","[#钱币]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_52.png","[#咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_53.png","[#蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_54.png","[#大拇指]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_55.png","[#胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_56.png","[#爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_57.png","[#OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_58.png","[#弱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_59.png","[#沙发]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_60.png","[#纸巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_61.png","[#香蕉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_62.png","[#便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_63.png","[#药丸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_64.png","[#红领巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_65.png","[#蜡烛]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_66.png","[#三道杠]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_67.png","[#音乐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_68.png","[#灯泡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_69.png","[doge]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/1.png","[doge思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/2.png","[doge再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/3.png","[doge生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/4.png","[doge气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/5.png","[doge笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/7.png","[doge调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/6.png","[doge啊哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/8.png","[doge原谅TA]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/9.png","[miao]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/10.png","[miao思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/11.png","[miao拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/12.png","[miao生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/13.png","[miao气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/14.png","[二哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/15.png","[摊手]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/19.png","[w并不简单]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/20.png","[w滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/21.png","[w色]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/22.png","[w爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/23.png","[w拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/24.png","[w悲伤]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/25.png","[w鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/26.png","[w馋嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/27.png","[w冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/28.png","[w打哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/29.png","[w打脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/30.png","[w敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/31.png","[w生病]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/32.png","[w闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/33.png","[w鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/34.png","[w哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/35.png","[w害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/36.png","[w呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/37.png","[w黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/38.png","[w哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/39.png","[w调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/40.png","[w可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/41.png","[w可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/42.png","[w酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/43.png","[w困]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/44.png","[w懒得理你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/45.png","[w流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/46.png","[w怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/47.png","[w怒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/48.png","[w钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/49.png","[w亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/50.png","[w傻眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/51.png","[w便秘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/52.png","[w失望]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/53.png","[w衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/54.png","[w睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/55.png","[w思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/56.png","[w开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/57.png","[w色舔]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/58.png","[w偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/59.png","[w吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/60.png","[w抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/61.png","[w委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/62.png","[w笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/63.png","[w嘻嘻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/64.png","[w嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/65.png","[w阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/66.png","[w疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/67.png","[w抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/70.png","[w晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/69.png","[w右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/68.png","[w左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/71.png","[w肥皂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/77.png","[w奥特曼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/78.png","[w草泥马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/79.png","[w兔子]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/80.png","[w熊猫]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/81.png","[w猪头]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/82.png","[w→_→]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/83.png","[w给力]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/84.png","[w囧]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/85.png","[w萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/86.png","[w神马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/87.png","[w威武]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/88.png"}),xt={parseText(e){const t=we();let i=e.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/g);i&&i.forEach(w=>{let x=w.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/),q=x?x[x.length-1]:"",R=o.attr(`#aimg_${q}`,"title"),P=o.attr(`#aimg_${q}`,"src");P||(R="该图片不存在"),e=e.replace(w,`<span class="comiis_postimg vm"><img loading="lazy" id="aimg_${q}" src="${P}" alt="${R}" title="${R}"></span>`);});let n=e.match(/\[code\]([\s\S]*?)\[\/code\]/g);n&&n.forEach(w=>{let x=w.match(/\[code\]([\s\S]*?)\[\/code\]/),q=x?x[x.length-1]:"",R="",P=q.split(`
`);P.length==1?R=`<li>${q}</li>`:Array.from(P).forEach((Q,at)=>{at==P.length-1?R=`${R}<li>${Q}</li>`:R=`${R}<li>${Q}<br></li>`;}),e=e.replace(w,`
                <div class="comiis_blockcode comiis_bodybg b_ok f_b"><div class="bg_f b_l"><ol>${R}</ol></div></div>`);});let s=e.match(/\[url\=[\s\S]*?\]([\s\S]*?)\[\/url\]/g);s&&s.forEach(w=>{let x=w.match(/\[url=([\s\S]*?)\][\s\S]*\[\/url\]/),q=w.match(/\[url=[\s\S]*?\]([\s\S]*?)\[\/url\]/),R=x?x[x.length-1]:"",P=q?q[q.length-1]:"";e=e.replace(w,`<a href="${R}" target="_blank">${P}</a>`);});let a=e.match(/\[color\=[\s\S]*?\]([\s\S]*?)\[\/color\]/g);a&&a.forEach(w=>{let x=w.match(/\[color=([\s\S]*?)\][\s\S]*\[\/color\]/),q=w.match(/\[color=[\s\S]*?\]([\s\S]*?)\[\/color\]/),R=x?x[x.length-1]:"",P=q?q[q.length-1]:"";e=e.replace(w,`<font color="${R}">${P}</font>`);});let r=e.match(/\[size\=[\s\S]*?\]([\s\S]*?)\[\/size\]/g);r&&r.forEach(w=>{let x=w.match(/\[size=([\s\S]*?)\][\s\S]*\[\/size\]/),q=w.match(/\[size=[\s\S]*?\]([\s\S]*?)\[\/size\]/),R=x?x[x.length-1]:"",P=q?q[q.length-1]:"";e=e.replace(w,`<font size="${R}">${P}</font>`);});let l=e.match(/\[img(|\=[\s\S]+?)\]([\s\S]*?)\[\/img\]/g);l&&l.forEach(w=>{let x=null,q=null,R=w.match(/\[img\=([\s\S]+?)\][\s\S]*?\[\/img\]/);R&&(R=R[R.length-1].split(","),x=R[0],q=R[1]),x=x||"",q=q||"";let P=w.match(/\[img\]([\s\S]*?)\[\/img\]|\[img=[\s\S]*?\]([\s\S]*?)\[\/img\]/),Q="";P&&(P[P.length-1]==null?Q=P[P.length-2]:Q=P[P.length-1]),e=e.replace(w,`<img loading="lazy" src="${Q}" border="0" alt="" width="${x}" height="${q}" crossoriginNew="anonymous">`);});let c=e.match(/\[hide\]([\s\S]*?)\[\/hide\]/g);c&&c.forEach(w=>{let x=w.match(/\[hide\]([\s\S]*?)\[\/hide\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c"><h2 class="f_a">本帖隐藏的内容: </h2>${q}</div>`);});let m=e.match(/\[hide=[\s\S]*?\]([\s\S]*?)\[\/hide\]/g);m&&m.forEach(w=>{let x=w.match(/\[hide=([\s\S]*?)\]([\s\S]*?)\[\/hide\]/),q=x?x[x.length-2]:"";q=q.split(",");let R=q.length==2?q[1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c">以下内容需要积分高于 ${R} 才可浏览</div>`);});let d=e.match(/\[quote\]([\s\S]*?)\[\/quote\]/g);d&&d.forEach(w=>{let x=w.match(/\[quote\]([\s\S]*?)\[\/quote\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h b_dashed f_c"><blockquote><font>回复</font> ${q}</blockquote></div>`);});let h=e.match(/\[free\]([\s\S]*?)\[\/free\]/g);h&&h.forEach(w=>{let x=w.match(/\[free\]([\s\S]*?)\[\/free\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c"><blockquote>${q}</blockquote></div>`);});let _=e.match(/\[b\]([\s\S]*?)\[\/b\]/g);_&&_.forEach(w=>{let x=w.match(/\[b\]([\s\S]*?)\[\/b\]/i),q=x?x[x.length-1]:"";e=e.replace(w,`<strong>${q}</strong>`);});let g=e.match(/\[u\]([\s\S]*?)\[\/u\]/g);g&&g.forEach(w=>{let x=w.match(/\[u\]([\s\S]*?)\[\/u\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<u>${q}</u>`);});let y=e.match(/\[i\]([\s\S]*?)\[\/i\]/g);y&&y.forEach(w=>{let x=w.match(/\[i\]([\s\S]*?)\[\/i\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<i>${q}</i>`);});let k=e.match(/\[s\]([\s\S]*?)\[\/s\]/g);k&&k.forEach(w=>{let x=w.match(/\[s\]([\s\S]*?)\[\/s\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<strike>${q}</strike>`);});let S=e.match(/\[([\s\S]+?)\]/g);S&&S.forEach(w=>{let x=t[w];x&&(e=e.replace(w,`<img loading="lazy" src="${x}" border="0" alt="" smilieid="">`));});let C=e.match(/\[media=[\s\S]+?\][\s\S]+?\[\/media\]/g);C&&C.forEach(w=>{let x=w.match(/\[media=[\s\S]*?\]([\s\S]*?)\[\/media\]/),q=x?x[x.length-1]:"";q&&(e=e.replace(w,`<ignore_js_op><span><iframe src="${q}" border="0" scrolling="no" framespacing="0" allowfullscreen="true" style="max-width: 100%" width="100%" height="auto" frameborder="no"></iframe></span></ignore_js_op>`));});let A=e.match(/\[email=[\s\S]+?\][\s\S]+?\[\/email\]/g);A&&A.forEach(w=>{let x=w.match(/\[email=([\s\S]*?)\][\s\S]*?\[\/email\]/),q=w.match(/\[email=[\s\S]*?\]([\s\S]*?)\[\/email\]/),R=x.length?x[x.length-1]:"",P=q.length?q[q.length-1]:"";(R||P)&&(e=e.replace(w,`<a href="mailto:${R}">${P}</a>`));});let E=e.match(/\[align=[\s\S]+?\][\s\S]+?\[\/align\]/g);E&&E.forEach(w=>{let x=w.match(/\[align=([\s\S]*?)\][\s\S]+?\[\/align\]/),q=w.match(/\[align=[\s\S]*?\]([\s\S]+?)\[\/align\]/),R=x.length?x[x.length-1]:"",P=q.length?q[q.length-1]:"";(R||P)&&(e=e.replace(w,`<div align="${R}">${P}</div>`));});let L=e.match(/\[qq\][\s\S]*?\[\/qq\]/g);L&&L.forEach(w=>{let x=w.match(/\[qq\]([\s\S]*?)\[\/qq\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<a href="http://wpa.qq.com/msgrd?v=3&uin=${q}&site=[Discuz!]&from=discuz&menu=yes" target="_blank"><img loading="lazy" src="static/image/common/qq_big.gif" border="0"></a>`);});let F=e.match(/\[td\][\s\S]+?\[\/td\]/g);F&&F.forEach(w=>{let x=w.match(/\[td\]([\s\S]*?)\[\/td\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<td>${q}</td>`);});let U=e.match(/\[tr\][\s\S]+?\[\/tr\]/g);U&&U.forEach(w=>{let x=w.match(/\[tr\]([\s\S]*?)\[\/tr\]/),q=x?x[x.length-1]:"";e=e.replace(w,`<tr>${q}</tr>`);});let j=e.match(/\[table\][\s\S]+?\[\/table\]/g);j&&j.forEach(w=>{let x=w.match(/\[table\]([\s\S]*?)\[\/table\]/),q=x?x[x.length-1]:"";q=q.replace(/\n/g,""),e=e.replace(w,`<table>${q}</table>`);});let O=e.match(/\[list=[\s\S]+?\][\s\S]+?\[\/list\]/g);return O&&O.forEach(w=>{let x=w.match(/\[list=([\s\S]*?)\][\s\S]*?\[\/list\]/),q=w.match(/\[list=[\s\S]*?\]([\s\S]*?)\[\/list\]/),R=x?x[x.length-1]:"",P="";R==="a"?P="litype_2":R==="A"?P="litype_3":R.length===1&&R.match(/[0-9]{1}/)&&(P="litype_1");let Q=q?q[q.length-1]:"",at=Q.split("[*]");if(at.length>1){let _t="";at[0].replace(/[\s]*/,"")==""&&(at=at.slice(1)),Array.from(at).forEach(Ht=>{_t=`${_t}<li>${Ht}</li>`;}),Q=_t;}Q=Q.replace(/\n/g,""),e=e.replace(w,`<ul type="${R}" class="${P}">${Q}</ul>`);}),e},parseVoteText(){let e=["rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)","rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)"],t=z(".comiis_polloption_add ul li:first-child div.flex .comiis_input.kmshow[type='text']"),i=parseInt(o.val("input#maxchoices"));i=isNaN(i)?0:i,i=i>0?i:0,i=i>t.length?t.length:i;let n=parseInt(o.val("input#polldatas"));n=isNaN(n)?0:n,b.$("input#visibilitypoll").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close");let s=!b.$("input#overt").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close"),a="",r="";t.forEach((l,c)=>{c>=20||(r=r+`
                    <li class="kmnop">
                ...
                `,b.$(".gm_plugin_previewpostforum_html .postforum_vote").remove(),b.$(".gm_plugin_previewpostforum_html .comiis_messages.comiis_aimg_show").children().eq(0).before(b.$(a));}},ht={$data:{db:new Y.indexedDB("mt_full_reply_record","input_text"),get type(){return T.isPostPublish_voting()?"post-vote":"post"},get tid(){return V.getThreadId(window.location.href)},get pid(){return V.getPostId(window.location.href)}},$key:{noPublishSerializeText:"mt-editor-no-publish-serialize-text",noPublishVotingSerializeText:"mt-editor-no-publish-voting-serialize-text"},$el:{$title:null,$input:null,$form:null},init(){u.info("编辑器优化"),G(xe),this.overridePageEditor();},overridePageEditor(){const e=this;this.$el.$title=$("#needsubject"),this.$el.$form=$("#postform"),this.$el.$input=$("#needmessage"),o.hide(o.parent(".comiis_scrollTop_box"),false),o.css("#postform .comiis_post_from.mt15",{"margin-top":"0px !important"});let t=b.$("#postform .comiis_post_from #comiis_post_tab");b.$("#postform .comiis_post_from .comiis_post_ico").append(t),t.remove(),b.textarea_scrollHeight=()=>{};let i=b.$.fn.comiis_delete;b.$.fn.extend({comiis_delete:function(...c){let m=i.call(this,...c);return p.dispatchEvent(e.$el.$input,"input"),m}}),o.hide(".comiis_btnbox",false),this.initVotePage(),b.$(".gm_plugin_chartbed .comiis_over_box.comiis_input_style #imglist"),G(`
        ...
        `),o.attr("#filedata","multiple",true),o.remove(".gm_plugin_chartbed .comiis_over_box.comiis_input_style"),o.on(document,"#comiis_pictitle_key li","click",function(){o.removeClass("#comiis_pictitle_key li","bg_f"),o.addClass(this,"bg_f"),b.$(".gm_plugin_chartbed .comiis_upbox").hide().eq(b.$(this).index()).fadeIn();});let n=parseInt(o.css("#comiis_head","height"))||0,s=parseInt(o.css("#comiis_sub","height"))||0,a=$("#pollm_c_1")?60:0,r=parseInt(o.css(".comiis_styli.comiis_flex","height"))||0,l=parseInt(o.css(".comiis_post_ico.comiis_minipost_icot","height"))||0;o.css("#needmessage","height",`${window.screen.height-n-s-48-r-l-10}px`),o.css("#needmessage","marginBottom",a+"px"),T.isPostPublish_edit()&&o.val("#needsubject")===""?o.hide(".comiis_styli.comiis_flex",false):o.attr("#needsubject","placeholder","请输入完整的帖子标题 (1-80个字)"),o.attr("#needmessage","placeholder","来吧，尽情发挥吧..."),typeof b.comiis_addsmilies=="function"&&(b.comiis_addsmilies=c=>{b.$("#needmessage").comiis_insert(c),b.$("#needmessage")[0].dispatchEvent(new Event("input"));}),(v.getValue("mt-forum-post-editorOptimizationNormal-recordInputText")||v.getValue("mt-forum-post-editorOptimization-recordInputText"))&&(this.setInputChangeEvent(),this.initReplyText()),this.initDeleteBtn(),this.initSaveDraftBtn(),this.initSaveBtn(),this.initPostBtn(),this.initReplyBtn(),this.observerChangeEditorHeight(),this.listenResize(),this.initSelectPostingSection(),this.initUBB(),this.initImage(),this.initPreview(),this.initCharacterCount(),this.initSettingImmersionMode();},async initReplyText(){const e=this;let t=null,i=null,n=null;if(T.isPostPublish_newthread())u.info("新发布帖子的页面"),T.isPostPublish_voting()?(u.info("投票页面"),t=K(this.$key.noPublishVotingSerializeText),n=()=>{st(e.$key.noPublishVotingSerializeText);}):(u.info("普通帖子页面"),t=K(this.$key.noPublishSerializeText),n=()=>{st(this.$key.noPublishSerializeText);});else if(T.isPostPublish_edit()){u.info("草稿的页面"),u.info(`type：${this.$data.type} tid：${this.$data.tid} pid：${this.$data.pid}`),(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let a=await this.$data.db.get("data");if(a.data){let r=a.data.find(l=>{if(l.type===e.$data.type&&!(l.tid!==e.$data.tid||l.pid!==e.$data.pid))return  true});r&&(t=r.data,n=async()=>{let l=await this.$data.db.get("data");if(l.data){let c=l.data.findIndex(m=>{if(m.type===e.$data.type&&!(m.tid!==e.$data.tid||m.pid!==e.$data.pid))return  true});c!=-1&&(l.data.splice(c,1),await this.$data.db.save("data",l.data));}});}}else if(T.isPostPublish_reply()&&(u.info("回复页面"),v.getValue("mt-forum-post-editorOptimizationNormal-recordInputText"))){(await tt.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let a=await tt.$data.db.get("data");if(a.data){let r=a.data.find(l=>l.forumId===e.$data.tid&&l.repquote===V.getRepquote(window.location.href));r&&(t=r);}}t&&(T.isPostPublish_voting()?i=()=>{let s=e.$el.$form.querySelector("input[name='subject']"),a=e.$el.$form.querySelector("textarea[name='message']"),r=e.$el.$form.querySelector("input[name='maxchoices']"),l=e.$el.$form.querySelector("input[name='expiration']"),c=e.$el.$form.querySelector("input[name='visibilitypoll']"),m=e.$el.$form.querySelector("input[name='overt']");return o.val(s,t.title),o.val(a,t.content),o.val(r,t.maxchoices),o.val(l,t.expiration),o.val(c,t.visibilitypoll),o.val(m,t.overt),p.dispatchEvent(s,"input"),p.dispatchEvent(a,"input"),p.dispatchEvent(r,"input"),p.dispatchEvent(l,"input"),p.dispatchEvent(c,"input"),p.dispatchEvent(m,"input"),true}:T.isPostPublish_reply()?i=()=>{let s=e.$el.$form.querySelector("textarea[name='message']");return o.val(s,t.text),p.dispatchEvent(s,"input"),true}:i=()=>{let s=e.$el.$form.querySelector("input[name='subject']"),a=e.$el.$form.querySelector("textarea[name='message']");return o.val(s,t.title),o.val(a,t.content),p.dispatchEvent(s,"input"),p.dispatchEvent(a,"input"),true},T.isPostPublish_newthread()?(u.info("新发布帖子的页面"),typeof i=="function"&&i()):T.isPostPublish_edit()?(u.info("草稿的页面"),typeof i=="function"&&typeof n=="function"&&D.confirm({title:{text:"提示",position:"center"},content:{text:"<p>存在历史写入的数据，是否恢复到编辑器里？</p>",html:true},btn:{merge:true,position:"space-between",ok:{text:"恢复",callback:async s=>{await i()&&(f.success("恢复成功"),s.close());}},other:{enable:true,type:"danger",text:"删除该数据",callback:async s=>{await n(),s.close(),f.success("删除成功");}}},width:"300px",height:"200px"})):T.isPostPublish_reply()&&(u.info("回复页面"),typeof i=="function"&&i()));},async getReplyRecordSize(){let e=await this.$data.db.get("data");return e.success?p.getTextStorageSize(e?.data?.length?JSON.stringify(e.data):""):p.formatByteToSize(0)},async clearAllReplyRecord(){return await this.$data.db.deleteAll()},deleteReplyTextStorage(){const e=this;this.$data.db.get("data").then(t=>{if(!t.success){console.warn(t);return}let i=T.isPostPublish_voting()?"post-vote":"post",n=V.getThreadId(window.location.href),s=V.getPostId(window.location.href),a=t.data.findIndex(r=>{if(r.type===i&&!(r.tid!==n||r.pid!==s))return  true});a!==-1&&(t.data.splice(a,1),e.$data.db.save("data",t.data).then(r=>{}));});},setInputChangeEvent(){const e=this;o.on([this.$el.$input,this.$el.$title].filter(Boolean),["input","propertychange"],function(t){let i=null;if(T.isPostPublish_voting()){let n=e.$el.$form.querySelector("input[name='subject']"),s=e.$el.$form.querySelector("textarea[name='message']"),a=e.$el.$form.querySelector("input[name='maxchoices']"),r=e.$el.$form.querySelector("input[name='expiration']"),l=e.$el.$form.querySelector("input[name='visibilitypoll']"),c=e.$el.$form.querySelector("input[name='overt']");i={title:n.value,maxchoices:a.value,expiration:r.value,visibilitypoll:l.checked,overt:c.checked,content:s.value};}else {let n=e.$el.$form.querySelector("input[name='subject']"),s=e.$el.$form.querySelector("textarea[name='message']");i={title:n?.value,content:s.value};}T.isPostPublish_newthread()?(u.info("内容改变 ==> 新发布帖子的页面"),T.isPostPublish_voting()?W(e.$key.noPublishVotingSerializeText,i):W(e.$key.noPublishSerializeText,i)):T.isPostPublish_edit()?(u.info("内容改变 ==> 草稿的页面"),e.$data.db.get("data").then(n=>{if(!n.success){console.warn(n);return}let s=n.data.findIndex(a=>{if(a.type===e.$data.type&&!(a.tid!==e.$data.tid||a.pid!==e.$data.pid))return  true});s!==-1&&n.data.splice(s,1),n.data.push({url:window.location.href,data:i,pid:e.$data.pid,tid:e.$data.tid,type:e.$data.type}),e.$data.db.save("data",n.data).then(a=>{});})):T.isPostPublish_reply()&&(u.info("内容改变 ==> 回复页面"),v.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{tt.$data.db.get("data").then(n=>{if(!n.success||n.code===201){console.warn(n);return}let s=n.data.findIndex(a=>a.forumId===e.$data.tid&&a.repquote===V.getRepquote(window.location.href));s!==-1?i.content==null||i.content===""?n.data.splice(s,1):n.data[s]=p.assign(n.data[s],{text:i.content}):n.data.push({forumId:e.$data.tid,url:window.location.href,repquote:V.getRepquote(window.location.href),text:i.content}),tt.$data.db.save("data",n.data).then(a=>{});});}));});},initDeleteBtn(){if(!$(".comiis_btnbox .comiis_btn.bg_del"))return;let t=$("#comiis_head .header_y"),i=o.createElement("input",{className:"new_btn_del"},{type:"button",value:"删除"});o.append(t,i),o.on(i,"click",function(){D.confirm({title:{text:"提示",position:"center"},content:{text:"<p>是否删除帖子?</p>",html:true},btn:{ok:{callback:n=>{n.close(),b.comiis_delthread();}}},width:"300px",height:"200px"});});},initSaveBtn(){let e=o.selector(".comiis_btnbox button#postsubmit:contains('保存')");if(!e||o.text(e).includes("草稿"))return;let t=$("#comiis_head .header_y"),i=o.createElement("input",{className:"new_btn_save"},{type:"button",value:"保存"});o.append(t,i),o.on(i,"click",function(){e.click();});},initPostBtn(){let e=o.selector(".comiis_btnbox button#postsubmit:contains('发表')");if(!e)return;let t=$("#comiis_head .header_y"),i=o.createElement("input",{className:"new_btn_post"},{type:"button",value:"发表"});o.append(t,i),o.on(i,"click",function(){o.val("#postsave",0),e.click();});},initReplyBtn(){const e=this;let t=o.selector(".comiis_btnbox button#postsubmit:contains('回复')");if(!t)return;let i=$("#comiis_head .header_y"),n=o.createElement("input",{className:"new_btn_reply"},{type:"button",value:"回复"});o.append(i,n),o.on(n,"click",function(){t.click(),e.deleteReplyTextStorage();});},initVotePage(){z(".comiis_scrollTop_box").length&&(b.$("#htmlon").parent().append(`
                ...
                `),b.$(".comiis_scrollTop_box .swiper-slide a:contains('发表帖子')").attr("class")!="f_c"?b.$(".comiis_checkbox.comiis_choose_post").removeClass("comiis_checkbox_close"):b.$(".comiis_checkbox.comiis_choose_vote").removeClass("comiis_checkbox_close"),b.$(".comiis_checkbox.comiis_choose_post").on("click",function(){let e=b.$(this);e.addClass("comiis_checkbox_close"),b.$(".comiis_checkbox.comiis_choose_vote").addClass("comiis_checkbox_close"),e.removeClass("comiis_checkbox_close"),window.location.href=window.location.href.replace("&special=1","");}),b.$(".comiis_checkbox.comiis_choose_vote").on("click",function(){let e=b.$(this);e.addClass("comiis_checkbox_close"),b.$(".comiis_checkbox.comiis_choose_post").addClass("comiis_checkbox_close"),e.removeClass("comiis_checkbox_close"),window.location.href=window.location.href+"&special=1";}));},initSaveDraftBtn(){let e=o.selector(".comiis_btnbox button#postsubmit em:contains('保存草稿')");if(!e)return;let t=$("#comiis_head .header_y"),i=o.createElement("input",{className:"new_btn_save_temp"},{type:"button",value:"保存草稿"});$("#needsubject"),o.append(t,i),o.selector(".comiis_scrollTop_box .swiper-slide a:contains('发表帖子')"),o.on(i,"click",function(){e.click();});},observerChangeEditorHeight(){var e=0;p.waitNode("#postform > div > div.comiis_post_ico.comiis_minipost_icot").then(t=>{p.mutationObserver(t,{callback:i=>{var n=$("#postform > div > div.comiis_post_ico.comiis_minipost_icot");let s=window.getComputedStyle(n).getPropertyValue("height");if(s.toString()===e.toString())return;e=parseInt(s);let a=document.documentElement.clientHeight-$("#postform > div > div.comiis_post_ico.comiis_minipost_icot").getBoundingClientRect().height-$("#needmessage").getBoundingClientRect().top;a-5<100?(b.$("#needmessage").css("height","100px"),b.$(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box").css("height","100px")):(b.$("#needmessage").css("height",a-5+"px"),b.$(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box").css("height",a-5+"px"));},config:{childList:true,attributes:true,characterData:true,subtree:true}});});},listenResize(){o.on(window,"resize",function(){let e=document.documentElement.clientHeight-$("#postform > div > div.comiis_post_ico.comiis_minipost_icot").getBoundingClientRect().height-$("#needmessage").getBoundingClientRect().top;e-5<100?(o.css("#needmessage","height","100px"),o.css(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box","height","100px")):(u.info("设置输入框、预览高度",e-5),o.css("#needmessage","height",e-5+"px"),o.css(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box","height",e-5+"px"));});},initSelectPostingSection(){G(`
            #select-post-section {
                height: 28px;
                width: 160px;
                line-height: 28px;
            ...
            `);let e={2:"版本发布",37:"插件交流",38:"建议反馈",41:"逆向交流",39:"玩机交流",42:"编程开发",40:"求助问答",44:"综合交流",50:"休闲灌水",46:"官方公告",53:"申诉举报",92:"站务专区"};o.before(".comiis_post_from .comiis_wzpost.comiis_input_style .comiis_styli:contains('标题')",`
        ...
        `);let t=$("#select-post-section"),i=V.getForumId(window.location.href);T.isPostPublish_newthread()?(u.info("发帖"),o.on(t,"change",function(){let n=o.val(t),s=`forum.php?mod=post&action=newthread&fid=${n}&extra=&topicsubmit=yes&mobile=2`;u.info(`修改发帖板块: ${e[n]} ${s}`);let a={求助问答:{className:"gm_user_select_help",optionHTML:`<option value="0" selected="selected">请选择</option>
                        ...
                        <option value="43">职位调整</option>`}},r=a[e[n]];r?(o.remove(o.parent(".comiis_post_from .styli_tit:contains('分类')")),o.before(".comiis_stylino.comiis_needmessage",`
                        ...
                        `)):Object.keys(a).forEach(l=>{o.remove(".comiis_post_from ."+a[l].className);}),o.attr("#postform","action",s);})):o.attr(t,"disabled",true),o.val(t,i),o.trigger(t,"change");},initCharacterCount(){u.info("添加功能：字符计数"),G(`
        .gm_plugin_word_count{display:flex}
        .gm_plugin_word_count::after{content:"/20000"}
        `),o.append("#comiis_mh_sub .swiper-wrapper.comiis_post_ico",`
            <a href="javascript:;" class="swiper-slide gm_plugin_word_count">
                <p>0</p>
            </a>`),o.on(this.$el.$input,["input","propertychange"],e=>{let t=this.$el.$input.value,i=p.getTextLength(t),n=xt.parseText(t);o.html(".gm_plugin_previewpostforum_html .comiis_message_table",n);let s=$(".gm_plugin_word_count p");o.text(s,i),i>2e4||i<10?o.attr(s,"style","color: red;"):o.attr(s,"style","");});},initUBB(){if(!$(".comiis_post_urlico")){u.error("未找到插入元素");return}G(`
        #comiis_post_tab .comiis_input_style .comiis_post_urlico li a.f_0{
            color: #53bcf5 !important;
        }
        `);let e=Nt(),t=$(".comiis_post_urlico > ul"),i=$("#comiis_post_qydiv > ul"),n=z("#comiis_post_qydiv ul li").length;le(),o.on("#comiis_post_tab .comiis_input_style .comiis_post_urlico li","click",function(){o.removeClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_0"),o.addClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_d"),o.attr(this.querySelector("a"),"class","comiis_xifont f_0"),b.$("#comiis_post_qydiv ul li").hide().eq(b.$(this).index()).fadeIn();}),b.$.each(e,function(s,a){let r=o.createElement("li",{className:"quickUBBs",innerHTML:`
                <a href="javascript:;" class="comiis_xifont f_d"><i class="comiis_font"></i>${a.key}</a>
                `});o.on(r,"click",c=>{if(!$(`#comiis_post_qydiv li[data-key='${a.key}']`)){u.error("未找到该元素");return}z("#comiis_post_tab div.comiis_post_urlico ul li a.comiis_xifont").forEach(_=>{_.className="comiis_xifont f_d";});let d=r.querySelector("a");d.className="comiis_xifont f_0";let h=n+Object.keys(e).indexOf(s);b.$("#comiis_post_qydiv ul li").hide().eq(h).fadeIn();}),o.append(t,r);let l=document.createElement("li");l.setAttribute("style","display: none;"),l.setAttribute("data-key",a.key),l.innerHTML=`
            <div class="comiis_styli_m f15" style="padding-top:12px;">
                <div class="bg_e comiis_p5" style="border-radius:4px">
                    <textarea class="comiis_pt kmshow f_c" id="comiis_input_${s}" style="font-size:15px" placeholder="请输入需要${a.key}的文字"></textarea>
                </div>
            </div>
            <div class="comiis_styli_m f15 comiis_flex" style="padding-top:0;">
                ...
                <div class="flex"></div>
            </div>`,o.append(i,l),o.on(`.comiis_sendbtn[data-keyI="${s}"]`,"click",()=>{let c=b.$(`#comiis_input_${s}`).val();if(c==""){f.warning("请输入需要插入的内容");return}let m=e[s];m.isFunc&&(c=Bt(m.num,c)),m.hasOwnProperty("L")&&(c=m.L+c+m.R),b.$("#needmessage").insertAtCaret(c),m.hasOwnProperty("cursorL")&&b.$("#needmessage").moveCursorToCenterByTextWithLeft(m.cursorL,m.cursorLength),m.hasOwnProperty("cursorR")&&b.$("#needmessage").moveCursorToCenterByTextWithRight(m.cursorR,m.cursorLength);});});},initImage(){u.info("添加功能：图片"),G(`
            #comiis_pictitle_tab .comiis_upbox{
                height: 140px;
                overflow-y: auto;
            }
            `),o.append("#comiis_mh_sub .swiper-wrapper.comiis_post_ico",`
        <a href="javascript:;" class="comiis_pictitle"><i class="comiis_font"><em>图片</em></i></a>`),o.on(".comiis_pictitle","click",function(){this.querySelector("i.comiis_font").classList.contains("f_0")?o.hide(".gm_plugin_chartbed",false):o.show(".gm_plugin_chartbed",false);}),o.append("#comiis_post_tab",`
            ...
            `);let t=$("#imglist"),i=o.parent(t);o.before(".gm_plugin_chartbed .bqbox_t",i),o.on("#imglist .comiis_font","click",n=>{$("#filedata").click();}),o.on("#comiis_pictitle_tab #comiis_pictitle_key","click","li",function(n){let s=n.target;o.removeClass("#comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),o.addClass(s,"bg_f"),b.$("#comiis_pictitle_tab div.comiis_upbox").hide().eq(b.$(s).index()).fadeIn();}),v.execMenuOnce("mt-image-bed-hello-enable",()=>{zt.init();}),v.execMenuOnce("mt-image-bed-mt-enable",()=>{Vt.init();});},initPreview(){const e=this;u.info("添加功能：双列预览"),G(`
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
        ...
        </a>`),o.css(o.parent(this.$el.$input),"display","flex"),o.after(this.$el.$input,`
            ...
            </div>`),o.on(".gm_plugin_previewpostforum","click",function(i){let n=this;if(z("#polldatas").length&&xt.parseVoteText(),n.querySelector("i.comiis_font").classList.contains("f_0"))o.hide(".gm_plugin_previewpostforum_html",false);else {o.show(".gm_plugin_previewpostforum_html",false);let a=xt.parseText(o.val(e.$el.$input));o.html(".gm_plugin_previewpostforum_html .comiis_message_table",a),o.css(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box.comiis_input_style","height",o.css(e.$el.$input,"height"));}});},initSettingImmersionMode(){u.info("初始化设置功能-使用沉浸模式"),o.append(o.parent("#htmlon"),`
            <li class="comiis_styli_m f15 comiis_flex b_b">
            ...
            `),o.on("#immersiveinput","click",function(){let e=this,t=o.parent(e).querySelector(".comiis_checkbox"),i=[".comiis_wzpost ul li.comiis_flex",".comiis_wzpost ul li.comiis_styli.kmquote",o.parent(o.parent("#pollchecked")),"#pollm_c_1",".comiis_polloption_add+div.f_0",".comiis_wzpost ul li.comiis_thread_content:contains('内容')","div#comiis_head","div#comiis_head+*:not([class])"];o.hasClass(t,"comiis_checkbox_close")?i.forEach(n=>{n&&o.hide(n,false);}):i.forEach(n=>{n&&o.show(n,false);}),window.dispatchEvent(new Event("resize"));});}},ve={init(){o.ready(()=>{v.execMenuOnce("mt-forum-post-publish-editorOptimization",()=>{ht.init();});});}},qe={$flag:{showUserUID_initCSS:false},init(){(T.isPage()||T.isGuide()||T.isPlate()||T.isPost()||T.isSearch()||T.isSpace())&&v.execMenuOnce("mt-show-user-uid",()=>{this.showUserUID();}),(T.isSearch()||T.isGuide()||T.isSpace()||T.isPlate())&&v.execMenuOnce("mt-small-window",()=>{Ft.init();}),T.isPost()?(u.info("Router: 帖子"),Ut.init()):T.isSearch()?(u.info("Router: 搜索"),ce.init()):T.isKMiSign()?(u.info("Router: 签到"),me.init()):T.isSpace()||T.isSpaceWithAt()?(u.info("Router: 空间"),de.init()):T.isGuide()?(u.info("Router: 导读"),ge.init()):T.isPostPublish()?(u.info("Router: 发帖页面"),ve.init()):u.error("Router: 未适配的链接 ==> "+window.location.href),o.ready(()=>{v.execMenuOnce("mt-black-home",()=>{ie.init();}),v.execMenuOnce("mt-online-user",()=>{se.init();}),v.execMenuOnce("mt-post-paidThemePost",()=>{lt.init();}),v.execMenuOnce("mt-ownBlock",()=>{fe.init();}),v.execMenuOnce("mt-post-comment-filter",()=>{be.init();}),v.execMenuOnce("mt-productListingReminder",()=>{_e.init();}),v.execMenuOnce("mt-customizeUserLabels",()=>{ye.init();}),v.execMenuOnce("mt-link-text-to-hyperlink",()=>{ae();}),v.execMenu("mt-auto-sign",()=>{gt.init();}),v.execMenu("mt-extend-cookie-expire",()=>{this.extendCookieExpire();});});},showUserUID(){u.info("显示用户UID"),this.$flag.showUserUID_initCSS||(this.$flag.showUserUID_initCSS=true,G(`
			.postli_top_tximg + h2{
 				height: auto;
			}
			...
			`));let e=new p.LockFunction(()=>{let t=p.getNodeListValue(H.comiisForumList(),H.comiisPostli(),H.comiisMmlist());t.length&&t.forEach(i=>{if(i.querySelector(".gm-custom-label-uid"))return;let s=Array.from(i.querySelectorAll("a")).map(a=>{let l=a.href.match(J.uid);if(l)return l[l.length-1]}).filter(a=>a!=null);if(s.length){let a=s[0],r=document.createElement("a"),l=i.querySelector(".top_lev");r.className=l.className,r.classList.add("gm-custom-label-uid"),r.style.cssText="background: #FF7600 !important;",r.innerHTML="UID:"+a,o.on(r,"click",async c=>{p.preventEvent(c),await p.setClip(a)?f.success(`${a}已复制`):f.error(`${a}复制失败`);}),l.parentElement.append(r);}});});p.mutationObserver(document,{config:{subtree:true,childList:true},callback(){e.run();}});},async extendCookieExpire(){u.info("延长cookie有效期");let e=await $t.cookie.list({}),t=["_auth","_saltkey","_client_created","_client_token"];e.forEach(async i=>{if(i.session)return;let n=i.expirationDate,s=Date.now()/1e3;if(n<s)return;let a=60*60*24*30;n-s>a||!t.find(l=>i.name.endsWith(l))||$t.cookie.set({name:i.name,value:i.value,expirationDate:i.expirationDate+a}).then(()=>{u.info(`延长Cookie +30天成功：${i.name}`);}).catch(()=>{u.error(`延长Cookie +30天失败：${i.name}`);});});}},Et=function(e,t,i,n,s,a){let r=[];typeof n=="function"?r=n():r=n;let l={text:e,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[M].get(t,i)},callback(c,m,d){let h=m;if(u.info(`选择：${d}`),typeof s=="function"&&s(c,h,d))return;this.props[M].set(t,h);},data:r};return Reflect.set(l.attributes,et,t),Reflect.set(l.attributes,it,i),bt.initComponentsStorageApi("select",l,{get(c,m){return v.getValue(c,m)},set(c,m){v.setValue(c,m);}}),l},ft=function(e,t,i,n,s,a,r,l,c,m){let d={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:s,buttonIconIsLoading:a,buttonType:r,buttonText:i,callback(h){typeof l=="function"&&l(h);},afterAddToUListCallBack:c};return Reflect.set(d.attributes,vt,()=>{d.disable=false;}),d},Lt=function(e,t,i,n){let s={type:"own",attributes:{},props:i,getLiElementCallBack:e,afterAddToUListCallBack:n};return Reflect.set(s.attributes,vt,()=>false),s},ot={$upload:{small:false,middle:false,big:false},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return ot.$el.$smallUpload.files[0]},get middle(){return ot.$el.$middleUpload.files[0]},get big(){return ot.$el.$bigUpload.files[0]}},showView(){const e=this;let t=D.confirm({title:{text:"修改头像",position:"center"},content:{text:`
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,i,n){o.on(e,"change",s=>{if(!e.files?.length)return;o.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let a=e.files[0],r=a.size,l=new Image,c=new FileReader;c.readAsDataURL(a),c.onload=function(m){l.src=m.target.result,l.onload=function(){if(l.width>i.width||l.height>i.height){e.value="",t.setAttribute("data-success","false"),o.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${l.width} 高：${l.height}`);return}if(r>ot.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),o.text(t,`🤡校验失败 ==> 图片大小不符合：${r}byte，限制最大：${ot.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),o.text(t,`🤣 通过 宽:${l.width} 高:${l.height} 大小(byte):${r}`),n();};};});},async getUploadUrl(){let e=await N.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":p.getRandomPCUA()}});if(!e.status)return;if(p.isNull(e.data.responseText)){f.error("动态头像：获取上传地址失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){f.error("动态头像：获取变量data失败");return}let n=t[t.length-1].split(","),s=n.indexOf("stl_src");if(s===-1&&(s=n.indexOf("src")),s===-1){f.error("动态头像：获取上传地址失败");return}let a=n[s+1],r=new URL(a);return r.pathname=r.pathname.replace("/images/camera.swf","/index.php"),r.searchParams.delete("inajax"),r.searchParams.set("m","user"),r.searchParams.set("a","rectavatar"),r.searchParams.set("base64","yes"),a=r.toString(),u.info("上传地址："+a),a}},$e={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[Et("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,i)=>{u.info("设置当前Qmsg弹出位置"+i);},"Toast显示在页面九宫格的位置"),Et("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),I("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[I("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),I("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie"),mt("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[I("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),I("显示用户UID","mt-show-user-uid",true,void 0,"格式为UID：xxx"),I("小窗模式","mt-small-window",true,void 0,"开启后点击帖子右侧区域为小窗打开"),I("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{text:"额外菜单项",type:"deepMenu",forms:[{type:"forms",text:"",forms:[I("小黑屋","mt-black-home",true,void 0,"将会在左侧面板添加【小黑屋】菜单"),I("在线用户","mt-online-user",true,void 0,"将会在左侧面板添加【在线用户】菜单"),I("付费主题白嫖提醒","mt-post-paidThemePost",true,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),I("我的屏蔽","mt-ownBlock",true,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),I("商品上架提醒","mt-productListingReminder",true,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),I("自定义用户标签","mt-customizeUserLabels",true,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),I("评论过滤器","mt-post-comment-filter",true,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",forms:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"forms",forms:[Lt(e=>{let t=o.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											`}),n=o.createElement("style",{innerHTML:`
											.avatar-img {
												width: 30px;
												height: 30px;
												border-radius: 50%;
										...
										`});return i.querySelector(".avatar-img[data-size='small']"),i.querySelector(".avatar-img[data-size='middle']"),i.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(i),e.appendChild(n),e}),Lt(e=>{let t=o.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return e.appendChild(t),e.appendChild(i),e}),ft("修改头像",`可以上传gif图片，注意图片最大限制为${Y.formatByteToSize(ot.$data.avatarInfo.maxSize)}`,"上传",void 0,false,false,"primary",()=>{ot.showView();})]}]}]}]},ke={id:"component-forum-post",title:"帖子",forms:[{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[I("自动展开内容","mt-forum-post-autoExpandContent",true,void 0,"注入CSS展开帖子的内容"),I("修复图片宽度","mt-forum-post-repairImageWidth",true,void 0,"修复图片宽度超出页面宽度的问题"),I("移除帖子字体效果","mt-forum-post-removeFontStyle",false,void 0,""),I("移除评论区的字体效果","mt-forum-post-removeCommentFontStyle",false,void 0,""),I("添加【点评】按钮","mt-forum-post-addCommentOnBtn",false,void 0,"在评论区的每个评论右下角添加按钮"),I("附件点击提醒","mt-forum-post-setAttachmentsClickTip",true,void 0,"阻止默认点击附件就会触发附件下载"),I("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮"),I("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片")]}]},{text:"自动加载评论",type:"deepMenu",forms:[{type:"forms",text:"",forms:[I("自动加载下一页评论","mt-forum-post-loadNextPageComment",true,void 0,""),I("同步加载的地址","mt-forum-post-syncNextPageUrl",false,void 0,"便于刷新页面会停留在当前查看的评论页面")]}]},{text:"编辑器-简略版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[I("启用","mt-forum-post-editorOptimizationNormal",true,void 0,"优化样式，插入bbcode代码等"),I("自动保存输入记录","mt-forum-post-editorOptimizationNormal-recordInputText",true,void 0,"当回复时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async e=>{let n=e.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await tt.clearAllReplyRecord();s.success?(f.success("清理成功"),o.text(n,`当前占用空间大小：${await tt.getReplyRecordSize()}`)):f.error("清理失败 "+s.msg);},async(e,t)=>{let i=t.target.querySelector(".pops-panel-item-left-desc-text");o.text(i,`当前占用空间大小：${await tt.getReplyRecordSize()}`);})]}]},{text:"编辑器-完整版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[I("启用","mt-forum-post-publish-editorOptimization",true,void 0,"优化样式，插入bbcode代码，双列预览等"),I("自动保存输入记录","mt-forum-post-editorOptimization-recordInputText",true,void 0,"当回复/发表时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async e=>{let n=e.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await ht.clearAllReplyRecord();s.success?(f.success("清理成功"),o.text(n,`当前占用空间大小：${await ht.getReplyRecordSize()}`)):f.error("清理失败 "+s.msg);},async(e,t)=>{let i=t.target.querySelector(".pops-panel-item-left-desc-text");o.text(i,`当前占用空间大小：${await ht.getReplyRecordSize()}`);})]}]},{text:"编辑器-图床配置",type:"deepMenu",forms:[{type:"forms",text:'<a href="https://www.helloimg.com/" target="_blank">Hello图床</a>',forms:[I("启用","mt-image-bed-hello-enable",false,void 0,"启用Hello图床"),B("账号","mt-image-bed-hello-account","","",void 0,"必填"),B("密码","mt-image-bed-hello-password","","",void 0,"必填",false,true),B("token","mt-image-bed-hello-token","","",void 0,"必填",false,true)]},{type:"forms",text:'<a href="https://img.binmt.cc/" target="_blank">MT图床</a>',forms:[I("启用","mt-image-bed-mt-enable",true,void 0,"启用MT图床")]},{type:"forms",text:"图片水印",forms:[I("启用","mt-image-bed-watermark-enable",false,void 0,"开启后会为图床图片添加文字水印"),I("自动添加水印","mt-image-bed-watermark-autoAddWaterMark",false,void 0,"开启后会自动添加水印，关闭后会有添加水印后的图片预览"),B("水印文字","mt-image-bed-watermark-text","MT论坛"),B("颜色","mt-image-bed-watermark-text-color","#000000",void 0,void 0,"",false,false,(e,t)=>{let i=t.target?.querySelector("input"),n=t.target?.querySelector(".pops-panel-input__suffix");o.hide(n,false),i.setAttribute("type","color"),o.css(i,{margin:"unset",padding:"unset",width:"80px"});}),B("大小","mt-image-bed-watermark-font-size",16,void 0,void 0,void 0,true),B("透明度","mt-image-bed-watermark-font-opacity",1,void 0,void 0,void 0,true),B("左右间距","mt-image-bed-watermark-left-right-margin",80,void 0,void 0,void 0,true),B("上下间距","mt-image-bed-watermark-top-bottom-margin",80,void 0,void 0,void 0,true),B("旋转角度","mt-image-bed-watermark-rotate",45,void 0,void 0,void 0,true)]}]}]}]},Se={id:"component-search",title:"搜索",forms:[{type:"forms",text:"",forms:[I("显示搜索历史","mt-search-showSearchHistory",true,void 0,"自动记住搜索历史并显示"),I("修复清空按钮","mt-search-repairClearBtn",true,void 0,"修复点击清空按钮不清空输入框的问题"),I("搜索框自动获取焦点","mt-search-searchInputAutoFocus",true,void 0,"")]}]},Ce={id:"component-sigh",title:"签到",forms:[{text:"功能",type:"forms",forms:[I("显示【今日签到之星】","mt-sign-showTodaySignStar",true,void 0,"在签到按钮上面显示今日签到之星"),I("显示【今日最先】","mt-sign-showTodayRanking",true,void 0,"在签到排名上面新增【今日最先】")]},{text:"自动签到",type:"forms",forms:[I("启用","mt-auto-sign",true,void 0,"自动请求签到"),I("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),ft("签到信息",`上次签到时间：${(()=>{let e=gt.getHostNameSignInfo(window.location.hostname);return e?Y.formatTime(e.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",e=>{let i=e.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");D.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:n=>{let s=window.location.hostname;gt.clearSignInfo(s),f.success("删除成功"),o.text(i,`上次签到时间：${(()=>{let a=gt.getHostNameSignInfo(s);return a?Y.formatTime(a.time):"尚未签到"})()}`),n.close();}}},width:"88vw",height:"200px"});})]}]},Te={id:"component-space",title:"空间",forms:[{type:"forms",text:"",forms:[I("修复无法进入空间","mt-space-repairEnterSpace",true,void 0,"修复链接错误导致不能进入空间的问题"),I("显示帖子回复内容","mt-space-showCommentContent",true,void 0,"在帖子-回复下面显示具体评论的内容")]}]},Ie={id:"component-guide",title:"导读",forms:[{type:"forms",text:"",forms:[I("显示最新帖子","mt-guide-showLatestPost",true,void 0,"在最上面显示最新发布的帖子")]}]};dt.addContentConfig([$e,ke,Se,Ce,Te,Ie]);v.init();H.registerLeftMenu({name:"MT论坛脚本设置",icon:"",iconColor:"#ff0505",iconSize:"23px",callback:()=>{v.showPanel(dt.getConfig(0));}});qe.init();

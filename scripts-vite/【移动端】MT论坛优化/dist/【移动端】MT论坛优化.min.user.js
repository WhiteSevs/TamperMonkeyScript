...
(function (b, j, X, _e, ye, Be) {
  'use strict';

  var Ae=typeof GM<"u"?GM:void 0,ne=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,De=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,Z=typeof GM_getValue<"u"?GM_getValue:void 0,ge=typeof GM_info<"u"?GM_info:void 0,xe=typeof GM_listValues<"u"?GM_listValues:void 0,Xe=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,W=typeof GM_setValue<"u"?GM_setValue:void 0,Pe=typeof GM_setValues<"u"?GM_setValues:void 0,et=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,tt=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,w=typeof unsafeWindow<"u"?unsafeWindow:void 0,it=window;const de={waitRemove(...e){e.forEach(t=>{typeof t=="string"&&j.waitNodeList(t).then(i=>{i.forEach(n=>n.remove());});});},createBlockCSSNode(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(i=>{Array.isArray(i)?t=t.concat(i):t.push(i);}),j.createElement("style",{type:"text/css",innerHTML:`${t.join(`,
`)}{display: none !important;}`})},addBlockCSS(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(i=>{Array.isArray(i)?t=t.concat(i):t.push(i);}),Y(`${t.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof De=="function"?De(e.keyName):null;return typeof t=="string"&&t?Y(t):de.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(i=>{j.ready(()=>{document.head.appendChild(t),i(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(i=>{t.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
			.pops-overflow-hidden-important {
				overflow: hidden !important;
			}
		`;let i=[document.documentElement,document.body].concat(...e||[]);return i.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){i.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(a=>{n(a);}).catch(a=>{h.error("读取剪贴板内容失败👉",a),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(a=>{e(n);}).catch(a=>{h.error("申请剪贴板权限失败，尝试直接读取👉",a.message??a.name??a.stack),e(n);});}function i(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!i()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,i=5e3){let n,a=i-t,o=t,r=async l=>{let c=await e(l);if(typeof c=="boolean"&&!c||l){g.workerClearTimeout(n);return}if(o+=t,o>a){r(true);return}n=g.workerSetTimeout(()=>{r(false);},t);};r(false);},findParentNode(e,t,i){if(i){let n=j.closest(e,i);if(n)return n.querySelector(t)}else return j.matches(e,t)?e:j.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(n,a)=>a===void 0?t:a,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},Fe={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}},te={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false},httpx_cookie_manager_enable:{key:"httpx-use-cookie-enable",defaultValue:false},httpx_cookie_manager_use_document_cookie:{key:"httpx-use-document-cookie",defaultValue:false}},g=X.noConflict(),s=j.noConflict(),V=_e,h=new g.Log(ge,w.console||it.console);let Ee=ge?.script?.name||void 0;const nt=_e.config.Utils.AnyTouch(),st=false;h.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});b.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.getSetting().type;if(t==="loading")return  false;const i=e.getSetting().content;return t==="warning"?h.warn(i):t==="error"?h.error(i):h.info(i),true},get position(){return k.getValue(te.qmsg_config_position.key,te.qmsg_config_position.defaultValue)},get maxNums(){return k.getValue(te.qmsg_config_maxnums.key,te.qmsg_config_maxnums.defaultValue)},get showReverse(){return k.getValue(te.qmsg_config_showreverse.key,te.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=X.getMaxZIndex(),t=_e.config.InstanceUtils.getPopsMaxZIndex().zIndex;return X.getMaxValue(e,t)+100}});V.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=X.getMaxZIndex(void 0,void 0,i=>{if(i?.classList?.contains("qmsg-shadow-container")||i?.closest("qmsg")&&i.getRootNode()instanceof ShadowRoot)return  false}),t=_e.config.InstanceUtils.getPopsMaxZIndex().zIndex;return X.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const at=new g.GM_Menu({GM_getValue:Z,GM_setValue:W,GM_registerMenuCommand:Xe,GM_unregisterMenuCommand:et}),U=new g.Httpx({xmlHttpRequest:tt,logDetails:st});U.interceptors.request.use(e=>e);U.interceptors.response.use(void 0,e=>(h.error("拦截器-请求错误",e),e.type==="onabort"?b.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?b.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?b.error("请求超时",{consoleLogContent:true}):b.error("其它错误",{consoleLogContent:true}),e));w.Object.defineProperty,w.Function.prototype.apply,w.Function.prototype.call,w.Element.prototype.appendChild,w.setTimeout;const Y=s.addStyle.bind(s),C=j.selector.bind(j),F=j.selectorAll.bind(j);new g.GM_Cookie;const qe="GM_Panel",Ie="data-init",se="data-key",ae="data-default-value",ot="data-init-more-value",Oe="data-plugin-search-config",P="data-storage-api",le={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},ce={setting:{get width(){return le.width<550?"88vw":le.width<700?"550px":"700px"},get height(){return le.height<450?"70vh":le.height<550?"450px":"550px"}},settingMiddle:{get width(){return le.width<350?"88vw":"350px"}},info:{get width(){return le.width<350?"88vw":"350px"},get height(){return le.height<250?"88vh":"250px"}}};class rt{storageKey;listenerData;constructor(t){if(typeof t=="string"){const i=t.trim();if(i=="")throw new Error("key参数不能为空字符串");this.storageKey=i;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new X.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let t=Z(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){W(this.storageKey,t);}set(t,i){const n=this.get(t),a=this.getLocalValue();Reflect.set(a,t,i),this.setLocalValue(a),this.triggerValueChangeListener(t,n,i);}get(t,i){const n=this.getLocalValue();return Reflect.get(n,t)??i}getAll(){return this.getLocalValue()}delete(t){const i=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,i,void 0);}has(t){const i=this.getLocalValue();return Reflect.has(i,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(i=>Reflect.get(t,i))}clear(){ne(this.storageKey);}addValueChangeListener(t,i){const n=Math.random(),a=this.listenerData.get(t)||[];return a.push({id:n,key:t,callback:i}),this.listenerData.set(t,a),n}removeValueChangeListener(t){let i=false;for(const[n,a]of this.listenerData.entries()){for(let o=0;o<a.length;o++){const r=a[o];(typeof t=="string"&&r.key===t||typeof t=="number"&&r.id===t)&&(a.splice(o,1),o--,i=true);}this.listenerData.set(n,a);}return i}async triggerValueChangeListener(...t){const[i,n,a]=t;if(!this.listenerData.has(i))return;let o=this.listenerData.get(i);for(let r=0;r<o.length;r++){const l=o[r];if(typeof l.callback=="function"){let c=this.get(i),m,d;typeof n<"u"&&t.length>=2?d=n:d=c,typeof a<"u"&&t.length>2?m=a:m=c,await l.callback(i,d,m);}}}}const re=new rt(qe),be={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new g.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const i=(o,r)=>{typeof r!="string"&&(r=de.toStr(r));const l=new Blob([r]),c=globalThis.URL.createObjectURL(l);s.createElement("a",{href:c,download:o}).click(),g.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(c);},500);},n=()=>{const o=u=>{const p=V.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),m={};if(typeof xe=="function")xe().forEach(p=>{const y=Z(p);Reflect.set(m,p,y);});else {b.warning("不支持函数GM_listValues，仅导出菜单配置");const u=Z(qe);Reflect.set(m,qe,u);}const d=de.toStr(m);c.value=d;},a=()=>{let o=ge?.script?.supportURL||ge?.script?.namespace;typeof o=="string"&&g.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${ge?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(){return  false},afterRender(o){new nt(o.$asideLiElement).on("tap",function(l){clearTimeout(t),t=void 0,e?(e=false,n()):(t=setTimeout(()=>{e=false,a();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},lt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{k.showPanel(be.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){k.isTopWindow()&&at.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let i=this.$data.menuOption.findIndex(n=>n.key===t.key);i!==-1&&(this.$data.menuOption[i]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},k={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new g.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new g.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new g.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new g.Dictionary),this.__onceExecData},get scriptName(){return Ee},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:qe,attributeKeyName:se,attributeDefaultValueName:ae},init(){this.initContentDefaultValue(),lt.init();},isTopWindow(){return w.top===w.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const a=n.attributes;let o=a[Ie];if(typeof o=="function"){let m=o();if(typeof m=="boolean"&&!m)return}let r=new Map,l=a[se];if(l!=null){const m=a[ae];r.set(l,m);}let c=a[ot];if(typeof c=="object"&&c&&Object.keys(c).forEach(m=>{const d=c[m];r.set(m,d);}),!r.size){h.warn(["请先配置键",n]);return}if(n.type==="switch"){let m=typeof n.disabled=="function"?n.disabled():n.disabled;typeof m=="boolean"&&m&&this.$data.contentConfigInitDisabledKeys.push(...r.keys());}for(const[m,d]of r.entries())this.setDefaultValue(m,d);},t=n=>{for(let a=0;a<n.length;a++){let o=n[a];e(o);let r=o.forms;r&&Array.isArray(r)&&t(r);}},i=[...be.getAllContentConfig()];for(let n=0;n<i.length;n++){let a=i[n];if(!a.forms)continue;const o=a.forms;o&&Array.isArray(o)&&t(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&h.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){re.set(e,t);},getValue(e,t){const i=re.get(e);return i??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){re.delete(e);},hasKey(e){return re.has(e)},addValueChangeListener(e,t){return re.addValueChangeListener(e,(n,a,o)=>{t(e,o,a);})},removeValueChangeListener(e){re.removeValueChangeListener(e);},triggerMenuValueChange(e,t,i){re.triggerValueChangeListener(e,i,t);},async exec(e,t,i,n=true){const a=this;let o;typeof e=="string"||Array.isArray(e)?o=()=>e:o=e;let r=false;const l=o();let c=[];Array.isArray(l)?(r=true,c=l):c.push(l);const m=c.find(I=>!this.$data.contentConfigInitDefaultValue.has(I));if(m){h.warn(`${m} 键不存在`);return}const d=JSON.stringify(c);if(n&&this.$data.onceExecMenuData.has(d))return this.$data.onceExecMenuData.get(d);let u=[];const p=[];let y=[];const x=(I,M)=>{let B=[],N=[],_=[];if(Array.isArray(M))_=_.concat(M);else if(typeof M=="object"&&M!=null)if(M instanceof Element)_.push(M);else {const{$css:f,destory:q}=M;f!=null&&(Array.isArray(f)?_=_.concat(f):_.push(f)),typeof q=="function"&&_.push(q);}else _.push(M);for(const f of _)if(f!=null){if(f instanceof Element){B.push(f);continue}if(typeof f=="function"){y.push(f);continue}}I?(u=u.concat(B),y=y.concat(N)):($(),S());},v=I=>!!this.getValue(I),$=()=>{for(let I=0;I<u.length;I++)u[I]?.remove(),u.splice(I,1),I--;},S=()=>{for(let I=0;I<y.length;I++){const M=y[I];M(),y.splice(I,1),I--;}},T=()=>{let I=false;return typeof i=="function"?I=i(c):I=c.every(M=>v(M)),I},R=async I=>{if(T()){const B=c.map(_=>this.getValue(_)),N=await t({value:r?B:B[0],addStoreValue:(..._)=>x(true,_)});x(true,N);}else x(false,[]);};n&&c.forEach(I=>{const M=this.addValueChangeListener(I,(B,N,_)=>R());p.push(M);}),await R();const E={reload(){this.clearStoreStyleElements(),this.destory(),R();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>$(),destory(){return S()},removeValueChangeListener:()=>{p.forEach(I=>{this.removeValueChangeListener(I);});},clearOnceExecMenuData(){n&&a.$data.onceExecMenuData.delete(d);}};return this.$data.onceExecMenuData.set(d,E),E},async execMenu(e,t,i=false,n=false){return await this.exec(e,async a=>await t(a),a=>a.every(r=>{let l=!!this.getValue(r);return k.$data.contentConfigInitDisabledKeys.includes(r)&&(l=false,h.warn(`.execMenu${n?"Once":""} ${r} 被禁用`)),i&&(l=!l),l}),n)},async execMenuOnce(e,t,i=false,n=false){const a=await this.execMenu(e,t,i,true);if(n&&a){const o=()=>{a.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,o);}return a},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),re.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async triggerUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const i of t)await i(e);},showPanel(e,t=`${Ee}-设置`,i=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let a=e.findIndex(r=>(typeof r.isBottom=="function"?r.isBottom():!!r.isBottom)&&r.id==="script-version")!==-1;!i&&!a&&e.push(...be.getDefaultBottomContentConfig());let o=V.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(r,l)=>{r.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(r,l)=>{r(),this.$data.$panel=null;}},width:ce.setting.width,height:ce.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:o,content:e});},registerConfigSearch(e){const{$panel:t,content:i}=e,n=async(p,y)=>{if(p==null)return;const x=await y(p);return x&&typeof x.isFind=="boolean"&&x.isFind?x.data:await n(x.data,y)},a=(p,y)=>{const x=new IntersectionObserver(v=>{v.forEach($=>{$.isIntersecting&&(y?.(),x.disconnect());});},{root:null,threshold:1});x.observe(p),p.scrollIntoView({behavior:"smooth",block:"center"});},o=p=>{const y="pops-flashing";s.animationend(p,()=>{p.classList.remove(y);}),p.classList.add(y);},r=p=>{if(p.type==="dblclick"&&u)return;s.preventEvent(p),c=null;const y=V.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`}));},transformKey(e){if(Array.isArray(e)){const t=e.sort();return JSON.stringify(t)}else return e}};class ct{$data={get enable(){return k.getValue(te.httpx_cookie_manager_enable.key,te.httpx_cookie_manager_enable.defaultValue)},get useDocumentCookie(){return k.getValue(te.httpx_cookie_manager_use_document_cookie.key,te.httpx_cookie_manager_use_document_cookie.defaultValue)},cookieRule:[]};constructor(t){Array.isArray(t)&&(this.$data.cookieRule=t);}fixCookieSplit(t){return g.isNotNull(t)&&!t.trim().endsWith(";")&&(t+=";"),t}concatCookie(t,i){return g.isNull(t)?i:(t=t.trim(),i=i.trim(),t=this.fixCookieSplit(t),i.startsWith(";")&&(i=i.substring(1)),t.concat(i))}handle(t){if(t.fetch||!this.$data.enable)return;let i="",n=t.url;n.startsWith("//")&&(n=window.location.protocol+n);let a=new URL(n);this.$data.useDocumentCookie&&a.hostname.endsWith(window.location.hostname.split(".").slice(-2).join("."))&&(i=this.concatCookie(i,document.cookie.trim()));for(let o=0;o<this.$data.cookieRule.length;o++){let r=this.$data.cookieRule[o];if(a.hostname.match(r.hostname)){let l=k.getValue(r.key);if(g.isNull(l))break;i=this.concatCookie(i,l);}}g.isNotNull(i)&&(t.headers&&t.headers.Cookie?t.headers.Cookie=this.concatCookie(t.headers.Cookie,i):t.headers.Cookie=i,h.info(["Httpx => 设置cookie:",t])),t.headers&&t.headers.Cookie!=null&&g.isNull(t.headers.Cookie)&&delete t.headers.Cookie;}}de.setGMResourceCSS(Fe.Viewer);de.setGMResourceCSS(Fe.Hljs);const mt=new ct([{key:"httpx-cookie-bbs.binmt.cc",hostname:/bbs.binmt.cc/g}]);U.interceptors.request.use(e=>(mt.handle(e),e));V.GlobalConfig.setGlobalConfig({mask:{enable:true},drag:true});const G={registerLeftMenu(e){s.waitNode(".comiis_sidenv_box .sidenv_li .comiis_left_Touch",1e4).then(t=>{if(!t){h.error("注册左侧面板菜单失败，原因：该元素不存在");return}let i=s.createElement("li",{className:"comiis_left_Touch",innerHTML:`
						<a href="javascript:;" class="comiis_left_Touch">
							<i class="comiis_font"></i>
							${e.name}
						</a>
						`}),n=i.querySelector(".comiis_font");typeof e.style=="string"&&(n.style.cssText=e.style),typeof e.icon=="string"&&(n.innerHTML=e.icon),typeof e.iconColor=="string"&&(n.style.color=e.iconColor),typeof e.iconSize=="string"&&(n.style.fontSize=e.iconSize),s.on(i,"click",a=>{s.preventEvent(a),typeof e.callback=="function"&&e.callback();}),s.append(t,i);});},comiisForumList:()=>document.querySelectorAll("li.forumlist_li"),comiisPostli:()=>document.querySelectorAll("div.comiis_postli.comiis_list_readimgs.nfqsqi"),comiisMmlist:()=>document.querySelectorAll(".comiis_mmlist")},dt=`.pops-confirm-content {\r
  display: flex;\r
...
`,ht={$data:{},init(){this.registerMenu();},registerMenu(){G.registerLeftMenu({name:"在线用户",iconColor:"#2d92ff",icon:"",callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let e=b.loading("正在获取在线用户名单中..."),t=await this.getOnlineUserListInfo();if(e.close(),!t)return;let i=V.alert({title:{text:"在线用户",position:"center"},content:{text:`
...
`)}    
...
]*;`,relevance:0},{begin:"[vp][0-9]+"}]}}this.$flag.isSetHljsCSS||(ye.registerLanguage("smali",e),Y(`
        ...
        `),j.ready(()=>{k.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),k.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),k.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){h.info("显示搜索历史");let e=Z("search_history",[]),t=C("#scform_srchtxt"),i=C("#searchform");const n=e.map(l=>({value:l,enableDeleteButton:true,deleteButtonClickCallback(c,m,d,u){let p=e.findIndex(y=>y===d.value);p!==-1&&(e.splice(p,1),W("search_history",e)),m.remove();},itemView(c,m,d){return c.value},clickCallback(c,m,d,u){t.value=d.value,i.submit();}}));let a=V.searchSuggestion({target:t,inputTarget:t,data:n,inputTargetChangeRefreshShowDataCallback(l,c,m){return n.filter(d=>d.value.includes(l))}});a.init(),a.setAllEvent();function o(){let l=document.querySelector("#scform_submit");j.on(l,"click",function(){let c=t.value;if(c!=""){let m=Z("search_history",[]);m.includes(c)?h.info("已有该搜索历史记录"):(h.info("无该记录，追加"),m.push(c)),W("search_history",m);}});}function r(){let c='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+Z("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    ...
                    min-width: 20vw;
                    width: 20vw;
                ">清理记录</button></div>`;j.before(document.querySelector(".comiis_p12"),c);let m=document.querySelector(".btn_clear_search_history");j.on(m,"click",d=>{j.preventEvent(d),ne("search_history"),window.location.reload();});}o(),r();},repairClearBtn(){j.waitNode("a.ssclose").then(e=>{h.info("修复清空按钮"),j.on(e,"click",t=>{let i=document.querySelector("#scform_srchtxt");i?i.value="":b.error("获取输入框失败");},{capture:true});});},searchInputAutoFocus(){new URLSearchParams(window.location.search).has("kw")||j.waitNode("#scform_srchtxt").then(t=>{h.info("搜索框自动获取焦点"),t.focus();});}},xt={init(){s.ready(()=>{k.execMenuOnce("mt-sign-showTodaySignStar",()=>{this.showTodaySignStar();}),k.execMenuOnce("mt-sign-showTodayRanking",()=>{this.showTodayRanking();});});},async showTodaySignStar(){h.info("显示【今日签到之星】");let e=document.querySelector(".pg_k_misign .comiis_qdinfo"),t=document.createElement("ul"),i=await U.get("/k_misign-sign.html",{headers:{"User-Agent":g.getRandomPCUA()}});if(!i.status)return;let a=s.toElement(i.data.responseText,true,true).querySelector("#pt span.xg1");if(!a)return;let o=s.text(a).replace("今日签到之星：","");t.innerHTML=`
		<li class="f_f" style="display: flex;flex-direction: column;width: 100%;">
			<span class="comiis_tm">今日签到之星</span>
			${o}
		</li>
		`;let r=document.querySelector(".comiis_space_box"),l=parseInt(getComputedStyle(r,null).height.replace("px","")),c=parseInt(getComputedStyle(r,null).paddingBottom.replace("px","")),m=l+c+50;Y(`
		.comiis_space_box{
			height: ${m}px;
...
`;class qt{isBacking=false;config;constructor(t){this.config=t,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(t){s.preventEvent(t),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){h.success("进入手势模式");let t=this.config.hash;t.startsWith("#")||(t.startsWith("/")||(t="/"+t),t="#"+t),this.config.useUrl&&(t=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+t),this.config.win.history.pushState({},"",t),h.success("监听popstate事件"),s.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(t=false){this.isBacking=true,h.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(t);let i=Date.now()+1e3*5;for(;;){if(Date.now()>i){h.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))h.info("history.back()"),this.config.win.history.back(),await X.sleep(this.config.backDelayTime||150);else break}h.success("移除popstate事件"),s.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(t);}}const ue={https:`
        ...
        <div class="small-window-title-container">
            ...
            `);var i="";g.sortListByProperty(t,a=>{var o=a.href.match(/thread-(.+?)-/i);return parseInt(o[o.length-1])},true),h.info("导读内容",t),t.forEach(a=>{i+=`
                ...
                </li>`;});let n=document.querySelector(".comiis_forumlist.comiis_xznlist");j.before(n,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}},ke={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new X.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,i){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=i,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,P,t);}},H=function(e,t,i,n,a,o="",r,l,c,m){const d={text:e,type:"input",isNumber:!!r,isPassword:!!l,attributes:{},props:{},description:n,afterAddToUListCallBack:c,getValue(){return this.props[P].get(t,i)},callback(u,p,y){this.props[P].set(t,p);},placeholder:o};return Reflect.set(d.attributes,se,t),Reflect.set(d.attributes,ae,i),ke.initComponentsStorageApi("input",d,{get(u,p){return k.getValue(u,p)},set(u,p){k.setValue(u,p);}}),d},A=function(e,t,i,n,a,o,r,l){const c={text:e,type:"switch",description:a,disabled:r,attributes:{},props:{},getValue(){return this.props[P].get(t,i)},callback(m,d){const u=!!d;h.success(`${u?"开启":"关闭"} ${e}`),this.props[P].set(t,u);},afterAddToUListCallBack:o};return Reflect.set(c.attributes,se,t),Reflect.set(c.attributes,ae,i),ke.initComponentsStorageApi("switch",c,{get(m,d){return k.getValue(m,d)},set(m,d){k.setValue(m,d);}}),c};class Je{option;constructor(t){this.option=t;}async showView(){let t=V.confirm({title:{text:this.option.title,position:"center"},content:{text:`
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return Z(this.$key.STORAGE_KEY,this.getTemplateData())},setData(e){W(this.$key.STORAGE_KEY,e);}},Tt={$key:{STORAGE_KEY:"mt-productListingReminder-rule"},init(){this.registerMenu(),this.runRule();},registerMenu(){G.registerLeftMenu({name:"商品上架提醒",icon:"",iconColor:"#2376b7",callback:()=>{this.showView();}});},async runRule(){async function e(){let n=await U.get("/keke_integralmall-keke_integralmall.html",{fetch:true,allowInterceptConfig:false});if(!n.status){b.error("【积分商城】获取数据失败");return}let a=[];return s.toElement(n.data.responseText,true,true).querySelectorAll(".task-list-wrapper li.col-xs-12").forEach(r=>{a.push({name:s.text(r.querySelector(".mall-info a > *:first-child"))||s.text(r.querySelector(".mall-info a")),price:s.text(r.querySelector(".mall-info span.discount-price i")),endTime:s.text(r.querySelector(".mall-info #time_hz span.time")),remainingQuantity:parseInt(r.querySelector(".mall-info .mall-count .count-r")?.innerText?.replace(/仅剩|件/gi,"")||"0")});}),a}if(L.isPointsMall())return;let t=this.getData();if(!t.length)return;let i=await e();if(i){for(const n of i)for(const a of t)if(a.enable&&n.name.match(new RegExp(a.productName,"i"))&&!isNaN(n.remainingQuantity)&&n.remainingQuantity>0){h.success("成功匹配对应商品",a,n),V.confirm({title:{text:"积分商城提醒",position:"center"},content:{text:`<br />
                    ...
                    background: ${c.labelColor} !important;${c.labelStyle||""}`,r.innerHTML=c.labelName,s.on(r,"click",async m=>{s.preventEvent(m),g.isNotNull(c.labelClickEvent)&&w.eval(c.labelClickEvent);}),l.parentElement.append(r);});}});},getTemplateData(){return {uuid:g.generateUUID(),enable:true,name:"",userUID:"",labelName:"",labelColor:"",labelStyle:"",labelClickEvent:""}},getData(){return Z(this.$key.STORAGE_KEY,[])},setData(e){W(this.$key.STORAGE_KEY,e);},addData(e){let t=this.getData();return t.findIndex(n=>n.uuid==e.uuid)===-1?(t.push(e),W(this.$key.STORAGE_KEY,t),true):false},updateData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t[i]=e),this.setData(t),n},deleteData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t.splice(i,1)),this.setData(t),n},clearData(){ne(this.$key.STORAGE_KEY);}},It=`.f_c,\r
.f_c a,\r
.ntc_body {\r
...
`);z.length==1?D=`<li>${q}</li>`:Array.from(z).forEach((K,J)=>{J==z.length-1?D=`${D}<li>${K}</li>`:D=`${D}<li>${K}<br></li>`;}),e=e.replace(_,`
        ...
        `);let t=C("#select-post-section"),i=O.getForumId(window.location.href);L.isPostPublish_newthread()?(h.info("发帖"),s.on(t,"change",function(){let n=s.val(t),a=`forum.php?mod=post&action=newthread&fid=${n}&extra=&topicsubmit=yes&mobile=2`;h.info(`修改发帖板块: ${e[n]} ${a}`);let o={求助问答:{className:"gm_user_select_help",optionHTML:`<option value="0" selected="selected">请选择</option>
                        ...
                        `)):Object.keys(o).forEach(l=>{s.remove(".comiis_post_from ."+o[l].className);}),s.attr("#postform","action",a);})):s.attr(t,"disabled",true),s.val(t,i),s.trigger(t,"change");},initCharacterCount(){h.info("添加功能：字符计数"),Y(`
        ...
        <a href="javascript:;" class="comiis_pictitle"><i class="comiis_font"><em>图片</em></i></a>`),s.on(".comiis_pictitle","click",function(){this.querySelector("i.comiis_font").classList.contains("f_0")?s.hide(".gm_plugin_chartbed",false):s.show(".gm_plugin_chartbed",false);}),s.append("#comiis_post_tab",`
            ...
            `);let t=C("#imglist"),i=s.parent(t);s.before(".gm_plugin_chartbed .bqbox_t",i),s.on("#imglist .comiis_font","click",n=>{C("#filedata").click();}),s.on("#comiis_pictitle_tab #comiis_pictitle_key","click","li",function(n){let a=n.target;s.removeClass("#comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),s.addClass(a,"bg_f"),w.$("#comiis_pictitle_tab div.comiis_upbox").hide().eq(w.$(a).index()).fadeIn();}),k.execMenuOnce("mt-image-bed-hello-enable",()=>{je.init();}),k.execMenuOnce("mt-image-bed-mt-enable",()=>{Ge.init();});},initPreview(){const e=this;h.info("添加功能：双列预览"),Y(`
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
            ...
            `),s.on("#immersiveinput","click",function(){let e=this,t=s.parent(e).querySelector(".comiis_checkbox"),i=[".comiis_wzpost ul li.comiis_flex",".comiis_wzpost ul li.comiis_styli.kmquote",s.parent(s.parent("#pollchecked")),"#pollm_c_1",".comiis_polloption_add+div.f_0",".comiis_wzpost ul li.comiis_thread_content:contains('内容')","div#comiis_head","div#comiis_head+*:not([class])"];s.hasClass(t,"comiis_checkbox_close")?i.forEach(n=>{n&&s.hide(n,false);}):i.forEach(n=>{n&&s.show(n,false);}),window.dispatchEvent(new Event("resize"));});}},Lt={init(){s.ready(()=>{k.execMenuOnce("mt-forum-post-publish-editorOptimization",()=>{ve.init();});});}},Mt={$flag:{showUserUID_initCSS:false},init(){(L.isPage()||L.isGuide()||L.isPlate()||L.isPost()||L.isSearch()||L.isSpace())&&k.execMenuOnce("mt-show-user-uid",()=>{this.showUserUID();}),(L.isSearch()||L.isGuide()||L.isSpace()||L.isPlate())&&k.execMenuOnce("mt-small-window",()=>{Ze.init();}),L.isPost()?(h.info("Router: 帖子"),Ye.init()):L.isSearch()?(h.info("Router: 搜索"),yt.init()):L.isKMiSign()?(h.info("Router: 签到"),xt.init()):L.isSpace()||L.isSpaceWithAt()?(h.info("Router: 空间"),wt.init()):L.isGuide()?(h.info("Router: 导读"),$t.init()):L.isPostPublish()?(h.info("Router: 发帖页面"),Lt.init()):h.error("Router: 未适配的链接 ==> "+window.location.href),s.ready(()=>{k.execMenuOnce("mt-black-home",()=>{pt.init();}),k.execMenuOnce("mt-online-user",()=>{ht.init();}),k.execMenuOnce("mt-post-paidThemePost",()=>{he.init();}),k.execMenuOnce("mt-ownBlock",()=>{St.init();}),k.execMenuOnce("mt-post-comment-filter",()=>{Ct.init();}),k.execMenuOnce("mt-productListingReminder",()=>{Tt.init();}),k.execMenuOnce("mt-customizeUserLabels",()=>{Et.init();}),k.execMenu("mt-auto-sign",()=>{we.init();}),k.execMenu("mt-extend-cookie-expire",()=>{this.extendCookieExpire();}),L.isPostPublish_edit()||k.execMenuOnce("mt-link-text-to-hyperlink",()=>{gt();});});},showUserUID(){h.info("显示用户UID"),this.$flag.showUserUID_initCSS||(this.$flag.showUserUID_initCSS=true,Y(`
			.postli_top_tximg + h2{
 				height: auto;
			}
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,i,n){s.on(e,"change",a=>{if(!e.files?.length)return;s.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let o=e.files[0],r=o.size,l=new Image,c=new FileReader;c.readAsDataURL(o),c.onload=function(m){l.src=m.target.result,l.onload=function(){if(l.width>i.width||l.height>i.height){e.value="",t.setAttribute("data-success","false"),s.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${l.width} 高：${l.height}`);return}if(r>me.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),s.text(t,`🤡校验失败 ==> 图片大小不符合：${r}byte，限制最大：${me.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),s.text(t,`🤣 通过 宽:${l.width} 高:${l.height} 大小(byte):${r}`),n();};};});},async getUploadUrl(){let e=await U.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":g.getRandomPCUA()}});if(!e.status)return;if(g.isNull(e.data.responseText)){b.error("动态头像：获取上传地址失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){b.error("动态头像：获取变量data失败");return}let n=t[t.length-1].split(","),a=n.indexOf("stl_src");if(a===-1&&(a=n.indexOf("src")),a===-1){b.error("动态头像：获取上传地址失败");return}let o=n[a+1],r=new URL(o);return r.pathname=r.pathname.replace("/images/camera.swf","/index.php"),r.searchParams.delete("inajax"),r.searchParams.set("m","user"),r.searchParams.set("a","rectavatar"),r.searchParams.set("base64","yes"),o=r.toString(),h.info("上传地址："+o),o}},At={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[Ne("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,i)=>{h.info("设置当前Qmsg弹出位置"+i);},"Toast显示在页面九宫格的位置"),Ne("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),A("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[A("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),A("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie"),fe("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[A("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),A("显示用户UID","mt-show-user-uid",true,void 0,"格式为UID：xxx"),A("小窗模式","mt-small-window",true,void 0,"开启后点击帖子右侧区域为小窗打开"),A("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{text:"额外菜单项",type:"deepMenu",forms:[{type:"forms",text:"",forms:[A("小黑屋","mt-black-home",true,void 0,"将会在左侧面板添加【小黑屋】菜单"),A("在线用户","mt-online-user",true,void 0,"将会在左侧面板添加【在线用户】菜单"),A("付费主题白嫖提醒","mt-post-paidThemePost",true,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),A("我的屏蔽","mt-ownBlock",true,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),A("商品上架提醒","mt-productListingReminder",true,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),A("自定义用户标签","mt-customizeUserLabels",true,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),A("评论过滤器","mt-post-comment-filter",true,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",forms:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"forms",forms:[Ue(e=>{const t=s.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return i.querySelector(".avatar-img[data-size='small']"),i.querySelector(".avatar-img[data-size='middle']"),i.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(i),e.appendChild(n),e},void 0,{text:"头像（有缓存）",desc:"小、中、大"}),Ue(e=>{const t=s.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`

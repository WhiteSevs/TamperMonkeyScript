...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Pe=="function"?Pe(e.keyName):null;return typeof t=="string"&&t?K(t):pe.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(i=>{H.onReady(()=>{document.head.appendChild(t),i(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(i=>{t.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let i=[document.documentElement,document.body].concat(...e||[]);return i.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){i.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(a=>{n(a);}).catch(a=>{h.error("读取剪贴板内容失败👉",a),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(a=>{e(n);}).catch(a=>{h.error("申请剪贴板权限失败，尝试直接读取👉",a.message??a.name??a.stack),e(n);});}function i(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!i()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,i=5e3){let n,a=i-t,o=t,r=async l=>{const c=await e(l);if(typeof c=="boolean"&&c||l){f.workerClearTimeout(n);return}if(o+=t,o>a){r(true);return}n=f.workerSetTimeout(()=>{r(false);},t);};r(false);},findParentNode(e,t,i){if(i){let n=H.closest(e,i);if(n)return n.querySelector(t)}else return H.matches(e,t)?e:H.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(n,a)=>a===void 0?t:a,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},f=X.noConflict(),s=H.noConflict(),U=we,h=new f.Log(be,x.console||nt.console),Ee=be?.script?.name||void 0,st=we.config.Utils.AnyTouch(),at=false;h.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});_.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const i=e.setting.content;return t==="warning"?h.warn(i):t==="error"?h.error(i):h.info(i),true},get position(){return S.getValue(ne.qmsg_config_position.key,ne.qmsg_config_position.defaultValue)},get maxNums(){return S.getValue(ne.qmsg_config_maxnums.key,ne.qmsg_config_maxnums.defaultValue)},get showReverse(){return S.getValue(ne.qmsg_config_showreverse.key,ne.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=X.getMaxZIndex(),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return X.getMaxValue(e,t)+100}});U.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=X.getMaxZIndex(void 0,void 0,i=>{if(i?.classList?.contains("qmsg-shadow-container")||i?.closest("qmsg")&&i.getRootNode()instanceof ShadowRoot)return  false}),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return X.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ot=new f.GM_Menu({GM_getValue:Z,GM_setValue:G,GM_registerMenuCommand:et,GM_unregisterMenuCommand:tt}),B=new f.Httpx({xmlHttpRequest:it,logDetails:at});B.interceptors.request.use(e=>e);B.interceptors.response.use(void 0,e=>(h.error("拦截器-请求错误",e),e.type==="onabort"?_.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?_.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?_.error("请求超时",{consoleLogContent:true}):_.error("其它错误",{consoleLogContent:true}),e));x.Object.defineProperty,x.Function.prototype.apply,x.Function.prototype.call,x.Element.prototype.appendChild,x.setTimeout.bind(x),x.clearTimeout.bind(x),x.setInterval.bind(x),x.clearInterval.bind(x);const K=s.addStyle.bind(s),C=H.selector.bind(H),F=H.selectorAll.bind(H);new f.GM_Cookie;const ke="GM_Panel",Re="data-init",te="data-key",ie="data-default-value",rt="data-init-more-value",He="data-plugin-search-config",V="data-storage-api",le={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},ce={setting:{get width(){return le.width<550?"88vw":le.width<700?"550px":"700px"},get height(){return le.height<450?"70vh":le.height<550?"450px":"550px"}},settingMiddle:{get width(){return le.width<350?"88vw":"350px"}},info:{get width(){return le.width<350?"88vw":"350px"},get height(){return le.height<250?"88vh":"250px"}}},ye={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new f.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const i=(o,r)=>{typeof r!="string"&&(r=pe.toStr(r));const l=new Blob([r]),c=globalThis.URL.createObjectURL(l);s.createElement("a",{href:c,download:o}).click(),f.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(c);},500);},n=()=>{const o=u=>{const p=U.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),g=p.$shadowRoot.querySelector(".btn-control[data-mode='local']"),y=p.$shadowRoot.querySelector(".btn-control[data-mode='network']"),q=p.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),$=async T=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof ve=="function"?typeof ae=="function"?(ve().forEach(E=>{ae(E);}),_.success("已清空脚本存储的配置")):_.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):_.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Ve=="function"?Ve(T):Object.keys(T).forEach(E=>{const A=T[E];G(E,A);}),_.success("配置导入完毕");},k=T=>new Promise(async R=>{const I=f.toJSON(T);Object.keys(I).length===0?_.warning("解析为空配置，不导入"):await $(I),R(true);});s.on(g,"click",T=>{s.preventEvent(T),p.close();const R=s.createElement("input",{type:"file",accept:".json"});s.on(R,["propertychange","input"],I=>{if(!R.files?.length)return;const E=R.files[0],A=new FileReader;A.onload=()=>{k(A.result);},A.readAsText(E,"UTF-8");}),R.click();}),s.on(y,"click",T=>{s.preventEvent(T),p.close();const R=U.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(A,N){A.close();}},ok:{text:"导入",callback:async(A,N)=>{const z=A.text;if(f.isNull(z)){_.error("请填入完整的url");return}const w=_.loading("正在获取配置..."),b=await B.get(z,{allowInterceptConfig:false});if(w.close(),!b.status){h.error(b),_.error("获取配置失败",{consoleLogContent:true});return}await k(b.data.responseText)&&A.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:ce.info.width,height:"auto"}),I=R.$shadowRoot.querySelector("input"),E=R.$shadowRoot.querySelector(".pops-prompt-btn-ok");s.on(I,["input","propertychange"],A=>{s.val(I)===""?s.attr(E,"disabled","true"):s.removeAttr(E,"disabled");}),s.onKeyboard(I,"keydown",(A,N,z)=>{A==="Enter"&&z.length===0&&s.val(I)!==""&&s.emit(E,"click");}),s.emit(I,"input");}),s.on(q,"click",async T=>{s.preventEvent(T),p.close();let R=await pe.getClipboardText();if(R.trim()===""){_.warning("获取到的剪贴板内容为空");return}await k(R);});},r=(u=`${Ee}_panel-setting-${f.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,p)=>{const g=U.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),y=g.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),q=g.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");s.on(y,"click",$=>{s.preventEvent($);try{i(u,p),g.close();}catch(k){_.error(k.toString(),{consoleLogContent:true});}}),s.on(q,"click",async $=>{await f.copy(p)?(_.success("复制成功"),g.close()):_.error("复制失败");});},c=U.confirm({title:{text:"配置",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),m={};if(typeof ve=="function")ve().forEach(p=>{const g=Z(p);Reflect.set(m,p,g);});else {_.warning("不支持函数GM_listValues，仅导出菜单配置");const u=Z(ke);Reflect.set(m,ke,u);}const d=pe.toStr(m);c.value=d;},a=()=>{let o=be?.script?.supportURL||be?.script?.namespace;typeof o=="string"&&f.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${be?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(o){new st(o.$asideLiElement).on("tap",function(l){clearTimeout(t),t=void 0,e?(e=false,n()):(t=setTimeout(()=>{e=false,a();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},lt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{S.showPanel(ye.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){S.isTopWindow()&&ot.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let i=this.$data.menuOption.findIndex(n=>n.key===t.key);i!==-1&&(this.$data.menuOption[i]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}};class ct{storageKey;listenerData;constructor(t){if(typeof t=="string"){const i=t.trim();if(i=="")throw new Error("key参数不能为空字符串");this.storageKey=i;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new X.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let t=Z(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){G(this.storageKey,t);}set(t,i){const n=this.get(t),a=this.getLocalValue();Reflect.set(a,t,i),this.setLocalValue(a),this.emitValueChangeListener(t,i,n);}get(t,i){const n=this.getLocalValue();return Reflect.get(n,t)??i}getAll(){return this.getLocalValue()}delete(t){const i=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.emitValueChangeListener(t,void 0,i);}has(t){const i=this.getLocalValue();return Reflect.has(i,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(i=>Reflect.get(t,i))}clear(){ae(this.storageKey);}addValueChangeListener(t,i){const n=Math.random(),a=this.listenerData.get(t)||[];return a.push({id:n,key:t,callback:i}),this.listenerData.set(t,a),n}removeValueChangeListener(t){let i=false;for(const[n,a]of this.listenerData.entries()){for(let o=0;o<a.length;o++){const r=a[o];(typeof t=="string"&&r.key===t||typeof t=="number"&&r.id===t)&&(a.splice(o,1),o--,i=true);}this.listenerData.set(n,a);}return i}async emitValueChangeListener(...t){const[i,n,a]=t;if(!this.listenerData.has(i))return;const o=this.listenerData.get(i);for(let r=0;r<o.length;r++){const l=o[r];if(typeof l.callback=="function"){let c,m;t.length===1||(t.length===2?c=n:t.length===3&&(c=n,m=a)),await l.callback(i,c,m);}}}}const re=new ct(ke),S={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new f.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new f.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new f.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new f.Dictionary),this.__onceExecData},get scriptName(){return Ee},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ke,attributeKeyName:te,attributeDefaultValueName:ie},init(){this.initContentDefaultValue(),lt.init();},isTopWindow(){return x.top===x.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="container"||n.type==="deepMenu")return;const a=n.attributes;let o=a[Re];if(typeof o=="function"){let m=o();if(typeof m=="boolean"&&!m)return}let r=new Map,l=a[te];if(l!=null){const m=a[ie];r.set(l,m);}let c=a[rt];if(typeof c=="object"&&c&&Object.keys(c).forEach(m=>{const d=c[m];r.set(m,d);}),!r.size){h.warn("请先配置键",n);return}if(n.type==="switch"){let m=typeof n.disabled=="function"?n.disabled():n.disabled;typeof m=="boolean"&&m&&this.$data.contentConfigInitDisabledKeys.push(...r.keys());}for(const[m,d]of r.entries())this.setDefaultValue(m,d);},t=n=>{for(let a=0;a<n.length;a++){let o=n[a];e(o);let r=o.views;r&&Array.isArray(r)&&t(r);}},i=[...ye.getAllContentConfig()];for(let n=0;n<i.length;n++){let a=i[n];if(!a.views)continue;const o=a.views;o&&Array.isArray(o)&&t(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&h.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){re.set(e,t);},getValue(e,t){const i=re.get(e);return i??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){re.delete(e);},hasKey(e){return re.has(e)},addValueChangeListener(e,t){return re.addValueChangeListener(e,t)},removeValueChangeListener(e){re.removeValueChangeListener(e);},emitMenuValueChange(e,t,i){re.emitValueChangeListener(e,t,i);},async exec(e,t,i,n=true){const a=this;let o;typeof e=="string"||Array.isArray(e)?o=()=>e:o=e;let r=false;const l=o();let c=[];Array.isArray(l)?(r=true,c=l):c.push(l);const m=c.find(E=>!this.$data.contentConfigInitDefaultValue.has(E));if(m){h.warn(`${m} 键不存在`);return}const d=JSON.stringify(c);if(n&&this.$data.onceExecMenuData.has(d))return this.$data.onceExecMenuData.get(d);let u=[];const p=[];let g=[];const y=(E,A)=>{let N=[],z=[],w=[];if(Array.isArray(A))w=w.concat(A);else {const b=v=>{if(typeof v=="object"&&v!=null)if(v instanceof Element)w.push(v);else {const{$css:M,destory:P}=v;M!=null&&(Array.isArray(M)?w=w.concat(M):w.push(M)),typeof P=="function"&&w.push(P);}else w.push(v);};if(A!=null&&Array.isArray(A))for(const v of A)b(v);else b(A);}for(const b of w)if(b!=null){if(b instanceof Element){N.push(b);continue}if(typeof b=="function"){z.push(b);continue}}$(),k(),E&&(u=u.concat(N),g=g.concat(z));},q=E=>!!this.getValue(E),$=()=>{for(let E=0;E<u.length;E++)u[E]?.remove(),u.splice(E,1),E--;},k=()=>{for(let E=0;E<g.length;E++){const A=g[E];A(),g.splice(E,1),E--;}},T=()=>{let E=false;return typeof i=="function"?E=i(c):E=c.every(A=>q(A)),E},R=async E=>{const A=T();let N=[];if(A){const z=c.map(w=>this.getValue(w));N=await t({value:r?z:z[0],addStoreValue:(...w)=>y(A,w)});}y(A,N);};n&&c.forEach(E=>{const A=this.addValueChangeListener(E,(N,z,w)=>R());p.push(A);}),await R();const I={reload(){this.clearStoreStyleElements(),this.destory(),R();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>$(),destory(){return k()},removeValueChangeListener:()=>{p.forEach(E=>{this.removeValueChangeListener(E);});},clearOnceExecMenuData(){n&&a.$data.onceExecMenuData.delete(d);}};return this.$data.onceExecMenuData.set(d,I),I},async execMenu(e,t,i=false,n=false){return await this.exec(e,async a=>await t(a),a=>a.every(r=>{let l=!!this.getValue(r);return S.$data.contentConfigInitDisabledKeys.includes(r)&&(l=false,h.warn(`.execMenu${n?"Once":""} ${r} 被禁用`)),i&&(l=!l),l}),n)},async execMenuOnce(e,t,i=false,n=false){const a=await this.execMenu(e,t,i,true);if(n&&a){const o=()=>{a.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,o);}return a},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),re.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async emitUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const i of t)await i(e);},showPanel(e,t=`${Ee}-设置`,i=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];const a=e.findIndex(r=>(typeof r.isBottom=="function"?r.isBottom():!!r.isBottom)&&r.id==="script-version")!==-1;!i&&!a&&e.push(...ye.getDefaultBottomContentConfig());const o=U.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(r,l)=>{r.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(r,l)=>{r(),this.$data.$panel=null;}},width:ce.setting.width,height:ce.setting.height,drag:true,only:true,style:`
        ...
        `,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:o,content:e});},registerConfigSearch(e){const{$panel:t,content:i}=e,n=async(p,g)=>{if(p==null)return;const y=await g(p);return y&&typeof y.isFind=="boolean"&&y.isFind?y.data:await n(y.data,g)},a=(p,g)=>{const y=new IntersectionObserver(q=>{q.forEach($=>{$.isIntersecting&&(g?.(),y.disconnect());});},{root:null,threshold:1});y.observe(p),p.scrollIntoView({behavior:"smooth",block:"center"});},o=p=>{const g="pops-flashing";s.onAnimationend(p,()=>{p.classList.remove(g);}),p.classList.add(g);},r=p=>{if(p.type==="dblclick"&&u)return;s.preventEvent(p),c=null;const g=U.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});g.$shadowRoot.querySelector(".search-wrapper");const y=g.$shadowRoot.querySelector(".search-config-text"),q=g.$shadowRoot.querySelector(".search-result-wrapper");y.focus();const $=()=>{s.empty(q);},k=R=>{const I=f.queryProperty(R,N=>N?.next?{isFind:false,data:N.next}:{isFind:true,data:N}),E=s.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),A=U.config.PanelHandlerComponents();return s.on(E,"click",N=>{const w=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[R.index];if(!w){_.error(`左侧项下标${R.index}不存在`);return}w.scrollIntoView({behavior:"smooth",block:"center"}),w.click(),n(R.next,async b=>{if(b?.next){const v=await s.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(M=>{const P=Reflect.get(M,A.$data.nodeStoreConfigKey);return typeof P=="object"&&P!=null&&P.text===b.name}),2500);if(v)v.click();else return _.error("未找到对应的二级菜单"),{isFind:true,data:b};return {isFind:false,data:b.next}}else {const v=await s.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(M=>Reflect.get(M,A.$data.nodeStoreConfigKey)===b.matchedData?.formConfig),2500);if(v){a(v);const M=v.closest(".pops-panel-forms-fold[data-fold-enable]");M&&(M.querySelector(".pops-panel-forms-fold-container").click(),await f.sleep(500)),a(v,()=>{o(v);});}else _.error("未找到对应的菜单项");return {isFind:true,data:b}}});}),E},T=R=>{const I=new RegExp(R,"i"),E=[],A=(z,w)=>{for(let b=0;b<z.length;b++){const v=z[b],M=v.views;if(M&&Array.isArray(M)){const P=f.deepClone(w);if(v.type==="deepMenu"){const W=f.queryProperty(P,J=>J?.next?{isFind:false,data:J.next}:{isFind:true,data:J});W.next={name:v.text};}A(M,P);}else {let P,W;if(v.type==="own"){const Q=Reflect.get(v.attributes||{},He);Q&&(typeof Q.text=="string"&&(P=Q.text),typeof Q.desc=="string"&&(W=Q.desc));}else P=v.text,W=Reflect.get(v,"description");const J=[P,W],ue=J.findIndex(Q=>{if(typeof Q=="string")return Q.match(I)});if(ue!==-1){const Q=f.deepClone(w),Ae=f.queryProperty(Q,oe=>oe?.next?{isFind:false,data:oe.next}:{isFind:true,data:oe});Ae.next={name:P,matchedData:{path:"",formConfig:v,matchedText:J[ue],description:W}};const Me=[];f.queryProperty(Q,oe=>{const Ce=oe?.name;return typeof Ce=="string"&&Ce.trim()!==""&&Me.push(Ce),oe?.next?{isFind:false,data:oe.next}:{isFind:true,data:oe}});const Xe=Me.join(pe.escapeHtml(" - "));Ae.next.matchedData.path=Xe,E.push(Q);}}}};for(let z=0;z<i.length;z++){const w=i[z];if(!w.views||w.isBottom&&w.id==="script-version")continue;const b=w.views;if(b&&Array.isArray(b)){let v=w.title;typeof v=="function"&&(v=v()),A(b,{index:z,name:v});}}const N=document.createDocumentFragment();for(const z of E){let w=k(z);N.appendChild(w);}$(),q.append(N);};s.on(y,"input",f.debounce(R=>{s.preventEvent(R);let I=s.val(y).trim();if(I===""){$();return}T(I);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(p=>{s.on(p,"dblclick",r);});let c=null,m=false,d,u=false;s.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(p,g)=>{u=true,clearTimeout(d),d=void 0,m&&c===g?(m=false,c=null,r(p)):(d=setTimeout(()=>{m=false;},200),m=true,c=g);},{capture:true}),t.$shadowRoot.appendChild(s.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
				...
				`}));},transformKey(e){if(Array.isArray(e)){const t=e.sort();return JSON.stringify(t)}else return e}};class mt{$data={get enable(){return S.getValue(ne.httpx_cookie_manager_enable.key,ne.httpx_cookie_manager_enable.defaultValue)},get useDocumentCookie(){return S.getValue(ne.httpx_cookie_manager_use_document_cookie.key,ne.httpx_cookie_manager_use_document_cookie.defaultValue)},cookieRule:[]};constructor(t){Array.isArray(t)&&(this.$data.cookieRule=t);}fixCookieSplit(t){return f.isNotNull(t)&&!t.trim().endsWith(";")&&(t+=";"),t}concatCookie(t,i){return f.isNull(t)?i:(t=t.trim(),i=i.trim(),t=this.fixCookieSplit(t),i.startsWith(";")&&(i=i.substring(1)),t.concat(i))}handle(t){if(t.fetch||!this.$data.enable)return;let i="",n=t.url;n.startsWith("//")&&(n=window.location.protocol+n);let a=new URL(n);this.$data.useDocumentCookie&&a.hostname.endsWith(window.location.hostname.split(".").slice(-2).join("."))&&(i=this.concatCookie(i,document.cookie.trim()));for(let o=0;o<this.$data.cookieRule.length;o++){let r=this.$data.cookieRule[o];if(a.hostname.match(r.hostname)){let l=S.getValue(r.key);if(f.isNull(l))break;i=this.concatCookie(i,l);}}f.isNotNull(i)&&(t.headers&&t.headers.Cookie?t.headers.Cookie=this.concatCookie(t.headers.Cookie,i):t.headers.Cookie=i,h.info("Httpx => 设置cookie:",t)),t.headers&&t.headers.Cookie!=null&&f.isNull(t.headers.Cookie)&&delete t.headers.Cookie;}}pe.setGMResourceCSS(Oe.Viewer);pe.setGMResourceCSS(Oe.Hljs);const dt=new mt([{key:"httpx-cookie-bbs.binmt.cc",hostname:/bbs.binmt.cc/g}]);B.interceptors.request.use(e=>(dt.handle(e),e));U.GlobalConfig.setGlobalConfig({mask:{enable:true},drag:true});_.config({isLimitWidth:true,limitWidthWrap:"wrap"});const j={registerLeftMenu(e){s.waitNode(".comiis_sidenv_box .sidenv_li .comiis_left_Touch",1e4).then(t=>{if(!t){h.error("注册左侧面板菜单失败，原因：该元素不存在");return}let i=s.createElement("li",{className:"comiis_left_Touch",innerHTML:`
						<a href="javascript:;" class="comiis_left_Touch">
							<i class="comiis_font"></i>
							${e.name}
						</a>
						`}),n=i.querySelector(".comiis_font");typeof e.style=="string"&&(n.style.cssText=e.style),typeof e.icon=="string"&&(n.innerHTML=e.icon),typeof e.iconColor=="string"&&(n.style.color=e.iconColor),typeof e.iconSize=="string"&&(n.style.fontSize=e.iconSize),s.on(i,"click",a=>{s.preventEvent(a),typeof e.callback=="function"&&e.callback();}),s.append(t,i);});},comiisForumList:()=>document.querySelectorAll("li.forumlist_li"),comiisPostli:()=>document.querySelectorAll("div.comiis_postli.comiis_list_readimgs.nfqsqi"),comiisMmlist:()=>document.querySelectorAll(".comiis_mmlist")},pt=`.pops-confirm-content {\r
  display: flex;\r
...
`,ee={formhash:/formhash=([0-9a-zA-Z]+)/,uid:/uid(=|-)(\d+)/,fontSpecial:/<font.*?>|<\/font>|<strike>|<strong>|<i>|<u>|align=".*?"|<br>[\s]*<br>[\s]*<br>/g,ptid:/&ptid=([\d]+)/i,pid:/&pid=([\d]+)/i,tid:/&tid=([\d]+)/i},O={getAvatar:(e,t="middle")=>`/uc_server/avatar.php?uid=${e}&size=${t}&ts=1`,getCurrentUID(){let e=x.discuz_uid;if(typeof e=="string")return e;let t=document.querySelector('.sidenv_exit a[href*="uid="]');if(t){let i=t.href.match(/uid=([0-9]+)/);if(i)return i[i.length-1]}},async getFormHash(){let e=Array.from((top||globalThis).document.querySelectorAll("input[name=formhash]"));for(let n=0;n<e.length;n++){let o=e[n].value;if(o)return o}let t=Array.from((top||globalThis).document.querySelectorAll('a[href*="formhash="]'));for(let n=0;n<t.length;n++){let o=t[n].href.match(ee.formhash);if(o){let r=o[o.length-1];if(r)return r}}let i=await B.get("/home.php?mod=spacecp",{fetch:true,allowInterceptConfig:false});if(i.status){let n=i.data.responseText,o=s.toElement(n,true,true).querySelector("input[name=formhash]");if(o){let r=o.value;if(f.isNotNull(r))return r}}else h.error("请求个人主页获取formhash失败",i);},envIsMobile(){return (x.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:e=>{let t=e.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(t){let i=t.filter(Boolean);return i[i.length-1]}},getForumId(e){let t=e.match(/&fid=([\d]+)/i);if(t)return t[t.length-1]},getPostId(e){let t=e.match(/&pid=([\d]+)/i);if(t)return t[t.length-1]},getRepquote(e){let t=e.match(/&repquote=([\d]+)/i);if(t)return t[t.length-1]}},ut={$data:{cid:""},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"小黑屋",iconColor:"#000000",icon:"",callback:()=>{this.showBlackHome();}});},async showBlackHome(){let e=_.loading("正在获取小黑屋名单中..."),t=await this.getBlackListInfo("");if(e.close(),!t)return;if(t.data.length===0){_.error("获取小黑屋名单为空");return}this.$data.cid=t.next_cid;let i=U.confirm({title:{text:"小黑屋名单",position:"center"},content:{text:`
                <div class="blackhome-user-filter">
                    <input placeholder="过滤用户名/操作人员/UID(可正则)">
                </div>
                <div class="blackhome-user-list"></div>
                `,html:true},btn:{ok:{text:"下一页",callback:async()=>{let l=_.loading("正在获取小黑屋名单中...");h.info("下一页的cid: ",this.$data.cid);let c=await this.getBlackListInfo(this.$data.cid);l.close(),c&&(this.$data.cid=c.next_cid,c.data.forEach(m=>{let d=this.createListViewItem(m);n.appendChild(d);}),c.data.length===0?_.error("获取小黑屋名单为空"):_.success(`成功获取 ${c.data.length}条数据`),s.emit(a,"input"));}},cancel:{text:"关闭"}},width:"88vw",height:"82vh",style:pt}),n=i.$shadowRoot.querySelector(".blackhome-user-list"),a=i.$shadowRoot.querySelector(".blackhome-user-filter input");t.data.forEach(l=>{let c=this.createListViewItem(l);n.appendChild(c);}),_.success(`成功获取 ${t.data.length}条数据`);let o=false;s.on(a,["input","propertychange"],f.debounce(()=>{let l=a.value.trim();if(!o){if(o=true,l==""){i.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.removeAttribute("style");}),o=false;return}i.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.getAttribute("data-name").match(new RegExp(l,"ig"))||c.getAttribute("data-uid").trim().match(new RegExp(l,"ig"))||c.getAttribute("data-operator").match(new RegExp(l,"ig"))?c.removeAttribute("style"):c.setAttribute("style","display:none;");}),o=false;}}));let r=await this.getBlackListInfo(this.$data.cid);r&&(this.$data.cid=r.next_cid);},async getBlackListInfo(e=""){let t={mod:"misc",action:"showdarkroom",cid:e,ajaxdata:"json"},i=await B.get(`/forum.php?${f.toSearchParamsStr(t)}`,{headers:{"User-Agent":f.getRandomPCUA()},responseType:"json"});if(!i.status)return;let n=f.toJSON(i.data.responseText),a=n.message.split("|"),o=a[a.length-1],r=f.parseObjectToArray(n.data),l=[],c=[];return r.forEach(m=>{let d=m.dateline.match(/([0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]*[0-9]{1,2}:[0-9]{1,2})/g);if(d==null){let u=parseInt((Date.now()/1e3).toString()),p=0,g=m.dateline.match(/([0-9]+|半)[\s\S]*秒前/),y=m.dateline.match(/([0-9]+|半)[\s\S]*分钟前/),q=m.dateline.match(/([0-9]+|半)[\s\S]*小时前/),$=m.dateline.match(/昨天[\s\S]*(\d{2}):(\d{2})/),k=m.dateline.match(/前天[\s\S]*(\d{2}):(\d{2})/),T=m.dateline.match(/([0-9]+|半)[\s\S]*天前/);if(g)g=g[g.length-1],g=g.replace(/半/g,.5),g=parseFloat(g),p=u-g;else if(y)y=y[y.length-1],y=y.replace(/半/g,.5),y=parseFloat(y),p=u-y*60;else if(q)q=q[q.length-1],q=q.replace(/半/g,.5),q=parseFloat(q),p=u-q*60*60;else if($){let R=$[1],I=$[2];p=u-86400-parseInt(R)*3600-parseInt(I)*60;}else if(k){let R=k[1],I=k[2];p=u-86400*2-parseInt(R)*3600-parseInt(I)*60;}else T&&(T=T[T.length-1],T=T.replace(/半/g,.5),T=parseFloat(T),p=u-T*60*60*24);m.time=parseInt(p.toString())*1e3,l=l.concat(m);return}else d=d[0];m.time=f.formatToTimeStamp(d),l=l.concat(m);}),f.sortListByProperty(l,"time"),f.sortListByProperty(c,"time",false),l=l.concat(c),{next_cid:o,data:l}},createListViewItem(e){let t=s.createElement("div",{className:"blackhome-user-item",innerHTML:`
...
`,gt={$data:{},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"在线用户",iconColor:"#2d92ff",icon:"",callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let e=_.loading("正在获取在线用户名单中..."),t=await this.getOnlineUserListInfo();if(e.close(),!t)return;let i=U.alert({title:{text:"在线用户",position:"center"},content:{text:`
                ...
                `,html:true},btn:{ok:{text:"关闭",type:"default"}},width:"88vw",height:"82vh",style:ht}),n=i.$shadowRoot.querySelector(".online-user-list"),a=i.$shadowRoot.querySelector(".online-user-filter input");t.data.forEach(r=>{let l=this.createListViewItem(r);n.appendChild(l);}),_.success(`成功获取 ${t.data.length}条数据`);let o=false;H.on(a,["propertychange","input"],f.debounce(()=>{let r=a.value.trim();if(!o){if(o=true,r==""){i.$shadowRoot.querySelectorAll(".online-user-list .online-item").forEach(l=>{l.removeAttribute("style");}),o=false;return}i.$shadowRoot.querySelectorAll(".online-user-list .online-item").forEach(l=>{l.getAttribute("data-name").match(new RegExp(r,"ig"))||l.getAttribute("data-sf").match(new RegExp(r,"ig"))||l.getAttribute("data-uid").match(new RegExp(r,"ig"))?l.removeAttribute("style"):l.setAttribute("style","display:none;");}),o=false;}}));},async getOnlineUserListInfo(){let e={showoldetails:"yes"},t=await B.get(`/forum.php?${f.toSearchParamsStr(e)}`,{headers:{"User-Agent":f.getRandomPCUA()}});if(!t.status)return;let i=f.parseFromString(t.data.responseText,"text/html"),n={data:[],totalOnline:0,onlineUser:0,noRegisterUser:0,invisibleUser:0};i.querySelectorAll("#onlinelist ul li").forEach(r=>{let l=r.querySelector("a").getAttribute("href").match("uid-(.+?).html")[1],c=O.getAvatar(l,"middle"),m=r.querySelector("a").innerText,d="",u=r.querySelector("a").getAttribute("href"),p=r.querySelector("img").src;p.indexOf("online_member")!=-1?d="会员":p.indexOf("online_moderator")!=-1?d="版主":p.indexOf("online_supermod")!=-1?d="超级版主":p.indexOf("online_admin")!=-1?d="管理员":d="未知身份",n.data.push({uid:l,avatar:c,name:m,sf:d,space:u});});let o=i.querySelector("#online div.bm_h span.xs1").textContent;return n.totalOnline=f.parseInt(o.match(/([0-9]*)\s*人在线/i),0),n.onlineUser=f.parseInt(o.match(/([0-9]*)\s*会员/i),0),n.noRegisterUser=f.parseInt(o.match(/([0-9]*)\s*位游客/i),0),n.invisibleUser=f.parseInt(o.match(/([0-9]*)\s*隐身/i),0),n},createListViewItem(e){let t=H.createElement("div",{className:"online-item",innerHTML:`
            ...
            `},{"data-name":e.name,"data-uid":e.uid,"data-sf":e.sf});return H.on(t,"click",".online-user-avatar",i=>{H.preventEvent(i),window.open(`home.php?mod=space&uid=${e.uid}&do=profile`,"_blank");}),t}},ft=()=>{const e="texttolink",t=/((https?:\/\/|www\.)[\x21-\x7e]+[\w\/]|(\w[\w._-]+\.(com|cn|org|net|info|tv|cc))(\/[\x21-\x7e]*[\w\/])?|ed2k:\/\/[\x21-\x7e]+\|\/|thunder:\/\/[\x21-\x7e]+=)/gi,i=function(y){let q=y.originalTarget??y.target,$;if(q!=null&&q.localName==="a"&&q.className.indexOf(e)!==-1&&($=q.getAttribute("href"),typeof $=="string"&&$.indexOf("http")!==0&&$.indexOf("ed2k://")!==0&&$.indexOf("thunder://")!==0))return q.setAttribute("href","http://"+q)},n=function(y){if(typeof y!="object"||y==null)return;const q=y?.textContent,$=y?.parentNode;if($!=null&&$?.className?.indexOf?.(e)===-1&&y.nodeName!=="#cdata-section"&&typeof q=="string"){const k=q.replace(t,`<a href="$1" target="_blank" class="${e}">$1</a>`);if(q.length!==k.length){const T=document.createElement("span");s.html(T,k);const R=T.querySelector("a"),I=R.href;return console.log(`识别: ${I}`),$.nodeName.toLowerCase()==="span"?$.replaceChild(R,y):$.replaceChild(T,y)}}},a="a svg canvas applet input button area pre embed frame frameset head iframe img option map meta noscript object script style textarea code".split(" "),o=`//text()[not(ancestor::${a.join(") and not(ancestor::")})]`,r=new RegExp(`^(${a.join("|")})$`,"i"),l=function(y,q){let $,k;if(q+1e4<y.snapshotLength){let T=$=q;for(k=q+1e4;q<=k?$<=k:$>=k;T=q<=k?++$:--$)n(y.snapshotItem(T));setTimeout(function(){return l(y,q+1e4)},15);}else {let T;for(T=$=q,k=y.snapshotLength;q<=k?$<=k:$>=k;T=q<=k?++$:--$)n(y.snapshotItem(T));}},c=function(y){const q=document.evaluate(o,y,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null);return l(q,0)},m=function(y){for(const q=document.createTreeWalker(y,NodeFilter.SHOW_TEXT,{acceptNode:function($){const k=$?.parentNode?.localName;return r.test(k)?NodeFilter.FILTER_SKIP:NodeFilter.FILTER_ACCEPT}});q.nextNode();)n(q.currentNode);};let d=new f.LockFunction(y=>{for(const q of y)if(q.type==="childList"){const $=q.addedNodes;for(let k=0;k<$.length;k++){const T=$[k];m(T);}}});const u=function(){return c(document.body),f.mutationObserver(document.body,{config:{subtree:true,childList:true},callback:q=>{d.run(q);}})},p=function(y){const q=y.getAttribute("href");if(typeof q=="string"&&q.indexOf("http")!==0&&q.indexOf("ed2k://")!==0&&q.indexOf("thunder://")!==0)return y.setAttribute("href","http://"+q)},g=function(){const y=Array.from(document.getElementsByClassName(e));for(const q of y)p(q);};document.addEventListener("mouseover",i),setTimeout(g,1500),setTimeout(u,100);},qe={$key:{sign:"mt-sign-time"},init(){this.sign();},checkSignInfo(){let t=this.getSignInfo().find(i=>i.hostName===window.location.hostname);return t?f.formatTime(Date.now(),"yyyyMMdd")===f.formatTime(t.time,"yyyyMMdd"):false},setSignInfo(){let e={hostName:window.location.hostname,time:Date.now()},t=this.getSignInfo(),i=t.findIndex(n=>n.hostName===e.hostName);i!==-1&&t.splice(i,1),t.push(e),G(this.$key.sign,t);},getSignInfo(){let e=Z(this.$key.sign,[]);return Array.isArray(e)?e:(this.clearSignInfo(),[])},getHostNameSignInfo(e=window.location.hostname){return this.getSignInfo().find(i=>i.hostName===e)},clearSignInfo(e){if(typeof e=="string"){let t=this.getSignInfo(),i=t.findIndex(n=>n.hostName===e);i!==-1&&t.splice(i,1),G(this.$key.sign,t);}else ae(this.$key.sign);},checkLogin(){return O.envIsMobile()?!!C("a[href*='member.php?mod=logging&action=logout']"):!!C("#comiis_key")},async sign(){if(this.checkSignInfo()){h.info("今日已签到");return}let e=await O.getFormHash();if(e==null){if(C("#comiis_picshowbox")){h.info("当前为评论区的看图模式 ");return}this.clearSignInfo(window.location.hostname),_.error("自动签到：获取账号formhash失败",{consoleLogContent:true});return}let t=!!S.getValue("mt-auto-sign-useFetch"),i=f.getRandomPCUA(),n=()=>{this.setSignInfo();},a=()=>{this.clearSignInfo(window.location.hostname);},o=l=>{let m=we.alert({title:{text:"未知签到内容",position:"center"},content:{text:"",html:false},width:"88vw",height:"300px"}).$shadowRoot.querySelector(".pops-alert-content");m.innerText=l;},r=[{checkPluginEnableUrl:"/plugin.php?id=k_misign:sign",async sign(){let l={operation:"qiandao",format:"button",formhash:e,inajax:1,ajaxtarget:"midaben_sign"},c=await B.get(`/k_misign-sign.html?${f.toSearchParamsStr(l)}`,{fetch:t,headers:{"User-Agent":i},allowInterceptConfig:false});if(!c.status){_.error("签到：网络异常，请求失败",{consoleLogContent:true});return}n(),h.info("签到信息：",c);let m=c.data.responseText,d=f.parseCDATA(m),u=s.toElement(`<div>${d}</div>`,true,false),p=s.text(u);if(p.includes("需要先登录")){_.error("签到：请先登录账号",{timeout:3e3,consoleLogContent:true}),a();return}else if(p.includes("请稍后再试")||p.includes("您已经被列入黑名单")||p.includes("绑定手机号后才可以签到")||p.includes("您所在用户组不允许使用")){_.error("签到："+p,{timeout:5e3});return}else if(p.includes("今日已签")||p.includes("今日已经签到")){_.info("签到："+p);return}else if(m.includes("您当前的访问请求当中含有非法字符，已经被系统拒绝")){_.error("签到: 您当前的访问请求当中含有非法字符，已经被系统拒绝",{timeout:6e3});return}else if(t&&"location"in f.toJSON(m)){_.success("签到: 签到成功");return}let g=u.querySelector(".con"),y=u.querySelector(".line");if(g&&y){let q=s.text(g).match(/([0-9]+)金币/),$=s.text(y).match(/([0-9]+)/),k=q[q.length-1],T=$[$.length-1];h.success(`金币${k}，排名${T}`),_.info(`
...
`,Ue=[];class je{option;$data={STORAGE_KEY:"mt-image-bed-upload-history"};constructor(t){this.option=t,Ue.push({id:this.option.id,callback:this.option.delImageEvent.bind(this)}),this.addTab(),s.on(`.comiis_post_imglist[data-chartbed="${this.option.name}"] .up_btn a`,"click",async i=>{await this.option.uploadBtnClickEvent(i)&&C(`.comiis_post_imglist[data-chartbed="${this.option.name}"] input[type="file"]`).click();}),s.on(`.comiis_post_imglist[data-chartbed="${this.option.name}"] input[type="file"]`,"change",async i=>{let n=i.target,a=()=>{n.value="";},o=async r=>{let l=await this.option.fileChangeEvent(i,r);a(),l.success&&l.data.forEach(c=>{this.addImage(c);let m=this.createImageBtnElement("插入",c.url);this.setImageBtnDeleteEvent(m,c),s.append(`.comiis_post_imglist[data-chartbed="${this.option.name}"]`,m);});};if(n.files&&n.files.length){let r=n.files;if(S.getValue("mt-image-bed-watermark-enable")){let l=_.loading("处理水印中..."),c=[],m=[];await Promise.all(Array.from(n.files).map(async(d,u)=>{if(d.type==="image/gif"){let g=await f.parseFileToBase64(d);c.push(g),m.push(d);}else {_.info(`添加水印 ${u+1}/${r.length}`);var p=new window.Watermark;await p.setFile(d),p.addText({text:[S.getValue("mt-image-bed-watermark-text")],color:S.getValue("mt-image-bed-watermark-text-color"),fontSize:S.getValue("mt-image-bed-watermark-font-size"),globalAlpha:S.getValue("mt-image-bed-watermark-font-opacity"),xMoveDistance:S.getValue("mt-image-bed-watermark-left-right-margin"),yMoveDistance:S.getValue("mt-image-bed-watermark-top-bottom-margin"),rotateAngle:S.getValue("mt-image-bed-watermark-rotate")}),c.push(p.render("png")),m.push(f.parseBase64ToFile(p.render("png"),"WaterMark_"+d.name));}})),l.close(),r=m,S.getValue("mt-image-bed-watermark-autoAddWaterMark")?await o(r):U.confirm({title:{text:"水印预览",position:"center"},content:{text:`
...
`)}
								...
								`});}else await o(r);}});}addTab(){const t=C("#comiis_pictitle_key");if(!t)return;let i=t.querySelector("a[data-type='history']"),n=`
    <li>
        <a href="javascript:;" class="comiis-picture-tab" data-type="image-bed">${this.option.name}</a>
    </li>`;if(!i){let r=s.createElement("li");i=s.createElement("a",{href:"javascript:;",className:"comiis-picture-tab",innerHTML:"历史图片"},{"data-type":"history"}),s.on(i,"click",()=>{this.initHistoryUploadImageList();}),s.append(r,i),s.append(t,r);}s.before(i.parentElement,n);let a=C("#comiis_pictitle_tab .bqbox_t"),o=Array.from(F("#comiis_pictitle_tab .comiis_upbox")).find(r=>!!r.querySelector("#imglist_history"));o||(o=s.createElement("div",{className:"comiis_upbox bg_f cl",innerHTML:'<ul class="comiis_post_imglist cl" id="imglist_history"></ul>'},{style:"display: none;"}),s.before(a,o),o=Array.from(F("#comiis_pictitle_tab .comiis_upbox")).find(r=>!!r.querySelector("#imglist_history"))),s.before(o,`
      ...
      `),C("#comiis_foot_menu_beautify .comiis_position_key"),this.$el.$like=C("#comiis_foot_menu_beautify .comiis_recommend_addkey"),C("#comiis_foot_menu_beautify #comiis_favorite_a"),C("#comiis_pictitle_key"),this.$el.$btn_submit=C('#comiis_foot_menu_beautify_big li[data-attr="发表"] input'),this.$el.$input=C("#comiis_foot_menu_beautify_big textarea"),this.$el.$fastpostsubmit=C("#fastpostsubmit"),x.textarea_scrollHeight=()=>{},typeof x.comiis_addsmilies=="function"&&(x.comiis_addsmilies=d=>{x.$("#needmessage").comiis_insert(d),x.$("#needmessage")[0].dispatchEvent(new Event("propertychange"));}),x.$("#imglist .up_btn").append(x.$("#filedata")),x.$(document).on("click","#imglist .up_btn a",function(){x.$(this).next().click();}),x.$(document).on("click","#imglist .p_img a",function(){let d=x.$(this);if(d.attr("onclick")==null){let u=d.find("img").attr("id").replace("aimg_","");x.comiis_addsmilies(`[attachimg]${u}[/attachimg]`);}}),s.hide("#comiis_foot_menu_beautify_big .menu_body",false),this.setInputChangeEvent(),this.setLikeBtnClickEvent(),this.setSubmitBtnClickEvent(),this.setGlobalReplyBtnClickEvent(),this.setGlobalClickCheckEvent(),this.setMenuIconToggleEvent(),this.setMenuImageClickEvent(),this.setMenuImageToggleEvent(),this.setMenuSmileClickEvent(),this.setMenuSmileTabClickEvent(),this.setMenuInsertClickEvent(),this.setMenuQuickUBB(),S.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",async()=>{this.setInputChangeSaveEvent(),await this.initReplyText();}),S.execMenuOnce("mt-image-bed-hello-enable",()=>{Ge.init();}),S.execMenuOnce("mt-image-bed-mt-enable",()=>{We.init();});},handle_error(e){let t=false;const i=s.text(s.toElement(e,false,false).querySelector("#messagetext"));return !i||typeof i=="string"&&i.trim()==""||wt.forEach(n=>{const a=n.match instanceof RegExp?n.match:new RegExp(n.match),o=i.match(a);if(o){if(i.includes("typeof errorhandle_=='function'")){let r=n.msg;o.forEach((l,c)=>{r=r.replace(`{$${c}}`,l);}),_.error(r);}t=true;return}}),t},setInputChangeEvent(){const e=this;s.on(e.$el.$input,["input","propertychange"],function(t){e.$el.$input.value===""?(e.$el.$btn_submit.setAttribute("data-text","false"),C("#comiis_foot_menu_beautify li[data-attr='回帖'] input")?.setAttribute("placeholder","发帖千百度，文明第一步")):(e.$el.$btn_submit.setAttribute("data-text","true"),C("#comiis_foot_menu_beautify li[data-attr='回帖'] input")?.setAttribute("placeholder","[草稿待发送]")),s.css(e.$el.$input,"height","70px"),s.css(e.$el.$input,"height",e.$el.$input.scrollHeight-20+"px");});},setInputChangeSaveEvent(){const e=this;s.on(this.$el.$input,["input","propertychange"],async t=>{const i=e.$el.$input.value,a=e.$el.$input.closest(".reply_area").querySelector(".reply_user_content").getAttribute("data-reply-url"),o={url:window.location.href,text:i,repquote:a?O.getRepquote(a):void 0,forumId:e.$data.tid},r=await e.$data.db.get("data");if(!r.success||r.code===201){console.warn(r);return}let l=r.data.findIndex(c=>c.forumId===o.forumId&&c.repquote===o.repquote);l!==-1?i==null||i===""?r.data.splice(l,1):r.data[l]=f.assign(r.data[l],{text:o.text}):r.data.push(o),await e.$data.db.save("data",r.data);});},async initReplyText(e=false,t=void 0){const i=this;(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let a=await this.$data.db.get("data");if(!a.success||a.code===201){console.warn(a);return}let o;t&&(o=O.getRepquote(t));let r=a.data.find(l=>e?l.forumId===i.$data.tid&&l.repquote==o:l.forumId===i.$data.tid&&l.repquote==null);r&&(s.val(this.$el.$input,r.text),s.emit(this.$el.$input,"input"));},setLikeBtnClickEvent(){s.on(this.$el.$like,"click",async e=>{if(s.preventEvent(e),x.comiis_recommend_key==0){x.comiis_recommend_key=1;let o=await B.get(this.$el.$like.href+"&inajax=1",{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false});if(!o.status){window.location.href=this.$el.$like.href,setTimeout(function(){x.comiis_recommend_key=0;},500);return}let l=f.parseFromString(o.data.responseText,"text/xml").lastChild?.firstChild?.nodeValue;if(l.includes("您已评价过本主题")){let c=this.$el.$like.href.match(ee.tid)[1];if(!(await B.get(`plugin.php?id=comiis_app&comiis=re_recommend&tid=${c}&inajax=1`,{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false})).status){_.error("取消点赞失败，网络异常");return}var t=Number(s.text("#comiis_recommend_num"));document.querySelectorAll(".comiis_recommend_list_a").length>0&&s.remove("#comiis_recommend_list_a"+x.uid),document.querySelectorAll(".comiis_recommend_list_s").length>0&&s.remove("#comiis_recommend_list_s"+x.uid),document.querySelectorAll(".comiis_recommend_list_t").length>0&&s.remove("#comiis_recommend_list_t"+x.uid),t>1?(s.text(".comiis_recommend_num",t-Number(x.allowrecommend)),s.text(".comiis_recommend_nums","+"+(t-Number(x.allowrecommend)))):(s.remove("#comiis_recommend_num"),s.text(".comiis_recommend_nums",""),document.querySelectorAll(".comiis_recommend_list_a").length>0&&(s.empty(".comiis_recommend_list_a"),s.removeClass(".comiis_recommend_list_a","comiis_recommend_list_on")),document.querySelectorAll(".comiis_recommend_list_t").length>0&&s.removeClass(".comiis_recommend_list_t","comiis_recommend_list_on")),s.html(".comiis_recommend_addkey i","&#xe63b;"),s.removeClass(".comiis_recommend_color","f_a"),s.addClass(".comiis_recommend_color","f_b"),document.querySelectorAll(".comiis_recommend_list_s").length>0&&(document.querySelectorAll(".comiis_recommend_list_s li").length<7?s.hide(".txshow_more",false):s.show(".txshow_more",false)),_.success("已取消点赞");}else if(l.includes("您不能评价自己的帖子"))_.error("不能点赞自己的帖子");else if(l.includes("今日评价机会已用完"))_.warning("您今日的点赞机会已用完");else if(l.includes("'recommendv':'+"+x.allowrecommend+"'")){var i={recommendc:0,daycount:0},n;n=l.match(/\'recommendc\':\'(.*?)\'/),n!=null?i.recommendc=parseInt(n[1]):i.recommendc=0,n=l.match(/\'daycount\':\'(.*?)\'/),n!=null?i.daycount=parseInt(n[1]):i.daycount=0,document.querySelectorAll(".comiis_recommend_new span").length<1&&s.append(".comiis_recommend_new",'<span class="bg_del f_f comiis_kmvnum comiis_recommend_num" id="comiis_recommend_num">0</span>');var a=Number(s.text("#comiis_recommend_num"));if(F(".comiis_recommend_list_a").length>0){let c=F(".comiis_recommend_list_a");s.removeClass(c,"comiis_recommend_list_on"),s.addClass(c,"comiis_recommend_list_on"),s.prepend(c,(F(".comiis_recommend_list_a li").length>0?"":'<li style="float:right;margin-right:0;"><a href="misc.php?op=recommend&tid= '+x.tid+'&mod=faq&mobile=2"><span class="bg_b f_c"><em class="comiis_recommend_num">'+a+"</em>赞</span></a></li>")+'<li id="comiis_recommend_list_a'+x.uid+'"><a href="home.php?mod=space&uid='+x.uid+'"><img src="'+O.getAvatar(x.uid,"small")+'"></a></li>');}if(F(".comiis_recommend_list_t").length>0){let c=F(".comiis_recommend_list_t");s.removeClass(c,"comiis_recommend_list_on"),s.addClass(c,"comiis_recommend_list_on"),s.prepend(c,`<span id="comiis_recommend_list_t${x.uid}">
        ...
        .comiis_messages img{
            max-width: 100% !important;
						...
						`,true,false);s.on(d,"click",function(){s.waitNode("div[id=ntcmsg_popmenu]>div>span.f_c").then(u=>{try{u.innerText="点评 "+m;}catch(p){h.error("修改点评失败",p);}});}),s.prepend(t,d);}});});},loadNextPageComment(){if(h.info("自动加载下一页评论"),document.title.includes("提示信息 - MT论坛"))return;function e(){return C("#loading-comment-tip")}function t(){return C("#loading-comment-tip").parentElement}function i(c){let m=e(),d=t();s.css(d,"display","");let p=Array.from(c.querySelectorAll("a[href]")).find($=>$.textContent?.trim()==="下一页").href;if(h.info("获取下一页url：",p),p.includes("javascript:;")){h.info("暂无下一页的评论"),s.remove(d);return}function g(){s.remove(".comiis_page.bg_f"),s.remove(d),s.off(m,"click",y),s.off(window,"scroll",q.run);}async function y(){s.text(m,"正在加载评论中..."),s.css(d,"display",""),h.info("请求下一页评论："+p);let $=p,k=await B.get($,{fetch:true});if(!k.status)return;let T=s.toElement(k.data.responseText,true,true),R=C(".comiis_postlist.kqide"),I=T.querySelector(".comiis_postlist.kqide"),E=T.querySelector(".nxt"),A=E?.getAttribute("href")||E?.href;if(A){if(h.success("成功获取到下一页评论"),A===p){h.warn("获取到下一页评论的url和上次请求的url相同，判定为已加载完全部评论，移除监听事件"),g();return}p=A;}else h.error("评论全部加载完毕，移除监听事件"),g();let N=E?.parentElement.querySelector("strong");if(N){let z=C("#select_a");if(z){let w=Array.from(z.childNodes).find(b=>b.nodeName==="#text");w&&(w.textContent=`第 ${N.textContent} 页`);}}S.execMenu("mt-forum-post-syncNextPageUrl",()=>{if(window===top?.window){let z=new URL($),w=`${z.pathname}${z.search}`;window.history.pushState("forward","",w);}}),s.append(R,I),Ze.init();}var q=new f.LockFunction(async()=>{f.isNearBottom(50)&&await y();});s.text(m,"请上下滑动或点击加载"),s.on(window,"scroll",q.run),s.on(m,"click",y),q.run();}let a=s.toElement(`
		<div class="comiis_multi_box bg_f b_t">
			...
			`),s.on(document,"click",".reader-copy-button",async function(i){s.preventEvent(i);let n=i.target,a=C(n.getAttribute("data-code-selector"));return await f.copy(a.outerText||a.innerText),_.success("已复制到剪贴板"),false})),F(".comiis_blockcode.comiis_bodybg").forEach(i=>{if(i.getAttribute("data-copy"))return;i.setAttribute("data-copy","true");let n=s.createElement("div",{innerHTML:`
        ...
        `),H.onReady(()=>{S.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),S.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),S.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){h.info("显示搜索历史");let e=Z("search_history",[]),t=C("#scform_srchtxt"),i=C("#searchform");const n=e.map(l=>({value:l,enableDeleteButton:true,deleteButtonClickCallback(c,m,d,u){let p=e.findIndex(g=>g===d.value);p!==-1&&(e.splice(p,1),G("search_history",e)),m.remove();},itemView(c,m,d){return c.value},clickCallback(c,m,d,u){t.value=d.value,i.submit();}}));let a=U.searchSuggestion({$target:t,$inputTarget:t,data:n,inputTargetChangeRefreshShowDataCallback(l,c,m){return n.filter(d=>d.value.includes(l))}});a.init(),a.setAllEvent();function o(){let l=document.querySelector("#scform_submit");H.on(l,"click",function(){let c=t.value;if(c!=""){let m=Z("search_history",[]);m.includes(c)?h.info("已有该搜索历史记录"):(h.info("无该记录，追加"),m.push(c)),G("search_history",m);}});}function r(){let c='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+Z("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    border: none;
                    float: right;
                    background: red;
                    color: #fff;
		...
		}`),e.append(t);},showTodayRanking(){h.info("显示【今日最先】");let e=document.querySelector(".comiis_topnv .comiis_flex .flex"),t=s.createElement("li",{className:"flex"}),i=s.createElement("a",{id:"k_misignlist_today_latest",href:"javascript:;",innerHTML:"今日最先"},{onclick:"ajaxlist('todayLatest');"});t.appendChild(i),s.after(e,t);let n=async r=>{let l=await B.get(`/k_misign-sign.html?operation=${r}`,{responseType:"html",headers:{"User-Agent":f.getRandomPCUA()}});if(!l.status)return;let m=s.toElement(l.data.responseText,true,true).querySelector("#J_list_detail .pg span");if(m&&typeof m.title<"u"){let d=m.title.match(/([0-9]+)/);if(d&&d.length==2)return parseInt(d[d.length-1]);_.error("获取页失败");}else _.error("请求最先签到的页失败");},a=async r=>{let l=await B.get(`/k_misign-sign.html?operation=list&op=&page=${r}`,{responseType:"html",headers:{"User-Agent":f.getRandomPCUA()}});if(!l.status)return;let m=s.toElement(l.data.responseText,true,true).querySelectorAll("#J_list_detail tbody tr"),d=[];if(m.length==2&&m[0].textContent.indexOf("暂无内容")!=-1)return d;for(let u=1;u<=m.length-2;u++){let p=m[u],g={user:"",uid:"",avatar:"",days:"",monthDays:"",time:"",reward:""},y=p.children[0].getElementsByTagName("a")[0].textContent,$=p.children[0].getElementsByTagName("a")[0].href.match(/space-uid-([0-9]*)/)[1],k=p.children[1].textContent,T=p.children[2].textContent,R=p.children[3].textContent,I=p.children[5].textContent;g.user=y,g.uid=$,g.avatar=O.getAvatar($,"small"),g.days=k,g.monthDays=T,g.time=R,g.reward=I,d.push(g);}return d};function o(r,l){let c=document.querySelector("#ranklist");s.html(c,r),s.attr(c,"listtype",l);}x.ajaxlist=async r=>{if(r=r,r=="today"?(loadingdelay=false,urlextra="list&op=today"):r=="month"?(loadingdelay=false,urlextra="list&op=month"):r=="zong"?(loadingdelay=false,urlextra="list&op=zong"):r=="calendar"?(loadingdelay=true,urlextra="calendar"):(loadingdelay=false,urlextra="list"),r=="todayLatest"){loadingdelay=false,urlextra="list&op=&page=0";let l=await n(urlextra);if(!l)return;let c=await a(l);if(c.reverse(),c.length<10){let u=await a(l-1);u.reverse(),c=c.concat(u),c.reverse();}let m="";c.reverse(),c.forEach(u=>{m=m+`
					...
					<div class="k_misign_wp">
						<div class="k_misign_list bg_f">
							...
							<li class="flex">
								...
								`)),o(c,r);});};}},qt={init(){S.execMenuOnce("mt-space-repairEnterSpace",()=>{this.repairEnterSpace();}),s.onReady(()=>{S.execMenuOnce("mt-space-showCommentContent",()=>{this.showCommentContent();});});},repairEnterSpace(){if(h.info("修复无法进入空间"),L.isSpace()){let e=window.location.href.match(/home.php\?(.+)/gi),t=e[e.length-1];t.split("&").length==2&&t.indexOf("uid=")!=-1&&t.indexOf("mod=space")!=-1&&(window.location.href=window.location.href+"&do=profile");}else if(L.isSpaceWithAt()){let e=window.location.href.match(/space-uid-(.+).html/i),t=e[e.length-1];window.location.href=`${window.location.origin}/home.php?mod=space&uid=${t}&do=profile`;}},async showCommentContent(){h.info("显示帖子回复内容"),K(`
		div.contrete-reply{padding:5px 10px;border-top:1px solid #f3f3f3}
		div.contrete-reply a{margin:0 10px}
		`);async function e(){let r=await B.get(window.location.href,{headers:{"User-Agent":f.getRandomPCUA()}});if(!r.status)return;let l=s.toElement(r.data.responseText,true,true),c=[];return l.querySelectorAll("#delform tr.bw0_all+tr").forEach(m=>{let d=[],u=m.querySelector("td"),p=s.html(u).replace(/^&nbsp;/,"");d.push(p);let g=s.next(m),y=l.querySelectorAll("#delform tr");for(let q=0;q<y.length&&!(!g||s.attr(g,"class")==="bw0_all");q++){let $=g.querySelector("td"),k=s.html($).replace(/^&nbsp;/,"");d=d.concat(k),g=s.next(g);}c.push(...d);}),c}function t(){return f.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist())}function i(r){let l={};return r.forEach(c=>{let d=s.createElement("div",{innerHTML:c}).querySelector("a")?.getAttribute("href"),u=d.match(ee.ptid),p=d.match(ee.pid);if(!u){_.error("获取ptid失败");return}if(!p){_.error("获取pid失败");return}let g=u[u.length-1],y=p[p.length-1];l[g]?l[g].data.push(c):l[g]={ptid:g,pid:y,data:[c]};}),l}var n=await e();if(n==null)return;var a=i(n);t().forEach((r,l)=>{let m=r.querySelector(".comiis_xznalist_bottom a").getAttribute("tid");if(!m){_.error("获取帖子tid失败"),h.error(r);return}a[m]&&a[m].data.forEach(d=>{s.append(r,`<div class="contrete-reply">${d}</div>`);});});}},ge={$key:{tipData:"tipToFreeSubjectForumPost"},init(){this.registerMenu();let e=this.getTipData();if(L.isPost()&&document.querySelector("span.kmren")){h.info("当前帖子存在需要购买主题");let o=false,r;e.forEach((c,m)=>{if(window.location.href.match(c.url)){o=true;return}}),o?(h.warn("已设置提醒"),r=s.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                        <i class="comiis_font" style="color: #ffffff;"></i>
                        `}),s.on(r,"click",function(){U.confirm({title:{text:"提示",position:"center"},content:{text:"<p>确定移出付费主题白嫖列表？</p>",html:true},btn:{ok:{callback:function(){let c=e.findIndex((m,d)=>window.location.href.match(m.url));c!==-1?(e.splice(c,1),ge.setTipData(e),_.success("移除成功")):_.error("移除失败");}}},width:"88vw",height:"300px"});})):(h.info("未设置提醒"),r=s.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                        <i class="comiis_font" style="color: #FF9900;"></i>
                        `}),s.on(r,"click",()=>{let c=document.querySelector(".kmren"),m=s.parent(c),d=s.text(m).replace(/\t|\n/g,"").match(/[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]{1}[0-9]{1,2}:[0-9]{1,2}/);if(!d||d.length==0){_.error("获取付费主题到期时间失败");return}let u=d[0],p=f.formatToTimeStamp(u);e.push({url:window.location.href,title:document.title.replace(" - MT论坛",""),expirationTime:u,expirationTimeStamp:p,isVisited:false}),G("tipToFreeSubjectForumPost",e),_.success("添加成功"),setTimeout(function(){window.location.reload();},1500);}));let l=document.querySelector(".comiis_head.f_top .header_y");s.append(l,r);}function t(){let a=0;return Array.from(ge.getTipData()).forEach((o,r)=>{new Date().getTime()>o.expirationTimeStamp&&o.isVisited==false&&(a+=1);}),a}if(L.isMySpace()||L.isGuide()||L.isForumList()||L.isPlate()){let a=document.querySelector(".icon_msgs.bg_del.f_f"),o=0;a?(o=parseInt(s.text(a)),s.html(a,(o+t()).toString()),s.append(".comiis_head .header_z .kmuser em",'<span class="icon_msgs bg_del"></span>')):t()&&s.append(".comiis_head .header_z .kmuser em",'<span class="icon_msgs bg_del"></span>');}let i=document.querySelector(".sidenv_num.bg_del.f_f"),n=0;if(i)n=parseInt(s.text(i)),s.html(".sidenv_num.bg_del.f_f",(n+t()).toString());else {let a=t();a&&s.before(".sidenv_user em",`<span class="sidenv_num bg_del f_f">${a}</span>`);}t()&&s.append(".comiis_left_Touch .paymentsubjectreminder div.flex",`
                <span class="sidenv_num bg_del f_f" style="
                    ...
                    display: inline-flex;
                    bottom: 8px;
                "></span>`);},registerMenu(){j.registerLeftMenu({name:"付费主题白嫖提醒",icon:"",iconColor:"#ec0000",callback:()=>{this.showView();}});},showView(){h.info("显示白嫖列表");let e=ge.getTipData();U.alert({title:{text:"付费主题白嫖列表",position:"center"},content:{text:"",html:true},btn:{ok:{text:"关闭",type:"default"}},width:"88vw",height:"88vh"});let t="",i=0,n="",a="",o=[],r=[],l=[];e.forEach((g,y)=>{let q="#f91212",$="";new Date().getTime()>g.expirationTimeStamp&&(q="#1e90ff",g.isVisited||($=`
                    ...
                    <tr>
                        <td style="width: 100%;">
                            ...
                            <div style="width: 240px;">                 
                                ...
                                <li style="margin: 5px 15px;color: ${q};">${g.expirationTime}</li>
                            </div>
                ...
                </tbody>`,timestamp:g.expirationTimeStamp};new Date().getTime()>g.expirationTimeStamp?$!=""?o.push(k):r.push(k):l.push(k);}),h.info("可白嫖但未访问：",o),h.info("可白嫖：",r),h.info("未到白嫖时间：",l),f.sortListByProperty(o,"expirationTimeStamp",false),f.sortListByProperty(r,"timestamp",false),f.sortListByProperty(l,"timestamp",false),h.info("排序后——可白嫖但未访问：",o),h.info("排序后——可白嫖：",r),h.info("排序后——未到白嫖时间：",l),n=f.mergeArrayToString(o,"content")+f.mergeArrayToString(r,"content"),a=f.mergeArrayToString(l,"content"),i>0&&(t=`
        ...
        `,d=document.querySelector(".msgcon");s.html(d,""),s.append(d,c),s.append(d,m),s.css(d,"height","400px"),s.on(document.querySelector(".delsubjecttip i.comiis_font"),"click",g=>{let y=g.target,q=s.parent(y);var $=parseInt(q.getAttribute("t-index"));U.confirm({title:{text:"提示",position:"center"},content:{text:"<p>确定移出付费主题白嫖列表？</p>",html:true},btn:{ok:{callback:k=>{e.splice($,1),ge.setTipData(e),s.deleteParentNode(y,"tr"),k.close();}}},width:"80vw",height:"300px"});});let u=document.querySelector("#paymentSubjectReminderIsFreeList");s.on(u,"click","a",g=>{let y=g.target;var q=parseInt(y.getAttribute("t-index")),$=y.getAttribute("t-href");if(e[q].isVisited=true,ge.setTipData(e),window.open($,"_blank"),y.setAttribute("style","color: #000000;"),y?.parentElement?.parentElement?.children[0].className!="icon_msgs bg_del")return;y.parentElement.parentElement.children[0].remove(),s.append(u,y?.parentElement?.parentElement?.parentElement?.parentElement?.parentElement);let k=document.querySelector(".subjectcanvisit summary span.icon_msgs.bg_del.f_f"),T=s.text(k),R=parseInt(T)-1;R>0?s.html(k,R.toString()):k.remove();});let p=document.querySelector("paymentSubjectReminderIsPaidList");s.on(p,"click","a",g=>{let y=g.target;y.getAttribute("t-index");var q=y.getAttribute("t-href");window.open(q,"_blank"),y.setAttribute("style","color: #000000;");});},getTipData(){return Z(this.$key.tipData,[])},setTipData(e){G(this.$key.tipData,e);}},$t=`.pops {\r
  --icon-width: 24px;\r
...
`;class kt{isBacking=false;config;constructor(t){this.config=t,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(t){s.preventEvent(t),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){h.success("进入手势模式");let t=this.config.hash;t.startsWith("#")||(t.startsWith("/")||(t="/"+t),t="#"+t),this.config.useUrl&&(t=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+t),this.config.win.history.pushState({},"",t),h.success("监听popstate事件"),s.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(t=false){this.isBacking=true,h.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(t);let i=Date.now()+1e3*5;for(;;){if(Date.now()>i){h.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))h.info("history.back()"),this.config.win.history.back(),await X.sleep(this.config.backDelayTime||150);else break}h.success("移除popstate事件"),s.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(t);}}const he={https:`
		...
		</svg>`},Je={$key:{smallWindow:"smallWindow"},$el:{$refreshIcon:null,$webSiteIcon:null},init(){let e=new f.LockFunction(()=>{let t=this.getForumList();t.length&&this.handleForumPost(t);});f.mutationObserver(document.documentElement,{callback:(t,i)=>{e.run();},config:{subtree:true,childList:true}});},getForumList(){return f.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist())},showSmallWindow(e,t,i=[]){let n=new URL(t),a=n.protocol.includes("https:"),o=`
        ...
        <div class="small-window-title-container">
            ...
            <div class="small-window-control">
                ...
                `,html:true},mask:{enable:true,clickEvent:{toClose:true},clickCallBack(I,E){R.quitGestureBackMode();}},btn:{ok:{enable:false},cancel:{enable:false},close:{enable:false}},direction:"bottom",size:"92%",borderRadius:18,style:$t}),l=r.$shadowRoot.querySelector(".small-window-website-icon"),c=r.$shadowRoot.querySelector(".refresh-icon"),m=r.$shadowRoot.querySelector(".small-window-control-image-view"),d=r.$shadowRoot.querySelector(".small-window-control-open-blank"),u=r.$shadowRoot.querySelector(".small-window-control-close"),p=r.$shadowRoot.querySelector(".small-window-title-text");this.$el.$refreshIcon=c,this.$el.$webSiteIcon=l;let g=r.$shadowRoot.querySelector("iframe"),y=r.$shadowRoot.querySelector(".small-window-drag"),q=U.config.Utils.AnyTouch(),$=new q(y),k=r.$pops,T=s.height(k);$.on("pan",I=>{I.phase=="move"&&I.displacementY>0&&(k.style.transition="none",k.style.height=Math.abs(T-I.distanceY)+"px"),I.isEnd&&(k.style.transition="0.2s ease-in",parseInt(k.style.height)>window.innerHeight/2?k.style.height=T+"px":r.close());});let R=new kt({hash:this.$key.smallWindow,useUrl:true,win:x,beforeHistoryBackCallBack:I=>{r.close();}});R.enterGestureBackMode(),s.on(p,"click",I=>{s.preventEvent(I),f.copy(`『${e}』 - ${t}`),_.success("已复制链接");}),s.on(m,"click",I=>{s.preventEvent(I),h.info("查看图片",i);var E="";i.forEach(z=>{E+=`<li><img data-src="${z}"></li>`;});var A=s.toElement(`<ul>${E}</ul>`,false,false);let N=new Fe(A,{inline:false,url:"data-src",zIndex:(()=>{let z=f.getMaxZIndex(),w=U.config.InstanceUtils.getPopsMaxZIndex().zIndex;return f.getMaxValue(z,w)+100})(),hidden:()=>{N.destroy();}});N.zoomTo(1),N.show();}),s.on(u,"click",I=>{s.preventEvent(I),R.quitGestureBackMode();}),s.on(d,"click",I=>{s.preventEvent(I),window.open(t,"_blank");}),s.on(l,"click",I=>{s.preventEvent(I),g.contentWindow.location.reload(),this.checkIframeReadyState(g);}),this.checkIframeReadyState(g);},async handleForumPost(e){e.forEach(t=>{if(t.getAttribute("data-injection-small-window"))return;let i=s.text(t.querySelector(".mmlist_li_box h2 a"));(i==""||i==null)&&(i=s.text(t.querySelector(".mmlist_li_box a"))),i=i.trim();let n=t.querySelector(".mmlist_li_box a").href;var a=[];t.setAttribute("data-injection-small-window","true"),t.setAttribute("data-injection-small-window-url",n),t.setAttribute("data-injection-small-window-title",i),t.querySelectorAll(".comiis_pyqlist_img img").forEach(r=>{a.push(r.getAttribute("src"));}),t.querySelectorAll(".comiis_pyqlist_imgs img").forEach(r=>{a.push(r.getAttribute("src"));}),t.querySelectorAll(".mmlist_li_box a").forEach(r=>{r.removeAttribute("href"),r.setAttribute("data-href",n);});let o=t.querySelector(".mmlist_li_box");s.on(o,"click",function(r){var l=Number(r.clientX);document.body.offsetWidth/2>l?window.location.href=n:Je.showSmallWindow(i,n,a);});});},checkIframeReadyState(e){this.showRefreshIcon();let t=setInterval(()=>{e.contentWindow&&(clearInterval(t),s.createDOMUtils({document:e.contentWindow.document,window:e.contentWindow,globalThis:e.contentWindow,self:e.contentWindow,top}).onReady(()=>{h.success("小窗内容已加载完毕"),this.hideRefreshIcon();}));},400);},hideRefreshIcon(){this.$el.$refreshIcon.style.display="none",this.$el.$webSiteIcon.style.display="";},showRefreshIcon(){this.$el.$refreshIcon.style.display="",this.$el.$webSiteIcon.style.display="none";}},St={init(){H.onReady(()=>{S.execMenuOnce("mt-guide-showLatestPost",()=>{this.showLatestPost();});});},showLatestPost(){h.info("显示最新帖子");async function e(){let t=await B.get("/forum.php?mod=guide&view=hot",{fetch:true,allowInterceptConfig:false});if(!t.status){_.error("获取轮播失败");return}if(t.data.responseText.indexOf('<script src="/_guard/auto.js"><\/script>')!==-1){_.error("获取轮播失败 未知的/_guard/auto.js文件");return}var i=H.toElement(t.data.responseText,true,true),n=i.querySelectorAll('div.comiis_mh_kxtxt div[id*="comiis_mh_kxtxt"] ul');if(n.length===0){_.error("获取轮播失败");return}else {var a=[];n[n.length-1].querySelectorAll("a").forEach(o=>{a.push({href:o.getAttribute("href"),title:o.getAttribute("title")});});}return a}e().then(t=>{if(!t)return;K(`
            ...
            `);var i="";f.sortListByProperty(t,a=>{var o=a.href.match(/thread-(.+?)-/i);return parseInt(o[o.length-1])},true),h.info("导读内容",t),t.forEach(a=>{i+=`
                <li>
                    <span>新帖</span>
                    <a href="${a.href}" title="${a.title}" target="_blank">${a.title}</a>
                </li>`;});let n=document.querySelector(".comiis_forumlist.comiis_xznlist");H.before(n,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}},Se=function(e,t,i,n,a,o,r,l,c,m){const d={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:a,buttonIconIsLoading:o,buttonType:r,buttonText:i,callback(u){typeof l=="function"&&l(u);},afterAddToUListCallBack:c};return Reflect.set(d.attributes,Re,()=>{d.disable=false;}),d},me=function(e,t,i,n,a,o="",r,l){const c={text:e,type:"input",inputType:"number",attributes:{},props:{},description:n,placeholder:o,afterAddToUListCallBack:r,getValue(){return this.props[V].get(t,i)},callback(m,d,u){this.props[V].set(t,d);}};return Reflect.set(c.attributes,te,t),Reflect.set(c.attributes,ie,i),fe.initComponentsStorageApi("input",c,{get(m,d){return S.getValue(m,d)},set(m,d){S.setValue(m,d);}}),c},ze=function(e,t,i,n,a,o="",r,l){const c={text:e,type:"input",inputType:"password",attributes:{},props:{},description:n,placeholder:o,afterAddToUListCallBack:r,getValue(){return this.props[V].get(t,i)},callback(m,d){this.props[V].set(t,d);}};return Reflect.set(c.attributes,te,t),Reflect.set(c.attributes,ie,i),fe.initComponentsStorageApi("input",c,{get(m,d){return S.getValue(m,d)},set(m,d){S.setValue(m,d);}}),c},Ne=function(e,t,i,n,a,o){const r={type:"own",attributes:{},props:{},createLIElement:e,afterAddToUListCallBack:o};return Reflect.set(r.attributes,Re,()=>false),typeof i=="object"&&i!==null&&Reflect.set(r.attributes,He,i),r},Be=function(e,t,i,n,a,o,r){const l={text:e,type:"select",description:o,attributes:{},props:{},getValue(){return this.props[V].get(t,i)},callback(c){if(c==null)return;const m=c.value;if(h.info(`选择：${c.text}`),typeof a=="function"&&a(c))return;this.props[V].set(t,m);},data:n};return Reflect.set(l.attributes,te,t),Reflect.set(l.attributes,ie,i),fe.initComponentsStorageApi("select",l,{get(c,m){return S.getValue(c,m)},set(c,m){S.setValue(c,m);}}),l},D=function(e,t,i,n,a,o,r,l,c){const m={text:e,type:"switch",description:a,disabled:r,attributes:{},props:{},getValue(){return this.props[V].get(t,i)},callback(d,u){const p=!!u;h.success(`${p?"开启":"关闭"} ${e}`),this.props[V].set(t,p);},afterAddToUListCallBack:(...d)=>{}};return Reflect.set(m.attributes,te,t),Reflect.set(m.attributes,ie,i),fe.initComponentsStorageApi("switch",m,{get(d,u){return S.getValue(d,u)},set(d,u){S.setValue(d,u);}}),m},_e=function(e,t,i,n,a,o="",r,l){const c={text:e,type:"textarea",attributes:{},props:{},description:n,placeholder:o,disabled:r,getValue(){const d=this.props[V].get(t,i);return Array.isArray(d)?d.join(`
`):d},callback(m,d){this.props[V].set(t,d);}};return Reflect.set(c.attributes,te,t),Reflect.set(c.attributes,ie,i),fe.initComponentsStorageApi("switch",c,{get(m,d){return S.getValue(m,d)},set(m,d){S.setValue(m,d);}}),c},fe={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new X.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,i){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=i,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,V,t);}},Y=function(e,t,i,n,a,o="",r="text",l,c){const m={text:e,type:"input",inputType:r,attributes:{},props:{},description:n,placeholder:o,afterAddToUListCallBack:l,getValue(){return this.props[V].get(t,i)},callback(d,u){d.target.validity.valid,this.props[V].set(t,u);}};return Reflect.set(m.attributes,te,t),Reflect.set(m.attributes,ie,i),fe.initComponentsStorageApi("input",m,{get(d,u){return S.getValue(d,u)},set(d,u){S.setValue(d,u);}}),m};class Qe{option;constructor(t){this.option=t;}async showView(){const t=U.confirm({title:{text:this.option.title,position:"center"},content:{text:`
      ...
      `,btn:{merge:true,reverse:false,position:"space-between",ok:{enable:this.option?.bottomControls?.add?.enable||true,type:"primary",text:"添加",callback:async l=>{this.showEditView(false,await this.option.getAddData(),i.$shadowRoot);}},close:{enable:true,callback(l){i.close();}},cancel:{enable:false},other:{enable:this.option?.bottomControls?.clear?.enable||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:l=>{let c=U.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async m=>{if(h.success("清空所有"),typeof this.option?.bottomControls?.clear?.callback=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){_.error("清理失败");return}else _.success("清理成功");await this.updateDeleteAllBtnText(i.$shadowRoot),this.clearContent(i.$shadowRoot),c.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh"}),{$searchContainer:n,$externalSelect:a,$ruleValueSelect:o,$searchInput:r}=this.parseViewElement(i.$shadowRoot);if(this.option.bottomControls?.filter?.enable){let l=null,c=null;Array.isArray(this.option.bottomControls?.filter?.option)&&s.append(a,this.option.bottomControls?.filter?.option.map(u=>{const p=s.createElement("option",{innerText:u.name});return Reflect.set(p,"data-value",u),p})),Array.isArray(this.option.bottomControls?.filter?.inputOption)&&s.append(o,this.option.bottomControls?.filter?.inputOption.map(u=>{const p=s.createElement("option",{innerText:u.name});return Reflect.set(p,"data-value",u),p})),s.on(a,"change",async u=>{const p=a[a.selectedIndex],g=Reflect.get(p,"data-value");typeof g?.selectedCallBack=="function"&&g.selectedCallBack(g),l=g,await d(false);}),s.on(o,"change",async u=>{const p=o[o.selectedIndex],g=Reflect.get(p,"data-value");typeof g?.selectedCallBack=="function"&&g.selectedCallBack(g),c=g,await d(false);}),s.onInput(r,f.debounce(async()=>{await d(false);}));const m=()=>{const u=a[a.selectedIndex];l=Reflect.get(u,"data-value");const p=o[o.selectedIndex];c=Reflect.get(p,"data-value");},d=async u=>{this.clearContent(i.$shadowRoot),u&&m();const p=await this.option.data(),g=[],y=s.val(r);for(let q=0;q<p.length;q++){const $=p[q];if(l){const k=await l?.filterCallBack?.($);if(typeof k=="boolean"&&!k)continue}if(c){let k=true;if(y===""?k=true:k=false,k||(k=await c?.filterCallBack?.($,y)),!k)continue}g.push($);}await this.appendRuleItemElement(i.$shadowRoot,g);};if(typeof t=="object"&&t!=null){let u;typeof t.external=="number"?u=t.external:u=Array.from(a.options).findIndex(g=>Reflect.get(g,"data-value").value===t.external),u!==-1&&(a.selectedIndex=u);let p;typeof t.rule=="number"?p=t.rule:p=Array.from(o.options).findIndex(g=>Reflect.get(g,"data-value").value===t.rule),p!==-1&&(o.selectedIndex=p);}await d(true);}else s.hide(n,false);}showEditView(t,i,n,a,o,r){let l=async m=>{if(m){if(typeof r=="function"){let d=await this.option.getData(i);r(d);}}else if(t||await this.option.deleteData(i),typeof o=="function"){let d=await this.option.getData(i);o(d);}};new Qe({title:t?"编辑":"添加",data:()=>i,dialogCloseCallBack:l,getView:async m=>await this.option.itemControls.edit.getView(m,t),btn:{ok:{enable:true,text:t?"修改":"添加"},cancel:{callback:async(m,d)=>{m.close(),await l(false);}},close:{callback:async(m,d)=>{m.close(),await l(false);}}},onsubmit:async(m,d)=>{let u=await this.option.itemControls.edit.onsubmit(m,t,d);return u.success?t?(_.success("修改成功"),n&&await this.updateRuleItemElement(u.data,a,n)):n&&await this.appendRuleItemElement(n,u.data):t&&h.error("修改失败"),u},style:this.option.itemControls.edit.style,width:this.option.itemControls.edit.width,height:this.option.itemControls.edit.height}).showView();}parseViewElement(t){const i=t.querySelector(".rule-view-container"),n=t.querySelector(".pops-confirm-btn button.pops-confirm-btn-other"),a=t.querySelector(".rule-view-search-container"),o=a.querySelector(".pops-panel-select .select-rule-status"),r=a.querySelector(".pops-panel-select .select-rule-value"),l=a.querySelector(".pops-panel-input input");return {$container:i,$deleteBtn:n,$searchContainer:a,$externalSelect:o,$ruleValueSelect:r,$searchInput:l}}parseRuleItemElement(t){const i=t.querySelector(".rule-controls-enable"),n=i.querySelector(".pops-panel-switch"),a=i.querySelector(".pops-panel-switch__input"),o=i.querySelector(".pops-panel-switch__core"),r=t.querySelector(".rule-controls-edit"),l=t.querySelector(".rule-controls-delete");return {$enable:i,$enableSwitch:n,$enableSwitchInput:a,$enableSwitchCore:o,$edit:r,$delete:l,data:Reflect.get(t,"data-rule")}}async createRuleItemElement(t,i){const n=await this.option.getDataItemName(t),a=s.createElement("div",{className:"rule-item",innerHTML:`
			...
			`});Reflect.set(a,"data-rule",t);const o="pops-panel-switch-is-checked",{$enable:r,$enableSwitch:l,$enableSwitchCore:c,$enableSwitchInput:m,$delete:d,$edit:u}=this.parseRuleItemElement(a);return this.option.itemControls.enable.enable?(s.on(c,"click",async p=>{let g=false;l.classList.contains(o)?(l.classList.remove(o),g=false):(l.classList.add(o),g=true),m.checked=g,await this.option.itemControls.enable.callback(t,g);}),await this.option.itemControls.enable.getEnable(t)&&l.classList.add(o)):r.remove(),this.option.itemControls.edit.enable?s.on(u,"click",p=>{s.preventEvent(p),this.showEditView(true,t,i,a,g=>{t=null,t=g;});}):u.remove(),this.option.itemControls.delete.enable?s.on(d,"click",p=>{s.preventEvent(p);const g=U.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async y=>{h.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(t)?(_.success("成功删除该数据"),a.remove(),await this.updateDeleteAllBtnText(i),g.close()):_.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):d.remove(),a}async appendRuleItemElement(t,i){const{$container:n}=this.parseViewElement(t),a=[],o=Array.isArray(i)?i:[i];for(let r=0;r<o.length;r++){const l=o[r],c=await this.createRuleItemElement(l,t);a.push(c);}return s.append(n,a),await this.updateDeleteAllBtnText(t),a}async updateRuleContaienrElement(t){this.clearContent(t);const{$container:i}=this.parseViewElement(t),n=await this.option.data();await this.appendRuleItemElement(t,n),await this.updateDeleteAllBtnText(t);}async updateRuleItemElement(t,i,n){const a=await this.createRuleItemElement(t,n);i.after(a),i.remove();}clearContent(t){const{$container:i}=this.parseViewElement(t);s.html(i,"");}setDeleteBtnText(t,i,n=false){const{$deleteBtn:a}=this.parseViewElement(t);n?s.html(a,i):s.text(a,i);}async updateDeleteAllBtnText(t){let i=await this.option.data();this.setDeleteBtnText(t,`清空所有(${i.length})`);}}const Ct={$key:{STORAGE_KEY:"mt-own-block-rule"},$data:{isRegister:false},init(){this.registerMenu();let e=new f.LockFunction(()=>{this.runRule();});f.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{e.run();}});},registerMenu(){this.$data.isRegister||(this.$data.isRegister=true,j.registerLeftMenu({name:"我的屏蔽",icon:"",iconColor:"#000",callback:()=>{this.showView();}}));},getTemplateData(){return {uuid:f.generateUUID(),enable:true,name:"",data:{userName:"",userUID:"",userLevel:"",postUrl:"",postTitle:"",postContent:"",postPlateName:""}}},showView(){let e=U.config.PanelHandlerComponents();function t(n){return {get(a,o){return n[a]??o},set(a,o){n[a]=o;}}}new Le({title:"我的屏蔽",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(r=>r.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,a)=>{n.enable=a,this.updateData(n);}},edit:{enable:true,getView:(n,a)=>{let o=document.createDocumentFragment();a||(n=this.getTemplateData());let r=D("启用","enable",true);Reflect.set(r.props,V,t(n));let l=e.createSectionContainerItem_switch(r).$el,c=Y("规则名称","name","","",void 0,"必填");Reflect.set(c.props,V,t(n));let m=e.createSectionContainerItem_input(c).$el,d=Y("用户名","userName","","",void 0,"可正则");Reflect.set(d.props,V,t(n.data));let u=e.createSectionContainerItem_input(d).$el,p=Y("用户UID","userUID","","",void 0,"可正则");Reflect.set(p.props,V,t(n.data));let g=e.createSectionContainerItem_input(p).$el,y=Y("用户等级","userLevel","","",void 0,"可正则");Reflect.set(y.props,V,t(n.data));let q=e.createSectionContainerItem_input(y).$el,$=Y("帖子url","postUrl","","",void 0,"可正则");Reflect.set($.props,V,t(n.data));let k=e.createSectionContainerItem_input($).$el,T=Y("帖子标题","postTitle","","",void 0,"可正则");Reflect.set(T.props,V,t(n.data));let R=e.createSectionContainerItem_input(T).$el,I=Y("帖子内容","postContent","","",void 0,"可正则");Reflect.set(I.props,V,t(n.data));let E=e.createSectionContainerItem_input(I).$el,A=Y("帖子所在的板块名","postPlateName","","",void 0,"可正则");Reflect.set(A.props,V,t(n.data));let N=e.createSectionContainerItem_input(A).$el;return o.appendChild(l),o.appendChild(m),o.appendChild(u),o.appendChild(g),o.appendChild(q),o.appendChild(k),o.appendChild(R),o.appendChild(E),o.appendChild(N),o},onsubmit:(n,a,o)=>{let r=n.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();return a&&(l.uuid=o.uuid),r.forEach(c=>{let m=Reflect.get(c,e.$data.nodeStoreConfigKey),d=Reflect.get(m,"attributes"),u=Reflect.get(c,V),p=Reflect.get(d,te),g=Reflect.get(d,ie),y=u.get(p,g);Reflect.has(l,p)?Reflect.set(l,p,y):Reflect.has(l.data,p)?Reflect.set(l.data,p,y):h.error(`${p}不在数据中`);}),l.name.trim()===""?(_.error("规则名称不能为空"),{success:false,data:l}):a?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}}},delete:{enable:true,deleteCallBack:n=>this.deleteData(n)}}}).showView();},runRule(){let e=this.getData();function t(i){for(const n of e){let a=n.data;if(Object.keys(a).find(r=>{let l=a[r];if(f.isNotNull(l)){let c=new RegExp(l,"i"),m=Reflect.get(i,r);if(typeof m=="string"&&f.isNotNull(m)&&m.match(c))return h.info("屏蔽",[a,m]),true}return  false}))return  true}return  false}(L.isGuide()||L.isPlate()||L.isPost())&&(this.getData(),document.querySelectorAll(".comiis_forumlist .forumlist_li").forEach(i=>{let n=i.querySelector("a.top_user"),a=n.href.match(ee.uid),o={userName:n.innerText,userUID:a[a.length-1].trim(),userLevel:i.querySelector("span.top_lev").innerText.replace("Lv.",""),postUrl:i.querySelector(".mmlist_li_box a").getAttribute("href")||i.querySelector(".mmlist_li_box a").getAttribute("data-href"),postTitle:i.querySelector(".mmlist_li_box h2 a")?.innerText||"",postContent:i.querySelector(".mmlist_li_box .list_body").innerText,postPlateName:(i.querySelector(".forumlist_li_time a.f_d")||i.querySelector(".comiis_xznalist_bk.cl")).innerText.replace(//g,"").replace(/\s*/g,"").replace(/来自/g,"")};f.isNull(o.postPlateName)&&(o.postPlateName=document.querySelector("#comiis_wx_title_box").innerText),t(o)&&i.remove();}),document.querySelectorAll(".comiis_postlist .comiis_postli").forEach(i=>{let n=i.querySelector("a.top_user"),a=n.href.match(ee.uid),o={userName:n.innerText,userUID:a[a.length-1].trim(),userLevel:i.querySelector("a.top_lev").innerText.replace("Lv.",""),postUrl:void 0,postTitle:void 0,postContent:i.querySelector(".comiis_message_table").innerText,postPlateName:void 0};t(o)&&i.remove();})),L.isMessageList()&&(this.getData(),F(".comiis_pms_box .comiis_pmlist ul li").forEach(i=>{let n=i.querySelector("a.b_b").href.match(ee.uid),a={userName:i.querySelector("h2").innerText.replace(i.querySelector("h2 span").innerText,"").replace(/\s*/,""),userUID:n[n.length-1].trim(),userLevel:void 0,postUrl:i.querySelector("a.b_b").href,postTitle:void 0,postContent:i.querySelector("p.f_c").innerText.trim(),postPlateName:void 0};t(a)&&i.remove();}));},getData(){return Z(this.$key.STORAGE_KEY,[])},setData(e){G(this.$key.STORAGE_KEY,e);},addData(e){let t=this.getData();return t.findIndex(n=>n.uuid==e.uuid)===-1?(t.push(e),G(this.$key.STORAGE_KEY,t),true):false},updateData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t[i]=e),this.setData(t),n},deleteData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t.splice(i,1)),this.setData(t),n},clearData(){ae(this.$key.STORAGE_KEY);}},Tt={$el:{isFilterElementHTML:[]},$key:{STORAGE_KEY:"mt-post-comment-filter-rule"},init(){if(this.registerMenu(),L.isPost()){let e=this.getData();if(!e.enable)return;let t=new f.LockFunction(()=>{this.runFilter(e);});f.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{t.run();}});}},registerMenu(){j.registerLeftMenu({name:"评论过滤器",icon:"",iconColor:"#ff0019",callback:()=>{this.showView();}});},runFilter(e){let t=function(n){for(const a of e.userBlackList)if(a==n.userName||a==n.userUID)return h.success("评论过滤器：黑名单用户",n),true;return  false},i=function(n){for(const a of e.userWhiteList)if(a===n.userName||a===n.userUID)return h.success("评论过滤器：白名单用户",n),true;return  false};F(".comiis_postlist .comiis_postli").forEach(n=>{if(n.querySelector("#comiis_allreplies"))return;let a=n.querySelector("a.top_user"),o=a.href.match(ee.uid),r={userName:a?.innerText||"",userUID:o&&o[o?.length-1]?.trim()||"",content:n.querySelector(".comiis_message_table")?.innerText?.trim()||"",isAuthor:!!n.querySelector("span.top_lev")};if(!i(r)){if(e.replyFlag&&n.querySelector(".comiis_quote")){let l=n.querySelector(".comiis_quote");this.$el.isFilterElementHTML.push(l.outerHTML),l.remove();}if(!(r.isAuthor&&!e.avatarFlag)){if(t(r)){this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}if(!(typeof e.minLength=="number"&&e.minLength>r.content.length)&&!(typeof e.keywordLength=="number"&&e.keywordLength<r.content.length))for(const l of e.keywords){if(typeof l!="string")continue;let c=new RegExp(l);if(r.content.match(c)){console.log("评论过滤器：",r),this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}}}}});},showView(){const e=this;function t(a){return {get(o,r){let l=e.getData(),c=Reflect.get(l,o,r);return (o==="keywords"||o==="userWhiteList"||o==="userBlackList")&&(c=c.join(`
`)),c},set(o,r){(o==="keywords"||o==="userWhiteList"||o==="userBlackList")&&(r=r.split(`
`).filter(l=>l.trim()!="")),Reflect.set(a,o,r),e.setData(a);}}}let i=U.config.PanelHandlerComponents();new Qe({title:"评论过滤器",data:()=>this.getData(),getView:a=>{let o=document.createDocumentFragment(),r=D("启用","enable",true);Reflect.set(r.props,V,t(a));let l=i.createSectionContainerItem_switch(r).$el,c=D("处理回复引用","replyFlag",false,void 0,"移除引用");Reflect.set(c.props,V,t(a));let m=i.createSectionContainerItem_switch(c).$el,d=D("处理作者评论","avatarFlag",false);Reflect.set(d.props,V,t(a));let u=i.createSectionContainerItem_switch(d).$el,p=D('处理从"搜索页面"或"我的帖子提醒页面"进入的网站',"viewthreadFlag",false);Reflect.set(p.props,V,t(a));let g=i.createSectionContainerItem_switch(p).$el,y=me("匹配的评论内容长度最小值","minLength",5,"小于此长度的评论就算关键字匹配成功了也不会被排除");Reflect.set(y.props,V,t(a));let q=i.createSectionContainerItem_input(y).$el,$=me("匹配的评论内容长度最大值","keywordLength",8,"大于此长度的评论就算关键字匹配成功了也不会被排除");Reflect.set($.props,V,t(a));let k=i.createSectionContainerItem_input($).$el,T=_e("评论关键字","keywords","","多个关键字换行分割");Reflect.set(T.props,V,t(a));let R=i.createSectionContainerItem_textarea(T).$el,I=_e("黑名单用户","userBlackList","","多个用户换行分割");Reflect.set(I.props,V,t(a));let E=i.createSectionContainerItem_textarea(I).$el,A=_e("白名单用户","userWhiteList","","多个用户换行分割");Reflect.set(A.props,V,t(a));let N=i.createSectionContainerItem_textarea(A).$el;return o.append(l,m,u,g,q,k,R,E,N),o},btn:{merge:true,position:"space-between",ok:{enable:false},cancel:{enable:true,text:"关闭"},other:{enable:true,text:`查看已过滤（${this.$el.isFilterElementHTML.length}）`,type:"primary",callback:(a,o)=>{console.log(this.$el.isFilterElementHTML),U.alert({title:{text:"评论过滤器-已过滤",position:"center"},content:{text:`
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return Z(this.$key.STORAGE_KEY,this.getTemplateData())},setData(e){G(this.$key.STORAGE_KEY,e);}},It={$key:{STORAGE_KEY:"mt-productListingReminder-rule"},init(){this.registerMenu(),this.runRule();},registerMenu(){j.registerLeftMenu({name:"商品上架提醒",icon:"",iconColor:"#2376b7",callback:()=>{this.showView();}});},async runRule(){async function e(){let n=await B.get("/keke_integralmall-keke_integralmall.html",{fetch:true,allowInterceptConfig:false});if(!n.status){_.error("【积分商城】获取数据失败");return}let a=[];return s.toElement(n.data.responseText,true,true).querySelectorAll(".task-list-wrapper li.col-xs-12").forEach(r=>{a.push({name:s.text(r.querySelector(".mall-info a > *:first-child"))||s.text(r.querySelector(".mall-info a")),price:s.text(r.querySelector(".mall-info span.discount-price i")),endTime:s.text(r.querySelector(".mall-info #time_hz span.time")),remainingQuantity:parseInt(r.querySelector(".mall-info .mall-count .count-r")?.innerText?.replace(/仅剩|件/gi,"")||"0")});}),a}if(L.isPointsMall())return;let t=this.getData();if(!t.length)return;let i=await e();if(i){for(const n of i)for(const a of t)if(a.enable&&n.name.match(new RegExp(a.productName,"i"))&&!isNaN(n.remainingQuantity)&&n.remainingQuantity>0){h.success("成功匹配对应商品",a,n),U.confirm({title:{text:"积分商城提醒",position:"center"},content:{text:`<br />
                            您设置的商品已上架在积分商城中，当前售价 ${n.price}金币，仅剩${n.remainingQuantity}件，是否前往购买？
                            <a style="color: red !important;">(如需关闭提醒，请删除该关键字)</a>
                            <br />`,html:true},btn:{merge:true,position:"space-between",other:{enable:true,type:"danger",text:"删除提醒",callback:()=>{this.deleteData(a)?_.success("删除成功"):_.error("删除失败");}},ok:{text:"前往购买",callback:()=>{window.location.href=`${window.location.origin}/keke_integralmall-keke_integralmall.html`;}}},width:"300px",height:"300px"});return}}},getTemplateData(){return {uuid:f.generateUUID(),enable:true,name:"",productName:""}},showView(){let e=U.config.PanelHandlerComponents();function t(n){return {get(a,o){return n[a]??o},set(a,o){n[a]=o;}}}new Le({title:"商品上架提醒",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(r=>r.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,a)=>{n.enable=a,this.updateData(n);}},edit:{enable:true,getView:(n,a)=>{let o=document.createDocumentFragment();a||(n=this.getTemplateData());let r=D("启用","enable",true);Reflect.set(r.props,V,t(n));let l=e.createSectionContainerItem_switch(r).$el,c=Y("规则名称","name","","",void 0,"必填");Reflect.set(c.props,V,t(n));let m=e.createSectionContainerItem_input(c).$el,d=Y("商品名","productName","","",void 0,"可正则，需手动转义");Reflect.set(d.props,V,t(n));let u=e.createSectionContainerItem_input(d).$el;return o.append(l,m,u),o},onsubmit:(n,a,o)=>{let r=n.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();return a&&(l.uuid=o.uuid),r.forEach(c=>{let m=Reflect.get(c,e.$data.nodeStoreConfigKey),d=Reflect.get(m,"attributes"),u=Reflect.get(c,V),p=Reflect.get(d,te),g=Reflect.get(d,ie),y=u.get(p,g);Reflect.has(l,p)?Reflect.set(l,p,y):h.error(`${p}不在数据中`);}),l.name.trim()===""?(_.error("规则名称不能为空"),{success:false,data:l}):a?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}}},delete:{enable:true,deleteCallBack:n=>this.deleteData(n)}}}).showView();},getData(){return Z(this.$key.STORAGE_KEY,[])},setData(e){G(this.$key.STORAGE_KEY,e);},addData(e){let t=this.getData();return t.findIndex(n=>n.uuid==e.uuid)===-1?(t.push(e),G(this.$key.STORAGE_KEY,t),true):false},updateData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t[i]=e),this.setData(t),n},deleteData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t.splice(i,1)),this.setData(t),n},clearData(){ae(this.$key.STORAGE_KEY);}},Et={$key:{STORAGE_KEY:"mt-customizeUserLabels-rule"},init(){if(this.registerMenu(),L.isPage()||L.isGuide()||L.isPlate()||L.isPost()||L.isSearch()||L.isSpace()){let e=this.getData();if(!e.length)return;let t=new f.LockFunction(()=>{this.runRule(e);});f.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{t.run();}});}},registerMenu(){j.registerLeftMenu({name:"自定义用户标签",icon:"",iconColor:"#c70ea6",callback:()=>{this.showView();}});},showView(){let e=U.config.PanelHandlerComponents();function t(n){return {get(a,o){return n[a]??o},set(a,o){n[a]=o;}}}new Le({title:"自定义用户标签",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(r=>r.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,a)=>{n.enable=a,this.updateData(n);}},edit:{enable:true,getView:(n,a)=>{let o=document.createDocumentFragment();a||(n=this.getTemplateData());let r=D("启用","enable",true);Reflect.set(r.props,V,t(n));let l=e.createSectionContainerItem_switch(r).$el,c=Y("规则名称","name","","",void 0,"必填");Reflect.set(c.props,V,t(n));let m=e.createSectionContainerItem_input(c).$el,d=Y("用户UID","userUID","","",void 0,"必填，可正则，注意转义");Reflect.set(d.props,V,t(n));let u=e.createSectionContainerItem_input(d).$el,p=Y("标签名","labelName","","",void 0,"必填");Reflect.set(p.props,V,t(n));let g=e.createSectionContainerItem_input(p).$el,y=Y("标签颜色","labelColor","","");Reflect.set(y.props,V,t(n));let q=e.createSectionContainerItem_input(y).$el,$=q.querySelector("input");q.querySelector(".pops-panel-input__suffix")?.remove(),$.setAttribute("type","color"),s.css($,{margin:"unset",padding:"unset",width:"80px"});let k=Y("标签CSS","labelStyle","","");Reflect.set(k.props,V,t(n));let T=e.createSectionContainerItem_input(k).$el,R=_e("标签点击事件","labelClickEvent","","");Reflect.set(R.props,V,t(n));let I=e.createSectionContainerItem_textarea(R).$el;return o.append(l,m,u,g,q,T,I),o},onsubmit:(n,a,o)=>{let r=n.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();return a&&(l.uuid=o.uuid),r.forEach(c=>{let m=Reflect.get(c,e.$data.nodeStoreConfigKey),d=Reflect.get(m,"attributes"),u=Reflect.get(c,V),p=Reflect.get(d,te),g=Reflect.get(d,ie),y=u.get(p,g);Reflect.has(l,p)?Reflect.set(l,p,y):h.error(`${p}不在数据中`);}),l.name.trim()===""?(_.error("规则名称不能为空"),{success:false,data:l}):l.userUID.trim()===""?(_.error("用户UID不能为空"),{success:false,data:l}):l.labelName.trim()===""?(_.error("标签名不能为空"),{success:false,data:l}):a?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}},style:`
                    .pops-panel-textarea textarea{
                        height: 150px;
                    }
                    `},delete:{enable:true,deleteCallBack:n=>this.deleteData(n)}}}).showView();},runRule(e){let t=f.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist());t.length&&t.forEach(i=>{if(i.hasAttribute("data-custom-label"))return;i.setAttribute("data-custom-label","true");let n=Array.from(i.querySelectorAll("a")).map(a=>{let r=a.href.match(ee.uid);if(r)return r[r.length-1]}).filter(a=>a!=null);if(n.length){let a=n[0],o=e.filter(c=>c.enable&&a.match(new RegExp(c.userUID)));if(!o.length)return;let r=document.createElement("a"),l=i.querySelector(".top_lev");o.forEach(c=>{r.className=l.className,r.classList.add("gm-custom-label"),r.style.cssText=`
                    background: ${c.labelColor} !important;${c.labelStyle||""}`,r.innerHTML=c.labelName,s.on(r,"click",async m=>{s.preventEvent(m),f.isNotNull(c.labelClickEvent)&&x.eval(c.labelClickEvent);}),l.parentElement.append(r);});}});},getTemplateData(){return {uuid:f.generateUUID(),enable:true,name:"",userUID:"",labelName:"",labelColor:"",labelStyle:"",labelClickEvent:""}},getData(){return Z(this.$key.STORAGE_KEY,[])},setData(e){G(this.$key.STORAGE_KEY,e);},addData(e){let t=this.getData();return t.findIndex(n=>n.uuid==e.uuid)===-1?(t.push(e),G(this.$key.STORAGE_KEY,t),true):false},updateData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t[i]=e),this.setData(t),n},deleteData(e){let t=this.getData(),i=t.findIndex(a=>a.uuid==e.uuid),n=false;return i!==-1&&(n=true,t.splice(i,1)),this.setData(t),n},clearData(){ae(this.$key.STORAGE_KEY);}},Rt=`.f_c,\r
.f_c a,\r
.ntc_body {\r
...
`,Lt=()=>({"[呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq001.gif","[撇嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq002.gif","[色]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq003.gif","[发呆]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq004.gif","[得意]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq005.gif","[流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq006.gif","[害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq007.gif","[闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq008.gif","[睡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq009.gif","[大哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq010.gif","[尴尬]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq011.gif","[发怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq012.gif","[调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq013.gif","[呲牙]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq014.gif","[惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq015.gif","[难过]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq016.gif","[酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq017.gif","[冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq018.gif","[抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq019.gif","[吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq020.gif","[偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq021.gif","[可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq022.gif","[白眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq023.gif","[傲慢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq024.gif","[饥饿]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq025.gif","[困]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq026.gif","[惊恐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq027.gif","[流汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq028.gif","[憨笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq029.gif","[装逼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq030.gif","[奋斗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq031.gif","[咒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq032.gif","[疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq033.gif","[嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq034.gif","[晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq035.gif","[折磨]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq036.gif","[衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq037.gif","[骷髅]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq038.gif","[敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq039.gif","[再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq040.gif","[擦汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq041.gif","[抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq042.gif","[鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq043.gif","[糗大了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq044.gif","[坏笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq045.gif","[左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq046.gif","[右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq047.gif","[哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq048.gif","[鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq049.gif","[委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq050.gif","[快哭了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq051.gif","[阴脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq052.gif","[亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq053.gif","[吓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq054.gif","[可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq055.gif","[眨眼睛]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq056.gif","[笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq057.gif","[dogeQQ]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq058.gif","[泪奔]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq059.gif","[无奈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq060.gif","[托腮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq061.gif","[卖萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq062.png","[斜眼笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq063.gif","[喷血]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq064.gif","[惊喜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq065.gif","[骚扰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq066.gif","[小纠结]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq067.gif","[我最美]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq068.gif","[菜刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq069.gif","[西瓜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq070.gif","[啤酒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq071.gif","[篮球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq072.gif","[乒乓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq073.gif","[咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq074.gif","[饭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq075.gif","[猪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq076.gif","[玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq077.gif","[凋谢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq078.gif","[示爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq079.gif","[爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq080.gif","[心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq081.gif","[蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq082.gif","[闪电]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq083.gif","[炸弹]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq084.gif","[刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq085.gif","[足球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq086.gif","[瓢虫]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq087.gif","[便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq088.gif","[月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq089.gif","[太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq090.gif","[礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq091.gif","[抱抱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq092.gif","[喝彩]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq93.gif","[祈祷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq94.gif","[棒棒糖]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq95.gif","[药]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq96.gif","[赞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq097.gif","[差劲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq098.gif","[握手]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq099.gif","[胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq100.gif","[抱拳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq101.gif","[勾引]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq102.gif","[拳头]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq103.gif","[爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq105.gif","[NO]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq106.gif","[OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq107.gif","[#呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_1.png","[#滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_10.png","[#吐舌]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_3.png","[#哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_2.png","[#啊]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_23.png","[#酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_22.png","[#怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_13.png","[#开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_39.png","[#汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_14.png","[#泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_16.png","[#黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_15.png","[#鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_21.png","[#不高兴]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_12.png","[#真棒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_17.png","[#钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_40.png","[#疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_26.png","[#阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_20.png","[#吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_34.png","[#咦]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_41.png","[#委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_29.png","[#花心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_6.png","[#呼～]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_42.png","[#激动]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_5.png","[#冷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_43.png","[#可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_4.png","[#What？]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_25.png","[#勉强]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_38.png","[#狂汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_24.png","[#酸爽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_27.png","[#乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_8.png","[#雅美蝶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_28.png","[#睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_31.png","[#惊哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_19.png","[#哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_44.png","[#笑尿]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_32.png","[#惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_30.png","[#小乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_7.png","[#喷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_18.png","[#抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_33.png","[#捂嘴笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_9.png","[#你懂的]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_11.png","[#犀利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_35.png","[#小红脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_36.png","[#懒得理]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_37.png","[#爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_45.png","[#心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_46.png","[#玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_47.png","[#礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_48.png","[#彩虹]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_49.png","[#太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_50.png","[#月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_51.png","[#钱币]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_52.png","[#咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_53.png","[#蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_54.png","[#大拇指]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_55.png","[#胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_56.png","[#爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_57.png","[#OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_58.png","[#弱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_59.png","[#沙发]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_60.png","[#纸巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_61.png","[#香蕉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_62.png","[#便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_63.png","[#药丸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_64.png","[#红领巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_65.png","[#蜡烛]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_66.png","[#三道杠]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_67.png","[#音乐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_68.png","[#灯泡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_69.png","[doge]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/1.png","[doge思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/2.png","[doge再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/3.png","[doge生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/4.png","[doge气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/5.png","[doge笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/7.png","[doge调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/6.png","[doge啊哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/8.png","[doge原谅TA]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/9.png","[miao]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/10.png","[miao思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/11.png","[miao拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/12.png","[miao生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/13.png","[miao气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/14.png","[二哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/15.png","[摊手]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/19.png","[w并不简单]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/20.png","[w滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/21.png","[w色]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/22.png","[w爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/23.png","[w拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/24.png","[w悲伤]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/25.png","[w鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/26.png","[w馋嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/27.png","[w冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/28.png","[w打哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/29.png","[w打脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/30.png","[w敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/31.png","[w生病]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/32.png","[w闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/33.png","[w鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/34.png","[w哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/35.png","[w害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/36.png","[w呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/37.png","[w黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/38.png","[w哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/39.png","[w调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/40.png","[w可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/41.png","[w可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/42.png","[w酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/43.png","[w困]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/44.png","[w懒得理你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/45.png","[w流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/46.png","[w怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/47.png","[w怒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/48.png","[w钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/49.png","[w亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/50.png","[w傻眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/51.png","[w便秘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/52.png","[w失望]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/53.png","[w衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/54.png","[w睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/55.png","[w思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/56.png","[w开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/57.png","[w色舔]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/58.png","[w偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/59.png","[w吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/60.png","[w抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/61.png","[w委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/62.png","[w笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/63.png","[w嘻嘻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/64.png","[w嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/65.png","[w阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/66.png","[w疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/67.png","[w抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/70.png","[w晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/69.png","[w右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/68.png","[w左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/71.png","[w肥皂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/77.png","[w奥特曼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/78.png","[w草泥马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/79.png","[w兔子]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/80.png","[w熊猫]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/81.png","[w猪头]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/82.png","[w→_→]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/83.png","[w给力]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/84.png","[w囧]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/85.png","[w萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/86.png","[w神马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/87.png","[w威武]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/88.png"}),Ie={parseText(e){const t=Lt();let i=e.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/g);i&&i.forEach(w=>{let b=w.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/),v=b?b[b.length-1]:"",M=s.attr(`#aimg_${v}`,"title"),P=s.attr(`#aimg_${v}`,"src");P||(M="该图片不存在"),e=e.replace(w,`<span class="comiis_postimg vm"><img loading="lazy" id="aimg_${v}" src="${P}" alt="${M}" title="${M}"></span>`);});let n=e.match(/\[code\]([\s\S]*?)\[\/code\]/g);n&&n.forEach(w=>{let b=w.match(/\[code\]([\s\S]*?)\[\/code\]/),v=b?b[b.length-1]:"",M="",P=v.split(`
`);P.length==1?M=`<li>${v}</li>`:Array.from(P).forEach((W,J)=>{J==P.length-1?M=`${M}<li>${W}</li>`:M=`${M}<li>${W}<br></li>`;}),e=e.replace(w,`
                <div class="comiis_blockcode comiis_bodybg b_ok f_b"><div class="bg_f b_l"><ol>${M}</ol></div></div>`);});let a=e.match(/\[url\=[\s\S]*?\]([\s\S]*?)\[\/url\]/g);a&&a.forEach(w=>{let b=w.match(/\[url=([\s\S]*?)\][\s\S]*\[\/url\]/),v=w.match(/\[url=[\s\S]*?\]([\s\S]*?)\[\/url\]/),M=b?b[b.length-1]:"",P=v?v[v.length-1]:"";e=e.replace(w,`<a href="${M}" target="_blank">${P}</a>`);});let o=e.match(/\[color\=[\s\S]*?\]([\s\S]*?)\[\/color\]/g);o&&o.forEach(w=>{let b=w.match(/\[color=([\s\S]*?)\][\s\S]*\[\/color\]/),v=w.match(/\[color=[\s\S]*?\]([\s\S]*?)\[\/color\]/),M=b?b[b.length-1]:"",P=v?v[v.length-1]:"";e=e.replace(w,`<font color="${M}">${P}</font>`);});let r=e.match(/\[size\=[\s\S]*?\]([\s\S]*?)\[\/size\]/g);r&&r.forEach(w=>{let b=w.match(/\[size=([\s\S]*?)\][\s\S]*\[\/size\]/),v=w.match(/\[size=[\s\S]*?\]([\s\S]*?)\[\/size\]/),M=b?b[b.length-1]:"",P=v?v[v.length-1]:"";e=e.replace(w,`<font size="${M}">${P}</font>`);});let l=e.match(/\[img(|\=[\s\S]+?)\]([\s\S]*?)\[\/img\]/g);l&&l.forEach(w=>{let b=null,v=null,M=w.match(/\[img\=([\s\S]+?)\][\s\S]*?\[\/img\]/);M&&(M=M[M.length-1].split(","),b=M[0],v=M[1]),b=b||"",v=v||"";let P=w.match(/\[img\]([\s\S]*?)\[\/img\]|\[img=[\s\S]*?\]([\s\S]*?)\[\/img\]/),W="";P&&(P[P.length-1]==null?W=P[P.length-2]:W=P[P.length-1]),e=e.replace(w,`<img loading="lazy" src="${W}" border="0" alt="" width="${b}" height="${v}" crossoriginNew="anonymous">`);});let c=e.match(/\[hide\]([\s\S]*?)\[\/hide\]/g);c&&c.forEach(w=>{let b=w.match(/\[hide\]([\s\S]*?)\[\/hide\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c"><h2 class="f_a">本帖隐藏的内容: </h2>${v}</div>`);});let m=e.match(/\[hide=[\s\S]*?\]([\s\S]*?)\[\/hide\]/g);m&&m.forEach(w=>{let b=w.match(/\[hide=([\s\S]*?)\]([\s\S]*?)\[\/hide\]/),v=b?b[b.length-2]:"";v=v.split(",");let M=v.length==2?v[1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c">以下内容需要积分高于 ${M} 才可浏览</div>`);});let d=e.match(/\[quote\]([\s\S]*?)\[\/quote\]/g);d&&d.forEach(w=>{let b=w.match(/\[quote\]([\s\S]*?)\[\/quote\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h b_dashed f_c"><blockquote><font>回复</font> ${v}</blockquote></div>`);});let u=e.match(/\[free\]([\s\S]*?)\[\/free\]/g);u&&u.forEach(w=>{let b=w.match(/\[free\]([\s\S]*?)\[\/free\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<div class="comiis_quote bg_h f_c"><blockquote>${v}</blockquote></div>`);});let p=e.match(/\[b\]([\s\S]*?)\[\/b\]/g);p&&p.forEach(w=>{let b=w.match(/\[b\]([\s\S]*?)\[\/b\]/i),v=b?b[b.length-1]:"";e=e.replace(w,`<strong>${v}</strong>`);});let g=e.match(/\[u\]([\s\S]*?)\[\/u\]/g);g&&g.forEach(w=>{let b=w.match(/\[u\]([\s\S]*?)\[\/u\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<u>${v}</u>`);});let y=e.match(/\[i\]([\s\S]*?)\[\/i\]/g);y&&y.forEach(w=>{let b=w.match(/\[i\]([\s\S]*?)\[\/i\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<i>${v}</i>`);});let q=e.match(/\[s\]([\s\S]*?)\[\/s\]/g);q&&q.forEach(w=>{let b=w.match(/\[s\]([\s\S]*?)\[\/s\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<strike>${v}</strike>`);});let $=e.match(/\[([\s\S]+?)\]/g);$&&$.forEach(w=>{let b=t[w];b&&(e=e.replace(w,`<img loading="lazy" src="${b}" border="0" alt="" smilieid="">`));});let k=e.match(/\[media=[\s\S]+?\][\s\S]+?\[\/media\]/g);k&&k.forEach(w=>{let b=w.match(/\[media=[\s\S]*?\]([\s\S]*?)\[\/media\]/),v=b?b[b.length-1]:"";v&&(e=e.replace(w,`<ignore_js_op><span><iframe src="${v}" border="0" scrolling="no" framespacing="0" allowfullscreen="true" style="max-width: 100%" width="100%" height="auto" frameborder="no"></iframe></span></ignore_js_op>`));});let T=e.match(/\[email=[\s\S]+?\][\s\S]+?\[\/email\]/g);T&&T.forEach(w=>{let b=w.match(/\[email=([\s\S]*?)\][\s\S]*?\[\/email\]/),v=w.match(/\[email=[\s\S]*?\]([\s\S]*?)\[\/email\]/),M=b.length?b[b.length-1]:"",P=v.length?v[v.length-1]:"";(M||P)&&(e=e.replace(w,`<a href="mailto:${M}">${P}</a>`));});let R=e.match(/\[align=[\s\S]+?\][\s\S]+?\[\/align\]/g);R&&R.forEach(w=>{let b=w.match(/\[align=([\s\S]*?)\][\s\S]+?\[\/align\]/),v=w.match(/\[align=[\s\S]*?\]([\s\S]+?)\[\/align\]/),M=b.length?b[b.length-1]:"",P=v.length?v[v.length-1]:"";(M||P)&&(e=e.replace(w,`<div align="${M}">${P}</div>`));});let I=e.match(/\[qq\][\s\S]*?\[\/qq\]/g);I&&I.forEach(w=>{let b=w.match(/\[qq\]([\s\S]*?)\[\/qq\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<a href="http://wpa.qq.com/msgrd?v=3&uin=${v}&site=[Discuz!]&from=discuz&menu=yes" target="_blank"><img loading="lazy" src="static/image/common/qq_big.gif" border="0"></a>`);});let E=e.match(/\[td\][\s\S]+?\[\/td\]/g);E&&E.forEach(w=>{let b=w.match(/\[td\]([\s\S]*?)\[\/td\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<td>${v}</td>`);});let A=e.match(/\[tr\][\s\S]+?\[\/tr\]/g);A&&A.forEach(w=>{let b=w.match(/\[tr\]([\s\S]*?)\[\/tr\]/),v=b?b[b.length-1]:"";e=e.replace(w,`<tr>${v}</tr>`);});let N=e.match(/\[table\][\s\S]+?\[\/table\]/g);N&&N.forEach(w=>{let b=w.match(/\[table\]([\s\S]*?)\[\/table\]/),v=b?b[b.length-1]:"";v=v.replace(/\n/g,""),e=e.replace(w,`<table>${v}</table>`);});let z=e.match(/\[list=[\s\S]+?\][\s\S]+?\[\/list\]/g);return z&&z.forEach(w=>{let b=w.match(/\[list=([\s\S]*?)\][\s\S]*?\[\/list\]/),v=w.match(/\[list=[\s\S]*?\]([\s\S]*?)\[\/list\]/),M=b?b[b.length-1]:"",P="";M==="a"?P="litype_2":M==="A"?P="litype_3":M.length===1&&M.match(/[0-9]{1}/)&&(P="litype_1");let W=v?v[v.length-1]:"",J=W.split("[*]");if(J.length>1){let ue="";J[0].replace(/[\s]*/,"")==""&&(J=J.slice(1)),Array.from(J).forEach(Q=>{ue=`${ue}<li>${Q}</li>`;}),W=ue;}W=W.replace(/\n/g,""),e=e.replace(w,`<ul type="${M}" class="${P}">${W}</ul>`);}),e},parseVoteText(){let e=["rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)","rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)"],t=F(".comiis_polloption_add ul li:first-child div.flex .comiis_input.kmshow[type='text']"),i=parseInt(s.val("input#maxchoices"));i=isNaN(i)?0:i,i=i>0?i:0,i=i>t.length?t.length:i;let n=parseInt(s.val("input#polldatas"));n=isNaN(n)?0:n,x.$("input#visibilitypoll").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close");let a=!x.$("input#overt").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close"),o="",r="";t.forEach((l,c)=>{c>=20||(r=r+`
                    <li class="kmnop">
        ...
        `);let t=C("#select-post-section"),i=O.getForumId(window.location.href);L.isPostPublish_newthread()?(h.info("发帖"),s.on(t,"change",function(){let n=s.val(t),a=`forum.php?mod=post&action=newthread&fid=${n}&extra=&topicsubmit=yes&mobile=2`;h.info(`修改发帖板块: ${e[n]} ${a}`);let o={求助问答:{className:"gm_user_select_help",optionHTML:`<option value="0" selected="selected">请选择</option>
                        ...
                        `)):Object.keys(o).forEach(l=>{s.remove(".comiis_post_from ."+o[l].className);}),s.attr("#postform","action",a);})):s.attr(t,"disabled",true),s.val(t,i),s.emit(t,"change");},initCharacterCount(){h.info("添加功能：字符计数"),K(`
        ...
        `);let e=Ke(),t=C(".comiis_post_urlico > ul"),i=C("#comiis_post_qydiv > ul"),n=F("#comiis_post_qydiv ul li").length;yt(),s.on("#comiis_post_tab .comiis_input_style .comiis_post_urlico li","click",function(){s.removeClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_0"),s.addClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_d"),s.attr(this.querySelector("a"),"class","comiis_xifont f_0"),x.$("#comiis_post_qydiv ul li").hide().eq(x.$(this).index()).fadeIn();}),x.$.each(e,function(a,o){let r=s.createElement("li",{className:"quickUBBs",innerHTML:`
                ...
                `});s.on(r,"click",c=>{if(!C(`#comiis_post_qydiv li[data-key='${o.key}']`)){h.error("未找到该元素");return}F("#comiis_post_tab div.comiis_post_urlico ul li a.comiis_xifont").forEach(p=>{p.className="comiis_xifont f_d";});let d=r.querySelector("a");d.className="comiis_xifont f_0";let u=n+Object.keys(e).indexOf(a);x.$("#comiis_post_qydiv ul li").hide().eq(u).fadeIn();}),s.append(t,r);let l=document.createElement("li");l.setAttribute("style","display: none;"),l.setAttribute("data-key",o.key),l.innerHTML=`
        ...
        <a href="javascript:;" class="comiis_pictitle"><i class="comiis_font"><em>图片</em></i></a>`),s.on(".comiis_pictitle","click",function(){this.querySelector("i.comiis_font").classList.contains("f_0")?s.hide(".gm_plugin_chartbed",false):s.show(".gm_plugin_chartbed",false);}),s.append("#comiis_post_tab",`
            ...
            `);let t=C("#imglist"),i=s.parent(t);s.before(".gm_plugin_chartbed .bqbox_t",i),s.on("#imglist .comiis_font","click",n=>{C("#filedata").click();}),s.on("#comiis_pictitle_tab #comiis_pictitle_key","click","li",function(n){let a=n.target;s.removeClass("#comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),s.addClass(a,"bg_f"),x.$("#comiis_pictitle_tab div.comiis_upbox").hide().eq(x.$(a).index()).fadeIn();}),S.execMenuOnce("mt-image-bed-hello-enable",()=>{Ge.init();}),S.execMenuOnce("mt-image-bed-mt-enable",()=>{We.init();});},initPreview(){const e=this;h.info("添加功能：双列预览"),K(`
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
            ...
            `),s.on("#immersiveinput","click",function(){let e=this,t=s.parent(e).querySelector(".comiis_checkbox"),i=[".comiis_wzpost ul li.comiis_flex",".comiis_wzpost ul li.comiis_styli.kmquote",s.parent(s.parent("#pollchecked")),"#pollm_c_1",".comiis_polloption_add+div.f_0",".comiis_wzpost ul li.comiis_thread_content:contains('内容')","div#comiis_head","div#comiis_head+*:not([class])"];s.hasClass(t,"comiis_checkbox_close")?i.forEach(n=>{n&&s.hide(n,false);}):i.forEach(n=>{n&&s.show(n,false);}),window.dispatchEvent(new Event("resize"));});}},At={init(){s.onReady(()=>{S.execMenuOnce("mt-forum-post-publish-editorOptimization",()=>{$e.init();});});}},Mt={$flag:{showUserUID_initCSS:false},init(){(L.isPage()||L.isGuide()||L.isPlate()||L.isPost()||L.isSearch()||L.isSpace())&&S.execMenuOnce("mt-show-user-uid",()=>{this.showUserUID();}),(L.isSearch()||L.isGuide()||L.isSpace()||L.isPlate())&&S.execMenuOnce("mt-small-window",()=>{Je.init();}),L.isPost()?(h.info("Router: 帖子"),Ze.init()):L.isSearch()?(h.info("Router: 搜索"),xt.init()):L.isKMiSign()?(h.info("Router: 签到"),vt.init()):L.isSpace()||L.isSpaceWithAt()?(h.info("Router: 空间"),qt.init()):L.isGuide()?(h.info("Router: 导读"),St.init()):L.isPostPublish()?(h.info("Router: 发帖页面"),At.init()):h.error("Router: 未适配的链接 ==> "+window.location.href),s.onReady(()=>{S.execMenuOnce("mt-black-home",()=>{ut.init();}),S.execMenuOnce("mt-online-user",()=>{gt.init();}),S.execMenuOnce("mt-post-paidThemePost",()=>{ge.init();}),S.execMenuOnce("mt-ownBlock",()=>{Ct.init();}),S.execMenuOnce("mt-post-comment-filter",()=>{Tt.init();}),S.execMenuOnce("mt-productListingReminder",()=>{It.init();}),S.execMenuOnce("mt-customizeUserLabels",()=>{Et.init();}),S.execMenu("mt-auto-sign",()=>{qe.init();}),S.execMenu("mt-extend-cookie-expire",()=>{this.extendCookieExpire();}),L.isPostPublish_edit()||S.execMenuOnce("mt-link-text-to-hyperlink",()=>{ft();});});},showUserUID(){h.info("显示用户UID"),this.$flag.showUserUID_initCSS||(this.$flag.showUserUID_initCSS=true,K(`
			.postli_top_tximg + h2{
 				height: auto;
			}
			...
			`));let e=new f.LockFunction(()=>{let t=f.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist());t.length&&t.forEach(i=>{if(i.querySelector(".gm-custom-label-uid"))return;let a=Array.from(i.querySelectorAll("a")).map(o=>{let l=o.href.match(ee.uid);if(l)return l[l.length-1]}).filter(o=>o!=null);if(a.length){let o=a[0],r=document.createElement("a"),l=i.querySelector(".top_lev");r.className=l.className,r.classList.add("gm-custom-label-uid"),r.style.cssText="background: #FF7600 !important;",r.innerHTML="UID:"+o,s.on(r,"click",async c=>{s.preventEvent(c),await f.copy(o)?_.success(`${o}已复制`):_.error(`${o}复制失败`);}),l.parentElement.append(r);}});});f.mutationObserver(document,{config:{subtree:true,childList:true},callback(){e.run();}});},async extendCookieExpire(){h.info("延长cookie有效期");let e=await De.cookie.list({}),t=["_auth","_saltkey","_client_created","_client_token"];e.forEach(async i=>{if(i.session)return;let n=i.expirationDate,a=Date.now()/1e3;if(n<a)return;let o=3600*24*30;n-a>o||!t.find(l=>i.name.endsWith(l))||De.cookie.set({name:i.name,value:i.value,expirationDate:i.expirationDate+o}).then(()=>{h.info(`延长Cookie +30天成功：${i.name}`);}).catch(()=>{h.error(`延长Cookie +30天失败：${i.name}`);});});}},de={$upload:{small:false,middle:false,big:false},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return de.$el.$smallUpload.files[0]},get middle(){return de.$el.$middleUpload.files[0]},get big(){return de.$el.$bigUpload.files[0]}},showView(){const e=this;let t=U.confirm({title:{text:"修改头像",position:"center"},content:{text:`
                ...
                `,html:true},btn:{ok:{text:"上传",callback:async()=>{if(!e.$upload.small){_.error("请上传小头像");return}if(!e.$upload.middle){_.error("请上传中头像");return}if(!e.$upload.big){_.error("请上传大头像");return}let i=_.loading("正在处理数据中...");try{let n=await this.getUploadUrl();if(n==null)return;let a=await O.getFormHash();if(a==null){_.error("获取formhash失败");return}let o={big:{base64:await f.parseFileToBase64(this.$avatar.big)},middle:{base64:await f.parseFileToBase64(this.$avatar.middle)},small:{base64:await f.parseFileToBase64(this.$avatar.small)}};Object.keys(o).forEach(c=>{let m=o[c];m.base64=m.base64.substring(m.base64.indexOf(",")+1);});let r=new FormData;r.append("Filedata",this.$avatar.big||""),r.append("confirm","确定"),r.append("avatar1",o.big.base64),r.append("avatar2",o.middle.base64),r.append("avatar3",o.small.base64),r.append("formhash",a),h.info("头像的base64字符串",o);let l=await B.post(n,{data:r,processData:!1,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","User-Agent":f.getRandomPCUA(),Host:window.location.hostname,Origin:window.location.origin,Referer:`${window.location.origin}/home.php?mod=spacecp&ac=avatar`}});if(!l.status)return;l.data.responseText.indexOf("window.parent.postMessage('success','*')")!=-1?(t.close(),_.success("上传成功")):(h.error("上传失败",l),_.error(l.data.responseText,{timeout:6e3,isHTML:!1}));}catch(n){h.error(n);}finally{i.close();}}}},width:"88vw",height:"500px",style:`
            .avatar-container{
                display: flex;
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,i,n){s.on(e,"change",a=>{if(!e.files?.length)return;s.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let o=e.files[0],r=o.size,l=new Image,c=new FileReader;c.readAsDataURL(o),c.onload=function(m){l.src=m.target.result,l.onload=function(){if(l.width>i.width||l.height>i.height){e.value="",t.setAttribute("data-success","false"),s.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${l.width} 高：${l.height}`);return}if(r>de.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),s.text(t,`🤡校验失败 ==> 图片大小不符合：${r}byte，限制最大：${de.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),s.text(t,`🤣 通过 宽:${l.width} 高:${l.height} 大小(byte):${r}`),n();};};});},async getUploadUrl(){let e=await B.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":f.getRandomPCUA()}});if(!e.status)return;if(f.isNull(e.data.responseText)){_.error("动态头像：获取上传地址失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){_.error("动态头像：获取变量data失败");return}let n=t[t.length-1].split(","),a=n.indexOf("stl_src");if(a===-1&&(a=n.indexOf("src")),a===-1){_.error("动态头像：获取上传地址失败");return}let o=n[a+1],r=new URL(o);return r.pathname=r.pathname.replace("/images/camera.swf","/index.php"),r.searchParams.delete("inajax"),r.searchParams.set("m","user"),r.searchParams.set("a","rectavatar"),r.searchParams.set("base64","yes"),o=r.toString(),h.info("上传地址："+o),o}},Dt={id:"component-common",title:"通用",views:[{text:"",type:"container",views:[{text:"Toast配置",type:"deepMenu",views:[{text:"",type:"container",views:[Be("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],e=>{h.info("设置当前Qmsg弹出位置"+e.text);},"Toast显示在页面九宫格的位置"),Be("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),D("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",views:[{text:"",type:"container",views:[D("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),D("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie"),_e("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"container",views:[{text:"功能",type:"deepMenu",views:[{text:"",type:"container",views:[D("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),D("显示用户UID","mt-show-user-uid",true,void 0,"格式为UID：xxx"),D("小窗模式","mt-small-window",true,void 0,"开启后点击帖子右侧区域为小窗打开"),D("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{text:"额外菜单项",type:"deepMenu",views:[{type:"container",text:"",views:[D("小黑屋","mt-black-home",true,void 0,"将会在左侧面板添加【小黑屋】菜单"),D("在线用户","mt-online-user",true,void 0,"将会在左侧面板添加【在线用户】菜单"),D("付费主题白嫖提醒","mt-post-paidThemePost",true,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),D("我的屏蔽","mt-ownBlock",true,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),D("商品上架提醒","mt-productListingReminder",true,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),D("自定义用户标签","mt-customizeUserLabels",true,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),D("评论过滤器","mt-post-comment-filter",true,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",views:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"container",views:[Ne(e=>{const t=s.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return i.querySelector(".avatar-img[data-size='small']"),i.querySelector(".avatar-img[data-size='middle']"),i.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(i),e.appendChild(n),e},void 0,{text:"头像（有缓存）",desc:"小、中、大"}),Ne(e=>{const t=s.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`

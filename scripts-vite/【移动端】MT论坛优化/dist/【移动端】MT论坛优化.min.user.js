...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof kt=="function"?kt(t.keyName):"";typeof e=="string"&&e?G(e):vt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,r.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()}},ee="【移动端】MT论坛优化",g=st.noConflict(),r=Z.noConflict(),B=bt,f=new g.Log(ht,y.console||Xt.console);var Rt;const St=((Rt=ht==null?void 0:ht.script)==null?void 0:Rt.name)||ee,Dt=false;f.config({debug:Dt,logMaxCount:1e3,autoClearConsole:true,tag:true});x.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return $.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return $.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return $.getValue("qmsg-config-showreverse",true)}},zIndex:{get(){let t=st.getMaxZIndex(),e=bt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return st.getMaxValue(t,e)+100}}}));const ie=new g.GM_Menu({GM_getValue:Y,GM_setValue:W,GM_registerMenuCommand:Qt,GM_unregisterMenuCommand:Jt}),H=new g.Httpx(Zt);H.interceptors.request.use(t=>(te.handle(t),t));H.interceptors.response.use(void 0,t=>(f.error("拦截器-请求错误",t),t.type==="onabort"?x.warning("请求取消"):t.type==="onerror"?x.error("请求异常"):t.type==="ontimeout"?x.error("请求超时"):x.error("其它错误"),t));H.config({logDetails:Dt});bt.GlobalConfig.setGlobalConfig({mask:{enable:true,clickEvent:{toClose:false,toHide:false}}});y.Object.defineProperty,y.Function.prototype.apply,y.Function.prototype.call,y.Element.prototype.appendChild,y.setTimeout;const G=g.addStyle.bind(g);vt.setGMResourceCSS(Lt.Viewer);vt.setGMResourceCSS(Lt.Hljs);const C=document.querySelector.bind(document),N=document.querySelectorAll.bind(document),rt="GM_Panel",zt="data-init",et="data-key",it="data-default-value",ne="data-init-more-value",D="data-storage-api",L=function(t,e,n,i,s,l){let o={text:t,type:"switch",description:s,attributes:{},props:{},getValue(){return !!this.props[D].get(e,n)},callback(a,c){let m=!!c;f.success(`${m?"开启":"关闭"} ${t}`),this.props[D].set(e,m);},afterAddToUListCallBack:l};return Reflect.set(o.attributes,et,e),Reflect.set(o.attributes,it,n),Reflect.set(o.props,D,{get(a,c){return $.getValue(a,c)},set(a,c){$.setValue(a,c);}}),o},pt=function(t,e,n,i,s,l="",o){let a={text:t,type:"textarea",attributes:{},props:{},description:i,placeholder:l,disabled:o,getValue(){return this.props[D].get(e,n)},callback(c,m){this.props[D].set(e,m);}};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,n),Reflect.set(a.props,D,{get(c,m){return $.getValue(c,m)},set(c,m){$.setValue(c,m);}}),a},Tt=function(t,e,n,i,s,l){let o=[];typeof i=="function"?o=i():o=i;let a={text:t,type:"select",description:l,attributes:{},props:{},getValue(){return this.props[D].get(e,n)},callback(c,m,d){let u=m;f.info(`选择：${d}`),this.props[D].set(e,u),typeof s=="function"&&s(c,u,d);},data:o};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,n),Reflect.set(a.props,D,{get(c,m){return $.getValue(c,m)},set(c,m){$.setValue(c,m);}}),a},ft=function(t,e,n,i,s,l,o,a,c){return {text:t,type:"button",description:e,buttonIcon:i,buttonIsRightIcon:s,buttonIconIsLoading:l,buttonType:o,buttonText:n,callback(d){typeof a=="function"&&a(d);},afterAddToUListCallBack:c}},Ct=function(t,e,n,i){let s={type:"own",attributes:{},props:n,getLiElementCallBack:t,afterAddToUListCallBack:i};return Reflect.set(s.attributes,zt,()=>false),s},X={formhash:/formhash=([0-9a-zA-Z]+)/,uid:/uid(=|-)(\d+)/,fontSpecial:/<font.*?>|<\/font>|<strike>|<strong>|<i>|<u>|align=".*?"|<br>[\s]*<br>[\s]*<br>/g,ptid:/&ptid=([\d]+)/i,pid:/&pid=([\d]+)/i,tid:/&tid=([\d]+)/i},F={getAvatar:(t,e="middle")=>`/uc_server/avatar.php?uid=${t}&size=${e}&ts=1`,getCurrentUID(){let t=y.discuz_uid;if(typeof t=="string")return t;let e=document.querySelector('.sidenv_exit a[href*="uid="]');if(e){let n=e.href.match(/uid=([0-9]+)/);if(n)return n[n.length-1]}},getFormHash(){let t=Array.from((top||globalThis).document.querySelectorAll("input[name=formhash]"));for(let n=0;n<t.length;n++){let s=t[n].value;if(s)return s}let e=Array.from((top||globalThis).document.querySelectorAll('a[href*="formhash="]'));for(let n=0;n<e.length;n++){let s=e[n].href.match(X.formhash);if(s){let l=s[s.length-1];if(l)return l}}},envIsMobile(){return (y.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:t=>{let e=t.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(e){let n=e.filter(Boolean);return n[n.length-1]}},getForumId(t){let e=t.match(/&fid=([\d]+)/i);if(e)return e[e.length-1]},getPostId(t){let e=t.match(/&pid=([\d]+)/i);if(e)return e[e.length-1]},getRepquote(t){let e=t.match(/&repquote=([\d]+)/i);if(e)return e[e.length-1]}},lt={$upload:{small:false,middle:false,big:false},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return lt.$el.$smallUpload.files[0]},get middle(){return lt.$el.$middleUpload.files[0]},get big(){return lt.$el.$bigUpload.files[0]}},showView(){const t=this;let e=B.confirm({title:{text:"修改头像",position:"center"},content:{text:`
            ...
            `});this.$el.$smallUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(t,e,n,i){r.on(t,"change",s=>{var m;if(!((m=t.files)!=null&&m.length))return;r.text(e,"🤡获取文件信息中..."),e.removeAttribute("data-success");let l=t.files[0],o=l.size,a=new Image,c=new FileReader;c.readAsDataURL(l),c.onload=function(d){a.src=d.target.result,a.onload=function(){if(a.width>n.width||a.height>n.height){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片尺寸不符合，宽：${a.width} 高：${a.height}`);return}if(o>lt.$data.avatarInfo.maxSize){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片大小不符合：${o}byte，限制最大：${lt.$data.avatarInfo.maxSize}byte`);return}e.setAttribute("data-success","true"),r.text(e,`🤣 通过 宽:${a.width} 高:${a.height} 大小(byte):${o}`),i();};};});},async getUploadUrl(){let t=await H.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":g.getRandomPCUA()}});if(!t.status)return;if(g.isNull(t.data.responseText)){x.error("动态头像：获取上传地址失败");return}let e=t.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(e==null||e.length!=2){x.error("动态头像：获取变量data失败");return}let i=e[e.length-1].split(","),s=i[i.indexOf("src")+1].replace("images/camera.swf?inajax=1","index.php?m=user&a=rectavatar&base64=yes");return f.info("上传地址："+s),s}},se={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[Tt("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,n)=>{f.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),Tt("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),L("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[L("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),L("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie"),pt("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[L("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),L("显示用户UID","mt-show-user-uid",true,void 0,"格式为UID：xxx"),L("小窗模式","mt-small-window",true,void 0,"开启后点击帖子右侧区域为小窗打开"),L("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{text:"额外菜单项",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("小黑屋","mt-black-home",true,void 0,"将会在左侧面板添加【小黑屋】菜单"),L("在线用户","mt-online-user",true,void 0,"将会在左侧面板添加【在线用户】菜单"),L("付费主题白嫖提醒","mt-post-paidThemePost",true,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),L("我的屏蔽","mt-ownBlock",true,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),L("商品上架提醒","mt-productListingReminder",true,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),L("自定义用户标签","mt-customizeUserLabels",true,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),L("评论过滤器","mt-post-comment-filter",true,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",forms:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"forms",forms:[Ct(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return n.querySelector(".avatar-img[data-size='small']"),n.querySelector(".avatar-img[data-size='middle']"),n.querySelector(".avatar-img[data-size='big']"),t.appendChild(e),t.appendChild(n),t.appendChild(i),t}),Ct(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
...
`);U.length==1?P=`<li>${T}</li>`:Array.from(U).forEach((J,ot)=>{ot==U.length-1?P=`${P}<li>${J}</li>`:P=`${P}<li>${J}<br></li>`;}),t=t.replace(v,`
        ...
        `);let e=C("#select-post-section"),n=F.getForumId(window.location.href);M.isPostPublish_newthread()?(f.info("发帖"),r.on(e,"change",function(){let i=r.val(e),s=`forum.php?mod=post&action=newthread&fid=${i}&extra=&topicsubmit=yes&mobile=2`;f.info(`修改发帖板块: ${t[i]} ${s}`);let l={求助问答:{className:"gm_user_select_help",optionHTML:`<option value="0" selected="selected">请选择</option>
                        ...
                        `)):Object.keys(l).forEach(a=>{r.remove(".comiis_post_from ."+l[a].className);}),r.attr("#postform","action",s);})):r.attr(e,"disabled",true),r.val(e,n),r.trigger(e,"change");},initCharacterCount(){f.info("添加功能：字符计数"),G(`
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
            ...
            `),r.on("#immersiveinput","click",function(){let t=this,e=r.parent(t).querySelector(".comiis_checkbox"),n=[".comiis_wzpost ul li.comiis_flex",".comiis_wzpost ul li.comiis_styli.kmquote",r.parent(r.parent("#pollchecked")),"#pollm_c_1",".comiis_polloption_add+div.f_0",".comiis_wzpost ul li.comiis_thread_content:contains('内容')","div#comiis_head","div#comiis_head+*:not([class])"];r.hasClass(e,"comiis_checkbox_close")?n.forEach(i=>{i&&r.hide(i,false);}):n.forEach(i=>{i&&r.show(i,false);}),window.dispatchEvent(new Event("resize"));});}},me={id:"component-forum-post",title:"帖子",forms:[{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[L("自动展开内容","mt-forum-post-autoExpandContent",true,void 0,"注入CSS展开帖子的内容"),L("修复图片宽度","mt-forum-post-repairImageWidth",true,void 0,"修复图片宽度超出页面宽度的问题"),L("移除帖子字体效果","mt-forum-post-removeFontStyle",false,void 0,""),L("移除评论区的字体效果","mt-forum-post-removeCommentFontStyle",false,void 0,""),L("添加【点评】按钮","mt-forum-post-addCommentOnBtn",false,void 0,"在评论区的每个评论右下角添加按钮"),L("附件点击提醒","mt-forum-post-setAttachmentsClickTip",true,void 0,"阻止默认点击附件就会触发附件下载"),L("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮"),L("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片")]}]},{text:"自动加载评论",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("自动加载下一页评论","mt-forum-post-loadNextPageComment",true,void 0,""),L("同步加载的地址","mt-forum-post-syncNextPageUrl",false,void 0,"便于刷新页面会停留在当前查看的评论页面")]}]},{text:"编辑器-简略版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("启用","mt-forum-post-editorOptimizationNormal",true,void 0,"优化样式，插入bbcode代码等"),L("自动保存输入记录","mt-forum-post-editorOptimizationNormal-recordInputText",true,void 0,"当回复时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async t=>{let i=t.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await tt.clearAllReplyRecord();s.success?(x.success("清理成功"),r.text(i,`当前占用空间大小：${await tt.getReplyRecordSize()}`)):x.error("清理失败 "+s.msg);},async(t,e)=>{let n=e.target.querySelector(".pops-panel-item-left-desc-text");r.text(n,`当前占用空间大小：${await tt.getReplyRecordSize()}`);})]}]},{text:"编辑器-完整版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("启用","mt-forum-post-publish-editorOptimization",true,void 0,"优化样式，插入bbcode代码，双列预览等"),L("自动保存输入记录","mt-forum-post-editorOptimization-recordInputText",true,void 0,"当回复/发表时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async t=>{let i=t.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await gt.clearAllReplyRecord();s.success?(x.success("清理成功"),r.text(i,`当前占用空间大小：${await gt.getReplyRecordSize()}`)):x.error("清理失败 "+s.msg);},async(t,e)=>{let n=e.target.querySelector(".pops-panel-item-left-desc-text");r.text(n,`当前占用空间大小：${await gt.getReplyRecordSize()}`);})]}]},{text:"编辑器-图床配置",type:"deepMenu",forms:[{type:"forms",text:'<a href="https://www.helloimg.com/" target="_blank">Hello图床</a>',forms:[L("启用","mt-image-bed-hello-enable",false,void 0,"启用Hello图床"),V("账号","mt-image-bed-hello-account","","",void 0,"必填"),V("密码","mt-image-bed-hello-password","","",void 0,"必填",false,true),V("token","mt-image-bed-hello-token","","",void 0,"必填",false,true)]},{type:"forms",text:'<a href="https://img.binmt.cc/" target="_blank">MT图床</a>',forms:[L("启用","mt-image-bed-mt-enable",true,void 0,"启用MT图床")]},{type:"forms",text:"图片水印",forms:[L("启用","mt-image-bed-watermark-enable",false,void 0,"开启后会为图床图片添加文字水印"),L("自动添加水印","mt-image-bed-watermark-autoAddWaterMark",false,void 0,"开启后会自动添加水印，关闭后会有添加水印后的图片预览"),V("水印文字","mt-image-bed-watermark-text","MT论坛"),V("颜色","mt-image-bed-watermark-text-color","#000000",void 0,void 0,"",false,false,(t,e)=>{var s,l;let n=(s=e.target)==null?void 0:s.querySelector("input"),i=(l=e.target)==null?void 0:l.querySelector(".pops-panel-input__suffix");r.hide(i,false),n.setAttribute("type","color"),r.css(n,{margin:"unset",padding:"unset",width:"80px"});}),V("大小","mt-image-bed-watermark-font-size",16,void 0,void 0,void 0,true),V("透明度","mt-image-bed-watermark-font-opacity",1,void 0,void 0,void 0,true),V("左右间距","mt-image-bed-watermark-left-right-margin",80,void 0,void 0,void 0,true),V("上下间距","mt-image-bed-watermark-top-bottom-margin",80,void 0,void 0,void 0,true),V("旋转角度","mt-image-bed-watermark-rotate",45,void 0,void 0,void 0,true)]}]}]}]},de={id:"component-search",title:"搜索",forms:[{type:"forms",text:"",forms:[L("显示搜索历史","mt-search-showSearchHistory",true,void 0,"自动记住搜索历史并显示"),L("修复清空按钮","mt-search-repairClearBtn",true,void 0,"修复点击清空按钮不清空输入框的问题"),L("搜索框自动获取焦点","mt-search-searchInputAutoFocus",true,void 0,"")]}]},mt={$key:{signTime:"mt-sign-time"},init(){this.sign();},todayIsSign(){let t=this.getSignTime();return !(t==null||g.formatTime(Date.now(),"yyyyMMdd")!==g.formatTime(t,"yyyyMMdd"))},setSignTime(){W(this.$key.signTime,Date.now());},getSignTime(){return Y(this.$key.signTime)},clearSignTime(){at(this.$key.signTime);},checkLogin(){return F.envIsMobile()?C(".sidenv_exit a[href*='member.php?mod=logging&action=logout']"):C("#comiis_key")},async sign(){let t=F.getFormHash();if(t==null){if(C("#comiis_picshowbox")){f.info("当前为评论区的看图模式 ");return}f.error("自动签到：获取账号formhash失败"),at("mt_sign"),x.error({content:"自动签到：获取账号formhash失败"});return}if(this.todayIsSign()){f.info("今日已签到");return}let e={operation:"qiandao",format:"button",formhash:t,inajax:1,ajaxtarget:"midaben_sign"},n=!!$.getValue("mt-auto-sign-useFetch"),i=await H.get(`/k_misign-sign.html?${g.toSearchParamsStr(e)}`,{fetch:n,headers:{"User-Agent":g.getRandomPCUA()},allowInterceptConfig:false});if(!i.status){f.error("签到：网络异常，请求失败"),x.error("签到：网络异常，请求失败");return}this.setSignTime(),f.info("签到信息：",i);let s=i.data.responseText,l=g.parseCDATA(s),o=r.parseHTML(`<div>${l}</div>`,true,false),a=r.text(o);if(a.includes("需要先登录")){x.error("签到：请先登录账号",{timeout:3e3}),this.clearSignTime();return}else if(a.includes("请稍后再试")||a.includes("您已经被列入黑名单")||a.includes("绑定手机号后才可以签到")||a.includes("您所在用户组不允许使用")){x.error("签到："+a,{timeout:5e3});return}else if(a.includes("今日已签")||a.includes("今日已经签到")){x.info("签到："+a);return}else if(s.includes("您当前的访问请求当中含有非法字符，已经被系统拒绝")){x.error("签到: 您当前的访问请求当中含有非法字符，已经被系统拒绝",{timeout:6e3});return}else if(n&&"location"in g.toJSON(s)){x.success("签到: 签到成功");return}let c=o.querySelector(".con"),m=o.querySelector(".line");if(c&&m){let b=r.text(c).match(/([0-9]+)金币/),p=r.text(m).match(/([0-9]+)/),h=b[b.length-1],_=p[p.length-1];f.success(`金币${h}，排名${_}`),x.info(`
                ...
                </div>`,{timeout:4e3,isHTML:true});return}let u=bt.alert({title:{text:"未知签到内容",position:"center"},content:{text:"",html:false},width:"88vw",height:"300px"}).$shadowRoot.querySelector(".pops-alert-content");u.innerText=i.data.responseText;}},pe={id:"component-sigh",title:"签到",forms:[{text:"功能",type:"forms",forms:[L("显示【今日签到之星】","mt-sign-showTodaySignStar",true,void 0,"在签到按钮上面显示今日签到之星"),L("显示【今日最先】","mt-sign-showTodayRanking",true,void 0,"在签到排名上面新增【今日最先】")]},{text:"自动签到",type:"forms",forms:[L("启用","mt-auto-sign",true,void 0,"自动请求签到"),L("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),ft("签到信息",`上次签到时间：${mt.getSignTime()==null?"尚未签到":st.formatTime(mt.getSignTime())}`,"清空信息",void 0,void 0,void 0,"primary",t=>{let n=t.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");B.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:i=>{mt.clearSignTime(),x.success("删除成功"),r.text(n,`上次签到时间：${mt.getSignTime()==null?"尚未签到":st.formatTime(mt.getSignTime())}`),i.close();}}},mask:{enable:true},width:"88vw",height:"200px"});})]}]},ue={id:"component-space",title:"空间",forms:[{type:"forms",text:"",forms:[L("修复无法进入空间","mt-space-repairEnterSpace",true,void 0,"修复链接错误导致不能进入空间的问题"),L("显示帖子回复内容","mt-space-showCommentContent",true,void 0,"在帖子-回复下面显示具体评论的内容")]}]},he={id:"component-guide",title:"导读",forms:[{type:"forms",text:"",forms:[L("显示最新帖子","mt-guide-showLatestPost",true,void 0,"在最上面显示最新发布的帖子")]}]},Et={setting:{get width(){return window.innerWidth<550?"88vw":"550px"},get height(){return window.innerHeight<450?"70vh":"450px"}}},$={$data:{__data:null,__oneSuccessExecMenu:null,__onceExec:null,__listenData:null,get data(){return $.$data.__data==null&&($.$data.__data=new g.Dictionary),$.$data.__data},get oneSuccessExecMenu(){return $.$data.__oneSuccessExecMenu==null&&($.$data.__oneSuccessExecMenu=new g.Dictionary),$.$data.__oneSuccessExecMenu},get onceExec(){return $.$data.__onceExec==null&&($.$data.__onceExec=new g.Dictionary),$.$data.__onceExec},get scriptName(){return St},key:rt,attributeKeyName:et,attributeDefaultValueName:it},$listener:{get listenData(){return $.$data.__listenData==null&&($.$data.__listenData=new g.Dictionary),$.$data.__listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},isTopWindow(){return y.top===y.self},initExtensionsMenu(){this.isTopWindow()&&(ie.add([{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{this.showPanel();}}]),j.registerLeftMenu({name:"MT论坛脚本设置",icon:"",iconColor:"#ff0505",iconSize:"23px",callback:()=>{this.showPanel();}}));},initPanelDefaultValue(){let t=this;function e(s){if(!s.attributes)return;let l={},o=s.attributes[et];o!=null&&(l[o]=s.attributes[it]);let a=s.attributes[zt];if(typeof a=="function"){let d=a();if(typeof d=="boolean"&&!d)return}let c=s.attributes[ne];c&&typeof c=="object"&&Object.assign(l,c);let m=Object.keys(l);if(!m.length){f.warn(["请先配置键",s]);return}m.forEach(d=>{let u=l[d];t.$data.data.has(d)&&f.warn("请检查该key(已存在): "+d),t.$data.data.set(d,u);});}function n(s){for(let l=0;l<s.length;l++){let o=s[l];e(o);let a=o.forms;a&&Array.isArray(a)&&n(a);}}let i=this.getPanelContentConfig();for(let s=0;s<i.length;s++){let l=i[s];if(!l.forms)continue;let o=l.forms;o&&Array.isArray(o)&&n(o);}},setValue(t,e){let n=Y(rt,{}),i=n[t];n[t]=e,W(rt,n),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,i,e);},getValue(t,e){let i=Y(rt,{})[t];return i??(this.$data.data.has(t)?this.$data.data.get(t):e)},deleteValue(t){let e=Y(rt,{}),n=e[t];Reflect.deleteProperty(e,t),W(rt,e),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,n,void 0);},addValueChangeListener(t,e,n){let i=Math.random();return this.$listener.listenData.set(t,{id:i,key:t,callback:e}),n&&n.immediate&&e(t,this.getValue(t),this.getValue(t)),i},removeValueChangeListener(t){let e=null;for(const[n,i]of this.$listener.listenData.entries())if(i.id===t){e=n;break}typeof e=="string"?this.$listener.listenData.delete(e):console.warn("没有找到对应的监听器");},triggerMenuValueChange(t,e,n){if(this.$listener.listenData.has(t)){let i=this.$listener.listenData.get(t);if(typeof i.callback=="function"){let s=this.getValue(t),l=s,o=s;typeof e<"u"&&arguments.length>1&&(l=e),typeof n<"u"&&arguments.length>2&&(o=n),i.callback(t,o,l);}}},hasKey(t){let e=Y(rt,{});return t in e},execMenu(t,e,n=false,i){if(!(typeof t=="string"||typeof t=="object"&&Array.isArray(t)))throw new TypeError("key 必须是字符串或者字符串数组");let s=[];typeof t=="object"&&Array.isArray(t)?s=[...t]:s.push(t);let l;for(let o=0;o<s.length;o++){const a=s[o];if(!this.$data.data.has(a)){f.warn(`${t} 键不存在`);return}let c=$.getValue(a);if(n&&(c=!c),typeof i=="function"){let m=i(a,c);typeof m=="boolean"&&(c=m);}if(!c)break;l=c;}l&&e(l);},execMenuOnce(t,e,n,i,s){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){f.warn(`${t} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(t))return;this.$data.oneSuccessExecMenu.set(t,1);let l=()=>{let u=$.getValue(t);return typeof n=="function"?n(t,u):u},o=[],a=u=>{let b=l(),p=[];if(u instanceof HTMLStyleElement?p=[u]:Array.isArray(u)&&(p=[...u.filter(h=>h!=null&&h instanceof HTMLStyleElement)]),b)o=o.concat(p);else for(let h=0;h<p.length;h++)p[h].remove(),p.splice(h,1),h--;},c=u=>typeof s=="function"?s(t,u):u,m=u=>{let b=[];if(c(u)){let p=e(u,a);p instanceof HTMLStyleElement?b=[p]:Array.isArray(p)&&(b=[...p.filter(h=>h!=null&&h instanceof HTMLStyleElement)]);}for(let p=0;p<o.length;p++)o[p].remove(),o.splice(p,1),p--;o=[...b];};this.addValueChangeListener(t,(u,b,p)=>{let h=p;typeof i=="function"&&(h=i(u,p,b)),m(h);});let d=l();d&&m(d);},execInheritMenuOnce(t,e,n,i){let s=this;const l=(o,a)=>{let c=s.getValue(o),m=s.getValue(a);if(typeof i=="function"){let d=i(c,m);if(d!=null)return d}return c};this.execMenuOnce(t,n,()=>l(t,e),()=>l(t,e)),this.execMenuOnce(e,()=>{},()=>false,()=>(this.triggerMenuValueChange(t),false));},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(t)||(e(),this.$data.onceExec.set(t,1));},showPanel(){B.panel({title:{text:`${St}-设置`,position:"center",html:false,style:""},content:this.getPanelContentConfig(),mask:{enable:true,clickEvent:{toClose:true,toHide:false}},width:Et.setting.width,height:Et.setting.height,drag:true,only:true});},isMobile(){return window.innerWidth<550},getWidth(){return window.innerWidth<550?"88vw":"550px"},getHeight(){return window.innerHeight>450?"450px":"88vh"},getPanelContentConfig(){return [se,me,de,pe,ue,he]}},ge=`.pops-confirm-content {\r
	display: flex;\r
	flex-direction: column;\r
}\r
...
`,fe={$data:{cid:""},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"小黑屋",iconColor:"#000000",icon:"",callback:()=>{this.showBlackHome();}});},async showBlackHome(){let t=x.loading("正在获取小黑屋名单中..."),e=await this.getBlackListInfo("");if(t.close(),!e)return;if(e.data.length===0){x.error("获取小黑屋名单为空");return}this.$data.cid=e.next_cid;let n=B.confirm({title:{text:"小黑屋名单",position:"center"},content:{text:`
                ...
                `,html:true},btn:{ok:{text:"下一页",callback:async()=>{let a=x.loading("正在获取小黑屋名单中...");f.info("下一页的cid: ",this.$data.cid);let c=await this.getBlackListInfo(this.$data.cid);a.close(),c&&(this.$data.cid=c.next_cid,c.data.forEach(m=>{let d=this.createListViewItem(m);i.appendChild(d);}),c.data.length===0?x.error("获取小黑屋名单为空"):x.success(`成功获取 ${c.data.length}条数据`));}},cancel:{text:"关闭"}},width:"88vw",height:"82vh",style:ge,mask:{enable:true}}),i=n.$shadowRoot.querySelector(".blackhome-user-list"),s=n.$shadowRoot.querySelector(".blackhome-user-filter input");e.data.forEach(a=>{let c=this.createListViewItem(a);i.appendChild(c);}),x.success(`成功获取 ${e.data.length}条数据`);let l=false;r.on(s,["input","propertychange"],g.debounce(()=>{let a=s.value.trim();if(!l){if(l=true,a==""){n.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.removeAttribute("style");}),l=false;return}n.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.getAttribute("data-name").match(new RegExp(a,"ig"))||c.getAttribute("data-uid").trim().match(new RegExp(a,"ig"))||c.getAttribute("data-operator").match(new RegExp(a,"ig"))?c.removeAttribute("style"):c.setAttribute("style","display:none;");}),l=false;}}));let o=await this.getBlackListInfo(this.$data.cid);o&&(this.$data.cid=o.next_cid);},async getBlackListInfo(t=""){let e={mod:"misc",action:"showdarkroom",cid:t,ajaxdata:"json"},n=await H.get(`/forum.php?${g.toSearchParamsStr(e)}`,{headers:{"User-Agent":g.getRandomPCUA()},responseType:"json"});if(!n.status)return;let i=g.toJSON(n.data.responseText),s=i.message.split("|"),l=s[s.length-1],o=g.parseObjectToArray(i.data),a=[],c=[];return o.forEach(m=>{let d=m.dateline.match(/([0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]*[0-9]{1,2}:[0-9]{1,2})/g);if(d==null){let u=parseInt((Date.now()/1e3).toString()),b=0,p=m.dateline.match(/([0-9]+|半)[\s\S]*秒前/),h=m.dateline.match(/([0-9]+|半)[\s\S]*分钟前/),_=m.dateline.match(/([0-9]+|半)[\s\S]*小时前/),k=m.dateline.match(/昨天[\s\S]*(\d{2}):(\d{2})/),q=m.dateline.match(/前天[\s\S]*(\d{2}):(\d{2})/),S=m.dateline.match(/([0-9]+|半)[\s\S]*天前/);if(p)p=p[p.length-1],p=p.replace(/半/g,.5),p=parseFloat(p),b=u-p;else if(h)h=h[h.length-1],h=h.replace(/半/g,.5),h=parseFloat(h),b=u-h*60;else if(_)_=_[_.length-1],_=_.replace(/半/g,.5),_=parseFloat(_),b=u-_*60*60;else if(k){let R=k[1],I=k[2];b=u-86400-parseInt(R)*3600-parseInt(I)*60;}else if(q){let R=q[1],I=q[2];b=u-86400*2-parseInt(R)*3600-parseInt(I)*60;}else S&&(S=S[S.length-1],S=S.replace(/半/g,.5),S=parseFloat(S),b=u-S*60*60*24);m.time=parseInt(b.toString())*1e3,a=a.concat(m);return}else d=d[0];m.time=g.formatToTimeStamp(d),a=a.concat(m);}),g.sortListByProperty(a,"time"),g.sortListByProperty(c,"time",false),a=a.concat(c),{next_cid:l,data:a}},createListViewItem(t){let e=r.createElement("div",{className:"blackhome-user-item",innerHTML:`
...
`,_e={$data:{},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"在线用户",iconColor:"#2d92ff",icon:"",callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let t=x.loading("正在获取在线用户名单中..."),e=await this.getOnlineUserListInfo();if(t.close(),!e)return;let n=B.alert({title:{text:"在线用户",position:"center"},content:{text:`
        ...
        }`)},removeFontStyle(){f.info("移除帖子字体效果");let t=C(".comiis_a.comiis_message_table");t&&r.html(t,r.html(t).replace(X.fontSpecial,""));},removeCommentFontStyle(){var n;f.info("移除评论区的字体效果");let t=N("font"),e=((n=C(".comiis_postlist .comiis_postli"))==null?void 0:n.innerHTML)||"";e!==""&&(t.forEach(i=>{e.includes(i.innerHTML)||(i.removeAttribute("color"),i.removeAttribute("style"),i.removeAttribute("size"));}),N(".comiis_message.message").forEach(i=>{if(e.includes(i.innerHTML)){i.innerHTML=i.innerHTML.replace(X.fontSpecial,"");let s=i.nextElementSibling;s&&s.localName==="strike"&&(s.outerHTML=s.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));}})),N(".comiis_postli.comiis_list_readimgs.nfqsqi").forEach(i=>{let s=i.parentElement;s&&s.localName==="strike"&&(s.outerHTML=s.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));});},addCommentOnBtn(){f.info("添加【点评】按钮"),g.waitNodeList(".bottom_zhan:not([data-isaddreviews])").then(t=>{t.forEach(e=>{var u,b,p;e.setAttribute("data-isaddreviews","true");var n=e.querySelector("a");if(n){var i=n.getAttribute("datahref")||n.getAttribute("data-href")||n.href||"",s=i.replace("mod=post&","mod=misc&").replace("action=reply&","action=comment&"),l=(u=i==null?void 0:i.match(/&page=([\w]+)/i))==null?void 0:u[1],o=`${s}&extra=page%3D1&page=${l}`,a=e==null?void 0:e.closest(".comiis_postli[id]"),c=(b=a.getAttribute("id"))==null?void 0:b.replace("pid","&pid=");o=o+c;var m=((p=a.querySelector(".top_user.f_b"))==null?void 0:p.textContent)||"",d=r.parseHTML(`
		...
		<div class="comiis_multi_box bg_f b_t">
			...
			`),r.on(document,"click",".reader-copy-button",async function(n){g.preventEvent(n);let i=n.target,s=C(i.getAttribute("data-code-selector"));return await g.setClip(s.outerText||s.innerText),x.success("已复制到剪贴板"),false})),N(".comiis_blockcode.comiis_bodybg").forEach(n=>{if(n.getAttribute("data-copy"))return;n.setAttribute("data-copy","true");let i=r.createElement("div",{innerHTML:`
					...
					复制
					</span>`},{style:"height: 34px;margin: 14px 0px;display: inline-flex;align-items: flex-end;"});r.before(n,i);function s(d,u="java"){d.oldValue||(d.oldValue=d.textContent),d.innerHTML=ut.highlight(d.oldValue,{language:u}).value.replace(/\\n$/gi,"");}let l=ut.highlightAuto(n.textContent).language,o=document.createElement("div"),a=document.createElement("select"),c=ut.listLanguages().sort();c=c.concat("自动检测");let m="";c.forEach(d=>{d.startsWith("自动检测")?m+=`<option data-value="${l}" selected="selected">${d}(${l})</option>`:m+=`<option data-value="${d}">${d}</option>`;}),a.className="code-select-language",a.innerHTML=m,r.on(a,"change",function(){let d=a.selectedOptions[0].getAttribute("data-value");a.setAttribute("aria-label",d),f.info("切换代码块语言: ",d),n.querySelectorAll("li").forEach(u=>{s(u,d);});}),g.preventEvent(a,"click"),o.appendChild(a),i.append(o),g.dispatchEvent(a,"change"),n.className="hljs",n.firstChild.removeAttribute("class"),i.querySelector(".reader-copy-button").setAttribute("data-code-selector",g.getElementSelector(n));});},optimizationImagePreview(){f.info("图片查看优化");function t(n=[],i=0){let s="";n.forEach(a=>{s+=`<li><img data-src="${a}"></li>`;});let l=r.createElement("ul",{innerHTML:s}),o=new At(l,{inline:false,url:"data-src",zIndex:g.getMaxZIndex()+100,hidden:()=>{o.destroy();}});f.info("查看的图片的下标",i),o.view(i),o.zoomTo(1),o.show();}let e=[{hostName:"avatar-bbs.mt2.cn",pathName:"*"},{hostName:"cdn-bbs.mt2.cn",pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"/uc_server/avatar.php"}];g.waitNodeList("div.comiis_postlist.kqide .comiis_postli:not([data-isHandlingViewIMG])").then(n=>{n.forEach(i=>{i.setAttribute("data-isHandlingViewIMG","true");let s=[];i.querySelectorAll("img").forEach(l=>{let o=l.src,a=new URL(o).hostname,c=new URL(o).pathname,m=l.parentElement;m.nodeName.toLowerCase()==="span"&&m.removeAttribute("onclick"),m.nodeName.toLowerCase()==="a"&&m.getAttribute("href")===o&&(m.setAttribute("href","javascript:;"),m.removeAttribute("target"));let d=false;for(let u of e)if(a.indexOf(u.hostName)!=-1&&c.match(u.pathName)){d=true;break}d||(s=[...s,o],r.on(l,"click",function(){f.info("点击图片",l);let u=s.findIndex(b=>b==o);t(s,u);}));}),s.length&&f.info("处理的图片",s);});});},setAttachmentsClickTip(){f.info("附件点击提醒");function t(e){if(e.hasAttribute("href")){let n=e.getAttribute("href"),i=e.querySelector("span.f_ok"),s=e.querySelector(".attach_size");if(r.text(s).indexOf("金币")===-1)return;f.info("发现附件",e),f.info("该附件是金币附件，拦截！");let l=r.text(i);e.setAttribute("data-href",e.getAttribute("href")),e.removeAttribute("href"),i.innerText="【已拦截】"+l,e.onclick=function(){f.info("附件url：",n),B.confirm({title:{text:"提示",position:"center"},content:{text:`<br />确定花费2金币下载附件 <a style="color: #507daf !important;">${l}</a> ？<br /><br />`,html:true},btn:{ok:{callback:o=>{window.open(n,"_blank"),o.close();}}},mask:{enable:true},width:"88vw",height:"200px"});};}}g.mutationObserver(document.documentElement,{callback:()=>{N(".attnm a").forEach(e=>{t(e);}),N(".comiis_attach a").forEach(e=>{t(e);});},config:{childList:true,subtree:true}}),g.waitNodeList(".attnm a").then(e=>{e.forEach(n=>{t(n);});}),g.waitNodeList(".comiis_attach a").then(e=>{e.forEach(n=>{t(n);});});}},xe={init(){G(`
		/* 去除搜索框的蒙版 */
        #comiis_search_noe{
        ...
        `),Z.ready(()=>{$.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),$.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),$.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){f.info("显示搜索历史");let t=Y("search_history",[]),e=C("#scform_srchtxt"),n=C("#searchform"),i=B.searchSuggestion({target:e,inputTarget:e,data:t,getItemHTML:function(o){return o},getData(o){return t.filter(a=>a.includes(o))},deleteIcon:{enable:true,callback(o,a,c){let m=t.findIndex(d=>d===c);m!==-1&&(t.splice(m,1),W("search_history",t)),a.remove();}},itemClickCallBack(o,a,c){e.value=c,n.submit();}});i.init(),i.setAllEvent();function s(){let o=document.querySelector("#scform_submit");Z.on(o,"click",function(){let a=e.value;if(a!=""){let c=Y("search_history",[]);c.includes(a)?f.info("已有该搜索历史记录"):(f.info("无该记录，追加"),c.push(a)),W("search_history",c);}});}function l(){let a='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+Y("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    ...
                    min-width: 20vw;
                    width: 20vw;
                ">清理记录</button></div>`;Z.before(document.querySelector(".comiis_p12"),a);let c=document.querySelector(".btn_clear_search_history");Z.on(c,"click",m=>{g.preventEvent(m),at("search_history"),window.location.reload();});}s(),l();},repairClearBtn(){g.waitNode("a.ssclose").then(t=>{f.info("修复清空按钮"),Z.on(t,"click",e=>{let n=document.querySelector("#scform_srchtxt");n?n.value="":x.error("获取输入框失败");},{capture:true});});},searchInputAutoFocus(){new URLSearchParams(window.location.search).has("kw")||g.waitNode("#scform_srchtxt").then(e=>{f.info("搜索框自动获取焦点"),e.focus();});}},we={init(){r.ready(()=>{$.execMenuOnce("mt-sign-showTodaySignStar",()=>{this.showTodaySignStar();}),$.execMenuOnce("mt-sign-showTodayRanking",()=>{this.showTodayRanking();});});},async showTodaySignStar(){f.info("显示【今日签到之星】");let t=document.querySelector(".pg_k_misign .comiis_qdinfo"),e=document.createElement("ul"),n=await H.get("/k_misign-sign.html",{headers:{"User-Agent":g.getRandomPCUA()}});if(!n.status)return;let s=r.parseHTML(n.data.responseText,true,true).querySelector("#pt span.xg1");if(!s)return;let l=r.text(s).replace("今日签到之星：","");e.innerHTML=`
		...
		}`),t.append(e);},showTodayRanking(){f.info("显示【今日最先】");let t=document.querySelector(".comiis_topnv .comiis_flex .flex"),e=r.createElement("li",{className:"flex"}),n=r.createElement("a",{id:"k_misignlist_today_latest",href:"javascript:;",innerHTML:"今日最先"},{onclick:"ajaxlist('todayLatest');"});e.appendChild(n),r.after(t,e);let i=async o=>{let a=await H.get(`/k_misign-sign.html?operation=${o}`,{responseType:"html",headers:{"User-Agent":g.getRandomPCUA()}});if(!a.status)return;let m=r.parseHTML(a.data.responseText,true,true).querySelector("#J_list_detail .pg span");if(m&&typeof m.title<"u"){let d=m.title.match(/([0-9]+)/);if(d&&d.length==2)return parseInt(d[d.length-1]);x.error("获取页失败");}else x.error("请求最先签到的页失败");},s=async o=>{let a=await H.get(`/k_misign-sign.html?operation=list&op=&page=${o}`,{responseType:"html",headers:{"User-Agent":g.getRandomPCUA()}});if(!a.status)return;let m=r.parseHTML(a.data.responseText,true,true).querySelectorAll("#J_list_detail tbody tr"),d=[];if(m.length==2&&m[0].textContent.indexOf("暂无内容")!=-1)return d;for(let u=1;u<=m.length-2;u++){let b=m[u],p={user:"",uid:"",avatar:"",days:"",monthDays:"",time:"",reward:""},h=b.children[0].getElementsByTagName("a")[0].textContent,k=b.children[0].getElementsByTagName("a")[0].href.match(/space-uid-([0-9]*)/)[1],q=b.children[1].textContent,S=b.children[2].textContent,R=b.children[3].textContent,I=b.children[5].textContent;p.user=h,p.uid=k,p.avatar=F.getAvatar(k,"small"),p.days=q,p.monthDays=S,p.time=R,p.reward=I,d.push(p);}return d};function l(o,a){let c=document.querySelector("#ranklist");r.html(c,o),r.attr(c,"listtype",a);}y.ajaxlist=async o=>{if(o=o,o=="today"?(loadingdelay=false,urlextra="list&op=today"):o=="month"?(loadingdelay=false,urlextra="list&op=month"):o=="zong"?(loadingdelay=false,urlextra="list&op=zong"):o=="calendar"?(loadingdelay=true,urlextra="calendar"):(loadingdelay=false,urlextra="list"),o=="todayLatest"){loadingdelay=false,urlextra="list&op=&page=0";let a=await i(urlextra);if(!a)return;let c=await s(a);if(c.reverse(),c.length<10){let u=await s(a-1);u.reverse(),c=c.concat(u),c.reverse();}let m="";c.reverse(),c.forEach(u=>{m=m+`
					...
					<div class="k_misign_wp">
						<div class="k_misign_list bg_f">
							...
							<li class="flex">
								...
								`)),l(c,o);});};}},ve={init(){$.execMenuOnce("mt-space-repairEnterSpace",()=>{this.repairEnterSpace();}),r.ready(()=>{$.execMenuOnce("mt-space-showCommentContent",()=>{this.showCommentContent();});});},repairEnterSpace(){if(f.info("修复无法进入空间"),M.isSpace()){let t=window.location.href.match(/home.php\?(.+)/gi),e=t[t.length-1];e.split("&").length==2&&e.indexOf("uid=")!=-1&&e.indexOf("mod=space")!=-1&&(window.location.href=window.location.href+"&do=profile");}else if(M.isSpaceWithAt()){let t=window.location.href.match(/space-uid-(.+).html/i),e=t[t.length-1];window.location.href=`${window.location.origin}/home.php?mod=space&uid=${e}&do=profile`;}},async showCommentContent(){f.info("显示帖子回复内容"),G(`
		div.contrete-reply{padding:5px 10px;border-top:1px solid #f3f3f3}
		div.contrete-reply a{margin:0 10px}
		`);async function t(){let o=await H.get(window.location.href,{headers:{"User-Agent":g.getRandomPCUA()}});if(!o.status)return;let a=r.parseHTML(o.data.responseText,true,true),c=[];return a.querySelectorAll("#delform tr.bw0_all+tr").forEach(m=>{let d=[],u=m.querySelector("td"),b=r.html(u).replace(/^&nbsp;/,"");d.push(b);let p=r.next(m),h=a.querySelectorAll("#delform tr");for(let _=0;_<h.length&&!(!p||r.attr(p,"class")==="bw0_all");_++){let k=p.querySelector("td"),q=r.html(k).replace(/^&nbsp;/,"");d=d.concat(q),p=r.next(p);}c.push(...d);}),c}function e(){return g.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist())}function n(o){let a={};return o.forEach(c=>{var _;let d=(_=r.createElement("div",{innerHTML:c}).querySelector("a"))==null?void 0:_.getAttribute("href"),u=d.match(X.ptid),b=d.match(X.pid);if(!u){x.error("获取ptid失败");return}if(!b){x.error("获取pid失败");return}let p=u[u.length-1],h=b[b.length-1];a[p]?a[p].data.push(c):a[p]={ptid:p,pid:h,data:[c]};}),a}var i=await t();if(i==null)return;var s=n(i);e().forEach((o,a)=>{let m=o.querySelector(".comiis_xznalist_bottom a").getAttribute("tid");if(!m){x.error("获取帖子tid失败"),f.error(o);return}s[m]&&s[m].data.forEach(d=>{r.append(o,`<div class="contrete-reply">${d}</div>`);});});}},dt={$key:{tipData:"tipToFreeSubjectForumPost"},init(){this.registerMenu();let t=this.getTipData();if(M.isPost()&&document.querySelector("span.kmren")){f.info("当前帖子存在需要购买主题");let l=false,o;t.forEach((c,m)=>{if(window.location.href.match(c.url)){l=true;return}}),l?(f.warn("已设置提醒"),o=r.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                ...
                <span class="sidenv_num bg_del f_f" style="
                    ...
                    display: inline-flex;
                    bottom: 8px;
                "></span>`);},registerMenu(){j.registerLeftMenu({name:"付费主题白嫖提醒",icon:"",iconColor:"#ec0000",callback:()=>{this.showView();}});},showView(){f.info("显示白嫖列表");let t=dt.getTipData();B.alert({title:{text:"付费主题白嫖列表",position:"center"},content:{text:"",html:true},btn:{ok:{text:"关闭",type:"default"}},mask:{enable:true},width:"88vw",height:"88vh"});let e="",n=0,i="",s="",l=[],o=[],a=[];t.forEach((p,h)=>{let _="#f91212",k="";new Date().getTime()>p.expirationTimeStamp&&(_="#1e90ff",p.isVisited||(k=`
                ...
                </tbody>`,timestamp:p.expirationTimeStamp};new Date().getTime()>p.expirationTimeStamp?k!=""?l.push(q):o.push(q):a.push(q);}),f.info("可白嫖但未访问：",l),f.info("可白嫖：",o),f.info("未到白嫖时间：",a),g.sortListByProperty(l,"expirationTimeStamp",false),g.sortListByProperty(o,"timestamp",false),g.sortListByProperty(a,"timestamp",false),f.info("排序后——可白嫖但未访问：",l),f.info("排序后——可白嫖：",o),f.info("排序后——未到白嫖时间：",a),i=g.mergeArrayToString(l,"content")+g.mergeArrayToString(o,"content"),s=g.mergeArrayToString(a,"content"),n>0&&(e=`
        ...
        `,d=document.querySelector(".msgcon");r.html(d,""),r.append(d,c),r.append(d,m),r.css(d,"height","400px"),r.on(document.querySelector(".delsubjecttip i.comiis_font"),"click",p=>{let h=p.target,_=r.parent(h);var k=parseInt(_.getAttribute("t-index"));B.confirm({title:{text:"提示",position:"center"},content:{text:"<p>确定移出付费主题白嫖列表？</p>",html:true},mask:{enable:true},btn:{ok:{callback:q=>{t.splice(k,1),dt.setTipData(t),g.deleteParentNode(h,"tr"),q.close();}}},width:"80vw",height:"300px"});});let u=document.querySelector("#paymentSubjectReminderIsFreeList");r.on(u,"click","a",p=>{var I,z,E,A,O,v;let h=p.target;var _=parseInt(h.getAttribute("t-index")),k=h.getAttribute("t-href");if(t[_].isVisited=true,dt.setTipData(t),window.open(k,"_blank"),h.setAttribute("style","color: #000000;"),((z=(I=h==null?void 0:h.parentElement)==null?void 0:I.parentElement)==null?void 0:z.children[0].className)!="icon_msgs bg_del")return;h.parentElement.parentElement.children[0].remove(),r.append(u,(v=(O=(A=(E=h==null?void 0:h.parentElement)==null?void 0:E.parentElement)==null?void 0:A.parentElement)==null?void 0:O.parentElement)==null?void 0:v.parentElement);let q=document.querySelector(".subjectcanvisit summary span.icon_msgs.bg_del.f_f"),S=r.text(q),R=parseInt(S)-1;R>0?r.html(q,R.toString()):q.remove();});let b=document.querySelector("paymentSubjectReminderIsPaidList");r.on(b,"click","a",p=>{let h=p.target;h.getAttribute("t-index");var _=h.getAttribute("t-href");window.open(_,"_blank"),h.setAttribute("style","color: #000000;");});},getTipData(){return Y(this.$key.tipData,[])},setTipData(t){W(this.$key.tipData,t);}},qe=`.pops {\r
	--icon-width: 24px;\r
...
`;class $e{constructor(e){nt(this,"isBacking",false);nt(this,"config");this.config=e,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(e){g.preventEvent(e),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){f.success("进入手势模式");let e=this.config.hash;e.startsWith("#")||(e.startsWith("/")||(e="/"+e),e="#"+e),this.config.useUrl&&(e=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+e),this.config.win.history.pushState({},"",e),f.success("监听popstate事件"),r.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(e=false){this.isBacking=true,f.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(e);let n=Date.now()+1e3*5;for(;;){if(Date.now()>n){f.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))f.info("history.back()"),this.config.win.history.back(),await g.sleep(this.config.backDelayTime||150);else break}f.success("移除popstate事件"),r.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(e);}}const ct={https:`
        ...
        <div class="small-window-title-container">
            ...
            <div class="small-window-control">
                ...
                `,html:true},mask:{enable:true,clickEvent:{toClose:true},clickCallBack(I,z){R.quitGestureBackMode();}},btn:{ok:{enable:false},cancel:{enable:false},close:{enable:false}},direction:"bottom",size:"92%",borderRadius:18,style:qe}),a=o.$shadowRoot.querySelector(".small-window-website-icon"),c=o.$shadowRoot.querySelector(".refresh-icon"),m=o.$shadowRoot.querySelector(".small-window-control-image-view"),d=o.$shadowRoot.querySelector(".small-window-control-open-blank"),u=o.$shadowRoot.querySelector(".small-window-control-close"),b=o.$shadowRoot.querySelector(".small-window-title-text");this.$el.$refreshIcon=c,this.$el.$webSiteIcon=a;let p=o.$shadowRoot.querySelector("iframe"),h=o.$shadowRoot.querySelector(".small-window-drag"),_=B.config.Utils.AnyTouch(),k=new _(h),q=o.popsElement,S=r.height(q);k.on("pan",I=>{I.phase=="move"&&I.displacementY>0&&(q.style.transition="none",q.style.height=Math.abs(S-I.distanceY)+"px"),I.isEnd&&(q.style.transition="0.2s ease-in",parseInt(q.style.height)>window.innerHeight/2?q.style.height=S+"px":o.close());});let R=new $e({hash:this.$key.smallWindow,useUrl:true,win:y,beforeHistoryBackCallBack:I=>{o.close();}});R.enterGestureBackMode(),r.on(b,"click",I=>{g.preventEvent(I),g.setClip(`『${t}』 - ${e}`),x.success("已复制链接");}),r.on(m,"click",I=>{g.preventEvent(I),f.info("查看图片",n);var z="";n.forEach(O=>{z+=`<li><img data-src="${O}"></li>`;});var E=r.parseHTML(`<ul>${z}</ul>`,false,false);let A=new At(E,{inline:false,url:"data-src",zIndex:(()=>{let O=g.getMaxZIndex(),v=B.config.InstanceUtils.getPopsMaxZIndex().zIndex;return g.getMaxValue(O,v)+100})(),hidden:()=>{A.destroy();}});A.zoomTo(1),A.show();}),r.on(u,"click",I=>{g.preventEvent(I),R.quitGestureBackMode();}),r.on(d,"click",I=>{g.preventEvent(I),window.open(e,"_blank");}),r.on(a,"click",I=>{g.preventEvent(I),p.contentWindow.location.reload(),this.checkIframeReadyState(p);}),this.checkIframeReadyState(p);},async handleForumPost(t){t.forEach(e=>{if(e.getAttribute("data-injection-small-window"))return;let n=r.text(e.querySelector(".mmlist_li_box h2 a"));(n==""||n==null)&&(n=r.text(e.querySelector(".mmlist_li_box a"))),n=n.trim();let i=e.querySelector(".mmlist_li_box a").href;var s=[];e.setAttribute("data-injection-small-window","true"),e.setAttribute("data-injection-small-window-url",i),e.setAttribute("data-injection-small-window-title",n),e.querySelectorAll(".comiis_pyqlist_img img").forEach(o=>{s.push(o.getAttribute("src"));}),e.querySelectorAll(".comiis_pyqlist_imgs img").forEach(o=>{s.push(o.getAttribute("src"));}),e.querySelectorAll(".mmlist_li_box a").forEach(o=>{o.removeAttribute("href"),o.setAttribute("data-href",i);});let l=e.querySelector(".mmlist_li_box");r.on(l,"click",function(o){var a=Number(o.clientX);document.body.offsetWidth/2>a?window.location.href=i:Ht.showSmallWindow(n,i,s);});});},checkIframeReadyState(t){this.showRefreshIcon();let e=setInterval(()=>{t.contentWindow&&(clearInterval(e),r.createDOMUtils({document:t.contentWindow.document,window:t.contentWindow,globalThis:t.contentWindow,self:t.contentWindow,top}).ready(()=>{f.success("小窗内容已加载完毕"),this.hideRefreshIcon();}));},400);},hideRefreshIcon(){this.$el.$refreshIcon.style.display="none",this.$el.$webSiteIcon.style.display="";},showRefreshIcon(){this.$el.$refreshIcon.style.display="",this.$el.$webSiteIcon.style.display="none";}},ke={init(){Z.ready(()=>{$.execMenuOnce("mt-guide-showLatestPost",()=>{this.showLatestPost();});});},showLatestPost(){f.info("显示最新帖子");async function t(){let e=await H.get("/forum.php?mod=guide&view=hot",{fetch:true,allowInterceptConfig:false});if(!e.status){x.error("获取轮播失败");return}if(e.data.responseText.indexOf('<script src="/_guard/auto.js"><\/script>')!==-1){x.error("获取轮播失败 未知的/_guard/auto.js文件");return}var n=Z.parseHTML(e.data.responseText,true,true),i=n.querySelectorAll('div.comiis_mh_kxtxt div[id*="comiis_mh_kxtxt"] ul');if(i.length===0){x.error("获取轮播失败");return}else {var s=[];i[i.length-1].querySelectorAll("a").forEach(l=>{s.push({href:l.getAttribute("href"),title:l.getAttribute("title")});});}return s}t().then(e=>{if(!e)return;G(`
            ...
            `);var n="";g.sortListByProperty(e,s=>{var l=s.href.match(/thread-(.+?)-/i);return parseInt(l[l.length-1])},true),f.info("导读内容",e),e.forEach(s=>{n+=`
                <li>
                    <span>新帖</span>
                    <a href="${s.href}" title="${s.title}" target="_blank">${s.title}</a>
                </li>`;});let i=document.querySelector(".comiis_forumlist.comiis_xznlist");Z.before(i,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${n}</ul></div>`);});}};class Ot{constructor(e){nt(this,"option");this.option=e;}async showView(){var o;let e=B.confirm({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `}),n=e.$shadowRoot.querySelector(".filter-container"),i=document.createDocumentFragment();this.option.filterOption.forEach(s=>{let l=document.createElement("button");l.innerText=s.name;let o=async()=>{(await this.option.getAllRuleInfo()).forEach(async c=>{await s.filterCallBack(c.data)?r.show(c.$el,false):r.hide(c.$el,false);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};r.on(l,"click",async a=>{g.preventEvent(a),!(typeof s.callback=="function"&&!await s.callback(a,o))&&await o();}),i.appendChild(l);}),n.appendChild(i);}}class qt{constructor(e){nt(this,"option");this.option=e;}async showView(e){var l,o,a,c,m,d,u,b,p;let n=B.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    <div class="rule-view-container">
                    </div>
                    `,html:true},btn:{merge:true,reverse:false,position:"space-between",ok:{enable:((a=(o=(l=this.option)==null?void 0:l.bottomControls)==null?void 0:o.add)==null?void 0:a.enable)||true,type:"primary",text:"添加",callback:async h=>{this.showEditView(false,await this.option.getAddData(),n.$shadowRoot);}},close:{enable:true,callback(h){n.close();}},cancel:{enable:((d=(m=(c=this.option)==null?void 0:c.bottomControls)==null?void 0:m.filter)==null?void 0:d.enable)||false,type:"default",text:"过滤",callback:(h,_)=>{var S,R,I,z,E,A,O;typeof((I=(R=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:R.filter)==null?void 0:I.callback)=="function"&&this.option.bottomControls.filter.callback();let k=()=>Array.from(n.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),q=_.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");r.text(q).includes("取消")?(k().forEach(v=>{r.show(v,false);}),r.text(q,"过滤")):new Se({title:((E=(z=this.option.bottomControls)==null?void 0:z.filter)==null?void 0:E.title)??"过滤规则",filterOption:((O=(A=this.option.bottomControls)==null?void 0:A.filter)==null?void 0:O.option)||[],execFilterCallBack(){r.text(q,"取消过滤");},getAllRuleInfo:()=>k().map(w=>({data:this.parseRuleItemElement(w).data,$el:w}))}).showView();}},other:{enable:((p=(b=(u=this.option)==null?void 0:u.bottomControls)==null?void 0:b.clear)==null?void 0:p.enable)||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:h=>{let _=B.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async k=>{var S,R,I;if(f.success("清空所有"),typeof((I=(R=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:R.clear)==null?void 0:I.callback)=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){x.error("清理失败");return}else x.success("清理成功");await this.updateDeleteAllBtnText(n.$shadowRoot),this.clearContent(n.$shadowRoot),_.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${B.config.cssText.panelCSS}
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return Y(this.$key.STORAGE_KEY,this.getTemplateData())},setData(t){W(this.$key.STORAGE_KEY,t);}},Ie={$key:{STORAGE_KEY:"mt-productListingReminder-rule"},init(){this.registerMenu(),this.runRule();},registerMenu(){j.registerLeftMenu({name:"商品上架提醒",icon:"",iconColor:"#2376b7",callback:()=>{this.showView();}});},async runRule(){async function t(){let i=await H.get("/keke_integralmall-keke_integralmall.html",{fetch:true,allowInterceptConfig:false});if(!i.status){x.error("【积分商城】获取数据失败");return}let s=[];return r.parseHTML(i.data.responseText,true,true).querySelectorAll(".task-list-wrapper li.col-xs-12").forEach(o=>{var a,c;s.push({name:r.text(o.querySelector(".mall-info a > *:first-child"))||r.text(o.querySelector(".mall-info a")),price:r.text(o.querySelector(".mall-info span.discount-price i")),endTime:r.text(o.querySelector(".mall-info #time_hz span.time")),remainingQuantity:parseInt(((c=(a=o.querySelector(".mall-info .mall-count .count-r"))==null?void 0:a.innerText)==null?void 0:c.replace(/仅剩|件/gi,""))||"0")});}),s}if(M.isPointsMall())return;let e=this.getData();if(!e.length)return;let n=await t();if(n){for(const i of n)for(const s of e)if(s.enable&&i.name.match(new RegExp(s.productName,"i"))&&!isNaN(i.remainingQuantity)&&i.remainingQuantity>0){f.success("成功匹配对应商品",s,i),B.confirm({title:{text:"积分商城提醒",position:"center"},content:{text:`<br />
                    ...
                    background: ${c.labelColor} !important;${c.labelStyle||""}`,o.innerHTML=c.labelName,r.on(o,"click",async m=>{g.preventEvent(m),g.isNotNull(c.labelClickEvent)&&y.eval(c.labelClickEvent);}),a.parentElement.append(o);});}});},getTemplateData(){return {uuid:g.generateUUID(),enable:true,name:"",userUID:"",labelName:"",labelColor:"",labelStyle:"",labelClickEvent:""}},getData(){return Y(this.$key.STORAGE_KEY,[])},setData(t){W(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(i=>i.uuid==t.uuid)===-1?(e.push(t),W(this.$key.STORAGE_KEY,e),true):false},updateData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=false;return n!==-1&&(i=true,e[n]=t),this.setData(e),i},deleteData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=false;return n!==-1&&(i=true,e.splice(n,1)),this.setData(e),i},clearData(){at(this.$key.STORAGE_KEY);}},Ee={init(){r.ready(()=>{$.execMenuOnce("mt-forum-post-publish-editorOptimization",()=>{gt.init();});});}},Re={$flag:{showUserUID_initCSS:false},init(){(M.isPage()||M.isGuide()||M.isPlate()||M.isPost()||M.isSearch()||M.isSpace())&&$.execMenuOnce("mt-show-user-uid",()=>{this.showUserUID();}),(M.isSearch()||M.isGuide()||M.isSpace()||M.isPlate())&&$.execMenuOnce("mt-small-window",()=>{Ht.init();}),M.isPost()?(f.info("Router: 帖子"),Vt.init()):M.isSearch()?(f.info("Router: 搜索"),xe.init()):M.isKMiSign()?(f.info("Router: 签到"),we.init()):M.isSpace()||M.isSpaceWithAt()?(f.info("Router: 空间"),ve.init()):M.isGuide()?(f.info("Router: 导读"),ke.init()):M.isPostPublish()?(f.info("Router: 发帖页面"),Ee.init()):f.error("Router: 未适配的链接 ==> "+window.location.href),r.ready(()=>{$.execMenuOnce("mt-black-home",()=>{fe.init();}),$.execMenuOnce("mt-online-user",()=>{_e.init();}),$.execMenuOnce("mt-post-paidThemePost",()=>{dt.init();}),$.execMenuOnce("mt-ownBlock",()=>{Te.init();}),$.execMenuOnce("mt-post-comment-filter",()=>{Ce.init();}),$.execMenuOnce("mt-productListingReminder",()=>{Ie.init();}),$.execMenuOnce("mt-customizeUserLabels",()=>{Me.init();}),$.execMenuOnce("mt-link-text-to-hyperlink",()=>{ye();}),$.execMenu("mt-auto-sign",()=>{mt.init();}),$.execMenu("mt-extend-cookie-expire",()=>{this.extendCookieExpire();});});},showUserUID(){f.info("显示用户UID"),this.$flag.showUserUID_initCSS||(this.$flag.showUserUID_initCSS=true,G(`
			.postli_top_tximg + h2{
 				height: auto;
			}

...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof $t=="function"?$t(t.keyName):"";typeof e=="string"&&e?G(e):vt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,r.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()}},te="【移动端】MT论坛优化",g=st.noConflict(),r=Z.noConflict(),B=bt,b=new g.Log(ht,y.console||Zt.console);var Et;const kt=((Et=ht==null?void 0:ht.script)==null?void 0:Et.name)||te,Lt=!1;b.config({debug:Lt,logMaxCount:1e3,autoClearConsole:!0,tag:!0});x.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return q.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return q.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return q.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let t=st.getMaxZIndex(),e=bt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return st.getMaxValue(t,e)+100}}}));const ee=new g.GM_Menu({GM_getValue:Y,GM_setValue:W,GM_registerMenuCommand:Kt,GM_unregisterMenuCommand:Qt}),V=new g.Httpx(Jt);V.interceptors.request.use(t=>(Xt.handle(t),t));V.interceptors.response.use(void 0,t=>(b.error("拦截器-请求错误",t),t.type==="onabort"?x.warning("请求取消"):t.type==="onerror"?x.error("请求异常"):t.type==="ontimeout"?x.error("请求超时"):x.error("其它错误"),t));V.config({logDetails:Lt});bt.GlobalConfig.setGlobalConfig({mask:{enable:!0,clickEvent:{toClose:!1,toHide:!1}}});y.Object.defineProperty,y.Function.prototype.apply,y.Function.prototype.call,y.Element.prototype.appendChild,y.setTimeout;const G=g.addStyle.bind(g);vt.setGMResourceCSS(Rt.Viewer);vt.setGMResourceCSS(Rt.Hljs);const I=document.querySelector.bind(document),H=document.querySelectorAll.bind(document),rt="GM_Panel",Dt="data-init",et="data-key",it="data-default-value",ie="data-init-more-value",P="data-storage-api",A=function(t,e,n,i,s,l){let o={text:t,type:"switch",description:s,attributes:{},props:{},getValue(){return !!this.props[P].get(e,n)},callback(a,c){let m=!!c;b.success(`${m?"开启":"关闭"} ${t}`),this.props[P].set(e,m);},afterAddToUListCallBack:l};return Reflect.set(o.attributes,et,e),Reflect.set(o.attributes,it,n),Reflect.set(o.props,P,{get(a,c){return q.getValue(a,c)},set(a,c){q.setValue(a,c);}}),o},pt=function(t,e,n,i,s,l="",o){let a={text:t,type:"textarea",attributes:{},props:{},description:i,placeholder:l,disabled:o,getValue(){return this.props[P].get(e,n)},callback(c,m){this.props[P].set(e,m);}};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,n),Reflect.set(a.props,P,{get(c,m){return q.getValue(c,m)},set(c,m){q.setValue(c,m);}}),a},St=function(t,e,n,i,s,l){let o=[];typeof i=="function"?o=i():o=i;let a={text:t,type:"select",description:l,attributes:{},props:{},getValue(){return this.props[P].get(e,n)},callback(c,m,d){let u=m;b.info(`选择：${d}`),this.props[P].set(e,u),typeof s=="function"&&s(c,u,d);},data:o};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,n),Reflect.set(a.props,P,{get(c,m){return q.getValue(c,m)},set(c,m){q.setValue(c,m);}}),a},ft=function(t,e,n,i,s,l,o,a,c){return {text:t,type:"button",description:e,buttonIcon:i,buttonIsRightIcon:s,buttonIconIsLoading:l,buttonType:o,buttonText:n,callback(d){typeof a=="function"&&a(d);},afterAddToUListCallBack:c}},Tt=function(t,e,n,i){let s={type:"own",attributes:{},props:n,getLiElementCallBack:t,afterAddToUListCallBack:i};return Reflect.set(s.attributes,Dt,()=>!1),s},X={formhash:/formhash=([0-9a-zA-Z]+)/,hash:/hash=(.+)&/,uid:/uid(=|-)(\d+)/,fontSpecial:/<font.*?>|<\/font>|<strike>|<strong>|<i>|<u>|align=".*?"|<br>[\s]*<br>[\s]*<br>/g,ptid:/&ptid=([\d]+)/i,pid:/&pid=([\d]+)/i,tid:/&tid=([\d]+)/i},U={getAvatar:(t,e="middle")=>`/uc_server/avatar.php?uid=${t}&size=${e}&ts=1`,getCurrentUID(){let t=y.discuz_uid;if(typeof t=="string")return t;let e=document.querySelector('.sidenv_exit a[href*="uid="]');if(e){let n=e.href.match(/uid=([0-9]+)/);if(n)return n[n.length-1]}},getFormHash(){let t=Array.from((top||globalThis).document.querySelectorAll("input[name=formhash]"));for(let n=0;n<t.length;n++){let s=t[n].value;if(s)return s}let e=Array.from((top||globalThis).document.querySelectorAll('a[href*="formhash="]'));for(let n=0;n<e.length;n++){let s=e[n].href.match(X.formhash);if(s){let l=s[s.length-1];if(l)return l}}},envIsMobile(){return (y.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:t=>{let e=t.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(e){let n=e.filter(Boolean);return n[n.length-1]}},getForumId(t){let e=t.match(/&fid=([\d]+)/i);if(e)return e[e.length-1]},getPostId(t){let e=t.match(/&pid=([\d]+)/i);if(e)return e[e.length-1]},getRepquote(t){let e=t.match(/&repquote=([\d]+)/i);if(e)return e[e.length-1]}},lt={$upload:{small:!1,middle:!1,big:!1},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return lt.$el.$smallUpload.files[0]},get middle(){return lt.$el.$middleUpload.files[0]},get big(){return lt.$el.$bigUpload.files[0]}},showView(){const t=this;let e=B.confirm({title:{text:"修改头像",position:"center"},content:{text:`
                ...
                `,html:!0},btn:{ok:{text:"上传",callback:async()=>{if(!t.$upload.small){x.error("请上传小头像");return}if(!t.$upload.middle){x.error("请上传中头像");return}if(!t.$upload.big){x.error("请上传大头像");return}let n=x.loading("正在处理数据中...");try{let i=await this.getUploadUrl();if(i==null)return;let s=U.getFormHash();if(s==null){x.error("获取formhash失败");return}let l={big:{base64:await g.parseFileToBase64(this.$avatar.big)},middle:{base64:await g.parseFileToBase64(this.$avatar.middle)},small:{base64:await g.parseFileToBase64(this.$avatar.small)}};Object.keys(l).forEach(c=>{let m=l[c];m.base64=m.base64.substring(m.base64.indexOf(",")+1);});let o=new FormData;o.append("Filedata",this.$avatar.big||""),o.append("confirm","确定"),o.append("avatar1",l.big.base64),o.append("avatar2",l.middle.base64),o.append("avatar3",l.small.base64),o.append("formhash",s),b.info("头像的base64字符串",l);let a=await V.post(i,{data:o,processData:!1,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","User-Agent":g.getRandomPCUA(),Host:window.location.hostname,Origin:window.location.origin,Referer:`${window.location.origin}/home.php?mod=spacecp&ac=avatar`}});if(!a.status)return;a.data.responseText.indexOf("window.parent.postMessage('success','*')")!=-1?(e.close(),x.success("上传成功")):(b.error("上传失败",a),x.error(a.data.responseText,{timeout:6e3,isHTML:!1,html:!1}));}catch(i){b.error(i);}finally{n.close();}}}},mask:{enable:!0},width:"88vw",height:"500px",style:`
            .avatar-container{
                display: flex;
            ...
            `});this.$el.$smallUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=!0;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=!0;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=!0;});},setUploadChangeEvent(t,e,n,i){r.on(t,"change",s=>{var m;if(!((m=t.files)!=null&&m.length))return;r.text(e,"🤡获取文件信息中..."),e.removeAttribute("data-success");let l=t.files[0],o=l.size,a=new Image,c=new FileReader;c.readAsDataURL(l),c.onload=function(d){a.src=d.target.result,a.onload=function(){if(a.width>n.width||a.height>n.height){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片尺寸不符合，宽：${a.width} 高：${a.height}`);return}if(o>lt.$data.avatarInfo.maxSize){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片大小不符合：${o}byte，限制最大：${lt.$data.avatarInfo.maxSize}byte`);return}e.setAttribute("data-success","true"),r.text(e,`🤣 通过 宽:${a.width} 高:${a.height} 大小(byte):${o}`),i();};};});},async getUploadUrl(){let t=await V.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":g.getRandomPCUA()}});if(!t.status)return;if(g.isNull(t.data.responseText)){x.error("动态头像：获取上传地址失败");return}let e=t.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(e==null||e.length!=2){x.error("动态头像：获取变量data失败");return}let i=e[e.length-1].split(","),s=i[i.indexOf("src")+1].replace("images/camera.swf?inajax=1","index.php?m=user&a=rectavatar&base64=yes");return b.info("上传地址："+s),s}},ne={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[St("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,n)=>{b.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),St("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),A("逆序弹出","qmsg-config-showreverse",!1,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[A("启用","httpx-use-cookie-enable",!1,void 0,"启用后，将根据下面的配置进行添加cookie"),A("使用document.cookie","httpx-use-document-cookie",!1,void 0,"自动根据请求的域名来设置对应的cookie"),pt("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[A("链接文本转超链接","mt-link-text-to-hyperlink",!0,void 0,"自动把页面中的链接文本转换为超链接"),A("显示用户UID","mt-show-user-uid",!0,void 0,"格式为UID：xxx"),A("小窗模式","mt-small-window",!0,void 0,"开启后点击帖子右侧区域为小窗打开")]}]},{text:"额外菜单项",type:"deepMenu",forms:[{type:"forms",text:"",forms:[A("小黑屋","mt-black-home",!0,void 0,"将会在左侧面板添加【小黑屋】菜单"),A("在线用户","mt-online-user",!0,void 0,"将会在左侧面板添加【在线用户】菜单"),A("付费主题白嫖提醒","mt-post-paidThemePost",!0,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),A("我的屏蔽","mt-ownBlock",!0,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),A("商品上架提醒","mt-productListingReminder",!0,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),A("自定义用户标签","mt-customizeUserLabels",!0,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),A("评论过滤器","mt-post-comment-filter",!0,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",forms:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"forms",forms:[Tt(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return n.querySelector(".avatar-img[data-size='small']"),n.querySelector(".avatar-img[data-size='middle']"),n.querySelector(".avatar-img[data-size='big']"),t.appendChild(e),t.appendChild(n),t.appendChild(i),t}),Tt(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return t.appendChild(e),t.appendChild(n),t}),ft("修改头像",`可以上传gif图片，注意图片最大限制为${st.formatByteToSize(lt.$data.avatarInfo.maxSize)}`,"上传",void 0,!1,!1,"primary",()=>{lt.showView();})]}]}]}]},j={registerLeftMenu(t){g.waitNode(".comiis_sidenv_box .sidenv_li .comiis_left_Touch",1e4).then(e=>{if(!e){b.error("注册左侧面板菜单失败，原因：该元素不存在");return}let n=r.createElement("li",{className:"comiis_left_Touch",innerHTML:`
						<a href="javascript:;" class="comiis_left_Touch">
							<i class="comiis_font"></i>
							${t.name}
						</a>
						`}),i=n.querySelector(".comiis_font");typeof t.style=="string"&&(i.style.cssText=t.style),typeof t.icon=="string"&&(i.innerHTML=t.icon),typeof t.iconColor=="string"&&(i.style.color=t.iconColor),typeof t.iconSize=="string"&&(i.style.fontSize=t.iconSize),r.on(n,"click",s=>{g.preventEvent(s),typeof t.callback=="function"&&t.callback();}),r.append(e,n);});},comiisForumList:()=>document.querySelectorAll("li.forumlist_li"),comiisPostli:()=>document.querySelectorAll("div.comiis_postli.comiis_list_readimgs.nfqsqi"),comiisMmlist:()=>document.querySelectorAll(".comiis_mmlist")},F=function(t,e,n,i,s,l="",o,a,c){let m={text:t,type:"input",isNumber:!!o,isPassword:!!a,props:{},attributes:{},description:i,afterAddToUListCallBack:c,getValue(){return this.props[P].get(e,n)},callback(d,u,f){this.props[P].set(e,o?f:u);},placeholder:l};return Reflect.set(m.attributes,et,e),Reflect.set(m.attributes,it,n),Reflect.set(m.props,P,{get(d,u){return q.getValue(d,u)},set(d,u){q.setValue(d,u);}}),m},se=`#comiis_foot_menu_beautify {\r
	position: fixed;\r
...
`)}
								...
								`});}else await l(o);}});}addTab(){let e=I("#comiis_pictitle_key"),n=e.querySelector("a[data-type='history']"),i=`
            <li>
                <a href="javascript:;" class="comiis-picture-tab" data-type="image-bed">${this.option.name}</a>
            </li>
        `;if(!n){let o=r.createElement("li");n=r.createElement("a",{href:"javascript:;",className:"comiis-picture-tab",innerHTML:"历史图片"},{"data-type":"history"}),r.on(n,"click",()=>{this.initHistoryUploadImageList();}),r.append(o,n),r.append(e,o);}r.before(n.parentElement,i);let s=I("#comiis_pictitle_tab .bqbox_t"),l=Array.from(H("#comiis_pictitle_tab .comiis_upbox")).find(o=>!!o.querySelector("#imglist_history"));l||(l=r.createElement("div",{className:"comiis_upbox bg_f cl",innerHTML:`
					<ul class="comiis_post_imglist cl" id="imglist_history">	
                    </ul>
				`},{style:"display: none;"}),r.before(s,l),l=Array.from(H("#comiis_pictitle_tab .comiis_upbox")).find(o=>!!o.querySelector("#imglist_history"))),r.before(l,`
...
`)}    
            ...
            `),I("#comiis_foot_menu_beautify .comiis_position_key"),this.$el.$like=I("#comiis_foot_menu_beautify .comiis_recommend_addkey"),I("#comiis_foot_menu_beautify #comiis_favorite_a"),I("#comiis_pictitle_key"),this.$el.$btn_submit=I('#comiis_foot_menu_beautify_big li[data-attr="发表"] input'),this.$el.$input=I("#comiis_foot_menu_beautify_big textarea"),this.$el.$fastpostsubmit=I("#fastpostsubmit"),y.textarea_scrollHeight=()=>{},typeof y.comiis_addsmilies=="function"&&(y.comiis_addsmilies=d=>{y.$("#needmessage").comiis_insert(d),y.$("#needmessage")[0].dispatchEvent(new Event("propertychange"));}),y.$("#imglist .up_btn").append(y.$("#filedata")),y.$(document).on("click","#imglist .up_btn a",function(){y.$(this).next().click();}),y.$(document).on("click","#imglist .p_img a",function(){let d=y.$(this);if(d.attr("onclick")==null){let u=d.find("img").attr("id").replace("aimg_","");y.comiis_addsmilies(`[attachimg]${u}[/attachimg]`);}}),r.hide("#comiis_foot_menu_beautify_big .menu_body",!1),this.setInputChangeEvent(),this.setLikeBtnClickEvent(),this.setSubmitBtnClickEvent(),this.setGlobalReplyBtnClickEvent(),this.setGlobalClickCheckEvent(),this.setMenuIconToggleEvent(),this.setMenuImageClickEvent(),this.setMenuImageToggleEvent(),this.setMenuSmileClickEvent(),this.setMenuSmileTabClickEvent(),this.setMenuInsertClickEvent(),this.setMenuQuickUBB(),q.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{this.initReplyText(),this.setInputChangeSaveEvent();}),q.execMenuOnce("mt-image-bed-hello-enable",()=>{zt.init();}),q.execMenuOnce("mt-image-bed-mt-enable",()=>{Bt.init();});},handle_error(t){let e=!1,n=r.text(r.parseHTML(t,!1,!1).querySelector("#messagetext"));return !n||typeof n=="string"&&n.trim()==""||Object.keys(It).forEach(i=>{let s=It[i];if(n.indexOf(s.error_match)!=-1){n.indexOf("typeof errorhandle_=='function'")!=-1&&x.error(s.popup_text),e=!0;return}}),e},setInputChangeEvent(){const t=this;r.on(t.$el.$input,["input","propertychange"],function(e){var i,s;t.$el.$input.value===""?(t.$el.$btn_submit.setAttribute("data-text","false"),(i=I("#comiis_foot_menu_beautify li[data-attr='回帖'] input"))==null||i.setAttribute("placeholder","发帖千百度，文明第一步")):(t.$el.$btn_submit.setAttribute("data-text","true"),(s=I("#comiis_foot_menu_beautify li[data-attr='回帖'] input"))==null||s.setAttribute("placeholder","[草稿待发送]")),r.css(t.$el.$input,"height","70px"),r.css(t.$el.$input,"height",t.$el.$input.scrollHeight-20+"px");});},setInputChangeSaveEvent(){const t=this;r.on(this.$el.$input,["input","propertychange"],e=>{let n=t.$el.$input.value,s=t.$el.$input.closest(".reply_area").querySelector(".reply_user_content").getAttribute("data-reply-url"),l={url:window.location.href,text:n,repquote:s?U.getRepquote(s):void 0,forumId:t.$data.tid};t.$data.db.get("data").then(o=>{if(!o.success||o.code===201){console.warn(o);return}let a=o.data.findIndex(c=>c.forumId===l.forumId&&c.repquote===l.repquote);a!==-1?n==null||n===""?o.data.splice(a,1):o.data[a]=g.assign(o.data[a],{text:l.text}):o.data.push(l),t.$data.db.save("data",o.data).then(c=>{});});});},async initReplyText(t=!1,e=void 0){const n=this;(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let s=await this.$data.db.get("data");if(!s.success||s.code===201){console.warn(s);return}let l;e&&(l=U.getRepquote(e));let o=s.data.find(a=>t?a.forumId===n.$data.tid&&a.repquote==l:a.forumId===n.$data.tid&&a.repquote==null);o&&(r.val(this.$el.$input,o.text),g.dispatchEvent(this.$el.$input,"input"));},setLikeBtnClickEvent(){r.on(this.$el.$like,"click",async t=>{var l,o;if(g.preventEvent(t),y.comiis_recommend_key==0){y.comiis_recommend_key=1;let a=await V.get(this.$el.$like.href+"&inajax=1",{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:!0,allowInterceptConfig:!1});if(!a.status){window.location.href=this.$el.$like.href,setTimeout(function(){y.comiis_recommend_key=0;},500);return}let m=(o=(l=g.parseFromString(a.data.responseText,"text/xml").lastChild)==null?void 0:l.firstChild)==null?void 0:o.nodeValue;if(m.includes("您已评价过本主题")){let d=this.$el.$like.href.match(X.tid)[1];if(!(await V.get(`plugin.php?id=comiis_app&comiis=re_recommend&tid=${d}&inajax=1`,{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:!0,allowInterceptConfig:!1})).status){x.error("取消点赞失败，网络异常");return}var e=Number(r.text("#comiis_recommend_num"));document.querySelectorAll(".comiis_recommend_list_a").length>0&&r.remove("#comiis_recommend_list_a"+y.uid),document.querySelectorAll(".comiis_recommend_list_s").length>0&&r.remove("#comiis_recommend_list_s"+y.uid),document.querySelectorAll(".comiis_recommend_list_t").length>0&&r.remove("#comiis_recommend_list_t"+y.uid),e>1?(r.text(".comiis_recommend_num",e-Number(y.allowrecommend)),r.text(".comiis_recommend_nums","+"+(e-Number(y.allowrecommend)))):(r.remove("#comiis_recommend_num"),r.text(".comiis_recommend_nums",""),document.querySelectorAll(".comiis_recommend_list_a").length>0&&(r.empty(".comiis_recommend_list_a"),r.removeClass(".comiis_recommend_list_a","comiis_recommend_list_on")),document.querySelectorAll(".comiis_recommend_list_t").length>0&&r.removeClass(".comiis_recommend_list_t","comiis_recommend_list_on")),r.html(".comiis_recommend_addkey i","&#xe63b;"),r.removeClass(".comiis_recommend_color","f_a"),r.addClass(".comiis_recommend_color","f_b"),document.querySelectorAll(".comiis_recommend_list_s").length>0&&(document.querySelectorAll(".comiis_recommend_list_s li").length<7?r.hide(".txshow_more",!1):r.show(".txshow_more",!1)),x.success("已取消点赞");}else if(m.includes("您不能评价自己的帖子"))x.error("不能点赞自己的帖子");else if(m.includes("今日评价机会已用完"))x.warning("您今日的点赞机会已用完");else if(m.includes("'recommendv':'+"+y.allowrecommend+"'")){var n={recommendc:0,daycount:0},i;i=m.match(/\'recommendc\':\'(.*?)\'/),i!=null?n.recommendc=parseInt(i[1]):n.recommendc=0,i=m.match(/\'daycount\':\'(.*?)\'/),i!=null?n.daycount=parseInt(i[1]):n.daycount=0,document.querySelectorAll(".comiis_recommend_new span").length<1&&r.append(".comiis_recommend_new",'<span class="bg_del f_f comiis_kmvnum comiis_recommend_num" id="comiis_recommend_num">0</span>');var s=Number(r.text("#comiis_recommend_num"));if(H(".comiis_recommend_list_a").length>0){let d=H(".comiis_recommend_list_a");r.removeClass(d,"comiis_recommend_list_on"),r.addClass(d,"comiis_recommend_list_on"),r.prepend(d,(H(".comiis_recommend_list_a li").length>0?"":'<li style="float:right;margin-right:0;"><a href="misc.php?op=recommend&tid= '+y.tid+'&mod=faq&mobile=2"><span class="bg_b f_c"><em class="comiis_recommend_num">'+s+"</em>赞</span></a></li>")+'<li id="comiis_recommend_list_a'+y.uid+'"><a href="home.php?mod=space&uid='+y.uid+'"><img src="'+U.getAvatar(y.uid,"small")+'"></a></li>');}if(H(".comiis_recommend_list_t").length>0){let d=H(".comiis_recommend_list_t");r.removeClass(d,"comiis_recommend_list_on"),r.addClass(d,"comiis_recommend_list_on"),r.prepend(d,`<span id="comiis_recommend_list_t${y.uid}">
                          							<a href="home.php?mod=space&uid=${y.uid}" class="f_c">${y.username}</a>
													${H(".comiis_recommend_list_t a").length>0?'<span class="f_d"> , </span>':""}
                        						</span>`);}if(H(".comiis_recommend_list_s").length>0){let d=H(".comiis_recommend_list_s");r.removeClass(d,"comiis_recommend_list_on"),r.addClass(d,"comiis_recommend_list_on"),r.prepend(d,(H(".comiis_recommend_list_s li").length>0,""+'<li id="comiis_recommend_list_s'+y.uid+'"><a href="home.php?mod=space&uid='+y.uid+'"><img loading="lazy" src="'+U.getAvatar(y.uid,"small")+'"></a></li>'));}r.text(".comiis_recommend_num",s+Number(y.allowrecommend)),r.text(".comiis_recommend_nums","+"+(s+Number(y.allowrecommend))),r.html(".comiis_recommend_addkey i","&#xe654;"),r.removeClass(".comiis_recommend_color","f_b"),r.addClass(".comiis_recommend_color","f_a"),H(".comiis_recommend_list_s").length>0&&(H(".comiis_recommend_list_s li").length<7?r.hide(".txshow_more",!1):r.show(".txshow_more",!1)),x.success("点赞成功"+(n.daycount?`, 您今天还能点赞 ${n.daycount-1} 次`:""));}else m.indexOf("window.location.href = 'member.php?mod=logging&action=login&mobile=2'")>=0?window.location.href="member.php?mod=logging&action=login&mobile=2":x.error("没有点赞权限或帖子不存在");setTimeout(function(){y.comiis_recommend_key=0;},500);}return !1});},setSubmitBtnClickEvent(){const t=this;r.on(this.$el.$fastpostsubmit,"click",async e=>{var s,l,o,a,c,m;g.preventEvent(e);var n=I("#needmessage"),i=r.val(n);if(i=encodeURIComponent(i),!(i==null||i==="")){if(r.val(t.$el.$fastpostsubmit)=="发表"){let d=x.loading("发表中，请稍后..."),u="message="+i;H("#imglist input[type='hidden']").forEach(k=>{let v=k.getAttribute("name");u+=`&${v}=`;}),u=r.serialize(t.$el.$form)+"&"+u;let f=t.$data.forum_action+"reply&handlekey=fastpost&loc=1&inajax=1",p=await V.post(f,{data:u,fetch:!0,allowInterceptConfig:!1,headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(d.close(),!p.status){x.error("发表失败，网络异常");return}let _=(l=(s=g.parseFromString(p.data.responseText,"text/xml").lastChild)==null?void 0:s.firstChild)==null?void 0:l.nodeValue;if(y.evalscript(_),this.handle_error(_))return;window.scrollTo({top:r.height(document)}),r.val("#needmessage",""),(o=I("#comiis_head"))==null||o.click(),r.hide("#comiis_foot_menu_beautify_big .reply_user_content",!1),r.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),r.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"),this.deleteReplyTextStorage();}else {let d=r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-serialize")+i;H("#imglist input[type='hidden']").forEach(_=>{d=`${d}&${_.getAttribute("name")}=`;});let u=r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-action"),f=await V.post(u+"&handlekey=fastposts&loc=1&inajax=1",{allowInterceptConfig:!1,fetch:!0,data:d,headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(!f.status){x.error("回复失败，网络异常");return}let h=(c=(a=g.parseFromString(f.data.responseText,"text/xml").lastChild)==null?void 0:a.firstChild)==null?void 0:c.nodeValue;if(b.info(h),y.evalscript(h),this.handle_error(h))return;(m=I(h))==null||m.click(),r.val("#needmessage",""),I("#comiis_head").click(),r.val('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"发表"),r.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),r.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"),window.scrollTo({top:r.height(document)}),this.deleteReplyTextStorage(!0,u);}return !1}});},setGlobalReplyBtnClickEvent(){r.on(document,"click",'.comiis_postli_times .dialog[href*="reply"]',async t=>{var u,f,p,h;g.preventEvent(t);let e=t.target;r.attr("#comiis_foot_menu_beautify_big","data-model","reply");let n=await V.get(r.attr(e,"datahref")||e.href+"&inajax=1",{fetch:!0,allowInterceptConfig:!1});if(!n.status){x.error("网络异常，获取回复参数失败");return}let s=(f=(u=g.parseFromString(n.data.responseText,"text/xml").lastChild)==null?void 0:u.firstChild)==null?void 0:f.nodeValue;if(this.handle_error(s))return;let l=r.parseHTML(`<div>${s}</div>`,!0,!1),o=(p=l.querySelector(".comiis_tip .tip_tit a"))==null?void 0:p.getAttribute("href"),a=r.text(l.querySelector(".comiis_tip span.f_0")),c=r.val(l.querySelector("input[name='noticeauthormsg']")),m=r.attr(l.querySelector("#postforms"),"action"),d=r.serialize(l.querySelector("#postforms"));r.text("#comiis_foot_menu_beautify_big .reply_user_content",`回复 ${a}: ${c}`),r.show("#comiis_foot_menu_beautify_big .reply_user_content",!1),(h=I("#comiis_foot_menu_beautify li[data-attr='回帖'] input"))==null||h.click(),r.focus("#comiis_foot_menu_beautify li[data-attr='回帖'] input"),r.val("#fastpostsubmitline input","回复"),r.attr("#comiis_foot_menu_beautify_big .fastpostform_new a","href",o),r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-url",o),r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-action",m),r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-serialize",d),yt=e,r.val("#needmessage",r.attr(e,"data-text")||""),q.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{this.initReplyText(!0,o);});},{capture:!0});},setGlobalClickCheckEvent(){const t=this;let e=I("#fastpostform .header_y a").href;r.on(document,"click",function(n){var s;let i=n.target;if(I(".popups-popmenu")||tt.$data.isUBBCodeInsertClick){b.info("点击的是弹出层，不做处理"),tt.$data.isUBBCodeInsertClick=!1;return}else i!=null&&i.classList&&((s=i==null?void 0:i.classList)!=null&&s.contains(".dialog_reply"))||i!=null&&i.closest&&(i!=null&&i.closest(".dialog_reply"))||i===I('li[data-attr="回帖"] input')?(b.info("点击回复按钮或者是编辑器，显示编辑器"),r.hide("#comiis_foot_menu_beautify",!1),r.show("#comiis_foot_menu_beautify_big",!1),r.focus("#needmessage")):window.event&&!g.checkUserClickInNode(I("#comiis_foot_menu_beautify_big"))&&(b.info("点击的其它区域，隐藏大编辑器，显示小编辑器"),r.show("#comiis_foot_menu_beautify",!1),r.hide("#comiis_foot_menu_beautify_big",!1),r.attr("#comiis_foot_menu_beautify_big","data-model")=="reply"&&(r.attr("#comiis_foot_menu_beautify_big","data-model","comment"),r.val("#fastpostsubmitline input","发表"),r.attr("#comiis_foot_menu_beautify_big .fastpostform_new a","href",e),r.text("#comiis_foot_menu_beautify_big .reply_area .reply_user_content"),r.hide("#comiis_foot_menu_beautify_big .reply_area .reply_user_content",!1),r.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-url",""),r.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-action",""),r.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-serialize",""),yt&&(r.attr(yt,"data-text",r.val("#needmessage")),r.val("#needmessage",""),r.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),r.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"))),r.val(t.$el.$input)===""&&q.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{t.initReplyText();}));});},setMenuIconToggleEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a i","click",function(t){let e=this;e.classList.contains("f_0")?(r.hide("#comiis_foot_menu_beautify_big .menu_body",!1),r.removeClass("#comiis_foot_menu_beautify_big .menu_icon a i","f_0")):(r.show("#comiis_foot_menu_beautify_big .menu_body",!1),r.removeClass("#comiis_foot_menu_beautify_big .menu_icon a i","f_0"),r.addClass(e,"f_0"));});},setMenuImageClickEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a.comiis_pictitle","click",function(t){r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",!1),r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",!1),r.show("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",!1);});},setMenuImageToggleEvent(){r.on("#comiis_foot_menu_beautify_big #comiis_pictitle_tab #comiis_pictitle_key","click","li",function(t){let e=t.target;r.removeClass("#comiis_foot_menu_beautify_big #comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),r.addClass(e,"bg_f"),y.$("#comiis_foot_menu_beautify_big #comiis_pictitle_tab div.comiis_upbox").hide().eq(y.$(e).index()).fadeIn();});},setMenuSmileClickEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a.comiis_smile","click",function(t){r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",!1),r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",!1),r.show("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",!1);let e=I("#comiis_foot_menu_beautify_big .menu_body .comiis_bqbox");r.attr(e,"data-isLoaded")!=1&&(r.attr(e,"data-isLoaded",1),e.querySelectorAll("img").forEach(n=>{let i=n.getAttribute("data-src");i&&n.setAttribute("src",i);}));});},setMenuSmileTabClickEvent(){r.on("#comiis_foot_menu_beautify_big #comiis_smilies_key li","click",function(t){let e=this;r.removeClass("#comiis_foot_menu_beautify_big #comiis_smilies_key li a"),r.addClass(e.querySelector("a"),"bg_f b_l b_r"),y.$("#comiis_post_tab div.swiper-wrapper.bqbox_c.comiis_optimization .swiper-slide").hide().eq(y.$(e).index()).fadeIn();});},setMenuInsertClickEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a.commis_insert_bbs","click",t=>{r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",!1),r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",!1),r.show("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",!1);});},async getReplyRecordSize(){var e;let t=await this.$data.db.get("data");return t.success?g.getTextStorageSize((e=t==null?void 0:t.data)!=null&&e.length?JSON.stringify(t.data):""):g.formatByteToSize(0)},async clearAllReplyRecord(){return await this.$data.db.deleteAll()},deleteReplyTextStorage(t=!1,e=void 0){const n=this;this.$data.db.get("data").then(i=>{if(!i.success||i.code===201){console.warn(i);return}let s=i.data.findIndex(l=>t?l.forumId===n.$data.tid&&e&&l.repquote===U.getRepquote(e):l.forumId===n.$data.tid&&g.isNull(l.repquote));s!==-1&&(i.data.splice(s,1),this.$data.db.save("data",i.data).then(l=>{}));});},setMenuQuickUBB(){let t=I("#comiis_insert_ubb_tab_list"),e=Nt();Reflect.set(e,"code",{key:"代码",value:"[code][/code]",tagL:"]",tagR:"[",L:"[code]",R:"[/code]",cursorL:"[code]",cursorLength:7,quickUBBReplace:"[code]replace[/code]"}),Reflect.set(e,"password",{key:"密码",value:"[password][/password]",tagL:"]",tagR:"[",L:"[password]",R:"[/password]",cursorL:"[password]",cursorLength:10,quickUBBReplace:"[password]replace[/password]"}),Object.keys(e).forEach(n=>{let i=e[n],s=r.createElement("li",{className:"quickUBBs",innerHTML:`
                    <a href="javascript:;" class="comiis_xifont f_d">
                        <i class="comiis_font"></i>${i.key}
                    </a>
                `});r.on(s,"click",l=>{r.removeClass("#comiis_insert_ubb_tab div.comiis_post_urlico ul li.quickUBBs a.comiis_xifont","f_0"),r.addClass("#comiis_insert_ubb_tab div.comiis_post_urlico ul li.quickUBBs a.comiis_xifont","f_d");let o=s.querySelector(".comiis_xifont");r.removeClass(o,"f_d"),r.removeClass(o,"f_d");let a=B.prompt({title:{text:"UBB代码",position:"center"},content:{text:"",placeholder:`请输入需要${i.key}的文字`,focus:!0},btn:{ok:{text:"插入",type:"primary",callback:c=>{if(c.text.trim()===""){x.error("输入框不能为空或纯空格");return}i.isFunc?y.comiis_addsmilies(Ut(i.num,c.text)):i.quickUBBReplace?y.comiis_addsmilies(i.quickUBBReplace.replaceAll("replace",c.text)):y.comiis_addsmilies(c.text),a.close();}},cancel:{text:"关闭",callback:()=>{a.close();}}},width:"300px",height:"200px"});}),t.append(s);});}},re=`.f_c,\r
.f_c a,\r
.ntc_body {\r
...
`,K=globalThis.location.pathname,Q=globalThis.location.search;new URLSearchParams(Q);const M={isKMiSign(){return K.startsWith("/k_misign-sign.html")},isPost(){return K.startsWith("/thread-")||K.startsWith("/forum.php")&&Q.startsWith("?mod=viewthread")},isPage(){return !!K.match(/^\/page-([0-9]+).html/g)},isGuide(){return K.startsWith("/forum.php")&&Q.startsWith("?mod=guide")},isPlate(){return !!K.match(/\/forum-[0-9]{1,2}-[0-9]{1,2}.html/g)},isSearch(){return K.startsWith("/search.php")},isSpace(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space")},isMySpace(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space&do=profile&mycenter")},isSpaceWithAt(){return K.startsWith("/space-uid-")},isForumList(){return K.startsWith("/forum.php")&&Q.startsWith("?forumlist")},isMessage(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space&do=notice")},isMessageList(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space&do=pm")},isPointsMall(){return K.startsWith("/keke_integralmall-keke_integralmall.html")||K.startsWith("/plugin.php")&&Q.startsWith("?id=keke_integralmal")},isPostPublish(){return K.startsWith("/forum.php")&&Q.startsWith("?mod=post")},isPostPublish_voting(){return K.startsWith("/forum.php")&&Q.includes("&special=1")||Q.includes("&fid=42")},isPostPublish_edit(){return this.isPostPublish()&&Q.includes("&action=edit")},isPostPublish_newthread(){return this.isPostPublish()&&Q.includes("&action=newthread")},isPostPublish_reply(){return this.isPostPublish()&&Q.includes("&action=reply")}},le=()=>({"[呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq001.gif","[撇嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq002.gif","[色]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq003.gif","[发呆]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq004.gif","[得意]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq005.gif","[流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq006.gif","[害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq007.gif","[闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq008.gif","[睡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq009.gif","[大哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq010.gif","[尴尬]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq011.gif","[发怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq012.gif","[调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq013.gif","[呲牙]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq014.gif","[惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq015.gif","[难过]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq016.gif","[酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq017.gif","[冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq018.gif","[抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq019.gif","[吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq020.gif","[偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq021.gif","[可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq022.gif","[白眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq023.gif","[傲慢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq024.gif","[饥饿]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq025.gif","[困]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq026.gif","[惊恐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq027.gif","[流汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq028.gif","[憨笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq029.gif","[装逼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq030.gif","[奋斗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq031.gif","[咒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq032.gif","[疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq033.gif","[嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq034.gif","[晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq035.gif","[折磨]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq036.gif","[衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq037.gif","[骷髅]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq038.gif","[敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq039.gif","[再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq040.gif","[擦汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq041.gif","[抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq042.gif","[鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq043.gif","[糗大了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq044.gif","[坏笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq045.gif","[左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq046.gif","[右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq047.gif","[哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq048.gif","[鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq049.gif","[委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq050.gif","[快哭了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq051.gif","[阴脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq052.gif","[亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq053.gif","[吓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq054.gif","[可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq055.gif","[眨眼睛]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq056.gif","[笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq057.gif","[dogeQQ]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq058.gif","[泪奔]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq059.gif","[无奈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq060.gif","[托腮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq061.gif","[卖萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq062.png","[斜眼笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq063.gif","[喷血]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq064.gif","[惊喜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq065.gif","[骚扰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq066.gif","[小纠结]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq067.gif","[我最美]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq068.gif","[菜刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq069.gif","[西瓜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq070.gif","[啤酒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq071.gif","[篮球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq072.gif","[乒乓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq073.gif","[咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq074.gif","[饭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq075.gif","[猪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq076.gif","[玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq077.gif","[凋谢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq078.gif","[示爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq079.gif","[爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq080.gif","[心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq081.gif","[蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq082.gif","[闪电]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq083.gif","[炸弹]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq084.gif","[刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq085.gif","[足球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq086.gif","[瓢虫]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq087.gif","[便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq088.gif","[月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq089.gif","[太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq090.gif","[礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq091.gif","[抱抱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq092.gif","[喝彩]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq93.gif","[祈祷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq94.gif","[棒棒糖]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq95.gif","[药]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq96.gif","[赞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq097.gif","[差劲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq098.gif","[握手]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq099.gif","[胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq100.gif","[抱拳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq101.gif","[勾引]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq102.gif","[拳头]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq103.gif","[爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq105.gif","[NO]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq106.gif","[OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq107.gif","[#呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_1.png","[#滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_10.png","[#吐舌]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_3.png","[#哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_2.png","[#啊]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_23.png","[#酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_22.png","[#怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_13.png","[#开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_39.png","[#汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_14.png","[#泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_16.png","[#黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_15.png","[#鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_21.png","[#不高兴]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_12.png","[#真棒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_17.png","[#钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_40.png","[#疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_26.png","[#阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_20.png","[#吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_34.png","[#咦]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_41.png","[#委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_29.png","[#花心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_6.png","[#呼～]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_42.png","[#激动]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_5.png","[#冷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_43.png","[#可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_4.png","[#What？]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_25.png","[#勉强]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_38.png","[#狂汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_24.png","[#酸爽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_27.png","[#乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_8.png","[#雅美蝶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_28.png","[#睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_31.png","[#惊哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_19.png","[#哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_44.png","[#笑尿]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_32.png","[#惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_30.png","[#小乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_7.png","[#喷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_18.png","[#抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_33.png","[#捂嘴笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_9.png","[#你懂的]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_11.png","[#犀利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_35.png","[#小红脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_36.png","[#懒得理]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_37.png","[#爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_45.png","[#心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_46.png","[#玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_47.png","[#礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_48.png","[#彩虹]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_49.png","[#太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_50.png","[#月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_51.png","[#钱币]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_52.png","[#咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_53.png","[#蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_54.png","[#大拇指]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_55.png","[#胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_56.png","[#爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_57.png","[#OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_58.png","[#弱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_59.png","[#沙发]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_60.png","[#纸巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_61.png","[#香蕉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_62.png","[#便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_63.png","[#药丸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_64.png","[#红领巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_65.png","[#蜡烛]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_66.png","[#三道杠]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_67.png","[#音乐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_68.png","[#灯泡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_69.png","[doge]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/1.png","[doge思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/2.png","[doge再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/3.png","[doge生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/4.png","[doge气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/5.png","[doge笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/7.png","[doge调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/6.png","[doge啊哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/8.png","[doge原谅TA]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/9.png","[miao]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/10.png","[miao思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/11.png","[miao拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/12.png","[miao生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/13.png","[miao气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/14.png","[二哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/15.png","[摊手]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/19.png","[w并不简单]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/20.png","[w滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/21.png","[w色]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/22.png","[w爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/23.png","[w拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/24.png","[w悲伤]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/25.png","[w鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/26.png","[w馋嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/27.png","[w冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/28.png","[w打哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/29.png","[w打脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/30.png","[w敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/31.png","[w生病]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/32.png","[w闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/33.png","[w鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/34.png","[w哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/35.png","[w害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/36.png","[w呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/37.png","[w黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/38.png","[w哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/39.png","[w调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/40.png","[w可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/41.png","[w可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/42.png","[w酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/43.png","[w困]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/44.png","[w懒得理你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/45.png","[w流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/46.png","[w怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/47.png","[w怒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/48.png","[w钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/49.png","[w亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/50.png","[w傻眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/51.png","[w便秘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/52.png","[w失望]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/53.png","[w衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/54.png","[w睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/55.png","[w思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/56.png","[w开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/57.png","[w色舔]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/58.png","[w偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/59.png","[w吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/60.png","[w抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/61.png","[w委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/62.png","[w笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/63.png","[w嘻嘻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/64.png","[w嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/65.png","[w阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/66.png","[w疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/67.png","[w抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/70.png","[w晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/69.png","[w右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/68.png","[w左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/71.png","[w肥皂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/77.png","[w奥特曼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/78.png","[w草泥马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/79.png","[w兔子]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/80.png","[w熊猫]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/81.png","[w猪头]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/82.png","[w→_→]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/83.png","[w给力]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/84.png","[w囧]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/85.png","[w萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/86.png","[w神马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/87.png","[w威武]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/88.png"}),xt={parseText(t){const e=le();let n=t.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/g);n&&n.forEach($=>{let w=$.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/),T=w?w[w.length-1]:"",z=r.attr(`#aimg_${T}`,"title"),N=r.attr(`#aimg_${T}`,"src");N||(z="该图片不存在"),t=t.replace($,`<span class="comiis_postimg vm"><img loading="lazy" id="aimg_${T}" src="${N}" alt="${z}" title="${z}"></span>`);});let i=t.match(/\[code\]([\s\S]*?)\[\/code\]/g);i&&i.forEach($=>{let w=$.match(/\[code\]([\s\S]*?)\[\/code\]/),T=w?w[w.length-1]:"",z="",N=T.split(`
`);N.length==1?z=`<li>${T}</li>`:Array.from(N).forEach((J,ot)=>{ot==N.length-1?z=`${z}<li>${J}</li>`:z=`${z}<li>${J}<br></li>`;}),t=t.replace($,`
                <div class="comiis_blockcode comiis_bodybg b_ok f_b"><div class="bg_f b_l"><ol>${z}</ol></div></div>`);});let s=t.match(/\[url\=[\s\S]*?\]([\s\S]*?)\[\/url\]/g);s&&s.forEach($=>{let w=$.match(/\[url=([\s\S]*?)\][\s\S]*\[\/url\]/),T=$.match(/\[url=[\s\S]*?\]([\s\S]*?)\[\/url\]/),z=w?w[w.length-1]:"",N=T?T[T.length-1]:"";t=t.replace($,`<a href="${z}" target="_blank">${N}</a>`);});let l=t.match(/\[color\=[\s\S]*?\]([\s\S]*?)\[\/color\]/g);l&&l.forEach($=>{let w=$.match(/\[color=([\s\S]*?)\][\s\S]*\[\/color\]/),T=$.match(/\[color=[\s\S]*?\]([\s\S]*?)\[\/color\]/),z=w?w[w.length-1]:"",N=T?T[T.length-1]:"";t=t.replace($,`<font color="${z}">${N}</font>`);});let o=t.match(/\[size\=[\s\S]*?\]([\s\S]*?)\[\/size\]/g);o&&o.forEach($=>{let w=$.match(/\[size=([\s\S]*?)\][\s\S]*\[\/size\]/),T=$.match(/\[size=[\s\S]*?\]([\s\S]*?)\[\/size\]/),z=w?w[w.length-1]:"",N=T?T[T.length-1]:"";t=t.replace($,`<font size="${z}">${N}</font>`);});let a=t.match(/\[img(|\=[\s\S]+?)\]([\s\S]*?)\[\/img\]/g);a&&a.forEach($=>{let w=null,T=null,z=$.match(/\[img\=([\s\S]+?)\][\s\S]*?\[\/img\]/);z&&(z=z[z.length-1].split(","),w=z[0],T=z[1]),w=w||"",T=T||"";let N=$.match(/\[img\]([\s\S]*?)\[\/img\]|\[img=[\s\S]*?\]([\s\S]*?)\[\/img\]/),J="";N&&(N[N.length-1]==null?J=N[N.length-2]:J=N[N.length-1]),t=t.replace($,`<img loading="lazy" src="${J}" border="0" alt="" width="${w}" height="${T}" crossoriginNew="anonymous">`);});let c=t.match(/\[hide\]([\s\S]*?)\[\/hide\]/g);c&&c.forEach($=>{let w=$.match(/\[hide\]([\s\S]*?)\[\/hide\]/),T=w?w[w.length-1]:"";t=t.replace($,`<div class="comiis_quote bg_h f_c"><h2 class="f_a">本帖隐藏的内容: </h2>${T}</div>`);});let m=t.match(/\[hide=[\s\S]*?\]([\s\S]*?)\[\/hide\]/g);m&&m.forEach($=>{let w=$.match(/\[hide=([\s\S]*?)\]([\s\S]*?)\[\/hide\]/),T=w?w[w.length-2]:"";T=T.split(",");let z=T.length==2?T[1]:"";t=t.replace($,`<div class="comiis_quote bg_h f_c">以下内容需要积分高于 ${z} 才可浏览</div>`);});let d=t.match(/\[quote\]([\s\S]*?)\[\/quote\]/g);d&&d.forEach($=>{let w=$.match(/\[quote\]([\s\S]*?)\[\/quote\]/),T=w?w[w.length-1]:"";t=t.replace($,`<div class="comiis_quote bg_h b_dashed f_c"><blockquote><font>回复</font> ${T}</blockquote></div>`);});let u=t.match(/\[free\]([\s\S]*?)\[\/free\]/g);u&&u.forEach($=>{let w=$.match(/\[free\]([\s\S]*?)\[\/free\]/),T=w?w[w.length-1]:"";t=t.replace($,`<div class="comiis_quote bg_h f_c"><blockquote>${T}</blockquote></div>`);});let f=t.match(/\[b\]([\s\S]*?)\[\/b\]/g);f&&f.forEach($=>{let w=$.match(/\[b\]([\s\S]*?)\[\/b\]/i),T=w?w[w.length-1]:"";t=t.replace($,`<strong>${T}</strong>`);});let p=t.match(/\[u\]([\s\S]*?)\[\/u\]/g);p&&p.forEach($=>{let w=$.match(/\[u\]([\s\S]*?)\[\/u\]/),T=w?w[w.length-1]:"";t=t.replace($,`<u>${T}</u>`);});let h=t.match(/\[i\]([\s\S]*?)\[\/i\]/g);h&&h.forEach($=>{let w=$.match(/\[i\]([\s\S]*?)\[\/i\]/),T=w?w[w.length-1]:"";t=t.replace($,`<i>${T}</i>`);});let _=t.match(/\[s\]([\s\S]*?)\[\/s\]/g);_&&_.forEach($=>{let w=$.match(/\[s\]([\s\S]*?)\[\/s\]/),T=w?w[w.length-1]:"";t=t.replace($,`<strike>${T}</strike>`);});let k=t.match(/\[([\s\S]+?)\]/g);k&&k.forEach($=>{let w=e[$];w&&(t=t.replace($,`<img loading="lazy" src="${w}" border="0" alt="" smilieid="">`));});let v=t.match(/\[media=[\s\S]+?\][\s\S]+?\[\/media\]/g);v&&v.forEach($=>{let w=$.match(/\[media=[\s\S]*?\]([\s\S]*?)\[\/media\]/),T=w?w[w.length-1]:"";T&&(t=t.replace($,`<ignore_js_op><span><iframe src="${T}" border="0" scrolling="no" framespacing="0" allowfullscreen="true" style="max-width: 100%" width="100%" height="auto" frameborder="no"></iframe></span></ignore_js_op>`));});let S=t.match(/\[email=[\s\S]+?\][\s\S]+?\[\/email\]/g);S&&S.forEach($=>{let w=$.match(/\[email=([\s\S]*?)\][\s\S]*?\[\/email\]/),T=$.match(/\[email=[\s\S]*?\]([\s\S]*?)\[\/email\]/),z=w.length?w[w.length-1]:"",N=T.length?T[T.length-1]:"";(z||N)&&(t=t.replace($,`<a href="mailto:${z}">${N}</a>`));});let R=t.match(/\[align=[\s\S]+?\][\s\S]+?\[\/align\]/g);R&&R.forEach($=>{let w=$.match(/\[align=([\s\S]*?)\][\s\S]+?\[\/align\]/),T=$.match(/\[align=[\s\S]*?\]([\s\S]+?)\[\/align\]/),z=w.length?w[w.length-1]:"",N=T.length?T[T.length-1]:"";(z||N)&&(t=t.replace($,`<div align="${z}">${N}</div>`));});let C=t.match(/\[qq\][\s\S]*?\[\/qq\]/g);C&&C.forEach($=>{let w=$.match(/\[qq\]([\s\S]*?)\[\/qq\]/),T=w?w[w.length-1]:"";t=t.replace($,`<a href="http://wpa.qq.com/msgrd?v=3&uin=${T}&site=[Discuz!]&from=discuz&menu=yes" target="_blank"><img loading="lazy" src="static/image/common/qq_big.gif" border="0"></a>`);});let D=t.match(/\[td\][\s\S]+?\[\/td\]/g);D&&D.forEach($=>{let w=$.match(/\[td\]([\s\S]*?)\[\/td\]/),T=w?w[w.length-1]:"";t=t.replace($,`<td>${T}</td>`);});let L=t.match(/\[tr\][\s\S]+?\[\/tr\]/g);L&&L.forEach($=>{let w=$.match(/\[tr\]([\s\S]*?)\[\/tr\]/),T=w?w[w.length-1]:"";t=t.replace($,`<tr>${T}</tr>`);});let E=t.match(/\[table\][\s\S]+?\[\/table\]/g);E&&E.forEach($=>{let w=$.match(/\[table\]([\s\S]*?)\[\/table\]/),T=w?w[w.length-1]:"";T=T.replace(/\n/g,""),t=t.replace($,`<table>${T}</table>`);});let O=t.match(/\[list=[\s\S]+?\][\s\S]+?\[\/list\]/g);return O&&O.forEach($=>{let w=$.match(/\[list=([\s\S]*?)\][\s\S]*?\[\/list\]/),T=$.match(/\[list=[\s\S]*?\]([\s\S]*?)\[\/list\]/),z=w?w[w.length-1]:"",N="";z==="a"?N="litype_2":z==="A"?N="litype_3":z.length===1&&z.match(/[0-9]{1}/)&&(N="litype_1");let J=T?T[T.length-1]:"",ot=J.split("[*]");if(ot.length>1){let _t="";ot[0].replace(/[\s]*/,"")==""&&(ot=ot.slice(1)),Array.from(ot).forEach(jt=>{_t=`${_t}<li>${jt}</li>`;}),J=_t;}J=J.replace(/\n/g,""),t=t.replace($,`<ul type="${z}" class="${N}">${J}</ul>`);}),t},parseVoteText(){let t=["rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)","rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)"],e=H(".comiis_polloption_add ul li:first-child div.flex .comiis_input.kmshow[type='text']"),n=parseInt(r.val("input#maxchoices"));n=isNaN(n)?0:n,n=n>0?n:0,n=n>e.length?e.length:n;let i=parseInt(r.val("input#polldatas"));i=isNaN(i)?0:i,y.$("input#visibilitypoll").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close");let s=!y.$("input#overt").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close"),l="",o="";e.forEach((a,c)=>{c>=20||(o=o+`
                    <li class="kmnop">
                ...
                `,y.$(".gm_plugin_previewpostforum_html .postforum_vote").remove(),y.$(".gm_plugin_previewpostforum_html .comiis_messages.comiis_aimg_show").children().eq(0).before(y.$(l));}},gt={$data:{db:new st.indexedDB("mt_full_reply_record","input_text"),get type(){return M.isPostPublish_voting()?"post-vote":"post"},get tid(){return U.getThreadId(window.location.href)},get pid(){return U.getPostId(window.location.href)}},$key:{noPublishSerializeText:"mt-editor-no-publish-serialize-text",noPublishVotingSerializeText:"mt-editor-no-publish-voting-serialize-text"},$el:{$title:null,$input:null,$form:null},init(){b.info("编辑器优化"),G(re),this.overridePageEditor();},overridePageEditor(){const t=this;this.$el.$title=I("#needsubject"),this.$el.$form=I("#postform"),this.$el.$input=I("#needmessage"),r.hide(r.parent(".comiis_scrollTop_box"),!1),r.css("#postform .comiis_post_from.mt15",{"margin-top":"0px !important"});let e=y.$("#postform .comiis_post_from #comiis_post_tab");y.$("#postform .comiis_post_from .comiis_post_ico").append(e),e.remove(),y.textarea_scrollHeight=()=>{};let n=y.$.fn.comiis_delete;y.$.fn.extend({comiis_delete:function(...c){let m=n.call(this,...c);return g.dispatchEvent(t.$el.$input,"input"),m}}),r.hide(".comiis_btnbox",!1),this.initVotePage(),y.$(".gm_plugin_chartbed .comiis_over_box.comiis_input_style #imglist"),G(`
        ...
        `),r.attr("#filedata","multiple",!0),r.remove(".gm_plugin_chartbed .comiis_over_box.comiis_input_style"),r.on(document,"#comiis_pictitle_key li","click",function(){r.removeClass("#comiis_pictitle_key li","bg_f"),r.addClass(this,"bg_f"),y.$(".gm_plugin_chartbed .comiis_upbox").hide().eq(y.$(this).index()).fadeIn();});let i=parseInt(r.css("#comiis_head","height"))||0,s=parseInt(r.css("#comiis_sub","height"))||0,l=I("#pollm_c_1")?60:0,o=parseInt(r.css(".comiis_styli.comiis_flex","height"))||0,a=parseInt(r.css(".comiis_post_ico.comiis_minipost_icot","height"))||0;r.css("#needmessage","height",`${window.screen.height-i-s-48-o-a-10}px`),r.css("#needmessage","marginBottom",l+"px"),M.isPostPublish_edit()&&r.val("#needsubject")===""?r.hide(".comiis_styli.comiis_flex",!1):r.attr("#needsubject","placeholder","请输入完整的帖子标题 (1-80个字)"),r.attr("#needmessage","placeholder","来吧，尽情发挥吧..."),typeof y.comiis_addsmilies=="function"&&(y.comiis_addsmilies=c=>{y.$("#needmessage").comiis_insert(c),y.$("#needmessage")[0].dispatchEvent(new Event("input"));}),(q.getValue("mt-forum-post-editorOptimizationNormal-recordInputText")||q.getValue("mt-forum-post-editorOptimization-recordInputText"))&&(this.setInputChangeEvent(),this.initReplyText()),this.initDeleteBtn(),this.initSaveDraftBtn(),this.initSaveBtn(),this.initPostBtn(),this.initReplyBtn(),this.observerChangeEditorHeight(),this.listenResize(),this.initSelectPostingSection(),this.initUBB(),this.initImage(),this.initPreview(),this.initCharacterCount(),this.initSettingImmersionMode();},async initReplyText(){const t=this;let e=null,n=null,i=null;if(M.isPostPublish_newthread())b.info("新发布帖子的页面"),M.isPostPublish_voting()?(b.info("投票页面"),e=Y(this.$key.noPublishVotingSerializeText),i=()=>{at(t.$key.noPublishVotingSerializeText);}):(b.info("普通帖子页面"),e=Y(this.$key.noPublishSerializeText),i=()=>{at(this.$key.noPublishSerializeText);});else if(M.isPostPublish_edit()){b.info("草稿的页面"),b.info(`type：${this.$data.type} tid：${this.$data.tid} pid：${this.$data.pid}`),(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let l=await this.$data.db.get("data");if(l.data){let o=l.data.find(a=>{if(a.type===t.$data.type&&!(a.tid!==t.$data.tid||a.pid!==t.$data.pid))return !0});o&&(e=o.data,i=async()=>{let a=await this.$data.db.get("data");if(a.data){let c=a.data.findIndex(m=>{if(m.type===t.$data.type&&!(m.tid!==t.$data.tid||m.pid!==t.$data.pid))return !0});c!=-1&&(a.data.splice(c,1),await this.$data.db.save("data",a.data));}});}}else if(M.isPostPublish_reply()&&(b.info("回复页面"),q.getValue("mt-forum-post-editorOptimizationNormal-recordInputText"))){(await tt.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let l=await tt.$data.db.get("data");if(l.data){let o=l.data.find(a=>a.forumId===t.$data.tid&&a.repquote===U.getRepquote(window.location.href));o&&(e=o);}}e&&(M.isPostPublish_voting()?n=()=>{let s=t.$el.$form.querySelector("input[name='subject']"),l=t.$el.$form.querySelector("textarea[name='message']"),o=t.$el.$form.querySelector("input[name='maxchoices']"),a=t.$el.$form.querySelector("input[name='expiration']"),c=t.$el.$form.querySelector("input[name='visibilitypoll']"),m=t.$el.$form.querySelector("input[name='overt']");return r.val(s,e.title),r.val(l,e.content),r.val(o,e.maxchoices),r.val(a,e.expiration),r.val(c,e.visibilitypoll),r.val(m,e.overt),g.dispatchEvent(s,"input"),g.dispatchEvent(l,"input"),g.dispatchEvent(o,"input"),g.dispatchEvent(a,"input"),g.dispatchEvent(c,"input"),g.dispatchEvent(m,"input"),!0}:M.isPostPublish_reply()?n=()=>{let s=t.$el.$form.querySelector("textarea[name='message']");return r.val(s,e.text),g.dispatchEvent(s,"input"),!0}:n=()=>{let s=t.$el.$form.querySelector("input[name='subject']"),l=t.$el.$form.querySelector("textarea[name='message']");return r.val(s,e.title),r.val(l,e.content),g.dispatchEvent(s,"input"),g.dispatchEvent(l,"input"),!0},M.isPostPublish_newthread()?(b.info("新发布帖子的页面"),typeof n=="function"&&n()):M.isPostPublish_edit()?(b.info("草稿的页面"),typeof n=="function"&&typeof i=="function"&&B.confirm({title:{text:"提示",position:"center"},content:{text:"<p>存在历史写入的数据，是否恢复到编辑器里？</p>",html:!0},btn:{merge:!0,position:"space-between",ok:{text:"恢复",callback:async s=>{await n()&&(x.success("恢复成功"),s.close());}},other:{enable:!0,type:"danger",text:"删除该数据",callback:async s=>{await i(),s.close(),x.success("删除成功");}}},width:"300px",height:"200px"})):M.isPostPublish_reply()&&(b.info("回复页面"),typeof n=="function"&&n()));},async getReplyRecordSize(){var e;let t=await this.$data.db.get("data");return t.success?g.getTextStorageSize((e=t==null?void 0:t.data)!=null&&e.length?JSON.stringify(t.data):""):g.formatByteToSize(0)},async clearAllReplyRecord(){return await this.$data.db.deleteAll()},deleteReplyTextStorage(){const t=this;this.$data.db.get("data").then(e=>{if(!e.success){console.warn(e);return}let n=M.isPostPublish_voting()?"post-vote":"post",i=U.getThreadId(window.location.href),s=U.getPostId(window.location.href),l=e.data.findIndex(o=>{if(o.type===n&&!(o.tid!==i||o.pid!==s))return !0});l!==-1&&(e.data.splice(l,1),t.$data.db.save("data",e.data).then(o=>{}));});},setInputChangeEvent(){const t=this;r.on([this.$el.$input,this.$el.$title].filter(Boolean),["input","propertychange"],function(e){let n=null;if(M.isPostPublish_voting()){let i=t.$el.$form.querySelector("input[name='subject']"),s=t.$el.$form.querySelector("textarea[name='message']"),l=t.$el.$form.querySelector("input[name='maxchoices']"),o=t.$el.$form.querySelector("input[name='expiration']"),a=t.$el.$form.querySelector("input[name='visibilitypoll']"),c=t.$el.$form.querySelector("input[name='overt']");n={title:i.value,maxchoices:l.value,expiration:o.value,visibilitypoll:a.checked,overt:c.checked,content:s.value};}else {let i=t.$el.$form.querySelector("input[name='subject']"),s=t.$el.$form.querySelector("textarea[name='message']");n={title:i==null?void 0:i.value,content:s.value};}M.isPostPublish_newthread()?(b.info("内容改变 ==> 新发布帖子的页面"),M.isPostPublish_voting()?W(t.$key.noPublishVotingSerializeText,n):W(t.$key.noPublishSerializeText,n)):M.isPostPublish_edit()?(b.info("内容改变 ==> 草稿的页面"),t.$data.db.get("data").then(i=>{if(!i.success){console.warn(i);return}let s=i.data.findIndex(l=>{if(l.type===t.$data.type&&!(l.tid!==t.$data.tid||l.pid!==t.$data.pid))return !0});s!==-1&&i.data.splice(s,1),i.data.push({url:window.location.href,data:n,pid:t.$data.pid,tid:t.$data.tid,type:t.$data.type}),t.$data.db.save("data",i.data).then(l=>{});})):M.isPostPublish_reply()&&(b.info("内容改变 ==> 回复页面"),q.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{tt.$data.db.get("data").then(i=>{if(!i.success||i.code===201){console.warn(i);return}let s=i.data.findIndex(l=>l.forumId===t.$data.tid&&l.repquote===U.getRepquote(window.location.href));s!==-1?n.content==null||n.content===""?i.data.splice(s,1):i.data[s]=g.assign(i.data[s],{text:n.content}):i.data.push({forumId:t.$data.tid,url:window.location.href,repquote:U.getRepquote(window.location.href),text:n.content}),tt.$data.db.save("data",i.data).then(l=>{});});}));});},initDeleteBtn(){if(!I(".comiis_btnbox .comiis_btn.bg_del"))return;let e=I("#comiis_head .header_y"),n=r.createElement("input",{className:"new_btn_del"},{type:"button",value:"删除"});r.append(e,n),r.on(n,"click",function(){B.confirm({title:{text:"提示",position:"center"},content:{text:"<p>是否删除帖子?</p>",html:!0},btn:{ok:{callback:i=>{i.close(),y.comiis_delthread();}}},width:"300px",height:"200px"});});},initSaveBtn(){let t=r.selector(".comiis_btnbox button#postsubmit:contains('保存')");if(!t||r.text(t).includes("草稿"))return;let e=I("#comiis_head .header_y"),n=r.createElement("input",{className:"new_btn_save"},{type:"button",value:"保存"});r.append(e,n),r.on(n,"click",function(){t.click();});},initPostBtn(){let t=r.selector(".comiis_btnbox button#postsubmit:contains('发表')");if(!t)return;let e=I("#comiis_head .header_y"),n=r.createElement("input",{className:"new_btn_post"},{type:"button",value:"发表"});r.append(e,n),r.on(n,"click",function(){r.val("#postsave",0),t.click();});},initReplyBtn(){const t=this;let e=r.selector(".comiis_btnbox button#postsubmit:contains('回复')");if(!e)return;let n=I("#comiis_head .header_y"),i=r.createElement("input",{className:"new_btn_reply"},{type:"button",value:"回复"});r.append(n,i),r.on(i,"click",function(){e.click(),t.deleteReplyTextStorage();});},initVotePage(){H(".comiis_scrollTop_box").length&&(y.$("#htmlon").parent().append(`
        ...
        `);let e=I("#select-post-section"),n=U.getForumId(window.location.href);M.isPostPublish_newthread()?(b.info("发帖"),r.on(e,"change",function(){let i=r.val(e),s=`forum.php?mod=post&action=newthread&fid=${i}&extra=&topicsubmit=yes&mobile=2`;b.info(`修改发帖板块: ${t[i]} ${s}`);let l={求助问答:{className:"gm_user_select_help",optionHTML:`<option value="0" selected="selected">请选择</option>
                        ...
                        `)):Object.keys(l).forEach(a=>{r.remove(".comiis_post_from ."+l[a].className);}),r.attr("#postform","action",s);})):r.attr(e,"disabled",!0),r.val(e,n),r.trigger(e,"change");},initCharacterCount(){b.info("添加功能：字符计数"),G(`
        ...
        `);let t=Nt(),e=I(".comiis_post_urlico > ul"),n=I("#comiis_post_qydiv > ul"),i=H("#comiis_post_qydiv ul li").length;oe(),r.on("#comiis_post_tab .comiis_input_style .comiis_post_urlico li","click",function(){r.removeClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_0"),r.addClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_d"),r.attr(this.querySelector("a"),"class","comiis_xifont f_0"),y.$("#comiis_post_qydiv ul li").hide().eq(y.$(this).index()).fadeIn();}),y.$.each(t,function(s,l){let o=r.createElement("li",{className:"quickUBBs",innerHTML:`
            ...
            <div class="comiis_styli_m f15 comiis_flex" style="padding-top:0;">
                ...
                <div class="flex"></div>
            </div>`,r.append(n,a),r.on(`.comiis_sendbtn[data-keyI="${s}"]`,"click",()=>{let c=y.$(`#comiis_input_${s}`).val();if(c==""){x.warning("请输入需要插入的内容");return}let m=t[s];m.isFunc&&(c=Ut(m.num,c)),m.hasOwnProperty("L")&&(c=m.L+c+m.R),y.$("#needmessage").insertAtCaret(c),m.hasOwnProperty("cursorL")&&y.$("#needmessage").moveCursorToCenterByTextWithLeft(m.cursorL,m.cursorLength),m.hasOwnProperty("cursorR")&&y.$("#needmessage").moveCursorToCenterByTextWithRight(m.cursorR,m.cursorLength);});});},initImage(){b.info("添加功能：图片"),G(`
            #comiis_pictitle_tab .comiis_upbox{
                height: 140px;
                overflow-y: auto;
            }
            `),r.append("#comiis_mh_sub .swiper-wrapper.comiis_post_ico",`
        <a href="javascript:;" class="comiis_pictitle"><i class="comiis_font"><em>图片</em></i></a>`),r.on(".comiis_pictitle","click",function(){this.querySelector("i.comiis_font").classList.contains("f_0")?r.hide(".gm_plugin_chartbed",!1):r.show(".gm_plugin_chartbed",!1);}),r.append("#comiis_post_tab",`
            ...
            `);let e=I("#imglist"),n=r.parent(e);r.before(".gm_plugin_chartbed .bqbox_t",n),r.on("#imglist .comiis_font","click",i=>{I("#filedata").click();}),r.on("#comiis_pictitle_tab #comiis_pictitle_key","click","li",function(i){let s=i.target;r.removeClass("#comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),r.addClass(s,"bg_f"),y.$("#comiis_pictitle_tab div.comiis_upbox").hide().eq(y.$(s).index()).fadeIn();}),q.execMenuOnce("mt-image-bed-hello-enable",()=>{zt.init();}),q.execMenuOnce("mt-image-bed-mt-enable",()=>{Bt.init();});},initPreview(){const t=this;b.info("添加功能：双列预览"),G(`
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
            ...
            </div>`),r.on(".gm_plugin_previewpostforum","click",function(n){let i=this;if(H("#polldatas").length&&xt.parseVoteText(),i.querySelector("i.comiis_font").classList.contains("f_0"))r.hide(".gm_plugin_previewpostforum_html",!1);else {r.show(".gm_plugin_previewpostforum_html",!1);let l=xt.parseText(r.val(t.$el.$input));r.html(".gm_plugin_previewpostforum_html .comiis_message_table",l),r.css(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box.comiis_input_style","height",r.css(t.$el.$input,"height"));}});},initSettingImmersionMode(){b.info("初始化设置功能-使用沉浸模式"),r.append(r.parent("#htmlon"),`
            <li class="comiis_styli_m f15 comiis_flex b_b">
            ...
            `),r.on("#immersiveinput","click",function(){let t=this,e=r.parent(t).querySelector(".comiis_checkbox"),n=[".comiis_wzpost ul li.comiis_flex",".comiis_wzpost ul li.comiis_styli.kmquote",r.parent(r.parent("#pollchecked")),"#pollm_c_1",".comiis_polloption_add+div.f_0",".comiis_wzpost ul li.comiis_thread_content:contains('内容')","div#comiis_head","div#comiis_head+*:not([class])"];r.hasClass(e,"comiis_checkbox_close")?n.forEach(i=>{i&&r.hide(i,!1);}):n.forEach(i=>{i&&r.show(i,!1);}),window.dispatchEvent(new Event("resize"));});}},ce={id:"component-forum-post",title:"帖子",forms:[{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[A("自动展开内容","mt-forum-post-autoExpandContent",!0,void 0,"注入CSS展开帖子的内容"),A("修复图片宽度","mt-forum-post-repairImageWidth",!0,void 0,"修复图片宽度超出页面宽度的问题"),A("移除帖子字体效果","mt-forum-post-removeFontStyle",!1,void 0,""),A("移除评论区的字体效果","mt-forum-post-removeCommentFontStyle",!1,void 0,""),A("添加【点评】按钮","mt-forum-post-addCommentOnBtn",!1,void 0,"在评论区的每个评论右下角添加按钮"),A("附件点击提醒","mt-forum-post-setAttachmentsClickTip",!0,void 0,"阻止默认点击附件就会触发附件下载"),A("代码块优化","mt-forum-post-codeQuoteOptimization",!0,void 0,"自动检测代码块语言并设置关键字高亮"),A("图片查看优化","mt-forum-post-optimizationImagePreview",!0,void 0,"使用Viewer查看图片")]}]},{text:"自动加载评论",type:"deepMenu",forms:[{type:"forms",text:"",forms:[A("自动加载下一页评论","mt-forum-post-loadNextPageComment",!0,void 0,""),A("同步加载的地址","mt-forum-post-syncNextPageUrl",!1,void 0,"便于刷新页面会停留在当前查看的评论页面")]}]},{text:"编辑器-简略版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[A("启用","mt-forum-post-editorOptimizationNormal",!0,void 0,"优化样式，插入bbcode代码等"),A("自动保存输入记录","mt-forum-post-editorOptimizationNormal-recordInputText",!0,void 0,"当回复时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,!1,!1,"default",async t=>{let i=t.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await tt.clearAllReplyRecord();s.success?(x.success("清理成功"),r.text(i,`当前占用空间大小：${await tt.getReplyRecordSize()}`)):x.error("清理失败 "+s.msg);},async(t,e)=>{let n=e.target.querySelector(".pops-panel-item-left-desc-text");r.text(n,`当前占用空间大小：${await tt.getReplyRecordSize()}`);})]}]},{text:"编辑器-完整版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[A("启用","mt-forum-post-publish-editorOptimization",!0,void 0,"优化样式，插入bbcode代码，双列预览等"),A("自动保存输入记录","mt-forum-post-editorOptimization-recordInputText",!0,void 0,"当回复/发表时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,!1,!1,"default",async t=>{let i=t.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await gt.clearAllReplyRecord();s.success?(x.success("清理成功"),r.text(i,`当前占用空间大小：${await gt.getReplyRecordSize()}`)):x.error("清理失败 "+s.msg);},async(t,e)=>{let n=e.target.querySelector(".pops-panel-item-left-desc-text");r.text(n,`当前占用空间大小：${await gt.getReplyRecordSize()}`);})]}]},{text:"编辑器-图床配置",type:"deepMenu",forms:[{type:"forms",text:'<a href="https://www.helloimg.com/" target="_blank">Hello图床</a>',forms:[A("启用","mt-image-bed-hello-enable",!1,void 0,"启用Hello图床"),F("账号","mt-image-bed-hello-account","","",void 0,"必填"),F("密码","mt-image-bed-hello-password","","",void 0,"必填",!1,!0),F("token","mt-image-bed-hello-token","","",void 0,"必填",!1,!0)]},{type:"forms",text:'<a href="https://img.binmt.cc/" target="_blank">MT图床</a>',forms:[A("启用","mt-image-bed-mt-enable",!0,void 0,"启用MT图床")]},{type:"forms",text:"图片水印",forms:[A("启用","mt-image-bed-watermark-enable",!1,void 0,"开启后会为图床图片添加文字水印"),A("自动添加水印","mt-image-bed-watermark-autoAddWaterMark",!1,void 0,"开启后会自动添加水印，关闭后会有添加水印后的图片预览"),F("水印文字","mt-image-bed-watermark-text","MT论坛"),F("颜色","mt-image-bed-watermark-text-color","#000000",void 0,void 0,"",!1,!1,(t,e)=>{var s,l;let n=(s=e.target)==null?void 0:s.querySelector("input"),i=(l=e.target)==null?void 0:l.querySelector(".pops-panel-input__suffix");r.hide(i,!1),n.setAttribute("type","color"),r.css(n,{margin:"unset",padding:"unset",width:"80px"});}),F("大小","mt-image-bed-watermark-font-size",16,void 0,void 0,void 0,!0),F("透明度","mt-image-bed-watermark-font-opacity",1,void 0,void 0,void 0,!0),F("左右间距","mt-image-bed-watermark-left-right-margin",80,void 0,void 0,void 0,!0),F("上下间距","mt-image-bed-watermark-top-bottom-margin",80,void 0,void 0,void 0,!0),F("旋转角度","mt-image-bed-watermark-rotate",45,void 0,void 0,void 0,!0)]}]}]}]},me={id:"component-search",title:"搜索",forms:[{type:"forms",text:"",forms:[A("显示搜索历史","mt-search-showSearchHistory",!0,void 0,"自动记住搜索历史并显示"),A("修复清空按钮","mt-search-repairClearBtn",!0,void 0,"修复点击清空按钮不清空输入框的问题"),A("搜索框自动获取焦点","mt-search-searchInputAutoFocus",!0,void 0,"")]}]},mt={$key:{signTime:"mt-sign-time"},init(){this.sign();},todayIsSign(){let t=this.getSignTime();return !(t==null||g.formatTime(Date.now(),"yyyyMMdd")!==g.formatTime(t,"yyyyMMdd"))},setSignTime(){W(this.$key.signTime,Date.now());},getSignTime(){return Y(this.$key.signTime)},clearSignTime(){at(this.$key.signTime);},checkLogin(){return U.envIsMobile()?I(".sidenv_exit a[href*='member.php?mod=logging&action=logout']"):I("#comiis_key")},async sign(){let t=U.getFormHash();if(t==null){if(I("#comiis_picshowbox")){b.info("当前为评论区的看图模式 ");return}b.error("自动签到：获取账号formhash失败"),at("mt_sign"),x.error({content:"自动签到：获取账号formhash失败"});return}if(this.todayIsSign()){b.info("今日已签到");return}let e={operation:"qiandao",format:"button",formhash:t,inajax:1,ajaxtarget:"midaben_sign"},n=!!q.getValue("mt-auto-sign-useFetch"),i=await V.get(`/k_misign-sign.html?${g.toSearchParamsStr(e)}`,{fetch:n,headers:{"User-Agent":g.getRandomPCUA()},allowInterceptConfig:!1});if(!i.status){b.error("签到：网络异常，请求失败"),x.error("签到：网络异常，请求失败");return}this.setSignTime(),b.info("签到信息：",i);let s=i.data.responseText,l=g.parseCDATA(s),o=r.parseHTML(`<div>${l}</div>`,!0,!1),a=r.text(o);if(a.includes("需要先登录")){x.error("签到：请先登录账号",{timeout:3e3}),this.clearSignTime();return}else if(a.includes("请稍后再试")||a.includes("您已经被列入黑名单")||a.includes("绑定手机号后才可以签到")||a.includes("您所在用户组不允许使用")){x.error("签到："+a,{timeout:5e3});return}else if(a.includes("今日已签")||a.includes("今日已经签到")){x.info("签到："+a);return}else if(s.includes("您当前的访问请求当中含有非法字符，已经被系统拒绝")){x.error("签到: 您当前的访问请求当中含有非法字符，已经被系统拒绝",{timeout:6e3});return}else if(n&&"location"in g.toJSON(s)){x.success("签到: 签到成功");return}let c=o.querySelector(".con"),m=o.querySelector(".line");if(c&&m){let f=r.text(c).match(/([0-9]+)金币/),p=r.text(m).match(/([0-9]+)/),h=f[f.length-1],_=p[p.length-1];b.success(`金币${h}，排名${_}`),x.info(`
                ...
                </div>`,{timeout:4e3,isHTML:!0});return}let u=bt.alert({title:{text:"未知签到内容",position:"center"},content:{text:"",html:!1},width:"88vw",height:"300px"}).$shadowRoot.querySelector(".pops-alert-content");u.innerText=i.data.responseText;}},de={id:"component-sigh",title:"签到",forms:[{text:"功能",type:"forms",forms:[A("显示【今日签到之星】","mt-sign-showTodaySignStar",!0,void 0,"在签到按钮上面显示今日签到之星"),A("显示【今日最先】","mt-sign-showTodayRanking",!0,void 0,"在签到排名上面新增【今日最先】")]},{text:"自动签到",type:"forms",forms:[A("启用","mt-auto-sign",!0,void 0,"自动请求签到"),A("使用fetch请求","mt-auto-sign-useFetch",!1,void 0,""),ft("签到信息",`上次签到时间：${mt.getSignTime()==null?"尚未签到":st.formatTime(mt.getSignTime())}`,"清空信息",void 0,void 0,void 0,"primary",t=>{let n=t.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");B.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:!0},btn:{ok:{enable:!0,callback:i=>{mt.clearSignTime(),x.success("删除成功"),r.text(n,`上次签到时间：${mt.getSignTime()==null?"尚未签到":st.formatTime(mt.getSignTime())}`),i.close();}}},mask:{enable:!0},width:"88vw",height:"200px"});})]}]},pe={id:"component-space",title:"空间",forms:[{type:"forms",text:"",forms:[A("修复无法进入空间","mt-space-repairEnterSpace",!0,void 0,"修复链接错误导致不能进入空间的问题"),A("显示帖子回复内容","mt-space-showCommentContent",!0,void 0,"在帖子-回复下面显示具体评论的内容")]}]},ue={id:"component-guide",title:"导读",forms:[{type:"forms",text:"",forms:[A("显示最新帖子","mt-guide-showLatestPost",!0,void 0,"在最上面显示最新发布的帖子")]}]},Mt={setting:{get width(){return window.innerWidth<550?"88vw":"550px"},get height(){return window.innerHeight<450?"70vh":"450px"}},settingBig:{get width(){return window.innerWidth<800?"92vw":"800px"},get height(){return window.innerHeight<600?"80vh":"600px"}},info:{get width(){return "350px"},get height(){return "250px"}}},q={$data:{__data:null,__oneSuccessExecMenu:null,__onceExec:null,__listenData:null,get data(){return q.$data.__data==null&&(q.$data.__data=new g.Dictionary),q.$data.__data},get oneSuccessExecMenu(){return q.$data.__oneSuccessExecMenu==null&&(q.$data.__oneSuccessExecMenu=new g.Dictionary),q.$data.__oneSuccessExecMenu},get onceExec(){return q.$data.__onceExec==null&&(q.$data.__onceExec=new g.Dictionary),q.$data.__onceExec},get scriptName(){return kt},key:rt,attributeKeyName:et,attributeDefaultValueName:it},$listener:{get listenData(){return q.$data.__listenData==null&&(q.$data.__listenData=new g.Dictionary),q.$data.__listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},isTopWindow(){return y.top===y.self},initExtensionsMenu(){this.isTopWindow()&&(ee.add([{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:!1,isStoreValue:!1,showText(t){return t},callback:()=>{this.showPanel();}}]),j.registerLeftMenu({name:"MT论坛脚本设置",icon:"",iconColor:"#ff0505",iconSize:"23px",callback:()=>{this.showPanel();}}));},initPanelDefaultValue(){let t=this;function e(s){if(!s.attributes)return;let l={},o=s.attributes[et];o!=null&&(l[o]=s.attributes[it]);let a=s.attributes[Dt];if(typeof a=="function"){let d=a();if(typeof d=="boolean"&&!d)return}let c=s.attributes[ie];c&&typeof c=="object"&&Object.assign(l,c);let m=Object.keys(l);if(!m.length){b.warn(["请先配置键",s]);return}m.forEach(d=>{let u=l[d];t.$data.data.has(d)&&b.warn("请检查该key(已存在): "+d),t.$data.data.set(d,u);});}function n(s){for(let l=0;l<s.length;l++){let o=s[l];e(o);let a=o.forms;a&&Array.isArray(a)&&n(a);}}let i=this.getPanelContentConfig();for(let s=0;s<i.length;s++){let l=i[s];if(!l.forms)continue;let o=l.forms;o&&Array.isArray(o)&&n(o);}},setValue(t,e){let n=Y(rt,{}),i=n[t];n[t]=e,W(rt,n),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,i,e);},getValue(t,e){let i=Y(rt,{})[t];return i??(this.$data.data.has(t)?this.$data.data.get(t):e)},deleteValue(t){let e=Y(rt,{}),n=e[t];Reflect.deleteProperty(e,t),W(rt,e),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,n,void 0);},addValueChangeListener(t,e,n){let i=Math.random();return this.$listener.listenData.set(t,{id:i,key:t,callback:e}),n&&n.immediate&&e(t,this.getValue(t),this.getValue(t)),i},removeValueChangeListener(t){let e=null;for(const[n,i]of this.$listener.listenData.entries())if(i.id===t){e=n;break}typeof e=="string"?this.$listener.listenData.delete(e):console.warn("没有找到对应的监听器");},triggerMenuValueChange(t,e,n){if(this.$listener.listenData.has(t)){let i=this.$listener.listenData.get(t);if(typeof i.callback=="function"){let s=this.getValue(t),l=s,o=s;typeof e<"u"&&arguments.length>1&&(l=e),typeof n<"u"&&arguments.length>2&&(o=n),i.callback(t,o,l);}}},hasKey(t){let e=Y(rt,{});return t in e},execMenu(t,e,n=!1,i){if(!(typeof t=="string"||typeof t=="object"&&Array.isArray(t)))throw new TypeError("key 必须是字符串或者字符串数组");let s=[];typeof t=="object"&&Array.isArray(t)?s=[...t]:s.push(t);let l;for(let o=0;o<s.length;o++){const a=s[o];if(!this.$data.data.has(a)){b.warn(`${t} 键不存在`);return}let c=q.getValue(a);if(n&&(c=!c),typeof i=="function"){let m=i(a,c);typeof m=="boolean"&&(c=m);}if(!c)break;l=c;}l&&e(l);},execMenuOnce(t,e,n,i,s){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){b.warn(`${t} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(t))return;this.$data.oneSuccessExecMenu.set(t,1);let l=()=>{let u=q.getValue(t);return typeof n=="function"?n(t,u):u},o=[],a=u=>{let f=l(),p=[];if(u instanceof HTMLStyleElement?p=[u]:Array.isArray(u)&&(p=[...u.filter(h=>h!=null&&h instanceof HTMLStyleElement)]),f)o=o.concat(p);else for(let h=0;h<p.length;h++)p[h].remove(),p.splice(h,1),h--;},c=u=>typeof s=="function"?s(t,u):u,m=u=>{let f=[];if(c(u)){let p=e(u,a);p instanceof HTMLStyleElement?f=[p]:Array.isArray(p)&&(f=[...p.filter(h=>h!=null&&h instanceof HTMLStyleElement)]);}for(let p=0;p<o.length;p++)o[p].remove(),o.splice(p,1),p--;o=[...f];};this.addValueChangeListener(t,(u,f,p)=>{let h=p;typeof i=="function"&&(h=i(u,p,f)),m(h);});let d=l();d&&m(d);},execInheritMenuOnce(t,e,n,i){let s=this;const l=(o,a)=>{let c=s.getValue(o),m=s.getValue(a);if(typeof i=="function"){let d=i(c,m);if(d!=null)return d}return c};this.execMenuOnce(t,n,()=>l(t,e),()=>l(t,e)),this.execMenuOnce(e,()=>{},()=>!1,()=>(this.triggerMenuValueChange(t),!1));},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(t)||(e(),this.$data.onceExec.set(t,1));},showPanel(){B.panel({title:{text:`${kt}-设置`,position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},width:Mt.setting.width,height:Mt.setting.height,drag:!0,only:!0});},isMobile(){return window.innerWidth<550},getWidth(){return window.innerWidth<550?"88vw":"550px"},getHeight(){return window.innerHeight>450?"450px":"88vh"},getPanelContentConfig(){return [ne,ce,me,de,pe,ue]}},he=`.pops-confirm-content {\r
	display: flex;\r
	flex-direction: column;\r
}\r
...
`,ge={$data:{cid:""},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"小黑屋",iconColor:"#000000",icon:"",callback:()=>{this.showBlackHome();}});},async showBlackHome(){let t=x.loading("正在获取小黑屋名单中..."),e=await this.getBlackListInfo("");if(t.close(),!e)return;if(e.data.length===0){x.error("获取小黑屋名单为空");return}this.$data.cid=e.next_cid;let n=B.confirm({title:{text:"小黑屋名单",position:"center"},content:{text:`
                ...
                `,html:!0},btn:{ok:{text:"下一页",callback:async()=>{let a=x.loading("正在获取小黑屋名单中...");b.info("下一页的cid: ",this.$data.cid);let c=await this.getBlackListInfo(this.$data.cid);a.close(),c&&(this.$data.cid=c.next_cid,c.data.forEach(m=>{let d=this.createListViewItem(m);i.appendChild(d);}),c.data.length===0?x.error("获取小黑屋名单为空"):x.success(`成功获取 ${c.data.length}条数据`));}},cancel:{text:"关闭"}},width:"88vw",height:"82vh",style:he,mask:{enable:!0}}),i=n.$shadowRoot.querySelector(".blackhome-user-list"),s=n.$shadowRoot.querySelector(".blackhome-user-filter input");e.data.forEach(a=>{let c=this.createListViewItem(a);i.appendChild(c);}),x.success(`成功获取 ${e.data.length}条数据`);let l=!1;r.on(s,["input","propertychange"],g.debounce(()=>{let a=s.value.trim();if(!l){if(l=!0,a==""){n.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.removeAttribute("style");}),l=!1;return}n.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.getAttribute("data-name").match(new RegExp(a,"ig"))||c.getAttribute("data-uid").trim().match(new RegExp(a,"ig"))||c.getAttribute("data-operator").match(new RegExp(a,"ig"))?c.removeAttribute("style"):c.setAttribute("style","display:none;");}),l=!1;}}));let o=await this.getBlackListInfo(this.$data.cid);o&&(this.$data.cid=o.next_cid);},async getBlackListInfo(t=""){let e={mod:"misc",action:"showdarkroom",cid:t,ajaxdata:"json"},n=await V.get(`/forum.php?${g.toSearchParamsStr(e)}`,{headers:{"User-Agent":g.getRandomPCUA()},responseType:"json"});if(!n.status)return;let i=g.toJSON(n.data.responseText),s=i.message.split("|"),l=s[s.length-1],o=g.parseObjectToArray(i.data),a=[],c=[];return o.forEach(m=>{let d=m.dateline.match(/([0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]*[0-9]{1,2}:[0-9]{1,2})/g);if(d==null){let u=parseInt((Date.now()/1e3).toString()),f=0,p=m.dateline.match(/([0-9]+|半)[\s\S]*秒前/),h=m.dateline.match(/([0-9]+|半)[\s\S]*分钟前/),_=m.dateline.match(/([0-9]+|半)[\s\S]*小时前/),k=m.dateline.match(/昨天[\s\S]*(\d{2}):(\d{2})/),v=m.dateline.match(/前天[\s\S]*(\d{2}):(\d{2})/),S=m.dateline.match(/([0-9]+|半)[\s\S]*天前/);if(p)p=p[p.length-1],p=p.replace(/半/g,.5),p=parseFloat(p),f=u-p;else if(h)h=h[h.length-1],h=h.replace(/半/g,.5),h=parseFloat(h),f=u-h*60;else if(_)_=_[_.length-1],_=_.replace(/半/g,.5),_=parseFloat(_),f=u-_*60*60;else if(k){let R=k[1],C=k[2];f=u-86400-parseInt(R)*3600-parseInt(C)*60;}else if(v){let R=v[1],C=v[2];f=u-86400*2-parseInt(R)*3600-parseInt(C)*60;}else S&&(S=S[S.length-1],S=S.replace(/半/g,.5),S=parseFloat(S),f=u-S*60*60*24);m.time=parseInt(f.toString())*1e3,a=a.concat(m);return}else d=d[0];m.time=g.formatToTimeStamp(d),a=a.concat(m);}),g.sortListByProperty(a,"time"),g.sortListByProperty(c,"time",!1),a=a.concat(c),{next_cid:l,data:a}},createListViewItem(t){let e=r.createElement("div",{className:"blackhome-user-item",innerHTML:`
                <div class="blackhome-user-avatar">
                    <div class="blackhome-user">
                    <img src="${U.getAvatar(t.uid,"big")}" loading="lazy">
                    ...
                    <div class="blackhome-operator-user">
                        <img loading="lazy" src="${U.getAvatar(t.operatorid,"big")}">
                        <p>${t.operator}</p>
                    </div>
...
`,be={$data:{},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"在线用户",iconColor:"#2d92ff",icon:"",callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let t=x.loading("正在获取在线用户名单中..."),e=await this.getOnlineUserListInfo();if(t.close(),!e)return;let n=B.alert({title:{text:"在线用户",position:"center"},content:{text:`
        ...
        }`)},removeFontStyle(){b.info("移除帖子字体效果");let t=I(".comiis_a.comiis_message_table");t&&r.html(t,r.html(t).replace(X.fontSpecial,""));},removeCommentFontStyle(){var n;b.info("移除评论区的字体效果");let t=document.querySelectorAll("font"),e=((n=document.querySelector(".comiis_postlist .comiis_postli"))==null?void 0:n.innerHTML)||"";e!==""&&(t.forEach(i=>{e.includes(i.innerHTML)||(i.removeAttribute("color"),i.removeAttribute("style"),i.removeAttribute("size"));}),H(".comiis_message.message").forEach(i=>{if(e.includes(i.innerHTML)){i.innerHTML=i.innerHTML.replace(X.fontSpecial,"");let s=i.nextElementSibling;s&&s.localName==="strike"&&(s.outerHTML=s.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));}})),H(".comiis_postli.comiis_list_readimgs.nfqsqi").forEach(i=>{let s=i.parentElement;s&&s.localName==="strike"&&(s.outerHTML=s.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));});},addCommentOnBtn(){b.info("添加【点评】按钮"),g.waitNodeList(".bottom_zhan:not([data-isaddreviews])").then(t=>{t.forEach(e=>{var u,f,p;e.setAttribute("data-isaddreviews","true");var n=e.querySelector("a");if(n){var i=n.getAttribute("datahref")||n.getAttribute("data-href")||n.href||"",s=i.replace("mod=post&","mod=misc&").replace("action=reply&","action=comment&"),l=(u=i==null?void 0:i.match(/&page=([\w]+)/i))==null?void 0:u[1],o=`${s}&extra=page%3D1&page=${l}`,a=e==null?void 0:e.closest(".comiis_postli[id]"),c=(f=a.getAttribute("id"))==null?void 0:f.replace("pid","&pid=");o=o+c;var m=((p=a.querySelector(".top_user.f_b"))==null?void 0:p.textContent)||"",d=r.parseHTML(`
		...
		<div class="comiis_multi_box bg_f b_t">
			...
			`),r.on(document,"click",".reader-copy-button",async function(n){g.preventEvent(n);let i=n.target,s=document.querySelector(i.getAttribute("data-code-selector"));return await g.setClip(s.outerText||s.innerText),x.success("已复制到剪贴板"),!1})),document.querySelectorAll(".comiis_blockcode.comiis_bodybg").forEach(n=>{if(n.getAttribute("data-copy"))return;n.setAttribute("data-copy","true");let i=r.createElement("div",{innerHTML:`
        ...
        `),Z.ready(()=>{q.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),q.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),q.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){b.info("显示搜索历史");let t=Y("search_history",[]),e=I("#scform_srchtxt"),n=I("#searchform"),i=B.searchSuggestion({target:e,inputTarget:e,data:t,getItemHTML:function(o){return o},getData(o){return t.filter(a=>a.includes(o))},deleteIcon:{enable:!0,callback(o,a,c){let m=t.findIndex(d=>d===c);m!==-1&&(t.splice(m,1),W("search_history",t)),a.remove();}},itemClickCallBack(o,a,c){e.value=c,n.submit();}});i.init(),i.setAllEvent();function s(){let o=document.querySelector("#scform_submit");Z.on(o,"click",function(){let a=e.value;if(a!=""){let c=Y("search_history",[]);c.includes(a)?b.info("已有该搜索历史记录"):(b.info("无该记录，追加"),c.push(a)),W("search_history",c);}});}function l(){let a='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+Y("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    ...
                    min-width: 20vw;
                    width: 20vw;
                ">清理记录</button></div>`;Z.before(document.querySelector(".comiis_p12"),a);let c=document.querySelector(".btn_clear_search_history");Z.on(c,"click",m=>{g.preventEvent(m),at("search_history"),window.location.reload();});}s(),l();},repairClearBtn(){g.waitNode("a.ssclose").then(t=>{b.info("修复清空按钮"),Z.on(t,"click",e=>{let n=document.querySelector("#scform_srchtxt");n?n.value="":x.error("获取输入框失败");},{capture:!0});});},searchInputAutoFocus(){new URLSearchParams(window.location.search).has("kw")||g.waitNode("#scform_srchtxt").then(e=>{b.info("搜索框自动获取焦点"),e.focus();});}},xe={init(){r.ready(()=>{q.execMenuOnce("mt-sign-showTodaySignStar",()=>{this.showTodaySignStar();}),q.execMenuOnce("mt-sign-showTodayRanking",()=>{this.showTodayRanking();});});},async showTodaySignStar(){b.info("显示【今日签到之星】");let t=document.querySelector(".pg_k_misign .comiis_qdinfo"),e=document.createElement("ul"),n=await V.get("/k_misign-sign.html",{headers:{"User-Agent":g.getRandomPCUA()}});if(!n.status)return;let s=r.parseHTML(n.data.responseText,!0,!0).querySelector("#pt span.xg1");if(!s)return;let l=r.text(s).replace("今日签到之星：","");e.innerHTML=`
		...
		.pg_k_misign .comiis_qdinfo{
			height: 110px !important;
		}`),t.append(e);},showTodayRanking(){b.info("显示【今日最先】");let t=document.querySelector(".comiis_topnv .comiis_flex .flex"),e=r.createElement("li",{className:"flex"}),n=r.createElement("a",{id:"k_misignlist_today_latest",href:"javascript:;",innerHTML:"今日最先"},{onclick:"ajaxlist('todayLatest');"});e.appendChild(n),r.after(t,e);let i=async o=>{let a=await V.get(`/k_misign-sign.html?operation=${o}`,{responseType:"html",headers:{"User-Agent":g.getRandomPCUA()}});if(!a.status)return;let m=r.parseHTML(a.data.responseText,!0,!0).querySelector("#J_list_detail .pg span");if(m&&typeof m.title<"u"){let d=m.title.match(/([0-9]+)/);if(d&&d.length==2)return parseInt(d[d.length-1]);x.error("获取页失败");}else x.error("请求最先签到的页失败");},s=async o=>{let a=await V.get(`/k_misign-sign.html?operation=list&op=&page=${o}`,{responseType:"html",headers:{"User-Agent":g.getRandomPCUA()}});if(!a.status)return;let m=r.parseHTML(a.data.responseText,!0,!0).querySelectorAll("#J_list_detail tbody tr"),d=[];if(m.length==2&&m[0].textContent.indexOf("暂无内容")!=-1)return d;for(let u=1;u<=m.length-2;u++){let f=m[u],p={user:"",uid:"",avatar:"",days:"",monthDays:"",time:"",reward:""},h=f.children[0].getElementsByTagName("a")[0].textContent,k=f.children[0].getElementsByTagName("a")[0].href.match(/space-uid-([0-9]*)/)[1],v=f.children[1].textContent,S=f.children[2].textContent,R=f.children[3].textContent,C=f.children[5].textContent;p.user=h,p.uid=k,p.avatar=U.getAvatar(k,"small"),p.days=v,p.monthDays=S,p.time=R,p.reward=C,d.push(p);}return d};function l(o,a){let c=document.querySelector("#ranklist");r.html(c,o),r.attr(c,"listtype",a);}y.ajaxlist=async o=>{if(o=o,o=="today"?(loadingdelay=!1,urlextra="list&op=today"):o=="month"?(loadingdelay=!1,urlextra="list&op=month"):o=="zong"?(loadingdelay=!1,urlextra="list&op=zong"):o=="calendar"?(loadingdelay=!0,urlextra="calendar"):(loadingdelay=!1,urlextra="list"),o=="todayLatest"){loadingdelay=!1,urlextra="list&op=&page=0";let a=await i(urlextra);if(!a)return;let c=await s(a);if(c.reverse(),c.length<10){let u=await s(a-1);u.reverse(),c=c.concat(u),c.reverse();}let m="";c.reverse(),c.forEach(u=>{m=m+`
					...
					</div>`;l(d,o);}else V.get(`plugin.php?id=k_misign:sign&operation=${urlextra}`,{responseType:"html",fetch:!0}).then(a=>{let c=a.data.responseText;c=c.replace("今日排行</a></li>",`今日排行</a></li>
							<li class="flex">
		...
		`);async function t(){let o=await V.get(window.location.href,{headers:{"User-Agent":g.getRandomPCUA()}});if(!o.status)return;let a=r.parseHTML(o.data.responseText,!0,!0),c=[];return a.querySelectorAll("#delform tr.bw0_all+tr").forEach(m=>{let d=[],u=m.querySelector("td"),f=r.html(u).replace(/^&nbsp;/,"");d.push(f);let p=r.next(m),h=a.querySelectorAll("#delform tr");for(let _=0;_<h.length&&!(!p||r.attr(p,"class")==="bw0_all");_++){let k=p.querySelector("td"),v=r.html(k).replace(/^&nbsp;/,"");d=d.concat(v),p=r.next(p);}c.push(...d);}),c}function e(){return g.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist())}function n(o){let a={};return o.forEach(c=>{var _;let d=(_=r.createElement("div",{innerHTML:c}).querySelector("a"))==null?void 0:_.getAttribute("href"),u=d.match(X.ptid),f=d.match(X.pid);if(!u){x.error("获取ptid失败");return}if(!f){x.error("获取pid失败");return}let p=u[u.length-1],h=f[f.length-1];a[p]?a[p].data.push(c):a[p]={ptid:p,pid:h,data:[c]};}),a}var i=await t();if(i==null)return;var s=n(i);e().forEach((o,a)=>{let m=o.querySelector(".comiis_xznalist_bottom a").getAttribute("tid");if(!m){x.error("获取帖子tid失败"),b.error(o);return}s[m]&&s[m].data.forEach(d=>{r.append(o,`<div class="contrete-reply">${d}</div>`);});});}},dt={$key:{tipData:"tipToFreeSubjectForumPost"},init(){this.registerMenu();let t=this.getTipData();if(M.isPost()&&document.querySelector("span.kmren")){b.info("当前帖子存在需要购买主题");let l=!1,o;t.forEach((c,m)=>{if(window.location.href.match(c.url)){l=!0;return}}),l?(b.warn("已设置提醒"),o=r.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                ...
                <span class="sidenv_num bg_del f_f" style="
                    ...
                    display: inline-flex;
                    bottom: 8px;
                "></span>`);},registerMenu(){j.registerLeftMenu({name:"付费主题白嫖提醒",icon:"",iconColor:"#ec0000",callback:()=>{this.showView();}});},showView(){b.info("显示白嫖列表");let t=dt.getTipData();B.alert({title:{text:"付费主题白嫖列表",position:"center"},content:{text:"",html:!0},btn:{ok:{text:"关闭",type:"default"}},mask:{enable:!0},width:"88vw",height:"88vh"});let e="",n=0,i="",s="",l=[],o=[],a=[];t.forEach((p,h)=>{let _="#f91212",k="";new Date().getTime()>p.expirationTimeStamp&&(_="#1e90ff",p.isVisited||(k=`
                ...
                </tbody>`,timestamp:p.expirationTimeStamp};new Date().getTime()>p.expirationTimeStamp?k!=""?l.push(v):o.push(v):a.push(v);}),b.info("可白嫖但未访问：",l),b.info("可白嫖：",o),b.info("未到白嫖时间：",a),g.sortListByProperty(l,"expirationTimeStamp",!1),g.sortListByProperty(o,"timestamp",!1),g.sortListByProperty(a,"timestamp",!1),b.info("排序后——可白嫖但未访问：",l),b.info("排序后——可白嫖：",o),b.info("排序后——未到白嫖时间：",a),i=g.mergeArrayToString(l,"content")+g.mergeArrayToString(o,"content"),s=g.mergeArrayToString(a,"content"),n>0&&(e=`
...
`;class qe{constructor(e){nt(this,"isBacking",!1);nt(this,"config");this.config=e,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(e){g.preventEvent(e),!this.isBacking&&this.quitGestureBackMode(!0);}enterGestureBackMode(){b.success("进入手势模式");let e=this.config.hash;e.startsWith("#")||(e.startsWith("/")||(e="/"+e),e="#"+e),this.config.useUrl&&(e=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+e),this.config.win.history.pushState({},"",e),b.success("监听popstate事件"),r.on(this.config.win,"popstate",this.popStateEvent,{capture:!0});}async quitGestureBackMode(e=!1){this.isBacking=!0,b.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(e);let n=Date.now()+1e3*5;for(;;){if(Date.now()>n){b.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))b.info("history.back()"),this.config.win.history.back(),await g.sleep(this.config.backDelayTime||150);else break}b.success("移除popstate事件"),r.off(this.config.win,"popstate",this.popStateEvent,{capture:!0}),this.isBacking=!1,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(e);}}const ct={https:`
        ...
        <div class="small-window-title-container">
            ...
            `);var n="";g.sortListByProperty(e,s=>{var l=s.href.match(/thread-(.+?)-/i);return parseInt(l[l.length-1])},!0),b.info("导读内容",e),e.forEach(s=>{n+=`
                <li>
                    <span>新帖</span>
                    ...
                    `,html:!0},btn:g.assign({ok:{callback:async()=>{await l();}}},this.option.btn||{},!0),mask:{enable:!0},style:`
            ...
            `,width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh"}),n=e.$shadowRoot.querySelector(".rule-form-container");e.$shadowRoot.querySelector("input[type=submit]");let i=e.$shadowRoot.querySelector(".rule-form-ulist"),s=await this.option.getView(await this.option.data());i.appendChild(s);const l=async()=>{(await this.option.onsubmit(n,await this.option.data())).success&&(e.close(),await this.option.dialogCloseCallBack(!0));};}}class ke{constructor(e){nt(this,"option");this.option=e;}showView(){let e=B.alert({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `}),n=e.$shadowRoot.querySelector(".filter-container"),i=document.createDocumentFragment();this.option.filterOption.forEach(s=>{let l=document.createElement("button");l.innerText=s.name;let o=async()=>{(await this.option.getAllRuleInfo()).forEach(async c=>{await s.filterCallBack(c.data)?r.show(c.$el,!1):r.hide(c.$el,!1);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};r.on(l,"click",async a=>{g.preventEvent(a),!(typeof s.callback=="function"&&!await s.callback(a,o))&&await o();}),i.appendChild(l);}),n.appendChild(i);}}class qt{constructor(e){nt(this,"option");this.option=e;}async showView(){var i,s,l,o,a,c,m,d,u;let e=B.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    <div class="rule-view-container">
                    </div>
                    `,html:!0},btn:{merge:!0,reverse:!1,position:"space-between",ok:{enable:((l=(s=(i=this.option)==null?void 0:i.bottomControls)==null?void 0:s.add)==null?void 0:l.enable)||!0,type:"primary",text:"添加",callback:async f=>{this.showEditView(e.$shadowRoot,!1,await this.option.getAddData());}},close:{enable:!0,callback(f){e.close();}},cancel:{enable:((c=(a=(o=this.option)==null?void 0:o.bottomControls)==null?void 0:a.filter)==null?void 0:c.enable)||!1,type:"default",text:"过滤",callback:(f,p)=>{var k,v,S,R,C,D,L;typeof((S=(v=(k=this.option)==null?void 0:k.bottomControls)==null?void 0:v.filter)==null?void 0:S.callback)=="function"&&this.option.bottomControls.filter.callback();let h=()=>Array.from(e.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),_=p.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");r.text(_).includes("取消")?(h().forEach(E=>{r.show(E,!1);}),r.text(_,"过滤")):new ke({title:((C=(R=this.option.bottomControls)==null?void 0:R.filter)==null?void 0:C.title)??"过滤规则",filterOption:((L=(D=this.option.bottomControls)==null?void 0:D.filter)==null?void 0:L.option)||[],execFilterCallBack(){r.text(_,"取消过滤");},getAllRuleInfo:()=>h().map(O=>({data:this.parseRuleItemElement(O).data,$el:O}))}).showView();}},other:{enable:((u=(d=(m=this.option)==null?void 0:m.bottomControls)==null?void 0:d.clear)==null?void 0:u.enable)||!0,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:f=>{let p=B.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:!1},btn:{ok:{enable:!0,callback:async h=>{var k,v,S;if(b.success("清空所有"),typeof((S=(v=(k=this.option)==null?void 0:k.bottomControls)==null?void 0:v.clear)==null?void 0:S.callback)=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){x.error("清理失败");return}else x.success("清理成功");await this.updateDeleteAllBtnText(e.$shadowRoot),this.clearContent(e.$shadowRoot),p.close();}},cancel:{text:"取消",enable:!0}},mask:{enable:!0},width:"300px",height:"200px"});}}},mask:{enable:!0},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${B.config.cssText.panelCSS}
            ...
            `}),n=await this.option.data();for(let f=0;f<n.length;f++)await this.appendRuleItemElement(e.$shadowRoot,n[f]);}parseViewElement(e){let n=e.querySelector(".rule-view-container"),i=e.querySelector(".pops-confirm-btn button.pops-confirm-btn-other");return {$container:n,$deleteBtn:i}}parseRuleItemElement(e){let n=e.querySelector(".rule-controls-enable"),i=n.querySelector(".pops-panel-switch"),s=n.querySelector(".pops-panel-switch__input"),l=n.querySelector(".pops-panel-switch__core"),o=e.querySelector(".rule-controls-edit"),a=e.querySelector(".rule-controls-delete");return {$enable:n,$enableSwitch:i,$enableSwitchInput:s,$enableSwitchCore:l,$edit:o,$delete:a,data:Reflect.get(e,"data-rule")}}async createRuleItemElement(e,n){let i=await this.option.getDataItemName(e),s=r.createElement("div",{className:"rule-item",innerHTML:`
			...
			`});Reflect.set(s,"data-rule",e);let l="pops-panel-switch-is-checked";const{$enable:o,$enableSwitch:a,$enableSwitchCore:c,$enableSwitchInput:m,$delete:d,$edit:u}=this.parseRuleItemElement(s);return this.option.itemControls.enable.enable?(r.on(c,"click",async f=>{let p=!1;a.classList.contains(l)?(a.classList.remove(l),p=!1):(a.classList.add(l),p=!0),m.checked=p,await this.option.itemControls.enable.callback(e,p);}),await this.option.itemControls.enable.getEnable(e)&&a.classList.add(l)):o.remove(),this.option.itemControls.edit.enable?r.on(u,"click",f=>{g.preventEvent(f),this.showEditView(n,!0,e,s,p=>{e=null,e=p;});}):u.remove(),this.option.itemControls.delete.enable?r.on(d,"click",f=>{g.preventEvent(f);let p=B.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:!1},btn:{ok:{enable:!0,callback:async h=>{b.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(e)?(x.success("成功删除该数据"),s.remove(),await this.updateDeleteAllBtnText(n),p.close()):x.error("删除该数据失败");}},cancel:{text:"取消",enable:!0}},mask:{enable:!0},width:"300px",height:"200px"});}):d.remove(),s}async appendRuleItemElement(e,n){const{$container:i}=this.parseViewElement(e);if(Array.isArray(n))for(let s=0;s<n.length;s++){const l=n[s];i.appendChild(await this.createRuleItemElement(l,e));}else i.appendChild(await this.createRuleItemElement(n,e));await this.updateDeleteAllBtnText(e);}async updateRuleContaienrElement(e){this.clearContent(e),this.parseViewElement(e);let n=await this.option.data();await this.appendRuleItemElement(e,n),await this.updateDeleteAllBtnText(e);}async updateRuleItemElement(e,n,i){let s=await this.createRuleItemElement(e,i);n.after(s),n.remove();}clearContent(e){const{$container:n}=this.parseViewElement(e);r.html(n,"");}setDeleteBtnText(e,n,i=!1){const{$deleteBtn:s}=this.parseViewElement(e);i?r.html(s,n):r.text(s,n);}async updateDeleteAllBtnText(e){let n=await this.option.data();this.setDeleteBtnText(e,`清空所有(${n.length})`);}showEditView(e,n,i,s,l){let o=async c=>{if(!c){if(n||await this.option.deleteData(i),typeof l=="function"){let m=await this.option.getData(i);l(m);}}};new Ht({title:n?"编辑":"添加",data:()=>i,dialogCloseCallBack:o,getView:async c=>await this.option.itemControls.edit.getView(c,n),btn:{ok:{enable:!0,text:n?"修改":"添加"},cancel:{callback:async(c,m)=>{c.close(),await o(!1);}},close:{callback:async(c,m)=>{c.close(),await o(!1);}}},onsubmit:async(c,m)=>{let d=await this.option.itemControls.edit.onsubmit(c,n,m);return d.success?n?(x.success("修改成功"),await this.updateRuleItemElement(d.data,s,e)):await this.appendRuleItemElement(e,d.data):n&&x.error("修改失败"),d},style:this.option.itemControls.edit.style}).showView();}}const Se={$key:{STORAGE_KEY:"mt-own-block-rule"},$data:{isRegister:!1},init(){this.registerMenu();let t=new g.LockFunction(()=>{this.runRule();});g.mutationObserver(document,{config:{subtree:!0,childList:!0},callback:()=>{t.run();}});},registerMenu(){this.$data.isRegister||(this.$data.isRegister=!0,j.registerLeftMenu({name:"我的屏蔽",icon:"",iconColor:"#000",callback:()=>{this.showView();}}));},getTemplateData(){return {uuid:g.generateUUID(),enable:!0,name:"",data:{userName:"",userUID:"",userLevel:"",postUrl:"",postTitle:"",postContent:"",postPlateName:""}}},showView(){let t=B.config.panelHandleContentUtils();function e(i){return {get(s,l){return i[s]??l},set(s,l){i[s]=l;}}}new qt({title:"我的屏蔽",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:i=>i.name,updateData:i=>this.updateData(i),deleteData:i=>this.deleteData(i),getData:i=>this.getData().find(o=>o.uuid===i.uuid)??i,itemControls:{enable:{enable:!0,getEnable(i){return i.enable},callback:(i,s)=>{i.enable=s,this.updateData(i);}},edit:{enable:!0,getView:(i,s)=>{let l=document.createDocumentFragment();s||(i=this.getTemplateData());let o=A("启用","enable",!0);Reflect.set(o.props,P,e(i));let a=t.createSectionContainerItem_switch(o),c=F("规则名称","name","","",void 0,"必填");Reflect.set(c.props,P,e(i));let m=t.createSectionContainerItem_input(c),d=F("用户名","userName","","",void 0,"可正则");Reflect.set(d.props,P,e(i.data));let u=t.createSectionContainerItem_input(d),f=F("用户UID","userUID","","",void 0,"可正则");Reflect.set(f.props,P,e(i.data));let p=t.createSectionContainerItem_input(f),h=F("用户等级","userLevel","","",void 0,"可正则");Reflect.set(h.props,P,e(i.data));let _=t.createSectionContainerItem_input(h),k=F("帖子url","postUrl","","",void 0,"可正则");Reflect.set(k.props,P,e(i.data));let v=t.createSectionContainerItem_input(k),S=F("帖子标题","postTitle","","",void 0,"可正则");Reflect.set(S.props,P,e(i.data));let R=t.createSectionContainerItem_input(S),C=F("帖子内容","postContent","","",void 0,"可正则");Reflect.set(C.props,P,e(i.data));let D=t.createSectionContainerItem_input(C),L=F("帖子所在的板块名","postPlateName","","",void 0,"可正则");Reflect.set(L.props,P,e(i.data));let E=t.createSectionContainerItem_input(L);return l.appendChild(a),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(_),l.appendChild(v),l.appendChild(R),l.appendChild(D),l.appendChild(E),l},onsubmit:(i,s,l)=>{let o=i.querySelectorAll(".rule-form-ulist > li"),a=this.getTemplateData();return s&&(a.uuid=l.uuid),o.forEach(c=>{let m=Reflect.get(c,"__formConfig__"),d=Reflect.get(m,"attributes"),u=Reflect.get(c,P),f=Reflect.get(d,et),p=Reflect.get(d,it),h=u.get(f,p);Reflect.has(a,f)?Reflect.set(a,f,h):Reflect.has(a.data,f)?Reflect.set(a.data,f,h):b.error(`${f}不在数据中`);}),a.name.trim()===""?(x.error("规则名称不能为空"),{success:!1,data:a}):s?{success:this.updateData(a),data:a}:{success:this.addData(a),data:a}}},delete:{enable:!0,deleteCallBack:i=>this.deleteData(i)}}}).showView();},runRule(){let t=this.getData();function e(n){for(const i of t){let s=i.data;if(Object.keys(s).find(o=>{let a=s[o];if(g.isNotNull(a)){let c=new RegExp(a,"i"),m=Reflect.get(n,o);if(typeof m=="string"&&g.isNotNull(m)&&m.match(c))return b.info("屏蔽",[s,m]),!0}return !1}))return !0}return !1}(M.isGuide()||M.isPlate()||M.isPost())&&(this.getData(),document.querySelectorAll(".comiis_forumlist .forumlist_li").forEach(n=>{var o;let i=n.querySelector("a.top_user"),s=i.href.match(X.uid),l={userName:i.innerText,userUID:s[s.length-1].trim(),userLevel:n.querySelector("span.top_lev").innerText.replace("Lv.",""),postUrl:n.querySelector(".mmlist_li_box a").getAttribute("href")||n.querySelector(".mmlist_li_box a").getAttribute("data-href"),postTitle:((o=n.querySelector(".mmlist_li_box h2 a"))==null?void 0:o.innerText)||"",postContent:n.querySelector(".mmlist_li_box .list_body").innerText,postPlateName:(n.querySelector(".forumlist_li_time a.f_d")||n.querySelector(".comiis_xznalist_bk.cl")).innerText.replace(//g,"").replace(/\s*/g,"").replace(/来自/g,"")};g.isNull(l.postPlateName)&&(l.postPlateName=document.querySelector("#comiis_wx_title_box").innerText),e(l)&&n.remove();}),document.querySelectorAll(".comiis_postlist .comiis_postli").forEach(n=>{let i=n.querySelector("a.top_user"),s=i.href.match(X.uid),l={userName:i.innerText,userUID:s[s.length-1].trim(),userLevel:n.querySelector("a.top_lev").innerText.replace("Lv.",""),postUrl:void 0,postTitle:void 0,postContent:n.querySelector(".comiis_message_table").innerText,postPlateName:void 0};e(l)&&n.remove();})),M.isMessageList()&&(this.getData(),H(".comiis_pms_box .comiis_pmlist ul li").forEach(n=>{let i=n.querySelector("a.b_b").href.match(X.uid),s={userName:n.querySelector("h2").innerText.replace(n.querySelector("h2 span").innerText,"").replace(/\s*/,""),userUID:i[i.length-1].trim(),userLevel:void 0,postUrl:n.querySelector("a.b_b").href,postTitle:void 0,postContent:n.querySelector("p.f_c").innerText.trim(),postPlateName:void 0};e(s)&&n.remove();}));},getData(){return Y(this.$key.STORAGE_KEY,[])},setData(t){W(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(i=>i.uuid==t.uuid)===-1?(e.push(t),W(this.$key.STORAGE_KEY,e),!0):!1},updateData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=!1;return n!==-1&&(i=!0,e[n]=t),this.setData(e),i},deleteData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=!1;return n!==-1&&(i=!0,e.splice(n,1)),this.setData(e),i},clearData(){at(this.$key.STORAGE_KEY);}},Te={$el:{isFilterElementHTML:[]},$key:{STORAGE_KEY:"mt-post-comment-filter-rule"},init(){if(this.registerMenu(),M.isPost()){let t=this.getData();if(!t.enable)return;let e=new g.LockFunction(()=>{this.runFilter(t);});g.mutationObserver(document,{config:{subtree:!0,childList:!0},callback:()=>{e.run();}});}},registerMenu(){j.registerLeftMenu({name:"评论过滤器",icon:"",iconColor:"#ff0019",callback:()=>{this.showView();}});},runFilter(t){let e=function(i){for(const s of t.userBlackList)if(s==i.userName||s==i.userUID)return b.success("评论过滤器：黑名单用户",i),!0;return !1},n=function(i){for(const s of t.userWhiteList)if(s===i.userName||s===i.userUID)return b.success("评论过滤器：白名单用户",i),!0;return !1};H(".comiis_postlist .comiis_postli").forEach(i=>{var a,c,m;if(i.querySelector("#comiis_allreplies"))return;let s=i.querySelector("a.top_user"),l=s.href.match(X.uid),o={userName:(s==null?void 0:s.innerText)||"",userUID:l&&((a=l[(l==null?void 0:l.length)-1])==null?void 0:a.trim())||"",content:((m=(c=i.querySelector(".comiis_message_table"))==null?void 0:c.innerText)==null?void 0:m.trim())||"",isAuthor:!!i.querySelector("span.top_lev")};if(!n(o)){if(t.replyFlag&&i.querySelector(".comiis_quote")){let d=i.querySelector(".comiis_quote");this.$el.isFilterElementHTML.push(d.outerHTML),d.remove();}if(!(o.isAuthor&&!t.avatarFlag)){if(e(o)){this.$el.isFilterElementHTML.push(i.outerHTML),i.remove();return}if(!(typeof t.minLength=="number"&&t.minLength>o.content.length)&&!(typeof t.keywordLength=="number"&&t.keywordLength<o.content.length))for(const d of t.keywords){if(typeof d!="string")continue;let u=new RegExp(d);if(o.content.match(u)){console.log("评论过滤器：",o),this.$el.isFilterElementHTML.push(i.outerHTML),i.remove();return}}}}});},showView(){const t=this;function e(s){return {get(l,o){let a=t.getData(),c=Reflect.get(a,l,o);return (l==="keywords"||l==="userWhiteList"||l==="userBlackList")&&(c=c.join(`
`)),c},set(l,o){(l==="keywords"||l==="userWhiteList"||l==="userBlackList")&&(o=o.split(`
`).filter(a=>a.trim()!="")),Reflect.set(s,l,o),t.setData(s);}}}let n=B.config.panelHandleContentUtils();new Ht({title:"评论过滤器",data:()=>this.getData(),getView:s=>{let l=document.createDocumentFragment(),o=A("启用","enable",!0);Reflect.set(o.props,P,e(s));let a=n.createSectionContainerItem_switch(o),c=A("处理回复引用","replyFlag",!1,void 0,"移除引用");Reflect.set(c.props,P,e(s));let m=n.createSectionContainerItem_switch(c),d=A("处理作者评论","avatarFlag",!1);Reflect.set(d.props,P,e(s));let u=n.createSectionContainerItem_switch(d),f=A('处理从"搜索页面"或"我的帖子提醒页面"进入的网站',"viewthreadFlag",!1);Reflect.set(f.props,P,e(s));let p=n.createSectionContainerItem_switch(f),h=F("匹配的评论内容长度最小值","minLength",5,"小于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",!0);Reflect.set(h.props,P,e(s));let _=n.createSectionContainerItem_input(h),k=F("匹配的评论内容长度最大值","keywordLength",8,"大于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",!0);Reflect.set(k.props,P,e(s));let v=n.createSectionContainerItem_input(k),S=pt("评论关键字","keywords","","多个关键字换行分割");Reflect.set(S.props,P,e(s));let R=n.createSectionContainerItem_textarea(S),C=pt("黑名单用户","userBlackList","","多个用户换行分割");Reflect.set(C.props,P,e(s));let D=n.createSectionContainerItem_textarea(C),L=pt("白名单用户","userWhiteList","","多个用户换行分割");Reflect.set(L.props,P,e(s));let E=n.createSectionContainerItem_textarea(L);return l.append(a,m,u,p,_,v,R,D,E),l},btn:{merge:!0,position:"space-between",ok:{enable:!1},cancel:{enable:!0,text:"关闭"},other:{enable:!0,text:`查看已过滤（${this.$el.isFilterElementHTML.length}）`,type:"primary",callback:(s,l)=>{console.log(this.$el.isFilterElementHTML),B.alert({title:{text:"评论过滤器-已过滤",position:"center"},content:{text:`
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:!0,avatarFlag:!1,replyFlag:!1,viewthreadFlag:!1,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return Y(this.$key.STORAGE_KEY,this.getTemplateData())},setData(t){W(this.$key.STORAGE_KEY,t);}},Ce={$key:{STORAGE_KEY:"mt-productListingReminder-rule"},init(){this.registerMenu(),this.runRule();},registerMenu(){j.registerLeftMenu({name:"商品上架提醒",icon:"",iconColor:"#2376b7",callback:()=>{this.showView();}});},async runRule(){async function t(){let i=await V.get("/keke_integralmall-keke_integralmall.html",{fetch:!0,allowInterceptConfig:!1});if(!i.status){x.error("【积分商城】获取数据失败");return}let s=[];return r.parseHTML(i.data.responseText,!0,!0).querySelectorAll(".task-list-wrapper li.col-xs-12").forEach(o=>{var a,c;s.push({name:r.text(o.querySelector(".mall-info a > *:first-child"))||r.text(o.querySelector(".mall-info a")),price:r.text(o.querySelector(".mall-info span.discount-price i")),endTime:r.text(o.querySelector(".mall-info #time_hz span.time")),remainingQuantity:parseInt(((c=(a=o.querySelector(".mall-info .mall-count .count-r"))==null?void 0:a.innerText)==null?void 0:c.replace(/仅剩|件/gi,""))||"0")});}),s}if(M.isPointsMall())return;let e=this.getData();if(!e.length)return;let n=await t();if(n){for(const i of n)for(const s of e)if(s.enable&&i.name.match(new RegExp(s.productName,"i"))&&!isNaN(i.remainingQuantity)&&i.remainingQuantity>0){b.success("成功匹配对应商品",s,i),B.confirm({title:{text:"积分商城提醒",position:"center"},content:{text:`<br />
                            您设置的商品已上架在积分商城中，当前售价 ${i.price}金币，仅剩${i.remainingQuantity}件，是否前往购买？
                            <a style="color: red !important;">(如需关闭提醒，请删除该关键字)</a>
                            <br />`,html:!0},btn:{merge:!0,position:"space-between",other:{enable:!0,type:"danger",text:"删除提醒",callback:()=>{this.deleteData(s)?x.success("删除成功"):x.error("删除失败");}},ok:{text:"前往购买",callback:()=>{window.location.href=`${window.location.origin}/keke_integralmall-keke_integralmall.html`;}}},width:"300px",height:"300px"});return}}},getTemplateData(){return {uuid:g.generateUUID(),enable:!0,name:"",productName:""}},showView(){let t=B.config.panelHandleContentUtils();function e(i){return {get(s,l){return i[s]??l},set(s,l){i[s]=l;}}}new qt({title:"商品上架提醒",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:i=>i.name,updateData:i=>this.updateData(i),deleteData:i=>this.deleteData(i),getData:i=>this.getData().find(o=>o.uuid===i.uuid)??i,itemControls:{enable:{enable:!0,getEnable(i){return i.enable},callback:(i,s)=>{i.enable=s,this.updateData(i);}},edit:{enable:!0,getView:(i,s)=>{let l=document.createDocumentFragment();s||(i=this.getTemplateData());let o=A("启用","enable",!0);Reflect.set(o.props,P,e(i));let a=t.createSectionContainerItem_switch(o),c=F("规则名称","name","","",void 0,"必填");Reflect.set(c.props,P,e(i));let m=t.createSectionContainerItem_input(c),d=F("商品名","productName","","",void 0,"可正则，需手动转义");Reflect.set(d.props,P,e(i));let u=t.createSectionContainerItem_input(d);return l.append(a,m,u),l},onsubmit:(i,s,l)=>{let o=i.querySelectorAll(".rule-form-ulist > li"),a=this.getTemplateData();return s&&(a.uuid=l.uuid),o.forEach(c=>{let m=Reflect.get(c,"__formConfig__"),d=Reflect.get(m,"attributes"),u=Reflect.get(c,P),f=Reflect.get(d,et),p=Reflect.get(d,it),h=u.get(f,p);Reflect.has(a,f)?Reflect.set(a,f,h):b.error(`${f}不在数据中`);}),a.name.trim()===""?(x.error("规则名称不能为空"),{success:!1,data:a}):s?{success:this.updateData(a),data:a}:{success:this.addData(a),data:a}}},delete:{enable:!0,deleteCallBack:i=>this.deleteData(i)}}}).showView();},getData(){return Y(this.$key.STORAGE_KEY,[])},setData(t){W(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(i=>i.uuid==t.uuid)===-1?(e.push(t),W(this.$key.STORAGE_KEY,e),!0):!1},updateData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=!1;return n!==-1&&(i=!0,e[n]=t),this.setData(e),i},deleteData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=!1;return n!==-1&&(i=!0,e.splice(n,1)),this.setData(e),i},clearData(){at(this.$key.STORAGE_KEY);}},Ie={$key:{STORAGE_KEY:"mt-customizeUserLabels-rule"},init(){if(this.registerMenu(),M.isPage()||M.isGuide()||M.isPlate()||M.isPost()||M.isSearch()||M.isSpace()){let t=this.getData();if(!t.length)return;let e=new g.LockFunction(()=>{this.runRule(t);});g.mutationObserver(document,{config:{subtree:!0,childList:!0},callback:()=>{e.run();}});}},registerMenu(){j.registerLeftMenu({name:"自定义用户标签",icon:"",iconColor:"#c70ea6",callback:()=>{this.showView();}});},showView(){let t=B.config.panelHandleContentUtils();function e(i){return {get(s,l){return i[s]??l},set(s,l){i[s]=l;}}}new qt({title:"自定义用户标签",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:i=>i.name,updateData:i=>this.updateData(i),deleteData:i=>this.deleteData(i),getData:i=>this.getData().find(o=>o.uuid===i.uuid)??i,itemControls:{enable:{enable:!0,getEnable(i){return i.enable},callback:(i,s)=>{i.enable=s,this.updateData(i);}},edit:{enable:!0,getView:(i,s)=>{var D;let l=document.createDocumentFragment();s||(i=this.getTemplateData());let o=A("启用","enable",!0);Reflect.set(o.props,P,e(i));let a=t.createSectionContainerItem_switch(o),c=F("规则名称","name","","",void 0,"必填");Reflect.set(c.props,P,e(i));let m=t.createSectionContainerItem_input(c),d=F("用户UID","userUID","","",void 0,"必填，可正则，注意转义");Reflect.set(d.props,P,e(i));let u=t.createSectionContainerItem_input(d),f=F("标签名","labelName","","",void 0,"必填");Reflect.set(f.props,P,e(i));let p=t.createSectionContainerItem_input(f),h=F("标签颜色","labelColor","","");Reflect.set(h.props,P,e(i));let _=t.createSectionContainerItem_input(h),k=_.querySelector("input");(D=_.querySelector(".pops-panel-input__suffix"))==null||D.remove(),k.setAttribute("type","color"),r.css(k,{margin:"unset",padding:"unset",width:"80px"});let v=F("标签CSS","labelStyle","","");Reflect.set(v.props,P,e(i));let S=t.createSectionContainerItem_input(v),R=pt("标签点击事件","labelClickEvent","","");Reflect.set(R.props,P,e(i));let C=t.createSectionContainerItem_textarea(R);return l.append(a,m,u,p,_,S,C),l},onsubmit:(i,s,l)=>{let o=i.querySelectorAll(".rule-form-ulist > li"),a=this.getTemplateData();return s&&(a.uuid=l.uuid),o.forEach(c=>{let m=Reflect.get(c,"__formConfig__"),d=Reflect.get(m,"attributes"),u=Reflect.get(c,P),f=Reflect.get(d,et),p=Reflect.get(d,it),h=u.get(f,p);Reflect.has(a,f)?Reflect.set(a,f,h):b.error(`${f}不在数据中`);}),a.name.trim()===""?(x.error("规则名称不能为空"),{success:!1,data:a}):a.userUID.trim()===""?(x.error("用户UID不能为空"),{success:!1,data:a}):a.labelName.trim()===""?(x.error("标签名不能为空"),{success:!1,data:a}):s?{success:this.updateData(a),data:a}:{success:this.addData(a),data:a}},style:`
                    .pops-panel-textarea textarea{
                        height: 150px;
                    }
                    ...
                    background: ${c.labelColor} !important;${c.labelStyle||""}`,o.innerHTML=c.labelName,r.on(o,"click",async m=>{g.preventEvent(m),g.isNotNull(c.labelClickEvent)&&y.eval(c.labelClickEvent);}),a.parentElement.append(o);});}});},getTemplateData(){return {uuid:g.generateUUID(),enable:!0,name:"",userUID:"",labelName:"",labelColor:"",labelStyle:"",labelClickEvent:""}},getData(){return Y(this.$key.STORAGE_KEY,[])},setData(t){W(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(i=>i.uuid==t.uuid)===-1?(e.push(t),W(this.$key.STORAGE_KEY,e),!0):!1},updateData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=!1;return n!==-1&&(i=!0,e[n]=t),this.setData(e),i},deleteData(t){let e=this.getData(),n=e.findIndex(s=>s.uuid==t.uuid),i=!1;return n!==-1&&(i=!0,e.splice(n,1)),this.setData(e),i},clearData(){at(this.$key.STORAGE_KEY);}},Me={init(){r.ready(()=>{q.execMenuOnce("mt-forum-post-publish-editorOptimization",()=>{gt.init();});});}},Ee={$flag:{showUserUID_initCSS:!1},init(){(M.isPage()||M.isGuide()||M.isPlate()||M.isPost()||M.isSearch()||M.isSpace())&&q.execMenuOnce("mt-show-user-uid",()=>{this.showUserUID();}),(M.isSearch()||M.isGuide()||M.isSpace()||M.isPlate())&&q.execMenuOnce("mt-small-window",()=>{Vt.init();}),M.isPost()?(b.info("Router: 帖子"),Ft.init()):M.isSearch()?(b.info("Router: 搜索"),ye.init()):M.isKMiSign()?(b.info("Router: 签到"),xe.init()):M.isSpace()||M.isSpaceWithAt()?(b.info("Router: 空间"),we.init()):M.isGuide()?(b.info("Router: 导读"),$e.init()):M.isPostPublish()?(b.info("Router: 发帖页面"),Me.init()):b.error("Router: 未适配的链接 ==> "+window.location.href),r.ready(()=>{q.execMenuOnce("mt-black-home",()=>{ge.init();}),q.execMenuOnce("mt-online-user",()=>{be.init();}),q.execMenuOnce("mt-post-paidThemePost",()=>{dt.init();}),q.execMenuOnce("mt-ownBlock",()=>{Se.init();}),q.execMenuOnce("mt-post-comment-filter",()=>{Te.init();}),q.execMenuOnce("mt-productListingReminder",()=>{Ce.init();}),q.execMenuOnce("mt-customizeUserLabels",()=>{Ie.init();}),q.execMenuOnce("mt-link-text-to-hyperlink",()=>{_e();}),q.execMenu("mt-auto-sign",()=>{mt.init();});});},showUserUID(){b.info("显示用户UID"),this.$flag.showUserUID_initCSS||(this.$flag.showUserUID_initCSS=!0,G(`
			.postli_top_tximg + h2{
 				height: auto;
			}

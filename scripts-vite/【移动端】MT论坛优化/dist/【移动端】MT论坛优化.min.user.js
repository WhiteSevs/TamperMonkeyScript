...
(function (y, Z, st, bt, Rt, pt) {
	'use strict';

	var Wt=Object.defineProperty;var Yt=(t,e,i)=>e in t?Wt(t,e,{enumerable:true,configurable:true,writable:true,value:i}):t[e]=i;var Kt=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var nt=(t,e,i)=>Yt(t,typeof e!="symbol"?e+"":e,i);var Re=Kt((jt,wt)=>{var $t=typeof GM<"u"?GM:void 0,lt=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,kt=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,Y=typeof GM_getValue<"u"?GM_getValue:void 0,ut=typeof GM_info<"u"?GM_info:void 0,Qt=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,G=typeof GM_setValue<"u"?GM_setValue:void 0,Jt=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Zt=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,x=typeof unsafeWindow<"u"?unsafeWindow:void 0,Xt=window;const te={$data:{get enable(){return $.getValue("httpx-use-cookie-enable")},get useDocumentCookie(){return $.getValue("httpx-use-document-cookie")},cookieRule:[{key:"httpx-cookie-bbs.binmt.cc",hostname:/bbs.binmt.cc/g}]},fixCookieSplit(t){return g.isNotNull(t)&&!t.trim().endsWith(";")&&(t+=";"),t},concatCookie(t,e){return g.isNull(t)?e:(t=t.trim(),e=e.trim(),t=this.fixCookieSplit(t),e.startsWith(";")&&(e=e.substring(1)),t.concat(e))},handle(t){if(t.fetch||!this.$data.enable)return;let e="",i=t.url;i.startsWith("//")&&(i=window.location.protocol+i);let n=new URL(i);this.$data.useDocumentCookie&&n.hostname.endsWith(window.location.hostname.split(".").slice(-2).join("."))&&(e=this.concatCookie(e,document.cookie.trim()));for(let s=0;s<this.$data.cookieRule.length;s++){let l=this.$data.cookieRule[s];if(n.hostname.match(l.hostname)){let o=$.getValue(l.key);if(g.isNull(o))break;e=this.concatCookie(e,o);}}g.isNotNull(e)&&(t.headers&&t.headers.Cookie?t.headers.Cookie=this.concatCookie(t.headers.Cookie,e):t.headers.Cookie=e,b.info(["Httpx => 设置cookie:",t])),t.headers&&t.headers.Cookie!=null&&g.isNull(t.headers.Cookie)&&delete t.headers.Cookie;}},Lt={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}};(function(t,e){typeof jt=="object"&&typeof wt<"u"?wt.exports=e():(t=typeof globalThis<"u"?globalThis:t||self,t.Watermark=e(t.Watermark));})(typeof window<"u"?window:void 0,function(t){let e=function(){};CanvasRenderingContext2D.prototype.letterSpacingText=function(o,a,c,m){var d=this,u=d.canvas;if(!m&&u&&(m=parseFloat(window.getComputedStyle(u).letterSpacing)),!m)return this.fillText(o,a,c);var f=o.split(""),p=d.textAlign||"left",h=d.measureText(o).width,_=h+m*(f.length-1);p=="center"?a=a-_/2:p=="right"&&(a=a-_),d.textAlign="left",f.forEach(function(k){var v=d.measureText(k).width;d.fillText(k,a,c),a=a+v+m;}),d.textAlign=p;},CanvasRenderingContext2D.prototype.wrapText=function(o,a,c,m,d,u){if(!(typeof o!="string"||typeof a!="number"||typeof c!="number")){var f=this,p=f.canvas;typeof m>"u"&&(m=p&&p.width||300),typeof d>"u"&&(d=p&&parseInt(window.getComputedStyle(p).lineHeight)||parseInt(window.getComputedStyle(document.body).lineHeight));for(var h=o.split(""),_="",k=0;k<h.length;k++){var v=_+h[k],S=f.measureText(v),A=S.width;A>m&&k>0?(u?f.strokeText(_,a,c,p.width):f.fillText(_,a,c),_=h[k],c+=d):_=v;}u?f.strokeText(_,a,c,p.width):f.fillText(_,a,c);}},CanvasRenderingContext2D.prototype.fillTextVertical=function(o,a,c){var m=this;m.canvas;var d=o.split(""),u=d.map(function(h){return m.measureText(h).width}),f=m.textAlign,p=m.textBaseline;f=="left"?a=a+Math.max.apply(null,u)/2:f=="right"&&(a=a-Math.max.apply(null,u)/2),p=="bottom"||p=="alphabetic"||p=="ideographic"?c=c-u[0]/2:(p=="top"||p=="hanging")&&(c=c+u[0]/2),m.textAlign="center",m.textBaseline="middle",d.forEach(function(h,_){var v=u[_],k=h.charCodeAt(0);k<=256?(m.translate(a,c),m.rotate(90*Math.PI/180),m.translate(-a,-c)):_>0&&o.charCodeAt(_-1)<256&&(c=c+u[_-1]/2),m.fillText(h,a,c),m.setTransform(1,0,0,1,0,0);var v=u[_];c=c+v;}),m.textAlign=f,m.textBaseline=p;};function i(o){let a=new FileReader;return new Promise(c=>{a.onloadend=async function(m){c(m);},a.readAsDataURL(o);})}function n(o){let a=new Image;return new Promise(c=>{a.onload=()=>{c(a);},a.src=o;})}function s(o,a,c){let m=false;return Array.from(o).forEach(d=>{if(d.x==a&&d.y==c){m=true;return}}),m}function l(o){return o instanceof Array?o[Math.floor(Math.random()*o.length)]:o}return e.prototype.setFile=function(o){let a=this;return new Promise(async c=>{try{var m=await i(o);await a.setImage(m.target.result),c(!0);}catch{c(false);}})},e.prototype.setImage=function(o){this.dataUrl=o;let a=this;return new Promise(async c=>{var m=await n(o);a.sizes={width:m.width,height:m.height};var d=document.createElement("canvas");d.width=a.sizes.width,d.height=a.sizes.height;var u=d.getContext("2d");u.drawImage(m,0,0),m=null,a.canvas=d,c(true);})},e.prototype.hasImage=function(){return !!this.dataUrl},e.prototype.getSize=function(){return this.sizes},e.prototype.clearMark=function(){let o=this;if(typeof o.canvas>"u")return;function a(){var c=o.canvas.getContext("2d");c.clearRect(0,0,o.canvas.width,o.canvas.height);var m=o.canvas.width,d=o.canvas.height;o.canvas.width=m,o.canvas.height=d,c.beginPath();var u=new Image;u.src=o.dataUrl,c.drawImage(u,0,0),u=null;}a();},e.prototype.addText=function(o){var a={text:["Call By waterMark.addText"],fontSize:"6vw",fontFamily:"Microsoft Yahei",color:"#000000",textAlign:"center",stroke:false,globalAlpha:.7,rotateAngle:50,maxWidth:100,xMoveDistance:30,yMoveDistance:30};for(let P in a)typeof o[P]<"u"&&(a[P]=o[P]);a.maxWidth=parseInt(a.maxWidth)>0?a.maxWidth:1,a.xMoveDistance=parseInt(a.xMoveDistance)>0?a.xMoveDistance:1,a.yMoveDistance=parseInt(a.yMoveDistance)>0?a.yMoveDistance:1;var c=this.canvas.getContext("2d"),m=a.fontSize;m=m.toString(),~m.indexOf("vw")&&(m=(this.sizes.width/100*parseInt(m)).toFixed(0)),m=parseInt(m),c.font=m+"px "+a.fontFamily,c.fillStyle=a.color,c.textAlign=a.textAlign,c.globalAlpha=a.globalAlpha;let d=this.sizes.width,u=this.sizes.height,f=a.rotateAngle*Math.PI/180,p=a.xMoveDistance,h=a.yMoveDistance,_=a.maxWidth,k=m,v=[];for(var S=d/2;S<d;S+=p){for(var A=u/2;A<u;A+=h)s(v,S,A)||(v=v.concat({x:S,y:A}),c.setTransform(1,0,0,1,0,0),c.translate(S,A),c.rotate(f),c.wrapText(l(a.text),0,0,_,k,a.stroke));for(var I=u/2;I>0;I-=h)s(v,S,I)||(v=v.concat({x:S,y:I}),c.setTransform(1,0,0,1,0,0),c.translate(S,I),c.rotate(f),c.wrapText(l(a.text),0,0,_,k,a.stroke));}for(var S=d/2;S>0;S-=p){for(var A=u/2;A<u;A+=h)s(v,S,A)||(v=v.concat({x:S,y:A}),c.setTransform(1,0,0,1,0,0),c.translate(S,A),c.rotate(f),c.wrapText(l(a.text),0,0,_,k,a.stroke));for(var I=u/2;I>0;I-=h)s(v,S,I)||(v=v.concat({x:S,y:I}),c.setTransform(1,0,0,1,0,0),c.translate(S,I),c.rotate(f),c.wrapText(l(a.text),0,0,_,k,a.stroke));}},e.prototype.addPixelText=function(o){var a={text:"像素文字水印",big:{fontSize:150,fontFamily:"微软雅黑",textAlign:"center",rotateAngle:0,stroke:false},small:{fontSize:10,fontFamily:"微软雅黑",color:"#000",textAlign:"center",globalAlpha:.7}};for(let S in a)typeof o[S]<"u"&&(a[S]=o[S]);var c=this.canvas.getContext("2d"),m=document.createElement("canvas"),d=m.getContext("2d");m.width=this.sizes.width,m.height=this.sizes.height,d.font=a.big.fontSize+"px "+a.big.fontFamily,d.textAlign=a.big.textAlign,d.textBaseline="middle",d.translate(m.width/2,m.height/2),d.rotate(a.big.rotateAngle*Math.PI/180),d.translate(-m.width/2,-m.height/2),a.big.stroke?d.strokeText(a.text,m.width/2,m.height/2,m.width):d.fillText(a.text,m.width/2,m.height/2);for(var u=a.text.split(""),f=d.getImageData(0,0,m.width,m.height),p=[],h=0;h<m.height;h+=a.small.fontSize)for(var _=0;_<m.width;_+=a.small.fontSize){var k=_+h*m.width,v=f.data[k*4+3];v>128&&p.push({text:l(u),x:_,y:h});}c.font=a.small.fontSize+"px "+a.small.fontFamily,c.fillStyle=a.small.color,c.textAlign=a.small.textAlign,c.textBaseline="middle",c.globalAlpha=a.small.globalAlpha,p.forEach(S=>{c.fillText(S.text,S.x,S.y);});},e.prototype.addImage=function(o){if(o.imageArray==null)return alert("参数缺少imageArray"),false;if(o.imageArray.length===0)return alert("参数imageArray不能为空"),false;let a={imageArray:[],width:50,height:50,globalAlpha:.5,rotateAngle:0,xMoveDistance:70,yMoveDistance:70};for(let E in a)typeof o[E]<"u"&&(a[E]=o[E]);a.width=parseInt(a.width)>0?a.width:1,a.height=parseInt(a.height)>0?a.height:1,a.xMoveDistance=parseInt(a.xMoveDistance)>0?a.xMoveDistance:1,a.yMoveDistance=parseInt(a.yMoveDistance)>0?a.yMoveDistance:1;let c=this.canvas.getContext("2d"),m=[],d=parseInt(Math.sqrt(a.width*a.width+a.height*a.height)),u=this.sizes.width,f=this.sizes.height,p=a.rotateAngle*Math.PI/180,h=a.xMoveDistance,_=a.yMoveDistance,k=u/2-d/2,v=f/2-d/2,S=(d-a.width)/2,A=(d-a.height)/2;Array.from(a.imageArray).forEach(E=>{var R=document.createElement("canvas"),O=R.getContext("2d");R.width=d,R.height=d,O.globalAlpha=a.globalAlpha,O.translate(d/2,d/2),O.rotate(p),O.translate(-d/2,-d/2),O.drawImage(E,S,A,a.width,a.height),m=m.concat(R);});function I(E){return E[Math.floor(Math.random()*E.length)]}c.setTransform(1,0,0,1,0,0);let P=[];for(let E=k;E<u;E+=h){for(let R=v;R<f;R+=_)s(P,E,R)||(P=P.concat({x:E,y:R}),c.drawImage(I(m),E,R));for(let R=v;R>-Math.abs(d);R-=_)s(P,E,R)||(P=P.concat({x:E,y:R}),c.drawImage(I(m),E,R));}for(let E=k;E>-Math.abs(d);E-=h){for(let R=v;R<f;R+=_)s(P,E,R)||(P=P.concat({x:E,y:R}),c.drawImage(I(m),E,R));for(let R=v;R>-Math.abs(d);R-=_)s(P,E,R)||(P=P.concat({x:E,y:R}),c.drawImage(I(m),E,R));}},e.prototype.getPreview=function(){return this.dataUrl},e.prototype.render=function(o){return o=o==="png"?"png":"jpeg",this.canvas.toDataURL("image/"+o)},e.prototype.renderBlob=function(){let o=this;return new Promise(a=>{o.canvas.toBlob(function(c){a(window.URL.createObjectURL(c));});})},e.prototype.noConflict=function(){return window.Watermark&&delete window.Watermark,t&&(window.Watermark=t),e},e});const vt={addBlockCSS(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(i=>{Array.isArray(i)?e=e.concat(i):e.push(i);}),W(`${e.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof kt=="function"?kt(t.keyName):"";typeof e=="string"&&e?W(e):vt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,r.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(i=>{e.onload=()=>{i(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()}},ee="【移动端】MT论坛优化",g=st.noConflict(),r=Z.noConflict(),N=bt,b=new g.Log(ut,x.console||Xt.console);var At;const St=((At=ut==null?void 0:ut.script)==null?void 0:At.name)||ee,Dt=false;b.config({debug:Dt,logMaxCount:1e3,autoClearConsole:true,tag:true});y.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return $.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return $.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return $.getValue("qmsg-config-showreverse",true)}},zIndex:{get(){let t=st.getMaxZIndex(),e=bt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return st.getMaxValue(t,e)+100}}}));const ie=new g.GM_Menu({GM_getValue:Y,GM_setValue:G,GM_registerMenuCommand:Qt,GM_unregisterMenuCommand:Jt}),H=new g.Httpx(Zt);H.interceptors.request.use(t=>(te.handle(t),t));H.interceptors.response.use(void 0,t=>(b.error("拦截器-请求错误",t),t.type==="onabort"?y.warning("请求取消"):t.type==="onerror"?y.error("请求异常"):t.type==="ontimeout"?y.error("请求超时"):y.error("其它错误"),t));H.config({logDetails:Dt});bt.GlobalConfig.setGlobalConfig({mask:{enable:true,clickEvent:{toClose:false,toHide:false}}});x.Object.defineProperty,x.Function.prototype.apply,x.Function.prototype.call,x.Element.prototype.appendChild,x.setTimeout;const W=g.addStyle.bind(g);vt.setGMResourceCSS(Lt.Viewer);vt.setGMResourceCSS(Lt.Hljs);const C=document.querySelector.bind(document),U=document.querySelectorAll.bind(document),ot="GM_Panel",Pt="data-init",et="data-key",it="data-default-value",ne="data-init-more-value",D="data-storage-api",L=function(t,e,i,n,s,l){let o={text:t,type:"switch",description:s,attributes:{},props:{},getValue(){return !!this.props[D].get(e,i)},callback(a,c){let m=!!c;b.success(`${m?"开启":"关闭"} ${t}`),this.props[D].set(e,m);},afterAddToUListCallBack:l};return Reflect.set(o.attributes,et,e),Reflect.set(o.attributes,it,i),Reflect.set(o.props,D,{get(a,c){return $.getValue(a,c)},set(a,c){$.setValue(a,c);}}),o},dt=function(t,e,i,n,s,l="",o){let a={text:t,type:"textarea",attributes:{},props:{},description:n,placeholder:l,disabled:o,getValue(){return this.props[D].get(e,i)},callback(c,m){this.props[D].set(e,m);}};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,i),Reflect.set(a.props,D,{get(c,m){return $.getValue(c,m)},set(c,m){$.setValue(c,m);}}),a},Tt=function(t,e,i,n,s,l){let o=[];typeof n=="function"?o=n():o=n;let a={text:t,type:"select",description:l,attributes:{},props:{},getValue(){return this.props[D].get(e,i)},callback(c,m,d){let u=m;b.info(`选择：${d}`),this.props[D].set(e,u),typeof s=="function"&&s(c,u,d);},data:o};return Reflect.set(a.attributes,et,e),Reflect.set(a.attributes,it,i),Reflect.set(a.props,D,{get(c,m){return $.getValue(c,m)},set(c,m){$.setValue(c,m);}}),a},ft=function(t,e,i,n,s,l,o,a,c){return {text:t,type:"button",description:e,buttonIcon:n,buttonIsRightIcon:s,buttonIconIsLoading:l,buttonType:o,buttonText:i,callback(d){typeof a=="function"&&a(d);},afterAddToUListCallBack:c}},Ct=function(t,e,i,n){let s={type:"own",attributes:{},props:i,getLiElementCallBack:t,afterAddToUListCallBack:n};return Reflect.set(s.attributes,Pt,()=>false),s},X={formhash:/formhash=([0-9a-zA-Z]+)/,uid:/uid(=|-)(\d+)/,fontSpecial:/<font.*?>|<\/font>|<strike>|<strong>|<i>|<u>|align=".*?"|<br>[\s]*<br>[\s]*<br>/g,ptid:/&ptid=([\d]+)/i,pid:/&pid=([\d]+)/i,tid:/&tid=([\d]+)/i},F={getAvatar:(t,e="middle")=>`/uc_server/avatar.php?uid=${t}&size=${e}&ts=1`,getCurrentUID(){let t=x.discuz_uid;if(typeof t=="string")return t;let e=document.querySelector('.sidenv_exit a[href*="uid="]');if(e){let i=e.href.match(/uid=([0-9]+)/);if(i)return i[i.length-1]}},getFormHash(){let t=Array.from((top||globalThis).document.querySelectorAll("input[name=formhash]"));for(let i=0;i<t.length;i++){let s=t[i].value;if(s)return s}let e=Array.from((top||globalThis).document.querySelectorAll('a[href*="formhash="]'));for(let i=0;i<e.length;i++){let s=e[i].href.match(X.formhash);if(s){let l=s[s.length-1];if(l)return l}}},envIsMobile(){return (x.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:t=>{let e=t.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(e){let i=e.filter(Boolean);return i[i.length-1]}},getForumId(t){let e=t.match(/&fid=([\d]+)/i);if(e)return e[e.length-1]},getPostId(t){let e=t.match(/&pid=([\d]+)/i);if(e)return e[e.length-1]},getRepquote(t){let e=t.match(/&repquote=([\d]+)/i);if(e)return e[e.length-1]}},rt={$upload:{small:false,middle:false,big:false},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return rt.$el.$smallUpload.files[0]},get middle(){return rt.$el.$middleUpload.files[0]},get big(){return rt.$el.$bigUpload.files[0]}},showView(){const t=this;let e=N.confirm({title:{text:"修改头像",position:"center"},content:{text:`
                ...
                `,html:true},btn:{ok:{text:"上传",callback:async()=>{if(!t.$upload.small){y.error("请上传小头像");return}if(!t.$upload.middle){y.error("请上传中头像");return}if(!t.$upload.big){y.error("请上传大头像");return}let i=y.loading("正在处理数据中...");try{let n=await this.getUploadUrl();if(n==null)return;let s=F.getFormHash();if(s==null){y.error("获取formhash失败");return}let l={big:{base64:await g.parseFileToBase64(this.$avatar.big)},middle:{base64:await g.parseFileToBase64(this.$avatar.middle)},small:{base64:await g.parseFileToBase64(this.$avatar.small)}};Object.keys(l).forEach(c=>{let m=l[c];m.base64=m.base64.substring(m.base64.indexOf(",")+1);});let o=new FormData;o.append("Filedata",this.$avatar.big||""),o.append("confirm","确定"),o.append("avatar1",l.big.base64),o.append("avatar2",l.middle.base64),o.append("avatar3",l.small.base64),o.append("formhash",s),b.info("头像的base64字符串",l);let a=await H.post(n,{data:o,processData:!1,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","User-Agent":g.getRandomPCUA(),Host:window.location.hostname,Origin:window.location.origin,Referer:`${window.location.origin}/home.php?mod=spacecp&ac=avatar`}});if(!a.status)return;a.data.responseText.indexOf("window.parent.postMessage('success','*')")!=-1?(e.close(),y.success("上传成功")):(b.error("上传失败",a),y.error(a.data.responseText,{timeout:6e3,isHTML:!1,html:!1}));}catch(n){b.error(n);}finally{i.close();}}}},mask:{enable:true},width:"88vw",height:"500px",style:`
            .avatar-container{
                display: flex;
            ...
            `});this.$el.$smallUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(t,e,i,n){r.on(t,"change",s=>{var m;if(!((m=t.files)!=null&&m.length))return;r.text(e,"🤡获取文件信息中..."),e.removeAttribute("data-success");let l=t.files[0],o=l.size,a=new Image,c=new FileReader;c.readAsDataURL(l),c.onload=function(d){a.src=d.target.result,a.onload=function(){if(a.width>i.width||a.height>i.height){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片尺寸不符合，宽：${a.width} 高：${a.height}`);return}if(o>rt.$data.avatarInfo.maxSize){t.value="",e.setAttribute("data-success","false"),r.text(e,`🤡校验失败 ==> 图片大小不符合：${o}byte，限制最大：${rt.$data.avatarInfo.maxSize}byte`);return}e.setAttribute("data-success","true"),r.text(e,`🤣 通过 宽:${a.width} 高:${a.height} 大小(byte):${o}`),n();};};});},async getUploadUrl(){let t=await H.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":g.getRandomPCUA()}});if(!t.status)return;if(g.isNull(t.data.responseText)){y.error("动态头像：获取上传地址失败");return}let e=t.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(e==null||e.length!=2){y.error("动态头像：获取变量data失败");return}let n=e[e.length-1].split(","),s=n[n.indexOf("src")+1].replace("images/camera.swf?inajax=1","index.php?m=user&a=rectavatar&base64=yes");return b.info("上传地址："+s),s}},se={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[Tt("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,i)=>{b.info("设置当前Qmsg弹出位置"+i);},"Toast显示在页面九宫格的位置"),Tt("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),L("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]},{text:"Cookie配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[L("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),L("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie"),dt("bbs.binmt.cc","httpx-cookie-bbs.binmt.cc","",void 0,void 0,"Cookie格式：xxx=xxxx;xxx=xxxx")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[L("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),L("显示用户UID","mt-show-user-uid",true,void 0,"格式为UID：xxx"),L("小窗模式","mt-small-window",true,void 0,"开启后点击帖子右侧区域为小窗打开"),L("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{text:"额外菜单项",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("小黑屋","mt-black-home",true,void 0,"将会在左侧面板添加【小黑屋】菜单"),L("在线用户","mt-online-user",true,void 0,"将会在左侧面板添加【在线用户】菜单"),L("付费主题白嫖提醒","mt-post-paidThemePost",true,void 0,"将会在左侧面板添加【付费主题白嫖提醒】菜单"),L("我的屏蔽","mt-ownBlock",true,void 0,"将会在左侧面板添加【我的屏蔽】菜单"),L("商品上架提醒","mt-productListingReminder",true,void 0,"将会在左侧面板添加【商品上架提醒】菜单"),L("自定义用户标签","mt-customizeUserLabels",true,void 0,"将会在左侧面板添加【自定义用户标签】菜单"),L("评论过滤器","mt-post-comment-filter",true,void 0,"将会在左侧面板添加【评论过滤器】菜单")]}]},{text:"头像",type:"deepMenu",forms:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"forms",forms:[Ct(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											`}),n=r.createElement("style",{innerHTML:`
											.avatar-img {
												width: 30px;
												height: 30px;
												border-radius: 50%;
										...
										`});return i.querySelector(".avatar-img[data-size='small']"),i.querySelector(".avatar-img[data-size='middle']"),i.querySelector(".avatar-img[data-size='big']"),t.appendChild(e),t.appendChild(i),t.appendChild(n),t}),Ct(t=>{let e=r.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return t.appendChild(e),t.appendChild(i),t}),ft("修改头像",`可以上传gif图片，注意图片最大限制为${st.formatByteToSize(rt.$data.avatarInfo.maxSize)}`,"上传",void 0,false,false,"primary",()=>{rt.showView();})]}]}]}]},j={registerLeftMenu(t){g.waitNode(".comiis_sidenv_box .sidenv_li .comiis_left_Touch",1e4).then(e=>{if(!e){b.error("注册左侧面板菜单失败，原因：该元素不存在");return}let i=r.createElement("li",{className:"comiis_left_Touch",innerHTML:`
						<a href="javascript:;" class="comiis_left_Touch">
							<i class="comiis_font"></i>
							${t.name}
						</a>
						`}),n=i.querySelector(".comiis_font");typeof t.style=="string"&&(n.style.cssText=t.style),typeof t.icon=="string"&&(n.innerHTML=t.icon),typeof t.iconColor=="string"&&(n.style.color=t.iconColor),typeof t.iconSize=="string"&&(n.style.fontSize=t.iconSize),r.on(i,"click",s=>{g.preventEvent(s),typeof t.callback=="function"&&t.callback();}),r.append(e,i);});},comiisForumList:()=>document.querySelectorAll("li.forumlist_li"),comiisPostli:()=>document.querySelectorAll("div.comiis_postli.comiis_list_readimgs.nfqsqi"),comiisMmlist:()=>document.querySelectorAll(".comiis_mmlist")},V=function(t,e,i,n,s,l="",o,a,c){let m={text:t,type:"input",isNumber:!!o,isPassword:!!a,props:{},attributes:{},description:n,afterAddToUListCallBack:c,getValue(){return this.props[D].get(e,i)},callback(d,u,f){this.props[D].set(e,o?f:u);},placeholder:l};return Reflect.set(m.attributes,et,e),Reflect.set(m.attributes,it,i),Reflect.set(m.props,D,{get(d,u){return $.getValue(d,u)},set(d,u){$.setValue(d,u);}}),m},ae=`#comiis_foot_menu_beautify {\r
	position: fixed;\r
...
`)}
								...
								`});}else await l(o);}});}addTab(){let e=C("#comiis_pictitle_key"),i=e.querySelector("a[data-type='history']"),n=`
            <li>
                <a href="javascript:;" class="comiis-picture-tab" data-type="image-bed">${this.option.name}</a>
            </li>
        `;if(!i){let o=r.createElement("li");i=r.createElement("a",{href:"javascript:;",className:"comiis-picture-tab",innerHTML:"历史图片"},{"data-type":"history"}),r.on(i,"click",()=>{this.initHistoryUploadImageList();}),r.append(o,i),r.append(e,o);}r.before(i.parentElement,n);let s=C("#comiis_pictitle_tab .bqbox_t"),l=Array.from(U("#comiis_pictitle_tab .comiis_upbox")).find(o=>!!o.querySelector("#imglist_history"));l||(l=r.createElement("div",{className:"comiis_upbox bg_f cl",innerHTML:`
					<ul class="comiis_post_imglist cl" id="imglist_history">	
                    </ul>
				`},{style:"display: none;"}),r.before(s,l),l=Array.from(U("#comiis_pictitle_tab .comiis_upbox")).find(o=>!!o.querySelector("#imglist_history"))),r.before(l,`
            ...
            `})}initHistoryUploadImageList(){let e=C("#comiis_pictitle_tab #imglist_history");e.innerHTML="";let i=document.createDocumentFragment();this.getAllImage().forEach(n=>{let s=this.createImageBtnElement(n.labelName,n.data.url);this.setHistoryImageBtnDeleteEvent(s,n),i.appendChild(s);}),e.appendChild(i);}setImageBtnDeleteEvent(e,i){let n=e.querySelector(".delImg");r.on(n,"click",async s=>{await this.option.delImageEvent(s,i)&&this.deleteImage(this.option.id,i)&&r.remove(e);});}setHistoryImageBtnDeleteEvent(e,i){let n=e.querySelector(".delImg");r.on(n,"click",async s=>{let l=It.find(a=>a.id===i.id);if(!l)return;await l.callback(s,i.data)&&this.deleteImage(i.id,i.data)&&r.remove(e);});}addImage(e){let i=Y(this.$data.STORAGE_KEY,[]);i.push({id:this.option.id,name:this.option.name,labelName:this.option.labelName,data:e}),G(this.$data.STORAGE_KEY,i);}getAllImage(){return Y(this.$data.STORAGE_KEY,[])}deleteImage(e,i){let n=this.getAllImage(),s=n.findIndex(l=>l.id===e&&JSON.stringify(l.data)===JSON.stringify(i));return s!=-1?(n.splice(s,1),G(this.$data.STORAGE_KEY,n),true):false}}const Nt={$data:{get account(){return $.getValue("mt-image-bed-hello-account")},get password(){return $.getValue("mt-image-bed-hello-password")},get token(){return $.getValue("mt-image-bed-hello-token")}},$code:{401:"未登录或授权失败",403:"管理员关闭了接口功能或没有该接口权限",429:"超出请求配额，请求受限",500:"服务端出现异常"},$config:{base_url:"https://www.helloimg.com/api/v1",TAG:"Hello图床："},$tabConfig:{id:"www.helloimg.com",name:"Hello图床",labelName:"hello"},init(){const t=this;new zt({id:this.$tabConfig.id,name:this.$tabConfig.name,labelName:this.$tabConfig.labelName,async uploadBtnClickEvent(e){return await t.checkLogin()},async fileChangeEvent(e,i){let n=[],s=y.loading("上传中..."),l=true;for(let o=0;o<Array.from(i).length;o++){const a=Array.from(i)[o];let c=await t.uploadImage(a);c?(n.push({url:c.data.links.url,data:c.data}),l=l&&true):l=l&&false;}return s.close(),{success:l,data:n}},storageSaveCallBack(e){return e.data},async delImageEvent(e,i){if(await t.checkLogin()){let s=y.loading("正在删除图片..."),l=await t.deleteImage(i.data.key)??false;return s.close(),l}else return  false}});},async checkLogin(){return this.$data.account?this.$data.password?this.$data.token?true:(y.error(`${this.$config.TAG}请先配置token`),false):(y.error(`${this.$config.TAG}请先配置密码`),false):(y.error(`${this.$config.TAG}请先配置账号`),false)},async uploadImage(t){let e=new FormData;e.append("file",t),e.append("permission","0"),e.append("strategy_id","0"),e.append("album_id","0");let i=await H.post(`${this.$config.base_url}/upload`,{data:e,headers:{Accept:"application/json",Authorization:`Bearer ${this.$data.token}`,"User-Agent":g.getRandomPCUA(),Referer:`${this.$config.base_url}/`,Origin:this.$config.base_url},allowInterceptConfig:false});if(!i.status){b.error(i),y.error(this.$config.TAG+"网络异常，上传图片失败");return}if(i.data.status in this.$code){b.error(i),y.error(this.$config.TAG+this.$code[i.data.status]);return}let n=g.toJSON(i.data.responseText);if(b.info(n),!n.status){y.error(this.$config.TAG+n.message);return}y.success(this.$config.TAG+"上传成功");let s=new FileReader;return s.readAsDataURL(t),await new Promise(l=>{s.onload=function(){let a={imageUri:this.result,data:n.data};l(a);};})},async deleteImage(t){let e=await H.delete(this.$config.base_url+"/images/"+t,{timeout:15e3,headers:{Accept:"application/json",Authorization:`Bearer ${this.$data.token}`,"User-Agent":g.getRandomPCUA(),Referer:`${this.$config.base_url}/`,Origin:this.$config.base_url},allowInterceptConfig:false});if(e.data.status in this.$code)return y.error(this.$config.TAG+this.$code[e.data.status]),false;let i=g.toJSON(e.data.responseText);return i.status?(y.success(this.$config.TAG+"删除成功"),true):(y.error(this.$config.TAG+i.message),false)}},Bt={$data:{csrf_token:null},$config:{TAG:"MT图床：",base_url:"https://img.binmt.cc"},$tabConfig:{id:"img.binmt.cc",name:"MT图床",labelName:"mt"},init(){const t=this;new zt({id:this.$tabConfig.id,name:this.$tabConfig.name,labelName:this.$tabConfig.labelName,async uploadBtnClickEvent(e){return await t.checkLogin()},async fileChangeEvent(e,i){let n=[],s=y.loading("上传中..."),l=true;for(let o=0;o<Array.from(i).length;o++){const a=Array.from(i)[o];let c=await t.uploadImage(a);c?(n.push({url:c.data.links.url,data:c.data}),l=l&&true):l=l&&false;}return s.close(),{success:l,data:n}},storageSaveCallBack(e){return e.data},async delImageEvent(e,i){return  true}});},async checkLogin(){if(!this.$data.csrf_token){let t=y.loading("正在获取CSRF Token中..."),e=await this.getCSRFToken();if(t.close(),!e)return  false;this.$data.csrf_token=e;}return  true},async getCSRFToken(){var n;let t=await H.get(this.$config.base_url,{allowInterceptConfig:false,headers:{"User-Agent":g.getRandomPCUA(),Referer:this.$config.base_url+"/",Origin:this.$config.base_url}});if(!t.status){y.error(this.$config.TAG+"获取CSRF Token失败，网络异常");return}let i=(n=r.parseHTML(t.data.responseText,true,true).querySelector('meta[name="csrf-token"]'))==null?void 0:n.getAttribute("content");if(i)return b.info("获取的CSRF token：",i),y.success(this.$config.TAG+"获取CSRF Token成功"),i},async uploadImage(t){let e=new FormData;e.append("strategy_id","2"),e.append("file",t);let i=await H.post(`${this.$config.base_url}/upload`,{data:e,headers:{Accept:"application/json, text/javascript, */*; q=0.01","User-Agent":g.getRandomAndroidUA(),Origin:this.$config.base_url,pragma:"no-cache","Accept-Encoding":"gzip, deflate, br","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6",Referer:this.$config.base_url+"/",Pragma:"no-cache","x-csrf-token":this.$data.csrf_token,"X-Requested-With":"XMLHttpRequest"},allowInterceptConfig:false});if(!i.status){b.error(i),y.error(this.$config.TAG+"网络异常，上传图片失败");return}let n=g.toJSON(i.data.responseText);if(b.info(n),!n.status){b.error(i),y.error(this.$config.TAG+n.message||JSON.stringify(n));return}y.success(this.$config.TAG+"上传成功");let s=new FileReader;return s.readAsDataURL(t),await new Promise(l=>{s.onload=function(){let a={imageUri:this.result,data:n.data};l(a);};})}},Ut=()=>({rainbow1:{key:"转普通彩虹",value:"",isFunc:true,num:1},rainbow2:{key:"转黑白彩虹",value:"",isFunc:true,num:2},rainbow3:{key:"转黑红彩虹",value:"",isFunc:true,num:3},rainbow4:{key:"转蓝绿彩虹",value:"",isFunc:true,num:4},size:{key:"大小",value:"[size=][/size]",tagL:"=",tagR:"]",L:"[size=]",R:"[/size]",cursorL:"[size=",cursorLength:6,quickUBBReplace:"[size=14]replace[/size]"},color:{key:"颜色",value:"[color=][/color]",tagL:"=",tagR:"]",L:"[color=]",R:"[/color]",cursorL:"[color=",cursorLength:7,quickUBBReplace:"[color=#000]replace[/color]"},b:{key:"加粗",value:"[b][/b]",tagL:"]",tagR:"[",L:"[b]",R:"[/b]",cursorR:"[/b]",cursorLength:4,quickUBBReplace:"[b]replace[/b]"},u:{key:"下划线",value:"[u][/u]",tagL:"]",tagR:"[",L:"[u]",R:"[/u]",cursorR:"[/u]",cursorLength:4,quickUBBReplace:"[u]replace[/u]"},i:{key:"倾斜",value:"[i][/i]",tagL:"]",tagR:"[",L:"[i]",R:"[/i]",cursorR:"[/i]",cursorLength:4,quickUBBReplace:"[i]replace[/i]"},s:{key:"中划线",value:"[s][/s]",tagL:"]",tagR:"[",L:"[s]",R:"[/s]",cursorR:"[/s]",cursorLength:4,quickUBBReplace:"[s]replace[/s]"},lineFeed:{key:"换行",value:"[*]",L:"",R:"[*]",cursorL:"[*]",cursorLength:3,quickUBBReplace:"replace[*]"},longHorizontalLine:{key:"水平线",value:"[hr]",L:"",R:"[hr]",cursorL:"[hr]",cursorLength:4,quickUBBReplace:"replace[hr]"},link:{key:"链接",value:"[url=][/url]",tagL:"=",tagR:"]",L:"[url=]",R:"[/url]",cursorL:"[url=",cursorLength:5,quickUBBReplace:"[url=replace]replace[/url]"},hide:{key:"隐藏",value:`[hide]
[/hide]`,tagL:"]",tagR:"[",L:"[hide]",R:"[/hide]",cursorR:"[/hide]",cursorLength:7,quickUBBReplace:`[hide]replace
[/hide]`},quote:{key:"引用",value:"[quote][/quote]",tagL:"]",tagR:"[",L:"[quote]",R:"[/quote]",cursorR:"[/quote]",cursorLength:8,quickUBBReplace:"[quote]replace[/quote]"},email:{key:"邮件",value:"[email=][/email]",tagL:"=",tagR:"]",L:"[email=]",R:"[/email]",cursorL:"[email=",cursorLength:7,quickUBBReplace:"[email=replace]replace[/email]"}}),Ft=(t,e)=>{if(e=="")return "";var i=e,n,s,l,o,a,c,m,d;if(l=0,o=0,a=0,d=0,n="",t==1){d=40,l=255,c=1,m=0;do i.charCodeAt(m)!=32?(o+d<256?c==1&&(o+=d):c==1&&(c=2,o=255),l-d>-1?c==2&&(l-=d):c==2&&(c=3,l=0),a+d<256?c==3&&(a+=d):c==3&&(c=4,a=255),o-d>-1?c==4&&(o-=d):c==4&&(c=5,o=0),l+d<256?c==5&&(l+=d):c==5&&(c=6,l=255),a-d>-1?c==6&&(a-=d):c==6&&(c=1,a=0),s="",s+=parseInt(l).toString(16).length==1?0+parseInt(l).toString(16):parseInt(l).toString(16),s+=parseInt(o).toString(16).length==1?0+parseInt(o).toString(16):parseInt(o).toString(16),s+=parseInt(a).toString(16).length==1?0+parseInt(a).toString(16):parseInt(a).toString(16),s=s.toUpperCase(),n+=`[color=#${s}]${i.charAt(m)}[/color]`):n+=i.charAt(m),m++;while(m<i.length)}else if(t==2)for(d=255/i.length,c=1;c<i.length+1;c++)i.charCodeAt(c-1)!=32?(l+=d,o+=d,a+=d,l>255&&(l=255),o>255&&(o=255),a>255&&(a=255),s="",s+=parseInt(l).toString(16).length==1?0+parseInt(l).toString(16):parseInt(l).toString(16),s+=parseInt(o).toString(16).length==1?0+parseInt(o).toString(16):parseInt(o).toString(16),s+=parseInt(a).toString(16).length==1?0+parseInt(a).toString(16):parseInt(a).toString(16),s=s.toUpperCase(),n+=`[color=#${s}]${i.charAt(c-1)}[/color]`):n+=i.charAt(c-1);else if(t==3)for(d=255/i.length,c=1;c<i.length+1;c++)i.charCodeAt(c-1)!=32?(l+=d,o=29,a=36,l>255&&(l=255),o>255&&(o=255),a>255&&(a=255),s="",s+=parseInt(l).toString(16).length==1?0+parseInt(l).toString(16):parseInt(l).toString(16),s+=parseInt(o).toString(16).length==1?0+parseInt(o).toString(16):parseInt(o).toString(16),s+=parseInt(a).toString(16).length==1?0+parseInt(a).toString(16):parseInt(a).toString(16),s=s.toUpperCase(),n+=`[color=#${s}]${i.charAt(c-1)}[/color]`):n+=i.charAt(c-1);else if(t==4)for(d=255/i.length,c=1;c<i.length+1;c++)i.charCodeAt(c-1)!=32?(l=0,o=174,a+=d,l>255&&(l=255),o>255&&(o=255),a>255&&(a=255),s="",s+=parseInt(l).toString(16).length==1?0+parseInt(l).toString(16):parseInt(l).toString(16),s+=parseInt(o).toString(16).length==1?0+parseInt(o).toString(16):parseInt(o).toString(16),s+=parseInt(255-a).toString(16).length==1?0+parseInt(255-a).toString(16):parseInt(255-a).toString(16),s=s.toUpperCase(),n+=`[color=#${s}]${i.charAt(c-1)}[/color]`):n+=i.charAt(c-1);return n},re=function(){x.$.fn.extend({insertAtCaret:function(t){var e=x.$(this)[0];if(document.selection){this.focus();var i=document.selection.createRange();i.text=t,this.focus();}else if(e.selectionStart||e.selectionStart=="0"){var n=e.selectionStart,s=e.selectionEnd,l=e.scrollTop;e.value=e.value.substring(0,n)+t+e.value.substring(s,e.value.length),this.focus(),e.selectionStart=n+t.length,e.selectionEnd=n+t.length,e.scrollTop=l;}else this.value+=t,this.focus();},selectRange:function(t,e){return e===void 0&&(e=t),this.each(function(){if("selectionStart"in this)this.selectionStart=t,this.selectionEnd=e;else if(this.setSelectionRange)this.setSelectionRange(t,e);else if(this.createTextRange){var i=this.createTextRange();i.collapse(true),i.moveEnd("character",e),i.moveStart("character",t),i.select();}})},getCursorPosition:function(){var t=x.$(this)[0],e=0;if("selectionStart"in t)e=t.selectionStart;else if("selection"in document){t.focus();var i=document.selection.createRange(),n=document.selection.createRange().text.length;i.moveStart("character",-t.value.length),e=i.text.length-n;}return e},moveCursorInCenterByText:function(t,e){var i=x.$(this)[0],n=i.value;for(let s=i.selectionStart-1;s>0;s--){let l=n[s-1],o=n[s];if(l==t&&o==e){this.selectRange(s);break}}},moveCursorToCenterByTextWithLeft:function(t,e){var i=x.$(this)[0],n=i.value;for(let s=i.selectionStart-1;s>0;s--)if(n.substring(s-e,s)==t){this.selectRange(s);break}},moveCursorToCenterByTextWithRight:function(t,e){var i=x.$(this)[0],n=i.value;for(let s=i.selectionStart-1;s>0;s--)if(n.substring(s,s+e)==t){this.selectRange(s+e);break}}});};let Mt={1:{error_match:"抱歉，您填写的内容包含敏感词而无法提交",popup_text:"抱歉，您填写的内容包含敏感词而无法提交"},2:{error_match:"抱歉，管理员设置了本版块发表于 30 天以前的主题自动关闭，不再接受新回复",popup_text:"抱歉，管理员设置了本版块发表于 30 天以前的主题自动关闭，不再接受新回复"},3:{error_match:"抱歉，本主题已关闭，不再接受新内容",popup_text:"抱歉，本主题已关闭，不再接受新内容"},4:{error_match:"抱歉，管理员设置了本版块发表于 30 天以前的主题自动关闭，不再接受新回复",popup_text:"抱歉，管理员设置了本版块发表于 30 天以前的主题自动关闭，不再接受新回复"},5:{error_match:"抱歉，您的帖子小于 10 个字符的限制",popup_text:"抱歉，您的帖子小于 10 个字符的限制"}},yt=null;const tt={$data:{isUBBCodeInsertClick:false,db:new st.indexedDB("mt_reply_record","input_text"),forum_action:null,get tid(){return F.getThreadId(window.location.href)}},$el:{$like:null,$btn_submit:null,$input:null,$form:null,$fastpostsubmit:null},init(){b.info("编辑器优化-简略版"),W(ae),this.overridePageEditor();},overridePageEditor(){let t=document.querySelector("#comiis_foot_memu .comiis_flex li:nth-child(2)"),e=document.querySelector("#comiis_foot_memu .comiis_flex li:nth-child(3)"),i=document.querySelector("#comiis_foot_memu .comiis_flex li:nth-child(4)");this.$el.$form=document.querySelector("#fastpostform"),this.$data.forum_action=this.$el.$form.getAttribute("action");let n=r.serialize(this.$el.$form),s=document.querySelector("#fastpostform .header_y a").href;r.remove("#needmessage[name='message']"),r.remove("#imglist"),r.remove("#fastpostsubmitline"),r.remove("#fastpostsubmit");let l=document.querySelector("#comiis_foot_memu");r.hide(l,false);let o=oe(),a=Object.keys(o[0]).map(d=>{let u=o[0][d];return `<li><a href="javascript:;" onclick="comiis_addsmilies('${d}');"><img loading="lazy" data-src="${u}" class="vm"></a></li>`}),c=Object.keys(o[1]).map(d=>{let u=o[1][d];return `<li><a href="javascript:;" onclick="comiis_addsmilies('${d}');"><img loading="lazy" data-src="${u}" class="vm"></a></li>`}),m=Object.keys(o[2]).map(d=>{let u=o[2][d];return `<li><a href="javascript:;" onclick="comiis_addsmilies('${d}');"><img loading="lazy" data-src="${u}" class="vm"></a></li>`});r.after(l,`
...
`)}    
            ...
            `),C("#comiis_foot_menu_beautify .comiis_position_key"),this.$el.$like=C("#comiis_foot_menu_beautify .comiis_recommend_addkey"),C("#comiis_foot_menu_beautify #comiis_favorite_a"),C("#comiis_pictitle_key"),this.$el.$btn_submit=C('#comiis_foot_menu_beautify_big li[data-attr="发表"] input'),this.$el.$input=C("#comiis_foot_menu_beautify_big textarea"),this.$el.$fastpostsubmit=C("#fastpostsubmit"),x.textarea_scrollHeight=()=>{},typeof x.comiis_addsmilies=="function"&&(x.comiis_addsmilies=d=>{x.$("#needmessage").comiis_insert(d),x.$("#needmessage")[0].dispatchEvent(new Event("propertychange"));}),x.$("#imglist .up_btn").append(x.$("#filedata")),x.$(document).on("click","#imglist .up_btn a",function(){x.$(this).next().click();}),x.$(document).on("click","#imglist .p_img a",function(){let d=x.$(this);if(d.attr("onclick")==null){let u=d.find("img").attr("id").replace("aimg_","");x.comiis_addsmilies(`[attachimg]${u}[/attachimg]`);}}),r.hide("#comiis_foot_menu_beautify_big .menu_body",false),this.setInputChangeEvent(),this.setLikeBtnClickEvent(),this.setSubmitBtnClickEvent(),this.setGlobalReplyBtnClickEvent(),this.setGlobalClickCheckEvent(),this.setMenuIconToggleEvent(),this.setMenuImageClickEvent(),this.setMenuImageToggleEvent(),this.setMenuSmileClickEvent(),this.setMenuSmileTabClickEvent(),this.setMenuInsertClickEvent(),this.setMenuQuickUBB(),$.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{this.initReplyText(),this.setInputChangeSaveEvent();}),$.execMenuOnce("mt-image-bed-hello-enable",()=>{Nt.init();}),$.execMenuOnce("mt-image-bed-mt-enable",()=>{Bt.init();});},handle_error(t){let e=false,i=r.text(r.parseHTML(t,false,false).querySelector("#messagetext"));return !i||typeof i=="string"&&i.trim()==""||Object.keys(Mt).forEach(n=>{let s=Mt[n];if(i.indexOf(s.error_match)!=-1){i.indexOf("typeof errorhandle_=='function'")!=-1&&y.error(s.popup_text),e=true;return}}),e},setInputChangeEvent(){const t=this;r.on(t.$el.$input,["input","propertychange"],function(e){var n,s;t.$el.$input.value===""?(t.$el.$btn_submit.setAttribute("data-text","false"),(n=C("#comiis_foot_menu_beautify li[data-attr='回帖'] input"))==null||n.setAttribute("placeholder","发帖千百度，文明第一步")):(t.$el.$btn_submit.setAttribute("data-text","true"),(s=C("#comiis_foot_menu_beautify li[data-attr='回帖'] input"))==null||s.setAttribute("placeholder","[草稿待发送]")),r.css(t.$el.$input,"height","70px"),r.css(t.$el.$input,"height",t.$el.$input.scrollHeight-20+"px");});},setInputChangeSaveEvent(){const t=this;r.on(this.$el.$input,["input","propertychange"],e=>{let i=t.$el.$input.value,s=t.$el.$input.closest(".reply_area").querySelector(".reply_user_content").getAttribute("data-reply-url"),l={url:window.location.href,text:i,repquote:s?F.getRepquote(s):void 0,forumId:t.$data.tid};t.$data.db.get("data").then(o=>{if(!o.success||o.code===201){console.warn(o);return}let a=o.data.findIndex(c=>c.forumId===l.forumId&&c.repquote===l.repquote);a!==-1?i==null||i===""?o.data.splice(a,1):o.data[a]=g.assign(o.data[a],{text:l.text}):o.data.push(l),t.$data.db.save("data",o.data).then(c=>{});});});},async initReplyText(t=false,e=void 0){const i=this;(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let s=await this.$data.db.get("data");if(!s.success||s.code===201){console.warn(s);return}let l;e&&(l=F.getRepquote(e));let o=s.data.find(a=>t?a.forumId===i.$data.tid&&a.repquote==l:a.forumId===i.$data.tid&&a.repquote==null);o&&(r.val(this.$el.$input,o.text),g.dispatchEvent(this.$el.$input,"input"));},setLikeBtnClickEvent(){r.on(this.$el.$like,"click",async t=>{var l,o;if(g.preventEvent(t),x.comiis_recommend_key==0){x.comiis_recommend_key=1;let a=await H.get(this.$el.$like.href+"&inajax=1",{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false});if(!a.status){window.location.href=this.$el.$like.href,setTimeout(function(){x.comiis_recommend_key=0;},500);return}let m=(o=(l=g.parseFromString(a.data.responseText,"text/xml").lastChild)==null?void 0:l.firstChild)==null?void 0:o.nodeValue;if(m.includes("您已评价过本主题")){let d=this.$el.$like.href.match(X.tid)[1];if(!(await H.get(`plugin.php?id=comiis_app&comiis=re_recommend&tid=${d}&inajax=1`,{headers:{Accept:"application/xml, text/xml, */*; q=0.01"},fetch:true,allowInterceptConfig:false})).status){y.error("取消点赞失败，网络异常");return}var e=Number(r.text("#comiis_recommend_num"));document.querySelectorAll(".comiis_recommend_list_a").length>0&&r.remove("#comiis_recommend_list_a"+x.uid),document.querySelectorAll(".comiis_recommend_list_s").length>0&&r.remove("#comiis_recommend_list_s"+x.uid),document.querySelectorAll(".comiis_recommend_list_t").length>0&&r.remove("#comiis_recommend_list_t"+x.uid),e>1?(r.text(".comiis_recommend_num",e-Number(x.allowrecommend)),r.text(".comiis_recommend_nums","+"+(e-Number(x.allowrecommend)))):(r.remove("#comiis_recommend_num"),r.text(".comiis_recommend_nums",""),document.querySelectorAll(".comiis_recommend_list_a").length>0&&(r.empty(".comiis_recommend_list_a"),r.removeClass(".comiis_recommend_list_a","comiis_recommend_list_on")),document.querySelectorAll(".comiis_recommend_list_t").length>0&&r.removeClass(".comiis_recommend_list_t","comiis_recommend_list_on")),r.html(".comiis_recommend_addkey i","&#xe63b;"),r.removeClass(".comiis_recommend_color","f_a"),r.addClass(".comiis_recommend_color","f_b"),document.querySelectorAll(".comiis_recommend_list_s").length>0&&(document.querySelectorAll(".comiis_recommend_list_s li").length<7?r.hide(".txshow_more",false):r.show(".txshow_more",false)),y.success("已取消点赞");}else if(m.includes("您不能评价自己的帖子"))y.error("不能点赞自己的帖子");else if(m.includes("今日评价机会已用完"))y.warning("您今日的点赞机会已用完");else if(m.includes("'recommendv':'+"+x.allowrecommend+"'")){var i={recommendc:0,daycount:0},n;n=m.match(/\'recommendc\':\'(.*?)\'/),n!=null?i.recommendc=parseInt(n[1]):i.recommendc=0,n=m.match(/\'daycount\':\'(.*?)\'/),n!=null?i.daycount=parseInt(n[1]):i.daycount=0,document.querySelectorAll(".comiis_recommend_new span").length<1&&r.append(".comiis_recommend_new",'<span class="bg_del f_f comiis_kmvnum comiis_recommend_num" id="comiis_recommend_num">0</span>');var s=Number(r.text("#comiis_recommend_num"));if(U(".comiis_recommend_list_a").length>0){let d=U(".comiis_recommend_list_a");r.removeClass(d,"comiis_recommend_list_on"),r.addClass(d,"comiis_recommend_list_on"),r.prepend(d,(U(".comiis_recommend_list_a li").length>0?"":'<li style="float:right;margin-right:0;"><a href="misc.php?op=recommend&tid= '+x.tid+'&mod=faq&mobile=2"><span class="bg_b f_c"><em class="comiis_recommend_num">'+s+"</em>赞</span></a></li>")+'<li id="comiis_recommend_list_a'+x.uid+'"><a href="home.php?mod=space&uid='+x.uid+'"><img src="'+F.getAvatar(x.uid,"small")+'"></a></li>');}if(U(".comiis_recommend_list_t").length>0){let d=U(".comiis_recommend_list_t");r.removeClass(d,"comiis_recommend_list_on"),r.addClass(d,"comiis_recommend_list_on"),r.prepend(d,`<span id="comiis_recommend_list_t${x.uid}">
                          							<a href="home.php?mod=space&uid=${x.uid}" class="f_c">${x.username}</a>
													${U(".comiis_recommend_list_t a").length>0?'<span class="f_d"> , </span>':""}
                        						</span>`);}if(U(".comiis_recommend_list_s").length>0){let d=U(".comiis_recommend_list_s");r.removeClass(d,"comiis_recommend_list_on"),r.addClass(d,"comiis_recommend_list_on"),r.prepend(d,(U(".comiis_recommend_list_s li").length>0,""+'<li id="comiis_recommend_list_s'+x.uid+'"><a href="home.php?mod=space&uid='+x.uid+'"><img loading="lazy" src="'+F.getAvatar(x.uid,"small")+'"></a></li>'));}r.text(".comiis_recommend_num",s+Number(x.allowrecommend)),r.text(".comiis_recommend_nums","+"+(s+Number(x.allowrecommend))),r.html(".comiis_recommend_addkey i","&#xe654;"),r.removeClass(".comiis_recommend_color","f_b"),r.addClass(".comiis_recommend_color","f_a"),U(".comiis_recommend_list_s").length>0&&(U(".comiis_recommend_list_s li").length<7?r.hide(".txshow_more",false):r.show(".txshow_more",false)),y.success("点赞成功"+(i.daycount?`, 您今天还能点赞 ${i.daycount-1} 次`:""));}else m.indexOf("window.location.href = 'member.php?mod=logging&action=login&mobile=2'")>=0?window.location.href="member.php?mod=logging&action=login&mobile=2":y.error("没有点赞权限或帖子不存在");setTimeout(function(){x.comiis_recommend_key=0;},500);}return  false});},setSubmitBtnClickEvent(){const t=this;r.on(this.$el.$fastpostsubmit,"click",async e=>{var s,l,o,a,c,m;g.preventEvent(e);var i=C("#needmessage"),n=r.val(i);if(n=encodeURIComponent(n),!(n==null||n==="")){if(r.val(t.$el.$fastpostsubmit)=="发表"){let d=y.loading("发表中，请稍后..."),u="message="+n;U("#imglist input[type='hidden']").forEach(k=>{let v=k.getAttribute("name");u+=`&${v}=`;}),u=r.serialize(t.$el.$form)+"&"+u;let f=t.$data.forum_action+"reply&handlekey=fastpost&loc=1&inajax=1",p=await H.post(f,{data:u,fetch:true,allowInterceptConfig:false,headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(d.close(),!p.status){y.error("发表失败，网络异常");return}let _=(l=(s=g.parseFromString(p.data.responseText,"text/xml").lastChild)==null?void 0:s.firstChild)==null?void 0:l.nodeValue;if(x.evalscript(_),this.handle_error(_))return;window.scrollTo({top:r.height(document)}),r.val("#needmessage",""),(o=C("#comiis_head"))==null||o.click(),r.hide("#comiis_foot_menu_beautify_big .reply_user_content",false),r.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),r.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"),this.deleteReplyTextStorage();}else {let d=r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-serialize")+n;U("#imglist input[type='hidden']").forEach(_=>{d=`${d}&${_.getAttribute("name")}=`;});let u=r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-action"),f=await H.post(u+"&handlekey=fastposts&loc=1&inajax=1",{allowInterceptConfig:false,fetch:true,data:d,headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(!f.status){y.error("回复失败，网络异常");return}let h=(c=(a=g.parseFromString(f.data.responseText,"text/xml").lastChild)==null?void 0:a.firstChild)==null?void 0:c.nodeValue;if(b.info(h),x.evalscript(h),this.handle_error(h))return;(m=C(h))==null||m.click(),r.val("#needmessage",""),C("#comiis_head").click(),r.val('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"发表"),r.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),r.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"),window.scrollTo({top:r.height(document)}),this.deleteReplyTextStorage(true,u);}return  false}});},setGlobalReplyBtnClickEvent(){r.on(document,"click",'.comiis_postli_times .dialog[href*="reply"]',async t=>{var u,f,p,h;g.preventEvent(t);let e=t.target;r.attr("#comiis_foot_menu_beautify_big","data-model","reply");let i=await H.get(r.attr(e,"datahref")||e.href+"&inajax=1",{fetch:true,allowInterceptConfig:false});if(!i.status){y.error("网络异常，获取回复参数失败");return}let s=(f=(u=g.parseFromString(i.data.responseText,"text/xml").lastChild)==null?void 0:u.firstChild)==null?void 0:f.nodeValue;if(this.handle_error(s))return;let l=r.parseHTML(`<div>${s}</div>`,true,false),o=(p=l.querySelector(".comiis_tip .tip_tit a"))==null?void 0:p.getAttribute("href"),a=r.text(l.querySelector(".comiis_tip span.f_0")),c=r.val(l.querySelector("input[name='noticeauthormsg']")),m=r.attr(l.querySelector("#postforms"),"action"),d=r.serialize(l.querySelector("#postforms"));r.text("#comiis_foot_menu_beautify_big .reply_user_content",`回复 ${a}: ${c}`),r.show("#comiis_foot_menu_beautify_big .reply_user_content",false),(h=C("#comiis_foot_menu_beautify li[data-attr='回帖'] input"))==null||h.click(),r.focus("#comiis_foot_menu_beautify li[data-attr='回帖'] input"),r.val("#fastpostsubmitline input","回复"),r.attr("#comiis_foot_menu_beautify_big .fastpostform_new a","href",o),r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-url",o),r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-action",m),r.attr("#comiis_foot_menu_beautify_big .reply_user_content","data-reply-serialize",d),yt=e,r.val("#needmessage",r.attr(e,"data-text")||""),$.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{this.initReplyText(true,o);});},{capture:true});},setGlobalClickCheckEvent(){const t=this;let e=C("#fastpostform .header_y a").href;r.on(document,"click",function(i){var s;let n=i.target;if(C(".popups-popmenu")||tt.$data.isUBBCodeInsertClick){b.info("点击的是弹出层，不做处理"),tt.$data.isUBBCodeInsertClick=false;return}else n!=null&&n.classList&&((s=n==null?void 0:n.classList)!=null&&s.contains(".dialog_reply"))||n!=null&&n.closest&&(n!=null&&n.closest(".dialog_reply"))||n===C('li[data-attr="回帖"] input')?(b.info("点击回复按钮或者是编辑器，显示编辑器"),r.hide("#comiis_foot_menu_beautify",false),r.show("#comiis_foot_menu_beautify_big",false),r.focus("#needmessage")):window.event&&!g.checkUserClickInNode(C("#comiis_foot_menu_beautify_big"))&&(b.info("点击的其它区域，隐藏大编辑器，显示小编辑器"),r.show("#comiis_foot_menu_beautify",false),r.hide("#comiis_foot_menu_beautify_big",false),r.attr("#comiis_foot_menu_beautify_big","data-model")=="reply"&&(r.attr("#comiis_foot_menu_beautify_big","data-model","comment"),r.val("#fastpostsubmitline input","发表"),r.attr("#comiis_foot_menu_beautify_big .fastpostform_new a","href",e),r.text("#comiis_foot_menu_beautify_big .reply_area .reply_user_content"),r.hide("#comiis_foot_menu_beautify_big .reply_area .reply_user_content",false),r.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-url",""),r.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-action",""),r.attr("#comiis_foot_menu_beautify_big .reply_area .reply_user_content","data-reply-serialize",""),yt&&(r.attr(yt,"data-text",r.val("#needmessage")),r.val("#needmessage",""),r.attr('#comiis_foot_menu_beautify_big li[data-attr="发表"] input',"data-text","false"),r.attr("#comiis_foot_menu_beautify li[data-attr='回帖'] input","placeholder","发帖千百度，文明第一步"))),r.val(t.$el.$input)===""&&$.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{t.initReplyText();}));});},setMenuIconToggleEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a i","click",function(t){let e=this;e.classList.contains("f_0")?(r.hide("#comiis_foot_menu_beautify_big .menu_body",false),r.removeClass("#comiis_foot_menu_beautify_big .menu_icon a i","f_0")):(r.show("#comiis_foot_menu_beautify_big .menu_body",false),r.removeClass("#comiis_foot_menu_beautify_big .menu_icon a i","f_0"),r.addClass(e,"f_0"));});},setMenuImageClickEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a.comiis_pictitle","click",function(t){r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",false),r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",false),r.show("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",false);});},setMenuImageToggleEvent(){r.on("#comiis_foot_menu_beautify_big #comiis_pictitle_tab #comiis_pictitle_key","click","li",function(t){let e=t.target;r.removeClass("#comiis_foot_menu_beautify_big #comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),r.addClass(e,"bg_f"),x.$("#comiis_foot_menu_beautify_big #comiis_pictitle_tab div.comiis_upbox").hide().eq(x.$(e).index()).fadeIn();});},setMenuSmileClickEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a.comiis_smile","click",function(t){r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",false),r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",false),r.show("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",false);let e=C("#comiis_foot_menu_beautify_big .menu_body .comiis_bqbox");r.attr(e,"data-isLoaded")!=1&&(r.attr(e,"data-isLoaded",1),e.querySelectorAll("img").forEach(i=>{let n=i.getAttribute("data-src");n&&i.setAttribute("src",n);}));});},setMenuSmileTabClickEvent(){r.on("#comiis_foot_menu_beautify_big #comiis_smilies_key li","click",function(t){let e=this;r.removeClass("#comiis_foot_menu_beautify_big #comiis_smilies_key li a"),r.addClass(e.querySelector("a"),"bg_f b_l b_r"),x.$("#comiis_post_tab div.swiper-wrapper.bqbox_c.comiis_optimization .swiper-slide").hide().eq(x.$(e).index()).fadeIn();});},setMenuInsertClickEvent(){r.on("#comiis_foot_menu_beautify_big .menu_icon a.commis_insert_bbs","click",t=>{r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_post_tab",false),r.hide("#comiis_foot_menu_beautify_big .menu_body #comiis_pictitle_tab",false),r.show("#comiis_foot_menu_beautify_big .menu_body #comiis_insert_ubb_tab",false);});},async getReplyRecordSize(){var e;let t=await this.$data.db.get("data");return t.success?g.getTextStorageSize((e=t==null?void 0:t.data)!=null&&e.length?JSON.stringify(t.data):""):g.formatByteToSize(0)},async clearAllReplyRecord(){return await this.$data.db.deleteAll()},deleteReplyTextStorage(t=false,e=void 0){const i=this;this.$data.db.get("data").then(n=>{if(!n.success||n.code===201){console.warn(n);return}let s=n.data.findIndex(l=>t?l.forumId===i.$data.tid&&e&&l.repquote===F.getRepquote(e):l.forumId===i.$data.tid&&g.isNull(l.repquote));s!==-1&&(n.data.splice(s,1),this.$data.db.save("data",n.data).then(l=>{}));});},setMenuQuickUBB(){let t=C("#comiis_insert_ubb_tab_list"),e=Ut();Reflect.set(e,"code",{key:"代码",value:"[code][/code]",tagL:"]",tagR:"[",L:"[code]",R:"[/code]",cursorL:"[code]",cursorLength:7,quickUBBReplace:"[code]replace[/code]"}),Reflect.set(e,"password",{key:"密码",value:"[password][/password]",tagL:"]",tagR:"[",L:"[password]",R:"[/password]",cursorL:"[password]",cursorLength:10,quickUBBReplace:"[password]replace[/password]"}),Object.keys(e).forEach(i=>{let n=e[i],s=r.createElement("li",{className:"quickUBBs",innerHTML:`
                    <a href="javascript:;" class="comiis_xifont f_d">
                        <i class="comiis_font"></i>${n.key}
                    </a>
                `});r.on(s,"click",l=>{r.removeClass("#comiis_insert_ubb_tab div.comiis_post_urlico ul li.quickUBBs a.comiis_xifont","f_0"),r.addClass("#comiis_insert_ubb_tab div.comiis_post_urlico ul li.quickUBBs a.comiis_xifont","f_d");let o=s.querySelector(".comiis_xifont");r.removeClass(o,"f_d"),r.removeClass(o,"f_d");let a=N.prompt({title:{text:"UBB代码",position:"center"},content:{text:"",placeholder:`请输入需要${n.key}的文字`,focus:true},btn:{ok:{text:"插入",type:"primary",callback:c=>{if(c.text.trim()===""){y.error("输入框不能为空或纯空格");return}n.isFunc?x.comiis_addsmilies(Ft(n.num,c.text)):n.quickUBBReplace?x.comiis_addsmilies(n.quickUBBReplace.replaceAll("replace",c.text)):x.comiis_addsmilies(c.text),a.close();}},cancel:{text:"关闭",callback:()=>{a.close();}}},width:"300px",height:"200px"});}),t.append(s);});}},le=`.f_c,\r
.f_c a,\r
.ntc_body {\r
...
`,K=globalThis.location.pathname,Q=globalThis.location.search;new URLSearchParams(Q);const M={isKMiSign(){return K.startsWith("/k_misign-sign.html")},isPost(){return K.startsWith("/thread-")||K.startsWith("/forum.php")&&Q.startsWith("?mod=viewthread")},isPage(){return !!K.match(/^\/page-([0-9]+).html/g)},isGuide(){return K.startsWith("/forum.php")&&Q.startsWith("?mod=guide")},isPlate(){return !!K.match(/\/forum-[0-9]{1,2}-[0-9]{1,2}.html/g)},isSearch(){return K.startsWith("/search.php")},isSpace(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space")},isMySpace(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space&do=profile&mycenter")},isSpaceWithAt(){return K.startsWith("/space-uid-")},isForumList(){return K.startsWith("/forum.php")&&Q.startsWith("?forumlist")},isMessage(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space&do=notice")},isMessageList(){return K.startsWith("/home.php")&&Q.startsWith("?mod=space&do=pm")},isPointsMall(){return K.startsWith("/keke_integralmall-keke_integralmall.html")||K.startsWith("/plugin.php")&&Q.startsWith("?id=keke_integralmal")},isPostPublish(){return K.startsWith("/forum.php")&&Q.startsWith("?mod=post")},isPostPublish_voting(){return K.startsWith("/forum.php")&&Q.includes("&special=1")||Q.includes("&fid=42")},isPostPublish_edit(){return this.isPostPublish()&&Q.includes("&action=edit")},isPostPublish_newthread(){return this.isPostPublish()&&Q.includes("&action=newthread")},isPostPublish_reply(){return this.isPostPublish()&&Q.includes("&action=reply")}},ce=()=>({"[呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq001.gif","[撇嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq002.gif","[色]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq003.gif","[发呆]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq004.gif","[得意]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq005.gif","[流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq006.gif","[害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq007.gif","[闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq008.gif","[睡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq009.gif","[大哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq010.gif","[尴尬]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq011.gif","[发怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq012.gif","[调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq013.gif","[呲牙]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq014.gif","[惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq015.gif","[难过]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq016.gif","[酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq017.gif","[冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq018.gif","[抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq019.gif","[吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq020.gif","[偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq021.gif","[可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq022.gif","[白眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq023.gif","[傲慢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq024.gif","[饥饿]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq025.gif","[困]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq026.gif","[惊恐]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq027.gif","[流汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq028.gif","[憨笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq029.gif","[装逼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq030.gif","[奋斗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq031.gif","[咒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq032.gif","[疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq033.gif","[嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq034.gif","[晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq035.gif","[折磨]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq036.gif","[衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq037.gif","[骷髅]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq038.gif","[敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq039.gif","[再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq040.gif","[擦汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq041.gif","[抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq042.gif","[鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq043.gif","[糗大了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq044.gif","[坏笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq045.gif","[左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq046.gif","[右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq047.gif","[哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq048.gif","[鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq049.gif","[委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq050.gif","[快哭了]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq051.gif","[阴脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq052.gif","[亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq053.gif","[吓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq054.gif","[可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq055.gif","[眨眼睛]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq056.gif","[笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq057.gif","[dogeQQ]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq058.gif","[泪奔]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq059.gif","[无奈]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq060.gif","[托腮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq061.gif","[卖萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq062.png","[斜眼笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq063.gif","[喷血]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq064.gif","[惊喜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq065.gif","[骚扰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq066.gif","[小纠结]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq067.gif","[我最美]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq068.gif","[菜刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq069.gif","[西瓜]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq070.gif","[啤酒]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq071.gif","[篮球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq072.gif","[乒乓]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq073.gif","[咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq074.gif","[饭]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq075.gif","[猪]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq076.gif","[玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq077.gif","[凋谢]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq078.gif","[示爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq079.gif","[爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq080.gif","[心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq081.gif","[蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq082.gif","[闪电]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq083.gif","[炸弹]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq084.gif","[刀]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq085.gif","[足球]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq086.gif","[瓢虫]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq087.gif","[便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq088.gif","[月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq089.gif","[太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq090.gif","[礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq091.gif","[抱抱]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq092.gif","[喝彩]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq93.gif","[祈祷]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq94.gif","[棒棒糖]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq95.gif","[药]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq96.gif","[赞]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq097.gif","[差劲]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq098.gif","[握手]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq099.gif","[胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq100.gif","[抱拳]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq101.gif","[勾引]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq102.gif","[拳头]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq103.gif","[爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq105.gif","[NO]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq106.gif","[OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/qq/qq107.gif","[#呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_1.png","[#滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_10.png","[#吐舌]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_3.png","[#哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_2.png","[#啊]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_23.png","[#酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_22.png","[#怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_13.png","[#开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_39.png","[#汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_14.png","[#泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_16.png","[#黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_15.png","[#鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_21.png","[#不高兴]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_12.png","[#真棒]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_17.png","[#钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_40.png","[#疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_26.png","[#阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_20.png","[#吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_34.png","[#咦]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_41.png","[#委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_29.png","[#花心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_6.png","[#呼～]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_42.png","[#激动]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_5.png","[#冷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_43.png","[#可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_4.png","[#What？]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_25.png","[#勉强]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_38.png","[#狂汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_24.png","[#酸爽]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_27.png","[#乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_8.png","[#雅美蝶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_28.png","[#睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_31.png","[#惊哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_19.png","[#哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_44.png","[#笑尿]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_32.png","[#惊讶]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_30.png","[#小乖]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_7.png","[#喷]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_18.png","[#抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_33.png","[#捂嘴笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_9.png","[#你懂的]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_11.png","[#犀利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_35.png","[#小红脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_36.png","[#懒得理]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_37.png","[#爱心]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_45.png","[#心碎]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_46.png","[#玫瑰]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_47.png","[#礼物]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_48.png","[#彩虹]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_49.png","[#太阳]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_50.png","[#月亮]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_51.png","[#钱币]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_52.png","[#咖啡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_53.png","[#蛋糕]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_54.png","[#大拇指]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_55.png","[#胜利]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_56.png","[#爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_57.png","[#OK]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_58.png","[#弱]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_59.png","[#沙发]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_60.png","[#纸巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_61.png","[#香蕉]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_62.png","[#便便]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_63.png","[#药丸]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_64.png","[#红领巾]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_65.png","[#蜡烛]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_66.png","[#三道杠]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_67.png","[#音乐]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_68.png","[#灯泡]":"https://cdn-bbs.mt2.cn/static/image/smiley/comiis_tb/tb_69.png","[doge]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/1.png","[doge思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/2.png","[doge再见]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/3.png","[doge生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/4.png","[doge气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/5.png","[doge笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/7.png","[doge调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/6.png","[doge啊哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/8.png","[doge原谅TA]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/9.png","[miao]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/10.png","[miao思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/11.png","[miao拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/12.png","[miao生气]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/13.png","[miao气哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/14.png","[二哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/15.png","[摊手]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/19.png","[w并不简单]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/20.png","[w滑稽]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/21.png","[w色]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/22.png","[w爱你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/23.png","[w拜拜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/24.png","[w悲伤]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/25.png","[w鄙视]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/26.png","[w馋嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/27.png","[w冷汗]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/28.png","[w打哈欠]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/29.png","[w打脸]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/30.png","[w敲打]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/31.png","[w生病]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/32.png","[w闭嘴]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/33.png","[w鼓掌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/34.png","[w哈哈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/35.png","[w害羞]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/36.png","[w呵呵]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/37.png","[w黑线]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/38.png","[w哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/39.png","[w调皮]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/40.png","[w可爱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/41.png","[w可怜]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/42.png","[w酷]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/43.png","[w困]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/44.png","[w懒得理你]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/45.png","[w流泪]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/46.png","[w怒]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/47.png","[w怒骂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/48.png","[w钱]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/49.png","[w亲亲]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/50.png","[w傻眼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/51.png","[w便秘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/52.png","[w失望]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/53.png","[w衰]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/54.png","[w睡觉]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/55.png","[w思考]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/56.png","[w开心]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/57.png","[w色舔]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/58.png","[w偷笑]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/59.png","[w吐]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/60.png","[w抠鼻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/61.png","[w委屈]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/62.png","[w笑哭]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/63.png","[w嘻嘻]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/64.png","[w嘘]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/65.png","[w阴险]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/66.png","[w疑问]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/67.png","[w抓狂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/70.png","[w晕]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/69.png","[w右哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/68.png","[w左哼哼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/71.png","[w肥皂]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/77.png","[w奥特曼]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/78.png","[w草泥马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/79.png","[w兔子]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/80.png","[w熊猫]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/81.png","[w猪头]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/82.png","[w→_→]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/83.png","[w给力]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/84.png","[w囧]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/85.png","[w萌]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/86.png","[w神马]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/87.png","[w威武]":"https://cdn-bbs.mt2.cn/static/image/smiley/doge/88.png"}),xt={parseText(t){const e=ce();let i=t.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/g);i&&i.forEach(q=>{let w=q.match(/\[attachimg\]([\s\S]+?)\[\/attachimg\]/),T=w?w[w.length-1]:"",z=r.attr(`#aimg_${T}`,"title"),B=r.attr(`#aimg_${T}`,"src");B||(z="该图片不存在"),t=t.replace(q,`<span class="comiis_postimg vm"><img loading="lazy" id="aimg_${T}" src="${B}" alt="${z}" title="${z}"></span>`);});let n=t.match(/\[code\]([\s\S]*?)\[\/code\]/g);n&&n.forEach(q=>{let w=q.match(/\[code\]([\s\S]*?)\[\/code\]/),T=w?w[w.length-1]:"",z="",B=T.split(`
`);B.length==1?z=`<li>${T}</li>`:Array.from(B).forEach((J,at)=>{at==B.length-1?z=`${z}<li>${J}</li>`:z=`${z}<li>${J}<br></li>`;}),t=t.replace(q,`
                <div class="comiis_blockcode comiis_bodybg b_ok f_b"><div class="bg_f b_l"><ol>${z}</ol></div></div>`);});let s=t.match(/\[url\=[\s\S]*?\]([\s\S]*?)\[\/url\]/g);s&&s.forEach(q=>{let w=q.match(/\[url=([\s\S]*?)\][\s\S]*\[\/url\]/),T=q.match(/\[url=[\s\S]*?\]([\s\S]*?)\[\/url\]/),z=w?w[w.length-1]:"",B=T?T[T.length-1]:"";t=t.replace(q,`<a href="${z}" target="_blank">${B}</a>`);});let l=t.match(/\[color\=[\s\S]*?\]([\s\S]*?)\[\/color\]/g);l&&l.forEach(q=>{let w=q.match(/\[color=([\s\S]*?)\][\s\S]*\[\/color\]/),T=q.match(/\[color=[\s\S]*?\]([\s\S]*?)\[\/color\]/),z=w?w[w.length-1]:"",B=T?T[T.length-1]:"";t=t.replace(q,`<font color="${z}">${B}</font>`);});let o=t.match(/\[size\=[\s\S]*?\]([\s\S]*?)\[\/size\]/g);o&&o.forEach(q=>{let w=q.match(/\[size=([\s\S]*?)\][\s\S]*\[\/size\]/),T=q.match(/\[size=[\s\S]*?\]([\s\S]*?)\[\/size\]/),z=w?w[w.length-1]:"",B=T?T[T.length-1]:"";t=t.replace(q,`<font size="${z}">${B}</font>`);});let a=t.match(/\[img(|\=[\s\S]+?)\]([\s\S]*?)\[\/img\]/g);a&&a.forEach(q=>{let w=null,T=null,z=q.match(/\[img\=([\s\S]+?)\][\s\S]*?\[\/img\]/);z&&(z=z[z.length-1].split(","),w=z[0],T=z[1]),w=w||"",T=T||"";let B=q.match(/\[img\]([\s\S]*?)\[\/img\]|\[img=[\s\S]*?\]([\s\S]*?)\[\/img\]/),J="";B&&(B[B.length-1]==null?J=B[B.length-2]:J=B[B.length-1]),t=t.replace(q,`<img loading="lazy" src="${J}" border="0" alt="" width="${w}" height="${T}" crossoriginNew="anonymous">`);});let c=t.match(/\[hide\]([\s\S]*?)\[\/hide\]/g);c&&c.forEach(q=>{let w=q.match(/\[hide\]([\s\S]*?)\[\/hide\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<div class="comiis_quote bg_h f_c"><h2 class="f_a">本帖隐藏的内容: </h2>${T}</div>`);});let m=t.match(/\[hide=[\s\S]*?\]([\s\S]*?)\[\/hide\]/g);m&&m.forEach(q=>{let w=q.match(/\[hide=([\s\S]*?)\]([\s\S]*?)\[\/hide\]/),T=w?w[w.length-2]:"";T=T.split(",");let z=T.length==2?T[1]:"";t=t.replace(q,`<div class="comiis_quote bg_h f_c">以下内容需要积分高于 ${z} 才可浏览</div>`);});let d=t.match(/\[quote\]([\s\S]*?)\[\/quote\]/g);d&&d.forEach(q=>{let w=q.match(/\[quote\]([\s\S]*?)\[\/quote\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<div class="comiis_quote bg_h b_dashed f_c"><blockquote><font>回复</font> ${T}</blockquote></div>`);});let u=t.match(/\[free\]([\s\S]*?)\[\/free\]/g);u&&u.forEach(q=>{let w=q.match(/\[free\]([\s\S]*?)\[\/free\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<div class="comiis_quote bg_h f_c"><blockquote>${T}</blockquote></div>`);});let f=t.match(/\[b\]([\s\S]*?)\[\/b\]/g);f&&f.forEach(q=>{let w=q.match(/\[b\]([\s\S]*?)\[\/b\]/i),T=w?w[w.length-1]:"";t=t.replace(q,`<strong>${T}</strong>`);});let p=t.match(/\[u\]([\s\S]*?)\[\/u\]/g);p&&p.forEach(q=>{let w=q.match(/\[u\]([\s\S]*?)\[\/u\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<u>${T}</u>`);});let h=t.match(/\[i\]([\s\S]*?)\[\/i\]/g);h&&h.forEach(q=>{let w=q.match(/\[i\]([\s\S]*?)\[\/i\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<i>${T}</i>`);});let _=t.match(/\[s\]([\s\S]*?)\[\/s\]/g);_&&_.forEach(q=>{let w=q.match(/\[s\]([\s\S]*?)\[\/s\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<strike>${T}</strike>`);});let k=t.match(/\[([\s\S]+?)\]/g);k&&k.forEach(q=>{let w=e[q];w&&(t=t.replace(q,`<img loading="lazy" src="${w}" border="0" alt="" smilieid="">`));});let v=t.match(/\[media=[\s\S]+?\][\s\S]+?\[\/media\]/g);v&&v.forEach(q=>{let w=q.match(/\[media=[\s\S]*?\]([\s\S]*?)\[\/media\]/),T=w?w[w.length-1]:"";T&&(t=t.replace(q,`<ignore_js_op><span><iframe src="${T}" border="0" scrolling="no" framespacing="0" allowfullscreen="true" style="max-width: 100%" width="100%" height="auto" frameborder="no"></iframe></span></ignore_js_op>`));});let S=t.match(/\[email=[\s\S]+?\][\s\S]+?\[\/email\]/g);S&&S.forEach(q=>{let w=q.match(/\[email=([\s\S]*?)\][\s\S]*?\[\/email\]/),T=q.match(/\[email=[\s\S]*?\]([\s\S]*?)\[\/email\]/),z=w.length?w[w.length-1]:"",B=T.length?T[T.length-1]:"";(z||B)&&(t=t.replace(q,`<a href="mailto:${z}">${B}</a>`));});let A=t.match(/\[align=[\s\S]+?\][\s\S]+?\[\/align\]/g);A&&A.forEach(q=>{let w=q.match(/\[align=([\s\S]*?)\][\s\S]+?\[\/align\]/),T=q.match(/\[align=[\s\S]*?\]([\s\S]+?)\[\/align\]/),z=w.length?w[w.length-1]:"",B=T.length?T[T.length-1]:"";(z||B)&&(t=t.replace(q,`<div align="${z}">${B}</div>`));});let I=t.match(/\[qq\][\s\S]*?\[\/qq\]/g);I&&I.forEach(q=>{let w=q.match(/\[qq\]([\s\S]*?)\[\/qq\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<a href="http://wpa.qq.com/msgrd?v=3&uin=${T}&site=[Discuz!]&from=discuz&menu=yes" target="_blank"><img loading="lazy" src="static/image/common/qq_big.gif" border="0"></a>`);});let P=t.match(/\[td\][\s\S]+?\[\/td\]/g);P&&P.forEach(q=>{let w=q.match(/\[td\]([\s\S]*?)\[\/td\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<td>${T}</td>`);});let E=t.match(/\[tr\][\s\S]+?\[\/tr\]/g);E&&E.forEach(q=>{let w=q.match(/\[tr\]([\s\S]*?)\[\/tr\]/),T=w?w[w.length-1]:"";t=t.replace(q,`<tr>${T}</tr>`);});let R=t.match(/\[table\][\s\S]+?\[\/table\]/g);R&&R.forEach(q=>{let w=q.match(/\[table\]([\s\S]*?)\[\/table\]/),T=w?w[w.length-1]:"";T=T.replace(/\n/g,""),t=t.replace(q,`<table>${T}</table>`);});let O=t.match(/\[list=[\s\S]+?\][\s\S]+?\[\/list\]/g);return O&&O.forEach(q=>{let w=q.match(/\[list=([\s\S]*?)\][\s\S]*?\[\/list\]/),T=q.match(/\[list=[\s\S]*?\]([\s\S]*?)\[\/list\]/),z=w?w[w.length-1]:"",B="";z==="a"?B="litype_2":z==="A"?B="litype_3":z.length===1&&z.match(/[0-9]{1}/)&&(B="litype_1");let J=T?T[T.length-1]:"",at=J.split("[*]");if(at.length>1){let _t="";at[0].replace(/[\s]*/,"")==""&&(at=at.slice(1)),Array.from(at).forEach(Gt=>{_t=`${_t}<li>${Gt}</li>`;}),J=_t;}J=J.replace(/\n/g,""),t=t.replace(q,`<ul type="${z}" class="${B}">${J}</ul>`);}),t},parseVoteText(){let t=["rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)","rgb(233, 39, 37)","rgb(242, 123, 33)","rgb(242, 166, 31)","rgb(90, 175, 74)","rgb(66, 196, 245)","rgb(0, 153, 204)","rgb(51, 101, 174)","rgb(42, 53, 145)","rgb(89, 45, 142)","rgb(219, 49, 145)"],e=U(".comiis_polloption_add ul li:first-child div.flex .comiis_input.kmshow[type='text']"),i=parseInt(r.val("input#maxchoices"));i=isNaN(i)?0:i,i=i>0?i:0,i=i>e.length?e.length:i;let n=parseInt(r.val("input#polldatas"));n=isNaN(n)?0:n,x.$("input#visibilitypoll").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close");let s=!x.$("input#overt").parent().find(".comiis_checkbox").hasClass("comiis_checkbox_close"),l="",o="";e.forEach((a,c)=>{c>=20||(o=o+`
                    <li class="kmnop">
                ...
                `,x.$(".gm_plugin_previewpostforum_html .postforum_vote").remove(),x.$(".gm_plugin_previewpostforum_html .comiis_messages.comiis_aimg_show").children().eq(0).before(x.$(l));}},ht={$data:{db:new st.indexedDB("mt_full_reply_record","input_text"),get type(){return M.isPostPublish_voting()?"post-vote":"post"},get tid(){return F.getThreadId(window.location.href)},get pid(){return F.getPostId(window.location.href)}},$key:{noPublishSerializeText:"mt-editor-no-publish-serialize-text",noPublishVotingSerializeText:"mt-editor-no-publish-voting-serialize-text"},$el:{$title:null,$input:null,$form:null},init(){b.info("编辑器优化"),W(le),this.overridePageEditor();},overridePageEditor(){const t=this;this.$el.$title=C("#needsubject"),this.$el.$form=C("#postform"),this.$el.$input=C("#needmessage"),r.hide(r.parent(".comiis_scrollTop_box"),false),r.css("#postform .comiis_post_from.mt15",{"margin-top":"0px !important"});let e=x.$("#postform .comiis_post_from #comiis_post_tab");x.$("#postform .comiis_post_from .comiis_post_ico").append(e),e.remove(),x.textarea_scrollHeight=()=>{};let i=x.$.fn.comiis_delete;x.$.fn.extend({comiis_delete:function(...c){let m=i.call(this,...c);return g.dispatchEvent(t.$el.$input,"input"),m}}),r.hide(".comiis_btnbox",false),this.initVotePage(),x.$(".gm_plugin_chartbed .comiis_over_box.comiis_input_style #imglist"),W(`
        ...
        `),r.attr("#filedata","multiple",true),r.remove(".gm_plugin_chartbed .comiis_over_box.comiis_input_style"),r.on(document,"#comiis_pictitle_key li","click",function(){r.removeClass("#comiis_pictitle_key li","bg_f"),r.addClass(this,"bg_f"),x.$(".gm_plugin_chartbed .comiis_upbox").hide().eq(x.$(this).index()).fadeIn();});let n=parseInt(r.css("#comiis_head","height"))||0,s=parseInt(r.css("#comiis_sub","height"))||0,l=C("#pollm_c_1")?60:0,o=parseInt(r.css(".comiis_styli.comiis_flex","height"))||0,a=parseInt(r.css(".comiis_post_ico.comiis_minipost_icot","height"))||0;r.css("#needmessage","height",`${window.screen.height-n-s-48-o-a-10}px`),r.css("#needmessage","marginBottom",l+"px"),M.isPostPublish_edit()&&r.val("#needsubject")===""?r.hide(".comiis_styli.comiis_flex",false):r.attr("#needsubject","placeholder","请输入完整的帖子标题 (1-80个字)"),r.attr("#needmessage","placeholder","来吧，尽情发挥吧..."),typeof x.comiis_addsmilies=="function"&&(x.comiis_addsmilies=c=>{x.$("#needmessage").comiis_insert(c),x.$("#needmessage")[0].dispatchEvent(new Event("input"));}),($.getValue("mt-forum-post-editorOptimizationNormal-recordInputText")||$.getValue("mt-forum-post-editorOptimization-recordInputText"))&&(this.setInputChangeEvent(),this.initReplyText()),this.initDeleteBtn(),this.initSaveDraftBtn(),this.initSaveBtn(),this.initPostBtn(),this.initReplyBtn(),this.observerChangeEditorHeight(),this.listenResize(),this.initSelectPostingSection(),this.initUBB(),this.initImage(),this.initPreview(),this.initCharacterCount(),this.initSettingImmersionMode();},async initReplyText(){const t=this;let e=null,i=null,n=null;if(M.isPostPublish_newthread())b.info("新发布帖子的页面"),M.isPostPublish_voting()?(b.info("投票页面"),e=Y(this.$key.noPublishVotingSerializeText),n=()=>{lt(t.$key.noPublishVotingSerializeText);}):(b.info("普通帖子页面"),e=Y(this.$key.noPublishSerializeText),n=()=>{lt(this.$key.noPublishSerializeText);});else if(M.isPostPublish_edit()){b.info("草稿的页面"),b.info(`type：${this.$data.type} tid：${this.$data.tid} pid：${this.$data.pid}`),(await this.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let l=await this.$data.db.get("data");if(l.data){let o=l.data.find(a=>{if(a.type===t.$data.type&&!(a.tid!==t.$data.tid||a.pid!==t.$data.pid))return  true});o&&(e=o.data,n=async()=>{let a=await this.$data.db.get("data");if(a.data){let c=a.data.findIndex(m=>{if(m.type===t.$data.type&&!(m.tid!==t.$data.tid||m.pid!==t.$data.pid))return  true});c!=-1&&(a.data.splice(c,1),await this.$data.db.save("data",a.data));}});}}else if(M.isPostPublish_reply()&&(b.info("回复页面"),$.getValue("mt-forum-post-editorOptimizationNormal-recordInputText"))){(await tt.$data.db.get("data")).code===201&&await this.$data.db.save("data",[]);let l=await tt.$data.db.get("data");if(l.data){let o=l.data.find(a=>a.forumId===t.$data.tid&&a.repquote===F.getRepquote(window.location.href));o&&(e=o);}}e&&(M.isPostPublish_voting()?i=()=>{let s=t.$el.$form.querySelector("input[name='subject']"),l=t.$el.$form.querySelector("textarea[name='message']"),o=t.$el.$form.querySelector("input[name='maxchoices']"),a=t.$el.$form.querySelector("input[name='expiration']"),c=t.$el.$form.querySelector("input[name='visibilitypoll']"),m=t.$el.$form.querySelector("input[name='overt']");return r.val(s,e.title),r.val(l,e.content),r.val(o,e.maxchoices),r.val(a,e.expiration),r.val(c,e.visibilitypoll),r.val(m,e.overt),g.dispatchEvent(s,"input"),g.dispatchEvent(l,"input"),g.dispatchEvent(o,"input"),g.dispatchEvent(a,"input"),g.dispatchEvent(c,"input"),g.dispatchEvent(m,"input"),true}:M.isPostPublish_reply()?i=()=>{let s=t.$el.$form.querySelector("textarea[name='message']");return r.val(s,e.text),g.dispatchEvent(s,"input"),true}:i=()=>{let s=t.$el.$form.querySelector("input[name='subject']"),l=t.$el.$form.querySelector("textarea[name='message']");return r.val(s,e.title),r.val(l,e.content),g.dispatchEvent(s,"input"),g.dispatchEvent(l,"input"),true},M.isPostPublish_newthread()?(b.info("新发布帖子的页面"),typeof i=="function"&&i()):M.isPostPublish_edit()?(b.info("草稿的页面"),typeof i=="function"&&typeof n=="function"&&N.confirm({title:{text:"提示",position:"center"},content:{text:"<p>存在历史写入的数据，是否恢复到编辑器里？</p>",html:true},btn:{merge:true,position:"space-between",ok:{text:"恢复",callback:async s=>{await i()&&(y.success("恢复成功"),s.close());}},other:{enable:true,type:"danger",text:"删除该数据",callback:async s=>{await n(),s.close(),y.success("删除成功");}}},width:"300px",height:"200px"})):M.isPostPublish_reply()&&(b.info("回复页面"),typeof i=="function"&&i()));},async getReplyRecordSize(){var e;let t=await this.$data.db.get("data");return t.success?g.getTextStorageSize((e=t==null?void 0:t.data)!=null&&e.length?JSON.stringify(t.data):""):g.formatByteToSize(0)},async clearAllReplyRecord(){return await this.$data.db.deleteAll()},deleteReplyTextStorage(){const t=this;this.$data.db.get("data").then(e=>{if(!e.success){console.warn(e);return}let i=M.isPostPublish_voting()?"post-vote":"post",n=F.getThreadId(window.location.href),s=F.getPostId(window.location.href),l=e.data.findIndex(o=>{if(o.type===i&&!(o.tid!==n||o.pid!==s))return  true});l!==-1&&(e.data.splice(l,1),t.$data.db.save("data",e.data).then(o=>{}));});},setInputChangeEvent(){const t=this;r.on([this.$el.$input,this.$el.$title].filter(Boolean),["input","propertychange"],function(e){let i=null;if(M.isPostPublish_voting()){let n=t.$el.$form.querySelector("input[name='subject']"),s=t.$el.$form.querySelector("textarea[name='message']"),l=t.$el.$form.querySelector("input[name='maxchoices']"),o=t.$el.$form.querySelector("input[name='expiration']"),a=t.$el.$form.querySelector("input[name='visibilitypoll']"),c=t.$el.$form.querySelector("input[name='overt']");i={title:n.value,maxchoices:l.value,expiration:o.value,visibilitypoll:a.checked,overt:c.checked,content:s.value};}else {let n=t.$el.$form.querySelector("input[name='subject']"),s=t.$el.$form.querySelector("textarea[name='message']");i={title:n==null?void 0:n.value,content:s.value};}M.isPostPublish_newthread()?(b.info("内容改变 ==> 新发布帖子的页面"),M.isPostPublish_voting()?G(t.$key.noPublishVotingSerializeText,i):G(t.$key.noPublishSerializeText,i)):M.isPostPublish_edit()?(b.info("内容改变 ==> 草稿的页面"),t.$data.db.get("data").then(n=>{if(!n.success){console.warn(n);return}let s=n.data.findIndex(l=>{if(l.type===t.$data.type&&!(l.tid!==t.$data.tid||l.pid!==t.$data.pid))return  true});s!==-1&&n.data.splice(s,1),n.data.push({url:window.location.href,data:i,pid:t.$data.pid,tid:t.$data.tid,type:t.$data.type}),t.$data.db.save("data",n.data).then(l=>{});})):M.isPostPublish_reply()&&(b.info("内容改变 ==> 回复页面"),$.execMenu("mt-forum-post-editorOptimizationNormal-recordInputText",()=>{tt.$data.db.get("data").then(n=>{if(!n.success||n.code===201){console.warn(n);return}let s=n.data.findIndex(l=>l.forumId===t.$data.tid&&l.repquote===F.getRepquote(window.location.href));s!==-1?i.content==null||i.content===""?n.data.splice(s,1):n.data[s]=g.assign(n.data[s],{text:i.content}):n.data.push({forumId:t.$data.tid,url:window.location.href,repquote:F.getRepquote(window.location.href),text:i.content}),tt.$data.db.save("data",n.data).then(l=>{});});}));});},initDeleteBtn(){if(!C(".comiis_btnbox .comiis_btn.bg_del"))return;let e=C("#comiis_head .header_y"),i=r.createElement("input",{className:"new_btn_del"},{type:"button",value:"删除"});r.append(e,i),r.on(i,"click",function(){N.confirm({title:{text:"提示",position:"center"},content:{text:"<p>是否删除帖子?</p>",html:true},btn:{ok:{callback:n=>{n.close(),x.comiis_delthread();}}},width:"300px",height:"200px"});});},initSaveBtn(){let t=r.selector(".comiis_btnbox button#postsubmit:contains('保存')");if(!t||r.text(t).includes("草稿"))return;let e=C("#comiis_head .header_y"),i=r.createElement("input",{className:"new_btn_save"},{type:"button",value:"保存"});r.append(e,i),r.on(i,"click",function(){t.click();});},initPostBtn(){let t=r.selector(".comiis_btnbox button#postsubmit:contains('发表')");if(!t)return;let e=C("#comiis_head .header_y"),i=r.createElement("input",{className:"new_btn_post"},{type:"button",value:"发表"});r.append(e,i),r.on(i,"click",function(){r.val("#postsave",0),t.click();});},initReplyBtn(){const t=this;let e=r.selector(".comiis_btnbox button#postsubmit:contains('回复')");if(!e)return;let i=C("#comiis_head .header_y"),n=r.createElement("input",{className:"new_btn_reply"},{type:"button",value:"回复"});r.append(i,n),r.on(n,"click",function(){e.click(),t.deleteReplyTextStorage();});},initVotePage(){U(".comiis_scrollTop_box").length&&(x.$("#htmlon").parent().append(`
        ...
        `);let e=C("#select-post-section"),i=F.getForumId(window.location.href);M.isPostPublish_newthread()?(b.info("发帖"),r.on(e,"change",function(){let n=r.val(e),s=`forum.php?mod=post&action=newthread&fid=${n}&extra=&topicsubmit=yes&mobile=2`;b.info(`修改发帖板块: ${t[n]} ${s}`);let l={求助问答:{className:"gm_user_select_help",optionHTML:`<option value="0" selected="selected">请选择</option>
                        ...
                        `)):Object.keys(l).forEach(a=>{r.remove(".comiis_post_from ."+l[a].className);}),r.attr("#postform","action",s);})):r.attr(e,"disabled",true),r.val(e,i),r.trigger(e,"change");},initCharacterCount(){b.info("添加功能：字符计数"),W(`
        ...
        `),r.append("#comiis_mh_sub .swiper-wrapper.comiis_post_ico",`
            <a href="javascript:;" class="swiper-slide gm_plugin_word_count">
                <p>0</p>
            </a>`),r.on(this.$el.$input,["input","propertychange"],t=>{let e=this.$el.$input.value,i=g.getTextLength(e),n=xt.parseText(e);r.html(".gm_plugin_previewpostforum_html .comiis_message_table",n);let s=C(".gm_plugin_word_count p");r.text(s,i),i>2e4||i<10?r.attr(s,"style","color: red;"):r.attr(s,"style","");});},initUBB(){if(!C(".comiis_post_urlico")){b.error("未找到插入元素");return}W(`
        #comiis_post_tab .comiis_input_style .comiis_post_urlico li a.f_0{
            color: #53bcf5 !important;
        }
        `);let t=Ut(),e=C(".comiis_post_urlico > ul"),i=C("#comiis_post_qydiv > ul"),n=U("#comiis_post_qydiv ul li").length;re(),r.on("#comiis_post_tab .comiis_input_style .comiis_post_urlico li","click",function(){r.removeClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_0"),r.addClass("#comiis_post_tab .comiis_input_style .comiis_post_urlico li a","f_d"),r.attr(this.querySelector("a"),"class","comiis_xifont f_0"),x.$("#comiis_post_qydiv ul li").hide().eq(x.$(this).index()).fadeIn();}),x.$.each(t,function(s,l){let o=r.createElement("li",{className:"quickUBBs",innerHTML:`
                <a href="javascript:;" class="comiis_xifont f_d"><i class="comiis_font"></i>${l.key}</a>
                `});r.on(o,"click",c=>{if(!C(`#comiis_post_qydiv li[data-key='${l.key}']`)){b.error("未找到该元素");return}U("#comiis_post_tab div.comiis_post_urlico ul li a.comiis_xifont").forEach(f=>{f.className="comiis_xifont f_d";});let d=o.querySelector("a");d.className="comiis_xifont f_0";let u=n+Object.keys(t).indexOf(s);x.$("#comiis_post_qydiv ul li").hide().eq(u).fadeIn();}),r.append(e,o);let a=document.createElement("li");a.setAttribute("style","display: none;"),a.setAttribute("data-key",l.key),a.innerHTML=`
            ...
            <div class="comiis_styli_m f15 comiis_flex" style="padding-top:0;">
                ...
                <div class="flex"></div>
            </div>`,r.append(i,a),r.on(`.comiis_sendbtn[data-keyI="${s}"]`,"click",()=>{let c=x.$(`#comiis_input_${s}`).val();if(c==""){y.warning("请输入需要插入的内容");return}let m=t[s];m.isFunc&&(c=Ft(m.num,c)),m.hasOwnProperty("L")&&(c=m.L+c+m.R),x.$("#needmessage").insertAtCaret(c),m.hasOwnProperty("cursorL")&&x.$("#needmessage").moveCursorToCenterByTextWithLeft(m.cursorL,m.cursorLength),m.hasOwnProperty("cursorR")&&x.$("#needmessage").moveCursorToCenterByTextWithRight(m.cursorR,m.cursorLength);});});},initImage(){b.info("添加功能：图片"),W(`
        ...
        <a href="javascript:;" class="comiis_pictitle"><i class="comiis_font"><em>图片</em></i></a>`),r.on(".comiis_pictitle","click",function(){this.querySelector("i.comiis_font").classList.contains("f_0")?r.hide(".gm_plugin_chartbed",false):r.show(".gm_plugin_chartbed",false);}),r.append("#comiis_post_tab",`
            ...
            `);let e=C("#imglist"),i=r.parent(e);r.before(".gm_plugin_chartbed .bqbox_t",i),r.on("#imglist .comiis_font","click",n=>{C("#filedata").click();}),r.on("#comiis_pictitle_tab #comiis_pictitle_key","click","li",function(n){let s=n.target;r.removeClass("#comiis_pictitle_tab #comiis_pictitle_key li","bg_f"),r.addClass(s,"bg_f"),x.$("#comiis_pictitle_tab div.comiis_upbox").hide().eq(x.$(s).index()).fadeIn();}),$.execMenuOnce("mt-image-bed-hello-enable",()=>{Nt.init();}),$.execMenuOnce("mt-image-bed-mt-enable",()=>{Bt.init();});},initPreview(){const t=this;b.info("添加功能：双列预览"),W(`
        ...
        <a href="javascript:;" class="swiper-slide gm_plugin_previewpostforum">
            ...
            </div>`),r.on(".gm_plugin_previewpostforum","click",function(i){let n=this;if(U("#polldatas").length&&xt.parseVoteText(),n.querySelector("i.comiis_font").classList.contains("f_0"))r.hide(".gm_plugin_previewpostforum_html",false);else {r.show(".gm_plugin_previewpostforum_html",false);let l=xt.parseText(r.val(t.$el.$input));r.html(".gm_plugin_previewpostforum_html .comiis_message_table",l),r.css(".gm_plugin_previewpostforum_html.double-preview .comiis_over_box.comiis_input_style","height",r.css(t.$el.$input,"height"));}});},initSettingImmersionMode(){b.info("初始化设置功能-使用沉浸模式"),r.append(r.parent("#htmlon"),`
            <li class="comiis_styli_m f15 comiis_flex b_b">
            ...
            `),r.on("#immersiveinput","click",function(){let t=this,e=r.parent(t).querySelector(".comiis_checkbox"),i=[".comiis_wzpost ul li.comiis_flex",".comiis_wzpost ul li.comiis_styli.kmquote",r.parent(r.parent("#pollchecked")),"#pollm_c_1",".comiis_polloption_add+div.f_0",".comiis_wzpost ul li.comiis_thread_content:contains('内容')","div#comiis_head","div#comiis_head+*:not([class])"];r.hasClass(e,"comiis_checkbox_close")?i.forEach(n=>{n&&r.hide(n,false);}):i.forEach(n=>{n&&r.show(n,false);}),window.dispatchEvent(new Event("resize"));});}},me={id:"component-forum-post",title:"帖子",forms:[{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[L("自动展开内容","mt-forum-post-autoExpandContent",true,void 0,"注入CSS展开帖子的内容"),L("修复图片宽度","mt-forum-post-repairImageWidth",true,void 0,"修复图片宽度超出页面宽度的问题"),L("移除帖子字体效果","mt-forum-post-removeFontStyle",false,void 0,""),L("移除评论区的字体效果","mt-forum-post-removeCommentFontStyle",false,void 0,""),L("添加【点评】按钮","mt-forum-post-addCommentOnBtn",false,void 0,"在评论区的每个评论右下角添加按钮"),L("附件点击提醒","mt-forum-post-setAttachmentsClickTip",true,void 0,"阻止默认点击附件就会触发附件下载"),L("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮"),L("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片")]}]},{text:"自动加载评论",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("自动加载下一页评论","mt-forum-post-loadNextPageComment",true,void 0,""),L("同步加载的地址","mt-forum-post-syncNextPageUrl",false,void 0,"便于刷新页面会停留在当前查看的评论页面")]}]},{text:"编辑器-简略版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("启用","mt-forum-post-editorOptimizationNormal",true,void 0,"优化样式，插入bbcode代码等"),L("自动保存输入记录","mt-forum-post-editorOptimizationNormal-recordInputText",true,void 0,"当回复时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async t=>{let n=t.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await tt.clearAllReplyRecord();s.success?(y.success("清理成功"),r.text(n,`当前占用空间大小：${await tt.getReplyRecordSize()}`)):y.error("清理失败 "+s.msg);},async(t,e)=>{let i=e.target.querySelector(".pops-panel-item-left-desc-text");r.text(i,`当前占用空间大小：${await tt.getReplyRecordSize()}`);})]}]},{text:"编辑器-完整版",type:"deepMenu",forms:[{type:"forms",text:"",forms:[L("启用","mt-forum-post-publish-editorOptimization",true,void 0,"优化样式，插入bbcode代码，双列预览等"),L("自动保存输入记录","mt-forum-post-editorOptimization-recordInputText",true,void 0,"当回复/发表时会自动清空记录"),ft("清空回复记录","当前占用空间大小：计算中","清理",void 0,false,false,"default",async t=>{let n=t.target.closest("li").querySelector(".pops-panel-item-left-desc-text"),s=await ht.clearAllReplyRecord();s.success?(y.success("清理成功"),r.text(n,`当前占用空间大小：${await ht.getReplyRecordSize()}`)):y.error("清理失败 "+s.msg);},async(t,e)=>{let i=e.target.querySelector(".pops-panel-item-left-desc-text");r.text(i,`当前占用空间大小：${await ht.getReplyRecordSize()}`);})]}]},{text:"编辑器-图床配置",type:"deepMenu",forms:[{type:"forms",text:'<a href="https://www.helloimg.com/" target="_blank">Hello图床</a>',forms:[L("启用","mt-image-bed-hello-enable",false,void 0,"启用Hello图床"),V("账号","mt-image-bed-hello-account","","",void 0,"必填"),V("密码","mt-image-bed-hello-password","","",void 0,"必填",false,true),V("token","mt-image-bed-hello-token","","",void 0,"必填",false,true)]},{type:"forms",text:'<a href="https://img.binmt.cc/" target="_blank">MT图床</a>',forms:[L("启用","mt-image-bed-mt-enable",true,void 0,"启用MT图床")]},{type:"forms",text:"图片水印",forms:[L("启用","mt-image-bed-watermark-enable",false,void 0,"开启后会为图床图片添加文字水印"),L("自动添加水印","mt-image-bed-watermark-autoAddWaterMark",false,void 0,"开启后会自动添加水印，关闭后会有添加水印后的图片预览"),V("水印文字","mt-image-bed-watermark-text","MT论坛"),V("颜色","mt-image-bed-watermark-text-color","#000000",void 0,void 0,"",false,false,(t,e)=>{var s,l;let i=(s=e.target)==null?void 0:s.querySelector("input"),n=(l=e.target)==null?void 0:l.querySelector(".pops-panel-input__suffix");r.hide(n,false),i.setAttribute("type","color"),r.css(i,{margin:"unset",padding:"unset",width:"80px"});}),V("大小","mt-image-bed-watermark-font-size",16,void 0,void 0,void 0,true),V("透明度","mt-image-bed-watermark-font-opacity",1,void 0,void 0,void 0,true),V("左右间距","mt-image-bed-watermark-left-right-margin",80,void 0,void 0,void 0,true),V("上下间距","mt-image-bed-watermark-top-bottom-margin",80,void 0,void 0,void 0,true),V("旋转角度","mt-image-bed-watermark-rotate",45,void 0,void 0,void 0,true)]}]}]}]},de={id:"component-search",title:"搜索",forms:[{type:"forms",text:"",forms:[L("显示搜索历史","mt-search-showSearchHistory",true,void 0,"自动记住搜索历史并显示"),L("修复清空按钮","mt-search-repairClearBtn",true,void 0,"修复点击清空按钮不清空输入框的问题"),L("搜索框自动获取焦点","mt-search-searchInputAutoFocus",true,void 0,"")]}]},gt={$key:{sign:"mt-sign-time"},init(){this.sign();},checkSignInfo(){let e=this.getSignInfo().find(i=>i.hostName===window.location.hostname);return e?g.formatTime(Date.now(),"yyyyMMdd")===g.formatTime(e.time,"yyyyMMdd"):false},setSignInfo(){let t={hostName:window.location.hostname,time:Date.now()},e=this.getSignInfo(),i=e.findIndex(n=>n.hostName===t.hostName);i!==-1&&e.splice(i,1),e.push(t),G(this.$key.sign,e);},getSignInfo(){let t=Y(this.$key.sign,[]);return Array.isArray(t)?t:(this.clearSignInfo(),[])},getHostNameSignInfo(t=window.location.hostname){return this.getSignInfo().find(i=>i.hostName===t)},clearSignInfo(t){if(typeof t=="string"){let e=this.getSignInfo(),i=e.findIndex(n=>n.hostName===t);i!==-1&&e.splice(i,1),G(this.$key.sign,e);}else lt(this.$key.sign);},checkLogin(){return F.envIsMobile()?!!C("a[href*='member.php?mod=logging&action=logout']"):!!C("#comiis_key")},async sign(){let t=F.getFormHash();if(t==null){if(C("#comiis_picshowbox")){b.info("当前为评论区的看图模式 ");return}b.error("自动签到：获取账号formhash失败"),this.clearSignInfo(window.location.hostname),y.error({content:"自动签到：获取账号formhash失败"});return}if(this.checkSignInfo()){b.info("今日已签到");return}let e=!!$.getValue("mt-auto-sign-useFetch"),i=g.getRandomPCUA(),n=()=>{this.setSignInfo();},s=()=>{this.clearSignInfo(window.location.hostname);},l=a=>{let m=bt.alert({title:{text:"未知签到内容",position:"center"},content:{text:"",html:false},width:"88vw",height:"300px"}).$shadowRoot.querySelector(".pops-alert-content");m.innerText=a;},o=[{id:"k_misign",async sign(){let a={operation:"qiandao",format:"button",formhash:t,inajax:1,ajaxtarget:"midaben_sign"},c=await H.get(`/k_misign-sign.html?${g.toSearchParamsStr(a)}`,{fetch:e,headers:{"User-Agent":i},allowInterceptConfig:false});if(!c.status){y.error("签到：网络异常，请求失败",{consoleLogContent:true});return}n(),b.info("签到信息：",c);let m=c.data.responseText,d=g.parseCDATA(m),u=r.parseHTML(`<div>${d}</div>`,true,false),f=r.text(u);if(f.includes("需要先登录")){y.error("签到：请先登录账号",{timeout:3e3,consoleLogContent:true}),s();return}else if(f.includes("请稍后再试")||f.includes("您已经被列入黑名单")||f.includes("绑定手机号后才可以签到")||f.includes("您所在用户组不允许使用")){y.error("签到："+f,{timeout:5e3});return}else if(f.includes("今日已签")||f.includes("今日已经签到")){y.info("签到："+f);return}else if(m.includes("您当前的访问请求当中含有非法字符，已经被系统拒绝")){y.error("签到: 您当前的访问请求当中含有非法字符，已经被系统拒绝",{timeout:6e3});return}else if(e&&"location"in g.toJSON(m)){y.success("签到: 签到成功");return}let p=u.querySelector(".con"),h=u.querySelector(".line");if(p&&h){let _=r.text(p).match(/([0-9]+)金币/),k=r.text(h).match(/([0-9]+)/),v=_[_.length-1],S=k[k.length-1];b.success(`金币${v}，排名${S}`),y.info(`
							...
							</div>`,{timeout:4e3,isHTML:true});return}l(m);}},{id:"dsu_paulsign",async sign(){let a={id:"dsu_paulsign:sign",operation:"qiandao",infloat:1,inajax:1},c=await H.post(`/plugin.php?${g.toSearchParamsStr(a)}`,{data:{formhash:t,qdxq:"kx",qdmode:3,todaysay:"",fastreply:0},processData:true,fetch:e,headers:{"User-Agent":i,"Content-Type":"application/x-www-form-urlencoded"},allowInterceptConfig:false});if(!c.status){y.error("签到：网络异常，请求失败",{consoleLogContent:true});return}n(),b.info("签到信息：",c);let m=c.data.responseText;if(m.includes("签到成功")){y.success("签到：签到成功");return}if(m.includes("今日已经签到")){y.info("签到：您今日已经签到，请明天再来！");return}l(m);}}];for(let a=0;a<o.length;a++){const c=o[a];let m=await H.get(`/plugin.php?id=${c.id}:sign`,{headers:{"User-Agent":g.getRandomPCUA()},allowInterceptConfig:false});if(!m.status){b.error("签到：检查签到插件是否启用的请求失败",m);continue}if(r.parseHTML(m.data.responseText,true,true).querySelector("#messagetext")){b.error(`插件：${c.id} 未启用或不存在`);continue}await c.sign();break}}},pe={id:"component-sigh",title:"签到",forms:[{text:"功能",type:"forms",forms:[L("显示【今日签到之星】","mt-sign-showTodaySignStar",true,void 0,"在签到按钮上面显示今日签到之星"),L("显示【今日最先】","mt-sign-showTodayRanking",true,void 0,"在签到排名上面新增【今日最先】")]},{text:"自动签到",type:"forms",forms:[L("启用","mt-auto-sign",true,void 0,"自动请求签到"),L("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),ft("签到信息",`上次签到时间：${(()=>{let t=gt.getHostNameSignInfo(window.location.hostname);return t?st.formatTime(t.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",t=>{let i=t.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");N.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:n=>{let s=window.location.hostname;gt.clearSignInfo(s),y.success("删除成功"),r.text(i,`上次签到时间：${(()=>{let l=gt.getHostNameSignInfo(s);return l?st.formatTime(l.time):"尚未签到"})()}`),n.close();}}},mask:{enable:true},width:"88vw",height:"200px"});})]}]},ue={id:"component-space",title:"空间",forms:[{type:"forms",text:"",forms:[L("修复无法进入空间","mt-space-repairEnterSpace",true,void 0,"修复链接错误导致不能进入空间的问题"),L("显示帖子回复内容","mt-space-showCommentContent",true,void 0,"在帖子-回复下面显示具体评论的内容")]}]},he={id:"component-guide",title:"导读",forms:[{type:"forms",text:"",forms:[L("显示最新帖子","mt-guide-showLatestPost",true,void 0,"在最上面显示最新发布的帖子")]}]},Et={setting:{get width(){return window.innerWidth<550?"88vw":"550px"},get height(){return window.innerHeight<450?"70vh":"450px"}}},$={$data:{__data:null,__oneSuccessExecMenu:null,__onceExec:null,__listenData:null,get data(){return $.$data.__data==null&&($.$data.__data=new g.Dictionary),$.$data.__data},get oneSuccessExecMenu(){return $.$data.__oneSuccessExecMenu==null&&($.$data.__oneSuccessExecMenu=new g.Dictionary),$.$data.__oneSuccessExecMenu},get onceExec(){return $.$data.__onceExec==null&&($.$data.__onceExec=new g.Dictionary),$.$data.__onceExec},get scriptName(){return St},key:ot,attributeKeyName:et,attributeDefaultValueName:it},$listener:{get listenData(){return $.$data.__listenData==null&&($.$data.__listenData=new g.Dictionary),$.$data.__listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},isTopWindow(){return x.top===x.self},initExtensionsMenu(){this.isTopWindow()&&(ie.add([{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{this.showPanel();}}]),j.registerLeftMenu({name:"MT论坛脚本设置",icon:"",iconColor:"#ff0505",iconSize:"23px",callback:()=>{this.showPanel();}}));},initPanelDefaultValue(){let t=this;function e(s){if(!s.attributes)return;let l={},o=s.attributes[et];o!=null&&(l[o]=s.attributes[it]);let a=s.attributes[Pt];if(typeof a=="function"){let d=a();if(typeof d=="boolean"&&!d)return}let c=s.attributes[ne];c&&typeof c=="object"&&Object.assign(l,c);let m=Object.keys(l);if(!m.length){b.warn(["请先配置键",s]);return}m.forEach(d=>{let u=l[d];t.$data.data.has(d)&&b.warn("请检查该key(已存在): "+d),t.$data.data.set(d,u);});}function i(s){for(let l=0;l<s.length;l++){let o=s[l];e(o);let a=o.forms;a&&Array.isArray(a)&&i(a);}}let n=this.getPanelContentConfig();for(let s=0;s<n.length;s++){let l=n[s];if(!l.forms)continue;let o=l.forms;o&&Array.isArray(o)&&i(o);}},setValue(t,e){let i=Y(ot,{}),n=i[t];i[t]=e,G(ot,i),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,n,e);},getValue(t,e){let n=Y(ot,{})[t];return n??(this.$data.data.has(t)?this.$data.data.get(t):e)},deleteValue(t){let e=Y(ot,{}),i=e[t];Reflect.deleteProperty(e,t),G(ot,e),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,i,void 0);},addValueChangeListener(t,e,i){let n=Math.random();return this.$listener.listenData.set(t,{id:n,key:t,callback:e}),i&&i.immediate&&e(t,this.getValue(t),this.getValue(t)),n},removeValueChangeListener(t){let e=null;for(const[i,n]of this.$listener.listenData.entries())if(n.id===t){e=i;break}typeof e=="string"?this.$listener.listenData.delete(e):console.warn("没有找到对应的监听器");},triggerMenuValueChange(t,e,i){if(this.$listener.listenData.has(t)){let n=this.$listener.listenData.get(t);if(typeof n.callback=="function"){let s=this.getValue(t),l=s,o=s;typeof e<"u"&&arguments.length>1&&(l=e),typeof i<"u"&&arguments.length>2&&(o=i),n.callback(t,o,l);}}},hasKey(t){let e=Y(ot,{});return t in e},execMenu(t,e,i=false,n){if(!(typeof t=="string"||typeof t=="object"&&Array.isArray(t)))throw new TypeError("key 必须是字符串或者字符串数组");let s=[];typeof t=="object"&&Array.isArray(t)?s=[...t]:s.push(t);let l;for(let o=0;o<s.length;o++){const a=s[o];if(!this.$data.data.has(a)){b.warn(`${t} 键不存在`);return}let c=$.getValue(a);if(i&&(c=!c),typeof n=="function"){let m=n(a,c);typeof m=="boolean"&&(c=m);}if(!c)break;l=c;}l&&e(l);},execMenuOnce(t,e,i,n,s){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){b.warn(`${t} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(t))return;this.$data.oneSuccessExecMenu.set(t,1);let l=()=>{let u=$.getValue(t);return typeof i=="function"?i(t,u):u},o=[],a=u=>{let f=l(),p=[];if(u instanceof HTMLStyleElement?p=[u]:Array.isArray(u)&&(p=[...u.filter(h=>h!=null&&h instanceof HTMLStyleElement)]),f)o=o.concat(p);else for(let h=0;h<p.length;h++)p[h].remove(),p.splice(h,1),h--;},c=u=>typeof s=="function"?s(t,u):u,m=u=>{let f=[];if(c(u)){let p=e(u,a);p instanceof HTMLStyleElement?f=[p]:Array.isArray(p)&&(f=[...p.filter(h=>h!=null&&h instanceof HTMLStyleElement)]);}for(let p=0;p<o.length;p++)o[p].remove(),o.splice(p,1),p--;o=[...f];};this.addValueChangeListener(t,(u,f,p)=>{let h=p;typeof n=="function"&&(h=n(u,p,f)),m(h);});let d=l();d&&m(d);},execInheritMenuOnce(t,e,i,n){let s=this;const l=(o,a)=>{let c=s.getValue(o),m=s.getValue(a);if(typeof n=="function"){let d=n(c,m);if(d!=null)return d}return c};this.execMenuOnce(t,i,()=>l(t,e),()=>l(t,e)),this.execMenuOnce(e,()=>{},()=>false,()=>(this.triggerMenuValueChange(t),false));},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(t)||(e(),this.$data.onceExec.set(t,1));},showPanel(){N.panel({title:{text:`${St}-设置`,position:"center",html:false,style:""},content:this.getPanelContentConfig(),mask:{enable:true,clickEvent:{toClose:true,toHide:false}},width:Et.setting.width,height:Et.setting.height,drag:true,only:true});},isMobile(){return window.innerWidth<550},getWidth(){return window.innerWidth<550?"88vw":"550px"},getHeight(){return window.innerHeight>450?"450px":"88vh"},getPanelContentConfig(){return [se,me,de,pe,ue,he]}},ge=`.pops-confirm-content {\r
	display: flex;\r
	flex-direction: column;\r
}\r
...
`,fe={$data:{cid:""},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"小黑屋",iconColor:"#000000",icon:"",callback:()=>{this.showBlackHome();}});},async showBlackHome(){let t=y.loading("正在获取小黑屋名单中..."),e=await this.getBlackListInfo("");if(t.close(),!e)return;if(e.data.length===0){y.error("获取小黑屋名单为空");return}this.$data.cid=e.next_cid;let i=N.confirm({title:{text:"小黑屋名单",position:"center"},content:{text:`
                <div class="blackhome-user-filter">
                    <input placeholder="过滤用户名/操作人员/UID(可正则)">
                </div>
                <div class="blackhome-user-list"></div>
                `,html:true},btn:{ok:{text:"下一页",callback:async()=>{let a=y.loading("正在获取小黑屋名单中...");b.info("下一页的cid: ",this.$data.cid);let c=await this.getBlackListInfo(this.$data.cid);a.close(),c&&(this.$data.cid=c.next_cid,c.data.forEach(m=>{let d=this.createListViewItem(m);n.appendChild(d);}),c.data.length===0?y.error("获取小黑屋名单为空"):y.success(`成功获取 ${c.data.length}条数据`));}},cancel:{text:"关闭"}},width:"88vw",height:"82vh",style:ge,mask:{enable:true}}),n=i.$shadowRoot.querySelector(".blackhome-user-list"),s=i.$shadowRoot.querySelector(".blackhome-user-filter input");e.data.forEach(a=>{let c=this.createListViewItem(a);n.appendChild(c);}),y.success(`成功获取 ${e.data.length}条数据`);let l=false;r.on(s,["input","propertychange"],g.debounce(()=>{let a=s.value.trim();if(!l){if(l=true,a==""){i.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.removeAttribute("style");}),l=false;return}i.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(c=>{c.getAttribute("data-name").match(new RegExp(a,"ig"))||c.getAttribute("data-uid").trim().match(new RegExp(a,"ig"))||c.getAttribute("data-operator").match(new RegExp(a,"ig"))?c.removeAttribute("style"):c.setAttribute("style","display:none;");}),l=false;}}));let o=await this.getBlackListInfo(this.$data.cid);o&&(this.$data.cid=o.next_cid);},async getBlackListInfo(t=""){let e={mod:"misc",action:"showdarkroom",cid:t,ajaxdata:"json"},i=await H.get(`/forum.php?${g.toSearchParamsStr(e)}`,{headers:{"User-Agent":g.getRandomPCUA()},responseType:"json"});if(!i.status)return;let n=g.toJSON(i.data.responseText),s=n.message.split("|"),l=s[s.length-1],o=g.parseObjectToArray(n.data),a=[],c=[];return o.forEach(m=>{let d=m.dateline.match(/([0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]*[0-9]{1,2}:[0-9]{1,2})/g);if(d==null){let u=parseInt((Date.now()/1e3).toString()),f=0,p=m.dateline.match(/([0-9]+|半)[\s\S]*秒前/),h=m.dateline.match(/([0-9]+|半)[\s\S]*分钟前/),_=m.dateline.match(/([0-9]+|半)[\s\S]*小时前/),k=m.dateline.match(/昨天[\s\S]*(\d{2}):(\d{2})/),v=m.dateline.match(/前天[\s\S]*(\d{2}):(\d{2})/),S=m.dateline.match(/([0-9]+|半)[\s\S]*天前/);if(p)p=p[p.length-1],p=p.replace(/半/g,.5),p=parseFloat(p),f=u-p;else if(h)h=h[h.length-1],h=h.replace(/半/g,.5),h=parseFloat(h),f=u-h*60;else if(_)_=_[_.length-1],_=_.replace(/半/g,.5),_=parseFloat(_),f=u-_*60*60;else if(k){let A=k[1],I=k[2];f=u-86400-parseInt(A)*3600-parseInt(I)*60;}else if(v){let A=v[1],I=v[2];f=u-86400*2-parseInt(A)*3600-parseInt(I)*60;}else S&&(S=S[S.length-1],S=S.replace(/半/g,.5),S=parseFloat(S),f=u-S*60*60*24);m.time=parseInt(f.toString())*1e3,a=a.concat(m);return}else d=d[0];m.time=g.formatToTimeStamp(d),a=a.concat(m);}),g.sortListByProperty(a,"time"),g.sortListByProperty(c,"time",false),a=a.concat(c),{next_cid:l,data:a}},createListViewItem(t){let e=r.createElement("div",{className:"blackhome-user-item",innerHTML:`
...
`,_e={$data:{},init(){this.registerMenu();},registerMenu(){j.registerLeftMenu({name:"在线用户",iconColor:"#2d92ff",icon:"",callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let t=y.loading("正在获取在线用户名单中..."),e=await this.getOnlineUserListInfo();if(t.close(),!e)return;let i=N.alert({title:{text:"在线用户",position:"center"},content:{text:`
                ...
                `,html:true},btn:{ok:{text:"关闭",type:"default"}},width:"88vw",height:"82vh",style:be,mask:{enable:true}}),n=i.$shadowRoot.querySelector(".online-user-list"),s=i.$shadowRoot.querySelector(".online-user-filter input");e.data.forEach(o=>{let a=this.createListViewItem(o);n.appendChild(a);}),y.success(`成功获取 ${e.data.length}条数据`);let l=false;Z.on(s,["propertychange","input"],g.debounce(()=>{let o=s.value.trim();if(!l){if(l=true,o==""){i.$shadowRoot.querySelectorAll(".online-user-list .online-item").forEach(a=>{a.removeAttribute("style");}),l=false;return}i.$shadowRoot.querySelectorAll(".online-user-list .online-item").forEach(a=>{a.getAttribute("data-name").match(new RegExp(o,"ig"))||a.getAttribute("data-sf").match(new RegExp(o,"ig"))||a.getAttribute("data-uid").match(new RegExp(o,"ig"))?a.removeAttribute("style"):a.setAttribute("style","display:none;");}),l=false;}}));},async getOnlineUserListInfo(){let t={showoldetails:"yes"},e=await H.get(`/forum.php?${g.toSearchParamsStr(t)}`,{headers:{"User-Agent":g.getRandomPCUA()}});if(!e.status)return;let i=g.parseFromString(e.data.responseText,"text/html"),n={data:[],totalOnline:0,onlineUser:0,noRegisterUser:0,invisibleUser:0};i.querySelectorAll("#onlinelist ul li").forEach(o=>{let a=o.querySelector("a").getAttribute("href").match("uid-(.+?).html")[1],c=F.getAvatar(a,"middle"),m=o.querySelector("a").innerText,d="",u=o.querySelector("a").getAttribute("href"),f=o.querySelector("img").src;f.indexOf("online_member")!=-1?d="会员":f.indexOf("online_moderator")!=-1?d="版主":f.indexOf("online_supermod")!=-1?d="超级版主":f.indexOf("online_admin")!=-1?d="管理员":d="未知身份",n.data.push({uid:a,avatar:c,name:m,sf:d,space:u});});let l=i.querySelector("#online div.bm_h span.xs1").textContent;return n.totalOnline=g.parseInt(l.match(/([0-9]*)\s*人在线/i),0),n.onlineUser=g.parseInt(l.match(/([0-9]*)\s*会员/i),0),n.noRegisterUser=g.parseInt(l.match(/([0-9]*)\s*位游客/i),0),n.invisibleUser=g.parseInt(l.match(/([0-9]*)\s*隐身/i),0),n},createListViewItem(t){let e=Z.createElement("div",{className:"online-item",innerHTML:`
        ...
        `)},repairImageWidth(){return b.info("修复图片宽度"),W(`
        .comiis_messages img{
            max-width: 100% !important;
        }`)},removeFontStyle(){b.info("移除帖子字体效果");let t=C(".comiis_a.comiis_message_table");t&&r.html(t,r.html(t).replace(X.fontSpecial,""));},removeCommentFontStyle(){var i;b.info("移除评论区的字体效果");let t=U("font"),e=((i=C(".comiis_postlist .comiis_postli"))==null?void 0:i.innerHTML)||"";e!==""&&(t.forEach(n=>{e.includes(n.innerHTML)||(n.removeAttribute("color"),n.removeAttribute("style"),n.removeAttribute("size"));}),U(".comiis_message.message").forEach(n=>{if(e.includes(n.innerHTML)){n.innerHTML=n.innerHTML.replace(X.fontSpecial,"");let s=n.nextElementSibling;s&&s.localName==="strike"&&(s.outerHTML=s.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));}})),U(".comiis_postli.comiis_list_readimgs.nfqsqi").forEach(n=>{let s=n.parentElement;s&&s.localName==="strike"&&(s.outerHTML=s.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));});},addCommentOnBtn(){b.info("添加【点评】按钮"),g.waitNodeList(".bottom_zhan:not([data-isaddreviews])").then(t=>{t.forEach(e=>{var u,f,p;e.setAttribute("data-isaddreviews","true");var i=e.querySelector("a");if(i){var n=i.getAttribute("datahref")||i.getAttribute("data-href")||i.href||"",s=n.replace("mod=post&","mod=misc&").replace("action=reply&","action=comment&"),l=(u=n==null?void 0:n.match(/&page=([\w]+)/i))==null?void 0:u[1],o=`${s}&extra=page%3D1&page=${l}`,a=e==null?void 0:e.closest(".comiis_postli[id]"),c=(f=a.getAttribute("id"))==null?void 0:f.replace("pid","&pid=");o=o+c;var m=((p=a.querySelector(".top_user.f_b"))==null?void 0:p.textContent)||"",d=r.parseHTML(`
						...
						`,true,false);r.on(d,"click",function(){g.waitNode("div[id=ntcmsg_popmenu]>div>span.f_c").then(h=>{try{h.innerText="点评 "+m;}catch(_){b.error("修改点评失败",_);}});}),r.prepend(e,d);}});});},loadNextPageComment(){var c;if(b.info("自动加载下一页评论"),document.title.includes("提示信息 - MT论坛"))return;function t(){return C("#loading-comment-tip")}function e(){return C("#loading-comment-tip").parentElement}function i(m){let d=t(),u=e();r.css(u,"display","");let p=Array.from(m.querySelectorAll("a[href]")).find(v=>{var S;return ((S=v.textContent)==null?void 0:S.trim())==="下一页"}).href;if(b.info("获取下一页url：",p),p.includes("javascript:;")){b.info("暂无下一页的评论"),r.remove(u);return}function h(){r.remove(".comiis_page.bg_f"),r.remove(u),r.off(d,"click",_),r.off(window,"scroll",k.run);}async function _(){r.text(d,"正在加载评论中..."),r.css(u,"display",""),b.info("请求下一页评论："+p);let v=p,S=await H.get(v,{fetch:true});if(!S.status)return;let A=r.parseHTML(S.data.responseText,true,true),I=C(".comiis_postlist.kqide"),P=A.querySelector(".comiis_postlist.kqide"),E=A.querySelector(".nxt"),R=(E==null?void 0:E.getAttribute("href"))||(E==null?void 0:E.href);if(R){if(b.success("成功获取到下一页评论"),R===p){b.warn("获取到下一页评论的url和上次请求的url相同，判定为已加载完全部评论，移除监听事件"),h();return}p=R;}else b.error("评论全部加载完毕，移除监听事件"),h();let O=E==null?void 0:E.parentElement.querySelector("strong");if(O){let q=C("#select_a");if(q){let w=Array.from(q.childNodes).find(T=>T.nodeName==="#text");w&&(w.textContent=`第 ${O.textContent} 页`);}}$.execMenu("mt-forum-post-syncNextPageUrl",()=>{if(window===(top==null?void 0:top.window)){let q=new URL(v),w=`${q.pathname}${q.search}`;window.history.pushState("forward","",w);}}),r.append(I,P),Vt.init();}var k=new g.LockFunction(async()=>{g.isNearBottom(50)&&await _();});r.text(d,"请上下滑动或点击加载"),r.on(window,"scroll",k.run),r.on(d,"click",_),k.run();}let s=r.parseHTML(`
		<div class="comiis_multi_box bg_f b_t">
...
]*;`,relevance:0},{begin:"[vp][0-9]+"}]}}this.$flag.isSetHljsCSS||(pt.registerLanguage("smali",t),W(`
			...
			`),r.on(document,"click",".reader-copy-button",async function(i){g.preventEvent(i);let n=i.target,s=C(n.getAttribute("data-code-selector"));return await g.setClip(s.outerText||s.innerText),y.success("已复制到剪贴板"),false})),U(".comiis_blockcode.comiis_bodybg").forEach(i=>{if(i.getAttribute("data-copy"))return;i.setAttribute("data-copy","true");let n=r.createElement("div",{innerHTML:`
					...
					复制
					</span>`},{style:"height: 34px;margin: 14px 0px;display: inline-flex;align-items: flex-end;"});r.before(i,n);function s(d,u="java"){d.oldValue||(d.oldValue=d.textContent),d.innerHTML=pt.highlight(d.oldValue,{language:u}).value.replace(/\\n$/gi,"");}let l=pt.highlightAuto(i.textContent).language,o=document.createElement("div"),a=document.createElement("select"),c=pt.listLanguages().sort();c=c.concat("自动检测");let m="";c.forEach(d=>{d.startsWith("自动检测")?m+=`<option data-value="${l}" selected="selected">${d}(${l})</option>`:m+=`<option data-value="${d}">${d}</option>`;}),a.className="code-select-language",a.innerHTML=m,r.on(a,"change",function(){let d=a.selectedOptions[0].getAttribute("data-value");a.setAttribute("aria-label",d),b.info("切换代码块语言: ",d),i.querySelectorAll("li").forEach(u=>{s(u,d);});}),g.preventEvent(a,"click"),o.appendChild(a),n.append(o),g.dispatchEvent(a,"change"),i.className="hljs",i.firstChild.removeAttribute("class"),n.querySelector(".reader-copy-button").setAttribute("data-code-selector",g.getElementSelector(i));});},optimizationImagePreview(){b.info("图片查看优化");function t(i=[],n=0){let s="";i.forEach(a=>{s+=`<li><img data-src="${a}"></li>`;});let l=r.createElement("ul",{innerHTML:s}),o=new Rt(l,{inline:false,url:"data-src",zIndex:g.getMaxZIndex()+100,hidden:()=>{o.destroy();}});b.info("查看的图片的下标",n),o.view(n),o.zoomTo(1),o.show();}let e=[{hostName:"avatar-bbs.mt2.cn",pathName:"*"},{hostName:"cdn-bbs.mt2.cn",pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"/uc_server/avatar.php"}];g.waitNodeList("div.comiis_postlist.kqide .comiis_postli:not([data-isHandlingViewIMG])").then(i=>{i.forEach(n=>{n.setAttribute("data-isHandlingViewIMG","true");let s=[];n.querySelectorAll("img").forEach(l=>{let o=l.src,a=new URL(o).hostname,c=new URL(o).pathname,m=l.parentElement;m.nodeName.toLowerCase()==="span"&&m.removeAttribute("onclick"),m.nodeName.toLowerCase()==="a"&&m.getAttribute("href")===o&&(m.setAttribute("href","javascript:;"),m.removeAttribute("target"));let d=false;for(let u of e)if(a.indexOf(u.hostName)!=-1&&c.match(u.pathName)){d=true;break}d||(s=[...s,o],r.on(l,"click",function(){b.info("点击图片",l);let u=s.findIndex(f=>f==o);t(s,u);}));}),s.length&&b.info("处理的图片",s);});});},setAttachmentsClickTip(){b.info("附件点击提醒");function t(e){if(e.hasAttribute("href")){let i=e.getAttribute("href"),n=e.querySelector("span.f_ok"),s=e.querySelector(".attach_size");if(r.text(s).indexOf("金币")===-1)return;b.info("发现附件",e),b.info("该附件是金币附件，拦截！");let l=r.text(n);e.setAttribute("data-href",e.getAttribute("href")),e.removeAttribute("href"),n.innerText="【已拦截】"+l,e.onclick=function(){b.info("附件url：",i),N.confirm({title:{text:"提示",position:"center"},content:{text:`<br />确定花费2金币下载附件 <a style="color: #507daf !important;">${l}</a> ？<br /><br />`,html:true},btn:{ok:{callback:o=>{window.open(i,"_blank"),o.close();}}},mask:{enable:true},width:"88vw",height:"200px"});};}}g.mutationObserver(document.documentElement,{callback:()=>{U(".attnm a").forEach(e=>{t(e);}),U(".comiis_attach a").forEach(e=>{t(e);});},config:{childList:true,subtree:true}}),g.waitNodeList(".attnm a").then(e=>{e.forEach(i=>{t(i);});}),g.waitNodeList(".comiis_attach a").then(e=>{e.forEach(i=>{t(i);});});}},xe={init(){W(`
		/* 去除搜索框的蒙版 */
        #comiis_search_noe{
        ...
        `),Z.ready(()=>{$.execMenuOnce("mt-search-showSearchHistory",()=>{this.showSearchHistory();}),$.execMenuOnce("mt-search-repairClearBtn",()=>{this.repairClearBtn();}),$.execMenuOnce("mt-search-searchInputAutoFocus",()=>{this.searchInputAutoFocus();});});},async showSearchHistory(){b.info("显示搜索历史");let t=Y("search_history",[]),e=C("#scform_srchtxt"),i=C("#searchform"),n=N.searchSuggestion({target:e,inputTarget:e,data:t,getItemHTML:function(o){return o},getData(o){return t.filter(a=>a.includes(o))},deleteIcon:{enable:true,callback(o,a,c){let m=t.findIndex(d=>d===c);m!==-1&&(t.splice(m,1),G("search_history",t)),a.remove();}},itemClickCallBack(o,a,c){e.value=c,i.submit();}});n.init(),n.setAllEvent();function s(){let o=document.querySelector("#scform_submit");Z.on(o,"click",function(){let a=e.value;if(a!=""){let c=Y("search_history",[]);c.includes(a)?b.info("已有该搜索历史记录"):(b.info("无该记录，追加"),c.push(a)),G("search_history",c);}});}function l(){let a='<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px">搜索记录个数: '+Y("search_history",[]).length+`<button class="btn_clear_search_history" style="
                    border: none;
                    float: right;
                    background: red;
                    color: #fff;
                    ...
                    min-width: 20vw;
                    width: 20vw;
                ">清理记录</button></div>`;Z.before(document.querySelector(".comiis_p12"),a);let c=document.querySelector(".btn_clear_search_history");Z.on(c,"click",m=>{g.preventEvent(m),lt("search_history"),window.location.reload();});}s(),l();},repairClearBtn(){g.waitNode("a.ssclose").then(t=>{b.info("修复清空按钮"),Z.on(t,"click",e=>{let i=document.querySelector("#scform_srchtxt");i?i.value="":y.error("获取输入框失败");},{capture:true});});},searchInputAutoFocus(){new URLSearchParams(window.location.search).has("kw")||g.waitNode("#scform_srchtxt").then(e=>{b.info("搜索框自动获取焦点"),e.focus();});}},we={init(){r.ready(()=>{$.execMenuOnce("mt-sign-showTodaySignStar",()=>{this.showTodaySignStar();}),$.execMenuOnce("mt-sign-showTodayRanking",()=>{this.showTodayRanking();});});},async showTodaySignStar(){b.info("显示【今日签到之星】");let t=document.querySelector(".pg_k_misign .comiis_qdinfo"),e=document.createElement("ul"),i=await H.get("/k_misign-sign.html",{headers:{"User-Agent":g.getRandomPCUA()}});if(!i.status)return;let s=r.parseHTML(i.data.responseText,true,true).querySelector("#pt span.xg1");if(!s)return;let l=r.text(s).replace("今日签到之星：","");e.innerHTML=`
		<li class="f_f" style="display: flex;flex-direction: column;width: 100%;">
			<span class="comiis_tm">今日签到之星</span>
			${l}
		</li>
		`;let o=document.querySelector(".comiis_space_box"),a=parseInt(getComputedStyle(o,null).height.replace("px","")),c=parseInt(getComputedStyle(o,null).paddingBottom.replace("px","")),m=a+c+50;W(`
		.comiis_space_box{
			height: ${m}px;
		...
		}`),t.append(e);},showTodayRanking(){b.info("显示【今日最先】");let t=document.querySelector(".comiis_topnv .comiis_flex .flex"),e=r.createElement("li",{className:"flex"}),i=r.createElement("a",{id:"k_misignlist_today_latest",href:"javascript:;",innerHTML:"今日最先"},{onclick:"ajaxlist('todayLatest');"});e.appendChild(i),r.after(t,e);let n=async o=>{let a=await H.get(`/k_misign-sign.html?operation=${o}`,{responseType:"html",headers:{"User-Agent":g.getRandomPCUA()}});if(!a.status)return;let m=r.parseHTML(a.data.responseText,true,true).querySelector("#J_list_detail .pg span");if(m&&typeof m.title<"u"){let d=m.title.match(/([0-9]+)/);if(d&&d.length==2)return parseInt(d[d.length-1]);y.error("获取页失败");}else y.error("请求最先签到的页失败");},s=async o=>{let a=await H.get(`/k_misign-sign.html?operation=list&op=&page=${o}`,{responseType:"html",headers:{"User-Agent":g.getRandomPCUA()}});if(!a.status)return;let m=r.parseHTML(a.data.responseText,true,true).querySelectorAll("#J_list_detail tbody tr"),d=[];if(m.length==2&&m[0].textContent.indexOf("暂无内容")!=-1)return d;for(let u=1;u<=m.length-2;u++){let f=m[u],p={user:"",uid:"",avatar:"",days:"",monthDays:"",time:"",reward:""},h=f.children[0].getElementsByTagName("a")[0].textContent,k=f.children[0].getElementsByTagName("a")[0].href.match(/space-uid-([0-9]*)/)[1],v=f.children[1].textContent,S=f.children[2].textContent,A=f.children[3].textContent,I=f.children[5].textContent;p.user=h,p.uid=k,p.avatar=F.getAvatar(k,"small"),p.days=v,p.monthDays=S,p.time=A,p.reward=I,d.push(p);}return d};function l(o,a){let c=document.querySelector("#ranklist");r.html(c,o),r.attr(c,"listtype",a);}x.ajaxlist=async o=>{if(o=o,o=="today"?(loadingdelay=false,urlextra="list&op=today"):o=="month"?(loadingdelay=false,urlextra="list&op=month"):o=="zong"?(loadingdelay=false,urlextra="list&op=zong"):o=="calendar"?(loadingdelay=true,urlextra="calendar"):(loadingdelay=false,urlextra="list"),o=="todayLatest"){loadingdelay=false,urlextra="list&op=&page=0";let a=await n(urlextra);if(!a)return;let c=await s(a);if(c.reverse(),c.length<10){let u=await s(a-1);u.reverse(),c=c.concat(u),c.reverse();}let m="";c.reverse(),c.forEach(u=>{m=m+`
		...
		`);async function t(){let o=await H.get(window.location.href,{headers:{"User-Agent":g.getRandomPCUA()}});if(!o.status)return;let a=r.parseHTML(o.data.responseText,true,true),c=[];return a.querySelectorAll("#delform tr.bw0_all+tr").forEach(m=>{let d=[],u=m.querySelector("td"),f=r.html(u).replace(/^&nbsp;/,"");d.push(f);let p=r.next(m),h=a.querySelectorAll("#delform tr");for(let _=0;_<h.length&&!(!p||r.attr(p,"class")==="bw0_all");_++){let k=p.querySelector("td"),v=r.html(k).replace(/^&nbsp;/,"");d=d.concat(v),p=r.next(p);}c.push(...d);}),c}function e(){return g.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist())}function i(o){let a={};return o.forEach(c=>{var _;let d=(_=r.createElement("div",{innerHTML:c}).querySelector("a"))==null?void 0:_.getAttribute("href"),u=d.match(X.ptid),f=d.match(X.pid);if(!u){y.error("获取ptid失败");return}if(!f){y.error("获取pid失败");return}let p=u[u.length-1],h=f[f.length-1];a[p]?a[p].data.push(c):a[p]={ptid:p,pid:h,data:[c]};}),a}var n=await t();if(n==null)return;var s=i(n);e().forEach((o,a)=>{let m=o.querySelector(".comiis_xznalist_bottom a").getAttribute("tid");if(!m){y.error("获取帖子tid失败"),b.error(o);return}s[m]&&s[m].data.forEach(d=>{r.append(o,`<div class="contrete-reply">${d}</div>`);});});}},mt={$key:{tipData:"tipToFreeSubjectForumPost"},init(){this.registerMenu();let t=this.getTipData();if(M.isPost()&&document.querySelector("span.kmren")){b.info("当前帖子存在需要购买主题");let l=false,o;t.forEach((c,m)=>{if(window.location.href.match(c.url)){l=true;return}}),l?(b.warn("已设置提醒"),o=r.createElement("a",{href:"javascript:;",className:"styli_tit f_c",innerHTML:`
                ...
                <span class="sidenv_num bg_del f_f" style="
                    ...
                    display: inline-flex;
                    bottom: 8px;
                "></span>`);},registerMenu(){j.registerLeftMenu({name:"付费主题白嫖提醒",icon:"",iconColor:"#ec0000",callback:()=>{this.showView();}});},showView(){b.info("显示白嫖列表");let t=mt.getTipData();N.alert({title:{text:"付费主题白嫖列表",position:"center"},content:{text:"",html:true},btn:{ok:{text:"关闭",type:"default"}},mask:{enable:true},width:"88vw",height:"88vh"});let e="",i=0,n="",s="",l=[],o=[],a=[];t.forEach((p,h)=>{let _="#f91212",k="";new Date().getTime()>p.expirationTimeStamp&&(_="#1e90ff",p.isVisited||(k=`
                ...
                </tbody>`,timestamp:p.expirationTimeStamp};new Date().getTime()>p.expirationTimeStamp?k!=""?l.push(v):o.push(v):a.push(v);}),b.info("可白嫖但未访问：",l),b.info("可白嫖：",o),b.info("未到白嫖时间：",a),g.sortListByProperty(l,"expirationTimeStamp",false),g.sortListByProperty(o,"timestamp",false),g.sortListByProperty(a,"timestamp",false),b.info("排序后——可白嫖但未访问：",l),b.info("排序后——可白嫖：",o),b.info("排序后——未到白嫖时间：",a),n=g.mergeArrayToString(l,"content")+g.mergeArrayToString(o,"content"),s=g.mergeArrayToString(a,"content"),i>0&&(e=`
        ...
        `,d=document.querySelector(".msgcon");r.html(d,""),r.append(d,c),r.append(d,m),r.css(d,"height","400px"),r.on(document.querySelector(".delsubjecttip i.comiis_font"),"click",p=>{let h=p.target,_=r.parent(h);var k=parseInt(_.getAttribute("t-index"));N.confirm({title:{text:"提示",position:"center"},content:{text:"<p>确定移出付费主题白嫖列表？</p>",html:true},mask:{enable:true},btn:{ok:{callback:v=>{t.splice(k,1),mt.setTipData(t),g.deleteParentNode(h,"tr"),v.close();}}},width:"80vw",height:"300px"});});let u=document.querySelector("#paymentSubjectReminderIsFreeList");r.on(u,"click","a",p=>{var I,P,E,R,O,q;let h=p.target;var _=parseInt(h.getAttribute("t-index")),k=h.getAttribute("t-href");if(t[_].isVisited=true,mt.setTipData(t),window.open(k,"_blank"),h.setAttribute("style","color: #000000;"),((P=(I=h==null?void 0:h.parentElement)==null?void 0:I.parentElement)==null?void 0:P.children[0].className)!="icon_msgs bg_del")return;h.parentElement.parentElement.children[0].remove(),r.append(u,(q=(O=(R=(E=h==null?void 0:h.parentElement)==null?void 0:E.parentElement)==null?void 0:R.parentElement)==null?void 0:O.parentElement)==null?void 0:q.parentElement);let v=document.querySelector(".subjectcanvisit summary span.icon_msgs.bg_del.f_f"),S=r.text(v),A=parseInt(S)-1;A>0?r.html(v,A.toString()):v.remove();});let f=document.querySelector("paymentSubjectReminderIsPaidList");r.on(f,"click","a",p=>{let h=p.target;h.getAttribute("t-index");var _=h.getAttribute("t-href");window.open(_,"_blank"),h.setAttribute("style","color: #000000;");});},getTipData(){return Y(this.$key.tipData,[])},setTipData(t){G(this.$key.tipData,t);}},qe=`.pops {\r
	--icon-width: 24px;\r
...
`;class $e{constructor(e){nt(this,"isBacking",false);nt(this,"config");this.config=e,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(e){g.preventEvent(e),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){b.success("进入手势模式");let e=this.config.hash;e.startsWith("#")||(e.startsWith("/")||(e="/"+e),e="#"+e),this.config.useUrl&&(e=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+e),this.config.win.history.pushState({},"",e),b.success("监听popstate事件"),r.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(e=false){this.isBacking=true,b.success("退出手势模式"),typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(e);let i=Date.now()+1e3*5;for(;;){if(Date.now()>i){b.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))b.info("history.back()"),this.config.win.history.back(),await g.sleep(this.config.backDelayTime||150);else break}b.success("移除popstate事件"),r.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(e);}}const ct={https:`
		...
		</svg>`},Ht={$key:{smallWindow:"smallWindow"},$el:{$refreshIcon:null,$webSiteIcon:null},init(){let t=new g.LockFunction(()=>{let e=this.getForumList();e.length&&this.handleForumPost(e);});g.mutationObserver(document.documentElement,{callback:(e,i)=>{t.run();},config:{subtree:true,childList:true}});},getForumList(){return g.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist())},showSmallWindow(t,e,i=[]){let n=new URL(e),s=n.protocol.includes("https:"),l=`
        ...
        <div class="small-window-title-container">
            ...
            <div class="small-window-control">
                ...
                `,html:true},mask:{enable:true,clickEvent:{toClose:true},clickCallBack(I,P){A.quitGestureBackMode();}},btn:{ok:{enable:false},cancel:{enable:false},close:{enable:false}},direction:"bottom",size:"92%",borderRadius:18,style:qe}),a=o.$shadowRoot.querySelector(".small-window-website-icon"),c=o.$shadowRoot.querySelector(".refresh-icon"),m=o.$shadowRoot.querySelector(".small-window-control-image-view"),d=o.$shadowRoot.querySelector(".small-window-control-open-blank"),u=o.$shadowRoot.querySelector(".small-window-control-close"),f=o.$shadowRoot.querySelector(".small-window-title-text");this.$el.$refreshIcon=c,this.$el.$webSiteIcon=a;let p=o.$shadowRoot.querySelector("iframe"),h=o.$shadowRoot.querySelector(".small-window-drag"),_=N.config.Utils.AnyTouch(),k=new _(h),v=o.popsElement,S=r.height(v);k.on("pan",I=>{I.phase=="move"&&I.displacementY>0&&(v.style.transition="none",v.style.height=Math.abs(S-I.distanceY)+"px"),I.isEnd&&(v.style.transition="0.2s ease-in",parseInt(v.style.height)>window.innerHeight/2?v.style.height=S+"px":o.close());});let A=new $e({hash:this.$key.smallWindow,useUrl:true,win:x,beforeHistoryBackCallBack:I=>{o.close();}});A.enterGestureBackMode(),r.on(f,"click",I=>{g.preventEvent(I),g.setClip(`『${t}』 - ${e}`),y.success("已复制链接");}),r.on(m,"click",I=>{g.preventEvent(I),b.info("查看图片",i);var P="";i.forEach(O=>{P+=`<li><img data-src="${O}"></li>`;});var E=r.parseHTML(`<ul>${P}</ul>`,false,false);let R=new Rt(E,{inline:false,url:"data-src",zIndex:(()=>{let O=g.getMaxZIndex(),q=N.config.InstanceUtils.getPopsMaxZIndex().zIndex;return g.getMaxValue(O,q)+100})(),hidden:()=>{R.destroy();}});R.zoomTo(1),R.show();}),r.on(u,"click",I=>{g.preventEvent(I),A.quitGestureBackMode();}),r.on(d,"click",I=>{g.preventEvent(I),window.open(e,"_blank");}),r.on(a,"click",I=>{g.preventEvent(I),p.contentWindow.location.reload(),this.checkIframeReadyState(p);}),this.checkIframeReadyState(p);},async handleForumPost(t){t.forEach(e=>{if(e.getAttribute("data-injection-small-window"))return;let i=r.text(e.querySelector(".mmlist_li_box h2 a"));(i==""||i==null)&&(i=r.text(e.querySelector(".mmlist_li_box a"))),i=i.trim();let n=e.querySelector(".mmlist_li_box a").href;var s=[];e.setAttribute("data-injection-small-window","true"),e.setAttribute("data-injection-small-window-url",n),e.setAttribute("data-injection-small-window-title",i),e.querySelectorAll(".comiis_pyqlist_img img").forEach(o=>{s.push(o.getAttribute("src"));}),e.querySelectorAll(".comiis_pyqlist_imgs img").forEach(o=>{s.push(o.getAttribute("src"));}),e.querySelectorAll(".mmlist_li_box a").forEach(o=>{o.removeAttribute("href"),o.setAttribute("data-href",n);});let l=e.querySelector(".mmlist_li_box");r.on(l,"click",function(o){var a=Number(o.clientX);document.body.offsetWidth/2>a?window.location.href=n:Ht.showSmallWindow(i,n,s);});});},checkIframeReadyState(t){this.showRefreshIcon();let e=setInterval(()=>{t.contentWindow&&(clearInterval(e),r.createDOMUtils({document:t.contentWindow.document,window:t.contentWindow,globalThis:t.contentWindow,self:t.contentWindow,top}).ready(()=>{b.success("小窗内容已加载完毕"),this.hideRefreshIcon();}));},400);},hideRefreshIcon(){this.$el.$refreshIcon.style.display="none",this.$el.$webSiteIcon.style.display="";},showRefreshIcon(){this.$el.$refreshIcon.style.display="",this.$el.$webSiteIcon.style.display="none";}},ke={init(){Z.ready(()=>{$.execMenuOnce("mt-guide-showLatestPost",()=>{this.showLatestPost();});});},showLatestPost(){b.info("显示最新帖子");async function t(){let e=await H.get("/forum.php?mod=guide&view=hot",{fetch:true,allowInterceptConfig:false});if(!e.status){y.error("获取轮播失败");return}if(e.data.responseText.indexOf('<script src="/_guard/auto.js"><\/script>')!==-1){y.error("获取轮播失败 未知的/_guard/auto.js文件");return}var i=Z.parseHTML(e.data.responseText,true,true),n=i.querySelectorAll('div.comiis_mh_kxtxt div[id*="comiis_mh_kxtxt"] ul');if(n.length===0){y.error("获取轮播失败");return}else {var s=[];n[n.length-1].querySelectorAll("a").forEach(l=>{s.push({href:l.getAttribute("href"),title:l.getAttribute("title")});});}return s}t().then(e=>{if(!e)return;W(`
            ...
            `);var i="";g.sortListByProperty(e,s=>{var l=s.href.match(/thread-(.+?)-/i);return parseInt(l[l.length-1])},true),b.info("导读内容",e),e.forEach(s=>{i+=`
                <li>
                    <span>新帖</span>
                    <a href="${s.href}" title="${s.title}" target="_blank">${s.title}</a>
                </li>`;});let n=document.querySelector(".comiis_forumlist.comiis_xznlist");Z.before(n,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}};class Ot{constructor(e){nt(this,"option");this.option=e;}async showView(){var o;let e=N.confirm({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `,width:typeof this.option.width=="function"?this.option.width():window.innerWidth>500?"500px":"88vw",height:typeof this.option.height=="function"?this.option.height():window.innerHeight>500?"500px":"80vh"}),i=e.$shadowRoot.querySelector(".rule-form-container");e.$shadowRoot.querySelector("input[type=submit]");let n=e.$shadowRoot.querySelector(".rule-form-ulist"),s=await this.option.getView(await this.option.data());n.appendChild(s);const l=async()=>{(await this.option.onsubmit(i,await this.option.data())).success&&(e.close(),await this.option.dialogCloseCallBack(true));};}}class Se{constructor(e){nt(this,"option");this.option=e;}showView(){let e=N.alert({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `}),i=e.$shadowRoot.querySelector(".filter-container"),n=document.createDocumentFragment();this.option.filterOption.forEach(s=>{let l=document.createElement("button");l.innerText=s.name;let o=async()=>{(await this.option.getAllRuleInfo()).forEach(async c=>{await s.filterCallBack(c.data)?r.show(c.$el,false):r.hide(c.$el,false);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};r.on(l,"click",async a=>{g.preventEvent(a),!(typeof s.callback=="function"&&!await s.callback(a,o))&&await o();}),n.appendChild(l);}),i.appendChild(n);}}class qt{constructor(e){nt(this,"option");this.option=e;}async showView(e){var l,o,a,c,m,d,u,f,p;let i=N.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    <div class="rule-view-container">
                    </div>
                    `,html:true},btn:{merge:true,reverse:false,position:"space-between",ok:{enable:((a=(o=(l=this.option)==null?void 0:l.bottomControls)==null?void 0:o.add)==null?void 0:a.enable)||true,type:"primary",text:"添加",callback:async h=>{this.showEditView(false,await this.option.getAddData(),i.$shadowRoot);}},close:{enable:true,callback(h){i.close();}},cancel:{enable:((d=(m=(c=this.option)==null?void 0:c.bottomControls)==null?void 0:m.filter)==null?void 0:d.enable)||false,type:"default",text:"过滤",callback:(h,_)=>{var S,A,I,P,E,R,O;typeof((I=(A=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:A.filter)==null?void 0:I.callback)=="function"&&this.option.bottomControls.filter.callback();let k=()=>Array.from(i.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),v=_.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");r.text(v).includes("取消")?(k().forEach(q=>{r.show(q,false);}),r.text(v,"过滤")):new Se({title:((E=(P=this.option.bottomControls)==null?void 0:P.filter)==null?void 0:E.title)??"过滤规则",filterOption:((O=(R=this.option.bottomControls)==null?void 0:R.filter)==null?void 0:O.option)||[],execFilterCallBack(){r.text(v,"取消过滤");},getAllRuleInfo:()=>k().map(w=>({data:this.parseRuleItemElement(w).data,$el:w}))}).showView();}},other:{enable:((p=(f=(u=this.option)==null?void 0:u.bottomControls)==null?void 0:f.clear)==null?void 0:p.enable)||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:h=>{let _=N.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async k=>{var S,A,I;if(b.success("清空所有"),typeof((I=(A=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:A.clear)==null?void 0:I.callback)=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){y.error("清理失败");return}else y.success("清理成功");await this.updateDeleteAllBtnText(i.$shadowRoot),this.clearContent(i.$shadowRoot),_.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${N.config.cssText.panelCSS}
            ...
            `}),n=await this.option.data(),s=false;for(let h=0;h<n.length;h++){let _=n[h],k=await this.appendRuleItemElement(i.$shadowRoot,_);(typeof e=="function"?e(_):true)||(s=true,k.forEach(S=>{r.hide(S,false);}));}if(s){let h=i.$shadowRoot.querySelector(".pops-confirm-btn-cancel span");r.text(h,"取消过滤");}}parseViewElement(e){let i=e.querySelector(".rule-view-container"),n=e.querySelector(".pops-confirm-btn button.pops-confirm-btn-other");return {$container:i,$deleteBtn:n}}parseRuleItemElement(e){let i=e.querySelector(".rule-controls-enable"),n=i.querySelector(".pops-panel-switch"),s=i.querySelector(".pops-panel-switch__input"),l=i.querySelector(".pops-panel-switch__core"),o=e.querySelector(".rule-controls-edit"),a=e.querySelector(".rule-controls-delete");return {$enable:i,$enableSwitch:n,$enableSwitchInput:s,$enableSwitchCore:l,$edit:o,$delete:a,data:Reflect.get(e,"data-rule")}}async createRuleItemElement(e,i){let n=await this.option.getDataItemName(e),s=r.createElement("div",{className:"rule-item",innerHTML:`
			...
			`});Reflect.set(s,"data-rule",e);let l="pops-panel-switch-is-checked";const{$enable:o,$enableSwitch:a,$enableSwitchCore:c,$enableSwitchInput:m,$delete:d,$edit:u}=this.parseRuleItemElement(s);return this.option.itemControls.enable.enable?(r.on(c,"click",async f=>{let p=false;a.classList.contains(l)?(a.classList.remove(l),p=false):(a.classList.add(l),p=true),m.checked=p,await this.option.itemControls.enable.callback(e,p);}),await this.option.itemControls.enable.getEnable(e)&&a.classList.add(l)):o.remove(),this.option.itemControls.edit.enable?r.on(u,"click",f=>{g.preventEvent(f),this.showEditView(true,e,i,s,p=>{e=null,e=p;});}):u.remove(),this.option.itemControls.delete.enable?r.on(d,"click",f=>{g.preventEvent(f);let p=N.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async h=>{b.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(e)?(y.success("成功删除该数据"),s.remove(),await this.updateDeleteAllBtnText(i),p.close()):y.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):d.remove(),s}async appendRuleItemElement(e,i){let{$container:n}=this.parseViewElement(e),s=[],l=Array.isArray(i)?i:[i];for(let o=0;o<l.length;o++){let a=l[o],c=await this.createRuleItemElement(a,e);n.appendChild(c),s.push(c);}return await this.updateDeleteAllBtnText(e),s}async updateRuleContaienrElement(e){this.clearContent(e);const{$container:i}=this.parseViewElement(e);let n=await this.option.data();await this.appendRuleItemElement(e,n),await this.updateDeleteAllBtnText(e);}async updateRuleItemElement(e,i,n){let s=await this.createRuleItemElement(e,n);i.after(s),i.remove();}clearContent(e){const{$container:i}=this.parseViewElement(e);r.html(i,"");}setDeleteBtnText(e,i,n=false){const{$deleteBtn:s}=this.parseViewElement(e);n?r.html(s,i):r.text(s,i);}async updateDeleteAllBtnText(e){let i=await this.option.data();this.setDeleteBtnText(e,`清空所有(${i.length})`);}showEditView(e,i,n,s,l){let o=async c=>{if(!c){if(e||await this.option.deleteData(i),typeof l=="function"){let m=await this.option.getData(i);l(m);}}};new Ot({title:e?"编辑":"添加",data:()=>i,dialogCloseCallBack:o,getView:async c=>await this.option.itemControls.edit.getView(c,e),btn:{ok:{enable:true,text:e?"修改":"添加"},cancel:{callback:async(c,m)=>{c.close(),await o(false);}},close:{callback:async(c,m)=>{c.close(),await o(false);}}},onsubmit:async(c,m)=>{let d=await this.option.itemControls.edit.onsubmit(c,e,m);return d.success?e?(y.success("修改成功"),n&&await this.updateRuleItemElement(d.data,s,n)):n&&await this.appendRuleItemElement(n,d.data):e&&y.error("修改失败"),d},style:this.option.itemControls.edit.style,width:this.option.itemControls.edit.width,height:this.option.itemControls.edit.height}).showView();}}const Te={$key:{STORAGE_KEY:"mt-own-block-rule"},$data:{isRegister:false},init(){this.registerMenu();let t=new g.LockFunction(()=>{this.runRule();});g.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{t.run();}});},registerMenu(){this.$data.isRegister||(this.$data.isRegister=true,j.registerLeftMenu({name:"我的屏蔽",icon:"",iconColor:"#000",callback:()=>{this.showView();}}));},getTemplateData(){return {uuid:g.generateUUID(),enable:true,name:"",data:{userName:"",userUID:"",userLevel:"",postUrl:"",postTitle:"",postContent:"",postPlateName:""}}},showView(){let t=N.config.panelHandleContentUtils();function e(n){return {get(s,l){return n[s]??l},set(s,l){n[s]=l;}}}new qt({title:"我的屏蔽",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(o=>o.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,s)=>{n.enable=s,this.updateData(n);}},edit:{enable:true,getView:(n,s)=>{let l=document.createDocumentFragment();s||(n=this.getTemplateData());let o=L("启用","enable",true);Reflect.set(o.props,D,e(n));let a=t.createSectionContainerItem_switch(o),c=V("规则名称","name","","",void 0,"必填");Reflect.set(c.props,D,e(n));let m=t.createSectionContainerItem_input(c),d=V("用户名","userName","","",void 0,"可正则");Reflect.set(d.props,D,e(n.data));let u=t.createSectionContainerItem_input(d),f=V("用户UID","userUID","","",void 0,"可正则");Reflect.set(f.props,D,e(n.data));let p=t.createSectionContainerItem_input(f),h=V("用户等级","userLevel","","",void 0,"可正则");Reflect.set(h.props,D,e(n.data));let _=t.createSectionContainerItem_input(h),k=V("帖子url","postUrl","","",void 0,"可正则");Reflect.set(k.props,D,e(n.data));let v=t.createSectionContainerItem_input(k),S=V("帖子标题","postTitle","","",void 0,"可正则");Reflect.set(S.props,D,e(n.data));let A=t.createSectionContainerItem_input(S),I=V("帖子内容","postContent","","",void 0,"可正则");Reflect.set(I.props,D,e(n.data));let P=t.createSectionContainerItem_input(I),E=V("帖子所在的板块名","postPlateName","","",void 0,"可正则");Reflect.set(E.props,D,e(n.data));let R=t.createSectionContainerItem_input(E);return l.appendChild(a),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(_),l.appendChild(v),l.appendChild(A),l.appendChild(P),l.appendChild(R),l},onsubmit:(n,s,l)=>{let o=n.querySelectorAll(".rule-form-ulist > li"),a=this.getTemplateData();return s&&(a.uuid=l.uuid),o.forEach(c=>{let m=Reflect.get(c,"__formConfig__"),d=Reflect.get(m,"attributes"),u=Reflect.get(c,D),f=Reflect.get(d,et),p=Reflect.get(d,it),h=u.get(f,p);Reflect.has(a,f)?Reflect.set(a,f,h):Reflect.has(a.data,f)?Reflect.set(a.data,f,h):b.error(`${f}不在数据中`);}),a.name.trim()===""?(y.error("规则名称不能为空"),{success:false,data:a}):s?{success:this.updateData(a),data:a}:{success:this.addData(a),data:a}}},delete:{enable:true,deleteCallBack:n=>this.deleteData(n)}}}).showView();},runRule(){let t=this.getData();function e(i){for(const n of t){let s=n.data;if(Object.keys(s).find(o=>{let a=s[o];if(g.isNotNull(a)){let c=new RegExp(a,"i"),m=Reflect.get(i,o);if(typeof m=="string"&&g.isNotNull(m)&&m.match(c))return b.info("屏蔽",[s,m]),true}return  false}))return  true}return  false}(M.isGuide()||M.isPlate()||M.isPost())&&(this.getData(),document.querySelectorAll(".comiis_forumlist .forumlist_li").forEach(i=>{var o;let n=i.querySelector("a.top_user"),s=n.href.match(X.uid),l={userName:n.innerText,userUID:s[s.length-1].trim(),userLevel:i.querySelector("span.top_lev").innerText.replace("Lv.",""),postUrl:i.querySelector(".mmlist_li_box a").getAttribute("href")||i.querySelector(".mmlist_li_box a").getAttribute("data-href"),postTitle:((o=i.querySelector(".mmlist_li_box h2 a"))==null?void 0:o.innerText)||"",postContent:i.querySelector(".mmlist_li_box .list_body").innerText,postPlateName:(i.querySelector(".forumlist_li_time a.f_d")||i.querySelector(".comiis_xznalist_bk.cl")).innerText.replace(//g,"").replace(/\s*/g,"").replace(/来自/g,"")};g.isNull(l.postPlateName)&&(l.postPlateName=document.querySelector("#comiis_wx_title_box").innerText),e(l)&&i.remove();}),document.querySelectorAll(".comiis_postlist .comiis_postli").forEach(i=>{let n=i.querySelector("a.top_user"),s=n.href.match(X.uid),l={userName:n.innerText,userUID:s[s.length-1].trim(),userLevel:i.querySelector("a.top_lev").innerText.replace("Lv.",""),postUrl:void 0,postTitle:void 0,postContent:i.querySelector(".comiis_message_table").innerText,postPlateName:void 0};e(l)&&i.remove();})),M.isMessageList()&&(this.getData(),U(".comiis_pms_box .comiis_pmlist ul li").forEach(i=>{let n=i.querySelector("a.b_b").href.match(X.uid),s={userName:i.querySelector("h2").innerText.replace(i.querySelector("h2 span").innerText,"").replace(/\s*/,""),userUID:n[n.length-1].trim(),userLevel:void 0,postUrl:i.querySelector("a.b_b").href,postTitle:void 0,postContent:i.querySelector("p.f_c").innerText.trim(),postPlateName:void 0};e(s)&&i.remove();}));},getData(){return Y(this.$key.STORAGE_KEY,[])},setData(t){G(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(n=>n.uuid==t.uuid)===-1?(e.push(t),G(this.$key.STORAGE_KEY,e),true):false},updateData(t){let e=this.getData(),i=e.findIndex(s=>s.uuid==t.uuid),n=false;return i!==-1&&(n=true,e[i]=t),this.setData(e),n},deleteData(t){let e=this.getData(),i=e.findIndex(s=>s.uuid==t.uuid),n=false;return i!==-1&&(n=true,e.splice(i,1)),this.setData(e),n},clearData(){lt(this.$key.STORAGE_KEY);}},Ce={$el:{isFilterElementHTML:[]},$key:{STORAGE_KEY:"mt-post-comment-filter-rule"},init(){if(this.registerMenu(),M.isPost()){let t=this.getData();if(!t.enable)return;let e=new g.LockFunction(()=>{this.runFilter(t);});g.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{e.run();}});}},registerMenu(){j.registerLeftMenu({name:"评论过滤器",icon:"",iconColor:"#ff0019",callback:()=>{this.showView();}});},runFilter(t){let e=function(n){for(const s of t.userBlackList)if(s==n.userName||s==n.userUID)return b.success("评论过滤器：黑名单用户",n),true;return  false},i=function(n){for(const s of t.userWhiteList)if(s===n.userName||s===n.userUID)return b.success("评论过滤器：白名单用户",n),true;return  false};U(".comiis_postlist .comiis_postli").forEach(n=>{var a,c,m;if(n.querySelector("#comiis_allreplies"))return;let s=n.querySelector("a.top_user"),l=s.href.match(X.uid),o={userName:(s==null?void 0:s.innerText)||"",userUID:l&&((a=l[(l==null?void 0:l.length)-1])==null?void 0:a.trim())||"",content:((m=(c=n.querySelector(".comiis_message_table"))==null?void 0:c.innerText)==null?void 0:m.trim())||"",isAuthor:!!n.querySelector("span.top_lev")};if(!i(o)){if(t.replyFlag&&n.querySelector(".comiis_quote")){let d=n.querySelector(".comiis_quote");this.$el.isFilterElementHTML.push(d.outerHTML),d.remove();}if(!(o.isAuthor&&!t.avatarFlag)){if(e(o)){this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}if(!(typeof t.minLength=="number"&&t.minLength>o.content.length)&&!(typeof t.keywordLength=="number"&&t.keywordLength<o.content.length))for(const d of t.keywords){if(typeof d!="string")continue;let u=new RegExp(d);if(o.content.match(u)){console.log("评论过滤器：",o),this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}}}}});},showView(){const t=this;function e(s){return {get(l,o){let a=t.getData(),c=Reflect.get(a,l,o);return (l==="keywords"||l==="userWhiteList"||l==="userBlackList")&&(c=c.join(`
`)),c},set(l,o){(l==="keywords"||l==="userWhiteList"||l==="userBlackList")&&(o=o.split(`
`).filter(a=>a.trim()!="")),Reflect.set(s,l,o),t.setData(s);}}}let i=N.config.panelHandleContentUtils();new Ot({title:"评论过滤器",data:()=>this.getData(),getView:s=>{let l=document.createDocumentFragment(),o=L("启用","enable",true);Reflect.set(o.props,D,e(s));let a=i.createSectionContainerItem_switch(o),c=L("处理回复引用","replyFlag",false,void 0,"移除引用");Reflect.set(c.props,D,e(s));let m=i.createSectionContainerItem_switch(c),d=L("处理作者评论","avatarFlag",false);Reflect.set(d.props,D,e(s));let u=i.createSectionContainerItem_switch(d),f=L('处理从"搜索页面"或"我的帖子提醒页面"进入的网站',"viewthreadFlag",false);Reflect.set(f.props,D,e(s));let p=i.createSectionContainerItem_switch(f),h=V("匹配的评论内容长度最小值","minLength",5,"小于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(h.props,D,e(s));let _=i.createSectionContainerItem_input(h),k=V("匹配的评论内容长度最大值","keywordLength",8,"大于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(k.props,D,e(s));let v=i.createSectionContainerItem_input(k),S=dt("评论关键字","keywords","","多个关键字换行分割");Reflect.set(S.props,D,e(s));let A=i.createSectionContainerItem_textarea(S),I=dt("黑名单用户","userBlackList","","多个用户换行分割");Reflect.set(I.props,D,e(s));let P=i.createSectionContainerItem_textarea(I),E=dt("白名单用户","userWhiteList","","多个用户换行分割");Reflect.set(E.props,D,e(s));let R=i.createSectionContainerItem_textarea(E);return l.append(a,m,u,p,_,v,A,P,R),l},btn:{merge:true,position:"space-between",ok:{enable:false},cancel:{enable:true,text:"关闭"},other:{enable:true,text:`查看已过滤（${this.$el.isFilterElementHTML.length}）`,type:"primary",callback:(s,l)=>{console.log(this.$el.isFilterElementHTML),N.alert({title:{text:"评论过滤器-已过滤",position:"center"},content:{text:`
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return Y(this.$key.STORAGE_KEY,this.getTemplateData())},setData(t){G(this.$key.STORAGE_KEY,t);}},Ie={$key:{STORAGE_KEY:"mt-productListingReminder-rule"},init(){this.registerMenu(),this.runRule();},registerMenu(){j.registerLeftMenu({name:"商品上架提醒",icon:"",iconColor:"#2376b7",callback:()=>{this.showView();}});},async runRule(){async function t(){let n=await H.get("/keke_integralmall-keke_integralmall.html",{fetch:true,allowInterceptConfig:false});if(!n.status){y.error("【积分商城】获取数据失败");return}let s=[];return r.parseHTML(n.data.responseText,true,true).querySelectorAll(".task-list-wrapper li.col-xs-12").forEach(o=>{var a,c;s.push({name:r.text(o.querySelector(".mall-info a > *:first-child"))||r.text(o.querySelector(".mall-info a")),price:r.text(o.querySelector(".mall-info span.discount-price i")),endTime:r.text(o.querySelector(".mall-info #time_hz span.time")),remainingQuantity:parseInt(((c=(a=o.querySelector(".mall-info .mall-count .count-r"))==null?void 0:a.innerText)==null?void 0:c.replace(/仅剩|件/gi,""))||"0")});}),s}if(M.isPointsMall())return;let e=this.getData();if(!e.length)return;let i=await t();if(i){for(const n of i)for(const s of e)if(s.enable&&n.name.match(new RegExp(s.productName,"i"))&&!isNaN(n.remainingQuantity)&&n.remainingQuantity>0){b.success("成功匹配对应商品",s,n),N.confirm({title:{text:"积分商城提醒",position:"center"},content:{text:`<br />
                            您设置的商品已上架在积分商城中，当前售价 ${n.price}金币，仅剩${n.remainingQuantity}件，是否前往购买？
                            <a style="color: red !important;">(如需关闭提醒，请删除该关键字)</a>
                            <br />`,html:true},btn:{merge:true,position:"space-between",other:{enable:true,type:"danger",text:"删除提醒",callback:()=>{this.deleteData(s)?y.success("删除成功"):y.error("删除失败");}},ok:{text:"前往购买",callback:()=>{window.location.href=`${window.location.origin}/keke_integralmall-keke_integralmall.html`;}}},width:"300px",height:"300px"});return}}},getTemplateData(){return {uuid:g.generateUUID(),enable:true,name:"",productName:""}},showView(){let t=N.config.panelHandleContentUtils();function e(n){return {get(s,l){return n[s]??l},set(s,l){n[s]=l;}}}new qt({title:"商品上架提醒",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(o=>o.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,s)=>{n.enable=s,this.updateData(n);}},edit:{enable:true,getView:(n,s)=>{let l=document.createDocumentFragment();s||(n=this.getTemplateData());let o=L("启用","enable",true);Reflect.set(o.props,D,e(n));let a=t.createSectionContainerItem_switch(o),c=V("规则名称","name","","",void 0,"必填");Reflect.set(c.props,D,e(n));let m=t.createSectionContainerItem_input(c),d=V("商品名","productName","","",void 0,"可正则，需手动转义");Reflect.set(d.props,D,e(n));let u=t.createSectionContainerItem_input(d);return l.append(a,m,u),l},onsubmit:(n,s,l)=>{let o=n.querySelectorAll(".rule-form-ulist > li"),a=this.getTemplateData();return s&&(a.uuid=l.uuid),o.forEach(c=>{let m=Reflect.get(c,"__formConfig__"),d=Reflect.get(m,"attributes"),u=Reflect.get(c,D),f=Reflect.get(d,et),p=Reflect.get(d,it),h=u.get(f,p);Reflect.has(a,f)?Reflect.set(a,f,h):b.error(`${f}不在数据中`);}),a.name.trim()===""?(y.error("规则名称不能为空"),{success:false,data:a}):s?{success:this.updateData(a),data:a}:{success:this.addData(a),data:a}}},delete:{enable:true,deleteCallBack:n=>this.deleteData(n)}}}).showView();},getData(){return Y(this.$key.STORAGE_KEY,[])},setData(t){G(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(n=>n.uuid==t.uuid)===-1?(e.push(t),G(this.$key.STORAGE_KEY,e),true):false},updateData(t){let e=this.getData(),i=e.findIndex(s=>s.uuid==t.uuid),n=false;return i!==-1&&(n=true,e[i]=t),this.setData(e),n},deleteData(t){let e=this.getData(),i=e.findIndex(s=>s.uuid==t.uuid),n=false;return i!==-1&&(n=true,e.splice(i,1)),this.setData(e),n},clearData(){lt(this.$key.STORAGE_KEY);}},Me={$key:{STORAGE_KEY:"mt-customizeUserLabels-rule"},init(){if(this.registerMenu(),M.isPage()||M.isGuide()||M.isPlate()||M.isPost()||M.isSearch()||M.isSpace()){let t=this.getData();if(!t.length)return;let e=new g.LockFunction(()=>{this.runRule(t);});g.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{e.run();}});}},registerMenu(){j.registerLeftMenu({name:"自定义用户标签",icon:"",iconColor:"#c70ea6",callback:()=>{this.showView();}});},showView(){let t=N.config.panelHandleContentUtils();function e(n){return {get(s,l){return n[s]??l},set(s,l){n[s]=l;}}}new qt({title:"自定义用户标签",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(o=>o.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,s)=>{n.enable=s,this.updateData(n);}},edit:{enable:true,getView:(n,s)=>{var P;let l=document.createDocumentFragment();s||(n=this.getTemplateData());let o=L("启用","enable",true);Reflect.set(o.props,D,e(n));let a=t.createSectionContainerItem_switch(o),c=V("规则名称","name","","",void 0,"必填");Reflect.set(c.props,D,e(n));let m=t.createSectionContainerItem_input(c),d=V("用户UID","userUID","","",void 0,"必填，可正则，注意转义");Reflect.set(d.props,D,e(n));let u=t.createSectionContainerItem_input(d),f=V("标签名","labelName","","",void 0,"必填");Reflect.set(f.props,D,e(n));let p=t.createSectionContainerItem_input(f),h=V("标签颜色","labelColor","","");Reflect.set(h.props,D,e(n));let _=t.createSectionContainerItem_input(h),k=_.querySelector("input");(P=_.querySelector(".pops-panel-input__suffix"))==null||P.remove(),k.setAttribute("type","color"),r.css(k,{margin:"unset",padding:"unset",width:"80px"});let v=V("标签CSS","labelStyle","","");Reflect.set(v.props,D,e(n));let S=t.createSectionContainerItem_input(v),A=dt("标签点击事件","labelClickEvent","","");Reflect.set(A.props,D,e(n));let I=t.createSectionContainerItem_textarea(A);return l.append(a,m,u,p,_,S,I),l},onsubmit:(n,s,l)=>{let o=n.querySelectorAll(".rule-form-ulist > li"),a=this.getTemplateData();return s&&(a.uuid=l.uuid),o.forEach(c=>{let m=Reflect.get(c,"__formConfig__"),d=Reflect.get(m,"attributes"),u=Reflect.get(c,D),f=Reflect.get(d,et),p=Reflect.get(d,it),h=u.get(f,p);Reflect.has(a,f)?Reflect.set(a,f,h):b.error(`${f}不在数据中`);}),a.name.trim()===""?(y.error("规则名称不能为空"),{success:false,data:a}):a.userUID.trim()===""?(y.error("用户UID不能为空"),{success:false,data:a}):a.labelName.trim()===""?(y.error("标签名不能为空"),{success:false,data:a}):s?{success:this.updateData(a),data:a}:{success:this.addData(a),data:a}},style:`
                    .pops-panel-textarea textarea{
                        height: 150px;
                    }
                    ...
                    background: ${c.labelColor} !important;${c.labelStyle||""}`,o.innerHTML=c.labelName,r.on(o,"click",async m=>{g.preventEvent(m),g.isNotNull(c.labelClickEvent)&&x.eval(c.labelClickEvent);}),a.parentElement.append(o);});}});},getTemplateData(){return {uuid:g.generateUUID(),enable:true,name:"",userUID:"",labelName:"",labelColor:"",labelStyle:"",labelClickEvent:""}},getData(){return Y(this.$key.STORAGE_KEY,[])},setData(t){G(this.$key.STORAGE_KEY,t);},addData(t){let e=this.getData();return e.findIndex(n=>n.uuid==t.uuid)===-1?(e.push(t),G(this.$key.STORAGE_KEY,e),true):false},updateData(t){let e=this.getData(),i=e.findIndex(s=>s.uuid==t.uuid),n=false;return i!==-1&&(n=true,e[i]=t),this.setData(e),n},deleteData(t){let e=this.getData(),i=e.findIndex(s=>s.uuid==t.uuid),n=false;return i!==-1&&(n=true,e.splice(i,1)),this.setData(e),n},clearData(){lt(this.$key.STORAGE_KEY);}},Ee={init(){r.ready(()=>{$.execMenuOnce("mt-forum-post-publish-editorOptimization",()=>{ht.init();});});}},Ae={$flag:{showUserUID_initCSS:false},init(){(M.isPage()||M.isGuide()||M.isPlate()||M.isPost()||M.isSearch()||M.isSpace())&&$.execMenuOnce("mt-show-user-uid",()=>{this.showUserUID();}),(M.isSearch()||M.isGuide()||M.isSpace()||M.isPlate())&&$.execMenuOnce("mt-small-window",()=>{Ht.init();}),M.isPost()?(b.info("Router: 帖子"),Vt.init()):M.isSearch()?(b.info("Router: 搜索"),xe.init()):M.isKMiSign()?(b.info("Router: 签到"),we.init()):M.isSpace()||M.isSpaceWithAt()?(b.info("Router: 空间"),ve.init()):M.isGuide()?(b.info("Router: 导读"),ke.init()):M.isPostPublish()?(b.info("Router: 发帖页面"),Ee.init()):b.error("Router: 未适配的链接 ==> "+window.location.href),r.ready(()=>{$.execMenuOnce("mt-black-home",()=>{fe.init();}),$.execMenuOnce("mt-online-user",()=>{_e.init();}),$.execMenuOnce("mt-post-paidThemePost",()=>{mt.init();}),$.execMenuOnce("mt-ownBlock",()=>{Te.init();}),$.execMenuOnce("mt-post-comment-filter",()=>{Ce.init();}),$.execMenuOnce("mt-productListingReminder",()=>{Ie.init();}),$.execMenuOnce("mt-customizeUserLabels",()=>{Me.init();}),$.execMenuOnce("mt-link-text-to-hyperlink",()=>{ye();}),$.execMenu("mt-auto-sign",()=>{gt.init();}),$.execMenu("mt-extend-cookie-expire",()=>{this.extendCookieExpire();});});},showUserUID(){b.info("显示用户UID"),this.$flag.showUserUID_initCSS||(this.$flag.showUserUID_initCSS=true,W(`
			.postli_top_tximg + h2{
 				height: auto;
			}
			...
			`));let t=new g.LockFunction(()=>{let e=g.getNodeListValue(j.comiisForumList(),j.comiisPostli(),j.comiisMmlist());e.length&&e.forEach(i=>{if(i.querySelector(".gm-custom-label-uid"))return;let s=Array.from(i.querySelectorAll("a")).map(l=>{let a=l.href.match(X.uid);if(a)return a[a.length-1]}).filter(l=>l!=null);if(s.length){let l=s[0],o=document.createElement("a"),a=i.querySelector(".top_lev");o.className=a.className,o.classList.add("gm-custom-label-uid"),o.style.cssText="background: #FF7600 !important;",o.innerHTML="UID:"+l,r.on(o,"click",async c=>{g.preventEvent(c),await g.setClip(l)?y.success(`${l}已复制`):y.error(`${l}复制失败`);}),a.parentElement.append(o);}});});g.mutationObserver(document,{config:{subtree:true,childList:true},callback(){t.run();}});},async extendCookieExpire(){b.info("延长cookie有效期");let t=await $t.cookie.list({}),e=["_auth","_saltkey","_client_created","_client_token"];t.forEach(async i=>{if(i.session)return;let n=i.expirationDate,s=Date.now()/1e3;if(n<s)return;let l=60*60*24*30;n-s>l||!e.find(a=>i.name.endsWith(a))||$t.cookie.set({name:i.name,value:i.value,expirationDate:i.expirationDate+l}).then(()=>{b.info(`延长Cookie +30天成功：${i.name}`);}).catch(()=>{b.error(`延长Cookie +30天失败：${i.name}`);});});}};$.init();Ae.init();});Re();

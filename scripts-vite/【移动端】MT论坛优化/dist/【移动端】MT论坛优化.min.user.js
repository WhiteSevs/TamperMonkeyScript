...
// @require      https://fastly.jsdelivr.net/gh/highlightjs/cdn-release@11.10.0/build/highlight.min.js
    ...
    `},MTSmallWindow={$key:{smallWindow:"smallWindow"},$el:{$refreshIcon:null,$webSiteIcon:null},init(){let t=new utils.LockFunction(()=>{let e=this.getForumList();e.length&&this.handleForumPost(e);});utils.mutationObserver(document.documentElement,{callback:(e,i)=>{t.run();},config:{subtree:!0,childList:!0}});},getForumList(){return utils.getNodeListValue(ElementUtils.comiisForumList(),ElementUtils.comiisPostli(),ElementUtils.comiisMmlist())},showSmallWindow(t,e,i=[]){let s=new URL(e),n=s.protocol.includes("https:"),l=`
        ...
        <div class="small-window-title-container">
            ...
            `);var i="";utils.sortListByProperty(e,n=>{var l=n.href.match(/thread-(.+?)-/i);return parseInt(l[l.length-1])},!0),log.info("导读内容",e),e.forEach(n=>{i+=`
                <li>
                ...
                </li>`;});let s=document.querySelector(".comiis_forumlist.comiis_xznlist");DOMUtils.before(s,`<div class="comiis_mh_kxtxt bg_f comiis_mh_kxtxt_owm"><ul>${i}</ul></div>`);});}};class RuleEditView{constructor(e){R(this,"option");this.option=e;}showView(){var o;let e=__pops.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    ...
                    `,html:!0},btn:utils.assign({ok:{callback(){s.click();}}},this.option.btn||{},!0),mask:{enable:!0},style:`
            ...
            `,width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh"}),i=e.$shadowRoot.querySelector(".rule-form-container"),s=e.$shadowRoot.querySelector("input[type=submit]"),n=e.$shadowRoot.querySelector(".rule-form-ulist"),l=this.option.getView(this.option.data());n.appendChild(l),domUtils.on(i,"submit",a=>{utils.preventEvent(a),this.option.onsubmit(i,this.option.data()).success&&(e.close(),this.option.dialogCloseCallBack(!0));});}}class RuleView{constructor(e){R(this,"option");this.option=e;}showView(){var s,n,l,o,a,r,c,m,p;let e=__pops.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    <div class="rule-view-container">
                    </div>
                    `,html:!0},btn:{merge:!0,reverse:!1,position:"space-between",ok:{enable:((l=(n=(s=this.option)==null?void 0:s.bottomControls)==null?void 0:n.add)==null?void 0:l.enable)||!0,type:"primary",text:"添加",callback:g=>{this.showEditView(e.$shadowRoot,!1,this.option.getAddData());}},close:{enable:!0,callback(g){e.close();}},cancel:{enable:((r=(a=(o=this.option)==null?void 0:o.bottomControls)==null?void 0:a.filter)==null?void 0:r.enable)||!1,type:"default",text:"过滤",callback:(g,d)=>{var u,h,y;typeof((y=(h=(u=this.option)==null?void 0:u.bottomControls)==null?void 0:h.filter)==null?void 0:y.callback)=="function"&&this.option.bottomControls.filter.callback();}},other:{enable:((p=(m=(c=this.option)==null?void 0:c.bottomControls)==null?void 0:m.clear)==null?void 0:p.enable)||!0,type:"xiaomi-primary",text:`清空所有(${this.option.data().length})`,callback:g=>{let d=__pops.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:!1},btn:{ok:{enable:!0,callback:u=>{var h,y,_;if(log.success("清空所有"),typeof((_=(y=(h=this.option)==null?void 0:h.bottomControls)==null?void 0:y.clear)==null?void 0:_.callback)=="function"&&this.option.bottomControls.clear.callback(),this.option.data().length){Qmsg.error("清理失败");return}else Qmsg.success("清理成功");this.updateDeleteAllBtnText(e.$shadowRoot),this.clearContent(e.$shadowRoot),d.close();}},cancel:{text:"取消",enable:!0}},mask:{enable:!0},width:"300px",height:"200px"});}}},mask:{enable:!0},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${__pops.config.cssText.panelCSS}

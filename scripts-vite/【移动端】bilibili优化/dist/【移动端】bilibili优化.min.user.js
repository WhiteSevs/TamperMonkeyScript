...
`,se={getUserSpaceUrl(e){return `https://m.bilibili.com/space/${e}`},getUserSpaceDynamicUrl(e){return `https://m.bilibili.com/dynamic/${e}`},getUserSpaceOpusUrl(e){return `https://m.bilibili.com/opus/${e}`},getVideoUrl(e){return `https://m.bilibili.com/video/${e}`}},A={className:{bangumi:"#app.main-container",dynamic:"#app .m-dynamic",opus:"#app .m-opus",search:"#app .m-search","topic-detail":"#app .topic-detail",video:"#app .video",mVideo:"#app .m-video",head:"#app .m-head",playlist:"#app .playlist"},theme:"#FB7299"},et={className:{read:{mobile:"#app .read-app-main"}}},Ct=`.artplayer-container {\r
	position: absolute;\r
	width: 100%;\r
	height: 100%;\r
	top: 0;\r
...
`)}
			...
			`);let e=f.getValue("bili-video-artplayer-controlsPadding-left-right",0);e!=0&&R(`
				...
				@charset "UTF-8";
				${A.className.video} .video-list .card-box {
					--left-card-width: 33%;
					--right-child-padding: 1.333vmin;
					/* 开启了bili-video-beautify */
				}
				${A.className.video} .video-list .card-box .v-card-toapp {
					width: 100%;
					border-bottom: 1px solid #b5b5b5;
					padding-left: 0;
					padding-right: 0;
				}
				${A.className.video} .video-list .card-box .v-card-toapp > a {
					display: flex;
					flex-wrap: nowrap;
					gap: var(--right-child-padding);
				}
				${A.className.video} .video-list .card-box .v-card-toapp > a .card {
					width: var(--left-card-width);
					height: 80px;
					flex: 0 auto;
				}
				${A.className.video} .video-list .card-box .v-card-toapp > a .card .count {
					background: transparent;
				}
				${A.className.video} .video-list .card-box .v-card-toapp > a .card .count .left {
					display: list-item;
				}
				${A.className.video} .video-list .card-box .v-card-toapp > a .card .count .left span.item {
					display: none;
				}
				${A.className.video} .video-list .card-box .v-card-toapp > a .card .count .duration {
				...
				${A.className.video} .video-list .card-box .v-card-toapp > a .title {
					/*flex: 1;*/
				...
				${A.className.video} .video-list .card-box .gm-right-container {
					display: flex;
					flex-direction: column;
				...
				${A.className.video} .video-list .card-box .gm-right-container .left {
					gap: 1rem;
				}
				${A.className.video} .video-list .card-box .gm-right-container .left span {
					display: flex;
					align-items: safe center;
					gap: 1vmin;
				}
				${A.className.video} .video-list .card-box .gm-right-container .gm-up-name,
				${A.className.video} .video-list .card-box .gm-right-container .left {
					color: #999;
					font-size: 3vmin;
				...
				${A.className.video} .video-list .card-box .gm-right-container .gm-up-name svg {
					width: 3vmin;
					height: 3vmin;
				}
				${A.className.video} .video-list .card-box .gm-right-container .gm-up-name-text {
					margin-left: 1vmin;
				}
				${A.className.video} .video-list .card-box .gm-right-container .num {
					margin-right: 4vmin;
				}
				${A.className.video} .video-list .card-box > a.v-card {
					width: 100%;
					border-bottom: 1px solid #b5b5b5;
					padding-left: 0;
					padding-right: 0;
				...
				${A.className.video} .video-list .card-box > a.v-card .card {
					width: var(--left-card-width);
					height: 100%;
					flex: 0 auto;
				}
				${A.className.video} .video-list .card-box > a.v-card .card .count {
					background: transparent;
				}
				${A.className.video} .video-list .card-box > a.v-card .card .count span {
					display: none;
				}
				${A.className.video} .video-list .card-box > a.v-card .card .count .duration {
				...
				${A.className.video} .video-list .card-box > a.v-card .title {
					flex: 1;
					/*padding: var(--right-child-padding);*/
					padding-top: 0;
					margin-top: 0;
			...
			`)),p.waitNode(A.className.video+" .bottom-tab .list-view .card-box",1e4).then(e=>{if(!e){l.error("$cardBox is null");return}function t(r){var c,m;let n=r.querySelector(".title"),o=r.querySelector(".count .left"),s=!!r.querySelector(".gm-right-container"),d=F.getVue(r);if(n&&o&&d&&!s){let g=(m=(c=d==null?void 0:d.info)==null?void 0:c.owner)==null?void 0:m.name;if(g==null){l.error("美化显示-handleVCardToApp：获取up主名字失败");return}r.querySelector(".count");let v=n.cloneNode(!0),D=o.cloneNode(!0);h.hide(n);let w=r.querySelector(".open-app.weakened");w&&h.hide(w);let $=document.createElement("div");$.className="gm-up-name",$.innerHTML=`
						...
						`;let b=document.createElement("div"),E=document.createElement("div");b.className="gm-right-container",E.className="gm-right-bottom",h.after(n,b),b.appendChild(w),b.appendChild(E),E.appendChild(x),E.appendChild($);}}let i=new p.LockFunction(()=>{let r=document.querySelectorAll(A.className.video+" .bottom-tab .list-view .card-box .v-card-toapp"),n=document.querySelectorAll(A.className.video+" .bottom-tab .list-view .card-box>a.v-card");r.forEach(o=>{t(o);}),n.forEach(o=>{u(o);});},25),a=document.querySelector(A.className.video);a?p.mutationObserver(a,{config:{subtree:!0,attributes:!0,childList:!0},callback(){i.run();}}):l.error("未找到视频根节点");});},repairVideoBottomAreaHeight(){return l.info("修复视频底部区域高度"),R(`
		${A.className.video},
		${A.className.mVideo} {
			/* 修复视频区域底部的高度 */

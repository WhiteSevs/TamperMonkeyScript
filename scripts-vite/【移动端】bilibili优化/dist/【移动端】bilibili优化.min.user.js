...
`):s},callback(s,p){this.props[j].set(e,p);}};return Reflect.set(l.attributes,Dt,e),Reflect.set(l.attributes,kt,r),Reflect.set(l.props,j,{get(s,p){return f.getValue(s,p)},set(s,p){f.setValue(s,p);}}),l},Ot=function(t,e,r,n,i,a){let o=[];typeof n=="function"?o=n():o=n;let l={text:t,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[j].get(e,r)},callback(s,p,c){let m=p;u.info(`选择：${c}`),this.props[j].set(e,m),typeof i=="function"&&i(s,m,c);},data:o};return Reflect.set(l.attributes,Dt,e),Reflect.set(l.attributes,kt,r),Reflect.set(l.props,j,{get(s,p){return f.getValue(s,p)},set(s,p){f.setValue(s,p);}}),l},pt=function(t,e,r,n,i,a="",o,l){let s={text:t,type:"input",isNumber:!!o,isPassword:!!l,props:{},attributes:{},description:n,getValue(){return this.props[j].get(e,r)},callback(p,c){typeof i=="function"&&i(p,c)||this.props[j].set(e,c);},placeholder:a};return Reflect.set(s.attributes,Dt,e),Reflect.set(s.attributes,kt,r),Reflect.set(s.props,j,{get(p,c){return f.getValue(p,c)},set(p,c){f.setValue(p,c);}}),s},vt={ios:{appkey:"27eb53fc9058f8c3",appsec:"c2ed53a74eeefe3cf99fbd01d8c9c375",mobi_app:"ipnone"}};function pe(t,e,r){t.appkey=e;const n=new URLSearchParams(t);return n.sort(),Fe(n.toString()+r)}const dt={isWebApiSuccess(t){return (t==null?void 0:t.code)===0&&((t==null?void 0:t.message)==="0"||(t==null?void 0:t.message)==="success")},isAreaLimit(t){let e={6002003:"抱歉您所在地区不可观看！"},r=false;return Object.keys(e).forEach(n=>{let i=e[n];(t.code.toString()===n.toString()||t.message.includes(i))&&(r=true);}),r}},de={async getQrCodeInfo(){var o;let t="https://passport.bilibili.com/x/passport-tv-login/qrcode/auth_code",e={appkey:vt.ios.appkey,local_id:"0",ts:"0",mobi_app:vt.ios.mobi_app,csrf:((o=Se.get("bili_jct"))==null?void 0:o.value)||""},r=pe(e,vt.ios.appkey,vt.ios.appsec),n=await X.post(t,{data:d.toSearchParamsStr({...e,sign:r}),headers:{"Content-Type":"application/x-www-form-urlencoded"},responseType:"json",fetch:true});if(u.info(n),!n.status)return;let i=d.toJSON(n.data.responseText);if(i.code!==0){D.error(i.message);return}return i.data},async poll(t){let e="https://passport.bilibili.com/x/passport-tv-login/qrcode/poll",r={appkey:vt.ios.appkey,auth_code:t,local_id:"0",ts:"0"},n=pe(r,vt.ios.appkey,vt.ios.appsec),i=await X.post(e,{data:d.toSearchParamsStr({...r,sign:n}),headers:{"Content-Type":"application/x-www-form-urlencoded"},responseType:"json",fetch:true});if(!i.status)return {success:false,message:"网络错误",action:void 0};const a=d.toJSON(i.data.responseText);u.info(a);const o={0:"成功","-3":"API校验密匙错误","-400":"请求错误","-404":"啥都木有",86038:"二维码已失效",86039:"二维码尚未确认",86090:"二维码已扫码未确认"};if(!dt.isWebApiSuccess(a)){const p=a.code.toString(),c=a.message||o[p]||"未知错误";return p==="86038"?{success:false,message:c,action:"refresh"}:p==="86039"||p==="86090"?{success:false,message:c,action:"wait"}:{success:false,message:c,action:void 0}}const l=a.data.access_token,s=Date.now()+a.data.expires_in*1e3;return {success:true,message:"获取成功",accessKey:l,accessKeyExpireAt:s}}},Tt={async init(){D.info("正在申请二维码...");let t=await this.getQRCodeInfo();t&&this.confirmScanQrcode(t);},getQRCodeInfo:async function(){u.info("正在申请二维码...");let t=await de.getQrCodeInfo();return u.info("获取到二维码信息",t),t},async confirmScanQrcode(t){let e=Z.alert({title:{text:"请扫描二维码登录",position:"center",html:false,style:""},content:{text:'<div id="bili-qrcode-canvas"></div>',html:true},btn:{ok:{enable:false},close:{enable:true,callback(a){i=true,a.close();}}},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},only:true,width:"310px",height:"365px",drag:true,dragLimit:true,style:`
            ...
            `}),r=e.$shadowRoot.querySelector(".filter-container"),n=document.createDocumentFragment();this.option.filterOption.forEach(i=>{let a=document.createElement("button");a.innerText=i.name;let o=async()=>{(await this.option.getAllRuleInfo()).forEach(async s=>{await i.filterCallBack(s.data)?h.show(s.$el,false):h.hide(s.$el,false);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};h.on(a,"click",async l=>{d.preventEvent(l),!(typeof i.callback=="function"&&!await i.callback(l,o))&&await o();}),n.appendChild(a);}),r.appendChild(n);}}class yr{constructor(e){rt(this,"option");this.option=e;}async showView(e){var a,o,l,s,p,c,m,g,C;let r=Z.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    ...
                    `,html:true},btn:{merge:true,reverse:false,position:"space-between",ok:{enable:((l=(o=(a=this.option)==null?void 0:a.bottomControls)==null?void 0:o.add)==null?void 0:l.enable)||true,type:"primary",text:"添加",callback:async B=>{this.showEditView(false,await this.option.getAddData(),r.$shadowRoot);}},close:{enable:true,callback(B){r.close();}},cancel:{enable:((c=(p=(s=this.option)==null?void 0:s.bottomControls)==null?void 0:p.filter)==null?void 0:c.enable)||false,type:"default",text:"过滤",callback:(B,_)=>{var S,v,E,N,U,J,ot;typeof((E=(v=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:v.filter)==null?void 0:E.callback)=="function"&&this.option.bottomControls.filter.callback();let L=()=>Array.from(r.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),R=_.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");h.text(R).includes("取消")?(L().forEach(Q=>{h.show(Q,false);}),h.text(R,"过滤")):new vr({title:((U=(N=this.option.bottomControls)==null?void 0:N.filter)==null?void 0:U.title)??"过滤规则",filterOption:((ot=(J=this.option.bottomControls)==null?void 0:J.filter)==null?void 0:ot.option)||[],execFilterCallBack(){h.text(R,"取消过滤");},getAllRuleInfo:()=>L().map(I=>({data:this.parseRuleItemElement(I).data,$el:I}))}).showView();}},other:{enable:((C=(g=(m=this.option)==null?void 0:m.bottomControls)==null?void 0:g.clear)==null?void 0:C.enable)||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:B=>{let _=Z.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async L=>{var S,v,E;if(u.success("清空所有"),typeof((E=(v=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:v.clear)==null?void 0:E.callback)=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){D.error("清理失败");return}else D.success("清理成功");await this.updateDeleteAllBtnText(r.$shadowRoot),this.clearContent(r.$shadowRoot),_.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${Z.config.cssText.panelCSS}
...
`)}
			...
			`);let t=f.getValue("bili-video-artplayer-controlsPadding-left-right",0);t!=0&&P(`
				...
				`);}this.updateArtPlayerVideoInfo();},updateArtPlayerVideoInfo(t,e){let r=this,n=()=>K(x.className.video+" .m-video-player")||K(x.className.mVideo+" .m-video-player");T.waitVuePropToSet(n,{msg:"等待m-video-player加载完成",check(i){var a,o,l,s,p,c;return !e&&St.$data.currentOption!=null?(St.$data.art.pause(),typeof((a=i==null?void 0:i.info)==null?void 0:a.aid)=="number"&&St.$data.currentOption.aid!==i.info.aid&&typeof((o=i==null?void 0:i.info)==null?void 0:o.bvid)=="string"&&typeof((l=i==null?void 0:i.info)==null?void 0:l.cid)=="number"):typeof((s=i==null?void 0:i.info)==null?void 0:s.aid)=="number"&&typeof((p=i==null?void 0:i.info)==null?void 0:p.bvid)=="string"&&typeof((c=i==null?void 0:i.info)==null?void 0:c.cid)=="number"},async set(i){var L,R;const a=n();let{aid:o,bvid:l,cid:s,pic:p,title:c}=i;o=o||i.info.aid,l=l||i.info.bvid,s=s||i.info.cid,p=p||i.info.pic,c=c||i.info.title;let m=[];const g=K(".m-video-season-new"),C=K(".m-video-part-new");if(g&&T.getVue(g)){let S=T.getVue(g),v=S==null?void 0:S.videoList;Array.isArray(v)&&(m=v);}else if(C&&T.getVue(C)){let S=T.getVue(C),v=S==null?void 0:S.info,E=S==null?void 0:S.p,N=(S==null?void 0:S.pages)||((L=S==null?void 0:S.info)==null?void 0:L.pages);Array.isArray(N)&&m.push({season_id:0,section_id:0,id:0,aid:o||v.aid,bvid:l||v.bvid,cid:s||v.cid,title:c||v.title,attribute:0,arc:{aid:o||v.aid,videos:v==null?void 0:v.videos,type_id:0,type_name:"",copyright:v==null?void 0:v.copyright,pic:v==null?void 0:v.pic,title:v==null?void 0:v.title,pubdate:v==null?void 0:v.pubdate,ctime:v==null?void 0:v.ctime,desc:v==null?void 0:v.desc,state:v==null?void 0:v.state,duration:v==null?void 0:v.duration,rights:v==null?void 0:v.rights,author:v==null?void 0:v.owner,stat:v==null?void 0:v.stat,dynamic:v==null?void 0:v.dynamic,dimension:v==null?void 0:v.dimension,desc_v2:v==null?void 0:v.desc_v2,is_chargeable_season:v==null?void 0:v.is_chargeable_season,is_blooper:v==null?void 0:v.is_blooper,enable_vt:v==null?void 0:v.enable_vt,vt_display:v==null?void 0:v.vt_display},page:(R=v==null?void 0:v.pages)==null?void 0:R[E],pages:v==null?void 0:v.pages});}t==null&&(t={aid:o,bvid:l,cid:s,pic:p,title:c,epList:m}),u.info(`视频播放信息 => aid：${o} bvid：${l} cid：${s}`);const B=await Xe(t);if(B==null)return;let _=K("#artplayer");if(!_){const S=h.createElement("div",{className:"artplayer-container",innerHTML:`
								<div id="artplayer"></div>
							`});_=S.querySelector("#artplayer"),h.append(a,S);}if(B.container=_,r.$data.art==null){let S=await St.init(B);if(S)r.$data.art=S;else return;r.$data.art.volume=1,r.$data.art.once("ready",()=>{f.execMenu("bili-video-playerAutoPlayVideoFullScreen",async()=>{u.info("自动进入全屏"),r.$data.art.fullscreen=true,r.$data.art.once("fullscreenError",()=>{u.warn("未成功进入全屏，需要用户交互操作，使用网页全屏代替"),r.$data.art.fullscreenWeb=true;});});});}else await St.update(r.$data.art,B);a.style.paddingTop="";}});}},be=async t=>{async function e(r){const{img_url:n,sub_url:i}=await fetch("https://api.bilibili.com/x/web-interface/nav").then(g=>g.json()).then(g=>g.data.wbi_img),a=n.slice(n.lastIndexOf("/")+1,n.lastIndexOf(".")),o=i.slice(i.lastIndexOf("/")+1,i.lastIndexOf(".")),l=a+o,p=[46,47,18,2,53,8,23,32,15,50,10,31,58,3,45,35,27,43,5,49,33,9,42,19,29,28,14,39,12,38,41,13,37,48,7,16,24,55,40,61,26,17,0,1,60,51,30,4,22,25,54,21,56,59,6,63,57,62,11,36,20,34,44,52].map(g=>l[g]).join("").slice(0,32),c=Object.keys(r).sort().map(g=>{const C=r[g].toString().replace(/[!'()*]/g,"");return `${encodeURIComponent(g)}=${encodeURIComponent(C)}`}).join("&"),m=Fe(c+p);return c+"&w_rid="+m}return await e(t)};function Ir(t){const e=23442827791579n,r=2251799813685247n,n=58n,a=["B","V",1,"","","","","","","","",""].length,o="FcwAPNKTMug3GV5Lj7EJnHpWsx4tb8haYeviqBz6rkCy12mUSDQX9RdoZf".split(""),l=[0,1,2,9,7,5,6,4,8,3,10,11];let s=0n;for(let p=3;p<a;p++)s=s*n+BigInt(o.indexOf(t[l[p]]));return `${s&r^e}`}const Hr=function(){const t=typeof et>"u"?window:et,e=/https:\/\/m\.bilibili\.com\/video\/.*/,r=/https:\/\/m.bilibili.com\/dynamic\/\d+/,n=/https:\/\/m.bilibili.com\/opus\/\d+/;let i,a,o,l;const s={LATEST:0,HOT:2};let p,c,m;return r.test(t.location.href)&&I(),q(),{init:g};async function g(y){i=a=o=void 0,m={},p=s.HOT,C(y),l=y.querySelector(".reply-list"),await new Promise(A=>{const $=setInterval(async()=>{var k,F,M,H,G,gt,mt,W,bt,Ft;if(e.test(t.location.href)){const it=t.location.pathname.replace("/video/","").replace("/","");it.startsWith("av")&&(i=it.slice(2)),it.startsWith("BV")&&(i=Ir(it)),o=1;}else r.test(t.location.href)?(i=(k=t.dynamicDetail)==null?void 0:k.oid,o=(F=t.dynamicDetail)==null?void 0:F.commentType):n.test(t.location.href)&&(i=(gt=(G=(H=(M=t==null?void 0:t.__INITIAL_STATE__)==null?void 0:M.opus)==null?void 0:H.detail)==null?void 0:G.basic)==null?void 0:gt.comment_id_str,o=(Ft=(bt=(W=(mt=t==null?void 0:t.__INITIAL_STATE__)==null?void 0:mt.opus)==null?void 0:W.detail)==null?void 0:bt.basic)==null?void 0:Ft.comment_type);i&&o&&(clearInterval($),A());},200);}),await B(y),await _(y);}function C(y){y.innerHTML=`
      ...
      `;}async function B(y){const A=y.querySelector(".comment-container .reply-header .nav-sort"),$=A.querySelector(".hot-sort"),k=A.querySelector(".time-sort");A.classList.add("hot"),A.classList.remove("time"),$.addEventListener("click",F=>{F.stopPropagation(),F.preventDefault(),p!==s.HOT&&(p=s.HOT,A.classList.add("hot"),A.classList.remove("time"),y.scrollTo(0,0),_(y));}),k.addEventListener("click",F=>{F.stopPropagation(),F.preventDefault(),p!==s.LATEST&&(p=s.LATEST,A.classList.add("time"),A.classList.remove("hot"),y.scrollTo(0,0),_(y));});}async function _(y){var M,H,G,gt,mt;c={1:'{"offset":""}'};const{data:A,code:$}=await L(1);if(a=A.upper.mid,l.innerHTML="",m={},(M=document.querySelector(".comment-container .reply-warp .no-more-replies-info"))==null||M.remove(),(H=document.querySelector(".comment-container .reply-warp .anchor-for-loading"))==null||H.remove(),$!==0){const W=$===12061?"UP主已关闭评论区":"无法从API获取评论数据";l.innerHTML=`<p style="padding: 100px 0; text-align: center; color: #999;">${W}</p>`;return}const k=y.querySelector(".comment-container .reply-header .total-reply"),F=parseInt((G=A==null?void 0:A.cursor)==null?void 0:G.all_count)||0;if(k.textContent=F,(mt=(gt=A==null?void 0:A.cursor)==null?void 0:gt.name)!=null&&mt.includes("精选")){const W=y.querySelector(".comment-container .reply-header .nav-sort");W.innerHTML='<div class="selected-sort">精选评论</div>';}if(p===s.HOT&&(p=s.LATEST,A.top_replies=await L(1).then(W=>W.data.top_replies),p=s.HOT),A.top_replies&&A.top_replies.length!==0){const W=A.top_replies[0];R(W,true);}if(A.replies.length===0){const W=document.createElement("p");W.classList.add("no-more-replies-info"),W.style="padding-bottom: 100px; text-align: center; color: #999;",W.textContent="没有更多评论",document.querySelector(".comment-container .reply-warp").appendChild(W);return}for(const W of A.replies)R(W);Q();}async function L(y){var $;const A={oid:i,type:o,wts:parseInt(Date.now()/1e3)};if(p===s.HOT)return A.mode=3,A.pagination_str=`{"offset":"{\\"type\\":1,\\"data\\":{\\"pn\\":${y}}}"}`,await fetch(`https://api.bilibili.com/x/v2/reply/wbi/main?${await be(A)}`).then(k=>k.json());if(p===s.LATEST){A.mode=2,A.pagination_str=c[y];const k=await fetch(`https://api.bilibili.com/x/v2/reply/wbi/main?${await be(A)}`).then(F=>F.json());if(k.code===0){const F=k.data.cursor.pagination_reply.next_offset;try{F=JSON.parse(F);}catch(G){console.warn("MobileCommentModule next_offset serialize error",G);}const H=F?($=void 0)==null?void 0:$.cursor:-1;c[y+1]=`{"offset":"{\\"type\\":3,\\"data\\":{\\"cursor\\":${H}}}"}`;}else k.data=k.data||{};return k}}function R(y,A){if(m[y.rpid_str])return;const $=document.createElement("div");$.classList.add("reply-item"),$.innerHTML=`
          ...
          <div class="content-warp">
            ...
            <div class="root-reply">
              ...
              <div class="reply-info">
                <span class="reply-time" style="margin-right: 20px;">${S(y.ctime)}</span>
              ...
              <div class="reply-tag-list">
                ${y.card_label?y.card_label.reduce((H,G)=>H+`<span class="reply-tag-item ${G.text_content==="热评"?"reply-tag-hot":""} ${G.text_content==="UP主觉得很赞"?"reply-tag-liked":""}" style="font-size: 12px; background-color: ${G.label_color_day}; color: ${G.text_color_day};">${G.text_content}</span>`,""):""}
              </div>
            </div>
          </div>
        </div>
      ...
      `,l.appendChild($),m[y.rpid_str]=true;const k=$.querySelector(".preview-image-container");k&&new lr(k,{title:false,toolbar:false,tooltip:false,keyboard:false});const F=$.querySelector(".sub-reply-list"),M=$.querySelector(".view-more-btn");M&&M.addEventListener("click",()=>J(y.rpid,F,y.rcount,1));}function S(y){const A=new Date(y*1e3),$=A.getFullYear(),k=(A.getMonth()+1).toString().padStart(2,"0"),F=A.getDate().toString().padStart(2,"0"),M=A.getHours().toString().padStart(2,"0"),H=A.getMinutes().toString().padStart(2,"0");return `${$}-${k}-${F} ${M}:${H}`}function v(y){return {0:"#C0C0C0",1:"#BBBBBB",2:"#8BD29B",3:"#7BCDEF",4:"#FEBB8B",5:"#EE672A",6:"#F04C49"}[y]}function E(y){let A=y.message;const $=["https://www.bilibili.com/video/av","https://b23.tv/mall-"];if(y.vote&&y.vote.deleted===false){const k=`<a class="jump-link normal" href="${y.vote.url}" target="_blank" noopener noreferrer>${y.vote.title}</a>`;$.push(k),A=A.replace(`{vote:${y.vote.id}}`,k);}if(y.emote)for(const[k,F]of Object.entries(y.emote)){const M=`<img class="emoji-${["","small","large"][F.meta.size]}" src="${F.url}" alt="${k}">`;$.push(M),A=A.replaceAll(k,M);}if(A=A.replaceAll(/(\d{1,2}[:：]){1,2}\d{1,2}/g,k=>{if(k=k.replaceAll("：",":"),!e.test(t.location.href))return k;const F=k.split(":");if(F.some(G=>parseInt(G)>=60))return k;let M;if(F.length===2?M=parseInt(F[0])*60+parseInt(F[1]):F.length===3&&(M=parseInt(F[0])*3600+parseInt(F[1])*60+parseInt(F[2])),Number.isNaN(M))return k;const H=`<a class="jump-link video-time" onclick="(async () => {
          // jump to exact time
          const videoElement = document.querySelector('video.gsl-video');
          videoElement.currentTime = ${M};
        ...
        })()">${k}</a>`;return $.push(H),H}),y.at_name_to_mid)for(const[k,F]of Object.entries(y.at_name_to_mid)){const M=`<a class="jump-link user" data-user-id="${F}" href="https://space.bilibili.com/${F}" target="_blank" noopener noreferrer>@${k}</a>`;$.push(M),A=A.replaceAll(`@${k}`,M);}if(Object.keys(y.jump_url).length){const k=[].concat(Object.entries(y.jump_url).filter(F=>F[0].startsWith("https://")),Object.entries(y.jump_url).filter(F=>!F[0].startsWith("https://")));for(const[F,M]of k){const H=F.startsWith("BV")||/^av\d+$/.test(F)?`https://www.bilibili.com/video/${F}`:M.pc_url||F;if(H.includes("search.bilibili.com")&&$.join("").includes(F))continue;const G=`<img class="icon normal" src="${M.prefix_icon}" style="${M.extra&&M.extra.is_word_search&&"width: 12px;"}"><a class="jump-link normal" href="${H}" target="_blank" noopener noreferrer>${M.title}</a>`;$.push(G),A=A.replaceAll(F,G);}}return A}function N(y){let A="width: 84px; height: 84px;";y.length===1&&(A="max-width: 260px; max-height: 180px;"),y.length===2&&(A="width: 128px; height: 128px;");let $="";for(const k of y)$+=`<div class="image-item-wrap" style="margin-top: 4px; margin-right: 4px; cursor: zoom-in;"><img src="${k.img_src}" style="border-radius: 4px; ${A}"></div>`;return $}function U(y){if(!(y instanceof Array))return "";let A="";for(const $ of y)A+=`
          <div class="sub-reply-item">
            <div class="sub-user-info">
              <a class="sub-reply-avatar" href="https://space.bilibili.com/${$.mid}" target="_blank" data-user-id="${$.mid}" data-root-reply-id="${$.rpid}">
                <div class="avatar">
                  <div class="bili-avatar">
                    <img class="bili-avatar-img bili-avatar-face bili-avatar-img-radius" data-src="${$.member.avatar}" alt="" src="${$.member.avatar}">
                    <span class="bili-avatar-icon bili-avatar-right-icon  bili-avatar-size-24"></span>
                  </div>
                </div>
              </a>
              <a class="sub-user-name" href="https://space.bilibili.com/${$.mid}" target="_blank" data-user-id="${$.mid}" data-root-reply-id="${$.rpid}" style="color: ${$.member.vip.nickname_color?$.member.vip.nickname_color:"#61666d"}">${$.member.uname}</a>
              <span style="height: 14px; padding: 0 2px; margin-right: 4px; display: flex; align-items: center; font-size: 10px; color: white; border-radius: 2px; background-color: ${v($.member.level_info.current_level)};">LV${$.member.level_info.current_level}</span>
              ${a===$.mid?'<i class="svg-icon up-web up-icon" style="width: 20px; height: 24px; transform: scale(1.03);"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="0" y="4" width="24" height="16" rx="2" fill="#FF6699"></rect><path d="M5.7 8.36V12.79C5.7 13.72 5.96 14.43 6.49 14.93C6.99 15.4 7.72 15.64 8.67 15.64C9.61 15.64 10.34 15.4 10.86 14.92C11.38 14.43 11.64 13.72 11.64 12.79V8.36H10.47V12.81C10.47 13.43 10.32 13.88 10.04 14.18C9.75 14.47 9.29 14.62 8.67 14.62C8.04 14.62 7.58 14.47 7.3 14.18C7.01 13.88 6.87 13.43 6.87 12.81V8.36H5.7ZM13.0438 8.36V15.5H14.2138V12.76H15.9838C17.7238 12.76 18.5938 12.02 18.5938 10.55C18.5938 9.09 17.7238 8.36 16.0038 8.36H13.0438ZM14.2138 9.36H15.9138C16.4238 9.36 16.8038 9.45 17.0438 9.64C17.2838 9.82 17.4138 10.12 17.4138 10.55C17.4138 10.98 17.2938 11.29 17.0538 11.48C16.8138 11.66 16.4338 11.76 15.9138 11.76H14.2138V9.36Z" fill="white"></path></svg></i>':""}
            </div>
            <span class="reply-content-container sub-reply-content">
              <span class="reply-content">${E($.content)}</span>
            </span>
            <div class="sub-reply-info" style="margin: 4px 0;">
              <span class="sub-reply-time" style="margin-right: 20px;">${S($.ctime)}</span>
        ...
        `;return A}async function J(y,A,$,k){const F=await fetch(`https://api.bilibili.com/x/v2/reply/reply?oid=${i}&pn=${k}&ps=10&root=${y}&type=${o}`).then(H=>H.json()).then(H=>H.data);A.innerHTML=U(F.replies),ot(y,A,$,k),A.parentElement.parentElement.scrollIntoView({behavior:"instant"}),t.scrollTo(0,document.documentElement.scrollTop-60);}function ot(y,A,$,k){var H,G,gt;if($<=10)return;const F=Math.ceil($/10),M=document.createElement("div");M.classList.add("view-more"),M.innerHTML=`
        <div class="view-more-pagination">
          ...
          ${(()=>{const mt=[k-4,k-3,k-2,k-1].filter(lt=>lt>=1),W=[k+1,k+2,k+3,k+4].filter(lt=>lt<=F),bt=[].concat(mt,k,W);let Ft;k<=3?Ft=bt.slice(0,5):k>=F-3?Ft=bt.reverse().slice(0,5).reverse():Ft=bt.slice(bt.indexOf(k)-2,bt.indexOf(k)+3);let it=JSON.parse(JSON.stringify(Ft));if(!it.includes(1)){let lt=[1];it.at(0)!==2&&(lt=[1,"..."]),it=[].concat(lt,it);}if(!it.includes(F)){let lt=[F];it.at(-1)!==F-1&&(lt=["...",F]),it=[].concat(it,lt);}return it.reduce((lt,Ht)=>Ht==="..."?lt+'<span class="pagination-page-dot">...</span>':Ht===k?lt+`<span class="pagination-page-number current-page">${Ht}</span>`:lt+`<span class="pagination-page-number">${Ht}</span>`,"")})()}
          ${k!==F?'<span class="pagination-btn pagination-to-next-btn">下一页</span>':""}
        </div>
      `,(H=M.querySelector(".pagination-to-prev-btn"))==null||H.addEventListener("click",()=>J(y,A,$,k-1)),(G=M.querySelector(".pagination-to-next-btn"))==null||G.addEventListener("click",()=>J(y,A,$,k+1)),(gt=M.querySelectorAll(".pagination-page-number:not(.current-page)"))==null||gt.forEach(mt=>{const W=parseInt(mt.textContent);mt.addEventListener("click",()=>J(y,A,$,W));}),A.appendChild(M);}function Q(){const y=document.createElement("div");y.classList.add("anchor-for-loading"),y.textContent="正在加载...",y.style="text-align: center; color: #61666d; transform: translateY(-50px);",document.querySelector(".comment-container .reply-warp").appendChild(y);let A=1;const $=new IntersectionObserver(async k=>{if(!k[0].isIntersecting)return;const{data:F}=await L(++A);if(!F.replies||F.replies.length===0){y.textContent="所有评论已加载完毕",$.disconnect();return}for(const M of F.replies)R(M);});$.observe(y);}function I(){const y=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(){const A=arguments[1];if(typeof A=="string"&&A.includes("reply/wbi/main")){const{searchParams:$}=new URL(`${A.startsWith("//")?"https:":""}${A}`);t.dynamicDetail={oid:$.get("oid"),commentType:$.get("type")};}return y.apply(this,arguments)};}async function q(){await new Promise(M=>{const H=setInterval(()=>{document&&document.createElement&&document.head&&document.head.appendChild&&(clearInterval(H),M());},100);});const y=document.createElement("style");y.textContent=`
        .reply-header {
          padding: 12px;
      ...
      `,document.head.appendChild(A);const $=document.createElement("style");$.textContent=`
      ...
      `,document.head.appendChild($);const k=document.createElement("style");k.textContent=`
      ...
      `,(document.head||document.documentElement).appendChild(k);const F=document.createElement("style");F.textContent=`
        :root {
          --text1: #18191C;
          --text3: #9499A0;
          --brand_blue: #00AEEC;
      ...
      `,(document.head||document.documentElement).appendChild(F);}}(),jr=`:root {\r
	--v_xs: 5px;\r
	--v_xsx: 4px;\r
	--v_xxs: 6px;\r
	--v_sm: 10px;\r
...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof le=="function"?le(t.keyName):"";typeof e=="string"&&e?P(e):Bt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,h.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(r=>{e.onload=()=>{r(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()}},Ur={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"}};class qr{constructor(e){rt(this,"isBacking",false);rt(this,"config");this.config=e,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(e){d.preventEvent(e),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){u.success("进入手势模式");let e=this.config.hash;e.startsWith("#")||(e.startsWith("/")||(e="/"+e),e="#"+e),this.config.useUrl&&(e=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+e),this.config.win.history.pushState({},"",e),u.success("监听popstate事件"),h.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(e=false){u.success("退出手势模式"),this.isBacking=true,typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(e);let r=Date.now()+1e3*5;for(;;){if(Date.now()>r){u.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))u.info("history.back()"),this.config.win.history.back(),await d.sleep(this.config.backDelayTime||150);else break}u.success("移除popstate事件"),h.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(e);}}const Gr={$data:{isAddBeautifyCSS:false,isInitCommentModule:false,isInitDescModule:false},init(){ne.init(),f.execMenuOnce("bili-video-cover-bottomRecommendVideo",()=>{this.coverBottomRecommendVideo();}),f.execMenuOnce("bili-video-cover-UpWrapper",()=>{this.coverUpWrapper();}),f.execMenuOnce("bili-video-cover-seasonNew",()=>{this.coverSeasonNew();}),h.ready(()=>{f.execMenu("bili-video-addCommentModule",()=>{this.addCommentModule();}),f.execMenu("bili-video-addDescModule",()=>{this.addDescModule();});});},beautify(){u.info("美化显示"),this.$data.isAddBeautifyCSS||(this.$data.isAddBeautifyCSS=true,P(`
			...
			`)),d.waitNode(x.className.video+" .bottom-tab .list-view .card-box",1e4).then(t=>{if(!t){u.error("$cardBox is null");return}function e(a){var c,m;let o=a.querySelector(".title"),l=a.querySelector(".count .left"),s=!!a.querySelector(".gm-right-container"),p=T.getVue(a);if(o&&l&&p&&!s){let g=(m=(c=p==null?void 0:p.info)==null?void 0:c.owner)==null?void 0:m.name;if(g==null){u.error("美化显示-handleVCardToApp：获取up主名字失败");return}a.querySelector(".count");let C=o.cloneNode(true),B=l.cloneNode(true);h.hide(o);let _=a.querySelector(".open-app.weakened");_&&h.hide(_);let L=document.createElement("div");L.className="gm-up-name",L.innerHTML=`
						...
						`;let R=document.createElement("div"),S=document.createElement("div");R.className="gm-right-container",S.className="gm-right-bottom",h.after(o,R),R.appendChild(C),R.appendChild(S),S.appendChild(L),S.appendChild(B);}}function r(a){var c,m,g;let o=a.querySelector(".title"),l=a.querySelector(".count"),s=!!a.querySelector(".gm-right-container"),p=T.getVue(a);if(o&&l&&p&&!s){let C=(c=p==null?void 0:p.info)==null?void 0:c.duration;if(C==null){u.error("美化显示-handleVCard：获取视频时长失败");return}let B=(g=(m=p==null?void 0:p.info)==null?void 0:m.owner)==null?void 0:g.name;if(B==null){u.error("美化显示-handleVCard：获取up主名字失败");return}let _=o.cloneNode(true),L=l.cloneNode(true);h.hide(o);let R=document.createElement("div");R.className="duration",R.innerText=z.parseDuration(C),L.className="left";let S=document.createElement("div");l.appendChild(R),S.className="gm-up-name",S.innerHTML=`
						<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
							<path fill="#999A9E" d="M896 736v-448c0-54.4-41.6-96-96-96h-576C169.6 192 128 233.6 128 288v448c0 54.4 41.6 96 96 96h576c54.4 0 96-41.6 96-96zM800 128C889.6 128 960 198.4 960 288v448c0 89.6-70.4 160-160 160h-576C134.4 896 64 825.6 64 736v-448C64 198.4 134.4 128 224 128h576zM419.2 544V326.4h60.8v240c0 96-57.6 144-147.2 144S192 665.6 192 569.6V326.4h60.8v217.6c0 51.2 3.2 108.8 83.2 108.8s83.2-57.6 83.2-108.8z m288-38.4c28.8 0 60.8-16 60.8-60.8 0-48-28.8-60.8-60.8-60.8H614.4v121.6h92.8z m3.2-179.2c102.4 0 121.6 70.4 121.6 115.2 0 48-19.2 115.2-121.6 115.2H614.4V704h-60.8V326.4h156.8z">
							</path>
						</svg>
						<span class="gm-up-name-text">${B}</span>
						`;let v=document.createElement("div"),E=document.createElement("div");v.className="gm-right-container",E.className="gm-right-bottom",h.after(o,v),v.appendChild(_),v.appendChild(E),E.appendChild(S),E.appendChild(L);}}let n=new d.LockFunction(()=>{let a=document.querySelectorAll(x.className.video+" .bottom-tab .list-view .card-box .v-card-toapp"),o=document.querySelectorAll(x.className.video+" .bottom-tab .list-view .card-box>a.v-card");a.forEach(l=>{e(l);}),o.forEach(l=>{r(l);});},25),i=document.querySelector(x.className.video);i?d.mutationObserver(i,{config:{subtree:true,attributes:true,childList:true},callback(){n.run();}}):u.error("未找到视频根节点");});},repairVideoBottomAreaHeight(){return u.info("修复视频底部区域高度"),P(`
		${x.className.video},
		${x.className.mVideo} {
			/* 修复视频区域底部的高度 */
...
`,rr={$flag_css:{enableOtherAreaSearchBangumi:false},init(){P(en),h.ready(()=>{f.execMenu("bili-search-enableOtherAreaSearchBangumi",()=>{this.enableOtherAreaSearchBangumi();});});},enableOtherAreaSearchBangumi(){this.$flag_css.enableOtherAreaSearchBangumi||(this.$flag_css.enableOtherAreaSearchBangumi=true,P(`
			...
			`)),d.waitNode(".m-search-result .tabs:not(:has(.gm-tab-item))").then(t=>{te.getSearchProxyHost().forEach(n=>{let i=h.createElement("a",{className:"tab-item gm-tab-item",innerHTML:`番剧（${n.name}）`},{"data-area":n.area,"data-host":n.host});t.appendChild(i);});const r=n=>{t.querySelectorAll(".tab-item").forEach(i=>n!=i&&i.classList.remove("on")),n.classList.add("on");};h.on(t,"click",".tab-item",async n=>{let i=n.target;r(i);let a=document.querySelector(".result-panel"),o=document.querySelector(".gm-result-panel");if(o&&(o.remove(),h.show(a)),!i.classList.contains("gm-tab-item"))return;let l=i.dataset.area,s=i.dataset.host,p=document.querySelector(".m-search-result"),c=T.getVue(p);c.switchTab(233),h.hide(a);let m=c.keyword,g=D.loading("搜索中，请稍后..."),C=await er.getBangumiSearchResult({keyword:m,area:l,host:s});if(g.close(),!C)return;if(!C.isSuccess){alert(JSON.stringify(C.data,null,2));return}let B=C.data;u.info("搜索结果：",B);let _=h.createElement("div",{className:"gm-result-panel",innerHTML:`
					...
					`}),L=_.querySelector(".gm-card-box");B.forEach(R=>{L.appendChild(this.createSearchResultVideoItem(R));}),p.appendChild(_);});});},createSearchResultVideoItem(t){var s,p;let e=h.createElement("div",{className:"gm-card-item",innerHTML:`
...
`)}
			...
			`)),f.onceExec("listenRouterChange",()=>{this.listenRouterChange();}),f.execMenuOnce("bili-hookSetTimeout_autoOpenApp",()=>{u.info("hook  window.setTimeout autoOpenApp"),Nt.setTimeout("autoOpenApp"),Nt.setTimeout("bilibili://"),Nt.setTimeout("void 0 !== y && document[y]");}),f.execMenuOnce("bili-overrideLaunchAppBtn_Vue_openApp",()=>{u.info("覆盖元素.launch-app-btn上的openApp"),Nt.overRideLaunchAppBtn_Vue_openApp();}),f.execMenuOnce("bili-cover-bili-open-app-open",()=>{u.info("覆盖元素bili-open-app上的opener.open"),Nt.overRideBiliOpenApp();}),f.execMenuOnce("bili-cover-wx-tag-handleClick",()=>{u.info("覆盖元素.wx-tag的handleClick函数"),Nt.overRideWxTaghandleClick();}),f.execMenuOnce("bili-head-beautify",()=>(u.info("添加美化CSS"),P($r))),f.execMenuOnce("bili-componentDetection",()=>{xn.init();}),Y.isVideo()?(u.info("Router: 视频稿件"),Gr.init()):Y.isOpus()?(u.info("Router: 专栏稿件"),un.init()):Cr.isReadMobile()?(u.info("PC-Router: 专栏稿件"),bn.init()):Y.isDynamic()?(u.info("Router: 动态"),sn.init()):Y.isBangumi()?(u.info("Router: 番剧"),tn.init()):Y.isSearch()?(u.info("Router: 搜索"),an.init()):Y.isLive()?(u.info("Router: 直播"),ln.init()):Y.isTopicDetail()?u.info("Router: 话题"):Y.isHead()?(u.info("Router: 首页之类的"),gn.init()):Y.isSpace()?(u.info("Router: 个人空间"),vn.init()):Y.isPlayList()?(u.info("Router: 播放列表"),wn.init()):u.error("该Router暂未适配，可能是首页之类："+window.location.href),h.ready(()=>{});},listenRouterChange(){T.waitVuePropToSet("#app",{msg:"监听路由变化",check:t=>{var e;return typeof((e=t==null?void 0:t.$router)==null?void 0:e.afterEach)=="function"},set:t=>{u.success("成功设置监听路由变化"),t.$router.beforeHooks.splice(0,0,(e,r,n)=>{if(u.info("路由变化 => 更新前",{to:e,from:r}),e.hash==="#/seeCommentReply"||r.hash==="#/seeCommentReply"){u.info("该路由变化判定为#/seeCommentReply"),n();return}if(f.getValue("bili-repairVueRouter404")&&e.name==="space"){u.info("修复空间跳转404"),window.location.href=e.fullPath;return}if(e.fullPath.startsWith("/video")){if(r.fullPath.startsWith("/video")&&f.getValue("bili-video-forceThisPageToRefreshAndRedirect")){u.info("强制本页刷新"),window.location.href=e.fullPath;return}else if(Y.isHead()&&f.getValue("bili-head-openVideoInNewTab")){u.info("当前是首页，新标签页打开"),window.open(e.fullPath,"_blank");return}}else if(e.fullPath.startsWith("/bangumi")){if(r.fullPath.startsWith("/bangumi")){u.info("番剧 => 番剧"),window.location.href=e.fullPath;return}else if(Y.isHead()&&f.getValue("bili-head-openVideoInNewTab")){u.info("首页 => 番剧"),window.open(e.fullPath,"_blank");return}}n();}),t.$router.afterHooks.splice(0,0,(e,r)=>{if(u.info("路由变化 => 更新后",{to:e,from:r}),e.hash==="#/seeCommentReply"||r.hash==="#/seeCommentReply"){u.info("该路由变化判定为#/seeCommentReply，不重载");return}f.execMenu("bili-listenRouterChange",()=>{nr.init();});});}});}};f.init();nr.init();Z.config.cssText.index+=`
/* bilibili颜色 #FB7299 */
.pops{
    --bili-color: #FB7299;

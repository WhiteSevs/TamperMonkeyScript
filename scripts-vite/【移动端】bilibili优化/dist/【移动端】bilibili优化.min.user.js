...
`,Ge={$data:{isInitPlayer:!1,isUnlockUpower:!1},init(){c.execMenu("bili-video-initPlayer",()=>{this.initPlayer();}),c.execMenu("bili-video-setVideoPlayer",()=>{this.setVideoPlayer();}),c.execMenu("bili-video-unlockUpower",()=>{this.unlockUpower();});},initPlayer(){if(this.$data.isInitPlayer)return;this.$data.isInitPlayer=!0;let e=this;s.waitNode("#bilibiliPlayer",3e3).then(async t=>{if(!t){e.$data.isInitPlayer=!1;return}await s.sleep(300),B.waitVuePropToSet("."+"m-video-player",[{msg:"等待设置参数 fullScreenCallApp",check(i){return typeof(i==null?void 0:i.fullScreenCallApp)=="boolean"},set(i){i.fullScreenCallApp=!1,o.success("成功设置参数 fullScreenCallApp=false");}},{msg:"等待设置参数 gameMode",check(i){return typeof(i==null?void 0:i.gameMode)=="boolean"},set(i){i.gameMode=!0,o.success("成功设置参数 gameMode=true");}},{msg:"等待获取函数 initPlayer()",check(i){return typeof(i==null?void 0:i.initPlayer)=="function"},set(i){e.$data.isInitPlayer=!1;function r(){let a,n,l=1,p=!1,d=new s.LockFunction(async()=>{var A,v,D,L;let C=document.querySelector("#bilibiliPlayer video"),f=document.querySelector("#bilibiliPlayer img.mplayer-poster");if(C&&f&&f.src!==""){p=!0,(A=y.player)==null||A.off("restart_call_app"),(v=y.player)==null||v.off("force_call_app_show"),o.success("<video>标签和视频封面图已成功初始化"),await s.sleep(1e3),c.execMenu(["bili-coverQuality","bili-rememberUserChooseQuality"],()=>{ae.coverQuality(!0);}),y.init();return}$.BPlayerMobile==null&&(o.error("未加载player播放器，主动引入script标签"),await k.loadScript("https://s1.hdslb.com/bfs/static/player/main/html5/mplayer.js?v=2876316"),await s.sleep(300));try{i.initPlayer(!0);}catch(R){o.error(R);try{o.info("强制重载player播放器失败，使用普通调用"),i.initPlayer();}catch(M){o.error(M);}}o.success("第 "+l+" 次未检测到视频，调用初始化视频函数 initPlayer()"),await s.sleep(300),(D=y.player)==null||D.off("restart_call_app"),(L=y.player)==null||L.off("force_call_app_show"),l++;});a=setInterval(async()=>{await d.run(),p&&(clearTimeout(n),clearInterval(a));},600),n=setTimeout(()=>{o.warn("检测视频超时5s，取消检测"),clearInterval(a);},5e3);}r();}}]);});},unlockUpower(){B.waitVuePropToSet(F.className.video,[{msg:"设置属性 __vue__.info.is_upower_exclusive",check(e){var t;return typeof((t=e==null?void 0:e.info)==null?void 0:t.is_upower_exclusive)=="boolean"},set(e){e.info.is_upower_exclusive=!1,o.success("成功设置属性  __vue__.info.is_upower_exclusive=false");}},{msg:"设置属性 __vue__.info.is_upower_play",check(e){var t;return typeof((t=e==null?void 0:e.info)==null?void 0:t.is_upower_play)=="boolean"},set(e){e.info.is_upower_play=!1,o.success("成功设置属性  __vue__.info.is_upower_play=false");}},{msg:"设置属性 __vue__.info.is_upower_preview",check(e){var t;return typeof((t=e==null?void 0:e.info)==null?void 0:t.is_upower_preview)=="boolean"},set(e){e.info.is_upower_preview=!1,Ge.initPlayer(),o.success("成功设置属性  __vue__.info.is_upower_preview=false");}}]);},setVideoPlayer(){B.waitVuePropToSet(F.className.video+" .m-video-player",[{msg:"设置参数 playBtnNoOpenApp",check(e){return typeof e.playBtnNoOpenApp=="boolean"},set(e){e.playBtnNoOpenApp=!0,o.success("成功设置参数 playBtnNoOpenApp=true");}},{msg:"设置参数 playBtnOpenApp",check(e){return typeof e.playBtnOpenApp=="boolean"},set(e){e.playBtnOpenApp=!1,o.success("成功设置参数 playBtnOpenApp=false");}},{msg:"设置参数 coverOpenApp",check(e){return typeof e.coverOpenApp=="boolean"},set(e){e.coverOpenApp=!1,o.success("成功设置参数 coverOpenApp=false");}}]);}},Je={$data:{isAddBeautifyCSS:!1},init(){At.init(),Ge.init(),c.execMenuOnce("bili-video-repairVideoBottomAreaHeight",()=>this.repairVideoBottomAreaHeight()),c.execMenuOnce("bili-video-autoClickContinueToWatchOnTheWebpage",()=>{this.autoClickContinueToWatchOnTheWebpage();}),c.execMenu("bili-video-beautify",()=>{this.beautify();}),c.execMenuOnce("bili-video-cover-bottomRecommendVideo",()=>{this.coverBottomRecommendVideo();}),c.execMenuOnce("bili-video-gestureReturnToCloseCommentArea",()=>{this.gestureReturnToCloseCommentArea();}),c.execMenuOnce("bili-video-cover-seasonNew",()=>{this.coverSeasonNew();}),m.ready(()=>{c.execMenuOnce("bili-video-optimizationScroll",()=>{this.optimizationScroll();}),c.execMenu("bili-video-disableSwipeTab",()=>{this.disableSwipeTab();});});},beautify(){o.info("美化显示"),this.$data.isAddBeautifyCSS||(this.$data.isAddBeautifyCSS=!0,V(gt)),s.waitNode(F.className.video+" .bottom-tab .list-view .card-box",1e4).then(e=>{if(!e){o.error("$cardBox is null");return}function t(a){var C,f;let n=a.querySelector(".title"),l=a.querySelector(".count .left"),p=!!a.querySelector(".gm-right-container"),d=B.getVue(a);if(n&&l&&d&&!p){let A=(f=(C=d==null?void 0:d.info)==null?void 0:C.owner)==null?void 0:f.name;if(A==null){o.error("美化显示-handleVCardToApp：获取up主名字失败");return}let v=a.querySelector(".count"),D=n.cloneNode(!0),L=l.cloneNode(!0);m.hide(n),v&&m.hide(v);let R=a.querySelector(".open-app.weakened");R&&m.hide(R);let M=document.createElement("div");M.className="gm-up-name",M.innerHTML=`
						...
						`;let E=document.createElement("div"),_=document.createElement("div");E.className="gm-right-container",_.className="gm-right-bottom",m.after(n,E),E.appendChild(D),E.appendChild(_),_.appendChild(M),_.appendChild(L);}}function u(a){var C,f,A;let n=a.querySelector(".title"),l=a.querySelector(".count"),p=!!a.querySelector(".gm-right-container"),d=B.getVue(a);if(n&&l&&d&&!p){let v=(C=d==null?void 0:d.info)==null?void 0:C.duration;if(v==null){o.error("美化显示-handleVCard：获取视频时长失败");return}let D=(A=(f=d==null?void 0:d.info)==null?void 0:f.owner)==null?void 0:A.name;if(D==null){o.error("美化显示-handleVCard：获取up主名字失败");return}let L=n.cloneNode(!0),R=l.cloneNode(!0);m.hide(n);let M=document.createElement("div");M.className="duration",M.innerText=k.parseDuration(v),R.className="left";let E=document.createElement("div");l.appendChild(M),E.className="gm-up-name",E.innerHTML=`
						<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
							<path fill="#999A9E" d="M896 736v-448c0-54.4-41.6-96-96-96h-576C169.6 192 128 233.6 128 288v448c0 54.4 41.6 96 96 96h576c54.4 0 96-41.6 96-96zM800 128C889.6 128 960 198.4 960 288v448c0 89.6-70.4 160-160 160h-576C134.4 896 64 825.6 64 736v-448C64 198.4 134.4 128 224 128h576zM419.2 544V326.4h60.8v240c0 96-57.6 144-147.2 144S192 665.6 192 569.6V326.4h60.8v217.6c0 51.2 3.2 108.8 83.2 108.8s83.2-57.6 83.2-108.8z m288-38.4c28.8 0 60.8-16 60.8-60.8 0-48-28.8-60.8-60.8-60.8H614.4v121.6h92.8z m3.2-179.2c102.4 0 121.6 70.4 121.6 115.2 0 48-19.2 115.2-121.6 115.2H614.4V704h-60.8V326.4h156.8z">
							</path>
						</svg>
						<span class="gm-up-name-text">${D}</span>
						`;let _=document.createElement("div"),x=document.createElement("div");_.className="gm-right-container",x.className="gm-right-bottom",m.after(n,_),_.appendChild(L),_.appendChild(x),x.appendChild(E),x.appendChild(R);}}let i=new s.LockFunction(()=>{let a=document.querySelectorAll(F.className.video+" .bottom-tab .list-view .card-box .v-card-toapp"),n=document.querySelectorAll(F.className.video+" .bottom-tab .list-view .card-box>a.v-card");a.forEach(l=>{t(l);}),n.forEach(l=>{u(l);});},25),r=document.querySelector(F.className.video);r?s.mutationObserver(r,{config:{subtree:!0,attributes:!0,childList:!0},callback(){i.run();}}):o.error("未找到视频根节点");});},repairVideoBottomAreaHeight(){return o.info("修复视频底部区域高度"),V(`
		${F.className.video} {
			/* 修复视频区域底部的高度 */

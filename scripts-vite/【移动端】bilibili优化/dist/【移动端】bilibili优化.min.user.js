...
`,be={$data:{isInitPlayer:!1,isUnlockUpower:!1},init(){p.execMenu("bili-video-initPlayer",()=>{this.initPlayer();}),p.execMenu("bili-video-setVideoPlayer",()=>{this.setVideoPlayer();}),p.execMenu("bili-video-unlockUpower",()=>{this.unlockUpower();});},initPlayer(){if(this.$data.isInitPlayer)return;this.$data.isInitPlayer=!0;let e=this;s.waitNode("#bilibiliPlayer",3e3).then(async t=>{if(!t){e.$data.isInitPlayer=!1;return}await s.sleep(300),v.waitVuePropToSet("."+"m-video-player",[{msg:"等待设置参数 fullScreenCallApp",check(r){return typeof(r==null?void 0:r.fullScreenCallApp)=="boolean"},set(r){r.fullScreenCallApp=!1,o.success("成功设置参数 fullScreenCallApp=false");}},{msg:"等待设置参数 gameMode",check(r){return typeof(r==null?void 0:r.gameMode)=="boolean"},set(r){r.gameMode=!0,o.success("成功设置参数 gameMode=true");}},{msg:"等待获取函数 initPlayer()",check(r){return typeof(r==null?void 0:r.initPlayer)=="function"},set(r){e.$data.isInitPlayer=!1;function a(){let n,l,c=1,d=!1,u=new s.LockFunction(async()=>{var b,_,E,D;let m=document.querySelector("#bilibiliPlayer video"),y=document.querySelector("#bilibiliPlayer img.mplayer-poster");if(m&&y&&y.src!==""){d=!0,(b=g.player)==null||b.off("restart_call_app"),(_=g.player)==null||_.off("force_call_app_show"),o.success("<video>标签和视频封面图已成功初始化"),await s.sleep(1e3),p.execMenu(["bili-coverQuality","bili-rememberUserChooseQuality"],()=>{H.coverQuality(!0);}),g.init();return}k.BPlayerMobile==null&&(o.error("未加载player播放器，主动引入script标签"),await v.loadScript("https://s1.hdslb.com/bfs/static/player/main/html5/mplayer.js?v=2876316"),await s.sleep(300));try{r.initPlayer(!0);}catch(L){o.error(L);try{o.info("强制重载player播放器失败，使用普通调用"),r.initPlayer();}catch(M){o.error(M);}}o.success("第 "+c+" 次未检测到视频，调用初始化视频函数 initPlayer()"),await s.sleep(300),(E=g.player)==null||E.off("restart_call_app"),(D=g.player)==null||D.off("force_call_app_show"),c++;});n=setInterval(async()=>{await u.run(),d&&(clearTimeout(l),clearInterval(n));},600),l=setTimeout(()=>{o.warn("检测视频超时5s，取消检测"),clearInterval(n);},5e3);}a();}}]);});},unlockUpower(){v.waitVuePropToSet(C.className.video,[{msg:"设置属性 __vue__.info.is_upower_exclusive",check(e){var t;return typeof((t=e==null?void 0:e.info)==null?void 0:t.is_upower_exclusive)=="boolean"},set(e){e.info.is_upower_exclusive=!1,o.success("成功设置属性  __vue__.info.is_upower_exclusive=false");}},{msg:"设置属性 __vue__.info.is_upower_play",check(e){var t;return typeof((t=e==null?void 0:e.info)==null?void 0:t.is_upower_play)=="boolean"},set(e){e.info.is_upower_play=!1,o.success("成功设置属性  __vue__.info.is_upower_play=false");}},{msg:"设置属性 __vue__.info.is_upower_preview",check(e){var t;return typeof((t=e==null?void 0:e.info)==null?void 0:t.is_upower_preview)=="boolean"},set(e){e.info.is_upower_preview=!1,be.initPlayer(),o.success("成功设置属性  __vue__.info.is_upower_preview=false");}}]);},setVideoPlayer(){v.waitVuePropToSet(C.className.video+" .m-video-player",[{msg:"设置参数 playBtnNoOpenApp",check(e){return typeof e.playBtnNoOpenApp=="boolean"},set(e){e.playBtnNoOpenApp=!0,o.success("成功设置参数 playBtnNoOpenApp=true");}},{msg:"设置参数 playBtnOpenApp",check(e){return typeof e.playBtnOpenApp=="boolean"},set(e){e.playBtnOpenApp=!1,o.success("成功设置参数 playBtnOpenApp=false");}},{msg:"设置参数 coverOpenApp",check(e){return typeof e.coverOpenApp=="boolean"},set(e){e.coverOpenApp=!1,o.success("成功设置参数 coverOpenApp=false");}}]);}},Ge={$data:{isAddBeautifyCSS:!1},init(){Qe.init(),be.init(),p.execMenuOnce("bili-video-repairVideoBottomAreaHeight",()=>this.repairVideoBottomAreaHeight()),p.execMenuOnce("bili-video-autoClickContinueToWatchOnTheWebpage",()=>{this.autoClickContinueToWatchOnTheWebpage();}),p.execMenu("bili-video-beautify",()=>{this.beautify();}),p.execMenuOnce("bili-video-cover-bottomRecommendVideo",()=>{this.coverBottomRecommendVideo();}),p.execMenuOnce("bili-video-gestureReturnToCloseCommentArea",()=>{this.gestureReturnToCloseCommentArea();}),p.execMenuOnce("bili-video-cover-seasonNew",()=>{this.coverSeasonNew();});},beautify(){o.info("美化显示"),this.$data.isAddBeautifyCSS||(this.$data.isAddBeautifyCSS=!0,S(Je)),s.waitNode(C.className.video+" .bottom-tab .list-view .card-box",1e4).then(e=>{if(!e){o.error("$cardBox is null");return}function t(n){var m,y;let l=n.querySelector(".title"),c=n.querySelector(".count .left"),d=!!n.querySelector(".gm-right-container"),u=v.getVue(n);if(l&&c&&u&&!d){let b=(y=(m=u==null?void 0:u.info)==null?void 0:m.owner)==null?void 0:y.name;if(b==null){o.error("美化显示-handleVCardToApp：获取up主名字失败");return}let _=n.querySelector(".count"),E=l.cloneNode(!0),D=c.cloneNode(!0);f.hide(l),_&&f.hide(_);let L=n.querySelector(".open-app.weakened");L&&f.hide(L);let M=document.createElement("div");M.className="gm-up-name",M.innerHTML=`
						...
						`;let P=document.createElement("div"),V=document.createElement("div");P.className="gm-right-container",V.className="gm-right-bottom",f.after(l,P),P.appendChild(E),P.appendChild(V),V.appendChild(M),V.appendChild(D);}}function i(n){var m,y,b;let l=n.querySelector(".title"),c=n.querySelector(".count"),d=!!n.querySelector(".gm-right-container"),u=v.getVue(n);if(l&&c&&u&&!d){let _=(m=u==null?void 0:u.info)==null?void 0:m.duration;if(_==null){o.error("美化显示-handleVCard：获取视频时长失败");return}let E=(b=(y=u==null?void 0:u.info)==null?void 0:y.owner)==null?void 0:b.name;if(E==null){o.error("美化显示-handleVCard：获取up主名字失败");return}let D=l.cloneNode(!0),L=c.cloneNode(!0);f.hide(l);let M=document.createElement("div");M.className="duration",M.innerText=v.parseDuration(_),L.className="left";let P=document.createElement("div");c.appendChild(M),P.className="gm-up-name",P.innerHTML=`

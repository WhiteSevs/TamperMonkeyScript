...
`):s},callback(s,p){this.props[j].set(e,p);}};return Reflect.set(l.attributes,Dt,e),Reflect.set(l.attributes,kt,r),Reflect.set(l.props,j,{get(s,p){return f.getValue(s,p)},set(s,p){f.setValue(s,p);}}),l},Ot=function(t,e,r,n,i,a){let o=[];typeof n=="function"?o=n():o=n;let l={text:t,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[j].get(e,r)},callback(s,p,c){let m=p;u.info(`选择：${c}`),this.props[j].set(e,m),typeof i=="function"&&i(s,m,c);},data:o};return Reflect.set(l.attributes,Dt,e),Reflect.set(l.attributes,kt,r),Reflect.set(l.props,j,{get(s,p){return f.getValue(s,p)},set(s,p){f.setValue(s,p);}}),l},pt=function(t,e,r,n,i,a="",o,l){let s={text:t,type:"input",isNumber:!!o,isPassword:!!l,props:{},attributes:{},description:n,getValue(){return this.props[j].get(e,r)},callback(p,c){typeof i=="function"&&i(p,c)||this.props[j].set(e,c);},placeholder:a};return Reflect.set(s.attributes,Dt,e),Reflect.set(s.attributes,kt,r),Reflect.set(s.props,j,{get(p,c){return f.getValue(p,c)},set(p,c){f.setValue(p,c);}}),s},vt={ios:{appkey:"27eb53fc9058f8c3",appsec:"c2ed53a74eeefe3cf99fbd01d8c9c375",mobi_app:"ipnone"}};function pe(t,e,r){t.appkey=e;const n=new URLSearchParams(t);return n.sort(),Fe(n.toString()+r)}const dt={isWebApiSuccess(t){return (t==null?void 0:t.code)===0&&((t==null?void 0:t.message)==="0"||(t==null?void 0:t.message)==="success")},isAreaLimit(t){let e={6002003:"抱歉您所在地区不可观看！"},r=false;return Object.keys(e).forEach(n=>{let i=e[n];(t.code.toString()===n.toString()||t.message.includes(i))&&(r=true);}),r}},de={async getQrCodeInfo(){var o;let t="https://passport.bilibili.com/x/passport-tv-login/qrcode/auth_code",e={appkey:vt.ios.appkey,local_id:"0",ts:"0",mobi_app:vt.ios.mobi_app,csrf:((o=Se.get("bili_jct"))==null?void 0:o.value)||""},r=pe(e,vt.ios.appkey,vt.ios.appsec),n=await et.post(t,{data:d.toSearchParamsStr({...e,sign:r}),headers:{"Content-Type":"application/x-www-form-urlencoded"},responseType:"json",fetch:true});if(u.info(n),!n.status)return;let i=d.toJSON(n.data.responseText);if(i.code!==0){k.error(i.message);return}return i.data},async poll(t){let e="https://passport.bilibili.com/x/passport-tv-login/qrcode/poll",r={appkey:vt.ios.appkey,auth_code:t,local_id:"0",ts:"0"},n=pe(r,vt.ios.appkey,vt.ios.appsec),i=await et.post(e,{data:d.toSearchParamsStr({...r,sign:n}),headers:{"Content-Type":"application/x-www-form-urlencoded"},responseType:"json",fetch:true});if(!i.status)return {success:false,message:"网络错误",action:void 0};const a=d.toJSON(i.data.responseText);u.info(a);const o={0:"成功","-3":"API校验密匙错误","-400":"请求错误","-404":"啥都木有",86038:"二维码已失效",86039:"二维码尚未确认",86090:"二维码已扫码未确认"};if(!dt.isWebApiSuccess(a)){const p=a.code.toString(),c=a.message||o[p]||"未知错误";return p==="86038"?{success:false,message:c,action:"refresh"}:p==="86039"||p==="86090"?{success:false,message:c,action:"wait"}:{success:false,message:c,action:void 0}}const l=a.data.access_token,s=Date.now()+a.data.expires_in*1e3;return {success:true,message:"获取成功",accessKey:l,accessKeyExpireAt:s}}},Tt={async init(){k.info("正在申请二维码...");let t=await this.getQRCodeInfo();t&&this.confirmScanQrcode(t);},getQRCodeInfo:async function(){u.info("正在申请二维码...");let t=await de.getQrCodeInfo();return u.info("获取到二维码信息",t),t},async confirmScanQrcode(t){let e=Z.alert({title:{text:"请扫描二维码登录",position:"center",html:false,style:""},content:{text:'<div id="bili-qrcode-canvas"></div>',html:true},btn:{ok:{enable:false},close:{enable:true,callback(a){i=true,a.close();}}},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},only:true,width:"310px",height:"365px",drag:true,dragLimit:true,style:`
            ...
            `}),n=await this.option.data(),i=false;for(let B=0;B<n.length;B++){let _=n[B],L=await this.appendRuleItemElement(r.$shadowRoot,_);(typeof e=="function"?e(_):true)||(i=true,L.forEach(S=>{h.hide(S,false);}));}if(i){let B=r.$shadowRoot.querySelector(".pops-confirm-btn-cancel span");h.text(B,"取消过滤");}}showEditView(e,r,n,i,a,o){let l=async p=>{if(p){if(typeof o=="function"){let c=await this.option.getData(r);o(c);}}else if(e||await this.option.deleteData(r),typeof a=="function"){let c=await this.option.getData(r);a(c);}};new br({title:e?"编辑":"添加",data:()=>r,dialogCloseCallBack:l,getView:async p=>await this.option.itemControls.edit.getView(p,e),btn:{ok:{enable:true,text:e?"修改":"添加"},cancel:{callback:async(p,c)=>{p.close(),await l(false);}},close:{callback:async(p,c)=>{p.close(),await l(false);}}},onsubmit:async(p,c)=>{let m=await this.option.itemControls.edit.onsubmit(p,e,c);return m.success?e?(k.success("修改成功"),n&&await this.updateRuleItemElement(m.data,i,n)):n&&await this.appendRuleItemElement(n,m.data):e&&u.error("修改失败"),m},style:this.option.itemControls.edit.style,width:this.option.itemControls.edit.width,height:this.option.itemControls.edit.height}).showView();}parseViewElement(e){let r=e.querySelector(".rule-view-container"),n=e.querySelector(".pops-confirm-btn button.pops-confirm-btn-other");return {$container:r,$deleteBtn:n}}parseRuleItemElement(e){let r=e.querySelector(".rule-controls-enable"),n=r.querySelector(".pops-panel-switch"),i=r.querySelector(".pops-panel-switch__input"),a=r.querySelector(".pops-panel-switch__core"),o=e.querySelector(".rule-controls-edit"),l=e.querySelector(".rule-controls-delete");return {$enable:r,$enableSwitch:n,$enableSwitchInput:i,$enableSwitchCore:a,$edit:o,$delete:l,data:Reflect.get(e,"data-rule")}}async createRuleItemElement(e,r){let n=await this.option.getDataItemName(e),i=h.createElement("div",{className:"rule-item",innerHTML:`
...
`).map(y=>Number(y)).filter(y=>!isNaN(y)):q},set(Q,I){typeof I=="string"&&(I=I.split(`
`).map(q=>Number(q)).filter(q=>!isNaN(q))),n.data[Q]=I;}});let ot=t.createSectionContainerItem_textarea(J);return a.append(s,c,g,B,L,S,E,U,ot),a},onsubmit:(n,i,a)=>{let o=n.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();i&&(l.uuid=a.uuid);try{return o.forEach(s=>{let p=Reflect.get(s,"__formConfig__"),c=Reflect.get(p,"attributes"),m=Reflect.get(s,j),g=Reflect.get(c,Dt),C=Reflect.get(c,kt),B=m.get(g,C);Reflect.has(l,g)?Reflect.set(l,g,B):Reflect.has(l.data,g)?Reflect.set(l.data,g,B):u.error(`${g}不在数据中`);}),l.name.trim()===""?(k.error("规则名称不能为空"),{success:!1,data:l}):i?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}}catch(s){return u.error(s),{success:false,data:l}}finally{this.init();}},style:`
...
`)}
      ...
      `,l.appendChild($),m[y.rpid_str]=true;const D=$.querySelector(".preview-image-container");D&&new lr(D,{title:false,toolbar:false,tooltip:false,keyboard:false});const F=$.querySelector(".sub-reply-list"),M=$.querySelector(".view-more-btn");M&&M.addEventListener("click",()=>J(y.rpid,F,y.rcount,1));}function S(y){const A=new Date(y*1e3),$=A.getFullYear(),D=(A.getMonth()+1).toString().padStart(2,"0"),F=A.getDate().toString().padStart(2,"0"),M=A.getHours().toString().padStart(2,"0"),H=A.getMinutes().toString().padStart(2,"0");return `${$}-${D}-${F} ${M}:${H}`}function v(y){return {0:"#C0C0C0",1:"#BBBBBB",2:"#8BD29B",3:"#7BCDEF",4:"#FEBB8B",5:"#EE672A",6:"#F04C49"}[y]}function E(y){let A=y.message;const $=["https://www.bilibili.com/video/av","https://b23.tv/mall-"];if(y.vote&&y.vote.deleted===false){const D=`<a class="jump-link normal" href="${y.vote.url}" target="_blank" noopener noreferrer>${y.vote.title}</a>`;$.push(D),A=A.replace(`{vote:${y.vote.id}}`,D);}if(y.emote)for(const[D,F]of Object.entries(y.emote)){const M=`<img class="emoji-${["","small","large"][F.meta.size]}" src="${F.url}" alt="${D}">`;$.push(M),A=A.replaceAll(D,M);}if(A=A.replaceAll(/(\d{1,2}[:：]){1,2}\d{1,2}/g,D=>{if(D=D.replaceAll("：",":"),!e.test(t.location.href))return D;const F=D.split(":");if(F.some(G=>parseInt(G)>=60))return D;let M;if(F.length===2?M=parseInt(F[0])*60+parseInt(F[1]):F.length===3&&(M=parseInt(F[0])*3600+parseInt(F[1])*60+parseInt(F[2])),Number.isNaN(M))return D;const H=`<a class="jump-link video-time" onclick="(async () => {
          // jump to exact time
        ...
        })()">${D}</a>`;return $.push(H),H}),y.at_name_to_mid)for(const[D,F]of Object.entries(y.at_name_to_mid)){const M=`<a class="jump-link user" data-user-id="${F}" href="https://space.bilibili.com/${F}" target="_blank" noopener noreferrer>@${D}</a>`;$.push(M),A=A.replaceAll(`@${D}`,M);}if(Object.keys(y.jump_url).length){const D=[].concat(Object.entries(y.jump_url).filter(F=>F[0].startsWith("https://")),Object.entries(y.jump_url).filter(F=>!F[0].startsWith("https://")));for(const[F,M]of D){const H=F.startsWith("BV")||/^av\d+$/.test(F)?`https://www.bilibili.com/video/${F}`:M.pc_url||F;if(H.includes("search.bilibili.com")&&$.join("").includes(F))continue;const G=`<img class="icon normal" src="${M.prefix_icon}" style="${M.extra&&M.extra.is_word_search&&"width: 12px;"}"><a class="jump-link normal" href="${H}" target="_blank" noopener noreferrer>${M.title}</a>`;$.push(G),A=A.replaceAll(F,G);}}return A}function N(y){let A="width: 84px; height: 84px;";y.length===1&&(A="max-width: 260px; max-height: 180px;"),y.length===2&&(A="width: 128px; height: 128px;");let $="";for(const D of y)$+=`<div class="image-item-wrap" style="margin-top: 4px; margin-right: 4px; cursor: zoom-in;"><img src="${D.img_src}" style="border-radius: 4px; ${A}"></div>`;return $}function U(y){if(!(y instanceof Array))return "";let A="";for(const $ of y)A+=`
        ...
        `;return A}async function J(y,A,$,D){const F=await fetch(`https://api.bilibili.com/x/v2/reply/reply?oid=${i}&pn=${D}&ps=10&root=${y}&type=${o}`).then(H=>H.json()).then(H=>H.data);A.innerHTML=U(F.replies),ot(y,A,$,D),A.parentElement.parentElement.scrollIntoView({behavior:"instant"}),t.scrollTo(0,document.documentElement.scrollTop-60);}function ot(y,A,$,D){var H,G,gt;if($<=10)return;const F=Math.ceil($/10),M=document.createElement("div");M.classList.add("view-more"),M.innerHTML=`
      ...
      `,document.head.appendChild($);const D=document.createElement("style");D.textContent=`
      ...
      `,(document.head||document.documentElement).appendChild(D);const F=document.createElement("style");F.textContent=`
        :root {
          --text1: #18191C;
          --text3: #9499A0;
          --brand_blue: #00AEEC;
		...
		`;let e=false,r=null,n=document.querySelector(".gm-face"),i=n.querySelector("img");T.waitVuePropToSet("#app",[{check(a){var o,l,s,p;return typeof((p=(s=(l=(o=a==null?void 0:a.$store)==null?void 0:o.state)==null?void 0:l.common)==null?void 0:s.userInfo)==null?void 0:p.isLogin)=="boolean"},set(a){var l,s,p;let o=(p=(s=(l=a==null?void 0:a.$store)==null?void 0:l.state)==null?void 0:s.common)==null?void 0:p.userInfo;if(e=o==null?void 0:o.isLogin,e){if(r=o==null?void 0:o.mid,r==null){u.warn("当前是脚本设置的isLogin但其实未登录账号"),e=false;return}o==null||o.uname,i.src=(o==null?void 0:o.face)||i.src;}else u.warn("经检测，Bilibili尚未登录账号");}}]),h.on(n,"click",a=>{if(d.preventEvent(a),e)if(r!=null){let o=Et.getUserSpaceUrl(r);z.goToUrl(o,false);}else k.error("获取用户id失败");else z.goToLogin(window.location.href);});},beautifyTopNavBar(){u.info("美化顶部navbar"),this.$flag.isInit_beautifyTopNavBar_css||(this.$flag.isInit_beautifyTopNavBar_css=true,P(`
			...
			${me.className.read.mobile} .limit{
				...
				max-height: unset !important;
						...
						`);});}}]);}},De={async space(t,e=""){let r=await et.get("https://api.bilibili.com/x/polymer/web-dynamic/v1/feed/space",{data:{host_mid:t,offset:e},fetch:true});if(!r.status)return;let n=d.toJSON(r.data.responseText);if(dt.isWebApiSuccess(n))return n.data},async following(t,e=1,r=50){let n=await et.get("https://api.bilibili.com/x/relation/followings",{data:{vmid:t,ps:r,pn:e},fetch:true});if(!n.status)return;let i=d.toJSON(n.data.responseText);return dt.isWebApiSuccess(i)?i.data:i.message}},xn={$data:{searchIcon:`

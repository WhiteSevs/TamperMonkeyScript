...
`,ot={30216:`64K`,30232:`132K`,30280:`192K`,30250:`杜比全景声`,30251:`Hi-Res无损`},st=class{$data={KEY:`art-player-danmaku-option`,localArtDanmakuOption:{}};constructor(e){this.$data.KEY=e;let t=this.getDefaultDanmakuOption();this.$data.localArtDanmakuOption=O.assign(t,se(this.$data.KEY,{}))}getDefaultDanmakuOption(){return{speed:5,margin:[10,`75%`],opacity:1,modes:[0,1,2],fontSize:18,antiOverlap:!1,synchronousPlayback:!0,visible:!0}}getLocalArtDanmakuOption(){return this.$data.localArtDanmakuOption}onConfigChange(e){e.on(`artplayerPluginDanmuku:config`,e=>{Object.keys(this.$data.localArtDanmakuOption).forEach(t=>{if(Reflect.has(e,t)){let n=Reflect.get(e,t);Reflect.set(this.$data.localArtDanmakuOption,t,n)}}),fe(this.$data.KEY,this.$data.localArtDanmakuOption)})}},ct=`[artplayer-plugin-m4sAudioSupport]：`,lt=`setting-bilibili-m4sAudio`,H={$flag:{isIntervaling:!1},intervalHandler(e,t=2,n=900){if(H.$flag.isIntervaling)return;H.$flag.isIntervaling=!0;let r=0,i,a=()=>{if(r>t){H.$flag.isIntervaling=!1,clearInterval(i);return}if(typeof e==`function`)try{e()}catch(e){console.error(ct,e)}r++};a(),t>1?i=setInterval(a,n):H.$flag.isIntervaling=!1}},U={$key:{plugin_KEY:`plugin-bilibili-m4sAudio`},$data:{art:null,audio:new Audio,latestSyncTime:0,reconnectConfig:{maxCount:5,delayTime:1e3},reconnectInfo:{url:``,count:0},option:null},userEvent:{onRestart:void 0},events:{play:()=>{U.handler.play(),U.handler.syncVolume(),U.handler.syncMuted(),H.intervalHandler(()=>{U.handler.syncTime()},1)},seek:e=>{H.intervalHandler(()=>{U.handler.syncTime(),U.handler.syncPlayState()})},pause:()=>{H.intervalHandler(()=>{U.handler.syncTime()},1),U.handler.pause()},restart:e=>{if(typeof U.userEvent.onRestart==`function`){let t=U.userEvent.onRestart(e);U.handler.playUrl(t)}H.intervalHandler(()=>{U.handler.syncTime()},1),U.handler.syncPlayState()},muted:e=>{U.handler.syncVolume(),U.handler.syncMuted()},destroy:()=>{U.handler.pause()},error:(e,t)=>{U.handler.pause()},resize:()=>{H.intervalHandler(()=>{U.handler.syncTime()})},fullscreen:()=>{H.intervalHandler(()=>{U.handler.syncTime()})},"video:ended":()=>{U.handler.pause()},"video:ratechange":()=>{U.handler.syncPlayBackRate()},"video:waiting":()=>{U.handler.pause()},"video:playing":()=>{H.intervalHandler(()=>{U.handler.syncTime()},1),U.handler.play()},"video:pause":()=>{U.handler.pause(),H.intervalHandler(()=>{U.handler.syncTime()},1)},"video:volumechange":()=>{U.handler.syncVolume(),U.handler.syncMuted(),U.handler.syncPlayState()},"video:timeupdate":()=>{let e=U.$data.art.currentTime;Math.abs(e-U.$data.latestSyncTime)>=3&&(U.$data.latestSyncTime=e,H.intervalHandler(()=>{U.handler.syncTime(.777)},1))}},audioEvents:{loadedmetadata:e=>{U.$data.art.emit(`m4sAudio:loadedmetadata`,e),console.log(`[artplayer-plugin-m4sAudioSupport]：Audio预加载完成`),U.$data.reconnectInfo.count=0,U.$data.reconnectInfo.url=``,U.$data.latestSyncTime=0,U.handler.syncPlayState(),U.handler.syncPlayBackRate(),U.handler.syncVolume(),U.handler.syncMuted(),H.intervalHandler(()=>{U.handler.syncTime()})},canplaythrough:e=>{U.$data.art.emit(`m4sAudio:canplaythrough`,e),console.log(`[artplayer-plugin-m4sAudioSupport]：浏览器估计该音频可以在不停止内容缓冲的情况下播放媒体直到结束`),H.intervalHandler(()=>{U.handler.syncTime()})},error:e=>{U.$data.art.emit(`m4sAudio:error`,e),console.error(`[artplayer-plugin-m4sAudioSupport]：Audio加载失败`,e),O.isNull(U.$data.reconnectInfo.url)&&(U.$data.reconnectInfo.url=U.$data.audio.src),U.$data.reconnectInfo.count<U.$data.reconnectConfig.maxCount?(console.log(`[artplayer-plugin-m4sAudioSupport]：Audio第${U.$data.reconnectInfo.count+1}次尝试重新连接`),U.$data.art.notice.show=`Audio第${U.$data.reconnectInfo.count+1}次尝试重新连接`,U.$data.reconnectInfo.count++,setTimeout(()=>{U.handler.playUrl(``),U.handler.playUrl(U.$data.reconnectInfo.url),U.$data.audio.load()},U.$data.reconnectConfig.delayTime)):(console.error(`[artplayer-plugin-m4sAudioSupport]：Audio已超出重连次数`),U.$data.art.notice.show=`Audio已超出重连次数，请尝试切换源`)}},handler:{playUrl(e){typeof e==`string`&&(U.$data.audio.src=e,U.unbindAudio(),O.isNotNull(e)&&U.bindAudio(),U.$data.art.emit(`m4sAudio:restart`,e),U.handler.syncTime(),U.handler.syncPlayState())},play(){U.$data.audio.paused&&(U.$data.audio.play(),U.$data.art.emit(`m4sAudio:play`))},pause(){U.$data.audio.paused||(U.$data.audio.pause(),U.$data.art.emit(`m4sAudio:pause`))},syncPlayState(){U.$data.art.playing?this.play():this.pause(),U.$data.art.emit(`m4sAudio:syncPlayState`)},syncTime(e=.1){let t=U.$data.art.currentTime,n=U.$data.audio.currentTime;Math.abs(t-n)>=Math.abs(e)&&(U.$data.audio.currentTime=t,this.syncVolume(),this.syncMuted(),U.$data.art.emit(`m4sAudio:syncTime`))},syncVolume(){U.$data.audio.volume=U.$data.art.volume,U.$data.art.emit(`m4sAudio:syncVolume`)},syncMuted(){let e=U.$data.art.muted;U.$data.audio.muted=e,U.$data.art.emit(`m4sAudio:syncMuted`)},syncPlayBackRate(){let e=U.$data.art.playbackRate;e!==U.$data.audio.playbackRate&&(U.$data.audio.playbackRate=e,U.$data.art.emit(`m4sAudio:syncPlayBackRate`))}},update(e){this.unbind(),this.unbindAudio(),this.$data.option=null,this.$data.option=e.audioList,this.$data.latestSyncTime=0;let t=this;if(e.audioList?.length){e.audioList.sort((e,t)=>t.bandwidth-e.bandwidth);let n=e.audioList[0],r=`artplayer-m4s-audio-${e.from}`,i=this.$data.art.storage.get(r),a={index:0,html:n.soundQualityCodeText,url:n.url};if(i){let t=e.audioList.findIndex(e=>e.soundQualityCode===i.soundQualityCode);if(t!==-1){let n=e.audioList[t];a.index=t,a.url=n.url,a.html=n.soundQualityCodeText}else console.warn(`[artplayer-plugin-m4sAudioSupport]：没有找到上次选的音频代码，使用当前默认第一个音频`)}let o=e.audioList.map((e,t)=>({default:t===a.index,html:e.soundQualityCodeText,url:e.url,soundQualityCode:e.soundQualityCode,soundQualityCodeText:e.soundQualityCodeText,codecs:e.codecs,mimeType:e.mimeType,bandwidth:e.bandwidth,size:e.size})),s={name:lt,width:200,html:`音频`,tooltip:a.html,icon:`
            ...
            `,mounted:async function(t){G.$el.$topWrap=t,G.$el.$topTitle=t.querySelector(`.art-player-top-title`),G.$el.$topTitleText=t.querySelector(`.art-player-top-title-text`),G.$el.$topTitleFollow=t.querySelector(`.art-player-top-follow`),G.$el.$topTitleFollowText=t.querySelector(`.art-player-top-follow-text`),G.$el.$topRight=t.querySelector(`.art-player-top-right`),G.$el.$topRightFollow=t.querySelector(`.art-player-top-right-follow`),W.hide(G.$el.$topTitleFollow),G.update(e),ft.bind()}})},update(e){this.$data.isInit||(this.$data.isInit=!0,Object.defineProperties(this.$data.option,{showWrap:{set(e){G.$data.__option.showWrap=e,e?W.show(G.$el.$topWrap):W.hide(G.$el.$topWrap)},get(){return G.$data.__option.showWrap}},showTitle:{set(e){G.$data.__option.showTitle=e,e?W.show(G.$el.$topTitle):W.hide(G.$el.$topTitle)},get(){return G.$data.__option.showTitle}},title:{set(e){G.$data.__option.title=e,typeof e==`string`&&(G.$el.$topTitleText.innerText=e)},get(){return G.$data.__option.title}},showOnlineTotal:{set(e){G.$data.__option.showOnlineTotal=e,e?W.show(G.$el.$topTitleFollow):W.hide(G.$el.$topTitleFollow)},get(){return G.$data.__option.showOnlineTotal}},onlineInfoParams:{set(e){G.$data.__option.onlineInfoParams=e,G.updateOnlineTotal({showOnlineTotal:this.showOnlineTotal,onlineInfoParams:e})},get(){return G.$data.__option.onlineInfoParams}},showRight:{set(e){G.$data.__option.showRight=e,e?W.show(G.$el.$topRight):W.hide(G.$el.$topRight)},get(){return G.$data.__option.showRight}},showRightFollow:{set(e){G.$data.__option.showRightFollow=e,e?W.show(G.$el.$topRightFollow):W.hide(G.$el.$topRightFollow)},get(){return G.$data.__option.showRightFollow}}})),Object.assign(this.$data.option,e)},async updateOnlineTotal(e){if(!e.showOnlineTotal)return;let t=await it.onlineTotal({aid:e.onlineInfoParams.aid,bvid:e.onlineInfoParams.bvid,cid:e.onlineInfoParams.cid});t&&(G.$el.$topTitleFollowText.innerText=`${t.total||t.count||0}人正在看`)}},pt=e=>t=>(G.art=t,G.init(e),{name:G.$key.plugin_KEY,update(e){G.update(e)}}),mt=G.$key.plugin_KEY,ht={S:`万与丑专业丛东丝丢两严丧个丬丰临为丽举么义乌乐乔习乡书买乱争于亏云亘亚产亩亲亵亸亿仅从仑仓仪们价众优伙会伛伞伟传伤伥伦伧伪伫体余佣佥侠侣侥侦侧侨
�鍔鍤鍬鍾鍛鎪鍠鍰鎄鍍鎂鏤鎡鏌鎮鎛鎘鑷鐫鎳鎿鎦鎬鎊鎰鎔鏢鏜鏍鏰鏞鏡鏑鏃鏇鏐鐔钁鐐鏷鑥鐓鑭鐠鑹鏹鐙鑊鐳鐶鐲鐮鐿鑔鑣鑞鑲長門閂閃閆閈閉問闖閏闈閒閎間閔閌悶閘鬧閨聞闥閩閭闓閥閣閡閫鬮閱閬闍閾閹閶鬩閿閽閻閼闡闌闃闠闊闋闔闐闒闕闞闤隊陽陰陣階際陸隴陳陘陝隉隕險隨隱隸雋難雛讎靂霧霽黴靄靚靜靨韃鞽韉鞴韋韌韍韓韙韞韜韻頁頂頃頇項順須頊頑顧頓頎頒頌頏預顱領頗頸頡頰頲頜潁熲頦頤頻頮頹頷頴穎顆題顒顎顓顏額顳顢顛顙顥纇顫顬顰顴風颺颭颮颯颶颸颼颻飀飄飆飈飛饗饜飣飢飥餳飩餼飪飫飭飯飲餞飾飽飼飿飴餌饒餉餄餎餃餏餅餑餖餓餘餒餕餜餛餡館餷饋餶餿饞饁饃餺餾饈饉饅饊饌饢馬馭馱馴馳驅馹駁驢駔駛駟駙駒騶駐駝駑駕驛駘驍罵駰驕驊駱駭駢驫驪騁驗騂駸駿騏騎騍騅騌驌驂騙騭騤騷騖驁騮騫騸驃騾驄驏驟驥驦驤髏髖髕鬢魘魎魚魛魢魷魨魯魴魺鮁鮃鮎鱸鮋鮓鮒鮊鮑鱟鮍鮐鮭鮚鮳鮪鮞鮦鰂鮜鱠鱭鮫鮮鮺鯗鱘鯁鱺鰱鰹鯉鰣鰷鯀鯊鯇鮶鯽鯒鯖鯪鯕鯫鯡鯤鯧鯝鯢鮎鯛鯨鰺鯴鯔鱝鰈鰏鱨鯷鰮鰃鰓鱷鰍鰒鰉鰁鱂鯿鰠鰲鰭鰨鰥鰩鰟鰜鰳鰾鱈鱉鰻鰵鱅鰼鱖鱔鱗鱒鱯鱤鱧鱣鳥鳩雞鳶鳴鳲鷗鴉鶬鴇鴆鴣鶇鸕鴨鴞鴦鴒鴟鴝鴛鷽鴕鷥鷙鴯鴰鵂鴴鵃鴿鸞鴻鵐鵓鸝鵑鵠鵝鵒鷳鵜鵡鵲鶓鵪鵾鵯鵬鵮鶉鶊鵷鷫鶘鶡鶚鶻鶿鶥鶩鷊鷂鶲鶹鶺鷁鶼鶴鷖鸚鷓鷚鷯鷦鷲鷸鷺鸇鷹鸌鸏鸛鸘鹺麥麩黃黌黶黷黲黽黿鼂鼉鞀鼴齇齊齏齒齔齕齗齟齡齙齠齜齦齬齪齲齷龍龔龕龜志制諮只裏系範鬆沒嚐嚐鬧面準鍾別閒乾盡髒拼衝裡`},gt=ht.S,_t=ht.T,vt=(e,t)=>{let n,r,i,a,o=``,s;for(t?(n=gt,r=_t):(n=_t,r=gt),i=0;i<e.length;i++){a=e.charAt(i);let t=e.charCodeAt(i);if(!(t>13312&&t<40899||t>63744&&t<64106)){o+=a;continue}s=n.indexOf(a),s===-1?o+=a:o+=r.charAt(s)}return o},yt={s2t:(e,t)=>{if(t){for(let n=0;n<t.length;n++)e.includes(t[n].src)&&(e=e.replaceAll(t[n].src,t[n].des));return vt(e,!0)}else return vt(e,!0)},t2s:(e,t)=>{if(t){for(let n=0;n<t.length;n++)e.includes(t[n].src)&&(e=e.replaceAll(t[n].src,t[n].des));return vt(e,!1)}else return vt(e,!1)}},bt={src:`臟妳為傢蔔餵眾係姊託迴蹟儘封啟`,des:`脏你为家卜喂众系姐托回迹尽对启`,more_src:[`乾脆`,`随著`,`相信著`,`奇蹟`,`拚命`,`採取`,`製造`,`艾連`],more_des:[`干脆`,`随着`,`相信着`,`奇迹`,`拼命`,`采取`,`制造`,`艾伦`],_custom_str:[],generteCustomStr(){for(let e=0;e<this.src.length;e++)this._custom_str.push({src:this.src[e],des:this.des[e]});for(let e=0;e<this.more_src.length;e++)this._custom_str.push({src:this.more_src[e],des:this.more_des[e]})},getCustomStr(){return this._custom_str}},xt={reset(){this.unbind()},bind(){q.art.on(`video:timeupdate`,this.event,this)},unbind(){q.clearSubTitle(),q.art.off(`video:timeupdate`,this.event)},event(){let e=q.art.currentTime,t=K.allSubTitleInfo[K.currentSelectIndex]?.data;if(!t)return;let n=t.find(t=>t.to>=e&&t.from<=e),r=Array.from(q.$el.$subtitle.querySelectorAll(`.art-subtitle-line`));for(let t=0;t<r.length;t++){let i=r[t],{from:a,to:o}=Reflect.get(i,`data-subtitle-line-info`);if(o<=e||a>=e)i.remove();else if(n&&n.from===a&&n.to===o)return}if(n){let e=document.createElement(`div`);e.className=`art-subtitle-line`,Reflect.set(e,`data-subtitle-line-info`,n),e.setAttribute(`data-group`,`0`),e.innerHTML=n.content,q.$el.$subtitle.appendChild(e)}}},K={allSubTitleInfo:[],currentSelectIndex:-1,reset(){this.allSubTitleInfo.length=0,this.currentSelectIndex=-1}},q={art:null,$key:{plugin_KEY:`plugin-bilibili-cc-subtitle`},$el:{$subtitle:null},async update(e){let t=this,n=`artplayer-bili-cc-subtitle-${e.from}`,r={config:{NAME:`setting-bilibili-cc-subtitle`},getDefaultSettingOption:()=>({name:r.config.NAME,width:200,html:`字幕`,tooltip:``,icon:`
					...
					`,selector:[],onSelect:function(e){let r=e;return t.art.storage.set(n,{lan:r.subTitle_lan}),xt.unbind(),K.currentSelectIndex=r.subTitle_index,r.subTitle_index!==-1&&xt.bind(),e.html}}),getSettingOption:()=>{let e=r.getDefaultSettingOption(),t=r.getDefaultSettingSelector();return e.selector.push(t),e.tooltip=t.html,e},getDefaultSettingSelector:()=>({default:!0,html:`无`,subTitle_lan:``,subTitle_index:0,subTitle_data:[]}),addSetting(e){let r=this.getSettingOption();if(e&&e.length){r.selector.push(...e);let i={index:0,html:r.selector[0].html},a=t.art.storage.get(n);if(a){let e=r.selector.findIndex(e=>e.subTitle_lan===a.lan);if(e!==-1){let t=r.selector[e];console.log(`[artplayer-plugin-bilibiliCCSubTitle]：选择字幕：`+t.html),i.index=e,i.html=t.html}else console.warn(`[artplayer-plugin-bilibiliCCSubTitle]：没有找到上次选的字幕，使用当前默认无`)}for(let e=0;e<r.selector.length;e++)r.selector[e].default=e===i.index;r.tooltip=i.html,K.currentSelectIndex=i.index}this.isAddSetting()?(console.log(`[artplayer-plugin-bilibiliCCSubTitle]：更新字幕菜单`,e??[]),t.art.setting.update(r)):t.art.setting.add(r)},isAddSetting(){return t.art.setting.find(this.config.NAME)!=null}};K.reset(),xt.reset();let i=r.getDefaultSettingSelector();K.currentSelectIndex=0,K.allSubTitleInfo.push({name:i.html,lan:i.subTitle_lan,data:i.subTitle_data}),r.addSetting();let a=[];this.$el.$subtitle=this.art.template.$subtitle;let o={cid:e.cid};if(e.ep_id&&Reflect.set(o,`ep_id`,e.ep_id),e.aid)Reflect.set(o,`aid`,e.aid);else if(e.bvid)Reflect.set(o,`bvid`,e.bvid);else throw TypeError(`avid or bvid must give one`);let s=await M.get(`https://api.bilibili.com/x/player/v2?${O.toSearchParamsStr(o)}`,{fetch:!0,allowInterceptConfig:!1,responseType:`json`,headers:{Host:`www.bilibili.com`,Referer:`https://www.bilibili.com`}});if(!s.status){console.error(`[artplayer-plugin-bilibiliCCSubTitle]：网络异常，获取视频的字幕信息失败`,s);return}console.log(`[artplayer-plugin-bilibiliCCSubTitle]：视频的字幕信息`,s);let c=O.toJSON(s.data.responseText);if(!L.isWebApiSuccess(c)){console.error(`[artplayer-plugin-bilibiliCCSubTitle]：获取视频的字幕信息失败`,c);return}let l=c.data.subtitle.subtitles;if(!l.length){console.warn(`[artplayer-plugin-bilibiliCCSubTitle]：字幕列表为空`,c);return}if(l=l.filter(e=>O.isNotNull(e.subtitle_url)),!l.length){console.warn(`[artplayer-plugin-bilibiliCCSubTitle]：有字幕列表，但是链接都为空`,c);return}for(let e=0;e<l.length;e++){let t=l[e];console.log(`[artplayer-plugin-bilibiliCCSubTitle]：获取字幕链接信息：`+t.subtitle_url);let n=await M.get(t.subtitle_url,{responseType:`json`,allowInterceptConfig:!1,headers:{Referer:`https://www.bilibili.com`,"User-Agent":O.getRandomPCUA()}});if(n.status){console.log(`[artplayer-plugin-bilibiliCCSubTitle]：获取字幕信息成功`);let e=O.toJSON(n.data.responseText).body,r=K.allSubTitleInfo.length,i={name:t.lan_doc,lan:t.lan,data:e};i.lan===`ai-zh`&&(i.name+=`（AI）`),K.allSubTitleInfo.push(i),a.push({html:i.name,subTitle_index:r,subTitle_lan:i.lan,subTitle_data:i.data})}else console.error(`[artplayer-plugin-bilibiliCCSubTitle]：获取字幕链接信息失败`,n)}if(D.getValue(`bili-bangumi-generateSimpleChineseSubtitle`)){let e=K.allSubTitleInfo.find(e=>e.lan===`zh-Hant`||e.name.includes(`繁体`));if(e){let t=[];e.data.forEach(e=>{let{content:n,...r}=e,i=yt.t2s(n,bt.getCustomStr());t.push({content:i,...r})});let n=`简体（自动生成）`,r=K.allSubTitleInfo.length;K.allSubTitleInfo.push({name:n,lan:`zh-CN-auto`,data:t}),a.push({html:n,subTitle_index:r,subTitle_lan:`zh-CN-auto`,subTitle_data:t})}}console.log(`[artplayer-plugin-bilibiliCCSubTitle]：加载视频CC字幕信息`,K.allSubTitleInfo),K.allSubTitleInfo[K.currentSelectIndex].data==null||K.allSubTitleInfo[K.currentSelectIndex].data.length==0||xt.bind(),r.addSetting(a)},clearSubTitle(){this.$el.$subtitle&&(this.$el.$subtitle.innerHTML=``)},updateArtPlayer(e){this.art=e}};function St(e){return t=>(bt.generteCustomStr(),q.updateArtPlayer(t),q.update(e),{name:q.$key.plugin_KEY,update(e){q.update(e)}})}var Ct=q.$key.plugin_KEY,wt=(e,t)=>t==null||t==``?e:isNaN(Number(t))?t.toString():`第${t}话 ${e}`,Tt=e=>{let t=``,n=e.EP_LIST.map((e,n)=>(e.isDefault&&(t=e.title),{html:e.title,default:e.isDefault,index:n,callback:e.onSelect}));return{name:J.$key.SETTING_KEY,icon:`<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2295" width="24" height="24"><path d="M983.745542 312.673133a510.516437 510.516437 0 0 0-109.673817-162.745211A510.516437 510.516437 0 0 0 511.999823 0.000353 510.516437 510.516437 0 0 0 149.927922 149.927922 510.516437 510.516437 0 0 0 0.000353 511.999823a510.516437 510.516437 0 0 0 149.927569 362.071902A510.516437 510.516437 0 0 0 511.999823 1023.999294a510.516437 510.516437 0 0 0 362.071902-149.927569A510.516437 510.516437 0 0 0 1023.999294 511.999823c0-69.137584-13.488538-136.121238-40.253752-199.32669z m-62.852348 372.029408a443.779955 443.779955 0 0 1-95.05535 140.994061 441.908508 441.908508 0 0 1-313.73209 129.941935c-59.886283 0-118.042361-11.758333-172.667407-34.851274a443.779955 443.779955 0 0 1-141.029372-95.090661 441.908508 441.908508 0 0 1-129.941934-313.696779c0-59.886283 11.758333-118.042361 34.851274-172.667407a443.779955 443.779955 0 0 1 95.09066-141.029371 441.908508 441.908508 0 0 1 313.696779-129.941935c59.886283 0 118.077671 11.758333 172.667408 34.851274a443.779955 443.779955 0 0 1 141.064682 95.090661 441.908508 441.908508 0 0 1 129.941934 313.696778c0 59.886283-11.793643 118.042361-34.851274 172.667408zM388.413744 706.206519l317.792775-211.86185-317.792775-211.861849v423.723699z" p-id="2296"></path></svg>`,html:`选集`,selector:n,tooltip:t,onSelect:function(e){return typeof e.callback==`function`&&e.callback(e,e.index),e.html},mounted(e,t){e.setAttribute(`data-plugin`,J.$key.SETTING_KEY)},playNext(){let e=this.selector.findIndex(e=>e.default);e!==-1&&e+1<this.selector.length-1?(e+=1,this.onSelect(this.selector[e])):console.warn(`[artplayer-plugin-epChoose]：当前播放列表已无下一集`)}}},Et={$event:{"video:ended":()=>{console.log(`[artplayer-plugin-epChoose]：自动连播启用，播放下一集`),J.$data.art.setting.find(J.$key.SETTING_KEY)?.playNext()}},bind(e){Object.keys(this.$event).forEach(t=>{e.on(t,this.$event[t])})},unbind(e){Object.keys(this.$event).forEach(t=>{e.off(t,this.$event[t])})}},J={$flag:{isInitCSS:!1},$key:{SETTING_KEY:`setting-ep-choose`,PLUGIN_KEY:`plugin-ep-choose`},$data:{art:null},resetEnv(){Object.keys(this.$data).forEach(e=>{Reflect.set(this.$data,e,null)})},init(e,t){this.resetEnv(),this.$data.art=e,Et.unbind(e),t.automaticBroadcast&&Et.bind(e),this.$flag.isInitCSS||(this.$flag.isInitCSS=!0,N(`
...
`)}
            ...
            `,mounted:async e=>{let t=e.querySelector(`.art-player-video-statistics-close svg`);this.art.proxy(t,`click`,e=>{e.stopPropagation(),e.stopImmediatePropagation(),e.preventDefault(),this.closeLayer()})}}}isRegisterLayer(){return this.$key.setting_name in this.art.layers}showLayer(e){clearInterval(this.$data.intervalId);let t=this.getLayerOption();this.art.layers.add(t),e&&(this.unbindUpdateLayerEvent(),this.bindUpdateLayerEvent())}updateLayer(){let e=this.getLayerOption();this.art.layers.update(e)}bindUpdateLayerEvent(){this.art.on(`play`,this.updateLayerEvent_interval,this),this.art.on(`restart`,this.updateLayerEvent_once,this),this.art.on(`m4sAudio:loadedmetadata`,this.updateLayerEvent_once,this),this.art.on(`pause`,this.updateLayerEvent_clear_interval,this),this.art.on(`video:ended`,this.updateLayerEvent_clear_interval,this),this.art.playing&&this.updateLayerEvent_interval()}unbindUpdateLayerEvent(){this.art.off(`play`,this.updateLayerEvent_interval),this.art.off(`restart`,this.updateLayerEvent_once),this.art.off(`m4sAudio:loadedmetadata`,this.updateLayerEvent_once),this.art.off(`pause`,this.updateLayerEvent_clear_interval),this.art.off(`video:ended`,this.updateLayerEvent_clear_interval)}updateLayerEvent_interval(){clearInterval(this.$data.intervalId),this.$data.intervalId=setInterval(()=>{this.updateLayer()},1500)}updateLayerEvent_once(){this.updateLayer()}updateLayerEvent_clear_interval(){clearInterval(this.$data.intervalId)}closeLayer(){clearInterval(this.$data.intervalId),this.art.layers.remove(this.$key.setting_name),this.unbindUpdateLayerEvent()}update(e){this.option=e}},Bt=e=>t=>{let n=new zt(t,e);return{name:n.$key.plugin_KEY,update(e){n.update(e)}}},Vt=()=>({heatmap:!1,color:`#FFFFFF`,mode:0,mount:void 0,width:800,points:[],filter:e=>e.text.length<=100,beforeVisible:()=>!0,emitter:!1,maxLength:50,lockTime:3,theme:O.isThemeDark()?`dark`:`light`}),Ht=e=>{let t=e.epList||[];if(t.length===1){let n=t[0];return n.pages.map(t=>({isDefault:t.cid===e.cid,title:t.part,aid:e.aid,bvid:e.bvid,cid:t.cid,onSelect(r,i){n.cid=t.cid,Yt.updateArtPlayerVideoInfo({aid:e.aid,bvid:e.bvid,cid:t.cid,pic:t.first_frame||``,title:t.part,epList:e.epList||[]},!0)}}))}else return t.map(t=>({isDefault:t.aid===e.aid&&t.cid===e.cid,title:wt(t.title),aid:t.aid,bvid:t.bvid,cid:t.cid,onSelect(n,r){Yt.updateArtPlayerVideoInfo({aid:t.aid,bvid:t.bvid,cid:t.cid,pic:t.arc.pic,title:t.title,epList:e.epList||[]},!0)}}))},Ut={$data:{art:null,currentOption:null},resetEnv(e){e&&Reflect.set(this.$data,`art`,null),Reflect.set(this.$data,`currentOption`,null)},async init(e){this.resetEnv(!0),this.$data.currentOption=e;let t=new st(`artplayer-video-danmaku-option`),n=t.getLocalArtDanmakuOption(),r={...At(),container:e.container,poster:e.poster};return Array.isArray(r.plugins)||(r.plugins=[]),r.plugins.push(Lt(),Ft({from:`video`,qualityList:e.quality})),r.type=`mp4`,D.getValue(`artplayer-plugin-video-danmaku-enable`)&&r.plugins.push((0,s.default)({...Vt(),danmuku:e.danmukuUrl,speed:n.speed,margin:n.margin,opacity:n.opacity,modes:n.modes,fontSize:n.fontSize,antiOverlap:n.antiOverlap,synchronousPlayback:n.synchronousPlayback,visible:n.visible,beforeEmit(e){return new Promise(t=>{console.log(e),setTimeout(()=>{t(!0)},1e3)})}})),D.getValue(`artplayer-plugin-video-m4sAudioSupport-enable`)&&r.plugins.push(ut({from:`video`,showSetting:!0,audioList:e.audioList||[]})),D.getValue(`artplayer-plugin-video-epChoose-enable`)&&r.plugins.push(Dt({EP_LIST:Ht(e),automaticBroadcast:!0})),D.getValue(`artplayer-plugin-video-cc-subtitle-enable`)&&r.plugins.push(St({from:`video`,cid:e.cid,aid:e.aid,bvid:e.bvid})),D.getValue(`artplayer-plugin-video-toptoolbar-enable`)&&r.plugins.push(pt({onlineInfoParams:{aid:e.aid,cid:e.cid,bvid:e.bvid},title:e.videoTitle,showWrap:!0,showTitle:!0,showOnlineTotal:!0})),D.getValue(`artplayer-plugin-video-statistics-enable`)&&r.plugins.push(Bt({data:[]})),D.getValue(`bili-video-playerAutoPlayVideo`)&&(r.muted=!0,r.autoplay=!0),this.$data.art=new o.default(r),t.onConfigChange(this.$data.art),this.$data.art},async update(e,t){this.resetEnv(!1),this.$data.currentOption=t,j.info(`更新新的播放信息`,t),e.pause(),j.info(`暂停视频`),e.currentTime=0,j.info(`重置播放进度`),this.updatePluginInfo(e,t),e.play(),j.info(`播放`)},updatePluginInfo(e,t){if(e.plugins[jt].update({from:`video`,qualityList:t.quality}),j.info(`更新画质`,t.quality),D.getValue(`artplayer-plugin-video-danmaku-enable`)&&(e.plugins.artplayerPluginDanmuku.config({danmuku:t.danmukuUrl}),e.plugins.artplayerPluginDanmuku.load(),j.info(`更新弹幕姬`,t.danmukuUrl)),D.getValue(`artplayer-plugin-video-m4sAudioSupport-enable`)&&(e.plugins[dt].update({from:`video`,audioList:t.audioList||[]}),j.info(`更新音频`,t.audioList)),D.getValue(`artplayer-plugin-video-epChoose-enable`)&&(e.plugins[Ot].update({EP_LIST:Ht(t),automaticBroadcast:!0}),j.info(`更新选集信息`,t.epList)),D.getValue(`artplayer-plugin-video-cc-subtitle-enable`)){let n=e.plugins[Ct],r={from:`video`,aid:t.aid,bvid:t.bvid,cid:t.cid};n.update(r),j.info(`更新字幕`,r)}if(D.getValue(`artplayer-plugin-video-toptoolbar-enable`)){let n=e.plugins[mt],r={showRight:!0,showRightFollow:!0,showWrap:!0,showTitle:!0,showOnlineTotal:!0,title:t.videoTitle,onlineInfoParams:{aid:t.aid,cid:t.cid,bvid:t.bvid}};n.update(r),j.info(`更新顶部标题`,r)}}},Wt=`.artplayer-container {
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`,Gt=()=>D.getValue(`bili-video-video-url-preferToUseUpos`),Kt=()=>D.getValue(`bili-video-audio-url-preferToUseUpos`),qt=function(e){let t=[];return e.video.forEach(n=>{if(!e.accept_quality.includes(n.id))return;let r=e.support_formats.find(e=>e.quality===n.id),i=z.findBetterCDN(Gt(),[n.base_url,n.baseUrl,n.backup_url,n.backupUrl]);i=z.replaceVideoOrAudioCDN(i,!1);let a=r?.new_description;t.push({name:a,url:i,type:n.mimeType||n.mime_type,id:n.id,quality:n.id,vip:!1,codecid:n.codecid,codecs:n.codecs,frameRate:n.frameRate||n.frame_rate,bandwidth:n.bandwidth})}),t},Jt=async e=>{let t=[],n=[];if(D.getValue(`bili-video-playType`,`mp4`)===`mp4`){let t=await it.playUrl({bvid:e.bvid,cid:e.cid,fnval:1,fnver:0,fourk:1,high_quality:1,qn:127,setPlatformHTML5:!0});if(j.info([`视频播放地址信息：`,t]),!t)return;let r=t.durl[0],i=t.support_formats.find(e=>e.quality===t.quality),a=z.findBetterCDN(Gt(),[r.url,r.url||r.backup_url?.[0]]),o=i?.new_description;n.push({name:o,url:a,type:`audio/mp4`,id:t.quality,codecid:t.video_codecid,quality:t.quality,vip:!1,codecs:``,frameRate:``,bandwidth:0})}else{let r=await it.playUrl({bvid:e.bvid,cid:e.cid,fnval:3088,fnver:0,fourk:1,high_quality:1,qn:127,setPlatformHTML5:!1});if(j.info(`视频播放地址信息：`,r),!r)return;r.dash.audio.forEach(e=>{let n=z.findBetterCDN(Kt(),[e.baseUrl,e.base_url,e.baseUrl,e.backup_url]);n=z.replaceVideoOrAudioCDN(n,!0),t.push({url:n,id:e.id,text:ot[e.id]||``,codecs:e.codecs,mimeType:e.mimeType,bandwidth:e.bandwidth,size:0})}),t.sort((e,t)=>t.id-e.id),j.info(`ArtPlayer: 最终的音频信息`,t),n=[...qt({accept_quality:r.accept_quality,support_formats:r.support_formats,video:r.dash.video})],j.info(`ArtPlayer: 最终的视频画质信息`,n)}let r=n.map(e=>({quality:e.quality,html:e.name,url:e.url,codecid:e.codecid,codecs:e.codecs,frameRate:e.frameRate,mimeType:e.type,bandwidth:e.bandwidth})),i={container:null,epList:e.epList,audioUrl:null,url:``,poster:e.pic,aid:e.aid,bvid:e.bvid,cid:e.cid,videoTitle:e.title,danmukuUrl:`https://${I.web_host}/x/v1/dm/list.so?oid=${e.cid}`,quality:r};return i.url=n?.[0]?.url,t.length&&(i.audioList=t.map((e,t)=>({isDefault:t===0,url:e.url,soundQualityCode:e.id,soundQualityCodeText:e.text,codecs:e.codecs,mimeType:e.mimeType,bandwidth:e.bandwidth,size:e.size}))),i},Yt={$data:{art:null},init(){D.execMenu(`bili-video-enableArtPlayer`,()=>{this.coverVideoPlayer()})},coverVideoPlayer(){if(P(`#artplayer`))j.warn(`已使用ArtPlayer覆盖原播放器，更新播放信息`);else{j.info(`覆盖播放器`),N(`
            /* 隐藏原本的播放器 */
...
`)}
			...
			`),Xn.updateArtPlayerVideoInfo()}},Qn={init(){Ke.init(),Je.init(),Bn.init(),D.execMenuOnce(`bili-allowCopy`,()=>N(`
				.v-drawer{
					-webkit-user-select: unset !important;
					-moz-user-select: unset !important;
					user-select: unset !important;
				}
			`)),D.onceExec(`listenRouterChange`,()=>{this.listenRouterChange()}),D.execMenuOnce(`bili-hookSetTimeout_autoOpenApp`,()=>{j.info(`hook  window.setTimeout autoOpenApp`),Dn.setTimeout(`autoOpenApp`),Dn.setTimeout(`bilibili://`),Dn.setTimeout(`void 0 !== y && document[y]`)}),D.execMenuOnce(`bili-overrideLaunchAppBtn_Vue_openApp`,()=>{j.info(`覆盖元素.launch-app-btn上的openApp`),Dn.overRideLaunchAppBtn_Vue_openApp()}),D.execMenuOnce(`bili-cover-bili-open-app-open`,()=>{j.info(`覆盖元素bili-open-app上的opener.open`),Dn.overRideBiliOpenApp()}),D.execMenuOnce(`bili-cover-wx-tag-handleClick`,()=>{j.info(`覆盖元素.wx-tag的handleClick函数`),Dn.overRideWxTaghandleClick()}),D.execMenuOnce(`bili-head-beautify`,()=>(j.info(`添加美化CSS`),N(te))),D.execMenuOnce(`bili-componentDetection`,()=>{Yn.init()}),v.isVideo()?(j.info(`Router: 视频稿件`),Xt.init()):v.isOpus()?(j.info(`Router: 专栏稿件`),wn.init()):ne.isReadMobile()?(j.info(`PC-Router: 专栏稿件`),Rn.init()):v.isDynamic()?(j.info(`Router: 动态`),En.init()):v.isBangumi()?(j.info(`Router: 番剧`),mn.init()):v.isSearch()?(j.info(`Router: 搜索`),bn.init()):v.isLive()?(j.info(`Router: 直播`),Sn.init()):v.isTopicDetail()?(j.info(`Router: 话题`),Tn.init()):v.isHead()?(j.info(`Router: 首页之类的`),Ln.init()):v.isSpace()?(j.info(`Router: 个人空间`),zn.init()):v.isPlayList()?(j.info(`Router: 播放列表`),Zn.init()):j.error(`该Router暂未适配，可能是首页之类：`+window.location.href)},listenRouterChange(){B.waitVuePropToSet(`#app`,{msg:`监听路由变化`,check:e=>typeof e?.$router?.afterEach==`function`,set:e=>{j.success(`成功设置监听路由变化`),e.$router.beforeHooks.splice(0,0,(e,t,n)=>{if(j.info(`路由变化 => 更新前`,{to:e,from:t}),e.hash===`#/seeCommentReply`||t.hash===`#/seeCommentReply`){j.info(`该路由变化判定为#/seeCommentReply`),n();return}if(D.getValue(`bili-repairVueRouter404`)&&e.name===`space`){j.info(`修复空间跳转404`),window.location.href=e.fullPath;return}if(e.fullPath.startsWith(`/video`)){if(t.fullPath.startsWith(`/video`)&&D.getValue(`bili-video-forceThisPageToRefreshAndRedirect`)){j.info(`强制本页刷新`),window.location.href=e.fullPath;return}else if(v.isHead()&&D.getValue(`bili-head-openVideoInNewTab`)){j.info(`当前是首页，新标签页打开`),window.open(e.fullPath,`_blank`);return}}else if(e.fullPath.startsWith(`/bangumi`)){if(t.fullPath.startsWith(`/bangumi`)){j.info(`番剧 => 番剧`),window.location.href=e.fullPath;return}else if(v.isHead()&&D.getValue(`bili-head-openVideoInNewTab`)){j.info(`首页 => 番剧`),window.open(e.fullPath,`_blank`);return}}n()}),e.$router.afterHooks.splice(0,0,(e,t)=>{if(j.info(`路由变化 => 更新后`,{to:e,from:t}),e.hash===`#/seeCommentReply`||t.hash===`#/seeCommentReply`){j.info(`该路由变化判定为#/seeCommentReply，不重载`);return}D.execMenu(`bili-listenRouterChange`,()=>{Qn.init()})})}})}},$n={id:`panel-common`,title:`通用`,views:[{text:``,type:`container`,views:[{text:`功能`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`监听路由-重载所有功能`,`bili-listenRouterChange`,!0,void 0,`用于处理页面跳转(本页)时功能不生效问题`),Z(`修复VueRouter跳转404问题`,`bili-repairVueRouter404`,!0,void 0,`例如：点击UP主正确进入空间`),Z(`新标签页打开`,`bili-go-to-url-blank`,!1,void 0,`通过开启【覆盖点击事件】相关的设置，通过新标签页打开链接`),Z(`允许复制`,`bili-allowCopy`,!0,void 0,`一般用于处理楼层的回复弹窗内无法选中复制问题`)]}]},{text:`变量设置`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`noCallApp`,`bili-noCallApp`,!0,void 0,`$store.state.common.noCallApp=true`),Z(`isLogin`,`bili-setLogin`,!0,void 0,[`$store.state.common.userInfo.isLogin=true`,`$store.state.loginInfo.isLogin=true`].join(`<br>`)),Z(`isClient`,`bili-setIsClient`,!0,void 0,[`$store.state.video.isClient=true`,`$store.state.opus.isClient=true`,`$store.state.playlist.isClient=true`,`$store.state.ver.bili=true`,`$store.state.ver.biliVer=2333`].join(`<br>`))]}]},{text:`劫持/拦截`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`覆盖.launch-app-btn openApp`,`bili-overrideLaunchAppBtn_Vue_openApp`,!0,void 0,`覆盖.launch-app-btn元素上的openApp函数，可阻止点击唤醒/下载App`),Z(`覆盖bili-open-app opener.open`,`bili-cover-bili-open-app-open`,!0,void 0,`覆盖bili-open-app/m-open-app元素上的opener.open函数，可阻止点击唤醒/下载App，如果存在有效链接，会自动跳转`),Z(`覆盖.wx-tag的handleClick`,`bili-cover-wx-tag-handleClick`,!0,void 0,`覆盖.wx-tag元素上的点击事件，让它直接打开视频`),Z(`劫持setTimeout-autoOpenApp`,`bili-hookSetTimeout_autoOpenApp`,!0,void 0,`阻止自动调用App`)]}]},{type:`deepMenu`,text:`成分检测`,views:[{type:`container`,text:``,views:[Z(`启用`,`bili-componentDetection`,!0,void 0,`启用后可检测用户的成分信息`),Vn(`自定义规则`,`检测用户成分的规则`,`管理`,void 0,!1,!1,`primary`,()=>{$.showView()})]},{type:`container`,text:``,views:[Vn(`数据导入`,`导入自定义规则数据`,`导入`,void 0,!1,!1,`primary`,()=>{$.importRule()}),Vn(`数据导出`,`导出自定义规则数据`,`导出`,void 0,!1,!1,`primary`,()=>{$.exportRule(`成分检测.json`)})]}]}]},{text:``,type:`container`,views:[{text:`数据配置`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Hn(`access_token`,`bili-head-recommend-access_token`,Re.getAccessToken(),`填入access_token，可用于获取推荐视频数据、番剧搜索、番剧播放等`,(e,t)=>{Re.setAccessTokenInfo({access_token:t,expireAt:Re.generateExpireAt()})})]}]},{text:`Toast配置`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Un(`Toast位置`,`qmsg-config-position`,`bottom`,[{value:`topleft`,text:`左上角`},{value:`top`,text:`顶部`},{value:`topright`,text:`右上角`},{value:`left`,text:`左边`},{value:`center`,text:`中间`},{value:`right`,text:`右边`},{value:`bottomleft`,text:`左下角`},{value:`bottom`,text:`底部`},{value:`bottomright`,text:`右下角`}],e=>{j.info(`设置当前Qmsg弹出位置`+e.text)},`Toast显示在页面九宫格的位置`),Un(`最多显示的数量`,`qmsg-config-maxnums`,3,[{value:1,text:`1`},{value:2,text:`2`},{value:3,text:`3`},{value:4,text:`4`},{value:5,text:`5`}],void 0,`限制Toast显示的数量`),Z(`逆序弹出`,`qmsg-config-showreverse`,!1,void 0,`修改Toast弹出的顺序`)]}]},{text:`Cookie配置`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`启用`,`httpx-use-cookie-enable`,!1,void 0,`启用后，将根据下面的配置进行添加cookie`),Z(`使用document.cookie`,`httpx-use-document-cookie`,!1,void 0,`自动根据请求的域名来获取对应的cookie`),Gn(`bilibili.com`,`httpx-cookie-bilibili.com`,``,void 0,void 0,`Cookie格式：xxx=xxxx;xxx=xxxx`)]}]}]}]},er={id:`panel-head`,title:`首页`,views:[{text:``,type:`container`,views:[{text:`功能`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`美化显示`,`bili-head-beautify`,!0,void 0,`调整瀑布流视频卡片样式类似哔哩哔哩App`),Z(`美化顶部NavBar`,`bili-beautifyTopNavBar`,!0,void 0,`类似哔哩哔哩App的样式`),Z(`补充推荐视频信息`,`bili-head-supplementaryVideoStreamingInformation`,!0,void 0,`给视频添加UP主名，当前视频总时长信息`),Z(`新标签页打开`,`bili-head-openVideoInNewTab`,!1,void 0,`包括视频、番剧`)]}]},{text:`推荐视频`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`启用`,`bili-head-recommend-enable`,!0,void 0,`添加【推荐】标签，数据来源为App端(如果填入了access_token的话)`),Z(`显示【图文】`,`bili-head-recommend-push-graphic`,!0,void 0,`加载App端推送的【图文】卡片`)]}]}]}]},tr={id:`panel-video`,title:`视频`,isDefault(){return v.isVideo()},views:[{text:``,type:`container`,views:[{text:`功能`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`强制本页刷新跳转`,`bili-video-forceThisPageToRefreshAndRedirect`,!1,void 0,`用于处理内存泄露问题`),Z(`新增评论模块`,`bili-video-addCommentModule`,!0,void 0,`用于查看当前视频的评论`),Z(`新增简介模块`,`bili-video-addDescModule`,!0,void 0,`用于查看当前视频的播放量、简介、一键三连等信息`)]}]},{text:`ArtPlayer播放器`,type:`deepMenu`,views:[{text:`功能`,type:`container`,views:[Z(`启用`,`bili-video-enableArtPlayer`,!0,void 0,`使用artplayer代替页面的播放器`),Un(`播放的视频类型`,`bili-video-playType`,`mp4`,[{text:`mp4`,value:`mp4`},{text:`dash`,value:`dash`}],void 0,`当选择dash时会有画质更高的选项`),Z(`自动播放视频`,`bili-video-playerAutoPlayVideo`,!1,void 0,``),Z(`自动进入全屏`,`bili-video-playerAutoPlayVideoFullScreen`,!1,void 0,``)]},{text:`控件设置`,type:`container`,views:[Wn(`controls左右边距`,`bili-video-artplayer-controlsPadding-left-right`,0,0,50,void 0,e=>e+`px`,`可用于全屏横屏适配屏幕`,1)]},{text:`插件`,type:`container`,views:[Z(`弹幕`,`artplayer-plugin-video-danmaku-enable`,!0,void 0,`哔哩哔哩 (゜-゜)つロ 干杯~`),Z(`Dash Audio Support`,`artplayer-plugin-video-m4sAudioSupport-enable`,!0,void 0,`视频类型为dash时，该插件可支持播放音频`),Z(`选集`,`artplayer-plugin-video-epChoose-enable`,!0,void 0,`当视频播放完毕后会自动连播`),Z(`CC字幕`,`artplayer-plugin-video-cc-subtitle-enable`,!0,void 0,`字幕支持插件，如果存在繁体字幕，则自动生成简体字幕`),Z(`顶部工具栏`,`artplayer-plugin-video-toptoolbar-enable`,!0,void 0,`显示视频标题和当前观看人数`),Z(`视频统计信息`,`artplayer-plugin-video-statistics-enable`,!0,void 0,`用于显示当前视频信息的弹窗`)]},{text:`加速CDN设置（dash）`,type:`container`,views:[Z(`视频-优先使用upos节点`,`bili-video-video-url-preferToUseUpos`,!1,void 0,`如果视频无法正常加载，请关闭该功能`),Un(`视频-UPOS服务器设置`,`bili-video-uposServerSelect`,R[0].host,R.map(e=>({text:e.name,value:e.host})),void 0,`设置视频流的服务器，可加快视频加载速度`),Q(`视频-自定义UPOS服务器`,`bili-video-uposServerSelect-own`,``,`自定义的服务器优先级大于上面选择的服务器`,void 0,`请输入upos服务器的域名`),Z(`视频-优先使用upos节点`,`bili-video-audio-url-preferToUseUpos`,!1,void 0,`如果视频无法正常加载，请关闭该功能`),Un(`音频-UPOS服务器设置`,`bili-video-uposServerSelect-audio`,R[0].host,R.map(e=>({text:e.name,value:e.host})),void 0,`设置音频的服务器，可加快音频加载速度`),Q(`音频-自定义UPOS服务器`,`bili-video-uposServerSelect-audio-own`,``,`自定义的服务器优先级大于上面选择的服务器`,void 0,`请输入upos服务器的域名`)]}]},{text:`覆盖点击事件`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`UP主信息`,`bili-video-cover-UpWrapper`,!0,void 0,`点击UP主头像/名称可跳转至UP主空间`),Z(`相关视频`,`bili-video-cover-bottomRecommendVideo`,!0,void 0,`点击下面的相关视频可正确跳转至该视频`),Z(`选集`,`bili-video-cover-seasonNew`,!0,void 0,`点击下面的选集列表内的视频可正确跳转至该视频`)]}]},{text:`劫持/拦截`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`阻止调用App`,`bili-video-hook-callApp`,!0,void 0,`处理函数: PlayerAgent`)]}]}]}]},nr={id:`panel-opus`,title:`专栏`,isDefault(){return v.isOpus()},views:[{text:``,type:`container`,views:[{text:`功能`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`自动展开阅读全文`,`bili-opus-automaticallyExpandToReadFullText`,!0,void 0,`屏蔽【展开阅读全文】按钮并自动处理全文高度`)]}]},{text:`变量设置`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`autoOpenApp`,`bili-opus-variable-autoOpenApp`,!0,void 0,`autoOpenApp函数置空`),Z(`go404`,`bili-opus-variable-go404`,!0,void 0,`go404函数置空，可禁止前往404页面`),Z(`handleFallback`,`bili-opus-variable-handleFallback`,!0,void 0,`禁止前往404页面`)]}]},{text:`覆盖点击事件`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`话题`,`bili-opus-cover-topicJump`,!0,void 0,`点击话题正确跳转`),Z(`header用户`,`bili-opus-cover-header`,!0,void 0,`点击内容上的发布本动态的用户正确跳转个人空间`)]}]}]}]},rr={id:`panel-dynamic`,title:`动态`,isDefault(){return v.isDynamic()},views:[{text:``,type:`container`,views:[{text:`覆盖点击事件`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`话题`,`bili-dynamic-cover-topicJump`,!0,void 0,`点击话题正确跳转`),Z(`header用户`,`bili-dynamic-cover-header`,!0,void 0,`点击内容上的发布本动态的用户正确跳转个人空间`),Z(`@用户`,`bili-dynamic-cover-atJump`,!0,void 0,`点击@用户正确跳转个人空间`),Z(`引用`,`bili-dynamic-cover-referenceJump`,!0,void 0,`点击引用的视频|用户正确跳转`)]}]}]}]},ir={id:`panel-bangumi`,title:`番剧`,isDefault(){return v.isBangumi()},views:[{text:``,type:`container`,views:[{text:`功能`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`固定缩放倍率`,`bili-bangumi-initialScale`,!0,void 0,``)]}]},{text:`ArtPlayer播放器`,type:`deepMenu`,views:[{text:`控件设置`,type:`container`,views:[Wn(`controls左右边距`,`bili-bangumi-artplayer-controlsPadding-left-right`,0,0,50,void 0,e=>e+`px`,`可用于全屏横屏适配屏幕`,1)]},{text:`插件`,type:`container`,views:[Z(`弹幕`,`artplayer-plugin-bangumi-danmaku-enable`,!0,void 0,`哔哩哔哩 (゜-゜)つロ 干杯~`),Z(`Dash Audio Support`,`artplayer-plugin-bangumi-m4sAudioSupport-enable`,!0,void 0,`视频类型为dash时，该插件可支持播放音频`),Z(`选集`,`artplayer-plugin-bangumi-epChoose-enable`,!0,void 0,`当视频播放完毕后会自动连播`),Z(`CC字幕`,`artplayer-plugin-bangumi-cc-subtitle-enable`,!0,void 0,`字幕支持插件，如果存在繁体字幕，则自动生成简体字幕`),Z(`顶部工具栏`,`artplayer-plugin-bangumi-toptoolbar-enable`,!0,void 0,`显示视频标题和当前观看人数`),Z(`空降助手`,`artplayer-plugin-bangumi-airborneHelper-enable`,!0,void 0,`如果获取到的信息中存在空降信息，如跳过片头片尾，那么会自动跳过`),Z(`视频统计信息`,`artplayer-plugin-bangumi-statistics-enable`,!0,void 0,`用于显示当前视频信息的弹窗`)]},{text:`解除区域限制`,type:`container`,views:[Z(`解锁番剧限制`,`bili-bangumi-unlockAreaLimit`,!1,void 0,`使用户可以观看区域外版权番剧`),Z(`生成简中字幕`,`bili-bangumi-generateSimpleChineseSubtitle`,!0,void 0,`根据繁体字幕自动生成简体中文字幕`)]},{text:`加速CDN设置（dash）`,type:`container`,views:[Z(`视频-优先使用upos节点`,`bili-bangumi-video-url-preferToUseUpos`,!1,void 0,`如果视频无法正常加载，请关闭该功能`),Un(`视频-UPOS服务器设置`,`bili-bangumi-uposServerSelect`,R[0].host,R.map(e=>({text:e.name,value:e.host})),void 0,`设置视频流的服务器，可加快视频加载速度`),Q(`视频-自定义UPOS服务器`,`bili-bangumi-uposServerSelect-own`,``,`自定义的服务器优先级大于上面选择的服务器`,void 0,`请输入upos服务器的域名`),Z(`音频-优先使用upos节点`,`bili-bangumi-audio-url-preferToUseUpos`,!1,void 0,`如果音频无法正常加载，请关闭该功能`),Un(`音频-UPOS服务器设置`,`bili-bangumi-uposServerSelect-audio`,R[0].host,R.map(e=>({text:e.name,value:e.host})),void 0,`设置音频的服务器，可加快音频加载速度`),Q(`音频-自定义UPOS服务器`,`bili-bangumi-uposServerSelect-audio-own`,``,`自定义的服务器优先级大于上面选择的服务器`,void 0,`请输入upos服务器的域名`)]},{text:`<a href='https://github.com/yujincheng08/BiliRoaming/wiki/%E5%85%AC%E5%85%B1%E8%A7%A3%E6%9E%90%E6%9C%8D%E5%8A%A1%E5%99%A8' target='_blank'>解析服务器</a>`,type:`container`,views:[Q(`中国大陆`,`bili-bangumi-proxyApiServer-default`,``,`用于请求播放地址的代理`,void 0,`bilibili优化.example.com`),Q(`香港`,`bili-bangumi-proxyApiServer-hk`,``,`用于请求播放地址的代理`,void 0,`bilibili优化.example.com`),Q(`台湾`,`bili-bangumi-proxyApiServer-tw`,``,`用于请求播放地址的代理`,void 0,`bilibili优化.example.com`),Q(`泰国/东南亚`,`bili-bangumi-proxyApiServer-tha-or-sea`,``,`用于请求播放地址的代理`,void 0,`bilibili优化.example.com`)]}]},{text:`覆盖点击事件`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`【选集】`,`bili-bangumi-cover-clicl-event-chooseEp`,!0,void 0,`让【选集】的视频列表可点击跳转`),Z(`【其它】`,`bili-bangumi-cover-clicl-event-other`,!0,void 0,`让【PV&其他】、【预告】、【主题曲】、【香境剧场】等的视频列表可点击跳转`),Z(`【更多推荐】`,`bili-bangumi-cover-clicl-event-recommend`,!0,void 0,`让【更多推荐】的视频列表可点击跳转`)]}]},{text:`劫持/拦截`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`阻止调用App`,`bili-bangumi-hook-callApp`,!0,void 0,``)]}]}]}]},ar={id:`panel-search`,title:`搜索`,isDefault(){return v.isSearch()},views:[{type:`container`,text:``,views:[{type:`deepMenu`,text:`功能`,views:[{type:`container`,text:``,views:[Z(`搜索框自动获取焦点`,`bili-search-inputAutoFocus`,!0,void 0,``),Z(`美化搜索结果`,`bili-search-beautifySearchResult`,!0,void 0,`重构搜索结果的样式`),Z(`开启其它地区番剧搜索`,`bili-search-enableOtherAreaSearchBangumi`,!1,void 0,`在搜索页面添加其它地区番剧搜索结果，需要解析服务器支持`)]},{text:`<a href='https://github.com/yujincheng08/BiliRoaming/wiki/%E5%85%AC%E5%85%B1%E8%A7%A3%E6%9E%90%E6%9C%8D%E5%8A%A1%E5%99%A8' target='_blank'>搜索服务器</a>`,type:`container`,views:[Q(`香港`,`bili-search-proxyApiServer-hk`,``,`用于搜索番剧结果的代理`,void 0,`bilibili优化.example.com`),Q(`台湾`,`bili-search-proxyApiServer-tw`,``,`用于搜索番剧结果的代理`,void 0,`bilibili优化.example.com`),Q(`泰国/东南亚`,`bili-search-proxyApiServer-tha-or-sea`,``,`用于搜索番剧结果的代理`,void 0,`bilibili优化.example.com`)]}]},{type:`deepMenu`,text:`覆盖点击事件`,views:[{type:`container`,text:``,views:[Z(`取消`,`bili-search-cover-cancel`,!1,void 0,`点击取消按钮回退至上一页`),Z(`搜索结果`,`bili-search-cover-card-result-click-event`,!0,void 0,`修复点击搜索结果不跳转视频的问题`)]}]},{text:`变量设置`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`noCallApp`,`bili-search-vue-prop-noCallApp`,!0,void 0,`noCallApp = true`),Z(`openAppDialog`,`bili-search-vue-prop-openAppDialog`,!0,void 0,`openAppDialog = false`)]}]}]}]},or={id:`panel-space`,title:`个人空间`,isDefault(){return v.isSpace()},views:[{text:``,type:`container`,views:[{text:`功能`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`修复正确跳转`,`bili-space-repairRealJump`,!0,void 0,`修复视频|动态的正确跳转，避免跳转404`)]}]},{text:`覆盖点击事件`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`动态视频`,`bili-space-coverDynamicStateCardVideo`,!0,void 0,`点击发布动态的视频可正常跳转至该视频`)]}]}]}]},sr={id:`panel-live`,title:`直播`,isDefault(){return v.isLive()},views:[{text:``,type:`container`,views:[{type:`deepMenu`,text:`功能`,views:[{text:`加速CDN设置`,type:`container`,views:[Z(`启用`,`bili-live-cdn-hook`,!1,void 0,`开启后，劫持网络请求并替换返回的视频流CDN`),Un(`直播视频流-UPOS服务器设置`,`bili-live-uposServerSelect`,R[0].host,R.map(e=>({text:e.name,value:e.host})),void 0,`设置视频流的服务器，可加快视频加载速度`),Q(`直播视频流-自定义UPOS服务器`,`bili-live-uposServerSelect-own`,``,`自定义的服务器优先级大于上面选择的服务器`,void 0,`请输入upos服务器的域名`)]}]},{text:`屏蔽`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`【屏蔽】聊天室`,`bili-live-block-chatRoom`,!1,void 0,`直接不显示底部的聊天室`),Z(`【屏蔽】xxx进入直播间`,`bili-live-block-brush-prompt`,!1,void 0,`直接不显示底部的xxx进入直播间`),Z(`【屏蔽】控制面板`,`bili-live-block-control-panel`,!1,void 0,`屏蔽底部的发个弹幕、送礼`)]}]},{text:`劫持/拦截`,type:`deepMenu`,views:[{text:``,type:`container`,views:[Z(`阻止open-app-btn元素点击事件触发`,`bili-live-prevent-openAppBtn`,!0,void 0,`开启后可不跳转至唤醒App页面`)]}]}]}]},cr={id:`panel-topic-detail`,title:`话题`,isDefault(){return v.isTopicDetail()},views:[]},lr=O.formatTime(void 0,`yyyy-MM-dd_HH:mm:ss`)+`BilibiliPerfScriptRunning`;Reflect.has(b,lr)?j.error(`${Ne}运行异常，请勿重复运行脚本：${lr}`):(Reflect.set(b,lr,!0),Se.addContentConfig([$n,er,tr,nr,rr,ir,cr,ar,or,sr]),Ce.addMenuOption([{key:`go_to_login`,text:`🛠 前往登录`,autoReload:!1,isStoreValue:!1,showText(e){return e},callback(){V.goToLogin()}},{key:`go_to_login_to_parse_access_key`,text:`🛠 扫码并解析access_key`,autoReload:!1,isStoreValue:!1,showText(e){return e},callback(){Re.init()}}]),D.init(),Qn.init(),A.config.cssText.index+=`
  /* bilibili颜色 #FB7299 */
  .pops{
      --bili-color: #FB7299;

...
`):s},callback(s,p){this.props[H].set(e,p);}};return Reflect.set(l.attributes,Dt,e),Reflect.set(l.attributes,kt,r),Reflect.set(l.props,H,{get(s,p){return f.getValue(s,p)},set(s,p){f.setValue(s,p);}}),l},Pt=function(t,e,r,n,i,a){let o=[];typeof n=="function"?o=n():o=n;let l={text:t,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[H].get(e,r)},callback(s,p,c){let m=p;u.info(`选择：${c}`),this.props[H].set(e,m),typeof i=="function"&&i(s,m,c);},data:o};return Reflect.set(l.attributes,Dt,e),Reflect.set(l.attributes,kt,r),Reflect.set(l.props,H,{get(s,p){return f.getValue(s,p)},set(s,p){f.setValue(s,p);}}),l},pt=function(t,e,r,n,i,a="",o,l){let s={text:t,type:"input",isNumber:!!o,isPassword:!!l,props:{},attributes:{},description:n,getValue(){return this.props[H].get(e,r)},callback(p,c){typeof i=="function"&&i(p,c)||this.props[H].set(e,c);},placeholder:a};return Reflect.set(s.attributes,Dt,e),Reflect.set(s.attributes,kt,r),Reflect.set(s.props,H,{get(p,c){return f.getValue(p,c)},set(p,c){f.setValue(p,c);}}),s},vt={ios:{appkey:"27eb53fc9058f8c3",appsec:"c2ed53a74eeefe3cf99fbd01d8c9c375",mobi_app:"ipnone"}};function pe(t,e,r){t.appkey=e;const n=new URLSearchParams(t);return n.sort(),Fe(n.toString()+r)}const dt={isWebApiSuccess(t){return (t==null?void 0:t.code)===0&&((t==null?void 0:t.message)==="0"||(t==null?void 0:t.message)==="success")},isAreaLimit(t){let e={6002003:"抱歉您所在地区不可观看！"},r=false;return Object.keys(e).forEach(n=>{let i=e[n];(t.code.toString()===n.toString()||t.message.includes(i))&&(r=true);}),r}},de={async getQrCodeInfo(){var o;let t="https://passport.bilibili.com/x/passport-tv-login/qrcode/auth_code",e={appkey:vt.ios.appkey,local_id:"0",ts:"0",mobi_app:vt.ios.mobi_app,csrf:((o=Se.get("bili_jct"))==null?void 0:o.value)||""},r=pe(e,vt.ios.appkey,vt.ios.appsec),n=await X.post(t,{data:d.toSearchParamsStr({...e,sign:r}),headers:{"Content-Type":"application/x-www-form-urlencoded"},responseType:"json",fetch:true});if(u.info(n),!n.status)return;let i=d.toJSON(n.data.responseText);if(i.code!==0){k.error(i.message);return}return i.data},async poll(t){let e="https://passport.bilibili.com/x/passport-tv-login/qrcode/poll",r={appkey:vt.ios.appkey,auth_code:t,local_id:"0",ts:"0"},n=pe(r,vt.ios.appkey,vt.ios.appsec),i=await X.post(e,{data:d.toSearchParamsStr({...r,sign:n}),headers:{"Content-Type":"application/x-www-form-urlencoded"},responseType:"json",fetch:true});if(!i.status)return {success:false,message:"网络错误",action:void 0};const a=d.toJSON(i.data.responseText);u.info(a);const o={0:"成功","-3":"API校验密匙错误","-400":"请求错误","-404":"啥都木有",86038:"二维码已失效",86039:"二维码尚未确认",86090:"二维码已扫码未确认"};if(!dt.isWebApiSuccess(a)){const p=a.code.toString(),c=a.message||o[p]||"未知错误";return p==="86038"?{success:false,message:c,action:"refresh"}:p==="86039"||p==="86090"?{success:false,message:c,action:"wait"}:{success:false,message:c,action:void 0}}const l=a.data.access_token,s=Date.now()+a.data.expires_in*1e3;return {success:true,message:"获取成功",accessKey:l,accessKeyExpireAt:s}}},Tt={async init(){k.info("正在申请二维码...");let t=await this.getQRCodeInfo();t&&this.confirmScanQrcode(t);},getQRCodeInfo:async function(){u.info("正在申请二维码...");let t=await de.getQrCodeInfo();return u.info("获取到二维码信息",t),t},async confirmScanQrcode(t){let e=Z.alert({title:{text:"请扫描二维码登录",position:"center",html:false,style:""},content:{text:'<div id="bili-qrcode-canvas"></div>',html:true},btn:{ok:{enable:false},close:{enable:true,callback(a){i=true,a.close();}}},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},only:true,width:"310px",height:"365px",drag:true,dragLimit:true,style:`
            ...
            `}),r=e.$shadowRoot.querySelector(".filter-container"),n=document.createDocumentFragment();this.option.filterOption.forEach(i=>{let a=document.createElement("button");a.innerText=i.name;let o=async()=>{(await this.option.getAllRuleInfo()).forEach(async s=>{await i.filterCallBack(s.data)?h.show(s.$el,false):h.hide(s.$el,false);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};h.on(a,"click",async l=>{d.preventEvent(l),!(typeof i.callback=="function"&&!await i.callback(l,o))&&await o();}),n.appendChild(a);}),r.appendChild(n);}}class yr{constructor(e){rt(this,"option");this.option=e;}async showView(e){var a,o,l,s,p,c,m,g,C;let r=Z.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    ...
                    `,html:true},btn:{merge:true,reverse:false,position:"space-between",ok:{enable:((l=(o=(a=this.option)==null?void 0:a.bottomControls)==null?void 0:o.add)==null?void 0:l.enable)||true,type:"primary",text:"添加",callback:async B=>{this.showEditView(false,await this.option.getAddData(),r.$shadowRoot);}},close:{enable:true,callback(B){r.close();}},cancel:{enable:((c=(p=(s=this.option)==null?void 0:s.bottomControls)==null?void 0:p.filter)==null?void 0:c.enable)||false,type:"default",text:"过滤",callback:(B,_)=>{var $,v,E,N,U,Y,ot;typeof((E=(v=($=this.option)==null?void 0:$.bottomControls)==null?void 0:v.filter)==null?void 0:E.callback)=="function"&&this.option.bottomControls.filter.callback();let L=()=>Array.from(r.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),M=_.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");h.text(M).includes("取消")?(L().forEach(W=>{h.show(W,false);}),h.text(M,"过滤")):new vr({title:((U=(N=this.option.bottomControls)==null?void 0:N.filter)==null?void 0:U.title)??"过滤规则",filterOption:((ot=(Y=this.option.bottomControls)==null?void 0:Y.filter)==null?void 0:ot.option)||[],execFilterCallBack(){h.text(M,"取消过滤");},getAllRuleInfo:()=>L().map(I=>({data:this.parseRuleItemElement(I).data,$el:I}))}).showView();}},other:{enable:((C=(g=(m=this.option)==null?void 0:m.bottomControls)==null?void 0:g.clear)==null?void 0:C.enable)||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:B=>{let _=Z.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async L=>{var $,v,E;if(u.success("清空所有"),typeof((E=(v=($=this.option)==null?void 0:$.bottomControls)==null?void 0:v.clear)==null?void 0:E.callback)=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){k.error("清理失败");return}else k.success("清理成功");await this.updateDeleteAllBtnText(r.$shadowRoot),this.clearContent(r.$shadowRoot),_.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${Z.config.cssText.panelCSS}
...
`)}
			...
			`);let t=f.getValue("bili-video-artplayer-controlsPadding-left-right",0);t!=0&&O(`
				@media (orientation: landscape) {
      ...
      `;}async function B(y){const A=y.querySelector(".comment-container .reply-header .nav-sort"),D=A.querySelector(".hot-sort"),F=A.querySelector(".time-sort");A.classList.add("hot"),A.classList.remove("time"),D.addEventListener("click",S=>{S.stopPropagation(),S.preventDefault(),p!==s.HOT&&(p=s.HOT,A.classList.add("hot"),A.classList.remove("time"),y.scrollTo(0,0),_(y));}),F.addEventListener("click",S=>{S.stopPropagation(),S.preventDefault(),p!==s.LATEST&&(p=s.LATEST,A.classList.add("time"),A.classList.remove("hot"),y.scrollTo(0,0),_(y));});}async function _(y){var R,j,J,gt,mt;c={1:'{"offset":""}'};const{data:A,code:D}=await L(1);if(a=A.upper.mid,l.innerHTML="",m={},(R=document.querySelector(".comment-container .reply-warp .no-more-replies-info"))==null||R.remove(),(j=document.querySelector(".comment-container .reply-warp .anchor-for-loading"))==null||j.remove(),D!==0){const G=D===12061?"UP主已关闭评论区":"无法从API获取评论数据";l.innerHTML=`<p style="padding: 100px 0; text-align: center; color: #999;">${G}</p>`;return}const F=y.querySelector(".comment-container .reply-header .total-reply"),S=parseInt((J=A==null?void 0:A.cursor)==null?void 0:J.all_count)||0;if(F.textContent=S,(mt=(gt=A==null?void 0:A.cursor)==null?void 0:gt.name)!=null&&mt.includes("精选")){const G=y.querySelector(".comment-container .reply-header .nav-sort");G.innerHTML='<div class="selected-sort">精选评论</div>';}if(p===s.HOT&&(p=s.LATEST,A.top_replies=await L(1).then(G=>G.data.top_replies),p=s.HOT),A.top_replies&&A.top_replies.length!==0){const G=A.top_replies[0];M(G,true);}if(A.replies.length===0){const G=document.createElement("p");G.classList.add("no-more-replies-info"),G.style="padding-bottom: 100px; text-align: center; color: #999;",G.textContent="没有更多评论",document.querySelector(".comment-container .reply-warp").appendChild(G);return}for(const G of A.replies)M(G);W();}async function L(y){const A={oid:i,type:o,wts:parseInt(Date.now()/1e3)};if(p===s.HOT)return A.mode=3,A.pagination_str=`{"offset":"{\\"type\\":1,\\"data\\":{\\"pn\\":${y}}}"}`,await fetch(`https://api.bilibili.com/x/v2/reply/wbi/main?${await be(A)}`).then(D=>D.json());if(p===s.LATEST){A.mode=2,A.pagination_str=c[y];const D=await fetch(`https://api.bilibili.com/x/v2/reply/wbi/main?${await be(A)}`).then(F=>F.json());if(D.code===0){const F=D.data.cursor.pagination_reply.next_offset,S=F?JSON.parse(F).Data.cursor:-1;c[y+1]=`{"offset":"{\\"type\\":3,\\"data\\":{\\"cursor\\":${S}}}"}`;}else D.data=D.data||{};return D}}function M(y,A){if(m[y.rpid_str])return;const D=document.createElement("div");D.classList.add("reply-item"),D.innerHTML=`
          ...
          <div class="content-warp">
            ...
            <div class="root-reply">
              ...
              <div class="reply-tag-list">
                ${y.card_label?y.card_label.reduce((j,J)=>j+`<span class="reply-tag-item ${J.text_content==="热评"?"reply-tag-hot":""} ${J.text_content==="UP主觉得很赞"?"reply-tag-liked":""}" style="font-size: 12px; background-color: ${J.label_color_day}; color: ${J.text_color_day};">${J.text_content}</span>`,""):""}
              </div>
            </div>
          </div>
        </div>
      ...
      `,l.appendChild(D),m[y.rpid_str]=true;const F=D.querySelector(".preview-image-container");F&&new lr(F,{title:false,toolbar:false,tooltip:false,keyboard:false});const S=D.querySelector(".sub-reply-list"),R=D.querySelector(".view-more-btn");R&&R.addEventListener("click",()=>Y(y.rpid,S,y.rcount,1));}function $(y){const A=new Date(y*1e3),D=A.getFullYear(),F=(A.getMonth()+1).toString().padStart(2,"0"),S=A.getDate().toString().padStart(2,"0"),R=A.getHours().toString().padStart(2,"0"),j=A.getMinutes().toString().padStart(2,"0");return `${D}-${F}-${S} ${R}:${j}`}function v(y){return {0:"#C0C0C0",1:"#BBBBBB",2:"#8BD29B",3:"#7BCDEF",4:"#FEBB8B",5:"#EE672A",6:"#F04C49"}[y]}function E(y){let A=y.message;const D=["https://www.bilibili.com/video/av","https://b23.tv/mall-"];if(y.vote&&y.vote.deleted===false){const F=`<a class="jump-link normal" href="${y.vote.url}" target="_blank" noopener noreferrer>${y.vote.title}</a>`;D.push(F),A=A.replace(`{vote:${y.vote.id}}`,F);}if(y.emote)for(const[F,S]of Object.entries(y.emote)){const R=`<img class="emoji-${["","small","large"][S.meta.size]}" src="${S.url}" alt="${F}">`;D.push(R),A=A.replaceAll(F,R);}if(A=A.replaceAll(/(\d{1,2}[:：]){1,2}\d{1,2}/g,F=>{if(F=F.replaceAll("：",":"),!e.test(t.location.href))return F;const S=F.split(":");if(S.some(J=>parseInt(J)>=60))return F;let R;if(S.length===2?R=parseInt(S[0])*60+parseInt(S[1]):S.length===3&&(R=parseInt(S[0])*3600+parseInt(S[1])*60+parseInt(S[2])),Number.isNaN(R))return F;const j=`<a class="jump-link video-time" onclick="(async () => {
          // jump to exact time
        ...
        })()">${F}</a>`;return D.push(j),j}),y.at_name_to_mid)for(const[F,S]of Object.entries(y.at_name_to_mid)){const R=`<a class="jump-link user" data-user-id="${S}" href="https://space.bilibili.com/${S}" target="_blank" noopener noreferrer>@${F}</a>`;D.push(R),A=A.replaceAll(`@${F}`,R);}if(Object.keys(y.jump_url).length){const F=[].concat(Object.entries(y.jump_url).filter(S=>S[0].startsWith("https://")),Object.entries(y.jump_url).filter(S=>!S[0].startsWith("https://")));for(const[S,R]of F){const j=S.startsWith("BV")||/^av\d+$/.test(S)?`https://www.bilibili.com/video/${S}`:R.pc_url||S;if(j.includes("search.bilibili.com")&&D.join("").includes(S))continue;const J=`<img class="icon normal" src="${R.prefix_icon}" style="${R.extra&&R.extra.is_word_search&&"width: 12px;"}"><a class="jump-link normal" href="${j}" target="_blank" noopener noreferrer>${R.title}</a>`;D.push(J),A=A.replaceAll(S,J);}}return A}function N(y){let A="width: 84px; height: 84px;";y.length===1&&(A="max-width: 260px; max-height: 180px;"),y.length===2&&(A="width: 128px; height: 128px;");let D="";for(const F of y)D+=`<div class="image-item-wrap" style="margin-top: 4px; margin-right: 4px; cursor: zoom-in;"><img src="${F.img_src}" style="border-radius: 4px; ${A}"></div>`;return D}function U(y){if(!(y instanceof Array))return "";let A="";for(const D of y)A+=`
          <div class="sub-reply-item">
            ...
            <span class="reply-content-container sub-reply-content">
              <span class="reply-content">${E(D.content)}</span>
            </span>
...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof le=="function"?le(t.keyName):"";typeof e=="string"&&e?O(e):Bt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,h.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(r=>{e.onload=()=>{r(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()}},Ur={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"}};class qr{constructor(e){rt(this,"isBacking",false);rt(this,"config");this.config=e,this.enterGestureBackMode=this.enterGestureBackMode.bind(this),this.quitGestureBackMode=this.quitGestureBackMode.bind(this),this.popStateEvent=this.popStateEvent.bind(this),(typeof this.config.backDelayTime!="number"||isNaN(this.config.backDelayTime))&&(this.config.backDelayTime=150),this.config.win==null&&(this.config.win=self);}popStateEvent(e){d.preventEvent(e),!this.isBacking&&this.quitGestureBackMode(true);}enterGestureBackMode(){u.success("进入手势模式");let e=this.config.hash;e.startsWith("#")||(e.startsWith("/")||(e="/"+e),e="#"+e),this.config.useUrl&&(e=this.config.win.location.origin+this.config.win.location.pathname+this.config.win.location.search+e),this.config.win.history.pushState({},"",e),u.success("监听popstate事件"),h.on(this.config.win,"popstate",this.popStateEvent,{capture:true});}async quitGestureBackMode(e=false){u.success("退出手势模式"),this.isBacking=true,typeof this.config.beforeHistoryBackCallBack=="function"&&this.config.beforeHistoryBackCallBack(e);let r=Date.now()+1e3*5;for(;;){if(Date.now()>r){u.error("未知情况，history.back()失败，无法退出手势模式");break}if(this.config.win.location.hash.endsWith(this.config.hash))u.info("history.back()"),this.config.win.history.back(),await d.sleep(this.config.backDelayTime||150);else break}u.success("移除popstate事件"),h.off(this.config.win,"popstate",this.popStateEvent,{capture:true}),this.isBacking=false,typeof this.config.afterHistoryBackCallBack=="function"&&this.config.afterHistoryBackCallBack(e);}}const Gr={$data:{isAddBeautifyCSS:false,isInitCommentModule:false,isInitDescModule:false},init(){ne.init(),f.execMenuOnce("bili-video-cover-bottomRecommendVideo",()=>{this.coverBottomRecommendVideo();}),f.execMenuOnce("bili-video-cover-UpWrapper",()=>{this.coverUpWrapper();}),f.execMenuOnce("bili-video-cover-seasonNew",()=>{this.coverSeasonNew();}),h.ready(()=>{f.execMenu("bili-video-addCommentModule",()=>{this.addCommentModule();}),f.execMenu("bili-video-addDescModule",()=>{this.addDescModule();});});},beautify(){u.info("美化显示"),this.$data.isAddBeautifyCSS||(this.$data.isAddBeautifyCSS=true,O(`
			...
			`)),d.waitNode(x.className.video+" .bottom-tab .list-view .card-box",1e4).then(t=>{if(!t){u.error("$cardBox is null");return}function e(a){var c,m;let o=a.querySelector(".title"),l=a.querySelector(".count .left"),s=!!a.querySelector(".gm-right-container"),p=T.getVue(a);if(o&&l&&p&&!s){let g=(m=(c=p==null?void 0:p.info)==null?void 0:c.owner)==null?void 0:m.name;if(g==null){u.error("美化显示-handleVCardToApp：获取up主名字失败");return}a.querySelector(".count");let C=o.cloneNode(true),B=l.cloneNode(true);h.hide(o);let _=a.querySelector(".open-app.weakened");_&&h.hide(_);let L=document.createElement("div");L.className="gm-up-name",L.innerHTML=`
						...
						`;let v=document.createElement("div"),E=document.createElement("div");v.className="gm-right-container",E.className="gm-right-bottom",h.after(o,v),v.appendChild(_),v.appendChild(E),E.appendChild($),E.appendChild(L);}}let n=new d.LockFunction(()=>{let a=document.querySelectorAll(x.className.video+" .bottom-tab .list-view .card-box .v-card-toapp"),o=document.querySelectorAll(x.className.video+" .bottom-tab .list-view .card-box>a.v-card");a.forEach(l=>{e(l);}),o.forEach(l=>{r(l);});},25),i=document.querySelector(x.className.video);i?d.mutationObserver(i,{config:{subtree:true,attributes:true,childList:true},callback(){n.run();}}):u.error("未找到视频根节点");});},repairVideoBottomAreaHeight(){return u.info("修复视频底部区域高度"),O(`
		${x.className.video},
		${x.className.mVideo} {
			/* 修复视频区域底部的高度 */
	...
	height: 35vh;\r
			...
			`);let t=f.getValue("bili-bangumi-artplayer-controlsPadding-left-right",0);t!=0&&O(`
				@media (orientation: landscape) {
					.art-video-player .art-layers .art-layer-top-wrap,
					/* 底部 */
					.art-video-player .art-bottom{
...
`,rr={$flag_css:{enableOtherAreaSearchBangumi:false},init(){O(en),h.ready(()=>{f.execMenu("bili-search-enableOtherAreaSearchBangumi",()=>{this.enableOtherAreaSearchBangumi();});});},enableOtherAreaSearchBangumi(){this.$flag_css.enableOtherAreaSearchBangumi||(this.$flag_css.enableOtherAreaSearchBangumi=true,O(`

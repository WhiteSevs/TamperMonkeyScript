...
export const BilibiliHook = {
   ...
   */
  windowWebPack(webpackName = "webpackJsonp", mainCoreData: string[] | number[], checkCallBack: (arg: any) => void) {
  ...
  overRideBiliOpenApp() {
    ...
    utils.mutationObserver(document, {
      ...
      immediate: true,
      callback() {
        [...Array.from($$<HTMLDivElement>("bili-open-app")), ...Array.from($$<HTMLDivElement>("m-open-app"))].forEach(
          ($biliOpenApp) => {

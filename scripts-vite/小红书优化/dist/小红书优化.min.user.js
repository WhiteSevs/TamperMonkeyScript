    ...
    .author-box .author-desc-wrapper .author-desc .author-desc-trigger{
      display: none !important;
        ...
        *{
		...
		`)}},R={init(){a.execMenu("pc-xhs-hook-vue",()=>{X.webPackVue();}),a.execMenu("pc-xhs-allowCopy",()=>{R.allowPCCopy();}),a.execMenu("pc-xhs-open-blank-article",()=>{R.openBlankArticle();}),Se.init(),Ee.init();},allowPCCopy(){l.success("允许复制文字"),g.on(_,"copy",void 0,function(e){m.preventEvent(e);let t=_.getSelection();return t?m.setClip(t.toString()):l.error("未选中任何内容"),!1},{capture:!0});},openBlankArticle(){l.success("新标签页打开文章"),g.on(document,"click",".feeds-container .note-item",function(e){m.preventEvent(e);let o=e.target.querySelector("a[href]");o&&o.href?(l.info("跳转文章: "+o.href),window.open(o.href,"_blank")):b.error("未找到文章链接");},{capture:!0});}};w(`
.qmsg svg.animate-turn {
    fill: none;
}
`);a.init();let le=m.isPhone(),D="change_env_set",C=$(D);ie.add({key:D,text:`⚙ 自动: ${le?"移动端":"PC端"}`,autoReload:!1,isStoreValue:!1,showText(e){return C==null?e:e+` 手动: ${C==1?"移动端":C==2?"PC端":"未知"}`},callback:()=>{let e=[0,1,2],t=window.prompt(`请输入当前脚本环境判定

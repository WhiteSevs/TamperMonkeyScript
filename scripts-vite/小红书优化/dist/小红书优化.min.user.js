...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof Ce=="function"?Ce(t.keyName):null;typeof e=="string"&&e?P(e):B.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,O.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...t||[]);return n.forEach(i=>{i.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){n.forEach(i=>{i.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(i){navigator.clipboard.readText().then(o=>{i(o);}).catch(o=>{f.error("读取剪贴板内容失败👉",o),i("");});}function e(i){navigator.permissions.query({name:"clipboard-read"}).then(o=>{t(i);}).catch(o=>{f.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),t(i);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(i=>{if(!n()){i("");return}document.hasFocus()?e(i):window.addEventListener("focus",()=>{e(i);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,n=5e3){let i,o=n-e,l=e,a=async s=>{let r=await t(s);if(typeof r=="boolean"&&!r||s){g.workerClearTimeout(i);return}if(l+=e,l>o){a(true);return}i=g.workerSetTimeout(()=>{a(false);},e);};a(false);},findParentNode(t,e,n){if(n){let i=O.closest(t,n);if(i)return i.querySelector(e)}else return O.matches(t,e)?t:O.closest(t,e)}},y={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new g.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new g.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new g.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new g.Dictionary),this.__onceExecData},get scriptName(){return ye},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:Ie,attributeKeyName:U,attributeDefaultValueName:q},init(){this.initContentDefaultValue(),fe.init();},isTopWindow(){return _.top===_.self},initContentDefaultValue(){const t=i=>{if(!i.attributes||i.type==="button"||i.type==="forms"||i.type==="deepMenu")return;let o=i.attributes[Me];if(typeof o=="function"){let r=o();if(typeof r=="boolean"&&!r)return}let l=new Map,a=i.attributes[U];if(a!=null){const r=i.attributes[q];l.set(a,r);}let s=i.attributes[We];if(typeof s=="object"&&s&&Object.keys(s).forEach(r=>{l.set(r,s[r]);}),!l.size){f.warn(["请先配置键",i]);return}if(i.type==="switch"){let r=typeof i.disabled=="function"?i.disabled():i.disabled;typeof r=="boolean"&&r&&this.$data.contentConfigInitDisabledKeys.push(...l.keys());}for(const[r,u]of l.entries())this.setDefaultValue(r,u);},e=i=>{for(let o=0;o<i.length;o++){let l=i[o];t(l);let a=l.forms;a&&Array.isArray(a)&&e(a);}},n=[...ee.getAllContentConfig()];for(let i=0;i<n.length;i++){let o=n[i];if(!o.forms)continue;const l=o.forms;l&&Array.isArray(l)&&e(l);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(t,e){this.$data.contentConfigInitDefaultValue.has(t)&&f.warn("请检查该key(已存在): "+t),this.$data.contentConfigInitDefaultValue.set(t,e);},getDefaultValue(t){return this.$data.contentConfigInitDefaultValue.get(t)},setValue(t,e){K.set(t,e);},getValue(t,e){let n=K.get(t);return n??(this.$data.contentConfigInitDefaultValue.has(t)?this.$data.contentConfigInitDefaultValue.get(t):e)},deleteValue(t){K.delete(t);},hasKey(t){return K.has(t)},addValueChangeListener(t,e){return K.addValueChangeListener(t,(i,o,l)=>{e(t,l,o);})},removeValueChangeListener(t){K.removeValueChangeListener(t);},triggerMenuValueChange(t,e,n){K.triggerValueChangeListener(t,n,e);},exec(t,e,n,i=true){const o=this;let l;typeof t=="string"||Array.isArray(t)?l=()=>t:l=t;let a=false,s=l(),r=[];Array.isArray(s)?(a=true,r=s):r.push(s);let u=r.find(v=>!this.$data.contentConfigInitDefaultValue.has(v));if(u){f.warn(`${u} 键不存在`);return}let c=JSON.stringify(r);if(i&&this.$data.onceExecMenuData.has(c))return this.$data.onceExecMenuData.get(c);let p=[],d=[],h=(v,V)=>{let T=[];Array.isArray(V)||(V=[V]),V.forEach(C=>{if(C!=null&&C instanceof HTMLStyleElement){T.push(C);return}}),p=p.concat(T);},x=v=>this.getValue(v),w=()=>{for(let v=0;v<p.length;v++)p[v].remove(),p.splice(v,1),v--;},k=()=>{let v=false;return typeof n=="function"?v=n(r):v=r.every(V=>x(V)),v},M=v=>{let V=k(),T=[];if(V){let C=r.map($=>this.getValue($)),S=e({value:a?C:C[0],addStyleElement:(...$)=>h(true,...$)});Array.isArray(S)||(S=[S]),S.forEach($=>{if($!=null&&$ instanceof HTMLStyleElement){T.push($);return}});}w(),p=[...T];};i&&r.forEach(v=>{let V=this.addValueChangeListener(v,(T,C,S)=>{M();});d.push(V);}),M();let L={reload(){M();},clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),i&&o.$data.onceExecMenuData.delete(c);},clearStoreStyleElements:()=>w(),removeValueChangeListener:()=>{d.forEach(v=>{this.removeValueChangeListener(v);});}};return this.$data.onceExecMenuData.set(c,L),L},execMenu(t,e,n=false,i=false){return this.exec(t,o=>e(o),o=>o.every(a=>{let s=!!this.getValue(a);return y.$data.contentConfigInitDisabledKeys.includes(a)&&(s=false,f.warn(`.execMenu${i?"Once":""} ${a} 被禁用`)),n&&(s=!s),s}),i)},execMenuOnce(t,e,n=false,i=false){const o=this.execMenu(t,e,n,true);if(i&&o){const l=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(t),this.addUrlChangeWithExecMenuOnceListener(t,l);const a=o.clear;o.clear=()=>{a(),this.removeUrlChangeWithExecMenuOnceListener(t);};}return o},deleteExecMenuOnce(t){return t=this.transformKey(t),this.$data.onceExecMenuData.delete(t),this.$data.urlChangeReloadMenuExecOnce.delete(t),K.removeValueChangeListener(t)},onceExec(t,e){if(t=this.transformKey(t),typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},deleteOnceExec(t){t=this.transformKey(t),this.$data.onceExecData.delete(t);},addUrlChangeWithExecMenuOnceListener(t,e){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.set(t,e);},removeUrlChangeWithExecMenuOnceListener(t){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.delete(t);},triggerUrlChangeWithExecMenuOnceEvent(t){this.$data.urlChangeReloadMenuExecOnce.forEach((e,n)=>{e(t);});},showPanel(t,e=`${ye}-设置`,n=false,i=false){this.$data.$panel=null,this.$data.panelContent=[];let o=t.findIndex(a=>(typeof a.isBottom=="function"?a.isBottom():!!a.isBottom)&&a.id==="script-version")!==-1;!n&&!o&&t.push(...ee.getDefaultBottomContentConfig());let l=D.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(a,s)=>{a.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(a,s)=>{a(),this.$data.$panel=null;}},width:z.setting.width,height:z.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=l,this.$data.panelContent=t,i||this.registerConfigSearch({$panel:l,content:t});},registerConfigSearch(t){const{$panel:e,content:n}=t;let i=async(c,p)=>{if(c==null)return;let d=await p(c);return d&&typeof d.isFind=="boolean"&&d.isFind?d.data:await i(d.data,p)},o=(c,p)=>{const d=new IntersectionObserver(h=>{h.forEach(x=>{x.isIntersecting&&(p?.(),d.disconnect());});},{root:null,threshold:1});d.observe(c),c.scrollIntoView({behavior:"smooth",block:"center"});},l=c=>{const p="pops-flashing";m.animationend(c,()=>{c.classList.remove(p);}),c.classList.add(p);},a=(c,p)=>{m.preventEvent(c);let d=D.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${t.searchDialogStyle??""}
				`});d.$shadowRoot.querySelector(".search-wrapper");let h=d.$shadowRoot.querySelector(".search-config-text"),x=d.$shadowRoot.querySelector(".search-result-wrapper");h.focus();let w=()=>{m.empty(x);},k=L=>{const v=g.queryProperty(L,T=>T?.next?{isFind:false,data:T.next}:{isFind:true,data:T});let V=m.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return m.on(V,"click",T=>{let S=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[L.index];if(!S){b.error(`左侧项下标${L.index}不存在`);return}S.scrollIntoView({behavior:"smooth",block:"center"}),S.click(),i(L.next,async $=>{if($?.next){let E=await m.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(R=>{const N=Reflect.get(R,"__formConfig__");return typeof N=="object"&&N!=null&&N.text===$.name}),2500);if(E)E.click();else return b.error("未找到对应的二级菜单"),{isFind:true,data:$};return {isFind:false,data:$.next}}else {let E=await m.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(R=>Reflect.get(R,"__formConfig__")===$.matchedData?.formConfig),2500);if(E){o(E);let R=E.closest(".pops-panel-forms-fold[data-fold-enable]");R&&(R.querySelector(".pops-panel-forms-fold-container").click(),await g.sleep(500)),o(E,()=>{l(E);});}else b.error("未找到对应的菜单项");return {isFind:true,data:$}}});}),V},M=L=>{const v=new RegExp(L,"i"),V=[],T=(S,$)=>{for(let E=0;E<S.length;E++){const R=S[E];let N=R.forms;if(N&&Array.isArray(N)){const H=g.deepClone($);if(R.type==="deepMenu"){const W=g.queryProperty(H,F=>F?.next?{isFind:false,data:F.next}:{isFind:true,data:F});W.next={name:R.text};}T(N,H);}else {let H=Reflect.get(R,"text"),W=Reflect.get(R,"description");const F=[H,W];let oe=F.findIndex(Z=>{if(typeof Z=="string")return Z.match(v)});if(oe!==-1){const Z=g.deepClone($),_e=g.queryProperty(Z,G=>G?.next?{isFind:false,data:G.next}:{isFind:true,data:G});_e.next={name:H,matchedData:{path:"",formConfig:R,matchedText:F[oe],description:W}};const ke=[];g.queryProperty(Z,G=>{const me=G?.name;return typeof me=="string"&&me.trim()!==""&&ke.push(me),G?.next?{isFind:false,data:G.next}:{isFind:true,data:G}});const Oe=ke.join(B.escapeHtml(" - "));_e.next.matchedData.path=Oe,V.push(Z);}}}};for(let S=0;S<n.length;S++){const $=n[S];if(!$.forms||$.isBottom&&$.id==="script-version")continue;const E=$.forms;if(E&&Array.isArray(E)){let R=$.title;typeof R=="function"&&(R=R()),T(E,{index:S,name:R});}}let C=document.createDocumentFragment();for(const S of V){let $=k(S);C.appendChild($);}w(),x.append(C);};m.on(h,"input",g.debounce(L=>{m.preventEvent(L);let v=m.val(h).trim();if(v===""){w();return}M(v);},200));},s=null,r=false,u;m.on(e.$shadowRoot,"dblclick","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",a),m.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(c,p)=>{clearTimeout(u),u=void 0,r&&s===p?(r=false,s=null,a(c)):(u=setTimeout(()=>{r=false;},200),r=true,s=p);},{capture:true}),e.$shadowRoot.appendChild(m.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`,be={init(){P(Qe),(y.getValue("little-red-book-hijack-webpack-mask")||y.getValue("little-red-book-hijack-webpack-scheme"))&&(f.info("劫持webpack"),xe.setTimeout(),xe.call()),y.execMenuOnce("little-red-book-shieldBottomSearchFind",()=>le.blockBottomSearchFind()),y.execMenuOnce("little-red-book-shieldBottomToorBar",()=>le.blockBottomToorBar()),y.execMenuOnce("little-red-book-optimizeImageBrowsing",()=>{be.optimizeImageBrowsing();}),y.execMenuOnce("little-red-book-optimizeVideoNoteDesc",()=>Ze.optimizeVideoNoteDesc()),y.execMenuOnce("little-red-book-shieldAuthorHotNote",()=>le.blockAuthorHotNote()),y.execMenuOnce("little-red-book-shieldHotRecommendNote",()=>le.blockHotRecommendNote()),m.ready(function(){y.execMenu("little-red-book-optimizeCommentBrowsing",()=>{be.optimizeCommentBrowsing();});});},optimizeCommentBrowsing(){f.info("优化评论浏览");const t={QmsgLoading:void 0,scrollFunc:void 0,noteId:"",xsec_token:"",noteData:{},commentData:{},emojiMap:{},emojiNameList:[],currentCursor:void 0,commentContainer:void 0,init(){this.emojiMap=g.toJSON(_.localStorage.getItem("redmoji"))?.redmojiMap||{},this.emojiNameList=Object.keys(this.emojiMap),this.scrollFunc=new g.LockFunction(this.scrollEvent,this);const e=_.__INITIAL_STATE__,n=e.noteData??e.data.noteData;t.noteData=n.data.noteData,t.commentData=n.data.commentData,t.noteId=t.noteData.noteId,t.xsec_token=e.noteData.routeQuery.xsec_token,f.info(["笔记数据",t.noteData]),f.info(["评论数据",t.commentData]);},getCommentHTML(e){return `
					...
					<div class="little-red-book-comments-author-wrapper">
						...
						<div class="little-red-book-comments-info">
							<div class="little-red-book-comments-info-date">
								<span class="little-red-book-comments-create-time">${g.formatTime(e.create_time)}</span>
								<span class="little-red-book-comments-location">${e.ip_location}</span>
							</div>
						</div>
					</div>
				</div>
            `},getCommentElement(e){let n=e.content,i=e.create_time||parseInt(e.time),o=e.id,l=e.ip_location||e.ipLocation,a=e.sub_comment_has_more,s=parseInt(e.sub_comment_count)||0,r=e.sub_comment_cursor,u=e.sub_comments||e.subComments,c=(e.user_info||e.user).image,p=(e.user_info||e.user).nickname,d=e?.user_info?.user_id||e?.user?.userId;n=t.converContent(n);let h=m.createElement("div",{className:"little-red-book-comments-item",innerHTML:`
					<div class="little-red-book-comments-parent">
					${t.getCommentHTML({user_id:d,user_avatar:c,user_nickname:p,content:n,create_time:i,ip_location:l})}
					</div>
					`});if(a&&Array.isArray(u)&&(u.forEach(x=>{let w=m.createElement("div",{className:"little-red-book-comments-reply-container",innerHTML:t.getCommentHTML({user_id:x.user_info.user_id,user_avatar:x.user_info.image,user_nickname:x.user_info.nickname,content:t.converContent(x.content),create_time:x.create_time,ip_location:x.ip_location})});h.appendChild(w);}),s!==u.length)){let x=s-u.length,w=r,k=m.createElement("div",{className:"little-red-book-comments-reply-show-more",innerText:`展开 ${x} 条回复`});async function M(){let L=b.loading("加载中，请稍后..."),v=await Ve.getLzlPageInfo(t.noteId,o,10,w,void 0);L.close(),v&&(w=v.cursor,x=x-v.comments.length,k.innerText=`展开 ${x} 条回复`,v.comments.forEach(V=>{let T=m.createElement("div",{className:"little-red-book-comments-reply-container",innerHTML:t.getCommentHTML({user_id:V.user_info.user_id,user_avatar:V.user_info.image,user_nickname:V.user_info.nickname,content:t.converContent(V.content),create_time:V.create_time,ip_location:V.ip_location})});m.before(k,T);}),v.has_more||(m.off(k,"click",void 0,M,{capture:true}),k.remove()));}m.on(k,"click",void 0,M,{capture:true}),h.appendChild(k);}return h},converContent(e){return t.emojiNameList.forEach(n=>{e.includes(n)&&(e=e.replaceAll(n,`<img class="little-red-book-note-content-emoji" crossorigin="anonymous" src="${t.emojiMap[n]}">`));}),e},async scrollEvent(){if(!g.isNearBottom(window.innerHeight/3))return;this.QmsgLoading==null&&(this.QmsgLoading=b.loading("加载中，请稍后..."));let e=await Ve.getPageInfo(t.noteId,t.currentCursor,t.xsec_token);if(this.QmsgLoading&&(this.QmsgLoading.close(),this.QmsgLoading=void 0),!!e&&(t.currentCursor=e.cursor,e.comments.forEach(n=>{let i=t.getCommentElement(n);t.commentContainer.appendChild(i);}),!e.has_more)){b.info("已加载全部评论"),t.removeScrollEventListener();return}},addSrollEventListener(){f.success("添加滚动监听事件"),m.on(document,"scroll",void 0,t.scrollFunc.run,{capture:true,once:false,passive:true});},removeScrollEventListener(){f.success("移除滚动监听事件"),m.off(document,"scroll",void 0,t.scrollFunc.run,{capture:true});}};m.waitNode(".narmal-note-container").then(async()=>{f.info("优化评论浏览-笔记元素出现");let e=document.querySelector(".note-view-container"),n=m.createElement("div",{className:"little-red-book-comments-container",innerHTML:`
                <style>
          ...
          `});t.commentContainer=n,t.init();let i=m.createElement("div",{className:"little-red-book-comments-total",innerHTML:`共 ${t.commentData.commentCount??t.noteData.comments} 条评论`});n.appendChild(i),t.commentData&&t.commentData.comments&&(f.info("从固定的评论中加载"),t.commentData.comments.forEach(o=>{let l=t.getCommentElement(o);n.appendChild(l);})),m.append(e,n);});},optimizeImageBrowsing(){f.info("优化图片浏览"),B.setGMResourceCSS(Ke.Viewer);function t(e=[],n=0){let i="";e.forEach(a=>{i+=`<li><img data-src="${a}" loading="lazy"></li>`;});let o=m.createElement("ul",{innerHTML:i}),l=new Je(o,{inline:false,url:"data-src",zIndex:g.getMaxZIndex()+100,hidden:()=>{l.destroy();}});n=n<0?0:n,l.view(n),l.zoomTo(1),l.show();}m.on(document,"click",".note-image-box",function(e){let n=e.target,i=n.querySelector("img"),o=[],l=[];n.closest(".onix-carousel-item")?l=Array.from(n.closest(".onix-carousel-item").parentElement.querySelectorAll("img")):l=[i];let a=l.findIndex(s=>s==i);l.forEach(s=>{let r=s.getAttribute("src")||s.getAttribute("data-src")||s.getAttribute("alt");r&&o.push(r);}),f.success(["点击浏览图片👉",o[a]]),t(o,a);});}},De={init(){m.ready(()=>{y.execMenuOnce("little-red-book-repariClick",()=>{De.repariClick();});});},repariClick(){f.info("修复正确的点击跳转"),m.on(document,"click",void 0,function(t){let e=t.target;if(f.info(["点击的按钮元素",e]),e?.className?.includes("follow-btn"))f.success("点击-关注按钮");else if(e?.closest("button.reds-button.message-btn"))f.success("点击-私信按钮");else if(e?.closest("div.reds-tab-item"))f.success("点击-笔记/收藏按钮");else if(e?.closest("section.reds-note-card")){f.success("点击-笔记卡片");let n=e?.closest("section.reds-note-card");n.getAttribute("id")||g.toJSON(n.getAttribute("impression"))?.noteTarget?.value?.noteId?window.open(`https://www.xiaohongshu.com/discovery/item/${e?.closest("section.reds-note-card")?.getAttribute("id")}`,"_blank"):b.error("获取笔记note_id失败");}return m.preventEvent(t),false},{capture:true});}},we={init(){y.execMenuOnce("little-red-book-shieldAd",()=>(f.info("注入默认屏蔽CSS"),P(je))),y.execMenuOnce("little-red-book-allowCopy",()=>we.allowCopy()),ge.isArticle()?be.init():ge.isUserHome()&&De.init();},allowCopy(){return f.info("允许复制文字"),P(`
        *{
            -webkit-user-select: unset !important;
            user-select: unset !important;
        }
        `)}},Ye="",et={init(){y.execMenuOnce("pc-xhs-shieldAd",()=>P(Ye)),y.execMenuOnce("pc-xhs-shield-select-text-search-position",()=>this.blockSelectTextVisibleSearchPosition()),y.execMenuOnce("pc-xhs-shield-topToolbar",()=>this.blockTopToolbar()),m.ready(()=>{y.execMenuOnce("pc-xhs-shield-login-dialog",()=>{this.blockLoginContainer();});});},blockLoginContainer(){f.info("添加屏蔽登录弹窗CSS，监听登录弹窗出现"),B.addBlockCSS(".login-container"),g.mutationObserver(document.body,{config:{subtree:true,childList:true},callback:()=>{let t=document.querySelector(".login-container .icon-btn-wrapper");t&&(t.click(),f.success("登录弹窗出现，关闭"));}});},blockSelectTextVisibleSearchPosition(){return f.info("屏蔽选择文字弹出的搜索提示"),B.addBlockCSS(".search-position")},blockTopToolbar(){return f.info("【屏蔽】顶部工具栏"),[B.addBlockCSS("#headerContainer",".header-container"),P(`
			/* 主内容去除padding */
			#mfContainer{
			...
			`)]}},tt={getSearchUrl(t){return `https://www.xiaohongshu.com/search_result?keyword=${t}&source=web_explore_feed`}},re={getVue(t){if(t!=null)return t.__vue__||t.__Ivue__||t.__IVue__},getVue3(t){if(t!=null)return t.__vueParentComponent},waitVuePropToSet(t,e){Array.isArray(e)||(e=[e]);function n(){let i=null;return typeof t=="string"?i=m.selector(t):typeof t=="function"?i=t():t instanceof HTMLElement&&(i=t),i}e.forEach(i=>{typeof i.msg=="string"&&f.info(i.msg);function o(){let l=n();if(l==null)return {status:false,isTimeout:true,inst:null,$el:l};let a=re.getVue(l);if(a==null)return {status:false,isTimeout:false,inst:null,$el:l};let s=i.check(a,l);return s=!!s,{status:s,isTimeout:false,inst:a,$el:l}}g.waitVueByInterval(()=>n(),()=>o().status,250,1e4).then(l=>{let a=o();if(a.status){let s=a.inst;i.set(s,a.$el);}else typeof i.failWait=="function"&&i.failWait(a.isTimeout);});});},watchVuePropChange(t,e,n,i,o){let l=g.assign({immediate:true,deep:false},i||{});return new Promise(a=>{re.waitVuePropToSet(t,{check(s){return typeof s?.$watch=="function"},set(s){let r=null;typeof e=="function"?r=s.$watch(()=>e(s),(u,c)=>{n(s,u,c);},l):r=s.$watch(e,(u,c)=>{n(s,u,c);},l),a(r);},failWait:o});})},goToUrl(t,e,n=false){if(t==null){b.error("跳转Url: $vueNode为空"),f.error("跳转Url: $vueNode为空："+e);return}let i=re.getVue(t);if(i==null){b.error("获取vue属性失败",{consoleLogContent:true});return}let o=i.$router,l=true;if(f.info("即将跳转URL："+e),n&&(l=false),l)window.open(e,"_blank");else {if(e.startsWith("http")||e.startsWith("//")){e.startsWith("//")&&(e=window.location.protocol+e);let a=new URL(e);if(a.origin===window.location.origin)e=a.pathname+a.search+a.hash;else {f.info("不同域名，直接本页打开，不用Router："+e),window.location.href=e;return}}f.info("$router push跳转Url："+e),o.push(e);}},hookGestureReturnByVueRouter(t){function e(){f.success("触发popstate事件"),i(true);}function n(){f.success("监听地址改变"),t.vueInst.$router.history.push(t.hash),m.on(_,"popstate",e);}async function i(o=false){if(m.off(_,"popstate",e),!t.callback(o))for(;;)if(t.vueInst.$router.history.current.hash===t.hash)f.info("后退！"),t.vueInst.$router.back(),await g.sleep(250);else return}return n(),{resumeBack:i}}},Ae={init(){(y.getValue("pc-xhs-search-open-blank-btn")||y.getValue("pc-xhs-search-open-blank-keyboard-enter"))&&this.optimizationSearch(),y.execMenuOnce("pc-xhs-article-fullWidth",()=>this.fullWidth());},optimizationSearch(){function t(e,n=true){{let i=document.querySelector("#search-input");if(i){let o=i.value,l=tt.getSearchUrl(o);f.info("搜索内容: "+o),window.open(l,n?"_blank":"_self");}else b.error("未找到搜索的输入框");}}m.waitNode("#search-input").then(e=>{e.placeholder="搜索小红书",y.execMenu("pc-xhs-search-open-blank-keyboard-enter",()=>{m.listenKeyboard(e,"keydown",(n,i,o,l)=>{n==="Enter"&&!o.length&&(f.info("按下回车键"),m.preventEvent(l),e.blur(),t());});});}),m.waitNode("#search-input + .input-button .search-icon").then(e=>{y.execMenu("pc-xhs-search-open-blank-btn",()=>{m.on(e,"click",n=>{m.preventEvent(n),f.info("点击搜索按钮"),t();},{capture:true});});});},fullWidth(){f.info("笔记宽屏");let t=y.getValue("pc-xhs-article-fullWidth-widthSize",90);return P(`
		...
		`)},transformPublishTime(){f.info("转换笔记发布时间");let t=new g.LockFunction(()=>{Xe(".note-content:not([data-edit-date])").forEach(e=>{let n=re.getVue(e);if(!n)return;let i=n?._?.props?.note;if(i==null)return;let o=i.time,l=i.lastUpdateTime,a=i.ipLocation;if(typeof o=="number"){let s=[];s.push(`发布：${g.formatTime(o)}`),typeof l=="number"&&s.push(`修改：${g.formatTime(l)}`),typeof a=="string"&&g.isNotNull(a)&&s.push(a);let r=e.querySelector(".date");m.html(r,s.join("<br>")),e.setAttribute("data-edit-date","");}});});g.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{t.run();}});}},te={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new j.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,n){let i;this.hasStorageApi(t)?i=this.getStorageApi(t):i=n,this.setComponentsStorageApiProperty(e,i);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,I,e);}},nt=function(t,e,n,i,o,l="",a,s,r,u){let c={text:t,type:"input",isNumber:false,isPassword:false,attributes:{},props:{},description:i,afterAddToUListCallBack:r,getValue(){return this.props[I].get(e,n)},callback(p,d,h){this.props[I].set(e,d);},placeholder:l};return Reflect.set(c.attributes,U,e),Reflect.set(c.attributes,q,n),te.initComponentsStorageApi("input",c,{get(p,d){return y.getValue(p,d)},set(p,d){y.setValue(p,d);}}),c},A=function(t,e,n,i,o,l,a,s){let r={text:t,type:"switch",description:o,disabled:a,attributes:{},props:{},getValue(){return this.props[I].get(e,n)},callback(u,c){let p=!!c;f.success(`${p?"开启":"关闭"} ${t}`),this.props[I].set(e,p);},afterAddToUListCallBack:l};return Reflect.set(r.attributes,U,e),Reflect.set(r.attributes,q,n),te.initComponentsStorageApi("switch",r,{get(u,c){return y.getValue(u,c)},set(u,c){y.setValue(u,c);}}),r},Re=function(t,e,n,i,o,l,a="请至少选择一个选项",s,r){let u=[];typeof i=="function"?u=i():u=i;let c={text:t,type:"select-multiple",description:l,placeholder:a,attributes:{},props:{},getValue(){return this.props[I].get(e,n)},selectConfirmDialogDetails:s,callback(p){let d=this.props[I],h=[];p.forEach(x=>{h.push(x.value);}),f.info("多选-选择：",h),d.set(e,h);},data:u};return Reflect.set(c.attributes,U,e),Reflect.set(c.attributes,q,n),te.initComponentsStorageApi("select-multiple",c,{get(p,d){return y.getValue(p,d)},set(p,d){y.setValue(p,d);}}),c},Ee=function(t,e,n,i,o,l="",a,s){let r={text:t,type:"textarea",attributes:{},props:{},description:i,placeholder:l,disabled:a,getValue(){let c=this.props[I].get(e,n);return Array.isArray(c)?c.join(`
`):c},callback(u,c){this.props[I].set(e,c);}};return Reflect.set(r.attributes,U,e),Reflect.set(r.attributes,q,n),te.initComponentsStorageApi("switch",r,{get(u,c){return y.getValue(u,c)},set(u,c){y.setValue(u,c);}}),r};class it{option;constructor(e){this.option=e;}getAllRule(){return pe(this.option.STORAGE_API_KEY,[])}setAllRule(e){de(this.option.STORAGE_API_KEY,e);}clearAllRule(){this.setAllRule([]);}getRule(e){let n=this.getAllRule(),i=n.findIndex(o=>o.uuid===e);if(i!==-1)return n[i]}setRule(e){let n=this.getAllRule(),i=n.findIndex(l=>l.uuid===e.uuid),o=false;return i!==-1&&(n[i]=e,this.setAllRule(n),o=true),o}addRule(e){let n=this.getAllRule(),i=n.findIndex(l=>l.uuid===e.uuid),o=false;return i!==-1||(n.push(e),this.setAllRule(n),o=true),o}updateRule(e){let n=this.getAllRule(),i=n.findIndex(o=>o.uuid===e.uuid);i!==-1?n[i]=e:n.push(e),this.setAllRule(n);}deleteRule(e){let n=this.getAllRule(),i=typeof e=="string"?e:e.uuid,o=n.findIndex(l=>l.uuid===i);return o!==-1?(n.splice(o,1),this.setAllRule(n),true):false}importRules(e){let n=D.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            ...
            `}),i=n.$shadowRoot.querySelector(".btn-control[data-mode='local']"),o=n.$shadowRoot.querySelector(".btn-control[data-mode='network']"),l=n.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),a=async r=>{let u=this.getAllRule(),c=[],p=[],d=false;for(let x=0;x<r.length;x++){const w=r[x];let k=u.findIndex(M=>M.uuid===w.uuid);k!==-1?p.push({index:k,data:w}):c.push(w);}if(p.length&&await new Promise(w=>{D.alert({title:{text:"覆盖规则",position:"center"},content:{text:`存在相同的uuid的规则 ${p.length}条，是否进行覆盖？`,html:true},btn:{close:{callback(k,M){k.close(),w(false);}},ok:{text:"覆盖",callback(k,M){k.close(),w(true);}}},width:z.info.width,height:z.info.height,mask:{enable:true},drag:true});})){for(const w of p)u[w.index]=w.data;d=true;}c.length&&(u=u.concat(c)),this.setAllRule(u);let h=`共 ${r.length} 条规则，新增 ${c.length} 条，覆盖 ${d?p.length:0} 条`;b.success(h),e?.();},s=r=>new Promise(async u=>{let c=g.toJSON(r);if(!Array.isArray(c)){f.error(c),b.error("导入失败，格式不符合（不是数组）",{consoleLogContent:true}),u(false);return}if(!c.length){b.error("导入失败，解析出的数据为空",{consoleLogContent:true}),u(false);return}await a(c),u(true);});m.on(i,"click",r=>{m.preventEvent(r),n.close();let u=m.createElement("input",{type:"file",accept:".json"});m.on(u,["propertychange","input"],c=>{if(!u.files?.length)return;let p=u.files[0],d=new FileReader;d.onload=()=>{s(d.result);},d.readAsText(p,"UTF-8");}),u.click();}),m.on(o,"click",r=>{m.preventEvent(r),n.close();let u=D.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(d,h){d.close();}},ok:{text:"导入",callback:async(d,h)=>{let x=d.text;if(g.isNull(x)){b.error("请填入完整的url");return}let w=b.loading("正在获取配置..."),k=await Y.get(x,{allowInterceptConfig:false});if(w.close(),!k.status){f.error(k),b.error("获取配置失败",{consoleLogContent:true});return}await s(k.data.responseText)&&d.close();}},cancel:{enable:false}},mask:{enable:true},drag:true,width:z.info.width,height:"auto"}),c=u.$shadowRoot.querySelector("input"),p=u.$shadowRoot.querySelector(".pops-prompt-btn-ok");m.on(c,["input","propertychange"],d=>{m.val(c)===""?m.attr(p,"disabled","true"):m.removeAttr(p,"disabled");}),m.listenKeyboard(c,"keydown",(d,h,x)=>{d==="Enter"&&x.length===0&&m.val(c)!==""&&m.trigger(p,"click");}),m.trigger(c,"input");}),m.on(l,"click",async r=>{m.preventEvent(r),n.close();let u=await g.getClipboardInfo();if(u.error!=null){b.error(u.error.toString());return}if(u.content.trim()===""){b.warning("获取到的剪贴板内容为空");return}await s(u.content);});}exportRules(e="rule.json"){let n=this.getAllRule(),i=new Blob([JSON.stringify(n,null,4)]),o=globalThis.URL.createObjectURL(i),l=document.createElement("a");l.href=o,l.download=e,l.click(),setTimeout(()=>{globalThis.URL.revokeObjectURL(o);},1500);}}class ot{option;constructor(e){this.option=e;}async showView(){let e=D.confirm({title:{text:this.option.title,position:"center"},content:{text:`
			...
			`});Reflect.set(o,"data-rule",e);let l="pops-panel-switch-is-checked";const{$enable:a,$enableSwitch:s,$enableSwitchCore:r,$enableSwitchInput:u,$delete:c,$edit:p}=this.parseRuleItemElement(o);return this.option.itemControls.enable.enable?(m.on(r,"click",async d=>{let h=false;s.classList.contains(l)?(s.classList.remove(l),h=false):(s.classList.add(l),h=true),u.checked=h,await this.option.itemControls.enable.callback(e,h);}),await this.option.itemControls.enable.getEnable(e)&&s.classList.add(l)):a.remove(),this.option.itemControls.edit.enable?m.on(p,"click",d=>{m.preventEvent(d),this.showEditView(true,e,n,o,h=>{e=null,e=h;});}):p.remove(),this.option.itemControls.delete.enable?m.on(c,"click",d=>{m.preventEvent(d);let h=D.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async x=>{f.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(e)?(b.success("成功删除该数据"),o.remove(),await this.updateDeleteAllBtnText(n),h.close()):b.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):c.remove(),o}async appendRuleItemElement(e,n){let{$container:i}=this.parseViewElement(e),o=[],l=Array.isArray(n)?n:[n];for(let a=0;a<l.length;a++){let s=l[a],r=await this.createRuleItemElement(s,e);i.appendChild(r),o.push(r);}return await this.updateDeleteAllBtnText(e),o}async updateRuleContaienrElement(e){this.clearContent(e);const{$container:n}=this.parseViewElement(e);let i=await this.option.data();await this.appendRuleItemElement(e,i),await this.updateDeleteAllBtnText(e);}async updateRuleItemElement(e,n,i){let o=await this.createRuleItemElement(e,i);n.after(o),n.remove();}clearContent(e){const{$container:n}=this.parseViewElement(e);m.html(n,"");}setDeleteBtnText(e,n,i=false){const{$deleteBtn:o}=this.parseViewElement(e);i?m.html(o,n):m.text(o,n);}async updateDeleteAllBtnText(e){let n=await this.option.data();this.setDeleteBtnText(e,`清空所有(${n.length})`);}}const at={__ajaxHooker:null,get ajaxHooker(){return this.__ajaxHooker==null&&(this.__ajaxHooker=g.ajaxHooker()),this.__ajaxHooker}};class st{parseInfoDictData(e,n=false){let i=e?.note_card,o=e.id,l=i.display_title,a=!!i?.interact_info?.liked,s=0,r=e?.note_card?.interact_info?.liked_count;typeof r=="string"&&(s=parseInt(r),isNaN(s)&&(s=0));let u=i?.user?.nick_name||i?.user?.nickname,c=i?.user?.user_id,p=i?.type==="video",d=i?.video?.capa?.duration||0;return {articleId:o,display_title:l,isLike:a,liked_count:s,nick_name:u,user_id:c,isVideo:p,videoDuration:d}}checkFilterWithRule(e){if(e.infoValue==null||e.ruleValue==null)return  false;if(typeof e.infoValue=="string"){if(e.infoValue.match(e.ruleValue))return  true}else if(typeof e.infoValue=="object"){if(Array.isArray(e.infoValue)&&e.infoValue.find(i=>typeof i=="string"&&e.ruleValue!=null?!!i.match(e.ruleValue):false))return  true}else if(typeof e.infoValue=="number"){if(typeof e.ruleValue=="string"){let n=e.ruleValue.trim(),i=n.match(/(\d+)/);if(!i)return f.warn("过滤器-解析比较大小的数字失败: ",e),false;let o=Number(i[1]);if(n.startsWith(">")){if(n.startsWith(">=")){if(e.infoValue>=o)return  true}else if(e.infoValue>o)return  true}else if(n.startsWith("<")){if(n.startsWith("<=")){if(e.infoValue<=o)return  true}else if(e.infoValue<o)return  true}else if(n.startsWith("=")){if(e.infoValue===o)return  true}else return f.warn("视频过滤器-未经允许的比较符号: ",e),false}}else if(typeof e.infoValue=="boolean"&&typeof e.ruleValue=="string"){let n=e.ruleValue.trim();return e.infoValue.toString()===n}return  false}checkInfoIsFilter(e,n){let i=this.parseInfoDictData(n),o=false,l=null;e:for(let a=0;a<e.length;a++){const s=e[a],r=Array.isArray(s.data.ruleName)?s.data.ruleName:[s.data.ruleName];for(let u=0;u<r.length;u++){const c=r[u];if(!Reflect.has(i,c))continue;let p=c,d=i[p],h={infoKey:p,infoValue:d,ruleKey:s.data.ruleName,ruleValue:s.data.ruleValue};if(o=this.checkFilterWithRule(h),o)if(Array.isArray(s.dynamicData)&&s.dynamicData.length){let x=[];for(let w=0;w<s.dynamicData.length;w++){const k=s.dynamicData[w];let M=k.ruleName,L=i[M],v={infoKey:M,infoValue:L,ruleKey:k.ruleName,ruleValue:k.ruleValue};x.push(v);let V=this.checkFilterWithRule(v);if(o=o&&V,!o)break}o&&f.success([`视频过滤器-多组 ==> ${s.name}`,i,h,x,n,s]);}else f.success([`视频过滤器 ==> ${s.name}`,i,h,n,s]);if(o){l=s;break e}}}return {isFilter:o,matchedFilterOption:l,transformInfo:i,info:n}}removeArticle(...e){if(e.length===1){let n=e[0];n!=null&&n instanceof Element&&n.remove();}else if(e.length===2){let n=e[0],i=e[1];if(typeof i=="number"){let o=n[i];o!=null&&o instanceof Element&&o.remove(),n.splice(i,1);}}}}const ae={$key:{ENABLE_KEY:"shieldVideo-exec-network-enable"},$data:{isFilterAwemeInfoList:new j.Dictionary,articleInfoMap:new j.Dictionary,__videoFilterRuleStorage:null,get videoFilterRuleStorage(){return this.__videoFilterRuleStorage==null&&(this.__videoFilterRuleStorage=new it({STORAGE_API_KEY:"xhs-article-filter-rule"})),this.__videoFilterRuleStorage},get isReverse(){return y.getValue("xhs-article-filter-only-show-filtered-video")}},init(){this.execFilter();},execFilter(){y.execMenuOnce(this.$key.ENABLE_KEY,async()=>{f.info("执行笔记过滤器");let t=new st,e=o=>{if(this.$data.isReverse&&(o.isFilter=!o.isFilter,typeof o.transformInfo.articleId=="string"&&o.matchedFilterOption)){let l=this.$data.isFilterAwemeInfoList.get(o.transformInfo.articleId)||[];l.push(o.matchedFilterOption),this.$data.isFilterAwemeInfoList.set(o.transformInfo.articleId,l);}typeof o.transformInfo.articleId=="string"&&this.$data.articleInfoMap.set(o.transformInfo.articleId,{articleInfo:o.info,transformArticleInfo:o.transformInfo});},n=o=>{if(!y.getValue(this.$key.ENABLE_KEY))return [];let l=this.$data.videoFilterRuleStorage.getAllRule();if(!l.length)return [];let a=Array.isArray(o)?o:[o];return l.filter(r=>r.enable&&(r.data.scope.includes("all")||Array.from(a).findIndex(u=>r.data.scope.includes(u))!==-1))},i=(o,l)=>{l.response=a=>{let s=n(o);if(!s.length)return;let r=g.toJSON(a.responseText),u=r?.data?.items;if(Array.isArray(u)){for(let c=0;c<u.length;c++){let p=u[c]||{},d=t.checkInfoIsFilter(s,p);e(d),d.isFilter&&t.removeArticle(u,c--);}a.responseText=JSON.stringify(r);}};};at.ajaxHooker.hook(o=>{let l=B.fixUrl(o.url);new URL(l).pathname.startsWith("/api/sns/web/v1/homefeed")&&i("xhr-explore",o);});});},getTemplateData(){return {uuid:g.generateUUID(),enable:true,name:"",data:{scope:[],ruleName:"display_title",ruleValue:"",remarks:""},dynamicData:[]}},showView(){this.getRuleViewInstance().showView();},getRuleViewInstance(){const t=this;let e=D.config.PanelHandlerComponents();function n(o){return {get(l,a){return o[l]??a},set(l,a){o[l]=a;}}}return new rt({title:"笔记过滤器",data:()=>this.$data.videoFilterRuleStorage.getAllRule(),getAddData:()=>this.getTemplateData(),getDataItemName:o=>o.name,updateData:o=>this.$data.videoFilterRuleStorage.setRule(o),deleteData:o=>this.$data.videoFilterRuleStorage.deleteRule(o),getData:o=>this.$data.videoFilterRuleStorage.getAllRule().find(s=>s.uuid===o.uuid)??o,itemControls:{enable:{enable:true,getEnable(o){return o.enable},callback:(o,l)=>{o.enable=l,this.$data.videoFilterRuleStorage.setRule(o);}},edit:{enable:true,getView:(o,l)=>{let a=document.createDocumentFragment();l||(o=this.getTemplateData());let s=A("启用","enable",true);Reflect.set(s.props,I,n(o));let r=e.createSectionContainerItem_switch(s),u=nt("规则名称","name","","",void 0,"必填");Reflect.set(u.props,I,n(o));let c=e.createSectionContainerItem_input(u),p=Re("作用域","scope",[],[{text:"所有",value:"all"},{text:"发现",value:"xhr-explore"}].map(C=>({...C,value:C.value})),void 0,"选择需要在xxx上生效的作用域");Reflect.set(p.props,I,n(o.data));let d=e.createSectionContainerItem_select_multiple_new(p),h=["display_title","isLike","liked_count","nick_name","user_id","isVideo","videoDuration"],x=C=>{let S=Array.isArray(C.ruleName)?C.ruleName:[C.ruleName],$=Re("属性名","ruleName",S,h.map(F=>({text:F,value:F})),void 0,"选择需要的属性名 ");Reflect.set($.props,I,n(C));let E=e.createSectionContainerItem_select_multiple_new($),R=Ee("属性值","ruleValue","","如果是字符串，可正则，注意转义");Reflect.set(R.props,I,n(C));let N=e.createSectionContainerItem_textarea(R),H=Ee("备注","remarks","","");Reflect.set(H.props,I,n(C));let W=e.createSectionContainerItem_textarea(H);return {$ruleName:E,$ruleValue:N,$remarks:W}},w=m.createElement("div",{className:"rule-form-ulist-dynamic",innerHTML:`
							...
							`}),k=w.querySelector(".rule-form-ulist-dynamic__inner"),M=w.querySelector(".pops-panel-button"),L=(C={ruleName:[],ruleValue:"",remarks:""})=>{let S=m.createElement("div",{className:"rule-form-ulist-dynamic__inner-container",innerHTML:`
								...
								`}),$=S.querySelector(".dynamic-control-delete");m.on($,"click",W=>{if(m.preventEvent(W),S.remove(),Array.isArray(o.dynamicData)){let F=o.dynamicData.findIndex(oe=>oe==C);F!==-1&&o.dynamicData.splice(F,1);}});let E=S.querySelector(".dynamic-forms"),{$ruleName:R,$ruleValue:N,$remarks:H}=x(C);E.appendChild(R),E.appendChild(N),E.appendChild(H),k.appendChild(S);};if(m.on(M,"click",C=>{m.preventEvent(C),L();}),Array.isArray(o.dynamicData))for(let C=0;C<o.dynamicData.length;C++){const S=o.dynamicData[C];L(S);}let{$ruleName:v,$ruleValue:V,$remarks:T}=x(o.data);return a.append(r,c,d,v,V,T,w),a},onsubmit:(o,l,a)=>{let s=o.querySelectorAll(".rule-form-ulist > li"),r=this.getTemplateData();return l&&(r.uuid=a.uuid),s.forEach(u=>{let c=Reflect.get(u,"__formConfig__");if(!c)return;let p=Reflect.get(c,"attributes");if(!p)return;let d=Reflect.get(u,I),h=Reflect.get(p,U),x=Reflect.get(p,q),w=d.get(h,x);Reflect.has(r,h)?Reflect.set(r,h,w):Reflect.has(r.data,h)?Reflect.set(r.data,h,w):f.error(`${h}不在数据中`);}),o.querySelectorAll(".rule-form-ulist-dynamic__inner-container").forEach(u=>{let c={};u.querySelectorAll(".dynamic-forms > li").forEach(p=>{let d=Reflect.get(p,"__formConfig__");if(!d)return;let h=Reflect.get(d,"attributes");if(!h)return;let x=Reflect.get(p,I),w=Reflect.get(h,U),k=Reflect.get(h,q),M=x.get(w,k);Reflect.set(c,w,M);}),r.dynamicData.push(c);}),r.name.trim()===""?(b.error("规则名称不能为空"),{success:false,data:r}):r.data.scope.length===0?(b.error("请选择作用域"),{success:false,data:r}):r.data.ruleName.length===0?(b.error("请选择属性名"),{success:false,data:r}):r.data.ruleValue.trim()===""?(b.error("属性值不能为空"),{success:false,data:r}):l?{success:t.$data.videoFilterRuleStorage.setRule(r),data:r}:{success:t.$data.videoFilterRuleStorage.addRule(r),data:r}},style:`

...
`,Q={init(){y(Pe),(d.getValue("little-red-book-hijack-webpack-mask")||d.getValue("little-red-book-hijack-webpack-scheme"))&&(u.info("劫持webpack"),X.setTimeout(),X.call()),d.execMenuOnce("little-red-book-shieldBottomSearchFind",()=>O.blockBottomSearchFind()),d.execMenuOnce("little-red-book-shieldBottomToorBar",()=>O.blockBottomToorBar()),d.execMenuOnce("little-red-book-optimizeImageBrowsing",()=>{Q.optimizeImageBrowsing();}),d.execMenuOnce("little-red-book-optimizeVideoNoteDesc",()=>Ve.optimizeVideoNoteDesc()),d.execMenuOnce("little-red-book-shieldAuthorHotNote",()=>O.blockAuthorHotNote()),d.execMenuOnce("little-red-book-shieldHotRecommendNote",()=>O.blockHotRecommendNote()),b.ready(function(){d.execMenu("little-red-book-optimizeCommentBrowsing",()=>{Q.optimizeCommentBrowsing();});});},optimizeCommentBrowsing(){u.info("优化评论浏览");const e={QmsgLoading:void 0,scrollFunc:void 0,noteId:"",xsec_token:"",noteData:{},commentData:{},emojiMap:{},emojiNameList:[],currentCursor:void 0,commentContainer:void 0,init(){var n;this.emojiMap=((n=m.toJSON(g.localStorage.getItem("redmoji")))==null?void 0:n.redmojiMap)||{},this.emojiNameList=Object.keys(this.emojiMap),this.scrollFunc=new m.LockFunction(this.scrollEvent,this);const t=g.__INITIAL_STATE__,o=t.noteData??t.data.noteData;e.noteData=o.data.noteData,e.commentData=o.data.commentData,e.noteId=e.noteData.noteId,e.xsec_token=t.noteData.routeQuery.xsec_token,u.info(["笔记数据",e.noteData]),u.info(["评论数据",e.commentData]);},getCommentHTML(t){return `
        ...
        *{
		...
		`)},transformPublishTime(){u.info("转换笔记发布时间");let e=new m.LockFunction(()=>{we(".note-content:not([data-edit-date])").forEach(t=>{var l,c;let o=V.getVue(t);if(!o)return;let n=(c=(l=o==null?void 0:o._)==null?void 0:l.props)==null?void 0:c.note;if(n==null)return;let s=n.time,i=n.lastUpdateTime,r=n.ipLocation;if(typeof s=="number"){let a=[];a.push(`发布：${m.formatTime(s)}`),typeof i=="number"&&a.push(`修改：${m.formatTime(i)}`),typeof r=="string"&&m.isNotNull(r)&&a.push(r);let f=t.querySelector(".date");b.html(f,a.join("<br>")),t.setAttribute("data-edit-date","");}});});m.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{e.run();}});}},W={init(){d.execMenuOnce("pc-xhs-hook-vue",()=>{X.webPackVue();}),d.execMenuOnce("pc-xhs-allowCopy",()=>{W.allowPCCopy();}),d.execMenuOnce("pc-xhs-open-blank-article",()=>{W.openBlankArticle();}),Ie.init(),d.execMenuOnce("pc-xhs-article-showPubsliushTime",()=>{ne.transformPublishTime();}),q.isArticle()&&(u.info("Router: 笔记页面"),ne.init());},allowPCCopy(){u.success("允许复制文字"),b.on(g,"copy",void 0,function(e){m.preventEvent(e);let t=g.getSelection();return t?m.setClip(t.toString()):u.error("未选中任何内容"),false},{capture:true});},openBlankArticle(){u.success("新标签页打开文章"),b.on(document,"click",".feeds-container .note-item",function(e){m.preventEvent(e);let o=e.target.querySelector("a.cover[href]");o&&o.href?(u.info("跳转文章: "+o.href),window.open(o.href,"_blank")):x.error("未找到文章链接");},{capture:true});}};y(`
.qmsg svg.animate-turn {
    fill: none;
}
`);d.init();let ue=m.isPhone(),N="change_env_set",C=P(N);ae.add({key:N,text:`⚙ 自动: ${ue?"移动端":"PC端"}`,autoReload:false,isStoreValue:false,showText(e){return C==null?e:e+` 手动: ${C==1?"移动端":C==2?"PC端":"未知"}`},callback:()=>{let e=[0,1,2],t=window.prompt(`请输入当前脚本环境判定

自动判断: 0
移动端: 1
PC端: 2`,"0");if(!t)return;let o=parseInt(t);if(isNaN(o)){x.error("输入的不是规范的数字");return}if(!e.includes(o)){x.error("输入的值必须是0或1或2");return}o==0?le(N):U(N,o);}});C!=null?(u.info(`手动判定为${C===1?"移动端":"PC端"}`),C==1?Z.init():C==2?W.init():(x.error("意外，手动判定的值不在范围内"),le(N))):ue?(u.info("自动判定为移动端"),Z.init()):(u.info("自动判定为PC端"),W.init());

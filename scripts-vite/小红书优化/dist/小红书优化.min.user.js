    ...
    .author-box .author-desc-wrapper .author-desc .author-desc-trigger{
      display: none !important;
        ...
        *{
		...
		`)}},U={init(){c.execMenuOnce("pc-xhs-hook-vue",()=>{Z.webPackVue();}),c.execMenuOnce("pc-xhs-allowCopy",()=>{U.allowPCCopy();}),c.execMenuOnce("pc-xhs-open-blank-article",()=>{U.openBlankArticle();}),Ve.init(),X.isArticle()&&(s.info("Router: 笔记页面"),Le.init());},allowPCCopy(){s.success("允许复制文字"),g.on(_,"copy",void 0,function(e){f.preventEvent(e);let t=_.getSelection();return t?f.setClip(t.toString()):s.error("未选中任何内容"),!1},{capture:!0});},openBlankArticle(){s.success("新标签页打开文章"),g.on(document,"click",".feeds-container .note-item",function(e){f.preventEvent(e);let o=e.target.querySelector("a.cover[href]");o&&o.href?(s.info("跳转文章: "+o.href),window.open(o.href,"_blank")):b.error("未找到文章链接");},{capture:!0});}};w(`

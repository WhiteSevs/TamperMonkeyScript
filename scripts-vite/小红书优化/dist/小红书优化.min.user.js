...
`)}{display: none !important;}`)},setGMResourceCSS(t){const e=typeof Re=="function"?Re(t.keyName):null;return typeof e=="string"&&e?j(e):P.loadStyleLink(t.url)},async loadStyleLink(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,new Promise(n=>{q.onReady(()=>{document.head.appendChild(e),n(e);});})},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...t||[]);return n.forEach(i=>{i.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){n.forEach(i=>{i.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(i){navigator.clipboard.readText().then(o=>{i(o);}).catch(o=>{h.error("读取剪贴板内容失败👉",o),i("");});}function e(i){navigator.permissions.query({name:"clipboard-read"}).then(()=>{t(i);}).catch(o=>{h.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),t(i);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(i=>{if(!n()){i("");return}document.hasFocus()?e(i):window.addEventListener("focus",()=>{e(i);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,n=5e3){let i,o=n-e,r=e,s=async u=>{const a=await t(u);if(typeof a=="boolean"&&a||u){y.workerClearTimeout(i);return}if(r+=e,r>o){s(true);return}i=y.workerSetTimeout(()=>{s(false);},e);};s(false);},findParentNode(t,e,n){if(n){let i=q.closest(t,n);if(i)return i.querySelector(e)}else return q.matches(t,e)?t:q.closest(t,e)},toStr(t){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(t,(i,o)=>o===void 0?e:o,2).replace(new RegExp(`"${e}"`,"g"),"undefined")},isVerticalScreen(){return !globalThis.screen.orientation.type.includes("landscape")},isMobileDevice(t=768){return this.isVerticalScreen()?globalThis.innerWidth<t:globalThis.innerHeight<t},isTopWindow(){const t=typeof k=="object"&&k!=null?k:window;return t.top===t.self}},y=K.noConflict(),f=q.noConflict(),O=ye,h=new y.Log(ie,k.console||Je.console),fe=ie?.script?.name||void 0,Ze=ye.config.Utils.AnyTouch(),Qe=false;h.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});w.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(t){const e=t.setting.type;if(e==="loading")return  false;const n=t.setting.content;return e==="warning"?h.warn(n):e==="error"?h.error(n):h.info(n),false},get position(){return x.getValue(ee.qmsg_config_position.key,ee.qmsg_config_position.defaultValue)},get maxNums(){return x.getValue(ee.qmsg_config_maxnums.key,ee.qmsg_config_maxnums.defaultValue)},get showReverse(){return x.getValue(ee.qmsg_config_showreverse.key,ee.qmsg_config_showreverse.defaultValue)},get zIndex(){let t=K.getMaxZIndex(),e=ye.config.InstanceUtils.getPopsMaxZIndex().zIndex;return K.getMaxValue(t,e)+100}});O.GlobalConfig.setGlobalConfig({zIndex:()=>{const t=K.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),e=ye.config.InstanceUtils.getPopsMaxZIndex().zIndex;return K.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Fe=new y.GM_Menu({GM_getValue:te,GM_setValue:se,GM_registerMenuCommand:Ge,GM_unregisterMenuCommand:Ke}),Y=new y.Httpx({xmlHttpRequest:ze,logDetails:Qe});Y.interceptors.request.use(t=>t);Y.interceptors.response.use(void 0,t=>(h.error("拦截器-请求错误",t),t.type==="onabort"?w.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?w.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?w.error("请求超时",{consoleLogContent:true}):w.error("其它错误",{consoleLogContent:true}),t));const Ee={Object:{defineProperty:k.Object.defineProperty,keys:k.Object.keys,values:k.Object.values},Function:{apply:k.Function.prototype.apply,call:k.Function.prototype.call},Element:{appendChild:k.Element.prototype.appendChild},setTimeout:k.setTimeout.bind(k),clearTimeout:k.clearTimeout.bind(k),setInterval:k.setInterval.bind(k),clearInterval:k.clearInterval.bind(k)},j=f.addStyle.bind(f),le=q.selector.bind(q),Ye=q.selectorAll.bind(q);new y.GM_Cookie;const he="GM_Panel",Be="data-init",W="data-key",G="data-default-value",et="data-init-more-value",tt="data-plugin-search-config",N="data-storage-api",Z={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},H={setting:{get width(){return Z.width<550?"88vw":Z.width<700?"550px":"700px"},get height(){return Z.height<450?"70vh":Z.height<550?"450px":"550px"}},settingMiddle:{get width(){return Z.width<350?"88vw":"350px"}},info:{get width(){return Z.width<350?"88vw":"350px"},get height(){return Z.height<250?"88vh":"250px"}}},ne={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new y.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let t=false,e;const n=(r,s)=>{typeof s!="string"&&(s=P.toStr(s));const u=new Blob([s]),a=globalThis.URL.createObjectURL(u);f.createElement("a",{href:a,download:r}).click(),y.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(a);},500);},i=()=>{const r=p=>{const d=O.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),m=d.$shadowRoot.querySelector(".btn-control[data-mode='local']"),g=d.$shadowRoot.querySelector(".btn-control[data-mode='network']"),v=d.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),C=async D=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof ce=="function"?typeof ae=="function"?(ce().forEach(_=>{ae(_);}),w.success("已清空脚本存储的配置")):w.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):w.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Ae=="function"?Ae(D):Object.keys(D).forEach(_=>{const b=D[_];se(_,b);}),w.success("配置导入完毕");},R=D=>new Promise(async V=>{const A=y.toJSON(D);Object.keys(A).length===0?w.warning("解析为空配置，不导入"):await C(A),V(true);});f.on(m,"click",D=>{f.preventEvent(D),d.close();const V=f.createElement("input",{type:"file",accept:".json"});f.on(V,["propertychange","input"],A=>{if(!V.files?.length)return;const _=V.files[0],b=new FileReader;b.onload=()=>{R(b.result);},b.readAsText(_,"UTF-8");}),V.click();}),f.on(g,"click",D=>{f.preventEvent(D),d.close();const V=O.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(b,I){b.close();}},ok:{text:"导入",callback:async(b,I)=>{const E=b.text;if(y.isNull(E)){w.error("请填入完整的url");return}const $=w.loading("正在获取配置..."),M=await Y.get(E,{allowInterceptConfig:false});if($.close(),!M.status){h.error(M),w.error("获取配置失败",{consoleLogContent:true});return}await R(M.data.responseText)&&b.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:H.info.width,height:"auto"}),A=V.$shadowRoot.querySelector("input"),_=V.$shadowRoot.querySelector(".pops-prompt-btn-ok");f.on(A,["input","propertychange"],b=>{f.val(A)===""?f.attr(_,"disabled","true"):f.removeAttr(_,"disabled");}),f.onKeyboard(A,"keydown",(b,I,E)=>{b==="Enter"&&E.length===0&&f.val(A)!==""&&f.emit(_,"click");}),f.emit(A,"input");}),f.on(v,"click",async D=>{f.preventEvent(D),d.close();let V=await P.getClipboardText();if(V.trim()===""){w.warning("获取到的剪贴板内容为空");return}await R(V);});},s=(p=`${fe}_panel-setting-${y.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,d)=>{const m=O.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(C,R){C.close();}}},drag:true,mask:{enable:true},width:H.info.width,height:H.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),g=m.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),v=m.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");f.on(g,"click",C=>{f.preventEvent(C);try{n(p,d),m.close();}catch(R){w.error(R.toString(),{consoleLogContent:true});}}),f.on(v,"click",async C=>{await y.copy(d)?(w.success("复制成功"),m.close()):w.error("复制失败");});},a=O.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(p,d){r();}},cancel:{enable:true,text:"导出",callback(p,d){s(void 0,c);}}},width:Z.width<450?"90vw":"450px",height:"auto",style:`
...
`,ue={allowCopy(){return h.info("允许复制"),j(`
        *{
        ...
        `)},blockBottomSearchFind(){return h.info("屏蔽底部搜索发现"),P.addBlockCSS(".hotlist-container",".safe-area-bottom.margin-placeholder")},blockBottomToorBar(){return h.info("屏蔽底部工具栏"),P.addBlockCSS(".engage-bar-container")},blockAuthorHotNote(){return h.info("屏蔽视频笔记的作者热门笔记"),P.addBlockCSS(".user-notes-box.user-notes-clo-layout-container")},blockHotRecommendNote(){return h.info("屏蔽视频笔记的热门推荐"),P.addBlockCSS("#new-note-view-container .recommend-box")}},rt={optimizeVideoNoteDesc(){return h.info("优化视频笔记的描述（可滚动）"),j(`
    ...
    .author-box .author-desc-wrapper .author-desc .author-desc-trigger{
      display: none !important;
        ...
        `});t.commentContainer=n,t.init();const i=f.createElement("div",{className:"little-red-book-comments-total",innerHTML:`共 ${t.commentData.commentCount??t.noteData.comments} 条评论`});n.appendChild(i),t.commentData&&t.commentData.comments&&(h.info("从固定的评论中加载"),t.commentData.comments.forEach(o=>{let r=t.getCommentElement(o);n.appendChild(r);})),f.append(e,n);});},optimizeImageBrowsing(){h.info("优化图片浏览");const t=function(i=[],o=0){let r="";i.forEach(a=>{r+=`<li><img data-src="${a}" loading="lazy"></li>`;});const s=f.createElement("ul",{innerHTML:r}),u=new ot(s,{inline:false,url:"data-src",zIndex:y.getMaxZIndex()+100,hidden:()=>{u.destroy();}});o=o<0?0:o,u.view(o),u.zoomTo(1),u.show();},e=(i,o)=>{let r=o.querySelector("img"),s=[],u=[];o.closest(".onix-carousel-item")?u=Array.from(o.closest(".onix-carousel-item").parentElement.querySelectorAll("img")):u=[r];let a=u.findIndex(l=>l==r);u.forEach(l=>{let c=l.getAttribute("src")||l.getAttribute("data-src")||l.getAttribute("alt");c&&s.push(c);}),h.success(["点击浏览图片👉",s[a]]),t(s,a);},n=f.on(document,"click",".note-image-box",e);return [P.setGMResourceCSS(Xe.Viewer),()=>{n.off();}]}},at=`/* 用户主页 */
/* 底部的-App内打开 */
...
`,He={init(){f.onReady(()=>{x.execMenuOnce("little-red-book-repariClick",()=>He.repariClick());});},repariClick(){h.info("修复正确的点击跳转");const t=n=>{const i=n.target;if(h.info(["点击的按钮元素",i]),i?.className?.includes("follow-btn"))h.success("点击-关注按钮");else if(i?.closest("button.reds-button.message-btn"))h.success("点击-私信按钮");else if(i?.closest("div.reds-tab-item"))h.success("点击-笔记/收藏按钮");else if(i?.closest("section.reds-note-card")){h.success("点击-笔记卡片");const o=i?.closest("section.reds-note-card"),r=o.getAttribute("id")||y.toJSON(o.getAttribute("impression"))?.noteTarget?.value?.noteId;r?window.open(`https://www.xiaohongshu.com/discovery/item/${r}`,"_blank"):w.error("获取笔记note_id失败");}return f.preventEvent(n),false},e=f.on(document,"click",t,{capture:true});return [()=>{e.off();}]}},Ce={init(){x.execMenuOnce("little-red-book-shieldAd",()=>(h.info("注入默认屏蔽CSS"),j(at))),x.execMenuOnce("little-red-book-allowCopy",()=>Ce.allowCopy()),ve.isArticle()?ke.init():ve.isUserHome()&&He.init();},allowCopy(){return h.info("允许复制文字"),j(`
        *{
		...
		`)},transformPublishTime(){h.info("转换笔记发布时间");const t=new y.LockFunction(()=>{Ye(".note-content:not([data-edit-date])").forEach(n=>{const i=de.getVue(n);if(!i)return;const o=i?._?.props?.note;if(o==null)return;const r=o.time,s=o.lastUpdateTime,u=o.ipLocation;if(typeof r=="number"){const a=[];a.push(`发布：${y.formatTime(r)}`),typeof s=="number"&&a.push(`修改：${y.formatTime(s)}`),typeof u=="string"&&y.isNotNull(u)&&a.push(u);const l=n.querySelector(".date");f.html(l,a.join("<br>")),n.setAttribute("data-edit-date","");}});}),e=y.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{t.run();}});return [()=>{e?.disconnect();}]}},st={__ajaxHooker:null,get ajaxHooker(){return this.__ajaxHooker==null&&(this.__ajaxHooker=y.ajaxHooker()),this.__ajaxHooker}},we=function(t,e,n,i,o,r,s,u,a,l){const c={text:t,type:"button",attributes:{},props:{},description:e,buttonIcon:i,buttonIsRightIcon:o,buttonIconIsLoading:r,buttonType:s,buttonText:n,callback(p){typeof u=="function"&&u(p);},afterAddToUListCallBack:a};return Reflect.set(c.attributes,Be,()=>{c.disable=false;}),c},me=function(t,e,n,i,o,r,s){const u={text:t,type:"select",description:r,attributes:{},props:{},getValue(){return this.props[N].get(e,n)},callback(a){if(a==null)return;const l=a.value;if(h.info(`选择：${a.text}`),typeof o=="function"&&o(a))return;this.props[N].set(e,l);},data:i};return Reflect.set(u.attributes,W,e),Reflect.set(u.attributes,G,n),oe.initComponentsStorageApi("select",u,{get(a,l){return x.getValue(a,l)},set(a,l){x.setValue(a,l);}}),u},De=function(t,e,n,i,o,r,s="请至少选择一个选项",u,a){let l=[];typeof i=="function"?l=i():l=i;const c={text:t,type:"select-multiple",description:r,placeholder:s,attributes:{},props:{},getValue(){return this.props[N].get(e,n)},selectConfirmDialogConfig:u,callback(p){const d=this.props[N],m=[];p.forEach(g=>{m.push(g.value);}),h.info("多选-选择：",m),d.set(e,m);},data:l};return Reflect.set(c.attributes,W,e),Reflect.set(c.attributes,G,n),oe.initComponentsStorageApi("select-multiple",c,{get(p,d){return x.getValue(p,d)},set(p,d){x.setValue(p,d);}}),c},Ne=function(t,e,n,i,o,r,s,u,a,l){const c={text:t,type:"slider",description:u,attributes:{},props:{},getValue(){return this.props[N].get(e,n)},getToolTipContent(p){return typeof s=="function"?s(p):`${p}`},callback(p,d){if(typeof r=="function"&&r(p,d))return;this.props[N].set(e,d);},min:i,max:o,step:a};return Reflect.set(c.attributes,W,e),Reflect.set(c.attributes,G,n),oe.initComponentsStorageApi("slider",c,{get(p,d){return x.getValue(p,d)},set(p,d){x.setValue(p,d);}}),c},L=function(t,e,n,i,o,r,s,u,a){const l={text:t,type:"switch",description:o,disabled:s,attributes:{},props:{},getValue(){return this.props[N].get(e,n)},callback(c,p){const d=!!p;h.success(`${d?"开启":"关闭"} ${t}`),this.props[N].set(e,d);},afterAddToUListCallBack:(...c)=>{}};return Reflect.set(l.attributes,W,e),Reflect.set(l.attributes,G,n),oe.initComponentsStorageApi("switch",l,{get(c,p){return x.getValue(c,p)},set(c,p){x.setValue(c,p);}}),l},Oe=function(t,e,n,i,o,r="",s,u){const a={text:t,type:"textarea",attributes:{},props:{},description:i,placeholder:r,disabled:s,getValue(){const c=this.props[N].get(e,n);return Array.isArray(c)?c.join(`
`):c},callback(l,c){this.props[N].set(e,c);}};return Reflect.set(a.attributes,W,e),Reflect.set(a.attributes,G,n),oe.initComponentsStorageApi("switch",a,{get(l,c){return x.getValue(l,c)},set(l,c){x.setValue(l,c);}}),a},oe={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new K.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,n){let i;this.hasStorageApi(t)?i=this.getStorageApi(t):i=n,this.setComponentsStorageApiProperty(e,i);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,N,e);}},ct=function(t,e,n,i,o,r="",s="text",u,a){const l={text:t,type:"input",inputType:s,attributes:{},props:{},description:i,placeholder:r,afterAddToUListCallBack:u,getValue(){return this.props[N].get(e,n)},callback(c,p){c.target.validity.valid,this.props[N].set(e,p);}};return Reflect.set(l.attributes,W,e),Reflect.set(l.attributes,G,n),oe.initComponentsStorageApi("input",l,{get(c,p){return x.getValue(c,p)},set(c,p){x.setValue(c,p);}}),l};class ut{option;constructor(e){this.option=e;}getAllRule(){return te(this.option.STORAGE_API_KEY,[])}setAllRule(e){se(this.option.STORAGE_API_KEY,e);}clearAllRule(){this.setAllRule([]);}getRule(e){const n=this.getAllRule(),i=n.findIndex(o=>o.uuid===e);if(i!==-1)return n[i]}setRule(e){const n=this.getAllRule(),i=n.findIndex(r=>r.uuid===e.uuid);let o=false;return i!==-1&&(n[i]=e,this.setAllRule(n),o=true),o}addRule(e){const n=this.getAllRule(),i=n.findIndex(r=>r.uuid===e.uuid);let o=false;return i!==-1||(n.push(e),this.setAllRule(n),o=true),o}updateRule(e){const n=this.getAllRule(),i=n.findIndex(o=>o.uuid===e.uuid);i!==-1?n[i]=e:n.push(e),this.setAllRule(n);}deleteRule(e){const n=this.getAllRule(),i=typeof e=="string"?e:e.uuid,o=n.findIndex(r=>r.uuid===i);return o!==-1?(n.splice(o,1),this.setAllRule(n),true):false}importRules(e){const n=O.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
                    <div class="btn-control" data-mode="local">本地导入</div>
                    <div class="btn-control" data-mode="network">网络导入</div>
                    <div class="btn-control" data-mode="clipboard">剪贴板导入</div>
                `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(a){a.close();}}},mask:{enable:true},drag:true,width:H.info.width,height:H.info.height,style:`
                .btn-control{
                    display: inline-block;
                    margin: 10px;
                    padding: 10px;
            ...
            `}),i=n.$shadowRoot.querySelector(".btn-control[data-mode='local']"),o=n.$shadowRoot.querySelector(".btn-control[data-mode='network']"),r=n.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),s=async a=>{let l=this.getAllRule();const c=[],p=[];let d=false;for(let g=0;g<a.length;g++){const v=a[g],C=l.findIndex(R=>R.uuid===v.uuid);C!==-1?p.push({index:C,data:v}):c.push(v);}if(p.length&&await new Promise(v=>{O.alert({title:{text:"覆盖规则",position:"center"},content:{text:`存在相同的uuid的规则 ${p.length}条，是否进行覆盖？`,html:true},btn:{close:{callback(C){C.close(),v(false);}},ok:{text:"覆盖",callback(C){C.close(),v(true);}}},width:H.info.width,height:H.info.height,mask:{enable:true},drag:true});})){for(const v of p)l[v.index]=v.data;d=true;}c.length&&(l=l.concat(c)),this.setAllRule(l);const m=`共 ${a.length} 条规则，新增 ${c.length} 条，覆盖 ${d?p.length:0} 条`;w.success(m),e?.();},u=a=>new Promise(async l=>{const c=y.toJSON(a);if(!Array.isArray(c)){h.error(c),w.error("导入失败，格式不符合（不是数组）",{consoleLogContent:true}),l(false);return}if(!c.length){w.error("导入失败，解析出的数据为空",{consoleLogContent:true}),l(false);return}await s(c),l(true);});f.on(i,"click",a=>{f.preventEvent(a),n.close();const l=f.createElement("input",{type:"file",accept:".json"});f.on(l,["propertychange","input"],()=>{if(!l.files?.length)return;const c=l.files[0],p=new FileReader;p.onload=()=>{u(p.result);},p.readAsText(c,"UTF-8");}),l.click();}),f.on(o,"click",a=>{f.preventEvent(a),n.close();const l=O.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(d){d.close();}},ok:{text:"导入",callback:async d=>{const m=d.text;if(y.isNull(m)){w.error("请填入完整的url");return}const g=w.loading("正在获取配置..."),v=await Y.get(m,{allowInterceptConfig:false});if(g.close(),!v.status){h.error(v),w.error("获取配置失败",{consoleLogContent:true});return}await u(v.data.responseText)&&d.close();}},cancel:{enable:false}},mask:{enable:true},drag:true,width:H.info.width,height:"auto"}),c=l.$shadowRoot.querySelector("input"),p=l.$shadowRoot.querySelector(".pops-prompt-btn-ok");f.on(c,["input","propertychange"],()=>{f.val(c)===""?f.attr(p,"disabled","true"):f.removeAttr(p,"disabled");}),f.onKeyboard(c,"keydown",(d,m,g)=>{d==="Enter"&&g.length===0&&f.val(c)!==""&&f.emit(p,"click");}),f.emit(c,"input");}),f.on(r,"click",async a=>{f.preventEvent(a),n.close();const l=await y.getClipboardInfo();if(l.error!=null){w.error(l.error.toString());return}if(l.content.trim()===""){w.warning("获取到的剪贴板内容为空");return}await u(l.content);});}exportRules(e="rule.json"){const n=this.getAllRule(),i=new Blob([JSON.stringify(n,null,4)]),o=globalThis.URL.createObjectURL(i),r=document.createElement("a");r.href=o,r.download=e,r.click(),setTimeout(()=>{globalThis.URL.revokeObjectURL(o);},1500);}}class dt{option;constructor(e){this.option=e;}async showView(){const e=O.confirm({title:{text:this.option.title,position:"center"},content:{text:`
      ...
      `,btn:{merge:true,reverse:false,position:"space-between",ok:{enable:this.option?.bottomControls?.add?.enable||true,type:"primary",text:"添加",callback:async()=>{this.showEditView(false,await this.option.getAddData(),n.$shadowRoot);}},close:{enable:true,callback(){n.close();}},cancel:{enable:false},other:{enable:this.option?.bottomControls?.clear?.enable||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:()=>{const u=O.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async()=>{if(h.success("清空所有"),typeof this.option?.bottomControls?.clear?.callback=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){w.error("清理失败");return}else w.success("清理成功");await this.updateDeleteAllBtnText(n.$shadowRoot),this.clearContent(n.$shadowRoot),u.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh"}),{$searchContainer:i,$externalSelect:o,$ruleValueSelect:r,$searchInput:s}=this.parseViewElement(n.$shadowRoot);if(this.option.bottomControls?.filter?.enable){let u=null,a=null;Array.isArray(this.option.bottomControls?.filter?.option)&&f.append(o,this.option.bottomControls?.filter?.option.map(p=>{const d=f.createElement("option",{innerText:p.name});return Reflect.set(d,"data-value",p),d})),Array.isArray(this.option.bottomControls?.filter?.inputOption)&&f.append(r,this.option.bottomControls?.filter?.inputOption.map(p=>{const d=f.createElement("option",{innerText:p.name});return Reflect.set(d,"data-value",p),d})),f.on(o,"change",async()=>{const p=o[o.selectedIndex],d=Reflect.get(p,"data-value");typeof d?.selectedCallBack=="function"&&d.selectedCallBack(d),u=d,await c(false);}),f.on(r,"change",async()=>{const p=r[r.selectedIndex],d=Reflect.get(p,"data-value");typeof d?.selectedCallBack=="function"&&d.selectedCallBack(d),a=d,await c(false);}),f.onInput(s,y.debounce(async()=>{await c(false);}));const l=()=>{const p=o[o.selectedIndex];u=Reflect.get(p,"data-value");const d=r[r.selectedIndex];a=Reflect.get(d,"data-value");},c=async p=>{this.clearContent(n.$shadowRoot),p&&l();const d=await this.option.data(),m=[],g=f.val(s);for(let v=0;v<d.length;v++){const C=d[v];if(typeof e=="function"){const R=await e(C);if(typeof R=="boolean"&&!R)continue}if(u){const R=await u?.filterCallBack?.(C);if(typeof R=="boolean"&&!R)continue}if(a){let R=true;if(g===""?R=true:R=false,R||(R=await a?.filterCallBack?.(C,g)),!R)continue}m.push(C);}await this.appendRuleItemElement(n.$shadowRoot,m);};if(typeof e=="object"&&e!=null){let p;typeof e.external=="number"?p=e.external:p=Array.from(o.options).findIndex(m=>Reflect.get(m,"data-value").value===e.external),p!==-1&&(o.selectedIndex=p);let d;typeof e.rule=="number"?d=e.rule:d=Array.from(r.options).findIndex(m=>Reflect.get(m,"data-value").value===e.rule),d!==-1&&(r.selectedIndex=d);}await c(true);}else f.hide(i,false);}showEditView(e,n,i,o,r,s){let u=async l=>{if(l){if(typeof s=="function"){let c=await this.option.getData(n);s(c);}}else if(e||await this.option.deleteData(n),typeof r=="function"){let c=await this.option.getData(n);r(c);}};new dt({title:e?"编辑":"添加",data:()=>n,dialogCloseCallBack:u,getView:async l=>await this.option.itemControls.edit.getView(l,e),btn:{ok:{enable:true,text:e?"修改":"添加"},cancel:{callback:async l=>{l.close(),await u(false);}},close:{callback:async l=>{l.close(),await u(false);}}},onsubmit:async(l,c)=>{let p=await this.option.itemControls.edit.onsubmit(l,e,c);return p.success?e?(w.success("修改成功"),i&&await this.updateRuleItemElement(p.data,o,i)):i&&await this.appendRuleItemElement(i,p.data):e&&h.error("修改失败"),p},style:this.option.itemControls.edit.style,width:this.option.itemControls.edit.width,height:this.option.itemControls.edit.height}).showView();}parseViewElement(e){const n=e.querySelector(".rule-view-container"),i=e.querySelector(".pops-confirm-btn button.pops-confirm-btn-other"),o=e.querySelector(".rule-view-search-container"),r=o.querySelector(".pops-panel-select .select-rule-status"),s=o.querySelector(".pops-panel-select .select-rule-value"),u=o.querySelector(".pops-panel-input input");return {$container:n,$deleteBtn:i,$searchContainer:o,$externalSelect:r,$ruleValueSelect:s,$searchInput:u}}parseRuleItemElement(e){const n=e.querySelector(".rule-controls-enable"),i=n.querySelector(".pops-panel-switch"),o=n.querySelector(".pops-panel-switch__input"),r=n.querySelector(".pops-panel-switch__core"),s=e.querySelector(".rule-controls-edit"),u=e.querySelector(".rule-controls-delete");return {$enable:n,$enableSwitch:i,$enableSwitchInput:o,$enableSwitchCore:r,$edit:s,$delete:u,data:Reflect.get(e,"data-rule")}}async createRuleItemElement(e,n){const i=await this.option.getDataItemName(e),o=f.createElement("div",{className:"rule-item",innerHTML:`
			...
			`});Reflect.set(o,"data-rule",e);const r="pops-panel-switch-is-checked",{$enable:s,$enableSwitch:u,$enableSwitchCore:a,$enableSwitchInput:l,$delete:c,$edit:p}=this.parseRuleItemElement(o);return this.option.itemControls.enable.enable?(f.on(a,"click",async()=>{let d=false;u.classList.contains(r)?(u.classList.remove(r),d=false):(u.classList.add(r),d=true),l.checked=d,await this.option.itemControls.enable.callback(e,d);}),await this.option.itemControls.enable.getEnable(e)&&u.classList.add(r)):s.remove(),this.option.itemControls.edit.enable?f.on(p,"click",d=>{f.preventEvent(d),this.showEditView(true,e,n,o,m=>{e=null,e=m;});}):p.remove(),this.option.itemControls.delete.enable?f.on(c,"click",d=>{f.preventEvent(d);const m=O.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async()=>{h.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(e)?(w.success("成功删除该数据"),o.remove(),await this.updateDeleteAllBtnText(n),m.close()):w.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):c.remove(),o}async appendRuleItemElement(e,n){const{$container:i}=this.parseViewElement(e),o=[],r=Array.isArray(n)?n:[n];for(let s=0;s<r.length;s++){const u=r[s],a=await this.createRuleItemElement(u,e);o.push(a);}return f.append(i,o),await this.updateDeleteAllBtnText(e),o}async updateRuleContaienrElement(e){this.clearContent(e);const n=await this.option.data();await this.appendRuleItemElement(e,n),await this.updateDeleteAllBtnText(e);}async updateRuleItemElement(e,n,i){const o=await this.createRuleItemElement(e,i);n.after(o),n.remove();}clearContent(e){const{$container:n}=this.parseViewElement(e);f.html(n,"");}setDeleteBtnText(e,n,i=false){const{$deleteBtn:o}=this.parseViewElement(e);i?f.html(o,n):f.text(o,n);}async updateDeleteAllBtnText(e){let n=await this.option.data();this.setDeleteBtnText(e,`清空所有(${n.length})`);}}class ft{parseInfoDictData(e,n=false){const i=e?.note_card;let o=e.id,r=i.display_title,s=!!i?.interact_info?.liked,u=0,a=e?.note_card?.interact_info?.liked_count;typeof a=="string"&&(u=parseInt(a),isNaN(u)&&(u=0));let l=i?.user?.nick_name||i?.user?.nickname,c=i?.user?.user_id,p=i?.type==="video",d=i?.video?.capa?.duration||0;return {articleId:o,display_title:r,isLike:s,liked_count:u,nick_name:l,user_id:c,isVideo:p,videoDuration:d}}checkFilterWithRule(e){if(e.infoValue==null||e.ruleValue==null)return  false;if(typeof e.infoValue=="string"){if(e.infoValue.match(e.ruleValue))return  true}else if(typeof e.infoValue=="object"){if(Array.isArray(e.infoValue)&&e.infoValue.find(i=>typeof i=="string"&&e.ruleValue!=null?!!i.match(e.ruleValue):false))return  true}else if(typeof e.infoValue=="number"){if(typeof e.ruleValue=="string"){let n=e.ruleValue.trim(),i=n.match(/(\d+)/);if(!i)return h.warn("过滤器-解析比较大小的数字失败: ",e),false;let o=Number(i[1]);if(n.startsWith(">")){if(n.startsWith(">=")){if(e.infoValue>=o)return  true}else if(e.infoValue>o)return  true}else if(n.startsWith("<")){if(n.startsWith("<=")){if(e.infoValue<=o)return  true}else if(e.infoValue<o)return  true}else if(n.startsWith("=")){if(e.infoValue===o)return  true}else return h.warn("视频过滤器-未经允许的比较符号: ",e),false}}else if(typeof e.infoValue=="boolean"&&typeof e.ruleValue=="string"){let n=e.ruleValue.trim();return e.infoValue.toString()===n}return  false}checkInfoIsFilter(e,n){let i=this.parseInfoDictData(n),o=false,r=null;e:for(let s=0;s<e.length;s++){const u=e[s],a=Array.isArray(u.data.ruleName)?u.data.ruleName:[u.data.ruleName];for(let l=0;l<a.length;l++){const c=a[l];if(!Reflect.has(i,c))continue;let p=c,d=i[p],m={infoKey:p,infoValue:d,ruleKey:u.data.ruleName,ruleValue:u.data.ruleValue};if(o=this.checkFilterWithRule(m),o)if(Array.isArray(u.dynamicData)&&u.dynamicData.length){let g=[];for(let v=0;v<u.dynamicData.length;v++){const C=u.dynamicData[v];let R=C.ruleName,D=i[R],V={infoKey:R,infoValue:D,ruleKey:C.ruleName,ruleValue:C.ruleValue};g.push(V);let A=this.checkFilterWithRule(V);if(o=o&&A,!o)break}o&&h.success([`视频过滤器-多组 ==> ${u.name}`,i,m,g,n,u]);}else h.success([`视频过滤器 ==> ${u.name}`,i,m,n,u]);if(o){r=u;break e}}}return {isFilter:o,matchedFilterOption:r,transformInfo:i,info:n}}removeArticle(...e){if(e.length===1){let n=e[0];n!=null&&n instanceof Element&&n.remove();}else if(e.length===2){let n=e[0],i=e[1];if(typeof i=="number"){let o=n[i];o!=null&&o instanceof Element&&o.remove(),n.splice(i,1);}}}}const pe={$key:{ENABLE_KEY:"shieldVideo-exec-network-enable"},$data:{isFilterAwemeInfoList:new K.Dictionary,articleInfoMap:new K.Dictionary,__videoFilterRuleStorage:null,get videoFilterRuleStorage(){return this.__videoFilterRuleStorage==null&&(this.__videoFilterRuleStorage=new ut({STORAGE_API_KEY:"xhs-article-filter-rule"})),this.__videoFilterRuleStorage},get isReverse(){return x.getValue("xhs-article-filter-only-show-filtered-video")}},init(){this.execFilter();},execFilter(){x.execMenuOnce(this.$key.ENABLE_KEY,async()=>{h.info("执行笔记过滤器");let t=new ft,e=o=>{if(this.$data.isReverse&&(o.isFilter=!o.isFilter,typeof o.transformInfo.articleId=="string"&&o.matchedFilterOption)){let r=this.$data.isFilterAwemeInfoList.get(o.transformInfo.articleId)||[];r.push(o.matchedFilterOption),this.$data.isFilterAwemeInfoList.set(o.transformInfo.articleId,r);}typeof o.transformInfo.articleId=="string"&&this.$data.articleInfoMap.set(o.transformInfo.articleId,{articleInfo:o.info,transformArticleInfo:o.transformInfo});},n=o=>{if(!x.getValue(this.$key.ENABLE_KEY))return [];let r=this.$data.videoFilterRuleStorage.getAllRule();if(!r.length)return [];let s=Array.isArray(o)?o:[o];return r.filter(a=>a.enable&&(a.data.scope.includes("all")||Array.from(s).findIndex(l=>a.data.scope.includes(l))!==-1))},i=(o,r)=>{r.response=s=>{let u=n(o);if(!u.length)return;let a=y.toJSON(s.responseText),l=a?.data?.items;if(Array.isArray(l)){for(let c=0;c<l.length;c++){let p=l[c]||{},d=t.checkInfoIsFilter(u,p);e(d),d.isFilter&&t.removeArticle(l,c--);}s.responseText=JSON.stringify(a);}};};st.ajaxHooker.hook(o=>{let r=P.fixUrl(o.url);new URL(r).pathname.startsWith("/api/sns/web/v1/homefeed")&&i("xhr-explore",o);});});},getTemplateData(){return {uuid:y.generateUUID(),enable:true,name:"",data:{scope:[],ruleName:"display_title",ruleValue:"",remarks:""},dynamicData:[]}},showView(){this.getRuleViewInstance().showView();},getRuleViewInstance(){const t=this;let e=O.config.PanelHandlerComponents();function n(o){return {get(r,s){return o[r]??s},set(r,s){o[r]=s;}}}return new pt({title:"笔记过滤器",data:()=>this.$data.videoFilterRuleStorage.getAllRule(),getAddData:()=>this.getTemplateData(),getDataItemName:o=>o.name,updateData:o=>this.$data.videoFilterRuleStorage.setRule(o),deleteData:o=>this.$data.videoFilterRuleStorage.deleteRule(o),getData:o=>this.$data.videoFilterRuleStorage.getAllRule().find(u=>u.uuid===o.uuid)??o,itemControls:{enable:{enable:true,getEnable(o){return o.enable},callback:(o,r)=>{o.enable=r,this.$data.videoFilterRuleStorage.setRule(o);}},edit:{enable:true,getView:(o,r)=>{let s=document.createDocumentFragment();r||(o=this.getTemplateData());let u=L("启用","enable",true);Reflect.set(u.props,N,n(o));let a=e.createSectionContainerItem_switch(u).$el,l=ct("规则名称","name","","",void 0,"必填");Reflect.set(l.props,N,n(o));let c=e.createSectionContainerItem_input(l).$el,p=De("作用域","scope",[],[{text:"所有",value:"all"},{text:"发现",value:"xhr-explore"}].map(b=>({...b,value:b.value})),void 0,"选择需要在xxx上生效的作用域");Reflect.set(p.props,N,n(o.data));let d=e.createSectionContainerItem_select_multiple(p).$el,m=["display_title","isLike","liked_count","nick_name","user_id","isVideo","videoDuration"],g=b=>{let I=Array.isArray(b.ruleName)?b.ruleName:[b.ruleName],E=De("属性名","ruleName",I,m.map(B=>({text:B,value:B})),void 0,"选择需要的属性名 ");Reflect.set(E.props,N,n(b));let $=e.createSectionContainerItem_select_multiple(E).$el,M=Oe("属性值","ruleValue","","如果是字符串，可正则，注意转义");Reflect.set(M.props,N,n(b));let S=e.createSectionContainerItem_textarea(M).$el,T=Oe("备注","remarks","","");Reflect.set(T.props,N,n(b));let F=e.createSectionContainerItem_textarea(T).$el;return {$ruleName:$,$ruleValue:S,$remarks:F}},v=f.createElement("div",{className:"rule-form-ulist-dynamic",innerHTML:`
							...
							`}),C=v.querySelector(".rule-form-ulist-dynamic__inner"),R=v.querySelector(".pops-panel-button"),D=(b={ruleName:[],ruleValue:"",remarks:""})=>{let I=f.createElement("div",{className:"rule-form-ulist-dynamic__inner-container",innerHTML:`
								...
								`}),E=I.querySelector(".dynamic-control-delete");f.on(E,"click",F=>{if(f.preventEvent(F),I.remove(),Array.isArray(o.dynamicData)){let B=o.dynamicData.findIndex(z=>z==b);B!==-1&&o.dynamicData.splice(B,1);}});let $=I.querySelector(".dynamic-forms"),{$ruleName:M,$ruleValue:S,$remarks:T}=g(b);$.appendChild(M),$.appendChild(S),$.appendChild(T),C.appendChild(I);};if(f.on(R,"click",b=>{f.preventEvent(b),D();}),Array.isArray(o.dynamicData))for(let b=0;b<o.dynamicData.length;b++){const I=o.dynamicData[b];D(I);}let{$ruleName:V,$ruleValue:A,$remarks:_}=g(o.data);return s.append(a,c,d,V,A,_,v),s},onsubmit:(o,r,s)=>{let u=o.querySelectorAll(".rule-form-ulist > li"),a=this.getTemplateData();return r&&(a.uuid=s.uuid),u.forEach(l=>{let c=Reflect.get(l,e.$data.nodeStoreConfigKey);if(!c)return;let p=Reflect.get(c,"attributes");if(!p)return;let d=Reflect.get(l,N),m=Reflect.get(p,W),g=Reflect.get(p,G),v=d.get(m,g);Reflect.has(a,m)?Reflect.set(a,m,v):Reflect.has(a.data,m)?Reflect.set(a.data,m,v):h.error(`${m}不在数据中`);}),o.querySelectorAll(".rule-form-ulist-dynamic__inner-container").forEach(l=>{let c={};l.querySelectorAll(".dynamic-forms > li").forEach(p=>{let d=Reflect.get(p,e.$data.nodeStoreConfigKey);if(!d)return;let m=Reflect.get(d,"attributes");if(!m)return;let g=Reflect.get(p,N),v=Reflect.get(m,W),C=Reflect.get(m,G),R=g.get(v,C);Reflect.set(c,v,R);}),a.dynamicData.push(c);}),a.name.trim()===""?(w.error("规则名称不能为空"),{success:false,data:a}):a.data.scope.length===0?(w.error("请选择作用域"),{success:false,data:a}):a.data.ruleName.length===0?(w.error("请选择属性名"),{success:false,data:a}):a.data.ruleValue.trim()===""?(w.error("属性值不能为空"),{success:false,data:a}):r?{success:t.$data.videoFilterRuleStorage.setRule(a),data:a}:{success:t.$data.videoFilterRuleStorage.addRule(a),data:a}},style:`

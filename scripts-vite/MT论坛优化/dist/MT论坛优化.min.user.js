...
(function (x, U, G, ce, de, Ue) {
  ...
  var Ee=typeof GM<"u"?GM:void 0,le=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Ie=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,ee=typeof GM_getValue<"u"?GM_getValue:void 0,oe=typeof GM_info<"u"?GM_info:void 0,pe=typeof GM_listValues<"u"?GM_listValues:void 0,Fe=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,J=typeof GM_setValue<"u"?GM_setValue:void 0,Re=typeof GM_setValues<"u"?GM_setValues:void 0,Ne=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,qe=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,H=typeof unsafeWindow<"u"?unsafeWindow:void 0,Pe=window;const Y={waitRemove(...e){e.forEach(t=>{typeof t=="string"&&U.waitNodeList(t).then(n=>{n.forEach(a=>a.remove());});});},createBlockCSSNode(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(n=>{Array.isArray(n)?t=t.concat(n):t.push(n);}),U.createElement("style",{type:"text/css",innerHTML:`${t.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Ie=="function"?Ie(e.keyName):null;return typeof t=="string"&&t?Z(t):Y.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{U.ready(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(a=>{a.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(a=>{a.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(a){navigator.clipboard.readText().then(r=>{a(r);}).catch(r=>{w.error("读取剪贴板内容失败👉",r),a("");});}function t(a){navigator.permissions.query({name:"clipboard-read"}).then(r=>{e(a);}).catch(r=>{w.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),e(a);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(a=>{if(!n()){a("");return}document.hasFocus()?t(a):window.addEventListener("focus",()=>{t(a);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let a,r=n-t,i=t,o=async s=>{let l=await e(s);if(typeof l=="boolean"&&!l||s){f.workerClearTimeout(a);return}if(i+=t,i>r){o(true);return}a=f.workerSetTimeout(()=>{o(false);},t);};o(false);},findParentNode(e,t,n){if(n){let a=U.closest(e,n);if(a)return a.querySelector(t)}else return U.matches(e,t)?e:U.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(a,r)=>r===void 0?t:r,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},De={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}},re={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},f=G.noConflict(),c=U.noConflict(),M=ce,w=new f.Log(oe,H.console||Pe.console),ve=oe?.script?.name||void 0,He=ce.config.Utils.AnyTouch(),ze=false;w.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});x.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?w.warn(n):t==="error"?w.error(n):w.info(n),true},get position(){return S.getValue(re.qmsg_config_position.key,re.qmsg_config_position.defaultValue)},get maxNums(){return S.getValue(re.qmsg_config_maxnums.key,re.qmsg_config_maxnums.defaultValue)},get showReverse(){return S.getValue(re.qmsg_config_showreverse.key,re.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=G.getMaxZIndex(),t=ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return G.getMaxValue(e,t)+100}});M.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=G.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),t=ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return G.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ue=new f.GM_Menu({GM_getValue:ee,GM_setValue:J,GM_registerMenuCommand:Fe,GM_unregisterMenuCommand:Ne}),F=new f.Httpx({xmlHttpRequest:qe,logDetails:ze});F.interceptors.request.use(e=>e);F.interceptors.response.use(void 0,e=>(w.error("拦截器-请求错误",e),e.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),e));H.Object.defineProperty,H.Function.prototype.apply,H.Function.prototype.call,H.Element.prototype.appendChild,H.setTimeout;const Z=c.addStyle.bind(c),z=U.selector.bind(U),B=U.selectorAll.bind(U);new f.GM_Cookie;const fe="GM_Panel",Ae="data-init",te="data-key",ne="data-default-value",je="data-init-more-value",Ve="data-plugin-search-config",D="data-storage-api",K={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},P={setting:{get width(){return K.width<550?"88vw":K.width<700?"550px":"700px"},get height(){return K.height<450?"70vh":K.height<550?"450px":"550px"}},settingMiddle:{get width(){return K.width<350?"88vw":"350px"}},settingBig:{get width(){return K.width<800?"92vw":"800px"},get height(){return K.height<600?"80vh":"600px"}},info:{get width(){return K.width<350?"88vw":"350px"},get height(){return K.height<250?"88vh":"250px"}}};class Ke{storageKey;listenerData;constructor(t){if(typeof t=="string"){const n=t.trim();if(n=="")throw new Error("key参数不能为空字符串");this.storageKey=n;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new G.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let t=ee(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){J(this.storageKey,t);}set(t,n){const a=this.get(t),r=this.getLocalValue();Reflect.set(r,t,n),this.setLocalValue(r),this.triggerValueChangeListener(t,a,n);}get(t,n){const a=this.getLocalValue();return Reflect.get(a,t)??n}getAll(){return this.getLocalValue()}delete(t){const n=this.get(t),a=this.getLocalValue();Reflect.deleteProperty(a,t),this.setLocalValue(a),this.triggerValueChangeListener(t,n,void 0);}has(t){const n=this.getLocalValue();return Reflect.has(n,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(n=>Reflect.get(t,n))}clear(){le(this.storageKey);}addValueChangeListener(t,n){const a=Math.random(),r=this.listenerData.get(t)||[];return r.push({id:a,key:t,callback:n}),this.listenerData.set(t,r),a}removeValueChangeListener(t){let n=false;for(const[a,r]of this.listenerData.entries()){for(let i=0;i<r.length;i++){const o=r[i];(typeof t=="string"&&o.key===t||typeof t=="number"&&o.id===t)&&(r.splice(i,1),i--,n=true);}this.listenerData.set(a,r);}return n}async triggerValueChangeListener(...t){const[n,a,r]=t;if(!this.listenerData.has(n))return;let i=this.listenerData.get(n);for(let o=0;o<i.length;o++){const s=i[o];if(typeof s.callback=="function"){let l=this.get(n),u,d;typeof a<"u"&&t.length>=2?d=a:d=l,typeof r<"u"&&t.length>2?u=r:u=l,await s.callback(n,d,u);}}}}const W=new Ke(fe),me={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new f.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(i,o)=>{typeof o!="string"&&(o=Y.toStr(o));const s=new Blob([o]),l=globalThis.URL.createObjectURL(s);c.createElement("a",{href:l,download:i}).click(),f.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},a=()=>{const i=h=>{const p=M.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),b=p.$shadowRoot.querySelector(".btn-control[data-mode='local']"),m=p.$shadowRoot.querySelector(".btn-control[data-mode='network']"),g=p.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),y=async v=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof pe=="function"?typeof le=="function"?(pe().forEach(A=>{le(A);}),x.success("已清空脚本存储的配置")):x.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):x.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Re=="function"?Re(v):Object.keys(v).forEach(A=>{const k=v[A];J(A,k);}),x.success("配置导入完毕");},C=v=>new Promise(async E=>{const I=f.toJSON(v);Object.keys(I).length===0?x.warning("解析为空配置，不导入"):await y(I),E(true);});c.on(b,"click",v=>{c.preventEvent(v),p.close();const E=c.createElement("input",{type:"file",accept:".json"});c.on(E,["propertychange","input"],I=>{if(!E.files?.length)return;const A=E.files[0],k=new FileReader;k.onload=()=>{C(k.result);},k.readAsText(A,"UTF-8");}),E.click();}),c.on(m,"click",v=>{c.preventEvent(v),p.close();const E=M.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(k,_){k.close();}},ok:{text:"导入",callback:async(k,_)=>{const O=k.text;if(f.isNull(O)){x.error("请填入完整的url");return}const R=x.loading("正在获取配置..."),T=await F.get(O,{allowInterceptConfig:false});if(R.close(),!T.status){w.error(T),x.error("获取配置失败",{consoleLogContent:true});return}await C(T.data.responseText)&&k.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:P.info.width,height:"auto"}),I=E.$shadowRoot.querySelector("input"),A=E.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(I,["input","propertychange"],k=>{c.val(I)===""?c.attr(A,"disabled","true"):c.removeAttr(A,"disabled");}),c.listenKeyboard(I,"keydown",(k,_,O)=>{k==="Enter"&&O.length===0&&c.val(I)!==""&&c.trigger(A,"click");}),c.trigger(I,"input");}),c.on(g,"click",async v=>{c.preventEvent(v),p.close();let E=await Y.getClipboardText();if(E.trim()===""){x.warning("获取到的剪贴板内容为空");return}await C(E);});},o=(h=`${ve}_panel-setting-${f.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,p)=>{const b=M.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(y,C){y.close();}}},drag:true,mask:{enable:true},width:P.info.width,height:P.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),m=b.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),g=b.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");c.on(m,"click",y=>{c.preventEvent(y);try{n(h,p),b.close();}catch(C){x.error(C.toString(),{consoleLogContent:true});}}),c.on(g,"click",async y=>{await f.copy(p)?(x.success("复制成功"),b.close()):x.error("复制失败");});},l=M.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(h,p){i();}},cancel:{enable:true,text:"导出",callback(h,p){o(void 0,d);}}},width:K.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),u={};if(typeof pe=="function")pe().forEach(p=>{const b=ee(p);Reflect.set(u,p,b);});else {x.warning("不支持函数GM_listValues，仅导出菜单配置");const h=ee(fe);Reflect.set(u,fe,h);}const d=Y.toStr(u);l.value=d;},r=()=>{let i=oe?.script?.supportURL||oe?.script?.namespace;typeof i=="string"&&f.isNotNull(i)&&window.open(i,"_blank");};return [{id:"script-version",title:`版本：${oe?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(i){new He(i.$asideLiElement).on("tap",function(s){clearTimeout(t),t=void 0,e?(e=false,a()):(t=setTimeout(()=>{e=false,r();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},Ge={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{S.showPanel(me.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){S.isTopWindow()&&ue.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let n=this.$data.menuOption.findIndex(a=>a.key===t.key);n!==-1&&(this.$data.menuOption[n]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},S={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new f.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new f.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new f.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new f.Dictionary),this.__onceExecData},get scriptName(){return ve},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:fe,attributeKeyName:te,attributeDefaultValueName:ne},init(){this.initContentDefaultValue(),Ge.init();},isTopWindow(){return H.top===H.self},initContentDefaultValue(){const e=a=>{if(!a.attributes||a.type==="button"||a.type==="container"||a.type==="deepMenu")return;const r=a.attributes;let i=r[Ae];if(typeof i=="function"){let u=i();if(typeof u=="boolean"&&!u)return}let o=new Map,s=r[te];if(s!=null){const u=r[ne];o.set(s,u);}let l=r[je];if(typeof l=="object"&&l&&Object.keys(l).forEach(u=>{const d=l[u];o.set(u,d);}),!o.size){w.warn(["请先配置键",a]);return}if(a.type==="switch"){let u=typeof a.disabled=="function"?a.disabled():a.disabled;typeof u=="boolean"&&u&&this.$data.contentConfigInitDisabledKeys.push(...o.keys());}for(const[u,d]of o.entries())this.setDefaultValue(u,d);},t=a=>{for(let r=0;r<a.length;r++){let i=a[r];e(i);let o=i.views;o&&Array.isArray(o)&&t(o);}},n=[...me.getAllContentConfig()];for(let a=0;a<n.length;a++){let r=n[a];if(!r.views)continue;const i=r.views;i&&Array.isArray(i)&&t(i);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&w.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){W.set(e,t);},getValue(e,t){const n=W.get(e);return n??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){W.delete(e);},hasKey(e){return W.has(e)},addValueChangeListener(e,t){return W.addValueChangeListener(e,(a,r,i)=>{t(e,i,r);})},removeValueChangeListener(e){W.removeValueChangeListener(e);},triggerMenuValueChange(e,t,n){W.triggerValueChangeListener(e,n,t);},async exec(e,t,n,a=true){const r=this;let i;typeof e=="string"||Array.isArray(e)?i=()=>e:i=e;let o=false;const s=i();let l=[];Array.isArray(s)?(o=true,l=s):l.push(s);const u=l.find(A=>!this.$data.contentConfigInitDefaultValue.has(A));if(u){w.warn(`${u} 键不存在`);return}const d=JSON.stringify(l);if(a&&this.$data.onceExecMenuData.has(d))return this.$data.onceExecMenuData.get(d);let h=[];const p=[];let b=[];const m=(A,k)=>{let _=[],O=[],R=[];if(Array.isArray(k))R=R.concat(k);else if(typeof k=="object"&&k!=null)if(k instanceof Element)R.push(k);else {const{$css:T,destory:L}=k;T!=null&&(Array.isArray(T)?R=R.concat(T):R.push(T)),typeof L=="function"&&R.push(L);}else R.push(k);for(const T of R)if(T!=null){if(T instanceof Element){_.push(T);continue}if(typeof T=="function"){b.push(T);continue}}A?(h=h.concat(_),b=b.concat(O)):(y(),C());},g=A=>!!this.getValue(A),y=()=>{for(let A=0;A<h.length;A++)h[A]?.remove(),h.splice(A,1),A--;},C=()=>{for(let A=0;A<b.length;A++){const k=b[A];k(),b.splice(A,1),A--;}},v=()=>{let A=false;return typeof n=="function"?A=n(l):A=l.every(k=>g(k)),A},E=async A=>{if(v()){const _=l.map(R=>this.getValue(R)),O=await t({value:o?_:_[0],addStoreValue:(...R)=>m(true,R)});m(true,O);}else m(false,[]);};a&&l.forEach(A=>{const k=this.addValueChangeListener(A,(_,O,R)=>E());p.push(k);}),await E();const I={reload(){this.clearStoreStyleElements(),this.destory(),E();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>y(),destory(){return C()},removeValueChangeListener:()=>{p.forEach(A=>{this.removeValueChangeListener(A);});},clearOnceExecMenuData(){a&&r.$data.onceExecMenuData.delete(d);}};return this.$data.onceExecMenuData.set(d,I),I},async execMenu(e,t,n=false,a=false){return await this.exec(e,async r=>await t(r),r=>r.every(o=>{let s=!!this.getValue(o);return S.$data.contentConfigInitDisabledKeys.includes(o)&&(s=false,w.warn(`.execMenu${a?"Once":""} ${o} 被禁用`)),n&&(s=!s),s}),a)},async execMenuOnce(e,t,n=false,a=false){const r=await this.execMenu(e,t,n,true);if(a&&r){const i=()=>{r.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,i);}return r},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),W.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async triggerUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const n of t)await n(e);},showPanel(e,t=`${ve}-设置`,n=false,a=false){this.$data.$panel=null,this.$data.panelContent=[];let r=e.findIndex(o=>(typeof o.isBottom=="function"?o.isBottom():!!o.isBottom)&&o.id==="script-version")!==-1;!n&&!r&&e.push(...me.getDefaultBottomContentConfig());let i=M.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(o,s)=>{o.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(o,s)=>{o(),this.$data.$panel=null;}},width:P.setting.width,height:P.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=i,this.$data.panelContent=e,a||this.registerConfigSearch({$panel:i,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,a=async(p,b)=>{if(p==null)return;const m=await b(p);return m&&typeof m.isFind=="boolean"&&m.isFind?m.data:await a(m.data,b)},r=(p,b)=>{const m=new IntersectionObserver(g=>{g.forEach(y=>{y.isIntersecting&&(b?.(),m.disconnect());});},{root:null,threshold:1});m.observe(p),p.scrollIntoView({behavior:"smooth",block:"center"});},i=p=>{const b="pops-flashing";c.animationend(p,()=>{p.classList.remove(b);}),p.classList.add(b);},o=p=>{if(p.type==="dblclick"&&h)return;c.preventEvent(p),l=null;const b=M.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});b.$shadowRoot.querySelector(".search-wrapper");const m=b.$shadowRoot.querySelector(".search-config-text"),g=b.$shadowRoot.querySelector(".search-result-wrapper");m.focus();const y=()=>{c.empty(g);},C=E=>{const I=f.queryProperty(E,_=>_?.next?{isFind:false,data:_.next}:{isFind:true,data:_}),A=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),k=M.config.PanelHandlerComponents();return c.on(A,"click",_=>{const R=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[E.index];if(!R){x.error(`左侧项下标${E.index}不存在`);return}R.scrollIntoView({behavior:"smooth",block:"center"}),R.click(),a(E.next,async T=>{if(T?.next){const L=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(j=>{const N=Reflect.get(j,k.$data.nodeStoreConfigKey);return typeof N=="object"&&N!=null&&N.text===T.name}),2500);if(L)L.click();else return x.error("未找到对应的二级菜单"),{isFind:true,data:T};return {isFind:false,data:T.next}}else {const L=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(j=>Reflect.get(j,k.$data.nodeStoreConfigKey)===T.matchedData?.formConfig),2500);if(L){r(L);const j=L.closest(".pops-panel-forms-fold[data-fold-enable]");j&&(j.querySelector(".pops-panel-forms-fold-container").click(),await f.sleep(500)),r(L,()=>{i(L);});}else x.error("未找到对应的菜单项");return {isFind:true,data:T}}});}),A},v=E=>{const I=new RegExp(E,"i"),A=[],k=(O,R)=>{for(let T=0;T<O.length;T++){const L=O[T],j=L.views;if(j&&Array.isArray(j)){const N=f.deepClone(R);if(L.type==="deepMenu"){const ae=f.queryProperty(N,ie=>ie?.next?{isFind:false,data:ie.next}:{isFind:true,data:ie});ae.next={name:L.text};}k(j,N);}else {let N,ae;if(L.type==="own"){const q=Reflect.get(L.attributes||{},Ve);q&&(typeof q.text=="string"&&(N=q.text),typeof q.desc=="string"&&(ae=q.desc));}else N=Reflect.get(L,"text"),ae=Reflect.get(L,"description");const ie=[N,ae],Ce=ie.findIndex(q=>{if(typeof q=="string")return q.match(I)});if(Ce!==-1){const q=f.deepClone(R),ke=f.queryProperty(q,Q=>Q?.next?{isFind:false,data:Q.next}:{isFind:true,data:Q});ke.next={name:N,matchedData:{path:"",formConfig:L,matchedText:ie[Ce],description:ae}};const Se=[];f.queryProperty(q,Q=>{const xe=Q?.name;return typeof xe=="string"&&xe.trim()!==""&&Se.push(xe),Q?.next?{isFind:false,data:Q.next}:{isFind:true,data:Q}});const $e=Se.join(Y.escapeHtml(" - "));ke.next.matchedData.path=$e,A.push(q);}}}};for(let O=0;O<n.length;O++){const R=n[O];if(!R.views||R.isBottom&&R.id==="script-version")continue;const T=R.views;if(T&&Array.isArray(T)){let L=R.title;typeof L=="function"&&(L=L()),k(T,{index:O,name:L});}}const _=document.createDocumentFragment();for(const O of A){let R=C(O);_.appendChild(R);}y(),g.append(_);};c.on(m,"input",f.debounce(E=>{c.preventEvent(E);let I=c.val(m).trim();if(I===""){y();return}v(I);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(p=>{c.on(p,"dblclick",o);});let l=null,u=false,d,h=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(p,b)=>{h=true,clearTimeout(d),d=void 0,u&&l===b?(u=false,l=null,o(p)):(d=setTimeout(()=>{u=false;},200),u=true,l=b);},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
        ...
        `});c.prepend(e,r);});},quickReplyOptimization(){c.waitNode('#scrolltop a[title="快速回复"]',1e4).then(e=>{e&&(w.info("快捷回复优化"),c.on(e,"click",function(){H.showWindow("reply",e.href),w.info("等待弹窗出现"),c.waitNode("#moreconf",1e4).then(t=>{if(!t)return;w.success("弹出出现，添加按钮");let n=c.createElement("button",{innerText:"一键空格",type:"button",id:"insertspace2"},{style:"float: left;"});c.on(n,"click",a=>{c.preventEvent(a),c.val(z("#postmessage"),c.val(z("#postmessage"))+"           ");}),c.append(t,n);});}));});}},Ze=".pls .avatar img,.avtm img{border-radius:10%}.pls .avatar img{--avatar-size: 90px;width:var(--avatar-size);height:var(--avatar-size)}";Be(Ze);const _e={$flag:{isSetHljsCSS:false},init(){We.init(),S.execMenuOnce("mt-forum-post-autoExpandContent",()=>this.autoExpandContent()),S.execMenuOnce("mt-forum-post-repairImageWidth",()=>this.repairImageWidth()),S.execMenuOnce("mt-forum-post-hideBottomInfoBlock",()=>this.hideBottomInfoBlock()),c.ready(()=>{S.execMenu("mt-forum-post-removeFontStyle",()=>{this.removeFontStyle();}),S.execMenu("mt-forum-post-removeCommentFontStyle",()=>{this.removeCommentFontStyle();}),S.execMenuOnce("mt-forum-post-loadNextPageComment",()=>this.loadNextPageComment()),S.execMenuOnce("mt-forum-post-codeQuoteOptimization",()=>this.codeQuoteOptimization()),S.execMenuOnce("mt-forum-post-optimizationImagePreview",()=>this.optimizationImagePreview()),S.execMenuOnce("mt-forum-post-interceptionAttachment",()=>this.setAttachmentsClickTip()),S.execMenu("mt-forum-post-detectingUserOnlineStatus",()=>{this.detectingUserOnlineStatus();}),S.execMenu("mt-forum-post-showUserLevel",()=>{this.showUserLevel();});});},autoExpandContent(){return w.info("自动展开帖子内容"),[Z(`
		...
		`)}},Ye={init(){c.ready(()=>{S.execMenuOnce("mt-guide-beautifyPage",()=>{this.beautifyPage();});});},beautifyPage(){w.info("页面美化"),Z(`
		.xst{font-size:15px}
	...
	`),B(".bm_c table tbody").forEach(e=>{let t=e.querySelector("th.common"),n=c.html(t),a=t.querySelectorAll("a")[0].getAttribute("href"),r=null,o=e.querySelector("td.by>cite>a").getAttribute("href").match(/uid-(\d+)/)[1],s=`
			...
			`;c.html(e,s);});}},be={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new G.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,n){let a;this.hasStorageApi(e)?a=this.getStorageApi(e):a=n,this.setComponentsStorageApiProperty(t,a);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,D,t);}},we=function(e,t,n,a,r,i="",o,s,l,u){const d={text:e,type:"input",isNumber:!!o,isPassword:false,attributes:{},props:{},description:a,afterAddToUListCallBack:l,getValue(){return this.props[D].get(t,n)},callback(h,p,b){this.props[D].set(t,p);},placeholder:i};return Reflect.set(d.attributes,te,t),Reflect.set(d.attributes,ne,n),be.initComponentsStorageApi("input",d,{get(h,p){return S.getValue(h,p)},set(h,p){S.setValue(h,p);}}),d},V=function(e,t,n,a,r,i,o,s){const l={text:e,type:"switch",description:r,disabled:o,attributes:{},props:{},getValue(){return this.props[D].get(t,n)},callback(u,d){const h=!!d;w.success(`${h?"开启":"关闭"} ${e}`),this.props[D].set(t,h);},afterAddToUListCallBack:i};return Reflect.set(l.attributes,te,t),Reflect.set(l.attributes,ne,n),be.initComponentsStorageApi("switch",l,{get(u,d){return S.getValue(u,d)},set(u,d){S.setValue(u,d);}}),l},ye=function(e,t,n,a,r,i="",o,s){const l={text:e,type:"textarea",attributes:{},props:{},description:a,placeholder:i,disabled:o,getValue(){const d=this.props[D].get(t,n);return Array.isArray(d)?d.join(`
`):d},callback(u,d){this.props[D].set(t,d);}};return Reflect.set(l.attributes,te,t),Reflect.set(l.attributes,ne,n),be.initComponentsStorageApi("switch",l,{get(u,d){return S.getValue(u,d)},set(u,d){S.setValue(u,d);}}),l};class Oe{option;constructor(t){this.option=t;}async showView(){let t=M.confirm({title:{text:this.option.title,position:"center"},content:{text:`
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return ee(this.$key.STORAGE_KEY,this.getTemplateData())},setData(e){J(this.$key.STORAGE_KEY,e);}};class Xe{option;$data={isFilteredData:[]};constructor(t){this.option=t;}showView(){let t=M.alert({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,n,a){c.on(e,"change",r=>{if(!e.files?.length)return;c.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let i=e.files[0],o=i.size,s=new Image,l=new FileReader;l.readAsDataURL(i),l.onload=function(u){s.src=u.target.result,s.onload=function(){if(s.width>n.width||s.height>n.height){e.value="",t.setAttribute("data-success","false"),c.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${s.width} 高：${s.height}`);return}if(o>X.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),c.text(t,`🤡校验失败 ==> 图片大小不符合：${o}byte，限制最大：${X.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),c.text(t,`🤣 通过 宽:${s.width} 高:${s.height} 大小(byte):${o}`),a();};};});},async getUploadUrl(){let e=await F.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":f.getRandomPCUA()}});if(!e.status)return;if(f.isNull(e.data.responseText)){x.error("动态头像：获取上传地址的内容失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){x.error("动态头像：获取变量data失败");return}let a=t[t.length-1].split(","),r=a.indexOf("stl_src");if(r===-1&&(r=a.indexOf("src")),r===-1){x.error("动态头像：获取上传地址失败");return}let i=a[r+1],o=new URL(i);return o.pathname=o.pathname.replace("/images/camera.swf","/index.php"),o.searchParams.delete("inajax"),o.searchParams.set("m","user"),o.searchParams.set("a","rectavatar"),o.searchParams.set("base64","yes"),i=o.toString(),w.info("上传地址："+i),i}},st={id:"component-common",title:"通用",views:[{text:"",type:"container",views:[{text:"Toast配置",type:"deepMenu",views:[{text:"",type:"container",views:[Te("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,n)=>{w.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),Te("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),V("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]}]},{text:"",type:"container",views:[{text:"功能",type:"deepMenu",views:[{text:"",type:"container",views:[V("新增【最新发表】","mt-addLatestPostBtn",true,void 0,"便于快捷跳转"),V("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),V("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{type:"deepMenu",text:"自动签到",views:[{text:"",type:"container",views:[V("启用","mt-auto-sign",true,void 0,"自动请求签到"),V("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),Me("签到信息",`上次签到时间：${(()=>{let e=he.getHostNameSignInfo(window.location.hostname);return e?G.formatTime(e.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",e=>{let n=e.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");M.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:a=>{let r=window.location.hostname;he.clearSignInfo(r),x.success("删除成功"),c.text(n,`上次签到时间：${(()=>{let i=he.getHostNameSignInfo(r);return i?G.formatTime(i.time):"尚未签到"})()}`),a.close();}}},width:"300px",height:"200px"});})]}]},{text:"头像",type:"deepMenu",views:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"container",views:[Le(e=>{const t=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return n.querySelector(".avatar-img[data-size='small']"),n.querySelector(".avatar-img[data-size='middle']"),n.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(n),e.appendChild(a),e},void 0,{text:"头像（有缓存）",desc:"小、中、大"}),Le(e=>{const t=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return e.appendChild(t),e.appendChild(n),e},void 0,{text:"头像",desc:"小、中、大"}),Me("修改头像",`可以上传gif图片，注意图片最大限制为${G.formatByteToSize(X.$data.avatarInfo.maxSize)}`,"上传",void 0,false,false,"primary",()=>{X.init();})]}]}]}]},lt={id:"component-forum-post",title:"帖子",views:[{type:"container",text:"",views:[{text:"功能",type:"deepMenu",views:[{type:"container",text:"",views:[V("拦截附件","mt-forum-post-interceptionAttachment",true,void 0,"点击附件时弹出提示框进行确认是否下载附件"),V("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片"),V("自动加载下一页","mt-forum-post-loadNextPageComment",true,void 0,"无缝预览下一页"),V("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮")]}]},{type:"deepMenu",text:"用户信息块",views:[{type:"container",text:"",views:[V("探测用户在线状态","mt-forum-post-detectingUserOnlineStatus",false,void 0,"获取用户在线状态并在用户信息处显示状态表情"),V("显示用户等级","mt-forum-post-showUserLevel",true,void 0,"在用户信息处显示当前用户的等级"),V("隐藏底部信息块","mt-forum-post-hideBottomInfoBlock",false,void 0,"包括金币、好评、信誉等信息")]}]},{type:"deepMenu",text:"右侧悬浮工具栏",views:[{type:"container",text:"",views:[V("新增【快捷收藏】","mt-forum-post-quickCollentBtn",true,void 0,"在右侧悬浮工具栏添加【收藏】按钮，用于快捷收藏"),V("快捷回复优化","mt-forum-post-quickReplyOptimization",true,void 0,"为快捷回复弹窗底部区域添加【一键空格】按钮")]}]}]}]},ct={id:"component-guide",title:"导读",views:[{type:"container",text:"",views:[V("页面美化","mt-guide-beautifyPage",true,void 0,"美化样式")]}]};me.addContentConfig([st,lt,ct]);S.init();ot.init();

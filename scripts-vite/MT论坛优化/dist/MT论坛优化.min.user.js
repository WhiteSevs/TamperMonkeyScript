...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Ee=="function"?Ee(e.keyName):null;return typeof t=="string"&&t?j(t):J.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{q.onReady(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(a=>{a.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(a=>{a.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(a){navigator.clipboard.readText().then(i=>{a(i);}).catch(i=>{b.error("读取剪贴板内容失败👉",i),a("");});}function t(a){navigator.permissions.query({name:"clipboard-read"}).then(i=>{e(a);}).catch(i=>{b.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(a);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(a=>{if(!n()){a("");return}document.hasFocus()?t(a):window.addEventListener("focus",()=>{t(a);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let a,i=n-t,o=t,r=async s=>{const l=await e(s);if(typeof l=="boolean"&&l||s){m.workerClearTimeout(a);return}if(o+=t,o>i){r(true);return}a=m.workerSetTimeout(()=>{r(false);},t);};r(false);},findParentNode(e,t,n){if(n){let a=q.closest(e,n);if(a)return a.querySelector(t)}else return q.matches(e,t)?e:q.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(a,i)=>i===void 0?t:i,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},m=W.noConflict(),c=q.noConflict(),M=ce,b=new m.Log(re,$.console||He.console),ve=re?.script?.name||void 0,ze=ce.config.Utils.AnyTouch(),Ge=false;b.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});x.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?b.warn(n):t==="error"?b.error(n):b.info(n),false},get position(){return k.getValue(oe.qmsg_config_position.key,oe.qmsg_config_position.defaultValue)},get maxNums(){return k.getValue(oe.qmsg_config_maxnums.key,oe.qmsg_config_maxnums.defaultValue)},get showReverse(){return k.getValue(oe.qmsg_config_showreverse.key,oe.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=W.getMaxZIndex(),t=ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return W.getMaxValue(e,t)+100}});M.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=W.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),t=ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return W.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ue=new m.GM_Menu({GM_getValue:ae,GM_setValue:X,GM_registerMenuCommand:Ne,GM_unregisterMenuCommand:qe}),P=new m.Httpx({xmlHttpRequest:Pe,logDetails:Ge});P.interceptors.request.use(e=>e);P.interceptors.response.use(void 0,e=>(b.error("拦截器-请求错误",e),e.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),e));$.Object.defineProperty,$.Object.keys,$.Object.values,$.Function.prototype.apply,$.Function.prototype.call,$.Element.prototype.appendChild,$.setTimeout.bind($),$.clearTimeout.bind($),$.setInterval.bind($),$.clearInterval.bind($);const j=c.addStyle.bind(c),K=q.selector.bind(q),N=q.selectorAll.bind(q);new m.GM_Cookie;const me="GM_Panel",ye="data-init",ee="data-key",te="data-default-value",Ke="data-init-more-value",Oe="data-plugin-search-config",L="data-storage-api",Q={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},G={setting:{get width(){return Q.width<550?"88vw":Q.width<700?"550px":"700px"},get height(){return Q.height<450?"70vh":Q.height<550?"450px":"550px"}},settingMiddle:{get width(){return Q.width<350?"88vw":"350px"}},settingBig:{get width(){return Q.width<800?"92vw":"800px"},get height(){return Q.height<600?"80vh":"600px"}},info:{get width(){return Q.width<350?"88vw":"350px"},get height(){return Q.height<250?"88vh":"250px"}}},ge={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new m.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(o,r)=>{typeof r!="string"&&(r=J.toStr(r));const s=new Blob([r]),l=globalThis.URL.createObjectURL(s);c.createElement("a",{href:l,download:o}).click(),m.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},a=()=>{const o=h=>{const p=M.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),f=p.$shadowRoot.querySelector(".btn-control[data-mode='local']"),g=p.$shadowRoot.querySelector(".btn-control[data-mode='network']"),w=p.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),v=async A=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof he=="function"?typeof le=="function"?(he().forEach(C=>{le(C);}),x.success("已清空脚本存储的配置")):x.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):x.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Ie=="function"?Ie(A):Object.keys(A).forEach(C=>{const S=A[C];X(C,S);}),x.success("配置导入完毕");},y=A=>new Promise(async E=>{const R=m.toJSON(A);Object.keys(R).length===0?x.warning("解析为空配置，不导入"):await v(R),E(true);});c.on(f,"click",A=>{c.preventEvent(A),p.close();const E=c.createElement("input",{type:"file",accept:".json"});c.on(E,["propertychange","input"],R=>{if(!E.files?.length)return;const C=E.files[0],S=new FileReader;S.onload=()=>{y(S.result);},S.readAsText(C,"UTF-8");}),E.click();}),c.on(g,"click",A=>{c.preventEvent(A),p.close();const E=M.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(S,U){S.close();}},ok:{text:"导入",callback:async(S,U)=>{const D=S.text;if(m.isNull(D)){x.error("请填入完整的url");return}const T=x.loading("正在获取配置..."),O=await P.get(D,{allowInterceptConfig:false});if(T.close(),!O.status){b.error(O),x.error("获取配置失败",{consoleLogContent:true});return}await y(O.data.responseText)&&S.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:G.info.width,height:"auto"}),R=E.$shadowRoot.querySelector("input"),C=E.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(R,["input","propertychange"],S=>{c.val(R)===""?c.attr(C,"disabled","true"):c.removeAttr(C,"disabled");}),c.onKeyboard(R,"keydown",(S,U,D)=>{S==="Enter"&&D.length===0&&c.val(R)!==""&&c.emit(C,"click");}),c.emit(R,"input");}),c.on(w,"click",async A=>{c.preventEvent(A),p.close();let E=await J.getClipboardText();if(E.trim()===""){x.warning("获取到的剪贴板内容为空");return}await y(E);});},r=(h=`${ve}_panel-setting-${m.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,p)=>{const f=M.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(v,y){v.close();}}},drag:true,mask:{enable:true},width:G.info.width,height:G.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),g=f.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),w=f.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");c.on(g,"click",v=>{c.preventEvent(v);try{n(h,p),f.close();}catch(y){x.error(y.toString(),{consoleLogContent:true});}}),c.on(w,"click",async v=>{await m.copy(p)?(x.success("复制成功"),f.close()):x.error("复制失败");});},l=M.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(h,p){o();}},cancel:{enable:true,text:"导出",callback(h,p){r(void 0,d);}}},width:Q.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=e,a||this.registerConfigSearch({$panel:o,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,a=async(p,f)=>{if(p==null)return;const g=await f(p);return g&&typeof g.isFind=="boolean"&&g.isFind?g.data:await a(g.data,f)},i=(p,f)=>{const g=new IntersectionObserver(w=>{w.forEach(v=>{v.isIntersecting&&(f?.(),g.disconnect());});},{root:null,threshold:1});g.observe(p),p.scrollIntoView({behavior:"smooth",block:"center"});},o=p=>{const f="pops-flashing";c.onAnimationend(p,()=>{p.classList.remove(f);}),p.classList.add(f);},r=p=>{if(p.type==="dblclick"&&h)return;c.preventEvent(p),l=null;const f=M.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});f.$shadowRoot.querySelector(".search-wrapper");const g=f.$shadowRoot.querySelector(".search-config-text"),w=f.$shadowRoot.querySelector(".search-result-wrapper");g.focus();const v=()=>{c.empty(w);},y=E=>{const R=m.queryProperty(E,U=>U?.next?{isFind:false,data:U.next}:{isFind:true,data:U}),C=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),S=M.config.PanelHandlerComponents();return c.on(C,"click",U=>{const T=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[E.index];if(!T){x.error(`左侧项下标${E.index}不存在`);return}T.scrollIntoView({behavior:"smooth",block:"center"}),T.click(),a(E.next,async O=>{if(O?.next){const I=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(V=>{const _=Reflect.get(V,S.$data.nodeStoreConfigKey);return typeof _=="object"&&_!=null&&_.text===O.name}),2500);if(I)I.click();else return x.error("未找到对应的二级菜单"),{isFind:true,data:O};return {isFind:false,data:O.next}}else {const I=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(V=>Reflect.get(V,S.$data.nodeStoreConfigKey)===O.matchedData?.formConfig),2500);if(I){i(I);const V=I.closest(".pops-panel-forms-fold[data-fold-enable]");V&&(V.querySelector(".pops-panel-forms-fold-container").click(),await m.sleep(500)),i(I,()=>{o(I);});}else x.error("未找到对应的菜单项");return {isFind:true,data:O}}});}),C},A=E=>{const R=new RegExp(E,"i"),C=[],S=(D,T)=>{for(let O=0;O<D.length;O++){const I=D[O],V=I.views;if(V&&Array.isArray(V)){const _=m.deepClone(T);if(I.type==="deepMenu"){const H=m.queryProperty(_,ie=>ie?.next?{isFind:false,data:ie.next}:{isFind:true,data:ie});H.next={name:I.text};}S(V,_);}else {let _,H;if(I.type==="own"){const z=Reflect.get(I.attributes||{},Oe);z&&(typeof z.text=="string"&&(_=z.text),typeof z.desc=="string"&&(H=z.desc));}else _=I.text,H=Reflect.get(I,"description");const ie=[_,H],Ae=ie.findIndex(z=>{if(typeof z=="string")return z.match(R)});if(Ae!==-1){const z=m.deepClone(T),Ce=m.queryProperty(z,Y=>Y?.next?{isFind:false,data:Y.next}:{isFind:true,data:Y});Ce.next={name:_,matchedData:{path:"",formConfig:I,matchedText:ie[Ae],description:H}};const ke=[];m.queryProperty(z,Y=>{const be=Y?.name;return typeof be=="string"&&be.trim()!==""&&ke.push(be),Y?.next?{isFind:false,data:Y.next}:{isFind:true,data:Y}});const _e=ke.join(J.escapeHtml(" - "));Ce.next.matchedData.path=_e,C.push(z);}}}};for(let D=0;D<n.length;D++){const T=n[D];if(!T.views||T.isBottom&&T.id==="script-version")continue;const O=T.views;if(O&&Array.isArray(O)){let I=T.title;typeof I=="function"&&(I=I()),S(O,{index:D,name:I});}}const U=document.createDocumentFragment();for(const D of C){let T=y(D);U.appendChild(T);}v(),w.append(U);};c.on(g,"input",m.debounce(E=>{c.preventEvent(E);let R=c.val(g).trim();if(R===""){v();return}A(R);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(p=>{c.on(p,"dblclick",r);});let l=null,u=false,d,h=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(p,f)=>{h=true,clearTimeout(d),d=void 0,u&&l===f?(u=false,l=null,r(p)):(d=setTimeout(()=>{u=false;},200),u=true,l=f);},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
    ...
    `),()=>{c.remove(i);}]},async quickReplyOptimization(){const e=await c.waitNode('#scrolltop a[title="快速回复"]',1e4);return e?(b.info("快捷回复优化"),c.on(e,"click",function(){$.showWindow("reply",e.href),b.info("等待弹窗出现"),c.waitNode("#moreconf",1e4).then(n=>{if(!n)return;b.success("弹出出现，添加按钮");let a=c.createElement("button",{innerText:"一键空格",type:"button",id:"insertspace2"},{style:"float: left;"});c.on(a,"click",i=>{c.preventEvent(i),c.val(K("#postmessage"),c.val(K("#postmessage"))+"           ");}),c.append(n,a);});}).off):void 0}},Ze=".pls .avatar img,.avtm img{border-radius:10%}.pls .avatar img{--avatar-size: 90px;width:var(--avatar-size);height:var(--avatar-size)}";$e(Ze);const Be={$flag:{isSetHljsCSS:false},init(){Ye.init(),k.execMenuOnce("mt-forum-post-autoExpandContent",()=>this.autoExpandContent()),k.execMenuOnce("mt-forum-post-repairImageWidth",()=>this.repairImageWidth()),k.execMenuOnce("mt-forum-post-hideBottomInfoBlock",()=>this.hideBottomInfoBlock()),c.onReady(()=>{k.execMenu("mt-forum-post-removeFontStyle",()=>{this.removeFontStyle();}),k.execMenu("mt-forum-post-removeCommentFontStyle",()=>{this.removeCommentFontStyle();}),k.execMenuOnce("mt-forum-post-loadNextPageComment",()=>this.loadNextPageComment()),k.execMenuOnce("mt-forum-post-codeQuoteOptimization",()=>this.codeQuoteOptimization()),k.execMenuOnce("mt-forum-post-optimizationImagePreview",()=>this.optimizationImagePreview()),k.execMenuOnce("mt-forum-post-interceptionAttachment",()=>this.setAttachmentsClickTip()),k.execMenu("mt-forum-post-detectingUserOnlineStatus",()=>{this.detectingUserOnlineStatus();}),k.execMenu("mt-forum-post-showUserLevel",()=>{this.showUserLevel();});});},autoExpandContent(){return b.info("自动展开帖子内容"),[j(`
		...
		`)}},Je={init(){c.onReady(()=>{k.execMenuOnce("mt-guide-beautifyPage",()=>{this.beautifyPage();});});},beautifyPage(){b.info("页面美化"),j(`
		.xst{font-size:15px}
...
`).filter(s=>s.trim()!="")),Reflect.set(i,o,r),e.setData(i);}}},n=M.config.PanelHandlerComponents();new Ue({title:"评论过滤器",data:()=>this.getData(),getView:i=>{const o=document.createDocumentFragment(),r=B("启用","enable",true);Reflect.set(r.props,L,t(i));const s=n.createSectionContainerItem_switch(r).$el,l=B("处理回复引用","replyFlag",false,void 0,"移除引用");Reflect.set(l.props,L,t(i));const u=n.createSectionContainerItem_switch(l).$el,d=B("处理作者评论","avatarFlag",false);Reflect.set(d.props,L,t(i));const h=n.createSectionContainerItem_switch(d).$el,p=B('处理从"搜索页面"或"我的帖子提醒页面"进入的网站',"viewthreadFlag",false);Reflect.set(p.props,L,t(i));const f=n.createSectionContainerItem_switch(p).$el,g=Me("匹配的评论内容长度最小值","minLength",5,"小于此长度的评论就算关键字匹配成功了也不会被排除");Reflect.set(g.props,L,t(i));const w=n.createSectionContainerItem_input(g).$el,v=Me("匹配的评论内容长度最大值","keywordLength",8,"大于此长度的评论就算关键字匹配成功了也不会被排除");Reflect.set(v.props,L,t(i));const y=n.createSectionContainerItem_input(v).$el,A=xe("评论关键字","keywords","","多个评论关键字换行分割");Reflect.set(A.props,L,t(i));const E=n.createSectionContainerItem_textarea(A).$el,R=xe("黑名单用户","userBlackList","","多个用户换行分割");Reflect.set(R.props,L,t(i));const C=n.createSectionContainerItem_textarea(R).$el,S=xe("白名单用户","userWhiteList","","多个用户换行分割");Reflect.set(S.props,L,t(i));const U=n.createSectionContainerItem_textarea(S).$el;return o.append(s,u,h,f,w,y,E,C,U),o},btn:{merge:true,position:"space-between",ok:{enable:false},cancel:{enable:true,text:"关闭"},other:{enable:true,text:`查看已过滤（${this.$el.isFilterElementHTML.length}）`,type:"primary",callback:(i,o)=>{M.alert({title:{text:"评论过滤器-已过滤",position:"center"},content:{text:`
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,n,a){c.on(e,"change",i=>{if(!e.files?.length)return;c.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let o=e.files[0],r=o.size,s=new Image,l=new FileReader;l.readAsDataURL(o),l.onload=function(u){s.src=u.target.result,s.onload=function(){if(s.width>n.width||s.height>n.height){e.value="",t.setAttribute("data-success","false"),c.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${s.width} 高：${s.height}`);return}if(r>ne.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),c.text(t,`🤡校验失败 ==> 图片大小不符合：${r}byte，限制最大：${ne.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),c.text(t,`🤣 通过 宽:${s.width} 高:${s.height} 大小(byte):${r}`),a();};};});},async getUploadUrl(){let e=await P.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":m.getRandomPCUA()}});if(!e.status)return;if(m.isNull(e.data.responseText)){x.error("动态头像：获取上传地址的内容失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){x.error("动态头像：获取变量data失败");return}let a=t[t.length-1].split(","),i=a.indexOf("stl_src");if(i===-1&&(i=a.indexOf("src")),i===-1){x.error("动态头像：获取上传地址失败");return}let o=a[i+1],r=new URL(o);return r.pathname=r.pathname.replace("/images/camera.swf","/index.php"),r.searchParams.delete("inajax"),r.searchParams.set("m","user"),r.searchParams.set("a","rectavatar"),r.searchParams.set("base64","yes"),o=r.toString(),b.info("上传地址："+o),o}},st={id:"component-common",title:"通用",views:[{text:"",type:"container",views:[{text:"Toast配置",type:"deepMenu",views:[{text:"",type:"container",views:[De("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],e=>{b.info("设置当前Qmsg弹出位置"+e.text);},"Toast显示在页面九宫格的位置"),De("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),B("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]}]},{text:"",type:"container",views:[{text:"功能",type:"deepMenu",views:[{text:"",type:"container",views:[B("新增【最新发表】","mt-addLatestPostBtn",true,void 0,"便于快捷跳转"),B("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),B("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{type:"deepMenu",text:"自动签到",views:[{text:"",type:"container",views:[B("启用","mt-auto-sign",true,void 0,"自动请求签到"),B("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),Re("签到信息",`上次签到时间：${(()=>{let e=fe.getHostNameSignInfo(window.location.hostname);return e?W.formatTime(e.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",e=>{let n=e.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");M.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:a=>{let i=window.location.hostname;fe.clearSignInfo(i),x.success("删除成功"),c.text(n,`上次签到时间：${(()=>{let o=fe.getHostNameSignInfo(i);return o?W.formatTime(o.time):"尚未签到"})()}`),a.close();}}},width:"300px",height:"200px"});})]}]},{text:"头像",type:"deepMenu",views:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"container",views:[Le(e=>{const t=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return n.querySelector(".avatar-img[data-size='small']"),n.querySelector(".avatar-img[data-size='middle']"),n.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(n),e.appendChild(a),e},void 0,{text:"头像（有缓存）",desc:"小、中、大"}),Le(e=>{const t=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return e.appendChild(t),e.appendChild(n),e},void 0,{text:"头像",desc:"小、中、大"}),Re("修改头像",`可以上传gif图片，注意图片最大限制为${W.formatByteToSize(ne.$data.avatarInfo.maxSize)}`,"上传",void 0,false,false,"primary",()=>{ne.init();})]}]}]}]},lt={id:"component-forum-post",title:"帖子",views:[{type:"container",text:"",views:[{text:"功能",type:"deepMenu",views:[{type:"container",text:"",views:[B("拦截附件","mt-forum-post-interceptionAttachment",true,void 0,"点击附件时弹出提示框进行确认是否下载附件"),B("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片"),B("自动加载下一页","mt-forum-post-loadNextPageComment",true,void 0,"无缝预览下一页"),B("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮")]}]},{type:"deepMenu",text:"用户信息块",views:[{type:"container",text:"",views:[B("探测用户在线状态","mt-forum-post-detectingUserOnlineStatus",false,void 0,"获取用户在线状态并在用户信息处显示状态表情"),B("显示用户等级","mt-forum-post-showUserLevel",true,void 0,"在用户信息处显示当前用户的等级"),B("隐藏底部信息块","mt-forum-post-hideBottomInfoBlock",false,void 0,"包括金币、好评、信誉等信息")]}]},{type:"deepMenu",text:"右侧悬浮工具栏",views:[{type:"container",text:"",views:[B("新增【快捷收藏】","mt-forum-post-quickCollentBtn",true,void 0,"在右侧悬浮工具栏添加【收藏】按钮，用于快捷收藏"),B("快捷回复优化","mt-forum-post-quickReplyOptimization",true,void 0,"为快捷回复弹窗底部区域添加【一键空格】按钮")]}]}]}]},ct={id:"component-guide",title:"导读",views:[{type:"container",text:"",views:[B("页面美化","mt-guide-beautifyPage",true,void 0,"美化样式")]}]};ge.addContentConfig([st,lt,ct]);k.init();rt.init();

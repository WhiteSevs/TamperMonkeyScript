...
(function (x, U, q, ne, oe, Be) {
	'use strict';

	const a=new Set;const Ve = async t=>{a.has(t)||(a.add(t),(n=>{function r(d){let e=document.createElement("style");if(e.setAttribute("type","text/css"),e.setAttribute("data-type","gm-css"),globalThis.trustedTypes){const l=globalThis.trustedTypes.createPolicy("safe-innerHTML",{createHTML:i=>i});e.innerHTML=l.createHTML(d);}else e.innerHTML=d;return (document.head||document.documentElement).appendChild(e),e}if(typeof GM_addStyle=="function"){GM_addStyle(n);return}r(n);})(t));};

	var ve=typeof GM<"u"?GM:void 0,ge=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Ae=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,ae=typeof GM_getValue<"u"?GM_getValue:void 0,te=typeof GM_info<"u"?GM_info:void 0,Oe=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,j=typeof GM_setValue<"u"?GM_setValue:void 0,_e=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Ue=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,N=typeof unsafeWindow<"u"?unsafeWindow:void 0,Ne=window;const ie={waitRemove(...t){t.forEach(e=>{typeof e=="string"&&p.waitNodeList(e).then(a=>{a.forEach(n=>n.remove());});});},addBlockCSS(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(a=>{Array.isArray(a)?e=e.concat(a):e.push(a);}),Q(`${e.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof Ae=="function"?Ae(t.keyName):null;typeof e=="string"&&e?Q(e):ie.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,U.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(a=>{e.onload=()=>{a(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`)}},Qe={init(){d.ready(()=>{y.execMenuOnce("mt-guide-beautifyPage",()=>this.beautifyPage());});},beautifyPage(){g.info("页面美化"),Q(`
			.xst{font-size:15px}
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return ae(this.$key.STORAGE_KEY,this.getTemplateData())},setData(t){j(this.$key.STORAGE_KEY,t);}};class Ge{option;constructor(e){this.option=e;}showView(){let e=E.alert({title:{text:this.option.title,position:"center"},content:{text:`
...
`,Je={$data:{},init(){this.registerMenu();},registerMenu(){re.add({key:"online-user",text:"⚙ 在线用户",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let t=x.loading("正在获取在线用户名单中..."),e=await this.getOnlineUserListInfo();if(t.close(),!e)return;let a=E.alert({title:{text:"在线用户",position:"center"},content:{text:`
                ...
                `,html:true},btn:{ok:{text:"关闭",type:"default"}},width:G.settingBig.width,height:G.settingBig.height,style:Xe}),n=a.$shadowRoot.querySelector(".online-user-list"),i=a.$shadowRoot.querySelector(".online-user-filter input");e.data.forEach(l=>{let o=this.createListViewItem(l);n.appendChild(o);}),x.success(`成功获取 ${e.data.length}条数据`);let r=false;U.on(i,["propertychange","input"],p.debounce(()=>{let l=i.value.trim();if(!r){if(r=true,l==""){a.$shadowRoot.querySelectorAll(".online-user-list .online-item").forEach(o=>{o.removeAttribute("style");}),r=false;return}a.$shadowRoot.querySelectorAll(".online-user-list .online-item").forEach(o=>{o.getAttribute("data-name").match(new RegExp(l,"ig"))||o.getAttribute("data-sf").match(new RegExp(l,"ig"))||o.getAttribute("data-uid").match(new RegExp(l,"ig"))?o.removeAttribute("style"):o.setAttribute("style","display:none;");}),r=false;}}));},async getOnlineUserListInfo(){let t={showoldetails:"yes"},e=await _.get(`/forum.php?${p.toSearchParamsStr(t)}`,{headers:{"User-Agent":p.getRandomPCUA()}});if(!e.status)return;let a=p.parseFromString(e.data.responseText,"text/html"),n={data:[],totalOnline:0,onlineUser:0,noRegisterUser:0,invisibleUser:0};a.querySelectorAll("#onlinelist ul li").forEach(l=>{let o=l.querySelector("a").getAttribute("href").match("uid-(.+?).html")[1],s=B.getAvatar(o,"middle"),c=l.querySelector("a").innerText,u="",f=l.querySelector("a").getAttribute("href"),m=l.querySelector("img").src;m.indexOf("online_member")!=-1?u="会员":m.indexOf("online_moderator")!=-1?u="版主":m.indexOf("online_supermod")!=-1?u="超级版主":m.indexOf("online_admin")!=-1?u="管理员":u="未知身份",n.data.push({uid:o,avatar:s,name:c,sf:u,space:f});});let r=a.querySelector("#online div.bm_h span.xs1").textContent;return n.totalOnline=p.parseInt(r.match(/([0-9]*)\s*人在线/i),0),n.onlineUser=p.parseInt(r.match(/([0-9]*)\s*会员/i),0),n.noRegisterUser=p.parseInt(r.match(/([0-9]*)\s*位游客/i),0),n.invisibleUser=p.parseInt(r.match(/([0-9]*)\s*隐身/i),0),n},createListViewItem(t){let e=U.createElement("div",{className:"online-item",innerHTML:`

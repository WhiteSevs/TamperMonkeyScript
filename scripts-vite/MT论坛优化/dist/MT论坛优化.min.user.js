...
(function (x, N, we, ne, de, Ne) {
  ...
  var Se=typeof GM<"u"?GM:void 0,le=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Ee=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,ae=typeof GM_getValue<"u"?GM_getValue:void 0,re=typeof GM_info<"u"?GM_info:void 0,pe=typeof GM_listValues<"u"?GM_listValues:void 0,qe=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,J=typeof GM_setValue<"u"?GM_setValue:void 0,Ie=typeof GM_setValues<"u"?GM_setValues:void 0,Pe=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,He=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,U=typeof unsafeWindow<"u"?unsafeWindow:void 0,ze=window;const Ve={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}},oe={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},j={waitRemove(...e){e.forEach(t=>{typeof t=="string"&&N.waitNodeList(t).then(n=>{n.forEach(a=>a.remove());});});},createBlockCSSNode(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(n=>{Array.isArray(n)?t=t.concat(n):t.push(n);}),N.createElement("style",{type:"text/css",innerHTML:`${t.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Ee=="function"?Ee(e.keyName):null;return typeof t=="string"&&t?W(t):j.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{N.onReady(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
			.pops-overflow-hidden-important {
				overflow: hidden !important;
			}
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(a=>{a.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(a=>{a.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(a){navigator.clipboard.readText().then(i=>{a(i);}).catch(i=>{b.error("读取剪贴板内容失败👉",i),a("");});}function t(a){navigator.permissions.query({name:"clipboard-read"}).then(()=>{e(a);}).catch(i=>{b.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(a);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(a=>{if(!n()){a("");return}document.hasFocus()?t(a):window.addEventListener("focus",()=>{t(a);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let a,i=n-t,o=t,r=async s=>{const l=await e(s);if(typeof l=="boolean"&&l||s){f.workerClearTimeout(a);return}if(o+=t,o>i){r(true);return}a=f.workerSetTimeout(()=>{r(false);},t);};r(false);},findParentNode(e,t,n){if(n){let a=N.closest(e,n);if(a)return a.querySelector(t)}else return N.matches(e,t)?e:N.closest(e,t)},toStr(e,t=2){const n="__undefined__placeholder__replaced__str__"+performance.now();return JSON.stringify(e,(i,o)=>o===void 0?n:o,t).replace(new RegExp(`"${n}"`,"g"),"undefined")},isVerticalScreen(){return !globalThis.screen.orientation.type.includes("landscape")},isMobileDevice(e=768){return this.isVerticalScreen()?globalThis.innerWidth<e:globalThis.innerHeight<e},isTopWindow(){const e=typeof U=="object"&&U!=null?U:window;return e.top===e.self}},f=ne.noConflict(),c=N.noConflict(),M=we,b=new f.Log(re,U.console||ze.console),ye=re?.script?.name||void 0,Ge=we.fn.Utils.AnyTouch(),Ke=false;b.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});const Oe=()=>{let t=100;const n=we.fn.InstanceUtils.getPopsMaxZIndex()?.zIndex??100,a=ne.getMaxZIndexNodeInfoFromPoint()[0]?.zIndex??100;return t=Math.max(t,n,a),t};x.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?b.warn(n):t==="error"?b.error(n):b.info(n),false},get position(){return S.getValue(oe.qmsg_config_position.key,oe.qmsg_config_position.defaultValue)},get maxNums(){return S.getValue(oe.qmsg_config_maxnums.key,oe.qmsg_config_maxnums.defaultValue)},get showReverse(){return S.getValue(oe.qmsg_config_showreverse.key,oe.qmsg_config_showreverse.defaultValue)},get zIndex(){return Oe()}});M.GlobalConfig.setGlobalConfig({zIndex:()=>Oe(),mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ce=new f.GM_Menu({GM_getValue:ae,GM_setValue:J,GM_registerMenuCommand:qe,GM_unregisterMenuCommand:Pe}),P=new f.Httpx({xmlHttpRequest:He,logDetails:Ke});P.interceptors.request.use(e=>e);P.interceptors.response.use(void 0,e=>(b.error("拦截器-请求错误",e),e.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),e));U.Object.defineProperty,U.Object.keys,U.Object.values,U.Function.prototype.apply,U.Function.prototype.call,U.Element.prototype.appendChild,U.setTimeout.bind(U),U.clearTimeout.bind(U),U.setInterval.bind(U),U.clearInterval.bind(U);const W=c.addStyle.bind(c),K=N.selector.bind(N),F=N.selectorAll.bind(N);new f.GM_Cookie;const fe="GM_Panel",ve="data-init",X="data-key",ee="data-default-value",Qe="data-init-more-value",Be="data-plugin-search-config",D="data-storage-api",Q={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},G={setting:{get width(){return Q.width<550?"88vw":Q.width<700?"550px":"700px"},get height(){return Q.height<450?"70vh":Q.height<550?"450px":"550px"}},settingMiddle:{get width(){return Q.width<350?"88vw":"350px"}},settingBig:{get width(){return Q.width<800?"92vw":"800px"},get height(){return Q.height<600?"80vh":"600px"}},info:{get width(){return Q.width<350?"88vw":"350px"},get height(){return Q.height<250?"88vh":"250px"}}},me={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new f.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(o,r)=>{typeof r!="string"&&(r=j.toStr(r));const s=new Blob([r]),l=globalThis.URL.createObjectURL(s);c.createElement("a",{href:l,download:o}).click(),f.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},a=()=>{const o=h=>{const d=M.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="local">本地导入</div>
            <div class="btn-control" data-mode="network">网络导入</div>
            <div class="btn-control" data-mode="clipboard">剪贴板导入</div>`,html:true},btn:{ok:{enable:false},close:{enable:true,callback(C,E){C.close();}}},drag:true,mask:{enable:true},width:G.info.width,height:G.info.height,style:`
          .btn-control{
          ...
          }`}),w=d.$shadowRoot.querySelector(".btn-control[data-mode='local']"),m=d.$shadowRoot.querySelector(".btn-control[data-mode='network']"),g=d.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),y=async C=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof pe=="function"?typeof le=="function"?(pe().forEach(A=>{le(A);}),x.success("已清空脚本存储的配置")):x.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):x.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Ie=="function"?Ie(C):Object.keys(C).forEach(A=>{const k=C[A];J(A,k);}),x.success("配置导入完毕");},v=C=>new Promise(async E=>{const T=f.toJSON(C);Object.keys(T).length===0?x.warning("解析为空配置，不导入"):await y(T),E(true);});c.on(w,"click",C=>{c.preventEvent(C),d.close();const E=c.createElement("input",{type:"file",accept:".json"});c.on(E,["propertychange","input"],T=>{if(!E.files?.length)return;const A=E.files[0],k=new FileReader;k.onload=()=>{v(k.result);},k.readAsText(A,"UTF-8");}),E.click();}),c.on(m,"click",C=>{c.preventEvent(C),d.close();const E=M.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(k,O){k.close();}},ok:{text:"导入",callback:async(k,O)=>{const L=k.text;if(f.isNull(L)){x.error("请填入完整的url");return}const I=x.loading("正在获取配置..."),V=await P.get(L,{allowInterceptConfig:false});if(I.close(),!V.status){b.error(V),x.error("获取配置失败",{consoleLogContent:true});return}await v(V.data.responseText)&&k.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:G.info.width,height:"auto"}),T=E.$shadowRoot.querySelector("input"),A=E.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(T,["input","propertychange"],k=>{c.val(T)===""?c.attr(A,"disabled","true"):c.removeAttr(A,"disabled");}),c.onKeyboard(T,"keydown",(k,O,L)=>{k==="Enter"&&L.length===0&&c.val(T)!==""&&c.emit(A,"click");}),c.emit(T,"input");}),c.on(g,"click",async C=>{c.preventEvent(C),d.close();let E=await j.getClipboardText();if(E.trim()===""){x.warning("获取到的剪贴板内容为空");return}await v(E);});},r=(h=`${ye}_panel-setting-${f.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,d)=>{const w=M.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),u={};if(typeof pe=="function")pe().forEach(d=>{const w=ae(d);Reflect.set(u,d,w);});else {x.warning("不支持函数GM_listValues，仅导出菜单配置");const h=ae(fe);Reflect.set(u,fe,h);}const p=j.toStr(u);l.value=p;},i=()=>{let o=re?.script?.supportURL||re?.script?.namespace;typeof o=="string"&&f.isNotNull(o)&&window.open(o,"_blank");};return [{id:"script-version",title:`版本：${re?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(o){new Ge(o.$asideLiElement).on("tap",function(s){clearTimeout(t),t=void 0,e?(e=false,a()):(t=setTimeout(()=>{e=false,i();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},We={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{S.showPanel(me.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){j.isTopWindow()&&ce.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let n=this.$data.menuOption.findIndex(a=>a.key===t.key);n!==-1&&(this.$data.menuOption[n]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}};class je{storageKey;listenerData;constructor(t){if(typeof t=="string"){const n=t.trim();if(n=="")throw new Error("key参数不能为空字符串");this.storageKey=n;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new ne.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let t=ae(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){J(this.storageKey,t);}set(t,n){const a=this.get(t),i=this.getLocalValue();Reflect.set(i,t,n),this.setLocalValue(i),this.emitValueChangeListener(t,n,a);}get(t,n){const a=this.getLocalValue();return Reflect.get(a,t)??n}getAll(){return this.getLocalValue()}delete(t){const n=this.get(t),a=this.getLocalValue();Reflect.deleteProperty(a,t),this.setLocalValue(a),this.emitValueChangeListener(t,void 0,n);}has(t){const n=this.getLocalValue();return Reflect.has(n,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(n=>Reflect.get(t,n))}clear(){le(this.storageKey);}addValueChangeListener(t,n){const a=Math.random(),i=this.listenerData.get(t)||[];return i.push({id:a,key:t,callback:n}),this.listenerData.set(t,i),a}removeValueChangeListener(t){let n=false;for(const[a,i]of this.listenerData.entries()){for(let o=0;o<i.length;o++){const r=i[o];(typeof t=="string"&&r.key===t||typeof t=="number"&&r.id===t)&&(i.splice(o,1),o--,n=true);}this.listenerData.set(a,i);}return n}async emitValueChangeListener(...t){const[n,a,i]=t;if(!this.listenerData.has(n))return;const o=this.listenerData.get(n);for(let r=0;r<o.length;r++){const s=o[r];if(typeof s.callback=="function"){let l,u;t.length===1||(t.length===2?l=a:t.length===3&&(l=a,u=i)),await s.callback(n,l,u);}}}}const Z=new je(fe),S={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new f.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new f.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new f.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new f.Dictionary),this.__onceExecData},get scriptName(){return ye},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:fe,attributeKeyName:X,attributeDefaultValueName:ee},init(){this.initContentDefaultValue(),We.init();},initContentDefaultValue(){const e=a=>{if(!a.attributes||a.type==="button"||a.type==="container"||a.type==="deepMenu")return;const i=a.attributes;let o=i[ve];if(typeof o=="function"){let u=o();if(typeof u=="boolean"&&!u)return}let r=new Map,s=i[X];if(s!=null){const u=i[ee];r.set(s,u);}let l=i[Qe];if(typeof l=="object"&&l&&Object.keys(l).forEach(u=>{const p=l[u];r.set(u,p);}),!r.size){b.warn("请先配置键",a);return}if(a.type==="switch"){let u=typeof a.disabled=="function"?a.disabled():a.disabled;typeof u=="boolean"&&u&&this.$data.contentConfigInitDisabledKeys.push(...r.keys());}for(const[u,p]of r.entries())this.setDefaultValue(u,p);},t=a=>{for(let i=0;i<a.length;i++){let o=a[i];e(o);let r=o.views;r&&Array.isArray(r)&&t(r);}},n=[...me.getAllContentConfig()];for(let a=0;a<n.length;a++){let i=n[a];if(!i.views)continue;const o=i.views;o&&Array.isArray(o)&&t(o);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&b.warn("该key已存在，初始化默认值失败: "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){Z.set(e,t);},getValue(e,t){const n=Z.get(e);return n??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){Z.delete(e);},hasKey(e){return Z.has(e)},addValueChangeListener(e,t,n){const a=Z.addValueChangeListener(e,t);if(n?.immediate||n?.immediateAll){const i=this.getValue(e);n?.immediate?t(e,i,i):n?.immediateAll&&S.emitMenuValueChange(e,i,i);}return a},removeValueChangeListener(e){Z.removeValueChangeListener(e);},emitMenuValueChange(e,t,n){Z.emitValueChangeListener(e,t,n);},async exec(e,t,n,a=true){const i=this;let o;typeof e=="string"||Array.isArray(e)?o=()=>e:o=e;let r=false;const s=o();let l=[];Array.isArray(s)?(r=true,l=s):l.push(s);const u=l.find(A=>!this.$data.contentConfigInitDefaultValue.has(A));if(u){b.warn(`${u} 键不存在`);return}const p=JSON.stringify(l);if(a&&this.$data.onceExecMenuData.has(p))return this.$data.onceExecMenuData.get(p);let h=[];const d=[];let w=[];const m=(A,k)=>{let O=[],L=[],I=[];if(Array.isArray(k))I=I.concat(k);else {const R=B=>{if(typeof B=="object"&&B!=null)if(B instanceof Element)I.push(B);else {const{$css:q,destory:H}=B;q!=null&&(Array.isArray(q)?I=I.concat(q):I.push(q)),typeof H=="function"&&I.push(H);}else I.push(B);};if(k!=null&&Array.isArray(k))for(const B of k)R(B);else R(k);}const V=R=>{if(R!=null){if(R instanceof Element){O.push(R);return}if(typeof R=="function"){L.push(R);return}}};for(const R of I){const B=V(R);if(typeof B=="boolean"&&!B)break;if(Array.isArray(R))for(const q of R){const H=V(q);if(typeof H=="boolean"&&!H)break}}y(),v(),A&&(h=h.concat(O),w=w.concat(L));},g=A=>!!this.getValue(A),y=()=>{for(let A=0;A<h.length;A++)h[A]?.remove(),h.splice(A,1),A--;},v=()=>{for(let A=0;A<w.length;A++){const k=w[A];k(),w.splice(A,1),A--;}},C=()=>{let A=false;return typeof n=="function"?A=n(l):A=l.every(k=>g(k)),A},E=async A=>{const k=C();let O=[];if(k){const L=l.map(I=>this.getValue(I));O=await t({key:l,triggerKey:A?.key,value:r?L:L[0],addStoreValue:(...I)=>m(k,I)});}m(k,O);};a&&l.forEach(A=>{const k=this.addValueChangeListener(A,(O,L,I)=>E({key:O}));d.push(k);}),await E();const T={reload(){this.clearStoreStyleElements(),this.destory(),E();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>y(),destory(){return v()},removeValueChangeListener:()=>{d.forEach(A=>{this.removeValueChangeListener(A);});},clearOnceExecMenuData(){a&&i.$data.onceExecMenuData.delete(p);}};return this.$data.onceExecMenuData.set(p,T),T},async execMenu(e,t,n=false,a=false){return await this.exec(e,async i=>await t(i),i=>i.every(r=>{let s=!!this.getValue(r);return S.$data.contentConfigInitDisabledKeys.includes(r)&&(s=false,b.warn(`.execMenu${a?"Once":""} ${r} 被禁用`)),n&&(s=!s),s}),a)},async execMenuOnce(e,t,n=false,a=false){const i=await this.execMenu(e,t,n,true);if(a&&i){const o=()=>{i.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,o);}return i},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),Z.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t),{off:()=>this.removeUrlChangeWithExecMenuOnceListener(e)}},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async emitUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const n of t)await n(e);},showPanel(e,t=`${ye}-设置`,n=false,a=false){this.$data.$panel=null,this.$data.panelContent=[];const i=e.findIndex(r=>(typeof r.isBottom=="function"?r.isBottom():!!r.isBottom)&&r.id==="script-version")!==-1;!n&&!i&&e.push(...me.getDefaultBottomContentConfig());const o=M.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:r=>{r.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:r=>{r(),this.$data.$panel=null;}},width:G.setting.width,height:G.setting.height,drag:true,only:true,style:`
      ...
      `,...this.$data.panelConfig});this.$data.$panel=o,this.$data.panelContent=e,a||this.registerConfigSearch({$panel:o,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,a=async(d,w)=>{if(d==null)return;const m=await w(d);return m&&typeof m.isFind=="boolean"&&m.isFind?m.data:await a(m.data,w)},i=(d,w)=>{const m=new IntersectionObserver(g=>{g.forEach(y=>{y.isIntersecting&&(w?.(),m.disconnect());});},{root:null,threshold:1});m.observe(d),d.scrollIntoView({behavior:"smooth",block:"center"});},o=d=>{const w="pops-flashing";c.onAnimationend(d,()=>{d.classList.remove(w);}),d.classList.add(w);},r=d=>{if(d.type==="dblclick"&&h)return;c.preventEvent(d);const w=M.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});w.$shadowRoot.querySelector(".search-wrapper");const m=w.$shadowRoot.querySelector(".search-config-text"),g=w.$shadowRoot.querySelector(".search-result-wrapper");m.focus();const y=()=>{c.empty(g);},v=E=>{const T=f.queryProperty(E,O=>O?.next?{isFind:false,data:O.next}:{isFind:true,data:O}),A=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),k=M.fn.PanelHandlerComponents();return c.on(A,"click",()=>{const L=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[E.index];if(!L){x.error(`左侧项下标${E.index}不存在`);return}L.scrollIntoView({behavior:"smooth",block:"center"}),L.click(),a(E.next,async I=>{if(I?.next){const V=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(R=>{const B=Reflect.get(R,k.$data.nodeStoreConfigKey);return typeof B=="object"&&B!=null&&B.text===I.name}),2500);if(V)V.click();else return x.error("未找到对应的二级菜单"),{isFind:true,data:I};return {isFind:false,data:I.next}}else {const V=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(R=>Reflect.get(R,k.$data.nodeStoreConfigKey)===I.matchedData?.formConfig),2500);if(V){i(V);const R=V.closest(".pops-panel-forms-fold[data-fold-enable]");R&&(R.querySelector(".pops-panel-forms-fold-container").click(),await f.sleep(500)),i(V,()=>{o(V);});}else x.error("未找到对应的菜单项");return {isFind:true,data:I}}});}),A},C=E=>{const T=new RegExp(E,"i"),A=[],k=(L,I)=>{for(let V=0;V<L.length;V++){const R=L[V],B=R.views;if(B&&Array.isArray(B)){const q=f.deepClone(I);if(R.type==="deepMenu"){const H=f.queryProperty(q,ie=>ie?.next?{isFind:false,data:ie.next}:{isFind:true,data:ie});H.next={name:R.text};}k(B,q);}else {let q,H;if(R.type==="own"){const z=Reflect.get(R.attributes||{},Be);z&&(typeof z.text=="string"&&(q=z.text),typeof z.desc=="string"&&(H=z.desc));}else q=R.text,H=Reflect.get(R,"description");const ie=[q,H],Ae=ie.findIndex(z=>{if(typeof z=="string")return z.match(T)});if(Ae!==-1){const z=f.deepClone(I),Ce=f.queryProperty(z,Y=>Y?.next?{isFind:false,data:Y.next}:{isFind:true,data:Y});Ce.next={name:q,matchedData:{path:"",formConfig:R,matchedText:ie[Ae],description:H}};const ke=[];f.queryProperty(z,Y=>{const be=Y?.name;return typeof be=="string"&&be.trim()!==""&&ke.push(be),Y?.next?{isFind:false,data:Y.next}:{isFind:true,data:Y}});const $e=ke.join(j.escapeHtml(" - "));Ce.next.matchedData.path=$e,A.push(z);}}}};for(let L=0;L<n.length;L++){const I=n[L];if(!I.views||I.isBottom&&I.id==="script-version")continue;const V=I.views;if(V&&Array.isArray(V)){let R=I.title;typeof R=="function"&&(R=R()),k(V,{index:L,name:R});}}const O=document.createDocumentFragment();for(const L of A){let I=v(L);O.appendChild(I);}y(),g.append(O);};c.on(m,"input",f.debounce(E=>{c.preventEvent(E);let T=c.val(m).trim();if(T===""){y();return}C(T);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(d=>{c.on(d,"dblclick",r);});let l=new WeakMap,u=false,p,h=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(d,w)=>{h=true,clearTimeout(p),p=void 0,u&&l.has(w)?(u=false,l.delete(w),r(d)):(p=setTimeout(()=>{u=false;},200),u=true,l.set(w,d));},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
    			.pops-flashing{
    ...
    `),()=>{c.remove(i);}]},async quickReplyOptimization(){const e=await c.waitNode('#scrolltop a[title="快速回复"]',1e4);return e?(b.info("快捷回复优化"),c.on(e,"click",function(){U.showWindow("reply",e.href),b.info("等待弹窗出现"),c.waitNode("#moreconf",1e4).then(n=>{if(!n)return;b.success("弹出出现，添加按钮");let a=c.createElement("button",{innerText:"一键空格",type:"button",id:"insertspace2"},{style:"float: left;"});c.on(a,"click",i=>{c.preventEvent(i),c.val(K("#postmessage"),c.val(K("#postmessage"))+"           ");}),c.append(n,a);});}).off):void 0}},Je=".pls .avatar img,.avtm img{border-radius:10%}.pls .avatar img{--avatar-size: 90px;width:var(--avatar-size);height:var(--avatar-size)}";Fe(Je);const Ue={$flag:{isSetHljsCSS:false},init(){Ze.init(),S.execMenuOnce("mt-forum-post-autoExpandContent",()=>this.autoExpandContent()),S.execMenuOnce("mt-forum-post-repairImageWidth",()=>this.repairImageWidth()),S.execMenuOnce("mt-forum-post-hideBottomInfoBlock",()=>this.hideBottomInfoBlock()),c.onReady(()=>{S.execMenu("mt-forum-post-removeFontStyle",()=>{this.removeFontStyle();}),S.execMenu("mt-forum-post-removeCommentFontStyle",()=>{this.removeCommentFontStyle();}),S.execMenuOnce("mt-forum-post-loadNextPageComment",()=>this.loadNextPageComment()),S.execMenuOnce("mt-forum-post-codeQuoteOptimization",()=>this.codeQuoteOptimization()),S.execMenuOnce("mt-forum-post-optimizationImagePreview",()=>this.optimizationImagePreview()),S.execMenuOnce("mt-forum-post-interceptionAttachment",()=>this.setAttachmentsClickTip()),S.execMenu("mt-forum-post-detectingUserOnlineStatus",()=>{this.detectingUserOnlineStatus();}),S.execMenu("mt-forum-post-showUserLevel",()=>{this.showUserLevel();});});},autoExpandContent(){return b.info("自动展开帖子内容"),[W(`
		...
		`)}},Xe={init(){c.onReady(()=>{S.execMenuOnce("mt-guide-beautifyPage",()=>{this.beautifyPage();});});},beautifyPage(){b.info("页面美化"),W(`
		.xst{font-size:15px}
	...
	`),F(".bm_c table tbody").forEach(e=>{let t=e.querySelector("th.common"),n=c.html(t),a=t.querySelectorAll("a")[0].getAttribute("href"),i=null,r=e.querySelector("td.by>cite>a").getAttribute("href").match(/uid-(\d+)/)[1],s=`
			...
			`;c.html(e,s);});}},Re=function(e,t,n,a,i,o,r,s,l,u){const p={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:a,buttonIsRightIcon:i,buttonIconIsLoading:o,buttonType:r,buttonText:n,callback(h){typeof s=="function"&&s(h);},afterAddToUListCallBack:l};return Reflect.set(p.attributes,ve,()=>{p.disable=false;}),p},Te=function(e,t,n,a,i,o="",r="text",s,l){const u={text:e,type:"input",inputType:r,attributes:{},props:{},description:a,placeholder:o,afterAddToUListCallBack:s,getValue(){return this.props[D].get(t,n)},callback(p,h){p.target.validity.valid,this.props[D].set(t,h);}};return Reflect.set(u.attributes,X,t),Reflect.set(u.attributes,ee,n),ue.initComponentsStorageApi("input",u,{get(p,h){return S.getValue(p,h)},set(p,h){S.setValue(p,h);}}),u},Me=function(e,t,n,a,i,o="",r,s){const l={text:e,type:"input",inputType:"number",attributes:{},props:{},description:a,placeholder:o,afterAddToUListCallBack:r,getValue(){return this.props[D].get(t,n)},callback(u,p,h){this.props[D].set(t,p);}};return Reflect.set(l.attributes,X,t),Reflect.set(l.attributes,ee,n),ue.initComponentsStorageApi("input",l,{get(u,p){return S.getValue(u,p)},set(u,p){S.setValue(u,p);}}),l},Le=function(e,t,n,a,i,o){const r={type:"own",attributes:{},props:{},createLIElement:e,afterAddToUListCallBack:o};return Reflect.set(r.attributes,ve,()=>false),typeof n=="object"&&n!==null&&Reflect.set(r.attributes,Be,n),r},De=function(e,t,n,a,i,o,r){const s={text:e,type:"select",description:o,attributes:{},props:{},getValue(){return this.props[D].get(t,n)},callback(l){if(l==null)return;const u=l.value;if(b.info(`选择：${l.text}`),typeof i=="function"&&i(l))return;this.props[D].set(t,u);},data:a};return Reflect.set(s.attributes,X,t),Reflect.set(s.attributes,ee,n),ue.initComponentsStorageApi("select",s,{get(l,u){return S.getValue(l,u)},set(l,u){S.setValue(l,u);}}),s},xe=function(e,t,n,a,i,o="",r,s){const l={text:e,type:"textarea",attributes:{},props:{},description:a,placeholder:o,disabled:r,getValue(){const p=this.props[D].get(t,n);return Array.isArray(p)?p.join(`
`):p},callback(u,p){this.props[D].set(t,p);}};return Reflect.set(l.attributes,X,t),Reflect.set(l.attributes,ee,n),ue.initComponentsStorageApi("switch",l,{get(u,p){return S.getValue(u,p)},set(u,p){S.setValue(u,p);}}),l},ue={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new ne.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,n){let a;this.hasStorageApi(e)?a=this.getStorageApi(e):a=n,this.setComponentsStorageApiProperty(t,a);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,D,t);}},_=function(e,t,n,a,i,o,r,s,l){const u={text:e,type:"switch",description:i,disabled:r,attributes:{},props:{},getValue(){return this.props[D].get(t,n)},callback(p,h){const d=!!h;b.success(`${d?"开启":"关闭"} ${e}`),this.props[D].set(t,d);},afterAddToUListCallBack:(...p)=>{}};return Reflect.set(u.attributes,X,t),Reflect.set(u.attributes,ee,n),ue.initComponentsStorageApi("switch",u,{get(p,h){return S.getValue(p,h)},set(p,h){S.setValue(p,h);}}),u};class _e{option;constructor(t){this.option=t;}async showView(){const t=M.confirm({title:{text:this.option.title,position:"center"},content:{text:`
...
`)}
      ...
      `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return ae(this.$key.STORAGE_KEY,this.getTemplateData())},setData(e){J(this.$key.STORAGE_KEY,e);}};class tt{option;constructor(t){this.option=t;}async showView(t){const n=M.confirm({title:{text:this.option.title,position:"center"},content:{text:`
...
`,rt={$data:{},init(){this.registerMenu();},registerMenu(){ce.add({key:"online-user",text:"⚙ 在线用户",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let e=x.loading("正在获取在线用户名单中..."),t=await this.getOnlineUserListInfo();if(e.close(),!t)return;let n=M.alert({title:{text:"在线用户",position:"center"},content:{text:`
            ...
            `},{"data-name":e.name,"data-uid":e.uid,"data-sf":e.sf});return N.on(t,"click",".online-user-avatar",n=>{N.preventEvent(n),window.open(`home.php?mod=space&uid=${e.uid}&do=profile`,"_blank");}),t}},st={$flag:{showUserUID_initCSS:false},init(){S.onceExec("mt-MTCommentFilter",()=>{et.init();}),se.isPost()?(b.info("Router: 帖子"),Ue.init()):se.isGuide()?(b.info("Router: 导读"),Xe.init()):b.error("Router: 未适配的链接 ==> "+window.location.href),c.onReady(()=>{S.onceExec("mt-MTProductListingReminder",()=>{nt.init();}),S.onceExec("mt-blackHome",()=>{it.init();}),S.onceExec("mt-onlineUser",()=>{rt.init();}),S.execMenuOnce("mt-addLatestPostBtn",()=>this.addLatestPostBtn()),S.execMenu("mt-auto-sign",()=>{he.init();}),S.execMenu("mt-extend-cookie-expire",()=>{this.extendCookieExpire();}),se.isPostPublish_edit()||S.execMenuOnce("mt-link-text-to-hyperlink",()=>Ye());});},addLatestPostBtn(){b.info("新增【最新发表】");const e=c.createElement("li",{id:"latest_publication",innerHTML:`
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,n,a){c.on(e,"change",i=>{if(!e.files?.length)return;c.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let o=e.files[0],r=o.size,s=new Image,l=new FileReader;l.readAsDataURL(o),l.onload=function(u){s.src=u.target.result,s.onload=function(){if(s.width>n.width||s.height>n.height){e.value="",t.setAttribute("data-success","false"),c.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${s.width} 高：${s.height}`);return}if(r>te.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),c.text(t,`🤡校验失败 ==> 图片大小不符合：${r}byte，限制最大：${te.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),c.text(t,`🤣 通过 宽:${s.width} 高:${s.height} 大小(byte):${r}`),a();};};});},async getUploadUrl(){let e=await P.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":f.getRandomPCUA()}});if(!e.status)return;if(f.isNull(e.data.responseText)){x.error("动态头像：获取上传地址的内容失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){x.error("动态头像：获取变量data失败");return}let a=t[t.length-1].split(","),i=a.indexOf("stl_src");if(i===-1&&(i=a.indexOf("src")),i===-1){x.error("动态头像：获取上传地址失败");return}let o=a[i+1],r=new URL(o);return r.pathname=r.pathname.replace("/images/camera.swf","/index.php"),r.searchParams.delete("inajax"),r.searchParams.set("m","user"),r.searchParams.set("a","rectavatar"),r.searchParams.set("base64","yes"),o=r.toString(),b.info("上传地址："+o),o}},lt={id:"component-common",title:"通用",views:[{text:"",type:"container",views:[{text:"Toast配置",type:"deepMenu",views:[{text:"",type:"container",views:[De("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],e=>{b.info("设置当前Qmsg弹出位置"+e.text);},"Toast显示在页面九宫格的位置"),De("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),_("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]}]},{text:"",type:"container",views:[{text:"功能",type:"deepMenu",views:[{text:"",type:"container",views:[_("新增【最新发表】","mt-addLatestPostBtn",true,void 0,"便于快捷跳转"),_("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),_("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{type:"deepMenu",text:"自动签到",views:[{text:"",type:"container",views:[_("启用","mt-auto-sign",true,void 0,"自动请求签到"),_("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),Re("签到信息",`上次签到时间：${(()=>{let e=he.getHostNameSignInfo(window.location.hostname);return e?ne.formatTime(e.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",e=>{let n=e.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");M.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:a=>{let i=window.location.hostname;he.clearSignInfo(i),x.success("删除成功"),c.text(n,`上次签到时间：${(()=>{let o=he.getHostNameSignInfo(i);return o?ne.formatTime(o.time):"尚未签到"})()}`),a.close();}}},width:"300px",height:"200px"});})]}]},{text:"头像",type:"deepMenu",views:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"container",views:[Le(e=>{const t=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return n.querySelector(".avatar-img[data-size='small']"),n.querySelector(".avatar-img[data-size='middle']"),n.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(n),e.appendChild(a),e},void 0,{text:"头像（有缓存）",desc:"小、中、大"}),Le(e=>{const t=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return e.appendChild(t),e.appendChild(n),e},void 0,{text:"头像",desc:"小、中、大"}),Re("修改头像",`可以上传gif图片，注意图片最大限制为${ne.formatByteToSize(te.$data.avatarInfo.maxSize)}`,"上传",void 0,false,false,"primary",()=>{te.init();})]}]}]}]},ct={id:"component-forum-post",title:"帖子",views:[{type:"container",text:"",views:[{text:"功能",type:"deepMenu",views:[{type:"container",text:"",views:[_("拦截附件","mt-forum-post-interceptionAttachment",true,void 0,"点击附件时弹出提示框进行确认是否下载附件"),_("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片"),_("自动加载下一页","mt-forum-post-loadNextPageComment",true,void 0,"无缝预览下一页"),_("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮")]}]},{type:"deepMenu",text:"用户信息块",views:[{type:"container",text:"",views:[_("探测用户在线状态","mt-forum-post-detectingUserOnlineStatus",false,void 0,"获取用户在线状态并在用户信息处显示状态表情"),_("显示用户等级","mt-forum-post-showUserLevel",true,void 0,"在用户信息处显示当前用户的等级"),_("隐藏底部信息块","mt-forum-post-hideBottomInfoBlock",false,void 0,"包括金币、好评、信誉等信息")]}]},{type:"deepMenu",text:"右侧悬浮工具栏",views:[{type:"container",text:"",views:[_("新增【快捷收藏】","mt-forum-post-quickCollentBtn",true,void 0,"在右侧悬浮工具栏添加【收藏】按钮，用于快捷收藏"),_("快捷回复优化","mt-forum-post-quickReplyOptimization",true,void 0,"为快捷回复弹窗底部区域添加【一键空格】按钮")]}]}]}]},ut={id:"component-guide",title:"导读",views:[{type:"container",text:"",views:[_("页面美化","mt-guide-beautifyPage",true,void 0,"美化样式")]}]};me.addContentConfig([lt,ct,ut]);S.init();st.init();

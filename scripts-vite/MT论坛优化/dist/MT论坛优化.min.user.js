...
`)}
      ...
      `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return ne(this.$key.STORAGE_KEY,this.getTemplateData())},setData(e){J(this.$key.STORAGE_KEY,e);}};class tt{option;constructor(t){this.option=t;}async showView(t){const n=M.confirm({title:{text:this.option.title,position:"center"},content:{text:`

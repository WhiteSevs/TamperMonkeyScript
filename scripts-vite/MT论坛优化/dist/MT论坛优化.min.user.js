...
(function (x, U, q, ie, ce, _e) {
	...
	var Ae=typeof GM<"u"?GM:void 0,we=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Ce=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,re=typeof GM_getValue<"u"?GM_getValue:void 0,ne=typeof GM_info<"u"?GM_info:void 0,Ue=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,j=typeof GM_setValue<"u"?GM_setValue:void 0,Be=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Fe=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,F=typeof unsafeWindow<"u"?unsafeWindow:void 0,qe=window;const oe={waitRemove(...e){e.forEach(t=>{typeof t=="string"&&p.waitNodeList(t).then(a=>{a.forEach(n=>n.remove());});});},createBlockCSSNode(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(a=>{Array.isArray(a)?t=t.concat(a):t.push(a);}),U.createElement("style",{type:"text/css",innerHTML:`${t.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof Ce=="function"?Ce(e.keyName):null;typeof t=="string"&&t?Q(t):oe.loadStyleLink(e.url);},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,U.ready(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(a=>{t.onload=()=>{a(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;let t=new URL(e);return t.protocol="https:",t.toString()},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let a=[document.documentElement,document.body].concat(...e||[]);return a.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){a.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(i=>{n(i);}).catch(i=>{f.error("读取剪贴板内容失败👉",i),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(i=>{e(n);}).catch(i=>{f.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(n);});}function a(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!a()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,a=5e3){let n,i=a-t,r=t,o=async l=>{let s=await e(l);if(typeof s=="boolean"&&!s||l){p.workerClearTimeout(n);return}if(r+=t,r>i){o(true);return}n=p.workerSetTimeout(()=>{o(false);},t);};o(false);},findParentNode(e,t,a){if(a){let n=U.closest(e,a);if(n)return n.querySelector(t)}else return U.matches(e,t)?e:U.closest(e,t)}},Re={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}},ee={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},p=q.noConflict(),d=U.noConflict(),I=ie,f=new p.Log(ne,F.console||qe.console);let Se=ne?.script?.name||void 0;ie.config.Utils.AnyTouch();const Te=false;f.config({debug:Te,logMaxCount:1e3,autoClearConsole:true,tag:true});x.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.getSetting().type;if(t==="loading")return  false;const a=e.getSetting().content;return t==="warning"?f.warn(a):t==="error"?f.error(a):f.info(a),true},get position(){return A.getValue(ee.qmsg_config_position.key,ee.qmsg_config_position.defaultValue)},get maxNums(){return A.getValue(ee.qmsg_config_maxnums.key,ee.qmsg_config_maxnums.defaultValue)},get showReverse(){return A.getValue(ee.qmsg_config_showreverse.key,ee.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=q.getMaxZIndex(),t=ie.config.InstanceUtils.getPopsMaxZIndex().zIndex;return q.getMaxValue(e,t)+100}});I.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=q.getMaxZIndex(void 0,void 0,a=>{if(a?.classList?.contains("qmsg-shadow-container")||a?.closest("qmsg")&&a.getRootNode()instanceof ShadowRoot)return  false}),t=ie.config.InstanceUtils.getPopsMaxZIndex().zIndex;return q.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const le=new p.GM_Menu({GM_getValue:re,GM_setValue:j,GM_registerMenuCommand:Ue,GM_unregisterMenuCommand:Be}),B=new p.Httpx({xmlHttpRequest:Fe,logDetails:Te});B.interceptors.request.use(e=>e);B.interceptors.response.use(void 0,e=>(f.error("拦截器-请求错误",e),e.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),e));F.Object.defineProperty,F.Function.prototype.apply,F.Function.prototype.call,F.Element.prototype.appendChild,F.setTimeout;const Q=p.addStyle.bind(p),$=U.selector.bind(U),P=U.selectorAll.bind(U);new p.GM_Cookie;const Me="GM_Panel",xe="data-init",Y="data-key",Z="data-default-value",Ne="data-init-more-value",R="data-storage-api",W={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},G={setting:{get width(){return W.width<550?"88vw":W.width<700?"550px":"700px"},get height(){return W.height<450?"70vh":W.height<550?"450px":"550px"}},settingMiddle:{get width(){return W.width<350?"88vw":"350px"}},settingBig:{get width(){return W.width<800?"92vw":"800px"},get height(){return W.height<600?"80vh":"600px"}}};class Pe{storageKey;listenerData;constructor(t){if(typeof t=="string"){let a=t.trim();if(a=="")throw new Error("key参数不能为空字符串");this.storageKey=a;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new q.Dictionary;}getLocalValue(){let t=re(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){j(this.storageKey,t);}set(t,a){let n=this.get(t),i=this.getLocalValue();Reflect.set(i,t,a),this.setLocalValue(i),this.triggerValueChangeListener(t,n,a);}get(t,a){let n=this.getLocalValue();return Reflect.get(n,t)??a}getAll(){return this.getLocalValue()}delete(t){let a=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,a,void 0);}has(t){let a=this.getLocalValue();return Reflect.has(a,t)}keys(){let t=this.getLocalValue();return Reflect.ownKeys(t)}values(){let t=this.getLocalValue();return Reflect.ownKeys(t).map(a=>Reflect.get(t,a))}clear(){we(this.storageKey);}addValueChangeListener(t,a){let n=Math.random(),i=this.listenerData.get(t)||[];return i.push({id:n,key:t,callback:a}),this.listenerData.set(t,i),n}removeValueChangeListener(t){let a=false;for(const[n,i]of this.listenerData.entries()){for(let r=0;r<i.length;r++){const o=i[r];(typeof t=="string"&&o.key===t||typeof t=="number"&&o.id===t)&&(i.splice(r,1),r--,a=true);}this.listenerData.set(n,i);}return a}triggerValueChangeListener(t,a,n){if(!this.listenerData.has(t))return;let i=this.listenerData.get(t);for(let r=0;r<i.length;r++){const o=i[r];if(typeof o.callback=="function"){let l=this.get(t),s,c;typeof a<"u"&&arguments.length>=2?c=a:c=l,typeof n<"u"&&arguments.length>2?s=n:s=l,o.callback(t,c,s);}}}}const z=new Pe(Me),de={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new p.Dictionary),this.__contentConfig}},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){return [{id:"script-version",title:`版本：${ne?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(e,t,a){let n=ne?.script?.supportURL||ne?.script?.namespace;return typeof n=="string"&&p.isNotNull(n)&&window.open(n,"_blank"),false}}]}},$e={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{A.showPanel(de.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){A.isTopWindow()&&le.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let a=this.$data.menuOption.findIndex(n=>n.key===t.key);a!==-1&&(this.$data.menuOption[a]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},A={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new p.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new p.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new p.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new p.Dictionary),this.__onceExecData},get scriptName(){return Se},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:Me,attributeKeyName:Y,attributeDefaultValueName:Z},init(){this.initContentDefaultValue(),$e.init();},isTopWindow(){return F.top===F.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;let i=n.attributes[xe];if(typeof i=="function"){let s=i();if(typeof s=="boolean"&&!s)return}let r=new Map,o=n.attributes[Y];if(o!=null){const s=n.attributes[Z];r.set(o,s);}let l=n.attributes[Ne];if(typeof l=="object"&&l&&Object.keys(l).forEach(s=>{r.set(s,l[s]);}),!r.size){f.warn(["请先配置键",n]);return}if(n.type==="switch"){let s=typeof n.disabled=="function"?n.disabled():n.disabled;typeof s=="boolean"&&s&&this.$data.contentConfigInitDisabledKeys.push(...r.keys());}for(const[s,c]of r.entries())this.setDefaultValue(s,c);},t=n=>{for(let i=0;i<n.length;i++){let r=n[i];e(r);let o=r.forms;o&&Array.isArray(o)&&t(o);}},a=[...de.getAllContentConfig()];for(let n=0;n<a.length;n++){let i=a[n];if(!i.forms)continue;const r=i.forms;r&&Array.isArray(r)&&t(r);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&f.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},setValue(e,t){z.set(e,t);},getValue(e,t){let a=z.get(e);return a??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){z.delete(e);},hasKey(e){return z.has(e)},addValueChangeListener(e,t){return z.addValueChangeListener(e,(n,i,r)=>{t(e,r,i);})},removeValueChangeListener(e){z.removeValueChangeListener(e);},triggerMenuValueChange(e,t,a){z.triggerValueChangeListener(e,a,t);},exec(e,t,a,n=true){const i=this;let r;typeof e=="string"||Array.isArray(e)?r=()=>e:r=e;let o=false,l=r(),s=[];Array.isArray(l)?(o=true,s=l):s.push(l);let c=s.find(C=>!this.$data.contentConfigInitDefaultValue.has(C));if(c){f.warn(`${c} 键不存在`);return}let u=JSON.stringify(s);if(n&&this.$data.onceExecMenuData.has(u))return this.$data.onceExecMenuData.get(u);let m=[],h=[],v=(C,k)=>{let D=[];Array.isArray(k)||(k=[k]),k.forEach(_=>{if(_!=null&&_ instanceof HTMLStyleElement){D.push(_);return}}),m=m.concat(D);},w=C=>this.getValue(C),g=()=>{for(let C=0;C<m.length;C++)m[C].remove(),m.splice(C,1),C--;},b=()=>{let C=false;return typeof a=="function"?C=a(s):C=s.every(k=>w(k)),C},S=C=>{let k=b(),D=[];if(k){let _=s.map(E=>this.getValue(E)),T=t({value:o?_:_[0],addStyleElement:(...E)=>v(true,...E)});Array.isArray(T)||(T=[T]),T.forEach(E=>{if(E!=null&&E instanceof HTMLStyleElement){D.push(E);return}});}g(),m=[...D];};n&&s.forEach(C=>{let k=this.addValueChangeListener(C,(D,_,T)=>{S();});h.push(k);}),S();let y={reload(){S();},clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),n&&i.$data.onceExecMenuData.delete(u);},clearStoreStyleElements:()=>g(),removeValueChangeListener:()=>{h.forEach(C=>{this.removeValueChangeListener(C);});}};return this.$data.onceExecMenuData.set(u,y),y},execMenu(e,t,a=false,n=false){return this.exec(e,i=>t(i),i=>i.every(o=>{let l=!!this.getValue(o);return A.$data.contentConfigInitDisabledKeys.includes(o)&&(l=false,f.warn(`.execMenu${n?"Once":""} ${o} 被禁用`)),a&&(l=!l),l}),n)},execMenuOnce(e,t,a=false,n=false){const i=this.execMenu(e,t,a,true);if(n&&i){const r=()=>{i.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,r);const o=i.clear;i.clear=()=>{o(),this.removeUrlChangeWithExecMenuOnceListener(e);};}return i},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),z.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},triggerUrlChangeWithExecMenuOnceEvent(e){this.$data.urlChangeReloadMenuExecOnce.forEach((t,a)=>{t(e);});},showPanel(e,t=`${Se}-设置`,a=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let i=e.findIndex(o=>(typeof o.isBottom=="function"?o.isBottom():!!o.isBottom)&&o.id==="script-version")!==-1;!a&&!i&&e.push(...de.getDefaultBottomContentConfig());let r=I.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(o,l)=>{o.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(o,l)=>{o(),this.$data.$panel=null;}},width:G.setting.width,height:G.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=r,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:r,content:e});},registerConfigSearch(e){const{$panel:t,content:a}=e;let n=async(u,m)=>{if(u==null)return;let h=await m(u);return h&&typeof h.isFind=="boolean"&&h.isFind?h.data:await n(h.data,m)},i=(u,m)=>{const h=new IntersectionObserver(v=>{v.forEach(w=>{w.isIntersecting&&(m?.(),h.disconnect());});},{root:null,threshold:1});h.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},r=u=>{const m="pops-flashing";d.animationend(u,()=>{u.classList.remove(m);}),u.classList.add(m);},o=(u,m)=>{p.preventEvent(u);let h=I.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});h.$shadowRoot.querySelector(".search-wrapper");let v=h.$shadowRoot.querySelector(".search-config-text"),w=h.$shadowRoot.querySelector(".search-result-wrapper");v.focus();let g=()=>{d.empty(w);},b=y=>{const C=p.queryProperty(y,D=>D?.next?{isFind:false,data:D.next}:{isFind:true,data:D});let k=d.createElement("div",{className:"search-result-item",innerHTML:`
			...
			`,d.prepend(e,i);});},quickReplyOptimization(){p.waitNode('#scrolltop a[title="快速回复"]',1e4).then(e=>{e&&(f.info("快捷回复优化"),d.on(e,"click",function(){F.showWindow("reply",e.href),f.info("等待弹窗出现"),p.waitNode("#moreconf",1e4).then(t=>{if(!t)return;f.success("弹出出现，添加按钮");let a=d.createElement("button",{innerText:"一键空格",type:"button",id:"insertspace2"},{style:"float: left;"});d.on(a,"click",n=>{p.preventEvent(n),d.val($("#postmessage"),d.val($("#postmessage"))+"           ");}),d.append(t,a);});}));});}},Qe=".pls .avatar img,.avtm img{border-radius:10%}.pls .avatar img{--avatar-size: 90px;width:var(--avatar-size);height:var(--avatar-size)}";Oe(Qe);const Le={$flag:{isSetHljsCSS:false},init(){ze.init(),A.execMenuOnce("mt-forum-post-autoExpandContent",()=>this.autoExpandContent()),A.execMenuOnce("mt-forum-post-repairImageWidth",()=>this.repairImageWidth()),A.execMenuOnce("mt-forum-post-hideBottomInfoBlock",()=>this.hideBottomInfoBlock()),d.ready(()=>{A.execMenu("mt-forum-post-removeFontStyle",()=>{this.removeFontStyle();}),A.execMenu("mt-forum-post-removeCommentFontStyle",()=>{this.removeCommentFontStyle();}),A.execMenuOnce("mt-forum-post-loadNextPageComment",()=>{this.loadNextPageComment();}),A.execMenuOnce("mt-forum-post-codeQuoteOptimization",()=>{this.codeQuoteOptimization();}),A.execMenuOnce("mt-forum-post-optimizationImagePreview",()=>{this.optimizationImagePreview();}),A.execMenuOnce("mt-forum-post-interceptionAttachment",()=>{this.setAttachmentsClickTip();}),A.execMenu("mt-forum-post-detectingUserOnlineStatus",()=>{this.detectingUserOnlineStatus();}),A.execMenu("mt-forum-post-showUserLevel",()=>{this.showUserLevel();});});},autoExpandContent(){return f.info("自动展开帖子内容"),[Q(`
		...
		`),ce.registerLanguage("smali",e);let t=new p.LockFunction(()=>{function a(i,r="java"){i.oldValue||(i.oldValue=i.textContent),i.innerHTML=ce.highlight(i.oldValue,{language:r}).value.replace(/\\n$/gi,"");}document.querySelectorAll("em[onclick^=copycode]").forEach(i=>{if(i.nextElementSibling&&typeof i.nextElementSibling.className=="string"&&i.nextElementSibling.className=="code-select-language")return;let r=ce.highlightAuto(d.text(i.parentElement.querySelector("div[id^=code]"))).language,o=document.createElement("select"),l=ce.listLanguages().sort();l=l.concat("自动检测");let s="";l.forEach(c=>{c.startsWith("自动检测")?s+=`<option data-value="${r}" selected="selected">${c}(${r})</option>`:s+=`<option data-value="${c}">${c}</option>`;}),o.className="code-select-language",o.innerHTML=s,d.on(o,"change",()=>{let c=o.selectedOptions[0].getAttribute("data-value");f.info("切换代码块语言: ",c),d.parent(o).querySelectorAll("li").forEach(u=>{a(u,c);});}),p.preventEvent(o,"click"),p.preventEvent(i,"click"),i.insertAdjacentElement("afterend",o),p.dispatchEvent(o,"change");}),document.querySelectorAll(".blockcode").forEach(i=>i.className="hljs");},this,500);p.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{t.run();}});},optimizationImagePreview(){f.info("图片查看优化");let e=[{hostName:"avatar-bbs.mt2.cn",pathName:"*"},{hostName:"cdn-bbs.mt2.cn",pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"/uc_server/avatar.php"}];function t(i=[],r=0){let o="";i.forEach(c=>{o+=`<li><img data-src="${c}"></li>`;});let l=d.createElement("ul",{innerHTML:o}),s=new _e(l,{inline:false,url:"data-src",zIndex:p.getMaxZIndex()+100,hidden:()=>{s.destroy();}});s.view(r),s.zoomTo(1),s.show();}function a(){P("#postlist .comiis_vrx:not([data-isHandlingViewIMG])").forEach(i=>{i.setAttribute("data-isHandlingViewIMG","true");let r=[];i.querySelectorAll("img").forEach(o=>{let l=o.getAttribute("file")||o.src;if(p.isNull(l))return;let s=new URL(l).hostname,c=new URL(l).pathname,u=o.parentElement;u.nodeName.toLowerCase()==="a"&&u.getAttribute("href")===l&&(u.setAttribute("href","javascript:;"),u.removeAttribute("target"));let m=false;for(let h of e)if(s.indexOf(h.hostName)!=-1&&c.match(h.pathName)){m=true;break}m||(r.push(l),o.removeAttribute("onclick"),o.setAttribute("onclick",""),d.on(o,"click",function(h){p.preventEvent(h),f.info("点击图片",o);let v=r.findIndex(w=>w==l);t(r,v);},{capture:true}));});});}let n=new p.LockFunction(()=>{a();});p.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{n.run();}});},setAttachmentsClickTip(){f.info("附件点击提醒");function e(t){if(t.hasAttribute("href")){let a=t.hasAttribute("id")?t.id:t.parentElement.id,n=t.getAttribute("href"),i=t.innerText;if(document.querySelector(`#${a}_menu`).innerText.indexOf("金币")===-1)return;console.log("发现附件",t),console.log("该附件是金币附件，拦截！"),t.setAttribute("data-href",n),t.style.setProperty("cursor","pointer"),t.removeAttribute("href"),t.innerText="【已拦截】"+i,t.onclick=function(){I.confirm({title:{text:"提示",position:"center"},content:{text:`<br />确定花费2金币下载附件 <a style="color: #507daf !important;">${i}</a> ？<br /><br />`,html:true},btn:{ok:{callback:o=>{window.open(n,"_blank"),o.close();}}},width:"400px",height:"200px"});};}}p.mutationObserver(document.documentElement,{callback:()=>{document.querySelectorAll(".attnm a").forEach(t=>{e(t);}),document.querySelectorAll(".comiis_attach a").forEach(t=>{e(t);}),document.querySelectorAll("span[id*=attach_] a").forEach(t=>{e(t);});},immediate:true,config:{childList:true,subtree:true}});},async detectingUserOnlineStatus(){f.info("探测用户在线状态"),A.onceExec("mt-forum-post-detectingUserOnlineStatus",()=>{Q(`
				.gm-user-status-icon{
					border: 0 !important;
		...
		`)}},We={init(){d.ready(()=>{A.execMenuOnce("mt-guide-beautifyPage",()=>this.beautifyPage());});},beautifyPage(){f.info("页面美化"),Q(`
			.xst{font-size:15px}
		...
		`),P(".bm_c table tbody").forEach(e=>{let t=e.querySelector("th.common"),a=d.html(t),n=t.querySelectorAll("a")[0].getAttribute("href"),i=null,o=e.querySelector("td.by>cite>a").getAttribute("href").match(/uid-(\d+)/)[1],l=`
			<td class="author_img">
			...
			`;d.html(e,l);});}},me={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new q.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,a){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=a,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,R,t);}},he=function(e,t,a,n,i,r="",o,l,s,c){let u={text:e,type:"input",isNumber:!!o,isPassword:false,attributes:{},props:{},description:n,afterAddToUListCallBack:s,getValue(){return this.props[R].get(t,a)},callback(m,h,v){this.props[R].set(t,h);},placeholder:r};return Reflect.set(u.attributes,Y,t),Reflect.set(u.attributes,Z,a),me.initComponentsStorageApi("input",u,{get(m,h){return A.getValue(m,h)},set(m,h){A.setValue(m,h);}}),u},M=function(e,t,a,n,i,r,o,l){let s={text:e,type:"switch",description:i,disabled:o,attributes:{},props:{},getValue(){return this.props[R].get(t,a)},callback(c,u){let m=!!u;f.success(`${m?"开启":"关闭"} ${e}`),this.props[R].set(t,m);},afterAddToUListCallBack:r};return Reflect.set(s.attributes,Y,t),Reflect.set(s.attributes,Z,a),me.initComponentsStorageApi("switch",s,{get(c,u){return A.getValue(c,u)},set(c,u){A.setValue(c,u);}}),s},ge=function(e,t,a,n,i,r="",o,l){let s={text:e,type:"textarea",attributes:{},props:{},description:n,placeholder:r,disabled:o,getValue(){let u=this.props[R].get(t,a);return Array.isArray(u)?u.join(`
`):u},callback(c,u){this.props[R].set(t,u);}};return Reflect.set(s.attributes,Y,t),Reflect.set(s.attributes,Z,a),me.initComponentsStorageApi("switch",s,{get(c,u){return A.getValue(c,u)},set(c,u){A.setValue(c,u);}}),s};class De{option;constructor(t){this.option=t;}async showView(){let t=I.confirm({title:{text:this.option.title,position:"center"},content:{text:`
...
`).filter(l=>l.trim()!="")),Reflect.set(i,r,o),e.setData(i);}}}let a=I.config.PanelHandlerComponents();new De({title:"评论过滤器",data:()=>this.getData(),getView:i=>{let r=document.createDocumentFragment(),o=M("启用","enable",true);Reflect.set(o.props,R,t(i));let l=a.createSectionContainerItem_switch(o),s=M("处理回复引用","replyFlag",false,void 0,"移除引用");Reflect.set(s.props,R,t(i));let c=a.createSectionContainerItem_switch(s),u=M("处理作者评论","avatarFlag",false);Reflect.set(u.props,R,t(i));let m=a.createSectionContainerItem_switch(u),h=M('处理从"搜索页面"或"我的帖子提醒页面"进入的网站',"viewthreadFlag",false);Reflect.set(h.props,R,t(i));let v=a.createSectionContainerItem_switch(h),w=he("匹配的评论内容长度最小值","minLength",5,"小于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(w.props,R,t(i));let g=a.createSectionContainerItem_input(w),b=he("匹配的评论内容长度最大值","keywordLength",8,"大于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(b.props,R,t(i));let S=a.createSectionContainerItem_input(b),y=ge("评论关键字","keywords","","多个评论关键字换行分割");Reflect.set(y.props,R,t(i));let C=a.createSectionContainerItem_textarea(y),k=ge("黑名单用户","userBlackList","","多个用户换行分割");Reflect.set(k.props,R,t(i));let D=a.createSectionContainerItem_textarea(k),_=ge("白名单用户","userWhiteList","","多个用户换行分割");Reflect.set(_.props,R,t(i));let T=a.createSectionContainerItem_textarea(_);return r.append(l,c,m,v,g,S,C,D,T),r},btn:{merge:true,position:"space-between",ok:{enable:false},cancel:{enable:true,text:"关闭"},other:{enable:true,text:`查看已过滤（${this.$el.isFilterElementHTML.length}）`,type:"primary",callback:(i,r)=>{I.alert({title:{text:"评论过滤器-已过滤",position:"center"},content:{text:`
...
`)}
			...
			`});Reflect.set(i,"data-rule",t);let r="pops-panel-switch-is-checked";const{$enable:o,$enableSwitch:l,$enableSwitchCore:s,$enableSwitchInput:c,$delete:u,$edit:m}=this.parseRuleItemElement(i);return this.option.itemControls.enable.enable?(d.on(s,"click",async h=>{let v=false;l.classList.contains(r)?(l.classList.remove(r),v=false):(l.classList.add(r),v=true),c.checked=v,await this.option.itemControls.enable.callback(t,v);}),await this.option.itemControls.enable.getEnable(t)&&l.classList.add(r)):o.remove(),this.option.itemControls.edit.enable?d.on(m,"click",h=>{p.preventEvent(h),this.showEditView(true,t,a,i,v=>{t=null,t=v;});}):m.remove(),this.option.itemControls.delete.enable?d.on(u,"click",h=>{p.preventEvent(h);let v=I.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async w=>{f.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(t)?(x.success("成功删除该数据"),i.remove(),await this.updateDeleteAllBtnText(a),v.close()):x.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):u.remove(),i}async appendRuleItemElement(t,a){let{$container:n}=this.parseViewElement(t),i=[],r=Array.isArray(a)?a:[a];for(let o=0;o<r.length;o++){let l=r[o],s=await this.createRuleItemElement(l,t);n.appendChild(s),i.push(s);}return await this.updateDeleteAllBtnText(t),i}async updateRuleContaienrElement(t){this.clearContent(t);const{$container:a}=this.parseViewElement(t);let n=await this.option.data();await this.appendRuleItemElement(t,n),await this.updateDeleteAllBtnText(t);}async updateRuleItemElement(t,a,n){let i=await this.createRuleItemElement(t,n);a.after(i),a.remove();}clearContent(t){const{$container:a}=this.parseViewElement(t);d.html(a,"");}setDeleteBtnText(t,a,n=false){const{$deleteBtn:i}=this.parseViewElement(t);n?d.html(i,a):d.text(i,a);}async updateDeleteAllBtnText(t){let a=await this.option.data();this.setDeleteBtnText(t,`清空所有(${a.length})`);}}const Ye={$key:{STORAGE_KEY:"mt-productListingReminder-rule"},init(){this.registerMenu(),this.runRule();},registerMenu(){le.add({key:"product-reminder",text:"⚙ 商品上架提醒",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.showView();}});},async runRule(){async function e(){let n=await B.get("/keke_integralmall-keke_integralmall.html",{allowInterceptConfig:false,headers:{"User-Agent":p.getRandomAndroidUA()}});if(!n.status){x.error("【积分商城】获取数据失败");return}let i=[];return d.parseHTML(n.data.responseText,true,true).querySelectorAll(".task-list-wrapper li.col-xs-12").forEach(o=>{i.push({name:d.text(o.querySelector(".mall-info a > *:first-child"))||d.text(o.querySelector(".mall-info a")),price:d.text(o.querySelector(".mall-info span.discount-price i")),endTime:d.text(o.querySelector(".mall-info #time_hz span.time")),remainingQuantity:parseInt(o.querySelector(".mall-info .mall-count .count-r")?.innerText?.replace(/仅剩|件/gi,"")||"0")});}),i}if(ae.isPointsMall())return;let t=this.getData();if(!t.length)return;let a=await e();if(a){for(const n of a)for(const i of t)if(i.enable&&n.name.match(new RegExp(i.productName,"i"))&&!isNaN(n.remainingQuantity)&&n.remainingQuantity>0){f.success("成功匹配对应商品",i,n),I.confirm({title:{text:"积分商城提醒",position:"center"},content:{text:`<br />
                            您设置的商品已上架在积分商城中，当前售价 ${n.price}金币，仅剩${n.remainingQuantity}件，是否前往购买？
                            <a style="color: red !important;">(如需关闭提醒，请删除该关键字)</a>
                            <br />`,html:true},btn:{merge:true,position:"space-between",other:{enable:true,type:"danger",text:"删除提醒",callback:()=>{this.deleteData(i)?x.success("删除成功"):x.error("删除失败");}},ok:{text:"前往购买",callback:()=>{window.location.href=`${window.location.origin}/keke_integralmall-keke_integralmall.html`;}}},width:"300px",height:"300px"});return}}},getTemplateData(){return {uuid:p.generateUUID(),enable:true,name:"",productName:""}},showView(){let e=I.config.PanelHandlerComponents();function t(n){return {get(i,r){return n[i]??r},set(i,r){n[i]=r;}}}new je({title:"商品上架提醒",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:n=>n.name,updateData:n=>this.updateData(n),deleteData:n=>this.deleteData(n),getData:n=>this.getData().find(o=>o.uuid===n.uuid)??n,itemControls:{enable:{enable:true,getEnable(n){return n.enable},callback:(n,i)=>{n.enable=i,this.updateData(n);}},edit:{enable:true,getView:(n,i)=>{let r=document.createDocumentFragment();i||(n=this.getTemplateData());let o=M("启用","enable",true);Reflect.set(o.props,R,t(n));let l=e.createSectionContainerItem_switch(o),s=he("规则名称","name","","",void 0,"必填");Reflect.set(s.props,R,t(n));let c=e.createSectionContainerItem_input(s),u=he("商品名","productName","","",void 0,"可正则，需手动转义");Reflect.set(u.props,R,t(n));let m=e.createSectionContainerItem_input(u);return r.append(l,c,m),r},onsubmit:(n,i,r)=>{let o=n.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();return i&&(l.uuid=r.uuid),o.forEach(s=>{let c=Reflect.get(s,"__formConfig__"),u=Reflect.get(c,"attributes"),m=Reflect.get(s,R),h=Reflect.get(u,Y),v=Reflect.get(u,Z),w=m.get(h,v);Reflect.has(l,h)?Reflect.set(l,h,w):f.error(`${h}不在数据中`);}),l.name.trim()===""?(x.error("规则名称不能为空"),{success:false,data:l}):i?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}}},delete:{enable:true,deleteCallBack:n=>this.deleteData(n)}}}).showView();},getData(){return re(this.$key.STORAGE_KEY,[])},setData(e){j(this.$key.STORAGE_KEY,e);},addData(e){let t=this.getData();return t.findIndex(n=>n.uuid==e.uuid)===-1?(t.push(e),j(this.$key.STORAGE_KEY,t),true):false},updateData(e){let t=this.getData(),a=t.findIndex(i=>i.uuid==e.uuid),n=false;return a!==-1&&(n=true,t[a]=e),this.setData(t),n},deleteData(e){let t=this.getData(),a=t.findIndex(i=>i.uuid==e.uuid),n=false;return a!==-1&&(n=true,t.splice(a,1)),this.setData(t),n},clearData(){we(this.$key.STORAGE_KEY);}},Ze=`.pops-confirm-content {\r
	display: flex;\r
...
`,et={$data:{},init(){this.registerMenu();},registerMenu(){le.add({key:"online-user",text:"⚙ 在线用户",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let e=x.loading("正在获取在线用户名单中..."),t=await this.getOnlineUserListInfo();if(e.close(),!t)return;let a=I.alert({title:{text:"在线用户",position:"center"},content:{text:`
            ...
            `});this.$el.$smallUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=t.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=t.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(e,t,a,n){d.on(e,"change",i=>{if(!e.files?.length)return;d.text(t,"🤡获取文件信息中..."),t.removeAttribute("data-success");let r=e.files[0],o=r.size,l=new Image,s=new FileReader;s.readAsDataURL(r),s.onload=function(c){l.src=c.target.result,l.onload=function(){if(l.width>a.width||l.height>a.height){e.value="",t.setAttribute("data-success","false"),d.text(t,`🤡校验失败 ==> 图片尺寸不符合，宽：${l.width} 高：${l.height}`);return}if(o>K.$data.avatarInfo.maxSize){e.value="",t.setAttribute("data-success","false"),d.text(t,`🤡校验失败 ==> 图片大小不符合：${o}byte，限制最大：${K.$data.avatarInfo.maxSize}byte`);return}t.setAttribute("data-success","true"),d.text(t,`🤣 通过 宽:${l.width} 高:${l.height} 大小(byte):${o}`),n();};};});},async getUploadUrl(){let e=await B.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":p.getRandomPCUA()}});if(!e.status)return;if(p.isNull(e.data.responseText)){x.error("动态头像：获取上传地址的内容失败");return}let t=e.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(t==null||t.length!=2){x.error("动态头像：获取变量data失败");return}let n=t[t.length-1].split(","),i=n.indexOf("stl_src");if(i===-1&&(i=n.indexOf("src")),i===-1){x.error("动态头像：获取上传地址失败");return}let r=n[i+1],o=new URL(r);return o.pathname=o.pathname.replace("/images/camera.swf","/index.php"),o.searchParams.delete("inajax"),o.searchParams.set("m","user"),o.searchParams.set("a","rectavatar"),o.searchParams.set("base64","yes"),r=o.toString(),f.info("上传地址："+r),r}},nt={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[ke("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,a)=>{f.info("设置当前Qmsg弹出位置"+a);},"Toast显示在页面九宫格的位置"),ke("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),M("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[M("新增【最新发表】","mt-addLatestPostBtn",true,void 0,"便于快捷跳转"),M("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),M("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{type:"deepMenu",text:"自动签到",forms:[{text:"",type:"forms",forms:[M("启用","mt-auto-sign",true,void 0,"自动请求签到"),M("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),Ee("签到信息",`上次签到时间：${(()=>{let e=ue.getHostNameSignInfo(window.location.hostname);return e?q.formatTime(e.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",e=>{let a=e.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");I.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:n=>{let i=window.location.hostname;ue.clearSignInfo(i),x.success("删除成功"),d.text(a,`上次签到时间：${(()=>{let r=ue.getHostNameSignInfo(i);return r?q.formatTime(r.time):"尚未签到"})()}`),n.close();}}},width:"300px",height:"200px"});})]}]},{text:"头像",type:"deepMenu",forms:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"forms",forms:[Ie(e=>{let t=d.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return a.querySelector(".avatar-img[data-size='small']"),a.querySelector(".avatar-img[data-size='middle']"),a.querySelector(".avatar-img[data-size='big']"),e.appendChild(t),e.appendChild(a),e.appendChild(n),e}),Ie(e=>{let t=d.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`

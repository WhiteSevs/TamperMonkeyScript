...
(function (x, G, _, ae, Z, Ce) {
	'use strict';

	var ke=Object.defineProperty;var Se=(t,e,a)=>e in t?ke(t,e,{enumerable:true,configurable:true,writable:true,value:a}):t[e]=a;var W=(t,e,a)=>Se(t,typeof e!="symbol"?e+"":e,a);var pe=typeof GM<"u"?GM:void 0,le=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,me=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,K=typeof GM_getValue<"u"?GM_getValue:void 0,X=typeof GM_info<"u"?GM_info:void 0,Ie=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,z=typeof GM_setValue<"u"?GM_setValue:void 0,Ee=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Te=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,V=typeof unsafeWindow<"u"?unsafeWindow:void 0,Me=window;const oe={addBlockCSS(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(a=>{Array.isArray(a)?e=e.concat(a):e.push(a);}),F(`${e.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof me=="function"?me(t.keyName):"";typeof e=="string"&&e?F(e):oe.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,G.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(a=>{e.onload=()=>{a(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
			.pops-overflow-hidden-important {
				overflow: hidden !important;
			}
		`;let a=[document.documentElement,document.body].concat(...t||[]);return a.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){a.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(n){navigator.clipboard.readText().then(i=>{n(i);}).catch(i=>{f.error("读取剪贴板内容失败👉",i),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(i=>{t(n);}).catch(i=>{f.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),t(n);});}function a(){var n,i;return !(typeof((n=navigator==null?void 0:navigator.clipboard)==null?void 0:n.readText)!="function"||typeof((i=navigator==null?void 0:navigator.permissions)==null?void 0:i.query)!="function")}return new Promise(n=>{if(!a()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})}},xe={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}},$={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},m=_.noConflict(),u=G.noConflict(),T=ae,f=new m.Log(X,V.console||Me.console);var we;let ie=((we=X==null?void 0:X.script)==null?void 0:we.name)||void 0;const be=false;f.config({debug:be,logMaxCount:1e3,autoClearConsole:true,tag:true});x.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return y.getValue($.qmsg_config_position.key,$.qmsg_config_position.defaultValue)}},maxNums:{get(){return y.getValue($.qmsg_config_maxnums.key,$.qmsg_config_maxnums.defaultValue)}},showReverse:{get(){return y.getValue($.qmsg_config_showreverse.key,$.qmsg_config_showreverse.defaultValue)}},zIndex:{get(){let t=_.getMaxZIndex(),e=ae.config.InstanceUtils.getPopsMaxZIndex().zIndex;return _.getMaxValue(t,e)+100}}}));T.GlobalConfig.setGlobalConfig({zIndex:()=>{let t=_.getMaxZIndex(void 0,void 0,a=>{var n;if((n=a==null?void 0:a.classList)!=null&&n.contains("qmsg-shadow-container")||a!=null&&a.closest("qmsg")&&a.getRootNode()instanceof ShadowRoot)return  false}),e=ae.config.InstanceUtils.getPopsMaxZIndex().zIndex;return _.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}}});const Y=new m.GM_Menu({GM_getValue:K,GM_setValue:z,GM_registerMenuCommand:Ie,GM_unregisterMenuCommand:Ee}),D=new m.Httpx({xmlHttpRequest:Te,logDetails:be});D.interceptors.request.use(t=>t);D.interceptors.response.use(void 0,t=>(f.error("拦截器-请求错误",t),t.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),t));V.Object.defineProperty,V.Function.prototype.apply,V.Function.prototype.call,V.Element.prototype.appendChild,V.setTimeout;const F=m.addStyle.bind(m),N=document.querySelector.bind(document),U=document.querySelectorAll.bind(document);new m.GM_Cookie;const ye="GM_Panel",se="data-init",P="data-key",Q="data-default-value",Re="data-init-more-value",I="data-storage-api",j={setting:{get width(){return window.innerWidth<550?"88vw":window.innerWidth<700?"550px":"700px"},get height(){return window.innerHeight<450?"70vh":window.innerHeight<550?"450px":"550px"}},settingBig:{get width(){return window.innerWidth<800?"92vw":"800px"},get height(){return window.innerHeight<600?"80vh":"600px"}}};class De{constructor(e){W(this,"storageKey");W(this,"listenerData");if(typeof e=="string"){let a=e.trim();if(a=="")throw new Error("key参数不能为空字符串");this.storageKey=a;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new _.Dictionary;}getLocalValue(){let e=K(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){z(this.storageKey,e);}set(e,a){let n=this.get(e),i=this.getLocalValue();Reflect.set(i,e,a),this.setLocalValue(i),this.triggerValueChangeListener(e,n,a);}get(e,a){let n=this.getLocalValue();return Reflect.get(n,e)??a}getAll(){return this.getLocalValue()}delete(e){let a=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.triggerValueChangeListener(e,a,void 0);}has(e){let a=this.getLocalValue();return Reflect.has(a,e)}keys(){let e=this.getLocalValue();return Reflect.ownKeys(e)}values(){let e=this.getLocalValue();return Reflect.ownKeys(e).map(a=>Reflect.get(e,a))}clear(){le(this.storageKey);}addValueChangeListener(e,a){let n=Math.random(),i=this.listenerData.get(e)||[];return i.push({id:n,key:e,callback:a}),this.listenerData.set(e,i),n}removeValueChangeListener(e){let a=false;for(const[n,i]of this.listenerData.entries()){for(let r=0;r<i.length;r++){const l=i[r];(typeof e=="string"&&l.key===e||typeof e=="number"&&l.id===e)&&(i.splice(r,1),r--,a=true);}this.listenerData.set(n,i);}return a}triggerValueChangeListener(e,a,n){if(!this.listenerData.has(e))return;let i=this.listenerData.get(e);for(let r=0;r<i.length;r++){const l=i[r];if(typeof l.callback=="function"){let o=this.get(e),s,c;typeof a<"u"&&arguments.length>=2?c=a:c=o,typeof n<"u"&&arguments.length>2?s=n:s=o,l.callback(e,c,s);}}}}const q=new De(ye),ce={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new m.Dictionary),this.__contentConfig}},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t){return this.$data.contentConfig.get(t)??[]}},Le={$data:{__menuOption:[],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){y.isTopWindow()&&Y.add([{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{y.showPanel(ce.getConfig(0));}},...this.$data.menuOption]);},addMenuOption(t){Array.isArray(t)||(t=[t]),this.$data.menuOption.push(...t);}},y={$data:{__configDefaultValueData:null,__onceExecMenuData:null,__onceExecData:null,__panelConfig:{},$panel:null,get configDefaultValueData(){return this.__configDefaultValueData==null&&(this.__configDefaultValueData=new m.Dictionary),this.__configDefaultValueData},get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new m.Dictionary),this.__onceExecMenuData},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new m.Dictionary),this.__onceExecData},get scriptName(){return ie},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:ye,attributeKeyName:P,attributeDefaultValueName:Q},init(){this.initContentDefaultValue(),Le.init();},isTopWindow(){return V.top===V.self},initContentDefaultValue(){const t=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;let i={},r=n.attributes[P];r!=null&&(i[r]=n.attributes[Q]);let l=n.attributes[se];if(typeof l=="function"){let c=l();if(typeof c=="boolean"&&!c)return}let o=n.attributes[Re];o&&typeof o=="object"&&Object.assign(i,o);let s=Object.keys(i);if(!s.length){f.warn(["请先配置键",n]);return}s.forEach(c=>{let p=i[c];this.setDefaultValue(c,p);});},e=n=>{for(let i=0;i<n.length;i++){let r=n[i];t(r);let l=r.forms;l&&Array.isArray(l)&&e(l);}},a=[...ce.getAllContentConfig()];for(let n=0;n<a.length;n++){let i=a[n];if(!i.forms)continue;const r=i.forms;r&&Array.isArray(r)&&e(r);}},setDefaultValue(t,e){this.$data.configDefaultValueData.has(t)&&f.warn("请检查该key(已存在): "+t),this.$data.configDefaultValueData.set(t,e);},setValue(t,e){q.set(t,e);},getValue(t,e){let a=q.get(t);return a??(this.$data.configDefaultValueData.has(t)?this.$data.configDefaultValueData.get(t):e)},deleteValue(t){q.delete(t);},hasKey(t){return q.has(t)},addValueChangeListener(t,e){return q.addValueChangeListener(t,(n,i,r)=>{e(t,r,i);})},removeValueChangeListener(t){q.removeValueChangeListener(t);},triggerMenuValueChange(t,e,a){q.triggerValueChangeListener(t,a,e);},deleteExecMenuOnce(t){return this.$data.onceExecMenuData.delete(t),q.removeValueChangeListener(t)},deleteOnceExec(t){this.$data.onceExecData.delete(t);},exec(t,e,a,n=true){const i=this;let r;typeof t=="string"||Array.isArray(t)?r=()=>t:r=t;let l=false,o=r(),s=[];Array.isArray(o)?(l=true,s=o):s.push(o);let c=s.find(v=>!this.$data.configDefaultValueData.has(v));if(c){f.warn(`${c} 键不存在`);return}let p=JSON.stringify(s);if(n){if(this.$data.onceExecMenuData.has(p))return;this.$data.onceExecMenuData.set(p,1);}let g=[],w=[],d=(v,C)=>{let R=[];C instanceof HTMLStyleElement?R=[C]:Array.isArray(C)&&(R=[...C.filter(L=>L!=null&&L instanceof HTMLStyleElement)]),g=g.concat(R);},h=v=>this.getValue(v),b=()=>{for(let v=0;v<g.length;v++)g[v].remove(),g.splice(v,1),v--;},A=()=>{let v=false;return typeof a=="function"?v=a(s):v=s.every(C=>h(C)),v},k=v=>{let C=A(),R=[];if(C){let L=s.map(B=>this.getValue(B)),O=e({addStyleElement:(...B)=>d(true,...B),value:l?L:L[0]});O instanceof HTMLStyleElement?R.push(O):Array.isArray(O)&&R.push(...O.filter(B=>B!=null&&B instanceof HTMLStyleElement));}b(),g=[...R];};return n&&s.forEach(v=>{let C=this.addValueChangeListener(v,(R,L,O)=>{k();});w.push(C);}),k(),{clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),n&&i.$data.onceExecMenuData.delete(p);},clearStoreStyleElements:()=>b(),removeValueChangeListener:()=>{w.forEach(v=>{this.removeValueChangeListener(v);});}}},execMenu(t,e,a=false){return this.exec(t,n=>e(n),n=>n.every(r=>{let l=!!this.getValue(r);return a&&(l=!l),l}),false)},execMenuOnce(t,e){return this.exec(t,e,a=>a.every(i=>!!this.getValue(i)),true)},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},showPanel(t,e=`${ie}-设置`){let a=T.panel({title:{text:`${ie}-设置`,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(n,i)=>{n.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(n,i)=>{n(),this.$data.$panel=null;}},width:j.setting.width,height:j.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a;}},Ve=()=>{var t,e,a,n,i,r,l,o,s,c,p;c=/((https?:\/\/|www\.)[\x21-\x7e]+[\w\/]|(\w[\w._-]+\.(com|cn|org|net|info|tv|cc))(\/[\x21-\x7e]*[\w\/])?|ed2k:\/\/[\x21-\x7e]+\|\/|thunder:\/\/[\x21-\x7e]+=)/gi,t=function(d){var h;if(d=(h=d.originalTarget)!=null?h:d.target,d!=null&&d.localName==="a"&&d.className.indexOf("texttolink")!==-1&&(h=d.getAttribute("href"),h.indexOf("http")!==0&&h.indexOf("ed2k://")!==0&&h.indexOf("thunder://")!==0))return d.setAttribute("href","http://"+h)},document.addEventListener("mouseover",t),s=function(d){if(typeof d=="object"&&d!=null&&typeof d.parentNode<"u"&&typeof d.parentNode.className<"u"&&typeof d.parentNode.className.indexOf=="function"&&d.parentNode.className.indexOf("texttolink")===-1&&d.nodeName!=="#cdata-section"){var h=d.textContent.replace(c,'<a href="$1" target="_blank" class="texttolink">$1</a>');if(d.textContent.length!==h.length){var b=document.createElement("span");return b.innerHTML=h,console.log(`识别: ${b.querySelector("a")}`),d.parentNode.replaceChild(b,d)}}},e="a svg canvas applet input button area pre embed frame frameset head iframe img option map meta noscript object script style textarea code".split(" "),p=`//text()[not(ancestor::${e.join(") and not(ancestor::")})]`,a=new RegExp(`^(${e.join("|")})$`,"i"),i=function(d,h){var b,A;if(h+1e4<d.snapshotLength){var k=b=h;for(A=h+1e4;h<=A?b<=A:b>=A;k=h<=A?++b:--b)s(d.snapshotItem(k));setTimeout(function(){return i(d,h+1e4)},15);}else for(k=b=h,A=d.snapshotLength;h<=A?b<=A:b>=A;k=h<=A?++b:--b)s(d.snapshotItem(k));},r=function(d){return d=document.evaluate(p,d,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null),i(d,0)},l=function(d){for(d=document.createTreeWalker(d,NodeFilter.SHOW_TEXT,{acceptNode:function(h){if(!a.test(h.parentNode.localName))return NodeFilter.FILTER_ACCEPT}},false);d.nextNode();)s(d.currentNode);},o=new window.MutationObserver(function(d){var h,b,A=0;for(h=d.length;A<h;A++){var k=d[A];if(k.type==="childList"){var S=k.addedNodes,v=0;for(b=S.length;v<b;v++)k=S[v],l(k);}}}),n=function(){return r(document.body),o.observe(document.body,{childList:true,subtree:true})};var g=function(d){var h=d.getAttribute("href");if(h.indexOf("http")!==0&&h.indexOf("ed2k://")!==0&&h.indexOf("thunder://")!==0)return d.setAttribute("href","http://"+h)},w=function(){for(var d=document.getElementsByClassName("texttolink"),h=0;h<d.length;h++)g(d[h]);};setTimeout(w,1500),setTimeout(n,100);};oe.setGMResourceCSS(xe.Viewer);oe.setGMResourceCSS(xe.Hljs);const ee={formhash:/formhash=([0-9a-zA-Z]+)/,uid:/uid(=|-)(\d+)/,fontSpecial:/<font.*?>|<\/font>|<strike>|<strong>|<i>|<u>|align=".*?"|<br>[\s]*<br>[\s]*<br>/g},M={getAvatar:(t,e="middle")=>`/uc_server/avatar.php?uid=${t}&size=${e}&ts=1`,getCurrentUID(){let t=V.discuz_uid;if(typeof t=="string")return t;let e=N('.sidenv_exit a[href*="uid-"]')||N('#comiis_key a[href*="uid-"]');if(e){let a=e.href.match(/uid=([0-9]+)/);if(a)return a[a.length-1]}},async getFormHash(){let t=Array.from((top||globalThis).document.querySelectorAll("input[name=formhash]"));for(let n=0;n<t.length;n++){let r=t[n].value;if(r)return r}let e=Array.from((top||globalThis).document.querySelectorAll('a[href*="formhash="]'));for(let n=0;n<e.length;n++){let r=e[n].href.match(ee.formhash);if(r){let l=r[r.length-1];if(l)return l}}let a=await D.get("/home.php?mod=spacecp",{fetch:true,allowInterceptConfig:false});if(a.status){let n=a.data.responseText,r=u.parseHTML(n,true,true).querySelector("input[name=formhash]");if(r){let l=r.value;if(m.isNotNull(l))return l}}else f.error("请求个人主页获取formhash失败",a);},envIsMobile(){return (V.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:t=>{let e=t.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(e){let a=e.filter(Boolean);return a[a.length-1]}},getForumId(t){let e=t.match(/&fid=([\d]+)/i);if(e)return e[e.length-1]},getPostId(t){let e=t.match(/&pid=([\d]+)/i);if(e)return e[e.length-1]},getRepquote(t){let e=t.match(/&repquote=([\d]+)/i);if(e)return e[e.length-1]}},J={$key:{sign:"mt-sign-time"},init(){this.sign();},checkSignInfo(){let e=this.getSignInfo().find(a=>a.hostName===window.location.hostname);return e?m.formatTime(Date.now(),"yyyyMMdd")===m.formatTime(e.time,"yyyyMMdd"):false},setSignInfo(){let t={hostName:window.location.hostname,time:Date.now()},e=this.getSignInfo(),a=e.findIndex(n=>n.hostName===t.hostName);a!==-1&&e.splice(a,1),e.push(t),z(this.$key.sign,e);},getSignInfo(){let t=K(this.$key.sign,[]);return Array.isArray(t)?t:(this.clearSignInfo(),[])},getHostNameSignInfo(t=window.location.hostname){return this.getSignInfo().find(a=>a.hostName===t)},clearSignInfo(t){if(typeof t=="string"){let e=this.getSignInfo(),a=e.findIndex(n=>n.hostName===t);a!==-1&&e.splice(a,1),z(this.$key.sign,e);}else le(this.$key.sign);},checkLogin(){return M.envIsMobile()?!!N("a[href*='member.php?mod=logging&action=logout']"):!!N("#comiis_key")},async sign(){let t=await M.getFormHash();if(t==null){if(N("#comiis_picshowbox")){f.info("当前为评论区的看图模式 ");return}f.error("自动签到：获取账号formhash失败"),this.clearSignInfo(window.location.hostname),x.error({content:"自动签到：获取账号formhash失败"});return}if(this.checkSignInfo()){f.info("今日已签到");return}let e=!!y.getValue("mt-auto-sign-useFetch"),a=m.getRandomPCUA(),n=()=>{this.setSignInfo();},i=()=>{this.clearSignInfo(window.location.hostname);},r=o=>{let c=ae.alert({title:{text:"未知签到内容",position:"center"},content:{text:"",html:false},width:"88vw",height:"300px"}).$shadowRoot.querySelector(".pops-alert-content");c.innerText=o;},l=[{checkPluginEnableUrl:"/plugin.php?id=k_misign:sign",async sign(){let o={operation:"qiandao",format:"button",formhash:t,inajax:1,ajaxtarget:"midaben_sign"},s=await D.get(`/k_misign-sign.html?${m.toSearchParamsStr(o)}`,{fetch:e,headers:{"User-Agent":a},allowInterceptConfig:false});if(!s.status){x.error("签到：网络异常，请求失败",{consoleLogContent:true});return}n(),f.info("签到信息：",s);let c=s.data.responseText,p=m.parseCDATA(c),g=u.parseHTML(`<div>${p}</div>`,true,false),w=u.text(g);if(w.includes("需要先登录")){x.error("签到：请先登录账号",{timeout:3e3,consoleLogContent:true}),i();return}else if(w.includes("请稍后再试")||w.includes("您已经被列入黑名单")||w.includes("绑定手机号后才可以签到")||w.includes("您所在用户组不允许使用")){x.error("签到："+w,{timeout:5e3});return}else if(w.includes("今日已签")||w.includes("今日已经签到")){x.info("签到："+w);return}else if(c.includes("您当前的访问请求当中含有非法字符，已经被系统拒绝")){x.error("签到: 您当前的访问请求当中含有非法字符，已经被系统拒绝",{timeout:6e3});return}else if(e&&"location"in m.toJSON(c)){x.success("签到: 签到成功");return}let d=g.querySelector(".con"),h=g.querySelector(".line");if(d&&h){let b=u.text(d).match(/([0-9]+)金币/),A=u.text(h).match(/([0-9]+)/),k=b[b.length-1],S=A[A.length-1];f.success(`金币${k}，排名${S}`),x.info(`
							<div style="display: flex;${M.envIsMobile()?"":"padding: 20px;"}">
								<div style="align-self: center;margin-right: 20px;">签到</div>
								<div>排名 ${S}<br>金币 ${k}</div>
							</div>`,{timeout:4e3,isHTML:true});return}r(c);}},{checkPluginEnableUrl:"/plugin.php?id=dsu_paulsign:sign",async sign(){let o={id:"dsu_paulsign:sign",operation:"qiandao",infloat:1,inajax:1},s=await D.post(`/plugin.php?${m.toSearchParamsStr(o)}`,{data:{formhash:t,qdxq:"kx",qdmode:3,todaysay:"",fastreply:0},processData:true,fetch:e,headers:{"User-Agent":a,"Content-Type":"application/x-www-form-urlencoded"},allowInterceptConfig:false});if(!s.status){x.error("签到：网络异常，请求失败",{consoleLogContent:true});return}n(),f.info("签到信息：",s);let c=s.data.responseText;if(c.includes("签到成功")){x.success("签到：签到成功");return}if(c.includes("今日已经签到")){x.info("签到：您今日已经签到，请明天再来！");return}r(c);}}];for(let o=0;o<l.length;o++){const s=l[o];let c=await D.get(s.checkPluginEnableUrl,{fetch:e,headers:{"User-Agent":m.getRandomPCUA()},allowInterceptConfig:false});if(!c.status){f.error("签到：检查签到插件是否启用的请求失败",c);continue}if(u.parseHTML(c.data.responseText,true,true).querySelector("#messagetext")||c.data.responseText.includes("插件不存在或已关闭")){f.error(`插件：${s.checkPluginEnableUrl} 未启用或不存在`);continue}await s.sign();break}}},te={isKMiSign(){return window.location.pathname.startsWith("/k_misign-sign.html")},isPost(){return window.location.pathname.startsWith("/thread-")||window.location.pathname.startsWith("/forum.php")&&window.location.search.startsWith("?mod=viewthread")},isPage(){return !!window.location.pathname.match(/^\/page-([0-9]+).html/g)},isGuide(){return window.location.pathname.startsWith("/forum.php")&&window.location.search.startsWith("?mod=guide")},isPlate(){return !!window.location.pathname.match(/\/forum-[0-9]{1,2}-[0-9]{1,2}.html/g)},isSearch(){return window.location.pathname.startsWith("/search.php")},isSpace(){return window.location.pathname.startsWith("/home.php")&&window.location.search.startsWith("?mod=space")},isMySpace(){return window.location.pathname.startsWith("/home.php")&&window.location.search.startsWith("?mod=space&do=profile&mycenter")},isSpaceWithAt(){return window.location.pathname.startsWith("/space-uid-")},isForumList(){return window.location.pathname.startsWith("/forum.php")&&window.location.search.startsWith("?forumlist")},isMessage(){return window.location.pathname.startsWith("/home.php")&&window.location.search.startsWith("?mod=space&do=notice")},isMessageList(){return window.location.pathname.startsWith("/home.php")&&window.location.search.startsWith("?mod=space&do=pm")},isPointsMall(){return window.location.pathname.startsWith("/keke_integralmall-keke_integralmall.html")||window.location.pathname.startsWith("/plugin.php")&&window.location.search.startsWith("?id=keke_integralmal")},isPostPublish(){return window.location.pathname.startsWith("/forum.php")&&window.location.search.startsWith("?mod=post")},isPostPublish_voting(){return window.location.pathname.startsWith("/forum.php")&&window.location.search.includes("&special=1")||window.location.search.includes("&fid=42")},isPostPublish_edit(){return this.isPostPublish()&&window.location.search.includes("&action=edit")},isPostPublish_newthread(){return this.isPostPublish()&&window.location.search.includes("&action=newthread")},isPostPublish_reply(){return this.isPostPublish()&&window.location.search.includes("&action=reply")}},Oe={init(){u.ready(()=>{y.execMenuOnce("mt-forum-post-quickCollentBtn",()=>{this.quickCollentBtn();}),y.execMenuOnce("mt-forum-post-quickReplyOptimization",()=>{this.quickReplyOptimization();});});},quickCollentBtn(){f.info("【快捷收藏】"),m.waitNode("#scrolltop",1e4).then(async t=>{if(!t)return;let e=await M.getFormHash(),a=M.getThreadId(window.location.href),n=`/home.php?${m.toSearchParamsStr({mod:"spacecp",ac:"favorite",type:"thread",id:a,formhash:e,infloat:"yes",handlekey:"k_favorite",inajax:1,ajaxtarget:"fwin_content_k_favorite"})}`,i=document.createElement("span");i.innerHTML=`
			<a href="${n}" 
				id="k_favorite"
			...
			`,u.prepend(t,i);});},quickReplyOptimization(){m.waitNode('#scrolltop a[title="快速回复"]',1e4).then(t=>{t&&(f.info("快捷回复优化"),u.on(t,"click",function(){V.showWindow("reply",t.href),f.info("等待弹窗出现"),m.waitNode("#moreconf",1e4).then(e=>{if(!e)return;f.success("弹出出现，添加按钮");let a=u.createElement("button",{innerText:"一键空格",type:"button",id:"insertspace2"},{style:"float: left;"});u.on(a,"click",n=>{m.preventEvent(n),u.val(N("#postmessage"),u.val(N("#postmessage"))+"           ");}),u.append(e,a);});}));});}},ve={$flag:{isSetHljsCSS:false},init(){Oe.init(),y.execMenuOnce("mt-forum-post-autoExpandContent",()=>this.autoExpandContent()),y.execMenuOnce("mt-forum-post-repairImageWidth",()=>this.repairImageWidth()),y.execMenuOnce("mt-forum-post-hideBottomInfoBlock",()=>this.hideBottomInfoBlock()),u.ready(()=>{y.execMenu("mt-forum-post-removeFontStyle",()=>{this.removeFontStyle();}),y.execMenu("mt-forum-post-removeCommentFontStyle",()=>{this.removeCommentFontStyle();}),y.execMenuOnce("mt-forum-post-loadNextPageComment",()=>{this.loadNextPageComment();}),y.execMenuOnce("mt-forum-post-codeQuoteOptimization",()=>{this.codeQuoteOptimization();}),y.execMenuOnce("mt-forum-post-optimizationImagePreview",()=>{this.optimizationImagePreview();}),y.execMenuOnce("mt-forum-post-interceptionAttachment",()=>{this.setAttachmentsClickTip();}),y.execMenu("mt-forum-post-detectingUserOnlineStatus",()=>{this.detectingUserOnlineStatus();}),y.execMenu("mt-forum-post-showUserLevel",()=>{this.showUserLevel();});});},autoExpandContent(){return f.info("自动展开帖子内容"),F(`
        ...
        `)},repairImageWidth(){return f.info("修复图片宽度"),F(`
        .comiis_messages img{
            max-width: 100% !important;
        }`)},removeFontStyle(){let t=document.querySelector(".comiis_a.comiis_message_table");t&&(f.info("移除帖子字体效果"),u.html(t,u.html(t).replace(ee.fontSpecial,"")));},removeCommentFontStyle(){var a;f.info("移除评论区的字体效果");let t=U("font"),e=((a=N(".comiis_postlist .comiis_postli"))==null?void 0:a.innerHTML)||"";e!==""&&(t.forEach(n=>{e.includes(n.innerHTML)||(n.removeAttribute("color"),n.removeAttribute("style"),n.removeAttribute("size"));}),U(".comiis_message.message").forEach(n=>{if(e.includes(n.innerHTML)){n.innerHTML=n.innerHTML.replace(ee.fontSpecial,"");let i=n.nextElementSibling;i&&i.localName==="strike"&&(i.outerHTML=i.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));}})),U(".comiis_postli.comiis_list_readimgs.nfqsqi").forEach(n=>{let i=n.parentElement;i&&i.localName==="strike"&&(i.outerHTML=i.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));});},loadNextPageComment(){if(f.info("自动加载下一页评论"),document.title.includes("提示信息 - MT论坛"))return;if(U(".pgbtn").length==0){f.warn("没有找到下一页按钮");return}var t=async function(n){var o,s;let i=await D.get(n,{fetch:true,allowInterceptConfig:false});if(!i.status){x.error("网络异常，请求下一页失败");return}var r=m.parseFromString(i.data.responseText),l=r.querySelector(".pgbtn a");return (o=r.querySelector("#postlistreply"))==null||o.remove(),(s=r.querySelector(".bm_h.comiis_snvbt"))==null||s.remove(),{url:l?l.getAttribute("href"):null,postlist:r.querySelector("#postlist"),pgbtn:r.querySelector(".pgbtn"),pgs:r.querySelector(".pgs.mtm")}},e=async function(){var i,r;var n=N(".pgbtn a").getAttribute("href");if(n){let l=await t(n);l&&((r=(i=l.postlist)==null?void 0:i.querySelector(".comiis_vrx"))!=null&&r.querySelector(".km1")&&(Object.keys(l).forEach(o=>{l[o]=null;}),f.warn("检测到请求的本页内容中存在【楼主】标识，判断为重复页请求")),(!l.url||l.url==n)&&(f.error("最后一页，取消监听"),u.off(document,["scroll","wheel"],a.run),u.remove(".pgbtn")),l.postlist&&u.append("#postlist",u.html(l.postlist)),l.pgbtn&&u.html(".pgbtn",u.html(l.pgbtn)),l.pgs&&u.html(".pgs.mtm",u.html(l.pgs)),ve.init());}else f.error("获取下一页元素失败");};let a=new m.LockFunction(async()=>{m.isNearBottom()&&await e();});u.on(document,["scroll","wheel"],a.run);},codeQuoteOptimization(){f.info("代码块优化");function t(a){var n=["add","and","cmp","cmpg","cmpl","const","div","double","float","goto","if","int","long","move","mul","neg","new","nop","not","or","rem","return","shl","shr","sput","sub","throw","ushr","xor"],i=["aget","aput","array","check","execute","fill","filled","goto/16","goto/32","iget","instance","invoke","iput","monitor","packed","sget","sparse"],r=["transient","constructor","abstract","final","synthetic","public","private","protected","static","bridge","system"];return {aliases:["smali"],contains:[{className:"string",begin:'"',end:'"',relevance:0},a.COMMENT("#","$",{relevance:0}),{className:"keyword",variants:[{begin:"\\s*\\.end\\s[a-zA-Z0-9]*"},{begin:"^[ ]*\\.[a-zA-Z]*",relevance:0},{begin:"\\s:[a-zA-Z_0-9]*",relevance:0},{begin:"\\s("+r.join("|")+")"}]},{className:"built_in",variants:[{begin:"\\s("+n.join("|")+")\\s"},{begin:"\\s("+n.join("|")+")((\\-|/)[a-zA-Z0-9]+)+\\s",relevance:10},{begin:"\\s("+i.join("|")+")((\\-|/)[a-zA-Z0-9]+)*\\s",relevance:10}]},{className:"class",begin:`L[^(;:
]*;`,relevance:0},{begin:"[vp][0-9]+"}]}}F(`
		...
		`),Z.registerLanguage("smali",t);let e=new m.LockFunction(()=>{function a(i,r="java"){i.oldValue||(i.oldValue=i.textContent),i.innerHTML=Z.highlight(i.oldValue,{language:r}).value.replace(/\\n$/gi,"");}document.querySelectorAll("em[onclick^=copycode]").forEach(i=>{if(i.nextElementSibling&&typeof i.nextElementSibling.className=="string"&&i.nextElementSibling.className=="code-select-language")return;let r=Z.highlightAuto(u.text(i.parentElement.querySelector("div[id^=code]"))).language,l=document.createElement("select"),o=Z.listLanguages().sort();o=o.concat("自动检测");let s="";o.forEach(c=>{c.startsWith("自动检测")?s+=`<option data-value="${r}" selected="selected">${c}(${r})</option>`:s+=`<option data-value="${c}">${c}</option>`;}),l.className="code-select-language",l.innerHTML=s,u.on(l,"change",()=>{let c=l.selectedOptions[0].getAttribute("data-value");f.info("切换代码块语言: ",c),u.parent(l).querySelectorAll("li").forEach(p=>{a(p,c);});}),m.preventEvent(l,"click"),m.preventEvent(i,"click"),i.insertAdjacentElement("afterend",l),m.dispatchEvent(l,"change");}),document.querySelectorAll(".blockcode").forEach(i=>i.className="hljs");},this,500);m.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{e.run();}});},optimizationImagePreview(){f.info("图片查看优化");let t=[{hostName:"avatar-bbs.mt2.cn",pathName:"*"},{hostName:"cdn-bbs.mt2.cn",pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"^(/static(/|//)image|/template)"},{hostName:window.location.hostname,pathName:"/uc_server/avatar.php"}];function e(i=[],r=0){let l="";i.forEach(c=>{l+=`<li><img data-src="${c}"></li>`;});let o=u.createElement("ul",{innerHTML:l}),s=new Ce(o,{inline:false,url:"data-src",zIndex:m.getMaxZIndex()+100,hidden:()=>{s.destroy();}});s.view(r),s.zoomTo(1),s.show();}function a(){U("#postlist .comiis_vrx:not([data-isHandlingViewIMG])").forEach(i=>{i.setAttribute("data-isHandlingViewIMG","true");let r=[];i.querySelectorAll("img").forEach(l=>{let o=l.src,s=new URL(o).hostname,c=new URL(o).pathname,p=l.parentElement;p.nodeName.toLowerCase()==="a"&&p.getAttribute("href")===o&&(p.setAttribute("href","javascript:;"),p.removeAttribute("target"));let g=false;for(let w of t)if(s.indexOf(w.hostName)!=-1&&c.match(w.pathName)){g=true;break}g||(r.push(o),l.removeAttribute("onclick"),l.setAttribute("onclick",""),u.on(l,"click",function(w){m.preventEvent(w),f.info("点击图片",l);let d=r.findIndex(h=>h==o);e(r,d);},{capture:true}));});});}let n=new m.LockFunction(()=>{a();});m.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{n.run();}});},setAttachmentsClickTip(){f.info("附件点击提醒");function t(e){if(e.hasAttribute("href")){let a=e.hasAttribute("id")?e.id:e.parentElement.id,n=e.getAttribute("href"),i=e.innerText;if(document.querySelector(`#${a}_menu`).innerText.indexOf("金币")===-1)return;console.log("发现附件",e),console.log("该附件是金币附件，拦截！"),e.setAttribute("data-href",n),e.style.setProperty("cursor","pointer"),e.removeAttribute("href"),e.innerText="【已拦截】"+i,e.onclick=function(){T.confirm({title:{text:"提示",position:"center"},content:{text:`<br />确定花费2金币下载附件 <a style="color: #507daf !important;">${i}</a> ？<br /><br />`,html:true},btn:{ok:{callback:l=>{window.open(n,"_blank"),l.close();}}},mask:{enable:true},width:"400px",height:"200px"});};}}m.mutationObserver(document.documentElement,{callback:()=>{document.querySelectorAll(".attnm a").forEach(e=>{t(e);}),document.querySelectorAll(".comiis_attach a").forEach(e=>{t(e);}),document.querySelectorAll("span[id*=attach_] a").forEach(e=>{t(e);});},immediate:true,config:{childList:true,subtree:true}});},async detectingUserOnlineStatus(){var n;f.info("探测用户在线状态"),y.onceExec("mt-forum-post-detectingUserOnlineStatus",()=>{F(`
				.gm-user-status-icon{
					border: 0 !important;
		...
		`)}},Be={init(){u.ready(()=>{y.execMenuOnce("mt-guide-beautifyPage",()=>this.beautifyPage());});},beautifyPage(){f.info("页面美化"),F(`
			.xst{font-size:15px}
		...
		`),U(".bm_c table tbody").forEach(t=>{let e=t.querySelector("th.common"),a=u.html(e),n=e.querySelectorAll("a")[0].getAttribute("href"),i=null,l=t.querySelector("td.by>cite>a").getAttribute("href").match(/uid-(\d+)/)[1],o=`
			...
			`;u.html(t,o);});}},ne=function(t,e,a,n,i,r="",l,o,s){let c={text:t,type:"input",isNumber:!!l,isPassword:false,props:{},attributes:{},description:n,afterAddToUListCallBack:s,getValue(){return this.props[I].get(e,a)},callback(p,g){this.props[I].set(e,g);},placeholder:r};return Reflect.set(c.attributes,P,e),Reflect.set(c.attributes,Q,a),Reflect.set(c.props,I,{get(p,g){return y.getValue(p,g)},set(p,g){y.setValue(p,g);}}),c},E=function(t,e,a,n,i,r){let l={text:t,type:"switch",description:i,attributes:{},props:{},getValue(){return !!this.props[I].get(e,a)},callback(o,s){let c=!!s;f.success(`${c?"开启":"关闭"} ${t}`),this.props[I].set(e,c);},afterAddToUListCallBack:r};return Reflect.set(l.attributes,P,e),Reflect.set(l.attributes,Q,a),Reflect.set(l.props,I,{get(o,s){return y.getValue(o,s)},set(o,s){y.setValue(o,s);}}),l},re=function(t,e,a,n,i,r="",l){let o={text:t,type:"textarea",attributes:{},props:{},description:n,placeholder:r,disabled:l,getValue(){let s=this.props[I].get(e,a);return Array.isArray(s)?s.join(`
`):s},callback(s,c){this.props[I].set(e,c);}};return Reflect.set(o.attributes,P,e),Reflect.set(o.attributes,Q,a),Reflect.set(o.props,I,{get(s,c){return y.getValue(s,c)},set(s,c){y.setValue(s,c);}}),o};class Ae{constructor(e){W(this,"option");this.option=e;}async showView(){var l;let e=T.confirm({title:{text:this.option.title,position:"center"},content:{text:`
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return K(this.$key.STORAGE_KEY,this.getTemplateData())},setData(t){z(this.$key.STORAGE_KEY,t);}};class _e{constructor(e){W(this,"option");this.option=e;}showView(){let e=T.alert({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `}),a=e.$shadowRoot.querySelector(".filter-container"),n=document.createDocumentFragment();this.option.filterOption.forEach(i=>{let r=document.createElement("button");r.innerText=i.name;let l=async()=>{(await this.option.getAllRuleInfo()).forEach(async s=>{await i.filterCallBack(s.data)?u.show(s.$el,false):u.hide(s.$el,false);}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};u.on(r,"click",async o=>{m.preventEvent(o),!(typeof i.callback=="function"&&!await i.callback(o,l))&&await l();}),n.appendChild(r);}),a.appendChild(n);}}class Ne{constructor(e){W(this,"option");this.option=e;}async showView(e){var r,l,o,s,c,p,g,w,d;let a=T.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                    <div class="rule-view-container">
                    </div>
                    `,html:true},btn:{merge:true,reverse:false,position:"space-between",ok:{enable:((o=(l=(r=this.option)==null?void 0:r.bottomControls)==null?void 0:l.add)==null?void 0:o.enable)||true,type:"primary",text:"添加",callback:async h=>{this.showEditView(false,await this.option.getAddData(),a.$shadowRoot);}},close:{enable:true,callback(h){a.close();}},cancel:{enable:((p=(c=(s=this.option)==null?void 0:s.bottomControls)==null?void 0:c.filter)==null?void 0:p.enable)||false,type:"default",text:"过滤",callback:(h,b)=>{var S,v,C,R,L,O,B;typeof((C=(v=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:v.filter)==null?void 0:C.callback)=="function"&&this.option.bottomControls.filter.callback();let A=()=>Array.from(a.$shadowRoot.querySelectorAll(".rule-view-container .rule-item")),k=b.target.closest(".pops-confirm-btn").querySelector(".pops-confirm-btn-cancel span");u.text(k).includes("取消")?(A().forEach(ue=>{u.show(ue,false);}),u.text(k,"过滤")):new _e({title:((L=(R=this.option.bottomControls)==null?void 0:R.filter)==null?void 0:L.title)??"过滤规则",filterOption:((B=(O=this.option.bottomControls)==null?void 0:O.filter)==null?void 0:B.option)||[],execFilterCallBack(){u.text(k,"取消过滤");},getAllRuleInfo:()=>A().map(de=>({data:this.parseRuleItemElement(de).data,$el:de}))}).showView();}},other:{enable:((d=(w=(g=this.option)==null?void 0:g.bottomControls)==null?void 0:w.clear)==null?void 0:d.enable)||true,type:"xiaomi-primary",text:`清空所有(${(await this.option.data()).length})`,callback:h=>{let b=T.confirm({title:{text:"提示",position:"center"},content:{text:"确定清空所有的数据？",html:false},btn:{ok:{enable:true,callback:async A=>{var S,v,C;if(f.success("清空所有"),typeof((C=(v=(S=this.option)==null?void 0:S.bottomControls)==null?void 0:v.clear)==null?void 0:C.callback)=="function"&&this.option.bottomControls.clear.callback(),(await this.option.data()).length){x.error("清理失败");return}else x.success("清理成功");await this.updateDeleteAllBtnText(a.$shadowRoot),this.clearContent(a.$shadowRoot),b.close();}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}}},mask:{enable:true},width:window.innerWidth>500?"500px":"88vw",height:window.innerHeight>500?"500px":"80vh",style:`
            ${T.config.cssText.panelCSS}
...
`,He={$data:{cid:""},init(){this.registerMenu();},registerMenu(){Y.add({key:"black-home",text:"⚙ 小黑屋",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{this.showBlackHome();}});},async showBlackHome(){let t=x.loading("正在获取小黑屋名单中..."),e=await this.getBlackListInfo("");if(t.close(),!e)return;if(e.data.length===0){x.error("获取小黑屋名单为空");return}this.$data.cid=e.next_cid;let a=T.confirm({title:{text:"小黑屋名单",position:"center"},content:{text:`
                <div class="blackhome-user-filter">
                    <input placeholder="过滤用户名/操作人员/UID(可正则)">
                </div>
                <div class="blackhome-user-list"></div>
                `,html:true},btn:{ok:{text:"下一页",callback:async()=>{let o=x.loading("正在获取小黑屋名单中...");f.info("下一页的cid: ",this.$data.cid);let s=await this.getBlackListInfo(this.$data.cid);o.close(),s&&(this.$data.cid=s.next_cid,s.data.forEach(c=>{let p=this.createListViewItem(c);n.appendChild(p);}),s.data.length===0?x.error("获取小黑屋名单为空"):x.success(`成功获取 ${s.data.length}条数据`),m.dispatchEvent(i,"input"));}},cancel:{text:"关闭"}},width:j.settingBig.width,height:j.settingBig.height,style:Fe,mask:{enable:true}}),n=a.$shadowRoot.querySelector(".blackhome-user-list"),i=a.$shadowRoot.querySelector(".blackhome-user-filter input");e.data.forEach(o=>{let s=this.createListViewItem(o);n.appendChild(s);}),x.success(`成功获取 ${e.data.length}条数据`);let r=false;u.on(i,["input","propertychange"],m.debounce(()=>{let o=i.value.trim();if(!r){if(r=true,o==""){a.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(s=>{s.removeAttribute("style");}),r=false;return}a.$shadowRoot.querySelectorAll(".blackhome-user-item").forEach(s=>{s.getAttribute("data-name").match(new RegExp(o,"ig"))||s.getAttribute("data-uid").trim().match(new RegExp(o,"ig"))||s.getAttribute("data-operator").match(new RegExp(o,"ig"))?s.removeAttribute("style"):s.setAttribute("style","display:none;");}),r=false;}}));let l=await this.getBlackListInfo(this.$data.cid);l&&(this.$data.cid=l.next_cid);},async getBlackListInfo(t=""){let e={mod:"misc",action:"showdarkroom",cid:t,ajaxdata:"json"},a=await D.get(`/forum.php?${m.toSearchParamsStr(e)}`,{headers:{"User-Agent":m.getRandomPCUA()},responseType:"json"});if(!a.status)return;let n=m.toJSON(a.data.responseText),i=n.message.split("|"),r=i[i.length-1],l=m.parseObjectToArray(n.data),o=[],s=[];return l.forEach(c=>{let p=c.dateline.match(/([0-9]{4}-[0-9]{1,2}-[0-9]{1,2}[\s]*[0-9]{1,2}:[0-9]{1,2})/g);if(p==null){let g=parseInt((Date.now()/1e3).toString()),w=0,d=c.dateline.match(/([0-9]+|半)[\s\S]*秒前/),h=c.dateline.match(/([0-9]+|半)[\s\S]*分钟前/),b=c.dateline.match(/([0-9]+|半)[\s\S]*小时前/),A=c.dateline.match(/昨天[\s\S]*(\d{2}):(\d{2})/),k=c.dateline.match(/前天[\s\S]*(\d{2}):(\d{2})/),S=c.dateline.match(/([0-9]+|半)[\s\S]*天前/);if(d)d=d[d.length-1],d=d.replace(/半/g,.5),d=parseFloat(d),w=g-d;else if(h)h=h[h.length-1],h=h.replace(/半/g,.5),h=parseFloat(h),w=g-h*60;else if(b)b=b[b.length-1],b=b.replace(/半/g,.5),b=parseFloat(b),w=g-b*60*60;else if(A){let v=A[1],C=A[2];w=g-86400-parseInt(v)*3600-parseInt(C)*60;}else if(k){let v=k[1],C=k[2];w=g-86400*2-parseInt(v)*3600-parseInt(C)*60;}else S&&(S=S[S.length-1],S=S.replace(/半/g,.5),S=parseFloat(S),w=g-S*60*60*24);c.time=parseInt(w.toString())*1e3,o=o.concat(c);return}else p=p[0];c.time=m.formatToTimeStamp(p),o=o.concat(c);}),m.sortListByProperty(o,"time"),m.sortListByProperty(s,"time",false),o=o.concat(s),{next_cid:r,data:o}},createListViewItem(t){let e=u.createElement("div",{className:"blackhome-user-item",innerHTML:`

...
(function (x, G, V, j, Z, ye) {
	'use strict';

	var ce=typeof GM<"u"?GM:void 0,re=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,ue=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,K=typeof GM_getValue<"u"?GM_getValue:void 0,he=typeof GM_info<"u"?GM_info:void 0,ve=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,H=typeof GM_setValue<"u"?GM_setValue:void 0,Ae=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,ke=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,D=typeof unsafeWindow<"u"?unsafeWindow:void 0,Se=window;const le={waitRemove(...t){t.forEach(e=>{typeof e=="string"&&m.waitNodeList(e).then(a=>{a.forEach(n=>n.remove());});});},addBlockCSS(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(a=>{Array.isArray(a)?e=e.concat(a):e.push(a);}),N(`${e.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof ue=="function"?ue(t.keyName):null;typeof e=="string"&&e?N(e):le.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,G.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(a=>{e.onload=()=>{a(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
			.pops-overflow-hidden-important {
				overflow: hidden !important;
			}
		`;let a=[document.documentElement,document.body].concat(...t||[]);return a.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){a.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(n){navigator.clipboard.readText().then(i=>{n(i);}).catch(i=>{h.error("读取剪贴板内容失败👉",i),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(i=>{t(n);}).catch(i=>{h.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),t(n);});}function a(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!a()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")}},fe={Viewer:{keyName:"ViewerCSS",url:"https://fastly.jsdelivr.net/npm/viewerjs@latest/dist/viewer.min.css"},Hljs:{keyName:"HljsCSS",url:"https://fastly.jsdelivr.net/npm/highlight.js@latest/styles/github-dark.min.css"}},Q={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},m=V.noConflict(),u=G.noConflict(),I=j,h=new m.Log(he,D.console||Se.console);let ae=he?.script?.name||void 0;j.config.Utils.AnyTouch();const ge=false;h.config({debug:ge,logMaxCount:1e3,autoClearConsole:true,tag:true});x.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return b.getValue(Q.qmsg_config_position.key,Q.qmsg_config_position.defaultValue)}},maxNums:{get(){return b.getValue(Q.qmsg_config_maxnums.key,Q.qmsg_config_maxnums.defaultValue)}},showReverse:{get(){return b.getValue(Q.qmsg_config_showreverse.key,Q.qmsg_config_showreverse.defaultValue)}},zIndex:{get(){let t=V.getMaxZIndex(),e=j.config.InstanceUtils.getPopsMaxZIndex().zIndex;return V.getMaxValue(t,e)+100}}}));I.GlobalConfig.setGlobalConfig({zIndex:()=>{let t=V.getMaxZIndex(void 0,void 0,a=>{if(a?.classList?.contains("qmsg-shadow-container")||a?.closest("qmsg")&&a.getRootNode()instanceof ShadowRoot)return  false}),e=j.config.InstanceUtils.getPopsMaxZIndex().zIndex;return V.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}}});const Y=new m.GM_Menu({GM_getValue:K,GM_setValue:H,GM_registerMenuCommand:ve,GM_unregisterMenuCommand:Ae}),R=new m.Httpx({xmlHttpRequest:ke,logDetails:ge});R.interceptors.request.use(t=>t);R.interceptors.response.use(void 0,t=>(h.error("拦截器-请求错误",t),t.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),t));D.Object.defineProperty,D.Function.prototype.apply,D.Function.prototype.call,D.Element.prototype.appendChild,D.setTimeout;const N=m.addStyle.bind(m),_=document.querySelector.bind(document),B=document.querySelectorAll.bind(document);new m.GM_Cookie;const we="GM_Panel",oe="data-init",P="data-key",z="data-default-value",Ce="data-init-more-value",S="data-storage-api",W={setting:{get width(){return window.innerWidth<550?"88vw":window.innerWidth<700?"550px":"700px"},get height(){return window.innerHeight<450?"70vh":window.innerHeight<550?"450px":"550px"}},settingBig:{get width(){return window.innerWidth<800?"92vw":"800px"},get height(){return window.innerHeight<600?"80vh":"600px"}}};class Ie{storageKey;listenerData;constructor(e){if(typeof e=="string"){let a=e.trim();if(a=="")throw new Error("key参数不能为空字符串");this.storageKey=a;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new V.Dictionary;}getLocalValue(){let e=K(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){H(this.storageKey,e);}set(e,a){let n=this.get(e),i=this.getLocalValue();Reflect.set(i,e,a),this.setLocalValue(i),this.triggerValueChangeListener(e,n,a);}get(e,a){let n=this.getLocalValue();return Reflect.get(n,e)??a}getAll(){return this.getLocalValue()}delete(e){let a=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.triggerValueChangeListener(e,a,void 0);}has(e){let a=this.getLocalValue();return Reflect.has(a,e)}keys(){let e=this.getLocalValue();return Reflect.ownKeys(e)}values(){let e=this.getLocalValue();return Reflect.ownKeys(e).map(a=>Reflect.get(e,a))}clear(){re(this.storageKey);}addValueChangeListener(e,a){let n=Math.random(),i=this.listenerData.get(e)||[];return i.push({id:n,key:e,callback:a}),this.listenerData.set(e,i),n}removeValueChangeListener(e){let a=false;for(const[n,i]of this.listenerData.entries()){for(let r=0;r<i.length;r++){const l=i[r];(typeof e=="string"&&l.key===e||typeof e=="number"&&l.id===e)&&(i.splice(r,1),r--,a=true);}this.listenerData.set(n,i);}return a}triggerValueChangeListener(e,a,n){if(!this.listenerData.has(e))return;let i=this.listenerData.get(e);for(let r=0;r<i.length;r++){const l=i[r];if(typeof l.callback=="function"){let o=this.get(e),s,c;typeof a<"u"&&arguments.length>=2?c=a:c=o,typeof n<"u"&&arguments.length>2?s=n:s=o,l.callback(e,c,s);}}}}const U=new Ie(we),se={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new m.Dictionary),this.__contentConfig}},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]}},Ee={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{b.showPanel(se.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){b.isTopWindow()&&Y.add(this.$data.menuOption);},addMenuOption(t){Array.isArray(t)||(t=[t]),this.$data.menuOption.push(...t);},updateMenuOption(t){Array.isArray(t)||(t=[t]),t.forEach(e=>{let a=this.$data.menuOption.findIndex(n=>n.key===e.key);a!==-1&&(this.$data.menuOption[a]=e);});},getMenuOption(t=0){return this.$data.menuOption[t]},deleteMenuOption(t=0){this.$data.menuOption.splice(t,1);}},b={$data:{__configDefaultValueData:null,__onceExecMenuData:null,__onceExecData:null,__panelConfig:{},$panel:null,get configDefaultValueData(){return this.__configDefaultValueData==null&&(this.__configDefaultValueData=new m.Dictionary),this.__configDefaultValueData},get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new m.Dictionary),this.__onceExecMenuData},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new m.Dictionary),this.__onceExecData},get scriptName(){return ae},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:we,attributeKeyName:P,attributeDefaultValueName:z},init(){this.initContentDefaultValue(),Ee.init();},isTopWindow(){return D.top===D.self},initContentDefaultValue(){const t=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;let i={},r=n.attributes[P];r!=null&&(i[r]=n.attributes[z]);let l=n.attributes[oe];if(typeof l=="function"){let c=l();if(typeof c=="boolean"&&!c)return}let o=n.attributes[Ce];o&&typeof o=="object"&&Object.assign(i,o);let s=Object.keys(i);if(!s.length){h.warn(["请先配置键",n]);return}s.forEach(c=>{let p=i[c];this.setDefaultValue(c,p);});},e=n=>{for(let i=0;i<n.length;i++){let r=n[i];t(r);let l=r.forms;l&&Array.isArray(l)&&e(l);}},a=[...se.getAllContentConfig()];for(let n=0;n<a.length;n++){let i=a[n];if(!i.forms)continue;const r=i.forms;r&&Array.isArray(r)&&e(r);}},setDefaultValue(t,e){this.$data.configDefaultValueData.has(t)&&h.warn("请检查该key(已存在): "+t),this.$data.configDefaultValueData.set(t,e);},setValue(t,e){U.set(t,e);},getValue(t,e){let a=U.get(t);return a??(this.$data.configDefaultValueData.has(t)?this.$data.configDefaultValueData.get(t):e)},deleteValue(t){U.delete(t);},hasKey(t){return U.has(t)},addValueChangeListener(t,e){return U.addValueChangeListener(t,(n,i,r)=>{e(t,r,i);})},removeValueChangeListener(t){U.removeValueChangeListener(t);},triggerMenuValueChange(t,e,a){U.triggerValueChangeListener(t,a,e);},deleteExecMenuOnce(t){return this.$data.onceExecMenuData.delete(t),U.removeValueChangeListener(t)},deleteOnceExec(t){this.$data.onceExecData.delete(t);},exec(t,e,a,n=true){const i=this;let r;typeof t=="string"||Array.isArray(t)?r=()=>t:r=t;let l=false,o=r(),s=[];Array.isArray(o)?(l=true,s=o):s.push(o);let c=s.find(v=>!this.$data.configDefaultValueData.has(v));if(c){h.warn(`${c} 键不存在`);return}let p=JSON.stringify(s);if(n){if(this.$data.onceExecMenuData.has(p))return;this.$data.onceExecMenuData.set(p,1);}let g=[],w=[],d=(v,T)=>{let L=[];T instanceof HTMLStyleElement?L=[T]:Array.isArray(T)&&(L=[...T.filter(O=>O!=null&&O instanceof HTMLStyleElement)]),g=g.concat(L);},f=v=>this.getValue(v),y=()=>{for(let v=0;v<g.length;v++)g[v].remove(),g.splice(v,1),v--;},A=()=>{let v=false;return typeof a=="function"?v=a(s):v=s.every(T=>f(T)),v},k=v=>{let T=A(),L=[];if(T){let O=s.map($=>this.getValue($)),q=e({addStyleElement:(...$)=>d(true,...$),value:l?O:O[0]});q instanceof HTMLStyleElement?L.push(q):Array.isArray(q)&&L.push(...q.filter($=>$!=null&&$ instanceof HTMLStyleElement));}y(),g=[...L];};return n&&s.forEach(v=>{let T=this.addValueChangeListener(v,(L,O,q)=>{k();});w.push(T);}),k(),{clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),n&&i.$data.onceExecMenuData.delete(p);},clearStoreStyleElements:()=>y(),removeValueChangeListener:()=>{w.forEach(v=>{this.removeValueChangeListener(v);});}}},execMenu(t,e,a=false){return this.exec(t,n=>e(n),n=>n.every(r=>{let l=!!this.getValue(r);return a&&(l=!l),l}),false)},execMenuOnce(t,e){return this.exec(t,e,a=>a.every(i=>!!this.getValue(i)),true)},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},showPanel(t,e=`${ae}-设置`){let a=I.panel({title:{text:`${ae}-设置`,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(n,i)=>{n.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(n,i)=>{n(),this.$data.$panel=null;}},width:W.setting.width,height:W.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a;}},Te=()=>{var t,e,a,n,i,r,l,o,s,c,p;c=/((https?:\/\/|www\.)[\x21-\x7e]+[\w\/]|(\w[\w._-]+\.(com|cn|org|net|info|tv|cc))(\/[\x21-\x7e]*[\w\/])?|ed2k:\/\/[\x21-\x7e]+\|\/|thunder:\/\/[\x21-\x7e]+=)/gi,t=function(d){var f;if(d=(f=d.originalTarget)!=null?f:d.target,d!=null&&d.localName==="a"&&d.className.indexOf("texttolink")!==-1&&(f=d.getAttribute("href"),f.indexOf("http")!==0&&f.indexOf("ed2k://")!==0&&f.indexOf("thunder://")!==0))return d.setAttribute("href","http://"+f)},document.addEventListener("mouseover",t),s=function(d){if(typeof d=="object"&&d!=null&&typeof d.parentNode<"u"&&typeof d.parentNode.className<"u"&&typeof d.parentNode.className.indexOf=="function"&&d.parentNode.className.indexOf("texttolink")===-1&&d.nodeName!=="#cdata-section"){var f=d.textContent.replace(c,'<a href="$1" target="_blank" class="texttolink">$1</a>');if(d.textContent.length!==f.length){var y=document.createElement("span");return y.innerHTML=f,console.log(`识别: ${y.querySelector("a")}`),d.parentNode.replaceChild(y,d)}}},e="a svg canvas applet input button area pre embed frame frameset head iframe img option map meta noscript object script style textarea code".split(" "),p=`//text()[not(ancestor::${e.join(") and not(ancestor::")})]`,a=new RegExp(`^(${e.join("|")})$`,"i"),i=function(d,f){var y,A;if(f+1e4<d.snapshotLength){var k=y=f;for(A=f+1e4;f<=A?y<=A:y>=A;k=f<=A?++y:--y)s(d.snapshotItem(k));setTimeout(function(){return i(d,f+1e4)},15);}else for(k=y=f,A=d.snapshotLength;f<=A?y<=A:y>=A;k=f<=A?++y:--y)s(d.snapshotItem(k));},r=function(d){return d=document.evaluate(p,d,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null),i(d,0)},l=function(d){for(d=document.createTreeWalker(d,NodeFilter.SHOW_TEXT,{acceptNode:function(f){if(!a.test(f.parentNode.localName))return NodeFilter.FILTER_ACCEPT}},false);d.nextNode();)s(d.currentNode);},o=new window.MutationObserver(function(d){var f,y,A=0;for(f=d.length;A<f;A++){var k=d[A];if(k.type==="childList"){var E=k.addedNodes,v=0;for(y=E.length;v<y;v++)k=E[v],l(k);}}}),n=function(){return r(document.body),o.observe(document.body,{childList:true,subtree:true})};var g=function(d){var f=d.getAttribute("href");if(f.indexOf("http")!==0&&f.indexOf("ed2k://")!==0&&f.indexOf("thunder://")!==0)return d.setAttribute("href","http://"+f)},w=function(){for(var d=document.getElementsByClassName("texttolink"),f=0;f<d.length;f++)g(d[f]);};setTimeout(w,1500),setTimeout(n,100);};le.setGMResourceCSS(fe.Viewer);le.setGMResourceCSS(fe.Hljs);I.GlobalConfig.setGlobalConfig({mask:{enable:true},drag:true});const J={formhash:/formhash=([0-9a-zA-Z]+)/,uid:/uid(=|-)(\d+)/,fontSpecial:/<font.*?>|<\/font>|<strike>|<strong>|<i>|<u>|align=".*?"|<br>[\s]*<br>[\s]*<br>/g},M={getAvatar:(t,e="middle")=>`/uc_server/avatar.php?uid=${t}&size=${e}&ts=1`,getCurrentUID(){let t=D.discuz_uid;if(typeof t=="string")return t;let e=_('.sidenv_exit a[href*="uid-"]')||_('#comiis_key a[href*="uid-"]');if(e){let a=e.href.match(/uid=([0-9]+)/);if(a)return a[a.length-1]}},async getFormHash(){let t=Array.from((top||globalThis).document.querySelectorAll("input[name=formhash]"));for(let n=0;n<t.length;n++){let r=t[n].value;if(r)return r}let e=Array.from((top||globalThis).document.querySelectorAll('a[href*="formhash="]'));for(let n=0;n<e.length;n++){let r=e[n].href.match(J.formhash);if(r){let l=r[r.length-1];if(l)return l}}let a=await R.get("/home.php?mod=spacecp",{fetch:true,allowInterceptConfig:false});if(a.status){let n=a.data.responseText,r=u.parseHTML(n,true,true).querySelector("input[name=formhash]");if(r){let l=r.value;if(m.isNotNull(l))return l}}else h.error("请求个人主页获取formhash失败",a);},envIsMobile(){return (D.STYLEID||window.STYLEID||typeof STYLEID<"u"&&STYLEID)==="3"},getThreadId:t=>{let e=t.match(/thread-([\d]+)-|&tid=([\d]+)/i);if(e){let a=e.filter(Boolean);return a[a.length-1]}},getForumId(t){let e=t.match(/&fid=([\d]+)/i);if(e)return e[e.length-1]},getPostId(t){let e=t.match(/&pid=([\d]+)/i);if(e)return e[e.length-1]},getRepquote(t){let e=t.match(/&repquote=([\d]+)/i);if(e)return e[e.length-1]}},X={$key:{sign:"mt-sign-time"},init(){this.sign();},checkSignInfo(){let e=this.getSignInfo().find(a=>a.hostName===window.location.hostname);return e?m.formatTime(Date.now(),"yyyyMMdd")===m.formatTime(e.time,"yyyyMMdd"):false},setSignInfo(){let t={hostName:window.location.hostname,time:Date.now()},e=this.getSignInfo(),a=e.findIndex(n=>n.hostName===t.hostName);a!==-1&&e.splice(a,1),e.push(t),H(this.$key.sign,e);},getSignInfo(){let t=K(this.$key.sign,[]);return Array.isArray(t)?t:(this.clearSignInfo(),[])},getHostNameSignInfo(t=window.location.hostname){return this.getSignInfo().find(a=>a.hostName===t)},clearSignInfo(t){if(typeof t=="string"){let e=this.getSignInfo(),a=e.findIndex(n=>n.hostName===t);a!==-1&&e.splice(a,1),H(this.$key.sign,e);}else re(this.$key.sign);},checkLogin(){return M.envIsMobile()?!!_("a[href*='member.php?mod=logging&action=logout']"):!!_("#comiis_key")},async sign(){let t=await M.getFormHash();if(t==null){if(_("#comiis_picshowbox")){h.info("当前为评论区的看图模式 ");return}h.error("自动签到：获取账号formhash失败"),this.clearSignInfo(window.location.hostname),x.error({content:"自动签到：获取账号formhash失败"});return}if(this.checkSignInfo()){h.info("今日已签到");return}let e=!!b.getValue("mt-auto-sign-useFetch"),a=m.getRandomPCUA(),n=()=>{this.setSignInfo();},i=()=>{this.clearSignInfo(window.location.hostname);},r=o=>{let c=j.alert({title:{text:"未知签到内容",position:"center"},content:{text:"",html:false},width:"88vw",height:"300px"}).$shadowRoot.querySelector(".pops-alert-content");c.innerText=o;},l=[{checkPluginEnableUrl:"/plugin.php?id=k_misign:sign",async sign(){let o={operation:"qiandao",format:"button",formhash:t,inajax:1,ajaxtarget:"midaben_sign"},s=await R.get(`/k_misign-sign.html?${m.toSearchParamsStr(o)}`,{fetch:e,headers:{"User-Agent":a},allowInterceptConfig:false});if(!s.status){x.error("签到：网络异常，请求失败",{consoleLogContent:true});return}n(),h.info("签到信息：",s);let c=s.data.responseText,p=m.parseCDATA(c),g=u.parseHTML(`<div>${p}</div>`,true,false),w=u.text(g);if(w.includes("需要先登录")){x.error("签到：请先登录账号",{timeout:3e3,consoleLogContent:true}),i();return}else if(w.includes("请稍后再试")||w.includes("您已经被列入黑名单")||w.includes("绑定手机号后才可以签到")||w.includes("您所在用户组不允许使用")){x.error("签到："+w,{timeout:5e3});return}else if(w.includes("今日已签")||w.includes("今日已经签到")){x.info("签到："+w);return}else if(c.includes("您当前的访问请求当中含有非法字符，已经被系统拒绝")){x.error("签到: 您当前的访问请求当中含有非法字符，已经被系统拒绝",{timeout:6e3});return}else if(e&&"location"in m.toJSON(c)){x.success("签到: 签到成功");return}let d=g.querySelector(".con"),f=g.querySelector(".line");if(d&&f){let y=u.text(d).match(/([0-9]+)金币/),A=u.text(f).match(/([0-9]+)/),k=y[y.length-1],E=A[A.length-1];h.success(`金币${k}，排名${E}`),x.info(`
        ...
        }`)},removeFontStyle(){let t=document.querySelector(".comiis_a.comiis_message_table");t&&(h.info("移除帖子字体效果"),u.html(t,u.html(t).replace(J.fontSpecial,"")));},removeCommentFontStyle(){h.info("移除评论区的字体效果");let t=B("font"),e=_(".comiis_postlist .comiis_postli")?.innerHTML||"";e!==""&&(t.forEach(a=>{e.includes(a.innerHTML)||(a.removeAttribute("color"),a.removeAttribute("style"),a.removeAttribute("size"));}),B(".comiis_message.message").forEach(a=>{if(e.includes(a.innerHTML)){a.innerHTML=a.innerHTML.replace(J.fontSpecial,"");let n=a.nextElementSibling;n&&n.localName==="strike"&&(n.outerHTML=n.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));}})),B(".comiis_postli.comiis_list_readimgs.nfqsqi").forEach(a=>{let n=a.parentElement;n&&n.localName==="strike"&&(n.outerHTML=n.outerHTML.replace(/^<strike>(\n|)/g,"").replace(/<\/strike>$/g,""));});},loadNextPageComment(){if(h.info("自动加载下一页评论"),document.title.includes("提示信息 - MT论坛"))return;if(B(".pgbtn").length==0){h.warn("没有找到下一页按钮");return}var t=async function(n){let i=await R.get(n,{fetch:true,allowInterceptConfig:false});if(!i.status){x.error("网络异常，请求下一页失败");return}var r=m.parseFromString(i.data.responseText),l=r.querySelector(".pgbtn a");return r.querySelector("#postlistreply")?.remove(),r.querySelector(".bm_h.comiis_snvbt")?.remove(),{url:l?l.getAttribute("href"):null,postlist:r.querySelector("#postlist"),pgbtn:r.querySelector(".pgbtn"),pgs:r.querySelector(".pgs.mtm")}},e=async function(){var n=_(".pgbtn a").getAttribute("href");if(n){let i=await t(n);i&&(i.postlist?.querySelector(".comiis_vrx")?.querySelector(".km1")&&(Object.keys(i).forEach(r=>{i[r]=null;}),h.warn("检测到请求的本页内容中存在【楼主】标识，判断为重复页请求")),(!i.url||i.url==n)&&(h.error("最后一页，取消监听"),u.off(document,["scroll","wheel"],a.run),u.remove(".pgbtn")),i.postlist&&u.append("#postlist",u.html(i.postlist)),i.pgbtn&&u.html(".pgbtn",u.html(i.pgbtn)),i.pgs&&u.html(".pgs.mtm",u.html(i.pgs)),xe.init());}else h.error("获取下一页元素失败");};let a=new m.LockFunction(async()=>{m.isNearBottom()&&await e();});u.on(document,["scroll","wheel"],a.run);},codeQuoteOptimization(){h.info("代码块优化");function t(a){var n=["add","and","cmp","cmpg","cmpl","const","div","double","float","goto","if","int","long","move","mul","neg","new","nop","not","or","rem","return","shl","shr","sput","sub","throw","ushr","xor"],i=["aget","aput","array","check","execute","fill","filled","goto/16","goto/32","iget","instance","invoke","iput","monitor","packed","sget","sparse"],r=["transient","constructor","abstract","final","synthetic","public","private","protected","static","bridge","system"];return {aliases:["smali"],contains:[{className:"string",begin:'"',end:'"',relevance:0},a.COMMENT("#","$",{relevance:0}),{className:"keyword",variants:[{begin:"\\s*\\.end\\s[a-zA-Z0-9]*"},{begin:"^[ ]*\\.[a-zA-Z]*",relevance:0},{begin:"\\s:[a-zA-Z_0-9]*",relevance:0},{begin:"\\s("+r.join("|")+")"}]},{className:"built_in",variants:[{begin:"\\s("+n.join("|")+")\\s"},{begin:"\\s("+n.join("|")+")((\\-|/)[a-zA-Z0-9]+)+\\s",relevance:10},{begin:"\\s("+i.join("|")+")((\\-|/)[a-zA-Z0-9]+)*\\s",relevance:10}]},{className:"class",begin:`L[^(;:
		...
		`),B(".bm_c table tbody").forEach(t=>{let e=t.querySelector("th.common"),a=u.html(e),n=e.querySelectorAll("a")[0].getAttribute("href"),i=null,l=t.querySelector("td.by>cite>a").getAttribute("href").match(/uid-(\d+)/)[1],o=`
			<td class="author_img">
...
`):c},callback(s,c){this.props[S].set(e,c);}};return Reflect.set(o.attributes,P,e),Reflect.set(o.attributes,z,a),ne.initComponentsStorageApi("switch",o,{get(s,c){return b.getValue(s,c)},set(s,c){b.setValue(s,c);}}),o};class be{option;constructor(e){this.option=e;}async showView(){let e=I.confirm({title:{text:this.option.title,position:"center"},content:{text:`
                ...
                ${this.option?.style??""}
            `,width:typeof this.option.width=="function"?this.option.width():window.innerWidth>500?"500px":"88vw",height:typeof this.option.height=="function"?this.option.height():window.innerHeight>500?"500px":"80vh"}),a=e.$shadowRoot.querySelector(".rule-form-container");e.$shadowRoot.querySelector("input[type=submit]");let n=e.$shadowRoot.querySelector(".rule-form-ulist"),i=await this.option.getView(await this.option.data());n.appendChild(i);const r=async()=>{(await this.option.onsubmit(a,await this.option.data())).success&&(e.close(),await this.option.dialogCloseCallBack(true));};}}const De={$el:{isFilterElementHTML:[]},$key:{STORAGE_KEY:"mt-post-comment-filter-rule"},init(){if(this.registerMenu(),ee.isPost()){let t=this.getData();if(!t.enable)return;let e=new m.LockFunction(()=>{this.runFilter(t);});m.mutationObserver(document,{config:{subtree:true,childList:true},callback:()=>{e.run();}});}},registerMenu(){Y.add({key:"comment-filter",text:"⚙ 评论过滤器",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{this.showView();}});},runFilter(t){let e=function(n){for(const i of t.userBlackList)if(i==n.userName||i==n.userUID)return h.success("评论过滤器：黑名单用户",n),true;return  false},a=function(n){for(const i of t.userWhiteList)if(i===n.userName||i===n.userUID)return h.success("评论过滤器：白名单用户",n),true;return  false};B(".comiis_vrx").forEach(n=>{if(n.querySelector(".plc .pti .authi .show"))return;let i=n.querySelector(".pls .authi a"),r={userName:i?.innerText||"",userUID:i?.href?.match(J.uid)?.[2]?.trim()||"",content:n.querySelector(".plc td.t_f")?.innerText?.trim()||"",isAuthor:false};if(!a(r)){if(t.replyFlag&&n.querySelector(".quote")){let l=n.querySelector(".quote");this.$el.isFilterElementHTML.push(l.outerHTML),l.remove();}if(!(r.isAuthor&&!t.avatarFlag)){if(e(r)){this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}if(!(typeof t.minLength=="number"&&t.minLength>r.content.length)&&!(typeof t.keywordLength=="number"&&t.keywordLength<r.content.length))for(const l of t.keywords){if(typeof l!="string")continue;let o=new RegExp(l);if(r.content.match(o)){console.log("评论过滤器：",r),this.$el.isFilterElementHTML.push(n.outerHTML),n.remove();return}}}}});},showView(){const t=this;function e(i){return {get(r,l){let o=t.getData(),s=Reflect.get(o,r,l);return (r==="keywords"||r==="userWhiteList"||r==="userBlackList")&&(s=s.join(`
`)),s},set(r,l){(r==="keywords"||r==="userWhiteList"||r==="userBlackList")&&(l=l.split(`
`).filter(o=>o.trim()!="")),Reflect.set(i,r,l),t.setData(i);}}}let a=I.config.PanelHandlerComponents();new be({title:"评论过滤器",data:()=>this.getData(),getView:i=>{let r=document.createDocumentFragment(),l=C("启用","enable",true);Reflect.set(l.props,S,e(i));let o=a.createSectionContainerItem_switch(l),s=C("处理回复引用","replyFlag",false,void 0,"移除引用");Reflect.set(s.props,S,e(i));let c=a.createSectionContainerItem_switch(s),p=C("处理作者评论","avatarFlag",false);Reflect.set(p.props,S,e(i));let g=a.createSectionContainerItem_switch(p),w=C('处理从"搜索页面"或"我的帖子提醒页面"进入的网站',"viewthreadFlag",false);Reflect.set(w.props,S,e(i));let d=a.createSectionContainerItem_switch(w),f=te("匹配的评论内容长度最小值","minLength",5,"小于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(f.props,S,e(i));let y=a.createSectionContainerItem_input(f),A=te("匹配的评论内容长度最大值","keywordLength",8,"大于此长度的评论就算关键字匹配成功了也不会被排除",void 0,"",true);Reflect.set(A.props,S,e(i));let k=a.createSectionContainerItem_input(A),E=ie("评论关键字","keywords","","多个评论关键字换行分割");Reflect.set(E.props,S,e(i));let v=a.createSectionContainerItem_textarea(E),T=ie("黑名单用户","userBlackList","","多个用户换行分割");Reflect.set(T.props,S,e(i));let L=a.createSectionContainerItem_textarea(T),O=ie("白名单用户","userWhiteList","","多个用户换行分割");Reflect.set(O.props,S,e(i));let q=a.createSectionContainerItem_textarea(O);return r.append(o,c,g,d,y,k,v,L,q),r},btn:{merge:true,position:"space-between",ok:{enable:false},cancel:{enable:true,text:"关闭"},other:{enable:true,text:`查看已过滤（${this.$el.isFilterElementHTML.length}）`,type:"primary",callback:(i,r)=>{I.alert({title:{text:"评论过滤器-已过滤",position:"center"},content:{text:`
...
`)}
            ...
            `}).showView();},getTemplateData(){return {enable:true,avatarFlag:false,replyFlag:false,viewthreadFlag:false,minLength:5,keywordLength:8,keywords:[],userBlackList:[],userWhiteList:[]}},getData(){return K(this.$key.STORAGE_KEY,this.getTemplateData())},setData(t){H(this.$key.STORAGE_KEY,t);}};class Le{option;constructor(e){this.option=e;}showView(){let e=I.alert({title:{text:this.option.title,position:"center"},content:{text:`
...
`,Ne={$data:{},init(){this.registerMenu();},registerMenu(){Y.add({key:"online-user",text:"⚙ 在线用户",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{this.showOnlineUser();}});},async showOnlineUser(){let t=x.loading("正在获取在线用户名单中..."),e=await this.getOnlineUserListInfo();if(t.close(),!e)return;let a=I.alert({title:{text:"在线用户",position:"center"},content:{text:`
            ...
            `},{"data-name":t.name,"data-uid":t.uid,"data-sf":t.sf});return G.on(e,"click",".online-user-avatar",a=>{m.preventEvent(a),window.open(`home.php?mod=space&uid=${t.uid}&do=profile`,"_blank");}),e}},qe={$flag:{showUserUID_initCSS:false},init(){b.onceExec("mt-MTCommentFilter",()=>{De.init();}),ee.isPost()?(h.info("Router: 帖子"),xe.init()):ee.isGuide()?(h.info("Router: 导读"),Re.init()):h.error("Router: 未适配的链接 ==> "+window.location.href),u.ready(()=>{b.onceExec("mt-MTProductListingReminder",()=>{Oe.init();}),b.onceExec("mt-blackHome",()=>{_e.init();}),b.onceExec("mt-onlineUser",()=>{Ne.init();}),b.execMenuOnce("mt-link-text-to-hyperlink",()=>{Te();}),b.execMenuOnce("mt-addLatestPostBtn",()=>{this.addLatestPostBtn();}),b.execMenu("mt-auto-sign",()=>{X.init();}),b.execMenu("mt-extend-cookie-expire",()=>{this.extendCookieExpire();});});},addLatestPostBtn(){h.info("新增【最新发表】"),u.append("#comiis_nv .wp.comiis_nvbox.cl ul",`
			<li id="latest_publication">
				<a href="/forum.php?mod=guide&view=newthread" hidefocus="true" title="最新发表">最新发表</a>
			</li>
		`),window.location.href.includes("/forum.php?mod=guide&view=newthread")&&(u.removeClass("#mn_forum_10","a"),u.css("#latest_publication a","background",'url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAcAAADICAYAAAAk7PuyAAAAAXNSR0IArs4c6QAAAGFJREFUWEft1zESgCAQQ9HsVfb+d5RRlLHRVotHS5f5+YHKyymXiRAihKMISBDCNOInJHT39iTkcpkIYUcTCUKYkkKCEJBwTaY6cML5eiNGYiRGYrz9pqyDdbAOqxC/q8MApobR97qxnMwAAAAASUVORK5CYII=") repeat-x 50% -50px'));},async extendCookieExpire(){h.info("延长cookie有效期");let t=await ce.cookie.list({}),e=["_auth","_saltkey","_client_created","_client_token"];t.forEach(async a=>{if(a.session)return;let n=a.expirationDate,i=Date.now()/1e3;if(n<i)return;let r=60*60*24*30;n-i>r||!e.find(o=>a.name.endsWith(o))||ce.cookie.set({name:a.name,value:a.value,expirationDate:a.expirationDate+r}).then(()=>{h.info(`延长Cookie +30天成功：${a.name}`);}).catch(()=>{h.error(`延长Cookie +30天失败：${a.name}`);});});}},de=function(t,e,a,n,i,r){let l=[];typeof n=="function"?l=n():l=n;let o={text:t,type:"select",description:r,attributes:{},props:{},getValue(){return this.props[S].get(e,a)},callback(s,c,p){let g=c;if(h.info(`选择：${p}`),typeof i=="function"&&i(s,g,p))return;this.props[S].set(e,g);},data:l};return Reflect.set(o.attributes,P,e),Reflect.set(o.attributes,z,a),ne.initComponentsStorageApi("select",o,{get(s,c){return b.getValue(s,c)},set(s,c){b.setValue(s,c);}}),o},pe=function(t,e,a,n,i,r,l,o,s,c){let p={text:t,type:"button",attributes:{},props:{},description:e,buttonIcon:n,buttonIsRightIcon:i,buttonIconIsLoading:r,buttonType:l,buttonText:a,callback(g){typeof o=="function"&&o(g);},afterAddToUListCallBack:s};return Reflect.set(p.attributes,oe,()=>{p.disable=false;}),p},me=function(t,e,a,n){let i={type:"own",attributes:{},props:a,getLiElementCallBack:t,afterAddToUListCallBack:n};return Reflect.set(i.attributes,oe,()=>false),i},F={$upload:{small:false,middle:false,big:false},$data:{avatarInfo:{maxSize:2097152,small:{width:48,height:48},middle:{width:120,height:120},big:{width:200,height:250}}},$el:{$smallUpload:null,$middleUpload:null,$bigUpload:null,$smallStatus:null,$middleStatus:null,$bigStatus:null},$avatar:{get small(){return F.$el.$smallUpload.files[0]},get middle(){return F.$el.$middleUpload.files[0]},get big(){return F.$el.$bigUpload.files[0]}},init(){this.showView();},showView(){const t=this;let e=I.confirm({title:{text:"修改头像",position:"center"},content:{text:`
            ...
            `});this.$el.$smallUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='small']"),this.$el.$middleUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='middle']"),this.$el.$bigUpload=e.$shadowRoot.querySelector(".avatar-upload[data-type='big']"),this.$el.$smallStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='small']"),this.$el.$middleStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='middle']"),this.$el.$bigStatus=e.$shadowRoot.querySelector(".avatar-upload-status[data-type='big']"),this.setUploadChangeEvent(this.$el.$smallUpload,this.$el.$smallStatus,this.$data.avatarInfo.small,()=>{this.$upload.small=true;}),this.setUploadChangeEvent(this.$el.$middleUpload,this.$el.$middleStatus,this.$data.avatarInfo.middle,()=>{this.$upload.middle=true;}),this.setUploadChangeEvent(this.$el.$bigUpload,this.$el.$bigStatus,this.$data.avatarInfo.big,()=>{this.$upload.big=true;});},setUploadChangeEvent(t,e,a,n){u.on(t,"change",i=>{if(!t.files?.length)return;u.text(e,"🤡获取文件信息中..."),e.removeAttribute("data-success");let r=t.files[0],l=r.size,o=new Image,s=new FileReader;s.readAsDataURL(r),s.onload=function(c){o.src=c.target.result,o.onload=function(){if(o.width>a.width||o.height>a.height){t.value="",e.setAttribute("data-success","false"),u.text(e,`🤡校验失败 ==> 图片尺寸不符合，宽：${o.width} 高：${o.height}`);return}if(l>F.$data.avatarInfo.maxSize){t.value="",e.setAttribute("data-success","false"),u.text(e,`🤡校验失败 ==> 图片大小不符合：${l}byte，限制最大：${F.$data.avatarInfo.maxSize}byte`);return}e.setAttribute("data-success","true"),u.text(e,`🤣 通过 宽:${o.width} 高:${o.height} 大小(byte):${l}`),n();};};});},async getUploadUrl(){let t=await R.get("/home.php?mod=spacecp&ac=avatar",{headers:{"User-Agent":m.getRandomPCUA()}});if(!t.status)return;if(m.isNull(t.data.responseText)){x.error("动态头像：获取上传地址的内容失败");return}let e=t.data.responseText.match(/var[\s]*data[\s]*=[\s]*"(.+?)"/);if(e==null||e.length!=2){x.error("动态头像：获取变量data失败");return}let n=e[e.length-1].split(","),i=n.indexOf("stl_src");if(i===-1&&(i=n.indexOf("src")),i===-1){x.error("动态头像：获取上传地址失败");return}let r=n[i+1],l=new URL(r);return l.pathname=l.pathname.replace("/images/camera.swf","/index.php"),l.searchParams.delete("inajax"),l.searchParams.set("m","user"),l.searchParams.set("a","rectavatar"),l.searchParams.set("base64","yes"),r=l.toString(),h.info("上传地址："+r),r}},Fe={id:"component-common",title:"通用",forms:[{text:"",type:"forms",forms:[{text:"Toast配置",type:"deepMenu",forms:[{text:"",type:"forms",forms:[de("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,a)=>{h.info("设置当前Qmsg弹出位置"+a);},"Toast显示在页面九宫格的位置"),de("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),C("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]}]}]},{text:"",type:"forms",forms:[{text:"功能",type:"deepMenu",forms:[{text:"",type:"forms",forms:[C("新增【最新发表】","mt-addLatestPostBtn",true,void 0,"便于快捷跳转"),C("文本转超链接","mt-link-text-to-hyperlink",true,void 0,"自动把符合超链接格式的文字转为超链接"),C("延长登录Cookie过期时间","mt-extend-cookie-expire",false,void 0,"减少频繁登录账号的问题")]}]},{type:"deepMenu",text:"自动签到",forms:[{text:"",type:"forms",forms:[C("启用","mt-auto-sign",true,void 0,"自动请求签到"),C("使用fetch请求","mt-auto-sign-useFetch",false,void 0,""),pe("签到信息",`上次签到时间：${(()=>{let t=X.getHostNameSignInfo(window.location.hostname);return t?V.formatTime(t.time):"尚未签到"})()}`,"清空信息",void 0,void 0,void 0,"primary",t=>{let a=t.composedPath()[0].closest("li").querySelector(".pops-panel-item-left-desc-text");I.confirm({title:{text:"提示 ",position:"center"},content:{text:"<p>是否清空脚本签到记录的时间?</p>",html:true},btn:{ok:{enable:true,callback:n=>{let i=window.location.hostname;X.clearSignInfo(i),x.success("删除成功"),u.text(a,`上次签到时间：${(()=>{let r=X.getHostNameSignInfo(i);return r?V.formatTime(r.time):"尚未签到"})()}`),n.close();}}},width:"300px",height:"200px"});})]}]},{text:"头像",type:"deepMenu",forms:[{text:"<a href='https://ezgif.com/resize' target='_blank'>Resize Image</a>",type:"forms",forms:[me(t=>{let e=u.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										`});return a.querySelector(".avatar-img[data-size='small']"),a.querySelector(".avatar-img[data-size='middle']"),a.querySelector(".avatar-img[data-size='big']"),t.appendChild(e),t.appendChild(a),t.appendChild(n),t}),me(t=>{let e=u.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											<img 
												...
												class="avatar-img" data-size="big">
											`});return t.appendChild(e),t.appendChild(a),t}),pe("修改头像",`可以上传gif图片，注意图片最大限制为${V.formatByteToSize(F.$data.avatarInfo.maxSize)}`,"上传",void 0,false,false,"primary",()=>{F.init();})]}]}]}]},He={id:"component-forum-post",title:"帖子",forms:[{type:"forms",text:"",forms:[{text:"功能",type:"deepMenu",forms:[{type:"forms",text:"",forms:[C("拦截附件","mt-forum-post-interceptionAttachment",true,void 0,"点击附件时弹出提示框进行确认是否下载附件"),C("图片查看优化","mt-forum-post-optimizationImagePreview",true,void 0,"使用Viewer查看图片"),C("自动加载下一页","mt-forum-post-loadNextPageComment",true,void 0,"无缝预览下一页"),C("代码块优化","mt-forum-post-codeQuoteOptimization",true,void 0,"自动检测代码块语言并设置关键字高亮")]}]},{type:"deepMenu",text:"用户信息块",forms:[{type:"forms",text:"",forms:[C("探测用户在线状态","mt-forum-post-detectingUserOnlineStatus",false,void 0,"获取用户在线状态并在用户信息处显示状态表情"),C("显示用户等级","mt-forum-post-showUserLevel",true,void 0,"在用户信息处显示当前用户的等级"),C("隐藏底部信息块","mt-forum-post-hideBottomInfoBlock",false,void 0,"包括金币、好评、信誉等信息")]}]},{type:"deepMenu",text:"右侧悬浮工具栏",forms:[{type:"forms",text:"",forms:[C("新增【快捷收藏】","mt-forum-post-quickCollentBtn",true,void 0,"在右侧悬浮工具栏添加【收藏】按钮，用于快捷收藏"),C("快捷回复优化","mt-forum-post-quickReplyOptimization",true,void 0,"为快捷回复弹窗底部区域添加【一键空格】按钮")]}]}]}]},Pe={id:"component-guide",title:"导读",forms:[{type:"forms",text:"",forms:[C("页面美化","mt-guide-beautifyPage",true,void 0,"美化样式")]}]};se.addContentConfig([Fe,He,Pe]);b.init();qe.init();

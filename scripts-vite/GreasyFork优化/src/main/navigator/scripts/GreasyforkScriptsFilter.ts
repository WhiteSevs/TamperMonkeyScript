...
export const GreasyforkScriptsFilter = {
   ...
   */
  getElementList() {
    let scriptList: HTMLLIElement[] = [...Array.from($$<HTMLLIElement>("ol.script-list li[data-script-name]"))];
    return scriptList;
  },
  /**
   * 对页面进行过滤
  ...
  addValue(key: keyof ScriptFilterRule, value: ScriptFilterRule[keyof ScriptFilterRule]) {

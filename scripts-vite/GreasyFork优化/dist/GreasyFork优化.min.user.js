...
(function (g, S, ae, we, r, Re, Xe) {
  ...
  var Pe=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Ce=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,ee=typeof GM_getValue<"u"?GM_getValue:void 0,pe=typeof GM_info<"u"?GM_info:void 0,qe=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,W=typeof GM_setValue<"u"?GM_setValue:void 0,He=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Ge=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,X=typeof unsafeWindow<"u"?unsafeWindow:void 0,Ve=window;const ie={waitRemove(...e){e.forEach(t=>{typeof t=="string"&&S.waitNodeList(t).then(A=>{A.forEach(n=>n.remove());});});},createBlockCSSNode(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(A=>{Array.isArray(A)?t=t.concat(A):t.push(A);}),S.createElement("style",{type:"text/css",innerHTML:`${t.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof Ce=="function"?Ce(e.keyName):null;typeof t=="string"&&t?M(t):ie.loadStyleLink(e.url);},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,S.ready(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(A=>{t.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
			.pops-overflow-hidden-important {
				overflow: hidden !important;
			}
		`;let A=[document.documentElement,document.body].concat(...e||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(i=>{n(i);}).catch(i=>{u.error("读取剪贴板内容失败👉",i),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(i=>{e(n);}).catch(i=>{u.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(n);});}function A(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!A()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,A=5e3){let n,i=A-t,a=t,o=async l=>{let s=await e(l);if(typeof s=="boolean"&&!s||l){h.workerClearTimeout(n);return}if(a+=t,a>i){o(true);return}n=h.workerSetTimeout(()=>{o(false);},t);};o(false);},findParentNode(e,t,A){if(A){let n=S.closest(e,A);if(n)return n.querySelector(t)}else return S.matches(e,t)?e:S.closest(e,t)}},ce={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},h=ae.noConflict(),c=S.noConflict(),R=we,u=new h.Log(pe,X.console||Ve.console);let ze=pe?.script?.name||void 0;we.config.Utils.AnyTouch();const Fe=false;u.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});g.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.getSetting().type;if(t==="loading")return  false;const A=e.getSetting().content;return t==="warning"?u.warn(A):t==="error"?u.error(A):u.info(A),true},get position(){return v.getValue(ce.qmsg_config_position.key,ce.qmsg_config_position.defaultValue)},get maxNums(){return v.getValue(ce.qmsg_config_maxnums.key,ce.qmsg_config_maxnums.defaultValue)},get showReverse(){return v.getValue(ce.qmsg_config_showreverse.key,ce.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=ae.getMaxZIndex(),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100}});R.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=ae.getMaxZIndex(void 0,void 0,A=>{if(A?.classList?.contains("qmsg-shadow-container")||A?.closest("qmsg")&&A.getRootNode()instanceof ShadowRoot)return  false}),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Te=new h.GM_Menu({GM_getValue:ee,GM_setValue:W,GM_registerMenuCommand:qe,GM_unregisterMenuCommand:He}),H=new h.Httpx({xmlHttpRequest:Ge,logDetails:Fe});H.interceptors.request.use(e=>e);H.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?g.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?g.error("请求超时",{consoleLogContent:true}):g.error("其它错误",{consoleLogContent:true}),e));X.Object.defineProperty,X.Function.prototype.apply,X.Function.prototype.call,X.Element.prototype.appendChild,X.setTimeout;const M=c.addStyle.bind(c),T=S.selector.bind(S),K=S.selectorAll.bind(S);new h.GM_Cookie;const ke="GM_Panel",Se="data-init",ge="data-key",ve="data-default-value",Ye="data-init-more-value",se="data-storage-api",Z={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},_={setting:{get width(){return Z.width<550?"88vw":Z.width<700?"550px":"700px"},get height(){return Z.height<450?"70vh":Z.height<550?"450px":"550px"}},settingMiddle:{get width(){return Z.width<350?"88vw":"350px"},get height(){return Z.height<450?"88vh":"450px"}},settingBig:{get width(){return Z.width<800?"92vw":"800px"},get height(){return Z.height<600?"80vh":"600px"}},info:{get width(){return Z.width<350?"88vw":"350px"},get height(){return Z.height<250?"88vh":"250px"}}};class Ze{storageKey;listenerData;constructor(t){if(typeof t=="string"){let A=t.trim();if(A=="")throw new Error("key参数不能为空字符串");this.storageKey=A;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new ae.Dictionary;}getLocalValue(){let t=ee(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){W(this.storageKey,t);}set(t,A){let n=this.get(t),i=this.getLocalValue();Reflect.set(i,t,A),this.setLocalValue(i),this.triggerValueChangeListener(t,n,A);}get(t,A){let n=this.getLocalValue();return Reflect.get(n,t)??A}getAll(){return this.getLocalValue()}delete(t){let A=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,A,void 0);}has(t){let A=this.getLocalValue();return Reflect.has(A,t)}keys(){let t=this.getLocalValue();return Reflect.ownKeys(t)}values(){let t=this.getLocalValue();return Reflect.ownKeys(t).map(A=>Reflect.get(t,A))}clear(){Pe(this.storageKey);}addValueChangeListener(t,A){let n=Math.random(),i=this.listenerData.get(t)||[];return i.push({id:n,key:t,callback:A}),this.listenerData.set(t,i),n}removeValueChangeListener(t){let A=false;for(const[n,i]of this.listenerData.entries()){for(let a=0;a<i.length;a++){const o=i[a];(typeof t=="string"&&o.key===t||typeof t=="number"&&o.id===t)&&(i.splice(a,1),a--,A=true);}this.listenerData.set(n,i);}return A}triggerValueChangeListener(t,A,n){if(!this.listenerData.has(t))return;let i=this.listenerData.get(t);for(let a=0;a<i.length;a++){const o=i[a];if(typeof o.callback=="function"){let l=this.get(t),s,d;typeof A<"u"&&arguments.length>=2?d=A:d=l,typeof n<"u"&&arguments.length>2?s=n:s=l,o.callback(t,d,s);}}}}const ne=new Ze(ke),ye={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new h.Dictionary),this.__contentConfig}},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){return [{id:"script-version",title:`版本：${pe?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(e,t,A){let n=pe?.script?.supportURL||pe?.script?.namespace;return typeof n=="string"&&h.isNotNull(n)&&window.open(n,"_blank"),false}}]}},Be={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{v.showPanel(ye.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){v.isTopWindow()&&Te.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let A=this.$data.menuOption.findIndex(n=>n.key===t.key);A!==-1&&(this.$data.menuOption[A]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},v={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new h.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new h.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new h.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new h.Dictionary),this.__onceExecData},get scriptName(){return ze},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ke,attributeKeyName:ge,attributeDefaultValueName:ve},init(){this.initContentDefaultValue(),Be.init();},isTopWindow(){return X.top===X.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;let i=n.attributes[Se];if(typeof i=="function"){let s=i();if(typeof s=="boolean"&&!s)return}let a=new Map,o=n.attributes[ge];if(o!=null){const s=n.attributes[ve];a.set(o,s);}let l=n.attributes[Ye];if(typeof l=="object"&&l&&Object.keys(l).forEach(s=>{a.set(s,l[s]);}),!a.size){u.warn(["请先配置键",n]);return}if(n.type==="switch"){let s=typeof n.disabled=="function"?n.disabled():n.disabled;typeof s=="boolean"&&s&&this.$data.contentConfigInitDisabledKeys.push(...a.keys());}for(const[s,d]of a.entries())this.setDefaultValue(s,d);},t=n=>{for(let i=0;i<n.length;i++){let a=n[i];e(a);let o=a.forms;o&&Array.isArray(o)&&t(o);}},A=[...ye.getAllContentConfig()];for(let n=0;n<A.length;n++){let i=A[n];if(!i.forms)continue;const a=i.forms;a&&Array.isArray(a)&&t(a);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&u.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){ne.set(e,t);},getValue(e,t){let A=ne.get(e);return A??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){ne.delete(e);},hasKey(e){return ne.has(e)},addValueChangeListener(e,t){return ne.addValueChangeListener(e,(n,i,a)=>{t(e,a,i);})},removeValueChangeListener(e){ne.removeValueChangeListener(e);},triggerMenuValueChange(e,t,A){ne.triggerValueChangeListener(e,A,t);},exec(e,t,A,n=true){const i=this;let a;typeof e=="string"||Array.isArray(e)?a=()=>e:a=e;let o=false,l=a(),s=[];Array.isArray(l)?(o=true,s=l):s.push(l);let d=s.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(d){u.warn(`${d} 键不存在`);return}let f=JSON.stringify(s);if(n&&this.$data.onceExecMenuData.has(f))return this.$data.onceExecMenuData.get(f);let p=[],m=[],y=(w,C)=>{let z=[];Array.isArray(C)||(C=[C]),C.forEach(N=>{if(N!=null&&N instanceof HTMLStyleElement){z.push(N);return}}),p=p.concat(z);},P=w=>this.getValue(w),b=()=>{for(let w=0;w<p.length;w++)p[w].remove(),p.splice(w,1),w--;},Q=()=>{let w=false;return typeof A=="function"?w=A(s):w=s.every(C=>P(C)),w},k=w=>{let C=Q(),z=[];if(C){let N=s.map(L=>this.getValue(L)),E=t({value:o?N:N[0],addStyleElement:(...L)=>y(true,...L)});Array.isArray(E)||(E=[E]),E.forEach(L=>{if(L!=null&&L instanceof HTMLStyleElement){z.push(L);return}});}b(),p=[...z];};n&&s.forEach(w=>{let C=this.addValueChangeListener(w,(z,N,E)=>{k();});m.push(C);}),k();let j={reload(){k();},clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),n&&i.$data.onceExecMenuData.delete(f);},clearStoreStyleElements:()=>b(),removeValueChangeListener:()=>{m.forEach(w=>{this.removeValueChangeListener(w);});}};return this.$data.onceExecMenuData.set(f,j),j},execMenu(e,t,A=false,n=false){return this.exec(e,i=>t(i),i=>i.every(o=>{let l=!!this.getValue(o);return v.$data.contentConfigInitDisabledKeys.includes(o)&&(l=false,u.warn(`.execMenu${n?"Once":""} ${o} 被禁用`)),A&&(l=!l),l}),n)},execMenuOnce(e,t,A=false,n=false){const i=this.execMenu(e,t,A,true);if(n&&i){const a=()=>{i.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,a);const o=i.clear;i.clear=()=>{o(),this.removeUrlChangeWithExecMenuOnceListener(e);};}return i},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),ne.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},triggerUrlChangeWithExecMenuOnceEvent(e){this.$data.urlChangeReloadMenuExecOnce.forEach((t,A)=>{t(e);});},showPanel(e,t=`${ze}-设置`,A=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let i=e.findIndex(o=>(typeof o.isBottom=="function"?o.isBottom():!!o.isBottom)&&o.id==="script-version")!==-1;!A&&!i&&e.push(...ye.getDefaultBottomContentConfig());let a=R.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(o,l)=>{o.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(o,l)=>{o(),this.$data.$panel=null;}},width:_.setting.width,height:_.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:a,content:e});},registerConfigSearch(e){const{$panel:t,content:A}=e;let n=async(f,p)=>{if(f==null)return;let m=await p(f);return m&&typeof m.isFind=="boolean"&&m.isFind?m.data:await n(m.data,p)},i=(f,p)=>{const m=new IntersectionObserver(y=>{y.forEach(P=>{P.isIntersecting&&(p?.(),m.disconnect());});},{root:null,threshold:1});m.observe(f),f.scrollIntoView({behavior:"smooth",block:"center"});},a=f=>{const p="pops-flashing";c.animationend(f,()=>{f.classList.remove(p);}),f.classList.add(p);},o=(f,p)=>{c.preventEvent(f);let m=R.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});m.$shadowRoot.querySelector(".search-wrapper");let y=m.$shadowRoot.querySelector(".search-config-text"),P=m.$shadowRoot.querySelector(".search-result-wrapper");y.focus();let b=()=>{c.empty(P);},Q=j=>{const w=h.queryProperty(j,z=>z?.next?{isFind:false,data:z.next}:{isFind:true,data:z});let C=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return c.on(C,"click",z=>{let E=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[j.index];if(!E){g.error(`左侧项下标${j.index}不存在`);return}E.scrollIntoView({behavior:"smooth",block:"center"}),E.click(),n(j.next,async L=>{if(L?.next){let I=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(O=>{const q=Reflect.get(O,"__formConfig__");return typeof q=="object"&&q!=null&&q.text===L.name}),2500);if(I)I.click();else return g.error("未找到对应的二级菜单"),{isFind:true,data:L};return {isFind:false,data:L.next}}else {let I=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(O=>Reflect.get(O,"__formConfig__")===L.matchedData?.formConfig),2500);if(I){i(I);let O=I.closest(".pops-panel-forms-fold[data-fold-enable]");O&&(O.querySelector(".pops-panel-forms-fold-container").click(),await h.sleep(500)),i(I,()=>{a(I);});}else g.error("未找到对应的菜单项");return {isFind:true,data:L}}});}),C},k=j=>{const w=new RegExp(j,"i"),C=[],z=(E,L)=>{for(let I=0;I<E.length;I++){const O=E[I];let q=O.forms;if(q&&Array.isArray(q)){const F=h.deepClone(L);if(O.type==="deepMenu"){const te=h.queryProperty(F,J=>J?.next?{isFind:false,data:J.next}:{isFind:true,data:J});te.next={name:O.text};}z(q,F);}else {let F=Reflect.get(O,"text"),te=Reflect.get(O,"description");const J=[F,te];let Y=J.findIndex(V=>{if(typeof V=="string")return V.match(w)});if(Y!==-1){const V=h.deepClone(L),Ae=h.queryProperty(V,re=>re?.next?{isFind:false,data:re.next}:{isFind:true,data:re});Ae.next={name:F,matchedData:{path:"",formConfig:O,matchedText:J[Y],description:te}};const he=[];h.queryProperty(V,re=>{const be=re?.name;return typeof be=="string"&&be.trim()!==""&&he.push(be),re?.next?{isFind:false,data:re.next}:{isFind:true,data:re}});const Ue=he.join(ie.escapeHtml(" - "));Ae.next.matchedData.path=Ue,C.push(V);}}}};for(let E=0;E<A.length;E++){const L=A[E];if(!L.forms||L.isBottom&&L.id==="script-version")continue;const I=L.forms;if(I&&Array.isArray(I)){let O=L.title;typeof O=="function"&&(O=O()),z(I,{index:E,name:O});}}let N=document.createDocumentFragment();for(const E of C){let L=Q(E);N.appendChild(L);}b(),P.append(N);};c.on(y,"input",h.debounce(j=>{c.preventEvent(j);let w=c.val(y).trim();if(w===""){b();return}k(w);},200));},l=null,s=false,d;c.on(t.$shadowRoot,"dblclick","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",o),c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(f,p)=>{clearTimeout(d),d=void 0,s&&l===p?(s=false,l=null,o(f)):(d=setTimeout(()=>{s=false;},200),s=true,l=p);},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`,lt="",B={isHome(){return window.location.pathname.split("/").length<=2&&window.location.search===""},isCode(){return !!window.location.pathname.split("/")?.includes("code")},isCodeStrict(){return !!window.location.pathname.match(/\/code(\/|)$/)},isVersion(){return !!window.location.pathname.match(/\/versions(\/|)$/)},isUsers(){return !!window.location.pathname.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!window.location.pathname.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!window.location.pathname.match(/\/conversations\/[\d]+/)},isScript(){return !!window.location.pathname.match(/\/scripts\/[\d+]/)},isScriptAdmin(){return !!window.location.pathname.endsWith("/admin")},isScriptList(){return !!window.location.pathname.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!window.location.pathname.match("/scripts/by-site")},isScriptsFeedback(){return this.isScript()&&window.location.pathname.match(/\/feedback(\/|)$/i)},isScriptLibraryList(){return !!window.location.pathname.match(/\/libraries(\/|)$/)},isScriptSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptList()&&e.has("q")},isScriptCodeSearch(){return !!window.location.pathname.match(/\/code-search(\/|)$/)},isScriptLibraryListSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptLibraryList()&&e.has("q")},isDiscuessions(){return !!window.location.pathname.match(/\/discussions(\/|)$/)},isImageSource(){return window.location.pathname.startsWith("/vite/assets")}},ct={init(){v.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),v.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),v.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),v.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let e=[];return e.push(M(et)),e.push(M(tt)),e.push(M(At)),e.push(M(rt)),e.push(M(nt)),e.push(M(`
			...
			`)),c.ready(()=>{let t=T('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(c.createElement("span",{textContent:"Markdown"}),t),K(".user-content ul li").forEach(i=>{let a=i.firstChild;a?.nodeName==="#text"&&(a.textContent?.startsWith("[x] ")?(a.textContent=a.textContent.replace("[x] ",""),c.prepend(i,`
				...
				section#script-info{
					margin-top: 10px;
				}`)),e},beautifyUploadImage(){u.info("美化上传图片");let e=[];return e.push(M(ot)),c.ready(()=>{function t(i){for(;i.nextElementSibling;)i.parentElement.removeChild(i.nextElementSibling);}let A=K('input[type="file"]');A.forEach(i=>{i.getAttribute("name")!=="code_upload"&&(i.hasAttribute("accept")&&i.getAttribute("accept").includes("javascript")||c.on(i,["propertychange","input"],function(a){t(a.target);let o=a.currentTarget.files;if(!o||o.length===0)return;u.info("选择的图片",o),o.length>5&&c.after(i,c.createElement("p",{textContent:r.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(o).forEach(s=>{(s.size>204800||!s.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(s);}),l.length!==0&&l.forEach(s=>{c.after(i,c.createElement("p",{textContent:r.t("❌ 图片：{{name}} 大小：{{size}}",{name:s.name,size:s.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(i=>{c.on(i,"paste",a=>{u.info("触发粘贴事件",a),setTimeout(()=>{c.trigger(A,"input");},100);});});}),e},beautifyTopNavigationBar(){u.info("美化顶部导航栏");let e=[];return e.push(M(at)),window.outerWidth>550&&(e.push(ie.addBlockCSS(".with-submenu")),c.ready(()=>{let A=T("#site-nav").querySelector("nav");K(".with-submenu nav li").forEach(n=>{A.appendChild(n);});})),e}},U={menu:Te,isLogin:false,initEnv(){let e=this.getUserLinkElement();this.isLogin=!!e;},getUserLinkElement(){return T("#nav-user-info span.user-profile-link a")},async updateScript(e){let t=function(A,n=1){return `
			...
			</div>`};if(h.isNull(e))g.error(r.t("未获取到【脚本列表】"));else {let A=g.loading(t(D.getScriptName(e[0])),{isHTML:true}),n=0,i=0;for(let a=0;a<e.length;a++){let o=e[a],l=D.getScriptId(o);u.success("更新："+o);let s=D.getScriptName(o);A.setHTML(t(s,a+1));let d=await G.getSourceCodeSyncFormDataInfo(l);if(d){const{formData:f,url:p}=d;await G.sourceCodeSync(l,f,p)?(g.success(r.t("源代码同步成功，3秒后更新下一个")),await h.sleep(3e3),n++):(g.error(r.t("源代码同步失败")),i++);}else g.error(r.t("源代码同步失败")),i++;}A.close(),n===0?g.error(r.t("全部更新失败")):g.success(r.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:n,failedNums:i,scriptUrlListLength:e.length}),{isHTML:true});}},handleLocalGotoCallBack(){if(v.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(v.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!B.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_scriptList",true),U.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];K("#user-script-list-section li a.script-link").forEach(t=>{e=e.concat(D.getAdminUrl(t.href));}),U.updateScript(e);}else if(v.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(v.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!B.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),U.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];K("#user-unlisted-script-list li a.script-link").forEach(t=>{e=e.concat(D.getAdminUrl(t.href));}),U.updateScript(e);}else if(v.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(v.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!B.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),U.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];K("#user-library-script-list li a.script-link").forEach(t=>{e=e.concat(D.getAdminUrl(t.href));}),U.updateScript(e);}}},dt={init(){v.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){c.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let e=v.getValue("user"),t=v.getValue("pwd"),A=v.getValue("secret");if(h.isNull(e)){g.error(r.t("请先在菜单中录入账号"));return}if(h.isNull(t)){g.error(r.t("请先在菜单中录入密码"));return}if(h.isNull(A)){g.error(r.t("请先在菜单中录入secret"));return}let n=T("meta[name='csrf-token']");if(!n){g.error(r.t("获取csrf-token失败"));return}let a=new Re__namespace.TOTP({secret:A}).generate(),o=g.loading(r.t("正在登录中...")),l=await H.post("/zh-CN/users/sign_in",{fetch:true,data:encodeURI(`authenticity_token=${n.getAttribute("content")}&user[email]=${e}&user[password]=${t}&user[remember_me]=1&user[otp_attempt]=${a}&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(o.destroy(),!l.status){u.error(l),g.error(r.t("登录失败，请求异常"));return}let s=l.data.responseText,d=c.toElement(s,true,true),f=d.querySelector(".width-constraint .alert");d.querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(g.success(r.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):f?(u.error(f),g.error(c.text(f))):(g.error(r.t("登录失败，可能是账号/密码错误，请在控制台查看原因"),{consoleLogContent:true}),u.error(l),u.error(`当前账号:${e}`),u.error(`当前密码:${t}`));});}},$={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){u.info("论坛-过滤"),M(`
        ...
        `);let e=new h.LockFunction(()=>{this.filter();},50);h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}}),e.run();},getElementList(){let e=[];return e=e.concat(Array.from(K(".discussion-list-container"))),e},filter(){const e=new Map;this.getElementList().forEach((t,A)=>{const n=this.parseDiscuessionListContainerInfo(t);if(!n)return;let i=this.getValue().split(`
`);if(e.has(n.snippet)&&v.getValue("greasyfork-discussions-filter-duplicate-comments")){let a=e.get(n.snippet).querySelector("a.discussion-title");a.setAttribute("data-repeat-tip-show","true");let o=0;a.hasAttribute("data-repeat-count")&&(o=parseInt(a.getAttribute("data-repeat-count"))),o++,a.setAttribute("data-repeat-count",o.toString()),a.setAttribute("data-repeat-tip-show",r.t("已过滤：{{oldCount}}",{oldCount:o})),u.success([`过滤重复内容：${n.snippet}`,n]),t.remove();return}e.set(n.snippet,t);for(let a=0;a<i.length;a++){let o=i[a],l=o.split("##"),s=l[0],d=l[1];if(s in n){let f=new RegExp(d,"ig");if(n[s]!=null&&String(n[s]).match(f)){u.info("触发论坛过滤规则",o,n),t.remove();return}}}});},parseDiscuessionListContainerInfo(e){let t=e.querySelector("a.discussion-title");if(!t)return;let A=t.href,n=A.match(/\/discussions(|\/greasyfork)\/([\d]+)/);if(!n)return;let i=n[n.length-1];const a=e.querySelector(".discussion-meta-item-script-name"),o=a?.querySelector("a"),l=e.querySelector("a.user-link"),s={scriptName:a.innerText,scriptUrl:o?.href,scriptId:D.getScriptId(o?.href),postUserName:l?.innerText,postUserHomeUrl:l?.href,postUserId:D.getUserId(l?.href),postTimeStamp:new Date(e.querySelector("relative-time").getAttribute("datetime")),snippetId:i,snippetUrl:A,snippet:e.querySelector("span.discussion-snippet")?.innerText||"",replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};let d=e.querySelector(".discussion-meta-item .discussion-meta-item");if(d){const f=d.querySelector("a.user-link");s.replyUserName=f.innerText,s.replyUserHomeUrl=f.href,s.replyUserId=D.getUserId(s.replyUserHomeUrl),s.replyTimeStamp=new Date(d.querySelector("relative-time").getAttribute("datetime"));}return s},setValue(e){v.setValue(this.key,e);},addValue(e,t){let A=this.getValue();if(A.trim()!==""&&(A+=`
`),h.isNull(e))return;e=e.toString().trim();let n=e+"##"+t;A+=n,this.setValue(A);},getValue(){return v.getValue(this.key,"")}},ut={init(){this.readBgColor(),c.ready(()=>{v.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();});let e=new h.LockFunction(()=>{v.execMenu("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();}),v.execMenu("discussions-addReportButton",()=>{this.addReportButton();});});h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),$.init();},readBgColor(){u.info("设置已读背景颜色");let e=v.getValue("discussions-readBgColor");return M(`
        .discussion-read{
            background: ${e} !important;
        }
        `)},addShortcutOperationButton(){u.info("添加【过滤】按钮"),$.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let A=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-filter-button">${r.t("过滤")}</button>
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-filter-button");A.appendChild(n),c.on(i,"click",a=>{c.preventEvent(a);const o=$.parseDiscuessionListContainerInfo(e);if(!o)return;let l="data-filter-key",s="data-filter-value",d=R.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:false},content:{text:`
								<button ${l}="scriptId" ${s}="^${o.scriptId}$">${r.t("脚本id：{{text}}",{text:o.scriptId})}</button>
								<button ${l}="scriptName" ${s}="^${h.toRegExpStr(o.scriptName)}$">${r.t("脚本名：{{text}}",{text:o.scriptName})}</button>
								<button ${l}="postUserId" ${s}="^${h.toRegExpStr(o.postUserId)}$">${r.t("发布的用户id：{{text}}",{text:o.postUserId})}</button>
						...
						`}),f=d.$shadowRoot.querySelector(".pops-alert-content");if(o.scriptId==null&&f.querySelector(`button[${l}="scriptId"]`)?.remove(),o.scriptName==null&&f.querySelector(`button[${l}="scriptName"]`)?.remove(),o.postUserId==null&&f.querySelector(`button[${l}="postUserId"]`)?.remove(),o.replyUserId!=null){let p=c.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:o.replyUserId})});p.setAttribute(l,"scriptAuthorId"),p.setAttribute(s,"^"+o.replyUserId+"$"),f.appendChild(p);}c.on(d.$shadowRoot,"click",`button[${l}]`,p=>{c.preventEvent(p);let m=p.target,y=m.getAttribute(l),P=m.getAttribute(s);$.addValue(y,P),d.close(),$.filter(),g.success(r.t("添加成功"));});});});},addReportButton(){u.info("添加【举报】按钮"),$.getElementList().forEach(e=>{if(e.querySelector(".discussion-report-button"))return;let A=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-report-button pops-button--danger">${r.t("举报")}</button>
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-report-button");A.appendChild(n),c.on(i,"click",a=>{c.preventEvent(a);const o=$.parseDiscuessionListContainerInfo(e);o&&R.alert({title:{text:r.t("举报"),position:"center",html:false},content:{text:`
						<div class="report-item">
							${r.t("举报讨论：")}
							<a href="${D.getReportUrl("discussion",o.snippetId)}" target="_blank">${o.snippet}</a>
						</div>
						${o.scriptId?`
							<div class="report-item">
							${r.t("举报脚本：")}
							<a href="${D.getReportUrl("script",o.scriptId)}" target="_blank">${o.scriptName}</a>
						</div>
						`:""}
						
						<div class="report-item">
							${r.t("举报用户：")}
							<a href="${D.getReportUrl("user",o.postUserId)}" target="_blank">${o.postUserName}</a>
						</div>
						${o.replyUserId&&o.replyUserId!=o.postUserId?`
								<div class="report-item">
									${r.t("举报用户：")}
									<a href="${D.getReportUrl("user",o.replyUserId)}" target="_blank">${o.replyUserName}</a>
								</div>
								`:""}
							...
							`});});});}},De={isCurrentLoginUserHome(){let e=le.getCurrentLoginUserId();return !!(e!=null&&B.isUsers()&&window.location.pathname.includes("/"+e))},monacoEditor(){return new Promise(e=>{const t="0.52.2",A="monaco-editor-ready";if(X.monaco){e(X.monaco);return}let n=g.loading(r.t("monaco-editor加载中...")),i=c.createElement("script",{type:"module",defer:true,innerHTML:`
				...
				`});c.append(document.head||document.documentElement,i),c.on(X,A,()=>{let a=X.monaco;u.success("网络加载monaco编辑器成功"),n.close(),e(a);},{once:true});})}},ft={init(){v.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();}),v.execMenuOnce("code-use-monaco-editor",()=>{this.coverEditorWithMonaco();});},repairCodeLineNumber(){u.info("修复代码的行号显示不够问题"),v.execMenuOnce("beautifyGreasyforkBeautify",()=>{M(`
				.code-container pre code .marker{
					padding-left: 6px;
				}	
				`);}),c.waitNode("#script-content div.code-container pre.prettyprint ol").then(e=>{e.childElementCount>=1e3&&(u.success(`当前代码行数${e.childElementCount}行，超过1000行，优化行号显示问题`),M(`
                    pre.prettyprint{
                        padding-left: 26px;
                    }
		...
		`),ie.addBlockCSS("#script-content .code-container > pre");let e=D.getScriptId(window.location.href);if(!e){g.error("未解析出当前脚本ID",{consoleLogContent:true});return}Promise.all([De.monacoEditor(),G.getScriptInfo(e)]).then(async([t,A])=>{let n=A?.code_url;if(!n){g.error("请求结果中未解析出脚本代码URL",{consoleLogContent:true});return}let i=new URLSearchParams(window.location.search);if(i.has("version")){let l=i.get("version");n=n.replace(new RegExp(`/${e}(/[\\d]+|)`),`/${e}/${l}`),u.info(`当前是历史代码页面，请求的脚本代码URL为${n}`);}let a=await H.get(n,{timeout:2e4});if(!a.status)return;let o=a.data.responseText;c.ready(async()=>{let l=await c.waitNode("#script-content .code-container > pre",1e4);if(!l)return;let s=c.createElement("div",{className:"monaco-editor"});c.after(l,s),t.editor.create(s,{value:o,minimap:{enabled:true},automaticLayout:true,codeLens:true,colorDecorators:true,contextmenu:true,readOnly:true,formatOnPaste:true,overviewRulerBorder:true,scrollBeyondLastLine:false,theme:"vs-dark",fontSize:window.innerWidth>600?14:12,wordWrap:"off",language:"javascript",folding:true,foldingStrategy:"indentation"});});});}},pt=`ul.history_versions,\r
...
`,gt={init(){v.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),v.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),v.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(M(pt)),e.push(ie.addBlockCSS(".version-number",".version-date",".version-changelog")),c.ready(function(){let t=T("ul.history_versions");if(!t){g.error(r.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(A=>{let n=A.querySelector(".version-number a").href,i=A.querySelector(".version-number a").innerText,a=A.querySelector(".version-date")?.getAttribute("datetime"),o=A.querySelector(".version-changelog")?.innerHTML||"",l=c.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),s=c.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),d=c.createElement("div",{className:"script-note-box-body",innerHTML:o});A.appendChild(l),A.appendChild(s),A.appendChild(d);});}),e},addExtraTagButton(){u.info("添加额外的标签按钮"),c.ready(()=>{K(".script-tag-version").forEach(e=>{let t=e.querySelector("a");if(!t)return;let A=new URL(t.href),n=A.pathname.match(/\/scripts\/([\d]+)/)?.[1],i=A.searchParams.get("version"),a=A.pathname.match(/\/scripts\/[\d]+-(.+)/)?.[1],o=D.getInstallUrl(n,i,a),l=D.getCodeUrl(n,i),s=c.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});c.after(e,s);});});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),De.monacoEditor().then(e=>{c.ready(()=>{K('#script-content form[action*="/diff"] input[type="submit"]').forEach(t=>{let A=c.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});c.after(t,A),c.on(A,"click",async n=>{c.preventEvent(n);let i=t.closest("form"),a=new FormData(i),o=a.get("v1"),l=a.get("v2");if(o===l){g.warning(r.t("版本号相同，不需要比较源码"));return}let s=g.loading(r.t("正在获取对比文本中...")),d=D.getScriptId(),f=await G.getScriptInfo(d);if(!f){s.close();return}let p=f.code_url,m=p.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${o}`),y=p.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${l}`),P="",b="";const[Q,k]=await Promise.all([H.get(m,{timeout:2e4}),H.get(y,{timeout:2e4})]);if(s.close(),!Q.status||!k.status)return;P=Q.data.responseText,b=k.data.responseText;let{recovery:j}=ie.lockScroll(),w=R.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
								<div class="monaco-editor-diff-container">
									<div class="monaco-editor-diff"></div>
								</div>
								`},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},btn:{ok:{enable:false},close:{callback(L,I){L.close(),j();}}},zIndex(){let L=h.getMaxZIndex(),I=R.config.InstanceUtils.getPopsMaxZIndex().zIndex;return h.getMaxValue(L,I)+100},useShadowRoot:false,width:"90vw",height:"90vh",drag:true,style:`
						...
						`});w.$shadowRoot.querySelector(".monaco-editor-diff-container");let C=w.$shadowRoot.querySelector(".monaco-editor-diff"),z=e.editor.createDiffEditor(C,{hideUnchangedRegions:{enabled:true},minimap:{enabled:true},automaticLayout:true,codeLens:true,colorDecorators:true,contextmenu:false,readOnly:true,formatOnPaste:true,overviewRulerBorder:true,scrollBeyondLastLine:false,theme:"vs-dark",fontSize:window.innerWidth>600?14:12,wordWrap:"off",language:"javascript"});const N=e.editor.createModel(b,"javascript"),E=e.editor.createModel(P,"javascript");z.setModel({original:N,modified:E});});});});});}};let me=[];const je=async function(e){if(u.info("当前脚本id："+e),!U.isLogin){u.error("请先登录账号"),g.error(r.t("请先登录账号"));return}let t=D.getUserId(U.getUserLinkElement().href);if(t==null){u.error("获取用户id失败"),g.error(r.t("获取用户id失败"));return}if(!me.length){let a=g.loading(r.t("获取收藏夹中..."));if(me=await G.getUserCollection(t)||[],a.close(),!me.length)return}let A="";const n=(a,o)=>{let l=false;o=o.toString().trim();for(const[s,d]of a.entries())if(s==="scripts-included[]"&&d.toString().trim()===o){l=true;break}return l};me.forEach(a=>{A+=`
		...
		`});c.on(i.$shadowRoot,"click",".collect-add-script-id",async function(a){let o=a.target.closest(".user-collect-item"),l=o.dataset.id;o.dataset.name;let s=g.loading(r.t("添加中..."));try{let d=await G.getUserCollectionInfo(t,l);if(!d)return;if(n(d,e)){g.warning(r.t("该脚本已经在该收藏集中"));return}let f=h.cloneFormData(d),p=h.cloneFormData(d);f.set("add-script",e.toString()),f.set("script-action","i"),p.append("scripts-included[]",e.toString()),p.set("save","1");let m=new URLSearchParams(f),y=new URLSearchParams(p),P=Array.from(m).map(([N,E])=>`${encodeURIComponent(N)}=${encodeURIComponent(E)}`).join("&"),b=Array.from(y).map(([N,E])=>`${encodeURIComponent(N)}=${encodeURIComponent(E)}`).join("&");u.info("添加的数据",P),u.info("保存的数据",b);let Q=await G.updateUserSetsInfo(t,l,P);if(!Q)return;let k=Q.querySelector(".change-script-set");if(!k){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let j=k.querySelector("section");if(!j){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}let w=j.querySelector(".alert");if(w){R.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:w.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:_.info.width,height:_.info.height});return}let C=new FormData(k);if(!n(C,e)){u.error("添加失败，提交的添加请求中不包含该脚本id"),g.error(r.t("添加失败，表单数据中不包含该脚本"));return}await G.updateUserSetsInfo(t,l,b),g.success(r.t("添加成功"));}catch(d){console.error(d);}finally{s.close();}}),c.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(a){let o=a.target.closest(".user-collect-item"),l=o.dataset.id;o.dataset.name;let s=g.loading(r.t("删除中..."));try{let d=await G.getUserCollectionInfo(t,l);if(!d)return;if(!n(d,e)){g.info(r.t("已删除：{{scriptId}}",{scriptId:e}));return}let f=h.cloneFormData(d,(C,z)=>C==="scripts-included[]"&&typeof z=="string"&&z.toString().trim()===e.toString().trim()),p=h.cloneFormData(f);f.set("remove-scripts-included[]",e.toString()),f.set("remove-selected-scripts","i"),f.delete("script-action"),p.set("save","1");let m=new URLSearchParams(f),y=new URLSearchParams(p),P=Array.from(m).map(([C,z])=>`${encodeURIComponent(C)}=${encodeURIComponent(z)}`).join("&"),b=Array.from(y).map(([C,z])=>`${encodeURIComponent(C)}=${encodeURIComponent(z)}`).join("&");u.info("删除的数据",P),u.info("保存的数据",b);let Q=await G.updateUserSetsInfo(t,l,P);if(!Q)return;let k=Q.querySelector(".change-script-set");if(!k){g.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let j=new FormData(k);if(n(j,e)){u.error("删除失败，提交的删除请求中包含该脚本id"),g.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await G.updateUserSetsInfo(t,l,b),g.success(r.t("删除成功"));}catch(d){console.error(d);}finally{s.close();}});},vt={init(){B.isCode()?ft.init():B.isVersion()&&gt.init(),B.isCodeStrict()&&(v.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),v.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),v.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),v.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),c.ready(()=>{v.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){u.info("添加收藏按钮"),c.waitNode("ul#script-links li.current span").then(()=>{let e=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
					</a>`});c.append(T("ul#script-links"),e),c.on(e,"click",()=>{let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){u.error(t,window.location.pathname),g.error(r.t("获取脚本id失败"));return}let A=t[t.length-1];je(A);});});},fullScreenOptimization(){u.info("F11全屏，F键代码全屏"),M(`
        ...
        `);let e=false;c.keydown(X,function(t){if(t.key.toLowerCase()==="f"){let A=T(".monaco-editor")||T("#script-content div.code-container code");t.altKey&&t.shiftKey?(u.info("宽屏"),c.preventEvent(t),A.classList.contains("code-wide-screen")?A.classList.remove("code-wide-screen"):A.classList.add("code-wide-screen")):!t.altKey&&!t.ctrlKey&&!t.shiftKey&&!t.metaKey&&(u.info("全屏"),c.preventEvent(t),e?(h.exitFullScreen(A),e=false):(h.enterFullScreen(A),e=true));}},{capture:true});},setFindCodeSearchBtn(){u.info("设置代码搜索按钮(对于库)"),c.waitNode("ul#script-links li.current span").then(()=>{let e=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("寻找引用")}</span>
					</a>`});c.append(T("ul#script-links"),e),c.on(e,"click",async function(){let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){u.error(t,window.location.pathname),g.error(r.t("获取脚本id失败"));return}let A=t[t.length-1];window.location.href=D.getCodeSearchUrl(`/scripts/${A}`);});});},async scriptHomepageAddedTodaySUpdate(){if(!T("#install-area"))return;u.info("脚本首页新增【今日检查】");let e=await G.getScriptStats(D.getScriptId());if(!e)return;u.info("统计信息",e);let t=e[h.formatTime(void 0,"yyyy-MM-dd")];if(!t){u.error("今日份的统计信息不存在");return}let A=t.update_checks;u.info("今日统计信息",t),c.after("dd.script-show-daily-installs",c.createElement("dt",{className:"script-show-daily-update_checks",innerHTML:`<span>${r.t("今日检查")}</span>`})),c.after("dt.script-show-daily-update_checks",c.createElement("dd",{className:"script-show-daily-update_checks",innerHTML:"<span>"+A+"</span>"}));},addCopyCodeButton(){u.info("添加复制代码按钮"),c.waitNode("div#script-content div.code-container").then(e=>{let t=c.createElement("button",{textContent:r.t("复制代码")},{style:"margin-bottom: 1em;"});c.on(t,"click",async function(){let A=g.loading(r.t("加载文件中...")),n=D.getScriptId(),i=await G.getScriptInfo(n);if(!i){A.close();return}let a=i.code_url;u.success("代码地址：",a);let o=await H.get(a);if(!o.status){A.close();return}A.close(),h.copy(o.data.responseText),g.success(r.t("复制成功"));}),c.before(e,t);});}},oe={key:"gf-shield-rule",init(){u.info("脚本过滤");let e=new h.LockFunction(()=>{this.filter();},50);c.ready(()=>{if(De.isCurrentLoginUserHome()){u.warn("当前在已登录的账户主页下，禁用脚本过滤");return}h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}}),e.run();});},getElementList(){return [...Array.from(K("ol.script-list li[data-script-name]"))]},filter(){this.getElementList().forEach(e=>{let t=le.parseScriptListInfo(e),A=this.getValue().split(`
`);for(let n=0;n<A.length;n++){let i=A[n],a=i.split("##"),o=a[0],l=a[1];if(o==="scriptRatingScore"){let s=parseFloat(l.slice(1));if(l.startsWith(">")){if(t.scriptRatingScore>s){u.info("触发脚本过滤规则",[i,t]),e.remove();break}}else if(l.startsWith("<")&&t.scriptRatingScore<s){u.info("触发脚本过滤规则",[i,t]),e.remove();break}}else if(o in t||o==="scriptDescription"){if(typeof l!="string")continue;let s=new RegExp(l,"ig");if(String(t[o]).match(s)){u.info("触发脚本过滤规则",i,t),e.remove();break}}}});},setValue(e){v.setValue(this.key,e);},addValue(e,t){let A=this.getValue();if(A.trim()!==""&&(A+=`
...
`,xe={getTampermonkey:()=>X.external?.Tampermonkey,getViolentmonkey:()=>X.external?.Violentmonkey,getScriptCat:()=>X.external?.Scriptcat,getScriptContainerStatus(){let e={Tampermonkey:false,Violentmonkey:false,ScriptCat:false};return X.external?.Tampermonkey&&(e.Tampermonkey=true),X.external?.Violentmonkey&&(e.Violentmonkey=true),X.external?.Scriptcat&&(e.ScriptCat=true),e},getRegisterScriptContainerNameList(){let t=this.getScriptContainerStatus(),A=[];return Object.keys(t).forEach(n=>{Reflect.get(t,n)&&A.push(n);}),A},getInstalledVersion(e,t){return new Promise((A,n)=>{const i=this.getTampermonkey();if(i){i.isInstalled(e,t,function(l){l.installed?A(l.version):A(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(A);return}const o=this.getScriptCat();if(o){o.isInstalled(e,t,function(l){l.installed?A(l.version):A(null);});return}n(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const A=e.split("."),n=t.split(".");for(let i=0;i<A.length;i++){const a=this.compareVersionPart(A[i],n[i]);if(a!==0)return a}return 0},compareVersionPart(e,t){const A=this.parseVersionPart(e),n=this.parseVersionPart(t);for(let i=0;i<A.length;i++){if(A[i].length>0&&n[i].length===0)return  -1;if(A[i].length===0&&n[i].length>0||A[i]>n[i])return 1;if(A[i]<n[i])return  -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,A){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,A)){case  -1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const A=e.getAttribute("data-script-name"),n=e.getAttribute("data-script-namespace"),i=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(A,n);return a==null?!1:(this.handleInstallResult(e,a,i),!0)}catch{if(t){await h.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return  false}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),A=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:A,url:location.href},location.origin);}},Ne={init(){v.execMenuOnce("gf-scripts-filter-enable",()=>{oe.init();}),v.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let e=[];e.push(M(ht));const t="lum-lightbox-loader",A=r.t("安装此脚本");return S.ready(()=>{let n=xe.getScriptContainerStatus(),i=Object.values(n).find(d=>d),a=xe.getRegisterScriptContainerNameList(),o=v.getValue("beautifyCenterContent-queryNameSpace");i?u.info("当前暴露的external信息："+a.map(d=>`【${d}】`).join("、")):u.error("脚本容器未暴露external信息",window.external);let l=new h.LockFunction(()=>{oe.getElementList().forEach(f=>{if(f.querySelector(".script-list-operation"))return;let p=le.parseScriptListInfo(f),m=f.querySelector(".inline-script-stats");if(!m)return;let y=p.codeUrl,P=S.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),b=S.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${p.scriptRatingScore}</span>`},{"data-position":"right"}),Q=f.querySelector("dd.script-list-ratings .good-rating-count"),k=f.querySelector("dd.script-list-ratings .ok-rating-count"),j=f.querySelector("dd.script-list-ratings .bad-rating-count");if(Q&&k&&j){let I=parseInt(Q.innerText),O=parseInt(k.innerText),q=parseInt(j.innerText),F=I+O+q;F>=10?I/F>=.6?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count"):F==0||I>O+q?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count");}let w=S.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),C=S.createElement("dd",{className:"script-list-version",innerHTML:`<span>${p.scriptVersion}</span>`},{"data-position":"right"}),z=S.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),N=S.createElement("dd",{className:"script-list-operation",innerHTML:`
						<a
							target="_blank"
							class="install-link"
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),E=N.querySelector(".script-collect-btn"),L=N.querySelector(".install-link");if(L["data-script-info"]=p,S.addClass(L,t),p.scriptType==="library"&&L.remove(),S.on(E,"click",I=>{S.preventEvent(I),je(p.scriptId);}),v.getValue("gf-scripts-filter-enable")){let I=S.createElement("button",{className:"script-filter-btn",innerHTML:r.t("过滤")}),O="data-filter-key",q="data-filter-value";S.on(I,"click",F=>{S.preventEvent(F);let te=R.alert({title:{text:r.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${O}="scriptId" ${q}="^${p.scriptId}$">${r.t("脚本id：{{text}}",{text:p.scriptId})}</button>
									<button ${O}="scriptName" ${q}="^${h.toRegExpStr(p.scriptName)}$">${r.t("脚本名：{{text}}",{text:p.scriptName})}</button>
								...
								`}),J=te.$shadowRoot.querySelector(".pops-alert-content");p.scriptAuthors.forEach(Y=>{let V=S.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:Y.authorId})});V.setAttribute(O,"scriptAuthorId"),V.setAttribute(q,"^"+Y.authorId+"$");let Ae=S.createElement("button",{innerHTML:r.t("作者名：{{text}}",{text:Y.authorName})});Ae.setAttribute(O,"scriptAuthorName"),Ae.setAttribute(q,"^"+h.toRegExpStr(Y.authorName)+"$"),J.appendChild(V),J.appendChild(Ae);}),S.on(te.$shadowRoot,"click",`button[${O}]`,Y=>{S.preventEvent(Y);let V=Y.target,Ae=V.getAttribute(O),he=V.getAttribute(q);oe.addValue(Ae,he),te.close(),oe.filter(),g.success(r.t("添加成功"));});}),N.appendChild(I);}m.appendChild(P),m.appendChild(b),m.appendChild(w),m.appendChild(C),m.appendChild(z),m.appendChild(N);});},100),s=new h.LockFunction(async()=>{let d=Array.from(K(".install-link[data-install-format=js]:not([gm-is-check-install-status])"));for(let f=0;f<d.length;f++){const p=d[f];p.setAttribute("gm-is-check-install-status","");let m=Reflect.get(p,"data-script-info");if(i){if(o){let y=await G.getScriptInfo(m.scriptId);y&&p.setAttribute("data-script-namespace",y.namespace);}xe.checkForUpdatesJS(p,true).then(y=>{S.removeClass(p,t),y||S.text(p,A);});}else S.removeClass(p,t),S.text(p,A);}});h.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{l.run(),s.run();}});}),e}},mt={init(){v.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),v.execMenuOnce("gf-scripts-filter-enable",()=>{oe.init();}),v.execMenuOnce("beautifyCenterContent",()=>Ne.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),ie.addBlockCSS("#about-user"),c.ready(()=>{let e=T("#about-user");if(!e){u.error("#about-user元素不存在");return}e=e.cloneNode(true),le.registerTopNavMenu({name:r.t("控制台"),className:"scripts-console",clickEvent(t){R.alert({title:{text:r.t("控制台"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:_.setting.width,height:_.setting.height,zIndex:h.getMaxZIndex(100),style:`
						#about-user{
							border: 0;
							box-shadow: none;
						}
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(e);}});});}};class yt{key="short-cut";$data;isWaitPress=false;currentWaitEnterPressInstanceHandler=null;constructor(t){typeof t=="string"&&(this.key=t),this.$data={otherShortCutOptions:[]};}initConfig(t,A){this.hasOption(t)||this.setOption(t,A);}getStorageKey(){return this.key}getLocalAllOptions(){return ee(this.key,[])}hasOption(t){return !!this.getLocalAllOptions().find(i=>i.key===t)}hasOptionValue(t){return this.hasOption(t)?this.getOption(t)?.value!=null:false}getOption(t,A){return this.getLocalAllOptions().find(a=>a.key===t)??A}setOption(t,A){let n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===t);i==-1?n.push({key:t,value:A}):Reflect.set(n[i],"value",A),W(this.key,n);}emptyOption(t){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===t);return i!==-1&&(n[i].value=null,A=true),W(this.key,n),A}deleteOption(t){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===t);return i!==-1&&(n.splice(i,1),A=true),W(this.key,n),A}translateKeyboardValueToButtonText(t){let A="";return t.ohterCodeList.forEach(n=>{A+=h.stringTitleToUpperCase(n,true)+" + ";}),A+=h.stringTitleToUpperCase(t.keyName),A}getShowText(t,A){if(this.hasOption(t)){let n=this.getOption(t);return n.value==null?A:this.translateKeyboardValueToButtonText(n.value)}else return A}async enterShortcutKeys(t){const A=this;return new Promise(n=>{this.isWaitPress=true;let i=c.listenKeyboard(window,"keyup",(a,o,l)=>{const s={keyName:a,keyValue:o,ohterCodeList:l};let d={};try{const f=JSON.stringify(s),p=this.getLocalAllOptions();Array.isArray(this.$data.otherShortCutOptions)&&p.push(...this.$data.otherShortCutOptions);for(let m=0;m<p.length;m++){let y=p[m];if(y.key===t)continue;const P=JSON.stringify(y.value);let b=!1;if(y.value!=null&&f===P&&(b=!0),b){d={status:!1,key:y.key,option:s};return}}this.setOption(t,s),d={status:!0,key:t,option:s};}catch(f){console.log(f),d={status:false,key:t,option:s};}finally{A.isWaitPress=false,i.removeListen(),A.currentWaitEnterPressInstanceHandler=null,n(d);}});A.currentWaitEnterPressInstanceHandler=null,A.currentWaitEnterPressInstanceHandler=()=>{A.isWaitPress=false,i.removeListen();};})}cancelEnterShortcutKeys(){typeof this.currentWaitEnterPressInstanceHandler=="function"&&this.currentWaitEnterPressInstanceHandler();}initGlobalKeyboardListener(t,A){let n=this.getLocalAllOptions();if(!n.length){u.warn("没有设置快捷键");return}const i=this;function a(s,d){c.listenKeyboard(s,"keydown",(f,p,m,y)=>{if(i.isWaitPress)return;A?.isPrevent&&c.preventEvent(y),n=i.getLocalAllOptions();let P=n.findIndex(b=>{let Q=b.value,k={keyName:f,keyValue:p,ohterCodeList:m};if(JSON.stringify(Q)===JSON.stringify(k))return b});if(P!=-1){let b=n[P];b.key in d&&(u.info(["调用快捷键",b]),d[b.key].callback());}},{capture:!!A?.capture});}let o={},l={};Object.keys(t).forEach(s=>{let d=t[s];(d.target==null||typeof d.target=="string"&&d.target==="")&&(d.target="window"),d.target==="window"?Reflect.set(o,s,d):Reflect.set(l,s,d);}),a(window,o),c.ready(()=>{Object.keys(l).forEach(async s=>{let d=l[s];if(typeof d.target=="string")c.waitNode(d.target,1e4).then(f=>{if(!f)return;let p={};Reflect.set(p,s,d),a(f,p);});else if(typeof d.target=="function"){let f=await d.target();if(f==null)return;let p={};Reflect.set(p,s,d),a(f,p);}else {let f={};Reflect.set(f,s,d),a(d.target,f);}});});}}const Qe={shortCut:new yt,shortOption:{"gf-quickReply":{target:()=>{let e=T("form textarea"),t=T('input[name="commit"][type="submit"]');if(e){if(!t){u.error("页面不存在【发表回复】按钮");return}}else {u.error("页面不存在输入框");return}return u.success("监听快捷键：gf-quickReply"),e},callback(){if(document.activeElement){let e=document.activeElement.closest("form");if(!e){u.error("当前activeElement不在表单内，无法触发快捷键");return}let t=e.querySelectorAll('input[name="commit"][type="submit"]');if(!t.length){u.error("表单内不存在【发表回复】按钮");return}t.length>1&&u.warn("表单内存在多个【发表回复】按钮，只触发第一个"),t[0].click();}else u.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},wt=`section.text-content {\r
...
`,bt={init(){v.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),c.ready(()=>{v.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return u.info("美化对话框"),M(wt)},beautifyPrivateMessageList(){u.info("美化私信列表"),M(`
		...
		`),K("section.text-content ul li").forEach(e=>{let t=e.querySelector('a[href*="conversations"]'),A=t.href,n=t.textContent?.split(" ")[1],i=e.querySelector("a.user-link"),a=null,o=null,l=null;if(i){a=i.textContent,o=i.href;let s=e.querySelector("relative-time");new Date(s.getAttribute("datetime")),l=s.shadowRoot.lastChild.textContent;}e.classList.add("user-conversations-item"),D.getUserId(),e.innerHTML=`
			...
			`;});}},Me={$key:{DB_KEY:"data"},$data:{db:null},init(){this.$data.db=this.getDB(),v.execMenuOnce("rememberReplyContent",()=>{this.rememberReplyContent();}),v.execMenu("gf-autoClearRememberReplayContent",e=>{this.autoClearRememberReplayContent(e.value);});},getDB(){const e="reply_record",t="textarea_text";return new h.indexedDB(e,t,2)},async rememberReplyContent(){const e="记住回复内容 -- ";let t=K("form");if(!t.length){u.warn(e+"不存在表单");return}try{await this.clearRelayHistoryRememberContentText();}catch(A){u.error(A);}t.forEach(async A=>{let n=A.querySelector("textarea"),i=A.querySelector('input[type="submit"]');n&&i&&(u.success("开始监听form --- 记住回复内容",A),this.$data.db.get(this.$key.DB_KEY).then(a=>{if(!a.data)return;let o=a.data.findIndex(s=>this.checkUrlIsSame(window.location.href,s.url));if(o==-1)return;let l=a.data[o].text;u.success("填入历史输入内容："+l),n.value=l;}),c.on(n,["propertychange","input"],h.debounce(a=>{let o={url:window.location.href,text:n.value,time:Date.now()};this.$data.db.get(this.$key.DB_KEY).then(l=>{if(!l.success&&l.event&&l.event.type!=="success"){u.warn(l);return}l.data==null&&(l.data=[]);let s=l.data.findIndex(d=>this.checkUrlIsSame(window.location.href,d.url));s!==-1?h.isNull(o.text)?l.data.splice(s,1):l.data[s]=h.assign(l.data[s],o):l.data=l.data.concat(o),this.$data.db.save(this.$key.DB_KEY,l.data).then(d=>{d.success||u.error("保存失败",d);});});},25)),c.on(A,"submit",a=>{u.info("表单提交，刷新页面后清理内容："+window.location.href),W("delyClear_rememberReplyContent_url",window.location.href);},{capture:true}));});},async clearRelayHistoryRememberContentText(){const e="delyClear_rememberReplyContent_url";let t=ee(e);if(t){let A=await this.$data.db.get(this.$key.DB_KEY);if(!A.data){u.info("表单记录：数据库是空的");return}let n=A.data.findIndex(a=>this.checkUrlIsSame(t,a.url));if(n==-1){u.info("表单记录：已不存在该数据"),Pe(e);return}A.data.splice(n,1),(await this.$data.db.save(this.$key.DB_KEY,A.data)).success?(u.success("表单记录：成功清除"),Pe(e)):u.error("表单记录：清除失败",A);}},checkUrlIsSame(e,t){let A=new URL(e),n=new URL(t);return A.origin===n.origin&&A.pathname===n.pathname},autoClearRememberReplayContent(e){const t="gf-last-time-autoClearRememberReplayContent";let A=ee(t),n=e*24*60*60*1e3;if(A)if(Date.now()-A>n)W(t,Date.now());else return;W(t,Date.now());},async getAllRememberReplyContent(){return (await this.$data.db.get(this.$key.DB_KEY)).data??[]},async clearAllRememberReplyContent(){return (await this.$data.db.delete(this.$key.DB_KEY)).success}},Ie={waitScritList(){return c.waitNode("#browse-script-list",1e4)},addFilterControls(e){function t(){let s=T("#gm-script-filter-controls");if(!s)return;let d=s?.shadowRoot;if(!d)return;let f=d.querySelector(".pops-filter-controls_inner"),p=d.querySelector(".pops-filter-search-container");if(f&&p)return {$filterControl:f,$search:p}}let A=t();if(A)return A;let n=c.createElement("div",{id:"gm-script-filter-controls"}),i=n.attachShadow({mode:"open"});i.appendChild(c.createElement("style",{innerHTML:`
			...
			`}),o=a.querySelector(".pops-filter-controls_inner"),l=a.querySelector(".pops-filter-search-container");return i.appendChild(a),c.before(e,n),{$filterControl:o,$search:l}}},xt={init(){c.ready(()=>{Ie.waitScritList().then(e=>{if(!e){u.error("未找到脚本列表节点，无法继续执行");return}v.onceExec("GreasyforkScriptsSearch",()=>{let{$filterControl:t,$search:A}=Ie.addFilterControls(e);this.addFilterControlsItem(A,t);});});});},addFilterControlsItem(e,t){let A=R.config.PanelHandlerComponents(),n=[{name:r.t("名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching-enable",callback:(o,l)=>{try{return !l.scriptName.match(new RegExp(o,"i"))}catch(s){return u.error(s),!l.scriptName.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("描述"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptDescWholeWordMatching-enable",callback:(o,l)=>{try{return !l.scriptDescription.match(new RegExp(o,"i"))}catch{return !l.scriptDescription.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("名称/描述"),desc:r.t("任一全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable",callback:(o,l)=>{let s=n.find(f=>f.ENABLE_KEY==="gf-script-search-filterScriptTitleWholeWordMatching").callback(o,l),d=n.find(f=>f.ENABLE_KEY==="gf-script-search-filterScriptDescWholeWordMatching").callback(o,l);return s&&d},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleWholeWordMatching-enable"]','.gm-script-control-item[data-storage-key="gf-script-search-filterScriptDescWholeWordMatching-enable"]']},{name:r.t("作者名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching-enable",callback:(o,l)=>{try{return !l.scriptAuthorName.match(new RegExp(o,"i"))}catch{return !l.scriptAuthorName.match(o)}}}],i=()=>{let o=e.querySelector("input");if(o)return o.value;let l=new URLSearchParams(window.location.search);return l.get("q")?.trim()||l.get("c")?.trim()||""},a=()=>{let o=i();oe.getElementList().forEach(s=>{let d=le.parseScriptListInfo(s),f=n.map(p=>{if(o=="")return  false;if(ee(p.STORAGE_KEY))return p.callback(o,d)}).filter(p=>typeof p=="boolean");if(f.length!==0){let p=false;f.forEach(m=>{p=p||m;}),p?c.hide(s,false):c.show(s,false);}else c.show(s,false);});};if(v.getValue("gf-script-search-addFilterSearchInput")){let o=A.createSectionContainerItem_input({type:"input",className:"gm-script-search-input",getValue(){let l=i();return v.getValue("gf-script-search-addFilterSearchInput-text")||l||""},description:r.t("自动执行过滤"),placeholder:r.t("过滤的关键词"),text:r.t("关键词"),callback:h.debounce((l,s)=>{v.setValue("gf-script-search-addFilterSearchInput-text",s.toString()),a();},500)});c.append(e,o);}n.forEach(o=>{if(!v.getValue(o.ENABLE_KEY))return;u.info(`添加按钮${o.name}`);let l=A.createSectionContainerItem_switch({type:"switch",className:"gm-script-control-item",text:o.name,description:o.desc,attributes:{"data-storage-key":o.STORAGE_KEY},getValue(){let s=ee(o.STORAGE_KEY,false);return s=!!s,a(),s},callback(s,d){if(W(o.STORAGE_KEY,d),a(),d&&Array.isArray(o.mutualExclusionSwitch)){let f=l.closest(".pops");o.mutualExclusionSwitch.forEach(p=>{let m=f.querySelector(p);m&&m.querySelector("input")?.checked&&m.querySelector(".pops-panel-switch__core")?.click();});}}});c.append(t,l);});}},ue={init(){if(B.isImageSource()){u.info("Router: 资源界面，不执行脚本功能");return}v.execMenu("checkPage",()=>{this.checkPage();}),ct.init(),Qe.init(),B.isScript()&&vt.init(),(B.isScriptList()||B.isScriptLibraryList()||B.isScriptCodeSearch()||B.isScriptsBySite())&&Ne.init(),B.isDiscuessions()?(u.info("Router: 讨论页面"),ut.init()):B.isUsers()?(u.info("Router: 用户页面"),mt.init(),B.isUsersConversations()&&(u.info("Router-next: 私聊用户页面"),bt.init())):(B.isScriptSearch()||B.isScriptsBySite()||B.isScriptCodeSearch()||B.isScriptLibraryListSearch())&&(u.info("Router: 脚本搜索页面"),xt.init()),v.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),c.ready(()=>{U.initEnv(),dt.init(),Me.init(),U.handleLocalGotoCallBack(),v.execMenuOnce("fixImageWidth",()=>{ue.fixImageWidth();}),ue.languageSelectorLocale(),v.execMenuOnce("optimizeImageBrowsing",()=>{ue.optimizeImageBrowsing();}),v.execMenuOnce("overlayBedImageClickEvent",()=>{ue.overlayBedImageClickEvent();}),B.isCodeStrict()||v.execMenuOnce("addMarkdownCopyButton",()=>{ue.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(u.info("修复图片显示问题"),M(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){u.info("优化图片浏览"),M(Ce("ViewerCSS")),M(`
        ...
        `);function e(A=[],n=0){let i="";A.forEach(l=>{i+=`<li><img data-src="${l}" loading="lazy"></li>`;});let a=c.createElement("ul",{innerHTML:i}),o=new Xe(a,{inline:false,url:"data-src",zIndex:h.getMaxZIndex()+100,hidden:()=>{o.destroy();}});n=n<0?0:n,o.view(n),o.zoomTo(1),o.show();}function t(A){return A.getAttribute("data-src")||A.getAttribute("src")||A.getAttribute("alt")}c.on(document,"click","img",function(A){let n=A.target;if(n.parentElement?.localName==="a"&&n.hasAttribute("data-screenshots")||n.closest(".viewer-container")||n.closest(".lum-lightbox-position-helper"))return;let i=n.closest(".user-content"),a=[],o=0,l=[],s=t(n);if(s){if(s.startsWith("https://img.shields.io"))return;if(s.startsWith("/vite/assets/"))return}i?(i.querySelectorAll("img").forEach(d=>{l.push(d);let f=t(d),p=d.parentElement;p?.localName==="a"&&(f=p.getAttribute("data-href")||p.href),a.push(f);}),o=l.indexOf(n),o===-1&&(o=0)):(a.push(s),o=0),u.success("点击浏览图片👉",a,o),e(a,o);}),K(".user-screenshots").forEach(A=>{let n=A.querySelector("a");if(!n)return;let i=n.getAttribute("data-href")||n.getAttribute("href"),a=A.querySelector("img");a&&(a.setAttribute("data-screenshots","true"),a.setAttribute("data-src",i),n.setAttribute("href","javascript:;"),c.after(n,a),n.remove());});},overlayBedImageClickEvent(){u.info("覆盖图床图片的parentElement的a标签"),K(".user-content a>img").forEach(e=>{let t=e.parentElement,A=t.getAttribute("href");if(t.setAttribute("data-href",A),t.removeAttribute("href"),A.startsWith("/rails/active_storage/blobs/redirect")){u.info("该图片是上传到Greasyfork的图片，拦截默认行为，不做提示");return}c.on(t,"click",()=>{g.warning(`<div style="overflow-wrap: anywhere;">${r.t("拦截跳转：")}<a href="${A}" target="_blank">${A}</a></div>`,{isHTML:true,zIndex:h.getMaxZIndex()+105});});});},addMarkdownCopyButton(){u.info("在Markdown右上角添加复制按钮"),M(`
        pre{
          position: relative;
        ...
        `);function e(){let t=c.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),A=t.querySelector(".js-clipboard-copy"),n=t.querySelector(".octicon-copy"),i=t.querySelector(".octicon-check-copy");return c.on(t,"click",()=>{let a=c.parent(t),o=a.querySelector("code");if(!o&&a.className.includes("prettyprinted")&&(o=t.parentElement),o||(o=a.querySelector("pre")),!o){g.error(r.t("未找到{{selector}}元素",{selector:"code"}));return}h.copy(c.text(o)),A.setAttribute("success","true"),n.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden");let l=R.tooltip({target:A,content:r.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:true});l.toolTip.onToolTipAnimationFinishEvent(),setTimeout(()=>{A.removeAttribute("success"),i.setAttribute("aria-hidden","true"),n.removeAttribute("aria-hidden"),l.toolTip.close();},2e3);}),t}K("pre").forEach(t=>{if(t.querySelector("div.zeroclipboard-container"))return;let n=e(),i=c.createElement("div",{className:"snippet-clipboard-content"});c.before(t,i),i.appendChild(t),i.appendChild(n);});},languageSelectorLocale(){let e=v.getValue("language-selector-locale"),t=window.location.pathname.split("/").filter(A=>!!A)[0];if(u.success("选择语言："+e),u.success("当前语言："+t),!h.isNull(e)&&e!==t){let A=null,n=D.getSwitchLanguageUrl(e);G.switchLanguage(n),u.success("新Url："+n),g.loading(r.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:t,localeLanguage:e}),{timeout:3e3,showClose:true,onClose(){clearTimeout(A);}}),g.info(r.t("导航至：")+n,{timeout:3e3}),A=setTimeout(()=>{window.location.href=n;},3e3);}},checkPage(){u.info("检测gf页面是否正确加载，有时候会出现"),c.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let e=parseInt(ee("greasyfork-check-page-time",0)),t=v.getValue("greasyfork-check-page-timeout",5),A=t*1e3;if(e&&Date.now()-e<A){g.warning(r.t("上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载",{time:h.formatTime(e,"yyyy-MM-dd HH:mm:ss"),timeout:t}));return}W("greasyfork-check-page-time",Date.now()),window.location.reload();}});},addOperationPanelBtnWithNavigator(){u.info("添加【操作面板】按钮"),ie.addBlockCSS(".sidebarred .sidebar",".sidebarred-main-content .open-sidebar"),M(`
		.sidebarred .sidebarred-main-content{
			max-width: 100%;
		}	
		`),c.ready(()=>{T("#site-nav nav"),T("#site-nav .with-submenu nav");let e=T("#script-list-option-groups")||T(".list-option-groups");if(!e){u.warn("不存在右侧面板元素#script-list-option-groups");return}e=e.cloneNode(true),e.classList.add("option-panel-groups"),le.registerTopNavMenu({name:r.t("操作面板"),className:"filter-scripts",clickEvent(t){R.alert({title:{text:r.t("操作面板"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:_.setting.width,height:_.setting.height,zIndex:h.getMaxZIndex(100),style:`
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(e);}});});}},Lt={init(){},showView(){let e=R.alert({title:{text:r.t("Url To WebhookUrl"),position:"center"},content:{text:`
            ...
            `}),t=e.$shadowRoot.querySelector("#github"),A=e.$shadowRoot.querySelector("#webhook");c.on(t,["input","propertychange"],n=>{let i=t.value.trim(),a=[];i.split(`
`).forEach(o=>{try{if(o=o.trim(),h.isNull(o))return;let s=new URL(o).pathname.split("/"),{1:d,2:f,3:p,4:m}=s,y="";if(s.length>=6&&p==="blob")y=s.slice(5,s.length).join("/");else if(s.length>=8&&p==="raw"&&m==="refs")m=s[6],y=s.slice(7,s.length).join("/");else return;if(y==="")return;a.push(`https://raw.githubusercontent.com/${d}/${f}/${m}/${y}`);}catch{}}),A.value=a.join(`
`);});}},fe=function(e,t,A,n,i,a,o,l,s,d){let f={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:i,buttonIconIsLoading:a,buttonType:o,buttonText:A,callback(p){typeof l=="function"&&l(p);},afterAddToUListCallBack:s};return Reflect.set(f.attributes,Se,()=>{f.disable=false;}),f},Ee={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new ae.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,A){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=A,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,se,t);}},Le=function(e,t,A,n,i,a="",o,l,s,d){let f={text:e,type:"input",isNumber:!!o,isPassword:!!l,attributes:{},props:{},description:n,afterAddToUListCallBack:s,getValue(){return this.props[se].get(t,A)},callback(p,m,y){this.props[se].set(t,m);},placeholder:a};return Reflect.set(f.attributes,ge,t),Reflect.set(f.attributes,ve,A),Ee.initComponentsStorageApi("input",f,{get(p,m){return v.getValue(p,m)},set(p,m){v.setValue(p,m);}}),f},x=function(e,t,A,n,i,a,o,l){let s={text:e,type:"switch",description:i,disabled:o,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f){let p=!!f;u.success(`${p?"开启":"关闭"} ${e}`),this.props[se].set(t,p);},afterAddToUListCallBack:a};return Reflect.set(s.attributes,ge,t),Reflect.set(s.attributes,ve,A),Ee.initComponentsStorageApi("switch",s,{get(d,f){return v.getValue(d,f)},set(d,f){v.setValue(d,f);}}),s},de=function(e,t,A,n,i,a,o){let l=[];typeof n=="function"?l=n():l=n;let s={text:e,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f,p){let m=f;if(u.info(`选择：${p}`),typeof i=="function"&&i(d,m,p))return;this.props[se].set(t,m);},data:l};return Reflect.set(s.attributes,ge,t),Reflect.set(s.attributes,ve,A),Ee.initComponentsStorageApi("select",s,{get(d,f){return v.getValue(d,f)},set(d,f){v.setValue(d,f);}}),s},Pt=function(e,t,A,n,i,a="default",o){let l=typeof i=="function"?i():i;typeof n=="object"&&o.initConfig(A,n);let s=()=>o.getShowText(A,l),d=fe(e,t,s,"keyboard",false,false,a,async f=>{let m=f.target.closest(".pops-panel-button")?.querySelector("span");if(o.isWaitPress){g.warning("请先执行当前的录入操作");return}if(o.hasOptionValue(A))o.emptyOption(A),g.success("清空快捷键");else {let y=g.loading("请按下快捷键...",{showClose:true,onClose(){o.cancelEnterShortcutKeys();}}),{status:P,option:b,key:Q}=await o.enterShortcutKeys(A);y.close(),P?(u.success(["成功录入快捷键",b]),g.success("成功录入")):g.error(`快捷键 ${o.translateKeyboardValueToButtonText(b)} 已被 ${Q} 占用`);}m.innerHTML=s();});return d.attributes={},Reflect.set(d.attributes,Se,()=>false),d},Oe={async UIScriptList(e,t){if(!U.isLogin){g.error(r.t("请先登录账号！"));return}let i=U.getUserLinkElement().href?.split("/")?.pop()?.match(/([0-9]+)/)?.[0],a=R.loading({mask:{enable:true},parent:t,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:false}),o=await G.getUserInfo(i);if(a.close(),!o)return;u.info(o);let l=e==="script-list"?o.scriptList:o.scriptLibraryList;g.success(r.t("获取成功，共 {{count}} 个",{count:l.length}));for(const s of l){let d=c.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),f=d.querySelector(".w-script-info"),p=c.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});s.deleted&&(d.classList.add("w-script-deleted"),p.querySelector("button").setAttribute("disabled","true")),c.on(p,"click",async function(){u.success("同步",s);let m=p.querySelector("button"),y=p.querySelector("button span"),P=c.createElement("i",{className:"pops-bottom-icon",innerHTML:R.config.iconSVG.loading},{"is-loading":true});m.setAttribute("disabled","true"),m.setAttribute("data-icon","true"),y.innerText=r.t("同步中..."),c.before(y,P);let b=s?.id,Q=await G.getSourceCodeSyncFormDataInfo(b.toString());if(Q){const{formData:k,url:j}=Q,w="script[script_sync_type_id]",C="script[sync_type]";if(k.has(w)||k.has(C)){let z="";if(k.has(w)){let L=k.get(w);L.toString()==="1"?z=r.t("手动"):L.toString()==="2"?z=r.t("自动"):L.toString()==="3"&&(z="webhook");}else k.has(C)&&(z=k.get(C));let N=d.querySelector(".w-script-sync-type");N?N.querySelector("p").innerText=r.t("同步方式：{{syncMode}}",{syncMode:z}):c.append(f,`
								...
								</div>`),await G.sourceCodeSync(s.id.toString(),k,j)?g.success(r.t("同步成功")):g.error(r.t("同步失败"));}else g.error(r.t("该脚本未设置同步信息"));}m.removeAttribute("disabled"),m.removeAttribute("data-icon"),y.innerText=r.t("同步代码"),P.remove();}),d.appendChild(p),t.appendChild(d);}}},Ct={id:"greasy-fork-panel-config-account",title:r.t("通用"),forms:[{text:"",type:"forms",forms:[{text:r.t("Toast配置"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[de(r.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:r.t("左上角")},{value:"top",text:r.t("顶部")},{value:"topright",text:r.t("右上角")},{value:"left",text:r.t("左边")},{value:"center",text:r.t("中间")},{value:"right",text:r.t("右边")},{value:"bottomleft",text:r.t("左下角")},{value:"bottom",text:r.t("底部")},{value:"bottomright",text:r.t("右下角")}],(e,t,A)=>{u.info("设置当前Qmsg弹出位置"+A);},r.t("Toast显示在页面九宫格的位置")),de(r.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,r.t("限制Toast显示的数量")),x(r.t("逆序弹出"),"qmsg-config-showreverse",false,void 0,r.t("修改Toast弹出的顺序"))]}]},de(r.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(e,t,A)=>{u.info("改变语言："+A),r.changeLanguage(t);})]},{text:"",type:"forms",forms:[{text:r.t("账号/密码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[Le(r.t("账号"),"user","",void 0,void 0,r.t("请输入账号")),Le(r.t("密码"),"pwd","",void 0,void 0,r.t("请输入密码"),false,true),Le(r.t("secret"),"secret","","两步验证（2FA）",void 0,r.t("请输入secret"),false,true)]},{text:"",type:"forms",forms:[x(r.t("自动登录"),"autoLogin",true,void 0,r.t("自动登录当前保存的账号")),fe(r.t("清空账号/密码"),void 0,r.t("点击清空"),void 0,void 0,false,"default",e=>{if(confirm(r.t("确定清空账号和密码？"))){v.deleteValue("user"),v.deleteValue("pwd"),g.success(r.t("已清空账号/密码"));let t=e.target.getRootNode();t.querySelector('li[data-key="user"] .pops-panel-input input').value="",t.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}})]}]},{text:r.t("功能"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[de(r.t("固定当前语言"),"language-selector-locale","",(function(){let e=[{value:"",text:r.t("无")}];return c.ready(()=>{K("select.language-selector-locale option").forEach(t=>{let A=t.getAttribute("value");if(A==="help")return;let n=c.text(t).trim();e.push({value:A,text:n});});}),e})()),x(r.t("修复图片宽度显示问题"),"fixImageWidth",true,void 0,r.t("修复图片在移动端宽度超出浏览器宽度问题")),x(r.t("优化图片浏览"),"optimizeImageBrowsing",true,void 0,r.t("使用Viewer浏览图片")),x(r.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",true,void 0,r.t("配合上面的【优化图片浏览】更优雅浏览图片")),x(r.t("添加【操作面板】按钮"),"scripts-addOperationPanelBtnWithNavigator",true,void 0,r.t("在脚本列表页面时为顶部导航栏添加【操作面板】按钮")),x(r.t("给Markdown添加【复制】按钮"),"addMarkdownCopyButton",true,void 0,r.t("在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容"))]},{text:r.t("检测页面加载"),type:"forms",forms:[x(r.t("启用"),"checkPage",true,void 0,r.t("检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面")),de(r.t("检测间隔"),"greasyfork-check-page-timeout",5,(()=>{let e=[];for(let t=0;t<5;t++)e.push({value:t+1,text:t+1+"s"});return e})(),void 0,r.t("设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面"))]}]},{type:"deepMenu",text:r.t("表单"),forms:[{type:"forms",text:"",forms:[x(r.t("记住回复内容"),"rememberReplyContent",true,void 0,r.t("监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复")),de(r.t("自动清理空间"),"gf-autoClearRememberReplayContent",7,[{text:r.t("不清理"),value:-1},{text:r.t("{{value}} 天",{value:1}),value:1},{text:r.t("{{value}} 周",{value:1}),value:7},{text:r.t("{{value}} 个月",{value:1}),value:30},{text:r.t("{{value}} 个月",{value:2}),value:60},{text:r.t("{{value}} 个月",{value:3}),value:90},{text:r.t("半年"),value:180}],void 0,r.t("根据设置的间隔时间自动清理保存的回复内容")),fe(r.t("数据占用空间：{{size}}",{size:r.t("计算中")}),r.t("当前存储的数据所占用的空间大小"),r.t("清空"),void 0,void 0,void 0,"default",async()=>{await Me.clearAllRememberReplyContent()?g.success(r.t("清理成功")):g.error(r.t("清理失败"));},async(e,t)=>{let A=t.ulElement.querySelector('li[data-key="gf-autoClearRememberReplayContent"]+li .pops-panel-item-left-main-text'),n=await Me.getAllRememberReplyContent(),i="";n.length?i=h.getTextStorageSize(JSON.stringify(n)):i=h.getTextStorageSize(""),A.innerText=r.t("数据占用空间：{{size}}",{size:i});})]}]},{text:r.t("美化"),type:"deepMenu",forms:[{text:r.t("全局"),type:"forms",forms:[x(r.t("美化页面元素"),"beautifyPage",true,void 0,r.t("如button、input、textarea")),x(r.t("美化上传图片按钮"),"beautifyUploadImage",true,void 0,r.t("放大上传区域")),x(r.t("美化顶部导航栏"),"beautifyTopNavigationBar",true,void 0,r.t("可能会跟Greasyfork Beautify脚本有冲突")),x(r.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",false,void 0,r.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]},{type:"forms",text:r.t("脚本列表"),forms:[x(r.t("美化脚本列表"),"beautifyCenterContent",true,void 0,r.t("双列显示且添加脚本卡片操作项（安装、收藏）")),x("↑"+r.t("使用namespace查询脚本信息"),"beautifyCenterContent-queryNameSpace",true,void 0,r.t("开启后检测已安装的脚本信息更准确，但是速度会更慢"))]}]},{type:"deepMenu",text:r.t("自定义快捷键"),forms:[{type:"forms",text:"",forms:[Pt(r.t("快捷键发表回复"),r.t("在输入框内按下快捷发表回复，例如：{{key}}",{key:"Ctrl + Enter"}),"gf-quickReply",{keyName:"Enter",keyValue:"13",ohterCodeList:["ctrl"]},r.t("点击录入快捷键"),void 0,Qe.shortCut)]}]},{text:r.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${r.t("帮助文档")}</a>`,type:"forms",forms:[x(r.t("启用"),"gf-scripts-filter-enable",true,void 0,r.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(e){let t=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${r.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),A=t.querySelector("textarea");return A.value=oe.getValue(),c.on(A,["input","propertychange"],void 0,h.debounce(function(n){oe.setValue(A.value);},200)),e.appendChild(t),e}}]}]}]},{type:"forms",text:r.t("脚本管理"),forms:[{type:"deepMenu",text:r.t("代码同步"),forms:[{text:r.t("代码同步"),type:"forms",forms:[fe(r.t("源代码同步【脚本列表】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",e=>{if(!B.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_scriptList",true),U.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];K("#user-script-list-section li a.script-link").forEach(A=>{t=t.concat(D.getAdminUrl(A.href));}),U.updateScript(t);}),fe(r.t("源代码同步【未上架的脚本】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",e=>{if(!B.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),U.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];K("#user-unlisted-script-list li a.script-link").forEach(A=>{t=t.concat(D.getAdminUrl(A.href));}),U.updateScript(t);}),fe(r.t("源代码同步【库】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",e=>{if(!B.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),U.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];K("#user-library-script-list li a.script-link").forEach(A=>{t=t.concat(D.getAdminUrl(A.href));}),U.updateScript(t);})]}]},{type:"deepMenu",text:r.t("脚本列表"),forms:[],afterEnterDeepMenuCallBack(e,t){Oe.UIScriptList("script-list",t.sectionBodyContainer);}},{type:"deepMenu",text:r.t("库"),forms:[],afterEnterDeepMenuCallBack(e,t){Oe.UIScriptList("script-library",t.sectionBodyContainer);}}]}]},zt={id:"greasy-fork-panel-config-scripts",title:r.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:r.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("添加复制代码按钮"),"addCopyCodeButton",true,void 0,r.t("更优雅的复制")),x(r.t("快捷键"),"fullScreenOptimization",true,void 0,r.t("【F】键全屏、【Alt+Shift+F】键宽屏")),x(r.t("修复代码行号显示"),"code-repairCodeLineNumber",false,void 0,r.t("修复代码行数超过1k行号显示不全问题")),x("monacoEditor","code-use-monaco-editor",true,void 0,r.t("使用Monaco编辑器"))]}]},{text:r.t("历史版本"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[x(r.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",true,void 0,r.t("在版本下面添加【安装】、【查看代码】按钮")),x(r.t("添加代码对比按钮"),"scripts-versions-addCompareCodeButton",true,void 0,r.t("monacoEditor"))]},{text:r.t("美化"),type:"forms",forms:[x(r.t("美化历史版本页面"),"beautifyHistoryVersionPage",true,void 0,r.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("添加【寻找引用】按钮"),"addFindReferenceButton",true,void 0,r.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),x(r.t("添加【收藏】按钮"),"addCollectionButton",true,void 0,r.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),x(r.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",true,void 0,r.t("在脚本信息栏添加【今日检查】信息块"))]}]}]}]},Mt={id:"greasy-fork-panel-config-script-search",title:r.t("搜索"),forms:[{type:"forms",text:"搜素结果过滤",forms:[x(r.t("新增【关键词】搜索框"),"gf-script-search-addFilterSearchInput",true,void 0,r.t("输入自定义关键词后自动执行过滤")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("名称")}),"gf-script-search-filterScriptTitleWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("描述")}),"gf-script-search-filterScriptDescWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("名称/描述")}),"gf-script-search-filterScriptTitleOrDescWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("作者名称")}),"gf-script-search-filterScriptAuthorNameWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本"))]}]},kt={id:"greasy-fork-panel-config-discussions",title:r.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",A=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
...
`;Be.addMenuOption({key:"githubUrl2webhookUrl",text:"⚙ "+r.t("Url To WebhookUrl"),autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{Lt.showView();}});v.$data.panelConfig={style:Dt};ye.addContentConfig([Ct,zt,Mt,kt,St]);v.init();ue.init();

...
`)}{display: none !important;}`)},setGMResourceCSS(e){{let t=typeof pe=="function"?pe(e.keyName):"";typeof t=="string"&&t?ie(t):oe.loadStyleLink(e.url);}},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,p.ready(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(r=>{t.onload=()=>{r(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;let t=new URL(e);return t.protocol="https:",t.toString()}};Pe();V(F,{});const Ge=n.t("GreasyFork优化"),m=ue.noConflict(),p=M.noConflict(),_=ke,u=new m.Log(se,U.console||qe.console);var Se;const ye=((Se=se==null?void 0:se.script)==null?void 0:Se.name)||Ge,Ee=!1;u.config({debug:Ee,logMaxCount:1e3,autoClearConsole:!0,tag:!0});g.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return h.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return h.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return h.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let e=ue.getMaxZIndex(),t=ke.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ue.getMaxValue(e,t)+100}}}));const Te=new m.GM_Menu({GM_getValue:V,GM_setValue:O,GM_registerMenuCommand:Re,GM_unregisterMenuCommand:Be}),R=new m.Httpx(Ve);R.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning(n.t("请求取消")):e.type==="onerror"?g.error(n.t("请求异常")):e.type==="ontimeout"?g.error(n.t("请求超时")):g.error(n.t("其它错误")),e));R.config({logDetails:Ee});U.Object.defineProperty,U.Function.prototype.apply,U.Function.prototype.call,U.Element.prototype.appendChild,U.setTimeout;const ie=m.addStyle.bind(m);document.querySelector.bind(document);document.querySelectorAll.bind(document);const Q=function(e,t,r,i,o,a,s,l,c){return {text:e,type:"button",description:t,buttonIcon:i,buttonIsRightIcon:o,buttonIconIsLoading:a,buttonType:s,buttonText:r,callback(f){typeof l=="function"&&l(f);},afterAddToUListCallBack:c}},be=function(e,t,r,i,o,a="",s,l){let c={text:e,type:"input",isNumber:!!s,isPassword:!!l,props:{},attributes:{},description:i,getValue(){return this.props[H].get(t,r)},callback(d,f){this.props[H].set(t,f);},placeholder:a};return Reflect.set(c.attributes,re,t),Reflect.set(c.attributes,ne,r),Reflect.set(c.props,H,{get(d,f){return h.getValue(d,f)},set(d,f){h.setValue(d,f);}}),c},w=function(e,t,r,i,o,a){let s={text:e,type:"switch",description:o,attributes:{},props:{},getValue(){return !!this.props[H].get(t,r)},callback(l,c){let d=!!c;u.success(`${d?"开启":"关闭"} ${e}`),this.props[H].set(t,d);},afterAddToUListCallBack:a};return Reflect.set(s.attributes,re,t),Reflect.set(s.attributes,ne,r),Reflect.set(s.props,H,{get(l,c){return h.getValue(l,c)},set(l,c){h.setValue(l,c);}}),s},A={getSwitchLanguageUrl(e="zh-CN"){let t=window.location.origin,r=window.location.pathname.split("/");return r[1]=e,t=t+r.join("/"),t+=window.location.search,window.location.search===""?t+="?locale_override=1":window.location.search.includes("locale_override=1")||(t+="&locale_override=1"),t},async getScriptStats(e){return new Promise(async t=>{let r=await R.get({url:`https://greasyfork.org/scripts/${e}/stats.json`,fetch:!0,onerror(){},ontimeout(){}});if(!r.status){t(null);return}let i=r.data;t(i);})},async getSourceCodeSyncFormData(e){let t=await R.get(`https://greasyfork.org/zh-CN/scripts/${e}/admin`,{fetch:!0});if(u.success(t),!t.status){g.error(n.t("请求admin内容失败"));return}let r=t.data.responseText,o=p.parseHTML(r,!1,!0).querySelector("form.edit_script");if(!o){g.error(n.t("解析admin的源代码同步表单失败"));return}return new FormData(o)},async sourceCodeSync(e,t){let r=await R.post(`https://greasyfork.org/zh-CN/scripts/${e}/sync_update`,{fetch:!0,data:t});if(u.success(r),!r.status){g.error(n.t("源代码同步失败"));return}return r},async getUserInfo(e){let t=await R.get(`https://greasyfork.org/zh-CN/users/${e}.json`,{fetch:!0});if(u.success(t),!t.status){g.error(n.t("获取用户信息失败"));return}let r=m.toJSON(t.data.responseText);return r.scriptList=[],r.scriptLibraryList=[],r.scripts.forEach(i=>{i.code_url.endsWith(".user.js")?r.scriptList.push(i):r.scriptLibraryList.push(i);}),r},async getUserCollection(e){let t=await R.get(`https://greasyfork.org/zh-CN/users/${e}`,{fetch:!0});if(u.info(["获取用户的收藏集",t]),!t.status){g.error(n.t("获取用户的收藏集失败"));return}let r=t.data.responseText,o=p.parseHTML(r,!0,!0).querySelector("#user-script-sets");if(!o){u.error("解析Script Sets失败");return}let a=[];return o.querySelectorAll("li").forEach(s=>{var y;let l=s.querySelector("a:last-child");if(!l)return;let c=l.href;if(c.includes("?fav=1"))return;let d=s.querySelector("a").innerText,f=(y=c.match(/\/sets\/([\d]+)\//))==null?void 0:y[1];a.push({id:f,name:d});}),a},async getUserCollectionInfo(e,t){let r=await R.get(`https://greasyfork.org/zh-CN/users/${e}/sets/${t}/edit`,{fetch:!0});if(!r.status){g.error(n.t("获取收藏集{{setsId}}失败",{setsId:t}));return}let i=r.data.responseText,o=p.parseHTML(i,!0,!0),a=o.querySelector('form[id^="edit_script_set"]');if(!a){g.error(n.t("获取表单元素#edit_script_set失败"));return}let s=new FormData(a),l=o.querySelector('meta[name="csrf-token"]');if(!l){g.error(n.t("获取表单csrfToken失败"));return}if(l.hasAttribute("content")){let c=l.getAttribute("content");c&&s.set("authenticity_token",c);}return s},async updateUserSetsInfo(e,t,r){let i=await R.post(`https://greasyfork.org/zh-CN/users/${e}/sets/${t}`,{fetch:!0,headers:{accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","cache-control":"no-cache","content-type":"application/x-www-form-urlencoded",pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:r});if(!i.status){g.error(n.t("更新收藏集表单请求失败"));return}let o=i.data.responseText;return p.parseHTML(o,!0,!0)},async switchLanguage(e){let t=await R.get(e,{fetch:!0,headers:{"Upgrade-Insecure-Requests":"1"}});t.status&&u.info(t);}},Fe=globalThis.location.href,Le=new URL(Fe),q=Le.pathname,He=Le.searchParams,T={isCode(){var e;return !!((e=q.split("/"))!=null&&e.includes("code"))},isCodeStrict(){return !!q.match(/\/code(\/|)$/)},isVersion(){return !!q.match(/\/versions(\/|)$/)},isUsers(){return !!q.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!q.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!q.match(/\/conversations\/[\d]+/)},isScript(){return !!q.match(/\/scripts\/[\d+]/)},isScriptList(){return !!q.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!q.match("/scripts/by-site")},isScriptLibraryList(){return !!q.match(/\/libraries(\/|)$/)},isScriptSearch(){return this.isScriptList()&&He.has("q")},isScriptCodeSearch(){return !!q.match(/\/code-search(\/|)$/)},isDiscuessions(){return !!q.match(/\/discussions(\/|)$/)}},C={getInstallUrl(e,t,r){return m.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${e}/${t}${r}.user.js`},getCodeUrl(e,t){return m.isNull(t)&&(t=""),`https://greasyfork.org/scripts/${e}/code?version=${t}`},getCodeSearchUrl(e){return "https://greasyfork.org/zh-CN/scripts/code-search?c="+e},getScriptInfoUrl(e){return `https://greasyfork.org/scripts/${e}.json`},getAdminUrl(e){return e+"/admin"},getScriptId(e){var t,r;return (r=(t=e||window.location.pathname)==null?void 0:t.match(/\/scripts\/([\d]+)/i))==null?void 0:r[1]},getUserId(e){var t;return (t=(e||window.location.pathname).match(/\/users\/([\d]+)/i))==null?void 0:t[1]},getScriptName(e){let t=window.location.pathname;e!=null&&(t=new URL(e).pathname),t=decodeURIComponent(t);let r=t.split("/");for(const i of r){let o=i.match(/[\d]+/);if(o&&o.length)return o[1]}},getSwitchLanguageUrl(e="zh-CN"){let t=window.location.origin,r=window.location.pathname.split("/");return r[1]=e,t=t+r.join("/"),t+=window.location.search,window.location.search===""?t+="?locale_override=1":window.location.search.includes("locale_override=1")||(t+="&locale_override=1"),t}},k={menu:Te,isLogin:!1,initEnv(){let e=this.getUserLinkElement();this.isLogin=!!e;},getUserLinkElement(){return document.querySelector("#nav-user-info span.user-profile-link a")},async updateScript(e){let t=function(r,i=1){return `
            ...
            `}),x=b.querySelector(".w-script-info"),v=p.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});y.deleted&&(b.classList.add("w-script-deleted"),v.querySelector("button").setAttribute("disabled","true")),p.on(v,"click",void 0,async function(){u.success(["同步",y]);let E=v.querySelector("button"),$=v.querySelector("button span"),L=p.createElement("i",{className:"pops-bottom-icon",innerHTML:_.config.iconSVG.loading},{"is-loading":!0});E.setAttribute("disabled","true"),E.setAttribute("data-icon","true"),$.innerText=n.t("同步中..."),p.before($,L);let N=y==null?void 0:y.id,P=await A.getSourceCodeSyncFormData(N.toString());if(P){const I="script[script_sync_type_id]";if(P.has(I)){let B=P.get(I),G="";B.toString()==="1"?G=n.t("手动"):B.toString()==="2"?G=n.t("自动"):B.toString()==="3"&&(G="webhook");let z=b.querySelector(".w-script-sync-type");z?z.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:G}):p.append(x,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:G})}
									</p>
								</div>`),await A.sourceCodeSync(y.id.toString(),P)?g.success(n.t("同步成功")):g.error(n.t("同步失败"));}else g.error(n.t("该脚本未设置同步信息"));}E.removeAttribute("disabled"),E.removeAttribute("data-icon"),$.innerText=n.t("同步代码"),L.remove();}),b.appendChild(v),t.appendChild(b);}}},Ke={init(){h.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();});},repairCodeLineNumber(){u.info("修复代码的行号显示不够问题"),h.execMenuOnce("beautifyGreasyforkBeautify",()=>{S(`
...
`,Je={init(){h.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),h.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(S(Ye)),e.push(oe.addBlockCSS(".version-number",".version-date",".version-changelog")),p.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){g.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var f,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(f=r.querySelector(".version-date"))==null?void 0:f.getAttribute("datetime"),s=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=p.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),c=p.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),d=p.createElement("div",{className:"script-note-box-body",innerHTML:s});r.appendChild(l),r.appendChild(c),r.appendChild(d);});}),e},addExtraTagButton(){u.info("添加额外的标签按钮"),p.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(e=>{var d,f;let t=e.querySelector("a");if(!t)return;let r=new URL(t.href),i=(d=r.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:d[1],o=r.searchParams.get("version"),a=(f=r.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:f[1],s=C.getInstallUrl(i,o,a),l=C.getCodeUrl(i,o),c=p.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});p.after(e,c);});});}},le={setting:{width:window.innerWidth<550?"88vw":"550px",height:window.innerHeight<450?"70vh":"450px"},settingBig:{width:window.innerWidth<800?"92vw":"800px",height:window.innerHeight<600?"80vh":"600px"},info:{width:("350px"),height:("250px")}};let ae=[];const _e=async function(e){if(u.info("当前脚本id："+e),!k.isLogin){u.error("请先登录账号"),g.error(n.t("请先登录账号"));return}let t=C.getUserId(k.getUserLinkElement().href);if(t==null){u.error("获取用户id失败"),g.error(n.t("获取用户id失败"));return}if(!ae.length){let o=g.loading(n.t("获取收藏夹中..."));if(ae=await A.getUserCollection(t)||[],o.close(),!ae.length)return}let r="";ae.forEach(o=>{r+=`
...
`,we={getTampermonkey:()=>{var e;return (e=U.external)==null?void 0:e.Tampermonkey},getViolentmonkey:()=>{var e;return (e=U.external)==null?void 0:e.Violentmonkey},getScriptCat:()=>{var e;return (e=U.external)==null?void 0:e.Scriptcat},getScriptContainerStatus(){var t,r,i;let e={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (t=U.external)!=null&&t.Tampermonkey&&(e.Tampermonkey=!0),(r=U.external)!=null&&r.Violentmonkey&&(e.Violentmonkey=!0),(i=U.external)!=null&&i.Scriptcat&&(e.ScriptCat=!0),e},getInstalledVersion(e,t){return new Promise((r,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(r);return}const s=this.getScriptCat();if(s){s.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const r=e.split("."),i=t.split(".");for(let o=0;o<r.length;o++){const a=this.compareVersionPart(r[o],i[o]);if(a!==0)return a}return 0},compareVersionPart(e,t){const r=this.parseVersionPart(e),i=this.parseVersionPart(t);for(let o=0;o<r.length;o++){if(r[o].length>0&&i[o].length===0)return -1;if(r[o].length===0&&i[o].length>0||r[o]>i[o])return 1;if(r[o]<i[o])return -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,r){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,r)){case-1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const r=e.getAttribute("data-script-name"),i=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(r,i);return a==null?!1:(this.handleInstallResult(e,a,o),!0)}catch{if(t){await m.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return !1}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),r=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:r,url:location.href},location.origin);}},he=e=>{let t=e.dataset;const r={scriptId:parseInt(t.scriptId),scriptName:t.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(t.scriptDailyInstalls),scriptTotalInstalls:parseInt(t.scriptTotalInstalls),scriptRatingScore:parseFloat(t.scriptRatingScore),scriptCreatedDate:new Date(t.scriptCreatedDate),scriptUpdatedDate:new Date(t.scriptUpdatedDate),scriptType:t.scriptType,scriptVersion:t.scriptVersion,sensitive:t.sensitive==="true",scriptLanguage:t.scriptLanguage,cssAvailableAsJs:t.cssAvailableAsJs==="true",codeUrl:t.codeUrl,scriptDescription:t.scriptDescription,scriptAuthorId:parseInt(t.scriptAuthorId),scriptAuthorName:t.scriptAuthorName};let i=m.toJSON(t.scriptAuthors);if(Object.keys(i).forEach(o=>{let a=i[o];r.scriptAuthors.push({authorId:parseInt(o),authorName:a});}),(r.scriptAuthorName==null||isNaN(r.scriptAuthorId))&&r.scriptAuthors.length&&(r.scriptAuthorName=r.scriptAuthors[0].authorName,r.scriptAuthorId=r.scriptAuthors[0].authorId),r.scriptDescription==null){let o=e.querySelector(".script-description")||e.querySelector(".description");o&&(r.scriptDescription=o.innerText||o.textContent);}return r},$e={init(){h.execMenuOnce("gf-scripts-filter-enable",()=>{W.init();}),h.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let e=[];e.push(ie(Qe));const t="lum-lightbox-loader",r=n.t("安装此脚本");return M.ready(async()=>{W.getElementList().forEach(c=>{if(c.querySelector(".script-list-operation"))return;let d=he(c),f=c.querySelector(".inline-script-stats");if(!f){u.error("美化脚本列表失败，未获取到.inline-script-stats");return}let y=d.codeUrl,b=M.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${n.t("评分")}</span>`}),x=M.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${d.scriptRatingScore}</span>`},{"data-position":"right"}),v=c.querySelector("dd.script-list-ratings .good-rating-count"),E=c.querySelector("dd.script-list-ratings .ok-rating-count"),$=c.querySelector("dd.script-list-ratings .bad-rating-count");if(v&&E&&$){let z=parseInt(v.innerText),D=parseInt(E.innerText),j=parseInt($.innerText),ee=z+D+j;ee>=10?z/ee>=.6?x.classList.add("good-rating-count"):x.classList.add("bad-rating-count"):ee==0||z>D+j?x.classList.add("good-rating-count"):x.classList.add("bad-rating-count");}let L=M.createElement("dt",{className:"script-list-version",innerHTML:`<span>${n.t("版本")}</span>`}),N=M.createElement("dd",{className:"script-list-version",innerHTML:`<span>${d.scriptVersion}</span>`},{"data-position":"right"}),P=M.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${n.t("操作")}</span>`}),I=M.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),B=I.querySelector(".script-collect-btn"),G=I.querySelector(".install-link");if(G["data-script-info"]=d,M.addClass(G,t),d.scriptType==="library"&&G.remove(),M.on(B,"click",z=>{m.preventEvent(z),_e(d.scriptId);}),h.getValue("gf-scripts-filter-enable")){let z=M.createElement("button",{className:"script-filter-btn",innerHTML:n.t("过滤")}),D="data-filter-key",j="data-filter-value";M.on(z,"click",ee=>{m.preventEvent(ee);let ce=_.alert({title:{text:n.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${D}="scriptId" ${j}="^${d.scriptId}$">${n.t("脚本id：{{text}}",{text:d.scriptId})}</button>
									<button ${D}="scriptName" ${j}="^${m.parseStringToRegExpString(d.scriptName)}$">${n.t("脚本名：{{text}}",{text:d.scriptName})}</button>
...
`),m.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return h.getValue(this.key,"")}},nt={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=p.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											`}),o=i.querySelector(".pops-color-choose");o.value=h.getValue(t);let a=p.createElement("style");return p.append(document.head,a),p.on(o,["input","propertychange"],s=>{u.info("选择颜色："+o.value),a.innerHTML=`
												.discussion-read{
										...
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=Y.getValue(),p.on(r,["input","propertychange"],void 0,m.debounce(function(i){Y.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},it=`.w-script-list-item {\r
	padding: 10px;\r
...
`,gt={init(){h.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),h.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),h.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),h.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let e=[];return e.push(S(lt)),e.push(S(ct)),e.push(S(dt)),e.push(S(ut)),e.push(S(pt)),e.push(S(`
			...
			`)),p.ready(function(){let t=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(p.createElement("span",{textContent:"Markdown"}),t),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&e.push(S(`
					...
					`));}),e},beautifyGreasyforkBeautify(){u.info("美化 Greasyfork Beautify脚本");let e=[];return e.push(S(ht)),m.isPhone()?e.push(S(`
				section#script-info,
				...
				section#script-info{
					margin-top: 10px;
				}`)),e},beautifyUploadImage(){u.info("美化上传图片");let e=[];return e.push(S(ft)),p.ready(()=>{function t(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let r=document.querySelectorAll('input[type="file"]');r.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||p.on(o,["propertychange","input"],function(a){t(a.target);let s=a.currentTarget.files;if(!s||s.length===0)return;u.info(["选择的图片",s]),s.length>5&&p.after(o,p.createElement("p",{textContent:n.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(s).forEach(c=>{(c.size>204800||!c.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(c);}),l.length!==0&&l.forEach(c=>{p.after(o,p.createElement("p",{textContent:n.t("❌ 图片：{{name}} 大小：{{size}}",{name:c.name,size:c.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{p.on(o,"paste",a=>{u.info(["触发粘贴事件",a]),setTimeout(()=>{p.trigger(r,"input");},100);});});}),e},beautifyTopNavigationBar(){u.info("美化顶部导航栏");let e=[];return e.push(S(mt)),window.outerWidth>550&&(e.push(oe.addBlockCSS(".with-submenu")),p.ready(()=>{let r=document.querySelector("#site-nav").querySelector("nav");document.querySelectorAll(".with-submenu nav li").forEach(i=>{r.appendChild(i);});})),e}},yt={init(){h.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){m.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let e=h.getValue("user"),t=h.getValue("pwd");if(m.isNull(e)){g.error(n.t("请先在菜单中录入账号"));return}if(m.isNull(t)){g.error(n.t("请先在菜单中录入密码"));return}let r=document.querySelector("meta[name='csrf-token']");if(!r){g.error(n.t("获取csrf-token失败"));return}let i=g.loading(n.t("正在登录中...")),o=await R.post("https://greasyfork.org/zh-CN/users/sign_in",{fetch:!0,data:encodeURI(`authenticity_token=${r.getAttribute("content")}&user[email]=${e}&user[password]=${t}&user[remember_me]=1&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(i.destroy(),!o.status){u.error(o),g.error(n.t("登录失败，请在控制台查看原因"));return}let a=o.data.responseText;p.parseHTML(a,!0,!0).querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(g.success(n.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):(u.error(o),u.error(`当前账号:${e}`),u.error(`当前密码:${t}`),g.error(n.t("登录失败，可能是账号/密码错误，请在控制台查看原因")));});}},bt={init(){this.readBgColor(),p.ready(()=>{h.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),h.execMenuOnce("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),Y.init();},readBgColor(){u.info("设置已读背景颜色");let e=h.getValue("discussions-readBgColor");S(`
        .discussion-read{
            background: ${e} !important;
        }
        `);},addShortcutOperationButton(){u.info("添加快捷操作按钮"),Y.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=p.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-filter-button">${n.t("过滤")}</button>
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),p.on(o,"click",a=>{var y,b,x;m.preventEvent(a);const s=Y.parseDiscuessionListContainerInfo(e);let l="data-filter-key",c="data-filter-value",d=_.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
						...
						`}),f=d.$shadowRoot.querySelector(".pops-alert-content");if(s.scriptId==null&&((y=f.querySelector(`button[${l}="scriptId"]`))==null||y.remove()),s.scriptName==null&&((b=f.querySelector(`button[${l}="scriptName"]`))==null||b.remove()),s.postUserId==null&&((x=f.querySelector(`button[${l}="postUserId"]`))==null||x.remove()),s.replyUserId!=null){let v=p.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:s.replyUserId})});v.setAttribute(l,"scriptAuthorId"),v.setAttribute(c,"^"+s.replyUserId+"$"),f.appendChild(v);}p.on(d.$shadowRoot,"click",`button[${l}]`,v=>{m.preventEvent(v);let E=v.target,$=E.getAttribute(l),L=E.getAttribute(c);Y.addValue($,L),d.close(),Y.filter(),g.success(n.t("添加成功"));});});});}},xt={init(){h.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),h.execMenuOnce("gf-scripts-filter-enable",()=>{W.init();}),h.execMenuOnce("beautifyCenterContent",()=>$e.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),oe.addBlockCSS("#about-user"),p.ready(()=>{let e=document.querySelector("#about-user"),t=document.querySelector("#site-nav nav");if(!e){u.error("#about-user元素不存在");return}if(!t){u.error("#site-nav nav元素不存在");return}e=e.cloneNode(!0);let r=p.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});p.on(r,"click",i=>{m.preventEvent(i),_.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:m.getMaxZIndex(100),style:`
                    .text-content{
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,vt={init(){h.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),p.ready(()=>{h.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){u.info("美化对话框"),[].push(ie(wt));},beautifyPrivateMessageList(){u.info("美化私信列表"),ie(`
		...
		`),document.querySelectorAll("section.text-content ul li").forEach(e=>{var c;let t=e.querySelector('a[href*="conversations"]'),r=t.href,i=(c=t.textContent)==null?void 0:c.split(" ")[1],o=e.querySelector("a.user-link"),a=null,s=null,l=null;if(o){a=o.textContent,s=o.href;let d=e.querySelector("relative-time");new Date(d.getAttribute("datetime")),l=d.shadowRoot.lastChild.textContent;}e.classList.add("user-conversations-item"),C.getUserId(),e.innerHTML=`
			...
			`;});}},ve={waitScritList(){return m.waitNode("#browse-script-list",1e4)},addFilterControls(e){function t(){var l;let s=document.querySelector("#gm-script-filter-controls");return (l=s==null?void 0:s.shadowRoot)==null?void 0:l.querySelector(".pops")}let r=t();if(r)return r;let i=p.createElement("div",{id:"gm-script-filter-controls"}),o=i.attachShadow({mode:"open"});o.appendChild(p.createElement("style",{innerHTML:`
        ...
        `);function e(){let t=p.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),r=t.querySelector(".js-clipboard-copy"),i=t.querySelector(".octicon-copy"),o=t.querySelector(".octicon-check-copy");return p.on(t,"click",function(){let a=t.parentElement.querySelector("code");if(!a&&t.parentElement.className.includes("prettyprinted")&&(a=t.parentElement),!a){g.error(n.t("未找到{{selector}}元素",{selector:"code"}));return}m.setClip(a.innerText||a.textContent),r.setAttribute("success","true"),i.setAttribute("aria-hidden","true"),o.removeAttribute("aria-hidden");let s=_.tooltip({target:r,content:n.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:!0});s.toolTip.onToolTipAnimationFinishEvent(),setTimeout(()=>{r.removeAttribute("success"),o.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden"),s.toolTip.close();},2e3);}),t}document.querySelectorAll("pre").forEach(t=>{if(t.querySelector("div.zeroclipboard-container"))return;let i=e(),o=p.createElement("div",{className:"snippet-clipboard-content"});p.before(t,o),o.appendChild(t),o.appendChild(i);});},languageSelectorLocale(){let e=h.getValue("language-selector-locale"),t=window.location.pathname.split("/").filter(r=>!!r)[0];if(u.success("选择语言："+e),u.success("当前语言："+t),!m.isNull(e)&&e!==t){let r=null,i=A.getSwitchLanguageUrl(e);A.switchLanguage(i),u.success("新Url："+i),g.loading(n.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:t,localeLanguage:e}),{timeout:3e3,showClose:!0,onClose(){clearTimeout(r);}}),g.info(n.t("导航至：")+i,{timeout:3e3}),r=setTimeout(()=>{window.location.href=i;},3e3);}},checkPage(){u.info("检测gf页面是否正确加载，有时候会出现"),p.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let e=parseInt(V("greasyfork-check-page-time",0)),t=h.getValue("greasyfork-check-page-timeout",5),r=t*1e3;if(e&&Date.now()-e<r){g.warning(n.t("上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载",{time:m.formatTime(e,"yyyy-MM-dd HH:mm:ss"),timeout:t}));return}O("greasyfork-check-page-time",Date.now()),window.location.reload();}});},addOperationPanelBtnWithNavigator(){u.info("添加【操作面板】按钮"),oe.addBlockCSS(".sidebarred .sidebar",".sidebarred-main-content .open-sidebar"),S(`

...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Se=="function"?Se(e.keyName):null;return typeof t=="string"&&t?I(t):_.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(A=>{B.ready(()=>{document.head.appendChild(t),A(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(A=>{t.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let A=[document.documentElement,document.body].concat(...e||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(o=>{n(o);}).catch(o=>{u.error("读取剪贴板内容失败👉",o),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(o=>{e(n);}).catch(o=>{u.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),e(n);});}function A(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!A()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,A=5e3){let n,o=A-t,a=t,i=async s=>{let l=await e(s);if(typeof l=="boolean"&&!l||s){h.workerClearTimeout(n);return}if(a+=t,a>o){i(true);return}n=h.workerSetTimeout(()=>{i(false);},t);};i(false);},findParentNode(e,t,A){if(A){let n=B.closest(e,A);if(n)return n.querySelector(t)}else return B.matches(e,t)?e:B.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(n,o)=>o===void 0?t:o,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},ce={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},h=ae.noConflict(),c=B.noConflict(),Q=Ce,u=new h.Log(fe,H.console||$e.console),xe=fe?.script?.name||void 0,_e=Ce.config.Utils.AnyTouch(),et=false;u.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});g.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const A=e.setting.content;return t==="warning"?u.warn(A):t==="error"?u.error(A):u.info(A),true},get position(){return m.getValue(ce.qmsg_config_position.key,ce.qmsg_config_position.defaultValue)},get maxNums(){return m.getValue(ce.qmsg_config_maxnums.key,ce.qmsg_config_maxnums.defaultValue)},get showReverse(){return m.getValue(ce.qmsg_config_showreverse.key,ce.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=ae.getMaxZIndex(),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100}});Q.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=ae.getMaxZIndex(void 0,void 0,A=>{if(A?.classList?.contains("qmsg-shadow-container")||A?.closest("qmsg")&&A.getRootNode()instanceof ShadowRoot)return  false}),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Qe=new h.GM_Menu({GM_getValue:ee,GM_setValue:$,GM_registerMenuCommand:Ze,GM_unregisterMenuCommand:We}),q=new h.Httpx({xmlHttpRequest:Je,logDetails:et});q.interceptors.request.use(e=>e);q.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?g.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?g.error("请求超时",{consoleLogContent:true}):g.error("其它错误",{consoleLogContent:true}),e));H.Object.defineProperty,H.Function.prototype.apply,H.Function.prototype.call,H.Element.prototype.appendChild,H.setTimeout;const I=c.addStyle.bind(c),N=B.selector.bind(B),X=B.selectorAll.bind(B);new h.GM_Cookie;const ve="GM_Panel",Pe="data-init",he="data-key",me="data-default-value",Ue="data-init-more-value",Ke="data-plugin-search-config",se="data-storage-api",J={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},W={setting:{get width(){return J.width<550?"88vw":J.width<700?"550px":"700px"},get height(){return J.height<450?"70vh":J.height<550?"450px":"550px"}},settingMiddle:{get width(){return J.width<350?"88vw":"350px"},get height(){return J.height<450?"88vh":"450px"}},settingBig:{get width(){return J.width<800?"92vw":"800px"},get height(){return J.height<600?"80vh":"600px"}},info:{get width(){return J.width<350?"88vw":"350px"},get height(){return J.height<250?"88vh":"250px"}}};class tt{storageKey;listenerData;constructor(t){if(typeof t=="string"){const A=t.trim();if(A=="")throw new Error("key参数不能为空字符串");this.storageKey=A;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new ae.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let t=ee(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){$(this.storageKey,t);}set(t,A){const n=this.get(t),o=this.getLocalValue();Reflect.set(o,t,A),this.setLocalValue(o),this.triggerValueChangeListener(t,n,A);}get(t,A){const n=this.getLocalValue();return Reflect.get(n,t)??A}getAll(){return this.getLocalValue()}delete(t){const A=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,A,void 0);}has(t){const A=this.getLocalValue();return Reflect.has(A,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(A=>Reflect.get(t,A))}clear(){ge(this.storageKey);}addValueChangeListener(t,A){const n=Math.random(),o=this.listenerData.get(t)||[];return o.push({id:n,key:t,callback:A}),this.listenerData.set(t,o),n}removeValueChangeListener(t){let A=false;for(const[n,o]of this.listenerData.entries()){for(let a=0;a<o.length;a++){const i=o[a];(typeof t=="string"&&i.key===t||typeof t=="number"&&i.id===t)&&(o.splice(a,1),a--,A=true);}this.listenerData.set(n,o);}return A}async triggerValueChangeListener(...t){const[A,n,o]=t;if(!this.listenerData.has(A))return;let a=this.listenerData.get(A);for(let i=0;i<a.length;i++){const s=a[i];if(typeof s.callback=="function"){let l=this.get(A),d,p;typeof n<"u"&&t.length>=2?p=n:p=l,typeof o<"u"&&t.length>2?d=o:d=l,await s.callback(A,p,d);}}}}const oe=new tt(ve),Le={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new h.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const A=(a,i)=>{typeof i!="string"&&(i=_.toStr(i));const s=new Blob([i]),l=globalThis.URL.createObjectURL(s);c.createElement("a",{href:l,download:a}).click(),h.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const a=f=>{const v=Q.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),y=v.$shadowRoot.querySelector(".btn-control[data-mode='local']"),x=v.$shadowRoot.querySelector(".btn-control[data-mode='network']"),L=v.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),E=async O=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof we=="function"?typeof ge=="function"?(we().forEach(w=>{ge(w);}),g.success("已清空脚本存储的配置")):g.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):g.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Be=="function"?Be(O):Object.keys(O).forEach(w=>{const b=O[w];$(w,b);}),g.success("配置导入完毕");},z=O=>new Promise(async P=>{const M=h.toJSON(O);Object.keys(M).length===0?g.warning("解析为空配置，不导入"):await E(M),P(true);});c.on(y,"click",O=>{c.preventEvent(O),v.close();const P=c.createElement("input",{type:"file",accept:".json"});c.on(P,["propertychange","input"],M=>{if(!P.files?.length)return;const w=P.files[0],b=new FileReader;b.onload=()=>{z(b.result);},b.readAsText(w,"UTF-8");}),P.click();}),c.on(x,"click",O=>{c.preventEvent(O),v.close();const P=Q.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(b,U){b.close();}},ok:{text:"导入",callback:async(b,U)=>{const T=b.text;if(h.isNull(T)){g.error("请填入完整的url");return}const C=g.loading("正在获取配置..."),k=await q.get(T,{allowInterceptConfig:false});if(C.close(),!k.status){u.error(k),g.error("获取配置失败",{consoleLogContent:true});return}await z(k.data.responseText)&&b.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:W.info.width,height:"auto"}),M=P.$shadowRoot.querySelector("input"),w=P.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(M,["input","propertychange"],b=>{c.val(M)===""?c.attr(w,"disabled","true"):c.removeAttr(w,"disabled");}),c.listenKeyboard(M,"keydown",(b,U,T)=>{b==="Enter"&&T.length===0&&c.val(M)!==""&&c.trigger(w,"click");}),c.trigger(M,"input");}),c.on(L,"click",async O=>{c.preventEvent(O),v.close();let P=await _.getClipboardText();if(P.trim()===""){g.warning("获取到的剪贴板内容为空");return}await z(P);});},i=(f=`${xe}_panel-setting-${h.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,v)=>{const y=Q.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(E,z){E.close();}}},drag:true,mask:{enable:true},width:W.info.width,height:W.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),x=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),L=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");c.on(x,"click",E=>{c.preventEvent(E);try{A(f,v),y.close();}catch(z){g.error(z.toString(),{consoleLogContent:true});}}),c.on(L,"click",async E=>{await h.copy(v)?(g.success("复制成功"),y.close()):g.error("复制失败");});},l=Q.confirm({title:{text:"配置",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),d={};if(typeof we=="function")we().forEach(v=>{const y=ee(v);Reflect.set(d,v,y);});else {g.warning("不支持函数GM_listValues，仅导出菜单配置");const f=ee(ve);Reflect.set(d,ve,f);}const p=_.toStr(d);l.value=p;},o=()=>{let a=fe?.script?.supportURL||fe?.script?.namespace;typeof a=="string"&&h.isNotNull(a)&&window.open(a,"_blank");};return [{id:"script-version",title:`版本：${fe?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(a){new _e(a.$asideLiElement).on("tap",function(s){clearTimeout(t),t=void 0,e?(e=false,n()):(t=setTimeout(()=>{e=false,o();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},Re={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{m.showPanel(Le.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){m.isTopWindow()&&Qe.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let A=this.$data.menuOption.findIndex(n=>n.key===t.key);A!==-1&&(this.$data.menuOption[A]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},m={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new h.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new h.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new h.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new h.Dictionary),this.__onceExecData},get scriptName(){return xe},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ve,attributeKeyName:he,attributeDefaultValueName:me},init(){this.initContentDefaultValue(),Re.init();},isTopWindow(){return H.top===H.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="container"||n.type==="deepMenu")return;const o=n.attributes;let a=o[Pe];if(typeof a=="function"){let d=a();if(typeof d=="boolean"&&!d)return}let i=new Map,s=o[he];if(s!=null){const d=o[me];i.set(s,d);}let l=o[Ue];if(typeof l=="object"&&l&&Object.keys(l).forEach(d=>{const p=l[d];i.set(d,p);}),!i.size){u.warn(["请先配置键",n]);return}if(n.type==="switch"){let d=typeof n.disabled=="function"?n.disabled():n.disabled;typeof d=="boolean"&&d&&this.$data.contentConfigInitDisabledKeys.push(...i.keys());}for(const[d,p]of i.entries())this.setDefaultValue(d,p);},t=n=>{for(let o=0;o<n.length;o++){let a=n[o];e(a);let i=a.views;i&&Array.isArray(i)&&t(i);}},A=[...Le.getAllContentConfig()];for(let n=0;n<A.length;n++){let o=A[n];if(!o.views)continue;const a=o.views;a&&Array.isArray(a)&&t(a);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&u.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){oe.set(e,t);},getValue(e,t){const A=oe.get(e);return A??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){oe.delete(e);},hasKey(e){return oe.has(e)},addValueChangeListener(e,t){return oe.addValueChangeListener(e,(n,o,a)=>{t(e,a,o);})},removeValueChangeListener(e){oe.removeValueChangeListener(e);},triggerMenuValueChange(e,t,A){oe.triggerValueChangeListener(e,A,t);},async exec(e,t,A,n=true){const o=this;let a;typeof e=="string"||Array.isArray(e)?a=()=>e:a=e;let i=false;const s=a();let l=[];Array.isArray(s)?(i=true,l=s):l.push(s);const d=l.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(d){u.warn(`${d} 键不存在`);return}const p=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(p))return this.$data.onceExecMenuData.get(p);let f=[];const v=[];let y=[];const x=(w,b)=>{let U=[],T=[],C=[];if(Array.isArray(b))C=C.concat(b);else if(typeof b=="object"&&b!=null)if(b instanceof Element)C.push(b);else {const{$css:k,destory:D}=b;k!=null&&(Array.isArray(k)?C=C.concat(k):C.push(k)),typeof D=="function"&&C.push(D);}else C.push(b);for(const k of C)if(k!=null){if(k instanceof Element){U.push(k);continue}if(typeof k=="function"){y.push(k);continue}}w?(f=f.concat(U),y=y.concat(T)):(E(),z());},L=w=>!!this.getValue(w),E=()=>{for(let w=0;w<f.length;w++)f[w]?.remove(),f.splice(w,1),w--;},z=()=>{for(let w=0;w<y.length;w++){const b=y[w];b(),y.splice(w,1),w--;}},O=()=>{let w=false;return typeof A=="function"?w=A(l):w=l.every(b=>L(b)),w},P=async w=>{if(O()){const U=l.map(C=>this.getValue(C)),T=await t({value:i?U:U[0],addStoreValue:(...C)=>x(true,C)});x(true,T);}else x(false,[]);};n&&l.forEach(w=>{const b=this.addValueChangeListener(w,(U,T,C)=>P());v.push(b);}),await P();const M={reload(){this.clearStoreStyleElements(),this.destory(),P();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>E(),destory(){return z()},removeValueChangeListener:()=>{v.forEach(w=>{this.removeValueChangeListener(w);});},clearOnceExecMenuData(){n&&o.$data.onceExecMenuData.delete(p);}};return this.$data.onceExecMenuData.set(p,M),M},async execMenu(e,t,A=false,n=false){return await this.exec(e,async o=>await t(o),o=>o.every(i=>{let s=!!this.getValue(i);return m.$data.contentConfigInitDisabledKeys.includes(i)&&(s=false,u.warn(`.execMenu${n?"Once":""} ${i} 被禁用`)),A&&(s=!s),s}),n)},async execMenuOnce(e,t,A=false,n=false){const o=await this.execMenu(e,t,A,true);if(n&&o){const a=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,a);}return o},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),oe.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async triggerUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const A of t)await A(e);},showPanel(e,t=`${xe}-设置`,A=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let o=e.findIndex(i=>(typeof i.isBottom=="function"?i.isBottom():!!i.isBottom)&&i.id==="script-version")!==-1;!A&&!o&&e.push(...Le.getDefaultBottomContentConfig());let a=Q.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(i,s)=>{i.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(i,s)=>{i(),this.$data.$panel=null;}},width:W.setting.width,height:W.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:a,content:e});},registerConfigSearch(e){const{$panel:t,content:A}=e,n=async(v,y)=>{if(v==null)return;const x=await y(v);return x&&typeof x.isFind=="boolean"&&x.isFind?x.data:await n(x.data,y)},o=(v,y)=>{const x=new IntersectionObserver(L=>{L.forEach(E=>{E.isIntersecting&&(y?.(),x.disconnect());});},{root:null,threshold:1});x.observe(v),v.scrollIntoView({behavior:"smooth",block:"center"});},a=v=>{const y="pops-flashing";c.animationend(v,()=>{v.classList.remove(y);}),v.classList.add(y);},i=v=>{if(v.type==="dblclick"&&f)return;c.preventEvent(v),l=null;const y=Q.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});y.$shadowRoot.querySelector(".search-wrapper");const x=y.$shadowRoot.querySelector(".search-config-text"),L=y.$shadowRoot.querySelector(".search-result-wrapper");x.focus();const E=()=>{c.empty(L);},z=P=>{const M=h.queryProperty(P,U=>U?.next?{isFind:false,data:U.next}:{isFind:true,data:U}),w=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),b=Q.config.PanelHandlerComponents();return c.on(w,"click",U=>{const C=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[P.index];if(!C){g.error(`左侧项下标${P.index}不存在`);return}C.scrollIntoView({behavior:"smooth",block:"center"}),C.click(),n(P.next,async k=>{if(k?.next){const D=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(Y=>{const F=Reflect.get(Y,b.$data.nodeStoreConfigKey);return typeof F=="object"&&F!=null&&F.text===k.name}),2500);if(D)D.click();else return g.error("未找到对应的二级菜单"),{isFind:true,data:k};return {isFind:false,data:k.next}}else {const D=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(Y=>Reflect.get(Y,b.$data.nodeStoreConfigKey)===k.matchedData?.formConfig),2500);if(D){o(D);const Y=D.closest(".pops-panel-forms-fold[data-fold-enable]");Y&&(Y.querySelector(".pops-panel-forms-fold-container").click(),await h.sleep(500)),o(D,()=>{a(D);});}else g.error("未找到对应的菜单项");return {isFind:true,data:k}}});}),w},O=P=>{const M=new RegExp(P,"i"),w=[],b=(T,C)=>{for(let k=0;k<T.length;k++){const D=T[k],Y=D.views;if(Y&&Array.isArray(Y)){const F=h.deepClone(C);if(D.type==="deepMenu"){const Ae=h.queryProperty(F,Z=>Z?.next?{isFind:false,data:Z.next}:{isFind:true,data:Z});Ae.next={name:D.text};}b(Y,F);}else {let F,Ae;if(D.type==="own"){const G=Reflect.get(D.attributes||{},Ke);G&&(typeof G.text=="string"&&(F=G.text),typeof G.desc=="string"&&(Ae=G.desc));}else F=Reflect.get(D,"text"),Ae=Reflect.get(D,"description");const Z=[F,Ae],re=Z.findIndex(G=>{if(typeof G=="string")return G.match(M)});if(re!==-1){const G=h.deepClone(C),ye=h.queryProperty(G,ne=>ne?.next?{isFind:false,data:ne.next}:{isFind:true,data:ne});ye.next={name:F,matchedData:{path:"",formConfig:D,matchedText:Z[re],description:Ae}};const Te=[];h.queryProperty(G,ne=>{const ze=ne?.name;return typeof ze=="string"&&ze.trim()!==""&&Te.push(ze),ne?.next?{isFind:false,data:ne.next}:{isFind:true,data:ne}});const Ge=Te.join(_.escapeHtml(" - "));ye.next.matchedData.path=Ge,w.push(G);}}}};for(let T=0;T<A.length;T++){const C=A[T];if(!C.views||C.isBottom&&C.id==="script-version")continue;const k=C.views;if(k&&Array.isArray(k)){let D=C.title;typeof D=="function"&&(D=D()),b(k,{index:T,name:D});}}const U=document.createDocumentFragment();for(const T of w){let C=z(T);U.appendChild(C);}E(),L.append(U);};c.on(x,"input",h.debounce(P=>{c.preventEvent(P);let M=c.val(x).trim();if(M===""){E();return}O(M);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(v=>{c.on(v,"dblclick",i);});let l=null,d=false,p,f=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(v,y)=>{f=true,clearTimeout(p),p=void 0,d&&l===y?(d=false,l=null,i(v)):(p=setTimeout(()=>{d=false;},200),d=true,l=y);},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
                ...
                <a href="javascript:;">${e.name}</a>
                `});c.on(o,"click",s=>{c.preventEvent(s),e.clickEvent(s);});let a=N("#mobile-nav nav"),i=N("#mobile-nav nav .multi-link-nav");i?c.before(i,o):a?c.append(a,o):u.error("元素#mobile-nav nav不存在");});}},V={async getScriptInfo(e){let t=j.getScriptInfoUrl(e),A=await q.get(t,{allowInterceptConfig:false,responseType:"json"});if(!A.status){let o=j.getScriptHomeUrl(e),a=await q.get(o,{fetch:true});if(!a.status)return;let i=c.toElement(a.data.responseText,true,true),s=i.querySelector(".install-link"),l=i.querySelector("dd.script-show-created-date relative-time[datetime]"),d=i.querySelector("dd.script-show-daily-installs"),p=i.querySelector("dd.script-show-total-installs"),f=i.querySelector("dd.script-show-updated-date relative-time[datetime]"),v=i.querySelector("#script-description"),y=i.querySelector(".good-rating-count"),x=i.querySelector(".ok-rating-count"),L=i.querySelector(".bad-rating-count"),E=i.querySelector("dd.script-show-license"),z={id:Number(e),created_at:l?.getAttribute("datetime")||"",daily_installs:Number(c.text(d)||"0"),total_installs:Number(c.text(p)||"0"),code_updated_at:f?.getAttribute("datetime")||"",support_url:"",fan_score:"",namespace:s?.getAttribute("data-script-namespace")||"",contribution_url:null,contribution_amount:null,good_ratings:Number(c.text(y)||"0"),ok_ratings:Number(c.text(x)||"0"),bad_ratings:Number(c.text(L)||"0"),users:[],name:s?.getAttribute("data-script-name")||c.text(i.querySelector("title")),description:c.text(v),url:t,code_url:s?.getAttribute("href")||"",license:c.text(E)||null,version:s?.getAttribute("data-script-version")||i.querySelector("dd.script-show-version")?.innerText||"",locale:"",deleted:false};if(h.isNull(z.code_url)&&!s){let O=i.querySelector("#script-content code");O&&(z.code_url=c.text(O).trim().replace(/^\/\/[\s]*@require[\s]*/gi,"").trim());}return z}return h.toJSON(A.data.responseText)},async getScriptStats(e){let t=await q.get(`/scripts/${e}/stats.json`,{allowInterceptConfig:false});if(u.info(t),!t.status){u.error(r.t("获取脚本统计数据失败"));return}return h.toJSON(t.data.responseText)},async getSourceCodeSyncFormDataInfo(e){let t=await q.get(`/scripts/${e}/admin`,{fetch:true,allowInterceptConfig:false});if(u.info(t),!t.status){g.error(r.t("请求admin内容失败"));return}let A=t.data.responseText,o=c.toElement(A,false,true).querySelector("form.edit_script[action*='sync_update']");if(!o){g.error(r.t("解析admin的源代码同步表单失败"));return}let a=new FormData(o),i=o.querySelector("input[type='submit'][name='update-and-sync']");return i&&a.append(i.name,i.value),{url:o.action,formData:a}},async sourceCodeSync(e,t,A){let n=await q.post(A||`/scripts/${e}/sync_update`,{fetch:true,data:t,allowInterceptConfig:false,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Content-Type":"application/x-www-form-urlencoded",Origin:window.location.origin,Referer:window.location.href,"User-Agent":h.getRandomPCUA()}});if(u.info(n),!n.status){g.error(r.t("源代码同步失败"));return}return n},async getUserInfo(e){let t=await q.get(`/users/${e}.json`,{allowInterceptConfig:false});if(u.success(t),!t.status){g.error(r.t("获取用户信息失败"));return}let A=h.toJSON(t.data.responseText);if(A.scriptList=[],A.scriptLibraryList=[],A.scripts.forEach(n=>{n.code_url.endsWith(".user.js")?A.scriptList.push(n):A.scriptLibraryList.push(n);}),!A.scriptLibraryList.length){let n=await q.get(`/users/${e}`,{fetch:true,allowInterceptConfig:false});if(!n.status){g.error(r.t("获取用户主页信息失败"));return}let o=n.data.responseText,a=c.toElement(o,true,true),i=a.querySelector("#user-library-script-list");i?i.querySelectorAll("li").forEach(s=>{let l=le.parseScriptListInfo(s),d=s.querySelector("a.script-link").href;A.scriptLibraryList.push({id:l.scriptId,created_at:l.scriptCreatedDate.toISOString(),daily_installs:l.scriptDailyInstalls,total_installs:l.scriptTotalInstalls,code_updated_at:l.scriptUpdatedDate.toISOString(),support_url:null,fan_score:l.scriptRatingScore.toString(),namespace:null,contribution_url:null,contribution_amount:null,good_ratings:0,ok_ratings:0,bad_ratings:0,name:l.scriptName,description:l.scriptDescription,url:d,code_url:l.codeUrl,license:null,version:l.scriptVersion,locale:l.scriptLanguage,deleted:false});}):u.error("解析用户主页的库列表失败",a);}return A},async getUserCollection(e){let t=await q.get(`/users/${e}`,{fetch:true,allowInterceptConfig:false});if(u.info("获取用户的收藏集",t),!t.status){g.error(r.t("获取用户的收藏集失败"));return}let A=t.data.responseText,o=c.toElement(A,true,true).querySelector("#user-script-sets");if(!o){u.error("解析Script Sets失败");return}let a=[];return o.querySelectorAll("li").forEach(i=>{let s=i.querySelector("a:last-child");if(!s)return;let l=s.href;if(l.includes("?fav=1"))return;let d=i.querySelector("a").innerText,p=l.match(/\/sets\/([\d]+)\//)?.[1];a.push({id:p,name:d});}),a},async getUserCollectionInfo(e,t){let A=await q.get(`/users/${e}/sets/${t}/edit`,{fetch:true,allowInterceptConfig:false});if(u.info(A),!A.status){g.error(r.t("获取收藏集{{setsId}}失败",{setsId:t}));return}let n=A.data.responseText,o=c.toElement(n,true,true),a=o.querySelector('form[id^="edit_script_set"]');if(!a){g.error(r.t("获取表单元素#edit_script_set失败"));return}let i=new FormData(a),s=o.querySelector('meta[name="csrf-token"]');if(!s){g.error(r.t("获取表单csrfToken失败"));return}if(s.hasAttribute("content")){let l=s.getAttribute("content");l&&i.set("authenticity_token",l);}return i},async updateUserSetsInfo(e,t,A){let n=await q.post(`/users/${e}/sets/${t}`,{fetch:true,allowInterceptConfig:false,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"no-cache","Content-Type":"application/x-www-form-urlencoded",Pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:A});if(u.info(n),!n.status){g.error(r.t("更新收藏集表单请求失败"));return}let o=n.data.responseText;return c.toElement(o,true,true)},async switchLanguage(e){let t=await q.get(e,{fetch:true,headers:{"Upgrade-Insecure-Requests":"1"}});u.info(t),t.status;}},it=`:root {\r
...
`,bt={init(){m.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),m.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),m.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(I(wt)),e.push(_.addBlockCSS(".version-number",".version-date",".version-changelog")),c.ready(function(){let t=N("ul.history_versions");if(!t){g.error(r.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(A=>{let n=A.querySelector(".version-number a").href,o=A.querySelector(".version-number a").innerText,a=A.querySelector(".version-date")?.getAttribute("datetime"),i=A.querySelector(".version-changelog")?.innerHTML||"",s=c.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),l=c.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
						...
						`});c.after(e,l);});});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),Ie.monacoEditor().then(e=>{c.ready(()=>{X('#script-content form[action*="/diff"] input[type="submit"]').forEach(t=>{let A=c.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});c.after(t,A),c.on(A,"click",async n=>{c.preventEvent(n);const o=t.closest("form"),a=new FormData(o),i=a.get("v1"),s=a.get("v2");if(i===s){g.warning(r.t("版本号相同，不需要比较源码"));return}u.info(`对比版本：${i} vs ${s}`);const l=g.loading(r.t("正在获取对比文本中...")),d=j.getScriptId(),p=await V.getScriptInfo(d);if(!p){l.close();return}u.info("脚本信息：",p);const f=p.code_url,v=f.replace(new RegExp(`/${d}/`),`/${d}/${i}/`),y=f.replace(new RegExp(`/${d}/`),`/${d}/${s}/`);u.info(`请求版本代码：${v}`),u.info(`请求版本代码：${y}`);let x="",L="";const[E,z]=await Promise.all([q.get(v,{timeout:2e4}),q.get(y,{timeout:2e4})]);if(l.close(),!E.status||!z.status)return;x=E.data.responseText,L=z.data.responseText;let{recovery:O}=_.lockScroll(),P=Q.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
						...
						`});P.$shadowRoot.querySelector(".monaco-editor-diff-container");let M=P.$shadowRoot.querySelector(".monaco-editor-diff"),w=e.editor.createDiffEditor(M,{hideUnchangedRegions:{enabled:true},minimap:{enabled:true},automaticLayout:true,codeLens:true,colorDecorators:true,contextmenu:false,readOnly:true,formatOnPaste:true,overviewRulerBorder:true,scrollBeyondLastLine:false,theme:"vs-dark",fontSize:window.innerWidth>600?14:12,wordWrap:"off",language:"javascript"});const b=e.editor.createModel(L,"javascript"),U=e.editor.createModel(x,"javascript");w.setModel({original:b,modified:U});});});});});}};let be=[];const Xe=async function(e){if(u.info("当前脚本id："+e),!R.isLogin){u.error("请先登录账号"),g.error(r.t("请先登录账号"));return}let t=j.getUserId(R.getUserLinkElement().href);if(t==null){u.error("获取用户id失败"),g.error(r.t("获取用户id失败"));return}if(!be.length){let a=g.loading(r.t("获取收藏夹中..."));if(be=await V.getUserCollection(t)||[],a.close(),!be.length)return}let A="";const n=(a,i)=>{let s=false;i=i.toString().trim();for(const[l,d]of a.entries())if(l==="scripts-included[]"&&d.toString().trim()===i){s=true;break}return s};be.forEach(a=>{A+=`
		...
		`});c.on(o.$shadowRoot,"click",".collect-add-script-id",async function(a){let i=a.target.closest(".user-collect-item"),s=i.dataset.id;i.dataset.name;let l=g.loading(r.t("添加中..."));try{let d=await V.getUserCollectionInfo(t,s);if(!d)return;if(n(d,e)){g.warning(r.t("该脚本已经在该收藏集中"));return}let p=h.cloneFormData(d),f=h.cloneFormData(d);p.set("add-script",e.toString()),p.set("script-action","i"),f.append("scripts-included[]",e.toString()),f.set("save","1");let v=new URLSearchParams(p),y=new URLSearchParams(f),x=Array.from(v).map(([b,U])=>`${encodeURIComponent(b)}=${encodeURIComponent(U)}`).join("&"),L=Array.from(y).map(([b,U])=>`${encodeURIComponent(b)}=${encodeURIComponent(U)}`).join("&");u.info("添加的数据",x),u.info("保存的数据",L);let E=await V.updateUserSetsInfo(t,s,x);if(!E)return;let z=E.querySelector(".change-script-set");if(!z){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let O=z.querySelector("section");if(!O){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}let P=O.querySelector(".alert");if(P){Q.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:P.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:W.info.width,height:W.info.height});return}let M=new FormData(z);if(!n(M,e)){u.error("添加失败，提交的添加请求中不包含该脚本id"),g.error(r.t("添加失败，表单数据中不包含该脚本"));return}await V.updateUserSetsInfo(t,s,L),g.success(r.t("添加成功"));}catch(d){console.error(d);}finally{l.close();}}),c.on(o.$shadowRoot,"click",".collect-delete-script-id",async function(a){let i=a.target.closest(".user-collect-item"),s=i.dataset.id;i.dataset.name;let l=g.loading(r.t("删除中..."));try{let d=await V.getUserCollectionInfo(t,s);if(!d)return;if(!n(d,e)){g.info(r.t("已删除：{{scriptId}}",{scriptId:e}));return}let p=h.cloneFormData(d,(M,w)=>M==="scripts-included[]"&&typeof w=="string"&&w.toString().trim()===e.toString().trim()),f=h.cloneFormData(p);p.set("remove-scripts-included[]",e.toString()),p.set("remove-selected-scripts","i"),p.delete("script-action"),f.set("save","1");let v=new URLSearchParams(p),y=new URLSearchParams(f),x=Array.from(v).map(([M,w])=>`${encodeURIComponent(M)}=${encodeURIComponent(w)}`).join("&"),L=Array.from(y).map(([M,w])=>`${encodeURIComponent(M)}=${encodeURIComponent(w)}`).join("&");u.info("删除的数据",x),u.info("保存的数据",L);let E=await V.updateUserSetsInfo(t,s,x);if(!E)return;let z=E.querySelector(".change-script-set");if(!z){g.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let O=new FormData(z);if(n(O,e)){u.error("删除失败，提交的删除请求中包含该脚本id"),g.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await V.updateUserSetsInfo(t,s,L),g.success(r.t("删除成功"));}catch(d){console.error(d);}finally{l.close();}});},xt={init(){K.isCode()?yt.init():K.isVersion()&&bt.init(),K.isCodeStrict()&&(m.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),m.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),m.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),m.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),c.ready(()=>{m.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){u.info("添加收藏按钮"),c.waitNode("ul#script-links li.current span").then(()=>{let e=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
...
`,Me={getTampermonkey:()=>H.external?.Tampermonkey,getViolentmonkey:()=>H.external?.Violentmonkey,getScriptCat:()=>H.external?.Scriptcat,getScriptContainerStatus(){let e={Tampermonkey:false,Violentmonkey:false,ScriptCat:false};return H.external?.Tampermonkey&&(e.Tampermonkey=true),H.external?.Violentmonkey&&(e.Violentmonkey=true),H.external?.Scriptcat&&(e.ScriptCat=true),e},getRegisterScriptContainerNameList(){let t=this.getScriptContainerStatus(),A=[];return Object.keys(t).forEach(n=>{Reflect.get(t,n)&&A.push(n);}),A},getInstalledVersion(e,t){return new Promise((A,n)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(A);return}const i=this.getScriptCat();if(i){i.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}n(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const A=e.split("."),n=t.split(".");for(let o=0;o<A.length;o++){const a=this.compareVersionPart(A[o],n[o]);if(a!==0)return a}return 0},compareVersionPart(e,t){const A=this.parseVersionPart(e),n=this.parseVersionPart(t);for(let o=0;o<A.length;o++){if(A[o].length>0&&n[o].length===0)return  -1;if(A[o].length===0&&n[o].length>0||A[o]>n[o])return 1;if(A[o]<n[o])return  -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,A){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,A)){case  -1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const A=e.getAttribute("data-script-name"),n=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(A,n);return a==null?!1:(this.handleInstallResult(e,a,o),!0)}catch{if(t){await h.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return  false}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),A=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:A,url:location.href},location.origin);}},qe={init(){m.execMenuOnce("gf-scripts-filter-enable",()=>{ie.init();}),m.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let e=[];e.push(I(Lt));const t="lum-lightbox-loader",A=r.t("安装此脚本");return B.ready(()=>{let n=Me.getScriptContainerStatus(),o=Object.values(n).find(d=>d),a=Me.getRegisterScriptContainerNameList(),i=m.getValue("beautifyCenterContent-queryNameSpace");o?u.info("当前暴露的external信息："+a.map(d=>`【${d}】`).join("、")):u.error("脚本容器未暴露external信息",window.external);let s=new h.LockFunction(()=>{ie.getElementList().forEach(p=>{if(p.querySelector(".script-list-operation"))return;let f=le.parseScriptListInfo(p),v=p.querySelector(".inline-script-stats");if(!v)return;let y=f.codeUrl,x=B.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),L=B.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${f.scriptRatingScore}</span>`},{"data-position":"right"}),E=p.querySelector("dd.script-list-ratings .good-rating-count"),z=p.querySelector("dd.script-list-ratings .ok-rating-count"),O=p.querySelector("dd.script-list-ratings .bad-rating-count");if(E&&z&&O){let C=parseInt(E.innerText),k=parseInt(z.innerText),D=parseInt(O.innerText),Y=C+k+D;Y>=10?C/Y>=.6?L.classList.add("good-rating-count"):L.classList.add("bad-rating-count"):Y==0||C>k+D?L.classList.add("good-rating-count"):L.classList.add("bad-rating-count");}let P=B.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),M=B.createElement("dd",{className:"script-list-version",innerHTML:`<span>${f.scriptVersion}</span>`},{"data-position":"right"}),w=B.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),b=B.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),U=b.querySelector(".script-collect-btn"),T=b.querySelector(".install-link");if(T["data-script-info"]=f,B.addClass(T,t),f.scriptType==="library"&&T.remove(),B.on(U,"click",C=>{B.preventEvent(C),Xe(f.scriptId);}),m.getValue("gf-scripts-filter-enable")){let C=B.createElement("button",{className:"script-filter-btn",innerHTML:r.t("过滤")}),k="data-filter-key",D="data-filter-value";B.on(C,"click",Y=>{B.preventEvent(Y);let F=Q.alert({title:{text:r.t("选择需要过滤的选项"),position:"center"},content:{text:`
								...
								`}),Ae=F.$shadowRoot.querySelector(".pops-alert-content");f.scriptAuthors.forEach(Z=>{let re=B.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:Z.authorId})});re.setAttribute(k,"scriptAuthorId"),re.setAttribute(D,"^"+Z.authorId+"$");let G=B.createElement("button",{innerHTML:r.t("作者名：{{text}}",{text:Z.authorName})});G.setAttribute(k,"scriptAuthorName"),G.setAttribute(D,"^"+h.toRegExpStr(Z.authorName)+"$"),Ae.appendChild(re),Ae.appendChild(G);}),B.on(F.$shadowRoot,"click",`button[${k}]`,Z=>{B.preventEvent(Z);let re=Z.target,G=re.getAttribute(k),ye=re.getAttribute(D);ie.addValue(G,ye),F.close(),ie.filter(),g.success(r.t("添加成功"));});}),b.appendChild(C);}v.appendChild(x),v.appendChild(L),v.appendChild(P),v.appendChild(M),v.appendChild(w),v.appendChild(b);});},100),l=new h.LockFunction(async()=>{let d=Array.from(X(".install-link[data-install-format=js]:not([gm-is-check-install-status])"));for(let p=0;p<d.length;p++){const f=d[p];f.setAttribute("gm-is-check-install-status","");let v=Reflect.get(f,"data-script-info");if(o){if(i){let y=await V.getScriptInfo(v.scriptId);y&&f.setAttribute("data-script-namespace",y.namespace);}Me.checkForUpdatesJS(f,true).then(y=>{B.removeClass(f,t),y||B.text(f,A);});}else B.removeClass(f,t),B.text(f,A);}});h.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{s.run(),l.run();}});}),e}},Ct={init(){m.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),m.execMenuOnce("gf-scripts-filter-enable",()=>{ie.init();}),m.execMenuOnce("beautifyCenterContent",()=>qe.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),_.addBlockCSS("#about-user"),c.ready(()=>{let e=N("#about-user");if(!e){u.error("#about-user元素不存在");return}e=e.cloneNode(true),le.registerTopNavMenu({name:r.t("控制台"),className:"scripts-console",clickEvent(t){Q.alert({title:{text:r.t("控制台"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:W.setting.width,height:W.setting.height,zIndex:h.getMaxZIndex(100),style:`
						#about-user{
							border: 0;
							box-shadow: none;
						}

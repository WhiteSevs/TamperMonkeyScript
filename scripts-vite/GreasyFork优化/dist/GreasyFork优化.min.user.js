...
(function (m, N, se, n, he, Le) {
	...
	var Ce=Object.defineProperty;var Ee=(e,t,r)=>t in e?Ce(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var oe=(e,t,r)=>Ee(e,typeof t!="symbol"?t+"":t,r);var v=typeof GM_addStyle<"u"?GM_addStyle:void 0,de=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,le=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,z=typeof GM_getValue<"u"?GM_getValue:void 0,ie=typeof GM_info<"u"?GM_info:void 0,Te=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,q=typeof GM_setValue<"u"?GM_setValue:void 0,Me=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Ie=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,A=typeof unsafeWindow<"u"?unsafeWindow:void 0,_e=window;const Ue={GreasyFork优化:"GreasyFork优化",请求取消:"请求取消",请求超时:"请求超时",请求异常:"请求异常",通用:"通用",账号:"账号",密码:"密码",语言:"语言","账号/密码":"账号/密码",请输入账号:"请输入账号",请输入密码:"请输入密码",自动登录:"自动登录",自动登录当前保存的账号:"自动登录当前保存的账号","清空账号/密码":"清空账号/密码",点击清空:"点击清空","确定清空账号和密码？":"确定清空账号和密码？","已清空账号/密码":"已清空账号/密码","源代码同步【脚本列表】":"源代码同步【脚本列表】",一键同步:"一键同步",前往用户主页:"前往用户主页",获取当前已登录的用户主页失败:"获取当前已登录的用户主页失败","源代码同步【未上架的脚本】":"源代码同步【未上架的脚本】","源代码同步【库】":"源代码同步【库】",论坛:"论坛",功能:"功能",过滤重复的评论:"过滤重复的评论","过滤掉重复的评论数量(≥2)":"过滤掉重复的评论数量(≥2)","过滤脚本(id)":"过滤脚本(id)","请输入脚本id，每行一个":"请输入脚本id，每行一个","过滤发布的用户(id)":"过滤发布的用户(id)","请输入用户id，每行一个":"请输入用户id，每行一个","过滤回复的用户(id)":"过滤回复的用户(id)",优化:"优化",固定当前语言:"固定当前语言",无:"无","如button、input、textarea":"如button、input、textarea",更直观的查看版本迭代:"更直观的查看版本迭代",美化上传图片按钮:"美化上传图片按钮",放大上传区域:"放大上传区域",优化图片浏览:"优化图片浏览",使用Viewer浏览图片:"使用Viewer浏览图片",覆盖图床图片跳转:"覆盖图床图片跳转","配合上面的【优化图片浏览】更优雅浏览图片":"配合上面的【优化图片浏览】更优雅浏览图片",'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>':'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>',代码:"代码",添加复制代码按钮:"添加复制代码按钮",更优雅的复制:"更优雅的复制",快捷键:"快捷键","【F】键全屏、【Alt+Shift+F】键宽屏":"【F】键全屏、【Alt+Shift+F】键宽屏",库:"库",脚本列表:"脚本列表","请输入屏蔽规则，每行一个":"请输入屏蔽规则，每行一个",请求admin内容失败:"请求admin内容失败",解析admin的源代码同步表单失败:"解析admin的源代码同步表单失败",源代码同步失败:"源代码同步失败",获取用户信息失败:"获取用户信息失败",获取用户的收藏集失败:"获取用户的收藏集失败","解析Script Sets失败":"解析Script Sets失败","获取收藏集{{setsId}}失败":"获取收藏集{{setsId}}失败","获取表单元素#edit_script_set失败":"获取表单元素#edit_script_set失败",更新收藏集表单请求失败:"更新收藏集表单请求失败",请先在菜单中录入账号:"请先在菜单中录入账号",请先在菜单中录入密码:"请先在菜单中录入密码","获取csrf-token失败":"获取csrf-token失败","正在登录中...":"正在登录中...","登录失败，请在控制台查看原因":"登录失败，请在控制台查看原因","登录成功，1s后自动跳转":"登录成功，1s后自动跳转","登录失败，可能是账号/密码错误，请在控制台查看原因":"登录失败，可能是账号/密码错误，请在控制台查看原因","美化 历史版本 页面":"美化 历史版本 页面",未找到history_versions元素列表:"未找到history_versions元素列表","yyyy年MM月dd日 HH:mm:ss":"yyyy-MM-dd HH:mm:ss","美化 Greasyfork Beautify脚本":"美化 Greasyfork Beautify脚本","❌ 最多同时长传5张图":"❌ 最多同时长传5张图片","❌ 图片：{{name}} 大小：{{size}}":"❌ 图片：{{name}} 大小：{{size}}","已过滤：{{oldCount}}":"已过滤：{{oldCount}}",寻找引用:"寻找引用",获取脚本id失败:"获取脚本id失败",收藏:"收藏",请先登录账号:"请先登录账号",获取用户id失败:"获取用户id失败","获取收藏夹中...":"获取收藏夹中...",收藏集:"收藏集","添加中...":"添加中...","添加失败，{{selector}}元素不存在":"添加失败，{{selector}}元素不存在","未找到{{selector}}元素":"未找到{{selector}}元素",添加失败:"添加失败",添加成功:"添加成功","删除中...":"删除中...",删除成功:"删除成功",添加:"添加",刪除:"刪除","拦截跳转：":"拦截跳转：",今日检查:"今日检查",复制代码:"复制代码","加载文件中...":"加载文件中...",复制成功:"复制成功","✅ 复制成功!":"✅ 复制成功!","当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}":"当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}","导航至：":"导航至：","请先登录账号！":"请先登录账号！","获取信息中，请稍后...":"获取信息中，请稍后...","获取成功，共 {{count}} 个":"获取成功，共 {{count}} 个","评分：":"评分：","语言：":"语言：","版本：":"版本：","更新：":"更新：",同步代码:"同步代码","同步中...":"同步中...",手动:"手动",自动:"自动","同步方式：{{syncMode}}":"同步方式：{{syncMode}}",同步成功:"同步成功",同步失败:"同步失败",该脚本未设置同步信息:"该脚本未设置同步信息","上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载":"上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载","名称：":"名称：","进度：":"进度：","未获取到【脚本列表】":"未获取到【脚本列表】","源代码同步成功，3秒后更新下一个":"源代码同步成功，3秒后更新下一个",全部更新失败:"全部更新失败","全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}":"全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}","⚙ 设置":"⚙ 设置","{{SCRIPT_NAME}}-设置":"{{SCRIPT_NAME}}-设置",美化页面元素:"美化页面元素",美化历史版本页面:"美化历史版本页面","美化Greasyfork Beautify脚本":"美化Greasyfork Beautify脚本",获取表单csrfToken失败:"获取表单csrfToken失败",Toast配置:"Toast配置",Toast位置:"Toast位置",左上角:"左上角",顶部:"顶部",右上角:"右上角",左边:"左边",中间:"中间",右边:"右边",左下角:"左下角",底部:"底部",右下角:"右下角",Toast显示在页面九宫格的位置:"Toast显示在页面九宫格的位置",最多显示的数量:"最多显示的数量",限制Toast显示的数量:"限制Toast显示的数量",逆序弹出:"逆序弹出",修改Toast弹出的顺序:"修改Toast弹出的顺序",该脚本已经在该收藏集中:"该脚本已经在该收藏集中",其它错误:"其它错误",启用:"启用",开启后下面的过滤功能才会生效:"开启后下面的功能才会生效",屏蔽脚本:"屏蔽脚本",点击查看规则:"点击查看规则",过滤:"过滤",代码同步:"代码同步",美化:"美化",修复代码行号显示:"修复代码行号显示",修复代码行数超过1k行号显示不全问题:"修复代码行数超过1k行号显示不全问题","添加【寻找引用】按钮":"添加【寻找引用】按钮","在脚本栏添加按钮，一般用于搜索引用该库的相关脚本":"在脚本栏添加按钮，一般用于搜索引用该库的相关脚本","添加【收藏】按钮":"添加【收藏】按钮","在脚本栏添加按钮，一般用于快捷收藏该脚本/库":"在脚本栏添加按钮，一般用于快捷收藏该脚本/库",修复图片宽度显示问题:"修复图片宽度显示问题",修复图片在移动端宽度超出浏览器宽度问题:"修复图片在移动端宽度超出浏览器宽度问题","添加【今日检查】信息块":"添加【今日检查】信息块","在脚本信息栏添加【今日检查】信息块":"在脚本信息栏添加【今日检查】信息块","给Markdown添加【复制】按钮":"给Markdown添加【复制】按钮","在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容":"在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容",开启后下面的功能才会生效:"开启后下面的功能才会生效",检测页面加载:"检测页面加载","检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面":"检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面",检测间隔:"检测间隔","设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面":"设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面",美化顶部导航栏:"美化顶部导航栏","可能会跟Greasyfork Beautify脚本有冲突":"可能会跟Greasyfork Beautify脚本有冲突",美化脚本列表:"美化脚本列表","双列显示且添加脚本卡片操作项（安装、收藏）":"双列显示且添加脚本卡片操作项（安装、收藏）",操作面板:"操作面板","添加【操作面板】按钮":"添加【操作面板】按钮","在脚本列表页面时为顶部导航栏添加【操作面板】按钮":"在脚本列表页面时为顶部导航栏添加【操作面板】按钮",操作:"操作",安装此脚本:"安装此脚本",脚本:"脚本",历史版本:"历史版本",自定义已读颜色:"自定义已读颜色",在讨论内生效:"在讨论内生效",用户:"用户",控制台:"控制台","迁移【控制台】到顶部导航栏":"迁移【控制台】到顶部导航栏","将【控制台】按钮移动到顶部导航栏，节省空间":"将【控制台】按钮移动到顶部导航栏，节省空间","在版本下面添加【安装】、【查看代码】按钮":"在版本下面添加【安装】、【查看代码】按钮",查看代码:"查看代码",添加快捷操作按钮:"添加快捷操作按钮","在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效":"在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效",选择需要过滤的选项:"选择需要过滤的选项","确定{{type}}：{{filterId}}？":"确定{{type}}：{{filterId}}？","该收藏集未包含：{{scriptId}}":"该收藏集未包含：{{scriptId}}",帮助文档:"帮助文档","请输入规则，每行一个":"请输入规则，每行一个",选择过滤的选项:"选择过滤的选项","脚本id：{{text}}":"脚本id：{{text}}","脚本名：{{text}}":"脚本名：{{text}}","作者id：{{text}}":"作者id：{{text}}","作者名：{{text}}":"作者名：{{text}}","作用域：脚本、脚本搜索、用户主页":"作用域：脚本、脚本搜索、用户主页","更新到 {{version}} 版本":"更新到 {{version}} 版本","降级到 {{version}} 版本":"降级到 {{version}} 版本","重新安装 {{version}} 版本":"重新安装 {{version}} 版本","发布的用户id：{{text}}":"发布的用户id：{{text}}",自定义快捷键:"自定义快捷键",点击录入快捷键:"点击录入快捷键",快捷键发表回复:"快捷键发表回复","在输入框内按下快捷发表回复，例如：{{key}}":"在输入框内按下快捷发表回复，例如：{{key}}",请先执行当前的录入操作:"请先执行当前的录入操作",清空快捷键:"清空快捷键","请按下快捷键...":"请按下快捷键...",成功录入:"成功录入","快捷键 {{key}} 已被 {{isUsedKey}} 占用":"快捷键 {{key}} 已被 {{isUsedKey}} 占用",私聊:"私聊",美化私信页面:"美化私信页面",美化为左右对话模式:"美化为左右对话模式","最后回复：":"最后回复：",进入:"进入",记住回复内容:"记住回复内容","监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复":"监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复",表单:"表单",自动清理空间:"自动清理空间",不清理:"不清理","{{value}} 天":"{{value}} 天","{{value}} 周":"{{value}} 周","{{value}} 个月":"{{value}} 个月",半年:"半年",计算中:"计算中",根据设置的间隔时间自动清理保存的回复内容:"根据设置的间隔时间自动清理保存的回复内容","数据占用空间：{{size}}":"数据占用空间：{{size}}",当前存储的数据所占用的空间大小:"当前存储的数据所占用的空间大小",清空:"清空",清理成功:"清理成功",清理失败:"清理失败","Url To WebhookUrl":"Url 转 WebhookUrl",关闭:"关闭","例如：":"例如：","结果：":"结果：",转换前:"转换前",转换后:"转换后"},$e={GreasyFork优化:"GreasyFork Optimization",请求取消:"http request cancel",请求超时:"http request timeout",请求异常:"http request error",通用:"General",账号:"Account",密码:"Password",语言:"Language","账号/密码":"Account/Password",请输入账号:"Please enter your account number",请输入密码:"Please enter password",自动登录:"Auto Login",自动登录当前保存的账号:"Automatically log in to the currently saved account","清空账号/密码":"Clear account/password",点击清空:"Clear","确定清空账号和密码？":"Are you sure to clear your account and password?","已清空账号/密码":"Account/password cleared","源代码同步【脚本列表】":"Source Code Synchronization [Script List]",一键同步:"Sync All",前往用户主页:"Go to the user's homepage",获取当前已登录的用户主页失败:"Failed to retrieve the currently logged in user's homepage","源代码同步【未上架的脚本】":"Source code synchronization [Script not listed]","源代码同步【库】":"Source code synchronization 【 Library 】",论坛:"Forum",功能:"Function",过滤重复的评论:"Filter duplicate comments","过滤掉重复的评论数量(≥2)":"Filter out duplicate comments (≥ 2)","过滤脚本(id)":"Filter script (id)","请输入脚本id，每行一个":"Please enter the script ID, one per line","过滤发布的用户(id)":"Filter published users (id)","请输入用户id，每行一个":"Please enter the user ID, one per line","过滤回复的用户(id)":"User (ID) who filters replies",优化:"Optimization",固定当前语言:"Fix current language",无:"nothing","如button、input、textarea":"For example button、input、textarea",更直观的查看版本迭代:"More intuitive viewing of version iterations",美化上传图片按钮:"Beautify upload image button",放大上传区域:"Enlarge the upload area",优化图片浏览:"Optimize image browsing",使用Viewer浏览图片:"Using Viewer to browse images",覆盖图床图片跳转:"Overlay bed image jump","配合上面的【优化图片浏览】更优雅浏览图片":"Collaborate with the optimization of image browsing above to browse images more elegantly",'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>':'Greasyfork Beauty script needs to be installed，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐 Click me to install</a>',代码:"Code",添加复制代码按钮:"Add Copy Code Button",更优雅的复制:"More elegant replication",快捷键:"Shortcut keys","【F】键全屏、【Alt+Shift+F】键宽屏":"【F】 Key full screen, [Alt+Shift+F] key wide screen",库:"Library",脚本列表:"Script List","请输入屏蔽规则，每行一个":"Please enter a blocking rule, one per line",请求admin内容失败:"Request for admin content failed",解析admin的源代码同步表单失败:"Failed to parse the source code of admin and synchronize the form",源代码同步失败:"Source code synchronization failed",获取用户信息失败:"Failed to obtain user information",获取用户的收藏集失败:"Failed to retrieve user's collection","解析Script Sets失败":"Parsing Script Sets failed","获取收藏集{{setsId}}失败":"Failed to retrieve collection {{setsId}}","获取表单元素#edit_script_set失败":"Failed to retrieve form element #edit_script_set",更新收藏集表单请求失败:"Update collection form request failed",请先在菜单中录入账号:"Please enter your account in the menu first",请先在菜单中录入密码:"Please enter your password in the menu first","获取csrf-token失败":"Failed to obtain csrf token","正在登录中...":"Logging in...","登录失败，请在控制台查看原因":"Login failed, please check the reason in the console","登录成功，1s后自动跳转":"Login successful, automatically redirect after 1 second","登录失败，可能是账号/密码错误，请在控制台查看原因":"Login failed, possibly due to incorrect account/password. Please check the reason in the console","美化 历史版本 页面":"Beautify the historical version page",未找到history_versions元素列表:"History_versions element list not found","yyyy年MM月dd日 HH:mm:ss":"yyyy-MM-dd HH:mm:ss","美化 Greasyfork Beautify脚本":"Beautify Greasyfork Beauty Script","❌ 最多同时长传5张图":"❌ Upload up to 5 images simultaneously","❌ 图片：{{name}} 大小：{{size}}":"❌ Image:{{name}} Size:{{size}}","已过滤：{{oldCount}}":"Filtered:{{oldCount}}",寻找引用:"Find references",获取脚本id失败:"Failed to obtain script ID",收藏:"Collection",请先登录账号:"Please log in to your account first",获取用户id失败:"Failed to obtain user ID","获取收藏夹中...":"Get in favorites...",收藏集:"Collection","添加中...":"Adding...","添加失败，{{selector}}元素不存在":"Add failed, {{selector}} element does not exist","未找到{{selector}}元素":"{{selector}} element not found",添加失败:"Add failed",添加成功:"Successfully added","删除中...":"Deleting...",删除成功:"Delete successful",添加:"Add in deletion",刪除:"Delete","拦截跳转：":"Intercept jump:",今日检查:"Today's inspection",复制代码:"Copy Code","加载文件中...":"Loading files...",复制成功:"Copy successful","✅ 复制成功!":"✅ Copy successful!","当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}":"Current language: {{currentLocaleLanguage}}, switch to {{localeLanguage}} in 3 seconds","导航至：":"Navigation to:","请先登录账号！":"Please log in to your account first!","获取信息中，请稍后...":"Obtaining information, please wait...","获取成功，共 {{count}} 个":"Successfully obtained, a total of {{count}}","评分：":"Rating:","语言：":"Language:","版本：":"Version:","更新：":"Update:",同步代码:"Synchronize Code","同步中...":"Synchronizing...",手动:"Manual",自动:"Automatic","同步方式：{{syncMode}}":"Synchronization method: {{syncMode}}",同步成功:"Sync successful",同步失败:"Sync failed",该脚本未设置同步信息:"The script has not set synchronization information","上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载":"Last reload time {{time}}, rejected repeated reloads within {{timeout}} seconds","名称：":"Name:","进度：":"Progress:","未获取到【脚本列表】":"Unable to obtain [Script List]","源代码同步成功，3秒后更新下一个":"Source code synchronization successful, update next one in 3 seconds",全部更新失败:"All updates failed","全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}":"All updates completed<br>Success: {{successNums}}<br>Failure: {{failed Nums}}<br>Total: {{scriptUrlListLength}}","⚙ 设置":"⚙  Setting","{{SCRIPT_NAME}}-设置":"{{SCRIPT_NAME}}-Setting",美化页面元素:"Beautify page elements",美化历史版本页面:"Beautify the historical version page","美化Greasyfork Beautify脚本":"Beautify Greasyfork Beauty Script",获取表单csrfToken失败:"Failed to obtain form csrfToken",Toast配置:"Toast Config",Toast位置:"Toast position",左上角:"Top left",顶部:"Top",右上角:"Top right",左边:"Left",中间:"Center",右边:"Right",左下角:"Bottom left",底部:"Bottom",右下角:"Bottom right",Toast显示在页面九宫格的位置:"Toast is displayed in the nine grid position on the page",最多显示的数量:"Maximum number of displays",限制Toast显示的数量:"Limit the number of Toast displays",逆序弹出:"Reverse pop-up",修改Toast弹出的顺序:"Modify the order in which Toast pops up",该脚本已经在该收藏集中:"The script is already in this collection",其它错误:"Ohter Error",启用:"Enable",开启后下面的过滤功能才会生效:"The following filtering function will only take effect after it is enabled",屏蔽脚本:"Block script",点击查看规则:"Click to view rules",过滤:"Filter",代码同步:"Code synchronization",美化:"Beautify",修复代码行号显示:"Fix code line number display",修复代码行数超过1k行号显示不全问题:"Fix the problem that the code line number display is not complete when the number of lines exceeds 1k","添加【寻找引用】按钮":"Add the button to find references","在脚本栏添加按钮，一般用于搜索引用该库的相关脚本":"Add a button to the script bar, generally used to search for scripts that reference this library","添加【收藏】按钮":"Add the button to collect","在脚本栏添加按钮，一般用于快捷收藏该脚本/库":"Add a button to the script bar, generally used to quickly collect this script / library",修复图片宽度显示问题:" Fix the problem that the picture width display is not complete",修复图片在移动端宽度超出浏览器宽度问题:"Fix the problem that the picture width exceeds the browser width on mobile","添加【今日检查】信息块":"Add the block of information of today's inspection","在脚本信息栏添加【今日检查】信息块":"Add the block of information of today's inspection to the script information bar","给Markdown添加【复制】按钮":"Add the button to copy to Markdown","在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容":"Add the button to copy to the top right corner of the Markdown content, click to copy the Markdown content in one click",开启后下面的功能才会生效:"The following functions will only take effect after it is enabled",检测页面加载:"Detect page loading","检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面":"Detect whether the Greasyfork page is loaded normally. If the loading fails, the page will be automatically refreshed",检测间隔:"Detection interval","设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面":"Set the interval time for detecting the last refresh page. If the time since the last refresh page exceeds the set value, the page will no longer be refreshed",美化顶部导航栏:"Beautify the top navigation bar","可能会跟Greasyfork Beautify脚本有冲突":"Possible conflict with Greasymfork Beautify script",美化脚本列表:"Beautify Script List","双列显示且添加脚本卡片操作项（安装、收藏）":"Double column display and add script card operation items (installation, bookmarking)",操作面板:"Operation Panel","添加【操作面板】按钮":"Add [Operation Panel] button","在脚本列表页面时为顶部导航栏添加【操作面板】按钮":"Add an 'Operation Panel' button to the top navigation bar on the script list page",操作:"Operation",安装此脚本:"Install this script",脚本:"Scripts",历史版本:"Historical version",自定义已读颜色:"Customize read colors",在讨论内生效:"Effective within the discussion",用户:"Users",控制台:"Console","迁移【控制台】到顶部导航栏":"Migration of Console to Top Navigation Bar","将【控制台】按钮移动到顶部导航栏，节省空间":"Move the 'Console' button to the top navigation bar to save space",添加额外的标签按钮:"Add additional label button","在版本下面添加【安装】、【查看代码】按钮":"Add 【 Install 】 and 【 View Code 】 buttons under the version",查看代码:"View Code",添加快捷操作按钮:"Add shortcut operation button","在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效":"Add a 'Filter' button at the end of each discussion line. The filtering function needs to be enabled for it to take effect",选择需要过滤的选项:"Select the options that need to be filtered","确定{{type}}：{{filterId}}？":"Are you sure {{type}}：{{filterId}}？","该收藏集未包含：{{scriptId}}":"This collection does not include:{{scriptId}}",帮助文档:"Help document","请输入规则，每行一个":"Please enter a rule, one per line",选择过滤的选项:"Select filtering options","脚本id：{{text}}":"Script Id: {{text}}","脚本名：{{text}}":"Script Name: {{text}}","作者id：{{text}}":"Author Id: {{text}}","作者名：{{text}}":"Author Name: {{text}}","作用域：脚本、脚本搜索、用户主页":"Scope: Script, Script Search, User Homepage","更新到 {{version}} 版本":"Update To {{version}} Version","降级到 {{version}} 版本":"Downgrade to {{version}} Version","重新安装 {{version}} 版本":"Reinstall {{version}} Version","发布的用户id：{{text}}":"Published user ID: {{text}}",自定义快捷键:"Customize shortcut keys",点击录入快捷键:"Click on the input shortcut key",快捷键发表回复:"Shortcut key to post reply","在输入框内按下快捷发表回复，例如：{{key}}":"Press the shortcut to post a reply in the input box, for example: {{key}}",请先执行当前的录入操作:"Please perform the current input operation first",清空快捷键:"Clear shortcut keys","请按下快捷键...":"Please press the shortcut key...",成功录入:"Successful entry","快捷键 {{key}} 已被 {{isUsedKey}} 占用":"The shortcut key {{key}} is already used by {{isUsedKey}}",私聊:"Private Chat",美化私信页面:"Beautify the private message page",美化为左右对话模式:"Beautify as a left-right dialogue mode","最后回复：":"Final response:",进入:"Enter",记住回复内容:"Remember the reply content","监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复":"Monitor changes to the textarea content in the form and store it in the index database. Submitting the form will clear the saved data, and dynamic recovery can be achieved when the page is accidentally refreshed",表单:"Forms",自动清理空间:"Automatically clear space",不清理:"Not cleaning","{{value}} 天":"{{value}} day","{{value}} 周":"{{value}} weeks","{{value}} 个月":"{{value}} months",半年:"half a year",计算中:"In the process of calculation",根据设置的间隔时间自动清理保存的回复内容:"Automatically clean up saved reply content according to the set interval time","数据占用空间：{{size}}":"Data occupancy space: {{size}}",当前存储的数据所占用的空间大小:"The size of the space occupied by the currently stored data",清空:"Clear",清理成功:"Cleanup successful",清理失败:"Cleaning failed","Url To WebhookUrl":"Url To WebhookUrl",关闭:"Clsoe","例如：":"Example: ","结果：":"Result: ",转换前:"Before Parse",转换后:"Parse Result"},G="GM_Panel",me="data-init",X="data-key",ee="data-default-value",Ae="data-init-more-value",Ne=function(){let t=z(G,{})["setting-language"]||"zh-CN";n.init({lng:t,fallbackLng:"zh-CN",resources:{"zh-CN":{translation:{...Ue}},"en-US":{translation:{...$e}}}});};Ne();z(G,{});const Re=n.t("GreasyFork优化"),g=se.noConflict(),f=N.noConflict(),B=he,d=new g.Log(ie,A.console||_e.console);var fe;const ue=((fe=ie==null?void 0:ie.script)==null?void 0:fe.name)||Re,ge=!1;d.config({debug:ge,logMaxCount:1e3,autoClearConsole:!0,tag:!0});m.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return p.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return p.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return p.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let e=se.getMaxZIndex(),t=he.config.InstanceUtils.getPopsMaxZIndex(e).zIndex;return se.getMaxValue(e,t)+100}}}));const ye=new g.GM_Menu({GM_getValue:z,GM_setValue:q,GM_registerMenuCommand:Te,GM_unregisterMenuCommand:Me}),R=new g.Httpx(Ie);R.interceptors.response.use(void 0,e=>(d.error(["拦截器-请求错误",e]),e.type==="onabort"?m.warning(n.t("请求取消")):e.type==="onerror"?m.error(n.t("请求异常")):e.type==="ontimeout"?m.error(n.t("请求超时")):m.error(n.t("其它错误")),e));R.config({logDetails:ge});A.Object.defineProperty,A.Function.prototype.apply,A.Function.prototype.call,A.Element.prototype.appendChild,A.setTimeout;const te=g.addStyle.bind(g),J=function(e,t,r,i,o,a,s,l,c){return {text:e,type:"button",description:t,buttonIcon:i,buttonIsRightIcon:o,buttonIconIsLoading:a,buttonType:s,buttonText:r,callback(h){typeof l=="function"&&l(h);},afterAddToUListCallBack:c}},pe=function(e,t,r,i,o,a="",s,l){let c={text:e,type:"input",isNumber:!!s,isPassword:!!l,attributes:{},description:i,getValue(){return p.getValue(t,r)},callback(u,h){p.setValue(t,h);},placeholder:a};return c.attributes&&(c.attributes[X]=t,c.attributes[ee]=r),c},w=function(e,t,r,i,o){let a={text:e,type:"switch",description:o,attributes:{},getValue(){return !!p.getValue(t,r)},callback(s,l){d.success(`${l?"开启":"关闭"} ${e}`),p.setValue(t,!!l);},afterAddToUListCallBack:void 0};return a.attributes&&(a.attributes[X]=t,a.attributes[ee]=!!r),a},$={getSwitchLanguageUrl(e="zh-CN"){let t=window.location.origin,r=window.location.pathname.split("/");return r[1]=e,t=t+r.join("/"),t+=window.location.search,window.location.search===""?t+="?locale_override=1":window.location.search.includes("locale_override=1")||(t+="&locale_override=1"),t},async getScriptStats(e){return new Promise(async t=>{let r=await R.get({url:`https://greasyfork.org/scripts/${e}/stats.json`,fetch:!0,onerror(){},ontimeout(){}});if(!r.status){t(null);return}let i=r.data;t(i);})},async getSourceCodeSyncFormData(e){let t=await R.get(`https://greasyfork.org/zh-CN/scripts/${e}/admin`,{fetch:!0});if(d.success(t),!t.status){m.error(n.t("请求admin内容失败"));return}let r=t.data.responseText,o=f.parseHTML(r,!1,!0).querySelector("form.edit_script");if(!o){m.error(n.t("解析admin的源代码同步表单失败"));return}return new FormData(o)},async sourceCodeSync(e,t){let r=await R.post(`https://greasyfork.org/zh-CN/scripts/${e}/sync_update`,{fetch:!0,data:t});if(d.success(r),!r.status){m.error(n.t("源代码同步失败"));return}return r},async getUserInfo(e){let t=await R.get(`https://greasyfork.org/zh-CN/users/${e}.json`,{fetch:!0});if(d.success(t),!t.status){m.error(n.t("获取用户信息失败"));return}let r=g.toJSON(t.data.responseText);return r.scriptList=[],r.scriptLibraryList=[],r.scripts.forEach(i=>{i.code_url.endsWith(".user.js")?r.scriptList.push(i):r.scriptLibraryList.push(i);}),r},async getUserCollection(e){let t=await R.get(`https://greasyfork.org/zh-CN/users/${e}`,{fetch:!0});if(d.info(["获取用户的收藏集",t]),!t.status){m.error(n.t("获取用户的收藏集失败"));return}let r=t.data.responseText,o=f.parseHTML(r,!0,!0).querySelector("#user-script-sets");if(!o){d.error("解析Script Sets失败");return}let a=[];return o.querySelectorAll("li").forEach(s=>{var y;let l=s.querySelector("a:last-child");if(!l)return;let c=l.href;if(c.includes("?fav=1"))return;let u=s.querySelector("a").innerText,h=(y=c.match(/\/sets\/([\d]+)\//))==null?void 0:y[1];a.push({id:h,name:u});}),a},async getUserCollectionInfo(e,t){let r=await R.get(`https://greasyfork.org/zh-CN/users/${e}/sets/${t}/edit`,{fetch:!0});if(!r.status){m.error(n.t("获取收藏集{{setsId}}失败",{setsId:t}));return}let i=r.data.responseText,o=f.parseHTML(i,!0,!0),a=o.querySelector('form[id^="edit_script_set"]');if(!a){m.error(n.t("获取表单元素#edit_script_set失败"));return}let s=new FormData(a),l=o.querySelector('meta[name="csrf-token"]');if(!l){m.error(n.t("获取表单csrfToken失败"));return}if(l.hasAttribute("content")){let c=l.getAttribute("content");c&&s.set("authenticity_token",c);}return s},async updateUserSetsInfo(e,t,r){let i=await R.post(`https://greasyfork.org/zh-CN/users/${e}/sets/${t}`,{fetch:!0,headers:{accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","cache-control":"no-cache","content-type":"application/x-www-form-urlencoded",pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:r});if(!i.status){m.error(n.t("更新收藏集表单请求失败"));return}let o=i.data.responseText;return f.parseHTML(o,!0,!0)},async switchLanguage(e){let t=await R.get(e,{fetch:!0,headers:{"Upgrade-Insecure-Requests":"1"}});t.status&&d.info(t);}},T={isCode(){var e;return !!((e=window.location.pathname.split("/"))!=null&&e.includes("code"))},isCodeStrict(){return !!window.location.pathname.endsWith("/code")},isVersion(){return !!window.location.pathname.endsWith("/versions")},isUsers(){return !!window.location.pathname.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!window.location.pathname.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!window.location.pathname.match(/\/conversations\/[\d]+/)},isScript(){return !!window.location.pathname.includes("/scripts/")},isScriptList(){return !!window.location.pathname.endsWith("/scripts")},isScriptsBySite(){return !!window.location.pathname.match("/scripts/by-site")},isScriptLibraryList(){return !!window.location.pathname.endsWith("/libraries")},isScriptCodeSearch(){return !!window.location.pathname.endsWith("/code-search")},isDiscuessions(){return !!window.location.pathname.endsWith("/discussions")}},L={getInstallUrl(e,t,r){return g.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${e}/${t}${r}.user.js`},getCodeUrl(e,t){return g.isNull(t)&&(t=""),`https://greasyfork.org/scripts/${e}/code?version=${t}`},getCodeSearchUrl(e){return "https://greasyfork.org/zh-CN/scripts/code-search?c="+e},getScriptInfoUrl(e){return `https://greasyfork.org/scripts/${e}.json`},getAdminUrl(e){return e+"/admin"},getScriptId(e){var t,r;return (r=(t=e||window.location.pathname)==null?void 0:t.match(/\/scripts\/([\d]+)/i))==null?void 0:r[1]},getUserId(e){var t;return (t=(e||window.location.pathname).match(/\/users\/([\d]+)/i))==null?void 0:t[1]},getScriptName(e){let t=window.location.pathname;e!=null&&(t=new URL(e).pathname),t=decodeURIComponent(t);let r=t.split("/");for(const i of r){let o=i.match(/[\d]+/);if(o&&o.length)return o[1]}},getSwitchLanguageUrl(e="zh-CN"){let t=window.location.origin,r=window.location.pathname.split("/");return r[1]=e,t=t+r.join("/"),t+=window.location.search,window.location.search===""?t+="?locale_override=1":window.location.search.includes("locale_override=1")||(t+="&locale_override=1"),t}},C={menu:ye,isLogin:!1,initEnv(){let e=this.getUserLinkElement();this.isLogin=!!e;},getUserLinkElement(){return document.querySelector("#nav-user-info span.user-profile-link a")},async updateScript(e){let t=function(r,i=1){return `
			...
			</div>`};if(g.isNull(e))m.error(n.t("未获取到【脚本列表】"));else {let r=m.loading(t(L.getScriptName(e[0])),{html:!0}),i=0,o=0;for(let a=0;a<e.length;a++){let s=e[a],l=L.getScriptId(s);d.success("更新："+s);let c=L.getScriptName(s);r.setHTML(t(c,a+1));let u=await $.getSourceCodeSyncFormData(l);u?await $.sourceCodeSync(l,u)?(m.success(n.t("源代码同步成功，3秒后更新下一个")),await g.sleep(3e3),i++):(m.error(n.t("源代码同步失败")),o++):(m.error(n.t("源代码同步失败")),o++);}r.close(),i===0?m.error(n.t("全部更新失败")):m.success(n.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:i,failedNums:o,scriptUrlListLength:e.length}),{html:!0});}},handleLocalGotoCallBack(){if(p.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(p.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!T.isUsers()){p.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),C.getUserLinkElement()?(m.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):m.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(t=>{e=e.concat(L.getAdminUrl(t.href));}),C.updateScript(e);}else if(p.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(p.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!T.isUsers()){p.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),C.getUserLinkElement()?(m.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):m.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(t=>{e=e.concat(L.getAdminUrl(t.href));}),C.updateScript(e);}else if(p.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(p.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!T.isUsers()){p.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),C.getUserLinkElement()?(m.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):m.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(t=>{e=e.concat(L.getAdminUrl(t.href));}),C.updateScript(e);}}},K=function(e,t,r,i,o,a){let s=[];typeof i=="function"?s=i():s=i;let l={text:e,type:"select",description:a,attributes:{},getValue(){return p.getValue(t,r)},callback(c,u,h){p.setValue(t,u),typeof o=="function"&&o(c,u,h);},data:s};return l.attributes&&(l.attributes[X]=t,l.attributes[ee]=r),l},Be=function(e,t,r,i,o,a="default",s){let l=typeof o=="function"?o():o;typeof i=="object"&&s.initConfig(r,i);let c=()=>s.getShowText(r,l),u=J(e,t,c,"keyboard",!1,!1,a,async h=>{var x;let b=(x=h.target.closest(".pops-panel-button"))==null?void 0:x.querySelector("span");if(s.isWaitPress){m.warning(n.t("请先执行当前的录入操作"));return}if(s.hasOptionValue(r))s.emptyOption(r),m.success(n.t("清空快捷键"));else {let S=m.loading(n.t("请按下快捷键..."),{showClose:!0}),{status:I,option:_,key:k}=await s.enterShortcutKeys(r);S.close(),I?(d.success(["成功录入快捷键",_]),m.success(n.t("成功录入"))):m.error(n.t("快捷键 {{key}} 已被 {{isUsedKey}} 占用",{key:s.translateKeyboardValueToButtonText(_),isUsedKey:k}));}b.innerHTML=c();});return u.attributes={},Reflect.set(u.attributes,me,()=>!1),u};class Ve{constructor(t){oe(this,"key","short-cut");oe(this,"isWaitPress",!1);typeof t=="string"&&(this.key=t);}initConfig(t,r){this.hasOption(t)||this.setOption(t,r);}getStorageKey(){return this.key}getLocalAllOptions(){return z(this.key,[])}hasOption(t){return !!this.getLocalAllOptions().find(o=>o.key===t)}hasOptionValue(t){if(this.hasOption(t)){let r=this.getOption(t);return (r==null?void 0:r.value)!=null}else return !1}getOption(t,r){return this.getLocalAllOptions().find(a=>a.key===t)??r}setOption(t,r){let i=this.getLocalAllOptions(),o=i.findIndex(a=>a.key===t);o==-1?i.push({key:t,value:r}):Reflect.set(i[o],"value",r),q(this.key,i);}emptyOption(t){let r=!1,i=this.getLocalAllOptions(),o=i.findIndex(a=>a.key===t);return o!==-1&&(i[o].value=null,r=!0),q(this.key,i),r}deleteOption(t){let r=!1,i=this.getLocalAllOptions(),o=i.findIndex(a=>a.key===t);return o!==-1&&(i.splice(o,1),r=!0),q(this.key,i),r}translateKeyboardValueToButtonText(t){let r="";return t.ohterCodeList.forEach(i=>{r+=g.stringTitleToUpperCase(i,!0)+" + ";}),r+=g.stringTitleToUpperCase(t.keyName),r}getShowText(t,r){if(this.hasOption(t)){let i=this.getOption(t);return i.value==null?r:this.translateKeyboardValueToButtonText(i.value)}else return r}async enterShortcutKeys(t){return new Promise(r=>{this.isWaitPress=!0;let i=f.listenKeyboard(window,"keyup",(o,a,s)=>{const l={keyName:o,keyValue:a,ohterCodeList:s},c=JSON.stringify(l),u=this.getLocalAllOptions();for(let h=0;h<u.length;h++){let y=u[h];if(y.key===t)continue;const b=JSON.stringify(y.value);let x=!1;if(y.value!=null&&c===b&&(x=!0),x){this.isWaitPress=!1,i.removeListen(),r({status:!1,key:y.key,option:l});return}}this.setOption(t,l),this.isWaitPress=!1,i.removeListen(),r({status:!0,key:t,option:l});});})}initGlobalKeyboardListener(t){let r=this.getLocalAllOptions();if(!r.length){d.warn("没有设置快捷键");return}let i=this;function o(l,c){f.listenKeyboard(l,"keydown",(u,h,y)=>{if(i.isWaitPress)return;r=i.getLocalAllOptions();let b=r.findIndex(x=>{let S=x.value,I={keyName:u,keyValue:h,ohterCodeList:y};if(JSON.stringify(S)===JSON.stringify(I))return x});if(b!=-1){let x=r[b];d.info(["调用快捷键",x]),x.key in c&&c[x.key].callback();}});}let a={},s={};Object.keys(t).forEach(l=>{let c=t[l];(c.target==null||typeof c.target=="string"&&c.target==="")&&(c.target="window"),c.target==="window"?Reflect.set(a,l,c):Reflect.set(s,l,c);}),o(window,a),f.ready(()=>{Object.keys(s).forEach(async l=>{let c=s[l];if(typeof c.target=="string")g.waitNode(c.target,1e4).then(u=>{if(!u)return;let h={};Reflect.set(h,l,c),o(u,h);});else if(typeof c.target=="function"){let u=await c.target();if(u==null)return;let h={};Reflect.set(h,l,c),o(u,h);}else {let u={};Reflect.set(u,l,c),o(c.target,u);}});});}}const be={shortCut:new Ve,shortOption:{"gf-quickReply":{target:()=>{let e=document.querySelector("form textarea"),t=document.querySelector('input[name="commit"][type="submit"]');if(e){if(!t){d.error("页面不存在【发表回复】按钮");return}}else {d.error("页面不存在输入框");return}return d.success("监听快捷键：gf-quickReply"),e},callback(){if(document.activeElement){let e=document.activeElement.closest("form");if(!e){d.error("当前activeElement不在表单内，无法触发快捷键");return}let t=e.querySelectorAll('input[name="commit"][type="submit"]');if(!t.length){d.error("表单内不存在【发表回复】按钮");return}t.length>1&&d.warn("表单内存在多个【发表回复】按钮，只触发第一个"),t[0].click();}else d.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},ce={$key:{DB_KEY:"data"},$data:{db:null},init(){this.$data.db=this.getDB(),p.execMenuOnce("rememberReplyContent",()=>{this.rememberReplyContent();}),p.execMenu("gf-autoClearRememberReplayContent",e=>{this.autoClearRememberReplayContent(e);});},getDB(){const e="reply_record",t="textarea_text";return new g.indexedDB(e,t,2)},async rememberReplyContent(){const e="记住回复内容 -- ";let t=document.querySelectorAll("form");if(!t.length){d.warn(e+"不存在表单");return}try{await this.clearRelayHistoryRememberContentText();}catch(r){d.error(r);}t.forEach(async r=>{let i=r.querySelector("textarea"),o=r.querySelector('input[type="submit"]');i&&o&&(d.success(["开始监听form --- 记住回复内容",r]),this.$data.db.get(this.$key.DB_KEY).then(a=>{if(!a.success)return;let s=a.data.findIndex(c=>this.checkUrlIsSame(window.location.href,c.url));if(s==-1)return;let l=a.data[s].text;d.success("填入历史输入内容："+l),i.value=l;}),f.on(i,["propertychange","input"],g.debounce(a=>{let s={url:window.location.href,text:i.value,time:Date.now()};this.$data.db.get(this.$key.DB_KEY).then(l=>{if(!l.success&&l.event&&l.event.type!=="success"){d.warn(l);return}l.data==null&&(l.data=[]);let c=l.data.findIndex(u=>this.checkUrlIsSame(window.location.href,u.url));c!==-1?g.isNull(s.text)?l.data.splice(c,1):l.data[c]=g.assign(l.data[c],s):l.data=l.data.concat(s),this.$data.db.save(this.$key.DB_KEY,l.data).then(u=>{u.success||d.error(["保存失败",u]);});});},25)),f.on(r,"submit",a=>{d.info("表单提交，刷新页面后清理内容："+window.location.href),q("delyClear_rememberReplyContent_url",window.location.href);},{capture:!0}));});},async clearRelayHistoryRememberContentText(){const e="delyClear_rememberReplyContent_url";let t=z(e);if(t){let r=await this.$data.db.get(this.$key.DB_KEY);if(!r.success){d.info("表单记录：数据库是空的");return}let i=r.data.findIndex(a=>this.checkUrlIsSame(t,a.url));if(i==-1){d.info("表单记录：已不存在该数据"),de(e);return}r.data.splice(i,1),(await this.$data.db.save(this.$key.DB_KEY,r.data)).success?(d.success("表单记录：成功清除"),de(e)):d.error(["表单记录：清除失败",r]);}},checkUrlIsSame(e,t){let r=new URL(e),i=new URL(t);return r.origin===i.origin&&r.pathname===i.pathname},autoClearRememberReplayContent(e){const t="gf-last-time-autoClearRememberReplayContent";let r=z(t),i=e*24*60*60*1e3;if(r)if(Date.now()-r>i)q(t,Date.now());else return;q(t,Date.now());},async getAllRememberReplyContent(){return (await this.$data.db.get(this.$key.DB_KEY)).data??[]},async clearAllRememberReplyContent(){return (await this.$data.db.delete(this.$key.DB_KEY)).success}},ze={id:"greasy-fork-panel-config-account",title:n.t("通用"),forms:[{text:"",type:"forms",forms:[{text:n.t("Toast配置"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[K(n.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:n.t("左上角")},{value:"top",text:n.t("顶部")},{value:"topright",text:n.t("右上角")},{value:"left",text:n.t("左边")},{value:"center",text:n.t("中间")},{value:"right",text:n.t("右边")},{value:"bottomleft",text:n.t("左下角")},{value:"bottom",text:n.t("底部")},{value:"bottomright",text:n.t("右下角")}],(e,t,r)=>{d.info("设置当前Qmsg弹出位置"+r);},n.t("Toast显示在页面九宫格的位置")),K(n.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,n.t("限制Toast显示的数量")),w(n.t("逆序弹出"),"qmsg-config-showreverse",!1,void 0,n.t("修改Toast弹出的顺序"))]}]},K(n.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(e,t,r)=>{d.info("改变语言："+r),n.changeLanguage(t);})]},{text:"",type:"forms",forms:[{text:n.t("账号/密码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[pe(n.t("账号"),"user","",void 0,void 0,n.t("请输入账号")),pe(n.t("密码"),"pwd","",void 0,void 0,n.t("请输入密码"),!1,!0)]},{text:"",type:"forms",forms:[w(n.t("自动登录"),"autoLogin",!0,void 0,n.t("自动登录当前保存的账号")),J(n.t("清空账号/密码"),void 0,n.t("点击清空"),void 0,void 0,!1,"default",e=>{if(confirm(n.t("确定清空账号和密码？"))){p.deleteValue("user"),p.deleteValue("pwd"),m.success(n.t("已清空账号/密码"));let t=e.target.getRootNode();t.querySelector('li[data-key="user"] .pops-panel-input input').value="",t.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}})]}]},{text:n.t("功能"),type:"deepMenu",forms:[{text:n.t("功能"),type:"forms",forms:[K(n.t("固定当前语言"),"language-selector-locale","",function(){let e=[{value:"",text:n.t("无")}];return document.querySelectorAll("select#language-selector-locale option").forEach(t=>{let r=t.getAttribute("value");if(r==="help")return;let i=(t.innerText||t.textContent).trim();e.push({value:r,text:i});}),e}()),w(n.t("修复图片宽度显示问题"),"fixImageWidth",!0,void 0,n.t("修复图片在移动端宽度超出浏览器宽度问题")),w(n.t("优化图片浏览"),"optimizeImageBrowsing",!0,void 0,n.t("使用Viewer浏览图片")),w(n.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",!0,void 0,n.t("配合上面的【优化图片浏览】更优雅浏览图片")),w(n.t("添加【操作面板】按钮"),"scripts-addOperationPanelBtnWithNavigator",!0,void 0,n.t("在脚本列表页面时为顶部导航栏添加【操作面板】按钮")),w(n.t("给Markdown添加【复制】按钮"),"addMarkdownCopyButton",!0,void 0,n.t("在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容"))]},{text:n.t("检测页面加载"),type:"forms",forms:[w(n.t("启用"),"checkPage",!0,void 0,n.t("检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面")),K(n.t("检测间隔"),"greasyfork-check-page-timeout",5,(()=>{let e=[];for(let t=0;t<5;t++)e.push({value:t+1,text:t+1+"s"});return e})(),void 0,n.t("设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面"))]},{text:n.t("代码同步"),type:"forms",forms:[J(n.t("源代码同步【脚本列表】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",e=>{if(!T.isUsers()){p.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),C.getUserLinkElement()?(m.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):m.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(r=>{t=t.concat(L.getAdminUrl(r.href));}),C.updateScript(t);}),J(n.t("源代码同步【未上架的脚本】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",e=>{if(!T.isUsers()){p.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),C.getUserLinkElement()?(m.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):m.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(r=>{t=t.concat(L.getAdminUrl(r.href));}),C.updateScript(t);}),J(n.t("源代码同步【库】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",e=>{if(!T.isUsers()){p.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),C.getUserLinkElement()?(m.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):m.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(r=>{t=t.concat(L.getAdminUrl(r.href));}),C.updateScript(t);})]}]},{type:"deepMenu",text:n.t("表单"),forms:[{type:"forms",text:"",forms:[w(n.t("记住回复内容"),"rememberReplyContent",!0,void 0,n.t("监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复")),K(n.t("自动清理空间"),"gf-autoClearRememberReplayContent",7,[{text:n.t("不清理"),value:-1},{text:n.t("{{value}} 天",{value:1}),value:1},{text:n.t("{{value}} 周",{value:1}),value:7},{text:n.t("{{value}} 个月",{value:1}),value:30},{text:n.t("{{value}} 个月",{value:2}),value:60},{text:n.t("{{value}} 个月",{value:3}),value:90},{text:n.t("半年"),value:180}],void 0,n.t("根据设置的间隔时间自动清理保存的回复内容")),J(n.t("数据占用空间：{{size}}",{size:n.t("计算中")}),n.t("当前存储的数据所占用的空间大小"),n.t("清空"),void 0,void 0,void 0,"default",async()=>{await ce.clearAllRememberReplyContent()?m.success(n.t("清理成功")):m.error(n.t("清理失败"));},async(e,t)=>{let r=t.ulElement.querySelector('li[data-key="gf-autoClearRememberReplayContent"]+li .pops-panel-item-left-main-text'),i=await ce.getAllRememberReplyContent(),o="";i.length?o=g.getTextStorageSize(JSON.stringify(i)):o=g.getTextStorageSize(""),r.innerText=n.t("数据占用空间：{{size}}",{size:o});})]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化页面元素"),"beautifyPage",!0,void 0,n.t("如button、input、textarea")),w(n.t("美化上传图片按钮"),"beautifyUploadImage",!0,void 0,n.t("放大上传区域")),w(n.t("美化顶部导航栏"),"beautifyTopNavigationBar",!0,void 0,n.t("可能会跟Greasyfork Beautify脚本有冲突")),w(n.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",!0,void 0,n.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]}]},{type:"deepMenu",text:n.t("自定义快捷键"),forms:[{type:"forms",text:"",forms:[Be(n.t("快捷键发表回复"),n.t("在输入框内按下快捷发表回复，例如：{{key}}",{key:"Ctrl + Enter"}),"gf-quickReply",{keyName:"Enter",keyValue:"13",ohterCodeList:["ctrl"]},n.t("点击录入快捷键"),void 0,be.shortCut)]}]}]}]},qe={init(){p.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();});},repairCodeLineNumber(){d.info("修复代码的行号显示不够问题"),p.execMenuOnce("beautifyGreasyforkBeautify",()=>{v(`
				.code-container pre code .marker{
					padding-left: 6px;
				}	
				`);}),g.waitNode("#script-content div.code-container pre.prettyprint ol").then(e=>{e.childElementCount>=1e3&&(d.success(`当前代码行数${e.childElementCount}行，超过1000行，优化行号显示问题`),v(`
                    pre.prettyprint{
                        padding-left: 26px;
                    }
...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof le=="function"?le(e.keyName):"";typeof t=="string"&&t?te(t):re.addLinkNode(e.url);},async addLinkNode(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,f.ready(()=>{document.head.appendChild(t);}),t},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e}},Oe={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){d.info("美化 历史版本 页面");let e=[];return e.push(v(De)),e.push(re.addBlockCSS(".version-number",".version-date",".version-changelog")),f.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){m.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var h,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(h=r.querySelector(".version-date"))==null?void 0:h.getAttribute("datetime"),s=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=f.createElement("span",{className:"script-version-date",innerHTML:g.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),c=f.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),u=f.createElement("div",{className:"script-note-box-body",innerHTML:s});r.appendChild(l),r.appendChild(c),r.appendChild(u);});}),e},addExtraTagButton(){d.info("添加额外的标签按钮"),f.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(e=>{var u,h;let t=e.querySelector("a");if(!t)return;let r=new URL(t.href),i=(u=r.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:u[1],o=r.searchParams.get("version"),a=(h=r.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:h[1],s=L.getInstallUrl(i,o,a),l=L.getCodeUrl(i,o),c=f.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});f.after(e,c);});});}};let ne=[];const xe=async function(e){if(d.info("当前脚本id："+e),!C.isLogin){d.error("请先登录账号"),m.error(n.t("请先登录账号"));return}let t=L.getUserId(C.getUserLinkElement().href);if(t==null){d.error("获取用户id失败"),m.error(n.t("获取用户id失败"));return}if(!ne.length){let o=m.loading(n.t("获取收藏夹中..."));if(ne=await $.getUserCollection(t)||[],o.close(),!ne.length)return}let r="";ne.forEach(o=>{r+=`
		<li class="user-collect-item" data-id="${o.id}" data-name="${o.name}">
		  ...
		  `;});let i=B.alert({title:{text:n.t("收藏集"),position:"center"},content:{html:!0,text:`<ul>${r}</ul>`},mask:{enable:!0,clickEvent:{toClose:!0}},btn:{ok:{enable:!1}},width:B.isPhone()?"92vw":"500px",height:"auto",drag:!0,only:!0,style:`
		.pops{
		...
		`});f.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=m.loading(n.t("添加中...")),c=await $.getUserCollectionInfo(t,s);if(!c){l.close();return}let u=g.cloneFormData(c),h=g.cloneFormData(c),y=!1;for(const[M,E]of c.entries())if(M==="scripts-included[]"&&String(E).trim()===String(e).trim()){y=!0;break}else h.append(M,E),u.append(M,E);if(y){m.warning(n.t("该脚本已经在该收藏集中")),l.close();return}u.set("add-script",e.toString()),u.set("script-action","i"),h.append("scripts-included[]",e.toString()),h.set("save","1");let b=new URLSearchParams(u),x=new URLSearchParams(h),S=Array.from(b).map(([M,E])=>`${encodeURIComponent(M)}=${encodeURIComponent(E)}`).join("&"),I=Array.from(x).map(([M,E])=>`${encodeURIComponent(M)}=${encodeURIComponent(E)}`).join("&");d.info(["添加的数据",S]),d.info(["保存的数据",I]);let _=await $.updateUserSetsInfo(t,s,S);if(!_){l.close();return}let k=_.querySelector(".change-script-set");if(!k){m.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let U=k.querySelector("section");if(!U){m.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let D=U.querySelector(".alert");D?B.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:D.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					.pops-alert-content{
						font-style: italic;
					...
					`,drag:!0,dragLimit:!0,width:B.isPhone()?"88vw":"400px",height:B.isPhone()?"50vh":"300px"}):(await $.updateUserSetsInfo(t,s,I),m.success(n.t("添加成功"))),l.close();}),f.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=m.loading(n.t("删除中...")),c=await $.getUserCollectionInfo(t,s);if(!c){l.close();return}let u=new FormData,h=new FormData,y=!1;for(const[k,U]of c.entries()){if(String(k).trim()==="scripts-included[]"&&String(U).trim()===String(e).trim()){y=!0;continue}h.append(k,U),u.append(k,U);}if(!y){m.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:e})),l.close();return}u.set("remove-scripts-included[]",e.toString()),u.set("remove-selected-scripts","i"),u.delete("script-action"),h.set("save","1");let b=new URLSearchParams(u),x=new URLSearchParams(h),S=Array.from(b).map(([k,U])=>`${encodeURIComponent(k)}=${encodeURIComponent(U)}`).join("&"),I=Array.from(x).map(([k,U])=>`${encodeURIComponent(k)}=${encodeURIComponent(U)}`).join("&");if(d.info(["删除的数据",S]),d.info(["保存的数据",I]),!await $.updateUserSetsInfo(t,s,S)){l.close();return}await $.updateUserSetsInfo(t,s,I),m.success(n.t("删除成功")),l.close();});},Pe={init(){T.isCode()?qe.init():T.isVersion()&&Oe.init(),T.isCodeStrict()&&(p.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),p.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),p.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),p.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),p.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){d.info("添加收藏按钮"),g.waitNode("ul#script-links li.current span").then(()=>{let e=f.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});f.append(document.querySelector("ul#script-links"),e),f.on(e,"click",()=>{let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){d.error([t,window.location.pathname]),m.error(n.t("获取脚本id失败"));return}let r=t[t.length-1];xe(r);});});},fullScreenOptimization(){d.info("F11全屏，F键代码全屏"),v(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
        ...
        `);let e=!1;f.keydown(A,function(t){if(t.key.toLowerCase()==="f"){let r=document.querySelector("#script-content div.code-container code");t.altKey&&t.shiftKey?(g.preventEvent(t),r.classList.contains("code-wide-screen")?r.classList.remove("code-wide-screen"):r.classList.add("code-wide-screen")):!t.altKey&&!t.ctrlKey&&!t.shiftKey&&!t.metaKey&&(g.preventEvent(t),e?(g.exitFullScreen(r),e=!1):(g.enterFullScreen(r),e=!0));}},{capture:!0});},setFindCodeSearchBtn(){d.info("设置代码搜索按钮(对于库)"),g.waitNode("ul#script-links li.current span").then(()=>{let e=f.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("寻找引用")}</span>
					</a>`});f.append(document.querySelector("ul#script-links"),e),f.on(e,"click",async function(){let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){d.error([t,window.location.pathname]),m.error(n.t("获取脚本id失败"));return}let r=t[t.length-1];window.location.href=L.getCodeSearchUrl(`greasyfork.org/scripts/${r}`);});});},async scriptHomepageAddedTodaySUpdate(){if(!document.querySelector("#install-area"))return;d.info("脚本首页新增【今日检查】");let e=await $.getScriptStats(L.getScriptId());if(!e)return;let t=g.toJSON(e.responseText);d.info(["统计信息",t]);let r=t[g.formatTime(void 0,"yyyy-MM-dd")];if(!r){d.error("今日份的统计信息不存在");return}let i=r.update_checks;d.info(["今日统计信息",r]),f.after("dd.script-show-daily-installs",f.createElement("dt",{className:"script-show-daily-update_checks",innerHTML:`<span>${n.t("今日检查")}</span>`})),f.after("dt.script-show-daily-update_checks",f.createElement("dd",{className:"script-show-daily-update_checks",innerHTML:"<span>"+i+"</span>"}));},addCopyCodeButton(){d.info("添加复制代码按钮"),g.waitNode("div#script-content div.code-container").then(e=>{let t=f.createElement("button",{textContent:n.t("复制代码")},{style:"margin-bottom: 1em;"});f.on(t,"click",async function(){let r=m.loading(n.t("加载文件中...")),i=await R.get(`https://greasyfork.org/zh-CN/scripts/${L.getScriptId()}.json`,{fetch:!0,responseType:"json"});if(!i.status){r.close();return}let a=g.toJSON(i.data.responseText).code_url;d.success(["代码地址：",a]);let s=await R.get(a);if(!s.status){r.close();return}r.close(),g.setClip(s.data.responseText),m.success(n.t("复制成功"));}),f.before(e,t);});}},Ge=`.sidebarred-main-content {\r
	max-width: unset;\r
	flex: unset;\r
}\r
ol.script-list {\r
...
`,ae={getTampermonkey:()=>{var e;return (e=A.external)==null?void 0:e.Tampermonkey},getViolentmonkey:()=>{var e;return (e=A.external)==null?void 0:e.Violentmonkey},getScriptCat:()=>{var e;return (e=A.external)==null?void 0:e.Scriptcat},getScriptContainerStatus(){var t,r,i;let e={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (t=A.external)!=null&&t.Tampermonkey&&(e.Tampermonkey=!0),(r=A.external)!=null&&r.Violentmonkey&&(e.Violentmonkey=!0),(i=A.external)!=null&&i.Scriptcat&&(e.ScriptCat=!0),e},getInstalledVersion(e,t){return new Promise((r,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(r);return}const s=this.getScriptCat();if(s){s.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const r=e.split("."),i=t.split(".");for(let o=0;o<r.length;o++){const a=this.compareVersionPart(r[o],i[o]);if(a!==0)return a}return 0},compareVersionPart(e,t){const r=this.parseVersionPart(e),i=this.parseVersionPart(t);for(let o=0;o<r.length;o++){if(r[o].length>0&&i[o].length===0)return -1;if(r[o].length===0&&i[o].length>0||r[o]>i[o])return 1;if(r[o]<i[o])return -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,r){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,r)){case-1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const r=e.getAttribute("data-script-name"),i=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(r,i);return a==null?!1:(this.handleInstallResult(e,a,o),!0)}catch{if(t){await g.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return !1}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),r=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:r,url:location.href},location.origin);}},we=e=>{let t=e.dataset;const r={scriptId:parseInt(t.scriptId),scriptName:t.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(t.scriptDailyInstalls),scriptTotalInstalls:parseInt(t.scriptTotalInstalls),scriptRatingScore:parseFloat(t.scriptRatingScore),scriptCreatedDate:new Date(t.scriptCreatedDate),scriptUpdatedDate:new Date(t.scriptUpdatedDate),scriptType:t.scriptType,scriptVersion:t.scriptVersion,sensitive:t.sensitive==="true",scriptLanguage:t.scriptLanguage,cssAvailableAsJs:t.cssAvailableAsJs==="true",codeUrl:t.codeUrl,scriptDescription:t.scriptDescription,scriptAuthorId:parseInt(t.scriptAuthorId),scriptAuthorName:t.scriptAuthorName};let i=g.toJSON(t.scriptAuthors);if(Object.keys(i).forEach(o=>{let a=i[o];r.scriptAuthors.push({authorId:parseInt(o),authorName:a});}),(r.scriptAuthorName==null||isNaN(r.scriptAuthorId))&&r.scriptAuthors.length&&(r.scriptAuthorName=r.scriptAuthors[0].authorName,r.scriptAuthorId=r.scriptAuthors[0].authorId),r.scriptDescription==null){let o=e.querySelector(".script-description")||e.querySelector(".description");o&&(r.scriptDescription=o.innerText||o.textContent);}return r},ve={init(){p.execMenuOnce("gf-scripts-filter-enable",()=>{j.init();}),p.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){d.info("美化脚本列表");let e=[];return e.push(te(Ge)),N.ready(async()=>{j.getElementList().forEach(a=>{if(a.querySelector(".script-list-operation"))return;let s=we(a),l=a.querySelector(".inline-script-stats"),c=s.codeUrl,u=N.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${n.t("评分")}</span>`}),h=N.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${s.scriptRatingScore}</span>`},{"data-position":"right"}),y=a.querySelector("dd.script-list-ratings .good-rating-count"),b=a.querySelector("dd.script-list-ratings .ok-rating-count"),x=a.querySelector("dd.script-list-ratings .bad-rating-count");if(y&&b&&x){let M=parseInt(y.innerText),E=parseInt(b.innerText),V=parseInt(x.innerText),O=M+E+V;O>=10?M/O>=.6?h.classList.add("good-rating-count"):h.classList.add("bad-rating-count"):O==0||M>E+V?h.classList.add("good-rating-count"):h.classList.add("bad-rating-count");}let S=N.createElement("dt",{className:"script-list-version",innerHTML:`<span>${n.t("版本")}</span>`}),I=N.createElement("dd",{className:"script-list-version",innerHTML:`<span>${s.scriptVersion}</span>`},{"data-position":"right"}),_=N.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${n.t("操作")}</span>`}),k=N.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),U=k.querySelector(".script-collect-btn"),D=k.querySelector(".install-link");if(D["data-script-info"]=s,D.classList.add("lum-lightbox-loader"),s.scriptType==="library"&&D.remove(),N.on(U,"click",M=>{g.preventEvent(M),xe(s.scriptId);}),p.getValue("gf-scripts-filter-enable")){let M=N.createElement("button",{className:"script-filter-btn",innerHTML:n.t("过滤")}),E="data-filter-key",V="data-filter-value";N.on(M,"click",O=>{g.preventEvent(O);let P=B.alert({title:{text:n.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${E}="scriptId" ${V}="^${s.scriptId}$">${n.t("脚本id：{{text}}",{text:s.scriptId})}</button>
									<button ${E}="scriptName" ${V}="^${g.parseStringToRegExpString(s.scriptName)}$">${n.t("脚本名：{{text}}",{text:s.scriptName})}</button>
								...
								`}),Z=P.$shadowRoot.querySelector(".pops-alert-content");s.scriptAuthors.forEach(F=>{let W=N.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:F.authorId})});W.setAttribute(E,"scriptAuthorId"),W.setAttribute(V,"^"+F.authorId+"$");let Q=N.createElement("button",{innerHTML:n.t("作者名：{{text}}",{text:F.authorName})});Q.setAttribute(E,"scriptAuthorName"),Q.setAttribute(V,"^"+g.parseStringToRegExpString(F.authorName)+"$"),Z.appendChild(W),Z.appendChild(Q);}),N.on(P.$shadowRoot,"click",`button[${E}]`,F=>{g.preventEvent(F);let W=F.target,Q=W.getAttribute(E),ke=W.getAttribute(V);j.addValue(Q,ke),P.close(),j.filter(),m.success(n.t("添加成功"));});}),k.appendChild(M);}l.appendChild(u),l.appendChild(h),l.appendChild(S),l.appendChild(I),l.appendChild(_),l.appendChild(k);});let r=Array.from(document.querySelectorAll(".install-link[data-install-format=js]")),i=ae.getScriptContainerStatus(),o=Object.values(i).filter(Boolean);if(i.Tampermonkey||i.ScriptCat)d.info(`当前脚本管理器【${i.Tampermonkey?"TamperMonkey":"ScriptCat"}】，启用极速检测已安装脚本信息`),r.forEach(async a=>{let s=await ae.checkForUpdatesJS(a,!0);a.classList.remove("lum-lightbox-loader"),s||(a.textContent=n.t("安装此脚本"));});else if(o.length){d.info("当前脚本管理器"+Object.keys(i).map(a=>`【${a}】`).join("、"));for(let a=0;a<r.length;a++){let s=r[a],l=s["data-script-info"],c=await R.get(L.getScriptInfoUrl(l.scriptId),{fetch:!0});if(!c.status){s.textContent=n.t("安装此脚本");continue}let u=g.toJSON(c.data.responseText);s.setAttribute("data-script-namespace",u.namespace);let h=await ae.checkForUpdatesJS(s,!0);s.classList.remove("lum-lightbox-loader"),h||(s.textContent=n.t("安装此脚本"));}}else d.error("未知的脚本容器",window.external);}),e}},Fe={getCurrentLoginUserId(){let e=document.querySelector("#nav-user-info .user-profile-link a");if(!e)return;let t=L.getUserId(e.href);if(t!=null)return t}},He={isCurrentLoginUserHome(){let e=Fe.getCurrentLoginUserId();return !!(e!=null&&T.isUsers()&&window.location.pathname.includes("/"+e))}},j={key:"gf-shield-rule",init(){d.info("脚本过滤");let e=new g.LockFunction(()=>{this.filter();},50);f.ready(()=>{if(He.isCurrentLoginUserHome()){d.warn("当前在已登录的账户主页下，禁用脚本过滤");return}g.mutationObserver(document.body,{config:{subtree:!0,childList:!0},callback:()=>{e.run();}}),e.run();});},getElementList(){let e=[];return e=e.concat(Array.from(document.querySelectorAll("ol.script-list li"))),e},filter(){this.getElementList().forEach(e=>{let t=we(e),r=this.getValue().split(`
`);for(let i=0;i<r.length;i++){let o=r[i],a=o.split("##"),s=a[0],l=a[1];if(s==="scriptRatingScore"){let c=parseFloat(l.slice(1));if(l.startsWith(">")){if(t.scriptRatingScore>c){d.info(["触发脚本过滤规则",[o,t]]),e.remove();break}}else if(l.startsWith("<")&&t.scriptRatingScore<c){d.info(["触发脚本过滤规则",[o,t]]),e.remove();break}}else if(s in t||s==="scriptDescription"){if(typeof l!="string")continue;let c=new RegExp(l,"ig");if(String(t[s]).match(c)){d.info(["触发脚本过滤规则",o,t]),e.remove();break}}}});},setValue(e){p.setValue(this.key,e);},addValue(e,t){let r=this.getValue();if(r.trim()!==""&&(r+=`
`),g.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},je={id:"greasy-fork-panel-config-scripts",title:n.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:n.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("添加复制代码按钮"),"addCopyCodeButton",!0,void 0,n.t("更优雅的复制")),w(n.t("快捷键"),"fullScreenOptimization",!0,void 0,n.t("【F】键全屏、【Alt+Shift+F】键宽屏")),w(n.t("修复代码行号显示"),"code-repairCodeLineNumber",!0,void 0,n.t("修复代码行数超过1k行号显示不全问题"))]}]},{text:n.t("历史版本"),type:"deepMenu",forms:[{text:n.t("功能"),type:"forms",forms:[w(n.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",!0,void 0,n.t("在版本下面添加【安装】、【查看代码】按钮"))]},{text:n.t("美化"),type:"forms",forms:[w(n.t("美化历史版本页面"),"beautifyHistoryVersionPage",!0,void 0,n.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("添加【寻找引用】按钮"),"addFindReferenceButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),w(n.t("添加【收藏】按钮"),"addCollectionButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),w(n.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",!0,void 0,n.t("在脚本信息栏添加【今日检查】信息块"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化脚本列表"),"beautifyCenterContent",!0,void 0,n.t("双列显示且添加脚本卡片操作项（安装、收藏）"))]}]},{text:n.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${n.t("帮助文档")}</a>`,type:"forms",forms:[w(n.t("启用"),"gf-scripts-filter-enable",!0,void 0,n.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(e){let t=f.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=j.getValue(),f.on(r,["input","propertychange"],void 0,g.debounce(function(i){j.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},H={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){d.info("论坛-过滤"),v(`
        ...
        `);let e=new g.LockFunction(()=>{this.filter();},50);g.mutationObserver(document.body,{config:{subtree:!0,childList:!0},callback:()=>{e.run();}}),e.run();},getElementList(){let e=[];return e=e.concat(Array.from(document.querySelectorAll(".discussion-list-container"))),e},filter(){this.transformOldRule();const e=new Map;this.getElementList().forEach((t,r)=>{const i=this.parseDiscuessionListContainerInfo(t);let o=this.getValue().split(`
`);if(e.has(i.snippet)&&p.getValue("greasyfork-discussions-filter-duplicate-comments")){let a=e.get(i.snippet).querySelector("a.discussion-title");a.setAttribute("data-repeat-tip-show","true");let s=0;a.hasAttribute("data-repeat-count")&&(s=parseInt(a.getAttribute("data-repeat-count"))),s++,a.setAttribute("data-repeat-count",s.toString()),a.setAttribute("data-repeat-tip-show",n.t("已过滤：{{oldCount}}",{oldCount:s})),d.success([`过滤重复内容：${i.snippet}`,i]),t.remove();return}e.set(i.snippet,t);for(let a=0;a<o.length;a++){let s=o[a],l=s.split("##"),c=l[0],u=l[1];if(c in i){let h=new RegExp(u,"ig");if(i[c]!=null&&String(i[c]).match(h)){d.info(["触发论坛过滤规则",s,i]),t.remove();return}}}});},parseDiscuessionListContainerInfo(e){var r,i,o,a;const t={scriptName:e.querySelector(".discussion-meta-item-script-name").innerText,scriptUrl:(r=e.querySelector(".discussion-meta-item-script-name a"))==null?void 0:r.href,scriptId:L.getScriptId((i=e.querySelector(".discussion-meta-item-script-name a"))==null?void 0:i.href),postUserName:e.querySelector("a.user-link").innerText,postUserHomeUrl:e.querySelector("a.user-link").href,postUserId:L.getUserId(e.querySelector("a.user-link").href),postTimeStamp:new Date(e.querySelector("relative-time").getAttribute("datetime")),snippetUrl:e.querySelector("a.discussion-title").href,snippet:((o=e.querySelector("span.discussion-snippet"))==null?void 0:o.innerText)||"",replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};return e.querySelector(".discussion-meta-item .discussion-meta-item")&&(t.replyUserName=e.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").innerText,t.replyUserHomeUrl=e.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").href,t.replyUserId=L.getUserId(t.replyUserHomeUrl),t.replyTimeStamp=new Date((a=e.querySelector(".discussion-meta-item .discussion-meta-item relative-time"))==null?void 0:a.getAttribute("datetime"))),t},transformOldRule(){if(Date.now()>new Date("2024-8-19").getTime())return;const e="greasyfork-discussions-filter-script",t="greasyfork-discussions-filter-post-user",r="greasyfork-discussions-filter-reply-user",i=p.getValue(e,""),o=p.getValue(t,""),a=p.getValue(r,""),s=i.trim()===""?[]:i.split(`
`),l=o.trim()===""?[]:o.split(`
`),c=a.trim()===""?[]:a.split(`
`);s.forEach(u=>{this.addValue("scriptId",g.parseStringToRegExpString("^"+u+"$"));}),l.forEach(u=>{this.addValue("postUserId",g.parseStringToRegExpString("^"+u+"$"));}),c.forEach(u=>{this.addValue("replyUserId",g.parseStringToRegExpString("^"+u+"$"));}),p.deleteValue(e),p.deleteValue(t),p.deleteValue(r);},setValue(e){p.setValue(this.key,e);},addValue(e,t){let r=this.getValue();if(r.trim()!==""&&(r+=`
`),g.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},We={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=f.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											`}),o=i.querySelector(".pops-color-choose");o.value=p.getValue(t);let a=f.createElement("style");return f.append(document.head,a),f.on(o,["input","propertychange"],s=>{d.info("选择颜色："+o.value),a.innerHTML=`
												.discussion-read{
													background: ${o.value} !important;
												}
												`,p.setValue(t,o.value);}),e.appendChild(r),e.appendChild(i),e}},w(n.t("添加快捷操作按钮"),"discussions-addShortcutOperationButton",!0,void 0,n.t("在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效"))]}]},{text:n.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%AE%BA%E5%9D%9B%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${n.t("帮助文档")}</a>`,type:"forms",forms:[w(n.t("启用"),"greasyfork-discussions-filter-enable",!0,void 0,n.t("开启后下面的过滤功能才会生效")),w(n.t("过滤重复的评论"),"greasyfork-discussions-filter-duplicate-comments",!1,void 0,n.t("过滤掉重复的评论数量(≥2)")),{type:"own",getLiElementCallBack(e){let t=f.createElement("div",{className:"pops-panel-textarea",innerHTML:`
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=H.getValue(),f.on(r,["input","propertychange"],void 0,g.debounce(function(i){H.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},Se={async UIScriptList(e,t,r,i){var h,y,b;if(!C.isLogin){m.error(n.t("请先登录账号！"));return}let a=C.getUserLinkElement().href,s=(b=(y=(h=a==null?void 0:a.split("/"))==null?void 0:h.pop())==null?void 0:y.match(/([0-9]+)/))==null?void 0:b[0],l=B.loading({mask:{enable:!0},parent:i,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),c=await $.getUserInfo(s);if(l.close(),!c)return;d.info(c);let u=e==="script-list"?c.scriptList:c.scriptLibraryList;m.success(n.t("获取成功，共 {{count}} 个",{count:u.length}));for(const x of u){let S=f.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),I=S.querySelector(".w-script-info"),_=f.createElement("div",{className:"pops-panel-button",innerHTML:`
				<button type="primary" data-icon="" data-righticon="false">
				<span>${n.t("同步代码")}</span>
				</button>
				`});x.deleted&&(S.classList.add("w-script-deleted"),_.querySelector("button").setAttribute("disabled","true")),f.on(_,"click",void 0,async function(){d.success(["同步",x]);let k=_.querySelector("button"),U=_.querySelector("button span"),D=f.createElement("i",{className:"pops-bottom-icon",innerHTML:B.config.iconSVG.loading},{"is-loading":!0});k.setAttribute("disabled","true"),k.setAttribute("data-icon","true"),U.innerText=n.t("同步中..."),f.before(U,D);let M=x==null?void 0:x.id,E=await $.getSourceCodeSyncFormData(M.toString());if(E){const V="script[script_sync_type_id]";if(E.has(V)){let O=E.get(V),P="";O.toString()==="1"?P=n.t("手动"):O.toString()==="2"?P=n.t("自动"):O.toString()==="3"&&(P="webhook");let Z=S.querySelector(".w-script-sync-type");Z?Z.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:P}):f.append(I,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:P})}
									</p>
								</div>`),await $.sourceCodeSync(x.id.toString(),E)?m.success(n.t("同步成功")):m.error(n.t("同步失败"));}else m.error(n.t("该脚本未设置同步信息"));}k.removeAttribute("disabled"),k.removeAttribute("data-icon"),U.innerText=n.t("同步代码"),D.remove();}),S.appendChild(_),i.appendChild(S);}}},Ke={id:"greasy-fork-panel-config-script-list",title:n.t("脚本列表"),callback(e,t,r){Se.UIScriptList("script-list",e,t,r);},forms:[]},Je={id:"greasy-fork-panel-config-library",title:n.t("库"),callback(e,t,r){Se.UIScriptList("script-library",e,t,r);},forms:[]},Ye=`.w-script-list-item {\r
	padding: 10px 0;\r
...
`,Ze={id:"greasy-fork-panel-config-account",title:n.t("用户"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("迁移【控制台】到顶部导航栏"),"users-changeConsoleToTopNavigator",!0,void 0,n.t("将【控制台】按钮移动到顶部导航栏，节省空间"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化私信页面"),"conversations-beautifyDialogBox",!0,void 0,n.t("美化为左右对话模式")),w(n.t("美化私信列表"),"conversations-beautifyPrivateMessageList",!0)]}]}]}]},Qe={init(){},showView(){let e=B.alert({title:{text:n.t("Url To WebhookUrl"),position:"center"},content:{text:`
            ...
            `}),t=e.$shadowRoot.querySelector("#github"),r=e.$shadowRoot.querySelector("#webhook");f.on(t,["input","propertychange"],i=>{let o=t.value.trim(),a=[];o.split(`
`).forEach(s=>{try{if(s=s.trim(),g.isNull(s))return;let c=new URL(s).pathname.split("/"),{1:u,2:h,3:y,4:b}=c,x="";if(c.length>=6&&y==="blob")x=c.slice(5,c.length).join("/");else if(c.length>=8&&y==="raw"&&b==="refs")b=c[6],x=c.slice(7,c.length).join("/");else return;if(x==="")return;a.push(`https://raw.githubusercontent.com/${u}/${h}/${b}/${x}`);}catch{}}),r.value=a.join(`
`);});}},p={$data:{__data:null,__oneSuccessExecMenu:null,__onceExec:null,__listenData:null,get data(){return p.$data.__data==null&&(p.$data.__data=new g.Dictionary),p.$data.__data},get oneSuccessExecMenu(){return p.$data.__oneSuccessExecMenu==null&&(p.$data.__oneSuccessExecMenu=new g.Dictionary),p.$data.__oneSuccessExecMenu},get onceExec(){return p.$data.__onceExec==null&&(p.$data.__onceExec=new g.Dictionary),p.$data.__onceExec},get scriptName(){return ue},key:G,attributeKeyName:X,attributeDefaultValueName:ee},$listener:{get listenData(){return p.$data.__listenData==null&&(p.$data.__listenData=new g.Dictionary),p.$data.__listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},isTopWindow(){return A.top===A.self},initExtensionsMenu(){this.isTopWindow()&&ye.add([{key:"show_pops_panel_setting",text:n.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showPanel();}},{key:"githubUrl2webhookUrl",text:"⚙ "+n.t("Url To WebhookUrl"),autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{Qe.showView();}}]);},initPanelDefaultValue(){let e=this;function t(o){if(!o.attributes)return;let a={},s=o.attributes[X];s!=null&&(a[s]=o.attributes[ee]);let l=o.attributes[me];if(typeof l=="function"){let h=l();if(typeof h=="boolean"&&!h)return}let c=o.attributes[Ae];c&&typeof c=="object"&&Object.assign(a,c);let u=Object.keys(a);if(!u.length){d.warn(["请先配置键",o]);return}u.forEach(h=>{let y=a[h];e.$data.data.has(h)&&d.warn("请检查该key(已存在): "+h),e.$data.data.set(h,y);});}function r(o){for(let a=0;a<o.length;a++){let s=o[a];t(s);let l=s.forms;l&&Array.isArray(l)&&r(l);}}let i=this.getPanelContentConfig();for(let o=0;o<i.length;o++){let a=i[o];if(!a.forms)continue;let s=a.forms;s&&Array.isArray(s)&&r(s);}},setValue(e,t){let r=z(G,{}),i=r[e];r[e]=t,q(G,r),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,i,t);},getValue(e,t){let i=z(G,{})[e];return i??(this.$data.data.has(e)?this.$data.data.get(e):t)},deleteValue(e){let t=z(G,{}),r=t[e];Reflect.deleteProperty(t,e),q(G,t),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,r,void 0);},addValueChangeListener(e,t,r){let i=Math.random();return this.$listener.listenData.set(e,{id:i,key:e,callback:t}),r&&r.immediate&&t(e,this.getValue(e),this.getValue(e)),i},removeValueChangeListener(e){let t=null;for(const[r,i]of this.$listener.listenData.entries())if(i.id===e){t=r;break}typeof t=="string"?this.$listener.listenData.delete(t):console.warn("没有找到对应的监听器");},triggerMenuValueChange(e,t,r){if(this.$listener.listenData.has(e)){let i=this.$listener.listenData.get(e);if(typeof i.callback=="function"){let o=this.getValue(e),a=o,s=o;typeof t<"u"&&arguments.length>1&&(a=t),typeof r<"u"&&arguments.length>2&&(s=r),i.callback(e,s,a);}}},hasKey(e){let t=z(G,{});return e in t},execMenu(e,t,r=!1){if(!(typeof e=="string"||typeof e=="object"&&Array.isArray(e)))throw new TypeError("key 必须是字符串或者字符串数组");let i=[];typeof e=="object"&&Array.isArray(e)?i=[...e]:i.push(e);let o;for(let a=0;a<i.length;a++){const s=i[a];if(!this.$data.data.has(s)){d.warn(`${e} 键不存在`);return}let l=p.getValue(s);if(r&&(l=!l),!l)break;o=l;}o&&t(o);},execMenuOnce(e,t,r,i){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){d.warn(`${e} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(e))return;this.$data.oneSuccessExecMenu.set(e,1);let o=()=>{let u=p.getValue(e);return typeof r=="function"?r(e,u):u},a=[],s=u=>{let h=o(),y=[];if(u instanceof HTMLStyleElement?y=[u]:Array.isArray(u)&&(y=[...u.filter(b=>b!=null&&b instanceof HTMLStyleElement)]),h)a=a.concat(y);else for(let b=0;b<y.length;b++)y[b].remove(),y.splice(b,1),b--;},l=u=>{let h=[];if(u){let y=t(u,s);y instanceof HTMLStyleElement?h=[y]:Array.isArray(y)&&(h=[...y.filter(b=>b!=null&&b instanceof HTMLStyleElement)]);}for(let y=0;y<a.length;y++)a[y].remove(),a.splice(y,1),y--;a=[...h];};this.addValueChangeListener(e,(u,h,y)=>{let b=y;typeof i=="function"&&(b=i(u,y,h)),l(b);});let c=o();c&&l(c);},execInheritMenuOnce(e,t,r,i){let o=this;const a=(s,l)=>{let c=o.getValue(s),u=o.getValue(l);if(typeof i=="function"){let h=i(c,u);if(h!==void 0)return h}return c};this.execMenuOnce(e,r,()=>a(e,t),()=>a(e,t)),this.execMenuOnce(t,()=>{},()=>!1,()=>(this.triggerMenuValueChange(e),!1));},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(e)||(t(),this.$data.onceExec.set(e,1));},showPanel(){B.panel({title:{text:n.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:ue}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0,style:`
			${Ye}
			`});},isMobile(){return window.innerWidth<550},getWidth(){return window.innerWidth<550?"92vw":"550px"},getHeight(){return window.innerHeight>450?"80vh":"450px"},getPanelContentConfig(){return [ze,je,We,Ze,Ke,Je]}},Xe=`code {\r
...
`,st={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){d.info("美化页面元素");let e=[];return e.push(v(Xe)),e.push(v(et)),e.push(v(tt)),e.push(v(rt)),e.push(v(nt)),e.push(v(`
			p:has(input[type="submit"][name="update-and-sync"]){
			  margin-top: 10px;
			}
			`)),f.ready(function(){let t=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(f.createElement("span",{textContent:"Markdown"}),t),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&e.push(v(`
					.indented{
						padding-left: unset;
					}
					`));}),e},beautifyGreasyforkBeautify(){d.info("美化 Greasyfork Beautify脚本");let e=[];return e.push(v(ot)),g.isPhone()?e.push(v(`
				section#script-info,
				...
				section#script-info{
					margin-top: 10px;
				}`)),e},beautifyUploadImage(){d.info("美化上传图片");let e=[];return e.push(v(it)),f.ready(()=>{function t(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let r=document.querySelectorAll('input[type="file"]');r.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||f.on(o,["propertychange","input"],function(a){t(a.target);let s=a.currentTarget.files;if(!s||s.length===0)return;d.info(["选择的图片",s]),s.length>5&&f.after(o,f.createElement("p",{textContent:n.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(s).forEach(c=>{(c.size>204800||!c.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(c);}),l.length!==0&&l.forEach(c=>{f.after(o,f.createElement("p",{textContent:n.t("❌ 图片：{{name}} 大小：{{size}}",{name:c.name,size:c.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{f.on(o,"paste",a=>{d.info(["触发粘贴事件",a]),setTimeout(()=>{f.trigger(r,"input");},100);});});}),e},beautifyTopNavigationBar(){d.info("美化顶部导航栏");let e=[];return e.push(v(at)),window.outerWidth>550&&(e.push(re.addBlockCSS(".with-submenu")),f.ready(()=>{let r=document.querySelector("#site-nav").querySelector("nav");document.querySelectorAll(".with-submenu nav li").forEach(i=>{r.appendChild(i);});})),e}},lt={init(){p.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){g.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let e=p.getValue("user"),t=p.getValue("pwd");if(g.isNull(e)){m.error(n.t("请先在菜单中录入账号"));return}if(g.isNull(t)){m.error(n.t("请先在菜单中录入密码"));return}let r=document.querySelector("meta[name='csrf-token']");if(!r){m.error(n.t("获取csrf-token失败"));return}let i=m.loading(n.t("正在登录中...")),o=await R.post("https://greasyfork.org/zh-CN/users/sign_in",{fetch:!0,data:encodeURI(`authenticity_token=${r.getAttribute("content")}&user[email]=${e}&user[password]=${t}&user[remember_me]=1&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(i.destroy(),!o.status){d.error(o),m.error(n.t("登录失败，请在控制台查看原因"));return}let a=o.data.responseText;f.parseHTML(a,!0,!0).querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(m.success(n.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):(d.error(o),d.error(`当前账号:${e}`),d.error(`当前密码:${t}`),m.error(n.t("登录失败，可能是账号/密码错误，请在控制台查看原因")));});}},ct={init(){this.readBgColor(),f.ready(()=>{p.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),p.execMenuOnce("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();});});},filterEnable(){d.info("启用Greasyfork论坛过滤器"),H.init();},readBgColor(){d.info("设置已读背景颜色");let e=p.getValue("discussions-readBgColor");v(`
        .discussion-read{
            background: ${e} !important;
        }
        `);},addShortcutOperationButton(){d.info("添加快捷操作按钮"),H.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=f.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-filter-button">${n.t("过滤")}</button>
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),f.on(o,"click",a=>{var y,b,x;g.preventEvent(a);const s=H.parseDiscuessionListContainerInfo(e);let l="data-filter-key",c="data-filter-value",u=B.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
						...
						`}),h=u.$shadowRoot.querySelector(".pops-alert-content");if(s.scriptId==null&&((y=h.querySelector(`button[${l}="scriptId"]`))==null||y.remove()),s.scriptName==null&&((b=h.querySelector(`button[${l}="scriptName"]`))==null||b.remove()),s.postUserId==null&&((x=h.querySelector(`button[${l}="postUserId"]`))==null||x.remove()),s.replyUserId!=null){let S=f.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:s.replyUserId})});S.setAttribute(l,"scriptAuthorId"),S.setAttribute(c,"^"+s.replyUserId+"$"),h.appendChild(S);}f.on(u.$shadowRoot,"click",`button[${l}]`,S=>{g.preventEvent(S);let I=S.target,_=I.getAttribute(l),k=I.getAttribute(c);H.addValue(_,k),u.close(),H.filter(),m.success(n.t("添加成功"));});});});}},dt={init(){p.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),p.execMenuOnce("gf-scripts-filter-enable",()=>{j.init();}),p.execMenuOnce("beautifyCenterContent",()=>ve.beautifyCenterContent());},changeConsoleToTopNavigator(){d.info("迁移【控制台】到顶部导航栏"),re.addBlockCSS("#about-user"),f.ready(()=>{let e=document.querySelector("#about-user"),t=document.querySelector("#site-nav nav");if(!e){d.error("#about-user元素不存在");return}if(!t){d.error("#site-nav nav元素不存在");return}e=e.cloneNode(!0);let r=f.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});f.on(r,"click",i=>{g.preventEvent(i),B.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:g.getMaxZIndex(100),style:`
                    .text-content{
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(e);}),t.appendChild(r);});}},ut=`section.text-content {\r
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,pt={init(){p.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),f.ready(()=>{p.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){d.info("美化对话框"),[].push(te(ut));},beautifyPrivateMessageList(){d.info("美化私信列表"),te(`
		...
		`),document.querySelectorAll("section.text-content ul li").forEach(e=>{var c;let t=e.querySelector('a[href*="conversations"]'),r=t.href,i=(c=t.textContent)==null?void 0:c.split(" ")[1],o=e.querySelector("a.user-link"),a=null,s=null,l=null;if(o){a=o.textContent,s=o.href;let u=e.querySelector("relative-time");new Date(u.getAttribute("datetime")),l=u.shadowRoot.lastChild.textContent;}e.classList.add("user-conversations-item"),L.getUserId(),e.innerHTML=`
			...
			`;});}},Y={init(){p.execMenu("checkPage",()=>{this.checkPage();}),st.init(),be.init(),T.isScript()&&Pe.init(),(T.isScriptList()||T.isScriptLibraryList()||T.isScriptCodeSearch()||T.isScriptsBySite())&&ve.init(),T.isDiscuessions()&&ct.init(),T.isUsers()&&(dt.init(),T.isUsersConversations()&&pt.init()),p.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),f.ready(()=>{C.initEnv(),lt.init(),ce.init(),C.handleLocalGotoCallBack(),p.execMenuOnce("fixImageWidth",()=>{Y.fixImageWidth();}),Y.languageSelectorLocale(),p.execMenuOnce("optimizeImageBrowsing",()=>{Y.optimizeImageBrowsing();}),p.execMenuOnce("overlayBedImageClickEvent",()=>{Y.overlayBedImageClickEvent();}),T.isCodeStrict()||p.execMenuOnce("addMarkdownCopyButton",()=>{Y.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(d.info("修复图片显示问题"),v(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){d.info("优化图片浏览"),v(le("ViewerCSS")),v(`
        ...
        `);function e(r=[],i=0){let o="";r.forEach(l=>{o+=`<li><img data-src="${l}" loading="lazy"></li>`;});let a=f.createElement("ul",{innerHTML:o}),s=new Le(a,{inline:!1,url:"data-src",zIndex:g.getMaxZIndex()+100,hidden:()=>{s.destroy();}});i=i<0?0:i,s.view(i),s.zoomTo(1),s.show();}function t(r){return r.getAttribute("data-src")||r.getAttribute("src")||r.getAttribute("alt")}f.on(document,"click","img",function(r){var u;let i=r.target;if(((u=i.parentElement)==null?void 0:u.localName)==="a"&&i.hasAttribute("data-screenshots")||i.closest(".viewer-container")||i.closest(".lum-lightbox-position-helper"))return;let o=i.closest(".user-content"),a=[],s=0,l=[],c=t(i);c!=null&&c.startsWith("https://img.shields.io")||(o?(o.querySelectorAll("img").forEach(h=>{l.push(h);let y=t(h),b=h.parentElement;(b==null?void 0:b.localName)==="a"&&(y=b.getAttribute("data-href")||b.href),a.push(y);}),s=l.indexOf(i),s===-1&&(s=0)):(a.push(c),s=0),d.success(["点击浏览图片👉",a,s]),e(a,s));}),document.querySelectorAll(".user-screenshots").forEach(r=>{let i=r.querySelector("a");if(!i)return;let o=i.getAttribute("data-href")||i.getAttribute("href"),a=r.querySelector("img");a&&(a.setAttribute("data-screenshots","true"),a.setAttribute("data-src",o),i.setAttribute("href","javascript:;"),f.after(i,a),i.remove());});},overlayBedImageClickEvent(){d.info("覆盖图床图片的parentElement的a标签"),document.querySelectorAll(".user-content a>img").forEach(e=>{let t=e.parentElement,r=t.getAttribute("href");if(t.setAttribute("data-href",r),t.removeAttribute("href"),r.startsWith("/rails/active_storage/blobs/redirect")){d.info("该图片是上传到Greasyfork的图片，拦截默认行为，不做提示");return}f.on(t,"click",()=>{m.warning(`<div style="overflow-wrap: anywhere;">${n.t("拦截跳转：")}<a href="${r}" target="_blank">${r}</a></div>`,{html:!0,zIndex:g.getMaxZIndex()+105});});});},addMarkdownCopyButton(){d.info("在Markdown右上角添加复制按钮"),v(`
        pre{
          position: relative;
        ...
        `);function e(){let t=f.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),r=t.querySelector(".js-clipboard-copy"),i=t.querySelector(".octicon-copy"),o=t.querySelector(".octicon-check-copy");return f.on(t,"click",function(){let a=t.parentElement.querySelector("code");if(!a&&t.parentElement.className.includes("prettyprinted")&&(a=t.parentElement),!a){m.error(n.t("未找到{{selector}}元素",{selector:"code"}));return}g.setClip(a.innerText||a.textContent),r.setAttribute("success","true"),i.setAttribute("aria-hidden","true"),o.removeAttribute("aria-hidden");let s=B.tooltip({target:r,content:n.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:!0});setTimeout(()=>{r.removeAttribute("success"),o.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden"),s.close();},2e3);}),t}document.querySelectorAll("pre").forEach(t=>{if(t.querySelector("div.zeroclipboard-container"))return;let i=e(),o=f.createElement("div",{className:"snippet-clipboard-content"});f.before(t,o),o.appendChild(t),o.appendChild(i);});},languageSelectorLocale(){let e=p.getValue("language-selector-locale"),t=window.location.pathname.split("/").filter(r=>!!r)[0];if(d.success("选择语言："+e),d.success("当前语言："+t),!g.isNull(e)&&e!==t){let r=null,i=$.getSwitchLanguageUrl(e);$.switchLanguage(i),d.success("新Url："+i),m.loading(n.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:t,localeLanguage:e}),{timeout:3e3,showClose:!0,onClose(){clearTimeout(r);}}),m.info(n.t("导航至：")+i,{timeout:3e3}),r=setTimeout(()=>{window.location.href=i;},3e3);}},checkPage(){d.info("检测gf页面是否正确加载，有时候会出现"),f.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let e=parseInt(z("greasyfork-check-page-time",0)),t=p.getValue("greasyfork-check-page-timeout",5),r=t*1e3;if(e&&Date.now()-e<r){m.warning(n.t("上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载",{time:g.formatTime(e,"yyyy-MM-dd HH:mm:ss"),timeout:t}));return}q("greasyfork-check-page-time",Date.now()),window.location.reload();}});},addOperationPanelBtnWithNavigator(){d.info("添加【操作面板】按钮"),re.addBlockCSS(".sidebarred .sidebar",".sidebarred-main-content .open-sidebar"),v(`
		.sidebarred .sidebarred-main-content{
			max-width: 100%;
		}	
		`),f.ready(()=>{let e=document.querySelector("#site-nav nav"),t=document.querySelector("#site-nav .with-submenu nav"),r=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!r){d.warn("不存在右侧面板元素#script-list-option-groups");return}if(r=r.cloneNode(!0),r.classList.add("option-panel-groups"),!e){d.error("元素#site-nav nav不存在");return}let i=f.createElement("li",{className:"filter-scripts",innerHTML:`
                <a href="javascript:;">${n.t("操作面板")}</a>
                `});f.on(i,"click",o=>{g.preventEvent(o),B.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:g.getMaxZIndex(100),style:`
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(r);}),t&&t.children.length?t.appendChild(i):e.appendChild(i);});}};p.init();Y.init();

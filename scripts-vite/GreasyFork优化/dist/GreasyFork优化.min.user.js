...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ae=="function"?ae(e.keyName):"";typeof t=="string"&&t?ce(t):X.addLinkNode(e.url);},async addLinkNode(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,d.ready(()=>{document.head.appendChild(t);}),t},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e}},se={getInstallUrl(e,t,r){return h.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${e}/${t}${r}.user.js`},getCodeUrl(e,t){return h.isNull(t)&&(t=""),`https://greasyfork.org/scripts/${e}/code?version=${t}`},getScriptInfoUrl(e){return `https://greasyfork.org/scripts/${e}.json`}},Ue={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){c.info("美化 历史版本 页面");let e=[];return e.push(b(Ae)),e.push(X.addBlockCSS(".version-number",".version-date",".version-changelog")),d.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){f.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var g,w;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(g=r.querySelector(".version-date"))==null?void 0:g.getAttribute("datetime"),s=((w=r.querySelector(".version-changelog"))==null?void 0:w.innerHTML)||"",l=d.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),u=d.createElement("div",{className:"script-tag",innerHTML:`
		...
		<li class="user-collect-item" data-id="${o.id}" data-name="${o.name}">
		  ...
		  `;});let i=N.alert({title:{text:n.t("收藏集"),position:"center"},content:{html:!0,text:`<ul>${r}</ul>`},mask:{enable:!0,clickEvent:{toClose:!0}},btn:{ok:{enable:!1}},width:N.isPhone()?"92vw":"500px",height:"auto",drag:!0,only:!0,style:`
		.pops{
		...
		`});d.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("添加中...")),u=await y.getUserCollectionInfo(t,s);if(!u){l.close();return}let m=h.cloneFormData(u),g=h.cloneFormData(u),w=!1;for(const[T,C]of u.entries())if(T==="scripts-included[]"&&String(C).trim()===String(e).trim()){w=!0;break}else g.append(T,C),m.append(T,C);if(w){f.warning(n.t("该脚本已经在该收藏集中")),l.close();return}m.set("add-script",e.toString()),m.set("script-action","i"),g.append("scripts-included[]",e.toString()),g.set("save","1");let L=new URLSearchParams(m),S=new URLSearchParams(g),E=Array.from(L).map(([T,C])=>`${encodeURIComponent(T)}=${encodeURIComponent(C)}`).join("&"),V=Array.from(S).map(([T,C])=>`${encodeURIComponent(T)}=${encodeURIComponent(C)}`).join("&");c.info(["添加的数据",E]),c.info(["保存的数据",V]);let _=await y.updateUserSetsInfo(t,s,E);if(!_){l.close();return}let k=_.querySelector(".change-script-set");if(!k){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let M=k.querySelector("section");if(!M){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let q=M.querySelector(".alert");q?N.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:q.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					...
					`,drag:!0,dragLimit:!0,width:N.isPhone()?"88vw":"400px",height:N.isPhone()?"50vh":"300px"}):(await y.updateUserSetsInfo(t,s,V),f.success(n.t("添加成功"))),l.close();}),d.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("删除中...")),u=await y.getUserCollectionInfo(t,s);if(!u){l.close();return}let m=new FormData,g=new FormData,w=!1;for(const[k,M]of u.entries()){if(String(k).trim()==="scripts-included[]"&&String(M).trim()===String(e).trim()){w=!0;continue}g.append(k,M),m.append(k,M);}if(!w){f.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:e})),l.close();return}m.set("remove-scripts-included[]",e.toString()),m.set("remove-selected-scripts","i"),m.delete("script-action"),g.set("save","1");let L=new URLSearchParams(m),S=new URLSearchParams(g),E=Array.from(L).map(([k,M])=>`${encodeURIComponent(k)}=${encodeURIComponent(M)}`).join("&"),V=Array.from(S).map(([k,M])=>`${encodeURIComponent(k)}=${encodeURIComponent(M)}`).join("&");if(c.info(["删除的数据",E]),c.info(["保存的数据",V]),!await y.updateUserSetsInfo(t,s,E)){l.close();return}await y.updateUserSetsInfo(t,s,V),f.success(n.t("删除成功")),l.close();});},$e={init(){I.isCode()?Ie.init():I.isVersion()&&Ue.init(),I.isCodeStrict()&&(p.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),p.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),p.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),p.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),p.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){c.info("添加收藏按钮"),h.waitNode("ul#script-links li.current span").then(()=>{let e=d.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});d.append(document.querySelector("ul#script-links"),e),d.on(e,"click",()=>{let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){c.error([t,window.location.pathname]),f.error(n.t("获取脚本id失败"));return}let r=t[t.length-1];me(r);});});},fullScreenOptimization(){c.info("F11全屏，F键代码全屏"),b(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
...
`),h.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},Ne={id:"greasy-fork-panel-config-scripts",title:n.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:n.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("添加复制代码按钮"),"addCopyCodeButton",!0,void 0,n.t("更优雅的复制")),x(n.t("快捷键"),"fullScreenOptimization",!0,void 0,n.t("【F】键全屏、【Alt+Shift+F】键宽屏")),x(n.t("修复代码行号显示"),"code-repairCodeLineNumber",!0,void 0,n.t("修复代码行数超过1k行号显示不全问题"))]}]},{text:n.t("历史版本"),type:"deepMenu",forms:[{text:n.t("功能"),type:"forms",forms:[x(n.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",!0,void 0,n.t("在版本下面添加【安装】、【查看代码】按钮"))]},{text:n.t("美化"),type:"forms",forms:[x(n.t("美化历史版本页面"),"beautifyHistoryVersionPage",!0,void 0,n.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("添加【寻找引用】按钮"),"addFindReferenceButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),x(n.t("添加【收藏】按钮"),"addCollectionButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),x(n.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",!0,void 0,n.t("在脚本信息栏添加【今日检查】信息块"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("美化脚本列表"),"beautifyCenterContent",!0,void 0,n.t("双列显示且添加脚本卡片操作项（安装、收藏）"))]}]},{text:n.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${n.t("帮助文档")}</a>`,type:"forms",forms:[x(n.t("启用"),"gf-scripts-filter-enable",!0,void 0,n.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(e){let t=d.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=j.getValue(),d.on(r,["input","propertychange"],void 0,h.debounce(function(i){j.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},O={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){c.info("论坛-过滤"),b(`
...
`),h.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},Ve={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=d.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=O.getValue(),d.on(r,["input","propertychange"],void 0,h.debounce(function(i){O.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},ze=`code {\r
...
`,He={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){c.info("美化页面元素");let e=[];return e.push(b(ze)),e.push(b(Be)),e.push(b(qe)),e.push(b(Re)),e.push(b(De)),e.push(b(`
			p:has(input[type="submit"][name="update-and-sync"]){
			  margin-top: 10px;
			}
			`)),d.ready(function(){let t=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(d.createElement("span",{textContent:"Markdown"}),t),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&e.push(b(`
					.indented{
						padding-left: unset;
					}
					`));}),e},beautifyGreasyforkBeautify(){c.info("美化 Greasyfork Beautify脚本");let e=[];return e.push(b(Fe)),h.isPhone()?e.push(b(`
				section#script-info,
				...
				section#script-info{
					margin-top: 10px;
				}`)),e},beautifyUploadImage(){c.info("美化上传图片");let e=[];return e.push(b(Pe)),d.ready(()=>{function t(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let r=document.querySelectorAll('input[type="file"]');r.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||d.on(o,["propertychange","input"],function(a){t(a.target);let s=a.currentTarget.files;if(!s||s.length===0)return;c.info(["选择的图片",s]),s.length>5&&d.after(o,d.createElement("p",{textContent:n.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(s).forEach(u=>{(u.size>204800||!u.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(u);}),l.length!==0&&l.forEach(u=>{d.after(o,d.createElement("p",{textContent:n.t("❌ 图片：{{name}} 大小：{{size}}",{name:u.name,size:u.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{d.on(o,"paste",a=>{c.info(["触发粘贴事件",a]),setTimeout(()=>{d.trigger(r,"input");},100);});});}),e},beautifyTopNavigationBar(){c.info("美化顶部导航栏");let e=[];return e.push(b(Ge)),window.outerWidth>550&&(e.push(X.addBlockCSS(".with-submenu")),d.ready(()=>{let r=document.querySelector("#site-nav").querySelector("nav");document.querySelectorAll(".with-submenu nav li").forEach(i=>{r.appendChild(i);});})),e}},Oe={init(){p.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){h.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let e=p.getValue("user"),t=p.getValue("pwd");if(h.isNull(e)){f.error(n.t("请先在菜单中录入账号"));return}if(h.isNull(t)){f.error(n.t("请先在菜单中录入密码"));return}let r=document.querySelector("meta[name='csrf-token']");if(!r){f.error(n.t("获取csrf-token失败"));return}let i=f.loading(n.t("正在登录中...")),o=await $.post("https://greasyfork.org/zh-CN/users/sign_in",{fetch:!0,data:encodeURI(`authenticity_token=${r.getAttribute("content")}&user[email]=${e}&user[password]=${t}&user[remember_me]=1&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(i.destroy(),!o.status){c.error(o),f.error(n.t("登录失败，请在控制台查看原因"));return}let a=o.data.responseText;d.parseHTML(a,!0,!0).querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(f.success(n.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):(c.error(o),c.error(`当前账号:${e}`),c.error(`当前密码:${t}`),f.error(n.t("登录失败，可能是账号/密码错误，请在控制台查看原因")));});}},je={init(){this.readBgColor(),d.ready(()=>{p.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),p.execMenuOnce("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();});});},filterEnable(){c.info("启用Greasyfork论坛过滤器"),O.init();},readBgColor(){c.info("设置已读背景颜色");let e=p.getValue("discussions-readBgColor");b(`
        .discussion-read{
        ...
        `);},addShortcutOperationButton(){c.info("添加快捷操作按钮"),O.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=d.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),d.on(o,"click",a=>{var w,L,S;h.preventEvent(a);const s=O.parseDiscuessionListContainerInfo(e);let l="data-filter-key",u="data-filter-value",m=N.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
						...
						`}),g=m.$shadowRoot.querySelector(".pops-alert-content");if(s.scriptId==null&&((w=g.querySelector(`button[${l}="scriptId"]`))==null||w.remove()),s.scriptName==null&&((L=g.querySelector(`button[${l}="scriptName"]`))==null||L.remove()),s.postUserId==null&&((S=g.querySelector(`button[${l}="postUserId"]`))==null||S.remove()),s.replyUserId!=null){let E=d.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:s.replyUserId})});E.setAttribute(l,"scriptAuthorId"),E.setAttribute(u,"^"+s.replyUserId+"$"),g.appendChild(E);}d.on(m.$shadowRoot,"click",`button[${l}]`,E=>{h.preventEvent(E);let V=E.target,_=V.getAttribute(l),k=V.getAttribute(u);O.addValue(_,k),m.close(),O.filter(),f.success(n.t("添加成功"));});});});}},We={init(){p.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),p.execMenuOnce("gf-scripts-filter-enable",()=>{j.init();}),p.execMenuOnce("beautifyCenterContent",()=>ye.beautifyCenterContent());},changeConsoleToTopNavigator(){c.info("迁移【控制台】到顶部导航栏"),X.addBlockCSS("#about-user"),d.ready(()=>{let e=document.querySelector("#about-user"),t=document.querySelector("#site-nav nav");if(!e){c.error("#about-user元素不存在");return}if(!t){c.error("#site-nav nav元素不存在");return}e=e.cloneNode(!0);let r=d.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});d.on(r,"click",i=>{h.preventEvent(i),N.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:h.getMaxZIndex(100),style:`
                    .text-content{
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(e);}),t.appendChild(r);});}},G={init(){p.execMenu("checkPage",()=>{this.checkPage();}),He.init(),I.isScript()&&$e.init(),(I.isScriptList()||I.isScriptLibraryList()||I.isScriptCodeSearch())&&ye.init(),I.isDiscuessions()&&je.init(),I.isUserHome()&&We.init(),p.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),d.ready(()=>{v.initEnv(),Oe.init(),v.handleLocalGotoCallBack(),p.execMenuOnce("fixImageWidth",()=>{G.fixImageWidth();}),G.languageSelectorLocale(),p.execMenuOnce("optimizeImageBrowsing",()=>{G.optimizeImageBrowsing();}),p.execMenuOnce("overlayBedImageClickEvent",()=>{G.overlayBedImageClickEvent();}),I.isCodeStrict()||p.execMenuOnce("addMarkdownCopyButton",()=>{G.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(c.info("修复图片显示问题"),b(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){c.info("优化图片浏览"),b(ae("ViewerCSS")),b(`
        ...
        `);function e(){let t=d.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),r=t.querySelector(".js-clipboard-copy"),i=t.querySelector(".octicon-copy"),o=t.querySelector(".octicon-check-copy");return d.on(t,"click",function(){let a=t.parentElement.querySelector("code");if(!a&&t.parentElement.className.includes("prettyprinted")&&(a=t.parentElement),!a){f.error(n.t("未找到{{selector}}元素",{selector:"code"}));return}h.setClip(a.innerText||a.textContent),r.setAttribute("success","true"),i.setAttribute("aria-hidden","true"),o.removeAttribute("aria-hidden");let s=N.tooltip({target:r,content:n.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:!0});setTimeout(()=>{r.removeAttribute("success"),o.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden"),s.close();},2e3);}),t}document.querySelectorAll("pre").forEach(t=>{if(t.querySelector("div.zeroclipboard-container"))return;let i=e(),o=d.createElement("div",{className:"snippet-clipboard-content"});d.before(t,o),o.appendChild(t),o.appendChild(i);});},languageSelectorLocale(){let e=p.getValue("language-selector-locale"),t=window.location.pathname.split("/").filter(r=>!!r)[0];if(c.success("选择语言："+e),c.success("当前语言："+t),!h.isNull(e)&&e!==t){let r=null,i=y.getSwitchLanguageUrl(e);y.switchLanguage(i),c.success("新Url："+i),f.loading(n.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:t,localeLanguage:e}),{timeout:3e3,showClose:!0,onClose(){clearTimeout(r);}}),f.info(n.t("导航至：")+i,{timeout:3e3}),r=setTimeout(()=>{window.location.href=i;},3e3);}},async UIScriptList(e,t,r,i){var g,w,L;if(!v.isLogin){f.error(n.t("请先登录账号！"));return}let a=v.getUserLinkElement().href,s=(L=(w=(g=a==null?void 0:a.split("/"))==null?void 0:g.pop())==null?void 0:w.match(/([0-9]+)/))==null?void 0:L[0],l=N.loading({mask:{enable:!0},parent:i,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),u=await y.getUserInfo(s);if(l.close(),!u)return;c.info(u);let m=e==="script-list"?u.scriptList:u.scriptLibraryList;f.success(n.t("获取成功，共 {{count}} 个",{count:m.length}));for(const S of m){let E=d.createElement("li",{className:"w-script-list-item",innerHTML:`
				...
				<div class="w-script-update-time">
					<p>${n.t("更新：")}${h.getDaysDifference(new Date(S.code_updated_at).getTime(),void 0,"auto")}前</p>
				</div>
				</div>
		...
		`),d.ready(()=>{let e=document.querySelector("#site-nav nav"),t=document.querySelector("#site-nav .with-submenu nav"),r=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!r){c.warn("不存在右侧面板元素#script-list-option-groups");return}if(r=r.cloneNode(!0),r.classList.add("option-panel-groups"),!e){c.error("元素#site-nav nav不存在");return}let i=d.createElement("li",{className:"filter-scripts",innerHTML:`
                ...
                `});d.on(i,"click",o=>{h.preventEvent(o),N.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:h.getMaxZIndex(100),style:`
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(r);}),t&&t.children.length?t.appendChild(i):e.appendChild(i);});}},Ke={id:"greasy-fork-panel-config-script-list",title:n.t("脚本列表"),callback(e,t,r){G.UIScriptList("script-list",e,t,r);},forms:[]},Je={id:"greasy-fork-panel-config-library",title:n.t("库"),callback(e,t,r){G.UIScriptList("script-library",e,t,r);},forms:[]},Ze=`.w-script-list-item {\r
	padding: 10px 0;\r

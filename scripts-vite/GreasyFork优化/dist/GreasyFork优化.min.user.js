...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof ke=="function"?ke(e.keyName):null;return typeof t=="string"&&t?D(t):_.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(A=>{j.onReady(()=>{document.head.appendChild(t),A(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(A=>{t.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let A=[document.documentElement,document.body].concat(...e||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(i=>{n(i);}).catch(i=>{u.error("读取剪贴板内容失败👉",i),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(i=>{e(n);}).catch(i=>{u.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(n);});}function A(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!A()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,A=5e3){let n,i=A-t,s=t,o=async a=>{const l=await e(a);if(typeof l=="boolean"&&l||a){h.workerClearTimeout(n);return}if(s+=t,s>i){o(true);return}n=h.workerSetTimeout(()=>{o(false);},t);};o(false);},findParentNode(e,t,A){if(A){let n=j.closest(e,A);if(n)return n.querySelector(t)}else return j.matches(e,t)?e:j.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(n,i)=>i===void 0?t:i,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},h=se.noConflict(),c=j.noConflict(),Q=Ce,u=new h.Log(ge,R.console||$e.console),be=ge?.script?.name||void 0,_e=Ce.config.Utils.AnyTouch(),et=false;u.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});g.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const A=e.setting.content;return t==="warning"?u.warn(A):t==="error"?u.error(A):u.info(A),true},get position(){return m.getValue(ce.qmsg_config_position.key,ce.qmsg_config_position.defaultValue)},get maxNums(){return m.getValue(ce.qmsg_config_maxnums.key,ce.qmsg_config_maxnums.defaultValue)},get showReverse(){return m.getValue(ce.qmsg_config_showreverse.key,ce.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=se.getMaxZIndex(),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return se.getMaxValue(e,t)+100}});Q.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=se.getMaxZIndex(void 0,void 0,A=>{if(A?.classList?.contains("qmsg-shadow-container")||A?.closest("qmsg")&&A.getRootNode()instanceof ShadowRoot)return  false}),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return se.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Ne=new h.GM_Menu({GM_getValue:ee,GM_setValue:$,GM_registerMenuCommand:We,GM_unregisterMenuCommand:Ze}),V=new h.Httpx({xmlHttpRequest:Je,logDetails:et});V.interceptors.request.use(e=>e);V.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?g.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?g.error("请求超时",{consoleLogContent:true}):g.error("其它错误",{consoleLogContent:true}),e));R.Object.defineProperty,R.Function.prototype.apply,R.Function.prototype.call,R.Element.prototype.appendChild,R.setTimeout.bind(R),R.clearTimeout.bind(R),R.setInterval.bind(R),R.clearInterval.bind(R);const D=c.addStyle.bind(c),N=j.selector.bind(j),X=j.selectorAll.bind(j);new h.GM_Cookie;const he="GM_Panel",Le="data-init",pe="data-key",fe="data-default-value",Qe="data-init-more-value",Ue="data-plugin-search-config",ne="data-storage-api",J={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},Z={setting:{get width(){return J.width<550?"88vw":J.width<700?"550px":"700px"},get height(){return J.height<450?"70vh":J.height<550?"450px":"550px"}},settingMiddle:{get width(){return J.width<350?"88vw":"350px"},get height(){return J.height<450?"88vh":"450px"}},settingBig:{get width(){return J.width<800?"92vw":"800px"},get height(){return J.height<600?"80vh":"600px"}},info:{get width(){return J.width<350?"88vw":"350px"},get height(){return J.height<250?"88vh":"250px"}}},xe={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new h.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const A=(s,o)=>{typeof o!="string"&&(o=_.toStr(o));const a=new Blob([o]),l=globalThis.URL.createObjectURL(a);c.createElement("a",{href:l,download:s}).click(),h.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const s=f=>{const v=Q.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),y=v.$shadowRoot.querySelector(".btn-control[data-mode='local']"),x=v.$shadowRoot.querySelector(".btn-control[data-mode='network']"),P=v.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),I=async B=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof ye=="function"?typeof ve=="function"?(ye().forEach(w=>{ve(w);}),g.success("已清空脚本存储的配置")):g.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):g.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Oe=="function"?Oe(B):Object.keys(B).forEach(w=>{const b=B[w];$(w,b);}),g.success("配置导入完毕");},M=B=>new Promise(async z=>{const k=h.toJSON(B);Object.keys(k).length===0?g.warning("解析为空配置，不导入"):await I(k),z(true);});c.on(y,"click",B=>{c.preventEvent(B),v.close();const z=c.createElement("input",{type:"file",accept:".json"});c.on(z,["propertychange","input"],k=>{if(!z.files?.length)return;const w=z.files[0],b=new FileReader;b.onload=()=>{M(b.result);},b.readAsText(w,"UTF-8");}),z.click();}),c.on(x,"click",B=>{c.preventEvent(B),v.close();const z=Q.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(b,U){b.close();}},ok:{text:"导入",callback:async(b,U)=>{const T=b.text;if(h.isNull(T)){g.error("请填入完整的url");return}const C=g.loading("正在获取配置..."),E=await V.get(T,{allowInterceptConfig:false});if(C.close(),!E.status){u.error(E),g.error("获取配置失败",{consoleLogContent:true});return}await M(E.data.responseText)&&b.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:Z.info.width,height:"auto"}),k=z.$shadowRoot.querySelector("input"),w=z.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(k,["input","propertychange"],b=>{c.val(k)===""?c.attr(w,"disabled","true"):c.removeAttr(w,"disabled");}),c.onKeyboard(k,"keydown",(b,U,T)=>{b==="Enter"&&T.length===0&&c.val(k)!==""&&c.emit(w,"click");}),c.emit(k,"input");}),c.on(P,"click",async B=>{c.preventEvent(B),v.close();let z=await _.getClipboardText();if(z.trim()===""){g.warning("获取到的剪贴板内容为空");return}await M(z);});},o=(f=`${be}_panel-setting-${h.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,v)=>{const y=Q.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(f,v){s();}},cancel:{enable:true,text:"导出",callback(f,v){o(void 0,p);}}},width:J.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `,...this.$data.panelConfig});this.$data.$panel=s,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:s,content:e});},registerConfigSearch(e){const{$panel:t,content:A}=e,n=async(v,y)=>{if(v==null)return;const x=await y(v);return x&&typeof x.isFind=="boolean"&&x.isFind?x.data:await n(x.data,y)},i=(v,y)=>{const x=new IntersectionObserver(P=>{P.forEach(I=>{I.isIntersecting&&(y?.(),x.disconnect());});},{root:null,threshold:1});x.observe(v),v.scrollIntoView({behavior:"smooth",block:"center"});},s=v=>{const y="pops-flashing";c.onAnimationend(v,()=>{v.classList.remove(y);}),v.classList.add(y);},o=v=>{if(v.type==="dblclick"&&f)return;c.preventEvent(v),l=null;const y=Q.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});y.$shadowRoot.querySelector(".search-wrapper");const x=y.$shadowRoot.querySelector(".search-config-text"),P=y.$shadowRoot.querySelector(".search-result-wrapper");x.focus();const I=()=>{c.empty(P);},M=z=>{const k=h.queryProperty(z,U=>U?.next?{isFind:false,data:U.next}:{isFind:true,data:U}),w=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),b=Q.config.PanelHandlerComponents();return c.on(w,"click",U=>{const C=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[z.index];if(!C){g.error(`左侧项下标${z.index}不存在`);return}C.scrollIntoView({behavior:"smooth",block:"center"}),C.click(),n(z.next,async E=>{if(E?.next){const L=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(H=>{const G=Reflect.get(H,b.$data.nodeStoreConfigKey);return typeof G=="object"&&G!=null&&G.text===E.name}),2500);if(L)L.click();else return g.error("未找到对应的二级菜单"),{isFind:true,data:E};return {isFind:false,data:E.next}}else {const L=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(H=>Reflect.get(H,b.$data.nodeStoreConfigKey)===E.matchedData?.formConfig),2500);if(L){i(L);const H=L.closest(".pops-panel-forms-fold[data-fold-enable]");H&&(H.querySelector(".pops-panel-forms-fold-container").click(),await h.sleep(500)),i(L,()=>{s(L);});}else g.error("未找到对应的菜单项");return {isFind:true,data:E}}});}),w},B=z=>{const k=new RegExp(z,"i"),w=[],b=(T,C)=>{for(let E=0;E<T.length;E++){const L=T[E],H=L.views;if(H&&Array.isArray(H)){const G=h.deepClone(C);if(L.type==="deepMenu"){const Ae=h.queryProperty(G,W=>W?.next?{isFind:false,data:W.next}:{isFind:true,data:W});Ae.next={name:L.text};}b(H,G);}else {let G,Ae;if(L.type==="own"){const Y=Reflect.get(L.attributes||{},Ue);Y&&(typeof Y.text=="string"&&(G=Y.text),typeof Y.desc=="string"&&(Ae=Y.desc));}else G=L.text,Ae=Reflect.get(L,"description");const W=[G,Ae],re=W.findIndex(Y=>{if(typeof Y=="string")return Y.match(k)});if(re!==-1){const Y=h.deepClone(C),me=h.queryProperty(Y,oe=>oe?.next?{isFind:false,data:oe.next}:{isFind:true,data:oe});me.next={name:G,matchedData:{path:"",formConfig:L,matchedText:W[re],description:Ae}};const Ie=[];h.queryProperty(Y,oe=>{const ze=oe?.name;return typeof ze=="string"&&ze.trim()!==""&&Ie.push(ze),oe?.next?{isFind:false,data:oe.next}:{isFind:true,data:oe}});const He=Ie.join(_.escapeHtml(" - "));me.next.matchedData.path=He,w.push(Y);}}}};for(let T=0;T<A.length;T++){const C=A[T];if(!C.views||C.isBottom&&C.id==="script-version")continue;const E=C.views;if(E&&Array.isArray(E)){let L=C.title;typeof L=="function"&&(L=L()),b(E,{index:T,name:L});}}const U=document.createDocumentFragment();for(const T of w){let C=M(T);U.appendChild(C);}I(),P.append(U);};c.on(x,"input",h.debounce(z=>{c.preventEvent(z);let k=c.val(x).trim();if(k===""){I();return}B(k);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(v=>{c.on(v,"dblclick",o);});let l=null,d=false,p,f=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(v,y)=>{f=true,clearTimeout(p),p=void 0,d&&l===y?(d=false,l=null,o(v)):(p=setTimeout(()=>{d=false;},200),d=true,l=y);},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`,gt="",vt={init(){m.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),m.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),m.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),m.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");const e=[];return e.push(D(it)),e.push(D(at)),e.push(D(st)),e.push(D(lt)),e.push(D(ct)),e.push(D(`
			...
			`)),c.onReady(()=>{let t=N('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(c.createElement("span",{textContent:"Markdown"}),t),X(".user-content ul li").forEach(i=>{let s=i.firstChild;s?.nodeName==="#text"&&(s.textContent?.startsWith("[x] ")?(s.textContent=s.textContent.replace("[x] ",""),c.prepend(i,`
				...
				`},n=Object.keys(A);if(X(".user-content blockquote").forEach(i=>{Array.from(i.children).forEach(s=>{let o=c.html(s);if(s.nodeName==="P"){let a=n.find(l=>o.toLowerCase().startsWith(l.toLowerCase()));a&&(c.html(s,o.replace(a,"")),c.before(s,A[a]),c.html(s)===""&&s.remove());}});}),X(".user-content > blockquote").forEach(i=>{Array.from(i.querySelectorAll(".markdown-alert-title")).forEach(s=>{let o=c.createElement("div",{className:"markdown-alert markdown-alert-tip"},{"data-type":s.getAttribute("data-type")});for(;s.nextSibling&&!s.nextSibling?.classList?.contains("markdown-alert-title");)c.append(o,s.nextSibling);c.prepend(o,s),c.before(i,o);});}),K.isHome())e.push(D(ft));else if(K.isScriptsFeedback()){e.push(D(gt));let i=N('.radio-label[for*="discussion_rating_0"]');i&&(i.innerHTML=i.innerHTML.replace("不评分",'<span class="rating-icon rating-icon-none">不评分</span>'));let s=N('.radio-label[for*="discussion_rating_2"]');s&&(s.innerHTML=s.innerHTML.replace("差评",'<span class="rating-icon rating-icon-bad">差评</span>'));let o=N('.radio-label[for*="discussion_rating_3"]');o&&(o.innerHTML=o.innerHTML.replace("一般",'<span class="rating-icon rating-icon-ok">一般</span>'));let a=N('.radio-label[for*="discussion_rating_4"]');a&&(a.innerHTML=a.innerHTML.replace("好评",'<span class="rating-icon rating-icon-good">好评</span>'));}else K.isScriptAdmin()&&(N('input[type="submit"][name="update-only"]')||e.push(D(`
					...
					`)));}),e},beautifyGreasyforkBeautify(){u.info("美化 Greasyfork Beautify脚本");const e=[];return e.push(D(ut)),h.isPhone()?e.push(D(`
				section#script-info,
			...
			</div>`};if(h.isNull(e))g.error(r.t("未获取到【脚本列表】"));else {let A=g.loading(t(O.getScriptName(e[0])),{isHTML:true}),n=0,i=0;for(let s=0;s<e.length;s++){let o=e[s],a=O.getScriptId(o);u.success("更新："+o);let l=O.getScriptName(o);A.setHTML(t(l,s+1));let d=await F.getSourceCodeSyncFormDataInfo(a);if(d){const{formData:p,url:f}=d;await F.sourceCodeSync(a,p,f)?(g.success(r.t("源代码同步成功，3秒后更新下一个")),await h.sleep(3e3),n++):(g.error(r.t("源代码同步失败")),i++);}else g.error(r.t("源代码同步失败")),i++;}A.close(),n===0?g.error(r.t("全部更新失败")):g.success(r.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:n,failedNums:i,scriptUrlListLength:e.length}),{isHTML:true});}},handleLocalGotoCallBack(){if(m.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(m.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!K.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_scriptList",true),q.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=q.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];X("#user-script-list-section li a.script-link").forEach(t=>{e=e.concat(O.getAdminUrl(t.href));}),q.updateScript(e);}else if(m.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(m.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!K.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),q.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=q.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];X("#user-unlisted-script-list li a.script-link").forEach(t=>{e=e.concat(O.getAdminUrl(t.href));}),q.updateScript(e);}else if(m.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(m.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!K.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),q.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=q.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];X("#user-library-script-list li a.script-link").forEach(t=>{e=e.concat(O.getAdminUrl(t.href));}),q.updateScript(e);}}},Se={$key:{DB_KEY:"data"},$data:{db:null},init(){this.$data.db=this.getDB(),m.execMenuOnce("rememberReplyContent",()=>{this.rememberReplyContent();}),m.execMenu("gf-autoClearRememberReplayContent",e=>{this.autoClearRememberReplayContent(e.value);});},getDB(){const e="reply_record",t="textarea_text";return new h.indexedDB(e,t,2)},async rememberReplyContent(){const e="记住回复内容 -- ";let t=X("form");if(!t.length){u.warn(e+"不存在表单");return}try{await this.clearRelayHistoryRememberContentText();}catch(A){u.error(A);}t.forEach(async A=>{let n=A.querySelector("textarea"),i=A.querySelector('input[type="submit"]');n&&i&&(u.success("开始监听form --- 记住回复内容",A),this.$data.db.get(this.$key.DB_KEY).then(s=>{if(!s.data)return;let o=s.data.findIndex(l=>this.checkUrlIsSame(window.location.href,l.url));if(o==-1)return;let a=s.data[o].text;u.success("填入历史输入内容："+a),n.value=a;}),c.on(n,["propertychange","input"],h.debounce(s=>{let o={url:window.location.href,text:n.value,time:Date.now()};this.$data.db.get(this.$key.DB_KEY).then(a=>{if(!a.success&&a.event&&a.event.type!=="success"){u.warn(a);return}a.data==null&&(a.data=[]);let l=a.data.findIndex(d=>this.checkUrlIsSame(window.location.href,d.url));l!==-1?h.isNull(o.text)?a.data.splice(l,1):a.data[l]=h.assign(a.data[l],o):a.data=a.data.concat(o),this.$data.db.save(this.$key.DB_KEY,a.data).then(d=>{d.success||u.error("保存失败",d);});});},25)),c.on(A,"submit",s=>{u.info("表单提交，刷新页面后清理内容："+window.location.href),$("delyClear_rememberReplyContent_url",window.location.href);},{capture:true}));});},async clearRelayHistoryRememberContentText(){const e="delyClear_rememberReplyContent_url";let t=ee(e);if(t){let A=await this.$data.db.get(this.$key.DB_KEY);if(!A.data){u.info("表单记录：数据库是空的");return}let n=A.data.findIndex(s=>this.checkUrlIsSame(t,s.url));if(n==-1){u.info("表单记录：已不存在该数据"),ve(e);return}A.data.splice(n,1),(await this.$data.db.save(this.$key.DB_KEY,A.data)).success?(u.success("表单记录：成功清除"),ve(e)):u.error("表单记录：清除失败",A);}},checkUrlIsSame(e,t){let A=new URL(e),n=new URL(t);return A.origin===n.origin&&A.pathname===n.pathname},autoClearRememberReplayContent(e){const t="gf-last-time-autoClearRememberReplayContent";let A=ee(t),n=e*24*60*60*1e3;if(A)if(Date.now()-A>n)$(t,Date.now());else return;$(t,Date.now());},async getAllRememberReplyContent(){return (await this.$data.db.get(this.$key.DB_KEY)).data??[]},async clearAllRememberReplyContent(){return (await this.$data.db.delete(this.$key.DB_KEY)).success}};class yt{KEY="short-cut";#e={otherShortCutOptions:[],localOptions:[],currentWaitEnterPressInstanceHandler:null};#t={isWaitPress:false};constructor(t){typeof t=="string"&&(this.KEY=t),this.initData();}initConfig(t,A){this.hasOption(t)||this.setOption(t,A);}initData(t){this.#e.localOptions.length=0,this.#e.localOptions=t??this.getLocalAllOptions();}initGlobalKeyboardListener(t,A){if(!this.#e.localOptions.length){u.warn("快捷键配置为空");return}const n=this,i=function(a,l){c.onKeyboard(a,"keydown",(d,p,f,v)=>{if(n.#t.isWaitPress)return;A?.isPrevent&&c.preventEvent(v);const x=JSON.stringify({keyName:d,keyValue:p,ohterCodeList:f}),P=n.#e.localOptions.find(I=>{const M=I.value;if(JSON.stringify(M)===x)return  true});P&&P.key in l&&(u.info("调用快捷键",P),l[P.key].callback());},{capture:!!A?.capture});},s={},o={};Object.keys(t).forEach(a=>{const l=t[a];(l.target==null||typeof l.target=="string"&&l.target==="")&&(l.target="window"),l.target==="window"?Reflect.set(s,a,l):Reflect.set(o,a,l);}),i(window,s),c.onReady(()=>{Object.keys(o).forEach(async a=>{const l=o[a],d={};let p=null;typeof l.target=="string"?p=await c.waitNode(l.target,1e4):typeof l.target=="function"?p=await l.target():p=l.target,p&&(Reflect.set(d,a,l),i(p,d));});});}isWaitKeyboardPress(){return this.#t.isWaitPress}getStorageKey(){return this.KEY}getLocalAllOptions(){return ee(this.KEY,[])}hasOption(t){return !!this.getLocalAllOptions().find(i=>i.key===t)}hasOptionValue(t){return this.hasOption(t)?this.getOption(t)?.value!=null:false}getOption(t,A){return this.getLocalAllOptions().find(s=>s.key===t)??A}setOption(t,A){const n=this.getLocalAllOptions(),i=n.findIndex(s=>s.key===t);i==-1?n.push({key:t,value:A}):Reflect.set(n[i],"value",A),this.initData(n),$(this.KEY,n);}emptyOption(t){let A=false;const n=this.getLocalAllOptions(),i=n.findIndex(s=>s.key===t);return i!==-1&&(n[i].value=null,A=true),this.initData(n),$(this.KEY,n),A}deleteOption(t){let A=false;const n=this.getLocalAllOptions(),i=n.findIndex(s=>s.key===t);return i!==-1&&(n.splice(i,1),A=true),this.initData(n),$(this.KEY,n),A}translateKeyboardValueToButtonText(t){let A="";return t.ohterCodeList.forEach(n=>{A+=h.stringTitleToUpperCase(n,true)+" + ";}),A+=h.stringTitleToUpperCase(t.keyName),A}getShowText(t,A){if(this.hasOption(t)){const n=this.getOption(t);return n.value==null?A:this.translateKeyboardValueToButtonText(n.value)}else return A}async enterShortcutKeys(t){return new Promise(A=>{this.#t.isWaitPress=true;const n=c.onKeyboard(window,"keyup",(i,s,o)=>{const a={keyName:i,keyValue:s,ohterCodeList:o};let l={};try{const d=JSON.stringify(a);let p=this.getLocalAllOptions();Array.isArray(this.#e.otherShortCutOptions)&&(p=p.concat(this.#e.otherShortCutOptions));for(let f=0;f<p.length;f++){let v=p[f];if(v.key===t)continue;const y=JSON.stringify(v.value);let x=!1;if(v.value!=null&&d===y&&(x=!0),x){l={status:!1,key:v.key,option:a};return}}this.setOption(t,a),l={status:!0,key:t,option:a};}catch(d){u.error(d),l={status:false,key:t,option:a};}finally{this.#t.isWaitPress=false,n.removeListen(),this.#e.currentWaitEnterPressInstanceHandler=null,A(l);}});this.#e.currentWaitEnterPressInstanceHandler=null,this.#e.currentWaitEnterPressInstanceHandler=()=>{this.#t.isWaitPress=false,n.removeListen();};})}cancelEnterShortcutKeys(){typeof this.#e.currentWaitEnterPressInstanceHandler=="function"&&this.#e.currentWaitEnterPressInstanceHandler();}}const Re={shortCut:new yt,shortOption:{"gf-quickReply":{target:()=>{let e=N("form textarea"),t=N('input[name="commit"][type="submit"]');if(e){if(!t){u.error("页面不存在【发表回复】按钮");return}}else {u.error("页面不存在输入框");return}return u.success("监听快捷键：gf-quickReply"),e},callback(){if(document.activeElement){let e=document.activeElement.closest("form");if(!e){u.error("当前activeElement不在表单内，无法触发快捷键");return}let t=e.querySelectorAll('input[name="commit"][type="submit"]');if(!t.length){u.error("表单内不存在【发表回复】按钮");return}t.length>1&&u.warn("表单内存在多个【发表回复】按钮，只触发第一个"),t[0].click();}else u.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},te={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){u.info("论坛-过滤"),D(`
...
`),h.isNull(e))return;e=e.toString().trim();let n=e+"##"+t;A+=n,this.setValue(A);},getValue(){return m.getValue(this.key,"")}},wt={init(){this.readBgColor(),c.onReady(()=>{m.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),D(`
      ...
      `);const e=new h.LockFunction(()=>{const t=m.getValue("discussions-addShortcutOperationButton"),A=m.getValue("discussions-addReportButton");t&&this.addFilterButton(),A&&this.addReportButton(),(t||A)&&this.addMoreButton({addFilterButton:t,addReportButton:A});});h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),te.init();},readBgColor(){u.info("设置已读背景颜色");const e=m.getValue("discussions-readBgColor"),A=new h.ColorConversion().getDarkColor(e,.8);return D(`
        ...
        `)},addFilterButton(){const e="discussion-filter-button";te.getElementList().forEach(t=>{if(t.querySelector(`.${e}`))return;const n=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`},{style:"flex: 0;","data-type":"filter"}),s=i.querySelector(`.${e}`);n.appendChild(i),c.on(s,"click",o=>{c.preventEvent(o);const a=te.parseDiscuessionListContainerInfo(t);if(!a)return;const l="data-filter-key",d="data-filter-value",p=Q.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:false},content:{text:`
                ...
                `:""}
						...
						`}),f=p.$shadowRoot.querySelector(".pops-alert-content");if(a.scriptId==null&&f.querySelector(`button[${l}="scriptId"]`)?.remove(),a.scriptName==null&&f.querySelector(`button[${l}="scriptName"]`)?.remove(),a.postUserId==null&&f.querySelector(`button[${l}="postUserId"]`)?.remove(),a.replyUserId!=null){const v=c.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:a.replyUserId})});v.setAttribute(l,"scriptAuthorId"),v.setAttribute(d,"^"+a.replyUserId+"$"),f.appendChild(v);}c.on(p.$shadowRoot,"click",`button[${l}]`,v=>{c.preventEvent(v);const y=v.target,x=y.getAttribute(l),P=y.getAttribute(d);te.addValue(x,P),p.close(),te.filter(),g.success(r.t("添加成功"));});});});},addReportButton(){const e="discussion-report-button";te.getElementList().forEach(t=>{if(t.querySelector(`.${e}`))return;let n=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`},{style:"flex: 0;","data-type":"more"});const o=s.querySelector(`.${t}`),a=[];if(e.addFilterButton&&a.push({text:r.t("过滤"),callback:()=>{const p=c.parent(n).querySelector('.discussion-meta-item[data-type="filter"] button');if(!p){g.error(r.t("未找到【过滤】按钮"));return}p.click();}}),e.addReportButton&&a.push({text:r.t("举报"),callback:()=>{const p=c.parent(n).querySelector('.discussion-meta-item[data-type="report"] button');if(!p){g.error(r.t("未找到【举报】按钮"));return}p.click();}}),!a.length)return;const l=Q.rightClickMenu({position:"absolute",limitPositionYInView:false,data:a});l.removeContextMenuEvent(document.documentElement),c.on(o,"click",d=>{c.preventEvent(d);const p=o.getBoundingClientRect();l.PopsContextMenu.contextMenuEvent(new PointerEvent("contextmenu",{clientX:p.left+window.scrollX,clientY:p.top+p.height+window.scrollY}),o);}),i.appendChild(s);});}},De={isCurrentLoginUserHome(){const e=le.getCurrentLoginUserId();return !!(e!=null&&K.isUsers()&&window.location.pathname.includes("/"+e))},monacoEditor(){return new Promise(e=>{const t="0.52.2",A="monaco-editor-ready";if(R.monaco){e(R.monaco);return}const n=g.loading(r.t("monaco-editor加载中...")),i=c.createElement("script",{type:"module",defer:true,innerHTML:`
				...
				`});c.append(document.head||document.documentElement,i),c.on(R,A,()=>{const s=R.monaco;u.success("网络加载monaco编辑器成功"),n.close(),e(s);},{once:true});})}},bt={init(){m.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();}),m.execMenuOnce("code-use-monaco-editor",()=>{this.coverEditorWithMonaco();});},repairCodeLineNumber(){u.info("修复代码的行号显示不够问题"),m.execMenuOnce("beautifyGreasyforkBeautify",()=>{D(`
				.code-container pre code .marker{
					padding-left: 6px;
				}	
				`);}),c.waitNode("#script-content div.code-container pre.prettyprint ol").then(e=>{e.childElementCount>=1e3&&(u.success(`当前代码行数${e.childElementCount}行，超过1000行，优化行号显示问题`),D(`
                    pre.prettyprint{
                        padding-left: 26px;
                    }
					`));});},coverEditorWithMonaco(){u.info("使用monacoEditor替换编辑器"),D(`
			.monaco-editor{
...
`,Ct={init(){m.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),m.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();}),c.onReady(()=>{m.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");const e=[];return e.push(D(xt)),e.push(_.addBlockCSS(".version-number",".version-date",".version-changelog")),c.onReady(function(){const t=N("ul.history_versions");if(!t){g.error(r.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(A=>{const n=A.querySelector(".version-number a").href,i=A.querySelector(".version-number a").innerText,s=A.querySelector(".version-date")?.getAttribute("datetime"),o=A.querySelector(".version-changelog")?.innerHTML||"",a=c.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(s,r.t("yyyy年MM月dd日 HH:mm:ss"))}),l=c.createElement("div",{className:"script-tag",innerHTML:`
          ...
          </div>`}),d=c.createElement("div",{className:"script-note-box-body",innerHTML:o});c.append(A,[a,l,d]);});}),e},addExtraTagButton(){u.info("添加额外的标签按钮"),X(".script-tag-version:has(a[href])").forEach(e=>{const t=e.querySelector("a");if(!t)return;const A=new URL(t.href),n=O.getScriptId(A.pathname),i=A.searchParams.get("version"),s=O.getScriptName(A.toString()),o=O.getInstallUrl(n,i,s),a=O.getCodeUrl(n,i),l=c.createElement("div",{className:"scripts-tag-install",innerHTML:`
        ...
        `});c.after(e,l);});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),De.monacoEditor().then(e=>{c.onReady(()=>{X('#script-content form[action*="/diff"] input[type="submit"]').forEach(t=>{let A=c.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});c.after(t,A),c.on(A,"click",async n=>{c.preventEvent(n);const i=t.closest("form"),s=new FormData(i),o=s.get("v1"),a=s.get("v2");if(o===a){g.warning(r.t("版本号相同，不需要比较源码"));return}u.info(`对比版本：${o} vs ${a}`);const l=g.loading(r.t("正在获取对比文本中...")),d=O.getScriptId(),p=await F.getScriptInfo(d);if(!p){l.close();return}u.info("脚本信息：",p);const f=p.code_url,v=f.replace(new RegExp(`/${d}/`),`/${d}/${o}/`),y=f.replace(new RegExp(`/${d}/`),`/${d}/${a}/`);u.info(`请求版本代码：${v}`),u.info(`请求版本代码：${y}`);let x="",P="";const[I,M]=await Promise.all([V.get(v,{timeout:2e4}),V.get(y,{timeout:2e4})]);if(l.close(),!I.status||!M.status)return;x=I.data.responseText,P=M.data.responseText;let{recovery:B}=_.lockScroll(),z=Q.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
								<div class="monaco-editor-diff-container">
									<div class="monaco-editor-diff"></div>
								</div>
								`},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},btn:{ok:{enable:false},close:{callback(T,C){T.close(),B();}}},zIndex(){let T=h.getMaxZIndex(),C=Q.config.InstanceUtils.getPopsMaxZIndex().zIndex;return h.getMaxValue(T,C)+100},useShadowRoot:false,width:"90vw",height:"90vh",drag:true,style:`
		...
		`});c.on(i.$shadowRoot,"click",".collect-add-script-id",async function(s){const o=s.target.closest(".user-collect-item"),a=o.dataset.id;if(h.isNull(a)){g.error(r.t("获取收藏集id失败"));return}o.dataset.name;const l=g.loading(r.t("添加中..."));try{const d=await F.getUserCollectionInfo(t,a);if(!d)return;if(n(d,e)){g.warning(r.t("该脚本已经在该收藏集中"));return}const p=h.cloneFormData(d),f=h.cloneFormData(d);p.set("add-script",e.toString()),p.set("script-action","i"),f.append("scripts-included[]",e.toString()),f.set("save","1");const v=new URLSearchParams(p),y=new URLSearchParams(f),x=Array.from(v).map(([b,U])=>`${encodeURIComponent(b)}=${encodeURIComponent(U)}`).join("&"),P=Array.from(y).map(([b,U])=>`${encodeURIComponent(b)}=${encodeURIComponent(U)}`).join("&");u.info("添加的数据",x),u.info("保存的数据",P);const I=await F.updateUserSetsInfo(t,a,x);if(!I)return;const M=I.querySelector(".change-script-set");if(!M){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}const B=M.querySelector("section");if(!B){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}const z=B.querySelector(".alert");if(z){Q.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:z.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:Z.info.width,height:Z.info.height});return}const k=new FormData(M);if(!n(k,e)){u.error("添加失败，提交的添加请求中不包含该脚本id"),g.error(r.t("添加失败，表单数据中不包含该脚本"));return}await F.updateUserSetsInfo(t,a,P),g.success(r.t("添加成功"));}catch(d){console.error(d);}finally{l.close();}}),c.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(s){const o=s.target.closest(".user-collect-item"),a=o.dataset.id;if(h.isNull(a)){g.error(r.t("获取收藏集id失败"));return}o.dataset.name;const l=g.loading(r.t("删除中..."));try{const d=await F.getUserCollectionInfo(t,a);if(!d)return;if(!n(d,e)){g.info(r.t("已删除：{{scriptId}}",{scriptId:e}));return}const p=h.cloneFormData(d,(k,w)=>k==="scripts-included[]"&&typeof w=="string"&&w.toString().trim()===e.toString().trim()),f=h.cloneFormData(p);p.set("remove-scripts-included[]",e.toString()),p.set("remove-selected-scripts","i"),p.delete("script-action"),f.set("save","1");const v=new URLSearchParams(p),y=new URLSearchParams(f),x=Array.from(v).map(([k,w])=>`${encodeURIComponent(k)}=${encodeURIComponent(w)}`).join("&"),P=Array.from(y).map(([k,w])=>`${encodeURIComponent(k)}=${encodeURIComponent(w)}`).join("&");u.info("删除的数据",x),u.info("保存的数据",P);const I=await F.updateUserSetsInfo(t,a,x);if(!I)return;const M=I.querySelector(".change-script-set");if(!M){g.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}const B=new FormData(M);if(n(B,e)){u.error("删除失败，提交的删除请求中包含该脚本id"),g.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await F.updateUserSetsInfo(t,a,P),g.success(r.t("删除成功"));}catch(d){console.error(d);}finally{l.close();}});},Lt={init(){K.isCode()?bt.init():K.isVersion()&&Ct.init(),K.isCodeStrict()&&(m.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),m.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),m.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),m.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),c.onReady(()=>{m.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){u.info("添加收藏按钮"),c.waitNode("ul#script-links li.current span").then(()=>{const e=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
					</a>`});c.append(N("ul#script-links"),e),c.on(e,"click",()=>{const t=O.getScriptId(window.location.pathname);if(!t){u.error(window.location.pathname),g.error(r.t("获取脚本id失败"));return}qe(t);});});},fullScreenOptimization(){u.info("F11全屏，F键代码全屏"),D(`
    ...
    .code-wide-screen{
        ...
        `);let e=false;c.onKeydown(R,function(t){if(t.key.toLowerCase()==="f"){const A=N(".monaco-editor")||N("#script-content div.code-container code");t.altKey&&t.shiftKey?(u.info("宽屏"),c.preventEvent(t),A.classList.contains("code-wide-screen")?A.classList.remove("code-wide-screen"):A.classList.add("code-wide-screen")):!t.altKey&&!t.ctrlKey&&!t.shiftKey&&!t.metaKey&&(u.info("全屏"),c.preventEvent(t),e?(h.exitFullScreen(A),e=false):(h.enterFullScreen(A),e=true));}},{capture:true});},setFindCodeSearchBtn(){u.info("设置代码搜索按钮(对于库)"),c.waitNode("ul#script-links li.current span").then(()=>{const e=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("寻找引用")}</span>
					</a>`});c.append(N("ul#script-links"),e),c.on(e,"click",async function(){let t=O.getScriptId(window.location.pathname);if(!t){u.error(window.location.pathname),g.error(r.t("获取脚本id失败"));return}window.location.href=O.getCodeSearchUrl(`/scripts/${t}`);});});},async scriptHomepageAddedTodaySUpdate(){if(!N("#install-area"))return;u.info("脚本首页新增【今日检查】");const e=await F.getScriptStats(O.getScriptId());if(!e)return;u.info("统计信息",e);const t=e[h.formatTime(void 0,"yyyy-MM-dd")];if(!t){u.error("今日份的统计信息不存在");return}const A=t.update_checks;u.info("今日统计信息",t),c.after("dd.script-show-daily-installs",c.createElement("dt",{className:"script-show-daily-update_checks",innerHTML:`<span>${r.t("今日检查")}</span>`})),c.after("dt.script-show-daily-update_checks",c.createElement("dd",{className:"script-show-daily-update_checks",innerHTML:"<span>"+A+"</span>"}));},addCopyCodeButton(){u.info("添加复制代码按钮"),c.waitNode("div#script-content div.code-container").then(e=>{const t=c.createElement("button",{textContent:r.t("复制代码")},{style:"margin-bottom: 1em;"});c.on(t,"click",async function(){const A=g.loading(r.t("加载文件中...")),n=O.getScriptId(),i=await F.getScriptInfo(n);if(!i){A.close();return}const s=i.code_url;u.success("代码地址：",s);const o=await V.get(s);if(!o.status){A.close();return}A.close(),h.copy(o.data.responseText),g.success(r.t("复制成功"));}),c.before(e,t);});}},ae={key:"gf-shield-rule",init(){u.info("脚本过滤");let e=new h.LockFunction(()=>{this.filter();},50);c.onReady(()=>{if(De.isCurrentLoginUserHome()){u.warn("当前在已登录的账户主页下，禁用脚本过滤");return}h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}}),e.run();});},getElementList(){return [...Array.from(X("ol.script-list li[data-script-name]"))]},filter(){this.getElementList().forEach(e=>{let t=le.parseScriptListInfo(e),A=this.getValue().split(`
`);for(let n=0;n<A.length;n++){let i=A[n],s=i.split("##"),o=s[0],a=s[1];if(o==="scriptRatingScore"){let l=parseFloat(a.slice(1));if(a.startsWith(">")){if(t.scriptRatingScore>l){u.info("触发脚本过滤规则",[i,t]),e.remove();break}}else if(a.startsWith("<")&&t.scriptRatingScore<l){u.info("触发脚本过滤规则",[i,t]),e.remove();break}}else if(o in t||o==="scriptDescription"){if(typeof a!="string")continue;let l=new RegExp(a,"ig");if(String(t[o]).match(l)){u.info("触发脚本过滤规则",i,t),e.remove();break}}}});},setValue(e){m.setValue(this.key,e);},addValue(e,t){let A=this.getValue();if(A.trim()!==""&&(A+=`
      ...
      `);function t(){let l=N("#gm-script-filter-controls");if(!l)return;let d=l?.shadowRoot;if(!d)return;let p=d.querySelector(".pops-filter-controls_inner"),f=d.querySelector(".pops-filter-search-container");if(p&&f)return {$filterControl:p,$search:f}}let A=t();if(A)return A;let n=c.createElement("div",{id:"gm-script-filter-controls"}),i=n.attachShadow({mode:"open"});i.appendChild(c.createElement("style",{innerHTML:`
        ...
        .pops .pops-panel-item-left-main-text{
          ...
          padding: 0px;
			...
			`}),o=s.querySelector(".pops-filter-controls_inner"),a=s.querySelector(".pops-filter-search-container");return i.appendChild(s),c.before(e,n),{$filterControl:o,$search:a}}},zt={init(){c.onReady(()=>{Te.waitScritList().then(e=>{if(!e){u.error("未找到脚本列表节点，无法继续执行");return}m.onceExec("GreasyforkScriptsSearch",()=>{let{$filterControl:t,$search:A}=Te.addFilterControls(e);this.addFilterControlsItem(A,t);});});});},addFilterControlsItem(e,t){let A=Q.config.PanelHandlerComponents(),n=[{name:r.t("名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching-enable",callback:(o,a)=>{try{return !a.scriptName.match(new RegExp(o,"i"))}catch(l){return u.error(l),!a.scriptName.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("描述"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptDescWholeWordMatching-enable",callback:(o,a)=>{try{return !a.scriptDescription.match(new RegExp(o,"i"))}catch{return !a.scriptDescription.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("名称/描述"),desc:r.t("任一全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable",callback:(o,a)=>{let l=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptTitleWholeWordMatching").callback(o,a),d=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptDescWholeWordMatching").callback(o,a);return l&&d},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleWholeWordMatching-enable"]','.gm-script-control-item[data-storage-key="gf-script-search-filterScriptDescWholeWordMatching-enable"]']},{name:r.t("作者名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching-enable",callback:(o,a)=>{try{return !a.scriptAuthorName.match(new RegExp(o,"i"))}catch{return !a.scriptAuthorName.match(o)}}}],i=()=>{let o=e.querySelector("input");if(o)return o.value;let a=new URLSearchParams(window.location.search);return a.get("q")?.trim()||a.get("c")?.trim()||""},s=()=>{let o=i();ae.getElementList().forEach(l=>{let d=le.parseScriptListInfo(l),p=n.map(f=>{if(o=="")return  false;if(ee(f.STORAGE_KEY))return f.callback(o,d)}).filter(f=>typeof f=="boolean");if(p.length!==0){let f=false;p.forEach(v=>{f=f||v;}),f?c.hide(l,false):c.show(l,false);}else c.show(l,false);});};if(m.getValue("gf-script-search-addFilterSearchInput")){let o=A.createSectionContainerItem_input({type:"input",className:"gm-script-search-input",getValue(){let a=i();return m.getValue("gf-script-search-addFilterSearchInput-text")||a||""},description:r.t("自动执行过滤"),placeholder:r.t("过滤的关键词"),text:r.t("关键词"),callback:h.debounce((a,l)=>{m.setValue("gf-script-search-addFilterSearchInput-text",l.toString()),s();},500)}).$el;c.append(e,o);}n.forEach(o=>{if(!m.getValue(o.ENABLE_KEY))return;u.info(`添加按钮${o.name}`);let a=A.createSectionContainerItem_switch({type:"switch",className:"gm-script-control-item",text:o.name,description:o.desc,attributes:{"data-storage-key":o.STORAGE_KEY},getValue(){let l=ee(o.STORAGE_KEY,false);return l=!!l,s(),l},callback(l,d){if($(o.STORAGE_KEY,d),s(),d&&Array.isArray(o.mutualExclusionSwitch)){let p=a.closest(".pops");o.mutualExclusionSwitch.forEach(f=>{let v=p.querySelector(f);v&&v.querySelector("input")?.checked&&v.querySelector(".pops-panel-switch__core")?.click();});}}}).$el;c.append(t,a);});}},Mt=`section.text-content {\r
...
`,kt={init(){m.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),c.onReady(()=>{m.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return u.info("美化对话框"),D(Mt)},beautifyPrivateMessageList(){u.info("美化私信列表"),D(`
		...
		`),X("section.text-content ul li").forEach(e=>{let t=e.querySelector('a[href*="conversations"]'),A=t.href,n=t.textContent?.split(" ")[1],i=e.querySelector("a.user-link"),s=null,o=null,a=null;if(i){s=i.textContent,o=i.href;let l=e.querySelector("relative-time");new Date(l.getAttribute("datetime")),a=l.shadowRoot.lastChild.textContent;}e.classList.add("user-conversations-item"),O.getUserId(),e.innerHTML=`
			...
			`;});}},St={init(){m.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),m.execMenuOnce("gf-scripts-filter-enable",()=>{ae.init();}),m.execMenuOnce("beautifyCenterContent",()=>Xe.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),_.addBlockCSS("#about-user"),c.onReady(()=>{let e=N("#about-user");if(!e){u.error("#about-user元素不存在");return}e=e.cloneNode(true),le.registerTopNavMenu({name:r.t("控制台"),className:"scripts-console",clickEvent(t){Q.alert({title:{text:r.t("控制台"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:Z.setting.width,height:Z.setting.height,zIndex:h.getMaxZIndex(100),style:`
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(e);}});});}},Et={init(){if(K.isImageSource()){u.info("Router: 资源界面，不执行脚本功能");return}m.execMenu("checkPage",()=>{this.checkPage();}),vt.init(),Re.init(),K.isScript()&&Lt.init(),(K.isScriptList()||K.isScriptLibraryList()||K.isScriptCodeSearch()||K.isScriptsBySite())&&Xe.init(),K.isDiscuessions()?(u.info("Router: 讨论页面"),wt.init()):K.isUsers()?(u.info("Router: 用户页面"),St.init(),K.isUsersConversations()&&(u.info("Router-next: 私聊用户页面"),kt.init())):(K.isScriptSearch()||K.isScriptsBySite()||K.isScriptCodeSearch()||K.isScriptLibraryListSearch())&&(u.info("Router: 脚本搜索页面"),zt.init()),m.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),c.onReady(()=>{q.initEnv(),mt.init(),Se.init(),q.handleLocalGotoCallBack(),m.execMenuOnce("fixImageWidth",()=>this.fixImageWidth()),this.languageSelectorLocale(),m.execMenuOnce("optimizeImageBrowsing",()=>{this.optimizeImageBrowsing();}),m.execMenuOnce("overlayBedImageClickEvent",()=>{this.overlayBedImageClickEvent();}),K.isCodeStrict()||m.execMenuOnce("addMarkdownCopyButton",()=>{this.addMarkdownCopyButton();}),m.execMenuOnce("queryUserRegisterTime",()=>this.queryUserRegisterTime());});},fixImageWidth(){if(window.innerWidth<window.innerHeight)return u.info("修复图片显示问题"),D(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `)},optimizeImageBrowsing(){u.info("优化图片浏览"),D(ke("ViewerCSS")),D(`
        ...
        `);function e(A=[],n=0){let i="";A.forEach(a=>{i+=`<li><img data-src="${a}" loading="lazy"></li>`;});let s=c.createElement("ul",{innerHTML:i}),o=new Ve(s,{inline:false,url:"data-src",zIndex:h.getMaxZIndex()+100,hidden:()=>{o.destroy();}});n=n<0?0:n,o.view(n),o.zoomTo(1),o.show();}function t(A){return A.getAttribute("data-src")||A.getAttribute("src")||A.getAttribute("alt")}c.on(document,"click","img",function(A){let n=A.target;if(n.parentElement?.localName==="a"&&n.hasAttribute("data-screenshots")||n.closest(".viewer-container")||n.closest(".lum-lightbox-position-helper"))return;let i=n.closest(".user-content"),s=[],o=0,a=[],l=t(n);if(l){if(l.startsWith("https://img.shields.io"))return;if(l.startsWith("/vite/assets/"))return}i?(i.querySelectorAll("img").forEach(d=>{a.push(d);let p=t(d),f=d.parentElement;f?.localName==="a"&&(p=f.getAttribute("data-href")||f.href),s.push(p);}),o=a.indexOf(n),o===-1&&(o=0)):(s.push(l),o=0),u.success("点击浏览图片👉",s,o),e(s,o);}),X(".user-screenshots").forEach(A=>{let n=A.querySelector("a");if(!n)return;let i=n.getAttribute("data-href")||n.getAttribute("href"),s=A.querySelector("img");s&&(s.setAttribute("data-screenshots","true"),s.setAttribute("data-src",i),n.setAttribute("href","javascript:;"),c.after(n,s),n.remove());});},overlayBedImageClickEvent(){u.info("覆盖图床图片的parentElement的a标签"),X(".user-content a>img").forEach(e=>{const t=e.parentElement,A=t.getAttribute("href");if(t.setAttribute("data-href",A),t.removeAttribute("href"),A.startsWith("/rails/active_storage/blobs/redirect")){u.info("该图片是上传到Greasyfork的图片，拦截默认行为，不做提示");return}c.on(t,"click",()=>{g.warning(`<div style="overflow-wrap: anywhere;">${r.t("拦截跳转：")}<a href="${A}" target="_blank">${A}</a></div>`,{isHTML:true,zIndex:h.getMaxZIndex()+105});});});},addMarkdownCopyButton(){u.info("在Markdown右上角添加复制按钮"),D(`
        pre{
          position: relative;
        ...
        /* ↑查询按钮 */
      `)]}},ue=function(e,t,A,n,i,s,o,a,l,d){const p={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:i,buttonIconIsLoading:s,buttonType:o,buttonText:A,callback(f){typeof a=="function"&&a(f);},afterAddToUListCallBack:l};return Reflect.set(p.attributes,Le,()=>{p.disable=false;}),p},Dt=function(e,t,A,n,i,s="default",o){const a=typeof i=="function"?i():i;typeof n=="object"&&n!=null&&o.initConfig(A,n);const l=()=>o.getShowText(A,a),d=ue(e,t,l,"keyboard",false,false,s,async p=>{const v=p.target.closest(".pops-panel-button")?.querySelector("span");if(o.isWaitKeyboardPress()){g.warning("请先执行当前的录入操作");return}if(o.hasOptionValue(A))o.emptyOption(A),g.success("清空快捷键");else {const y=g.loading("请按下快捷键...",{showClose:true,onClose(){o.cancelEnterShortcutKeys();}}),{status:x,option:P,key:I}=await o.enterShortcutKeys(A);y.close(),x?(u.success("录入快捷键",P),g.success("录入成功")):g.error(`快捷键 ${o.translateKeyboardValueToButtonText(P)} 已被 ${I} 占用`);}c.html(v,l());});return d.attributes={},Reflect.set(d.attributes,Le,()=>false),d},Be=function(e,t,A,n,i,s="",o,a){const l={text:e,type:"input",inputType:"password",attributes:{},props:{},description:n,placeholder:s,afterAddToUListCallBack:o,getValue(){return this.props[ne].get(t,A)},callback(d,p){this.props[ne].set(t,p);}};return Reflect.set(l.attributes,pe,t),Reflect.set(l.attributes,fe,A),Pe.initComponentsStorageApi("input",l,{get(d,p){return m.getValue(d,p)},set(d,p){m.setValue(d,p);}}),l},Ee=function(e,t,A,n,i,s){const o={type:"own",attributes:{},props:{},createLIElement:e,afterAddToUListCallBack:s};return typeof t=="object"&&t!==null&&Object.keys(t).length>0?Reflect.set(o.attributes,Qe,t):Reflect.set(o.attributes,Le,()=>false),typeof A=="object"&&A!==null&&Reflect.set(o.attributes,Ue,A),o},de=function(e,t,A,n,i,s,o){const a={text:e,type:"select",description:s,attributes:{},props:{},getValue(){return this.props[ne].get(t,A)},callback(l){if(l==null)return;const d=l.value;if(u.info(`选择：${l.text}`),typeof i=="function"&&i(l))return;this.props[ne].set(t,d);},data:n};return Reflect.set(a.attributes,pe,t),Reflect.set(a.attributes,fe,A),Pe.initComponentsStorageApi("select",a,{get(l,d){return m.getValue(l,d)},set(l,d){m.setValue(l,d);}}),a},S=function(e,t,A,n,i,s,o,a,l){const d={text:e,type:"switch",description:i,disabled:o,attributes:{},props:{},getValue(){return this.props[ne].get(t,A)},callback(p,f){const v=!!f;u.success(`${v?"开启":"关闭"} ${e}`),this.props[ne].set(t,v);},afterAddToUListCallBack:(...p)=>{}};return Reflect.set(d.attributes,pe,t),Reflect.set(d.attributes,fe,A),Pe.initComponentsStorageApi("switch",d,{get(p,f){return m.getValue(p,f)},set(p,f){m.setValue(p,f);}}),d},Pe={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new se.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,A){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=A,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,ne,t);}},It=function(e,t,A,n,i,s="",o="text",a,l){const d={text:e,type:"input",inputType:o,attributes:{},props:{},description:n,placeholder:s,afterAddToUListCallBack:a,getValue(){return this.props[ne].get(t,A)},callback(p,f){p.target.validity.valid,this.props[ne].set(t,f);}};return Reflect.set(d.attributes,pe,t),Reflect.set(d.attributes,fe,A),Pe.initComponentsStorageApi("input",d,{get(p,f){return m.getValue(p,f)},set(p,f){m.setValue(p,f);}}),d},je={async UIScriptList(e,t){if(!q.isLogin){g.error(r.t("请先登录账号！"));return}const i=q.getUserLinkElement().href?.split("/")?.pop()?.match(/([0-9]+)/)?.[0],s=Q.loading({mask:{enable:true},$parent:t,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:false}),o=await F.getUserAllInfo(i);if(s.close(),!o)return;u.info(o);const a=e==="script-list"?o.scriptList:o.scriptLibraryList;g.success(r.t("获取成功，共 {{count}} 个",{count:a.length}));for(const l of a){const d=c.createElement("li",{className:"w-script-list-item",innerHTML:`
				...
				`});l.deleted&&(d.classList.add("w-script-deleted"),f.querySelector("button").setAttribute("disabled","true")),c.on(f,"click",async function(){u.success("同步",l);const v=f.querySelector("button"),y=f.querySelector("button span"),x=c.createElement("i",{className:"pops-bottom-icon",innerHTML:Q.config.iconSVG.loading},{"is-loading":true});v.setAttribute("disabled","true"),v.setAttribute("data-icon","true"),y.innerText=r.t("同步中..."),c.before(y,x);const P=l?.id,I=await F.getSourceCodeSyncFormDataInfo(P.toString());if(I){const{formData:M,url:B}=I,z="script[script_sync_type_id]",k="script[sync_type]";if(M.has(z)||M.has(k)){let w="";if(M.has(z)){let T=M.get(z);T.toString()==="1"?w=r.t("手动"):T.toString()==="2"?w=r.t("自动"):T.toString()==="3"&&(w="webhook");}else M.has(k)&&(w=M.get(k));const b=d.querySelector(".w-script-sync-type");b?b.querySelector("p").innerText=r.t("同步方式：{{syncMode}}",{syncMode:w}):c.append(p,`
								<div class="w-script-sync-type">
									<p>${r.t("同步方式：{{syncMode}}",{syncMode:w})}
											...
											`}),i=n.querySelector(".pops-color-choose");i.value=m.getValue(t);const s=c.createElement("style");return c.append(document.head,s),c.on(i,["input","propertychange"],o=>{u.info("选择颜色："+i.value),s.innerHTML=`
												.discussion-read{

...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ae=="function"?ae(e.keyName):"";typeof t=="string"&&t?ce(t):X.addLinkNode(e.url);},async addLinkNode(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,d.ready(()=>{document.head.appendChild(t);}),t},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e}},se={getInstallUrl(e,t,r){return m.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${e}/${t}${r}.user.js`},getCodeUrl(e,t){return m.isNull(t)&&(t=""),`https://greasyfork.org/scripts/${e}/code?version=${t}`},getScriptInfoUrl(e){return `https://greasyfork.org/scripts/${e}.json`}},Ue={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){c.info("美化 历史版本 页面");let e=[];return e.push(w(Ae)),e.push(X.addBlockCSS(".version-number",".version-date",".version-changelog")),d.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){f.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var g,b;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(g=r.querySelector(".version-date"))==null?void 0:g.getAttribute("datetime"),s=((b=r.querySelector(".version-changelog"))==null?void 0:b.innerHTML)||"",l=d.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),u=d.createElement("div",{className:"script-tag",innerHTML:`
		...
		`});d.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("添加中...")),u=await y.getUserCollectionInfo(t,s);if(!u){l.close();return}let h=m.cloneFormData(u),g=m.cloneFormData(u),b=!1;for(const[L,S]of u.entries())if(L==="scripts-included[]"&&String(S).trim()===String(e).trim()){b=!0;break}else g.append(L,S),h.append(L,S);if(b){f.warning(n.t("该脚本已经在该收藏集中")),l.close();return}h.set("add-script",e.toString()),h.set("script-action","i"),g.append("scripts-included[]",e.toString()),g.set("save","1");let T=new URLSearchParams(h),k=new URLSearchParams(g),E=Array.from(T).map(([L,S])=>`${encodeURIComponent(L)}=${encodeURIComponent(S)}`).join("&"),B=Array.from(k).map(([L,S])=>`${encodeURIComponent(L)}=${encodeURIComponent(S)}`).join("&");c.info(["添加的数据",E]),c.info(["保存的数据",B]);let V=await y.updateUserSetsInfo(t,s,E);if(!V){l.close();return}let C=V.querySelector(".change-script-set");if(!C){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let M=C.querySelector("section");if(!M){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let q=M.querySelector(".alert");q?N.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:q.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					.pops-alert-content{
						font-style: italic;
					...
					`,drag:!0,dragLimit:!0,width:N.isPhone()?"88vw":"400px",height:N.isPhone()?"50vh":"300px"}):(await y.updateUserSetsInfo(t,s,B),f.success(n.t("添加成功"))),l.close();}),d.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("删除中...")),u=await y.getUserCollectionInfo(t,s);if(!u){l.close();return}let h=new FormData,g=new FormData,b=!1;for(const[C,M]of u.entries()){if(String(C).trim()==="scripts-included[]"&&String(M).trim()===String(e).trim()){b=!0;continue}g.append(C,M),h.append(C,M);}if(!b){f.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:e})),l.close();return}h.set("remove-scripts-included[]",e.toString()),h.set("remove-selected-scripts","i"),h.delete("script-action"),g.set("save","1");let T=new URLSearchParams(h),k=new URLSearchParams(g),E=Array.from(T).map(([C,M])=>`${encodeURIComponent(C)}=${encodeURIComponent(M)}`).join("&"),B=Array.from(k).map(([C,M])=>`${encodeURIComponent(C)}=${encodeURIComponent(M)}`).join("&");if(c.info(["删除的数据",E]),c.info(["保存的数据",B]),!await y.updateUserSetsInfo(t,s,E)){l.close();return}await y.updateUserSetsInfo(t,s,B),f.success(n.t("删除成功")),l.close();});},_e={init(){A.isCode()?Ie.init():A.isVersion()&&Ue.init(),A.isCodeStrict()&&(p.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),p.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),p.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),p.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),p.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){c.info("添加收藏按钮"),m.waitNode("ul#script-links li.current span").then(()=>{let e=d.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
...
`,ie={getTampermonkey:()=>{var e;return (e=I.external)==null?void 0:e.Tampermonkey},getViolentmonkey:()=>{var e;return (e=I.external)==null?void 0:e.Violentmonkey},getScriptCat:()=>{var e;return (e=I.external)==null?void 0:e.Scriptcat},getScriptContainerStatus(){var t,r,i;let e={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (t=I.external)!=null&&t.Tampermonkey&&(e.Tampermonkey=!0),(r=I.external)!=null&&r.Violentmonkey&&(e.Violentmonkey=!0),(i=I.external)!=null&&i.Scriptcat&&(e.ScriptCat=!0),e},getInstalledVersion(e,t){return new Promise((r,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(r);return}const s=this.getScriptCat();if(s){s.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const r=e.split("."),i=t.split(".");for(let o=0;o<r.length;o++){const a=this.compareVersionPart(r[o],i[o]);if(a!==0)return a}return 0},compareVersionPart(e,t){const r=this.parseVersionPart(e),i=this.parseVersionPart(t);for(let o=0;o<r.length;o++){if(r[o].length>0&&i[o].length===0)return -1;if(r[o].length===0&&i[o].length>0||r[o]>i[o])return 1;if(r[o]<i[o])return -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,r){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,r)){case-1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const r=e.getAttribute("data-script-name"),i=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(r,i);return a==null?!1:(this.handleInstallResult(e,a,o),!0)}catch{if(t){await m.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return !1}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),r=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:r,url:location.href},location.origin);}},ge=e=>{let t=e.dataset;const r={scriptId:parseInt(t.scriptId),scriptName:t.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(t.scriptDailyInstalls),scriptTotalInstalls:parseInt(t.scriptTotalInstalls),scriptRatingScore:parseFloat(t.scriptRatingScore),scriptCreatedDate:new Date(t.scriptCreatedDate),scriptUpdatedDate:new Date(t.scriptUpdatedDate),scriptType:t.scriptType,scriptVersion:t.scriptVersion,sensitive:t.sensitive==="true",scriptLanguage:t.scriptLanguage,cssAvailableAsJs:t.cssAvailableAsJs==="true",codeUrl:t.codeUrl,scriptDescription:t.scriptDescription,scriptAuthorId:parseInt(t.scriptAuthorId),scriptAuthorName:t.scriptAuthorName};let i=m.toJSON(t.scriptAuthors);if(Object.keys(i).forEach(o=>{let a=i[o];r.scriptAuthors.push({authorId:parseInt(o),authorName:a});}),(r.scriptAuthorName==null||isNaN(r.scriptAuthorId))&&r.scriptAuthors.length&&(r.scriptAuthorName=r.scriptAuthors[0].authorName,r.scriptAuthorId=r.scriptAuthors[0].authorId),r.scriptDescription==null){let o=e.querySelector(".script-description")||e.querySelector(".description");o&&(r.scriptDescription=o.innerText||o.textContent);}return r},ye={init(){p.execMenuOnce("gf-scripts-filter-enable",()=>{j.init();}),p.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){c.info("美化脚本列表");let e=[];return e.push(w(Ne)),U.ready(async()=>{j.getElementList().forEach(a=>{if(a.querySelector(".script-list-operation"))return;let s=ge(a),l=a.querySelector(".inline-script-stats"),u=s.codeUrl,h=U.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${n.t("评分")}</span>`}),g=U.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${s.scriptRatingScore}</span>`},{"data-position":"right"}),b=a.querySelector("dd.script-list-ratings .good-rating-count"),T=a.querySelector("dd.script-list-ratings .ok-rating-count"),k=a.querySelector("dd.script-list-ratings .bad-rating-count");if(b&&T&&k){let L=parseInt(b.innerText),S=parseInt(T.innerText),z=parseInt(k.innerText),R=L+S+z;R>=10?L/R>=.6?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count"):R==0||L>S+z?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count");}let E=U.createElement("dt",{className:"script-list-version",innerHTML:`<span>${n.t("版本")}</span>`}),B=U.createElement("dd",{className:"script-list-version",innerHTML:`<span>${s.scriptVersion}</span>`},{"data-position":"right"}),V=U.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${n.t("操作")}</span>`}),C=U.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),M=C.querySelector(".script-collect-btn"),q=C.querySelector(".install-link");if(q["data-script-info"]=s,q.classList.add("lum-lightbox-loader"),s.scriptType==="library"&&q.remove(),U.on(M,"click",L=>{m.preventEvent(L),he(s.scriptId);}),p.getValue("gf-scripts-filter-enable")){let L=U.createElement("button",{className:"script-filter-btn",innerHTML:n.t("过滤")}),S="data-filter-key",z="data-filter-value";U.on(L,"click",R=>{m.preventEvent(R);let D=N.alert({title:{text:n.t("选择过滤的选项"),position:"center"},content:{text:`
									<button ${S}="scriptId" ${z}="^${s.scriptId}$">${n.t("脚本id：{{text}}",{text:s.scriptId})}</button>
									<button ${S}="scriptName" ${z}="^${m.parseStringToRegExpString(s.scriptName)}$">${n.t("脚本名：{{text}}",{text:s.scriptName})}</button>
...
`),m.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},Ve={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=d.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=G.getValue(),d.on(r,["input","propertychange"],void 0,m.debounce(function(i){G.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},ze=`code {\r
...
`,Ge={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){c.info("美化页面元素");let e=[];return e.push(w(ze)),e.push(w(Be)),e.push(w(qe)),e.push(w(Re)),e.push(w(`
			...
			`)),d.ready(function(){let t=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(d.createElement("span",{textContent:"Markdown"}),t),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&e.push(w(`
					...
					`));}),e},beautifyGreasyforkBeautify(){c.info("美化 Greasyfork Beautify脚本");let e=[];return e.push(w(Pe)),m.isPhone()?e.push(w(`
				section#script-info,
        ...
        `);},addShortcutOperationButton(){c.info("添加快捷操作按钮"),document.querySelectorAll(".discussion-list-container").forEach(e=>{if(!e.querySelector("a.script-link"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=d.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),d.on(o,"click",a=>{m.preventEvent(a);const s=G.parseDiscuessionListContainerInfo(e);let l=N.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
						...
						`});d.on(l.$shadowRoot,"click","button[data-type]",u=>{m.preventEvent(u);let h=u.target,g="",b="";h.dataset.type==="script-id"?(g=s.scriptId,b=G.$data.FILTER_SCRIPT_KEY):h.dataset.type==="user-id"?(g=s.postUserId,b=G.$data.FILTER_POST_USER_KEY):h.dataset.type==="reply-user-id"?(g=s.replyUserId,b=G.$data.FILTER_REPLY_USER_KEY):c.warn("未知data-type"),N.confirm({title:{text:n.t("提示"),position:"center"},content:{text:n.t("确定{{type}}：{{filterId}}？",{type:h.textContent,filterId:g}),html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},btn:{ok:{callback(T,k){if(m.isNull(b)){c.error("存储的key是空的");return}let E=p.getValue(b,"").trim();E!==""&&(E+=`
`),E+=g,p.setValue(b,E),T.close(),l.close(),G.filter();}}},drag:!0,dragLimit:!0,width:"300px",height:"200px"});});});});}},je={init(){p.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),p.execMenuOnce("gf-scripts-filter-enable",()=>{j.init();}),p.execMenuOnce("beautifyCenterContent",()=>ye.beautifyCenterContent());},changeConsoleToTopNavigator(){c.info("迁移【控制台】到顶部导航栏"),X.addBlockCSS("#about-user"),d.ready(()=>{let e=document.querySelector("#about-user"),t=document.querySelector("#site-nav nav");if(!e){c.error("#about-user元素不存在");return}if(!t){c.error("#site-nav nav元素不存在");return}e=e.cloneNode(!0);let r=d.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});d.on(r,"click",i=>{m.preventEvent(i),N.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:m.getMaxZIndex(100),style:`
                    .text-content{
        ...
        `);function e(){let t=d.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),r=t.querySelector(".js-clipboard-copy"),i=t.querySelector(".octicon-copy"),o=t.querySelector(".octicon-check-copy");return d.on(t,"click",function(){let a=t.parentElement.querySelector("code");if(!a&&t.parentElement.className.includes("prettyprinted")&&(a=t.parentElement),!a){f.error(n.t("未找到{{selector}}元素",{selector:"code"}));return}m.setClip(a.innerText||a.textContent),r.setAttribute("success","true"),i.setAttribute("aria-hidden","true"),o.removeAttribute("aria-hidden");let s=N.tooltip({target:r,content:n.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:!0});setTimeout(()=>{r.removeAttribute("success"),o.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden"),s.close();},2e3);}),t}document.querySelectorAll("pre").forEach(t=>{if(t.querySelector("div.zeroclipboard-container"))return;let i=e(),o=d.createElement("div",{className:"snippet-clipboard-content"});d.before(t,o),o.appendChild(t),o.appendChild(i);});},languageSelectorLocale(){let e=p.getValue("language-selector-locale"),t=window.location.pathname.split("/").filter(r=>!!r)[0];if(c.success("选择语言："+e),c.success("当前语言："+t),!m.isNull(e)&&e!==t){let r=null,i=y.getSwitchLanguageUrl(e);y.switchLanguage(i),c.success("新Url："+i),f.loading(n.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:t,localeLanguage:e}),{timeout:3e3,showClose:!0,onClose(){clearTimeout(r);}}),f.info(n.t("导航至：")+i,{timeout:3e3}),r=setTimeout(()=>{window.location.href=i;},3e3);}},async UIScriptList(e,t,r,i){var g,b,T;if(!v.isLogin){f.error(n.t("请先登录账号！"));return}let a=v.getUserLinkElement().href,s=(T=(b=(g=a==null?void 0:a.split("/"))==null?void 0:g.pop())==null?void 0:b.match(/([0-9]+)/))==null?void 0:T[0],l=N.loading({mask:{enable:!0},parent:i,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),u=await y.getUserInfo(s);if(l.close(),!u)return;c.info(u);let h=e==="script-list"?u.scriptList:u.scriptLibraryList;f.success(n.t("获取成功，共 {{count}} 个",{count:h.length}));for(const k of h){let E=d.createElement("li",{className:"w-script-list-item",innerHTML:`
				...
				<div class="w-script-update-time">
					<p>${n.t("更新：")}${m.getDaysDifference(new Date(k.code_updated_at).getTime(),void 0,"auto")}前</p>
				</div>
				</div>
            `}),B=E.querySelector(".w-script-info"),V=d.createElement("div",{className:"pops-panel-button",innerHTML:`
				<button type="primary" data-icon="" data-righticon="false">
				<span>${n.t("同步代码")}</span>
				</button>
				`});k.deleted&&(E.classList.add("w-script-deleted"),V.querySelector("button").setAttribute("disabled","true")),d.on(V,"click",void 0,async function(){c.success(["同步",k]);let C=V.querySelector("button"),M=V.querySelector("button span"),q=d.createElement("i",{className:"pops-bottom-icon",innerHTML:N.config.iconSVG.loading},{"is-loading":!0});C.setAttribute("disabled","true"),C.setAttribute("data-icon","true"),M.innerText=n.t("同步中..."),d.before(M,q);let L=k==null?void 0:k.id,S=await y.getSourceCodeSyncFormData(L.toString());if(S){const z="script[script_sync_type_id]";if(S.has(z)){let R=S.get(z),D="";R.toString()==="1"?D=n.t("手动"):R.toString()==="2"?D=n.t("自动"):R.toString()==="3"&&(D="webhook");let K=E.querySelector(".w-script-sync-type");K?K.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:D}):d.append(B,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:D})}
									</p>
								</div>`),await y.sourceCodeSync(k.id.toString(),S)?f.success(n.t("同步成功")):f.error(n.t("同步失败"));}else f.error(n.t("该脚本未设置同步信息"));}C.removeAttribute("disabled"),C.removeAttribute("data-icon"),M.innerText=n.t("同步代码"),q.remove();}),E.appendChild(V),i.appendChild(E);}},checkPage(){c.info("检测gf页面是否正确加载，有时候会出现"),d.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let e=parseInt(O("greasyfork-check-page-time",0)),t=p.getValue("greasyfork-check-page-timeout",5),r=t*1e3;if(e&&Date.now()-e<r){f.warning(n.t("上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载",{time:m.formatTime(e,"yyyy-MM-dd HH:mm:ss"),timeout:t}));return}ne("greasyfork-check-page-time",Date.now()),window.location.reload();}});},addOperationPanelBtnWithNavigator(){c.info("添加【操作面板】按钮"),X.addBlockCSS(".sidebarred .sidebar",".sidebarred-main-content .open-sidebar"),w(`
...
`,Ye={id:"greasy-fork-panel-config-account",title:n.t("用户"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(n.t("迁移【控制台】到顶部导航栏"),"users-changeConsoleToTopNavigator",!0,void 0,n.t("将【控制台】按钮移动到顶部导航栏，节省空间"))]}]}]}]},$={data:null,oneSuccessExecMenu:null,onceExec:null,listenData:null},p={$data:{get data(){return $.data==null&&($.data=new m.Dictionary),$.data},get oneSuccessExecMenu(){return $.oneSuccessExecMenu==null&&($.oneSuccessExecMenu=new m.Dictionary),$.oneSuccessExecMenu},get onceExec(){return $.onceExec==null&&($.onceExec=new m.Dictionary),$.onceExec},get scriptName(){return le},key:P,attributeKeyName:Z,attributeDefaultValueName:Q},$listener:{get listenData(){return $.listenData==null&&($.listenData=new m.Dictionary),$.listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},initExtensionsMenu(){I.top===I.self&&me.add([{key:"show_pops_panel_setting",text:n.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showPanel();}}]);},initPanelDefaultValue(){let e=this;function t(o){if(!o.attributes)return;let a=o.attributes[Z],s=o.attributes[Q];if(a==null){c.warn(["请先配置键",o]);return}e.$data.data.has(a)&&c.warn("请检查该key(已存在): "+a),e.$data.data.set(a,s);}function r(o){for(let a=0;a<o.length;a++){let s=o[a];t(s);let l=s.forms;l&&Array.isArray(l)&&r(l);}}let i=this.getPanelContentConfig();for(let o=0;o<i.length;o++){let a=i[o];if(!a.forms)continue;let s=a.forms;s&&Array.isArray(s)&&r(s);}},setValue(e,t){let r=O(P,{}),i=r[e];r[e]=t,ne(P,r),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,i,t);},getValue(e,t){let i=O(P,{})[e];return i??(this.$data.data.has(e)?this.$data.data.get(e):t)},deleteValue(e){let t=O(P,{}),r=t[e];Reflect.deleteProperty(t,e),ne(P,t),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,r,void 0);},addValueChangeListener(e,t,r){let i=Math.random();return this.$listener.listenData.set(e,{id:i,key:e,callback:t}),r&&r.immediate&&t(e,this.getValue(e),this.getValue(e)),i},removeValueChangeListener(e){let t=null;for(const[r,i]of this.$listener.listenData.entries())if(i.id===e){t=r;break}typeof t=="string"?this.$listener.listenData.delete(t):console.warn("没有找到对应的监听器");},hasKey(e){let t=O(P,{});return e in t},execMenu(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){c.warn(`${e} 键不存在`);return}let r=p.getValue(e);r&&t(r);},execMenuOnce(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){c.warn(`${e} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(e))return;this.$data.oneSuccessExecMenu.set(e,1);let r=[],i=s=>{let l=p.getValue(e);o(l,s);},o=(s,l)=>{let u=[];if(s){let h=l??t(s,i);h instanceof HTMLStyleElement?u=[h]:Array.isArray(h)&&(u=[...h.filter(g=>g!=null&&g instanceof HTMLStyleElement)]);}for(let h=0;h<r.length;h++)r[h].remove(),r.splice(h,1),h--;r=[...u];};this.addValueChangeListener(e,(s,l,u)=>{o(u);});let a=p.getValue(e);a&&o(a);},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(e)||(t(),this.$data.onceExec.set(e,1));},showPanel(){N.panel({title:{text:n.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:le}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0,style:`
			${Je}
			`});},isMobile(){return window.outerWidth<550},getWidth(){return window.outerWidth<550?"92dvw":"550px"},getHeight(){return window.outerHeight>450?"80dvh":"450px"},getPanelContentConfig(){return [Me,$e,Ve,Ye,We,Ke]}};p.init();H.init();

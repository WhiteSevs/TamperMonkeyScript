...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof Ce=="function"?Ce(e.keyName):null;typeof t=="string"&&t?M(t):ie.loadStyleLink(e.url);},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,S.ready(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(A=>{t.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let A=[document.documentElement,document.body].concat(...e||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(i=>{n(i);}).catch(i=>{u.error("读取剪贴板内容失败👉",i),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(i=>{e(n);}).catch(i=>{u.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(n);});}function A(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!A()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,A=5e3){let n,i=A-t,a=t,o=async s=>{let l=await e(s);if(typeof l=="boolean"&&!l||s){h.workerClearTimeout(n);return}if(a+=t,a>i){o(true);return}n=h.workerSetTimeout(()=>{o(false);},t);};o(false);},findParentNode(e,t,A){if(A){let n=S.closest(e,A);if(n)return n.querySelector(t)}else return S.matches(e,t)?e:S.closest(e,t)}},ce={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},h=ae.noConflict(),c=S.noConflict(),R=we,u=new h.Log(pe,X.console||Ve.console);let ze=pe?.script?.name||void 0;we.config.Utils.AnyTouch();const Fe=false;u.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});g.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.getSetting().type;if(t==="loading")return  false;const A=e.getSetting().content;return t==="warning"?u.warn(A):t==="error"?u.error(A):u.info(A),true},get position(){return v.getValue(ce.qmsg_config_position.key,ce.qmsg_config_position.defaultValue)},get maxNums(){return v.getValue(ce.qmsg_config_maxnums.key,ce.qmsg_config_maxnums.defaultValue)},get showReverse(){return v.getValue(ce.qmsg_config_showreverse.key,ce.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=ae.getMaxZIndex(),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100}});R.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=ae.getMaxZIndex(void 0,void 0,A=>{if(A?.classList?.contains("qmsg-shadow-container")||A?.closest("qmsg")&&A.getRootNode()instanceof ShadowRoot)return  false}),t=we.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Te=new h.GM_Menu({GM_getValue:ee,GM_setValue:W,GM_registerMenuCommand:qe,GM_unregisterMenuCommand:He}),H=new h.Httpx({xmlHttpRequest:Ge,logDetails:Fe});H.interceptors.request.use(e=>e);H.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?g.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?g.error("请求超时",{consoleLogContent:true}):g.error("其它错误",{consoleLogContent:true}),e));X.Object.defineProperty,X.Function.prototype.apply,X.Function.prototype.call,X.Element.prototype.appendChild,X.setTimeout;const M=c.addStyle.bind(c),T=S.selector.bind(S),K=S.selectorAll.bind(S);new h.GM_Cookie;const ke="GM_Panel",Se="data-init",ge="data-key",ve="data-default-value",Ye="data-init-more-value",se="data-storage-api",Z={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},_={setting:{get width(){return Z.width<550?"88vw":Z.width<700?"550px":"700px"},get height(){return Z.height<450?"70vh":Z.height<550?"450px":"550px"}},settingMiddle:{get width(){return Z.width<350?"88vw":"350px"},get height(){return Z.height<450?"88vh":"450px"}},settingBig:{get width(){return Z.width<800?"92vw":"800px"},get height(){return Z.height<600?"80vh":"600px"}},info:{get width(){return Z.width<350?"88vw":"350px"},get height(){return Z.height<250?"88vh":"250px"}}};class Ze{storageKey;listenerData;constructor(t){if(typeof t=="string"){let A=t.trim();if(A=="")throw new Error("key参数不能为空字符串");this.storageKey=A;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new ae.Dictionary;}getLocalValue(){let t=ee(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){W(this.storageKey,t);}set(t,A){let n=this.get(t),i=this.getLocalValue();Reflect.set(i,t,A),this.setLocalValue(i),this.triggerValueChangeListener(t,n,A);}get(t,A){let n=this.getLocalValue();return Reflect.get(n,t)??A}getAll(){return this.getLocalValue()}delete(t){let A=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,A,void 0);}has(t){let A=this.getLocalValue();return Reflect.has(A,t)}keys(){let t=this.getLocalValue();return Reflect.ownKeys(t)}values(){let t=this.getLocalValue();return Reflect.ownKeys(t).map(A=>Reflect.get(t,A))}clear(){Pe(this.storageKey);}addValueChangeListener(t,A){let n=Math.random(),i=this.listenerData.get(t)||[];return i.push({id:n,key:t,callback:A}),this.listenerData.set(t,i),n}removeValueChangeListener(t){let A=false;for(const[n,i]of this.listenerData.entries()){for(let a=0;a<i.length;a++){const o=i[a];(typeof t=="string"&&o.key===t||typeof t=="number"&&o.id===t)&&(i.splice(a,1),a--,A=true);}this.listenerData.set(n,i);}return A}triggerValueChangeListener(t,A,n){if(!this.listenerData.has(t))return;let i=this.listenerData.get(t);for(let a=0;a<i.length;a++){const o=i[a];if(typeof o.callback=="function"){let s=this.get(t),l,d;typeof A<"u"&&arguments.length>=2?d=A:d=s,typeof n<"u"&&arguments.length>2?l=n:l=s,o.callback(t,d,l);}}}}const ne=new Ze(ke),ye={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new h.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){return this.$data.__defaultBottomContentConfig.length?this.$data.__defaultBottomContentConfig:[{id:"script-version",title:`版本：${pe?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(e,t,A){let n=pe?.script?.supportURL||pe?.script?.namespace;return typeof n=="string"&&h.isNotNull(n)&&window.open(n,"_blank"),false}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},Be={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{v.showPanel(ye.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){v.isTopWindow()&&Te.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let A=this.$data.menuOption.findIndex(n=>n.key===t.key);A!==-1&&(this.$data.menuOption[A]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},v={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new h.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new h.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new h.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new h.Dictionary),this.__onceExecData},get scriptName(){return ze},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ke,attributeKeyName:ge,attributeDefaultValueName:ve},init(){this.initContentDefaultValue(),Be.init();},isTopWindow(){return X.top===X.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const i=n.attributes;let a=i[Se];if(typeof a=="function"){let d=a();if(typeof d=="boolean"&&!d)return}let o=new Map,s=i[ge];if(s!=null){const d=i[ve];o.set(s,d);}let l=i[Ye];if(typeof l=="object"&&l&&Object.keys(l).forEach(d=>{o.set(d,l[d]);}),!o.size){u.warn(["请先配置键",n]);return}if(n.type==="switch"){let d=typeof n.disabled=="function"?n.disabled():n.disabled;typeof d=="boolean"&&d&&this.$data.contentConfigInitDisabledKeys.push(...o.keys());}for(const[d,f]of o.entries())this.setDefaultValue(d,f);},t=n=>{for(let i=0;i<n.length;i++){let a=n[i];e(a);let o=a.forms;o&&Array.isArray(o)&&t(o);}},A=[...ye.getAllContentConfig()];for(let n=0;n<A.length;n++){let i=A[n];if(!i.forms)continue;const a=i.forms;a&&Array.isArray(a)&&t(a);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&u.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){ne.set(e,t);},getValue(e,t){let A=ne.get(e);return A??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){ne.delete(e);},hasKey(e){return ne.has(e)},addValueChangeListener(e,t){return ne.addValueChangeListener(e,(n,i,a)=>{t(e,a,i);})},removeValueChangeListener(e){ne.removeValueChangeListener(e);},triggerMenuValueChange(e,t,A){ne.triggerValueChangeListener(e,A,t);},exec(e,t,A,n=true){const i=this;let a;typeof e=="string"||Array.isArray(e)?a=()=>e:a=e;let o=false,s=a(),l=[];Array.isArray(s)?(o=true,l=s):l.push(s);let d=l.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(d){u.warn(`${d} 键不存在`);return}let f=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(f))return this.$data.onceExecMenuData.get(f);let p=[],m=[],y=(w,C)=>{let z=[];Array.isArray(C)||(C=[C]),C.forEach(N=>{if(N!=null&&N instanceof HTMLStyleElement){z.push(N);return}}),p=p.concat(z);},P=w=>this.getValue(w),b=()=>{for(let w=0;w<p.length;w++)p[w].remove(),p.splice(w,1),w--;},Q=()=>{let w=false;return typeof A=="function"?w=A(l):w=l.every(C=>P(C)),w},k=w=>{let C=Q(),z=[];if(C){let N=l.map(L=>this.getValue(L)),E=t({value:o?N:N[0],addStyleElement:(...L)=>y(true,...L)});Array.isArray(E)||(E=[E]),E.forEach(L=>{if(L!=null&&L instanceof HTMLStyleElement){z.push(L);return}});}b(),p=[...z];};n&&l.forEach(w=>{let C=this.addValueChangeListener(w,(z,N,E)=>{k();});m.push(C);}),k();let j={reload(){k();},clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),n&&i.$data.onceExecMenuData.delete(f);},clearStoreStyleElements:()=>b(),removeValueChangeListener:()=>{m.forEach(w=>{this.removeValueChangeListener(w);});}};return this.$data.onceExecMenuData.set(f,j),j},execMenu(e,t,A=false,n=false){return this.exec(e,i=>t(i),i=>i.every(o=>{let s=!!this.getValue(o);return v.$data.contentConfigInitDisabledKeys.includes(o)&&(s=false,u.warn(`.execMenu${n?"Once":""} ${o} 被禁用`)),A&&(s=!s),s}),n)},execMenuOnce(e,t,A=false,n=false){const i=this.execMenu(e,t,A,true);if(n&&i){const a=()=>{i.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,a);const o=i.clear;i.clear=()=>{o(),this.removeUrlChangeWithExecMenuOnceListener(e);};}return i},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),ne.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},triggerUrlChangeWithExecMenuOnceEvent(e){this.$data.urlChangeReloadMenuExecOnce.forEach((t,A)=>{t(e);});},showPanel(e,t=`${ze}-设置`,A=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let i=e.findIndex(o=>(typeof o.isBottom=="function"?o.isBottom():!!o.isBottom)&&o.id==="script-version")!==-1;!A&&!i&&e.push(...ye.getDefaultBottomContentConfig());let a=R.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(o,s)=>{o.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(o,s)=>{o(),this.$data.$panel=null;}},width:_.setting.width,height:_.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:a,content:e});},registerConfigSearch(e){const{$panel:t,content:A}=e;let n=async(f,p)=>{if(f==null)return;let m=await p(f);return m&&typeof m.isFind=="boolean"&&m.isFind?m.data:await n(m.data,p)},i=(f,p)=>{const m=new IntersectionObserver(y=>{y.forEach(P=>{P.isIntersecting&&(p?.(),m.disconnect());});},{root:null,threshold:1});m.observe(f),f.scrollIntoView({behavior:"smooth",block:"center"});},a=f=>{const p="pops-flashing";c.animationend(f,()=>{f.classList.remove(p);}),f.classList.add(p);},o=(f,p)=>{c.preventEvent(f);let m=R.alert({title:{text:"搜索配置",position:"center"},content:{text:`
                ...
                `});c.on(n,"click",s=>{c.preventEvent(s),e.clickEvent(s);}),A&&A.children.length?A.appendChild(n):t.appendChild(n);let i=c.createElement("li",{className:e.className,innerHTML:`
                <a href="javascript:;">${e.name}</a>
                `});c.on(i,"click",s=>{c.preventEvent(s),e.clickEvent(s);});let a=T("#mobile-nav nav"),o=T("#mobile-nav nav .multi-link-nav");o?c.before(o,i):a?c.append(a,i):u.error("元素#mobile-nav nav不存在");});}},G={async getScriptInfo(e){let t=D.getScriptInfoUrl(e),A=await H.get(t,{allowInterceptConfig:false,responseType:"json"});if(!A.status){let i=D.getScriptHomeUrl(e),a=await H.get(i,{fetch:true});if(!a.status)return;let o=c.toElement(a.data.responseText,true,true),s=o.querySelector(".install-link"),l=o.querySelector("dd.script-show-created-date relative-time[datetime]"),d=o.querySelector("dd.script-show-daily-installs"),f=o.querySelector("dd.script-show-total-installs"),p=o.querySelector("dd.script-show-updated-date relative-time[datetime]"),m=o.querySelector("#script-description"),y=o.querySelector(".good-rating-count"),P=o.querySelector(".ok-rating-count"),b=o.querySelector(".bad-rating-count"),Q=o.querySelector("dd.script-show-license"),k={id:Number(e),created_at:l?.getAttribute("datetime")||"",daily_installs:Number(c.text(d)||"0"),total_installs:Number(c.text(f)||"0"),code_updated_at:p?.getAttribute("datetime")||"",support_url:"",fan_score:"",namespace:s?.getAttribute("data-script-namespace")||"",contribution_url:null,contribution_amount:null,good_ratings:Number(c.text(y)||"0"),ok_ratings:Number(c.text(P)||"0"),bad_ratings:Number(c.text(b)||"0"),users:[],name:s?.getAttribute("data-script-name")||c.text(o.querySelector("title")),description:c.text(m),url:t,code_url:s?.getAttribute("href")||"",license:c.text(Q)||null,version:s?.getAttribute("data-script-version")||o.querySelector("dd.script-show-version")?.innerText||"",locale:"",deleted:false};if(h.isNull(k.code_url)&&!s){let j=o.querySelector("#script-content code");j&&(k.code_url=c.text(j).trim().replace(/^\/\/[\s]*@require[\s]*/gi,"").trim());}return k}return h.toJSON(A.data.responseText)},async getScriptStats(e){let t=await H.get(`/scripts/${e}/stats.json`,{allowInterceptConfig:false});if(u.info(t),!t.status){u.error(r.t("获取脚本统计数据失败"));return}return h.toJSON(t.data.responseText)},async getSourceCodeSyncFormDataInfo(e){let t=await H.get(`/scripts/${e}/admin`,{fetch:true,allowInterceptConfig:false});if(u.info(t),!t.status){g.error(r.t("请求admin内容失败"));return}let A=t.data.responseText,i=c.toElement(A,false,true).querySelector("form.edit_script[action*='sync_update']");if(!i){g.error(r.t("解析admin的源代码同步表单失败"));return}let a=new FormData(i),o=i.querySelector("input[type='submit'][name='update-and-sync']");return o&&a.append(o.name,o.value),{url:i.action,formData:a}},async sourceCodeSync(e,t,A){let n=await H.post(A||`/scripts/${e}/sync_update`,{fetch:true,data:t,allowInterceptConfig:false,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Content-Type":"application/x-www-form-urlencoded",Origin:window.location.origin,Referer:window.location.href,"User-Agent":h.getRandomPCUA()}});if(u.info(n),!n.status){g.error(r.t("源代码同步失败"));return}return n},async getUserInfo(e){let t=await H.get(`/users/${e}.json`,{allowInterceptConfig:false});if(u.success(t),!t.status){g.error(r.t("获取用户信息失败"));return}let A=h.toJSON(t.data.responseText);if(A.scriptList=[],A.scriptLibraryList=[],A.scripts.forEach(n=>{n.code_url.endsWith(".user.js")?A.scriptList.push(n):A.scriptLibraryList.push(n);}),!A.scriptLibraryList.length){let n=await H.get(`/users/${e}`,{fetch:true,allowInterceptConfig:false});if(!n.status){g.error(r.t("获取用户主页信息失败"));return}let i=n.data.responseText,a=c.toElement(i,true,true),o=a.querySelector("#user-library-script-list");o?o.querySelectorAll("li").forEach(s=>{let l=le.parseScriptListInfo(s),d=s.querySelector("a.script-link").href;A.scriptLibraryList.push({id:l.scriptId,created_at:l.scriptCreatedDate.toISOString(),daily_installs:l.scriptDailyInstalls,total_installs:l.scriptTotalInstalls,code_updated_at:l.scriptUpdatedDate.toISOString(),support_url:null,fan_score:l.scriptRatingScore.toString(),namespace:null,contribution_url:null,contribution_amount:null,good_ratings:0,ok_ratings:0,bad_ratings:0,name:l.scriptName,description:l.scriptDescription,url:d,code_url:l.codeUrl,license:null,version:l.scriptVersion,locale:l.scriptLanguage,deleted:false});}):u.error("解析用户主页的库列表失败",a);}return A},async getUserCollection(e){let t=await H.get(`/users/${e}`,{fetch:true,allowInterceptConfig:false});if(u.info("获取用户的收藏集",t),!t.status){g.error(r.t("获取用户的收藏集失败"));return}let A=t.data.responseText,i=c.toElement(A,true,true).querySelector("#user-script-sets");if(!i){u.error("解析Script Sets失败");return}let a=[];return i.querySelectorAll("li").forEach(o=>{let s=o.querySelector("a:last-child");if(!s)return;let l=s.href;if(l.includes("?fav=1"))return;let d=o.querySelector("a").innerText,f=l.match(/\/sets\/([\d]+)\//)?.[1];a.push({id:f,name:d});}),a},async getUserCollectionInfo(e,t){let A=await H.get(`/users/${e}/sets/${t}/edit`,{fetch:true,allowInterceptConfig:false});if(u.info(A),!A.status){g.error(r.t("获取收藏集{{setsId}}失败",{setsId:t}));return}let n=A.data.responseText,i=c.toElement(n,true,true),a=i.querySelector('form[id^="edit_script_set"]');if(!a){g.error(r.t("获取表单元素#edit_script_set失败"));return}let o=new FormData(a),s=i.querySelector('meta[name="csrf-token"]');if(!s){g.error(r.t("获取表单csrfToken失败"));return}if(s.hasAttribute("content")){let l=s.getAttribute("content");l&&o.set("authenticity_token",l);}return o},async updateUserSetsInfo(e,t,A){let n=await H.post(`/users/${e}/sets/${t}`,{fetch:true,allowInterceptConfig:false,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"no-cache","Content-Type":"application/x-www-form-urlencoded",Pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:A});if(u.info(n),!n.status){g.error(r.t("更新收藏集表单请求失败"));return}let i=n.data.responseText;return c.toElement(i,true,true)},async switchLanguage(e){let t=await H.get(e,{fetch:true,headers:{"Upgrade-Insecure-Requests":"1"}});u.info(t),t.status;}},et=`:root {\r
...
`,lt="",B={isHome(){return window.location.pathname.split("/").length<=2&&window.location.search===""},isCode(){return !!window.location.pathname.split("/")?.includes("code")},isCodeStrict(){return !!window.location.pathname.match(/\/code(\/|)$/)},isVersion(){return !!window.location.pathname.match(/\/versions(\/|)$/)},isUsers(){return !!window.location.pathname.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!window.location.pathname.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!window.location.pathname.match(/\/conversations\/[\d]+/)},isScript(){return !!window.location.pathname.match(/\/scripts\/[\d+]/)},isScriptAdmin(){return !!window.location.pathname.endsWith("/admin")},isScriptList(){return !!window.location.pathname.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!window.location.pathname.match("/scripts/by-site")},isScriptsFeedback(){return this.isScript()&&window.location.pathname.match(/\/feedback(\/|)$/i)},isScriptLibraryList(){return !!window.location.pathname.match(/\/libraries(\/|)$/)},isScriptSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptList()&&e.has("q")},isScriptCodeSearch(){return !!window.location.pathname.match(/\/code-search(\/|)$/)},isScriptLibraryListSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptLibraryList()&&e.has("q")},isDiscuessions(){return !!window.location.pathname.match(/\/discussions(\/|)$/)},isImageSource(){return window.location.pathname.startsWith("/vite/assets")}},ct={init(){v.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),v.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),v.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),v.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let e=[];return e.push(M(et)),e.push(M(tt)),e.push(M(At)),e.push(M(rt)),e.push(M(nt)),e.push(M(`
			...
			`)),c.ready(()=>{let t=T('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(c.createElement("span",{textContent:"Markdown"}),t),K(".user-content ul li").forEach(i=>{let a=i.firstChild;a?.nodeName==="#text"&&(a.textContent?.startsWith("[x] ")?(a.textContent=a.textContent.replace("[x] ",""),c.prepend(i,`
				...
				`},n=Object.keys(A);if(K(".user-content blockquote").forEach(i=>{Array.from(i.children).forEach(a=>{let o=c.html(a);if(a.nodeName==="P"){let s=n.find(l=>o.toLowerCase().startsWith(l.toLowerCase()));s&&(c.html(a,o.replace(s,"")),c.before(a,A[s]),c.html(a)===""&&a.remove());}});}),K(".user-content > blockquote").forEach(i=>{Array.from(i.querySelectorAll(".markdown-alert-title")).forEach(a=>{let o=c.createElement("div",{className:"markdown-alert markdown-alert-tip"},{"data-type":a.getAttribute("data-type")});for(;a.nextSibling&&!a.nextSibling?.classList?.contains("markdown-alert-title");)c.append(o,a.nextSibling);c.prepend(o,a),c.before(i,o);});}),B.isHome())e.push(M(st));else if(B.isScriptsFeedback()){e.push(M(lt));let i=T('.radio-label[for*="discussion_rating_0"]');i&&(i.innerHTML=i.innerHTML.replace("不评分",'<span class="rating-icon rating-icon-none">不评分</span>'));let a=T('.radio-label[for*="discussion_rating_2"]');a&&(a.innerHTML=a.innerHTML.replace("差评",'<span class="rating-icon rating-icon-bad">差评</span>'));let o=T('.radio-label[for*="discussion_rating_3"]');o&&(o.innerHTML=o.innerHTML.replace("一般",'<span class="rating-icon rating-icon-ok">一般</span>'));let s=T('.radio-label[for*="discussion_rating_4"]');s&&(s.innerHTML=s.innerHTML.replace("好评",'<span class="rating-icon rating-icon-good">好评</span>'));}else B.isScriptAdmin()&&(T('input[type="submit"][name="update-only"]')||e.push(M(`
					.indented{
						padding-left: unset;
					}
...
`),h.isNull(e))return;e=e.toString().trim();let n=e+"##"+t;A+=n,this.setValue(A);},getValue(){return v.getValue(this.key,"")}},ut={init(){this.readBgColor(),c.ready(()=>{v.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();});let e=new h.LockFunction(()=>{v.execMenu("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();}),v.execMenu("discussions-addReportButton",()=>{this.addReportButton();});});h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),$.init();},readBgColor(){u.info("设置已读背景颜色");let e=v.getValue("discussions-readBgColor");return M(`
        ...
        `)},addShortcutOperationButton(){u.info("添加【过滤】按钮"),$.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let A=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-filter-button");A.appendChild(n),c.on(i,"click",a=>{c.preventEvent(a);const o=$.parseDiscuessionListContainerInfo(e);if(!o)return;let s="data-filter-key",l="data-filter-value",d=R.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:false},content:{text:`
								<button ${s}="scriptId" ${l}="^${o.scriptId}$">${r.t("脚本id：{{text}}",{text:o.scriptId})}</button>
								<button ${s}="scriptName" ${l}="^${h.toRegExpStr(o.scriptName)}$">${r.t("脚本名：{{text}}",{text:o.scriptName})}</button>
								<button ${s}="postUserId" ${l}="^${h.toRegExpStr(o.postUserId)}$">${r.t("发布的用户id：{{text}}",{text:o.postUserId})}</button>
						...
						`}),f=d.$shadowRoot.querySelector(".pops-alert-content");if(o.scriptId==null&&f.querySelector(`button[${s}="scriptId"]`)?.remove(),o.scriptName==null&&f.querySelector(`button[${s}="scriptName"]`)?.remove(),o.postUserId==null&&f.querySelector(`button[${s}="postUserId"]`)?.remove(),o.replyUserId!=null){let p=c.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:o.replyUserId})});p.setAttribute(s,"scriptAuthorId"),p.setAttribute(l,"^"+o.replyUserId+"$"),f.appendChild(p);}c.on(d.$shadowRoot,"click",`button[${s}]`,p=>{c.preventEvent(p);let m=p.target,y=m.getAttribute(s),P=m.getAttribute(l);$.addValue(y,P),d.close(),$.filter(),g.success(r.t("添加成功"));});});});},addReportButton(){u.info("添加【举报】按钮"),$.getElementList().forEach(e=>{if(e.querySelector(".discussion-report-button"))return;let A=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
...
`,gt={init(){v.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),v.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),v.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(M(pt)),e.push(ie.addBlockCSS(".version-number",".version-date",".version-changelog")),c.ready(function(){let t=T("ul.history_versions");if(!t){g.error(r.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(A=>{let n=A.querySelector(".version-number a").href,i=A.querySelector(".version-number a").innerText,a=A.querySelector(".version-date")?.getAttribute("datetime"),o=A.querySelector(".version-changelog")?.innerHTML||"",s=c.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),l=c.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),d=c.createElement("div",{className:"script-note-box-body",innerHTML:o});A.appendChild(s),A.appendChild(l),A.appendChild(d);});}),e},addExtraTagButton(){u.info("添加额外的标签按钮"),c.ready(()=>{K(".script-tag-version").forEach(e=>{let t=e.querySelector("a");if(!t)return;let A=new URL(t.href),n=A.pathname.match(/\/scripts\/([\d]+)/)?.[1],i=A.searchParams.get("version"),a=A.pathname.match(/\/scripts\/[\d]+-(.+)/)?.[1],o=D.getInstallUrl(n,i,a),s=D.getCodeUrl(n,i),l=c.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});c.after(e,l);});});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),De.monacoEditor().then(e=>{c.ready(()=>{K('#script-content form[action*="/diff"] input[type="submit"]').forEach(t=>{let A=c.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});c.after(t,A),c.on(A,"click",async n=>{c.preventEvent(n);let i=t.closest("form"),a=new FormData(i),o=a.get("v1"),s=a.get("v2");if(o===s){g.warning(r.t("版本号相同，不需要比较源码"));return}let l=g.loading(r.t("正在获取对比文本中...")),d=D.getScriptId(),f=await G.getScriptInfo(d);if(!f){l.close();return}let p=f.code_url,m=p.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${o}`),y=p.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${s}`),P="",b="";const[Q,k]=await Promise.all([H.get(m,{timeout:2e4}),H.get(y,{timeout:2e4})]);if(l.close(),!Q.status||!k.status)return;P=Q.data.responseText,b=k.data.responseText;let{recovery:j}=ie.lockScroll(),w=R.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
		...
		`});c.on(i.$shadowRoot,"click",".collect-add-script-id",async function(a){let o=a.target.closest(".user-collect-item"),s=o.dataset.id;o.dataset.name;let l=g.loading(r.t("添加中..."));try{let d=await G.getUserCollectionInfo(t,s);if(!d)return;if(n(d,e)){g.warning(r.t("该脚本已经在该收藏集中"));return}let f=h.cloneFormData(d),p=h.cloneFormData(d);f.set("add-script",e.toString()),f.set("script-action","i"),p.append("scripts-included[]",e.toString()),p.set("save","1");let m=new URLSearchParams(f),y=new URLSearchParams(p),P=Array.from(m).map(([N,E])=>`${encodeURIComponent(N)}=${encodeURIComponent(E)}`).join("&"),b=Array.from(y).map(([N,E])=>`${encodeURIComponent(N)}=${encodeURIComponent(E)}`).join("&");u.info("添加的数据",P),u.info("保存的数据",b);let Q=await G.updateUserSetsInfo(t,s,P);if(!Q)return;let k=Q.querySelector(".change-script-set");if(!k){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let j=k.querySelector("section");if(!j){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}let w=j.querySelector(".alert");if(w){R.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:w.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:_.info.width,height:_.info.height});return}let C=new FormData(k);if(!n(C,e)){u.error("添加失败，提交的添加请求中不包含该脚本id"),g.error(r.t("添加失败，表单数据中不包含该脚本"));return}await G.updateUserSetsInfo(t,s,b),g.success(r.t("添加成功"));}catch(d){console.error(d);}finally{l.close();}}),c.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(a){let o=a.target.closest(".user-collect-item"),s=o.dataset.id;o.dataset.name;let l=g.loading(r.t("删除中..."));try{let d=await G.getUserCollectionInfo(t,s);if(!d)return;if(!n(d,e)){g.info(r.t("已删除：{{scriptId}}",{scriptId:e}));return}let f=h.cloneFormData(d,(C,z)=>C==="scripts-included[]"&&typeof z=="string"&&z.toString().trim()===e.toString().trim()),p=h.cloneFormData(f);f.set("remove-scripts-included[]",e.toString()),f.set("remove-selected-scripts","i"),f.delete("script-action"),p.set("save","1");let m=new URLSearchParams(f),y=new URLSearchParams(p),P=Array.from(m).map(([C,z])=>`${encodeURIComponent(C)}=${encodeURIComponent(z)}`).join("&"),b=Array.from(y).map(([C,z])=>`${encodeURIComponent(C)}=${encodeURIComponent(z)}`).join("&");u.info("删除的数据",P),u.info("保存的数据",b);let Q=await G.updateUserSetsInfo(t,s,P);if(!Q)return;let k=Q.querySelector(".change-script-set");if(!k){g.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let j=new FormData(k);if(n(j,e)){u.error("删除失败，提交的删除请求中包含该脚本id"),g.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await G.updateUserSetsInfo(t,s,b),g.success(r.t("删除成功"));}catch(d){console.error(d);}finally{l.close();}});},vt={init(){B.isCode()?ft.init():B.isVersion()&&gt.init(),B.isCodeStrict()&&(v.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),v.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),v.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),v.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),c.ready(()=>{v.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){u.info("添加收藏按钮"),c.waitNode("ul#script-links li.current span").then(()=>{let e=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
...
`);for(let n=0;n<A.length;n++){let i=A[n],a=i.split("##"),o=a[0],s=a[1];if(o==="scriptRatingScore"){let l=parseFloat(s.slice(1));if(s.startsWith(">")){if(t.scriptRatingScore>l){u.info("触发脚本过滤规则",[i,t]),e.remove();break}}else if(s.startsWith("<")&&t.scriptRatingScore<l){u.info("触发脚本过滤规则",[i,t]),e.remove();break}}else if(o in t||o==="scriptDescription"){if(typeof s!="string")continue;let l=new RegExp(s,"ig");if(String(t[o]).match(l)){u.info("触发脚本过滤规则",i,t),e.remove();break}}}});},setValue(e){v.setValue(this.key,e);},addValue(e,t){let A=this.getValue();if(A.trim()!==""&&(A+=`
...
`,xe={getTampermonkey:()=>X.external?.Tampermonkey,getViolentmonkey:()=>X.external?.Violentmonkey,getScriptCat:()=>X.external?.Scriptcat,getScriptContainerStatus(){let e={Tampermonkey:false,Violentmonkey:false,ScriptCat:false};return X.external?.Tampermonkey&&(e.Tampermonkey=true),X.external?.Violentmonkey&&(e.Violentmonkey=true),X.external?.Scriptcat&&(e.ScriptCat=true),e},getRegisterScriptContainerNameList(){let t=this.getScriptContainerStatus(),A=[];return Object.keys(t).forEach(n=>{Reflect.get(t,n)&&A.push(n);}),A},getInstalledVersion(e,t){return new Promise((A,n)=>{const i=this.getTampermonkey();if(i){i.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(A);return}const o=this.getScriptCat();if(o){o.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}n(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const A=e.split("."),n=t.split(".");for(let i=0;i<A.length;i++){const a=this.compareVersionPart(A[i],n[i]);if(a!==0)return a}return 0},compareVersionPart(e,t){const A=this.parseVersionPart(e),n=this.parseVersionPart(t);for(let i=0;i<A.length;i++){if(A[i].length>0&&n[i].length===0)return  -1;if(A[i].length===0&&n[i].length>0||A[i]>n[i])return 1;if(A[i]<n[i])return  -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,A){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,A)){case  -1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const A=e.getAttribute("data-script-name"),n=e.getAttribute("data-script-namespace"),i=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(A,n);return a==null?!1:(this.handleInstallResult(e,a,i),!0)}catch{if(t){await h.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return  false}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),A=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:A,url:location.href},location.origin);}},Ne={init(){v.execMenuOnce("gf-scripts-filter-enable",()=>{oe.init();}),v.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let e=[];e.push(M(ht));const t="lum-lightbox-loader",A=r.t("安装此脚本");return S.ready(()=>{let n=xe.getScriptContainerStatus(),i=Object.values(n).find(d=>d),a=xe.getRegisterScriptContainerNameList(),o=v.getValue("beautifyCenterContent-queryNameSpace");i?u.info("当前暴露的external信息："+a.map(d=>`【${d}】`).join("、")):u.error("脚本容器未暴露external信息",window.external);let s=new h.LockFunction(()=>{oe.getElementList().forEach(f=>{if(f.querySelector(".script-list-operation"))return;let p=le.parseScriptListInfo(f),m=f.querySelector(".inline-script-stats");if(!m)return;let y=p.codeUrl,P=S.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),b=S.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${p.scriptRatingScore}</span>`},{"data-position":"right"}),Q=f.querySelector("dd.script-list-ratings .good-rating-count"),k=f.querySelector("dd.script-list-ratings .ok-rating-count"),j=f.querySelector("dd.script-list-ratings .bad-rating-count");if(Q&&k&&j){let I=parseInt(Q.innerText),O=parseInt(k.innerText),q=parseInt(j.innerText),F=I+O+q;F>=10?I/F>=.6?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count"):F==0||I>O+q?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count");}let w=S.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),C=S.createElement("dd",{className:"script-list-version",innerHTML:`<span>${p.scriptVersion}</span>`},{"data-position":"right"}),z=S.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),N=S.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(e);}});});}};class yt{key="short-cut";$data;isWaitPress=false;currentWaitEnterPressInstanceHandler=null;constructor(t){typeof t=="string"&&(this.key=t),this.$data={otherShortCutOptions:[]};}initConfig(t,A){this.hasOption(t)||this.setOption(t,A);}getStorageKey(){return this.key}getLocalAllOptions(){return ee(this.key,[])}hasOption(t){return !!this.getLocalAllOptions().find(i=>i.key===t)}hasOptionValue(t){return this.hasOption(t)?this.getOption(t)?.value!=null:false}getOption(t,A){return this.getLocalAllOptions().find(a=>a.key===t)??A}setOption(t,A){let n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===t);i==-1?n.push({key:t,value:A}):Reflect.set(n[i],"value",A),W(this.key,n);}emptyOption(t){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===t);return i!==-1&&(n[i].value=null,A=true),W(this.key,n),A}deleteOption(t){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===t);return i!==-1&&(n.splice(i,1),A=true),W(this.key,n),A}translateKeyboardValueToButtonText(t){let A="";return t.ohterCodeList.forEach(n=>{A+=h.stringTitleToUpperCase(n,true)+" + ";}),A+=h.stringTitleToUpperCase(t.keyName),A}getShowText(t,A){if(this.hasOption(t)){let n=this.getOption(t);return n.value==null?A:this.translateKeyboardValueToButtonText(n.value)}else return A}async enterShortcutKeys(t){const A=this;return new Promise(n=>{this.isWaitPress=true;let i=c.listenKeyboard(window,"keyup",(a,o,s)=>{const l={keyName:a,keyValue:o,ohterCodeList:s};let d={};try{const f=JSON.stringify(l),p=this.getLocalAllOptions();Array.isArray(this.$data.otherShortCutOptions)&&p.push(...this.$data.otherShortCutOptions);for(let m=0;m<p.length;m++){let y=p[m];if(y.key===t)continue;const P=JSON.stringify(y.value);let b=!1;if(y.value!=null&&f===P&&(b=!0),b){d={status:!1,key:y.key,option:l};return}}this.setOption(t,l),d={status:!0,key:t,option:l};}catch(f){console.log(f),d={status:false,key:t,option:l};}finally{A.isWaitPress=false,i.removeListen(),A.currentWaitEnterPressInstanceHandler=null,n(d);}});A.currentWaitEnterPressInstanceHandler=null,A.currentWaitEnterPressInstanceHandler=()=>{A.isWaitPress=false,i.removeListen();};})}cancelEnterShortcutKeys(){typeof this.currentWaitEnterPressInstanceHandler=="function"&&this.currentWaitEnterPressInstanceHandler();}initGlobalKeyboardListener(t,A){let n=this.getLocalAllOptions();if(!n.length){u.warn("没有设置快捷键");return}const i=this;function a(l,d){c.listenKeyboard(l,"keydown",(f,p,m,y)=>{if(i.isWaitPress)return;A?.isPrevent&&c.preventEvent(y),n=i.getLocalAllOptions();let P=n.findIndex(b=>{let Q=b.value,k={keyName:f,keyValue:p,ohterCodeList:m};if(JSON.stringify(Q)===JSON.stringify(k))return b});if(P!=-1){let b=n[P];b.key in d&&(u.info(["调用快捷键",b]),d[b.key].callback());}},{capture:!!A?.capture});}let o={},s={};Object.keys(t).forEach(l=>{let d=t[l];(d.target==null||typeof d.target=="string"&&d.target==="")&&(d.target="window"),d.target==="window"?Reflect.set(o,l,d):Reflect.set(s,l,d);}),a(window,o),c.ready(()=>{Object.keys(s).forEach(async l=>{let d=s[l];if(typeof d.target=="string")c.waitNode(d.target,1e4).then(f=>{if(!f)return;let p={};Reflect.set(p,l,d),a(f,p);});else if(typeof d.target=="function"){let f=await d.target();if(f==null)return;let p={};Reflect.set(p,l,d),a(f,p);}else {let f={};Reflect.set(f,l,d),a(d.target,f);}});});}}const Qe={shortCut:new yt,shortOption:{"gf-quickReply":{target:()=>{let e=T("form textarea"),t=T('input[name="commit"][type="submit"]');if(e){if(!t){u.error("页面不存在【发表回复】按钮");return}}else {u.error("页面不存在输入框");return}return u.success("监听快捷键：gf-quickReply"),e},callback(){if(document.activeElement){let e=document.activeElement.closest("form");if(!e){u.error("当前activeElement不在表单内，无法触发快捷键");return}let t=e.querySelectorAll('input[name="commit"][type="submit"]');if(!t.length){u.error("表单内不存在【发表回复】按钮");return}t.length>1&&u.warn("表单内存在多个【发表回复】按钮，只触发第一个"),t[0].click();}else u.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},wt=`section.text-content {\r
...
`,bt={init(){v.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),c.ready(()=>{v.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return u.info("美化对话框"),M(wt)},beautifyPrivateMessageList(){u.info("美化私信列表"),M(`
		...
		`),K("section.text-content ul li").forEach(e=>{let t=e.querySelector('a[href*="conversations"]'),A=t.href,n=t.textContent?.split(" ")[1],i=e.querySelector("a.user-link"),a=null,o=null,s=null;if(i){a=i.textContent,o=i.href;let l=e.querySelector("relative-time");new Date(l.getAttribute("datetime")),s=l.shadowRoot.lastChild.textContent;}e.classList.add("user-conversations-item"),D.getUserId(),e.innerHTML=`
...
`).forEach(o=>{try{if(o=o.trim(),h.isNull(o))return;let l=new URL(o).pathname.split("/"),{1:d,2:f,3:p,4:m}=l,y="";if(l.length>=6&&p==="blob")y=l.slice(5,l.length).join("/");else if(l.length>=8&&p==="raw"&&m==="refs")m=l[6],y=l.slice(7,l.length).join("/");else return;if(y==="")return;a.push(`https://raw.githubusercontent.com/${d}/${f}/${m}/${y}`);}catch{}}),A.value=a.join(`
`);});}},fe=function(e,t,A,n,i,a,o,s,l,d){let f={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:i,buttonIconIsLoading:a,buttonType:o,buttonText:A,callback(p){typeof s=="function"&&s(p);},afterAddToUListCallBack:l};return Reflect.set(f.attributes,Se,()=>{f.disable=false;}),f},Ee={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new ae.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,A){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=A,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,se,t);}},Le=function(e,t,A,n,i,a="",o,s,l,d){let f={text:e,type:"input",isNumber:!!o,isPassword:!!s,attributes:{},props:{},description:n,afterAddToUListCallBack:l,getValue(){return this.props[se].get(t,A)},callback(p,m,y){this.props[se].set(t,m);},placeholder:a};return Reflect.set(f.attributes,ge,t),Reflect.set(f.attributes,ve,A),Ee.initComponentsStorageApi("input",f,{get(p,m){return v.getValue(p,m)},set(p,m){v.setValue(p,m);}}),f},x=function(e,t,A,n,i,a,o,s){let l={text:e,type:"switch",description:i,disabled:o,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f){let p=!!f;u.success(`${p?"开启":"关闭"} ${e}`),this.props[se].set(t,p);},afterAddToUListCallBack:a};return Reflect.set(l.attributes,ge,t),Reflect.set(l.attributes,ve,A),Ee.initComponentsStorageApi("switch",l,{get(d,f){return v.getValue(d,f)},set(d,f){v.setValue(d,f);}}),l},de=function(e,t,A,n,i,a,o){let s=[];typeof n=="function"?s=n():s=n;let l={text:e,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f,p){let m=f;if(u.info(`选择：${p}`),typeof i=="function"&&i(d,m,p))return;this.props[se].set(t,m);},data:s};return Reflect.set(l.attributes,ge,t),Reflect.set(l.attributes,ve,A),Ee.initComponentsStorageApi("select",l,{get(d,f){return v.getValue(d,f)},set(d,f){v.setValue(d,f);}}),l},Pt=function(e,t,A,n,i,a="default",o){let s=typeof i=="function"?i():i;typeof n=="object"&&o.initConfig(A,n);let l=()=>o.getShowText(A,s),d=fe(e,t,l,"keyboard",false,false,a,async f=>{let m=f.target.closest(".pops-panel-button")?.querySelector("span");if(o.isWaitPress){g.warning("请先执行当前的录入操作");return}if(o.hasOptionValue(A))o.emptyOption(A),g.success("清空快捷键");else {let y=g.loading("请按下快捷键...",{showClose:true,onClose(){o.cancelEnterShortcutKeys();}}),{status:P,option:b,key:Q}=await o.enterShortcutKeys(A);y.close(),P?(u.success(["成功录入快捷键",b]),g.success("成功录入")):g.error(`快捷键 ${o.translateKeyboardValueToButtonText(b)} 已被 ${Q} 占用`);}m.innerHTML=l();});return d.attributes={},Reflect.set(d.attributes,Se,()=>false),d},Oe={async UIScriptList(e,t){if(!U.isLogin){g.error(r.t("请先登录账号！"));return}let i=U.getUserLinkElement().href?.split("/")?.pop()?.match(/([0-9]+)/)?.[0],a=R.loading({mask:{enable:true},parent:t,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:false}),o=await G.getUserInfo(i);if(a.close(),!o)return;u.info(o);let s=e==="script-list"?o.scriptList:o.scriptLibraryList;g.success(r.t("获取成功，共 {{count}} 个",{count:s.length}));for(const l of s){let d=c.createElement("li",{className:"w-script-list-item",innerHTML:`

...
`),g.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},Ye={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=f.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
            ...
            `}),M=v.querySelector(".w-script-info"),I=f.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});x.deleted&&(v.classList.add("w-script-deleted"),I.querySelector("button").setAttribute("disabled","true")),f.on(I,"click",void 0,async function(){u.success(["同步",x]);let C=I.querySelector("button"),$=I.querySelector("button span"),G=f.createElement("i",{className:"pops-bottom-icon",innerHTML:V.config.iconSVG.loading},{"is-loading":!0});C.setAttribute("disabled","true"),C.setAttribute("data-icon","true"),$.innerText=n.t("同步中..."),f.before($,G);let N=x==null?void 0:x.id,R=await U.getSourceCodeSyncFormData(N.toString());if(R){const W="script[script_sync_type_id]";if(R.has(W)){let z=R.get(W),_="";z.toString()==="1"?_=n.t("手动"):z.toString()==="2"?_=n.t("自动"):z.toString()==="3"&&(_="webhook");let q=v.querySelector(".w-script-sync-type");q?q.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:_}):f.append(M,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:_})}
									</p>
								</div>`),await U.sourceCodeSync(x.id.toString(),R)?m.success(n.t("同步成功")):m.error(n.t("同步失败"));}else m.error(n.t("该脚本未设置同步信息"));}C.removeAttribute("disabled"),C.removeAttribute("data-icon"),$.innerText=n.t("同步代码"),G.remove();}),v.appendChild(I),i.appendChild(v);}}},Ze={id:"greasy-fork-panel-config-script-list",title:n.t("脚本列表"),callback(e,t,r){Ee.UIScriptList("script-list",e,t,r);},forms:[]},Qe={id:"greasy-fork-panel-config-library",title:n.t("库"),callback(e,t,r){Ee.UIScriptList("script-library",e,t,r);},forms:[]},Xe=`.w-script-list-item {\r
	padding: 10px 0;\r

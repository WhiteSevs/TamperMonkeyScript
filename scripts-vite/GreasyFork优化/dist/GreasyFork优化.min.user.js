...
// @require            https://fastly.jsdelivr.net/npm/i18next@25.2.1/i18next.min.js
...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof ht=="function"?ht(t.keyName):"";typeof e=="string"&&e?P(e):tt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,d.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(A=>{e.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let A=[document.documentElement,document.body].concat(...t||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}}};qt();H(Y,{});const Vt=r.t("GreasyFork优化"),g=lt.noConflict(),d=T.noConflict(),D=Ct,u=new g.Log(ft,O.console||Rt.console);var zt;const xt=((zt=ft==null?void 0:ft.script)==null?void 0:zt.name)||Vt,St=false;u.config({debug:St,logMaxCount:1e3,autoClearConsole:true,tag:true});h.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return v.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return v.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return v.getValue("qmsg-config-showreverse",true)}},zIndex:{get(){let t=lt.getMaxZIndex(),e=Ct.config.InstanceUtils.getPopsMaxZIndex().zIndex;return lt.getMaxValue(t,e)+100}}}));const kt=new g.GM_Menu({GM_getValue:H,GM_setValue:V,GM_registerMenuCommand:Qt,GM_unregisterMenuCommand:Ut}),j=new g.Httpx({xmlHttpRequest:Kt,logDetails:St});j.interceptors.response.use(void 0,t=>(u.error("拦截器-请求错误",t),t.type==="onabort"?h.warning(r.t("请求取消")):t.type==="onerror"?h.error(r.t("请求异常")):t.type==="ontimeout"?h.error(r.t("请求超时")):h.error(r.t("其它错误")),t));O.Object.defineProperty,O.Function.prototype.apply,O.Function.prototype.call,O.Element.prototype.appendChild,O.setTimeout;const P=g.addStyle.bind(g),z=document.querySelector.bind(document),E=document.querySelectorAll.bind(document),nt=function(t,e,A,n,i,a,o,s,l){return {text:t,type:"button",description:e,buttonIcon:n,buttonIsRightIcon:i,buttonIconIsLoading:a,buttonType:o,buttonText:A,callback(p){typeof s=="function"&&s(p);},afterAddToUListCallBack:l}},vt=function(t,e,A,n,i,a="",o,s){let l={text:t,type:"input",isNumber:!!o,isPassword:!!s,props:{},attributes:{},description:n,getValue(){return this.props[W].get(e,A)},callback(c,p){this.props[W].set(e,p);},placeholder:a};return Reflect.set(l.attributes,ct,e),Reflect.set(l.attributes,dt,A),Reflect.set(l.props,W,{get(c,p){return v.getValue(c,p)},set(c,p){v.setValue(c,p);}}),l},y=function(t,e,A,n,i,a){let o={text:t,type:"switch",description:i,attributes:{},props:{},getValue(){return !!this.props[W].get(e,A)},callback(s,l){let c=!!l;u.success(`${c?"开启":"关闭"} ${t}`),this.props[W].set(e,c);},afterAddToUListCallBack:a};return Reflect.set(o.attributes,ct,e),Reflect.set(o.attributes,dt,A),Reflect.set(o.props,W,{get(s,l){return v.getValue(s,l)},set(s,l){v.setValue(s,l);}}),o},L={getInstallUrl(t,e,A){return g.isNotNull(A)?A="/"+A:A="",`https://update.${window.location.hostname}/scripts/${t}/${e}${A}.user.js`},getCodeUrl(t,e){return g.isNull(e)&&(e=""),`/scripts/${t}/code?version=${e}`},getCodeSearchUrl(t){return "/zh-CN/scripts/code-search?c="+encodeURIComponent(t)},getScriptInfoUrl(t){return `/scripts/${t}.json`},getScriptHomeUrl(t){return `/scripts/${t}`},getAdminUrl(t){return t+"/admin"},getScriptId(t){var e,A;return (A=(e=t||window.location.pathname)==null?void 0:e.match(/\/scripts\/([\d]+)/i))==null?void 0:A[1]},getUserId(t){var e;return (e=(t||window.location.pathname).match(/\/users\/([\d]+)/i))==null?void 0:e[1]},getReportUrl(t,e){return `${window.location.origin}/reports/new?item_class=${t}&item_id=${e}`},getScriptName(t){let e=window.location.pathname;t!=null&&(e=new URL(t).pathname),e=decodeURIComponent(e);let A=e.split("/");for(const n of A){let i=n.match(/[\d]+/);if(i&&i.length)return i[1]}},getSwitchLanguageUrl(t="zh-CN"){let e=window.location.origin,A=window.location.pathname.split("/");return A[1]=t,e=e+A.join("/"),e+=window.location.search,window.location.search===""?e+="?locale_override=1":window.location.search.includes("locale_override=1")||(e+="&locale_override=1"),e}},et={getCurrentLoginUserId(){let t=z("#nav-user-info .user-profile-link a");if(!t)return;let e=L.getUserId(t.href);if(e!=null)return e},parseScriptListInfo(t){let e=t.dataset;const A={scriptId:parseInt(e.scriptId),scriptName:e.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(e.scriptDailyInstalls),scriptTotalInstalls:parseInt(e.scriptTotalInstalls),scriptRatingScore:parseFloat(e.scriptRatingScore),scriptCreatedDate:new Date(e.scriptCreatedDate),scriptUpdatedDate:new Date(e.scriptUpdatedDate),scriptType:e.scriptType,scriptVersion:e.scriptVersion,sensitive:e.sensitive==="true",scriptLanguage:e.scriptLanguage,cssAvailableAsJs:e.cssAvailableAsJs==="true",codeUrl:e.codeUrl,scriptDescription:e.scriptDescription,scriptAuthorId:parseInt(e.scriptAuthorId),scriptAuthorName:e.scriptAuthorName};let n=g.toJSON(e.scriptAuthors);if(Object.keys(n).forEach(i=>{let a=n[i];A.scriptAuthors.push({authorId:parseInt(i),authorName:a});}),(A.scriptAuthorName==null||isNaN(A.scriptAuthorId))&&A.scriptAuthors.length&&(A.scriptAuthorName=A.scriptAuthors[0].authorName,A.scriptAuthorId=A.scriptAuthors[0].authorId),A.scriptDescription==null){let i=t.querySelector(".script-description")||t.querySelector(".description");i&&(A.scriptDescription=i.innerText||i.textContent);}return A},registerTopNavMenu(t){d.ready(()=>{let e=z("#site-nav nav"),A=z("#site-nav .with-submenu nav");if(!e){u.error("元素#site-nav nav不存在");return}let n=d.createElement("li",{className:t.className,innerHTML:`
            ...
            `}),w=m.querySelector(".w-script-info"),x=d.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});f.deleted&&(m.classList.add("w-script-deleted"),x.querySelector("button").setAttribute("disabled","true")),d.on(x,"click",async function(){u.success("同步",f);let b=x.querySelector("button"),M=x.querySelector("button span"),k=d.createElement("i",{className:"pops-bottom-icon",innerHTML:D.config.iconSVG.loading},{"is-loading":true});b.setAttribute("disabled","true"),b.setAttribute("data-icon","true"),M.innerText=r.t("同步中..."),d.before(M,k);let N=f==null?void 0:f.id,Q=await B.getSourceCodeSyncFormDataInfo(N.toString());if(Q){const{formData:I,url:X}=Q,U="script[script_sync_type_id]",q="script[sync_type]";if(I.has(U)||I.has(q)){let K="";if(I.has(U)){let G=I.get(U);G.toString()==="1"?K=r.t("手动"):G.toString()==="2"?K=r.t("自动"):G.toString()==="3"&&(K="webhook");}else I.has(q)&&(K=I.get(q));let R=m.querySelector(".w-script-sync-type");R?R.querySelector("p").innerText=r.t("同步方式：{{syncMode}}",{syncMode:K}):d.append(w,`
								<div class="w-script-sync-type">
									<p>${r.t("同步方式：{{syncMode}}",{syncMode:K})}
									</p>
								</div>`),await B.sourceCodeSync(f.id.toString(),I,X)?h.success(r.t("同步成功")):h.error(r.t("同步失败"));}else h.error(r.t("该脚本未设置同步信息"));}b.removeAttribute("disabled"),b.removeAttribute("data-icon"),M.innerText=r.t("同步代码"),k.remove();}),m.appendChild(x),e.appendChild(m);}}},wt={isCurrentLoginUserHome(){let t=et.getCurrentLoginUserId();return !!(t!=null&&C.isUsers()&&window.location.pathname.includes("/"+t))},monacoEditor(){return new Promise(t=>{const e="0.52.2",A="monaco-editor-ready";if(O.monaco){t(O.monaco);return}let n=h.loading(r.t("monaco-editor加载中...")),i=d.createElement("script",{type:"module",defer:true,innerHTML:`
...
`),g.isNull(t))return;t=t.toString().trim();let n=t+"##"+e;A+=n,this.setValue(A);},getValue(){return v.getValue(this.key,"")}},Jt={id:"greasy-fork-panel-config-discussions",title:r.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(t){let e="discussions-readBgColor",A=d.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										<textarea placeholder="${r.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),A=e.querySelector("textarea");return A.value=Z.getValue(),d.on(A,["input","propertychange"],void 0,g.debounce(function(n){Z.setValue(A.value);},200)),t.appendChild(e),t}}]}]}]}]},$t=`.w-script-list-item {\r
	padding: 10px;\r
...
`,de="",ue={init(){v.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),v.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),v.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),v.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let t=[];return t.push(P(Ae)),t.push(P(re)),t.push(P(ne)),t.push(P(oe)),t.push(P(ie)),t.push(P(`
			...
			`)),d.ready(()=>{let e=z('a[target="markup_choice"][href*="daringfireball.net"]');e&&e.parentElement.replaceChild(d.createElement("span",{textContent:"Markdown"}),e),E(".user-content ul li").forEach(i=>{var o,s;let a=i.firstChild;(a==null?void 0:a.nodeName)==="#text"&&((o=a.textContent)!=null&&o.startsWith("[x] ")?(a.textContent=a.textContent.replace("[x] ",""),d.prepend(i,`
				...
				section#script-info{
					margin-top: 10px;
				}`)),t},beautifyUploadImage(){u.info("美化上传图片");let t=[];return t.push(P(ae)),d.ready(()=>{function e(i){for(;i.nextElementSibling;)i.parentElement.removeChild(i.nextElementSibling);}let A=E('input[type="file"]');A.forEach(i=>{i.getAttribute("name")!=="code_upload"&&(i.hasAttribute("accept")&&i.getAttribute("accept").includes("javascript")||d.on(i,["propertychange","input"],function(a){e(a.target);let o=a.currentTarget.files;if(!o||o.length===0)return;u.info("选择的图片",o),o.length>5&&d.after(i,d.createElement("p",{textContent:r.t("❌ 最多同时长传5张图片")}));let s=[];Array.from(o).forEach(l=>{(l.size>204800||!l.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&s.push(l);}),s.length!==0&&s.forEach(l=>{d.after(i,d.createElement("p",{textContent:r.t("❌ 图片：{{name}} 大小：{{size}}",{name:l.name,size:l.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(i=>{d.on(i,"paste",a=>{u.info("触发粘贴事件",a),setTimeout(()=>{d.trigger(A,"input");},100);});});}),t},beautifyTopNavigationBar(){u.info("美化顶部导航栏");let t=[];return t.push(P(le)),window.outerWidth>550&&(t.push(tt.addBlockCSS(".with-submenu")),d.ready(()=>{let A=z("#site-nav").querySelector("nav");E(".with-submenu nav li").forEach(n=>{A.appendChild(n);});})),t}},fe={init(){v.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){g.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let t=v.getValue("user"),e=v.getValue("pwd"),A=v.getValue("secret");if(g.isNull(t)){h.error(r.t("请先在菜单中录入账号"));return}if(g.isNull(e)){h.error(r.t("请先在菜单中录入密码"));return}if(g.isNull(A)){h.error(r.t("请先在菜单中录入secret"));return}let n=z("meta[name='csrf-token']");if(!n){h.error(r.t("获取csrf-token失败"));return}let a=new jt__namespace.TOTP({secret:A}).generate(),o=h.loading(r.t("正在登录中...")),s=await j.post("/zh-CN/users/sign_in",{fetch:true,data:encodeURI(`authenticity_token=${n.getAttribute("content")}&user[email]=${t}&user[password]=${e}&user[remember_me]=1&user[otp_attempt]=${a}&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(o.destroy(),!s.status){u.error(s),h.error(r.t("登录失败，请求异常"));return}let l=s.data.responseText,c=d.parseHTML(l,true,true),p=c.querySelector(".width-constraint .alert");c.querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(h.success(r.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):p?(u.error(p),h.error(d.text(p))):(h.error(r.t("登录失败，可能是账号/密码错误，请在控制台查看原因"),{consoleLogContent:true}),u.error(s),u.error(`当前账号:${t}`),u.error(`当前密码:${e}`));});}},pe={init(){this.readBgColor(),d.ready(()=>{v.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();});let t=new g.LockFunction(()=>{v.execMenu("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();}),v.execMenu("discussions-addReportButton",()=>{this.addReportButton();});});g.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{t.run();}});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),Z.init();},readBgColor(){u.info("设置已读背景颜色");let t=v.getValue("discussions-readBgColor");return P(`
        .discussion-read{
        ...
        `)},addShortcutOperationButton(){u.info("添加【过滤】按钮"),Z.getElementList().forEach(t=>{if(t.querySelector(".discussion-filter-button"))return;let A=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=d.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-report-button");A.appendChild(n),d.on(i,"click",a=>{g.preventEvent(a);const o=Z.parseDiscuessionListContainerInfo(t);D.alert({title:{text:r.t("举报"),position:"center",html:false},content:{text:`
						...
						${o.replyUserId&&o.replyUserId!=o.postUserId?`
							...
							`});});});}},ve={init(){v.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();}),v.execMenuOnce("code-use-monaco-editor",()=>{this.coverEditorWithMonaco();});},repairCodeLineNumber(){u.info("修复代码的行号显示不够问题"),v.execMenuOnce("beautifyGreasyforkBeautify",()=>{P(`
...
`,he={init(){v.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),v.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),v.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let t=[];return t.push(P(ge)),t.push(tt.addBlockCSS(".version-number",".version-date",".version-changelog")),d.ready(function(){let e=z("ul.history_versions");if(!e){h.error(r.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(A=>{var p,f;let n=A.querySelector(".version-number a").href,i=A.querySelector(".version-number a").innerText,a=(p=A.querySelector(".version-date"))==null?void 0:p.getAttribute("datetime"),o=((f=A.querySelector(".version-changelog"))==null?void 0:f.innerHTML)||"",s=d.createElement("span",{className:"script-version-date",innerHTML:g.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),l=d.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
						...
						`});d.after(t,l);});});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),wt.monacoEditor().then(t=>{d.ready(()=>{E('#script-content form[action*="/diff"] input[type="submit"]').forEach(e=>{let A=d.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});d.after(e,A),d.on(A,"click",async n=>{g.preventEvent(n);let i=e.closest("form"),a=new FormData(i),o=a.get("v1"),s=a.get("v2");if(o===s){h.warning(r.t("版本号相同，不需要比较源码"));return}let l=h.loading(r.t("正在获取对比文本中...")),c=L.getScriptId(),p=await B.getScriptInfo(c);if(!p){l.close();return}let f=p.code_url,m=f.replace(new RegExp(`/${c}(/[\\d]+|)`),`/${c}/${o}`),w=f.replace(new RegExp(`/${c}(/[\\d]+|)`),`/${c}/${s}`),x="",b="";const[M,k]=await Promise.all([j.get(m,{timeout:2e4}),j.get(w,{timeout:2e4})]);if(l.close(),!M.status||!k.status)return;x=M.data.responseText,b=k.data.responseText;let{recovery:N}=tt.lockScroll(),Q=D.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
								<div class="monaco-editor-diff-container">
									<div class="monaco-editor-diff"></div>
								</div>
								`},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},btn:{ok:{enable:false},close:{callback(K,R){K.close(),N();}}},zIndex(){let K=g.getMaxZIndex(),R=D.config.InstanceUtils.getPopsMaxZIndex().zIndex;return g.getMaxValue(K,R)+100},useShadowRoot:false,width:"90vw",height:"90vh",drag:true,style:`
						...
						`});Q.$shadowRoot.querySelector(".monaco-editor-diff-container");let I=Q.$shadowRoot.querySelector(".monaco-editor-diff"),X=t.editor.createDiffEditor(I,{hideUnchangedRegions:{enabled:true},minimap:{enabled:true},automaticLayout:true,codeLens:true,colorDecorators:true,contextmenu:false,readOnly:true,formatOnPaste:true,overviewRulerBorder:true,scrollBeyondLastLine:false,theme:"vs-dark",fontSize:window.innerWidth>600?14:12,wordWrap:"off",language:"javascript"});const U=t.editor.createModel(b,"javascript"),q=t.editor.createModel(x,"javascript");X.setModel({original:U,modified:q});});});});});}};let ut=[];const Dt=async function(t){if(u.info("当前脚本id："+t),!S.isLogin){u.error("请先登录账号"),h.error(r.t("请先登录账号"));return}let e=L.getUserId(S.getUserLinkElement().href);if(e==null){u.error("获取用户id失败"),h.error(r.t("获取用户id失败"));return}if(!ut.length){let a=h.loading(r.t("获取收藏夹中..."));if(ut=await B.getUserCollection(e)||[],a.close(),!ut.length)return}let A="";const n=(a,o)=>{let s=false;o=o.toString().trim();for(const[l,c]of a.entries())if(l==="scripts-included[]"&&c.toString().trim()===o){s=true;break}return s};ut.forEach(a=>{A+=`
		...
		`});d.on(i.$shadowRoot,"click",".collect-add-script-id",async function(a){let o=a.target.closest(".user-collect-item"),s=o.dataset.id;o.dataset.name;let l=h.loading(r.t("添加中..."));try{let c=await B.getUserCollectionInfo(e,s);if(!c)return;if(n(c,t)){h.warning(r.t("该脚本已经在该收藏集中"));return}let p=g.cloneFormData(c),f=g.cloneFormData(c);p.set("add-script",t.toString()),p.set("script-action","i"),f.append("scripts-included[]",t.toString()),f.set("save","1");let m=new URLSearchParams(p),w=new URLSearchParams(f),x=Array.from(m).map(([U,q])=>`${encodeURIComponent(U)}=${encodeURIComponent(q)}`).join("&"),b=Array.from(w).map(([U,q])=>`${encodeURIComponent(U)}=${encodeURIComponent(q)}`).join("&");u.info("添加的数据",x),u.info("保存的数据",b);let M=await B.updateUserSetsInfo(e,s,x);if(!M)return;let k=M.querySelector(".change-script-set");if(!k){h.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let N=k.querySelector("section");if(!N){h.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}let Q=N.querySelector(".alert");if(Q){D.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:Q.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:$.info.width,height:$.info.height});return}let I=new FormData(k);if(!n(I,t)){u.error("添加失败，提交的添加请求中不包含该脚本id"),h.error(r.t("添加失败，表单数据中不包含该脚本"));return}await B.updateUserSetsInfo(e,s,b),h.success(r.t("添加成功"));}catch(c){console.error(c);}finally{l.close();}}),d.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(a){let o=a.target.closest(".user-collect-item"),s=o.dataset.id;o.dataset.name;let l=h.loading(r.t("删除中..."));try{let c=await B.getUserCollectionInfo(e,s);if(!c)return;if(!n(c,t)){h.info(r.t("已删除：{{scriptId}}",{scriptId:t}));return}let p=g.cloneFormData(c,(I,X)=>I==="scripts-included[]"&&typeof X=="string"&&X.toString().trim()===t.toString().trim()),f=g.cloneFormData(p);p.set("remove-scripts-included[]",t.toString()),p.set("remove-selected-scripts","i"),p.delete("script-action"),f.set("save","1");let m=new URLSearchParams(p),w=new URLSearchParams(f),x=Array.from(m).map(([I,X])=>`${encodeURIComponent(I)}=${encodeURIComponent(X)}`).join("&"),b=Array.from(w).map(([I,X])=>`${encodeURIComponent(I)}=${encodeURIComponent(X)}`).join("&");u.info("删除的数据",x),u.info("保存的数据",b);let M=await B.updateUserSetsInfo(e,s,x);if(!M)return;let k=M.querySelector(".change-script-set");if(!k){h.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let N=new FormData(k);if(n(N,t)){u.error("删除失败，提交的删除请求中包含该脚本id"),h.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await B.updateUserSetsInfo(e,s,b),h.success(r.t("删除成功"));}catch(c){console.error(c);}finally{l.close();}});},me={init(){C.isCode()?ve.init():C.isVersion()&&he.init(),C.isCodeStrict()&&(v.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),v.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),v.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),v.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),d.ready(()=>{v.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){u.info("添加收藏按钮"),g.waitNode("ul#script-links li.current span").then(()=>{let t=d.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
					</a>`});d.append(z("ul#script-links"),t),d.on(t,"click",()=>{let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){u.error(e,window.location.pathname),h.error(r.t("获取脚本id失败"));return}let A=e[e.length-1];Dt(A);});});},fullScreenOptimization(){u.info("F11全屏，F键代码全屏"),P(`
...
`,gt={getTampermonkey:()=>{var t;return (t=O.external)==null?void 0:t.Tampermonkey},getViolentmonkey:()=>{var t;return (t=O.external)==null?void 0:t.Violentmonkey},getScriptCat:()=>{var t;return (t=O.external)==null?void 0:t.Scriptcat},getScriptContainerStatus(){var e,A,n;let t={Tampermonkey:false,Violentmonkey:false,ScriptCat:false};return (e=O.external)!=null&&e.Tampermonkey&&(t.Tampermonkey=true),(A=O.external)!=null&&A.Violentmonkey&&(t.Violentmonkey=true),(n=O.external)!=null&&n.Scriptcat&&(t.ScriptCat=true),t},getRegisterScriptContainerNameList(){let e=this.getScriptContainerStatus(),A=[];return Object.keys(e).forEach(n=>{Reflect.get(e,n)&&A.push(n);}),A},getInstalledVersion(t,e){return new Promise((A,n)=>{const i=this.getTampermonkey();if(i){i.isInstalled(t,e,function(s){s.installed?A(s.version):A(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(t,e).then(A);return}const o=this.getScriptCat();if(o){o.isInstalled(t,e,function(s){s.installed?A(s.version):A(null);});return}n(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(t,e){if(t===e)return 0;const A=t.split("."),n=e.split(".");for(let i=0;i<A.length;i++){const a=this.compareVersionPart(A[i],n[i]);if(a!==0)return a}return 0},compareVersionPart(t,e){const A=this.parseVersionPart(t),n=this.parseVersionPart(e);for(let i=0;i<A.length;i++){if(A[i].length>0&&n[i].length===0)return  -1;if(A[i].length===0&&n[i].length>0||A[i]>n[i])return 1;if(A[i]<n[i])return  -1}return 0},parseVersionPart(t){if(!t)return [0,"",0,""];const e=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(t);return [e[1]?parseInt(e[1]):0,e[2],e[3]?parseInt(e[3]):0,e[4]]},handleInstallResult(t,e,A){if(e!=null)switch(t.removeAttribute("data-ping-url"),this.compareVersions(e,A)){case  -1:t.textContent=t.getAttribute("data-update-label");break;case 1:t.textContent=t.getAttribute("data-downgrade-label");break;case 0:t.textContent=t.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(t,e){const A=t.getAttribute("data-script-name"),n=t.getAttribute("data-script-namespace"),i=t.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(A,n);return a==null?!1:(this.handleInstallResult(t,a,i),!0)}catch{if(e){await g.sleep(1e3);try{return await this.checkForUpdatesJS(t,!1)}catch{}}return  false}},checkForUpdatesCSS(t){const e=t.getAttribute("data-script-name"),A=t.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:e,namespace:A,url:location.href},location.origin);}},It={init(){v.execMenuOnce("gf-scripts-filter-enable",()=>{J.init();}),v.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let t=[];t.push(P(we));const e="lum-lightbox-loader",A=r.t("安装此脚本");return T.ready(()=>{let n=gt.getScriptContainerStatus(),i=Object.values(n).find(c=>c),a=gt.getRegisterScriptContainerNameList(),o=v.getValue("beautifyCenterContent-queryNameSpace");i?u.info("当前暴露的external信息："+a.map(c=>`【${c}】`).join("、")):u.error("脚本容器未暴露external信息",window.external);let s=new g.LockFunction(()=>{J.getElementList().forEach(p=>{if(p.querySelector(".script-list-operation"))return;let f=et.parseScriptListInfo(p),m=p.querySelector(".inline-script-stats");if(!m)return;let w=f.codeUrl,x=T.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),b=T.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${f.scriptRatingScore}</span>`},{"data-position":"right"}),M=p.querySelector("dd.script-list-ratings .good-rating-count"),k=p.querySelector("dd.script-list-ratings .ok-rating-count"),N=p.querySelector("dd.script-list-ratings .bad-rating-count");if(M&&k&&N){let R=parseInt(M.innerText),F=parseInt(k.innerText),G=parseInt(N.innerText),it=R+F+G;it>=10?R/it>=.6?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count"):it==0||R>F+G?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count");}let Q=T.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),I=T.createElement("dd",{className:"script-list-version",innerHTML:`<span>${f.scriptVersion}</span>`},{"data-position":"right"}),X=T.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),U=T.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),q=U.querySelector(".script-collect-btn"),K=U.querySelector(".install-link");if(K["data-script-info"]=f,T.addClass(K,e),f.scriptType==="library"&&K.remove(),T.on(q,"click",R=>{g.preventEvent(R),Dt(f.scriptId);}),v.getValue("gf-scripts-filter-enable")){let R=T.createElement("button",{className:"script-filter-btn",innerHTML:r.t("过滤")}),F="data-filter-key",G="data-filter-value";T.on(R,"click",it=>{g.preventEvent(it);let pt=D.alert({title:{text:r.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${F}="scriptId" ${G}="^${f.scriptId}$">${r.t("脚本id：{{text}}",{text:f.scriptId})}</button>
									<button ${F}="scriptName" ${G}="^${g.parseStringToRegExpString(f.scriptName)}$">${r.t("脚本名：{{text}}",{text:f.scriptName})}</button>
								...
								`}),yt=pt.$shadowRoot.querySelector(".pops-alert-content");f.scriptAuthors.forEach(_=>{let At=T.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:_.authorId})});At.setAttribute(F,"scriptAuthorId"),At.setAttribute(G,"^"+_.authorId+"$");let at=T.createElement("button",{innerHTML:r.t("作者名：{{text}}",{text:_.authorName})});at.setAttribute(F,"scriptAuthorName"),at.setAttribute(G,"^"+g.parseStringToRegExpString(_.authorName)+"$"),yt.appendChild(At),yt.appendChild(at);}),T.on(pt.$shadowRoot,"click",`button[${F}]`,_=>{g.preventEvent(_);let At=_.target,at=At.getAttribute(F),Tt=At.getAttribute(G);J.addValue(at,Tt),pt.close(),J.filter(),h.success(r.t("添加成功"));});}),U.appendChild(R);}m.appendChild(x),m.appendChild(b),m.appendChild(Q),m.appendChild(I),m.appendChild(X),m.appendChild(U);});},100),l=new g.LockFunction(async()=>{let c=Array.from(E(".install-link[data-install-format=js]:not([gm-is-check-install-status])"));for(let p=0;p<c.length;p++){const f=c[p];f.setAttribute("gm-is-check-install-status","");let m=Reflect.get(f,"data-script-info");if(i){if(o){let w=await B.getScriptInfo(m.scriptId);w&&f.setAttribute("data-script-namespace",w.namespace);}gt.checkForUpdatesJS(f,true).then(w=>{T.removeClass(f,e),w||T.text(f,A);});}else T.removeClass(f,e),T.text(f,A);}});g.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{s.run(),l.run();}});}),t}},ye={init(){v.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),v.execMenuOnce("gf-scripts-filter-enable",()=>{J.init();}),v.execMenuOnce("beautifyCenterContent",()=>It.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),tt.addBlockCSS("#about-user"),d.ready(()=>{let t=z("#about-user");if(!t){u.error("#about-user元素不存在");return}t=t.cloneNode(true),et.registerTopNavMenu({name:r.t("控制台"),className:"scripts-console",clickEvent(e){D.alert({title:{text:r.t("控制台"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:$.setting.width,height:$.setting.height,zIndex:g.getMaxZIndex(100),style:`
						#about-user{
							border: 0;
							box-shadow: none;
						}
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(t);}});});}},be=`section.text-content {\r
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,xe={init(){v.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),d.ready(()=>{v.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return u.info("美化对话框"),P(be)},beautifyPrivateMessageList(){u.info("美化私信列表"),P(`
		...
		`),E("section.text-content ul li").forEach(t=>{var l;let e=t.querySelector('a[href*="conversations"]'),A=e.href,n=(l=e.textContent)==null?void 0:l.split(" ")[1],i=t.querySelector("a.user-link"),a=null,o=null,s=null;if(i){a=i.textContent,o=i.href;let c=t.querySelector("relative-time");new Date(c.getAttribute("datetime")),s=c.shadowRoot.lastChild.textContent;}t.classList.add("user-conversations-item"),L.getUserId(),t.innerHTML=`
			...
			`;});}},Lt={waitScritList(){return g.waitNode("#browse-script-list",1e4)},addFilterControls(t){function e(){let l=z("#gm-script-filter-controls");if(!l)return;let c=l==null?void 0:l.shadowRoot;if(!c)return;let p=c.querySelector(".pops-filter-controls_inner"),f=c.querySelector(".pops-filter-search-container");if(p&&f)return {$filterControl:p,$search:f}}let A=e();if(A)return A;let n=d.createElement("div",{id:"gm-script-filter-controls"}),i=n.attachShadow({mode:"open"});i.appendChild(d.createElement("style",{innerHTML:`
			...
			`}),o=a.querySelector(".pops-filter-controls_inner"),s=a.querySelector(".pops-filter-search-container");return i.appendChild(a),d.before(t,n),{$filterControl:o,$search:s}}},Pe={init(){d.ready(()=>{Lt.waitScritList().then(t=>{if(!t){u.error("未找到脚本列表节点，无法继续执行");return}v.onceExec("GreasyforkScriptsSearch",()=>{let{$filterControl:e,$search:A}=Lt.addFilterControls(t);this.addFilterControlsItem(A,e);});});});},addFilterControlsItem(t,e){let A=D.config.panelHandleContentUtils(),n=[{name:r.t("名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching-enable",callback:(o,s)=>{try{return !s.scriptName.match(new RegExp(o,"i"))}catch(l){return u.error(l),!s.scriptName.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("描述"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptDescWholeWordMatching-enable",callback:(o,s)=>{try{return !s.scriptDescription.match(new RegExp(o,"i"))}catch{return !s.scriptDescription.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("名称/描述"),desc:r.t("任一全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable",callback:(o,s)=>{let l=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptTitleWholeWordMatching").callback(o,s),c=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptDescWholeWordMatching").callback(o,s);return l&&c},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleWholeWordMatching-enable"]','.gm-script-control-item[data-storage-key="gf-script-search-filterScriptDescWholeWordMatching-enable"]']},{name:r.t("作者名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching-enable",callback:(o,s)=>{try{return !s.scriptAuthorName.match(new RegExp(o,"i"))}catch{return !s.scriptAuthorName.match(o)}}}],i=()=>{var c,p;let o=t.querySelector("input");if(o)return o.value;let s=new URLSearchParams(window.location.search);return ((c=s.get("q"))==null?void 0:c.trim())||((p=s.get("c"))==null?void 0:p.trim())||""},a=()=>{let o=i();J.getElementList().forEach(l=>{let c=et.parseScriptListInfo(l),p=n.map(f=>{if(o=="")return  false;if(H(f.STORAGE_KEY))return f.callback(o,c)}).filter(f=>typeof f=="boolean");if(p.length!==0){let f=false;p.forEach(m=>{f=f||m;}),f?d.hide(l,false):d.show(l,false);}else d.show(l,false);});};if(v.getValue("gf-script-search-addFilterSearchInput")){let o=A.createSectionContainerItem_input({type:"input",className:"gm-script-search-input",getValue(){let s=i();return v.getValue("gf-script-search-addFilterSearchInput-text")||s||""},description:r.t("自动执行过滤"),placeholder:r.t("过滤的关键词"),text:r.t("关键词"),callback:g.debounce((s,l)=>{v.setValue("gf-script-search-addFilterSearchInput-text",l.toString()),a();},500)});d.append(t,o);}n.forEach(o=>{if(!v.getValue(o.ENABLE_KEY))return;u.info(`添加按钮${o.name}`);let s=A.createSectionContainerItem_switch({type:"switch",className:"gm-script-control-item",text:o.name,description:o.desc,attributes:{"data-storage-key":o.STORAGE_KEY},getValue(){let l=H(o.STORAGE_KEY,false);return l=!!l,a(),l},callback(l,c){if(V(o.STORAGE_KEY,c),a(),c&&Array.isArray(o.mutualExclusionSwitch)){let p=s.closest(".pops");o.mutualExclusionSwitch.forEach(f=>{let m=p.querySelector(f);if(m){let w=m.querySelector("input");if(w!=null&&w.checked){let x=m.querySelector(".pops-panel-switch__core");x==null||x.click();}}});}}});d.append(e,s);});}},ot={init(){if(C.isImageSource()){u.info("Router: 资源界面，不执行脚本功能");return}v.execMenu("checkPage",()=>{this.checkPage();}),ue.init(),Et.init(),C.isScript()&&me.init(),(C.isScriptList()||C.isScriptLibraryList()||C.isScriptCodeSearch()||C.isScriptsBySite())&&It.init(),C.isDiscuessions()?(u.info("Router: 讨论页面"),pe.init()):C.isUsers()?(u.info("Router: 用户页面"),ye.init(),C.isUsersConversations()&&(u.info("Router-next: 私聊用户页面"),xe.init())):(C.isScriptSearch()||C.isScriptsBySite()||C.isScriptCodeSearch()||C.isScriptLibraryListSearch())&&(u.info("Router: 脚本搜索页面"),Pe.init()),v.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),d.ready(()=>{S.initEnv(),fe.init(),mt.init(),S.handleLocalGotoCallBack(),v.execMenuOnce("fixImageWidth",()=>{ot.fixImageWidth();}),ot.languageSelectorLocale(),v.execMenuOnce("optimizeImageBrowsing",()=>{ot.optimizeImageBrowsing();}),v.execMenuOnce("overlayBedImageClickEvent",()=>{ot.overlayBedImageClickEvent();}),C.isCodeStrict()||v.execMenuOnce("addMarkdownCopyButton",()=>{ot.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(u.info("修复图片显示问题"),P(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }

...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ae=="function"?ae(e.keyName):"";typeof t=="string"&&t?ce(t):X.addLinkNode(e.url);},async addLinkNode(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,d.ready(()=>{document.head.appendChild(t);}),t},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e}},se={getInstallUrl(e,t,r){return m.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${e}/${t}${r}.user.js`},getCodeUrl(e,t){return m.isNull(t)&&(t=""),`https://greasyfork.org/scripts/${e}/code?version=${t}`},getScriptInfoUrl(e){return `https://greasyfork.org/scripts/${e}.json`}},Ue={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){c.info("美化 历史版本 页面");let e=[];return e.push(x(Ae)),e.push(X.addBlockCSS(".version-number",".version-date",".version-changelog")),d.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){f.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var g,w;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,s=(g=r.querySelector(".version-date"))==null?void 0:g.getAttribute("datetime"),a=((w=r.querySelector(".version-changelog"))==null?void 0:w.innerHTML)||"",l=d.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(s,n.t("yyyy年MM月dd日 HH:mm:ss"))}),u=d.createElement("div",{className:"script-tag",innerHTML:`
                    ...
                    </div>`}),h=d.createElement("div",{className:"script-note-box-body",innerHTML:a});r.appendChild(l),r.appendChild(u),r.appendChild(h);});}),e},addExtraTagButton(){c.info("添加额外的标签按钮"),d.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(e=>{var h,g;let t=e.querySelector("a");if(!t)return;let r=new URL(t.href),i=(h=r.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:h[1],o=r.searchParams.get("version"),s=(g=r.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:g[1],a=se.getInstallUrl(i,o,s),l=se.getCodeUrl(i,o),u=d.createElement("div",{className:"scripts-tag-install",innerHTML:`
...
`,ie={getTampermonkey:()=>{var e;return (e=I.external)==null?void 0:e.Tampermonkey},getViolentmonkey:()=>{var e;return (e=I.external)==null?void 0:e.Violentmonkey},getScriptCat:()=>{var e;return (e=I.external)==null?void 0:e.Scriptcat},getScriptContainerStatus(){var t,r,i;let e={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (t=I.external)!=null&&t.Tampermonkey&&(e.Tampermonkey=!0),(r=I.external)!=null&&r.Violentmonkey&&(e.Violentmonkey=!0),(i=I.external)!=null&&i.Scriptcat&&(e.ScriptCat=!0),e},getInstalledVersion(e,t){return new Promise((r,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}const s=this.getViolentmonkey();if(s){s.isInstalled(e,t).then(r);return}const a=this.getScriptCat();if(a){a.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const r=e.split("."),i=t.split(".");for(let o=0;o<r.length;o++){const s=this.compareVersionPart(r[o],i[o]);if(s!==0)return s}return 0},compareVersionPart(e,t){const r=this.parseVersionPart(e),i=this.parseVersionPart(t);for(let o=0;o<r.length;o++){if(r[o].length>0&&i[o].length===0)return -1;if(r[o].length===0&&i[o].length>0||r[o]>i[o])return 1;if(r[o]<i[o])return -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,r){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,r)){case-1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const r=e.getAttribute("data-script-name"),i=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let s=await this.getInstalledVersion(r,i);return s==null?!1:(this.handleInstallResult(e,s,o),!0)}catch{if(t){await m.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return !1}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),r=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:r,url:location.href},location.origin);}},ge=e=>{let t=e.dataset;const r={scriptId:parseInt(t.scriptId),scriptName:t.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(t.scriptDailyInstalls),scriptTotalInstalls:parseInt(t.scriptTotalInstalls),scriptRatingScore:parseFloat(t.scriptRatingScore),scriptCreatedDate:new Date(t.scriptCreatedDate),scriptUpdatedDate:new Date(t.scriptUpdatedDate),scriptType:t.scriptType,scriptVersion:t.scriptVersion,sensitive:t.sensitive==="true",scriptLanguage:t.scriptLanguage,cssAvailableAsJs:t.cssAvailableAsJs==="true",codeUrl:t.codeUrl,scriptDescription:t.scriptDescription,scriptAuthorId:parseInt(t.scriptAuthorId),scriptAuthorName:t.scriptAuthorName};let i=m.toJSON(t.scriptAuthors);if(Object.keys(i).forEach(o=>{let s=i[o];r.scriptAuthors.push({authorId:parseInt(o),authorName:s});}),(r.scriptAuthorName==null||isNaN(r.scriptAuthorId))&&r.scriptAuthors.length&&(r.scriptAuthorName=r.scriptAuthors[0].authorName,r.scriptAuthorId=r.scriptAuthors[0].authorId),r.scriptDescription==null){let o=e.querySelector(".script-description")||e.querySelector(".description");o&&(r.scriptDescription=o.innerText||o.textContent);}return r},ye={init(){p.execMenuOnce("gf-scripts-filter-enable",()=>{j.init();}),p.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){c.info("美化脚本列表");let e=[];return e.push(x(_e)),U.ready(async()=>{j.getElementList().forEach(s=>{if(s.querySelector(".script-list-operation"))return;let a=ge(s),l=s.querySelector(".inline-script-stats"),u=a.codeUrl,h=U.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${n.t("评分")}</span>`}),g=U.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${a.scriptRatingScore}</span>`},{"data-position":"right"}),w=s.querySelector("dd.script-list-ratings .good-rating-count"),L=s.querySelector("dd.script-list-ratings .ok-rating-count"),S=s.querySelector("dd.script-list-ratings .bad-rating-count");if(w&&L&&S){let T=parseInt(w.innerText),C=parseInt(L.innerText),B=parseInt(S.innerText),R=T+C+B;R>=10?T/R>=.6?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count"):R==0||T>C+B?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count");}let E=U.createElement("dt",{className:"script-list-version",innerHTML:`<span>${n.t("版本")}</span>`}),V=U.createElement("dd",{className:"script-list-version",innerHTML:`<span>${a.scriptVersion}</span>`},{"data-position":"right"}),_=U.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${n.t("操作")}</span>`}),k=U.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),M=k.querySelector(".script-collect-btn"),q=k.querySelector(".install-link");if(q["data-script-info"]=a,q.classList.add("lum-lightbox-loader"),a.scriptType==="library"&&q.remove(),U.on(M,"click",T=>{m.preventEvent(T),he(a.scriptId);}),p.getValue("gf-scripts-filter-enable")){let T=U.createElement("button",{className:"script-filter-btn",innerHTML:n.t("过滤")}),C="data-filter-key",B="data-filter-value";U.on(T,"click",R=>{m.preventEvent(R);let D=N.alert({title:{text:n.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${C}="scriptId" ${B}="^${a.scriptId}$">${n.t("脚本id：{{text}}",{text:a.scriptId})}</button>
									<button ${C}="scriptName" ${B}="^${m.parseStringToRegExpString(a.scriptName)}$">${n.t("脚本名：{{text}}",{text:a.scriptName})}</button>
...
`);if(e.has(i.snippet)&&p.getValue("greasyfork-discussions-filter-duplicate-comments")){let s=e.get(i.snippet).querySelector("a.discussion-title");s.setAttribute("data-repeat-tip-show","true");let a=0;s.hasAttribute("data-repeat-count")&&(a=parseInt(s.getAttribute("data-repeat-count"))),a++,s.setAttribute("data-repeat-count",a.toString()),s.setAttribute("data-repeat-tip-show",n.t("已过滤：{{oldCount}}",{oldCount:a})),c.success([`过滤重复内容：${i.snippet}`,i]),t.remove();return}e.set(i.snippet,t);for(let s=0;s<o.length;s++){let a=o[s],l=a.split("##"),u=l[0],h=l[1];if(u in i){let g=new RegExp(h,"ig");if(i[u]!=null&&String(i[u]).match(g)){c.info(["触发论坛过滤规则",a,i]),t.remove();return}}}});},parseDiscuessionListContainerInfo(e){var r,i,o;const t={scriptName:e.querySelector(".discussion-meta-item-script-name").innerText,scriptUrl:(r=e.querySelector(".discussion-meta-item-script-name a"))==null?void 0:r.href,scriptId:y.getScriptId((i=e.querySelector(".discussion-meta-item-script-name a"))==null?void 0:i.href),postUserName:e.querySelector("a.user-link").innerText,postUserHomeUrl:e.querySelector("a.user-link").href,postUserId:y.getUserId(e.querySelector("a.user-link").href),postTimeStamp:new Date(e.querySelector("relative-time").getAttribute("datetime")),snippetUrl:e.querySelector("a.discussion-title").href,snippet:e.querySelector("span.discussion-snippet").innerText,replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};return e.querySelector(".discussion-meta-item .discussion-meta-item")&&(t.replyUserName=e.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").innerText,t.replyUserHomeUrl=e.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").href,t.replyUserId=y.getUserId(t.replyUserHomeUrl),t.replyTimeStamp=new Date((o=e.querySelector(".discussion-meta-item .discussion-meta-item relative-time"))==null?void 0:o.getAttribute("datetime"))),t},transformOldRule(){if(Date.now()>new Date("2024-8-19").getTime())return;const e="greasyfork-discussions-filter-script",t="greasyfork-discussions-filter-post-user",r="greasyfork-discussions-filter-reply-user",i=p.getValue(e,""),o=p.getValue(t,""),s=p.getValue(r,""),a=i.trim()===""?[]:i.split(`
`),l=o.trim()===""?[]:o.split(`
`),u=s.trim()===""?[]:s.split(`
`);a.forEach(h=>{this.addValue("scriptId",m.parseStringToRegExpString("^"+h+"$"));}),l.forEach(h=>{this.addValue("postUserId",m.parseStringToRegExpString("^"+h+"$"));}),u.forEach(h=>{this.addValue("replyUserId",m.parseStringToRegExpString("^"+h+"$"));}),p.deleteValue(e),p.deleteValue(t),p.deleteValue(r);},setValue(e){p.setValue(this.key,e);},addValue(e,t){let r=this.getValue();if(r.trim()!==""&&(r+=`
...
`,Ge={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){c.info("美化页面元素");let e=[];return e.push(x(ze)),e.push(x(Be)),e.push(x(qe)),e.push(x(Re)),e.push(x(`
        ...
        `);},addShortcutOperationButton(){c.info("添加快捷操作按钮"),O.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=d.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),d.on(o,"click",s=>{var w,L,S;m.preventEvent(s);const a=O.parseDiscuessionListContainerInfo(e);let l="data-filter-key",u="data-filter-value",h=N.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
								<button ${l}="scriptId" ${u}="^${a.scriptId}$">${n.t("脚本id：{{text}}",{text:a.scriptId})}</button>
								<button ${l}="scriptName" ${u}="^${m.parseStringToRegExpString(a.scriptName)}$">${n.t("脚本名：{{text}}",{text:a.scriptName})}</button>
								<button ${l}="postUserId" ${u}="^${m.parseStringToRegExpString(a.postUserId)}$">${n.t("发布的用户id：{{text}}",{text:a.postUserId})}</button>

...
`)}{display: none !important;}`)},setGMResourceCSS(e){{let t=typeof pe=="function"?pe(e.keyName):"";typeof t=="string"&&t?oe(t):ae.loadStyleLink(e.url);}},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,p.ready(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(r=>{t.onload=()=>{r(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;let t=new URL(e);return t.protocol="https:",t.toString()}};Pe();V(F,{});const Ge=n.t("GreasyFork优化"),m=re.noConflict(),p=I.noConflict(),$=ke,u=new m.Log(le,U.console||qe.console);var Se;const ye=((Se=le==null?void 0:le.script)==null?void 0:Se.name)||Ge,Ee=!1;u.config({debug:Ee,logMaxCount:1e3,autoClearConsole:!0,tag:!0});g.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return f.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return f.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return f.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let e=re.getMaxZIndex(),t=ke.config.InstanceUtils.getPopsMaxZIndex().zIndex;return re.getMaxValue(e,t)+100}}}));const Te=new m.GM_Menu({GM_getValue:V,GM_setValue:z,GM_registerMenuCommand:Ne,GM_unregisterMenuCommand:Be}),R=new m.Httpx(Ve);R.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning(n.t("请求取消")):e.type==="onerror"?g.error(n.t("请求异常")):e.type==="ontimeout"?g.error(n.t("请求超时")):g.error(n.t("其它错误")),e));R.config({logDetails:Ee});U.Object.defineProperty,U.Function.prototype.apply,U.Function.prototype.call,U.Element.prototype.appendChild,U.setTimeout;const oe=m.addStyle.bind(m);document.querySelector.bind(document);document.querySelectorAll.bind(document);const Q=function(e,t,r,i,o,s,a,l,c){return {text:e,type:"button",description:t,buttonIcon:i,buttonIsRightIcon:o,buttonIconIsLoading:s,buttonType:a,buttonText:r,callback(h){typeof l=="function"&&l(h);},afterAddToUListCallBack:c}},be=function(e,t,r,i,o,s="",a,l){let c={text:e,type:"input",isNumber:!!a,isPassword:!!l,props:{},attributes:{},description:i,getValue(){return this.props[j].get(t,r)},callback(d,h){this.props[j].set(t,h);},placeholder:s};return Reflect.set(c.attributes,ne,t),Reflect.set(c.attributes,ie,r),Reflect.set(c.props,j,{get(d,h){return f.getValue(d,h)},set(d,h){f.setValue(d,h);}}),c},w=function(e,t,r,i,o,s){let a={text:e,type:"switch",description:o,attributes:{},props:{},getValue(){return !!this.props[j].get(t,r)},callback(l,c){let d=!!c;u.success(`${d?"开启":"关闭"} ${e}`),this.props[j].set(t,d);},afterAddToUListCallBack:s};return Reflect.set(a.attributes,ne,t),Reflect.set(a.attributes,ie,r),Reflect.set(a.props,j,{get(l,c){return f.getValue(l,c)},set(l,c){f.setValue(l,c);}}),a},N={async getScriptStats(e){let t=await R.get(`/scripts/${e}/stats.json`,{fetch:!0,allowInterceptConfig:!1});if(u.info(t),!t.status){u.error(n.t("获取脚本统计数据失败"));return}return m.toJSON(t.data.responseText)},async getSourceCodeSyncFormData(e){let t=await R.get(`/scripts/${e}/admin`,{fetch:!0,allowInterceptConfig:!1});if(u.info(t),!t.status){g.error(n.t("请求admin内容失败"));return}let r=t.data.responseText,o=p.parseHTML(r,!1,!0).querySelector("form.edit_script");if(!o){g.error(n.t("解析admin的源代码同步表单失败"));return}return new FormData(o)},async sourceCodeSync(e,t){let r=await R.post(`/scripts/${e}/sync_update`,{fetch:!0,data:t,allowInterceptConfig:!1});if(u.info(r),!r.status){g.error(n.t("源代码同步失败"));return}return r},async getUserInfo(e){let t=await R.get(`/users/${e}.json`,{fetch:!0,allowInterceptConfig:!1});if(u.success(t),!t.status){g.error(n.t("获取用户信息失败"));return}let r=m.toJSON(t.data.responseText);return r.scriptList=[],r.scriptLibraryList=[],r.scripts.forEach(i=>{i.code_url.endsWith(".user.js")?r.scriptList.push(i):r.scriptLibraryList.push(i);}),r},async getUserCollection(e){let t=await R.get(`/users/${e}`,{fetch:!0,allowInterceptConfig:!1});if(u.info("获取用户的收藏集",t),!t.status){g.error(n.t("获取用户的收藏集失败"));return}let r=t.data.responseText,o=p.parseHTML(r,!0,!0).querySelector("#user-script-sets");if(!o){u.error("解析Script Sets失败");return}let s=[];return o.querySelectorAll("li").forEach(a=>{var y;let l=a.querySelector("a:last-child");if(!l)return;let c=l.href;if(c.includes("?fav=1"))return;let d=a.querySelector("a").innerText,h=(y=c.match(/\/sets\/([\d]+)\//))==null?void 0:y[1];s.push({id:h,name:d});}),s},async getUserCollectionInfo(e,t){let r=await R.get(`/users/${e}/sets/${t}/edit`,{fetch:!0,allowInterceptConfig:!1});if(u.info(r),!r.status){g.error(n.t("获取收藏集{{setsId}}失败",{setsId:t}));return}let i=r.data.responseText,o=p.parseHTML(i,!0,!0),s=o.querySelector('form[id^="edit_script_set"]');if(!s){g.error(n.t("获取表单元素#edit_script_set失败"));return}let a=new FormData(s),l=o.querySelector('meta[name="csrf-token"]');if(!l){g.error(n.t("获取表单csrfToken失败"));return}if(l.hasAttribute("content")){let c=l.getAttribute("content");c&&a.set("authenticity_token",c);}return a},async updateUserSetsInfo(e,t,r){let i=await R.post(`/users/${e}/sets/${t}`,{fetch:!0,allowInterceptConfig:!1,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"no-cache","Content-Type":"application/x-www-form-urlencoded",Pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:r});if(u.info(i),!i.status){g.error(n.t("更新收藏集表单请求失败"));return}let o=i.data.responseText;return p.parseHTML(o,!0,!0)},async switchLanguage(e){let t=await R.get(e,{fetch:!0,headers:{"Upgrade-Insecure-Requests":"1"}});u.info(t),t.status;}},Fe=globalThis.location.href,Le=new URL(Fe),q=Le.pathname,He=Le.searchParams,T={isCode(){var e;return !!((e=q.split("/"))!=null&&e.includes("code"))},isCodeStrict(){return !!q.match(/\/code(\/|)$/)},isVersion(){return !!q.match(/\/versions(\/|)$/)},isUsers(){return !!q.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!q.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!q.match(/\/conversations\/[\d]+/)},isScript(){return !!q.match(/\/scripts\/[\d+]/)},isScriptList(){return !!q.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!q.match("/scripts/by-site")},isScriptLibraryList(){return !!q.match(/\/libraries(\/|)$/)},isScriptSearch(){return this.isScriptList()&&He.has("q")},isScriptCodeSearch(){return !!q.match(/\/code-search(\/|)$/)},isDiscuessions(){return !!q.match(/\/discussions(\/|)$/)}},v={getInstallUrl(e,t,r){return m.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${e}/${t}${r}.user.js`},getCodeUrl(e,t){return m.isNull(t)&&(t=""),`https://greasyfork.org/scripts/${e}/code?version=${t}`},getCodeSearchUrl(e){return "https://greasyfork.org/zh-CN/scripts/code-search?c="+e},getScriptInfoUrl(e){return `https://greasyfork.org/scripts/${e}.json`},getAdminUrl(e){return e+"/admin"},getScriptId(e){var t,r;return (r=(t=e||window.location.pathname)==null?void 0:t.match(/\/scripts\/([\d]+)/i))==null?void 0:r[1]},getUserId(e){var t;return (t=(e||window.location.pathname).match(/\/users\/([\d]+)/i))==null?void 0:t[1]},getReportUrl(e,t){return `${window.location.origin}/reports/new?item_class=${e}&item_id=${t}`},getScriptName(e){let t=window.location.pathname;e!=null&&(t=new URL(e).pathname),t=decodeURIComponent(t);let r=t.split("/");for(const i of r){let o=i.match(/[\d]+/);if(o&&o.length)return o[1]}},getSwitchLanguageUrl(e="zh-CN"){let t=window.location.origin,r=window.location.pathname.split("/");return r[1]=e,t=t+r.join("/"),t+=window.location.search,window.location.search===""?t+="?locale_override=1":window.location.search.includes("locale_override=1")||(t+="&locale_override=1"),t}},C={menu:Te,isLogin:!1,initEnv(){let e=this.getUserLinkElement();this.isLogin=!!e;},getUserLinkElement(){return document.querySelector("#nav-user-info span.user-profile-link a")},async updateScript(e){let t=function(r,i=1){return `
			...
			</div>`};if(m.isNull(e))g.error(n.t("未获取到【脚本列表】"));else {let r=g.loading(t(v.getScriptName(e[0])),{html:!0}),i=0,o=0;for(let s=0;s<e.length;s++){let a=e[s],l=v.getScriptId(a);u.success("更新："+a);let c=v.getScriptName(a);r.setHTML(t(c,s+1));let d=await N.getSourceCodeSyncFormData(l);d?await N.sourceCodeSync(l,d)?(g.success(n.t("源代码同步成功，3秒后更新下一个")),await m.sleep(3e3),i++):(g.error(n.t("源代码同步失败")),o++):(g.error(n.t("源代码同步失败")),o++);}r.close(),i===0?g.error(n.t("全部更新失败")):g.success(n.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:i,failedNums:o,scriptUrlListLength:e.length}),{html:!0});}},handleLocalGotoCallBack(){if(f.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(f.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!T.isUsers()){f.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),C.getUserLinkElement()?(g.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):g.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(t=>{e=e.concat(v.getAdminUrl(t.href));}),C.updateScript(e);}else if(f.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(f.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!T.isUsers()){f.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),C.getUserLinkElement()?(g.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):g.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(t=>{e=e.concat(v.getAdminUrl(t.href));}),C.updateScript(e);}else if(f.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(f.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!T.isUsers()){f.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),C.getUserLinkElement()?(g.success(n.t("前往用户主页")),window.location.href=C.getUserLinkElement().href):g.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(t=>{e=e.concat(v.getAdminUrl(t.href));}),C.updateScript(e);}}},Z=function(e,t,r,i,o,s){let a=[];typeof i=="function"?a=i():a=i;let l={text:e,type:"select",description:s,attributes:{},props:{},getValue(){return this.props[j].get(t,r)},callback(c,d,h){let y=d;u.info(`选择：${h}`),this.props[j].set(t,y),typeof o=="function"&&o(c,y,h);},data:a};return Reflect.set(l.attributes,ne,t),Reflect.set(l.attributes,ie,r),Reflect.set(l.props,j,{get(c,d){return f.getValue(c,d)},set(c,d){f.setValue(c,d);}}),l},je=function(e,t,r,i,o,s="default",a){let l=typeof o=="function"?o():o;typeof i=="object"&&a.initConfig(r,i);let c=()=>a.getShowText(r,l),d=Q(e,t,c,"keyboard",!1,!1,s,async h=>{var x;let b=(x=h.target.closest(".pops-panel-button"))==null?void 0:x.querySelector("span");if(a.isWaitPress){g.warning("请先执行当前的录入操作");return}if(a.hasOptionValue(r))a.emptyOption(r),g.success("清空快捷键");else {let S=g.loading("请按下快捷键...",{showClose:!0}),{status:E,option:M,key:L}=await a.enterShortcutKeys(r);S.close(),E?(u.success(["成功录入快捷键",M]),g.success("成功录入")):g.error(`快捷键 ${a.translateKeyboardValueToButtonText(M)} 已被 ${L} 占用`);}b.innerHTML=c();});return d.attributes={},Reflect.set(d.attributes,Ce,()=>!1),d};class We{constructor(t){ue(this,"key","short-cut");ue(this,"isWaitPress",!1);typeof t=="string"&&(this.key=t);}initConfig(t,r){this.hasOption(t)||this.setOption(t,r);}getStorageKey(){return this.key}getLocalAllOptions(){return V(this.key,[])}hasOption(t){return !!this.getLocalAllOptions().find(o=>o.key===t)}hasOptionValue(t){if(this.hasOption(t)){let r=this.getOption(t);return (r==null?void 0:r.value)!=null}else return !1}getOption(t,r){return this.getLocalAllOptions().find(s=>s.key===t)??r}setOption(t,r){let i=this.getLocalAllOptions(),o=i.findIndex(s=>s.key===t);o==-1?i.push({key:t,value:r}):Reflect.set(i[o],"value",r),z(this.key,i);}emptyOption(t){let r=!1,i=this.getLocalAllOptions(),o=i.findIndex(s=>s.key===t);return o!==-1&&(i[o].value=null,r=!0),z(this.key,i),r}deleteOption(t){let r=!1,i=this.getLocalAllOptions(),o=i.findIndex(s=>s.key===t);return o!==-1&&(i.splice(o,1),r=!0),z(this.key,i),r}translateKeyboardValueToButtonText(t){let r="";return t.ohterCodeList.forEach(i=>{r+=m.stringTitleToUpperCase(i,!0)+" + ";}),r+=m.stringTitleToUpperCase(t.keyName),r}getShowText(t,r){if(this.hasOption(t)){let i=this.getOption(t);return i.value==null?r:this.translateKeyboardValueToButtonText(i.value)}else return r}async enterShortcutKeys(t){return new Promise(r=>{this.isWaitPress=!0;let i=p.listenKeyboard(window,"keyup",(o,s,a)=>{const l={keyName:o,keyValue:s,ohterCodeList:a},c=JSON.stringify(l),d=this.getLocalAllOptions();for(let h=0;h<d.length;h++){let y=d[h];if(y.key===t)continue;const b=JSON.stringify(y.value);let x=!1;if(y.value!=null&&c===b&&(x=!0),x){this.isWaitPress=!1,i.removeListen(),r({status:!1,key:y.key,option:l});return}}this.setOption(t,l),this.isWaitPress=!1,i.removeListen(),r({status:!0,key:t,option:l});});})}initGlobalKeyboardListener(t){let r=this.getLocalAllOptions();if(!r.length){u.warn("没有设置快捷键");return}let i=this;function o(l,c){p.listenKeyboard(l,"keydown",(d,h,y)=>{if(i.isWaitPress)return;r=i.getLocalAllOptions();let b=r.findIndex(x=>{let S=x.value,E={keyName:d,keyValue:h,ohterCodeList:y};if(JSON.stringify(S)===JSON.stringify(E))return x});if(b!=-1){let x=r[b];u.info(["调用快捷键",x]),x.key in c&&c[x.key].callback();}});}let s={},a={};Object.keys(t).forEach(l=>{let c=t[l];(c.target==null||typeof c.target=="string"&&c.target==="")&&(c.target="window"),c.target==="window"?Reflect.set(s,l,c):Reflect.set(a,l,c);}),o(window,s),p.ready(()=>{Object.keys(a).forEach(async l=>{let c=a[l];if(typeof c.target=="string")m.waitNode(c.target,1e4).then(d=>{if(!d)return;let h={};Reflect.set(h,l,c),o(d,h);});else if(typeof c.target=="function"){let d=await c.target();if(d==null)return;let h={};Reflect.set(h,l,c),o(d,h);}else {let d={};Reflect.set(d,l,c),o(c.target,d);}});});}}const Ie={shortCut:new We,shortOption:{"gf-quickReply":{target:()=>{let e=document.querySelector("form textarea"),t=document.querySelector('input[name="commit"][type="submit"]');if(e){if(!t){u.error("页面不存在【发表回复】按钮");return}}else {u.error("页面不存在输入框");return}return u.success("监听快捷键：gf-quickReply"),e},callback(){if(document.activeElement){let e=document.activeElement.closest("form");if(!e){u.error("当前activeElement不在表单内，无法触发快捷键");return}let t=e.querySelectorAll('input[name="commit"][type="submit"]');if(!t.length){u.error("表单内不存在【发表回复】按钮");return}t.length>1&&u.warn("表单内存在多个【发表回复】按钮，只触发第一个"),t[0].click();}else u.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},fe={$key:{DB_KEY:"data"},$data:{db:null},init(){this.$data.db=this.getDB(),f.execMenuOnce("rememberReplyContent",()=>{this.rememberReplyContent();}),f.execMenu("gf-autoClearRememberReplayContent",e=>{this.autoClearRememberReplayContent(e);});},getDB(){const e="reply_record",t="textarea_text";return new m.indexedDB(e,t,2)},async rememberReplyContent(){const e="记住回复内容 -- ";let t=document.querySelectorAll("form");if(!t.length){u.warn(e+"不存在表单");return}try{await this.clearRelayHistoryRememberContentText();}catch(r){u.error(r);}t.forEach(async r=>{let i=r.querySelector("textarea"),o=r.querySelector('input[type="submit"]');i&&o&&(u.success(["开始监听form --- 记住回复内容",r]),this.$data.db.get(this.$key.DB_KEY).then(s=>{if(!s.success)return;let a=s.data.findIndex(c=>this.checkUrlIsSame(window.location.href,c.url));if(a==-1)return;let l=s.data[a].text;u.success("填入历史输入内容："+l),i.value=l;}),p.on(i,["propertychange","input"],m.debounce(s=>{let a={url:window.location.href,text:i.value,time:Date.now()};this.$data.db.get(this.$key.DB_KEY).then(l=>{if(!l.success&&l.event&&l.event.type!=="success"){u.warn(l);return}l.data==null&&(l.data=[]);let c=l.data.findIndex(d=>this.checkUrlIsSame(window.location.href,d.url));c!==-1?m.isNull(a.text)?l.data.splice(c,1):l.data[c]=m.assign(l.data[c],a):l.data=l.data.concat(a),this.$data.db.save(this.$key.DB_KEY,l.data).then(d=>{d.success||u.error(["保存失败",d]);});});},25)),p.on(r,"submit",s=>{u.info("表单提交，刷新页面后清理内容："+window.location.href),z("delyClear_rememberReplyContent_url",window.location.href);},{capture:!0}));});},async clearRelayHistoryRememberContentText(){const e="delyClear_rememberReplyContent_url";let t=V(e);if(t){let r=await this.$data.db.get(this.$key.DB_KEY);if(!r.success){u.info("表单记录：数据库是空的");return}let i=r.data.findIndex(s=>this.checkUrlIsSame(t,s.url));if(i==-1){u.info("表单记录：已不存在该数据"),ge(e);return}r.data.splice(i,1),(await this.$data.db.save(this.$key.DB_KEY,r.data)).success?(u.success("表单记录：成功清除"),ge(e)):u.error(["表单记录：清除失败",r]);}},checkUrlIsSame(e,t){let r=new URL(e),i=new URL(t);return r.origin===i.origin&&r.pathname===i.pathname},autoClearRememberReplayContent(e){const t="gf-last-time-autoClearRememberReplayContent";let r=V(t),i=e*24*60*60*1e3;if(r)if(Date.now()-r>i)z(t,Date.now());else return;z(t,Date.now());},async getAllRememberReplyContent(){return (await this.$data.db.get(this.$key.DB_KEY)).data??[]},async clearAllRememberReplyContent(){return (await this.$data.db.delete(this.$key.DB_KEY)).success}},xe={async UIScriptList(e,t){var c,d,h;if(!C.isLogin){g.error(n.t("请先登录账号！"));return}let i=C.getUserLinkElement().href,o=(h=(d=(c=i==null?void 0:i.split("/"))==null?void 0:c.pop())==null?void 0:d.match(/([0-9]+)/))==null?void 0:h[0],s=$.loading({mask:{enable:!0},parent:t,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),a=await N.getUserInfo(o);if(s.close(),!a)return;u.info(a);let l=e==="script-list"?a.scriptList:a.scriptLibraryList;g.success(n.t("获取成功，共 {{count}} 个",{count:l.length}));for(const y of l){let b=p.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),x=b.querySelector(".w-script-info"),S=p.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});y.deleted&&(b.classList.add("w-script-deleted"),S.querySelector("button").setAttribute("disabled","true")),p.on(S,"click",void 0,async function(){u.success(["同步",y]);let E=S.querySelector("button"),M=S.querySelector("button span"),L=p.createElement("i",{className:"pops-bottom-icon",innerHTML:$.config.iconSVG.loading},{"is-loading":!0});E.setAttribute("disabled","true"),E.setAttribute("data-icon","true"),M.innerText=n.t("同步中..."),p.before(M,L);let A=y==null?void 0:y.id,P=await N.getSourceCodeSyncFormData(A.toString());if(P){const _="script[script_sync_type_id]";if(P.has(_)){let B=P.get(_),G="";B.toString()==="1"?G=n.t("手动"):B.toString()==="2"?G=n.t("自动"):B.toString()==="3"&&(G="webhook");let O=b.querySelector(".w-script-sync-type");O?O.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:G}):p.append(x,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:G})}
									</p>
								</div>`),await N.sourceCodeSync(y.id.toString(),P)?g.success(n.t("同步成功")):g.error(n.t("同步失败"));}else g.error(n.t("该脚本未设置同步信息"));}E.removeAttribute("disabled"),E.removeAttribute("data-icon"),M.innerText=n.t("同步代码"),L.remove();}),b.appendChild(S),t.appendChild(b);}}},Ke={init(){f.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();});},repairCodeLineNumber(){u.info("修复代码的行号显示不够问题"),f.execMenuOnce("beautifyGreasyforkBeautify",()=>{k(`
...
`,Je={init(){f.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),f.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(k(Ye)),e.push(ae.addBlockCSS(".version-number",".version-date",".version-changelog")),p.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){g.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var h,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,s=(h=r.querySelector(".version-date"))==null?void 0:h.getAttribute("datetime"),a=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=p.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(s,n.t("yyyy年MM月dd日 HH:mm:ss"))}),c=p.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),d=p.createElement("div",{className:"script-note-box-body",innerHTML:a});r.appendChild(l),r.appendChild(c),r.appendChild(d);});}),e},addExtraTagButton(){u.info("添加额外的标签按钮"),p.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(e=>{var d,h;let t=e.querySelector("a");if(!t)return;let r=new URL(t.href),i=(d=r.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:d[1],o=r.searchParams.get("version"),s=(h=r.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:h[1],a=v.getInstallUrl(i,o,s),l=v.getCodeUrl(i,o),c=p.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});p.after(e,c);});});}},ce={setting:{width:window.innerWidth<550?"88vw":"550px",height:window.innerHeight<450?"70vh":"450px"},settingBig:{width:window.innerWidth<800?"92vw":"800px",height:window.innerHeight<600?"80vh":"600px"},info:{width:("350px"),height:("250px")}};let se=[];const $e=async function(e){if(u.info("当前脚本id："+e),!C.isLogin){u.error("请先登录账号"),g.error(n.t("请先登录账号"));return}let t=v.getUserId(C.getUserLinkElement().href);if(t==null){u.error("获取用户id失败"),g.error(n.t("获取用户id失败"));return}if(!se.length){let o=g.loading(n.t("获取收藏夹中..."));if(se=await N.getUserCollection(t)||[],o.close(),!se.length)return}let r="";se.forEach(o=>{r+=`
		<li class="user-collect-item" data-id="${o.id}" data-name="${o.name}">
		  ...
		  `;});let i=$.alert({title:{text:n.t("收藏集"),position:"center"},content:{html:!0,text:`<ul>${r}</ul>`},mask:{enable:!0,clickEvent:{toClose:!0}},btn:{ok:{enable:!1}},width:$.isPhone()?"92vw":"500px",height:"auto",drag:!0,only:!0,style:`
		.pops{
		...
		`});p.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let s=o.target.closest(".user-collect-item"),a=s.dataset.id;s.dataset.name;let l=g.loading(n.t("添加中...")),c=await N.getUserCollectionInfo(t,a);if(!c){l.close();return}let d=m.cloneFormData(c),h=m.cloneFormData(c),y=!1;for(const[_,B]of c.entries())if(_==="scripts-included[]"&&String(B).trim()===String(e).trim()){y=!0;break}else h.append(_,B),d.append(_,B);if(y){g.warning(n.t("该脚本已经在该收藏集中")),l.close();return}d.set("add-script",e.toString()),d.set("script-action","i"),h.append("scripts-included[]",e.toString()),h.set("save","1");let b=new URLSearchParams(d),x=new URLSearchParams(h),S=Array.from(b).map(([_,B])=>`${encodeURIComponent(_)}=${encodeURIComponent(B)}`).join("&"),E=Array.from(x).map(([_,B])=>`${encodeURIComponent(_)}=${encodeURIComponent(B)}`).join("&");u.info(["添加的数据",S]),u.info(["保存的数据",E]);let M=await N.updateUserSetsInfo(t,a,S);if(!M){l.close();return}let L=M.querySelector(".change-script-set");if(!L){g.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let A=L.querySelector("section");if(!A){g.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let P=A.querySelector(".alert");P?$.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:P.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					.pops-alert-content{
						font-style: italic;
					...
					`,drag:!0,dragLimit:!0,width:ce.info.width,height:ce.info.height}):(await N.updateUserSetsInfo(t,a,E),g.success(n.t("添加成功"))),l.close();}),p.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let s=o.target.closest(".user-collect-item"),a=s.dataset.id;s.dataset.name;let l=g.loading(n.t("删除中...")),c=await N.getUserCollectionInfo(t,a);if(!c){l.close();return}let d=new FormData,h=new FormData,y=!1;for(const[L,A]of c.entries()){if(String(L).trim()==="scripts-included[]"&&String(A).trim()===String(e).trim()){y=!0;continue}h.append(L,A),d.append(L,A);}if(!y){g.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:e})),l.close();return}d.set("remove-scripts-included[]",e.toString()),d.set("remove-selected-scripts","i"),d.delete("script-action"),h.set("save","1");let b=new URLSearchParams(d),x=new URLSearchParams(h),S=Array.from(b).map(([L,A])=>`${encodeURIComponent(L)}=${encodeURIComponent(A)}`).join("&"),E=Array.from(x).map(([L,A])=>`${encodeURIComponent(L)}=${encodeURIComponent(A)}`).join("&");if(u.info(["删除的数据",S]),u.info(["保存的数据",E]),!await N.updateUserSetsInfo(t,a,S)){l.close();return}await N.updateUserSetsInfo(t,a,E),g.success(n.t("删除成功")),l.close();});},Ze={init(){T.isCode()?Ke.init():T.isVersion()&&Je.init(),T.isCodeStrict()&&(f.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),f.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),f.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),f.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),f.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){u.info("添加收藏按钮"),m.waitNode("ul#script-links li.current span").then(()=>{let e=p.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});p.append(document.querySelector("ul#script-links"),e),p.on(e,"click",()=>{let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){u.error([t,window.location.pathname]),g.error(n.t("获取脚本id失败"));return}let r=t[t.length-1];$e(r);});});},fullScreenOptimization(){u.info("F11全屏，F键代码全屏"),k(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
...
`,we={getTampermonkey:()=>{var e;return (e=U.external)==null?void 0:e.Tampermonkey},getViolentmonkey:()=>{var e;return (e=U.external)==null?void 0:e.Violentmonkey},getScriptCat:()=>{var e;return (e=U.external)==null?void 0:e.Scriptcat},getScriptContainerStatus(){var t,r,i;let e={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (t=U.external)!=null&&t.Tampermonkey&&(e.Tampermonkey=!0),(r=U.external)!=null&&r.Violentmonkey&&(e.Violentmonkey=!0),(i=U.external)!=null&&i.Scriptcat&&(e.ScriptCat=!0),e},getInstalledVersion(e,t){return new Promise((r,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}const s=this.getViolentmonkey();if(s){s.isInstalled(e,t).then(r);return}const a=this.getScriptCat();if(a){a.isInstalled(e,t,function(l){l.installed?r(l.version):r(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const r=e.split("."),i=t.split(".");for(let o=0;o<r.length;o++){const s=this.compareVersionPart(r[o],i[o]);if(s!==0)return s}return 0},compareVersionPart(e,t){const r=this.parseVersionPart(e),i=this.parseVersionPart(t);for(let o=0;o<r.length;o++){if(r[o].length>0&&i[o].length===0)return -1;if(r[o].length===0&&i[o].length>0||r[o]>i[o])return 1;if(r[o]<i[o])return -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,r){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,r)){case-1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const r=e.getAttribute("data-script-name"),i=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let s=await this.getInstalledVersion(r,i);return s==null?!1:(this.handleInstallResult(e,s,o),!0)}catch{if(t){await m.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return !1}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),r=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:r,url:location.href},location.origin);}},he=e=>{let t=e.dataset;const r={scriptId:parseInt(t.scriptId),scriptName:t.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(t.scriptDailyInstalls),scriptTotalInstalls:parseInt(t.scriptTotalInstalls),scriptRatingScore:parseFloat(t.scriptRatingScore),scriptCreatedDate:new Date(t.scriptCreatedDate),scriptUpdatedDate:new Date(t.scriptUpdatedDate),scriptType:t.scriptType,scriptVersion:t.scriptVersion,sensitive:t.sensitive==="true",scriptLanguage:t.scriptLanguage,cssAvailableAsJs:t.cssAvailableAsJs==="true",codeUrl:t.codeUrl,scriptDescription:t.scriptDescription,scriptAuthorId:parseInt(t.scriptAuthorId),scriptAuthorName:t.scriptAuthorName};let i=m.toJSON(t.scriptAuthors);if(Object.keys(i).forEach(o=>{let s=i[o];r.scriptAuthors.push({authorId:parseInt(o),authorName:s});}),(r.scriptAuthorName==null||isNaN(r.scriptAuthorId))&&r.scriptAuthors.length&&(r.scriptAuthorName=r.scriptAuthors[0].authorName,r.scriptAuthorId=r.scriptAuthors[0].authorId),r.scriptDescription==null){let o=e.querySelector(".script-description")||e.querySelector(".description");o&&(r.scriptDescription=o.innerText||o.textContent);}return r},Me={init(){f.execMenuOnce("gf-scripts-filter-enable",()=>{K.init();}),f.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let e=[];e.push(oe(Qe));const t="lum-lightbox-loader",r=n.t("安装此脚本");return I.ready(async()=>{K.getElementList().forEach(c=>{if(c.querySelector(".script-list-operation"))return;let d=he(c),h=c.querySelector(".inline-script-stats");if(!h){u.error("美化脚本列表失败，未获取到.inline-script-stats");return}let y=d.codeUrl,b=I.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${n.t("评分")}</span>`}),x=I.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${d.scriptRatingScore}</span>`},{"data-position":"right"}),S=c.querySelector("dd.script-list-ratings .good-rating-count"),E=c.querySelector("dd.script-list-ratings .ok-rating-count"),M=c.querySelector("dd.script-list-ratings .bad-rating-count");if(S&&E&&M){let O=parseInt(S.innerText),D=parseInt(E.innerText),W=parseInt(M.innerText),ee=O+D+W;ee>=10?O/ee>=.6?x.classList.add("good-rating-count"):x.classList.add("bad-rating-count"):ee==0||O>D+W?x.classList.add("good-rating-count"):x.classList.add("bad-rating-count");}let L=I.createElement("dt",{className:"script-list-version",innerHTML:`<span>${n.t("版本")}</span>`}),A=I.createElement("dd",{className:"script-list-version",innerHTML:`<span>${d.scriptVersion}</span>`},{"data-position":"right"}),P=I.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${n.t("操作")}</span>`}),_=I.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),B=_.querySelector(".script-collect-btn"),G=_.querySelector(".install-link");if(G["data-script-info"]=d,I.addClass(G,t),d.scriptType==="library"&&G.remove(),I.on(B,"click",O=>{m.preventEvent(O),$e(d.scriptId);}),f.getValue("gf-scripts-filter-enable")){let O=I.createElement("button",{className:"script-filter-btn",innerHTML:n.t("过滤")}),D="data-filter-key",W="data-filter-value";I.on(O,"click",ee=>{m.preventEvent(ee);let de=$.alert({title:{text:n.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${D}="scriptId" ${W}="^${d.scriptId}$">${n.t("脚本id：{{text}}",{text:d.scriptId})}</button>
									<button ${D}="scriptName" ${W}="^${m.parseStringToRegExpString(d.scriptName)}$">${n.t("脚本名：{{text}}",{text:d.scriptName})}</button>
...
`),m.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return f.getValue(this.key,"")}},nt={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=p.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											`}),o=i.querySelector(".pops-color-choose");o.value=f.getValue(t);let s=p.createElement("style");return p.append(document.head,s),p.on(o,["input","propertychange"],a=>{u.info("选择颜色："+o.value),s.innerHTML=`
												.discussion-read{
										...
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=H.getValue(),p.on(r,["input","propertychange"],void 0,m.debounce(function(i){H.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},it=`.w-script-list-item {\r
	padding: 10px;\r
...
`).forEach(a=>{try{if(a=a.trim(),m.isNull(a))return;let c=new URL(a).pathname.split("/"),{1:d,2:h,3:y,4:b}=c,x="";if(c.length>=6&&y==="blob")x=c.slice(5,c.length).join("/");else if(c.length>=8&&y==="raw"&&b==="refs")b=c[6],x=c.slice(7,c.length).join("/");else return;if(x==="")return;s.push(`https://raw.githubusercontent.com/${d}/${h}/${b}/${x}`);}catch{}}),r.value=s.join(`
`);});}},st={id:"greasy-fork-panel-config-script-search",title:n.t("搜索"),forms:[{type:"forms",text:"",forms:[w(n.t("新增【{{buttonText}}】按钮",{buttonText:n.t("名称-全词匹配")}),"gf-script-search-filterScriptTitleWholeWordMatching",!0,void 0,n.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),w(n.t("新增【{{buttonText}}】按钮",{buttonText:n.t("描述-全词匹配")}),"gf-script-search-filterScriptDescWholeWordMatching",!0,void 0,n.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),w(n.t("新增【{{buttonText}}】按钮",{buttonText:n.t("作者名称-全词匹配")}),"gf-script-search-filterScriptAuthorNameWholeWordMatching",!0,void 0,n.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本"))]}]},f={$data:{__data:null,__oneSuccessExecMenu:null,__onceExec:null,__listenData:null,get data(){return f.$data.__data==null&&(f.$data.__data=new m.Dictionary),f.$data.__data},get oneSuccessExecMenu(){return f.$data.__oneSuccessExecMenu==null&&(f.$data.__oneSuccessExecMenu=new m.Dictionary),f.$data.__oneSuccessExecMenu},get onceExec(){return f.$data.__onceExec==null&&(f.$data.__onceExec=new m.Dictionary),f.$data.__onceExec},get scriptName(){return ye},key:F,attributeKeyName:ne,attributeDefaultValueName:ie},$listener:{get listenData(){return f.$data.__listenData==null&&(f.$data.__listenData=new m.Dictionary),f.$data.__listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},isTopWindow(){return U.top===U.self},initExtensionsMenu(){this.isTopWindow()&&Te.add([{key:"show_pops_panel_setting",text:n.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showPanel();}},{key:"githubUrl2webhookUrl",text:"⚙ "+n.t("Url To WebhookUrl"),autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{at.showView();}}]);},initPanelDefaultValue(){let e=this;function t(o){if(!o.attributes)return;let s={},a=o.attributes[ne];a!=null&&(s[a]=o.attributes[ie]);let l=o.attributes[Ce];if(typeof l=="function"){let h=l();if(typeof h=="boolean"&&!h)return}let c=o.attributes[De];c&&typeof c=="object"&&Object.assign(s,c);let d=Object.keys(s);if(!d.length){u.warn(["请先配置键",o]);return}d.forEach(h=>{let y=s[h];e.$data.data.has(h)&&u.warn("请检查该key(已存在): "+h),e.$data.data.set(h,y);});}function r(o){for(let s=0;s<o.length;s++){let a=o[s];t(a);let l=a.forms;l&&Array.isArray(l)&&r(l);}}let i=this.getPanelContentConfig();for(let o=0;o<i.length;o++){let s=i[o];if(!s.forms)continue;let a=s.forms;a&&Array.isArray(a)&&r(a);}},setValue(e,t){let r=V(F,{}),i=r[e];r[e]=t,z(F,r),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,i,t);},getValue(e,t){let i=V(F,{})[e];return i??(this.$data.data.has(e)?this.$data.data.get(e):t)},deleteValue(e){let t=V(F,{}),r=t[e];Reflect.deleteProperty(t,e),z(F,t),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,r,void 0);},addValueChangeListener(e,t,r){let i=Math.random();return this.$listener.listenData.set(e,{id:i,key:e,callback:t}),r&&r.immediate&&t(e,this.getValue(e),this.getValue(e)),i},removeValueChangeListener(e){let t=null;for(const[r,i]of this.$listener.listenData.entries())if(i.id===e){t=r;break}typeof t=="string"?this.$listener.listenData.delete(t):console.warn("没有找到对应的监听器");},triggerMenuValueChange(e,t,r){if(this.$listener.listenData.has(e)){let i=this.$listener.listenData.get(e);if(typeof i.callback=="function"){let o=this.getValue(e),s=o,a=o;typeof t<"u"&&arguments.length>1&&(s=t),typeof r<"u"&&arguments.length>2&&(a=r),i.callback(e,a,s);}}},hasKey(e){let t=V(F,{});return e in t},execMenu(e,t,r=!1){if(!(typeof e=="string"||typeof e=="object"&&Array.isArray(e)))throw new TypeError("key 必须是字符串或者字符串数组");let i=[];typeof e=="object"&&Array.isArray(e)?i=[...e]:i.push(e);let o;for(let s=0;s<i.length;s++){const a=i[s];if(!this.$data.data.has(a)){u.warn(`${e} 键不存在`);return}let l=f.getValue(a);if(r&&(l=!l),!l)break;o=l;}o&&t(o);},execMenuOnce(e,t,r,i){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){u.warn(`${e} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(e))return;this.$data.oneSuccessExecMenu.set(e,1);let o=()=>{let d=f.getValue(e);return typeof r=="function"?r(e,d):d},s=[],a=d=>{let h=o(),y=[];if(d instanceof HTMLStyleElement?y=[d]:Array.isArray(d)&&(y=[...d.filter(b=>b!=null&&b instanceof HTMLStyleElement)]),h)s=s.concat(y);else for(let b=0;b<y.length;b++)y[b].remove(),y.splice(b,1),b--;},l=d=>{let h=[];if(d){let y=t(d,a);y instanceof HTMLStyleElement?h=[y]:Array.isArray(y)&&(h=[...y.filter(b=>b!=null&&b instanceof HTMLStyleElement)]);}for(let y=0;y<s.length;y++)s[y].remove(),s.splice(y,1),y--;s=[...h];};this.addValueChangeListener(e,(d,h,y)=>{let b=y;typeof i=="function"&&(b=i(d,y,h)),l(b);});let c=o();c&&l(c);},execInheritMenuOnce(e,t,r,i){let o=this;const s=(a,l)=>{let c=o.getValue(a),d=o.getValue(l);if(typeof i=="function"){let h=i(c,d);if(h!==void 0)return h}return c};this.execMenuOnce(e,r,()=>s(e,t),()=>s(e,t)),this.execMenuOnce(t,()=>{},()=>!1,()=>(this.triggerMenuValueChange(e),!1));},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(e)||(t(),this.$data.onceExec.set(e,1));},showPanel(){$.panel({title:{text:n.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:ye}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},zIndex(){let e=re.getMaxZIndex(),t=$.config.InstanceUtils.getPopsMaxZIndex().zIndex;return re.getMaxValue(e,t)+100},width:ce.setting.width,height:ce.setting.height,drag:!0,only:!0,style:`
			${it}
...
`,gt={init(){f.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),f.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),f.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),f.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let e=[];return e.push(k(lt)),e.push(k(ct)),e.push(k(dt)),e.push(k(ut)),e.push(k(pt)),e.push(k(`
        ...
        `);},addShortcutOperationButton(){u.info("添加【过滤】按钮"),H.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=p.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`},{style:"flex: 0;"}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),p.on(o,"click",s=>{var y,b,x;m.preventEvent(s);const a=H.parseDiscuessionListContainerInfo(e);let l="data-filter-key",c="data-filter-value",d=$.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
						...
						`}),h=d.$shadowRoot.querySelector(".pops-alert-content");if(a.scriptId==null&&((y=h.querySelector(`button[${l}="scriptId"]`))==null||y.remove()),a.scriptName==null&&((b=h.querySelector(`button[${l}="scriptName"]`))==null||b.remove()),a.postUserId==null&&((x=h.querySelector(`button[${l}="postUserId"]`))==null||x.remove()),a.replyUserId!=null){let S=p.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:a.replyUserId})});S.setAttribute(l,"scriptAuthorId"),S.setAttribute(c,"^"+a.replyUserId+"$"),h.appendChild(S);}p.on(d.$shadowRoot,"click",`button[${l}]`,S=>{m.preventEvent(S);let E=S.target,M=E.getAttribute(l),L=E.getAttribute(c);H.addValue(M,L),d.close(),H.filter(),g.success(n.t("添加成功"));});});});},addReportButton(){u.info("添加【举报】按钮"),H.getElementList().forEach(e=>{if(e.querySelector(".discussion-report-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=p.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-report-button" style="border-color: #ff4d4d;background-color: #ffe6e6;color: red;">${n.t("举报")}</button>
					`},{style:"flex: 0;"}),o=i.querySelector(".discussion-report-button");r.appendChild(i),p.on(o,"click",s=>{m.preventEvent(s);const a=H.parseDiscuessionListContainerInfo(e);$.alert({title:{text:n.t("举报"),position:"center",html:!1},content:{text:`
						...
						${a.replyUserId&&a.replyUserId!=a.postUserId?`
							...
							`});});});}},xt={init(){f.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),f.execMenuOnce("gf-scripts-filter-enable",()=>{K.init();}),f.execMenuOnce("beautifyCenterContent",()=>Me.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),ae.addBlockCSS("#about-user"),p.ready(()=>{let e=document.querySelector("#about-user"),t=document.querySelector("#site-nav nav");if(!e){u.error("#about-user元素不存在");return}if(!t){u.error("#site-nav nav元素不存在");return}e=e.cloneNode(!0);let r=p.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});p.on(r,"click",i=>{m.preventEvent(i),$.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:m.getMaxZIndex(100),style:`
                    .text-content{
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,vt={init(){f.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),p.ready(()=>{f.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){u.info("美化对话框"),[].push(oe(wt));},beautifyPrivateMessageList(){u.info("美化私信列表"),oe(`
		...
		`),p.ready(()=>{let e=document.querySelector("#site-nav nav"),t=document.querySelector("#site-nav .with-submenu nav"),r=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!r){u.warn("不存在右侧面板元素#script-list-option-groups");return}if(r=r.cloneNode(!0),r.classList.add("option-panel-groups"),!e){u.error("元素#site-nav nav不存在");return}let i=p.createElement("li",{className:"filter-scripts",innerHTML:`
                ...
                `});p.on(i,"click",o=>{m.preventEvent(o),$.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:m.getMaxZIndex(100),style:`
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(r);}),t&&t.children.length?t.appendChild(i):e.appendChild(i);});}};f.init();X.init();

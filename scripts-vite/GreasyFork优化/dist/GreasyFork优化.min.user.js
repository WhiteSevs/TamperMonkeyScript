...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ce=="function"?ce(e.keyName):"";typeof t=="string"&&t?te(t):re.addLinkNode(e.url);},async addLinkNode(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,h.ready(()=>{document.head.appendChild(t);}),t},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e}},Oe={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(v(De)),e.push(re.addBlockCSS(".version-number",".version-date",".version-changelog")),h.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){g.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var f,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(f=r.querySelector(".version-date"))==null?void 0:f.getAttribute("datetime"),s=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=h.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),c=h.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),d=h.createElement("div",{className:"script-note-box-body",innerHTML:s});r.appendChild(l),r.appendChild(c),r.appendChild(d);});}),e},addExtraTagButton(){u.info("添加额外的标签按钮"),h.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(e=>{var d,f;let t=e.querySelector("a");if(!t)return;let r=new URL(t.href),i=(d=r.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:d[1],o=r.searchParams.get("version"),a=(f=r.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:f[1],s=E.getInstallUrl(i,o,a),l=E.getCodeUrl(i,o),c=h.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});h.after(e,c);});});}};let ne=[];const xe=async function(e){if(u.info("当前脚本id："+e),!C.isLogin){u.error("请先登录账号"),g.error(n.t("请先登录账号"));return}let t=E.getUserId(C.getUserLinkElement().href);if(t==null){u.error("获取用户id失败"),g.error(n.t("获取用户id失败"));return}if(!ne.length){let o=g.loading(n.t("获取收藏夹中..."));if(ne=await $.getUserCollection(t)||[],o.close(),!ne.length)return}let r="";ne.forEach(o=>{r+=`
		...
		`});h.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=g.loading(n.t("添加中...")),c=await $.getUserCollectionInfo(t,s);if(!c){l.close();return}let d=m.cloneFormData(c),f=m.cloneFormData(c),y=!1;for(const[T,L]of c.entries())if(T==="scripts-included[]"&&String(L).trim()===String(e).trim()){y=!0;break}else f.append(T,L),d.append(T,L);if(y){g.warning(n.t("该脚本已经在该收藏集中")),l.close();return}d.set("add-script",e.toString()),d.set("script-action","i"),f.append("scripts-included[]",e.toString()),f.set("save","1");let b=new URLSearchParams(d),x=new URLSearchParams(f),S=Array.from(b).map(([T,L])=>`${encodeURIComponent(T)}=${encodeURIComponent(L)}`).join("&"),_=Array.from(x).map(([T,L])=>`${encodeURIComponent(T)}=${encodeURIComponent(L)}`).join("&");u.info(["添加的数据",S]),u.info(["保存的数据",_]);let I=await $.updateUserSetsInfo(t,s,S);if(!I){l.close();return}let k=I.querySelector(".change-script-set");if(!k){g.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let A=k.querySelector("section");if(!A){g.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let D=A.querySelector(".alert");D?R.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:D.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					.pops-alert-content{
						font-style: italic;
					...
					`,drag:!0,dragLimit:!0,width:R.isPhone()?"88vw":"400px",height:R.isPhone()?"50vh":"300px"}):(await $.updateUserSetsInfo(t,s,_),g.success(n.t("添加成功"))),l.close();}),h.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=g.loading(n.t("删除中...")),c=await $.getUserCollectionInfo(t,s);if(!c){l.close();return}let d=new FormData,f=new FormData,y=!1;for(const[k,A]of c.entries()){if(String(k).trim()==="scripts-included[]"&&String(A).trim()===String(e).trim()){y=!0;continue}f.append(k,A),d.append(k,A);}if(!y){g.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:e})),l.close();return}d.set("remove-scripts-included[]",e.toString()),d.set("remove-selected-scripts","i"),d.delete("script-action"),f.set("save","1");let b=new URLSearchParams(d),x=new URLSearchParams(f),S=Array.from(b).map(([k,A])=>`${encodeURIComponent(k)}=${encodeURIComponent(A)}`).join("&"),_=Array.from(x).map(([k,A])=>`${encodeURIComponent(k)}=${encodeURIComponent(A)}`).join("&");if(u.info(["删除的数据",S]),u.info(["保存的数据",_]),!await $.updateUserSetsInfo(t,s,S)){l.close();return}await $.updateUserSetsInfo(t,s,_),g.success(n.t("删除成功")),l.close();});},Pe={init(){M.isCode()?qe.init():M.isVersion()&&Oe.init(),M.isCodeStrict()&&(p.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),p.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),p.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),p.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),p.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){u.info("添加收藏按钮"),m.waitNode("ul#script-links li.current span").then(()=>{let e=h.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});h.append(document.querySelector("ul#script-links"),e),h.on(e,"click",()=>{let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){u.error([t,window.location.pathname]),g.error(n.t("获取脚本id失败"));return}let r=t[t.length-1];xe(r);});});},fullScreenOptimization(){u.info("F11全屏，F键代码全屏"),v(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
...
`),m.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},He={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=h.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											...
											`}),o=i.querySelector(".pops-color-choose");o.value=p.getValue(t);let a=h.createElement("style");return h.append(document.head,a),h.on(o,["input","propertychange"],s=>{u.info("选择颜色："+o.value),a.innerHTML=`
												.discussion-read{
										...
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=H.getValue(),h.on(r,["input","propertychange"],void 0,m.debounce(function(i){H.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},Se={async UIScriptList(e,t,r,i){var f,y,b;if(!C.isLogin){g.error(n.t("请先登录账号！"));return}let a=C.getUserLinkElement().href,s=(b=(y=(f=a==null?void 0:a.split("/"))==null?void 0:f.pop())==null?void 0:y.match(/([0-9]+)/))==null?void 0:b[0],l=R.loading({mask:{enable:!0},parent:i,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),c=await $.getUserInfo(s);if(l.close(),!c)return;u.info(c);let d=e==="script-list"?c.scriptList:c.scriptLibraryList;g.success(n.t("获取成功，共 {{count}} 个",{count:d.length}));for(const x of d){let S=h.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),_=S.querySelector(".w-script-info"),I=h.createElement("div",{className:"pops-panel-button",innerHTML:`
				<button type="primary" data-icon="" data-righticon="false">
				<span>${n.t("同步代码")}</span>
				</button>
				`});x.deleted&&(S.classList.add("w-script-deleted"),I.querySelector("button").setAttribute("disabled","true")),h.on(I,"click",void 0,async function(){u.success(["同步",x]);let k=I.querySelector("button"),A=I.querySelector("button span"),D=h.createElement("i",{className:"pops-bottom-icon",innerHTML:R.config.iconSVG.loading},{"is-loading":!0});k.setAttribute("disabled","true"),k.setAttribute("data-icon","true"),A.innerText=n.t("同步中..."),h.before(A,D);let T=x==null?void 0:x.id,L=await $.getSourceCodeSyncFormData(T.toString());if(L){const V="script[script_sync_type_id]";if(L.has(V)){let O=L.get(V),P="";O.toString()==="1"?P=n.t("手动"):O.toString()==="2"?P=n.t("自动"):O.toString()==="3"&&(P="webhook");let Z=S.querySelector(".w-script-sync-type");Z?Z.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:P}):h.append(_,`
...
`,Je={id:"greasy-fork-panel-config-account",title:n.t("用户"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("迁移【控制台】到顶部导航栏"),"users-changeConsoleToTopNavigator",!0,void 0,n.t("将【控制台】按钮移动到顶部导航栏，节省空间"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化私信页面"),"conversations-beautifyDialogBox",!0,void 0,n.t("美化为左右对话模式")),w(n.t("美化私信列表"),"conversations-beautifyPrivateMessageList",!0)]}]}]}]},p={$data:{__data:null,__oneSuccessExecMenu:null,__onceExec:null,__listenData:null,get data(){return p.$data.__data==null&&(p.$data.__data=new m.Dictionary),p.$data.__data},get oneSuccessExecMenu(){return p.$data.__oneSuccessExecMenu==null&&(p.$data.__oneSuccessExecMenu=new m.Dictionary),p.$data.__oneSuccessExecMenu},get onceExec(){return p.$data.__onceExec==null&&(p.$data.__onceExec=new m.Dictionary),p.$data.__onceExec},get scriptName(){return ue},key:G,attributeKeyName:X,attributeDefaultValueName:ee},$listener:{get listenData(){return p.$data.__listenData==null&&(p.$data.__listenData=new m.Dictionary),p.$data.__listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},isTopWindow(){return U.top===U.self},initExtensionsMenu(){this.isTopWindow()&&ye.add([{key:"show_pops_panel_setting",text:n.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showPanel();}}]);},initPanelDefaultValue(){let e=this;function t(o){if(!o.attributes)return;let a={},s=o.attributes[X];s!=null&&(a[s]=o.attributes[ee]);let l=o.attributes[me];if(typeof l=="function"){let f=l();if(typeof f=="boolean"&&!f)return}let c=o.attributes[Ue];c&&typeof c=="object"&&Object.assign(a,c);let d=Object.keys(a);if(!d.length){u.warn(["请先配置键",o]);return}d.forEach(f=>{let y=a[f];e.$data.data.has(f)&&u.warn("请检查该key(已存在): "+f),e.$data.data.set(f,y);});}function r(o){for(let a=0;a<o.length;a++){let s=o[a];t(s);let l=s.forms;l&&Array.isArray(l)&&r(l);}}let i=this.getPanelContentConfig();for(let o=0;o<i.length;o++){let a=i[o];if(!a.forms)continue;let s=a.forms;s&&Array.isArray(s)&&r(s);}},setValue(e,t){let r=z(G,{}),i=r[e];r[e]=t,q(G,r),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,i,t);},getValue(e,t){let i=z(G,{})[e];return i??(this.$data.data.has(e)?this.$data.data.get(e):t)},deleteValue(e){let t=z(G,{}),r=t[e];Reflect.deleteProperty(t,e),q(G,t),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,r,void 0);},addValueChangeListener(e,t,r){let i=Math.random();return this.$listener.listenData.set(e,{id:i,key:e,callback:t}),r&&r.immediate&&t(e,this.getValue(e),this.getValue(e)),i},removeValueChangeListener(e){let t=null;for(const[r,i]of this.$listener.listenData.entries())if(i.id===e){t=r;break}typeof t=="string"?this.$listener.listenData.delete(t):console.warn("没有找到对应的监听器");},triggerMenuValueChange(e,t,r){if(this.$listener.listenData.has(e)){let i=this.$listener.listenData.get(e);if(typeof i.callback=="function"){let o=this.getValue(e),a=o,s=o;typeof t<"u"&&arguments.length>1&&(a=t),typeof r<"u"&&arguments.length>2&&(s=r),i.callback(e,s,a);}}},hasKey(e){let t=z(G,{});return e in t},execMenu(e,t,r=!1){if(!(typeof e=="string"||typeof e=="object"&&Array.isArray(e)))throw new TypeError("key 必须是字符串或者字符串数组");let i=[];typeof e=="object"&&Array.isArray(e)?i=[...e]:i.push(e);let o;for(let a=0;a<i.length;a++){const s=i[a];if(!this.$data.data.has(s)){u.warn(`${e} 键不存在`);return}let l=p.getValue(s);if(r&&(l=!l),!l)break;o=l;}o&&t(o);},execMenuOnce(e,t,r,i){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){u.warn(`${e} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(e))return;this.$data.oneSuccessExecMenu.set(e,1);let o=()=>{let d=p.getValue(e);return typeof r=="function"?r(e,d):d},a=[],s=d=>{let f=o(),y=[];if(d instanceof HTMLStyleElement?y=[d]:Array.isArray(d)&&(y=[...d.filter(b=>b!=null&&b instanceof HTMLStyleElement)]),f)a=a.concat(y);else for(let b=0;b<y.length;b++)y[b].remove(),y.splice(b,1),b--;},l=d=>{let f=[];if(d){let y=t(d,s);y instanceof HTMLStyleElement?f=[y]:Array.isArray(y)&&(f=[...y.filter(b=>b!=null&&b instanceof HTMLStyleElement)]);}for(let y=0;y<a.length;y++)a[y].remove(),a.splice(y,1),y--;a=[...f];};this.addValueChangeListener(e,(d,f,y)=>{let b=y;typeof i=="function"&&(b=i(d,y,f)),l(b);});let c=o();c&&l(c);},execInheritMenuOnce(e,t,r,i){let o=this;const a=(s,l)=>{let c=o.getValue(s),d=o.getValue(l);if(typeof i=="function"){let f=i(c,d);if(f!==void 0)return f}return c};this.execMenuOnce(e,r,()=>a(e,t),()=>a(e,t)),this.execMenuOnce(t,()=>{},()=>!1,()=>(this.triggerMenuValueChange(e),!1));},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(e)||(t(),this.$data.onceExec.set(e,1));},showPanel(){R.panel({title:{text:n.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:ue}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0,style:`
			${Ke}
...
`,it={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let e=[];return e.push(v(Ye)),e.push(v(Ze)),e.push(v(Qe)),e.push(v(Xe)),e.push(v(et)),e.push(v(`
			...
			`)),h.ready(function(){let t=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(h.createElement("span",{textContent:"Markdown"}),t),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&e.push(v(`
					...
					`));}),e},beautifyGreasyforkBeautify(){u.info("美化 Greasyfork Beautify脚本");let e=[];return e.push(v(rt)),m.isPhone()?e.push(v(`
				section#script-info,
				...
				section#script-info{
					margin-top: 10px;
				}`)),e},beautifyUploadImage(){u.info("美化上传图片");let e=[];return e.push(v(tt)),h.ready(()=>{function t(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let r=document.querySelectorAll('input[type="file"]');r.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||h.on(o,["propertychange","input"],function(a){t(a.target);let s=a.currentTarget.files;if(!s||s.length===0)return;u.info(["选择的图片",s]),s.length>5&&h.after(o,h.createElement("p",{textContent:n.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(s).forEach(c=>{(c.size>204800||!c.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(c);}),l.length!==0&&l.forEach(c=>{h.after(o,h.createElement("p",{textContent:n.t("❌ 图片：{{name}} 大小：{{size}}",{name:c.name,size:c.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{h.on(o,"paste",a=>{u.info(["触发粘贴事件",a]),setTimeout(()=>{h.trigger(r,"input");},100);});});}),e},beautifyTopNavigationBar(){u.info("美化顶部导航栏");let e=[];return e.push(v(nt)),window.outerWidth>550&&(e.push(re.addBlockCSS(".with-submenu")),h.ready(()=>{let r=document.querySelector("#site-nav").querySelector("nav");document.querySelectorAll(".with-submenu nav li").forEach(i=>{r.appendChild(i);});})),e}},ot={init(){p.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){m.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let e=p.getValue("user"),t=p.getValue("pwd");if(m.isNull(e)){g.error(n.t("请先在菜单中录入账号"));return}if(m.isNull(t)){g.error(n.t("请先在菜单中录入密码"));return}let r=document.querySelector("meta[name='csrf-token']");if(!r){g.error(n.t("获取csrf-token失败"));return}let i=g.loading(n.t("正在登录中...")),o=await B.post("https://greasyfork.org/zh-CN/users/sign_in",{fetch:!0,data:encodeURI(`authenticity_token=${r.getAttribute("content")}&user[email]=${e}&user[password]=${t}&user[remember_me]=1&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(i.destroy(),!o.status){u.error(o),g.error(n.t("登录失败，请在控制台查看原因"));return}let a=o.data.responseText;h.parseHTML(a,!0,!0).querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(g.success(n.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):(u.error(o),u.error(`当前账号:${e}`),u.error(`当前密码:${t}`),g.error(n.t("登录失败，可能是账号/密码错误，请在控制台查看原因")));});}},at={init(){this.readBgColor(),h.ready(()=>{p.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),p.execMenuOnce("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),H.init();},readBgColor(){u.info("设置已读背景颜色");let e=p.getValue("discussions-readBgColor");v(`
        .discussion-read{
            background: ${e} !important;
        }
        `);},addShortcutOperationButton(){u.info("添加快捷操作按钮"),H.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=h.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-filter-button">${n.t("过滤")}</button>
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),h.on(o,"click",a=>{var y,b,x;m.preventEvent(a);const s=H.parseDiscuessionListContainerInfo(e);let l="data-filter-key",c="data-filter-value",d=R.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
						...
						`}),f=d.$shadowRoot.querySelector(".pops-alert-content");if(s.scriptId==null&&((y=f.querySelector(`button[${l}="scriptId"]`))==null||y.remove()),s.scriptName==null&&((b=f.querySelector(`button[${l}="scriptName"]`))==null||b.remove()),s.postUserId==null&&((x=f.querySelector(`button[${l}="postUserId"]`))==null||x.remove()),s.replyUserId!=null){let S=h.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:s.replyUserId})});S.setAttribute(l,"scriptAuthorId"),S.setAttribute(c,"^"+s.replyUserId+"$"),f.appendChild(S);}h.on(d.$shadowRoot,"click",`button[${l}]`,S=>{m.preventEvent(S);let _=S.target,I=_.getAttribute(l),k=_.getAttribute(c);H.addValue(I,k),d.close(),H.filter(),g.success(n.t("添加成功"));});});});}},st={init(){p.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),p.execMenuOnce("gf-scripts-filter-enable",()=>{j.init();}),p.execMenuOnce("beautifyCenterContent",()=>ve.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),re.addBlockCSS("#about-user"),h.ready(()=>{let e=document.querySelector("#about-user"),t=document.querySelector("#site-nav nav");if(!e){u.error("#about-user元素不存在");return}if(!t){u.error("#site-nav nav元素不存在");return}e=e.cloneNode(!0);let r=h.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});h.on(r,"click",i=>{m.preventEvent(i),R.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:m.getMaxZIndex(100),style:`
                    .text-content{
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,ct={init(){p.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),h.ready(()=>{p.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){u.info("美化对话框"),[].push(te(lt));},beautifyPrivateMessageList(){u.info("美化私信列表"),te(`
		...
		`),document.querySelectorAll("section.text-content ul li").forEach(e=>{var c;let t=e.querySelector('a[href*="conversations"]'),r=t.href,i=(c=t.textContent)==null?void 0:c.split(" ")[1],o=e.querySelector("a.user-link"),a=null,s=null,l=null;if(o){a=o.textContent,s=o.href;let d=e.querySelector("relative-time");new Date(d.getAttribute("datetime")),l=d.shadowRoot.textContent;}e.classList.add("user-conversations-item"),E.getUserId(),e.innerHTML=`
			...
			`;});}},Y={init(){p.execMenu("checkPage",()=>{this.checkPage();}),it.init(),be.init(),M.isScript()&&Pe.init(),(M.isScriptList()||M.isScriptLibraryList()||M.isScriptCodeSearch())&&ve.init(),M.isDiscuessions()&&at.init(),M.isUsers()&&(st.init(),M.isUsersConversations()&&ct.init()),p.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),h.ready(()=>{C.initEnv(),ot.init(),de.init(),C.handleLocalGotoCallBack(),p.execMenuOnce("fixImageWidth",()=>{Y.fixImageWidth();}),Y.languageSelectorLocale(),p.execMenuOnce("optimizeImageBrowsing",()=>{Y.optimizeImageBrowsing();}),p.execMenuOnce("overlayBedImageClickEvent",()=>{Y.overlayBedImageClickEvent();}),M.isCodeStrict()||p.execMenuOnce("addMarkdownCopyButton",()=>{Y.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(u.info("修复图片显示问题"),v(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){u.info("优化图片浏览"),v(ce("ViewerCSS")),v(`
        ...
        `);function e(r=[],i=0){let o="";r.forEach(l=>{o+=`<li><img data-src="${l}" loading="lazy"></li>`;});let a=h.createElement("ul",{innerHTML:o}),s=new Ee(a,{inline:!1,url:"data-src",zIndex:m.getMaxZIndex()+100,hidden:()=>{s.destroy();}});i=i<0?0:i,s.view(i),s.zoomTo(1),s.show();}function t(r){return r.getAttribute("data-src")||r.getAttribute("src")||r.getAttribute("alt")}h.on(document,"click","img",function(r){var d;let i=r.target;if(((d=i.parentElement)==null?void 0:d.localName)==="a"&&i.hasAttribute("data-screenshots")||i.closest(".viewer-container")||i.closest(".lum-lightbox-position-helper"))return;let o=i.closest(".user-content"),a=[],s=0,l=[],c=t(i);c!=null&&c.startsWith("https://img.shields.io")||(o?(o.querySelectorAll("img").forEach(f=>{l.push(f);let y=t(f),b=f.parentElement;(b==null?void 0:b.localName)==="a"&&(y=b.getAttribute("data-href")||b.href),a.push(y);}),s=l.indexOf(i),s===-1&&(s=0)):(a.push(c),s=0),u.success(["点击浏览图片👉",a,s]),e(a,s));}),document.querySelectorAll(".user-screenshots").forEach(r=>{let i=r.querySelector("a");if(!i)return;let o=i.getAttribute("data-href")||i.getAttribute("href"),a=r.querySelector("img");a&&(a.setAttribute("data-screenshots","true"),a.setAttribute("data-src",o),i.setAttribute("href","javascript:;"),h.after(i,a),i.remove());});},overlayBedImageClickEvent(){u.info("覆盖图床图片的parentElement的a标签"),document.querySelectorAll(".user-content a>img").forEach(e=>{let t=e.parentElement,r=t.getAttribute("href");if(t.setAttribute("data-href",r),t.removeAttribute("href"),r.startsWith("/rails/active_storage/blobs/redirect")){u.info("该图片是上传到Greasyfork的图片，拦截默认行为，不做提示");return}h.on(t,"click",()=>{g.warning(`<div style="overflow-wrap: anywhere;">${n.t("拦截跳转：")}<a href="${r}" target="_blank">${r}</a></div>`,{html:!0,zIndex:m.getMaxZIndex()+105});});});},addMarkdownCopyButton(){u.info("在Markdown右上角添加复制按钮"),v(`
        pre{
          position: relative;

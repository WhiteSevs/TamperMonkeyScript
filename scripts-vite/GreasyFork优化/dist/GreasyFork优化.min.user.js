...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Se=="function"?Se(e.keyName):null;return typeof t=="string"&&t?I(t):_.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(A=>{B.ready(()=>{document.head.appendChild(t),A(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(A=>{t.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let A=[document.documentElement,document.body].concat(...e||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(o=>{n(o);}).catch(o=>{u.error("读取剪贴板内容失败👉",o),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(o=>{e(n);}).catch(o=>{u.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),e(n);});}function A(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!A()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,A=5e3){let n,o=A-t,a=t,i=async s=>{let l=await e(s);if(typeof l=="boolean"&&!l||s){h.workerClearTimeout(n);return}if(a+=t,a>o){i(true);return}n=h.workerSetTimeout(()=>{i(false);},t);};i(false);},findParentNode(e,t,A){if(A){let n=B.closest(e,A);if(n)return n.querySelector(t)}else return B.matches(e,t)?e:B.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(n,o)=>o===void 0?t:o,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},ce={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},h=ae.noConflict(),c=B.noConflict(),U=Ce,u=new h.Log(pe,H.console||$e.console),xe=pe?.script?.name||void 0,_e=Ce.config.Utils.AnyTouch(),et=false;u.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});g.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const A=e.setting.content;return t==="warning"?u.warn(A):t==="error"?u.error(A):u.info(A),true},get position(){return m.getValue(ce.qmsg_config_position.key,ce.qmsg_config_position.defaultValue)},get maxNums(){return m.getValue(ce.qmsg_config_maxnums.key,ce.qmsg_config_maxnums.defaultValue)},get showReverse(){return m.getValue(ce.qmsg_config_showreverse.key,ce.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=ae.getMaxZIndex(),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100}});U.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=ae.getMaxZIndex(void 0,void 0,A=>{if(A?.classList?.contains("qmsg-shadow-container")||A?.closest("qmsg")&&A.getRootNode()instanceof ShadowRoot)return  false}),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Qe=new h.GM_Menu({GM_getValue:ee,GM_setValue:$,GM_registerMenuCommand:Ze,GM_unregisterMenuCommand:We}),q=new h.Httpx({xmlHttpRequest:Je,logDetails:et});q.interceptors.request.use(e=>e);q.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?g.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?g.error("请求超时",{consoleLogContent:true}):g.error("其它错误",{consoleLogContent:true}),e));H.Object.defineProperty,H.Function.prototype.apply,H.Function.prototype.call,H.Element.prototype.appendChild,H.setTimeout;const I=c.addStyle.bind(c),N=B.selector.bind(B),X=B.selectorAll.bind(B);new h.GM_Cookie;const ve="GM_Panel",Pe="data-init",he="data-key",me="data-default-value",Ue="data-init-more-value",Ke="data-plugin-search-config",se="data-storage-api",J={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},Z={setting:{get width(){return J.width<550?"88vw":J.width<700?"550px":"700px"},get height(){return J.height<450?"70vh":J.height<550?"450px":"550px"}},settingMiddle:{get width(){return J.width<350?"88vw":"350px"},get height(){return J.height<450?"88vh":"450px"}},settingBig:{get width(){return J.width<800?"92vw":"800px"},get height(){return J.height<600?"80vh":"600px"}},info:{get width(){return J.width<350?"88vw":"350px"},get height(){return J.height<250?"88vh":"250px"}}};class tt{storageKey;listenerData;constructor(t){if(typeof t=="string"){const A=t.trim();if(A=="")throw new Error("key参数不能为空字符串");this.storageKey=A;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new ae.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let t=ee(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){$(this.storageKey,t);}set(t,A){const n=this.get(t),o=this.getLocalValue();Reflect.set(o,t,A),this.setLocalValue(o),this.triggerValueChangeListener(t,n,A);}get(t,A){const n=this.getLocalValue();return Reflect.get(n,t)??A}getAll(){return this.getLocalValue()}delete(t){const A=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,A,void 0);}has(t){const A=this.getLocalValue();return Reflect.has(A,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(A=>Reflect.get(t,A))}clear(){ge(this.storageKey);}addValueChangeListener(t,A){const n=Math.random(),o=this.listenerData.get(t)||[];return o.push({id:n,key:t,callback:A}),this.listenerData.set(t,o),n}removeValueChangeListener(t){let A=false;for(const[n,o]of this.listenerData.entries()){for(let a=0;a<o.length;a++){const i=o[a];(typeof t=="string"&&i.key===t||typeof t=="number"&&i.id===t)&&(o.splice(a,1),a--,A=true);}this.listenerData.set(n,o);}return A}async triggerValueChangeListener(...t){const[A,n,o]=t;if(!this.listenerData.has(A))return;let a=this.listenerData.get(A);for(let i=0;i<a.length;i++){const s=a[i];if(typeof s.callback=="function"){let l=this.get(A),d,f;typeof n<"u"&&t.length>=2?f=n:f=l,typeof o<"u"&&t.length>2?d=o:d=l,await s.callback(A,f,d);}}}}const oe=new tt(ve),Le={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new h.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const A=(a,i)=>{typeof i!="string"&&(i=_.toStr(i));const s=new Blob([i]),l=globalThis.URL.createObjectURL(s);c.createElement("a",{href:l,download:a}).click(),h.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const a=p=>{const v=U.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),y=v.$shadowRoot.querySelector(".btn-control[data-mode='local']"),x=v.$shadowRoot.querySelector(".btn-control[data-mode='network']"),C=v.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),E=async T=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof we=="function"?typeof ge=="function"?(we().forEach(w=>{ge(w);}),g.success("已清空脚本存储的配置")):g.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):g.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Be=="function"?Be(T):Object.keys(T).forEach(w=>{const b=T[w];$(w,b);}),g.success("配置导入完毕");},M=T=>new Promise(async z=>{const k=h.toJSON(T);Object.keys(k).length===0?g.warning("解析为空配置，不导入"):await E(k),z(true);});c.on(y,"click",T=>{c.preventEvent(T),v.close();const z=c.createElement("input",{type:"file",accept:".json"});c.on(z,["propertychange","input"],k=>{if(!z.files?.length)return;const w=z.files[0],b=new FileReader;b.onload=()=>{M(b.result);},b.readAsText(w,"UTF-8");}),z.click();}),c.on(x,"click",T=>{c.preventEvent(T),v.close();const z=U.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(b,R){b.close();}},ok:{text:"导入",callback:async(b,R)=>{const D=b.text;if(h.isNull(D)){g.error("请填入完整的url");return}const L=g.loading("正在获取配置..."),P=await q.get(D,{allowInterceptConfig:false});if(L.close(),!P.status){u.error(P),g.error("获取配置失败",{consoleLogContent:true});return}await M(P.data.responseText)&&b.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:Z.info.width,height:"auto"}),k=z.$shadowRoot.querySelector("input"),w=z.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(k,["input","propertychange"],b=>{c.val(k)===""?c.attr(w,"disabled","true"):c.removeAttr(w,"disabled");}),c.listenKeyboard(k,"keydown",(b,R,D)=>{b==="Enter"&&D.length===0&&c.val(k)!==""&&c.trigger(w,"click");}),c.trigger(k,"input");}),c.on(C,"click",async T=>{c.preventEvent(T),v.close();let z=await _.getClipboardText();if(z.trim()===""){g.warning("获取到的剪贴板内容为空");return}await M(z);});},i=(p=`${xe}_panel-setting-${h.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,v)=>{const y=U.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(E,M){E.close();}}},drag:true,mask:{enable:true},width:Z.info.width,height:Z.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),x=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),C=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");c.on(x,"click",E=>{c.preventEvent(E);try{A(p,v),y.close();}catch(M){g.error(M.toString(),{consoleLogContent:true});}}),c.on(C,"click",async E=>{await h.copy(v)?(g.success("复制成功"),y.close()):g.error("复制失败");});},l=U.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(p,v){a();}},cancel:{enable:true,text:"导出",callback(p,v){i(void 0,f);}}},width:J.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),d={};if(typeof we=="function")we().forEach(v=>{const y=ee(v);Reflect.set(d,v,y);});else {g.warning("不支持函数GM_listValues，仅导出菜单配置");const p=ee(ve);Reflect.set(d,ve,p);}const f=_.toStr(d);l.value=f;},o=()=>{let a=pe?.script?.supportURL||pe?.script?.namespace;typeof a=="string"&&h.isNotNull(a)&&window.open(a,"_blank");};return [{id:"script-version",title:`版本：${pe?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(){return  false},afterRender(a){new _e(a.$asideLiElement).on("tap",function(s){clearTimeout(t),t=void 0,e?(e=false,n()):(t=setTimeout(()=>{e=false,o();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},Re={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{m.showPanel(Le.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){m.isTopWindow()&&Qe.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let A=this.$data.menuOption.findIndex(n=>n.key===t.key);A!==-1&&(this.$data.menuOption[A]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},m={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new h.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new h.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new h.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new h.Dictionary),this.__onceExecData},get scriptName(){return xe},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ve,attributeKeyName:he,attributeDefaultValueName:me},init(){this.initContentDefaultValue(),Re.init();},isTopWindow(){return H.top===H.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const o=n.attributes;let a=o[Pe];if(typeof a=="function"){let d=a();if(typeof d=="boolean"&&!d)return}let i=new Map,s=o[he];if(s!=null){const d=o[me];i.set(s,d);}let l=o[Ue];if(typeof l=="object"&&l&&Object.keys(l).forEach(d=>{const f=l[d];i.set(d,f);}),!i.size){u.warn(["请先配置键",n]);return}if(n.type==="switch"){let d=typeof n.disabled=="function"?n.disabled():n.disabled;typeof d=="boolean"&&d&&this.$data.contentConfigInitDisabledKeys.push(...i.keys());}for(const[d,f]of i.entries())this.setDefaultValue(d,f);},t=n=>{for(let o=0;o<n.length;o++){let a=n[o];e(a);let i=a.forms;i&&Array.isArray(i)&&t(i);}},A=[...Le.getAllContentConfig()];for(let n=0;n<A.length;n++){let o=A[n];if(!o.forms)continue;const a=o.forms;a&&Array.isArray(a)&&t(a);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&u.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){oe.set(e,t);},getValue(e,t){const A=oe.get(e);return A??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){oe.delete(e);},hasKey(e){return oe.has(e)},addValueChangeListener(e,t){return oe.addValueChangeListener(e,(n,o,a)=>{t(e,a,o);})},removeValueChangeListener(e){oe.removeValueChangeListener(e);},triggerMenuValueChange(e,t,A){oe.triggerValueChangeListener(e,A,t);},async exec(e,t,A,n=true){const o=this;let a;typeof e=="string"||Array.isArray(e)?a=()=>e:a=e;let i=false;const s=a();let l=[];Array.isArray(s)?(i=true,l=s):l.push(s);const d=l.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(d){u.warn(`${d} 键不存在`);return}const f=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(f))return this.$data.onceExecMenuData.get(f);let p=[];const v=[];let y=[];const x=(w,b)=>{let R=[],D=[],L=[];if(Array.isArray(b))L=L.concat(b);else if(typeof b=="object"&&b!=null)if(b instanceof Element)L.push(b);else {const{$css:P,destory:O}=b;P!=null&&(Array.isArray(P)?L=L.concat(P):L.push(P)),typeof O=="function"&&L.push(O);}else L.push(b);for(const P of L)if(P!=null){if(P instanceof Element){R.push(P);continue}if(typeof P=="function"){y.push(P);continue}}w?(p=p.concat(R),y=y.concat(D)):(E(),M());},C=w=>!!this.getValue(w),E=()=>{for(let w=0;w<p.length;w++)p[w]?.remove(),p.splice(w,1),w--;},M=()=>{for(let w=0;w<y.length;w++){const b=y[w];b(),y.splice(w,1),w--;}},T=()=>{let w=false;return typeof A=="function"?w=A(l):w=l.every(b=>C(b)),w},z=async w=>{if(T()){const R=l.map(L=>this.getValue(L)),D=await t({value:i?R:R[0],addStoreValue:(...L)=>x(true,L)});x(true,D);}else x(false,[]);};n&&l.forEach(w=>{const b=this.addValueChangeListener(w,(R,D,L)=>z());v.push(b);}),await z();const k={reload(){this.clearStoreStyleElements(),this.destory(),z();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>E(),destory(){return M()},removeValueChangeListener:()=>{v.forEach(w=>{this.removeValueChangeListener(w);});},clearOnceExecMenuData(){n&&o.$data.onceExecMenuData.delete(f);}};return this.$data.onceExecMenuData.set(f,k),k},async execMenu(e,t,A=false,n=false){return await this.exec(e,async o=>await t(o),o=>o.every(i=>{let s=!!this.getValue(i);return m.$data.contentConfigInitDisabledKeys.includes(i)&&(s=false,u.warn(`.execMenu${n?"Once":""} ${i} 被禁用`)),A&&(s=!s),s}),n)},async execMenuOnce(e,t,A=false,n=false){const o=await this.execMenu(e,t,A,true);if(n&&o){const a=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,a);}return o},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),oe.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async triggerUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const A of t)await A(e);},showPanel(e,t=`${xe}-设置`,A=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let o=e.findIndex(i=>(typeof i.isBottom=="function"?i.isBottom():!!i.isBottom)&&i.id==="script-version")!==-1;!A&&!o&&e.push(...Le.getDefaultBottomContentConfig());let a=U.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(i,s)=>{i.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(i,s)=>{i(),this.$data.$panel=null;}},width:Z.setting.width,height:Z.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:a,content:e});},registerConfigSearch(e){const{$panel:t,content:A}=e,n=async(v,y)=>{if(v==null)return;const x=await y(v);return x&&typeof x.isFind=="boolean"&&x.isFind?x.data:await n(x.data,y)},o=(v,y)=>{const x=new IntersectionObserver(C=>{C.forEach(E=>{E.isIntersecting&&(y?.(),x.disconnect());});},{root:null,threshold:1});x.observe(v),v.scrollIntoView({behavior:"smooth",block:"center"});},a=v=>{const y="pops-flashing";c.animationend(v,()=>{v.classList.remove(y);}),v.classList.add(y);},i=v=>{if(v.type==="dblclick"&&p)return;c.preventEvent(v),l=null;const y=U.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});y.$shadowRoot.querySelector(".search-wrapper");const x=y.$shadowRoot.querySelector(".search-config-text"),C=y.$shadowRoot.querySelector(".search-result-wrapper");x.focus();const E=()=>{c.empty(C);},M=z=>{const k=h.queryProperty(z,b=>b?.next?{isFind:false,data:b.next}:{isFind:true,data:b}),w=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return c.on(w,"click",b=>{const D=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[z.index];if(!D){g.error(`左侧项下标${z.index}不存在`);return}D.scrollIntoView({behavior:"smooth",block:"center"}),D.click(),n(z.next,async L=>{if(L?.next){const P=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(O=>{const F=Reflect.get(O,"__formConfig__");return typeof F=="object"&&F!=null&&F.text===L.name}),2500);if(P)P.click();else return g.error("未找到对应的二级菜单"),{isFind:true,data:L};return {isFind:false,data:L.next}}else {const P=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(O=>Reflect.get(O,"__formConfig__")===L.matchedData?.formConfig),2500);if(P){o(P);const O=P.closest(".pops-panel-forms-fold[data-fold-enable]");O&&(O.querySelector(".pops-panel-forms-fold-container").click(),await h.sleep(500)),o(P,()=>{a(P);});}else g.error("未找到对应的菜单项");return {isFind:true,data:L}}});}),w},T=z=>{const k=new RegExp(z,"i"),w=[],b=(D,L)=>{for(let P=0;P<D.length;P++){const O=D[P],F=O.forms;if(F&&Array.isArray(F)){const W=h.deepClone(L);if(O.type==="deepMenu"){const Ae=h.queryProperty(W,Y=>Y?.next?{isFind:false,data:Y.next}:{isFind:true,data:Y});Ae.next={name:O.text};}b(F,W);}else {let W,Ae;if(O.type==="own"){const G=Reflect.get(O.attributes||{},Ke);G&&(typeof G.text=="string"&&(W=G.text),typeof G.desc=="string"&&(Ae=G.desc));}else W=Reflect.get(O,"text"),Ae=Reflect.get(O,"description");const Y=[W,Ae],re=Y.findIndex(G=>{if(typeof G=="string")return G.match(k)});if(re!==-1){const G=h.deepClone(L),ye=h.queryProperty(G,ne=>ne?.next?{isFind:false,data:ne.next}:{isFind:true,data:ne});ye.next={name:W,matchedData:{path:"",formConfig:O,matchedText:Y[re],description:Ae}};const Te=[];h.queryProperty(G,ne=>{const ze=ne?.name;return typeof ze=="string"&&ze.trim()!==""&&Te.push(ze),ne?.next?{isFind:false,data:ne.next}:{isFind:true,data:ne}});const Ge=Te.join(_.escapeHtml(" - "));ye.next.matchedData.path=Ge,w.push(G);}}}};for(let D=0;D<A.length;D++){const L=A[D];if(!L.forms||L.isBottom&&L.id==="script-version")continue;const P=L.forms;if(P&&Array.isArray(P)){let O=L.title;typeof O=="function"&&(O=O()),b(P,{index:D,name:O});}}const R=document.createDocumentFragment();for(const D of w){let L=M(D);R.appendChild(L);}E(),C.append(R);};c.on(x,"input",h.debounce(z=>{c.preventEvent(z);let k=c.val(x).trim();if(k===""){E();return}T(k);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(v=>{c.on(v,"dblclick",i);});let l=null,d=false,f,p=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(v,y)=>{p=true,clearTimeout(f),f=void 0,d&&l===y?(d=false,l=null,i(v)):(f=setTimeout(()=>{d=false;},200),d=true,l=y);},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`,gt="",Q={isHome(){return window.location.pathname.split("/").length<=2&&window.location.search===""},isCode(){return !!window.location.pathname.split("/")?.includes("code")},isCodeStrict(){return !!window.location.pathname.match(/\/code(\/|)$/)},isVersion(){return !!window.location.pathname.match(/\/versions(\/|)$/)},isUsers(){return !!window.location.pathname.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!window.location.pathname.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!window.location.pathname.match(/\/conversations\/[\d]+/)},isScript(){return !!window.location.pathname.match(/\/scripts\/[\d+]/)},isScriptAdmin(){return !!window.location.pathname.endsWith("/admin")},isScriptList(){return !!window.location.pathname.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!window.location.pathname.match("/scripts/by-site")},isScriptsFeedback(){return this.isScript()&&window.location.pathname.match(/\/feedback(\/|)$/i)},isScriptLibraryList(){return !!window.location.pathname.match(/\/libraries(\/|)$/)},isScriptSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptList()&&e.has("q")},isScriptCodeSearch(){return !!window.location.pathname.match(/\/code-search(\/|)$/)},isScriptLibraryListSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptLibraryList()&&e.has("q")},isDiscuessions(){return !!window.location.pathname.match(/\/discussions(\/|)$/)},isImageSource(){return window.location.pathname.startsWith("/vite/assets")}},vt={init(){m.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),m.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),m.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),m.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let e=[];return e.push(I(it)),e.push(I(at)),e.push(I(st)),e.push(I(lt)),e.push(I(ct)),e.push(I(`
			...
			`)),c.ready(()=>{let t=N('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(c.createElement("span",{textContent:"Markdown"}),t),X(".user-content ul li").forEach(o=>{let a=o.firstChild;a?.nodeName==="#text"&&(a.textContent?.startsWith("[x] ")?(a.textContent=a.textContent.replace("[x] ",""),c.prepend(o,`
				...
				`},n=Object.keys(A);if(X(".user-content blockquote").forEach(o=>{Array.from(o.children).forEach(a=>{let i=c.html(a);if(a.nodeName==="P"){let s=n.find(l=>i.toLowerCase().startsWith(l.toLowerCase()));s&&(c.html(a,i.replace(s,"")),c.before(a,A[s]),c.html(a)===""&&a.remove());}});}),X(".user-content > blockquote").forEach(o=>{Array.from(o.querySelectorAll(".markdown-alert-title")).forEach(a=>{let i=c.createElement("div",{className:"markdown-alert markdown-alert-tip"},{"data-type":a.getAttribute("data-type")});for(;a.nextSibling&&!a.nextSibling?.classList?.contains("markdown-alert-title");)c.append(i,a.nextSibling);c.prepend(i,a),c.before(o,i);});}),Q.isHome())e.push(I(pt));else if(Q.isScriptsFeedback()){e.push(I(gt));let o=N('.radio-label[for*="discussion_rating_0"]');o&&(o.innerHTML=o.innerHTML.replace("不评分",'<span class="rating-icon rating-icon-none">不评分</span>'));let a=N('.radio-label[for*="discussion_rating_2"]');a&&(a.innerHTML=a.innerHTML.replace("差评",'<span class="rating-icon rating-icon-bad">差评</span>'));let i=N('.radio-label[for*="discussion_rating_3"]');i&&(i.innerHTML=i.innerHTML.replace("一般",'<span class="rating-icon rating-icon-ok">一般</span>'));let s=N('.radio-label[for*="discussion_rating_4"]');s&&(s.innerHTML=s.innerHTML.replace("好评",'<span class="rating-icon rating-icon-good">好评</span>'));}else Q.isScriptAdmin()&&(N('input[type="submit"][name="update-only"]')||e.push(I(`
					.indented{
						padding-left: unset;
					}
			...
			</div>`};if(h.isNull(e))g.error(r.t("未获取到【脚本列表】"));else {let A=g.loading(t(j.getScriptName(e[0])),{isHTML:true}),n=0,o=0;for(let a=0;a<e.length;a++){let i=e[a],s=j.getScriptId(i);u.success("更新："+i);let l=j.getScriptName(i);A.setHTML(t(l,a+1));let d=await V.getSourceCodeSyncFormDataInfo(s);if(d){const{formData:f,url:p}=d;await V.sourceCodeSync(s,f,p)?(g.success(r.t("源代码同步成功，3秒后更新下一个")),await h.sleep(3e3),n++):(g.error(r.t("源代码同步失败")),o++);}else g.error(r.t("源代码同步失败")),o++;}A.close(),n===0?g.error(r.t("全部更新失败")):g.success(r.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:n,failedNums:o,scriptUrlListLength:e.length}),{isHTML:true});}},handleLocalGotoCallBack(){if(m.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(m.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!Q.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_scriptList",true),K.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=K.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];X("#user-script-list-section li a.script-link").forEach(t=>{e=e.concat(j.getAdminUrl(t.href));}),K.updateScript(e);}else if(m.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(m.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!Q.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),K.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=K.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];X("#user-unlisted-script-list li a.script-link").forEach(t=>{e=e.concat(j.getAdminUrl(t.href));}),K.updateScript(e);}else if(m.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(m.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!Q.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),K.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=K.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];X("#user-library-script-list li a.script-link").forEach(t=>{e=e.concat(j.getAdminUrl(t.href));}),K.updateScript(e);}}},ht={init(){m.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){c.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let e=m.getValue("user"),t=m.getValue("pwd"),A=m.getValue("secret");if(h.isNull(e)){g.error(r.t("请先在菜单中录入账号"));return}if(h.isNull(t)){g.error(r.t("请先在菜单中录入密码"));return}if(h.isNull(A)){g.error(r.t("请先在菜单中录入secret"));return}let n=N("meta[name='csrf-token']");if(!n){g.error(r.t("获取csrf-token失败"));return}let a=new Fe__namespace.TOTP({secret:A}).generate(),i=g.loading(r.t("正在登录中...")),s=await q.post("/zh-CN/users/sign_in",{fetch:true,data:encodeURI(`authenticity_token=${n.getAttribute("content")}&user[email]=${e}&user[password]=${t}&user[remember_me]=1&user[otp_attempt]=${a}&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(i.destroy(),!s.status){u.error(s),g.error(r.t("登录失败，请求异常"));return}let l=s.data.responseText,d=c.toElement(l,true,true),f=d.querySelector(".width-constraint .alert");d.querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(g.success(r.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):f?(u.error(f),g.error(c.text(f))):(g.error(r.t("登录失败，可能是账号/密码错误，请在控制台查看原因"),{consoleLogContent:true}),u.error(s),u.error(`当前账号:${e}`),u.error(`当前密码:${t}`));});}},te={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){u.info("论坛-过滤"),I(`
...
`),h.isNull(e))return;e=e.toString().trim();let n=e+"##"+t;A+=n,this.setValue(A);},getValue(){return m.getValue(this.key,"")}},mt={init(){this.readBgColor(),c.ready(()=>{m.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),I(`
      ...
      `);const e=new h.LockFunction(()=>{const t=m.getValue("discussions-addShortcutOperationButton"),A=m.getValue("discussions-addReportButton");t&&this.addFilterButton(),A&&this.addReportButton(),(t||A)&&this.addMoreButton({addFilterButton:t,addReportButton:A});});h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),te.init();},readBgColor(){u.info("设置已读背景颜色");const e=m.getValue("discussions-readBgColor"),A=new h.ColorConversion().getDarkColor(e,.8);return I(`
        ...
        `)},addFilterButton(){const e="discussion-filter-button";te.getElementList().forEach(t=>{if(t.querySelector(`.${e}`))return;let n=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),o=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`},{style:"flex: 0;","data-type":"filter"}),a=o.querySelector(`.${e}`);n.appendChild(o),c.on(a,"click",i=>{c.preventEvent(i);const s=te.parseDiscuessionListContainerInfo(t);if(!s)return;let l="data-filter-key",d="data-filter-value",f=U.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:false},content:{text:`
						...
						`}),p=f.$shadowRoot.querySelector(".pops-alert-content");if(s.scriptId==null&&p.querySelector(`button[${l}="scriptId"]`)?.remove(),s.scriptName==null&&p.querySelector(`button[${l}="scriptName"]`)?.remove(),s.postUserId==null&&p.querySelector(`button[${l}="postUserId"]`)?.remove(),s.replyUserId!=null){let v=c.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:s.replyUserId})});v.setAttribute(l,"scriptAuthorId"),v.setAttribute(d,"^"+s.replyUserId+"$"),p.appendChild(v);}c.on(f.$shadowRoot,"click",`button[${l}]`,v=>{c.preventEvent(v);let y=v.target,x=y.getAttribute(l),C=y.getAttribute(d);te.addValue(x,C),f.close(),te.filter(),g.success(r.t("添加成功"));});});});},addReportButton(){const e="discussion-report-button";te.getElementList().forEach(t=>{if(t.querySelector(`.${e}`))return;let n=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),o=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="${e} pops-button--danger">${r.t("举报")}</button>
					`},{style:"flex: 0;","data-type":"report"}),a=o.querySelector(`.${e}`);n.appendChild(o),c.on(a,"click",i=>{c.preventEvent(i);const s=te.parseDiscuessionListContainerInfo(t);s&&U.alert({title:{text:r.t("举报"),position:"center",html:false},content:{text:`
					...
					`},{style:"flex: 0;","data-type":"more"});const i=a.querySelector(`.${t}`),s=[];if(e.addFilterButton&&s.push({text:r.t("过滤"),callback:()=>{const f=c.parent(n).querySelector('.discussion-meta-item[data-type="filter"] button');if(!f){g.error(r.t("未找到【过滤】按钮"));return}f.click();}}),e.addReportButton&&s.push({text:r.t("举报"),callback:()=>{const f=c.parent(n).querySelector('.discussion-meta-item[data-type="report"] button');if(!f){g.error(r.t("未找到【举报】按钮"));return}f.click();}}),!s.length)return;const l=U.rightClickMenu({target:document.documentElement,position:"absolute",limitPositionYInView:false,data:s});l.removeContextMenuEvent(document.documentElement),c.on(i,"click",d=>{c.preventEvent(d);const f=i.getBoundingClientRect();l.PopsContextMenu.contextMenuEvent(new PointerEvent("contextmenu",{clientX:f.left+window.scrollX,clientY:f.top+f.height+window.scrollY}),i);}),o.appendChild(a);});}},Ie={isCurrentLoginUserHome(){let e=le.getCurrentLoginUserId();return !!(e!=null&&Q.isUsers()&&window.location.pathname.includes("/"+e))},monacoEditor(){return new Promise(e=>{const t="0.52.2",A="monaco-editor-ready";if(H.monaco){e(H.monaco);return}let n=g.loading(r.t("monaco-editor加载中...")),o=c.createElement("script",{type:"module",defer:true,innerHTML:`
...
`,bt={init(){m.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),m.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),m.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(I(wt)),e.push(_.addBlockCSS(".version-number",".version-date",".version-changelog")),c.ready(function(){let t=N("ul.history_versions");if(!t){g.error(r.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(A=>{let n=A.querySelector(".version-number a").href,o=A.querySelector(".version-number a").innerText,a=A.querySelector(".version-date")?.getAttribute("datetime"),i=A.querySelector(".version-changelog")?.innerHTML||"",s=c.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),l=c.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
						...
						`});c.after(e,l);});});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),Ie.monacoEditor().then(e=>{c.ready(()=>{X('#script-content form[action*="/diff"] input[type="submit"]').forEach(t=>{let A=c.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});c.after(t,A),c.on(A,"click",async n=>{c.preventEvent(n);const o=t.closest("form"),a=new FormData(o),i=a.get("v1"),s=a.get("v2");if(i===s){g.warning(r.t("版本号相同，不需要比较源码"));return}u.info(`对比版本：${i} vs ${s}`);const l=g.loading(r.t("正在获取对比文本中...")),d=j.getScriptId(),f=await V.getScriptInfo(d);if(!f){l.close();return}u.info("脚本信息：",f);const p=f.code_url,v=p.replace(new RegExp(`/${d}/`),`/${d}/${i}/`),y=p.replace(new RegExp(`/${d}/`),`/${d}/${s}/`);u.info(`请求版本代码：${v}`),u.info(`请求版本代码：${y}`);let x="",C="";const[E,M]=await Promise.all([q.get(v,{timeout:2e4}),q.get(y,{timeout:2e4})]);if(l.close(),!E.status||!M.status)return;x=E.data.responseText,C=M.data.responseText;let{recovery:T}=_.lockScroll(),z=U.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
								<div class="monaco-editor-diff-container">
									<div class="monaco-editor-diff"></div>
								</div>
								`},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},btn:{ok:{enable:false},close:{callback(D,L){D.close(),T();}}},zIndex(){let D=h.getMaxZIndex(),L=U.config.InstanceUtils.getPopsMaxZIndex().zIndex;return h.getMaxValue(D,L)+100},useShadowRoot:false,width:"90vw",height:"90vh",drag:true,style:`
						...
						`});z.$shadowRoot.querySelector(".monaco-editor-diff-container");let k=z.$shadowRoot.querySelector(".monaco-editor-diff"),w=e.editor.createDiffEditor(k,{hideUnchangedRegions:{enabled:true},minimap:{enabled:true},automaticLayout:true,codeLens:true,colorDecorators:true,contextmenu:false,readOnly:true,formatOnPaste:true,overviewRulerBorder:true,scrollBeyondLastLine:false,theme:"vs-dark",fontSize:window.innerWidth>600?14:12,wordWrap:"off",language:"javascript"});const b=e.editor.createModel(C,"javascript"),R=e.editor.createModel(x,"javascript");w.setModel({original:b,modified:R});});});});});}};let be=[];const Xe=async function(e){if(u.info("当前脚本id："+e),!K.isLogin){u.error("请先登录账号"),g.error(r.t("请先登录账号"));return}let t=j.getUserId(K.getUserLinkElement().href);if(t==null){u.error("获取用户id失败"),g.error(r.t("获取用户id失败"));return}if(!be.length){let a=g.loading(r.t("获取收藏夹中..."));if(be=await V.getUserCollection(t)||[],a.close(),!be.length)return}let A="";const n=(a,i)=>{let s=false;i=i.toString().trim();for(const[l,d]of a.entries())if(l==="scripts-included[]"&&d.toString().trim()===i){s=true;break}return s};be.forEach(a=>{A+=`
		<li class="user-collect-item" data-id="${a.id}" data-name="${a.name}">
		  ...
		  `;});let o=U.alert({title:{text:r.t("收藏集"),position:"center"},content:{html:true,text:`<ul>${A}</ul>`},mask:{enable:true,clickEvent:{toClose:true}},btn:{ok:{enable:false}},width:U.isPhone()?"92vw":"500px",height:"auto",drag:true,only:true,style:`
		.pops{
		...
		`});c.on(o.$shadowRoot,"click",".collect-add-script-id",async function(a){let i=a.target.closest(".user-collect-item"),s=i.dataset.id;i.dataset.name;let l=g.loading(r.t("添加中..."));try{let d=await V.getUserCollectionInfo(t,s);if(!d)return;if(n(d,e)){g.warning(r.t("该脚本已经在该收藏集中"));return}let f=h.cloneFormData(d),p=h.cloneFormData(d);f.set("add-script",e.toString()),f.set("script-action","i"),p.append("scripts-included[]",e.toString()),p.set("save","1");let v=new URLSearchParams(f),y=new URLSearchParams(p),x=Array.from(v).map(([b,R])=>`${encodeURIComponent(b)}=${encodeURIComponent(R)}`).join("&"),C=Array.from(y).map(([b,R])=>`${encodeURIComponent(b)}=${encodeURIComponent(R)}`).join("&");u.info("添加的数据",x),u.info("保存的数据",C);let E=await V.updateUserSetsInfo(t,s,x);if(!E)return;let M=E.querySelector(".change-script-set");if(!M){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let T=M.querySelector("section");if(!T){g.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}let z=T.querySelector(".alert");if(z){U.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:z.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:Z.info.width,height:Z.info.height});return}let k=new FormData(M);if(!n(k,e)){u.error("添加失败，提交的添加请求中不包含该脚本id"),g.error(r.t("添加失败，表单数据中不包含该脚本"));return}await V.updateUserSetsInfo(t,s,C),g.success(r.t("添加成功"));}catch(d){console.error(d);}finally{l.close();}}),c.on(o.$shadowRoot,"click",".collect-delete-script-id",async function(a){let i=a.target.closest(".user-collect-item"),s=i.dataset.id;i.dataset.name;let l=g.loading(r.t("删除中..."));try{let d=await V.getUserCollectionInfo(t,s);if(!d)return;if(!n(d,e)){g.info(r.t("已删除：{{scriptId}}",{scriptId:e}));return}let f=h.cloneFormData(d,(k,w)=>k==="scripts-included[]"&&typeof w=="string"&&w.toString().trim()===e.toString().trim()),p=h.cloneFormData(f);f.set("remove-scripts-included[]",e.toString()),f.set("remove-selected-scripts","i"),f.delete("script-action"),p.set("save","1");let v=new URLSearchParams(f),y=new URLSearchParams(p),x=Array.from(v).map(([k,w])=>`${encodeURIComponent(k)}=${encodeURIComponent(w)}`).join("&"),C=Array.from(y).map(([k,w])=>`${encodeURIComponent(k)}=${encodeURIComponent(w)}`).join("&");u.info("删除的数据",x),u.info("保存的数据",C);let E=await V.updateUserSetsInfo(t,s,x);if(!E)return;let M=E.querySelector(".change-script-set");if(!M){g.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let T=new FormData(M);if(n(T,e)){u.error("删除失败，提交的删除请求中包含该脚本id"),g.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await V.updateUserSetsInfo(t,s,C),g.success(r.t("删除成功"));}catch(d){console.error(d);}finally{l.close();}});},xt={init(){Q.isCode()?yt.init():Q.isVersion()&&bt.init(),Q.isCodeStrict()&&(m.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),m.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),m.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),m.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),c.ready(()=>{m.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){u.info("添加收藏按钮"),c.waitNode("ul#script-links li.current span").then(()=>{let e=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
...
`,Me={getTampermonkey:()=>H.external?.Tampermonkey,getViolentmonkey:()=>H.external?.Violentmonkey,getScriptCat:()=>H.external?.Scriptcat,getScriptContainerStatus(){let e={Tampermonkey:false,Violentmonkey:false,ScriptCat:false};return H.external?.Tampermonkey&&(e.Tampermonkey=true),H.external?.Violentmonkey&&(e.Violentmonkey=true),H.external?.Scriptcat&&(e.ScriptCat=true),e},getRegisterScriptContainerNameList(){let t=this.getScriptContainerStatus(),A=[];return Object.keys(t).forEach(n=>{Reflect.get(t,n)&&A.push(n);}),A},getInstalledVersion(e,t){return new Promise((A,n)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(A);return}const i=this.getScriptCat();if(i){i.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}n(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const A=e.split("."),n=t.split(".");for(let o=0;o<A.length;o++){const a=this.compareVersionPart(A[o],n[o]);if(a!==0)return a}return 0},compareVersionPart(e,t){const A=this.parseVersionPart(e),n=this.parseVersionPart(t);for(let o=0;o<A.length;o++){if(A[o].length>0&&n[o].length===0)return  -1;if(A[o].length===0&&n[o].length>0||A[o]>n[o])return 1;if(A[o]<n[o])return  -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,A){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,A)){case  -1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const A=e.getAttribute("data-script-name"),n=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(A,n);return a==null?!1:(this.handleInstallResult(e,a,o),!0)}catch{if(t){await h.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return  false}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),A=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:A,url:location.href},location.origin);}},qe={init(){m.execMenuOnce("gf-scripts-filter-enable",()=>{ie.init();}),m.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let e=[];e.push(I(Lt));const t="lum-lightbox-loader",A=r.t("安装此脚本");return B.ready(()=>{let n=Me.getScriptContainerStatus(),o=Object.values(n).find(d=>d),a=Me.getRegisterScriptContainerNameList(),i=m.getValue("beautifyCenterContent-queryNameSpace");o?u.info("当前暴露的external信息："+a.map(d=>`【${d}】`).join("、")):u.error("脚本容器未暴露external信息",window.external);let s=new h.LockFunction(()=>{ie.getElementList().forEach(f=>{if(f.querySelector(".script-list-operation"))return;let p=le.parseScriptListInfo(f),v=f.querySelector(".inline-script-stats");if(!v)return;let y=p.codeUrl,x=B.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),C=B.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${p.scriptRatingScore}</span>`},{"data-position":"right"}),E=f.querySelector("dd.script-list-ratings .good-rating-count"),M=f.querySelector("dd.script-list-ratings .ok-rating-count"),T=f.querySelector("dd.script-list-ratings .bad-rating-count");if(E&&M&&T){let L=parseInt(E.innerText),P=parseInt(M.innerText),O=parseInt(T.innerText),F=L+P+O;F>=10?L/F>=.6?C.classList.add("good-rating-count"):C.classList.add("bad-rating-count"):F==0||L>P+O?C.classList.add("good-rating-count"):C.classList.add("bad-rating-count");}let z=B.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),k=B.createElement("dd",{className:"script-list-version",innerHTML:`<span>${p.scriptVersion}</span>`},{"data-position":"right"}),w=B.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),b=B.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),R=b.querySelector(".script-collect-btn"),D=b.querySelector(".install-link");if(D["data-script-info"]=p,B.addClass(D,t),p.scriptType==="library"&&D.remove(),B.on(R,"click",L=>{B.preventEvent(L),Xe(p.scriptId);}),m.getValue("gf-scripts-filter-enable")){let L=B.createElement("button",{className:"script-filter-btn",innerHTML:r.t("过滤")}),P="data-filter-key",O="data-filter-value";B.on(L,"click",F=>{B.preventEvent(F);let W=U.alert({title:{text:r.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${P}="scriptId" ${O}="^${p.scriptId}$">${r.t("脚本id：{{text}}",{text:p.scriptId})}</button>
									<button ${P}="scriptName" ${O}="^${h.toRegExpStr(p.scriptName)}$">${r.t("脚本名：{{text}}",{text:p.scriptName})}</button>
								...
								`}),Ae=W.$shadowRoot.querySelector(".pops-alert-content");p.scriptAuthors.forEach(Y=>{let re=B.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:Y.authorId})});re.setAttribute(P,"scriptAuthorId"),re.setAttribute(O,"^"+Y.authorId+"$");let G=B.createElement("button",{innerHTML:r.t("作者名：{{text}}",{text:Y.authorName})});G.setAttribute(P,"scriptAuthorName"),G.setAttribute(O,"^"+h.toRegExpStr(Y.authorName)+"$"),Ae.appendChild(re),Ae.appendChild(G);}),B.on(W.$shadowRoot,"click",`button[${P}]`,Y=>{B.preventEvent(Y);let re=Y.target,G=re.getAttribute(P),ye=re.getAttribute(O);ie.addValue(G,ye),W.close(),ie.filter(),g.success(r.t("添加成功"));});}),b.appendChild(L);}v.appendChild(x),v.appendChild(C),v.appendChild(z),v.appendChild(k),v.appendChild(w),v.appendChild(b);});},100),l=new h.LockFunction(async()=>{let d=Array.from(X(".install-link[data-install-format=js]:not([gm-is-check-install-status])"));for(let f=0;f<d.length;f++){const p=d[f];p.setAttribute("gm-is-check-install-status","");let v=Reflect.get(p,"data-script-info");if(o){if(i){let y=await V.getScriptInfo(v.scriptId);y&&p.setAttribute("data-script-namespace",y.namespace);}Me.checkForUpdatesJS(p,true).then(y=>{B.removeClass(p,t),y||B.text(p,A);});}else B.removeClass(p,t),B.text(p,A);}});h.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{s.run(),l.run();}});}),e}},Ct={init(){m.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),m.execMenuOnce("gf-scripts-filter-enable",()=>{ie.init();}),m.execMenuOnce("beautifyCenterContent",()=>qe.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),_.addBlockCSS("#about-user"),c.ready(()=>{let e=N("#about-user");if(!e){u.error("#about-user元素不存在");return}e=e.cloneNode(true),le.registerTopNavMenu({name:r.t("控制台"),className:"scripts-console",clickEvent(t){U.alert({title:{text:r.t("控制台"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:Z.setting.width,height:Z.setting.height,zIndex:h.getMaxZIndex(100),style:`
						#about-user{
							border: 0;
							box-shadow: none;
						}
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(e);}});});}};class Pt{key="short-cut";$data;isWaitPress=false;currentWaitEnterPressInstanceHandler=null;constructor(t){typeof t=="string"&&(this.key=t),this.$data={otherShortCutOptions:[]};}initConfig(t,A){this.hasOption(t)||this.setOption(t,A);}getStorageKey(){return this.key}getLocalAllOptions(){return ee(this.key,[])}hasOption(t){return !!this.getLocalAllOptions().find(o=>o.key===t)}hasOptionValue(t){return this.hasOption(t)?this.getOption(t)?.value!=null:false}getOption(t,A){return this.getLocalAllOptions().find(a=>a.key===t)??A}setOption(t,A){let n=this.getLocalAllOptions(),o=n.findIndex(a=>a.key===t);o==-1?n.push({key:t,value:A}):Reflect.set(n[o],"value",A),$(this.key,n);}emptyOption(t){let A=false,n=this.getLocalAllOptions(),o=n.findIndex(a=>a.key===t);return o!==-1&&(n[o].value=null,A=true),$(this.key,n),A}deleteOption(t){let A=false,n=this.getLocalAllOptions(),o=n.findIndex(a=>a.key===t);return o!==-1&&(n.splice(o,1),A=true),$(this.key,n),A}translateKeyboardValueToButtonText(t){let A="";return t.ohterCodeList.forEach(n=>{A+=h.stringTitleToUpperCase(n,true)+" + ";}),A+=h.stringTitleToUpperCase(t.keyName),A}getShowText(t,A){if(this.hasOption(t)){let n=this.getOption(t);return n.value==null?A:this.translateKeyboardValueToButtonText(n.value)}else return A}async enterShortcutKeys(t){const A=this;return new Promise(n=>{this.isWaitPress=true;let o=c.listenKeyboard(window,"keyup",(a,i,s)=>{const l={keyName:a,keyValue:i,ohterCodeList:s};let d={};try{const f=JSON.stringify(l),p=this.getLocalAllOptions();Array.isArray(this.$data.otherShortCutOptions)&&p.push(...this.$data.otherShortCutOptions);for(let v=0;v<p.length;v++){let y=p[v];if(y.key===t)continue;const x=JSON.stringify(y.value);let C=!1;if(y.value!=null&&f===x&&(C=!0),C){d={status:!1,key:y.key,option:l};return}}this.setOption(t,l),d={status:!0,key:t,option:l};}catch(f){console.log(f),d={status:false,key:t,option:l};}finally{A.isWaitPress=false,o.removeListen(),A.currentWaitEnterPressInstanceHandler=null,n(d);}});A.currentWaitEnterPressInstanceHandler=null,A.currentWaitEnterPressInstanceHandler=()=>{A.isWaitPress=false,o.removeListen();};})}cancelEnterShortcutKeys(){typeof this.currentWaitEnterPressInstanceHandler=="function"&&this.currentWaitEnterPressInstanceHandler();}initGlobalKeyboardListener(t,A){let n=this.getLocalAllOptions();if(!n.length){u.warn("没有设置快捷键");return}const o=this;function a(l,d){c.listenKeyboard(l,"keydown",(f,p,v,y)=>{if(o.isWaitPress)return;A?.isPrevent&&c.preventEvent(y),n=o.getLocalAllOptions();let x=n.findIndex(C=>{let E=C.value,M={keyName:f,keyValue:p,ohterCodeList:v};if(JSON.stringify(E)===JSON.stringify(M))return C});if(x!=-1){let C=n[x];C.key in d&&(u.info(["调用快捷键",C]),d[C.key].callback());}},{capture:!!A?.capture});}let i={},s={};Object.keys(t).forEach(l=>{let d=t[l];(d.target==null||typeof d.target=="string"&&d.target==="")&&(d.target="window"),d.target==="window"?Reflect.set(i,l,d):Reflect.set(s,l,d);}),a(window,i),c.ready(()=>{Object.keys(s).forEach(async l=>{let d=s[l];if(typeof d.target=="string")c.waitNode(d.target,1e4).then(f=>{if(!f)return;let p={};Reflect.set(p,l,d),a(f,p);});else if(typeof d.target=="function"){let f=await d.target();if(f==null)return;let p={};Reflect.set(p,l,d),a(f,p);}else {let f={};Reflect.set(f,l,d),a(d.target,f);}});});}}const He={shortCut:new Pt,shortOption:{"gf-quickReply":{target:()=>{let e=N("form textarea"),t=N('input[name="commit"][type="submit"]');if(e){if(!t){u.error("页面不存在【发表回复】按钮");return}}else {u.error("页面不存在输入框");return}return u.success("监听快捷键：gf-quickReply"),e},callback(){if(document.activeElement){let e=document.activeElement.closest("form");if(!e){u.error("当前activeElement不在表单内，无法触发快捷键");return}let t=e.querySelectorAll('input[name="commit"][type="submit"]');if(!t.length){u.error("表单内不存在【发表回复】按钮");return}t.length>1&&u.warn("表单内存在多个【发表回复】按钮，只触发第一个"),t[0].click();}else u.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},zt=`section.text-content {\r
...
`,Mt={init(){m.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),c.ready(()=>{m.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return u.info("美化对话框"),I(zt)},beautifyPrivateMessageList(){u.info("美化私信列表"),I(`
		...
		`),c.ready(()=>{N("#site-nav nav"),N("#site-nav .with-submenu nav");let e=N("#script-list-option-groups")||N(".list-option-groups");if(!e){u.warn("不存在右侧面板元素#script-list-option-groups");return}e=e.cloneNode(true),e.classList.add("option-panel-groups"),le.registerTopNavMenu({name:r.t("操作面板"),className:"filter-scripts",clickEvent(t){U.alert({title:{text:r.t("操作面板"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:Z.setting.width,height:Z.setting.height,zIndex:h.getMaxZIndex(100),style:`
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(e);}});});}},St={init(){},showView(){let e=U.alert({title:{text:r.t("Url To WebhookUrl"),position:"center"},content:{text:`
...
`).forEach(i=>{try{if(i=i.trim(),h.isNull(i))return;let l=new URL(i).pathname.split("/"),{1:d,2:f,3:p,4:v}=l,y="";if(l.length>=6&&p==="blob")y=l.slice(5,l.length).join("/");else if(l.length>=8&&p==="raw"&&v==="refs")v=l[6],y=l.slice(7,l.length).join("/");else return;if(y==="")return;a.push(`https://raw.githubusercontent.com/${d}/${f}/${v}/${y}`);}catch{}}),A.value=a.join(`
`);});}},fe=function(e,t,A,n,o,a,i,s,l,d){const f={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:o,buttonIconIsLoading:a,buttonType:i,buttonText:A,callback(p){typeof s=="function"&&s(p);},afterAddToUListCallBack:l};return Reflect.set(f.attributes,Pe,()=>{f.disable=false;}),f},Oe={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new ae.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,A){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=A,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,se,t);}},ke=function(e,t,A,n,o,a="",i,s,l,d){const f={text:e,type:"input",isNumber:!!i,isPassword:!!s,attributes:{},props:{},description:n,afterAddToUListCallBack:l,getValue(){return this.props[se].get(t,A)},callback(p,v,y){this.props[se].set(t,v);},placeholder:a};return Reflect.set(f.attributes,he,t),Reflect.set(f.attributes,me,A),Oe.initComponentsStorageApi("input",f,{get(p,v){return m.getValue(p,v)},set(p,v){m.setValue(p,v);}}),f},S=function(e,t,A,n,o,a,i,s){const l={text:e,type:"switch",description:o,disabled:i,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f){const p=!!f;u.success(`${p?"开启":"关闭"} ${e}`),this.props[se].set(t,p);},afterAddToUListCallBack:a};return Reflect.set(l.attributes,he,t),Reflect.set(l.attributes,me,A),Oe.initComponentsStorageApi("switch",l,{get(d,f){return m.getValue(d,f)},set(d,f){m.setValue(d,f);}}),l},de=function(e,t,A,n,o,a,i){let s=[];typeof n=="function"?s=n():s=n;const l={text:e,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f,p){const v=f;if(u.info(`选择：${p}`),typeof o=="function"&&o(d,v,p))return;this.props[se].set(t,v);},data:s};return Reflect.set(l.attributes,he,t),Reflect.set(l.attributes,me,A),Oe.initComponentsStorageApi("select",l,{get(d,f){return m.getValue(d,f)},set(d,f){m.setValue(d,f);}}),l},Et=function(e,t,A,n,o,a="default",i){const s=typeof o=="function"?o():o;typeof n=="object"&&i.initConfig(A,n);const l=()=>i.getShowText(A,s),d=fe(e,t,l,"keyboard",false,false,a,async f=>{const v=f.target.closest(".pops-panel-button")?.querySelector("span");if(i.isWaitPress){g.warning("请先执行当前的录入操作");return}if(i.hasOptionValue(A))i.emptyOption(A),g.success("清空快捷键");else {const y=g.loading("请按下快捷键...",{showClose:true,onClose(){i.cancelEnterShortcutKeys();}}),{status:x,option:C,key:E}=await i.enterShortcutKeys(A);y.close(),x?(u.success(["成功录入快捷键",C]),g.success("成功录入")):g.error(`快捷键 ${i.translateKeyboardValueToButtonText(C)} 已被 ${E} 占用`);}v.innerHTML=l();});return d.attributes={},Reflect.set(d.attributes,Pe,()=>false),d},Ne={async UIScriptList(e,t){if(!K.isLogin){g.error(r.t("请先登录账号！"));return}let o=K.getUserLinkElement().href?.split("/")?.pop()?.match(/([0-9]+)/)?.[0],a=U.loading({mask:{enable:true},parent:t,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:false}),i=await V.getUserInfo(o);if(a.close(),!i)return;u.info(i);let s=e==="script-list"?i.scriptList:i.scriptLibraryList;g.success(r.t("获取成功，共 {{count}} 个",{count:s.length}));for(const l of s){let d=c.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `});const f=d.querySelector(".w-script-info"),p=c.createElement("div",{className:"pops-panel-button",innerHTML:`
				<button type="button" data-type="primary" data-icon="" data-righticon="false">
				  <span>${r.t("同步代码")}</span>
				</button>
				`});l.deleted&&(d.classList.add("w-script-deleted"),p.querySelector("button").setAttribute("disabled","true")),c.on(p,"click",async function(){u.success("同步",l);const v=p.querySelector("button"),y=p.querySelector("button span"),x=c.createElement("i",{className:"pops-bottom-icon",innerHTML:U.config.iconSVG.loading},{"is-loading":true});v.setAttribute("disabled","true"),v.setAttribute("data-icon","true"),y.innerText=r.t("同步中..."),c.before(y,x);const C=l?.id,E=await V.getSourceCodeSyncFormDataInfo(C.toString());if(E){const{formData:M,url:T}=E,z="script[script_sync_type_id]",k="script[sync_type]";if(M.has(z)||M.has(k)){let w="";if(M.has(z)){let D=M.get(z);D.toString()==="1"?w=r.t("手动"):D.toString()==="2"?w=r.t("自动"):D.toString()==="3"&&(w="webhook");}else M.has(k)&&(w=M.get(k));const b=d.querySelector(".w-script-sync-type");b?b.querySelector("p").innerText=r.t("同步方式：{{syncMode}}",{syncMode:w}):c.append(f,`
								<div class="w-script-sync-type">
									<p>${r.t("同步方式：{{syncMode}}",{syncMode:w})}
									</p>
								</div>`),await V.sourceCodeSync(l.id.toString(),M,T)?g.success(r.t("同步成功")):g.error(r.t("同步失败"));}else g.error(r.t("该脚本未设置同步信息"));}v.removeAttribute("disabled"),v.removeAttribute("data-icon"),y.innerText=r.t("同步代码"),x.remove();}),d.appendChild(p),t.appendChild(d);}}},De=function(e,t,A,n,o,a){const i={type:"own",attributes:{},props:{},getLiElementCallBack:e,afterAddToUListCallBack:a};return typeof t=="object"&&t!==null&&Object.keys(t).length>0?Reflect.set(i.attributes,Ue,t):Reflect.set(i.attributes,Pe,()=>false),typeof A=="object"&&A!==null&&Reflect.set(i.attributes,Ke,A),i},Dt={id:"greasy-fork-panel-config-account",title:r.t("通用"),forms:[{text:"",type:"forms",forms:[{text:r.t("Toast配置"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[de(r.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:r.t("左上角")},{value:"top",text:r.t("顶部")},{value:"topright",text:r.t("右上角")},{value:"left",text:r.t("左边")},{value:"center",text:r.t("中间")},{value:"right",text:r.t("右边")},{value:"bottomleft",text:r.t("左下角")},{value:"bottom",text:r.t("底部")},{value:"bottomright",text:r.t("右下角")}],(e,t,A)=>{u.info("设置当前Qmsg弹出位置"+A);},r.t("Toast显示在页面九宫格的位置")),de(r.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,r.t("限制Toast显示的数量")),S(r.t("逆序弹出"),"qmsg-config-showreverse",false,void 0,r.t("修改Toast弹出的顺序"))]}]},de(r.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(e,t,A)=>{u.info("改变语言："+A),r.changeLanguage(t);})]},{text:"",type:"forms",forms:[{text:r.t("账号/密码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[ke(r.t("账号"),"user","",void 0,void 0,r.t("请输入账号")),ke(r.t("密码"),"pwd","",void 0,void 0,r.t("请输入密码"),false,true),ke(r.t("secret"),"secret","","两步验证（2FA）",void 0,r.t("请输入secret"),false,true)]},{text:"",type:"forms",forms:[S(r.t("自动登录"),"autoLogin",true,void 0,r.t("自动登录当前保存的账号")),fe(r.t("清空账号/密码"),void 0,r.t("点击清空"),void 0,void 0,false,"default",e=>{if(confirm(r.t("确定清空账号和密码？"))){m.deleteValue("user"),m.deleteValue("pwd"),g.success(r.t("已清空账号/密码"));let t=e.target.getRootNode();t.querySelector('li[data-key="user"] .pops-panel-input input').value="",t.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}})]}]},{text:r.t("功能"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[de(r.t("固定当前语言"),"language-selector-locale","",(function(){let e=[{value:"",text:r.t("无")}];return c.ready(()=>{X("select.language-selector-locale option").forEach(t=>{let A=t.getAttribute("value");if(A==="help")return;let n=c.text(t).trim();e.push({value:A,text:n});});}),e})()),S(r.t("修复图片宽度显示问题"),"fixImageWidth",true,void 0,r.t("修复图片在移动端宽度超出浏览器宽度问题")),S(r.t("优化图片浏览"),"optimizeImageBrowsing",true,void 0,r.t("使用Viewer浏览图片")),S(r.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",true,void 0,r.t("配合上面的【优化图片浏览】更优雅浏览图片")),S(r.t("添加【操作面板】按钮"),"scripts-addOperationPanelBtnWithNavigator",true,void 0,r.t("在脚本列表页面时为顶部导航栏添加【操作面板】按钮")),S(r.t("给Markdown添加【复制】按钮"),"addMarkdownCopyButton",true,void 0,r.t("在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容"))]},{text:r.t("检测页面加载"),type:"forms",forms:[S(r.t("启用"),"checkPage",true,void 0,r.t("检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面")),de(r.t("检测间隔"),"greasyfork-check-page-timeout",5,(()=>{let e=[];for(let t=0;t<5;t++)e.push({value:t+1,text:t+1+"s"});return e})(),void 0,r.t("设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面"))]}]},{type:"deepMenu",text:r.t("表单"),forms:[{type:"forms",text:"",forms:[S(r.t("记住回复内容"),"rememberReplyContent",true,void 0,r.t("监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复")),de(r.t("自动清理空间"),"gf-autoClearRememberReplayContent",7,[{text:r.t("不清理"),value:-1},{text:r.t("{{value}} 天",{value:1}),value:1},{text:r.t("{{value}} 周",{value:1}),value:7},{text:r.t("{{value}} 个月",{value:1}),value:30},{text:r.t("{{value}} 个月",{value:2}),value:60},{text:r.t("{{value}} 个月",{value:3}),value:90},{text:r.t("半年"),value:180}],void 0,r.t("根据设置的间隔时间自动清理保存的回复内容")),fe(r.t("数据占用空间：{{size}}",{size:r.t("计算中")}),r.t("当前存储的数据所占用的空间大小"),r.t("清空"),void 0,void 0,void 0,"default",async()=>{await Ee.clearAllRememberReplyContent()?g.success(r.t("清理成功")):g.error(r.t("清理失败"));},async(e,t)=>{let A=t.ulElement.querySelector('li[data-key="gf-autoClearRememberReplayContent"]+li .pops-panel-item-left-main-text'),n=await Ee.getAllRememberReplyContent(),o="";n.length?o=h.getTextStorageSize(JSON.stringify(n)):o=h.getTextStorageSize(""),A.innerText=r.t("数据占用空间：{{size}}",{size:o});})]}]},{text:r.t("美化"),type:"deepMenu",forms:[{text:r.t("全局"),type:"forms",forms:[S(r.t("美化页面元素"),"beautifyPage",true,void 0,r.t("如button、input、textarea")),S(r.t("美化上传图片按钮"),"beautifyUploadImage",true,void 0,r.t("放大上传区域")),S(r.t("美化顶部导航栏"),"beautifyTopNavigationBar",true,void 0,r.t("可能会跟Greasyfork Beautify脚本有冲突")),S(r.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",false,void 0,r.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]},{type:"forms",text:r.t("脚本列表"),forms:[S(r.t("美化脚本列表"),"beautifyCenterContent",true,void 0,r.t("双列显示且添加脚本卡片操作项（安装、收藏）")),S("↑"+r.t("使用namespace查询脚本信息"),"beautifyCenterContent-queryNameSpace",true,void 0,r.t("开启后检测已安装的脚本信息更准确，但是速度会更慢"))]}]},{type:"deepMenu",text:r.t("自定义快捷键"),forms:[{type:"forms",text:"",forms:[Et(r.t("快捷键发表回复"),r.t("在输入框内按下快捷发表回复，例如：{{key}}",{key:"Ctrl + Enter"}),"gf-quickReply",{keyName:"Enter",keyValue:"13",ohterCodeList:["ctrl"]},r.t("点击录入快捷键"),void 0,He.shortCut)]}]},{text:r.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${r.t("帮助文档")}</a>`,type:"forms",forms:[S(r.t("启用"),"gf-scripts-filter-enable",true,void 0,r.t("作用域：脚本、脚本搜索、用户主页")),De(e=>{const t=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${r.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),A=t.querySelector("textarea");return A.value=ie.getValue(),c.on(A,["input","propertychange"],void 0,h.debounce(function(n){ie.setValue(A.value);},200)),e.appendChild(t),e})]}]}]},{type:"forms",text:r.t("脚本管理"),forms:[{type:"deepMenu",text:r.t("代码同步"),forms:[{text:r.t("代码同步"),type:"forms",forms:[fe(r.t("源代码同步【脚本列表】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",e=>{if(!Q.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_scriptList",true),K.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=K.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];X("#user-script-list-section li a.script-link").forEach(A=>{t=t.concat(j.getAdminUrl(A.href));}),K.updateScript(t);}),fe(r.t("源代码同步【未上架的脚本】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",e=>{if(!Q.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),K.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=K.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];X("#user-unlisted-script-list li a.script-link").forEach(A=>{t=t.concat(j.getAdminUrl(A.href));}),K.updateScript(t);}),fe(r.t("源代码同步【库】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",e=>{if(!Q.isUsers()){m.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),K.getUserLinkElement()?(g.success(r.t("前往用户主页")),window.location.href=K.getUserLinkElement().href):g.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];X("#user-library-script-list li a.script-link").forEach(A=>{t=t.concat(j.getAdminUrl(A.href));}),K.updateScript(t);})]}]},{type:"deepMenu",text:r.t("脚本列表"),forms:[],afterEnterDeepMenuCallBack(e,t){Ne.UIScriptList("script-list",t.sectionBodyContainer);}},{type:"deepMenu",text:r.t("库"),forms:[],afterEnterDeepMenuCallBack(e,t){Ne.UIScriptList("script-library",t.sectionBodyContainer);}}]}]},It={id:"greasy-fork-panel-config-scripts",title:r.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:r.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[S(r.t("添加复制代码按钮"),"addCopyCodeButton",true,void 0,r.t("更优雅的复制")),S(r.t("快捷键"),"fullScreenOptimization",true,void 0,r.t("【F】键全屏、【Alt+Shift+F】键宽屏")),S(r.t("修复代码行号显示"),"code-repairCodeLineNumber",false,void 0,r.t("修复代码行数超过1k行号显示不全问题")),S("monacoEditor","code-use-monaco-editor",true,void 0,r.t("使用Monaco编辑器"))]}]},{text:r.t("历史版本"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[S(r.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",true,void 0,r.t("在版本下面添加【安装】、【查看代码】按钮")),S(r.t("添加代码对比按钮"),"scripts-versions-addCompareCodeButton",true,void 0,r.t("monacoEditor"))]},{text:r.t("美化"),type:"forms",forms:[S(r.t("美化历史版本页面"),"beautifyHistoryVersionPage",true,void 0,r.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[S(r.t("添加【寻找引用】按钮"),"addFindReferenceButton",true,void 0,r.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),S(r.t("添加【收藏】按钮"),"addCollectionButton",true,void 0,r.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),S(r.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",true,void 0,r.t("在脚本信息栏添加【今日检查】信息块"))]}]}]}]},Ot={id:"greasy-fork-panel-config-script-search",title:r.t("搜索"),forms:[{type:"forms",text:"搜素结果过滤",forms:[S(r.t("新增【关键词】搜索框"),"gf-script-search-addFilterSearchInput",true,void 0,r.t("输入自定义关键词后自动执行过滤")),S(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("名称")}),"gf-script-search-filterScriptTitleWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),S(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("描述")}),"gf-script-search-filterScriptDescWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),S(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("名称/描述")}),"gf-script-search-filterScriptTitleOrDescWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),S(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("作者名称")}),"gf-script-search-filterScriptAuthorNameWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本"))]}]},Tt={id:"greasy-fork-panel-config-discussions",title:r.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[De(e=>{const t="discussions-readBgColor",A=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`

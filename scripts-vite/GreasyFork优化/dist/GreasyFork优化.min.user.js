...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof st=="function"?st(t.keyName):"";typeof e=="string"&&e?dt(e):et.addLinkNode(t.url);},async addLinkNode(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,u.ready(()=>{document.head.appendChild(e);}),e},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t}},lt={getInstallUrl(t,e,r){return m.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${t}/${e}${r}.user.js`},getCodeUrl(t,e){return m.isNull(e)&&(e=""),`https://greasyfork.org/scripts/${t}/code?version=${e}`},getScriptInfoUrl(t){return `https://greasyfork.org/scripts/${t}.json`}},Rt={init(){h.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),h.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){d.info("美化 历史版本 页面");let t=[];return t.push(v(qt)),t.push(et.addBlockCSS(".version-number",".version-date",".version-changelog")),u.ready(function(){let e=document.querySelector("ul.history_versions");if(!e){f.error(n.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(r=>{var g,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(g=r.querySelector(".version-date"))==null?void 0:g.getAttribute("datetime"),s=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=u.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),c=u.createElement("div",{className:"script-tag",innerHTML:`
		...
		`});u.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("添加中...")),c=await x.getUserCollectionInfo(e,s);if(!c){l.close();return}let p=m.cloneFormData(c),g=m.cloneFormData(c),y=!1;for(const[T,E]of c.entries())if(T==="scripts-included[]"&&String(E).trim()===String(t).trim()){y=!0;break}else g.append(T,E),p.append(T,E);if(y){f.warning(n.t("该脚本已经在该收藏集中")),l.close();return}p.set("add-script",t.toString()),p.set("script-action","i"),g.append("scripts-included[]",t.toString()),g.set("save","1");let w=new URLSearchParams(p),b=new URLSearchParams(g),k=Array.from(w).map(([T,E])=>`${encodeURIComponent(T)}=${encodeURIComponent(E)}`).join("&"),I=Array.from(b).map(([T,E])=>`${encodeURIComponent(T)}=${encodeURIComponent(E)}`).join("&");d.info(["添加的数据",k]),d.info(["保存的数据",I]);let M=await x.updateUserSetsInfo(e,s,k);if(!M){l.close();return}let C=M.querySelector(".change-script-set");if(!C){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let A=C.querySelector("section");if(!A){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let q=A.querySelector(".alert");q?V.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:q.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					...
					`,drag:!0,dragLimit:!0,width:V.isPhone()?"88vw":"400px",height:V.isPhone()?"50vh":"300px"}):(await x.updateUserSetsInfo(e,s,I),f.success(n.t("添加成功"))),l.close();}),u.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("删除中...")),c=await x.getUserCollectionInfo(e,s);if(!c){l.close();return}let p=new FormData,g=new FormData,y=!1;for(const[C,A]of c.entries()){if(String(C).trim()==="scripts-included[]"&&String(A).trim()===String(t).trim()){y=!0;continue}g.append(C,A),p.append(C,A);}if(!y){f.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:t})),l.close();return}p.set("remove-scripts-included[]",t.toString()),p.set("remove-selected-scripts","i"),p.delete("script-action"),g.set("save","1");let w=new URLSearchParams(p),b=new URLSearchParams(g),k=Array.from(w).map(([C,A])=>`${encodeURIComponent(C)}=${encodeURIComponent(A)}`).join("&"),I=Array.from(b).map(([C,A])=>`${encodeURIComponent(C)}=${encodeURIComponent(A)}`).join("&");if(d.info(["删除的数据",k]),d.info(["保存的数据",I]),!await x.updateUserSetsInfo(e,s,k)){l.close();return}await x.updateUserSetsInfo(e,s,I),f.success(n.t("删除成功")),l.close();});},Ot={init(){U.isCode()?zt.init():U.isVersion()&&Rt.init(),U.isCodeStrict()&&(h.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),h.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),h.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),h.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),h.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){d.info("添加收藏按钮"),m.waitNode("ul#script-links li.current span").then(()=>{let t=u.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});u.append(document.querySelector("ul#script-links"),t),u.on(t,"click",()=>{let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){d.error([e,window.location.pathname]),f.error(n.t("获取脚本id失败"));return}let r=e[e.length-1];bt(r);});});},fullScreenOptimization(){d.info("F11全屏，F键代码全屏"),v(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
...
`,ot={getTampermonkey:()=>{var t;return (t=_.external)==null?void 0:t.Tampermonkey},getViolentmonkey:()=>{var t;return (t=_.external)==null?void 0:t.Violentmonkey},getScriptCat:()=>{var t;return (t=_.external)==null?void 0:t.Scriptcat},getScriptContainerStatus(){var e,r,i;let t={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (e=_.external)!=null&&e.Tampermonkey&&(t.Tampermonkey=!0),(r=_.external)!=null&&r.Violentmonkey&&(t.Violentmonkey=!0),(i=_.external)!=null&&i.Scriptcat&&(t.ScriptCat=!0),t},getInstalledVersion(t,e){return new Promise((r,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(t,e,function(l){l.installed?r(l.version):r(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(t,e).then(r);return}const s=this.getScriptCat();if(s){s.isInstalled(t,e,function(l){l.installed?r(l.version):r(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(t,e){if(t===e)return 0;const r=t.split("."),i=e.split(".");for(let o=0;o<r.length;o++){const a=this.compareVersionPart(r[o],i[o]);if(a!==0)return a}return 0},compareVersionPart(t,e){const r=this.parseVersionPart(t),i=this.parseVersionPart(e);for(let o=0;o<r.length;o++){if(r[o].length>0&&i[o].length===0)return -1;if(r[o].length===0&&i[o].length>0||r[o]>i[o])return 1;if(r[o]<i[o])return -1}return 0},parseVersionPart(t){if(!t)return [0,"",0,""];const e=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(t);return [e[1]?parseInt(e[1]):0,e[2],e[3]?parseInt(e[3]):0,e[4]]},handleInstallResult(t,e,r){if(e!=null)switch(t.removeAttribute("data-ping-url"),this.compareVersions(e,r)){case-1:t.textContent=t.getAttribute("data-update-label");break;case 1:t.textContent=t.getAttribute("data-downgrade-label");break;case 0:t.textContent=t.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(t,e){const r=t.getAttribute("data-script-name"),i=t.getAttribute("data-script-namespace"),o=t.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(r,i);return a==null?!1:(this.handleInstallResult(t,a,o),!0)}catch{if(e){await m.sleep(1e3);try{return await this.checkForUpdatesJS(t,!1)}catch{}}return !1}},checkForUpdatesCSS(t){const e=t.getAttribute("data-script-name"),r=t.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:e,namespace:r,url:location.href},location.origin);}},xt=t=>{let e=t.dataset;const r={scriptId:parseInt(e.scriptId),scriptName:e.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(e.scriptDailyInstalls),scriptTotalInstalls:parseInt(e.scriptTotalInstalls),scriptRatingScore:parseFloat(e.scriptRatingScore),scriptCreatedDate:new Date(e.scriptCreatedDate),scriptUpdatedDate:new Date(e.scriptUpdatedDate),scriptType:e.scriptType,scriptVersion:e.scriptVersion,sensitive:e.sensitive==="true",scriptLanguage:e.scriptLanguage,cssAvailableAsJs:e.cssAvailableAsJs==="true",codeUrl:e.codeUrl,scriptDescription:e.scriptDescription,scriptAuthorId:parseInt(e.scriptAuthorId),scriptAuthorName:e.scriptAuthorName};let i=m.toJSON(e.scriptAuthors);if(Object.keys(i).forEach(o=>{let a=i[o];r.scriptAuthors.push({authorId:parseInt(o),authorName:a});}),(r.scriptAuthorName==null||isNaN(r.scriptAuthorId))&&r.scriptAuthors.length&&(r.scriptAuthorName=r.scriptAuthors[0].authorName,r.scriptAuthorId=r.scriptAuthors[0].authorId),r.scriptDescription==null){let o=t.querySelector(".script-description")||t.querySelector(".description");o&&(r.scriptDescription=o.innerText||o.textContent);}return r},wt={init(){h.execMenuOnce("gf-scripts-filter-enable",()=>{H.init();}),h.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){d.info("美化脚本列表");let t=[];return t.push(v(Pt)),$.ready(async()=>{H.getElementList().forEach(a=>{if(a.querySelector(".script-list-operation"))return;let s=xt(a),l=a.querySelector(".inline-script-stats"),c=s.codeUrl,p=$.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${n.t("评分")}</span>`}),g=$.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${s.scriptRatingScore}</span>`},{"data-position":"right"}),y=a.querySelector("dd.script-list-ratings .good-rating-count"),w=a.querySelector("dd.script-list-ratings .ok-rating-count"),b=a.querySelector("dd.script-list-ratings .bad-rating-count");if(y&&w&&b){let T=parseInt(y.innerText),E=parseInt(w.innerText),z=parseInt(b.innerText),R=T+E+z;R>=10?T/R>=.6?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count"):R==0||T>E+z?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count");}let k=$.createElement("dt",{className:"script-list-version",innerHTML:`<span>${n.t("版本")}</span>`}),I=$.createElement("dd",{className:"script-list-version",innerHTML:`<span>${s.scriptVersion}</span>`},{"data-position":"right"}),M=$.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${n.t("操作")}</span>`}),C=$.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),A=C.querySelector(".script-collect-btn"),q=C.querySelector(".install-link");if(q["data-script-info"]=s,q.classList.add("lum-lightbox-loader"),s.scriptType==="library"&&q.remove(),$.on(A,"click",T=>{m.preventEvent(T),bt(s.scriptId);}),h.getValue("gf-scripts-filter-enable")){let T=$.createElement("button",{className:"script-filter-btn",innerHTML:n.t("过滤")}),E="data-filter-key",z="data-filter-value";$.on(T,"click",R=>{m.preventEvent(R);let O=V.alert({title:{text:n.t("选择需要过滤的选项"),position:"center"},content:{text:`
								...
								`}),J=O.$shadowRoot.querySelector(".pops-alert-content");s.scriptAuthors.forEach(F=>{let W=$.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:F.authorId})});W.setAttribute(E,"scriptAuthorId"),W.setAttribute(z,"^"+F.authorId+"$");let Z=$.createElement("button",{innerHTML:n.t("作者名：{{text}}",{text:F.authorName})});Z.setAttribute(E,"scriptAuthorName"),Z.setAttribute(z,"^"+m.parseStringToRegExpString(F.authorName)+"$"),J.appendChild(W),J.appendChild(Z);}),$.on(O.$shadowRoot,"click",`button[${E}]`,F=>{m.preventEvent(F);let W=F.target,Z=W.getAttribute(E),St=W.getAttribute(z);H.addValue(Z,St),O.close(),H.filter(),f.success(n.t("添加成功"));});}),C.appendChild(T);}l.appendChild(p),l.appendChild(g),l.appendChild(k),l.appendChild(I),l.appendChild(M),l.appendChild(C);});let r=Array.from(document.querySelectorAll(".install-link[data-install-format=js]")),i=ot.getScriptContainerStatus(),o=Object.values(i).filter(Boolean);if(!i.Tampermonkey)r.forEach(async a=>{let s=await ot.checkForUpdatesJS(a,!0);a.classList.remove("lum-lightbox-loader"),s||(a.textContent=n.t("安装此脚本"));});else if(o.length)for(let a=0;a<r.length;a++){let s=r[a],l=s["data-script-info"],c=await N.get(lt.getScriptInfoUrl(l.scriptId),{fetch:!0});if(!c.status){s.textContent=n.t("安装此脚本");continue}let p=m.toJSON(c.data.responseText);s.setAttribute("data-script-namespace",p.namespace);let g=await ot.checkForUpdatesJS(s,!0);s.classList.remove("lum-lightbox-loader"),g||(s.textContent=n.t("安装此脚本")),await m.sleep(150);}else d.error("未知的脚本容器");}),t}},H={key:"gf-shield-rule",init(){d.info("脚本过滤");let t=new m.LockFunction(()=>{this.filter();},50);u.ready(()=>{m.mutationObserver(document.body,{config:{subtree:!0,childList:!0},callback:()=>{t.run();}}),t.run();});},getElementList(){let t=[];return t=t.concat(Array.from(document.querySelectorAll("ol.script-list li"))),t},filter(){this.getElementList().forEach(t=>{let e=xt(t),r=this.getValue().split(`
...
`,re={init(){h.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),h.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),h.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),h.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){d.info("美化页面元素");let t=[];return t.push(v(Kt)),t.push(v(Jt)),t.push(v(Zt)),t.push(v(Yt)),t.push(v(Qt)),t.push(v(`
			p:has(input[type="submit"][name="update-and-sync"]){
			  margin-top: 10px;
			}
			`)),u.ready(function(){let e=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');e&&e.parentElement.replaceChild(u.createElement("span",{textContent:"Markdown"}),e),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&t.push(v(`
					.indented{
						padding-left: unset;
					}
					`));}),t},beautifyGreasyforkBeautify(){d.info("美化 Greasyfork Beautify脚本");let t=[];return t.push(v(te)),m.isPhone()?t.push(v(`
				section#script-info,
        ...
        `);},addShortcutOperationButton(){d.info("添加快捷操作按钮"),G.getElementList().forEach(t=>{if(t.querySelector(".discussion-filter-button"))return;let r=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=u.createElement("div",{className:"discussion-meta-item",innerHTML:`
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(t);}),e.appendChild(r);});}},K={init(){h.execMenu("checkPage",()=>{this.checkPage();}),re.init(),yt.init(),U.isScript()&&Ot.init(),(U.isScriptList()||U.isScriptLibraryList()||U.isScriptCodeSearch())&&wt.init(),U.isDiscuessions()&&ie.init(),U.isUserHome()&&oe.init(),h.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),u.ready(()=>{L.initEnv(),ne.init(),L.handleLocalGotoCallBack(),h.execMenuOnce("fixImageWidth",()=>{K.fixImageWidth();}),K.languageSelectorLocale(),h.execMenuOnce("optimizeImageBrowsing",()=>{K.optimizeImageBrowsing();}),h.execMenuOnce("overlayBedImageClickEvent",()=>{K.overlayBedImageClickEvent();}),U.isCodeStrict()||h.execMenuOnce("addMarkdownCopyButton",()=>{K.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(d.info("修复图片显示问题"),v(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){d.info("优化图片浏览"),v(st("ViewerCSS")),v(`

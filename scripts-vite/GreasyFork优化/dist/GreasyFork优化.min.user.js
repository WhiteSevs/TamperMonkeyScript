...
(function (g, T, ae, Ce, r, He, Ge) {
  ...
  const He__namespace = /*#__PURE__*/_interopNamespaceDefault(He);

  const d=new Set;const qe = async t=>{d.has(t)||(d.add(t),(a=>{function r(n){if(typeof GM_addStyle=="function")return GM_addStyle(n);let e=document.createElement("style");if(e.setAttribute("type","text/css"),e.setAttribute("data-type","gm-css"),globalThis.trustedTypes){const l=globalThis.trustedTypes.createPolicy("safe-innerHTML",{createHTML:i=>i});e.innerHTML=l.createHTML(n);}else e.innerHTML=n;return (document.head||document.documentElement).appendChild(e),e}r(a);})(t));};

  var ge=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,ke=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,_=typeof GM_getValue<"u"?GM_getValue:void 0,pe=typeof GM_info<"u"?GM_info:void 0,we=typeof GM_listValues<"u"?GM_listValues:void 0,Ve=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,J=typeof GM_setValue<"u"?GM_setValue:void 0,Te=typeof GM_setValues<"u"?GM_setValues:void 0,Fe=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Ye=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,H=typeof unsafeWindow<"u"?unsafeWindow:void 0,Ze=window;const $={waitRemove(...e){e.forEach(t=>{typeof t=="string"&&T.waitNodeList(t).then(A=>{A.forEach(n=>n.remove());});});},createBlockCSSNode(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(A=>{Array.isArray(A)?t=t.concat(A):t.push(A);}),T.createElement("style",{type:"text/css",innerHTML:`${t.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof ke=="function"?ke(e.keyName):null;return typeof t=="string"&&t?I(t):$.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(A=>{T.ready(()=>{document.head.appendChild(t),A(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(A=>{t.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
			.pops-overflow-hidden-important {
				overflow: hidden !important;
			}
		`;let A=[document.documentElement,document.body].concat(...e||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(n){navigator.clipboard.readText().then(o=>{n(o);}).catch(o=>{u.error("读取剪贴板内容失败👉",o),n("");});}function t(n){navigator.permissions.query({name:"clipboard-read"}).then(o=>{e(n);}).catch(o=>{u.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),e(n);});}function A(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!A()){n("");return}document.hasFocus()?t(n):window.addEventListener("focus",()=>{t(n);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,A=5e3){let n,o=A-t,a=t,i=async s=>{let l=await e(s);if(typeof l=="boolean"&&!l||s){h.workerClearTimeout(n);return}if(a+=t,a>o){i(true);return}n=h.workerSetTimeout(()=>{i(false);},t);};i(false);},findParentNode(e,t,A){if(A){let n=T.closest(e,A);if(n)return n.querySelector(t)}else return T.matches(e,t)?e:T.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(n,o)=>o===void 0?t:o,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},ce={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},h=ae.noConflict(),c=T.noConflict(),U=Ce,u=new h.Log(pe,H.console||Ze.console);let xe=pe?.script?.name||void 0;const We=Ce.config.Utils.AnyTouch(),Je=false;u.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});g.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.getSetting().type;if(t==="loading")return  false;const A=e.getSetting().content;return t==="warning"?u.warn(A):t==="error"?u.error(A):u.info(A),true},get position(){return m.getValue(ce.qmsg_config_position.key,ce.qmsg_config_position.defaultValue)},get maxNums(){return m.getValue(ce.qmsg_config_maxnums.key,ce.qmsg_config_maxnums.defaultValue)},get showReverse(){return m.getValue(ce.qmsg_config_showreverse.key,ce.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=ae.getMaxZIndex(),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100}});U.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=ae.getMaxZIndex(void 0,void 0,A=>{if(A?.classList?.contains("qmsg-shadow-container")||A?.closest("qmsg")&&A.getRootNode()instanceof ShadowRoot)return  false}),t=Ce.config.InstanceUtils.getPopsMaxZIndex().zIndex;return ae.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Ne=new h.GM_Menu({GM_getValue:_,GM_setValue:J,GM_registerMenuCommand:Ve,GM_unregisterMenuCommand:Fe}),q=new h.Httpx({xmlHttpRequest:Ye,logDetails:Je});q.interceptors.request.use(e=>e);q.interceptors.response.use(void 0,e=>(u.error("拦截器-请求错误",e),e.type==="onabort"?g.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?g.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?g.error("请求超时",{consoleLogContent:true}):g.error("其它错误",{consoleLogContent:true}),e));H.Object.defineProperty,H.Function.prototype.apply,H.Function.prototype.call,H.Element.prototype.appendChild,H.setTimeout;const I=c.addStyle.bind(c),N=T.selector.bind(T),X=T.selectorAll.bind(T);new h.GM_Cookie;const ve="GM_Panel",Ee="data-init",he="data-key",me="data-default-value",$e="data-init-more-value",se="data-storage-api",W={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},Y={setting:{get width(){return W.width<550?"88vw":W.width<700?"550px":"700px"},get height(){return W.height<450?"70vh":W.height<550?"450px":"550px"}},settingMiddle:{get width(){return W.width<350?"88vw":"350px"},get height(){return W.height<450?"88vh":"450px"}},settingBig:{get width(){return W.width<800?"92vw":"800px"},get height(){return W.height<600?"80vh":"600px"}},info:{get width(){return W.width<350?"88vw":"350px"},get height(){return W.height<250?"88vh":"250px"}}};class _e{storageKey;listenerData;constructor(t){if(typeof t=="string"){const A=t.trim();if(A=="")throw new Error("key参数不能为空字符串");this.storageKey=A;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new ae.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let t=_(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){J(this.storageKey,t);}set(t,A){const n=this.get(t),o=this.getLocalValue();Reflect.set(o,t,A),this.setLocalValue(o),this.triggerValueChangeListener(t,n,A);}get(t,A){const n=this.getLocalValue();return Reflect.get(n,t)??A}getAll(){return this.getLocalValue()}delete(t){const A=this.get(t),n=this.getLocalValue();Reflect.deleteProperty(n,t),this.setLocalValue(n),this.triggerValueChangeListener(t,A,void 0);}has(t){const A=this.getLocalValue();return Reflect.has(A,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(A=>Reflect.get(t,A))}clear(){ge(this.storageKey);}addValueChangeListener(t,A){const n=Math.random(),o=this.listenerData.get(t)||[];return o.push({id:n,key:t,callback:A}),this.listenerData.set(t,o),n}removeValueChangeListener(t){let A=false;for(const[n,o]of this.listenerData.entries()){for(let a=0;a<o.length;a++){const i=o[a];(typeof t=="string"&&i.key===t||typeof t=="number"&&i.id===t)&&(o.splice(a,1),a--,A=true);}this.listenerData.set(n,o);}return A}async triggerValueChangeListener(...t){const[A,n,o]=t;if(!this.listenerData.has(A))return;let a=this.listenerData.get(A);for(let i=0;i<a.length;i++){const s=a[i];if(typeof s.callback=="function"){let l=this.get(A),d,f;typeof n<"u"&&t.length>=2?f=n:f=l,typeof o<"u"&&t.length>2?d=o:d=l,await s.callback(A,f,d);}}}}const ne=new _e(ve),Le={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new h.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const A=(a,i)=>{typeof i!="string"&&(i=$.toStr(i));const s=new Blob([i]),l=globalThis.URL.createObjectURL(s);c.createElement("a",{href:l,download:a}).click(),h.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},n=()=>{const a=p=>{const v=U.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="local">本地导入</div>
            <div class="btn-control" data-mode="network">网络导入</div>
            <div class="btn-control" data-mode="clipboard">剪贴板导入</div>`,html:true},btn:{ok:{enable:false},close:{enable:true,callback(O,z){O.close();}}},drag:true,mask:{enable:true},width:Y.info.width,height:Y.info.height,style:`
          .btn-control{
          ...
          }`}),y=v.$shadowRoot.querySelector(".btn-control[data-mode='local']"),x=v.$shadowRoot.querySelector(".btn-control[data-mode='network']"),C=v.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),E=async O=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof we=="function"?typeof ge=="function"?(we().forEach(w=>{ge(w);}),g.success("已清空脚本存储的配置")):g.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):g.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Te=="function"?Te(O):Object.keys(O).forEach(w=>{const b=O[w];J(w,b);}),g.success("配置导入完毕");},M=O=>new Promise(async z=>{const k=h.toJSON(O);Object.keys(k).length===0?g.warning("解析为空配置，不导入"):await E(k),z(true);});c.on(y,"click",O=>{c.preventEvent(O),v.close();const z=c.createElement("input",{type:"file",accept:".json"});c.on(z,["propertychange","input"],k=>{if(!z.files?.length)return;const w=z.files[0],b=new FileReader;b.onload=()=>{M(b.result);},b.readAsText(w,"UTF-8");}),z.click();}),c.on(x,"click",O=>{c.preventEvent(O),v.close();const z=U.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(b,R){b.close();}},ok:{text:"导入",callback:async(b,R)=>{const D=b.text;if(h.isNull(D)){g.error("请填入完整的url");return}const L=g.loading("正在获取配置..."),P=await q.get(D,{allowInterceptConfig:false});if(L.close(),!P.status){u.error(P),g.error("获取配置失败",{consoleLogContent:true});return}await M(P.data.responseText)&&b.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:Y.info.width,height:"auto"}),k=z.$shadowRoot.querySelector("input"),w=z.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(k,["input","propertychange"],b=>{c.val(k)===""?c.attr(w,"disabled","true"):c.removeAttr(w,"disabled");}),c.listenKeyboard(k,"keydown",(b,R,D)=>{b==="Enter"&&D.length===0&&c.val(k)!==""&&c.trigger(w,"click");}),c.trigger(k,"input");}),c.on(C,"click",async O=>{c.preventEvent(O),v.close();let z=await $.getClipboardText();if(z.trim()===""){g.warning("获取到的剪贴板内容为空");return}await M(z);});},i=(p=`${xe}_panel-setting-${h.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,v)=>{const y=U.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(E,M){E.close();}}},drag:true,mask:{enable:true},width:Y.info.width,height:Y.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(p,v){a();}},cancel:{enable:true,text:"导出",callback(p,v){i(void 0,f);}}},width:W.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),d={};if(typeof we=="function")we().forEach(v=>{const y=_(v);Reflect.set(d,v,y);});else {g.warning("不支持函数GM_listValues，仅导出菜单配置");const p=_(ve);Reflect.set(d,ve,p);}const f=$.toStr(d);l.value=f;},o=()=>{let a=pe?.script?.supportURL||pe?.script?.namespace;typeof a=="string"&&h.isNotNull(a)&&window.open(a,"_blank");};return [{id:"script-version",title:`版本：${pe?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(){return  false},afterRender(a){new We(a.$asideLiElement).on("tap",function(s){clearTimeout(t),t=void 0,e?(e=false,n()):(t=setTimeout(()=>{e=false,o();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},Qe={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{m.showPanel(Le.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){m.isTopWindow()&&Ne.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let A=this.$data.menuOption.findIndex(n=>n.key===t.key);A!==-1&&(this.$data.menuOption[A]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},m={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new h.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new h.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new h.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new h.Dictionary),this.__onceExecData},get scriptName(){return xe},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ve,attributeKeyName:he,attributeDefaultValueName:me},init(){this.initContentDefaultValue(),Qe.init();},isTopWindow(){return H.top===H.self},initContentDefaultValue(){const e=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;const o=n.attributes;let a=o[Ee];if(typeof a=="function"){let d=a();if(typeof d=="boolean"&&!d)return}let i=new Map,s=o[he];if(s!=null){const d=o[me];i.set(s,d);}let l=o[$e];if(typeof l=="object"&&l&&Object.keys(l).forEach(d=>{i.set(d,l[d]);}),!i.size){u.warn(["请先配置键",n]);return}if(n.type==="switch"){let d=typeof n.disabled=="function"?n.disabled():n.disabled;typeof d=="boolean"&&d&&this.$data.contentConfigInitDisabledKeys.push(...i.keys());}for(const[d,f]of i.entries())this.setDefaultValue(d,f);},t=n=>{for(let o=0;o<n.length;o++){let a=n[o];e(a);let i=a.forms;i&&Array.isArray(i)&&t(i);}},A=[...Le.getAllContentConfig()];for(let n=0;n<A.length;n++){let o=A[n];if(!o.forms)continue;const a=o.forms;a&&Array.isArray(a)&&t(a);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&u.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){ne.set(e,t);},getValue(e,t){const A=ne.get(e);return A??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){ne.delete(e);},hasKey(e){return ne.has(e)},addValueChangeListener(e,t){return ne.addValueChangeListener(e,(n,o,a)=>{t(e,a,o);})},removeValueChangeListener(e){ne.removeValueChangeListener(e);},triggerMenuValueChange(e,t,A){ne.triggerValueChangeListener(e,A,t);},async exec(e,t,A,n=true){const o=this;let a;typeof e=="string"||Array.isArray(e)?a=()=>e:a=e;let i=false;const s=a();let l=[];Array.isArray(s)?(i=true,l=s):l.push(s);const d=l.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(d){u.warn(`${d} 键不存在`);return}const f=JSON.stringify(l);if(n&&this.$data.onceExecMenuData.has(f))return this.$data.onceExecMenuData.get(f);let p=[];const v=[];let y=[];const x=(w,b)=>{let R=[],D=[],L=[];if(Array.isArray(b))L=L.concat(b);else if(typeof b=="object"&&b!=null)if(b instanceof Element)L.push(b);else {const{$css:P,destory:B}=b;P!=null&&(Array.isArray(P)?L=L.concat(P):L.push(P)),typeof B=="function"&&L.push(B);}else L.push(b);for(const P of L)if(P!=null){if(P instanceof Element){R.push(P);continue}if(typeof P=="function"){y.push(P);continue}}w?(p=p.concat(R),y=y.concat(D)):(E(),M());},C=w=>!!this.getValue(w),E=()=>{for(let w=0;w<p.length;w++)p[w]?.remove(),p.splice(w,1),w--;},M=()=>{for(let w=0;w<y.length;w++){const b=y[w];b(),y.splice(w,1),w--;}},O=()=>{let w=false;return typeof A=="function"?w=A(l):w=l.every(b=>C(b)),w},z=async w=>{if(O()){const R=l.map(L=>this.getValue(L)),D=await t({value:i?R:R[0],addStoreValue:(...L)=>x(true,L)});x(true,D);}else x(false,[]);};n&&l.forEach(w=>{const b=this.addValueChangeListener(w,(R,D,L)=>z());v.push(b);}),await z();const k={reload(){this.clearStoreStyleElements(),this.destory(),z();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>E(),destory(){return M()},removeValueChangeListener:()=>{v.forEach(w=>{this.removeValueChangeListener(w);});},clearOnceExecMenuData(){n&&o.$data.onceExecMenuData.delete(f);}};return this.$data.onceExecMenuData.set(f,k),k},async execMenu(e,t,A=false,n=false){return await this.exec(e,async o=>await t(o),o=>o.every(i=>{let s=!!this.getValue(i);return m.$data.contentConfigInitDisabledKeys.includes(i)&&(s=false,u.warn(`.execMenu${n?"Once":""} ${i} 被禁用`)),A&&(s=!s),s}),n)},async execMenuOnce(e,t,A=false,n=false){const o=await this.execMenu(e,t,A,true);if(n&&o){const a=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,a);}return o},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),ne.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async triggerUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const A of t)await A(e);},showPanel(e,t=`${xe}-设置`,A=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let o=e.findIndex(i=>(typeof i.isBottom=="function"?i.isBottom():!!i.isBottom)&&i.id==="script-version")!==-1;!A&&!o&&e.push(...Le.getDefaultBottomContentConfig());let a=U.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(i,s)=>{i.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(i,s)=>{i(),this.$data.$panel=null;}},width:Y.setting.width,height:Y.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a,this.$data.panelContent=e,n||this.registerConfigSearch({$panel:a,content:e});},registerConfigSearch(e){const{$panel:t,content:A}=e,n=async(v,y)=>{if(v==null)return;const x=await y(v);return x&&typeof x.isFind=="boolean"&&x.isFind?x.data:await n(x.data,y)},o=(v,y)=>{const x=new IntersectionObserver(C=>{C.forEach(E=>{E.isIntersecting&&(y?.(),x.disconnect());});},{root:null,threshold:1});x.observe(v),v.scrollIntoView({behavior:"smooth",block:"center"});},a=v=>{const y="pops-flashing";c.animationend(v,()=>{v.classList.remove(y);}),v.classList.add(y);},i=v=>{if(v.type==="dblclick"&&p)return;c.preventEvent(v),l=null;const y=U.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});y.$shadowRoot.querySelector(".search-wrapper");const x=y.$shadowRoot.querySelector(".search-config-text"),C=y.$shadowRoot.querySelector(".search-result-wrapper");x.focus();const E=()=>{c.empty(C);},M=z=>{const k=h.queryProperty(z,b=>b?.next?{isFind:false,data:b.next}:{isFind:true,data:b}),w=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return c.on(w,"click",b=>{const D=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[z.index];if(!D){g.error(`左侧项下标${z.index}不存在`);return}D.scrollIntoView({behavior:"smooth",block:"center"}),D.click(),n(z.next,async L=>{if(L?.next){const P=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(B=>{const V=Reflect.get(B,"__formConfig__");return typeof V=="object"&&V!=null&&V.text===L.name}),2500);if(P)P.click();else return g.error("未找到对应的二级菜单"),{isFind:true,data:L};return {isFind:false,data:L.next}}else {const P=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(B=>Reflect.get(B,"__formConfig__")===L.matchedData?.formConfig),2500);if(P){o(P);const B=P.closest(".pops-panel-forms-fold[data-fold-enable]");B&&(B.querySelector(".pops-panel-forms-fold-container").click(),await h.sleep(500)),o(P,()=>{a(P);});}else g.error("未找到对应的菜单项");return {isFind:true,data:L}}});}),w},O=z=>{const k=new RegExp(z,"i"),w=[],b=(D,L)=>{for(let P=0;P<D.length;P++){const B=D[P],V=B.forms;if(V&&Array.isArray(V)){const te=h.deepClone(L);if(B.type==="deepMenu"){const ie=h.queryProperty(te,F=>F?.next?{isFind:false,data:F.next}:{isFind:true,data:F});ie.next={name:B.text};}b(V,te);}else {const te=Reflect.get(B,"text"),ie=Reflect.get(B,"description"),F=[te,ie],Ae=F.findIndex(Z=>{if(typeof Z=="string")return Z.match(k)});if(Ae!==-1){const Z=h.deepClone(L),ye=h.queryProperty(Z,re=>re?.next?{isFind:false,data:re.next}:{isFind:true,data:re});ye.next={name:te,matchedData:{path:"",formConfig:B,matchedText:F[Ae],description:ie}};const Oe=[];h.queryProperty(Z,re=>{const Pe=re?.name;return typeof Pe=="string"&&Pe.trim()!==""&&Oe.push(Pe),re?.next?{isFind:false,data:re.next}:{isFind:true,data:re}});const Xe=Oe.join($.escapeHtml(" - "));ye.next.matchedData.path=Xe,w.push(Z);}}}};for(let D=0;D<A.length;D++){const L=A[D];if(!L.forms||L.isBottom&&L.id==="script-version")continue;const P=L.forms;if(P&&Array.isArray(P)){let B=L.title;typeof B=="function"&&(B=B()),b(P,{index:D,name:B});}}const R=document.createDocumentFragment();for(const D of w){let L=M(D);R.appendChild(L);}E(),C.append(R);};c.on(x,"input",h.debounce(z=>{c.preventEvent(z);let k=c.val(x).trim();if(k===""){E();return}O(k);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(v=>{c.on(v,"dblclick",i);});let l=null,d=false,f,p=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(v,y)=>{p=true,clearTimeout(f),f=void 0,d&&l===y?(d=false,l=null,i(v)):(f=setTimeout(()=>{d=false;},200),d=true,l=y);},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`,ft="",Q={isHome(){return window.location.pathname.split("/").length<=2&&window.location.search===""},isCode(){return !!window.location.pathname.split("/")?.includes("code")},isCodeStrict(){return !!window.location.pathname.match(/\/code(\/|)$/)},isVersion(){return !!window.location.pathname.match(/\/versions(\/|)$/)},isUsers(){return !!window.location.pathname.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!window.location.pathname.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!window.location.pathname.match(/\/conversations\/[\d]+/)},isScript(){return !!window.location.pathname.match(/\/scripts\/[\d+]/)},isScriptAdmin(){return !!window.location.pathname.endsWith("/admin")},isScriptList(){return !!window.location.pathname.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!window.location.pathname.match("/scripts/by-site")},isScriptsFeedback(){return this.isScript()&&window.location.pathname.match(/\/feedback(\/|)$/i)},isScriptLibraryList(){return !!window.location.pathname.match(/\/libraries(\/|)$/)},isScriptSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptList()&&e.has("q")},isScriptCodeSearch(){return !!window.location.pathname.match(/\/code-search(\/|)$/)},isScriptLibraryListSearch(){let e=new URLSearchParams(window.location.search);return this.isScriptLibraryList()&&e.has("q")},isDiscuessions(){return !!window.location.pathname.match(/\/discussions(\/|)$/)},isImageSource(){return window.location.pathname.startsWith("/vite/assets")}},pt={init(){m.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),m.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),m.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),m.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let e=[];return e.push(I(nt)),e.push(I(ot)),e.push(I(it)),e.push(I(at)),e.push(I(st)),e.push(I(`
			...
			`)),c.ready(()=>{let t=N('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(c.createElement("span",{textContent:"Markdown"}),t),X(".user-content ul li").forEach(o=>{let a=o.firstChild;a?.nodeName==="#text"&&(a.textContent?.startsWith("[x] ")?(a.textContent=a.textContent.replace("[x] ",""),c.prepend(o,`
				...
				section#script-info{
					margin-top: 10px;
				}`)),e},beautifyUploadImage(){u.info("美化上传图片");let e=[];return e.push(I(lt)),c.ready(()=>{function t(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let A=X('input[type="file"]');A.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||c.on(o,["propertychange","input"],function(a){t(a.target);let i=a.currentTarget.files;if(!i||i.length===0)return;u.info("选择的图片",i),i.length>5&&c.after(o,c.createElement("p",{textContent:r.t("❌ 最多同时长传5张图片")}));let s=[];Array.from(i).forEach(l=>{(l.size>204800||!l.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&s.push(l);}),s.length!==0&&s.forEach(l=>{c.after(o,c.createElement("p",{textContent:r.t("❌ 图片：{{name}} 大小：{{size}}",{name:l.name,size:l.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{c.on(o,"paste",a=>{u.info("触发粘贴事件",a),setTimeout(()=>{c.trigger(A,"input");},100);});});}),e},beautifyTopNavigationBar(){u.info("美化顶部导航栏");let e=[];return e.push(I(dt)),window.outerWidth>550&&(e.push($.addBlockCSS(".with-submenu")),c.ready(()=>{let A=N("#site-nav").querySelector("nav");X(".with-submenu nav li").forEach(n=>{A.appendChild(n);});})),e}},K={menu:Ne,isLogin:false,initEnv(){let e=this.getUserLinkElement();this.isLogin=!!e;},getUserLinkElement(){return N("#nav-user-info span.user-profile-link a")},async updateScript(e){let t=function(A,n=1){return `
...
`),h.isNull(e))return;e=e.toString().trim();let n=e+"##"+t;A+=n,this.setValue(A);},getValue(){return m.getValue(this.key,"")}},vt={init(){this.readBgColor(),c.ready(()=>{m.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),I(`
      ...
      `);const e=new h.LockFunction(()=>{const t=m.getValue("discussions-addShortcutOperationButton"),A=m.getValue("discussions-addReportButton");t&&this.addFilterButton(),A&&this.addReportButton(),(t||A)&&this.addMoreButton({addFilterButton:t,addReportButton:A});});h.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{e.run();}});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),ee.init();},readBgColor(){u.info("设置已读背景颜色");let e=m.getValue("discussions-readBgColor");return I(`
        .discussion-read{
            background: ${e} !important;
        }
        `)},addFilterButton(){const e="discussion-filter-button";ee.getElementList().forEach(t=>{if(t.querySelector(`.${e}`))return;let n=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),o=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="${e}">${r.t("过滤")}</button>
					`},{style:"flex: 0;","data-type":"filter"}),a=o.querySelector(`.${e}`);n.appendChild(o),c.on(a,"click",i=>{c.preventEvent(i);const s=ee.parseDiscuessionListContainerInfo(t);if(!s)return;let l="data-filter-key",d="data-filter-value",f=U.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:false},content:{text:`
				...
				`});c.append(document.head||document.documentElement,o),c.on(H,A,()=>{let a=H.monaco;u.success("网络加载monaco编辑器成功"),n.close(),e(a);},{once:true});})}},ht={init(){m.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();}),m.execMenuOnce("code-use-monaco-editor",()=>{this.coverEditorWithMonaco();});},repairCodeLineNumber(){u.info("修复代码的行号显示不够问题"),m.execMenuOnce("beautifyGreasyforkBeautify",()=>{I(`
...
`,yt={init(){m.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),m.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),m.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let e=[];return e.push(I(mt)),e.push($.addBlockCSS(".version-number",".version-date",".version-changelog")),c.ready(function(){let t=N("ul.history_versions");if(!t){g.error(r.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(A=>{let n=A.querySelector(".version-number a").href,o=A.querySelector(".version-number a").innerText,a=A.querySelector(".version-date")?.getAttribute("datetime"),i=A.querySelector(".version-changelog")?.innerHTML||"",s=c.createElement("span",{className:"script-version-date",innerHTML:h.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),l=c.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
						...
						`});c.after(e,l);});});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),De.monacoEditor().then(e=>{c.ready(()=>{X('#script-content form[action*="/diff"] input[type="submit"]').forEach(t=>{let A=c.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});c.after(t,A),c.on(A,"click",async n=>{c.preventEvent(n);let o=t.closest("form"),a=new FormData(o),i=a.get("v1"),s=a.get("v2");if(i===s){g.warning(r.t("版本号相同，不需要比较源码"));return}let l=g.loading(r.t("正在获取对比文本中...")),d=j.getScriptId(),f=await G.getScriptInfo(d);if(!f){l.close();return}let p=f.code_url,v=p.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${i}`),y=p.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${s}`),x="",C="";const[E,M]=await Promise.all([q.get(v,{timeout:2e4}),q.get(y,{timeout:2e4})]);if(l.close(),!E.status||!M.status)return;x=E.data.responseText,C=M.data.responseText;let{recovery:O}=$.lockScroll(),z=U.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
								<div class="monaco-editor-diff-container">
									<div class="monaco-editor-diff"></div>
								</div>
								`},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},btn:{ok:{enable:false},close:{callback(D,L){D.close(),O();}}},zIndex(){let D=h.getMaxZIndex(),L=U.config.InstanceUtils.getPopsMaxZIndex().zIndex;return h.getMaxValue(D,L)+100},useShadowRoot:false,width:"90vw",height:"90vh",drag:true,style:`
...
`),h.isNull(e))return;e=e.toString().trim();let n=e+"##"+t;A+=n,this.setValue(A);},getValue(){return m.getValue(this.key,"")}},bt=`.sidebarred-main-content {\r
  max-width: unset;\r
  flex: unset;\r
}\r
ol.script-list {\r
...
`,ze={getTampermonkey:()=>H.external?.Tampermonkey,getViolentmonkey:()=>H.external?.Violentmonkey,getScriptCat:()=>H.external?.Scriptcat,getScriptContainerStatus(){let e={Tampermonkey:false,Violentmonkey:false,ScriptCat:false};return H.external?.Tampermonkey&&(e.Tampermonkey=true),H.external?.Violentmonkey&&(e.Violentmonkey=true),H.external?.Scriptcat&&(e.ScriptCat=true),e},getRegisterScriptContainerNameList(){let t=this.getScriptContainerStatus(),A=[];return Object.keys(t).forEach(n=>{Reflect.get(t,n)&&A.push(n);}),A},getInstalledVersion(e,t){return new Promise((A,n)=>{const o=this.getTampermonkey();if(o){o.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(e,t).then(A);return}const i=this.getScriptCat();if(i){i.isInstalled(e,t,function(s){s.installed?A(s.version):A(null);});return}n(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(e,t){if(e===t)return 0;const A=e.split("."),n=t.split(".");for(let o=0;o<A.length;o++){const a=this.compareVersionPart(A[o],n[o]);if(a!==0)return a}return 0},compareVersionPart(e,t){const A=this.parseVersionPart(e),n=this.parseVersionPart(t);for(let o=0;o<A.length;o++){if(A[o].length>0&&n[o].length===0)return  -1;if(A[o].length===0&&n[o].length>0||A[o]>n[o])return 1;if(A[o]<n[o])return  -1}return 0},parseVersionPart(e){if(!e)return [0,"",0,""];const t=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(e);return [t[1]?parseInt(t[1]):0,t[2],t[3]?parseInt(t[3]):0,t[4]]},handleInstallResult(e,t,A){if(t!=null)switch(e.removeAttribute("data-ping-url"),this.compareVersions(t,A)){case  -1:e.textContent=e.getAttribute("data-update-label");break;case 1:e.textContent=e.getAttribute("data-downgrade-label");break;case 0:e.textContent=e.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(e,t){const A=e.getAttribute("data-script-name"),n=e.getAttribute("data-script-namespace"),o=e.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(A,n);return a==null?!1:(this.handleInstallResult(e,a,o),!0)}catch{if(t){await h.sleep(1e3);try{return await this.checkForUpdatesJS(e,!1)}catch{}}return  false}},checkForUpdatesCSS(e){const t=e.getAttribute("data-script-name"),A=e.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:t,namespace:A,url:location.href},location.origin);}},Ke={init(){m.execMenuOnce("gf-scripts-filter-enable",()=>{oe.init();}),m.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let e=[];e.push(I(bt));const t="lum-lightbox-loader",A=r.t("安装此脚本");return T.ready(()=>{let n=ze.getScriptContainerStatus(),o=Object.values(n).find(d=>d),a=ze.getRegisterScriptContainerNameList(),i=m.getValue("beautifyCenterContent-queryNameSpace");o?u.info("当前暴露的external信息："+a.map(d=>`【${d}】`).join("、")):u.error("脚本容器未暴露external信息",window.external);let s=new h.LockFunction(()=>{oe.getElementList().forEach(f=>{if(f.querySelector(".script-list-operation"))return;let p=le.parseScriptListInfo(f),v=f.querySelector(".inline-script-stats");if(!v)return;let y=p.codeUrl,x=T.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),C=T.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${p.scriptRatingScore}</span>`},{"data-position":"right"}),E=f.querySelector("dd.script-list-ratings .good-rating-count"),M=f.querySelector("dd.script-list-ratings .ok-rating-count"),O=f.querySelector("dd.script-list-ratings .bad-rating-count");if(E&&M&&O){let L=parseInt(E.innerText),P=parseInt(M.innerText),B=parseInt(O.innerText),V=L+P+B;V>=10?L/V>=.6?C.classList.add("good-rating-count"):C.classList.add("bad-rating-count"):V==0||L>P+B?C.classList.add("good-rating-count"):C.classList.add("bad-rating-count");}let z=T.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),k=T.createElement("dd",{className:"script-list-version",innerHTML:`<span>${p.scriptVersion}</span>`},{"data-position":"right"}),w=T.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),b=T.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),R=b.querySelector(".script-collect-btn"),D=b.querySelector(".install-link");if(D["data-script-info"]=p,T.addClass(D,t),p.scriptType==="library"&&D.remove(),T.on(R,"click",L=>{T.preventEvent(L),Ue(p.scriptId);}),m.getValue("gf-scripts-filter-enable")){let L=T.createElement("button",{className:"script-filter-btn",innerHTML:r.t("过滤")}),P="data-filter-key",B="data-filter-value";T.on(L,"click",V=>{T.preventEvent(V);let te=U.alert({title:{text:r.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${P}="scriptId" ${B}="^${p.scriptId}$">${r.t("脚本id：{{text}}",{text:p.scriptId})}</button>
									<button ${P}="scriptName" ${B}="^${h.toRegExpStr(p.scriptName)}$">${r.t("脚本名：{{text}}",{text:p.scriptName})}</button>
								...
								`}),ie=te.$shadowRoot.querySelector(".pops-alert-content");p.scriptAuthors.forEach(F=>{let Ae=T.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:F.authorId})});Ae.setAttribute(P,"scriptAuthorId"),Ae.setAttribute(B,"^"+F.authorId+"$");let Z=T.createElement("button",{innerHTML:r.t("作者名：{{text}}",{text:F.authorName})});Z.setAttribute(P,"scriptAuthorName"),Z.setAttribute(B,"^"+h.toRegExpStr(F.authorName)+"$"),ie.appendChild(Ae),ie.appendChild(Z);}),T.on(te.$shadowRoot,"click",`button[${P}]`,F=>{T.preventEvent(F);let Ae=F.target,Z=Ae.getAttribute(P),ye=Ae.getAttribute(B);oe.addValue(Z,ye),te.close(),oe.filter(),g.success(r.t("添加成功"));});}),b.appendChild(L);}v.appendChild(x),v.appendChild(C),v.appendChild(z),v.appendChild(k),v.appendChild(w),v.appendChild(b);});},100),l=new h.LockFunction(async()=>{let d=Array.from(X(".install-link[data-install-format=js]:not([gm-is-check-install-status])"));for(let f=0;f<d.length;f++){const p=d[f];p.setAttribute("gm-is-check-install-status","");let v=Reflect.get(p,"data-script-info");if(o){if(i){let y=await G.getScriptInfo(v.scriptId);y&&p.setAttribute("data-script-namespace",y.namespace);}ze.checkForUpdatesJS(p,true).then(y=>{T.removeClass(p,t),y||T.text(p,A);});}else T.removeClass(p,t),T.text(p,A);}});h.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{s.run(),l.run();}});}),e}},xt={init(){m.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),m.execMenuOnce("gf-scripts-filter-enable",()=>{oe.init();}),m.execMenuOnce("beautifyCenterContent",()=>Ke.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),$.addBlockCSS("#about-user"),c.ready(()=>{let e=N("#about-user");if(!e){u.error("#about-user元素不存在");return}e=e.cloneNode(true),le.registerTopNavMenu({name:r.t("控制台"),className:"scripts-console",clickEvent(t){U.alert({title:{text:r.t("控制台"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:Y.setting.width,height:Y.setting.height,zIndex:h.getMaxZIndex(100),style:`
						#about-user{
							border: 0;
							box-shadow: none;
						}
...
`,Pt={init(){m.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),c.ready(()=>{m.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return u.info("美化对话框"),I(Ct)},beautifyPrivateMessageList(){u.info("美化私信列表"),I(`
		...
		`),c.ready(()=>{N("#site-nav nav"),N("#site-nav .with-submenu nav");let e=N("#script-list-option-groups")||N(".list-option-groups");if(!e){u.warn("不存在右侧面板元素#script-list-option-groups");return}e=e.cloneNode(true),e.classList.add("option-panel-groups"),le.registerTopNavMenu({name:r.t("操作面板"),className:"filter-scripts",clickEvent(t){U.alert({title:{text:r.t("操作面板"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:Y.setting.width,height:Y.setting.height,zIndex:h.getMaxZIndex(100),style:`
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(e);}});});}},Mt={init(){},showView(){let e=U.alert({title:{text:r.t("Url To WebhookUrl"),position:"center"},content:{text:`
...
`);});}},fe=function(e,t,A,n,o,a,i,s,l,d){let f={text:e,type:"button",attributes:{},props:{},description:t,buttonIcon:n,buttonIsRightIcon:o,buttonIconIsLoading:a,buttonType:i,buttonText:A,callback(p){typeof s=="function"&&s(p);},afterAddToUListCallBack:l};return Reflect.set(f.attributes,Ee,()=>{f.disable=false;}),f},Ie={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new ae.Dictionary),this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t);},initComponentsStorageApi(e,t,A){let n;this.hasStorageApi(e)?n=this.getStorageApi(e):n=A,this.setComponentsStorageApiProperty(t,n);},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,se,t);}},Me=function(e,t,A,n,o,a="",i,s,l,d){let f={text:e,type:"input",isNumber:!!i,isPassword:!!s,attributes:{},props:{},description:n,afterAddToUListCallBack:l,getValue(){return this.props[se].get(t,A)},callback(p,v,y){this.props[se].set(t,v);},placeholder:a};return Reflect.set(f.attributes,he,t),Reflect.set(f.attributes,me,A),Ie.initComponentsStorageApi("input",f,{get(p,v){return m.getValue(p,v)},set(p,v){m.setValue(p,v);}}),f},S=function(e,t,A,n,o,a,i,s){let l={text:e,type:"switch",description:o,disabled:i,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f){let p=!!f;u.success(`${p?"开启":"关闭"} ${e}`),this.props[se].set(t,p);},afterAddToUListCallBack:a};return Reflect.set(l.attributes,he,t),Reflect.set(l.attributes,me,A),Ie.initComponentsStorageApi("switch",l,{get(d,f){return m.getValue(d,f)},set(d,f){m.setValue(d,f);}}),l},de=function(e,t,A,n,o,a,i){let s=[];typeof n=="function"?s=n():s=n;let l={text:e,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[se].get(t,A)},callback(d,f,p){let v=f;if(u.info(`选择：${p}`),typeof o=="function"&&o(d,v,p))return;this.props[se].set(t,v);},data:s};return Reflect.set(l.attributes,he,t),Reflect.set(l.attributes,me,A),Ie.initComponentsStorageApi("select",l,{get(d,f){return m.getValue(d,f)},set(d,f){m.setValue(d,f);}}),l},kt=function(e,t,A,n,o,a="default",i){let s=typeof o=="function"?o():o;typeof n=="object"&&i.initConfig(A,n);let l=()=>i.getShowText(A,s),d=fe(e,t,l,"keyboard",false,false,a,async f=>{let v=f.target.closest(".pops-panel-button")?.querySelector("span");if(i.isWaitPress){g.warning("请先执行当前的录入操作");return}if(i.hasOptionValue(A))i.emptyOption(A),g.success("清空快捷键");else {let y=g.loading("请按下快捷键...",{showClose:true,onClose(){i.cancelEnterShortcutKeys();}}),{status:x,option:C,key:E}=await i.enterShortcutKeys(A);y.close(),x?(u.success(["成功录入快捷键",C]),g.success("成功录入")):g.error(`快捷键 ${i.translateKeyboardValueToButtonText(C)} 已被 ${E} 占用`);}v.innerHTML=l();});return d.attributes={},Reflect.set(d.attributes,Ee,()=>false),d},je={async UIScriptList(e,t){if(!K.isLogin){g.error(r.t("请先登录账号！"));return}let o=K.getUserLinkElement().href?.split("/")?.pop()?.match(/([0-9]+)/)?.[0],a=U.loading({mask:{enable:true},parent:t,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:false}),i=await G.getUserInfo(o);if(a.close(),!i)return;u.info(i);let s=e==="script-list"?i.scriptList:i.scriptLibraryList;g.success(r.t("获取成功，共 {{count}} 个",{count:s.length}));for(const l of s){let d=c.createElement("li",{className:"w-script-list-item",innerHTML:`
...
`;Qe.addMenuOption({key:"githubUrl2webhookUrl",text:"⚙ "+r.t("Url To WebhookUrl"),autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{Mt.showView();}});m.$data.panelConfig={style:Tt};Le.addContentConfig([St,Et,Dt,It,Ot]);m.init();ue.init();

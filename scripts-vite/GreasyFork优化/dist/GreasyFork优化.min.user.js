...
// @require            https://fastly.jsdelivr.net/npm/i18next@25.4.2/i18next.min.js
...
(function (v, O, it, yt, r, Rt, Xt) {
	...
	const Rt__namespace = /*#__PURE__*/_interopNamespaceDefault(Rt);

	const a=new Set;const Kt = async t=>{a.has(t)||(a.add(t),(n=>{function r(d){let e=document.createElement("style");if(e.setAttribute("type","text/css"),e.setAttribute("data-type","gm-css"),globalThis.trustedTypes){const l=globalThis.trustedTypes.createPolicy("safe-innerHTML",{createHTML:i=>i});e.innerHTML=l.createHTML(d);}else e.innerHTML=d;return (document.head||document.documentElement).appendChild(e),e}if(typeof GM_addStyle=="function"){GM_addStyle(n);return}r(n);})(t));};

	var Lt=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,Pt=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,_=typeof GM_getValue<"u"?GM_getValue:void 0,ft=typeof GM_info<"u"?GM_info:void 0,Ht=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,Z=typeof GM_setValue<"u"?GM_setValue:void 0,qt=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Gt=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,X=typeof unsafeWindow<"u"?unsafeWindow:void 0,Vt=window;const ot={waitRemove(...t){t.forEach(e=>{typeof e=="string"&&g.waitNodeList(e).then(A=>{A.forEach(n=>n.remove());});});},addBlockCSS(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(A=>{Array.isArray(A)?e=e.concat(A):e.push(A);}),M(`${e.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof Pt=="function"?Pt(t.keyName):null;typeof e=="string"&&e?M(e):ot.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,O.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(A=>{e.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let A=[document.documentElement,document.body].concat(...t||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(n){navigator.clipboard.readText().then(i=>{n(i);}).catch(i=>{u.error("读取剪贴板内容失败👉",i),n("");});}function e(n){navigator.permissions.query({name:"clipboard-read"}).then(i=>{t(n);}).catch(i=>{u.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),t(n);});}function A(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(n=>{if(!A()){n("");return}document.hasFocus()?e(n):window.addEventListener("focus",()=>{e(n);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,A=5e3){let n,i=A-e,a=e,o=async l=>{let s=await t(l);if(typeof s=="boolean"&&!s||l){g.workerClearTimeout(n);return}if(a+=e,a>i){o(true);return}n=g.workerSetTimeout(()=>{o(false);},e);};o(false);},findParentNode(t,e,A){if(A){let n=O.closest(t,A);if(n)return n.querySelector(e)}else return O.matches(t,e)?t:O.closest(t,e)}},lt={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},g=it.noConflict(),c=O.noConflict(),R=yt,u=new g.Log(ft,X.console||Vt.console);let Ct=ft?.script?.name||void 0;yt.config.Utils.AnyTouch();const Tt=false;u.config({debug:Tt,logMaxCount:1e3,autoClearConsole:true,tag:true});v.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(t){const e=t.getSetting().type;if(e==="loading")return  false;const A=t.getSetting().content;return e==="warning"?u.warn(A):e==="error"?u.error(A):u.info(A),true},get position(){return h.getValue(lt.qmsg_config_position.key,lt.qmsg_config_position.defaultValue)},get maxNums(){return h.getValue(lt.qmsg_config_maxnums.key,lt.qmsg_config_maxnums.defaultValue)},get showReverse(){return h.getValue(lt.qmsg_config_showreverse.key,lt.qmsg_config_showreverse.defaultValue)},get zIndex(){let t=it.getMaxZIndex(),e=yt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return it.getMaxValue(t,e)+100}});R.GlobalConfig.setGlobalConfig({zIndex:()=>{let t=it.getMaxZIndex(void 0,void 0,A=>{if(A?.classList?.contains("qmsg-shadow-container")||A?.closest("qmsg")&&A.getRootNode()instanceof ShadowRoot)return  false}),e=yt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return it.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Ot=new g.GM_Menu({GM_getValue:_,GM_setValue:Z,GM_registerMenuCommand:Ht,GM_unregisterMenuCommand:qt}),q=new g.Httpx({xmlHttpRequest:Gt,logDetails:Tt});q.interceptors.request.use(t=>t);q.interceptors.response.use(void 0,t=>(u.error("拦截器-请求错误",t),t.type==="onabort"?v.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?v.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?v.error("请求超时",{consoleLogContent:true}):v.error("其它错误",{consoleLogContent:true}),t));X.Object.defineProperty,X.Function.prototype.apply,X.Function.prototype.call,X.Element.prototype.appendChild,X.setTimeout;const M=g.addStyle.bind(g),T=O.selector.bind(O),K=O.selectorAll.bind(O);new g.GM_Cookie;const Mt="GM_Panel",kt="data-init",pt="data-key",gt="data-default-value",Ft="data-init-more-value",at="data-storage-api",$={setting:{get width(){return window.innerWidth<550?"88vw":window.innerWidth<700?"550px":"700px"},get height(){return window.innerHeight<450?"70vh":window.innerHeight<550?"450px":"550px"}},settingMiddle:{get width(){return window.innerWidth<350?"88vw":"350px"},get height(){return window.innerHeight<450?"88vh":"450px"}},settingBig:{get width(){return window.innerWidth<800?"92vw":"800px"},get height(){return window.innerHeight<600?"80vh":"600px"}},info:{get width(){return window.innerWidth<350?"88vw":"350px"},get height(){return window.innerHeight<250?"88vh":"250px"}}};class Yt{storageKey;listenerData;constructor(e){if(typeof e=="string"){let A=e.trim();if(A=="")throw new Error("key参数不能为空字符串");this.storageKey=A;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new it.Dictionary;}getLocalValue(){let e=_(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){Z(this.storageKey,e);}set(e,A){let n=this.get(e),i=this.getLocalValue();Reflect.set(i,e,A),this.setLocalValue(i),this.triggerValueChangeListener(e,n,A);}get(e,A){let n=this.getLocalValue();return Reflect.get(n,e)??A}getAll(){return this.getLocalValue()}delete(e){let A=this.get(e),n=this.getLocalValue();Reflect.deleteProperty(n,e),this.setLocalValue(n),this.triggerValueChangeListener(e,A,void 0);}has(e){let A=this.getLocalValue();return Reflect.has(A,e)}keys(){let e=this.getLocalValue();return Reflect.ownKeys(e)}values(){let e=this.getLocalValue();return Reflect.ownKeys(e).map(A=>Reflect.get(e,A))}clear(){Lt(this.storageKey);}addValueChangeListener(e,A){let n=Math.random(),i=this.listenerData.get(e)||[];return i.push({id:n,key:e,callback:A}),this.listenerData.set(e,i),n}removeValueChangeListener(e){let A=false;for(const[n,i]of this.listenerData.entries()){for(let a=0;a<i.length;a++){const o=i[a];(typeof e=="string"&&o.key===e||typeof e=="number"&&o.id===e)&&(i.splice(a,1),a--,A=true);}this.listenerData.set(n,i);}return A}triggerValueChangeListener(e,A,n){if(!this.listenerData.has(e))return;let i=this.listenerData.get(e);for(let a=0;a<i.length;a++){const o=i[a];if(typeof o.callback=="function"){let l=this.get(e),s,d;typeof A<"u"&&arguments.length>=2?d=A:d=l,typeof n<"u"&&arguments.length>2?s=n:s=l,o.callback(e,d,s);}}}}const rt=new Yt(Mt),mt={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new g.Dictionary),this.__contentConfig}},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){return [{id:"script-version",title:`版本：${ft?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(t,e,A){let n=ft?.script?.supportURL||ft?.script?.namespace;return typeof n=="string"&&g.isNotNull(n)&&window.open(n,"_blank"),false}}]}},Bt={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{h.showPanel(mt.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){h.isTopWindow()&&Ot.add(this.$data.menuOption);},addMenuOption(t){Array.isArray(t)||(t=[t]),this.$data.menuOption.push(...t);},updateMenuOption(t){Array.isArray(t)||(t=[t]),t.forEach(e=>{let A=this.$data.menuOption.findIndex(n=>n.key===e.key);A!==-1&&(this.$data.menuOption[A]=e);});},getMenuOption(t=0){return this.$data.menuOption[t]},deleteMenuOption(t=0){this.$data.menuOption.splice(t,1);}},h={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new g.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new g.Dictionary),this.__onceExecMenuData},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new g.Dictionary),this.__onceExecData},get scriptName(){return Ct},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:Mt,attributeKeyName:pt,attributeDefaultValueName:gt},init(){this.initContentDefaultValue(),Bt.init();},isTopWindow(){return X.top===X.self},initContentDefaultValue(){const t=n=>{if(!n.attributes||n.type==="button"||n.type==="forms"||n.type==="deepMenu")return;let i=new Map,a=n.attributes[pt];if(a!=null){const s=n.attributes[gt];i.set(a,s);}let o=n.attributes[Ft];if(typeof o=="object"&&o&&Object.keys(o).forEach(s=>{i.set(s,o[s]);}),!i.size){u.warn(["请先配置键",n]);return}let l=n.attributes[kt];if(typeof l=="function"){let s=l();if(typeof s=="boolean"&&!s)return}if(n.type==="switch"){let s=typeof n.disabled=="function"?n.disabled():n.disabled;typeof s=="boolean"&&s&&this.$data.contentConfigInitDisabledKeys.push(...i.keys());}for(const[s,d]of i.entries())this.setDefaultValue(s,d);},e=n=>{for(let i=0;i<n.length;i++){let a=n[i];t(a);let o=a.forms;o&&Array.isArray(o)&&e(o);}},A=[...mt.getAllContentConfig()];for(let n=0;n<A.length;n++){let i=A[n];if(!i.forms)continue;const a=i.forms;a&&Array.isArray(a)&&e(a);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(t,e){this.$data.contentConfigInitDefaultValue.has(t)&&u.warn("请检查该key(已存在): "+t),this.$data.contentConfigInitDefaultValue.set(t,e);},setValue(t,e){rt.set(t,e);},getValue(t,e){let A=rt.get(t);return A??(this.$data.contentConfigInitDefaultValue.has(t)?this.$data.contentConfigInitDefaultValue.get(t):e)},deleteValue(t){rt.delete(t);},hasKey(t){return rt.has(t)},addValueChangeListener(t,e){return rt.addValueChangeListener(t,(n,i,a)=>{e(t,a,i);})},removeValueChangeListener(t){rt.removeValueChangeListener(t);},triggerMenuValueChange(t,e,A){rt.triggerValueChangeListener(t,A,e);},exec(t,e,A,n=true){const i=this;let a;typeof t=="string"||Array.isArray(t)?a=()=>t:a=t;let o=false,l=a(),s=[];Array.isArray(l)?(o=true,s=l):s.push(l);let d=s.find(w=>!this.$data.contentConfigInitDefaultValue.has(w));if(d){u.warn(`${d} 键不存在`);return}let p=JSON.stringify(s);if(n){if(this.$data.onceExecMenuData.has(p))return;this.$data.onceExecMenuData.set(p,1);}let f=[],m=[],y=(w,C)=>{let z=[];Array.isArray(C)||(C=[C]),C.forEach(j=>{if(j!=null&&j instanceof HTMLStyleElement){z.push(j);return}}),f=f.concat(z);},P=w=>this.getValue(w),b=()=>{for(let w=0;w<f.length;w++)f[w].remove(),f.splice(w,1),w--;},N=()=>{let w=false;return typeof A=="function"?w=A(s):w=s.every(C=>P(C)),w},k=w=>{let C=N(),z=[];if(C){let j=s.map(L=>this.getValue(L)),D=e({value:o?j:j[0],addStyleElement:(...L)=>y(true,...L)});Array.isArray(D)||(D=[D]),D.forEach(L=>{if(L!=null&&L instanceof HTMLStyleElement){z.push(L);return}});}b(),f=[...z];};return n&&s.forEach(w=>{let C=this.addValueChangeListener(w,(z,j,D)=>{k();});m.push(C);}),k(),{clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),n&&i.$data.onceExecMenuData.delete(p);},clearStoreStyleElements:()=>b(),removeValueChangeListener:()=>{m.forEach(w=>{this.removeValueChangeListener(w);});}}},execMenu(t,e,A=false,n=false){return this.exec(t,i=>e(i),i=>i.every(o=>{let l=!!this.getValue(o);return h.$data.contentConfigInitDisabledKeys.includes(o)&&(l=false,u.warn(`.execMenu${n?"Once":""} ${o} 被禁用`)),A&&(l=!l),l}),n)},execMenuOnce(t,e,A=false){return this.execMenu(t,e,A,true)},deleteExecMenuOnce(t){return this.$data.onceExecMenuData.delete(t),rt.removeValueChangeListener(t)},onceExec(t,e){if(t=this.transformKey(t),typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},deleteOnceExec(t){t=this.transformKey(t),this.$data.onceExecData.delete(t);},showPanel(t,e=`${Ct}-设置`,A=false,n=false){this.$data.$panel=null,this.$data.panelContent=[];let i=t.findIndex(o=>(typeof o.isBottom=="function"?o.isBottom():!!o.isBottom)&&o.id==="script-version")!==-1;!A&&!i&&t.push(...mt.getDefaultBottomContentConfig());let a=R.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(o,l)=>{o.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(o,l)=>{o(),this.$data.$panel=null;}},width:$.setting.width,height:$.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=a,this.$data.panelContent=t,n||this.registerConfigSearch({$panel:a,content:t});},registerConfigSearch(t){const{$panel:e,content:A}=t;let n=async(p,f)=>{if(p==null)return;let m=await f(p);return m&&typeof m.isFind=="boolean"&&m.isFind?m.data:await n(m.data,f)},i=(p,f)=>{const m=new IntersectionObserver(y=>{y.forEach(P=>{P.isIntersecting&&(f?.(),m.disconnect());});},{root:null,threshold:1});m.observe(p),p.scrollIntoView({behavior:"smooth",block:"center"});},a=p=>{const f="pops-flashing";c.animationend(p,()=>{p.classList.remove(f);}),p.classList.add(f);},o=(p,f)=>{g.preventEvent(p);let m=R.alert({title:{text:"搜索配置",position:"center"},content:{text:`
						<div class="search-wrapper">
							<input class="search-config-text" name="search-config" type="text" placeholder="请输入需要搜素的配置名称">
						</div>
						<div class="search-result-wrapper"></div>
					`,html:true},btn:{ok:{enable:false}},mask:{clickEvent:{toClose:true}},width:$.settingMiddle.width,height:"auto",drag:true,style:`
				...
				`});m.$shadowRoot.querySelector(".search-wrapper");let y=m.$shadowRoot.querySelector(".search-config-text"),P=m.$shadowRoot.querySelector(".search-result-wrapper");y.focus();let b=()=>{c.empty(P);},N=Q=>{const w=g.queryProperty(Q,z=>z?.next?{isFind:false,data:z.next}:{isFind:true,data:z});let C=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return c.on(C,"click",z=>{let D=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[Q.index];if(!D){v.error(`左侧项下标${Q.index}不存在`);return}D.scrollIntoView({behavior:"smooth",block:"center"}),D.click(),n(Q.next,async L=>{if(L?.next){let E=await g.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(I=>{const H=Reflect.get(I,"__formConfig__");return typeof H=="object"&&H!=null&&H.text===L.name}),2500);if(E)E.click();else return v.error("未找到对应的二级菜单"),{isFind:true,data:L};return {isFind:false,data:L.next}}else {let E=await g.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(I=>Reflect.get(I,"__formConfig__")===L.matchedData?.formConfig),2500);if(E){i(E);let I=E.closest(".pops-panel-forms-fold[data-fold-enable]");I&&(I.querySelector(".pops-panel-forms-fold-container").click(),await g.sleep(500)),i(E,()=>{a(E);});}else v.error("未找到对应的菜单项");return {isFind:true,data:L}}});}),C},k=Q=>{const w=new RegExp(Q,"i"),C=[],z=(D,L)=>{for(let E=0;E<D.length;E++){const I=D[E];let H=I.forms;if(H&&Array.isArray(H)){const F=g.deepClone(L);if(I.type==="deepMenu"){const tt=g.queryProperty(F,W=>W?.next?{isFind:false,data:W.next}:{isFind:true,data:W});tt.next={name:I.text};}z(H,F);}else {let F=Reflect.get(I,"text"),tt=Reflect.get(I,"description");const W=[F,tt];let Y=W.findIndex(V=>{if(typeof V=="string")return V.match(w)});if(Y!==-1){const V=g.deepClone(L),et=g.queryProperty(V,At=>At?.next?{isFind:false,data:At.next}:{isFind:true,data:At});et.next={name:F,matchedData:{path:"",formConfig:I,matchedText:W[Y],description:tt}};const vt=[];g.queryProperty(V,At=>{const wt=At?.name;return typeof wt=="string"&&wt.trim()!==""&&vt.push(wt),At?.next?{isFind:false,data:At.next}:{isFind:true,data:At}});const Ut=vt.join(ot.escapeHtml(" - "));et.next.matchedData.path=Ut,C.push(V);}}}};for(let D=0;D<A.length;D++){const L=A[D];if(!L.forms||L.isBottom&&L.id==="script-version")continue;const E=L.forms;if(E&&Array.isArray(E)){let I=L.title;typeof I=="function"&&(I=I()),z(E,{index:D,name:I});}}let j=document.createDocumentFragment();for(const D of C){let L=N(D);j.appendChild(L);}b(),P.append(j);};c.on(y,"input",g.debounce(Q=>{g.preventEvent(Q);let w=c.val(y).trim();if(w===""){b();return}k(w);},200));},l=null,s=false,d;c.on(e.$shadowRoot,"dblclick","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",o),c.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(p,f)=>{clearTimeout(d),d=void 0,s&&l===f?(s=false,l=null,o(p)):(d=setTimeout(()=>{s=false;},200),s=true,l=f);},{capture:true}),e.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`,se="",B={isHome(){return window.location.pathname.split("/").length<=2&&window.location.search===""},isCode(){return !!window.location.pathname.split("/")?.includes("code")},isCodeStrict(){return !!window.location.pathname.match(/\/code(\/|)$/)},isVersion(){return !!window.location.pathname.match(/\/versions(\/|)$/)},isUsers(){return !!window.location.pathname.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!window.location.pathname.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!window.location.pathname.match(/\/conversations\/[\d]+/)},isScript(){return !!window.location.pathname.match(/\/scripts\/[\d+]/)},isScriptAdmin(){return !!window.location.pathname.endsWith("/admin")},isScriptList(){return !!window.location.pathname.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!window.location.pathname.match("/scripts/by-site")},isScriptsFeedback(){return this.isScript()&&window.location.pathname.match(/\/feedback(\/|)$/i)},isScriptLibraryList(){return !!window.location.pathname.match(/\/libraries(\/|)$/)},isScriptSearch(){let t=new URLSearchParams(window.location.search);return this.isScriptList()&&t.has("q")},isScriptCodeSearch(){return !!window.location.pathname.match(/\/code-search(\/|)$/)},isScriptLibraryListSearch(){let t=new URLSearchParams(window.location.search);return this.isScriptLibraryList()&&t.has("q")},isDiscuessions(){return !!window.location.pathname.match(/\/discussions(\/|)$/)},isImageSource(){return window.location.pathname.startsWith("/vite/assets")}},le={init(){h.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),h.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),h.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),h.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){u.info("美化页面元素");let t=[];return t.push(M(_t)),t.push(M(te)),t.push(M(ee)),t.push(M(Ae)),t.push(M(re)),t.push(M(`
			...
			`)),c.ready(()=>{let e=T('a[target="markup_choice"][href*="daringfireball.net"]');e&&e.parentElement.replaceChild(c.createElement("span",{textContent:"Markdown"}),e),K(".user-content ul li").forEach(i=>{let a=i.firstChild;a?.nodeName==="#text"&&(a.textContent?.startsWith("[x] ")?(a.textContent=a.textContent.replace("[x] ",""),c.prepend(i,`
				...
				section#script-info{
					margin-top: 10px;
				}`)),t},beautifyUploadImage(){u.info("美化上传图片");let t=[];return t.push(M(ne)),c.ready(()=>{function e(i){for(;i.nextElementSibling;)i.parentElement.removeChild(i.nextElementSibling);}let A=K('input[type="file"]');A.forEach(i=>{i.getAttribute("name")!=="code_upload"&&(i.hasAttribute("accept")&&i.getAttribute("accept").includes("javascript")||c.on(i,["propertychange","input"],function(a){e(a.target);let o=a.currentTarget.files;if(!o||o.length===0)return;u.info("选择的图片",o),o.length>5&&c.after(i,c.createElement("p",{textContent:r.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(o).forEach(s=>{(s.size>204800||!s.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(s);}),l.length!==0&&l.forEach(s=>{c.after(i,c.createElement("p",{textContent:r.t("❌ 图片：{{name}} 大小：{{size}}",{name:s.name,size:s.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(i=>{c.on(i,"paste",a=>{u.info("触发粘贴事件",a),setTimeout(()=>{c.trigger(A,"input");},100);});});}),t},beautifyTopNavigationBar(){u.info("美化顶部导航栏");let t=[];return t.push(M(ie)),window.outerWidth>550&&(t.push(ot.addBlockCSS(".with-submenu")),c.ready(()=>{let A=T("#site-nav").querySelector("nav");K(".with-submenu nav li").forEach(n=>{A.appendChild(n);});})),t}},U={menu:Ot,isLogin:false,initEnv(){let t=this.getUserLinkElement();this.isLogin=!!t;},getUserLinkElement(){return T("#nav-user-info span.user-profile-link a")},async updateScript(t){let e=function(A,n=1){return `
...
`);if(t.has(n.snippet)&&h.getValue("greasyfork-discussions-filter-duplicate-comments")){let a=t.get(n.snippet).querySelector("a.discussion-title");a.setAttribute("data-repeat-tip-show","true");let o=0;a.hasAttribute("data-repeat-count")&&(o=parseInt(a.getAttribute("data-repeat-count"))),o++,a.setAttribute("data-repeat-count",o.toString()),a.setAttribute("data-repeat-tip-show",r.t("已过滤：{{oldCount}}",{oldCount:o})),u.success([`过滤重复内容：${n.snippet}`,n]),e.remove();return}t.set(n.snippet,e);for(let a=0;a<i.length;a++){let o=i[a],l=o.split("##"),s=l[0],d=l[1];if(s in n){let p=new RegExp(d,"ig");if(n[s]!=null&&String(n[s]).match(p)){u.info("触发论坛过滤规则",o,n),e.remove();return}}}});},parseDiscuessionListContainerInfo(t){let e=t.querySelector("a.discussion-title");if(!e)return;let A=e.href,n=A.match(/\/discussions(|\/greasyfork)\/([\d]+)/);if(!n)return;let i=n[n.length-1];const a=t.querySelector(".discussion-meta-item-script-name"),o=a?.querySelector("a"),l=t.querySelector("a.user-link"),s={scriptName:a.innerText,scriptUrl:o?.href,scriptId:S.getScriptId(o?.href),postUserName:l?.innerText,postUserHomeUrl:l?.href,postUserId:S.getUserId(l?.href),postTimeStamp:new Date(t.querySelector("relative-time").getAttribute("datetime")),snippetId:i,snippetUrl:A,snippet:t.querySelector("span.discussion-snippet")?.innerText||"",replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};let d=t.querySelector(".discussion-meta-item .discussion-meta-item");if(d){const p=d.querySelector("a.user-link");s.replyUserName=p.innerText,s.replyUserHomeUrl=p.href,s.replyUserId=S.getUserId(s.replyUserHomeUrl),s.replyTimeStamp=new Date(d.querySelector("relative-time").getAttribute("datetime"));}return s},setValue(t){h.setValue(this.key,t);},addValue(t,e){let A=this.getValue();if(A.trim()!==""&&(A+=`
`),g.isNull(t))return;t=t.toString().trim();let n=t+"##"+e;A+=n,this.setValue(A);},getValue(){return h.getValue(this.key,"")}},de={init(){this.readBgColor(),c.ready(()=>{h.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();});let t=new g.LockFunction(()=>{h.execMenu("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();}),h.execMenu("discussions-addReportButton",()=>{this.addReportButton();});});g.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{t.run();}});});},filterEnable(){u.info("启用Greasyfork论坛过滤器"),J.init();},readBgColor(){u.info("设置已读背景颜色");let t=h.getValue("discussions-readBgColor");return M(`
        .discussion-read{
            background: ${t} !important;
        }
        `)},addShortcutOperationButton(){u.info("添加【过滤】按钮"),J.getElementList().forEach(t=>{if(t.querySelector(".discussion-filter-button"))return;let A=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-filter-button">${r.t("过滤")}</button>
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-filter-button");A.appendChild(n),c.on(i,"click",a=>{g.preventEvent(a);const o=J.parseDiscuessionListContainerInfo(t);if(!o)return;let l="data-filter-key",s="data-filter-value",d=R.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:false},content:{text:`
						...
						`}),p=d.$shadowRoot.querySelector(".pops-alert-content");if(o.scriptId==null&&p.querySelector(`button[${l}="scriptId"]`)?.remove(),o.scriptName==null&&p.querySelector(`button[${l}="scriptName"]`)?.remove(),o.postUserId==null&&p.querySelector(`button[${l}="postUserId"]`)?.remove(),o.replyUserId!=null){let f=c.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:o.replyUserId})});f.setAttribute(l,"scriptAuthorId"),f.setAttribute(s,"^"+o.replyUserId+"$"),p.appendChild(f);}c.on(d.$shadowRoot,"click",`button[${l}]`,f=>{g.preventEvent(f);let m=f.target,y=m.getAttribute(l),P=m.getAttribute(s);J.addValue(y,P),d.close(),J.filter(),v.success(r.t("添加成功"));});});});},addReportButton(){u.info("添加【举报】按钮"),J.getElementList().forEach(t=>{if(t.querySelector(".discussion-report-button"))return;let A=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=c.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-report-button pops-button--danger">${r.t("举报")}</button>
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-report-button");A.appendChild(n),c.on(i,"click",a=>{g.preventEvent(a);const o=J.parseDiscuessionListContainerInfo(t);o&&R.alert({title:{text:r.t("举报"),position:"center",html:false},content:{text:`
						...
						${o.replyUserId&&o.replyUserId!=o.postUserId?`
							...
							`});});});}},St={isCurrentLoginUserHome(){let t=st.getCurrentLoginUserId();return !!(t!=null&&B.isUsers()&&window.location.pathname.includes("/"+t))},monacoEditor(){return new Promise(t=>{const e="0.52.2",A="monaco-editor-ready";if(X.monaco){t(X.monaco);return}let n=v.loading(r.t("monaco-editor加载中...")),i=c.createElement("script",{type:"module",defer:true,innerHTML:`
...
`,pe={init(){h.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),h.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),h.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){u.info("美化 历史版本 页面");let t=[];return t.push(M(fe)),t.push(ot.addBlockCSS(".version-number",".version-date",".version-changelog")),c.ready(function(){let e=T("ul.history_versions");if(!e){v.error(r.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(A=>{let n=A.querySelector(".version-number a").href,i=A.querySelector(".version-number a").innerText,a=A.querySelector(".version-date")?.getAttribute("datetime"),o=A.querySelector(".version-changelog")?.innerHTML||"",l=c.createElement("span",{className:"script-version-date",innerHTML:g.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),s=c.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
						...
						`});c.after(t,s);});});},sourceDiffMonacoEditor(){u.info("源码对比（monacoEditor）"),St.monacoEditor().then(t=>{c.ready(()=>{K('#script-content form[action*="/diff"] input[type="submit"]').forEach(e=>{let A=c.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});c.after(e,A),c.on(A,"click",async n=>{g.preventEvent(n);let i=e.closest("form"),a=new FormData(i),o=a.get("v1"),l=a.get("v2");if(o===l){v.warning(r.t("版本号相同，不需要比较源码"));return}let s=v.loading(r.t("正在获取对比文本中...")),d=S.getScriptId(),p=await G.getScriptInfo(d);if(!p){s.close();return}let f=p.code_url,m=f.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${o}`),y=f.replace(new RegExp(`/${d}(/[\\d]+|)`),`/${d}/${l}`),P="",b="";const[N,k]=await Promise.all([q.get(m,{timeout:2e4}),q.get(y,{timeout:2e4})]);if(s.close(),!N.status||!k.status)return;P=N.data.responseText,b=k.data.responseText;let{recovery:Q}=ot.lockScroll(),w=R.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
								<div class="monaco-editor-diff-container">
									<div class="monaco-editor-diff"></div>
								</div>
								`},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},btn:{ok:{enable:false},close:{callback(L,E){L.close(),Q();}}},zIndex(){let L=g.getMaxZIndex(),E=R.config.InstanceUtils.getPopsMaxZIndex().zIndex;return g.getMaxValue(L,E)+100},useShadowRoot:false,width:"90vw",height:"90vh",drag:true,style:`
						...
						`});w.$shadowRoot.querySelector(".monaco-editor-diff-container");let C=w.$shadowRoot.querySelector(".monaco-editor-diff"),z=t.editor.createDiffEditor(C,{hideUnchangedRegions:{enabled:true},minimap:{enabled:true},automaticLayout:true,codeLens:true,colorDecorators:true,contextmenu:false,readOnly:true,formatOnPaste:true,overviewRulerBorder:true,scrollBeyondLastLine:false,theme:"vs-dark",fontSize:window.innerWidth>600?14:12,wordWrap:"off",language:"javascript"});const j=t.editor.createModel(b,"javascript"),D=t.editor.createModel(P,"javascript");z.setModel({original:j,modified:D});});});});});}};let ht=[];const jt=async function(t){if(u.info("当前脚本id："+t),!U.isLogin){u.error("请先登录账号"),v.error(r.t("请先登录账号"));return}let e=S.getUserId(U.getUserLinkElement().href);if(e==null){u.error("获取用户id失败"),v.error(r.t("获取用户id失败"));return}if(!ht.length){let a=v.loading(r.t("获取收藏夹中..."));if(ht=await G.getUserCollection(e)||[],a.close(),!ht.length)return}let A="";const n=(a,o)=>{let l=false;o=o.toString().trim();for(const[s,d]of a.entries())if(s==="scripts-included[]"&&d.toString().trim()===o){l=true;break}return l};ht.forEach(a=>{A+=`
		...
		`});c.on(i.$shadowRoot,"click",".collect-add-script-id",async function(a){let o=a.target.closest(".user-collect-item"),l=o.dataset.id;o.dataset.name;let s=v.loading(r.t("添加中..."));try{let d=await G.getUserCollectionInfo(e,l);if(!d)return;if(n(d,t)){v.warning(r.t("该脚本已经在该收藏集中"));return}let p=g.cloneFormData(d),f=g.cloneFormData(d);p.set("add-script",t.toString()),p.set("script-action","i"),f.append("scripts-included[]",t.toString()),f.set("save","1");let m=new URLSearchParams(p),y=new URLSearchParams(f),P=Array.from(m).map(([j,D])=>`${encodeURIComponent(j)}=${encodeURIComponent(D)}`).join("&"),b=Array.from(y).map(([j,D])=>`${encodeURIComponent(j)}=${encodeURIComponent(D)}`).join("&");u.info("添加的数据",P),u.info("保存的数据",b);let N=await G.updateUserSetsInfo(e,l,P);if(!N)return;let k=N.querySelector(".change-script-set");if(!k){v.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let Q=k.querySelector("section");if(!Q){v.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}let w=Q.querySelector(".alert");if(w){R.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:w.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:$.info.width,height:$.info.height});return}let C=new FormData(k);if(!n(C,t)){u.error("添加失败，提交的添加请求中不包含该脚本id"),v.error(r.t("添加失败，表单数据中不包含该脚本"));return}await G.updateUserSetsInfo(e,l,b),v.success(r.t("添加成功"));}catch(d){console.error(d);}finally{s.close();}}),c.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(a){let o=a.target.closest(".user-collect-item"),l=o.dataset.id;o.dataset.name;let s=v.loading(r.t("删除中..."));try{let d=await G.getUserCollectionInfo(e,l);if(!d)return;if(!n(d,t)){v.info(r.t("已删除：{{scriptId}}",{scriptId:t}));return}let p=g.cloneFormData(d,(C,z)=>C==="scripts-included[]"&&typeof z=="string"&&z.toString().trim()===t.toString().trim()),f=g.cloneFormData(p);p.set("remove-scripts-included[]",t.toString()),p.set("remove-selected-scripts","i"),p.delete("script-action"),f.set("save","1");let m=new URLSearchParams(p),y=new URLSearchParams(f),P=Array.from(m).map(([C,z])=>`${encodeURIComponent(C)}=${encodeURIComponent(z)}`).join("&"),b=Array.from(y).map(([C,z])=>`${encodeURIComponent(C)}=${encodeURIComponent(z)}`).join("&");u.info("删除的数据",P),u.info("保存的数据",b);let N=await G.updateUserSetsInfo(e,l,P);if(!N)return;let k=N.querySelector(".change-script-set");if(!k){v.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let Q=new FormData(k);if(n(Q,t)){u.error("删除失败，提交的删除请求中包含该脚本id"),v.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await G.updateUserSetsInfo(e,l,b),v.success(r.t("删除成功"));}catch(d){console.error(d);}finally{s.close();}});},ge={init(){B.isCode()?ue.init():B.isVersion()&&pe.init(),B.isCodeStrict()&&(h.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),h.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),h.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),h.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),c.ready(()=>{h.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){u.info("添加收藏按钮"),g.waitNode("ul#script-links li.current span").then(()=>{let t=c.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
					</a>`});c.append(T("ul#script-links"),t),c.on(t,"click",()=>{let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){u.error(e,window.location.pathname),v.error(r.t("获取脚本id失败"));return}let A=e[e.length-1];jt(A);});});},fullScreenOptimization(){u.info("F11全屏，F键代码全屏"),M(`
...
`),g.isNull(t))return;t=t.toString().trim();let n=t+"##"+e;A+=n,this.setValue(A);},getValue(){return h.getValue(this.key,"")}},ve=`.sidebarred-main-content {\r
	max-width: unset;\r
	flex: unset;\r
}\r
ol.script-list {\r
...
`,bt={getTampermonkey:()=>X.external?.Tampermonkey,getViolentmonkey:()=>X.external?.Violentmonkey,getScriptCat:()=>X.external?.Scriptcat,getScriptContainerStatus(){let t={Tampermonkey:false,Violentmonkey:false,ScriptCat:false};return X.external?.Tampermonkey&&(t.Tampermonkey=true),X.external?.Violentmonkey&&(t.Violentmonkey=true),X.external?.Scriptcat&&(t.ScriptCat=true),t},getRegisterScriptContainerNameList(){let e=this.getScriptContainerStatus(),A=[];return Object.keys(e).forEach(n=>{Reflect.get(e,n)&&A.push(n);}),A},getInstalledVersion(t,e){return new Promise((A,n)=>{const i=this.getTampermonkey();if(i){i.isInstalled(t,e,function(l){l.installed?A(l.version):A(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(t,e).then(A);return}const o=this.getScriptCat();if(o){o.isInstalled(t,e,function(l){l.installed?A(l.version):A(null);});return}n(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(t,e){if(t===e)return 0;const A=t.split("."),n=e.split(".");for(let i=0;i<A.length;i++){const a=this.compareVersionPart(A[i],n[i]);if(a!==0)return a}return 0},compareVersionPart(t,e){const A=this.parseVersionPart(t),n=this.parseVersionPart(e);for(let i=0;i<A.length;i++){if(A[i].length>0&&n[i].length===0)return  -1;if(A[i].length===0&&n[i].length>0||A[i]>n[i])return 1;if(A[i]<n[i])return  -1}return 0},parseVersionPart(t){if(!t)return [0,"",0,""];const e=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(t);return [e[1]?parseInt(e[1]):0,e[2],e[3]?parseInt(e[3]):0,e[4]]},handleInstallResult(t,e,A){if(e!=null)switch(t.removeAttribute("data-ping-url"),this.compareVersions(e,A)){case  -1:t.textContent=t.getAttribute("data-update-label");break;case 1:t.textContent=t.getAttribute("data-downgrade-label");break;case 0:t.textContent=t.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(t,e){const A=t.getAttribute("data-script-name"),n=t.getAttribute("data-script-namespace"),i=t.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(A,n);return a==null?!1:(this.handleInstallResult(t,a,i),!0)}catch{if(e){await g.sleep(1e3);try{return await this.checkForUpdatesJS(t,!1)}catch{}}return  false}},checkForUpdatesCSS(t){const e=t.getAttribute("data-script-name"),A=t.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:e,namespace:A,url:location.href},location.origin);}},Nt={init(){h.execMenuOnce("gf-scripts-filter-enable",()=>{nt.init();}),h.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){u.info("美化脚本列表-双列");let t=[];t.push(M(ve));const e="lum-lightbox-loader",A=r.t("安装此脚本");return O.ready(()=>{let n=bt.getScriptContainerStatus(),i=Object.values(n).find(d=>d),a=bt.getRegisterScriptContainerNameList(),o=h.getValue("beautifyCenterContent-queryNameSpace");i?u.info("当前暴露的external信息："+a.map(d=>`【${d}】`).join("、")):u.error("脚本容器未暴露external信息",window.external);let l=new g.LockFunction(()=>{nt.getElementList().forEach(p=>{if(p.querySelector(".script-list-operation"))return;let f=st.parseScriptListInfo(p),m=p.querySelector(".inline-script-stats");if(!m)return;let y=f.codeUrl,P=O.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${r.t("评分")}</span>`}),b=O.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${f.scriptRatingScore}</span>`},{"data-position":"right"}),N=p.querySelector("dd.script-list-ratings .good-rating-count"),k=p.querySelector("dd.script-list-ratings .ok-rating-count"),Q=p.querySelector("dd.script-list-ratings .bad-rating-count");if(N&&k&&Q){let E=parseInt(N.innerText),I=parseInt(k.innerText),H=parseInt(Q.innerText),F=E+I+H;F>=10?E/F>=.6?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count"):F==0||E>I+H?b.classList.add("good-rating-count"):b.classList.add("bad-rating-count");}let w=O.createElement("dt",{className:"script-list-version",innerHTML:`<span>${r.t("版本")}</span>`}),C=O.createElement("dd",{className:"script-list-version",innerHTML:`<span>${f.scriptVersion}</span>`},{"data-position":"right"}),z=O.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${r.t("操作")}</span>`}),j=O.createElement("dd",{className:"script-list-operation",innerHTML:`
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),D=j.querySelector(".script-collect-btn"),L=j.querySelector(".install-link");if(L["data-script-info"]=f,O.addClass(L,e),f.scriptType==="library"&&L.remove(),O.on(D,"click",E=>{g.preventEvent(E),jt(f.scriptId);}),h.getValue("gf-scripts-filter-enable")){let E=O.createElement("button",{className:"script-filter-btn",innerHTML:r.t("过滤")}),I="data-filter-key",H="data-filter-value";O.on(E,"click",F=>{g.preventEvent(F);let tt=R.alert({title:{text:r.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${I}="scriptId" ${H}="^${f.scriptId}$">${r.t("脚本id：{{text}}",{text:f.scriptId})}</button>
									<button ${I}="scriptName" ${H}="^${g.parseStringToRegExpString(f.scriptName)}$">${r.t("脚本名：{{text}}",{text:f.scriptName})}</button>
								...
								`}),W=tt.$shadowRoot.querySelector(".pops-alert-content");f.scriptAuthors.forEach(Y=>{let V=O.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:Y.authorId})});V.setAttribute(I,"scriptAuthorId"),V.setAttribute(H,"^"+Y.authorId+"$");let et=O.createElement("button",{innerHTML:r.t("作者名：{{text}}",{text:Y.authorName})});et.setAttribute(I,"scriptAuthorName"),et.setAttribute(H,"^"+g.parseStringToRegExpString(Y.authorName)+"$"),W.appendChild(V),W.appendChild(et);}),O.on(tt.$shadowRoot,"click",`button[${I}]`,Y=>{g.preventEvent(Y);let V=Y.target,et=V.getAttribute(I),vt=V.getAttribute(H);nt.addValue(et,vt),tt.close(),nt.filter(),v.success(r.t("添加成功"));});}),j.appendChild(E);}m.appendChild(P),m.appendChild(b),m.appendChild(w),m.appendChild(C),m.appendChild(z),m.appendChild(j);});},100),s=new g.LockFunction(async()=>{let d=Array.from(K(".install-link[data-install-format=js]:not([gm-is-check-install-status])"));for(let p=0;p<d.length;p++){const f=d[p];f.setAttribute("gm-is-check-install-status","");let m=Reflect.get(f,"data-script-info");if(i){if(o){let y=await G.getScriptInfo(m.scriptId);y&&f.setAttribute("data-script-namespace",y.namespace);}bt.checkForUpdatesJS(f,true).then(y=>{O.removeClass(f,e),y||O.text(f,A);});}else O.removeClass(f,e),O.text(f,A);}});g.mutationObserver(document,{config:{subtree:true,childList:true},immediate:true,callback:()=>{l.run(),s.run();}});}),t}},he={init(){h.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),h.execMenuOnce("gf-scripts-filter-enable",()=>{nt.init();}),h.execMenuOnce("beautifyCenterContent",()=>Nt.beautifyCenterContent());},changeConsoleToTopNavigator(){u.info("迁移【控制台】到顶部导航栏"),ot.addBlockCSS("#about-user"),c.ready(()=>{let t=T("#about-user");if(!t){u.error("#about-user元素不存在");return}t=t.cloneNode(true),st.registerTopNavMenu({name:r.t("控制台"),className:"scripts-console",clickEvent(e){R.alert({title:{text:r.t("控制台"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:$.setting.width,height:$.setting.height,zIndex:g.getMaxZIndex(100),style:`
						#about-user{
							border: 0;
							box-shadow: none;
						}
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(t);}});});}};class me{key="short-cut";$data;isWaitPress=false;currentWaitEnterPressInstanceHandler=null;constructor(e){typeof e=="string"&&(this.key=e),this.$data={otherShortCutOptions:[]};}initConfig(e,A){this.hasOption(e)||this.setOption(e,A);}getStorageKey(){return this.key}getLocalAllOptions(){return _(this.key,[])}hasOption(e){return !!this.getLocalAllOptions().find(i=>i.key===e)}hasOptionValue(e){return this.hasOption(e)?this.getOption(e)?.value!=null:false}getOption(e,A){return this.getLocalAllOptions().find(a=>a.key===e)??A}setOption(e,A){let n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===e);i==-1?n.push({key:e,value:A}):Reflect.set(n[i],"value",A),Z(this.key,n);}emptyOption(e){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===e);return i!==-1&&(n[i].value=null,A=true),Z(this.key,n),A}deleteOption(e){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===e);return i!==-1&&(n.splice(i,1),A=true),Z(this.key,n),A}translateKeyboardValueToButtonText(e){let A="";return e.ohterCodeList.forEach(n=>{A+=g.stringTitleToUpperCase(n,true)+" + ";}),A+=g.stringTitleToUpperCase(e.keyName),A}getShowText(e,A){if(this.hasOption(e)){let n=this.getOption(e);return n.value==null?A:this.translateKeyboardValueToButtonText(n.value)}else return A}async enterShortcutKeys(e){const A=this;return new Promise(n=>{this.isWaitPress=true;let i=c.listenKeyboard(window,"keyup",(a,o,l)=>{const s={keyName:a,keyValue:o,ohterCodeList:l};let d={};try{const p=JSON.stringify(s),f=this.getLocalAllOptions();Array.isArray(this.$data.otherShortCutOptions)&&f.push(...this.$data.otherShortCutOptions);for(let m=0;m<f.length;m++){let y=f[m];if(y.key===e)continue;const P=JSON.stringify(y.value);let b=!1;if(y.value!=null&&p===P&&(b=!0),b){d={status:!1,key:y.key,option:s};return}}this.setOption(e,s),d={status:!0,key:e,option:s};}catch(p){console.log(p),d={status:false,key:e,option:s};}finally{A.isWaitPress=false,i.removeListen(),A.currentWaitEnterPressInstanceHandler=null,n(d);}});A.currentWaitEnterPressInstanceHandler=null,A.currentWaitEnterPressInstanceHandler=()=>{A.isWaitPress=false,i.removeListen();};})}cancelEnterShortcutKeys(){typeof this.currentWaitEnterPressInstanceHandler=="function"&&this.currentWaitEnterPressInstanceHandler();}initGlobalKeyboardListener(e,A){let n=this.getLocalAllOptions();if(!n.length){u.warn("没有设置快捷键");return}const i=this;function a(s,d){c.listenKeyboard(s,"keydown",(p,f,m,y)=>{if(i.isWaitPress)return;A?.isPrevent&&g.preventEvent(y),n=i.getLocalAllOptions();let P=n.findIndex(b=>{let N=b.value,k={keyName:p,keyValue:f,ohterCodeList:m};if(JSON.stringify(N)===JSON.stringify(k))return b});if(P!=-1){let b=n[P];b.key in d&&(u.info(["调用快捷键",b]),d[b.key].callback());}},{capture:!!A?.capture});}let o={},l={};Object.keys(e).forEach(s=>{let d=e[s];(d.target==null||typeof d.target=="string"&&d.target==="")&&(d.target="window"),d.target==="window"?Reflect.set(o,s,d):Reflect.set(l,s,d);}),a(window,o),c.ready(()=>{Object.keys(l).forEach(async s=>{let d=l[s];if(typeof d.target=="string")g.waitNode(d.target,1e4).then(p=>{if(!p)return;let f={};Reflect.set(f,s,d),a(p,f);});else if(typeof d.target=="function"){let p=await d.target();if(p==null)return;let f={};Reflect.set(f,s,d),a(p,f);}else {let p={};Reflect.set(p,s,d),a(d.target,p);}});});}}const Qt={shortCut:new me,shortOption:{"gf-quickReply":{target:()=>{let t=T("form textarea"),e=T('input[name="commit"][type="submit"]');if(t){if(!e){u.error("页面不存在【发表回复】按钮");return}}else {u.error("页面不存在输入框");return}return u.success("监听快捷键：gf-quickReply"),t},callback(){if(document.activeElement){let t=document.activeElement.closest("form");if(!t){u.error("当前activeElement不在表单内，无法触发快捷键");return}let e=t.querySelectorAll('input[name="commit"][type="submit"]');if(!e.length){u.error("表单内不存在【发表回复】按钮");return}e.length>1&&u.warn("表单内存在多个【发表回复】按钮，只触发第一个"),e[0].click();}else u.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},ye=`section.text-content {\r
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,we={init(){h.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),c.ready(()=>{h.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return u.info("美化对话框"),M(ye)},beautifyPrivateMessageList(){u.info("美化私信列表"),M(`
		...
		`),K("section.text-content ul li").forEach(t=>{let e=t.querySelector('a[href*="conversations"]'),A=e.href,n=e.textContent?.split(" ")[1],i=t.querySelector("a.user-link"),a=null,o=null,l=null;if(i){a=i.textContent,o=i.href;let s=t.querySelector("relative-time");new Date(s.getAttribute("datetime")),l=s.shadowRoot.lastChild.textContent;}t.classList.add("user-conversations-item"),S.getUserId(),t.innerHTML=`
			...
			`}),o=a.querySelector(".pops-filter-controls_inner"),l=a.querySelector(".pops-filter-search-container");return i.appendChild(a),c.before(t,n),{$filterControl:o,$search:l}}},be={init(){c.ready(()=>{Et.waitScritList().then(t=>{if(!t){u.error("未找到脚本列表节点，无法继续执行");return}h.onceExec("GreasyforkScriptsSearch",()=>{let{$filterControl:e,$search:A}=Et.addFilterControls(t);this.addFilterControlsItem(A,e);});});});},addFilterControlsItem(t,e){let A=R.config.PanelHandlerComponents(),n=[{name:r.t("名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching-enable",callback:(o,l)=>{try{return !l.scriptName.match(new RegExp(o,"i"))}catch(s){return u.error(s),!l.scriptName.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("描述"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptDescWholeWordMatching-enable",callback:(o,l)=>{try{return !l.scriptDescription.match(new RegExp(o,"i"))}catch{return !l.scriptDescription.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("名称/描述"),desc:r.t("任一全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable",callback:(o,l)=>{let s=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptTitleWholeWordMatching").callback(o,l),d=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptDescWholeWordMatching").callback(o,l);return s&&d},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleWholeWordMatching-enable"]','.gm-script-control-item[data-storage-key="gf-script-search-filterScriptDescWholeWordMatching-enable"]']},{name:r.t("作者名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching-enable",callback:(o,l)=>{try{return !l.scriptAuthorName.match(new RegExp(o,"i"))}catch{return !l.scriptAuthorName.match(o)}}}],i=()=>{let o=t.querySelector("input");if(o)return o.value;let l=new URLSearchParams(window.location.search);return l.get("q")?.trim()||l.get("c")?.trim()||""},a=()=>{let o=i();nt.getElementList().forEach(s=>{let d=st.parseScriptListInfo(s),p=n.map(f=>{if(o=="")return  false;if(_(f.STORAGE_KEY))return f.callback(o,d)}).filter(f=>typeof f=="boolean");if(p.length!==0){let f=false;p.forEach(m=>{f=f||m;}),f?c.hide(s,false):c.show(s,false);}else c.show(s,false);});};if(h.getValue("gf-script-search-addFilterSearchInput")){let o=A.createSectionContainerItem_input({type:"input",className:"gm-script-search-input",getValue(){let l=i();return h.getValue("gf-script-search-addFilterSearchInput-text")||l||""},description:r.t("自动执行过滤"),placeholder:r.t("过滤的关键词"),text:r.t("关键词"),callback:g.debounce((l,s)=>{h.setValue("gf-script-search-addFilterSearchInput-text",s.toString()),a();},500)});c.append(t,o);}n.forEach(o=>{if(!h.getValue(o.ENABLE_KEY))return;u.info(`添加按钮${o.name}`);let l=A.createSectionContainerItem_switch({type:"switch",className:"gm-script-control-item",text:o.name,description:o.desc,attributes:{"data-storage-key":o.STORAGE_KEY},getValue(){let s=_(o.STORAGE_KEY,false);return s=!!s,a(),s},callback(s,d){if(Z(o.STORAGE_KEY,d),a(),d&&Array.isArray(o.mutualExclusionSwitch)){let p=l.closest(".pops");o.mutualExclusionSwitch.forEach(f=>{let m=p.querySelector(f);m&&m.querySelector("input")?.checked&&m.querySelector(".pops-panel-switch__core")?.click();});}}});c.append(e,l);});}},dt={init(){if(B.isImageSource()){u.info("Router: 资源界面，不执行脚本功能");return}h.execMenu("checkPage",()=>{this.checkPage();}),le.init(),Qt.init(),B.isScript()&&ge.init(),(B.isScriptList()||B.isScriptLibraryList()||B.isScriptCodeSearch()||B.isScriptsBySite())&&Nt.init(),B.isDiscuessions()?(u.info("Router: 讨论页面"),de.init()):B.isUsers()?(u.info("Router: 用户页面"),he.init(),B.isUsersConversations()&&(u.info("Router-next: 私聊用户页面"),we.init())):(B.isScriptSearch()||B.isScriptsBySite()||B.isScriptCodeSearch()||B.isScriptLibraryListSearch())&&(u.info("Router: 脚本搜索页面"),be.init()),h.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),c.ready(()=>{U.initEnv(),ce.init(),zt.init(),U.handleLocalGotoCallBack(),h.execMenuOnce("fixImageWidth",()=>{dt.fixImageWidth();}),dt.languageSelectorLocale(),h.execMenuOnce("optimizeImageBrowsing",()=>{dt.optimizeImageBrowsing();}),h.execMenuOnce("overlayBedImageClickEvent",()=>{dt.overlayBedImageClickEvent();}),B.isCodeStrict()||h.execMenuOnce("addMarkdownCopyButton",()=>{dt.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(u.info("修复图片显示问题"),M(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){u.info("优化图片浏览"),M(Pt("ViewerCSS")),M(`
        ...
        `);function t(A=[],n=0){let i="";A.forEach(l=>{i+=`<li><img data-src="${l}" loading="lazy"></li>`;});let a=c.createElement("ul",{innerHTML:i}),o=new Xt(a,{inline:false,url:"data-src",zIndex:g.getMaxZIndex()+100,hidden:()=>{o.destroy();}});n=n<0?0:n,o.view(n),o.zoomTo(1),o.show();}function e(A){return A.getAttribute("data-src")||A.getAttribute("src")||A.getAttribute("alt")}c.on(document,"click","img",function(A){let n=A.target;if(n.parentElement?.localName==="a"&&n.hasAttribute("data-screenshots")||n.closest(".viewer-container")||n.closest(".lum-lightbox-position-helper"))return;let i=n.closest(".user-content"),a=[],o=0,l=[],s=e(n);if(s){if(s.startsWith("https://img.shields.io"))return;if(s.startsWith("/vite/assets/"))return}i?(i.querySelectorAll("img").forEach(d=>{l.push(d);let p=e(d),f=d.parentElement;f?.localName==="a"&&(p=f.getAttribute("data-href")||f.href),a.push(p);}),o=l.indexOf(n),o===-1&&(o=0)):(a.push(s),o=0),u.success("点击浏览图片👉",a,o),t(a,o);}),K(".user-screenshots").forEach(A=>{let n=A.querySelector("a");if(!n)return;let i=n.getAttribute("data-href")||n.getAttribute("href"),a=A.querySelector("img");a&&(a.setAttribute("data-screenshots","true"),a.setAttribute("data-src",i),n.setAttribute("href","javascript:;"),c.after(n,a),n.remove());});},overlayBedImageClickEvent(){u.info("覆盖图床图片的parentElement的a标签"),K(".user-content a>img").forEach(t=>{let e=t.parentElement,A=e.getAttribute("href");if(e.setAttribute("data-href",A),e.removeAttribute("href"),A.startsWith("/rails/active_storage/blobs/redirect")){u.info("该图片是上传到Greasyfork的图片，拦截默认行为，不做提示");return}c.on(e,"click",()=>{v.warning(`<div style="overflow-wrap: anywhere;">${r.t("拦截跳转：")}<a href="${A}" target="_blank">${A}</a></div>`,{isHTML:true,zIndex:g.getMaxZIndex()+105});});});},addMarkdownCopyButton(){u.info("在Markdown右上角添加复制按钮"),M(`
        pre{
          position: relative;
		...
		`),c.ready(()=>{T("#site-nav nav"),T("#site-nav .with-submenu nav");let t=T("#script-list-option-groups")||T(".list-option-groups");if(!t){u.warn("不存在右侧面板元素#script-list-option-groups");return}t=t.cloneNode(true),t.classList.add("option-panel-groups"),st.registerTopNavMenu({name:r.t("操作面板"),className:"filter-scripts",clickEvent(e){R.alert({title:{text:r.t("操作面板"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:$.setting.width,height:$.setting.height,zIndex:g.getMaxZIndex(100),style:`
						...
						`}).$shadowRoot.querySelector(".pops-alert-content").appendChild(t);}});});}},xe={init(){},showView(){let t=R.alert({title:{text:r.t("Url To WebhookUrl"),position:"center"},content:{text:`
...
`).forEach(o=>{try{if(o=o.trim(),g.isNull(o))return;let s=new URL(o).pathname.split("/"),{1:d,2:p,3:f,4:m}=s,y="";if(s.length>=6&&f==="blob")y=s.slice(5,s.length).join("/");else if(s.length>=8&&f==="raw"&&m==="refs")m=s[6],y=s.slice(7,s.length).join("/");else return;if(y==="")return;a.push(`https://raw.githubusercontent.com/${d}/${p}/${m}/${y}`);}catch{}}),A.value=a.join(`
`);});}},ut=function(t,e,A,n,i,a,o,l,s,d){let p={text:t,type:"button",attributes:{},props:{},description:e,buttonIcon:n,buttonIsRightIcon:i,buttonIconIsLoading:a,buttonType:o,buttonText:A,callback(f){typeof l=="function"&&l(f);},afterAddToUListCallBack:s};return Reflect.set(p.attributes,kt,()=>{p.disable=false;}),p},Dt={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new it.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,A){let n;this.hasStorageApi(t)?n=this.getStorageApi(t):n=A,this.setComponentsStorageApiProperty(e,n);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,at,e);}},xt=function(t,e,A,n,i,a="",o,l,s,d){let p={text:t,type:"input",isNumber:!!o,isPassword:!!l,attributes:{},props:{},description:n,afterAddToUListCallBack:s,getValue(){return this.props[at].get(e,A)},callback(f,m,y){this.props[at].set(e,m);},placeholder:a};return Reflect.set(p.attributes,pt,e),Reflect.set(p.attributes,gt,A),Dt.initComponentsStorageApi("input",p,{get(f,m){return h.getValue(f,m)},set(f,m){h.setValue(f,m);}}),p},x=function(t,e,A,n,i,a,o,l){let s={text:t,type:"switch",description:i,disabled:o,attributes:{},props:{},getValue(){return this.props[at].get(e,A)},callback(d,p){let f=!!p;u.success(`${f?"开启":"关闭"} ${t}`),this.props[at].set(e,f);},afterAddToUListCallBack:a};return Reflect.set(s.attributes,pt,e),Reflect.set(s.attributes,gt,A),Dt.initComponentsStorageApi("switch",s,{get(d,p){return h.getValue(d,p)},set(d,p){h.setValue(d,p);}}),s},ct=function(t,e,A,n,i,a,o){let l=[];typeof n=="function"?l=n():l=n;let s={text:t,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[at].get(e,A)},callback(d,p,f){let m=p;if(u.info(`选择：${f}`),typeof i=="function"&&i(d,m,f))return;this.props[at].set(e,m);},data:l};return Reflect.set(s.attributes,pt,e),Reflect.set(s.attributes,gt,A),Dt.initComponentsStorageApi("select",s,{get(d,p){return h.getValue(d,p)},set(d,p){h.setValue(d,p);}}),s},Le=function(t,e,A,n,i,a="default",o){let l=typeof i=="function"?i():i;typeof n=="object"&&o.initConfig(A,n);let s=()=>o.getShowText(A,l),d=ut(t,e,s,"keyboard",false,false,a,async p=>{let m=p.target.closest(".pops-panel-button")?.querySelector("span");if(o.isWaitPress){v.warning("请先执行当前的录入操作");return}if(o.hasOptionValue(A))o.emptyOption(A),v.success("清空快捷键");else {let y=v.loading("请按下快捷键...",{showClose:true,onClose(){o.cancelEnterShortcutKeys();}}),{status:P,option:b,key:N}=await o.enterShortcutKeys(A);y.close(),P?(u.success(["成功录入快捷键",b]),v.success("成功录入")):v.error(`快捷键 ${o.translateKeyboardValueToButtonText(b)} 已被 ${N} 占用`);}m.innerHTML=s();});return d.attributes={},Reflect.set(d.attributes,kt,()=>false),d},It={async UIScriptList(t,e){if(!U.isLogin){v.error(r.t("请先登录账号！"));return}let i=U.getUserLinkElement().href?.split("/")?.pop()?.match(/([0-9]+)/)?.[0],a=R.loading({mask:{enable:true},parent:e,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:false}),o=await G.getUserInfo(i);if(a.close(),!o)return;u.info(o);let l=t==="script-list"?o.scriptList:o.scriptLibraryList;v.success(r.t("获取成功，共 {{count}} 个",{count:l.length}));for(const s of l){let d=c.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),p=d.querySelector(".w-script-info"),f=c.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});s.deleted&&(d.classList.add("w-script-deleted"),f.querySelector("button").setAttribute("disabled","true")),c.on(f,"click",async function(){u.success("同步",s);let m=f.querySelector("button"),y=f.querySelector("button span"),P=c.createElement("i",{className:"pops-bottom-icon",innerHTML:R.config.iconSVG.loading},{"is-loading":true});m.setAttribute("disabled","true"),m.setAttribute("data-icon","true"),y.innerText=r.t("同步中..."),c.before(y,P);let b=s?.id,N=await G.getSourceCodeSyncFormDataInfo(b.toString());if(N){const{formData:k,url:Q}=N,w="script[script_sync_type_id]",C="script[sync_type]";if(k.has(w)||k.has(C)){let z="";if(k.has(w)){let L=k.get(w);L.toString()==="1"?z=r.t("手动"):L.toString()==="2"?z=r.t("自动"):L.toString()==="3"&&(z="webhook");}else k.has(C)&&(z=k.get(C));let j=d.querySelector(".w-script-sync-type");j?j.querySelector("p").innerText=r.t("同步方式：{{syncMode}}",{syncMode:z}):c.append(p,`
								<div class="w-script-sync-type">
									<p>${r.t("同步方式：{{syncMode}}",{syncMode:z})}
									</p>
								</div>`),await G.sourceCodeSync(s.id.toString(),k,Q)?v.success(r.t("同步成功")):v.error(r.t("同步失败"));}else v.error(r.t("该脚本未设置同步信息"));}m.removeAttribute("disabled"),m.removeAttribute("data-icon"),y.innerText=r.t("同步代码"),P.remove();}),d.appendChild(f),e.appendChild(d);}}},Pe={id:"greasy-fork-panel-config-account",title:r.t("通用"),forms:[{text:"",type:"forms",forms:[{text:r.t("Toast配置"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[ct(r.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:r.t("左上角")},{value:"top",text:r.t("顶部")},{value:"topright",text:r.t("右上角")},{value:"left",text:r.t("左边")},{value:"center",text:r.t("中间")},{value:"right",text:r.t("右边")},{value:"bottomleft",text:r.t("左下角")},{value:"bottom",text:r.t("底部")},{value:"bottomright",text:r.t("右下角")}],(t,e,A)=>{u.info("设置当前Qmsg弹出位置"+A);},r.t("Toast显示在页面九宫格的位置")),ct(r.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,r.t("限制Toast显示的数量")),x(r.t("逆序弹出"),"qmsg-config-showreverse",false,void 0,r.t("修改Toast弹出的顺序"))]}]},ct(r.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(t,e,A)=>{u.info("改变语言："+A),r.changeLanguage(e);})]},{text:"",type:"forms",forms:[{text:r.t("账号/密码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[xt(r.t("账号"),"user","",void 0,void 0,r.t("请输入账号")),xt(r.t("密码"),"pwd","",void 0,void 0,r.t("请输入密码"),false,true),xt(r.t("secret"),"secret","","两步验证（2FA）",void 0,r.t("请输入secret"),false,true)]},{text:"",type:"forms",forms:[x(r.t("自动登录"),"autoLogin",true,void 0,r.t("自动登录当前保存的账号")),ut(r.t("清空账号/密码"),void 0,r.t("点击清空"),void 0,void 0,false,"default",t=>{if(confirm(r.t("确定清空账号和密码？"))){h.deleteValue("user"),h.deleteValue("pwd"),v.success(r.t("已清空账号/密码"));let e=t.target.getRootNode();e.querySelector('li[data-key="user"] .pops-panel-input input').value="",e.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}})]}]},{text:r.t("功能"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[ct(r.t("固定当前语言"),"language-selector-locale","",(function(){let t=[{value:"",text:r.t("无")}];return c.ready(()=>{K("select.language-selector-locale option").forEach(e=>{let A=e.getAttribute("value");if(A==="help")return;let n=c.text(e).trim();t.push({value:A,text:n});});}),t})()),x(r.t("修复图片宽度显示问题"),"fixImageWidth",true,void 0,r.t("修复图片在移动端宽度超出浏览器宽度问题")),x(r.t("优化图片浏览"),"optimizeImageBrowsing",true,void 0,r.t("使用Viewer浏览图片")),x(r.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",true,void 0,r.t("配合上面的【优化图片浏览】更优雅浏览图片")),x(r.t("添加【操作面板】按钮"),"scripts-addOperationPanelBtnWithNavigator",true,void 0,r.t("在脚本列表页面时为顶部导航栏添加【操作面板】按钮")),x(r.t("给Markdown添加【复制】按钮"),"addMarkdownCopyButton",true,void 0,r.t("在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容"))]},{text:r.t("检测页面加载"),type:"forms",forms:[x(r.t("启用"),"checkPage",true,void 0,r.t("检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面")),ct(r.t("检测间隔"),"greasyfork-check-page-timeout",5,(()=>{let t=[];for(let e=0;e<5;e++)t.push({value:e+1,text:e+1+"s"});return t})(),void 0,r.t("设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面"))]}]},{type:"deepMenu",text:r.t("表单"),forms:[{type:"forms",text:"",forms:[x(r.t("记住回复内容"),"rememberReplyContent",true,void 0,r.t("监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复")),ct(r.t("自动清理空间"),"gf-autoClearRememberReplayContent",7,[{text:r.t("不清理"),value:-1},{text:r.t("{{value}} 天",{value:1}),value:1},{text:r.t("{{value}} 周",{value:1}),value:7},{text:r.t("{{value}} 个月",{value:1}),value:30},{text:r.t("{{value}} 个月",{value:2}),value:60},{text:r.t("{{value}} 个月",{value:3}),value:90},{text:r.t("半年"),value:180}],void 0,r.t("根据设置的间隔时间自动清理保存的回复内容")),ut(r.t("数据占用空间：{{size}}",{size:r.t("计算中")}),r.t("当前存储的数据所占用的空间大小"),r.t("清空"),void 0,void 0,void 0,"default",async()=>{await zt.clearAllRememberReplyContent()?v.success(r.t("清理成功")):v.error(r.t("清理失败"));},async(t,e)=>{let A=e.ulElement.querySelector('li[data-key="gf-autoClearRememberReplayContent"]+li .pops-panel-item-left-main-text'),n=await zt.getAllRememberReplyContent(),i="";n.length?i=g.getTextStorageSize(JSON.stringify(n)):i=g.getTextStorageSize(""),A.innerText=r.t("数据占用空间：{{size}}",{size:i});})]}]},{text:r.t("美化"),type:"deepMenu",forms:[{text:r.t("全局"),type:"forms",forms:[x(r.t("美化页面元素"),"beautifyPage",true,void 0,r.t("如button、input、textarea")),x(r.t("美化上传图片按钮"),"beautifyUploadImage",true,void 0,r.t("放大上传区域")),x(r.t("美化顶部导航栏"),"beautifyTopNavigationBar",true,void 0,r.t("可能会跟Greasyfork Beautify脚本有冲突")),x(r.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",false,void 0,r.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]},{type:"forms",text:r.t("脚本列表"),forms:[x(r.t("美化脚本列表"),"beautifyCenterContent",true,void 0,r.t("双列显示且添加脚本卡片操作项（安装、收藏）")),x("↑"+r.t("使用namespace查询脚本信息"),"beautifyCenterContent-queryNameSpace",true,void 0,r.t("开启后检测已安装的脚本信息更准确，但是速度会更慢"))]}]},{type:"deepMenu",text:r.t("自定义快捷键"),forms:[{type:"forms",text:"",forms:[Le(r.t("快捷键发表回复"),r.t("在输入框内按下快捷发表回复，例如：{{key}}",{key:"Ctrl + Enter"}),"gf-quickReply",{keyName:"Enter",keyValue:"13",ohterCodeList:["ctrl"]},r.t("点击录入快捷键"),void 0,Qt.shortCut)]}]},{text:r.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${r.t("帮助文档")}</a>`,type:"forms",forms:[x(r.t("启用"),"gf-scripts-filter-enable",true,void 0,r.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(t){let e=c.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${r.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),A=e.querySelector("textarea");return A.value=nt.getValue(),c.on(A,["input","propertychange"],void 0,g.debounce(function(n){nt.setValue(A.value);},200)),t.appendChild(e),t}}]}]}]},{type:"forms",text:r.t("脚本管理"),forms:[{type:"deepMenu",text:r.t("代码同步"),forms:[{text:r.t("代码同步"),type:"forms",forms:[ut(r.t("源代码同步【脚本列表】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",t=>{if(!B.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_scriptList",true),U.getUserLinkElement()?(v.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):v.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];K("#user-script-list-section li a.script-link").forEach(A=>{e=e.concat(S.getAdminUrl(A.href));}),U.updateScript(e);}),ut(r.t("源代码同步【未上架的脚本】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",t=>{if(!B.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),U.getUserLinkElement()?(v.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):v.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];K("#user-unlisted-script-list li a.script-link").forEach(A=>{e=e.concat(S.getAdminUrl(A.href));}),U.updateScript(e);}),ut(r.t("源代码同步【库】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",t=>{if(!B.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),U.getUserLinkElement()?(v.success(r.t("前往用户主页")),window.location.href=U.getUserLinkElement().href):v.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];K("#user-library-script-list li a.script-link").forEach(A=>{e=e.concat(S.getAdminUrl(A.href));}),U.updateScript(e);})]}]},{type:"deepMenu",text:r.t("脚本列表"),forms:[],afterEnterDeepMenuCallBack(t,e){It.UIScriptList("script-list",e.sectionBodyContainer);}},{type:"deepMenu",text:r.t("库"),forms:[],afterEnterDeepMenuCallBack(t,e){It.UIScriptList("script-library",e.sectionBodyContainer);}}]}]},Ce={id:"greasy-fork-panel-config-scripts",title:r.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:r.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("添加复制代码按钮"),"addCopyCodeButton",true,void 0,r.t("更优雅的复制")),x(r.t("快捷键"),"fullScreenOptimization",true,void 0,r.t("【F】键全屏、【Alt+Shift+F】键宽屏")),x(r.t("修复代码行号显示"),"code-repairCodeLineNumber",false,void 0,r.t("修复代码行数超过1k行号显示不全问题")),x("monacoEditor","code-use-monaco-editor",true,void 0,r.t("使用Monaco编辑器"))]}]},{text:r.t("历史版本"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[x(r.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",true,void 0,r.t("在版本下面添加【安装】、【查看代码】按钮")),x(r.t("添加代码对比按钮"),"scripts-versions-addCompareCodeButton",true,void 0,r.t("monacoEditor"))]},{text:r.t("美化"),type:"forms",forms:[x(r.t("美化历史版本页面"),"beautifyHistoryVersionPage",true,void 0,r.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[x(r.t("添加【寻找引用】按钮"),"addFindReferenceButton",true,void 0,r.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),x(r.t("添加【收藏】按钮"),"addCollectionButton",true,void 0,r.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),x(r.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",true,void 0,r.t("在脚本信息栏添加【今日检查】信息块"))]}]}]}]},ze={id:"greasy-fork-panel-config-script-search",title:r.t("搜索"),forms:[{type:"forms",text:"搜素结果过滤",forms:[x(r.t("新增【关键词】搜索框"),"gf-script-search-addFilterSearchInput",true,void 0,r.t("输入自定义关键词后自动执行过滤")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("名称")}),"gf-script-search-filterScriptTitleWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("描述")}),"gf-script-search-filterScriptDescWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("名称/描述")}),"gf-script-search-filterScriptTitleOrDescWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本")),x(r.t("新增【{{buttonText}}】按钮",{buttonText:r.t("作者名称")}),"gf-script-search-filterScriptAuthorNameWholeWordMatching",true,void 0,r.t("该Checkbox按钮开启后，自动过滤出包含搜索关键词的脚本"))]}]},Me={id:"greasy-fork-panel-config-discussions",title:r.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(t){let e="discussions-readBgColor",A=c.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
...
`;Bt.addMenuOption({key:"githubUrl2webhookUrl",text:"⚙ "+r.t("Url To WebhookUrl"),autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{xe.showView();}});h.$data.panelConfig={style:Se};mt.addContentConfig([Pe,Ce,ze,Me,ke]);h.init();dt.init();

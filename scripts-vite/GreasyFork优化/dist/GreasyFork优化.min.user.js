...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof le=="function"?le(e.keyName):"";typeof t=="string"&&t?te(t):re.addLinkNode(e.url);},async addLinkNode(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,f.ready(()=>{document.head.appendChild(t);}),t},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e}},Oe={init(){p.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),p.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){d.info("美化 历史版本 页面");let e=[];return e.push(v(De)),e.push(re.addBlockCSS(".version-number",".version-date",".version-changelog")),f.ready(function(){let t=document.querySelector("ul.history_versions");if(!t){g.error(n.t("未找到history_versions元素列表"));return}Array.from(t.children).forEach(r=>{var h,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(h=r.querySelector(".version-date"))==null?void 0:h.getAttribute("datetime"),s=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=f.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),c=f.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
						...
						`});f.after(e,c);});});}};let ne=[];const xe=async function(e){if(d.info("当前脚本id："+e),!C.isLogin){d.error("请先登录账号"),g.error(n.t("请先登录账号"));return}let t=L.getUserId(C.getUserLinkElement().href);if(t==null){d.error("获取用户id失败"),g.error(n.t("获取用户id失败"));return}if(!ne.length){let o=g.loading(n.t("获取收藏夹中..."));if(ne=await $.getUserCollection(t)||[],o.close(),!ne.length)return}let r="";ne.forEach(o=>{r+=`
		...
		`});f.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=g.loading(n.t("添加中...")),c=await $.getUserCollectionInfo(t,s);if(!c){l.close();return}let u=m.cloneFormData(c),h=m.cloneFormData(c),y=!1;for(const[M,E]of c.entries())if(M==="scripts-included[]"&&String(E).trim()===String(e).trim()){y=!0;break}else h.append(M,E),u.append(M,E);if(y){g.warning(n.t("该脚本已经在该收藏集中")),l.close();return}u.set("add-script",e.toString()),u.set("script-action","i"),h.append("scripts-included[]",e.toString()),h.set("save","1");let b=new URLSearchParams(u),x=new URLSearchParams(h),S=Array.from(b).map(([M,E])=>`${encodeURIComponent(M)}=${encodeURIComponent(E)}`).join("&"),I=Array.from(x).map(([M,E])=>`${encodeURIComponent(M)}=${encodeURIComponent(E)}`).join("&");d.info(["添加的数据",S]),d.info(["保存的数据",I]);let _=await $.updateUserSetsInfo(t,s,S);if(!_){l.close();return}let k=_.querySelector(".change-script-set");if(!k){g.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let U=k.querySelector("section");if(!U){g.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let D=U.querySelector(".alert");D?B.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:D.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					...
					`,drag:!0,dragLimit:!0,width:B.isPhone()?"88vw":"400px",height:B.isPhone()?"50vh":"300px"}):(await $.updateUserSetsInfo(t,s,I),g.success(n.t("添加成功"))),l.close();}),f.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=g.loading(n.t("删除中...")),c=await $.getUserCollectionInfo(t,s);if(!c){l.close();return}let u=new FormData,h=new FormData,y=!1;for(const[k,U]of c.entries()){if(String(k).trim()==="scripts-included[]"&&String(U).trim()===String(e).trim()){y=!0;continue}h.append(k,U),u.append(k,U);}if(!y){g.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:e})),l.close();return}u.set("remove-scripts-included[]",e.toString()),u.set("remove-selected-scripts","i"),u.delete("script-action"),h.set("save","1");let b=new URLSearchParams(u),x=new URLSearchParams(h),S=Array.from(b).map(([k,U])=>`${encodeURIComponent(k)}=${encodeURIComponent(U)}`).join("&"),I=Array.from(x).map(([k,U])=>`${encodeURIComponent(k)}=${encodeURIComponent(U)}`).join("&");if(d.info(["删除的数据",S]),d.info(["保存的数据",I]),!await $.updateUserSetsInfo(t,s,S)){l.close();return}await $.updateUserSetsInfo(t,s,I),g.success(n.t("删除成功")),l.close();});},Pe={init(){T.isCode()?qe.init():T.isVersion()&&Oe.init(),T.isCodeStrict()&&(p.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),p.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),p.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),p.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),p.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){d.info("添加收藏按钮"),m.waitNode("ul#script-links li.current span").then(()=>{let e=f.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});f.append(document.querySelector("ul#script-links"),e),f.on(e,"click",()=>{let t=window.location.pathname.match(/scripts\/([\d]+)/i);if(!t){d.error([t,window.location.pathname]),g.error(n.t("获取脚本id失败"));return}let r=t[t.length-1];xe(r);});});},fullScreenOptimization(){d.info("F11全屏，F键代码全屏"),v(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
...
`),m.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},je={id:"greasy-fork-panel-config-scripts",title:n.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:n.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("添加复制代码按钮"),"addCopyCodeButton",!0,void 0,n.t("更优雅的复制")),w(n.t("快捷键"),"fullScreenOptimization",!0,void 0,n.t("【F】键全屏、【Alt+Shift+F】键宽屏")),w(n.t("修复代码行号显示"),"code-repairCodeLineNumber",!0,void 0,n.t("修复代码行数超过1k行号显示不全问题"))]}]},{text:n.t("历史版本"),type:"deepMenu",forms:[{text:n.t("功能"),type:"forms",forms:[w(n.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",!0,void 0,n.t("在版本下面添加【安装】、【查看代码】按钮"))]},{text:n.t("美化"),type:"forms",forms:[w(n.t("美化历史版本页面"),"beautifyHistoryVersionPage",!0,void 0,n.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("添加【寻找引用】按钮"),"addFindReferenceButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),w(n.t("添加【收藏】按钮"),"addCollectionButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),w(n.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",!0,void 0,n.t("在脚本信息栏添加【今日检查】信息块"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化脚本列表"),"beautifyCenterContent",!0,void 0,n.t("双列显示且添加脚本卡片操作项（安装、收藏）"))]}]},{text:n.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${n.t("帮助文档")}</a>`,type:"forms",forms:[w(n.t("启用"),"gf-scripts-filter-enable",!0,void 0,n.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(e){let t=f.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=j.getValue(),f.on(r,["input","propertychange"],void 0,m.debounce(function(i){j.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},H={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){d.info("论坛-过滤"),v(`
...
`),l=o.trim()===""?[]:o.split(`
`),c=a.trim()===""?[]:a.split(`
`);s.forEach(u=>{this.addValue("scriptId",m.parseStringToRegExpString("^"+u+"$"));}),l.forEach(u=>{this.addValue("postUserId",m.parseStringToRegExpString("^"+u+"$"));}),c.forEach(u=>{this.addValue("replyUserId",m.parseStringToRegExpString("^"+u+"$"));}),p.deleteValue(e),p.deleteValue(t),p.deleteValue(r);},setValue(e){p.setValue(this.key,e);},addValue(e,t){let r=this.getValue();if(r.trim()!==""&&(r+=`
`),m.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return p.getValue(this.key,"")}},We={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=f.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
										...
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=t.querySelector("textarea");return r.value=H.getValue(),f.on(r,["input","propertychange"],void 0,m.debounce(function(i){H.setValue(r.value);},200)),e.appendChild(t),e}}]}]}]}]},Se={async UIScriptList(e,t,r,i){var h,y,b;if(!C.isLogin){g.error(n.t("请先登录账号！"));return}let a=C.getUserLinkElement().href,s=(b=(y=(h=a==null?void 0:a.split("/"))==null?void 0:h.pop())==null?void 0:y.match(/([0-9]+)/))==null?void 0:b[0],l=B.loading({mask:{enable:!0},parent:i,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),c=await $.getUserInfo(s);if(l.close(),!c)return;d.info(c);let u=e==="script-list"?c.scriptList:c.scriptLibraryList;g.success(n.t("获取成功，共 {{count}} 个",{count:u.length}));for(const x of u){let S=f.createElement("li",{className:"w-script-list-item",innerHTML:`
...
`,st={init(){p.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),p.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),p.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),p.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){d.info("美化页面元素");let e=[];return e.push(v(Xe)),e.push(v(et)),e.push(v(tt)),e.push(v(rt)),e.push(v(nt)),e.push(v(`
			...
			`)),f.ready(function(){let t=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');t&&t.parentElement.replaceChild(f.createElement("span",{textContent:"Markdown"}),t),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&e.push(v(`
					...
					`));}),e},beautifyGreasyforkBeautify(){d.info("美化 Greasyfork Beautify脚本");let e=[];return e.push(v(ot)),m.isPhone()?e.push(v(`
				section#script-info,
        ...
        `);},addShortcutOperationButton(){d.info("添加快捷操作按钮"),H.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=f.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),f.on(o,"click",a=>{var y,b,x;m.preventEvent(a);const s=H.parseDiscuessionListContainerInfo(e);let l="data-filter-key",c="data-filter-value",u=B.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	...
	margin-right: 15px;\r
		...
		`),f.ready(()=>{let e=document.querySelector("#site-nav nav"),t=document.querySelector("#site-nav .with-submenu nav"),r=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!r){d.warn("不存在右侧面板元素#script-list-option-groups");return}if(r=r.cloneNode(!0),r.classList.add("option-panel-groups"),!e){d.error("元素#site-nav nav不存在");return}let i=f.createElement("li",{className:"filter-scripts",innerHTML:`
                ...
                `});f.on(i,"click",o=>{m.preventEvent(o),B.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:m.getMaxZIndex(100),style:`

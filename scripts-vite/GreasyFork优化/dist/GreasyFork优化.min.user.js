...
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof ht=="function"?ht(t.keyName):"";typeof e=="string"&&e?P(e):tt.loadStyleLink(t.url);},async loadStyleLink(t){let e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.href=t,u.ready(()=>{document.head.appendChild(e);});},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(A=>{e.onload=()=>{A(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;let e=new URL(t);return e.protocol="https:",e.toString()},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let A=[document.documentElement,document.body].concat(...t||[]);return A.forEach(n=>{n.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){A.forEach(n=>{n.classList.remove("pops-overflow-hidden-important");}),e.remove();}}}};Vt();R(Y,{});const Ft=r.t("GreasyFork优化"),g=lt.noConflict(),u=T.noConflict(),D=Mt,d=new g.Log(ft,j.console||Xt.console);var Ct;const xt=((Ct=ft==null?void 0:ft.script)==null?void 0:Ct.name)||Ft,kt=false;d.config({debug:kt,logMaxCount:1e3,autoClearConsole:true,tag:true});h.config(Object.defineProperties({html:true,autoClose:true,showClose:false},{position:{get(){return v.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return v.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return v.getValue("qmsg-config-showreverse",true)}},zIndex:{get(){let t=lt.getMaxZIndex(),e=Mt.config.InstanceUtils.getPopsMaxZIndex().zIndex;return lt.getMaxValue(t,e)+100}}}));const Et=new g.GM_Menu({GM_getValue:R,GM_setValue:V,GM_registerMenuCommand:Ut,GM_unregisterMenuCommand:Kt}),O=new g.Httpx(Rt);O.interceptors.response.use(void 0,t=>(d.error("拦截器-请求错误",t),t.type==="onabort"?h.warning(r.t("请求取消")):t.type==="onerror"?h.error(r.t("请求异常")):t.type==="ontimeout"?h.error(r.t("请求超时")):h.error(r.t("其它错误")),t));O.config({logDetails:kt});j.Object.defineProperty,j.Function.prototype.apply,j.Function.prototype.call,j.Element.prototype.appendChild,j.setTimeout;const P=g.addStyle.bind(g),L=document.querySelector.bind(document),k=document.querySelectorAll.bind(document),nt=function(t,e,A,n,i,a,o,s,l){return {text:t,type:"button",description:e,buttonIcon:n,buttonIsRightIcon:i,buttonIconIsLoading:a,buttonType:o,buttonText:A,callback(p){typeof s=="function"&&s(p);},afterAddToUListCallBack:l}},vt=function(t,e,A,n,i,a="",o,s){let l={text:t,type:"input",isNumber:!!o,isPassword:!!s,props:{},attributes:{},description:n,getValue(){return this.props[W].get(e,A)},callback(c,p){this.props[W].set(e,p);},placeholder:a};return Reflect.set(l.attributes,ct,e),Reflect.set(l.attributes,dt,A),Reflect.set(l.props,W,{get(c,p){return v.getValue(c,p)},set(c,p){v.setValue(c,p);}}),l},w=function(t,e,A,n,i,a){let o={text:t,type:"switch",description:i,attributes:{},props:{},getValue(){return !!this.props[W].get(e,A)},callback(s,l){let c=!!l;d.success(`${c?"开启":"关闭"} ${t}`),this.props[W].set(e,c);},afterAddToUListCallBack:a};return Reflect.set(o.attributes,ct,e),Reflect.set(o.attributes,dt,A),Reflect.set(o.props,W,{get(s,l){return v.getValue(s,l)},set(s,l){v.setValue(s,l);}}),o},z={getInstallUrl(t,e,A){return g.isNotNull(A)?A="/"+A:A="",`https://update.${window.location.hostname}/scripts/${t}/${e}${A}.user.js`},getCodeUrl(t,e){return g.isNull(e)&&(e=""),`/scripts/${t}/code?version=${e}`},getCodeSearchUrl(t){return "/zh-CN/scripts/code-search?c="+encodeURIComponent(t)},getScriptInfoUrl(t){return `/scripts/${t}.json`},getAdminUrl(t){return t+"/admin"},getScriptId(t){var e,A;return (A=(e=t||window.location.pathname)==null?void 0:e.match(/\/scripts\/([\d]+)/i))==null?void 0:A[1]},getUserId(t){var e;return (e=(t||window.location.pathname).match(/\/users\/([\d]+)/i))==null?void 0:e[1]},getReportUrl(t,e){return `${window.location.origin}/reports/new?item_class=${t}&item_id=${e}`},getScriptName(t){let e=window.location.pathname;t!=null&&(e=new URL(t).pathname),e=decodeURIComponent(e);let A=e.split("/");for(const n of A){let i=n.match(/[\d]+/);if(i&&i.length)return i[1]}},getSwitchLanguageUrl(t="zh-CN"){let e=window.location.origin,A=window.location.pathname.split("/");return A[1]=t,e=e+A.join("/"),e+=window.location.search,window.location.search===""?e+="?locale_override=1":window.location.search.includes("locale_override=1")||(e+="&locale_override=1"),e}},et={getCurrentLoginUserId(){let t=L("#nav-user-info .user-profile-link a");if(!t)return;let e=z.getUserId(t.href);if(e!=null)return e},parseScriptListInfo(t){let e=t.dataset;const A={scriptId:parseInt(e.scriptId),scriptName:e.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(e.scriptDailyInstalls),scriptTotalInstalls:parseInt(e.scriptTotalInstalls),scriptRatingScore:parseFloat(e.scriptRatingScore),scriptCreatedDate:new Date(e.scriptCreatedDate),scriptUpdatedDate:new Date(e.scriptUpdatedDate),scriptType:e.scriptType,scriptVersion:e.scriptVersion,sensitive:e.sensitive==="true",scriptLanguage:e.scriptLanguage,cssAvailableAsJs:e.cssAvailableAsJs==="true",codeUrl:e.codeUrl,scriptDescription:e.scriptDescription,scriptAuthorId:parseInt(e.scriptAuthorId),scriptAuthorName:e.scriptAuthorName};let n=g.toJSON(e.scriptAuthors);if(Object.keys(n).forEach(i=>{let a=n[i];A.scriptAuthors.push({authorId:parseInt(i),authorName:a});}),(A.scriptAuthorName==null||isNaN(A.scriptAuthorId))&&A.scriptAuthors.length&&(A.scriptAuthorName=A.scriptAuthors[0].authorName,A.scriptAuthorId=A.scriptAuthors[0].authorId),A.scriptDescription==null){let i=t.querySelector(".script-description")||t.querySelector(".description");i&&(A.scriptDescription=i.innerText||i.textContent);}return A},registerTopNavMenu(t){u.ready(()=>{let e=L("#site-nav nav"),A=L("#site-nav .with-submenu nav");if(!e){d.error("元素#site-nav nav不存在");return}let n=u.createElement("li",{className:t.className,innerHTML:`
                <a href="javascript:;">${t.name}</a>
                `});u.on(n,"click",s=>{g.preventEvent(s),t.clickEvent(s);}),A&&A.children.length?A.appendChild(n):e.appendChild(n);let i=u.createElement("li",{className:t.className,innerHTML:`
                <a href="javascript:;">${t.name}</a>
                `});u.on(i,"click",s=>{g.preventEvent(s),t.clickEvent(s);});let a=L("#mobile-nav nav"),o=L("#mobile-nav nav .multi-link-nav");o?u.before(o,i):a?u.append(a,i):d.error("元素#mobile-nav nav不存在");});}},B={async getScriptInfo(t){let e=z.getScriptInfoUrl(t),A=await O.get(e,{});return A.status?g.toJSON(A.data.responseText):void 0},async getScriptStats(t){let e=await O.get(`/scripts/${t}/stats.json`,{allowInterceptConfig:false});if(d.info(e),!e.status){d.error(r.t("获取脚本统计数据失败"));return}return g.toJSON(e.data.responseText)},async getSourceCodeSyncFormDataInfo(t){let e=await O.get(`/scripts/${t}/admin`,{fetch:true,allowInterceptConfig:false});if(d.info(e),!e.status){h.error(r.t("请求admin内容失败"));return}let A=e.data.responseText,i=u.parseHTML(A,false,true).querySelector("form.edit_script[action*='sync_update']");if(!i){h.error(r.t("解析admin的源代码同步表单失败"));return}let a=new FormData(i),o=i.querySelector("input[type='submit'][name='update-and-sync']");return o&&a.append(o.name,o.value),{url:i.action,formData:a}},async sourceCodeSync(t,e,A){let n=await O.post(A||`/scripts/${t}/sync_update`,{fetch:true,data:e,allowInterceptConfig:false,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Content-Type":"application/x-www-form-urlencoded",Origin:window.location.origin,Referer:window.location.href,"User-Agent":g.getRandomPCUA()}});if(d.info(n),!n.status){h.error(r.t("源代码同步失败"));return}return n},async getUserInfo(t){let e=await O.get(`/users/${t}.json`,{allowInterceptConfig:false});if(d.success(e),!e.status){h.error(r.t("获取用户信息失败"));return}let A=g.toJSON(e.data.responseText);if(A.scriptList=[],A.scriptLibraryList=[],A.scripts.forEach(n=>{n.code_url.endsWith(".user.js")?A.scriptList.push(n):A.scriptLibraryList.push(n);}),!A.scriptLibraryList.length){let n=await O.get(`/users/${t}`,{fetch:true,allowInterceptConfig:false});if(!n.status){h.error(r.t("获取用户主页信息失败"));return}let i=n.data.responseText,a=u.parseHTML(i,true,true),o=a.querySelector("#user-library-script-list");o?o.querySelectorAll("li").forEach(s=>{let l=et.parseScriptListInfo(s),c=s.querySelector("a.script-link").href;A.scriptLibraryList.push({id:l.scriptId,created_at:l.scriptCreatedDate.toISOString(),daily_installs:l.scriptDailyInstalls,total_installs:l.scriptTotalInstalls,code_updated_at:l.scriptUpdatedDate.toISOString(),support_url:null,fan_score:l.scriptRatingScore.toString(),namespace:null,contribution_url:null,contribution_amount:null,good_ratings:0,ok_ratings:0,bad_ratings:0,name:l.scriptName,description:l.scriptDescription,url:c,code_url:l.codeUrl,license:null,version:l.scriptVersion,locale:l.scriptLanguage,deleted:false});}):d.error("解析用户主页的库列表失败",a);}return A},async getUserCollection(t){let e=await O.get(`/users/${t}`,{fetch:true,allowInterceptConfig:false});if(d.info("获取用户的收藏集",e),!e.status){h.error(r.t("获取用户的收藏集失败"));return}let A=e.data.responseText,i=u.parseHTML(A,true,true).querySelector("#user-script-sets");if(!i){d.error("解析Script Sets失败");return}let a=[];return i.querySelectorAll("li").forEach(o=>{var f;let s=o.querySelector("a:last-child");if(!s)return;let l=s.href;if(l.includes("?fav=1"))return;let c=o.querySelector("a").innerText,p=(f=l.match(/\/sets\/([\d]+)\//))==null?void 0:f[1];a.push({id:p,name:c});}),a},async getUserCollectionInfo(t,e){let A=await O.get(`/users/${t}/sets/${e}/edit`,{fetch:true,allowInterceptConfig:false});if(d.info(A),!A.status){h.error(r.t("获取收藏集{{setsId}}失败",{setsId:e}));return}let n=A.data.responseText,i=u.parseHTML(n,true,true),a=i.querySelector('form[id^="edit_script_set"]');if(!a){h.error(r.t("获取表单元素#edit_script_set失败"));return}let o=new FormData(a),s=i.querySelector('meta[name="csrf-token"]');if(!s){h.error(r.t("获取表单csrfToken失败"));return}if(s.hasAttribute("content")){let l=s.getAttribute("content");l&&o.set("authenticity_token",l);}return o},async updateUserSetsInfo(t,e,A){let n=await O.post(`/users/${t}/sets/${e}`,{fetch:true,allowInterceptConfig:false,headers:{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"no-cache","Content-Type":"application/x-www-form-urlencoded",Pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:A});if(d.info(n),!n.status){h.error(r.t("更新收藏集表单请求失败"));return}let i=n.data.responseText;return u.parseHTML(i,true,true)},async switchLanguage(t){let e=await O.get(t,{fetch:true,headers:{"Upgrade-Insecure-Requests":"1"}});d.info(e),e.status;}},C={isHome(){return window.location.pathname.split("/").length<=2&&window.location.search===""},isCode(){var t;return !!((t=window.location.pathname.split("/"))!=null&&t.includes("code"))},isCodeStrict(){return !!window.location.pathname.match(/\/code(\/|)$/)},isVersion(){return !!window.location.pathname.match(/\/versions(\/|)$/)},isUsers(){return !!window.location.pathname.match(/\/.+\/users\/.+/gi)},isUsersConversations(){return this.isUsers()&&!!window.location.pathname.includes("/conversations")},isUsersConversationsWithSomeUser(){return this.isUsersConversations()&&!!window.location.pathname.match(/\/conversations\/[\d]+/)},isScript(){return !!window.location.pathname.match(/\/scripts\/[\d+]/)},isScriptAdmin(){return !!window.location.pathname.endsWith("/admin")},isScriptList(){return !!window.location.pathname.match(/\/scripts(\/|)$/)},isScriptsBySite(){return !!window.location.pathname.match("/scripts/by-site")},isScriptsFeedback(){return this.isScript()&&window.location.pathname.match(/\/feedback(\/|)$/i)},isScriptLibraryList(){return !!window.location.pathname.match(/\/libraries(\/|)$/)},isScriptSearch(){let t=new URLSearchParams(window.location.search);return this.isScriptList()&&t.has("q")},isScriptCodeSearch(){return !!window.location.pathname.match(/\/code-search(\/|)$/)},isScriptLibraryListSearch(){let t=new URLSearchParams(window.location.search);return this.isScriptLibraryList()&&t.has("q")},isDiscuessions(){return !!window.location.pathname.match(/\/discussions(\/|)$/)},isImageSource(){return window.location.pathname.startsWith("/vite/assets")}},M={menu:Et,isLogin:false,initEnv(){let t=this.getUserLinkElement();this.isLogin=!!t;},getUserLinkElement(){return L("#nav-user-info span.user-profile-link a")},async updateScript(t){let e=function(A,n=1){return `
			...
			</div>`};if(g.isNull(t))h.error(r.t("未获取到【脚本列表】"));else {let A=h.loading(e(z.getScriptName(t[0])),{html:true}),n=0,i=0;for(let a=0;a<t.length;a++){let o=t[a],s=z.getScriptId(o);d.success("更新："+o);let l=z.getScriptName(o);A.setHTML(e(l,a+1));let c=await B.getSourceCodeSyncFormDataInfo(s);if(c){const{formData:p,url:f}=c;await B.sourceCodeSync(s,p,f)?(h.success(r.t("源代码同步成功，3秒后更新下一个")),await g.sleep(3e3),n++):(h.error(r.t("源代码同步失败")),i++);}else h.error(r.t("源代码同步失败")),i++;}A.close(),n===0?h.error(r.t("全部更新失败")):h.success(r.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:n,failedNums:i,scriptUrlListLength:t.length}),{html:true});}},handleLocalGotoCallBack(){if(v.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(v.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!C.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_scriptList",true),M.getUserLinkElement()?(h.success(r.t("前往用户主页")),window.location.href=M.getUserLinkElement().href):h.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];k("#user-script-list-section li a.script-link").forEach(e=>{t=t.concat(z.getAdminUrl(e.href));}),M.updateScript(t);}else if(v.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(v.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!C.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),M.getUserLinkElement()?(h.success(r.t("前往用户主页")),window.location.href=M.getUserLinkElement().href):h.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];k("#user-unlisted-script-list li a.script-link").forEach(e=>{t=t.concat(z.getAdminUrl(e.href));}),M.updateScript(t);}else if(v.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(v.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!C.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),M.getUserLinkElement()?(h.success(r.t("前往用户主页")),window.location.href=M.getUserLinkElement().href):h.error(r.t("获取当前已登录的用户主页失败"));return}let t=[];k("#user-library-script-list li a.script-link").forEach(e=>{t=t.concat(z.getAdminUrl(e.href));}),M.updateScript(t);}}},rt=function(t,e,A,n,i,a){let o=[];typeof n=="function"?o=n():o=n;let s={text:t,type:"select",description:a,attributes:{},props:{},getValue(){return this.props[W].get(e,A)},callback(l,c,p){let f=c;d.info(`选择：${p}`),this.props[W].set(e,f),typeof i=="function"&&i(l,f,p);},data:o};return Reflect.set(s.attributes,ct,e),Reflect.set(s.attributes,dt,A),Reflect.set(s.props,W,{get(l,c){return v.getValue(l,c)},set(l,c){v.setValue(l,c);}}),s},Yt=function(t,e,A,n,i,a="default",o){let s=typeof i=="function"?i():i;typeof n=="object"&&o.initConfig(A,n);let l=()=>o.getShowText(A,s),c=nt(t,e,l,"keyboard",false,false,a,async p=>{var y;let m=(y=p.target.closest(".pops-panel-button"))==null?void 0:y.querySelector("span");if(o.isWaitPress){h.warning("请先执行当前的录入操作");return}if(o.hasOptionValue(A))o.emptyOption(A),h.success("清空快捷键");else {let x=h.loading("请按下快捷键...",{showClose:true,onClose(){o.cancelEnterShortcutKeys();}}),{status:b,option:S,key:E}=await o.enterShortcutKeys(A);x.close(),b?(d.success(["成功录入快捷键",S]),h.success("成功录入")):h.error(`快捷键 ${o.translateKeyboardValueToButtonText(S)} 已被 ${E} 占用`);}m.innerHTML=l();});return c.attributes={},Reflect.set(c.attributes,St,()=>false),c};class Zt{constructor(e){st(this,"key","short-cut");st(this,"$data");st(this,"isWaitPress",false);st(this,"currentWaitEnterPressInstanceHandler",null);typeof e=="string"&&(this.key=e),this.$data={otherShortCutOptions:[]};}initConfig(e,A){this.hasOption(e)||this.setOption(e,A);}getStorageKey(){return this.key}getLocalAllOptions(){return R(this.key,[])}hasOption(e){return !!this.getLocalAllOptions().find(i=>i.key===e)}hasOptionValue(e){if(this.hasOption(e)){let A=this.getOption(e);return (A==null?void 0:A.value)!=null}else return  false}getOption(e,A){return this.getLocalAllOptions().find(a=>a.key===e)??A}setOption(e,A){let n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===e);i==-1?n.push({key:e,value:A}):Reflect.set(n[i],"value",A),V(this.key,n);}emptyOption(e){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===e);return i!==-1&&(n[i].value=null,A=true),V(this.key,n),A}deleteOption(e){let A=false,n=this.getLocalAllOptions(),i=n.findIndex(a=>a.key===e);return i!==-1&&(n.splice(i,1),A=true),V(this.key,n),A}translateKeyboardValueToButtonText(e){let A="";return e.ohterCodeList.forEach(n=>{A+=g.stringTitleToUpperCase(n,true)+" + ";}),A+=g.stringTitleToUpperCase(e.keyName),A}getShowText(e,A){if(this.hasOption(e)){let n=this.getOption(e);return n.value==null?A:this.translateKeyboardValueToButtonText(n.value)}else return A}async enterShortcutKeys(e){const A=this;return new Promise(n=>{this.isWaitPress=true;let i=u.listenKeyboard(window,"keyup",(a,o,s)=>{const l={keyName:a,keyValue:o,ohterCodeList:s};let c={};try{const p=JSON.stringify(l),f=this.getLocalAllOptions();Array.isArray(this.$data.otherShortCutOptions)&&f.push(...this.$data.otherShortCutOptions);for(let m=0;m<f.length;m++){let y=f[m];if(y.key===e)continue;const x=JSON.stringify(y.value);let b=!1;if(y.value!=null&&p===x&&(b=!0),b){c={status:!1,key:y.key,option:l};return}}this.setOption(e,l),c={status:!0,key:e,option:l};}catch(p){console.log(p),c={status:false,key:e,option:l};}finally{A.isWaitPress=false,i.removeListen(),A.currentWaitEnterPressInstanceHandler=null,n(c);}});A.currentWaitEnterPressInstanceHandler=null,A.currentWaitEnterPressInstanceHandler=()=>{A.isWaitPress=false,i.removeListen();};})}cancelEnterShortcutKeys(){typeof this.currentWaitEnterPressInstanceHandler=="function"&&this.currentWaitEnterPressInstanceHandler();}initGlobalKeyboardListener(e,A){let n=this.getLocalAllOptions();if(!n.length){d.warn("没有设置快捷键");return}const i=this;function a(l,c){u.listenKeyboard(l,"keydown",(p,f,m,y)=>{if(i.isWaitPress)return;A!=null&&A.isPrevent&&g.preventEvent(y),n=i.getLocalAllOptions();let x=n.findIndex(b=>{let S=b.value,E={keyName:p,keyValue:f,ohterCodeList:m};if(JSON.stringify(S)===JSON.stringify(E))return b});if(x!=-1){let b=n[x];b.key in c&&(d.info(["调用快捷键",b]),c[b.key].callback());}},{capture:!!(A!=null&&A.capture)});}let o={},s={};Object.keys(e).forEach(l=>{let c=e[l];(c.target==null||typeof c.target=="string"&&c.target==="")&&(c.target="window"),c.target==="window"?Reflect.set(o,l,c):Reflect.set(s,l,c);}),a(window,o),u.ready(()=>{Object.keys(s).forEach(async l=>{let c=s[l];if(typeof c.target=="string")g.waitNode(c.target,1e4).then(p=>{if(!p)return;let f={};Reflect.set(f,l,c),a(p,f);});else if(typeof c.target=="function"){let p=await c.target();if(p==null)return;let f={};Reflect.set(f,l,c),a(p,f);}else {let p={};Reflect.set(p,l,c),a(c.target,p);}});});}}const Dt={shortCut:new Zt,shortOption:{"gf-quickReply":{target:()=>{let t=L("form textarea"),e=L('input[name="commit"][type="submit"]');if(t){if(!e){d.error("页面不存在【发表回复】按钮");return}}else {d.error("页面不存在输入框");return}return d.success("监听快捷键：gf-quickReply"),t},callback(){if(document.activeElement){let t=document.activeElement.closest("form");if(!t){d.error("当前activeElement不在表单内，无法触发快捷键");return}let e=t.querySelectorAll('input[name="commit"][type="submit"]');if(!e.length){d.error("表单内不存在【发表回复】按钮");return}e.length>1&&d.warn("表单内存在多个【发表回复】按钮，只触发第一个"),e[0].click();}else d.error("当前页面没有激活元素，无法触发快捷键");}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},mt={$key:{DB_KEY:"data"},$data:{db:null},init(){this.$data.db=this.getDB(),v.execMenuOnce("rememberReplyContent",()=>{this.rememberReplyContent();}),v.execMenu("gf-autoClearRememberReplayContent",t=>{this.autoClearRememberReplayContent(t);});},getDB(){const t="reply_record",e="textarea_text";return new g.indexedDB(t,e,2)},async rememberReplyContent(){const t="记住回复内容 -- ";let e=k("form");if(!e.length){d.warn(t+"不存在表单");return}try{await this.clearRelayHistoryRememberContentText();}catch(A){d.error(A);}e.forEach(async A=>{let n=A.querySelector("textarea"),i=A.querySelector('input[type="submit"]');n&&i&&(d.success("开始监听form --- 记住回复内容",A),this.$data.db.get(this.$key.DB_KEY).then(a=>{if(!a.data)return;let o=a.data.findIndex(l=>this.checkUrlIsSame(window.location.href,l.url));if(o==-1)return;let s=a.data[o].text;d.success("填入历史输入内容："+s),n.value=s;}),u.on(n,["propertychange","input"],g.debounce(a=>{let o={url:window.location.href,text:n.value,time:Date.now()};this.$data.db.get(this.$key.DB_KEY).then(s=>{if(!s.success&&s.event&&s.event.type!=="success"){d.warn(s);return}s.data==null&&(s.data=[]);let l=s.data.findIndex(c=>this.checkUrlIsSame(window.location.href,c.url));l!==-1?g.isNull(o.text)?s.data.splice(l,1):s.data[l]=g.assign(s.data[l],o):s.data=s.data.concat(o),this.$data.db.save(this.$key.DB_KEY,s.data).then(c=>{c.success||d.error("保存失败",c);});});},25)),u.on(A,"submit",a=>{d.info("表单提交，刷新页面后清理内容："+window.location.href),V("delyClear_rememberReplyContent_url",window.location.href);},{capture:true}));});},async clearRelayHistoryRememberContentText(){const t="delyClear_rememberReplyContent_url";let e=R(t);if(e){let A=await this.$data.db.get(this.$key.DB_KEY);if(!A.data){d.info("表单记录：数据库是空的");return}let n=A.data.findIndex(a=>this.checkUrlIsSame(e,a.url));if(n==-1){d.info("表单记录：已不存在该数据"),bt(t);return}A.data.splice(n,1),(await this.$data.db.save(this.$key.DB_KEY,A.data)).success?(d.success("表单记录：成功清除"),bt(t)):d.error("表单记录：清除失败",A);}},checkUrlIsSame(t,e){let A=new URL(t),n=new URL(e);return A.origin===n.origin&&A.pathname===n.pathname},autoClearRememberReplayContent(t){const e="gf-last-time-autoClearRememberReplayContent";let A=R(e),n=t*24*60*60*1e3;if(A)if(Date.now()-A>n)V(e,Date.now());else return;V(e,Date.now());},async getAllRememberReplyContent(){return (await this.$data.db.get(this.$key.DB_KEY)).data??[]},async clearAllRememberReplyContent(){return (await this.$data.db.delete(this.$key.DB_KEY)).success}},Pt={async UIScriptList(t,e){var l,c,p;if(!M.isLogin){h.error(r.t("请先登录账号！"));return}let n=M.getUserLinkElement().href,i=(p=(c=(l=n==null?void 0:n.split("/"))==null?void 0:l.pop())==null?void 0:c.match(/([0-9]+)/))==null?void 0:p[0],a=D.loading({mask:{enable:true},parent:e,content:{text:r.t("获取信息中，请稍后...")},addIndexCSS:false}),o=await B.getUserInfo(i);if(a.close(),!o)return;d.info(o);let s=t==="script-list"?o.scriptList:o.scriptLibraryList;h.success(r.t("获取成功，共 {{count}} 个",{count:s.length}));for(const f of s){let m=u.createElement("li",{className:"w-script-list-item",innerHTML:`
            ...
            `}),y=m.querySelector(".w-script-info"),x=u.createElement("div",{className:"pops-panel-button",innerHTML:`
				<button type="primary" data-icon="" data-righticon="false">
				<span>${r.t("同步代码")}</span>
				</button>
				`});f.deleted&&(m.classList.add("w-script-deleted"),x.querySelector("button").setAttribute("disabled","true")),u.on(x,"click",async function(){d.success("同步",f);let b=x.querySelector("button"),S=x.querySelector("button span"),E=u.createElement("i",{className:"pops-bottom-icon",innerHTML:D.config.iconSVG.loading},{"is-loading":true});b.setAttribute("disabled","true"),b.setAttribute("data-icon","true"),S.innerText=r.t("同步中..."),u.before(S,E);let H=f==null?void 0:f.id,G=await B.getSourceCodeSyncFormDataInfo(H.toString());if(G){const{formData:I,url:K}=G,N="script[script_sync_type_id]",q="script[sync_type]";if(I.has(N)||I.has(q)){let Q="";if(I.has(N)){let X=I.get(N);X.toString()==="1"?Q=r.t("手动"):X.toString()==="2"?Q=r.t("自动"):X.toString()==="3"&&(Q="webhook");}else I.has(q)&&(Q=I.get(q));let U=m.querySelector(".w-script-sync-type");U?U.querySelector("p").innerText=r.t("同步方式：{{syncMode}}",{syncMode:Q}):u.append(y,`
								<div class="w-script-sync-type">
									<p>${r.t("同步方式：{{syncMode}}",{syncMode:Q})}
									</p>
								</div>`),await B.sourceCodeSync(f.id.toString(),I,K)?h.success(r.t("同步成功")):h.error(r.t("同步失败"));}else h.error(r.t("该脚本未设置同步信息"));}b.removeAttribute("disabled"),b.removeAttribute("data-icon"),S.innerText=r.t("同步代码"),E.remove();}),m.appendChild(x),e.appendChild(m);}}};let Lt=false;const wt={isCurrentLoginUserHome(){let t=et.getCurrentLoginUserId();return !!(t!=null&&C.isUsers()&&window.location.pathname.includes("/"+t))},monacoEditor(){const t="0.52.2",e="monaco-editor-ready";d.info("网络加载monaco编辑器中，请稍后..."),Lt||(Lt=true,P(`
				@font-face {
					font-family: 'codicon';
					src: url('https://fastly.jsdelivr.net/npm/monaco-editor@${t}/min/vs/base/browser/ui/codicons/codicon/codicon.ttf') format('truetype');
				}
			`));let A=u.createElement("script",{type:"module",defer:true,innerHTML:`
					import * as monaco from "https://fastly.jsdelivr.net/npm/monaco-editor@${t}/+esm";
					window.monaco = monaco;
					window.dispatchEvent(new CustomEvent("${e}"));
				`});return u.append(document.head||document.documentElement,A),new Promise(n=>{u.on(j,e,()=>{let i=j.monaco;d.success("网络加载monaco编辑器成功"),n(i);},{once:true});})}},J={key:"gf-shield-rule",init(){d.info("脚本过滤");let t=new g.LockFunction(()=>{this.filter();},50);u.ready(()=>{if(wt.isCurrentLoginUserHome()){d.warn("当前在已登录的账户主页下，禁用脚本过滤");return}g.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{t.run();}}),t.run();});},getElementList(){return [...Array.from(k("ol.script-list li[data-script-name]"))]},filter(){this.getElementList().forEach(t=>{let e=et.parseScriptListInfo(t),A=this.getValue().split(`
`);for(let n=0;n<A.length;n++){let i=A[n],a=i.split("##"),o=a[0],s=a[1];if(o==="scriptRatingScore"){let l=parseFloat(s.slice(1));if(s.startsWith(">")){if(e.scriptRatingScore>l){d.info("触发脚本过滤规则",[i,e]),t.remove();break}}else if(s.startsWith("<")&&e.scriptRatingScore<l){d.info("触发脚本过滤规则",[i,e]),t.remove();break}}else if(o in e||o==="scriptDescription"){if(typeof s!="string")continue;let l=new RegExp(s,"ig");if(String(e[o]).match(l)){d.info("触发脚本过滤规则",i,e),t.remove();break}}}});},setValue(t){v.setValue(this.key,t);},addValue(t,e){let A=this.getValue();if(A.trim()!==""&&(A+=`
`),g.isNull(t))return;t=t.toString().trim();let n=t+"##"+e;A+=n,this.setValue(A);},getValue(){return v.getValue(this.key,"")}},Wt={id:"greasy-fork-panel-config-account",title:r.t("通用"),forms:[{text:"",type:"forms",forms:[{text:r.t("Toast配置"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[rt(r.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:r.t("左上角")},{value:"top",text:r.t("顶部")},{value:"topright",text:r.t("右上角")},{value:"left",text:r.t("左边")},{value:"center",text:r.t("中间")},{value:"right",text:r.t("右边")},{value:"bottomleft",text:r.t("左下角")},{value:"bottom",text:r.t("底部")},{value:"bottomright",text:r.t("右下角")}],(t,e,A)=>{d.info("设置当前Qmsg弹出位置"+A);},r.t("Toast显示在页面九宫格的位置")),rt(r.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,r.t("限制Toast显示的数量")),w(r.t("逆序弹出"),"qmsg-config-showreverse",false,void 0,r.t("修改Toast弹出的顺序"))]}]},rt(r.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(t,e,A)=>{d.info("改变语言："+A),r.changeLanguage(e);})]},{text:"",type:"forms",forms:[{text:r.t("账号/密码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[vt(r.t("账号"),"user","",void 0,void 0,r.t("请输入账号")),vt(r.t("密码"),"pwd","",void 0,void 0,r.t("请输入密码"),false,true),vt(r.t("secret"),"secret","","两步验证（2FA）",void 0,r.t("请输入secret"),false,true)]},{text:"",type:"forms",forms:[w(r.t("自动登录"),"autoLogin",true,void 0,r.t("自动登录当前保存的账号")),nt(r.t("清空账号/密码"),void 0,r.t("点击清空"),void 0,void 0,false,"default",t=>{if(confirm(r.t("确定清空账号和密码？"))){v.deleteValue("user"),v.deleteValue("pwd"),h.success(r.t("已清空账号/密码"));let e=t.target.getRootNode();e.querySelector('li[data-key="user"] .pops-panel-input input').value="",e.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}})]}]},{text:r.t("功能"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[rt(r.t("固定当前语言"),"language-selector-locale","",function(){let t=[{value:"",text:r.t("无")}];return u.ready(()=>{k("select.language-selector-locale option").forEach(e=>{let A=e.getAttribute("value");if(A==="help")return;let n=u.text(e).trim();t.push({value:A,text:n});});}),t}()),w(r.t("修复图片宽度显示问题"),"fixImageWidth",true,void 0,r.t("修复图片在移动端宽度超出浏览器宽度问题")),w(r.t("优化图片浏览"),"optimizeImageBrowsing",true,void 0,r.t("使用Viewer浏览图片")),w(r.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",true,void 0,r.t("配合上面的【优化图片浏览】更优雅浏览图片")),w(r.t("添加【操作面板】按钮"),"scripts-addOperationPanelBtnWithNavigator",true,void 0,r.t("在脚本列表页面时为顶部导航栏添加【操作面板】按钮")),w(r.t("给Markdown添加【复制】按钮"),"addMarkdownCopyButton",true,void 0,r.t("在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容"))]},{text:r.t("检测页面加载"),type:"forms",forms:[w(r.t("启用"),"checkPage",true,void 0,r.t("检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面")),rt(r.t("检测间隔"),"greasyfork-check-page-timeout",5,(()=>{let t=[];for(let e=0;e<5;e++)t.push({value:e+1,text:e+1+"s"});return t})(),void 0,r.t("设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面"))]}]},{type:"deepMenu",text:r.t("表单"),forms:[{type:"forms",text:"",forms:[w(r.t("记住回复内容"),"rememberReplyContent",true,void 0,r.t("监听表单内的textarea内容改变并存储到indexDB中，提交表单将清除保存的数据，误刷新页面时可动态恢复")),rt(r.t("自动清理空间"),"gf-autoClearRememberReplayContent",7,[{text:r.t("不清理"),value:-1},{text:r.t("{{value}} 天",{value:1}),value:1},{text:r.t("{{value}} 周",{value:1}),value:7},{text:r.t("{{value}} 个月",{value:1}),value:30},{text:r.t("{{value}} 个月",{value:2}),value:60},{text:r.t("{{value}} 个月",{value:3}),value:90},{text:r.t("半年"),value:180}],void 0,r.t("根据设置的间隔时间自动清理保存的回复内容")),nt(r.t("数据占用空间：{{size}}",{size:r.t("计算中")}),r.t("当前存储的数据所占用的空间大小"),r.t("清空"),void 0,void 0,void 0,"default",async()=>{await mt.clearAllRememberReplyContent()?h.success(r.t("清理成功")):h.error(r.t("清理失败"));},async(t,e)=>{let A=e.ulElement.querySelector('li[data-key="gf-autoClearRememberReplayContent"]+li .pops-panel-item-left-main-text'),n=await mt.getAllRememberReplyContent(),i="";n.length?i=g.getTextStorageSize(JSON.stringify(n)):i=g.getTextStorageSize(""),A.innerText=r.t("数据占用空间：{{size}}",{size:i});})]}]},{text:r.t("美化"),type:"deepMenu",forms:[{text:r.t("全局"),type:"forms",forms:[w(r.t("美化页面元素"),"beautifyPage",true,void 0,r.t("如button、input、textarea")),w(r.t("美化上传图片按钮"),"beautifyUploadImage",true,void 0,r.t("放大上传区域")),w(r.t("美化顶部导航栏"),"beautifyTopNavigationBar",true,void 0,r.t("可能会跟Greasyfork Beautify脚本有冲突")),w(r.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",false,void 0,r.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]},{type:"forms",text:r.t("脚本列表"),forms:[w(r.t("美化脚本列表"),"beautifyCenterContent",true,void 0,r.t("双列显示且添加脚本卡片操作项（安装、收藏）")),w("↑"+r.t("使用namespace查询脚本信息"),"beautifyCenterContent-queryNameSpace",true,void 0,r.t("开启后检测已安装的脚本信息更准确，但是速度会更慢"))]}]},{type:"deepMenu",text:r.t("自定义快捷键"),forms:[{type:"forms",text:"",forms:[Yt(r.t("快捷键发表回复"),r.t("在输入框内按下快捷发表回复，例如：{{key}}",{key:"Ctrl + Enter"}),"gf-quickReply",{keyName:"Enter",keyValue:"13",ohterCodeList:["ctrl"]},r.t("点击录入快捷键"),void 0,Dt.shortCut)]}]},{text:r.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${r.t("帮助文档")}</a>`,type:"forms",forms:[w(r.t("启用"),"gf-scripts-filter-enable",true,void 0,r.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(t){let e=u.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${r.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),A=e.querySelector("textarea");return A.value=J.getValue(),u.on(A,["input","propertychange"],void 0,g.debounce(function(n){J.setValue(A.value);},200)),t.appendChild(e),t}}]}]}]},{type:"forms",text:r.t("脚本管理"),forms:[{type:"deepMenu",text:r.t("代码同步"),forms:[{text:r.t("代码同步"),type:"forms",forms:[nt(r.t("源代码同步【脚本列表】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",t=>{if(!C.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_scriptList",true),M.getUserLinkElement()?(h.success(r.t("前往用户主页")),window.location.href=M.getUserLinkElement().href):h.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];k("#user-script-list-section li a.script-link").forEach(A=>{e=e.concat(z.getAdminUrl(A.href));}),M.updateScript(e);}),nt(r.t("源代码同步【未上架的脚本】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",t=>{if(!C.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",true),M.getUserLinkElement()?(h.success(r.t("前往用户主页")),window.location.href=M.getUserLinkElement().href):h.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];k("#user-unlisted-script-list li a.script-link").forEach(A=>{e=e.concat(z.getAdminUrl(A.href));}),M.updateScript(e);}),nt(r.t("源代码同步【库】"),void 0,r.t("一键同步"),void 0,void 0,false,"primary",t=>{if(!C.isUsers()){v.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",true),M.getUserLinkElement()?(h.success(r.t("前往用户主页")),window.location.href=M.getUserLinkElement().href):h.error(r.t("获取当前已登录的用户主页失败"));return}let e=[];k("#user-library-script-list li a.script-link").forEach(A=>{e=e.concat(z.getAdminUrl(A.href));}),M.updateScript(e);})]}]},{type:"deepMenu",text:r.t("脚本列表"),forms:[],afterEnterDeepMenuCallBack(t,e){Pt.UIScriptList("script-list",e.sectionBodyContainer);}},{type:"deepMenu",text:r.t("库"),forms:[],afterEnterDeepMenuCallBack(t,e){Pt.UIScriptList("script-library",e.sectionBodyContainer);}}]}]},Jt={id:"greasy-fork-panel-config-scripts",title:r.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:r.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(r.t("添加复制代码按钮"),"addCopyCodeButton",true,void 0,r.t("更优雅的复制")),w(r.t("快捷键"),"fullScreenOptimization",true,void 0,r.t("【F】键全屏、【Alt+Shift+F】键宽屏")),w(r.t("修复代码行号显示"),"code-repairCodeLineNumber",false,void 0,r.t("修复代码行数超过1k行号显示不全问题")),w("monacoEditor","code-use-monaco-editor",true,void 0,r.t("使用Monaco编辑器"))]}]},{text:r.t("历史版本"),type:"deepMenu",forms:[{text:r.t("功能"),type:"forms",forms:[w(r.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",true,void 0,r.t("在版本下面添加【安装】、【查看代码】按钮")),w(r.t("添加代码对比按钮"),"scripts-versions-addCompareCodeButton",true,void 0,r.t("monacoEditor"))]},{text:r.t("美化"),type:"forms",forms:[w(r.t("美化历史版本页面"),"beautifyHistoryVersionPage",true,void 0,r.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(r.t("添加【寻找引用】按钮"),"addFindReferenceButton",true,void 0,r.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),w(r.t("添加【收藏】按钮"),"addCollectionButton",true,void 0,r.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),w(r.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",true,void 0,r.t("在脚本信息栏添加【今日检查】信息块"))]}]}]}]},Z={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){d.info("论坛-过滤"),P(`
        ...
        `);let t=new g.LockFunction(()=>{this.filter();},50);g.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{t.run();}}),t.run();},getElementList(){let t=[];return t=t.concat(Array.from(k(".discussion-list-container"))),t},filter(){this.transformOldRule();const t=new Map;this.getElementList().forEach((e,A)=>{const n=this.parseDiscuessionListContainerInfo(e);let i=this.getValue().split(`
`);if(t.has(n.snippet)&&v.getValue("greasyfork-discussions-filter-duplicate-comments")){let a=t.get(n.snippet).querySelector("a.discussion-title");a.setAttribute("data-repeat-tip-show","true");let o=0;a.hasAttribute("data-repeat-count")&&(o=parseInt(a.getAttribute("data-repeat-count"))),o++,a.setAttribute("data-repeat-count",o.toString()),a.setAttribute("data-repeat-tip-show",r.t("已过滤：{{oldCount}}",{oldCount:o})),d.success([`过滤重复内容：${n.snippet}`,n]),e.remove();return}t.set(n.snippet,e);for(let a=0;a<i.length;a++){let o=i[a],s=o.split("##"),l=s[0],c=s[1];if(l in n){let p=new RegExp(c,"ig");if(n[l]!=null&&String(n[l]).match(p)){d.info("触发论坛过滤规则",o,n),e.remove();return}}}});},parseDiscuessionListContainerInfo(t){var a,o,s,l;let e=t.querySelector("a.discussion-title").href,A=e.match(/\/discussions(|\/greasyfork)\/([\d]+)/),n=A[A.length-1];const i={scriptName:t.querySelector(".discussion-meta-item-script-name").innerText,scriptUrl:(a=t.querySelector(".discussion-meta-item-script-name a"))==null?void 0:a.href,scriptId:z.getScriptId((o=t.querySelector(".discussion-meta-item-script-name a"))==null?void 0:o.href),postUserName:t.querySelector("a.user-link").innerText,postUserHomeUrl:t.querySelector("a.user-link").href,postUserId:z.getUserId(t.querySelector("a.user-link").href),postTimeStamp:new Date(t.querySelector("relative-time").getAttribute("datetime")),snippetId:n,snippetUrl:e,snippet:((s=t.querySelector("span.discussion-snippet"))==null?void 0:s.innerText)||"",replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};return t.querySelector(".discussion-meta-item .discussion-meta-item")&&(i.replyUserName=t.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").innerText,i.replyUserHomeUrl=t.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").href,i.replyUserId=z.getUserId(i.replyUserHomeUrl),i.replyTimeStamp=new Date((l=t.querySelector(".discussion-meta-item .discussion-meta-item relative-time"))==null?void 0:l.getAttribute("datetime"))),i},transformOldRule(){if(Date.now()>new Date("2024-8-19").getTime())return;const t="greasyfork-discussions-filter-script",e="greasyfork-discussions-filter-post-user",A="greasyfork-discussions-filter-reply-user",n=v.getValue(t,""),i=v.getValue(e,""),a=v.getValue(A,""),o=n.trim()===""?[]:n.split(`
`),s=i.trim()===""?[]:i.split(`
`),l=a.trim()===""?[]:a.split(`
...
`),g.isNull(t))return;t=t.toString().trim();let n=t+"##"+e;A+=n,this.setValue(A);},getValue(){return v.getValue(this.key,"")}},$t={id:"greasy-fork-panel-config-discussions",title:r.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:r.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(t){let e="discussions-readBgColor",A=u.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											<p class="pops-panel-item-left-main-text">${r.t("自定义已读颜色")}</p>
											<p class="pops-panel-item-left-desc-text">${r.t("在讨论内生效")}</p>
											`}),n=u.createElement("div",{className:"pops-panel-item-right",innerHTML:`
											<input type="color" class="pops-color-choose" />
											`}),i=n.querySelector(".pops-color-choose");i.value=v.getValue(e);let a=u.createElement("style");return u.append(document.head,a),u.on(i,["input","propertychange"],o=>{d.info("选择颜色："+i.value),a.innerHTML=`
												.discussion-read{
													background: ${i.value} !important;
												}
												`,v.setValue(e,i.value);}),t.appendChild(A),t.appendChild(n),t}},w(r.t("添加【过滤】按钮"),"discussions-addShortcutOperationButton",true,void 0,r.t("在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效")),w(r.t("添加【举报】按钮"),"discussions-addReportButton",true,void 0,r.t("在每一行讨论的最后面添加【举报】按钮"))]}]},{text:r.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%AE%BA%E5%9D%9B%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${r.t("帮助文档")}</a>`,type:"forms",forms:[w(r.t("启用"),"greasyfork-discussions-filter-enable",true,void 0,r.t("开启后下面的过滤功能才会生效")),w(r.t("过滤重复的评论"),"greasyfork-discussions-filter-duplicate-comments",true,void 0,r.t("过滤掉重复的评论数量(≥2)")),{type:"own",getLiElementCallBack(t){let e=u.createElement("div",{className:"pops-panel-textarea",innerHTML:`
										<textarea placeholder="${r.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),A=e.querySelector("textarea");return A.value=Z.getValue(),u.on(A,["input","propertychange"],void 0,g.debounce(function(n){Z.setValue(A.value);},200)),t.appendChild(e),t}}]}]}]}]},_t=`.w-script-list-item {\r
	padding: 10px;\r
...
`,ue="",fe={init(){v.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),v.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),v.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),v.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){d.info("美化页面元素");let t=[];return t.push(P(re)),t.push(P(ne)),t.push(P(oe)),t.push(P(ie)),t.push(P(ae)),t.push(P(`
			p:has(input[type="submit"][name="update-and-sync"]){
			  margin-top: 10px;
			}
			`)),u.ready(()=>{let e=L('a[target="markup_choice"][href*="daringfireball.net"]');e&&e.parentElement.replaceChild(u.createElement("span",{textContent:"Markdown"}),e),k(".user-content ul li").forEach(i=>{var o,s;let a=i.firstChild;(a==null?void 0:a.nodeName)==="#text"&&((o=a.textContent)!=null&&o.startsWith("[x] ")?(a.textContent=a.textContent.replace("[x] ",""),u.prepend(i,`
							<input type="checkbox" disabled="" class="task-list-item-checkbox" checked="">
						`)):(s=a.textContent)!=null&&s.startsWith("[ ] ")&&(a.textContent=a.textContent.replace("[ ] ",""),u.prepend(i,`
				...
				`},n=Object.keys(A);if(k(".user-content blockquote").forEach(i=>{Array.from(i.children).forEach(a=>{let o=u.html(a);if(a.nodeName==="P"){let s=n.find(l=>o.toLowerCase().startsWith(l.toLowerCase()));s&&(u.html(a,o.replace(s,"")),u.before(a,A[s]),u.html(a)===""&&a.remove());}});}),k(".user-content > blockquote").forEach(i=>{Array.from(i.querySelectorAll(".markdown-alert-title")).forEach(a=>{var s,l;let o=u.createElement("div",{className:"markdown-alert markdown-alert-tip"},{"data-type":a.getAttribute("data-type")});for(;a.nextSibling&&!((l=(s=a.nextSibling)==null?void 0:s.classList)!=null&&l.contains("markdown-alert-title"));)u.append(o,a.nextSibling);u.prepend(o,a),u.before(i,o);});}),C.isHome())t.push(P(de));else if(C.isScriptsFeedback()){t.push(P(ue));let i=L('.radio-label[for*="discussion_rating_0"]');i&&(i.innerHTML=i.innerHTML.replace("不评分",'<span class="rating-icon rating-icon-none">不评分</span>'));let a=L('.radio-label[for*="discussion_rating_2"]');a&&(a.innerHTML=a.innerHTML.replace("差评",'<span class="rating-icon rating-icon-bad">差评</span>'));let o=L('.radio-label[for*="discussion_rating_3"]');o&&(o.innerHTML=o.innerHTML.replace("一般",'<span class="rating-icon rating-icon-ok">一般</span>'));let s=L('.radio-label[for*="discussion_rating_4"]');s&&(s.innerHTML=s.innerHTML.replace("好评",'<span class="rating-icon rating-icon-good">好评</span>'));}else C.isScriptAdmin()&&(L('input[type="submit"][name="update-only"]')||t.push(P(`
					.indented{
						padding-left: unset;
					}
					`)));}),t},beautifyGreasyforkBeautify(){d.info("美化 Greasyfork Beautify脚本");let t=[];return t.push(P(le)),g.isPhone()?t.push(P(`
				section#script-info,
				...
				section#script-info{
					margin-top: 10px;
				}`)),t},beautifyUploadImage(){d.info("美化上传图片");let t=[];return t.push(P(se)),u.ready(()=>{function e(i){for(;i.nextElementSibling;)i.parentElement.removeChild(i.nextElementSibling);}let A=k('input[type="file"]');A.forEach(i=>{i.getAttribute("name")!=="code_upload"&&(i.hasAttribute("accept")&&i.getAttribute("accept").includes("javascript")||u.on(i,["propertychange","input"],function(a){e(a.target);let o=a.currentTarget.files;if(!o||o.length===0)return;d.info("选择的图片",o),o.length>5&&u.after(i,u.createElement("p",{textContent:r.t("❌ 最多同时长传5张图片")}));let s=[];Array.from(o).forEach(l=>{(l.size>204800||!l.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&s.push(l);}),s.length!==0&&s.forEach(l=>{u.after(i,u.createElement("p",{textContent:r.t("❌ 图片：{{name}} 大小：{{size}}",{name:l.name,size:l.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(i=>{u.on(i,"paste",a=>{d.info("触发粘贴事件",a),setTimeout(()=>{u.trigger(A,"input");},100);});});}),t},beautifyTopNavigationBar(){d.info("美化顶部导航栏");let t=[];return t.push(P(ce)),window.outerWidth>550&&(t.push(tt.addBlockCSS(".with-submenu")),u.ready(()=>{let A=L("#site-nav").querySelector("nav");k(".with-submenu nav li").forEach(n=>{A.appendChild(n);});})),t}},pe={init(){v.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){g.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let t=v.getValue("user"),e=v.getValue("pwd"),A=v.getValue("secret");if(g.isNull(t)){h.error(r.t("请先在菜单中录入账号"));return}if(g.isNull(e)){h.error(r.t("请先在菜单中录入密码"));return}if(g.isNull(A)){h.error(r.t("请先在菜单中录入secret"));return}let n=L("meta[name='csrf-token']");if(!n){h.error(r.t("获取csrf-token失败"));return}let a=new Nt__namespace.TOTP({secret:A}).generate(),o=h.loading(r.t("正在登录中...")),s=await O.post("/zh-CN/users/sign_in",{fetch:true,data:encodeURI(`authenticity_token=${n.getAttribute("content")}&user[email]=${t}&user[password]=${e}&user[remember_me]=1&user[otp_attempt]=${a}&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(o.destroy(),!s.status){d.error(s),h.error(r.t("登录失败，请求异常"));return}let l=s.data.responseText,c=u.parseHTML(l,true,true),p=c.querySelector(".width-constraint .alert");c.querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(h.success(r.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):p?(d.error(p),h.error(u.text(p))):(h.error(r.t("登录失败，可能是账号/密码错误，请在控制台查看原因"),{consoleLogContent:true}),d.error(s),d.error(`当前账号:${t}`),d.error(`当前密码:${e}`));});}},ve={init(){this.readBgColor(),u.ready(()=>{v.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();});let t=new g.LockFunction(()=>{v.execMenu("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();}),v.execMenu("discussions-addReportButton",()=>{this.addReportButton();});});g.mutationObserver(document.body,{config:{subtree:true,childList:true},immediate:true,callback:()=>{t.run();}});});},filterEnable(){d.info("启用Greasyfork论坛过滤器"),Z.init();},readBgColor(){d.info("设置已读背景颜色");let t=v.getValue("discussions-readBgColor");return P(`
        .discussion-read{
            background: ${t} !important;
        }
        `)},addShortcutOperationButton(){d.info("添加【过滤】按钮"),Z.getElementList().forEach(t=>{if(t.querySelector(".discussion-filter-button"))return;let A=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=u.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-filter-button">${r.t("过滤")}</button>
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-filter-button");A.appendChild(n),u.on(i,"click",a=>{var f,m,y;g.preventEvent(a);const o=Z.parseDiscuessionListContainerInfo(t);let s="data-filter-key",l="data-filter-value",c=D.alert({title:{text:r.t("选择需要过滤的选项"),position:"center",html:false},content:{text:`
						...
						`}),p=c.$shadowRoot.querySelector(".pops-alert-content");if(o.scriptId==null&&((f=p.querySelector(`button[${s}="scriptId"]`))==null||f.remove()),o.scriptName==null&&((m=p.querySelector(`button[${s}="scriptName"]`))==null||m.remove()),o.postUserId==null&&((y=p.querySelector(`button[${s}="postUserId"]`))==null||y.remove()),o.replyUserId!=null){let x=u.createElement("button",{innerHTML:r.t("作者id：{{text}}",{text:o.replyUserId})});x.setAttribute(s,"scriptAuthorId"),x.setAttribute(l,"^"+o.replyUserId+"$"),p.appendChild(x);}u.on(c.$shadowRoot,"click",`button[${s}]`,x=>{g.preventEvent(x);let b=x.target,S=b.getAttribute(s),E=b.getAttribute(l);Z.addValue(S,E),c.close(),Z.filter(),h.success(r.t("添加成功"));});});});},addReportButton(){d.info("添加【举报】按钮"),Z.getElementList().forEach(t=>{if(t.querySelector(".discussion-report-button"))return;let A=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),n=u.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-report-button" style="border-color: #ff4d4d;background-color: #ffe6e6;color: red;">${r.t("举报")}</button>
					`},{style:"flex: 0;"}),i=n.querySelector(".discussion-report-button");A.appendChild(n),u.on(i,"click",a=>{g.preventEvent(a);const o=Z.parseDiscuessionListContainerInfo(t);D.alert({title:{text:r.t("举报"),position:"center",html:false},content:{text:`
						<div class="report-item">
							${r.t("举报讨论：")}
							<a href="${z.getReportUrl("discussion",o.snippetId)}" target="_blank">${o.snippet}</a>
						</div>
						${o.scriptId?`
							<div class="report-item">
							${r.t("举报脚本：")}
							<a href="${z.getReportUrl("script",o.scriptId)}" target="_blank">${o.scriptName}</a>
						</div>
						`:""}
						
						<div class="report-item">
							${r.t("举报用户：")}
							<a href="${z.getReportUrl("user",o.postUserId)}" target="_blank">${o.postUserName}</a>
						</div>
						${o.replyUserId&&o.replyUserId!=o.postUserId?`
								<div class="report-item">
									${r.t("举报用户：")}
									<a href="${z.getReportUrl("user",o.replyUserId)}" target="_blank">${o.replyUserName}</a>
								</div>
								`:""}
							...
							`});});});}},ge={init(){v.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();}),v.execMenuOnce("code-use-monaco-editor",()=>{this.coverEditorWithMonaco();});},repairCodeLineNumber(){d.info("修复代码的行号显示不够问题"),v.execMenuOnce("beautifyGreasyforkBeautify",()=>{P(`
				.code-container pre code .marker{
					padding-left: 6px;
				}	
				`);}),g.waitNode("#script-content div.code-container pre.prettyprint ol").then(t=>{t.childElementCount>=1e3&&(d.success(`当前代码行数${t.childElementCount}行，超过1000行，优化行号显示问题`),P(`
                    pre.prettyprint{
                        padding-left: 26px;
                    }
					`));});},coverEditorWithMonaco(){d.info("使用monacoEditor替换编辑器"),P(`
			.monaco-editor{
		...
		`),tt.addBlockCSS("#script-content .code-container > pre"),wt.monacoEditor().then(async t=>{let e=z.getScriptId(window.location.href);if(!e){h.error("未解析出当前脚本ID",{consoleLogContent:true});return}let A=await B.getScriptInfo(e),n=A==null?void 0:A.code_url;if(!n){h.error("请求结果中未解析出脚本代码URL",{consoleLogContent:true});return}let i=new URLSearchParams(window.location.search);if(i.has("version")){let s=i.get("version");n=n.replace(new RegExp(`/${e}(/[\\d]+|)`),`/${e}/${s}`),d.info(`当前是历史代码页面，请求的脚本代码URL为${n}`);}let a=await O.get(n,{timeout:2e4});if(!a.status)return;let o=a.data.responseText;u.ready(async()=>{let s=await g.waitNode("#script-content .code-container > pre",1e4);if(!s)return;let l=u.createElement("div",{className:"monaco-editor"});u.after(s,l),t.editor.create(l,{value:o,minimap:{enabled:true},automaticLayout:true,codeLens:true,colorDecorators:true,contextmenu:true,readOnly:true,formatOnPaste:true,overviewRulerBorder:true,scrollBeyondLastLine:true,theme:"vs-dark",fontSize:window.innerWidth>600?14:12,wordWrap:"off",language:"javascript",folding:true,foldingStrategy:"indentation"});});});}},he=`ul.history_versions,\r
...
`,me={init(){v.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),v.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();}),v.execMenuOnce("scripts-versions-addCompareCodeButton",()=>{this.sourceDiffMonacoEditor();});},beautifyHistoryVersionPage(){d.info("美化 历史版本 页面");let t=[];return t.push(P(he)),t.push(tt.addBlockCSS(".version-number",".version-date",".version-changelog")),u.ready(function(){let e=L("ul.history_versions");if(!e){h.error(r.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(A=>{var p,f;let n=A.querySelector(".version-number a").href,i=A.querySelector(".version-number a").innerText,a=(p=A.querySelector(".version-date"))==null?void 0:p.getAttribute("datetime"),o=((f=A.querySelector(".version-changelog"))==null?void 0:f.innerHTML)||"",s=u.createElement("span",{className:"script-version-date",innerHTML:g.formatTime(a,r.t("yyyy年MM月dd日 HH:mm:ss"))}),l=u.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),c=u.createElement("div",{className:"script-note-box-body",innerHTML:o});A.appendChild(s),A.appendChild(l),A.appendChild(c);});}),t},addExtraTagButton(){d.info("添加额外的标签按钮"),u.ready(()=>{k(".script-tag-version").forEach(t=>{var c,p;let e=t.querySelector("a");if(!e)return;let A=new URL(e.href),n=(c=A.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:c[1],i=A.searchParams.get("version"),a=(p=A.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:p[1],o=z.getInstallUrl(n,i,a),s=z.getCodeUrl(n,i),l=u.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});u.after(t,l);});});},sourceDiffMonacoEditor(){d.info("源码对比（monacoEditor）"),wt.monacoEditor().then(t=>{u.ready(()=>{k('#script-content form[action*="/diff"] input[type="submit"]').forEach(e=>{let A=u.createElement("input",{type:"button",value:r.t("对比选中版本差异（monacoEditor）")},{style:"margin-left: 10px;"});u.after(e,A),u.on(A,"click",async n=>{g.preventEvent(n);let i=e.closest("form"),a=new FormData(i),o=a.get("v1"),s=a.get("v2");if(o===s){h.warning(r.t("版本号相同，不需要比较源码"));return}let l=h.loading(r.t("正在获取对比文本中...")),c=z.getScriptId(),p=await B.getScriptInfo(c);if(!p){l.close();return}let f=p.code_url,m=f.replace(new RegExp(`/${c}(/[\\d]+|)`),`/${c}/${o}`),y=f.replace(new RegExp(`/${c}(/[\\d]+|)`),`/${c}/${s}`),x="",b="",S=await O.get(m,{timeout:2e4});if(!S.status){l.close();return}x=S.data.responseText;let E=await O.get(y,{timeout:2e4});if(!E.status){l.close();return}b=E.data.responseText,l.close();let{recovery:H}=tt.lockScroll(),G=D.alert({title:{text:r.t("代码对比"),html:false,position:"center"},content:{html:true,text:`
		...
		`});u.on(i.$shadowRoot,"click",".collect-add-script-id",async function(a){let o=a.target.closest(".user-collect-item"),s=o.dataset.id;o.dataset.name;let l=h.loading(r.t("添加中..."));try{let c=await B.getUserCollectionInfo(e,s);if(!c)return;if(n(c,t)){h.warning(r.t("该脚本已经在该收藏集中"));return}let p=g.cloneFormData(c),f=g.cloneFormData(c);p.set("add-script",t.toString()),p.set("script-action","i"),f.append("scripts-included[]",t.toString()),f.set("save","1");let m=new URLSearchParams(p),y=new URLSearchParams(f),x=Array.from(m).map(([N,q])=>`${encodeURIComponent(N)}=${encodeURIComponent(q)}`).join("&"),b=Array.from(y).map(([N,q])=>`${encodeURIComponent(N)}=${encodeURIComponent(q)}`).join("&");d.info("添加的数据",x),d.info("保存的数据",b);let S=await B.updateUserSetsInfo(e,s,x);if(!S)return;let E=S.querySelector(".change-script-set");if(!E){h.error(r.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let H=E.querySelector("section");if(!H){h.error(r.t("添加失败，{{selector}}元素不存在",{selector:"section"}));return}let G=H.querySelector(".alert");if(G){D.alert({title:{text:r.t("添加失败"),position:"center"},content:{text:G.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
						.pops-alert-content{
							font-style: italic;
						...
						`,drag:!0,dragLimit:!0,width:$.info.width,height:$.info.height});return}let I=new FormData(E);if(!n(I,t)){d.error("添加失败，提交的添加请求中不包含该脚本id"),h.error(r.t("添加失败，表单数据中不包含该脚本"));return}await B.updateUserSetsInfo(e,s,b),h.success(r.t("添加成功"));}catch(c){console.error(c);}finally{l.close();}}),u.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(a){let o=a.target.closest(".user-collect-item"),s=o.dataset.id;o.dataset.name;let l=h.loading(r.t("删除中..."));try{let c=await B.getUserCollectionInfo(e,s);if(!c)return;if(!n(c,t)){h.info(r.t("已删除：{{scriptId}}",{scriptId:t}));return}let p=g.cloneFormData(c,(I,K)=>I==="scripts-included[]"&&typeof K=="string"&&K.toString().trim()===t.toString().trim()),f=g.cloneFormData(p);p.set("remove-scripts-included[]",t.toString()),p.set("remove-selected-scripts","i"),p.delete("script-action"),f.set("save","1");let m=new URLSearchParams(p),y=new URLSearchParams(f),x=Array.from(m).map(([I,K])=>`${encodeURIComponent(I)}=${encodeURIComponent(K)}`).join("&"),b=Array.from(y).map(([I,K])=>`${encodeURIComponent(I)}=${encodeURIComponent(K)}`).join("&");d.info("删除的数据",x),d.info("保存的数据",b);let S=await B.updateUserSetsInfo(e,s,x);if(!S)return;let E=S.querySelector(".change-script-set");if(!E){h.error(r.t("删除失败，{{selector}}元素不存在",{selector:".change-script-set"}));return}let H=new FormData(E);if(n(H,t)){d.error("删除失败，提交的删除请求中包含该脚本id"),h.error(r.t("删除失败，表单数据中仍包含该脚本"));return}await B.updateUserSetsInfo(e,s,b),h.success(r.t("删除成功"));}catch(c){console.error(c);}finally{l.close();}});},we={init(){C.isCode()?ge.init():C.isVersion()&&me.init(),C.isCodeStrict()&&(v.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),v.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),v.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),v.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),u.ready(()=>{v.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});});},addCollectionButton(){d.info("添加收藏按钮"),g.waitNode("ul#script-links li.current span").then(()=>{let t=u.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("收藏")}</span>
					</a>`});u.append(L("ul#script-links"),t),u.on(t,"click",()=>{let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){d.error(e,window.location.pathname),h.error(r.t("获取脚本id失败"));return}let A=e[e.length-1];It(A);});});},fullScreenOptimization(){d.info("F11全屏，F键代码全屏"),P(`
        ...
        `);let t=false;u.keydown(j,function(e){if(e.key.toLowerCase()==="f"){let A=L(".monaco-editor")||L("#script-content div.code-container code");e.altKey&&e.shiftKey?(d.info("宽屏"),g.preventEvent(e),A.classList.contains("code-wide-screen")?A.classList.remove("code-wide-screen"):A.classList.add("code-wide-screen")):!e.altKey&&!e.ctrlKey&&!e.shiftKey&&!e.metaKey&&(d.info("全屏"),g.preventEvent(e),t?(g.exitFullScreen(A),t=false):(g.enterFullScreen(A),t=true));}},{capture:true});},setFindCodeSearchBtn(){d.info("设置代码搜索按钮(对于库)"),g.waitNode("ul#script-links li.current span").then(()=>{let t=u.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${r.t("寻找引用")}</span>
					</a>`});u.append(L("ul#script-links"),t),u.on(t,"click",async function(){let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){d.error(e,window.location.pathname),h.error(r.t("获取脚本id失败"));return}let A=e[e.length-1];window.location.href=z.getCodeSearchUrl(`/scripts/${A}`);});});},async scriptHomepageAddedTodaySUpdate(){if(!L("#install-area"))return;d.info("脚本首页新增【今日检查】");let t=await B.getScriptStats(z.getScriptId());if(!t)return;d.info("统计信息",t);let e=t[g.formatTime(void 0,"yyyy-MM-dd")];if(!e){d.error("今日份的统计信息不存在");return}let A=e.update_checks;d.info("今日统计信息",e),u.after("dd.script-show-daily-installs",u.createElement("dt",{className:"script-show-daily-update_checks",innerHTML:`<span>${r.t("今日检查")}</span>`})),u.after("dt.script-show-daily-update_checks",u.createElement("dd",{className:"script-show-daily-update_checks",innerHTML:"<span>"+A+"</span>"}));},addCopyCodeButton(){d.info("添加复制代码按钮"),g.waitNode("div#script-content div.code-container").then(t=>{let e=u.createElement("button",{textContent:r.t("复制代码")},{style:"margin-bottom: 1em;"});u.on(e,"click",async function(){let A=h.loading(r.t("加载文件中...")),n=await O.get(`/zh-CN/scripts/${z.getScriptId()}.json`,{responseType:"json"});if(!n.status){A.close();return}let a=g.toJSON(n.data.responseText).code_url;d.success("代码地址：",a);let o=await O.get(a);if(!o.status){A.close();return}A.close(),g.setClip(o.data.responseText),h.success(r.t("复制成功"));}),u.before(t,e);});}},ye=`.sidebarred-main-content {\r
	max-width: unset;\r
	flex: unset;\r
}\r
ol.script-list {\r
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,Pe={init(){v.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox()),u.ready(()=>{v.execMenuOnce("conversations-beautifyPrivateMessageList",()=>{this.beautifyPrivateMessageList();});});},beautifyDialogBox(){return d.info("美化对话框"),P(xe)},beautifyPrivateMessageList(){d.info("美化私信列表"),P(`
		...
		`),k("section.text-content ul li").forEach(t=>{var l;let e=t.querySelector('a[href*="conversations"]'),A=e.href,n=(l=e.textContent)==null?void 0:l.split(" ")[1],i=t.querySelector("a.user-link"),a=null,o=null,s=null;if(i){a=i.textContent,o=i.href;let c=t.querySelector("relative-time");new Date(c.getAttribute("datetime")),s=c.shadowRoot.lastChild.textContent;}t.classList.add("user-conversations-item"),z.getUserId(),t.innerHTML=`
			...
			`;});}},zt={waitScritList(){return g.waitNode("#browse-script-list",1e4)},addFilterControls(t){function e(){let l=L("#gm-script-filter-controls");if(!l)return;let c=l==null?void 0:l.shadowRoot;if(!c)return;let p=c.querySelector(".pops-filter-controls_inner"),f=c.querySelector(".pops-filter-search-container");if(p&&f)return {$filterControl:p,$search:f}}let A=e();if(A)return A;let n=u.createElement("div",{id:"gm-script-filter-controls"}),i=n.attachShadow({mode:"open"});i.appendChild(u.createElement("style",{innerHTML:`
                    ${D.config.cssText.index}

                    ${D.config.cssText.common}

                    ${D.config.cssText.panelCSS}
                `})),i.appendChild(u.createElement("style",{innerHTML:`
                .pops{
					display: flex;
					flex-direction: column;
					gap: 10px;
            ...
            `}));let a=u.createElement("div",{className:"pops pops-filter-controls-container",innerHTML:`
				<div class="pops-filter-search-container"></div>
				<div class="pops-filter-controls_inner"></div>
			`}),o=a.querySelector(".pops-filter-controls_inner"),s=a.querySelector(".pops-filter-search-container");return i.appendChild(a),u.before(t,n),{$filterControl:o,$search:s}}},Le={init(){u.ready(()=>{zt.waitScritList().then(t=>{if(!t){d.error("未找到脚本列表节点，无法继续执行");return}v.onceExec("GreasyforkScriptsSearch",()=>{let{$filterControl:e,$search:A}=zt.addFilterControls(t);this.addFilterControlsItem(A,e);});});});},addFilterControlsItem(t,e){let A=D.config.panelHandleContentUtils(),n=[{name:r.t("名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleWholeWordMatching-enable",callback:(o,s)=>{try{return !s.scriptName.match(new RegExp(o,"i"))}catch(l){return d.error(l),!s.scriptName.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("描述"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptDescWholeWordMatching-enable",callback:(o,s)=>{try{return !s.scriptDescription.match(new RegExp(o,"i"))}catch{return !s.scriptDescription.match(o)}},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable"]']},{name:r.t("名称/描述"),desc:r.t("任一全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptTitleOrDescWholeWordMatching-enable",callback:(o,s)=>{let l=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptTitleWholeWordMatching").callback(o,s),c=n.find(p=>p.ENABLE_KEY==="gf-script-search-filterScriptDescWholeWordMatching").callback(o,s);return l&&c},mutualExclusionSwitch:['.gm-script-control-item[data-storage-key="gf-script-search-filterScriptTitleWholeWordMatching-enable"]','.gm-script-control-item[data-storage-key="gf-script-search-filterScriptDescWholeWordMatching-enable"]']},{name:r.t("作者名称"),desc:r.t("全词匹配"),ENABLE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching",STORAGE_KEY:"gf-script-search-filterScriptAuthorNameWholeWordMatching-enable",callback:(o,s)=>{try{return !s.scriptAuthorName.match(new RegExp(o,"i"))}catch{return !s.scriptAuthorName.match(o)}}}],i=()=>{var c,p;let o=t.querySelector("input");if(o)return o.value;let s=new URLSearchParams(window.location.search);return ((c=s.get("q"))==null?void 0:c.trim())||((p=s.get("c"))==null?void 0:p.trim())||""},a=()=>{let o=i();J.getElementList().forEach(l=>{let c=et.parseScriptListInfo(l),p=n.map(f=>{if(o=="")return  false;if(R(f.STORAGE_KEY))return f.callback(o,c)}).filter(f=>typeof f=="boolean");if(p.length!==0){let f=false;p.forEach(m=>{f=f||m;}),f?u.hide(l,false):u.show(l,false);}else u.show(l,false);});};if(v.getValue("gf-script-search-addFilterSearchInput")){let o=A.createSectionContainerItem_input({type:"input",className:"gm-script-search-input",getValue(){let s=i();return v.getValue("gf-script-search-addFilterSearchInput-text")||s||""},description:r.t("自动执行过滤"),placeholder:r.t("过滤的关键词"),text:r.t("关键词"),callback:g.debounce((s,l)=>{v.setValue("gf-script-search-addFilterSearchInput-text",l.toString()),a();},500)});u.append(t,o);}n.forEach(o=>{if(!v.getValue(o.ENABLE_KEY))return;d.info(`添加按钮${o.name}`);let s=A.createSectionContainerItem_switch({type:"switch",className:"gm-script-control-item",text:o.name,description:o.desc,attributes:{"data-storage-key":o.STORAGE_KEY},getValue(){let l=R(o.STORAGE_KEY,false);return l=!!l,a(),l},callback(l,c){if(V(o.STORAGE_KEY,c),a(),c&&Array.isArray(o.mutualExclusionSwitch)){let p=s.closest(".pops");o.mutualExclusionSwitch.forEach(f=>{let m=p.querySelector(f);if(m){let y=m.querySelector("input");if(y!=null&&y.checked){let x=m.querySelector(".pops-panel-switch__core");x==null||x.click();}}});}}});u.append(e,s);});}},ot={init(){if(C.isImageSource()){d.info("Router: 资源界面，不执行脚本功能");return}v.execMenu("checkPage",()=>{this.checkPage();}),fe.init(),Dt.init(),C.isScript()&&we.init(),(C.isScriptList()||C.isScriptLibraryList()||C.isScriptCodeSearch()||C.isScriptsBySite())&&Tt.init(),C.isDiscuessions()?(d.info("Router: 讨论页面"),ve.init()):C.isUsers()?(d.info("Router: 用户页面"),be.init(),C.isUsersConversations()&&(d.info("Router-next: 私聊用户页面"),Pe.init())):(C.isScriptSearch()||C.isScriptsBySite()||C.isScriptCodeSearch()||C.isScriptLibraryListSearch())&&(d.info("Router: 脚本搜索页面"),Le.init()),v.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),u.ready(()=>{M.initEnv(),pe.init(),mt.init(),M.handleLocalGotoCallBack(),v.execMenuOnce("fixImageWidth",()=>{ot.fixImageWidth();}),ot.languageSelectorLocale(),v.execMenuOnce("optimizeImageBrowsing",()=>{ot.optimizeImageBrowsing();}),v.execMenuOnce("overlayBedImageClickEvent",()=>{ot.overlayBedImageClickEvent();}),C.isCodeStrict()||v.execMenuOnce("addMarkdownCopyButton",()=>{ot.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(d.info("修复图片显示问题"),P(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){d.info("优化图片浏览"),P(ht("ViewerCSS")),P(`
        ...
        `);function t(A=[],n=0){let i="";A.forEach(s=>{i+=`<li><img data-src="${s}" loading="lazy"></li>`;});let a=u.createElement("ul",{innerHTML:i}),o=new Qt(a,{inline:false,url:"data-src",zIndex:g.getMaxZIndex()+100,hidden:()=>{o.destroy();}});n=n<0?0:n,o.view(n),o.zoomTo(1),o.show();}function e(A){return A.getAttribute("data-src")||A.getAttribute("src")||A.getAttribute("alt")}u.on(document,"click","img",function(A){var c;let n=A.target;if(((c=n.parentElement)==null?void 0:c.localName)==="a"&&n.hasAttribute("data-screenshots")||n.closest(".viewer-container")||n.closest(".lum-lightbox-position-helper"))return;let i=n.closest(".user-content"),a=[],o=0,s=[],l=e(n);if(l){if(l.startsWith("https://img.shields.io"))return;if(l.startsWith("/vite/assets/"))return}i?(i.querySelectorAll("img").forEach(p=>{s.push(p);let f=e(p),m=p.parentElement;(m==null?void 0:m.localName)==="a"&&(f=m.getAttribute("data-href")||m.href),a.push(f);}),o=s.indexOf(n),o===-1&&(o=0)):(a.push(l),o=0),d.success("点击浏览图片👉",a,o),t(a,o);}),k(".user-screenshots").forEach(A=>{let n=A.querySelector("a");if(!n)return;let i=n.getAttribute("data-href")||n.getAttribute("href"),a=A.querySelector("img");a&&(a.setAttribute("data-screenshots","true"),a.setAttribute("data-src",i),n.setAttribute("href","javascript:;"),u.after(n,a),n.remove());});},overlayBedImageClickEvent(){d.info("覆盖图床图片的parentElement的a标签"),k(".user-content a>img").forEach(t=>{let e=t.parentElement,A=e.getAttribute("href");if(e.setAttribute("data-href",A),e.removeAttribute("href"),A.startsWith("/rails/active_storage/blobs/redirect")){d.info("该图片是上传到Greasyfork的图片，拦截默认行为，不做提示");return}u.on(e,"click",()=>{h.warning(`<div style="overflow-wrap: anywhere;">${r.t("拦截跳转：")}<a href="${A}" target="_blank">${A}</a></div>`,{html:true,zIndex:g.getMaxZIndex()+105});});});},addMarkdownCopyButton(){d.info("在Markdown右上角添加复制按钮"),P(`
        pre{
          position: relative;
        ...
        `);function t(){let e=u.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),A=e.querySelector(".js-clipboard-copy"),n=e.querySelector(".octicon-copy"),i=e.querySelector(".octicon-check-copy");return u.on(e,"click",()=>{let a=u.parent(e),o=a.querySelector("code");if(!o&&a.className.includes("prettyprinted")&&(o=e.parentElement),o||(o=a.querySelector("pre")),!o){h.error(r.t("未找到{{selector}}元素",{selector:"code"}));return}g.setClip(u.text(o)),A.setAttribute("success","true"),n.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden");let s=D.tooltip({target:A,content:r.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:true});s.toolTip.onToolTipAnimationFinishEvent(),setTimeout(()=>{A.removeAttribute("success"),i.setAttribute("aria-hidden","true"),n.removeAttribute("aria-hidden"),s.toolTip.close();},2e3);}),e}k("pre").forEach(e=>{if(e.querySelector("div.zeroclipboard-container"))return;let n=t(),i=u.createElement("div",{className:"snippet-clipboard-content"});u.before(e,i),i.appendChild(e),i.appendChild(n);});},languageSelectorLocale(){let t=v.getValue("language-selector-locale"),e=window.location.pathname.split("/").filter(A=>!!A)[0];if(d.success("选择语言："+t),d.success("当前语言："+e),!g.isNull(t)&&t!==e){let A=null,n=z.getSwitchLanguageUrl(t);B.switchLanguage(n),d.success("新Url："+n),h.loading(r.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:e,localeLanguage:t}),{timeout:3e3,showClose:true,onClose(){clearTimeout(A);}}),h.info(r.t("导航至：")+n,{timeout:3e3}),A=setTimeout(()=>{window.location.href=n;},3e3);}},checkPage(){d.info("检测gf页面是否正确加载，有时候会出现"),u.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let t=parseInt(R("greasyfork-check-page-time",0)),e=v.getValue("greasyfork-check-page-timeout",5),A=e*1e3;if(t&&Date.now()-t<A){h.warning(r.t("上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载",{time:g.formatTime(t,"yyyy-MM-dd HH:mm:ss"),timeout:e}));return}V("greasyfork-check-page-time",Date.now()),window.location.reload();}});},addOperationPanelBtnWithNavigator(){d.info("添加【操作面板】按钮"),tt.addBlockCSS(".sidebarred .sidebar",".sidebarred-main-content .open-sidebar"),P(`
		.sidebarred .sidebarred-main-content{
			max-width: 100%;
		}	
		`),u.ready(()=>{L("#site-nav nav"),L("#site-nav .with-submenu nav");let t=L("#script-list-option-groups")||L(".list-option-groups");if(!t){d.warn("不存在右侧面板元素#script-list-option-groups");return}t=t.cloneNode(true),t.classList.add("option-panel-groups"),et.registerTopNavMenu({name:r.t("操作面板"),className:"filter-scripts",clickEvent(e){D.alert({title:{text:r.t("操作面板"),position:"center"},content:{text:"",html:true},btn:{ok:{enable:false}},mask:{enable:true,clickEvent:{toClose:true}},drag:true,useShadowRoot:true,width:$.setting.width,height:$.setting.height,zIndex:g.getMaxZIndex(100),style:`

...
(function (f, $, st, n, ft, Lt) {
	...
	var kt=Object.defineProperty;var Ct=(t,e,r)=>e in t?kt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var ot=(t,e,r)=>Ct(t,typeof e!="symbol"?e+"":e,r);var S=typeof GM_addStyle<"u"?GM_addStyle:void 0,lt=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,D=typeof GM_getValue<"u"?GM_getValue:void 0,nt=typeof GM_info<"u"?GM_info:void 0,Et=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,j=typeof GM_setValue<"u"?GM_setValue:void 0,Tt=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,It=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,_=typeof unsafeWindow<"u"?unsafeWindow:void 0,Mt=window;const At={GreasyFork优化:"GreasyFork优化",请求取消:"请求取消",请求超时:"请求超时",请求异常:"请求异常",通用:"通用",账号:"账号",密码:"密码",语言:"语言","账号/密码":"账号/密码",请输入账号:"请输入账号",请输入密码:"请输入密码",自动登录:"自动登录",自动登录当前保存的账号:"自动登录当前保存的账号","清空账号/密码":"清空账号/密码",点击清空:"点击清空","确定清空账号和密码？":"确定清空账号和密码？","已清空账号/密码":"已清空账号/密码","源代码同步【脚本列表】":"源代码同步【脚本列表】",一键同步:"一键同步",前往用户主页:"前往用户主页",获取当前已登录的用户主页失败:"获取当前已登录的用户主页失败","源代码同步【未上架的脚本】":"源代码同步【未上架的脚本】","源代码同步【库】":"源代码同步【库】",论坛:"论坛",功能:"功能",过滤重复的评论:"过滤重复的评论","过滤掉重复的评论数量(≥2)":"过滤掉重复的评论数量(≥2)","过滤脚本(id)":"过滤脚本(id)","请输入脚本id，每行一个":"请输入脚本id，每行一个","过滤发布的用户(id)":"过滤发布的用户(id)","请输入用户id，每行一个":"请输入用户id，每行一个","过滤回复的用户(id)":"过滤回复的用户(id)",优化:"优化",固定当前语言:"固定当前语言",无:"无","如button、input、textarea":"如button、input、textarea",更直观的查看版本迭代:"更直观的查看版本迭代",美化上传图片按钮:"美化上传图片按钮",放大上传区域:"放大上传区域",优化图片浏览:"优化图片浏览",使用Viewer浏览图片:"使用Viewer浏览图片",覆盖图床图片跳转:"覆盖图床图片跳转","配合上面的【优化图片浏览】更优雅浏览图片":"配合上面的【优化图片浏览】更优雅浏览图片",'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>':'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>',代码:"代码",添加复制代码按钮:"添加复制代码按钮",更优雅的复制:"更优雅的复制",快捷键:"快捷键","【F】键全屏、【Alt+Shift+F】键宽屏":"【F】键全屏、【Alt+Shift+F】键宽屏",库:"库",脚本列表:"脚本列表","请输入屏蔽规则，每行一个":"请输入屏蔽规则，每行一个",请求admin内容失败:"请求admin内容失败",解析admin的源代码同步表单失败:"解析admin的源代码同步表单失败",源代码同步失败:"源代码同步失败",获取用户信息失败:"获取用户信息失败",获取用户的收藏集失败:"获取用户的收藏集失败","解析Script Sets失败":"解析Script Sets失败","获取收藏集{{setsId}}失败":"获取收藏集{{setsId}}失败","获取表单元素#edit_script_set失败":"获取表单元素#edit_script_set失败",更新收藏集表单请求失败:"更新收藏集表单请求失败",请先在菜单中录入账号:"请先在菜单中录入账号",请先在菜单中录入密码:"请先在菜单中录入密码","获取csrf-token失败":"获取csrf-token失败","正在登录中...":"正在登录中...","登录失败，请在控制台查看原因":"登录失败，请在控制台查看原因","登录成功，1s后自动跳转":"登录成功，1s后自动跳转","登录失败，可能是账号/密码错误，请在控制台查看原因":"登录失败，可能是账号/密码错误，请在控制台查看原因","美化 历史版本 页面":"美化 历史版本 页面",未找到history_versions元素列表:"未找到history_versions元素列表","yyyy年MM月dd日 HH:mm:ss":"yyyy-MM-dd HH:mm:ss","美化 Greasyfork Beautify脚本":"美化 Greasyfork Beautify脚本","❌ 最多同时长传5张图":"❌ 最多同时长传5张图片","❌ 图片：{{name}} 大小：{{size}}":"❌ 图片：{{name}} 大小：{{size}}","已过滤：{{oldCount}}":"已过滤：{{oldCount}}",寻找引用:"寻找引用",获取脚本id失败:"获取脚本id失败",收藏:"收藏",请先登录账号:"请先登录账号",获取用户id失败:"获取用户id失败","获取收藏夹中...":"获取收藏夹中...",收藏集:"收藏集","添加中...":"添加中...","添加失败，{{selector}}元素不存在":"添加失败，{{selector}}元素不存在","未找到{{selector}}元素":"未找到{{selector}}元素",添加失败:"添加失败",添加成功:"添加成功","删除中...":"删除中...",删除成功:"删除成功",添加:"添加",刪除:"刪除","拦截跳转：":"拦截跳转：",今日检查:"今日检查",复制代码:"复制代码","加载文件中...":"加载文件中...",复制成功:"复制成功","✅ 复制成功!":"✅ 复制成功!","当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}":"当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}","导航至：":"导航至：","请先登录账号！":"请先登录账号！","获取信息中，请稍后...":"获取信息中，请稍后...","获取成功，共 {{count}} 个":"获取成功，共 {{count}} 个","评分：":"评分：","语言：":"语言：","版本：":"版本：","更新：":"更新：",同步代码:"同步代码","同步中...":"同步中...",手动:"手动",自动:"自动","同步方式：{{syncMode}}":"同步方式：{{syncMode}}",同步成功:"同步成功",同步失败:"同步失败",该脚本未设置同步信息:"该脚本未设置同步信息","上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载":"上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载","名称：":"名称：","进度：":"进度：","未获取到【脚本列表】":"未获取到【脚本列表】","源代码同步成功，3秒后更新下一个":"源代码同步成功，3秒后更新下一个",全部更新失败:"全部更新失败","全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}":"全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}","⚙ 设置":"⚙ 设置","{{SCRIPT_NAME}}-设置":"{{SCRIPT_NAME}}-设置",美化页面元素:"美化页面元素",美化历史版本页面:"美化历史版本页面","美化Greasyfork Beautify脚本":"美化Greasyfork Beautify脚本",获取表单csrfToken失败:"获取表单csrfToken失败",Toast配置:"Toast配置",Toast位置:"Toast位置",左上角:"左上角",顶部:"顶部",右上角:"右上角",左边:"左边",中间:"中间",右边:"右边",左下角:"左下角",底部:"底部",右下角:"右下角",Toast显示在页面九宫格的位置:"Toast显示在页面九宫格的位置",最多显示的数量:"最多显示的数量",限制Toast显示的数量:"限制Toast显示的数量",逆序弹出:"逆序弹出",修改Toast弹出的顺序:"修改Toast弹出的顺序",该脚本已经在该收藏集中:"该脚本已经在该收藏集中",其它错误:"其它错误",启用:"启用",开启后下面的过滤功能才会生效:"开启后下面的功能才会生效",屏蔽脚本:"屏蔽脚本",点击查看规则:"点击查看规则",过滤:"过滤",代码同步:"代码同步",美化:"美化",修复代码行号显示:"修复代码行号显示",修复代码行数超过1k行号显示不全问题:"修复代码行数超过1k行号显示不全问题","添加【寻找引用】按钮":"添加【寻找引用】按钮","在脚本栏添加按钮，一般用于搜索引用该库的相关脚本":"在脚本栏添加按钮，一般用于搜索引用该库的相关脚本","添加【收藏】按钮":"添加【收藏】按钮","在脚本栏添加按钮，一般用于快捷收藏该脚本/库":"在脚本栏添加按钮，一般用于快捷收藏该脚本/库",修复图片宽度显示问题:"修复图片宽度显示问题",修复图片在移动端宽度超出浏览器宽度问题:"修复图片在移动端宽度超出浏览器宽度问题","添加【今日检查】信息块":"添加【今日检查】信息块","在脚本信息栏添加【今日检查】信息块":"在脚本信息栏添加【今日检查】信息块","给Markdown添加【复制】按钮":"给Markdown添加【复制】按钮","在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容":"在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容",开启后下面的功能才会生效:"开启后下面的功能才会生效",检测页面加载:"检测页面加载","检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面":"检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面",检测间隔:"检测间隔","设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面":"设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面",美化顶部导航栏:"美化顶部导航栏","可能会跟Greasyfork Beautify脚本有冲突":"可能会跟Greasyfork Beautify脚本有冲突",美化脚本列表:"美化脚本列表","双列显示且添加脚本卡片操作项（安装、收藏）":"双列显示且添加脚本卡片操作项（安装、收藏）",操作面板:"操作面板","添加【操作面板】按钮":"添加【操作面板】按钮","在脚本列表页面时为顶部导航栏添加【操作面板】按钮":"在脚本列表页面时为顶部导航栏添加【操作面板】按钮",操作:"操作",安装此脚本:"安装此脚本",脚本:"脚本",历史版本:"历史版本",自定义已读颜色:"自定义已读颜色",在讨论内生效:"在讨论内生效",用户:"用户",控制台:"控制台","迁移【控制台】到顶部导航栏":"迁移【控制台】到顶部导航栏","将【控制台】按钮移动到顶部导航栏，节省空间":"将【控制台】按钮移动到顶部导航栏，节省空间","在版本下面添加【安装】、【查看代码】按钮":"在版本下面添加【安装】、【查看代码】按钮",查看代码:"查看代码",添加快捷操作按钮:"添加快捷操作按钮","在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效":"在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效",选择需要过滤的选项:"选择需要过滤的选项","确定{{type}}：{{filterId}}？":"确定{{type}}：{{filterId}}？","该收藏集未包含：{{scriptId}}":"该收藏集未包含：{{scriptId}}",帮助文档:"帮助文档","请输入规则，每行一个":"请输入规则，每行一个",选择过滤的选项:"选择过滤的选项","脚本id：{{text}}":"脚本id：{{text}}","脚本名：{{text}}":"脚本名：{{text}}","作者id：{{text}}":"作者id：{{text}}","作者名：{{text}}":"作者名：{{text}}","作用域：脚本、脚本搜索、用户主页":"作用域：脚本、脚本搜索、用户主页","更新到 {{version}} 版本":"更新到 {{version}} 版本","降级到 {{version}} 版本":"降级到 {{version}} 版本","重新安装 {{version}} 版本":"重新安装 {{version}} 版本","发布的用户id：{{text}}":"发布的用户id：{{text}}",自定义快捷键:"自定义快捷键",点击录入快捷键:"点击录入快捷键",快捷键发表回复:"快捷键发表回复","在输入框内按下快捷发表回复，例如：{{key}}":"在输入框内按下快捷发表回复，例如：{{key}}",请先执行当前的录入操作:"请先执行当前的录入操作",清空快捷键:"清空快捷键","请按下快捷键...":"请按下快捷键...",成功录入:"成功录入","快捷键 {{key}} 已被 {{isUsedKey}} 占用":"快捷键 {{key}} 已被 {{isUsedKey}} 占用",私聊:"私聊",美化私聊页面:"美化私聊页面",美化为左右对话模式:"美化为左右对话模式"},Ut={GreasyFork优化:"GreasyFork Optimization",请求取消:"http request cancel",请求超时:"http request timeout",请求异常:"http request error",通用:"General",账号:"Account",密码:"Password",语言:"Language","账号/密码":"Account/Password",请输入账号:"Please enter your account number",请输入密码:"Please enter password",自动登录:"Auto Login",自动登录当前保存的账号:"Automatically log in to the currently saved account","清空账号/密码":"Clear account/password",点击清空:"Clear","确定清空账号和密码？":"Are you sure to clear your account and password?","已清空账号/密码":"Account/password cleared","源代码同步【脚本列表】":"Source Code Synchronization [Script List]",一键同步:"Sync All",前往用户主页:"Go to the user's homepage",获取当前已登录的用户主页失败:"Failed to retrieve the currently logged in user's homepage","源代码同步【未上架的脚本】":"Source code synchronization [Script not listed]","源代码同步【库】":"Source code synchronization 【 Library 】",论坛:"Forum",功能:"Function",过滤重复的评论:"Filter duplicate comments","过滤掉重复的评论数量(≥2)":"Filter out duplicate comments (≥ 2)","过滤脚本(id)":"Filter script (id)","请输入脚本id，每行一个":"Please enter the script ID, one per line","过滤发布的用户(id)":"Filter published users (id)","请输入用户id，每行一个":"Please enter the user ID, one per line","过滤回复的用户(id)":"User (ID) who filters replies",优化:"Optimization",固定当前语言:"Fix current language",无:"nothing","如button、input、textarea":"For example button、input、textarea",更直观的查看版本迭代:"More intuitive viewing of version iterations",美化上传图片按钮:"Beautify upload image button",放大上传区域:"Enlarge the upload area",优化图片浏览:"Optimize image browsing",使用Viewer浏览图片:"Using Viewer to browse images",覆盖图床图片跳转:"Overlay bed image jump","配合上面的【优化图片浏览】更优雅浏览图片":"Collaborate with the optimization of image browsing above to browse images more elegantly",'需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>':'Greasyfork Beauty script needs to be installed，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐 Click me to install</a>',代码:"Code",添加复制代码按钮:"Add Copy Code Button",更优雅的复制:"More elegant replication",快捷键:"Shortcut keys","【F】键全屏、【Alt+Shift+F】键宽屏":"【F】 Key full screen, [Alt+Shift+F] key wide screen",库:"Library",脚本列表:"Script List","请输入屏蔽规则，每行一个":"Please enter a blocking rule, one per line",请求admin内容失败:"Request for admin content failed",解析admin的源代码同步表单失败:"Failed to parse the source code of admin and synchronize the form",源代码同步失败:"Source code synchronization failed",获取用户信息失败:"Failed to obtain user information",获取用户的收藏集失败:"Failed to retrieve user's collection","解析Script Sets失败":"Parsing Script Sets failed","获取收藏集{{setsId}}失败":"Failed to retrieve collection {{setsId}}","获取表单元素#edit_script_set失败":"Failed to retrieve form element #edit_script_set",更新收藏集表单请求失败:"Update collection form request failed",请先在菜单中录入账号:"Please enter your account in the menu first",请先在菜单中录入密码:"Please enter your password in the menu first","获取csrf-token失败":"Failed to obtain csrf token","正在登录中...":"Logging in...","登录失败，请在控制台查看原因":"Login failed, please check the reason in the console","登录成功，1s后自动跳转":"Login successful, automatically redirect after 1 second","登录失败，可能是账号/密码错误，请在控制台查看原因":"Login failed, possibly due to incorrect account/password. Please check the reason in the console","美化 历史版本 页面":"Beautify the historical version page",未找到history_versions元素列表:"History_versions element list not found","yyyy年MM月dd日 HH:mm:ss":"yyyy-MM-dd HH:mm:ss","美化 Greasyfork Beautify脚本":"Beautify Greasyfork Beauty Script","❌ 最多同时长传5张图":"❌ Upload up to 5 images simultaneously","❌ 图片：{{name}} 大小：{{size}}":"❌ Image:{{name}} Size:{{size}}","已过滤：{{oldCount}}":"Filtered:{{oldCount}}",寻找引用:"Find references",获取脚本id失败:"Failed to obtain script ID",收藏:"Collection",请先登录账号:"Please log in to your account first",获取用户id失败:"Failed to obtain user ID","获取收藏夹中...":"Get in favorites...",收藏集:"Collection","添加中...":"Adding...","添加失败，{{selector}}元素不存在":"Add failed, {{selector}} element does not exist","未找到{{selector}}元素":"{{selector}} element not found",添加失败:"Add failed",添加成功:"Successfully added","删除中...":"Deleting...",删除成功:"Delete successful",添加:"Add in deletion",刪除:"Delete","拦截跳转：":"Intercept jump:",今日检查:"Today's inspection",复制代码:"Copy Code","加载文件中...":"Loading files...",复制成功:"Copy successful","✅ 复制成功!":"✅ Copy successful!","当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}":"Current language: {{currentLocaleLanguage}}, switch to {{localeLanguage}} in 3 seconds","导航至：":"Navigation to:","请先登录账号！":"Please log in to your account first!","获取信息中，请稍后...":"Obtaining information, please wait...","获取成功，共 {{count}} 个":"Successfully obtained, a total of {{count}}","评分：":"Rating:","语言：":"Language:","版本：":"Version:","更新：":"Update:",同步代码:"Synchronize Code","同步中...":"Synchronizing...",手动:"Manual",自动:"Automatic","同步方式：{{syncMode}}":"Synchronization method: {{syncMode}}",同步成功:"Sync successful",同步失败:"Sync failed",该脚本未设置同步信息:"The script has not set synchronization information","上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载":"Last reload time {{time}}, rejected repeated reloads within {{timeout}} seconds","名称：":"Name:","进度：":"Progress:","未获取到【脚本列表】":"Unable to obtain [Script List]","源代码同步成功，3秒后更新下一个":"Source code synchronization successful, update next one in 3 seconds",全部更新失败:"All updates failed","全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}":"All updates completed<br>Success: {{successNums}}<br>Failure: {{failed Nums}}<br>Total: {{scriptUrlListLength}}","⚙ 设置":"⚙  Setting","{{SCRIPT_NAME}}-设置":"{{SCRIPT_NAME}}-Setting",美化页面元素:"Beautify page elements",美化历史版本页面:"Beautify the historical version page","美化Greasyfork Beautify脚本":"Beautify Greasyfork Beauty Script",获取表单csrfToken失败:"Failed to obtain form csrfToken",Toast配置:"Toast Config",Toast位置:"Toast position",左上角:"Top left",顶部:"Top",右上角:"Top right",左边:"Left",中间:"Center",右边:"Right",左下角:"Bottom left",底部:"Bottom",右下角:"Bottom right",Toast显示在页面九宫格的位置:"Toast is displayed in the nine grid position on the page",最多显示的数量:"Maximum number of displays",限制Toast显示的数量:"Limit the number of Toast displays",逆序弹出:"Reverse pop-up",修改Toast弹出的顺序:"Modify the order in which Toast pops up",该脚本已经在该收藏集中:"The script is already in this collection",其它错误:"Ohter Error",启用:"Enable",开启后下面的过滤功能才会生效:"The following filtering function will only take effect after it is enabled",屏蔽脚本:"Block script",点击查看规则:"Click to view rules",过滤:"Filter",代码同步:"Code synchronization",美化:"Beautify",修复代码行号显示:"Fix code line number display",修复代码行数超过1k行号显示不全问题:"Fix the problem that the code line number display is not complete when the number of lines exceeds 1k","添加【寻找引用】按钮":"Add the button to find references","在脚本栏添加按钮，一般用于搜索引用该库的相关脚本":"Add a button to the script bar, generally used to search for scripts that reference this library","添加【收藏】按钮":"Add the button to collect","在脚本栏添加按钮，一般用于快捷收藏该脚本/库":"Add a button to the script bar, generally used to quickly collect this script / library",修复图片宽度显示问题:" Fix the problem that the picture width display is not complete",修复图片在移动端宽度超出浏览器宽度问题:"Fix the problem that the picture width exceeds the browser width on mobile","添加【今日检查】信息块":"Add the block of information of today's inspection","在脚本信息栏添加【今日检查】信息块":"Add the block of information of today's inspection to the script information bar","给Markdown添加【复制】按钮":"Add the button to copy to Markdown","在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容":"Add the button to copy to the top right corner of the Markdown content, click to copy the Markdown content in one click",开启后下面的功能才会生效:"The following functions will only take effect after it is enabled",检测页面加载:"Detect page loading","检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面":"Detect whether the Greasyfork page is loaded normally. If the loading fails, the page will be automatically refreshed",检测间隔:"Detection interval","设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面":"Set the interval time for detecting the last refresh page. If the time since the last refresh page exceeds the set value, the page will no longer be refreshed",美化顶部导航栏:"Beautify the top navigation bar","可能会跟Greasyfork Beautify脚本有冲突":"Possible conflict with Greasymfork Beautify script",美化脚本列表:"Beautify Script List","双列显示且添加脚本卡片操作项（安装、收藏）":"Double column display and add script card operation items (installation, bookmarking)",操作面板:"Operation Panel","添加【操作面板】按钮":"Add [Operation Panel] button","在脚本列表页面时为顶部导航栏添加【操作面板】按钮":"Add an 'Operation Panel' button to the top navigation bar on the script list page",操作:"Operation",安装此脚本:"Install this script",脚本:"Scripts",历史版本:"Historical version",自定义已读颜色:"Customize read colors",在讨论内生效:"Effective within the discussion",用户:"Users",控制台:"Console","迁移【控制台】到顶部导航栏":"Migration of Console to Top Navigation Bar","将【控制台】按钮移动到顶部导航栏，节省空间":"Move the 'Console' button to the top navigation bar to save space",添加额外的标签按钮:"Add additional label button","在版本下面添加【安装】、【查看代码】按钮":"Add 【 Install 】 and 【 View Code 】 buttons under the version",查看代码:"View Code",添加快捷操作按钮:"Add shortcut operation button","在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效":"Add a 'Filter' button at the end of each discussion line. The filtering function needs to be enabled for it to take effect",选择需要过滤的选项:"Select the options that need to be filtered","确定{{type}}：{{filterId}}？":"Are you sure {{type}}：{{filterId}}？","该收藏集未包含：{{scriptId}}":"This collection does not include:{{scriptId}}",帮助文档:"Help document","请输入规则，每行一个":"Please enter a rule, one per line",选择过滤的选项:"Select filtering options","脚本id：{{text}}":"Script Id: {{text}}","脚本名：{{text}}":"Script Name: {{text}}","作者id：{{text}}":"Author Id: {{text}}","作者名：{{text}}":"Author Name: {{text}}","作用域：脚本、脚本搜索、用户主页":"Scope: Script, Script Search, User Homepage","更新到 {{version}} 版本":"Update To {{version}} Version","降级到 {{version}} 版本":"Downgrade to {{version}} Version","重新安装 {{version}} 版本":"Reinstall {{version}} Version","发布的用户id：{{text}}":"Published user ID: {{text}}",自定义快捷键:"Customize shortcut keys",点击录入快捷键:"Click on the input shortcut key",快捷键发表回复:"Shortcut key to post reply","在输入框内按下快捷发表回复，例如：{{key}}":"Press the shortcut to post a reply in the input box, for example: {{key}}",请先执行当前的录入操作:"Please perform the current input operation first",清空快捷键:"Clear shortcut keys","请按下快捷键...":"Please press the shortcut key...",成功录入:"Successful entry","快捷键 {{key}} 已被 {{isUsedKey}} 占用":"The shortcut key {{key}} is already used by {{isUsedKey}}",私聊:"Private Chat",美化私聊页面:"Beautify the private chat page",美化为左右对话模式:"Beautify as a left-right dialogue mode"},P="GM_Panel",ht="data-init",X="data-key",tt="data-default-value",_t=function(){let e=D(P,{})["setting-language"]||"zh-CN";n.init({lng:e,fallbackLng:"zh-CN",resources:{"zh-CN":{translation:{...At}},"en-US":{translation:{...Ut}}}});};_t();D(P,{});const $t=n.t("GreasyFork优化"),m=st.noConflict(),u=$.noConflict(),V=ft,d=new m.Log(nt,_.console||Mt.console);var ut;const dt=((ut=nt==null?void 0:nt.script)==null?void 0:ut.name)||$t,mt=!1;d.config({debug:mt,logMaxCount:1e3,autoClearConsole:!0,tag:!0});f.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return h.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return h.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return h.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let t=st.getMaxZIndex(),e=ft.config.InstanceUtils.getPopsMaxZIndex(t).zIndex;return st.getMaxValue(t,e)+100}}}));const gt=new m.GM_Menu({GM_getValue:D,GM_setValue:j,GM_registerMenuCommand:Et,GM_unregisterMenuCommand:Tt}),N=new m.Httpx(It);N.interceptors.response.use(void 0,t=>(d.error(["拦截器-请求错误",t]),t.type==="onabort"?f.warning(n.t("请求取消")):t.type==="onerror"?f.error(n.t("请求异常")):t.type==="ontimeout"?f.error(n.t("请求超时")):f.error(n.t("其它错误")),t));N.config({logDetails:mt});_.Object.defineProperty,_.Function.prototype.apply,_.Function.prototype.call,_.Element.prototype.appendChild,_.setTimeout;const it=m.addStyle.bind(m),Q=function(t,e,r,i,o,a,s,l){return {text:t,type:"button",description:e,buttonIcon:i,buttonIsRightIcon:o,buttonIconIsLoading:a,buttonType:s,buttonText:r,callback(p){typeof l=="function"&&l(p);},afterAddToUListCallBack:void 0}},pt=function(t,e,r,i,o,a="",s,l){let c={text:t,type:"input",isNumber:!!s,isPassword:!!l,attributes:{},description:i,getValue(){return h.getValue(e,r)},callback(p,g){h.setValue(e,g);},placeholder:a};return c.attributes&&(c.attributes[X]=e,c.attributes[tt]=r),c},w=function(t,e,r,i,o){let a={text:t,type:"switch",description:o,attributes:{},getValue(){return !!h.getValue(e,r)},callback(s,l){d.success(`${l?"开启":"关闭"} ${t}`),h.setValue(e,!!l);},afterAddToUListCallBack:void 0};return a.attributes&&(a.attributes[X]=e,a.attributes[tt]=!!r),a},x={getCodeSearchUrl(t){return "https://greasyfork.org/zh-CN/scripts/code-search?c="+t},getAdminUrl(t){return t+"/admin"},getScriptId(t){var e,r;return (r=(e=t||window.location.pathname)==null?void 0:e.match(/\/scripts\/([\d]+)/i))==null?void 0:r[1]},getUserId(t){var e;return (e=(t||window.location.pathname).match(/\/users\/([\d]+)/i))==null?void 0:e[1]},getScriptName(t){let e=window.location.pathname;t!=null&&(e=new URL(t).pathname),e=decodeURIComponent(e);let r=e.split("/");for(const i of r){let o=i.match(/[\d]+/);if(o&&o.length)return o[1]}},getSwitchLanguageUrl(t="zh-CN"){let e=window.location.origin,r=window.location.pathname.split("/");return r[1]=t,e=e+r.join("/"),e+=window.location.search,window.location.search===""?e+="?locale_override=1":window.location.search.includes("locale_override=1")||(e+="&locale_override=1"),e},async getScriptStats(t){return new Promise(async e=>{let r=await N.get({url:`https://greasyfork.org/scripts/${t}/stats.json`,fetch:!0,onerror(){},ontimeout(){}});if(!r.status){e(null);return}let i=r.data;e(i);})},async getSourceCodeSyncFormData(t){let e=await N.get(`https://greasyfork.org/zh-CN/scripts/${t}/admin`,{fetch:!0});if(d.success(e),!e.status){f.error(n.t("请求admin内容失败"));return}let r=e.data.responseText,o=u.parseHTML(r,!1,!0).querySelector("form.edit_script");if(!o){f.error(n.t("解析admin的源代码同步表单失败"));return}return new FormData(o)},async sourceCodeSync(t,e){let r=await N.post(`https://greasyfork.org/zh-CN/scripts/${t}/sync_update`,{fetch:!0,data:e});if(d.success(r),!r.status){f.error(n.t("源代码同步失败"));return}return r},async getUserInfo(t){let e=await N.get(`https://greasyfork.org/zh-CN/users/${t}.json`,{fetch:!0});if(d.success(e),!e.status){f.error(n.t("获取用户信息失败"));return}let r=m.toJSON(e.data.responseText);return r.scriptList=[],r.scriptLibraryList=[],r.scripts.forEach(i=>{i.code_url.endsWith(".user.js")?r.scriptList.push(i):r.scriptLibraryList.push(i);}),r},async getUserCollection(t){let e=await N.get(`https://greasyfork.org/zh-CN/users/${t}`,{fetch:!0});if(d.info(["获取用户的收藏集",e]),!e.status){f.error(n.t("获取用户的收藏集失败"));return}let r=e.data.responseText,o=u.parseHTML(r,!0,!0).querySelector("#user-script-sets");if(!o){d.error("解析Script Sets失败");return}let a=[];return o.querySelectorAll("li").forEach(s=>{var y;let l=s.querySelector("a:last-child");if(!l)return;let c=l.href;if(c.includes("?fav=1"))return;let p=s.querySelector("a").innerText,g=(y=c.match(/\/sets\/([\d]+)\//))==null?void 0:y[1];a.push({id:g,name:p});}),a},async getUserCollectionInfo(t,e){let r=await N.get(`https://greasyfork.org/zh-CN/users/${t}/sets/${e}/edit`,{fetch:!0});if(!r.status){f.error(n.t("获取收藏集{{setsId}}失败",{setsId:e}));return}let i=r.data.responseText,o=u.parseHTML(i,!0,!0),a=o.querySelector('form[id^="edit_script_set"]');if(!a){f.error(n.t("获取表单元素#edit_script_set失败"));return}let s=new FormData(a),l=o.querySelector('meta[name="csrf-token"]');if(!l){f.error(n.t("获取表单csrfToken失败"));return}if(l.hasAttribute("content")){let c=l.getAttribute("content");c&&s.set("authenticity_token",c);}return s},async updateUserSetsInfo(t,e,r){let i=await N.post(`https://greasyfork.org/zh-CN/users/${t}/sets/${e}`,{fetch:!0,headers:{accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","cache-control":"no-cache","content-type":"application/x-www-form-urlencoded",pragma:"no-cache"},fetchInit:{referrerPolicy:"strict-origin-when-cross-origin"},data:r});if(!i.status){f.error(n.t("更新收藏集表单请求失败"));return}let o=i.data.responseText;return u.parseHTML(o,!0,!0)},async switchLanguage(t){let e=await N.get(t,{fetch:!0,headers:{"Upgrade-Insecure-Requests":"1"}});e.status&&d.info(e);}},I={isCode(){var t;return (t=window.location.pathname.split("/"))==null?void 0:t.includes("code")},isCodeStrict(){return window.location.pathname.endsWith("/code")},isVersion(){return window.location.pathname.endsWith("/versions")},isUsers(){return window.location.pathname.match(/\/.+\/users\/.+/gi)},isScript(){return window.location.pathname.includes("/scripts/")},isScriptList(){return window.location.pathname.endsWith("/scripts")},isScriptLibraryList(){return window.location.pathname.endsWith("/libraries")},isScriptCodeSearch(){return window.location.pathname.endsWith("/code-search")},isDiscuessions(){return window.location.pathname.endsWith("/discussions")},isConversations(){return this.isUsers()&&window.location.pathname.includes("/conversations")}},L={menu:gt,isLogin:!1,initEnv(){let t=this.getUserLinkElement();this.isLogin=!!t;},getUserLinkElement(){return document.querySelector("#nav-user-info span.user-profile-link a")},async updateScript(t){let e=function(r,i=1){return `
			...
			</div>`};if(m.isNull(t))f.error(n.t("未获取到【脚本列表】"));else {let r=f.loading(e(x.getScriptName(t[0])),{html:!0}),i=0,o=0;for(let a=0;a<t.length;a++){let s=t[a],l=x.getScriptId(s);d.success("更新："+s);let c=x.getScriptName(s);r.setHTML(e(c,a+1));let p=await x.getSourceCodeSyncFormData(l);p?await x.sourceCodeSync(l,p)?(f.success(n.t("源代码同步成功，3秒后更新下一个")),await m.sleep(3e3),i++):(f.error(n.t("源代码同步失败")),o++):(f.error(n.t("源代码同步失败")),o++);}r.close(),i===0?f.error(n.t("全部更新失败")):f.success(n.t("全部更新完毕<br >成功：{{successNums}}<br >失败：{{failedNums}}<br >总计：{{scriptUrlListLength}}",{successNums:i,failedNums:o,scriptUrlListLength:t.length}),{html:!0});}},handleLocalGotoCallBack(){if(h.getValue("goto_updateSettingsAndSynchronize_scriptList")){if(h.deleteValue("goto_updateSettingsAndSynchronize_scriptList"),!I.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),L.getUserLinkElement()?(f.success(n.t("前往用户主页")),window.location.href=L.getUserLinkElement().href):f.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(e=>{t=t.concat(x.getAdminUrl(e.href));}),L.updateScript(t);}else if(h.getValue("goto_updateSettingsAndSynchronize_unlistedScriptList")){if(h.deleteValue("goto_updateSettingsAndSynchronize_unlistedScriptList"),!I.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),L.getUserLinkElement()?(f.success(n.t("前往用户主页")),window.location.href=L.getUserLinkElement().href):f.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(e=>{t=t.concat(x.getAdminUrl(e.href));}),L.updateScript(t);}else if(h.getValue("goto_updateSettingsAndSynchronize_libraryScriptList")){if(h.deleteValue("goto_updateSettingsAndSynchronize_libraryScriptList"),!I.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),L.getUserLinkElement()?(f.success(n.t("前往用户主页")),window.location.href=L.getUserLinkElement().href):f.error(n.t("获取当前已登录的用户主页失败"));return}let t=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(e=>{t=t.concat(x.getAdminUrl(e.href));}),L.updateScript(t);}}},Y=function(t,e,r,i,o,a){let s=[];typeof i=="function"?s=i():s=i;let l={text:t,type:"select",description:a,attributes:{},getValue(){return h.getValue(e,r)},callback(c,p,g){h.setValue(e,p),typeof o=="function"&&o(c,p,g);},data:s};return l.attributes&&(l.attributes[X]=e,l.attributes[tt]=r),l},Nt=function(t,e,r,i,o,a="default",s){let l=typeof o=="function"?o():o;typeof i=="object"&&s.initConfig(r,i);let c=()=>s.getShowText(r,l),p=Q(t,e,c,"keyboard",!1,!1,a,async g=>{var b;let v=(b=g.target.closest(".pops-panel-button"))==null?void 0:b.querySelector("span");if(s.isWaitPress){f.warning(n.t("请先执行当前的录入操作"));return}if(s.hasOptionValue(r))s.emptyOption(r),f.success(n.t("清空快捷键"));else {let k=f.loading(n.t("请按下快捷键..."),{showClose:!0}),{status:M,option:A,key:C}=await s.enterShortcutKeys(r);k.close(),M?(d.success(["成功录入快捷键",A]),f.success(n.t("成功录入"))):f.error(n.t("快捷键 {{key}} 已被 {{isUsedKey}} 占用",{key:s.translateKeyboardValueToButtonText(A),isUsedKey:C}));}v.innerHTML=c();});return p.attributes={},Reflect.set(p.attributes,ht,()=>!1),p};class Vt{constructor(e){ot(this,"key","short-cut");ot(this,"isWaitPress",!1);typeof e=="string"&&(this.key=e);}initConfig(e,r){this.hasOption(e)||this.setOption(e,r);}getStorageKey(){return this.key}getLocalAllOptions(){return D(this.key,[])}hasOption(e){return !!this.getLocalAllOptions().find(o=>o.key===e)}hasOptionValue(e){if(this.hasOption(e)){let r=this.getOption(e);return (r==null?void 0:r.value)!=null}else return !1}getOption(e,r){return this.getLocalAllOptions().find(a=>a.key===e)??r}setOption(e,r){let i=this.getLocalAllOptions(),o=i.findIndex(a=>a.key===e);o==-1?i.push({key:e,value:r}):Reflect.set(i[o],"value",r),j(this.key,i);}emptyOption(e){let r=!1,i=this.getLocalAllOptions(),o=i.findIndex(a=>a.key===e);return o!==-1&&(i[o].value=null,r=!0),j(this.key,i),r}deleteOption(e){let r=!1,i=this.getLocalAllOptions(),o=i.findIndex(a=>a.key===e);return o!==-1&&(i.splice(o,1),r=!0),j(this.key,i),r}translateKeyboardValueToButtonText(e){let r="";return e.ohterCodeList.forEach(i=>{r+=m.stringTitleToUpperCase(i,!0)+" + ";}),r+=e.keyName,r}getShowText(e,r){if(this.hasOption(e)){let i=this.getOption(e);return i.value==null?r:this.translateKeyboardValueToButtonText(i.value)}else return r}async enterShortcutKeys(e){return new Promise(r=>{this.isWaitPress=!0;let i=m.listenKeyboard(window,"keyup",(o,a,s)=>{let l={keyName:o,keyValue:a,ohterCodeList:s},c=JSON.stringify(l),p=this.getLocalAllOptions();for(let g=0;g<p.length;g++){let y=p[g];if(y.key===e)continue;let v=!1;if(y.value!=null&&c===JSON.stringify(y.value)&&(v=!0),v){this.isWaitPress=!1,i.removeListen(),r({status:!1,key:y.key,option:l});return}}this.setOption(e,l),this.isWaitPress=!1,i.removeListen(),r({status:!0,key:e,option:l});});})}initGlobalKeyboardListener(e){let r=this.getLocalAllOptions();if(!r.length){d.warn("没有设置快捷键");return}let i=this;function o(l,c){m.listenKeyboard(l,"keydown",(p,g,y)=>{if(i.isWaitPress)return;r=i.getLocalAllOptions();let v=r.findIndex(b=>{let k=b.value,M={keyName:p,keyValue:g,ohterCodeList:y};if(JSON.stringify(k)===JSON.stringify(M))return b});if(v!=-1){let b=r[v];d.info(["调用快捷键",b]),b.key in c&&c[b.key].callback();}});}let a={},s={};Object.keys(e).forEach(l=>{let c=e[l];(c.target==null||typeof c.target=="string"&&c.target==="")&&(c.target="window"),c.target==="window"?Reflect.set(a,l,c):Reflect.set(s,l,c);}),o(window,a),u.ready(()=>{Object.keys(s).forEach(async l=>{let c=s[l];if(typeof c.target=="string")m.waitNode(c.target,1e4).then(p=>{if(!p)return;let g={};Reflect.set(g,l,c),o(p,g);});else if(typeof c.target=="function"){let p=await c.target();if(p==null)return;let g={};Reflect.set(g,l,c),o(p,g);}else {let p={};Reflect.set(p,l,c),o(c.target,p);}});});}}const yt={shortCut:new Vt,shortOption:{"gf-quickReply":{target:()=>{let t=document.querySelector("#comment_text"),e=document.querySelector('input[name="commit"][type="submit"]');if(t){if(!e){d.error("页面不存在【发表回复】按钮");return}}else {d.error("页面不存在输入框");return}return t},callback(){let t=document.querySelector('input[name="commit"][type="submit"]');if(!t){d.error("页面不存在【发表回复】按钮");return}t.click();}}},init(){this.shortCut.initGlobalKeyboardListener(this.shortOption);}},Bt={id:"greasy-fork-panel-config-account",title:n.t("通用"),forms:[{text:"",type:"forms",forms:[{text:n.t("Toast配置"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[Y(n.t("Toast位置"),"qmsg-config-position","bottom",[{value:"topleft",text:n.t("左上角")},{value:"top",text:n.t("顶部")},{value:"topright",text:n.t("右上角")},{value:"left",text:n.t("左边")},{value:"center",text:n.t("中间")},{value:"right",text:n.t("右边")},{value:"bottomleft",text:n.t("左下角")},{value:"bottom",text:n.t("底部")},{value:"bottomright",text:n.t("右下角")}],(t,e,r)=>{d.info("设置当前Qmsg弹出位置"+r);},n.t("Toast显示在页面九宫格的位置")),Y(n.t("最多显示的数量"),"qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,n.t("限制Toast显示的数量")),w(n.t("逆序弹出"),"qmsg-config-showreverse",!1,void 0,n.t("修改Toast弹出的顺序"))]}]},Y(n.t("语言"),"setting-language","zh-CN",[{value:"zh-CN",text:"中文"},{value:"en-US",text:"English"}],(t,e,r)=>{d.info("改变语言："+r),n.changeLanguage(e);})]},{text:"",type:"forms",forms:[{text:n.t("账号/密码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[pt(n.t("账号"),"user","",void 0,void 0,n.t("请输入账号")),pt(n.t("密码"),"pwd","",void 0,void 0,n.t("请输入密码"),!1,!0)]},{text:"",type:"forms",forms:[w(n.t("自动登录"),"autoLogin",!0,void 0,n.t("自动登录当前保存的账号")),Q(n.t("清空账号/密码"),void 0,n.t("点击清空"),void 0,void 0,!1,"default",t=>{if(confirm(n.t("确定清空账号和密码？"))){h.deleteValue("user"),h.deleteValue("pwd"),f.success(n.t("已清空账号/密码"));let e=t.target.getRootNode();e.querySelector('li[data-key="user"] .pops-panel-input input').value="",e.querySelector('li[data-key="pwd"] .pops-panel-input input').value="";}})]}]},{text:n.t("功能"),type:"deepMenu",forms:[{text:n.t("功能"),type:"forms",forms:[Y(n.t("固定当前语言"),"language-selector-locale","",function(){let t=[{value:"",text:n.t("无")}];return document.querySelectorAll("select#language-selector-locale option").forEach(e=>{let r=e.getAttribute("value");if(r==="help")return;let i=(e.innerText||e.textContent).trim();t.push({value:r,text:i});}),t}()),w(n.t("修复图片宽度显示问题"),"fixImageWidth",!0,void 0,n.t("修复图片在移动端宽度超出浏览器宽度问题")),w(n.t("优化图片浏览"),"optimizeImageBrowsing",!0,void 0,n.t("使用Viewer浏览图片")),w(n.t("覆盖图床图片跳转"),"overlayBedImageClickEvent",!0,void 0,n.t("配合上面的【优化图片浏览】更优雅浏览图片")),w(n.t("添加【操作面板】按钮"),"scripts-addOperationPanelBtnWithNavigator",!0,void 0,n.t("在脚本列表页面时为顶部导航栏添加【操作面板】按钮")),w(n.t("给Markdown添加【复制】按钮"),"addMarkdownCopyButton",!0,void 0,n.t("在Markdown内容右上角添加【复制】按钮，点击一键复制Markdown内容"))]},{text:n.t("检测页面加载"),type:"forms",forms:[w(n.t("启用"),"checkPage",!0,void 0,n.t("检测Greasyfork页面是否正常加载，如加载失败则自动刷新页面")),Y(n.t("检测间隔"),"greasyfork-check-page-timeout",5,(()=>{let t=[];for(let e=0;e<5;e++)t.push({value:e+1,text:e+1+"s"});return t})(),void 0,n.t("设置检测上次刷新页面的间隔时间，当距离上次刷新页面的时间超过设置的值，将不再刷新页面"))]},{text:n.t("代码同步"),type:"forms",forms:[Q(n.t("源代码同步【脚本列表】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!I.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_scriptList",!0),L.getUserLinkElement()?(f.success(n.t("前往用户主页")),window.location.href=L.getUserLinkElement().href):f.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-script-list-section li a.script-link").forEach(r=>{e=e.concat(x.getAdminUrl(r.href));}),L.updateScript(e);}),Q(n.t("源代码同步【未上架的脚本】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!I.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_unlistedScriptList",!0),L.getUserLinkElement()?(f.success(n.t("前往用户主页")),window.location.href=L.getUserLinkElement().href):f.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-unlisted-script-list li a.script-link").forEach(r=>{e=e.concat(x.getAdminUrl(r.href));}),L.updateScript(e);}),Q(n.t("源代码同步【库】"),void 0,n.t("一键同步"),void 0,void 0,!1,"primary",t=>{if(!I.isUsers()){h.setValue("goto_updateSettingsAndSynchronize_libraryScriptList",!0),L.getUserLinkElement()?(f.success(n.t("前往用户主页")),window.location.href=L.getUserLinkElement().href):f.error(n.t("获取当前已登录的用户主页失败"));return}let e=[];document.querySelectorAll("#user-library-script-list li a.script-link").forEach(r=>{e=e.concat(x.getAdminUrl(r.href));}),L.updateScript(e);})]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化页面元素"),"beautifyPage",!0,void 0,n.t("如button、input、textarea")),w(n.t("美化上传图片按钮"),"beautifyUploadImage",!0,void 0,n.t("放大上传区域")),w(n.t("美化顶部导航栏"),"beautifyTopNavigationBar",!0,void 0,n.t("可能会跟Greasyfork Beautify脚本有冲突")),w(n.t("美化Greasyfork Beautify脚本"),"beautifyGreasyforkBeautify",!0,void 0,n.t('需安装Greasyfork Beautify脚本，<a href="https://greasyfork.org/zh-CN/scripts/446849-greasyfork-beautify" target="_blank">🖐点我安装</a>'))]}]},{type:"deepMenu",text:n.t("自定义快捷键"),forms:[{type:"forms",text:"",forms:[Nt(n.t("快捷键发表回复"),n.t("在输入框内按下快捷发表回复，例如：{{key}}",{key:"Ctrl + Enter"}),"gf-quickReply",{keyName:"Enter",keyValue:"13",ohterCodeList:["ctrl"]},n.t("点击录入快捷键"),void 0,yt.shortCut)]}]}]}]},zt={init(){h.execMenuOnce("code-repairCodeLineNumber",()=>{this.repairCodeLineNumber();});},repairCodeLineNumber(){d.info("修复代码的行号显示不够问题"),h.execMenuOnce("beautifyGreasyforkBeautify",()=>{S(`
				.code-container pre code .marker{
					padding-left: 6px;
				}	
				`);}),m.waitNode("#script-content div.code-container pre.prettyprint ol").then(t=>{t.childElementCount>=1e3&&(d.success(`当前代码行数${t.childElementCount}行，超过1000行，优化行号显示问题`),S(`
                    pre.prettyprint{
                        padding-left: 26px;
                    }
...
`,et={addBlockCSS(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(r=>{Array.isArray(r)?e=e.concat(r):e.push(r);}),it(`${e.join(`,
`)}{display: none !important;}`)},setGMResourceCSS(t){let e=typeof lt=="function"?lt(t.keyName):"";typeof e=="string"&&e?it(e):et.addLinkNode(t.url);},async addLinkNode(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,u.ready(()=>{document.head.appendChild(e);}),e},fixUrl(t){return t=t.trim(),t.match(/^http(s|):\/\//i)||(t.startsWith("/")||(t+="/"),t=window.location.origin+t),t}},ct={getInstallUrl(t,e,r){return m.isNotNull(r)?r="/"+r:r="",`https://update.greasyfork.org/scripts/${t}/${e}${r}.user.js`},getCodeUrl(t,e){return m.isNull(e)&&(e=""),`https://greasyfork.org/scripts/${t}/code?version=${e}`},getScriptInfoUrl(t){return `https://greasyfork.org/scripts/${t}.json`}},Rt={init(){h.execMenuOnce("beautifyHistoryVersionPage",()=>this.beautifyHistoryVersionPage()),h.execMenuOnce("scripts-versions-addExtraTagButton",()=>{this.addExtraTagButton();});},beautifyHistoryVersionPage(){d.info("美化 历史版本 页面");let t=[];return t.push(S(qt)),t.push(et.addBlockCSS(".version-number",".version-date",".version-changelog")),u.ready(function(){let e=document.querySelector("ul.history_versions");if(!e){f.error(n.t("未找到history_versions元素列表"));return}Array.from(e.children).forEach(r=>{var g,y;let i=r.querySelector(".version-number a").href,o=r.querySelector(".version-number a").innerText,a=(g=r.querySelector(".version-date"))==null?void 0:g.getAttribute("datetime"),s=((y=r.querySelector(".version-changelog"))==null?void 0:y.innerHTML)||"",l=u.createElement("span",{className:"script-version-date",innerHTML:m.formatTime(a,n.t("yyyy年MM月dd日 HH:mm:ss"))}),c=u.createElement("div",{className:"script-tag",innerHTML:`
                    <div class="script-tag-version">
                    ...
                    </div>`}),p=u.createElement("div",{className:"script-note-box-body",innerHTML:s});r.appendChild(l),r.appendChild(c),r.appendChild(p);});}),t},addExtraTagButton(){d.info("添加额外的标签按钮"),u.ready(()=>{document.querySelectorAll(".script-tag-version").forEach(t=>{var p,g;let e=t.querySelector("a");if(!e)return;let r=new URL(e.href),i=(p=r.pathname.match(/\/scripts\/([\d]+)/))==null?void 0:p[1],o=r.searchParams.get("version"),a=(g=r.pathname.match(/\/scripts\/[\d]+-(.+)/))==null?void 0:g[1],s=ct.getInstallUrl(i,o,a),l=ct.getCodeUrl(i,o),c=u.createElement("div",{className:"scripts-tag-install",innerHTML:`
						...
						`});u.after(t,c);});});}};let rt=[];const bt=async function(t){if(d.info("当前脚本id："+t),!L.isLogin){d.error("请先登录账号"),f.error(n.t("请先登录账号"));return}let e=x.getUserId(L.getUserLinkElement().href);if(e==null){d.error("获取用户id失败"),f.error(n.t("获取用户id失败"));return}if(!rt.length){let o=f.loading(n.t("获取收藏夹中..."));if(rt=await x.getUserCollection(e)||[],o.close(),!rt.length)return}let r="";rt.forEach(o=>{r+=`
		...
		`});u.on(i.$shadowRoot,"click",".collect-add-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("添加中...")),c=await x.getUserCollectionInfo(e,s);if(!c){l.close();return}let p=m.cloneFormData(c),g=m.cloneFormData(c),y=!1;for(const[T,E]of c.entries())if(T==="scripts-included[]"&&String(E).trim()===String(t).trim()){y=!0;break}else g.append(T,E),p.append(T,E);if(y){f.warning(n.t("该脚本已经在该收藏集中")),l.close();return}p.set("add-script",t.toString()),p.set("script-action","i"),g.append("scripts-included[]",t.toString()),g.set("save","1");let v=new URLSearchParams(p),b=new URLSearchParams(g),k=Array.from(v).map(([T,E])=>`${encodeURIComponent(T)}=${encodeURIComponent(E)}`).join("&"),M=Array.from(b).map(([T,E])=>`${encodeURIComponent(T)}=${encodeURIComponent(E)}`).join("&");d.info(["添加的数据",k]),d.info(["保存的数据",M]);let A=await x.updateUserSetsInfo(e,s,k);if(!A){l.close();return}let C=A.querySelector(".change-script-set");if(!C){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:".change-script-set"})),l.close();return}let U=C.querySelector("section");if(!U){f.error(n.t("添加失败，{{selector}}元素不存在",{selector:"section"})),l.close();return}let q=U.querySelector(".alert");q?V.alert({title:{text:n.t("添加失败"),position:"center"},content:{text:q.innerHTML,html:!0},mask:{enable:!0,clickEvent:{toClose:!0}},style:`
					.pops-alert-content{
						font-style: italic;
					...
					`,drag:!0,dragLimit:!0,width:V.isPhone()?"88vw":"400px",height:V.isPhone()?"50vh":"300px"}):(await x.updateUserSetsInfo(e,s,M),f.success(n.t("添加成功"))),l.close();}),u.on(i.$shadowRoot,"click",".collect-delete-script-id",async function(o){let a=o.target.closest(".user-collect-item"),s=a.dataset.id;a.dataset.name;let l=f.loading(n.t("删除中...")),c=await x.getUserCollectionInfo(e,s);if(!c){l.close();return}let p=new FormData,g=new FormData,y=!1;for(const[C,U]of c.entries()){if(String(C).trim()==="scripts-included[]"&&String(U).trim()===String(t).trim()){y=!0;continue}g.append(C,U),p.append(C,U);}if(!y){f.warning(n.t("该收藏集未包含：{{scriptId}}",{scriptId:t})),l.close();return}p.set("remove-scripts-included[]",t.toString()),p.set("remove-selected-scripts","i"),p.delete("script-action"),g.set("save","1");let v=new URLSearchParams(p),b=new URLSearchParams(g),k=Array.from(v).map(([C,U])=>`${encodeURIComponent(C)}=${encodeURIComponent(U)}`).join("&"),M=Array.from(b).map(([C,U])=>`${encodeURIComponent(C)}=${encodeURIComponent(U)}`).join("&");if(d.info(["删除的数据",k]),d.info(["保存的数据",M]),!await x.updateUserSetsInfo(e,s,k)){l.close();return}await x.updateUserSetsInfo(e,s,M),f.success(n.t("删除成功")),l.close();});},Ot={init(){I.isCode()?zt.init():I.isVersion()&&Rt.init(),I.isCodeStrict()&&(h.execMenuOnce("fullScreenOptimization",()=>{this.fullScreenOptimization();}),h.execMenuOnce("addCopyCodeButton",()=>{this.addCopyCodeButton();})),h.execMenuOnce("addCollectionButton",()=>{this.addCollectionButton();}),h.execMenuOnce("addFindReferenceButton",()=>{this.setFindCodeSearchBtn();}),h.execMenuOnce("scriptHomepageAddedTodaySUpdate",()=>{this.scriptHomepageAddedTodaySUpdate();});},addCollectionButton(){d.info("添加收藏按钮"),m.waitNode("ul#script-links li.current span").then(()=>{let t=u.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("收藏")}</span>
					</a>`});u.append(document.querySelector("ul#script-links"),t),u.on(t,"click",()=>{let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){d.error([e,window.location.pathname]),f.error(n.t("获取脚本id失败"));return}let r=e[e.length-1];bt(r);});});},fullScreenOptimization(){d.info("F11全屏，F键代码全屏"),S(`
        .code-wide-screen{
          position: absolute;
          top: 0;
          left: 0;
        ...
        `);let t=!1;u.keydown(_,function(e){if(e.key.toLowerCase()==="f"){let r=document.querySelector("#script-content div.code-container code");e.altKey&&e.shiftKey?(m.preventEvent(e),r.classList.contains("code-wide-screen")?r.classList.remove("code-wide-screen"):r.classList.add("code-wide-screen")):!e.altKey&&!e.ctrlKey&&!e.shiftKey&&!e.metaKey&&(m.preventEvent(e),t?(m.exitFullScreen(r),t=!1):(m.enterFullScreen(r),t=!0));}},{capture:!0});},setFindCodeSearchBtn(){d.info("设置代码搜索按钮(对于库)"),m.waitNode("ul#script-links li.current span").then(()=>{let t=u.createElement("li",{innerHTML:`
					<a href="javascript:;">
						<span>${n.t("寻找引用")}</span>
					</a>`});u.append(document.querySelector("ul#script-links"),t),u.on(t,"click",async function(){let e=window.location.pathname.match(/scripts\/([\d]+)/i);if(!e){d.error([e,window.location.pathname]),f.error(n.t("获取脚本id失败"));return}let r=e[e.length-1];window.location.href=x.getCodeSearchUrl(`greasyfork.org/scripts/${r}`);});});},async scriptHomepageAddedTodaySUpdate(){if(!document.querySelector("#install-area"))return;d.info("脚本首页新增【今日检查】");let t=await x.getScriptStats(x.getScriptId());if(!t)return;let e=m.toJSON(t.responseText);d.info(["统计信息",e]);let r=e[m.formatTime(void 0,"yyyy-MM-dd")];if(!r){d.error("今日份的统计信息不存在");return}let i=r.update_checks;d.info(["今日统计信息",r]),u.after("dd.script-show-daily-installs",u.createElement("dt",{className:"script-show-daily-update_checks",innerHTML:`<span>${n.t("今日检查")}</span>`})),u.after("dt.script-show-daily-update_checks",u.createElement("dd",{className:"script-show-daily-update_checks",innerHTML:"<span>"+i+"</span>"}));},addCopyCodeButton(){d.info("添加复制代码按钮"),m.waitNode("div#script-content div.code-container").then(t=>{let e=u.createElement("button",{textContent:n.t("复制代码")},{style:"margin-bottom: 1em;"});u.on(e,"click",async function(){let r=f.loading(n.t("加载文件中...")),i=await N.get(`https://greasyfork.org/zh-CN/scripts/${x.getScriptId()}.json`,{fetch:!0,responseType:"json"});if(!i.status){r.close();return}let a=m.toJSON(i.data.responseText).code_url;d.success(["代码地址：",a]);let s=await N.get(a);if(!s.status){r.close();return}r.close(),m.setClip(s.data.responseText),f.success(n.t("复制成功"));}),u.before(t,e);});}},Pt=`.sidebarred-main-content {\r
	max-width: unset;\r
	flex: unset;\r
}\r
ol.script-list {\r
...
`,at={getTampermonkey:()=>{var t;return (t=_.external)==null?void 0:t.Tampermonkey},getViolentmonkey:()=>{var t;return (t=_.external)==null?void 0:t.Violentmonkey},getScriptCat:()=>{var t;return (t=_.external)==null?void 0:t.Scriptcat},getScriptContainerStatus(){var e,r,i;let t={Tampermonkey:!1,Violentmonkey:!1,ScriptCat:!1};return (e=_.external)!=null&&e.Tampermonkey&&(t.Tampermonkey=!0),(r=_.external)!=null&&r.Violentmonkey&&(t.Violentmonkey=!0),(i=_.external)!=null&&i.Scriptcat&&(t.ScriptCat=!0),t},getInstalledVersion(t,e){return new Promise((r,i)=>{const o=this.getTampermonkey();if(o){o.isInstalled(t,e,function(l){l.installed?r(l.version):r(null);});return}const a=this.getViolentmonkey();if(a){a.isInstalled(t,e).then(r);return}const s=this.getScriptCat();if(s){s.isInstalled(t,e,function(l){l.installed?r(l.version):r(null);});return}i(new TypeError("获取脚本容器暴露的external信息失败"));})},compareVersions(t,e){if(t===e)return 0;const r=t.split("."),i=e.split(".");for(let o=0;o<r.length;o++){const a=this.compareVersionPart(r[o],i[o]);if(a!==0)return a}return 0},compareVersionPart(t,e){const r=this.parseVersionPart(t),i=this.parseVersionPart(e);for(let o=0;o<r.length;o++){if(r[o].length>0&&i[o].length===0)return -1;if(r[o].length===0&&i[o].length>0||r[o]>i[o])return 1;if(r[o]<i[o])return -1}return 0},parseVersionPart(t){if(!t)return [0,"",0,""];const e=/([0-9]*)([^0-9]*)([0-9]*)([^0-9]*)/.exec(t);return [e[1]?parseInt(e[1]):0,e[2],e[3]?parseInt(e[3]):0,e[4]]},handleInstallResult(t,e,r){if(e!=null)switch(t.removeAttribute("data-ping-url"),this.compareVersions(e,r)){case-1:t.textContent=t.getAttribute("data-update-label");break;case 1:t.textContent=t.getAttribute("data-downgrade-label");break;case 0:t.textContent=t.getAttribute("data-reinstall-label");break}},async checkForUpdatesJS(t,e){const r=t.getAttribute("data-script-name"),i=t.getAttribute("data-script-namespace"),o=t.getAttribute("data-script-version");try{let a=await this.getInstalledVersion(r,i);return a==null?!1:(this.handleInstallResult(t,a,o),!0)}catch{if(e){await m.sleep(1e3);try{return await this.checkForUpdatesJS(t,!1)}catch{}}return !1}},checkForUpdatesCSS(t){const e=t.getAttribute("data-script-name"),r=t.getAttribute("data-script-namespace");postMessage({type:"style-version-query",name:e,namespace:r,url:location.href},location.origin);}},xt=t=>{let e=t.dataset;const r={scriptId:parseInt(e.scriptId),scriptName:e.scriptName,scriptAuthors:[],scriptDailyInstalls:parseInt(e.scriptDailyInstalls),scriptTotalInstalls:parseInt(e.scriptTotalInstalls),scriptRatingScore:parseFloat(e.scriptRatingScore),scriptCreatedDate:new Date(e.scriptCreatedDate),scriptUpdatedDate:new Date(e.scriptUpdatedDate),scriptType:e.scriptType,scriptVersion:e.scriptVersion,sensitive:e.sensitive==="true",scriptLanguage:e.scriptLanguage,cssAvailableAsJs:e.cssAvailableAsJs==="true",codeUrl:e.codeUrl,scriptDescription:e.scriptDescription,scriptAuthorId:parseInt(e.scriptAuthorId),scriptAuthorName:e.scriptAuthorName};let i=m.toJSON(e.scriptAuthors);if(Object.keys(i).forEach(o=>{let a=i[o];r.scriptAuthors.push({authorId:parseInt(o),authorName:a});}),(r.scriptAuthorName==null||isNaN(r.scriptAuthorId))&&r.scriptAuthors.length&&(r.scriptAuthorName=r.scriptAuthors[0].authorName,r.scriptAuthorId=r.scriptAuthors[0].authorId),r.scriptDescription==null){let o=t.querySelector(".script-description")||t.querySelector(".description");o&&(r.scriptDescription=o.innerText||o.textContent);}return r},wt={init(){h.execMenuOnce("gf-scripts-filter-enable",()=>{H.init();}),h.execMenuOnce("beautifyCenterContent",()=>this.beautifyCenterContent());},beautifyCenterContent(){d.info("美化脚本列表");let t=[];return t.push(it(Pt)),$.ready(async()=>{H.getElementList().forEach(a=>{if(a.querySelector(".script-list-operation"))return;let s=xt(a),l=a.querySelector(".inline-script-stats"),c=s.codeUrl,p=$.createElement("dt",{className:"script-list-rating-score",innerHTML:`<span>${n.t("评分")}</span>`}),g=$.createElement("dd",{className:"script-list-rating-score",innerHTML:`<span>${s.scriptRatingScore}</span>`},{"data-position":"right"}),y=a.querySelector("dd.script-list-ratings .good-rating-count"),v=a.querySelector("dd.script-list-ratings .ok-rating-count"),b=a.querySelector("dd.script-list-ratings .bad-rating-count");if(y&&v&&b){let T=parseInt(y.innerText),E=parseInt(v.innerText),z=parseInt(b.innerText),R=T+E+z;R>=10?T/R>=.6?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count"):R==0||T>E+z?g.classList.add("good-rating-count"):g.classList.add("bad-rating-count");}let k=$.createElement("dt",{className:"script-list-version",innerHTML:`<span>${n.t("版本")}</span>`}),M=$.createElement("dd",{className:"script-list-version",innerHTML:`<span>${s.scriptVersion}</span>`},{"data-position":"right"}),A=$.createElement("dt",{className:"script-list-operation",innerHTML:`<span>${n.t("操作")}</span>`}),C=$.createElement("dd",{className:"script-list-operation",innerHTML:`
						<a
							target="_blank"
							class="install-link"
						...
						`},{"data-position":"right",style:"gap:10px;display: flex;flex-wrap: wrap;align-items: center;"}),U=C.querySelector(".script-collect-btn"),q=C.querySelector(".install-link");if(q["data-script-info"]=s,q.classList.add("lum-lightbox-loader"),s.scriptType==="library"&&q.remove(),$.on(U,"click",T=>{m.preventEvent(T),bt(s.scriptId);}),h.getValue("gf-scripts-filter-enable")){let T=$.createElement("button",{className:"script-filter-btn",innerHTML:n.t("过滤")}),E="data-filter-key",z="data-filter-value";$.on(T,"click",R=>{m.preventEvent(R);let O=V.alert({title:{text:n.t("选择需要过滤的选项"),position:"center"},content:{text:`
									<button ${E}="scriptId" ${z}="^${s.scriptId}$">${n.t("脚本id：{{text}}",{text:s.scriptId})}</button>
									<button ${E}="scriptName" ${z}="^${m.parseStringToRegExpString(s.scriptName)}$">${n.t("脚本名：{{text}}",{text:s.scriptName})}</button>
								...
								`}),J=O.$shadowRoot.querySelector(".pops-alert-content");s.scriptAuthors.forEach(G=>{let W=$.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:G.authorId})});W.setAttribute(E,"scriptAuthorId"),W.setAttribute(z,"^"+G.authorId+"$");let Z=$.createElement("button",{innerHTML:n.t("作者名：{{text}}",{text:G.authorName})});Z.setAttribute(E,"scriptAuthorName"),Z.setAttribute(z,"^"+m.parseStringToRegExpString(G.authorName)+"$"),J.appendChild(W),J.appendChild(Z);}),$.on(O.$shadowRoot,"click",`button[${E}]`,G=>{m.preventEvent(G);let W=G.target,Z=W.getAttribute(E),St=W.getAttribute(z);H.addValue(Z,St),O.close(),H.filter(),f.success(n.t("添加成功"));});}),C.appendChild(T);}l.appendChild(p),l.appendChild(g),l.appendChild(k),l.appendChild(M),l.appendChild(A),l.appendChild(C);});let r=Array.from(document.querySelectorAll(".install-link[data-install-format=js]")),i=at.getScriptContainerStatus(),o=Object.values(i).filter(Boolean);if(!i.Tampermonkey)r.forEach(async a=>{let s=await at.checkForUpdatesJS(a,!0);a.classList.remove("lum-lightbox-loader"),s||(a.textContent=n.t("安装此脚本"));});else if(o.length)for(let a=0;a<r.length;a++){let s=r[a],l=s["data-script-info"],c=await N.get(ct.getScriptInfoUrl(l.scriptId),{fetch:!0});if(!c.status){s.textContent=n.t("安装此脚本");continue}let p=m.toJSON(c.data.responseText);s.setAttribute("data-script-namespace",p.namespace);let g=await at.checkForUpdatesJS(s,!0);s.classList.remove("lum-lightbox-loader"),g||(s.textContent=n.t("安装此脚本")),await m.sleep(150);}else d.error("未知的脚本容器");}),t}},H={key:"gf-shield-rule",init(){d.info("脚本过滤");let t=new m.LockFunction(()=>{this.filter();},50);u.ready(()=>{m.mutationObserver(document.body,{config:{subtree:!0,childList:!0},callback:()=>{t.run();}}),t.run();});},getElementList(){let t=[];return t=t.concat(Array.from(document.querySelectorAll("ol.script-list li"))),t},filter(){this.getElementList().forEach(t=>{let e=xt(t),r=this.getValue().split(`
`);for(let i=0;i<r.length;i++){let o=r[i],a=o.split("##"),s=a[0],l=a[1];if(s==="scriptRatingScore"){let c=parseFloat(l.slice(1));if(l.startsWith(">")){if(e.scriptRatingScore>c){d.info(["触发脚本过滤规则",[o,e]]),t.remove();break}}else if(l.startsWith("<")&&e.scriptRatingScore<c){d.info(["触发脚本过滤规则",[o,e]]),t.remove();break}}else if(s in e||s==="scriptDescription"){if(typeof l!="string")continue;let c=new RegExp(l,"ig");if(String(e[s]).match(c)){d.info(["触发脚本过滤规则",o,e]),t.remove();break}}}});},setValue(t){h.setValue(this.key,t);},addValue(t,e){let r=this.getValue();if(r.trim()!==""&&(r+=`
`),m.isNull(t))return;t=t.toString().trim();let i=t+"##"+e;r+=i,this.setValue(r);},getValue(){return h.getValue(this.key,"")}},Dt={id:"greasy-fork-panel-config-scripts",title:n.t("脚本"),forms:[{text:"",type:"forms",forms:[{text:n.t("代码"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("添加复制代码按钮"),"addCopyCodeButton",!0,void 0,n.t("更优雅的复制")),w(n.t("快捷键"),"fullScreenOptimization",!0,void 0,n.t("【F】键全屏、【Alt+Shift+F】键宽屏")),w(n.t("修复代码行号显示"),"code-repairCodeLineNumber",!0,void 0,n.t("修复代码行数超过1k行号显示不全问题"))]}]},{text:n.t("历史版本"),type:"deepMenu",forms:[{text:n.t("功能"),type:"forms",forms:[w(n.t("添加额外的标签按钮"),"scripts-versions-addExtraTagButton",!0,void 0,n.t("在版本下面添加【安装】、【查看代码】按钮"))]},{text:n.t("美化"),type:"forms",forms:[w(n.t("美化历史版本页面"),"beautifyHistoryVersionPage",!0,void 0,n.t("更直观的查看版本迭代"))]}]}]},{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("添加【寻找引用】按钮"),"addFindReferenceButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于搜索引用该库的相关脚本")),w(n.t("添加【收藏】按钮"),"addCollectionButton",!0,void 0,n.t("在脚本栏添加按钮，一般用于快捷收藏该脚本/库")),w(n.t("添加【今日检查】信息块"),"scriptHomepageAddedTodaySUpdate",!0,void 0,n.t("在脚本信息栏添加【今日检查】信息块"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化脚本列表"),"beautifyCenterContent",!0,void 0,n.t("双列显示且添加脚本卡片操作项（安装、收藏）"))]}]},{text:n.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%84%9A%E6%9C%AC%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${n.t("帮助文档")}</a>`,type:"forms",forms:[w(n.t("启用"),"gf-scripts-filter-enable",!0,void 0,n.t("作用域：脚本、脚本搜索、用户主页")),{type:"own",getLiElementCallBack(t){let e=u.createElement("div",{className:"pops-panel-textarea",innerHTML:`
												<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=e.querySelector("textarea");return r.value=H.getValue(),u.on(r,["input","propertychange"],void 0,m.debounce(function(i){H.setValue(r.value);},200)),t.appendChild(e),t}}]}]}]}]},F={key:"gf-discuessions-filter-rule",$data:{FILTER_SCRIPT_KEY:"greasyfork-discussions-filter-script",FILTER_POST_USER_KEY:"greasyfork-discussions-filter-post-user",FILTER_REPLY_USER_KEY:"greasyfork-discussions-filter-reply-user"},init(){d.info("论坛-过滤"),S(`
        ...
        `);let t=new m.LockFunction(()=>{this.filter();},50);m.mutationObserver(document.body,{config:{subtree:!0,childList:!0},callback:()=>{t.run();}}),t.run();},getElementList(){let t=[];return t=t.concat(Array.from(document.querySelectorAll(".discussion-list-container"))),t},filter(){this.transformOldRule();const t=new Map;this.getElementList().forEach((e,r)=>{const i=this.parseDiscuessionListContainerInfo(e);let o=this.getValue().split(`
`);if(t.has(i.snippet)&&h.getValue("greasyfork-discussions-filter-duplicate-comments")){let a=t.get(i.snippet).querySelector("a.discussion-title");a.setAttribute("data-repeat-tip-show","true");let s=0;a.hasAttribute("data-repeat-count")&&(s=parseInt(a.getAttribute("data-repeat-count"))),s++,a.setAttribute("data-repeat-count",s.toString()),a.setAttribute("data-repeat-tip-show",n.t("已过滤：{{oldCount}}",{oldCount:s})),d.success([`过滤重复内容：${i.snippet}`,i]),e.remove();return}t.set(i.snippet,e);for(let a=0;a<o.length;a++){let s=o[a],l=s.split("##"),c=l[0],p=l[1];if(c in i){let g=new RegExp(p,"ig");if(i[c]!=null&&String(i[c]).match(g)){d.info(["触发论坛过滤规则",s,i]),e.remove();return}}}});},parseDiscuessionListContainerInfo(t){var r,i,o,a;const e={scriptName:t.querySelector(".discussion-meta-item-script-name").innerText,scriptUrl:(r=t.querySelector(".discussion-meta-item-script-name a"))==null?void 0:r.href,scriptId:x.getScriptId((i=t.querySelector(".discussion-meta-item-script-name a"))==null?void 0:i.href),postUserName:t.querySelector("a.user-link").innerText,postUserHomeUrl:t.querySelector("a.user-link").href,postUserId:x.getUserId(t.querySelector("a.user-link").href),postTimeStamp:new Date(t.querySelector("relative-time").getAttribute("datetime")),snippetUrl:t.querySelector("a.discussion-title").href,snippet:((o=t.querySelector("span.discussion-snippet"))==null?void 0:o.innerText)||"",replyUserName:void 0,replyUserHomeUrl:void 0,replyUserId:void 0,replyTimeStamp:void 0};return t.querySelector(".discussion-meta-item .discussion-meta-item")&&(e.replyUserName=t.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").innerText,e.replyUserHomeUrl=t.querySelector(".discussion-meta-item .discussion-meta-item a.user-link").href,e.replyUserId=x.getUserId(e.replyUserHomeUrl),e.replyTimeStamp=new Date((a=t.querySelector(".discussion-meta-item .discussion-meta-item relative-time"))==null?void 0:a.getAttribute("datetime"))),e},transformOldRule(){if(Date.now()>new Date("2024-8-19").getTime())return;const t="greasyfork-discussions-filter-script",e="greasyfork-discussions-filter-post-user",r="greasyfork-discussions-filter-reply-user",i=h.getValue(t,""),o=h.getValue(e,""),a=h.getValue(r,""),s=i.trim()===""?[]:i.split(`
`),l=o.trim()===""?[]:o.split(`
`),c=a.trim()===""?[]:a.split(`
`);s.forEach(p=>{this.addValue("scriptId",m.parseStringToRegExpString("^"+p+"$"));}),l.forEach(p=>{this.addValue("postUserId",m.parseStringToRegExpString("^"+p+"$"));}),c.forEach(p=>{this.addValue("replyUserId",m.parseStringToRegExpString("^"+p+"$"));}),h.deleteValue(t),h.deleteValue(e),h.deleteValue(r);},setValue(t){h.setValue(this.key,t);},addValue(t,e){let r=this.getValue();if(r.trim()!==""&&(r+=`
`),m.isNull(t))return;t=t.toString().trim();let i=t+"##"+e;r+=i,this.setValue(r);},getValue(){return h.getValue(this.key,"")}},Gt={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(t){let e="discussions-readBgColor",r=u.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
											<p class="pops-panel-item-left-main-text">${n.t("自定义已读颜色")}</p>
											<p class="pops-panel-item-left-desc-text">${n.t("在讨论内生效")}</p>
											`}),i=u.createElement("div",{className:"pops-panel-item-right",innerHTML:`
											<input type="color" class="pops-color-choose" />
											`}),o=i.querySelector(".pops-color-choose");o.value=h.getValue(e);let a=u.createElement("style");return u.append(document.head,a),u.on(o,["input","propertychange"],s=>{d.info("选择颜色："+o.value),a.innerHTML=`
												.discussion-read{
													background: ${o.value} !important;
												}
												`,h.setValue(e,o.value);}),t.appendChild(r),t.appendChild(i),t}},w(n.t("添加快捷操作按钮"),"discussions-addShortcutOperationButton",!0,void 0,n.t("在每一行讨论的最后面添加【过滤】按钮，需开启过滤功能才会生效"))]}]},{text:n.t("过滤"),type:"deepMenu",forms:[{text:`<a target="_blank" href="https://greasyfork.org/zh-CN/scripts/475722-greasyfork%E4%BC%98%E5%8C%96#:~:text=%E8%AE%BA%E5%9D%9B%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99">${n.t("帮助文档")}</a>`,type:"forms",forms:[w(n.t("启用"),"greasyfork-discussions-filter-enable",!0,void 0,n.t("开启后下面的过滤功能才会生效")),w(n.t("过滤重复的评论"),"greasyfork-discussions-filter-duplicate-comments",!1,void 0,n.t("过滤掉重复的评论数量(≥2)")),{type:"own",getLiElementCallBack(t){let e=u.createElement("div",{className:"pops-panel-textarea",innerHTML:`
										<textarea placeholder="${n.t("请输入规则，每行一个")}" style="height:200px;"></textarea>`},{style:"width: 100%;"}),r=e.querySelector("textarea");return r.value=F.getValue(),u.on(r,["input","propertychange"],void 0,m.debounce(function(i){F.setValue(r.value);},200)),t.appendChild(e),t}}]}]}]}]},vt={async UIScriptList(t,e,r,i){var g,y,v;if(!L.isLogin){f.error(n.t("请先登录账号！"));return}let a=L.getUserLinkElement().href,s=(v=(y=(g=a==null?void 0:a.split("/"))==null?void 0:g.pop())==null?void 0:y.match(/([0-9]+)/))==null?void 0:v[0],l=V.loading({mask:{enable:!0},parent:i,content:{text:n.t("获取信息中，请稍后...")},addIndexCSS:!1}),c=await x.getUserInfo(s);if(l.close(),!c)return;d.info(c);let p=t==="script-list"?c.scriptList:c.scriptLibraryList;f.success(n.t("获取成功，共 {{count}} 个",{count:p.length}));for(const b of p){let k=u.createElement("li",{className:"w-script-list-item",innerHTML:`
				<div class="w-script-info">
				<div class="w-script-name">
					<a href="${b.url}" target="_blank">${b.name}</a>
				</div>
				<div class="w-script-fan-score">
					<p>${n.t("评分：")}${b.fan_score}</p>
				</div>
				<div class="w-script-locale">
					<p>${n.t("语言：")}${b.locale}</p>
				</div>
				<div class="w-script-version">
					<p>${n.t("版本：")}${b.version}</p>
				</div>
				<div class="w-script-update-time">
					<p>${n.t("更新：")}${m.getDaysDifference(new Date(b.code_updated_at).getTime(),void 0,"auto")}前</p>
				</div>
				</div>
            `}),M=k.querySelector(".w-script-info"),A=u.createElement("div",{className:"pops-panel-button",innerHTML:`
				<button type="primary" data-icon="" data-righticon="false">
				<span>${n.t("同步代码")}</span>
				</button>
				`});b.deleted&&(k.classList.add("w-script-deleted"),A.querySelector("button").setAttribute("disabled","true")),u.on(A,"click",void 0,async function(){d.success(["同步",b]);let C=A.querySelector("button"),U=A.querySelector("button span"),q=u.createElement("i",{className:"pops-bottom-icon",innerHTML:V.config.iconSVG.loading},{"is-loading":!0});C.setAttribute("disabled","true"),C.setAttribute("data-icon","true"),U.innerText=n.t("同步中..."),u.before(U,q);let T=b==null?void 0:b.id,E=await x.getSourceCodeSyncFormData(T.toString());if(E){const z="script[script_sync_type_id]";if(E.has(z)){let R=E.get(z),O="";R.toString()==="1"?O=n.t("手动"):R.toString()==="2"?O=n.t("自动"):R.toString()==="3"&&(O="webhook");let J=k.querySelector(".w-script-sync-type");J?J.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:O}):u.append(M,`
								<div class="w-script-sync-type">
									<p>${n.t("同步方式：{{syncMode}}",{syncMode:O})}
									</p>
								</div>`),await x.sourceCodeSync(b.id.toString(),E)?f.success(n.t("同步成功")):f.error(n.t("同步失败"));}else f.error(n.t("该脚本未设置同步信息"));}C.removeAttribute("disabled"),C.removeAttribute("data-icon"),U.innerText=n.t("同步代码"),q.remove();}),k.appendChild(A),i.appendChild(k);}}},Ft={id:"greasy-fork-panel-config-script-list",title:n.t("脚本列表"),callback(t,e,r){vt.UIScriptList("script-list",t,e,r);},forms:[]},Ht={id:"greasy-fork-panel-config-library",title:n.t("库"),callback(t,e,r){vt.UIScriptList("script-library",t,e,r);},forms:[]},jt=`.w-script-list-item {\r
	padding: 10px 0;\r
...
`,Wt={id:"greasy-fork-panel-config-account",title:n.t("用户"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("迁移【控制台】到顶部导航栏"),"users-changeConsoleToTopNavigator",!0,void 0,n.t("将【控制台】按钮移动到顶部导航栏，节省空间"))]}]},{text:n.t("美化"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[w(n.t("美化私聊页面"),"conversations-beautifyDialogBox",!0,void 0,n.t("美化为左右对话模式"))]}]}]}]},B={data:null,oneSuccessExecMenu:null,onceExec:null,listenData:null},h={$data:{get data(){return B.data==null&&(B.data=new m.Dictionary),B.data},get oneSuccessExecMenu(){return B.oneSuccessExecMenu==null&&(B.oneSuccessExecMenu=new m.Dictionary),B.oneSuccessExecMenu},get onceExec(){return B.onceExec==null&&(B.onceExec=new m.Dictionary),B.onceExec},get scriptName(){return dt},key:P,attributeKeyName:X,attributeDefaultValueName:tt},$listener:{get listenData(){return B.listenData==null&&(B.listenData=new m.Dictionary),B.listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},initExtensionsMenu(){_.top===_.self&&gt.add([{key:"show_pops_panel_setting",text:n.t("⚙ 设置"),autoReload:!1,isStoreValue:!1,showText(t){return t},callback:()=>{this.showPanel();}}]);},initPanelDefaultValue(){let t=this;function e(o){if(!o.attributes)return;let a=o.attributes[X],s=o.attributes[tt],l=o.attributes[ht];if(typeof l=="function"){let c=l();if(typeof c=="boolean"&&!c)return}if(a==null){d.warn(["请先配置键",o]);return}t.$data.data.has(a)&&d.warn("请检查该key(已存在): "+a),t.$data.data.set(a,s);}function r(o){for(let a=0;a<o.length;a++){let s=o[a];e(s);let l=s.forms;l&&Array.isArray(l)&&r(l);}}let i=this.getPanelContentConfig();for(let o=0;o<i.length;o++){let a=i[o];if(!a.forms)continue;let s=a.forms;s&&Array.isArray(s)&&r(s);}},setValue(t,e){let r=D(P,{}),i=r[t];r[t]=e,j(P,r),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,i,e);},getValue(t,e){let i=D(P,{})[t];return i??(this.$data.data.has(t)?this.$data.data.get(t):e)},deleteValue(t){let e=D(P,{}),r=e[t];Reflect.deleteProperty(e,t),j(P,e),this.$listener.listenData.has(t)&&this.$listener.listenData.get(t).callback(t,r,void 0);},addValueChangeListener(t,e,r){let i=Math.random();return this.$listener.listenData.set(t,{id:i,key:t,callback:e}),r&&r.immediate&&e(t,this.getValue(t),this.getValue(t)),i},removeValueChangeListener(t){let e=null;for(const[r,i]of this.$listener.listenData.entries())if(i.id===t){e=r;break}typeof e=="string"?this.$listener.listenData.delete(e):console.warn("没有找到对应的监听器");},hasKey(t){let e=D(P,{});return t in e},execMenu(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){d.warn(`${t} 键不存在`);return}let r=h.getValue(t);r&&e(r);},execMenuOnce(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(t)){d.warn(`${t} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(t))return;this.$data.oneSuccessExecMenu.set(t,1);let r=[],i=s=>{let l=h.getValue(t);o(l,s);},o=(s,l)=>{let c=[];if(s){let p=l??e(s,i);p instanceof HTMLStyleElement?c=[p]:Array.isArray(p)&&(c=[...p.filter(g=>g!=null&&g instanceof HTMLStyleElement)]);}for(let p=0;p<r.length;p++)r[p].remove(),r.splice(p,1),p--;r=[...c];};this.addValueChangeListener(t,(s,l,c)=>{o(c);});let a=h.getValue(t);a&&o(a);},onceExec(t,e){if(typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(t)||(e(),this.$data.onceExec.set(t,1));},showPanel(){V.panel({title:{text:n.t("{{SCRIPT_NAME}}-设置",{SCRIPT_NAME:dt}),position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0,style:`
			${jt}
			`});},isMobile(){return window.outerWidth<550},getWidth(){return window.outerWidth<550?"92vw":"550px"},getHeight(){return window.outerHeight>450?"80vh":"450px"},getPanelContentConfig(){return [Bt,Dt,Gt,Wt,Ft,Ht]}},Kt=`code {\r
...
`,re={init(){h.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),h.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),h.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),h.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){d.info("美化页面元素");let t=[];return t.push(S(Kt)),t.push(S(Jt)),t.push(S(Zt)),t.push(S(Yt)),t.push(S(Qt)),t.push(S(`
			p:has(input[type="submit"][name="update-and-sync"]){
			  margin-top: 10px;
			}
			`)),u.ready(function(){let e=document.querySelector('a[target="markup_choice"][href*="daringfireball.net"]');e&&e.parentElement.replaceChild(u.createElement("span",{textContent:"Markdown"}),e),globalThis.location.pathname.endsWith("/admin")&&!document.querySelector('input[type="submit"][name="update-only"]')&&t.push(S(`
					.indented{
						padding-left: unset;
					}
					`));}),t},beautifyGreasyforkBeautify(){d.info("美化 Greasyfork Beautify脚本");let t=[];return t.push(S(te)),m.isPhone()?t.push(S(`
				section#script-info,
				...
				section#script-info{
					margin-top: 10px;
				}`)),t},beautifyUploadImage(){d.info("美化上传图片");let t=[];return t.push(S(Xt)),u.ready(()=>{function e(o){for(;o.nextElementSibling;)o.parentElement.removeChild(o.nextElementSibling);}let r=document.querySelectorAll('input[type="file"]');r.forEach(o=>{o.getAttribute("name")!=="code_upload"&&(o.hasAttribute("accept")&&o.getAttribute("accept").includes("javascript")||u.on(o,["propertychange","input"],function(a){e(a.target);let s=a.currentTarget.files;if(!s||s.length===0)return;d.info(["选择的图片",s]),s.length>5&&u.after(o,u.createElement("p",{textContent:n.t("❌ 最多同时长传5张图片")}));let l=[];Array.from(s).forEach(c=>{(c.size>204800||!c.type.match(/png|jpg|jpeg|gif|apng|webp/i))&&l.push(c);}),l.length!==0&&l.forEach(c=>{u.after(o,u.createElement("p",{textContent:n.t("❌ 图片：{{name}} 大小：{{size}}",{name:c.name,size:c.size})}));});}));}),["textarea#comment_text","textarea.comment-entry"].forEach(o=>{u.on(o,"paste",a=>{d.info(["触发粘贴事件",a]),setTimeout(()=>{u.trigger(r,"input");},100);});});}),t},beautifyTopNavigationBar(){d.info("美化顶部导航栏");let t=[];return t.push(S(ee)),window.outerWidth>550&&(t.push(et.addBlockCSS(".with-submenu")),u.ready(()=>{let r=document.querySelector("#site-nav").querySelector("nav");document.querySelectorAll(".with-submenu nav li").forEach(i=>{r.appendChild(i);});})),t}},ne={init(){h.execMenu("autoLogin",()=>{this.autoLogin();});},autoLogin(){m.waitNode("span.sign-in-link a[rel=nofollow]").then(async()=>{let t=h.getValue("user"),e=h.getValue("pwd");if(m.isNull(t)){f.error(n.t("请先在菜单中录入账号"));return}if(m.isNull(e)){f.error(n.t("请先在菜单中录入密码"));return}let r=document.querySelector("meta[name='csrf-token']");if(!r){f.error(n.t("获取csrf-token失败"));return}let i=f.loading(n.t("正在登录中...")),o=await N.post("https://greasyfork.org/zh-CN/users/sign_in",{fetch:!0,data:encodeURI(`authenticity_token=${r.getAttribute("content")}&user[email]=${t}&user[password]=${e}&user[remember_me]=1&commit=登录`),headers:{"Content-Type":"application/x-www-form-urlencoded"}});if(i.destroy(),!o.status){d.error(o),f.error(n.t("登录失败，请在控制台查看原因"));return}let a=o.data.responseText;u.parseHTML(a,!0,!0).querySelectorAll(".sign-out-link a[rel=nofollow][data-method='delete']").length?(f.success(n.t("登录成功，1s后自动跳转")),setTimeout(()=>{window.location.reload();},1e3)):(d.error(o),d.error(`当前账号:${t}`),d.error(`当前密码:${e}`),f.error(n.t("登录失败，可能是账号/密码错误，请在控制台查看原因")));});}},ie={init(){this.readBgColor(),u.ready(()=>{h.execMenuOnce("greasyfork-discussions-filter-enable",()=>{this.filterEnable();}),h.execMenuOnce("discussions-addShortcutOperationButton",()=>{this.addShortcutOperationButton();});});},filterEnable(){d.info("启用Greasyfork论坛过滤器"),F.init();},readBgColor(){d.info("设置已读背景颜色");let t=h.getValue("discussions-readBgColor");S(`
        .discussion-read{
            background: ${t} !important;
        }
        `);},addShortcutOperationButton(){d.info("添加快捷操作按钮"),F.getElementList().forEach(t=>{if(t.querySelector(".discussion-filter-button"))return;let r=t.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=u.createElement("div",{className:"discussion-meta-item",innerHTML:`
					<button class="discussion-filter-button">${n.t("过滤")}</button>
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),u.on(o,"click",a=>{var y,v,b;m.preventEvent(a);const s=F.parseDiscuessionListContainerInfo(t);let l="data-filter-key",c="data-filter-value",p=V.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
						...
						`}),g=p.$shadowRoot.querySelector(".pops-alert-content");if(s.scriptId==null&&((y=g.querySelector(`button[${l}="scriptId"]`))==null||y.remove()),s.scriptName==null&&((v=g.querySelector(`button[${l}="scriptName"]`))==null||v.remove()),s.postUserId==null&&((b=g.querySelector(`button[${l}="postUserId"]`))==null||b.remove()),s.replyUserId!=null){let k=u.createElement("button",{innerHTML:n.t("作者id：{{text}}",{text:s.replyUserId})});k.setAttribute(l,"scriptAuthorId"),k.setAttribute(c,"^"+s.replyUserId+"$"),g.appendChild(k);}u.on(p.$shadowRoot,"click",`button[${l}]`,k=>{m.preventEvent(k);let M=k.target,A=M.getAttribute(l),C=M.getAttribute(c);F.addValue(A,C),p.close(),F.filter(),f.success(n.t("添加成功"));});});});}},oe={init(){h.execMenuOnce("users-changeConsoleToTopNavigator",()=>{this.changeConsoleToTopNavigator();}),h.execMenuOnce("gf-scripts-filter-enable",()=>{H.init();}),h.execMenuOnce("beautifyCenterContent",()=>wt.beautifyCenterContent());},changeConsoleToTopNavigator(){d.info("迁移【控制台】到顶部导航栏"),et.addBlockCSS("#about-user"),u.ready(()=>{let t=document.querySelector("#about-user"),e=document.querySelector("#site-nav nav");if(!t){d.error("#about-user元素不存在");return}if(!e){d.error("#site-nav nav元素不存在");return}t=t.cloneNode(!0);let r=u.createElement("li",{className:"scripts-console",innerHTML:`<a href="javascript:;">${n.t("控制台")}</a>`});u.on(r,"click",i=>{m.preventEvent(i),V.drawer({title:{enable:!1},content:{text:"",html:!0},size:"auto",direction:"top",zIndex:m.getMaxZIndex(100),style:`
                    .text-content{
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	margin-left: 0px;\r
	margin-right: 15px;\r
}`,se={init(){h.execMenuOnce("conversations-beautifyDialogBox",()=>this.beautifyDialogBox());},beautifyDialogBox(){d.info("美化对话框"),[].push(it(ae));}},K={init(){h.execMenu("checkPage",()=>{this.checkPage();}),re.init(),yt.init(),I.isScript()&&Ot.init(),(I.isScriptList()||I.isScriptLibraryList()||I.isScriptCodeSearch())&&wt.init(),I.isDiscuessions()&&ie.init(),I.isUsers()&&(oe.init(),I.isConversations()&&se.init()),h.execMenuOnce("scripts-addOperationPanelBtnWithNavigator",()=>{this.addOperationPanelBtnWithNavigator();}),u.ready(()=>{L.initEnv(),ne.init(),L.handleLocalGotoCallBack(),h.execMenuOnce("fixImageWidth",()=>{K.fixImageWidth();}),K.languageSelectorLocale(),h.execMenuOnce("optimizeImageBrowsing",()=>{K.optimizeImageBrowsing();}),h.execMenuOnce("overlayBedImageClickEvent",()=>{K.overlayBedImageClickEvent();}),I.isCodeStrict()||h.execMenuOnce("addMarkdownCopyButton",()=>{K.addMarkdownCopyButton();});});},fixImageWidth(){window.innerWidth<window.innerHeight&&(d.info("修复图片显示问题"),S(`
            img.lum-img{
                width: 100% !important;
                height: 100% !important;
            }
          `));},optimizeImageBrowsing(){d.info("优化图片浏览"),S(lt("ViewerCSS")),S(`
        ...
        `);function t(r=[],i=0){let o="";r.forEach(l=>{o+=`<li><img data-src="${l}" loading="lazy"></li>`;});let a=u.createElement("ul",{innerHTML:o}),s=new Lt(a,{inline:!1,url:"data-src",zIndex:m.getMaxZIndex()+100,hidden:()=>{s.destroy();}});i=i<0?0:i,s.view(i),s.zoomTo(1),s.show();}function e(r){return r.getAttribute("data-src")||r.getAttribute("src")||r.getAttribute("alt")}u.on(document,"click","img",function(r){var p;let i=r.target;if(((p=i.parentElement)==null?void 0:p.localName)==="a"&&i.hasAttribute("data-screenshots")||i.closest(".viewer-container")||i.closest(".lum-lightbox-position-helper"))return;let o=i.closest(".user-content"),a=[],s=0,l=[],c=e(i);c!=null&&c.startsWith("https://img.shields.io")||(o?(o.querySelectorAll("img").forEach(g=>{l.push(g);let y=e(g),v=g.parentElement;(v==null?void 0:v.localName)==="a"&&(y=v.getAttribute("data-href")||v.href),a.push(y);}),s=l.indexOf(i),s===-1&&(s=0)):(a.push(c),s=0),d.success(["点击浏览图片👉",a,s]),t(a,s));}),document.querySelectorAll(".user-screenshots").forEach(r=>{let i=r.querySelector("a");if(!i)return;let o=i.getAttribute("data-href")||i.getAttribute("href"),a=r.querySelector("img");a&&(a.setAttribute("data-screenshots","true"),a.setAttribute("data-src",o),i.setAttribute("href","javascript:;"),u.after(i,a),i.remove());});},overlayBedImageClickEvent(){d.info("覆盖图床图片的parentElement的a标签"),document.querySelectorAll(".user-content a>img").forEach(t=>{let e=t.parentElement,r=e.getAttribute("href");e.setAttribute("data-href",r),e.removeAttribute("href"),u.on(e,"click",()=>{f.warning(`<div style="overflow-wrap: anywhere;">${n.t("拦截跳转：")}<a href="${r}" target="_blank">${r}</a></div>`,{html:!0,zIndex:m.getMaxZIndex()+105});});});},addMarkdownCopyButton(){d.info("在Markdown右上角添加复制按钮"),S(`
        pre{
          position: relative;
        ...
        `);function t(){let e=u.createElement("div",{className:"zeroclipboard-container",innerHTML:`
            ...
            `}),r=e.querySelector(".js-clipboard-copy"),i=e.querySelector(".octicon-copy"),o=e.querySelector(".octicon-check-copy");return u.on(e,"click",function(){let a=e.parentElement.querySelector("code");if(!a&&e.parentElement.className.includes("prettyprinted")&&(a=e.parentElement),!a){f.error(n.t("未找到{{selector}}元素",{selector:"code"}));return}m.setClip(a.innerText||a.textContent),r.setAttribute("success","true"),i.setAttribute("aria-hidden","true"),o.removeAttribute("aria-hidden");let s=V.tooltip({target:r,content:n.t("✅ 复制成功!"),position:"left",className:"github-tooltip",alwaysShow:!0});setTimeout(()=>{r.removeAttribute("success"),o.setAttribute("aria-hidden","true"),i.removeAttribute("aria-hidden"),s.close();},2e3);}),e}document.querySelectorAll("pre").forEach(e=>{if(e.querySelector("div.zeroclipboard-container"))return;let i=t(),o=u.createElement("div",{className:"snippet-clipboard-content"});u.before(e,o),o.appendChild(e),o.appendChild(i);});},languageSelectorLocale(){let t=h.getValue("language-selector-locale"),e=window.location.pathname.split("/").filter(r=>!!r)[0];if(d.success("选择语言："+t),d.success("当前语言："+e),!m.isNull(t)&&t!==e){let r=null,i=x.getSwitchLanguageUrl(t);x.switchLanguage(i),d.success("新Url："+i),f.loading(n.t("当前语言：{{currentLocaleLanguage}}，，3秒后切换至：{{localeLanguage}}",{currentLocaleLanguage:e,localeLanguage:t}),{timeout:3e3,showClose:!0,onClose(){clearTimeout(r);}}),f.info(n.t("导航至：")+i,{timeout:3e3}),r=setTimeout(()=>{window.location.href=i;},3e3);}},checkPage(){d.info("检测gf页面是否正确加载，有时候会出现"),u.ready(()=>{if(document.body.firstElementChild&&document.body.firstElementChild.localName==="p"&&document.body.firstElementChild.innerText.includes("We're down for maintenance. Check back again soon.")){let t=parseInt(D("greasyfork-check-page-time",0)),e=h.getValue("greasyfork-check-page-timeout",5),r=e*1e3;if(t&&Date.now()-t<r){f.warning(n.t("上次重载时间 {{time}}，{{timeout}}秒内拒绝反复重载",{time:m.formatTime(t,"yyyy-MM-dd HH:mm:ss"),timeout:e}));return}j("greasyfork-check-page-time",Date.now()),window.location.reload();}});},addOperationPanelBtnWithNavigator(){d.info("添加【操作面板】按钮"),et.addBlockCSS(".sidebarred .sidebar",".sidebarred-main-content .open-sidebar"),S(`
		.sidebarred .sidebarred-main-content{
			max-width: 100%;
		}	
		`),u.ready(()=>{let t=document.querySelector("#site-nav nav"),e=document.querySelector("#site-nav .with-submenu nav"),r=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!r){d.warn("不存在右侧面板元素#script-list-option-groups");return}if(r=r.cloneNode(!0),r.classList.add("option-panel-groups"),!t){d.error("元素#site-nav nav不存在");return}let i=u.createElement("li",{className:"filter-scripts",innerHTML:`
                <a href="javascript:;">${n.t("操作面板")}</a>
                `});u.on(i,"click",o=>{m.preventEvent(o),V.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:m.getMaxZIndex(100),style:`
                    ...
                    `}).$shadowRoot.querySelector(".pops-drawer-content").appendChild(r);}),e&&e.children.length?e.appendChild(i):t.appendChild(i);});}};h.init();K.init();

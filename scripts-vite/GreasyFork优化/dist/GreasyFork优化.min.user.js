...
`),m.isNull(e))return;e=e.toString().trim();let i=e+"##"+t;r+=i,this.setValue(r);},getValue(){return f.getValue(this.key,"")}},He={id:"greasy-fork-panel-config-discussions",title:n.t("论坛"),forms:[{text:"",type:"forms",forms:[{text:n.t("功能"),type:"deepMenu",forms:[{text:"",type:"forms",forms:[{type:"own",attributes:{"data-key":"discussions-readBgColor","data-default-value":"#e5e5e5"},getLiElementCallBack(e){let t="discussions-readBgColor",r=h.createElement("div",{className:"pops-panel-item-left-text",innerHTML:`
            ...
            `}),M=S.querySelector(".w-script-info"),I=h.createElement("div",{className:"pops-panel-button",innerHTML:`
				...
				`});x.deleted&&(S.classList.add("w-script-deleted"),I.querySelector("button").setAttribute("disabled","true")),h.on(I,"click",void 0,async function(){p.success(["同步",x]);let k=I.querySelector("button"),A=I.querySelector("button span"),D=h.createElement("i",{className:"pops-bottom-icon",innerHTML:V.config.iconSVG.loading},{"is-loading":!0});k.setAttribute("disabled","true"),k.setAttribute("data-icon","true"),A.innerText=n.t("同步中..."),h.before(A,D);let T=x==null?void 0:x.id,L=await $.getSourceCodeSyncFormData(T.toString());if(L){const R="script[script_sync_type_id]";if(L.has(R)){let O=L.get(R),P="";O.toString()==="1"?P=n.t("手动"):O.toString()==="2"?P=n.t("自动"):O.toString()==="3"&&(P="webhook");let Z=S.querySelector(".w-script-sync-type");Z?Z.querySelector("p").innerText=n.t("同步方式：{{syncMode}}",{syncMode:P}):h.append(M,`
...
`,it={init(){f.execMenuOnce("beautifyPage",()=>this.beautifyPageElement()),f.execMenuOnce("beautifyGreasyforkBeautify",()=>this.beautifyGreasyforkBeautify()),f.execMenuOnce("beautifyUploadImage",()=>this.beautifyUploadImage()),f.execMenuOnce("beautifyTopNavigationBar",()=>this.beautifyTopNavigationBar());},beautifyPageElement(){p.info("美化页面元素");let e=[];return e.push(v(Ye)),e.push(v(Ze)),e.push(v(Qe)),e.push(v(Xe)),e.push(v(et)),e.push(v(`
        ...
        `);},addShortcutOperationButton(){p.info("添加快捷操作按钮"),H.getElementList().forEach(e=>{if(e.querySelector(".discussion-filter-button"))return;let r=e.querySelector(".discussion-list-item").querySelector(".discussion-meta"),i=h.createElement("div",{className:"discussion-meta-item",innerHTML:`
					...
					`}),o=i.querySelector(".discussion-filter-button");r.appendChild(i),h.on(o,"click",a=>{var y,b,x;m.preventEvent(a);const s=H.parseDiscuessionListContainerInfo(e);let l="data-filter-key",c="data-filter-value",u=V.alert({title:{text:n.t("选择需要过滤的选项"),position:"center",html:!1},content:{text:`
...
.comment:not(:has(.report-link)) .comment-meta-item {\r
	...
	margin-right: 15px;\r
		...
		`),h.ready(()=>{let e=document.querySelector("#site-nav nav"),t=document.querySelector("#site-nav .with-submenu nav"),r=document.querySelector("#script-list-option-groups")||document.querySelector(".list-option-groups");if(!r){p.warn("不存在右侧面板元素#script-list-option-groups");return}if(r=r.cloneNode(!0),r.classList.add("option-panel-groups"),!e){p.error("元素#site-nav nav不存在");return}let i=h.createElement("li",{className:"filter-scripts",innerHTML:`
                ...
                `});h.on(i,"click",o=>{m.preventEvent(o),V.drawer({title:{enable:!1},content:{text:"",html:!0},direction:"top",size:"80%",zIndex:m.getMaxZIndex(100),style:`

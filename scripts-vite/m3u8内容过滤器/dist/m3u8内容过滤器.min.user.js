...
`)}{display: none !important;}`)},setGMResourceCSS(t){const e=typeof ye=="function"?ye(t.keyName):null;return typeof e=="string"&&e?be(e):j.loadStyleLink(t.url)},async loadStyleLink(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,new Promise(n=>{q.onReady(()=>{document.head.appendChild(e),n(e);});})},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
      ...
      `,...this.$data.panelConfig});this.$data.$panel=i,this.$data.panelContent=t,a||this.registerConfigSearch({$panel:i,content:t});},registerConfigSearch(t){const{$panel:e,content:n}=t,a=async(u,h)=>{if(u==null)return;const g=await h(u);return g&&typeof g.isFind=="boolean"&&g.isFind?g.data:await a(g.data,h)},o=(u,h)=>{const g=new IntersectionObserver(V=>{V.forEach(S=>{S.isIntersecting&&(h?.(),g.disconnect());});},{root:null,threshold:1});g.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},i=u=>{const h="pops-flashing";f.onAnimationend(u,()=>{u.classList.remove(h);}),u.classList.add(h);},s=u=>{if(u.type==="dblclick"&&d)return;f.preventEvent(u);const h=D.alert({title:{text:"搜索配置",position:"center"},content:{text:`
    		...
    		`}));},transformKey(t){if(Array.isArray(t)){const e=t.sort();return JSON.stringify(e)}else return t},getDynamicValue(t,e){const n=this;let a=false,o=e;const i=this.addValueChangeListener(t,(s,l)=>{o=l;});return {get value(){return a||(a=true,o=n.getValue(t,e)),o},destory(){n.removeValueChangeListener(i);}}}},X={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},v=le.noConflict(),f=q.noConflict(),D=fe,C=new v.Log(J,M.console||De.console),de=J?.script?.name||void 0,Fe=fe.fn.Utils.AnyTouch(),Pe=false;C.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});const Ve=()=>{let e=100;const n=fe.fn.InstanceUtils.getPopsMaxZIndex()?.zIndex??100,a=le.getMaxZIndexNodeInfoFromPoint()[0]?.zIndex??100;return e=Math.max(e,n,a),e};y.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(t){const e=t.setting.type;if(e==="loading")return  false;const n=t.setting.content;return e==="warning"?C.warn(n):e==="error"?C.error(n):C.info(n),false},get position(){return F.getValue(X.qmsg_config_position.key,X.qmsg_config_position.defaultValue)},get maxNums(){return F.getValue(X.qmsg_config_maxnums.key,X.qmsg_config_maxnums.defaultValue)},get showReverse(){return F.getValue(X.qmsg_config_showreverse.key,X.qmsg_config_showreverse.defaultValue)},get zIndex(){return Ve()}});D.GlobalConfig.setGlobalConfig({zIndex:()=>Ve(),mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const oe=new v.GM_Menu({GM_getValue:Q,GM_setValue:ee,GM_registerMenuCommand:Re,GM_unregisterMenuCommand:Ee}),re=new v.Httpx({xmlHttpRequest:Ie,logDetails:Pe});re.interceptors.request.use(t=>t);re.interceptors.response.use(void 0,t=>(C.error("拦截器-请求错误",t),t.type==="onabort"?y.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?y.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?y.error("请求超时",{consoleLogContent:true}):y.error("其它错误",{consoleLogContent:true}),t));M.Object.defineProperty,M.Object.keys,M.Object.values,M.Function.prototype.apply,M.Function.prototype.call,M.Element.prototype.appendChild,M.setTimeout.bind(M),M.clearTimeout.bind(M),M.setInterval.bind(M),M.clearInterval.bind(M);const be=f.addStyle.bind(f);q.selector.bind(q);q.selectorAll.bind(q);new v.GM_Cookie;const ie={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new v.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let t=false,e;const n=(i,s)=>{typeof s!="string"&&(s=j.toStr(s));const l=new Blob([s]),r=globalThis.URL.createObjectURL(l);f.createElement("a",{href:r,download:i}).click(),v.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(r);},500);},a=()=>{const i=d=>{const u=D.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof te=="function")te().forEach(u=>{const h=Q(u);Reflect.set(c,u,h);});else {y.warning("不支持函数GM_listValues，仅导出菜单配置");const d=Q(ae);Reflect.set(c,ae,d);}const p=j.toStr(c);r.value=p;},o=()=>{let i=J?.script?.supportURL||J?.script?.namespace;typeof i=="string"&&v.isNotNull(i)&&window.open(i,"_blank");};return [{id:"script-version",title:`版本：${J?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(i){new Fe(i.$asideLiElement).on("tap",function(l){clearTimeout(e),e=void 0,t?(t=false,a()):(e=setTimeout(()=>{t=false,o();},200),t=true);});}}]},setDefaultBottomContentConfig(t){this.$data.__defaultBottomContentConfig=t;}},Oe={get ajaxHooker(){return this.__ajaxHooker==null&&(this.__ajaxHooker=v.ajaxHooker()),this.__ajaxHooker},hook(){this.ajaxHooker.hook(t=>{let e=j.fixUrl(t.url);try{if(!new URL(e).pathname.endsWith(".m3u8"))return;t.response=o=>{let i=o.responseText;if(i.trim()===""||!i.includes("#EXT-X-ENDLIST"))return;let s=he.runRule(i);o.responseText=s;};}catch(n){C.error("m3u8过滤器 hook network出错",n);}});},unhook(){this.ajaxHooker.unhook();}},ve=function(t,e,n,a,o,i,s){const l={text:t,type:"select",description:i,attributes:{},props:{},getValue(){return this.props[L].get(e,n)},callback(r){if(r==null)return;const c=r.value;if(C.info(`选择：${r.text}`),typeof o=="function"&&o(r))return;this.props[L].set(e,c);},data:a};return Reflect.set(l.attributes,W,e),Reflect.set(l.attributes,H,n),se.initComponentsStorageApi("select",l,{get(r,c){return F.getValue(r,c)},set(r,c){F.setValue(r,c);}}),l},Y=function(t,e,n,a,o,i,s,l,r){const c={text:t,type:"switch",description:o,disabled:s,attributes:{},props:{},getValue(){return this.props[L].get(e,n)},callback(p,d){const u=!!d;C.success(`${u?"开启":"关闭"} ${t}`),this.props[L].set(e,u);},afterAddToUListCallBack:(...p)=>{}};return Reflect.set(c.attributes,W,e),Reflect.set(c.attributes,H,n),se.initComponentsStorageApi("switch",c,{get(p,d){return F.getValue(p,d)},set(p,d){F.setValue(p,d);}}),c},Ue=function(t,e,n,a,o,i="",s,l){const r={text:t,type:"textarea",attributes:{},props:{},description:a,placeholder:i,disabled:s,getValue(){const p=this.props[L].get(e,n);return Array.isArray(p)?p.join(`
`):p},callback(c,p){this.props[L].set(e,p);}};return Reflect.set(r.attributes,W,e),Reflect.set(r.attributes,H,n),se.initComponentsStorageApi("switch",r,{get(c,p){return F.getValue(c,p)},set(c,p){F.setValue(c,p);}}),r},se={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new le.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,n){let a;this.hasStorageApi(t)?a=this.getStorageApi(t):a=n,this.setComponentsStorageApiProperty(e,a);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,L,e);}},Ce=function(t,e,n,a,o,i="",s="text",l,r){const c={text:t,type:"input",inputType:s,attributes:{},props:{},description:a,placeholder:i,afterAddToUListCallBack:l,getValue(){return this.props[L].get(e,n)},callback(p,d){p.target.validity.valid,this.props[L].set(e,d);}};return Reflect.set(c.attributes,W,e),Reflect.set(c.attributes,H,n),se.initComponentsStorageApi("input",c,{get(p,d){return F.getValue(p,d)},set(p,d){F.setValue(p,d);}}),c};class qe{option;constructor(e){this.option=e;}async showView(){const e=D.confirm({title:{text:this.option.title,position:"center"},content:{text:`
...
`),a=[],o=0;for(let l=0;l<n.length;l++){const r=n[l].trim();if(!r.startsWith("#EXTINF:"))continue;let{duration:c,startDuration:p,endDuration:d,filePath:u}=pe.parse_EXTINF(r,n[l+1],o);if(e&&typeof e.handlerFilePath=="function"){let h=e.handlerFilePath(u);typeof h=="string"&&(u=h);}o+=c,a.push({filePath:u,startDuration:p,endDuration:d,duration:c,index:l}),l++;}let i=[],s=0;for(let l=0;l<a.length;l++){const r=a[l];let c=true,p=0,d=a;for(let u=0;u<d.length;u++){const h=d[u];if(ue.similar(r.filePath,h.filePath)>=e.similarCompareValue&&p++,p/d.length>e.includePercent){c=false;break}}c&&(i.push(r),C.info(`通杀2：过滤广告片段 ==> 索引：${r.index} 文件名：${r.filePath} 开始：${ue.duration2Text(r.startDuration)} 持续时长：${r.duration}s`),n.splice(r.index-s,2),s+=2);}return i.forEach(l=>{_e(l);}),{m3u8Text:n.join(`
`),filterInfo:i}}},he={$key:{STORAGE_KEY:"m3u8-rule"},$data:{matchedRule:[]},init(){let t=this.getData();this.registerMenu(t);for(let e=0;e<t.length;e++)try{const n=t[e];n.enable&&window.location.href.match(new RegExp(n.data.url))&&this.$data.matchedRule.push(n);}catch(n){C.error("m3u8过滤器 ==> 规则初始化出错",n);}this.$data.matchedRule.length&&(C.info("m3u8过滤器 ==> 当前网站执行的规则：",this.$data.matchedRule),Oe.hook(),ke.updateISMatchedRuleMenu());},registerMenu(t){oe.update([{key:"m3u8-rule",text:`⚙ 自定义规则（${t.length}条）`,autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.showView();}},{key:"m3u8-export-rule",text:"⚙ 规则导出",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.exportRule("m3u8-filter-rule.json");}},{key:"m3u8-import-rule",text:"⚙ 规则导入",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.importRule();}}]);},getTemplateData(){return {uuid:v.generateUUID(),enable:true,name:"",data:{url:"",commonFilterAdsSegmentsFilePathLength:true,commonFilterAdsSegmentsFilePathSimilar:false,ownFilterCode:""}}},showView(){let t=D.fn.PanelHandlerComponents();function e(a){return {get(o,i){return a[o]??i},set(o,i){a[o]=i;}}}new Ge({title:"m3u8自定义规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:a=>a.name,updateData:a=>this.updateData(a),deleteData:a=>this.deleteData(a),getData:a=>this.getData().find(s=>s.uuid===a.uuid)??a,itemControls:{enable:{enable:true,getEnable(a){return a.enable},callback:(a,o)=>{a.enable=o,this.updateData(a);}},edit:{enable:true,getView:(a,o)=>{let i=document.createDocumentFragment();o||(a=this.getTemplateData());let s=Y("启用","enable",true);Reflect.set(s.props,L,e(a));let l=t.createSectionContainerItem_switch(s).$el,r=Ce("规则名称","name","","",void 0,"必填");Reflect.set(r.props,L,e(a));let c=t.createSectionContainerItem_input(r).$el,p=Ce("匹配网址","url","","",void 0,"必填，可正则，注意转义");Reflect.set(p.props,L,e(a.data));let d=t.createSectionContainerItem_input(p).$el,u=Y("广告通杀1","commonFilterAdsSegmentsFilePathLength",true,void 0,"使用文件名称长度比较");Reflect.set(u.props,L,e(a.data));let h=t.createSectionContainerItem_switch(u).$el,g=Y("广告通杀2","commonFilterAdsSegmentsFilePathSimilar",false,void 0,"使用文件名称相似度比较");Reflect.set(g.props,L,e(a.data));let V=t.createSectionContainerItem_switch(g).$el,S=Ue("自定义过滤js","ownFilterCode","","",void 0,`参数：

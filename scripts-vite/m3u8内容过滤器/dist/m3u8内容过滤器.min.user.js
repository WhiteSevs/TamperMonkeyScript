...
(function (y, q, pe, fe) {
    ...
    var ne=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,ye=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,Q=typeof GM_getValue<"u"?GM_getValue:void 0,Z=typeof GM_info<"u"?GM_info:void 0,te=typeof GM_listValues<"u"?GM_listValues:void 0,Re=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,ee=typeof GM_setValue<"u"?GM_setValue:void 0,we=typeof GM_setValues<"u"?GM_setValues:void 0,Ee=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Ie=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,M=typeof unsafeWindow<"u"?unsafeWindow:void 0,De=window;const j={waitRemove(...t){t.forEach(e=>{typeof e=="string"&&q.waitNodeList(e).then(n=>{n.forEach(a=>a.remove());});});},createBlockCSSNode(...t){let e=[];if(t.length!==0&&!(t.length===1&&typeof t[0]=="string"&&t[0].trim()===""))return t.forEach(n=>{Array.isArray(n)?e=e.concat(n):e.push(n);}),q.createElement("style",{type:"text/css",innerHTML:`${e.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(t){const e=typeof ye=="function"?ye(t.keyName):null;return typeof e=="string"&&e?be(e):j.loadStyleLink(t.url)},async loadStyleLink(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,new Promise(n=>{q.onReady(()=>{document.head.appendChild(e),n(e);});})},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
      ...
      `,...this.$data.panelConfig});this.$data.$panel=i,this.$data.panelContent=t,a||this.registerConfigSearch({$panel:i,content:t});},registerConfigSearch(t){const{$panel:e,content:n}=t,a=async(u,h)=>{if(u==null)return;const g=await h(u);return g&&typeof g.isFind=="boolean"&&g.isFind?g.data:await a(g.data,h)},o=(u,h)=>{const g=new IntersectionObserver(V=>{V.forEach(S=>{S.isIntersecting&&(h?.(),g.disconnect());});},{root:null,threshold:1});g.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},i=u=>{const h="pops-flashing";f.onAnimationend(u,()=>{u.classList.remove(h);}),u.classList.add(h);},s=u=>{if(u.type==="dblclick"&&d)return;f.preventEvent(u);const h=D.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${t.searchDialogStyle??""}
				`});h.$shadowRoot.querySelector(".search-wrapper");const g=h.$shadowRoot.querySelector(".search-config-text"),V=h.$shadowRoot.querySelector(".search-result-wrapper");g.focus();const S=()=>{f.empty(V);},$=_=>{const R=b.queryProperty(_,A=>A?.next?{isFind:false,data:A.next}:{isFind:true,data:A}),m=f.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),x=D.fn.PanelHandlerComponents();return f.on(m,"click",()=>{const k=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[_.index];if(!k){y.error(`左侧项下标${_.index}不存在`);return}k.scrollIntoView({behavior:"smooth",block:"center"}),k.click(),a(_.next,async w=>{if(w?.next){const E=await f.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(v=>{const I=Reflect.get(v,x.$data.nodeStoreConfigKey);return typeof I=="object"&&I!=null&&I.text===w.name}),2500);if(E)E.click();else return y.error("未找到对应的二级菜单"),{isFind:true,data:w};return {isFind:false,data:w.next}}else {const E=await f.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(v=>Reflect.get(v,x.$data.nodeStoreConfigKey)===w.matchedData?.formConfig),2500);if(E){o(E);const v=E.closest(".pops-panel-forms-fold[data-fold-enable]");v&&(v.querySelector(".pops-panel-forms-fold-container").click(),await b.sleep(500)),o(E,()=>{i(E);});}else y.error("未找到对应的菜单项");return {isFind:true,data:w}}});}),m},T=_=>{const R=new RegExp(_,"i"),m=[],x=(k,w)=>{for(let E=0;E<k.length;E++){const v=k[E],I=v.views;if(I&&Array.isArray(I)){const O=b.deepClone(w);if(v.type==="deepMenu"){const U=b.queryProperty(O,z=>z?.next?{isFind:false,data:z.next}:{isFind:true,data:z});U.next={name:v.text};}x(I,O);}else {let O,U;if(v.type==="own"){let F=Reflect.get(v.attributes||{},Te);F&&(typeof F=="function"&&(F=F()),typeof F.text=="string"&&(O=F.text),typeof F.desc=="string"&&(U=F.desc));}else O=v.text,U=Reflect.get(v,"description");const z=[O,U],me=z.findIndex(F=>{if(typeof F=="string")return F.match(R)});if(me!==-1){const F=b.deepClone(w),ge=b.queryProperty(F,B=>B?.next?{isFind:false,data:B.next}:{isFind:true,data:B});ge.next={name:O,matchedData:{path:"",formConfig:v,matchedText:z[me],description:U}};const xe=[];b.queryProperty(F,B=>{const se=B?.name;return typeof se=="string"&&se.trim()!==""&&xe.push(se),B?.next?{isFind:false,data:B.next}:{isFind:true,data:B}});const Se=xe.join(j.escapeHtml(" - "));ge.next.matchedData.path=Se,m.push(F);}}}};for(let k=0;k<n.length;k++){const w=n[k];if(!w.views||w.isBottom&&w.id==="script-version")continue;const E=w.views;if(E&&Array.isArray(E)){let v=w.title;typeof v=="function"&&(v=v()),x(E,{index:k,name:v});}}const A=document.createDocumentFragment();for(const k of m){let w=$(k);A.appendChild(w);}S(),V.append(A);};f.on(g,"input",b.debounce(_=>{f.preventEvent(_);let R=f.val(g).trim();if(R===""){S();return}T(R);},200));};e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(u=>{f.on(u,"dblclick",s);});let r=new WeakMap,c=false,p,d=false;f.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(u,h)=>{d=true,clearTimeout(p),p=void 0,c&&r.has(h)?(c=false,r.delete(h),s(u)):(p=setTimeout(()=>{c=false;},200),c=true,r.set(h,u));},{capture:true}),e.$shadowRoot.appendChild(f.createElement("style",{type:"text/css",textContent:`
    			.pops-flashing{
    		...
    		`}));},transformKey(t){if(Array.isArray(t)){const e=t.sort();return JSON.stringify(e)}else return t},getDynamicValue(t,e){const n=this;let a=false,o=e;const i=this.addValueChangeListener(t,(s,l)=>{o=l;});return {get value(){return a||(a=true,o=n.getValue(t,e)),o},destory(){n.removeValueChangeListener(i);}}}},X={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},b=fe.noConflict(),f=q.noConflict(),D=pe,C=new b.Log(Z,M.console||De.console),ue=Z?.script?.name||void 0,Fe=pe.fn.Utils.AnyTouch(),Pe=false;C.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});const Ve=()=>{const e=pe.fn.InstanceUtils.getPopsMaxZIndex()?.zIndex??0,n=b.getMaxZIndexNodeInfoFromPoint()[0]?.zIndex??0;return Math.max(100,e,n)};y.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(t){const e=t.setting.type;if(e==="loading")return  false;const n=t.setting.content;return e==="warning"?C.warn(n):e==="error"?C.error(n):C.info(n),false},get position(){return P.getValue(X.qmsg_config_position.key,X.qmsg_config_position.defaultValue)},get maxNums(){return P.getValue(X.qmsg_config_maxnums.key,X.qmsg_config_maxnums.defaultValue)},get showReverse(){return P.getValue(X.qmsg_config_showreverse.key,X.qmsg_config_showreverse.defaultValue)},get zIndex(){return Ve()}});D.GlobalConfig.setGlobalConfig({zIndex:()=>Ve(),mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const oe=new b.GM_Menu({GM_getValue:Q,GM_setValue:ee,GM_registerMenuCommand:Re,GM_unregisterMenuCommand:Ee}),le=new b.Httpx({xmlHttpRequest:Ie,logDetails:Pe});le.interceptors.request.use(t=>t);le.interceptors.response.use(void 0,t=>(C.error("拦截器-请求错误",t),t.type==="onabort"?y.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?y.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?y.error("请求超时",{consoleLogContent:true}):y.error("其它错误",{consoleLogContent:true}),t));M.Object.defineProperty,M.Object.keys,M.Object.values,M.Function.prototype.apply,M.Function.prototype.call,M.Element.prototype.appendChild,M.setTimeout.bind(M),M.clearTimeout.bind(M),M.setInterval.bind(M),M.clearInterval.bind(M);const be=f.addStyle.bind(f);q.selector.bind(q);q.selectorAll.bind(q);new b.GM_Cookie;const ie={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new b.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let t=false,e;const n=(i,s)=>{typeof s!="string"&&(s=j.toStr(s));const l=new Blob([s]),r=globalThis.URL.createObjectURL(l);f.createElement("a",{href:r,download:i}).click(),b.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(r);},500);},a=()=>{const i=d=>{const u=D.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),h=u.$shadowRoot.querySelector(".btn-control[data-mode='local']"),g=u.$shadowRoot.querySelector(".btn-control[data-mode='network']"),V=u.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),S=async T=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof te=="function"?typeof ne=="function"?(te().forEach(m=>{ne(m);}),y.success("已清空脚本存储的配置")):y.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):y.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof we=="function"?we(T):Object.keys(T).forEach(m=>{const x=T[m];ee(m,x);}),y.success("配置导入完毕");},$=T=>new Promise(async _=>{const R=b.toJSON(T);Object.keys(R).length===0?y.warning("解析为空配置，不导入"):await S(R),_(true);});f.on(h,"click",T=>{f.preventEvent(T),u.close();const _=f.createElement("input",{type:"file",accept:".json"});f.on(_,["propertychange","input"],R=>{if(!_.files?.length)return;const m=_.files[0],x=new FileReader;x.onload=()=>{$(x.result);},x.readAsText(m,"UTF-8");}),_.click();}),f.on(g,"click",T=>{f.preventEvent(T),u.close();const _=D.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(x,A){x.close();}},ok:{text:"导入",callback:async(x,A)=>{const k=x.text;if(b.isNull(k)){y.error("请填入完整的url");return}const w=y.loading("正在获取配置..."),E=await le.get(k,{allowInterceptConfig:false});if(w.close(),!E.status){C.error(E),y.error("获取配置失败",{consoleLogContent:true});return}await $(E.data.responseText)&&x.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:G.info.width,height:"auto"}),R=_.$shadowRoot.querySelector("input"),m=_.$shadowRoot.querySelector(".pops-prompt-btn-ok");f.on(R,["input","propertychange"],x=>{f.val(R)===""?f.attr(m,"disabled","true"):f.removeAttr(m,"disabled");}),f.onKeyboard(R,"keydown",(x,A,k)=>{x==="Enter"&&k.length===0&&f.val(R)!==""&&f.emit(m,"click");}),f.emit(R,"input");}),f.on(V,"click",async T=>{f.preventEvent(T),u.close();let _=await j.getClipboardText();if(_.trim()===""){y.warning("获取到的剪贴板内容为空");return}await $(_);});},s=(d=`${ue}_panel-setting-${b.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,u)=>{const h=D.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof te=="function")te().forEach(u=>{const h=Q(u);Reflect.set(c,u,h);});else {y.warning("不支持函数GM_listValues，仅导出菜单配置");const d=Q(ae);Reflect.set(c,ae,d);}const p=j.toStr(c);r.value=p;},o=()=>{let i=Z?.script?.supportURL||Z?.script?.namespace;typeof i=="string"&&b.isNotNull(i)&&window.open(i,"_blank");};return [{id:"script-version",title:`版本：${Z?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(i){new Fe(i.$asideLiElement).on("tap",function(l){clearTimeout(e),e=void 0,t?(t=false,a()):(e=setTimeout(()=>{t=false,o();},200),t=true);});}}]},setDefaultBottomContentConfig(t){this.$data.__defaultBottomContentConfig=t;}},Oe={get ajaxHooker(){return this.__ajaxHooker==null&&(this.__ajaxHooker=b.ajaxHooker()),this.__ajaxHooker},hook(){this.ajaxHooker.hook(t=>{let e=j.fixUrl(t.url);try{if(!new URL(e).pathname.endsWith(".m3u8"))return;t.response=o=>{let i=o.responseText;if(i.trim()===""||!i.includes("#EXT-X-ENDLIST"))return;let s=he.runRule(i);o.responseText=s;};}catch(n){C.error("m3u8过滤器 hook network出错",n);}});},unhook(){this.ajaxHooker.unhook();}},ve=function(t,e,n,a,o,i,s){const l={text:t,type:"select",description:i,attributes:{},props:{},getValue(){return this.props[L].get(e,n)},callback(r){if(r==null)return;const c=r.value;if(C.info(`选择：${r.text}`),typeof o=="function"&&o(r))return;this.props[L].set(e,c);},data:a};return Reflect.set(l.attributes,W,e),Reflect.set(l.attributes,H,n),re.initComponentsStorageApi("select",l,{get(r,c){return P.getValue(r,c)},set(r,c){P.setValue(r,c);}}),l},Y=function(t,e,n,a,o,i,s,l,r){const c={text:t,type:"switch",description:o,disabled:s,attributes:{},props:{},getValue(){return this.props[L].get(e,n)},callback(p,d){const u=!!d;C.success(`${u?"开启":"关闭"} ${t}`),this.props[L].set(e,u);},afterAddToUListCallBack:(...p)=>{}};return Reflect.set(c.attributes,W,e),Reflect.set(c.attributes,H,n),re.initComponentsStorageApi("switch",c,{get(p,d){return P.getValue(p,d)},set(p,d){P.setValue(p,d);}}),c},Ue=function(t,e,n,a,o,i="",s,l){const r={text:t,type:"textarea",attributes:{},props:{},description:a,placeholder:i,disabled:s,getValue(){const p=this.props[L].get(e,n);return Array.isArray(p)?p.join(`
`):p},callback(c,p){this.props[L].set(e,p);}};return Reflect.set(r.attributes,W,e),Reflect.set(r.attributes,H,n),re.initComponentsStorageApi("switch",r,{get(c,p){return P.getValue(c,p)},set(c,p){P.setValue(c,p);}}),r},re={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new fe.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,n){let a;this.hasStorageApi(t)?a=this.getStorageApi(t):a=n,this.setComponentsStorageApiProperty(e,a);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,L,e);}},Ce=function(t,e,n,a,o,i="",s="text",l,r){const c={text:t,type:"input",inputType:s,attributes:{},props:{},description:a,placeholder:i,afterAddToUListCallBack:l,getValue(){return this.props[L].get(e,n)},callback(p,d){p.target.validity.valid,this.props[L].set(e,d);}};return Reflect.set(c.attributes,W,e),Reflect.set(c.attributes,H,n),re.initComponentsStorageApi("input",c,{get(p,d){return P.getValue(p,d)},set(p,d){P.setValue(p,d);}}),c};class qe{option;constructor(e){this.option=e;}async showView(){const e=D.confirm({title:{text:this.option.title,position:"center"},content:{text:`
        <form class="rule-form-container" onsubmit="return false">
            <ul class="rule-form-ulist"></ul>
            <input type="submit" style="display: none;" />
        </form>
        `,html:true},btn:b.assign({ok:{callback:async()=>{await i();}}},this.option.btn||{},true),drag:true,mask:{enable:true},style:`
      ${D.config.cssText.panelCSS}
...
`);Reflect.set(S.props,L,e(a.data));let $=t.createSectionContainerItem_textarea(S).$el;return i.appendChild(l),i.appendChild(c),i.appendChild(d),i.appendChild(h),i.appendChild(V),i.appendChild($),i},onsubmit:(a,o,i)=>{let s=a.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();return o&&(l.uuid=i.uuid),s.forEach(r=>{let c=Reflect.get(r,t.$data.nodeStoreConfigKey),p=Reflect.get(c,"attributes"),d=Reflect.get(r,L),u=Reflect.get(p,W),h=Reflect.get(p,H),g=d.get(u,h);Reflect.has(l,u)?Reflect.set(l,u,g):Reflect.has(l.data,u)?Reflect.set(l.data,u,g):C.error(`${u}不在数据中`);}),l.name.trim()===""?(y.error("规则名称不能为空"),{success:false,data:l}):l.data.url.trim()===""?(y.error("匹配网址不能为空"),{success:false,data:l}):o?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}},style:`
            ...
            `}),n=e.$shadowRoot.querySelector(".btn-control[data-mode='local']"),a=e.$shadowRoot.querySelector(".btn-control[data-mode='network']"),o=e.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),i=l=>{let r=this.getData(),c=[];for(let p=0;p<l.length;p++){const d=l[p];r.findIndex(h=>h.uuid===d.uuid)!==-1||c.push(d);}r=r.concat(c),this.setData(r),y.success(`共 ${l.length} 条规则，新增 ${c.length} 条`),t?.();},s=l=>new Promise(r=>{let c=b.toJSON(l);if(!Array.isArray(c)){C.error(c),y.error("导入失败，格式不符合（不是数组）",{consoleLogContent:true}),r(false);return}if(!c.length){y.error("导入失败，解析出的数据为空",{consoleLogContent:true}),r(false);return}i(c),r(true);});f.on(n,"click",l=>{f.preventEvent(l),e.close();let r=f.createElement("input",{type:"file",accept:".json"});f.on(r,["propertychange","input"],c=>{if(!r.files?.length)return;let p=r.files[0],d=new FileReader;d.onload=()=>{s(d.result);},d.readAsText(p,"UTF-8");}),r.click();}),f.on(a,"click",l=>{f.preventEvent(l),e.close();let r=D.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(d,u){d.close();}},ok:{text:"导入",callback:async(d,u)=>{let h=d.text;if(b.isNull(h)){y.error("请填入完整的url");return}let g=y.loading("正在获取配置..."),V=await le.get(h,{allowInterceptConfig:false});if(g.close(),!V.status){C.error(V),y.error("获取配置失败",{consoleLogContent:true});return}await s(V.data.responseText)&&d.close();}},cancel:{enable:false}},mask:{enable:true},drag:true,width:G.info.width,height:"auto"}),c=r.$shadowRoot.querySelector("input"),p=r.$shadowRoot.querySelector(".pops-prompt-btn-ok");f.on(c,["input","propertychange"],d=>{f.val(c)===""?f.attr(p,"disabled","true"):f.removeAttr(p,"disabled");}),f.onKeyboard(c,"keydown",(d,u,h)=>{d==="Enter"&&h.length===0&&f.val(c)!==""&&f.emit(p,"click");}),f.emit(c,"input");}),f.on(o,"click",async l=>{f.preventEvent(l),e.close();let r=await b.getClipboardInfo();if(r.error!=null){y.error(r.error.toString());return}if(r.content.trim()===""){y.warning("获取到的剪贴板内容为空");return}await s(r.content);});}},Be={id:"component-common",title:"通用",views:[{text:"Toast配置",type:"container",views:[ve("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],t=>{C.info("设置当前Qmsg弹出位置"+t.text);},"Toast显示在页面九宫格的位置"),ve("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),Y("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]},{text:"Cookie配置",type:"container",views:[Y("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),Y("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie")]}]};ie.addContentConfig([Be]);$e.deleteMenuOption();P.init();he.init();

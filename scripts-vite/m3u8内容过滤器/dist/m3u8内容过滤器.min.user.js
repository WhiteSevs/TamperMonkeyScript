...
`)}{display: none !important;}`)},setGMResourceCSS(t){const e=typeof ye=="function"?ye(t.keyName):null;return typeof e=="string"&&e?be(e):Z.loadStyleLink(t.url)},async loadStyleLink(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,new Promise(n=>{q.onReady(()=>{document.head.appendChild(e),n(e);});})},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...t||[]);return n.forEach(a=>{a.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){n.forEach(a=>{a.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(a){navigator.clipboard.readText().then(o=>{a(o);}).catch(o=>{C.error("读取剪贴板内容失败👉",o),a("");});}function e(a){navigator.permissions.query({name:"clipboard-read"}).then(o=>{t(a);}).catch(o=>{C.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),t(a);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(a=>{if(!n()){a("");return}document.hasFocus()?e(a):window.addEventListener("focus",()=>{e(a);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,n=5e3){let a,o=n-e,r=e,s=async i=>{const l=await t(i);if(typeof l=="boolean"&&l||i){w.workerClearTimeout(a);return}if(r+=e,r>o){s(true);return}a=w.workerSetTimeout(()=>{s(false);},e);};s(false);},findParentNode(t,e,n){if(n){let a=q.closest(t,n);if(a)return a.querySelector(e)}else return q.matches(t,e)?t:q.closest(t,e)},toStr(t){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(t,(a,o)=>o===void 0?e:o,2).replace(new RegExp(`"${e}"`,"g"),"undefined")}},oe="GM_Panel",De="data-init",j="data-key",W="data-default-value",Ae="data-init-more-value",Me="data-plugin-search-config",T="data-storage-api",$e={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(t){return t},callback:()=>{P.showPanel(le.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){P.isTopWindow()&&ie.add(this.$data.menuOption);},addMenuOption(t){Array.isArray(t)||(t=[t]),this.$data.menuOption.push(...t);},updateMenuOption(t){Array.isArray(t)||(t=[t]),t.forEach(e=>{let n=this.$data.menuOption.findIndex(a=>a.key===e.key);n!==-1&&(this.$data.menuOption[n]=e);});},getMenuOption(t=0){return this.$data.menuOption[t]},deleteMenuOption(t=0){this.$data.menuOption.splice(t,1);}};class Te{storageKey;listenerData;constructor(e){if(typeof e=="string"){const n=e.trim();if(n=="")throw new Error("key参数不能为空字符串");this.storageKey=n;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new K.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let e=ee(this.storageKey);return e==null&&(e={},this.setLocalValue(e)),e}setLocalValue(e){te(this.storageKey,e);}set(e,n){const a=this.get(e),o=this.getLocalValue();Reflect.set(o,e,n),this.setLocalValue(o),this.emitValueChangeListener(e,n,a);}get(e,n){const a=this.getLocalValue();return Reflect.get(a,e)??n}getAll(){return this.getLocalValue()}delete(e){const n=this.get(e),a=this.getLocalValue();Reflect.deleteProperty(a,e),this.setLocalValue(a),this.emitValueChangeListener(e,void 0,n);}has(e){const n=this.getLocalValue();return Reflect.has(n,e)}keys(){const e=this.getLocalValue();return Reflect.ownKeys(e)}values(){const e=this.getLocalValue();return Reflect.ownKeys(e).map(n=>Reflect.get(e,n))}clear(){ae(this.storageKey);}addValueChangeListener(e,n){const a=Math.random(),o=this.listenerData.get(e)||[];return o.push({id:a,key:e,callback:n}),this.listenerData.set(e,o),a}removeValueChangeListener(e){let n=false;for(const[a,o]of this.listenerData.entries()){for(let r=0;r<o.length;r++){const s=o[r];(typeof e=="string"&&s.key===e||typeof e=="number"&&s.id===e)&&(o.splice(r,1),r--,n=true);}this.listenerData.set(a,o);}return n}async emitValueChangeListener(...e){const[n,a,o]=e;if(!this.listenerData.has(n))return;const r=this.listenerData.get(n);for(let s=0;s<r.length;s++){const i=r[s];if(typeof i.callback=="function"){let l,c;e.length===1||(e.length===2?l=a:e.length===3&&(l=a,c=o)),await i.callback(n,l,c);}}}}const G=new Te(oe),N={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},U={setting:{get width(){return N.width<550?"88vw":N.width<700?"550px":"700px"},get height(){return N.height<450?"70vh":N.height<550?"450px":"550px"}},settingMiddle:{get width(){return N.width<350?"88vw":"350px"}},info:{get width(){return N.width<350?"88vw":"350px"},get height(){return N.height<250?"88vh":"250px"}}},P={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new w.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new w.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new w.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new w.Dictionary),this.__onceExecData},get scriptName(){return pe},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:oe,attributeKeyName:j,attributeDefaultValueName:W},init(){this.initContentDefaultValue(),$e.init();},isTopWindow(){return F.top===F.self},initContentDefaultValue(){const t=a=>{if(!a.attributes||a.type==="button"||a.type==="container"||a.type==="deepMenu")return;const o=a.attributes;let r=o[De];if(typeof r=="function"){let c=r();if(typeof c=="boolean"&&!c)return}let s=new Map,i=o[j];if(i!=null){const c=o[W];s.set(i,c);}let l=o[Ae];if(typeof l=="object"&&l&&Object.keys(l).forEach(c=>{const p=l[c];s.set(c,p);}),!s.size){C.warn("请先配置键",a);return}if(a.type==="switch"){let c=typeof a.disabled=="function"?a.disabled():a.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...s.keys());}for(const[c,p]of s.entries())this.setDefaultValue(c,p);},e=a=>{for(let o=0;o<a.length;o++){let r=a[o];t(r);let s=r.views;s&&Array.isArray(s)&&e(s);}},n=[...le.getAllContentConfig()];for(let a=0;a<n.length;a++){let o=n[a];if(!o.views)continue;const r=o.views;r&&Array.isArray(r)&&e(r);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(t,e){this.$data.contentConfigInitDefaultValue.has(t)&&C.warn("请检查该key(已存在): "+t),this.$data.contentConfigInitDefaultValue.set(t,e);},getDefaultValue(t){return this.$data.contentConfigInitDefaultValue.get(t)},setValue(t,e){G.set(t,e);},getValue(t,e){const n=G.get(t);return n??(this.$data.contentConfigInitDefaultValue.has(t)?this.$data.contentConfigInitDefaultValue.get(t):e)},deleteValue(t){G.delete(t);},hasKey(t){return G.has(t)},addValueChangeListener(t,e){return G.addValueChangeListener(t,e)},removeValueChangeListener(t){G.removeValueChangeListener(t);},emitMenuValueChange(t,e,n){G.emitValueChangeListener(t,e,n);},async exec(t,e,n,a=true){const o=this;let r;typeof t=="string"||Array.isArray(t)?r=()=>t:r=t;let s=false;const i=r();let l=[];Array.isArray(i)?(s=true,l=i):l.push(i);const c=l.find(m=>!this.$data.contentConfigInitDefaultValue.has(m));if(c){C.warn(`${c} 键不存在`);return}const p=JSON.stringify(l);if(a&&this.$data.onceExecMenuData.has(p))return this.$data.onceExecMenuData.get(p);let u=[];const d=[];let f=[];const g=(m,x)=>{let D=[],E=[],b=[];if(Array.isArray(x))b=b.concat(x);else {const $=v=>{if(typeof v=="object"&&v!=null)if(v instanceof Element)b.push(v);else {const{$css:L,destory:M}=v;L!=null&&(Array.isArray(L)?b=b.concat(L):b.push(L)),typeof M=="function"&&b.push(M);}else b.push(v);};if(x!=null&&Array.isArray(x))for(const v of x)$(v);else $(x);}for(const $ of b)if($!=null){if($ instanceof Element){D.push($);continue}if(typeof $=="function"){E.push($);continue}}R(),V(),m&&(u=u.concat(D),f=f.concat(E));},k=m=>!!this.getValue(m),R=()=>{for(let m=0;m<u.length;m++)u[m]?.remove(),u.splice(m,1),m--;},V=()=>{for(let m=0;m<f.length;m++){const x=f[m];x(),f.splice(m,1),m--;}},A=()=>{let m=false;return typeof n=="function"?m=n(l):m=l.every(x=>k(x)),m},_=async m=>{const x=A();let D=[];if(x){const E=l.map(b=>this.getValue(b));D=await e({value:s?E:E[0],addStoreValue:(...b)=>g(x,b)});}g(x,D);};a&&l.forEach(m=>{const x=this.addValueChangeListener(m,(D,E,b)=>_());d.push(x);}),await _();const S={reload(){this.clearStoreStyleElements(),this.destory(),_();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>R(),destory(){return V()},removeValueChangeListener:()=>{d.forEach(m=>{this.removeValueChangeListener(m);});},clearOnceExecMenuData(){a&&o.$data.onceExecMenuData.delete(p);}};return this.$data.onceExecMenuData.set(p,S),S},async execMenu(t,e,n=false,a=false){return await this.exec(t,async o=>await e(o),o=>o.every(s=>{let i=!!this.getValue(s);return P.$data.contentConfigInitDisabledKeys.includes(s)&&(i=false,C.warn(`.execMenu${a?"Once":""} ${s} 被禁用`)),n&&(i=!i),i}),a)},async execMenuOnce(t,e,n=false,a=false){const o=await this.execMenu(t,e,n,true);if(a&&o){const r=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(t),this.addUrlChangeWithExecMenuOnceListener(t,r);}return o},deleteExecMenuOnce(t){return t=this.transformKey(t),this.$data.onceExecMenuData.delete(t),this.$data.urlChangeReloadMenuExecOnce.delete(t),G.removeValueChangeListener(t)},onceExec(t,e){if(t=this.transformKey(t),typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},deleteOnceExec(t){t=this.transformKey(t),this.$data.onceExecData.delete(t);},addUrlChangeWithExecMenuOnceListener(t,e){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.set(t,e);},removeUrlChangeWithExecMenuOnceListener(t){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.delete(t);},hasUrlChangeWithExecMenuOnceListener(t){return t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.has(t)},async emitUrlChangeWithExecMenuOnceEvent(t){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const n of e)await n(t);},showPanel(t,e=`${pe}-设置`,n=false,a=false){this.$data.$panel=null,this.$data.panelContent=[];const o=t.findIndex(s=>(typeof s.isBottom=="function"?s.isBottom():!!s.isBottom)&&s.id==="script-version")!==-1;!n&&!o&&t.push(...le.getDefaultBottomContentConfig());const r=I.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(s,i)=>{s.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(s,i)=>{s(),this.$data.$panel=null;}},width:U.setting.width,height:U.setting.height,drag:true,only:true,style:`
        ...
        `,...this.$data.panelConfig});this.$data.$panel=r,this.$data.panelContent=t,a||this.registerConfigSearch({$panel:r,content:t});},registerConfigSearch(t){const{$panel:e,content:n}=t,a=async(d,f)=>{if(d==null)return;const g=await f(d);return g&&typeof g.isFind=="boolean"&&g.isFind?g.data:await a(g.data,f)},o=(d,f)=>{const g=new IntersectionObserver(k=>{k.forEach(R=>{R.isIntersecting&&(f?.(),g.disconnect());});},{root:null,threshold:1});g.observe(d),d.scrollIntoView({behavior:"smooth",block:"center"});},r=d=>{const f="pops-flashing";h.onAnimationend(d,()=>{d.classList.remove(f);}),d.classList.add(f);},s=d=>{if(d.type==="dblclick"&&u)return;h.preventEvent(d),l=null;const f=I.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${t.searchDialogStyle??""}
				`});f.$shadowRoot.querySelector(".search-wrapper");const g=f.$shadowRoot.querySelector(".search-config-text"),k=f.$shadowRoot.querySelector(".search-result-wrapper");g.focus();const R=()=>{h.empty(k);},V=_=>{const S=w.queryProperty(_,D=>D?.next?{isFind:false,data:D.next}:{isFind:true,data:D}),m=h.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),x=I.config.PanelHandlerComponents();return h.on(m,"click",D=>{const b=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[_.index];if(!b){y.error(`左侧项下标${_.index}不存在`);return}b.scrollIntoView({behavior:"smooth",block:"center"}),b.click(),a(_.next,async $=>{if($?.next){const v=await h.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(L=>{const M=Reflect.get(L,x.$data.nodeStoreConfigKey);return typeof M=="object"&&M!=null&&M.text===$.name}),2500);if(v)v.click();else return y.error("未找到对应的二级菜单"),{isFind:true,data:$};return {isFind:false,data:$.next}}else {const v=await h.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(L=>Reflect.get(L,x.$data.nodeStoreConfigKey)===$.matchedData?.formConfig),2500);if(v){o(v);const L=v.closest(".pops-panel-forms-fold[data-fold-enable]");L&&(L.querySelector(".pops-panel-forms-fold-container").click(),await w.sleep(500)),o(v,()=>{r(v);});}else y.error("未找到对应的菜单项");return {isFind:true,data:$}}});}),m},A=_=>{const S=new RegExp(_,"i"),m=[],x=(E,b)=>{for(let $=0;$<E.length;$++){const v=E[$],L=v.views;if(L&&Array.isArray(L)){const M=w.deepClone(b);if(v.type==="deepMenu"){const H=w.queryProperty(M,z=>z?.next?{isFind:false,data:z.next}:{isFind:true,data:z});H.next={name:v.text};}x(L,M);}else {let M,H;if(v.type==="own"){const O=Reflect.get(v.attributes||{},Me);O&&(typeof O.text=="string"&&(M=O.text),typeof O.desc=="string"&&(H=O.desc));}else M=v.text,H=Reflect.get(v,"description");const z=[M,H],me=z.findIndex(O=>{if(typeof O=="string")return O.match(S)});if(me!==-1){const O=w.deepClone(b),ge=w.queryProperty(O,B=>B?.next?{isFind:false,data:B.next}:{isFind:true,data:B});ge.next={name:M,matchedData:{path:"",formConfig:v,matchedText:z[me],description:H}};const xe=[];w.queryProperty(O,B=>{const ue=B?.name;return typeof ue=="string"&&ue.trim()!==""&&xe.push(ue),B?.next?{isFind:false,data:B.next}:{isFind:true,data:B}});const Ve=xe.join(Z.escapeHtml(" - "));ge.next.matchedData.path=Ve,m.push(O);}}}};for(let E=0;E<n.length;E++){const b=n[E];if(!b.views||b.isBottom&&b.id==="script-version")continue;const $=b.views;if($&&Array.isArray($)){let v=b.title;typeof v=="function"&&(v=v()),x($,{index:E,name:v});}}const D=document.createDocumentFragment();for(const E of m){let b=V(E);D.appendChild(b);}R(),k.append(D);};h.on(g,"input",w.debounce(_=>{h.preventEvent(_);let S=h.val(g).trim();if(S===""){R();return}A(S);},200));};e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(d=>{h.on(d,"dblclick",s);});let l=null,c=false,p,u=false;h.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(d,f)=>{u=true,clearTimeout(p),p=void 0,c&&l===f?(c=false,l=null,s(d)):(p=setTimeout(()=>{c=false;},200),c=true,l=f);},{capture:true}),e.$shadowRoot.appendChild(h.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
				...
				`}));},transformKey(t){if(Array.isArray(t)){const e=t.sort();return JSON.stringify(e)}else return t}},X={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},w=K.noConflict(),h=q.noConflict(),I=re,C=new w.Log(J,F.console||Ie.console),pe=J?.script?.name||void 0,Le=re.config.Utils.AnyTouch(),Fe=false;C.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});y.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(t){const e=t.setting.type;if(e==="loading")return  false;const n=t.setting.content;return e==="warning"?C.warn(n):e==="error"?C.error(n):C.info(n),true},get position(){return P.getValue(X.qmsg_config_position.key,X.qmsg_config_position.defaultValue)},get maxNums(){return P.getValue(X.qmsg_config_maxnums.key,X.qmsg_config_maxnums.defaultValue)},get showReverse(){return P.getValue(X.qmsg_config_showreverse.key,X.qmsg_config_showreverse.defaultValue)},get zIndex(){let t=K.getMaxZIndex(),e=re.config.InstanceUtils.getPopsMaxZIndex().zIndex;return K.getMaxValue(t,e)+100}});I.GlobalConfig.setGlobalConfig({zIndex:()=>{const t=K.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),e=re.config.InstanceUtils.getPopsMaxZIndex().zIndex;return K.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ie=new w.GM_Menu({GM_getValue:ee,GM_setValue:te,GM_registerMenuCommand:Se,GM_unregisterMenuCommand:Re}),se=new w.Httpx({xmlHttpRequest:Ee,logDetails:Fe});se.interceptors.request.use(t=>t);se.interceptors.response.use(void 0,t=>(C.error("拦截器-请求错误",t),t.type==="onabort"?y.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?y.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?y.error("请求超时",{consoleLogContent:true}):y.error("其它错误",{consoleLogContent:true}),t));F.Object.defineProperty,F.Function.prototype.apply,F.Function.prototype.call,F.Element.prototype.appendChild,F.setTimeout.bind(F),F.clearTimeout.bind(F),F.setInterval.bind(F),F.clearInterval.bind(F);const be=h.addStyle.bind(h);q.selector.bind(q);q.selectorAll.bind(q);new w.GM_Cookie;const le={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new w.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let t=false,e;const n=(r,s)=>{typeof s!="string"&&(s=Z.toStr(s));const i=new Blob([s]),l=globalThis.URL.createObjectURL(i);h.createElement("a",{href:l,download:r}).click(),w.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(l);},500);},a=()=>{const r=u=>{const d=I.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="local">本地导入</div>
            <div class="btn-control" data-mode="network">网络导入</div>
            <div class="btn-control" data-mode="clipboard">剪贴板导入</div>`,html:true},btn:{ok:{enable:false},close:{enable:true,callback(A,_){A.close();}}},drag:true,mask:{enable:true},width:U.info.width,height:U.info.height,style:`
          .btn-control{
          ...
          }`}),f=d.$shadowRoot.querySelector(".btn-control[data-mode='local']"),g=d.$shadowRoot.querySelector(".btn-control[data-mode='network']"),k=d.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),R=async A=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof ne=="function"?typeof ae=="function"?(ne().forEach(m=>{ae(m);}),y.success("已清空脚本存储的配置")):y.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):y.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof we=="function"?we(A):Object.keys(A).forEach(m=>{const x=A[m];te(m,x);}),y.success("配置导入完毕");},V=A=>new Promise(async _=>{const S=w.toJSON(A);Object.keys(S).length===0?y.warning("解析为空配置，不导入"):await R(S),_(true);});h.on(f,"click",A=>{h.preventEvent(A),d.close();const _=h.createElement("input",{type:"file",accept:".json"});h.on(_,["propertychange","input"],S=>{if(!_.files?.length)return;const m=_.files[0],x=new FileReader;x.onload=()=>{V(x.result);},x.readAsText(m,"UTF-8");}),_.click();}),h.on(g,"click",A=>{h.preventEvent(A),d.close();const _=I.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(x,D){x.close();}},ok:{text:"导入",callback:async(x,D)=>{const E=x.text;if(w.isNull(E)){y.error("请填入完整的url");return}const b=y.loading("正在获取配置..."),$=await se.get(E,{allowInterceptConfig:false});if(b.close(),!$.status){C.error($),y.error("获取配置失败",{consoleLogContent:true});return}await V($.data.responseText)&&x.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:U.info.width,height:"auto"}),S=_.$shadowRoot.querySelector("input"),m=_.$shadowRoot.querySelector(".pops-prompt-btn-ok");h.on(S,["input","propertychange"],x=>{h.val(S)===""?h.attr(m,"disabled","true"):h.removeAttr(m,"disabled");}),h.onKeyboard(S,"keydown",(x,D,E)=>{x==="Enter"&&E.length===0&&h.val(S)!==""&&h.emit(m,"click");}),h.emit(S,"input");}),h.on(k,"click",async A=>{h.preventEvent(A),d.close();let _=await Z.getClipboardText();if(_.trim()===""){y.warning("获取到的剪贴板内容为空");return}await V(_);});},s=(u=`${pe}_panel-setting-${w.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,d)=>{const f=I.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(R,V){R.close();}}},drag:true,mask:{enable:true},width:U.info.width,height:U.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),g=f.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),k=f.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");h.on(g,"click",R=>{h.preventEvent(R);try{n(u,d),f.close();}catch(V){y.error(V.toString(),{consoleLogContent:true});}}),h.on(k,"click",async R=>{await w.copy(d)?(y.success("复制成功"),f.close()):y.error("复制失败");});},l=I.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(u,d){r();}},cancel:{enable:true,text:"导出",callback(u,d){s(void 0,p);}}},width:N.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof ne=="function")ne().forEach(d=>{const f=ee(d);Reflect.set(c,d,f);});else {y.warning("不支持函数GM_listValues，仅导出菜单配置");const u=ee(oe);Reflect.set(c,oe,u);}const p=Z.toStr(c);l.value=p;},o=()=>{let r=J?.script?.supportURL||J?.script?.namespace;typeof r=="string"&&w.isNotNull(r)&&window.open(r,"_blank");};return [{id:"script-version",title:`版本：${J?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(r){new Le(r.$asideLiElement).on("tap",function(i){clearTimeout(e),e=void 0,t?(t=false,a()):(e=setTimeout(()=>{t=false,o();},200),t=true);});}}]},setDefaultBottomContentConfig(t){this.$data.__defaultBottomContentConfig=t;}},Pe={get ajaxHooker(){return this.__ajaxHooker==null&&(this.__ajaxHooker=w.ajaxHooker()),this.__ajaxHooker},hook(){this.ajaxHooker.hook(t=>{let e=Z.fixUrl(t.url);try{if(!new URL(e).pathname.endsWith(".m3u8"))return;t.response=o=>{let r=o.responseText;if(r.trim()===""||!r.includes("#EXT-X-ENDLIST"))return;let s=he.runRule(r);o.responseText=s;};}catch(n){C.error("m3u8过滤器 hook network出错",n);}});},unhook(){this.ajaxHooker.unhook();}},ve=function(t,e,n,a,o,r,s){const i={text:t,type:"select",description:r,attributes:{},props:{},getValue(){return this.props[T].get(e,n)},callback(l){if(l==null)return;const c=l.value;if(C.info(`选择：${l.text}`),typeof o=="function"&&o(l))return;this.props[T].set(e,c);},data:a};return Reflect.set(i.attributes,j,e),Reflect.set(i.attributes,W,n),ce.initComponentsStorageApi("select",i,{get(l,c){return P.getValue(l,c)},set(l,c){P.setValue(l,c);}}),i},Y=function(t,e,n,a,o,r,s,i,l){const c={text:t,type:"switch",description:o,disabled:s,attributes:{},props:{},getValue(){return this.props[T].get(e,n)},callback(p,u){const d=!!u;C.success(`${d?"开启":"关闭"} ${t}`),this.props[T].set(e,d);},afterAddToUListCallBack:(...p)=>{}};return Reflect.set(c.attributes,j,e),Reflect.set(c.attributes,W,n),ce.initComponentsStorageApi("switch",c,{get(p,u){return P.getValue(p,u)},set(p,u){P.setValue(p,u);}}),c},Oe=function(t,e,n,a,o,r="",s,i){const l={text:t,type:"textarea",attributes:{},props:{},description:a,placeholder:r,disabled:s,getValue(){const p=this.props[T].get(e,n);return Array.isArray(p)?p.join(`
`):p},callback(c,p){this.props[T].set(e,p);}};return Reflect.set(l.attributes,j,e),Reflect.set(l.attributes,W,n),ce.initComponentsStorageApi("switch",l,{get(c,p){return P.getValue(c,p)},set(c,p){P.setValue(c,p);}}),l},ce={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new K.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,n){let a;this.hasStorageApi(t)?a=this.getStorageApi(t):a=n,this.setComponentsStorageApiProperty(e,a);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,T,e);}},Ce=function(t,e,n,a,o,r="",s="text",i,l){const c={text:t,type:"input",inputType:s,attributes:{},props:{},description:a,placeholder:r,afterAddToUListCallBack:i,getValue(){return this.props[T].get(e,n)},callback(p,u){p.target.validity.valid,this.props[T].set(e,u);}};return Reflect.set(c.attributes,j,e),Reflect.set(c.attributes,W,n),ce.initComponentsStorageApi("input",c,{get(p,u){return P.getValue(p,u)},set(p,u){P.setValue(p,u);}}),c};class qe{option;constructor(e){this.option=e;}async showView(){const e=I.confirm({title:{text:this.option.title,position:"center"},content:{text:`
        <form class="rule-form-container" onsubmit="return false">
            <ul class="rule-form-ulist"></ul>
            <input type="submit" style="display: none;" />
        </form>
        `,html:true},btn:w.assign({ok:{callback:async()=>{await r();}}},this.option.btn||{},true),drag:true,mask:{enable:true},style:`
      ${I.config.cssText.panelCSS}
...
`),filterInfo:r}}},he={$key:{STORAGE_KEY:"m3u8-rule"},$data:{matchedRule:[]},init(){let t=this.getData();this.registerMenu(t);for(let e=0;e<t.length;e++)try{const n=t[e];n.enable&&window.location.href.match(new RegExp(n.data.url))&&this.$data.matchedRule.push(n);}catch(n){C.error("m3u8过滤器 ==> 规则初始化出错",n);}this.$data.matchedRule.length&&(C.info("m3u8过滤器 ==> 当前网站执行的规则：",this.$data.matchedRule),Pe.hook(),ke.updateISMatchedRuleMenu());},registerMenu(t){ie.update([{key:"m3u8-rule",text:`⚙ 自定义规则（${t.length}条）`,autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.showView();}},{key:"m3u8-export-rule",text:"⚙ 规则导出",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.exportRule("m3u8-filter-rule.json");}},{key:"m3u8-import-rule",text:"⚙ 规则导入",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.importRule();}}]);},getTemplateData(){return {uuid:w.generateUUID(),enable:true,name:"",data:{url:"",commonFilterAdsSegmentsFilePathLength:true,commonFilterAdsSegmentsFilePathSimilar:false,ownFilterCode:""}}},showView(){let t=I.config.PanelHandlerComponents();function e(a){return {get(o,r){return a[o]??r},set(o,r){a[o]=r;}}}new Ue({title:"m3u8自定义规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:a=>a.name,updateData:a=>this.updateData(a),deleteData:a=>this.deleteData(a),getData:a=>this.getData().find(s=>s.uuid===a.uuid)??a,itemControls:{enable:{enable:true,getEnable(a){return a.enable},callback:(a,o)=>{a.enable=o,this.updateData(a);}},edit:{enable:true,getView:(a,o)=>{let r=document.createDocumentFragment();o||(a=this.getTemplateData());let s=Y("启用","enable",true);Reflect.set(s.props,T,e(a));let i=t.createSectionContainerItem_switch(s).$el,l=Ce("规则名称","name","","",void 0,"必填");Reflect.set(l.props,T,e(a));let c=t.createSectionContainerItem_input(l).$el,p=Ce("匹配网址","url","","",void 0,"必填，可正则，注意转义");Reflect.set(p.props,T,e(a.data));let u=t.createSectionContainerItem_input(p).$el,d=Y("广告通杀1","commonFilterAdsSegmentsFilePathLength",true,void 0,"使用文件名称长度比较");Reflect.set(d.props,T,e(a.data));let f=t.createSectionContainerItem_switch(d).$el,g=Y("广告通杀2","commonFilterAdsSegmentsFilePathSimilar",false,void 0,"使用文件名称相似度比较");Reflect.set(g.props,T,e(a.data));let k=t.createSectionContainerItem_switch(g).$el,R=Oe("自定义过滤js","ownFilterCode","","",void 0,`参数：
...
return m3u8Text;
`);Reflect.set(R.props,T,e(a.data));let V=t.createSectionContainerItem_textarea(R).$el;return r.appendChild(i),r.appendChild(c),r.appendChild(u),r.appendChild(f),r.appendChild(k),r.appendChild(V),r},onsubmit:(a,o,r)=>{let s=a.querySelectorAll(".rule-form-ulist > li"),i=this.getTemplateData();return o&&(i.uuid=r.uuid),s.forEach(l=>{let c=Reflect.get(l,t.$data.nodeStoreConfigKey),p=Reflect.get(c,"attributes"),u=Reflect.get(l,T),d=Reflect.get(p,j),f=Reflect.get(p,W),g=u.get(d,f);Reflect.has(i,d)?Reflect.set(i,d,g):Reflect.has(i.data,d)?Reflect.set(i.data,d,g):C.error(`${d}不在数据中`);}),i.name.trim()===""?(y.error("规则名称不能为空"),{success:false,data:i}):i.data.url.trim()===""?(y.error("匹配网址不能为空"),{success:false,data:i}):o?{success:this.updateData(i),data:i}:{success:this.addData(i),data:i}},style:`
            ...
            `}),n=e.$shadowRoot.querySelector(".btn-control[data-mode='local']"),a=e.$shadowRoot.querySelector(".btn-control[data-mode='network']"),o=e.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),r=i=>{let l=this.getData(),c=[];for(let p=0;p<i.length;p++){const u=i[p];l.findIndex(f=>f.uuid===u.uuid)!==-1||c.push(u);}l=l.concat(c),this.setData(l),y.success(`共 ${i.length} 条规则，新增 ${c.length} 条`),t?.();},s=i=>new Promise(l=>{let c=w.toJSON(i);if(!Array.isArray(c)){C.error(c),y.error("导入失败，格式不符合（不是数组）",{consoleLogContent:true}),l(false);return}if(!c.length){y.error("导入失败，解析出的数据为空",{consoleLogContent:true}),l(false);return}r(c),l(true);});h.on(n,"click",i=>{h.preventEvent(i),e.close();let l=h.createElement("input",{type:"file",accept:".json"});h.on(l,["propertychange","input"],c=>{if(!l.files?.length)return;let p=l.files[0],u=new FileReader;u.onload=()=>{s(u.result);},u.readAsText(p,"UTF-8");}),l.click();}),h.on(a,"click",i=>{h.preventEvent(i),e.close();let l=I.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(u,d){u.close();}},ok:{text:"导入",callback:async(u,d)=>{let f=u.text;if(w.isNull(f)){y.error("请填入完整的url");return}let g=y.loading("正在获取配置..."),k=await se.get(f,{allowInterceptConfig:false});if(g.close(),!k.status){C.error(k),y.error("获取配置失败",{consoleLogContent:true});return}await s(k.data.responseText)&&u.close();}},cancel:{enable:false}},mask:{enable:true},drag:true,width:U.info.width,height:"auto"}),c=l.$shadowRoot.querySelector("input"),p=l.$shadowRoot.querySelector(".pops-prompt-btn-ok");h.on(c,["input","propertychange"],u=>{h.val(c)===""?h.attr(p,"disabled","true"):h.removeAttr(p,"disabled");}),h.onKeyboard(c,"keydown",(u,d,f)=>{u==="Enter"&&f.length===0&&h.val(c)!==""&&h.emit(p,"click");}),h.emit(c,"input");}),h.on(o,"click",async i=>{h.preventEvent(i),e.close();let l=await w.getClipboardInfo();if(l.error!=null){y.error(l.error.toString());return}if(l.content.trim()===""){y.warning("获取到的剪贴板内容为空");return}await s(l.content);});}},Be={id:"component-common",title:"通用",views:[{text:"Toast配置",type:"container",views:[ve("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],t=>{C.info("设置当前Qmsg弹出位置"+t.text);},"Toast显示在页面九宫格的位置"),ve("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),Y("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]},{text:"Cookie配置",type:"container",views:[Y("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),Y("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie")]}]};le.addContentConfig([Be]);$e.deleteMenuOption();P.init();he.init();

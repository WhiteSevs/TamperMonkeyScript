...
`)}{display: none !important;}`)},setGMResourceCSS(t){const e=typeof we=="function"?we(t.keyName):null;return typeof e=="string"&&e?be(e):Z.loadStyleLink(t.url)},async loadStyleLink(t){let e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.href=t,new Promise(n=>{P.ready(()=>{document.head.appendChild(e),n(e);});})},async loadScript(t){let e=document.createElement("script");return e.src=t,new Promise(n=>{e.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(e);})},fixUrl(t){return t=t.trim(),t.startsWith("data:")||t.match(/^http(s|):\/\//i)?t:t.startsWith("//")?(t.startsWith("///")||(t=window.location.protocol+t),t):(t.startsWith("/")||(t+="/"),t=window.location.origin+t,t)},fixHttps(t){if(t.startsWith("https://")||!t.startsWith("http://"))return t;try{let e=new URL(t);return e.protocol="https:",e.toString()}catch{return t}},lockScroll(...t){let e=document.createElement("style");e.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...t||[]);return n.forEach(a=>{a.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(e),{recovery(){n.forEach(a=>{a.classList.remove("pops-overflow-hidden-important");}),e.remove();}}},async getClipboardText(){function t(a){navigator.clipboard.readText().then(o=>{a(o);}).catch(o=>{v.error("读取剪贴板内容失败👉",o),a("");});}function e(a){navigator.permissions.query({name:"clipboard-read"}).then(o=>{t(a);}).catch(o=>{v.error("申请剪贴板权限失败，尝试直接读取👉",o.message??o.name??o.stack),t(a);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(a=>{if(!n()){a("");return}document.hasFocus()?e(a):window.addEventListener("focus",()=>{e(a);},{once:true});})},escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(t,e,n=5e3){let a,o=n-e,s=e,r=async l=>{let i=await t(l);if(typeof i=="boolean"&&!i||l){y.workerClearTimeout(a);return}if(s+=e,s>o){r(true);return}a=y.workerSetTimeout(()=>{r(false);},e);};r(false);},findParentNode(t,e,n){if(n){let a=P.closest(t,n);if(a)return a.querySelector(e)}else return P.matches(t,e)?t:P.closest(t,e)},toStr(t){const e="__undefined__placeholder__replaced__str__";return JSON.stringify(t,(a,o)=>o===void 0?e:o,2).replace(new RegExp(`"${e}"`,"g"),"undefined")}},M={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new y.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new y.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new y.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new y.Dictionary),this.__onceExecData},get scriptName(){return pe},get panelConfig(){return this.__panelConfig},set panelConfig(t){this.__panelConfig=t;},key:oe,attributeKeyName:j,attributeDefaultValueName:W},init(){this.initContentDefaultValue(),$e.init();},isTopWindow(){return N.top===N.self},initContentDefaultValue(){const t=a=>{if(!a.attributes||a.type==="button"||a.type==="container"||a.type==="deepMenu")return;const o=a.attributes;let s=o[Ie];if(typeof s=="function"){let c=s();if(typeof c=="boolean"&&!c)return}let r=new Map,l=o[j];if(l!=null){const c=o[W];r.set(l,c);}let i=o[Ae];if(typeof i=="object"&&i&&Object.keys(i).forEach(c=>{const u=i[c];r.set(c,u);}),!r.size){v.warn(["请先配置键",a]);return}if(a.type==="switch"){let c=typeof a.disabled=="function"?a.disabled():a.disabled;typeof c=="boolean"&&c&&this.$data.contentConfigInitDisabledKeys.push(...r.keys());}for(const[c,u]of r.entries())this.setDefaultValue(c,u);},e=a=>{for(let o=0;o<a.length;o++){let s=a[o];t(s);let r=s.views;r&&Array.isArray(r)&&e(r);}},n=[...le.getAllContentConfig()];for(let a=0;a<n.length;a++){let o=n[a];if(!o.views)continue;const s=o.views;s&&Array.isArray(s)&&e(s);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(t,e){this.$data.contentConfigInitDefaultValue.has(t)&&v.warn("请检查该key(已存在): "+t),this.$data.contentConfigInitDefaultValue.set(t,e);},getDefaultValue(t){return this.$data.contentConfigInitDefaultValue.get(t)},setValue(t,e){G.set(t,e);},getValue(t,e){const n=G.get(t);return n??(this.$data.contentConfigInitDefaultValue.has(t)?this.$data.contentConfigInitDefaultValue.get(t):e)},deleteValue(t){G.delete(t);},hasKey(t){return G.has(t)},addValueChangeListener(t,e){return G.addValueChangeListener(t,(a,o,s)=>{e(t,s,o);})},removeValueChangeListener(t){G.removeValueChangeListener(t);},triggerMenuValueChange(t,e,n){G.triggerValueChangeListener(t,n,e);},async exec(t,e,n,a=true){const o=this;let s;typeof t=="string"||Array.isArray(t)?s=()=>t:s=t;let r=false;const l=s();let i=[];Array.isArray(l)?(r=true,i=l):i.push(l);const c=i.find(g=>!this.$data.contentConfigInitDefaultValue.has(g));if(c){v.warn(`${c} 键不存在`);return}const u=JSON.stringify(i);if(a&&this.$data.onceExecMenuData.has(u))return this.$data.onceExecMenuData.get(u);let d=[];const p=[];let h=[];const m=(g,x)=>{let D=[],R=[],b=[];if(Array.isArray(x))b=b.concat(x);else if(typeof x=="object"&&x!=null)if(x instanceof Element)b.push(x);else {const{$css:C,destory:$}=x;C!=null&&(Array.isArray(C)?b=b.concat(C):b.push(C)),typeof $=="function"&&b.push($);}else b.push(x);for(const C of b)if(C!=null){if(C instanceof Element){D.push(C);continue}if(typeof C=="function"){h.push(C);continue}}g?(d=d.concat(D),h=h.concat(R)):(E(),F());},V=g=>!!this.getValue(g),E=()=>{for(let g=0;g<d.length;g++)d[g]?.remove(),d.splice(g,1),g--;},F=()=>{for(let g=0;g<h.length;g++){const x=h[g];x(),h.splice(g,1),g--;}},I=()=>{let g=false;return typeof n=="function"?g=n(i):g=i.every(x=>V(x)),g},_=async g=>{if(I()){const D=i.map(b=>this.getValue(b)),R=await e({value:r?D:D[0],addStoreValue:(...b)=>m(true,b)});m(true,R);}else m(false,[]);};a&&i.forEach(g=>{const x=this.addValueChangeListener(g,(D,R,b)=>_());p.push(x);}),await _();const k={reload(){this.clearStoreStyleElements(),this.destory(),_();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>E(),destory(){return F()},removeValueChangeListener:()=>{p.forEach(g=>{this.removeValueChangeListener(g);});},clearOnceExecMenuData(){a&&o.$data.onceExecMenuData.delete(u);}};return this.$data.onceExecMenuData.set(u,k),k},async execMenu(t,e,n=false,a=false){return await this.exec(t,async o=>await e(o),o=>o.every(r=>{let l=!!this.getValue(r);return M.$data.contentConfigInitDisabledKeys.includes(r)&&(l=false,v.warn(`.execMenu${a?"Once":""} ${r} 被禁用`)),n&&(l=!l),l}),a)},async execMenuOnce(t,e,n=false,a=false){const o=await this.execMenu(t,e,n,true);if(a&&o){const s=()=>{o.reload();};this.removeUrlChangeWithExecMenuOnceListener(t),this.addUrlChangeWithExecMenuOnceListener(t,s);}return o},deleteExecMenuOnce(t){return t=this.transformKey(t),this.$data.onceExecMenuData.delete(t),this.$data.urlChangeReloadMenuExecOnce.delete(t),G.removeValueChangeListener(t)},onceExec(t,e){if(t=this.transformKey(t),typeof t!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(t)||(e(),this.$data.onceExecData.set(t,1));},deleteOnceExec(t){t=this.transformKey(t),this.$data.onceExecData.delete(t);},addUrlChangeWithExecMenuOnceListener(t,e){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.set(t,e);},removeUrlChangeWithExecMenuOnceListener(t){t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.delete(t);},hasUrlChangeWithExecMenuOnceListener(t){return t=this.transformKey(t),this.$data.urlChangeReloadMenuExecOnce.has(t)},async triggerUrlChangeWithExecMenuOnceEvent(t){const e=this.$data.urlChangeReloadMenuExecOnce.values();for(const n of e)await n(t);},showPanel(t,e=`${pe}-设置`,n=false,a=false){this.$data.$panel=null,this.$data.panelContent=[];let o=t.findIndex(r=>(typeof r.isBottom=="function"?r.isBottom():!!r.isBottom)&&r.id==="script-version")!==-1;!n&&!o&&t.push(...le.getDefaultBottomContentConfig());let s=S.panel({title:{text:e,position:"center",html:false,style:""},content:t,btn:{close:{enable:true,callback:(r,l)=>{r.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(r,l)=>{r(),this.$data.$panel=null;}},width:O.setting.width,height:O.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=s,this.$data.panelContent=t,a||this.registerConfigSearch({$panel:s,content:t});},registerConfigSearch(t){const{$panel:e,content:n}=t,a=async(p,h)=>{if(p==null)return;const m=await h(p);return m&&typeof m.isFind=="boolean"&&m.isFind?m.data:await a(m.data,h)},o=(p,h)=>{const m=new IntersectionObserver(V=>{V.forEach(E=>{E.isIntersecting&&(h?.(),m.disconnect());});},{root:null,threshold:1});m.observe(p),p.scrollIntoView({behavior:"smooth",block:"center"});},s=p=>{const h="pops-flashing";f.animationend(p,()=>{p.classList.remove(h);}),p.classList.add(h);},r=p=>{if(p.type==="dblclick"&&d)return;f.preventEvent(p),i=null;const h=S.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${t.searchDialogStyle??""}
				`});h.$shadowRoot.querySelector(".search-wrapper");const m=h.$shadowRoot.querySelector(".search-config-text"),V=h.$shadowRoot.querySelector(".search-result-wrapper");m.focus();const E=()=>{f.empty(V);},F=_=>{const k=y.queryProperty(_,D=>D?.next?{isFind:false,data:D.next}:{isFind:true,data:D}),g=f.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),x=S.config.PanelHandlerComponents();return f.on(g,"click",D=>{const b=e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[_.index];if(!b){w.error(`左侧项下标${_.index}不存在`);return}b.scrollIntoView({behavior:"smooth",block:"center"}),b.click(),a(_.next,async C=>{if(C?.next){const $=await f.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(q=>{const L=Reflect.get(q,x.$data.nodeStoreConfigKey);return typeof L=="object"&&L!=null&&L.text===C.name}),2500);if($)$.click();else return w.error("未找到对应的二级菜单"),{isFind:true,data:C};return {isFind:false,data:C.next}}else {const $=await f.waitNode(()=>Array.from(e.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(q=>Reflect.get(q,x.$data.nodeStoreConfigKey)===C.matchedData?.formConfig),2500);if($){o($);const q=$.closest(".pops-panel-forms-fold[data-fold-enable]");q&&(q.querySelector(".pops-panel-forms-fold-container").click(),await y.sleep(500)),o($,()=>{s($);});}else w.error("未找到对应的菜单项");return {isFind:true,data:C}}});}),g},I=_=>{const k=new RegExp(_,"i"),g=[],x=(R,b)=>{for(let C=0;C<R.length;C++){const $=R[C],q=$.views;if(q&&Array.isArray(q)){const L=y.deepClone(b);if($.type==="deepMenu"){const H=y.queryProperty(L,z=>z?.next?{isFind:false,data:z.next}:{isFind:true,data:z});H.next={name:$.text};}x(q,L);}else {let L,H;if($.type==="own"){const T=Reflect.get($.attributes||{},Me);T&&(typeof T.text=="string"&&(L=T.text),typeof T.desc=="string"&&(H=T.desc));}else L=Reflect.get($,"text"),H=Reflect.get($,"description");const z=[L,H],ge=z.findIndex(T=>{if(typeof T=="string")return T.match(k)});if(ge!==-1){const T=y.deepClone(b),me=y.queryProperty(T,U=>U?.next?{isFind:false,data:U.next}:{isFind:true,data:U});me.next={name:L,matchedData:{path:"",formConfig:$,matchedText:z[ge],description:H}};const xe=[];y.queryProperty(T,U=>{const ue=U?.name;return typeof ue=="string"&&ue.trim()!==""&&xe.push(ue),U?.next?{isFind:false,data:U.next}:{isFind:true,data:U}});const Ve=xe.join(Z.escapeHtml(" - "));me.next.matchedData.path=Ve,g.push(T);}}}};for(let R=0;R<n.length;R++){const b=n[R];if(!b.views||b.isBottom&&b.id==="script-version")continue;const C=b.views;if(C&&Array.isArray(C)){let $=b.title;typeof $=="function"&&($=$()),x(C,{index:R,name:$});}}const D=document.createDocumentFragment();for(const R of g){let b=F(R);D.appendChild(b);}E(),V.append(D);};f.on(m,"input",y.debounce(_=>{f.preventEvent(_);let k=f.val(m).trim();if(k===""){E();return}I(k);},200));};e.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(p=>{f.on(p,"dblclick",r);});let i=null,c=false,u,d=false;f.on(e.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(p,h)=>{d=true,clearTimeout(u),u=void 0,c&&i===h?(c=false,i=null,r(p)):(u=setTimeout(()=>{c=false;},200),c=true,i=h);},{capture:true}),e.$shadowRoot.appendChild(f.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
				...
				`}));},transformKey(t){if(Array.isArray(t)){const e=t.sort();return JSON.stringify(e)}else return t}},X={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},y=K.noConflict(),f=P.noConflict(),S=re,v=new y.Log(J,N.console||De.console),pe=J?.script?.name||void 0,Le=re.config.Utils.AnyTouch(),Te=false;v.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});w.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(t){const e=t.setting.type;if(e==="loading")return  false;const n=t.setting.content;return e==="warning"?v.warn(n):e==="error"?v.error(n):v.info(n),true},get position(){return M.getValue(X.qmsg_config_position.key,X.qmsg_config_position.defaultValue)},get maxNums(){return M.getValue(X.qmsg_config_maxnums.key,X.qmsg_config_maxnums.defaultValue)},get showReverse(){return M.getValue(X.qmsg_config_showreverse.key,X.qmsg_config_showreverse.defaultValue)},get zIndex(){let t=K.getMaxZIndex(),e=re.config.InstanceUtils.getPopsMaxZIndex().zIndex;return K.getMaxValue(t,e)+100}});S.GlobalConfig.setGlobalConfig({zIndex:()=>{const t=K.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),e=re.config.InstanceUtils.getPopsMaxZIndex().zIndex;return K.getMaxValue(t,e)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ie=new y.GM_Menu({GM_getValue:ee,GM_setValue:te,GM_registerMenuCommand:Se,GM_unregisterMenuCommand:Re}),se=new y.Httpx({xmlHttpRequest:Ee,logDetails:Te});se.interceptors.request.use(t=>t);se.interceptors.response.use(void 0,t=>(v.error("拦截器-请求错误",t),t.type==="onabort"?w.warning("请求取消",{consoleLogContent:true}):t.type==="onerror"?w.error("请求异常",{consoleLogContent:true}):t.type==="ontimeout"?w.error("请求超时",{consoleLogContent:true}):w.error("其它错误",{consoleLogContent:true}),t));N.Object.defineProperty,N.Function.prototype.apply,N.Function.prototype.call,N.Element.prototype.appendChild,N.setTimeout;const be=f.addStyle.bind(f);P.selector.bind(P);P.selectorAll.bind(P);new y.GM_Cookie;const le={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new y.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(t){Array.isArray(t)||(t=[t]);let e=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(e,t);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(t=0){return this.$data.contentConfig.get(t)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let t=false,e;const n=(s,r)=>{typeof r!="string"&&(r=Z.toStr(r));const l=new Blob([r]),i=globalThis.URL.createObjectURL(l);f.createElement("a",{href:i,download:s}).click(),y.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(i);},500);},a=()=>{const s=d=>{const p=S.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="local">本地导入</div>
            <div class="btn-control" data-mode="network">网络导入</div>
            <div class="btn-control" data-mode="clipboard">剪贴板导入</div>`,html:true},btn:{ok:{enable:false},close:{enable:true,callback(I,_){I.close();}}},drag:true,mask:{enable:true},width:O.info.width,height:O.info.height,style:`
          .btn-control{
          ...
          }`}),h=p.$shadowRoot.querySelector(".btn-control[data-mode='local']"),m=p.$shadowRoot.querySelector(".btn-control[data-mode='network']"),V=p.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),E=async I=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof ne=="function"?typeof ae=="function"?(ne().forEach(g=>{ae(g);}),w.success("已清空脚本存储的配置")):w.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):w.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof ye=="function"?ye(I):Object.keys(I).forEach(g=>{const x=I[g];te(g,x);}),w.success("配置导入完毕");},F=I=>new Promise(async _=>{const k=y.toJSON(I);Object.keys(k).length===0?w.warning("解析为空配置，不导入"):await E(k),_(true);});f.on(h,"click",I=>{f.preventEvent(I),p.close();const _=f.createElement("input",{type:"file",accept:".json"});f.on(_,["propertychange","input"],k=>{if(!_.files?.length)return;const g=_.files[0],x=new FileReader;x.onload=()=>{F(x.result);},x.readAsText(g,"UTF-8");}),_.click();}),f.on(m,"click",I=>{f.preventEvent(I),p.close();const _=S.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(x,D){x.close();}},ok:{text:"导入",callback:async(x,D)=>{const R=x.text;if(y.isNull(R)){w.error("请填入完整的url");return}const b=w.loading("正在获取配置..."),C=await se.get(R,{allowInterceptConfig:false});if(b.close(),!C.status){v.error(C),w.error("获取配置失败",{consoleLogContent:true});return}await F(C.data.responseText)&&x.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:O.info.width,height:"auto"}),k=_.$shadowRoot.querySelector("input"),g=_.$shadowRoot.querySelector(".pops-prompt-btn-ok");f.on(k,["input","propertychange"],x=>{f.val(k)===""?f.attr(g,"disabled","true"):f.removeAttr(g,"disabled");}),f.listenKeyboard(k,"keydown",(x,D,R)=>{x==="Enter"&&R.length===0&&f.val(k)!==""&&f.trigger(g,"click");}),f.trigger(k,"input");}),f.on(V,"click",async I=>{f.preventEvent(I),p.close();let _=await Z.getClipboardText();if(_.trim()===""){w.warning("获取到的剪贴板内容为空");return}await F(_);});},r=(d=`${pe}_panel-setting-${y.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,p)=>{const h=S.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
            <div class="btn-control" data-mode="export-to-file">导出至文件</div>
            <div class="btn-control" data-mode="export-to-clipboard">导出至剪贴板</div>
            `,html:true},btn:{ok:{enable:false},close:{enable:true,callback(E,F){E.close();}}},drag:true,mask:{enable:true},width:O.info.width,height:O.info.height,style:`
          .btn-control{
              display: inline-block;
              margin: 10px;
              padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),m=h.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),V=h.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");f.on(m,"click",E=>{f.preventEvent(E);try{n(d,p),h.close();}catch(F){w.error(F.toString(),{consoleLogContent:true});}}),f.on(V,"click",async E=>{await y.copy(p)?(w.success("复制成功"),h.close()):w.error("复制失败");});},i=S.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(d,p){s();}},cancel:{enable:true,text:"导出",callback(d,p){r(void 0,u);}}},width:B.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),c={};if(typeof ne=="function")ne().forEach(p=>{const h=ee(p);Reflect.set(c,p,h);});else {w.warning("不支持函数GM_listValues，仅导出菜单配置");const d=ee(oe);Reflect.set(c,oe,d);}const u=Z.toStr(c);i.value=u;},o=()=>{let s=J?.script?.supportURL||J?.script?.namespace;typeof s=="string"&&y.isNotNull(s)&&window.open(s,"_blank");};return [{id:"script-version",title:`版本：${J?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(s){new Le(s.$asideLiElement).on("tap",function(l){clearTimeout(e),e=void 0,t?(t=false,a()):(e=setTimeout(()=>{t=false,o();},200),t=true);});}}]},setDefaultBottomContentConfig(t){this.$data.__defaultBottomContentConfig=t;}},Pe={get ajaxHooker(){return this.__ajaxHooker==null&&(this.__ajaxHooker=y.ajaxHooker()),this.__ajaxHooker},hook(){this.ajaxHooker.hook(t=>{let e=Z.fixUrl(t.url);try{if(!new URL(e).pathname.endsWith(".m3u8"))return;t.response=o=>{let s=o.responseText;if(s.trim()===""||!s.includes("#EXT-X-ENDLIST"))return;let r=he.runRule(s);o.responseText=r;};}catch(n){v.error("m3u8过滤器 hook network出错",n);}});},unhook(){this.ajaxHooker.unhook();}},ce={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||(this.__storeApiFn=new K.Dictionary),this.__storeApiFn}},getStorageApi(t){if(this.hasStorageApi(t))return this.$data.storeApiValue.get(t)},hasStorageApi(t){return this.$data.storeApiValue.has(t)},setStorageApi(t,e){this.$data.storeApiValue.set(t,e);},initComponentsStorageApi(t,e,n){let a;this.hasStorageApi(t)?a=this.getStorageApi(t):a=n,this.setComponentsStorageApiProperty(e,a);},setComponentsStorageApiProperty(t,e){Reflect.set(t.props,A,e);}},Ce=function(t,e,n,a,o,s="",r,l,i,c){const u={text:t,type:"input",isNumber:false,isPassword:false,attributes:{},props:{},description:a,afterAddToUListCallBack:i,getValue(){return this.props[A].get(e,n)},callback(d,p,h){this.props[A].set(e,p);},placeholder:s};return Reflect.set(u.attributes,j,e),Reflect.set(u.attributes,W,n),ce.initComponentsStorageApi("input",u,{get(d,p){return M.getValue(d,p)},set(d,p){M.setValue(d,p);}}),u},Y=function(t,e,n,a,o,s,r,l){const i={text:t,type:"switch",description:o,disabled:r,attributes:{},props:{},getValue(){return this.props[A].get(e,n)},callback(c,u){const d=!!u;v.success(`${d?"开启":"关闭"} ${t}`),this.props[A].set(e,d);},afterAddToUListCallBack:s};return Reflect.set(i.attributes,j,e),Reflect.set(i.attributes,W,n),ce.initComponentsStorageApi("switch",i,{get(c,u){return M.getValue(c,u)},set(c,u){M.setValue(c,u);}}),i};class Oe{option;constructor(e){this.option=e;}async showView(){let e=S.confirm({title:{text:this.option.title,position:"center"},content:{text:`
            ...
            `}),n=e.$shadowRoot.querySelector(".filter-container"),a=document.createDocumentFragment();this.option.filterOption.forEach(o=>{let s=f.createElement("button",{innerText:o.name},{type:"button"}),r=async()=>{this.$data.isFilteredData=[],(await this.option.getAllRuleInfo()).forEach(async i=>{await o.filterCallBack(i.data)?f.show(i.$el,false):(f.hide(i.$el,false),this.$data.isFilteredData.push(i.data));}),typeof this.option.execFilterCallBack=="function"&&await this.option.execFilterCallBack(),e.close();};f.on(s,"click",async l=>{f.preventEvent(l),!(typeof o.callback=="function"&&!await o.callback(l,r))&&await r();}),a.appendChild(s);}),n.appendChild(a);}getFilteredData(){return this.$data.isFilteredData}}class Ue{option;constructor(e){this.option=e;}async showView(e){let n=S.confirm({title:{text:this.option.title,position:"center"},content:{text:`
			...
			`});Reflect.set(o,"data-rule",e);let s="pops-panel-switch-is-checked";const{$enable:r,$enableSwitch:l,$enableSwitchCore:i,$enableSwitchInput:c,$delete:u,$edit:d}=this.parseRuleItemElement(o);return this.option.itemControls.enable.enable?(f.on(i,"click",async p=>{let h=false;l.classList.contains(s)?(l.classList.remove(s),h=false):(l.classList.add(s),h=true),c.checked=h,await this.option.itemControls.enable.callback(e,h);}),await this.option.itemControls.enable.getEnable(e)&&l.classList.add(s)):r.remove(),this.option.itemControls.edit.enable?f.on(d,"click",p=>{f.preventEvent(p),this.showEditView(true,e,n,o,h=>{e=null,e=h;});}):d.remove(),this.option.itemControls.delete.enable?f.on(u,"click",p=>{f.preventEvent(p);let h=S.confirm({title:{text:"提示",position:"center"},content:{text:"确定删除该条数据？",html:false},btn:{ok:{enable:true,callback:async m=>{v.success("删除数据"),await this.option.itemControls.delete.deleteCallBack(e)?(w.success("成功删除该数据"),o.remove(),await this.updateDeleteAllBtnText(n),h.close()):w.error("删除该数据失败");}},cancel:{text:"取消",enable:true}},mask:{enable:true},width:"300px",height:"200px"});}):u.remove(),o}async appendRuleItemElement(e,n){let{$container:a}=this.parseViewElement(e),o=[],s=Array.isArray(n)?n:[n];for(let r=0;r<s.length;r++){let l=s[r],i=await this.createRuleItemElement(l,e);a.appendChild(i),o.push(i);}return await this.updateDeleteAllBtnText(e),o}async updateRuleContaienrElement(e){this.clearContent(e);const{$container:n}=this.parseViewElement(e);let a=await this.option.data();await this.appendRuleItemElement(e,a),await this.updateDeleteAllBtnText(e);}async updateRuleItemElement(e,n,a){let o=await this.createRuleItemElement(e,a);n.after(o),n.remove();}clearContent(e){const{$container:n}=this.parseViewElement(e);f.html(n,"");}setDeleteBtnText(e,n,a=false){const{$deleteBtn:o}=this.parseViewElement(e);a?f.html(o,n):f.text(o,n);}async updateDeleteAllBtnText(e){let n=await this.option.data();this.setDeleteBtnText(e,`清空所有(${n.length})`);}}const de={duration2Text(t){const e=Math.floor(t/3600),n=Math.floor(t%3600/60),a=parseInt((t%60).toString());return [e.toString().padStart(2,"0"),n.toString().padStart(2,"0"),a.toString().padStart(2,"0")].join(":")},similar(t,e){if(!t||!e)return 0;var n=t.length>e.length?t.length:e.length,a=t.length,o=e.length,s=[],r=function(h,m,V){return h<m?h<V?h:V:m<V?m:V},l,i,c,u,d;if(a===0)return o;if(o===0)return a;for(l=0;l<=a;l++)s[l]=[],s[l][0]=l;for(i=0;i<=o;i++)s[0][i]=i;for(l=1;l<=a;l++)for(c=t.charAt(l-1),i=1;i<=o;i++)u=e.charAt(i-1),c===u?d=0:d=1,s[l][i]=r(s[l-1][i]+1,s[l][i-1]+1,s[l-1][i-1]+d);return 1-s[a][o]/n}},ke={updateISMatchedRuleMenu(){let t={key:"matched-rule-count",text:`🔧 当前页面执行规则数量： ${he.$data.matchedRule.length}`,autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{}};ie.update(t);},updateIsFilterAdsDurationInfoMenu(t){let e={key:"is-filter-segment-duration",text:`🍵 已过滤时长：${t}s`,autoReload:false,isStoreValue:false,showText(n){return n},callback:()=>{}};ie.update(e);}},fe={parse_EXTINF(t,e,n){let a=Number(t.replace(/(^#EXTINF:\s*|,)/g,"")),o=n,s=n+a;return {filePath:e.trim(),startDuration:o,endDuration:s,duration:a}}},ve=t=>{Q.$data.isFilterDuration+=t.duration,ke.updateIsFilterAdsDurationInfoMenu(Q.$data.isFilterDuration);},Q={$data:{isFilterDuration:0},filterAdsWithFilePathLength(t,e={handlerFilePath(n){return n}}){let n=t.split(`
`),a=new y.Dictionary,o=0;for(let r=0;r<n.length;r++){const l=n[r].trim();if(!l.startsWith("#EXTINF:"))continue;let{duration:i,startDuration:c,endDuration:u,filePath:d}=fe.parse_EXTINF(l,n[r+1],o);if(e&&typeof e.handlerFilePath=="function"){let m=e.handlerFilePath(d);typeof m=="string"&&(d=m);}o+=i;let p=d.length.toString(),h=a.get(p)||[];h.push({filePath:d,startDuration:c,endDuration:u,duration:i,index:r}),a.set(p,h),r++;}let s=[];if(a.forEach((r,l)=>{s.push({filePathLength:l,segmentsInfoList:r});}),s=y.sortListByProperty(s,r=>r.segmentsInfoList.length,true),s.splice(0,1),s.length){let r=[];s.forEach(i=>{i.segmentsInfoList.forEach(c=>{r.push({index:c.index,data:c});});});let l=0;for(let i=0;i<n.length;i++){let c=r.findIndex(u=>u.index===i+l);if(c!=-1){let u=r[c];v.info(`通杀1：过滤广告片段 ==> 索引：${i+l} 文件名：${u.data.filePath} 开始：${de.duration2Text(u.data.startDuration)} 持续时长：${u.data.duration}s`),n.splice(i,2),i-=2,r.splice(c,1),l=l+2;}}}return s.forEach(r=>{r.segmentsInfoList.forEach(l=>{ve(l);});}),{m3u8Text:n.join(`
...
`),a=[],o=0;for(let l=0;l<n.length;l++){const i=n[l].trim();if(!i.startsWith("#EXTINF:"))continue;let{duration:c,startDuration:u,endDuration:d,filePath:p}=fe.parse_EXTINF(i,n[l+1],o);if(e&&typeof e.handlerFilePath=="function"){let h=e.handlerFilePath(p);typeof h=="string"&&(p=h);}o+=c,a.push({filePath:p,startDuration:u,endDuration:d,duration:c,index:l}),l++;}let s=[],r=0;for(let l=0;l<a.length;l++){const i=a[l];let c=true,u=0,d=a;for(let p=0;p<d.length;p++){const h=d[p];if(de.similar(i.filePath,h.filePath)>=e.similarCompareValue&&u++,u/d.length>e.includePercent){c=false;break}}c&&(s.push(i),v.info(`通杀2：过滤广告片段 ==> 索引：${i.index} 文件名：${i.filePath} 开始：${de.duration2Text(i.startDuration)} 持续时长：${i.duration}s`),n.splice(i.index-r,2),r+=2);}return s.forEach(l=>{ve(l);}),{m3u8Text:n.join(`
`),filterInfo:s}}},Ge=function(t,e,n,a,o,s="",r,l){const i={text:t,type:"textarea",attributes:{},props:{},description:a,placeholder:s,disabled:r,getValue(){const u=this.props[A].get(e,n);return Array.isArray(u)?u.join(`
`):u},callback(c,u){this.props[A].set(e,u);}};return Reflect.set(i.attributes,j,e),Reflect.set(i.attributes,W,n),ce.initComponentsStorageApi("switch",i,{get(c,u){return M.getValue(c,u)},set(c,u){M.setValue(c,u);}}),i},he={$key:{STORAGE_KEY:"m3u8-rule"},$data:{matchedRule:[]},init(){let t=this.getData();this.registerMenu(t);for(let e=0;e<t.length;e++)try{const n=t[e];n.enable&&window.location.href.match(new RegExp(n.data.url))&&this.$data.matchedRule.push(n);}catch(n){v.error("m3u8过滤器 ==> 规则初始化出错",n);}this.$data.matchedRule.length&&(v.info("m3u8过滤器 ==> 当前网站执行的规则：",this.$data.matchedRule),Pe.hook(),ke.updateISMatchedRuleMenu());},registerMenu(t){ie.update([{key:"m3u8-rule",text:`⚙ 自定义规则（${t.length}条）`,autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.showView();}},{key:"m3u8-export-rule",text:"⚙ 规则导出",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.exportRule("m3u8-filter-rule.json");}},{key:"m3u8-import-rule",text:"⚙ 规则导入",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{this.importRule();}}]);},getTemplateData(){return {uuid:y.generateUUID(),enable:true,name:"",data:{url:"",commonFilterAdsSegmentsFilePathLength:true,commonFilterAdsSegmentsFilePathSimilar:false,ownFilterCode:""}}},showView(){let t=S.config.PanelHandlerComponents();function e(a){return {get(o,s){return a[o]??s},set(o,s){a[o]=s;}}}new Ue({title:"m3u8自定义规则",data:()=>this.getData(),getAddData:()=>this.getTemplateData(),getDataItemName:a=>a.name,updateData:a=>this.updateData(a),deleteData:a=>this.deleteData(a),getData:a=>this.getData().find(r=>r.uuid===a.uuid)??a,itemControls:{enable:{enable:true,getEnable(a){return a.enable},callback:(a,o)=>{a.enable=o,this.updateData(a);}},edit:{enable:true,getView:(a,o)=>{let s=document.createDocumentFragment();o||(a=this.getTemplateData());let r=Y("启用","enable",true);Reflect.set(r.props,A,e(a));let l=t.createSectionContainerItem_switch(r),i=Ce("规则名称","name","","",void 0,"必填");Reflect.set(i.props,A,e(a));let c=t.createSectionContainerItem_input(i),u=Ce("匹配网址","url","","",void 0,"必填，可正则，注意转义");Reflect.set(u.props,A,e(a.data));let d=t.createSectionContainerItem_input(u),p=Y("广告通杀1","commonFilterAdsSegmentsFilePathLength",true,void 0,"使用文件名称长度比较");Reflect.set(p.props,A,e(a.data));let h=t.createSectionContainerItem_switch(p),m=Y("广告通杀2","commonFilterAdsSegmentsFilePathSimilar",false,void 0,"使用文件名称相似度比较");Reflect.set(m.props,A,e(a.data));let V=t.createSectionContainerItem_switch(m),E=Ge("自定义过滤js","ownFilterCode","","",void 0,`参数：
...
return m3u8Text;
`);Reflect.set(E.props,A,e(a.data));let F=t.createSectionContainerItem_textarea(E);return s.appendChild(l),s.appendChild(c),s.appendChild(d),s.appendChild(h),s.appendChild(V),s.appendChild(F),s},onsubmit:(a,o,s)=>{let r=a.querySelectorAll(".rule-form-ulist > li"),l=this.getTemplateData();return o&&(l.uuid=s.uuid),r.forEach(i=>{let c=Reflect.get(i,t.$data.nodeStoreConfigKey),u=Reflect.get(c,"attributes"),d=Reflect.get(i,A),p=Reflect.get(u,j),h=Reflect.get(u,W),m=d.get(p,h);Reflect.has(l,p)?Reflect.set(l,p,m):Reflect.has(l.data,p)?Reflect.set(l.data,p,m):v.error(`${p}不在数据中`);}),l.name.trim()===""?(w.error("规则名称不能为空"),{success:false,data:l}):l.data.url.trim()===""?(w.error("匹配网址不能为空"),{success:false,data:l}):o?{success:this.updateData(l),data:l}:{success:this.addData(l),data:l}},style:`
            ...
            `}),n=e.$shadowRoot.querySelector(".btn-control[data-mode='local']"),a=e.$shadowRoot.querySelector(".btn-control[data-mode='network']"),o=e.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),s=l=>{let i=this.getData(),c=[];for(let u=0;u<l.length;u++){const d=l[u];i.findIndex(h=>h.uuid===d.uuid)!==-1||c.push(d);}i=i.concat(c),this.setData(i),w.success(`共 ${l.length} 条规则，新增 ${c.length} 条`),t?.();},r=l=>new Promise(i=>{let c=y.toJSON(l);if(!Array.isArray(c)){v.error(c),w.error("导入失败，格式不符合（不是数组）",{consoleLogContent:true}),i(false);return}if(!c.length){w.error("导入失败，解析出的数据为空",{consoleLogContent:true}),i(false);return}s(c),i(true);});f.on(n,"click",l=>{f.preventEvent(l),e.close();let i=f.createElement("input",{type:"file",accept:".json"});f.on(i,["propertychange","input"],c=>{if(!i.files?.length)return;let u=i.files[0],d=new FileReader;d.onload=()=>{r(d.result);},d.readAsText(u,"UTF-8");}),i.click();}),f.on(a,"click",l=>{f.preventEvent(l),e.close();let i=S.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(d,p){d.close();}},ok:{text:"导入",callback:async(d,p)=>{let h=d.text;if(y.isNull(h)){w.error("请填入完整的url");return}let m=w.loading("正在获取配置..."),V=await se.get(h,{allowInterceptConfig:false});if(m.close(),!V.status){v.error(V),w.error("获取配置失败",{consoleLogContent:true});return}await r(V.data.responseText)&&d.close();}},cancel:{enable:false}},mask:{enable:true},drag:true,width:O.info.width,height:"auto"}),c=i.$shadowRoot.querySelector("input"),u=i.$shadowRoot.querySelector(".pops-prompt-btn-ok");f.on(c,["input","propertychange"],d=>{f.val(c)===""?f.attr(u,"disabled","true"):f.removeAttr(u,"disabled");}),f.listenKeyboard(c,"keydown",(d,p,h)=>{d==="Enter"&&h.length===0&&f.val(c)!==""&&f.trigger(u,"click");}),f.trigger(c,"input");}),f.on(o,"click",async l=>{f.preventEvent(l),e.close();let i=await y.getClipboardInfo();if(i.error!=null){w.error(i.error.toString());return}if(i.content.trim()===""){w.warning("获取到的剪贴板内容为空");return}await r(i.content);});}},_e=function(t,e,n,a,o,s,r){let l=[];typeof a=="function"?l=a():l=a;const i={text:t,type:"select",description:s,attributes:{},props:{},getValue(){return this.props[A].get(e,n)},callback(c,u,d){const p=u;if(v.info(`选择：${d}`),typeof o=="function"&&o(c,p,d))return;this.props[A].set(e,p);},data:l};return Reflect.set(i.attributes,j,e),Reflect.set(i.attributes,W,n),ce.initComponentsStorageApi("select",i,{get(c,u){return M.getValue(c,u)},set(c,u){M.setValue(c,u);}}),i},Be={id:"component-common",title:"通用",views:[{text:"Toast配置",type:"container",views:[_e("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(t,e,n)=>{v.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),_e("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),Y("逆序弹出","qmsg-config-showreverse",false,void 0,"修改Toast弹出的顺序")]},{text:"Cookie配置",type:"container",views:[Y("启用","httpx-use-cookie-enable",false,void 0,"启用后，将根据下面的配置进行添加cookie"),Y("使用document.cookie","httpx-use-document-cookie",false,void 0,"自动根据请求的域名来设置对应的cookie")]}]};le.addContentConfig([Be]);$e.deleteMenuOption();M.init();he.init();

...
const userConfig = await GenerateUserConfig({
  ...
  monkeyOption: {
    userscript: {
      ...
      // 脚本描述
      description:
        "识别网页中显示的网盘链接，目前支持的网盘如：百度网盘、蓝奏云、天翼云、中国移动云盘(原:和彩云)、阿里云盘、文叔叔、123盘、腾讯微云、迅雷网盘、115网盘、夸克网盘、城通网盘(部分)、坚果云、UC网盘、BT磁力、360云盘、小飞机网盘，页面动态监控加载的链接，可添加自定义规则来识别小众网盘/网赚网盘或者其它链接。",
      // 脚本图标
      ...
      match: ["*://*/*"], // 脚本运行域
      // 脚本运行排除域
      exclude: ["*://*.cloudflare.com/*", "*://live.douyin.com/*", "*://video.qq.com/*"],
      // 引用库

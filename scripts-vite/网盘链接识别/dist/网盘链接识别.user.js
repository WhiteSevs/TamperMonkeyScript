...
// @require      https://fastly.jsdelivr.net/npm/@whitesev/pops@1.6.0/dist/index.umd.js
// @connect      *
// @connect      lanzoub.com
// @connect      lanzouc.com
// @connect      lanzoue.com
...
密码：{#accessCode#}`,
  ...
  const UISelectMultiple = function(text, key, defaultValue, data, callback, description) {
    let selectData = [];
    if (typeof data === "function") {
      selectData = data();
    } else {

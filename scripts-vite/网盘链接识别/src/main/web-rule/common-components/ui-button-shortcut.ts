...
import { log } from "@/env";
import { UserWebRuleUIButton } from "./ui-button";
import { ATTRIBUTE_INIT } from "@/setting/config";
 ...
 * )
 */
export const UserWebRuleUIButtonShortCut = function (
	text: string,
	...
	let result = UserWebRuleUIButton(
		text,
		description,
		getButtonText,
		"keyboard",

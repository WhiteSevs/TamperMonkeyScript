        ...
        ok: {
          callback: (event) => {
            ...
            let currentItemElement =
              NetDiskView.$el.$linkView?.$shadowRoot?.querySelector<HTMLElement>(currentItemSelector);
            let currentHistoryItemElement =
              NetDiskView.$el.$historyView?.$shadowRoot?.querySelector<HTMLElement>(currentHistoryItemSelector);

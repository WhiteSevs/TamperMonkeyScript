...
(function (S, Y, A, P) {
  ...
  var H=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,M=typeof GM_getValue<"u"?GM_getValue:void 0,_=typeof GM_info<"u"?GM_info:void 0,Z=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,R=typeof GM_setValue<"u"?GM_setValue:void 0,Q=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,J=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,p=typeof unsafeWindow<"u"?unsafeWindow:void 0,X=window;const ee="CSDN优化",u=A.noConflict(),C=Y.noConflict(),V=P,o=new u.Log(_,p.console||X.console);var I;const E=((I=_==null?void 0:_.script)==null?void 0:I.name)||ee,U=!1;o.config({debug:U,logMaxCount:1e3,autoClearConsole:!0,tag:!0});S.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return i.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return i.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return i.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let e=A.getMaxZIndex(),t=P.config.InstanceUtils.getPopsMaxZIndex(e).zIndex;return A.getMaxValue(e,t)+100}}}));const q=new u.GM_Menu({GM_getValue:M,GM_setValue:R,GM_registerMenuCommand:Z,GM_unregisterMenuCommand:Q}),j=new u.Httpx(J);j.interceptors.response.use(void 0,e=>(o.error(["拦截器-请求错误",e]),e.type==="onabort"?S.warning("请求取消"):e.type==="onerror"?S.error("请求异常"):e.type==="ontimeout"?S.error("请求超时"):S.error("其它错误"),e));j.config({logDetails:U});p.Object.defineProperty,p.Function.prototype.apply,p.Function.prototype.call,p.Element.prototype.appendChild,p.setTimeout;const h=u.addStyle,v="GM_Panel",k="data-key",B="data-default-value",g={isHuaWeiCloudBlog(){return !!/huaweicloud.csdn.net/i.test(window.location.origin)},isBlog(){return !!/blog.csdn.net/i.test(window.location.origin)},isWenKu(){return !!/wenku.csdn.net/i.test(window.location.origin)},isLink(){return window.location.hostname==="link.csdn.net"},isSo(){return window.location.hostname==="so.csdn.net"},isSoCKnow(){return this.isSo()&&(window.location.pathname.startsWith("/chat")||window.location.pathname.startsWith("/so/ai"))},isDownload(){return window.location.hostname==="download.csdn.net"}},N=function(e,t,n,a,l,s,c,f){let x={text:e,type:"slider",description:f,attributes:{},getValue(){return i.getValue(t,n)},getToolTipContent(m){return typeof c=="function"?c(m):`${m}`},callback(m,w){typeof s=="function"&&s(m,w)||i.setValue(t,w);},min:a,max:l};return x.attributes&&(x.attributes[k]=t,x.attributes[B]=n),x},r=function(e,t,n,a,l){let s={text:e,type:"switch",description:l,attributes:{},getValue(){return !!i.getValue(t,n)},callback(c,f){o.success(`${f?"开启":"关闭"} ${e}`),!(typeof a=="function"&&a(c,f))&&i.setValue(t,!!f);},afterAddToUListCallBack:void 0};return s.attributes&&(s.attributes[k]=t,s.attributes[B]=!!n),s},te={id:"panel-blog",title:"博客",isDefault(){return g.isBlog()},forms:[{text:"",type:"forms",forms:[{text:"全局屏蔽",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("【屏蔽】登录弹窗","csdn-blog-shieldLoginDialog",!0),r("【屏蔽】左侧博客信息","csdn-blog-shieldLeftBlogContainerAside",!1),r("【屏蔽】右侧目录信息","csdn-blog-shieldRightDirectoryInformation",!1),r("【屏蔽】顶部工具栏","csdn-blog-shieldTopToolbar",!1),r("【屏蔽】底部的悬浮工具栏","csdn-blog-shieldBottomFloatingToolbar",!1)]}]},{text:"右侧悬浮工具栏",type:"deepMenu",forms:[{text:"功能",type:"forms",forms:[r("启用","csdn-blog-rightToolbarEnable",!0,void 0,"创作中心，隐藏/显示侧栏，新手引导，客服、举报..."),r("【添加按钮】前往评论","csdn-blog-addGotoRecommandButton",!0,void 0,"在悬浮工具栏最后面添加"),N("right偏移","csdn-blog-rightToolbarRightOffset",90,0,document.documentElement.clientWidth,(e,t)=>{let n=document.querySelector(".csdn-side-toolbar");C.css(n,{right:t+"px"});},e=>`当前：${e}px，默认：90px`),N("top偏移","csdn-blog-rightToolbarTopOffset",140,0,document.documentElement.clientHeight,(e,t)=>{let n=document.querySelector(".csdn-side-toolbar");C.css(n,{top:t+"px"});},e=>`当前：${e}px，默认：90px`)]},{text:"屏蔽",type:"forms",forms:[r("【屏蔽】创作中心","csdn-blog-rightToolbarCreativeCenter",!1),r("【屏蔽】显示/隐藏侧栏","csdn-blog-rightToolbarShowOrSidebar",!1),r("【屏蔽】新手引导","csdn-blog-rightToolbarBeginnerGuidance",!1),r("【屏蔽】客服","csdn-blog-rightToolbarCustomerService",!1),r("【屏蔽】举报","csdn-blog-rightToolbarReport",!1),r("【屏蔽】返回顶部","csdn-blog-rightToolbarBackToTop",!1)]}]},{text:"内容",type:"deepMenu",forms:[{text:"功能",type:"forms",forms:[r("点击代码块自动展开","csdn-blog-clickPreCodeAutomatically",!0,void 0,"当鼠标点击代码块区域时，将自动展开内容"),r("自动展开代码块","csdn-blog-autoExpandCodeContent",!0,void 0,"懒人操作，免手动点击展开"),r("自动展开内容","csdn-blog-autoExpandContent",!0,void 0,"懒人操作，免手动点击展开"),r("全文居中","csdn-blog-articleCenter",!0,function(e,t){t&&alert("为了更好的呈现效果，请开启功能：【屏蔽】左侧博客信息、【屏蔽】右侧目录信息");},"自动屏蔽左侧和右侧的信息，且将文章居中"),r("允许选择内容","csdn-blog-allowSelectContent",!0,void 0)]},{text:"屏蔽",type:"forms",forms:[r("【屏蔽】底部xx技能树","csdn-blog-shieldBottomSkillTree",!1),r("【屏蔽】选中文字悬浮栏","csdn-blog-shieldArticleSearchTip",!1,void 0,"选中文字弹出的，例如：搜索、评论、笔记")]}]},{text:"评论区",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("启用","csdn-blog-blockComment",!0,void 0,"关闭是屏蔽评论区"),r("优化评论区的位置","csdn-blog-restoreComments",!0)]}]},{text:"底部文章",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("启用","csdn-blog-bottomRecommendArticleEnable",!0,void 0,"关闭是屏蔽底部文章"),r("标识CSDN下载","csdn-blog-identityCSDNDownload",!0,void 0,"使用红框标识"),r("移除资源下载的文章","csdn-blog-removeResourceDownloadArticle",!1,void 0,"移除download.csdn.net、www.iteye.com、edu.csdn.net的文章链接")]}]},{text:"劫持/拦截",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("拦截-复制的小尾巴","csdn-blog-removeClipboardHijacking",!0),r("劫持-禁止复制","csdn-blog-unBlockCopy",!0,void 0,"允许点击复制按钮进行复制")]}]}]}]},ne={id:"panel-link",title:"链接",isDefault(){return g.isLink()},forms:[{text:"功能",type:"forms",forms:[r("重定向链接","csdn-link-jumpRedirect",!0,void 0,"自动跳转至被拦截的Url链接")]}]},oe={id:"panel-hua-wei-cloud",title:"华为云开发者联盟",isDefault(){return g.isHuaWeiCloudBlog()},forms:[{text:"功能",type:"forms",forms:[r("自动展开全文","csdn-hua-wei-cloud-autoExpandContent",!0)]},{text:"屏蔽",type:"forms",forms:[r("【屏蔽】云开发者任务挑战活动","csdn-hua-wei-cloud-shieldCloudDeveloperTaskChallengeEvent",!0),r("【屏蔽】左侧悬浮按钮","csdn-hua-wei-cloud-shieldLeftFloatingButton",!1,function(e,t){t&&alert("开启后将屏蔽【当前阅读量】、【点赞按钮】、【评论按钮】、【分享按钮】");}),r("【屏蔽】右侧栏","csdn-hua-wei-cloud-blockRightColumn",!1,function(e,t){t&&alert("开启后将屏蔽【相关产品】-【活动日历】-【运营活动】-【热门标签】");}),r("【屏蔽】底部推荐内容","csdn-hua-wei-cloud-blockRecommendedContentAtTheBottom",!1),r("【屏蔽】底部更多推荐","csdn-hua-wei-cloud-shieldTheBottomForMoreRecommendations",!1)]}]},ie={id:"panel-wenku",title:"资源",isDefault(){return g.isLink()},forms:[{text:"屏蔽",type:"forms",forms:[r("【屏蔽】资源推荐","csdn-wenku-shieldResourceRecommend",!1),r("【屏蔽】右侧用户信息","csdn-wenku-shieldRightUserInfo",!1),r("【屏蔽】右侧悬浮工具栏","csdn-wenku-shieldRightToolBar",!1)]}]},re={id:"panel-so",title:"搜索",isDefault(){return g.isSo()},forms:[{text:"C知道-功能",type:"forms",forms:[r("去除水印","csdn-so-cknow-removeMaskCover",!0)]}]},le={id:"m-panel-blog",title:"博客",isDefault(){return g.isBlog()},forms:[{text:"",type:"forms",forms:[{text:"全局屏蔽",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("【屏蔽】广告","m-csdn-blog-removeAds",!0,void 0,"包括：登录弹窗、打开APP、ios版本提示等"),r("【屏蔽】顶部Toolbar","m-csdn-blog-shieldTopToolbar",!1)]}]},{text:"内容",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("允许选中文字","m-csdn-blog-allowSelectText",!0,void 0,"设置user-select: text;"),r("自动展开","m-csdn-blog-autoExpandContent",!0,void 0,"包括内容、代码块"),r("不限制代码块的最大高度","m-csdn-blog-notLimitCodePreMaxHeight",!1,void 0,"让代码块的高度直接被撑开")]}]},{text:"评论",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("启用","m-csdn-blog-comment-enable",!0,void 0,"关闭是屏蔽评论区"),r("不限制评论区的最大高度","m-csdn-blog-notLimitCommentMaxHeight",!0,void 0,"让评论区高度直接被撑开")]}]},{text:"底部文章",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("启用","m-csdn-blog-bottomArticleEnable",!0,void 0,"关闭是屏蔽底部文章"),r("移除资源下载","m-csdn-blog-removeResourceArticle",!1,void 0,"移除download.csdn.net、www.iteye.com、edu.csdn.net的文章链接"),r("重构","m-csdn-blog-refactoringRecommendation",!0,void 0,"文章的样式统一"),r("新标签页打开","m-csdn-blog-openNewTab",!0,void 0,"新标签页打开文章")]}]},{text:"劫持/拦截",type:"deepMenu",forms:[{text:"",type:"forms",forms:[r("劫持-禁止复制","m-csdn-blog-unBlockCopy",!0,void 0,"允许点击复制按钮进行复制")]}]}]}]},ae={id:"m-panel-link",title:"链接",isDefault(){return g.isLink()},forms:[{text:"功能",type:"forms",forms:[r("重定向链接","m-csdn-link-jumpRedirect",!0,void 0,"自动跳转至被拦截的Url链接")]}]},se={id:"panel-so",title:"搜索",isDefault(){return g.isSo()},forms:[{text:"C知道-功能",type:"forms",forms:[r("去除水印","m-csdn-so-cknow-removeMaskCover",!0)]}]},de={id:"m-panel-wenku",title:"文库",isDefault(){return g.isWenKu()},forms:[{text:"屏蔽",type:"forms",forms:[r("【屏蔽】底部工具栏","m-csdn-wenku-shieldBottomToolbar",!1)]}]},ce={id:"m-panel-hua-wei-cloud",title:"华为云开发者联盟",isDefault(){return g.isHuaWeiCloudBlog()},forms:[{text:"功能",type:"forms",forms:[r("自动展开全文","m-csdn-hua-wei-cloud-autoExpandContent",!0)]}]},ue={id:"m-panel-download",title:"资源",isDefault(){return g.isDownload()},forms:[{text:"功能",type:"forms",forms:[r("自动展开资源介绍","m-csdn-download-automaticallyExpandResourceIntroduction",!0,void 0,"屏蔽资源介绍【展开全部】按钮并展开资源介绍")]},{text:"屏蔽",type:"forms",forms:[r("【屏蔽】广告","m-csdn-download-removeAds",!0,void 0,"包括：登录弹窗、会员降价等")]}]},D=function(e,t,n,a,l,s){let c=[];typeof a=="function"?c=a():c=a;let f={text:e,type:"select",description:s,attributes:{},getValue(){return i.getValue(t,n)},callback(x,m,w){i.setValue(t,m),typeof l=="function"&&l(x,m,w);},data:c};return f.attributes&&(f.attributes[k]=t,f.attributes[B]=n),f},me={id:"component-common",title:"通用",forms:[{text:"Toast配置",type:"forms",forms:[D("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,n)=>{o.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),D("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),r("逆序弹出","qmsg-config-showreverse",!1,void 0,"修改Toast弹出的顺序")]}]},he={id:"component-common",title:"通用",forms:[{text:"Toast配置",type:"forms",forms:[D("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,n)=>{o.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),D("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),r("逆序弹出","qmsg-config-showreverse",!1,void 0,"修改Toast弹出的顺序")]}]},b={data:null,oneSuccessExecMenu:null,onceExec:null,listenData:null},i={$data:{get data(){return b.data==null&&(b.data=new u.Dictionary),b.data},get oneSuccessExecMenu(){return b.oneSuccessExecMenu==null&&(b.oneSuccessExecMenu=new u.Dictionary),b.oneSuccessExecMenu},get onceExec(){return b.onceExec==null&&(b.onceExec=new u.Dictionary),b.onceExec},get scriptName(){return E},key:v,attributeKeyName:k,attributeDefaultValueName:B},$listener:{get listenData(){return b.listenData==null&&(b.listenData=new u.Dictionary),b.listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},initExtensionsMenu(){p.top===p.self&&q.add([{key:"show_pops_panel_setting",text:"⚙ PC端设置",autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showPanel();}},{key:"m_show_pops_panel_setting",text:"⚙ 移动端端设置",autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showMPanel();}},{key:"gotoCSDNCKnow",text:"⚙ 前往C知道",isStoreValue:!1,autoReload:!1,showText(e){return e},callback(){window.open("https://so.csdn.net/chat","_blank");}}]);},initPanelDefaultValue(){let e=this;function t(l){if(!l.attributes)return;let s=l.attributes[k],c=l.attributes[B];if(s==null){o.warn(["请先配置键",l]);return}e.$data.data.has(s)&&o.warn("请检查该key(已存在): "+s),e.$data.data.set(s,c);}function n(l){for(let s=0;s<l.length;s++){let c=l[s];t(c);let f=c.forms;f&&Array.isArray(f)&&n(f);}}let a=this.getPanelContentConfig().concat(this.getMPanelContentConfig());for(let l=0;l<a.length;l++){let s=a[l];if(!s.forms)continue;let c=s.forms;c&&Array.isArray(c)&&n(c);}},setValue(e,t){let n=M(v,{}),a=n[e];n[e]=t,R(v,n),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,a,t);},hasKey(e){let t=M(v,{});return e in t},getValue(e,t){let a=M(v,{})[e];return a??(this.$data.data.has(e)?this.$data.data.get(e):t)},deleteValue(e){let t=M(v,{}),n=t[e];Reflect.deleteProperty(t,e),R(v,t),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,n,void 0);},addValueChangeListener(e,t){let n=Math.random();return this.$listener.listenData.set(e,{id:n,key:e,callback:t}),n},removeValueChangeListener(e){let t=null;for(const[n,a]of this.$listener.listenData.entries())if(a.id===e){t=n;break}typeof t=="string"?this.$listener.listenData.delete(t):console.warn("没有找到对应的监听器");},execMenu(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){o.warn(`${e} 键不存在`);return}let n=i.getValue(e);n&&t(n);},execMenuOnce(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){o.warn(`${e} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(e))return;this.$data.oneSuccessExecMenu.set(e,1);let n=[],a=c=>{let f=i.getValue(e);l(f,c);},l=(c,f)=>{let x=[];if(c){let m=f??t(c,a);m instanceof HTMLStyleElement?x=[m]:Array.isArray(m)&&(x=[...m.filter(w=>w!=null&&w instanceof HTMLStyleElement)]);}for(let m=0;m<n.length;m++)n[m].remove(),n.splice(m,1),m--;n=[...x];};this.addValueChangeListener(e,(c,f,x)=>{l(x);});let s=i.getValue(e);s&&l(s);},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(e)||(t(),this.$data.onceExec.set(e,1));},showPanel(){V.panel({title:{text:`${E}-PC端设置`,position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0});},showMPanel(){V.panel({title:{text:`${E}-移动端设置`,position:"center",html:!1,style:""},content:this.getMPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0});},isMobile(){return window.outerWidth<550},getWidth(){return window.outerWidth<800?"92vw":"800px"},getHeight(){return window.outerHeight>450?"80vh":"450px"},getPanelContentConfig(){return [me,te,ne,oe,ie,re]},getMPanelContentConfig(){return [he,le,ae,ce,de,se,ue]}},fe=`/* 底部免费抽xxx奖品广告 */\r
div.siderbar-box,\r
/* 华为开发者联盟加入社区 */\r
div.user-desc.user-desc-fix {\r
  display: none !important;\r
}\r
`,d={waitForElementToRemove(e=""){u.waitNodeList(e).then(t=>{t.forEach(n=>n.remove());});},addBlockCSS(...e){let t=[];e.length!==0&&(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""||(e.forEach(n=>{Array.isArray(n)?t=t.concat(n):t.push(n);}),h(`${t.join(`,
`)}{display: none !important;}`)));}},W={init(){h(fe),i.execMenu("csdn-hua-wei-cloud-shieldCloudDeveloperTaskChallengeEvent",()=>{this.shieldCloudDeveloperTaskChallengeEvent();}),i.execMenu("csdn-hua-wei-cloud-autoExpandContent",()=>{this.autoExpandContent();}),i.execMenu("csdn-hua-wei-cloud-shieldLeftFloatingButton",()=>{this.shieldLeftFloatingButton();}),i.execMenu("csdn-hua-wei-cloud-blockRightColumn",()=>{this.blockRightColumn();}),i.execMenu("csdn-hua-wei-cloud-blockRecommendedContentAtTheBottom",()=>{this.blockRecommendedContentAtTheBottom();}),i.execMenu("csdn-hua-wei-cloud-shieldTheBottomForMoreRecommendations",()=>{this.shieldTheBottomForMoreRecommendations();});},autoExpandContent(){o.info("自动展开全文"),d.addBlockCSS("div.article-show-more"),h(`
        /* 自动展开全文 */
        .main-content .user-article{
            height: auto !important;
            overflow: auto !important;
        }
        `);},shieldCloudDeveloperTaskChallengeEvent(){new u.GM_Cookie().set({name:"show_join_group_index",value:1}),o.info("设置Cookie 屏蔽云开发者任务挑战活动");},shieldLeftFloatingButton(){o.info("屏蔽左侧悬浮按钮，包括当前阅读量、点赞按钮、评论按钮、分享按钮"),d.addBlockCSS("div.toolbar-wrapper.article-interact-bar");},blockRightColumn(){o.info("屏蔽右侧栏，包括相关产品-活动日历-运营活动-热门标签"),d.addBlockCSS("div.page-home-right.dp-aside-right");},blockRecommendedContentAtTheBottom(){o.info("屏蔽底部推荐内容"),d.addBlockCSS("div.recommend-card-box");},shieldTheBottomForMoreRecommendations(){o.info("屏蔽底部更多推荐"),d.addBlockCSS("div.more-article");}},pe=`.ecommend-item-box.recommend-recommend-box,\r
.login-mark,\r
...
`,be={init(){i.getValue("csdn-blog-rightToolbarEnable")||this.shieldRightToolbar(),i.execMenuOnce("csdn-blog-rightToolbarCreativeCenter",()=>{this.shieldCreativeCenter();}),i.execMenuOnce("csdn-blog-rightToolbarShowOrSidebar",()=>{this.shieldShowOrSidebar();}),i.execMenuOnce("csdn-blog-rightToolbarBeginnerGuidance",()=>{this.shieldBeginnerGuidance();}),i.execMenuOnce("csdn-blog-rightToolbarCustomerService",()=>{this.shieldCustomerService();}),i.execMenuOnce("csdn-blog-rightToolbarReport",()=>{this.shieldReport();}),i.execMenuOnce("csdn-blog-rightToolbarBackToTop",()=>{this.shieldBackToTop();}),this.initRightToolbarOffset(),C.ready(()=>{i.execMenu("csdn-blog-addGotoRecommandButton",()=>{this.addGotoRecommandButton();});});},shieldRightToolbar(){o.info("屏蔽右侧工具栏"),d.addBlockCSS("div.csdn-side-toolbar");},addGotoRecommandButton(){o.info("【添加】前往评论按钮，在返回顶部的上面");let e=document.createElement("a");e.className="option-box",e.setAttribute("data-type","gorecommand"),e.innerHTML='<span class="show-txt" style="display:flex;opacity:100;">前往<br>评论</span>',e.addEventListener("click",function(){let t=document.querySelector("#toolBarBox");if(!t.getClientRects().length){o.error("评论区处于隐藏状态");return}o.info("滚动到评论");let n=t.getBoundingClientRect().top+window.scrollY,a=document.querySelector("#csdn-toolbar"),l=window.getComputedStyle(a),s=a.clientHeight-parseFloat(l.paddingTop)-parseFloat(l.paddingBottom);window.scrollTo({top:n-s-8,left:0,behavior:"smooth"});}),u.waitNode(".csdn-side-toolbar").then(()=>{let t=document.querySelector(".csdn-side-toolbar a:nth-last-child(2)");t.parentElement.insertBefore(e,t.nextSibling);});},initRightToolbarOffset(){o.info("初始化右侧工具栏的偏移（top、right）"),h(`
        .csdn-side-toolbar{
          left: unset !important;
        }
        `),u.waitNode(".csdn-side-toolbar").then(e=>{C.css(e,{top:parseInt(i.getValue("csdn-blog-rightToolbarTopOffset"))+"px",right:parseInt(i.getValue("csdn-blog-rightToolbarRightOffset"))+"px"});});},shieldCreativeCenter(){o.info("【屏蔽】创作中心"),d.addBlockCSS(".csdn-side-toolbar .sidetool-writeguide-box");},shieldShowOrSidebar(){o.info("【屏蔽】显示/隐藏侧栏"),d.addBlockCSS(".csdn-side-toolbar a.sidecolumn");},shieldBeginnerGuidance(){o.info("【屏蔽】新手引导"),d.addBlockCSS('.csdn-side-toolbar a.option-box[data-type="guide"]');},shieldCustomerService(){o.info("【屏蔽】客服"),d.addBlockCSS('.csdn-side-toolbar a.option-box[data-type="cs"]');},shieldReport(){o.info("【屏蔽】举报"),d.addBlockCSS('.csdn-side-toolbar a.option-box[data-type="report"]');},shieldBackToTop(){o.info("【屏蔽】返回顶部"),d.addBlockCSS('.csdn-side-toolbar a.option-box[data-type="gotop"]');}},F={init(){this.addCSS(),be.init(),i.execMenu("csdn-blog-articleCenter",()=>{this.articleCenter();}),i.execMenu("csdn-blog-shieldLoginDialog",()=>{this.shieldLoginDialog();}),i.execMenu("csdn-blog-autoExpandContent",()=>{this.autoExpandContent();}),i.execMenu("csdn-blog-autoExpandCodeContent",()=>{this.autoExpandCodeContent();}),i.getValue("csdn-blog-comment-enable")||this.blockComment(),i.getValue("csdn-blog-bottomRecommendArticleEnable")||this.shieldBottomRecommendArticle(),i.execMenu("csdn-blog-shieldBottomSkillTree",()=>{this.shieldBottomSkillTree();}),i.execMenu("csdn-blog-shieldBottomFloatingToolbar",()=>{this.shieldBottomFloatingToolbar();}),i.execMenu("csdn-blog-shieldLeftBlogContainerAside",()=>{this.shieldLeftBlogContainerAside();}),i.execMenu("csdn-blog-shieldRightDirectoryInformation",()=>{this.shieldRightDirectoryInformation();}),i.execMenu("csdn-blog-shieldTopToolbar",()=>{this.shieldTopToolbar();}),i.execMenu("csdn-blog-shieldArticleSearchTip",()=>{this.shieldArticleSearchTip();}),i.execMenu("csdn-blog-allowSelectContent",()=>{this.allowSelectContent();}),C.ready(()=>{i.execMenu("csdn-blog-removeClipboardHijacking",()=>{this.removeClipboardHijacking();}),i.execMenuOnce("csdn-blog-unBlockCopy",()=>{this.unBlockCopy();}),i.execMenu("csdn-blog-identityCSDNDownload",()=>{this.identityCSDNDownload();}),i.execMenuOnce("csdn-blog-clickPreCodeAutomatically",()=>{this.clickPreCodeAutomatically();}),i.execMenu("csdn-blog-restoreComments",()=>{this.restoreComments();});});},addCSS(){o.info("添加屏蔽CSS和功能CSS"),h(pe),h(ge);},removeClipboardHijacking(){var e;o.info("去除剪贴板劫持"),(e=document.querySelector(".article-copyright"))==null||e.remove(),p.articleType&&(p.articleType=0),p.csdn&&p.csdn.copyright&&p.csdn.copyright.textData&&(p.csdn.copyright.textData=""),p.csdn&&p.csdn.copyright&&p.csdn.copyright.htmlData&&(p.csdn.copyright.htmlData="");},unBlockCopy(){o.info("取消禁止复制"),C.on(document,"click",function(t){let n=t.target,a=n.parentElement;if(!n.classList.contains("hljs-button"))return;u.preventEvent(t);let l=(a.innerText||a.textContent||"").toString();o.info("点击复制按钮复制内容："+(l.length>8?l.substring(0,8)+"...":l)),u.setClip(l),n.setAttribute("data-title","复制成功");},{capture:!0});let e=new u.LockFunction(function(t){let n=t.target;if(n.localName!=="pre")return;let a=n.querySelector(".hljs-button");a&&a.setAttribute("data-title","复制");});C.on(document,["mouseenter","mouseleave"],function(t){e.run(t);},{capture:!0}),u.waitNode("#content_views").then(t=>{var n;p.$&&((n=p.$("#content_views"))==null||n.unbind("copy")),C.on(t,"copy",function(a){u.preventEvent(a);let l=p.getSelection(),s=l==null?void 0:l.toString();return o.info("Ctrl+C复制内容："+(s.length>8?s.substring(0,8)+"...":s)),u.setClip(s),!1},{capture:!0});}),u.waitNode(".hljs-button").then(()=>{setTimeout(()=>{document.querySelectorAll(".hljs-button").forEach(t=>{t.removeAttribute("onclick"),t.removeAttribute("data-report-click"),t.setAttribute("data-title","复制");});},250);});},clickPreCodeAutomatically(){o.info("点击代码块自动展开"),document.addEventListener("click",function(e){var n;let t=e.target;t.localName==="pre"&&(t.style.setProperty("height","auto"),(n=t.querySelector(".hide-preCode-box"))==null||n.remove());});},restoreComments(){o.info("恢复评论到正确位置-第一条评论"),u.waitNode(".first-recommend-box").then(e=>{let t=document.querySelector(".recommend-box.insert-baidu-box.recommend-box-style");t.insertBefore(e,t.firstChild);}),o.info("恢复评论到正确位置-第二条评论"),u.waitNode(".second-recommend-box").then(e=>{let t=document.querySelector(".recommend-box.insert-baidu-box.recommend-box-style");t.insertBefore(e,t.firstChild);});},identityCSDNDownload(){o.info("标识CSDN下载的链接"),document.querySelectorAll(".recommend-item-box[data-url*='https://download.csdn.net/']").forEach(e=>{i.getValue("csdn-blog-removeResourceDownloadArticle")?e.remove():e.querySelector(".content-box").style.setProperty("border","2px solid red");});},articleCenter(){o.info("全文居中"),h(xe);},shieldLoginDialog(){o.info("屏蔽登录弹窗"),d.addBlockCSS(".passport-login-container");},autoExpandCodeContent(){o.info("自动展开代码块"),d.addBlockCSS("pre.set-code-hide .hide-preCode-box"),h(`
		pre.set-code-hide{
			height: auto !important;
		}
		/* 自动展开代码块 */
        ...
        `);},autoExpandContent(){o.info("自动展开全文"),h(`
		/* 自动展开全文 */
		#article_content,
        ...
        `);},blockComment(){o.info("屏蔽评论区"),d.addBlockCSS("#pcCommentBox");},shieldBottomRecommendArticle(){o.info("屏蔽底部推荐文章"),d.addBlockCSS("main > div.recommend-box");},shieldBottomSkillTree(){o.info("屏蔽底部xx技能树"),d.addBlockCSS("#treeSkill");},shieldBottomFloatingToolbar(){o.info("屏蔽底部悬浮工具栏"),d.addBlockCSS("#toolBarBox");},shieldLeftBlogContainerAside(){o.info("【屏蔽】左侧博客信息"),d.addBlockCSS("aside.blog_container_aside");},shieldRightDirectoryInformation(){o.info("【屏蔽】右侧目录信息"),d.addBlockCSS("#rightAsideConcision","#rightAside");},shieldTopToolbar(){o.info("屏蔽顶部Toolbar"),d.addBlockCSS("#toolbarBox");},shieldArticleSearchTip(){o.info("屏蔽文章内的选中搜索悬浮提示"),d.addBlockCSS("#articleSearchTip");},allowSelectContent(){o.info("允许选择内容"),h(`
		#content_views,
		#content_views pre,
...
#chatgpt-article-detail > div.layout-center > div.main > div.article-box > div.cont.first-show.forbid > div.open {\r
  display: none !important;\r
}`,Se={init(){h(we),h(Ce),i.execMenu("csdn-wenku-shieldResourceRecommend",()=>{this.shieldResourceRecommend();}),i.execMenu("csdn-wenku-shieldRightUserInfo",()=>{this.shieldRightUserInfo();}),i.execMenu("csdn-wenku-shieldRightToolBar",()=>{this.shieldRightToolBar();});},shieldResourceRecommend(){o.info("【屏蔽】资源推荐"),d.addBlockCSS("#recommend");},shieldRightUserInfo(){o.info("【屏蔽】右侧用户信息"),d.addBlockCSS(".layout-right");},shieldRightToolBar(){o.info("【屏蔽】右侧悬浮工具栏"),d.addBlockCSS(".csdn-side-toolbar");}},O={init(){i.execMenu("csdn-link-jumpRedirect",()=>{this.jumpRedirect();});},jumpRedirect(){if(window.location.hostname==="link.csdn.net"&&window.location.search.startsWith("?target")){window.stop();let e=window.location.search.replace(/^\?target=/gi,"");e=decodeURIComponent(e);let t=e;o.success(`跳转链接 ${t}`),window.location.href=t;}}},G={init(){g.isLink()?(o.info("Router: 中转链接"),O.init()):g.isHuaWeiCloudBlog()?(o.info("Router: 华为云联盟"),W.init()):g.isBlog()?(o.info("Router: 博客"),F.init()):g.isWenKu()?(o.info("Router: 文库"),Se.init()):o.error("暂未适配，请反馈开发者："+globalThis.location.href);}},ve={init(){i.execMenu("m-csdn-link-jumpRedirect",()=>{O.jumpRedirect();});}},ye=`/* 右下角的 免费赢华为平板xxxx */\r
.org-main-content .siderbar-box {\r
  display: none !important;\r
}\r
`,Me={init(){h(ye),i.execMenu("m-csdn-hua-wei-cloud-autoExpandContent",()=>{W.autoExpandContent();});}},Te=`#operate,.feed-Sign-span,\r
.view_comment_box,\r
...
`,Be={init(){this.addCSS(),i.execMenu("m-csdn-blog-shieldTopToolbar",()=>{this.shieldTopToolbar();}),i.execMenu("m-csdn-blog-notLimitCodePreMaxHeight",()=>{this.notLimitCodePreMaxHeight();}),i.execMenu("m-csdn-blog-notLimitCommentMaxHeight",()=>{this.notLimitCommentMaxHeight();}),i.execMenu("m-csdn-blog-allowSelectText",()=>{this.allowSelectText();}),i.execMenu("m-csdn-blog-autoExpandContent",()=>{this.autoExpandContent();}),i.getValue("m-csdn-blog-bottomArticleEnable")||this.blockBottomArticle(),i.getValue("m-csdn-blog-comment-enable")||this.blockComment(),C.ready(()=>{i.execMenu("m-csdn-blog-removeAds",()=>{this.removeAds();}),i.execMenu("m-csdn-blog-refactoringRecommendation",()=>{this.refactoringRecommendation();}),i.execMenu("m-csdn-blog-unBlockCopy",()=>{F.unBlockCopy();});});},addCSS(){h(Te),h(ke);},shieldTopToolbar(){o.info("屏蔽顶部Toolbar"),d.addBlockCSS("#csdn-toolbar"),h(`
        ...
        `);},refactoringRecommendation(){function e(){o.info("重构底部推荐"),document.querySelectorAll(".container-fluid").forEach(n=>{var w,L;let a="",l="",s="",c="",f=!1,x=!1;if(n.hasAttribute("data-url")){if(a=n.getAttribute("data-url"),l=(w=n.querySelector(".recommend_title div.left"))==null?void 0:w.innerHTML,!n.querySelector(".text"))return;s=(L=n.querySelector(".text"))==null?void 0:L.innerHTML,n.querySelectorAll(".recommend-img").length&&n.querySelectorAll(".recommend-img").forEach(z=>{c+=z.innerHTML;});}else o.info("节点上无data-url"),a=n.querySelector("a[data-type]").getAttribute("href"),l=n.querySelector(".recommend_title div.left").innerHTML,s=n.querySelector(".text").innerHTML;var m=new URL(a);m.host==="download.csdn.net"||m.host==="www.iteye.com"&&m.pathname.match(/^\/resource/gi)?(o.info("该链接为csdn资源下载"),f=!0,l='<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>'+l):m.origin.match(/edu.csdn.net/gi)&&(x=!0,o.info("该链接为csdn学院下载"),l='<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>'+l),n.setAttribute("class","GM-csdn-dl"),n.setAttribute("data-url",a),n.innerHTML=`<div class="GM-csdn-title"><div class="left">${l}</div></div><div class="GM-csdn-content">${s}</div><div class="GM-csdn-img">${c}</div>`,n.addEventListener("click",function(){i.getValue("m-csdn-blog-openNewTab")?window.open(a,"_blank"):window.location.href=a;}),(f||x)&&i.getValue("m-csdn-blog-removeResourceArticle")&&n.remove();});}let t=new u.LockFunction(e,50);u.waitNode("#recommend").then(n=>{o.info("重构底部推荐"),t.run(),u.mutationObserver(n,{callback:()=>{t.run();},config:{childList:!0,subtree:!0,attributes:!0}});});},blockBottomArticle(){o.info("屏蔽底部文章"),d.addBlockCSS("#recommend");},blockComment(){o.info("屏蔽评论"),d.addBlockCSS("#comment");},removeAds(){o.info("去除广告"),d.waitForElementToRemove(".passport-login-container"),d.waitForElementToRemove(".btn_open_app_prompt_box.detail-open-removed"),d.waitForElementToRemove(".add-firstAd"),d.waitForElementToRemove("div.feed-Sign-weixin"),d.waitForElementToRemove("div.ios-shadowbox");},notLimitCodePreMaxHeight(){o.info("不限制代码块最大高度"),h(`
        pre{
            max-height: unset !important;
        }
        `);},notLimitCommentMaxHeight(){o.info("不限制评论区最大高度"),h(`
        #comment{
          max-height: none !important;
        }
      `);},allowSelectText(){o.info("允许选择文字"),h(`
        #content_views,
        #content_views pre,
        #content_views pre code{
        ...
        `);},autoExpandContent(){o.info("自动展开内容"),h(`
...
`,Re={init(){h(_e),i.execMenu("m-csdn-wenku-shieldBottomToolbar",()=>{this.shieldBottomToolbar();});},shieldBottomToolbar(){o.info("【屏蔽】底部工具栏"),d.addBlockCSS(".page-container > div.btn");}},De=`/* 右下角悬浮图标 买1年送3个月 */\r
...
`,Ee={init(){i.execMenu("m-csdn-download-removeAds",()=>{h(De);}),i.execMenuOnce("m-csdn-download-automaticallyExpandResourceIntroduction",()=>{this.automaticallyExpandResourceIntroduction();});},automaticallyExpandResourceIntroduction(){o.info("自动展开资源介绍"),d.addBlockCSS("label.unfold-font"),h(`
		.resource-desc{
			max-height: unset !important;
    		overflow: unset !important;
		}
		`);}},$={init(){g.isLink()?(o.info("Router: 中转链接"),ve.init()):g.isHuaWeiCloudBlog()?(o.info("Router: 华为云联盟"),Me.init()):g.isBlog()?(o.info("Router: 博客"),Be.init()):g.isWenKu()?(o.info("Router: 文库"),Re.init()):g.isDownload()?(o.info("Router: 资源下载"),Ee.init()):o.error("暂未适配，请反馈开发者："+globalThis.location.href);}};i.init();let K=u.isPhone(),T="change_env_set",y=M(T);q.add({key:T,text:`⚙ 自动: ${K?"移动端":"PC端"}`,autoReload:!1,isStoreValue:!1,showText(e){return y==null?e:e+` 手动: ${y==1?"移动端":y==2?"PC端":"未知"}`},callback:()=>{let e=[0,1,2],t=window.prompt(`请输入当前脚本环境判定

自动判断: 0
移动端: 1
PC端: 2`,"0");if(!t)return;let n=parseInt(t);if(isNaN(n)){S.error("输入的不是规范的数字");return}if(!e.includes(n)){S.error("输入的值必须是0或1或2");return}n==0?H(T):R(T,n);}});y!=null?(o.info(`手动判定为${y===1?"移动端":"PC端"}`),y==1?$.init():y==2?G.init():(S.error("意外，手动判定的值不在范围内"),H(T))):K?(o.info("自动判定为移动端"),$.init()):(o.info("自动判定为PC端"),G.init());

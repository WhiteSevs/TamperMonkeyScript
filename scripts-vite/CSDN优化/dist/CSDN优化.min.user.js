...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof Ce=="function"?Ce(e.keyName):null;return typeof t=="string"&&t?R(t):x.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{U.onReady(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(r=>{r.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(r=>{r.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(r){navigator.clipboard.readText().then(i=>{r(i);}).catch(i=>{o.error("读取剪贴板内容失败👉",i),r("");});}function t(r){navigator.permissions.query({name:"clipboard-read"}).then(i=>{e(r);}).catch(i=>{o.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(r);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(r=>{if(!n()){r("");return}document.hasFocus()?t(r):window.addEventListener("focus",()=>{t(r);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let r,i=n-t,l=t,c=async b=>{let p=await e(b);if(typeof p=="boolean"&&!p||b){C.workerClearTimeout(r);return}if(l+=t,l>i){c(true);return}r=C.workerSetTimeout(()=>{c(false);},t);};c(false);},findParentNode(e,t,n){if(n){let r=U.closest(e,n);if(r)return r.querySelector(t)}else return U.matches(e,t)?e:U.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(r,i)=>i===void 0?t:i,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},C=J.noConflict(),s=U.noConflict(),G=pe,o=new C.Log(te,B.console||Ie.console),me=te?.script?.name||void 0,Oe=pe.config.Utils.AnyTouch(),Ne=false;o.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});v.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?o.warn(n):t==="error"?o.error(n):o.info(n),true},get position(){return a.getValue(ee.qmsg_config_position.key,ee.qmsg_config_position.defaultValue)},get maxNums(){return a.getValue(ee.qmsg_config_maxnums.key,ee.qmsg_config_maxnums.defaultValue)},get showReverse(){return a.getValue(ee.qmsg_config_showreverse.key,ee.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=J.getMaxZIndex(),t=pe.config.InstanceUtils.getPopsMaxZIndex().zIndex;return J.getMaxValue(e,t)+100}});G.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=J.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),t=pe.config.InstanceUtils.getPopsMaxZIndex().zIndex;return J.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Me=new C.GM_Menu({GM_getValue:re,GM_setValue:he,GM_registerMenuCommand:De,GM_unregisterMenuCommand:Ve}),K=new C.Httpx({xmlHttpRequest:Le,logDetails:Ne});K.interceptors.request.use(e=>e);K.interceptors.response.use(void 0,e=>(o.error("拦截器-请求错误",e),e.type==="onabort"?v.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?v.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?v.error("请求超时",{consoleLogContent:true}):v.error("其它错误",{consoleLogContent:true}),e));B.Object.defineProperty,B.Function.prototype.apply,B.Function.prototype.call,B.Element.prototype.appendChild,B.setTimeout;const R=s.addStyle.bind(s),Te=U.selector.bind(U),Fe=U.selectorAll.bind(U);new C.GM_Cookie;const de="GM_Panel",qe="data-init",ie="data-key",ae="data-default-value",Ue="data-init-more-value",Pe="data-plugin-search-config",Z="data-storage-api",W={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},P={setting:{get width(){return W.width<550?"88vw":W.width<700?"550px":"700px"},get height(){return W.height<450?"70vh":W.height<550?"450px":"550px"}},settingMiddle:{get width(){return W.width<350?"88vw":"350px"}},info:{get width(){return W.width<350?"88vw":"350px"},get height(){return W.height<250?"88vh":"250px"}}},Y={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new C.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(l,c)=>{typeof c!="string"&&(c=x.toStr(c));const b=new Blob([c]),p=globalThis.URL.createObjectURL(b);s.createElement("a",{href:p,download:l}).click(),C.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(p);},500);},r=()=>{const l=y=>{const m=G.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector("textarea"),d={};if(typeof le=="function")le().forEach(m=>{const S=re(m);Reflect.set(d,m,S);});else {v.warning("不支持函数GM_listValues，仅导出菜单配置");const y=re(de);Reflect.set(d,de,y);}const h=x.toStr(d);p.value=h;},i=()=>{let l=te?.script?.supportURL||te?.script?.namespace;typeof l=="string"&&C.isNotNull(l)&&window.open(l,"_blank");};return [{id:"script-version",title:`版本：${te?.script?.version||"未知"}`,isBottom:true,views:[],clickFirstCallback(){return  false},afterRender(l){new Oe(l.$asideLiElement).on("tap",function(b){clearTimeout(t),t=void 0,e?(e=false,r()):(t=setTimeout(()=>{e=false,i();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},ge={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{a.showPanel(Y.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){a.isTopWindow()&&Me.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let n=this.$data.menuOption.findIndex(r=>r.key===t.key);n!==-1&&(this.$data.menuOption[n]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}};class Ge{storageKey;listenerData;constructor(t){if(typeof t=="string"){const n=t.trim();if(n=="")throw new Error("key参数不能为空字符串");this.storageKey=n;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new J.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.emitValueChangeListener=this.emitValueChangeListener.bind(this);}getLocalValue(){let t=re(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){he(this.storageKey,t);}set(t,n){const r=this.get(t),i=this.getLocalValue();Reflect.set(i,t,n),this.setLocalValue(i),this.emitValueChangeListener(t,n,r);}get(t,n){const r=this.getLocalValue();return Reflect.get(r,t)??n}getAll(){return this.getLocalValue()}delete(t){const n=this.get(t),r=this.getLocalValue();Reflect.deleteProperty(r,t),this.setLocalValue(r),this.emitValueChangeListener(t,void 0,n);}has(t){const n=this.getLocalValue();return Reflect.has(n,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(n=>Reflect.get(t,n))}clear(){oe(this.storageKey);}addValueChangeListener(t,n){const r=Math.random(),i=this.listenerData.get(t)||[];return i.push({id:r,key:t,callback:n}),this.listenerData.set(t,i),r}removeValueChangeListener(t){let n=false;for(const[r,i]of this.listenerData.entries()){for(let l=0;l<i.length;l++){const c=i[l];(typeof t=="string"&&c.key===t||typeof t=="number"&&c.id===t)&&(i.splice(l,1),l--,n=true);}this.listenerData.set(r,i);}return n}async emitValueChangeListener(...t){const[n,r,i]=t;if(!this.listenerData.has(n))return;let l=this.listenerData.get(n);for(let c=0;c<l.length;c++){const b=l[c];if(typeof b.callback=="function"){let p=this.get(n),d,h;typeof i<"u"&&t.length>=2?h=i:h=p,typeof r<"u"&&t.length>2?d=r:d=p,await b.callback(n,d,h);}}}}const j=new Ge(de),a={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new C.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new C.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new C.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new C.Dictionary),this.__onceExecData},get scriptName(){return me},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:de,attributeKeyName:ie,attributeDefaultValueName:ae},init(){this.initContentDefaultValue(),ge.init();},isTopWindow(){return B.top===B.self},initContentDefaultValue(){const e=r=>{if(!r.attributes||r.type==="button"||r.type==="container"||r.type==="deepMenu")return;const i=r.attributes;let l=i[qe];if(typeof l=="function"){let d=l();if(typeof d=="boolean"&&!d)return}let c=new Map,b=i[ie];if(b!=null){const d=i[ae];c.set(b,d);}let p=i[Ue];if(typeof p=="object"&&p&&Object.keys(p).forEach(d=>{const h=p[d];c.set(d,h);}),!c.size){o.warn(["请先配置键",r]);return}if(r.type==="switch"){let d=typeof r.disabled=="function"?r.disabled():r.disabled;typeof d=="boolean"&&d&&this.$data.contentConfigInitDisabledKeys.push(...c.keys());}for(const[d,h]of c.entries())this.setDefaultValue(d,h);},t=r=>{for(let i=0;i<r.length;i++){let l=r[i];e(l);let c=l.views;c&&Array.isArray(c)&&t(c);}},n=[...Y.getAllContentConfig()];for(let r=0;r<n.length;r++){let i=n[r];if(!i.views)continue;const l=i.views;l&&Array.isArray(l)&&t(l);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&o.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){j.set(e,t);},getValue(e,t){const n=j.get(e);return n??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){j.delete(e);},hasKey(e){return j.has(e)},addValueChangeListener(e,t){return j.addValueChangeListener(e,t)},removeValueChangeListener(e){j.removeValueChangeListener(e);},emitMenuValueChange(e,t,n){j.emitValueChangeListener(e,t,n);},async exec(e,t,n,r=true){const i=this;let l;typeof e=="string"||Array.isArray(e)?l=()=>e:l=e;let c=false;const b=l();let p=[];Array.isArray(b)?(c=true,p=b):p.push(b);const d=p.find(f=>!this.$data.contentConfigInitDefaultValue.has(f));if(d){o.warn(`${d} 键不存在`);return}const h=JSON.stringify(p);if(r&&this.$data.onceExecMenuData.has(h))return this.$data.onceExecMenuData.get(h);let y=[];const m=[];let S=[];const A=(f,g)=>{let D=[],V=[],w=[];if(Array.isArray(g))w=w.concat(g);else {const T=k=>{if(typeof k=="object"&&k!=null)if(k instanceof Element)w.push(k);else {const{$css:F,destory:O}=k;F!=null&&(Array.isArray(F)?w=w.concat(F):w.push(F)),typeof O=="function"&&w.push(O);}else w.push(k);};if(g!=null&&Array.isArray(g))for(const k of g)T(k);else T(g);}for(const T of w)if(T!=null){if(T instanceof Element){D.push(T);continue}if(typeof T=="function"){S.push(T);continue}}f?(y=y.concat(D),S=S.concat(V)):(L(),N());},I=f=>!!this.getValue(f),L=()=>{for(let f=0;f<y.length;f++)y[f]?.remove(),y.splice(f,1),f--;},N=()=>{for(let f=0;f<S.length;f++){const g=S[f];g(),S.splice(f,1),f--;}},E=()=>{let f=false;return typeof n=="function"?f=n(p):f=p.every(g=>I(g)),f},_=async f=>{if(E()){const D=p.map(w=>this.getValue(w)),V=await t({value:c?D:D[0],addStoreValue:(...w)=>A(true,w)});A(true,V);}else A(false,[]);};r&&p.forEach(f=>{const g=this.addValueChangeListener(f,(D,V,w)=>_());m.push(g);}),await _();const M={reload(){this.clearStoreStyleElements(),this.destory(),_();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>L(),destory(){return N()},removeValueChangeListener:()=>{m.forEach(f=>{this.removeValueChangeListener(f);});},clearOnceExecMenuData(){r&&i.$data.onceExecMenuData.delete(h);}};return this.$data.onceExecMenuData.set(h,M),M},async execMenu(e,t,n=false,r=false){return await this.exec(e,async i=>await t(i),i=>i.every(c=>{let b=!!this.getValue(c);return a.$data.contentConfigInitDisabledKeys.includes(c)&&(b=false,o.warn(`.execMenu${r?"Once":""} ${c} 被禁用`)),n&&(b=!b),b}),r)},async execMenuOnce(e,t,n=false,r=false){const i=await this.execMenu(e,t,n,true);if(r&&i){const l=()=>{i.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,l);}return i},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),j.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async emitUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const n of t)await n(e);},showPanel(e,t=`${me}-设置`,n=false,r=false){this.$data.$panel=null,this.$data.panelContent=[];let i=e.findIndex(c=>(typeof c.isBottom=="function"?c.isBottom():!!c.isBottom)&&c.id==="script-version")!==-1;!n&&!i&&e.push(...Y.getDefaultBottomContentConfig());let l=G.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(c,b)=>{c.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(c,b)=>{c(),this.$data.$panel=null;}},width:P.setting.width,height:P.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=l,this.$data.panelContent=e,r||this.registerConfigSearch({$panel:l,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,r=async(m,S)=>{if(m==null)return;const A=await S(m);return A&&typeof A.isFind=="boolean"&&A.isFind?A.data:await r(A.data,S)},i=(m,S)=>{const A=new IntersectionObserver(I=>{I.forEach(L=>{L.isIntersecting&&(S?.(),A.disconnect());});},{root:null,threshold:1});A.observe(m),m.scrollIntoView({behavior:"smooth",block:"center"});},l=m=>{const S="pops-flashing";s.onAnimationend(m,()=>{m.classList.remove(S);}),m.classList.add(S);},c=m=>{if(m.type==="dblclick"&&y)return;s.preventEvent(m),p=null;const S=G.alert({title:{text:"搜索配置",position:"center"},content:{text:`
...
`,We={init(){a.exec("csdn-blog-rightToolbarEnable",()=>this.shieldRightToolbar(),e=>!a.getValue(e[0]),true),a.execMenuOnce("csdn-blog-rightToolbarCreativeCenter",()=>this.shieldCreativeCenter()),a.execMenuOnce("csdn-blog-rightToolbarShowOrSidebar",()=>this.shieldShowOrSidebar()),a.execMenuOnce("csdn-blog-rightToolbarBeginnerGuidance",()=>this.shieldBeginnerGuidance()),a.execMenuOnce("csdn-blog-rightToolbarCustomerService",()=>this.shieldCustomerService()),a.execMenuOnce("csdn-blog-rightToolbarReport",()=>this.shieldReport()),a.execMenuOnce("csdn-blog-rightToolbarBackToTop",()=>this.shieldBackToTop()),this.initRightToolbarOffset(),s.onReady(()=>{a.execMenuOnce("csdn-blog-addGotoRecommandButton",()=>{this.addGotoRecommandButton();});});},addGotoRecommandButton(){o.info("【添加】前往评论按钮，在返回顶部的上面");let e=document.createElement("a");e.className="option-box",e.setAttribute("data-type","gorecommand"),e.innerHTML=`
      ...
      #mainBox {
        margin-left: 0px;
      }`)),e},shieldLoginDialog(){return o.info("屏蔽登录弹窗"),x.addBlockCSS(".passport-login-container")},autoExpandCodeContent(){return o.info("自动展开代码块"),[x.addBlockCSS("pre.set-code-hide .hide-preCode-box"),R(`
			pre.set-code-hide{
				height: auto !important;
			}
			/* 自动展开代码块 */
        ...
        `)},blockComment(){return o.info("屏蔽评论区"),x.addBlockCSS("#pcCommentBox")},shieldBottomRecommendArticle(){return o.info("屏蔽底部推荐文章"),x.addBlockCSS("main > div.recommend-box")},shieldBottomSkillTree(){return o.info("屏蔽底部xx技能树"),x.addBlockCSS("#treeSkill")},shieldBottomFloatingToolbar(){return o.info("屏蔽底部悬浮工具栏"),x.addBlockCSS("#toolBarBox")},shieldLeftBlogContainerAside(){return o.info("【屏蔽】左侧博客信息"),x.addBlockCSS("aside.blog_container_aside")},shieldRightDirectoryInformation(){return o.info("【屏蔽】右侧目录信息"),x.addBlockCSS("#rightAsideConcision","#rightAside")},shieldArticleSearchTip(){return o.info("屏蔽文章内的选中搜索悬浮提示"),x.addBlockCSS("#articleSearchTip")},allowSelectContent(){return o.info("允许选择内容"),R(`
		#content_views,
		#content_views pre,
...
`,Ae={init(){a.onceExec("csdn-blog-blockCSS",()=>this.addCSS()),a.execMenuOnce("csdn-blog-shieldTopToolbar",()=>this.shieldTopToolbar()),s.onReady(()=>{a.execMenuOnce("csdn-blog-removeClipboardHijacking",()=>{this.removeClipboardHijacking();}),a.execMenuOnce("csdn-blog-unBlockCopy",()=>{this.unBlockCopy();});});},addCSS(){return o.info("添加屏蔽CSS和功能CSS"),[R(Qe),R(Ye)]},removeClipboardHijacking(){o.info("去除剪贴板劫持");let e=document.querySelector(".article-copyright");e&&e.remove(),B.articleType&&(B.articleType=0),B.csdn&&B.csdn.copyright&&B.csdn.copyright.textData&&(B.csdn.copyright.textData=""),B.csdn&&B.csdn.copyright&&B.csdn.copyright.htmlData&&(B.csdn.copyright.htmlData="");},unBlockCopy(){o.info("取消禁止复制"),s.on(document,"click",".hljs-button",function(t,n){s.preventEvent(t);let r=n,i=r.closest(".hljs")||r.closest("pre"),l=r.parentElement,c=i?.querySelector("code")||l.querySelector("code")||l,b=c.innerText;o.info("点击复制按钮复制内容："+(b.length>8?b.substring(0,8)+"...":b),c),C.copy(b),r.setAttribute("data-title","复制成功");},{capture:true});let e=new C.LockFunction(function(t){let n=t.target;if(n.localName!=="pre")return;let r=n.querySelector(".hljs-button");r&&r.setAttribute("data-title","复制");});s.on(document,["mouseenter","mouseleave"],function(t){e.run(t);},{capture:true}),s.waitNode("#content_views").then(t=>{B.$&&B.$("#content_views")?.unbind("copy"),s.on(t,"copy",function(n){s.preventEvent(n);let i=B.getSelection()?.toString();return o.info("Ctrl+C复制内容："+(i.length>8?i.substring(0,8)+"...":i)),C.copy(i),false},{capture:true});}),s.waitNode(".hljs-button").then(()=>{setTimeout(()=>{Fe(".hljs-button").forEach(t=>{t.removeAttribute("onclick"),t.removeAttribute("data-report-click"),t.setAttribute("data-title","复制");});},250);});},shieldTopToolbar(){return o.info("屏蔽顶部Toolbar"),x.addBlockCSS("#toolbarBox","#csdn-toolbar")}},Se={init(){$.isLink()?(o.info("Router: 中转链接"),Be.init()):$.isHuaWeiCloudBlog()?(o.info("Router: 华为云联盟"),Re.init()):$.isBlog()?(o.info("Router: 博客"),Ae.init(),$.isBlogArticle()&&(o.info("Router: 帖子"),Ke.init())):$.isWenKu()?(o.info("Router: 文库"),Ze.init()):o.error("暂未适配，请反馈开发者："+globalThis.location.href);}},Xe={init(){a.execMenuOnce("m-csdn-link-jumpRedirect",()=>{Be.jumpRedirect();});}},et=`/* 右下角的 免费赢华为平板xxxx */\r
.org-main-content .siderbar-box {\r
  display: none !important;\r
}\r
`,tt={init(){R(et),a.execMenuOnce("m-csdn-hua-wei-cloud-autoExpandContent",()=>Re.autoExpandContent()),a.execMenuOnce("m-csdn-hua-wei-cloud-blockBottomJoinTheCommunity",()=>this.blockBottomJoinTheCommunity());},blockBottomJoinTheCommunity(){return o.info("【屏蔽】底部加入社区"),x.addBlockCSS(".user-desc")}},se={isSuccessResponse(e){return e==null?false:(typeof e=="string"&&(e=C.toJSON(e)),e?.code===200)}},ce={async folderListWithCheck(e){const t=await K.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/folderListWithCheck",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":C.getRandomPCUA()}});o.info(t);const n=C.toJSON(t.data.responseText);if(!t.status||!se.isSuccessResponse(t.data.responseText)){o.error("获取收藏夹信息失败，请求异常"),typeof n.msg=="string"?v.error(n.msg):v.error("获取收藏夹信息失败");return}return n.data.result},async addFavoriteInFolds(e){const t=await K.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/addFavoriteInFolds",{fetch:true,data:e,headers:{"Content-Type":"application/json","User-Agent":C.getRandomPCUA()},allowInterceptConfig:false});if(o.info(t),!t.status||!se.isSuccessResponse(t.data.responseText)){o.error("添加收藏失败，请求异常",t),v.error("添加收藏失败，请求异常");return}return  true},async checkFavoriteByUrl(e){const t=await K.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/checkFavoriteByUrl",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":C.getRandomPCUA()}});if(o.info(t),!t.status||!se.isSuccessResponse(t.data.responseText)){o.error("检查收藏夹状态失败，请求异常"),v.error("检查收藏夹状态失败，请求异常");return}return C.toJSON(t.data.responseText).data},async createFolder(e){const t=await K.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/createFolder",{data:e,fetch:true,headers:{Accept:"application/json, text/javascript, */*; q=0.01","Content-Type":"application/json","User-Agent":C.getRandomPCUA()},allowInterceptConfig:false});if(o.info(t),!t.status||!se.isSuccessResponse(t.data.responseText)){v.error("创建收藏夹失败");return}return C.toJSON(t.data.responseText).data}},nt={init(){a.exec("m-csdn-blog-shieldTopToolbar",()=>this.shieldTopToolbar(),e=>!a.getValue(e[0]),true),a.execMenuOnce("m-csdn-blog-notLimitCodePreMaxHeight",()=>this.notLimitCodePreMaxHeight()),a.execMenuOnce("m-csdn-blog-notLimitCommentMaxHeight",()=>this.notLimitCommentMaxHeight()),a.execMenuOnce("m-csdn-blog-allowSelectText",()=>this.allowSelectText()),a.execMenuOnce("m-csdn-blog-autoExpandContent",()=>this.autoExpandContent()),a.exec("m-csdn-blog-bottomArticleEnable",()=>this.blockBottomArticle(),e=>!a.getValue(e[0]),true),a.exec("m-csdn-blog-comment-enable",()=>this.blockComment(),e=>!a.getValue(e[0]),true),a.exec("m-csdn-blog-bottom-toolbar-enable",()=>this.blockBottomToolBar(),e=>!a.getValue(e[0]),true),a.execMenuOnce("m-csdn-blog-bottom-toolbar-always-bottom",()=>this.bottomToolBarAlwaysShow()),s.onReady(()=>{a.execMenuOnce("m-csdn-blog-removeAds",()=>this.removeAds()),a.execMenuOnce("m-csdn-blog-refactoringRecommendation",()=>{this.refactoringRecommendation();}),a.execMenuOnce("m-csdn-blog-unBlockCopy",()=>{Ae.unBlockCopy();}),a.execMenuOnce("m-csdn-blog-bottom-toolbar-optimizationCollectButton",()=>{this.optimizationCollectButton();});});},shieldTopToolbar(){return o.info("屏蔽顶部Toolbar"),[x.addBlockCSS("#csdn-toolbar"),R(`
			/* 内容顶部要归位 */
			body #main,
			.margin_sides{
			...
			`)]},refactoringRecommendation(){function e(){document.querySelectorAll(".container-fluid").forEach(n=>{let r="",i="",l="",c="",b=false,p=false;if(n.hasAttribute("data-url")){if(r=n.getAttribute("data-url"),i=n.querySelector(".recommend_title div.left")?.innerHTML,!n.querySelector(".text"))return;l=n.querySelector(".text")?.innerHTML,n.querySelectorAll(".recommend-img").length&&n.querySelectorAll(".recommend-img").forEach(h=>{c+=h.innerHTML;});}else r=n.querySelector("a[data-type]").getAttribute("href"),i=n.querySelector(".recommend_title div.left").innerHTML,l=n.querySelector(".text").innerHTML;var d=new URL(r);d.host==="download.csdn.net"||d.host==="www.iteye.com"&&d.pathname.match(/^\/resource/gi)?(b=true,i='<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>'+i):d.origin.match(/edu.csdn.net/gi)&&(p=true,i='<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>'+i),n.setAttribute("class","GM-csdn-dl"),n.setAttribute("data-url",r),n.innerHTML=`<div class="GM-csdn-title"><div class="left">${i}</div></div><div class="GM-csdn-content">${l}</div><div class="GM-csdn-img">${c}</div>`,n.addEventListener("click",function(){a.getValue("m-csdn-blog-openNewTab")?window.open(r,"_blank"):window.location.href=r;}),(b||p)&&a.getValue("m-csdn-blog-removeResourceArticle")&&n.remove();});}let t=new C.LockFunction(e,50);s.waitNode("#recommend").then(n=>{o.info("重构底部推荐"),t.run(),C.mutationObserver(n,{callback:()=>{t.run();},config:{childList:true,subtree:true,attributes:true}});});},blockBottomArticle(){return o.info("屏蔽底部文章"),x.addBlockCSS("#recommend")},blockComment(){return o.info("屏蔽评论"),x.addBlockCSS("#comment")},removeAds(){return o.info("去除广告"),[x.waitRemove(".passport-login-container"),x.waitRemove(".btn_open_app_prompt_box.detail-open-removed"),x.waitRemove(".add-firstAd"),x.waitRemove("div.feed-Sign-weixin"),x.waitRemove("div.ios-shadowbox")]},notLimitCodePreMaxHeight(){return o.info("不限制代码块最大高度"),R(`
        pre{
            max-height: unset !important;
        }
        `)},notLimitCommentMaxHeight(){return o.info("不限制评论区最大高度"),R(`
        #comment{
          max-height: none !important;
        }
      `)},allowSelectText(){return o.info("允许选择文字"),R(`
        #content_views,
        #content_views pre,
        #content_views pre code{
        ...
        `)},autoExpandContent(){return o.info("自动展开内容"),R(`
        #content_views pre.set-code-hide,
        .article_content{
          height: 100% !important;
          overflow: auto !important;
        }
        `)},blockBottomToolBar(){return o.info("屏蔽底部工具栏"),x.addBlockCSS("#operate")},bottomToolBarAlwaysShow(){return o.info("底部工具栏常驻"),R(`
			/* 底部工具栏 */
			#operate {
				bottom: 0 !important;
			}
			`)},optimizationCollectButton(){o.info("优化收藏按钮"),s.waitNode("#operate .collect-btn",1e4).then(e=>{e&&s.on(e,"click",async t=>{s.preventEvent(t);let n=e.querySelector(".collect"),r=e.querySelector(".uncollect"),i=await ce.folderListWithCheck(window.location.origin+window.location.pathname);if(!i)return;let l=[];i.forEach(d=>{d.IsFavorite&&l.push(d.ID);});let c=d=>{let h=d.ID,y=s.createElement("li",{className:"csdn-collection-item",innerHTML:`
								...
								`},{"data-is-collect":d.IsFavorite});y.querySelector(".title-m");let m=y.querySelector(".csdn-collection-item_length");y.querySelector(".csdn-collection-controls");let S=y.querySelector(".collect-btn");return s.on(S,"click",async A=>{let I=B.articleDetailUrl;I==null&&(I=window.location.origin+window.location.pathname);let L=B.articleId;if(L==null){o.error("获取文章ID失败"),v.error("获取文章ID失败");return}let N=B.username;if(N==null){o.error("获取文章作者失败"),v.error("获取文章作者失败");return}let E=B.articleTitle;if(E==null&&(E=document.title.replace(/-CSDN博客$/,"")),E==null){o.error("获取文章标题失败"),v.error("获取文章标题失败");return}let _=B.articleDesc;if(_==null){let g=Te("meta[name='description']");g&&(_=g.getAttribute("content"));}if(_==null){o.error("获取文章描述失败"),v.error("获取文章描述失败");return}let M=[...l],f=v.loading("处理中...");try{let g=await ce.checkFavoriteByUrl(I);if(g==null)return;o.info(h,g);let D=!g[h];if(D?(o.info("添加收藏"),M.push(h)):(o.info("取消收藏"),M.splice(M.indexOf(h),1)),!await ce.addFavoriteInFolds({author:N,url:I,source:"blog",sourceId:L,title:E,description:_,fromType:"PC",username:d.Username,folderIdList:M}))return;let w=await ce.checkFavoriteByUrl(I);if(w==null)return;o.info(h,w),y.setAttribute("data-is-collect",(!!w[h]).toString()),D?w[h]?(o.success("收藏成功"),v.success("收藏成功"),s.text(S,"已收藏"),l.includes(h)||l.push(h),d.FavoriteNum++):(o.error("收藏失败",w,h),v.error("收藏失败")):w[h]?(o.error("取消收藏失败",w,h),v.error("取消收藏失败")):(o.success("取消收藏成功"),v.success("取消收藏成功"),s.text(S,"收藏"),l.includes(h)&&l.splice(l.indexOf(h),1),d.FavoriteNum--),s.text(m,`${d.FavoriteNum}条内容`),Object.values(w).find(k=>k)?(s.show(n,!1),s.hide(r,!1)):(s.show(r,!1),s.hide(n,!1)),f.close();}catch(g){o.error(g);}finally{f.close();}}),y},p=G.alert({title:{text:"添加收藏夹",position:"center"},content:{text:`
...
`,rt={init(){R(ot),a.execMenuOnce("m-csdn-wenku-shieldBottomToolbar",()=>this.shieldBottomToolbar());},shieldBottomToolbar(){return o.info("【屏蔽】底部工具栏"),x.addBlockCSS(".page-container > div.btn")}},it=`/* 右下角悬浮图标 买1年送3个月 */\r
...
`,at={init(){a.execMenuOnce("m-csdn-download-removeAds",()=>R(it)),a.execMenuOnce("m-csdn-download-automaticallyExpandResourceIntroduction",()=>this.automaticallyExpandResourceIntroduction());},automaticallyExpandResourceIntroduction(){return o.info("自动展开资源介绍"),[x.addBlockCSS("label.unfold-font"),R(`
			.resource-desc{
				max-height: unset !important;

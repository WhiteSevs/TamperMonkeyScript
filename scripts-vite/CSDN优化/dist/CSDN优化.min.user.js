...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof ye=="function"?ye(e.keyName):null;return typeof t=="string"&&t?T(t):b.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{F.ready(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(o=>{o.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(o=>{o.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(o){navigator.clipboard.readText().then(i=>{o(i);}).catch(i=>{r.error("读取剪贴板内容失败👉",i),o("");});}function t(o){navigator.permissions.query({name:"clipboard-read"}).then(i=>{e(o);}).catch(i=>{r.error("申请剪贴板权限失败，尝试直接读取👉",i.message??i.name??i.stack),e(o);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(o=>{if(!n()){o("");return}document.hasFocus()?t(o):window.addEventListener("focus",()=>{t(o);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let o,i=n-t,l=t,c=async w=>{let m=await e(w);if(typeof m=="boolean"&&!m||w){v.workerClearTimeout(o);return}if(l+=t,l>i){c(true);return}o=v.workerSetTimeout(()=>{c(false);},t);};c(false);},findParentNode(e,t,n){if(n){let o=F.closest(e,n);if(o)return o.querySelector(t)}else return F.matches(e,t)?e:F.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(o,i)=>i===void 0?t:i,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},ee={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},v=J.noConflict(),s=F.noConflict(),G=pe,r=new v.Log(te,B.console||Ie.console),he=te?.script?.name||void 0,Oe=pe.config.Utils.AnyTouch(),Ne=false;r.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});y.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.getSetting().type;if(t==="loading")return  false;const n=e.getSetting().content;return t==="warning"?r.warn(n):t==="error"?r.error(n):r.info(n),true},get position(){return a.getValue(ee.qmsg_config_position.key,ee.qmsg_config_position.defaultValue)},get maxNums(){return a.getValue(ee.qmsg_config_maxnums.key,ee.qmsg_config_maxnums.defaultValue)},get showReverse(){return a.getValue(ee.qmsg_config_showreverse.key,ee.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=J.getMaxZIndex(),t=pe.config.InstanceUtils.getPopsMaxZIndex().zIndex;return J.getMaxValue(e,t)+100}});G.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=J.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),t=pe.config.InstanceUtils.getPopsMaxZIndex().zIndex;return J.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Me=new v.GM_Menu({GM_getValue:re,GM_setValue:fe,GM_registerMenuCommand:De,GM_unregisterMenuCommand:$e}),K=new v.Httpx({xmlHttpRequest:Le,logDetails:Ne});K.interceptors.request.use(e=>e);K.interceptors.response.use(void 0,e=>(r.error("拦截器-请求错误",e),e.type==="onabort"?y.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?y.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?y.error("请求超时",{consoleLogContent:true}):y.error("其它错误",{consoleLogContent:true}),e));B.Object.defineProperty,B.Function.prototype.apply,B.Function.prototype.call,B.Element.prototype.appendChild,B.setTimeout;const T=s.addStyle.bind(s),Te=F.selector.bind(F),Fe=F.selectorAll.bind(F);new v.GM_Cookie;const de="GM_Panel",qe="data-init",ie="data-key",ae="data-default-value",Ue="data-init-more-value",Ge="data-plugin-search-config",Z="data-storage-api",H={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},q={setting:{get width(){return H.width<550?"88vw":H.width<700?"550px":"700px"},get height(){return H.height<450?"70vh":H.height<550?"450px":"550px"}},settingMiddle:{get width(){return H.width<350?"88vw":"350px"}},info:{get width(){return H.width<350?"88vw":"350px"},get height(){return H.height<250?"88vh":"250px"}}};class Pe{storageKey;listenerData;constructor(t){if(typeof t=="string"){const n=t.trim();if(n=="")throw new Error("key参数不能为空字符串");this.storageKey=n;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new J.Dictionary,this.getLocalValue=this.getLocalValue.bind(this),this.set=this.set.bind(this),this.get=this.get.bind(this),this.getAll=this.getAll.bind(this),this.delete=this.delete.bind(this),this.has=this.has.bind(this),this.keys=this.keys.bind(this),this.values=this.values.bind(this),this.clear=this.clear.bind(this),this.addValueChangeListener=this.addValueChangeListener.bind(this),this.removeValueChangeListener=this.removeValueChangeListener.bind(this),this.triggerValueChangeListener=this.triggerValueChangeListener.bind(this);}getLocalValue(){let t=re(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){fe(this.storageKey,t);}set(t,n){const o=this.get(t),i=this.getLocalValue();Reflect.set(i,t,n),this.setLocalValue(i),this.triggerValueChangeListener(t,o,n);}get(t,n){const o=this.getLocalValue();return Reflect.get(o,t)??n}getAll(){return this.getLocalValue()}delete(t){const n=this.get(t),o=this.getLocalValue();Reflect.deleteProperty(o,t),this.setLocalValue(o),this.triggerValueChangeListener(t,n,void 0);}has(t){const n=this.getLocalValue();return Reflect.has(n,t)}keys(){const t=this.getLocalValue();return Reflect.ownKeys(t)}values(){const t=this.getLocalValue();return Reflect.ownKeys(t).map(n=>Reflect.get(t,n))}clear(){oe(this.storageKey);}addValueChangeListener(t,n){const o=Math.random(),i=this.listenerData.get(t)||[];return i.push({id:o,key:t,callback:n}),this.listenerData.set(t,i),o}removeValueChangeListener(t){let n=false;for(const[o,i]of this.listenerData.entries()){for(let l=0;l<i.length;l++){const c=i[l];(typeof t=="string"&&c.key===t||typeof t=="number"&&c.id===t)&&(i.splice(l,1),l--,n=true);}this.listenerData.set(o,i);}return n}async triggerValueChangeListener(...t){const[n,o,i]=t;if(!this.listenerData.has(n))return;let l=this.listenerData.get(n);for(let c=0;c<l.length;c++){const w=l[c];if(typeof w.callback=="function"){let m=this.get(n),d,p;typeof o<"u"&&t.length>=2?p=o:p=m,typeof i<"u"&&t.length>2?d=i:d=m,await w.callback(n,p,d);}}}}const j=new Pe(de),Y={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new v.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(l,c)=>{typeof c!="string"&&(c=b.toStr(c));const w=new Blob([c]),m=globalThis.URL.createObjectURL(w);s.createElement("a",{href:m,download:l}).click(),v.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(m);},500);},o=()=>{const l=C=>{const h=G.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),S=h.$shadowRoot.querySelector(".btn-control[data-mode='local']"),A=h.$shadowRoot.querySelector(".btn-control[data-mode='network']"),I=h.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),$=async V=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof le=="function"?typeof oe=="function"?(le().forEach(g=>{oe(g);}),y.success("已清空脚本存储的配置")):y.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):y.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof ve=="function"?ve(V):Object.keys(V).forEach(g=>{const f=V[g];fe(g,f);}),y.success("配置导入完毕");},O=V=>new Promise(async _=>{const M=v.toJSON(V);Object.keys(M).length===0?y.warning("解析为空配置，不导入"):await $(M),_(true);});s.on(S,"click",V=>{s.preventEvent(V),h.close();const _=s.createElement("input",{type:"file",accept:".json"});s.on(_,["propertychange","input"],M=>{if(!_.files?.length)return;const g=_.files[0],f=new FileReader;f.onload=()=>{O(f.result);},f.readAsText(g,"UTF-8");}),_.click();}),s.on(A,"click",V=>{s.preventEvent(V),h.close();const _=G.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(f,L){f.close();}},ok:{text:"导入",callback:async(f,L)=>{const E=f.text;if(v.isNull(E)){y.error("请填入完整的url");return}const x=y.loading("正在获取配置..."),k=await K.get(E,{allowInterceptConfig:false});if(x.close(),!k.status){r.error(k),y.error("获取配置失败",{consoleLogContent:true});return}await O(k.data.responseText)&&f.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:q.info.width,height:"auto"}),M=_.$shadowRoot.querySelector("input"),g=_.$shadowRoot.querySelector(".pops-prompt-btn-ok");s.on(M,["input","propertychange"],f=>{s.val(M)===""?s.attr(g,"disabled","true"):s.removeAttr(g,"disabled");}),s.listenKeyboard(M,"keydown",(f,L,E)=>{f==="Enter"&&E.length===0&&s.val(M)!==""&&s.trigger(g,"click");}),s.trigger(M,"input");}),s.on(I,"click",async V=>{s.preventEvent(V),h.close();let _=await b.getClipboardText();if(_.trim()===""){y.warning("获取到的剪贴板内容为空");return}await O(_);});},c=(C=`${he}_panel-setting-${v.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,h)=>{const S=G.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),A=S.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),I=S.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");s.on(A,"click",$=>{s.preventEvent($);try{n(C,h),S.close();}catch(O){y.error(O.toString(),{consoleLogContent:true});}}),s.on(I,"click",async $=>{await v.copy(h)?(y.success("复制成功"),S.close()):y.error("复制失败");});},m=G.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(C,h){l();}},cancel:{enable:true,text:"导出",callback(C,h){c(void 0,p);}}},width:H.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `}).$shadowRoot.querySelector("textarea"),d={};if(typeof le=="function")le().forEach(h=>{const S=re(h);Reflect.set(d,h,S);});else {y.warning("不支持函数GM_listValues，仅导出菜单配置");const C=re(de);Reflect.set(d,de,C);}const p=b.toStr(d);m.value=p;},i=()=>{let l=te?.script?.supportURL||te?.script?.namespace;typeof l=="string"&&v.isNotNull(l)&&window.open(l,"_blank");};return [{id:"script-version",title:`版本：${te?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(){return  false},afterRender(l){new Oe(l.$asideLiElement).on("tap",function(w){clearTimeout(t),t=void 0,e?(e=false,o()):(t=setTimeout(()=>{e=false,i();},200),e=true);});}}]},setDefaultBottomContentConfig(e){this.$data.__defaultBottomContentConfig=e;}},ge={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{a.showPanel(Y.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){a.isTopWindow()&&Me.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let n=this.$data.menuOption.findIndex(o=>o.key===t.key);n!==-1&&(this.$data.menuOption[n]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},a={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__urlChangeReloadMenuExecOnce:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new v.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new v.Dictionary),this.__onceExecMenuData},get urlChangeReloadMenuExecOnce(){return this.__urlChangeReloadMenuExecOnce==null&&(this.__urlChangeReloadMenuExecOnce=new v.Dictionary),this.__urlChangeReloadMenuExecOnce},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new v.Dictionary),this.__onceExecData},get scriptName(){return he},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:de,attributeKeyName:ie,attributeDefaultValueName:ae},init(){this.initContentDefaultValue(),ge.init();},isTopWindow(){return B.top===B.self},initContentDefaultValue(){const e=o=>{if(!o.attributes||o.type==="button"||o.type==="forms"||o.type==="deepMenu")return;const i=o.attributes;let l=i[qe];if(typeof l=="function"){let d=l();if(typeof d=="boolean"&&!d)return}let c=new Map,w=i[ie];if(w!=null){const d=i[ae];c.set(w,d);}let m=i[Ue];if(typeof m=="object"&&m&&Object.keys(m).forEach(d=>{const p=m[d];c.set(d,p);}),!c.size){r.warn(["请先配置键",o]);return}if(o.type==="switch"){let d=typeof o.disabled=="function"?o.disabled():o.disabled;typeof d=="boolean"&&d&&this.$data.contentConfigInitDisabledKeys.push(...c.keys());}for(const[d,p]of c.entries())this.setDefaultValue(d,p);},t=o=>{for(let i=0;i<o.length;i++){let l=o[i];e(l);let c=l.forms;c&&Array.isArray(c)&&t(c);}},n=[...Y.getAllContentConfig()];for(let o=0;o<n.length;o++){let i=n[o];if(!i.forms)continue;const l=i.forms;l&&Array.isArray(l)&&t(l);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&r.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},getDefaultValue(e){return this.$data.contentConfigInitDefaultValue.get(e)},setValue(e,t){j.set(e,t);},getValue(e,t){const n=j.get(e);return n??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){j.delete(e);},hasKey(e){return j.has(e)},addValueChangeListener(e,t){return j.addValueChangeListener(e,(o,i,l)=>{t(e,l,i);})},removeValueChangeListener(e){j.removeValueChangeListener(e);},triggerMenuValueChange(e,t,n){j.triggerValueChangeListener(e,n,t);},async exec(e,t,n,o=true){const i=this;let l;typeof e=="string"||Array.isArray(e)?l=()=>e:l=e;let c=false;const w=l();let m=[];Array.isArray(w)?(c=true,m=w):m.push(w);const d=m.find(g=>!this.$data.contentConfigInitDefaultValue.has(g));if(d){r.warn(`${d} 键不存在`);return}const p=JSON.stringify(m);if(o&&this.$data.onceExecMenuData.has(p))return this.$data.onceExecMenuData.get(p);let C=[];const h=[];let S=[];const A=(g,f)=>{let L=[],E=[],x=[];if(Array.isArray(f))x=x.concat(f);else if(typeof f=="object"&&f!=null)if(f instanceof Element)x.push(f);else {const{$css:k,destory:R}=f;k!=null&&(Array.isArray(k)?x=x.concat(k):x.push(k)),typeof R=="function"&&x.push(R);}else x.push(f);for(const k of x)if(k!=null){if(k instanceof Element){L.push(k);continue}if(typeof k=="function"){S.push(k);continue}}g?(C=C.concat(L),S=S.concat(E)):($(),O());},I=g=>!!this.getValue(g),$=()=>{for(let g=0;g<C.length;g++)C[g]?.remove(),C.splice(g,1),g--;},O=()=>{for(let g=0;g<S.length;g++){const f=S[g];f(),S.splice(g,1),g--;}},V=()=>{let g=false;return typeof n=="function"?g=n(m):g=m.every(f=>I(f)),g},_=async g=>{if(V()){const L=m.map(x=>this.getValue(x)),E=await t({value:c?L:L[0],addStoreValue:(...x)=>A(true,x)});A(true,E);}else A(false,[]);};o&&m.forEach(g=>{const f=this.addValueChangeListener(g,(L,E,x)=>_());h.push(f);}),await _();const M={reload(){this.clearStoreStyleElements(),this.destory(),_();},clear(){this.clearStoreStyleElements(),this.destory(),this.removeValueChangeListener(),this.clearOnceExecMenuData();},clearStoreStyleElements:()=>$(),destory(){return O()},removeValueChangeListener:()=>{h.forEach(g=>{this.removeValueChangeListener(g);});},clearOnceExecMenuData(){o&&i.$data.onceExecMenuData.delete(p);}};return this.$data.onceExecMenuData.set(p,M),M},async execMenu(e,t,n=false,o=false){return await this.exec(e,async i=>await t(i),i=>i.every(c=>{let w=!!this.getValue(c);return a.$data.contentConfigInitDisabledKeys.includes(c)&&(w=false,r.warn(`.execMenu${o?"Once":""} ${c} 被禁用`)),n&&(w=!w),w}),o)},async execMenuOnce(e,t,n=false,o=false){const i=await this.execMenu(e,t,n,true);if(o&&i){const l=()=>{i.reload();};this.removeUrlChangeWithExecMenuOnceListener(e),this.addUrlChangeWithExecMenuOnceListener(e,l);}return i},deleteExecMenuOnce(e){return e=this.transformKey(e),this.$data.onceExecMenuData.delete(e),this.$data.urlChangeReloadMenuExecOnce.delete(e),j.removeValueChangeListener(e)},onceExec(e,t){if(e=this.transformKey(e),typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},deleteOnceExec(e){e=this.transformKey(e),this.$data.onceExecData.delete(e);},addUrlChangeWithExecMenuOnceListener(e,t){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.set(e,t);},removeUrlChangeWithExecMenuOnceListener(e){e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.delete(e);},hasUrlChangeWithExecMenuOnceListener(e){return e=this.transformKey(e),this.$data.urlChangeReloadMenuExecOnce.has(e)},async triggerUrlChangeWithExecMenuOnceEvent(e){const t=this.$data.urlChangeReloadMenuExecOnce.values();for(const n of t)await n(e);},showPanel(e,t=`${he}-设置`,n=false,o=false){this.$data.$panel=null,this.$data.panelContent=[];let i=e.findIndex(c=>(typeof c.isBottom=="function"?c.isBottom():!!c.isBottom)&&c.id==="script-version")!==-1;!n&&!i&&e.push(...Y.getDefaultBottomContentConfig());let l=G.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(c,w)=>{c.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(c,w)=>{c(),this.$data.$panel=null;}},width:q.setting.width,height:q.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=l,this.$data.panelContent=e,o||this.registerConfigSearch({$panel:l,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,o=async(h,S)=>{if(h==null)return;const A=await S(h);return A&&typeof A.isFind=="boolean"&&A.isFind?A.data:await o(A.data,S)},i=(h,S)=>{const A=new IntersectionObserver(I=>{I.forEach($=>{$.isIntersecting&&(S?.(),A.disconnect());});},{root:null,threshold:1});A.observe(h),h.scrollIntoView({behavior:"smooth",block:"center"});},l=h=>{const S="pops-flashing";s.animationend(h,()=>{h.classList.remove(S);}),h.classList.add(S);},c=h=>{if(h.type==="dblclick"&&C)return;s.preventEvent(h),m=null;const S=G.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});S.$shadowRoot.querySelector(".search-wrapper");const A=S.$shadowRoot.querySelector(".search-config-text"),I=S.$shadowRoot.querySelector(".search-result-wrapper");A.focus();const $=()=>{s.empty(I);},O=_=>{const M=v.queryProperty(_,f=>f?.next?{isFind:false,data:f.next}:{isFind:true,data:f}),g=s.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return s.on(g,"click",f=>{const E=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[_.index];if(!E){y.error(`左侧项下标${_.index}不存在`);return}E.scrollIntoView({behavior:"smooth",block:"center"}),E.click(),o(_.next,async x=>{if(x?.next){const k=await s.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(R=>{const U=Reflect.get(R,"__formConfig__");return typeof U=="object"&&U!=null&&U.text===x.name}),2500);if(k)k.click();else return y.error("未找到对应的二级菜单"),{isFind:true,data:x};return {isFind:false,data:x.next}}else {const k=await s.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(R=>Reflect.get(R,"__formConfig__")===x.matchedData?.formConfig),2500);if(k){i(k);const R=k.closest(".pops-panel-forms-fold[data-fold-enable]");R&&(R.querySelector(".pops-panel-forms-fold-container").click(),await v.sleep(500)),i(k,()=>{l(k);});}else y.error("未找到对应的菜单项");return {isFind:true,data:x}}});}),g},V=_=>{const M=new RegExp(_,"i"),g=[],f=(E,x)=>{for(let k=0;k<E.length;k++){const R=E[k],U=R.forms;if(U&&Array.isArray(U)){const W=v.deepClone(x);if(R.type==="deepMenu"){const Q=v.queryProperty(W,X=>X?.next?{isFind:false,data:X.next}:{isFind:true,data:X});Q.next={name:R.text};}f(U,W);}else {let W,Q;if(R.type==="own"){const N=Reflect.get(R.attributes||{},Ge);N&&(typeof N.text=="string"&&(W=N.text),typeof N.desc=="string"&&(Q=N.desc));}else W=Reflect.get(R,"text"),Q=Reflect.get(R,"description");const X=[W,Q],be=X.findIndex(N=>{if(typeof N=="string")return N.match(M)});if(be!==-1){const N=v.deepClone(x),we=v.queryProperty(N,P=>P?.next?{isFind:false,data:P.next}:{isFind:true,data:P});we.next={name:W,matchedData:{path:"",formConfig:R,matchedText:X[be],description:Q}};const Ce=[];v.queryProperty(N,P=>{const me=P?.name;return typeof me=="string"&&me.trim()!==""&&Ce.push(me),P?.next?{isFind:false,data:P.next}:{isFind:true,data:P}});const Ve=Ce.join(b.escapeHtml(" - "));we.next.matchedData.path=Ve,g.push(N);}}}};for(let E=0;E<n.length;E++){const x=n[E];if(!x.forms||x.isBottom&&x.id==="script-version")continue;const k=x.forms;if(k&&Array.isArray(k)){let R=x.title;typeof R=="function"&&(R=R()),f(k,{index:E,name:R});}}const L=document.createDocumentFragment();for(const E of g){let x=O(E);L.appendChild(x);}$(),I.append(L);};s.on(A,"input",v.debounce(_=>{s.preventEvent(_);let M=s.val(A).trim();if(M===""){$();return}V(M);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(h=>{s.on(h,"dblclick",c);});let m=null,d=false,p,C=false;s.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(h,S)=>{C=true,clearTimeout(p),p=void 0,d&&m===S?(d=false,m=null,c(h)):(p=setTimeout(()=>{d=false;},200),d=true,m=S);},{capture:true}),t.$shadowRoot.appendChild(s.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
      ...
      `)},allowSelectText(){return r.info("允许选择文字"),T(`
        ...
        `)},blockBottomToolBar(){return r.info("屏蔽底部工具栏"),b.addBlockCSS("#operate")},bottomToolBarAlwaysShow(){return r.info("底部工具栏常驻"),T(`
			...
			`)},optimizationCollectButton(){r.info("优化收藏按钮"),s.waitNode("#operate .collect-btn",1e4).then(e=>{e&&s.on(e,"click",async t=>{s.preventEvent(t);let n=e.querySelector(".collect"),o=e.querySelector(".uncollect"),i=await ce.folderListWithCheck(window.location.origin+window.location.pathname);if(!i)return;let l=[];i.forEach(d=>{d.IsFavorite&&l.push(d.ID);});let c=d=>{let p=d.ID,C=s.createElement("li",{className:"csdn-collection-item",innerHTML:`
								...
								`},{"data-is-collect":d.IsFavorite});C.querySelector(".title-m");let h=C.querySelector(".csdn-collection-item_length");C.querySelector(".csdn-collection-controls");let S=C.querySelector(".collect-btn");return s.on(S,"click",async A=>{let I=B.articleDetailUrl;I==null&&(I=window.location.origin+window.location.pathname);let $=B.articleId;if($==null){r.error("获取文章ID失败"),y.error("获取文章ID失败");return}let O=B.username;if(O==null){r.error("获取文章作者失败"),y.error("获取文章作者失败");return}let V=B.articleTitle;if(V==null&&(V=document.title.replace(/-CSDN博客$/,"")),V==null){r.error("获取文章标题失败"),y.error("获取文章标题失败");return}let _=B.articleDesc;if(_==null){let f=Te("meta[name='description']");f&&(_=f.getAttribute("content"));}if(_==null){r.error("获取文章描述失败"),y.error("获取文章描述失败");return}let M=[...l],g=y.loading("处理中...");try{let f=await ce.checkFavoriteByUrl(I);if(f==null)return;r.info(p,f);let L=!f[p];if(L?(r.info("添加收藏"),M.push(p)):(r.info("取消收藏"),M.splice(M.indexOf(p),1)),!await ce.addFavoriteInFolds({author:O,url:I,source:"blog",sourceId:$,title:V,description:_,fromType:"PC",username:d.Username,folderIdList:M}))return;let x=await ce.checkFavoriteByUrl(I);if(x==null)return;r.info(p,x),C.setAttribute("data-is-collect",(!!x[p]).toString()),L?x[p]?(r.success("收藏成功"),y.success("收藏成功"),s.text(S,"已收藏"),l.includes(p)||l.push(p),d.FavoriteNum++):(r.error("收藏失败",x,p),y.error("收藏失败")):x[p]?(r.error("取消收藏失败",x,p),y.error("取消收藏失败")):(r.success("取消收藏成功"),y.success("取消收藏成功"),s.text(S,"收藏"),l.includes(p)&&l.splice(l.indexOf(p),1),d.FavoriteNum--),s.text(h,`${d.FavoriteNum}条内容`),Object.values(x).find(R=>R)?(s.show(n,!1),s.hide(o,!1)):(s.show(o,!1),s.hide(n,!1)),g.close();}catch(f){r.error(f);}finally{g.close();}}),C},m=G.alert({title:{text:"添加收藏夹",position:"center"},content:{text:`
							...
							`}).$shadowRoot.querySelector(".csdn-collection-items");i.forEach(d=>{let p=c(d);m.appendChild(p);});},{capture:true});});}},ot=`/* 右下角的买一年送3个月的广告图标 */\r
.blind_box {\r
  display: none !important;\r
}\r
`,rt={init(){T(ot),a.execMenuOnce("m-csdn-wenku-shieldBottomToolbar",()=>this.shieldBottomToolbar());},shieldBottomToolbar(){return r.info("【屏蔽】底部工具栏"),b.addBlockCSS(".page-container > div.btn")}},it=`/* 右下角悬浮图标 买1年送3个月 */\r
...
`,at={init(){a.execMenuOnce("m-csdn-download-removeAds",()=>T(it)),a.execMenuOnce("m-csdn-download-automaticallyExpandResourceIntroduction",()=>this.automaticallyExpandResourceIntroduction());},automaticallyExpandResourceIntroduction(){return r.info("自动展开资源介绍"),[b.addBlockCSS("label.unfold-font"),T(`
			.resource-desc{
				max-height: unset !important;

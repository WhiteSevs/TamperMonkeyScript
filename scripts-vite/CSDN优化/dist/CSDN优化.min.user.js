...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ge=="function"?ge(e.keyName):null;typeof t=="string"&&t?k(t):h.loadStyleLink(e.url);},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,z.ready(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;let t=new URL(e);return t.protocol="https:",t.toString()},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(o=>{o.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(o=>{o.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(o){navigator.clipboard.readText().then(l=>{o(l);}).catch(l=>{r.error("读取剪贴板内容失败👉",l),o("");});}function t(o){navigator.permissions.query({name:"clipboard-read"}).then(l=>{e(o);}).catch(l=>{r.error("申请剪贴板权限失败，尝试直接读取👉",l.message??l.name??l.stack),e(o);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(o=>{if(!n()){o("");return}document.hasFocus()?t(o):window.addEventListener("focus",()=>{t(o);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let o,l=n-t,s=t,c=async g=>{let u=await e(g);if(typeof u=="boolean"&&!u||g){p.workerClearTimeout(o);return}if(s+=t,s>l){c(true);return}o=p.workerSetTimeout(()=>{c(false);},t);};c(false);}},W={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},p=F.noConflict(),b=z.noConflict(),Y=le,r=new p.Log(Z,y.console||Ee.console);let xe=Z?.script?.name||void 0;le.config.Utils.AnyTouch();const ye=false;r.config({debug:ye,logMaxCount:1e3,autoClearConsole:true,tag:true});v.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.getSetting().type;if(t==="loading")return  false;const n=e.getSetting().content;return t==="warning"?r.warn(n):t==="error"?r.error(n):r.info(n),true},get position(){return i.getValue(W.qmsg_config_position.key,W.qmsg_config_position.defaultValue)},get maxNums(){return i.getValue(W.qmsg_config_maxnums.key,W.qmsg_config_maxnums.defaultValue)},get showReverse(){return i.getValue(W.qmsg_config_showreverse.key,W.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=F.getMaxZIndex(),t=le.config.InstanceUtils.getPopsMaxZIndex().zIndex;return F.getMaxValue(e,t)+100}});Y.GlobalConfig.setGlobalConfig({zIndex:()=>{let e=F.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),t=le.config.InstanceUtils.getPopsMaxZIndex().zIndex;return F.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const ve=new p.GM_Menu({GM_getValue:ce,GM_setValue:de,GM_registerMenuCommand:Ae,GM_unregisterMenuCommand:De}),K=new p.Httpx({xmlHttpRequest:Ve,logDetails:ye});K.interceptors.request.use(e=>e);K.interceptors.response.use(void 0,e=>(r.error("拦截器-请求错误",e),e.type==="onabort"?v.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?v.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?v.error("请求超时",{consoleLogContent:true}):v.error("其它错误",{consoleLogContent:true}),e));y.Object.defineProperty,y.Function.prototype.apply,y.Function.prototype.call,y.Element.prototype.appendChild,y.setTimeout;const k=p.addStyle.bind(p),Se=z.selector.bind(z),$e=z.selectorAll.bind(z);new p.GM_Cookie;const ke="GM_Panel",Le="data-init",ee="data-key",te="data-default-value",Ie="data-init-more-value",U="data-storage-api",Q={setting:{get width(){return window.innerWidth<550?"88vw":window.innerWidth<700?"550px":"700px"},get height(){return window.innerHeight<450?"70vh":window.innerHeight<550?"450px":"550px"}},settingMiddle:{get width(){return window.innerWidth<350?"88vw":"350px"}}};class Oe{storageKey;listenerData;constructor(t){if(typeof t=="string"){let n=t.trim();if(n=="")throw new Error("key参数不能为空字符串");this.storageKey=n;}else throw new Error("key参数类型错误，必须是字符串");this.listenerData=new F.Dictionary;}getLocalValue(){let t=ce(this.storageKey);return t==null&&(t={},this.setLocalValue(t)),t}setLocalValue(t){de(this.storageKey,t);}set(t,n){let o=this.get(t),l=this.getLocalValue();Reflect.set(l,t,n),this.setLocalValue(l),this.triggerValueChangeListener(t,o,n);}get(t,n){let o=this.getLocalValue();return Reflect.get(o,t)??n}getAll(){return this.getLocalValue()}delete(t){let n=this.get(t),o=this.getLocalValue();Reflect.deleteProperty(o,t),this.setLocalValue(o),this.triggerValueChangeListener(t,n,void 0);}has(t){let n=this.getLocalValue();return Reflect.has(n,t)}keys(){let t=this.getLocalValue();return Reflect.ownKeys(t)}values(){let t=this.getLocalValue();return Reflect.ownKeys(t).map(n=>Reflect.get(t,n))}clear(){se(this.storageKey);}addValueChangeListener(t,n){let o=Math.random(),l=this.listenerData.get(t)||[];return l.push({id:o,key:t,callback:n}),this.listenerData.set(t,l),o}removeValueChangeListener(t){let n=false;for(const[o,l]of this.listenerData.entries()){for(let s=0;s<l.length;s++){const c=l[s];(typeof t=="string"&&c.key===t||typeof t=="number"&&c.id===t)&&(l.splice(s,1),s--,n=true);}this.listenerData.set(o,l);}return n}triggerValueChangeListener(t,n,o){if(!this.listenerData.has(t))return;let l=this.listenerData.get(t);for(let s=0;s<l.length;s++){const c=l[s];if(typeof c.callback=="function"){let g=this.get(t),u,m;typeof n<"u"&&arguments.length>=2?m=n:m=g,typeof o<"u"&&arguments.length>2?u=o:u=g,c.callback(t,m,u);}}}}const O=new Oe(ke),P={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new p.Dictionary),this.__contentConfig}},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){return [{id:"script-version",title:`版本：${Z?.script?.version||"未知"}`,isBottom:true,forms:[],clickFirstCallback(e,t,n){let o=Z?.script?.supportURL||Z?.script?.namespace;return typeof o=="string"&&p.isNotNull(o)&&window.open(o,"_blank"),false}}]}},ue={$data:{__menuOption:[{key:"show_pops_panel_setting",text:"⚙ 设置",autoReload:false,isStoreValue:false,showText(e){return e},callback:()=>{i.showPanel(P.getConfig(0));}}],get menuOption(){return this.__menuOption}},init(){this.initExtensionsMenu();},initExtensionsMenu(){i.isTopWindow()&&ve.add(this.$data.menuOption);},addMenuOption(e){Array.isArray(e)||(e=[e]),this.$data.menuOption.push(...e);},updateMenuOption(e){Array.isArray(e)||(e=[e]),e.forEach(t=>{let n=this.$data.menuOption.findIndex(o=>o.key===t.key);n!==-1&&(this.$data.menuOption[n]=t);});},getMenuOption(e=0){return this.$data.menuOption[e]},deleteMenuOption(e=0){this.$data.menuOption.splice(e,1);}},i={$data:{__contentConfigInitDefaultValue:null,__onceExecMenuData:null,__onceExecData:null,__panelConfig:{},$panel:null,panelContent:[],get contentConfigInitDefaultValue(){return this.__contentConfigInitDefaultValue==null&&(this.__contentConfigInitDefaultValue=new p.Dictionary),this.__contentConfigInitDefaultValue},contentConfigInitDisabledKeys:[],get onceExecMenuData(){return this.__onceExecMenuData==null&&(this.__onceExecMenuData=new p.Dictionary),this.__onceExecMenuData},get onceExecData(){return this.__onceExecData==null&&(this.__onceExecData=new p.Dictionary),this.__onceExecData},get scriptName(){return xe},get panelConfig(){return this.__panelConfig},set panelConfig(e){this.__panelConfig=e;},key:ke,attributeKeyName:ee,attributeDefaultValueName:te},init(){this.initContentDefaultValue(),ue.init();},isTopWindow(){return y.top===y.self},initContentDefaultValue(){const e=o=>{if(!o.attributes||o.type==="button"||o.type==="forms"||o.type==="deepMenu")return;let l=new Map,s=o.attributes[ee];if(s!=null){const u=o.attributes[te];l.set(s,u);}let c=o.attributes[Ie];if(typeof c=="object"&&c&&Object.keys(c).forEach(u=>{l.set(u,c[u]);}),!l.size){r.warn(["请先配置键",o]);return}let g=o.attributes[Le];if(typeof g=="function"){let u=g();if(typeof u=="boolean"&&!u)return}if(o.type==="switch"){let u=typeof o.disabled=="function"?o.disabled():o.disabled;typeof u=="boolean"&&u&&this.$data.contentConfigInitDisabledKeys.push(...l.keys());}for(const[u,m]of l.entries())this.setDefaultValue(u,m);},t=o=>{for(let l=0;l<o.length;l++){let s=o[l];e(s);let c=s.forms;c&&Array.isArray(c)&&t(c);}},n=[...P.getAllContentConfig()];for(let o=0;o<n.length;o++){let l=n[o];if(!l.forms)continue;const s=l.forms;s&&Array.isArray(s)&&t(s);}this.$data.contentConfigInitDisabledKeys=[...new Set(this.$data.contentConfigInitDisabledKeys)];},setDefaultValue(e,t){this.$data.contentConfigInitDefaultValue.has(e)&&r.warn("请检查该key(已存在): "+e),this.$data.contentConfigInitDefaultValue.set(e,t);},setValue(e,t){O.set(e,t);},getValue(e,t){let n=O.get(e);return n??(this.$data.contentConfigInitDefaultValue.has(e)?this.$data.contentConfigInitDefaultValue.get(e):t)},deleteValue(e){O.delete(e);},hasKey(e){return O.has(e)},addValueChangeListener(e,t){return O.addValueChangeListener(e,(o,l,s)=>{t(e,s,l);})},removeValueChangeListener(e){O.removeValueChangeListener(e);},triggerMenuValueChange(e,t,n){O.triggerValueChangeListener(e,n,t);},deleteExecMenuOnce(e){return this.$data.onceExecMenuData.delete(e),O.removeValueChangeListener(e)},deleteOnceExec(e){this.$data.onceExecData.delete(e);},exec(e,t,n,o=true){const l=this;let s;typeof e=="string"||Array.isArray(e)?s=()=>e:s=e;let c=false,g=s(),u=[];Array.isArray(g)?(c=true,u=g):u.push(g);let m=u.find(x=>!this.$data.contentConfigInitDefaultValue.has(x));if(m){r.warn(`${m} 键不存在`);return}let d=JSON.stringify(u);if(o){if(this.$data.onceExecMenuData.has(d))return;this.$data.onceExecMenuData.set(d,1);}let f=[],w=[],D=(x,_)=>{let A=[];Array.isArray(_)||(_=[_]),_.forEach(B=>{if(B!=null&&B instanceof HTMLStyleElement){A.push(B);return}}),f=f.concat(A);},L=x=>this.getValue(x),E=()=>{for(let x=0;x<f.length;x++)f[x].remove(),f.splice(x,1),x--;},G=()=>{let x=false;return typeof n=="function"?x=n(u):x=u.every(_=>L(_)),x},N=x=>{let _=G(),A=[];if(_){let B=u.map(C=>this.getValue(C)),M=t({value:c?B:B[0],addStyleElement:(...C)=>D(true,...C)});Array.isArray(M)||(M=[M]),M.forEach(C=>{if(C!=null&&C instanceof HTMLStyleElement){A.push(C);return}});}E(),f=[...A];};return o&&u.forEach(x=>{let _=this.addValueChangeListener(x,(A,B,M)=>{N();});w.push(_);}),N(),{clear(){this.clearStoreStyleElements(),this.removeValueChangeListener(),o&&l.$data.onceExecMenuData.delete(d);},clearStoreStyleElements:()=>E(),removeValueChangeListener:()=>{w.forEach(x=>{this.removeValueChangeListener(x);});}}},execMenu(e,t,n=false,o=false){return this.exec(e,l=>t(l),l=>l.every(c=>{let g=!!this.getValue(c);return i.$data.contentConfigInitDisabledKeys.includes(c)&&(g=false,r.warn(`.execMenu${o?"Once":""} ${c} 被禁用`)),n&&(g=!g),g}),o)},execMenuOnce(e,t,n=false){return this.execMenu(e,t,n,true)},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExecData.has(e)||(t(),this.$data.onceExecData.set(e,1));},showPanel(e,t=`${xe}-设置`,n=false,o=false){this.$data.$panel=null,this.$data.panelContent=[];let l=e.findIndex(c=>(typeof c.isBottom=="function"?c.isBottom():!!c.isBottom)&&c.id==="script-version")!==-1;!n&&!l&&e.push(...P.getDefaultBottomContentConfig());let s=Y.panel({title:{text:t,position:"center",html:false,style:""},content:e,btn:{close:{enable:true,callback:(c,g)=>{c.close(),this.$data.$panel=null;}}},mask:{enable:true,clickEvent:{toClose:true,toHide:false},clickCallBack:(c,g)=>{c(),this.$data.$panel=null;}},width:Q.setting.width,height:Q.setting.height,drag:true,only:true,...this.$data.panelConfig});this.$data.$panel=s,this.$data.panelContent=e,o||this.registerConfigSearch({$panel:s,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e;let o=async(d,f)=>{if(d==null)return;let w=await f(d);return w&&typeof w.isFind=="boolean"&&w.isFind?w.data:await o(w.data,f)},l=(d,f)=>{const w=new IntersectionObserver(D=>{D.forEach(L=>{L.isIntersecting&&(f?.(),w.disconnect());});},{root:null,threshold:1});w.observe(d),d.scrollIntoView({behavior:"smooth",block:"center"});},s=d=>{const f="pops-flashing";b.animationend(d,()=>{d.classList.remove(f);}),d.classList.add(f);},c=(d,f)=>{p.preventEvent(d);let w=Y.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});w.$shadowRoot.querySelector(".search-wrapper");let D=w.$shadowRoot.querySelector(".search-config-text"),L=w.$shadowRoot.querySelector(".search-result-wrapper");D.focus();let E=()=>{b.empty(L);},G=V=>{const x=p.queryProperty(V,A=>A?.next?{isFind:false,data:A.next}:{isFind:true,data:A});let _=b.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`});return b.on(_,"click",A=>{let M=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[V.index];if(!M){v.error(`左侧项下标${V.index}不存在`);return}M.scrollIntoView({behavior:"smooth",block:"center"}),M.click(),o(V.next,async C=>{if(C?.next){let S=await p.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(R=>{const $=Reflect.get(R,"__formConfig__");return typeof $=="object"&&$!=null&&$.text===C.name}),2500);if(S)S.click();else return v.error("未找到对应的二级菜单"),{isFind:true,data:C};return {isFind:false,data:C.next}}else {let S=await p.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(R=>Reflect.get(R,"__formConfig__")===C.matchedData?.formConfig),2500);if(S){l(S);let R=S.closest(".pops-panel-forms-fold[data-fold-enable]");R&&(R.querySelector(".pops-panel-forms-fold-container").click(),await p.sleep(500)),l(S,()=>{s(S);});}else v.error("未找到对应的菜单项");return {isFind:true,data:C}}});}),_},N=V=>{const x=new RegExp(V,"i"),_=[],A=(M,C)=>{for(let S=0;S<M.length;S++){const R=M[S];let $=R.forms;if($&&Array.isArray($)){const J=p.deepClone(C);if(R.type==="deepMenu"){const ne=p.queryProperty(J,H=>H?.next?{isFind:false,data:H.next}:{isFind:true,data:H});ne.next={name:R.text};}A($,J);}else {let J=Reflect.get(R,"text"),ne=Reflect.get(R,"description");const H=[J,ne];let me=H.findIndex(j=>{if(typeof j=="string")return j.match(x)});if(me!==-1){const j=p.deepClone(C),fe=p.queryProperty(j,I=>I?.next?{isFind:false,data:I.next}:{isFind:true,data:I});fe.next={name:J,matchedData:{path:"",formConfig:R,matchedText:H[me],description:ne}};const he=[];p.queryProperty(j,I=>{const ae=I?.name;return typeof ae=="string"&&ae.trim()!==""&&he.push(ae),I?.next?{isFind:false,data:I.next}:{isFind:true,data:I}});const Re=he.join(h.escapeHtml(" - "));fe.next.matchedData.path=Re,_.push(j);}}}};for(let M=0;M<n.length;M++){const C=n[M];if(!C.forms||C.isBottom&&C.id==="script-version")continue;const S=C.forms;if(S&&Array.isArray(S)){let R=C.title;typeof R=="function"&&(R=R()),A(S,{index:M,name:R});}}let B=document.createDocumentFragment();for(const M of _){let C=G(M);B.appendChild(C);}E(),L.append(B);};b.on(D,"input",p.debounce(V=>{p.preventEvent(V);let x=b.val(D).trim();if(x===""){E();return}N(x);},200));},g=null,u=false,m;b.on(t.$shadowRoot,"dblclick","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",c),b.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(d,f)=>{clearTimeout(m),m=void 0,u&&g===f?(u=false,c(d)):(m=setTimeout(()=>{u=false;},200),g=f,u=true);},{capture:true}),t.$shadowRoot.appendChild(b.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`,Fe={init(){i.exec("csdn-blog-rightToolbarEnable",()=>this.shieldRightToolbar(),e=>!i.getValue(e[0]),true),i.execMenuOnce("csdn-blog-rightToolbarCreativeCenter",()=>this.shieldCreativeCenter()),i.execMenuOnce("csdn-blog-rightToolbarShowOrSidebar",()=>this.shieldShowOrSidebar()),i.execMenuOnce("csdn-blog-rightToolbarBeginnerGuidance",()=>this.shieldBeginnerGuidance()),i.execMenuOnce("csdn-blog-rightToolbarCustomerService",()=>this.shieldCustomerService()),i.execMenuOnce("csdn-blog-rightToolbarReport",()=>this.shieldReport()),i.execMenuOnce("csdn-blog-rightToolbarBackToTop",()=>this.shieldBackToTop()),this.initRightToolbarOffset(),b.ready(()=>{i.execMenuOnce("csdn-blog-addGotoRecommandButton",()=>{this.addGotoRecommandButton();});});},addGotoRecommandButton(){r.info("【添加】前往评论按钮，在返回顶部的上面");let e=document.createElement("a");e.className="option-box",e.setAttribute("data-type","gorecommand"),e.innerHTML=`
        ...
        `)]},autoExpandContent(){return r.info("自动展开全文"),k(`
		/* 自动展开全文 */
		#article_content,
...
`,Je={init(){k(ze),i.execMenuOnce("m-csdn-hua-wei-cloud-autoExpandContent",()=>_e.autoExpandContent()),i.execMenuOnce("m-csdn-hua-wei-cloud-blockBottomJoinTheCommunity",()=>this.blockBottomJoinTheCommunity());},blockBottomJoinTheCommunity(){return r.info("【屏蔽】底部加入社区"),h.addBlockCSS(".user-desc")}},oe={isSuccessResponse(e){return e==null?false:(typeof e=="string"&&(e=p.toJSON(e)),e?.code===200)}},re={async folderListWithCheck(e){let t=await K.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/folderListWithCheck",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":p.getRandomPCUA()}});r.info(t);let n=p.toJSON(t.data.responseText);if(!t.status||!oe.isSuccessResponse(t.data.responseText)){r.error("获取收藏夹信息失败，请求异常"),typeof n.msg=="string"?v.error(n.msg):v.error("获取收藏夹信息失败");return}return n.data.result},async addFavoriteInFolds(e){let t=await K.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/addFavoriteInFolds",{fetch:true,data:e,headers:{"Content-Type":"application/json","User-Agent":p.getRandomPCUA()},allowInterceptConfig:false});if(r.info(t),!t.status||!oe.isSuccessResponse(t.data.responseText)){r.error("添加收藏失败，请求异常",t),v.error("添加收藏失败，请求异常");return}return  true},async checkFavoriteByUrl(e){debugger;let t=await K.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/checkFavoriteByUrl",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":p.getRandomPCUA()}});if(r.info(t),!t.status||!oe.isSuccessResponse(t.data.responseText)){r.error("检查收藏夹状态失败，请求异常"),v.error("检查收藏夹状态失败，请求异常");return}return p.toJSON(t.data.responseText).data},async createFolder(e){let t=await K.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/createFolder",{data:e,fetch:true,headers:{Accept:"application/json, text/javascript, */*; q=0.01","Content-Type":"application/json","User-Agent":p.getRandomPCUA()},allowInterceptConfig:false});if(r.info(t),!t.status||!oe.isSuccessResponse(t.data.responseText)){v.error("创建收藏夹失败");return}return p.toJSON(t.data.responseText).data}},Ze={init(){i.exec("m-csdn-blog-shieldTopToolbar",()=>this.shieldTopToolbar(),e=>!i.getValue(e[0]),true),i.execMenuOnce("m-csdn-blog-notLimitCodePreMaxHeight",()=>this.notLimitCodePreMaxHeight()),i.execMenuOnce("m-csdn-blog-notLimitCommentMaxHeight",()=>this.notLimitCommentMaxHeight()),i.execMenuOnce("m-csdn-blog-allowSelectText",()=>this.allowSelectText()),i.execMenuOnce("m-csdn-blog-autoExpandContent",()=>this.autoExpandContent()),i.exec("m-csdn-blog-bottomArticleEnable",()=>this.blockBottomArticle(),e=>!i.getValue(e[0]),true),i.exec("m-csdn-blog-comment-enable",()=>this.blockComment(),e=>!i.getValue(e[0]),true),i.exec("m-csdn-blog-bottom-toolbar-enable",()=>this.blockBottomToolBar(),e=>!i.getValue(e[0]),true),i.execMenuOnce("m-csdn-blog-bottom-toolbar-always-bottom",()=>this.bottomToolBarAlwaysShow()),b.ready(()=>{i.execMenuOnce("m-csdn-blog-removeAds",()=>this.removeAds()),i.execMenuOnce("m-csdn-blog-refactoringRecommendation",()=>{this.refactoringRecommendation();}),i.execMenuOnce("m-csdn-blog-unBlockCopy",()=>{Te.unBlockCopy();}),i.execMenuOnce("m-csdn-blog-bottom-toolbar-optimizationCollectButton",()=>{this.optimizationCollectButton();});});},shieldTopToolbar(){return r.info("屏蔽顶部Toolbar"),[h.addBlockCSS("#csdn-toolbar"),k(`
      ...
      `)},allowSelectText(){return r.info("允许选择文字"),k(`
        ...
        `)},autoExpandContent(){return r.info("自动展开内容"),k(`
        #content_views pre.set-code-hide,
        .article_content{
          height: 100% !important;
          overflow: auto !important;
        }
        `)},blockBottomToolBar(){return r.info("屏蔽底部工具栏"),h.addBlockCSS("#operate")},bottomToolBarAlwaysShow(){return r.info("底部工具栏常驻"),k(`
			/* 底部工具栏 */
			#operate {
				bottom: 0 !important;
			}
			`)},optimizationCollectButton(){r.info("优化收藏按钮"),p.waitNode("#operate .collect-btn",1e4).then(e=>{e&&b.on(e,"click",async t=>{p.preventEvent(t);let n=e.querySelector(".collect"),o=e.querySelector(".uncollect"),l=await re.folderListWithCheck(window.location.origin+window.location.pathname);if(!l)return;let s=[];l.forEach(m=>{m.IsFavorite&&s.push(m.ID);});let c=m=>{let d=m.ID,f=b.createElement("li",{className:"csdn-collection-item",innerHTML:`
								...
								`},{"data-is-collect":m.IsFavorite});f.querySelector(".title-m");let w=f.querySelector(".csdn-collection-item_length");f.querySelector(".csdn-collection-controls");let D=f.querySelector(".collect-btn");return b.on(D,"click",async L=>{let E=y.articleDetailUrl;E==null&&(E=window.location.origin+window.location.pathname);let G=y.articleId;if(G==null){r.error("获取文章ID失败"),v.error("获取文章ID失败");return}let N=y.username;if(N==null){r.error("获取文章作者失败"),v.error("获取文章作者失败");return}let V=y.articleTitle;if(V==null&&(V=document.title.replace(/-CSDN博客$/,"")),V==null){r.error("获取文章标题失败"),v.error("获取文章标题失败");return}let x=y.articleDesc;if(x==null){let B=Se("meta[name='description']");B&&(x=B.getAttribute("content"));}if(x==null){r.error("获取文章描述失败"),v.error("获取文章描述失败");return}let _=[...s],A=v.loading("处理中...");try{let B=await re.checkFavoriteByUrl(E);if(B==null)return;r.info(d,B);let M=!B[d];if(M?(r.info("添加收藏"),_.push(d)):(r.info("取消收藏"),_.splice(_.indexOf(d),1)),!await re.addFavoriteInFolds({author:N,url:E,source:"blog",sourceId:G,title:V,description:x,fromType:"PC",username:m.Username,folderIdList:_}))return;let S=await re.checkFavoriteByUrl(E);if(S==null)return;r.info(d,S),f.setAttribute("data-is-collect",(!!S[d]).toString()),M?S[d]?(r.success("收藏成功"),v.success("收藏成功"),b.text(D,"已收藏"),s.includes(d)||s.push(d),m.FavoriteNum++):(r.error("收藏失败",S,d),v.error("收藏失败")):S[d]?(r.error("取消收藏失败",S,d),v.error("取消收藏失败")):(r.success("取消收藏成功"),v.success("取消收藏成功"),b.text(D,"收藏"),s.includes(d)&&s.splice(s.indexOf(d),1),m.FavoriteNum--),b.text(w,`${m.FavoriteNum}条内容`),Object.values(S).find($=>$)?(b.show(n,!1),b.hide(o,!1)):(b.show(o,!1),b.hide(n,!1)),A.close();}catch(B){r.error(B);}finally{A.close();}}),f},u=Y.alert({title:{text:"添加收藏夹",position:"center"},content:{text:`
...
`,Qe={init(){k(Ye),i.execMenuOnce("m-csdn-wenku-shieldBottomToolbar",()=>this.shieldBottomToolbar());},shieldBottomToolbar(){return r.info("【屏蔽】底部工具栏"),h.addBlockCSS(".page-container > div.btn")}},Xe=`/* 右下角悬浮图标 买1年送3个月 */\r
...
`,et={init(){i.execMenuOnce("m-csdn-download-removeAds",()=>k(Xe)),i.execMenuOnce("m-csdn-download-automaticallyExpandResourceIntroduction",()=>this.automaticallyExpandResourceIntroduction());},automaticallyExpandResourceIntroduction(){return r.info("自动展开资源介绍"),[h.addBlockCSS("label.unfold-font"),k(`
			.resource-desc{
				max-height: unset !important;

...
`,U={isSuccessResponse(e){return e==null?!1:(typeof e=="string"&&(e=f.toJSON(e)),(e==null?void 0:e.code)===200)}},P={async folderListWithCheck(e){let t=await R.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/folderListWithCheck",{data:{url:e},fetch:!0,allowInterceptConfig:!1,headers:{"User-Agent":f.getRandomPCUA()}});if(n.info(t),!t.status||!U.isSuccessResponse(t.data.responseText)){n.error("获取收藏夹信息失败，请求异常"),w.error("获取收藏夹信息失败");return}return f.toJSON(t.data.responseText).data.result},async addFavoriteInFolds(e){let t=await R.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/addFavoriteInFolds",{fetch:!0,data:e,headers:{"Content-Type":"application/json","User-Agent":f.getRandomPCUA()},allowInterceptConfig:!1});if(n.info(t),!t.status||!U.isSuccessResponse(t.data.responseText)){n.error("添加收藏失败，请求异常",t),w.error("添加收藏失败，请求异常");return}return !0},async checkFavoriteByUrl(e){debugger;let t=await R.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/checkFavoriteByUrl",{data:{url:e},fetch:!0,allowInterceptConfig:!1,headers:{"User-Agent":f.getRandomPCUA()}});if(n.info(t),!t.status||!U.isSuccessResponse(t.data.responseText)){n.error("检查收藏夹状态失败，请求异常"),w.error("检查收藏夹状态失败，请求异常");return}return f.toJSON(t.data.responseText).data},async createFolder(e){let t=await R.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/createFolder",{data:e,fetch:!0,headers:{Accept:"application/json, text/javascript, */*; q=0.01","Content-Type":"application/json","User-Agent":f.getRandomPCUA()},allowInterceptConfig:!1});if(n.info(t),!t.status||!U.isSuccessResponse(t.data.responseText)){w.error("创建收藏夹失败");return}return f.toJSON(t.data.responseText).data}},We={init(){this.addCSS(),r.execMenuOnce("m-csdn-blog-shieldTopToolbar",()=>this.shieldTopToolbar(),(e,t)=>!t,(e,t)=>!t),r.execMenuOnce("m-csdn-blog-notLimitCodePreMaxHeight",()=>this.notLimitCodePreMaxHeight()),r.execMenuOnce("m-csdn-blog-notLimitCommentMaxHeight",()=>this.notLimitCommentMaxHeight()),r.execMenuOnce("m-csdn-blog-allowSelectText",()=>this.allowSelectText()),r.execMenuOnce("m-csdn-blog-autoExpandContent",()=>this.autoExpandContent()),r.execMenuOnce("m-csdn-blog-bottomArticleEnable",()=>this.blockBottomArticle(),(e,t)=>!t,(e,t)=>!t),r.execMenuOnce("m-csdn-blog-comment-enable",()=>this.blockComment(),(e,t)=>!t,(e,t)=>!t),r.execMenuOnce("m-csdn-blog-bottom-toolbar-enable",()=>this.blockBottomToolBar(),(e,t)=>!t,(e,t)=>!t),r.execMenuOnce("m-csdn-blog-bottom-toolbar-always-bottom",()=>this.bottomToolBarAlwaysShow()),C.ready(()=>{r.execMenuOnce("m-csdn-blog-removeAds",()=>this.removeAds()),r.execMenuOnce("m-csdn-blog-refactoringRecommendation",()=>{this.refactoringRecommendation();}),r.execMenuOnce("m-csdn-blog-unBlockCopy",()=>{se.unBlockCopy();}),r.execMenuOnce("m-csdn-blog-bottom-toolbar-optimizationCollectButton",()=>{this.optimizationCollectButton();});});},addCSS(){b(He),b(Fe);},shieldTopToolbar(){return n.info("屏蔽顶部Toolbar"),[p.addBlockCSS("#csdn-toolbar"),b(`
      ...
      `)},allowSelectText(){return n.info("允许选择文字"),b(`
        ...
        `)},blockBottomToolBar(){return n.info("屏蔽底部工具栏"),p.addBlockCSS("#operate")},bottomToolBarAlwaysShow(){return n.info("底部工具栏常驻"),b(`
			...
			`)},optimizationCollectButton(){n.info("优化收藏按钮"),f.waitNode("#operate .collect-btn",1e4).then(e=>{e&&C.on(e,"click",async t=>{f.preventEvent(t);let o=e.querySelector(".collect"),l=e.querySelector(".uncollect"),a=await P.folderListWithCheck(window.location.origin+window.location.pathname);if(!a)return;let s=[];a.forEach(c=>{c.IsFavorite&&s.push(c.ID);});let m=c=>{let d=c.ID,u=C.createElement("li",{className:"csdn-collection-item",innerHTML:`
...
`,Ye={init(){r.execMenuOnce("m-csdn-download-removeAds",()=>b(Je)),r.execMenuOnce("m-csdn-download-automaticallyExpandResourceIntroduction",()=>this.automaticallyExpandResourceIntroduction());},automaticallyExpandResourceIntroduction(){return n.info("自动展开资源介绍"),[p.addBlockCSS("label.unfold-font"),b(`
			...
			`)]}},ee={init(){v.isLink()?(n.info("Router: 中转链接"),Ge.init()):v.isHuaWeiCloudBlog()?(n.info("Router: 华为云联盟"),qe.init()):v.isBlog()?(n.info("Router: 博客"),We.init()):v.isWenKu()?(n.info("Router: 文库"),Ke.init()):v.isDownload()?(n.info("Router: 资源下载"),Ye.init()):n.error("暂未适配，请反馈开发者："+globalThis.location.href);}};r.init();let de=f.isPhone(),A="change_env_set",k=B(A);ie.add({key:A,text:`⚙ 自动: ${de?"移动端":"PC端"}`,autoReload:!1,isStoreValue:!1,showText(e){return k==null?e:e+` 手动: ${k==1?"移动端":k==2?"PC端":"未知"}`},callback:()=>{let e=[0,1,2],t=window.prompt(`请输入当前脚本环境判定

自动判断: 0
移动端: 1
PC端: 2`,"0");if(!t)return;let o=parseInt(t);if(isNaN(o)){w.error("输入的不是规范的数字");return}if(!e.includes(o)){w.error("输入的值必须是0或1或2");return}o==0?oe(A):j(A,o);}});k!=null?(n.info(`手动判定为${k===1?"移动端":"PC端"}`),k==1?ee.init():k==2?X.init():(w.error("意外，手动判定的值不在范围内"),oe(A))):de?(n.info("自动判定为移动端"),ee.init()):(n.info("自动判定为PC端"),X.init());

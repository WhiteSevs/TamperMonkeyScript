...
`,Pe={init(){V.onceExec(`m-csdn-blog-removeAds`,()=>this.addCSS()),V.execMenuOnce(`m-csdn-blog-blockBottomAskAIToolbar`,()=>W.blockBottomAskAIToolbar())},addCSS(){return[k(Me),k(Ne)]}},Fe={init(){Pe.init()}},Ie={init(){U.isLink()?(E.info(`Router: 中转链接`),ge.init()):U.isBlog()?(E.info(`Router: 博客`),Fe.init(),U.isBlogArticle()&&(E.info(`Router: 文章`),De.init())):U.isWenKu()?(E.info(`Router: 文库`),ke.init()):U.isDownload()?(E.info(`Router: 资源下载`),je.init()):U.isDevPressArticle()?(E.info(`Router: 社区-文章`),be.init()):E.error(`暂未适配，请反馈开发者：`+globalThis.location.href)}},Le=`#chatgpt-article-detail > div.layout-center > div.main > div.article-box > div.cont.first-show.forbid {
  max-height: unset !important;
  height: auto !important;
  overflow: auto !important;
}

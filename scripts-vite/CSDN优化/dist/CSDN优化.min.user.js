...
`,W={init(){k(ve),V.execMenuOnce(`csdn-devpress-centerContent`,()=>this.centerContent()),V.execMenuOnce(`csdn-devpress-shieldCloudDeveloperTaskChallengeEvent`,()=>this.blockCloudDeveloperTaskChallengeEvent()),V.execMenuOnce(`csdn-devpress-autoExpandContent`,()=>this.autoExpandContent()),V.execMenuOnce(`csdn-devpress-shieldLeftFloatingButton`,()=>this.blockLeftFloatingButton()),V.execMenuOnce(`csdn-devpress-blockRightColumn`,()=>this.blockRightColumn()),V.execMenuOnce(`csdn-devpress-blockBottomCSo`,()=>this.blockBottomCSo()),V.execMenuOnce(`csdn-devpress-blockRecommendedContentAtTheBottom`,()=>this.blockRecommendedContentAtTheBottom()),V.execMenuOnce(`csdn-devpress-shieldTheBottomForMoreRecommendations`,()=>this.blockTheBottomForMoreRecommendations())},centerContent(){return E.info(`全文居中`),k(`
...
`,Ne={init(){V.onceExec(`m-csdn-blog-removeAds`,()=>this.addCSS()),V.execMenuOnce(`m-csdn-blog-blockBottomAskAIToolbar`,()=>G.blockBottomAskAIToolbar())},addCSS(){return[k(je),k(Me)]}},Pe={init(){Ne.init()}},Fe={init(){U.isLink()?(E.info(`Router: 中转链接`),ge.init()):U.isBlog()?(E.info(`Router: 博客`),Pe.init(),U.isBlogArticle()&&(E.info(`Router: 文章`),Ee.init())):U.isWenKu()?(E.info(`Router: 文库`),Oe.init()):U.isDownload()?(E.info(`Router: 资源下载`),Ae.init()):U.isDevPressArticle()?(E.info(`Router: 社区-文章`),ye.init()):E.error(`暂未适配，请反馈开发者：`+globalThis.location.href)}},Ie=`#chatgpt-article-detail > div.layout-center > div.main > div.article-box > div.cont.first-show.forbid {
  max-height: unset !important;
  height: auto !important;
  overflow: auto !important;
}

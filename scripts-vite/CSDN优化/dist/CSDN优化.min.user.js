...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof ue=="function"?ue(e.keyName):null;return typeof t=="string"&&t?R(t):k.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{q.onReady(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(i=>{i.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(i=>{i.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(i){navigator.clipboard.readText().then(r=>{i(r);}).catch(r=>{o.error("读取剪贴板内容失败👉",r),i("");});}function t(i){navigator.permissions.query({name:"clipboard-read"}).then(()=>{e(i);}).catch(r=>{o.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),e(i);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(i=>{if(!n()){i("");return}document.hasFocus()?t(i):window.addEventListener("focus",()=>{t(i);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let i,r=n-t,d=t,l=async w=>{const f=await e(w);if(typeof f=="boolean"&&f||w){C.workerClearTimeout(i);return}if(d+=t,d>r){l(true);return}i=C.workerSetTimeout(()=>{l(false);},t);};l(false);},findParentNode(e,t,n){if(n){let i=q.closest(e,n);if(i)return i.querySelector(t)}else return q.matches(e,t)?e:q.closest(e,t)},toStr(e,t=2){const n="__undefined__placeholder__replaced__str__"+performance.now();return JSON.stringify(e,(r,d)=>d===void 0?n:d,t).replace(new RegExp(`"${n}"`,"g"),"undefined")},isVerticalScreen(){return !globalThis.screen.orientation.type.includes("landscape")},isMobileDevice(e=768){return this.isVerticalScreen()?globalThis.innerWidth<e:globalThis.innerHeight<e},isTopWindow(){const e=typeof _=="object"&&_!=null?_:window;return e.top===e.self}},C=ge.noConflict(),c=q.noConflict(),W=Ce,o=new C.Log(te,_.console||Fe.console),we=te?.script?.name||void 0,Ge=Ce.fn.Utils.AnyTouch(),Pe=false;o.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});const Be=()=>{let t=100;const n=Ce.fn.InstanceUtils.getPopsMaxZIndex()?.zIndex??100,i=ge.getMaxZIndexNodeInfoFromPoint()[0]?.zIndex??100;return t=Math.max(t,n,i),t};x.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?o.warn(n):t==="error"?o.error(n):o.info(n),false},get position(){return a.getValue(ee.qmsg_config_position.key,ee.qmsg_config_position.defaultValue)},get maxNums(){return a.getValue(ee.qmsg_config_maxnums.key,ee.qmsg_config_maxnums.defaultValue)},get showReverse(){return a.getValue(ee.qmsg_config_showreverse.key,ee.qmsg_config_showreverse.defaultValue)},get zIndex(){return Be()}});W.GlobalConfig.setGlobalConfig({zIndex:()=>Be(),mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Ae=new C.GM_Menu({GM_getValue:ie,GM_setValue:be,GM_registerMenuCommand:Ie,GM_unregisterMenuCommand:Ne}),J=new C.Httpx({xmlHttpRequest:Ue,logDetails:Pe});J.interceptors.request.use(e=>e);J.interceptors.response.use(void 0,e=>(o.error("拦截器-请求错误",e),e.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),e));_.Object.defineProperty,_.Object.keys,_.Object.values,_.Function.prototype.apply,_.Function.prototype.call,_.Element.prototype.appendChild,_.setTimeout.bind(_),_.clearTimeout.bind(_),_.setInterval.bind(_),_.clearInterval.bind(_);const R=c.addStyle.bind(c),pe=q.selector.bind(q),De=q.selectorAll.bind(q);new C.GM_Cookie;const he="GM_Panel",qe="data-init",re="data-key",ae="data-default-value",He="data-init-more-value",We="data-plugin-search-config",Y="data-storage-api",z={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},H={setting:{get width(){return z.width<550?"88vw":z.width<700?"550px":"700px"},get height(){return z.height<450?"70vh":z.height<550?"450px":"550px"}},settingMiddle:{get width(){return z.width<350?"88vw":"350px"}},info:{get width(){return z.width<350?"88vw":"350px"},get height(){return z.height<250?"88vh":"250px"}}},Q={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new C.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(d,l)=>{typeof l!="string"&&(l=k.toStr(l));const w=new Blob([l]),f=globalThis.URL.createObjectURL(w);c.createElement("a",{href:f,download:d}).click(),C.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(f);},500);},i=()=>{const d=p=>{const u=W.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),E=S.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),P=S.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");c.on(E,"click",O=>{c.preventEvent(O);try{n(p,u),S.close();}catch(N){x.error(N.toString(),{consoleLogContent:true});}}),c.on(P,"click",async O=>{await C.copy(u)?(x.success("复制成功"),S.close()):x.error("复制失败");});},f=W.confirm({title:{text:"配置",position:"center"},content:{text:`
      ...
      `,...this.$data.panelConfig});this.$data.$panel=d,this.$data.panelContent=e,i||this.registerConfigSearch({$panel:d,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,i=async(u,S)=>{if(u==null)return;const E=await S(u);return E&&typeof E.isFind=="boolean"&&E.isFind?E.data:await i(E.data,S)},r=(u,S)=>{const E=new IntersectionObserver(P=>{P.forEach(O=>{O.isIntersecting&&(S?.(),E.disconnect());});},{root:null,threshold:1});E.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},d=u=>{const S="pops-flashing";c.onAnimationend(u,()=>{u.classList.remove(S);}),u.classList.add(S);},l=u=>{if(u.type==="dblclick"&&p)return;c.preventEvent(u);const S=W.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});S.$shadowRoot.querySelector(".search-wrapper");const E=S.$shadowRoot.querySelector(".search-config-text"),P=S.$shadowRoot.querySelector(".search-result-wrapper");E.focus();const O=()=>{c.empty(P);},N=T=>{const B=C.queryProperty(T,A=>A?.next?{isFind:false,data:A.next}:{isFind:true,data:A}),h=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),b=W.fn.PanelHandlerComponents();return c.on(h,"click",()=>{const D=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[T.index];if(!D){x.error(`左侧项下标${T.index}不存在`);return}D.scrollIntoView({behavior:"smooth",block:"center"}),D.click(),i(T.next,async v=>{if(v?.next){const M=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(y=>{const $=Reflect.get(y,b.$data.nodeStoreConfigKey);return typeof $=="object"&&$!=null&&$.text===v.name}),2500);if(M)M.click();else return x.error("未找到对应的二级菜单"),{isFind:true,data:v};return {isFind:false,data:v.next}}else {const M=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(y=>Reflect.get(y,b.$data.nodeStoreConfigKey)===v.matchedData?.formConfig),2500);if(M){r(M);const y=M.closest(".pops-panel-forms-fold[data-fold-enable]");y&&(y.querySelector(".pops-panel-forms-fold-container").click(),await C.sleep(500)),r(M,()=>{d(M);});}else x.error("未找到对应的菜单项");return {isFind:true,data:v}}});}),h},I=T=>{const B=new RegExp(T,"i"),h=[],b=(D,v)=>{for(let M=0;M<D.length;M++){const y=D[M],$=y.views;if($&&Array.isArray($)){const U=C.deepClone(v);if(y.type==="deepMenu"){const F=C.queryProperty(U,X=>X?.next?{isFind:false,data:X.next}:{isFind:true,data:X});F.next={name:y.text};}b($,U);}else {let U,F;if(y.type==="own"){const G=Reflect.get(y.attributes||{},We);G&&(typeof G.text=="string"&&(U=G.text),typeof G.desc=="string"&&(F=G.desc));}else U=y.text,F=Reflect.get(y,"description");const X=[U,F],Se=X.findIndex(G=>{if(typeof G=="string")return G.match(B)});if(Se!==-1){const G=C.deepClone(v),ke=C.queryProperty(G,j=>j?.next?{isFind:false,data:j.next}:{isFind:true,data:j});ke.next={name:U,matchedData:{path:"",formConfig:y,matchedText:X[Se],description:F}};const Te=[];C.queryProperty(G,j=>{const xe=j?.name;return typeof xe=="string"&&xe.trim()!==""&&Te.push(xe),j?.next?{isFind:false,data:j.next}:{isFind:true,data:j}});const Oe=Te.join(k.escapeHtml(" - "));ke.next.matchedData.path=Oe,h.push(G);}}}};for(let D=0;D<n.length;D++){const v=n[D];if(!v.views||v.isBottom&&v.id==="script-version")continue;const M=v.views;if(M&&Array.isArray(M)){let y=v.title;typeof y=="function"&&(y=y()),b(M,{index:D,name:y});}}const A=document.createDocumentFragment();for(const D of h){let v=N(D);A.appendChild(v);}O(),P.append(A);};c.on(E,"input",C.debounce(T=>{c.preventEvent(T);let B=c.val(E).trim();if(B===""){O();return}I(B);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(u=>{c.on(u,"dblclick",l);});let f=new WeakMap,m=false,g,p=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(u,S)=>{p=true,clearTimeout(g),g=void 0,m&&f.has(S)?(m=false,f.delete(S),l(u)):(g=setTimeout(()=>{m=false;},200),m=true,f.set(S,u));},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
    			.pops-flashing{

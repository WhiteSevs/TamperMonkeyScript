...
(function (x, q, we, Ce) {
  ...
  var Ie=typeof GM_addValueChangeListener<"u"?GM_addValueChangeListener:void 0,oe=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,ue=typeof GM_getResourceText<"u"?GM_getResourceText:void 0,ie=typeof GM_getValue<"u"?GM_getValue:void 0,te=typeof GM_info<"u"?GM_info:void 0,le=typeof GM_listValues<"u"?GM_listValues:void 0,Ne=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,Ue=typeof GM_removeValueChangeListener<"u"?GM_removeValueChangeListener:void 0,ge=typeof GM_setValue<"u"?GM_setValue:void 0,Te=typeof GM_setValues<"u"?GM_setValues:void 0,Fe=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Ge=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,_=typeof unsafeWindow<"u"?unsafeWindow:void 0,Pe=window;const ee={qmsg_config_position:{key:"qmsg-config-position",defaultValue:"bottom"},qmsg_config_maxnums:{key:"qmsg-config-maxnums",defaultValue:3},qmsg_config_showreverse:{key:"qmsg-config-showreverse",defaultValue:false}},k={waitRemove(...e){e.forEach(t=>{typeof t=="string"&&q.waitNodeList(t).then(n=>{n.forEach(i=>i.remove());});});},createBlockCSSNode(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(n=>{Array.isArray(n)?t=t.concat(n):t.push(n);}),q.createElement("style",{type:"text/css",innerHTML:`${t.join(`,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof ue=="function"?ue(e.keyName):null;return typeof t=="string"&&t?R(t):k.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{q.onReady(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(i=>{i.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(i=>{i.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(i){navigator.clipboard.readText().then(r=>{i(r);}).catch(r=>{o.error("读取剪贴板内容失败👉",r),i("");});}function t(i){navigator.permissions.query({name:"clipboard-read"}).then(()=>{e(i);}).catch(r=>{o.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),e(i);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(i=>{if(!n()){i("");return}document.hasFocus()?t(i):window.addEventListener("focus",()=>{t(i);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let i,r=n-t,d=t,l=async C=>{const f=await e(C);if(typeof f=="boolean"&&f||C){w.workerClearTimeout(i);return}if(d+=t,d>r){l(true);return}i=w.workerSetTimeout(()=>{l(false);},t);};l(false);},findParentNode(e,t,n){if(n){let i=q.closest(e,n);if(i)return i.querySelector(t)}else return q.matches(e,t)?e:q.closest(e,t)},toStr(e,t=2){const n="__undefined__placeholder__replaced__str__"+performance.now();return JSON.stringify(e,(r,d)=>d===void 0?n:d,t).replace(new RegExp(`"${n}"`,"g"),"undefined")},isVerticalScreen(){return !globalThis.screen.orientation.type.includes("landscape")},isMobileDevice(e=768){return this.isVerticalScreen()?globalThis.innerWidth<e:globalThis.innerHeight<e},isTopWindow(){const e=typeof _=="object"&&_!=null?_:window;return e.top===e.self}},w=Ce.noConflict(),c=q.noConflict(),W=we,o=new w.Log(te,_.console||Pe.console),xe=te?.script?.name||void 0,qe=we.fn.Utils.AnyTouch(),He=false;o.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});const Be=()=>{const t=we.fn.InstanceUtils.getPopsMaxZIndex()?.zIndex??0,n=w.getMaxZIndexNodeInfoFromPoint()[0]?.zIndex??0;return Math.max(100,t,n)};x.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?o.warn(n):t==="error"?o.error(n):o.info(n),false},get position(){return a.getValue(ee.qmsg_config_position.key,ee.qmsg_config_position.defaultValue)},get maxNums(){return a.getValue(ee.qmsg_config_maxnums.key,ee.qmsg_config_maxnums.defaultValue)},get showReverse(){return a.getValue(ee.qmsg_config_showreverse.key,ee.qmsg_config_showreverse.defaultValue)},get zIndex(){return Be()}});W.GlobalConfig.setGlobalConfig({zIndex:()=>Be(),mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Ae=new w.GM_Menu({GM_getValue:ie,GM_setValue:ge,GM_registerMenuCommand:Ne,GM_unregisterMenuCommand:Fe}),J=new w.Httpx({xmlHttpRequest:Ge,logDetails:He});J.interceptors.request.use(e=>e);J.interceptors.response.use(void 0,e=>(o.error("拦截器-请求错误",e),e.type==="onabort"?x.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?x.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?x.error("请求超时",{consoleLogContent:true}):x.error("其它错误",{consoleLogContent:true}),e));_.Object.defineProperty,_.Object.keys,_.Object.values,_.Function.prototype.apply,_.Function.prototype.call,_.Element.prototype.appendChild,_.setTimeout.bind(_),_.clearTimeout.bind(_),_.setInterval.bind(_),_.clearInterval.bind(_);const R=c.addStyle.bind(c),pe=q.selector.bind(q),De=q.selectorAll.bind(q);new w.GM_Cookie;const he="GM_Panel",We="data-init",re="data-key",ae="data-default-value",je="data-init-more-value",Ke="data-plugin-search-config",Y="data-storage-api",z={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},H={setting:{get width(){return z.width<550?"88vw":z.width<700?"550px":"700px"},get height(){return z.height<450?"70vh":z.height<550?"450px":"550px"}},settingMiddle:{get width(){return z.width<350?"88vw":"350px"}},info:{get width(){return z.width<350?"88vw":"350px"},get height(){return z.height<250?"88vh":"250px"}}},Q={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new w.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(d,l)=>{typeof l!="string"&&(l=k.toStr(l));const C=new Blob([l]),f=globalThis.URL.createObjectURL(C);c.createElement("a",{href:f,download:d}).click(),w.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(f);},500);},i=()=>{const d=p=>{const u=W.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),S=u.$shadowRoot.querySelector(".btn-control[data-mode='local']"),E=u.$shadowRoot.querySelector(".btn-control[data-mode='network']"),P=u.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),O=async I=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof le=="function"?typeof oe=="function"?(le().forEach(h=>{oe(h);}),x.success("已清空脚本存储的配置")):x.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):x.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof Te=="function"?Te(I):Object.keys(I).forEach(h=>{const b=I[h];ge(h,b);}),x.success("配置导入完毕");},N=I=>new Promise(async M=>{const B=w.toJSON(I);Object.keys(B).length===0?x.warning("解析为空配置，不导入"):await O(B),M(true);});c.on(S,"click",I=>{c.preventEvent(I),u.close();const M=c.createElement("input",{type:"file",accept:".json"});c.on(M,["propertychange","input"],B=>{if(!M.files?.length)return;const h=M.files[0],b=new FileReader;b.onload=()=>{N(b.result);},b.readAsText(h,"UTF-8");}),M.click();}),c.on(E,"click",I=>{c.preventEvent(I),u.close();const M=W.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(b,A){b.close();}},ok:{text:"导入",callback:async(b,A)=>{const D=b.text;if(w.isNull(D)){x.error("请填入完整的url");return}const v=x.loading("正在获取配置..."),T=await J.get(D,{allowInterceptConfig:false});if(v.close(),!T.status){o.error(T),x.error("获取配置失败",{consoleLogContent:true});return}await N(T.data.responseText)&&b.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:H.info.width,height:"auto"}),B=M.$shadowRoot.querySelector("input"),h=M.$shadowRoot.querySelector(".pops-prompt-btn-ok");c.on(B,["input","propertychange"],b=>{c.val(B)===""?c.attr(h,"disabled","true"):c.removeAttr(h,"disabled");}),c.onKeyboard(B,"keydown",(b,A,D)=>{b==="Enter"&&D.length===0&&c.val(B)!==""&&c.emit(h,"click");}),c.emit(B,"input");}),c.on(P,"click",async I=>{c.preventEvent(I),u.close();let M=await k.getClipboardText();if(M.trim()===""){x.warning("获取到的剪贴板内容为空");return}await N(M);});},l=(p=`${xe}_panel-setting-${w.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,u)=>{const S=W.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
      ...
      `,...this.$data.panelConfig});this.$data.$panel=d,this.$data.panelContent=e,i||this.registerConfigSearch({$panel:d,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,i=async(u,S)=>{if(u==null)return;const E=await S(u);return E&&typeof E.isFind=="boolean"&&E.isFind?E.data:await i(E.data,S)},r=(u,S)=>{const E=new IntersectionObserver(P=>{P.forEach(O=>{O.isIntersecting&&(S?.(),E.disconnect());});},{root:null,threshold:1});E.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},d=u=>{const S="pops-flashing";c.onAnimationend(u,()=>{u.classList.remove(S);}),u.classList.add(S);},l=u=>{if(u.type==="dblclick"&&p)return;c.preventEvent(u);const S=W.alert({title:{text:"搜索配置",position:"center"},content:{text:`
					...
					${e.searchDialogStyle??""}
				`});S.$shadowRoot.querySelector(".search-wrapper");const E=S.$shadowRoot.querySelector(".search-config-text"),P=S.$shadowRoot.querySelector(".search-result-wrapper");E.focus();const O=()=>{c.empty(P);},N=M=>{const B=w.queryProperty(M,A=>A?.next?{isFind:false,data:A.next}:{isFind:true,data:A}),h=c.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),b=W.fn.PanelHandlerComponents();return c.on(h,"click",()=>{const D=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[M.index];if(!D){x.error(`左侧项下标${M.index}不存在`);return}D.scrollIntoView({behavior:"smooth",block:"center"}),D.click(),i(M.next,async v=>{if(v?.next){const T=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(y=>{const V=Reflect.get(y,b.$data.nodeStoreConfigKey);return typeof V=="object"&&V!=null&&V.text===v.name}),2500);if(T)T.click();else return x.error("未找到对应的二级菜单"),{isFind:true,data:v};return {isFind:false,data:v.next}}else {const T=await c.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(y=>Reflect.get(y,b.$data.nodeStoreConfigKey)===v.matchedData?.formConfig),2500);if(T){r(T);const y=T.closest(".pops-panel-forms-fold[data-fold-enable]");y&&(y.querySelector(".pops-panel-forms-fold-container").click(),await w.sleep(500)),r(T,()=>{d(T);});}else x.error("未找到对应的菜单项");return {isFind:true,data:v}}});}),h},I=M=>{const B=new RegExp(M,"i"),h=[],b=(D,v)=>{for(let T=0;T<D.length;T++){const y=D[T],V=y.views;if(V&&Array.isArray(V)){const F=w.deepClone(v);if(y.type==="deepMenu"){const G=w.queryProperty(F,X=>X?.next?{isFind:false,data:X.next}:{isFind:true,data:X});G.next={name:y.text};}b(V,F);}else {let F,G;if(y.type==="own"){let U=Reflect.get(y.attributes||{},Ke);U&&(typeof U=="function"&&(U=U()),typeof U.text=="string"&&(F=U.text),typeof U.desc=="string"&&(G=U.desc));}else F=y.text,G=Reflect.get(y,"description");const X=[F,G],Se=X.findIndex(U=>{if(typeof U=="string")return U.match(B)});if(Se!==-1){const U=w.deepClone(v),ke=w.queryProperty(U,j=>j?.next?{isFind:false,data:j.next}:{isFind:true,data:j});ke.next={name:F,matchedData:{path:"",formConfig:y,matchedText:X[Se],description:G}};const Me=[];w.queryProperty(U,j=>{const be=j?.name;return typeof be=="string"&&be.trim()!==""&&Me.push(be),j?.next?{isFind:false,data:j.next}:{isFind:true,data:j}});const Oe=Me.join(k.escapeHtml(" - "));ke.next.matchedData.path=Oe,h.push(U);}}}};for(let D=0;D<n.length;D++){const v=n[D];if(!v.views||v.isBottom&&v.id==="script-version")continue;const T=v.views;if(T&&Array.isArray(T)){let y=v.title;typeof y=="function"&&(y=y()),b(T,{index:D,name:y});}}const A=document.createDocumentFragment();for(const D of h){let v=N(D);A.appendChild(v);}O(),P.append(A);};c.on(E,"input",w.debounce(M=>{c.preventEvent(M);let B=c.val(E).trim();if(B===""){O();return}I(B);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(u=>{c.on(u,"dblclick",l);});let f=new WeakMap,m=false,g,p=false;c.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(u,S)=>{p=true,clearTimeout(g),g=void 0,m&&f.has(S)?(m=false,f.delete(S),l(u)):(g=setTimeout(()=>{m=false;},200),m=true,f.set(S,u));},{capture:true}),t.$shadowRoot.appendChild(c.createElement("style",{type:"text/css",textContent:`
    			.pops-flashing{
...
`,et=`.ecommend-item-box.recommend-recommend-box,
.login-mark,
.opt-box.text-center,
.leftPop,
#csdn-shop-window,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ue=="function"?ue(e.keyName):"";typeof t=="string"&&t?R(t):$.loadStyleLink(e.url);},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,c.onReady(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;let t=new URL(e);return t.protocol="https:",t.toString()}},tt={init(){a.execMenuOnce("m-csdn-blog-blockBottomArticle",()=>this.blockBottomArticle()),a.execMenuOnce("m-csdn-blog-removeResourceArticle",()=>this.removeResourceArticle()),a.execMenuOnce("m-csdn-blog-openNewTab",()=>this.openNewTab()),c.onReady(()=>{a.execMenuOnce("m-csdn-blog-refactoringRecommendation",e=>this.refactoringRecommendation());});},blockBottomArticle(){return o.info("【屏蔽】底部文章"),$.addBlockCSS("#recommend")},async refactoringRecommendation(){const e=function(){De(".container-fluid").forEach(r=>{let d="",l="",C="",f="";if(r.hasAttribute("data-url")){if(d=r.getAttribute("data-url"),l=r.querySelector(".recommend_title div.left")?.innerHTML,!r.querySelector(".text"))return;C=r.querySelector(".text")?.innerHTML,r.querySelectorAll(".recommend-img").length&&r.querySelectorAll(".recommend-img").forEach(g=>{f+=g.innerHTML;});}else d=r.querySelector("a[data-type]").getAttribute("href"),l=r.querySelector(".recommend_title div.left").innerHTML,C=r.querySelector(".text").innerHTML;const m=new URL(d);m.host==="download.csdn.net"||m.host==="www.iteye.com"&&m.pathname.match(/^\/resource/gi)?l='<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>'+l:m.origin.match(/edu.csdn.net/gi)&&(l='<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>'+l),r.setAttribute("class","GM-csdn-dl"),r.setAttribute("data-url",d),r.innerHTML=`<div class="GM-csdn-title"><div class="left">${l}</div></div><div class="GM-csdn-content">${C}</div><div class="GM-csdn-img">${f}</div>`,r.addEventListener("click",function(){window.location.href=d;});});},t=new w.LockFunction(e,50),n=await c.waitNode("#recommend");o.info("重构底部推荐");const i=w.mutationObserver(n,{config:{childList:true,subtree:true,attributes:true},immediate:true,callback:()=>{t.run();}});return [()=>{i.disconnect();}]},removeResourceArticle(){return o.info("移除资源下载的文章"),$.addBlockCSS('.container-fluid:has(a[href*="https://download.csdn.net/"])','.container-fluid[data-url*="https://download.csdn.net/"]','.GM-csdn-dl[data-url*="https://download.csdn.net/"]')},openNewTab(){return o.info("新标签页打开"),c.on(document,"click",[".container-fluid",".GM-csdn-dl"],(t,n)=>{c.preventEvent(t);const i=n.getAttribute("data-url");typeof i=="string"?(o.info(`新标签页打开：${i}`),window.open(i,"_blank")):x.error("未获取到data-url属性");},{capture:true}).off}},se={isSuccessResponse(e){return e==null?false:(typeof e=="string"&&(e=w.toJSON(e)),e?.code===200)}},ce={async folderListWithCheck(e){const t=await J.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/folderListWithCheck",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":w.getRandomPCUA()}});o.info(t);const n=w.toJSON(t.data.responseText);if(!t.status||!se.isSuccessResponse(t.data.responseText)){o.error("获取收藏夹信息失败，请求异常"),typeof n.msg=="string"?x.error(n.msg):x.error("获取收藏夹信息失败");return}return n.data.result},async addFavoriteInFolds(e){const t=await J.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/addFavoriteInFolds",{fetch:true,data:e,headers:{"Content-Type":"application/json","User-Agent":w.getRandomPCUA()},allowInterceptConfig:false});if(o.info(t),!t.status||!se.isSuccessResponse(t.data.responseText)){o.error("添加收藏失败，请求异常",t),x.error("添加收藏失败，请求异常");return}return  true},async checkFavoriteByUrl(e){const t=await J.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/checkFavoriteByUrl",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":w.getRandomPCUA()}});if(o.info(t),!t.status||!se.isSuccessResponse(t.data.responseText)){o.error("检查收藏夹状态失败，请求异常"),x.error("检查收藏夹状态失败，请求异常");return}return w.toJSON(t.data.responseText).data},async createFolder(e){const t=await J.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/createFolder",{data:e,fetch:true,headers:{Accept:"application/json, text/javascript, */*; q=0.01","Content-Type":"application/json","User-Agent":w.getRandomPCUA()},allowInterceptConfig:false});if(o.info(t),!t.status||!se.isSuccessResponse(t.data.responseText)){x.error("创建收藏夹失败");return}return w.toJSON(t.data.responseText).data}},nt={init(){a.execMenuOnce("m-csdn-blog-blockBottomToolbar",()=>this.blockBottomToolbar()),a.execMenuOnce("m-csdn-blog-bottom-toolbar-always-bottom",()=>this.bottomToolBarAlwaysShow()),c.onReady(()=>{a.execMenuOnce("m-csdn-blog-bottom-toolbar-optimizationCollectButton",()=>this.optimizationCollectButton());});},blockBottomToolbar(){return o.info("【屏蔽】底部工具栏"),$.addBlockCSS("#operate")},bottomToolBarAlwaysShow(){return o.info("底部工具栏常驻"),R(`
    ...
    `)},async optimizationCollectButton(){o.info("优化收藏按钮");const e=await c.waitNode("#operate .collect-btn",1e4);if(!e)return;const t=c.on(e,"click",async n=>{c.preventEvent(n);const i=e.querySelector(".collect"),r=e.querySelector(".uncollect"),d=await ce.folderListWithCheck(window.location.origin+window.location.pathname);if(!d)return;const l=[];d.forEach(g=>{g.IsFavorite&&l.push(g.ID);});const C=g=>{let p=g.ID,u=c.createElement("li",{className:"csdn-collection-item",innerHTML:`
            ...
            `},{"data-is-collect":g.IsFavorite});u.querySelector(".title-m");let S=u.querySelector(".csdn-collection-item_length");u.querySelector(".csdn-collection-controls");let E=u.querySelector(".collect-btn");return c.on(E,"click",async P=>{let O=_.articleDetailUrl;O==null&&(O=window.location.origin+window.location.pathname);let N=_.articleId;if(N==null){o.error("获取文章ID失败"),x.error("获取文章ID失败");return}let I=_.username;if(I==null){o.error("获取文章作者失败"),x.error("获取文章作者失败");return}let M=_.articleTitle;if(M==null&&(M=document.title.replace(/-CSDN博客$/,"")),M==null){o.error("获取文章标题失败"),x.error("获取文章标题失败");return}let B=_.articleDesc;if(B==null){const A=pe("meta[name='description']");A&&(B=A.getAttribute("content"));}if(B==null){o.error("获取文章描述失败"),x.error("获取文章描述失败");return}const h=[...l];let b=x.loading("处理中...");try{let A=await ce.checkFavoriteByUrl(O);if(A==null)return;o.info(p,A);let D=!A[p];if(D?(o.info("添加收藏"),h.push(p)):(o.info("取消收藏"),h.splice(h.indexOf(p),1)),!await ce.addFavoriteInFolds({author:I,url:O,source:"blog",sourceId:N,title:M,description:B,fromType:"PC",username:g.Username,folderIdList:h}))return;const T=await ce.checkFavoriteByUrl(O);if(T==null)return;o.info(p,T),u.setAttribute("data-is-collect",(!!T[p]).toString()),D?T[p]?(o.success("收藏成功"),x.success("收藏成功"),c.text(E,"已收藏"),l.includes(p)||l.push(p),g.FavoriteNum++):(o.error("收藏失败",T,p),x.error("收藏失败")):T[p]?(o.error("取消收藏失败",T,p),x.error("取消收藏失败")):(o.success("取消收藏成功"),x.success("取消收藏成功"),c.text(E,"收藏"),l.includes(p)&&l.splice(l.indexOf(p),1),g.FavoriteNum--),c.text(S,`${g.FavoriteNum}条内容`),Object.values(T).find(V=>V)?(c.show(i,!1),c.hide(r,!1)):(c.show(r,!1),c.hide(i,!1)),b.close();}catch(A){o.error(A);}finally{b.close();}}),u},m=W.alert({title:{text:"添加收藏夹",position:"center"},content:{text:`
        ...
        `}).$shadowRoot.querySelector(".csdn-collection-items");d.forEach(g=>{const p=C(g);m.appendChild(p);});},{capture:true});return [()=>{t.off();}]}},ot={init(){a.execMenuOnce("m-csdn-blog-blockComment",()=>this.blockComment()),a.execMenuOnce("m-csdn-blog-notLimitCommentMaxHeight",()=>this.notLimitCommentMaxHeight());},blockComment(){return o.info("【屏蔽】评论区"),$.addBlockCSS("#comment")},notLimitCommentMaxHeight(){return o.info("不限制评论区的最大高度"),R(`
        #comment{
          max-height: none !important;
        }
      `)}},it={init(){ot.init(),tt.init(),nt.init(),a.execMenuOnce("m-csdn-blog-blockTopToolbar",()=>this.blockTopToolbar()),a.execMenuOnce("m-csdn-blog-removeAds",()=>this.removeAds()),a.execMenuOnce("m-csdn-blog-allowSelectText",()=>this.allowSelectText()),a.execMenuOnce("m-csdn-blog-autoExpandContent",()=>this.autoExpandContent()),a.execMenuOnce("m-csdn-blog-notLimitCodePreMaxHeight",()=>this.notLimitCodePreMaxHeight()),c.onReady(()=>{a.execMenuOnce("m-csdn-blog-unBlockCopy",()=>{$e.unBlockCopy();});});},blockTopToolbar(){return o.info("屏蔽顶部Toolbar"),[k.addBlockCSS("#csdn-toolbar"),R(`
			/* 内容顶部要归位 */
			body #main,
			.margin_sides{
...
`,at={init(){R(rt),a.execMenuOnce("m-csdn-wenku-shieldBottomToolbar",()=>this.shieldBottomToolbar());},shieldBottomToolbar(){return o.info("【屏蔽】底部工具栏"),k.addBlockCSS(".page-container > div.btn")}},lt=`/* 右下角悬浮图标 买1年送3个月 */
...
`,st={init(){a.execMenuOnce("m-csdn-download-removeAds",()=>R(lt)),a.execMenuOnce("m-csdn-download-automaticallyExpandResourceIntroduction",()=>this.automaticallyExpandResourceIntroduction());},automaticallyExpandResourceIntroduction(){return o.info("自动展开资源介绍"),[k.addBlockCSS("label.unfold-font"),R(`
			.resource-desc{
				max-height: unset !important;
...
`,ut={init(){a.onceExec("m-csdn-blog-removeAds",()=>this.addCSS()),a.execMenuOnce("m-csdn-blog-blockBottomAskAIToolbar",()=>fe.blockBottomAskAIToolbar());},addCSS(){return [R(ct),R(dt)]}},pt={init(){ut.init();}},_e={init(){L.isLink()?(o.info("Router: 中转链接"),Je.init()):L.isHuaWeiCloudBlog()?(o.info("Router: 华为云联盟"),Qe.init()):L.isBlog()?(o.info("Router: 博客"),pt.init(),L.isBlogArticle()&&(o.info("Router: 文章"),it.init())):L.isWenKu()?(o.info("Router: 文库"),at.init()):L.isDownload()?(o.info("Router: 资源下载"),st.init()):o.error("暂未适配，请反馈开发者："+globalThis.location.href);}},ht=`#chatgpt-article-detail > div.layout-center > div.main > div.article-box > div.cont.first-show.forbid {
  max-height: unset !important;
  height: auto !important;
  overflow: auto !important;
}
...
`,mt={init(){R(ht),R(ft),a.execMenuOnce("csdn-wenku-shieldResourceRecommend",()=>this.shieldResourceRecommend()),a.execMenuOnce("csdn-wenku-shieldRightUserInfo",()=>this.shieldRightUserInfo()),a.execMenuOnce("csdn-wenku-shieldRightToolBar",()=>this.shieldRightToolBar());},shieldResourceRecommend(){return o.info("【屏蔽】资源推荐"),k.addBlockCSS("#recommend")},shieldRightUserInfo(){return o.info("【屏蔽】右侧用户信息"),k.addBlockCSS(".layout-right")},shieldRightToolBar(){return o.info("【屏蔽】右侧悬浮工具栏"),k.addBlockCSS(".csdn-side-toolbar")}},gt={init(){a.execMenuOnce("csdn-blog-shieldBottomSkillTree",()=>this.shieldBottomSkillTree()),a.execMenuOnce("csdn-blog-shieldArticleSearchTip",()=>this.shieldArticleSearchTip()),a.execMenuOnce("csdn-blog-blockGitCodeLinkCard",()=>this.blockGitCodeLinkCard());},shieldBottomSkillTree(){return o.info("【屏蔽】底部xx技能树"),k.addBlockCSS("#treeSkill")},shieldArticleSearchTip(){return o.info("【屏蔽】选中文字悬浮栏"),k.addBlockCSS("#articleSearchTip")},blockGitCodeLinkCard(){return o.info("【屏蔽】gitcode链接卡片"),k.addBlockCSS('a.has-card[href*="gitcode.com"]',".t2-card-container")}},bt=`.main_father {

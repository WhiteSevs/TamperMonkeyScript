...
`,ve={init(){k(_e),V.execMenuOnce(`csdn-hua-wei-cloud-shieldCloudDeveloperTaskChallengeEvent`,()=>this.shieldCloudDeveloperTaskChallengeEvent()),V.execMenuOnce(`csdn-hua-wei-cloud-autoExpandContent`,()=>this.autoExpandContent()),V.execMenuOnce(`csdn-hua-wei-cloud-shieldLeftFloatingButton`,()=>this.shieldLeftFloatingButton()),V.execMenuOnce(`csdn-hua-wei-cloud-blockRightColumn`,()=>this.blockRightColumn()),V.execMenuOnce(`csdn-hua-wei-cloud-blockRecommendedContentAtTheBottom`,()=>this.blockRecommendedContentAtTheBottom()),V.execMenuOnce(`csdn-hua-wei-cloud-shieldTheBottomForMoreRecommendations`,()=>this.shieldTheBottomForMoreRecommendations())},autoExpandContent(){return E.info(`自动展开全文`),[S.addBlockCSS(`div.article-show-more`),k(`
			/* 自动展开全文 */
			.main-content .user-article{
				height: auto !important;
				overflow: auto !important;
			}
			`)]},shieldCloudDeveloperTaskChallengeEvent(){return E.info(`屏蔽云开发者任务挑战活动`),S.addBlockCSS(`.luck-draw-modal-warp`)},shieldLeftFloatingButton(){return E.info(`屏蔽左侧悬浮按钮，包括当前阅读量、点赞按钮、评论按钮、分享按钮`),S.addBlockCSS(`div.toolbar-wrapper.article-interact-bar`)},blockRightColumn(){return E.info(`屏蔽右侧栏，包括相关产品-活动日历-运营活动-热门标签`),S.addBlockCSS(`div.page-home-right.dp-aside-right`)},blockRecommendedContentAtTheBottom(){return E.info(`屏蔽底部推荐内容`),S.addBlockCSS(`div.recommend-card-box`)},shieldTheBottomForMoreRecommendations(){return E.info(`屏蔽底部更多推荐`),S.addBlockCSS(`div.more-article`)}},ye={init(){k(ge),V.execMenuOnce(`m-csdn-hua-wei-cloud-autoExpandContent`,()=>ve.autoExpandContent()),V.execMenuOnce(`m-csdn-hua-wei-cloud-blockBottomJoinTheCommunity`,()=>this.blockBottomJoinTheCommunity())},blockBottomJoinTheCommunity(){return E.info(`【屏蔽】底部加入社区`),S.addBlockCSS(`.user-desc`)}},be=`/*.blog_container_aside,
#nav {
	margin-left: -45px;
}
...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof m==`function`?m(e.keyName):``;typeof t==`string`&&t?k(t):G.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement(`link`);t.rel=`stylesheet`,t.type=`text/css`,t.href=e,w.onReady(()=>{document.head.appendChild(t)})},async loadScript(e){let t=document.createElement(`script`);return t.src=e,new Promise(e=>{t.onload=()=>{e(null)},(document.head||document.documentElement).appendChild(t)})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)?e:(e.startsWith(`/`)||(e+=`/`),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith(`https://`)||!e.startsWith(`http://`))return e;let t=new URL(e);return t.protocol=`https:`,t.toString()}},Ce={init(){V.execMenuOnce(`m-csdn-blog-blockBottomArticle`,()=>this.blockBottomArticle()),V.execMenuOnce(`m-csdn-blog-removeResourceArticle`,()=>this.removeResourceArticle()),V.execMenuOnce(`m-csdn-blog-openNewTab`,()=>this.openNewTab()),w.onReady(()=>{V.execMenuOnce(`m-csdn-blog-refactoringRecommendation`,e=>this.refactoringRecommendation())})},blockBottomArticle(){return E.info(`【屏蔽】底部文章`),G.addBlockCSS(`#recommend`)},async refactoringRecommendation(){let e=new C.LockFunction(function(){ce(`.container-fluid`).forEach(e=>{let t=``,n=``,r=``,i=``;if(e.hasAttribute(`data-url`)){if(t=e.getAttribute(`data-url`),n=e.querySelector(`.recommend_title div.left`)?.innerHTML,!e.querySelector(`.text`))return;r=e.querySelector(`.text`)?.innerHTML,e.querySelectorAll(`.recommend-img`).length&&e.querySelectorAll(`.recommend-img`).forEach(e=>{i+=e.innerHTML})}else t=e.querySelector(`a[data-type]`).getAttribute(`href`),n=e.querySelector(`.recommend_title div.left`).innerHTML,r=e.querySelector(`.text`).innerHTML;let a=new URL(t);a.host===`download.csdn.net`||a.host===`www.iteye.com`&&a.pathname.match(/^\/resource/gi)?n=`<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>`+n:a.origin.match(/edu.csdn.net/gi)&&(n=`<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>`+n),e.setAttribute(`class`,`GM-csdn-dl`),e.setAttribute(`data-url`,t),e.innerHTML=`<div class="GM-csdn-title"><div class="left">${n}</div></div><div class="GM-csdn-content">${r}</div><div class="GM-csdn-img">${i}</div>`,e.addEventListener(`click`,function(){window.location.href=t})})},50),t=await w.waitNode(`#recommend`);E.info(`重构底部推荐`);let n=C.mutationObserver(t,{config:{childList:!0,subtree:!0,attributes:!0},immediate:!0,callback:()=>{e.run()}});return[()=>{n.disconnect()}]},removeResourceArticle(){return E.info(`移除资源下载的文章`),G.addBlockCSS(`.container-fluid:has(a[href*="https://download.csdn.net/"])`,`.container-fluid[data-url*="https://download.csdn.net/"]`,`.GM-csdn-dl[data-url*="https://download.csdn.net/"]`)},openNewTab(){return E.info(`新标签页打开`),w.on(document,`click`,[`.container-fluid`,`.GM-csdn-dl`],(t,n)=>{w.preventEvent(t);let r=n.getAttribute(`data-url`);typeof r==`string`?(E.info(`新标签页打开：${r}`),window.open(r,`_blank`)):e.default.error(`未获取到data-url属性`)},{capture:!0}).off}},K={isSuccessResponse(e){return e==null?!1:(typeof e==`string`&&(e=C.toJSON(e)),e?.code===200)}},q={async folderListWithCheck(t){let n=await O.get(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/folderListWithCheck`,{data:{url:t},fetch:!0,allowInterceptConfig:!1,headers:{"User-Agent":C.getRandomPCUA()}});E.info(n);let r=C.toJSON(n.data.responseText);if(!n.status||!K.isSuccessResponse(n.data.responseText)){E.error(`获取收藏夹信息失败，请求异常`),typeof r.msg==`string`?e.default.error(r.msg):e.default.error(`获取收藏夹信息失败`);return}return r.data.result},async addFavoriteInFolds(t){let n=await O.post(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/addFavoriteInFolds`,{fetch:!0,data:t,headers:{"Content-Type":`application/json`,"User-Agent":C.getRandomPCUA()},allowInterceptConfig:!1});if(E.info(n),!n.status||!K.isSuccessResponse(n.data.responseText)){E.error(`添加收藏失败，请求异常`,n),e.default.error(`添加收藏失败，请求异常`);return}return!0},async checkFavoriteByUrl(t){let n=await O.get(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/checkFavoriteByUrl`,{data:{url:t},fetch:!0,allowInterceptConfig:!1,headers:{"User-Agent":C.getRandomPCUA()}});if(E.info(n),!n.status||!K.isSuccessResponse(n.data.responseText)){E.error(`检查收藏夹状态失败，请求异常`),e.default.error(`检查收藏夹状态失败，请求异常`);return}return C.toJSON(n.data.responseText).data},async createFolder(t){let n=await O.post(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/createFolder`,{data:t,fetch:!0,headers:{Accept:`application/json, text/javascript, */*; q=0.01`,"Content-Type":`application/json`,"User-Agent":C.getRandomPCUA()},allowInterceptConfig:!1});if(E.info(n),!n.status||!K.isSuccessResponse(n.data.responseText)){e.default.error(`创建收藏夹失败`);return}return C.toJSON(n.data.responseText).data}},we={init(){V.execMenuOnce(`m-csdn-blog-blockBottomToolbar`,()=>this.blockBottomToolbar()),V.execMenuOnce(`m-csdn-blog-bottom-toolbar-always-bottom`,()=>this.bottomToolBarAlwaysShow()),w.onReady(()=>{V.execMenuOnce(`m-csdn-blog-bottom-toolbar-optimizationCollectButton`,()=>this.optimizationCollectButton())})},blockBottomToolbar(){return E.info(`【屏蔽】底部工具栏`),G.addBlockCSS(`#operate`)},bottomToolBarAlwaysShow(){return E.info(`底部工具栏常驻`),k(`
    ...
    `)},async optimizationCollectButton(){E.info(`优化收藏按钮`);let t=await w.waitNode(`#operate .collect-btn`,1e4);if(!t)return;let n=w.on(t,`click`,async n=>{w.preventEvent(n);let r=t.querySelector(`.collect`),i=t.querySelector(`.uncollect`),a=await q.folderListWithCheck(window.location.origin+window.location.pathname);if(!a)return;let o=[];a.forEach(e=>{e.IsFavorite&&o.push(e.ID)});let s=t=>{let n=t.ID,a=w.createElement(`li`,{className:`csdn-collection-item`,innerHTML:`
        ...
        `}).$shadowRoot.querySelector(`.csdn-collection-items`);a.forEach(e=>{let t=s(e);c.appendChild(t)})},{capture:!0});return[()=>{n.off()}]}},Te={init(){V.execMenuOnce(`m-csdn-blog-blockComment`,()=>this.blockComment()),V.execMenuOnce(`m-csdn-blog-notLimitCommentMaxHeight`,()=>this.notLimitCommentMaxHeight())},blockComment(){return E.info(`【屏蔽】评论区`),G.addBlockCSS(`#comment`)},notLimitCommentMaxHeight(){return E.info(`不限制评论区的最大高度`),k(`
        #comment{
...
`,Ne={init(){V.onceExec(`m-csdn-blog-removeAds`,()=>this.addCSS()),V.execMenuOnce(`m-csdn-blog-blockBottomAskAIToolbar`,()=>W.blockBottomAskAIToolbar())},addCSS(){return[k(je),k(Me)]}},Pe={init(){Ne.init()}},Fe={init(){U.isLink()?(E.info(`Router: 中转链接`),he.init()):U.isHuaWeiCloudBlog()?(E.info(`Router: 华为云联盟`),ye.init()):U.isBlog()?(E.info(`Router: 博客`),Pe.init(),U.isBlogArticle()&&(E.info(`Router: 文章`),Ee.init())):U.isWenKu()?(E.info(`Router: 文库`),Oe.init()):U.isDownload()?(E.info(`Router: 资源下载`),Ae.init()):E.error(`暂未适配，请反馈开发者：`+globalThis.location.href)}},Ie=`#chatgpt-article-detail > div.layout-center > div.main > div.article-box > div.cont.first-show.forbid {
  max-height: unset !important;
  height: auto !important;
  overflow: auto !important;
}
...
`,Ze={init(){k(Xe),U.isLink()?(E.info(`Router: 中转链接`),me.init()):U.isHuaWeiCloudBlog()?(E.info(`Router: 华为云联盟`),ve.init()):U.isBlog()?(E.info(`Router: 博客`),Se.init(),U.isBlogArticle()&&(E.info(`Router: 帖子`),qe.init())):U.isWenKu()?(E.info(`Router: 文库`),Re.init()):U.isDownload()?(E.info(`Router: 下载`),Ye.init()):E.error(`暂未适配，请反馈开发者：`+globalThis.location.href)}},J=function(e,t,n,r,i,a,o){let s={text:e,type:`select`,description:a,attributes:{},props:{},getValue(){return this.props[F].get(t,n)},callback(e){if(e==null)return;let n=e.value;E.info(`选择：${e.text}`),!(typeof i==`function`&&i(e))&&(this.props[F].set(t,n),typeof o==`function`&&o(e))},data:r};return Reflect.set(s.attributes,N,t),Reflect.set(s.attributes,P,n),X.initComponentsStorageApi(`select`,s,{get(e,t){return V.getValue(e,t)},set(e,t){V.setValue(e,t)}}),s},Y=function(e,t,n,r,i,a,o,s,c,l){let u={text:e,type:`slider`,description:s,attributes:{},props:{},getValue(){return this.props[F].get(t,n)},getToolTipContent(e){return typeof o==`function`?o(e):`${e}`},callback(e,n){typeof a==`function`&&a(e,n)||(this.props[F].set(t,n),typeof l==`function`&&l(e,n))},min:r,max:i,step:c};return Reflect.set(u.attributes,N,t),Reflect.set(u.attributes,P,n),X.initComponentsStorageApi(`slider`,u,{get(e,t){return V.getValue(e,t)},set(e,t){V.setValue(e,t)}}),u},X={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||=new r.default.Dictionary,this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t)},initComponentsStorageApi(e,t,n){let r;r=this.hasStorageApi(e)?this.getStorageApi(e):n,this.setComponentsStorageApiProperty(t,r)},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,F,t)}},Z=function(t,n,r=!1,i,a,o,s,c,l){if(l&&typeof l.defaultValue==`object`&&l.defaultValue!=null){let e=l.key??n;l.handler.add({key:e,name:t}),l.handler.shortCut.initConfig(e,l.defaultValue)}let u={text:t,type:`switch`,description:a,disabled:s,attributes:{},props:{},getValue(){return this.props[F].get(n,r)},callback(e,r){let a=!!r;E.success(`${a?`开启`:`关闭`} ${t}`),!(typeof i==`function`&&i(e,a))&&(this.props[F].set(n,a),typeof c==`function`&&c(e,a))},afterAddToUListCallBack:(...r)=>{if(o?.(...r),l){let i=l.handler.shortCut,a=l.key??n,[o,s]=r,c=s.target?.querySelector(`.pops-panel-item-left-main-text`);if(!c)return;let u=()=>{let e=l.handler.shortCut.getShowText(a,`暂未录入快捷键`),n=w.createElement(`div`,{className:`pops-switch-shortcut-wrapper`,innerHTML:`

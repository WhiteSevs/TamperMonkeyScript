...
(function (v, z, O, G) {
	...
	var H=typeof GM_deleteValue<"u"?GM_deleteValue:void 0,T=typeof GM_getValue<"u"?GM_getValue:void 0,R=typeof GM_info<"u"?GM_info:void 0,J=typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand:void 0,D=typeof GM_setValue<"u"?GM_setValue:void 0,Y=typeof GM_unregisterMenuCommand<"u"?GM_unregisterMenuCommand:void 0,Z=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0,x=typeof unsafeWindow<"u"?unsafeWindow:void 0,Q=window;const X="CSDN优化",p=O.noConflict(),S=z.noConflict(),L=G,o=new p.Log(R,x.console||Q.console);var N;const A=((N=R==null?void 0:R.script)==null?void 0:N.name)||X,P=!1;o.config({debug:P,logMaxCount:1e3,autoClearConsole:!0,tag:!0});v.config(Object.defineProperties({html:!0,autoClose:!0,showClose:!1},{position:{get(){return r.getValue("qmsg-config-position","bottom")}},maxNums:{get(){return r.getValue("qmsg-config-maxnums",5)}},showReverse:{get(){return r.getValue("qmsg-config-showreverse",!0)}},zIndex:{get(){let e=O.getMaxZIndex(),t=G.config.InstanceUtils.getPopsMaxZIndex(e).zIndex;return O.getMaxValue(e,t)+100}}}));const U=new p.GM_Menu({GM_getValue:T,GM_setValue:D,GM_registerMenuCommand:J,GM_unregisterMenuCommand:Y}),q=new p.Httpx(Z);q.interceptors.response.use(void 0,e=>(o.error(["拦截器-请求错误",e]),e.type==="onabort"?v.warning("请求取消"):e.type==="onerror"?v.error("请求异常"):e.type==="ontimeout"?v.error("请求超时"):v.error("其它错误"),e));q.config({logDetails:P});x.Object.defineProperty,x.Function.prototype.apply,x.Function.prototype.call,x.Element.prototype.appendChild,x.setTimeout;const g=p.addStyle.bind(p),y="GM_Panel",ee="data-init",B="data-key",k="data-default-value",te="data-init-more-value",b={isHuaWeiCloudBlog(){return !!/huaweicloud.csdn.net/i.test(window.location.origin)},isBlog(){return !!/blog.csdn.net/i.test(window.location.origin)},isWenKu(){return !!/wenku.csdn.net/i.test(window.location.origin)},isLink(){return window.location.hostname==="link.csdn.net"},isSo(){return window.location.hostname==="so.csdn.net"},isSoCKnow(){return this.isSo()&&(window.location.pathname.startsWith("/chat")||window.location.pathname.startsWith("/so/ai"))},isDownload(){return window.location.hostname==="download.csdn.net"}},$=function(e,t,n,l,a,s,u,h,C){let c={text:e,type:"slider",description:h,attributes:{},getValue(){return r.getValue(t,n)},getToolTipContent(m){return typeof u=="function"?u(m):`${m}`},callback(m,f){typeof s=="function"&&s(m,f)||r.setValue(t,f);},min:l,max:a,step:C};return c.attributes&&(c.attributes[B]=t,c.attributes[k]=n),c},i=function(e,t,n,l,a){let s={text:e,type:"switch",description:a,attributes:{},getValue(){return !!r.getValue(t,n)},callback(u,h){o.success(`${h?"开启":"关闭"} ${e}`),!(typeof l=="function"&&l(u,h))&&r.setValue(t,!!h);},afterAddToUListCallBack:void 0};return s.attributes&&(s.attributes[B]=t,s.attributes[k]=!!n),s},ne={id:"panel-blog",title:"博客",isDefault(){return b.isBlog()},forms:[{text:"",type:"forms",forms:[{text:"全局屏蔽",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("【屏蔽】登录弹窗","csdn-blog-shieldLoginDialog",!0),i("【屏蔽】左侧博客信息","csdn-blog-shieldLeftBlogContainerAside",!1),i("【屏蔽】右侧目录信息","csdn-blog-shieldRightDirectoryInformation",!1),i("【屏蔽】顶部工具栏","csdn-blog-shieldTopToolbar",!1),i("【屏蔽】底部的悬浮工具栏","csdn-blog-shieldBottomFloatingToolbar",!1)]}]},{text:"右侧悬浮工具栏",type:"deepMenu",forms:[{text:"功能",type:"forms",forms:[i("启用","csdn-blog-rightToolbarEnable",!0,void 0,"创作中心，隐藏/显示侧栏，新手引导，客服、举报..."),i("【添加按钮】前往评论","csdn-blog-addGotoRecommandButton",!0,void 0,"在悬浮工具栏最后面添加"),$("right偏移","csdn-blog-rightToolbarRightOffset",90,0,document.documentElement.clientWidth,(e,t)=>{let n=document.querySelector(".csdn-side-toolbar");S.css(n,{right:t+"px"});},e=>`当前：${e}px，默认：90px`),$("top偏移","csdn-blog-rightToolbarTopOffset",140,0,document.documentElement.clientHeight,(e,t)=>{let n=document.querySelector(".csdn-side-toolbar");S.css(n,{top:t+"px"});},e=>`当前：${e}px，默认：90px`)]},{text:"屏蔽",type:"forms",forms:[i("【屏蔽】创作中心","csdn-blog-rightToolbarCreativeCenter",!1),i("【屏蔽】显示/隐藏侧栏","csdn-blog-rightToolbarShowOrSidebar",!1),i("【屏蔽】新手引导","csdn-blog-rightToolbarBeginnerGuidance",!1),i("【屏蔽】客服","csdn-blog-rightToolbarCustomerService",!1),i("【屏蔽】举报","csdn-blog-rightToolbarReport",!1),i("【屏蔽】返回顶部","csdn-blog-rightToolbarBackToTop",!1)]}]},{text:"内容",type:"deepMenu",forms:[{text:"功能",type:"forms",forms:[i("点击代码块自动展开","csdn-blog-clickPreCodeAutomatically",!0,void 0,"当鼠标点击代码块区域时，将自动展开内容"),i("自动展开代码块","csdn-blog-autoExpandCodeContent",!0,void 0,"懒人操作，免手动点击展开"),i("自动展开内容","csdn-blog-autoExpandContent",!0,void 0,"懒人操作，免手动点击展开"),i("全文居中","csdn-blog-articleCenter",!0,function(e,t){t&&alert("为了更好的呈现效果，请开启功能：【屏蔽】左侧博客信息、【屏蔽】右侧目录信息");},"自动屏蔽左侧和右侧的信息，且将文章居中"),i("允许选择内容","csdn-blog-allowSelectContent",!0,void 0)]},{text:"屏蔽",type:"forms",forms:[i("【屏蔽】底部xx技能树","csdn-blog-shieldBottomSkillTree",!1),i("【屏蔽】选中文字悬浮栏","csdn-blog-shieldArticleSearchTip",!1,void 0,"选中文字弹出的，例如：搜索、评论、笔记")]}]},{text:"评论区",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("启用","csdn-blog-blockComment",!0,void 0,"关闭是屏蔽评论区"),i("优化评论区的位置","csdn-blog-restoreComments",!0)]}]},{text:"底部文章",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("启用","csdn-blog-bottomRecommendArticleEnable",!0,void 0,"关闭是屏蔽底部文章"),i("标识CSDN下载","csdn-blog-identityCSDNDownload",!0,void 0,"使用红框标识"),i("移除资源下载的文章","csdn-blog-removeResourceDownloadArticle",!1,void 0,"移除download.csdn.net、www.iteye.com、edu.csdn.net的文章链接")]}]},{text:"劫持/拦截",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("拦截-复制的小尾巴","csdn-blog-removeClipboardHijacking",!0),i("劫持-禁止复制","csdn-blog-unBlockCopy",!0,void 0,"允许点击复制按钮进行复制")]}]}]}]},oe={id:"panel-link",title:"链接",isDefault(){return b.isLink()},forms:[{text:"功能",type:"forms",forms:[i("重定向链接","csdn-link-jumpRedirect",!0,void 0,"自动跳转至被拦截的Url链接")]}]},re={id:"panel-hua-wei-cloud",title:"华为云开发者联盟",isDefault(){return b.isHuaWeiCloudBlog()},forms:[{text:"功能",type:"forms",forms:[i("自动展开全文","csdn-hua-wei-cloud-autoExpandContent",!0)]},{text:"屏蔽",type:"forms",forms:[i("【屏蔽】云开发者任务挑战活动","csdn-hua-wei-cloud-shieldCloudDeveloperTaskChallengeEvent",!0),i("【屏蔽】左侧悬浮按钮","csdn-hua-wei-cloud-shieldLeftFloatingButton",!1,function(e,t){t&&alert("开启后将屏蔽【当前阅读量】、【点赞按钮】、【评论按钮】、【分享按钮】");}),i("【屏蔽】右侧栏","csdn-hua-wei-cloud-blockRightColumn",!1,function(e,t){t&&alert("开启后将屏蔽【相关产品】-【活动日历】-【运营活动】-【热门标签】");}),i("【屏蔽】底部推荐内容","csdn-hua-wei-cloud-blockRecommendedContentAtTheBottom",!1),i("【屏蔽】底部更多推荐","csdn-hua-wei-cloud-shieldTheBottomForMoreRecommendations",!1)]}]},ie={id:"panel-wenku",title:"资源",isDefault(){return b.isLink()},forms:[{text:"屏蔽",type:"forms",forms:[i("【屏蔽】资源推荐","csdn-wenku-shieldResourceRecommend",!1),i("【屏蔽】右侧用户信息","csdn-wenku-shieldRightUserInfo",!1),i("【屏蔽】右侧悬浮工具栏","csdn-wenku-shieldRightToolBar",!1)]}]},le={id:"panel-so",title:"搜索",isDefault(){return b.isSo()},forms:[{text:"C知道-功能",type:"forms",forms:[i("去除水印","csdn-so-cknow-removeMaskCover",!0)]}]},ae={id:"m-panel-blog",title:"博客",isDefault(){return b.isBlog()},forms:[{text:"",type:"forms",forms:[{text:"全局屏蔽",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("【屏蔽】广告","m-csdn-blog-removeAds",!0,void 0,"包括：登录弹窗、打开APP、ios版本提示等"),i("【屏蔽】顶部Toolbar","m-csdn-blog-shieldTopToolbar",!1)]}]},{text:"内容",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("允许选中文字","m-csdn-blog-allowSelectText",!0,void 0,"设置user-select: text;"),i("自动展开","m-csdn-blog-autoExpandContent",!0,void 0,"包括内容、代码块"),i("不限制代码块的最大高度","m-csdn-blog-notLimitCodePreMaxHeight",!1,void 0,"让代码块的高度直接被撑开")]}]},{text:"评论",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("启用","m-csdn-blog-comment-enable",!0,void 0,"关闭是屏蔽评论区"),i("不限制评论区的最大高度","m-csdn-blog-notLimitCommentMaxHeight",!0,void 0,"让评论区高度直接被撑开")]}]},{text:"底部文章",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("启用","m-csdn-blog-bottomArticleEnable",!0,void 0,"关闭是屏蔽底部文章"),i("移除资源下载","m-csdn-blog-removeResourceArticle",!1,void 0,"移除download.csdn.net、www.iteye.com、edu.csdn.net的文章链接"),i("重构","m-csdn-blog-refactoringRecommendation",!0,void 0,"文章的样式统一"),i("新标签页打开","m-csdn-blog-openNewTab",!0,void 0,"新标签页打开文章")]}]},{text:"劫持/拦截",type:"deepMenu",forms:[{text:"",type:"forms",forms:[i("劫持-禁止复制","m-csdn-blog-unBlockCopy",!0,void 0,"允许点击复制按钮进行复制")]}]}]}]},se={id:"m-panel-link",title:"链接",isDefault(){return b.isLink()},forms:[{text:"功能",type:"forms",forms:[i("重定向链接","m-csdn-link-jumpRedirect",!0,void 0,"自动跳转至被拦截的Url链接")]}]},de={id:"panel-so",title:"搜索",isDefault(){return b.isSo()},forms:[{text:"C知道-功能",type:"forms",forms:[i("去除水印","m-csdn-so-cknow-removeMaskCover",!0)]}]},ce={id:"m-panel-wenku",title:"文库",isDefault(){return b.isWenKu()},forms:[{text:"屏蔽",type:"forms",forms:[i("【屏蔽】底部工具栏","m-csdn-wenku-shieldBottomToolbar",!1)]}]},ue={id:"m-panel-hua-wei-cloud",title:"华为云开发者联盟",isDefault(){return b.isHuaWeiCloudBlog()},forms:[{text:"功能",type:"forms",forms:[i("自动展开全文","m-csdn-hua-wei-cloud-autoExpandContent",!0)]},{text:"屏蔽",type:"forms",forms:[i("【屏蔽】底部加入社区","m-csdn-hua-wei-cloud-blockBottomJoinTheCommunity",!0)]}]},me={id:"m-panel-download",title:"资源",isDefault(){return b.isDownload()},forms:[{text:"功能",type:"forms",forms:[i("自动展开资源介绍","m-csdn-download-automaticallyExpandResourceIntroduction",!0,void 0,"屏蔽资源介绍【展开全部】按钮并展开资源介绍")]},{text:"屏蔽",type:"forms",forms:[i("【屏蔽】广告","m-csdn-download-removeAds",!0,void 0,"包括：登录弹窗、会员降价等")]}]},E=function(e,t,n,l,a,s){let u=[];typeof l=="function"?u=l():u=l;let h={text:e,type:"select",description:s,attributes:{},getValue(){return r.getValue(t,n)},callback(C,c,m){r.setValue(t,c),typeof a=="function"&&a(C,c,m);},data:u};return h.attributes&&(h.attributes[B]=t,h.attributes[k]=n),h},fe={id:"component-common",title:"通用",forms:[{text:"Toast配置",type:"forms",forms:[E("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,n)=>{o.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),E("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),i("逆序弹出","qmsg-config-showreverse",!1,void 0,"修改Toast弹出的顺序")]}]},he={id:"component-common",title:"通用",forms:[{text:"Toast配置",type:"forms",forms:[E("Toast位置","qmsg-config-position","bottom",[{value:"topleft",text:"左上角"},{value:"top",text:"顶部"},{value:"topright",text:"右上角"},{value:"left",text:"左边"},{value:"center",text:"中间"},{value:"right",text:"右边"},{value:"bottomleft",text:"左下角"},{value:"bottom",text:"底部"},{value:"bottomright",text:"右下角"}],(e,t,n)=>{o.info("设置当前Qmsg弹出位置"+n);},"Toast显示在页面九宫格的位置"),E("最多显示的数量","qmsg-config-maxnums",3,[{value:1,text:"1"},{value:2,text:"2"},{value:3,text:"3"},{value:4,text:"4"},{value:5,text:"5"}],void 0,"限制Toast显示的数量"),i("逆序弹出","qmsg-config-showreverse",!1,void 0,"修改Toast弹出的顺序")]}]},r={$data:{__data:null,__oneSuccessExecMenu:null,__onceExec:null,__listenData:null,get data(){return r.$data.__data==null&&(r.$data.__data=new p.Dictionary),r.$data.__data},get oneSuccessExecMenu(){return r.$data.__oneSuccessExecMenu==null&&(r.$data.__oneSuccessExecMenu=new p.Dictionary),r.$data.__oneSuccessExecMenu},get onceExec(){return r.$data.__onceExec==null&&(r.$data.__onceExec=new p.Dictionary),r.$data.__onceExec},get scriptName(){return A},key:y,attributeKeyName:B,attributeDefaultValueName:k},$listener:{get listenData(){return r.$data.__listenData==null&&(r.$data.__listenData=new p.Dictionary),r.$data.__listenData}},init(){this.initPanelDefaultValue(),this.initExtensionsMenu();},initExtensionsMenu(){x.top===x.self&&U.add([{key:"show_pops_panel_setting",text:"⚙ PC端设置",autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showPanel();}},{key:"m_show_pops_panel_setting",text:"⚙ 移动端端设置",autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{this.showMPanel();}},{key:"gotoCSDNCKnow",text:"⚙ 前往C知道",isStoreValue:!1,autoReload:!1,showText(e){return e},callback(){window.open("https://so.csdn.net/chat","_blank");}}]);},initPanelDefaultValue(){let e=this;function t(a){if(!a.attributes)return;let s={},u=a.attributes[B];u!=null&&(s[u]=a.attributes[k]);let h=a.attributes[ee];if(typeof h=="function"){let m=h();if(typeof m=="boolean"&&!m)return}let C=a.attributes[te];C&&typeof C=="object"&&Object.assign(s,C);let c=Object.keys(s);if(!c.length){o.warn(["请先配置键",a]);return}c.forEach(m=>{let f=s[m];e.$data.data.has(m)&&o.warn("请检查该key(已存在): "+m),e.$data.data.set(m,f);});}function n(a){for(let s=0;s<a.length;s++){let u=a[s];t(u);let h=u.forms;h&&Array.isArray(h)&&n(h);}}let l=this.getPanelContentConfig();for(let a=0;a<l.length;a++){let s=l[a];if(!s.forms)continue;let u=s.forms;u&&Array.isArray(u)&&n(u);}},setValue(e,t){let n=T(y,{}),l=n[e];n[e]=t,D(y,n),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,l,t);},getValue(e,t){let l=T(y,{})[e];return l??(this.$data.data.has(e)?this.$data.data.get(e):t)},deleteValue(e){let t=T(y,{}),n=t[e];Reflect.deleteProperty(t,e),D(y,t),this.$listener.listenData.has(e)&&this.$listener.listenData.get(e).callback(e,n,void 0);},addValueChangeListener(e,t,n){let l=Math.random();return this.$listener.listenData.set(e,{id:l,key:e,callback:t}),n&&n.immediate&&t(e,this.getValue(e),this.getValue(e)),l},removeValueChangeListener(e){let t=null;for(const[n,l]of this.$listener.listenData.entries())if(l.id===e){t=n;break}typeof t=="string"?this.$listener.listenData.delete(t):console.warn("没有找到对应的监听器");},triggerMenuValueChange(e,t,n){if(this.$listener.listenData.has(e)){let l=this.$listener.listenData.get(e);if(typeof l.callback=="function"){let a=this.getValue(e),s=a,u=a;typeof t<"u"&&arguments.length>1&&(s=t),typeof n<"u"&&arguments.length>2&&(u=n),l.callback(e,u,s);}}},hasKey(e){let t=T(y,{});return e in t},execMenu(e,t,n=!1){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){o.warn(`${e} 键不存在`);return}let l=r.getValue(e);n&&(l=!l),l&&t(l);},execMenuOnce(e,t,n,l){if(typeof e!="string")throw new TypeError("key 必须是字符串");if(!this.$data.data.has(e)){o.warn(`${e} 键不存在`);return}if(this.$data.oneSuccessExecMenu.has(e))return;this.$data.oneSuccessExecMenu.set(e,1);let a=()=>{let c=r.getValue(e);return typeof n=="function"?n(e,c):c},s=[],u=c=>{let m=a(),f=[];if(c instanceof HTMLStyleElement?f=[c]:Array.isArray(c)&&(f=[...c.filter(w=>w!=null&&w instanceof HTMLStyleElement)]),m)s=s.concat(f);else for(let w=0;w<f.length;w++)f[w].remove(),f.splice(w,1),w--;},h=c=>{let m=[];if(c){let f=t(c,u);f instanceof HTMLStyleElement?m=[f]:Array.isArray(f)&&(m=[...f.filter(w=>w!=null&&w instanceof HTMLStyleElement)]);}for(let f=0;f<s.length;f++)s[f].remove(),s.splice(f,1),f--;s=[...m];};this.addValueChangeListener(e,(c,m,f)=>{let w=f;typeof l=="function"&&(w=l(c,f,m)),h(w);});let C=a();C&&h(C);},execInheritMenuOnce(e,t,n,l){let a=this;const s=(u,h)=>{let C=a.getValue(u),c=a.getValue(h);if(typeof l=="function"){let m=l(C,c);if(m!==void 0)return m}return C};this.execMenuOnce(e,n,()=>s(e,t),()=>s(e,t)),this.execMenuOnce(t,()=>{},()=>!1,()=>(this.triggerMenuValueChange(e),!1));},onceExec(e,t){if(typeof e!="string")throw new TypeError("key 必须是字符串");this.$data.onceExec.has(e)||(t(),this.$data.onceExec.set(e,1));},showPanel(){L.panel({title:{text:`${A}-PC端设置`,position:"center",html:!1,style:""},content:this.getPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0});},showMPanel(){L.panel({title:{text:`${A}-移动端设置`,position:"center",html:!1,style:""},content:this.getMPanelContentConfig(),mask:{enable:!0,clickEvent:{toClose:!0,toHide:!1}},isMobile:this.isMobile(),width:this.getWidth(),height:this.getHeight(),drag:!0,only:!0});},isMobile(){return window.innerWidth<550},getWidth(){return window.innerWidth<550?"92vw":"550px"},getHeight(){return window.innerHeight>450?"80vh":"450px"},getPanelContentConfig(){return [fe,ne,oe,re,ie,le]},getMPanelContentConfig(){return [he,ae,se,ue,ce,de,me]}},pe=`/* 底部免费抽xxx奖品广告 */\r
div.siderbar-box,\r
/* 华为开发者联盟加入社区 */\r
div.user-desc.user-desc-fix {\r
  display: none !important;\r
}\r
`,d={waitForElementToRemove(e=""){p.waitNodeList(e).then(t=>{t.forEach(n=>n.remove());});},addBlockCSS(...e){let t=[];if(e.length!==0&&!(e.length===1&&typeof e[0]=="string"&&e[0].trim()===""))return e.forEach(n=>{Array.isArray(n)?t=t.concat(n):t.push(n);}),g(`${t.join(`,
`)}{display: none !important;}`)}},j={init(){g(pe),r.execMenuOnce("csdn-hua-wei-cloud-shieldCloudDeveloperTaskChallengeEvent",()=>this.shieldCloudDeveloperTaskChallengeEvent()),r.execMenuOnce("csdn-hua-wei-cloud-autoExpandContent",()=>this.autoExpandContent()),r.execMenuOnce("csdn-hua-wei-cloud-shieldLeftFloatingButton",()=>this.shieldLeftFloatingButton()),r.execMenuOnce("csdn-hua-wei-cloud-blockRightColumn",()=>this.blockRightColumn()),r.execMenuOnce("csdn-hua-wei-cloud-blockRecommendedContentAtTheBottom",()=>this.blockRecommendedContentAtTheBottom()),r.execMenuOnce("csdn-hua-wei-cloud-shieldTheBottomForMoreRecommendations",()=>this.shieldTheBottomForMoreRecommendations());},autoExpandContent(){return o.info("自动展开全文"),[d.addBlockCSS("div.article-show-more"),g(`
			/* 自动展开全文 */
			.main-content .user-article{
				height: auto !important;
				overflow: auto !important;
			}
			`)]},shieldCloudDeveloperTaskChallengeEvent(){return o.info("屏蔽云开发者任务挑战活动"),d.addBlockCSS(".luck-draw-modal-warp")},shieldLeftFloatingButton(){return o.info("屏蔽左侧悬浮按钮，包括当前阅读量、点赞按钮、评论按钮、分享按钮"),d.addBlockCSS("div.toolbar-wrapper.article-interact-bar")},blockRightColumn(){return o.info("屏蔽右侧栏，包括相关产品-活动日历-运营活动-热门标签"),d.addBlockCSS("div.page-home-right.dp-aside-right")},blockRecommendedContentAtTheBottom(){return o.info("屏蔽底部推荐内容"),d.addBlockCSS("div.recommend-card-box")},shieldTheBottomForMoreRecommendations(){return o.info("屏蔽底部更多推荐"),d.addBlockCSS("div.more-article")}},ge=`.ecommend-item-box.recommend-recommend-box,\r
.login-mark,\r
...
#chatgpt-article-detail > div.layout-center > div.main > div.article-box > div.cont.first-show.forbid > div.open {\r
  display: none !important;\r
}`,ve={init(){g(Ce),g(Se),r.execMenuOnce("csdn-wenku-shieldResourceRecommend",()=>this.shieldResourceRecommend()),r.execMenuOnce("csdn-wenku-shieldRightUserInfo",()=>this.shieldRightUserInfo()),r.execMenuOnce("csdn-wenku-shieldRightToolBar",()=>this.shieldRightToolBar());},shieldResourceRecommend(){return o.info("【屏蔽】资源推荐"),d.addBlockCSS("#recommend")},shieldRightUserInfo(){return o.info("【屏蔽】右侧用户信息"),d.addBlockCSS(".layout-right")},shieldRightToolBar(){return o.info("【屏蔽】右侧悬浮工具栏"),d.addBlockCSS(".csdn-side-toolbar")}},F={init(){r.execMenuOnce("csdn-link-jumpRedirect",()=>{this.jumpRedirect();});},jumpRedirect(){if(window.location.hostname==="link.csdn.net"&&window.location.search.startsWith("?target")){window.stop();let e=window.location.search.replace(/^\?target=/gi,"");e=decodeURIComponent(e);let t=e;o.success(`跳转链接 ${t}`),window.location.href=t;}}},V={init(){b.isLink()?(o.info("Router: 中转链接"),F.init()):b.isHuaWeiCloudBlog()?(o.info("Router: 华为云联盟"),j.init()):b.isBlog()?(o.info("Router: 博客"),W.init()):b.isWenKu()?(o.info("Router: 文库"),ve.init()):o.error("暂未适配，请反馈开发者："+globalThis.location.href);}},ye={init(){r.execMenuOnce("m-csdn-link-jumpRedirect",()=>{F.jumpRedirect();});}},Me=`/* 右下角的 免费赢华为平板xxxx */\r
.org-main-content .siderbar-box {\r
  display: none !important;\r
}\r
`,Te={init(){g(Me),r.execMenuOnce("m-csdn-hua-wei-cloud-autoExpandContent",()=>j.autoExpandContent()),r.execMenuOnce("m-csdn-hua-wei-cloud-blockBottomJoinTheCommunity",()=>this.blockBottomJoinTheCommunity());},blockBottomJoinTheCommunity(){return o.info("【屏蔽】底部加入社区"),d.addBlockCSS(".user-desc")}},_e=`#operate,.feed-Sign-span,\r
.view_comment_box,\r
...
`,ke={init(){this.addCSS(),r.execMenuOnce("m-csdn-blog-shieldTopToolbar",()=>this.shieldTopToolbar()),r.execMenuOnce("m-csdn-blog-notLimitCodePreMaxHeight",()=>this.notLimitCodePreMaxHeight()),r.execMenuOnce("m-csdn-blog-notLimitCommentMaxHeight",()=>this.notLimitCommentMaxHeight()),r.execMenuOnce("m-csdn-blog-allowSelectText",()=>this.allowSelectText()),r.execMenuOnce("m-csdn-blog-autoExpandContent",()=>this.autoExpandContent()),r.execMenuOnce("m-csdn-blog-bottomArticleEnable",()=>this.blockBottomArticle()),r.execMenuOnce("m-csdn-blog-comment-enable",()=>this.blockComment(),(e,t)=>!t,(e,t)=>!t),S.ready(()=>{r.execMenuOnce("m-csdn-blog-removeAds",()=>this.removeAds()),r.execMenuOnce("m-csdn-blog-refactoringRecommendation",()=>{this.refactoringRecommendation();}),r.execMenuOnce("m-csdn-blog-unBlockCopy",()=>{W.unBlockCopy();});});},addCSS(){g(_e),g(Be);},shieldTopToolbar(){return o.info("屏蔽顶部Toolbar"),[d.addBlockCSS("#csdn-toolbar"),g(`
			/* 内容顶部要归位 */
			body #main,
			.margin_sides{
			...
			`)]},refactoringRecommendation(){function e(){o.info("重构底部推荐"),document.querySelectorAll(".container-fluid").forEach(n=>{var m,f;let l="",a="",s="",u="",h=!1,C=!1;if(n.hasAttribute("data-url")){if(l=n.getAttribute("data-url"),a=(m=n.querySelector(".recommend_title div.left"))==null?void 0:m.innerHTML,!n.querySelector(".text"))return;s=(f=n.querySelector(".text"))==null?void 0:f.innerHTML,n.querySelectorAll(".recommend-img").length&&n.querySelectorAll(".recommend-img").forEach(w=>{u+=w.innerHTML;});}else o.info("节点上无data-url"),l=n.querySelector("a[data-type]").getAttribute("href"),a=n.querySelector(".recommend_title div.left").innerHTML,s=n.querySelector(".text").innerHTML;var c=new URL(l);c.host==="download.csdn.net"||c.host==="www.iteye.com"&&c.pathname.match(/^\/resource/gi)?(o.info("该链接为csdn资源下载"),h=!0,a='<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>'+a):c.origin.match(/edu.csdn.net/gi)&&(C=!0,o.info("该链接为csdn学院下载"),a='<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>'+a),n.setAttribute("class","GM-csdn-dl"),n.setAttribute("data-url",l),n.innerHTML=`<div class="GM-csdn-title"><div class="left">${a}</div></div><div class="GM-csdn-content">${s}</div><div class="GM-csdn-img">${u}</div>`,n.addEventListener("click",function(){r.getValue("m-csdn-blog-openNewTab")?window.open(l,"_blank"):window.location.href=l;}),(h||C)&&r.getValue("m-csdn-blog-removeResourceArticle")&&n.remove();});}let t=new p.LockFunction(e,50);p.waitNode("#recommend").then(n=>{o.info("重构底部推荐"),t.run(),p.mutationObserver(n,{callback:()=>{t.run();},config:{childList:!0,subtree:!0,attributes:!0}});});},blockBottomArticle(){return o.info("屏蔽底部文章"),d.addBlockCSS("#recommend")},blockComment(){return o.info("屏蔽评论"),d.addBlockCSS("#comment")},removeAds(){o.info("去除广告"),d.waitForElementToRemove(".passport-login-container"),d.waitForElementToRemove(".btn_open_app_prompt_box.detail-open-removed"),d.waitForElementToRemove(".add-firstAd"),d.waitForElementToRemove("div.feed-Sign-weixin"),d.waitForElementToRemove("div.ios-shadowbox");},notLimitCodePreMaxHeight(){return o.info("不限制代码块最大高度"),g(`
        pre{
      ...
      `)},allowSelectText(){return o.info("允许选择文字"),g(`
        ...
        `)}},Re=`/* 右下角的买一年送3个月的广告图标 */\r
.blind_box {\r
  display: none !important;\r
}\r
`,De={init(){g(Re),r.execMenu("m-csdn-wenku-shieldBottomToolbar",()=>{this.shieldBottomToolbar();});},shieldBottomToolbar(){o.info("【屏蔽】底部工具栏"),d.addBlockCSS(".page-container > div.btn");}},Ee=`/* 右下角悬浮图标 买1年送3个月 */\r
...
`,Ae={init(){r.execMenuOnce("m-csdn-download-removeAds",()=>g(Ee)),r.execMenuOnce("m-csdn-download-automaticallyExpandResourceIntroduction",()=>this.automaticallyExpandResourceIntroduction());},automaticallyExpandResourceIntroduction(){return o.info("自动展开资源介绍"),[d.addBlockCSS("label.unfold-font"),g(`
			.resource-desc{
				max-height: unset !important;
				overflow: unset !important;
			}
			`)]}},I={init(){b.isLink()?(o.info("Router: 中转链接"),ye.init()):b.isHuaWeiCloudBlog()?(o.info("Router: 华为云联盟"),Te.init()):b.isBlog()?(o.info("Router: 博客"),ke.init()):b.isWenKu()?(o.info("Router: 文库"),De.init()):b.isDownload()?(o.info("Router: 资源下载"),Ae.init()):o.error("暂未适配，请反馈开发者："+globalThis.location.href);}};r.init();let K=p.isPhone(),_="change_env_set",M=T(_);U.add({key:_,text:`⚙ 自动: ${K?"移动端":"PC端"}`,autoReload:!1,isStoreValue:!1,showText(e){return M==null?e:e+` 手动: ${M==1?"移动端":M==2?"PC端":"未知"}`},callback:()=>{let e=[0,1,2],t=window.prompt(`请输入当前脚本环境判定

自动判断: 0
移动端: 1
PC端: 2`,"0");if(!t)return;let n=parseInt(t);if(isNaN(n)){v.error("输入的不是规范的数字");return}if(!e.includes(n)){v.error("输入的值必须是0或1或2");return}n==0?H(_):D(_,n);}});M!=null?(o.info(`手动判定为${M===1?"移动端":"PC端"}`),M==1?I.init():M==2?V.init():(v.error("意外，手动判定的值不在范围内"),H(_))):K?(o.info("自动判定为移动端"),I.init()):(o.info("自动判定为PC端"),V.init());

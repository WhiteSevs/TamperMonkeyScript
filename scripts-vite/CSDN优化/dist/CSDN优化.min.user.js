...
`)}{display: none !important;}`)},addBlockCSSWithEnd(...e){let t=S.addBlockCSS(...e);return t&&document.documentElement.appendChild(t),t},setGMResourceCSS(e){let t=typeof m==`function`?m(e.keyName):null;return typeof t==`string`&&t?k(t):S.loadStyleLink(e.url)},async loadStyleLink(e){let n=document.createElement(`link`);return n.rel=`stylesheet`,n.type=`text/css`,n.href=e,new Promise(e=>{t.default.onReady(()=>{document.head.appendChild(n),e(n)})})},async loadScript(e){let t=document.createElement(`script`);return t.src=e,new Promise(e=>{t.onload=()=>{e(null)},(document.head||document.documentElement).appendChild(t)})},fixUrl(e){return e=e.trim(),e.startsWith(`data:`)||e.match(/^http(s|):\/\//i)?e:e.startsWith(`//`)?(e.startsWith(`///`)||(e=window.location.protocol+e),e):(e.startsWith(`/`)||(e+=`/`),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith(`https://`)||!e.startsWith(`http://`))return e;try{let t=new URL(e);return t.protocol=`https:`,t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement(`style`);t.innerHTML=`
      ...
      `,...this.$data.panelConfig});return this.$data.$panel=a,this.$data.panelContent=e,r||this.registerConfigSearch({$panel:a,content:e}),{$panel:a,content:e}},registerConfigSearch(t){let{$panel:n,content:r}=t,i=(e,n)=>{if(typeof t.translateCallback==`function`)return t.translateCallback(e,n);if(typeof n==`object`&&n)for(let t in n)e=e.replaceAll(`{{${t}}}`,n[t]);return e},a=async(e,t)=>{if(e==null)return;let n=await t(e);return n&&typeof n.isFind==`boolean`&&n.isFind?n.data:await a(n.data,t)},o=(e,t)=>{let n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(t?.(),n.disconnect())})},{root:null,threshold:1});n.observe(e),e.scrollIntoView({behavior:`smooth`,block:`center`})},s=e=>{let t=`pops-flashing`;w.onAnimationend(e,()=>{e.classList.remove(t)}),e.classList.add(t)},c=c=>{if(c.type===`dblclick`&&f)return;w.preventEvent(c);let l=T.alert({title:{text:i(`搜索配置`),position:`center`},content:{text:`
    		...
    		`}))},transformKey(e){if(Array.isArray(e)){if(e.length>1){let t=e.sort();return JSON.stringify(t)}return e[0]}return e},getDynamicValue(e,t){let n=!1,r=t,i=this.addValueChangeListener(e,(e,t)=>{r=t});return{get value(){return n||(n=!0,r=V.getValue(e,t)),r},destory(){V.removeValueChangeListener(i)}}}},me=class e{__href__;get __href(){return this.__href__||globalThis.location.href}__origin={value:void 0,type:`same`};__protocol={value:void 0,type:`same`};__host={value:void 0,type:`same`,hasPort:!1};__pathname={value:void 0,type:`same`};__searchParams={value:new Set};otherInstResultWithOr=!1;constructor(e){typeof e==`string`&&this.href(e)}href(e){return this.__href__=e,this}origin(e){return this.__origin={value:e,type:`same`},this}originStartsWith(e){return this.__origin={value:e,type:`startsWith`},this}originEndsWith(e){return this.__origin={value:e,type:`endsWith`},this}originIncludes(e){return this.__origin={value:e,type:`includes`},this}originMatch(e){return this.__origin={value:e,type:`match`},this}protocol(e){return this.__protocol={value:e,type:`same`},this}protocolStartsWith(e){return this.__protocol={value:e,type:`startsWith`},this}protocolEndsWith(e){return this.__protocol={value:e,type:`endsWith`},this}protocolIncludes(e){return this.__protocol={value:e,type:`includes`},this}protocolMatch(e){return this.__protocol={value:e,type:`match`},this}host(e){return this.__host={value:e,type:`same`,hasPort:!0},this}hostStartsWith(e){return this.__host={value:e,type:`startsWith`,hasPort:!0},this}hostEndsWith(e){return this.__host={value:e,type:`endsWith`,hasPort:!0},this}hostIncludes(e){return this.__host={value:e,type:`includes`,hasPort:!0},this}hostMatch(e){return this.__host={value:e,type:`match`,hasPort:!0},this}hostName(e){return this.__host={value:e,type:`same`,hasPort:!1},this}hostNameStartsWith(e){return this.__host={value:e,type:`startsWith`,hasPort:!1},this}hostNameEndsWith(e){return this.__host={value:e,type:`endsWith`,hasPort:!1},this}hostNameIncludes(e){return this.__host={value:e,type:`includes`,hasPort:!1},this}hostNameMatch(e){return this.__host={value:e,type:`match`,hasPort:!1},this}pathname(e){return this.__pathname={value:e,type:`same`},this}pathnameStartsWith(e){return this.__pathname={value:e,type:`startsWith`},this}pathnameEndsWith(e){return this.__pathname={value:e,type:`endsWith`},this}pathnameIncludes(e){return this.__pathname={value:e,type:`includes`},this}pathnameMatch(e){return this.__pathname={value:e,type:`match`},this}searchParams(e,t){return this.__searchParams.value.add({name:e,value:t}),this}search(e){return this.__searchParams.value.add({name:``,value:e,type:`same`}),this}searchStartsWith(e){return this.__searchParams.value.add({name:``,value:e,type:`startsWith`}),this}searchEndsWith(e){return this.__searchParams.value.add({name:``,value:e,type:`endsWith`}),this}searchIncludes(e){return this.__searchParams.value.add({name:``,value:e,type:`includes`}),this}searchMatch(e){return this.__searchParams.value.add({name:``,value:e,type:`match`}),this}build(){if(!this.__host.value)throw TypeError(`host or hostName should be required`);let e=`${this.__protocol.value||`https`}://${this.__host.value}${this.__pathname.value||`/`}`;if(this.__searchParams.value.size>0){let t=[];this.__searchParams.value.forEach(e=>{if(typeof e.name==`string`){let n=``;(typeof e.value==`string`||typeof e.value==`number`||typeof e.value==`boolean`)&&(n=e.value.toString()),t.push(`${encodeURIComponent(e.name)}=${encodeURIComponent(n)}`)}}),t.length&&(e+=`?${t.join(`&`)}`)}return e}or(t){this.otherInstResultWithOr=this.otherInstResultWithOr||this.r();let n=new e(t);return n.otherInstResultWithOr=this.otherInstResultWithOr,n}r(){if(this.otherInstResultWithOr)return this.otherInstResultWithOr;let e=new URL(this.__href);return[()=>{if(this.__origin.value){if(this.__origin.type===`same`){if(typeof this.__origin.value==`string`)return e.origin===this.__origin.value;throw TypeError(`origin value should be string by type `+this.__origin.type)}if(this.__origin.type===`startsWith`){if(typeof this.__origin.value==`string`)return e.origin.startsWith(this.__origin.value);throw TypeError(`origin value should be string by type `+this.__origin.type)}if(this.__origin.type===`endsWith`){if(typeof this.__origin.value==`string`)return e.origin.endsWith(this.__origin.value);throw TypeError(`origin value should be string by type `+this.__origin.type)}if(this.__origin.type===`includes`){if(typeof this.__origin.value==`string`)return e.origin.includes(this.__origin.value);throw TypeError(`origin value should be string by type `+this.__origin.type)}if(this.__origin.type===`match`){if(this.__origin.value instanceof RegExp)return this.__origin.value.test(e.origin);if(typeof this.__origin.value==`string`)return e.origin.match(this.__origin.value);throw TypeError(`origin value should be RegExp or string by type `+this.__origin.type)}throw TypeError(`origin type should be same or startsWith or endsWith or includes or match`)}return!0},()=>{if(this.__protocol.value){if(this.__protocol.type===`same`){if(typeof this.__protocol.value==`string`)return e.protocol===this.__protocol.value;throw TypeError(`protocol value should be string by type `+this.__protocol.type)}if(this.__protocol.type===`startsWith`){if(typeof this.__protocol.value==`string`)return e.protocol.startsWith(this.__protocol.value);throw TypeError(`protocol value should be string by type `+this.__protocol.type)}if(this.__protocol.type===`endsWith`){if(typeof this.__protocol.value==`string`)return e.protocol.endsWith(this.__protocol.value);throw TypeError(`protocol value should be string by type `+this.__protocol.type)}if(this.__protocol.type===`includes`){if(typeof this.__protocol.value==`string`)return e.protocol.includes(this.__protocol.value);throw TypeError(`protocol value should be string by type `+this.__protocol.type)}if(this.__protocol.type===`match`){if(this.__protocol.value instanceof RegExp)return this.__protocol.value.test(e.protocol);if(typeof this.__protocol.value==`string`)return e.protocol.match(this.__protocol.value);throw TypeError(`protocol value should be RegExp or string by type `+this.__protocol.type)}throw TypeError(`protocol type should be same,startsWith,endsWith,includes,match`)}return!0},()=>{if(this.__host.value){let t=this.__host.hasPort?e.host:e.hostname;if(this.__host.type===`same`){if(typeof this.__host.value==`string`)return this.__host.value===t;throw TypeError(`host value should be string by type `+this.__host.type)}if(this.__host.type===`startsWith`){if(typeof this.__host.value==`string`)return t.startsWith(this.__host.value);throw TypeError(`host value should be string by type `+this.__host.type)}if(this.__host.type===`endsWith`){if(typeof this.__host.value==`string`)return t.endsWith(this.__host.value);throw TypeError(`host value should be string by type `+this.__host.type)}if(this.__host.type===`includes`){if(typeof this.__host.value==`string`)return t.includes(this.__host.value);throw TypeError(`host value should be string by type `+this.__host.type)}if(this.__host.type===`match`){if(this.__host.value instanceof RegExp)return this.__host.value.test(t);if(typeof this.__host.value==`string`)return t.match(this.__host.value);throw TypeError(`host value should be RegExp or string by type `+this.__host.type)}throw TypeError(`host type should be same,startsWith,endsWith,includes,match`)}return!0},()=>{if(this.__pathname.value){if(this.__pathname.type===`same`){if(typeof this.__pathname.value==`string`)return e.pathname===this.__pathname.value;throw TypeError(`pathname value should be string by type `+this.__pathname.type)}if(this.__pathname.type===`startsWith`){if(typeof this.__pathname.value==`string`)return e.pathname.startsWith(this.__pathname.value);throw TypeError(`pathname value should be string by type `+this.__pathname.type)}if(this.__pathname.type===`endsWith`){if(typeof this.__pathname.value==`string`)return e.pathname.endsWith(this.__pathname.value);throw TypeError(`pathname value should be string by type `+this.__pathname.type)}if(this.__pathname.type===`includes`){if(typeof this.__pathname.value==`string`)return e.pathname.includes(this.__pathname.value);throw TypeError(`pathname value should be string by type `+this.__pathname.type)}if(this.__pathname.type===`match`){if(this.__pathname.value instanceof RegExp)return this.__pathname.value.test(e.pathname);if(typeof this.__pathname.value==`string`)return e.pathname.match(this.__pathname.value);throw TypeError(`pathname value should be RegExp or string by type `+this.__pathname.type)}throw TypeError(`pathname type should be same,startsWith,endsWith,includes,match`)}return!0},()=>{let t=!0,n=[];this.__searchParams.value.forEach(e=>{n.push(e)});for(let r=0;r<n.length;r++){let i=n[r];if(i.type){if(i.type===`same`){if(typeof i.value==`string`||typeof i.value==`number`||typeof i.value==`boolean`)return e.search===i.value.toString();throw TypeError(`search value should be string、number、boolean by type `+i.type)}if(i.type===`startsWith`){if(typeof i.value==`string`||typeof i.value==`number`||typeof i.value==`boolean`)return e.search.startsWith(i.value.toString());throw TypeError(`search value should be string、number、boolean by type `+i.type)}if(i.type===`endsWith`){if(typeof i.value==`string`||typeof i.value==`number`||typeof i.value==`boolean`)return e.search.endsWith(i.value.toString());throw TypeError(`search value should be string、number、boolean by type `+i.type)}if(i.type===`includes`){if(typeof i.value==`string`||typeof i.value==`number`||typeof i.value==`boolean`)return e.search.includes(i.value.toString());throw TypeError(`search value should be string、number、boolean by type `+i.type)}if(i.type===`match`){if(i.value instanceof RegExp)return i.value.test(e.search);if(typeof i.value==`string`||typeof i.value==`number`||typeof i.value==`boolean`)return e.search.match(i.value.toString());throw TypeError(`search value should be RegExp、string、number、boolean by type `+i.type)}throw TypeError(`search type should be same, startsWith, endsWith, includes, match`)}if(typeof i.name==`string`){let n=i.value;if(n==null||typeof n==`string`||typeof n==`number`||typeof n==`boolean`){if(n=n?.toString(),!e.searchParams.has(i.name,n)){t=!1;break}}else if(n instanceof RegExp){let r=e.searchParams.get(i.name);if(r){if(!n.test(r)){t=!1;break}}else{t=!1;break}}else throw TypeError(`searchParams value should be string, RegExp, boolean, number, null, undefined`)}else if(i.name instanceof RegExp){let n,r;if(e.searchParams.forEach((e,t)=>{!n&&t.match(i.name)&&(n=t,r=e)}),n){let e=i.value;if(e!=null){if(typeof e==`string`||typeof e==`number`||typeof e==`boolean`){if(e=e.toString(),t=e===r,!t)break}else if(e instanceof RegExp){if(r){if(!e.test(r)){t=!1;break}}else{t=!1;break}}else throw TypeError(`searchParams value should be string, RegExp, boolean, number, null, undefined`)}}else{t=!1;break}}else throw TypeError(`searchParams name should be string or RegExp`)}return t}].every(e=>e())}},H={host(e,t){return H.builder(t).host(e)},hostName(e,t){return H.builder(t).hostName(e)},search(e,t){return H.builder(t).search(e)},seachParams(e,t,n){return H.builder(n).searchParams(e,t)},pathname(e,t){return H.builder(t).pathname(e)},protocol(e,t){return H.builder(t).protocol(e)},builder(e){return new me(e)}},U={isDevPress(){return H.hostName(`devpress.csdn.net`).r()},isDevPressArticle(){return window.location.hostname.split(`.`).length===3&&H.builder().pathnameEndsWith(`.html`).r()},isBlog(){return H.builder().originIncludes(`blog.csdn.net`).r()},isEdu(){return H.hostName(`edu.csdn.net`).r()},isBBS(){return H.hostName(`bbs.csdn.net`).r()},isBlogArticle(){return this.isBlog()&&H.builder().pathnameIncludes(`/article/details/`).r()},isWenKu(){return H.builder().originIncludes(`wenku.csdn.net`).r()},isLink(){return H.hostName(`link.csdn.net`).r()},isDownload(){return H.hostName(`download.csdn.net`).r()},isSo(){return H.hostName(`so.csdn.net`).r()},isSoCKnow(){return this.isSo()&&H.builder().pathnameStartsWith(`/chat`).or().pathnameStartsWith(`/so/ai`).r()}},he={init(){V.execMenuOnce(`csdn-link-jumpRedirect`,()=>{this.jumpRedirect()})},jumpRedirect(){try{let e=new URLSearchParams(window.location.search),t=`target`;if(e.has(t)){let n=e.get(t),r=decodeURIComponent(n);E.success(`跳转链接：${r}`),window.location.href=r}else E.error(`解析跳转的链接失败，原因：搜索参数中没有target参数`)}catch(t){e.default.error(`跳转链接失败：`+t.message)}}},ge={init(){V.execMenuOnce(`m-csdn-link-jumpRedirect`,()=>{he.jumpRedirect()})}},_e=`/* 右下角的 免费赢华为平板xxxx */
...
`,ye={init(){k(ve),V.execMenuOnce(`csdn-devpress-centerContent`,()=>this.centerContent()),V.execMenuOnce(`csdn-devpress-shieldCloudDeveloperTaskChallengeEvent`,()=>this.blockCloudDeveloperTaskChallengeEvent()),V.execMenuOnce(`csdn-devpress-autoExpandContent`,()=>this.autoExpandContent()),V.execMenuOnce(`csdn-devpress-shieldLeftFloatingButton`,()=>this.blockLeftFloatingButton()),V.execMenuOnce(`csdn-devpress-blockRightColumn`,()=>this.blockRightColumn()),V.execMenuOnce(`csdn-devpress-blockBottomCSo`,()=>this.blockBottomCSo()),V.execMenuOnce(`csdn-devpress-blockRecommendedContentAtTheBottom`,()=>this.blockRecommendedContentAtTheBottom()),V.execMenuOnce(`csdn-devpress-shieldTheBottomForMoreRecommendations`,()=>this.blockTheBottomForMoreRecommendations())},centerContent(){return E.info(`全文居中`),k(`
...
`,Se=`.ecommend-item-box.recommend-recommend-box,
.login-mark,
.opt-box.text-center,
.leftPop,
#csdn-shop-window,
...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof m==`function`?m(e.keyName):``;typeof t==`string`&&t?k(t):G.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement(`link`);t.rel=`stylesheet`,t.type=`text/css`,t.href=e,w.onReady(()=>{document.head.appendChild(t)})},async loadScript(e){let t=document.createElement(`script`);return t.src=e,new Promise(e=>{t.onload=()=>{e(null)},(document.head||document.documentElement).appendChild(t)})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)?e:(e.startsWith(`/`)||(e+=`/`),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith(`https://`)||!e.startsWith(`http://`))return e;let t=new URL(e);return t.protocol=`https:`,t.toString()}},we={init(){V.execMenuOnce(`m-csdn-blog-blockBottomArticle`,()=>this.blockBottomArticle()),V.execMenuOnce(`m-csdn-blog-removeResourceArticle`,()=>this.removeResourceArticle()),V.execMenuOnce(`m-csdn-blog-openNewTab`,()=>this.openNewTab()),w.onReady(()=>{V.execMenuOnce(`m-csdn-blog-refactoringRecommendation`,e=>this.refactoringRecommendation())})},blockBottomArticle(){return E.info(`【屏蔽】底部文章`),G.addBlockCSS(`#recommend`)},async refactoringRecommendation(){let e=new C.LockFunction(function(){ce(`.container-fluid`).forEach(e=>{let t=``,n=``,r=``,i=``;if(e.hasAttribute(`data-url`)){if(t=e.getAttribute(`data-url`),n=e.querySelector(`.recommend_title div.left`)?.innerHTML,!e.querySelector(`.text`))return;r=e.querySelector(`.text`)?.innerHTML,e.querySelectorAll(`.recommend-img`).length&&e.querySelectorAll(`.recommend-img`).forEach(e=>{i+=e.innerHTML})}else t=e.querySelector(`a[data-type]`).getAttribute(`href`),n=e.querySelector(`.recommend_title div.left`).innerHTML,r=e.querySelector(`.text`).innerHTML;let a=new URL(t);a.host===`download.csdn.net`||a.host===`www.iteye.com`&&a.pathname.match(/^\/resource/gi)?n=`<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>`+n:a.origin.match(/edu.csdn.net/gi)&&(n=`<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>`+n),e.setAttribute(`class`,`GM-csdn-dl`),e.setAttribute(`data-url`,t),e.innerHTML=`<div class="GM-csdn-title"><div class="left">${n}</div></div><div class="GM-csdn-content">${r}</div><div class="GM-csdn-img">${i}</div>`,e.addEventListener(`click`,function(){window.location.href=t})})},50),t=await w.waitNode(`#recommend`);E.info(`重构底部推荐`);let n=C.mutationObserver(t,{config:{childList:!0,subtree:!0,attributes:!0},immediate:!0,callback:()=>{e.run()}});return[()=>{n.disconnect()}]},removeResourceArticle(){return E.info(`移除资源下载的文章`),G.addBlockCSS(`.container-fluid:has(a[href*="https://download.csdn.net/"])`,`.container-fluid[data-url*="https://download.csdn.net/"]`,`.GM-csdn-dl[data-url*="https://download.csdn.net/"]`)},openNewTab(){return E.info(`新标签页打开`),w.on(document,`click`,[`.container-fluid`,`.GM-csdn-dl`],(t,n)=>{w.preventEvent(t);let r=n.getAttribute(`data-url`);typeof r==`string`?(E.info(`新标签页打开：${r}`),window.open(r,`_blank`)):e.default.error(`未获取到data-url属性`)},{capture:!0}).off}},K={isSuccessResponse(e){return e!=null&&(typeof e==`string`&&(e=C.toJSON(e)),e?.code===200)}},q={async folderListWithCheck(t){let n=await O.get(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/folderListWithCheck`,{data:{url:t},fetch:!0,allowInterceptConfig:!1,headers:{"User-Agent":C.getRandomPCUA()}});E.info(n);let r=C.toJSON(n.data.responseText);if(!n.status||!K.isSuccessResponse(n.data.responseText)){E.error(`获取收藏夹信息失败，请求异常`),typeof r.msg==`string`?e.default.error(r.msg):e.default.error(`获取收藏夹信息失败`);return}return r.data.result},async addFavoriteInFolds(t){let n=await O.post(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/addFavoriteInFolds`,{fetch:!0,data:t,headers:{"Content-Type":`application/json`,"User-Agent":C.getRandomPCUA()},allowInterceptConfig:!1});if(E.info(n),!n.status||!K.isSuccessResponse(n.data.responseText)){E.error(`添加收藏失败，请求异常`,n),e.default.error(`添加收藏失败，请求异常`);return}return!0},async checkFavoriteByUrl(t){let n=await O.get(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/checkFavoriteByUrl`,{data:{url:t},fetch:!0,allowInterceptConfig:!1,headers:{"User-Agent":C.getRandomPCUA()}});if(E.info(n),!n.status||!K.isSuccessResponse(n.data.responseText)){E.error(`检查收藏夹状态失败，请求异常`),e.default.error(`检查收藏夹状态失败，请求异常`);return}return C.toJSON(n.data.responseText).data},async createFolder(t){let n=await O.post(`https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/createFolder`,{data:t,fetch:!0,headers:{Accept:`application/json, text/javascript, */*; q=0.01`,"Content-Type":`application/json`,"User-Agent":C.getRandomPCUA()},allowInterceptConfig:!1});if(E.info(n),!n.status||!K.isSuccessResponse(n.data.responseText)){e.default.error(`创建收藏夹失败`);return}return C.toJSON(n.data.responseText).data}},Te={init(){V.execMenuOnce(`m-csdn-blog-blockBottomToolbar`,()=>this.blockBottomToolbar()),V.execMenuOnce(`m-csdn-blog-bottom-toolbar-always-bottom`,()=>this.bottomToolBarAlwaysShow()),w.onReady(()=>{V.execMenuOnce(`m-csdn-blog-bottom-toolbar-optimizationCollectButton`,()=>this.optimizationCollectButton())})},blockBottomToolbar(){return E.info(`【屏蔽】底部工具栏`),G.addBlockCSS(`#operate`)},bottomToolBarAlwaysShow(){return E.info(`底部工具栏常驻`),k(`
    ...
    `)},async optimizationCollectButton(){E.info(`优化收藏按钮`);let t=await w.waitNode(`#operate .collect-btn`,1e4);if(!t)return;let n=w.on(t,`click`,async n=>{w.preventEvent(n);let r=t.querySelector(`.collect`),i=t.querySelector(`.uncollect`),a=await q.folderListWithCheck(window.location.origin+window.location.pathname);if(!a)return;let o=[];a.forEach(e=>{e.IsFavorite&&o.push(e.ID)});let s=t=>{let n=t.ID,a=w.createElement(`li`,{className:`csdn-collection-item`,innerHTML:`
        ...
        `}).$shadowRoot.querySelector(`.csdn-collection-items`);a.forEach(e=>{let t=s(e);c.appendChild(t)})},{capture:!0});return[()=>{n.off()}]}},Ee={init(){V.execMenuOnce(`m-csdn-blog-blockComment`,()=>this.blockComment()),V.execMenuOnce(`m-csdn-blog-notLimitCommentMaxHeight`,()=>this.notLimitCommentMaxHeight())},blockComment(){return E.info(`【屏蔽】评论区`),G.addBlockCSS(`#comment`)},notLimitCommentMaxHeight(){return E.info(`不限制评论区的最大高度`),k(`
        #comment{
          max-height: none !important;
        }
      `)}},De={init(){Ee.init(),we.init(),Te.init(),V.execMenuOnce(`m-csdn-blog-blockTopToolbar`,()=>this.blockTopToolbar()),V.execMenuOnce(`m-csdn-blog-removeAds`,()=>this.removeAds()),V.execMenuOnce(`m-csdn-blog-allowSelectText`,()=>this.allowSelectText()),V.execMenuOnce(`m-csdn-blog-autoExpandContent`,()=>this.autoExpandContent()),V.execMenuOnce(`m-csdn-blog-notLimitCodePreMaxHeight`,()=>this.notLimitCodePreMaxHeight()),w.onReady(()=>{V.execMenuOnce(`m-csdn-blog-unBlockCopy`,()=>{Ce.unBlockCopy()})})},blockTopToolbar(){return E.info(`屏蔽顶部Toolbar`),[S.addBlockCSS(`#csdn-toolbar`),k(`
			/* 内容顶部要归位 */
			body #main,
			.margin_sides{
...
`,ke={init(){k(Oe),V.execMenuOnce(`m-csdn-wenku-shieldBottomToolbar`,()=>this.shieldBottomToolbar())},shieldBottomToolbar(){return E.info(`【屏蔽】底部工具栏`),S.addBlockCSS(`.page-container > div.btn`)}},Ae=`/* 右下角悬浮图标 买1年送3个月 */
...
`,je={init(){V.execMenuOnce(`m-csdn-download-removeAds`,()=>k(Ae)),V.execMenuOnce(`m-csdn-download-automaticallyExpandResourceIntroduction`,()=>this.automaticallyExpandResourceIntroduction())},automaticallyExpandResourceIntroduction(){return E.info(`自动展开资源介绍`),[S.addBlockCSS(`label.unfold-font`),k(`
			.resource-desc{
				max-height: unset !important;
...
`,Pe={init(){V.onceExec(`m-csdn-blog-removeAds`,()=>this.addCSS()),V.execMenuOnce(`m-csdn-blog-blockBottomAskAIToolbar`,()=>W.blockBottomAskAIToolbar())},addCSS(){return[k(Me),k(Ne)]}},Fe={init(){Pe.init()}},Ie={init(){U.isLink()?(E.info(`Router: 中转链接`),ge.init()):U.isBlog()?(E.info(`Router: 博客`),Fe.init(),U.isBlogArticle()&&(E.info(`Router: 文章`),De.init())):U.isWenKu()?(E.info(`Router: 文库`),ke.init()):U.isDownload()?(E.info(`Router: 资源下载`),je.init()):U.isDevPressArticle()?(E.info(`Router: 社区-文章`),be.init()):E.error(`暂未适配，请反馈开发者：`+globalThis.location.href)}},Le=`/* 顶部工具栏右边的 会员 */
#csdn-toolbar .toolbar-btn > a[href*="mall.csdn.net/vip"],
/* 顶部工具栏右边的 VIP抢千元豪礼 */
#csdn-toolbar a.toolbar-btn[href*="mall.csdn.net/vip"] {
  display: none !important;
}
`,Re={init(){V.execMenuOnce(`csdn-blog-shieldBottomSkillTree`,()=>this.shieldBottomSkillTree()),V.execMenuOnce(`csdn-blog-shieldArticleSearchTip`,()=>this.shieldArticleSearchTip()),V.execMenuOnce(`csdn-blog-blockGitCodeLinkCard`,()=>this.blockGitCodeLinkCard())},shieldBottomSkillTree(){return E.info(`【屏蔽】底部xx技能树`),S.addBlockCSS(`#treeSkill`)},shieldArticleSearchTip(){return E.info(`【屏蔽】选中文字悬浮栏`),S.addBlockCSS(`#articleSearchTip`)},blockGitCodeLinkCard(){return E.info(`【屏蔽】gitcode链接卡片`),S.addBlockCSS(`a.has-card[href*="gitcode.com"]`,`.t2-card-container`)}},ze=`.main_father {
...
`,Be={init(){V.execMenuOnce(`csdn-blog-blockComment`,()=>this.blockComment()),w.onReady(()=>{V.execMenuOnce(`csdn-blog-restoreComments`,()=>{this.restoreComments()})})},blockComment(){return E.info(`【屏蔽】评论区`),G.addBlockCSS(`#pcCommentBox`)},restoreComments(){E.info(`恢复评论到正确位置-第一条评论`),w.waitNode(`.first-recommend-box`).then(e=>{let t=j(`.recommend-box.insert-baidu-box.recommend-box-style`);t.insertBefore(e,t.firstChild)}),E.info(`恢复评论到正确位置-第二条评论`),w.waitNode(`.second-recommend-box`).then(e=>{let t=j(`.recommend-box.insert-baidu-box.recommend-box-style`);t.insertBefore(e,t.firstChild)})}},Ve={init(){V.execMenuOnce(`csdn-blog-blockBottomRecommendArticle`,()=>this.blockBottomRecommendArticle()),V.execMenuOnce(`csdn-blog-identityCSDNDownload`,()=>this.identityCSDNDownload()),V.execMenuOnce(`csdn-blog-removeResourceDownloadArticle`,()=>this.removeResourceDownloadArticle())},blockBottomRecommendArticle(){return E.info(`【屏蔽】底部文章`),G.addBlockCSS(`main > div.recommend-box`)},identityCSDNDownload(){return E.info(`标识CSDN下载的链接`),k(`
        .recommend-item-box[data-url*='https://download.csdn.net/'] .content-box{
            border: 2px solid red;
        }
    `)},removeResourceDownloadArticle(){return E.info(`移除资源下载的文章`),G.addBlockCSS(`.recommend-item-box[data-url*='https://download.csdn.net/']`)}},He={init(){V.exec(`csdn-blog-rightToolbarEnable`,()=>this.shieldRightToolbar(),e=>!V.getValue(e[0]),!0),V.execMenuOnce(`csdn-blog-rightToolbarCreativeCenter`,()=>this.shieldCreativeCenter()),V.execMenuOnce(`csdn-blog-rightToolbarShowOrSidebar`,()=>this.shieldShowOrSidebar()),V.execMenuOnce(`csdn-blog-rightToolbarBeginnerGuidance`,()=>this.shieldBeginnerGuidance()),V.execMenuOnce(`csdn-blog-rightToolbarCustomerService`,()=>this.shieldCustomerService()),V.execMenuOnce(`csdn-blog-rightToolbarReport`,()=>this.shieldReport()),V.execMenuOnce(`csdn-blog-rightToolbarBackToTop`,()=>this.shieldBackToTop())},shieldRightToolbar(){return E.info(`启用/关闭 右侧工具栏`),G.addBlockCSS(`div.csdn-side-toolbar`,`.article-aside-container`)},shieldCreativeCenter(){return E.info(`【屏蔽】创作中心`),G.addBlockCSS(`.csdn-side-toolbar .sidetool-writeguide-box`)},shieldShowOrSidebar(){return E.info(`【屏蔽】显示/隐藏侧栏`),G.addBlockCSS(`.csdn-side-toolbar a.sidecolumn`)},shieldBeginnerGuidance(){return E.info(`【屏蔽】新手引导`),G.addBlockCSS(`.csdn-side-toolbar a.option-box[data-type="guide"]`)},shieldCustomerService(){return E.info(`【屏蔽】客服`),G.addBlockCSS(`.csdn-side-toolbar a.option-box[data-type="cs"]`)},shieldReport(){return E.info(`【屏蔽】举报`),G.addBlockCSS(`.csdn-side-toolbar a.option-box[data-type="report"]`)},shieldBackToTop(){return E.info(`【屏蔽】返回顶部`),G.addBlockCSS(`.csdn-side-toolbar a.option-box[data-type="gotop"]`)}},Ue={init(){He.init(),V.execMenuOnce([`csdn-blog-coverRightToolOffSet`,`csdn-blog-rightToolbarTopOffset`,`csdn-blog-rightToolbarRightOffset`],e=>{if(e.value[0])return this.initRightToolbarOffset(e.value[1],e.value[2])}),w.onReady(()=>{V.execMenuOnce(`csdn-blog-addGotoRecommandButton`,()=>{this.addGotoRecommandButton()})})},addGotoRecommandButton(){E.info(`【添加】前往评论按钮，在返回顶部的上面`);let e=document.createElement(`a`);e.className=`option-box`,e.setAttribute(`data-type`,`gorecommand`),e.innerHTML=`
    ...
    `)}},We={init(){V.execMenuOnce(`csdn-blog-ai-blockRightToolbar`,()=>this.blockRightToolbar()),V.execMenuOnce(`csdn-blog-ai-blockRightToolbarCatalogue`,()=>this.blockRightToolbarCatalogue()),V.execMenuOnce(`csdn-blog-ai-blockRightToolbarLike`,()=>this.blockRightToolbarLike()),V.execMenuOnce(`csdn-blog-ai-blockRightToolbarComment`,()=>this.blockRightToolbarComment()),V.execMenuOnce(`csdn-blog-ai-blockRightToolbarCollect`,()=>this.blockRightToolbarCollect()),V.execMenuOnce(`csdn-blog-ai-blockRightToolbarShare`,()=>this.blockRightToolbarShare()),V.execMenuOnce(`csdn-blog-ai-blockRightToolbarMore`,()=>this.blockRightToolbarMore())},blockRightToolbar(){return E.info(`【屏蔽】右侧工具栏`),G.addBlockCSS(`.article-aside-container`)},blockRightToolbarCatalogue(){return E.info(`【屏蔽】目录`),G.addBlockCSS(`.article-aside-container .sidebar-item.groupfile`)},blockRightToolbarLike(){return E.info(`【屏蔽】点赞`),G.addBlockCSS(`.article-aside-container .sidebar-item.islike`)},blockRightToolbarComment(){return E.info(`【屏蔽】评论`),G.addBlockCSS(`.article-aside-container .sidebar-item.go-side-comment`)},blockRightToolbarCollect(){return E.info(`【屏蔽】收藏`),G.addBlockCSS(`.article-aside-container .sidebar-item#sidebar-collect`)},blockRightToolbarShare(){return E.info(`【屏蔽】分享`),G.addBlockCSS(`.article-aside-container .sidebar-item#tool-share`)},blockRightToolbarMore(){return E.info(`【屏蔽】...`),G.addBlockCSS(`.article-aside-container .sidebar-item#sidebar-more`)}},Ge={init(){We.init(),V.execMenuOnce([`csdn-blog-ai-coverRightToolOffSet`,`csdn-blog-ai-coverRightToolOffSet-top`,`csdn-blog-ai-coverRightToolOffSet-right`],e=>{if(e.value[0])return this.coverRightToolOffSet(e.value[1],e.value[2])})},async coverRightToolOffSet(e,t){return E.info(`覆盖右侧工具栏的偏移（top、right）`),k(`
    #mainBox .article-aside-container{
      left: unset !important;
      top: ${e}px !important;
      right: ${t}px !important;
    }
    `)}},Ke={init(){Re.init(),Be.init(),Ve.init(),Ue.init(),Ge.init(),V.execMenuOnce(`csdn-blog-articleCenter`,()=>this.articleCenter()),V.execMenuOnce(`csdn-blog-autoExpandContent`,()=>this.autoExpandContent()),V.execMenuOnce(`csdn-blog-autoExpandCodeContent`,()=>this.autoExpandCodeContent()),V.execMenuOnce(`csdn-blog-allowSelectContent`,()=>this.allowSelectContent()),w.onReady(()=>{V.execMenuOnce(`csdn-blog-clickPreCodeAutomatically`,()=>{this.clickPreCodeAutomatically()})})},clickPreCodeAutomatically(){E.info(`点击代码块自动展开`),document.addEventListener(`click`,function(e){let t=e.target;t.localName===`pre`&&(t.style.setProperty(`height`,`auto`),t.querySelector(`.hide-preCode-box`)?.remove())})},articleCenter(){E.info(`全文居中`);let e=[k(ze)];return e.push(W.shieldRightDirectoryInformation()),e.push(k(`
      #mainBox {
        margin-right: 0px;
      }
      `)),e.push(W.shieldLeftBlogContainerAside()),e.push(k(`
      #mainBox {
        margin-left: 0px;
      }`)),e.push(k(`
...
`,Je={init(){k(qe),k(``)}},Ye=`#chatgpt-article-detail > div.layout-center > div.main > div.article-box > div.cont.first-show.forbid {
  max-height: unset !important;
  height: auto !important;
  overflow: auto !important;
}
...
`,Ze={init(){k(Ye),k(Xe),V.execMenuOnce(`csdn-wenku-shieldResourceRecommend`,()=>this.shieldResourceRecommend()),V.execMenuOnce(`csdn-wenku-shieldRightUserInfo`,()=>this.shieldRightUserInfo()),V.execMenuOnce(`csdn-wenku-shieldRightToolBar`,()=>this.shieldRightToolBar())},shieldResourceRecommend(){return E.info(`【屏蔽】资源推荐`),S.addBlockCSS(`#recommend`)},shieldRightUserInfo(){return E.info(`【屏蔽】右侧用户信息`),S.addBlockCSS(`.layout-right`)},shieldRightToolBar(){return E.info(`【屏蔽】右侧悬浮工具栏`),S.addBlockCSS(`.csdn-side-toolbar`)}},Qe={init(){k(Le),U.isLink()?(E.info(`Router: 中转链接`),he.init()):U.isBlog()?(E.info(`Router: 博客`),Ce.init(),U.isBlogArticle()&&(E.info(`Router: 帖子`),Ke.init())):U.isWenKu()?(E.info(`Router: 文库`),Ze.init()):U.isDownload()?(E.info(`Router: 下载`),Je.init()):U.isDevPressArticle()?(E.info(`Router: 社区-文章`),ye.init()):E.error(`暂未适配，请反馈开发者：`+globalThis.location.href)}},J=function(e,t,n,r,i,a,o){let s={text:e,type:`select`,description:a,attributes:{},props:{},getValue(){return this.props[I].get(t,n)},callback(e){if(e==null)return;let n=e.value;E.info(`选择：${e.text}`),!(typeof i==`function`&&i(e))&&(this.props[I].set(t,n),typeof o==`function`&&o(e))},data:r};return Reflect.set(s.attributes,P,t),Reflect.set(s.attributes,F,n),$e.initComponentsStorageApi(`select`,s,{get(e,t){return V.getValue(e,t)},set(e,t){V.setValue(e,t)}}),s},Y=function(e,t,n,r,i,a,o,s,c,l){let u={text:e,type:`slider`,description:s,attributes:{},props:{},getValue(){return this.props[I].get(t,n)},getToolTipContent(e){return typeof o==`function`?o(e):`${e}`},callback(e,n){typeof a==`function`&&a(e,n)||(this.props[I].set(t,n),typeof l==`function`&&l(e,n))},min:r,max:i,step:c};return Reflect.set(u.attributes,P,t),Reflect.set(u.attributes,F,n),$e.initComponentsStorageApi(`slider`,u,{get(e,t){return V.getValue(e,t)},set(e,t){V.setValue(e,t)}}),u},$e={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||=new r.default.Dictionary,this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t)},initComponentsStorageApi(e,t,n){let r;r=this.hasStorageApi(e)?this.getStorageApi(e):n,this.setComponentsStorageApiProperty(t,r)},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,I,t)}},X=function(t,n,r=!1,i,a,o,s,c,l){if(l&&typeof l.defaultValue==`object`&&l.defaultValue!=null){let e=l.key??n;l.handler.add({key:e,name:t}),l.handler.shortCut.initConfig(e,l.defaultValue)}let u={text:t,type:`switch`,description:a,disabled:s,attributes:{},props:{},getValue(){return this.props[I].get(n,r)},callback(e,r){let a=!!r;E.success(`${a?`开启`:`关闭`} ${t}`),!(typeof i==`function`&&i(e,a))&&(this.props[I].set(n,a),typeof c==`function`&&c(e,a))},afterAddToUListCallBack:(...r)=>{if(o?.(...r),l){let i=l.handler.shortCut,a=l.key??n,[o,s]=r,c=s.target?.querySelector(`.pops-panel-item-left-main-text`);if(!c)return;let u=()=>{let e=l.handler.shortCut.getShowText(a,`暂未录入快捷键`),n=w.createElement(`div`,{className:`pops-switch-shortcut-wrapper`,innerHTML:`
            ...
            `},{style:`margin-right: 5px;display: inline-flex;`}),r=n.querySelector(`.pops-bottom-icon`);w.on(r,`click`,function(e){l.handler.shortCut.deleteOption(a),i.toolTip.offEvent(),i.toolTip.close(),i.toolTip.destory(),n.remove()},{once:!0});let i=T.tooltip({$target:r,content:()=>e,className:`github-tooltip`,isFixed:!0,only:!0});w.empty(c),w.append(c,n,t)};if(T.rightClickMenu({$target:c,only:!0,data:[{text:()=>l.handler.shortCut.hasOption(a)?`修改快捷键`:`添加快捷键`,icon:T.config.iconSVG.keyboard,callback(t,n,r,o){if(i.isWaitKeyboardPress()){e.default.warning(`请先执行当前的录入操作`);return}let s=e.default.loading(`请按下快捷键...`,{showClose:!0,onClose(){i.cancelEnterShortcutKeys()}});i.enterShortcutKeys(a).then(({status:t,option:n,key:r})=>{s.close(),t?(E.success(`录入快捷键`,n),e.default.success(`录入成功`),u()):e.default.error(`快捷键 ${i.translateKeyboardValueToButtonText(n)} 已被 ${r} 占用`)})}}]}),!i.hasOption(a))return;u()}}};return Reflect.set(u.attributes,P,n),Reflect.set(u.attributes,F,r),$e.initComponentsStorageApi(`switch`,u,{get(e,t){return V.getValue(e,t)},set(e,t){V.setValue(e,t)}}),u},et={id:`m-panel-blog`,title:`博客`,isDefault(){return U.isBlog()},views:[{text:``,type:`container`,views:[{text:`劫持/拦截`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`允许复制`,`m-csdn-blog-unBlockCopy`,!0,void 0,`允许点击复制按钮进行复制`)]}]}]},{type:`container`,text:`文章`,views:[{text:`布局屏蔽`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`【屏蔽】广告`,`m-csdn-blog-removeAds`,!0,void 0,`包括：登录弹窗、打开APP、ios版本提示等`),X(`【屏蔽】顶部工具栏`,`m-csdn-blog-blockTopToolbar`,!1),X(`【屏蔽】评论区`,`m-csdn-blog-blockComment`,!1),X(`【屏蔽】底部文章`,`m-csdn-blog-blockBottomArticle`,!1),X(`【屏蔽】底部工具栏`,`m-csdn-blog-blockBottomToolbar`,!1),X(`【屏蔽】底部的AI伴读`,`m-csdn-blog-blockBottomAskAIToolbar`,!1)]}]},{text:`内容`,type:`deepMenu`,views:[{text:`功能`,type:`container`,views:[X(`允许选择内容`,`m-csdn-blog-allowSelectText`,!0,void 0,`解除文字选中限制`),X(`自动展开`,`m-csdn-blog-autoExpandContent`,!0,void 0,`懒人操作，免手动点击展开，包括：内容、代码块`),X(`不限制代码块的最大高度`,`m-csdn-blog-notLimitCodePreMaxHeight`,!1,void 0,`让代码块的高度直接被撑开`)]}]},{text:`评论`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`不限制评论区的最大高度`,`m-csdn-blog-notLimitCommentMaxHeight`,!0,void 0,`让评论区高度直接被撑开`)]}]},{text:`底部文章`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`重构`,`m-csdn-blog-refactoringRecommendation`,!0,void 0,`文章的样式统一`),X(`移除资源下载的文章`,`m-csdn-blog-removeResourceArticle`,!1,void 0,`download.csdn.net<br>www.iteye.com<br>edu.csdn.net`),X(`新标签页打开`,`m-csdn-blog-openNewTab`,!0,void 0,`新标签页打开文章`)]}]},{type:`deepMenu`,text:`底部工具栏`,views:[{type:`container`,text:``,views:[X(`常驻底部`,`m-csdn-blog-bottom-toolbar-always-bottom`,!1,void 0,`开启后底部工具栏不随下滑滚动而隐藏`),X(`优化收藏按钮`,`m-csdn-blog-bottom-toolbar-optimizationCollectButton`,!1,void 0,`可以自行选择收藏夹`)]}]}]}]},tt={id:`m-panel-devpress`,title:`开发者社区`,isDefault(){return U.isDevPressArticle()},views:[{text:`功能`,type:`container`,views:[X(`自动展开全文`,`m-csdn-devpress-autoExpandContent`,!0)]},{text:`布局屏蔽`,type:`container`,views:[X(`【屏蔽】推荐内容`,`m-csdn-devpress-blockRecommendedContentAtTheBottom`,!1),X(`【屏蔽】底部的加入社区`,`m-csdn-devpress-blockBottomJoinTheCommunity`,!0)]}]},nt={id:`m-panel-download`,title:`资源`,isDefault(){return U.isDownload()},views:[{text:`功能`,type:`container`,views:[X(`自动展开资源介绍`,`m-csdn-download-automaticallyExpandResourceIntroduction`,!0,void 0,`屏蔽资源介绍【展开全部】按钮并展开资源介绍`)]},{text:`布局屏蔽`,type:`container`,views:[X(`【屏蔽】广告`,`m-csdn-download-removeAds`,!0,void 0,`包括：登录弹窗、会员降价等`)]}]},rt={id:`component-common`,title:`通用`,views:[{text:`Toast配置`,type:`container`,views:[J(`Toast位置`,`qmsg-config-position`,`bottom`,[{value:`topleft`,text:`左上角`},{value:`top`,text:`顶部`},{value:`topright`,text:`右上角`},{value:`left`,text:`左边`},{value:`center`,text:`中间`},{value:`right`,text:`右边`},{value:`bottomleft`,text:`左下角`},{value:`bottom`,text:`底部`},{value:`bottomright`,text:`右下角`}],e=>{E.info(`设置当前Qmsg弹出位置`+e.text)},`Toast显示在页面九宫格的位置`),J(`最多显示的数量`,`qmsg-config-maxnums`,3,[{value:1,text:`1`},{value:2,text:`2`},{value:3,text:`3`},{value:4,text:`4`},{value:5,text:`5`}],void 0,`限制Toast显示的数量`),X(`逆序弹出`,`qmsg-config-showreverse`,!1,void 0,`修改Toast弹出的顺序`)]}]},it={id:`m-panel-link`,title:`链接`,isDefault(){return U.isLink()},views:[{text:`功能`,type:`container`,views:[X(`重定向链接`,`m-csdn-link-jumpRedirect`,!0,void 0,`自动跳转至被拦截的Url链接`)]}]},at={id:`panel-so`,title:`搜索`,isDefault(){return U.isSo()},views:[{text:`C知道-功能`,type:`container`,views:[X(`去除水印`,`m-csdn-so-cknow-removeMaskCover`,!0)]}]},ot={id:`m-panel-wenku`,title:`文库`,isDefault(){return U.isWenKu()},views:[{text:`布局屏蔽`,type:`container`,views:[X(`【屏蔽】底部工具栏`,`m-csdn-wenku-shieldBottomToolbar`,!1)]}]},st={id:`panel-blog`,title:`博客`,isDefault(){return U.isBlog()},views:[{text:``,type:`container`,views:[{text:`劫持/拦截`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`拦截-复制的小尾巴`,`csdn-blog-removeClipboardHijacking`,!0),X(`劫持-禁止复制`,`csdn-blog-unBlockCopy`,!0,void 0,`允许点击复制按钮进行复制`),X(`劫持-loginBox`,`csdn-blog-hookCSDN_loginBox`,!0,void 0,`阻止跳转登录`)]}]}]},{type:`container`,text:`文章`,views:[{text:`布局屏蔽`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`【屏蔽】登录弹窗`,`csdn-blog-shieldLoginDialog`,!0),X(`【屏蔽】顶部工具栏`,`csdn-blog-shieldTopToolbar`,!1),X(`【屏蔽】左侧博客信息`,`csdn-blog-shieldLeftBlogContainerAside`,!1),X(`【屏蔽】右侧目录信息`,`csdn-blog-shieldRightDirectoryInformation`,!1),X(`【屏蔽】评论区`,`csdn-blog-blockComment`,!1),X(`【屏蔽】底部文章`,`csdn-blog-blockBottomRecommendArticle`,!1),X(`【屏蔽】底部的悬浮工具栏`,`csdn-blog-shieldBottomFloatingToolbar`,!1),X(`【屏蔽】底部的AI伴读`,`csdn-blog-blockBottomAskAIToolbar`,!1),X(`【屏蔽】runner-box`,`csdn-blog-blockRunnerBox`,!0)]}]},{text:`右侧悬浮工具栏`,type:`deepMenu`,views:[{text:`功能`,type:`container`,views:[X(`【添加按钮】前往评论`,`csdn-blog-addGotoRecommandButton`,!0,void 0,`在悬浮工具栏最后面添加`)]},{text:`坐标偏移`,type:`container`,views:[X(`启用`,`csdn-blog-coverRightToolOffSet`,!1),Y(`top偏移`,`csdn-blog-rightToolbarTopOffset`,140,0,Math.max(document.documentElement.clientHeight/2,400),void 0,e=>`当前：${e}px，默认：140px`),Y(`right偏移`,`csdn-blog-rightToolbarRightOffset`,90,0,Math.max(document.documentElement.clientWidth/2,400),void 0,e=>`当前：${e}px，默认：90px`)]},{text:`屏蔽`,type:`container`,views:[X(`【屏蔽】右侧工具栏`,`csdn-blog-rightToolbarEnable`,!1),X(`【屏蔽】创作中心`,`csdn-blog-rightToolbarCreativeCenter`,!1),X(`【屏蔽】显示/隐藏侧栏`,`csdn-blog-rightToolbarShowOrSidebar`,!1),X(`【屏蔽】新手引导`,`csdn-blog-rightToolbarBeginnerGuidance`,!1),X(`【屏蔽】客服`,`csdn-blog-rightToolbarCustomerService`,!1),X(`【屏蔽】举报`,`csdn-blog-rightToolbarReport`,!1),X(`【屏蔽】返回顶部`,`csdn-blog-rightToolbarBackToTop`,!1)]}]},{text:`右侧悬浮工具栏（AI助读版）`,type:`deepMenu`,views:[{text:`坐标偏移`,type:`container`,views:[X(`启用`,`csdn-blog-ai-coverRightToolOffSet`,!1),Y(`top偏移`,`csdn-blog-ai-coverRightToolOffSet-top`,48,0,Math.max(document.documentElement.clientHeight/2,400),void 0,e=>`当前：${e}px，默认：48px`),Y(`right偏移`,`csdn-blog-ai-coverRightToolOffSet-right`,150,0,Math.max(document.documentElement.clientWidth/2,400),void 0,e=>`当前：${e}px，默认：150px`)]},{text:`屏蔽`,type:`container`,views:[X(`【屏蔽】右侧工具栏`,`csdn-blog-ai-blockRightToolbar`,!1),X(`【屏蔽】目录`,`csdn-blog-ai-blockRightToolbarCatalogue`,!1),X(`【屏蔽】点赞`,`csdn-blog-ai-blockRightToolbarLike`,!1),X(`【屏蔽】评论`,`csdn-blog-ai-blockRightToolbarComment`,!1),X(`【屏蔽】收藏`,`csdn-blog-ai-blockRightToolbarCollect`,!1),X(`【屏蔽】分享`,`csdn-blog-ai-blockRightToolbarShare`,!1),X(`【屏蔽】...`,`csdn-blog-ai-blockRightToolbarMore`,!1)]}]},{text:`内容`,type:`deepMenu`,views:[{text:`功能`,type:`container`,views:[X(`点击代码块自动展开`,`csdn-blog-clickPreCodeAutomatically`,!0,void 0,`当鼠标点击代码块区域时，将自动展开内容`),X(`自动展开代码块`,`csdn-blog-autoExpandCodeContent`,!0,void 0,`懒人操作，免手动点击展开`),X(`自动展开内容`,`csdn-blog-autoExpandContent`,!0,void 0,`懒人操作，免手动点击展开`),X(`全文居中`,`csdn-blog-articleCenter`,!0,void 0,`自动执行<code>【屏蔽】左侧博客信息</code>和<code>【屏蔽】右侧目录信息</code>，并将文章居中`),X(`允许选择内容`,`csdn-blog-allowSelectContent`,!0,void 0,`解除文字选中限制`)]},{text:`屏蔽`,type:`container`,views:[X(`【屏蔽】底部xx技能树`,`csdn-blog-shieldBottomSkillTree`,!1),X(`【屏蔽】选中文字悬浮栏`,`csdn-blog-shieldArticleSearchTip`,!1,void 0,`选中文字弹出的，例如：搜索、评论、笔记`),X(`【屏蔽】gitcode链接卡片`,`csdn-blog-blockGitCodeLinkCard`,!1)]}]},{text:`评论区`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`优化评论区的位置`,`csdn-blog-restoreComments`,!0)]}]},{text:`底部文章`,type:`deepMenu`,views:[{text:``,type:`container`,views:[X(`标识CSDN下载`,`csdn-blog-identityCSDNDownload`,!0,void 0,`使用红框标识`),X(`移除资源下载的文章`,`csdn-blog-removeResourceDownloadArticle`,!1,void 0,`download.csdn.net<br>www.iteye.com<br>edu.csdn.net`)]}]}]}]},ct={id:`panel-devpress`,title:`开发者社区`,isDefault(){return U.isDevPressArticle()},views:[{text:`功能`,type:`container`,views:[X(`自动展开全文`,`csdn-devpress-autoExpandContent`,!0),X(`全文居中`,`csdn-devpress-centerContent`,!1)]},{text:`布局屏蔽`,type:`container`,views:[X(`【屏蔽】云开发者任务挑战活动`,`csdn-devpress-shieldCloudDeveloperTaskChallengeEvent`,!0),X(`【屏蔽】推荐内容`,`csdn-devpress-blockRecommendedContentAtTheBottom`,!0),X(`【屏蔽】左侧悬浮按钮`,`csdn-devpress-shieldLeftFloatingButton`,!1,void 0,`开启后将屏蔽【当前阅读量】、【点赞按钮】、【评论按钮】、【分享按钮】`),X(`【屏蔽】右侧栏`,`csdn-devpress-blockRightColumn`,!1,void 0,`开启后将屏蔽【相关产品】-【活动日历】-【运营活动】-【热门标签】`),X(`【屏蔽】底部C知道`,`csdn-devpress-blockBottomCSo`,!1),X(`【屏蔽】底部更多推荐`,`csdn-devpress-shieldTheBottomForMoreRecommendations`,!1)]}]},lt={id:`component-common`,title:`通用`,views:[{text:`Toast配置`,type:`container`,views:[J(`Toast位置`,`qmsg-config-position`,`bottom`,[{value:`topleft`,text:`左上角`},{value:`top`,text:`顶部`},{value:`topright`,text:`右上角`},{value:`left`,text:`左边`},{value:`center`,text:`中间`},{value:`right`,text:`右边`},{value:`bottomleft`,text:`左下角`},{value:`bottom`,text:`底部`},{value:`bottomright`,text:`右下角`}],e=>{E.info(`设置当前Qmsg弹出位置`+e.text)},`Toast显示在页面九宫格的位置`),J(`最多显示的数量`,`qmsg-config-maxnums`,3,[{value:1,text:`1`},{value:2,text:`2`},{value:3,text:`3`},{value:4,text:`4`},{value:5,text:`5`}],void 0,`限制Toast显示的数量`),X(`逆序弹出`,`qmsg-config-showreverse`,!1,void 0,`修改Toast弹出的顺序`)]}]},ut={id:`panel-link`,title:`链接`,isDefault(){return U.isLink()},views:[{text:`功能`,type:`container`,views:[X(`重定向链接`,`csdn-link-jumpRedirect`,!0,void 0,`自动跳转至被拦截的Url链接`)]}]},dt={id:`panel-so`,title:`搜索`,isDefault(){return U.isSo()},views:[{text:`C知道-功能`,type:`container`,views:[X(`去除水印`,`csdn-so-cknow-removeMaskCover`,!0)]}]},ft={id:`panel-wenku`,title:`资源`,isDefault(){return U.isLink()},views:[{text:`布局屏蔽`,type:`container`,views:[X(`【屏蔽】资源推荐`,`csdn-wenku-shieldResourceRecommend`,!1),X(`【屏蔽】右侧用户信息`,`csdn-wenku-shieldRightUserInfo`,!1),X(`【屏蔽】右侧悬浮工具栏`,`csdn-wenku-shieldRightToolBar`,!1)]}]};fe.deleteMenuOption(0),fe.addMenuOption([{key:`pc_setting`,text:`⚙ PC端设置`,autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{V.showPanel(z.getConfig(0))}},{key:`m_setting`,text:`⚙ 移动端设置`,autoReload:!1,isStoreValue:!1,showText(e){return e},callback:()=>{V.showPanel(z.getConfig(1))}}]),z.addContentConfig([lt,st,ut,ct,ft,dt]),z.addContentConfig([rt,et,it,tt,ot,at,nt]),V.init();var Z=C.isPhone(),Q=`change_env_set`,$=h(Q);$!=null&&($==1?(Z=!0,E.info(`手动指定为移动端`)):$==2?(Z=!1,E.info(`手动指定为PC端`)):(e.default.error(`意外，手动指定的值不在允许范围内，自动判定为${$===1?`移动端`:`PC端`}`),p(Q))),D.add({key:Q,text:`🖥️ 自动: ${Z?`移动端`:`PC端`}`,autoReload:!1,isStoreValue:!1,showText(e){return $==null?e:`🖥️ 手动: ${$==1?`移动端`:$==2?`PC端`:`未知`}`},callback:()=>{let t=[0,1,2],n=window.prompt(`请输入当前脚本环境判定

自动判断: 0
移动端: 1
PC端: 2`,`0`);if(!n)return;let r=parseInt(n);if(isNaN(r)){e.default.error(`输入的不是规范的数字`);return}if(!t.includes(r)){e.default.error(`输入的值必须是0或1或2`);return}r==0?p(Q):y(Q,r)}}),Z?(E.info(`自动判定为移动端`),D.delete(`pc_setting`),Ie.init()):(E.info(`自动判定为PC端`),D.delete(`m_setting`),Qe.init())})(Qmsg,DOMUtils,pops,Utils);

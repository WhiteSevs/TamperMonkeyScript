...
`)}{display: none !important;}`)},setGMResourceCSS(e){const t=typeof ue=="function"?ue(e.keyName):null;return typeof t=="string"&&t?T(t):M.loadStyleLink(e.url)},async loadStyleLink(e){let t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.href=e,new Promise(n=>{q.onReady(()=>{document.head.appendChild(t),n(t);});})},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.startsWith("data:")||e.match(/^http(s|):\/\//i)?e:e.startsWith("//")?(e.startsWith("///")||(e=window.location.protocol+e),e):(e.startsWith("/")||(e+="/"),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;try{let t=new URL(e);return t.protocol="https:",t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement("style");t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(i=>{i.classList.add("pops-overflow-hidden-important");}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(i=>{i.classList.remove("pops-overflow-hidden-important");}),t.remove();}}},async getClipboardText(){function e(i){navigator.clipboard.readText().then(r=>{i(r);}).catch(r=>{o.error("读取剪贴板内容失败👉",r),i("");});}function t(i){navigator.permissions.query({name:"clipboard-read"}).then(r=>{e(i);}).catch(r=>{o.error("申请剪贴板权限失败，尝试直接读取👉",r.message??r.name??r.stack),e(i);});}function n(){return !(typeof navigator?.clipboard?.readText!="function"||typeof navigator?.permissions?.query!="function")}return new Promise(i=>{if(!n()){i("");return}document.hasFocus()?t(i):window.addEventListener("focus",()=>{t(i);},{once:true});})},escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/©/g,"&copy;").replace(/®/g,"&reg;").replace(/™/g,"&trade;").replace(/→/g,"&rarr;").replace(/←/g,"&larr;").replace(/↑/g,"&uarr;").replace(/↓/g,"&darr;").replace(/—/g,"&mdash;").replace(/–/g,"&ndash;").replace(/…/g,"&hellip;").replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br>").replace(/\r/g,"<br>").replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")},interval(e,t,n=5e3){let i,r=n-t,c=t,s=async w=>{const h=await e(w);if(typeof h=="boolean"&&h||w){C.workerClearTimeout(i);return}if(c+=t,c>r){s(true);return}i=C.workerSetTimeout(()=>{s(false);},t);};s(false);},findParentNode(e,t,n){if(n){let i=q.closest(e,n);if(i)return i.querySelector(t)}else return q.matches(e,t)?e:q.closest(e,t)},toStr(e){const t="__undefined__placeholder__replaced__str__";return JSON.stringify(e,(i,r)=>r===void 0?t:r,2).replace(new RegExp(`"${t}"`,"g"),"undefined")}},C=Z.noConflict(),l=q.noConflict(),H=me,o=new C.Log(ne,B.console||Ue.console),be=ne?.script?.name||void 0,Fe=me.config.Utils.AnyTouch(),Ge=false;o.config({debug:false,logMaxCount:250,autoClearConsole:true,tag:true});b.config({isHTML:true,autoClose:true,showClose:false,consoleLogContent(e){const t=e.setting.type;if(t==="loading")return  false;const n=e.setting.content;return t==="warning"?o.warn(n):t==="error"?o.error(n):o.info(n),true},get position(){return a.getValue(te.qmsg_config_position.key,te.qmsg_config_position.defaultValue)},get maxNums(){return a.getValue(te.qmsg_config_maxnums.key,te.qmsg_config_maxnums.defaultValue)},get showReverse(){return a.getValue(te.qmsg_config_showreverse.key,te.qmsg_config_showreverse.defaultValue)},get zIndex(){let e=Z.getMaxZIndex(),t=me.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Z.getMaxValue(e,t)+100}});H.GlobalConfig.setGlobalConfig({zIndex:()=>{const e=Z.getMaxZIndex(void 0,void 0,n=>{if(n?.classList?.contains("qmsg-shadow-container")||n?.closest("qmsg")&&n.getRootNode()instanceof ShadowRoot)return  false}),t=me.config.InstanceUtils.getPopsMaxZIndex().zIndex;return Z.getMaxValue(e,t)+100},mask:{enable:true,clickEvent:{toClose:false,toHide:false}},drag:true});const Re=new C.GM_Menu({GM_getValue:re,GM_setValue:ge,GM_registerMenuCommand:Oe,GM_unregisterMenuCommand:Ie}),z=new C.Httpx({xmlHttpRequest:Ne,logDetails:Ge});z.interceptors.request.use(e=>e);z.interceptors.response.use(void 0,e=>(o.error("拦截器-请求错误",e),e.type==="onabort"?b.warning("请求取消",{consoleLogContent:true}):e.type==="onerror"?b.error("请求异常",{consoleLogContent:true}):e.type==="ontimeout"?b.error("请求超时",{consoleLogContent:true}):b.error("其它错误",{consoleLogContent:true}),e));B.Object.defineProperty,B.Function.prototype.apply,B.Function.prototype.call,B.Element.prototype.appendChild,B.setTimeout.bind(B),B.clearTimeout.bind(B),B.setInterval.bind(B),B.clearInterval.bind(B);const T=l.addStyle.bind(l),pe=q.selector.bind(q),Ae=q.selectorAll.bind(q);new C.GM_Cookie;const he="GM_Panel",qe="data-init",ae="data-key",se="data-default-value",Pe="data-init-more-value",He="data-plugin-search-config",Y="data-storage-api",K={get width(){return globalThis.innerWidth},get height(){return globalThis.innerHeight}},P={setting:{get width(){return K.width<550?"88vw":K.width<700?"550px":"700px"},get height(){return K.height<450?"70vh":K.height<550?"450px":"550px"}},settingMiddle:{get width(){return K.width<350?"88vw":"350px"}},info:{get width(){return K.width<350?"88vw":"350px"},get height(){return K.height<250?"88vh":"250px"}}},Q={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig==null&&(this.__contentConfig=new C.Dictionary),this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e);},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let e=false,t;const n=(c,s)=>{typeof s!="string"&&(s=M.toStr(s));const w=new Blob([s]),h=globalThis.URL.createObjectURL(w);l.createElement("a",{href:h,download:c}).click(),C.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(h);},500);},i=()=>{const c=p=>{const u=H.alert({title:{text:"请选择导入方式",position:"center"},content:{text:`
          ...
          }`}),y=u.$shadowRoot.querySelector(".btn-control[data-mode='local']"),E=u.$shadowRoot.querySelector(".btn-control[data-mode='network']"),G=u.$shadowRoot.querySelector(".btn-control[data-mode='clipboard']"),$=async L=>{confirm("是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）")&&(typeof le=="function"?typeof ie=="function"?(le().forEach(f=>{ie(f);}),b.success("已清空脚本存储的配置")):b.error("不支持GM_deleteValue函数，无法执行删除脚本配置"):b.error("不支持GM_listValues函数，无法清空脚本存储的配置")),typeof _e=="function"?_e(L):Object.keys(L).forEach(f=>{const x=L[f];ge(f,x);}),b.success("配置导入完毕");},N=L=>new Promise(async _=>{const R=C.toJSON(L);Object.keys(R).length===0?b.warning("解析为空配置，不导入"):await $(R),_(true);});l.on(y,"click",L=>{l.preventEvent(L),u.close();const _=l.createElement("input",{type:"file",accept:".json"});l.on(_,["propertychange","input"],R=>{if(!_.files?.length)return;const f=_.files[0],x=new FileReader;x.onload=()=>{N(x.result);},x.readAsText(f,"UTF-8");}),_.click();}),l.on(E,"click",L=>{l.preventEvent(L),u.close();const _=H.prompt({title:{text:"网络导入",position:"center"},content:{text:"",placeholder:"请填写URL",focus:true},btn:{close:{enable:true,callback(x,A){x.close();}},ok:{text:"导入",callback:async(x,A)=>{const D=x.text;if(C.isNull(D)){b.error("请填入完整的url");return}const S=b.loading("正在获取配置..."),v=await z.get(D,{allowInterceptConfig:false});if(S.close(),!v.status){o.error(v),b.error("获取配置失败",{consoleLogContent:true});return}await N(v.data.responseText)&&x.close();}},cancel:{enable:false}},drag:true,mask:{enable:true},width:P.info.width,height:"auto"}),R=_.$shadowRoot.querySelector("input"),f=_.$shadowRoot.querySelector(".pops-prompt-btn-ok");l.on(R,["input","propertychange"],x=>{l.val(R)===""?l.attr(f,"disabled","true"):l.removeAttr(f,"disabled");}),l.onKeyboard(R,"keydown",(x,A,D)=>{x==="Enter"&&D.length===0&&l.val(R)!==""&&l.emit(f,"click");}),l.emit(R,"input");}),l.on(G,"click",async L=>{l.preventEvent(L),u.close();let _=await M.getClipboardText();if(_.trim()===""){b.warning("获取到的剪贴板内容为空");return}await N(_);});},s=(p=`${be}_panel-setting-${C.formatTime(Date.now(),"yyyy_MM_dd_HH_mm_ss")}.json`,u)=>{const y=H.alert({title:{text:"请选择导出方式",position:"center"},content:{text:`
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),E=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-file']"),G=y.$shadowRoot.querySelector(".btn-control[data-mode='export-to-clipboard']");l.on(E,"click",$=>{l.preventEvent($);try{n(p,u),y.close();}catch(N){b.error(N.toString(),{consoleLogContent:true});}}),l.on(G,"click",async $=>{await C.copy(u)?(b.success("复制成功"),y.close()):b.error("复制失败");});},h=H.confirm({title:{text:"配置",position:"center"},content:{text:`
            <textarea name="config-value" id="config" readonly></textarea>
          `,html:true},btn:{ok:{enable:true,type:"primary",text:"导入",callback(p,u){c();}},cancel:{enable:true,text:"导出",callback(p,u){s(void 0,g);}}},width:K.width<450?"90vw":"450px",height:"auto",style:`
        ...
        `,...this.$data.panelConfig});this.$data.$panel=c,this.$data.panelContent=e,i||this.registerConfigSearch({$panel:c,content:e});},registerConfigSearch(e){const{$panel:t,content:n}=e,i=async(u,y)=>{if(u==null)return;const E=await y(u);return E&&typeof E.isFind=="boolean"&&E.isFind?E.data:await i(E.data,y)},r=(u,y)=>{const E=new IntersectionObserver(G=>{G.forEach($=>{$.isIntersecting&&(y?.(),E.disconnect());});},{root:null,threshold:1});E.observe(u),u.scrollIntoView({behavior:"smooth",block:"center"});},c=u=>{const y="pops-flashing";l.onAnimationend(u,()=>{u.classList.remove(y);}),u.classList.add(y);},s=u=>{if(u.type==="dblclick"&&p)return;l.preventEvent(u),h=null;const y=H.alert({title:{text:"搜索配置",position:"center"},content:{text:`
				...
				`});y.$shadowRoot.querySelector(".search-wrapper");const E=y.$shadowRoot.querySelector(".search-config-text"),G=y.$shadowRoot.querySelector(".search-result-wrapper");E.focus();const $=()=>{l.empty(G);},N=_=>{const R=C.queryProperty(_,A=>A?.next?{isFind:false,data:A.next}:{isFind:true,data:A}),f=l.createElement("div",{className:"search-result-item",innerHTML:`
						...
						`}),x=H.config.PanelHandlerComponents();return l.on(f,"click",A=>{const S=t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-top-container li")[_.index];if(!S){b.error(`左侧项下标${_.index}不存在`);return}S.scrollIntoView({behavior:"smooth",block:"center"}),S.click(),i(_.next,async v=>{if(v?.next){const k=await l.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(".pops-panel-deepMenu-nav-item")).find(O=>{const I=Reflect.get(O,x.$data.nodeStoreConfigKey);return typeof I=="object"&&I!=null&&I.text===v.name}),2500);if(k)k.click();else return b.error("未找到对应的二级菜单"),{isFind:true,data:v};return {isFind:false,data:v.next}}else {const k=await l.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll("li:not(.pops-panel-deepMenu-nav-item)")).find(O=>Reflect.get(O,x.$data.nodeStoreConfigKey)===v.matchedData?.formConfig),2500);if(k){r(k);const O=k.closest(".pops-panel-forms-fold[data-fold-enable]");O&&(O.querySelector(".pops-panel-forms-fold-container").click(),await C.sleep(500)),r(k,()=>{c(k);});}else b.error("未找到对应的菜单项");return {isFind:true,data:v}}});}),f},L=_=>{const R=new RegExp(_,"i"),f=[],x=(D,S)=>{for(let v=0;v<D.length;v++){const k=D[v],O=k.views;if(O&&Array.isArray(O)){const I=C.deepClone(S);if(k.type==="deepMenu"){const X=C.queryProperty(I,ee=>ee?.next?{isFind:false,data:ee.next}:{isFind:true,data:ee});X.next={name:k.text};}x(O,I);}else {let I,X;if(k.type==="own"){const F=Reflect.get(k.attributes||{},He);F&&(typeof F.text=="string"&&(I=F.text),typeof F.desc=="string"&&(X=F.desc));}else I=k.text,X=Reflect.get(k,"description");const ee=[I,X],ye=ee.findIndex(F=>{if(typeof F=="string")return F.match(R)});if(ye!==-1){const F=C.deepClone(S),Se=C.queryProperty(F,j=>j?.next?{isFind:false,data:j.next}:{isFind:true,data:j});Se.next={name:I,matchedData:{path:"",formConfig:k,matchedText:ee[ye],description:X}};const ke=[];C.queryProperty(F,j=>{const xe=j?.name;return typeof xe=="string"&&xe.trim()!==""&&ke.push(xe),j?.next?{isFind:false,data:j.next}:{isFind:true,data:j}});const Le=ke.join(M.escapeHtml(" - "));Se.next.matchedData.path=Le,f.push(F);}}}};for(let D=0;D<n.length;D++){const S=n[D];if(!S.views||S.isBottom&&S.id==="script-version")continue;const v=S.views;if(v&&Array.isArray(v)){let k=S.title;typeof k=="function"&&(k=k()),x(v,{index:D,name:k});}}const A=document.createDocumentFragment();for(const D of f){let S=N(D);A.appendChild(S);}$(),G.append(A);};l.on(E,"input",C.debounce(_=>{l.preventEvent(_);let R=l.val(E).trim();if(R===""){$();return}L(R);},200));};t.$shadowRoot.querySelectorAll("aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)").forEach(u=>{l.on(u,"dblclick",s);});let h=null,m=false,g,p=false;l.on(t.$shadowRoot,"touchend","aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)",(u,y)=>{p=true,clearTimeout(g),g=void 0,m&&h===y?(m=false,h=null,s(u)):(g=setTimeout(()=>{m=false;},200),m=true,h=y);},{capture:true}),t.$shadowRoot.appendChild(l.createElement("style",{type:"text/css",textContent:`
					.pops-flashing{
...
`)}{display: none !important;}`)},setGMResourceCSS(e){let t=typeof ue=="function"?ue(e.keyName):"";typeof t=="string"&&t?T(t):U.loadStyleLink(e.url);},async loadStyleLink(e){let t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href=e,l.onReady(()=>{document.head.appendChild(t);});},async loadScript(e){let t=document.createElement("script");return t.src=e,new Promise(n=>{t.onload=()=>{n(null);},(document.head||document.documentElement).appendChild(t);})},fixUrl(e){return e=e.trim(),e.match(/^http(s|):\/\//i)||(e.startsWith("/")||(e+="/"),e=window.location.origin+e),e},fixHttps(e){if(e.startsWith("https://")||!e.startsWith("http://"))return e;let t=new URL(e);return t.protocol="https:",t.toString()}},Qe={init(){a.exec("m-csdn-blog-comment-enable",()=>this.blockComment(),e=>!a.getValue(e[0]),true),a.execMenuOnce("m-csdn-blog-notLimitCommentMaxHeight",()=>this.notLimitCommentMaxHeight());},blockComment(){return o.info("启用/关闭 评论区"),U.addBlockCSS("#comment")},notLimitCommentMaxHeight(){return o.info("不限制评论区的最大高度"),T(`
      ...
      `)}},Xe={init(){a.exec("m-csdn-blog-bottomArticleEnable",()=>this.blockBottomArticle(),e=>!a.getValue(e[0]),true),a.execMenuOnce("m-csdn-blog-removeResourceArticle",()=>this.removeResourceArticle()),a.execMenuOnce("m-csdn-blog-openNewTab",()=>this.openNewTab()),l.onReady(()=>{a.execMenuOnce("m-csdn-blog-refactoringRecommendation",e=>this.refactoringRecommendation());});},blockBottomArticle(){return o.info("启用/关闭 底部文章"),U.addBlockCSS("#recommend")},async refactoringRecommendation(){const e=function(){Ae(".container-fluid").forEach(r=>{let c="",s="",w="",h="";if(r.hasAttribute("data-url")){if(c=r.getAttribute("data-url"),s=r.querySelector(".recommend_title div.left")?.innerHTML,!r.querySelector(".text"))return;w=r.querySelector(".text")?.innerHTML,r.querySelectorAll(".recommend-img").length&&r.querySelectorAll(".recommend-img").forEach(g=>{h+=g.innerHTML;});}else c=r.querySelector("a[data-type]").getAttribute("href"),s=r.querySelector(".recommend_title div.left").innerHTML,w=r.querySelector(".text").innerHTML;const m=new URL(c);m.host==="download.csdn.net"||m.host==="www.iteye.com"&&m.pathname.match(/^\/resource/gi)?s='<div class="component-box"><a class="praise" href="javascript:;">CSDN下载</a></div>'+s:m.origin.match(/edu.csdn.net/gi)&&(s='<div class="component-box"><a class="csdn-edu-title" href="javascript:;">CSDN学院</a></div>'+s),r.setAttribute("class","GM-csdn-dl"),r.setAttribute("data-url",c),r.innerHTML=`<div class="GM-csdn-title"><div class="left">${s}</div></div><div class="GM-csdn-content">${w}</div><div class="GM-csdn-img">${h}</div>`,r.addEventListener("click",function(){window.location.href=c;});});},t=new C.LockFunction(e,50),n=await l.waitNode("#recommend");o.info("重构底部推荐");const i=C.mutationObserver(n,{config:{childList:true,subtree:true,attributes:true},immediate:true,callback:()=>{t.run();}});return [()=>{i.disconnect();}]},removeResourceArticle(){return o.info("移除资源下载的文章"),U.addBlockCSS('.container-fluid:has(a[href*="https://download.csdn.net/"])','.container-fluid[data-url*="https://download.csdn.net/"]','.GM-csdn-dl[data-url*="https://download.csdn.net/"]')},openNewTab(){return o.info("新标签页打开"),l.on(document,"click",[".container-fluid",".GM-csdn-dl"],(t,n)=>{l.preventEvent(t);const i=n.getAttribute("data-url");typeof i=="string"?(o.info(`新标签页打开：${i}`),window.open(i,"_blank")):b.error("未获取到data-url属性");},{capture:true}).off}},ce={isSuccessResponse(e){return e==null?false:(typeof e=="string"&&(e=C.toJSON(e)),e?.code===200)}},de={async folderListWithCheck(e){const t=await z.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/folderListWithCheck",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":C.getRandomPCUA()}});o.info(t);const n=C.toJSON(t.data.responseText);if(!t.status||!ce.isSuccessResponse(t.data.responseText)){o.error("获取收藏夹信息失败，请求异常"),typeof n.msg=="string"?b.error(n.msg):b.error("获取收藏夹信息失败");return}return n.data.result},async addFavoriteInFolds(e){const t=await z.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/addFavoriteInFolds",{fetch:true,data:e,headers:{"Content-Type":"application/json","User-Agent":C.getRandomPCUA()},allowInterceptConfig:false});if(o.info(t),!t.status||!ce.isSuccessResponse(t.data.responseText)){o.error("添加收藏失败，请求异常",t),b.error("添加收藏失败，请求异常");return}return  true},async checkFavoriteByUrl(e){const t=await z.get("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/checkFavoriteByUrl",{data:{url:e},fetch:true,allowInterceptConfig:false,headers:{"User-Agent":C.getRandomPCUA()}});if(o.info(t),!t.status||!ce.isSuccessResponse(t.data.responseText)){o.error("检查收藏夹状态失败，请求异常"),b.error("检查收藏夹状态失败，请求异常");return}return C.toJSON(t.data.responseText).data},async createFolder(e){const t=await z.post("https://mp-action.csdn.net/interact/wrapper/pc/favorite/v1/api/createFolder",{data:e,fetch:true,headers:{Accept:"application/json, text/javascript, */*; q=0.01","Content-Type":"application/json","User-Agent":C.getRandomPCUA()},allowInterceptConfig:false});if(o.info(t),!t.status||!ce.isSuccessResponse(t.data.responseText)){b.error("创建收藏夹失败");return}return C.toJSON(t.data.responseText).data}},et={init(){a.exec("m-csdn-blog-bottom-toolbar-enable",()=>this.blockBottomToolBar(),e=>!a.getValue(e[0]),true),a.execMenuOnce("m-csdn-blog-bottom-toolbar-always-bottom",()=>this.bottomToolBarAlwaysShow()),l.onReady(()=>{a.execMenuOnce("m-csdn-blog-bottom-toolbar-optimizationCollectButton",()=>this.optimizationCollectButton());});},blockBottomToolBar(){return o.info("屏蔽底部工具栏"),U.addBlockCSS("#operate")},bottomToolBarAlwaysShow(){return o.info("底部工具栏常驻"),T(`
    #operate {
        bottom: 0 !important;
    }
    `)},async optimizationCollectButton(){o.info("优化收藏按钮");const e=await l.waitNode("#operate .collect-btn",1e4);if(!e)return;const t=l.on(e,"click",async n=>{l.preventEvent(n);const i=e.querySelector(".collect"),r=e.querySelector(".uncollect"),c=await de.folderListWithCheck(window.location.origin+window.location.pathname);if(!c)return;const s=[];c.forEach(g=>{g.IsFavorite&&s.push(g.ID);});const w=g=>{let p=g.ID,u=l.createElement("li",{className:"csdn-collection-item",innerHTML:`
            ...
            `},{"data-is-collect":g.IsFavorite});u.querySelector(".title-m");let y=u.querySelector(".csdn-collection-item_length");u.querySelector(".csdn-collection-controls");let E=u.querySelector(".collect-btn");return l.on(E,"click",async G=>{let $=B.articleDetailUrl;$==null&&($=window.location.origin+window.location.pathname);let N=B.articleId;if(N==null){o.error("获取文章ID失败"),b.error("获取文章ID失败");return}let L=B.username;if(L==null){o.error("获取文章作者失败"),b.error("获取文章作者失败");return}let _=B.articleTitle;if(_==null&&(_=document.title.replace(/-CSDN博客$/,"")),_==null){o.error("获取文章标题失败"),b.error("获取文章标题失败");return}let R=B.articleDesc;if(R==null){const A=pe("meta[name='description']");A&&(R=A.getAttribute("content"));}if(R==null){o.error("获取文章描述失败"),b.error("获取文章描述失败");return}const f=[...s];let x=b.loading("处理中...");try{let A=await de.checkFavoriteByUrl($);if(A==null)return;o.info(p,A);let D=!A[p];if(D?(o.info("添加收藏"),f.push(p)):(o.info("取消收藏"),f.splice(f.indexOf(p),1)),!await de.addFavoriteInFolds({author:L,url:$,source:"blog",sourceId:N,title:_,description:R,fromType:"PC",username:g.Username,folderIdList:f}))return;const v=await de.checkFavoriteByUrl($);if(v==null)return;o.info(p,v),u.setAttribute("data-is-collect",(!!v[p]).toString()),D?v[p]?(o.success("收藏成功"),b.success("收藏成功"),l.text(E,"已收藏"),s.includes(p)||s.push(p),g.FavoriteNum++):(o.error("收藏失败",v,p),b.error("收藏失败")):v[p]?(o.error("取消收藏失败",v,p),b.error("取消收藏失败")):(o.success("取消收藏成功"),b.success("取消收藏成功"),l.text(E,"收藏"),s.includes(p)&&s.splice(s.indexOf(p),1),g.FavoriteNum--),l.text(y,`${g.FavoriteNum}条内容`),Object.values(v).find(O=>O)?(l.show(i,!1),l.hide(r,!1)):(l.show(r,!1),l.hide(i,!1)),x.close();}catch(A){o.error(A);}finally{x.close();}}),u},m=H.alert({title:{text:"添加收藏夹",position:"center"},content:{text:`

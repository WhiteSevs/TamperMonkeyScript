<script setup lang="ts">
  ...
  let levelBgColor0_3 = ref(colorConversion.getLightColor(levelColor0_3.value, colorLightLevel));
  let levelBgColor4_9 = ref(colorConversion.getLightColor(levelColor4_9.value, colorLightLevel));
  let levelBgColor10_15 = ref(colorConversion.getLightColor(levelColor10_15.value, colorLightLevel));
  let levelBgColor16_18 = ref(colorConversion.getLightColor(levelColor16_18.value, colorLightLevel));

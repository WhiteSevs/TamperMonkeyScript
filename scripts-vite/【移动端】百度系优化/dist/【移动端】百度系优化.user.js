...
`;
  ...
  const BaiduHandleResultItem = {
      ...
      if (this.isNotRlLinkUrl(url)) {
        ...
        if (dataIVKStr) {
          try {
            ...
            if (((_a3 = dataIVK == null ? void 0 : dataIVK.control) == null ? void 0 : _a3.default_url) && !BaiduHandleResultItem.isBaiDuTransferStation(
            ...
            } else if (((_d = dataIVK == null ? void 0 : dataIVK.control) == null ? void 0 : _d.dataUrl) && !BaiduHandleResultItem.isBaiDuTransferStation(
            ...
            } else if (((_h = (_g = dataIVK == null ? void 0 : dataIVK.control) == null ? void 0 : _g.ext) == null ? void 0 : _h.url) && !BaiduHandleResultItem.isBaiDuTransferStation(
      ...
      if (this.isNotRlLinkUrl(url)) {
        ...
        if (rlLinkDataIvkStr) {
          try {
            ...
            if (((_m = rlLinkDataIvk == null ? void 0 : rlLinkDataIvk.control) == null ? void 0 : _m.default_url) && !BaiduHandleResultItem.isBaiDuTransferStation(
            ...
            } else if (((_p = rlLinkDataIvk == null ? void 0 : rlLinkDataIvk.control) == null ? void 0 : _p.invoke_url) && !BaiduHandleResultItem.isBaiDuTransferStation(
            ...
            } else if (((_t = (_s = rlLinkDataIvk == null ? void 0 : rlLinkDataIvk.control) == null ? void 0 : _s.ext) == null ? void 0 : _t.url) && !BaiduHandleResultItem.isBaiDuTransferStation(
      ...
      if (this.isNotRlLinkUrl(url)) {
        ...
        if (articleLinkDataIVKStr) {
          try {
            ...
            if (((_y = articleLinkDataIVK == null ? void 0 : articleLinkDataIVK.control) == null ? void 0 : _y.default_url) && !BaiduHandleResultItem.isBaiDuTransferStation(
            ...
            } else if (((_B = articleLinkDataIVK == null ? void 0 : articleLinkDataIVK.control) == null ? void 0 : _B.dataUrl) && !BaiduHandleResultItem.isBaiDuTransferStation(
    ...
    removeAds() {
      ...
      if (PopsPanel.getValue("baidu_search_blocking_everyone_is_still_searching")) {
        let $conterEveryOneSearch = document.querySelectorAll(
        ...
        let $bottomEveryOneSearch = document.querySelectorAll("#page-relative");
        if ($bottomEveryOneSearch.length) {
          log.success(`${TAG}末尾 大家都在搜 ${$bottomEveryOneSearch.length}个`);
          domutils.remove($bottomEveryOneSearch);
        }
        let $searchCraftEveryOnceSearch = document.querySelectorAll("#relativewords");
  ...
  const SearchNextPage = {
    ...
    $el: {
       ...
       */
      get pageController() {
        return document.querySelector("#page-controller") || document.querySelector("#page-bd") || // 问答页面的
       ...
       */
      get results() {
        return document.querySelector("#results") || document.querySelector("b-superframe-body .sfa-results");
      }
    },
    init() {
  ...
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-d279d03f"), n = n(), vue.popScopeId(), n);
  ...
  const SmallToolbar = /* @__PURE__ */ _export_sfc$1(_sfc_main$D, [["__scopeId", "data-v-d279d03f"]]);
  ...
  **/
  ...
  const Tiptap = /* @__PURE__ */ _export_sfc$1(_sfc_main$c, [["__scopeId", "data-v-394d8e04"]]);
  const _withScopeId$2 = (n) => (vue.pushScopeId("data-v-75decc4a"), n = n(), vue.popScopeId(), n);
  ...
  const FullToolbar = /* @__PURE__ */ _export_sfc$1(_sfc_main$b, [["__scopeId", "data-v-75decc4a"]]);
  ...
  const TiebaHomeData = {
    async getUserData() {
      ...
      let userName = new URL($name.href).searchParams.get("un") || pcUserInfo.userName;
      if (utils.isNull(userName)) {
        log.error("获取用户un为空");
        return;
      }
    ...
    async getUserDataWithPCDoc() {
      ...
      let ipLocation = "未知";
      let userName = "";
      let showUserName = pcDoc.querySelector(".userinfo_username").textContent;
      let $navIcon = pcDoc.querySelector("a.nav_icon");
      if ($navIcon) {
      ...
      pcDoc.querySelectorAll(".userinfo_userdata span").forEach((spanItem) => {
      ...
      let postsList = [];
      pcDoc.querySelectorAll("ul.new_list > div").forEach((listItem) => {
        let postInfo = {
      ...
      let sex = 0;
      let $sex = pcDoc.querySelector(".userinfo_sex");
      if ($sex) {
      ...
      let avatar = "";
      let $avatar = pcDoc.querySelector("#j_userhead img");
      if ($avatar) {
        avatar = $avatar.src;
      }
      ...
      let receivedLikes = 0;
      let follow = 0;
      let forum = pcDoc.querySelectorAll(
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-49222b2e"), n = n(), vue.popScopeId(), n);
  ...
  const Home = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["__scopeId", "data-v-49222b2e"]]);
...
})(Vue, Qmsg, Utils, DOMUtils, pops, Viewer, Pinia, ElementPlusIconsVue, VueDemi, VueRouter, ElementPlus);
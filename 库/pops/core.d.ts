 ...
 * pops.panel的 select
 */
declare interface PopsPanelSelectDetails<T extends any>
...
declare interface PopsMoreButtonConfig {
	btn?: PopsButtonConfig["btn"] & {
		 ...
		 * 确定按钮
		 */
		ok?: Partial<PopsButtonDetails>;
		/**
		 * 取消按钮
		 */
		cancel?: Partial<PopsButtonDetails>;
		/**
		 * 其他按钮
		 */
		other?: Partial<PopsButtonDetails>;
	};
}
/**
 * 拖拽配置

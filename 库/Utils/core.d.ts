...
interface Utils {
	 ...
	 */
	getMaxValue(
		val: UtilsNestedObjectWithToString,
	 ...
	 */
	getRandomValue(
		val_1: UtilsNestedObjectWithToString,
		val_2: UtilsNestedObjectWithToString
	): any;
	/**
	 * 获取随机的电脑端User-Agent
	...
	enterFullScreen(
		element: HTMLElement,
		options?: FullscreenOptions | null
	): void;
	/**
	 * 使浏览器退出全屏
	 * @param element （可选）目标元素，默认：document.documentElement
	...
	sortListByProperty<T extends any[] | NodeList>(
		data: T,
		getPropertyValueFunc: string | (() => any),
		sortByDesc?: boolean
	): T;
	/**
	 ...
	 * > {123:123}
	 */
	toJSON<T extends UtilsNestedObjectWithToString>(
		data: string | null,

 ...
 * }
 */
type UtilsNestedObjectWithToString = {
...
declare interface UtilsIndexedDBConstructor {
     ...
     * @param dbName 数据库名
     */
    open(callback: (store: UtilsNestedObjectWithToString | {
        code: number,
        msg: string,
        error: Error
...
declare interface UtilsLogConstructor {
     ...
     */
    table(msg: UtilsNestedObjectWithToString[], color?: string, otherStyle?: string): void;
    /**
     * 配置Log对象的颜色
...
interface Utils {
    ...
    dispatchEvent(
        ...
        details?: UtilsNestedObjectWithToString
    ): void;
    /**
     * 下载base64格式的数据
     ...
     * > 456
     */
    getMaxValue(val: UtilsNestedObjectWithToString, handler: (key: any, value: any) => number): number;
    /**
     * 获取最大值
     * @example
     ...
     * > 2
     */
    getMaxValue(val: UtilsNestedObjectWithToString[], handler: (index: number, value: any) => number): number;
    /**
     * 获取页面中最大的z-index
     ...
     * > 123
     */
    getMinValue(val: UtilsNestedObjectWithToString, handler: (key: any, value: any) => number): number;
    /**
     * 获取最小值
     * @example
     ...
     * > 0
     */
    getMinValue(val: UtilsNestedObjectWithToString[], handler: (index: number, value: any) => number): number;
    /**
     * 获取随机的安卓手机User-Agent
     * @example
     ...
     * > 结果2
     */
    getRandomValue(val: any[] | UtilsNestedObjectWithToString): any;
    /**
     * 获取两个数之间随机值
     * @example
     ...
     * > {1: 1}
     */
    getRandomValue(val_1: UtilsNestedObjectWithToString, val_2: UtilsNestedObjectWithToString): any;
    /**
     * 获取随机的电脑端User-Agent
     ...
     */
    getSymbol(target: UtilsNestedObjectWithToString, keyName?: string | symbol): any;
    /**
     * 获取文本的字符长度
     * @param text
     * @example
     ...
     * > {123:123}
     */
    toJSON<T extends UtilsNestedObjectWithToString>(data: string | null, errorCallBack?: (error: Error) => void): T;
    /**
     ...
     */
    watchObject(
        target: UtilsNestedObjectWithToString,
        propertyName: string,
...
declare interface Vue2Context extends UtilsNestedObjectWithToString {
    _isVue: true;

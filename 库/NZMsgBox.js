...
(function () {
  ...
  .NZ-MsgBox-bg{position:fixed;top:0;right:0;bottom:0;left:0;z-index:99998;background-color:rgba(245,245,245,.55);}
  ...
  .NZ-MsgBox-alert{position:fixed;top:0!important;top:0;right:0;bottom:0;left:0!important;left:0;z-index:99999;display:inline-grid;box-sizing:initial;margin:auto;width:80vw;height:82vh;max-width:500px;max-height:520px;min-width:350px;border-radius:5px;background-color:#fff;box-shadow:0 3px 12px rgba(0,0,0,.23),0 3px 12px rgba(0,0,0,.16);align-content:space-between;}
  .NZ-MsgBox-alert .distop{display:none;height:30px;border-radius:0;border-top-right-radius:5px;border-top-left-radius:5px;background:#fff;}
  ...
  .NZ-MsgBox-alert .msgcontainer .msgcon{overflow-y:auto;margin-top:10px;max-height:400px;text-align:left;font-weight:400;font-size:16px;line-height:normal;}
  ...
  .NZ-MsgBox-alert .operatebar button.cancel:hover{background:rgba(238,238,238,.8);}
  ...
  .NZ-TipsBar-Container .tipbar{position:relative;overflow:hidden;margin:5px 0;padding:15px;width:auto;min-width:280px;border-radius:3px;background-color:rgba(238,238,238,.95);box-shadow:0 1.5px 4px rgba(0,0,0,.24),0 1.5px 6px rgba(0,0,0,.12);color:#757575;font-size:14px;pointer-events:all;backface-visibility:hidden;}
  .NZ-TipsBar-Container.locationT .tipbar{flex:1;-webkit-flex:1;}
  ...
  .NZ-TipsBar-Container .tipbar .tipsbar-icon{position:absolute;top:50%;left:16px;display:table;margin-top:-12px;color:#000;font-size:35px;line-height:24px;opacity:0;}
  ...
  .NZ-Toast{position:fixed;top:50%;left:50%;z-index:99999;padding:22px 32px 19px 32px;border-radius:.5em;background-color:rgba(10,10,10,.7);color:#efefef;text-align:center;font-size:1em;user-select:none;}
  .NZ-Toast.top{top:20px;}
  .NZ-Tooltips{position:absolute;top:0;left:0;padding:13px;max-width:300px;max-height:200px;border-radius:2px;background-color:#fff;box-shadow:0 1.5px 4px rgba(0,0,0,.24),0 1.5px 6px rgba(0,0,0,.12);color:#4e4e4e;font-size:14px;}
  ...
  .NZ-TipsBar-show--top{-webkit-backface-visibility:visible!important;backface-visibility:visible!important;-webkit-animation-name:TipsBar-show--top;animation-name:TipsBar-show--top;animation-duration:.9s;animation-timing-function:cubic-bezier(.35,0,.25,1);}
  .NZ-TipsBar-hide--top{-webkit-animation-name:TipsBar-hide--top;animation-name:TipsBar-hide--top;-webkit-backface-visibility:visible!important;backface-visibility:visible!important;animation-duration:.7s;animation-timing-function:cubic-bezier(.4,.45,.15,.91);}
  ...
  100%{opacity:0;-webkit-transform:scale3d(1.25,1.25,1);}
  }
  @keyframes anim-close{0%{opacity:1;}
  100%{opacity:0;-webkit-transform:scale3d(1.25,1.25,1);transform:scale3d(1.25,1.25,1);}
  }
  ...
  @keyframes MsgBox-leap{0%{transform:scale3d(1,1,1);}
  100%{transform:scale3d(1.03,1.03,1);}
  }
  @-webkit-keyframes MsgBox-leap{0%{-webkit-transform:scale3d(1,1,1);transform:scale3d(1,1,1);}
  100%{-webkit-transform:scale3d(1.03,1.03,1);transform:scale3d(1.03,1.03,1);}
  }
  ...
  100%{opacity:1;-webkit-transform:translateX(300px);transform:translateX(300px);}
  }
  ...
  @-webkit-keyframes NZ-Motion--fadeOutTop{0%{opacity:10;-webkit-transform:translateY(0);transform:translateY(0);}
  ...
  @keyframes NZ-Motion--fadeInLeft{0%{opacity:0;-webkit-transform:translateX(-20px);transform:translateX(-20px);-ms-transform:translateX(-20px);}
  100%{opacity:1;-webkit-transform:translateX(0);transform:translateX(0);-ms-transform:translateX(0);}
  }

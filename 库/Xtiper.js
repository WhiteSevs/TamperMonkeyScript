...
.xtiper_msg {max-width:752px; position:fixed; left:50%; min-height:50px; line-height:50px; font-size:14px; border-radius:3px; overflow:hidden; z-index:99999; opacity:0; box-shadow:0 0 10px rgba(0,0,0,0.2);}
...
styleNode.innerHTML= cssResource;

    ...
    cssText: {
      ...
      * {
      ...
      .pops-tip {
        ...
        --tooltip-arrow--after-color: #4e4e4e;
        --tooltip-arrow--after-bg-color: #fff;
      ...
      .pops-tip.github-tooltip{
        ...
        --tooltip-arrow--after-color: #ffffff;
        --tooltip-arrow--after-bg-color: #24292f;
